...
OAILivenessSessionStatus::OAILivenessSessionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILivenessSessionStatus::OAILivenessSessionStatus() {
    this->initializeModel();
}

OAILivenessSessionStatus::~OAILivenessSessionStatus() {}

void OAILivenessSessionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAILivenessSessionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILivenessSessionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CREATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAILivenessSessionStatus::CREATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAILivenessSessionStatus::IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SUCCEEDED", Qt::CaseInsensitive) == 0) {
        m_value = eOAILivenessSessionStatus::SUCCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAILivenessSessionStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXPIRED", Qt::CaseInsensitive) == 0) {
        m_value = eOAILivenessSessionStatus::EXPIRED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILivenessSessionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAILivenessSessionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAILivenessSessionStatus::CREATED:
            val = "CREATED";
            break;
        case eOAILivenessSessionStatus::IN_PROGRESS:
            val = "IN_PROGRESS";
            break;
        case eOAILivenessSessionStatus::SUCCEEDED:
            val = "SUCCEEDED";
            break;
        case eOAILivenessSessionStatus::FAILED:
            val = "FAILED";
            break;
        case eOAILivenessSessionStatus::EXPIRED:
            val = "EXPIRED";
            break;
        default:
            break;
...
QJsonValue OAILivenessSessionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILivenessSessionStatus::eOAILivenessSessionStatus OAILivenessSessionStatus::getValue() const {
    return m_value;
}

void OAILivenessSessionStatus::setValue(const OAILivenessSessionStatus::eOAILivenessSessionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAILivenessSessionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAILivenessSessionStatus::isValid() const {
