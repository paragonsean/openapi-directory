...
#include "OAIDatasetStatusMessageCode.h"
...
OAIDatasetStatusMessageCode::OAIDatasetStatusMessageCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasetStatusMessageCode::OAIDatasetStatusMessageCode() {
    this->initializeModel();
}

OAIDatasetStatusMessageCode::~OAIDatasetStatusMessageCode() {}

void OAIDatasetStatusMessageCode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDatasetStatusMessageCode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDatasetStatusMessageCode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SUCCESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasetStatusMessageCode::SUCCESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SERVICE_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasetStatusMessageCode::SERVICE_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CLIENT_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasetStatusMessageCode::CLIENT_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDatasetStatusMessageCode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDatasetStatusMessageCode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDatasetStatusMessageCode::SUCCESS:
            val = "SUCCESS";
            break;
        case eOAIDatasetStatusMessageCode::SERVICE_ERROR:
            val = "SERVICE_ERROR";
            break;
        case eOAIDatasetStatusMessageCode::CLIENT_ERROR:
            val = "CLIENT_ERROR";
            break;
        default:
            break;
...
QJsonValue OAIDatasetStatusMessageCode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDatasetStatusMessageCode::eOAIDatasetStatusMessageCode OAIDatasetStatusMessageCode::getValue() const {
    return m_value;
}

void OAIDatasetStatusMessageCode::setValue(const OAIDatasetStatusMessageCode::eOAIDatasetStatusMessageCode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDatasetStatusMessageCode::isSet() const {
    
    return m_value_isSet;
}

bool OAIDatasetStatusMessageCode::isValid() const {
