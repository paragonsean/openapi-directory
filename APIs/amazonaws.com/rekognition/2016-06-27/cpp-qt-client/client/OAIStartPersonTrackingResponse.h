...
/*
 * OAIStartPersonTrackingResponse.h
 *
 * 
 */

#ifndef OAIStartPersonTrackingResponse_H
#define OAIStartPersonTrackingResponse_H
...
class OAIStartPersonTrackingResponse : public OAIObject {
public:
    OAIStartPersonTrackingResponse();
    OAIStartPersonTrackingResponse(QString json);
    ~OAIStartPersonTrackingResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartPersonTrackingResponse)

#endif // OAIStartPersonTrackingResponse_H
