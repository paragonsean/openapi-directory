...
#include "OAICreateProjectVersionRequest_OutputConfig.h"
...
OAICreateProjectVersionRequest_OutputConfig::OAICreateProjectVersionRequest_OutputConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateProjectVersionRequest_OutputConfig::OAICreateProjectVersionRequest_OutputConfig() {
    this->initializeModel();
}

OAICreateProjectVersionRequest_OutputConfig::~OAICreateProjectVersionRequest_OutputConfig() {}

void OAICreateProjectVersionRequest_OutputConfig::initializeModel() {
...
void OAICreateProjectVersionRequest_OutputConfig::fromJson(QString jsonString) {
...
void OAICreateProjectVersionRequest_OutputConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateProjectVersionRequest_OutputConfig::asJson() const {
...
QJsonObject OAICreateProjectVersionRequest_OutputConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateProjectVersionRequest_OutputConfig::getS3Bucket() const {
    return m_s3_bucket;
}
void OAICreateProjectVersionRequest_OutputConfig::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAICreateProjectVersionRequest_OutputConfig::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAICreateProjectVersionRequest_OutputConfig::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAICreateProjectVersionRequest_OutputConfig::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAICreateProjectVersionRequest_OutputConfig::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAICreateProjectVersionRequest_OutputConfig::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAICreateProjectVersionRequest_OutputConfig::is_s3_key_prefix_Valid() const{
    return m_s3_key_prefix_isValid;
}

bool OAICreateProjectVersionRequest_OutputConfig::isSet() const {
...
bool OAICreateProjectVersionRequest_OutputConfig::isValid() const {
