...
/*
 * OAIGetFaceDetectionResponse_VideoMetadata.h
 *
 * 
 */

#ifndef OAIGetFaceDetectionResponse_VideoMetadata_H
#define OAIGetFaceDetectionResponse_VideoMetadata_H
...
class OAIGetFaceDetectionResponse_VideoMetadata : public OAIObject {
public:
    OAIGetFaceDetectionResponse_VideoMetadata();
    OAIGetFaceDetectionResponse_VideoMetadata(QString json);
    ~OAIGetFaceDetectionResponse_VideoMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceDetectionResponse_VideoMetadata)

#endif // OAIGetFaceDetectionResponse_VideoMetadata_H
