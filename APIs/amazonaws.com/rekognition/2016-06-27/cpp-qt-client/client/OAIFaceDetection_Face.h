...
/*
 * OAIFaceDetection_Face.h
 *
 * 
 */

#ifndef OAIFaceDetection_Face_H
#define OAIFaceDetection_Face_H
...
class OAIFaceDetection_Face : public OAIObject {
public:
    OAIFaceDetection_Face();
    OAIFaceDetection_Face(QString json);
    ~OAIFaceDetection_Face() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetection_Face)

#endif // OAIFaceDetection_Face_H
