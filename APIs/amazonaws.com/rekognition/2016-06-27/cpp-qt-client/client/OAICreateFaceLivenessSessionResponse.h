...
/*
 * OAICreateFaceLivenessSessionResponse.h
 *
 * 
 */

#ifndef OAICreateFaceLivenessSessionResponse_H
#define OAICreateFaceLivenessSessionResponse_H
...
class OAICreateFaceLivenessSessionResponse : public OAIObject {
public:
    OAICreateFaceLivenessSessionResponse();
    OAICreateFaceLivenessSessionResponse(QString json);
    ~OAICreateFaceLivenessSessionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFaceLivenessSessionResponse)

#endif // OAICreateFaceLivenessSessionResponse_H
