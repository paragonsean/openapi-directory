...
class OAIReason : public OAIEnum {
public:
    OAIReason();
    OAIReason(QString json);
    ~OAIReason() override;
    ...
    OAIReason::eOAIReason getValue() const;
    void setValue(const OAIReason::eOAIReason& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReason)
