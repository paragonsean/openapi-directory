...
#ifndef OAIEyeDirection_H
#define OAIEyeDirection_H
...
class OAIEyeDirection : public OAIObject {
public:
    OAIEyeDirection();
    OAIEyeDirection(QString json);
    ~OAIEyeDirection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEyeDirection)

#endif // OAIEyeDirection_H
