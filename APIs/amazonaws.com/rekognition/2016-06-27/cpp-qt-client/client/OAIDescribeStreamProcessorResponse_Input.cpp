...
#include "OAIDescribeStreamProcessorResponse_Input.h"
...
OAIDescribeStreamProcessorResponse_Input::OAIDescribeStreamProcessorResponse_Input(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeStreamProcessorResponse_Input::OAIDescribeStreamProcessorResponse_Input() {
    this->initializeModel();
}

OAIDescribeStreamProcessorResponse_Input::~OAIDescribeStreamProcessorResponse_Input() {}

void OAIDescribeStreamProcessorResponse_Input::initializeModel() {

    m_kinesis_video_stream_isSet = false;
    m_kinesis_video_stream_isValid = false;
}

void OAIDescribeStreamProcessorResponse_Input::fromJson(QString jsonString) {
...
void OAIDescribeStreamProcessorResponse_Input::fromJsonObject(QJsonObject json) {

    m_kinesis_video_stream_isValid = ::OpenAPI::fromJsonValue(m_kinesis_video_stream, json[QString("KinesisVideoStream")]);
    m_kinesis_video_stream_isSet = !json[QString("KinesisVideoStream")].isNull() && m_kinesis_video_stream_isValid;
}

QString OAIDescribeStreamProcessorResponse_Input::asJson() const {
...
QJsonObject OAIDescribeStreamProcessorResponse_Input::asJsonObject() const {
    QJsonObject obj;
    if (m_kinesis_video_stream.isSet()) {
        obj.insert(QString("KinesisVideoStream"), ::OpenAPI::toJsonValue(m_kinesis_video_stream));
    }
    return obj;
}

OAIStreamProcessorInput_KinesisVideoStream OAIDescribeStreamProcessorResponse_Input::getKinesisVideoStream() const {
    return m_kinesis_video_stream;
}
void OAIDescribeStreamProcessorResponse_Input::setKinesisVideoStream(const OAIStreamProcessorInput_KinesisVideoStream &kinesis_video_stream) {
    m_kinesis_video_stream = kinesis_video_stream;
    m_kinesis_video_stream_isSet = true;
}

bool OAIDescribeStreamProcessorResponse_Input::is_kinesis_video_stream_Set() const{
    return m_kinesis_video_stream_isSet;
}

bool OAIDescribeStreamProcessorResponse_Input::is_kinesis_video_stream_Valid() const{
    return m_kinesis_video_stream_isValid;
}

bool OAIDescribeStreamProcessorResponse_Input::isSet() const {
...
bool OAIDescribeStreamProcessorResponse_Input::isValid() const {
