...
#ifndef OAIAssociatedFace_H
#define OAIAssociatedFace_H
...
class OAIAssociatedFace : public OAIObject {
public:
    OAIAssociatedFace();
    OAIAssociatedFace(QString json);
    ~OAIAssociatedFace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociatedFace)

#endif // OAIAssociatedFace_H
