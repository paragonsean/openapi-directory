...
OAIStartTechnicalCueDetectionFilter_BlackFrame::OAIStartTechnicalCueDetectionFilter_BlackFrame(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartTechnicalCueDetectionFilter_BlackFrame::OAIStartTechnicalCueDetectionFilter_BlackFrame() {
    this->initializeModel();
}

OAIStartTechnicalCueDetectionFilter_BlackFrame::~OAIStartTechnicalCueDetectionFilter_BlackFrame() {}

void OAIStartTechnicalCueDetectionFilter_BlackFrame::initializeModel() {
...
void OAIStartTechnicalCueDetectionFilter_BlackFrame::fromJson(QString jsonString) {
...
void OAIStartTechnicalCueDetectionFilter_BlackFrame::fromJsonObject(QJsonObject json) {
...
QString OAIStartTechnicalCueDetectionFilter_BlackFrame::asJson() const {
...
QJsonObject OAIStartTechnicalCueDetectionFilter_BlackFrame::asJsonObject() const {
    QJsonObject obj;
...
float OAIStartTechnicalCueDetectionFilter_BlackFrame::getMaxPixelThreshold() const {
    return m_max_pixel_threshold;
}
void OAIStartTechnicalCueDetectionFilter_BlackFrame::setMaxPixelThreshold(const float &max_pixel_threshold) {
    m_max_pixel_threshold = max_pixel_threshold;
    m_max_pixel_threshold_isSet = true;
}

bool OAIStartTechnicalCueDetectionFilter_BlackFrame::is_max_pixel_threshold_Set() const{
    return m_max_pixel_threshold_isSet;
}

bool OAIStartTechnicalCueDetectionFilter_BlackFrame::is_max_pixel_threshold_Valid() const{
    return m_max_pixel_threshold_isValid;
}

float OAIStartTechnicalCueDetectionFilter_BlackFrame::getMinCoveragePercentage() const {
    return m_min_coverage_percentage;
}
void OAIStartTechnicalCueDetectionFilter_BlackFrame::setMinCoveragePercentage(const float &min_coverage_percentage) {
    m_min_coverage_percentage = min_coverage_percentage;
    m_min_coverage_percentage_isSet = true;
}

bool OAIStartTechnicalCueDetectionFilter_BlackFrame::is_min_coverage_percentage_Set() const{
    return m_min_coverage_percentage_isSet;
}

bool OAIStartTechnicalCueDetectionFilter_BlackFrame::is_min_coverage_percentage_Valid() const{
    return m_min_coverage_percentage_isValid;
}

bool OAIStartTechnicalCueDetectionFilter_BlackFrame::isSet() const {
...
bool OAIStartTechnicalCueDetectionFilter_BlackFrame::isValid() const {
