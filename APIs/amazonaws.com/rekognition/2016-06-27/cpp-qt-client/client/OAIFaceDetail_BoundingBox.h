...
/*
 * OAIFaceDetail_BoundingBox.h
 *
 * 
 */

#ifndef OAIFaceDetail_BoundingBox_H
#define OAIFaceDetail_BoundingBox_H
...
class OAIFaceDetail_BoundingBox : public OAIObject {
public:
    OAIFaceDetail_BoundingBox();
    OAIFaceDetail_BoundingBox(QString json);
    ~OAIFaceDetail_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_BoundingBox)

#endif // OAIFaceDetail_BoundingBox_H
