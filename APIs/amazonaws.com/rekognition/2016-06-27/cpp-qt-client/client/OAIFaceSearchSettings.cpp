...
#include "OAIFaceSearchSettings.h"
...
OAIFaceSearchSettings::OAIFaceSearchSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceSearchSettings::OAIFaceSearchSettings() {
    this->initializeModel();
}

OAIFaceSearchSettings::~OAIFaceSearchSettings() {}

void OAIFaceSearchSettings::initializeModel() {
...
void OAIFaceSearchSettings::fromJson(QString jsonString) {
...
void OAIFaceSearchSettings::fromJsonObject(QJsonObject json) {
...
QString OAIFaceSearchSettings::asJson() const {
...
QJsonObject OAIFaceSearchSettings::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFaceSearchSettings::getCollectionId() const {
    return m_collection_id;
}
void OAIFaceSearchSettings::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIFaceSearchSettings::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIFaceSearchSettings::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

float OAIFaceSearchSettings::getFaceMatchThreshold() const {
    return m_face_match_threshold;
}
void OAIFaceSearchSettings::setFaceMatchThreshold(const float &face_match_threshold) {
    m_face_match_threshold = face_match_threshold;
    m_face_match_threshold_isSet = true;
}

bool OAIFaceSearchSettings::is_face_match_threshold_Set() const{
    return m_face_match_threshold_isSet;
}

bool OAIFaceSearchSettings::is_face_match_threshold_Valid() const{
    return m_face_match_threshold_isValid;
}

bool OAIFaceSearchSettings::isSet() const {
...
bool OAIFaceSearchSettings::isValid() const {
