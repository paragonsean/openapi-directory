...
/*
 * OAICopyProjectVersionRequest_OutputConfig.h
 *
 * 
 */

#ifndef OAICopyProjectVersionRequest_OutputConfig_H
#define OAICopyProjectVersionRequest_OutputConfig_H
...
class OAICopyProjectVersionRequest_OutputConfig : public OAIObject {
public:
    OAICopyProjectVersionRequest_OutputConfig();
    OAICopyProjectVersionRequest_OutputConfig(QString json);
    ~OAICopyProjectVersionRequest_OutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyProjectVersionRequest_OutputConfig)

#endif // OAICopyProjectVersionRequest_OutputConfig_H
