...
OAIStreamProcessorOutput_S3Destination::OAIStreamProcessorOutput_S3Destination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorOutput_S3Destination::OAIStreamProcessorOutput_S3Destination() {
    this->initializeModel();
}

OAIStreamProcessorOutput_S3Destination::~OAIStreamProcessorOutput_S3Destination() {}

void OAIStreamProcessorOutput_S3Destination::initializeModel() {
...
void OAIStreamProcessorOutput_S3Destination::fromJson(QString jsonString) {
...
void OAIStreamProcessorOutput_S3Destination::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessorOutput_S3Destination::asJson() const {
...
QJsonObject OAIStreamProcessorOutput_S3Destination::asJsonObject() const {
    QJsonObject obj;
    if (m_bucket_isSet) {
...
QString OAIStreamProcessorOutput_S3Destination::getBucket() const {
    return m_bucket;
}
void OAIStreamProcessorOutput_S3Destination::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAIStreamProcessorOutput_S3Destination::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAIStreamProcessorOutput_S3Destination::is_bucket_Valid() const{
    return m_bucket_isValid;
}

QString OAIStreamProcessorOutput_S3Destination::getKeyPrefix() const {
    return m_key_prefix;
}
void OAIStreamProcessorOutput_S3Destination::setKeyPrefix(const QString &key_prefix) {
    m_key_prefix = key_prefix;
    m_key_prefix_isSet = true;
}

bool OAIStreamProcessorOutput_S3Destination::is_key_prefix_Set() const{
    return m_key_prefix_isSet;
}

bool OAIStreamProcessorOutput_S3Destination::is_key_prefix_Valid() const{
    return m_key_prefix_isValid;
}

bool OAIStreamProcessorOutput_S3Destination::isSet() const {
...
bool OAIStreamProcessorOutput_S3Destination::isValid() const {
