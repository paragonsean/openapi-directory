...
OAIStartCelebrityRecognitionRequest_Video::OAIStartCelebrityRecognitionRequest_Video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartCelebrityRecognitionRequest_Video::OAIStartCelebrityRecognitionRequest_Video() {
    this->initializeModel();
}

OAIStartCelebrityRecognitionRequest_Video::~OAIStartCelebrityRecognitionRequest_Video() {}

void OAIStartCelebrityRecognitionRequest_Video::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIStartCelebrityRecognitionRequest_Video::fromJson(QString jsonString) {
...
void OAIStartCelebrityRecognitionRequest_Video::fromJsonObject(QJsonObject json) {
...
QString OAIStartCelebrityRecognitionRequest_Video::asJson() const {
...
QJsonObject OAIStartCelebrityRecognitionRequest_Video::asJsonObject() const {
    QJsonObject obj;
...
OAIVideo_S3Object OAIStartCelebrityRecognitionRequest_Video::getS3Object() const {
    return m_s3_object;
}
void OAIStartCelebrityRecognitionRequest_Video::setS3Object(const OAIVideo_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIStartCelebrityRecognitionRequest_Video::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIStartCelebrityRecognitionRequest_Video::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIStartCelebrityRecognitionRequest_Video::isSet() const {
...
bool OAIStartCelebrityRecognitionRequest_Video::isValid() const {
