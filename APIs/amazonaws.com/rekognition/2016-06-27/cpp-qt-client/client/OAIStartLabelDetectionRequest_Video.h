...
/*
 * OAIStartLabelDetectionRequest_Video.h
 *
 * 
 */

#ifndef OAIStartLabelDetectionRequest_Video_H
#define OAIStartLabelDetectionRequest_Video_H
...
class OAIStartLabelDetectionRequest_Video : public OAIObject {
public:
    OAIStartLabelDetectionRequest_Video();
    OAIStartLabelDetectionRequest_Video(QString json);
    ~OAIStartLabelDetectionRequest_Video() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartLabelDetectionRequest_Video)

#endif // OAIStartLabelDetectionRequest_Video_H
