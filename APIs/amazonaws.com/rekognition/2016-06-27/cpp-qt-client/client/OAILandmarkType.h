...
#ifndef OAILandmarkType_H
#define OAILandmarkType_H
...
class OAILandmarkType : public OAIEnum {
public:
    OAILandmarkType();
    OAILandmarkType(QString json);
    ~OAILandmarkType() override;
    ...
    OAILandmarkType::eOAILandmarkType getValue() const;
    void setValue(const OAILandmarkType::eOAILandmarkType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAILandmarkType)

#endif // OAILandmarkType_H
