...
#include "OAIDeleteProjectVersionResponse.h"
...
OAIDeleteProjectVersionResponse::OAIDeleteProjectVersionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteProjectVersionResponse::OAIDeleteProjectVersionResponse() {
    this->initializeModel();
}

OAIDeleteProjectVersionResponse::~OAIDeleteProjectVersionResponse() {}

void OAIDeleteProjectVersionResponse::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIDeleteProjectVersionResponse::fromJson(QString jsonString) {
...
void OAIDeleteProjectVersionResponse::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("Status")]);
    m_status_isSet = !json[QString("Status")].isNull() && m_status_isValid;
}

QString OAIDeleteProjectVersionResponse::asJson() const {
...
QJsonObject OAIDeleteProjectVersionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIProjectVersionStatus OAIDeleteProjectVersionResponse::getStatus() const {
    return m_status;
}
void OAIDeleteProjectVersionResponse::setStatus(const OAIProjectVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeleteProjectVersionResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeleteProjectVersionResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDeleteProjectVersionResponse::isSet() const {
...
bool OAIDeleteProjectVersionResponse::isValid() const {
