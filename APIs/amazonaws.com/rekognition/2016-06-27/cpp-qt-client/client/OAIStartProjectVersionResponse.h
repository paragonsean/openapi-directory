...
/*
 * OAIStartProjectVersionResponse.h
 *
 * 
 */

#ifndef OAIStartProjectVersionResponse_H
#define OAIStartProjectVersionResponse_H
...
class OAIStartProjectVersionResponse : public OAIObject {
public:
    OAIStartProjectVersionResponse();
    OAIStartProjectVersionResponse(QString json);
    ~OAIStartProjectVersionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartProjectVersionResponse)

#endif // OAIStartProjectVersionResponse_H
