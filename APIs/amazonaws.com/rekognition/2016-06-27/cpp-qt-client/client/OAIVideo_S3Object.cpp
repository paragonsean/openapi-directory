...
OAIVideo_S3Object::OAIVideo_S3Object(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideo_S3Object::OAIVideo_S3Object() {
    this->initializeModel();
}

OAIVideo_S3Object::~OAIVideo_S3Object() {}

void OAIVideo_S3Object::initializeModel() {
...
void OAIVideo_S3Object::fromJson(QString jsonString) {
...
void OAIVideo_S3Object::fromJsonObject(QJsonObject json) {
...
QString OAIVideo_S3Object::asJson() const {
...
QJsonObject OAIVideo_S3Object::asJsonObject() const {
    QJsonObject obj;
    if (m_bucket_isSet) {
...
QString OAIVideo_S3Object::getBucket() const {
    return m_bucket;
}
void OAIVideo_S3Object::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAIVideo_S3Object::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAIVideo_S3Object::is_bucket_Valid() const{
    return m_bucket_isValid;
}

QString OAIVideo_S3Object::getName() const {
    return m_name;
}
void OAIVideo_S3Object::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIVideo_S3Object::is_name_Set() const{
    return m_name_isSet;
}

bool OAIVideo_S3Object::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIVideo_S3Object::getVersion() const {
    return m_version;
}
void OAIVideo_S3Object::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIVideo_S3Object::is_version_Set() const{
    return m_version_isSet;
}

bool OAIVideo_S3Object::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIVideo_S3Object::isSet() const {
...
bool OAIVideo_S3Object::isValid() const {
