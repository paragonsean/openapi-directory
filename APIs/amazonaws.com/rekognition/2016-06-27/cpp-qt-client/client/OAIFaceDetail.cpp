...
OAIFaceDetail::OAIFaceDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail::OAIFaceDetail() {
    this->initializeModel();
}

OAIFaceDetail::~OAIFaceDetail() {}

void OAIFaceDetail::initializeModel() {
...
void OAIFaceDetail::fromJson(QString jsonString) {
...
void OAIFaceDetail::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail::asJson() const {
...
QJsonObject OAIFaceDetail::asJsonObject() const {
    QJsonObject obj;
...
OAIFaceDetail_BoundingBox OAIFaceDetail::getBoundingBox() const {
    return m_bounding_box;
}
void OAIFaceDetail::setBoundingBox(const OAIFaceDetail_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIFaceDetail::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIFaceDetail::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

OAIFaceDetail_AgeRange OAIFaceDetail::getAgeRange() const {
    return m_age_range;
}
void OAIFaceDetail::setAgeRange(const OAIFaceDetail_AgeRange &age_range) {
    m_age_range = age_range;
    m_age_range_isSet = true;
}

bool OAIFaceDetail::is_age_range_Set() const{
    return m_age_range_isSet;
}

bool OAIFaceDetail::is_age_range_Valid() const{
    return m_age_range_isValid;
}

OAIFaceDetail_Smile OAIFaceDetail::getSmile() const {
    return m_smile;
}
void OAIFaceDetail::setSmile(const OAIFaceDetail_Smile &smile) {
    m_smile = smile;
    m_smile_isSet = true;
}

bool OAIFaceDetail::is_smile_Set() const{
    return m_smile_isSet;
}

bool OAIFaceDetail::is_smile_Valid() const{
    return m_smile_isValid;
}

OAIFaceDetail_Eyeglasses OAIFaceDetail::getEyeglasses() const {
    return m_eyeglasses;
}
void OAIFaceDetail::setEyeglasses(const OAIFaceDetail_Eyeglasses &eyeglasses) {
    m_eyeglasses = eyeglasses;
    m_eyeglasses_isSet = true;
}

bool OAIFaceDetail::is_eyeglasses_Set() const{
    return m_eyeglasses_isSet;
}

bool OAIFaceDetail::is_eyeglasses_Valid() const{
    return m_eyeglasses_isValid;
}

OAIFaceDetail_Sunglasses OAIFaceDetail::getSunglasses() const {
    return m_sunglasses;
}
void OAIFaceDetail::setSunglasses(const OAIFaceDetail_Sunglasses &sunglasses) {
    m_sunglasses = sunglasses;
    m_sunglasses_isSet = true;
}

bool OAIFaceDetail::is_sunglasses_Set() const{
    return m_sunglasses_isSet;
}

bool OAIFaceDetail::is_sunglasses_Valid() const{
    return m_sunglasses_isValid;
}

OAIFaceDetail_Gender OAIFaceDetail::getGender() const {
    return m_gender;
}
void OAIFaceDetail::setGender(const OAIFaceDetail_Gender &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIFaceDetail::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIFaceDetail::is_gender_Valid() const{
    return m_gender_isValid;
}

OAIFaceDetail_Beard OAIFaceDetail::getBeard() const {
    return m_beard;
}
void OAIFaceDetail::setBeard(const OAIFaceDetail_Beard &beard) {
    m_beard = beard;
    m_beard_isSet = true;
}

bool OAIFaceDetail::is_beard_Set() const{
    return m_beard_isSet;
}

bool OAIFaceDetail::is_beard_Valid() const{
    return m_beard_isValid;
}

OAIFaceDetail_Mustache OAIFaceDetail::getMustache() const {
    return m_mustache;
}
void OAIFaceDetail::setMustache(const OAIFaceDetail_Mustache &mustache) {
    m_mustache = mustache;
    m_mustache_isSet = true;
}

bool OAIFaceDetail::is_mustache_Set() const{
    return m_mustache_isSet;
}

bool OAIFaceDetail::is_mustache_Valid() const{
    return m_mustache_isValid;
}

OAIFaceDetail_EyesOpen OAIFaceDetail::getEyesOpen() const {
    return m_eyes_open;
}
void OAIFaceDetail::setEyesOpen(const OAIFaceDetail_EyesOpen &eyes_open) {
    m_eyes_open = eyes_open;
    m_eyes_open_isSet = true;
}

bool OAIFaceDetail::is_eyes_open_Set() const{
    return m_eyes_open_isSet;
}

bool OAIFaceDetail::is_eyes_open_Valid() const{
    return m_eyes_open_isValid;
}

OAIFaceDetail_MouthOpen OAIFaceDetail::getMouthOpen() const {
    return m_mouth_open;
}
void OAIFaceDetail::setMouthOpen(const OAIFaceDetail_MouthOpen &mouth_open) {
    m_mouth_open = mouth_open;
    m_mouth_open_isSet = true;
}

bool OAIFaceDetail::is_mouth_open_Set() const{
    return m_mouth_open_isSet;
}

bool OAIFaceDetail::is_mouth_open_Valid() const{
    return m_mouth_open_isValid;
}

QList OAIFaceDetail::getEmotions() const {
    return m_emotions;
}
void OAIFaceDetail::setEmotions(const QList &emotions) {
    m_emotions = emotions;
    m_emotions_isSet = true;
}

bool OAIFaceDetail::is_emotions_Set() const{
    return m_emotions_isSet;
}

bool OAIFaceDetail::is_emotions_Valid() const{
    return m_emotions_isValid;
}

QList OAIFaceDetail::getLandmarks() const {
    return m_landmarks;
}
void OAIFaceDetail::setLandmarks(const QList &landmarks) {
    m_landmarks = landmarks;
    m_landmarks_isSet = true;
}

bool OAIFaceDetail::is_landmarks_Set() const{
    return m_landmarks_isSet;
}

bool OAIFaceDetail::is_landmarks_Valid() const{
    return m_landmarks_isValid;
}

OAIFaceDetail_Pose OAIFaceDetail::getPose() const {
    return m_pose;
}
void OAIFaceDetail::setPose(const OAIFaceDetail_Pose &pose) {
    m_pose = pose;
    m_pose_isSet = true;
}

bool OAIFaceDetail::is_pose_Set() const{
    return m_pose_isSet;
}

bool OAIFaceDetail::is_pose_Valid() const{
    return m_pose_isValid;
}

OAIFaceDetail_Quality OAIFaceDetail::getQuality() const {
    return m_quality;
}
void OAIFaceDetail::setQuality(const OAIFaceDetail_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIFaceDetail::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIFaceDetail::is_quality_Valid() const{
    return m_quality_isValid;
}

float OAIFaceDetail::getConfidence() const {
    return m_confidence;
}
void OAIFaceDetail::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceDetail::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceDetail::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAIFaceDetail_FaceOccluded OAIFaceDetail::getFaceOccluded() const {
    return m_face_occluded;
}
void OAIFaceDetail::setFaceOccluded(const OAIFaceDetail_FaceOccluded &face_occluded) {
    m_face_occluded = face_occluded;
    m_face_occluded_isSet = true;
}

bool OAIFaceDetail::is_face_occluded_Set() const{
    return m_face_occluded_isSet;
}

bool OAIFaceDetail::is_face_occluded_Valid() const{
    return m_face_occluded_isValid;
}

OAIFaceDetail_EyeDirection OAIFaceDetail::getEyeDirection() const {
    return m_eye_direction;
}
void OAIFaceDetail::setEyeDirection(const OAIFaceDetail_EyeDirection &eye_direction) {
    m_eye_direction = eye_direction;
    m_eye_direction_isSet = true;
}

bool OAIFaceDetail::is_eye_direction_Set() const{
    return m_eye_direction_isSet;
}

bool OAIFaceDetail::is_eye_direction_Valid() const{
    return m_eye_direction_isValid;
}

bool OAIFaceDetail::isSet() const {
...
bool OAIFaceDetail::isValid() const {
