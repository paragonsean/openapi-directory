...
/*
 * OAIFaceDetail_MouthOpen.h
 *
 * 
 */

#ifndef OAIFaceDetail_MouthOpen_H
#define OAIFaceDetail_MouthOpen_H
...
class OAIFaceDetail_MouthOpen : public OAIObject {
public:
    OAIFaceDetail_MouthOpen();
    OAIFaceDetail_MouthOpen(QString json);
    ~OAIFaceDetail_MouthOpen() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_MouthOpen)

#endif // OAIFaceDetail_MouthOpen_H
