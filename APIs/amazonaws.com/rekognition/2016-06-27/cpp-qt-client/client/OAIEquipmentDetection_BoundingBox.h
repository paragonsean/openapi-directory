...
/*
 * OAIEquipmentDetection_BoundingBox.h
 *
 * 
 */

#ifndef OAIEquipmentDetection_BoundingBox_H
#define OAIEquipmentDetection_BoundingBox_H
...
class OAIEquipmentDetection_BoundingBox : public OAIObject {
public:
    OAIEquipmentDetection_BoundingBox();
    OAIEquipmentDetection_BoundingBox(QString json);
    ~OAIEquipmentDetection_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEquipmentDetection_BoundingBox)

#endif // OAIEquipmentDetection_BoundingBox_H
