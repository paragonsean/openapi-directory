...
/*
 * OAIStreamProcessorDataSharingPreference.h
 *
...
#ifndef OAIStreamProcessorDataSharingPreference_H
#define OAIStreamProcessorDataSharingPreference_H
...
class OAIStreamProcessorDataSharingPreference : public OAIObject {
public:
    OAIStreamProcessorDataSharingPreference();
    OAIStreamProcessorDataSharingPreference(QString json);
    ~OAIStreamProcessorDataSharingPreference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorDataSharingPreference)

#endif // OAIStreamProcessorDataSharingPreference_H
