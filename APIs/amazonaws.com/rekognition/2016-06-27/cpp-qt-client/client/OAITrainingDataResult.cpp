...
#include "OAITrainingDataResult.h"
...
OAITrainingDataResult::OAITrainingDataResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrainingDataResult::OAITrainingDataResult() {
    this->initializeModel();
}

OAITrainingDataResult::~OAITrainingDataResult() {}

void OAITrainingDataResult::initializeModel() {
...
void OAITrainingDataResult::fromJson(QString jsonString) {
...
void OAITrainingDataResult::fromJsonObject(QJsonObject json) {
...
QString OAITrainingDataResult::asJson() const {
...
QJsonObject OAITrainingDataResult::asJsonObject() const {
    QJsonObject obj;
    if (m_input.isSet()) {
...
OAITrainingDataResult_Input OAITrainingDataResult::getInput() const {
    return m_input;
}
void OAITrainingDataResult::setInput(const OAITrainingDataResult_Input &input) {
    m_input = input;
    m_input_isSet = true;
}

bool OAITrainingDataResult::is_input_Set() const{
    return m_input_isSet;
}

bool OAITrainingDataResult::is_input_Valid() const{
    return m_input_isValid;
}

OAITrainingDataResult_Output OAITrainingDataResult::getOutput() const {
    return m_output;
}
void OAITrainingDataResult::setOutput(const OAITrainingDataResult_Output &output) {
    m_output = output;
    m_output_isSet = true;
}

bool OAITrainingDataResult::is_output_Set() const{
    return m_output_isSet;
}

bool OAITrainingDataResult::is_output_Valid() const{
    return m_output_isValid;
}

OAITrainingDataResult_Validation OAITrainingDataResult::getValidation() const {
    return m_validation;
}
void OAITrainingDataResult::setValidation(const OAITrainingDataResult_Validation &validation) {
    m_validation = validation;
    m_validation_isSet = true;
}

bool OAITrainingDataResult::is_validation_Set() const{
    return m_validation_isSet;
}

bool OAITrainingDataResult::is_validation_Valid() const{
    return m_validation_isValid;
}

bool OAITrainingDataResult::isSet() const {
...
bool OAITrainingDataResult::isValid() const {
