...
/*
 * OAIProjectVersionStatus.h
 *
 * 
 */

#ifndef OAIProjectVersionStatus_H
#define OAIProjectVersionStatus_H
...
class OAIProjectVersionStatus : public OAIEnum {
public:
    OAIProjectVersionStatus();
    OAIProjectVersionStatus(QString json);
    ~OAIProjectVersionStatus() override;
    ...
    enum class eOAIProjectVersionStatus {
    ...
    OAIProjectVersionStatus::eOAIProjectVersionStatus getValue() const;
    void setValue(const OAIProjectVersionStatus::eOAIProjectVersionStatus& value);
...
private:
    ...
    eOAIProjectVersionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectVersionStatus)

#endif // OAIProjectVersionStatus_H
