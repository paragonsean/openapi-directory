...
OAIKnownGenderType::OAIKnownGenderType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKnownGenderType::OAIKnownGenderType() {
    this->initializeModel();
}

OAIKnownGenderType::~OAIKnownGenderType() {}

void OAIKnownGenderType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIKnownGenderType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIKnownGenderType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Male", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKnownGenderType::MALE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Female", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKnownGenderType::FEMALE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Nonbinary", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKnownGenderType::NONBINARY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Unlisted", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKnownGenderType::UNLISTED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIKnownGenderType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIKnownGenderType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIKnownGenderType::MALE:
            val = "Male";
            break;
        case eOAIKnownGenderType::FEMALE:
            val = "Female";
            break;
        case eOAIKnownGenderType::NONBINARY:
            val = "Nonbinary";
            break;
        case eOAIKnownGenderType::UNLISTED:
            val = "Unlisted";
            break;
        default:
            break;
...
QJsonValue OAIKnownGenderType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIKnownGenderType::eOAIKnownGenderType OAIKnownGenderType::getValue() const {
    return m_value;
}

void OAIKnownGenderType::setValue(const OAIKnownGenderType::eOAIKnownGenderType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIKnownGenderType::isSet() const {
    
    return m_value_isSet;
}

bool OAIKnownGenderType::isValid() const {
