...
#include "OAIStartPersonTrackingRequest.h"
...
OAIStartPersonTrackingRequest::OAIStartPersonTrackingRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartPersonTrackingRequest::OAIStartPersonTrackingRequest() {
    this->initializeModel();
}

OAIStartPersonTrackingRequest::~OAIStartPersonTrackingRequest() {}

void OAIStartPersonTrackingRequest::initializeModel() {
...
void OAIStartPersonTrackingRequest::fromJson(QString jsonString) {
...
void OAIStartPersonTrackingRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartPersonTrackingRequest::asJson() const {
...
QJsonObject OAIStartPersonTrackingRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_video.isSet()) {
...
OAIStartPersonTrackingRequest_Video OAIStartPersonTrackingRequest::getVideo() const {
    return m_video;
}
void OAIStartPersonTrackingRequest::setVideo(const OAIStartPersonTrackingRequest_Video &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIStartPersonTrackingRequest::is_video_Set() const{
    return m_video_isSet;
}

bool OAIStartPersonTrackingRequest::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIStartPersonTrackingRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIStartPersonTrackingRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIStartPersonTrackingRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIStartPersonTrackingRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAIStartPersonTrackingRequest_NotificationChannel OAIStartPersonTrackingRequest::getNotificationChannel() const {
    return m_notification_channel;
}
void OAIStartPersonTrackingRequest::setNotificationChannel(const OAIStartPersonTrackingRequest_NotificationChannel &notification_channel) {
    m_notification_channel = notification_channel;
    m_notification_channel_isSet = true;
}

bool OAIStartPersonTrackingRequest::is_notification_channel_Set() const{
    return m_notification_channel_isSet;
}

bool OAIStartPersonTrackingRequest::is_notification_channel_Valid() const{
    return m_notification_channel_isValid;
}

QString OAIStartPersonTrackingRequest::getJobTag() const {
    return m_job_tag;
}
void OAIStartPersonTrackingRequest::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIStartPersonTrackingRequest::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIStartPersonTrackingRequest::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIStartPersonTrackingRequest::isSet() const {
...
bool OAIStartPersonTrackingRequest::isValid() const {
