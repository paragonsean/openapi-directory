...
/*
 * OAIStartTextDetectionRequest.h
 *
 * 
 */

#ifndef OAIStartTextDetectionRequest_H
#define OAIStartTextDetectionRequest_H
...
class OAIStartTextDetectionRequest_Filters;

class OAIStartTextDetectionRequest : public OAIObject {
public:
    OAIStartTextDetectionRequest();
    OAIStartTextDetectionRequest(QString json);
    ~OAIStartTextDetectionRequest() override;
    ...
    OAIStartTextDetectionRequest_Filters getFilters() const;
    void setFilters(const OAIStartTextDetectionRequest_Filters &filters);
...
private:
    ...
    OAIStartTextDetectionRequest_Filters m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTextDetectionRequest)

#endif // OAIStartTextDetectionRequest_H
