...
class OAIProjectDescription : public OAIObject {
public:
    OAIProjectDescription();
    OAIProjectDescription(QString json);
    ~OAIProjectDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectDescription)

#endif // OAIProjectDescription_H
