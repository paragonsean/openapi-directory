...
#include "OAIDetectModerationLabelsResponse.h"
...
OAIDetectModerationLabelsResponse::OAIDetectModerationLabelsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectModerationLabelsResponse::OAIDetectModerationLabelsResponse() {
    this->initializeModel();
}

OAIDetectModerationLabelsResponse::~OAIDetectModerationLabelsResponse() {}

void OAIDetectModerationLabelsResponse::initializeModel() {

    m_moderation_labels_isSet = false;
    m_moderation_labels_isValid = false;

    m_moderation_model_version_isSet = false;
    m_moderation_model_version_isValid = false;

    m_human_loop_activation_output_isSet = false;
    m_human_loop_activation_output_isValid = false;
}

void OAIDetectModerationLabelsResponse::fromJson(QString jsonString) {
...
void OAIDetectModerationLabelsResponse::fromJsonObject(QJsonObject json) {

    m_moderation_labels_isValid = ::OpenAPI::fromJsonValue(m_moderation_labels, json[QString("ModerationLabels")]);
    m_moderation_labels_isSet = !json[QString("ModerationLabels")].isNull() && m_moderation_labels_isValid;

    m_moderation_model_version_isValid = ::OpenAPI::fromJsonValue(m_moderation_model_version, json[QString("ModerationModelVersion")]);
    m_moderation_model_version_isSet = !json[QString("ModerationModelVersion")].isNull() && m_moderation_model_version_isValid;
...
QString OAIDetectModerationLabelsResponse::asJson() const {
...
QJsonObject OAIDetectModerationLabelsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_moderation_labels.isSet()) {
        obj.insert(QString("ModerationLabels"), ::OpenAPI::toJsonValue(m_moderation_labels));
    }
    if (m_moderation_model_version_isSet) {
        obj.insert(QString("ModerationModelVersion"), ::OpenAPI::toJsonValue(m_moderation_model_version));
    }
...
QList OAIDetectModerationLabelsResponse::getModerationLabels() const {
    return m_moderation_labels;
}
void OAIDetectModerationLabelsResponse::setModerationLabels(const QList &moderation_labels) {
    m_moderation_labels = moderation_labels;
    m_moderation_labels_isSet = true;
}

bool OAIDetectModerationLabelsResponse::is_moderation_labels_Set() const{
    return m_moderation_labels_isSet;
}

bool OAIDetectModerationLabelsResponse::is_moderation_labels_Valid() const{
    return m_moderation_labels_isValid;
}

QString OAIDetectModerationLabelsResponse::getModerationModelVersion() const {
    return m_moderation_model_version;
}
void OAIDetectModerationLabelsResponse::setModerationModelVersion(const QString &moderation_model_version) {
    m_moderation_model_version = moderation_model_version;
    m_moderation_model_version_isSet = true;
}

bool OAIDetectModerationLabelsResponse::is_moderation_model_version_Set() const{
    return m_moderation_model_version_isSet;
}

bool OAIDetectModerationLabelsResponse::is_moderation_model_version_Valid() const{
    return m_moderation_model_version_isValid;
}

OAIDetectModerationLabelsResponse_HumanLoopActivationOutput OAIDetectModerationLabelsResponse::getHumanLoopActivationOutput() const {
    return m_human_loop_activation_output;
}
void OAIDetectModerationLabelsResponse::setHumanLoopActivationOutput(const OAIDetectModerationLabelsResponse_HumanLoopActivationOutput &human_loop_activation_output) {
    m_human_loop_activation_output = human_loop_activation_output;
    m_human_loop_activation_output_isSet = true;
}

bool OAIDetectModerationLabelsResponse::is_human_loop_activation_output_Set() const{
    return m_human_loop_activation_output_isSet;
}

bool OAIDetectModerationLabelsResponse::is_human_loop_activation_output_Valid() const{
    return m_human_loop_activation_output_isValid;
}

bool OAIDetectModerationLabelsResponse::isSet() const {
...
bool OAIDetectModerationLabelsResponse::isValid() const {
