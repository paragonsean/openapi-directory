...
/*
 * OAIComparedFace_Smile.h
 *
 * 
 */

#ifndef OAIComparedFace_Smile_H
#define OAIComparedFace_Smile_H
...
class OAIComparedFace_Smile : public OAIObject {
public:
    OAIComparedFace_Smile();
    OAIComparedFace_Smile(QString json);
    ~OAIComparedFace_Smile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComparedFace_Smile)

#endif // OAIComparedFace_Smile_H
