...
#include "OAIDetectLabelsRequest_Settings.h"
...
OAIDetectLabelsRequest_Settings::OAIDetectLabelsRequest_Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsRequest_Settings::OAIDetectLabelsRequest_Settings() {
    this->initializeModel();
}

OAIDetectLabelsRequest_Settings::~OAIDetectLabelsRequest_Settings() {}

void OAIDetectLabelsRequest_Settings::initializeModel() {

    m_general_labels_isSet = false;
    m_general_labels_isValid = false;

    m_image_properties_isSet = false;
    m_image_properties_isValid = false;
}

void OAIDetectLabelsRequest_Settings::fromJson(QString jsonString) {
...
void OAIDetectLabelsRequest_Settings::fromJsonObject(QJsonObject json) {

    m_general_labels_isValid = ::OpenAPI::fromJsonValue(m_general_labels, json[QString("GeneralLabels")]);
    m_general_labels_isSet = !json[QString("GeneralLabels")].isNull() && m_general_labels_isValid;
...
QString OAIDetectLabelsRequest_Settings::asJson() const {
...
QJsonObject OAIDetectLabelsRequest_Settings::asJsonObject() const {
    QJsonObject obj;
    if (m_general_labels.isSet()) {
        obj.insert(QString("GeneralLabels"), ::OpenAPI::toJsonValue(m_general_labels));
    }
...
OAIDetectLabelsSettings_GeneralLabels OAIDetectLabelsRequest_Settings::getGeneralLabels() const {
    return m_general_labels;
}
void OAIDetectLabelsRequest_Settings::setGeneralLabels(const OAIDetectLabelsSettings_GeneralLabels &general_labels) {
    m_general_labels = general_labels;
    m_general_labels_isSet = true;
}

bool OAIDetectLabelsRequest_Settings::is_general_labels_Set() const{
    return m_general_labels_isSet;
}

bool OAIDetectLabelsRequest_Settings::is_general_labels_Valid() const{
    return m_general_labels_isValid;
}

OAIDetectLabelsSettings_ImageProperties OAIDetectLabelsRequest_Settings::getImageProperties() const {
    return m_image_properties;
}
void OAIDetectLabelsRequest_Settings::setImageProperties(const OAIDetectLabelsSettings_ImageProperties &image_properties) {
    m_image_properties = image_properties;
    m_image_properties_isSet = true;
}

bool OAIDetectLabelsRequest_Settings::is_image_properties_Set() const{
    return m_image_properties_isSet;
}

bool OAIDetectLabelsRequest_Settings::is_image_properties_Valid() const{
    return m_image_properties_isValid;
}

bool OAIDetectLabelsRequest_Settings::isSet() const {
...
bool OAIDetectLabelsRequest_Settings::isValid() const {
