...
/*
 * OAICompareFacesRequest_SourceImage.h
 *
 * 
 */

#ifndef OAICompareFacesRequest_SourceImage_H
#define OAICompareFacesRequest_SourceImage_H

#include <QJsonObject>

#include "OAIImage_S3Object.h"
#include <QString>
...
namespace OpenAPI {
class OAIImage_S3Object;

class OAICompareFacesRequest_SourceImage : public OAIObject {
public:
    OAICompareFacesRequest_SourceImage();
    OAICompareFacesRequest_SourceImage(QString json);
    ~OAICompareFacesRequest_SourceImage() override;
    ...
    OAIImage_S3Object getS3Object() const;
    void setS3Object(const OAIImage_S3Object &s3_object);
...
Q_DECLARE_METATYPE(OpenAPI::OAICompareFacesRequest_SourceImage)

#endif // OAICompareFacesRequest_SourceImage_H
