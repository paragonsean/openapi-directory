...
OAITestingData::OAITestingData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestingData::OAITestingData() {
    this->initializeModel();
}

OAITestingData::~OAITestingData() {}

void OAITestingData::initializeModel() {
...
void OAITestingData::fromJson(QString jsonString) {
...
void OAITestingData::fromJsonObject(QJsonObject json) {
...
QString OAITestingData::asJson() const {
...
QJsonObject OAITestingData::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAITestingData::getAssets() const {
    return m_assets;
}
void OAITestingData::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAITestingData::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAITestingData::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAITestingData::getAutoCreate() const {
    return m_auto_create;
}
void OAITestingData::setAutoCreate(const bool &auto_create) {
    m_auto_create = auto_create;
    m_auto_create_isSet = true;
}

bool OAITestingData::is_auto_create_Set() const{
    return m_auto_create_isSet;
}

bool OAITestingData::is_auto_create_Valid() const{
    return m_auto_create_isValid;
}

bool OAITestingData::isSet() const {
...
bool OAITestingData::isValid() const {
