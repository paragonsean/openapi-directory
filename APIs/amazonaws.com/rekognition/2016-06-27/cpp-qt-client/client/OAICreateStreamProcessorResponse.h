...
/*
 * OAICreateStreamProcessorResponse.h
 *
 * 
 */

#ifndef OAICreateStreamProcessorResponse_H
#define OAICreateStreamProcessorResponse_H
...
class OAICreateStreamProcessorResponse : public OAIObject {
public:
    OAICreateStreamProcessorResponse();
    OAICreateStreamProcessorResponse(QString json);
    ~OAICreateStreamProcessorResponse() override;
    ...
    QString getStreamProcessorArn() const;
    void setStreamProcessorArn(const QString &stream_processor_arn);
    bool is_stream_processor_arn_Set() const;
    bool is_stream_processor_arn_Valid() const;
...
private:
    ...
    QString m_stream_processor_arn;
    bool m_stream_processor_arn_isSet;
    bool m_stream_processor_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamProcessorResponse)

#endif // OAICreateStreamProcessorResponse_H
