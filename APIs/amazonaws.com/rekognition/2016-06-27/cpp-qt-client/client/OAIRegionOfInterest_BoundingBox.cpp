...
#include "OAIRegionOfInterest_BoundingBox.h"
...
OAIRegionOfInterest_BoundingBox::OAIRegionOfInterest_BoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegionOfInterest_BoundingBox::OAIRegionOfInterest_BoundingBox() {
    this->initializeModel();
}

OAIRegionOfInterest_BoundingBox::~OAIRegionOfInterest_BoundingBox() {}

void OAIRegionOfInterest_BoundingBox::initializeModel() {
...
void OAIRegionOfInterest_BoundingBox::fromJson(QString jsonString) {
...
void OAIRegionOfInterest_BoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAIRegionOfInterest_BoundingBox::asJson() const {
...
QJsonObject OAIRegionOfInterest_BoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAIRegionOfInterest_BoundingBox::getWidth() const {
    return m_width;
}
void OAIRegionOfInterest_BoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIRegionOfInterest_BoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAIRegionOfInterest_BoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAIRegionOfInterest_BoundingBox::getHeight() const {
    return m_height;
}
void OAIRegionOfInterest_BoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIRegionOfInterest_BoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAIRegionOfInterest_BoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAIRegionOfInterest_BoundingBox::getLeft() const {
    return m_left;
}
void OAIRegionOfInterest_BoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIRegionOfInterest_BoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAIRegionOfInterest_BoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAIRegionOfInterest_BoundingBox::getTop() const {
    return m_top;
}
void OAIRegionOfInterest_BoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIRegionOfInterest_BoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAIRegionOfInterest_BoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAIRegionOfInterest_BoundingBox::isSet() const {
...
bool OAIRegionOfInterest_BoundingBox::isValid() const {
