...
#include "OAICreateStreamProcessorRequest_Input.h"
...
OAICreateStreamProcessorRequest_Input::OAICreateStreamProcessorRequest_Input(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamProcessorRequest_Input::OAICreateStreamProcessorRequest_Input() {
    this->initializeModel();
}

OAICreateStreamProcessorRequest_Input::~OAICreateStreamProcessorRequest_Input() {}

void OAICreateStreamProcessorRequest_Input::initializeModel() {

    m_kinesis_video_stream_isSet = false;
    m_kinesis_video_stream_isValid = false;
}

void OAICreateStreamProcessorRequest_Input::fromJson(QString jsonString) {
...
void OAICreateStreamProcessorRequest_Input::fromJsonObject(QJsonObject json) {
...
QString OAICreateStreamProcessorRequest_Input::asJson() const {
...
QJsonObject OAICreateStreamProcessorRequest_Input::asJsonObject() const {
    QJsonObject obj;
...
OAIStreamProcessorInput_KinesisVideoStream OAICreateStreamProcessorRequest_Input::getKinesisVideoStream() const {
    return m_kinesis_video_stream;
}
void OAICreateStreamProcessorRequest_Input::setKinesisVideoStream(const OAIStreamProcessorInput_KinesisVideoStream &kinesis_video_stream) {
    m_kinesis_video_stream = kinesis_video_stream;
    m_kinesis_video_stream_isSet = true;
}

bool OAICreateStreamProcessorRequest_Input::is_kinesis_video_stream_Set() const{
    return m_kinesis_video_stream_isSet;
}

bool OAICreateStreamProcessorRequest_Input::is_kinesis_video_stream_Valid() const{
    return m_kinesis_video_stream_isValid;
}

bool OAICreateStreamProcessorRequest_Input::isSet() const {
...
bool OAICreateStreamProcessorRequest_Input::isValid() const {
