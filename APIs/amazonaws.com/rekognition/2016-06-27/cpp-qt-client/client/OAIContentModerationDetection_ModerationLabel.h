...
/*
 * OAIContentModerationDetection_ModerationLabel.h
 *
 * 
 */

#ifndef OAIContentModerationDetection_ModerationLabel_H
#define OAIContentModerationDetection_ModerationLabel_H
...
class OAIContentModerationDetection_ModerationLabel : public OAIObject {
public:
    OAIContentModerationDetection_ModerationLabel();
    OAIContentModerationDetection_ModerationLabel(QString json);
    ~OAIContentModerationDetection_ModerationLabel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentModerationDetection_ModerationLabel)

#endif // OAIContentModerationDetection_ModerationLabel_H
