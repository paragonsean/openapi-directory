...
/*
 * OAIStartFaceDetectionResponse.h
 *
 * 
 */

#ifndef OAIStartFaceDetectionResponse_H
#define OAIStartFaceDetectionResponse_H
...
class OAIStartFaceDetectionResponse : public OAIObject {
public:
    OAIStartFaceDetectionResponse();
    OAIStartFaceDetectionResponse(QString json);
    ~OAIStartFaceDetectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceDetectionResponse)

#endif // OAIStartFaceDetectionResponse_H
