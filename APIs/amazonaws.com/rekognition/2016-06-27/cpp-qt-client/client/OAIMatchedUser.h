...
#ifndef OAIMatchedUser_H
#define OAIMatchedUser_H
...
class OAIMatchedUser : public OAIObject {
public:
    OAIMatchedUser();
    OAIMatchedUser(QString json);
    ~OAIMatchedUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchedUser)

#endif // OAIMatchedUser_H
