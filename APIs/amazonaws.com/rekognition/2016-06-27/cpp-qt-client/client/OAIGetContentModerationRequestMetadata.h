...
/*
 * OAIGetContentModerationRequestMetadata.h
 *
 * Contains metadata about a content moderation request, including the SortBy and AggregateBy options.
 */

#ifndef OAIGetContentModerationRequestMetadata_H
#define OAIGetContentModerationRequestMetadata_H
...
class OAIGetContentModerationRequestMetadata : public OAIObject {
public:
    OAIGetContentModerationRequestMetadata();
    OAIGetContentModerationRequestMetadata(QString json);
    ~OAIGetContentModerationRequestMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetContentModerationRequestMetadata)

#endif // OAIGetContentModerationRequestMetadata_H
