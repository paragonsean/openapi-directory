...
/*
 * OAIGetCelebrityRecognitionResponse.h
 *
 * 
 */

#ifndef OAIGetCelebrityRecognitionResponse_H
#define OAIGetCelebrityRecognitionResponse_H

#include <QJsonObject>

#include "OAIGetCelebrityRecognitionResponse_VideoMetadata.h"
#include "OAIVideo.h"
...
namespace OpenAPI {
class OAIGetCelebrityRecognitionResponse_VideoMetadata;
class OAIVideo;

class OAIGetCelebrityRecognitionResponse : public OAIObject {
public:
    OAIGetCelebrityRecognitionResponse();
    OAIGetCelebrityRecognitionResponse(QString json);
    ~OAIGetCelebrityRecognitionResponse() override;
    ...
    OAIGetCelebrityRecognitionResponse_VideoMetadata getVideoMetadata() const;
    void setVideoMetadata(const OAIGetCelebrityRecognitionResponse_VideoMetadata &video_metadata);
    ...
    QList getCelebrities() const;
    void setCelebrities(const QList &celebrities);
...
private:
    ...
    OAIGetCelebrityRecognitionResponse_VideoMetadata m_video_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCelebrityRecognitionResponse)

#endif // OAIGetCelebrityRecognitionResponse_H
