...
OAIGenderType::OAIGenderType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenderType::OAIGenderType() {
    this->initializeModel();
}

OAIGenderType::~OAIGenderType() {}

void OAIGenderType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGenderType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGenderType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Male", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGenderType::MALE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Female", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGenderType::FEMALE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGenderType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGenderType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGenderType::MALE:
            val = "Male";
            break;
        case eOAIGenderType::FEMALE:
            val = "Female";
            break;
        default:
            break;
...
QJsonValue OAIGenderType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGenderType::eOAIGenderType OAIGenderType::getValue() const {
    return m_value;
}

void OAIGenderType::setValue(const OAIGenderType::eOAIGenderType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGenderType::isSet() const {
    
    return m_value_isSet;
}

bool OAIGenderType::isValid() const {
