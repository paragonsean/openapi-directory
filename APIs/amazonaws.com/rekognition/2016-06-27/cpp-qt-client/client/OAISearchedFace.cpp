...
OAISearchedFace::OAISearchedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchedFace::OAISearchedFace() {
    this->initializeModel();
}

OAISearchedFace::~OAISearchedFace() {}

void OAISearchedFace::initializeModel() {

    m_face_id_isSet = false;
    m_face_id_isValid = false;
}

void OAISearchedFace::fromJson(QString jsonString) {
...
void OAISearchedFace::fromJsonObject(QJsonObject json) {
...
QString OAISearchedFace::asJson() const {
...
QJsonObject OAISearchedFace::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
...
QString OAISearchedFace::getFaceId() const {
    return m_face_id;
}
void OAISearchedFace::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAISearchedFace::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAISearchedFace::is_face_id_Valid() const{
    return m_face_id_isValid;
}

bool OAISearchedFace::isSet() const {
...
bool OAISearchedFace::isValid() const {
