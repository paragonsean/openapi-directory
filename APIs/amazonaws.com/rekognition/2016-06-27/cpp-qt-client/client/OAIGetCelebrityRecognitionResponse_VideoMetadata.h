...
/*
 * OAIGetCelebrityRecognitionResponse_VideoMetadata.h
 *
 * 
 */

#ifndef OAIGetCelebrityRecognitionResponse_VideoMetadata_H
#define OAIGetCelebrityRecognitionResponse_VideoMetadata_H
...
class OAIGetCelebrityRecognitionResponse_VideoMetadata : public OAIObject {
public:
    OAIGetCelebrityRecognitionResponse_VideoMetadata();
    OAIGetCelebrityRecognitionResponse_VideoMetadata(QString json);
    ~OAIGetCelebrityRecognitionResponse_VideoMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCelebrityRecognitionResponse_VideoMetadata)

#endif // OAIGetCelebrityRecognitionResponse_VideoMetadata_H
