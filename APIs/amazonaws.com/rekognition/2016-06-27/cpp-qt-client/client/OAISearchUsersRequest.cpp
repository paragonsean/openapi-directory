...
#include "OAISearchUsersRequest.h"
...
OAISearchUsersRequest::OAISearchUsersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchUsersRequest::OAISearchUsersRequest() {
    this->initializeModel();
}

OAISearchUsersRequest::~OAISearchUsersRequest() {}

void OAISearchUsersRequest::initializeModel() {
    ...
    m_user_match_threshold_isSet = false;
    m_user_match_threshold_isValid = false;

    m_max_users_isSet = false;
    m_max_users_isValid = false;
}

void OAISearchUsersRequest::fromJson(QString jsonString) {
...
void OAISearchUsersRequest::fromJsonObject(QJsonObject json) {
    ...
    m_user_match_threshold_isValid = ::OpenAPI::fromJsonValue(m_user_match_threshold, json[QString("UserMatchThreshold")]);
    m_user_match_threshold_isSet = !json[QString("UserMatchThreshold")].isNull() && m_user_match_threshold_isValid;
...
QString OAISearchUsersRequest::asJson() const {
...
QJsonObject OAISearchUsersRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_user_match_threshold_isSet) {
        obj.insert(QString("UserMatchThreshold"), ::OpenAPI::toJsonValue(m_user_match_threshold));
    }
...
QString OAISearchUsersRequest::getCollectionId() const {
    return m_collection_id;
}
void OAISearchUsersRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAISearchUsersRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAISearchUsersRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAISearchUsersRequest::getUserId() const {
    return m_user_id;
}
void OAISearchUsersRequest::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAISearchUsersRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAISearchUsersRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAISearchUsersRequest::getFaceId() const {
    return m_face_id;
}
void OAISearchUsersRequest::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAISearchUsersRequest::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAISearchUsersRequest::is_face_id_Valid() const{
    return m_face_id_isValid;
}

float OAISearchUsersRequest::getUserMatchThreshold() const {
    return m_user_match_threshold;
}
void OAISearchUsersRequest::setUserMatchThreshold(const float &user_match_threshold) {
    m_user_match_threshold = user_match_threshold;
    m_user_match_threshold_isSet = true;
}

bool OAISearchUsersRequest::is_user_match_threshold_Set() const{
    return m_user_match_threshold_isSet;
}

bool OAISearchUsersRequest::is_user_match_threshold_Valid() const{
    return m_user_match_threshold_isValid;
}

qint32 OAISearchUsersRequest::getMaxUsers() const {
    return m_max_users;
}
void OAISearchUsersRequest::setMaxUsers(const qint32 &max_users) {
    m_max_users = max_users;
    m_max_users_isSet = true;
}

bool OAISearchUsersRequest::is_max_users_Set() const{
    return m_max_users_isSet;
}

bool OAISearchUsersRequest::is_max_users_Valid() const{
    return m_max_users_isValid;
}

bool OAISearchUsersRequest::isSet() const {
...
bool OAISearchUsersRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_collection_id_isValid && true;
}
