...
#ifndef OAILabelDetection_H
#define OAILabelDetection_H

#include <QJsonObject>

#include "OAILabelDetection_Label.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAILabelDetection_Label;

class OAILabelDetection : public OAIObject {
public:
    OAILabelDetection();
    OAILabelDetection(QString json);
    ~OAILabelDetection() override;
    ...
    OAILabelDetection_Label getLabel() const;
    void setLabel(const OAILabelDetection_Label &label);
    bool is_label_Set() const;
    bool is_label_Valid() const;

    qint32 getStartTimestampMillis() const;
    void setStartTimestampMillis(const qint32 &start_timestamp_millis);
    bool is_start_timestamp_millis_Set() const;
    bool is_start_timestamp_millis_Valid() const;

    qint32 getEndTimestampMillis() const;
    void setEndTimestampMillis(const qint32 &end_timestamp_millis);
    bool is_end_timestamp_millis_Set() const;
    bool is_end_timestamp_millis_Valid() const;
...
private:
    ...
    OAILabelDetection_Label m_label;
    bool m_label_isSet;
    bool m_label_isValid;

    qint32 m_start_timestamp_millis;
    bool m_start_timestamp_millis_isSet;
    bool m_start_timestamp_millis_isValid;

    qint32 m_end_timestamp_millis;
    bool m_end_timestamp_millis_isSet;
    bool m_end_timestamp_millis_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelDetection)

#endif // OAILabelDetection_H
