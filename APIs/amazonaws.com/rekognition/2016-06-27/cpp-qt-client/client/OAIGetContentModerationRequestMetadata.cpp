...
#include "OAIGetContentModerationRequestMetadata.h"
...
OAIGetContentModerationRequestMetadata::OAIGetContentModerationRequestMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetContentModerationRequestMetadata::OAIGetContentModerationRequestMetadata() {
    this->initializeModel();
}

OAIGetContentModerationRequestMetadata::~OAIGetContentModerationRequestMetadata() {}

void OAIGetContentModerationRequestMetadata::initializeModel() {
...
void OAIGetContentModerationRequestMetadata::fromJson(QString jsonString) {
...
void OAIGetContentModerationRequestMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIGetContentModerationRequestMetadata::asJson() const {
...
QJsonObject OAIGetContentModerationRequestMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_sort_by.isSet()) {
...
OAIContentModerationSortBy OAIGetContentModerationRequestMetadata::getSortBy() const {
    return m_sort_by;
}
void OAIGetContentModerationRequestMetadata::setSortBy(const OAIContentModerationSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetContentModerationRequestMetadata::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetContentModerationRequestMetadata::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAIContentModerationAggregateBy OAIGetContentModerationRequestMetadata::getAggregateBy() const {
    return m_aggregate_by;
}
void OAIGetContentModerationRequestMetadata::setAggregateBy(const OAIContentModerationAggregateBy &aggregate_by) {
    m_aggregate_by = aggregate_by;
    m_aggregate_by_isSet = true;
}

bool OAIGetContentModerationRequestMetadata::is_aggregate_by_Set() const{
    return m_aggregate_by_isSet;
}

bool OAIGetContentModerationRequestMetadata::is_aggregate_by_Valid() const{
    return m_aggregate_by_isValid;
}

bool OAIGetContentModerationRequestMetadata::isSet() const {
...
bool OAIGetContentModerationRequestMetadata::isValid() const {
