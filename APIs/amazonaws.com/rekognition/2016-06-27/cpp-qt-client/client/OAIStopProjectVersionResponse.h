...
/*
 * OAIStopProjectVersionResponse.h
 *
 * 
 */

#ifndef OAIStopProjectVersionResponse_H
#define OAIStopProjectVersionResponse_H
...
class OAIStopProjectVersionResponse : public OAIObject {
public:
    OAIStopProjectVersionResponse();
    OAIStopProjectVersionResponse(QString json);
    ~OAIStopProjectVersionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopProjectVersionResponse)

#endif // OAIStopProjectVersionResponse_H
