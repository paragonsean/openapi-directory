...
#include "OAIConnectedHomeSettingsForUpdate.h"
...
OAIConnectedHomeSettingsForUpdate::OAIConnectedHomeSettingsForUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectedHomeSettingsForUpdate::OAIConnectedHomeSettingsForUpdate() {
    this->initializeModel();
}

OAIConnectedHomeSettingsForUpdate::~OAIConnectedHomeSettingsForUpdate() {}

void OAIConnectedHomeSettingsForUpdate::initializeModel() {
...
void OAIConnectedHomeSettingsForUpdate::fromJson(QString jsonString) {
...
void OAIConnectedHomeSettingsForUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIConnectedHomeSettingsForUpdate::asJson() const {
...
QJsonObject OAIConnectedHomeSettingsForUpdate::asJsonObject() const {
    QJsonObject obj;
    if (m_labels.isSet()) {
...
QList OAIConnectedHomeSettingsForUpdate::getLabels() const {
    return m_labels;
}
void OAIConnectedHomeSettingsForUpdate::setLabels(const QList &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIConnectedHomeSettingsForUpdate::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIConnectedHomeSettingsForUpdate::is_labels_Valid() const{
    return m_labels_isValid;
}

float OAIConnectedHomeSettingsForUpdate::getMinConfidence() const {
    return m_min_confidence;
}
void OAIConnectedHomeSettingsForUpdate::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIConnectedHomeSettingsForUpdate::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIConnectedHomeSettingsForUpdate::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

bool OAIConnectedHomeSettingsForUpdate::isSet() const {
...
bool OAIConnectedHomeSettingsForUpdate::isValid() const {
