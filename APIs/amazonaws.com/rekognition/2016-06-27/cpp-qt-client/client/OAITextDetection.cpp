...
OAITextDetection::OAITextDetection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITextDetection::OAITextDetection() {
    this->initializeModel();
}

OAITextDetection::~OAITextDetection() {}

void OAITextDetection::initializeModel() {
...
void OAITextDetection::fromJson(QString jsonString) {
...
void OAITextDetection::fromJsonObject(QJsonObject json) {
...
QString OAITextDetection::asJson() const {
...
QJsonObject OAITextDetection::asJsonObject() const {
    QJsonObject obj;
...
QString OAITextDetection::getDetectedText() const {
    return m_detected_text;
}
void OAITextDetection::setDetectedText(const QString &detected_text) {
    m_detected_text = detected_text;
    m_detected_text_isSet = true;
}

bool OAITextDetection::is_detected_text_Set() const{
    return m_detected_text_isSet;
}

bool OAITextDetection::is_detected_text_Valid() const{
    return m_detected_text_isValid;
}

OAITextTypes OAITextDetection::getType() const {
    return m_type;
}
void OAITextDetection::setType(const OAITextTypes &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAITextDetection::is_type_Set() const{
    return m_type_isSet;
}

bool OAITextDetection::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAITextDetection::getId() const {
    return m_id;
}
void OAITextDetection::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITextDetection::is_id_Set() const{
    return m_id_isSet;
}

bool OAITextDetection::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAITextDetection::getParentId() const {
    return m_parent_id;
}
void OAITextDetection::setParentId(const qint32 &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAITextDetection::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAITextDetection::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

float OAITextDetection::getConfidence() const {
    return m_confidence;
}
void OAITextDetection::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAITextDetection::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAITextDetection::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAITextDetection_Geometry OAITextDetection::getGeometry() const {
    return m_geometry;
}
void OAITextDetection::setGeometry(const OAITextDetection_Geometry &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAITextDetection::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAITextDetection::is_geometry_Valid() const{
    return m_geometry_isValid;
}

bool OAITextDetection::isSet() const {
...
bool OAITextDetection::isValid() const {
