...
#include "OAIGetCelebrityInfoRequest.h"
...
OAIGetCelebrityInfoRequest::OAIGetCelebrityInfoRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCelebrityInfoRequest::OAIGetCelebrityInfoRequest() {
    this->initializeModel();
}

OAIGetCelebrityInfoRequest::~OAIGetCelebrityInfoRequest() {}

void OAIGetCelebrityInfoRequest::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIGetCelebrityInfoRequest::fromJson(QString jsonString) {
...
void OAIGetCelebrityInfoRequest::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("Id")]);
    m_id_isSet = !json[QString("Id")].isNull() && m_id_isValid;
}

QString OAIGetCelebrityInfoRequest::asJson() const {
...
QJsonObject OAIGetCelebrityInfoRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIGetCelebrityInfoRequest::getId() const {
    return m_id;
}
void OAIGetCelebrityInfoRequest::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetCelebrityInfoRequest::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetCelebrityInfoRequest::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIGetCelebrityInfoRequest::isSet() const {
...
bool OAIGetCelebrityInfoRequest::isValid() const {
