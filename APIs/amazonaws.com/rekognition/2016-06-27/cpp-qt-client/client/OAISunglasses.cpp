...
OAISunglasses::OAISunglasses(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISunglasses::OAISunglasses() {
    this->initializeModel();
}

OAISunglasses::~OAISunglasses() {}

void OAISunglasses::initializeModel() {
...
void OAISunglasses::fromJson(QString jsonString) {
...
void OAISunglasses::fromJsonObject(QJsonObject json) {
...
QString OAISunglasses::asJson() const {
...
QJsonObject OAISunglasses::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAISunglasses::getValue() const {
    return m_value;
}
void OAISunglasses::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAISunglasses::is_value_Set() const{
    return m_value_isSet;
}

bool OAISunglasses::is_value_Valid() const{
    return m_value_isValid;
}

float OAISunglasses::getConfidence() const {
    return m_confidence;
}
void OAISunglasses::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAISunglasses::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAISunglasses::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAISunglasses::isSet() const {
...
bool OAISunglasses::isValid() const {
