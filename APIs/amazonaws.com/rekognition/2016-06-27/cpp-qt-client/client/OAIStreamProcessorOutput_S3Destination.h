...
/*
 * OAIStreamProcessorOutput_S3Destination.h
 *
 * 
 */

#ifndef OAIStreamProcessorOutput_S3Destination_H
#define OAIStreamProcessorOutput_S3Destination_H
...
class OAIStreamProcessorOutput_S3Destination : public OAIObject {
public:
    OAIStreamProcessorOutput_S3Destination();
    OAIStreamProcessorOutput_S3Destination(QString json);
    ~OAIStreamProcessorOutput_S3Destination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorOutput_S3Destination)

#endif // OAIStreamProcessorOutput_S3Destination_H
