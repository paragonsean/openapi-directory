...
OAIVideo_S3Object OAIVideo::getS3Object() const {
    return m_s3_object;
}
void OAIVideo::setS3Object(const OAIVideo_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIVideo::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIVideo::is_s3_object_Valid() const{
