...
/*
 * OAIProtectiveEquipmentSummarizationAttributes.h
 *
...
#ifndef OAIProtectiveEquipmentSummarizationAttributes_H
#define OAIProtectiveEquipmentSummarizationAttributes_H
...
class OAIProtectiveEquipmentSummarizationAttributes : public OAIObject {
public:
    OAIProtectiveEquipmentSummarizationAttributes();
    OAIProtectiveEquipmentSummarizationAttributes(QString json);
    ~OAIProtectiveEquipmentSummarizationAttributes() override;
    ...
    QList getRequiredEquipmentTypes() const;
    void setRequiredEquipmentTypes(const QList &required_equipment_types);
    bool is_required_equipment_types_Set() const;
    bool is_required_equipment_types_Valid() const;
...
private:
    ...
    QList m_required_equipment_types;
    bool m_required_equipment_types_isSet;
    bool m_required_equipment_types_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProtectiveEquipmentSummarizationAttributes)

#endif // OAIProtectiveEquipmentSummarizationAttributes_H
