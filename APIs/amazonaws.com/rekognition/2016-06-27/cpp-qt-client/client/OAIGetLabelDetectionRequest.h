...
/*
 * OAIGetLabelDetectionRequest.h
 *
 * 
 */

#ifndef OAIGetLabelDetectionRequest_H
#define OAIGetLabelDetectionRequest_H
...
class OAIGetLabelDetectionRequest : public OAIObject {
public:
    OAIGetLabelDetectionRequest();
    OAIGetLabelDetectionRequest(QString json);
    ~OAIGetLabelDetectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLabelDetectionRequest)

#endif // OAIGetLabelDetectionRequest_H
