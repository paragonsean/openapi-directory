...
#include "OAIStartFaceSearchRequest.h"
...
OAIStartFaceSearchRequest::OAIStartFaceSearchRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFaceSearchRequest::OAIStartFaceSearchRequest() {
    this->initializeModel();
}

OAIStartFaceSearchRequest::~OAIStartFaceSearchRequest() {}

void OAIStartFaceSearchRequest::initializeModel() {
...
void OAIStartFaceSearchRequest::fromJson(QString jsonString) {
...
void OAIStartFaceSearchRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartFaceSearchRequest::asJson() const {
...
QJsonObject OAIStartFaceSearchRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_video.isSet()) {
...
OAIStartFaceSearchRequest_Video OAIStartFaceSearchRequest::getVideo() const {
    return m_video;
}
void OAIStartFaceSearchRequest::setVideo(const OAIStartFaceSearchRequest_Video &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIStartFaceSearchRequest::is_video_Set() const{
    return m_video_isSet;
}

bool OAIStartFaceSearchRequest::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIStartFaceSearchRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIStartFaceSearchRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIStartFaceSearchRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIStartFaceSearchRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

float OAIStartFaceSearchRequest::getFaceMatchThreshold() const {
    return m_face_match_threshold;
}
void OAIStartFaceSearchRequest::setFaceMatchThreshold(const float &face_match_threshold) {
    m_face_match_threshold = face_match_threshold;
    m_face_match_threshold_isSet = true;
}

bool OAIStartFaceSearchRequest::is_face_match_threshold_Set() const{
    return m_face_match_threshold_isSet;
}

bool OAIStartFaceSearchRequest::is_face_match_threshold_Valid() const{
    return m_face_match_threshold_isValid;
}

QString OAIStartFaceSearchRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIStartFaceSearchRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIStartFaceSearchRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIStartFaceSearchRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

OAIStartFaceSearchRequest_NotificationChannel OAIStartFaceSearchRequest::getNotificationChannel() const {
    return m_notification_channel;
}
void OAIStartFaceSearchRequest::setNotificationChannel(const OAIStartFaceSearchRequest_NotificationChannel &notification_channel) {
    m_notification_channel = notification_channel;
    m_notification_channel_isSet = true;
}

bool OAIStartFaceSearchRequest::is_notification_channel_Set() const{
    return m_notification_channel_isSet;
}

bool OAIStartFaceSearchRequest::is_notification_channel_Valid() const{
    return m_notification_channel_isValid;
}

QString OAIStartFaceSearchRequest::getJobTag() const {
    return m_job_tag;
}
void OAIStartFaceSearchRequest::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIStartFaceSearchRequest::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIStartFaceSearchRequest::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIStartFaceSearchRequest::isSet() const {
...
bool OAIStartFaceSearchRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_video_isValid && m_collection_id_isValid && true;
}
