...
#include "OAIGetFaceSearchResponse.h"
...
OAIGetFaceSearchResponse::OAIGetFaceSearchResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFaceSearchResponse::OAIGetFaceSearchResponse() {
    this->initializeModel();
}

OAIGetFaceSearchResponse::~OAIGetFaceSearchResponse() {}

void OAIGetFaceSearchResponse::initializeModel() {
...
void OAIGetFaceSearchResponse::fromJson(QString jsonString) {
...
void OAIGetFaceSearchResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetFaceSearchResponse::asJson() const {
...
QJsonObject OAIGetFaceSearchResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIVideoJobStatus OAIGetFaceSearchResponse::getJobStatus() const {
    return m_job_status;
}
void OAIGetFaceSearchResponse::setJobStatus(const OAIVideoJobStatus &job_status) {
    m_job_status = job_status;
    m_job_status_isSet = true;
}

bool OAIGetFaceSearchResponse::is_job_status_Set() const{
    return m_job_status_isSet;
}

bool OAIGetFaceSearchResponse::is_job_status_Valid() const{
    return m_job_status_isValid;
}

QString OAIGetFaceSearchResponse::getStatusMessage() const {
    return m_status_message;
}
void OAIGetFaceSearchResponse::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIGetFaceSearchResponse::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIGetFaceSearchResponse::is_status_message_Valid() const{
    return m_status_message_isValid;
}

QString OAIGetFaceSearchResponse::getNextToken() const {
    return m_next_token;
}
void OAIGetFaceSearchResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetFaceSearchResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetFaceSearchResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

OAIGetFaceSearchResponse_VideoMetadata OAIGetFaceSearchResponse::getVideoMetadata() const {
    return m_video_metadata;
}
void OAIGetFaceSearchResponse::setVideoMetadata(const OAIGetFaceSearchResponse_VideoMetadata &video_metadata) {
    m_video_metadata = video_metadata;
    m_video_metadata_isSet = true;
}

bool OAIGetFaceSearchResponse::is_video_metadata_Set() const{
    return m_video_metadata_isSet;
}

bool OAIGetFaceSearchResponse::is_video_metadata_Valid() const{
    return m_video_metadata_isValid;
}

QList OAIGetFaceSearchResponse::getPersons() const {
    return m_persons;
}
void OAIGetFaceSearchResponse::setPersons(const QList &persons) {
    m_persons = persons;
    m_persons_isSet = true;
}

bool OAIGetFaceSearchResponse::is_persons_Set() const{
    return m_persons_isSet;
}

bool OAIGetFaceSearchResponse::is_persons_Valid() const{
    return m_persons_isValid;
}

QString OAIGetFaceSearchResponse::getJobId() const {
    return m_job_id;
}
void OAIGetFaceSearchResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetFaceSearchResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetFaceSearchResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIVideo OAIGetFaceSearchResponse::getVideo() const {
    return m_video;
}
void OAIGetFaceSearchResponse::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIGetFaceSearchResponse::is_video_Set() const{
    return m_video_isSet;
}

bool OAIGetFaceSearchResponse::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIGetFaceSearchResponse::getJobTag() const {
    return m_job_tag;
}
void OAIGetFaceSearchResponse::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIGetFaceSearchResponse::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIGetFaceSearchResponse::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIGetFaceSearchResponse::isSet() const {
...
bool OAIGetFaceSearchResponse::isValid() const {
