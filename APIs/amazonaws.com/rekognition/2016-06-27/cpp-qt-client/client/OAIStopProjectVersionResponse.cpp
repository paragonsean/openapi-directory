...
#include "OAIStopProjectVersionResponse.h"
...
OAIStopProjectVersionResponse::OAIStopProjectVersionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopProjectVersionResponse::OAIStopProjectVersionResponse() {
    this->initializeModel();
}

OAIStopProjectVersionResponse::~OAIStopProjectVersionResponse() {}

void OAIStopProjectVersionResponse::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIStopProjectVersionResponse::fromJson(QString jsonString) {
...
void OAIStopProjectVersionResponse::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("Status")]);
    m_status_isSet = !json[QString("Status")].isNull() && m_status_isValid;
}

QString OAIStopProjectVersionResponse::asJson() const {
...
QJsonObject OAIStopProjectVersionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIProjectVersionStatus OAIStopProjectVersionResponse::getStatus() const {
    return m_status;
}
void OAIStopProjectVersionResponse::setStatus(const OAIProjectVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStopProjectVersionResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStopProjectVersionResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStopProjectVersionResponse::isSet() const {
...
bool OAIStopProjectVersionResponse::isValid() const {
