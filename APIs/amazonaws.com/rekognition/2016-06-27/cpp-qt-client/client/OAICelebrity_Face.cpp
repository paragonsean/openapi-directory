...
OAICelebrity_Face::OAICelebrity_Face(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICelebrity_Face::OAICelebrity_Face() {
    this->initializeModel();
}

OAICelebrity_Face::~OAICelebrity_Face() {}

void OAICelebrity_Face::initializeModel() {
...
void OAICelebrity_Face::fromJson(QString jsonString) {
...
void OAICelebrity_Face::fromJsonObject(QJsonObject json) {
...
QString OAICelebrity_Face::asJson() const {
...
QJsonObject OAICelebrity_Face::asJsonObject() const {
    QJsonObject obj;
...
OAIComparedFace_BoundingBox OAICelebrity_Face::getBoundingBox() const {
    return m_bounding_box;
}
void OAICelebrity_Face::setBoundingBox(const OAIComparedFace_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAICelebrity_Face::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAICelebrity_Face::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

float OAICelebrity_Face::getConfidence() const {
    return m_confidence;
}
void OAICelebrity_Face::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAICelebrity_Face::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAICelebrity_Face::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QList OAICelebrity_Face::getLandmarks() const {
    return m_landmarks;
}
void OAICelebrity_Face::setLandmarks(const QList &landmarks) {
    m_landmarks = landmarks;
    m_landmarks_isSet = true;
}

bool OAICelebrity_Face::is_landmarks_Set() const{
    return m_landmarks_isSet;
}

bool OAICelebrity_Face::is_landmarks_Valid() const{
    return m_landmarks_isValid;
}

OAIComparedFace_Pose OAICelebrity_Face::getPose() const {
    return m_pose;
}
void OAICelebrity_Face::setPose(const OAIComparedFace_Pose &pose) {
    m_pose = pose;
    m_pose_isSet = true;
}

bool OAICelebrity_Face::is_pose_Set() const{
    return m_pose_isSet;
}

bool OAICelebrity_Face::is_pose_Valid() const{
    return m_pose_isValid;
}

OAIComparedFace_Quality OAICelebrity_Face::getQuality() const {
    return m_quality;
}
void OAICelebrity_Face::setQuality(const OAIComparedFace_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAICelebrity_Face::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAICelebrity_Face::is_quality_Valid() const{
    return m_quality_isValid;
}

QList OAICelebrity_Face::getEmotions() const {
    return m_emotions;
}
void OAICelebrity_Face::setEmotions(const QList &emotions) {
    m_emotions = emotions;
    m_emotions_isSet = true;
}

bool OAICelebrity_Face::is_emotions_Set() const{
    return m_emotions_isSet;
}

bool OAICelebrity_Face::is_emotions_Valid() const{
    return m_emotions_isValid;
}

OAIComparedFace_Smile OAICelebrity_Face::getSmile() const {
    return m_smile;
}
void OAICelebrity_Face::setSmile(const OAIComparedFace_Smile &smile) {
    m_smile = smile;
    m_smile_isSet = true;
}

bool OAICelebrity_Face::is_smile_Set() const{
    return m_smile_isSet;
}

bool OAICelebrity_Face::is_smile_Valid() const{
    return m_smile_isValid;
}

bool OAICelebrity_Face::isSet() const {
...
bool OAICelebrity_Face::isValid() const {
