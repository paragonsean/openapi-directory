...
#ifndef OAIVideoJobStatus_H
#define OAIVideoJobStatus_H
...
class OAIVideoJobStatus : public OAIEnum {
public:
    OAIVideoJobStatus();
    OAIVideoJobStatus(QString json);
    ~OAIVideoJobStatus() override;
    ...
    enum class eOAIVideoJobStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        IN_PROGRESS, 
        SUCCEEDED, 
        FAILED
    };
    OAIVideoJobStatus::eOAIVideoJobStatus getValue() const;
    void setValue(const OAIVideoJobStatus::eOAIVideoJobStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoJobStatus)

#endif // OAIVideoJobStatus_H
