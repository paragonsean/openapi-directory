...
/*
 * OAIStartFaceSearchRequest_Video.h
 *
 * 
 */

#ifndef OAIStartFaceSearchRequest_Video_H
#define OAIStartFaceSearchRequest_Video_H
...
class OAIStartFaceSearchRequest_Video : public OAIObject {
public:
    OAIStartFaceSearchRequest_Video();
    OAIStartFaceSearchRequest_Video(QString json);
    ~OAIStartFaceSearchRequest_Video() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceSearchRequest_Video)

#endif // OAIStartFaceSearchRequest_Video_H
