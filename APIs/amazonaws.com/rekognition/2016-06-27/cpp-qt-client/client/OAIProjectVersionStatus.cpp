...
#include "OAIProjectVersionStatus.h"
...
OAIProjectVersionStatus::OAIProjectVersionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectVersionStatus::OAIProjectVersionStatus() {
    this->initializeModel();
}

OAIProjectVersionStatus::~OAIProjectVersionStatus() {}

void OAIProjectVersionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIProjectVersionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIProjectVersionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("TRAINING_IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::TRAINING_IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TRAINING_COMPLETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::TRAINING_COMPLETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TRAINING_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::TRAINING_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STARTING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::STARTING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RUNNING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::RUNNING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STOPPING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::STOPPING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STOPPED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::STOPPED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("COPYING_IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::COPYING_IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("COPYING_COMPLETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::COPYING_COMPLETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("COPYING_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProjectVersionStatus::COPYING_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIProjectVersionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIProjectVersionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIProjectVersionStatus::TRAINING_IN_PROGRESS:
            val = "TRAINING_IN_PROGRESS";
            break;
        case eOAIProjectVersionStatus::TRAINING_COMPLETED:
            val = "TRAINING_COMPLETED";
            break;
        case eOAIProjectVersionStatus::TRAINING_FAILED:
            val = "TRAINING_FAILED";
            break;
        case eOAIProjectVersionStatus::STARTING:
            val = "STARTING";
            break;
        case eOAIProjectVersionStatus::RUNNING:
            val = "RUNNING";
            break;
        case eOAIProjectVersionStatus::FAILED:
            val = "FAILED";
            break;
        case eOAIProjectVersionStatus::STOPPING:
            val = "STOPPING";
            break;
        case eOAIProjectVersionStatus::STOPPED:
            val = "STOPPED";
            break;
        case eOAIProjectVersionStatus::DELETING:
            val = "DELETING";
            break;
        case eOAIProjectVersionStatus::COPYING_IN_PROGRESS:
            val = "COPYING_IN_PROGRESS";
            break;
        case eOAIProjectVersionStatus::COPYING_COMPLETED:
            val = "COPYING_COMPLETED";
            break;
        case eOAIProjectVersionStatus::COPYING_FAILED:
            val = "COPYING_FAILED";
            break;
        default:
            break;
...
QJsonValue OAIProjectVersionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIProjectVersionStatus::eOAIProjectVersionStatus OAIProjectVersionStatus::getValue() const {
    return m_value;
}

void OAIProjectVersionStatus::setValue(const OAIProjectVersionStatus::eOAIProjectVersionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIProjectVersionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIProjectVersionStatus::isValid() const {
