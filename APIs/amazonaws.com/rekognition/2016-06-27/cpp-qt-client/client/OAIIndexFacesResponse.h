...
/*
 * OAIIndexFacesResponse.h
 *
 * 
 */

#ifndef OAIIndexFacesResponse_H
#define OAIIndexFacesResponse_H
...
class OAIIndexFacesResponse : public OAIObject {
public:
    OAIIndexFacesResponse();
    OAIIndexFacesResponse(QString json);
    ~OAIIndexFacesResponse() override;
    ...
    QList getFaceRecords() const;
    void setFaceRecords(const QList &face_records);
    bool is_face_records_Set() const;
    bool is_face_records_Valid() const;
    ...
    QList getUnindexedFaces() const;
    void setUnindexedFaces(const QList &unindexed_faces);
    bool is_unindexed_faces_Set() const;
    bool is_unindexed_faces_Valid() const;
...
private:
    ...
    QList m_face_records;
    bool m_face_records_isSet;
    bool m_face_records_isValid;
    ...
    QList m_unindexed_faces;
    bool m_unindexed_faces_isSet;
    bool m_unindexed_faces_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIIndexFacesResponse)

#endif // OAIIndexFacesResponse_H
