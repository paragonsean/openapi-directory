...
/*
 * OAIStartTextDetectionResponse.h
 *
 * 
 */

#ifndef OAIStartTextDetectionResponse_H
#define OAIStartTextDetectionResponse_H
...
class OAIStartTextDetectionResponse : public OAIObject {
public:
    OAIStartTextDetectionResponse();
    OAIStartTextDetectionResponse(QString json);
    ~OAIStartTextDetectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTextDetectionResponse)

#endif // OAIStartTextDetectionResponse_H
