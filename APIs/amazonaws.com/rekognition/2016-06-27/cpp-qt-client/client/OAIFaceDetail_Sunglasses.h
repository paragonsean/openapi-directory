...
/*
 * OAIFaceDetail_Sunglasses.h
 *
 * 
 */

#ifndef OAIFaceDetail_Sunglasses_H
#define OAIFaceDetail_Sunglasses_H
...
class OAIFaceDetail_Sunglasses : public OAIObject {
public:
    OAIFaceDetail_Sunglasses();
    OAIFaceDetail_Sunglasses(QString json);
    ~OAIFaceDetail_Sunglasses() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Sunglasses)

#endif // OAIFaceDetail_Sunglasses_H
