...
OAIMouthOpen::OAIMouthOpen(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMouthOpen::OAIMouthOpen() {
    this->initializeModel();
}

OAIMouthOpen::~OAIMouthOpen() {}

void OAIMouthOpen::initializeModel() {
...
void OAIMouthOpen::fromJson(QString jsonString) {
...
void OAIMouthOpen::fromJsonObject(QJsonObject json) {
...
QString OAIMouthOpen::asJson() const {
...
QJsonObject OAIMouthOpen::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIMouthOpen::getValue() const {
    return m_value;
}
void OAIMouthOpen::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIMouthOpen::is_value_Set() const{
    return m_value_isSet;
}

bool OAIMouthOpen::is_value_Valid() const{
    return m_value_isValid;
}

float OAIMouthOpen::getConfidence() const {
    return m_confidence;
}
void OAIMouthOpen::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIMouthOpen::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIMouthOpen::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIMouthOpen::isSet() const {
...
bool OAIMouthOpen::isValid() const {
