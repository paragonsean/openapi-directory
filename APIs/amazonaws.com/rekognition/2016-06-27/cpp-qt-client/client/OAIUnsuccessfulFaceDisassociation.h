...
/*
 * OAIUnsuccessfulFaceDisassociation.h
 *
 * Contains metadata like FaceId, UserID, and Reasons, for a face that was unsuccessfully disassociated.
 */

#ifndef OAIUnsuccessfulFaceDisassociation_H
#define OAIUnsuccessfulFaceDisassociation_H
...
class OAIUnsuccessfulFaceDisassociation : public OAIObject {
public:
    OAIUnsuccessfulFaceDisassociation();
    OAIUnsuccessfulFaceDisassociation(QString json);
    ~OAIUnsuccessfulFaceDisassociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsuccessfulFaceDisassociation)

#endif // OAIUnsuccessfulFaceDisassociation_H
