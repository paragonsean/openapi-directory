...
#include "OAIDatasetDescription_DatasetStats.h"
...
OAIDatasetDescription_DatasetStats::OAIDatasetDescription_DatasetStats(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasetDescription_DatasetStats::OAIDatasetDescription_DatasetStats() {
    this->initializeModel();
}

OAIDatasetDescription_DatasetStats::~OAIDatasetDescription_DatasetStats() {}

void OAIDatasetDescription_DatasetStats::initializeModel() {

    m_labeled_entries_isSet = false;
    m_labeled_entries_isValid = false;
...
void OAIDatasetDescription_DatasetStats::fromJson(QString jsonString) {
...
void OAIDatasetDescription_DatasetStats::fromJsonObject(QJsonObject json) {

    m_labeled_entries_isValid = ::OpenAPI::fromJsonValue(m_labeled_entries, json[QString("LabeledEntries")]);
    m_labeled_entries_isSet = !json[QString("LabeledEntries")].isNull() && m_labeled_entries_isValid;

    m_total_entries_isValid = ::OpenAPI::fromJsonValue(m_total_entries, json[QString("TotalEntries")]);
    m_total_entries_isSet = !json[QString("TotalEntries")].isNull() && m_total_entries_isValid;
...
QString OAIDatasetDescription_DatasetStats::asJson() const {
...
QJsonObject OAIDatasetDescription_DatasetStats::asJsonObject() const {
    QJsonObject obj;
    if (m_labeled_entries_isSet) {
        obj.insert(QString("LabeledEntries"), ::OpenAPI::toJsonValue(m_labeled_entries));
    }
    if (m_total_entries_isSet) {
        obj.insert(QString("TotalEntries"), ::OpenAPI::toJsonValue(m_total_entries));
    }
    if (m_total_labels_isSet) {
        obj.insert(QString("TotalLabels"), ::OpenAPI::toJsonValue(m_total_labels));
    }
    if (m_error_entries_isSet) {
        obj.insert(QString("ErrorEntries"), ::OpenAPI::toJsonValue(m_error_entries));
    }
    return obj;
}

qint32 OAIDatasetDescription_DatasetStats::getLabeledEntries() const {
    return m_labeled_entries;
}
void OAIDatasetDescription_DatasetStats::setLabeledEntries(const qint32 &labeled_entries) {
    m_labeled_entries = labeled_entries;
    m_labeled_entries_isSet = true;
}

bool OAIDatasetDescription_DatasetStats::is_labeled_entries_Set() const{
    return m_labeled_entries_isSet;
}

bool OAIDatasetDescription_DatasetStats::is_labeled_entries_Valid() const{
    return m_labeled_entries_isValid;
}

qint32 OAIDatasetDescription_DatasetStats::getTotalEntries() const {
    return m_total_entries;
}
void OAIDatasetDescription_DatasetStats::setTotalEntries(const qint32 &total_entries) {
    m_total_entries = total_entries;
    m_total_entries_isSet = true;
}

bool OAIDatasetDescription_DatasetStats::is_total_entries_Set() const{
    return m_total_entries_isSet;
}

bool OAIDatasetDescription_DatasetStats::is_total_entries_Valid() const{
    return m_total_entries_isValid;
}

qint32 OAIDatasetDescription_DatasetStats::getTotalLabels() const {
    return m_total_labels;
}
void OAIDatasetDescription_DatasetStats::setTotalLabels(const qint32 &total_labels) {
    m_total_labels = total_labels;
    m_total_labels_isSet = true;
}

bool OAIDatasetDescription_DatasetStats::is_total_labels_Set() const{
    return m_total_labels_isSet;
}

bool OAIDatasetDescription_DatasetStats::is_total_labels_Valid() const{
    return m_total_labels_isValid;
}

qint32 OAIDatasetDescription_DatasetStats::getErrorEntries() const {
    return m_error_entries;
}
void OAIDatasetDescription_DatasetStats::setErrorEntries(const qint32 &error_entries) {
    m_error_entries = error_entries;
    m_error_entries_isSet = true;
}

bool OAIDatasetDescription_DatasetStats::is_error_entries_Set() const{
    return m_error_entries_isSet;
}

bool OAIDatasetDescription_DatasetStats::is_error_entries_Valid() const{
    return m_error_entries_isValid;
}

bool OAIDatasetDescription_DatasetStats::isSet() const {
...
bool OAIDatasetDescription_DatasetStats::isValid() const {
