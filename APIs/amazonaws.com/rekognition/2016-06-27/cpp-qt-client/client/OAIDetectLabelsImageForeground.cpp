...
#include "OAIDetectLabelsImageForeground.h"
...
OAIDetectLabelsImageForeground::OAIDetectLabelsImageForeground(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageForeground::OAIDetectLabelsImageForeground() {
    this->initializeModel();
}

OAIDetectLabelsImageForeground::~OAIDetectLabelsImageForeground() {}

void OAIDetectLabelsImageForeground::initializeModel() {
...
void OAIDetectLabelsImageForeground::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageForeground::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageForeground::asJson() const {
...
QJsonObject OAIDetectLabelsImageForeground::asJsonObject() const {
    QJsonObject obj;
    if (m_quality.isSet()) {
...
OAIDetectLabelsImageForeground_Quality OAIDetectLabelsImageForeground::getQuality() const {
    return m_quality;
}
void OAIDetectLabelsImageForeground::setQuality(const OAIDetectLabelsImageForeground_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIDetectLabelsImageForeground::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIDetectLabelsImageForeground::is_quality_Valid() const{
    return m_quality_isValid;
}

QList OAIDetectLabelsImageForeground::getDominantColors() const {
    return m_dominant_colors;
}
void OAIDetectLabelsImageForeground::setDominantColors(const QList &dominant_colors) {
    m_dominant_colors = dominant_colors;
    m_dominant_colors_isSet = true;
}

bool OAIDetectLabelsImageForeground::is_dominant_colors_Set() const{
    return m_dominant_colors_isSet;
}

bool OAIDetectLabelsImageForeground::is_dominant_colors_Valid() const{
    return m_dominant_colors_isValid;
}

bool OAIDetectLabelsImageForeground::isSet() const {
...
bool OAIDetectLabelsImageForeground::isValid() const {
