...
OAIStartPersonTrackingRequest_NotificationChannel::OAIStartPersonTrackingRequest_NotificationChannel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartPersonTrackingRequest_NotificationChannel::OAIStartPersonTrackingRequest_NotificationChannel() {
    this->initializeModel();
}

OAIStartPersonTrackingRequest_NotificationChannel::~OAIStartPersonTrackingRequest_NotificationChannel() {}

void OAIStartPersonTrackingRequest_NotificationChannel::initializeModel() {
...
void OAIStartPersonTrackingRequest_NotificationChannel::fromJson(QString jsonString) {
...
void OAIStartPersonTrackingRequest_NotificationChannel::fromJsonObject(QJsonObject json) {
...
QString OAIStartPersonTrackingRequest_NotificationChannel::asJson() const {
...
QJsonObject OAIStartPersonTrackingRequest_NotificationChannel::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartPersonTrackingRequest_NotificationChannel::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIStartPersonTrackingRequest_NotificationChannel::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIStartPersonTrackingRequest_NotificationChannel::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIStartPersonTrackingRequest_NotificationChannel::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

QString OAIStartPersonTrackingRequest_NotificationChannel::getRoleArn() const {
    return m_role_arn;
}
void OAIStartPersonTrackingRequest_NotificationChannel::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIStartPersonTrackingRequest_NotificationChannel::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIStartPersonTrackingRequest_NotificationChannel::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAIStartPersonTrackingRequest_NotificationChannel::isSet() const {
...
bool OAIStartPersonTrackingRequest_NotificationChannel::isValid() const {
