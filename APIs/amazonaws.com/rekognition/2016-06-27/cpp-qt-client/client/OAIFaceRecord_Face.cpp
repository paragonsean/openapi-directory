...
OAIFaceRecord_Face::OAIFaceRecord_Face(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceRecord_Face::OAIFaceRecord_Face() {
    this->initializeModel();
}

OAIFaceRecord_Face::~OAIFaceRecord_Face() {}

void OAIFaceRecord_Face::initializeModel() {
    ...
    m_external_image_id_isSet = false;
    m_external_image_id_isValid = false;

    m_confidence_isSet = false;
    m_confidence_isValid = false;

    m_index_faces_model_version_isSet = false;
    m_index_faces_model_version_isValid = false;

    m_user_id_isSet = false;
    m_user_id_isValid = false;
}

void OAIFaceRecord_Face::fromJson(QString jsonString) {
...
void OAIFaceRecord_Face::fromJsonObject(QJsonObject json) {
    ...
    m_external_image_id_isValid = ::OpenAPI::fromJsonValue(m_external_image_id, json[QString("ExternalImageId")]);
    m_external_image_id_isSet = !json[QString("ExternalImageId")].isNull() && m_external_image_id_isValid;

    m_confidence_isValid = ::OpenAPI::fromJsonValue(m_confidence, json[QString("Confidence")]);
    m_confidence_isSet = !json[QString("Confidence")].isNull() && m_confidence_isValid;

    m_index_faces_model_version_isValid = ::OpenAPI::fromJsonValue(m_index_faces_model_version, json[QString("IndexFacesModelVersion")]);
    m_index_faces_model_version_isSet = !json[QString("IndexFacesModelVersion")].isNull() && m_index_faces_model_version_isValid;

    m_user_id_isValid = ::OpenAPI::fromJsonValue(m_user_id, json[QString("UserId")]);
    m_user_id_isSet = !json[QString("UserId")].isNull() && m_user_id_isValid;
}

QString OAIFaceRecord_Face::asJson() const {
...
QJsonObject OAIFaceRecord_Face::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
    ...
    if (m_external_image_id_isSet) {
        obj.insert(QString("ExternalImageId"), ::OpenAPI::toJsonValue(m_external_image_id));
    }
    if (m_confidence_isSet) {
        obj.insert(QString("Confidence"), ::OpenAPI::toJsonValue(m_confidence));
    }
    if (m_index_faces_model_version_isSet) {
        obj.insert(QString("IndexFacesModelVersion"), ::OpenAPI::toJsonValue(m_index_faces_model_version));
    }
    if (m_user_id_isSet) {
...
QString OAIFaceRecord_Face::getFaceId() const {
    return m_face_id;
}
void OAIFaceRecord_Face::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAIFaceRecord_Face::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAIFaceRecord_Face::is_face_id_Valid() const{
    return m_face_id_isValid;
}

OAIComparedFace_BoundingBox OAIFaceRecord_Face::getBoundingBox() const {
    return m_bounding_box;
}
void OAIFaceRecord_Face::setBoundingBox(const OAIComparedFace_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIFaceRecord_Face::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIFaceRecord_Face::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

QString OAIFaceRecord_Face::getImageId() const {
    return m_image_id;
}
void OAIFaceRecord_Face::setImageId(const QString &image_id) {
    m_image_id = image_id;
    m_image_id_isSet = true;
}

bool OAIFaceRecord_Face::is_image_id_Set() const{
    return m_image_id_isSet;
}

bool OAIFaceRecord_Face::is_image_id_Valid() const{
    return m_image_id_isValid;
}

QString OAIFaceRecord_Face::getExternalImageId() const {
    return m_external_image_id;
}
void OAIFaceRecord_Face::setExternalImageId(const QString &external_image_id) {
    m_external_image_id = external_image_id;
    m_external_image_id_isSet = true;
}

bool OAIFaceRecord_Face::is_external_image_id_Set() const{
    return m_external_image_id_isSet;
}

bool OAIFaceRecord_Face::is_external_image_id_Valid() const{
    return m_external_image_id_isValid;
}

float OAIFaceRecord_Face::getConfidence() const {
    return m_confidence;
}
void OAIFaceRecord_Face::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceRecord_Face::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceRecord_Face::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QString OAIFaceRecord_Face::getIndexFacesModelVersion() const {
    return m_index_faces_model_version;
}
void OAIFaceRecord_Face::setIndexFacesModelVersion(const QString &index_faces_model_version) {
    m_index_faces_model_version = index_faces_model_version;
    m_index_faces_model_version_isSet = true;
}

bool OAIFaceRecord_Face::is_index_faces_model_version_Set() const{
    return m_index_faces_model_version_isSet;
}

bool OAIFaceRecord_Face::is_index_faces_model_version_Valid() const{
    return m_index_faces_model_version_isValid;
}

QString OAIFaceRecord_Face::getUserId() const {
    return m_user_id;
}
void OAIFaceRecord_Face::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIFaceRecord_Face::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIFaceRecord_Face::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIFaceRecord_Face::isSet() const {
...
bool OAIFaceRecord_Face::isValid() const {
