...
#include "OAIStartLabelDetectionRequest_Video.h"
...
OAIStartLabelDetectionRequest_Video::OAIStartLabelDetectionRequest_Video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartLabelDetectionRequest_Video::OAIStartLabelDetectionRequest_Video() {
    this->initializeModel();
}

OAIStartLabelDetectionRequest_Video::~OAIStartLabelDetectionRequest_Video() {}

void OAIStartLabelDetectionRequest_Video::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIStartLabelDetectionRequest_Video::fromJson(QString jsonString) {
...
void OAIStartLabelDetectionRequest_Video::fromJsonObject(QJsonObject json) {
...
QString OAIStartLabelDetectionRequest_Video::asJson() const {
...
QJsonObject OAIStartLabelDetectionRequest_Video::asJsonObject() const {
    QJsonObject obj;
...
OAIVideo_S3Object OAIStartLabelDetectionRequest_Video::getS3Object() const {
    return m_s3_object;
}
void OAIStartLabelDetectionRequest_Video::setS3Object(const OAIVideo_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIStartLabelDetectionRequest_Video::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIStartLabelDetectionRequest_Video::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIStartLabelDetectionRequest_Video::isSet() const {
...
bool OAIStartLabelDetectionRequest_Video::isValid() const {
