...
/*
 * OAIGetCelebrityInfoResponse.h
 *
 * 
 */

#ifndef OAIGetCelebrityInfoResponse_H
#define OAIGetCelebrityInfoResponse_H
...
class OAIGetCelebrityInfoResponse : public OAIObject {
public:
    OAIGetCelebrityInfoResponse();
    OAIGetCelebrityInfoResponse(QString json);
    ~OAIGetCelebrityInfoResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCelebrityInfoResponse)

#endif // OAIGetCelebrityInfoResponse_H
