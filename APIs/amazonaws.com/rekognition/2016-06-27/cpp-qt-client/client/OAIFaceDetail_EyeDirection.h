...
/*
 * OAIFaceDetail_EyeDirection.h
 *
 * 
 */

#ifndef OAIFaceDetail_EyeDirection_H
#define OAIFaceDetail_EyeDirection_H
...
class OAIFaceDetail_EyeDirection : public OAIObject {
public:
    OAIFaceDetail_EyeDirection();
    OAIFaceDetail_EyeDirection(QString json);
    ~OAIFaceDetail_EyeDirection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_EyeDirection)

#endif // OAIFaceDetail_EyeDirection_H
