...
QString OAICreateDatasetRequest::getProjectArn() const {
    return m_project_arn;
}
void OAICreateDatasetRequest::setProjectArn(const QString &project_arn) {
    m_project_arn = project_arn;
    m_project_arn_isSet = true;
}

bool OAICreateDatasetRequest::is_project_arn_Set() const{
    return m_project_arn_isSet;
}

bool OAICreateDatasetRequest::is_project_arn_Valid() const{
...
bool OAICreateDatasetRequest::isValid() const {
    ...
    return m_dataset_type_isValid && m_project_arn_isValid && true;
}
