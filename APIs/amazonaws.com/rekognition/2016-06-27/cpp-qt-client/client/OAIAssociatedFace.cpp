...
OAIAssociatedFace::OAIAssociatedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociatedFace::OAIAssociatedFace() {
    this->initializeModel();
}

OAIAssociatedFace::~OAIAssociatedFace() {}

void OAIAssociatedFace::initializeModel() {

    m_face_id_isSet = false;
    m_face_id_isValid = false;
}

void OAIAssociatedFace::fromJson(QString jsonString) {
...
void OAIAssociatedFace::fromJsonObject(QJsonObject json) {
...
QString OAIAssociatedFace::asJson() const {
...
QJsonObject OAIAssociatedFace::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
...
QString OAIAssociatedFace::getFaceId() const {
    return m_face_id;
}
void OAIAssociatedFace::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAIAssociatedFace::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAIAssociatedFace::is_face_id_Valid() const{
    return m_face_id_isValid;
}

bool OAIAssociatedFace::isSet() const {
...
bool OAIAssociatedFace::isValid() const {
