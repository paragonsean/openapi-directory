...
/*
 * OAIStreamProcessingStopSelector.h
 *
 *  Specifies when to stop processing the stream. You can specify a maximum amount of time to process the video. 
 */

#ifndef OAIStreamProcessingStopSelector_H
#define OAIStreamProcessingStopSelector_H
...
class OAIStreamProcessingStopSelector : public OAIObject {
public:
    OAIStreamProcessingStopSelector();
    OAIStreamProcessingStopSelector(QString json);
    ~OAIStreamProcessingStopSelector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessingStopSelector)

#endif // OAIStreamProcessingStopSelector_H
