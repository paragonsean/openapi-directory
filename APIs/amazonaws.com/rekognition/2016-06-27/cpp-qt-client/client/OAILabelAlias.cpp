...
OAILabelAlias::OAILabelAlias(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelAlias::OAILabelAlias() {
    this->initializeModel();
}

OAILabelAlias::~OAILabelAlias() {}

void OAILabelAlias::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAILabelAlias::fromJson(QString jsonString) {
...
void OAILabelAlias::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAILabelAlias::asJson() const {
...
QJsonObject OAILabelAlias::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAILabelAlias::getName() const {
    return m_name;
}
void OAILabelAlias::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILabelAlias::is_name_Set() const{
    return m_name_isSet;
}

bool OAILabelAlias::is_name_Valid() const{
    return m_name_isValid;
}

bool OAILabelAlias::isSet() const {
...
bool OAILabelAlias::isValid() const {
