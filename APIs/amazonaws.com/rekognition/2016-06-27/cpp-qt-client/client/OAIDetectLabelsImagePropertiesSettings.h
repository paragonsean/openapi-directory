...
/*
 * OAIDetectLabelsImagePropertiesSettings.h
 *
 * Settings for the IMAGE_PROPERTIES feature type.
 */

#ifndef OAIDetectLabelsImagePropertiesSettings_H
#define OAIDetectLabelsImagePropertiesSettings_H
...
class OAIDetectLabelsImagePropertiesSettings : public OAIObject {
public:
    OAIDetectLabelsImagePropertiesSettings();
    OAIDetectLabelsImagePropertiesSettings(QString json);
    ~OAIDetectLabelsImagePropertiesSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImagePropertiesSettings)

#endif // OAIDetectLabelsImagePropertiesSettings_H
