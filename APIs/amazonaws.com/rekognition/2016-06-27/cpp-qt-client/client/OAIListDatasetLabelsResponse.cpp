...
#include "OAIListDatasetLabelsResponse.h"
...
OAIListDatasetLabelsResponse::OAIListDatasetLabelsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDatasetLabelsResponse::OAIListDatasetLabelsResponse() {
    this->initializeModel();
}

OAIListDatasetLabelsResponse::~OAIListDatasetLabelsResponse() {}

void OAIListDatasetLabelsResponse::initializeModel() {

    m_dataset_label_descriptions_isSet = false;
    m_dataset_label_descriptions_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListDatasetLabelsResponse::fromJson(QString jsonString) {
...
void OAIListDatasetLabelsResponse::fromJsonObject(QJsonObject json) {

    m_dataset_label_descriptions_isValid = ::OpenAPI::fromJsonValue(m_dataset_label_descriptions, json[QString("DatasetLabelDescriptions")]);
    m_dataset_label_descriptions_isSet = !json[QString("DatasetLabelDescriptions")].isNull() && m_dataset_label_descriptions_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListDatasetLabelsResponse::asJson() const {
...
QJsonObject OAIListDatasetLabelsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_dataset_label_descriptions.isSet()) {
        obj.insert(QString("DatasetLabelDescriptions"), ::OpenAPI::toJsonValue(m_dataset_label_descriptions));
    }
...
QList OAIListDatasetLabelsResponse::getDatasetLabelDescriptions() const {
    return m_dataset_label_descriptions;
}
void OAIListDatasetLabelsResponse::setDatasetLabelDescriptions(const QList &dataset_label_descriptions) {
    m_dataset_label_descriptions = dataset_label_descriptions;
    m_dataset_label_descriptions_isSet = true;
}

bool OAIListDatasetLabelsResponse::is_dataset_label_descriptions_Set() const{
    return m_dataset_label_descriptions_isSet;
}

bool OAIListDatasetLabelsResponse::is_dataset_label_descriptions_Valid() const{
    return m_dataset_label_descriptions_isValid;
}

QString OAIListDatasetLabelsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListDatasetLabelsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDatasetLabelsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDatasetLabelsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListDatasetLabelsResponse::isSet() const {
...
bool OAIListDatasetLabelsResponse::isValid() const {
