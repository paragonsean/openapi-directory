...
/*
 * OAIContentModerationDetection.h
 *
 * Information about an inappropriate, unwanted, or offensive content label detection in a stored video.
 */

#ifndef OAIContentModerationDetection_H
#define OAIContentModerationDetection_H

#include <QJsonObject>

#include "OAIContentModerationDetection_ModerationLabel.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIContentModerationDetection_ModerationLabel;

class OAIContentModerationDetection : public OAIObject {
public:
    OAIContentModerationDetection();
    OAIContentModerationDetection(QString json);
    ~OAIContentModerationDetection() override;
    ...
    OAIContentModerationDetection_ModerationLabel getModerationLabel() const;
    void setModerationLabel(const OAIContentModerationDetection_ModerationLabel &moderation_label);
    bool is_moderation_label_Set() const;
    bool is_moderation_label_Valid() const;
...
private:
    ...
    OAIContentModerationDetection_ModerationLabel m_moderation_label;
    bool m_moderation_label_isSet;
    bool m_moderation_label_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentModerationDetection)

#endif // OAIContentModerationDetection_H
