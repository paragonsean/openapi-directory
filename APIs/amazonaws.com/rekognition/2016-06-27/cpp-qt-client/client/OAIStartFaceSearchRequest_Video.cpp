...
OAIStartFaceSearchRequest_Video::OAIStartFaceSearchRequest_Video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFaceSearchRequest_Video::OAIStartFaceSearchRequest_Video() {
    this->initializeModel();
}

OAIStartFaceSearchRequest_Video::~OAIStartFaceSearchRequest_Video() {}

void OAIStartFaceSearchRequest_Video::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIStartFaceSearchRequest_Video::fromJson(QString jsonString) {
...
void OAIStartFaceSearchRequest_Video::fromJsonObject(QJsonObject json) {
...
QString OAIStartFaceSearchRequest_Video::asJson() const {
...
QJsonObject OAIStartFaceSearchRequest_Video::asJsonObject() const {
    QJsonObject obj;
...
OAIVideo_S3Object OAIStartFaceSearchRequest_Video::getS3Object() const {
    return m_s3_object;
}
void OAIStartFaceSearchRequest_Video::setS3Object(const OAIVideo_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIStartFaceSearchRequest_Video::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIStartFaceSearchRequest_Video::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIStartFaceSearchRequest_Video::isSet() const {
...
bool OAIStartFaceSearchRequest_Video::isValid() const {
