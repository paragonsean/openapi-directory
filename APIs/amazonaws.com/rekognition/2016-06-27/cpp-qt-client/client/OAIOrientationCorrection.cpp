...
OAIOrientationCorrection::OAIOrientationCorrection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrientationCorrection::OAIOrientationCorrection() {
    this->initializeModel();
}

OAIOrientationCorrection::~OAIOrientationCorrection() {}

void OAIOrientationCorrection::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOrientationCorrection::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOrientationCorrection::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ROTATE_0", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrientationCorrection::_0;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ROTATE_90", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrientationCorrection::_90;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ROTATE_180", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrientationCorrection::_180;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ROTATE_270", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrientationCorrection::_270;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOrientationCorrection::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOrientationCorrection::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOrientationCorrection::_0:
            val = "ROTATE_0";
            break;
        case eOAIOrientationCorrection::_90:
            val = "ROTATE_90";
            break;
        case eOAIOrientationCorrection::_180:
            val = "ROTATE_180";
            break;
        case eOAIOrientationCorrection::_270:
            val = "ROTATE_270";
            break;
        default:
            break;
...
QJsonValue OAIOrientationCorrection::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOrientationCorrection::eOAIOrientationCorrection OAIOrientationCorrection::getValue() const {
    return m_value;
}

void OAIOrientationCorrection::setValue(const OAIOrientationCorrection::eOAIOrientationCorrection& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOrientationCorrection::isSet() const {
    
    return m_value_isSet;
}

bool OAIOrientationCorrection::isValid() const {
