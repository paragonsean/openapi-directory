...
OAIEmotionName::OAIEmotionName(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmotionName::OAIEmotionName() {
    this->initializeModel();
}

OAIEmotionName::~OAIEmotionName() {}

void OAIEmotionName::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEmotionName::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEmotionName::fromJson(QString jsonString) {
    
    if ( jsonString.compare("HAPPY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::HAPPY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SAD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::SAD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ANGRY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::ANGRY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONFUSED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::CONFUSED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISGUSTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::DISGUSTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SURPRISED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::SURPRISED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CALM", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::CALM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNKNOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FEAR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmotionName::FEAR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEmotionName::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEmotionName::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEmotionName::HAPPY:
            val = "HAPPY";
            break;
        case eOAIEmotionName::SAD:
            val = "SAD";
            break;
        case eOAIEmotionName::ANGRY:
            val = "ANGRY";
            break;
        case eOAIEmotionName::CONFUSED:
            val = "CONFUSED";
            break;
        case eOAIEmotionName::DISGUSTED:
            val = "DISGUSTED";
            break;
        case eOAIEmotionName::SURPRISED:
            val = "SURPRISED";
            break;
        case eOAIEmotionName::CALM:
            val = "CALM";
            break;
        case eOAIEmotionName::UNKNOWN:
            val = "UNKNOWN";
            break;
        case eOAIEmotionName::FEAR:
            val = "FEAR";
            break;
        default:
            break;
...
QJsonValue OAIEmotionName::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEmotionName::eOAIEmotionName OAIEmotionName::getValue() const {
    return m_value;
}

void OAIEmotionName::setValue(const OAIEmotionName::eOAIEmotionName& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEmotionName::isSet() const {
    
    return m_value_isSet;
}

bool OAIEmotionName::isValid() const {
