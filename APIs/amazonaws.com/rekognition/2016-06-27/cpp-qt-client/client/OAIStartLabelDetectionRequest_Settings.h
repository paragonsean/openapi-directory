...
/*
 * OAIStartLabelDetectionRequest_Settings.h
 *
 * 
 */

#ifndef OAIStartLabelDetectionRequest_Settings_H
#define OAIStartLabelDetectionRequest_Settings_H
...
class OAIStartLabelDetectionRequest_Settings : public OAIObject {
public:
    OAIStartLabelDetectionRequest_Settings();
    OAIStartLabelDetectionRequest_Settings(QString json);
    ~OAIStartLabelDetectionRequest_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartLabelDetectionRequest_Settings)

#endif // OAIStartLabelDetectionRequest_Settings_H
