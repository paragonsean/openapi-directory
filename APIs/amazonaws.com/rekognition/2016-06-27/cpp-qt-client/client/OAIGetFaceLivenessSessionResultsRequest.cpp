...
#include "OAIGetFaceLivenessSessionResultsRequest.h"
...
OAIGetFaceLivenessSessionResultsRequest::OAIGetFaceLivenessSessionResultsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFaceLivenessSessionResultsRequest::OAIGetFaceLivenessSessionResultsRequest() {
    this->initializeModel();
}

OAIGetFaceLivenessSessionResultsRequest::~OAIGetFaceLivenessSessionResultsRequest() {}

void OAIGetFaceLivenessSessionResultsRequest::initializeModel() {

    m_session_id_isSet = false;
    m_session_id_isValid = false;
}

void OAIGetFaceLivenessSessionResultsRequest::fromJson(QString jsonString) {
...
void OAIGetFaceLivenessSessionResultsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetFaceLivenessSessionResultsRequest::asJson() const {
...
QJsonObject OAIGetFaceLivenessSessionResultsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetFaceLivenessSessionResultsRequest::getSessionId() const {
    return m_session_id;
}
void OAIGetFaceLivenessSessionResultsRequest::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIGetFaceLivenessSessionResultsRequest::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIGetFaceLivenessSessionResultsRequest::is_session_id_Valid() const{
    return m_session_id_isValid;
}

bool OAIGetFaceLivenessSessionResultsRequest::isSet() const {
...
bool OAIGetFaceLivenessSessionResultsRequest::isValid() const {
