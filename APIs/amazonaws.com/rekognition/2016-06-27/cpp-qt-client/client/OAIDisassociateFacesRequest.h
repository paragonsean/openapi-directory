...
/*
 * OAIDisassociateFacesRequest.h
 *
 * 
 */

#ifndef OAIDisassociateFacesRequest_H
#define OAIDisassociateFacesRequest_H
...
class OAIDisassociateFacesRequest : public OAIObject {
public:
    OAIDisassociateFacesRequest();
    OAIDisassociateFacesRequest(QString json);
    ~OAIDisassociateFacesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateFacesRequest)

#endif // OAIDisassociateFacesRequest_H
