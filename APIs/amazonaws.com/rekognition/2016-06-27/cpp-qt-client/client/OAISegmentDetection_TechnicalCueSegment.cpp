...
#include "OAISegmentDetection_TechnicalCueSegment.h"
...
OAISegmentDetection_TechnicalCueSegment::OAISegmentDetection_TechnicalCueSegment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISegmentDetection_TechnicalCueSegment::OAISegmentDetection_TechnicalCueSegment() {
    this->initializeModel();
}

OAISegmentDetection_TechnicalCueSegment::~OAISegmentDetection_TechnicalCueSegment() {}

void OAISegmentDetection_TechnicalCueSegment::initializeModel() {
...
void OAISegmentDetection_TechnicalCueSegment::fromJson(QString jsonString) {
...
void OAISegmentDetection_TechnicalCueSegment::fromJsonObject(QJsonObject json) {
...
QString OAISegmentDetection_TechnicalCueSegment::asJson() const {
...
QJsonObject OAISegmentDetection_TechnicalCueSegment::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAITechnicalCueType OAISegmentDetection_TechnicalCueSegment::getType() const {
    return m_type;
}
void OAISegmentDetection_TechnicalCueSegment::setType(const OAITechnicalCueType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISegmentDetection_TechnicalCueSegment::is_type_Set() const{
    return m_type_isSet;
}

bool OAISegmentDetection_TechnicalCueSegment::is_type_Valid() const{
    return m_type_isValid;
}

float OAISegmentDetection_TechnicalCueSegment::getConfidence() const {
    return m_confidence;
}
void OAISegmentDetection_TechnicalCueSegment::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAISegmentDetection_TechnicalCueSegment::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAISegmentDetection_TechnicalCueSegment::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAISegmentDetection_TechnicalCueSegment::isSet() const {
...
bool OAISegmentDetection_TechnicalCueSegment::isValid() const {
