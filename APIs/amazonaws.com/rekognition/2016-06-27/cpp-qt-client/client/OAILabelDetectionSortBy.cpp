...
OAILabelDetectionSortBy::OAILabelDetectionSortBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelDetectionSortBy::OAILabelDetectionSortBy() {
    this->initializeModel();
}

OAILabelDetectionSortBy::~OAILabelDetectionSortBy() {}

void OAILabelDetectionSortBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAILabelDetectionSortBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILabelDetectionSortBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NAME", Qt::CaseInsensitive) == 0) {
        m_value = eOAILabelDetectionSortBy::NAME;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TIMESTAMP", Qt::CaseInsensitive) == 0) {
        m_value = eOAILabelDetectionSortBy::TIMESTAMP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILabelDetectionSortBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAILabelDetectionSortBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAILabelDetectionSortBy::NAME:
            val = "NAME";
            break;
        case eOAILabelDetectionSortBy::TIMESTAMP:
            val = "TIMESTAMP";
            break;
        default:
            break;
...
QJsonValue OAILabelDetectionSortBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILabelDetectionSortBy::eOAILabelDetectionSortBy OAILabelDetectionSortBy::getValue() const {
    return m_value;
}

void OAILabelDetectionSortBy::setValue(const OAILabelDetectionSortBy::eOAILabelDetectionSortBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAILabelDetectionSortBy::isSet() const {
    
    return m_value_isSet;
}

bool OAILabelDetectionSortBy::isValid() const {
