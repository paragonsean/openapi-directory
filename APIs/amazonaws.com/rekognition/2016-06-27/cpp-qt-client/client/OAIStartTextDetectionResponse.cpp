...
#include "OAIStartTextDetectionResponse.h"
...
OAIStartTextDetectionResponse::OAIStartTextDetectionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartTextDetectionResponse::OAIStartTextDetectionResponse() {
    this->initializeModel();
}

OAIStartTextDetectionResponse::~OAIStartTextDetectionResponse() {}

void OAIStartTextDetectionResponse::initializeModel() {

    m_job_id_isSet = false;
    m_job_id_isValid = false;
}

void OAIStartTextDetectionResponse::fromJson(QString jsonString) {
...
void OAIStartTextDetectionResponse::fromJsonObject(QJsonObject json) {

    m_job_id_isValid = ::OpenAPI::fromJsonValue(m_job_id, json[QString("JobId")]);
    m_job_id_isSet = !json[QString("JobId")].isNull() && m_job_id_isValid;
}

QString OAIStartTextDetectionResponse::asJson() const {
...
QJsonObject OAIStartTextDetectionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIStartTextDetectionResponse::getJobId() const {
    return m_job_id;
}
void OAIStartTextDetectionResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIStartTextDetectionResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIStartTextDetectionResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIStartTextDetectionResponse::isSet() const {
...
bool OAIStartTextDetectionResponse::isValid() const {
