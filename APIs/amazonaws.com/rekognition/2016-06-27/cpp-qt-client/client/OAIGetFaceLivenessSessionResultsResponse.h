...
/*
 * OAIGetFaceLivenessSessionResultsResponse.h
 *
 * 
 */

#ifndef OAIGetFaceLivenessSessionResultsResponse_H
#define OAIGetFaceLivenessSessionResultsResponse_H

#include <QJsonObject>

#include "OAIGetFaceLivenessSessionResultsResponse_ReferenceImage.h"
#include "OAILivenessSessionStatus.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGetFaceLivenessSessionResultsResponse_ReferenceImage;

class OAIGetFaceLivenessSessionResultsResponse : public OAIObject {
public:
    OAIGetFaceLivenessSessionResultsResponse();
    OAIGetFaceLivenessSessionResultsResponse(QString json);
    ~OAIGetFaceLivenessSessionResultsResponse() override;
    ...
    OAILivenessSessionStatus getStatus() const;
    void setStatus(const OAILivenessSessionStatus &status);
    ...
    OAIGetFaceLivenessSessionResultsResponse_ReferenceImage getReferenceImage() const;
    void setReferenceImage(const OAIGetFaceLivenessSessionResultsResponse_ReferenceImage &reference_image);
    bool is_reference_image_Set() const;
    bool is_reference_image_Valid() const;

    QList getAuditImages() const;
    void setAuditImages(const QList &audit_images);
    bool is_audit_images_Set() const;
    bool is_audit_images_Valid() const;
...
private:
    ...
    OAILivenessSessionStatus m_status;
    bool m_status_isSet;
    ...
    OAIGetFaceLivenessSessionResultsResponse_ReferenceImage m_reference_image;
    bool m_reference_image_isSet;
    bool m_reference_image_isValid;

    QList m_audit_images;
    bool m_audit_images_isSet;
    bool m_audit_images_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceLivenessSessionResultsResponse)

#endif // OAIGetFaceLivenessSessionResultsResponse_H
