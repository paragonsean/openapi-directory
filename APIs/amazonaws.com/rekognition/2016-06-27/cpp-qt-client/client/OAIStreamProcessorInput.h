...
/*
 * OAIStreamProcessorInput.h
 *
 * Information about the source streaming video. 
 */

#ifndef OAIStreamProcessorInput_H
#define OAIStreamProcessorInput_H
...
class OAIStreamProcessorInput : public OAIObject {
public:
    OAIStreamProcessorInput();
    OAIStreamProcessorInput(QString json);
    ~OAIStreamProcessorInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorInput)

#endif // OAIStreamProcessorInput_H
