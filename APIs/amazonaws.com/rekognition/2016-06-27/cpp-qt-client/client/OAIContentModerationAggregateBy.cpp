...
#include "OAIContentModerationAggregateBy.h"
...
OAIContentModerationAggregateBy::OAIContentModerationAggregateBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContentModerationAggregateBy::OAIContentModerationAggregateBy() {
    this->initializeModel();
}

OAIContentModerationAggregateBy::~OAIContentModerationAggregateBy() {}

void OAIContentModerationAggregateBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIContentModerationAggregateBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIContentModerationAggregateBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("TIMESTAMPS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContentModerationAggregateBy::TIMESTAMPS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SEGMENTS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContentModerationAggregateBy::SEGMENTS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIContentModerationAggregateBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIContentModerationAggregateBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIContentModerationAggregateBy::TIMESTAMPS:
            val = "TIMESTAMPS";
            break;
        case eOAIContentModerationAggregateBy::SEGMENTS:
            val = "SEGMENTS";
            break;
        default:
            break;
...
QJsonValue OAIContentModerationAggregateBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIContentModerationAggregateBy::eOAIContentModerationAggregateBy OAIContentModerationAggregateBy::getValue() const {
    return m_value;
}

void OAIContentModerationAggregateBy::setValue(const OAIContentModerationAggregateBy::eOAIContentModerationAggregateBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIContentModerationAggregateBy::isSet() const {
    
    return m_value_isSet;
}

bool OAIContentModerationAggregateBy::isValid() const {
