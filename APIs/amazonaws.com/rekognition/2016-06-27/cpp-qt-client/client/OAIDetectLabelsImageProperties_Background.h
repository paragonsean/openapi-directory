...
/*
 * OAIDetectLabelsImageProperties_Background.h
 *
 * 
 */

#ifndef OAIDetectLabelsImageProperties_Background_H
#define OAIDetectLabelsImageProperties_Background_H
...
namespace OpenAPI {
class OAIDetectLabelsImageBackground_Quality;

class OAIDetectLabelsImageProperties_Background : public OAIObject {
public:
    OAIDetectLabelsImageProperties_Background();
    OAIDetectLabelsImageProperties_Background(QString json);
    ~OAIDetectLabelsImageProperties_Background() override;
    ...
    OAIDetectLabelsImageBackground_Quality getQuality() const;
    void setQuality(const OAIDetectLabelsImageBackground_Quality &quality);
...
private:
    ...
    OAIDetectLabelsImageBackground_Quality m_quality;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageProperties_Background)

#endif // OAIDetectLabelsImageProperties_Background_H
