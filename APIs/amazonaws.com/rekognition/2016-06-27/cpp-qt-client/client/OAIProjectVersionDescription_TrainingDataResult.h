...
/*
 * OAIProjectVersionDescription_TrainingDataResult.h
 *
 * 
 */

#ifndef OAIProjectVersionDescription_TrainingDataResult_H
#define OAIProjectVersionDescription_TrainingDataResult_H
...
namespace OpenAPI {
class OAITrainingDataResult_Input;
class OAITrainingDataResult_Output;
class OAITrainingDataResult_Validation;

class OAIProjectVersionDescription_TrainingDataResult : public OAIObject {
public:
    OAIProjectVersionDescription_TrainingDataResult();
    OAIProjectVersionDescription_TrainingDataResult(QString json);
    ~OAIProjectVersionDescription_TrainingDataResult() override;
    ...
    OAITrainingDataResult_Input getInput() const;
    void setInput(const OAITrainingDataResult_Input &input);
    bool is_input_Set() const;
    bool is_input_Valid() const;

    OAITrainingDataResult_Output getOutput() const;
    void setOutput(const OAITrainingDataResult_Output &output);
    bool is_output_Set() const;
    bool is_output_Valid() const;

    OAITrainingDataResult_Validation getValidation() const;
    void setValidation(const OAITrainingDataResult_Validation &validation);
...
private:
    ...
    OAITrainingDataResult_Input m_input;
    bool m_input_isSet;
    bool m_input_isValid;

    OAITrainingDataResult_Output m_output;
    bool m_output_isSet;
    bool m_output_isValid;

    OAITrainingDataResult_Validation m_validation;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectVersionDescription_TrainingDataResult)

#endif // OAIProjectVersionDescription_TrainingDataResult_H
