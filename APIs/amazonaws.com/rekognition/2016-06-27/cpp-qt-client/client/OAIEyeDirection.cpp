...
OAIEyeDirection::OAIEyeDirection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEyeDirection::OAIEyeDirection() {
    this->initializeModel();
}

OAIEyeDirection::~OAIEyeDirection() {}

void OAIEyeDirection::initializeModel() {
...
void OAIEyeDirection::fromJson(QString jsonString) {
...
void OAIEyeDirection::fromJsonObject(QJsonObject json) {
...
QString OAIEyeDirection::asJson() const {
...
QJsonObject OAIEyeDirection::asJsonObject() const {
    QJsonObject obj;
    if (m_yaw_isSet) {
...
float OAIEyeDirection::getYaw() const {
    return m_yaw;
}
void OAIEyeDirection::setYaw(const float &yaw) {
    m_yaw = yaw;
    m_yaw_isSet = true;
}

bool OAIEyeDirection::is_yaw_Set() const{
    return m_yaw_isSet;
}

bool OAIEyeDirection::is_yaw_Valid() const{
    return m_yaw_isValid;
}

float OAIEyeDirection::getPitch() const {
    return m_pitch;
}
void OAIEyeDirection::setPitch(const float &pitch) {
    m_pitch = pitch;
    m_pitch_isSet = true;
}

bool OAIEyeDirection::is_pitch_Set() const{
    return m_pitch_isSet;
}

bool OAIEyeDirection::is_pitch_Valid() const{
    return m_pitch_isValid;
}

float OAIEyeDirection::getConfidence() const {
    return m_confidence;
}
void OAIEyeDirection::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIEyeDirection::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIEyeDirection::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIEyeDirection::isSet() const {
...
bool OAIEyeDirection::isValid() const {
