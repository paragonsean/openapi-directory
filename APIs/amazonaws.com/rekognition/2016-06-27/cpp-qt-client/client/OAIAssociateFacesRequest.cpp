...
#include "OAIAssociateFacesRequest.h"
...
OAIAssociateFacesRequest::OAIAssociateFacesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateFacesRequest::OAIAssociateFacesRequest() {
    this->initializeModel();
}

OAIAssociateFacesRequest::~OAIAssociateFacesRequest() {}

void OAIAssociateFacesRequest::initializeModel() {
...
void OAIAssociateFacesRequest::fromJson(QString jsonString) {
...
void OAIAssociateFacesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateFacesRequest::asJson() const {
...
QJsonObject OAIAssociateFacesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateFacesRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIAssociateFacesRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIAssociateFacesRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIAssociateFacesRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAIAssociateFacesRequest::getUserId() const {
    return m_user_id;
}
void OAIAssociateFacesRequest::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIAssociateFacesRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIAssociateFacesRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QList OAIAssociateFacesRequest::getFaceIds() const {
    return m_face_ids;
}
void OAIAssociateFacesRequest::setFaceIds(const QList &face_ids) {
    m_face_ids = face_ids;
    m_face_ids_isSet = true;
}

bool OAIAssociateFacesRequest::is_face_ids_Set() const{
    return m_face_ids_isSet;
}

bool OAIAssociateFacesRequest::is_face_ids_Valid() const{
    return m_face_ids_isValid;
}

float OAIAssociateFacesRequest::getUserMatchThreshold() const {
    return m_user_match_threshold;
}
void OAIAssociateFacesRequest::setUserMatchThreshold(const float &user_match_threshold) {
    m_user_match_threshold = user_match_threshold;
    m_user_match_threshold_isSet = true;
}

bool OAIAssociateFacesRequest::is_user_match_threshold_Set() const{
    return m_user_match_threshold_isSet;
}

bool OAIAssociateFacesRequest::is_user_match_threshold_Valid() const{
    return m_user_match_threshold_isValid;
}

QString OAIAssociateFacesRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIAssociateFacesRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIAssociateFacesRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIAssociateFacesRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

bool OAIAssociateFacesRequest::isSet() const {
...
bool OAIAssociateFacesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_collection_id_isValid && m_user_id_isValid && m_face_ids_isValid && true;
}
