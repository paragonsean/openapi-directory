...
OAIShotSegment::OAIShotSegment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShotSegment::OAIShotSegment() {
    this->initializeModel();
}

OAIShotSegment::~OAIShotSegment() {}

void OAIShotSegment::initializeModel() {
...
void OAIShotSegment::fromJson(QString jsonString) {
...
void OAIShotSegment::fromJsonObject(QJsonObject json) {
...
QString OAIShotSegment::asJson() const {
...
QJsonObject OAIShotSegment::asJsonObject() const {
    QJsonObject obj;
    if (m_index_isSet) {
...
qint32 OAIShotSegment::getIndex() const {
    return m_index;
}
void OAIShotSegment::setIndex(const qint32 &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAIShotSegment::is_index_Set() const{
    return m_index_isSet;
}

bool OAIShotSegment::is_index_Valid() const{
    return m_index_isValid;
}

float OAIShotSegment::getConfidence() const {
    return m_confidence;
}
void OAIShotSegment::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIShotSegment::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIShotSegment::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIShotSegment::isSet() const {
...
bool OAIShotSegment::isValid() const {
