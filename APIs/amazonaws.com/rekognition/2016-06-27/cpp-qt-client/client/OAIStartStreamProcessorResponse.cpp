...
#include "OAIStartStreamProcessorResponse.h"
...
OAIStartStreamProcessorResponse::OAIStartStreamProcessorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartStreamProcessorResponse::OAIStartStreamProcessorResponse() {
    this->initializeModel();
}

OAIStartStreamProcessorResponse::~OAIStartStreamProcessorResponse() {}

void OAIStartStreamProcessorResponse::initializeModel() {

    m_session_id_isSet = false;
    m_session_id_isValid = false;
}

void OAIStartStreamProcessorResponse::fromJson(QString jsonString) {
...
void OAIStartStreamProcessorResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStartStreamProcessorResponse::asJson() const {
...
QJsonObject OAIStartStreamProcessorResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartStreamProcessorResponse::getSessionId() const {
    return m_session_id;
}
void OAIStartStreamProcessorResponse::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIStartStreamProcessorResponse::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIStartStreamProcessorResponse::is_session_id_Valid() const{
    return m_session_id_isValid;
}

bool OAIStartStreamProcessorResponse::isSet() const {
...
bool OAIStartStreamProcessorResponse::isValid() const {
