...
void OAIBodyPart::initializeModel() {
    ...
    m_value = eOAIBodyPart::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIBodyPart::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FACE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBodyPart::FACE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HEAD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBodyPart::HEAD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LEFT_HAND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBodyPart::LEFT_HAND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RIGHT_HAND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBodyPart::RIGHT_HAND;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIBodyPart::fromJsonValue(QJsonValue json) {
...
QString OAIBodyPart::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIBodyPart::FACE:
            val = "FACE";
            break;
        case eOAIBodyPart::HEAD:
            val = "HEAD";
            break;
        case eOAIBodyPart::LEFT_HAND:
            val = "LEFT_HAND";
            break;
        case eOAIBodyPart::RIGHT_HAND:
            val = "RIGHT_HAND";
            break;
        default:
            break;
...
QJsonValue OAIBodyPart::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIBodyPart::eOAIBodyPart OAIBodyPart::getValue() const {
    return m_value;
}

void OAIBodyPart::setValue(const OAIBodyPart::eOAIBodyPart& value){
    m_value = value;
    m_value_isSet = true;
}
