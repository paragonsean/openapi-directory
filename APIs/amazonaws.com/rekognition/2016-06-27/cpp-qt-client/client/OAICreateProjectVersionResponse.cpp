...
#include "OAICreateProjectVersionResponse.h"
...
OAICreateProjectVersionResponse::OAICreateProjectVersionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateProjectVersionResponse::OAICreateProjectVersionResponse() {
    this->initializeModel();
}

OAICreateProjectVersionResponse::~OAICreateProjectVersionResponse() {}

void OAICreateProjectVersionResponse::initializeModel() {

    m_project_version_arn_isSet = false;
    m_project_version_arn_isValid = false;
}

void OAICreateProjectVersionResponse::fromJson(QString jsonString) {
...
void OAICreateProjectVersionResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateProjectVersionResponse::asJson() const {
...
QJsonObject OAICreateProjectVersionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateProjectVersionResponse::getProjectVersionArn() const {
    return m_project_version_arn;
}
void OAICreateProjectVersionResponse::setProjectVersionArn(const QString &project_version_arn) {
    m_project_version_arn = project_version_arn;
    m_project_version_arn_isSet = true;
}

bool OAICreateProjectVersionResponse::is_project_version_arn_Set() const{
    return m_project_version_arn_isSet;
}

bool OAICreateProjectVersionResponse::is_project_version_arn_Valid() const{
    return m_project_version_arn_isValid;
}

bool OAICreateProjectVersionResponse::isSet() const {
...
bool OAICreateProjectVersionResponse::isValid() const {
