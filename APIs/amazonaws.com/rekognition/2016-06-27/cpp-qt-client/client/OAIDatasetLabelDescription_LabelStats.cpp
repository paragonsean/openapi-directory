...
OAIDatasetLabelDescription_LabelStats::OAIDatasetLabelDescription_LabelStats(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasetLabelDescription_LabelStats::OAIDatasetLabelDescription_LabelStats() {
    this->initializeModel();
}

OAIDatasetLabelDescription_LabelStats::~OAIDatasetLabelDescription_LabelStats() {}

void OAIDatasetLabelDescription_LabelStats::initializeModel() {

    m_entry_count_isSet = false;
    m_entry_count_isValid = false;

    m_bounding_box_count_isSet = false;
    m_bounding_box_count_isValid = false;
}

void OAIDatasetLabelDescription_LabelStats::fromJson(QString jsonString) {
...
void OAIDatasetLabelDescription_LabelStats::fromJsonObject(QJsonObject json) {
    ...
    m_bounding_box_count_isValid = ::OpenAPI::fromJsonValue(m_bounding_box_count, json[QString("BoundingBoxCount")]);
    m_bounding_box_count_isSet = !json[QString("BoundingBoxCount")].isNull() && m_bounding_box_count_isValid;
}

QString OAIDatasetLabelDescription_LabelStats::asJson() const {
...
QJsonObject OAIDatasetLabelDescription_LabelStats::asJsonObject() const {
    QJsonObject obj;
    if (m_entry_count_isSet) {
        obj.insert(QString("EntryCount"), ::OpenAPI::toJsonValue(m_entry_count));
    }
    if (m_bounding_box_count_isSet) {
        obj.insert(QString("BoundingBoxCount"), ::OpenAPI::toJsonValue(m_bounding_box_count));
    }
    return obj;
}

qint32 OAIDatasetLabelDescription_LabelStats::getEntryCount() const {
    return m_entry_count;
}
void OAIDatasetLabelDescription_LabelStats::setEntryCount(const qint32 &entry_count) {
    m_entry_count = entry_count;
    m_entry_count_isSet = true;
}

bool OAIDatasetLabelDescription_LabelStats::is_entry_count_Set() const{
    return m_entry_count_isSet;
}

bool OAIDatasetLabelDescription_LabelStats::is_entry_count_Valid() const{
    return m_entry_count_isValid;
}

qint32 OAIDatasetLabelDescription_LabelStats::getBoundingBoxCount() const {
    return m_bounding_box_count;
}
void OAIDatasetLabelDescription_LabelStats::setBoundingBoxCount(const qint32 &bounding_box_count) {
    m_bounding_box_count = bounding_box_count;
    m_bounding_box_count_isSet = true;
}

bool OAIDatasetLabelDescription_LabelStats::is_bounding_box_count_Set() const{
    return m_bounding_box_count_isSet;
}

bool OAIDatasetLabelDescription_LabelStats::is_bounding_box_count_Valid() const{
    return m_bounding_box_count_isValid;
}

bool OAIDatasetLabelDescription_LabelStats::isSet() const {
...
bool OAIDatasetLabelDescription_LabelStats::isValid() const {
