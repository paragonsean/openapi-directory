...
#include "OAIGetFaceLivenessSessionResultsResponse_ReferenceImage.h"
...
OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::OAIGetFaceLivenessSessionResultsResponse_ReferenceImage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::OAIGetFaceLivenessSessionResultsResponse_ReferenceImage() {
    this->initializeModel();
}

OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::~OAIGetFaceLivenessSessionResultsResponse_ReferenceImage() {}

void OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::initializeModel() {
...
void OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::fromJson(QString jsonString) {
...
void OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::fromJsonObject(QJsonObject json) {
...
QString OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::asJson() const {
...
QJsonObject OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::getBytes() const {
    return m_bytes;
}
void OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIS3Object OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::getS3Object() const {
    return m_s3_object;
}
void OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::setS3Object(const OAIS3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

OAIBoundingBox OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::getBoundingBox() const {
    return m_bounding_box;
}
void OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::setBoundingBox(const OAIBoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::isSet() const {
...
bool OAIGetFaceLivenessSessionResultsResponse_ReferenceImage::isValid() const {
