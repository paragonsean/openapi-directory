...
#ifndef OAIUnsearchedFace_H
#define OAIUnsearchedFace_H
...
class OAIUnsearchedFace : public OAIObject {
public:
    OAIUnsearchedFace();
    OAIUnsearchedFace(QString json);
    ~OAIUnsearchedFace() override;
    ...
    OAIFaceDetail getFaceDetails() const;
    void setFaceDetails(const OAIFaceDetail &face_details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsearchedFace)

#endif // OAIUnsearchedFace_H
