...
OAIUserMatch::OAIUserMatch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserMatch::OAIUserMatch() {
    this->initializeModel();
}

OAIUserMatch::~OAIUserMatch() {}

void OAIUserMatch::initializeModel() {
...
void OAIUserMatch::fromJson(QString jsonString) {
...
void OAIUserMatch::fromJsonObject(QJsonObject json) {
...
QString OAIUserMatch::asJson() const {
...
QJsonObject OAIUserMatch::asJsonObject() const {
    QJsonObject obj;
...
float OAIUserMatch::getSimilarity() const {
    return m_similarity;
}
void OAIUserMatch::setSimilarity(const float &similarity) {
    m_similarity = similarity;
    m_similarity_isSet = true;
}

bool OAIUserMatch::is_similarity_Set() const{
    return m_similarity_isSet;
}

bool OAIUserMatch::is_similarity_Valid() const{
    return m_similarity_isValid;
}

OAIUserMatch_User OAIUserMatch::getUser() const {
    return m_user;
}
void OAIUserMatch::setUser(const OAIUserMatch_User &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIUserMatch::is_user_Set() const{
    return m_user_isSet;
}

bool OAIUserMatch::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIUserMatch::isSet() const {
...
bool OAIUserMatch::isValid() const {
