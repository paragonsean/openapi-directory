...
#include "OAIDeleteFacesResponse.h"
...
OAIDeleteFacesResponse::OAIDeleteFacesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFacesResponse::OAIDeleteFacesResponse() {
    this->initializeModel();
}

OAIDeleteFacesResponse::~OAIDeleteFacesResponse() {}

void OAIDeleteFacesResponse::initializeModel() {

    m_deleted_faces_isSet = false;
    m_deleted_faces_isValid = false;

    m_unsuccessful_face_deletions_isSet = false;
    m_unsuccessful_face_deletions_isValid = false;
}

void OAIDeleteFacesResponse::fromJson(QString jsonString) {
...
void OAIDeleteFacesResponse::fromJsonObject(QJsonObject json) {

    m_deleted_faces_isValid = ::OpenAPI::fromJsonValue(m_deleted_faces, json[QString("DeletedFaces")]);
    m_deleted_faces_isSet = !json[QString("DeletedFaces")].isNull() && m_deleted_faces_isValid;

    m_unsuccessful_face_deletions_isValid = ::OpenAPI::fromJsonValue(m_unsuccessful_face_deletions, json[QString("UnsuccessfulFaceDeletions")]);
    m_unsuccessful_face_deletions_isSet = !json[QString("UnsuccessfulFaceDeletions")].isNull() && m_unsuccessful_face_deletions_isValid;
}

QString OAIDeleteFacesResponse::asJson() const {
...
QJsonObject OAIDeleteFacesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_deleted_faces.isSet()) {
        obj.insert(QString("DeletedFaces"), ::OpenAPI::toJsonValue(m_deleted_faces));
    }
    if (m_unsuccessful_face_deletions.isSet()) {
        obj.insert(QString("UnsuccessfulFaceDeletions"), ::OpenAPI::toJsonValue(m_unsuccessful_face_deletions));
    }
    return obj;
}

QList OAIDeleteFacesResponse::getDeletedFaces() const {
    return m_deleted_faces;
}
void OAIDeleteFacesResponse::setDeletedFaces(const QList &deleted_faces) {
    m_deleted_faces = deleted_faces;
    m_deleted_faces_isSet = true;
}

bool OAIDeleteFacesResponse::is_deleted_faces_Set() const{
    return m_deleted_faces_isSet;
}

bool OAIDeleteFacesResponse::is_deleted_faces_Valid() const{
    return m_deleted_faces_isValid;
}

QList OAIDeleteFacesResponse::getUnsuccessfulFaceDeletions() const {
    return m_unsuccessful_face_deletions;
}
void OAIDeleteFacesResponse::setUnsuccessfulFaceDeletions(const QList &unsuccessful_face_deletions) {
    m_unsuccessful_face_deletions = unsuccessful_face_deletions;
    m_unsuccessful_face_deletions_isSet = true;
}

bool OAIDeleteFacesResponse::is_unsuccessful_face_deletions_Set() const{
    return m_unsuccessful_face_deletions_isSet;
}

bool OAIDeleteFacesResponse::is_unsuccessful_face_deletions_Valid() const{
    return m_unsuccessful_face_deletions_isValid;
}

bool OAIDeleteFacesResponse::isSet() const {
...
bool OAIDeleteFacesResponse::isValid() const {
