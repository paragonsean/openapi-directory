...
/*
 * OAIGetLabelDetectionRequestMetadata.h
 *
 * Contains metadata about a label detection request, including the SortBy and AggregateBy options.
 */

#ifndef OAIGetLabelDetectionRequestMetadata_H
#define OAIGetLabelDetectionRequestMetadata_H
...
class OAIGetLabelDetectionRequestMetadata : public OAIObject {
public:
    OAIGetLabelDetectionRequestMetadata();
    OAIGetLabelDetectionRequestMetadata(QString json);
    ~OAIGetLabelDetectionRequestMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLabelDetectionRequestMetadata)

#endif // OAIGetLabelDetectionRequestMetadata_H
