...
#ifndef OAIValidationData_H
#define OAIValidationData_H
...
class OAIValidationData : public OAIObject {
public:
    OAIValidationData();
    OAIValidationData(QString json);
    ~OAIValidationData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidationData)

#endif // OAIValidationData_H
