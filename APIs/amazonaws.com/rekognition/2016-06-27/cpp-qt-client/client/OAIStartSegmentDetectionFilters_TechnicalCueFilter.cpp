...
OAIStartSegmentDetectionFilters_TechnicalCueFilter::OAIStartSegmentDetectionFilters_TechnicalCueFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSegmentDetectionFilters_TechnicalCueFilter::OAIStartSegmentDetectionFilters_TechnicalCueFilter() {
    this->initializeModel();
}

OAIStartSegmentDetectionFilters_TechnicalCueFilter::~OAIStartSegmentDetectionFilters_TechnicalCueFilter() {}

void OAIStartSegmentDetectionFilters_TechnicalCueFilter::initializeModel() {
...
void OAIStartSegmentDetectionFilters_TechnicalCueFilter::fromJson(QString jsonString) {
...
void OAIStartSegmentDetectionFilters_TechnicalCueFilter::fromJsonObject(QJsonObject json) {
...
QString OAIStartSegmentDetectionFilters_TechnicalCueFilter::asJson() const {
...
QJsonObject OAIStartSegmentDetectionFilters_TechnicalCueFilter::asJsonObject() const {
    QJsonObject obj;
...
float OAIStartSegmentDetectionFilters_TechnicalCueFilter::getMinSegmentConfidence() const {
    return m_min_segment_confidence;
}
void OAIStartSegmentDetectionFilters_TechnicalCueFilter::setMinSegmentConfidence(const float &min_segment_confidence) {
    m_min_segment_confidence = min_segment_confidence;
    m_min_segment_confidence_isSet = true;
}

bool OAIStartSegmentDetectionFilters_TechnicalCueFilter::is_min_segment_confidence_Set() const{
    return m_min_segment_confidence_isSet;
}

bool OAIStartSegmentDetectionFilters_TechnicalCueFilter::is_min_segment_confidence_Valid() const{
    return m_min_segment_confidence_isValid;
}

OAIStartTechnicalCueDetectionFilter_BlackFrame OAIStartSegmentDetectionFilters_TechnicalCueFilter::getBlackFrame() const {
    return m_black_frame;
}
void OAIStartSegmentDetectionFilters_TechnicalCueFilter::setBlackFrame(const OAIStartTechnicalCueDetectionFilter_BlackFrame &black_frame) {
    m_black_frame = black_frame;
    m_black_frame_isSet = true;
}

bool OAIStartSegmentDetectionFilters_TechnicalCueFilter::is_black_frame_Set() const{
    return m_black_frame_isSet;
}

bool OAIStartSegmentDetectionFilters_TechnicalCueFilter::is_black_frame_Valid() const{
    return m_black_frame_isValid;
}

bool OAIStartSegmentDetectionFilters_TechnicalCueFilter::isSet() const {
...
bool OAIStartSegmentDetectionFilters_TechnicalCueFilter::isValid() const {
