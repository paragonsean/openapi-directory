...
/*
 * OAIGetContentModerationResponse_GetRequestMetadata.h
 *
 * 
 */

#ifndef OAIGetContentModerationResponse_GetRequestMetadata_H
#define OAIGetContentModerationResponse_GetRequestMetadata_H

#include <QJsonObject>

#include "OAIContentModerationAggregateBy.h"
#include "OAIContentModerationSortBy.h"
...
class OAIGetContentModerationResponse_GetRequestMetadata : public OAIObject {
public:
    OAIGetContentModerationResponse_GetRequestMetadata();
    OAIGetContentModerationResponse_GetRequestMetadata(QString json);
    ~OAIGetContentModerationResponse_GetRequestMetadata() override;
    ...
    OAIContentModerationSortBy getSortBy() const;
    void setSortBy(const OAIContentModerationSortBy &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    OAIContentModerationAggregateBy getAggregateBy() const;
    void setAggregateBy(const OAIContentModerationAggregateBy &aggregate_by);
...
private:
    ...
    OAIContentModerationSortBy m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    OAIContentModerationAggregateBy m_aggregate_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetContentModerationResponse_GetRequestMetadata)

#endif // OAIGetContentModerationResponse_GetRequestMetadata_H
