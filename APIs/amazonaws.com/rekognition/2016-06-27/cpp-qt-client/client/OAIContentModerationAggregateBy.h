...
/*
 * OAIContentModerationAggregateBy.h
 *
 * 
 */

#ifndef OAIContentModerationAggregateBy_H
#define OAIContentModerationAggregateBy_H
...
class OAIContentModerationAggregateBy : public OAIEnum {
public:
    OAIContentModerationAggregateBy();
    OAIContentModerationAggregateBy(QString json);
    ~OAIContentModerationAggregateBy() override;
    ...
    enum class eOAIContentModerationAggregateBy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TIMESTAMPS, 
        SEGMENTS
    };
    OAIContentModerationAggregateBy::eOAIContentModerationAggregateBy getValue() const;
    void setValue(const OAIContentModerationAggregateBy::eOAIContentModerationAggregateBy& value);
...
private:
    ...
    eOAIContentModerationAggregateBy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentModerationAggregateBy)

#endif // OAIContentModerationAggregateBy_H
