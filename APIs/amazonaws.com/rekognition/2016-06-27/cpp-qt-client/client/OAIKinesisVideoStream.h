...
/*
 * OAIKinesisVideoStream.h
 *
 * Kinesis video stream stream that provides the source streaming video for a Amazon Rekognition Video stream processor. For more information, see CreateStreamProcessor in the Amazon Rekognition Developer Guide.
 */

#ifndef OAIKinesisVideoStream_H
#define OAIKinesisVideoStream_H
...
class OAIKinesisVideoStream : public OAIObject {
public:
    OAIKinesisVideoStream();
    OAIKinesisVideoStream(QString json);
    ~OAIKinesisVideoStream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKinesisVideoStream)

#endif // OAIKinesisVideoStream_H
