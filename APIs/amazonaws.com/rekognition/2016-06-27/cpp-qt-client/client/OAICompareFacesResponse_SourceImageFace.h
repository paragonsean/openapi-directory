...
/*
 * OAICompareFacesResponse_SourceImageFace.h
 *
 * 
 */

#ifndef OAICompareFacesResponse_SourceImageFace_H
#define OAICompareFacesResponse_SourceImageFace_H
...
class OAICompareFacesResponse_SourceImageFace : public OAIObject {
public:
    OAICompareFacesResponse_SourceImageFace();
    OAICompareFacesResponse_SourceImageFace(QString json);
    ~OAICompareFacesResponse_SourceImageFace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompareFacesResponse_SourceImageFace)

#endif // OAICompareFacesResponse_SourceImageFace_H
