...
#include "OAICreateFaceLivenessSessionRequest_Settings.h"
...
OAICreateFaceLivenessSessionRequest_Settings::OAICreateFaceLivenessSessionRequest_Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFaceLivenessSessionRequest_Settings::OAICreateFaceLivenessSessionRequest_Settings() {
    this->initializeModel();
}

OAICreateFaceLivenessSessionRequest_Settings::~OAICreateFaceLivenessSessionRequest_Settings() {}

void OAICreateFaceLivenessSessionRequest_Settings::initializeModel() {

    m_output_config_isSet = false;
    m_output_config_isValid = false;

    m_audit_images_limit_isSet = false;
    m_audit_images_limit_isValid = false;
}

void OAICreateFaceLivenessSessionRequest_Settings::fromJson(QString jsonString) {
...
void OAICreateFaceLivenessSessionRequest_Settings::fromJsonObject(QJsonObject json) {
    ...
    m_audit_images_limit_isValid = ::OpenAPI::fromJsonValue(m_audit_images_limit, json[QString("AuditImagesLimit")]);
    m_audit_images_limit_isSet = !json[QString("AuditImagesLimit")].isNull() && m_audit_images_limit_isValid;
}

QString OAICreateFaceLivenessSessionRequest_Settings::asJson() const {
...
QJsonObject OAICreateFaceLivenessSessionRequest_Settings::asJsonObject() const {
    QJsonObject obj;
    if (m_output_config.isSet()) {
        obj.insert(QString("OutputConfig"), ::OpenAPI::toJsonValue(m_output_config));
    }
    if (m_audit_images_limit_isSet) {
        obj.insert(QString("AuditImagesLimit"), ::OpenAPI::toJsonValue(m_audit_images_limit));
    }
    return obj;
}

OAICreateFaceLivenessSessionRequestSettings_OutputConfig OAICreateFaceLivenessSessionRequest_Settings::getOutputConfig() const {
    return m_output_config;
}
void OAICreateFaceLivenessSessionRequest_Settings::setOutputConfig(const OAICreateFaceLivenessSessionRequestSettings_OutputConfig &output_config) {
    m_output_config = output_config;
    m_output_config_isSet = true;
}

bool OAICreateFaceLivenessSessionRequest_Settings::is_output_config_Set() const{
    return m_output_config_isSet;
}

bool OAICreateFaceLivenessSessionRequest_Settings::is_output_config_Valid() const{
    return m_output_config_isValid;
}

qint32 OAICreateFaceLivenessSessionRequest_Settings::getAuditImagesLimit() const {
    return m_audit_images_limit;
}
void OAICreateFaceLivenessSessionRequest_Settings::setAuditImagesLimit(const qint32 &audit_images_limit) {
    m_audit_images_limit = audit_images_limit;
    m_audit_images_limit_isSet = true;
}

bool OAICreateFaceLivenessSessionRequest_Settings::is_audit_images_limit_Set() const{
    return m_audit_images_limit_isSet;
}

bool OAICreateFaceLivenessSessionRequest_Settings::is_audit_images_limit_Valid() const{
    return m_audit_images_limit_isValid;
}

bool OAICreateFaceLivenessSessionRequest_Settings::isSet() const {
...
bool OAICreateFaceLivenessSessionRequest_Settings::isValid() const {
