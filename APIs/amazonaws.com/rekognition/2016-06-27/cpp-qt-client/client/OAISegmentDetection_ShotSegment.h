...
/*
 * OAISegmentDetection_ShotSegment.h
 *
 * 
 */

#ifndef OAISegmentDetection_ShotSegment_H
#define OAISegmentDetection_ShotSegment_H
...
class OAISegmentDetection_ShotSegment : public OAIObject {
public:
    OAISegmentDetection_ShotSegment();
    OAISegmentDetection_ShotSegment(QString json);
    ~OAISegmentDetection_ShotSegment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISegmentDetection_ShotSegment)

#endif // OAISegmentDetection_ShotSegment_H
