...
/*
 * OAICreateProjectVersionRequest.h
 *
 * 
 */

#ifndef OAICreateProjectVersionRequest_H
#define OAICreateProjectVersionRequest_H

#include <QJsonObject>

#include "OAICreateProjectVersionRequest_OutputConfig.h"
#include "OAICreateProjectVersionRequest_TestingData.h"
#include "OAICreateProjectVersionRequest_TrainingData.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAICreateProjectVersionRequest_OutputConfig;
class OAICreateProjectVersionRequest_TrainingData;
class OAICreateProjectVersionRequest_TestingData;

class OAICreateProjectVersionRequest : public OAIObject {
public:
    OAICreateProjectVersionRequest();
    OAICreateProjectVersionRequest(QString json);
    ~OAICreateProjectVersionRequest() override;
    ...
    OAICreateProjectVersionRequest_OutputConfig getOutputConfig() const;
    void setOutputConfig(const OAICreateProjectVersionRequest_OutputConfig &output_config);
    bool is_output_config_Set() const;
    bool is_output_config_Valid() const;

    OAICreateProjectVersionRequest_TrainingData getTrainingData() const;
    void setTrainingData(const OAICreateProjectVersionRequest_TrainingData &training_data);
    bool is_training_data_Set() const;
    bool is_training_data_Valid() const;

    OAICreateProjectVersionRequest_TestingData getTestingData() const;
    void setTestingData(const OAICreateProjectVersionRequest_TestingData &testing_data);
    bool is_testing_data_Set() const;
    bool is_testing_data_Valid() const;
...
private:
    ...
    OAICreateProjectVersionRequest_OutputConfig m_output_config;
    bool m_output_config_isSet;
    bool m_output_config_isValid;

    OAICreateProjectVersionRequest_TrainingData m_training_data;
    bool m_training_data_isSet;
    bool m_training_data_isValid;

    OAICreateProjectVersionRequest_TestingData m_testing_data;
    bool m_testing_data_isSet;
    bool m_testing_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectVersionRequest)

#endif // OAICreateProjectVersionRequest_H
