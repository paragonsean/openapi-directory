...
#include "OAIUpdateStreamProcessorRequest.h"
...
OAIUpdateStreamProcessorRequest::OAIUpdateStreamProcessorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateStreamProcessorRequest::OAIUpdateStreamProcessorRequest() {
    this->initializeModel();
}

OAIUpdateStreamProcessorRequest::~OAIUpdateStreamProcessorRequest() {}

void OAIUpdateStreamProcessorRequest::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;

    m_settings_for_update_isSet = false;
    m_settings_for_update_isValid = false;

    m_regions_of_interest_for_update_isSet = false;
    m_regions_of_interest_for_update_isValid = false;

    m_data_sharing_preference_for_update_isSet = false;
    m_data_sharing_preference_for_update_isValid = false;

    m_parameters_to_delete_isSet = false;
    m_parameters_to_delete_isValid = false;
}

void OAIUpdateStreamProcessorRequest::fromJson(QString jsonString) {
...
void OAIUpdateStreamProcessorRequest::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;

    m_settings_for_update_isValid = ::OpenAPI::fromJsonValue(m_settings_for_update, json[QString("SettingsForUpdate")]);
    m_settings_for_update_isSet = !json[QString("SettingsForUpdate")].isNull() && m_settings_for_update_isValid;

    m_regions_of_interest_for_update_isValid = ::OpenAPI::fromJsonValue(m_regions_of_interest_for_update, json[QString("RegionsOfInterestForUpdate")]);
    m_regions_of_interest_for_update_isSet = !json[QString("RegionsOfInterestForUpdate")].isNull() && m_regions_of_interest_for_update_isValid;

    m_data_sharing_preference_for_update_isValid = ::OpenAPI::fromJsonValue(m_data_sharing_preference_for_update, json[QString("DataSharingPreferenceForUpdate")]);
    m_data_sharing_preference_for_update_isSet = !json[QString("DataSharingPreferenceForUpdate")].isNull() && m_data_sharing_preference_for_update_isValid;

    m_parameters_to_delete_isValid = ::OpenAPI::fromJsonValue(m_parameters_to_delete, json[QString("ParametersToDelete")]);
    m_parameters_to_delete_isSet = !json[QString("ParametersToDelete")].isNull() && m_parameters_to_delete_isValid;
}

QString OAIUpdateStreamProcessorRequest::asJson() const {
...
QJsonObject OAIUpdateStreamProcessorRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
        obj.insert(QString("Name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_settings_for_update.isSet()) {
        obj.insert(QString("SettingsForUpdate"), ::OpenAPI::toJsonValue(m_settings_for_update));
    }
    if (m_regions_of_interest_for_update.isSet()) {
        obj.insert(QString("RegionsOfInterestForUpdate"), ::OpenAPI::toJsonValue(m_regions_of_interest_for_update));
    }
    if (m_data_sharing_preference_for_update.isSet()) {
        obj.insert(QString("DataSharingPreferenceForUpdate"), ::OpenAPI::toJsonValue(m_data_sharing_preference_for_update));
    }
    if (m_parameters_to_delete.isSet()) {
        obj.insert(QString("ParametersToDelete"), ::OpenAPI::toJsonValue(m_parameters_to_delete));
    }
    return obj;
}

QString OAIUpdateStreamProcessorRequest::getName() const {
    return m_name;
}
void OAIUpdateStreamProcessorRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateStreamProcessorRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateStreamProcessorRequest::is_name_Valid() const{
    return m_name_isValid;
}

OAIUpdateStreamProcessorRequest_SettingsForUpdate OAIUpdateStreamProcessorRequest::getSettingsForUpdate() const {
    return m_settings_for_update;
}
void OAIUpdateStreamProcessorRequest::setSettingsForUpdate(const OAIUpdateStreamProcessorRequest_SettingsForUpdate &settings_for_update) {
    m_settings_for_update = settings_for_update;
    m_settings_for_update_isSet = true;
}

bool OAIUpdateStreamProcessorRequest::is_settings_for_update_Set() const{
    return m_settings_for_update_isSet;
}

bool OAIUpdateStreamProcessorRequest::is_settings_for_update_Valid() const{
    return m_settings_for_update_isValid;
}

QList OAIUpdateStreamProcessorRequest::getRegionsOfInterestForUpdate() const {
    return m_regions_of_interest_for_update;
}
void OAIUpdateStreamProcessorRequest::setRegionsOfInterestForUpdate(const QList &regions_of_interest_for_update) {
    m_regions_of_interest_for_update = regions_of_interest_for_update;
    m_regions_of_interest_for_update_isSet = true;
}

bool OAIUpdateStreamProcessorRequest::is_regions_of_interest_for_update_Set() const{
    return m_regions_of_interest_for_update_isSet;
}

bool OAIUpdateStreamProcessorRequest::is_regions_of_interest_for_update_Valid() const{
    return m_regions_of_interest_for_update_isValid;
}

OAICreateStreamProcessorRequest_DataSharingPreference OAIUpdateStreamProcessorRequest::getDataSharingPreferenceForUpdate() const {
    return m_data_sharing_preference_for_update;
}
void OAIUpdateStreamProcessorRequest::setDataSharingPreferenceForUpdate(const OAICreateStreamProcessorRequest_DataSharingPreference &data_sharing_preference_for_update) {
    m_data_sharing_preference_for_update = data_sharing_preference_for_update;
    m_data_sharing_preference_for_update_isSet = true;
}

bool OAIUpdateStreamProcessorRequest::is_data_sharing_preference_for_update_Set() const{
    return m_data_sharing_preference_for_update_isSet;
}

bool OAIUpdateStreamProcessorRequest::is_data_sharing_preference_for_update_Valid() const{
    return m_data_sharing_preference_for_update_isValid;
}

QList OAIUpdateStreamProcessorRequest::getParametersToDelete() const {
    return m_parameters_to_delete;
}
void OAIUpdateStreamProcessorRequest::setParametersToDelete(const QList &parameters_to_delete) {
    m_parameters_to_delete = parameters_to_delete;
    m_parameters_to_delete_isSet = true;
}

bool OAIUpdateStreamProcessorRequest::is_parameters_to_delete_Set() const{
    return m_parameters_to_delete_isSet;
}

bool OAIUpdateStreamProcessorRequest::is_parameters_to_delete_Valid() const{
    return m_parameters_to_delete_isValid;
}

bool OAIUpdateStreamProcessorRequest::isSet() const {
...
bool OAIUpdateStreamProcessorRequest::isValid() const {
