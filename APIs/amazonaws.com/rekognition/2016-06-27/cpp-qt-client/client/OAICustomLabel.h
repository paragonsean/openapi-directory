...
#include "OAICustomLabel_Geometry.h"
#include <QString>
...
public:
    ...
    OAICustomLabel_Geometry getGeometry() const;
    void setGeometry(const OAICustomLabel_Geometry &geometry);
...
private:
    ...
    OAICustomLabel_Geometry m_geometry;
