...
/*
 * OAIRecognizeCelebritiesResponse.h
 *
 * 
 */

#ifndef OAIRecognizeCelebritiesResponse_H
#define OAIRecognizeCelebritiesResponse_H
...
class OAIRecognizeCelebritiesResponse : public OAIObject {
public:
    OAIRecognizeCelebritiesResponse();
    OAIRecognizeCelebritiesResponse(QString json);
    ~OAIRecognizeCelebritiesResponse() override;
    ...
    QList getCelebrityFaces() const;
    void setCelebrityFaces(const QList &celebrity_faces);
    bool is_celebrity_faces_Set() const;
    bool is_celebrity_faces_Valid() const;

    QList getUnrecognizedFaces() const;
    void setUnrecognizedFaces(const QList &unrecognized_faces);
    bool is_unrecognized_faces_Set() const;
    bool is_unrecognized_faces_Valid() const;

    OAIOrientationCorrection getOrientationCorrection() const;
    void setOrientationCorrection(const OAIOrientationCorrection &orientation_correction);
    bool is_orientation_correction_Set() const;
    bool is_orientation_correction_Valid() const;
...
private:
    ...
    QList m_celebrity_faces;
    bool m_celebrity_faces_isSet;
    bool m_celebrity_faces_isValid;

    QList m_unrecognized_faces;
    bool m_unrecognized_faces_isSet;
    bool m_unrecognized_faces_isValid;

    OAIOrientationCorrection m_orientation_correction;
    bool m_orientation_correction_isSet;
    bool m_orientation_correction_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRecognizeCelebritiesResponse)

#endif // OAIRecognizeCelebritiesResponse_H
