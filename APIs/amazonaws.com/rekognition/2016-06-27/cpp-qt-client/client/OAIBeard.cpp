...
OAIBeard::OAIBeard(QString json) {
...
void OAIBeard::fromJson(QString jsonString) {
...
void OAIBeard::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIBeard::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIBeard::getValue() const {
    return m_value;
}
void OAIBeard::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIBeard::is_value_Set() const{
    return m_value_isSet;
}

bool OAIBeard::is_value_Valid() const{
    return m_value_isValid;
}

float OAIBeard::getConfidence() const {
    return m_confidence;
}
void OAIBeard::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIBeard::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIBeard::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIBeard::isSet() const {
