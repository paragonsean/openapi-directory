...
#include "OAIDetectLabelsImageQuality.h"
...
OAIDetectLabelsImageQuality::OAIDetectLabelsImageQuality(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageQuality::OAIDetectLabelsImageQuality() {
    this->initializeModel();
}

OAIDetectLabelsImageQuality::~OAIDetectLabelsImageQuality() {}

void OAIDetectLabelsImageQuality::initializeModel() {
...
void OAIDetectLabelsImageQuality::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageQuality::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageQuality::asJson() const {
...
QJsonObject OAIDetectLabelsImageQuality::asJsonObject() const {
    QJsonObject obj;
...
float OAIDetectLabelsImageQuality::getBrightness() const {
    return m_brightness;
}
void OAIDetectLabelsImageQuality::setBrightness(const float &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIDetectLabelsImageQuality::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIDetectLabelsImageQuality::is_brightness_Valid() const{
    return m_brightness_isValid;
}

float OAIDetectLabelsImageQuality::getSharpness() const {
    return m_sharpness;
}
void OAIDetectLabelsImageQuality::setSharpness(const float &sharpness) {
    m_sharpness = sharpness;
    m_sharpness_isSet = true;
}

bool OAIDetectLabelsImageQuality::is_sharpness_Set() const{
    return m_sharpness_isSet;
}

bool OAIDetectLabelsImageQuality::is_sharpness_Valid() const{
    return m_sharpness_isValid;
}

float OAIDetectLabelsImageQuality::getContrast() const {
    return m_contrast;
}
void OAIDetectLabelsImageQuality::setContrast(const float &contrast) {
    m_contrast = contrast;
    m_contrast_isSet = true;
}

bool OAIDetectLabelsImageQuality::is_contrast_Set() const{
    return m_contrast_isSet;
}

bool OAIDetectLabelsImageQuality::is_contrast_Valid() const{
    return m_contrast_isValid;
}

bool OAIDetectLabelsImageQuality::isSet() const {
...
bool OAIDetectLabelsImageQuality::isValid() const {
