...
void OAIFaceAttributes::initializeModel() {
    ...
    m_value = eOAIFaceAttributes::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFaceAttributes::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DEFAULT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFaceAttributes::DEFAULT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFaceAttributes::ALL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFaceAttributes::fromJsonValue(QJsonValue json) {
...
QString OAIFaceAttributes::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIFaceAttributes::DEFAULT:
            val = "DEFAULT";
            break;
        case eOAIFaceAttributes::ALL:
            val = "ALL";
            break;
        default:
            break;
...
QJsonValue OAIFaceAttributes::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFaceAttributes::eOAIFaceAttributes OAIFaceAttributes::getValue() const {
    return m_value;
}

void OAIFaceAttributes::setValue(const OAIFaceAttributes::eOAIFaceAttributes& value){
    m_value = value;
    m_value_isSet = true;
}
