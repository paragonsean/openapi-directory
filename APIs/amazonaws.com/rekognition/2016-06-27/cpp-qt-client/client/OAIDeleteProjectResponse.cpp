...
OAIProjectStatus OAIDeleteProjectResponse::getStatus() const {
    return m_status;
}
void OAIDeleteProjectResponse::setStatus(const OAIProjectStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeleteProjectResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeleteProjectResponse::is_status_Valid() const{
