...
/*
 * OAICelebrityDetail_BoundingBox.h
 *
 * 
 */

#ifndef OAICelebrityDetail_BoundingBox_H
#define OAICelebrityDetail_BoundingBox_H
...
class OAICelebrityDetail_BoundingBox : public OAIObject {
public:
    OAICelebrityDetail_BoundingBox();
    OAICelebrityDetail_BoundingBox(QString json);
    ~OAICelebrityDetail_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICelebrityDetail_BoundingBox)

#endif // OAICelebrityDetail_BoundingBox_H
