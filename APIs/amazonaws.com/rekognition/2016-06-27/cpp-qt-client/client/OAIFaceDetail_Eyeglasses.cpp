...
#include "OAIFaceDetail_Eyeglasses.h"
...
OAIFaceDetail_Eyeglasses::OAIFaceDetail_Eyeglasses(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail_Eyeglasses::OAIFaceDetail_Eyeglasses() {
    this->initializeModel();
}

OAIFaceDetail_Eyeglasses::~OAIFaceDetail_Eyeglasses() {}

void OAIFaceDetail_Eyeglasses::initializeModel() {
...
void OAIFaceDetail_Eyeglasses::fromJson(QString jsonString) {
...
void OAIFaceDetail_Eyeglasses::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail_Eyeglasses::asJson() const {
...
QJsonObject OAIFaceDetail_Eyeglasses::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIFaceDetail_Eyeglasses::getValue() const {
    return m_value;
}
void OAIFaceDetail_Eyeglasses::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFaceDetail_Eyeglasses::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFaceDetail_Eyeglasses::is_value_Valid() const{
    return m_value_isValid;
}

float OAIFaceDetail_Eyeglasses::getConfidence() const {
    return m_confidence;
}
void OAIFaceDetail_Eyeglasses::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceDetail_Eyeglasses::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceDetail_Eyeglasses::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIFaceDetail_Eyeglasses::isSet() const {
...
bool OAIFaceDetail_Eyeglasses::isValid() const {
