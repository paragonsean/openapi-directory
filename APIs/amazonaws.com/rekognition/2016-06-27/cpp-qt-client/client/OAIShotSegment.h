...
#ifndef OAIShotSegment_H
#define OAIShotSegment_H
...
class OAIShotSegment : public OAIObject {
public:
    OAIShotSegment();
    OAIShotSegment(QString json);
    ~OAIShotSegment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShotSegment)

#endif // OAIShotSegment_H
