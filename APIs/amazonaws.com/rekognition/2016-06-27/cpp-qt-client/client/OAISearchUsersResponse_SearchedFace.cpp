...
#include "OAISearchUsersResponse_SearchedFace.h"
...
OAISearchUsersResponse_SearchedFace::OAISearchUsersResponse_SearchedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchUsersResponse_SearchedFace::OAISearchUsersResponse_SearchedFace() {
    this->initializeModel();
}

OAISearchUsersResponse_SearchedFace::~OAISearchUsersResponse_SearchedFace() {}

void OAISearchUsersResponse_SearchedFace::initializeModel() {

    m_face_id_isSet = false;
    m_face_id_isValid = false;
}

void OAISearchUsersResponse_SearchedFace::fromJson(QString jsonString) {
...
void OAISearchUsersResponse_SearchedFace::fromJsonObject(QJsonObject json) {
...
QString OAISearchUsersResponse_SearchedFace::asJson() const {
...
QJsonObject OAISearchUsersResponse_SearchedFace::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
...
QString OAISearchUsersResponse_SearchedFace::getFaceId() const {
    return m_face_id;
}
void OAISearchUsersResponse_SearchedFace::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAISearchUsersResponse_SearchedFace::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAISearchUsersResponse_SearchedFace::is_face_id_Valid() const{
    return m_face_id_isValid;
}

bool OAISearchUsersResponse_SearchedFace::isSet() const {
...
bool OAISearchUsersResponse_SearchedFace::isValid() const {
