...
void OAIVideoMetadata::initializeModel() {
    ...
    m_frame_height_isSet = false;
    m_frame_height_isValid = false;

    m_frame_width_isSet = false;
    m_frame_width_isValid = false;
...
void OAIVideoMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_frame_height_isValid = ::OpenAPI::fromJsonValue(m_frame_height, json[QString("FrameHeight")]);
    m_frame_height_isSet = !json[QString("FrameHeight")].isNull() && m_frame_height_isValid;

    m_frame_width_isValid = ::OpenAPI::fromJsonValue(m_frame_width, json[QString("FrameWidth")]);
    m_frame_width_isSet = !json[QString("FrameWidth")].isNull() && m_frame_width_isValid;
...
QJsonObject OAIVideoMetadata::asJsonObject() const {
    ...
    if (m_frame_height_isSet) {
        obj.insert(QString("FrameHeight"), ::OpenAPI::toJsonValue(m_frame_height));
    }
    if (m_frame_width_isSet) {
        obj.insert(QString("FrameWidth"), ::OpenAPI::toJsonValue(m_frame_width));
    }
    if (m_color_range.isSet()) {
        obj.insert(QString("ColorRange"), ::OpenAPI::toJsonValue(m_color_range));
    }
    return obj;
}

QString OAIVideoMetadata::getCodec() const {
    return m_codec;
}
void OAIVideoMetadata::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIVideoMetadata::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIVideoMetadata::is_codec_Valid() const{
    return m_codec_isValid;
}

qint32 OAIVideoMetadata::getDurationMillis() const {
    return m_duration_millis;
}
void OAIVideoMetadata::setDurationMillis(const qint32 &duration_millis) {
    m_duration_millis = duration_millis;
    m_duration_millis_isSet = true;
}

bool OAIVideoMetadata::is_duration_millis_Set() const{
    return m_duration_millis_isSet;
}

bool OAIVideoMetadata::is_duration_millis_Valid() const{
    return m_duration_millis_isValid;
}

QString OAIVideoMetadata::getFormat() const {
    return m_format;
}
void OAIVideoMetadata::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIVideoMetadata::is_format_Set() const{
    return m_format_isSet;
}

bool OAIVideoMetadata::is_format_Valid() const{
    return m_format_isValid;
}

float OAIVideoMetadata::getFrameRate() const {
    return m_frame_rate;
}
void OAIVideoMetadata::setFrameRate(const float &frame_rate) {
    m_frame_rate = frame_rate;
    m_frame_rate_isSet = true;
}

bool OAIVideoMetadata::is_frame_rate_Set() const{
    return m_frame_rate_isSet;
}

bool OAIVideoMetadata::is_frame_rate_Valid() const{
    return m_frame_rate_isValid;
}

qint32 OAIVideoMetadata::getFrameHeight() const {
    return m_frame_height;
}
void OAIVideoMetadata::setFrameHeight(const qint32 &frame_height) {
    m_frame_height = frame_height;
    m_frame_height_isSet = true;
}

bool OAIVideoMetadata::is_frame_height_Set() const{
    return m_frame_height_isSet;
}

bool OAIVideoMetadata::is_frame_height_Valid() const{
    return m_frame_height_isValid;
}

qint32 OAIVideoMetadata::getFrameWidth() const {
    return m_frame_width;
}
void OAIVideoMetadata::setFrameWidth(const qint32 &frame_width) {
    m_frame_width = frame_width;
    m_frame_width_isSet = true;
}

bool OAIVideoMetadata::is_frame_width_Set() const{
    return m_frame_width_isSet;
}

bool OAIVideoMetadata::is_frame_width_Valid() const{
    return m_frame_width_isValid;
}

OAIVideoColorRange OAIVideoMetadata::getColorRange() const {
    return m_color_range;
}
void OAIVideoMetadata::setColorRange(const OAIVideoColorRange &color_range) {
    m_color_range = color_range;
    m_color_range_isSet = true;
}

bool OAIVideoMetadata::is_color_range_Set() const{
    return m_color_range_isSet;
}

bool OAIVideoMetadata::is_color_range_Valid() const{
