...
#include "OAITechnicalCueSegment.h"
...
OAITechnicalCueSegment::OAITechnicalCueSegment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITechnicalCueSegment::OAITechnicalCueSegment() {
    this->initializeModel();
}

OAITechnicalCueSegment::~OAITechnicalCueSegment() {}

void OAITechnicalCueSegment::initializeModel() {
...
void OAITechnicalCueSegment::fromJson(QString jsonString) {
...
void OAITechnicalCueSegment::fromJsonObject(QJsonObject json) {
...
QString OAITechnicalCueSegment::asJson() const {
...
QJsonObject OAITechnicalCueSegment::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAITechnicalCueType OAITechnicalCueSegment::getType() const {
    return m_type;
}
void OAITechnicalCueSegment::setType(const OAITechnicalCueType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAITechnicalCueSegment::is_type_Set() const{
    return m_type_isSet;
}

bool OAITechnicalCueSegment::is_type_Valid() const{
    return m_type_isValid;
}

float OAITechnicalCueSegment::getConfidence() const {
    return m_confidence;
}
void OAITechnicalCueSegment::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAITechnicalCueSegment::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAITechnicalCueSegment::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAITechnicalCueSegment::isSet() const {
...
bool OAITechnicalCueSegment::isValid() const {
