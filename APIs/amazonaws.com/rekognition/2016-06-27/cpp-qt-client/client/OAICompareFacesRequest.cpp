...
#include "OAICompareFacesRequest.h"
...
OAICompareFacesRequest::OAICompareFacesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompareFacesRequest::OAICompareFacesRequest() {
    this->initializeModel();
}

OAICompareFacesRequest::~OAICompareFacesRequest() {}

void OAICompareFacesRequest::initializeModel() {
    ...
    m_similarity_threshold_isSet = false;
    m_similarity_threshold_isValid = false;

    m_quality_filter_isSet = false;
    m_quality_filter_isValid = false;
}

void OAICompareFacesRequest::fromJson(QString jsonString) {
...
void OAICompareFacesRequest::fromJsonObject(QJsonObject json) {
    ...
    m_similarity_threshold_isValid = ::OpenAPI::fromJsonValue(m_similarity_threshold, json[QString("SimilarityThreshold")]);
    m_similarity_threshold_isSet = !json[QString("SimilarityThreshold")].isNull() && m_similarity_threshold_isValid;
...
QString OAICompareFacesRequest::asJson() const {
...
QJsonObject OAICompareFacesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_source_image.isSet()) {
        obj.insert(QString("SourceImage"), ::OpenAPI::toJsonValue(m_source_image));
    }
    if (m_target_image.isSet()) {
        obj.insert(QString("TargetImage"), ::OpenAPI::toJsonValue(m_target_image));
    }
    if (m_similarity_threshold_isSet) {
        obj.insert(QString("SimilarityThreshold"), ::OpenAPI::toJsonValue(m_similarity_threshold));
    }
...
OAICompareFacesRequest_SourceImage OAICompareFacesRequest::getSourceImage() const {
    return m_source_image;
}
void OAICompareFacesRequest::setSourceImage(const OAICompareFacesRequest_SourceImage &source_image) {
    m_source_image = source_image;
    m_source_image_isSet = true;
}

bool OAICompareFacesRequest::is_source_image_Set() const{
    return m_source_image_isSet;
}

bool OAICompareFacesRequest::is_source_image_Valid() const{
    return m_source_image_isValid;
}

OAICompareFacesRequest_TargetImage OAICompareFacesRequest::getTargetImage() const {
    return m_target_image;
}
void OAICompareFacesRequest::setTargetImage(const OAICompareFacesRequest_TargetImage &target_image) {
    m_target_image = target_image;
    m_target_image_isSet = true;
}

bool OAICompareFacesRequest::is_target_image_Set() const{
    return m_target_image_isSet;
}

bool OAICompareFacesRequest::is_target_image_Valid() const{
    return m_target_image_isValid;
}

float OAICompareFacesRequest::getSimilarityThreshold() const {
    return m_similarity_threshold;
}
void OAICompareFacesRequest::setSimilarityThreshold(const float &similarity_threshold) {
    m_similarity_threshold = similarity_threshold;
    m_similarity_threshold_isSet = true;
}

bool OAICompareFacesRequest::is_similarity_threshold_Set() const{
    return m_similarity_threshold_isSet;
}

bool OAICompareFacesRequest::is_similarity_threshold_Valid() const{
    return m_similarity_threshold_isValid;
}

OAIQualityFilter OAICompareFacesRequest::getQualityFilter() const {
    return m_quality_filter;
}
void OAICompareFacesRequest::setQualityFilter(const OAIQualityFilter &quality_filter) {
    m_quality_filter = quality_filter;
    m_quality_filter_isSet = true;
}

bool OAICompareFacesRequest::is_quality_filter_Set() const{
    return m_quality_filter_isSet;
}

bool OAICompareFacesRequest::is_quality_filter_Valid() const{
    return m_quality_filter_isValid;
}

bool OAICompareFacesRequest::isSet() const {
...
bool OAICompareFacesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_source_image_isValid && m_target_image_isValid && true;
}
