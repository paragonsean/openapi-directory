...
#include "OAITextDetectionResult_TextDetection.h"
...
OAITextDetectionResult_TextDetection::OAITextDetectionResult_TextDetection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITextDetectionResult_TextDetection::OAITextDetectionResult_TextDetection() {
    this->initializeModel();
}

OAITextDetectionResult_TextDetection::~OAITextDetectionResult_TextDetection() {}

void OAITextDetectionResult_TextDetection::initializeModel() {

    m_detected_text_isSet = false;
    m_detected_text_isValid = false;
...
void OAITextDetectionResult_TextDetection::fromJson(QString jsonString) {
...
void OAITextDetectionResult_TextDetection::fromJsonObject(QJsonObject json) {

    m_detected_text_isValid = ::OpenAPI::fromJsonValue(m_detected_text, json[QString("DetectedText")]);
    m_detected_text_isSet = !json[QString("DetectedText")].isNull() && m_detected_text_isValid;
...
QString OAITextDetectionResult_TextDetection::asJson() const {
...
QJsonObject OAITextDetectionResult_TextDetection::asJsonObject() const {
    QJsonObject obj;
    if (m_detected_text_isSet) {
        obj.insert(QString("DetectedText"), ::OpenAPI::toJsonValue(m_detected_text));
    }
    if (m_type.isSet()) {
...
QString OAITextDetectionResult_TextDetection::getDetectedText() const {
    return m_detected_text;
}
void OAITextDetectionResult_TextDetection::setDetectedText(const QString &detected_text) {
    m_detected_text = detected_text;
    m_detected_text_isSet = true;
}

bool OAITextDetectionResult_TextDetection::is_detected_text_Set() const{
    return m_detected_text_isSet;
}

bool OAITextDetectionResult_TextDetection::is_detected_text_Valid() const{
    return m_detected_text_isValid;
}

OAITextTypes OAITextDetectionResult_TextDetection::getType() const {
    return m_type;
}
void OAITextDetectionResult_TextDetection::setType(const OAITextTypes &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAITextDetectionResult_TextDetection::is_type_Set() const{
    return m_type_isSet;
}

bool OAITextDetectionResult_TextDetection::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAITextDetectionResult_TextDetection::getId() const {
    return m_id;
}
void OAITextDetectionResult_TextDetection::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITextDetectionResult_TextDetection::is_id_Set() const{
    return m_id_isSet;
}

bool OAITextDetectionResult_TextDetection::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAITextDetectionResult_TextDetection::getParentId() const {
    return m_parent_id;
}
void OAITextDetectionResult_TextDetection::setParentId(const qint32 &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAITextDetectionResult_TextDetection::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAITextDetectionResult_TextDetection::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

float OAITextDetectionResult_TextDetection::getConfidence() const {
    return m_confidence;
}
void OAITextDetectionResult_TextDetection::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAITextDetectionResult_TextDetection::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAITextDetectionResult_TextDetection::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAITextDetection_Geometry OAITextDetectionResult_TextDetection::getGeometry() const {
    return m_geometry;
}
void OAITextDetectionResult_TextDetection::setGeometry(const OAITextDetection_Geometry &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAITextDetectionResult_TextDetection::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAITextDetectionResult_TextDetection::is_geometry_Valid() const{
    return m_geometry_isValid;
}

bool OAITextDetectionResult_TextDetection::isSet() const {
...
bool OAITextDetectionResult_TextDetection::isValid() const {
