...
/*
 * OAICreateStreamProcessorRequest_DataSharingPreference.h
 *
 * 
 */

#ifndef OAICreateStreamProcessorRequest_DataSharingPreference_H
#define OAICreateStreamProcessorRequest_DataSharingPreference_H
...
class OAICreateStreamProcessorRequest_DataSharingPreference : public OAIObject {
public:
    OAICreateStreamProcessorRequest_DataSharingPreference();
    OAICreateStreamProcessorRequest_DataSharingPreference(QString json);
    ~OAICreateStreamProcessorRequest_DataSharingPreference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamProcessorRequest_DataSharingPreference)

#endif // OAICreateStreamProcessorRequest_DataSharingPreference_H
