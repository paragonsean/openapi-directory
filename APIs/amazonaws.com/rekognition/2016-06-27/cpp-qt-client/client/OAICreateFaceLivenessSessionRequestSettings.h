...
/*
 * OAICreateFaceLivenessSessionRequestSettings.h
 *
...
#ifndef OAICreateFaceLivenessSessionRequestSettings_H
#define OAICreateFaceLivenessSessionRequestSettings_H
...
class OAICreateFaceLivenessSessionRequestSettings : public OAIObject {
public:
    OAICreateFaceLivenessSessionRequestSettings();
    OAICreateFaceLivenessSessionRequestSettings(QString json);
    ~OAICreateFaceLivenessSessionRequestSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFaceLivenessSessionRequestSettings)

#endif // OAICreateFaceLivenessSessionRequestSettings_H
