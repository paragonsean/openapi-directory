...
/*
 * OAIDetectProtectiveEquipmentRequest.h
 *
 * 
 */

#ifndef OAIDetectProtectiveEquipmentRequest_H
#define OAIDetectProtectiveEquipmentRequest_H
...
namespace OpenAPI {
class OAIDetectProtectiveEquipmentRequest_Image;
class OAIDetectProtectiveEquipmentRequest_SummarizationAttributes;

class OAIDetectProtectiveEquipmentRequest : public OAIObject {
public:
    OAIDetectProtectiveEquipmentRequest();
    OAIDetectProtectiveEquipmentRequest(QString json);
    ~OAIDetectProtectiveEquipmentRequest() override;
    ...
    OAIDetectProtectiveEquipmentRequest_Image getImage() const;
    void setImage(const OAIDetectProtectiveEquipmentRequest_Image &image);
    bool is_image_Set() const;
    bool is_image_Valid() const;

    OAIDetectProtectiveEquipmentRequest_SummarizationAttributes getSummarizationAttributes() const;
    void setSummarizationAttributes(const OAIDetectProtectiveEquipmentRequest_SummarizationAttributes &summarization_attributes);
    bool is_summarization_attributes_Set() const;
    bool is_summarization_attributes_Valid() const;
...
private:
    ...
    OAIDetectProtectiveEquipmentRequest_Image m_image;
    bool m_image_isSet;
    bool m_image_isValid;

    OAIDetectProtectiveEquipmentRequest_SummarizationAttributes m_summarization_attributes;
    bool m_summarization_attributes_isSet;
    bool m_summarization_attributes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDetectProtectiveEquipmentRequest)

#endif // OAIDetectProtectiveEquipmentRequest_H
