...
/*
 * OAIDescribeStreamProcessorResponse_Input.h
 *
 * 
 */

#ifndef OAIDescribeStreamProcessorResponse_Input_H
#define OAIDescribeStreamProcessorResponse_Input_H
...
class OAIDescribeStreamProcessorResponse_Input : public OAIObject {
public:
    OAIDescribeStreamProcessorResponse_Input();
    OAIDescribeStreamProcessorResponse_Input(QString json);
    ~OAIDescribeStreamProcessorResponse_Input() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStreamProcessorResponse_Input)

#endif // OAIDescribeStreamProcessorResponse_Input_H
