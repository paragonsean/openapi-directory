...
/*
 * OAIDescribeStreamProcessorRequest.h
 *
 * 
 */

#ifndef OAIDescribeStreamProcessorRequest_H
#define OAIDescribeStreamProcessorRequest_H
...
class OAIDescribeStreamProcessorRequest : public OAIObject {
public:
    OAIDescribeStreamProcessorRequest();
    OAIDescribeStreamProcessorRequest(QString json);
    ~OAIDescribeStreamProcessorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStreamProcessorRequest)

#endif // OAIDescribeStreamProcessorRequest_H
