...
/*
 * OAIGetCelebrityInfoRequest.h
 *
 * 
 */

#ifndef OAIGetCelebrityInfoRequest_H
#define OAIGetCelebrityInfoRequest_H
...
class OAIGetCelebrityInfoRequest : public OAIObject {
public:
    OAIGetCelebrityInfoRequest();
    OAIGetCelebrityInfoRequest(QString json);
    ~OAIGetCelebrityInfoRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCelebrityInfoRequest)

#endif // OAIGetCelebrityInfoRequest_H
