...
#include "OAIDetectProtectiveEquipmentRequest_SummarizationAttributes.h"
...
OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::OAIDetectProtectiveEquipmentRequest_SummarizationAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::OAIDetectProtectiveEquipmentRequest_SummarizationAttributes() {
    this->initializeModel();
}

OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::~OAIDetectProtectiveEquipmentRequest_SummarizationAttributes() {}

void OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::initializeModel() {

    m_min_confidence_isSet = false;
    m_min_confidence_isValid = false;

    m_required_equipment_types_isSet = false;
    m_required_equipment_types_isValid = false;
}

void OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::fromJson(QString jsonString) {
...
void OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::fromJsonObject(QJsonObject json) {

    m_min_confidence_isValid = ::OpenAPI::fromJsonValue(m_min_confidence, json[QString("MinConfidence")]);
    m_min_confidence_isSet = !json[QString("MinConfidence")].isNull() && m_min_confidence_isValid;

    m_required_equipment_types_isValid = ::OpenAPI::fromJsonValue(m_required_equipment_types, json[QString("RequiredEquipmentTypes")]);
    m_required_equipment_types_isSet = !json[QString("RequiredEquipmentTypes")].isNull() && m_required_equipment_types_isValid;
}

QString OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::asJson() const {
...
QJsonObject OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_min_confidence_isSet) {
        obj.insert(QString("MinConfidence"), ::OpenAPI::toJsonValue(m_min_confidence));
    }
    if (m_required_equipment_types.isSet()) {
        obj.insert(QString("RequiredEquipmentTypes"), ::OpenAPI::toJsonValue(m_required_equipment_types));
    }
    return obj;
}

float OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::getMinConfidence() const {
    return m_min_confidence;
}
void OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

QList OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::getRequiredEquipmentTypes() const {
    return m_required_equipment_types;
}
void OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::setRequiredEquipmentTypes(const QList &required_equipment_types) {
    m_required_equipment_types = required_equipment_types;
    m_required_equipment_types_isSet = true;
}

bool OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::is_required_equipment_types_Set() const{
    return m_required_equipment_types_isSet;
}

bool OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::is_required_equipment_types_Valid() const{
    return m_required_equipment_types_isValid;
}

bool OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::isSet() const {
...
bool OAIDetectProtectiveEquipmentRequest_SummarizationAttributes::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_min_confidence_isValid && m_required_equipment_types_isValid && true;
}
