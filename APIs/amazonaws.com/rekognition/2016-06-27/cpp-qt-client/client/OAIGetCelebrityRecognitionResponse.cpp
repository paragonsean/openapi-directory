...
#include "OAIGetCelebrityRecognitionResponse.h"
...
OAIGetCelebrityRecognitionResponse::OAIGetCelebrityRecognitionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCelebrityRecognitionResponse::OAIGetCelebrityRecognitionResponse() {
    this->initializeModel();
}

OAIGetCelebrityRecognitionResponse::~OAIGetCelebrityRecognitionResponse() {}

void OAIGetCelebrityRecognitionResponse::initializeModel() {
...
void OAIGetCelebrityRecognitionResponse::fromJson(QString jsonString) {
...
void OAIGetCelebrityRecognitionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetCelebrityRecognitionResponse::asJson() const {
...
QJsonObject OAIGetCelebrityRecognitionResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIVideoJobStatus OAIGetCelebrityRecognitionResponse::getJobStatus() const {
    return m_job_status;
}
void OAIGetCelebrityRecognitionResponse::setJobStatus(const OAIVideoJobStatus &job_status) {
    m_job_status = job_status;
    m_job_status_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_job_status_Set() const{
    return m_job_status_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_job_status_Valid() const{
    return m_job_status_isValid;
}

QString OAIGetCelebrityRecognitionResponse::getStatusMessage() const {
    return m_status_message;
}
void OAIGetCelebrityRecognitionResponse::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_status_message_Valid() const{
    return m_status_message_isValid;
}

OAIGetCelebrityRecognitionResponse_VideoMetadata OAIGetCelebrityRecognitionResponse::getVideoMetadata() const {
    return m_video_metadata;
}
void OAIGetCelebrityRecognitionResponse::setVideoMetadata(const OAIGetCelebrityRecognitionResponse_VideoMetadata &video_metadata) {
    m_video_metadata = video_metadata;
    m_video_metadata_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_video_metadata_Set() const{
    return m_video_metadata_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_video_metadata_Valid() const{
    return m_video_metadata_isValid;
}

QString OAIGetCelebrityRecognitionResponse::getNextToken() const {
    return m_next_token;
}
void OAIGetCelebrityRecognitionResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIGetCelebrityRecognitionResponse::getCelebrities() const {
    return m_celebrities;
}
void OAIGetCelebrityRecognitionResponse::setCelebrities(const QList &celebrities) {
    m_celebrities = celebrities;
    m_celebrities_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_celebrities_Set() const{
    return m_celebrities_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_celebrities_Valid() const{
    return m_celebrities_isValid;
}

QString OAIGetCelebrityRecognitionResponse::getJobId() const {
    return m_job_id;
}
void OAIGetCelebrityRecognitionResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIVideo OAIGetCelebrityRecognitionResponse::getVideo() const {
    return m_video;
}
void OAIGetCelebrityRecognitionResponse::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_video_Set() const{
    return m_video_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIGetCelebrityRecognitionResponse::getJobTag() const {
    return m_job_tag;
}
void OAIGetCelebrityRecognitionResponse::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIGetCelebrityRecognitionResponse::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIGetCelebrityRecognitionResponse::isSet() const {
...
bool OAIGetCelebrityRecognitionResponse::isValid() const {
