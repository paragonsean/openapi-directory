...
#include "OAIUnsuccessfulFaceAssociation.h"
...
OAIUnsuccessfulFaceAssociation::OAIUnsuccessfulFaceAssociation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsuccessfulFaceAssociation::OAIUnsuccessfulFaceAssociation() {
    this->initializeModel();
}

OAIUnsuccessfulFaceAssociation::~OAIUnsuccessfulFaceAssociation() {}

void OAIUnsuccessfulFaceAssociation::initializeModel() {
...
void OAIUnsuccessfulFaceAssociation::fromJson(QString jsonString) {
...
void OAIUnsuccessfulFaceAssociation::fromJsonObject(QJsonObject json) {
...
QString OAIUnsuccessfulFaceAssociation::asJson() const {
...
QJsonObject OAIUnsuccessfulFaceAssociation::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
...
QString OAIUnsuccessfulFaceAssociation::getFaceId() const {
    return m_face_id;
}
void OAIUnsuccessfulFaceAssociation::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAIUnsuccessfulFaceAssociation::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAIUnsuccessfulFaceAssociation::is_face_id_Valid() const{
    return m_face_id_isValid;
}

QString OAIUnsuccessfulFaceAssociation::getUserId() const {
    return m_user_id;
}
void OAIUnsuccessfulFaceAssociation::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIUnsuccessfulFaceAssociation::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIUnsuccessfulFaceAssociation::is_user_id_Valid() const{
    return m_user_id_isValid;
}

float OAIUnsuccessfulFaceAssociation::getConfidence() const {
    return m_confidence;
}
void OAIUnsuccessfulFaceAssociation::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIUnsuccessfulFaceAssociation::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIUnsuccessfulFaceAssociation::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QList OAIUnsuccessfulFaceAssociation::getReasons() const {
    return m_reasons;
}
void OAIUnsuccessfulFaceAssociation::setReasons(const QList &reasons) {
    m_reasons = reasons;
    m_reasons_isSet = true;
}

bool OAIUnsuccessfulFaceAssociation::is_reasons_Set() const{
    return m_reasons_isSet;
}

bool OAIUnsuccessfulFaceAssociation::is_reasons_Valid() const{
    return m_reasons_isValid;
}

bool OAIUnsuccessfulFaceAssociation::isSet() const {
...
bool OAIUnsuccessfulFaceAssociation::isValid() const {
