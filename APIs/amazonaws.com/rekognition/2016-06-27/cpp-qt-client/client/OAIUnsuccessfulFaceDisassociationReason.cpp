...
#include "OAIUnsuccessfulFaceDisassociationReason.h"
...
OAIUnsuccessfulFaceDisassociationReason::OAIUnsuccessfulFaceDisassociationReason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsuccessfulFaceDisassociationReason::OAIUnsuccessfulFaceDisassociationReason() {
    this->initializeModel();
}

OAIUnsuccessfulFaceDisassociationReason::~OAIUnsuccessfulFaceDisassociationReason() {}

void OAIUnsuccessfulFaceDisassociationReason::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUnsuccessfulFaceDisassociationReason::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUnsuccessfulFaceDisassociationReason::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FACE_NOT_FOUND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsuccessfulFaceDisassociationReason::FACE_NOT_FOUND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ASSOCIATED_TO_A_DIFFERENT_USER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsuccessfulFaceDisassociationReason::ASSOCIATED_TO_A_DIFFERENT_USER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUnsuccessfulFaceDisassociationReason::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUnsuccessfulFaceDisassociationReason::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUnsuccessfulFaceDisassociationReason::FACE_NOT_FOUND:
            val = "FACE_NOT_FOUND";
            break;
        case eOAIUnsuccessfulFaceDisassociationReason::ASSOCIATED_TO_A_DIFFERENT_USER:
...
QJsonValue OAIUnsuccessfulFaceDisassociationReason::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUnsuccessfulFaceDisassociationReason::eOAIUnsuccessfulFaceDisassociationReason OAIUnsuccessfulFaceDisassociationReason::getValue() const {
    return m_value;
}

void OAIUnsuccessfulFaceDisassociationReason::setValue(const OAIUnsuccessfulFaceDisassociationReason::eOAIUnsuccessfulFaceDisassociationReason& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUnsuccessfulFaceDisassociationReason::isSet() const {
    
    return m_value_isSet;
}

bool OAIUnsuccessfulFaceDisassociationReason::isValid() const {
