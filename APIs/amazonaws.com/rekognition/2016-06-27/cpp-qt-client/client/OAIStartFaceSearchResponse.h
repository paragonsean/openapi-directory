...
/*
 * OAIStartFaceSearchResponse.h
 *
 * 
 */

#ifndef OAIStartFaceSearchResponse_H
#define OAIStartFaceSearchResponse_H
...
class OAIStartFaceSearchResponse : public OAIObject {
public:
    OAIStartFaceSearchResponse();
    OAIStartFaceSearchResponse(QString json);
    ~OAIStartFaceSearchResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceSearchResponse)

#endif // OAIStartFaceSearchResponse_H
