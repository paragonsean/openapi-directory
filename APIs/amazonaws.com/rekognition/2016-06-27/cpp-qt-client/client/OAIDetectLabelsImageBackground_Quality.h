...
/*
 * OAIDetectLabelsImageBackground_Quality.h
 *
 * 
 */

#ifndef OAIDetectLabelsImageBackground_Quality_H
#define OAIDetectLabelsImageBackground_Quality_H
...
class OAIDetectLabelsImageBackground_Quality : public OAIObject {
public:
    OAIDetectLabelsImageBackground_Quality();
    OAIDetectLabelsImageBackground_Quality(QString json);
    ~OAIDetectLabelsImageBackground_Quality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageBackground_Quality)

#endif // OAIDetectLabelsImageBackground_Quality_H
