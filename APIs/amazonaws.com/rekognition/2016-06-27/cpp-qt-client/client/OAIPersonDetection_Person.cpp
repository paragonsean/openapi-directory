...
#include "OAIPersonDetection_Person.h"
...
OAIPersonDetection_Person::OAIPersonDetection_Person(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonDetection_Person::OAIPersonDetection_Person() {
    this->initializeModel();
}

OAIPersonDetection_Person::~OAIPersonDetection_Person() {}

void OAIPersonDetection_Person::initializeModel() {
...
void OAIPersonDetection_Person::fromJson(QString jsonString) {
...
void OAIPersonDetection_Person::fromJsonObject(QJsonObject json) {
...
QString OAIPersonDetection_Person::asJson() const {
...
QJsonObject OAIPersonDetection_Person::asJsonObject() const {
    QJsonObject obj;
    if (m_index_isSet) {
...
qint32 OAIPersonDetection_Person::getIndex() const {
    return m_index;
}
void OAIPersonDetection_Person::setIndex(const qint32 &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAIPersonDetection_Person::is_index_Set() const{
    return m_index_isSet;
}

bool OAIPersonDetection_Person::is_index_Valid() const{
    return m_index_isValid;
}

OAIPersonDetail_BoundingBox OAIPersonDetection_Person::getBoundingBox() const {
    return m_bounding_box;
}
void OAIPersonDetection_Person::setBoundingBox(const OAIPersonDetail_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIPersonDetection_Person::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIPersonDetection_Person::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

OAIPersonDetail_Face OAIPersonDetection_Person::getFace() const {
    return m_face;
}
void OAIPersonDetection_Person::setFace(const OAIPersonDetail_Face &face) {
    m_face = face;
    m_face_isSet = true;
}

bool OAIPersonDetection_Person::is_face_Set() const{
    return m_face_isSet;
}

bool OAIPersonDetection_Person::is_face_Valid() const{
    return m_face_isValid;
}

bool OAIPersonDetection_Person::isSet() const {
...
bool OAIPersonDetection_Person::isValid() const {
