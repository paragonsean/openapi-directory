...
#ifndef OAIStreamProcessor_H
#define OAIStreamProcessor_H
...
class OAIStreamProcessor : public OAIObject {
public:
    OAIStreamProcessor();
    OAIStreamProcessor(QString json);
    ~OAIStreamProcessor() override;
    ...
    OAIStreamProcessorStatus getStatus() const;
    void setStatus(const OAIStreamProcessorStatus &status);
...
private:
    ...
    OAIStreamProcessorStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessor)

#endif // OAIStreamProcessor_H
