...
#include "OAISearchFacesRequest.h"
...
OAISearchFacesRequest::OAISearchFacesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchFacesRequest::OAISearchFacesRequest() {
    this->initializeModel();
}

OAISearchFacesRequest::~OAISearchFacesRequest() {}

void OAISearchFacesRequest::initializeModel() {
...
void OAISearchFacesRequest::fromJson(QString jsonString) {
...
void OAISearchFacesRequest::fromJsonObject(QJsonObject json) {
...
QString OAISearchFacesRequest::asJson() const {
...
QJsonObject OAISearchFacesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISearchFacesRequest::getCollectionId() const {
    return m_collection_id;
}
void OAISearchFacesRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAISearchFacesRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAISearchFacesRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAISearchFacesRequest::getFaceId() const {
    return m_face_id;
}
void OAISearchFacesRequest::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAISearchFacesRequest::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAISearchFacesRequest::is_face_id_Valid() const{
    return m_face_id_isValid;
}

qint32 OAISearchFacesRequest::getMaxFaces() const {
    return m_max_faces;
}
void OAISearchFacesRequest::setMaxFaces(const qint32 &max_faces) {
    m_max_faces = max_faces;
    m_max_faces_isSet = true;
}

bool OAISearchFacesRequest::is_max_faces_Set() const{
    return m_max_faces_isSet;
}

bool OAISearchFacesRequest::is_max_faces_Valid() const{
    return m_max_faces_isValid;
}

float OAISearchFacesRequest::getFaceMatchThreshold() const {
    return m_face_match_threshold;
}
void OAISearchFacesRequest::setFaceMatchThreshold(const float &face_match_threshold) {
    m_face_match_threshold = face_match_threshold;
    m_face_match_threshold_isSet = true;
}

bool OAISearchFacesRequest::is_face_match_threshold_Set() const{
    return m_face_match_threshold_isSet;
}

bool OAISearchFacesRequest::is_face_match_threshold_Valid() const{
    return m_face_match_threshold_isValid;
}

bool OAISearchFacesRequest::isSet() const {
...
bool OAISearchFacesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_collection_id_isValid && m_face_id_isValid && true;
}
