...
/*
 * OAIFaceDetail_AgeRange.h
 *
 * 
 */

#ifndef OAIFaceDetail_AgeRange_H
#define OAIFaceDetail_AgeRange_H
...
class OAIFaceDetail_AgeRange : public OAIObject {
public:
    OAIFaceDetail_AgeRange();
    OAIFaceDetail_AgeRange(QString json);
    ~OAIFaceDetail_AgeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_AgeRange)

#endif // OAIFaceDetail_AgeRange_H
