...
/*
 * OAIContentModerationSortBy.h
 *
 * 
 */

#ifndef OAIContentModerationSortBy_H
#define OAIContentModerationSortBy_H
...
class OAIContentModerationSortBy : public OAIEnum {
public:
    OAIContentModerationSortBy();
    OAIContentModerationSortBy(QString json);
    ~OAIContentModerationSortBy() override;
    ...
    enum class eOAIContentModerationSortBy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NAME, 
        TIMESTAMP
    };
    OAIContentModerationSortBy::eOAIContentModerationSortBy getValue() const;
    void setValue(const OAIContentModerationSortBy::eOAIContentModerationSortBy& value);
...
private:
    ...
    eOAIContentModerationSortBy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentModerationSortBy)

#endif // OAIContentModerationSortBy_H
