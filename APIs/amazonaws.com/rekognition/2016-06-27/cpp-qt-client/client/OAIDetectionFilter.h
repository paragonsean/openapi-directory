...
/*
 * OAIDetectionFilter.h
 *
 * A set of parameters that allow you to filter out certain results from your returned results.
 */

#ifndef OAIDetectionFilter_H
#define OAIDetectionFilter_H
...
class OAIDetectionFilter : public OAIObject {
public:
    OAIDetectionFilter();
    OAIDetectionFilter(QString json);
    ~OAIDetectionFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectionFilter)

#endif // OAIDetectionFilter_H
