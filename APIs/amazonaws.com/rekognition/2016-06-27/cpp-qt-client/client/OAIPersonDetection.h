...
#ifndef OAIPersonDetection_H
#define OAIPersonDetection_H
...
namespace OpenAPI {
class OAIPersonDetection_Person;

class OAIPersonDetection : public OAIObject {
public:
    OAIPersonDetection();
    OAIPersonDetection(QString json);
    ~OAIPersonDetection() override;
    ...
    OAIPersonDetection_Person getPerson() const;
    void setPerson(const OAIPersonDetection_Person &person);
...
private:
    ...
    OAIPersonDetection_Person m_person;
    bool m_person_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonDetection)

#endif // OAIPersonDetection_H
