...
/*
 * OAIListProjectPoliciesRequest.h
 *
 * 
 */

#ifndef OAIListProjectPoliciesRequest_H
#define OAIListProjectPoliciesRequest_H
...
class OAIListProjectPoliciesRequest : public OAIObject {
public:
    OAIListProjectPoliciesRequest();
    OAIListProjectPoliciesRequest(QString json);
    ~OAIListProjectPoliciesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListProjectPoliciesRequest)

#endif // OAIListProjectPoliciesRequest_H
