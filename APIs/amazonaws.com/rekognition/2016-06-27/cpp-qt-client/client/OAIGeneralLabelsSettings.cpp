...
OAIGeneralLabelsSettings::OAIGeneralLabelsSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGeneralLabelsSettings::OAIGeneralLabelsSettings() {
    this->initializeModel();
}

OAIGeneralLabelsSettings::~OAIGeneralLabelsSettings() {}

void OAIGeneralLabelsSettings::initializeModel() {

    m_label_inclusion_filters_isSet = false;
    m_label_inclusion_filters_isValid = false;

    m_label_exclusion_filters_isSet = false;
    m_label_exclusion_filters_isValid = false;

    m_label_category_inclusion_filters_isSet = false;
    m_label_category_inclusion_filters_isValid = false;

    m_label_category_exclusion_filters_isSet = false;
    m_label_category_exclusion_filters_isValid = false;
}

void OAIGeneralLabelsSettings::fromJson(QString jsonString) {
...
void OAIGeneralLabelsSettings::fromJsonObject(QJsonObject json) {

    m_label_inclusion_filters_isValid = ::OpenAPI::fromJsonValue(m_label_inclusion_filters, json[QString("LabelInclusionFilters")]);
    m_label_inclusion_filters_isSet = !json[QString("LabelInclusionFilters")].isNull() && m_label_inclusion_filters_isValid;

    m_label_exclusion_filters_isValid = ::OpenAPI::fromJsonValue(m_label_exclusion_filters, json[QString("LabelExclusionFilters")]);
    m_label_exclusion_filters_isSet = !json[QString("LabelExclusionFilters")].isNull() && m_label_exclusion_filters_isValid;

    m_label_category_inclusion_filters_isValid = ::OpenAPI::fromJsonValue(m_label_category_inclusion_filters, json[QString("LabelCategoryInclusionFilters")]);
    m_label_category_inclusion_filters_isSet = !json[QString("LabelCategoryInclusionFilters")].isNull() && m_label_category_inclusion_filters_isValid;

    m_label_category_exclusion_filters_isValid = ::OpenAPI::fromJsonValue(m_label_category_exclusion_filters, json[QString("LabelCategoryExclusionFilters")]);
    m_label_category_exclusion_filters_isSet = !json[QString("LabelCategoryExclusionFilters")].isNull() && m_label_category_exclusion_filters_isValid;
}

QString OAIGeneralLabelsSettings::asJson() const {
...
QJsonObject OAIGeneralLabelsSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_label_inclusion_filters.isSet()) {
        obj.insert(QString("LabelInclusionFilters"), ::OpenAPI::toJsonValue(m_label_inclusion_filters));
    }
    if (m_label_exclusion_filters.isSet()) {
        obj.insert(QString("LabelExclusionFilters"), ::OpenAPI::toJsonValue(m_label_exclusion_filters));
    }
    if (m_label_category_inclusion_filters.isSet()) {
        obj.insert(QString("LabelCategoryInclusionFilters"), ::OpenAPI::toJsonValue(m_label_category_inclusion_filters));
    }
    if (m_label_category_exclusion_filters.isSet()) {
        obj.insert(QString("LabelCategoryExclusionFilters"), ::OpenAPI::toJsonValue(m_label_category_exclusion_filters));
    }
    return obj;
}

QList OAIGeneralLabelsSettings::getLabelInclusionFilters() const {
    return m_label_inclusion_filters;
}
void OAIGeneralLabelsSettings::setLabelInclusionFilters(const QList &label_inclusion_filters) {
    m_label_inclusion_filters = label_inclusion_filters;
    m_label_inclusion_filters_isSet = true;
}

bool OAIGeneralLabelsSettings::is_label_inclusion_filters_Set() const{
    return m_label_inclusion_filters_isSet;
}

bool OAIGeneralLabelsSettings::is_label_inclusion_filters_Valid() const{
    return m_label_inclusion_filters_isValid;
}

QList OAIGeneralLabelsSettings::getLabelExclusionFilters() const {
    return m_label_exclusion_filters;
}
void OAIGeneralLabelsSettings::setLabelExclusionFilters(const QList &label_exclusion_filters) {
    m_label_exclusion_filters = label_exclusion_filters;
    m_label_exclusion_filters_isSet = true;
}

bool OAIGeneralLabelsSettings::is_label_exclusion_filters_Set() const{
    return m_label_exclusion_filters_isSet;
}

bool OAIGeneralLabelsSettings::is_label_exclusion_filters_Valid() const{
    return m_label_exclusion_filters_isValid;
}

QList OAIGeneralLabelsSettings::getLabelCategoryInclusionFilters() const {
    return m_label_category_inclusion_filters;
}
void OAIGeneralLabelsSettings::setLabelCategoryInclusionFilters(const QList &label_category_inclusion_filters) {
    m_label_category_inclusion_filters = label_category_inclusion_filters;
    m_label_category_inclusion_filters_isSet = true;
}

bool OAIGeneralLabelsSettings::is_label_category_inclusion_filters_Set() const{
    return m_label_category_inclusion_filters_isSet;
}

bool OAIGeneralLabelsSettings::is_label_category_inclusion_filters_Valid() const{
    return m_label_category_inclusion_filters_isValid;
}

QList OAIGeneralLabelsSettings::getLabelCategoryExclusionFilters() const {
    return m_label_category_exclusion_filters;
}
void OAIGeneralLabelsSettings::setLabelCategoryExclusionFilters(const QList &label_category_exclusion_filters) {
    m_label_category_exclusion_filters = label_category_exclusion_filters;
    m_label_category_exclusion_filters_isSet = true;
}

bool OAIGeneralLabelsSettings::is_label_category_exclusion_filters_Set() const{
    return m_label_category_exclusion_filters_isSet;
}

bool OAIGeneralLabelsSettings::is_label_category_exclusion_filters_Valid() const{
    return m_label_category_exclusion_filters_isValid;
}

bool OAIGeneralLabelsSettings::isSet() const {
...
bool OAIGeneralLabelsSettings::isValid() const {
