...
/*
 * OAIDetectLabelsImageProperties_Foreground.h
 *
 * 
 */

#ifndef OAIDetectLabelsImageProperties_Foreground_H
#define OAIDetectLabelsImageProperties_Foreground_H
...
namespace OpenAPI {
class OAIDetectLabelsImageForeground_Quality;

class OAIDetectLabelsImageProperties_Foreground : public OAIObject {
public:
    OAIDetectLabelsImageProperties_Foreground();
    OAIDetectLabelsImageProperties_Foreground(QString json);
    ~OAIDetectLabelsImageProperties_Foreground() override;
    ...
    OAIDetectLabelsImageForeground_Quality getQuality() const;
    void setQuality(const OAIDetectLabelsImageForeground_Quality &quality);
    bool is_quality_Set() const;
    bool is_quality_Valid() const;

    QList getDominantColors() const;
    void setDominantColors(const QList &dominant_colors);
...
private:
    ...
    OAIDetectLabelsImageForeground_Quality m_quality;
    bool m_quality_isSet;
    bool m_quality_isValid;

    QList m_dominant_colors;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageProperties_Foreground)

#endif // OAIDetectLabelsImageProperties_Foreground_H
