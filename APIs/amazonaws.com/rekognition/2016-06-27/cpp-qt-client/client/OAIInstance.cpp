...
OAIInstance_BoundingBox OAIInstance::getBoundingBox() const {
    return m_bounding_box;
}
void OAIInstance::setBoundingBox(const OAIInstance_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIInstance::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIInstance::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

float OAIInstance::getConfidence() const {
    return m_confidence;
}
void OAIInstance::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIInstance::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIInstance::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QList OAIInstance::getDominantColors() const {
    return m_dominant_colors;
}
void OAIInstance::setDominantColors(const QList &dominant_colors) {
    m_dominant_colors = dominant_colors;
    m_dominant_colors_isSet = true;
}

bool OAIInstance::is_dominant_colors_Set() const{
    return m_dominant_colors_isSet;
}

bool OAIInstance::is_dominant_colors_Valid() const{
