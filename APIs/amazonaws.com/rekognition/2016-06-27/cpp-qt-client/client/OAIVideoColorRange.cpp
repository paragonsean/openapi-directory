...
OAIVideoColorRange::OAIVideoColorRange(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideoColorRange::OAIVideoColorRange() {
    this->initializeModel();
}

OAIVideoColorRange::~OAIVideoColorRange() {}

void OAIVideoColorRange::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIVideoColorRange::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIVideoColorRange::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FULL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVideoColorRange::FULL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LIMITED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVideoColorRange::LIMITED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIVideoColorRange::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIVideoColorRange::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIVideoColorRange::FULL:
            val = "FULL";
            break;
        case eOAIVideoColorRange::LIMITED:
            val = "LIMITED";
            break;
        default:
            break;
...
QJsonValue OAIVideoColorRange::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIVideoColorRange::eOAIVideoColorRange OAIVideoColorRange::getValue() const {
    return m_value;
}

void OAIVideoColorRange::setValue(const OAIVideoColorRange::eOAIVideoColorRange& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIVideoColorRange::isSet() const {
    
    return m_value_isSet;
}

bool OAIVideoColorRange::isValid() const {
