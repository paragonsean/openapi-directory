...
#include "OAIDetectLabelsImageBackground_Quality.h"
...
OAIDetectLabelsImageBackground_Quality::OAIDetectLabelsImageBackground_Quality(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageBackground_Quality::OAIDetectLabelsImageBackground_Quality() {
    this->initializeModel();
}

OAIDetectLabelsImageBackground_Quality::~OAIDetectLabelsImageBackground_Quality() {}

void OAIDetectLabelsImageBackground_Quality::initializeModel() {
...
void OAIDetectLabelsImageBackground_Quality::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageBackground_Quality::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageBackground_Quality::asJson() const {
...
QJsonObject OAIDetectLabelsImageBackground_Quality::asJsonObject() const {
    QJsonObject obj;
...
float OAIDetectLabelsImageBackground_Quality::getBrightness() const {
    return m_brightness;
}
void OAIDetectLabelsImageBackground_Quality::setBrightness(const float &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIDetectLabelsImageBackground_Quality::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIDetectLabelsImageBackground_Quality::is_brightness_Valid() const{
    return m_brightness_isValid;
}

float OAIDetectLabelsImageBackground_Quality::getSharpness() const {
    return m_sharpness;
}
void OAIDetectLabelsImageBackground_Quality::setSharpness(const float &sharpness) {
    m_sharpness = sharpness;
    m_sharpness_isSet = true;
}

bool OAIDetectLabelsImageBackground_Quality::is_sharpness_Set() const{
    return m_sharpness_isSet;
}

bool OAIDetectLabelsImageBackground_Quality::is_sharpness_Valid() const{
    return m_sharpness_isValid;
}

float OAIDetectLabelsImageBackground_Quality::getContrast() const {
    return m_contrast;
}
void OAIDetectLabelsImageBackground_Quality::setContrast(const float &contrast) {
    m_contrast = contrast;
    m_contrast_isSet = true;
}

bool OAIDetectLabelsImageBackground_Quality::is_contrast_Set() const{
    return m_contrast_isSet;
}

bool OAIDetectLabelsImageBackground_Quality::is_contrast_Valid() const{
    return m_contrast_isValid;
}

bool OAIDetectLabelsImageBackground_Quality::isSet() const {
...
bool OAIDetectLabelsImageBackground_Quality::isValid() const {
