...
/*
 * OAICreateProjectVersionRequest_TestingData.h
 *
 * 
 */

#ifndef OAICreateProjectVersionRequest_TestingData_H
#define OAICreateProjectVersionRequest_TestingData_H
...
class OAICreateProjectVersionRequest_TestingData : public OAIObject {
public:
    OAICreateProjectVersionRequest_TestingData();
    OAICreateProjectVersionRequest_TestingData(QString json);
    ~OAICreateProjectVersionRequest_TestingData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectVersionRequest_TestingData)

#endif // OAICreateProjectVersionRequest_TestingData_H
