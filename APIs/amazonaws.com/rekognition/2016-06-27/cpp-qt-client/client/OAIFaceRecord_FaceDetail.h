...
/*
 * OAIFaceRecord_FaceDetail.h
 *
 * 
 */

#ifndef OAIFaceRecord_FaceDetail_H
#define OAIFaceRecord_FaceDetail_H
...
class OAIFaceRecord_FaceDetail : public OAIObject {
public:
    OAIFaceRecord_FaceDetail();
    OAIFaceRecord_FaceDetail(QString json);
    ~OAIFaceRecord_FaceDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceRecord_FaceDetail)

#endif // OAIFaceRecord_FaceDetail_H
