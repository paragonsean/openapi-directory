...
#ifndef OAITextDetection_H
#define OAITextDetection_H

#include <QJsonObject>

#include "OAITextDetection_Geometry.h"
...
namespace OpenAPI {
class OAITextDetection_Geometry;

class OAITextDetection : public OAIObject {
public:
    OAITextDetection();
    OAITextDetection(QString json);
    ~OAITextDetection() override;
    ...
    QString getDetectedText() const;
    void setDetectedText(const QString &detected_text);
    bool is_detected_text_Set() const;
    bool is_detected_text_Valid() const;

    OAITextTypes getType() const;
    void setType(const OAITextTypes &type);
    ...
    OAITextDetection_Geometry getGeometry() const;
    void setGeometry(const OAITextDetection_Geometry &geometry);
...
private:
    ...
    QString m_detected_text;
    bool m_detected_text_isSet;
    bool m_detected_text_isValid;
    ...
    OAITextDetection_Geometry m_geometry;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextDetection)

#endif // OAITextDetection_H
