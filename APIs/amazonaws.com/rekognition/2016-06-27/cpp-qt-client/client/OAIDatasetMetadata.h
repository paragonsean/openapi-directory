...
public:
    ...
    OAIDatasetStatusMessageCode getStatusMessageCode() const;
    void setStatusMessageCode(const OAIDatasetStatusMessageCode &status_message_code);
    bool is_status_message_code_Set() const;
    bool is_status_message_code_Valid() const;
...
private:
    ...
    OAIDatasetStatusMessageCode m_status_message_code;
    bool m_status_message_code_isSet;
    bool m_status_message_code_isValid;
};
