...
/*
 * OAIComparedFace_Quality.h
 *
 * 
 */

#ifndef OAIComparedFace_Quality_H
#define OAIComparedFace_Quality_H
...
class OAIComparedFace_Quality : public OAIObject {
public:
    OAIComparedFace_Quality();
    OAIComparedFace_Quality(QString json);
    ~OAIComparedFace_Quality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComparedFace_Quality)

#endif // OAIComparedFace_Quality_H
