...
/*
 * OAIProjectVersionDescription_OutputConfig.h
 *
 * 
 */

#ifndef OAIProjectVersionDescription_OutputConfig_H
#define OAIProjectVersionDescription_OutputConfig_H
...
class OAIProjectVersionDescription_OutputConfig : public OAIObject {
public:
    OAIProjectVersionDescription_OutputConfig();
    OAIProjectVersionDescription_OutputConfig(QString json);
    ~OAIProjectVersionDescription_OutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectVersionDescription_OutputConfig)

#endif // OAIProjectVersionDescription_OutputConfig_H
