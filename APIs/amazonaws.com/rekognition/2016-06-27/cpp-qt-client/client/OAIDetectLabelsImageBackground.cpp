...
#include "OAIDetectLabelsImageBackground.h"
...
OAIDetectLabelsImageBackground::OAIDetectLabelsImageBackground(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageBackground::OAIDetectLabelsImageBackground() {
    this->initializeModel();
}

OAIDetectLabelsImageBackground::~OAIDetectLabelsImageBackground() {}

void OAIDetectLabelsImageBackground::initializeModel() {
...
void OAIDetectLabelsImageBackground::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageBackground::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageBackground::asJson() const {
...
QJsonObject OAIDetectLabelsImageBackground::asJsonObject() const {
    QJsonObject obj;
    if (m_quality.isSet()) {
...
OAIDetectLabelsImageBackground_Quality OAIDetectLabelsImageBackground::getQuality() const {
    return m_quality;
}
void OAIDetectLabelsImageBackground::setQuality(const OAIDetectLabelsImageBackground_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIDetectLabelsImageBackground::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIDetectLabelsImageBackground::is_quality_Valid() const{
    return m_quality_isValid;
}

QList OAIDetectLabelsImageBackground::getDominantColors() const {
    return m_dominant_colors;
}
void OAIDetectLabelsImageBackground::setDominantColors(const QList &dominant_colors) {
    m_dominant_colors = dominant_colors;
    m_dominant_colors_isSet = true;
}

bool OAIDetectLabelsImageBackground::is_dominant_colors_Set() const{
    return m_dominant_colors_isSet;
}

bool OAIDetectLabelsImageBackground::is_dominant_colors_Valid() const{
    return m_dominant_colors_isValid;
}

bool OAIDetectLabelsImageBackground::isSet() const {
...
bool OAIDetectLabelsImageBackground::isValid() const {
