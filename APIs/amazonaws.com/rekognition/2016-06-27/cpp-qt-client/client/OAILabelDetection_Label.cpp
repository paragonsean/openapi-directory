...
OAILabelDetection_Label::OAILabelDetection_Label(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelDetection_Label::OAILabelDetection_Label() {
    this->initializeModel();
}

OAILabelDetection_Label::~OAILabelDetection_Label() {}

void OAILabelDetection_Label::initializeModel() {
...
void OAILabelDetection_Label::fromJson(QString jsonString) {
...
void OAILabelDetection_Label::fromJsonObject(QJsonObject json) {
...
QString OAILabelDetection_Label::asJson() const {
...
QJsonObject OAILabelDetection_Label::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAILabelDetection_Label::getName() const {
    return m_name;
}
void OAILabelDetection_Label::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILabelDetection_Label::is_name_Set() const{
    return m_name_isSet;
}

bool OAILabelDetection_Label::is_name_Valid() const{
    return m_name_isValid;
}

float OAILabelDetection_Label::getConfidence() const {
    return m_confidence;
}
void OAILabelDetection_Label::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAILabelDetection_Label::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAILabelDetection_Label::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QList OAILabelDetection_Label::getInstances() const {
    return m_instances;
}
void OAILabelDetection_Label::setInstances(const QList &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAILabelDetection_Label::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAILabelDetection_Label::is_instances_Valid() const{
    return m_instances_isValid;
}

QList OAILabelDetection_Label::getParents() const {
    return m_parents;
}
void OAILabelDetection_Label::setParents(const QList &parents) {
    m_parents = parents;
    m_parents_isSet = true;
}

bool OAILabelDetection_Label::is_parents_Set() const{
    return m_parents_isSet;
}

bool OAILabelDetection_Label::is_parents_Valid() const{
    return m_parents_isValid;
}

QList OAILabelDetection_Label::getAliases() const {
    return m_aliases;
}
void OAILabelDetection_Label::setAliases(const QList &aliases) {
    m_aliases = aliases;
    m_aliases_isSet = true;
}

bool OAILabelDetection_Label::is_aliases_Set() const{
    return m_aliases_isSet;
}

bool OAILabelDetection_Label::is_aliases_Valid() const{
    return m_aliases_isValid;
}

QList OAILabelDetection_Label::getCategories() const {
    return m_categories;
}
void OAILabelDetection_Label::setCategories(const QList &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAILabelDetection_Label::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAILabelDetection_Label::is_categories_Valid() const{
    return m_categories_isValid;
}

bool OAILabelDetection_Label::isSet() const {
...
bool OAILabelDetection_Label::isValid() const {
