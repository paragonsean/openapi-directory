...
namespace OpenAPI {
class OAIDatasetDescription_DatasetStats;
...
public:
    ...
    OAIDatasetDescription_DatasetStats getDatasetStats() const;
    void setDatasetStats(const OAIDatasetDescription_DatasetStats &dataset_stats);
    bool is_dataset_stats_Set() const;
    bool is_dataset_stats_Valid() const;
...
private:
    ...
    OAIDatasetDescription_DatasetStats m_dataset_stats;
    bool m_dataset_stats_isSet;
    bool m_dataset_stats_isValid;
};
