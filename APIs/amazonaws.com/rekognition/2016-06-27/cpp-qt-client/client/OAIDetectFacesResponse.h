...
/*
 * OAIDetectFacesResponse.h
 *
 * 
 */

#ifndef OAIDetectFacesResponse_H
#define OAIDetectFacesResponse_H
...
class OAIDetectFacesResponse : public OAIObject {
public:
    OAIDetectFacesResponse();
    OAIDetectFacesResponse(QString json);
    ~OAIDetectFacesResponse() override;
    ...
    QList getFaceDetails() const;
    void setFaceDetails(const QList &face_details);
    bool is_face_details_Set() const;
    bool is_face_details_Valid() const;
...
private:
    ...
    QList m_face_details;
    bool m_face_details_isSet;
    bool m_face_details_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectFacesResponse)

#endif // OAIDetectFacesResponse_H
