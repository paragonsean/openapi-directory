...
#ifndef OAIEyeglasses_H
#define OAIEyeglasses_H
...
class OAIEyeglasses : public OAIObject {
public:
    OAIEyeglasses();
    OAIEyeglasses(QString json);
    ~OAIEyeglasses() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEyeglasses)

#endif // OAIEyeglasses_H
