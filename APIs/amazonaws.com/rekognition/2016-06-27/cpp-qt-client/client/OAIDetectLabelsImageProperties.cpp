...
#include "OAIDetectLabelsImageProperties.h"
...
OAIDetectLabelsImageProperties::OAIDetectLabelsImageProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageProperties::OAIDetectLabelsImageProperties() {
    this->initializeModel();
}

OAIDetectLabelsImageProperties::~OAIDetectLabelsImageProperties() {}

void OAIDetectLabelsImageProperties::initializeModel() {
...
void OAIDetectLabelsImageProperties::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageProperties::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageProperties::asJson() const {
...
QJsonObject OAIDetectLabelsImageProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_quality.isSet()) {
...
OAIDetectLabelsImageProperties_Quality OAIDetectLabelsImageProperties::getQuality() const {
    return m_quality;
}
void OAIDetectLabelsImageProperties::setQuality(const OAIDetectLabelsImageProperties_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIDetectLabelsImageProperties::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIDetectLabelsImageProperties::is_quality_Valid() const{
    return m_quality_isValid;
}

QList OAIDetectLabelsImageProperties::getDominantColors() const {
    return m_dominant_colors;
}
void OAIDetectLabelsImageProperties::setDominantColors(const QList &dominant_colors) {
    m_dominant_colors = dominant_colors;
    m_dominant_colors_isSet = true;
}

bool OAIDetectLabelsImageProperties::is_dominant_colors_Set() const{
    return m_dominant_colors_isSet;
}

bool OAIDetectLabelsImageProperties::is_dominant_colors_Valid() const{
    return m_dominant_colors_isValid;
}

OAIDetectLabelsImageProperties_Foreground OAIDetectLabelsImageProperties::getForeground() const {
    return m_foreground;
}
void OAIDetectLabelsImageProperties::setForeground(const OAIDetectLabelsImageProperties_Foreground &foreground) {
    m_foreground = foreground;
    m_foreground_isSet = true;
}

bool OAIDetectLabelsImageProperties::is_foreground_Set() const{
    return m_foreground_isSet;
}

bool OAIDetectLabelsImageProperties::is_foreground_Valid() const{
    return m_foreground_isValid;
}

OAIDetectLabelsImageProperties_Background OAIDetectLabelsImageProperties::getBackground() const {
    return m_background;
}
void OAIDetectLabelsImageProperties::setBackground(const OAIDetectLabelsImageProperties_Background &background) {
    m_background = background;
    m_background_isSet = true;
}

bool OAIDetectLabelsImageProperties::is_background_Set() const{
    return m_background_isSet;
}

bool OAIDetectLabelsImageProperties::is_background_Valid() const{
    return m_background_isValid;
}

bool OAIDetectLabelsImageProperties::isSet() const {
...
bool OAIDetectLabelsImageProperties::isValid() const {
