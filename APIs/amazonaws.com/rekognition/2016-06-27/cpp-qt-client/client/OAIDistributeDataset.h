...
#ifndef OAIDistributeDataset_H
#define OAIDistributeDataset_H
...
class OAIDistributeDataset : public OAIObject {
public:
    OAIDistributeDataset();
    OAIDistributeDataset(QString json);
    ~OAIDistributeDataset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDistributeDataset)

#endif // OAIDistributeDataset_H
