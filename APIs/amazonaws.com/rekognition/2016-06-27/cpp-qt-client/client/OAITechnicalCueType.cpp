...
OAITechnicalCueType::OAITechnicalCueType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITechnicalCueType::OAITechnicalCueType() {
    this->initializeModel();
}

OAITechnicalCueType::~OAITechnicalCueType() {}

void OAITechnicalCueType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITechnicalCueType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITechnicalCueType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ColorBars", Qt::CaseInsensitive) == 0) {
        m_value = eOAITechnicalCueType::COLORBARS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EndCredits", Qt::CaseInsensitive) == 0) {
        m_value = eOAITechnicalCueType::ENDCREDITS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BlackFrames", Qt::CaseInsensitive) == 0) {
        m_value = eOAITechnicalCueType::BLACKFRAMES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OpeningCredits", Qt::CaseInsensitive) == 0) {
        m_value = eOAITechnicalCueType::OPENINGCREDITS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("StudioLogo", Qt::CaseInsensitive) == 0) {
        m_value = eOAITechnicalCueType::STUDIOLOGO;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Slate", Qt::CaseInsensitive) == 0) {
        m_value = eOAITechnicalCueType::SLATE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Content", Qt::CaseInsensitive) == 0) {
        m_value = eOAITechnicalCueType::CONTENT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITechnicalCueType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITechnicalCueType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITechnicalCueType::COLORBARS:
            val = "ColorBars";
            break;
        case eOAITechnicalCueType::ENDCREDITS:
            val = "EndCredits";
            break;
        case eOAITechnicalCueType::BLACKFRAMES:
            val = "BlackFrames";
            break;
        case eOAITechnicalCueType::OPENINGCREDITS:
            val = "OpeningCredits";
            break;
        case eOAITechnicalCueType::STUDIOLOGO:
            val = "StudioLogo";
            break;
        case eOAITechnicalCueType::SLATE:
            val = "Slate";
            break;
        case eOAITechnicalCueType::CONTENT:
            val = "Content";
            break;
        default:
            break;
...
QJsonValue OAITechnicalCueType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITechnicalCueType::eOAITechnicalCueType OAITechnicalCueType::getValue() const {
    return m_value;
}

void OAITechnicalCueType::setValue(const OAITechnicalCueType::eOAITechnicalCueType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITechnicalCueType::isSet() const {
    
    return m_value_isSet;
}

bool OAITechnicalCueType::isValid() const {
