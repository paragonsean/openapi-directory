...
class OAIFaceAttributes : public OAIEnum {
public:
    OAIFaceAttributes();
    ...
    enum class eOAIFaceAttributes {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DEFAULT, 
        ALL
    };
    OAIFaceAttributes::eOAIFaceAttributes getValue() const;
    void setValue(const OAIFaceAttributes::eOAIFaceAttributes& value);
