...
OAICompareFacesRequest_SourceImage::OAICompareFacesRequest_SourceImage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompareFacesRequest_SourceImage::OAICompareFacesRequest_SourceImage() {
    this->initializeModel();
}

OAICompareFacesRequest_SourceImage::~OAICompareFacesRequest_SourceImage() {}

void OAICompareFacesRequest_SourceImage::initializeModel() {
...
void OAICompareFacesRequest_SourceImage::fromJson(QString jsonString) {
...
void OAICompareFacesRequest_SourceImage::fromJsonObject(QJsonObject json) {
...
QString OAICompareFacesRequest_SourceImage::asJson() const {
...
QJsonObject OAICompareFacesRequest_SourceImage::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAICompareFacesRequest_SourceImage::getBytes() const {
    return m_bytes;
}
void OAICompareFacesRequest_SourceImage::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAICompareFacesRequest_SourceImage::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAICompareFacesRequest_SourceImage::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIImage_S3Object OAICompareFacesRequest_SourceImage::getS3Object() const {
    return m_s3_object;
}
void OAICompareFacesRequest_SourceImage::setS3Object(const OAIImage_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAICompareFacesRequest_SourceImage::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAICompareFacesRequest_SourceImage::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAICompareFacesRequest_SourceImage::isSet() const {
...
bool OAICompareFacesRequest_SourceImage::isValid() const {
