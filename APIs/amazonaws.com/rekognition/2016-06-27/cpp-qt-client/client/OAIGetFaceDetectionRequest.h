...
/*
 * OAIGetFaceDetectionRequest.h
 *
 * 
 */

#ifndef OAIGetFaceDetectionRequest_H
#define OAIGetFaceDetectionRequest_H
...
class OAIGetFaceDetectionRequest : public OAIObject {
public:
    OAIGetFaceDetectionRequest();
    OAIGetFaceDetectionRequest(QString json);
    ~OAIGetFaceDetectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceDetectionRequest)

#endif // OAIGetFaceDetectionRequest_H
