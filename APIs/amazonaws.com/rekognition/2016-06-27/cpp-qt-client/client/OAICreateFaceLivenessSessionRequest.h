...
/*
 * OAICreateFaceLivenessSessionRequest.h
 *
 * 
 */

#ifndef OAICreateFaceLivenessSessionRequest_H
#define OAICreateFaceLivenessSessionRequest_H
...
namespace OpenAPI {
class OAICreateFaceLivenessSessionRequest_Settings;

class OAICreateFaceLivenessSessionRequest : public OAIObject {
public:
    OAICreateFaceLivenessSessionRequest();
    OAICreateFaceLivenessSessionRequest(QString json);
    ~OAICreateFaceLivenessSessionRequest() override;
    ...
    OAICreateFaceLivenessSessionRequest_Settings getSettings() const;
    void setSettings(const OAICreateFaceLivenessSessionRequest_Settings &settings);
...
private:
    ...
    OAICreateFaceLivenessSessionRequest_Settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFaceLivenessSessionRequest)

#endif // OAICreateFaceLivenessSessionRequest_H
