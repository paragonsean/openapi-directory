...
/*
 * OAITextDetectionResult.h
 *
 * Information about text detected in a video. Incudes the detected text, the time in milliseconds from the start of the video that the text was detected, and where it was detected on the screen.
 */

#ifndef OAITextDetectionResult_H
#define OAITextDetectionResult_H
...
namespace OpenAPI {
class OAITextDetectionResult_TextDetection;

class OAITextDetectionResult : public OAIObject {
public:
    OAITextDetectionResult();
    OAITextDetectionResult(QString json);
    ~OAITextDetectionResult() override;
    ...
    OAITextDetectionResult_TextDetection getTextDetection() const;
    void setTextDetection(const OAITextDetectionResult_TextDetection &text_detection);
    bool is_text_detection_Set() const;
    bool is_text_detection_Valid() const;
...
private:
    ...
    OAITextDetectionResult_TextDetection m_text_detection;
    bool m_text_detection_isSet;
    bool m_text_detection_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITextDetectionResult)

#endif // OAITextDetectionResult_H
