...
/*
 * OAIStartTextDetectionFilters_WordFilter.h
 *
 * 
 */

#ifndef OAIStartTextDetectionFilters_WordFilter_H
#define OAIStartTextDetectionFilters_WordFilter_H
...
class OAIStartTextDetectionFilters_WordFilter : public OAIObject {
public:
    OAIStartTextDetectionFilters_WordFilter();
    OAIStartTextDetectionFilters_WordFilter(QString json);
    ~OAIStartTextDetectionFilters_WordFilter() override;
    ...
    float getMinBoundingBoxHeight() const;
    void setMinBoundingBoxHeight(const float &min_bounding_box_height);
    bool is_min_bounding_box_height_Set() const;
    bool is_min_bounding_box_height_Valid() const;

    float getMinBoundingBoxWidth() const;
    void setMinBoundingBoxWidth(const float &min_bounding_box_width);
    bool is_min_bounding_box_width_Set() const;
    bool is_min_bounding_box_width_Valid() const;
...
private:
    ...
    float m_min_bounding_box_height;
    bool m_min_bounding_box_height_isSet;
    bool m_min_bounding_box_height_isValid;

    float m_min_bounding_box_width;
    bool m_min_bounding_box_width_isSet;
    bool m_min_bounding_box_width_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartTextDetectionFilters_WordFilter)

#endif // OAIStartTextDetectionFilters_WordFilter_H
