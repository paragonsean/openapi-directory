...
/*
 * OAIDisassociateFacesResponse.h
 *
 * 
 */

#ifndef OAIDisassociateFacesResponse_H
#define OAIDisassociateFacesResponse_H
...
class OAIDisassociateFacesResponse : public OAIObject {
public:
    OAIDisassociateFacesResponse();
    OAIDisassociateFacesResponse(QString json);
    ~OAIDisassociateFacesResponse() override;
    ...
    QList getDisassociatedFaces() const;
    void setDisassociatedFaces(const QList &disassociated_faces);
    bool is_disassociated_faces_Set() const;
    bool is_disassociated_faces_Valid() const;

    QList getUnsuccessfulFaceDisassociations() const;
    void setUnsuccessfulFaceDisassociations(const QList &unsuccessful_face_disassociations);
    bool is_unsuccessful_face_disassociations_Set() const;
    bool is_unsuccessful_face_disassociations_Valid() const;

    OAIUserStatus getUserStatus() const;
    void setUserStatus(const OAIUserStatus &user_status);
...
private:
    ...
    QList m_disassociated_faces;
    bool m_disassociated_faces_isSet;
    bool m_disassociated_faces_isValid;

    QList m_unsuccessful_face_disassociations;
    bool m_unsuccessful_face_disassociations_isSet;
    bool m_unsuccessful_face_disassociations_isValid;

    OAIUserStatus m_user_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateFacesResponse)

#endif // OAIDisassociateFacesResponse_H
