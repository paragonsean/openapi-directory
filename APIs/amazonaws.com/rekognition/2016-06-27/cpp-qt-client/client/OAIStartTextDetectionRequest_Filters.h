...
/*
 * OAIStartTextDetectionRequest_Filters.h
 *
 * 
 */

#ifndef OAIStartTextDetectionRequest_Filters_H
#define OAIStartTextDetectionRequest_Filters_H
...
class OAIStartTextDetectionRequest_Filters : public OAIObject {
public:
    OAIStartTextDetectionRequest_Filters();
    OAIStartTextDetectionRequest_Filters(QString json);
    ~OAIStartTextDetectionRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTextDetectionRequest_Filters)

#endif // OAIStartTextDetectionRequest_Filters_H
