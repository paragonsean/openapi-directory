...
OAIFaceSearchSortBy::OAIFaceSearchSortBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceSearchSortBy::OAIFaceSearchSortBy() {
    this->initializeModel();
}

OAIFaceSearchSortBy::~OAIFaceSearchSortBy() {}

void OAIFaceSearchSortBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFaceSearchSortBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFaceSearchSortBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INDEX", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFaceSearchSortBy::INDEX;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TIMESTAMP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFaceSearchSortBy::TIMESTAMP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFaceSearchSortBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFaceSearchSortBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFaceSearchSortBy::INDEX:
            val = "INDEX";
            break;
        case eOAIFaceSearchSortBy::TIMESTAMP:
            val = "TIMESTAMP";
            break;
        default:
            break;
...
QJsonValue OAIFaceSearchSortBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFaceSearchSortBy::eOAIFaceSearchSortBy OAIFaceSearchSortBy::getValue() const {
    return m_value;
}

void OAIFaceSearchSortBy::setValue(const OAIFaceSearchSortBy::eOAIFaceSearchSortBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFaceSearchSortBy::isSet() const {
    
    return m_value_isSet;
}

bool OAIFaceSearchSortBy::isValid() const {
