...
/*
 * OAIStartPersonTrackingRequest.h
 *
 * 
 */

#ifndef OAIStartPersonTrackingRequest_H
#define OAIStartPersonTrackingRequest_H

#include <QJsonObject>

#include "OAIStartPersonTrackingRequest_NotificationChannel.h"
#include "OAIStartPersonTrackingRequest_Video.h"
#include <QString>
...
namespace OpenAPI {
class OAIStartPersonTrackingRequest_Video;
class OAIStartPersonTrackingRequest_NotificationChannel;

class OAIStartPersonTrackingRequest : public OAIObject {
public:
    OAIStartPersonTrackingRequest();
    OAIStartPersonTrackingRequest(QString json);
    ~OAIStartPersonTrackingRequest() override;
    ...
    OAIStartPersonTrackingRequest_Video getVideo() const;
    void setVideo(const OAIStartPersonTrackingRequest_Video &video);
    ...
    OAIStartPersonTrackingRequest_NotificationChannel getNotificationChannel() const;
    void setNotificationChannel(const OAIStartPersonTrackingRequest_NotificationChannel &notification_channel);
...
private:
    ...
    OAIStartPersonTrackingRequest_Video m_video;
    bool m_video_isSet;
    ...
    OAIStartPersonTrackingRequest_NotificationChannel m_notification_channel;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartPersonTrackingRequest)

#endif // OAIStartPersonTrackingRequest_H
