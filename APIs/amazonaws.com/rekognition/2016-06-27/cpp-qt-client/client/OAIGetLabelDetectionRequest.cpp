...
#include "OAIGetLabelDetectionRequest.h"
...
OAIGetLabelDetectionRequest::OAIGetLabelDetectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLabelDetectionRequest::OAIGetLabelDetectionRequest() {
    this->initializeModel();
}

OAIGetLabelDetectionRequest::~OAIGetLabelDetectionRequest() {}

void OAIGetLabelDetectionRequest::initializeModel() {
...
void OAIGetLabelDetectionRequest::fromJson(QString jsonString) {
...
void OAIGetLabelDetectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetLabelDetectionRequest::asJson() const {
...
QJsonObject OAIGetLabelDetectionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIGetLabelDetectionRequest::getJobId() const {
    return m_job_id;
}
void OAIGetLabelDetectionRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetLabelDetectionRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetLabelDetectionRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint32 OAIGetLabelDetectionRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetLabelDetectionRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetLabelDetectionRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetLabelDetectionRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetLabelDetectionRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetLabelDetectionRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetLabelDetectionRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetLabelDetectionRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

OAILabelDetectionSortBy OAIGetLabelDetectionRequest::getSortBy() const {
    return m_sort_by;
}
void OAIGetLabelDetectionRequest::setSortBy(const OAILabelDetectionSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetLabelDetectionRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetLabelDetectionRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAILabelDetectionAggregateBy OAIGetLabelDetectionRequest::getAggregateBy() const {
    return m_aggregate_by;
}
void OAIGetLabelDetectionRequest::setAggregateBy(const OAILabelDetectionAggregateBy &aggregate_by) {
    m_aggregate_by = aggregate_by;
    m_aggregate_by_isSet = true;
}

bool OAIGetLabelDetectionRequest::is_aggregate_by_Set() const{
    return m_aggregate_by_isSet;
}

bool OAIGetLabelDetectionRequest::is_aggregate_by_Valid() const{
    return m_aggregate_by_isValid;
}

bool OAIGetLabelDetectionRequest::isSet() const {
...
bool OAIGetLabelDetectionRequest::isValid() const {
