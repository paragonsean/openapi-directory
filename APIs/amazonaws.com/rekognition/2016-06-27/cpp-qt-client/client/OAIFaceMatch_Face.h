...
#ifndef OAIFaceMatch_Face_H
#define OAIFaceMatch_Face_H
...
class OAIFaceMatch_Face : public OAIObject {
public:
    OAIFaceMatch_Face();
    OAIFaceMatch_Face(QString json);
    ~OAIFaceMatch_Face() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceMatch_Face)

#endif // OAIFaceMatch_Face_H
