...
#include "OAIProtectiveEquipmentPerson.h"
...
OAIProtectiveEquipmentPerson::OAIProtectiveEquipmentPerson(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProtectiveEquipmentPerson::OAIProtectiveEquipmentPerson() {
    this->initializeModel();
}

OAIProtectiveEquipmentPerson::~OAIProtectiveEquipmentPerson() {}

void OAIProtectiveEquipmentPerson::initializeModel() {
...
void OAIProtectiveEquipmentPerson::fromJson(QString jsonString) {
...
void OAIProtectiveEquipmentPerson::fromJsonObject(QJsonObject json) {
...
QString OAIProtectiveEquipmentPerson::asJson() const {
...
QJsonObject OAIProtectiveEquipmentPerson::asJsonObject() const {
    QJsonObject obj;
    if (m_body_parts.isSet()) {
...
QList OAIProtectiveEquipmentPerson::getBodyParts() const {
    return m_body_parts;
}
void OAIProtectiveEquipmentPerson::setBodyParts(const QList &body_parts) {
    m_body_parts = body_parts;
    m_body_parts_isSet = true;
}

bool OAIProtectiveEquipmentPerson::is_body_parts_Set() const{
    return m_body_parts_isSet;
}

bool OAIProtectiveEquipmentPerson::is_body_parts_Valid() const{
    return m_body_parts_isValid;
}

OAIProtectiveEquipmentPerson_BoundingBox OAIProtectiveEquipmentPerson::getBoundingBox() const {
    return m_bounding_box;
}
void OAIProtectiveEquipmentPerson::setBoundingBox(const OAIProtectiveEquipmentPerson_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIProtectiveEquipmentPerson::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIProtectiveEquipmentPerson::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

float OAIProtectiveEquipmentPerson::getConfidence() const {
    return m_confidence;
}
void OAIProtectiveEquipmentPerson::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIProtectiveEquipmentPerson::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIProtectiveEquipmentPerson::is_confidence_Valid() const{
    return m_confidence_isValid;
}

qint32 OAIProtectiveEquipmentPerson::getId() const {
    return m_id;
}
void OAIProtectiveEquipmentPerson::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProtectiveEquipmentPerson::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProtectiveEquipmentPerson::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIProtectiveEquipmentPerson::isSet() const {
...
bool OAIProtectiveEquipmentPerson::isValid() const {
