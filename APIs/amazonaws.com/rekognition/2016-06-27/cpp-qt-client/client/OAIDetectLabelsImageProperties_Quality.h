...
/*
 * OAIDetectLabelsImageProperties_Quality.h
 *
 * 
 */

#ifndef OAIDetectLabelsImageProperties_Quality_H
#define OAIDetectLabelsImageProperties_Quality_H
...
class OAIDetectLabelsImageProperties_Quality : public OAIObject {
public:
    OAIDetectLabelsImageProperties_Quality();
    OAIDetectLabelsImageProperties_Quality(QString json);
    ~OAIDetectLabelsImageProperties_Quality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageProperties_Quality)

#endif // OAIDetectLabelsImageProperties_Quality_H
