...
#include "OAIDetectLabelsImageForeground_Quality.h"
...
OAIDetectLabelsImageForeground_Quality::OAIDetectLabelsImageForeground_Quality(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageForeground_Quality::OAIDetectLabelsImageForeground_Quality() {
    this->initializeModel();
}

OAIDetectLabelsImageForeground_Quality::~OAIDetectLabelsImageForeground_Quality() {}

void OAIDetectLabelsImageForeground_Quality::initializeModel() {
...
void OAIDetectLabelsImageForeground_Quality::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageForeground_Quality::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageForeground_Quality::asJson() const {
...
QJsonObject OAIDetectLabelsImageForeground_Quality::asJsonObject() const {
    QJsonObject obj;
...
float OAIDetectLabelsImageForeground_Quality::getBrightness() const {
    return m_brightness;
}
void OAIDetectLabelsImageForeground_Quality::setBrightness(const float &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIDetectLabelsImageForeground_Quality::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIDetectLabelsImageForeground_Quality::is_brightness_Valid() const{
    return m_brightness_isValid;
}

float OAIDetectLabelsImageForeground_Quality::getSharpness() const {
    return m_sharpness;
}
void OAIDetectLabelsImageForeground_Quality::setSharpness(const float &sharpness) {
    m_sharpness = sharpness;
    m_sharpness_isSet = true;
}

bool OAIDetectLabelsImageForeground_Quality::is_sharpness_Set() const{
    return m_sharpness_isSet;
}

bool OAIDetectLabelsImageForeground_Quality::is_sharpness_Valid() const{
    return m_sharpness_isValid;
}

float OAIDetectLabelsImageForeground_Quality::getContrast() const {
    return m_contrast;
}
void OAIDetectLabelsImageForeground_Quality::setContrast(const float &contrast) {
    m_contrast = contrast;
    m_contrast_isSet = true;
}

bool OAIDetectLabelsImageForeground_Quality::is_contrast_Set() const{
    return m_contrast_isSet;
}

bool OAIDetectLabelsImageForeground_Quality::is_contrast_Valid() const{
    return m_contrast_isValid;
}

bool OAIDetectLabelsImageForeground_Quality::isSet() const {
...
bool OAIDetectLabelsImageForeground_Quality::isValid() const {
