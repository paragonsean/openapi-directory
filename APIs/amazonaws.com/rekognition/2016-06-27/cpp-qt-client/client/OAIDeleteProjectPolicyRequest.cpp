...
#include "OAIDeleteProjectPolicyRequest.h"
...
OAIDeleteProjectPolicyRequest::OAIDeleteProjectPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteProjectPolicyRequest::OAIDeleteProjectPolicyRequest() {
    this->initializeModel();
}

OAIDeleteProjectPolicyRequest::~OAIDeleteProjectPolicyRequest() {}

void OAIDeleteProjectPolicyRequest::initializeModel() {
...
void OAIDeleteProjectPolicyRequest::fromJson(QString jsonString) {
...
void OAIDeleteProjectPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteProjectPolicyRequest::asJson() const {
...
QJsonObject OAIDeleteProjectPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteProjectPolicyRequest::getProjectArn() const {
    return m_project_arn;
}
void OAIDeleteProjectPolicyRequest::setProjectArn(const QString &project_arn) {
    m_project_arn = project_arn;
    m_project_arn_isSet = true;
}

bool OAIDeleteProjectPolicyRequest::is_project_arn_Set() const{
    return m_project_arn_isSet;
}

bool OAIDeleteProjectPolicyRequest::is_project_arn_Valid() const{
    return m_project_arn_isValid;
}

QString OAIDeleteProjectPolicyRequest::getPolicyName() const {
    return m_policy_name;
}
void OAIDeleteProjectPolicyRequest::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIDeleteProjectPolicyRequest::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIDeleteProjectPolicyRequest::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

QString OAIDeleteProjectPolicyRequest::getPolicyRevisionId() const {
    return m_policy_revision_id;
}
void OAIDeleteProjectPolicyRequest::setPolicyRevisionId(const QString &policy_revision_id) {
    m_policy_revision_id = policy_revision_id;
    m_policy_revision_id_isSet = true;
}

bool OAIDeleteProjectPolicyRequest::is_policy_revision_id_Set() const{
    return m_policy_revision_id_isSet;
}

bool OAIDeleteProjectPolicyRequest::is_policy_revision_id_Valid() const{
    return m_policy_revision_id_isValid;
}

bool OAIDeleteProjectPolicyRequest::isSet() const {
...
bool OAIDeleteProjectPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_project_arn_isValid && m_policy_name_isValid && true;
}
