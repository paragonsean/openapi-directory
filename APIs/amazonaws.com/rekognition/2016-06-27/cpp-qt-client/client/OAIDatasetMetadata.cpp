...
OAIDatasetType OAIDatasetMetadata::getDatasetType() const {
    return m_dataset_type;
}
void OAIDatasetMetadata::setDatasetType(const OAIDatasetType &dataset_type) {
...
OAIDatasetStatusMessageCode OAIDatasetMetadata::getStatusMessageCode() const {
    return m_status_message_code;
}
void OAIDatasetMetadata::setStatusMessageCode(const OAIDatasetStatusMessageCode &status_message_code) {
    m_status_message_code = status_message_code;
    m_status_message_code_isSet = true;
}

bool OAIDatasetMetadata::is_status_message_code_Set() const{
    return m_status_message_code_isSet;
}

bool OAIDatasetMetadata::is_status_message_code_Valid() const{
