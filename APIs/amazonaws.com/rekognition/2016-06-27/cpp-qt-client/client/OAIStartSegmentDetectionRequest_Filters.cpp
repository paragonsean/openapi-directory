...
#include "OAIStartSegmentDetectionRequest_Filters.h"
...
OAIStartSegmentDetectionRequest_Filters::OAIStartSegmentDetectionRequest_Filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSegmentDetectionRequest_Filters::OAIStartSegmentDetectionRequest_Filters() {
    this->initializeModel();
}

OAIStartSegmentDetectionRequest_Filters::~OAIStartSegmentDetectionRequest_Filters() {}

void OAIStartSegmentDetectionRequest_Filters::initializeModel() {

    m_technical_cue_filter_isSet = false;
    m_technical_cue_filter_isValid = false;

    m_shot_filter_isSet = false;
    m_shot_filter_isValid = false;
}

void OAIStartSegmentDetectionRequest_Filters::fromJson(QString jsonString) {
...
void OAIStartSegmentDetectionRequest_Filters::fromJsonObject(QJsonObject json) {

    m_technical_cue_filter_isValid = ::OpenAPI::fromJsonValue(m_technical_cue_filter, json[QString("TechnicalCueFilter")]);
    m_technical_cue_filter_isSet = !json[QString("TechnicalCueFilter")].isNull() && m_technical_cue_filter_isValid;

    m_shot_filter_isValid = ::OpenAPI::fromJsonValue(m_shot_filter, json[QString("ShotFilter")]);
    m_shot_filter_isSet = !json[QString("ShotFilter")].isNull() && m_shot_filter_isValid;
}

QString OAIStartSegmentDetectionRequest_Filters::asJson() const {
...
QJsonObject OAIStartSegmentDetectionRequest_Filters::asJsonObject() const {
    QJsonObject obj;
    if (m_technical_cue_filter.isSet()) {
        obj.insert(QString("TechnicalCueFilter"), ::OpenAPI::toJsonValue(m_technical_cue_filter));
    }
    if (m_shot_filter.isSet()) {
        obj.insert(QString("ShotFilter"), ::OpenAPI::toJsonValue(m_shot_filter));
    }
    return obj;
}

OAIStartSegmentDetectionFilters_TechnicalCueFilter OAIStartSegmentDetectionRequest_Filters::getTechnicalCueFilter() const {
    return m_technical_cue_filter;
}
void OAIStartSegmentDetectionRequest_Filters::setTechnicalCueFilter(const OAIStartSegmentDetectionFilters_TechnicalCueFilter &technical_cue_filter) {
    m_technical_cue_filter = technical_cue_filter;
    m_technical_cue_filter_isSet = true;
}

bool OAIStartSegmentDetectionRequest_Filters::is_technical_cue_filter_Set() const{
    return m_technical_cue_filter_isSet;
}

bool OAIStartSegmentDetectionRequest_Filters::is_technical_cue_filter_Valid() const{
    return m_technical_cue_filter_isValid;
}

OAIStartSegmentDetectionFilters_ShotFilter OAIStartSegmentDetectionRequest_Filters::getShotFilter() const {
    return m_shot_filter;
}
void OAIStartSegmentDetectionRequest_Filters::setShotFilter(const OAIStartSegmentDetectionFilters_ShotFilter &shot_filter) {
    m_shot_filter = shot_filter;
    m_shot_filter_isSet = true;
}

bool OAIStartSegmentDetectionRequest_Filters::is_shot_filter_Set() const{
    return m_shot_filter_isSet;
}

bool OAIStartSegmentDetectionRequest_Filters::is_shot_filter_Valid() const{
    return m_shot_filter_isValid;
}

bool OAIStartSegmentDetectionRequest_Filters::isSet() const {
...
bool OAIStartSegmentDetectionRequest_Filters::isValid() const {
