...
/*
 * OAIStreamProcessorSettings_FaceSearch.h
 *
 * 
 */

#ifndef OAIStreamProcessorSettings_FaceSearch_H
#define OAIStreamProcessorSettings_FaceSearch_H
...
class OAIStreamProcessorSettings_FaceSearch : public OAIObject {
public:
    OAIStreamProcessorSettings_FaceSearch();
    OAIStreamProcessorSettings_FaceSearch(QString json);
    ~OAIStreamProcessorSettings_FaceSearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorSettings_FaceSearch)

#endif // OAIStreamProcessorSettings_FaceSearch_H
