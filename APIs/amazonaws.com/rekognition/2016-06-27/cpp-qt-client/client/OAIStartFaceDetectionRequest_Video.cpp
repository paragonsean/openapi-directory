...
#include "OAIStartFaceDetectionRequest_Video.h"
...
OAIStartFaceDetectionRequest_Video::OAIStartFaceDetectionRequest_Video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFaceDetectionRequest_Video::OAIStartFaceDetectionRequest_Video() {
    this->initializeModel();
}

OAIStartFaceDetectionRequest_Video::~OAIStartFaceDetectionRequest_Video() {}

void OAIStartFaceDetectionRequest_Video::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIStartFaceDetectionRequest_Video::fromJson(QString jsonString) {
...
void OAIStartFaceDetectionRequest_Video::fromJsonObject(QJsonObject json) {
...
QString OAIStartFaceDetectionRequest_Video::asJson() const {
...
QJsonObject OAIStartFaceDetectionRequest_Video::asJsonObject() const {
    QJsonObject obj;
...
OAIVideo_S3Object OAIStartFaceDetectionRequest_Video::getS3Object() const {
    return m_s3_object;
}
void OAIStartFaceDetectionRequest_Video::setS3Object(const OAIVideo_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIStartFaceDetectionRequest_Video::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIStartFaceDetectionRequest_Video::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIStartFaceDetectionRequest_Video::isSet() const {
...
bool OAIStartFaceDetectionRequest_Video::isValid() const {
