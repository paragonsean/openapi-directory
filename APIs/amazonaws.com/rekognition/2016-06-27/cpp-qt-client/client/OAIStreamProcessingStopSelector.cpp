...
#include "OAIStreamProcessingStopSelector.h"
...
OAIStreamProcessingStopSelector::OAIStreamProcessingStopSelector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessingStopSelector::OAIStreamProcessingStopSelector() {
    this->initializeModel();
}

OAIStreamProcessingStopSelector::~OAIStreamProcessingStopSelector() {}

void OAIStreamProcessingStopSelector::initializeModel() {

    m_max_duration_in_seconds_isSet = false;
    m_max_duration_in_seconds_isValid = false;
}

void OAIStreamProcessingStopSelector::fromJson(QString jsonString) {
...
void OAIStreamProcessingStopSelector::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessingStopSelector::asJson() const {
...
QJsonObject OAIStreamProcessingStopSelector::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIStreamProcessingStopSelector::getMaxDurationInSeconds() const {
    return m_max_duration_in_seconds;
}
void OAIStreamProcessingStopSelector::setMaxDurationInSeconds(const qint32 &max_duration_in_seconds) {
    m_max_duration_in_seconds = max_duration_in_seconds;
    m_max_duration_in_seconds_isSet = true;
}

bool OAIStreamProcessingStopSelector::is_max_duration_in_seconds_Set() const{
    return m_max_duration_in_seconds_isSet;
}

bool OAIStreamProcessingStopSelector::is_max_duration_in_seconds_Valid() const{
    return m_max_duration_in_seconds_isValid;
}

bool OAIStreamProcessingStopSelector::isSet() const {
...
bool OAIStreamProcessingStopSelector::isValid() const {
