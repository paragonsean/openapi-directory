...
/*
 * OAIStreamProcessorInput_KinesisVideoStream.h
 *
 * 
 */

#ifndef OAIStreamProcessorInput_KinesisVideoStream_H
#define OAIStreamProcessorInput_KinesisVideoStream_H
...
class OAIStreamProcessorInput_KinesisVideoStream : public OAIObject {
public:
    OAIStreamProcessorInput_KinesisVideoStream();
    OAIStreamProcessorInput_KinesisVideoStream(QString json);
    ~OAIStreamProcessorInput_KinesisVideoStream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorInput_KinesisVideoStream)

#endif // OAIStreamProcessorInput_KinesisVideoStream_H
