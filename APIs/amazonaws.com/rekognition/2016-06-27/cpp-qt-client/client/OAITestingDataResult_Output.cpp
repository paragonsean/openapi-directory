...
OAITestingDataResult_Output::OAITestingDataResult_Output(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestingDataResult_Output::OAITestingDataResult_Output() {
    this->initializeModel();
}

OAITestingDataResult_Output::~OAITestingDataResult_Output() {}

void OAITestingDataResult_Output::initializeModel() {
...
void OAITestingDataResult_Output::fromJson(QString jsonString) {
...
void OAITestingDataResult_Output::fromJsonObject(QJsonObject json) {
...
QString OAITestingDataResult_Output::asJson() const {
...
QJsonObject OAITestingDataResult_Output::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAITestingDataResult_Output::getAssets() const {
    return m_assets;
}
void OAITestingDataResult_Output::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAITestingDataResult_Output::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAITestingDataResult_Output::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAITestingDataResult_Output::getAutoCreate() const {
    return m_auto_create;
}
void OAITestingDataResult_Output::setAutoCreate(const bool &auto_create) {
    m_auto_create = auto_create;
    m_auto_create_isSet = true;
}

bool OAITestingDataResult_Output::is_auto_create_Set() const{
    return m_auto_create_isSet;
}

bool OAITestingDataResult_Output::is_auto_create_Valid() const{
    return m_auto_create_isValid;
}

bool OAITestingDataResult_Output::isSet() const {
...
bool OAITestingDataResult_Output::isValid() const {
