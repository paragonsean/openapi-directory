...
/*
 * OAIStartFaceDetectionRequest_NotificationChannel.h
 *
 * 
 */

#ifndef OAIStartFaceDetectionRequest_NotificationChannel_H
#define OAIStartFaceDetectionRequest_NotificationChannel_H
...
class OAIStartFaceDetectionRequest_NotificationChannel : public OAIObject {
public:
    OAIStartFaceDetectionRequest_NotificationChannel();
    OAIStartFaceDetectionRequest_NotificationChannel(QString json);
    ~OAIStartFaceDetectionRequest_NotificationChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceDetectionRequest_NotificationChannel)

#endif // OAIStartFaceDetectionRequest_NotificationChannel_H
