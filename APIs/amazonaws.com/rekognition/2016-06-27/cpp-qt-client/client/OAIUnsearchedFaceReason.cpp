...
#include "OAIUnsearchedFaceReason.h"
...
OAIUnsearchedFaceReason::OAIUnsearchedFaceReason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsearchedFaceReason::OAIUnsearchedFaceReason() {
    this->initializeModel();
}

OAIUnsearchedFaceReason::~OAIUnsearchedFaceReason() {}

void OAIUnsearchedFaceReason::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUnsearchedFaceReason::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUnsearchedFaceReason::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FACE_NOT_LARGEST", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::FACE_NOT_LARGEST;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXCEEDS_MAX_FACES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::EXCEEDS_MAX_FACES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXTREME_POSE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::EXTREME_POSE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOW_BRIGHTNESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::LOW_BRIGHTNESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOW_SHARPNESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::LOW_SHARPNESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOW_CONFIDENCE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::LOW_CONFIDENCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SMALL_BOUNDING_BOX", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::SMALL_BOUNDING_BOX;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOW_FACE_QUALITY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsearchedFaceReason::LOW_FACE_QUALITY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUnsearchedFaceReason::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUnsearchedFaceReason::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUnsearchedFaceReason::FACE_NOT_LARGEST:
            val = "FACE_NOT_LARGEST";
            break;
        case eOAIUnsearchedFaceReason::EXCEEDS_MAX_FACES:
            val = "EXCEEDS_MAX_FACES";
            break;
        case eOAIUnsearchedFaceReason::EXTREME_POSE:
            val = "EXTREME_POSE";
            break;
        case eOAIUnsearchedFaceReason::LOW_BRIGHTNESS:
            val = "LOW_BRIGHTNESS";
            break;
        case eOAIUnsearchedFaceReason::LOW_SHARPNESS:
            val = "LOW_SHARPNESS";
            break;
        case eOAIUnsearchedFaceReason::LOW_CONFIDENCE:
            val = "LOW_CONFIDENCE";
            break;
        case eOAIUnsearchedFaceReason::SMALL_BOUNDING_BOX:
            val = "SMALL_BOUNDING_BOX";
            break;
        case eOAIUnsearchedFaceReason::LOW_FACE_QUALITY:
            val = "LOW_FACE_QUALITY";
            break;
        default:
            break;
    }
...
QJsonValue OAIUnsearchedFaceReason::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUnsearchedFaceReason::eOAIUnsearchedFaceReason OAIUnsearchedFaceReason::getValue() const {
    return m_value;
}

void OAIUnsearchedFaceReason::setValue(const OAIUnsearchedFaceReason::eOAIUnsearchedFaceReason& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUnsearchedFaceReason::isSet() const {
    
    return m_value_isSet;
}

bool OAIUnsearchedFaceReason::isValid() const {
