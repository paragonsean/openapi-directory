...
#include "OAIStartFaceSearchResponse.h"
...
OAIStartFaceSearchResponse::OAIStartFaceSearchResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFaceSearchResponse::OAIStartFaceSearchResponse() {
    this->initializeModel();
}

OAIStartFaceSearchResponse::~OAIStartFaceSearchResponse() {}

void OAIStartFaceSearchResponse::initializeModel() {

    m_job_id_isSet = false;
    m_job_id_isValid = false;
}

void OAIStartFaceSearchResponse::fromJson(QString jsonString) {
...
void OAIStartFaceSearchResponse::fromJsonObject(QJsonObject json) {

    m_job_id_isValid = ::OpenAPI::fromJsonValue(m_job_id, json[QString("JobId")]);
    m_job_id_isSet = !json[QString("JobId")].isNull() && m_job_id_isValid;
}

QString OAIStartFaceSearchResponse::asJson() const {
...
QJsonObject OAIStartFaceSearchResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIStartFaceSearchResponse::getJobId() const {
    return m_job_id;
}
void OAIStartFaceSearchResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIStartFaceSearchResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIStartFaceSearchResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIStartFaceSearchResponse::isSet() const {
...
bool OAIStartFaceSearchResponse::isValid() const {
