...
/*
 * OAIProtectiveEquipmentSummary.h
 *
...
#ifndef OAIProtectiveEquipmentSummary_H
#define OAIProtectiveEquipmentSummary_H
...
class OAIProtectiveEquipmentSummary : public OAIObject {
public:
    OAIProtectiveEquipmentSummary();
    OAIProtectiveEquipmentSummary(QString json);
    ~OAIProtectiveEquipmentSummary() override;
    ...
    QList getPersonsWithRequiredEquipment() const;
    void setPersonsWithRequiredEquipment(const QList &persons_with_required_equipment);
    bool is_persons_with_required_equipment_Set() const;
    bool is_persons_with_required_equipment_Valid() const;

    QList getPersonsWithoutRequiredEquipment() const;
    void setPersonsWithoutRequiredEquipment(const QList &persons_without_required_equipment);
    bool is_persons_without_required_equipment_Set() const;
    bool is_persons_without_required_equipment_Valid() const;

    QList getPersonsIndeterminate() const;
    void setPersonsIndeterminate(const QList &persons_indeterminate);
    bool is_persons_indeterminate_Set() const;
    bool is_persons_indeterminate_Valid() const;
...
private:
    ...
    QList m_persons_with_required_equipment;
    bool m_persons_with_required_equipment_isSet;
    bool m_persons_with_required_equipment_isValid;

    QList m_persons_without_required_equipment;
    bool m_persons_without_required_equipment_isSet;
    bool m_persons_without_required_equipment_isValid;

    QList m_persons_indeterminate;
    bool m_persons_indeterminate_isSet;
    bool m_persons_indeterminate_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProtectiveEquipmentSummary)

#endif // OAIProtectiveEquipmentSummary_H
