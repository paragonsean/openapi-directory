...
OAIListFacesRequest::OAIListFacesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFacesRequest::OAIListFacesRequest() {
    this->initializeModel();
}

OAIListFacesRequest::~OAIListFacesRequest() {}

void OAIListFacesRequest::initializeModel() {
...
void OAIListFacesRequest::fromJson(QString jsonString) {
...
void OAIListFacesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListFacesRequest::asJson() const {
...
QJsonObject OAIListFacesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListFacesRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIListFacesRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIListFacesRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIListFacesRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAIListFacesRequest::getNextToken() const {
    return m_next_token;
}
void OAIListFacesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListFacesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListFacesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListFacesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListFacesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListFacesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListFacesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListFacesRequest::getUserId() const {
    return m_user_id;
}
void OAIListFacesRequest::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIListFacesRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIListFacesRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QList OAIListFacesRequest::getFaceIds() const {
    return m_face_ids;
}
void OAIListFacesRequest::setFaceIds(const QList &face_ids) {
    m_face_ids = face_ids;
    m_face_ids_isSet = true;
}

bool OAIListFacesRequest::is_face_ids_Set() const{
    return m_face_ids_isSet;
}

bool OAIListFacesRequest::is_face_ids_Valid() const{
    return m_face_ids_isValid;
}

bool OAIListFacesRequest::isSet() const {
...
bool OAIListFacesRequest::isValid() const {
