...
#ifndef OAIEmotionName_H
#define OAIEmotionName_H
...
class OAIEmotionName : public OAIEnum {
public:
    OAIEmotionName();
    OAIEmotionName(QString json);
    ~OAIEmotionName() override;
    ...
    OAIEmotionName::eOAIEmotionName getValue() const;
    void setValue(const OAIEmotionName::eOAIEmotionName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmotionName)

#endif // OAIEmotionName_H
