...
OAICompareFacesRequest_TargetImage::OAICompareFacesRequest_TargetImage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompareFacesRequest_TargetImage::OAICompareFacesRequest_TargetImage() {
    this->initializeModel();
}

OAICompareFacesRequest_TargetImage::~OAICompareFacesRequest_TargetImage() {}

void OAICompareFacesRequest_TargetImage::initializeModel() {
...
void OAICompareFacesRequest_TargetImage::fromJson(QString jsonString) {
...
void OAICompareFacesRequest_TargetImage::fromJsonObject(QJsonObject json) {
...
QString OAICompareFacesRequest_TargetImage::asJson() const {
...
QJsonObject OAICompareFacesRequest_TargetImage::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAICompareFacesRequest_TargetImage::getBytes() const {
    return m_bytes;
}
void OAICompareFacesRequest_TargetImage::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAICompareFacesRequest_TargetImage::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAICompareFacesRequest_TargetImage::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIImage_S3Object OAICompareFacesRequest_TargetImage::getS3Object() const {
    return m_s3_object;
}
void OAICompareFacesRequest_TargetImage::setS3Object(const OAIImage_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAICompareFacesRequest_TargetImage::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAICompareFacesRequest_TargetImage::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAICompareFacesRequest_TargetImage::isSet() const {
...
bool OAICompareFacesRequest_TargetImage::isValid() const {
