...
/*
 * OAIRegionOfInterest_BoundingBox.h
 *
 * 
 */

#ifndef OAIRegionOfInterest_BoundingBox_H
#define OAIRegionOfInterest_BoundingBox_H
...
class OAIRegionOfInterest_BoundingBox : public OAIObject {
public:
    OAIRegionOfInterest_BoundingBox();
    OAIRegionOfInterest_BoundingBox(QString json);
    ~OAIRegionOfInterest_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegionOfInterest_BoundingBox)

#endif // OAIRegionOfInterest_BoundingBox_H
