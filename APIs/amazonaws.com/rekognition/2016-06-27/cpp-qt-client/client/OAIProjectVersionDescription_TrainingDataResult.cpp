...
#include "OAIProjectVersionDescription_TrainingDataResult.h"
...
OAIProjectVersionDescription_TrainingDataResult::OAIProjectVersionDescription_TrainingDataResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectVersionDescription_TrainingDataResult::OAIProjectVersionDescription_TrainingDataResult() {
    this->initializeModel();
}

OAIProjectVersionDescription_TrainingDataResult::~OAIProjectVersionDescription_TrainingDataResult() {}

void OAIProjectVersionDescription_TrainingDataResult::initializeModel() {
...
void OAIProjectVersionDescription_TrainingDataResult::fromJson(QString jsonString) {
...
void OAIProjectVersionDescription_TrainingDataResult::fromJsonObject(QJsonObject json) {
...
QString OAIProjectVersionDescription_TrainingDataResult::asJson() const {
...
QJsonObject OAIProjectVersionDescription_TrainingDataResult::asJsonObject() const {
    QJsonObject obj;
    if (m_input.isSet()) {
...
OAITrainingDataResult_Input OAIProjectVersionDescription_TrainingDataResult::getInput() const {
    return m_input;
}
void OAIProjectVersionDescription_TrainingDataResult::setInput(const OAITrainingDataResult_Input &input) {
    m_input = input;
    m_input_isSet = true;
}

bool OAIProjectVersionDescription_TrainingDataResult::is_input_Set() const{
    return m_input_isSet;
}

bool OAIProjectVersionDescription_TrainingDataResult::is_input_Valid() const{
    return m_input_isValid;
}

OAITrainingDataResult_Output OAIProjectVersionDescription_TrainingDataResult::getOutput() const {
    return m_output;
}
void OAIProjectVersionDescription_TrainingDataResult::setOutput(const OAITrainingDataResult_Output &output) {
    m_output = output;
    m_output_isSet = true;
}

bool OAIProjectVersionDescription_TrainingDataResult::is_output_Set() const{
    return m_output_isSet;
}

bool OAIProjectVersionDescription_TrainingDataResult::is_output_Valid() const{
    return m_output_isValid;
}

OAITrainingDataResult_Validation OAIProjectVersionDescription_TrainingDataResult::getValidation() const {
    return m_validation;
}
void OAIProjectVersionDescription_TrainingDataResult::setValidation(const OAITrainingDataResult_Validation &validation) {
    m_validation = validation;
    m_validation_isSet = true;
}

bool OAIProjectVersionDescription_TrainingDataResult::is_validation_Set() const{
    return m_validation_isSet;
}

bool OAIProjectVersionDescription_TrainingDataResult::is_validation_Valid() const{
    return m_validation_isValid;
}

bool OAIProjectVersionDescription_TrainingDataResult::isSet() const {
...
bool OAIProjectVersionDescription_TrainingDataResult::isValid() const {
