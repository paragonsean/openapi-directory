...
/*
 * OAISearchUsersByImageResponse_SearchedFace.h
 *
 * 
 */

#ifndef OAISearchUsersByImageResponse_SearchedFace_H
#define OAISearchUsersByImageResponse_SearchedFace_H
...
class OAISearchUsersByImageResponse_SearchedFace : public OAIObject {
public:
    OAISearchUsersByImageResponse_SearchedFace();
    OAISearchUsersByImageResponse_SearchedFace(QString json);
    ~OAISearchUsersByImageResponse_SearchedFace() override;
    ...
    OAIFaceDetail getFaceDetail() const;
    void setFaceDetail(const OAIFaceDetail &face_detail);
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchUsersByImageResponse_SearchedFace)

#endif // OAISearchUsersByImageResponse_SearchedFace_H
