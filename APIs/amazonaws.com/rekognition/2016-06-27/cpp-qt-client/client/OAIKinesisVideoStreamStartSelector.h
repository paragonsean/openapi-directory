...
/*
 * OAIKinesisVideoStreamStartSelector.h
 *
...
#ifndef OAIKinesisVideoStreamStartSelector_H
#define OAIKinesisVideoStreamStartSelector_H
...
class OAIKinesisVideoStreamStartSelector : public OAIObject {
public:
    OAIKinesisVideoStreamStartSelector();
    OAIKinesisVideoStreamStartSelector(QString json);
    ~OAIKinesisVideoStreamStartSelector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKinesisVideoStreamStartSelector)

#endif // OAIKinesisVideoStreamStartSelector_H
