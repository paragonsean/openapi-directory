...
#include "OAIProjectVersionDescription_ManifestSummary.h"
...
OAIProjectVersionDescription_ManifestSummary::OAIProjectVersionDescription_ManifestSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectVersionDescription_ManifestSummary::OAIProjectVersionDescription_ManifestSummary() {
    this->initializeModel();
}

OAIProjectVersionDescription_ManifestSummary::~OAIProjectVersionDescription_ManifestSummary() {}

void OAIProjectVersionDescription_ManifestSummary::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIProjectVersionDescription_ManifestSummary::fromJson(QString jsonString) {
...
void OAIProjectVersionDescription_ManifestSummary::fromJsonObject(QJsonObject json) {
...
QString OAIProjectVersionDescription_ManifestSummary::asJson() const {
...
QJsonObject OAIProjectVersionDescription_ManifestSummary::asJsonObject() const {
    QJsonObject obj;
...
OAIS3Object OAIProjectVersionDescription_ManifestSummary::getS3Object() const {
    return m_s3_object;
}
void OAIProjectVersionDescription_ManifestSummary::setS3Object(const OAIS3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIProjectVersionDescription_ManifestSummary::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIProjectVersionDescription_ManifestSummary::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIProjectVersionDescription_ManifestSummary::isSet() const {
...
bool OAIProjectVersionDescription_ManifestSummary::isValid() const {
