...
/*
 * OAIGetLabelDetectionResponse.h
 *
 * 
 */

#ifndef OAIGetLabelDetectionResponse_H
#define OAIGetLabelDetectionResponse_H

#include <QJsonObject>

#include "OAIGetFaceDetectionResponse_VideoMetadata.h"
#include "OAIGetLabelDetectionResponse_GetRequestMetadata.h"
#include "OAIVideo.h"
#include "OAIVideoJobStatus.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGetFaceDetectionResponse_VideoMetadata;
class OAIVideo;
class OAIGetLabelDetectionResponse_GetRequestMetadata;

class OAIGetLabelDetectionResponse : public OAIObject {
public:
    OAIGetLabelDetectionResponse();
    OAIGetLabelDetectionResponse(QString json);
    ~OAIGetLabelDetectionResponse() override;
    ...
    OAIVideoJobStatus getJobStatus() const;
    void setJobStatus(const OAIVideoJobStatus &job_status);
    ...
    OAIGetFaceDetectionResponse_VideoMetadata getVideoMetadata() const;
    void setVideoMetadata(const OAIGetFaceDetectionResponse_VideoMetadata &video_metadata);
    ...
    QString getLabelModelVersion() const;
    void setLabelModelVersion(const QString &label_model_version);
    bool is_label_model_version_Set() const;
    bool is_label_model_version_Valid() const;
    ...
    OAIGetLabelDetectionResponse_GetRequestMetadata getGetRequestMetadata() const;
    void setGetRequestMetadata(const OAIGetLabelDetectionResponse_GetRequestMetadata &get_request_metadata);
    bool is_get_request_metadata_Set() const;
    bool is_get_request_metadata_Valid() const;
...
private:
    ...
    OAIVideoJobStatus m_job_status;
    ...
    OAIGetFaceDetectionResponse_VideoMetadata m_video_metadata;
    ...
    QString m_label_model_version;
    bool m_label_model_version_isSet;
    bool m_label_model_version_isValid;
    ...
    OAIGetLabelDetectionResponse_GetRequestMetadata m_get_request_metadata;
    bool m_get_request_metadata_isSet;
    bool m_get_request_metadata_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetLabelDetectionResponse)

#endif // OAIGetLabelDetectionResponse_H
