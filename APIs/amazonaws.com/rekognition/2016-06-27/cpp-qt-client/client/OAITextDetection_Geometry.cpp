...
OAITextDetection_Geometry::OAITextDetection_Geometry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITextDetection_Geometry::OAITextDetection_Geometry() {
    this->initializeModel();
}

OAITextDetection_Geometry::~OAITextDetection_Geometry() {}

void OAITextDetection_Geometry::initializeModel() {
...
void OAITextDetection_Geometry::fromJson(QString jsonString) {
...
void OAITextDetection_Geometry::fromJsonObject(QJsonObject json) {
...
QString OAITextDetection_Geometry::asJson() const {
...
QJsonObject OAITextDetection_Geometry::asJsonObject() const {
    QJsonObject obj;
...
OAIGeometry_BoundingBox OAITextDetection_Geometry::getBoundingBox() const {
    return m_bounding_box;
}
void OAITextDetection_Geometry::setBoundingBox(const OAIGeometry_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAITextDetection_Geometry::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAITextDetection_Geometry::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

QList OAITextDetection_Geometry::getPolygon() const {
    return m_polygon;
}
void OAITextDetection_Geometry::setPolygon(const QList &polygon) {
    m_polygon = polygon;
    m_polygon_isSet = true;
}

bool OAITextDetection_Geometry::is_polygon_Set() const{
    return m_polygon_isSet;
}

bool OAITextDetection_Geometry::is_polygon_Valid() const{
    return m_polygon_isValid;
}

bool OAITextDetection_Geometry::isSet() const {
...
bool OAITextDetection_Geometry::isValid() const {
