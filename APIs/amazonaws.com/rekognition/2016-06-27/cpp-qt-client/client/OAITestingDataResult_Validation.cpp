...
OAITestingDataResult_Validation::OAITestingDataResult_Validation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestingDataResult_Validation::OAITestingDataResult_Validation() {
    this->initializeModel();
}

OAITestingDataResult_Validation::~OAITestingDataResult_Validation() {}

void OAITestingDataResult_Validation::initializeModel() {

    m_assets_isSet = false;
    m_assets_isValid = false;
}

void OAITestingDataResult_Validation::fromJson(QString jsonString) {
...
void OAITestingDataResult_Validation::fromJsonObject(QJsonObject json) {
...
QString OAITestingDataResult_Validation::asJson() const {
...
QJsonObject OAITestingDataResult_Validation::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAITestingDataResult_Validation::getAssets() const {
    return m_assets;
}
void OAITestingDataResult_Validation::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAITestingDataResult_Validation::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAITestingDataResult_Validation::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAITestingDataResult_Validation::isSet() const {
...
bool OAITestingDataResult_Validation::isValid() const {
