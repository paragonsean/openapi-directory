...
/*
 * OAIEquipmentDetection_CoversBodyPart.h
 *
 * 
 */

#ifndef OAIEquipmentDetection_CoversBodyPart_H
#define OAIEquipmentDetection_CoversBodyPart_H
...
class OAIEquipmentDetection_CoversBodyPart : public OAIObject {
public:
    OAIEquipmentDetection_CoversBodyPart();
    OAIEquipmentDetection_CoversBodyPart(QString json);
    ~OAIEquipmentDetection_CoversBodyPart() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEquipmentDetection_CoversBodyPart)

#endif // OAIEquipmentDetection_CoversBodyPart_H
