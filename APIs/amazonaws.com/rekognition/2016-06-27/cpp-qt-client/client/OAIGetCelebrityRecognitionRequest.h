...
/*
 * OAIGetCelebrityRecognitionRequest.h
 *
 * 
 */

#ifndef OAIGetCelebrityRecognitionRequest_H
#define OAIGetCelebrityRecognitionRequest_H

#include <QJsonObject>

#include "OAICelebrityRecognitionSortBy.h"
#include <QString>
...
class OAIGetCelebrityRecognitionRequest : public OAIObject {
public:
    OAIGetCelebrityRecognitionRequest();
    OAIGetCelebrityRecognitionRequest(QString json);
    ~OAIGetCelebrityRecognitionRequest() override;
    ...
    OAICelebrityRecognitionSortBy getSortBy() const;
    void setSortBy(const OAICelebrityRecognitionSortBy &sort_by);
...
private:
    ...
    OAICelebrityRecognitionSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCelebrityRecognitionRequest)

#endif // OAIGetCelebrityRecognitionRequest_H
