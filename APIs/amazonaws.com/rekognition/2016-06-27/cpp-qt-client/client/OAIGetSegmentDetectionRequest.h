...
/*
 * OAIGetSegmentDetectionRequest.h
 *
 * 
 */

#ifndef OAIGetSegmentDetectionRequest_H
#define OAIGetSegmentDetectionRequest_H
...
class OAIGetSegmentDetectionRequest : public OAIObject {
public:
    OAIGetSegmentDetectionRequest();
    OAIGetSegmentDetectionRequest(QString json);
    ~OAIGetSegmentDetectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSegmentDetectionRequest)

#endif // OAIGetSegmentDetectionRequest_H
