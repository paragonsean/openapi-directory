...
OAILabelDetectionAggregateBy::OAILabelDetectionAggregateBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelDetectionAggregateBy::OAILabelDetectionAggregateBy() {
    this->initializeModel();
}

OAILabelDetectionAggregateBy::~OAILabelDetectionAggregateBy() {}

void OAILabelDetectionAggregateBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAILabelDetectionAggregateBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILabelDetectionAggregateBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("TIMESTAMPS", Qt::CaseInsensitive) == 0) {
        m_value = eOAILabelDetectionAggregateBy::TIMESTAMPS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SEGMENTS", Qt::CaseInsensitive) == 0) {
        m_value = eOAILabelDetectionAggregateBy::SEGMENTS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILabelDetectionAggregateBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAILabelDetectionAggregateBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAILabelDetectionAggregateBy::TIMESTAMPS:
            val = "TIMESTAMPS";
            break;
        case eOAILabelDetectionAggregateBy::SEGMENTS:
            val = "SEGMENTS";
            break;
        default:
            break;
...
QJsonValue OAILabelDetectionAggregateBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILabelDetectionAggregateBy::eOAILabelDetectionAggregateBy OAILabelDetectionAggregateBy::getValue() const {
    return m_value;
}

void OAILabelDetectionAggregateBy::setValue(const OAILabelDetectionAggregateBy::eOAILabelDetectionAggregateBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAILabelDetectionAggregateBy::isSet() const {
    
    return m_value_isSet;
}

bool OAILabelDetectionAggregateBy::isValid() const {
