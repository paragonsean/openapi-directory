...
/*
 * OAICelebrityDetail_Face.h
 *
 * 
 */

#ifndef OAICelebrityDetail_Face_H
#define OAICelebrityDetail_Face_H

#include <QJsonObject>

#include "OAIFaceDetail_AgeRange.h"
#include "OAIFaceDetail_Beard.h"
#include "OAIFaceDetail_BoundingBox.h"
#include "OAIFaceDetail_EyeDirection.h"
#include "OAIFaceDetail_Eyeglasses.h"
#include "OAIFaceDetail_EyesOpen.h"
#include "OAIFaceDetail_FaceOccluded.h"
#include "OAIFaceDetail_Gender.h"
#include "OAIFaceDetail_MouthOpen.h"
#include "OAIFaceDetail_Mustache.h"
#include "OAIFaceDetail_Pose.h"
#include "OAIFaceDetail_Quality.h"
#include "OAIFaceDetail_Smile.h"
#include "OAIFaceDetail_Sunglasses.h"
#include <QList>
...
namespace OpenAPI {
class OAIFaceDetail_BoundingBox;
class OAIFaceDetail_AgeRange;
class OAIFaceDetail_Smile;
class OAIFaceDetail_Eyeglasses;
class OAIFaceDetail_Sunglasses;
class OAIFaceDetail_Gender;
class OAIFaceDetail_Beard;
class OAIFaceDetail_Mustache;
class OAIFaceDetail_EyesOpen;
class OAIFaceDetail_MouthOpen;
class OAIFaceDetail_Pose;
class OAIFaceDetail_Quality;
class OAIFaceDetail_FaceOccluded;
class OAIFaceDetail_EyeDirection;

class OAICelebrityDetail_Face : public OAIObject {
public:
    OAICelebrityDetail_Face();
    OAICelebrityDetail_Face(QString json);
    ~OAICelebrityDetail_Face() override;
    ...
    OAIFaceDetail_BoundingBox getBoundingBox() const;
    void setBoundingBox(const OAIFaceDetail_BoundingBox &bounding_box);
    bool is_bounding_box_Set() const;
    bool is_bounding_box_Valid() const;

    OAIFaceDetail_AgeRange getAgeRange() const;
    void setAgeRange(const OAIFaceDetail_AgeRange &age_range);
    bool is_age_range_Set() const;
    bool is_age_range_Valid() const;

    OAIFaceDetail_Smile getSmile() const;
    void setSmile(const OAIFaceDetail_Smile &smile);
    bool is_smile_Set() const;
    bool is_smile_Valid() const;

    OAIFaceDetail_Eyeglasses getEyeglasses() const;
    void setEyeglasses(const OAIFaceDetail_Eyeglasses &eyeglasses);
    bool is_eyeglasses_Set() const;
    bool is_eyeglasses_Valid() const;

    OAIFaceDetail_Sunglasses getSunglasses() const;
    void setSunglasses(const OAIFaceDetail_Sunglasses &sunglasses);
    bool is_sunglasses_Set() const;
    bool is_sunglasses_Valid() const;

    OAIFaceDetail_Gender getGender() const;
    void setGender(const OAIFaceDetail_Gender &gender);
    bool is_gender_Set() const;
    bool is_gender_Valid() const;

    OAIFaceDetail_Beard getBeard() const;
    void setBeard(const OAIFaceDetail_Beard &beard);
    bool is_beard_Set() const;
    bool is_beard_Valid() const;

    OAIFaceDetail_Mustache getMustache() const;
    void setMustache(const OAIFaceDetail_Mustache &mustache);
    bool is_mustache_Set() const;
    bool is_mustache_Valid() const;

    OAIFaceDetail_EyesOpen getEyesOpen() const;
    void setEyesOpen(const OAIFaceDetail_EyesOpen &eyes_open);
    bool is_eyes_open_Set() const;
    bool is_eyes_open_Valid() const;

    OAIFaceDetail_MouthOpen getMouthOpen() const;
    void setMouthOpen(const OAIFaceDetail_MouthOpen &mouth_open);
    bool is_mouth_open_Set() const;
    bool is_mouth_open_Valid() const;

    QList getEmotions() const;
    void setEmotions(const QList &emotions);
    bool is_emotions_Set() const;
    bool is_emotions_Valid() const;

    QList getLandmarks() const;
    void setLandmarks(const QList &landmarks);
    bool is_landmarks_Set() const;
    bool is_landmarks_Valid() const;

    OAIFaceDetail_Pose getPose() const;
    void setPose(const OAIFaceDetail_Pose &pose);
    bool is_pose_Set() const;
    bool is_pose_Valid() const;

    OAIFaceDetail_Quality getQuality() const;
    void setQuality(const OAIFaceDetail_Quality &quality);
    ...
    OAIFaceDetail_FaceOccluded getFaceOccluded() const;
    void setFaceOccluded(const OAIFaceDetail_FaceOccluded &face_occluded);
    bool is_face_occluded_Set() const;
    bool is_face_occluded_Valid() const;

    OAIFaceDetail_EyeDirection getEyeDirection() const;
    void setEyeDirection(const OAIFaceDetail_EyeDirection &eye_direction);
    bool is_eye_direction_Set() const;
    bool is_eye_direction_Valid() const;
...
private:
    ...
    OAIFaceDetail_BoundingBox m_bounding_box;
    bool m_bounding_box_isSet;
    bool m_bounding_box_isValid;

    OAIFaceDetail_AgeRange m_age_range;
    bool m_age_range_isSet;
    bool m_age_range_isValid;

    OAIFaceDetail_Smile m_smile;
    bool m_smile_isSet;
    bool m_smile_isValid;

    OAIFaceDetail_Eyeglasses m_eyeglasses;
    bool m_eyeglasses_isSet;
    bool m_eyeglasses_isValid;

    OAIFaceDetail_Sunglasses m_sunglasses;
    bool m_sunglasses_isSet;
    bool m_sunglasses_isValid;

    OAIFaceDetail_Gender m_gender;
    bool m_gender_isSet;
    bool m_gender_isValid;

    OAIFaceDetail_Beard m_beard;
    bool m_beard_isSet;
    bool m_beard_isValid;

    OAIFaceDetail_Mustache m_mustache;
    bool m_mustache_isSet;
    bool m_mustache_isValid;

    OAIFaceDetail_EyesOpen m_eyes_open;
    bool m_eyes_open_isSet;
    bool m_eyes_open_isValid;

    OAIFaceDetail_MouthOpen m_mouth_open;
    bool m_mouth_open_isSet;
    bool m_mouth_open_isValid;
    ...
    OAIFaceDetail_Pose m_pose;
    bool m_pose_isSet;
    bool m_pose_isValid;

    OAIFaceDetail_Quality m_quality;
    ...
    OAIFaceDetail_FaceOccluded m_face_occluded;
    bool m_face_occluded_isSet;
    bool m_face_occluded_isValid;

    OAIFaceDetail_EyeDirection m_eye_direction;
    bool m_eye_direction_isSet;
    bool m_eye_direction_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICelebrityDetail_Face)

#endif // OAICelebrityDetail_Face_H
