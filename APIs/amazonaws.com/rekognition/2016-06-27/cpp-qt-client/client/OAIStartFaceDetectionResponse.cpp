...
#include "OAIStartFaceDetectionResponse.h"
...
OAIStartFaceDetectionResponse::OAIStartFaceDetectionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFaceDetectionResponse::OAIStartFaceDetectionResponse() {
    this->initializeModel();
}

OAIStartFaceDetectionResponse::~OAIStartFaceDetectionResponse() {}

void OAIStartFaceDetectionResponse::initializeModel() {

    m_job_id_isSet = false;
    m_job_id_isValid = false;
}

void OAIStartFaceDetectionResponse::fromJson(QString jsonString) {
...
void OAIStartFaceDetectionResponse::fromJsonObject(QJsonObject json) {

    m_job_id_isValid = ::OpenAPI::fromJsonValue(m_job_id, json[QString("JobId")]);
    m_job_id_isSet = !json[QString("JobId")].isNull() && m_job_id_isValid;
}

QString OAIStartFaceDetectionResponse::asJson() const {
...
QJsonObject OAIStartFaceDetectionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIStartFaceDetectionResponse::getJobId() const {
    return m_job_id;
}
void OAIStartFaceDetectionResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIStartFaceDetectionResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIStartFaceDetectionResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIStartFaceDetectionResponse::isSet() const {
...
bool OAIStartFaceDetectionResponse::isValid() const {
