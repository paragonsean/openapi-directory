...
#include "OAIStreamProcessorParameterToDelete.h"
...
OAIStreamProcessorParameterToDelete::OAIStreamProcessorParameterToDelete(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorParameterToDelete::OAIStreamProcessorParameterToDelete() {
    this->initializeModel();
}

OAIStreamProcessorParameterToDelete::~OAIStreamProcessorParameterToDelete() {}

void OAIStreamProcessorParameterToDelete::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStreamProcessorParameterToDelete::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStreamProcessorParameterToDelete::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ConnectedHomeMinConfidence", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorParameterToDelete::CONNECTEDHOMEMINCONFIDENCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RegionsOfInterest", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorParameterToDelete::REGIONSOFINTEREST;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStreamProcessorParameterToDelete::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStreamProcessorParameterToDelete::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStreamProcessorParameterToDelete::CONNECTEDHOMEMINCONFIDENCE:
            val = "ConnectedHomeMinConfidence";
            break;
        case eOAIStreamProcessorParameterToDelete::REGIONSOFINTEREST:
...
QJsonValue OAIStreamProcessorParameterToDelete::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStreamProcessorParameterToDelete::eOAIStreamProcessorParameterToDelete OAIStreamProcessorParameterToDelete::getValue() const {
    return m_value;
}

void OAIStreamProcessorParameterToDelete::setValue(const OAIStreamProcessorParameterToDelete::eOAIStreamProcessorParameterToDelete& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStreamProcessorParameterToDelete::isSet() const {
    
    return m_value_isSet;
}

bool OAIStreamProcessorParameterToDelete::isValid() const {
