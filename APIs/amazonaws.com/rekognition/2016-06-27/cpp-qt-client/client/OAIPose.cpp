...
float OAIPose::getRoll() const {
    return m_roll;
}
void OAIPose::setRoll(const float &roll) {
    m_roll = roll;
    m_roll_isSet = true;
}
...
float OAIPose::getYaw() const {
    return m_yaw;
}
void OAIPose::setYaw(const float &yaw) {
    m_yaw = yaw;
    m_yaw_isSet = true;
}

bool OAIPose::is_yaw_Set() const{
    return m_yaw_isSet;
}

bool OAIPose::is_yaw_Valid() const{
    return m_yaw_isValid;
}

float OAIPose::getPitch() const {
    return m_pitch;
}
void OAIPose::setPitch(const float &pitch) {
    m_pitch = pitch;
    m_pitch_isSet = true;
}
