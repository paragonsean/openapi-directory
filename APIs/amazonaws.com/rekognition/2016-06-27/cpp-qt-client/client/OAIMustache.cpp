...
OAIMustache::OAIMustache(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMustache::OAIMustache() {
    this->initializeModel();
}

OAIMustache::~OAIMustache() {}

void OAIMustache::initializeModel() {
...
void OAIMustache::fromJson(QString jsonString) {
...
void OAIMustache::fromJsonObject(QJsonObject json) {
...
QString OAIMustache::asJson() const {
...
QJsonObject OAIMustache::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIMustache::getValue() const {
    return m_value;
}
void OAIMustache::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIMustache::is_value_Set() const{
    return m_value_isSet;
}

bool OAIMustache::is_value_Valid() const{
    return m_value_isValid;
}

float OAIMustache::getConfidence() const {
    return m_confidence;
}
void OAIMustache::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIMustache::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIMustache::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIMustache::isSet() const {
...
bool OAIMustache::isValid() const {
