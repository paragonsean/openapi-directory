...
#include "OAIDetectFacesRequest.h"
...
OAIDetectFacesRequest::OAIDetectFacesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectFacesRequest::OAIDetectFacesRequest() {
    this->initializeModel();
}

OAIDetectFacesRequest::~OAIDetectFacesRequest() {}

void OAIDetectFacesRequest::initializeModel() {
...
void OAIDetectFacesRequest::fromJson(QString jsonString) {
...
void OAIDetectFacesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDetectFacesRequest::asJson() const {
...
QJsonObject OAIDetectFacesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_image.isSet()) {
...
OAICompareFacesRequest_SourceImage OAIDetectFacesRequest::getImage() const {
    return m_image;
}
void OAIDetectFacesRequest::setImage(const OAICompareFacesRequest_SourceImage &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIDetectFacesRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAIDetectFacesRequest::is_image_Valid() const{
    return m_image_isValid;
}

QList OAIDetectFacesRequest::getAttributes() const {
    return m_attributes;
}
void OAIDetectFacesRequest::setAttributes(const QList &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIDetectFacesRequest::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIDetectFacesRequest::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIDetectFacesRequest::isSet() const {
...
bool OAIDetectFacesRequest::isValid() const {
