...
/*
 * OAICompareFacesResponse.h
 *
 * 
 */

#ifndef OAICompareFacesResponse_H
#define OAICompareFacesResponse_H

#include <QJsonObject>

#include "OAICompareFacesResponse_SourceImageFace.h"
#include "OAIOrientationCorrection.h"
#include <QList>
...
namespace OpenAPI {
class OAICompareFacesResponse_SourceImageFace;

class OAICompareFacesResponse : public OAIObject {
public:
    OAICompareFacesResponse();
    OAICompareFacesResponse(QString json);
    ~OAICompareFacesResponse() override;
    ...
    OAICompareFacesResponse_SourceImageFace getSourceImageFace() const;
    void setSourceImageFace(const OAICompareFacesResponse_SourceImageFace &source_image_face);
    bool is_source_image_face_Set() const;
    bool is_source_image_face_Valid() const;

    QList getFaceMatches() const;
    void setFaceMatches(const QList &face_matches);
    bool is_face_matches_Set() const;
    bool is_face_matches_Valid() const;

    QList getUnmatchedFaces() const;
    void setUnmatchedFaces(const QList &unmatched_faces);
    bool is_unmatched_faces_Set() const;
    bool is_unmatched_faces_Valid() const;

    OAIOrientationCorrection getSourceImageOrientationCorrection() const;
    void setSourceImageOrientationCorrection(const OAIOrientationCorrection &source_image_orientation_correction);
    bool is_source_image_orientation_correction_Set() const;
    bool is_source_image_orientation_correction_Valid() const;

    OAIOrientationCorrection getTargetImageOrientationCorrection() const;
    void setTargetImageOrientationCorrection(const OAIOrientationCorrection &target_image_orientation_correction);
    bool is_target_image_orientation_correction_Set() const;
    bool is_target_image_orientation_correction_Valid() const;
...
private:
    ...
    OAICompareFacesResponse_SourceImageFace m_source_image_face;
    bool m_source_image_face_isSet;
    bool m_source_image_face_isValid;

    QList m_face_matches;
    bool m_face_matches_isSet;
    bool m_face_matches_isValid;

    QList m_unmatched_faces;
    bool m_unmatched_faces_isSet;
    bool m_unmatched_faces_isValid;

    OAIOrientationCorrection m_source_image_orientation_correction;
    bool m_source_image_orientation_correction_isSet;
    bool m_source_image_orientation_correction_isValid;

    OAIOrientationCorrection m_target_image_orientation_correction;
    bool m_target_image_orientation_correction_isSet;
    bool m_target_image_orientation_correction_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICompareFacesResponse)

#endif // OAICompareFacesResponse_H
