...
/*
 * OAIStartCelebrityRecognitionResponse.h
 *
 * 
 */

#ifndef OAIStartCelebrityRecognitionResponse_H
#define OAIStartCelebrityRecognitionResponse_H
...
class OAIStartCelebrityRecognitionResponse : public OAIObject {
public:
    OAIStartCelebrityRecognitionResponse();
    OAIStartCelebrityRecognitionResponse(QString json);
    ~OAIStartCelebrityRecognitionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartCelebrityRecognitionResponse)

#endif // OAIStartCelebrityRecognitionResponse_H
