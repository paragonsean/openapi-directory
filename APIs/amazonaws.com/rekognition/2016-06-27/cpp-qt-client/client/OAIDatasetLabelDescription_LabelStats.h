...
/*
 * OAIDatasetLabelDescription_LabelStats.h
 *
 * 
 */

#ifndef OAIDatasetLabelDescription_LabelStats_H
#define OAIDatasetLabelDescription_LabelStats_H
...
class OAIDatasetLabelDescription_LabelStats : public OAIObject {
public:
    OAIDatasetLabelDescription_LabelStats();
    OAIDatasetLabelDescription_LabelStats(QString json);
    ~OAIDatasetLabelDescription_LabelStats() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetLabelDescription_LabelStats)

#endif // OAIDatasetLabelDescription_LabelStats_H
