...
#include "OAIUnsuccessfulFaceDisassociation.h"
...
OAIUnsuccessfulFaceDisassociation::OAIUnsuccessfulFaceDisassociation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsuccessfulFaceDisassociation::OAIUnsuccessfulFaceDisassociation() {
    this->initializeModel();
}

OAIUnsuccessfulFaceDisassociation::~OAIUnsuccessfulFaceDisassociation() {}

void OAIUnsuccessfulFaceDisassociation::initializeModel() {
...
void OAIUnsuccessfulFaceDisassociation::fromJson(QString jsonString) {
...
void OAIUnsuccessfulFaceDisassociation::fromJsonObject(QJsonObject json) {
...
QString OAIUnsuccessfulFaceDisassociation::asJson() const {
...
QJsonObject OAIUnsuccessfulFaceDisassociation::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
...
QString OAIUnsuccessfulFaceDisassociation::getFaceId() const {
    return m_face_id;
}
void OAIUnsuccessfulFaceDisassociation::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAIUnsuccessfulFaceDisassociation::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAIUnsuccessfulFaceDisassociation::is_face_id_Valid() const{
    return m_face_id_isValid;
}

QString OAIUnsuccessfulFaceDisassociation::getUserId() const {
    return m_user_id;
}
void OAIUnsuccessfulFaceDisassociation::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIUnsuccessfulFaceDisassociation::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIUnsuccessfulFaceDisassociation::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QList OAIUnsuccessfulFaceDisassociation::getReasons() const {
    return m_reasons;
}
void OAIUnsuccessfulFaceDisassociation::setReasons(const QList &reasons) {
    m_reasons = reasons;
    m_reasons_isSet = true;
}

bool OAIUnsuccessfulFaceDisassociation::is_reasons_Set() const{
    return m_reasons_isSet;
}

bool OAIUnsuccessfulFaceDisassociation::is_reasons_Valid() const{
    return m_reasons_isValid;
}

bool OAIUnsuccessfulFaceDisassociation::isSet() const {
...
bool OAIUnsuccessfulFaceDisassociation::isValid() const {
