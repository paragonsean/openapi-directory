...
/*
 * OAIUnsuccessfulFaceDisassociationReason.h
 *
 * 
 */

#ifndef OAIUnsuccessfulFaceDisassociationReason_H
#define OAIUnsuccessfulFaceDisassociationReason_H
...
class OAIUnsuccessfulFaceDisassociationReason : public OAIEnum {
public:
    OAIUnsuccessfulFaceDisassociationReason();
    OAIUnsuccessfulFaceDisassociationReason(QString json);
    ~OAIUnsuccessfulFaceDisassociationReason() override;
    ...
    enum class eOAIUnsuccessfulFaceDisassociationReason {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        FACE_NOT_FOUND, 
        ASSOCIATED_TO_A_DIFFERENT_USER
    };
    OAIUnsuccessfulFaceDisassociationReason::eOAIUnsuccessfulFaceDisassociationReason getValue() const;
    void setValue(const OAIUnsuccessfulFaceDisassociationReason::eOAIUnsuccessfulFaceDisassociationReason& value);
...
private:
    ...
    eOAIUnsuccessfulFaceDisassociationReason m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsuccessfulFaceDisassociationReason)

#endif // OAIUnsuccessfulFaceDisassociationReason_H
