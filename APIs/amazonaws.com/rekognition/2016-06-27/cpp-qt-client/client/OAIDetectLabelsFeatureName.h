...
/*
 * OAIDetectLabelsFeatureName.h
 *
 * 
 */

#ifndef OAIDetectLabelsFeatureName_H
#define OAIDetectLabelsFeatureName_H
...
class OAIDetectLabelsFeatureName : public OAIEnum {
public:
    OAIDetectLabelsFeatureName();
    OAIDetectLabelsFeatureName(QString json);
    ~OAIDetectLabelsFeatureName() override;
    ...
    enum class eOAIDetectLabelsFeatureName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        GENERAL_LABELS, 
        IMAGE_PROPERTIES
    };
    OAIDetectLabelsFeatureName::eOAIDetectLabelsFeatureName getValue() const;
    void setValue(const OAIDetectLabelsFeatureName::eOAIDetectLabelsFeatureName& value);
...
private:
    ...
    eOAIDetectLabelsFeatureName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsFeatureName)

#endif // OAIDetectLabelsFeatureName_H
