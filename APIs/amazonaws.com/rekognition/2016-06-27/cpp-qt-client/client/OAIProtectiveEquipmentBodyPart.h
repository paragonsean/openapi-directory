...
/*
 * OAIProtectiveEquipmentBodyPart.h
 *
...
#ifndef OAIProtectiveEquipmentBodyPart_H
#define OAIProtectiveEquipmentBodyPart_H
...
class OAIProtectiveEquipmentBodyPart : public OAIObject {
public:
    OAIProtectiveEquipmentBodyPart();
    OAIProtectiveEquipmentBodyPart(QString json);
    ~OAIProtectiveEquipmentBodyPart() override;
    ...
    OAIBodyPart getName() const;
    void setName(const OAIBodyPart &name);
    ...
    QList getEquipmentDetections() const;
    void setEquipmentDetections(const QList &equipment_detections);
    bool is_equipment_detections_Set() const;
    bool is_equipment_detections_Valid() const;
...
private:
    ...
    QList m_equipment_detections;
    bool m_equipment_detections_isSet;
    bool m_equipment_detections_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProtectiveEquipmentBodyPart)

#endif // OAIProtectiveEquipmentBodyPart_H
