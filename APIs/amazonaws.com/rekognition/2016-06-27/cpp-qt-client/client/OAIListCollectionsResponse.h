...
public:
    ...
    QList getCollectionIds() const;
    void setCollectionIds(const QList &collection_ids);
    ...
    QList getFaceModelVersions() const;
    void setFaceModelVersions(const QList &face_model_versions);
    bool is_face_model_versions_Set() const;
    bool is_face_model_versions_Valid() const;
...
private:
    ...
    QList m_face_model_versions;
    bool m_face_model_versions_isSet;
    bool m_face_model_versions_isValid;
};
