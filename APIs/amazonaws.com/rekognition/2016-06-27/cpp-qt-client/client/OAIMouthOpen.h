...
#ifndef OAIMouthOpen_H
#define OAIMouthOpen_H
...
class OAIMouthOpen : public OAIObject {
public:
    OAIMouthOpen();
    OAIMouthOpen(QString json);
    ~OAIMouthOpen() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMouthOpen)

#endif // OAIMouthOpen_H
