...
/*
 * OAIDetectProtectiveEquipmentRequest_SummarizationAttributes.h
 *
 * 
 */

#ifndef OAIDetectProtectiveEquipmentRequest_SummarizationAttributes_H
#define OAIDetectProtectiveEquipmentRequest_SummarizationAttributes_H
...
class OAIDetectProtectiveEquipmentRequest_SummarizationAttributes : public OAIObject {
public:
    OAIDetectProtectiveEquipmentRequest_SummarizationAttributes();
    OAIDetectProtectiveEquipmentRequest_SummarizationAttributes(QString json);
    ~OAIDetectProtectiveEquipmentRequest_SummarizationAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectProtectiveEquipmentRequest_SummarizationAttributes)

#endif // OAIDetectProtectiveEquipmentRequest_SummarizationAttributes_H
