...
/*
 * OAIUnsuccessfulFaceAssociationReason.h
 *
 * 
 */

#ifndef OAIUnsuccessfulFaceAssociationReason_H
#define OAIUnsuccessfulFaceAssociationReason_H
...
class OAIUnsuccessfulFaceAssociationReason : public OAIEnum {
public:
    OAIUnsuccessfulFaceAssociationReason();
    OAIUnsuccessfulFaceAssociationReason(QString json);
    ~OAIUnsuccessfulFaceAssociationReason() override;
    ...
    enum class eOAIUnsuccessfulFaceAssociationReason {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        FACE_NOT_FOUND, 
        ASSOCIATED_TO_A_DIFFERENT_USER, 
        LOW_MATCH_CONFIDENCE
    };
    OAIUnsuccessfulFaceAssociationReason::eOAIUnsuccessfulFaceAssociationReason getValue() const;
    void setValue(const OAIUnsuccessfulFaceAssociationReason::eOAIUnsuccessfulFaceAssociationReason& value);
...
private:
    ...
    eOAIUnsuccessfulFaceAssociationReason m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsuccessfulFaceAssociationReason)

#endif // OAIUnsuccessfulFaceAssociationReason_H
