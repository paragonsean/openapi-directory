...
/*
 * OAIUpdateDatasetEntriesRequest_Changes.h
 *
 * 
 */

#ifndef OAIUpdateDatasetEntriesRequest_Changes_H
#define OAIUpdateDatasetEntriesRequest_Changes_H
...
class OAIUpdateDatasetEntriesRequest_Changes : public OAIObject {
public:
    OAIUpdateDatasetEntriesRequest_Changes();
    OAIUpdateDatasetEntriesRequest_Changes(QString json);
    ~OAIUpdateDatasetEntriesRequest_Changes() override;
    ...
    QString getGroundTruth() const;
    void setGroundTruth(const QString &ground_truth);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDatasetEntriesRequest_Changes)

#endif // OAIUpdateDatasetEntriesRequest_Changes_H
