...
/*
 * OAIDetectTextRequest.h
 *
 * 
 */

#ifndef OAIDetectTextRequest_H
#define OAIDetectTextRequest_H
...
namespace OpenAPI {
class OAIDetectTextRequest_Image;
class OAIDetectTextRequest_Filters;

class OAIDetectTextRequest : public OAIObject {
public:
    OAIDetectTextRequest();
    OAIDetectTextRequest(QString json);
    ~OAIDetectTextRequest() override;
    ...
    OAIDetectTextRequest_Image getImage() const;
    void setImage(const OAIDetectTextRequest_Image &image);
    bool is_image_Set() const;
    bool is_image_Valid() const;

    OAIDetectTextRequest_Filters getFilters() const;
    void setFilters(const OAIDetectTextRequest_Filters &filters);
...
private:
    ...
    OAIDetectTextRequest_Image m_image;
    bool m_image_isSet;
    bool m_image_isValid;

    OAIDetectTextRequest_Filters m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectTextRequest)

#endif // OAIDetectTextRequest_H
