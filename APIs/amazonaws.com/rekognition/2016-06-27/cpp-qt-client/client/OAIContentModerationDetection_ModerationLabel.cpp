...
OAIContentModerationDetection_ModerationLabel::OAIContentModerationDetection_ModerationLabel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContentModerationDetection_ModerationLabel::OAIContentModerationDetection_ModerationLabel() {
    this->initializeModel();
}

OAIContentModerationDetection_ModerationLabel::~OAIContentModerationDetection_ModerationLabel() {}

void OAIContentModerationDetection_ModerationLabel::initializeModel() {
...
void OAIContentModerationDetection_ModerationLabel::fromJson(QString jsonString) {
...
void OAIContentModerationDetection_ModerationLabel::fromJsonObject(QJsonObject json) {
...
QString OAIContentModerationDetection_ModerationLabel::asJson() const {
...
QJsonObject OAIContentModerationDetection_ModerationLabel::asJsonObject() const {
    QJsonObject obj;
...
float OAIContentModerationDetection_ModerationLabel::getConfidence() const {
    return m_confidence;
}
void OAIContentModerationDetection_ModerationLabel::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIContentModerationDetection_ModerationLabel::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIContentModerationDetection_ModerationLabel::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QString OAIContentModerationDetection_ModerationLabel::getName() const {
    return m_name;
}
void OAIContentModerationDetection_ModerationLabel::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIContentModerationDetection_ModerationLabel::is_name_Set() const{
    return m_name_isSet;
}

bool OAIContentModerationDetection_ModerationLabel::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIContentModerationDetection_ModerationLabel::getParentName() const {
    return m_parent_name;
}
void OAIContentModerationDetection_ModerationLabel::setParentName(const QString &parent_name) {
    m_parent_name = parent_name;
    m_parent_name_isSet = true;
}

bool OAIContentModerationDetection_ModerationLabel::is_parent_name_Set() const{
    return m_parent_name_isSet;
}

bool OAIContentModerationDetection_ModerationLabel::is_parent_name_Valid() const{
    return m_parent_name_isValid;
}

bool OAIContentModerationDetection_ModerationLabel::isSet() const {
...
bool OAIContentModerationDetection_ModerationLabel::isValid() const {
