...
#ifndef OAIDatasetStats_H
#define OAIDatasetStats_H
...
class OAIDatasetStats : public OAIObject {
public:
    OAIDatasetStats();
    OAIDatasetStats(QString json);
    ~OAIDatasetStats() override;
    ...
    qint32 getLabeledEntries() const;
    void setLabeledEntries(const qint32 &labeled_entries);
    bool is_labeled_entries_Set() const;
    bool is_labeled_entries_Valid() const;
    ...
    qint32 getErrorEntries() const;
    void setErrorEntries(const qint32 &error_entries);
...
private:
    ...
    qint32 m_labeled_entries;
    bool m_labeled_entries_isSet;
    bool m_labeled_entries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetStats)

#endif // OAIDatasetStats_H
