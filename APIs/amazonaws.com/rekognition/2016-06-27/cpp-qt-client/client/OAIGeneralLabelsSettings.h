...
#ifndef OAIGeneralLabelsSettings_H
#define OAIGeneralLabelsSettings_H
...
class OAIGeneralLabelsSettings : public OAIObject {
public:
    OAIGeneralLabelsSettings();
    OAIGeneralLabelsSettings(QString json);
    ~OAIGeneralLabelsSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeneralLabelsSettings)

#endif // OAIGeneralLabelsSettings_H
