...
#include "OAIStartShotDetectionFilter.h"
...
OAIStartShotDetectionFilter::OAIStartShotDetectionFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartShotDetectionFilter::OAIStartShotDetectionFilter() {
    this->initializeModel();
}

OAIStartShotDetectionFilter::~OAIStartShotDetectionFilter() {}

void OAIStartShotDetectionFilter::initializeModel() {

    m_min_segment_confidence_isSet = false;
    m_min_segment_confidence_isValid = false;
}

void OAIStartShotDetectionFilter::fromJson(QString jsonString) {
...
void OAIStartShotDetectionFilter::fromJsonObject(QJsonObject json) {

    m_min_segment_confidence_isValid = ::OpenAPI::fromJsonValue(m_min_segment_confidence, json[QString("MinSegmentConfidence")]);
    m_min_segment_confidence_isSet = !json[QString("MinSegmentConfidence")].isNull() && m_min_segment_confidence_isValid;
}

QString OAIStartShotDetectionFilter::asJson() const {
...
QJsonObject OAIStartShotDetectionFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_min_segment_confidence_isSet) {
        obj.insert(QString("MinSegmentConfidence"), ::OpenAPI::toJsonValue(m_min_segment_confidence));
    }
    return obj;
}

float OAIStartShotDetectionFilter::getMinSegmentConfidence() const {
    return m_min_segment_confidence;
}
void OAIStartShotDetectionFilter::setMinSegmentConfidence(const float &min_segment_confidence) {
    m_min_segment_confidence = min_segment_confidence;
    m_min_segment_confidence_isSet = true;
}

bool OAIStartShotDetectionFilter::is_min_segment_confidence_Set() const{
    return m_min_segment_confidence_isSet;
}

bool OAIStartShotDetectionFilter::is_min_segment_confidence_Valid() const{
    return m_min_segment_confidence_isValid;
}

bool OAIStartShotDetectionFilter::isSet() const {
...
bool OAIStartShotDetectionFilter::isValid() const {
