...
/*
 * OAIGetLabelDetectionResponse_GetRequestMetadata.h
 *
 * 
 */

#ifndef OAIGetLabelDetectionResponse_GetRequestMetadata_H
#define OAIGetLabelDetectionResponse_GetRequestMetadata_H

#include <QJsonObject>

#include "OAILabelDetectionAggregateBy.h"
#include "OAILabelDetectionSortBy.h"
...
class OAIGetLabelDetectionResponse_GetRequestMetadata : public OAIObject {
public:
    OAIGetLabelDetectionResponse_GetRequestMetadata();
    OAIGetLabelDetectionResponse_GetRequestMetadata(QString json);
    ~OAIGetLabelDetectionResponse_GetRequestMetadata() override;
    ...
    OAILabelDetectionSortBy getSortBy() const;
    void setSortBy(const OAILabelDetectionSortBy &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    OAILabelDetectionAggregateBy getAggregateBy() const;
    void setAggregateBy(const OAILabelDetectionAggregateBy &aggregate_by);
...
private:
    ...
    OAILabelDetectionSortBy m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    OAILabelDetectionAggregateBy m_aggregate_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLabelDetectionResponse_GetRequestMetadata)

#endif // OAIGetLabelDetectionResponse_GetRequestMetadata_H
