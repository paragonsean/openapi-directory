...
/*
 * OAIInstance_BoundingBox.h
 *
 * 
 */

#ifndef OAIInstance_BoundingBox_H
#define OAIInstance_BoundingBox_H
...
class OAIInstance_BoundingBox : public OAIObject {
public:
    OAIInstance_BoundingBox();
    OAIInstance_BoundingBox(QString json);
    ~OAIInstance_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstance_BoundingBox)

#endif // OAIInstance_BoundingBox_H
