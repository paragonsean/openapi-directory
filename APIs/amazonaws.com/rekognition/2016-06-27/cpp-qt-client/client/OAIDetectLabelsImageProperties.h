...
/*
 * OAIDetectLabelsImageProperties.h
 *
...
#ifndef OAIDetectLabelsImageProperties_H
#define OAIDetectLabelsImageProperties_H

#include <QJsonObject>

#include "OAIDetectLabelsImageProperties_Background.h"
#include "OAIDetectLabelsImageProperties_Foreground.h"
...
namespace OpenAPI {
class OAIDetectLabelsImageProperties_Quality;
class OAIDetectLabelsImageProperties_Foreground;
class OAIDetectLabelsImageProperties_Background;

class OAIDetectLabelsImageProperties : public OAIObject {
public:
    OAIDetectLabelsImageProperties();
    OAIDetectLabelsImageProperties(QString json);
    ~OAIDetectLabelsImageProperties() override;
    ...
    OAIDetectLabelsImageProperties_Quality getQuality() const;
    void setQuality(const OAIDetectLabelsImageProperties_Quality &quality);
    ...
    OAIDetectLabelsImageProperties_Foreground getForeground() const;
    void setForeground(const OAIDetectLabelsImageProperties_Foreground &foreground);
    bool is_foreground_Set() const;
    bool is_foreground_Valid() const;

    OAIDetectLabelsImageProperties_Background getBackground() const;
    void setBackground(const OAIDetectLabelsImageProperties_Background &background);
...
private:
    ...
    OAIDetectLabelsImageProperties_Quality m_quality;
    ...
    OAIDetectLabelsImageProperties_Foreground m_foreground;
    bool m_foreground_isSet;
    bool m_foreground_isValid;

    OAIDetectLabelsImageProperties_Background m_background;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageProperties)

#endif // OAIDetectLabelsImageProperties_H
