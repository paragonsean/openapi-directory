...
#include "OAIDetectTextRequest_Image.h"
...
OAIDetectTextRequest_Image::OAIDetectTextRequest_Image(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectTextRequest_Image::OAIDetectTextRequest_Image() {
    this->initializeModel();
}

OAIDetectTextRequest_Image::~OAIDetectTextRequest_Image() {}

void OAIDetectTextRequest_Image::initializeModel() {
...
void OAIDetectTextRequest_Image::fromJson(QString jsonString) {
...
void OAIDetectTextRequest_Image::fromJsonObject(QJsonObject json) {
...
QString OAIDetectTextRequest_Image::asJson() const {
...
QJsonObject OAIDetectTextRequest_Image::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAIDetectTextRequest_Image::getBytes() const {
    return m_bytes;
}
void OAIDetectTextRequest_Image::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAIDetectTextRequest_Image::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAIDetectTextRequest_Image::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIImage_S3Object OAIDetectTextRequest_Image::getS3Object() const {
    return m_s3_object;
}
void OAIDetectTextRequest_Image::setS3Object(const OAIImage_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIDetectTextRequest_Image::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIDetectTextRequest_Image::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIDetectTextRequest_Image::isSet() const {
...
bool OAIDetectTextRequest_Image::isValid() const {
