...
#ifndef OAISearchedFace_H
#define OAISearchedFace_H
...
class OAISearchedFace : public OAIObject {
public:
    OAISearchedFace();
    OAISearchedFace(QString json);
    ~OAISearchedFace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchedFace)

#endif // OAISearchedFace_H
