...
/*
 * OAICreateStreamProcessorRequest_Output.h
 *
 * 
 */

#ifndef OAICreateStreamProcessorRequest_Output_H
#define OAICreateStreamProcessorRequest_Output_H
...
class OAICreateStreamProcessorRequest_Output : public OAIObject {
public:
    OAICreateStreamProcessorRequest_Output();
    OAICreateStreamProcessorRequest_Output(QString json);
    ~OAICreateStreamProcessorRequest_Output() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamProcessorRequest_Output)

#endif // OAICreateStreamProcessorRequest_Output_H
