...
#include "OAIGetCelebrityRecognitionRequest.h"
...
OAIGetCelebrityRecognitionRequest::OAIGetCelebrityRecognitionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCelebrityRecognitionRequest::OAIGetCelebrityRecognitionRequest() {
    this->initializeModel();
}

OAIGetCelebrityRecognitionRequest::~OAIGetCelebrityRecognitionRequest() {}

void OAIGetCelebrityRecognitionRequest::initializeModel() {
...
void OAIGetCelebrityRecognitionRequest::fromJson(QString jsonString) {
...
void OAIGetCelebrityRecognitionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetCelebrityRecognitionRequest::asJson() const {
...
QJsonObject OAIGetCelebrityRecognitionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIGetCelebrityRecognitionRequest::getJobId() const {
    return m_job_id;
}
void OAIGetCelebrityRecognitionRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetCelebrityRecognitionRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetCelebrityRecognitionRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint32 OAIGetCelebrityRecognitionRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetCelebrityRecognitionRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetCelebrityRecognitionRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetCelebrityRecognitionRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetCelebrityRecognitionRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetCelebrityRecognitionRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCelebrityRecognitionRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCelebrityRecognitionRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

OAICelebrityRecognitionSortBy OAIGetCelebrityRecognitionRequest::getSortBy() const {
    return m_sort_by;
}
void OAIGetCelebrityRecognitionRequest::setSortBy(const OAICelebrityRecognitionSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetCelebrityRecognitionRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetCelebrityRecognitionRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

bool OAIGetCelebrityRecognitionRequest::isSet() const {
...
bool OAIGetCelebrityRecognitionRequest::isValid() const {
