...
/*
 * OAIStopStreamProcessorRequest.h
 *
 * 
 */

#ifndef OAIStopStreamProcessorRequest_H
#define OAIStopStreamProcessorRequest_H
...
class OAIStopStreamProcessorRequest : public OAIObject {
public:
    OAIStopStreamProcessorRequest();
    OAIStopStreamProcessorRequest(QString json);
    ~OAIStopStreamProcessorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopStreamProcessorRequest)

#endif // OAIStopStreamProcessorRequest_H
