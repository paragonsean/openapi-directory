...
#include "OAIGetFaceDetectionRequest.h"
...
OAIGetFaceDetectionRequest::OAIGetFaceDetectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFaceDetectionRequest::OAIGetFaceDetectionRequest() {
    this->initializeModel();
}

OAIGetFaceDetectionRequest::~OAIGetFaceDetectionRequest() {}

void OAIGetFaceDetectionRequest::initializeModel() {
...
void OAIGetFaceDetectionRequest::fromJson(QString jsonString) {
...
void OAIGetFaceDetectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetFaceDetectionRequest::asJson() const {
...
QJsonObject OAIGetFaceDetectionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIGetFaceDetectionRequest::getJobId() const {
    return m_job_id;
}
void OAIGetFaceDetectionRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetFaceDetectionRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetFaceDetectionRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint32 OAIGetFaceDetectionRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetFaceDetectionRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetFaceDetectionRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetFaceDetectionRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetFaceDetectionRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetFaceDetectionRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetFaceDetectionRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetFaceDetectionRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetFaceDetectionRequest::isSet() const {
...
bool OAIGetFaceDetectionRequest::isValid() const {
