...
/*
 * OAIGetFaceLivenessSessionResultsResponse_ReferenceImage.h
 *
 * 
 */

#ifndef OAIGetFaceLivenessSessionResultsResponse_ReferenceImage_H
#define OAIGetFaceLivenessSessionResultsResponse_ReferenceImage_H
...
class OAIGetFaceLivenessSessionResultsResponse_ReferenceImage : public OAIObject {
public:
    OAIGetFaceLivenessSessionResultsResponse_ReferenceImage();
    OAIGetFaceLivenessSessionResultsResponse_ReferenceImage(QString json);
    ~OAIGetFaceLivenessSessionResultsResponse_ReferenceImage() override;
    ...
    OAIS3Object getS3Object() const;
    void setS3Object(const OAIS3Object &s3_object);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceLivenessSessionResultsResponse_ReferenceImage)

#endif // OAIGetFaceLivenessSessionResultsResponse_ReferenceImage_H
