...
#include "OAILivenessOutputConfig.h"
...
OAILivenessOutputConfig::OAILivenessOutputConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILivenessOutputConfig::OAILivenessOutputConfig() {
    this->initializeModel();
}

OAILivenessOutputConfig::~OAILivenessOutputConfig() {}

void OAILivenessOutputConfig::initializeModel() {
...
void OAILivenessOutputConfig::fromJson(QString jsonString) {
...
void OAILivenessOutputConfig::fromJsonObject(QJsonObject json) {
...
QString OAILivenessOutputConfig::asJson() const {
...
QJsonObject OAILivenessOutputConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAILivenessOutputConfig::getS3Bucket() const {
    return m_s3_bucket;
}
void OAILivenessOutputConfig::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAILivenessOutputConfig::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAILivenessOutputConfig::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAILivenessOutputConfig::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAILivenessOutputConfig::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAILivenessOutputConfig::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAILivenessOutputConfig::is_s3_key_prefix_Valid() const{
    return m_s3_key_prefix_isValid;
}

bool OAILivenessOutputConfig::isSet() const {
...
bool OAILivenessOutputConfig::isValid() const {
