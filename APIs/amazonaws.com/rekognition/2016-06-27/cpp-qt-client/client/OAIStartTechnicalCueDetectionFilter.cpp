...
#include "OAIStartTechnicalCueDetectionFilter.h"
...
OAIStartTechnicalCueDetectionFilter::OAIStartTechnicalCueDetectionFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartTechnicalCueDetectionFilter::OAIStartTechnicalCueDetectionFilter() {
    this->initializeModel();
}

OAIStartTechnicalCueDetectionFilter::~OAIStartTechnicalCueDetectionFilter() {}

void OAIStartTechnicalCueDetectionFilter::initializeModel() {

    m_min_segment_confidence_isSet = false;
    m_min_segment_confidence_isValid = false;

    m_black_frame_isSet = false;
    m_black_frame_isValid = false;
}

void OAIStartTechnicalCueDetectionFilter::fromJson(QString jsonString) {
...
void OAIStartTechnicalCueDetectionFilter::fromJsonObject(QJsonObject json) {
    ...
    m_black_frame_isValid = ::OpenAPI::fromJsonValue(m_black_frame, json[QString("BlackFrame")]);
    m_black_frame_isSet = !json[QString("BlackFrame")].isNull() && m_black_frame_isValid;
}

QString OAIStartTechnicalCueDetectionFilter::asJson() const {
...
QJsonObject OAIStartTechnicalCueDetectionFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_min_segment_confidence_isSet) {
        obj.insert(QString("MinSegmentConfidence"), ::OpenAPI::toJsonValue(m_min_segment_confidence));
    }
    if (m_black_frame.isSet()) {
        obj.insert(QString("BlackFrame"), ::OpenAPI::toJsonValue(m_black_frame));
    }
    return obj;
}

float OAIStartTechnicalCueDetectionFilter::getMinSegmentConfidence() const {
    return m_min_segment_confidence;
}
void OAIStartTechnicalCueDetectionFilter::setMinSegmentConfidence(const float &min_segment_confidence) {
    m_min_segment_confidence = min_segment_confidence;
    m_min_segment_confidence_isSet = true;
}

bool OAIStartTechnicalCueDetectionFilter::is_min_segment_confidence_Set() const{
    return m_min_segment_confidence_isSet;
}

bool OAIStartTechnicalCueDetectionFilter::is_min_segment_confidence_Valid() const{
    return m_min_segment_confidence_isValid;
}

OAIStartTechnicalCueDetectionFilter_BlackFrame OAIStartTechnicalCueDetectionFilter::getBlackFrame() const {
    return m_black_frame;
}
void OAIStartTechnicalCueDetectionFilter::setBlackFrame(const OAIStartTechnicalCueDetectionFilter_BlackFrame &black_frame) {
    m_black_frame = black_frame;
    m_black_frame_isSet = true;
}

bool OAIStartTechnicalCueDetectionFilter::is_black_frame_Set() const{
    return m_black_frame_isSet;
}

bool OAIStartTechnicalCueDetectionFilter::is_black_frame_Valid() const{
    return m_black_frame_isValid;
}

bool OAIStartTechnicalCueDetectionFilter::isSet() const {
...
bool OAIStartTechnicalCueDetectionFilter::isValid() const {
