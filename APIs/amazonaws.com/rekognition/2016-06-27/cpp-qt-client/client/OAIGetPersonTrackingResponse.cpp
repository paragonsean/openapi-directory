...
#include "OAIGetPersonTrackingResponse.h"
...
OAIGetPersonTrackingResponse::OAIGetPersonTrackingResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPersonTrackingResponse::OAIGetPersonTrackingResponse() {
    this->initializeModel();
}

OAIGetPersonTrackingResponse::~OAIGetPersonTrackingResponse() {}

void OAIGetPersonTrackingResponse::initializeModel() {
...
void OAIGetPersonTrackingResponse::fromJson(QString jsonString) {
...
void OAIGetPersonTrackingResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetPersonTrackingResponse::asJson() const {
...
QJsonObject OAIGetPersonTrackingResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIVideoJobStatus OAIGetPersonTrackingResponse::getJobStatus() const {
    return m_job_status;
}
void OAIGetPersonTrackingResponse::setJobStatus(const OAIVideoJobStatus &job_status) {
    m_job_status = job_status;
    m_job_status_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_job_status_Set() const{
    return m_job_status_isSet;
}

bool OAIGetPersonTrackingResponse::is_job_status_Valid() const{
    return m_job_status_isValid;
}

QString OAIGetPersonTrackingResponse::getStatusMessage() const {
    return m_status_message;
}
void OAIGetPersonTrackingResponse::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIGetPersonTrackingResponse::is_status_message_Valid() const{
    return m_status_message_isValid;
}

OAIGetCelebrityRecognitionResponse_VideoMetadata OAIGetPersonTrackingResponse::getVideoMetadata() const {
    return m_video_metadata;
}
void OAIGetPersonTrackingResponse::setVideoMetadata(const OAIGetCelebrityRecognitionResponse_VideoMetadata &video_metadata) {
    m_video_metadata = video_metadata;
    m_video_metadata_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_video_metadata_Set() const{
    return m_video_metadata_isSet;
}

bool OAIGetPersonTrackingResponse::is_video_metadata_Valid() const{
    return m_video_metadata_isValid;
}

QString OAIGetPersonTrackingResponse::getNextToken() const {
    return m_next_token;
}
void OAIGetPersonTrackingResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetPersonTrackingResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIGetPersonTrackingResponse::getPersons() const {
    return m_persons;
}
void OAIGetPersonTrackingResponse::setPersons(const QList &persons) {
    m_persons = persons;
    m_persons_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_persons_Set() const{
    return m_persons_isSet;
}

bool OAIGetPersonTrackingResponse::is_persons_Valid() const{
    return m_persons_isValid;
}

QString OAIGetPersonTrackingResponse::getJobId() const {
    return m_job_id;
}
void OAIGetPersonTrackingResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetPersonTrackingResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIVideo OAIGetPersonTrackingResponse::getVideo() const {
    return m_video;
}
void OAIGetPersonTrackingResponse::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_video_Set() const{
    return m_video_isSet;
}

bool OAIGetPersonTrackingResponse::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIGetPersonTrackingResponse::getJobTag() const {
    return m_job_tag;
}
void OAIGetPersonTrackingResponse::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIGetPersonTrackingResponse::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIGetPersonTrackingResponse::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIGetPersonTrackingResponse::isSet() const {
...
bool OAIGetPersonTrackingResponse::isValid() const {
