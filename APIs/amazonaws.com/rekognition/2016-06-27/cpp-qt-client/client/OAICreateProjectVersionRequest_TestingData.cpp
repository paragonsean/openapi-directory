...
OAICreateProjectVersionRequest_TestingData::OAICreateProjectVersionRequest_TestingData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateProjectVersionRequest_TestingData::OAICreateProjectVersionRequest_TestingData() {
    this->initializeModel();
}

OAICreateProjectVersionRequest_TestingData::~OAICreateProjectVersionRequest_TestingData() {}

void OAICreateProjectVersionRequest_TestingData::initializeModel() {
...
void OAICreateProjectVersionRequest_TestingData::fromJson(QString jsonString) {
...
void OAICreateProjectVersionRequest_TestingData::fromJsonObject(QJsonObject json) {
...
QString OAICreateProjectVersionRequest_TestingData::asJson() const {
...
QJsonObject OAICreateProjectVersionRequest_TestingData::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAICreateProjectVersionRequest_TestingData::getAssets() const {
    return m_assets;
}
void OAICreateProjectVersionRequest_TestingData::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAICreateProjectVersionRequest_TestingData::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAICreateProjectVersionRequest_TestingData::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAICreateProjectVersionRequest_TestingData::getAutoCreate() const {
    return m_auto_create;
}
void OAICreateProjectVersionRequest_TestingData::setAutoCreate(const bool &auto_create) {
    m_auto_create = auto_create;
    m_auto_create_isSet = true;
}

bool OAICreateProjectVersionRequest_TestingData::is_auto_create_Set() const{
    return m_auto_create_isSet;
}

bool OAICreateProjectVersionRequest_TestingData::is_auto_create_Valid() const{
    return m_auto_create_isValid;
}

bool OAICreateProjectVersionRequest_TestingData::isSet() const {
...
bool OAICreateProjectVersionRequest_TestingData::isValid() const {
