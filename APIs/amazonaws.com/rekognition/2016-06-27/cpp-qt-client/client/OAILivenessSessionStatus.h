...
/*
 * OAILivenessSessionStatus.h
 *
 * 
 */

#ifndef OAILivenessSessionStatus_H
#define OAILivenessSessionStatus_H
...
class OAILivenessSessionStatus : public OAIEnum {
public:
    OAILivenessSessionStatus();
    OAILivenessSessionStatus(QString json);
    ~OAILivenessSessionStatus() override;
    ...
    enum class eOAILivenessSessionStatus {
    ...
    OAILivenessSessionStatus::eOAILivenessSessionStatus getValue() const;
    void setValue(const OAILivenessSessionStatus::eOAILivenessSessionStatus& value);
...
private:
    ...
    eOAILivenessSessionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILivenessSessionStatus)

#endif // OAILivenessSessionStatus_H
