...
OAIFaceOccluded::OAIFaceOccluded(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceOccluded::OAIFaceOccluded() {
    this->initializeModel();
}

OAIFaceOccluded::~OAIFaceOccluded() {}

void OAIFaceOccluded::initializeModel() {
...
void OAIFaceOccluded::fromJson(QString jsonString) {
...
void OAIFaceOccluded::fromJsonObject(QJsonObject json) {
...
QString OAIFaceOccluded::asJson() const {
...
QJsonObject OAIFaceOccluded::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIFaceOccluded::getValue() const {
    return m_value;
}
void OAIFaceOccluded::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFaceOccluded::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFaceOccluded::is_value_Valid() const{
    return m_value_isValid;
}

float OAIFaceOccluded::getConfidence() const {
    return m_confidence;
}
void OAIFaceOccluded::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceOccluded::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceOccluded::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIFaceOccluded::isSet() const {
...
bool OAIFaceOccluded::isValid() const {
