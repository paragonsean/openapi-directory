...
#include "OAIProtectiveEquipmentSummarizationAttributes.h"
...
OAIProtectiveEquipmentSummarizationAttributes::OAIProtectiveEquipmentSummarizationAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProtectiveEquipmentSummarizationAttributes::OAIProtectiveEquipmentSummarizationAttributes() {
    this->initializeModel();
}

OAIProtectiveEquipmentSummarizationAttributes::~OAIProtectiveEquipmentSummarizationAttributes() {}

void OAIProtectiveEquipmentSummarizationAttributes::initializeModel() {
...
void OAIProtectiveEquipmentSummarizationAttributes::fromJson(QString jsonString) {
...
void OAIProtectiveEquipmentSummarizationAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIProtectiveEquipmentSummarizationAttributes::asJson() const {
...
QJsonObject OAIProtectiveEquipmentSummarizationAttributes::asJsonObject() const {
    QJsonObject obj;
...
float OAIProtectiveEquipmentSummarizationAttributes::getMinConfidence() const {
    return m_min_confidence;
}
void OAIProtectiveEquipmentSummarizationAttributes::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIProtectiveEquipmentSummarizationAttributes::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIProtectiveEquipmentSummarizationAttributes::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

QList OAIProtectiveEquipmentSummarizationAttributes::getRequiredEquipmentTypes() const {
    return m_required_equipment_types;
}
void OAIProtectiveEquipmentSummarizationAttributes::setRequiredEquipmentTypes(const QList &required_equipment_types) {
    m_required_equipment_types = required_equipment_types;
    m_required_equipment_types_isSet = true;
}

bool OAIProtectiveEquipmentSummarizationAttributes::is_required_equipment_types_Set() const{
    return m_required_equipment_types_isSet;
}

bool OAIProtectiveEquipmentSummarizationAttributes::is_required_equipment_types_Valid() const{
    return m_required_equipment_types_isValid;
}

bool OAIProtectiveEquipmentSummarizationAttributes::isSet() const {
...
bool OAIProtectiveEquipmentSummarizationAttributes::isValid() const {
