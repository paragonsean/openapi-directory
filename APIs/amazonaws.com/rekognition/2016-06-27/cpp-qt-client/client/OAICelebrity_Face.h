...
#ifndef OAICelebrity_Face_H
#define OAICelebrity_Face_H

#include <QJsonObject>

#include "OAIComparedFace_BoundingBox.h"
#include "OAIComparedFace_Pose.h"
#include "OAIComparedFace_Quality.h"
#include "OAIComparedFace_Smile.h"
#include <QList>
...
class OAIComparedFace_Pose;
class OAIComparedFace_Quality;
class OAIComparedFace_Smile;

class OAICelebrity_Face : public OAIObject {
public:
    OAICelebrity_Face();
    OAICelebrity_Face(QString json);
    ~OAICelebrity_Face() override;
    ...
    OAIComparedFace_Pose getPose() const;
    void setPose(const OAIComparedFace_Pose &pose);
    bool is_pose_Set() const;
    bool is_pose_Valid() const;

    OAIComparedFace_Quality getQuality() const;
    void setQuality(const OAIComparedFace_Quality &quality);
    ...
    OAIComparedFace_Smile getSmile() const;
    void setSmile(const OAIComparedFace_Smile &smile);
...
private:
    ...
    OAIComparedFace_Pose m_pose;
    bool m_pose_isSet;
    bool m_pose_isValid;

    OAIComparedFace_Quality m_quality;
...
Q_DECLARE_METATYPE(OpenAPI::OAICelebrity_Face)

#endif // OAICelebrity_Face_H
