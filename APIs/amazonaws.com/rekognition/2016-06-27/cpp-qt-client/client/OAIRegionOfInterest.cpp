...
OAIRegionOfInterest::OAIRegionOfInterest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegionOfInterest::OAIRegionOfInterest() {
    this->initializeModel();
}

OAIRegionOfInterest::~OAIRegionOfInterest() {}

void OAIRegionOfInterest::initializeModel() {
...
void OAIRegionOfInterest::fromJson(QString jsonString) {
...
void OAIRegionOfInterest::fromJsonObject(QJsonObject json) {
...
QString OAIRegionOfInterest::asJson() const {
...
QJsonObject OAIRegionOfInterest::asJsonObject() const {
    QJsonObject obj;
...
OAIRegionOfInterest_BoundingBox OAIRegionOfInterest::getBoundingBox() const {
    return m_bounding_box;
}
void OAIRegionOfInterest::setBoundingBox(const OAIRegionOfInterest_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIRegionOfInterest::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIRegionOfInterest::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

QList OAIRegionOfInterest::getPolygon() const {
    return m_polygon;
}
void OAIRegionOfInterest::setPolygon(const QList &polygon) {
    m_polygon = polygon;
    m_polygon_isSet = true;
}

bool OAIRegionOfInterest::is_polygon_Set() const{
    return m_polygon_isSet;
}

bool OAIRegionOfInterest::is_polygon_Valid() const{
    return m_polygon_isValid;
}

bool OAIRegionOfInterest::isSet() const {
...
bool OAIRegionOfInterest::isValid() const {
