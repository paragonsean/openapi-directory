...
#include "OAICelebrityRecognition.h"
...
OAICelebrityRecognition::OAICelebrityRecognition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICelebrityRecognition::OAICelebrityRecognition() {
    this->initializeModel();
}

OAICelebrityRecognition::~OAICelebrityRecognition() {}

void OAICelebrityRecognition::initializeModel() {
...
void OAICelebrityRecognition::fromJson(QString jsonString) {
...
void OAICelebrityRecognition::fromJsonObject(QJsonObject json) {
...
QString OAICelebrityRecognition::asJson() const {
...
QJsonObject OAICelebrityRecognition::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICelebrityRecognition::getTimestamp() const {
    return m_timestamp;
}
void OAICelebrityRecognition::setTimestamp(const qint32 &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAICelebrityRecognition::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAICelebrityRecognition::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

OAICelebrityRecognition_Celebrity OAICelebrityRecognition::getCelebrity() const {
    return m_celebrity;
}
void OAICelebrityRecognition::setCelebrity(const OAICelebrityRecognition_Celebrity &celebrity) {
    m_celebrity = celebrity;
    m_celebrity_isSet = true;
}

bool OAICelebrityRecognition::is_celebrity_Set() const{
    return m_celebrity_isSet;
}

bool OAICelebrityRecognition::is_celebrity_Valid() const{
    return m_celebrity_isValid;
}

bool OAICelebrityRecognition::isSet() const {
...
bool OAICelebrityRecognition::isValid() const {
