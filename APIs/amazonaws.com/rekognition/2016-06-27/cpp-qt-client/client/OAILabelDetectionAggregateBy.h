...
/*
 * OAILabelDetectionAggregateBy.h
 *
 * 
 */

#ifndef OAILabelDetectionAggregateBy_H
#define OAILabelDetectionAggregateBy_H
...
class OAILabelDetectionAggregateBy : public OAIEnum {
public:
    OAILabelDetectionAggregateBy();
    OAILabelDetectionAggregateBy(QString json);
    ~OAILabelDetectionAggregateBy() override;
    ...
    enum class eOAILabelDetectionAggregateBy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TIMESTAMPS, 
        SEGMENTS
    };
    OAILabelDetectionAggregateBy::eOAILabelDetectionAggregateBy getValue() const;
    void setValue(const OAILabelDetectionAggregateBy::eOAILabelDetectionAggregateBy& value);
...
private:
    ...
    eOAILabelDetectionAggregateBy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelDetectionAggregateBy)

#endif // OAILabelDetectionAggregateBy_H
