...
#include "OAITrainingDataResult_Input.h"
...
OAITrainingDataResult_Input::OAITrainingDataResult_Input(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrainingDataResult_Input::OAITrainingDataResult_Input() {
    this->initializeModel();
}

OAITrainingDataResult_Input::~OAITrainingDataResult_Input() {}

void OAITrainingDataResult_Input::initializeModel() {

    m_assets_isSet = false;
    m_assets_isValid = false;
}

void OAITrainingDataResult_Input::fromJson(QString jsonString) {
...
void OAITrainingDataResult_Input::fromJsonObject(QJsonObject json) {
...
QString OAITrainingDataResult_Input::asJson() const {
...
QJsonObject OAITrainingDataResult_Input::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAITrainingDataResult_Input::getAssets() const {
    return m_assets;
}
void OAITrainingDataResult_Input::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAITrainingDataResult_Input::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAITrainingDataResult_Input::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAITrainingDataResult_Input::isSet() const {
...
bool OAITrainingDataResult_Input::isValid() const {
