...
/*
 * OAIComparedFace_BoundingBox.h
 *
 * 
 */

#ifndef OAIComparedFace_BoundingBox_H
#define OAIComparedFace_BoundingBox_H
...
class OAIComparedFace_BoundingBox : public OAIObject {
public:
    OAIComparedFace_BoundingBox();
    OAIComparedFace_BoundingBox(QString json);
    ~OAIComparedFace_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComparedFace_BoundingBox)

#endif // OAIComparedFace_BoundingBox_H
