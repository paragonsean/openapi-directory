...
/*
 * OAIKnownGenderType.h
 *
 * A list of enum string of possible gender values that Celebrity returns.
 */

#ifndef OAIKnownGenderType_H
#define OAIKnownGenderType_H
...
class OAIKnownGenderType : public OAIEnum {
public:
    OAIKnownGenderType();
    OAIKnownGenderType(QString json);
    ~OAIKnownGenderType() override;
    ...
    enum class eOAIKnownGenderType {
    ...
    OAIKnownGenderType::eOAIKnownGenderType getValue() const;
    void setValue(const OAIKnownGenderType::eOAIKnownGenderType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKnownGenderType)

#endif // OAIKnownGenderType_H
