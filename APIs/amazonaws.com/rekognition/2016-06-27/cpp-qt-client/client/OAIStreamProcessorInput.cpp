...
#include "OAIStreamProcessorInput.h"
...
OAIStreamProcessorInput::OAIStreamProcessorInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorInput::OAIStreamProcessorInput() {
    this->initializeModel();
}

OAIStreamProcessorInput::~OAIStreamProcessorInput() {}

void OAIStreamProcessorInput::initializeModel() {

    m_kinesis_video_stream_isSet = false;
    m_kinesis_video_stream_isValid = false;
}

void OAIStreamProcessorInput::fromJson(QString jsonString) {
...
void OAIStreamProcessorInput::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessorInput::asJson() const {
...
QJsonObject OAIStreamProcessorInput::asJsonObject() const {
    QJsonObject obj;
...
OAIStreamProcessorInput_KinesisVideoStream OAIStreamProcessorInput::getKinesisVideoStream() const {
    return m_kinesis_video_stream;
}
void OAIStreamProcessorInput::setKinesisVideoStream(const OAIStreamProcessorInput_KinesisVideoStream &kinesis_video_stream) {
    m_kinesis_video_stream = kinesis_video_stream;
    m_kinesis_video_stream_isSet = true;
}

bool OAIStreamProcessorInput::is_kinesis_video_stream_Set() const{
    return m_kinesis_video_stream_isSet;
}

bool OAIStreamProcessorInput::is_kinesis_video_stream_Valid() const{
    return m_kinesis_video_stream_isValid;
}

bool OAIStreamProcessorInput::isSet() const {
...
bool OAIStreamProcessorInput::isValid() const {
