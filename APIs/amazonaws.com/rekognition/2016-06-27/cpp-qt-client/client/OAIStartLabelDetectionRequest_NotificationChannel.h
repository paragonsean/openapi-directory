...
/*
 * OAIStartLabelDetectionRequest_NotificationChannel.h
 *
 * 
 */

#ifndef OAIStartLabelDetectionRequest_NotificationChannel_H
#define OAIStartLabelDetectionRequest_NotificationChannel_H
...
class OAIStartLabelDetectionRequest_NotificationChannel : public OAIObject {
public:
    OAIStartLabelDetectionRequest_NotificationChannel();
    OAIStartLabelDetectionRequest_NotificationChannel(QString json);
    ~OAIStartLabelDetectionRequest_NotificationChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartLabelDetectionRequest_NotificationChannel)

#endif // OAIStartLabelDetectionRequest_NotificationChannel_H
