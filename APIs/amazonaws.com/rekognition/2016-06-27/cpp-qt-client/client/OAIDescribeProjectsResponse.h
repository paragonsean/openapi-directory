...
/*
 * OAIDescribeProjectsResponse.h
 *
 * 
 */

#ifndef OAIDescribeProjectsResponse_H
#define OAIDescribeProjectsResponse_H
...
class OAIDescribeProjectsResponse : public OAIObject {
public:
    OAIDescribeProjectsResponse();
    OAIDescribeProjectsResponse(QString json);
    ~OAIDescribeProjectsResponse() override;
    ...
    QList getProjectDescriptions() const;
    void setProjectDescriptions(const QList &project_descriptions);
    bool is_project_descriptions_Set() const;
    bool is_project_descriptions_Valid() const;
...
private:
    ...
    QList m_project_descriptions;
    bool m_project_descriptions_isSet;
    bool m_project_descriptions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProjectsResponse)

#endif // OAIDescribeProjectsResponse_H
