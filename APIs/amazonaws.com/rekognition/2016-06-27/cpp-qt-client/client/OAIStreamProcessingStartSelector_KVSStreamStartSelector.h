...
/*
 * OAIStreamProcessingStartSelector_KVSStreamStartSelector.h
 *
 * 
 */

#ifndef OAIStreamProcessingStartSelector_KVSStreamStartSelector_H
#define OAIStreamProcessingStartSelector_KVSStreamStartSelector_H
...
class OAIStreamProcessingStartSelector_KVSStreamStartSelector : public OAIObject {
public:
    OAIStreamProcessingStartSelector_KVSStreamStartSelector();
    OAIStreamProcessingStartSelector_KVSStreamStartSelector(QString json);
    ~OAIStreamProcessingStartSelector_KVSStreamStartSelector() override;
    ...
    qint32 getProducerTimestamp() const;
    void setProducerTimestamp(const qint32 &producer_timestamp);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessingStartSelector_KVSStreamStartSelector)

#endif // OAIStreamProcessingStartSelector_KVSStreamStartSelector_H
