...
/*
 * OAICompareFacesRequest.h
 *
 * 
 */

#ifndef OAICompareFacesRequest_H
#define OAICompareFacesRequest_H

#include <QJsonObject>

#include "OAICompareFacesRequest_SourceImage.h"
#include "OAICompareFacesRequest_TargetImage.h"
...
class OAICompareFacesRequest_TargetImage;

class OAICompareFacesRequest : public OAIObject {
public:
    OAICompareFacesRequest();
    OAICompareFacesRequest(QString json);
    ~OAICompareFacesRequest() override;
    ...
    OAICompareFacesRequest_SourceImage getSourceImage() const;
    void setSourceImage(const OAICompareFacesRequest_SourceImage &source_image);
    bool is_source_image_Set() const;
    bool is_source_image_Valid() const;

    OAICompareFacesRequest_TargetImage getTargetImage() const;
    void setTargetImage(const OAICompareFacesRequest_TargetImage &target_image);
    bool is_target_image_Set() const;
    bool is_target_image_Valid() const;

    float getSimilarityThreshold() const;
    void setSimilarityThreshold(const float &similarity_threshold);
    bool is_similarity_threshold_Set() const;
    bool is_similarity_threshold_Valid() const;
...
private:
    ...
    OAICompareFacesRequest_SourceImage m_source_image;
    bool m_source_image_isSet;
    bool m_source_image_isValid;

    OAICompareFacesRequest_TargetImage m_target_image;
    bool m_target_image_isSet;
    bool m_target_image_isValid;

    float m_similarity_threshold;
    bool m_similarity_threshold_isSet;
    bool m_similarity_threshold_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompareFacesRequest)

#endif // OAICompareFacesRequest_H
