...
/**
 * StartTechnicalCueDetectionFilterBlackFrame
 */
...
public class StartTechnicalCueDetectionFilterBlackFrame {
  ...
  public StartTechnicalCueDetectionFilterBlackFrame() {
  }

  public StartTechnicalCueDetectionFilterBlackFrame maxPixelThreshold(Float maxPixelThreshold) {
  ...
  public StartTechnicalCueDetectionFilterBlackFrame minCoveragePercentage(Float minCoveragePercentage) {
  ...
  public boolean equals(Object o) {
    ...
    StartTechnicalCueDetectionFilterBlackFrame startTechnicalCueDetectionFilterBlackFrame = (StartTechnicalCueDetectionFilterBlackFrame) o;
    return Objects.equals(this.maxPixelThreshold, startTechnicalCueDetectionFilterBlackFrame.maxPixelThreshold) &&
        Objects.equals(this.minCoveragePercentage, startTechnicalCueDetectionFilterBlackFrame.minCoveragePercentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartTechnicalCueDetectionFilterBlackFrame {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTechnicalCueDetectionFilterBlackFrame
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTechnicalCueDetectionFilterBlackFrame.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTechnicalCueDetectionFilterBlackFrame is not found in the empty JSON string", StartTechnicalCueDetectionFilterBlackFrame.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTechnicalCueDetectionFilterBlackFrame.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTechnicalCueDetectionFilterBlackFrame` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTechnicalCueDetectionFilterBlackFrame.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTechnicalCueDetectionFilterBlackFrame' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTechnicalCueDetectionFilterBlackFrame> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTechnicalCueDetectionFilterBlackFrame.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTechnicalCueDetectionFilterBlackFrame>() {
           @Override
           public void write(JsonWriter out, StartTechnicalCueDetectionFilterBlackFrame value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTechnicalCueDetectionFilterBlackFrame read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTechnicalCueDetectionFilterBlackFrame given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTechnicalCueDetectionFilterBlackFrame
   * @throws IOException if the JSON string is invalid with respect to StartTechnicalCueDetectionFilterBlackFrame
   */
  public static StartTechnicalCueDetectionFilterBlackFrame fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTechnicalCueDetectionFilterBlackFrame.class);
  }

  /**
   * Convert an instance of StartTechnicalCueDetectionFilterBlackFrame to an JSON string
   *
   * @return JSON string
   */
