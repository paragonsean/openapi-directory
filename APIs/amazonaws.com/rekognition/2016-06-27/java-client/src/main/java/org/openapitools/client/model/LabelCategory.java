...
public class LabelCategory {
  ...
  public LabelCategory name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LabelCategory labelCategory = (LabelCategory) o;
    return Objects.equals(this.name, labelCategory.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabelCategory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabelCategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabelCategory is not found in the empty JSON string", LabelCategory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabelCategory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabelCategory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabelCategory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabelCategory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabelCategory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabelCategory.class));

       return (TypeAdapter<T>) new TypeAdapter<LabelCategory>() {
           @Override
           public void write(JsonWriter out, LabelCategory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabelCategory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabelCategory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabelCategory
   * @throws IOException if the JSON string is invalid with respect to LabelCategory
   */
  public static LabelCategory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabelCategory.class);
  }

  /**
   * Convert an instance of LabelCategory to an JSON string
   *
   * @return JSON string
   */
