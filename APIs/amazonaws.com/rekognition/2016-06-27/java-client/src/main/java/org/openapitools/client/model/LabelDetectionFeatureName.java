...
/**
 * Gets or Sets LabelDetectionFeatureName
 */
@JsonAdapter(LabelDetectionFeatureName.Adapter.class)
public enum LabelDetectionFeatureName {
  ...
  LabelDetectionFeatureName(String value) {
    this.value = value;
  }
  ...
  public static LabelDetectionFeatureName fromValue(String value) {
    for (LabelDetectionFeatureName b : LabelDetectionFeatureName.values()) {
  ...
  public static class Adapter extends TypeAdapter<LabelDetectionFeatureName> {
    @Override
    public void write(final JsonWriter jsonWriter, final LabelDetectionFeatureName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LabelDetectionFeatureName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LabelDetectionFeatureName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LabelDetectionFeatureName.fromValue(value);
  }
}
