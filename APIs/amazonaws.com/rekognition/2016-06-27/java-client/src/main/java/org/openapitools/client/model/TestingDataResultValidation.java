...
public class TestingDataResultValidation {
  public static final String SERIALIZED_NAME_ASSETS = "Assets";
  @SerializedName(SERIALIZED_NAME_ASSETS)
  private List assets;

  public TestingDataResultValidation() {
  }

  public TestingDataResultValidation assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestingDataResultValidation testingDataResultValidation = (TestingDataResultValidation) o;
    return Objects.equals(this.assets, testingDataResultValidation.assets);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestingDataResultValidation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestingDataResultValidation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestingDataResultValidation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestingDataResultValidation is not found in the empty JSON string", TestingDataResultValidation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestingDataResultValidation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestingDataResultValidation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestingDataResultValidation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestingDataResultValidation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestingDataResultValidation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestingDataResultValidation.class));

       return (TypeAdapter<T>) new TypeAdapter<TestingDataResultValidation>() {
           @Override
           public void write(JsonWriter out, TestingDataResultValidation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestingDataResultValidation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestingDataResultValidation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestingDataResultValidation
   * @throws IOException if the JSON string is invalid with respect to TestingDataResultValidation
   */
  public static TestingDataResultValidation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestingDataResultValidation.class);
  }

  /**
   * Convert an instance of TestingDataResultValidation to an JSON string
   *
   * @return JSON string
   */
