...
import org.openapitools.client.model.FaceDetectionFace;
...
public class FaceDetection {
  ...
  private FaceDetectionFace face;

  public FaceDetection() {
  }

  public FaceDetection timestamp(Integer timestamp) {
  ...
  public FaceDetection face(FaceDetectionFace face) {
    this.face = face;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public FaceDetectionFace getFace() {
    return face;
  }

  public void setFace(FaceDetectionFace face) {
    this.face = face;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timestamp, faceDetection.timestamp) &&
        Objects.equals(this.face, faceDetection.face);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, face);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Face") != null && !jsonObj.get("Face").isJsonNull()) {
        FaceDetectionFace.validateJsonElement(jsonObj.get("Face"));
      }
  }
