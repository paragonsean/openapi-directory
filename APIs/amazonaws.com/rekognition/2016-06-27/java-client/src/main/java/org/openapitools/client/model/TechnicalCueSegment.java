...
import org.openapitools.client.model.TechnicalCueType;
...
public class TechnicalCueSegment {
  ...
  public TechnicalCueSegment type(TechnicalCueType type) {
    this.type = type;
    return this;
  }
  ...
  public TechnicalCueType getType() {
    return type;
  }
  ...
  public TechnicalCueSegment confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    TechnicalCueSegment technicalCueSegment = (TechnicalCueSegment) o;
    return Objects.equals(this.type, technicalCueSegment.type) &&
        Objects.equals(this.confidence, technicalCueSegment.confidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, confidence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TechnicalCueSegment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TechnicalCueSegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TechnicalCueSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TechnicalCueSegment is not found in the empty JSON string", TechnicalCueSegment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TechnicalCueSegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TechnicalCueSegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Type`
      if (jsonObj.get("Type") != null && !jsonObj.get("Type").isJsonNull()) {
        TechnicalCueType.validateJsonElement(jsonObj.get("Type"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TechnicalCueSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TechnicalCueSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TechnicalCueSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TechnicalCueSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<TechnicalCueSegment>() {
           @Override
           public void write(JsonWriter out, TechnicalCueSegment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TechnicalCueSegment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TechnicalCueSegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TechnicalCueSegment
   * @throws IOException if the JSON string is invalid with respect to TechnicalCueSegment
   */
  public static TechnicalCueSegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TechnicalCueSegment.class);
  }

  /**
   * Convert an instance of TechnicalCueSegment to an JSON string
   *
   * @return JSON string
   */
