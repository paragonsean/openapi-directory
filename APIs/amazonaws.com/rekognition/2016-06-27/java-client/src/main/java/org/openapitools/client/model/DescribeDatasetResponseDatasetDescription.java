...
public class DescribeDatasetResponseDatasetDescription {
  ...
  public DescribeDatasetResponseDatasetDescription() {
  }

  public DescribeDatasetResponseDatasetDescription creationTimestamp(OffsetDateTime creationTimestamp) {
  ...
  public DescribeDatasetResponseDatasetDescription lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public DescribeDatasetResponseDatasetDescription status(DatasetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeDatasetResponseDatasetDescription statusMessage(String statusMessage) {
  ...
  public DescribeDatasetResponseDatasetDescription statusMessageCode(DatasetStatusMessageCode statusMessageCode) {
  ...
  public DescribeDatasetResponseDatasetDescription datasetStats(DatasetDescriptionDatasetStats datasetStats) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeDatasetResponseDatasetDescription describeDatasetResponseDatasetDescription = (DescribeDatasetResponseDatasetDescription) o;
    return Objects.equals(this.creationTimestamp, describeDatasetResponseDatasetDescription.creationTimestamp) &&
        Objects.equals(this.lastUpdatedTimestamp, describeDatasetResponseDatasetDescription.lastUpdatedTimestamp) &&
        Objects.equals(this.status, describeDatasetResponseDatasetDescription.status) &&
        Objects.equals(this.statusMessage, describeDatasetResponseDatasetDescription.statusMessage) &&
        Objects.equals(this.statusMessageCode, describeDatasetResponseDatasetDescription.statusMessageCode) &&
        Objects.equals(this.datasetStats, describeDatasetResponseDatasetDescription.datasetStats);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeDatasetResponseDatasetDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeDatasetResponseDatasetDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeDatasetResponseDatasetDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeDatasetResponseDatasetDescription is not found in the empty JSON string", DescribeDatasetResponseDatasetDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeDatasetResponseDatasetDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeDatasetResponseDatasetDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeDatasetResponseDatasetDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeDatasetResponseDatasetDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeDatasetResponseDatasetDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeDatasetResponseDatasetDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeDatasetResponseDatasetDescription>() {
           @Override
           public void write(JsonWriter out, DescribeDatasetResponseDatasetDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeDatasetResponseDatasetDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeDatasetResponseDatasetDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeDatasetResponseDatasetDescription
   * @throws IOException if the JSON string is invalid with respect to DescribeDatasetResponseDatasetDescription
   */
  public static DescribeDatasetResponseDatasetDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeDatasetResponseDatasetDescription.class);
  }

  /**
   * Convert an instance of DescribeDatasetResponseDatasetDescription to an JSON string
   *
   * @return JSON string
   */
