...
public class CreateStreamProcessorResponse {
  ...
  public CreateStreamProcessorResponse streamProcessorArn(String streamProcessorArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamProcessorResponse createStreamProcessorResponse = (CreateStreamProcessorResponse) o;
    return Objects.equals(this.streamProcessorArn, createStreamProcessorResponse.streamProcessorArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(streamProcessorArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateStreamProcessorResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamProcessorResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamProcessorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamProcessorResponse is not found in the empty JSON string", CreateStreamProcessorResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamProcessorResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamProcessorResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamProcessorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamProcessorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamProcessorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamProcessorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamProcessorResponse>() {
           @Override
           public void write(JsonWriter out, CreateStreamProcessorResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamProcessorResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamProcessorResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamProcessorResponse
   * @throws IOException if the JSON string is invalid with respect to CreateStreamProcessorResponse
   */
  public static CreateStreamProcessorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamProcessorResponse.class);
  }

  /**
   * Convert an instance of CreateStreamProcessorResponse to an JSON string
   *
   * @return JSON string
   */
