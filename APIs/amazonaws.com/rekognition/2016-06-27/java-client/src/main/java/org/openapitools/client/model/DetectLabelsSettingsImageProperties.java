...
public class DetectLabelsSettingsImageProperties {
  public static final String SERIALIZED_NAME_MAX_DOMINANT_COLORS = "MaxDominantColors";
  @SerializedName(SERIALIZED_NAME_MAX_DOMINANT_COLORS)
  private Integer maxDominantColors;

  public DetectLabelsSettingsImageProperties() {
  }

  public DetectLabelsSettingsImageProperties maxDominantColors(Integer maxDominantColors) {
    this.maxDominantColors = maxDominantColors;
    return this;
  }

  /**
   * Get maxDominantColors
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsSettingsImageProperties detectLabelsSettingsImageProperties = (DetectLabelsSettingsImageProperties) o;
    return Objects.equals(this.maxDominantColors, detectLabelsSettingsImageProperties.maxDominantColors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxDominantColors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectLabelsSettingsImageProperties {\n");
    sb.append("    maxDominantColors: ").append(toIndentedString(maxDominantColors)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("MaxDominantColors");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsSettingsImageProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsSettingsImageProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsSettingsImageProperties is not found in the empty JSON string", DetectLabelsSettingsImageProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsSettingsImageProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsSettingsImageProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `MaxDominantColors`
      if (jsonObj.get("MaxDominantColors") != null && !jsonObj.get("MaxDominantColors").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("MaxDominantColors"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsSettingsImageProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsSettingsImageProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsSettingsImageProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsSettingsImageProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsSettingsImageProperties>() {
           @Override
           public void write(JsonWriter out, DetectLabelsSettingsImageProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsSettingsImageProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsSettingsImageProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsSettingsImageProperties
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsSettingsImageProperties
   */
  public static DetectLabelsSettingsImageProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsSettingsImageProperties.class);
  }

  /**
   * Convert an instance of DetectLabelsSettingsImageProperties to an JSON string
   *
   * @return JSON string
   */
