...
/**
 * Gets or Sets TechnicalCueType
 */
@JsonAdapter(TechnicalCueType.Adapter.class)
public enum TechnicalCueType {
  ...
  public static TechnicalCueType fromValue(String value) {
    for (TechnicalCueType b : TechnicalCueType.values()) {
  ...
  public static class Adapter extends TypeAdapter<TechnicalCueType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TechnicalCueType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TechnicalCueType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TechnicalCueType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TechnicalCueType.fromValue(value);
  }
}
