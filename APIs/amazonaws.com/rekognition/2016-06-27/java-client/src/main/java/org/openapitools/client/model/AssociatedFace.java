...
public class AssociatedFace {
  ...
  public AssociatedFace() {
  }

  public AssociatedFace faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssociatedFace associatedFace = (AssociatedFace) o;
    return Objects.equals(this.faceId, associatedFace.faceId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociatedFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociatedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociatedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociatedFace is not found in the empty JSON string", AssociatedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociatedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociatedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociatedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociatedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociatedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociatedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociatedFace>() {
           @Override
           public void write(JsonWriter out, AssociatedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociatedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociatedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociatedFace
   * @throws IOException if the JSON string is invalid with respect to AssociatedFace
   */
  public static AssociatedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociatedFace.class);
  }

  /**
   * Convert an instance of AssociatedFace to an JSON string
   *
   * @return JSON string
   */
