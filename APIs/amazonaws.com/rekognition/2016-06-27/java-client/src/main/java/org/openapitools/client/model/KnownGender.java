...
import org.openapitools.client.model.KnownGenderType;
...
public class KnownGender {
  ...
  private KnownGenderType type;

  public KnownGender() {
  }

  public KnownGender type(KnownGenderType type) {
    this.type = type;
    return this;
  }
  ...
  public KnownGenderType getType() {
    return type;
  }
  ...
  public boolean equals(Object o) {
    ...
    KnownGender knownGender = (KnownGender) o;
    return Objects.equals(this.type, knownGender.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to KnownGender
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KnownGender.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KnownGender is not found in the empty JSON string", KnownGender.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KnownGender.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KnownGender` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Type`
      if (jsonObj.get("Type") != null && !jsonObj.get("Type").isJsonNull()) {
        KnownGenderType.validateJsonElement(jsonObj.get("Type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KnownGender.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KnownGender' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KnownGender> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KnownGender.class));

       return (TypeAdapter<T>) new TypeAdapter<KnownGender>() {
           @Override
           public void write(JsonWriter out, KnownGender value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KnownGender read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KnownGender given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KnownGender
   * @throws IOException if the JSON string is invalid with respect to KnownGender
   */
  public static KnownGender fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KnownGender.class);
  }

  /**
   * Convert an instance of KnownGender to an JSON string
   *
   * @return JSON string
   */
