...
public class GetContentModerationRequest {
  ...
  public GetContentModerationRequest() {
  }

  public GetContentModerationRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetContentModerationRequest maxResults(Integer maxResults) {
  ...
  public GetContentModerationRequest nextToken(String nextToken) {
  ...
  public GetContentModerationRequest sortBy(ContentModerationSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public GetContentModerationRequest aggregateBy(ContentModerationAggregateBy aggregateBy) {
  ...
  public boolean equals(Object o) {
    ...
    GetContentModerationRequest getContentModerationRequest = (GetContentModerationRequest) o;
    return Objects.equals(this.jobId, getContentModerationRequest.jobId) &&
        Objects.equals(this.maxResults, getContentModerationRequest.maxResults) &&
        Objects.equals(this.nextToken, getContentModerationRequest.nextToken) &&
        Objects.equals(this.sortBy, getContentModerationRequest.sortBy) &&
        Objects.equals(this.aggregateBy, getContentModerationRequest.aggregateBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetContentModerationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetContentModerationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetContentModerationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetContentModerationRequest is not found in the empty JSON string", GetContentModerationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetContentModerationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetContentModerationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetContentModerationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetContentModerationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetContentModerationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetContentModerationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetContentModerationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetContentModerationRequest>() {
           @Override
           public void write(JsonWriter out, GetContentModerationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetContentModerationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetContentModerationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetContentModerationRequest
   * @throws IOException if the JSON string is invalid with respect to GetContentModerationRequest
   */
  public static GetContentModerationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetContentModerationRequest.class);
  }

  /**
   * Convert an instance of GetContentModerationRequest to an JSON string
   *
   * @return JSON string
   */
