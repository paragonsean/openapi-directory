...
/**
 * Gets or Sets ProjectVersionStatus
 */
@JsonAdapter(ProjectVersionStatus.Adapter.class)
public enum ProjectVersionStatus {
  ...
  ProjectVersionStatus(String value) {
    this.value = value;
  }
  ...
  public static ProjectVersionStatus fromValue(String value) {
    for (ProjectVersionStatus b : ProjectVersionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProjectVersionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProjectVersionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProjectVersionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProjectVersionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ProjectVersionStatus.fromValue(value);
  }
}
