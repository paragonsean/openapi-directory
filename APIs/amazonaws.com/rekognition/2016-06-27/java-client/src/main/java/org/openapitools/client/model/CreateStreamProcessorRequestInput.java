...
/**
 * CreateStreamProcessorRequestInput
 */
...
public class CreateStreamProcessorRequestInput {
  ...
  public CreateStreamProcessorRequestInput() {
  }

  public CreateStreamProcessorRequestInput kinesisVideoStream(StreamProcessorInputKinesisVideoStream kinesisVideoStream) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamProcessorRequestInput createStreamProcessorRequestInput = (CreateStreamProcessorRequestInput) o;
    return Objects.equals(this.kinesisVideoStream, createStreamProcessorRequestInput.kinesisVideoStream);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStreamProcessorRequestInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamProcessorRequestInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamProcessorRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamProcessorRequestInput is not found in the empty JSON string", CreateStreamProcessorRequestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamProcessorRequestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamProcessorRequestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamProcessorRequestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamProcessorRequestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamProcessorRequestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamProcessorRequestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamProcessorRequestInput>() {
           @Override
           public void write(JsonWriter out, CreateStreamProcessorRequestInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamProcessorRequestInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamProcessorRequestInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamProcessorRequestInput
   * @throws IOException if the JSON string is invalid with respect to CreateStreamProcessorRequestInput
   */
  public static CreateStreamProcessorRequestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamProcessorRequestInput.class);
  }

  /**
   * Convert an instance of CreateStreamProcessorRequestInput to an JSON string
   *
   * @return JSON string
   */
