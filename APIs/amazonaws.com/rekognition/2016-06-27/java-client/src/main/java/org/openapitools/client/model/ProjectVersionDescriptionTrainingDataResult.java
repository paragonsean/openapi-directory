...
/**
 * ProjectVersionDescriptionTrainingDataResult
 */
...
public class ProjectVersionDescriptionTrainingDataResult {
  public static final String SERIALIZED_NAME_INPUT = "Input";
  @SerializedName(SERIALIZED_NAME_INPUT)
  private TrainingDataResultInput input;

  public static final String SERIALIZED_NAME_OUTPUT = "Output";
  @SerializedName(SERIALIZED_NAME_OUTPUT)
  private TrainingDataResultOutput output;

  public static final String SERIALIZED_NAME_VALIDATION = "Validation";
  @SerializedName(SERIALIZED_NAME_VALIDATION)
  private TrainingDataResultValidation validation;

  public ProjectVersionDescriptionTrainingDataResult() {
  }

  public ProjectVersionDescriptionTrainingDataResult input(TrainingDataResultInput input) {
    this.input = input;
    return this;
  }
  ...
  public TrainingDataResultInput getInput() {
    return input;
  }

  public void setInput(TrainingDataResultInput input) {
    this.input = input;
  }


  public ProjectVersionDescriptionTrainingDataResult output(TrainingDataResultOutput output) {
    this.output = output;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public TrainingDataResultOutput getOutput() {
    return output;
  }

  public void setOutput(TrainingDataResultOutput output) {
    this.output = output;
  }


  public ProjectVersionDescriptionTrainingDataResult validation(TrainingDataResultValidation validation) {
   ...
   */
  @javax.annotation.Nullable
  public TrainingDataResultValidation getValidation() {
    return validation;
  }

  public void setValidation(TrainingDataResultValidation validation) {
    this.validation = validation;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectVersionDescriptionTrainingDataResult projectVersionDescriptionTrainingDataResult = (ProjectVersionDescriptionTrainingDataResult) o;
    return Objects.equals(this.input, projectVersionDescriptionTrainingDataResult.input) &&
        Objects.equals(this.output, projectVersionDescriptionTrainingDataResult.output) &&
        Objects.equals(this.validation, projectVersionDescriptionTrainingDataResult.validation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(input, output, validation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectVersionDescriptionTrainingDataResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectVersionDescriptionTrainingDataResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectVersionDescriptionTrainingDataResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectVersionDescriptionTrainingDataResult is not found in the empty JSON string", ProjectVersionDescriptionTrainingDataResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectVersionDescriptionTrainingDataResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectVersionDescriptionTrainingDataResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Input`
      if (jsonObj.get("Input") != null && !jsonObj.get("Input").isJsonNull()) {
        TrainingDataResultInput.validateJsonElement(jsonObj.get("Input"));
      }
      // validate the optional field `Output`
      if (jsonObj.get("Output") != null && !jsonObj.get("Output").isJsonNull()) {
        TrainingDataResultOutput.validateJsonElement(jsonObj.get("Output"));
      }
      // validate the optional field `Validation`
      if (jsonObj.get("Validation") != null && !jsonObj.get("Validation").isJsonNull()) {
        TrainingDataResultValidation.validateJsonElement(jsonObj.get("Validation"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectVersionDescriptionTrainingDataResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectVersionDescriptionTrainingDataResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectVersionDescriptionTrainingDataResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectVersionDescriptionTrainingDataResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectVersionDescriptionTrainingDataResult>() {
           @Override
           public void write(JsonWriter out, ProjectVersionDescriptionTrainingDataResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectVersionDescriptionTrainingDataResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectVersionDescriptionTrainingDataResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectVersionDescriptionTrainingDataResult
   * @throws IOException if the JSON string is invalid with respect to ProjectVersionDescriptionTrainingDataResult
   */
  public static ProjectVersionDescriptionTrainingDataResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectVersionDescriptionTrainingDataResult.class);
  }

  /**
   * Convert an instance of ProjectVersionDescriptionTrainingDataResult to an JSON string
   *
   * @return JSON string
   */
