...
/**
 * Gets or Sets LabelDetectionAggregateBy
 */
@JsonAdapter(LabelDetectionAggregateBy.Adapter.class)
public enum LabelDetectionAggregateBy {
  ...
  LabelDetectionAggregateBy(String value) {
    this.value = value;
  }
  ...
  public static LabelDetectionAggregateBy fromValue(String value) {
    for (LabelDetectionAggregateBy b : LabelDetectionAggregateBy.values()) {
  ...
  public static class Adapter extends TypeAdapter<LabelDetectionAggregateBy> {
    @Override
    public void write(final JsonWriter jsonWriter, final LabelDetectionAggregateBy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LabelDetectionAggregateBy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LabelDetectionAggregateBy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LabelDetectionAggregateBy.fromValue(value);
  }
}
