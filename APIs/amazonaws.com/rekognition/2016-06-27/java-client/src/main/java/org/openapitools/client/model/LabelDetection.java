...
import org.openapitools.client.model.LabelDetectionLabel;
...
public class LabelDetection {
  ...
  private LabelDetectionLabel label;
  ...
  public LabelDetection timestamp(Integer timestamp) {
  ...
  public LabelDetection label(LabelDetectionLabel label) {
    this.label = label;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public LabelDetectionLabel getLabel() {
    return label;
  }

  public void setLabel(LabelDetectionLabel label) {
    this.label = label;
  }


  public LabelDetection startTimestampMillis(Integer startTimestampMillis) {
  ...
  public LabelDetection endTimestampMillis(Integer endTimestampMillis) {
  ...
  public LabelDetection durationMillis(Integer durationMillis) {
  ...
  public boolean equals(Object o) {
    ...
    LabelDetection labelDetection = (LabelDetection) o;
    return Objects.equals(this.timestamp, labelDetection.timestamp) &&
        Objects.equals(this.label, labelDetection.label) &&
        Objects.equals(this.startTimestampMillis, labelDetection.startTimestampMillis) &&
        Objects.equals(this.endTimestampMillis, labelDetection.endTimestampMillis) &&
        Objects.equals(this.durationMillis, labelDetection.durationMillis);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, label, startTimestampMillis, endTimestampMillis, durationMillis);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LabelDetection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabelDetection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabelDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabelDetection is not found in the empty JSON string", LabelDetection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabelDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabelDetection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Label") != null && !jsonObj.get("Label").isJsonNull()) {
        LabelDetectionLabel.validateJsonElement(jsonObj.get("Label"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabelDetection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabelDetection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabelDetection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabelDetection.class));

       return (TypeAdapter<T>) new TypeAdapter<LabelDetection>() {
           @Override
           public void write(JsonWriter out, LabelDetection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabelDetection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabelDetection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabelDetection
   * @throws IOException if the JSON string is invalid with respect to LabelDetection
   */
  public static LabelDetection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabelDetection.class);
  }

  /**
   * Convert an instance of LabelDetection to an JSON string
   *
   * @return JSON string
   */
