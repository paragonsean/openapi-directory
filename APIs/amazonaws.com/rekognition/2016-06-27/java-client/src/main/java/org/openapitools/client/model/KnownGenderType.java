 ...
 */
@JsonAdapter(KnownGenderType.Adapter.class)
public enum KnownGenderType {
  ...
  public static KnownGenderType fromValue(String value) {
    for (KnownGenderType b : KnownGenderType.values()) {
  ...
  public static class Adapter extends TypeAdapter<KnownGenderType> {
    @Override
    public void write(final JsonWriter jsonWriter, final KnownGenderType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KnownGenderType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KnownGenderType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KnownGenderType.fromValue(value);
  }
}
