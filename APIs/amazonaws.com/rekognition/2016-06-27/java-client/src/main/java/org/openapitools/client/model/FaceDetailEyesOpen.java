...
public class FaceDetailEyesOpen {
  ...
  public FaceDetailEyesOpen() {
  }

  public FaceDetailEyesOpen value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailEyesOpen confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailEyesOpen faceDetailEyesOpen = (FaceDetailEyesOpen) o;
    return Objects.equals(this.value, faceDetailEyesOpen.value) &&
        Objects.equals(this.confidence, faceDetailEyesOpen.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailEyesOpen {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailEyesOpen
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailEyesOpen.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailEyesOpen is not found in the empty JSON string", FaceDetailEyesOpen.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailEyesOpen.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailEyesOpen` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailEyesOpen.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailEyesOpen' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailEyesOpen> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailEyesOpen.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailEyesOpen>() {
           @Override
           public void write(JsonWriter out, FaceDetailEyesOpen value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailEyesOpen read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailEyesOpen given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailEyesOpen
   * @throws IOException if the JSON string is invalid with respect to FaceDetailEyesOpen
   */
  public static FaceDetailEyesOpen fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailEyesOpen.class);
  }

  /**
   * Convert an instance of FaceDetailEyesOpen to an JSON string
   *
   * @return JSON string
   */
