...
public class AuditImage {
  ...
  public AuditImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public AuditImage s3Object(S3Object s3Object) {
  ...
  public AuditImage boundingBox(BoundingBox boundingBox) {
  ...
  public boolean equals(Object o) {
    ...
    AuditImage auditImage = (AuditImage) o;
    return Objects.equals(this.bytes, auditImage.bytes) &&
        Objects.equals(this.s3Object, auditImage.s3Object) &&
        Objects.equals(this.boundingBox, auditImage.boundingBox);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bytes, s3Object, boundingBox);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuditImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuditImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuditImage is not found in the empty JSON string", AuditImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuditImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuditImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuditImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuditImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuditImage.class));

       return (TypeAdapter<T>) new TypeAdapter<AuditImage>() {
           @Override
           public void write(JsonWriter out, AuditImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuditImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuditImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuditImage
   * @throws IOException if the JSON string is invalid with respect to AuditImage
   */
  public static AuditImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuditImage.class);
  }

  /**
   * Convert an instance of AuditImage to an JSON string
   *
   * @return JSON string
   */
