...
public class CreateProjectVersionRequestTestingData {
  ...
  public CreateProjectVersionRequestTestingData() {
  }

  public CreateProjectVersionRequestTestingData assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public CreateProjectVersionRequestTestingData autoCreate(Boolean autoCreate) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectVersionRequestTestingData createProjectVersionRequestTestingData = (CreateProjectVersionRequestTestingData) o;
    return Objects.equals(this.assets, createProjectVersionRequestTestingData.assets) &&
        Objects.equals(this.autoCreate, createProjectVersionRequestTestingData.autoCreate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectVersionRequestTestingData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectVersionRequestTestingData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectVersionRequestTestingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectVersionRequestTestingData is not found in the empty JSON string", CreateProjectVersionRequestTestingData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectVersionRequestTestingData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectVersionRequestTestingData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectVersionRequestTestingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectVersionRequestTestingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectVersionRequestTestingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectVersionRequestTestingData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectVersionRequestTestingData>() {
           @Override
           public void write(JsonWriter out, CreateProjectVersionRequestTestingData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectVersionRequestTestingData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectVersionRequestTestingData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectVersionRequestTestingData
   * @throws IOException if the JSON string is invalid with respect to CreateProjectVersionRequestTestingData
   */
  public static CreateProjectVersionRequestTestingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectVersionRequestTestingData.class);
  }

  /**
   * Convert an instance of CreateProjectVersionRequestTestingData to an JSON string
   *
   * @return JSON string
   */
