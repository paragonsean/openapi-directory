...
public class ValidationData {
  ...
  public ValidationData assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assets, validationData.assets);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidationData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidationData is not found in the empty JSON string", ValidationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationData.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationData>() {
           @Override
           public void write(JsonWriter out, ValidationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidationData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValidationData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValidationData
   * @throws IOException if the JSON string is invalid with respect to ValidationData
   */
  public static ValidationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationData.class);
  }

  /**
   * Convert an instance of ValidationData to an JSON string
   *
   * @return JSON string
   */
