...
/**
 * DetectProtectiveEquipmentRequestImage
 */
...
public class DetectProtectiveEquipmentRequestImage {
  ...
  public DetectProtectiveEquipmentRequestImage() {
  }

  public DetectProtectiveEquipmentRequestImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public DetectProtectiveEquipmentRequestImage s3Object(ImageS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    DetectProtectiveEquipmentRequestImage detectProtectiveEquipmentRequestImage = (DetectProtectiveEquipmentRequestImage) o;
    return Objects.equals(this.bytes, detectProtectiveEquipmentRequestImage.bytes) &&
        Objects.equals(this.s3Object, detectProtectiveEquipmentRequestImage.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectProtectiveEquipmentRequestImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectProtectiveEquipmentRequestImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectProtectiveEquipmentRequestImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectProtectiveEquipmentRequestImage is not found in the empty JSON string", DetectProtectiveEquipmentRequestImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectProtectiveEquipmentRequestImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectProtectiveEquipmentRequestImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectProtectiveEquipmentRequestImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectProtectiveEquipmentRequestImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectProtectiveEquipmentRequestImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectProtectiveEquipmentRequestImage.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectProtectiveEquipmentRequestImage>() {
           @Override
           public void write(JsonWriter out, DetectProtectiveEquipmentRequestImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectProtectiveEquipmentRequestImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectProtectiveEquipmentRequestImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectProtectiveEquipmentRequestImage
   * @throws IOException if the JSON string is invalid with respect to DetectProtectiveEquipmentRequestImage
   */
  public static DetectProtectiveEquipmentRequestImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectProtectiveEquipmentRequestImage.class);
  }

  /**
   * Convert an instance of DetectProtectiveEquipmentRequestImage to an JSON string
   *
   * @return JSON string
   */
