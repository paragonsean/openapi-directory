...
import org.openapitools.client.model.CelebrityRecognitionSortBy;
...
public class GetCelebrityRecognitionRequest {
  ...
  private CelebrityRecognitionSortBy sortBy;

  public GetCelebrityRecognitionRequest() {
  }

  public GetCelebrityRecognitionRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetCelebrityRecognitionRequest maxResults(Integer maxResults) {
  ...
  public GetCelebrityRecognitionRequest nextToken(String nextToken) {
  ...
  public GetCelebrityRecognitionRequest sortBy(CelebrityRecognitionSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CelebrityRecognitionSortBy getSortBy() {
    return sortBy;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCelebrityRecognitionRequest getCelebrityRecognitionRequest = (GetCelebrityRecognitionRequest) o;
    return Objects.equals(this.jobId, getCelebrityRecognitionRequest.jobId) &&
        Objects.equals(this.maxResults, getCelebrityRecognitionRequest.maxResults) &&
        Objects.equals(this.nextToken, getCelebrityRecognitionRequest.nextToken) &&
        Objects.equals(this.sortBy, getCelebrityRecognitionRequest.sortBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCelebrityRecognitionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCelebrityRecognitionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCelebrityRecognitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCelebrityRecognitionRequest is not found in the empty JSON string", GetCelebrityRecognitionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCelebrityRecognitionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCelebrityRecognitionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCelebrityRecognitionRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("SortBy") != null && !jsonObj.get("SortBy").isJsonNull()) {
        CelebrityRecognitionSortBy.validateJsonElement(jsonObj.get("SortBy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCelebrityRecognitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCelebrityRecognitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCelebrityRecognitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCelebrityRecognitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCelebrityRecognitionRequest>() {
           @Override
           public void write(JsonWriter out, GetCelebrityRecognitionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCelebrityRecognitionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCelebrityRecognitionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCelebrityRecognitionRequest
   * @throws IOException if the JSON string is invalid with respect to GetCelebrityRecognitionRequest
   */
  public static GetCelebrityRecognitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCelebrityRecognitionRequest.class);
  }

  /**
   * Convert an instance of GetCelebrityRecognitionRequest to an JSON string
   *
   * @return JSON string
   */
