...
import org.openapitools.client.model.StreamProcessorInputKinesisVideoStream;
...
public class DescribeStreamProcessorResponseInput {
  public static final String SERIALIZED_NAME_KINESIS_VIDEO_STREAM = "KinesisVideoStream";
  @SerializedName(SERIALIZED_NAME_KINESIS_VIDEO_STREAM)
  private StreamProcessorInputKinesisVideoStream kinesisVideoStream;

  public DescribeStreamProcessorResponseInput() {
  }

  public DescribeStreamProcessorResponseInput kinesisVideoStream(StreamProcessorInputKinesisVideoStream kinesisVideoStream) {
  ...
  public StreamProcessorInputKinesisVideoStream getKinesisVideoStream() {
    return kinesisVideoStream;
  }

  public void setKinesisVideoStream(StreamProcessorInputKinesisVideoStream kinesisVideoStream) {
    this.kinesisVideoStream = kinesisVideoStream;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeStreamProcessorResponseInput describeStreamProcessorResponseInput = (DescribeStreamProcessorResponseInput) o;
    return Objects.equals(this.kinesisVideoStream, describeStreamProcessorResponseInput.kinesisVideoStream);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kinesisVideoStream);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeStreamProcessorResponseInput {\n");
    sb.append("    kinesisVideoStream: ").append(toIndentedString(kinesisVideoStream)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("KinesisVideoStream");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeStreamProcessorResponseInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeStreamProcessorResponseInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeStreamProcessorResponseInput is not found in the empty JSON string", DescribeStreamProcessorResponseInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeStreamProcessorResponseInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeStreamProcessorResponseInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `KinesisVideoStream`
      if (jsonObj.get("KinesisVideoStream") != null && !jsonObj.get("KinesisVideoStream").isJsonNull()) {
        StreamProcessorInputKinesisVideoStream.validateJsonElement(jsonObj.get("KinesisVideoStream"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeStreamProcessorResponseInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeStreamProcessorResponseInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeStreamProcessorResponseInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeStreamProcessorResponseInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeStreamProcessorResponseInput>() {
           @Override
           public void write(JsonWriter out, DescribeStreamProcessorResponseInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeStreamProcessorResponseInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeStreamProcessorResponseInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeStreamProcessorResponseInput
   * @throws IOException if the JSON string is invalid with respect to DescribeStreamProcessorResponseInput
   */
  public static DescribeStreamProcessorResponseInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeStreamProcessorResponseInput.class);
  }

  /**
   * Convert an instance of DescribeStreamProcessorResponseInput to an JSON string
   *
   * @return JSON string
   */
