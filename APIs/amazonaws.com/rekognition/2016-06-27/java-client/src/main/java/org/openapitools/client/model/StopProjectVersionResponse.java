...
public class StopProjectVersionResponse {
  ...
  public StopProjectVersionResponse status(ProjectVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StopProjectVersionResponse stopProjectVersionResponse = (StopProjectVersionResponse) o;
    return Objects.equals(this.status, stopProjectVersionResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopProjectVersionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopProjectVersionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopProjectVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopProjectVersionResponse is not found in the empty JSON string", StopProjectVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopProjectVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopProjectVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopProjectVersionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopProjectVersionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopProjectVersionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopProjectVersionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StopProjectVersionResponse>() {
           @Override
           public void write(JsonWriter out, StopProjectVersionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopProjectVersionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopProjectVersionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopProjectVersionResponse
   * @throws IOException if the JSON string is invalid with respect to StopProjectVersionResponse
   */
  public static StopProjectVersionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopProjectVersionResponse.class);
  }

  /**
   * Convert an instance of StopProjectVersionResponse to an JSON string
   *
   * @return JSON string
   */
