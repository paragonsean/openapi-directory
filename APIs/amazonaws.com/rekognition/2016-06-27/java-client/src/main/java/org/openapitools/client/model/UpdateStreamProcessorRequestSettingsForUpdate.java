...
import org.openapitools.client.model.StreamProcessorSettingsForUpdateConnectedHomeForUpdate;
...
public class UpdateStreamProcessorRequestSettingsForUpdate {
  public static final String SERIALIZED_NAME_CONNECTED_HOME_FOR_UPDATE = "ConnectedHomeForUpdate";
  @SerializedName(SERIALIZED_NAME_CONNECTED_HOME_FOR_UPDATE)
  private StreamProcessorSettingsForUpdateConnectedHomeForUpdate connectedHomeForUpdate;

  public UpdateStreamProcessorRequestSettingsForUpdate() {
  }

  public UpdateStreamProcessorRequestSettingsForUpdate connectedHomeForUpdate(StreamProcessorSettingsForUpdateConnectedHomeForUpdate connectedHomeForUpdate) {
    this.connectedHomeForUpdate = connectedHomeForUpdate;
    return this;
  }

  /**
   * Get connectedHomeForUpdate
   * @return connectedHomeForUpdate
   */
  @javax.annotation.Nullable
  public StreamProcessorSettingsForUpdateConnectedHomeForUpdate getConnectedHomeForUpdate() {
    return connectedHomeForUpdate;
  }

  public void setConnectedHomeForUpdate(StreamProcessorSettingsForUpdateConnectedHomeForUpdate connectedHomeForUpdate) {
    this.connectedHomeForUpdate = connectedHomeForUpdate;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateStreamProcessorRequestSettingsForUpdate updateStreamProcessorRequestSettingsForUpdate = (UpdateStreamProcessorRequestSettingsForUpdate) o;
    return Objects.equals(this.connectedHomeForUpdate, updateStreamProcessorRequestSettingsForUpdate.connectedHomeForUpdate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectedHomeForUpdate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateStreamProcessorRequestSettingsForUpdate {\n");
    sb.append("    connectedHomeForUpdate: ").append(toIndentedString(connectedHomeForUpdate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ConnectedHomeForUpdate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateStreamProcessorRequestSettingsForUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateStreamProcessorRequestSettingsForUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateStreamProcessorRequestSettingsForUpdate is not found in the empty JSON string", UpdateStreamProcessorRequestSettingsForUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateStreamProcessorRequestSettingsForUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateStreamProcessorRequestSettingsForUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ConnectedHomeForUpdate`
      if (jsonObj.get("ConnectedHomeForUpdate") != null && !jsonObj.get("ConnectedHomeForUpdate").isJsonNull()) {
        StreamProcessorSettingsForUpdateConnectedHomeForUpdate.validateJsonElement(jsonObj.get("ConnectedHomeForUpdate"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateStreamProcessorRequestSettingsForUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateStreamProcessorRequestSettingsForUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateStreamProcessorRequestSettingsForUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateStreamProcessorRequestSettingsForUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateStreamProcessorRequestSettingsForUpdate>() {
           @Override
           public void write(JsonWriter out, UpdateStreamProcessorRequestSettingsForUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateStreamProcessorRequestSettingsForUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateStreamProcessorRequestSettingsForUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateStreamProcessorRequestSettingsForUpdate
   * @throws IOException if the JSON string is invalid with respect to UpdateStreamProcessorRequestSettingsForUpdate
   */
  public static UpdateStreamProcessorRequestSettingsForUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateStreamProcessorRequestSettingsForUpdate.class);
  }

  /**
   * Convert an instance of UpdateStreamProcessorRequestSettingsForUpdate to an JSON string
   *
   * @return JSON string
   */
