...
/**
 * StartFaceDetectionRequestNotificationChannel
 */
...
public class StartFaceDetectionRequestNotificationChannel {
  ...
  public StartFaceDetectionRequestNotificationChannel() {
  }

  public StartFaceDetectionRequestNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public StartFaceDetectionRequestNotificationChannel roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartFaceDetectionRequestNotificationChannel startFaceDetectionRequestNotificationChannel = (StartFaceDetectionRequestNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, startFaceDetectionRequestNotificationChannel.snSTopicArn) &&
        Objects.equals(this.roleArn, startFaceDetectionRequestNotificationChannel.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFaceDetectionRequestNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFaceDetectionRequestNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFaceDetectionRequestNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFaceDetectionRequestNotificationChannel is not found in the empty JSON string", StartFaceDetectionRequestNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFaceDetectionRequestNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFaceDetectionRequestNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartFaceDetectionRequestNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFaceDetectionRequestNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFaceDetectionRequestNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFaceDetectionRequestNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFaceDetectionRequestNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFaceDetectionRequestNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StartFaceDetectionRequestNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFaceDetectionRequestNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFaceDetectionRequestNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFaceDetectionRequestNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StartFaceDetectionRequestNotificationChannel
   */
  public static StartFaceDetectionRequestNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFaceDetectionRequestNotificationChannel.class);
  }

  /**
   * Convert an instance of StartFaceDetectionRequestNotificationChannel to an JSON string
   *
   * @return JSON string
   */
