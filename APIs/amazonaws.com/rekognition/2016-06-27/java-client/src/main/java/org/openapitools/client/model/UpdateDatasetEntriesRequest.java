...
import org.openapitools.client.model.UpdateDatasetEntriesRequestChanges;
...
public class UpdateDatasetEntriesRequest {
  ...
  private UpdateDatasetEntriesRequestChanges changes;

  public UpdateDatasetEntriesRequest() {
  }

  public UpdateDatasetEntriesRequest datasetArn(String datasetArn) {
  ...
  public UpdateDatasetEntriesRequest changes(UpdateDatasetEntriesRequestChanges changes) {
   ...
   */
  @javax.annotation.Nonnull
  public UpdateDatasetEntriesRequestChanges getChanges() {
    return changes;
  }

  public void setChanges(UpdateDatasetEntriesRequestChanges changes) {
    this.changes = changes;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateDatasetEntriesRequest updateDatasetEntriesRequest = (UpdateDatasetEntriesRequest) o;
    return Objects.equals(this.datasetArn, updateDatasetEntriesRequest.datasetArn) &&
        Objects.equals(this.changes, updateDatasetEntriesRequest.changes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datasetArn, changes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateDatasetEntriesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDatasetEntriesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDatasetEntriesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDatasetEntriesRequest is not found in the empty JSON string", UpdateDatasetEntriesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDatasetEntriesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDatasetEntriesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDatasetEntriesRequest.openapiRequiredFields) {
      ...
      UpdateDatasetEntriesRequestChanges.validateJsonElement(jsonObj.get("Changes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDatasetEntriesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDatasetEntriesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDatasetEntriesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDatasetEntriesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDatasetEntriesRequest>() {
           @Override
           public void write(JsonWriter out, UpdateDatasetEntriesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDatasetEntriesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDatasetEntriesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDatasetEntriesRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateDatasetEntriesRequest
   */
  public static UpdateDatasetEntriesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDatasetEntriesRequest.class);
  }

  /**
   * Convert an instance of UpdateDatasetEntriesRequest to an JSON string
   *
   * @return JSON string
   */
