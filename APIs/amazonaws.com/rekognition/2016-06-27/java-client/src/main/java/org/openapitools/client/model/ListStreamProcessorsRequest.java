...
public class ListStreamProcessorsRequest {
  ...
  public ListStreamProcessorsRequest nextToken(String nextToken) {
  ...
  public ListStreamProcessorsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListStreamProcessorsRequest listStreamProcessorsRequest = (ListStreamProcessorsRequest) o;
    return Objects.equals(this.nextToken, listStreamProcessorsRequest.nextToken) &&
        Objects.equals(this.maxResults, listStreamProcessorsRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListStreamProcessorsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStreamProcessorsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStreamProcessorsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStreamProcessorsRequest is not found in the empty JSON string", ListStreamProcessorsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStreamProcessorsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStreamProcessorsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStreamProcessorsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStreamProcessorsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStreamProcessorsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStreamProcessorsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStreamProcessorsRequest>() {
           @Override
           public void write(JsonWriter out, ListStreamProcessorsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStreamProcessorsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStreamProcessorsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStreamProcessorsRequest
   * @throws IOException if the JSON string is invalid with respect to ListStreamProcessorsRequest
   */
  public static ListStreamProcessorsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStreamProcessorsRequest.class);
  }

  /**
   * Convert an instance of ListStreamProcessorsRequest to an JSON string
   *
   * @return JSON string
   */
