...
public class PersonMatchPerson {
  ...
  public PersonMatchPerson() {
  }

  public PersonMatchPerson index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public PersonMatchPerson boundingBox(PersonDetailBoundingBox boundingBox) {
  ...
  public PersonMatchPerson face(PersonDetailFace face) {
    this.face = face;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersonMatchPerson personMatchPerson = (PersonMatchPerson) o;
    return Objects.equals(this.index, personMatchPerson.index) &&
        Objects.equals(this.boundingBox, personMatchPerson.boundingBox) &&
        Objects.equals(this.face, personMatchPerson.face);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonMatchPerson {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonMatchPerson
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonMatchPerson.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonMatchPerson is not found in the empty JSON string", PersonMatchPerson.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonMatchPerson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonMatchPerson` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonMatchPerson.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonMatchPerson' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonMatchPerson> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonMatchPerson.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonMatchPerson>() {
           @Override
           public void write(JsonWriter out, PersonMatchPerson value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonMatchPerson read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonMatchPerson given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonMatchPerson
   * @throws IOException if the JSON string is invalid with respect to PersonMatchPerson
   */
  public static PersonMatchPerson fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonMatchPerson.class);
  }

  /**
   * Convert an instance of PersonMatchPerson to an JSON string
   *
   * @return JSON string
   */
