...
public class ModerationLabel {
  ...
  public ModerationLabel confidence(Float confidence) {
  ...
  public ModerationLabel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ModerationLabel parentName(String parentName) {
  ...
  public boolean equals(Object o) {
    ...
    ModerationLabel moderationLabel = (ModerationLabel) o;
    return Objects.equals(this.confidence, moderationLabel.confidence) &&
        Objects.equals(this.name, moderationLabel.name) &&
        Objects.equals(this.parentName, moderationLabel.parentName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModerationLabel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModerationLabel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModerationLabel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModerationLabel is not found in the empty JSON string", ModerationLabel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModerationLabel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModerationLabel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModerationLabel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModerationLabel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModerationLabel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModerationLabel.class));

       return (TypeAdapter<T>) new TypeAdapter<ModerationLabel>() {
           @Override
           public void write(JsonWriter out, ModerationLabel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModerationLabel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModerationLabel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModerationLabel
   * @throws IOException if the JSON string is invalid with respect to ModerationLabel
   */
  public static ModerationLabel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModerationLabel.class);
  }

  /**
   * Convert an instance of ModerationLabel to an JSON string
   *
   * @return JSON string
   */
