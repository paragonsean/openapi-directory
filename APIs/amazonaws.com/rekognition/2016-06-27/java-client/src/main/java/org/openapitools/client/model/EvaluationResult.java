...
import org.openapitools.client.model.EvaluationResultSummary;
...
public class EvaluationResult {
  ...
  private EvaluationResultSummary summary;

  public EvaluationResult() {
  }

  public EvaluationResult f1Score(Float f1Score) {
  ...
  public EvaluationResult summary(EvaluationResultSummary summary) {
   ...
   */
  @javax.annotation.Nullable
  public EvaluationResultSummary getSummary() {
    return summary;
  }

  public void setSummary(EvaluationResultSummary summary) {
    this.summary = summary;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.f1Score, evaluationResult.f1Score) &&
        Objects.equals(this.summary, evaluationResult.summary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(f1Score, summary);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Summary") != null && !jsonObj.get("Summary").isJsonNull()) {
        EvaluationResultSummary.validateJsonElement(jsonObj.get("Summary"));
      }
  }
