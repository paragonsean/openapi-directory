...
public class CopyProjectVersionRequestOutputConfig {
  ...
  public CopyProjectVersionRequestOutputConfig() {
  }

  public CopyProjectVersionRequestOutputConfig s3Bucket(String s3Bucket) {
  ...
  public CopyProjectVersionRequestOutputConfig s3KeyPrefix(String s3KeyPrefix) {
  ...
  public boolean equals(Object o) {
    ...
    CopyProjectVersionRequestOutputConfig copyProjectVersionRequestOutputConfig = (CopyProjectVersionRequestOutputConfig) o;
    return Objects.equals(this.s3Bucket, copyProjectVersionRequestOutputConfig.s3Bucket) &&
        Objects.equals(this.s3KeyPrefix, copyProjectVersionRequestOutputConfig.s3KeyPrefix);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopyProjectVersionRequestOutputConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyProjectVersionRequestOutputConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyProjectVersionRequestOutputConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyProjectVersionRequestOutputConfig is not found in the empty JSON string", CopyProjectVersionRequestOutputConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyProjectVersionRequestOutputConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyProjectVersionRequestOutputConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyProjectVersionRequestOutputConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyProjectVersionRequestOutputConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyProjectVersionRequestOutputConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyProjectVersionRequestOutputConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyProjectVersionRequestOutputConfig>() {
           @Override
           public void write(JsonWriter out, CopyProjectVersionRequestOutputConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyProjectVersionRequestOutputConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyProjectVersionRequestOutputConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyProjectVersionRequestOutputConfig
   * @throws IOException if the JSON string is invalid with respect to CopyProjectVersionRequestOutputConfig
   */
  public static CopyProjectVersionRequestOutputConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyProjectVersionRequestOutputConfig.class);
  }

  /**
   * Convert an instance of CopyProjectVersionRequestOutputConfig to an JSON string
   *
   * @return JSON string
   */
