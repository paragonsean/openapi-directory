...
/**
 * Gets or Sets LandmarkType
 */
@JsonAdapter(LandmarkType.Adapter.class)
public enum LandmarkType {
  ...
  public static LandmarkType fromValue(String value) {
    for (LandmarkType b : LandmarkType.values()) {
  ...
  public static class Adapter extends TypeAdapter<LandmarkType> {
    @Override
    public void write(final JsonWriter jsonWriter, final LandmarkType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LandmarkType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LandmarkType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LandmarkType.fromValue(value);
  }
}
