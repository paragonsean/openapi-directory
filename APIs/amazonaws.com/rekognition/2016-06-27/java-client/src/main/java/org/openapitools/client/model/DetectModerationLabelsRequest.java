...
public class DetectModerationLabelsRequest {
  ...
  private DetectModerationLabelsRequestHumanLoopConfig humanLoopConfig;

  public DetectModerationLabelsRequest() {
  }

  public DetectModerationLabelsRequest image(CompareFacesRequestSourceImage image) {
    this.image = image;
    return this;
  }
  ...
  public DetectModerationLabelsRequest minConfidence(Float minConfidence) {
  ...
  public DetectModerationLabelsRequest humanLoopConfig(DetectModerationLabelsRequestHumanLoopConfig humanLoopConfig) {
   ...
   */
  @javax.annotation.Nullable
  public DetectModerationLabelsRequestHumanLoopConfig getHumanLoopConfig() {
    return humanLoopConfig;
  }

  public void setHumanLoopConfig(DetectModerationLabelsRequestHumanLoopConfig humanLoopConfig) {
    this.humanLoopConfig = humanLoopConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectModerationLabelsRequest detectModerationLabelsRequest = (DetectModerationLabelsRequest) o;
    return Objects.equals(this.image, detectModerationLabelsRequest.image) &&
        Objects.equals(this.minConfidence, detectModerationLabelsRequest.minConfidence) &&
        Objects.equals(this.humanLoopConfig, detectModerationLabelsRequest.humanLoopConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(image, minConfidence, humanLoopConfig);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectModerationLabelsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectModerationLabelsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectModerationLabelsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectModerationLabelsRequest is not found in the empty JSON string", DetectModerationLabelsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectModerationLabelsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectModerationLabelsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectModerationLabelsRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("HumanLoopConfig") != null && !jsonObj.get("HumanLoopConfig").isJsonNull()) {
        DetectModerationLabelsRequestHumanLoopConfig.validateJsonElement(jsonObj.get("HumanLoopConfig"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectModerationLabelsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectModerationLabelsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectModerationLabelsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectModerationLabelsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectModerationLabelsRequest>() {
           @Override
           public void write(JsonWriter out, DetectModerationLabelsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectModerationLabelsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectModerationLabelsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectModerationLabelsRequest
   * @throws IOException if the JSON string is invalid with respect to DetectModerationLabelsRequest
   */
  public static DetectModerationLabelsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectModerationLabelsRequest.class);
  }

  /**
   * Convert an instance of DetectModerationLabelsRequest to an JSON string
   *
   * @return JSON string
   */
