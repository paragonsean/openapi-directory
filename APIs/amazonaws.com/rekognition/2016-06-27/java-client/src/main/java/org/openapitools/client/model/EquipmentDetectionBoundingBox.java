...
public class EquipmentDetectionBoundingBox {
  ...
  public EquipmentDetectionBoundingBox() {
  }

  public EquipmentDetectionBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public EquipmentDetectionBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public EquipmentDetectionBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public EquipmentDetectionBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EquipmentDetectionBoundingBox equipmentDetectionBoundingBox = (EquipmentDetectionBoundingBox) o;
    return Objects.equals(this.width, equipmentDetectionBoundingBox.width) &&
        Objects.equals(this.height, equipmentDetectionBoundingBox.height) &&
        Objects.equals(this.left, equipmentDetectionBoundingBox.left) &&
        Objects.equals(this.top, equipmentDetectionBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class EquipmentDetectionBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EquipmentDetectionBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EquipmentDetectionBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EquipmentDetectionBoundingBox is not found in the empty JSON string", EquipmentDetectionBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EquipmentDetectionBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EquipmentDetectionBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EquipmentDetectionBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EquipmentDetectionBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EquipmentDetectionBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EquipmentDetectionBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<EquipmentDetectionBoundingBox>() {
           @Override
           public void write(JsonWriter out, EquipmentDetectionBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EquipmentDetectionBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EquipmentDetectionBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EquipmentDetectionBoundingBox
   * @throws IOException if the JSON string is invalid with respect to EquipmentDetectionBoundingBox
   */
  public static EquipmentDetectionBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EquipmentDetectionBoundingBox.class);
  }

  /**
   * Convert an instance of EquipmentDetectionBoundingBox to an JSON string
   *
   * @return JSON string
   */
