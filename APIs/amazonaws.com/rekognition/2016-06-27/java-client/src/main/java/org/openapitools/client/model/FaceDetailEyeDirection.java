...
public class FaceDetailEyeDirection {
  ...
  public FaceDetailEyeDirection() {
  }

  public FaceDetailEyeDirection yaw(Float yaw) {
    this.yaw = yaw;
    return this;
  }
  ...
  public FaceDetailEyeDirection pitch(Float pitch) {
    this.pitch = pitch;
    return this;
  }
  ...
  public FaceDetailEyeDirection confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailEyeDirection faceDetailEyeDirection = (FaceDetailEyeDirection) o;
    return Objects.equals(this.yaw, faceDetailEyeDirection.yaw) &&
        Objects.equals(this.pitch, faceDetailEyeDirection.pitch) &&
        Objects.equals(this.confidence, faceDetailEyeDirection.confidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(yaw, pitch, confidence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FaceDetailEyeDirection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailEyeDirection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailEyeDirection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailEyeDirection is not found in the empty JSON string", FaceDetailEyeDirection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailEyeDirection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailEyeDirection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailEyeDirection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailEyeDirection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailEyeDirection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailEyeDirection.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailEyeDirection>() {
           @Override
           public void write(JsonWriter out, FaceDetailEyeDirection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailEyeDirection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailEyeDirection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailEyeDirection
   * @throws IOException if the JSON string is invalid with respect to FaceDetailEyeDirection
   */
  public static FaceDetailEyeDirection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailEyeDirection.class);
  }

  /**
   * Convert an instance of FaceDetailEyeDirection to an JSON string
   *
   * @return JSON string
   */
