...
import org.openapitools.client.model.StartLabelDetectionRequestNotificationChannel;
import org.openapitools.client.model.StartLabelDetectionRequestSettings;
import org.openapitools.client.model.StartLabelDetectionRequestVideo;
...
public class StartLabelDetectionRequest {
  ...
  private StartLabelDetectionRequestVideo video;
  ...
  private StartLabelDetectionRequestNotificationChannel notificationChannel;
  ...
  private StartLabelDetectionRequestSettings settings;

  public StartLabelDetectionRequest() {
  }

  public StartLabelDetectionRequest video(StartLabelDetectionRequestVideo video) {
    this.video = video;
    return this;
  }
  ...
  public StartLabelDetectionRequestVideo getVideo() {
    return video;
  }

  public void setVideo(StartLabelDetectionRequestVideo video) {
    this.video = video;
  }


  public StartLabelDetectionRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartLabelDetectionRequest minConfidence(Float minConfidence) {
  ...
  public StartLabelDetectionRequest notificationChannel(StartLabelDetectionRequestNotificationChannel notificationChannel) {
   ...
   */
  @javax.annotation.Nullable
  public StartLabelDetectionRequestNotificationChannel getNotificationChannel() {
    return notificationChannel;
  }

  public void setNotificationChannel(StartLabelDetectionRequestNotificationChannel notificationChannel) {
    this.notificationChannel = notificationChannel;
  }


  public StartLabelDetectionRequest jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public StartLabelDetectionRequest features(List features) {
  ...
  public StartLabelDetectionRequest settings(StartLabelDetectionRequestSettings settings) {
   ...
   */
  @javax.annotation.Nullable
  public StartLabelDetectionRequestSettings getSettings() {
    return settings;
  }

  public void setSettings(StartLabelDetectionRequestSettings settings) {
    this.settings = settings;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartLabelDetectionRequest startLabelDetectionRequest = (StartLabelDetectionRequest) o;
    return Objects.equals(this.video, startLabelDetectionRequest.video) &&
        Objects.equals(this.clientRequestToken, startLabelDetectionRequest.clientRequestToken) &&
        Objects.equals(this.minConfidence, startLabelDetectionRequest.minConfidence) &&
        Objects.equals(this.notificationChannel, startLabelDetectionRequest.notificationChannel) &&
        Objects.equals(this.jobTag, startLabelDetectionRequest.jobTag) &&
        Objects.equals(this.features, startLabelDetectionRequest.features) &&
        Objects.equals(this.settings, startLabelDetectionRequest.settings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(video, clientRequestToken, minConfidence, notificationChannel, jobTag, features, settings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartLabelDetectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartLabelDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartLabelDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartLabelDetectionRequest is not found in the empty JSON string", StartLabelDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartLabelDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartLabelDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartLabelDetectionRequest.openapiRequiredFields) {
      ...
      StartLabelDetectionRequestVideo.validateJsonElement(jsonObj.get("Video"));
      ...
      if (jsonObj.get("NotificationChannel") != null && !jsonObj.get("NotificationChannel").isJsonNull()) {
        StartLabelDetectionRequestNotificationChannel.validateJsonElement(jsonObj.get("NotificationChannel"));
      }
      ...
      if (jsonObj.get("Settings") != null && !jsonObj.get("Settings").isJsonNull()) {
        StartLabelDetectionRequestSettings.validateJsonElement(jsonObj.get("Settings"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartLabelDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartLabelDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartLabelDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartLabelDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartLabelDetectionRequest>() {
           @Override
           public void write(JsonWriter out, StartLabelDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartLabelDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartLabelDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartLabelDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to StartLabelDetectionRequest
   */
  public static StartLabelDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartLabelDetectionRequest.class);
  }

  /**
   * Convert an instance of StartLabelDetectionRequest to an JSON string
   *
   * @return JSON string
   */
