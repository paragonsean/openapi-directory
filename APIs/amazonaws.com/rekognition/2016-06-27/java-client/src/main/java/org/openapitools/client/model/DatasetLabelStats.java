...
public class DatasetLabelStats {
  ...
  public static final String SERIALIZED_NAME_BOUNDING_BOX_COUNT = "BoundingBoxCount";
  @SerializedName(SERIALIZED_NAME_BOUNDING_BOX_COUNT)
  private Integer boundingBoxCount;

  public DatasetLabelStats() {
  }

  public DatasetLabelStats entryCount(Integer entryCount) {
  ...
  public DatasetLabelStats boundingBoxCount(Integer boundingBoxCount) {
    this.boundingBoxCount = boundingBoxCount;
    return this;
  }

  /**
   * Get boundingBoxCount
  ...
  public boolean equals(Object o) {
    ...
    DatasetLabelStats datasetLabelStats = (DatasetLabelStats) o;
    return Objects.equals(this.entryCount, datasetLabelStats.entryCount) &&
        Objects.equals(this.boundingBoxCount, datasetLabelStats.boundingBoxCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entryCount, boundingBoxCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatasetLabelStats {\n");
    sb.append("    entryCount: ").append(toIndentedString(entryCount)).append("\n");
    sb.append("    boundingBoxCount: ").append(toIndentedString(boundingBoxCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("BoundingBoxCount");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetLabelStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetLabelStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetLabelStats is not found in the empty JSON string", DatasetLabelStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetLabelStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetLabelStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `EntryCount`
      if (jsonObj.get("EntryCount") != null && !jsonObj.get("EntryCount").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("EntryCount"));
      }
      // validate the optional field `BoundingBoxCount`
      if (jsonObj.get("BoundingBoxCount") != null && !jsonObj.get("BoundingBoxCount").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("BoundingBoxCount"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetLabelStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetLabelStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetLabelStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetLabelStats.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetLabelStats>() {
           @Override
           public void write(JsonWriter out, DatasetLabelStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetLabelStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetLabelStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetLabelStats
   * @throws IOException if the JSON string is invalid with respect to DatasetLabelStats
   */
  public static DatasetLabelStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetLabelStats.class);
  }

  /**
   * Convert an instance of DatasetLabelStats to an JSON string
   *
   * @return JSON string
   */
