...
/**
 * CreateProjectVersionRequestTrainingData
 */
...
public class CreateProjectVersionRequestTrainingData {
  public static final String SERIALIZED_NAME_ASSETS = "Assets";
  @SerializedName(SERIALIZED_NAME_ASSETS)
  private List assets;

  public CreateProjectVersionRequestTrainingData() {
  }

  public CreateProjectVersionRequestTrainingData assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectVersionRequestTrainingData createProjectVersionRequestTrainingData = (CreateProjectVersionRequestTrainingData) o;
    return Objects.equals(this.assets, createProjectVersionRequestTrainingData.assets);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectVersionRequestTrainingData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectVersionRequestTrainingData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectVersionRequestTrainingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectVersionRequestTrainingData is not found in the empty JSON string", CreateProjectVersionRequestTrainingData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectVersionRequestTrainingData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectVersionRequestTrainingData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectVersionRequestTrainingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectVersionRequestTrainingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectVersionRequestTrainingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectVersionRequestTrainingData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectVersionRequestTrainingData>() {
           @Override
           public void write(JsonWriter out, CreateProjectVersionRequestTrainingData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectVersionRequestTrainingData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectVersionRequestTrainingData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectVersionRequestTrainingData
   * @throws IOException if the JSON string is invalid with respect to CreateProjectVersionRequestTrainingData
   */
  public static CreateProjectVersionRequestTrainingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectVersionRequestTrainingData.class);
  }

  /**
   * Convert an instance of CreateProjectVersionRequestTrainingData to an JSON string
   *
   * @return JSON string
   */
