...
public class DetectLabelsImageQuality {
  ...
  public DetectLabelsImageQuality brightness(Float brightness) {
  ...
  public DetectLabelsImageQuality sharpness(Float sharpness) {
  ...
  public DetectLabelsImageQuality contrast(Float contrast) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImageQuality detectLabelsImageQuality = (DetectLabelsImageQuality) o;
    return Objects.equals(this.brightness, detectLabelsImageQuality.brightness) &&
        Objects.equals(this.sharpness, detectLabelsImageQuality.sharpness) &&
        Objects.equals(this.contrast, detectLabelsImageQuality.contrast);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsImageQuality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImageQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImageQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImageQuality is not found in the empty JSON string", DetectLabelsImageQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImageQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImageQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImageQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImageQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImageQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImageQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImageQuality>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImageQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImageQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImageQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImageQuality
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImageQuality
   */
  public static DetectLabelsImageQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImageQuality.class);
  }

  /**
   * Convert an instance of DetectLabelsImageQuality to an JSON string
   *
   * @return JSON string
   */
