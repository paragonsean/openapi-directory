...
public class DetectModerationLabelsResponse {
  ...
  private DetectModerationLabelsResponseHumanLoopActivationOutput humanLoopActivationOutput;

  public DetectModerationLabelsResponse() {
  }

  public DetectModerationLabelsResponse moderationLabels(List moderationLabels) {
  ...
  public DetectModerationLabelsResponse moderationModelVersion(String moderationModelVersion) {
  ...
  public DetectModerationLabelsResponse humanLoopActivationOutput(DetectModerationLabelsResponseHumanLoopActivationOutput humanLoopActivationOutput) {
   ...
   */
  @javax.annotation.Nullable
  public DetectModerationLabelsResponseHumanLoopActivationOutput getHumanLoopActivationOutput() {
    return humanLoopActivationOutput;
  }

  public void setHumanLoopActivationOutput(DetectModerationLabelsResponseHumanLoopActivationOutput humanLoopActivationOutput) {
    this.humanLoopActivationOutput = humanLoopActivationOutput;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectModerationLabelsResponse detectModerationLabelsResponse = (DetectModerationLabelsResponse) o;
    return Objects.equals(this.moderationLabels, detectModerationLabelsResponse.moderationLabels) &&
        Objects.equals(this.moderationModelVersion, detectModerationLabelsResponse.moderationModelVersion) &&
        Objects.equals(this.humanLoopActivationOutput, detectModerationLabelsResponse.humanLoopActivationOutput);
  }

  @Override
  public int hashCode() {
    return Objects.hash(moderationLabels, moderationModelVersion, humanLoopActivationOutput);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectModerationLabelsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectModerationLabelsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectModerationLabelsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectModerationLabelsResponse is not found in the empty JSON string", DetectModerationLabelsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectModerationLabelsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectModerationLabelsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("HumanLoopActivationOutput") != null && !jsonObj.get("HumanLoopActivationOutput").isJsonNull()) {
        DetectModerationLabelsResponseHumanLoopActivationOutput.validateJsonElement(jsonObj.get("HumanLoopActivationOutput"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectModerationLabelsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectModerationLabelsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectModerationLabelsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectModerationLabelsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectModerationLabelsResponse>() {
           @Override
           public void write(JsonWriter out, DetectModerationLabelsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectModerationLabelsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectModerationLabelsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectModerationLabelsResponse
   * @throws IOException if the JSON string is invalid with respect to DetectModerationLabelsResponse
   */
  public static DetectModerationLabelsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectModerationLabelsResponse.class);
  }

  /**
   * Convert an instance of DetectModerationLabelsResponse to an JSON string
   *
   * @return JSON string
   */
