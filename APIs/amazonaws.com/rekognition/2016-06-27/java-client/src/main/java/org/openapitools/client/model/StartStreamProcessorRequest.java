...
public class StartStreamProcessorRequest {
  ...
  public static final String SERIALIZED_NAME_START_SELECTOR = "StartSelector";
  @SerializedName(SERIALIZED_NAME_START_SELECTOR)
  private StartStreamProcessorRequestStartSelector startSelector;

  public static final String SERIALIZED_NAME_STOP_SELECTOR = "StopSelector";
  @SerializedName(SERIALIZED_NAME_STOP_SELECTOR)
  private StartStreamProcessorRequestStopSelector stopSelector;

  public StartStreamProcessorRequest() {
  }

  public StartStreamProcessorRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StartStreamProcessorRequest startSelector(StartStreamProcessorRequestStartSelector startSelector) {
  ...
  public StartStreamProcessorRequestStartSelector getStartSelector() {
    return startSelector;
  }

  public void setStartSelector(StartStreamProcessorRequestStartSelector startSelector) {
    this.startSelector = startSelector;
  }


  public StartStreamProcessorRequest stopSelector(StartStreamProcessorRequestStopSelector stopSelector) {
   ...
   */
  @javax.annotation.Nullable
  public StartStreamProcessorRequestStopSelector getStopSelector() {
    return stopSelector;
  }

  public void setStopSelector(StartStreamProcessorRequestStopSelector stopSelector) {
    this.stopSelector = stopSelector;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartStreamProcessorRequest startStreamProcessorRequest = (StartStreamProcessorRequest) o;
    return Objects.equals(this.name, startStreamProcessorRequest.name) &&
        Objects.equals(this.startSelector, startStreamProcessorRequest.startSelector) &&
        Objects.equals(this.stopSelector, startStreamProcessorRequest.stopSelector);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, startSelector, stopSelector);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartStreamProcessorRequest {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    startSelector: ").append(toIndentedString(startSelector)).append("\n");
    sb.append("    stopSelector: ").append(toIndentedString(stopSelector)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("StartSelector");
    openapiFields.add("StopSelector");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartStreamProcessorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartStreamProcessorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartStreamProcessorRequest is not found in the empty JSON string", StartStreamProcessorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartStreamProcessorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartStreamProcessorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartStreamProcessorRequest.openapiRequiredFields) {
      ...
      // validate the optional field `StartSelector`
      if (jsonObj.get("StartSelector") != null && !jsonObj.get("StartSelector").isJsonNull()) {
        StartStreamProcessorRequestStartSelector.validateJsonElement(jsonObj.get("StartSelector"));
      }
      // validate the optional field `StopSelector`
      if (jsonObj.get("StopSelector") != null && !jsonObj.get("StopSelector").isJsonNull()) {
        StartStreamProcessorRequestStopSelector.validateJsonElement(jsonObj.get("StopSelector"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartStreamProcessorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartStreamProcessorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartStreamProcessorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartStreamProcessorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartStreamProcessorRequest>() {
           @Override
           public void write(JsonWriter out, StartStreamProcessorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartStreamProcessorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartStreamProcessorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartStreamProcessorRequest
   * @throws IOException if the JSON string is invalid with respect to StartStreamProcessorRequest
   */
  public static StartStreamProcessorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartStreamProcessorRequest.class);
  }

  /**
   * Convert an instance of StartStreamProcessorRequest to an JSON string
   *
   * @return JSON string
   */
