...
public class SearchUsersResponseSearchedFace {
  public static final String SERIALIZED_NAME_FACE_ID = "FaceId";
  @SerializedName(SERIALIZED_NAME_FACE_ID)
  private String faceId;

  public SearchUsersResponseSearchedFace() {
  }

  public SearchUsersResponseSearchedFace faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchUsersResponseSearchedFace searchUsersResponseSearchedFace = (SearchUsersResponseSearchedFace) o;
    return Objects.equals(this.faceId, searchUsersResponseSearchedFace.faceId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchUsersResponseSearchedFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchUsersResponseSearchedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchUsersResponseSearchedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchUsersResponseSearchedFace is not found in the empty JSON string", SearchUsersResponseSearchedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchUsersResponseSearchedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchUsersResponseSearchedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchUsersResponseSearchedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchUsersResponseSearchedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchUsersResponseSearchedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchUsersResponseSearchedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchUsersResponseSearchedFace>() {
           @Override
           public void write(JsonWriter out, SearchUsersResponseSearchedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchUsersResponseSearchedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchUsersResponseSearchedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchUsersResponseSearchedFace
   * @throws IOException if the JSON string is invalid with respect to SearchUsersResponseSearchedFace
   */
  public static SearchUsersResponseSearchedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchUsersResponseSearchedFace.class);
  }

  /**
   * Convert an instance of SearchUsersResponseSearchedFace to an JSON string
   *
   * @return JSON string
   */
