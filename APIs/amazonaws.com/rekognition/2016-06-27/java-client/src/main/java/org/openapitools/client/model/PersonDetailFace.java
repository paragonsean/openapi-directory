...
public class PersonDetailFace {
  ...
  public PersonDetailFace() {
  }

  public PersonDetailFace boundingBox(FaceDetailBoundingBox boundingBox) {
  ...
  public PersonDetailFace ageRange(FaceDetailAgeRange ageRange) {
  ...
  public PersonDetailFace smile(FaceDetailSmile smile) {
    this.smile = smile;
    return this;
  }
  ...
  public PersonDetailFace eyeglasses(FaceDetailEyeglasses eyeglasses) {
  ...
  public PersonDetailFace sunglasses(FaceDetailSunglasses sunglasses) {
  ...
  public PersonDetailFace gender(FaceDetailGender gender) {
    this.gender = gender;
    return this;
  }
  ...
  public PersonDetailFace beard(FaceDetailBeard beard) {
    this.beard = beard;
    return this;
  }
  ...
  public PersonDetailFace mustache(FaceDetailMustache mustache) {
  ...
  public PersonDetailFace eyesOpen(FaceDetailEyesOpen eyesOpen) {
  ...
  public PersonDetailFace mouthOpen(FaceDetailMouthOpen mouthOpen) {
  ...
  public PersonDetailFace emotions(List emotions) {
  ...
  public PersonDetailFace landmarks(List landmarks) {
  ...
  public PersonDetailFace pose(FaceDetailPose pose) {
    this.pose = pose;
    return this;
  }
  ...
  public PersonDetailFace quality(FaceDetailQuality quality) {
  ...
  public PersonDetailFace confidence(Float confidence) {
  ...
  public PersonDetailFace faceOccluded(FaceDetailFaceOccluded faceOccluded) {
  ...
  public PersonDetailFace eyeDirection(FaceDetailEyeDirection eyeDirection) {
  ...
  public boolean equals(Object o) {
    ...
    PersonDetailFace personDetailFace = (PersonDetailFace) o;
    return Objects.equals(this.boundingBox, personDetailFace.boundingBox) &&
        Objects.equals(this.ageRange, personDetailFace.ageRange) &&
        Objects.equals(this.smile, personDetailFace.smile) &&
        Objects.equals(this.eyeglasses, personDetailFace.eyeglasses) &&
        Objects.equals(this.sunglasses, personDetailFace.sunglasses) &&
        Objects.equals(this.gender, personDetailFace.gender) &&
        Objects.equals(this.beard, personDetailFace.beard) &&
        Objects.equals(this.mustache, personDetailFace.mustache) &&
        Objects.equals(this.eyesOpen, personDetailFace.eyesOpen) &&
        Objects.equals(this.mouthOpen, personDetailFace.mouthOpen) &&
        Objects.equals(this.emotions, personDetailFace.emotions) &&
        Objects.equals(this.landmarks, personDetailFace.landmarks) &&
        Objects.equals(this.pose, personDetailFace.pose) &&
        Objects.equals(this.quality, personDetailFace.quality) &&
        Objects.equals(this.confidence, personDetailFace.confidence) &&
        Objects.equals(this.faceOccluded, personDetailFace.faceOccluded) &&
        Objects.equals(this.eyeDirection, personDetailFace.eyeDirection);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonDetailFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonDetailFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonDetailFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonDetailFace is not found in the empty JSON string", PersonDetailFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonDetailFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonDetailFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonDetailFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonDetailFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonDetailFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonDetailFace.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonDetailFace>() {
           @Override
           public void write(JsonWriter out, PersonDetailFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonDetailFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonDetailFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonDetailFace
   * @throws IOException if the JSON string is invalid with respect to PersonDetailFace
   */
  public static PersonDetailFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonDetailFace.class);
  }

  /**
   * Convert an instance of PersonDetailFace to an JSON string
   *
   * @return JSON string
   */
