...
public class DisassociatedFace {
  ...
  public DisassociatedFace() {
  }

  public DisassociatedFace faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DisassociatedFace disassociatedFace = (DisassociatedFace) o;
    return Objects.equals(this.faceId, disassociatedFace.faceId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociatedFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociatedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociatedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociatedFace is not found in the empty JSON string", DisassociatedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociatedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociatedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociatedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociatedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociatedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociatedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociatedFace>() {
           @Override
           public void write(JsonWriter out, DisassociatedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociatedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociatedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociatedFace
   * @throws IOException if the JSON string is invalid with respect to DisassociatedFace
   */
  public static DisassociatedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociatedFace.class);
  }

  /**
   * Convert an instance of DisassociatedFace to an JSON string
   *
   * @return JSON string
   */
