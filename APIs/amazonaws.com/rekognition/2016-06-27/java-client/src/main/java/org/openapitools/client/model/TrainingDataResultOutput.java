...
public class TrainingDataResultOutput {
  public static final String SERIALIZED_NAME_ASSETS = "Assets";
  @SerializedName(SERIALIZED_NAME_ASSETS)
  private List assets;

  public TrainingDataResultOutput() {
  }

  public TrainingDataResultOutput assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrainingDataResultOutput trainingDataResultOutput = (TrainingDataResultOutput) o;
    return Objects.equals(this.assets, trainingDataResultOutput.assets);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingDataResultOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingDataResultOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingDataResultOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingDataResultOutput is not found in the empty JSON string", TrainingDataResultOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingDataResultOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingDataResultOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingDataResultOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingDataResultOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingDataResultOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingDataResultOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingDataResultOutput>() {
           @Override
           public void write(JsonWriter out, TrainingDataResultOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingDataResultOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingDataResultOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingDataResultOutput
   * @throws IOException if the JSON string is invalid with respect to TrainingDataResultOutput
   */
  public static TrainingDataResultOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingDataResultOutput.class);
  }

  /**
   * Convert an instance of TrainingDataResultOutput to an JSON string
   *
   * @return JSON string
   */
