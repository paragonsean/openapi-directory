 ...
 */
@JsonAdapter(BodyPart.Adapter.class)
public enum BodyPart {
  ...
  public static class Adapter extends TypeAdapter<BodyPart> {
    @Override
    public void write(final JsonWriter jsonWriter, final BodyPart enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public BodyPart read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return BodyPart.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    BodyPart.fromValue(value);
  }
}
