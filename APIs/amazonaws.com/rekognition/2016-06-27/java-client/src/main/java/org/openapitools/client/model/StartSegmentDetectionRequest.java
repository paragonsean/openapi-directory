...
public class StartSegmentDetectionRequest {
  ...
  private StartSegmentDetectionRequestNotificationChannel notificationChannel;
  ...
  private StartSegmentDetectionRequestFilters filters;

  public static final String SERIALIZED_NAME_SEGMENT_TYPES = "SegmentTypes";
  @SerializedName(SERIALIZED_NAME_SEGMENT_TYPES)
  private List segmentTypes;

  public StartSegmentDetectionRequest() {
  }

  public StartSegmentDetectionRequest video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public StartSegmentDetectionRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartSegmentDetectionRequest notificationChannel(StartSegmentDetectionRequestNotificationChannel notificationChannel) {
   ...
   */
  @javax.annotation.Nullable
  public StartSegmentDetectionRequestNotificationChannel getNotificationChannel() {
    return notificationChannel;
  }

  public void setNotificationChannel(StartSegmentDetectionRequestNotificationChannel notificationChannel) {
    this.notificationChannel = notificationChannel;
  }


  public StartSegmentDetectionRequest jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public StartSegmentDetectionRequest filters(StartSegmentDetectionRequestFilters filters) {
   ...
   */
  @javax.annotation.Nullable
  public StartSegmentDetectionRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(StartSegmentDetectionRequestFilters filters) {
    this.filters = filters;
  }


  public StartSegmentDetectionRequest segmentTypes(List segmentTypes) {
   ...
   */
  @javax.annotation.Nonnull
  public List getSegmentTypes() {
    return segmentTypes;
  }

  public void setSegmentTypes(List segmentTypes) {
    this.segmentTypes = segmentTypes;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartSegmentDetectionRequest startSegmentDetectionRequest = (StartSegmentDetectionRequest) o;
    return Objects.equals(this.video, startSegmentDetectionRequest.video) &&
        Objects.equals(this.clientRequestToken, startSegmentDetectionRequest.clientRequestToken) &&
        Objects.equals(this.notificationChannel, startSegmentDetectionRequest.notificationChannel) &&
        Objects.equals(this.jobTag, startSegmentDetectionRequest.jobTag) &&
        Objects.equals(this.filters, startSegmentDetectionRequest.filters) &&
        Objects.equals(this.segmentTypes, startSegmentDetectionRequest.segmentTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(video, clientRequestToken, notificationChannel, jobTag, filters, segmentTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartSegmentDetectionRequest {\n");
  ...
  static {
    ...
    openapiFields.add("SegmentTypes");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("Video");
    openapiRequiredFields.add("SegmentTypes");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSegmentDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSegmentDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSegmentDetectionRequest is not found in the empty JSON string", StartSegmentDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSegmentDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSegmentDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartSegmentDetectionRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("NotificationChannel") != null && !jsonObj.get("NotificationChannel").isJsonNull()) {
        StartSegmentDetectionRequestNotificationChannel.validateJsonElement(jsonObj.get("NotificationChannel"));
      }
      ...
      if (jsonObj.get("Filters") != null && !jsonObj.get("Filters").isJsonNull()) {
        StartSegmentDetectionRequestFilters.validateJsonElement(jsonObj.get("Filters"));
      }
      // validate the required field `SegmentTypes`
      List.validateJsonElement(jsonObj.get("SegmentTypes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSegmentDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSegmentDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSegmentDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSegmentDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSegmentDetectionRequest>() {
           @Override
           public void write(JsonWriter out, StartSegmentDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSegmentDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSegmentDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSegmentDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to StartSegmentDetectionRequest
   */
  public static StartSegmentDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSegmentDetectionRequest.class);
  }

  /**
   * Convert an instance of StartSegmentDetectionRequest to an JSON string
   *
   * @return JSON string
   */
