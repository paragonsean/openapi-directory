...
public class StartStreamProcessorResponse {
  ...
  public StartStreamProcessorResponse sessionId(String sessionId) {
  ...
  public boolean equals(Object o) {
    ...
    StartStreamProcessorResponse startStreamProcessorResponse = (StartStreamProcessorResponse) o;
    return Objects.equals(this.sessionId, startStreamProcessorResponse.sessionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartStreamProcessorResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartStreamProcessorResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartStreamProcessorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartStreamProcessorResponse is not found in the empty JSON string", StartStreamProcessorResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartStreamProcessorResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartStreamProcessorResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartStreamProcessorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartStreamProcessorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartStreamProcessorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartStreamProcessorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartStreamProcessorResponse>() {
           @Override
           public void write(JsonWriter out, StartStreamProcessorResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartStreamProcessorResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartStreamProcessorResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartStreamProcessorResponse
   * @throws IOException if the JSON string is invalid with respect to StartStreamProcessorResponse
   */
  public static StartStreamProcessorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartStreamProcessorResponse.class);
  }

  /**
   * Convert an instance of StartStreamProcessorResponse to an JSON string
   *
   * @return JSON string
   */
