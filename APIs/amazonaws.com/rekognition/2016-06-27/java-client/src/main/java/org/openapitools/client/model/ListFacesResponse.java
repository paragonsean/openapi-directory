...
public class ListFacesResponse {
  ...
  public ListFacesResponse faces(List faces) {
    this.faces = faces;
    return this;
  }
  ...
  public ListFacesResponse nextToken(String nextToken) {
  ...
  public ListFacesResponse faceModelVersion(String faceModelVersion) {
  ...
  public boolean equals(Object o) {
    ...
    ListFacesResponse listFacesResponse = (ListFacesResponse) o;
    return Objects.equals(this.faces, listFacesResponse.faces) &&
        Objects.equals(this.nextToken, listFacesResponse.nextToken) &&
        Objects.equals(this.faceModelVersion, listFacesResponse.faceModelVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faces, nextToken, faceModelVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListFacesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFacesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFacesResponse is not found in the empty JSON string", ListFacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFacesResponse>() {
           @Override
           public void write(JsonWriter out, ListFacesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFacesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFacesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFacesResponse
   * @throws IOException if the JSON string is invalid with respect to ListFacesResponse
   */
  public static ListFacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFacesResponse.class);
  }

  /**
   * Convert an instance of ListFacesResponse to an JSON string
   *
   * @return JSON string
   */
