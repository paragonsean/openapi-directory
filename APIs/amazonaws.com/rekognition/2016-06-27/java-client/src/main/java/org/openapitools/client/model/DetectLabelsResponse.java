...
public class DetectLabelsResponse {
  ...
  private DetectLabelsResponseImageProperties imageProperties;

  public DetectLabelsResponse() {
  }

  public DetectLabelsResponse labels(List labels) {
    this.labels = labels;
    return this;
  }
  ...
  public DetectLabelsResponse orientationCorrection(OrientationCorrection orientationCorrection) {
  ...
  public DetectLabelsResponse labelModelVersion(String labelModelVersion) {
  ...
  public DetectLabelsResponse imageProperties(DetectLabelsResponseImageProperties imageProperties) {
   ...
   */
  @javax.annotation.Nullable
  public DetectLabelsResponseImageProperties getImageProperties() {
    return imageProperties;
  }

  public void setImageProperties(DetectLabelsResponseImageProperties imageProperties) {
    this.imageProperties = imageProperties;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsResponse detectLabelsResponse = (DetectLabelsResponse) o;
    return Objects.equals(this.labels, detectLabelsResponse.labels) &&
        Objects.equals(this.orientationCorrection, detectLabelsResponse.orientationCorrection) &&
        Objects.equals(this.labelModelVersion, detectLabelsResponse.labelModelVersion) &&
        Objects.equals(this.imageProperties, detectLabelsResponse.imageProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labels, orientationCorrection, labelModelVersion, imageProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectLabelsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsResponse is not found in the empty JSON string", DetectLabelsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ImageProperties") != null && !jsonObj.get("ImageProperties").isJsonNull()) {
        DetectLabelsResponseImageProperties.validateJsonElement(jsonObj.get("ImageProperties"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsResponse>() {
           @Override
           public void write(JsonWriter out, DetectLabelsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsResponse
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsResponse
   */
  public static DetectLabelsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsResponse.class);
  }

  /**
   * Convert an instance of DetectLabelsResponse to an JSON string
   *
   * @return JSON string
   */
