...
/**
 * Gets or Sets TextTypes
 */
@JsonAdapter(TextTypes.Adapter.class)
public enum TextTypes {
  ...
  public static TextTypes fromValue(String value) {
    for (TextTypes b : TextTypes.values()) {
  ...
  public static class Adapter extends TypeAdapter<TextTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final TextTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TextTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TextTypes.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TextTypes.fromValue(value);
  }
}
