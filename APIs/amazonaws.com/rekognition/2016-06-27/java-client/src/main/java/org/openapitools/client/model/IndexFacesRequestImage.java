...
public class IndexFacesRequestImage {
  ...
  public IndexFacesRequestImage() {
  }

  public IndexFacesRequestImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public IndexFacesRequestImage s3Object(ImageS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    IndexFacesRequestImage indexFacesRequestImage = (IndexFacesRequestImage) o;
    return Objects.equals(this.bytes, indexFacesRequestImage.bytes) &&
        Objects.equals(this.s3Object, indexFacesRequestImage.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class IndexFacesRequestImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IndexFacesRequestImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndexFacesRequestImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IndexFacesRequestImage is not found in the empty JSON string", IndexFacesRequestImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IndexFacesRequestImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IndexFacesRequestImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IndexFacesRequestImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IndexFacesRequestImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IndexFacesRequestImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IndexFacesRequestImage.class));

       return (TypeAdapter<T>) new TypeAdapter<IndexFacesRequestImage>() {
           @Override
           public void write(JsonWriter out, IndexFacesRequestImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IndexFacesRequestImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IndexFacesRequestImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IndexFacesRequestImage
   * @throws IOException if the JSON string is invalid with respect to IndexFacesRequestImage
   */
  public static IndexFacesRequestImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IndexFacesRequestImage.class);
  }

  /**
   * Convert an instance of IndexFacesRequestImage to an JSON string
   *
   * @return JSON string
   */
