...
/**
 * DatasetDescriptionDatasetStats
 */
...
public class DatasetDescriptionDatasetStats {
  public static final String SERIALIZED_NAME_LABELED_ENTRIES = "LabeledEntries";
  @SerializedName(SERIALIZED_NAME_LABELED_ENTRIES)
  ...
  public DatasetDescriptionDatasetStats() {
  }

  public DatasetDescriptionDatasetStats labeledEntries(Integer labeledEntries) {
  ...
  public DatasetDescriptionDatasetStats totalEntries(Integer totalEntries) {
  ...
  public DatasetDescriptionDatasetStats totalLabels(Integer totalLabels) {
  ...
  public DatasetDescriptionDatasetStats errorEntries(Integer errorEntries) {
  ...
  public boolean equals(Object o) {
    ...
    DatasetDescriptionDatasetStats datasetDescriptionDatasetStats = (DatasetDescriptionDatasetStats) o;
    return Objects.equals(this.labeledEntries, datasetDescriptionDatasetStats.labeledEntries) &&
        Objects.equals(this.totalEntries, datasetDescriptionDatasetStats.totalEntries) &&
        Objects.equals(this.totalLabels, datasetDescriptionDatasetStats.totalLabels) &&
        Objects.equals(this.errorEntries, datasetDescriptionDatasetStats.errorEntries);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labeledEntries, totalEntries, totalLabels, errorEntries);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatasetDescriptionDatasetStats {\n");
    sb.append("    labeledEntries: ").append(toIndentedString(labeledEntries)).append("\n");
  ...
  static {
    ...
    openapiFields.add("LabeledEntries");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetDescriptionDatasetStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetDescriptionDatasetStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetDescriptionDatasetStats is not found in the empty JSON string", DatasetDescriptionDatasetStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetDescriptionDatasetStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetDescriptionDatasetStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `LabeledEntries`
      if (jsonObj.get("LabeledEntries") != null && !jsonObj.get("LabeledEntries").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("LabeledEntries"));
      }
      // validate the optional field `TotalEntries`
      if (jsonObj.get("TotalEntries") != null && !jsonObj.get("TotalEntries").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("TotalEntries"));
      }
      // validate the optional field `TotalLabels`
      if (jsonObj.get("TotalLabels") != null && !jsonObj.get("TotalLabels").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("TotalLabels"));
      }
      // validate the optional field `ErrorEntries`
      if (jsonObj.get("ErrorEntries") != null && !jsonObj.get("ErrorEntries").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("ErrorEntries"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetDescriptionDatasetStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetDescriptionDatasetStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetDescriptionDatasetStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetDescriptionDatasetStats.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetDescriptionDatasetStats>() {
           @Override
           public void write(JsonWriter out, DatasetDescriptionDatasetStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetDescriptionDatasetStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetDescriptionDatasetStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetDescriptionDatasetStats
   * @throws IOException if the JSON string is invalid with respect to DatasetDescriptionDatasetStats
   */
  public static DatasetDescriptionDatasetStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetDescriptionDatasetStats.class);
  }

  /**
   * Convert an instance of DatasetDescriptionDatasetStats to an JSON string
   *
   * @return JSON string
   */
