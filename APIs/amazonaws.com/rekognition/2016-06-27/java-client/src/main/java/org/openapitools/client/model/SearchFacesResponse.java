...
public class SearchFacesResponse {
  public static final String SERIALIZED_NAME_SEARCHED_FACE_ID = "SearchedFaceId";
  @SerializedName(SERIALIZED_NAME_SEARCHED_FACE_ID)
  ...
  public SearchFacesResponse searchedFaceId(String searchedFaceId) {
  ...
  public SearchFacesResponse faceMatches(List faceMatches) {
  ...
  public SearchFacesResponse faceModelVersion(String faceModelVersion) {
  ...
  public boolean equals(Object o) {
    ...
    SearchFacesResponse searchFacesResponse = (SearchFacesResponse) o;
    return Objects.equals(this.searchedFaceId, searchFacesResponse.searchedFaceId) &&
        Objects.equals(this.faceMatches, searchFacesResponse.faceMatches) &&
        Objects.equals(this.faceModelVersion, searchFacesResponse.faceModelVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(searchedFaceId, faceMatches, faceModelVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchFacesResponse {\n");
    sb.append("    searchedFaceId: ").append(toIndentedString(searchedFaceId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("SearchedFaceId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchFacesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchFacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchFacesResponse is not found in the empty JSON string", SearchFacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchFacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchFacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `SearchedFaceId`
      if (jsonObj.get("SearchedFaceId") != null && !jsonObj.get("SearchedFaceId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("SearchedFaceId"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchFacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchFacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchFacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchFacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchFacesResponse>() {
           @Override
           public void write(JsonWriter out, SearchFacesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchFacesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchFacesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchFacesResponse
   * @throws IOException if the JSON string is invalid with respect to SearchFacesResponse
   */
  public static SearchFacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchFacesResponse.class);
  }

  /**
   * Convert an instance of SearchFacesResponse to an JSON string
   *
   * @return JSON string
   */
