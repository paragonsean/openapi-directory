...
public class AssociateFacesResponse {
  public static final String SERIALIZED_NAME_ASSOCIATED_FACES = "AssociatedFaces";
  @SerializedName(SERIALIZED_NAME_ASSOCIATED_FACES)
  private List associatedFaces;

  public static final String SERIALIZED_NAME_UNSUCCESSFUL_FACE_ASSOCIATIONS = "UnsuccessfulFaceAssociations";
  @SerializedName(SERIALIZED_NAME_UNSUCCESSFUL_FACE_ASSOCIATIONS)
  private List unsuccessfulFaceAssociations;

  public static final String SERIALIZED_NAME_USER_STATUS = "UserStatus";
  @SerializedName(SERIALIZED_NAME_USER_STATUS)
  private UserStatus userStatus;

  public AssociateFacesResponse() {
  }

  public AssociateFacesResponse associatedFaces(List associatedFaces) {
    this.associatedFaces = associatedFaces;
    return this;
  }
  ...
  public List getAssociatedFaces() {
    return associatedFaces;
  }

  public void setAssociatedFaces(List associatedFaces) {
    this.associatedFaces = associatedFaces;
  }


  public AssociateFacesResponse unsuccessfulFaceAssociations(List unsuccessfulFaceAssociations) {
    this.unsuccessfulFaceAssociations = unsuccessfulFaceAssociations;
    return this;
  }

  /**
   * Get unsuccessfulFaceAssociations
   * @return unsuccessfulFaceAssociations
   */
  @javax.annotation.Nullable
  public List getUnsuccessfulFaceAssociations() {
    return unsuccessfulFaceAssociations;
  }

  public void setUnsuccessfulFaceAssociations(List unsuccessfulFaceAssociations) {
    this.unsuccessfulFaceAssociations = unsuccessfulFaceAssociations;
  }


  public AssociateFacesResponse userStatus(UserStatus userStatus) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateFacesResponse associateFacesResponse = (AssociateFacesResponse) o;
    return Objects.equals(this.associatedFaces, associateFacesResponse.associatedFaces) &&
        Objects.equals(this.unsuccessfulFaceAssociations, associateFacesResponse.unsuccessfulFaceAssociations) &&
        Objects.equals(this.userStatus, associateFacesResponse.userStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(associatedFaces, unsuccessfulFaceAssociations, userStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateFacesResponse {\n");
    sb.append("    associatedFaces: ").append(toIndentedString(associatedFaces)).append("\n");
    sb.append("    unsuccessfulFaceAssociations: ").append(toIndentedString(unsuccessfulFaceAssociations)).append("\n");
  ...
  static {
    ...
    openapiFields.add("AssociatedFaces");
    openapiFields.add("UnsuccessfulFaceAssociations");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateFacesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateFacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateFacesResponse is not found in the empty JSON string", AssociateFacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateFacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateFacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AssociatedFaces`
      if (jsonObj.get("AssociatedFaces") != null && !jsonObj.get("AssociatedFaces").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("AssociatedFaces"));
      }
      // validate the optional field `UnsuccessfulFaceAssociations`
      if (jsonObj.get("UnsuccessfulFaceAssociations") != null && !jsonObj.get("UnsuccessfulFaceAssociations").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("UnsuccessfulFaceAssociations"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateFacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateFacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateFacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateFacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateFacesResponse>() {
           @Override
           public void write(JsonWriter out, AssociateFacesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateFacesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateFacesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateFacesResponse
   * @throws IOException if the JSON string is invalid with respect to AssociateFacesResponse
   */
  public static AssociateFacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateFacesResponse.class);
  }

  /**
   * Convert an instance of AssociateFacesResponse to an JSON string
   *
   * @return JSON string
   */
