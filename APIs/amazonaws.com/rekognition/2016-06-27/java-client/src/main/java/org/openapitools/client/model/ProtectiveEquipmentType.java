...
/**
 * Gets or Sets ProtectiveEquipmentType
 */
@JsonAdapter(ProtectiveEquipmentType.Adapter.class)
public enum ProtectiveEquipmentType {
  ...
  ProtectiveEquipmentType(String value) {
    this.value = value;
  }
  ...
  public static ProtectiveEquipmentType fromValue(String value) {
    for (ProtectiveEquipmentType b : ProtectiveEquipmentType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProtectiveEquipmentType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProtectiveEquipmentType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProtectiveEquipmentType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProtectiveEquipmentType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ProtectiveEquipmentType.fromValue(value);
  }
}
