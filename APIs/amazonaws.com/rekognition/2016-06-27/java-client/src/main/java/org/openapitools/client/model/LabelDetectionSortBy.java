...
/**
 * Gets or Sets LabelDetectionSortBy
 */
@JsonAdapter(LabelDetectionSortBy.Adapter.class)
public enum LabelDetectionSortBy {
  ...
  LabelDetectionSortBy(String value) {
    this.value = value;
  }
  ...
  public static LabelDetectionSortBy fromValue(String value) {
    for (LabelDetectionSortBy b : LabelDetectionSortBy.values()) {
  ...
  public static class Adapter extends TypeAdapter<LabelDetectionSortBy> {
    @Override
    public void write(final JsonWriter jsonWriter, final LabelDetectionSortBy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LabelDetectionSortBy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LabelDetectionSortBy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LabelDetectionSortBy.fromValue(value);
  }
}
