...
public class StartTextDetectionResponse {
  ...
  public StartTextDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartTextDetectionResponse startTextDetectionResponse = (StartTextDetectionResponse) o;
    return Objects.equals(this.jobId, startTextDetectionResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartTextDetectionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTextDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTextDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTextDetectionResponse is not found in the empty JSON string", StartTextDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTextDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTextDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTextDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTextDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTextDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTextDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTextDetectionResponse>() {
           @Override
           public void write(JsonWriter out, StartTextDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTextDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTextDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTextDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to StartTextDetectionResponse
   */
  public static StartTextDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTextDetectionResponse.class);
  }

  /**
   * Convert an instance of StartTextDetectionResponse to an JSON string
   *
   * @return JSON string
   */
