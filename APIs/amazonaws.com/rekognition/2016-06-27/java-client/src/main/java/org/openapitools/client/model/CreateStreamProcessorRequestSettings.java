...
import org.openapitools.client.model.ConnectedHomeSettings;
import org.openapitools.client.model.StreamProcessorSettingsFaceSearch;
...
/**
 * CreateStreamProcessorRequestSettings
 */
...
public class CreateStreamProcessorRequestSettings {
  public static final String SERIALIZED_NAME_FACE_SEARCH = "FaceSearch";
  @SerializedName(SERIALIZED_NAME_FACE_SEARCH)
  private StreamProcessorSettingsFaceSearch faceSearch;

  public static final String SERIALIZED_NAME_CONNECTED_HOME = "ConnectedHome";
  @SerializedName(SERIALIZED_NAME_CONNECTED_HOME)
  private ConnectedHomeSettings connectedHome;

  public CreateStreamProcessorRequestSettings() {
  }

  public CreateStreamProcessorRequestSettings faceSearch(StreamProcessorSettingsFaceSearch faceSearch) {
  ...
  public StreamProcessorSettingsFaceSearch getFaceSearch() {
    return faceSearch;
  }

  public void setFaceSearch(StreamProcessorSettingsFaceSearch faceSearch) {
    this.faceSearch = faceSearch;
  }


  public CreateStreamProcessorRequestSettings connectedHome(ConnectedHomeSettings connectedHome) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamProcessorRequestSettings createStreamProcessorRequestSettings = (CreateStreamProcessorRequestSettings) o;
    return Objects.equals(this.faceSearch, createStreamProcessorRequestSettings.faceSearch) &&
        Objects.equals(this.connectedHome, createStreamProcessorRequestSettings.connectedHome);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceSearch, connectedHome);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateStreamProcessorRequestSettings {\n");
    sb.append("    faceSearch: ").append(toIndentedString(faceSearch)).append("\n");
    sb.append("    connectedHome: ").append(toIndentedString(connectedHome)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("FaceSearch");
    openapiFields.add("ConnectedHome");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamProcessorRequestSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamProcessorRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamProcessorRequestSettings is not found in the empty JSON string", CreateStreamProcessorRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamProcessorRequestSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamProcessorRequestSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `FaceSearch`
      if (jsonObj.get("FaceSearch") != null && !jsonObj.get("FaceSearch").isJsonNull()) {
        StreamProcessorSettingsFaceSearch.validateJsonElement(jsonObj.get("FaceSearch"));
      }
      // validate the optional field `ConnectedHome`
      if (jsonObj.get("ConnectedHome") != null && !jsonObj.get("ConnectedHome").isJsonNull()) {
        ConnectedHomeSettings.validateJsonElement(jsonObj.get("ConnectedHome"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamProcessorRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamProcessorRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamProcessorRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamProcessorRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamProcessorRequestSettings>() {
           @Override
           public void write(JsonWriter out, CreateStreamProcessorRequestSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamProcessorRequestSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamProcessorRequestSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamProcessorRequestSettings
   * @throws IOException if the JSON string is invalid with respect to CreateStreamProcessorRequestSettings
   */
  public static CreateStreamProcessorRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamProcessorRequestSettings.class);
  }

  /**
   * Convert an instance of CreateStreamProcessorRequestSettings to an JSON string
   *
   * @return JSON string
   */
