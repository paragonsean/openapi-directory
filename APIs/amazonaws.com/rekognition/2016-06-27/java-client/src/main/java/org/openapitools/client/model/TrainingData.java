...
public class TrainingData {
  ...
  public TrainingData assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assets, trainingData.assets);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingData is not found in the empty JSON string", TrainingData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingData.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingData>() {
           @Override
           public void write(JsonWriter out, TrainingData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingData
   * @throws IOException if the JSON string is invalid with respect to TrainingData
   */
  public static TrainingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingData.class);
  }

  /**
   * Convert an instance of TrainingData to an JSON string
   *
   * @return JSON string
   */
