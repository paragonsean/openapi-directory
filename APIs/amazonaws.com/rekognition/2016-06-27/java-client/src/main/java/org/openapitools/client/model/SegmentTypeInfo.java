...
public class SegmentTypeInfo {
  ...
  public SegmentTypeInfo type(SegmentType type) {
    this.type = type;
    return this;
  }
  ...
  public SegmentTypeInfo modelVersion(String modelVersion) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentTypeInfo segmentTypeInfo = (SegmentTypeInfo) o;
    return Objects.equals(this.type, segmentTypeInfo.type) &&
        Objects.equals(this.modelVersion, segmentTypeInfo.modelVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, modelVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SegmentTypeInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SegmentTypeInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentTypeInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentTypeInfo is not found in the empty JSON string", SegmentTypeInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentTypeInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentTypeInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentTypeInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentTypeInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentTypeInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentTypeInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentTypeInfo>() {
           @Override
           public void write(JsonWriter out, SegmentTypeInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SegmentTypeInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SegmentTypeInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SegmentTypeInfo
   * @throws IOException if the JSON string is invalid with respect to SegmentTypeInfo
   */
  public static SegmentTypeInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentTypeInfo.class);
  }

  /**
   * Convert an instance of SegmentTypeInfo to an JSON string
   *
   * @return JSON string
   */
