...
import org.openapitools.client.model.GeneralLabelsSettings;
...
public class StartLabelDetectionRequestSettings {
  ...
  public StartLabelDetectionRequestSettings() {
  }

  public StartLabelDetectionRequestSettings generalLabels(GeneralLabelsSettings generalLabels) {
  ...
  public boolean equals(Object o) {
    ...
    StartLabelDetectionRequestSettings startLabelDetectionRequestSettings = (StartLabelDetectionRequestSettings) o;
    return Objects.equals(this.generalLabels, startLabelDetectionRequestSettings.generalLabels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(generalLabels);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartLabelDetectionRequestSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartLabelDetectionRequestSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartLabelDetectionRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartLabelDetectionRequestSettings is not found in the empty JSON string", StartLabelDetectionRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartLabelDetectionRequestSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartLabelDetectionRequestSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GeneralLabels`
      if (jsonObj.get("GeneralLabels") != null && !jsonObj.get("GeneralLabels").isJsonNull()) {
        GeneralLabelsSettings.validateJsonElement(jsonObj.get("GeneralLabels"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartLabelDetectionRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartLabelDetectionRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartLabelDetectionRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartLabelDetectionRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<StartLabelDetectionRequestSettings>() {
           @Override
           public void write(JsonWriter out, StartLabelDetectionRequestSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartLabelDetectionRequestSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartLabelDetectionRequestSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartLabelDetectionRequestSettings
   * @throws IOException if the JSON string is invalid with respect to StartLabelDetectionRequestSettings
   */
  public static StartLabelDetectionRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartLabelDetectionRequestSettings.class);
  }

  /**
   * Convert an instance of StartLabelDetectionRequestSettings to an JSON string
   *
   * @return JSON string
   */
