...
import org.openapitools.client.model.IndexFacesRequestImage;
import org.openapitools.client.model.QualityFilter;
...
public class IndexFacesRequest {
  ...
  private IndexFacesRequestImage image;
  ...
  public static final String SERIALIZED_NAME_DETECTION_ATTRIBUTES = "DetectionAttributes";
  @SerializedName(SERIALIZED_NAME_DETECTION_ATTRIBUTES)
  private List detectionAttributes;

  public static final String SERIALIZED_NAME_MAX_FACES = "MaxFaces";
  @SerializedName(SERIALIZED_NAME_MAX_FACES)
  ...
  public IndexFacesRequest collectionId(String collectionId) {
  ...
  public IndexFacesRequest image(IndexFacesRequestImage image) {
    this.image = image;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public IndexFacesRequestImage getImage() {
    return image;
  }

  public void setImage(IndexFacesRequestImage image) {
    this.image = image;
  }


  public IndexFacesRequest externalImageId(String externalImageId) {
  ...
  public IndexFacesRequest detectionAttributes(List detectionAttributes) {
    this.detectionAttributes = detectionAttributes;
    return this;
  }

  /**
   * Get detectionAttributes
   * @return detectionAttributes
   */
  @javax.annotation.Nullable
  public List getDetectionAttributes() {
    return detectionAttributes;
  }

  public void setDetectionAttributes(List detectionAttributes) {
    this.detectionAttributes = detectionAttributes;
  }


  public IndexFacesRequest maxFaces(Integer maxFaces) {
  ...
  public IndexFacesRequest qualityFilter(QualityFilter qualityFilter) {
  ...
  public boolean equals(Object o) {
    ...
    IndexFacesRequest indexFacesRequest = (IndexFacesRequest) o;
    return Objects.equals(this.collectionId, indexFacesRequest.collectionId) &&
        Objects.equals(this.image, indexFacesRequest.image) &&
        Objects.equals(this.externalImageId, indexFacesRequest.externalImageId) &&
        Objects.equals(this.detectionAttributes, indexFacesRequest.detectionAttributes) &&
        Objects.equals(this.maxFaces, indexFacesRequest.maxFaces) &&
        Objects.equals(this.qualityFilter, indexFacesRequest.qualityFilter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, image, externalImageId, detectionAttributes, maxFaces, qualityFilter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IndexFacesRequest {\n");
    sb.append("    collectionId: ").append(toIndentedString(collectionId)).append("\n");
    sb.append("    image: ").append(toIndentedString(image)).append("\n");
    sb.append("    externalImageId: ").append(toIndentedString(externalImageId)).append("\n");
    sb.append("    detectionAttributes: ").append(toIndentedString(detectionAttributes)).append("\n");
    sb.append("    maxFaces: ").append(toIndentedString(maxFaces)).append("\n");
  ...
  static {
    ...
    openapiFields.add("DetectionAttributes");
    openapiFields.add("MaxFaces");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IndexFacesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndexFacesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IndexFacesRequest is not found in the empty JSON string", IndexFacesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IndexFacesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IndexFacesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IndexFacesRequest.openapiRequiredFields) {
      ...
      IndexFacesRequestImage.validateJsonElement(jsonObj.get("Image"));
      ...
      // validate the optional field `DetectionAttributes`
      if (jsonObj.get("DetectionAttributes") != null && !jsonObj.get("DetectionAttributes").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DetectionAttributes"));
      }
      // validate the optional field `MaxFaces`
      if (jsonObj.get("MaxFaces") != null && !jsonObj.get("MaxFaces").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("MaxFaces"));
      }
      // validate the optional field `QualityFilter`
      if (jsonObj.get("QualityFilter") != null && !jsonObj.get("QualityFilter").isJsonNull()) {
        QualityFilter.validateJsonElement(jsonObj.get("QualityFilter"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IndexFacesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IndexFacesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IndexFacesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IndexFacesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IndexFacesRequest>() {
           @Override
           public void write(JsonWriter out, IndexFacesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IndexFacesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IndexFacesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IndexFacesRequest
   * @throws IOException if the JSON string is invalid with respect to IndexFacesRequest
   */
  public static IndexFacesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IndexFacesRequest.class);
  }

  /**
   * Convert an instance of IndexFacesRequest to an JSON string
   *
   * @return JSON string
   */
