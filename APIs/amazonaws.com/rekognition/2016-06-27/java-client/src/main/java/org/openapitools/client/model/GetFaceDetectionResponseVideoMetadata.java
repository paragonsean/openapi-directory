...
/**
 * GetFaceDetectionResponseVideoMetadata
 */
...
public class GetFaceDetectionResponseVideoMetadata {
  ...
  public GetFaceDetectionResponseVideoMetadata() {
  }

  public GetFaceDetectionResponseVideoMetadata codec(String codec) {
    this.codec = codec;
    return this;
  }
  ...
  public GetFaceDetectionResponseVideoMetadata durationMillis(Integer durationMillis) {
  ...
  public GetFaceDetectionResponseVideoMetadata format(String format) {
    this.format = format;
    return this;
  }
  ...
  public GetFaceDetectionResponseVideoMetadata frameRate(Float frameRate) {
  ...
  public GetFaceDetectionResponseVideoMetadata frameHeight(Integer frameHeight) {
  ...
  public GetFaceDetectionResponseVideoMetadata frameWidth(Integer frameWidth) {
  ...
  public GetFaceDetectionResponseVideoMetadata colorRange(VideoColorRange colorRange) {
  ...
  public boolean equals(Object o) {
    ...
    GetFaceDetectionResponseVideoMetadata getFaceDetectionResponseVideoMetadata = (GetFaceDetectionResponseVideoMetadata) o;
    return Objects.equals(this.codec, getFaceDetectionResponseVideoMetadata.codec) &&
        Objects.equals(this.durationMillis, getFaceDetectionResponseVideoMetadata.durationMillis) &&
        Objects.equals(this.format, getFaceDetectionResponseVideoMetadata.format) &&
        Objects.equals(this.frameRate, getFaceDetectionResponseVideoMetadata.frameRate) &&
        Objects.equals(this.frameHeight, getFaceDetectionResponseVideoMetadata.frameHeight) &&
        Objects.equals(this.frameWidth, getFaceDetectionResponseVideoMetadata.frameWidth) &&
        Objects.equals(this.colorRange, getFaceDetectionResponseVideoMetadata.colorRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFaceDetectionResponseVideoMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFaceDetectionResponseVideoMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFaceDetectionResponseVideoMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFaceDetectionResponseVideoMetadata is not found in the empty JSON string", GetFaceDetectionResponseVideoMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFaceDetectionResponseVideoMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFaceDetectionResponseVideoMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFaceDetectionResponseVideoMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFaceDetectionResponseVideoMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFaceDetectionResponseVideoMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFaceDetectionResponseVideoMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFaceDetectionResponseVideoMetadata>() {
           @Override
           public void write(JsonWriter out, GetFaceDetectionResponseVideoMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFaceDetectionResponseVideoMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFaceDetectionResponseVideoMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFaceDetectionResponseVideoMetadata
   * @throws IOException if the JSON string is invalid with respect to GetFaceDetectionResponseVideoMetadata
   */
  public static GetFaceDetectionResponseVideoMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFaceDetectionResponseVideoMetadata.class);
  }

  /**
   * Convert an instance of GetFaceDetectionResponseVideoMetadata to an JSON string
   *
   * @return JSON string
   */
