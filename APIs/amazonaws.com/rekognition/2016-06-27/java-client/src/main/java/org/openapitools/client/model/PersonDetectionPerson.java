...
public class PersonDetectionPerson {
  ...
  private PersonDetailBoundingBox boundingBox;

  public static final String SERIALIZED_NAME_FACE = "Face";
  @SerializedName(SERIALIZED_NAME_FACE)
  private PersonDetailFace face;

  public PersonDetectionPerson() {
  }

  public PersonDetectionPerson index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public PersonDetectionPerson boundingBox(PersonDetailBoundingBox boundingBox) {
   ...
   */
  @javax.annotation.Nullable
  public PersonDetailBoundingBox getBoundingBox() {
    return boundingBox;
  }

  public void setBoundingBox(PersonDetailBoundingBox boundingBox) {
    this.boundingBox = boundingBox;
  }


  public PersonDetectionPerson face(PersonDetailFace face) {
    this.face = face;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PersonDetailFace getFace() {
    return face;
  }

  public void setFace(PersonDetailFace face) {
    this.face = face;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersonDetectionPerson personDetectionPerson = (PersonDetectionPerson) o;
    return Objects.equals(this.index, personDetectionPerson.index) &&
        Objects.equals(this.boundingBox, personDetectionPerson.boundingBox) &&
        Objects.equals(this.face, personDetectionPerson.face);
  }

  @Override
  public int hashCode() {
    return Objects.hash(index, boundingBox, face);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PersonDetectionPerson {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonDetectionPerson
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonDetectionPerson.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonDetectionPerson is not found in the empty JSON string", PersonDetectionPerson.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonDetectionPerson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonDetectionPerson` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("BoundingBox") != null && !jsonObj.get("BoundingBox").isJsonNull()) {
        PersonDetailBoundingBox.validateJsonElement(jsonObj.get("BoundingBox"));
      }
      // validate the optional field `Face`
      if (jsonObj.get("Face") != null && !jsonObj.get("Face").isJsonNull()) {
        PersonDetailFace.validateJsonElement(jsonObj.get("Face"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonDetectionPerson.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonDetectionPerson' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonDetectionPerson> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonDetectionPerson.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonDetectionPerson>() {
           @Override
           public void write(JsonWriter out, PersonDetectionPerson value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonDetectionPerson read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonDetectionPerson given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonDetectionPerson
   * @throws IOException if the JSON string is invalid with respect to PersonDetectionPerson
   */
  public static PersonDetectionPerson fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonDetectionPerson.class);
  }

  /**
   * Convert an instance of PersonDetectionPerson to an JSON string
   *
   * @return JSON string
   */
