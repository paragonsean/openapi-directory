...
public enum Reason {
  ...
  public static class Adapter extends TypeAdapter<Reason> {
    @Override
    public void write(final JsonWriter jsonWriter, final Reason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Reason read(final JsonReader jsonReader) throws IOException {
