...
public class FaceDetailAgeRange {
  ...
  public FaceDetailAgeRange() {
  }

  public FaceDetailAgeRange low(Integer low) {
    this.low = low;
    return this;
  }
  ...
  public FaceDetailAgeRange high(Integer high) {
    this.high = high;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailAgeRange faceDetailAgeRange = (FaceDetailAgeRange) o;
    return Objects.equals(this.low, faceDetailAgeRange.low) &&
        Objects.equals(this.high, faceDetailAgeRange.high);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailAgeRange {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailAgeRange
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailAgeRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailAgeRange is not found in the empty JSON string", FaceDetailAgeRange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailAgeRange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailAgeRange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Low`
      if (jsonObj.get("Low") != null && !jsonObj.get("Low").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("Low"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailAgeRange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailAgeRange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailAgeRange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailAgeRange.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailAgeRange>() {
           @Override
           public void write(JsonWriter out, FaceDetailAgeRange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailAgeRange read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailAgeRange given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailAgeRange
   * @throws IOException if the JSON string is invalid with respect to FaceDetailAgeRange
   */
  public static FaceDetailAgeRange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailAgeRange.class);
  }

  /**
   * Convert an instance of FaceDetailAgeRange to an JSON string
   *
   * @return JSON string
   */
