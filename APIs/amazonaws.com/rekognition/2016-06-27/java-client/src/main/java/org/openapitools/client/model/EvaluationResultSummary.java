...
public class EvaluationResultSummary {
  ...
  public EvaluationResultSummary() {
  }

  public EvaluationResultSummary s3Object(S3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    EvaluationResultSummary evaluationResultSummary = (EvaluationResultSummary) o;
    return Objects.equals(this.s3Object, evaluationResultSummary.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvaluationResultSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvaluationResultSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluationResultSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EvaluationResultSummary is not found in the empty JSON string", EvaluationResultSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvaluationResultSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvaluationResultSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluationResultSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluationResultSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluationResultSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluationResultSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluationResultSummary>() {
           @Override
           public void write(JsonWriter out, EvaluationResultSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EvaluationResultSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EvaluationResultSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvaluationResultSummary
   * @throws IOException if the JSON string is invalid with respect to EvaluationResultSummary
   */
  public static EvaluationResultSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvaluationResultSummary.class);
  }

  /**
   * Convert an instance of EvaluationResultSummary to an JSON string
   *
   * @return JSON string
   */
