...
public class Mustache {
  ...
  public Mustache value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public Mustache confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, mustache.value) &&
        Objects.equals(this.confidence, mustache.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Mustache
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mustache.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Mustache is not found in the empty JSON string", Mustache.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mustache.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mustache` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Mustache.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Mustache' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Mustache> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Mustache.class));

       return (TypeAdapter<T>) new TypeAdapter<Mustache>() {
           @Override
           public void write(JsonWriter out, Mustache value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Mustache read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Mustache given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Mustache
   * @throws IOException if the JSON string is invalid with respect to Mustache
   */
  public static Mustache fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Mustache.class);
  }

  /**
   * Convert an instance of Mustache to an JSON string
   *
   * @return JSON string
   */
