...
public class FaceSearchSettings {
  ...
  public FaceSearchSettings collectionId(String collectionId) {
  ...
  public FaceSearchSettings faceMatchThreshold(Float faceMatchThreshold) {
  ...
  public boolean equals(Object o) {
    ...
    FaceSearchSettings faceSearchSettings = (FaceSearchSettings) o;
    return Objects.equals(this.collectionId, faceSearchSettings.collectionId) &&
        Objects.equals(this.faceMatchThreshold, faceSearchSettings.faceMatchThreshold);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, faceMatchThreshold);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FaceSearchSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceSearchSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceSearchSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceSearchSettings is not found in the empty JSON string", FaceSearchSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceSearchSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceSearchSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CollectionId`
      if (jsonObj.get("CollectionId") != null && !jsonObj.get("CollectionId").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceSearchSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceSearchSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceSearchSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceSearchSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceSearchSettings>() {
           @Override
           public void write(JsonWriter out, FaceSearchSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceSearchSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceSearchSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceSearchSettings
   * @throws IOException if the JSON string is invalid with respect to FaceSearchSettings
   */
  public static FaceSearchSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceSearchSettings.class);
  }

  /**
   * Convert an instance of FaceSearchSettings to an JSON string
   *
   * @return JSON string
   */
