...
public class TrainingDataResultInput {
  public static final String SERIALIZED_NAME_ASSETS = "Assets";
  @SerializedName(SERIALIZED_NAME_ASSETS)
  private List assets;

  public TrainingDataResultInput() {
  }

  public TrainingDataResultInput assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrainingDataResultInput trainingDataResultInput = (TrainingDataResultInput) o;
    return Objects.equals(this.assets, trainingDataResultInput.assets);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingDataResultInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingDataResultInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingDataResultInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingDataResultInput is not found in the empty JSON string", TrainingDataResultInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingDataResultInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingDataResultInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingDataResultInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingDataResultInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingDataResultInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingDataResultInput.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingDataResultInput>() {
           @Override
           public void write(JsonWriter out, TrainingDataResultInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingDataResultInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingDataResultInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingDataResultInput
   * @throws IOException if the JSON string is invalid with respect to TrainingDataResultInput
   */
  public static TrainingDataResultInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingDataResultInput.class);
  }

  /**
   * Convert an instance of TrainingDataResultInput to an JSON string
   *
   * @return JSON string
   */
