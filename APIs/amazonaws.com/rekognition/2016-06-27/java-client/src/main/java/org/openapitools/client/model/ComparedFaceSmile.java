...
public class ComparedFaceSmile {
  ...
  public ComparedFaceSmile() {
  }

  public ComparedFaceSmile value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public ComparedFaceSmile confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    ComparedFaceSmile comparedFaceSmile = (ComparedFaceSmile) o;
    return Objects.equals(this.value, comparedFaceSmile.value) &&
        Objects.equals(this.confidence, comparedFaceSmile.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComparedFaceSmile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComparedFaceSmile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComparedFaceSmile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComparedFaceSmile is not found in the empty JSON string", ComparedFaceSmile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComparedFaceSmile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComparedFaceSmile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComparedFaceSmile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComparedFaceSmile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComparedFaceSmile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComparedFaceSmile.class));

       return (TypeAdapter<T>) new TypeAdapter<ComparedFaceSmile>() {
           @Override
           public void write(JsonWriter out, ComparedFaceSmile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComparedFaceSmile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComparedFaceSmile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComparedFaceSmile
   * @throws IOException if the JSON string is invalid with respect to ComparedFaceSmile
   */
  public static ComparedFaceSmile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComparedFaceSmile.class);
  }

  /**
   * Convert an instance of ComparedFaceSmile to an JSON string
   *
   * @return JSON string
   */
