...
public class UnsuccessfulFaceAssociation {
  ...
  public UnsuccessfulFaceAssociation() {
  }

  public UnsuccessfulFaceAssociation faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public UnsuccessfulFaceAssociation userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UnsuccessfulFaceAssociation confidence(Float confidence) {
  ...
  public UnsuccessfulFaceAssociation reasons(List reasons) {
  ...
  public boolean equals(Object o) {
    ...
    UnsuccessfulFaceAssociation unsuccessfulFaceAssociation = (UnsuccessfulFaceAssociation) o;
    return Objects.equals(this.faceId, unsuccessfulFaceAssociation.faceId) &&
        Objects.equals(this.userId, unsuccessfulFaceAssociation.userId) &&
        Objects.equals(this.confidence, unsuccessfulFaceAssociation.confidence) &&
        Objects.equals(this.reasons, unsuccessfulFaceAssociation.reasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceId, userId, confidence, reasons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnsuccessfulFaceAssociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnsuccessfulFaceAssociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnsuccessfulFaceAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnsuccessfulFaceAssociation is not found in the empty JSON string", UnsuccessfulFaceAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnsuccessfulFaceAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnsuccessfulFaceAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnsuccessfulFaceAssociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnsuccessfulFaceAssociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnsuccessfulFaceAssociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnsuccessfulFaceAssociation.class));

       return (TypeAdapter<T>) new TypeAdapter<UnsuccessfulFaceAssociation>() {
           @Override
           public void write(JsonWriter out, UnsuccessfulFaceAssociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnsuccessfulFaceAssociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnsuccessfulFaceAssociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnsuccessfulFaceAssociation
   * @throws IOException if the JSON string is invalid with respect to UnsuccessfulFaceAssociation
   */
  public static UnsuccessfulFaceAssociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnsuccessfulFaceAssociation.class);
  }

  /**
   * Convert an instance of UnsuccessfulFaceAssociation to an JSON string
   *
   * @return JSON string
   */
