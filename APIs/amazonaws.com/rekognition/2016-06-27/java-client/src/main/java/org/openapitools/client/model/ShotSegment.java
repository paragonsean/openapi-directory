...
public class ShotSegment {
  ...
  public ShotSegment index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public ShotSegment confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    ShotSegment shotSegment = (ShotSegment) o;
    return Objects.equals(this.index, shotSegment.index) &&
        Objects.equals(this.confidence, shotSegment.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShotSegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShotSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShotSegment is not found in the empty JSON string", ShotSegment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShotSegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShotSegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShotSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShotSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShotSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShotSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<ShotSegment>() {
           @Override
           public void write(JsonWriter out, ShotSegment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShotSegment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShotSegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShotSegment
   * @throws IOException if the JSON string is invalid with respect to ShotSegment
   */
  public static ShotSegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShotSegment.class);
  }

  /**
   * Convert an instance of ShotSegment to an JSON string
   *
   * @return JSON string
   */
