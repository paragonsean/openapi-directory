...
public class StartPersonTrackingRequestVideo {
  ...
  public StartPersonTrackingRequestVideo() {
  }

  public StartPersonTrackingRequestVideo s3Object(VideoS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    StartPersonTrackingRequestVideo startPersonTrackingRequestVideo = (StartPersonTrackingRequestVideo) o;
    return Objects.equals(this.s3Object, startPersonTrackingRequestVideo.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartPersonTrackingRequestVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartPersonTrackingRequestVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartPersonTrackingRequestVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartPersonTrackingRequestVideo is not found in the empty JSON string", StartPersonTrackingRequestVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartPersonTrackingRequestVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartPersonTrackingRequestVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartPersonTrackingRequestVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartPersonTrackingRequestVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartPersonTrackingRequestVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartPersonTrackingRequestVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<StartPersonTrackingRequestVideo>() {
           @Override
           public void write(JsonWriter out, StartPersonTrackingRequestVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartPersonTrackingRequestVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartPersonTrackingRequestVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartPersonTrackingRequestVideo
   * @throws IOException if the JSON string is invalid with respect to StartPersonTrackingRequestVideo
   */
  public static StartPersonTrackingRequestVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartPersonTrackingRequestVideo.class);
  }

  /**
   * Convert an instance of StartPersonTrackingRequestVideo to an JSON string
   *
   * @return JSON string
   */
