...
import org.openapitools.client.model.StartFaceDetectionRequestNotificationChannel;
import org.openapitools.client.model.StartFaceDetectionRequestVideo;
...
public class StartFaceDetectionRequest {
  ...
  private StartFaceDetectionRequestVideo video;
  ...
  private StartFaceDetectionRequestNotificationChannel notificationChannel;
  ...
  public StartFaceDetectionRequest() {
  }

  public StartFaceDetectionRequest video(StartFaceDetectionRequestVideo video) {
    this.video = video;
    return this;
  }
  ...
  public StartFaceDetectionRequestVideo getVideo() {
    return video;
  }

  public void setVideo(StartFaceDetectionRequestVideo video) {
    this.video = video;
  }


  public StartFaceDetectionRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartFaceDetectionRequest notificationChannel(StartFaceDetectionRequestNotificationChannel notificationChannel) {
   ...
   */
  @javax.annotation.Nullable
  public StartFaceDetectionRequestNotificationChannel getNotificationChannel() {
    return notificationChannel;
  }

  public void setNotificationChannel(StartFaceDetectionRequestNotificationChannel notificationChannel) {
    this.notificationChannel = notificationChannel;
  }


  public StartFaceDetectionRequest faceAttributes(FaceAttributes faceAttributes) {
  ...
  public StartFaceDetectionRequest jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartFaceDetectionRequest startFaceDetectionRequest = (StartFaceDetectionRequest) o;
    return Objects.equals(this.video, startFaceDetectionRequest.video) &&
        Objects.equals(this.clientRequestToken, startFaceDetectionRequest.clientRequestToken) &&
        Objects.equals(this.notificationChannel, startFaceDetectionRequest.notificationChannel) &&
        Objects.equals(this.faceAttributes, startFaceDetectionRequest.faceAttributes) &&
        Objects.equals(this.jobTag, startFaceDetectionRequest.jobTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(video, clientRequestToken, notificationChannel, faceAttributes, jobTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartFaceDetectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFaceDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFaceDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFaceDetectionRequest is not found in the empty JSON string", StartFaceDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFaceDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFaceDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartFaceDetectionRequest.openapiRequiredFields) {
      ...
      StartFaceDetectionRequestVideo.validateJsonElement(jsonObj.get("Video"));
      ...
      if (jsonObj.get("NotificationChannel") != null && !jsonObj.get("NotificationChannel").isJsonNull()) {
        StartFaceDetectionRequestNotificationChannel.validateJsonElement(jsonObj.get("NotificationChannel"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFaceDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFaceDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFaceDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFaceDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFaceDetectionRequest>() {
           @Override
           public void write(JsonWriter out, StartFaceDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFaceDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFaceDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFaceDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to StartFaceDetectionRequest
   */
  public static StartFaceDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFaceDetectionRequest.class);
  }

  /**
   * Convert an instance of StartFaceDetectionRequest to an JSON string
   *
   * @return JSON string
   */
