...
/**
 * GetFaceSearchResponseVideoMetadata
 */
...
public class GetFaceSearchResponseVideoMetadata {
  ...
  public GetFaceSearchResponseVideoMetadata() {
  }

  public GetFaceSearchResponseVideoMetadata codec(String codec) {
    this.codec = codec;
    return this;
  }
  ...
  public GetFaceSearchResponseVideoMetadata durationMillis(Integer durationMillis) {
  ...
  public GetFaceSearchResponseVideoMetadata format(String format) {
    this.format = format;
    return this;
  }
  ...
  public GetFaceSearchResponseVideoMetadata frameRate(Float frameRate) {
  ...
  public GetFaceSearchResponseVideoMetadata frameHeight(Integer frameHeight) {
  ...
  public GetFaceSearchResponseVideoMetadata frameWidth(Integer frameWidth) {
  ...
  public GetFaceSearchResponseVideoMetadata colorRange(VideoColorRange colorRange) {
  ...
  public boolean equals(Object o) {
    ...
    GetFaceSearchResponseVideoMetadata getFaceSearchResponseVideoMetadata = (GetFaceSearchResponseVideoMetadata) o;
    return Objects.equals(this.codec, getFaceSearchResponseVideoMetadata.codec) &&
        Objects.equals(this.durationMillis, getFaceSearchResponseVideoMetadata.durationMillis) &&
        Objects.equals(this.format, getFaceSearchResponseVideoMetadata.format) &&
        Objects.equals(this.frameRate, getFaceSearchResponseVideoMetadata.frameRate) &&
        Objects.equals(this.frameHeight, getFaceSearchResponseVideoMetadata.frameHeight) &&
        Objects.equals(this.frameWidth, getFaceSearchResponseVideoMetadata.frameWidth) &&
        Objects.equals(this.colorRange, getFaceSearchResponseVideoMetadata.colorRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFaceSearchResponseVideoMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFaceSearchResponseVideoMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFaceSearchResponseVideoMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFaceSearchResponseVideoMetadata is not found in the empty JSON string", GetFaceSearchResponseVideoMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFaceSearchResponseVideoMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFaceSearchResponseVideoMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFaceSearchResponseVideoMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFaceSearchResponseVideoMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFaceSearchResponseVideoMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFaceSearchResponseVideoMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFaceSearchResponseVideoMetadata>() {
           @Override
           public void write(JsonWriter out, GetFaceSearchResponseVideoMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFaceSearchResponseVideoMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFaceSearchResponseVideoMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFaceSearchResponseVideoMetadata
   * @throws IOException if the JSON string is invalid with respect to GetFaceSearchResponseVideoMetadata
   */
  public static GetFaceSearchResponseVideoMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFaceSearchResponseVideoMetadata.class);
  }

  /**
   * Convert an instance of GetFaceSearchResponseVideoMetadata to an JSON string
   *
   * @return JSON string
   */
