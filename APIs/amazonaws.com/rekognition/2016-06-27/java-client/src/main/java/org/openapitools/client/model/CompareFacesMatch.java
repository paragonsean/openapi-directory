...
import org.openapitools.client.model.CompareFacesMatchFace;
...
public class CompareFacesMatch {
  ...
  private CompareFacesMatchFace face;

  public CompareFacesMatch() {
  }

  public CompareFacesMatch similarity(Float similarity) {
  ...
  public CompareFacesMatch face(CompareFacesMatchFace face) {
    this.face = face;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CompareFacesMatchFace getFace() {
    return face;
  }

  public void setFace(CompareFacesMatchFace face) {
    this.face = face;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompareFacesMatch compareFacesMatch = (CompareFacesMatch) o;
    return Objects.equals(this.similarity, compareFacesMatch.similarity) &&
        Objects.equals(this.face, compareFacesMatch.face);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompareFacesMatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompareFacesMatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompareFacesMatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompareFacesMatch is not found in the empty JSON string", CompareFacesMatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompareFacesMatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompareFacesMatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Face") != null && !jsonObj.get("Face").isJsonNull()) {
        CompareFacesMatchFace.validateJsonElement(jsonObj.get("Face"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompareFacesMatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompareFacesMatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompareFacesMatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompareFacesMatch.class));

       return (TypeAdapter<T>) new TypeAdapter<CompareFacesMatch>() {
           @Override
           public void write(JsonWriter out, CompareFacesMatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompareFacesMatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompareFacesMatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompareFacesMatch
   * @throws IOException if the JSON string is invalid with respect to CompareFacesMatch
   */
  public static CompareFacesMatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompareFacesMatch.class);
  }

  /**
   * Convert an instance of CompareFacesMatch to an JSON string
   *
   * @return JSON string
   */
