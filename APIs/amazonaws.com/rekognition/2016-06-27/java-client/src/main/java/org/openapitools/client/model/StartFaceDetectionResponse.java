...
public class StartFaceDetectionResponse {
  ...
  public StartFaceDetectionResponse() {
  }

  public StartFaceDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartFaceDetectionResponse startFaceDetectionResponse = (StartFaceDetectionResponse) o;
    return Objects.equals(this.jobId, startFaceDetectionResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFaceDetectionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFaceDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFaceDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFaceDetectionResponse is not found in the empty JSON string", StartFaceDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFaceDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFaceDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFaceDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFaceDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFaceDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFaceDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFaceDetectionResponse>() {
           @Override
           public void write(JsonWriter out, StartFaceDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFaceDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFaceDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFaceDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to StartFaceDetectionResponse
   */
  public static StartFaceDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFaceDetectionResponse.class);
  }

  /**
   * Convert an instance of StartFaceDetectionResponse to an JSON string
   *
   * @return JSON string
   */
