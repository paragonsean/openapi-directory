...
import org.openapitools.client.model.SearchFacesByImageResponseSearchedFaceBoundingBox;
...
public class SearchFacesByImageResponse {
  public static final String SERIALIZED_NAME_SEARCHED_FACE_BOUNDING_BOX = "SearchedFaceBoundingBox";
  @SerializedName(SERIALIZED_NAME_SEARCHED_FACE_BOUNDING_BOX)
  private SearchFacesByImageResponseSearchedFaceBoundingBox searchedFaceBoundingBox;

  public static final String SERIALIZED_NAME_SEARCHED_FACE_CONFIDENCE = "SearchedFaceConfidence";
  @SerializedName(SERIALIZED_NAME_SEARCHED_FACE_CONFIDENCE)
  ...
  public SearchFacesByImageResponse searchedFaceBoundingBox(SearchFacesByImageResponseSearchedFaceBoundingBox searchedFaceBoundingBox) {
    this.searchedFaceBoundingBox = searchedFaceBoundingBox;
    return this;
  }

  /**
   * Get searchedFaceBoundingBox
   * @return searchedFaceBoundingBox
   */
  @javax.annotation.Nullable
  public SearchFacesByImageResponseSearchedFaceBoundingBox getSearchedFaceBoundingBox() {
    return searchedFaceBoundingBox;
  }

  public void setSearchedFaceBoundingBox(SearchFacesByImageResponseSearchedFaceBoundingBox searchedFaceBoundingBox) {
    this.searchedFaceBoundingBox = searchedFaceBoundingBox;
  }


  public SearchFacesByImageResponse searchedFaceConfidence(Float searchedFaceConfidence) {
    this.searchedFaceConfidence = searchedFaceConfidence;
    return this;
  }

  /**
   * Get searchedFaceConfidence
  ...
  public SearchFacesByImageResponse faceMatches(List faceMatches) {
  ...
  public SearchFacesByImageResponse faceModelVersion(String faceModelVersion) {
  ...
  public boolean equals(Object o) {
    ...
    SearchFacesByImageResponse searchFacesByImageResponse = (SearchFacesByImageResponse) o;
    return Objects.equals(this.searchedFaceBoundingBox, searchFacesByImageResponse.searchedFaceBoundingBox) &&
        Objects.equals(this.searchedFaceConfidence, searchFacesByImageResponse.searchedFaceConfidence) &&
        Objects.equals(this.faceMatches, searchFacesByImageResponse.faceMatches) &&
        Objects.equals(this.faceModelVersion, searchFacesByImageResponse.faceModelVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(searchedFaceBoundingBox, searchedFaceConfidence, faceMatches, faceModelVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchFacesByImageResponse {\n");
    sb.append("    searchedFaceBoundingBox: ").append(toIndentedString(searchedFaceBoundingBox)).append("\n");
    sb.append("    searchedFaceConfidence: ").append(toIndentedString(searchedFaceConfidence)).append("\n");
  ...
  static {
    ...
    openapiFields.add("SearchedFaceBoundingBox");
    openapiFields.add("SearchedFaceConfidence");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchFacesByImageResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchFacesByImageResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchFacesByImageResponse is not found in the empty JSON string", SearchFacesByImageResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchFacesByImageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchFacesByImageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `SearchedFaceBoundingBox`
      if (jsonObj.get("SearchedFaceBoundingBox") != null && !jsonObj.get("SearchedFaceBoundingBox").isJsonNull()) {
        SearchFacesByImageResponseSearchedFaceBoundingBox.validateJsonElement(jsonObj.get("SearchedFaceBoundingBox"));
      }
      // validate the optional field `SearchedFaceConfidence`
      if (jsonObj.get("SearchedFaceConfidence") != null && !jsonObj.get("SearchedFaceConfidence").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("SearchedFaceConfidence"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchFacesByImageResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchFacesByImageResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchFacesByImageResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchFacesByImageResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchFacesByImageResponse>() {
           @Override
           public void write(JsonWriter out, SearchFacesByImageResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchFacesByImageResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchFacesByImageResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchFacesByImageResponse
   * @throws IOException if the JSON string is invalid with respect to SearchFacesByImageResponse
   */
  public static SearchFacesByImageResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchFacesByImageResponse.class);
  }

  /**
   * Convert an instance of SearchFacesByImageResponse to an JSON string
   *
   * @return JSON string
   */
