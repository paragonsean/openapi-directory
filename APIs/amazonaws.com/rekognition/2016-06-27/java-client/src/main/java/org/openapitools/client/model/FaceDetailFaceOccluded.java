...
public class FaceDetailFaceOccluded {
  ...
  public FaceDetailFaceOccluded() {
  }

  public FaceDetailFaceOccluded value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailFaceOccluded confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailFaceOccluded faceDetailFaceOccluded = (FaceDetailFaceOccluded) o;
    return Objects.equals(this.value, faceDetailFaceOccluded.value) &&
        Objects.equals(this.confidence, faceDetailFaceOccluded.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailFaceOccluded {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailFaceOccluded
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailFaceOccluded.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailFaceOccluded is not found in the empty JSON string", FaceDetailFaceOccluded.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailFaceOccluded.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailFaceOccluded` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Value`
      if (jsonObj.get("Value") != null && !jsonObj.get("Value").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("Value"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailFaceOccluded.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailFaceOccluded' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailFaceOccluded> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailFaceOccluded.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailFaceOccluded>() {
           @Override
           public void write(JsonWriter out, FaceDetailFaceOccluded value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailFaceOccluded read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailFaceOccluded given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailFaceOccluded
   * @throws IOException if the JSON string is invalid with respect to FaceDetailFaceOccluded
   */
  public static FaceDetailFaceOccluded fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailFaceOccluded.class);
  }

  /**
   * Convert an instance of FaceDetailFaceOccluded to an JSON string
   *
   * @return JSON string
   */
