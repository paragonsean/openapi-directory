...
public class ConnectedHomeSettings {
  ...
  public ConnectedHomeSettings() {
  }

  public ConnectedHomeSettings labels(List labels) {
    this.labels = labels;
    return this;
  }
  ...
  public ConnectedHomeSettings minConfidence(Float minConfidence) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectedHomeSettings connectedHomeSettings = (ConnectedHomeSettings) o;
    return Objects.equals(this.labels, connectedHomeSettings.labels) &&
        Objects.equals(this.minConfidence, connectedHomeSettings.minConfidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectedHomeSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectedHomeSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectedHomeSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectedHomeSettings is not found in the empty JSON string", ConnectedHomeSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectedHomeSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectedHomeSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectedHomeSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectedHomeSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectedHomeSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectedHomeSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectedHomeSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectedHomeSettings>() {
           @Override
           public void write(JsonWriter out, ConnectedHomeSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectedHomeSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectedHomeSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectedHomeSettings
   * @throws IOException if the JSON string is invalid with respect to ConnectedHomeSettings
   */
  public static ConnectedHomeSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectedHomeSettings.class);
  }

  /**
   * Convert an instance of ConnectedHomeSettings to an JSON string
   *
   * @return JSON string
   */
