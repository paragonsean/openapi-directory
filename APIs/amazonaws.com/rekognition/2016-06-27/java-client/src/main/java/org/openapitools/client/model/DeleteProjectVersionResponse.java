...
public class DeleteProjectVersionResponse {
  ...
  public DeleteProjectVersionResponse status(ProjectVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteProjectVersionResponse deleteProjectVersionResponse = (DeleteProjectVersionResponse) o;
    return Objects.equals(this.status, deleteProjectVersionResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteProjectVersionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteProjectVersionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteProjectVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteProjectVersionResponse is not found in the empty JSON string", DeleteProjectVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteProjectVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteProjectVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteProjectVersionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteProjectVersionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteProjectVersionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteProjectVersionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteProjectVersionResponse>() {
           @Override
           public void write(JsonWriter out, DeleteProjectVersionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteProjectVersionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteProjectVersionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteProjectVersionResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteProjectVersionResponse
   */
  public static DeleteProjectVersionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteProjectVersionResponse.class);
  }

  /**
   * Convert an instance of DeleteProjectVersionResponse to an JSON string
   *
   * @return JSON string
   */
