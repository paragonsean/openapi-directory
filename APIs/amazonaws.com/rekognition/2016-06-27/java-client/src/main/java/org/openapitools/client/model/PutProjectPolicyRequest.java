...
public class PutProjectPolicyRequest {
  ...
  public PutProjectPolicyRequest() {
  }

  public PutProjectPolicyRequest projectArn(String projectArn) {
  ...
  public PutProjectPolicyRequest policyName(String policyName) {
  ...
  public PutProjectPolicyRequest policyRevisionId(String policyRevisionId) {
  ...
  public PutProjectPolicyRequest policyDocument(String policyDocument) {
  ...
  public boolean equals(Object o) {
    ...
    PutProjectPolicyRequest putProjectPolicyRequest = (PutProjectPolicyRequest) o;
    return Objects.equals(this.projectArn, putProjectPolicyRequest.projectArn) &&
        Objects.equals(this.policyName, putProjectPolicyRequest.policyName) &&
        Objects.equals(this.policyRevisionId, putProjectPolicyRequest.policyRevisionId) &&
        Objects.equals(this.policyDocument, putProjectPolicyRequest.policyDocument);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectArn, policyName, policyRevisionId, policyDocument);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutProjectPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutProjectPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutProjectPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutProjectPolicyRequest is not found in the empty JSON string", PutProjectPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutProjectPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutProjectPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutProjectPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutProjectPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutProjectPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutProjectPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutProjectPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutProjectPolicyRequest>() {
           @Override
           public void write(JsonWriter out, PutProjectPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutProjectPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutProjectPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutProjectPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to PutProjectPolicyRequest
   */
  public static PutProjectPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutProjectPolicyRequest.class);
  }

  /**
   * Convert an instance of PutProjectPolicyRequest to an JSON string
   *
   * @return JSON string
   */
