...
public class GetLabelDetectionRequestMetadata {
  ...
  public GetLabelDetectionRequestMetadata() {
  }

  public GetLabelDetectionRequestMetadata sortBy(LabelDetectionSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public GetLabelDetectionRequestMetadata aggregateBy(LabelDetectionAggregateBy aggregateBy) {
  ...
  public boolean equals(Object o) {
    ...
    GetLabelDetectionRequestMetadata getLabelDetectionRequestMetadata = (GetLabelDetectionRequestMetadata) o;
    return Objects.equals(this.sortBy, getLabelDetectionRequestMetadata.sortBy) &&
        Objects.equals(this.aggregateBy, getLabelDetectionRequestMetadata.aggregateBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLabelDetectionRequestMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLabelDetectionRequestMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLabelDetectionRequestMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLabelDetectionRequestMetadata is not found in the empty JSON string", GetLabelDetectionRequestMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLabelDetectionRequestMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLabelDetectionRequestMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLabelDetectionRequestMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLabelDetectionRequestMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLabelDetectionRequestMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLabelDetectionRequestMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLabelDetectionRequestMetadata>() {
           @Override
           public void write(JsonWriter out, GetLabelDetectionRequestMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLabelDetectionRequestMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLabelDetectionRequestMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLabelDetectionRequestMetadata
   * @throws IOException if the JSON string is invalid with respect to GetLabelDetectionRequestMetadata
   */
  public static GetLabelDetectionRequestMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLabelDetectionRequestMetadata.class);
  }

  /**
   * Convert an instance of GetLabelDetectionRequestMetadata to an JSON string
   *
   * @return JSON string
   */
