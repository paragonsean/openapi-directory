...
public class TestingDataResultOutput {
  ...
  public TestingDataResultOutput() {
  }

  public TestingDataResultOutput assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public TestingDataResultOutput autoCreate(Boolean autoCreate) {
  ...
  public boolean equals(Object o) {
    ...
    TestingDataResultOutput testingDataResultOutput = (TestingDataResultOutput) o;
    return Objects.equals(this.assets, testingDataResultOutput.assets) &&
        Objects.equals(this.autoCreate, testingDataResultOutput.autoCreate);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestingDataResultOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestingDataResultOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestingDataResultOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestingDataResultOutput is not found in the empty JSON string", TestingDataResultOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestingDataResultOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestingDataResultOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestingDataResultOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestingDataResultOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestingDataResultOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestingDataResultOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<TestingDataResultOutput>() {
           @Override
           public void write(JsonWriter out, TestingDataResultOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestingDataResultOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestingDataResultOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestingDataResultOutput
   * @throws IOException if the JSON string is invalid with respect to TestingDataResultOutput
   */
  public static TestingDataResultOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestingDataResultOutput.class);
  }

  /**
   * Convert an instance of TestingDataResultOutput to an JSON string
   *
   * @return JSON string
   */
