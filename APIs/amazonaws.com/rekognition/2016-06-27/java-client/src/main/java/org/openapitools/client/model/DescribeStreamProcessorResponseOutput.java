...
public class DescribeStreamProcessorResponseOutput {
  ...
  public DescribeStreamProcessorResponseOutput() {
  }

  public DescribeStreamProcessorResponseOutput kinesisDataStream(StreamProcessorOutputKinesisDataStream kinesisDataStream) {
  ...
  public DescribeStreamProcessorResponseOutput s3Destination(StreamProcessorOutputS3Destination s3Destination) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeStreamProcessorResponseOutput describeStreamProcessorResponseOutput = (DescribeStreamProcessorResponseOutput) o;
    return Objects.equals(this.kinesisDataStream, describeStreamProcessorResponseOutput.kinesisDataStream) &&
        Objects.equals(this.s3Destination, describeStreamProcessorResponseOutput.s3Destination);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeStreamProcessorResponseOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeStreamProcessorResponseOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeStreamProcessorResponseOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeStreamProcessorResponseOutput is not found in the empty JSON string", DescribeStreamProcessorResponseOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeStreamProcessorResponseOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeStreamProcessorResponseOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeStreamProcessorResponseOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeStreamProcessorResponseOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeStreamProcessorResponseOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeStreamProcessorResponseOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeStreamProcessorResponseOutput>() {
           @Override
           public void write(JsonWriter out, DescribeStreamProcessorResponseOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeStreamProcessorResponseOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeStreamProcessorResponseOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeStreamProcessorResponseOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeStreamProcessorResponseOutput
   */
  public static DescribeStreamProcessorResponseOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeStreamProcessorResponseOutput.class);
  }

  /**
   * Convert an instance of DescribeStreamProcessorResponseOutput to an JSON string
   *
   * @return JSON string
   */
