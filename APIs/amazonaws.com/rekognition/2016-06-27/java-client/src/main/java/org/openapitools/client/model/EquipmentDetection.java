...
import org.openapitools.client.model.EquipmentDetectionBoundingBox;
import org.openapitools.client.model.EquipmentDetectionCoversBodyPart;
import org.openapitools.client.model.ProtectiveEquipmentType;
...
public class EquipmentDetection {
  ...
  private EquipmentDetectionBoundingBox boundingBox;
  ...
  private ProtectiveEquipmentType type;

  public static final String SERIALIZED_NAME_COVERS_BODY_PART = "CoversBodyPart";
  @SerializedName(SERIALIZED_NAME_COVERS_BODY_PART)
  private EquipmentDetectionCoversBodyPart coversBodyPart;

  public EquipmentDetection() {
  }

  public EquipmentDetection boundingBox(EquipmentDetectionBoundingBox boundingBox) {
  ...
  public EquipmentDetectionBoundingBox getBoundingBox() {
    return boundingBox;
  }

  public void setBoundingBox(EquipmentDetectionBoundingBox boundingBox) {
    this.boundingBox = boundingBox;
  }


  public EquipmentDetection confidence(Float confidence) {
  ...
  public EquipmentDetection type(ProtectiveEquipmentType type) {
    this.type = type;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ProtectiveEquipmentType getType() {
    return type;
  }
  ...
  public EquipmentDetection coversBodyPart(EquipmentDetectionCoversBodyPart coversBodyPart) {
   ...
   */
  @javax.annotation.Nullable
  public EquipmentDetectionCoversBodyPart getCoversBodyPart() {
    return coversBodyPart;
  }

  public void setCoversBodyPart(EquipmentDetectionCoversBodyPart coversBodyPart) {
    this.coversBodyPart = coversBodyPart;
  }
  ...
  public boolean equals(Object o) {
    ...
    EquipmentDetection equipmentDetection = (EquipmentDetection) o;
    return Objects.equals(this.boundingBox, equipmentDetection.boundingBox) &&
        Objects.equals(this.confidence, equipmentDetection.confidence) &&
        Objects.equals(this.type, equipmentDetection.type) &&
        Objects.equals(this.coversBodyPart, equipmentDetection.coversBodyPart);
  }

  @Override
  public int hashCode() {
    return Objects.hash(boundingBox, confidence, type, coversBodyPart);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EquipmentDetection {\n");
    sb.append("    boundingBox: ").append(toIndentedString(boundingBox)).append("\n");
    sb.append("    confidence: ").append(toIndentedString(confidence)).append("\n");
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    coversBodyPart: ").append(toIndentedString(coversBodyPart)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("CoversBodyPart");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EquipmentDetection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EquipmentDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EquipmentDetection is not found in the empty JSON string", EquipmentDetection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EquipmentDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EquipmentDetection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `BoundingBox`
      if (jsonObj.get("BoundingBox") != null && !jsonObj.get("BoundingBox").isJsonNull()) {
        EquipmentDetectionBoundingBox.validateJsonElement(jsonObj.get("BoundingBox"));
      }
      ...
      if (jsonObj.get("Type") != null && !jsonObj.get("Type").isJsonNull()) {
        ProtectiveEquipmentType.validateJsonElement(jsonObj.get("Type"));
      }
      // validate the optional field `CoversBodyPart`
      if (jsonObj.get("CoversBodyPart") != null && !jsonObj.get("CoversBodyPart").isJsonNull()) {
        EquipmentDetectionCoversBodyPart.validateJsonElement(jsonObj.get("CoversBodyPart"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EquipmentDetection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EquipmentDetection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EquipmentDetection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EquipmentDetection.class));

       return (TypeAdapter<T>) new TypeAdapter<EquipmentDetection>() {
           @Override
           public void write(JsonWriter out, EquipmentDetection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EquipmentDetection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EquipmentDetection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EquipmentDetection
   * @throws IOException if the JSON string is invalid with respect to EquipmentDetection
   */
  public static EquipmentDetection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EquipmentDetection.class);
  }

  /**
   * Convert an instance of EquipmentDetection to an JSON string
   *
   * @return JSON string
   */
