...
import org.openapitools.client.model.PersonDetectionPerson;
...
public class PersonDetection {
  ...
  private PersonDetectionPerson person;

  public PersonDetection() {
  }

  public PersonDetection timestamp(Integer timestamp) {
  ...
  public PersonDetection person(PersonDetectionPerson person) {
    this.person = person;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PersonDetectionPerson getPerson() {
    return person;
  }

  public void setPerson(PersonDetectionPerson person) {
    this.person = person;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersonDetection personDetection = (PersonDetection) o;
    return Objects.equals(this.timestamp, personDetection.timestamp) &&
        Objects.equals(this.person, personDetection.person);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, person);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PersonDetection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonDetection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonDetection is not found in the empty JSON string", PersonDetection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonDetection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Person") != null && !jsonObj.get("Person").isJsonNull()) {
        PersonDetectionPerson.validateJsonElement(jsonObj.get("Person"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonDetection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonDetection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonDetection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonDetection.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonDetection>() {
           @Override
           public void write(JsonWriter out, PersonDetection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonDetection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonDetection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonDetection
   * @throws IOException if the JSON string is invalid with respect to PersonDetection
   */
  public static PersonDetection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonDetection.class);
  }

  /**
   * Convert an instance of PersonDetection to an JSON string
   *
   * @return JSON string
   */
