 ...
 */
@JsonAdapter(SegmentType.Adapter.class)
public enum SegmentType {
  ...
  public static class Adapter extends TypeAdapter<SegmentType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SegmentType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SegmentType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SegmentType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SegmentType.fromValue(value);
  }
}
