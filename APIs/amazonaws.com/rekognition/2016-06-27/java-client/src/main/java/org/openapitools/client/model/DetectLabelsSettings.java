...
import org.openapitools.client.model.DetectLabelsSettingsGeneralLabels;
import org.openapitools.client.model.DetectLabelsSettingsImageProperties;
...
public class DetectLabelsSettings {
  public static final String SERIALIZED_NAME_GENERAL_LABELS = "GeneralLabels";
  @SerializedName(SERIALIZED_NAME_GENERAL_LABELS)
  private DetectLabelsSettingsGeneralLabels generalLabels;
  ...
  private DetectLabelsSettingsImageProperties imageProperties;

  public DetectLabelsSettings() {
  }

  public DetectLabelsSettings generalLabels(DetectLabelsSettingsGeneralLabels generalLabels) {
  ...
  public DetectLabelsSettingsGeneralLabels getGeneralLabels() {
    return generalLabels;
  }

  public void setGeneralLabels(DetectLabelsSettingsGeneralLabels generalLabels) {
    this.generalLabels = generalLabels;
  }


  public DetectLabelsSettings imageProperties(DetectLabelsSettingsImageProperties imageProperties) {
   ...
   */
  @javax.annotation.Nullable
  public DetectLabelsSettingsImageProperties getImageProperties() {
    return imageProperties;
  }

  public void setImageProperties(DetectLabelsSettingsImageProperties imageProperties) {
    this.imageProperties = imageProperties;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsSettings detectLabelsSettings = (DetectLabelsSettings) o;
    return Objects.equals(this.generalLabels, detectLabelsSettings.generalLabels) &&
        Objects.equals(this.imageProperties, detectLabelsSettings.imageProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(generalLabels, imageProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectLabelsSettings {\n");
    sb.append("    generalLabels: ").append(toIndentedString(generalLabels)).append("\n");
  ...
  static {
    ...
    openapiFields.add("GeneralLabels");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsSettings is not found in the empty JSON string", DetectLabelsSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GeneralLabels`
      if (jsonObj.get("GeneralLabels") != null && !jsonObj.get("GeneralLabels").isJsonNull()) {
        DetectLabelsSettingsGeneralLabels.validateJsonElement(jsonObj.get("GeneralLabels"));
      }
      // validate the optional field `ImageProperties`
      if (jsonObj.get("ImageProperties") != null && !jsonObj.get("ImageProperties").isJsonNull()) {
        DetectLabelsSettingsImageProperties.validateJsonElement(jsonObj.get("ImageProperties"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsSettings>() {
           @Override
           public void write(JsonWriter out, DetectLabelsSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsSettings
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsSettings
   */
  public static DetectLabelsSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsSettings.class);
  }

  /**
   * Convert an instance of DetectLabelsSettings to an JSON string
   *
   * @return JSON string
   */
