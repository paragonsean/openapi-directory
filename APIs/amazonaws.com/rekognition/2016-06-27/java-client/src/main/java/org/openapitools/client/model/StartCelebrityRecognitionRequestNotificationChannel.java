...
/**
 * StartCelebrityRecognitionRequestNotificationChannel
 */
...
public class StartCelebrityRecognitionRequestNotificationChannel {
  ...
  public StartCelebrityRecognitionRequestNotificationChannel() {
  }

  public StartCelebrityRecognitionRequestNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public StartCelebrityRecognitionRequestNotificationChannel roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartCelebrityRecognitionRequestNotificationChannel startCelebrityRecognitionRequestNotificationChannel = (StartCelebrityRecognitionRequestNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, startCelebrityRecognitionRequestNotificationChannel.snSTopicArn) &&
        Objects.equals(this.roleArn, startCelebrityRecognitionRequestNotificationChannel.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartCelebrityRecognitionRequestNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartCelebrityRecognitionRequestNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartCelebrityRecognitionRequestNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartCelebrityRecognitionRequestNotificationChannel is not found in the empty JSON string", StartCelebrityRecognitionRequestNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartCelebrityRecognitionRequestNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartCelebrityRecognitionRequestNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartCelebrityRecognitionRequestNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartCelebrityRecognitionRequestNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartCelebrityRecognitionRequestNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartCelebrityRecognitionRequestNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartCelebrityRecognitionRequestNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StartCelebrityRecognitionRequestNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StartCelebrityRecognitionRequestNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartCelebrityRecognitionRequestNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartCelebrityRecognitionRequestNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartCelebrityRecognitionRequestNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StartCelebrityRecognitionRequestNotificationChannel
   */
  public static StartCelebrityRecognitionRequestNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartCelebrityRecognitionRequestNotificationChannel.class);
  }

  /**
   * Convert an instance of StartCelebrityRecognitionRequestNotificationChannel to an JSON string
   *
   * @return JSON string
   */
