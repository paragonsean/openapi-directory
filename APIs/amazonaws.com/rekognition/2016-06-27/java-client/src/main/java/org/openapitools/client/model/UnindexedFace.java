...
public class UnindexedFace {
  ...
  private UnindexedFaceFaceDetail faceDetail;

  public UnindexedFace() {
  }

  public UnindexedFace reasons(List reasons) {
  ...
  public UnindexedFace faceDetail(UnindexedFaceFaceDetail faceDetail) {
   ...
   */
  @javax.annotation.Nullable
  public UnindexedFaceFaceDetail getFaceDetail() {
    return faceDetail;
  }

  public void setFaceDetail(UnindexedFaceFaceDetail faceDetail) {
    this.faceDetail = faceDetail;
  }
  ...
  public boolean equals(Object o) {
    ...
    UnindexedFace unindexedFace = (UnindexedFace) o;
    return Objects.equals(this.reasons, unindexedFace.reasons) &&
        Objects.equals(this.faceDetail, unindexedFace.faceDetail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reasons, faceDetail);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnindexedFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnindexedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnindexedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnindexedFace is not found in the empty JSON string", UnindexedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnindexedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnindexedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("FaceDetail") != null && !jsonObj.get("FaceDetail").isJsonNull()) {
        UnindexedFaceFaceDetail.validateJsonElement(jsonObj.get("FaceDetail"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnindexedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnindexedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnindexedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnindexedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<UnindexedFace>() {
           @Override
           public void write(JsonWriter out, UnindexedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnindexedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnindexedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnindexedFace
   * @throws IOException if the JSON string is invalid with respect to UnindexedFace
   */
  public static UnindexedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnindexedFace.class);
  }

  /**
   * Convert an instance of UnindexedFace to an JSON string
   *
   * @return JSON string
   */
