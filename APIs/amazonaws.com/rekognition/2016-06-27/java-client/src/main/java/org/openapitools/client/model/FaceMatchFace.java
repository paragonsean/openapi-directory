...
public class FaceMatchFace {
  ...
  public FaceMatchFace() {
  }

  public FaceMatchFace faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public FaceMatchFace boundingBox(ComparedFaceBoundingBox boundingBox) {
  ...
  public FaceMatchFace imageId(String imageId) {
  ...
  public FaceMatchFace externalImageId(String externalImageId) {
  ...
  public FaceMatchFace confidence(Float confidence) {
  ...
  public FaceMatchFace indexFacesModelVersion(String indexFacesModelVersion) {
  ...
  public FaceMatchFace userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FaceMatchFace faceMatchFace = (FaceMatchFace) o;
    return Objects.equals(this.faceId, faceMatchFace.faceId) &&
        Objects.equals(this.boundingBox, faceMatchFace.boundingBox) &&
        Objects.equals(this.imageId, faceMatchFace.imageId) &&
        Objects.equals(this.externalImageId, faceMatchFace.externalImageId) &&
        Objects.equals(this.confidence, faceMatchFace.confidence) &&
        Objects.equals(this.indexFacesModelVersion, faceMatchFace.indexFacesModelVersion) &&
        Objects.equals(this.userId, faceMatchFace.userId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceMatchFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceMatchFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceMatchFace is not found in the empty JSON string", FaceMatchFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceMatchFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceMatchFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceMatchFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceMatchFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceMatchFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceMatchFace.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceMatchFace>() {
           @Override
           public void write(JsonWriter out, FaceMatchFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceMatchFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceMatchFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceMatchFace
   * @throws IOException if the JSON string is invalid with respect to FaceMatchFace
   */
  public static FaceMatchFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceMatchFace.class);
  }

  /**
   * Convert an instance of FaceMatchFace to an JSON string
   *
   * @return JSON string
   */
