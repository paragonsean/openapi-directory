...
public class GetSegmentDetectionRequest {
  ...
  public GetSegmentDetectionRequest() {
  }

  public GetSegmentDetectionRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetSegmentDetectionRequest maxResults(Integer maxResults) {
  ...
  public GetSegmentDetectionRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetSegmentDetectionRequest getSegmentDetectionRequest = (GetSegmentDetectionRequest) o;
    return Objects.equals(this.jobId, getSegmentDetectionRequest.jobId) &&
        Objects.equals(this.maxResults, getSegmentDetectionRequest.maxResults) &&
        Objects.equals(this.nextToken, getSegmentDetectionRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSegmentDetectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSegmentDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSegmentDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSegmentDetectionRequest is not found in the empty JSON string", GetSegmentDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSegmentDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSegmentDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetSegmentDetectionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSegmentDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSegmentDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSegmentDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSegmentDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSegmentDetectionRequest>() {
           @Override
           public void write(JsonWriter out, GetSegmentDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSegmentDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSegmentDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSegmentDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to GetSegmentDetectionRequest
   */
  public static GetSegmentDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSegmentDetectionRequest.class);
  }

  /**
   * Convert an instance of GetSegmentDetectionRequest to an JSON string
   *
   * @return JSON string
   */
