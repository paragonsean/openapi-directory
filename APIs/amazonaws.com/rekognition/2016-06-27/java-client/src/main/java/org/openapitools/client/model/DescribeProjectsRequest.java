...
public class DescribeProjectsRequest {
  ...
  public DescribeProjectsRequest nextToken(String nextToken) {
  ...
  public DescribeProjectsRequest maxResults(Integer maxResults) {
  ...
  public DescribeProjectsRequest projectNames(List projectNames) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeProjectsRequest describeProjectsRequest = (DescribeProjectsRequest) o;
    return Objects.equals(this.nextToken, describeProjectsRequest.nextToken) &&
        Objects.equals(this.maxResults, describeProjectsRequest.maxResults) &&
        Objects.equals(this.projectNames, describeProjectsRequest.projectNames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, maxResults, projectNames);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeProjectsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeProjectsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeProjectsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeProjectsRequest is not found in the empty JSON string", DescribeProjectsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeProjectsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeProjectsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `ProjectNames`
      if (jsonObj.get("ProjectNames") != null && !jsonObj.get("ProjectNames").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ProjectNames"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeProjectsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeProjectsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeProjectsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeProjectsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeProjectsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeProjectsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeProjectsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeProjectsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeProjectsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeProjectsRequest
   */
  public static DescribeProjectsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeProjectsRequest.class);
  }

  /**
   * Convert an instance of DescribeProjectsRequest to an JSON string
   *
   * @return JSON string
   */
