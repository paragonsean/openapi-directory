...
public class DeleteCollectionResponse {
  ...
  public DeleteCollectionResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusCode, deleteCollectionResponse.statusCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteCollectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCollectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCollectionResponse is not found in the empty JSON string", DeleteCollectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCollectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCollectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCollectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCollectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCollectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCollectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCollectionResponse>() {
           @Override
           public void write(JsonWriter out, DeleteCollectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCollectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteCollectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteCollectionResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteCollectionResponse
   */
  public static DeleteCollectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCollectionResponse.class);
  }

  /**
   * Convert an instance of DeleteCollectionResponse to an JSON string
   *
   * @return JSON string
   */
