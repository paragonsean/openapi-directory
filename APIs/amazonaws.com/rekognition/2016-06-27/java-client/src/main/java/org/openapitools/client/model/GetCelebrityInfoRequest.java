...
public class GetCelebrityInfoRequest {
  ...
  public GetCelebrityInfoRequest() {
  }

  public GetCelebrityInfoRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCelebrityInfoRequest getCelebrityInfoRequest = (GetCelebrityInfoRequest) o;
    return Objects.equals(this.id, getCelebrityInfoRequest.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCelebrityInfoRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCelebrityInfoRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCelebrityInfoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCelebrityInfoRequest is not found in the empty JSON string", GetCelebrityInfoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCelebrityInfoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCelebrityInfoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCelebrityInfoRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCelebrityInfoRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCelebrityInfoRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCelebrityInfoRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCelebrityInfoRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCelebrityInfoRequest>() {
           @Override
           public void write(JsonWriter out, GetCelebrityInfoRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCelebrityInfoRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCelebrityInfoRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCelebrityInfoRequest
   * @throws IOException if the JSON string is invalid with respect to GetCelebrityInfoRequest
   */
  public static GetCelebrityInfoRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCelebrityInfoRequest.class);
  }

  /**
   * Convert an instance of GetCelebrityInfoRequest to an JSON string
   *
   * @return JSON string
   */
