...
/**
 * Gets or Sets StreamProcessorParameterToDelete
 */
@JsonAdapter(StreamProcessorParameterToDelete.Adapter.class)
public enum StreamProcessorParameterToDelete {
  ...
  StreamProcessorParameterToDelete(String value) {
    this.value = value;
  }
  ...
  public static StreamProcessorParameterToDelete fromValue(String value) {
    for (StreamProcessorParameterToDelete b : StreamProcessorParameterToDelete.values()) {
  ...
  public static class Adapter extends TypeAdapter<StreamProcessorParameterToDelete> {
    @Override
    public void write(final JsonWriter jsonWriter, final StreamProcessorParameterToDelete enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StreamProcessorParameterToDelete read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StreamProcessorParameterToDelete.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StreamProcessorParameterToDelete.fromValue(value);
  }
}
