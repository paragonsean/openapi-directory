...
import org.openapitools.client.model.LandmarkType;
...
public class Landmark {
  ...
  public Landmark type(LandmarkType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, landmark.type) &&
        Objects.equals(this.X, landmark.X) &&
        Objects.equals(this.Y, landmark.Y);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Type") != null && !jsonObj.get("Type").isJsonNull()) {
        LandmarkType.validateJsonElement(jsonObj.get("Type"));
      }
