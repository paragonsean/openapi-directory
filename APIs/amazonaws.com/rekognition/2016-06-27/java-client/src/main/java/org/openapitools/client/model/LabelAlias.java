...
public class LabelAlias {
  ...
  public LabelAlias name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LabelAlias labelAlias = (LabelAlias) o;
    return Objects.equals(this.name, labelAlias.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabelAlias
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabelAlias.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabelAlias is not found in the empty JSON string", LabelAlias.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabelAlias.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabelAlias` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabelAlias.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabelAlias' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabelAlias> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabelAlias.class));

       return (TypeAdapter<T>) new TypeAdapter<LabelAlias>() {
           @Override
           public void write(JsonWriter out, LabelAlias value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabelAlias read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabelAlias given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabelAlias
   * @throws IOException if the JSON string is invalid with respect to LabelAlias
   */
  public static LabelAlias fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabelAlias.class);
  }

  /**
   * Convert an instance of LabelAlias to an JSON string
   *
   * @return JSON string
   */
