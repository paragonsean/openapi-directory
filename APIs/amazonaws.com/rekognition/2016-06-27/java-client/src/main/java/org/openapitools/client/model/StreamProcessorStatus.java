...
/**
 * Gets or Sets StreamProcessorStatus
 */
@JsonAdapter(StreamProcessorStatus.Adapter.class)
public enum StreamProcessorStatus {
  ...
  StreamProcessorStatus(String value) {
    this.value = value;
  }
  ...
  public static StreamProcessorStatus fromValue(String value) {
    for (StreamProcessorStatus b : StreamProcessorStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<StreamProcessorStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final StreamProcessorStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StreamProcessorStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StreamProcessorStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StreamProcessorStatus.fromValue(value);
  }
}
