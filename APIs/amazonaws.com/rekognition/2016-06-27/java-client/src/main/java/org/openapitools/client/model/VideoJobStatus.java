...
/**
 * Gets or Sets VideoJobStatus
 */
@JsonAdapter(VideoJobStatus.Adapter.class)
public enum VideoJobStatus {
  ...
  public static VideoJobStatus fromValue(String value) {
    for (VideoJobStatus b : VideoJobStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<VideoJobStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final VideoJobStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VideoJobStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VideoJobStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VideoJobStatus.fromValue(value);
  }
}
