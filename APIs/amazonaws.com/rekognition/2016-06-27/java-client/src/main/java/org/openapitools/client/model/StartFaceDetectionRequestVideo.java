...
public class StartFaceDetectionRequestVideo {
  ...
  public StartFaceDetectionRequestVideo() {
  }

  public StartFaceDetectionRequestVideo s3Object(VideoS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    StartFaceDetectionRequestVideo startFaceDetectionRequestVideo = (StartFaceDetectionRequestVideo) o;
    return Objects.equals(this.s3Object, startFaceDetectionRequestVideo.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFaceDetectionRequestVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFaceDetectionRequestVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFaceDetectionRequestVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFaceDetectionRequestVideo is not found in the empty JSON string", StartFaceDetectionRequestVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFaceDetectionRequestVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFaceDetectionRequestVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFaceDetectionRequestVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFaceDetectionRequestVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFaceDetectionRequestVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFaceDetectionRequestVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFaceDetectionRequestVideo>() {
           @Override
           public void write(JsonWriter out, StartFaceDetectionRequestVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFaceDetectionRequestVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFaceDetectionRequestVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFaceDetectionRequestVideo
   * @throws IOException if the JSON string is invalid with respect to StartFaceDetectionRequestVideo
   */
  public static StartFaceDetectionRequestVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFaceDetectionRequestVideo.class);
  }

  /**
   * Convert an instance of StartFaceDetectionRequestVideo to an JSON string
   *
   * @return JSON string
   */
