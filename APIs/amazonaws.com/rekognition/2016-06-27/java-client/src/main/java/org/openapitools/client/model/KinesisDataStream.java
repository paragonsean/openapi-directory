...
public class KinesisDataStream {
  ...
  public KinesisDataStream() {
  }

  public KinesisDataStream arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KinesisDataStream kinesisDataStream = (KinesisDataStream) o;
    return Objects.equals(this.arn, kinesisDataStream.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class KinesisDataStream {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KinesisDataStream
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KinesisDataStream.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KinesisDataStream is not found in the empty JSON string", KinesisDataStream.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KinesisDataStream.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KinesisDataStream` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KinesisDataStream.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KinesisDataStream' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KinesisDataStream> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KinesisDataStream.class));

       return (TypeAdapter<T>) new TypeAdapter<KinesisDataStream>() {
           @Override
           public void write(JsonWriter out, KinesisDataStream value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KinesisDataStream read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KinesisDataStream given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KinesisDataStream
   * @throws IOException if the JSON string is invalid with respect to KinesisDataStream
   */
  public static KinesisDataStream fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KinesisDataStream.class);
  }

  /**
   * Convert an instance of KinesisDataStream to an JSON string
   *
   * @return JSON string
   */
