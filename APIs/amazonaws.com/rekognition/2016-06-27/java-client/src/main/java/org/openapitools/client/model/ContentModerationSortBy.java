...
/**
 * Gets or Sets ContentModerationSortBy
 */
@JsonAdapter(ContentModerationSortBy.Adapter.class)
public enum ContentModerationSortBy {
  ...
  ContentModerationSortBy(String value) {
    this.value = value;
  }
  ...
  public static ContentModerationSortBy fromValue(String value) {
    for (ContentModerationSortBy b : ContentModerationSortBy.values()) {
  ...
  public static class Adapter extends TypeAdapter<ContentModerationSortBy> {
    @Override
    public void write(final JsonWriter jsonWriter, final ContentModerationSortBy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ContentModerationSortBy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ContentModerationSortBy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ContentModerationSortBy.fromValue(value);
  }
}
