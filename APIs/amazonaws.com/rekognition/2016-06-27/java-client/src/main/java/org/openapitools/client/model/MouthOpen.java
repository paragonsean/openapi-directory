...
public class MouthOpen {
  ...
  public MouthOpen value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public MouthOpen confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    MouthOpen mouthOpen = (MouthOpen) o;
    return Objects.equals(this.value, mouthOpen.value) &&
        Objects.equals(this.confidence, mouthOpen.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MouthOpen
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MouthOpen.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MouthOpen is not found in the empty JSON string", MouthOpen.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MouthOpen.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MouthOpen` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MouthOpen.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MouthOpen' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MouthOpen> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MouthOpen.class));

       return (TypeAdapter<T>) new TypeAdapter<MouthOpen>() {
           @Override
           public void write(JsonWriter out, MouthOpen value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MouthOpen read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MouthOpen given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MouthOpen
   * @throws IOException if the JSON string is invalid with respect to MouthOpen
   */
  public static MouthOpen fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MouthOpen.class);
  }

  /**
   * Convert an instance of MouthOpen to an JSON string
   *
   * @return JSON string
   */
