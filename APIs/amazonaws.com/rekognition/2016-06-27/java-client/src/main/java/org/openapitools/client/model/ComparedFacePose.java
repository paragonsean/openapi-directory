...
public class ComparedFacePose {
  ...
  public ComparedFacePose() {
  }

  public ComparedFacePose roll(Float roll) {
    this.roll = roll;
    return this;
  }
  ...
  public ComparedFacePose yaw(Float yaw) {
    this.yaw = yaw;
    return this;
  }
  ...
  public ComparedFacePose pitch(Float pitch) {
    this.pitch = pitch;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ComparedFacePose comparedFacePose = (ComparedFacePose) o;
    return Objects.equals(this.roll, comparedFacePose.roll) &&
        Objects.equals(this.yaw, comparedFacePose.yaw) &&
        Objects.equals(this.pitch, comparedFacePose.pitch);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComparedFacePose {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComparedFacePose
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComparedFacePose.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComparedFacePose is not found in the empty JSON string", ComparedFacePose.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComparedFacePose.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComparedFacePose` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComparedFacePose.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComparedFacePose' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComparedFacePose> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComparedFacePose.class));

       return (TypeAdapter<T>) new TypeAdapter<ComparedFacePose>() {
           @Override
           public void write(JsonWriter out, ComparedFacePose value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComparedFacePose read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComparedFacePose given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComparedFacePose
   * @throws IOException if the JSON string is invalid with respect to ComparedFacePose
   */
  public static ComparedFacePose fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComparedFacePose.class);
  }

  /**
   * Convert an instance of ComparedFacePose to an JSON string
   *
   * @return JSON string
   */
