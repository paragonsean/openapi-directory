...
public class DetectLabelsRequest {
  ...
  private DetectLabelsRequestImage image;

  public static final String SERIALIZED_NAME_MAX_LABELS = "MaxLabels";
  @SerializedName(SERIALIZED_NAME_MAX_LABELS)
  ...
  private DetectLabelsRequestSettings settings;

  public DetectLabelsRequest() {
  }

  public DetectLabelsRequest image(DetectLabelsRequestImage image) {
    this.image = image;
    return this;
  }
  ...
  public DetectLabelsRequestImage getImage() {
    return image;
  }

  public void setImage(DetectLabelsRequestImage image) {
    this.image = image;
  }


  public DetectLabelsRequest maxLabels(Integer maxLabels) {
  ...
  public DetectLabelsRequest minConfidence(Float minConfidence) {
  ...
  public DetectLabelsRequest features(List features) {
  ...
  public DetectLabelsRequest settings(DetectLabelsRequestSettings settings) {
   ...
   */
  @javax.annotation.Nullable
  public DetectLabelsRequestSettings getSettings() {
    return settings;
  }

  public void setSettings(DetectLabelsRequestSettings settings) {
    this.settings = settings;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsRequest detectLabelsRequest = (DetectLabelsRequest) o;
    return Objects.equals(this.image, detectLabelsRequest.image) &&
        Objects.equals(this.maxLabels, detectLabelsRequest.maxLabels) &&
        Objects.equals(this.minConfidence, detectLabelsRequest.minConfidence) &&
        Objects.equals(this.features, detectLabelsRequest.features) &&
        Objects.equals(this.settings, detectLabelsRequest.settings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(image, maxLabels, minConfidence, features, settings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectLabelsRequest {\n");
    sb.append("    image: ").append(toIndentedString(image)).append("\n");
    sb.append("    maxLabels: ").append(toIndentedString(maxLabels)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsRequest is not found in the empty JSON string", DetectLabelsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectLabelsRequest.openapiRequiredFields) {
      ...
      DetectLabelsRequestImage.validateJsonElement(jsonObj.get("Image"));
      // validate the optional field `MaxLabels`
      if (jsonObj.get("MaxLabels") != null && !jsonObj.get("MaxLabels").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("MaxLabels"));
      }
      ...
      if (jsonObj.get("Settings") != null && !jsonObj.get("Settings").isJsonNull()) {
        DetectLabelsRequestSettings.validateJsonElement(jsonObj.get("Settings"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsRequest>() {
           @Override
           public void write(JsonWriter out, DetectLabelsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsRequest
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsRequest
   */
  public static DetectLabelsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsRequest.class);
  }

  /**
   * Convert an instance of DetectLabelsRequest to an JSON string
   *
   * @return JSON string
   */
