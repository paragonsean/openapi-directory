...
import org.openapitools.client.model.DetectLabelsImageBackgroundQuality;
...
/**
 * DetectLabelsImagePropertiesBackground
 */
...
public class DetectLabelsImagePropertiesBackground {
  public static final String SERIALIZED_NAME_QUALITY = "Quality";
  @SerializedName(SERIALIZED_NAME_QUALITY)
  private DetectLabelsImageBackgroundQuality quality;
  ...
  public DetectLabelsImagePropertiesBackground() {
  }

  public DetectLabelsImagePropertiesBackground quality(DetectLabelsImageBackgroundQuality quality) {
  ...
  public DetectLabelsImageBackgroundQuality getQuality() {
    return quality;
  }

  public void setQuality(DetectLabelsImageBackgroundQuality quality) {
    this.quality = quality;
  }


  public DetectLabelsImagePropertiesBackground dominantColors(List dominantColors) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImagePropertiesBackground detectLabelsImagePropertiesBackground = (DetectLabelsImagePropertiesBackground) o;
    return Objects.equals(this.quality, detectLabelsImagePropertiesBackground.quality) &&
        Objects.equals(this.dominantColors, detectLabelsImagePropertiesBackground.dominantColors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsImagePropertiesBackground {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImagePropertiesBackground
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImagePropertiesBackground.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImagePropertiesBackground is not found in the empty JSON string", DetectLabelsImagePropertiesBackground.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImagePropertiesBackground.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImagePropertiesBackground` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Quality`
      if (jsonObj.get("Quality") != null && !jsonObj.get("Quality").isJsonNull()) {
        DetectLabelsImageBackgroundQuality.validateJsonElement(jsonObj.get("Quality"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImagePropertiesBackground.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImagePropertiesBackground' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImagePropertiesBackground> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImagePropertiesBackground.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImagePropertiesBackground>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImagePropertiesBackground value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImagePropertiesBackground read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImagePropertiesBackground given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImagePropertiesBackground
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImagePropertiesBackground
   */
  public static DetectLabelsImagePropertiesBackground fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImagePropertiesBackground.class);
  }

  /**
   * Convert an instance of DetectLabelsImagePropertiesBackground to an JSON string
   *
   * @return JSON string
   */
