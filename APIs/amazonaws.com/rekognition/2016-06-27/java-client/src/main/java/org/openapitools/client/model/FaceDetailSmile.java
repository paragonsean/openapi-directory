...
public class FaceDetailSmile {
  ...
  public FaceDetailSmile() {
  }

  public FaceDetailSmile value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailSmile confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailSmile faceDetailSmile = (FaceDetailSmile) o;
    return Objects.equals(this.value, faceDetailSmile.value) &&
        Objects.equals(this.confidence, faceDetailSmile.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailSmile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailSmile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailSmile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailSmile is not found in the empty JSON string", FaceDetailSmile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailSmile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailSmile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailSmile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailSmile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailSmile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailSmile.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailSmile>() {
           @Override
           public void write(JsonWriter out, FaceDetailSmile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailSmile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailSmile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailSmile
   * @throws IOException if the JSON string is invalid with respect to FaceDetailSmile
   */
  public static FaceDetailSmile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailSmile.class);
  }

  /**
   * Convert an instance of FaceDetailSmile to an JSON string
   *
   * @return JSON string
   */
