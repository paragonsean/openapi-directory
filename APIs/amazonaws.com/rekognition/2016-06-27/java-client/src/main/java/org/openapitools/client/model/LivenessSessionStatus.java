...
/**
 * Gets or Sets LivenessSessionStatus
 */
@JsonAdapter(LivenessSessionStatus.Adapter.class)
public enum LivenessSessionStatus {
  ...
  LivenessSessionStatus(String value) {
    this.value = value;
  }
  ...
  public static LivenessSessionStatus fromValue(String value) {
    for (LivenessSessionStatus b : LivenessSessionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<LivenessSessionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final LivenessSessionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LivenessSessionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LivenessSessionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LivenessSessionStatus.fromValue(value);
  }
}
