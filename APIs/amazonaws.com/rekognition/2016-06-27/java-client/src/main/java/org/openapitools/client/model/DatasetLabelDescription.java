...
import org.openapitools.client.model.DatasetLabelDescriptionLabelStats;
...
public class DatasetLabelDescription {
  ...
  private DatasetLabelDescriptionLabelStats labelStats;

  public DatasetLabelDescription() {
  }

  public DatasetLabelDescription labelName(String labelName) {
  ...
  public DatasetLabelDescription labelStats(DatasetLabelDescriptionLabelStats labelStats) {
   ...
   */
  @javax.annotation.Nullable
  public DatasetLabelDescriptionLabelStats getLabelStats() {
    return labelStats;
  }

  public void setLabelStats(DatasetLabelDescriptionLabelStats labelStats) {
    this.labelStats = labelStats;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatasetLabelDescription datasetLabelDescription = (DatasetLabelDescription) o;
    return Objects.equals(this.labelName, datasetLabelDescription.labelName) &&
        Objects.equals(this.labelStats, datasetLabelDescription.labelStats);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labelName, labelStats);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatasetLabelDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetLabelDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetLabelDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetLabelDescription is not found in the empty JSON string", DatasetLabelDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetLabelDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetLabelDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `LabelName`
      if (jsonObj.get("LabelName") != null && !jsonObj.get("LabelName").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("LabelName"));
      }
      // validate the optional field `LabelStats`
      if (jsonObj.get("LabelStats") != null && !jsonObj.get("LabelStats").isJsonNull()) {
        DatasetLabelDescriptionLabelStats.validateJsonElement(jsonObj.get("LabelStats"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetLabelDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetLabelDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetLabelDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetLabelDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetLabelDescription>() {
           @Override
           public void write(JsonWriter out, DatasetLabelDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetLabelDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetLabelDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetLabelDescription
   * @throws IOException if the JSON string is invalid with respect to DatasetLabelDescription
   */
  public static DatasetLabelDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetLabelDescription.class);
  }

  /**
   * Convert an instance of DatasetLabelDescription to an JSON string
   *
   * @return JSON string
   */
