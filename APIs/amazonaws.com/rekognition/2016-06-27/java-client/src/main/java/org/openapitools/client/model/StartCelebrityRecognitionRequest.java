...
public class StartCelebrityRecognitionRequest {
  ...
  private StartCelebrityRecognitionRequestVideo video;
  ...
  private StartCelebrityRecognitionRequestNotificationChannel notificationChannel;

  public static final String SERIALIZED_NAME_JOB_TAG = "JobTag";
  @SerializedName(SERIALIZED_NAME_JOB_TAG)
  private String jobTag;

  public StartCelebrityRecognitionRequest() {
  }

  public StartCelebrityRecognitionRequest video(StartCelebrityRecognitionRequestVideo video) {
    this.video = video;
    return this;
  }
  ...
  public StartCelebrityRecognitionRequestVideo getVideo() {
    return video;
  }

  public void setVideo(StartCelebrityRecognitionRequestVideo video) {
    this.video = video;
  }


  public StartCelebrityRecognitionRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartCelebrityRecognitionRequest notificationChannel(StartCelebrityRecognitionRequestNotificationChannel notificationChannel) {
   ...
   */
  @javax.annotation.Nullable
  public StartCelebrityRecognitionRequestNotificationChannel getNotificationChannel() {
    return notificationChannel;
  }

  public void setNotificationChannel(StartCelebrityRecognitionRequestNotificationChannel notificationChannel) {
    this.notificationChannel = notificationChannel;
  }


  public StartCelebrityRecognitionRequest jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartCelebrityRecognitionRequest startCelebrityRecognitionRequest = (StartCelebrityRecognitionRequest) o;
    return Objects.equals(this.video, startCelebrityRecognitionRequest.video) &&
        Objects.equals(this.clientRequestToken, startCelebrityRecognitionRequest.clientRequestToken) &&
        Objects.equals(this.notificationChannel, startCelebrityRecognitionRequest.notificationChannel) &&
        Objects.equals(this.jobTag, startCelebrityRecognitionRequest.jobTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(video, clientRequestToken, notificationChannel, jobTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartCelebrityRecognitionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartCelebrityRecognitionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartCelebrityRecognitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartCelebrityRecognitionRequest is not found in the empty JSON string", StartCelebrityRecognitionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartCelebrityRecognitionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartCelebrityRecognitionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartCelebrityRecognitionRequest.openapiRequiredFields) {
      ...
      StartCelebrityRecognitionRequestVideo.validateJsonElement(jsonObj.get("Video"));
      ...
      if (jsonObj.get("NotificationChannel") != null && !jsonObj.get("NotificationChannel").isJsonNull()) {
        StartCelebrityRecognitionRequestNotificationChannel.validateJsonElement(jsonObj.get("NotificationChannel"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartCelebrityRecognitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartCelebrityRecognitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartCelebrityRecognitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartCelebrityRecognitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartCelebrityRecognitionRequest>() {
           @Override
           public void write(JsonWriter out, StartCelebrityRecognitionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartCelebrityRecognitionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartCelebrityRecognitionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartCelebrityRecognitionRequest
   * @throws IOException if the JSON string is invalid with respect to StartCelebrityRecognitionRequest
   */
  public static StartCelebrityRecognitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartCelebrityRecognitionRequest.class);
  }

  /**
   * Convert an instance of StartCelebrityRecognitionRequest to an JSON string
   *
   * @return JSON string
   */
