...
public class EyeDirection {
  ...
  public EyeDirection yaw(Float yaw) {
    this.yaw = yaw;
    return this;
  }
  ...
  public EyeDirection pitch(Float pitch) {
    this.pitch = pitch;
    return this;
  }
  ...
  public EyeDirection confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    EyeDirection eyeDirection = (EyeDirection) o;
    return Objects.equals(this.yaw, eyeDirection.yaw) &&
        Objects.equals(this.pitch, eyeDirection.pitch) &&
        Objects.equals(this.confidence, eyeDirection.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EyeDirection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EyeDirection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EyeDirection is not found in the empty JSON string", EyeDirection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EyeDirection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EyeDirection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EyeDirection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EyeDirection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EyeDirection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EyeDirection.class));

       return (TypeAdapter<T>) new TypeAdapter<EyeDirection>() {
           @Override
           public void write(JsonWriter out, EyeDirection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EyeDirection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EyeDirection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EyeDirection
   * @throws IOException if the JSON string is invalid with respect to EyeDirection
   */
  public static EyeDirection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EyeDirection.class);
  }

  /**
   * Convert an instance of EyeDirection to an JSON string
   *
   * @return JSON string
   */
