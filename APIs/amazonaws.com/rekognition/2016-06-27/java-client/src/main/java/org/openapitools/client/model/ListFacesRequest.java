...
public class ListFacesRequest {
  ...
  public ListFacesRequest collectionId(String collectionId) {
  ...
  public ListFacesRequest nextToken(String nextToken) {
  ...
  public ListFacesRequest maxResults(Integer maxResults) {
  ...
  public ListFacesRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public ListFacesRequest faceIds(List faceIds) {
  ...
  public boolean equals(Object o) {
    ...
    ListFacesRequest listFacesRequest = (ListFacesRequest) o;
    return Objects.equals(this.collectionId, listFacesRequest.collectionId) &&
        Objects.equals(this.nextToken, listFacesRequest.nextToken) &&
        Objects.equals(this.maxResults, listFacesRequest.maxResults) &&
        Objects.equals(this.userId, listFacesRequest.userId) &&
        Objects.equals(this.faceIds, listFacesRequest.faceIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, nextToken, maxResults, userId, faceIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListFacesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFacesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFacesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFacesRequest is not found in the empty JSON string", ListFacesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFacesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFacesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListFacesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFacesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFacesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFacesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFacesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFacesRequest>() {
           @Override
           public void write(JsonWriter out, ListFacesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFacesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFacesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFacesRequest
   * @throws IOException if the JSON string is invalid with respect to ListFacesRequest
   */
  public static ListFacesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFacesRequest.class);
  }

  /**
   * Convert an instance of ListFacesRequest to an JSON string
   *
   * @return JSON string
   */
