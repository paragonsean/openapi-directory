...
/**
 * DatasetLabelDescriptionLabelStats
 */
...
public class DatasetLabelDescriptionLabelStats {
  ...
  public DatasetLabelDescriptionLabelStats() {
  }

  public DatasetLabelDescriptionLabelStats entryCount(Integer entryCount) {
  ...
  public DatasetLabelDescriptionLabelStats boundingBoxCount(Integer boundingBoxCount) {
  ...
  public boolean equals(Object o) {
    ...
    DatasetLabelDescriptionLabelStats datasetLabelDescriptionLabelStats = (DatasetLabelDescriptionLabelStats) o;
    return Objects.equals(this.entryCount, datasetLabelDescriptionLabelStats.entryCount) &&
        Objects.equals(this.boundingBoxCount, datasetLabelDescriptionLabelStats.boundingBoxCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatasetLabelDescriptionLabelStats {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetLabelDescriptionLabelStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetLabelDescriptionLabelStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetLabelDescriptionLabelStats is not found in the empty JSON string", DatasetLabelDescriptionLabelStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetLabelDescriptionLabelStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetLabelDescriptionLabelStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetLabelDescriptionLabelStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetLabelDescriptionLabelStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetLabelDescriptionLabelStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetLabelDescriptionLabelStats.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetLabelDescriptionLabelStats>() {
           @Override
           public void write(JsonWriter out, DatasetLabelDescriptionLabelStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetLabelDescriptionLabelStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetLabelDescriptionLabelStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetLabelDescriptionLabelStats
   * @throws IOException if the JSON string is invalid with respect to DatasetLabelDescriptionLabelStats
   */
  public static DatasetLabelDescriptionLabelStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetLabelDescriptionLabelStats.class);
  }

  /**
   * Convert an instance of DatasetLabelDescriptionLabelStats to an JSON string
   *
   * @return JSON string
   */
