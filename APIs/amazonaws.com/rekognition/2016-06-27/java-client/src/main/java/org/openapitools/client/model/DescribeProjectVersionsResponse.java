...
public class DescribeProjectVersionsResponse {
  public static final String SERIALIZED_NAME_PROJECT_VERSION_DESCRIPTIONS = "ProjectVersionDescriptions";
  @SerializedName(SERIALIZED_NAME_PROJECT_VERSION_DESCRIPTIONS)
  private List projectVersionDescriptions;
  ...
  public DescribeProjectVersionsResponse projectVersionDescriptions(List projectVersionDescriptions) {
  ...
  public List getProjectVersionDescriptions() {
    return projectVersionDescriptions;
  }

  public void setProjectVersionDescriptions(List projectVersionDescriptions) {
    this.projectVersionDescriptions = projectVersionDescriptions;
  }


  public DescribeProjectVersionsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeProjectVersionsResponse describeProjectVersionsResponse = (DescribeProjectVersionsResponse) o;
    return Objects.equals(this.projectVersionDescriptions, describeProjectVersionsResponse.projectVersionDescriptions) &&
        Objects.equals(this.nextToken, describeProjectVersionsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectVersionDescriptions, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeProjectVersionsResponse {\n");
    sb.append("    projectVersionDescriptions: ").append(toIndentedString(projectVersionDescriptions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ProjectVersionDescriptions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeProjectVersionsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeProjectVersionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeProjectVersionsResponse is not found in the empty JSON string", DescribeProjectVersionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeProjectVersionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeProjectVersionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ProjectVersionDescriptions`
      if (jsonObj.get("ProjectVersionDescriptions") != null && !jsonObj.get("ProjectVersionDescriptions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ProjectVersionDescriptions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeProjectVersionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeProjectVersionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeProjectVersionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeProjectVersionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeProjectVersionsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeProjectVersionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeProjectVersionsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeProjectVersionsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeProjectVersionsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeProjectVersionsResponse
   */
  public static DescribeProjectVersionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeProjectVersionsResponse.class);
  }

  /**
   * Convert an instance of DescribeProjectVersionsResponse to an JSON string
   *
   * @return JSON string
   */
