...
public class ComparedFaceBoundingBox {
  ...
  public ComparedFaceBoundingBox() {
  }

  public ComparedFaceBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public ComparedFaceBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public ComparedFaceBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public ComparedFaceBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ComparedFaceBoundingBox comparedFaceBoundingBox = (ComparedFaceBoundingBox) o;
    return Objects.equals(this.width, comparedFaceBoundingBox.width) &&
        Objects.equals(this.height, comparedFaceBoundingBox.height) &&
        Objects.equals(this.left, comparedFaceBoundingBox.left) &&
        Objects.equals(this.top, comparedFaceBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComparedFaceBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComparedFaceBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComparedFaceBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComparedFaceBoundingBox is not found in the empty JSON string", ComparedFaceBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComparedFaceBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComparedFaceBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComparedFaceBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComparedFaceBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComparedFaceBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComparedFaceBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<ComparedFaceBoundingBox>() {
           @Override
           public void write(JsonWriter out, ComparedFaceBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComparedFaceBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComparedFaceBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComparedFaceBoundingBox
   * @throws IOException if the JSON string is invalid with respect to ComparedFaceBoundingBox
   */
  public static ComparedFaceBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComparedFaceBoundingBox.class);
  }

  /**
   * Convert an instance of ComparedFaceBoundingBox to an JSON string
   *
   * @return JSON string
   */
