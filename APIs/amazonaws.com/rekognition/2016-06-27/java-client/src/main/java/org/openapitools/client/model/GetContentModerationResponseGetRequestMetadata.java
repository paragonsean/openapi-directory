...
import org.openapitools.client.model.ContentModerationAggregateBy;
import org.openapitools.client.model.ContentModerationSortBy;
...
/**
 * GetContentModerationResponseGetRequestMetadata
 */
...
public class GetContentModerationResponseGetRequestMetadata {
  public static final String SERIALIZED_NAME_SORT_BY = "SortBy";
  @SerializedName(SERIALIZED_NAME_SORT_BY)
  private ContentModerationSortBy sortBy;

  public static final String SERIALIZED_NAME_AGGREGATE_BY = "AggregateBy";
  @SerializedName(SERIALIZED_NAME_AGGREGATE_BY)
  private ContentModerationAggregateBy aggregateBy;

  public GetContentModerationResponseGetRequestMetadata() {
  }

  public GetContentModerationResponseGetRequestMetadata sortBy(ContentModerationSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public ContentModerationSortBy getSortBy() {
    return sortBy;
  }
  ...
  public GetContentModerationResponseGetRequestMetadata aggregateBy(ContentModerationAggregateBy aggregateBy) {
   ...
   */
  @javax.annotation.Nullable
  public ContentModerationAggregateBy getAggregateBy() {
    return aggregateBy;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetContentModerationResponseGetRequestMetadata getContentModerationResponseGetRequestMetadata = (GetContentModerationResponseGetRequestMetadata) o;
    return Objects.equals(this.sortBy, getContentModerationResponseGetRequestMetadata.sortBy) &&
        Objects.equals(this.aggregateBy, getContentModerationResponseGetRequestMetadata.aggregateBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sortBy, aggregateBy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetContentModerationResponseGetRequestMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetContentModerationResponseGetRequestMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetContentModerationResponseGetRequestMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetContentModerationResponseGetRequestMetadata is not found in the empty JSON string", GetContentModerationResponseGetRequestMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetContentModerationResponseGetRequestMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetContentModerationResponseGetRequestMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `SortBy`
      if (jsonObj.get("SortBy") != null && !jsonObj.get("SortBy").isJsonNull()) {
        ContentModerationSortBy.validateJsonElement(jsonObj.get("SortBy"));
      }
      // validate the optional field `AggregateBy`
      if (jsonObj.get("AggregateBy") != null && !jsonObj.get("AggregateBy").isJsonNull()) {
        ContentModerationAggregateBy.validateJsonElement(jsonObj.get("AggregateBy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetContentModerationResponseGetRequestMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetContentModerationResponseGetRequestMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetContentModerationResponseGetRequestMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetContentModerationResponseGetRequestMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetContentModerationResponseGetRequestMetadata>() {
           @Override
           public void write(JsonWriter out, GetContentModerationResponseGetRequestMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetContentModerationResponseGetRequestMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetContentModerationResponseGetRequestMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetContentModerationResponseGetRequestMetadata
   * @throws IOException if the JSON string is invalid with respect to GetContentModerationResponseGetRequestMetadata
   */
  public static GetContentModerationResponseGetRequestMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetContentModerationResponseGetRequestMetadata.class);
  }

  /**
   * Convert an instance of GetContentModerationResponseGetRequestMetadata to an JSON string
   *
   * @return JSON string
   */
