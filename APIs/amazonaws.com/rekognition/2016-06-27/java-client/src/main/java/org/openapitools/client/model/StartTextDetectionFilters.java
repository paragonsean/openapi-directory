...
public class StartTextDetectionFilters {
  ...
  public StartTextDetectionFilters wordFilter(StartTextDetectionFiltersWordFilter wordFilter) {
  ...
  public StartTextDetectionFilters regionsOfInterest(List regionsOfInterest) {
  ...
  public boolean equals(Object o) {
    ...
    StartTextDetectionFilters startTextDetectionFilters = (StartTextDetectionFilters) o;
    return Objects.equals(this.wordFilter, startTextDetectionFilters.wordFilter) &&
        Objects.equals(this.regionsOfInterest, startTextDetectionFilters.regionsOfInterest);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartTextDetectionFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTextDetectionFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTextDetectionFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTextDetectionFilters is not found in the empty JSON string", StartTextDetectionFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTextDetectionFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTextDetectionFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTextDetectionFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTextDetectionFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTextDetectionFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTextDetectionFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTextDetectionFilters>() {
           @Override
           public void write(JsonWriter out, StartTextDetectionFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTextDetectionFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTextDetectionFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTextDetectionFilters
   * @throws IOException if the JSON string is invalid with respect to StartTextDetectionFilters
   */
  public static StartTextDetectionFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTextDetectionFilters.class);
  }

  /**
   * Convert an instance of StartTextDetectionFilters to an JSON string
   *
   * @return JSON string
   */
