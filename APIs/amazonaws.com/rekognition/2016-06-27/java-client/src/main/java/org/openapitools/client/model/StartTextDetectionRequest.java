...
public class StartTextDetectionRequest {
  ...
  private StartTextDetectionRequestFilters filters;

  public StartTextDetectionRequest() {
  }

  public StartTextDetectionRequest video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public StartTextDetectionRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartTextDetectionRequest notificationChannel(NotificationChannel notificationChannel) {
  ...
  public StartTextDetectionRequest jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public StartTextDetectionRequest filters(StartTextDetectionRequestFilters filters) {
   ...
   */
  @javax.annotation.Nullable
  public StartTextDetectionRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(StartTextDetectionRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartTextDetectionRequest startTextDetectionRequest = (StartTextDetectionRequest) o;
    return Objects.equals(this.video, startTextDetectionRequest.video) &&
        Objects.equals(this.clientRequestToken, startTextDetectionRequest.clientRequestToken) &&
        Objects.equals(this.notificationChannel, startTextDetectionRequest.notificationChannel) &&
        Objects.equals(this.jobTag, startTextDetectionRequest.jobTag) &&
        Objects.equals(this.filters, startTextDetectionRequest.filters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(video, clientRequestToken, notificationChannel, jobTag, filters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartTextDetectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTextDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTextDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTextDetectionRequest is not found in the empty JSON string", StartTextDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTextDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTextDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartTextDetectionRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("Filters") != null && !jsonObj.get("Filters").isJsonNull()) {
        StartTextDetectionRequestFilters.validateJsonElement(jsonObj.get("Filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTextDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTextDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTextDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTextDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTextDetectionRequest>() {
           @Override
           public void write(JsonWriter out, StartTextDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTextDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTextDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTextDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to StartTextDetectionRequest
   */
  public static StartTextDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTextDetectionRequest.class);
  }

  /**
   * Convert an instance of StartTextDetectionRequest to an JSON string
   *
   * @return JSON string
   */
