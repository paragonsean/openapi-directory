...
public class DetectFacesResponse {
  public static final String SERIALIZED_NAME_FACE_DETAILS = "FaceDetails";
  @SerializedName(SERIALIZED_NAME_FACE_DETAILS)
  private List faceDetails;
  ...
  public DetectFacesResponse faceDetails(List faceDetails) {
  ...
  public List getFaceDetails() {
    return faceDetails;
  }

  public void setFaceDetails(List faceDetails) {
    this.faceDetails = faceDetails;
  }


  public DetectFacesResponse orientationCorrection(OrientationCorrection orientationCorrection) {
  ...
  public boolean equals(Object o) {
    ...
    DetectFacesResponse detectFacesResponse = (DetectFacesResponse) o;
    return Objects.equals(this.faceDetails, detectFacesResponse.faceDetails) &&
        Objects.equals(this.orientationCorrection, detectFacesResponse.orientationCorrection);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceDetails, orientationCorrection);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectFacesResponse {\n");
    sb.append("    faceDetails: ").append(toIndentedString(faceDetails)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectFacesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectFacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectFacesResponse is not found in the empty JSON string", DetectFacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectFacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectFacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `FaceDetails`
      if (jsonObj.get("FaceDetails") != null && !jsonObj.get("FaceDetails").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("FaceDetails"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectFacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectFacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectFacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectFacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectFacesResponse>() {
           @Override
           public void write(JsonWriter out, DetectFacesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectFacesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectFacesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectFacesResponse
   * @throws IOException if the JSON string is invalid with respect to DetectFacesResponse
   */
  public static DetectFacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectFacesResponse.class);
  }

  /**
   * Convert an instance of DetectFacesResponse to an JSON string
   *
   * @return JSON string
   */
