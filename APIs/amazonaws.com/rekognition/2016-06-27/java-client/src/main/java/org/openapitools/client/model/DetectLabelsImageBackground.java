...
public class DetectLabelsImageBackground {
  ...
  public DetectLabelsImageBackground quality(DetectLabelsImageBackgroundQuality quality) {
  ...
  public DetectLabelsImageBackground dominantColors(List dominantColors) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImageBackground detectLabelsImageBackground = (DetectLabelsImageBackground) o;
    return Objects.equals(this.quality, detectLabelsImageBackground.quality) &&
        Objects.equals(this.dominantColors, detectLabelsImageBackground.dominantColors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsImageBackground {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImageBackground
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImageBackground.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImageBackground is not found in the empty JSON string", DetectLabelsImageBackground.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImageBackground.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImageBackground` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImageBackground.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImageBackground' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImageBackground> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImageBackground.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImageBackground>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImageBackground value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImageBackground read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImageBackground given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImageBackground
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImageBackground
   */
  public static DetectLabelsImageBackground fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImageBackground.class);
  }

  /**
   * Convert an instance of DetectLabelsImageBackground to an JSON string
   *
   * @return JSON string
   */
