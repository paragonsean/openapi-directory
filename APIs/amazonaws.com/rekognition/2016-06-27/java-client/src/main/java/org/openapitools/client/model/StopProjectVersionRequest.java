...
public class StopProjectVersionRequest {
  ...
  public StopProjectVersionRequest() {
  }

  public StopProjectVersionRequest projectVersionArn(String projectVersionArn) {
  ...
  public boolean equals(Object o) {
    ...
    StopProjectVersionRequest stopProjectVersionRequest = (StopProjectVersionRequest) o;
    return Objects.equals(this.projectVersionArn, stopProjectVersionRequest.projectVersionArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopProjectVersionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopProjectVersionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopProjectVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopProjectVersionRequest is not found in the empty JSON string", StopProjectVersionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopProjectVersionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopProjectVersionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopProjectVersionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopProjectVersionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopProjectVersionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopProjectVersionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopProjectVersionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StopProjectVersionRequest>() {
           @Override
           public void write(JsonWriter out, StopProjectVersionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopProjectVersionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopProjectVersionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopProjectVersionRequest
   * @throws IOException if the JSON string is invalid with respect to StopProjectVersionRequest
   */
  public static StopProjectVersionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopProjectVersionRequest.class);
  }

  /**
   * Convert an instance of StopProjectVersionRequest to an JSON string
   *
   * @return JSON string
   */
