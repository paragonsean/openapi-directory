...
public class SearchFacesByImageRequest {
  ...
  private CompareFacesRequestSourceImage image;
  ...
  public SearchFacesByImageRequest collectionId(String collectionId) {
  ...
  public SearchFacesByImageRequest image(CompareFacesRequestSourceImage image) {
    this.image = image;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public CompareFacesRequestSourceImage getImage() {
    return image;
  }

  public void setImage(CompareFacesRequestSourceImage image) {
    this.image = image;
  }


  public SearchFacesByImageRequest maxFaces(Integer maxFaces) {
  ...
  public SearchFacesByImageRequest faceMatchThreshold(Float faceMatchThreshold) {
  ...
  public SearchFacesByImageRequest qualityFilter(QualityFilter qualityFilter) {
  ...
  public boolean equals(Object o) {
    ...
    SearchFacesByImageRequest searchFacesByImageRequest = (SearchFacesByImageRequest) o;
    return Objects.equals(this.collectionId, searchFacesByImageRequest.collectionId) &&
        Objects.equals(this.image, searchFacesByImageRequest.image) &&
        Objects.equals(this.maxFaces, searchFacesByImageRequest.maxFaces) &&
        Objects.equals(this.faceMatchThreshold, searchFacesByImageRequest.faceMatchThreshold) &&
        Objects.equals(this.qualityFilter, searchFacesByImageRequest.qualityFilter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, image, maxFaces, faceMatchThreshold, qualityFilter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchFacesByImageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchFacesByImageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchFacesByImageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchFacesByImageRequest is not found in the empty JSON string", SearchFacesByImageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchFacesByImageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchFacesByImageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchFacesByImageRequest.openapiRequiredFields) {
      ...
      CompareFacesRequestSourceImage.validateJsonElement(jsonObj.get("Image"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchFacesByImageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchFacesByImageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchFacesByImageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchFacesByImageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchFacesByImageRequest>() {
           @Override
           public void write(JsonWriter out, SearchFacesByImageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchFacesByImageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchFacesByImageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchFacesByImageRequest
   * @throws IOException if the JSON string is invalid with respect to SearchFacesByImageRequest
   */
  public static SearchFacesByImageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchFacesByImageRequest.class);
  }

  /**
   * Convert an instance of SearchFacesByImageRequest to an JSON string
   *
   * @return JSON string
   */
