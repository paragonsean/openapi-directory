...
public class StartCelebrityRecognitionResponse {
  ...
  public StartCelebrityRecognitionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartCelebrityRecognitionResponse startCelebrityRecognitionResponse = (StartCelebrityRecognitionResponse) o;
    return Objects.equals(this.jobId, startCelebrityRecognitionResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartCelebrityRecognitionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartCelebrityRecognitionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartCelebrityRecognitionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartCelebrityRecognitionResponse is not found in the empty JSON string", StartCelebrityRecognitionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartCelebrityRecognitionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartCelebrityRecognitionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartCelebrityRecognitionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartCelebrityRecognitionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartCelebrityRecognitionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartCelebrityRecognitionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartCelebrityRecognitionResponse>() {
           @Override
           public void write(JsonWriter out, StartCelebrityRecognitionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartCelebrityRecognitionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartCelebrityRecognitionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartCelebrityRecognitionResponse
   * @throws IOException if the JSON string is invalid with respect to StartCelebrityRecognitionResponse
   */
  public static StartCelebrityRecognitionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartCelebrityRecognitionResponse.class);
  }

  /**
   * Convert an instance of StartCelebrityRecognitionResponse to an JSON string
   *
   * @return JSON string
   */
