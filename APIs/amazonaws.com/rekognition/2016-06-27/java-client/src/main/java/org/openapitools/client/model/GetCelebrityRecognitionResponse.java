...
public class GetCelebrityRecognitionResponse {
  ...
  public GetCelebrityRecognitionResponse() {
  }

  public GetCelebrityRecognitionResponse jobStatus(VideoJobStatus jobStatus) {
  ...
  public GetCelebrityRecognitionResponse statusMessage(String statusMessage) {
  ...
  public GetCelebrityRecognitionResponse videoMetadata(GetCelebrityRecognitionResponseVideoMetadata videoMetadata) {
  ...
  public GetCelebrityRecognitionResponse nextToken(String nextToken) {
  ...
  public GetCelebrityRecognitionResponse celebrities(List celebrities) {
  ...
  public void setCelebrities(List celebrities) {
    this.celebrities = celebrities;
  }


  public GetCelebrityRecognitionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetCelebrityRecognitionResponse video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public GetCelebrityRecognitionResponse jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCelebrityRecognitionResponse getCelebrityRecognitionResponse = (GetCelebrityRecognitionResponse) o;
    return Objects.equals(this.jobStatus, getCelebrityRecognitionResponse.jobStatus) &&
        Objects.equals(this.statusMessage, getCelebrityRecognitionResponse.statusMessage) &&
        Objects.equals(this.videoMetadata, getCelebrityRecognitionResponse.videoMetadata) &&
        Objects.equals(this.nextToken, getCelebrityRecognitionResponse.nextToken) &&
        Objects.equals(this.celebrities, getCelebrityRecognitionResponse.celebrities) &&
        Objects.equals(this.jobId, getCelebrityRecognitionResponse.jobId) &&
        Objects.equals(this.video, getCelebrityRecognitionResponse.video) &&
        Objects.equals(this.jobTag, getCelebrityRecognitionResponse.jobTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobStatus, statusMessage, videoMetadata, nextToken, celebrities, jobId, video, jobTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCelebrityRecognitionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCelebrityRecognitionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCelebrityRecognitionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCelebrityRecognitionResponse is not found in the empty JSON string", GetCelebrityRecognitionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCelebrityRecognitionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCelebrityRecognitionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Celebrities") != null && !jsonObj.get("Celebrities").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Celebrities"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCelebrityRecognitionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCelebrityRecognitionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCelebrityRecognitionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCelebrityRecognitionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCelebrityRecognitionResponse>() {
           @Override
           public void write(JsonWriter out, GetCelebrityRecognitionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCelebrityRecognitionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCelebrityRecognitionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCelebrityRecognitionResponse
   * @throws IOException if the JSON string is invalid with respect to GetCelebrityRecognitionResponse
   */
  public static GetCelebrityRecognitionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCelebrityRecognitionResponse.class);
  }

  /**
   * Convert an instance of GetCelebrityRecognitionResponse to an JSON string
   *
   * @return JSON string
   */
