...
public class FaceDetectionFace {
  ...
  public FaceDetectionFace() {
  }

  public FaceDetectionFace boundingBox(FaceDetailBoundingBox boundingBox) {
  ...
  public FaceDetectionFace ageRange(FaceDetailAgeRange ageRange) {
  ...
  public FaceDetectionFace smile(FaceDetailSmile smile) {
    this.smile = smile;
    return this;
  }
  ...
  public FaceDetectionFace eyeglasses(FaceDetailEyeglasses eyeglasses) {
  ...
  public FaceDetectionFace sunglasses(FaceDetailSunglasses sunglasses) {
  ...
  public FaceDetectionFace gender(FaceDetailGender gender) {
    this.gender = gender;
    return this;
  }
  ...
  public FaceDetectionFace beard(FaceDetailBeard beard) {
    this.beard = beard;
    return this;
  }
  ...
  public FaceDetectionFace mustache(FaceDetailMustache mustache) {
  ...
  public FaceDetectionFace eyesOpen(FaceDetailEyesOpen eyesOpen) {
  ...
  public FaceDetectionFace mouthOpen(FaceDetailMouthOpen mouthOpen) {
  ...
  public FaceDetectionFace emotions(List emotions) {
  ...
  public FaceDetectionFace landmarks(List landmarks) {
  ...
  public FaceDetectionFace pose(FaceDetailPose pose) {
    this.pose = pose;
    return this;
  }
  ...
  public FaceDetectionFace quality(FaceDetailQuality quality) {
  ...
  public FaceDetectionFace confidence(Float confidence) {
  ...
  public FaceDetectionFace faceOccluded(FaceDetailFaceOccluded faceOccluded) {
  ...
  public FaceDetectionFace eyeDirection(FaceDetailEyeDirection eyeDirection) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetectionFace faceDetectionFace = (FaceDetectionFace) o;
    return Objects.equals(this.boundingBox, faceDetectionFace.boundingBox) &&
        Objects.equals(this.ageRange, faceDetectionFace.ageRange) &&
        Objects.equals(this.smile, faceDetectionFace.smile) &&
        Objects.equals(this.eyeglasses, faceDetectionFace.eyeglasses) &&
        Objects.equals(this.sunglasses, faceDetectionFace.sunglasses) &&
        Objects.equals(this.gender, faceDetectionFace.gender) &&
        Objects.equals(this.beard, faceDetectionFace.beard) &&
        Objects.equals(this.mustache, faceDetectionFace.mustache) &&
        Objects.equals(this.eyesOpen, faceDetectionFace.eyesOpen) &&
        Objects.equals(this.mouthOpen, faceDetectionFace.mouthOpen) &&
        Objects.equals(this.emotions, faceDetectionFace.emotions) &&
        Objects.equals(this.landmarks, faceDetectionFace.landmarks) &&
        Objects.equals(this.pose, faceDetectionFace.pose) &&
        Objects.equals(this.quality, faceDetectionFace.quality) &&
        Objects.equals(this.confidence, faceDetectionFace.confidence) &&
        Objects.equals(this.faceOccluded, faceDetectionFace.faceOccluded) &&
        Objects.equals(this.eyeDirection, faceDetectionFace.eyeDirection);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetectionFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetectionFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetectionFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetectionFace is not found in the empty JSON string", FaceDetectionFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetectionFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetectionFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetectionFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetectionFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetectionFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetectionFace.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetectionFace>() {
           @Override
           public void write(JsonWriter out, FaceDetectionFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetectionFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetectionFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetectionFace
   * @throws IOException if the JSON string is invalid with respect to FaceDetectionFace
   */
  public static FaceDetectionFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetectionFace.class);
  }

  /**
   * Convert an instance of FaceDetectionFace to an JSON string
   *
   * @return JSON string
   */
