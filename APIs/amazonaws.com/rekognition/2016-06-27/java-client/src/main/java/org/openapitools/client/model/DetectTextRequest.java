...
import org.openapitools.client.model.DetectTextRequestFilters;
import org.openapitools.client.model.DetectTextRequestImage;
...
public class DetectTextRequest {
  ...
  private DetectTextRequestImage image;

  public static final String SERIALIZED_NAME_FILTERS = "Filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private DetectTextRequestFilters filters;

  public DetectTextRequest() {
  }

  public DetectTextRequest image(DetectTextRequestImage image) {
    this.image = image;
    return this;
  }
  ...
  public DetectTextRequestImage getImage() {
    return image;
  }

  public void setImage(DetectTextRequestImage image) {
    this.image = image;
  }


  public DetectTextRequest filters(DetectTextRequestFilters filters) {
  ...
  public DetectTextRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(DetectTextRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectTextRequest detectTextRequest = (DetectTextRequest) o;
    return Objects.equals(this.image, detectTextRequest.image) &&
        Objects.equals(this.filters, detectTextRequest.filters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(image, filters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectTextRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectTextRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectTextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectTextRequest is not found in the empty JSON string", DetectTextRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectTextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectTextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectTextRequest.openapiRequiredFields) {
      ...
      DetectTextRequestImage.validateJsonElement(jsonObj.get("Image"));
      // validate the optional field `Filters`
      if (jsonObj.get("Filters") != null && !jsonObj.get("Filters").isJsonNull()) {
        DetectTextRequestFilters.validateJsonElement(jsonObj.get("Filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectTextRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectTextRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectTextRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectTextRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectTextRequest>() {
           @Override
           public void write(JsonWriter out, DetectTextRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectTextRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectTextRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectTextRequest
   * @throws IOException if the JSON string is invalid with respect to DetectTextRequest
   */
  public static DetectTextRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectTextRequest.class);
  }

  /**
   * Convert an instance of DetectTextRequest to an JSON string
   *
   * @return JSON string
   */
