...
public class UnsuccessfulFaceDeletion {
  ...
  public UnsuccessfulFaceDeletion() {
  }

  public UnsuccessfulFaceDeletion faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public UnsuccessfulFaceDeletion userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UnsuccessfulFaceDeletion reasons(List reasons) {
  ...
  public boolean equals(Object o) {
    ...
    UnsuccessfulFaceDeletion unsuccessfulFaceDeletion = (UnsuccessfulFaceDeletion) o;
    return Objects.equals(this.faceId, unsuccessfulFaceDeletion.faceId) &&
        Objects.equals(this.userId, unsuccessfulFaceDeletion.userId) &&
        Objects.equals(this.reasons, unsuccessfulFaceDeletion.reasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceId, userId, reasons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnsuccessfulFaceDeletion {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnsuccessfulFaceDeletion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnsuccessfulFaceDeletion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnsuccessfulFaceDeletion is not found in the empty JSON string", UnsuccessfulFaceDeletion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnsuccessfulFaceDeletion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnsuccessfulFaceDeletion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnsuccessfulFaceDeletion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnsuccessfulFaceDeletion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnsuccessfulFaceDeletion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnsuccessfulFaceDeletion.class));

       return (TypeAdapter<T>) new TypeAdapter<UnsuccessfulFaceDeletion>() {
           @Override
           public void write(JsonWriter out, UnsuccessfulFaceDeletion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnsuccessfulFaceDeletion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnsuccessfulFaceDeletion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnsuccessfulFaceDeletion
   * @throws IOException if the JSON string is invalid with respect to UnsuccessfulFaceDeletion
   */
  public static UnsuccessfulFaceDeletion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnsuccessfulFaceDeletion.class);
  }

  /**
   * Convert an instance of UnsuccessfulFaceDeletion to an JSON string
   *
   * @return JSON string
   */
