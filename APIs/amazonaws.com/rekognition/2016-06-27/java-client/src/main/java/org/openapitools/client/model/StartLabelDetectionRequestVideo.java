...
/**
 * StartLabelDetectionRequestVideo
 */
...
public class StartLabelDetectionRequestVideo {
  ...
  public StartLabelDetectionRequestVideo() {
  }

  public StartLabelDetectionRequestVideo s3Object(VideoS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    StartLabelDetectionRequestVideo startLabelDetectionRequestVideo = (StartLabelDetectionRequestVideo) o;
    return Objects.equals(this.s3Object, startLabelDetectionRequestVideo.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartLabelDetectionRequestVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartLabelDetectionRequestVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartLabelDetectionRequestVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartLabelDetectionRequestVideo is not found in the empty JSON string", StartLabelDetectionRequestVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartLabelDetectionRequestVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartLabelDetectionRequestVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartLabelDetectionRequestVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartLabelDetectionRequestVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartLabelDetectionRequestVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartLabelDetectionRequestVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<StartLabelDetectionRequestVideo>() {
           @Override
           public void write(JsonWriter out, StartLabelDetectionRequestVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartLabelDetectionRequestVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartLabelDetectionRequestVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartLabelDetectionRequestVideo
   * @throws IOException if the JSON string is invalid with respect to StartLabelDetectionRequestVideo
   */
  public static StartLabelDetectionRequestVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartLabelDetectionRequestVideo.class);
  }

  /**
   * Convert an instance of StartLabelDetectionRequestVideo to an JSON string
   *
   * @return JSON string
   */
