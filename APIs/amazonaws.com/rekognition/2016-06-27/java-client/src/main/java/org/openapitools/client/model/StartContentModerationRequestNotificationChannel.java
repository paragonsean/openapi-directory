...
/**
 * StartContentModerationRequestNotificationChannel
 */
...
public class StartContentModerationRequestNotificationChannel {
  ...
  public StartContentModerationRequestNotificationChannel() {
  }

  public StartContentModerationRequestNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public StartContentModerationRequestNotificationChannel roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartContentModerationRequestNotificationChannel startContentModerationRequestNotificationChannel = (StartContentModerationRequestNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, startContentModerationRequestNotificationChannel.snSTopicArn) &&
        Objects.equals(this.roleArn, startContentModerationRequestNotificationChannel.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartContentModerationRequestNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartContentModerationRequestNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartContentModerationRequestNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartContentModerationRequestNotificationChannel is not found in the empty JSON string", StartContentModerationRequestNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartContentModerationRequestNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartContentModerationRequestNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartContentModerationRequestNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartContentModerationRequestNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartContentModerationRequestNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartContentModerationRequestNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartContentModerationRequestNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StartContentModerationRequestNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StartContentModerationRequestNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartContentModerationRequestNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartContentModerationRequestNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartContentModerationRequestNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StartContentModerationRequestNotificationChannel
   */
  public static StartContentModerationRequestNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartContentModerationRequestNotificationChannel.class);
  }

  /**
   * Convert an instance of StartContentModerationRequestNotificationChannel to an JSON string
   *
   * @return JSON string
   */
