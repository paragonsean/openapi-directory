...
/**
 * Gets or Sets UnsuccessfulFaceDisassociationReason
 */
@JsonAdapter(UnsuccessfulFaceDisassociationReason.Adapter.class)
public enum UnsuccessfulFaceDisassociationReason {
  ...
  UnsuccessfulFaceDisassociationReason(String value) {
    this.value = value;
  }
  ...
  public static UnsuccessfulFaceDisassociationReason fromValue(String value) {
    for (UnsuccessfulFaceDisassociationReason b : UnsuccessfulFaceDisassociationReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnsuccessfulFaceDisassociationReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnsuccessfulFaceDisassociationReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UnsuccessfulFaceDisassociationReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UnsuccessfulFaceDisassociationReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UnsuccessfulFaceDisassociationReason.fromValue(value);
  }
}
