...
import org.openapitools.client.model.LabelDetectionAggregateBy;
import org.openapitools.client.model.LabelDetectionSortBy;
...
/**
 * GetLabelDetectionResponseGetRequestMetadata
 */
...
public class GetLabelDetectionResponseGetRequestMetadata {
  public static final String SERIALIZED_NAME_SORT_BY = "SortBy";
  @SerializedName(SERIALIZED_NAME_SORT_BY)
  private LabelDetectionSortBy sortBy;

  public static final String SERIALIZED_NAME_AGGREGATE_BY = "AggregateBy";
  @SerializedName(SERIALIZED_NAME_AGGREGATE_BY)
  private LabelDetectionAggregateBy aggregateBy;

  public GetLabelDetectionResponseGetRequestMetadata() {
  }

  public GetLabelDetectionResponseGetRequestMetadata sortBy(LabelDetectionSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public LabelDetectionSortBy getSortBy() {
    return sortBy;
  }
  ...
  public GetLabelDetectionResponseGetRequestMetadata aggregateBy(LabelDetectionAggregateBy aggregateBy) {
   ...
   */
  @javax.annotation.Nullable
  public LabelDetectionAggregateBy getAggregateBy() {
    return aggregateBy;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLabelDetectionResponseGetRequestMetadata getLabelDetectionResponseGetRequestMetadata = (GetLabelDetectionResponseGetRequestMetadata) o;
    return Objects.equals(this.sortBy, getLabelDetectionResponseGetRequestMetadata.sortBy) &&
        Objects.equals(this.aggregateBy, getLabelDetectionResponseGetRequestMetadata.aggregateBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLabelDetectionResponseGetRequestMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLabelDetectionResponseGetRequestMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLabelDetectionResponseGetRequestMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLabelDetectionResponseGetRequestMetadata is not found in the empty JSON string", GetLabelDetectionResponseGetRequestMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLabelDetectionResponseGetRequestMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLabelDetectionResponseGetRequestMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `SortBy`
      if (jsonObj.get("SortBy") != null && !jsonObj.get("SortBy").isJsonNull()) {
        LabelDetectionSortBy.validateJsonElement(jsonObj.get("SortBy"));
      }
      // validate the optional field `AggregateBy`
      if (jsonObj.get("AggregateBy") != null && !jsonObj.get("AggregateBy").isJsonNull()) {
        LabelDetectionAggregateBy.validateJsonElement(jsonObj.get("AggregateBy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLabelDetectionResponseGetRequestMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLabelDetectionResponseGetRequestMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLabelDetectionResponseGetRequestMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLabelDetectionResponseGetRequestMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLabelDetectionResponseGetRequestMetadata>() {
           @Override
           public void write(JsonWriter out, GetLabelDetectionResponseGetRequestMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLabelDetectionResponseGetRequestMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLabelDetectionResponseGetRequestMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLabelDetectionResponseGetRequestMetadata
   * @throws IOException if the JSON string is invalid with respect to GetLabelDetectionResponseGetRequestMetadata
   */
  public static GetLabelDetectionResponseGetRequestMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLabelDetectionResponseGetRequestMetadata.class);
  }

  /**
   * Convert an instance of GetLabelDetectionResponseGetRequestMetadata to an JSON string
   *
   * @return JSON string
   */
