...
public class StartStreamProcessorRequestStopSelector {
  ...
  public StartStreamProcessorRequestStopSelector() {
  }

  public StartStreamProcessorRequestStopSelector maxDurationInSeconds(Integer maxDurationInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    StartStreamProcessorRequestStopSelector startStreamProcessorRequestStopSelector = (StartStreamProcessorRequestStopSelector) o;
    return Objects.equals(this.maxDurationInSeconds, startStreamProcessorRequestStopSelector.maxDurationInSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartStreamProcessorRequestStopSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartStreamProcessorRequestStopSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartStreamProcessorRequestStopSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartStreamProcessorRequestStopSelector is not found in the empty JSON string", StartStreamProcessorRequestStopSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartStreamProcessorRequestStopSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartStreamProcessorRequestStopSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartStreamProcessorRequestStopSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartStreamProcessorRequestStopSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartStreamProcessorRequestStopSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartStreamProcessorRequestStopSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<StartStreamProcessorRequestStopSelector>() {
           @Override
           public void write(JsonWriter out, StartStreamProcessorRequestStopSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartStreamProcessorRequestStopSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartStreamProcessorRequestStopSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartStreamProcessorRequestStopSelector
   * @throws IOException if the JSON string is invalid with respect to StartStreamProcessorRequestStopSelector
   */
  public static StartStreamProcessorRequestStopSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartStreamProcessorRequestStopSelector.class);
  }

  /**
   * Convert an instance of StartStreamProcessorRequestStopSelector to an JSON string
   *
   * @return JSON string
   */
