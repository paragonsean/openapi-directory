...
import org.openapitools.client.model.ImageS3Object;
...
/**
 * CompareFacesRequestSourceImage
 */
...
public class CompareFacesRequestSourceImage {
  ...
  private ImageS3Object s3Object;

  public CompareFacesRequestSourceImage() {
  }

  public CompareFacesRequestSourceImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public CompareFacesRequestSourceImage s3Object(ImageS3Object s3Object) {
   ...
   */
  @javax.annotation.Nullable
  public ImageS3Object getS3Object() {
    return s3Object;
  }

  public void setS3Object(ImageS3Object s3Object) {
    this.s3Object = s3Object;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompareFacesRequestSourceImage compareFacesRequestSourceImage = (CompareFacesRequestSourceImage) o;
    return Objects.equals(this.bytes, compareFacesRequestSourceImage.bytes) &&
        Objects.equals(this.s3Object, compareFacesRequestSourceImage.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompareFacesRequestSourceImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompareFacesRequestSourceImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompareFacesRequestSourceImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompareFacesRequestSourceImage is not found in the empty JSON string", CompareFacesRequestSourceImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompareFacesRequestSourceImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompareFacesRequestSourceImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("S3Object") != null && !jsonObj.get("S3Object").isJsonNull()) {
        ImageS3Object.validateJsonElement(jsonObj.get("S3Object"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompareFacesRequestSourceImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompareFacesRequestSourceImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompareFacesRequestSourceImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompareFacesRequestSourceImage.class));

       return (TypeAdapter<T>) new TypeAdapter<CompareFacesRequestSourceImage>() {
           @Override
           public void write(JsonWriter out, CompareFacesRequestSourceImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompareFacesRequestSourceImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompareFacesRequestSourceImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompareFacesRequestSourceImage
   * @throws IOException if the JSON string is invalid with respect to CompareFacesRequestSourceImage
   */
  public static CompareFacesRequestSourceImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompareFacesRequestSourceImage.class);
  }

  /**
   * Convert an instance of CompareFacesRequestSourceImage to an JSON string
   *
   * @return JSON string
   */
