...
public class ApiClient {
    ...
    private String basePath = "http://rekognition.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-06-27/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://rekognition.us-east-1.amazonaws.com
