...
/**
 * DetectLabelsResponseImageProperties
 */
...
public class DetectLabelsResponseImageProperties {
  ...
  public DetectLabelsResponseImageProperties() {
  }

  public DetectLabelsResponseImageProperties quality(DetectLabelsImagePropertiesQuality quality) {
  ...
  public DetectLabelsResponseImageProperties dominantColors(List dominantColors) {
  ...
  public DetectLabelsResponseImageProperties foreground(DetectLabelsImagePropertiesForeground foreground) {
  ...
  public DetectLabelsResponseImageProperties background(DetectLabelsImagePropertiesBackground background) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsResponseImageProperties detectLabelsResponseImageProperties = (DetectLabelsResponseImageProperties) o;
    return Objects.equals(this.quality, detectLabelsResponseImageProperties.quality) &&
        Objects.equals(this.dominantColors, detectLabelsResponseImageProperties.dominantColors) &&
        Objects.equals(this.foreground, detectLabelsResponseImageProperties.foreground) &&
        Objects.equals(this.background, detectLabelsResponseImageProperties.background);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsResponseImageProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsResponseImageProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsResponseImageProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsResponseImageProperties is not found in the empty JSON string", DetectLabelsResponseImageProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsResponseImageProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsResponseImageProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsResponseImageProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsResponseImageProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsResponseImageProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsResponseImageProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsResponseImageProperties>() {
           @Override
           public void write(JsonWriter out, DetectLabelsResponseImageProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsResponseImageProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsResponseImageProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsResponseImageProperties
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsResponseImageProperties
   */
  public static DetectLabelsResponseImageProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsResponseImageProperties.class);
  }

  /**
   * Convert an instance of DetectLabelsResponseImageProperties to an JSON string
   *
   * @return JSON string
   */
