...
public class StartSegmentDetectionResponse {
  ...
  public StartSegmentDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartSegmentDetectionResponse startSegmentDetectionResponse = (StartSegmentDetectionResponse) o;
    return Objects.equals(this.jobId, startSegmentDetectionResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartSegmentDetectionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSegmentDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSegmentDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSegmentDetectionResponse is not found in the empty JSON string", StartSegmentDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSegmentDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSegmentDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSegmentDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSegmentDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSegmentDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSegmentDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSegmentDetectionResponse>() {
           @Override
           public void write(JsonWriter out, StartSegmentDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSegmentDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSegmentDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSegmentDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to StartSegmentDetectionResponse
   */
  public static StartSegmentDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSegmentDetectionResponse.class);
  }

  /**
   * Convert an instance of StartSegmentDetectionResponse to an JSON string
   *
   * @return JSON string
   */
