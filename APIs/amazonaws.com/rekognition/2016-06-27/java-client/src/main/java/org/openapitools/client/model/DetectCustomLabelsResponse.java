...
public class DetectCustomLabelsResponse {
  public static final String SERIALIZED_NAME_CUSTOM_LABELS = "CustomLabels";
  @SerializedName(SERIALIZED_NAME_CUSTOM_LABELS)
  private List customLabels;

  public DetectCustomLabelsResponse() {
  }

  public DetectCustomLabelsResponse customLabels(List customLabels) {
  ...
  public List getCustomLabels() {
    return customLabels;
  }

  public void setCustomLabels(List customLabels) {
    this.customLabels = customLabels;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectCustomLabelsResponse detectCustomLabelsResponse = (DetectCustomLabelsResponse) o;
    return Objects.equals(this.customLabels, detectCustomLabelsResponse.customLabels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customLabels);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectCustomLabelsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectCustomLabelsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectCustomLabelsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectCustomLabelsResponse is not found in the empty JSON string", DetectCustomLabelsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectCustomLabelsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectCustomLabelsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CustomLabels`
      if (jsonObj.get("CustomLabels") != null && !jsonObj.get("CustomLabels").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("CustomLabels"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectCustomLabelsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectCustomLabelsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectCustomLabelsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectCustomLabelsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectCustomLabelsResponse>() {
           @Override
           public void write(JsonWriter out, DetectCustomLabelsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectCustomLabelsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectCustomLabelsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectCustomLabelsResponse
   * @throws IOException if the JSON string is invalid with respect to DetectCustomLabelsResponse
   */
  public static DetectCustomLabelsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectCustomLabelsResponse.class);
  }

  /**
   * Convert an instance of DetectCustomLabelsResponse to an JSON string
   *
   * @return JSON string
   */
