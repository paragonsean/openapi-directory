...
public class FaceDetailSunglasses {
  ...
  public FaceDetailSunglasses() {
  }

  public FaceDetailSunglasses value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailSunglasses confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailSunglasses faceDetailSunglasses = (FaceDetailSunglasses) o;
    return Objects.equals(this.value, faceDetailSunglasses.value) &&
        Objects.equals(this.confidence, faceDetailSunglasses.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailSunglasses {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailSunglasses
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailSunglasses.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailSunglasses is not found in the empty JSON string", FaceDetailSunglasses.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailSunglasses.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailSunglasses` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailSunglasses.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailSunglasses' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailSunglasses> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailSunglasses.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailSunglasses>() {
           @Override
           public void write(JsonWriter out, FaceDetailSunglasses value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailSunglasses read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailSunglasses given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailSunglasses
   * @throws IOException if the JSON string is invalid with respect to FaceDetailSunglasses
   */
  public static FaceDetailSunglasses fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailSunglasses.class);
  }

  /**
   * Convert an instance of FaceDetailSunglasses to an JSON string
   *
   * @return JSON string
   */
