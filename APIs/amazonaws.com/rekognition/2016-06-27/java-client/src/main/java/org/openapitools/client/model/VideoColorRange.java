...
/**
 * Gets or Sets VideoColorRange
 */
@JsonAdapter(VideoColorRange.Adapter.class)
public enum VideoColorRange {
  ...
  public static VideoColorRange fromValue(String value) {
    for (VideoColorRange b : VideoColorRange.values()) {
  ...
  public static class Adapter extends TypeAdapter<VideoColorRange> {
    @Override
    public void write(final JsonWriter jsonWriter, final VideoColorRange enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VideoColorRange read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VideoColorRange.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VideoColorRange.fromValue(value);
  }
}
