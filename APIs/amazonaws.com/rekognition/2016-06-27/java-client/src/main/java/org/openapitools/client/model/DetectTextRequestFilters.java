...
import org.openapitools.client.model.DetectionFilter;
...
public class DetectTextRequestFilters {
  ...
  public DetectTextRequestFilters() {
  }

  public DetectTextRequestFilters wordFilter(DetectionFilter wordFilter) {
  ...
  public DetectTextRequestFilters regionsOfInterest(List regionsOfInterest) {
  ...
  public boolean equals(Object o) {
    ...
    DetectTextRequestFilters detectTextRequestFilters = (DetectTextRequestFilters) o;
    return Objects.equals(this.wordFilter, detectTextRequestFilters.wordFilter) &&
        Objects.equals(this.regionsOfInterest, detectTextRequestFilters.regionsOfInterest);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectTextRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectTextRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectTextRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectTextRequestFilters is not found in the empty JSON string", DetectTextRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectTextRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectTextRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `WordFilter`
      if (jsonObj.get("WordFilter") != null && !jsonObj.get("WordFilter").isJsonNull()) {
        DetectionFilter.validateJsonElement(jsonObj.get("WordFilter"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectTextRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectTextRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectTextRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectTextRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectTextRequestFilters>() {
           @Override
           public void write(JsonWriter out, DetectTextRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectTextRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectTextRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectTextRequestFilters
   * @throws IOException if the JSON string is invalid with respect to DetectTextRequestFilters
   */
  public static DetectTextRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectTextRequestFilters.class);
  }

  /**
   * Convert an instance of DetectTextRequestFilters to an JSON string
   *
   * @return JSON string
   */
