...
public class ListStreamProcessorsResponse {
  ...
  public static final String SERIALIZED_NAME_STREAM_PROCESSORS = "StreamProcessors";
  @SerializedName(SERIALIZED_NAME_STREAM_PROCESSORS)
  private List streamProcessors;

  public ListStreamProcessorsResponse() {
  }

  public ListStreamProcessorsResponse nextToken(String nextToken) {
  ...
  public ListStreamProcessorsResponse streamProcessors(List streamProcessors) {
    this.streamProcessors = streamProcessors;
    return this;
  }

  /**
   * Get streamProcessors
   * @return streamProcessors
   */
  @javax.annotation.Nullable
  public List getStreamProcessors() {
    return streamProcessors;
  }

  public void setStreamProcessors(List streamProcessors) {
    this.streamProcessors = streamProcessors;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListStreamProcessorsResponse listStreamProcessorsResponse = (ListStreamProcessorsResponse) o;
    return Objects.equals(this.nextToken, listStreamProcessorsResponse.nextToken) &&
        Objects.equals(this.streamProcessors, listStreamProcessorsResponse.streamProcessors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, streamProcessors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListStreamProcessorsResponse {\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    streamProcessors: ").append(toIndentedString(streamProcessors)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("StreamProcessors");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStreamProcessorsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStreamProcessorsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStreamProcessorsResponse is not found in the empty JSON string", ListStreamProcessorsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStreamProcessorsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStreamProcessorsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `StreamProcessors`
      if (jsonObj.get("StreamProcessors") != null && !jsonObj.get("StreamProcessors").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("StreamProcessors"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStreamProcessorsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStreamProcessorsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStreamProcessorsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStreamProcessorsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStreamProcessorsResponse>() {
           @Override
           public void write(JsonWriter out, ListStreamProcessorsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStreamProcessorsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStreamProcessorsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStreamProcessorsResponse
   * @throws IOException if the JSON string is invalid with respect to ListStreamProcessorsResponse
   */
  public static ListStreamProcessorsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStreamProcessorsResponse.class);
  }

  /**
   * Convert an instance of ListStreamProcessorsResponse to an JSON string
   *
   * @return JSON string
   */
