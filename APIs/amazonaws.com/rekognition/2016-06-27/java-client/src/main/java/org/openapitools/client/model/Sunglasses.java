...
public class Sunglasses {
  ...
  public Sunglasses value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public Sunglasses confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    Sunglasses sunglasses = (Sunglasses) o;
    return Objects.equals(this.value, sunglasses.value) &&
        Objects.equals(this.confidence, sunglasses.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sunglasses
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sunglasses.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sunglasses is not found in the empty JSON string", Sunglasses.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sunglasses.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sunglasses` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sunglasses.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sunglasses' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sunglasses> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sunglasses.class));

       return (TypeAdapter<T>) new TypeAdapter<Sunglasses>() {
           @Override
           public void write(JsonWriter out, Sunglasses value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Sunglasses read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Sunglasses given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sunglasses
   * @throws IOException if the JSON string is invalid with respect to Sunglasses
   */
  public static Sunglasses fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sunglasses.class);
  }

  /**
   * Convert an instance of Sunglasses to an JSON string
   *
   * @return JSON string
   */
