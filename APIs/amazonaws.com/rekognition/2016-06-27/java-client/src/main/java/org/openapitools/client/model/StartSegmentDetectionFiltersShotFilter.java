...
public class StartSegmentDetectionFiltersShotFilter {
  public static final String SERIALIZED_NAME_MIN_SEGMENT_CONFIDENCE = "MinSegmentConfidence";
  @SerializedName(SERIALIZED_NAME_MIN_SEGMENT_CONFIDENCE)
  private Float minSegmentConfidence;

  public StartSegmentDetectionFiltersShotFilter() {
  }

  public StartSegmentDetectionFiltersShotFilter minSegmentConfidence(Float minSegmentConfidence) {
    this.minSegmentConfidence = minSegmentConfidence;
    return this;
  }

  /**
   * Get minSegmentConfidence
  ...
  public boolean equals(Object o) {
    ...
    StartSegmentDetectionFiltersShotFilter startSegmentDetectionFiltersShotFilter = (StartSegmentDetectionFiltersShotFilter) o;
    return Objects.equals(this.minSegmentConfidence, startSegmentDetectionFiltersShotFilter.minSegmentConfidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(minSegmentConfidence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartSegmentDetectionFiltersShotFilter {\n");
    sb.append("    minSegmentConfidence: ").append(toIndentedString(minSegmentConfidence)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("MinSegmentConfidence");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSegmentDetectionFiltersShotFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSegmentDetectionFiltersShotFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSegmentDetectionFiltersShotFilter is not found in the empty JSON string", StartSegmentDetectionFiltersShotFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSegmentDetectionFiltersShotFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSegmentDetectionFiltersShotFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `MinSegmentConfidence`
      if (jsonObj.get("MinSegmentConfidence") != null && !jsonObj.get("MinSegmentConfidence").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("MinSegmentConfidence"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSegmentDetectionFiltersShotFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSegmentDetectionFiltersShotFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSegmentDetectionFiltersShotFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSegmentDetectionFiltersShotFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSegmentDetectionFiltersShotFilter>() {
           @Override
           public void write(JsonWriter out, StartSegmentDetectionFiltersShotFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSegmentDetectionFiltersShotFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSegmentDetectionFiltersShotFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSegmentDetectionFiltersShotFilter
   * @throws IOException if the JSON string is invalid with respect to StartSegmentDetectionFiltersShotFilter
   */
  public static StartSegmentDetectionFiltersShotFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSegmentDetectionFiltersShotFilter.class);
  }

  /**
   * Convert an instance of StartSegmentDetectionFiltersShotFilter to an JSON string
   *
   * @return JSON string
   */
