...
/**
 * DetectLabelsImagePropertiesForeground
 */
...
public class DetectLabelsImagePropertiesForeground {
  ...
  public DetectLabelsImagePropertiesForeground() {
  }

  public DetectLabelsImagePropertiesForeground quality(DetectLabelsImageForegroundQuality quality) {
  ...
  public DetectLabelsImagePropertiesForeground dominantColors(List dominantColors) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImagePropertiesForeground detectLabelsImagePropertiesForeground = (DetectLabelsImagePropertiesForeground) o;
    return Objects.equals(this.quality, detectLabelsImagePropertiesForeground.quality) &&
        Objects.equals(this.dominantColors, detectLabelsImagePropertiesForeground.dominantColors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsImagePropertiesForeground {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImagePropertiesForeground
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImagePropertiesForeground.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImagePropertiesForeground is not found in the empty JSON string", DetectLabelsImagePropertiesForeground.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImagePropertiesForeground.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImagePropertiesForeground` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImagePropertiesForeground.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImagePropertiesForeground' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImagePropertiesForeground> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImagePropertiesForeground.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImagePropertiesForeground>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImagePropertiesForeground value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImagePropertiesForeground read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImagePropertiesForeground given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImagePropertiesForeground
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImagePropertiesForeground
   */
  public static DetectLabelsImagePropertiesForeground fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImagePropertiesForeground.class);
  }

  /**
   * Convert an instance of DetectLabelsImagePropertiesForeground to an JSON string
   *
   * @return JSON string
   */
