...
public class SearchFacesRequest {
  ...
  public SearchFacesRequest collectionId(String collectionId) {
  ...
  public SearchFacesRequest faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public SearchFacesRequest maxFaces(Integer maxFaces) {
  ...
  public SearchFacesRequest faceMatchThreshold(Float faceMatchThreshold) {
  ...
  public boolean equals(Object o) {
    ...
    SearchFacesRequest searchFacesRequest = (SearchFacesRequest) o;
    return Objects.equals(this.collectionId, searchFacesRequest.collectionId) &&
        Objects.equals(this.faceId, searchFacesRequest.faceId) &&
        Objects.equals(this.maxFaces, searchFacesRequest.maxFaces) &&
        Objects.equals(this.faceMatchThreshold, searchFacesRequest.faceMatchThreshold);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, faceId, maxFaces, faceMatchThreshold);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchFacesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchFacesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchFacesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchFacesRequest is not found in the empty JSON string", SearchFacesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchFacesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchFacesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchFacesRequest.openapiRequiredFields) {
      ...
      // validate the required field `FaceId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchFacesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchFacesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchFacesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchFacesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchFacesRequest>() {
           @Override
           public void write(JsonWriter out, SearchFacesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchFacesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchFacesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchFacesRequest
   * @throws IOException if the JSON string is invalid with respect to SearchFacesRequest
   */
  public static SearchFacesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchFacesRequest.class);
  }

  /**
   * Convert an instance of SearchFacesRequest to an JSON string
   *
   * @return JSON string
   */
