...
public class CopyProjectVersionResponse {
  ...
  public CopyProjectVersionResponse projectVersionArn(String projectVersionArn) {
  ...
  public boolean equals(Object o) {
    ...
    CopyProjectVersionResponse copyProjectVersionResponse = (CopyProjectVersionResponse) o;
    return Objects.equals(this.projectVersionArn, copyProjectVersionResponse.projectVersionArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopyProjectVersionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyProjectVersionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyProjectVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyProjectVersionResponse is not found in the empty JSON string", CopyProjectVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyProjectVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyProjectVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyProjectVersionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyProjectVersionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyProjectVersionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyProjectVersionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyProjectVersionResponse>() {
           @Override
           public void write(JsonWriter out, CopyProjectVersionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyProjectVersionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyProjectVersionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyProjectVersionResponse
   * @throws IOException if the JSON string is invalid with respect to CopyProjectVersionResponse
   */
  public static CopyProjectVersionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyProjectVersionResponse.class);
  }

  /**
   * Convert an instance of CopyProjectVersionResponse to an JSON string
   *
   * @return JSON string
   */
