...
public class ComparedFace {
  ...
  public ComparedFace boundingBox(ComparedFaceBoundingBox boundingBox) {
  ...
  public ComparedFace confidence(Float confidence) {
  ...
  public ComparedFace landmarks(List landmarks) {
  ...
  public ComparedFace pose(ComparedFacePose pose) {
    this.pose = pose;
    return this;
  }
  ...
  public ComparedFace quality(ComparedFaceQuality quality) {
  ...
  public ComparedFace emotions(List emotions) {
  ...
  public ComparedFace smile(ComparedFaceSmile smile) {
    this.smile = smile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ComparedFace comparedFace = (ComparedFace) o;
    return Objects.equals(this.boundingBox, comparedFace.boundingBox) &&
        Objects.equals(this.confidence, comparedFace.confidence) &&
        Objects.equals(this.landmarks, comparedFace.landmarks) &&
        Objects.equals(this.pose, comparedFace.pose) &&
        Objects.equals(this.quality, comparedFace.quality) &&
        Objects.equals(this.emotions, comparedFace.emotions) &&
        Objects.equals(this.smile, comparedFace.smile);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComparedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComparedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComparedFace is not found in the empty JSON string", ComparedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComparedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComparedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComparedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComparedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComparedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComparedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<ComparedFace>() {
           @Override
           public void write(JsonWriter out, ComparedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComparedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComparedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComparedFace
   * @throws IOException if the JSON string is invalid with respect to ComparedFace
   */
  public static ComparedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComparedFace.class);
  }

  /**
   * Convert an instance of ComparedFace to an JSON string
   *
   * @return JSON string
   */
