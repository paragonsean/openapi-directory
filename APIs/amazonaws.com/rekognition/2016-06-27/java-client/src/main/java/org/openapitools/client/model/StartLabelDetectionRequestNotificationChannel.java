...
/**
 * StartLabelDetectionRequestNotificationChannel
 */
...
public class StartLabelDetectionRequestNotificationChannel {
  ...
  public StartLabelDetectionRequestNotificationChannel() {
  }

  public StartLabelDetectionRequestNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public StartLabelDetectionRequestNotificationChannel roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartLabelDetectionRequestNotificationChannel startLabelDetectionRequestNotificationChannel = (StartLabelDetectionRequestNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, startLabelDetectionRequestNotificationChannel.snSTopicArn) &&
        Objects.equals(this.roleArn, startLabelDetectionRequestNotificationChannel.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartLabelDetectionRequestNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartLabelDetectionRequestNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartLabelDetectionRequestNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartLabelDetectionRequestNotificationChannel is not found in the empty JSON string", StartLabelDetectionRequestNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartLabelDetectionRequestNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartLabelDetectionRequestNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartLabelDetectionRequestNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartLabelDetectionRequestNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartLabelDetectionRequestNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartLabelDetectionRequestNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartLabelDetectionRequestNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StartLabelDetectionRequestNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StartLabelDetectionRequestNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartLabelDetectionRequestNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartLabelDetectionRequestNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartLabelDetectionRequestNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StartLabelDetectionRequestNotificationChannel
   */
  public static StartLabelDetectionRequestNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartLabelDetectionRequestNotificationChannel.class);
  }

  /**
   * Convert an instance of StartLabelDetectionRequestNotificationChannel to an JSON string
   *
   * @return JSON string
   */
