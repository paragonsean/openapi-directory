...
public class StartPersonTrackingResponse {
  ...
  public StartPersonTrackingResponse() {
  }

  public StartPersonTrackingResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartPersonTrackingResponse startPersonTrackingResponse = (StartPersonTrackingResponse) o;
    return Objects.equals(this.jobId, startPersonTrackingResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartPersonTrackingResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartPersonTrackingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartPersonTrackingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartPersonTrackingResponse is not found in the empty JSON string", StartPersonTrackingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartPersonTrackingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartPersonTrackingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartPersonTrackingResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartPersonTrackingResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartPersonTrackingResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartPersonTrackingResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartPersonTrackingResponse>() {
           @Override
           public void write(JsonWriter out, StartPersonTrackingResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartPersonTrackingResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartPersonTrackingResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartPersonTrackingResponse
   * @throws IOException if the JSON string is invalid with respect to StartPersonTrackingResponse
   */
  public static StartPersonTrackingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartPersonTrackingResponse.class);
  }

  /**
   * Convert an instance of StartPersonTrackingResponse to an JSON string
   *
   * @return JSON string
   */
