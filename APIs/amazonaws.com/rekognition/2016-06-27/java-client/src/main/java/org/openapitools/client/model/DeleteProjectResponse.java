...
public class DeleteProjectResponse {
  ...
  public DeleteProjectResponse status(ProjectStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteProjectResponse deleteProjectResponse = (DeleteProjectResponse) o;
    return Objects.equals(this.status, deleteProjectResponse.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteProjectResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteProjectResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteProjectResponse is not found in the empty JSON string", DeleteProjectResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteProjectResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteProjectResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteProjectResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteProjectResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteProjectResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteProjectResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteProjectResponse>() {
           @Override
           public void write(JsonWriter out, DeleteProjectResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteProjectResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteProjectResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteProjectResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteProjectResponse
   */
  public static DeleteProjectResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteProjectResponse.class);
  }

  /**
   * Convert an instance of DeleteProjectResponse to an JSON string
   *
   * @return JSON string
   */
