...
public class StreamProcessorSettingsFaceSearch {
  ...
  public StreamProcessorSettingsFaceSearch() {
  }

  public StreamProcessorSettingsFaceSearch collectionId(String collectionId) {
  ...
  public StreamProcessorSettingsFaceSearch faceMatchThreshold(Float faceMatchThreshold) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorSettingsFaceSearch streamProcessorSettingsFaceSearch = (StreamProcessorSettingsFaceSearch) o;
    return Objects.equals(this.collectionId, streamProcessorSettingsFaceSearch.collectionId) &&
        Objects.equals(this.faceMatchThreshold, streamProcessorSettingsFaceSearch.faceMatchThreshold);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessorSettingsFaceSearch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorSettingsFaceSearch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorSettingsFaceSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorSettingsFaceSearch is not found in the empty JSON string", StreamProcessorSettingsFaceSearch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorSettingsFaceSearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorSettingsFaceSearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorSettingsFaceSearch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorSettingsFaceSearch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorSettingsFaceSearch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorSettingsFaceSearch.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorSettingsFaceSearch>() {
           @Override
           public void write(JsonWriter out, StreamProcessorSettingsFaceSearch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorSettingsFaceSearch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorSettingsFaceSearch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorSettingsFaceSearch
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorSettingsFaceSearch
   */
  public static StreamProcessorSettingsFaceSearch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorSettingsFaceSearch.class);
  }

  /**
   * Convert an instance of StreamProcessorSettingsFaceSearch to an JSON string
   *
   * @return JSON string
   */
