...
/**
 * ProjectVersionDescriptionOutputConfig
 */
...
public class ProjectVersionDescriptionOutputConfig {
  ...
  public ProjectVersionDescriptionOutputConfig() {
  }

  public ProjectVersionDescriptionOutputConfig s3Bucket(String s3Bucket) {
  ...
  public ProjectVersionDescriptionOutputConfig s3KeyPrefix(String s3KeyPrefix) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectVersionDescriptionOutputConfig projectVersionDescriptionOutputConfig = (ProjectVersionDescriptionOutputConfig) o;
    return Objects.equals(this.s3Bucket, projectVersionDescriptionOutputConfig.s3Bucket) &&
        Objects.equals(this.s3KeyPrefix, projectVersionDescriptionOutputConfig.s3KeyPrefix);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectVersionDescriptionOutputConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectVersionDescriptionOutputConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectVersionDescriptionOutputConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectVersionDescriptionOutputConfig is not found in the empty JSON string", ProjectVersionDescriptionOutputConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectVersionDescriptionOutputConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectVersionDescriptionOutputConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectVersionDescriptionOutputConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectVersionDescriptionOutputConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectVersionDescriptionOutputConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectVersionDescriptionOutputConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectVersionDescriptionOutputConfig>() {
           @Override
           public void write(JsonWriter out, ProjectVersionDescriptionOutputConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectVersionDescriptionOutputConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectVersionDescriptionOutputConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectVersionDescriptionOutputConfig
   * @throws IOException if the JSON string is invalid with respect to ProjectVersionDescriptionOutputConfig
   */
  public static ProjectVersionDescriptionOutputConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectVersionDescriptionOutputConfig.class);
  }

  /**
   * Convert an instance of ProjectVersionDescriptionOutputConfig to an JSON string
   *
   * @return JSON string
   */
