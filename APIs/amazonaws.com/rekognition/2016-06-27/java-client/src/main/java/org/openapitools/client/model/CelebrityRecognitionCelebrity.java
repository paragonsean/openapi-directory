...
public class CelebrityRecognitionCelebrity {
  ...
  public CelebrityRecognitionCelebrity() {
  }

  public CelebrityRecognitionCelebrity urls(List urls) {
    this.urls = urls;
    return this;
  }
  ...
  public CelebrityRecognitionCelebrity name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CelebrityRecognitionCelebrity id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CelebrityRecognitionCelebrity confidence(Float confidence) {
  ...
  public CelebrityRecognitionCelebrity boundingBox(CelebrityDetailBoundingBox boundingBox) {
  ...
  public CelebrityRecognitionCelebrity face(CelebrityDetailFace face) {
    this.face = face;
    return this;
  }
  ...
  public CelebrityRecognitionCelebrity knownGender(GetCelebrityInfoResponseKnownGender knownGender) {
  ...
  public boolean equals(Object o) {
    ...
    CelebrityRecognitionCelebrity celebrityRecognitionCelebrity = (CelebrityRecognitionCelebrity) o;
    return Objects.equals(this.urls, celebrityRecognitionCelebrity.urls) &&
        Objects.equals(this.name, celebrityRecognitionCelebrity.name) &&
        Objects.equals(this.id, celebrityRecognitionCelebrity.id) &&
        Objects.equals(this.confidence, celebrityRecognitionCelebrity.confidence) &&
        Objects.equals(this.boundingBox, celebrityRecognitionCelebrity.boundingBox) &&
        Objects.equals(this.face, celebrityRecognitionCelebrity.face) &&
        Objects.equals(this.knownGender, celebrityRecognitionCelebrity.knownGender);
  }
  ...
  public String toString() {
    ...
    sb.append("class CelebrityRecognitionCelebrity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CelebrityRecognitionCelebrity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CelebrityRecognitionCelebrity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CelebrityRecognitionCelebrity is not found in the empty JSON string", CelebrityRecognitionCelebrity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CelebrityRecognitionCelebrity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CelebrityRecognitionCelebrity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CelebrityRecognitionCelebrity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CelebrityRecognitionCelebrity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CelebrityRecognitionCelebrity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CelebrityRecognitionCelebrity.class));

       return (TypeAdapter<T>) new TypeAdapter<CelebrityRecognitionCelebrity>() {
           @Override
           public void write(JsonWriter out, CelebrityRecognitionCelebrity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CelebrityRecognitionCelebrity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CelebrityRecognitionCelebrity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CelebrityRecognitionCelebrity
   * @throws IOException if the JSON string is invalid with respect to CelebrityRecognitionCelebrity
   */
  public static CelebrityRecognitionCelebrity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CelebrityRecognitionCelebrity.class);
  }

  /**
   * Convert an instance of CelebrityRecognitionCelebrity to an JSON string
   *
   * @return JSON string
   */
