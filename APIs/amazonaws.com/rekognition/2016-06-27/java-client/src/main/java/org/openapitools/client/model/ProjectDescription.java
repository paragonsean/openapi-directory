...
public class ProjectDescription {
  ...
  public ProjectDescription status(ProjectStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectArn, projectDescription.projectArn) &&
        ...
        Objects.equals(this.status, projectDescription.status) &&
        Objects.equals(this.datasets, projectDescription.datasets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectArn, creationTimestamp, status, datasets);
  }
