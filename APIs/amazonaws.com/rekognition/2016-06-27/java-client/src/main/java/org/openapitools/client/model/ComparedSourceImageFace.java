...
public class ComparedSourceImageFace {
  ...
  public ComparedSourceImageFace boundingBox(ComparedFaceBoundingBox boundingBox) {
  ...
  public ComparedSourceImageFace confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    ComparedSourceImageFace comparedSourceImageFace = (ComparedSourceImageFace) o;
    return Objects.equals(this.boundingBox, comparedSourceImageFace.boundingBox) &&
        Objects.equals(this.confidence, comparedSourceImageFace.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComparedSourceImageFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComparedSourceImageFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComparedSourceImageFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComparedSourceImageFace is not found in the empty JSON string", ComparedSourceImageFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComparedSourceImageFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComparedSourceImageFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComparedSourceImageFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComparedSourceImageFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComparedSourceImageFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComparedSourceImageFace.class));

       return (TypeAdapter<T>) new TypeAdapter<ComparedSourceImageFace>() {
           @Override
           public void write(JsonWriter out, ComparedSourceImageFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComparedSourceImageFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComparedSourceImageFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComparedSourceImageFace
   * @throws IOException if the JSON string is invalid with respect to ComparedSourceImageFace
   */
  public static ComparedSourceImageFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComparedSourceImageFace.class);
  }

  /**
   * Convert an instance of ComparedSourceImageFace to an JSON string
   *
   * @return JSON string
   */
