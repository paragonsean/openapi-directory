...
public class CelebrityFace {
  ...
  public CelebrityFace() {
  }

  public CelebrityFace boundingBox(ComparedFaceBoundingBox boundingBox) {
  ...
  public CelebrityFace confidence(Float confidence) {
  ...
  public CelebrityFace landmarks(List landmarks) {
  ...
  public CelebrityFace pose(ComparedFacePose pose) {
    this.pose = pose;
    return this;
  }
  ...
  public CelebrityFace quality(ComparedFaceQuality quality) {
  ...
  public CelebrityFace emotions(List emotions) {
  ...
  public CelebrityFace smile(ComparedFaceSmile smile) {
    this.smile = smile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CelebrityFace celebrityFace = (CelebrityFace) o;
    return Objects.equals(this.boundingBox, celebrityFace.boundingBox) &&
        Objects.equals(this.confidence, celebrityFace.confidence) &&
        Objects.equals(this.landmarks, celebrityFace.landmarks) &&
        Objects.equals(this.pose, celebrityFace.pose) &&
        Objects.equals(this.quality, celebrityFace.quality) &&
        Objects.equals(this.emotions, celebrityFace.emotions) &&
        Objects.equals(this.smile, celebrityFace.smile);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CelebrityFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CelebrityFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CelebrityFace is not found in the empty JSON string", CelebrityFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CelebrityFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CelebrityFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CelebrityFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CelebrityFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CelebrityFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CelebrityFace.class));

       return (TypeAdapter<T>) new TypeAdapter<CelebrityFace>() {
           @Override
           public void write(JsonWriter out, CelebrityFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CelebrityFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CelebrityFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CelebrityFace
   * @throws IOException if the JSON string is invalid with respect to CelebrityFace
   */
  public static CelebrityFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CelebrityFace.class);
  }

  /**
   * Convert an instance of CelebrityFace to an JSON string
   *
   * @return JSON string
   */
