...
/**
 * ProtectiveEquipmentPersonBoundingBox
 */
...
public class ProtectiveEquipmentPersonBoundingBox {
  ...
  public ProtectiveEquipmentPersonBoundingBox() {
  }

  public ProtectiveEquipmentPersonBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public ProtectiveEquipmentPersonBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public ProtectiveEquipmentPersonBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public ProtectiveEquipmentPersonBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProtectiveEquipmentPersonBoundingBox protectiveEquipmentPersonBoundingBox = (ProtectiveEquipmentPersonBoundingBox) o;
    return Objects.equals(this.width, protectiveEquipmentPersonBoundingBox.width) &&
        Objects.equals(this.height, protectiveEquipmentPersonBoundingBox.height) &&
        Objects.equals(this.left, protectiveEquipmentPersonBoundingBox.left) &&
        Objects.equals(this.top, protectiveEquipmentPersonBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProtectiveEquipmentPersonBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProtectiveEquipmentPersonBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProtectiveEquipmentPersonBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProtectiveEquipmentPersonBoundingBox is not found in the empty JSON string", ProtectiveEquipmentPersonBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProtectiveEquipmentPersonBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProtectiveEquipmentPersonBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProtectiveEquipmentPersonBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProtectiveEquipmentPersonBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProtectiveEquipmentPersonBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProtectiveEquipmentPersonBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<ProtectiveEquipmentPersonBoundingBox>() {
           @Override
           public void write(JsonWriter out, ProtectiveEquipmentPersonBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProtectiveEquipmentPersonBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProtectiveEquipmentPersonBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProtectiveEquipmentPersonBoundingBox
   * @throws IOException if the JSON string is invalid with respect to ProtectiveEquipmentPersonBoundingBox
   */
  public static ProtectiveEquipmentPersonBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProtectiveEquipmentPersonBoundingBox.class);
  }

  /**
   * Convert an instance of ProtectiveEquipmentPersonBoundingBox to an JSON string
   *
   * @return JSON string
   */
