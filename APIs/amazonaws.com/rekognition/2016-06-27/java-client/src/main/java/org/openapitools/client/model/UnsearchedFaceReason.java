...
/**
 * Gets or Sets UnsearchedFaceReason
 */
@JsonAdapter(UnsearchedFaceReason.Adapter.class)
public enum UnsearchedFaceReason {
  ...
  UnsearchedFaceReason(String value) {
    this.value = value;
  }
  ...
  public static UnsearchedFaceReason fromValue(String value) {
    for (UnsearchedFaceReason b : UnsearchedFaceReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnsearchedFaceReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnsearchedFaceReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UnsearchedFaceReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UnsearchedFaceReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UnsearchedFaceReason.fromValue(value);
  }
}
