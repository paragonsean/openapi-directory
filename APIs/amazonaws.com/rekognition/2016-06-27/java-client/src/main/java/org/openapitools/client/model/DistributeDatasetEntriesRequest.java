...
public class DistributeDatasetEntriesRequest {
  ...
  public DistributeDatasetEntriesRequest() {
  }

  public DistributeDatasetEntriesRequest datasets(List datasets) {
  ...
  public boolean equals(Object o) {
    ...
    DistributeDatasetEntriesRequest distributeDatasetEntriesRequest = (DistributeDatasetEntriesRequest) o;
    return Objects.equals(this.datasets, distributeDatasetEntriesRequest.datasets);
  }
  ...
  public String toString() {
    ...
    sb.append("class DistributeDatasetEntriesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DistributeDatasetEntriesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DistributeDatasetEntriesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DistributeDatasetEntriesRequest is not found in the empty JSON string", DistributeDatasetEntriesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DistributeDatasetEntriesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DistributeDatasetEntriesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DistributeDatasetEntriesRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `Datasets`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DistributeDatasetEntriesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DistributeDatasetEntriesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DistributeDatasetEntriesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DistributeDatasetEntriesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DistributeDatasetEntriesRequest>() {
           @Override
           public void write(JsonWriter out, DistributeDatasetEntriesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DistributeDatasetEntriesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DistributeDatasetEntriesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DistributeDatasetEntriesRequest
   * @throws IOException if the JSON string is invalid with respect to DistributeDatasetEntriesRequest
   */
  public static DistributeDatasetEntriesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DistributeDatasetEntriesRequest.class);
  }

  /**
   * Convert an instance of DistributeDatasetEntriesRequest to an JSON string
   *
   * @return JSON string
   */
