...
public class StreamProcessor {
  ...
  public StreamProcessor name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StreamProcessor status(StreamProcessorStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessor streamProcessor = (StreamProcessor) o;
    return Objects.equals(this.name, streamProcessor.name) &&
        Objects.equals(this.status, streamProcessor.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessor is not found in the empty JSON string", StreamProcessor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessor.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessor>() {
           @Override
           public void write(JsonWriter out, StreamProcessor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessor
   * @throws IOException if the JSON string is invalid with respect to StreamProcessor
   */
  public static StreamProcessor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessor.class);
  }

  /**
   * Convert an instance of StreamProcessor to an JSON string
   *
   * @return JSON string
   */
