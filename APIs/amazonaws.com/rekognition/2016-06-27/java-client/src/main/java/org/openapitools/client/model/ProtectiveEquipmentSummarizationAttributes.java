...
public class ProtectiveEquipmentSummarizationAttributes {
  ...
  public static final String SERIALIZED_NAME_REQUIRED_EQUIPMENT_TYPES = "RequiredEquipmentTypes";
  @SerializedName(SERIALIZED_NAME_REQUIRED_EQUIPMENT_TYPES)
  private List requiredEquipmentTypes;

  public ProtectiveEquipmentSummarizationAttributes() {
  }

  public ProtectiveEquipmentSummarizationAttributes minConfidence(Float minConfidence) {
  ...
  public ProtectiveEquipmentSummarizationAttributes requiredEquipmentTypes(List requiredEquipmentTypes) {
    this.requiredEquipmentTypes = requiredEquipmentTypes;
    return this;
  }

  /**
   * Get requiredEquipmentTypes
   * @return requiredEquipmentTypes
   */
  @javax.annotation.Nonnull
  public List getRequiredEquipmentTypes() {
    return requiredEquipmentTypes;
  }

  public void setRequiredEquipmentTypes(List requiredEquipmentTypes) {
    this.requiredEquipmentTypes = requiredEquipmentTypes;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProtectiveEquipmentSummarizationAttributes protectiveEquipmentSummarizationAttributes = (ProtectiveEquipmentSummarizationAttributes) o;
    return Objects.equals(this.minConfidence, protectiveEquipmentSummarizationAttributes.minConfidence) &&
        Objects.equals(this.requiredEquipmentTypes, protectiveEquipmentSummarizationAttributes.requiredEquipmentTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(minConfidence, requiredEquipmentTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProtectiveEquipmentSummarizationAttributes {\n");
    sb.append("    minConfidence: ").append(toIndentedString(minConfidence)).append("\n");
    sb.append("    requiredEquipmentTypes: ").append(toIndentedString(requiredEquipmentTypes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("RequiredEquipmentTypes");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("MinConfidence");
    openapiRequiredFields.add("RequiredEquipmentTypes");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProtectiveEquipmentSummarizationAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProtectiveEquipmentSummarizationAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProtectiveEquipmentSummarizationAttributes is not found in the empty JSON string", ProtectiveEquipmentSummarizationAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProtectiveEquipmentSummarizationAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProtectiveEquipmentSummarizationAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProtectiveEquipmentSummarizationAttributes.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `MinConfidence`
      Float.validateJsonElement(jsonObj.get("MinConfidence"));
      // validate the required field `RequiredEquipmentTypes`
      List.validateJsonElement(jsonObj.get("RequiredEquipmentTypes"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProtectiveEquipmentSummarizationAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProtectiveEquipmentSummarizationAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProtectiveEquipmentSummarizationAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProtectiveEquipmentSummarizationAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ProtectiveEquipmentSummarizationAttributes>() {
           @Override
           public void write(JsonWriter out, ProtectiveEquipmentSummarizationAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProtectiveEquipmentSummarizationAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProtectiveEquipmentSummarizationAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProtectiveEquipmentSummarizationAttributes
   * @throws IOException if the JSON string is invalid with respect to ProtectiveEquipmentSummarizationAttributes
   */
  public static ProtectiveEquipmentSummarizationAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProtectiveEquipmentSummarizationAttributes.class);
  }

  /**
   * Convert an instance of ProtectiveEquipmentSummarizationAttributes to an JSON string
   *
   * @return JSON string
   */
