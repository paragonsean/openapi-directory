...
public class StreamProcessorOutputS3Destination {
  ...
  public StreamProcessorOutputS3Destination() {
  }

  public StreamProcessorOutputS3Destination bucket(String bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public StreamProcessorOutputS3Destination keyPrefix(String keyPrefix) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorOutputS3Destination streamProcessorOutputS3Destination = (StreamProcessorOutputS3Destination) o;
    return Objects.equals(this.bucket, streamProcessorOutputS3Destination.bucket) &&
        Objects.equals(this.keyPrefix, streamProcessorOutputS3Destination.keyPrefix);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessorOutputS3Destination {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorOutputS3Destination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorOutputS3Destination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorOutputS3Destination is not found in the empty JSON string", StreamProcessorOutputS3Destination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorOutputS3Destination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorOutputS3Destination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorOutputS3Destination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorOutputS3Destination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorOutputS3Destination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorOutputS3Destination.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorOutputS3Destination>() {
           @Override
           public void write(JsonWriter out, StreamProcessorOutputS3Destination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorOutputS3Destination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorOutputS3Destination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorOutputS3Destination
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorOutputS3Destination
   */
  public static StreamProcessorOutputS3Destination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorOutputS3Destination.class);
  }

  /**
   * Convert an instance of StreamProcessorOutputS3Destination to an JSON string
   *
   * @return JSON string
   */
