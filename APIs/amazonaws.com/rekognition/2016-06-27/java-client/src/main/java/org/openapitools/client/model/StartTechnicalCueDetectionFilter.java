...
import org.openapitools.client.model.StartTechnicalCueDetectionFilterBlackFrame;
...
public class StartTechnicalCueDetectionFilter {
  ...
  public static final String SERIALIZED_NAME_BLACK_FRAME = "BlackFrame";
  @SerializedName(SERIALIZED_NAME_BLACK_FRAME)
  private StartTechnicalCueDetectionFilterBlackFrame blackFrame;

  public StartTechnicalCueDetectionFilter() {
  }

  public StartTechnicalCueDetectionFilter minSegmentConfidence(Float minSegmentConfidence) {
  ...
  public StartTechnicalCueDetectionFilter blackFrame(StartTechnicalCueDetectionFilterBlackFrame blackFrame) {
   ...
   */
  @javax.annotation.Nullable
  public StartTechnicalCueDetectionFilterBlackFrame getBlackFrame() {
    return blackFrame;
  }

  public void setBlackFrame(StartTechnicalCueDetectionFilterBlackFrame blackFrame) {
    this.blackFrame = blackFrame;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartTechnicalCueDetectionFilter startTechnicalCueDetectionFilter = (StartTechnicalCueDetectionFilter) o;
    return Objects.equals(this.minSegmentConfidence, startTechnicalCueDetectionFilter.minSegmentConfidence) &&
        Objects.equals(this.blackFrame, startTechnicalCueDetectionFilter.blackFrame);
  }

  @Override
  public int hashCode() {
    return Objects.hash(minSegmentConfidence, blackFrame);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartTechnicalCueDetectionFilter {\n");
    sb.append("    minSegmentConfidence: ").append(toIndentedString(minSegmentConfidence)).append("\n");
    sb.append("    blackFrame: ").append(toIndentedString(blackFrame)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTechnicalCueDetectionFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTechnicalCueDetectionFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTechnicalCueDetectionFilter is not found in the empty JSON string", StartTechnicalCueDetectionFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTechnicalCueDetectionFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTechnicalCueDetectionFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("BlackFrame") != null && !jsonObj.get("BlackFrame").isJsonNull()) {
        StartTechnicalCueDetectionFilterBlackFrame.validateJsonElement(jsonObj.get("BlackFrame"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTechnicalCueDetectionFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTechnicalCueDetectionFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTechnicalCueDetectionFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTechnicalCueDetectionFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTechnicalCueDetectionFilter>() {
           @Override
           public void write(JsonWriter out, StartTechnicalCueDetectionFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTechnicalCueDetectionFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTechnicalCueDetectionFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTechnicalCueDetectionFilter
   * @throws IOException if the JSON string is invalid with respect to StartTechnicalCueDetectionFilter
   */
  public static StartTechnicalCueDetectionFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTechnicalCueDetectionFilter.class);
  }

  /**
   * Convert an instance of StartTechnicalCueDetectionFilter to an JSON string
   *
   * @return JSON string
   */
