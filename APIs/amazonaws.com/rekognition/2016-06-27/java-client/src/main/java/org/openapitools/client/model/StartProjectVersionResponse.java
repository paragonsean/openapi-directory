...
public class StartProjectVersionResponse {
  ...
  public StartProjectVersionResponse status(ProjectVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartProjectVersionResponse startProjectVersionResponse = (StartProjectVersionResponse) o;
    return Objects.equals(this.status, startProjectVersionResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartProjectVersionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartProjectVersionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartProjectVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartProjectVersionResponse is not found in the empty JSON string", StartProjectVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartProjectVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartProjectVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartProjectVersionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartProjectVersionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartProjectVersionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartProjectVersionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartProjectVersionResponse>() {
           @Override
           public void write(JsonWriter out, StartProjectVersionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartProjectVersionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartProjectVersionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartProjectVersionResponse
   * @throws IOException if the JSON string is invalid with respect to StartProjectVersionResponse
   */
  public static StartProjectVersionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartProjectVersionResponse.class);
  }

  /**
   * Convert an instance of StartProjectVersionResponse to an JSON string
   *
   * @return JSON string
   */
