...
public class IndexFacesResponse {
  public static final String SERIALIZED_NAME_FACE_RECORDS = "FaceRecords";
  @SerializedName(SERIALIZED_NAME_FACE_RECORDS)
  private List faceRecords;
  ...
  public static final String SERIALIZED_NAME_UNINDEXED_FACES = "UnindexedFaces";
  @SerializedName(SERIALIZED_NAME_UNINDEXED_FACES)
  private List unindexedFaces;

  public IndexFacesResponse() {
  }

  public IndexFacesResponse faceRecords(List faceRecords) {
  ...
  public List getFaceRecords() {
    return faceRecords;
  }

  public void setFaceRecords(List faceRecords) {
    this.faceRecords = faceRecords;
  }


  public IndexFacesResponse orientationCorrection(OrientationCorrection orientationCorrection) {
  ...
  public IndexFacesResponse faceModelVersion(String faceModelVersion) {
  ...
  public IndexFacesResponse unindexedFaces(List unindexedFaces) {
   ...
   */
  @javax.annotation.Nullable
  public List getUnindexedFaces() {
    return unindexedFaces;
  }

  public void setUnindexedFaces(List unindexedFaces) {
    this.unindexedFaces = unindexedFaces;
  }
  ...
  public boolean equals(Object o) {
    ...
    IndexFacesResponse indexFacesResponse = (IndexFacesResponse) o;
    return Objects.equals(this.faceRecords, indexFacesResponse.faceRecords) &&
        Objects.equals(this.orientationCorrection, indexFacesResponse.orientationCorrection) &&
        Objects.equals(this.faceModelVersion, indexFacesResponse.faceModelVersion) &&
        Objects.equals(this.unindexedFaces, indexFacesResponse.unindexedFaces);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceRecords, orientationCorrection, faceModelVersion, unindexedFaces);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IndexFacesResponse {\n");
    sb.append("    faceRecords: ").append(toIndentedString(faceRecords)).append("\n");
    ...
    sb.append("    unindexedFaces: ").append(toIndentedString(unindexedFaces)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IndexFacesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndexFacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IndexFacesResponse is not found in the empty JSON string", IndexFacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IndexFacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IndexFacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `FaceRecords`
      if (jsonObj.get("FaceRecords") != null && !jsonObj.get("FaceRecords").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("FaceRecords"));
      }
      ...
      // validate the optional field `UnindexedFaces`
      if (jsonObj.get("UnindexedFaces") != null && !jsonObj.get("UnindexedFaces").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("UnindexedFaces"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IndexFacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IndexFacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IndexFacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IndexFacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IndexFacesResponse>() {
           @Override
           public void write(JsonWriter out, IndexFacesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IndexFacesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IndexFacesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IndexFacesResponse
   * @throws IOException if the JSON string is invalid with respect to IndexFacesResponse
   */
  public static IndexFacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IndexFacesResponse.class);
  }

  /**
   * Convert an instance of IndexFacesResponse to an JSON string
   *
   * @return JSON string
   */
