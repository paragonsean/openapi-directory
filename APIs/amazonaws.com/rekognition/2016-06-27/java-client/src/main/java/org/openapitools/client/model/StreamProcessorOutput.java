...
import org.openapitools.client.model.StreamProcessorOutputKinesisDataStream;
import org.openapitools.client.model.StreamProcessorOutputS3Destination;
...
public class StreamProcessorOutput {
  public static final String SERIALIZED_NAME_KINESIS_DATA_STREAM = "KinesisDataStream";
  @SerializedName(SERIALIZED_NAME_KINESIS_DATA_STREAM)
  private StreamProcessorOutputKinesisDataStream kinesisDataStream;

  public static final String SERIALIZED_NAME_S3_DESTINATION = "S3Destination";
  @SerializedName(SERIALIZED_NAME_S3_DESTINATION)
  private StreamProcessorOutputS3Destination s3Destination;

  public StreamProcessorOutput() {
  }

  public StreamProcessorOutput kinesisDataStream(StreamProcessorOutputKinesisDataStream kinesisDataStream) {
  ...
  public StreamProcessorOutputKinesisDataStream getKinesisDataStream() {
    return kinesisDataStream;
  }

  public void setKinesisDataStream(StreamProcessorOutputKinesisDataStream kinesisDataStream) {
    this.kinesisDataStream = kinesisDataStream;
  }


  public StreamProcessorOutput s3Destination(StreamProcessorOutputS3Destination s3Destination) {
   ...
   */
  @javax.annotation.Nullable
  public StreamProcessorOutputS3Destination getS3Destination() {
    return s3Destination;
  }

  public void setS3Destination(StreamProcessorOutputS3Destination s3Destination) {
    this.s3Destination = s3Destination;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorOutput streamProcessorOutput = (StreamProcessorOutput) o;
    return Objects.equals(this.kinesisDataStream, streamProcessorOutput.kinesisDataStream) &&
        Objects.equals(this.s3Destination, streamProcessorOutput.s3Destination);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kinesisDataStream, s3Destination);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamProcessorOutput {\n");
    sb.append("    kinesisDataStream: ").append(toIndentedString(kinesisDataStream)).append("\n");
  ...
  static {
    ...
    openapiFields.add("KinesisDataStream");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorOutput is not found in the empty JSON string", StreamProcessorOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `KinesisDataStream`
      if (jsonObj.get("KinesisDataStream") != null && !jsonObj.get("KinesisDataStream").isJsonNull()) {
        StreamProcessorOutputKinesisDataStream.validateJsonElement(jsonObj.get("KinesisDataStream"));
      }
      // validate the optional field `S3Destination`
      if (jsonObj.get("S3Destination") != null && !jsonObj.get("S3Destination").isJsonNull()) {
        StreamProcessorOutputS3Destination.validateJsonElement(jsonObj.get("S3Destination"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorOutput>() {
           @Override
           public void write(JsonWriter out, StreamProcessorOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorOutput
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorOutput
   */
  public static StreamProcessorOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorOutput.class);
  }

  /**
   * Convert an instance of StreamProcessorOutput to an JSON string
   *
   * @return JSON string
   */
