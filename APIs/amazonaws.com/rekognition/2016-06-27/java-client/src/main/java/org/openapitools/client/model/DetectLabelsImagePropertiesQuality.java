...
/**
 * DetectLabelsImagePropertiesQuality
 */
...
public class DetectLabelsImagePropertiesQuality {
  ...
  public DetectLabelsImagePropertiesQuality() {
  }

  public DetectLabelsImagePropertiesQuality brightness(Float brightness) {
  ...
  public DetectLabelsImagePropertiesQuality sharpness(Float sharpness) {
  ...
  public DetectLabelsImagePropertiesQuality contrast(Float contrast) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImagePropertiesQuality detectLabelsImagePropertiesQuality = (DetectLabelsImagePropertiesQuality) o;
    return Objects.equals(this.brightness, detectLabelsImagePropertiesQuality.brightness) &&
        Objects.equals(this.sharpness, detectLabelsImagePropertiesQuality.sharpness) &&
        Objects.equals(this.contrast, detectLabelsImagePropertiesQuality.contrast);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brightness, sharpness, contrast);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectLabelsImagePropertiesQuality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImagePropertiesQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImagePropertiesQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImagePropertiesQuality is not found in the empty JSON string", DetectLabelsImagePropertiesQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImagePropertiesQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImagePropertiesQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Brightness`
      if (jsonObj.get("Brightness") != null && !jsonObj.get("Brightness").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("Brightness"));
      }
      // validate the optional field `Sharpness`
      if (jsonObj.get("Sharpness") != null && !jsonObj.get("Sharpness").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("Sharpness"));
      }
      // validate the optional field `Contrast`
      if (jsonObj.get("Contrast") != null && !jsonObj.get("Contrast").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("Contrast"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImagePropertiesQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImagePropertiesQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImagePropertiesQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImagePropertiesQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImagePropertiesQuality>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImagePropertiesQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImagePropertiesQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImagePropertiesQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImagePropertiesQuality
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImagePropertiesQuality
   */
  public static DetectLabelsImagePropertiesQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImagePropertiesQuality.class);
  }

  /**
   * Convert an instance of DetectLabelsImagePropertiesQuality to an JSON string
   *
   * @return JSON string
   */
