...
public class Eyeglasses {
  ...
  public Eyeglasses value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public Eyeglasses confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    Eyeglasses eyeglasses = (Eyeglasses) o;
    return Objects.equals(this.value, eyeglasses.value) &&
        Objects.equals(this.confidence, eyeglasses.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Eyeglasses
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Eyeglasses.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Eyeglasses is not found in the empty JSON string", Eyeglasses.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Eyeglasses.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Eyeglasses` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Eyeglasses.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Eyeglasses' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Eyeglasses> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Eyeglasses.class));

       return (TypeAdapter<T>) new TypeAdapter<Eyeglasses>() {
           @Override
           public void write(JsonWriter out, Eyeglasses value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Eyeglasses read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Eyeglasses given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Eyeglasses
   * @throws IOException if the JSON string is invalid with respect to Eyeglasses
   */
  public static Eyeglasses fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Eyeglasses.class);
  }

  /**
   * Convert an instance of Eyeglasses to an JSON string
   *
   * @return JSON string
   */
