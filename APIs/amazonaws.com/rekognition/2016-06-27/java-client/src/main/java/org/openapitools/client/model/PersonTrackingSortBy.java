...
/**
 * Gets or Sets PersonTrackingSortBy
 */
@JsonAdapter(PersonTrackingSortBy.Adapter.class)
public enum PersonTrackingSortBy {
  ...
  PersonTrackingSortBy(String value) {
    this.value = value;
  }
  ...
  public static PersonTrackingSortBy fromValue(String value) {
    for (PersonTrackingSortBy b : PersonTrackingSortBy.values()) {
  ...
  public static class Adapter extends TypeAdapter<PersonTrackingSortBy> {
    @Override
    public void write(final JsonWriter jsonWriter, final PersonTrackingSortBy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PersonTrackingSortBy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PersonTrackingSortBy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PersonTrackingSortBy.fromValue(value);
  }
}
