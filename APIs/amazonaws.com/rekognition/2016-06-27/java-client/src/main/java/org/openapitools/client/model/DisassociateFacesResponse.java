...
public class DisassociateFacesResponse {
  public static final String SERIALIZED_NAME_DISASSOCIATED_FACES = "DisassociatedFaces";
  @SerializedName(SERIALIZED_NAME_DISASSOCIATED_FACES)
  private List disassociatedFaces;

  public static final String SERIALIZED_NAME_UNSUCCESSFUL_FACE_DISASSOCIATIONS = "UnsuccessfulFaceDisassociations";
  @SerializedName(SERIALIZED_NAME_UNSUCCESSFUL_FACE_DISASSOCIATIONS)
  private List unsuccessfulFaceDisassociations;
  ...
  public DisassociateFacesResponse disassociatedFaces(List disassociatedFaces) {
    this.disassociatedFaces = disassociatedFaces;
    return this;
  }

  /**
   * Get disassociatedFaces
   * @return disassociatedFaces
   */
  @javax.annotation.Nullable
  public List getDisassociatedFaces() {
    return disassociatedFaces;
  }

  public void setDisassociatedFaces(List disassociatedFaces) {
    this.disassociatedFaces = disassociatedFaces;
  }


  public DisassociateFacesResponse unsuccessfulFaceDisassociations(List unsuccessfulFaceDisassociations) {
    this.unsuccessfulFaceDisassociations = unsuccessfulFaceDisassociations;
    return this;
  }

  /**
   * Get unsuccessfulFaceDisassociations
   * @return unsuccessfulFaceDisassociations
   */
  @javax.annotation.Nullable
  public List getUnsuccessfulFaceDisassociations() {
    return unsuccessfulFaceDisassociations;
  }

  public void setUnsuccessfulFaceDisassociations(List unsuccessfulFaceDisassociations) {
    this.unsuccessfulFaceDisassociations = unsuccessfulFaceDisassociations;
  }


  public DisassociateFacesResponse userStatus(UserStatus userStatus) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateFacesResponse disassociateFacesResponse = (DisassociateFacesResponse) o;
    return Objects.equals(this.disassociatedFaces, disassociateFacesResponse.disassociatedFaces) &&
        Objects.equals(this.unsuccessfulFaceDisassociations, disassociateFacesResponse.unsuccessfulFaceDisassociations) &&
        Objects.equals(this.userStatus, disassociateFacesResponse.userStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disassociatedFaces, unsuccessfulFaceDisassociations, userStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisassociateFacesResponse {\n");
    sb.append("    disassociatedFaces: ").append(toIndentedString(disassociatedFaces)).append("\n");
    sb.append("    unsuccessfulFaceDisassociations: ").append(toIndentedString(unsuccessfulFaceDisassociations)).append("\n");
  ...
  static {
    ...
    openapiFields.add("DisassociatedFaces");
    openapiFields.add("UnsuccessfulFaceDisassociations");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateFacesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateFacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateFacesResponse is not found in the empty JSON string", DisassociateFacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateFacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateFacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DisassociatedFaces`
      if (jsonObj.get("DisassociatedFaces") != null && !jsonObj.get("DisassociatedFaces").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DisassociatedFaces"));
      }
      // validate the optional field `UnsuccessfulFaceDisassociations`
      if (jsonObj.get("UnsuccessfulFaceDisassociations") != null && !jsonObj.get("UnsuccessfulFaceDisassociations").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("UnsuccessfulFaceDisassociations"));
      }
      // validate the optional field `UserStatus`
      if (jsonObj.get("UserStatus") != null && !jsonObj.get("UserStatus").isJsonNull()) {
        UserStatus.validateJsonElement(jsonObj.get("UserStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateFacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateFacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateFacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateFacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateFacesResponse>() {
           @Override
           public void write(JsonWriter out, DisassociateFacesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateFacesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateFacesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateFacesResponse
   * @throws IOException if the JSON string is invalid with respect to DisassociateFacesResponse
   */
  public static DisassociateFacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateFacesResponse.class);
  }

  /**
   * Convert an instance of DisassociateFacesResponse to an JSON string
   *
   * @return JSON string
   */
