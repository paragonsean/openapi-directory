...
public class VideoS3Object {
  ...
  public VideoS3Object() {
  }

  public VideoS3Object bucket(String bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public VideoS3Object name(String name) {
    this.name = name;
    return this;
  }
  ...
  public VideoS3Object version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    VideoS3Object videoS3Object = (VideoS3Object) o;
    return Objects.equals(this.bucket, videoS3Object.bucket) &&
        Objects.equals(this.name, videoS3Object.name) &&
        Objects.equals(this.version, videoS3Object.version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoS3Object
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoS3Object.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoS3Object is not found in the empty JSON string", VideoS3Object.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoS3Object.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoS3Object` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoS3Object.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoS3Object' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoS3Object> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoS3Object.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoS3Object>() {
           @Override
           public void write(JsonWriter out, VideoS3Object value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoS3Object read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoS3Object given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoS3Object
   * @throws IOException if the JSON string is invalid with respect to VideoS3Object
   */
  public static VideoS3Object fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoS3Object.class);
  }

  /**
   * Convert an instance of VideoS3Object to an JSON string
   *
   * @return JSON string
   */
