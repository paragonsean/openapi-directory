...
public class StartShotDetectionFilter {
  ...
  public StartShotDetectionFilter minSegmentConfidence(Float minSegmentConfidence) {
  ...
  public boolean equals(Object o) {
    ...
    StartShotDetectionFilter startShotDetectionFilter = (StartShotDetectionFilter) o;
    return Objects.equals(this.minSegmentConfidence, startShotDetectionFilter.minSegmentConfidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartShotDetectionFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartShotDetectionFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartShotDetectionFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartShotDetectionFilter is not found in the empty JSON string", StartShotDetectionFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartShotDetectionFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartShotDetectionFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartShotDetectionFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartShotDetectionFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartShotDetectionFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartShotDetectionFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<StartShotDetectionFilter>() {
           @Override
           public void write(JsonWriter out, StartShotDetectionFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartShotDetectionFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartShotDetectionFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartShotDetectionFilter
   * @throws IOException if the JSON string is invalid with respect to StartShotDetectionFilter
   */
  public static StartShotDetectionFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartShotDetectionFilter.class);
  }

  /**
   * Convert an instance of StartShotDetectionFilter to an JSON string
   *
   * @return JSON string
   */
