...
public class DeleteProjectPolicyRequest {
  ...
  public DeleteProjectPolicyRequest() {
  }

  public DeleteProjectPolicyRequest projectArn(String projectArn) {
  ...
  public DeleteProjectPolicyRequest policyName(String policyName) {
  ...
  public DeleteProjectPolicyRequest policyRevisionId(String policyRevisionId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteProjectPolicyRequest deleteProjectPolicyRequest = (DeleteProjectPolicyRequest) o;
    return Objects.equals(this.projectArn, deleteProjectPolicyRequest.projectArn) &&
        Objects.equals(this.policyName, deleteProjectPolicyRequest.policyName) &&
        Objects.equals(this.policyRevisionId, deleteProjectPolicyRequest.policyRevisionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectArn, policyName, policyRevisionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteProjectPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteProjectPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteProjectPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteProjectPolicyRequest is not found in the empty JSON string", DeleteProjectPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteProjectPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteProjectPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteProjectPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteProjectPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteProjectPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteProjectPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteProjectPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteProjectPolicyRequest>() {
           @Override
           public void write(JsonWriter out, DeleteProjectPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteProjectPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteProjectPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteProjectPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteProjectPolicyRequest
   */
  public static DeleteProjectPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteProjectPolicyRequest.class);
  }

  /**
   * Convert an instance of DeleteProjectPolicyRequest to an JSON string
   *
   * @return JSON string
   */
