...
/**
 * ProjectVersionDescriptionTestingDataResult
 */
...
public class ProjectVersionDescriptionTestingDataResult {
  public static final String SERIALIZED_NAME_INPUT = "Input";
  @SerializedName(SERIALIZED_NAME_INPUT)
  private TestingDataResultInput input;

  public static final String SERIALIZED_NAME_OUTPUT = "Output";
  @SerializedName(SERIALIZED_NAME_OUTPUT)
  private TestingDataResultOutput output;

  public static final String SERIALIZED_NAME_VALIDATION = "Validation";
  @SerializedName(SERIALIZED_NAME_VALIDATION)
  private TestingDataResultValidation validation;

  public ProjectVersionDescriptionTestingDataResult() {
  }

  public ProjectVersionDescriptionTestingDataResult input(TestingDataResultInput input) {
    this.input = input;
    return this;
  }
  ...
  public TestingDataResultInput getInput() {
    return input;
  }

  public void setInput(TestingDataResultInput input) {
    this.input = input;
  }


  public ProjectVersionDescriptionTestingDataResult output(TestingDataResultOutput output) {
    this.output = output;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public TestingDataResultOutput getOutput() {
    return output;
  }

  public void setOutput(TestingDataResultOutput output) {
    this.output = output;
  }


  public ProjectVersionDescriptionTestingDataResult validation(TestingDataResultValidation validation) {
   ...
   */
  @javax.annotation.Nullable
  public TestingDataResultValidation getValidation() {
    return validation;
  }

  public void setValidation(TestingDataResultValidation validation) {
    this.validation = validation;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectVersionDescriptionTestingDataResult projectVersionDescriptionTestingDataResult = (ProjectVersionDescriptionTestingDataResult) o;
    return Objects.equals(this.input, projectVersionDescriptionTestingDataResult.input) &&
        Objects.equals(this.output, projectVersionDescriptionTestingDataResult.output) &&
        Objects.equals(this.validation, projectVersionDescriptionTestingDataResult.validation);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectVersionDescriptionTestingDataResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectVersionDescriptionTestingDataResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectVersionDescriptionTestingDataResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectVersionDescriptionTestingDataResult is not found in the empty JSON string", ProjectVersionDescriptionTestingDataResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectVersionDescriptionTestingDataResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectVersionDescriptionTestingDataResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Input`
      if (jsonObj.get("Input") != null && !jsonObj.get("Input").isJsonNull()) {
        TestingDataResultInput.validateJsonElement(jsonObj.get("Input"));
      }
      // validate the optional field `Output`
      if (jsonObj.get("Output") != null && !jsonObj.get("Output").isJsonNull()) {
        TestingDataResultOutput.validateJsonElement(jsonObj.get("Output"));
      }
      // validate the optional field `Validation`
      if (jsonObj.get("Validation") != null && !jsonObj.get("Validation").isJsonNull()) {
        TestingDataResultValidation.validateJsonElement(jsonObj.get("Validation"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectVersionDescriptionTestingDataResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectVersionDescriptionTestingDataResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectVersionDescriptionTestingDataResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectVersionDescriptionTestingDataResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectVersionDescriptionTestingDataResult>() {
           @Override
           public void write(JsonWriter out, ProjectVersionDescriptionTestingDataResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectVersionDescriptionTestingDataResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectVersionDescriptionTestingDataResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectVersionDescriptionTestingDataResult
   * @throws IOException if the JSON string is invalid with respect to ProjectVersionDescriptionTestingDataResult
   */
  public static ProjectVersionDescriptionTestingDataResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectVersionDescriptionTestingDataResult.class);
  }

  /**
   * Convert an instance of ProjectVersionDescriptionTestingDataResult to an JSON string
   *
   * @return JSON string
   */
