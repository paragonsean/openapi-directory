...
public class CompareFacesRequestTargetImage {
  ...
  public CompareFacesRequestTargetImage() {
  }

  public CompareFacesRequestTargetImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public CompareFacesRequestTargetImage s3Object(ImageS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    CompareFacesRequestTargetImage compareFacesRequestTargetImage = (CompareFacesRequestTargetImage) o;
    return Objects.equals(this.bytes, compareFacesRequestTargetImage.bytes) &&
        Objects.equals(this.s3Object, compareFacesRequestTargetImage.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompareFacesRequestTargetImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompareFacesRequestTargetImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompareFacesRequestTargetImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompareFacesRequestTargetImage is not found in the empty JSON string", CompareFacesRequestTargetImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompareFacesRequestTargetImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompareFacesRequestTargetImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompareFacesRequestTargetImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompareFacesRequestTargetImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompareFacesRequestTargetImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompareFacesRequestTargetImage.class));

       return (TypeAdapter<T>) new TypeAdapter<CompareFacesRequestTargetImage>() {
           @Override
           public void write(JsonWriter out, CompareFacesRequestTargetImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompareFacesRequestTargetImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompareFacesRequestTargetImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompareFacesRequestTargetImage
   * @throws IOException if the JSON string is invalid with respect to CompareFacesRequestTargetImage
   */
  public static CompareFacesRequestTargetImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompareFacesRequestTargetImage.class);
  }

  /**
   * Convert an instance of CompareFacesRequestTargetImage to an JSON string
   *
   * @return JSON string
   */
