...
public class ListCollectionsResponse {
  ...
  public static final String SERIALIZED_NAME_FACE_MODEL_VERSIONS = "FaceModelVersions";
  @SerializedName(SERIALIZED_NAME_FACE_MODEL_VERSIONS)
  private List faceModelVersions;

  public ListCollectionsResponse() {
  }

  public ListCollectionsResponse collectionIds(List collectionIds) {
  ...
  public ListCollectionsResponse faceModelVersions(List faceModelVersions) {
    this.faceModelVersions = faceModelVersions;
    return this;
  }

  /**
   * Get faceModelVersions
   * @return faceModelVersions
   */
  @javax.annotation.Nullable
  public List getFaceModelVersions() {
    return faceModelVersions;
  }

  public void setFaceModelVersions(List faceModelVersions) {
    this.faceModelVersions = faceModelVersions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collectionIds, listCollectionsResponse.collectionIds) &&
        Objects.equals(this.nextToken, listCollectionsResponse.nextToken) &&
        Objects.equals(this.faceModelVersions, listCollectionsResponse.faceModelVersions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionIds, nextToken, faceModelVersions);
  }
  ...
  public String toString() {
    ...
    sb.append("    faceModelVersions: ").append(toIndentedString(faceModelVersions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("FaceModelVersions");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `CollectionIds`
      if (jsonObj.get("CollectionIds") != null && !jsonObj.get("CollectionIds").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("CollectionIds"));
      }
      // validate the optional field `NextToken`
      if (jsonObj.get("NextToken") != null && !jsonObj.get("NextToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("NextToken"));
      }
      // validate the optional field `FaceModelVersions`
      if (jsonObj.get("FaceModelVersions") != null && !jsonObj.get("FaceModelVersions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("FaceModelVersions"));
      }
  }
