...
public class CreateProjectVersionResponse {
  ...
  public CreateProjectVersionResponse projectVersionArn(String projectVersionArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectVersionResponse createProjectVersionResponse = (CreateProjectVersionResponse) o;
    return Objects.equals(this.projectVersionArn, createProjectVersionResponse.projectVersionArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectVersionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectVersionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectVersionResponse is not found in the empty JSON string", CreateProjectVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectVersionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectVersionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectVersionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectVersionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectVersionResponse>() {
           @Override
           public void write(JsonWriter out, CreateProjectVersionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectVersionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectVersionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectVersionResponse
   * @throws IOException if the JSON string is invalid with respect to CreateProjectVersionResponse
   */
  public static CreateProjectVersionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectVersionResponse.class);
  }

  /**
   * Convert an instance of CreateProjectVersionResponse to an JSON string
   *
   * @return JSON string
   */
