...
public class StartFaceSearchResponse {
  ...
  public StartFaceSearchResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartFaceSearchResponse startFaceSearchResponse = (StartFaceSearchResponse) o;
    return Objects.equals(this.jobId, startFaceSearchResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFaceSearchResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFaceSearchResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFaceSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFaceSearchResponse is not found in the empty JSON string", StartFaceSearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFaceSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFaceSearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFaceSearchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFaceSearchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFaceSearchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFaceSearchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFaceSearchResponse>() {
           @Override
           public void write(JsonWriter out, StartFaceSearchResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFaceSearchResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFaceSearchResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFaceSearchResponse
   * @throws IOException if the JSON string is invalid with respect to StartFaceSearchResponse
   */
  public static StartFaceSearchResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFaceSearchResponse.class);
  }

  /**
   * Convert an instance of StartFaceSearchResponse to an JSON string
   *
   * @return JSON string
   */
