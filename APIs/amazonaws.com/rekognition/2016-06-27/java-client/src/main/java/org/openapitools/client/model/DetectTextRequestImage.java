...
public class DetectTextRequestImage {
  ...
  public DetectTextRequestImage() {
  }

  public DetectTextRequestImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public DetectTextRequestImage s3Object(ImageS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    DetectTextRequestImage detectTextRequestImage = (DetectTextRequestImage) o;
    return Objects.equals(this.bytes, detectTextRequestImage.bytes) &&
        Objects.equals(this.s3Object, detectTextRequestImage.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectTextRequestImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectTextRequestImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectTextRequestImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectTextRequestImage is not found in the empty JSON string", DetectTextRequestImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectTextRequestImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectTextRequestImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectTextRequestImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectTextRequestImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectTextRequestImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectTextRequestImage.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectTextRequestImage>() {
           @Override
           public void write(JsonWriter out, DetectTextRequestImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectTextRequestImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectTextRequestImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectTextRequestImage
   * @throws IOException if the JSON string is invalid with respect to DetectTextRequestImage
   */
  public static DetectTextRequestImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectTextRequestImage.class);
  }

  /**
   * Convert an instance of DetectTextRequestImage to an JSON string
   *
   * @return JSON string
   */
