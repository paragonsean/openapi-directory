...
/**
 * EquipmentDetectionCoversBodyPart
 */
...
public class EquipmentDetectionCoversBodyPart {
  ...
  public EquipmentDetectionCoversBodyPart() {
  }

  public EquipmentDetectionCoversBodyPart confidence(Float confidence) {
  ...
  public EquipmentDetectionCoversBodyPart value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EquipmentDetectionCoversBodyPart equipmentDetectionCoversBodyPart = (EquipmentDetectionCoversBodyPart) o;
    return Objects.equals(this.confidence, equipmentDetectionCoversBodyPart.confidence) &&
        Objects.equals(this.value, equipmentDetectionCoversBodyPart.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class EquipmentDetectionCoversBodyPart {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EquipmentDetectionCoversBodyPart
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EquipmentDetectionCoversBodyPart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EquipmentDetectionCoversBodyPart is not found in the empty JSON string", EquipmentDetectionCoversBodyPart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EquipmentDetectionCoversBodyPart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EquipmentDetectionCoversBodyPart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EquipmentDetectionCoversBodyPart.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EquipmentDetectionCoversBodyPart' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EquipmentDetectionCoversBodyPart> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EquipmentDetectionCoversBodyPart.class));

       return (TypeAdapter<T>) new TypeAdapter<EquipmentDetectionCoversBodyPart>() {
           @Override
           public void write(JsonWriter out, EquipmentDetectionCoversBodyPart value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EquipmentDetectionCoversBodyPart read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EquipmentDetectionCoversBodyPart given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EquipmentDetectionCoversBodyPart
   * @throws IOException if the JSON string is invalid with respect to EquipmentDetectionCoversBodyPart
   */
  public static EquipmentDetectionCoversBodyPart fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EquipmentDetectionCoversBodyPart.class);
  }

  /**
   * Convert an instance of EquipmentDetectionCoversBodyPart to an JSON string
   *
   * @return JSON string
   */
