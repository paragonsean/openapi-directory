...
public class FaceDetailBeard {
  ...
  public FaceDetailBeard() {
  }

  public FaceDetailBeard value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailBeard confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailBeard faceDetailBeard = (FaceDetailBeard) o;
    return Objects.equals(this.value, faceDetailBeard.value) &&
        Objects.equals(this.confidence, faceDetailBeard.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailBeard {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailBeard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailBeard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailBeard is not found in the empty JSON string", FaceDetailBeard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailBeard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailBeard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailBeard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailBeard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailBeard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailBeard.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailBeard>() {
           @Override
           public void write(JsonWriter out, FaceDetailBeard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailBeard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailBeard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailBeard
   * @throws IOException if the JSON string is invalid with respect to FaceDetailBeard
   */
  public static FaceDetailBeard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailBeard.class);
  }

  /**
   * Convert an instance of FaceDetailBeard to an JSON string
   *
   * @return JSON string
   */
