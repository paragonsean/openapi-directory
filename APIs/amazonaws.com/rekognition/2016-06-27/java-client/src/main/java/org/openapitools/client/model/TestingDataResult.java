...
public class TestingDataResult {
  ...
  public TestingDataResult input(TestingDataResultInput input) {
    this.input = input;
    return this;
  }
  ...
  public TestingDataResult output(TestingDataResultOutput output) {
    this.output = output;
    return this;
  }
  ...
  public TestingDataResult validation(TestingDataResultValidation validation) {
  ...
  public boolean equals(Object o) {
    ...
    TestingDataResult testingDataResult = (TestingDataResult) o;
    return Objects.equals(this.input, testingDataResult.input) &&
        Objects.equals(this.output, testingDataResult.output) &&
        Objects.equals(this.validation, testingDataResult.validation);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestingDataResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestingDataResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestingDataResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestingDataResult is not found in the empty JSON string", TestingDataResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestingDataResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestingDataResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestingDataResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestingDataResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestingDataResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestingDataResult.class));

       return (TypeAdapter<T>) new TypeAdapter<TestingDataResult>() {
           @Override
           public void write(JsonWriter out, TestingDataResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestingDataResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestingDataResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestingDataResult
   * @throws IOException if the JSON string is invalid with respect to TestingDataResult
   */
  public static TestingDataResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestingDataResult.class);
  }

  /**
   * Convert an instance of TestingDataResult to an JSON string
   *
   * @return JSON string
   */
