...
public class PersonDetailBoundingBox {
  ...
  public PersonDetailBoundingBox() {
  }

  public PersonDetailBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public PersonDetailBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public PersonDetailBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public PersonDetailBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersonDetailBoundingBox personDetailBoundingBox = (PersonDetailBoundingBox) o;
    return Objects.equals(this.width, personDetailBoundingBox.width) &&
        Objects.equals(this.height, personDetailBoundingBox.height) &&
        Objects.equals(this.left, personDetailBoundingBox.left) &&
        Objects.equals(this.top, personDetailBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonDetailBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonDetailBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonDetailBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonDetailBoundingBox is not found in the empty JSON string", PersonDetailBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonDetailBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonDetailBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonDetailBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonDetailBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonDetailBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonDetailBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonDetailBoundingBox>() {
           @Override
           public void write(JsonWriter out, PersonDetailBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonDetailBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonDetailBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonDetailBoundingBox
   * @throws IOException if the JSON string is invalid with respect to PersonDetailBoundingBox
   */
  public static PersonDetailBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonDetailBoundingBox.class);
  }

  /**
   * Convert an instance of PersonDetailBoundingBox to an JSON string
   *
   * @return JSON string
   */
