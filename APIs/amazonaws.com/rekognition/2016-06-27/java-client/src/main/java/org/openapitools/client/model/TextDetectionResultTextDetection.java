...
import org.openapitools.client.model.TextDetectionGeometry;
import org.openapitools.client.model.TextTypes;
...
/**
 * TextDetectionResultTextDetection
 */
...
public class TextDetectionResultTextDetection {
  public static final String SERIALIZED_NAME_DETECTED_TEXT = "DetectedText";
  @SerializedName(SERIALIZED_NAME_DETECTED_TEXT)
  ...
  private TextDetectionGeometry geometry;

  public TextDetectionResultTextDetection() {
  }

  public TextDetectionResultTextDetection detectedText(String detectedText) {
  ...
  public TextDetectionResultTextDetection type(TextTypes type) {
    this.type = type;
    return this;
  }
  ...
  public TextDetectionResultTextDetection id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public TextDetectionResultTextDetection parentId(Integer parentId) {
  ...
  public TextDetectionResultTextDetection confidence(Float confidence) {
  ...
  public TextDetectionResultTextDetection geometry(TextDetectionGeometry geometry) {
   ...
   */
  @javax.annotation.Nullable
  public TextDetectionGeometry getGeometry() {
    return geometry;
  }

  public void setGeometry(TextDetectionGeometry geometry) {
    this.geometry = geometry;
  }
  ...
  public boolean equals(Object o) {
    ...
    TextDetectionResultTextDetection textDetectionResultTextDetection = (TextDetectionResultTextDetection) o;
    return Objects.equals(this.detectedText, textDetectionResultTextDetection.detectedText) &&
        Objects.equals(this.type, textDetectionResultTextDetection.type) &&
        Objects.equals(this.id, textDetectionResultTextDetection.id) &&
        Objects.equals(this.parentId, textDetectionResultTextDetection.parentId) &&
        Objects.equals(this.confidence, textDetectionResultTextDetection.confidence) &&
        Objects.equals(this.geometry, textDetectionResultTextDetection.geometry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(detectedText, type, id, parentId, confidence, geometry);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TextDetectionResultTextDetection {\n");
    sb.append("    detectedText: ").append(toIndentedString(detectedText)).append("\n");
  ...
  static {
    ...
    openapiFields.add("DetectedText");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextDetectionResultTextDetection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextDetectionResultTextDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TextDetectionResultTextDetection is not found in the empty JSON string", TextDetectionResultTextDetection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextDetectionResultTextDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TextDetectionResultTextDetection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DetectedText`
      if (jsonObj.get("DetectedText") != null && !jsonObj.get("DetectedText").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("DetectedText"));
      }
      // validate the optional field `Type`
      if (jsonObj.get("Type") != null && !jsonObj.get("Type").isJsonNull()) {
        TextTypes.validateJsonElement(jsonObj.get("Type"));
      }
      ...
      if (jsonObj.get("ParentId") != null && !jsonObj.get("ParentId").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("ParentId"));
      }
      ...
      if (jsonObj.get("Geometry") != null && !jsonObj.get("Geometry").isJsonNull()) {
        TextDetectionGeometry.validateJsonElement(jsonObj.get("Geometry"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TextDetectionResultTextDetection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TextDetectionResultTextDetection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TextDetectionResultTextDetection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TextDetectionResultTextDetection.class));

       return (TypeAdapter<T>) new TypeAdapter<TextDetectionResultTextDetection>() {
           @Override
           public void write(JsonWriter out, TextDetectionResultTextDetection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TextDetectionResultTextDetection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TextDetectionResultTextDetection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TextDetectionResultTextDetection
   * @throws IOException if the JSON string is invalid with respect to TextDetectionResultTextDetection
   */
  public static TextDetectionResultTextDetection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextDetectionResultTextDetection.class);
  }

  /**
   * Convert an instance of TextDetectionResultTextDetection to an JSON string
   *
   * @return JSON string
   */
