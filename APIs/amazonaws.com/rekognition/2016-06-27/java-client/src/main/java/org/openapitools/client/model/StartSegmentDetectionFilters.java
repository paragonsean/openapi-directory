...
public class StartSegmentDetectionFilters {
  ...
  public StartSegmentDetectionFilters technicalCueFilter(StartSegmentDetectionFiltersTechnicalCueFilter technicalCueFilter) {
  ...
  public StartSegmentDetectionFilters shotFilter(StartSegmentDetectionFiltersShotFilter shotFilter) {
  ...
  public boolean equals(Object o) {
    ...
    StartSegmentDetectionFilters startSegmentDetectionFilters = (StartSegmentDetectionFilters) o;
    return Objects.equals(this.technicalCueFilter, startSegmentDetectionFilters.technicalCueFilter) &&
        Objects.equals(this.shotFilter, startSegmentDetectionFilters.shotFilter);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartSegmentDetectionFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSegmentDetectionFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSegmentDetectionFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSegmentDetectionFilters is not found in the empty JSON string", StartSegmentDetectionFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSegmentDetectionFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSegmentDetectionFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSegmentDetectionFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSegmentDetectionFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSegmentDetectionFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSegmentDetectionFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSegmentDetectionFilters>() {
           @Override
           public void write(JsonWriter out, StartSegmentDetectionFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSegmentDetectionFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSegmentDetectionFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSegmentDetectionFilters
   * @throws IOException if the JSON string is invalid with respect to StartSegmentDetectionFilters
   */
  public static StartSegmentDetectionFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSegmentDetectionFilters.class);
  }

  /**
   * Convert an instance of StartSegmentDetectionFilters to an JSON string
   *
   * @return JSON string
   */
