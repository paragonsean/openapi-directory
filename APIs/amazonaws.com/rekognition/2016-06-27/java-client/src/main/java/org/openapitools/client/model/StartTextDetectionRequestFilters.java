...
import org.openapitools.client.model.StartTextDetectionFiltersWordFilter;
...
public class StartTextDetectionRequestFilters {
  public static final String SERIALIZED_NAME_WORD_FILTER = "WordFilter";
  @SerializedName(SERIALIZED_NAME_WORD_FILTER)
  private StartTextDetectionFiltersWordFilter wordFilter;
  ...
  public StartTextDetectionRequestFilters() {
  }

  public StartTextDetectionRequestFilters wordFilter(StartTextDetectionFiltersWordFilter wordFilter) {
  ...
  public StartTextDetectionFiltersWordFilter getWordFilter() {
    return wordFilter;
  }

  public void setWordFilter(StartTextDetectionFiltersWordFilter wordFilter) {
    this.wordFilter = wordFilter;
  }


  public StartTextDetectionRequestFilters regionsOfInterest(List regionsOfInterest) {
  ...
  public boolean equals(Object o) {
    ...
    StartTextDetectionRequestFilters startTextDetectionRequestFilters = (StartTextDetectionRequestFilters) o;
    return Objects.equals(this.wordFilter, startTextDetectionRequestFilters.wordFilter) &&
        Objects.equals(this.regionsOfInterest, startTextDetectionRequestFilters.regionsOfInterest);
  }

  @Override
  public int hashCode() {
    return Objects.hash(wordFilter, regionsOfInterest);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartTextDetectionRequestFilters {\n");
    sb.append("    wordFilter: ").append(toIndentedString(wordFilter)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTextDetectionRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTextDetectionRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTextDetectionRequestFilters is not found in the empty JSON string", StartTextDetectionRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTextDetectionRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTextDetectionRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `WordFilter`
      if (jsonObj.get("WordFilter") != null && !jsonObj.get("WordFilter").isJsonNull()) {
        StartTextDetectionFiltersWordFilter.validateJsonElement(jsonObj.get("WordFilter"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTextDetectionRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTextDetectionRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTextDetectionRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTextDetectionRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTextDetectionRequestFilters>() {
           @Override
           public void write(JsonWriter out, StartTextDetectionRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTextDetectionRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTextDetectionRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTextDetectionRequestFilters
   * @throws IOException if the JSON string is invalid with respect to StartTextDetectionRequestFilters
   */
  public static StartTextDetectionRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTextDetectionRequestFilters.class);
  }

  /**
   * Convert an instance of StartTextDetectionRequestFilters to an JSON string
   *
   * @return JSON string
   */
