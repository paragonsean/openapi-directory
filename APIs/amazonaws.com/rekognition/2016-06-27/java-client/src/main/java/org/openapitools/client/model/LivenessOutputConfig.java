...
public class LivenessOutputConfig {
  ...
  public LivenessOutputConfig() {
  }

  public LivenessOutputConfig s3Bucket(String s3Bucket) {
  ...
  public LivenessOutputConfig s3KeyPrefix(String s3KeyPrefix) {
  ...
  public boolean equals(Object o) {
    ...
    LivenessOutputConfig livenessOutputConfig = (LivenessOutputConfig) o;
    return Objects.equals(this.s3Bucket, livenessOutputConfig.s3Bucket) &&
        Objects.equals(this.s3KeyPrefix, livenessOutputConfig.s3KeyPrefix);
  }

  @Override
  public int hashCode() {
    return Objects.hash(s3Bucket, s3KeyPrefix);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LivenessOutputConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LivenessOutputConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LivenessOutputConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LivenessOutputConfig is not found in the empty JSON string", LivenessOutputConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LivenessOutputConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LivenessOutputConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LivenessOutputConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LivenessOutputConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LivenessOutputConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LivenessOutputConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LivenessOutputConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<LivenessOutputConfig>() {
           @Override
           public void write(JsonWriter out, LivenessOutputConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LivenessOutputConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LivenessOutputConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LivenessOutputConfig
   * @throws IOException if the JSON string is invalid with respect to LivenessOutputConfig
   */
  public static LivenessOutputConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LivenessOutputConfig.class);
  }

  /**
   * Convert an instance of LivenessOutputConfig to an JSON string
   *
   * @return JSON string
   */
