...
public class DistributeDataset {
  ...
  public DistributeDataset() {
  }

  public DistributeDataset arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DistributeDataset distributeDataset = (DistributeDataset) o;
    return Objects.equals(this.arn, distributeDataset.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DistributeDataset {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DistributeDataset
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DistributeDataset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DistributeDataset is not found in the empty JSON string", DistributeDataset.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DistributeDataset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DistributeDataset` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DistributeDataset.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DistributeDataset.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DistributeDataset' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DistributeDataset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DistributeDataset.class));

       return (TypeAdapter<T>) new TypeAdapter<DistributeDataset>() {
           @Override
           public void write(JsonWriter out, DistributeDataset value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DistributeDataset read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DistributeDataset given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DistributeDataset
   * @throws IOException if the JSON string is invalid with respect to DistributeDataset
   */
  public static DistributeDataset fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DistributeDataset.class);
  }

  /**
   * Convert an instance of DistributeDataset to an JSON string
   *
   * @return JSON string
   */
