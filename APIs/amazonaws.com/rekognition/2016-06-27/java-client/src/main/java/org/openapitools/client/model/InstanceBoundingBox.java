...
public class InstanceBoundingBox {
  ...
  public InstanceBoundingBox() {
  }

  public InstanceBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public InstanceBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public InstanceBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public InstanceBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InstanceBoundingBox instanceBoundingBox = (InstanceBoundingBox) o;
    return Objects.equals(this.width, instanceBoundingBox.width) &&
        Objects.equals(this.height, instanceBoundingBox.height) &&
        Objects.equals(this.left, instanceBoundingBox.left) &&
        Objects.equals(this.top, instanceBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceBoundingBox is not found in the empty JSON string", InstanceBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceBoundingBox>() {
           @Override
           public void write(JsonWriter out, InstanceBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceBoundingBox
   * @throws IOException if the JSON string is invalid with respect to InstanceBoundingBox
   */
  public static InstanceBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceBoundingBox.class);
  }

  /**
   * Convert an instance of InstanceBoundingBox to an JSON string
   *
   * @return JSON string
   */
