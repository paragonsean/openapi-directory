...
public class ConnectedHomeSettingsForUpdate {
  ...
  public ConnectedHomeSettingsForUpdate labels(List labels) {
    this.labels = labels;
    return this;
  }
  ...
  public ConnectedHomeSettingsForUpdate minConfidence(Float minConfidence) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectedHomeSettingsForUpdate connectedHomeSettingsForUpdate = (ConnectedHomeSettingsForUpdate) o;
    return Objects.equals(this.labels, connectedHomeSettingsForUpdate.labels) &&
        Objects.equals(this.minConfidence, connectedHomeSettingsForUpdate.minConfidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectedHomeSettingsForUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectedHomeSettingsForUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectedHomeSettingsForUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectedHomeSettingsForUpdate is not found in the empty JSON string", ConnectedHomeSettingsForUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectedHomeSettingsForUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectedHomeSettingsForUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectedHomeSettingsForUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectedHomeSettingsForUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectedHomeSettingsForUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectedHomeSettingsForUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectedHomeSettingsForUpdate>() {
           @Override
           public void write(JsonWriter out, ConnectedHomeSettingsForUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectedHomeSettingsForUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectedHomeSettingsForUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectedHomeSettingsForUpdate
   * @throws IOException if the JSON string is invalid with respect to ConnectedHomeSettingsForUpdate
   */
  public static ConnectedHomeSettingsForUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectedHomeSettingsForUpdate.class);
  }

  /**
   * Convert an instance of ConnectedHomeSettingsForUpdate to an JSON string
   *
   * @return JSON string
   */
