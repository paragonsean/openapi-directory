...
public class StartContentModerationRequestVideo {
  ...
  public StartContentModerationRequestVideo() {
  }

  public StartContentModerationRequestVideo s3Object(VideoS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    StartContentModerationRequestVideo startContentModerationRequestVideo = (StartContentModerationRequestVideo) o;
    return Objects.equals(this.s3Object, startContentModerationRequestVideo.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartContentModerationRequestVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartContentModerationRequestVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartContentModerationRequestVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartContentModerationRequestVideo is not found in the empty JSON string", StartContentModerationRequestVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartContentModerationRequestVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartContentModerationRequestVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartContentModerationRequestVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartContentModerationRequestVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartContentModerationRequestVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartContentModerationRequestVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<StartContentModerationRequestVideo>() {
           @Override
           public void write(JsonWriter out, StartContentModerationRequestVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartContentModerationRequestVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartContentModerationRequestVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartContentModerationRequestVideo
   * @throws IOException if the JSON string is invalid with respect to StartContentModerationRequestVideo
   */
  public static StartContentModerationRequestVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartContentModerationRequestVideo.class);
  }

  /**
   * Convert an instance of StartContentModerationRequestVideo to an JSON string
   *
   * @return JSON string
   */
