...
/**
 * DetectProtectiveEquipmentResponseSummary
 */
...
public class DetectProtectiveEquipmentResponseSummary {
  public static final String SERIALIZED_NAME_PERSONS_WITH_REQUIRED_EQUIPMENT = "PersonsWithRequiredEquipment";
  @SerializedName(SERIALIZED_NAME_PERSONS_WITH_REQUIRED_EQUIPMENT)
  private List personsWithRequiredEquipment;

  public static final String SERIALIZED_NAME_PERSONS_WITHOUT_REQUIRED_EQUIPMENT = "PersonsWithoutRequiredEquipment";
  @SerializedName(SERIALIZED_NAME_PERSONS_WITHOUT_REQUIRED_EQUIPMENT)
  private List personsWithoutRequiredEquipment;

  public static final String SERIALIZED_NAME_PERSONS_INDETERMINATE = "PersonsIndeterminate";
  @SerializedName(SERIALIZED_NAME_PERSONS_INDETERMINATE)
  private List personsIndeterminate;

  public DetectProtectiveEquipmentResponseSummary() {
  }

  public DetectProtectiveEquipmentResponseSummary personsWithRequiredEquipment(List personsWithRequiredEquipment) {
    this.personsWithRequiredEquipment = personsWithRequiredEquipment;
    return this;
  }

  /**
   * Get personsWithRequiredEquipment
   * @return personsWithRequiredEquipment
   */
  @javax.annotation.Nullable
  public List getPersonsWithRequiredEquipment() {
    return personsWithRequiredEquipment;
  }

  public void setPersonsWithRequiredEquipment(List personsWithRequiredEquipment) {
    this.personsWithRequiredEquipment = personsWithRequiredEquipment;
  }


  public DetectProtectiveEquipmentResponseSummary personsWithoutRequiredEquipment(List personsWithoutRequiredEquipment) {
    this.personsWithoutRequiredEquipment = personsWithoutRequiredEquipment;
    return this;
  }

  /**
   * Get personsWithoutRequiredEquipment
   * @return personsWithoutRequiredEquipment
   */
  @javax.annotation.Nullable
  public List getPersonsWithoutRequiredEquipment() {
    return personsWithoutRequiredEquipment;
  }

  public void setPersonsWithoutRequiredEquipment(List personsWithoutRequiredEquipment) {
    this.personsWithoutRequiredEquipment = personsWithoutRequiredEquipment;
  }


  public DetectProtectiveEquipmentResponseSummary personsIndeterminate(List personsIndeterminate) {
    this.personsIndeterminate = personsIndeterminate;
    return this;
  }

  /**
   * Get personsIndeterminate
   * @return personsIndeterminate
   */
  @javax.annotation.Nullable
  public List getPersonsIndeterminate() {
    return personsIndeterminate;
  }

  public void setPersonsIndeterminate(List personsIndeterminate) {
    this.personsIndeterminate = personsIndeterminate;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectProtectiveEquipmentResponseSummary detectProtectiveEquipmentResponseSummary = (DetectProtectiveEquipmentResponseSummary) o;
    return Objects.equals(this.personsWithRequiredEquipment, detectProtectiveEquipmentResponseSummary.personsWithRequiredEquipment) &&
        Objects.equals(this.personsWithoutRequiredEquipment, detectProtectiveEquipmentResponseSummary.personsWithoutRequiredEquipment) &&
        Objects.equals(this.personsIndeterminate, detectProtectiveEquipmentResponseSummary.personsIndeterminate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(personsWithRequiredEquipment, personsWithoutRequiredEquipment, personsIndeterminate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectProtectiveEquipmentResponseSummary {\n");
    sb.append("    personsWithRequiredEquipment: ").append(toIndentedString(personsWithRequiredEquipment)).append("\n");
    sb.append("    personsWithoutRequiredEquipment: ").append(toIndentedString(personsWithoutRequiredEquipment)).append("\n");
    sb.append("    personsIndeterminate: ").append(toIndentedString(personsIndeterminate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("PersonsWithRequiredEquipment");
    openapiFields.add("PersonsWithoutRequiredEquipment");
    openapiFields.add("PersonsIndeterminate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectProtectiveEquipmentResponseSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectProtectiveEquipmentResponseSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectProtectiveEquipmentResponseSummary is not found in the empty JSON string", DetectProtectiveEquipmentResponseSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectProtectiveEquipmentResponseSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectProtectiveEquipmentResponseSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `PersonsWithRequiredEquipment`
      if (jsonObj.get("PersonsWithRequiredEquipment") != null && !jsonObj.get("PersonsWithRequiredEquipment").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("PersonsWithRequiredEquipment"));
      }
      // validate the optional field `PersonsWithoutRequiredEquipment`
      if (jsonObj.get("PersonsWithoutRequiredEquipment") != null && !jsonObj.get("PersonsWithoutRequiredEquipment").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("PersonsWithoutRequiredEquipment"));
      }
      // validate the optional field `PersonsIndeterminate`
      if (jsonObj.get("PersonsIndeterminate") != null && !jsonObj.get("PersonsIndeterminate").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("PersonsIndeterminate"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectProtectiveEquipmentResponseSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectProtectiveEquipmentResponseSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectProtectiveEquipmentResponseSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectProtectiveEquipmentResponseSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectProtectiveEquipmentResponseSummary>() {
           @Override
           public void write(JsonWriter out, DetectProtectiveEquipmentResponseSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectProtectiveEquipmentResponseSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectProtectiveEquipmentResponseSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectProtectiveEquipmentResponseSummary
   * @throws IOException if the JSON string is invalid with respect to DetectProtectiveEquipmentResponseSummary
   */
  public static DetectProtectiveEquipmentResponseSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectProtectiveEquipmentResponseSummary.class);
  }

  /**
   * Convert an instance of DetectProtectiveEquipmentResponseSummary to an JSON string
   *
   * @return JSON string
   */
