...
public class StartProjectVersionRequest {
  ...
  public StartProjectVersionRequest() {
  }

  public StartProjectVersionRequest projectVersionArn(String projectVersionArn) {
  ...
  public StartProjectVersionRequest minInferenceUnits(Integer minInferenceUnits) {
  ...
  public StartProjectVersionRequest maxInferenceUnits(Integer maxInferenceUnits) {
  ...
  public boolean equals(Object o) {
    ...
    StartProjectVersionRequest startProjectVersionRequest = (StartProjectVersionRequest) o;
    return Objects.equals(this.projectVersionArn, startProjectVersionRequest.projectVersionArn) &&
        Objects.equals(this.minInferenceUnits, startProjectVersionRequest.minInferenceUnits) &&
        Objects.equals(this.maxInferenceUnits, startProjectVersionRequest.maxInferenceUnits);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectVersionArn, minInferenceUnits, maxInferenceUnits);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartProjectVersionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartProjectVersionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartProjectVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartProjectVersionRequest is not found in the empty JSON string", StartProjectVersionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartProjectVersionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartProjectVersionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartProjectVersionRequest.openapiRequiredFields) {
      ...
      // validate the required field `MinInferenceUnits`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartProjectVersionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartProjectVersionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartProjectVersionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartProjectVersionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartProjectVersionRequest>() {
           @Override
           public void write(JsonWriter out, StartProjectVersionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartProjectVersionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartProjectVersionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartProjectVersionRequest
   * @throws IOException if the JSON string is invalid with respect to StartProjectVersionRequest
   */
  public static StartProjectVersionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartProjectVersionRequest.class);
  }

  /**
   * Convert an instance of StartProjectVersionRequest to an JSON string
   *
   * @return JSON string
   */
