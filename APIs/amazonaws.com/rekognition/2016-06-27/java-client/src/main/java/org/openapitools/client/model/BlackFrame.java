...
public class BlackFrame {
  public static final String SERIALIZED_NAME_MAX_PIXEL_THRESHOLD = "MaxPixelThreshold";
  @SerializedName(SERIALIZED_NAME_MAX_PIXEL_THRESHOLD)
  private Float maxPixelThreshold;

  public static final String SERIALIZED_NAME_MIN_COVERAGE_PERCENTAGE = "MinCoveragePercentage";
  @SerializedName(SERIALIZED_NAME_MIN_COVERAGE_PERCENTAGE)
  private Float minCoveragePercentage;

  public BlackFrame() {
  }

  public BlackFrame maxPixelThreshold(Float maxPixelThreshold) {
  ...
  public BlackFrame minCoveragePercentage(Float minCoveragePercentage) {
  ...
  public boolean equals(Object o) {
    ...
    BlackFrame blackFrame = (BlackFrame) o;
    return Objects.equals(this.maxPixelThreshold, blackFrame.maxPixelThreshold) &&
        Objects.equals(this.minCoveragePercentage, blackFrame.minCoveragePercentage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxPixelThreshold, minCoveragePercentage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BlackFrame {\n");
    sb.append("    maxPixelThreshold: ").append(toIndentedString(maxPixelThreshold)).append("\n");
    sb.append("    minCoveragePercentage: ").append(toIndentedString(minCoveragePercentage)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("MaxPixelThreshold");
    openapiFields.add("MinCoveragePercentage");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BlackFrame
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlackFrame.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlackFrame is not found in the empty JSON string", BlackFrame.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlackFrame.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlackFrame` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `MaxPixelThreshold`
      if (jsonObj.get("MaxPixelThreshold") != null && !jsonObj.get("MaxPixelThreshold").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("MaxPixelThreshold"));
      }
      // validate the optional field `MinCoveragePercentage`
      if (jsonObj.get("MinCoveragePercentage") != null && !jsonObj.get("MinCoveragePercentage").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("MinCoveragePercentage"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlackFrame.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlackFrame' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlackFrame> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlackFrame.class));

       return (TypeAdapter<T>) new TypeAdapter<BlackFrame>() {
           @Override
           public void write(JsonWriter out, BlackFrame value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlackFrame read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BlackFrame given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BlackFrame
   * @throws IOException if the JSON string is invalid with respect to BlackFrame
   */
  public static BlackFrame fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlackFrame.class);
  }

  /**
   * Convert an instance of BlackFrame to an JSON string
   *
   * @return JSON string
   */
