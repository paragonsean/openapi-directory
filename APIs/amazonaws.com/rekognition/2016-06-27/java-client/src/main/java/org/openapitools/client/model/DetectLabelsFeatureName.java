...
/**
 * Gets or Sets DetectLabelsFeatureName
 */
@JsonAdapter(DetectLabelsFeatureName.Adapter.class)
public enum DetectLabelsFeatureName {
  ...
  DetectLabelsFeatureName(String value) {
    this.value = value;
  }
  ...
  public static DetectLabelsFeatureName fromValue(String value) {
    for (DetectLabelsFeatureName b : DetectLabelsFeatureName.values()) {
  ...
  public static class Adapter extends TypeAdapter<DetectLabelsFeatureName> {
    @Override
    public void write(final JsonWriter jsonWriter, final DetectLabelsFeatureName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DetectLabelsFeatureName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DetectLabelsFeatureName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DetectLabelsFeatureName.fromValue(value);
  }
}
