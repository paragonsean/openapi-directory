...
public class StreamProcessorNotificationChannel {
  ...
  public StreamProcessorNotificationChannel() {
  }

  public StreamProcessorNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorNotificationChannel streamProcessorNotificationChannel = (StreamProcessorNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, streamProcessorNotificationChannel.snSTopicArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(snSTopicArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamProcessorNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorNotificationChannel is not found in the empty JSON string", StreamProcessorNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StreamProcessorNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StreamProcessorNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorNotificationChannel
   */
  public static StreamProcessorNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorNotificationChannel.class);
  }

  /**
   * Convert an instance of StreamProcessorNotificationChannel to an JSON string
   *
   * @return JSON string
   */
