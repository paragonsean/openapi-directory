...
public class Smile {
  ...
  public Smile value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public Smile confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    Smile smile = (Smile) o;
    return Objects.equals(this.value, smile.value) &&
        Objects.equals(this.confidence, smile.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Smile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Smile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Smile is not found in the empty JSON string", Smile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Smile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Smile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Smile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Smile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Smile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Smile.class));

       return (TypeAdapter<T>) new TypeAdapter<Smile>() {
           @Override
           public void write(JsonWriter out, Smile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Smile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Smile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Smile
   * @throws IOException if the JSON string is invalid with respect to Smile
   */
  public static Smile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Smile.class);
  }

  /**
   * Convert an instance of Smile to an JSON string
   *
   * @return JSON string
   */
