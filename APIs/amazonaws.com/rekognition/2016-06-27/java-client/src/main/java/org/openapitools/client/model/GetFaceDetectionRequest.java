...
public class GetFaceDetectionRequest {
  ...
  public GetFaceDetectionRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetFaceDetectionRequest maxResults(Integer maxResults) {
  ...
  public GetFaceDetectionRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetFaceDetectionRequest getFaceDetectionRequest = (GetFaceDetectionRequest) o;
    return Objects.equals(this.jobId, getFaceDetectionRequest.jobId) &&
        Objects.equals(this.maxResults, getFaceDetectionRequest.maxResults) &&
        Objects.equals(this.nextToken, getFaceDetectionRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFaceDetectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFaceDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFaceDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFaceDetectionRequest is not found in the empty JSON string", GetFaceDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFaceDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFaceDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFaceDetectionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFaceDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFaceDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFaceDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFaceDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFaceDetectionRequest>() {
           @Override
           public void write(JsonWriter out, GetFaceDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFaceDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFaceDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFaceDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to GetFaceDetectionRequest
   */
  public static GetFaceDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFaceDetectionRequest.class);
  }

  /**
   * Convert an instance of GetFaceDetectionRequest to an JSON string
   *
   * @return JSON string
   */
