...
public class GetContentModerationRequestMetadata {
  ...
  public GetContentModerationRequestMetadata() {
  }

  public GetContentModerationRequestMetadata sortBy(ContentModerationSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public GetContentModerationRequestMetadata aggregateBy(ContentModerationAggregateBy aggregateBy) {
  ...
  public boolean equals(Object o) {
    ...
    GetContentModerationRequestMetadata getContentModerationRequestMetadata = (GetContentModerationRequestMetadata) o;
    return Objects.equals(this.sortBy, getContentModerationRequestMetadata.sortBy) &&
        Objects.equals(this.aggregateBy, getContentModerationRequestMetadata.aggregateBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetContentModerationRequestMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetContentModerationRequestMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetContentModerationRequestMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetContentModerationRequestMetadata is not found in the empty JSON string", GetContentModerationRequestMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetContentModerationRequestMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetContentModerationRequestMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetContentModerationRequestMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetContentModerationRequestMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetContentModerationRequestMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetContentModerationRequestMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetContentModerationRequestMetadata>() {
           @Override
           public void write(JsonWriter out, GetContentModerationRequestMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetContentModerationRequestMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetContentModerationRequestMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetContentModerationRequestMetadata
   * @throws IOException if the JSON string is invalid with respect to GetContentModerationRequestMetadata
   */
  public static GetContentModerationRequestMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetContentModerationRequestMetadata.class);
  }

  /**
   * Convert an instance of GetContentModerationRequestMetadata to an JSON string
   *
   * @return JSON string
   */
