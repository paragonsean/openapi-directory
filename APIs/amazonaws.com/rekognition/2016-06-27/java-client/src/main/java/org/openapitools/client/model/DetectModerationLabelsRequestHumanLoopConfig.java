...
/**
 * DetectModerationLabelsRequestHumanLoopConfig
 */
...
public class DetectModerationLabelsRequestHumanLoopConfig {
  ...
  public DetectModerationLabelsRequestHumanLoopConfig() {
  }

  public DetectModerationLabelsRequestHumanLoopConfig humanLoopName(String humanLoopName) {
  ...
  public DetectModerationLabelsRequestHumanLoopConfig flowDefinitionArn(String flowDefinitionArn) {
  ...
  public DetectModerationLabelsRequestHumanLoopConfig dataAttributes(HumanLoopConfigDataAttributes dataAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    DetectModerationLabelsRequestHumanLoopConfig detectModerationLabelsRequestHumanLoopConfig = (DetectModerationLabelsRequestHumanLoopConfig) o;
    return Objects.equals(this.humanLoopName, detectModerationLabelsRequestHumanLoopConfig.humanLoopName) &&
        Objects.equals(this.flowDefinitionArn, detectModerationLabelsRequestHumanLoopConfig.flowDefinitionArn) &&
        Objects.equals(this.dataAttributes, detectModerationLabelsRequestHumanLoopConfig.dataAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectModerationLabelsRequestHumanLoopConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectModerationLabelsRequestHumanLoopConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectModerationLabelsRequestHumanLoopConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectModerationLabelsRequestHumanLoopConfig is not found in the empty JSON string", DetectModerationLabelsRequestHumanLoopConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectModerationLabelsRequestHumanLoopConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectModerationLabelsRequestHumanLoopConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectModerationLabelsRequestHumanLoopConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectModerationLabelsRequestHumanLoopConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectModerationLabelsRequestHumanLoopConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectModerationLabelsRequestHumanLoopConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectModerationLabelsRequestHumanLoopConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectModerationLabelsRequestHumanLoopConfig>() {
           @Override
           public void write(JsonWriter out, DetectModerationLabelsRequestHumanLoopConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectModerationLabelsRequestHumanLoopConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectModerationLabelsRequestHumanLoopConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectModerationLabelsRequestHumanLoopConfig
   * @throws IOException if the JSON string is invalid with respect to DetectModerationLabelsRequestHumanLoopConfig
   */
  public static DetectModerationLabelsRequestHumanLoopConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectModerationLabelsRequestHumanLoopConfig.class);
  }

  /**
   * Convert an instance of DetectModerationLabelsRequestHumanLoopConfig to an JSON string
   *
   * @return JSON string
   */
