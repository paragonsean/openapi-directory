...
import org.openapitools.client.model.StreamProcessingStartSelectorKVSStreamStartSelector;
...
public class StreamProcessingStartSelector {
  public static final String SERIALIZED_NAME_KV_S_STREAM_START_SELECTOR = "KVSStreamStartSelector";
  @SerializedName(SERIALIZED_NAME_KV_S_STREAM_START_SELECTOR)
  private StreamProcessingStartSelectorKVSStreamStartSelector kvSStreamStartSelector;

  public StreamProcessingStartSelector() {
  }

  public StreamProcessingStartSelector kvSStreamStartSelector(StreamProcessingStartSelectorKVSStreamStartSelector kvSStreamStartSelector) {
    this.kvSStreamStartSelector = kvSStreamStartSelector;
    return this;
  }

  /**
   * Get kvSStreamStartSelector
   * @return kvSStreamStartSelector
   */
  @javax.annotation.Nullable
  public StreamProcessingStartSelectorKVSStreamStartSelector getKvSStreamStartSelector() {
    return kvSStreamStartSelector;
  }

  public void setKvSStreamStartSelector(StreamProcessingStartSelectorKVSStreamStartSelector kvSStreamStartSelector) {
    this.kvSStreamStartSelector = kvSStreamStartSelector;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessingStartSelector streamProcessingStartSelector = (StreamProcessingStartSelector) o;
    return Objects.equals(this.kvSStreamStartSelector, streamProcessingStartSelector.kvSStreamStartSelector);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kvSStreamStartSelector);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamProcessingStartSelector {\n");
    sb.append("    kvSStreamStartSelector: ").append(toIndentedString(kvSStreamStartSelector)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("KVSStreamStartSelector");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessingStartSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessingStartSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessingStartSelector is not found in the empty JSON string", StreamProcessingStartSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessingStartSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessingStartSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `KVSStreamStartSelector`
      if (jsonObj.get("KVSStreamStartSelector") != null && !jsonObj.get("KVSStreamStartSelector").isJsonNull()) {
        StreamProcessingStartSelectorKVSStreamStartSelector.validateJsonElement(jsonObj.get("KVSStreamStartSelector"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessingStartSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessingStartSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessingStartSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessingStartSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessingStartSelector>() {
           @Override
           public void write(JsonWriter out, StreamProcessingStartSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessingStartSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessingStartSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessingStartSelector
   * @throws IOException if the JSON string is invalid with respect to StreamProcessingStartSelector
   */
  public static StreamProcessingStartSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessingStartSelector.class);
  }

  /**
   * Convert an instance of StreamProcessingStartSelector to an JSON string
   *
   * @return JSON string
   */
