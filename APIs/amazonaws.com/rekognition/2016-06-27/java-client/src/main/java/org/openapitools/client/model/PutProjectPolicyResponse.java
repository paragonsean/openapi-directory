...
public class PutProjectPolicyResponse {
  ...
  public PutProjectPolicyResponse policyRevisionId(String policyRevisionId) {
  ...
  public boolean equals(Object o) {
    ...
    PutProjectPolicyResponse putProjectPolicyResponse = (PutProjectPolicyResponse) o;
    return Objects.equals(this.policyRevisionId, putProjectPolicyResponse.policyRevisionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyRevisionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutProjectPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutProjectPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutProjectPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutProjectPolicyResponse is not found in the empty JSON string", PutProjectPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutProjectPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutProjectPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutProjectPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutProjectPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutProjectPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutProjectPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PutProjectPolicyResponse>() {
           @Override
           public void write(JsonWriter out, PutProjectPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutProjectPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutProjectPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutProjectPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to PutProjectPolicyResponse
   */
  public static PutProjectPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutProjectPolicyResponse.class);
  }

  /**
   * Convert an instance of PutProjectPolicyResponse to an JSON string
   *
   * @return JSON string
   */
