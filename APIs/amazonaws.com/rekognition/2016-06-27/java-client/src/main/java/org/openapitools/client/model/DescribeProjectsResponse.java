...
public class DescribeProjectsResponse {
  public static final String SERIALIZED_NAME_PROJECT_DESCRIPTIONS = "ProjectDescriptions";
  @SerializedName(SERIALIZED_NAME_PROJECT_DESCRIPTIONS)
  private List projectDescriptions;
  ...
  public DescribeProjectsResponse projectDescriptions(List projectDescriptions) {
  ...
  public void setProjectDescriptions(List projectDescriptions) {
    this.projectDescriptions = projectDescriptions;
  }


  public DescribeProjectsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeProjectsResponse describeProjectsResponse = (DescribeProjectsResponse) o;
    return Objects.equals(this.projectDescriptions, describeProjectsResponse.projectDescriptions) &&
        Objects.equals(this.nextToken, describeProjectsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectDescriptions, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeProjectsResponse {\n");
    sb.append("    projectDescriptions: ").append(toIndentedString(projectDescriptions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ProjectDescriptions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeProjectsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeProjectsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeProjectsResponse is not found in the empty JSON string", DescribeProjectsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeProjectsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeProjectsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ProjectDescriptions`
      if (jsonObj.get("ProjectDescriptions") != null && !jsonObj.get("ProjectDescriptions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ProjectDescriptions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeProjectsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeProjectsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeProjectsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeProjectsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeProjectsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeProjectsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeProjectsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeProjectsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeProjectsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeProjectsResponse
   */
  public static DescribeProjectsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeProjectsResponse.class);
  }

  /**
   * Convert an instance of DescribeProjectsResponse to an JSON string
   *
   * @return JSON string
   */
