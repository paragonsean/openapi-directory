...
public class SearchUsersByImageRequest {
  ...
  public SearchUsersByImageRequest() {
  }

  public SearchUsersByImageRequest collectionId(String collectionId) {
  ...
  public SearchUsersByImageRequest image(Image image) {
    this.image = image;
    return this;
  }
  ...
  public SearchUsersByImageRequest userMatchThreshold(Float userMatchThreshold) {
  ...
  public SearchUsersByImageRequest maxUsers(Integer maxUsers) {
  ...
  public SearchUsersByImageRequest qualityFilter(QualityFilter qualityFilter) {
  ...
  public boolean equals(Object o) {
    ...
    SearchUsersByImageRequest searchUsersByImageRequest = (SearchUsersByImageRequest) o;
    return Objects.equals(this.collectionId, searchUsersByImageRequest.collectionId) &&
        Objects.equals(this.image, searchUsersByImageRequest.image) &&
        Objects.equals(this.userMatchThreshold, searchUsersByImageRequest.userMatchThreshold) &&
        Objects.equals(this.maxUsers, searchUsersByImageRequest.maxUsers) &&
        Objects.equals(this.qualityFilter, searchUsersByImageRequest.qualityFilter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, image, userMatchThreshold, maxUsers, qualityFilter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchUsersByImageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchUsersByImageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchUsersByImageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchUsersByImageRequest is not found in the empty JSON string", SearchUsersByImageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchUsersByImageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchUsersByImageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchUsersByImageRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("MaxUsers") != null && !jsonObj.get("MaxUsers").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("MaxUsers"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchUsersByImageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchUsersByImageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchUsersByImageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchUsersByImageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchUsersByImageRequest>() {
           @Override
           public void write(JsonWriter out, SearchUsersByImageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchUsersByImageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchUsersByImageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchUsersByImageRequest
   * @throws IOException if the JSON string is invalid with respect to SearchUsersByImageRequest
   */
  public static SearchUsersByImageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchUsersByImageRequest.class);
  }

  /**
   * Convert an instance of SearchUsersByImageRequest to an JSON string
   *
   * @return JSON string
   */
