...
public class AssociateFacesRequest {
  ...
  public static final String SERIALIZED_NAME_USER_MATCH_THRESHOLD = "UserMatchThreshold";
  @SerializedName(SERIALIZED_NAME_USER_MATCH_THRESHOLD)
  ...
  public AssociateFacesRequest() {
  }

  public AssociateFacesRequest collectionId(String collectionId) {
  ...
  public AssociateFacesRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public AssociateFacesRequest faceIds(List faceIds) {
   ...
   */
  @javax.annotation.Nonnull
  public List getFaceIds() {
    return faceIds;
  }

  public void setFaceIds(List faceIds) {
    this.faceIds = faceIds;
  }


  public AssociateFacesRequest userMatchThreshold(Float userMatchThreshold) {
    this.userMatchThreshold = userMatchThreshold;
    return this;
  }

  /**
   * Get userMatchThreshold
  ...
  public AssociateFacesRequest clientRequestToken(String clientRequestToken) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateFacesRequest associateFacesRequest = (AssociateFacesRequest) o;
    return Objects.equals(this.collectionId, associateFacesRequest.collectionId) &&
        Objects.equals(this.userId, associateFacesRequest.userId) &&
        Objects.equals(this.faceIds, associateFacesRequest.faceIds) &&
        Objects.equals(this.userMatchThreshold, associateFacesRequest.userMatchThreshold) &&
        Objects.equals(this.clientRequestToken, associateFacesRequest.clientRequestToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, userId, faceIds, userMatchThreshold, clientRequestToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateFacesRequest {\n");
    sb.append("    collectionId: ").append(toIndentedString(collectionId)).append("\n");
    sb.append("    userId: ").append(toIndentedString(userId)).append("\n");
    sb.append("    faceIds: ").append(toIndentedString(faceIds)).append("\n");
    sb.append("    userMatchThreshold: ").append(toIndentedString(userMatchThreshold)).append("\n");
  ...
  static {
    ...
    openapiFields.add("UserMatchThreshold");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateFacesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateFacesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateFacesRequest is not found in the empty JSON string", AssociateFacesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateFacesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateFacesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateFacesRequest.openapiRequiredFields) {
      ...
      // validate the required field `FaceIds`
      List.validateJsonElement(jsonObj.get("FaceIds"));
      // validate the optional field `UserMatchThreshold`
      if (jsonObj.get("UserMatchThreshold") != null && !jsonObj.get("UserMatchThreshold").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("UserMatchThreshold"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateFacesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateFacesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateFacesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateFacesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateFacesRequest>() {
           @Override
           public void write(JsonWriter out, AssociateFacesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateFacesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateFacesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateFacesRequest
   * @throws IOException if the JSON string is invalid with respect to AssociateFacesRequest
   */
  public static AssociateFacesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateFacesRequest.class);
  }

  /**
   * Convert an instance of AssociateFacesRequest to an JSON string
   *
   * @return JSON string
   */
