...
public class UnsearchedFace {
  ...
  public UnsearchedFace() {
  }

  public UnsearchedFace faceDetails(FaceDetail faceDetails) {
  ...
  public UnsearchedFace reasons(List reasons) {
  ...
  public boolean equals(Object o) {
    ...
    UnsearchedFace unsearchedFace = (UnsearchedFace) o;
    return Objects.equals(this.faceDetails, unsearchedFace.faceDetails) &&
        Objects.equals(this.reasons, unsearchedFace.reasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceDetails, reasons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnsearchedFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnsearchedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnsearchedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnsearchedFace is not found in the empty JSON string", UnsearchedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnsearchedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnsearchedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `FaceDetails`
      if (jsonObj.get("FaceDetails") != null && !jsonObj.get("FaceDetails").isJsonNull()) {
        FaceDetail.validateJsonElement(jsonObj.get("FaceDetails"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnsearchedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnsearchedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnsearchedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnsearchedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<UnsearchedFace>() {
           @Override
           public void write(JsonWriter out, UnsearchedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnsearchedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnsearchedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnsearchedFace
   * @throws IOException if the JSON string is invalid with respect to UnsearchedFace
   */
  public static UnsearchedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnsearchedFace.class);
  }

  /**
   * Convert an instance of UnsearchedFace to an JSON string
   *
   * @return JSON string
   */
