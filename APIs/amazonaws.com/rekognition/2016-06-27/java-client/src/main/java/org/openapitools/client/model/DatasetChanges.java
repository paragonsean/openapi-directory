...
public class DatasetChanges {
  ...
  public DatasetChanges groundTruth(String groundTruth) {
  ...
  public boolean equals(Object o) {
    ...
    DatasetChanges datasetChanges = (DatasetChanges) o;
    return Objects.equals(this.groundTruth, datasetChanges.groundTruth);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatasetChanges {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetChanges
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetChanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetChanges is not found in the empty JSON string", DatasetChanges.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetChanges.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetChanges` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatasetChanges.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetChanges.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetChanges' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetChanges> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetChanges.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetChanges>() {
           @Override
           public void write(JsonWriter out, DatasetChanges value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetChanges read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetChanges given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetChanges
   * @throws IOException if the JSON string is invalid with respect to DatasetChanges
   */
  public static DatasetChanges fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetChanges.class);
  }

  /**
   * Convert an instance of DatasetChanges to an JSON string
   *
   * @return JSON string
   */
