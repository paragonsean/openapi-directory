...
public class DetectionFilter {
  ...
  public DetectionFilter minConfidence(Float minConfidence) {
  ...
  public DetectionFilter minBoundingBoxHeight(Float minBoundingBoxHeight) {
  ...
  public DetectionFilter minBoundingBoxWidth(Float minBoundingBoxWidth) {
  ...
  public boolean equals(Object o) {
    ...
    DetectionFilter detectionFilter = (DetectionFilter) o;
    return Objects.equals(this.minConfidence, detectionFilter.minConfidence) &&
        Objects.equals(this.minBoundingBoxHeight, detectionFilter.minBoundingBoxHeight) &&
        Objects.equals(this.minBoundingBoxWidth, detectionFilter.minBoundingBoxWidth);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectionFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectionFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectionFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectionFilter is not found in the empty JSON string", DetectionFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectionFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectionFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectionFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectionFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectionFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectionFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectionFilter>() {
           @Override
           public void write(JsonWriter out, DetectionFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectionFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectionFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectionFilter
   * @throws IOException if the JSON string is invalid with respect to DetectionFilter
   */
  public static DetectionFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectionFilter.class);
  }

  /**
   * Convert an instance of DetectionFilter to an JSON string
   *
   * @return JSON string
   */
