...
/**
 * CompareFacesResponseSourceImageFace
 */
...
public class CompareFacesResponseSourceImageFace {
  ...
  public CompareFacesResponseSourceImageFace() {
  }

  public CompareFacesResponseSourceImageFace boundingBox(ComparedFaceBoundingBox boundingBox) {
  ...
  public CompareFacesResponseSourceImageFace confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    CompareFacesResponseSourceImageFace compareFacesResponseSourceImageFace = (CompareFacesResponseSourceImageFace) o;
    return Objects.equals(this.boundingBox, compareFacesResponseSourceImageFace.boundingBox) &&
        Objects.equals(this.confidence, compareFacesResponseSourceImageFace.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompareFacesResponseSourceImageFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompareFacesResponseSourceImageFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompareFacesResponseSourceImageFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompareFacesResponseSourceImageFace is not found in the empty JSON string", CompareFacesResponseSourceImageFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompareFacesResponseSourceImageFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompareFacesResponseSourceImageFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompareFacesResponseSourceImageFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompareFacesResponseSourceImageFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompareFacesResponseSourceImageFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompareFacesResponseSourceImageFace.class));

       return (TypeAdapter<T>) new TypeAdapter<CompareFacesResponseSourceImageFace>() {
           @Override
           public void write(JsonWriter out, CompareFacesResponseSourceImageFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompareFacesResponseSourceImageFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompareFacesResponseSourceImageFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompareFacesResponseSourceImageFace
   * @throws IOException if the JSON string is invalid with respect to CompareFacesResponseSourceImageFace
   */
  public static CompareFacesResponseSourceImageFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompareFacesResponseSourceImageFace.class);
  }

  /**
   * Convert an instance of CompareFacesResponseSourceImageFace to an JSON string
   *
   * @return JSON string
   */
