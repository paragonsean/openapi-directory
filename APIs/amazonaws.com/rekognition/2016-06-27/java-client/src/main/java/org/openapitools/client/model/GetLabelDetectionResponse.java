...
import org.openapitools.client.model.GetLabelDetectionResponseGetRequestMetadata;
...
public class GetLabelDetectionResponse {
  ...
  public static final String SERIALIZED_NAME_LABEL_MODEL_VERSION = "LabelModelVersion";
  @SerializedName(SERIALIZED_NAME_LABEL_MODEL_VERSION)
  ...
  private GetLabelDetectionResponseGetRequestMetadata getRequestMetadata;

  public GetLabelDetectionResponse() {
  }

  public GetLabelDetectionResponse jobStatus(VideoJobStatus jobStatus) {
  ...
  public GetLabelDetectionResponse statusMessage(String statusMessage) {
  ...
  public GetLabelDetectionResponse videoMetadata(GetFaceDetectionResponseVideoMetadata videoMetadata) {
  ...
  public GetLabelDetectionResponse nextToken(String nextToken) {
  ...
  public GetLabelDetectionResponse labels(List labels) {
    this.labels = labels;
    return this;
  }
  ...
  public GetLabelDetectionResponse labelModelVersion(String labelModelVersion) {
    this.labelModelVersion = labelModelVersion;
    return this;
  }

  /**
   * Get labelModelVersion
  ...
  public GetLabelDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetLabelDetectionResponse video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public GetLabelDetectionResponse jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public GetLabelDetectionResponse getRequestMetadata(GetLabelDetectionResponseGetRequestMetadata getRequestMetadata) {
   ...
   */
  @javax.annotation.Nullable
  public GetLabelDetectionResponseGetRequestMetadata getGetRequestMetadata() {
    return getRequestMetadata;
  }

  public void setGetRequestMetadata(GetLabelDetectionResponseGetRequestMetadata getRequestMetadata) {
    this.getRequestMetadata = getRequestMetadata;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLabelDetectionResponse getLabelDetectionResponse = (GetLabelDetectionResponse) o;
    return Objects.equals(this.jobStatus, getLabelDetectionResponse.jobStatus) &&
        Objects.equals(this.statusMessage, getLabelDetectionResponse.statusMessage) &&
        Objects.equals(this.videoMetadata, getLabelDetectionResponse.videoMetadata) &&
        Objects.equals(this.nextToken, getLabelDetectionResponse.nextToken) &&
        Objects.equals(this.labels, getLabelDetectionResponse.labels) &&
        Objects.equals(this.labelModelVersion, getLabelDetectionResponse.labelModelVersion) &&
        Objects.equals(this.jobId, getLabelDetectionResponse.jobId) &&
        Objects.equals(this.video, getLabelDetectionResponse.video) &&
        Objects.equals(this.jobTag, getLabelDetectionResponse.jobTag) &&
        Objects.equals(this.getRequestMetadata, getLabelDetectionResponse.getRequestMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobStatus, statusMessage, videoMetadata, nextToken, labels, labelModelVersion, jobId, video, jobTag, getRequestMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLabelDetectionResponse {\n");
    sb.append("    jobStatus: ").append(toIndentedString(jobStatus)).append("\n");
    sb.append("    statusMessage: ").append(toIndentedString(statusMessage)).append("\n");
    sb.append("    videoMetadata: ").append(toIndentedString(videoMetadata)).append("\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    labels: ").append(toIndentedString(labels)).append("\n");
    sb.append("    labelModelVersion: ").append(toIndentedString(labelModelVersion)).append("\n");
  ...
  static {
    ...
    openapiFields.add("LabelModelVersion");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLabelDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLabelDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLabelDetectionResponse is not found in the empty JSON string", GetLabelDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLabelDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLabelDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `LabelModelVersion`
      if (jsonObj.get("LabelModelVersion") != null && !jsonObj.get("LabelModelVersion").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("LabelModelVersion"));
      }
      ...
      if (jsonObj.get("GetRequestMetadata") != null && !jsonObj.get("GetRequestMetadata").isJsonNull()) {
        GetLabelDetectionResponseGetRequestMetadata.validateJsonElement(jsonObj.get("GetRequestMetadata"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLabelDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLabelDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLabelDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLabelDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLabelDetectionResponse>() {
           @Override
           public void write(JsonWriter out, GetLabelDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLabelDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLabelDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLabelDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to GetLabelDetectionResponse
   */
  public static GetLabelDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLabelDetectionResponse.class);
  }

  /**
   * Convert an instance of GetLabelDetectionResponse to an JSON string
   *
   * @return JSON string
   */
