...
/**
 * Gets or Sets UnsuccessfulFaceAssociationReason
 */
@JsonAdapter(UnsuccessfulFaceAssociationReason.Adapter.class)
public enum UnsuccessfulFaceAssociationReason {
  ...
  UnsuccessfulFaceAssociationReason(String value) {
    this.value = value;
  }
  ...
  public static UnsuccessfulFaceAssociationReason fromValue(String value) {
    for (UnsuccessfulFaceAssociationReason b : UnsuccessfulFaceAssociationReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnsuccessfulFaceAssociationReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnsuccessfulFaceAssociationReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UnsuccessfulFaceAssociationReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UnsuccessfulFaceAssociationReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UnsuccessfulFaceAssociationReason.fromValue(value);
  }
}
