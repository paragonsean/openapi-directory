...
public class StreamProcessorInputKinesisVideoStream {
  public static final String SERIALIZED_NAME_ARN = "Arn";
  @SerializedName(SERIALIZED_NAME_ARN)
  private String arn;

  public StreamProcessorInputKinesisVideoStream() {
  }

  public StreamProcessorInputKinesisVideoStream arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorInputKinesisVideoStream streamProcessorInputKinesisVideoStream = (StreamProcessorInputKinesisVideoStream) o;
    return Objects.equals(this.arn, streamProcessorInputKinesisVideoStream.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessorInputKinesisVideoStream {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorInputKinesisVideoStream
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorInputKinesisVideoStream.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorInputKinesisVideoStream is not found in the empty JSON string", StreamProcessorInputKinesisVideoStream.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorInputKinesisVideoStream.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorInputKinesisVideoStream` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorInputKinesisVideoStream.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorInputKinesisVideoStream' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorInputKinesisVideoStream> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorInputKinesisVideoStream.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorInputKinesisVideoStream>() {
           @Override
           public void write(JsonWriter out, StreamProcessorInputKinesisVideoStream value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorInputKinesisVideoStream read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorInputKinesisVideoStream given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorInputKinesisVideoStream
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorInputKinesisVideoStream
   */
  public static StreamProcessorInputKinesisVideoStream fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorInputKinesisVideoStream.class);
  }

  /**
   * Convert an instance of StreamProcessorInputKinesisVideoStream to an JSON string
   *
   * @return JSON string
   */
