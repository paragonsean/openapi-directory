...
public class StartPersonTrackingRequestNotificationChannel {
  ...
  public StartPersonTrackingRequestNotificationChannel() {
  }

  public StartPersonTrackingRequestNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public StartPersonTrackingRequestNotificationChannel roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartPersonTrackingRequestNotificationChannel startPersonTrackingRequestNotificationChannel = (StartPersonTrackingRequestNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, startPersonTrackingRequestNotificationChannel.snSTopicArn) &&
        Objects.equals(this.roleArn, startPersonTrackingRequestNotificationChannel.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartPersonTrackingRequestNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartPersonTrackingRequestNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartPersonTrackingRequestNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartPersonTrackingRequestNotificationChannel is not found in the empty JSON string", StartPersonTrackingRequestNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartPersonTrackingRequestNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartPersonTrackingRequestNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartPersonTrackingRequestNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartPersonTrackingRequestNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartPersonTrackingRequestNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartPersonTrackingRequestNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartPersonTrackingRequestNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StartPersonTrackingRequestNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StartPersonTrackingRequestNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartPersonTrackingRequestNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartPersonTrackingRequestNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartPersonTrackingRequestNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StartPersonTrackingRequestNotificationChannel
   */
  public static StartPersonTrackingRequestNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartPersonTrackingRequestNotificationChannel.class);
  }

  /**
   * Convert an instance of StartPersonTrackingRequestNotificationChannel to an JSON string
   *
   * @return JSON string
   */
