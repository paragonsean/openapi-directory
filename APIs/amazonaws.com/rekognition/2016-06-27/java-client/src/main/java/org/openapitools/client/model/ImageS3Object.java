...
public class ImageS3Object {
  ...
  public ImageS3Object() {
  }

  public ImageS3Object bucket(String bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public ImageS3Object name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImageS3Object version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    ImageS3Object imageS3Object = (ImageS3Object) o;
    return Objects.equals(this.bucket, imageS3Object.bucket) &&
        Objects.equals(this.name, imageS3Object.name) &&
        Objects.equals(this.version, imageS3Object.version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImageS3Object
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImageS3Object.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageS3Object is not found in the empty JSON string", ImageS3Object.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImageS3Object.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImageS3Object` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageS3Object.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageS3Object' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageS3Object> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageS3Object.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageS3Object>() {
           @Override
           public void write(JsonWriter out, ImageS3Object value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImageS3Object read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImageS3Object given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImageS3Object
   * @throws IOException if the JSON string is invalid with respect to ImageS3Object
   */
  public static ImageS3Object fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageS3Object.class);
  }

  /**
   * Convert an instance of ImageS3Object to an JSON string
   *
   * @return JSON string
   */
