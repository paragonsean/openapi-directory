...
public class DetectLabelsImageForegroundQuality {
  ...
  public DetectLabelsImageForegroundQuality() {
  }

  public DetectLabelsImageForegroundQuality brightness(Float brightness) {
  ...
  public DetectLabelsImageForegroundQuality sharpness(Float sharpness) {
  ...
  public DetectLabelsImageForegroundQuality contrast(Float contrast) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImageForegroundQuality detectLabelsImageForegroundQuality = (DetectLabelsImageForegroundQuality) o;
    return Objects.equals(this.brightness, detectLabelsImageForegroundQuality.brightness) &&
        Objects.equals(this.sharpness, detectLabelsImageForegroundQuality.sharpness) &&
        Objects.equals(this.contrast, detectLabelsImageForegroundQuality.contrast);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsImageForegroundQuality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImageForegroundQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImageForegroundQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImageForegroundQuality is not found in the empty JSON string", DetectLabelsImageForegroundQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImageForegroundQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImageForegroundQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImageForegroundQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImageForegroundQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImageForegroundQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImageForegroundQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImageForegroundQuality>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImageForegroundQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImageForegroundQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImageForegroundQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImageForegroundQuality
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImageForegroundQuality
   */
  public static DetectLabelsImageForegroundQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImageForegroundQuality.class);
  }

  /**
   * Convert an instance of DetectLabelsImageForegroundQuality to an JSON string
   *
   * @return JSON string
   */
