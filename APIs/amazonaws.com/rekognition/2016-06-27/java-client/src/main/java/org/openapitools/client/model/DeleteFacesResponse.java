...
public class DeleteFacesResponse {
  public static final String SERIALIZED_NAME_DELETED_FACES = "DeletedFaces";
  @SerializedName(SERIALIZED_NAME_DELETED_FACES)
  private List deletedFaces;

  public static final String SERIALIZED_NAME_UNSUCCESSFUL_FACE_DELETIONS = "UnsuccessfulFaceDeletions";
  @SerializedName(SERIALIZED_NAME_UNSUCCESSFUL_FACE_DELETIONS)
  private List unsuccessfulFaceDeletions;

  public DeleteFacesResponse() {
  }

  public DeleteFacesResponse deletedFaces(List deletedFaces) {
  ...
  public List getDeletedFaces() {
    return deletedFaces;
  }

  public void setDeletedFaces(List deletedFaces) {
    this.deletedFaces = deletedFaces;
  }


  public DeleteFacesResponse unsuccessfulFaceDeletions(List unsuccessfulFaceDeletions) {
    this.unsuccessfulFaceDeletions = unsuccessfulFaceDeletions;
    return this;
  }

  /**
   * Get unsuccessfulFaceDeletions
   * @return unsuccessfulFaceDeletions
   */
  @javax.annotation.Nullable
  public List getUnsuccessfulFaceDeletions() {
    return unsuccessfulFaceDeletions;
  }

  public void setUnsuccessfulFaceDeletions(List unsuccessfulFaceDeletions) {
    this.unsuccessfulFaceDeletions = unsuccessfulFaceDeletions;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteFacesResponse deleteFacesResponse = (DeleteFacesResponse) o;
    return Objects.equals(this.deletedFaces, deleteFacesResponse.deletedFaces) &&
        Objects.equals(this.unsuccessfulFaceDeletions, deleteFacesResponse.unsuccessfulFaceDeletions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deletedFaces, unsuccessfulFaceDeletions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteFacesResponse {\n");
    sb.append("    deletedFaces: ").append(toIndentedString(deletedFaces)).append("\n");
    sb.append("    unsuccessfulFaceDeletions: ").append(toIndentedString(unsuccessfulFaceDeletions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DeletedFaces");
    openapiFields.add("UnsuccessfulFaceDeletions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFacesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFacesResponse is not found in the empty JSON string", DeleteFacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DeletedFaces`
      if (jsonObj.get("DeletedFaces") != null && !jsonObj.get("DeletedFaces").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DeletedFaces"));
      }
      // validate the optional field `UnsuccessfulFaceDeletions`
      if (jsonObj.get("UnsuccessfulFaceDeletions") != null && !jsonObj.get("UnsuccessfulFaceDeletions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("UnsuccessfulFaceDeletions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFacesResponse>() {
           @Override
           public void write(JsonWriter out, DeleteFacesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFacesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFacesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFacesResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteFacesResponse
   */
  public static DeleteFacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFacesResponse.class);
  }

  /**
   * Convert an instance of DeleteFacesResponse to an JSON string
   *
   * @return JSON string
   */
