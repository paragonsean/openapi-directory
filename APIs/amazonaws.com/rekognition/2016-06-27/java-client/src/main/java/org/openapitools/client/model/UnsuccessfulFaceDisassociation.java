...
public class UnsuccessfulFaceDisassociation {
  ...
  public UnsuccessfulFaceDisassociation() {
  }

  public UnsuccessfulFaceDisassociation faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public UnsuccessfulFaceDisassociation userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UnsuccessfulFaceDisassociation reasons(List reasons) {
  ...
  public boolean equals(Object o) {
    ...
    UnsuccessfulFaceDisassociation unsuccessfulFaceDisassociation = (UnsuccessfulFaceDisassociation) o;
    return Objects.equals(this.faceId, unsuccessfulFaceDisassociation.faceId) &&
        Objects.equals(this.userId, unsuccessfulFaceDisassociation.userId) &&
        Objects.equals(this.reasons, unsuccessfulFaceDisassociation.reasons);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnsuccessfulFaceDisassociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnsuccessfulFaceDisassociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnsuccessfulFaceDisassociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnsuccessfulFaceDisassociation is not found in the empty JSON string", UnsuccessfulFaceDisassociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnsuccessfulFaceDisassociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnsuccessfulFaceDisassociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnsuccessfulFaceDisassociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnsuccessfulFaceDisassociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnsuccessfulFaceDisassociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnsuccessfulFaceDisassociation.class));

       return (TypeAdapter<T>) new TypeAdapter<UnsuccessfulFaceDisassociation>() {
           @Override
           public void write(JsonWriter out, UnsuccessfulFaceDisassociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnsuccessfulFaceDisassociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnsuccessfulFaceDisassociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnsuccessfulFaceDisassociation
   * @throws IOException if the JSON string is invalid with respect to UnsuccessfulFaceDisassociation
   */
  public static UnsuccessfulFaceDisassociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnsuccessfulFaceDisassociation.class);
  }

  /**
   * Convert an instance of UnsuccessfulFaceDisassociation to an JSON string
   *
   * @return JSON string
   */
