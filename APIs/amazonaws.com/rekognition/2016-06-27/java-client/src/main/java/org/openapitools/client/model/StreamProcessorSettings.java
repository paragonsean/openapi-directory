...
public class StreamProcessorSettings {
  ...
  public StreamProcessorSettings faceSearch(StreamProcessorSettingsFaceSearch faceSearch) {
  ...
  public StreamProcessorSettings connectedHome(ConnectedHomeSettings connectedHome) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorSettings streamProcessorSettings = (StreamProcessorSettings) o;
    return Objects.equals(this.faceSearch, streamProcessorSettings.faceSearch) &&
        Objects.equals(this.connectedHome, streamProcessorSettings.connectedHome);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessorSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorSettings is not found in the empty JSON string", StreamProcessorSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorSettings>() {
           @Override
           public void write(JsonWriter out, StreamProcessorSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorSettings
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorSettings
   */
  public static StreamProcessorSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorSettings.class);
  }

  /**
   * Convert an instance of StreamProcessorSettings to an JSON string
   *
   * @return JSON string
   */
