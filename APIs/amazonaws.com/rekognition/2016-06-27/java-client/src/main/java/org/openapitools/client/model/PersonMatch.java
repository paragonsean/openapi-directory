...
import org.openapitools.client.model.PersonMatchPerson;
...
public class PersonMatch {
  ...
  private PersonMatchPerson person;
  ...
  public PersonMatch timestamp(Integer timestamp) {
  ...
  public PersonMatch person(PersonMatchPerson person) {
    this.person = person;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PersonMatchPerson getPerson() {
    return person;
  }

  public void setPerson(PersonMatchPerson person) {
    this.person = person;
  }


  public PersonMatch faceMatches(List faceMatches) {
  ...
  public boolean equals(Object o) {
    ...
    PersonMatch personMatch = (PersonMatch) o;
    return Objects.equals(this.timestamp, personMatch.timestamp) &&
        Objects.equals(this.person, personMatch.person) &&
        Objects.equals(this.faceMatches, personMatch.faceMatches);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, person, faceMatches);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PersonMatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonMatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonMatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonMatch is not found in the empty JSON string", PersonMatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonMatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonMatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Person") != null && !jsonObj.get("Person").isJsonNull()) {
        PersonMatchPerson.validateJsonElement(jsonObj.get("Person"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonMatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonMatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonMatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonMatch.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonMatch>() {
           @Override
           public void write(JsonWriter out, PersonMatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonMatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonMatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonMatch
   * @throws IOException if the JSON string is invalid with respect to PersonMatch
   */
  public static PersonMatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonMatch.class);
  }

  /**
   * Convert an instance of PersonMatch to an JSON string
   *
   * @return JSON string
   */
