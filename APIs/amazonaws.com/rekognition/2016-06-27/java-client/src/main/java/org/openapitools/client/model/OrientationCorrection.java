...
/**
 * Gets or Sets OrientationCorrection
 */
@JsonAdapter(OrientationCorrection.Adapter.class)
public enum OrientationCorrection {
  ...
  OrientationCorrection(String value) {
    this.value = value;
  }
  ...
  public static OrientationCorrection fromValue(String value) {
    for (OrientationCorrection b : OrientationCorrection.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrientationCorrection> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrientationCorrection enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrientationCorrection read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrientationCorrection.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrientationCorrection.fromValue(value);
  }
}
