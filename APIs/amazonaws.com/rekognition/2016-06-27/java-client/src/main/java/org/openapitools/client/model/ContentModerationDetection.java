...
import org.openapitools.client.model.ContentModerationDetectionModerationLabel;
...
public class ContentModerationDetection {
  ...
  public static final String SERIALIZED_NAME_MODERATION_LABEL = "ModerationLabel";
  @SerializedName(SERIALIZED_NAME_MODERATION_LABEL)
  private ContentModerationDetectionModerationLabel moderationLabel;
  ...
  public ContentModerationDetection timestamp(Integer timestamp) {
  ...
  public ContentModerationDetection moderationLabel(ContentModerationDetectionModerationLabel moderationLabel) {
   ...
   */
  @javax.annotation.Nullable
  public ContentModerationDetectionModerationLabel getModerationLabel() {
    return moderationLabel;
  }

  public void setModerationLabel(ContentModerationDetectionModerationLabel moderationLabel) {
    this.moderationLabel = moderationLabel;
  }


  public ContentModerationDetection startTimestampMillis(Integer startTimestampMillis) {
  ...
  public ContentModerationDetection endTimestampMillis(Integer endTimestampMillis) {
  ...
  public ContentModerationDetection durationMillis(Integer durationMillis) {
  ...
  public boolean equals(Object o) {
    ...
    ContentModerationDetection contentModerationDetection = (ContentModerationDetection) o;
    return Objects.equals(this.timestamp, contentModerationDetection.timestamp) &&
        Objects.equals(this.moderationLabel, contentModerationDetection.moderationLabel) &&
        Objects.equals(this.startTimestampMillis, contentModerationDetection.startTimestampMillis) &&
        Objects.equals(this.endTimestampMillis, contentModerationDetection.endTimestampMillis) &&
        Objects.equals(this.durationMillis, contentModerationDetection.durationMillis);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, moderationLabel, startTimestampMillis, endTimestampMillis, durationMillis);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContentModerationDetection {\n");
    sb.append("    timestamp: ").append(toIndentedString(timestamp)).append("\n");
    sb.append("    moderationLabel: ").append(toIndentedString(moderationLabel)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ModerationLabel");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContentModerationDetection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentModerationDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContentModerationDetection is not found in the empty JSON string", ContentModerationDetection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentModerationDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContentModerationDetection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `ModerationLabel`
      if (jsonObj.get("ModerationLabel") != null && !jsonObj.get("ModerationLabel").isJsonNull()) {
        ContentModerationDetectionModerationLabel.validateJsonElement(jsonObj.get("ModerationLabel"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContentModerationDetection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContentModerationDetection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContentModerationDetection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContentModerationDetection.class));

       return (TypeAdapter<T>) new TypeAdapter<ContentModerationDetection>() {
           @Override
           public void write(JsonWriter out, ContentModerationDetection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContentModerationDetection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContentModerationDetection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContentModerationDetection
   * @throws IOException if the JSON string is invalid with respect to ContentModerationDetection
   */
  public static ContentModerationDetection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContentModerationDetection.class);
  }

  /**
   * Convert an instance of ContentModerationDetection to an JSON string
   *
   * @return JSON string
   */
