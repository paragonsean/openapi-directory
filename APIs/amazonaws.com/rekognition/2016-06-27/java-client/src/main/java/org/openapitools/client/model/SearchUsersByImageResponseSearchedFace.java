...
import org.openapitools.client.model.FaceDetail;
...
public class SearchUsersByImageResponseSearchedFace {
  public static final String SERIALIZED_NAME_FACE_DETAIL = "FaceDetail";
  @SerializedName(SERIALIZED_NAME_FACE_DETAIL)
  private FaceDetail faceDetail;

  public SearchUsersByImageResponseSearchedFace() {
  }

  public SearchUsersByImageResponseSearchedFace faceDetail(FaceDetail faceDetail) {
  ...
  public boolean equals(Object o) {
    ...
    SearchUsersByImageResponseSearchedFace searchUsersByImageResponseSearchedFace = (SearchUsersByImageResponseSearchedFace) o;
    return Objects.equals(this.faceDetail, searchUsersByImageResponseSearchedFace.faceDetail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceDetail);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchUsersByImageResponseSearchedFace {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchUsersByImageResponseSearchedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchUsersByImageResponseSearchedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchUsersByImageResponseSearchedFace is not found in the empty JSON string", SearchUsersByImageResponseSearchedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchUsersByImageResponseSearchedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchUsersByImageResponseSearchedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `FaceDetail`
      if (jsonObj.get("FaceDetail") != null && !jsonObj.get("FaceDetail").isJsonNull()) {
        FaceDetail.validateJsonElement(jsonObj.get("FaceDetail"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchUsersByImageResponseSearchedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchUsersByImageResponseSearchedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchUsersByImageResponseSearchedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchUsersByImageResponseSearchedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchUsersByImageResponseSearchedFace>() {
           @Override
           public void write(JsonWriter out, SearchUsersByImageResponseSearchedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchUsersByImageResponseSearchedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchUsersByImageResponseSearchedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchUsersByImageResponseSearchedFace
   * @throws IOException if the JSON string is invalid with respect to SearchUsersByImageResponseSearchedFace
   */
  public static SearchUsersByImageResponseSearchedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchUsersByImageResponseSearchedFace.class);
  }

  /**
   * Convert an instance of SearchUsersByImageResponseSearchedFace to an JSON string
   *
   * @return JSON string
   */
