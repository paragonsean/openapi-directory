...
public class EyeOpen {
  ...
  public EyeOpen value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public EyeOpen confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    EyeOpen eyeOpen = (EyeOpen) o;
    return Objects.equals(this.value, eyeOpen.value) &&
        Objects.equals(this.confidence, eyeOpen.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EyeOpen
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EyeOpen.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EyeOpen is not found in the empty JSON string", EyeOpen.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EyeOpen.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EyeOpen` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EyeOpen.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EyeOpen' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EyeOpen> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EyeOpen.class));

       return (TypeAdapter<T>) new TypeAdapter<EyeOpen>() {
           @Override
           public void write(JsonWriter out, EyeOpen value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EyeOpen read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EyeOpen given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EyeOpen
   * @throws IOException if the JSON string is invalid with respect to EyeOpen
   */
  public static EyeOpen fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EyeOpen.class);
  }

  /**
   * Convert an instance of EyeOpen to an JSON string
   *
   * @return JSON string
   */
