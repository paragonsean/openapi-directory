...
public class StartContentModerationRequest {
  ...
  private StartContentModerationRequestVideo video;
  ...
  private StartContentModerationRequestNotificationChannel notificationChannel;

  public static final String SERIALIZED_NAME_JOB_TAG = "JobTag";
  @SerializedName(SERIALIZED_NAME_JOB_TAG)
  private String jobTag;

  public StartContentModerationRequest() {
  }

  public StartContentModerationRequest video(StartContentModerationRequestVideo video) {
    this.video = video;
    return this;
  }
  ...
  public StartContentModerationRequestVideo getVideo() {
    return video;
  }

  public void setVideo(StartContentModerationRequestVideo video) {
    this.video = video;
  }


  public StartContentModerationRequest minConfidence(Float minConfidence) {
  ...
  public StartContentModerationRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartContentModerationRequest notificationChannel(StartContentModerationRequestNotificationChannel notificationChannel) {
   ...
   */
  @javax.annotation.Nullable
  public StartContentModerationRequestNotificationChannel getNotificationChannel() {
    return notificationChannel;
  }

  public void setNotificationChannel(StartContentModerationRequestNotificationChannel notificationChannel) {
    this.notificationChannel = notificationChannel;
  }


  public StartContentModerationRequest jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartContentModerationRequest startContentModerationRequest = (StartContentModerationRequest) o;
    return Objects.equals(this.video, startContentModerationRequest.video) &&
        Objects.equals(this.minConfidence, startContentModerationRequest.minConfidence) &&
        Objects.equals(this.clientRequestToken, startContentModerationRequest.clientRequestToken) &&
        Objects.equals(this.notificationChannel, startContentModerationRequest.notificationChannel) &&
        Objects.equals(this.jobTag, startContentModerationRequest.jobTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(video, minConfidence, clientRequestToken, notificationChannel, jobTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartContentModerationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartContentModerationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartContentModerationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartContentModerationRequest is not found in the empty JSON string", StartContentModerationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartContentModerationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartContentModerationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartContentModerationRequest.openapiRequiredFields) {
      ...
      StartContentModerationRequestVideo.validateJsonElement(jsonObj.get("Video"));
      ...
      if (jsonObj.get("NotificationChannel") != null && !jsonObj.get("NotificationChannel").isJsonNull()) {
        StartContentModerationRequestNotificationChannel.validateJsonElement(jsonObj.get("NotificationChannel"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartContentModerationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartContentModerationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartContentModerationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartContentModerationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartContentModerationRequest>() {
           @Override
           public void write(JsonWriter out, StartContentModerationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartContentModerationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartContentModerationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartContentModerationRequest
   * @throws IOException if the JSON string is invalid with respect to StartContentModerationRequest
   */
  public static StartContentModerationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartContentModerationRequest.class);
  }

  /**
   * Convert an instance of StartContentModerationRequest to an JSON string
   *
   * @return JSON string
   */
