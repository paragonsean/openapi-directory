...
/**
 * ProjectVersionDescriptionManifestSummary
 */
...
public class ProjectVersionDescriptionManifestSummary {
  public static final String SERIALIZED_NAME_S3_OBJECT = "S3Object";
  @SerializedName(SERIALIZED_NAME_S3_OBJECT)
  private S3Object s3Object;

  public ProjectVersionDescriptionManifestSummary() {
  }

  public ProjectVersionDescriptionManifestSummary s3Object(S3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectVersionDescriptionManifestSummary projectVersionDescriptionManifestSummary = (ProjectVersionDescriptionManifestSummary) o;
    return Objects.equals(this.s3Object, projectVersionDescriptionManifestSummary.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectVersionDescriptionManifestSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectVersionDescriptionManifestSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectVersionDescriptionManifestSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectVersionDescriptionManifestSummary is not found in the empty JSON string", ProjectVersionDescriptionManifestSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectVersionDescriptionManifestSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectVersionDescriptionManifestSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `S3Object`
      if (jsonObj.get("S3Object") != null && !jsonObj.get("S3Object").isJsonNull()) {
        S3Object.validateJsonElement(jsonObj.get("S3Object"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectVersionDescriptionManifestSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectVersionDescriptionManifestSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectVersionDescriptionManifestSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectVersionDescriptionManifestSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectVersionDescriptionManifestSummary>() {
           @Override
           public void write(JsonWriter out, ProjectVersionDescriptionManifestSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectVersionDescriptionManifestSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectVersionDescriptionManifestSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectVersionDescriptionManifestSummary
   * @throws IOException if the JSON string is invalid with respect to ProjectVersionDescriptionManifestSummary
   */
  public static ProjectVersionDescriptionManifestSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectVersionDescriptionManifestSummary.class);
  }

  /**
   * Convert an instance of ProjectVersionDescriptionManifestSummary to an JSON string
   *
   * @return JSON string
   */
