...
public class StartContentModerationResponse {
  ...
  public StartContentModerationResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartContentModerationResponse startContentModerationResponse = (StartContentModerationResponse) o;
    return Objects.equals(this.jobId, startContentModerationResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartContentModerationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartContentModerationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartContentModerationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartContentModerationResponse is not found in the empty JSON string", StartContentModerationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartContentModerationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartContentModerationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartContentModerationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartContentModerationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartContentModerationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartContentModerationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartContentModerationResponse>() {
           @Override
           public void write(JsonWriter out, StartContentModerationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartContentModerationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartContentModerationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartContentModerationResponse
   * @throws IOException if the JSON string is invalid with respect to StartContentModerationResponse
   */
  public static StartContentModerationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartContentModerationResponse.class);
  }

  /**
   * Convert an instance of StartContentModerationResponse to an JSON string
   *
   * @return JSON string
   */
