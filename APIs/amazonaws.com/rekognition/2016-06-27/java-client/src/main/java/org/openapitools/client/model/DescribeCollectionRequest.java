...
public class DescribeCollectionRequest {
  ...
  public DescribeCollectionRequest collectionId(String collectionId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collectionId, describeCollectionRequest.collectionId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCollectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCollectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCollectionRequest is not found in the empty JSON string", DescribeCollectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCollectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCollectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeCollectionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCollectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCollectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCollectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCollectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCollectionRequest>() {
           @Override
           public void write(JsonWriter out, DescribeCollectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCollectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCollectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCollectionRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeCollectionRequest
   */
  public static DescribeCollectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCollectionRequest.class);
  }

  /**
   * Convert an instance of DescribeCollectionRequest to an JSON string
   *
   * @return JSON string
   */
