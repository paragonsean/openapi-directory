...
public class GetTextDetectionResponse {
  ...
  public static final String SERIALIZED_NAME_TEXT_DETECTIONS = "TextDetections";
  @SerializedName(SERIALIZED_NAME_TEXT_DETECTIONS)
  private List textDetections;

  public static final String SERIALIZED_NAME_NEXT_TOKEN = "NextToken";
  @SerializedName(SERIALIZED_NAME_NEXT_TOKEN)
  private String nextToken;

  public static final String SERIALIZED_NAME_TEXT_MODEL_VERSION = "TextModelVersion";
  @SerializedName(SERIALIZED_NAME_TEXT_MODEL_VERSION)
  ...
  public GetTextDetectionResponse jobStatus(VideoJobStatus jobStatus) {
  ...
  public GetTextDetectionResponse statusMessage(String statusMessage) {
  ...
  public GetTextDetectionResponse videoMetadata(VideoMetadata videoMetadata) {
  ...
  public GetTextDetectionResponse textDetections(List textDetections) {
   ...
   */
  @javax.annotation.Nullable
  public List getTextDetections() {
    return textDetections;
  }

  public void setTextDetections(List textDetections) {
    this.textDetections = textDetections;
  }


  public GetTextDetectionResponse nextToken(String nextToken) {
  ...
  public GetTextDetectionResponse textModelVersion(String textModelVersion) {
    this.textModelVersion = textModelVersion;
    return this;
  }

  /**
   * Get textModelVersion
  ...
  public GetTextDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetTextDetectionResponse video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public GetTextDetectionResponse jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTextDetectionResponse getTextDetectionResponse = (GetTextDetectionResponse) o;
    return Objects.equals(this.jobStatus, getTextDetectionResponse.jobStatus) &&
        Objects.equals(this.statusMessage, getTextDetectionResponse.statusMessage) &&
        Objects.equals(this.videoMetadata, getTextDetectionResponse.videoMetadata) &&
        Objects.equals(this.textDetections, getTextDetectionResponse.textDetections) &&
        Objects.equals(this.nextToken, getTextDetectionResponse.nextToken) &&
        Objects.equals(this.textModelVersion, getTextDetectionResponse.textModelVersion) &&
        Objects.equals(this.jobId, getTextDetectionResponse.jobId) &&
        Objects.equals(this.video, getTextDetectionResponse.video) &&
        Objects.equals(this.jobTag, getTextDetectionResponse.jobTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobStatus, statusMessage, videoMetadata, textDetections, nextToken, textModelVersion, jobId, video, jobTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetTextDetectionResponse {\n");
    sb.append("    jobStatus: ").append(toIndentedString(jobStatus)).append("\n");
    sb.append("    statusMessage: ").append(toIndentedString(statusMessage)).append("\n");
    sb.append("    videoMetadata: ").append(toIndentedString(videoMetadata)).append("\n");
    sb.append("    textDetections: ").append(toIndentedString(textDetections)).append("\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    textModelVersion: ").append(toIndentedString(textModelVersion)).append("\n");
  ...
  static {
    ...
    openapiFields.add("TextDetections");
    openapiFields.add("NextToken");
    openapiFields.add("TextModelVersion");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTextDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTextDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTextDetectionResponse is not found in the empty JSON string", GetTextDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTextDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTextDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("VideoMetadata") != null && !jsonObj.get("VideoMetadata").isJsonNull()) {
        VideoMetadata.validateJsonElement(jsonObj.get("VideoMetadata"));
      }
      // validate the optional field `TextDetections`
      if (jsonObj.get("TextDetections") != null && !jsonObj.get("TextDetections").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("TextDetections"));
      }
      // validate the optional field `NextToken`
      if (jsonObj.get("NextToken") != null && !jsonObj.get("NextToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("NextToken"));
      }
      // validate the optional field `TextModelVersion`
      if (jsonObj.get("TextModelVersion") != null && !jsonObj.get("TextModelVersion").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("TextModelVersion"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTextDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTextDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTextDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTextDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTextDetectionResponse>() {
           @Override
           public void write(JsonWriter out, GetTextDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTextDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTextDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTextDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to GetTextDetectionResponse
   */
  public static GetTextDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTextDetectionResponse.class);
  }

  /**
   * Convert an instance of GetTextDetectionResponse to an JSON string
   *
   * @return JSON string
   */
