...
/**
 * Gets or Sets CelebrityRecognitionSortBy
 */
@JsonAdapter(CelebrityRecognitionSortBy.Adapter.class)
public enum CelebrityRecognitionSortBy {
  ...
  CelebrityRecognitionSortBy(String value) {
    this.value = value;
  }
  ...
  public static CelebrityRecognitionSortBy fromValue(String value) {
    for (CelebrityRecognitionSortBy b : CelebrityRecognitionSortBy.values()) {
  ...
  public static class Adapter extends TypeAdapter<CelebrityRecognitionSortBy> {
    @Override
    public void write(final JsonWriter jsonWriter, final CelebrityRecognitionSortBy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CelebrityRecognitionSortBy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CelebrityRecognitionSortBy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CelebrityRecognitionSortBy.fromValue(value);
  }
}
