...
public class Beard {
  ...
  public Beard value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public Beard confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    Beard beard = (Beard) o;
    return Objects.equals(this.value, beard.value) &&
        Objects.equals(this.confidence, beard.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Beard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Beard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Beard is not found in the empty JSON string", Beard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Beard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Beard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Beard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Beard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Beard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Beard.class));

       return (TypeAdapter<T>) new TypeAdapter<Beard>() {
           @Override
           public void write(JsonWriter out, Beard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Beard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Beard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Beard
   * @throws IOException if the JSON string is invalid with respect to Beard
   */
  public static Beard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Beard.class);
  }

  /**
   * Convert an instance of Beard to an JSON string
   *
   * @return JSON string
   */
