...
public class CreateFaceLivenessSessionRequest {
  ...
  public CreateFaceLivenessSessionRequest kmsKeyId(String kmsKeyId) {
  ...
  public CreateFaceLivenessSessionRequest settings(CreateFaceLivenessSessionRequestSettings settings) {
  ...
  public CreateFaceLivenessSessionRequest clientRequestToken(String clientRequestToken) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFaceLivenessSessionRequest createFaceLivenessSessionRequest = (CreateFaceLivenessSessionRequest) o;
    return Objects.equals(this.kmsKeyId, createFaceLivenessSessionRequest.kmsKeyId) &&
        Objects.equals(this.settings, createFaceLivenessSessionRequest.settings) &&
        Objects.equals(this.clientRequestToken, createFaceLivenessSessionRequest.clientRequestToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kmsKeyId, settings, clientRequestToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateFaceLivenessSessionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFaceLivenessSessionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFaceLivenessSessionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFaceLivenessSessionRequest is not found in the empty JSON string", CreateFaceLivenessSessionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFaceLivenessSessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFaceLivenessSessionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Settings") != null && !jsonObj.get("Settings").isJsonNull()) {
        CreateFaceLivenessSessionRequestSettings.validateJsonElement(jsonObj.get("Settings"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFaceLivenessSessionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFaceLivenessSessionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFaceLivenessSessionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFaceLivenessSessionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFaceLivenessSessionRequest>() {
           @Override
           public void write(JsonWriter out, CreateFaceLivenessSessionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFaceLivenessSessionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFaceLivenessSessionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFaceLivenessSessionRequest
   * @throws IOException if the JSON string is invalid with respect to CreateFaceLivenessSessionRequest
   */
  public static CreateFaceLivenessSessionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFaceLivenessSessionRequest.class);
  }

  /**
   * Convert an instance of CreateFaceLivenessSessionRequest to an JSON string
   *
   * @return JSON string
   */
