...
public class ListDatasetLabelsRequest {
  ...
  public ListDatasetLabelsRequest() {
  }

  public ListDatasetLabelsRequest datasetArn(String datasetArn) {
  ...
  public ListDatasetLabelsRequest nextToken(String nextToken) {
  ...
  public ListDatasetLabelsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListDatasetLabelsRequest listDatasetLabelsRequest = (ListDatasetLabelsRequest) o;
    return Objects.equals(this.datasetArn, listDatasetLabelsRequest.datasetArn) &&
        Objects.equals(this.nextToken, listDatasetLabelsRequest.nextToken) &&
        Objects.equals(this.maxResults, listDatasetLabelsRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListDatasetLabelsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDatasetLabelsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDatasetLabelsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDatasetLabelsRequest is not found in the empty JSON string", ListDatasetLabelsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDatasetLabelsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDatasetLabelsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListDatasetLabelsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDatasetLabelsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDatasetLabelsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDatasetLabelsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDatasetLabelsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDatasetLabelsRequest>() {
           @Override
           public void write(JsonWriter out, ListDatasetLabelsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDatasetLabelsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDatasetLabelsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDatasetLabelsRequest
   * @throws IOException if the JSON string is invalid with respect to ListDatasetLabelsRequest
   */
  public static ListDatasetLabelsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDatasetLabelsRequest.class);
  }

  /**
   * Convert an instance of ListDatasetLabelsRequest to an JSON string
   *
   * @return JSON string
   */
