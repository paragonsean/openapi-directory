...
public class UnindexedFaceFaceDetail {
  ...
  public UnindexedFaceFaceDetail() {
  }

  public UnindexedFaceFaceDetail boundingBox(FaceDetailBoundingBox boundingBox) {
  ...
  public UnindexedFaceFaceDetail ageRange(FaceDetailAgeRange ageRange) {
  ...
  public UnindexedFaceFaceDetail smile(FaceDetailSmile smile) {
    this.smile = smile;
    return this;
  }
  ...
  public UnindexedFaceFaceDetail eyeglasses(FaceDetailEyeglasses eyeglasses) {
  ...
  public UnindexedFaceFaceDetail sunglasses(FaceDetailSunglasses sunglasses) {
  ...
  public UnindexedFaceFaceDetail gender(FaceDetailGender gender) {
    this.gender = gender;
    return this;
  }
  ...
  public UnindexedFaceFaceDetail beard(FaceDetailBeard beard) {
    this.beard = beard;
    return this;
  }
  ...
  public UnindexedFaceFaceDetail mustache(FaceDetailMustache mustache) {
  ...
  public UnindexedFaceFaceDetail eyesOpen(FaceDetailEyesOpen eyesOpen) {
  ...
  public UnindexedFaceFaceDetail mouthOpen(FaceDetailMouthOpen mouthOpen) {
  ...
  public UnindexedFaceFaceDetail emotions(List emotions) {
  ...
  public UnindexedFaceFaceDetail landmarks(List landmarks) {
  ...
  public UnindexedFaceFaceDetail pose(FaceDetailPose pose) {
    this.pose = pose;
    return this;
  }
  ...
  public UnindexedFaceFaceDetail quality(FaceDetailQuality quality) {
  ...
  public UnindexedFaceFaceDetail confidence(Float confidence) {
  ...
  public UnindexedFaceFaceDetail faceOccluded(FaceDetailFaceOccluded faceOccluded) {
  ...
  public UnindexedFaceFaceDetail eyeDirection(FaceDetailEyeDirection eyeDirection) {
  ...
  public boolean equals(Object o) {
    ...
    UnindexedFaceFaceDetail unindexedFaceFaceDetail = (UnindexedFaceFaceDetail) o;
    return Objects.equals(this.boundingBox, unindexedFaceFaceDetail.boundingBox) &&
        Objects.equals(this.ageRange, unindexedFaceFaceDetail.ageRange) &&
        Objects.equals(this.smile, unindexedFaceFaceDetail.smile) &&
        Objects.equals(this.eyeglasses, unindexedFaceFaceDetail.eyeglasses) &&
        Objects.equals(this.sunglasses, unindexedFaceFaceDetail.sunglasses) &&
        Objects.equals(this.gender, unindexedFaceFaceDetail.gender) &&
        Objects.equals(this.beard, unindexedFaceFaceDetail.beard) &&
        Objects.equals(this.mustache, unindexedFaceFaceDetail.mustache) &&
        Objects.equals(this.eyesOpen, unindexedFaceFaceDetail.eyesOpen) &&
        Objects.equals(this.mouthOpen, unindexedFaceFaceDetail.mouthOpen) &&
        Objects.equals(this.emotions, unindexedFaceFaceDetail.emotions) &&
        Objects.equals(this.landmarks, unindexedFaceFaceDetail.landmarks) &&
        Objects.equals(this.pose, unindexedFaceFaceDetail.pose) &&
        Objects.equals(this.quality, unindexedFaceFaceDetail.quality) &&
        Objects.equals(this.confidence, unindexedFaceFaceDetail.confidence) &&
        Objects.equals(this.faceOccluded, unindexedFaceFaceDetail.faceOccluded) &&
        Objects.equals(this.eyeDirection, unindexedFaceFaceDetail.eyeDirection);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnindexedFaceFaceDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnindexedFaceFaceDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnindexedFaceFaceDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnindexedFaceFaceDetail is not found in the empty JSON string", UnindexedFaceFaceDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnindexedFaceFaceDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnindexedFaceFaceDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnindexedFaceFaceDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnindexedFaceFaceDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnindexedFaceFaceDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnindexedFaceFaceDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<UnindexedFaceFaceDetail>() {
           @Override
           public void write(JsonWriter out, UnindexedFaceFaceDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnindexedFaceFaceDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnindexedFaceFaceDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnindexedFaceFaceDetail
   * @throws IOException if the JSON string is invalid with respect to UnindexedFaceFaceDetail
   */
  public static UnindexedFaceFaceDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnindexedFaceFaceDetail.class);
  }

  /**
   * Convert an instance of UnindexedFaceFaceDetail to an JSON string
   *
   * @return JSON string
   */
