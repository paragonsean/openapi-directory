...
public class DeleteStreamProcessorRequest {
  ...
  public DeleteStreamProcessorRequest() {
  }

  public DeleteStreamProcessorRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteStreamProcessorRequest deleteStreamProcessorRequest = (DeleteStreamProcessorRequest) o;
    return Objects.equals(this.name, deleteStreamProcessorRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteStreamProcessorRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteStreamProcessorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteStreamProcessorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteStreamProcessorRequest is not found in the empty JSON string", DeleteStreamProcessorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteStreamProcessorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteStreamProcessorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteStreamProcessorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteStreamProcessorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteStreamProcessorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteStreamProcessorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteStreamProcessorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteStreamProcessorRequest>() {
           @Override
           public void write(JsonWriter out, DeleteStreamProcessorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteStreamProcessorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteStreamProcessorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteStreamProcessorRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteStreamProcessorRequest
   */
  public static DeleteStreamProcessorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteStreamProcessorRequest.class);
  }

  /**
   * Convert an instance of DeleteStreamProcessorRequest to an JSON string
   *
   * @return JSON string
   */
