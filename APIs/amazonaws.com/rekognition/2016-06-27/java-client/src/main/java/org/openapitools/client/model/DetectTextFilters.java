...
public class DetectTextFilters {
  ...
  public DetectTextFilters wordFilter(DetectionFilter wordFilter) {
  ...
  public DetectTextFilters regionsOfInterest(List regionsOfInterest) {
  ...
  public boolean equals(Object o) {
    ...
    DetectTextFilters detectTextFilters = (DetectTextFilters) o;
    return Objects.equals(this.wordFilter, detectTextFilters.wordFilter) &&
        Objects.equals(this.regionsOfInterest, detectTextFilters.regionsOfInterest);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectTextFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectTextFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectTextFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectTextFilters is not found in the empty JSON string", DetectTextFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectTextFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectTextFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectTextFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectTextFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectTextFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectTextFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectTextFilters>() {
           @Override
           public void write(JsonWriter out, DetectTextFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectTextFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectTextFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectTextFilters
   * @throws IOException if the JSON string is invalid with respect to DetectTextFilters
   */
  public static DetectTextFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectTextFilters.class);
  }

  /**
   * Convert an instance of DetectTextFilters to an JSON string
   *
   * @return JSON string
   */
