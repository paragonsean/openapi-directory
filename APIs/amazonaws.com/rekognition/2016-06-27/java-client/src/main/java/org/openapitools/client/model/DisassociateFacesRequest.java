...
public class DisassociateFacesRequest {
  ...
  public DisassociateFacesRequest() {
  }

  public DisassociateFacesRequest collectionId(String collectionId) {
  ...
  public DisassociateFacesRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public DisassociateFacesRequest clientRequestToken(String clientRequestToken) {
  ...
  public DisassociateFacesRequest faceIds(List faceIds) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateFacesRequest disassociateFacesRequest = (DisassociateFacesRequest) o;
    return Objects.equals(this.collectionId, disassociateFacesRequest.collectionId) &&
        Objects.equals(this.userId, disassociateFacesRequest.userId) &&
        Objects.equals(this.clientRequestToken, disassociateFacesRequest.clientRequestToken) &&
        Objects.equals(this.faceIds, disassociateFacesRequest.faceIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, userId, clientRequestToken, faceIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisassociateFacesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateFacesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateFacesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateFacesRequest is not found in the empty JSON string", DisassociateFacesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateFacesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateFacesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisassociateFacesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateFacesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateFacesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateFacesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateFacesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateFacesRequest>() {
           @Override
           public void write(JsonWriter out, DisassociateFacesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateFacesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateFacesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateFacesRequest
   * @throws IOException if the JSON string is invalid with respect to DisassociateFacesRequest
   */
  public static DisassociateFacesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateFacesRequest.class);
  }

  /**
   * Convert an instance of DisassociateFacesRequest to an JSON string
   *
   * @return JSON string
   */
