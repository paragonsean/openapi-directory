...
/**
 * SegmentDetectionTechnicalCueSegment
 */
...
public class SegmentDetectionTechnicalCueSegment {
  ...
  public SegmentDetectionTechnicalCueSegment() {
  }

  public SegmentDetectionTechnicalCueSegment type(TechnicalCueType type) {
    this.type = type;
    return this;
  }
  ...
  public SegmentDetectionTechnicalCueSegment confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentDetectionTechnicalCueSegment segmentDetectionTechnicalCueSegment = (SegmentDetectionTechnicalCueSegment) o;
    return Objects.equals(this.type, segmentDetectionTechnicalCueSegment.type) &&
        Objects.equals(this.confidence, segmentDetectionTechnicalCueSegment.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentDetectionTechnicalCueSegment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SegmentDetectionTechnicalCueSegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentDetectionTechnicalCueSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentDetectionTechnicalCueSegment is not found in the empty JSON string", SegmentDetectionTechnicalCueSegment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentDetectionTechnicalCueSegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentDetectionTechnicalCueSegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentDetectionTechnicalCueSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentDetectionTechnicalCueSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentDetectionTechnicalCueSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentDetectionTechnicalCueSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentDetectionTechnicalCueSegment>() {
           @Override
           public void write(JsonWriter out, SegmentDetectionTechnicalCueSegment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SegmentDetectionTechnicalCueSegment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SegmentDetectionTechnicalCueSegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SegmentDetectionTechnicalCueSegment
   * @throws IOException if the JSON string is invalid with respect to SegmentDetectionTechnicalCueSegment
   */
  public static SegmentDetectionTechnicalCueSegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentDetectionTechnicalCueSegment.class);
  }

  /**
   * Convert an instance of SegmentDetectionTechnicalCueSegment to an JSON string
   *
   * @return JSON string
   */
