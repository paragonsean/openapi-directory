...
public class ComparedFaceQuality {
  ...
  public ComparedFaceQuality() {
  }

  public ComparedFaceQuality brightness(Float brightness) {
  ...
  public ComparedFaceQuality sharpness(Float sharpness) {
  ...
  public boolean equals(Object o) {
    ...
    ComparedFaceQuality comparedFaceQuality = (ComparedFaceQuality) o;
    return Objects.equals(this.brightness, comparedFaceQuality.brightness) &&
        Objects.equals(this.sharpness, comparedFaceQuality.sharpness);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brightness, sharpness);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ComparedFaceQuality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComparedFaceQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComparedFaceQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComparedFaceQuality is not found in the empty JSON string", ComparedFaceQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComparedFaceQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComparedFaceQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComparedFaceQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComparedFaceQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComparedFaceQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComparedFaceQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<ComparedFaceQuality>() {
           @Override
           public void write(JsonWriter out, ComparedFaceQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComparedFaceQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComparedFaceQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComparedFaceQuality
   * @throws IOException if the JSON string is invalid with respect to ComparedFaceQuality
   */
  public static ComparedFaceQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComparedFaceQuality.class);
  }

  /**
   * Convert an instance of ComparedFaceQuality to an JSON string
   *
   * @return JSON string
   */
