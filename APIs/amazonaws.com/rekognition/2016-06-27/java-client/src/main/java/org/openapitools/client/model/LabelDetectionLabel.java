...
public class LabelDetectionLabel {
  ...
  public LabelDetectionLabel() {
  }

  public LabelDetectionLabel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LabelDetectionLabel confidence(Float confidence) {
  ...
  public LabelDetectionLabel instances(List instances) {
  ...
  public LabelDetectionLabel parents(List parents) {
  ...
  public LabelDetectionLabel aliases(List aliases) {
  ...
  public LabelDetectionLabel categories(List categories) {
  ...
  public boolean equals(Object o) {
    ...
    LabelDetectionLabel labelDetectionLabel = (LabelDetectionLabel) o;
    return Objects.equals(this.name, labelDetectionLabel.name) &&
        Objects.equals(this.confidence, labelDetectionLabel.confidence) &&
        Objects.equals(this.instances, labelDetectionLabel.instances) &&
        Objects.equals(this.parents, labelDetectionLabel.parents) &&
        Objects.equals(this.aliases, labelDetectionLabel.aliases) &&
        Objects.equals(this.categories, labelDetectionLabel.categories);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, confidence, instances, parents, aliases, categories);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LabelDetectionLabel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabelDetectionLabel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabelDetectionLabel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabelDetectionLabel is not found in the empty JSON string", LabelDetectionLabel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabelDetectionLabel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabelDetectionLabel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabelDetectionLabel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabelDetectionLabel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabelDetectionLabel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabelDetectionLabel.class));

       return (TypeAdapter<T>) new TypeAdapter<LabelDetectionLabel>() {
           @Override
           public void write(JsonWriter out, LabelDetectionLabel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabelDetectionLabel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabelDetectionLabel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabelDetectionLabel
   * @throws IOException if the JSON string is invalid with respect to LabelDetectionLabel
   */
  public static LabelDetectionLabel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabelDetectionLabel.class);
  }

  /**
   * Convert an instance of LabelDetectionLabel to an JSON string
   *
   * @return JSON string
   */
