...
/**
 * Gets or Sets UnsuccessfulFaceDeletionReason
 */
@JsonAdapter(UnsuccessfulFaceDeletionReason.Adapter.class)
public enum UnsuccessfulFaceDeletionReason {
  ...
  UnsuccessfulFaceDeletionReason(String value) {
    this.value = value;
  }
  ...
  public static UnsuccessfulFaceDeletionReason fromValue(String value) {
    for (UnsuccessfulFaceDeletionReason b : UnsuccessfulFaceDeletionReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnsuccessfulFaceDeletionReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnsuccessfulFaceDeletionReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UnsuccessfulFaceDeletionReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UnsuccessfulFaceDeletionReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UnsuccessfulFaceDeletionReason.fromValue(value);
  }
}
