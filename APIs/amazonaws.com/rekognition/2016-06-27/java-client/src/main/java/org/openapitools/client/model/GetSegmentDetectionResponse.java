...
public class GetSegmentDetectionResponse {
  ...
  private List videoMetadata;

  public static final String SERIALIZED_NAME_AUDIO_METADATA = "AudioMetadata";
  @SerializedName(SERIALIZED_NAME_AUDIO_METADATA)
  private List audioMetadata;
  ...
  public static final String SERIALIZED_NAME_SELECTED_SEGMENT_TYPES = "SelectedSegmentTypes";
  @SerializedName(SERIALIZED_NAME_SELECTED_SEGMENT_TYPES)
  private List selectedSegmentTypes;
  ...
  public GetSegmentDetectionResponse jobStatus(VideoJobStatus jobStatus) {
  ...
  public GetSegmentDetectionResponse statusMessage(String statusMessage) {
  ...
  public GetSegmentDetectionResponse videoMetadata(List videoMetadata) {
   ...
   */
  @javax.annotation.Nullable
  public List getVideoMetadata() {
    return videoMetadata;
  }

  public void setVideoMetadata(List videoMetadata) {
    this.videoMetadata = videoMetadata;
  }


  public GetSegmentDetectionResponse audioMetadata(List audioMetadata) {
   ...
   */
  @javax.annotation.Nullable
  public List getAudioMetadata() {
    return audioMetadata;
  }

  public void setAudioMetadata(List audioMetadata) {
    this.audioMetadata = audioMetadata;
  }


  public GetSegmentDetectionResponse nextToken(String nextToken) {
  ...
  public GetSegmentDetectionResponse segments(List segments) {
  ...
  public GetSegmentDetectionResponse selectedSegmentTypes(List selectedSegmentTypes) {
    this.selectedSegmentTypes = selectedSegmentTypes;
    return this;
  }

  /**
   * Get selectedSegmentTypes
   * @return selectedSegmentTypes
   */
  @javax.annotation.Nullable
  public List getSelectedSegmentTypes() {
    return selectedSegmentTypes;
  }

  public void setSelectedSegmentTypes(List selectedSegmentTypes) {
    this.selectedSegmentTypes = selectedSegmentTypes;
  }


  public GetSegmentDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetSegmentDetectionResponse video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public GetSegmentDetectionResponse jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetSegmentDetectionResponse getSegmentDetectionResponse = (GetSegmentDetectionResponse) o;
    return Objects.equals(this.jobStatus, getSegmentDetectionResponse.jobStatus) &&
        Objects.equals(this.statusMessage, getSegmentDetectionResponse.statusMessage) &&
        Objects.equals(this.videoMetadata, getSegmentDetectionResponse.videoMetadata) &&
        Objects.equals(this.audioMetadata, getSegmentDetectionResponse.audioMetadata) &&
        Objects.equals(this.nextToken, getSegmentDetectionResponse.nextToken) &&
        Objects.equals(this.segments, getSegmentDetectionResponse.segments) &&
        Objects.equals(this.selectedSegmentTypes, getSegmentDetectionResponse.selectedSegmentTypes) &&
        Objects.equals(this.jobId, getSegmentDetectionResponse.jobId) &&
        Objects.equals(this.video, getSegmentDetectionResponse.video) &&
        Objects.equals(this.jobTag, getSegmentDetectionResponse.jobTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobStatus, statusMessage, videoMetadata, audioMetadata, nextToken, segments, selectedSegmentTypes, jobId, video, jobTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetSegmentDetectionResponse {\n");
    sb.append("    jobStatus: ").append(toIndentedString(jobStatus)).append("\n");
    sb.append("    statusMessage: ").append(toIndentedString(statusMessage)).append("\n");
    sb.append("    videoMetadata: ").append(toIndentedString(videoMetadata)).append("\n");
    sb.append("    audioMetadata: ").append(toIndentedString(audioMetadata)).append("\n");
  ...
  static {
    ...
    openapiFields.add("AudioMetadata");
    openapiFields.add("NextToken");
    openapiFields.add("Segments");
    openapiFields.add("SelectedSegmentTypes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSegmentDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSegmentDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSegmentDetectionResponse is not found in the empty JSON string", GetSegmentDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSegmentDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSegmentDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("VideoMetadata") != null && !jsonObj.get("VideoMetadata").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("VideoMetadata"));
      }
      // validate the optional field `AudioMetadata`
      if (jsonObj.get("AudioMetadata") != null && !jsonObj.get("AudioMetadata").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("AudioMetadata"));
      }
      ...
      if (jsonObj.get("SelectedSegmentTypes") != null && !jsonObj.get("SelectedSegmentTypes").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("SelectedSegmentTypes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSegmentDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSegmentDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSegmentDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSegmentDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSegmentDetectionResponse>() {
           @Override
           public void write(JsonWriter out, GetSegmentDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSegmentDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSegmentDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSegmentDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to GetSegmentDetectionResponse
   */
  public static GetSegmentDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSegmentDetectionResponse.class);
  }

  /**
   * Convert an instance of GetSegmentDetectionResponse to an JSON string
   *
   * @return JSON string
   */
