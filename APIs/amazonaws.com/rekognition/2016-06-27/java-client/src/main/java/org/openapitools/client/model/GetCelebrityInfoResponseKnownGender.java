...
public class GetCelebrityInfoResponseKnownGender {
  public static final String SERIALIZED_NAME_TYPE = "Type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private KnownGenderType type;

  public GetCelebrityInfoResponseKnownGender() {
  }

  public GetCelebrityInfoResponseKnownGender type(KnownGenderType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCelebrityInfoResponseKnownGender getCelebrityInfoResponseKnownGender = (GetCelebrityInfoResponseKnownGender) o;
    return Objects.equals(this.type, getCelebrityInfoResponseKnownGender.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCelebrityInfoResponseKnownGender {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCelebrityInfoResponseKnownGender
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCelebrityInfoResponseKnownGender.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCelebrityInfoResponseKnownGender is not found in the empty JSON string", GetCelebrityInfoResponseKnownGender.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCelebrityInfoResponseKnownGender.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCelebrityInfoResponseKnownGender` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCelebrityInfoResponseKnownGender.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCelebrityInfoResponseKnownGender' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCelebrityInfoResponseKnownGender> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCelebrityInfoResponseKnownGender.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCelebrityInfoResponseKnownGender>() {
           @Override
           public void write(JsonWriter out, GetCelebrityInfoResponseKnownGender value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCelebrityInfoResponseKnownGender read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCelebrityInfoResponseKnownGender given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCelebrityInfoResponseKnownGender
   * @throws IOException if the JSON string is invalid with respect to GetCelebrityInfoResponseKnownGender
   */
  public static GetCelebrityInfoResponseKnownGender fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCelebrityInfoResponseKnownGender.class);
  }

  /**
   * Convert an instance of GetCelebrityInfoResponseKnownGender to an JSON string
   *
   * @return JSON string
   */
