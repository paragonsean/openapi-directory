...
import org.openapitools.client.model.CustomLabelGeometry;
...
public class CustomLabel {
  ...
  private CustomLabelGeometry geometry;

  public CustomLabel() {
  }

  public CustomLabel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomLabel confidence(Float confidence) {
  ...
  public CustomLabel geometry(CustomLabelGeometry geometry) {
   ...
   */
  @javax.annotation.Nullable
  public CustomLabelGeometry getGeometry() {
    return geometry;
  }

  public void setGeometry(CustomLabelGeometry geometry) {
    this.geometry = geometry;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, customLabel.name) &&
        Objects.equals(this.confidence, customLabel.confidence) &&
        Objects.equals(this.geometry, customLabel.geometry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, confidence, geometry);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Geometry") != null && !jsonObj.get("Geometry").isJsonNull()) {
        CustomLabelGeometry.validateJsonElement(jsonObj.get("Geometry"));
      }
  }
