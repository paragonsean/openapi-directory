 ...
 */
@JsonAdapter(Attribute.Adapter.class)
public enum Attribute {
  ...
  public static class Adapter extends TypeAdapter<Attribute> {
    @Override
    public void write(final JsonWriter jsonWriter, final Attribute enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Attribute read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Attribute.fromValue(value);
    }
  }
