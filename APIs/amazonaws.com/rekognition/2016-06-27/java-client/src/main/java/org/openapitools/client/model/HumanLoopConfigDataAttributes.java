...
public class HumanLoopConfigDataAttributes {
  ...
  public HumanLoopConfigDataAttributes() {
  }

  public HumanLoopConfigDataAttributes contentClassifiers(List contentClassifiers) {
  ...
  public boolean equals(Object o) {
    ...
    HumanLoopConfigDataAttributes humanLoopConfigDataAttributes = (HumanLoopConfigDataAttributes) o;
    return Objects.equals(this.contentClassifiers, humanLoopConfigDataAttributes.contentClassifiers);
  }
  ...
  public String toString() {
    ...
    sb.append("class HumanLoopConfigDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HumanLoopConfigDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HumanLoopConfigDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HumanLoopConfigDataAttributes is not found in the empty JSON string", HumanLoopConfigDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HumanLoopConfigDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HumanLoopConfigDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HumanLoopConfigDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HumanLoopConfigDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HumanLoopConfigDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HumanLoopConfigDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<HumanLoopConfigDataAttributes>() {
           @Override
           public void write(JsonWriter out, HumanLoopConfigDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HumanLoopConfigDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HumanLoopConfigDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HumanLoopConfigDataAttributes
   * @throws IOException if the JSON string is invalid with respect to HumanLoopConfigDataAttributes
   */
  public static HumanLoopConfigDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HumanLoopConfigDataAttributes.class);
  }

  /**
   * Convert an instance of HumanLoopConfigDataAttributes to an JSON string
   *
   * @return JSON string
   */
