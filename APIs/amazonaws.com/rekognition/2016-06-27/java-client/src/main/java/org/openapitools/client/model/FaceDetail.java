...
public class FaceDetail {
  ...
  public FaceDetail boundingBox(FaceDetailBoundingBox boundingBox) {
  ...
  public FaceDetail ageRange(FaceDetailAgeRange ageRange) {
  ...
  public FaceDetail smile(FaceDetailSmile smile) {
    this.smile = smile;
    return this;
  }
  ...
  public FaceDetail eyeglasses(FaceDetailEyeglasses eyeglasses) {
  ...
  public FaceDetail sunglasses(FaceDetailSunglasses sunglasses) {
  ...
  public FaceDetail gender(FaceDetailGender gender) {
    this.gender = gender;
    return this;
  }
  ...
  public FaceDetail beard(FaceDetailBeard beard) {
    this.beard = beard;
    return this;
  }
  ...
  public FaceDetail mustache(FaceDetailMustache mustache) {
  ...
  public FaceDetail eyesOpen(FaceDetailEyesOpen eyesOpen) {
  ...
  public FaceDetail mouthOpen(FaceDetailMouthOpen mouthOpen) {
  ...
  public FaceDetail emotions(List emotions) {
  ...
  public FaceDetail landmarks(List landmarks) {
  ...
  public FaceDetail pose(FaceDetailPose pose) {
    this.pose = pose;
    return this;
  }
  ...
  public FaceDetail quality(FaceDetailQuality quality) {
  ...
  public FaceDetail confidence(Float confidence) {
  ...
  public FaceDetail faceOccluded(FaceDetailFaceOccluded faceOccluded) {
  ...
  public FaceDetail eyeDirection(FaceDetailEyeDirection eyeDirection) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetail faceDetail = (FaceDetail) o;
    return Objects.equals(this.boundingBox, faceDetail.boundingBox) &&
        Objects.equals(this.ageRange, faceDetail.ageRange) &&
        Objects.equals(this.smile, faceDetail.smile) &&
        Objects.equals(this.eyeglasses, faceDetail.eyeglasses) &&
        Objects.equals(this.sunglasses, faceDetail.sunglasses) &&
        Objects.equals(this.gender, faceDetail.gender) &&
        Objects.equals(this.beard, faceDetail.beard) &&
        Objects.equals(this.mustache, faceDetail.mustache) &&
        Objects.equals(this.eyesOpen, faceDetail.eyesOpen) &&
        Objects.equals(this.mouthOpen, faceDetail.mouthOpen) &&
        Objects.equals(this.emotions, faceDetail.emotions) &&
        Objects.equals(this.landmarks, faceDetail.landmarks) &&
        Objects.equals(this.pose, faceDetail.pose) &&
        Objects.equals(this.quality, faceDetail.quality) &&
        Objects.equals(this.confidence, faceDetail.confidence) &&
        Objects.equals(this.faceOccluded, faceDetail.faceOccluded) &&
        Objects.equals(this.eyeDirection, faceDetail.eyeDirection);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetail is not found in the empty JSON string", FaceDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetail>() {
           @Override
           public void write(JsonWriter out, FaceDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetail
   * @throws IOException if the JSON string is invalid with respect to FaceDetail
   */
  public static FaceDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetail.class);
  }

  /**
   * Convert an instance of FaceDetail to an JSON string
   *
   * @return JSON string
   */
