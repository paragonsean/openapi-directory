...
public class TextDetectionGeometry {
  ...
  public TextDetectionGeometry() {
  }

  public TextDetectionGeometry boundingBox(GeometryBoundingBox boundingBox) {
  ...
  public TextDetectionGeometry polygon(List polygon) {
  ...
  public boolean equals(Object o) {
    ...
    TextDetectionGeometry textDetectionGeometry = (TextDetectionGeometry) o;
    return Objects.equals(this.boundingBox, textDetectionGeometry.boundingBox) &&
        Objects.equals(this.polygon, textDetectionGeometry.polygon);
  }
  ...
  public String toString() {
    ...
    sb.append("class TextDetectionGeometry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextDetectionGeometry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextDetectionGeometry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TextDetectionGeometry is not found in the empty JSON string", TextDetectionGeometry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextDetectionGeometry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TextDetectionGeometry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TextDetectionGeometry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TextDetectionGeometry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TextDetectionGeometry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TextDetectionGeometry.class));

       return (TypeAdapter<T>) new TypeAdapter<TextDetectionGeometry>() {
           @Override
           public void write(JsonWriter out, TextDetectionGeometry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TextDetectionGeometry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TextDetectionGeometry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TextDetectionGeometry
   * @throws IOException if the JSON string is invalid with respect to TextDetectionGeometry
   */
  public static TextDetectionGeometry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextDetectionGeometry.class);
  }

  /**
   * Convert an instance of TextDetectionGeometry to an JSON string
   *
   * @return JSON string
   */
