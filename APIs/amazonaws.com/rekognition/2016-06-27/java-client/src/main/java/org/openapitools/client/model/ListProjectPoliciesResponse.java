...
public class ListProjectPoliciesResponse {
  public static final String SERIALIZED_NAME_PROJECT_POLICIES = "ProjectPolicies";
  @SerializedName(SERIALIZED_NAME_PROJECT_POLICIES)
  private List projectPolicies;
  ...
  public ListProjectPoliciesResponse projectPolicies(List projectPolicies) {
  ...
  public List getProjectPolicies() {
    return projectPolicies;
  }

  public void setProjectPolicies(List projectPolicies) {
    this.projectPolicies = projectPolicies;
  }


  public ListProjectPoliciesResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListProjectPoliciesResponse listProjectPoliciesResponse = (ListProjectPoliciesResponse) o;
    return Objects.equals(this.projectPolicies, listProjectPoliciesResponse.projectPolicies) &&
        Objects.equals(this.nextToken, listProjectPoliciesResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectPolicies, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListProjectPoliciesResponse {\n");
    sb.append("    projectPolicies: ").append(toIndentedString(projectPolicies)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ProjectPolicies");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListProjectPoliciesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListProjectPoliciesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProjectPoliciesResponse is not found in the empty JSON string", ListProjectPoliciesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListProjectPoliciesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListProjectPoliciesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ProjectPolicies`
      if (jsonObj.get("ProjectPolicies") != null && !jsonObj.get("ProjectPolicies").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ProjectPolicies"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProjectPoliciesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProjectPoliciesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProjectPoliciesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProjectPoliciesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProjectPoliciesResponse>() {
           @Override
           public void write(JsonWriter out, ListProjectPoliciesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListProjectPoliciesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListProjectPoliciesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListProjectPoliciesResponse
   * @throws IOException if the JSON string is invalid with respect to ListProjectPoliciesResponse
   */
  public static ListProjectPoliciesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProjectPoliciesResponse.class);
  }

  /**
   * Convert an instance of ListProjectPoliciesResponse to an JSON string
   *
   * @return JSON string
   */
