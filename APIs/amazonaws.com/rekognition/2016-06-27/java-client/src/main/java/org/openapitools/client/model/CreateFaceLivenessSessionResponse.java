...
public class CreateFaceLivenessSessionResponse {
  ...
  public CreateFaceLivenessSessionResponse() {
  }

  public CreateFaceLivenessSessionResponse sessionId(String sessionId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFaceLivenessSessionResponse createFaceLivenessSessionResponse = (CreateFaceLivenessSessionResponse) o;
    return Objects.equals(this.sessionId, createFaceLivenessSessionResponse.sessionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFaceLivenessSessionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFaceLivenessSessionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFaceLivenessSessionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFaceLivenessSessionResponse is not found in the empty JSON string", CreateFaceLivenessSessionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFaceLivenessSessionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFaceLivenessSessionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFaceLivenessSessionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFaceLivenessSessionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFaceLivenessSessionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFaceLivenessSessionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFaceLivenessSessionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFaceLivenessSessionResponse>() {
           @Override
           public void write(JsonWriter out, CreateFaceLivenessSessionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFaceLivenessSessionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFaceLivenessSessionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFaceLivenessSessionResponse
   * @throws IOException if the JSON string is invalid with respect to CreateFaceLivenessSessionResponse
   */
  public static CreateFaceLivenessSessionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFaceLivenessSessionResponse.class);
  }

  /**
   * Convert an instance of CreateFaceLivenessSessionResponse to an JSON string
   *
   * @return JSON string
   */
