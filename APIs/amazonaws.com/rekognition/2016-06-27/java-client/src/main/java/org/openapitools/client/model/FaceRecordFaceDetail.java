...
public class FaceRecordFaceDetail {
  ...
  public FaceRecordFaceDetail() {
  }

  public FaceRecordFaceDetail boundingBox(FaceDetailBoundingBox boundingBox) {
  ...
  public FaceRecordFaceDetail ageRange(FaceDetailAgeRange ageRange) {
  ...
  public FaceRecordFaceDetail smile(FaceDetailSmile smile) {
    this.smile = smile;
    return this;
  }
  ...
  public FaceRecordFaceDetail eyeglasses(FaceDetailEyeglasses eyeglasses) {
  ...
  public FaceRecordFaceDetail sunglasses(FaceDetailSunglasses sunglasses) {
  ...
  public FaceRecordFaceDetail gender(FaceDetailGender gender) {
    this.gender = gender;
    return this;
  }
  ...
  public FaceRecordFaceDetail beard(FaceDetailBeard beard) {
    this.beard = beard;
    return this;
  }
  ...
  public FaceRecordFaceDetail mustache(FaceDetailMustache mustache) {
  ...
  public FaceRecordFaceDetail eyesOpen(FaceDetailEyesOpen eyesOpen) {
  ...
  public FaceRecordFaceDetail mouthOpen(FaceDetailMouthOpen mouthOpen) {
  ...
  public FaceRecordFaceDetail emotions(List emotions) {
  ...
  public FaceRecordFaceDetail landmarks(List landmarks) {
  ...
  public FaceRecordFaceDetail pose(FaceDetailPose pose) {
    this.pose = pose;
    return this;
  }
  ...
  public FaceRecordFaceDetail quality(FaceDetailQuality quality) {
  ...
  public FaceRecordFaceDetail confidence(Float confidence) {
  ...
  public FaceRecordFaceDetail faceOccluded(FaceDetailFaceOccluded faceOccluded) {
  ...
  public FaceRecordFaceDetail eyeDirection(FaceDetailEyeDirection eyeDirection) {
  ...
  public boolean equals(Object o) {
    ...
    FaceRecordFaceDetail faceRecordFaceDetail = (FaceRecordFaceDetail) o;
    return Objects.equals(this.boundingBox, faceRecordFaceDetail.boundingBox) &&
        Objects.equals(this.ageRange, faceRecordFaceDetail.ageRange) &&
        Objects.equals(this.smile, faceRecordFaceDetail.smile) &&
        Objects.equals(this.eyeglasses, faceRecordFaceDetail.eyeglasses) &&
        Objects.equals(this.sunglasses, faceRecordFaceDetail.sunglasses) &&
        Objects.equals(this.gender, faceRecordFaceDetail.gender) &&
        Objects.equals(this.beard, faceRecordFaceDetail.beard) &&
        Objects.equals(this.mustache, faceRecordFaceDetail.mustache) &&
        Objects.equals(this.eyesOpen, faceRecordFaceDetail.eyesOpen) &&
        Objects.equals(this.mouthOpen, faceRecordFaceDetail.mouthOpen) &&
        Objects.equals(this.emotions, faceRecordFaceDetail.emotions) &&
        Objects.equals(this.landmarks, faceRecordFaceDetail.landmarks) &&
        Objects.equals(this.pose, faceRecordFaceDetail.pose) &&
        Objects.equals(this.quality, faceRecordFaceDetail.quality) &&
        Objects.equals(this.confidence, faceRecordFaceDetail.confidence) &&
        Objects.equals(this.faceOccluded, faceRecordFaceDetail.faceOccluded) &&
        Objects.equals(this.eyeDirection, faceRecordFaceDetail.eyeDirection);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceRecordFaceDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceRecordFaceDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceRecordFaceDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceRecordFaceDetail is not found in the empty JSON string", FaceRecordFaceDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceRecordFaceDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceRecordFaceDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceRecordFaceDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceRecordFaceDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceRecordFaceDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceRecordFaceDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceRecordFaceDetail>() {
           @Override
           public void write(JsonWriter out, FaceRecordFaceDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceRecordFaceDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceRecordFaceDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceRecordFaceDetail
   * @throws IOException if the JSON string is invalid with respect to FaceRecordFaceDetail
   */
  public static FaceRecordFaceDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceRecordFaceDetail.class);
  }

  /**
   * Convert an instance of FaceRecordFaceDetail to an JSON string
   *
   * @return JSON string
   */
