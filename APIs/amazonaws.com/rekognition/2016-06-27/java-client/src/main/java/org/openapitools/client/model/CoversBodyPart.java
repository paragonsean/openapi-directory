...
public class CoversBodyPart {
  ...
  public CoversBodyPart confidence(Float confidence) {
  ...
  public CoversBodyPart value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CoversBodyPart coversBodyPart = (CoversBodyPart) o;
    return Objects.equals(this.confidence, coversBodyPart.confidence) &&
        Objects.equals(this.value, coversBodyPart.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoversBodyPart {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CoversBodyPart
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoversBodyPart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoversBodyPart is not found in the empty JSON string", CoversBodyPart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CoversBodyPart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CoversBodyPart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoversBodyPart.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoversBodyPart' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoversBodyPart> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoversBodyPart.class));

       return (TypeAdapter<T>) new TypeAdapter<CoversBodyPart>() {
           @Override
           public void write(JsonWriter out, CoversBodyPart value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CoversBodyPart read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CoversBodyPart given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CoversBodyPart
   * @throws IOException if the JSON string is invalid with respect to CoversBodyPart
   */
  public static CoversBodyPart fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoversBodyPart.class);
  }

  /**
   * Convert an instance of CoversBodyPart to an JSON string
   *
   * @return JSON string
   */
