...
/**
 * Gets or Sets QualityFilter
 */
@JsonAdapter(QualityFilter.Adapter.class)
public enum QualityFilter {
  ...
  public static QualityFilter fromValue(String value) {
    for (QualityFilter b : QualityFilter.values()) {
  ...
  public static class Adapter extends TypeAdapter<QualityFilter> {
    @Override
    public void write(final JsonWriter jsonWriter, final QualityFilter enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public QualityFilter read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return QualityFilter.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    QualityFilter.fromValue(value);
  }
}
