...
public class LabelDetectionSettings {
  ...
  public LabelDetectionSettings generalLabels(GeneralLabelsSettings generalLabels) {
  ...
  public boolean equals(Object o) {
    ...
    LabelDetectionSettings labelDetectionSettings = (LabelDetectionSettings) o;
    return Objects.equals(this.generalLabels, labelDetectionSettings.generalLabels);
  }
  ...
  public String toString() {
    ...
    sb.append("class LabelDetectionSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabelDetectionSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabelDetectionSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabelDetectionSettings is not found in the empty JSON string", LabelDetectionSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabelDetectionSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabelDetectionSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabelDetectionSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabelDetectionSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabelDetectionSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabelDetectionSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<LabelDetectionSettings>() {
           @Override
           public void write(JsonWriter out, LabelDetectionSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabelDetectionSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabelDetectionSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabelDetectionSettings
   * @throws IOException if the JSON string is invalid with respect to LabelDetectionSettings
   */
  public static LabelDetectionSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabelDetectionSettings.class);
  }

  /**
   * Convert an instance of LabelDetectionSettings to an JSON string
   *
   * @return JSON string
   */
