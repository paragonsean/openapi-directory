...
public class UpdateDatasetEntriesRequestChanges {
  public static final String SERIALIZED_NAME_GROUND_TRUTH = "GroundTruth";
  @SerializedName(SERIALIZED_NAME_GROUND_TRUTH)
  private String groundTruth;

  public UpdateDatasetEntriesRequestChanges() {
  }

  public UpdateDatasetEntriesRequestChanges groundTruth(String groundTruth) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDatasetEntriesRequestChanges updateDatasetEntriesRequestChanges = (UpdateDatasetEntriesRequestChanges) o;
    return Objects.equals(this.groundTruth, updateDatasetEntriesRequestChanges.groundTruth);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDatasetEntriesRequestChanges {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("GroundTruth");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDatasetEntriesRequestChanges
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDatasetEntriesRequestChanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDatasetEntriesRequestChanges is not found in the empty JSON string", UpdateDatasetEntriesRequestChanges.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDatasetEntriesRequestChanges.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDatasetEntriesRequestChanges` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDatasetEntriesRequestChanges.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `GroundTruth`
      String.validateJsonElement(jsonObj.get("GroundTruth"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDatasetEntriesRequestChanges.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDatasetEntriesRequestChanges' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDatasetEntriesRequestChanges> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDatasetEntriesRequestChanges.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDatasetEntriesRequestChanges>() {
           @Override
           public void write(JsonWriter out, UpdateDatasetEntriesRequestChanges value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDatasetEntriesRequestChanges read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDatasetEntriesRequestChanges given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDatasetEntriesRequestChanges
   * @throws IOException if the JSON string is invalid with respect to UpdateDatasetEntriesRequestChanges
   */
  public static UpdateDatasetEntriesRequestChanges fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDatasetEntriesRequestChanges.class);
  }

  /**
   * Convert an instance of UpdateDatasetEntriesRequestChanges to an JSON string
   *
   * @return JSON string
   */
