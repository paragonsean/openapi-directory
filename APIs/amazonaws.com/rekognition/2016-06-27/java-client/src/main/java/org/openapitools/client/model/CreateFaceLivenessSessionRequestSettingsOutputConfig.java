...
/**
 * CreateFaceLivenessSessionRequestSettingsOutputConfig
 */
...
public class CreateFaceLivenessSessionRequestSettingsOutputConfig {
  ...
  public CreateFaceLivenessSessionRequestSettingsOutputConfig() {
  }

  public CreateFaceLivenessSessionRequestSettingsOutputConfig s3Bucket(String s3Bucket) {
  ...
  public CreateFaceLivenessSessionRequestSettingsOutputConfig s3KeyPrefix(String s3KeyPrefix) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFaceLivenessSessionRequestSettingsOutputConfig createFaceLivenessSessionRequestSettingsOutputConfig = (CreateFaceLivenessSessionRequestSettingsOutputConfig) o;
    return Objects.equals(this.s3Bucket, createFaceLivenessSessionRequestSettingsOutputConfig.s3Bucket) &&
        Objects.equals(this.s3KeyPrefix, createFaceLivenessSessionRequestSettingsOutputConfig.s3KeyPrefix);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFaceLivenessSessionRequestSettingsOutputConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFaceLivenessSessionRequestSettingsOutputConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFaceLivenessSessionRequestSettingsOutputConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFaceLivenessSessionRequestSettingsOutputConfig is not found in the empty JSON string", CreateFaceLivenessSessionRequestSettingsOutputConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFaceLivenessSessionRequestSettingsOutputConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFaceLivenessSessionRequestSettingsOutputConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFaceLivenessSessionRequestSettingsOutputConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFaceLivenessSessionRequestSettingsOutputConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFaceLivenessSessionRequestSettingsOutputConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFaceLivenessSessionRequestSettingsOutputConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFaceLivenessSessionRequestSettingsOutputConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFaceLivenessSessionRequestSettingsOutputConfig>() {
           @Override
           public void write(JsonWriter out, CreateFaceLivenessSessionRequestSettingsOutputConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFaceLivenessSessionRequestSettingsOutputConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFaceLivenessSessionRequestSettingsOutputConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFaceLivenessSessionRequestSettingsOutputConfig
   * @throws IOException if the JSON string is invalid with respect to CreateFaceLivenessSessionRequestSettingsOutputConfig
   */
  public static CreateFaceLivenessSessionRequestSettingsOutputConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFaceLivenessSessionRequestSettingsOutputConfig.class);
  }

  /**
   * Convert an instance of CreateFaceLivenessSessionRequestSettingsOutputConfig to an JSON string
   *
   * @return JSON string
   */
