...
public class SearchedFace {
  ...
  public SearchedFace faceId(String faceId) {
    this.faceId = faceId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchedFace searchedFace = (SearchedFace) o;
    return Objects.equals(this.faceId, searchedFace.faceId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchedFace
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchedFace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchedFace is not found in the empty JSON string", SearchedFace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchedFace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchedFace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchedFace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchedFace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchedFace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchedFace.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchedFace>() {
           @Override
           public void write(JsonWriter out, SearchedFace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchedFace read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchedFace given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchedFace
   * @throws IOException if the JSON string is invalid with respect to SearchedFace
   */
  public static SearchedFace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchedFace.class);
  }

  /**
   * Convert an instance of SearchedFace to an JSON string
   *
   * @return JSON string
   */
