...
import org.openapitools.client.model.CopyProjectVersionRequestOutputConfig;
...
public class CopyProjectVersionRequest {
  public static final String SERIALIZED_NAME_SOURCE_PROJECT_ARN = "SourceProjectArn";
  @SerializedName(SERIALIZED_NAME_SOURCE_PROJECT_ARN)
  ...
  public static final String SERIALIZED_NAME_DESTINATION_PROJECT_ARN = "DestinationProjectArn";
  @SerializedName(SERIALIZED_NAME_DESTINATION_PROJECT_ARN)
  ...
  private CopyProjectVersionRequestOutputConfig outputConfig;
  ...
  public CopyProjectVersionRequest() {
  }

  public CopyProjectVersionRequest sourceProjectArn(String sourceProjectArn) {
    this.sourceProjectArn = sourceProjectArn;
    return this;
  }

  /**
   * Get sourceProjectArn
  ...
  public CopyProjectVersionRequest sourceProjectVersionArn(String sourceProjectVersionArn) {
  ...
  public CopyProjectVersionRequest destinationProjectArn(String destinationProjectArn) {
    this.destinationProjectArn = destinationProjectArn;
    return this;
  }

  /**
   * Get destinationProjectArn
  ...
  public CopyProjectVersionRequest versionName(String versionName) {
  ...
  public CopyProjectVersionRequest outputConfig(CopyProjectVersionRequestOutputConfig outputConfig) {
   ...
   */
  @javax.annotation.Nonnull
  public CopyProjectVersionRequestOutputConfig getOutputConfig() {
    return outputConfig;
  }

  public void setOutputConfig(CopyProjectVersionRequestOutputConfig outputConfig) {
    this.outputConfig = outputConfig;
  }


  public CopyProjectVersionRequest tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CopyProjectVersionRequest kmsKeyId(String kmsKeyId) {
  ...
  public boolean equals(Object o) {
    ...
    CopyProjectVersionRequest copyProjectVersionRequest = (CopyProjectVersionRequest) o;
    return Objects.equals(this.sourceProjectArn, copyProjectVersionRequest.sourceProjectArn) &&
        Objects.equals(this.sourceProjectVersionArn, copyProjectVersionRequest.sourceProjectVersionArn) &&
        Objects.equals(this.destinationProjectArn, copyProjectVersionRequest.destinationProjectArn) &&
        Objects.equals(this.versionName, copyProjectVersionRequest.versionName) &&
        Objects.equals(this.outputConfig, copyProjectVersionRequest.outputConfig) &&
        Objects.equals(this.tags, copyProjectVersionRequest.tags) &&
        Objects.equals(this.kmsKeyId, copyProjectVersionRequest.kmsKeyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceProjectArn, sourceProjectVersionArn, destinationProjectArn, versionName, outputConfig, tags, kmsKeyId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CopyProjectVersionRequest {\n");
    sb.append("    sourceProjectArn: ").append(toIndentedString(sourceProjectArn)).append("\n");
    sb.append("    sourceProjectVersionArn: ").append(toIndentedString(sourceProjectVersionArn)).append("\n");
    sb.append("    destinationProjectArn: ").append(toIndentedString(destinationProjectArn)).append("\n");
  ...
  static {
    ...
    openapiFields.add("SourceProjectArn");
    openapiFields.add("SourceProjectVersionArn");
    openapiFields.add("DestinationProjectArn");
    ...
    openapiRequiredFields.add("SourceProjectArn");
    openapiRequiredFields.add("SourceProjectVersionArn");
    openapiRequiredFields.add("DestinationProjectArn");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyProjectVersionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyProjectVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyProjectVersionRequest is not found in the empty JSON string", CopyProjectVersionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyProjectVersionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyProjectVersionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopyProjectVersionRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `SourceProjectArn`
      String.validateJsonElement(jsonObj.get("SourceProjectArn"));
      // validate the required field `SourceProjectVersionArn`
      String.validateJsonElement(jsonObj.get("SourceProjectVersionArn"));
      // validate the required field `DestinationProjectArn`
      String.validateJsonElement(jsonObj.get("DestinationProjectArn"));
      ...
      CopyProjectVersionRequestOutputConfig.validateJsonElement(jsonObj.get("OutputConfig"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyProjectVersionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyProjectVersionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyProjectVersionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyProjectVersionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyProjectVersionRequest>() {
           @Override
           public void write(JsonWriter out, CopyProjectVersionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyProjectVersionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyProjectVersionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyProjectVersionRequest
   * @throws IOException if the JSON string is invalid with respect to CopyProjectVersionRequest
   */
  public static CopyProjectVersionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyProjectVersionRequest.class);
  }

  /**
   * Convert an instance of CopyProjectVersionRequest to an JSON string
   *
   * @return JSON string
   */
