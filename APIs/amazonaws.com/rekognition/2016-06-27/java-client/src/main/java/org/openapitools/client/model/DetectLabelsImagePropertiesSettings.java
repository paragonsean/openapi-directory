...
public class DetectLabelsImagePropertiesSettings {
  ...
  public DetectLabelsImagePropertiesSettings maxDominantColors(Integer maxDominantColors) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImagePropertiesSettings detectLabelsImagePropertiesSettings = (DetectLabelsImagePropertiesSettings) o;
    return Objects.equals(this.maxDominantColors, detectLabelsImagePropertiesSettings.maxDominantColors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsImagePropertiesSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImagePropertiesSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImagePropertiesSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImagePropertiesSettings is not found in the empty JSON string", DetectLabelsImagePropertiesSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImagePropertiesSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImagePropertiesSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImagePropertiesSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImagePropertiesSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImagePropertiesSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImagePropertiesSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImagePropertiesSettings>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImagePropertiesSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImagePropertiesSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImagePropertiesSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImagePropertiesSettings
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImagePropertiesSettings
   */
  public static DetectLabelsImagePropertiesSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImagePropertiesSettings.class);
  }

  /**
   * Convert an instance of DetectLabelsImagePropertiesSettings to an JSON string
   *
   * @return JSON string
   */
