...
import org.openapitools.client.model.GenderType;
...
public class FaceDetailGender {
  ...
  public FaceDetailGender() {
  }

  public FaceDetailGender value(GenderType value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailGender confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailGender faceDetailGender = (FaceDetailGender) o;
    return Objects.equals(this.value, faceDetailGender.value) &&
        Objects.equals(this.confidence, faceDetailGender.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailGender {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailGender
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailGender.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailGender is not found in the empty JSON string", FaceDetailGender.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailGender.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailGender` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Value`
      if (jsonObj.get("Value") != null && !jsonObj.get("Value").isJsonNull()) {
        GenderType.validateJsonElement(jsonObj.get("Value"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailGender.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailGender' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailGender> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailGender.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailGender>() {
           @Override
           public void write(JsonWriter out, FaceDetailGender value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailGender read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailGender given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailGender
   * @throws IOException if the JSON string is invalid with respect to FaceDetailGender
   */
  public static FaceDetailGender fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailGender.class);
  }

  /**
   * Convert an instance of FaceDetailGender to an JSON string
   *
   * @return JSON string
   */
