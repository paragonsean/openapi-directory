...
public class SearchedUser {
  ...
  public SearchedUser userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchedUser searchedUser = (SearchedUser) o;
    return Objects.equals(this.userId, searchedUser.userId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchedUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchedUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchedUser is not found in the empty JSON string", SearchedUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchedUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchedUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchedUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchedUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchedUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchedUser.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchedUser>() {
           @Override
           public void write(JsonWriter out, SearchedUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchedUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchedUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchedUser
   * @throws IOException if the JSON string is invalid with respect to SearchedUser
   */
  public static SearchedUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchedUser.class);
  }

  /**
   * Convert an instance of SearchedUser to an JSON string
   *
   * @return JSON string
   */
