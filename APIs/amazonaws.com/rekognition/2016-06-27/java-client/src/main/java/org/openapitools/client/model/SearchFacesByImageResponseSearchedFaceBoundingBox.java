...
/**
 * SearchFacesByImageResponseSearchedFaceBoundingBox
 */
...
public class SearchFacesByImageResponseSearchedFaceBoundingBox {
  ...
  public SearchFacesByImageResponseSearchedFaceBoundingBox() {
  }

  public SearchFacesByImageResponseSearchedFaceBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public SearchFacesByImageResponseSearchedFaceBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public SearchFacesByImageResponseSearchedFaceBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public SearchFacesByImageResponseSearchedFaceBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchFacesByImageResponseSearchedFaceBoundingBox searchFacesByImageResponseSearchedFaceBoundingBox = (SearchFacesByImageResponseSearchedFaceBoundingBox) o;
    return Objects.equals(this.width, searchFacesByImageResponseSearchedFaceBoundingBox.width) &&
        Objects.equals(this.height, searchFacesByImageResponseSearchedFaceBoundingBox.height) &&
        Objects.equals(this.left, searchFacesByImageResponseSearchedFaceBoundingBox.left) &&
        Objects.equals(this.top, searchFacesByImageResponseSearchedFaceBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchFacesByImageResponseSearchedFaceBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchFacesByImageResponseSearchedFaceBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchFacesByImageResponseSearchedFaceBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchFacesByImageResponseSearchedFaceBoundingBox is not found in the empty JSON string", SearchFacesByImageResponseSearchedFaceBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchFacesByImageResponseSearchedFaceBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchFacesByImageResponseSearchedFaceBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchFacesByImageResponseSearchedFaceBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchFacesByImageResponseSearchedFaceBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchFacesByImageResponseSearchedFaceBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchFacesByImageResponseSearchedFaceBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchFacesByImageResponseSearchedFaceBoundingBox>() {
           @Override
           public void write(JsonWriter out, SearchFacesByImageResponseSearchedFaceBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchFacesByImageResponseSearchedFaceBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchFacesByImageResponseSearchedFaceBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchFacesByImageResponseSearchedFaceBoundingBox
   * @throws IOException if the JSON string is invalid with respect to SearchFacesByImageResponseSearchedFaceBoundingBox
   */
  public static SearchFacesByImageResponseSearchedFaceBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchFacesByImageResponseSearchedFaceBoundingBox.class);
  }

  /**
   * Convert an instance of SearchFacesByImageResponseSearchedFaceBoundingBox to an JSON string
   *
   * @return JSON string
   */
