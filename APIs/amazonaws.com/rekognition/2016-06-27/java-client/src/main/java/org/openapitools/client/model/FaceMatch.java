...
import org.openapitools.client.model.FaceMatchFace;
...
public class FaceMatch {
  ...
  private FaceMatchFace face;

  public FaceMatch() {
  }

  public FaceMatch similarity(Float similarity) {
  ...
  public FaceMatch face(FaceMatchFace face) {
    this.face = face;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public FaceMatchFace getFace() {
    return face;
  }

  public void setFace(FaceMatchFace face) {
    this.face = face;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.similarity, faceMatch.similarity) &&
        Objects.equals(this.face, faceMatch.face);
  }

  @Override
  public int hashCode() {
    return Objects.hash(similarity, face);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceMatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceMatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceMatch is not found in the empty JSON string", FaceMatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceMatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceMatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Face") != null && !jsonObj.get("Face").isJsonNull()) {
        FaceMatchFace.validateJsonElement(jsonObj.get("Face"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceMatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceMatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceMatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceMatch.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceMatch>() {
           @Override
           public void write(JsonWriter out, FaceMatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceMatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceMatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceMatch
   * @throws IOException if the JSON string is invalid with respect to FaceMatch
   */
  public static FaceMatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceMatch.class);
  }

  /**
   * Convert an instance of FaceMatch to an JSON string
   *
   * @return JSON string
   */
