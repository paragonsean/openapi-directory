...
/**
 * Gets or Sets ContentModerationAggregateBy
 */
@JsonAdapter(ContentModerationAggregateBy.Adapter.class)
public enum ContentModerationAggregateBy {
  ...
  ContentModerationAggregateBy(String value) {
    this.value = value;
  }
  ...
  public static ContentModerationAggregateBy fromValue(String value) {
    for (ContentModerationAggregateBy b : ContentModerationAggregateBy.values()) {
  ...
  public static class Adapter extends TypeAdapter<ContentModerationAggregateBy> {
    @Override
    public void write(final JsonWriter jsonWriter, final ContentModerationAggregateBy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ContentModerationAggregateBy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ContentModerationAggregateBy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ContentModerationAggregateBy.fromValue(value);
  }
}
