...
import org.openapitools.client.model.GetCelebrityInfoResponseKnownGender;
...
public class GetCelebrityInfoResponse {
  ...
  public static final String SERIALIZED_NAME_KNOWN_GENDER = "KnownGender";
  @SerializedName(SERIALIZED_NAME_KNOWN_GENDER)
  private GetCelebrityInfoResponseKnownGender knownGender;

  public GetCelebrityInfoResponse() {
  }

  public GetCelebrityInfoResponse urls(List urls) {
    this.urls = urls;
    return this;
  }
  ...
  public GetCelebrityInfoResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetCelebrityInfoResponse knownGender(GetCelebrityInfoResponseKnownGender knownGender) {
   ...
   */
  @javax.annotation.Nullable
  public GetCelebrityInfoResponseKnownGender getKnownGender() {
    return knownGender;
  }

  public void setKnownGender(GetCelebrityInfoResponseKnownGender knownGender) {
    this.knownGender = knownGender;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCelebrityInfoResponse getCelebrityInfoResponse = (GetCelebrityInfoResponse) o;
    return Objects.equals(this.urls, getCelebrityInfoResponse.urls) &&
        Objects.equals(this.name, getCelebrityInfoResponse.name) &&
        Objects.equals(this.knownGender, getCelebrityInfoResponse.knownGender);
  }

  @Override
  public int hashCode() {
    return Objects.hash(urls, name, knownGender);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCelebrityInfoResponse {\n");
    sb.append("    urls: ").append(toIndentedString(urls)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    knownGender: ").append(toIndentedString(knownGender)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCelebrityInfoResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCelebrityInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCelebrityInfoResponse is not found in the empty JSON string", GetCelebrityInfoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCelebrityInfoResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCelebrityInfoResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `KnownGender`
      if (jsonObj.get("KnownGender") != null && !jsonObj.get("KnownGender").isJsonNull()) {
        GetCelebrityInfoResponseKnownGender.validateJsonElement(jsonObj.get("KnownGender"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCelebrityInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCelebrityInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCelebrityInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCelebrityInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCelebrityInfoResponse>() {
           @Override
           public void write(JsonWriter out, GetCelebrityInfoResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCelebrityInfoResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCelebrityInfoResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCelebrityInfoResponse
   * @throws IOException if the JSON string is invalid with respect to GetCelebrityInfoResponse
   */
  public static GetCelebrityInfoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCelebrityInfoResponse.class);
  }

  /**
   * Convert an instance of GetCelebrityInfoResponse to an JSON string
   *
   * @return JSON string
   */
