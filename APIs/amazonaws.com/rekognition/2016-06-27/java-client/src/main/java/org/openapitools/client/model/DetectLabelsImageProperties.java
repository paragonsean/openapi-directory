...
public class DetectLabelsImageProperties {
  ...
  private DetectLabelsImagePropertiesQuality quality;
  ...
  private DetectLabelsImagePropertiesForeground foreground;

  public static final String SERIALIZED_NAME_BACKGROUND = "Background";
  @SerializedName(SERIALIZED_NAME_BACKGROUND)
  private DetectLabelsImagePropertiesBackground background;

  public DetectLabelsImageProperties() {
  }

  public DetectLabelsImageProperties quality(DetectLabelsImagePropertiesQuality quality) {
  ...
  public DetectLabelsImagePropertiesQuality getQuality() {
    return quality;
  }

  public void setQuality(DetectLabelsImagePropertiesQuality quality) {
    this.quality = quality;
  }


  public DetectLabelsImageProperties dominantColors(List dominantColors) {
  ...
  public DetectLabelsImageProperties foreground(DetectLabelsImagePropertiesForeground foreground) {
   ...
   */
  @javax.annotation.Nullable
  public DetectLabelsImagePropertiesForeground getForeground() {
    return foreground;
  }

  public void setForeground(DetectLabelsImagePropertiesForeground foreground) {
    this.foreground = foreground;
  }


  public DetectLabelsImageProperties background(DetectLabelsImagePropertiesBackground background) {
   ...
   */
  @javax.annotation.Nullable
  public DetectLabelsImagePropertiesBackground getBackground() {
    return background;
  }

  public void setBackground(DetectLabelsImagePropertiesBackground background) {
    this.background = background;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImageProperties detectLabelsImageProperties = (DetectLabelsImageProperties) o;
    return Objects.equals(this.quality, detectLabelsImageProperties.quality) &&
        Objects.equals(this.dominantColors, detectLabelsImageProperties.dominantColors) &&
        Objects.equals(this.foreground, detectLabelsImageProperties.foreground) &&
        Objects.equals(this.background, detectLabelsImageProperties.background);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quality, dominantColors, foreground, background);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectLabelsImageProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImageProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImageProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImageProperties is not found in the empty JSON string", DetectLabelsImageProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImageProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImageProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Quality`
      if (jsonObj.get("Quality") != null && !jsonObj.get("Quality").isJsonNull()) {
        DetectLabelsImagePropertiesQuality.validateJsonElement(jsonObj.get("Quality"));
      }
      ...
      if (jsonObj.get("Foreground") != null && !jsonObj.get("Foreground").isJsonNull()) {
        DetectLabelsImagePropertiesForeground.validateJsonElement(jsonObj.get("Foreground"));
      }
      // validate the optional field `Background`
      if (jsonObj.get("Background") != null && !jsonObj.get("Background").isJsonNull()) {
        DetectLabelsImagePropertiesBackground.validateJsonElement(jsonObj.get("Background"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImageProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImageProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImageProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImageProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImageProperties>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImageProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImageProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImageProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImageProperties
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImageProperties
   */
  public static DetectLabelsImageProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImageProperties.class);
  }

  /**
   * Convert an instance of DetectLabelsImageProperties to an JSON string
   *
   * @return JSON string
   */
