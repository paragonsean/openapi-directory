...
import org.openapitools.client.model.DetectLabelsImageForegroundQuality;
...
public class DetectLabelsImageForeground {
  ...
  private DetectLabelsImageForegroundQuality quality;

  public static final String SERIALIZED_NAME_DOMINANT_COLORS = "DominantColors";
  @SerializedName(SERIALIZED_NAME_DOMINANT_COLORS)
  private List dominantColors;

  public DetectLabelsImageForeground() {
  }

  public DetectLabelsImageForeground quality(DetectLabelsImageForegroundQuality quality) {
  ...
  public DetectLabelsImageForegroundQuality getQuality() {
    return quality;
  }

  public void setQuality(DetectLabelsImageForegroundQuality quality) {
    this.quality = quality;
  }


  public DetectLabelsImageForeground dominantColors(List dominantColors) {
   ...
   */
  @javax.annotation.Nullable
  public List getDominantColors() {
    return dominantColors;
  }

  public void setDominantColors(List dominantColors) {
    this.dominantColors = dominantColors;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImageForeground detectLabelsImageForeground = (DetectLabelsImageForeground) o;
    return Objects.equals(this.quality, detectLabelsImageForeground.quality) &&
        Objects.equals(this.dominantColors, detectLabelsImageForeground.dominantColors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quality, dominantColors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectLabelsImageForeground {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImageForeground
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImageForeground.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImageForeground is not found in the empty JSON string", DetectLabelsImageForeground.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImageForeground.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImageForeground` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Quality`
      if (jsonObj.get("Quality") != null && !jsonObj.get("Quality").isJsonNull()) {
        DetectLabelsImageForegroundQuality.validateJsonElement(jsonObj.get("Quality"));
      }
      // validate the optional field `DominantColors`
      if (jsonObj.get("DominantColors") != null && !jsonObj.get("DominantColors").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DominantColors"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImageForeground.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImageForeground' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImageForeground> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImageForeground.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImageForeground>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImageForeground value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImageForeground read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImageForeground given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImageForeground
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImageForeground
   */
  public static DetectLabelsImageForeground fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImageForeground.class);
  }

  /**
   * Convert an instance of DetectLabelsImageForeground to an JSON string
   *
   * @return JSON string
   */
