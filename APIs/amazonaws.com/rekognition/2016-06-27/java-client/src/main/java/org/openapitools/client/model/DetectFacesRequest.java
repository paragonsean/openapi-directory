...
public class DetectFacesRequest {
  ...
  public DetectFacesRequest image(CompareFacesRequestSourceImage image) {
    this.image = image;
    return this;
  }
  ...
  public DetectFacesRequest attributes(List attributes) {
  ...
  public boolean equals(Object o) {
    ...
    DetectFacesRequest detectFacesRequest = (DetectFacesRequest) o;
    return Objects.equals(this.image, detectFacesRequest.image) &&
        Objects.equals(this.attributes, detectFacesRequest.attributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(image, attributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectFacesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectFacesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectFacesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectFacesRequest is not found in the empty JSON string", DetectFacesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectFacesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectFacesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectFacesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectFacesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectFacesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectFacesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectFacesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectFacesRequest>() {
           @Override
           public void write(JsonWriter out, DetectFacesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectFacesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectFacesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectFacesRequest
   * @throws IOException if the JSON string is invalid with respect to DetectFacesRequest
   */
  public static DetectFacesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectFacesRequest.class);
  }

  /**
   * Convert an instance of DetectFacesRequest to an JSON string
   *
   * @return JSON string
   */
