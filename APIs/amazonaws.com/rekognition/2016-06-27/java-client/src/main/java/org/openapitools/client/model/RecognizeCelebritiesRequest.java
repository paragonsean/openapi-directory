...
public class RecognizeCelebritiesRequest {
  ...
  public RecognizeCelebritiesRequest() {
  }

  public RecognizeCelebritiesRequest image(CompareFacesRequestSourceImage image) {
    this.image = image;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RecognizeCelebritiesRequest recognizeCelebritiesRequest = (RecognizeCelebritiesRequest) o;
    return Objects.equals(this.image, recognizeCelebritiesRequest.image);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecognizeCelebritiesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecognizeCelebritiesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecognizeCelebritiesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecognizeCelebritiesRequest is not found in the empty JSON string", RecognizeCelebritiesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecognizeCelebritiesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecognizeCelebritiesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecognizeCelebritiesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecognizeCelebritiesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecognizeCelebritiesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecognizeCelebritiesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecognizeCelebritiesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RecognizeCelebritiesRequest>() {
           @Override
           public void write(JsonWriter out, RecognizeCelebritiesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecognizeCelebritiesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecognizeCelebritiesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecognizeCelebritiesRequest
   * @throws IOException if the JSON string is invalid with respect to RecognizeCelebritiesRequest
   */
  public static RecognizeCelebritiesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecognizeCelebritiesRequest.class);
  }

  /**
   * Convert an instance of RecognizeCelebritiesRequest to an JSON string
   *
   * @return JSON string
   */
