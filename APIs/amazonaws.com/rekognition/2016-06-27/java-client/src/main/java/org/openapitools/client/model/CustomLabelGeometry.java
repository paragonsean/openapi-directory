...
public class CustomLabelGeometry {
  ...
  public CustomLabelGeometry() {
  }

  public CustomLabelGeometry boundingBox(GeometryBoundingBox boundingBox) {
  ...
  public CustomLabelGeometry polygon(List polygon) {
  ...
  public boolean equals(Object o) {
    ...
    CustomLabelGeometry customLabelGeometry = (CustomLabelGeometry) o;
    return Objects.equals(this.boundingBox, customLabelGeometry.boundingBox) &&
        Objects.equals(this.polygon, customLabelGeometry.polygon);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomLabelGeometry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomLabelGeometry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomLabelGeometry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomLabelGeometry is not found in the empty JSON string", CustomLabelGeometry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomLabelGeometry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomLabelGeometry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomLabelGeometry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomLabelGeometry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomLabelGeometry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomLabelGeometry.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomLabelGeometry>() {
           @Override
           public void write(JsonWriter out, CustomLabelGeometry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomLabelGeometry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomLabelGeometry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomLabelGeometry
   * @throws IOException if the JSON string is invalid with respect to CustomLabelGeometry
   */
  public static CustomLabelGeometry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomLabelGeometry.class);
  }

  /**
   * Convert an instance of CustomLabelGeometry to an JSON string
   *
   * @return JSON string
   */
