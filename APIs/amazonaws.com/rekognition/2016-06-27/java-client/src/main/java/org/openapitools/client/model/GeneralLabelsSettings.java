...
public class GeneralLabelsSettings {
  ...
  public GeneralLabelsSettings labelInclusionFilters(List labelInclusionFilters) {
  ...
  public GeneralLabelsSettings labelExclusionFilters(List labelExclusionFilters) {
  ...
  public GeneralLabelsSettings labelCategoryInclusionFilters(List labelCategoryInclusionFilters) {
  ...
  public GeneralLabelsSettings labelCategoryExclusionFilters(List labelCategoryExclusionFilters) {
  ...
  public boolean equals(Object o) {
    ...
    GeneralLabelsSettings generalLabelsSettings = (GeneralLabelsSettings) o;
    return Objects.equals(this.labelInclusionFilters, generalLabelsSettings.labelInclusionFilters) &&
        Objects.equals(this.labelExclusionFilters, generalLabelsSettings.labelExclusionFilters) &&
        Objects.equals(this.labelCategoryInclusionFilters, generalLabelsSettings.labelCategoryInclusionFilters) &&
        Objects.equals(this.labelCategoryExclusionFilters, generalLabelsSettings.labelCategoryExclusionFilters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeneralLabelsSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GeneralLabelsSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GeneralLabelsSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GeneralLabelsSettings is not found in the empty JSON string", GeneralLabelsSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GeneralLabelsSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GeneralLabelsSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GeneralLabelsSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GeneralLabelsSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GeneralLabelsSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GeneralLabelsSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<GeneralLabelsSettings>() {
           @Override
           public void write(JsonWriter out, GeneralLabelsSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GeneralLabelsSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GeneralLabelsSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GeneralLabelsSettings
   * @throws IOException if the JSON string is invalid with respect to GeneralLabelsSettings
   */
  public static GeneralLabelsSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GeneralLabelsSettings.class);
  }

  /**
   * Convert an instance of GeneralLabelsSettings to an JSON string
   *
   * @return JSON string
   */
