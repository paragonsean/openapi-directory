...
public class ListProjectPoliciesRequest {
  ...
  public ListProjectPoliciesRequest() {
  }

  public ListProjectPoliciesRequest projectArn(String projectArn) {
  ...
  public ListProjectPoliciesRequest nextToken(String nextToken) {
  ...
  public ListProjectPoliciesRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListProjectPoliciesRequest listProjectPoliciesRequest = (ListProjectPoliciesRequest) o;
    return Objects.equals(this.projectArn, listProjectPoliciesRequest.projectArn) &&
        Objects.equals(this.nextToken, listProjectPoliciesRequest.nextToken) &&
        Objects.equals(this.maxResults, listProjectPoliciesRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectArn, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListProjectPoliciesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListProjectPoliciesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListProjectPoliciesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProjectPoliciesRequest is not found in the empty JSON string", ListProjectPoliciesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListProjectPoliciesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListProjectPoliciesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListProjectPoliciesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProjectPoliciesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProjectPoliciesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProjectPoliciesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProjectPoliciesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProjectPoliciesRequest>() {
           @Override
           public void write(JsonWriter out, ListProjectPoliciesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListProjectPoliciesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListProjectPoliciesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListProjectPoliciesRequest
   * @throws IOException if the JSON string is invalid with respect to ListProjectPoliciesRequest
   */
  public static ListProjectPoliciesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProjectPoliciesRequest.class);
  }

  /**
   * Convert an instance of ListProjectPoliciesRequest to an JSON string
   *
   * @return JSON string
   */
