...
public class FaceDetailMustache {
  ...
  public FaceDetailMustache() {
  }

  public FaceDetailMustache value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailMustache confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailMustache faceDetailMustache = (FaceDetailMustache) o;
    return Objects.equals(this.value, faceDetailMustache.value) &&
        Objects.equals(this.confidence, faceDetailMustache.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailMustache {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailMustache
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailMustache.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailMustache is not found in the empty JSON string", FaceDetailMustache.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailMustache.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailMustache` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailMustache.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailMustache' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailMustache> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailMustache.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailMustache>() {
           @Override
           public void write(JsonWriter out, FaceDetailMustache value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailMustache read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailMustache given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailMustache
   * @throws IOException if the JSON string is invalid with respect to FaceDetailMustache
   */
  public static FaceDetailMustache fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailMustache.class);
  }

  /**
   * Convert an instance of FaceDetailMustache to an JSON string
   *
   * @return JSON string
   */
