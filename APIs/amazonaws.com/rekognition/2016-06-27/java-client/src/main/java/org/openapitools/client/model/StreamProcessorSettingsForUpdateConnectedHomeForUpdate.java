...
/**
 * StreamProcessorSettingsForUpdateConnectedHomeForUpdate
 */
...
public class StreamProcessorSettingsForUpdateConnectedHomeForUpdate {
  ...
  public StreamProcessorSettingsForUpdateConnectedHomeForUpdate() {
  }

  public StreamProcessorSettingsForUpdateConnectedHomeForUpdate labels(List labels) {
    this.labels = labels;
    return this;
  }
  ...
  public StreamProcessorSettingsForUpdateConnectedHomeForUpdate minConfidence(Float minConfidence) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorSettingsForUpdateConnectedHomeForUpdate streamProcessorSettingsForUpdateConnectedHomeForUpdate = (StreamProcessorSettingsForUpdateConnectedHomeForUpdate) o;
    return Objects.equals(this.labels, streamProcessorSettingsForUpdateConnectedHomeForUpdate.labels) &&
        Objects.equals(this.minConfidence, streamProcessorSettingsForUpdateConnectedHomeForUpdate.minConfidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labels, minConfidence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamProcessorSettingsForUpdateConnectedHomeForUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorSettingsForUpdateConnectedHomeForUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorSettingsForUpdateConnectedHomeForUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorSettingsForUpdateConnectedHomeForUpdate is not found in the empty JSON string", StreamProcessorSettingsForUpdateConnectedHomeForUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorSettingsForUpdateConnectedHomeForUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorSettingsForUpdateConnectedHomeForUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorSettingsForUpdateConnectedHomeForUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorSettingsForUpdateConnectedHomeForUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorSettingsForUpdateConnectedHomeForUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorSettingsForUpdateConnectedHomeForUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorSettingsForUpdateConnectedHomeForUpdate>() {
           @Override
           public void write(JsonWriter out, StreamProcessorSettingsForUpdateConnectedHomeForUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorSettingsForUpdateConnectedHomeForUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorSettingsForUpdateConnectedHomeForUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorSettingsForUpdateConnectedHomeForUpdate
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorSettingsForUpdateConnectedHomeForUpdate
   */
  public static StreamProcessorSettingsForUpdateConnectedHomeForUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorSettingsForUpdateConnectedHomeForUpdate.class);
  }

  /**
   * Convert an instance of StreamProcessorSettingsForUpdateConnectedHomeForUpdate to an JSON string
   *
   * @return JSON string
   */
