...
public class StreamProcessorOutputKinesisDataStream {
  public static final String SERIALIZED_NAME_ARN = "Arn";
  @SerializedName(SERIALIZED_NAME_ARN)
  private String arn;

  public StreamProcessorOutputKinesisDataStream() {
  }

  public StreamProcessorOutputKinesisDataStream arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorOutputKinesisDataStream streamProcessorOutputKinesisDataStream = (StreamProcessorOutputKinesisDataStream) o;
    return Objects.equals(this.arn, streamProcessorOutputKinesisDataStream.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessorOutputKinesisDataStream {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorOutputKinesisDataStream
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorOutputKinesisDataStream.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorOutputKinesisDataStream is not found in the empty JSON string", StreamProcessorOutputKinesisDataStream.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorOutputKinesisDataStream.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorOutputKinesisDataStream` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorOutputKinesisDataStream.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorOutputKinesisDataStream' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorOutputKinesisDataStream> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorOutputKinesisDataStream.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorOutputKinesisDataStream>() {
           @Override
           public void write(JsonWriter out, StreamProcessorOutputKinesisDataStream value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorOutputKinesisDataStream read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorOutputKinesisDataStream given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorOutputKinesisDataStream
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorOutputKinesisDataStream
   */
  public static StreamProcessorOutputKinesisDataStream fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorOutputKinesisDataStream.class);
  }

  /**
   * Convert an instance of StreamProcessorOutputKinesisDataStream to an JSON string
   *
   * @return JSON string
   */
