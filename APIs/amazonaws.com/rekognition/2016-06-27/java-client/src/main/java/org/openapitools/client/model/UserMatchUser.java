...
public class UserMatchUser {
  ...
  public UserMatchUser() {
  }

  public UserMatchUser userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UserMatchUser userStatus(UserStatus userStatus) {
  ...
  public boolean equals(Object o) {
    ...
    UserMatchUser userMatchUser = (UserMatchUser) o;
    return Objects.equals(this.userId, userMatchUser.userId) &&
        Objects.equals(this.userStatus, userMatchUser.userStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserMatchUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserMatchUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserMatchUser is not found in the empty JSON string", UserMatchUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserMatchUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserMatchUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserMatchUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserMatchUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserMatchUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserMatchUser.class));

       return (TypeAdapter<T>) new TypeAdapter<UserMatchUser>() {
           @Override
           public void write(JsonWriter out, UserMatchUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserMatchUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserMatchUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserMatchUser
   * @throws IOException if the JSON string is invalid with respect to UserMatchUser
   */
  public static UserMatchUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserMatchUser.class);
  }

  /**
   * Convert an instance of UserMatchUser to an JSON string
   *
   * @return JSON string
   */
