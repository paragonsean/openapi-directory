...
public class TrainingDataResultValidation {
  public static final String SERIALIZED_NAME_ASSETS = "Assets";
  @SerializedName(SERIALIZED_NAME_ASSETS)
  private List assets;

  public TrainingDataResultValidation() {
  }

  public TrainingDataResultValidation assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrainingDataResultValidation trainingDataResultValidation = (TrainingDataResultValidation) o;
    return Objects.equals(this.assets, trainingDataResultValidation.assets);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingDataResultValidation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingDataResultValidation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingDataResultValidation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingDataResultValidation is not found in the empty JSON string", TrainingDataResultValidation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingDataResultValidation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingDataResultValidation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingDataResultValidation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingDataResultValidation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingDataResultValidation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingDataResultValidation.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingDataResultValidation>() {
           @Override
           public void write(JsonWriter out, TrainingDataResultValidation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingDataResultValidation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingDataResultValidation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingDataResultValidation
   * @throws IOException if the JSON string is invalid with respect to TrainingDataResultValidation
   */
  public static TrainingDataResultValidation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingDataResultValidation.class);
  }

  /**
   * Convert an instance of TrainingDataResultValidation to an JSON string
   *
   * @return JSON string
   */
