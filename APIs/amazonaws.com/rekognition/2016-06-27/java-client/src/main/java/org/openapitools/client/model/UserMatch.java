...
import org.openapitools.client.model.UserMatchUser;
...
public class UserMatch {
  ...
  private UserMatchUser user;

  public UserMatch() {
  }

  public UserMatch similarity(Float similarity) {
  ...
  public UserMatch user(UserMatchUser user) {
    this.user = user;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public UserMatchUser getUser() {
    return user;
  }

  public void setUser(UserMatchUser user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.similarity, userMatch.similarity) &&
        Objects.equals(this.user, userMatch.user);
  }

  @Override
  public int hashCode() {
    return Objects.hash(similarity, user);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserMatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserMatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserMatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserMatch is not found in the empty JSON string", UserMatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserMatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserMatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Similarity`
      if (jsonObj.get("Similarity") != null && !jsonObj.get("Similarity").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("Similarity"));
      }
      // validate the optional field `User`
      if (jsonObj.get("User") != null && !jsonObj.get("User").isJsonNull()) {
        UserMatchUser.validateJsonElement(jsonObj.get("User"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserMatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserMatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserMatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserMatch.class));

       return (TypeAdapter<T>) new TypeAdapter<UserMatch>() {
           @Override
           public void write(JsonWriter out, UserMatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserMatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserMatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserMatch
   * @throws IOException if the JSON string is invalid with respect to UserMatch
   */
  public static UserMatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserMatch.class);
  }

  /**
   * Convert an instance of UserMatch to an JSON string
   *
   * @return JSON string
   */
