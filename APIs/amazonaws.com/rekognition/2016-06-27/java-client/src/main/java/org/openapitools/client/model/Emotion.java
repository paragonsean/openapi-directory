...
import org.openapitools.client.model.EmotionName;
...
public class Emotion {
  ...
  public Emotion type(EmotionName type) {
    this.type = type;
    return this;
  }
  ...
  public Emotion confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, emotion.type) &&
        Objects.equals(this.confidence, emotion.confidence);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Type") != null && !jsonObj.get("Type").isJsonNull()) {
        EmotionName.validateJsonElement(jsonObj.get("Type"));
      }
