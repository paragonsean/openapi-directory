...
public class DescribeProjectVersionsRequest {
  ...
  public static final String SERIALIZED_NAME_VERSION_NAMES = "VersionNames";
  @SerializedName(SERIALIZED_NAME_VERSION_NAMES)
  private List versionNames;
  ...
  public DescribeProjectVersionsRequest() {
  }

  public DescribeProjectVersionsRequest projectArn(String projectArn) {
  ...
  public DescribeProjectVersionsRequest versionNames(List versionNames) {
  ...
  public void setVersionNames(List versionNames) {
    this.versionNames = versionNames;
  }


  public DescribeProjectVersionsRequest nextToken(String nextToken) {
  ...
  public DescribeProjectVersionsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeProjectVersionsRequest describeProjectVersionsRequest = (DescribeProjectVersionsRequest) o;
    return Objects.equals(this.projectArn, describeProjectVersionsRequest.projectArn) &&
        Objects.equals(this.versionNames, describeProjectVersionsRequest.versionNames) &&
        Objects.equals(this.nextToken, describeProjectVersionsRequest.nextToken) &&
        Objects.equals(this.maxResults, describeProjectVersionsRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectArn, versionNames, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeProjectVersionsRequest {\n");
    sb.append("    projectArn: ").append(toIndentedString(projectArn)).append("\n");
    sb.append("    versionNames: ").append(toIndentedString(versionNames)).append("\n");
  ...
  static {
    ...
    openapiFields.add("VersionNames");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeProjectVersionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeProjectVersionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeProjectVersionsRequest is not found in the empty JSON string", DescribeProjectVersionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeProjectVersionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeProjectVersionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeProjectVersionsRequest.openapiRequiredFields) {
      ...
      // validate the optional field `VersionNames`
      if (jsonObj.get("VersionNames") != null && !jsonObj.get("VersionNames").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("VersionNames"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeProjectVersionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeProjectVersionsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeProjectVersionsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeProjectVersionsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeProjectVersionsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeProjectVersionsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeProjectVersionsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeProjectVersionsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeProjectVersionsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeProjectVersionsRequest
   */
  public static DescribeProjectVersionsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeProjectVersionsRequest.class);
  }

  /**
   * Convert an instance of DescribeProjectVersionsRequest to an JSON string
   *
   * @return JSON string
   */
