...
public class FaceDetailBoundingBox {
  ...
  public FaceDetailBoundingBox() {
  }

  public FaceDetailBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public FaceDetailBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public FaceDetailBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public FaceDetailBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailBoundingBox faceDetailBoundingBox = (FaceDetailBoundingBox) o;
    return Objects.equals(this.width, faceDetailBoundingBox.width) &&
        Objects.equals(this.height, faceDetailBoundingBox.height) &&
        Objects.equals(this.left, faceDetailBoundingBox.left) &&
        Objects.equals(this.top, faceDetailBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailBoundingBox is not found in the empty JSON string", FaceDetailBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailBoundingBox>() {
           @Override
           public void write(JsonWriter out, FaceDetailBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailBoundingBox
   * @throws IOException if the JSON string is invalid with respect to FaceDetailBoundingBox
   */
  public static FaceDetailBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailBoundingBox.class);
  }

  /**
   * Convert an instance of FaceDetailBoundingBox to an JSON string
   *
   * @return JSON string
   */
