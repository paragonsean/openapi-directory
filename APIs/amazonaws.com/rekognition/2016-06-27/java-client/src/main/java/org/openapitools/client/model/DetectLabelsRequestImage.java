...
public class DetectLabelsRequestImage {
  ...
  public DetectLabelsRequestImage() {
  }

  public DetectLabelsRequestImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public DetectLabelsRequestImage s3Object(ImageS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsRequestImage detectLabelsRequestImage = (DetectLabelsRequestImage) o;
    return Objects.equals(this.bytes, detectLabelsRequestImage.bytes) &&
        Objects.equals(this.s3Object, detectLabelsRequestImage.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsRequestImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsRequestImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsRequestImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsRequestImage is not found in the empty JSON string", DetectLabelsRequestImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsRequestImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsRequestImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsRequestImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsRequestImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsRequestImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsRequestImage.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsRequestImage>() {
           @Override
           public void write(JsonWriter out, DetectLabelsRequestImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsRequestImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsRequestImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsRequestImage
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsRequestImage
   */
  public static DetectLabelsRequestImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsRequestImage.class);
  }

  /**
   * Convert an instance of DetectLabelsRequestImage to an JSON string
   *
   * @return JSON string
   */
