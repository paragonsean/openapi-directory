...
public class StreamProcessorSettingsForUpdate {
  ...
  public StreamProcessorSettingsForUpdate connectedHomeForUpdate(StreamProcessorSettingsForUpdateConnectedHomeForUpdate connectedHomeForUpdate) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorSettingsForUpdate streamProcessorSettingsForUpdate = (StreamProcessorSettingsForUpdate) o;
    return Objects.equals(this.connectedHomeForUpdate, streamProcessorSettingsForUpdate.connectedHomeForUpdate);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessorSettingsForUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorSettingsForUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorSettingsForUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorSettingsForUpdate is not found in the empty JSON string", StreamProcessorSettingsForUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorSettingsForUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorSettingsForUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorSettingsForUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorSettingsForUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorSettingsForUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorSettingsForUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorSettingsForUpdate>() {
           @Override
           public void write(JsonWriter out, StreamProcessorSettingsForUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorSettingsForUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorSettingsForUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorSettingsForUpdate
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorSettingsForUpdate
   */
  public static StreamProcessorSettingsForUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorSettingsForUpdate.class);
  }

  /**
   * Convert an instance of StreamProcessorSettingsForUpdate to an JSON string
   *
   * @return JSON string
   */
