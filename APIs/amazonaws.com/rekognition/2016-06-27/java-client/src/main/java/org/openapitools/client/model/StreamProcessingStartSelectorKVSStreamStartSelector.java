...
/**
 * StreamProcessingStartSelectorKVSStreamStartSelector
 */
...
public class StreamProcessingStartSelectorKVSStreamStartSelector {
  ...
  private Integer producerTimestamp;
  ...
  public StreamProcessingStartSelectorKVSStreamStartSelector() {
  }

  public StreamProcessingStartSelectorKVSStreamStartSelector producerTimestamp(Integer producerTimestamp) {
  ...
  public Integer getProducerTimestamp() {
    return producerTimestamp;
  }

  public void setProducerTimestamp(Integer producerTimestamp) {
    this.producerTimestamp = producerTimestamp;
  }


  public StreamProcessingStartSelectorKVSStreamStartSelector fragmentNumber(String fragmentNumber) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessingStartSelectorKVSStreamStartSelector streamProcessingStartSelectorKVSStreamStartSelector = (StreamProcessingStartSelectorKVSStreamStartSelector) o;
    return Objects.equals(this.producerTimestamp, streamProcessingStartSelectorKVSStreamStartSelector.producerTimestamp) &&
        Objects.equals(this.fragmentNumber, streamProcessingStartSelectorKVSStreamStartSelector.fragmentNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(producerTimestamp, fragmentNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamProcessingStartSelectorKVSStreamStartSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessingStartSelectorKVSStreamStartSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessingStartSelectorKVSStreamStartSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessingStartSelectorKVSStreamStartSelector is not found in the empty JSON string", StreamProcessingStartSelectorKVSStreamStartSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessingStartSelectorKVSStreamStartSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessingStartSelectorKVSStreamStartSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ProducerTimestamp") != null && !jsonObj.get("ProducerTimestamp").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("ProducerTimestamp"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessingStartSelectorKVSStreamStartSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessingStartSelectorKVSStreamStartSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessingStartSelectorKVSStreamStartSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessingStartSelectorKVSStreamStartSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessingStartSelectorKVSStreamStartSelector>() {
           @Override
           public void write(JsonWriter out, StreamProcessingStartSelectorKVSStreamStartSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessingStartSelectorKVSStreamStartSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessingStartSelectorKVSStreamStartSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessingStartSelectorKVSStreamStartSelector
   * @throws IOException if the JSON string is invalid with respect to StreamProcessingStartSelectorKVSStreamStartSelector
   */
  public static StreamProcessingStartSelectorKVSStreamStartSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessingStartSelectorKVSStreamStartSelector.class);
  }

  /**
   * Convert an instance of StreamProcessingStartSelectorKVSStreamStartSelector to an JSON string
   *
   * @return JSON string
   */
