...
import org.openapitools.client.model.VideoS3Object;
...
public class StartCelebrityRecognitionRequestVideo {
  public static final String SERIALIZED_NAME_S3_OBJECT = "S3Object";
  @SerializedName(SERIALIZED_NAME_S3_OBJECT)
  private VideoS3Object s3Object;

  public StartCelebrityRecognitionRequestVideo() {
  }

  public StartCelebrityRecognitionRequestVideo s3Object(VideoS3Object s3Object) {
  ...
  public VideoS3Object getS3Object() {
    return s3Object;
  }

  public void setS3Object(VideoS3Object s3Object) {
    this.s3Object = s3Object;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartCelebrityRecognitionRequestVideo startCelebrityRecognitionRequestVideo = (StartCelebrityRecognitionRequestVideo) o;
    return Objects.equals(this.s3Object, startCelebrityRecognitionRequestVideo.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartCelebrityRecognitionRequestVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartCelebrityRecognitionRequestVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartCelebrityRecognitionRequestVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartCelebrityRecognitionRequestVideo is not found in the empty JSON string", StartCelebrityRecognitionRequestVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartCelebrityRecognitionRequestVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartCelebrityRecognitionRequestVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `S3Object`
      if (jsonObj.get("S3Object") != null && !jsonObj.get("S3Object").isJsonNull()) {
        VideoS3Object.validateJsonElement(jsonObj.get("S3Object"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartCelebrityRecognitionRequestVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartCelebrityRecognitionRequestVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartCelebrityRecognitionRequestVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartCelebrityRecognitionRequestVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<StartCelebrityRecognitionRequestVideo>() {
           @Override
           public void write(JsonWriter out, StartCelebrityRecognitionRequestVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartCelebrityRecognitionRequestVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartCelebrityRecognitionRequestVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartCelebrityRecognitionRequestVideo
   * @throws IOException if the JSON string is invalid with respect to StartCelebrityRecognitionRequestVideo
   */
  public static StartCelebrityRecognitionRequestVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartCelebrityRecognitionRequestVideo.class);
  }

  /**
   * Convert an instance of StartCelebrityRecognitionRequestVideo to an JSON string
   *
   * @return JSON string
   */
