...
public class StreamProcessorInput {
  ...
  public StreamProcessorInput kinesisVideoStream(StreamProcessorInputKinesisVideoStream kinesisVideoStream) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessorInput streamProcessorInput = (StreamProcessorInput) o;
    return Objects.equals(this.kinesisVideoStream, streamProcessorInput.kinesisVideoStream);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamProcessorInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessorInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessorInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessorInput is not found in the empty JSON string", StreamProcessorInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessorInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessorInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessorInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessorInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessorInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessorInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessorInput>() {
           @Override
           public void write(JsonWriter out, StreamProcessorInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessorInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessorInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessorInput
   * @throws IOException if the JSON string is invalid with respect to StreamProcessorInput
   */
  public static StreamProcessorInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessorInput.class);
  }

  /**
   * Convert an instance of StreamProcessorInput to an JSON string
   *
   * @return JSON string
   */
