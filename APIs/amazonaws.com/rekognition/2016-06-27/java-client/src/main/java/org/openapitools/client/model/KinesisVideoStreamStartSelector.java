...
public class KinesisVideoStreamStartSelector {
  ...
  public KinesisVideoStreamStartSelector producerTimestamp(Integer producerTimestamp) {
  ...
  public KinesisVideoStreamStartSelector fragmentNumber(String fragmentNumber) {
  ...
  public boolean equals(Object o) {
    ...
    KinesisVideoStreamStartSelector kinesisVideoStreamStartSelector = (KinesisVideoStreamStartSelector) o;
    return Objects.equals(this.producerTimestamp, kinesisVideoStreamStartSelector.producerTimestamp) &&
        Objects.equals(this.fragmentNumber, kinesisVideoStreamStartSelector.fragmentNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class KinesisVideoStreamStartSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KinesisVideoStreamStartSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KinesisVideoStreamStartSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KinesisVideoStreamStartSelector is not found in the empty JSON string", KinesisVideoStreamStartSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KinesisVideoStreamStartSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KinesisVideoStreamStartSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KinesisVideoStreamStartSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KinesisVideoStreamStartSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KinesisVideoStreamStartSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KinesisVideoStreamStartSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<KinesisVideoStreamStartSelector>() {
           @Override
           public void write(JsonWriter out, KinesisVideoStreamStartSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KinesisVideoStreamStartSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KinesisVideoStreamStartSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KinesisVideoStreamStartSelector
   * @throws IOException if the JSON string is invalid with respect to KinesisVideoStreamStartSelector
   */
  public static KinesisVideoStreamStartSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KinesisVideoStreamStartSelector.class);
  }

  /**
   * Convert an instance of KinesisVideoStreamStartSelector to an JSON string
   *
   * @return JSON string
   */
