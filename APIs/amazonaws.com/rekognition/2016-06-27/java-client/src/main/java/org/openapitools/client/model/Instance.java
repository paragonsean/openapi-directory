...
import org.openapitools.client.model.InstanceBoundingBox;
...
public class Instance {
  ...
  private InstanceBoundingBox boundingBox;
  ...
  public Instance boundingBox(InstanceBoundingBox boundingBox) {
  ...
  public InstanceBoundingBox getBoundingBox() {
    return boundingBox;
  }

  public void setBoundingBox(InstanceBoundingBox boundingBox) {
    this.boundingBox = boundingBox;
  }


  public Instance confidence(Float confidence) {
  ...
  public Instance dominantColors(List dominantColors) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.boundingBox, instance.boundingBox) &&
        Objects.equals(this.confidence, instance.confidence) &&
        Objects.equals(this.dominantColors, instance.dominantColors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(boundingBox, confidence, dominantColors);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("BoundingBox") != null && !jsonObj.get("BoundingBox").isJsonNull()) {
        InstanceBoundingBox.validateJsonElement(jsonObj.get("BoundingBox"));
      }
