...
public class FaceDetailEyeglasses {
  ...
  public FaceDetailEyeglasses() {
  }

  public FaceDetailEyeglasses value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailEyeglasses confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailEyeglasses faceDetailEyeglasses = (FaceDetailEyeglasses) o;
    return Objects.equals(this.value, faceDetailEyeglasses.value) &&
        Objects.equals(this.confidence, faceDetailEyeglasses.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailEyeglasses {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailEyeglasses
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailEyeglasses.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailEyeglasses is not found in the empty JSON string", FaceDetailEyeglasses.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailEyeglasses.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailEyeglasses` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailEyeglasses.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailEyeglasses' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailEyeglasses> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailEyeglasses.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailEyeglasses>() {
           @Override
           public void write(JsonWriter out, FaceDetailEyeglasses value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailEyeglasses read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailEyeglasses given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailEyeglasses
   * @throws IOException if the JSON string is invalid with respect to FaceDetailEyeglasses
   */
  public static FaceDetailEyeglasses fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailEyeglasses.class);
  }

  /**
   * Convert an instance of FaceDetailEyeglasses to an JSON string
   *
   * @return JSON string
   */
