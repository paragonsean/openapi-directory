...
public class FaceDetailMouthOpen {
  ...
  public FaceDetailMouthOpen() {
  }

  public FaceDetailMouthOpen value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceDetailMouthOpen confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailMouthOpen faceDetailMouthOpen = (FaceDetailMouthOpen) o;
    return Objects.equals(this.value, faceDetailMouthOpen.value) &&
        Objects.equals(this.confidence, faceDetailMouthOpen.confidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailMouthOpen {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailMouthOpen
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailMouthOpen.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailMouthOpen is not found in the empty JSON string", FaceDetailMouthOpen.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailMouthOpen.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailMouthOpen` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailMouthOpen.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailMouthOpen' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailMouthOpen> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailMouthOpen.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailMouthOpen>() {
           @Override
           public void write(JsonWriter out, FaceDetailMouthOpen value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailMouthOpen read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailMouthOpen given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailMouthOpen
   * @throws IOException if the JSON string is invalid with respect to FaceDetailMouthOpen
   */
  public static FaceDetailMouthOpen fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailMouthOpen.class);
  }

  /**
   * Convert an instance of FaceDetailMouthOpen to an JSON string
   *
   * @return JSON string
   */
