...
public class DeleteProjectVersionRequest {
  ...
  public DeleteProjectVersionRequest projectVersionArn(String projectVersionArn) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteProjectVersionRequest deleteProjectVersionRequest = (DeleteProjectVersionRequest) o;
    return Objects.equals(this.projectVersionArn, deleteProjectVersionRequest.projectVersionArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectVersionArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteProjectVersionRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ProjectVersionArn");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteProjectVersionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteProjectVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteProjectVersionRequest is not found in the empty JSON string", DeleteProjectVersionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteProjectVersionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteProjectVersionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteProjectVersionRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ProjectVersionArn`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteProjectVersionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteProjectVersionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteProjectVersionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteProjectVersionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteProjectVersionRequest>() {
           @Override
           public void write(JsonWriter out, DeleteProjectVersionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteProjectVersionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteProjectVersionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteProjectVersionRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteProjectVersionRequest
   */
  public static DeleteProjectVersionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteProjectVersionRequest.class);
  }

  /**
   * Convert an instance of DeleteProjectVersionRequest to an JSON string
   *
   * @return JSON string
   */
