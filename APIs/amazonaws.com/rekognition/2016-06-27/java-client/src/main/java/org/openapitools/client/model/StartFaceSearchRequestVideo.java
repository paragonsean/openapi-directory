...
public class StartFaceSearchRequestVideo {
  ...
  public StartFaceSearchRequestVideo() {
  }

  public StartFaceSearchRequestVideo s3Object(VideoS3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    StartFaceSearchRequestVideo startFaceSearchRequestVideo = (StartFaceSearchRequestVideo) o;
    return Objects.equals(this.s3Object, startFaceSearchRequestVideo.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFaceSearchRequestVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFaceSearchRequestVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFaceSearchRequestVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFaceSearchRequestVideo is not found in the empty JSON string", StartFaceSearchRequestVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFaceSearchRequestVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFaceSearchRequestVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFaceSearchRequestVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFaceSearchRequestVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFaceSearchRequestVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFaceSearchRequestVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFaceSearchRequestVideo>() {
           @Override
           public void write(JsonWriter out, StartFaceSearchRequestVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFaceSearchRequestVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFaceSearchRequestVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFaceSearchRequestVideo
   * @throws IOException if the JSON string is invalid with respect to StartFaceSearchRequestVideo
   */
  public static StartFaceSearchRequestVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFaceSearchRequestVideo.class);
  }

  /**
   * Convert an instance of StartFaceSearchRequestVideo to an JSON string
   *
   * @return JSON string
   */
