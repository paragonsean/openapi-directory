...
public class ProtectiveEquipmentSummary {
  ...
  public ProtectiveEquipmentSummary personsWithRequiredEquipment(List personsWithRequiredEquipment) {
  ...
  public ProtectiveEquipmentSummary personsWithoutRequiredEquipment(List personsWithoutRequiredEquipment) {
  ...
  public ProtectiveEquipmentSummary personsIndeterminate(List personsIndeterminate) {
  ...
  public boolean equals(Object o) {
    ...
    ProtectiveEquipmentSummary protectiveEquipmentSummary = (ProtectiveEquipmentSummary) o;
    return Objects.equals(this.personsWithRequiredEquipment, protectiveEquipmentSummary.personsWithRequiredEquipment) &&
        Objects.equals(this.personsWithoutRequiredEquipment, protectiveEquipmentSummary.personsWithoutRequiredEquipment) &&
        Objects.equals(this.personsIndeterminate, protectiveEquipmentSummary.personsIndeterminate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProtectiveEquipmentSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProtectiveEquipmentSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProtectiveEquipmentSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProtectiveEquipmentSummary is not found in the empty JSON string", ProtectiveEquipmentSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProtectiveEquipmentSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProtectiveEquipmentSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProtectiveEquipmentSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProtectiveEquipmentSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProtectiveEquipmentSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProtectiveEquipmentSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ProtectiveEquipmentSummary>() {
           @Override
           public void write(JsonWriter out, ProtectiveEquipmentSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProtectiveEquipmentSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProtectiveEquipmentSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProtectiveEquipmentSummary
   * @throws IOException if the JSON string is invalid with respect to ProtectiveEquipmentSummary
   */
  public static ProtectiveEquipmentSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProtectiveEquipmentSummary.class);
  }

  /**
   * Convert an instance of ProtectiveEquipmentSummary to an JSON string
   *
   * @return JSON string
   */
