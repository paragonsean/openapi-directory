...
public class StartFaceSearchRequestNotificationChannel {
  ...
  public StartFaceSearchRequestNotificationChannel() {
  }

  public StartFaceSearchRequestNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public StartFaceSearchRequestNotificationChannel roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartFaceSearchRequestNotificationChannel startFaceSearchRequestNotificationChannel = (StartFaceSearchRequestNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, startFaceSearchRequestNotificationChannel.snSTopicArn) &&
        Objects.equals(this.roleArn, startFaceSearchRequestNotificationChannel.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFaceSearchRequestNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFaceSearchRequestNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFaceSearchRequestNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFaceSearchRequestNotificationChannel is not found in the empty JSON string", StartFaceSearchRequestNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFaceSearchRequestNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFaceSearchRequestNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartFaceSearchRequestNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFaceSearchRequestNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFaceSearchRequestNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFaceSearchRequestNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFaceSearchRequestNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFaceSearchRequestNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StartFaceSearchRequestNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFaceSearchRequestNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFaceSearchRequestNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFaceSearchRequestNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StartFaceSearchRequestNotificationChannel
   */
  public static StartFaceSearchRequestNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFaceSearchRequestNotificationChannel.class);
  }

  /**
   * Convert an instance of StartFaceSearchRequestNotificationChannel to an JSON string
   *
   * @return JSON string
   */
