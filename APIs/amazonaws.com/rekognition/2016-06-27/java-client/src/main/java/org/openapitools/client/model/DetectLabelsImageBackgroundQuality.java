...
/**
 * DetectLabelsImageBackgroundQuality
 */
...
public class DetectLabelsImageBackgroundQuality {
  ...
  public DetectLabelsImageBackgroundQuality() {
  }

  public DetectLabelsImageBackgroundQuality brightness(Float brightness) {
  ...
  public DetectLabelsImageBackgroundQuality sharpness(Float sharpness) {
  ...
  public DetectLabelsImageBackgroundQuality contrast(Float contrast) {
  ...
  public boolean equals(Object o) {
    ...
    DetectLabelsImageBackgroundQuality detectLabelsImageBackgroundQuality = (DetectLabelsImageBackgroundQuality) o;
    return Objects.equals(this.brightness, detectLabelsImageBackgroundQuality.brightness) &&
        Objects.equals(this.sharpness, detectLabelsImageBackgroundQuality.sharpness) &&
        Objects.equals(this.contrast, detectLabelsImageBackgroundQuality.contrast);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectLabelsImageBackgroundQuality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectLabelsImageBackgroundQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectLabelsImageBackgroundQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectLabelsImageBackgroundQuality is not found in the empty JSON string", DetectLabelsImageBackgroundQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectLabelsImageBackgroundQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectLabelsImageBackgroundQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectLabelsImageBackgroundQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectLabelsImageBackgroundQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectLabelsImageBackgroundQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectLabelsImageBackgroundQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectLabelsImageBackgroundQuality>() {
           @Override
           public void write(JsonWriter out, DetectLabelsImageBackgroundQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectLabelsImageBackgroundQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectLabelsImageBackgroundQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectLabelsImageBackgroundQuality
   * @throws IOException if the JSON string is invalid with respect to DetectLabelsImageBackgroundQuality
   */
  public static DetectLabelsImageBackgroundQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectLabelsImageBackgroundQuality.class);
  }

  /**
   * Convert an instance of DetectLabelsImageBackgroundQuality to an JSON string
   *
   * @return JSON string
   */
