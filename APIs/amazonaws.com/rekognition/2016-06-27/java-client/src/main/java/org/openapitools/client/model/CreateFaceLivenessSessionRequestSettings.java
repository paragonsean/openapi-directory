...
import org.openapitools.client.model.CreateFaceLivenessSessionRequestSettingsOutputConfig;
...
public class CreateFaceLivenessSessionRequestSettings {
  ...
  private CreateFaceLivenessSessionRequestSettingsOutputConfig outputConfig;

  public static final String SERIALIZED_NAME_AUDIT_IMAGES_LIMIT = "AuditImagesLimit";
  @SerializedName(SERIALIZED_NAME_AUDIT_IMAGES_LIMIT)
  private Integer auditImagesLimit;

  public CreateFaceLivenessSessionRequestSettings() {
  }

  public CreateFaceLivenessSessionRequestSettings outputConfig(CreateFaceLivenessSessionRequestSettingsOutputConfig outputConfig) {
  ...
  public CreateFaceLivenessSessionRequestSettingsOutputConfig getOutputConfig() {
    return outputConfig;
  }

  public void setOutputConfig(CreateFaceLivenessSessionRequestSettingsOutputConfig outputConfig) {
    this.outputConfig = outputConfig;
  }


  public CreateFaceLivenessSessionRequestSettings auditImagesLimit(Integer auditImagesLimit) {
    this.auditImagesLimit = auditImagesLimit;
    return this;
  }

  /**
   * Get auditImagesLimit
  ...
  public boolean equals(Object o) {
    ...
    CreateFaceLivenessSessionRequestSettings createFaceLivenessSessionRequestSettings = (CreateFaceLivenessSessionRequestSettings) o;
    return Objects.equals(this.outputConfig, createFaceLivenessSessionRequestSettings.outputConfig) &&
        Objects.equals(this.auditImagesLimit, createFaceLivenessSessionRequestSettings.auditImagesLimit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(outputConfig, auditImagesLimit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateFaceLivenessSessionRequestSettings {\n");
    sb.append("    outputConfig: ").append(toIndentedString(outputConfig)).append("\n");
    sb.append("    auditImagesLimit: ").append(toIndentedString(auditImagesLimit)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("AuditImagesLimit");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFaceLivenessSessionRequestSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFaceLivenessSessionRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFaceLivenessSessionRequestSettings is not found in the empty JSON string", CreateFaceLivenessSessionRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFaceLivenessSessionRequestSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFaceLivenessSessionRequestSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `OutputConfig`
      if (jsonObj.get("OutputConfig") != null && !jsonObj.get("OutputConfig").isJsonNull()) {
        CreateFaceLivenessSessionRequestSettingsOutputConfig.validateJsonElement(jsonObj.get("OutputConfig"));
      }
      // validate the optional field `AuditImagesLimit`
      if (jsonObj.get("AuditImagesLimit") != null && !jsonObj.get("AuditImagesLimit").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("AuditImagesLimit"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFaceLivenessSessionRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFaceLivenessSessionRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFaceLivenessSessionRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFaceLivenessSessionRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFaceLivenessSessionRequestSettings>() {
           @Override
           public void write(JsonWriter out, CreateFaceLivenessSessionRequestSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFaceLivenessSessionRequestSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFaceLivenessSessionRequestSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFaceLivenessSessionRequestSettings
   * @throws IOException if the JSON string is invalid with respect to CreateFaceLivenessSessionRequestSettings
   */
  public static CreateFaceLivenessSessionRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFaceLivenessSessionRequestSettings.class);
  }

  /**
   * Convert an instance of CreateFaceLivenessSessionRequestSettings to an JSON string
   *
   * @return JSON string
   */
