...
import org.openapitools.client.model.TextDetectionResultTextDetection;
...
public class TextDetectionResult {
  ...
  public static final String SERIALIZED_NAME_TEXT_DETECTION = "TextDetection";
  @SerializedName(SERIALIZED_NAME_TEXT_DETECTION)
  private TextDetectionResultTextDetection textDetection;

  public TextDetectionResult() {
  }

  public TextDetectionResult timestamp(Integer timestamp) {
  ...
  public TextDetectionResult textDetection(TextDetectionResultTextDetection textDetection) {
   ...
   */
  @javax.annotation.Nullable
  public TextDetectionResultTextDetection getTextDetection() {
    return textDetection;
  }

  public void setTextDetection(TextDetectionResultTextDetection textDetection) {
    this.textDetection = textDetection;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timestamp, textDetectionResult.timestamp) &&
        Objects.equals(this.textDetection, textDetectionResult.textDetection);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, textDetection);
  }
  ...
  static {
    ...
    openapiFields.add("TextDetection");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextDetectionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextDetectionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TextDetectionResult is not found in the empty JSON string", TextDetectionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextDetectionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TextDetectionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("TextDetection") != null && !jsonObj.get("TextDetection").isJsonNull()) {
        TextDetectionResultTextDetection.validateJsonElement(jsonObj.get("TextDetection"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TextDetectionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TextDetectionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TextDetectionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TextDetectionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<TextDetectionResult>() {
           @Override
           public void write(JsonWriter out, TextDetectionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TextDetectionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TextDetectionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TextDetectionResult
   * @throws IOException if the JSON string is invalid with respect to TextDetectionResult
   */
  public static TextDetectionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextDetectionResult.class);
  }

  /**
   * Convert an instance of TextDetectionResult to an JSON string
   *
   * @return JSON string
   */
