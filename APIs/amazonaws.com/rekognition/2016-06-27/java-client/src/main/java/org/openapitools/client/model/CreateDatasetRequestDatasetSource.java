...
import org.openapitools.client.model.GroundTruthManifest;
...
public class CreateDatasetRequestDatasetSource {
  ...
  public CreateDatasetRequestDatasetSource groundTruthManifest(GroundTruthManifest groundTruthManifest) {
  ...
  public CreateDatasetRequestDatasetSource datasetArn(String datasetArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groundTruthManifest, createDatasetRequestDatasetSource.groundTruthManifest) &&
        Objects.equals(this.datasetArn, createDatasetRequestDatasetSource.datasetArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groundTruthManifest, datasetArn);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("GroundTruthManifest") != null && !jsonObj.get("GroundTruthManifest").isJsonNull()) {
        GroundTruthManifest.validateJsonElement(jsonObj.get("GroundTruthManifest"));
      }
