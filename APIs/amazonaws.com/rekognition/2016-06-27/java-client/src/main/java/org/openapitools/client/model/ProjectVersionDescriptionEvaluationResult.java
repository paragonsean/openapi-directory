...
/**
 * ProjectVersionDescriptionEvaluationResult
 */
...
public class ProjectVersionDescriptionEvaluationResult {
  ...
  public ProjectVersionDescriptionEvaluationResult() {
  }

  public ProjectVersionDescriptionEvaluationResult f1Score(Float f1Score) {
  ...
  public ProjectVersionDescriptionEvaluationResult summary(EvaluationResultSummary summary) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectVersionDescriptionEvaluationResult projectVersionDescriptionEvaluationResult = (ProjectVersionDescriptionEvaluationResult) o;
    return Objects.equals(this.f1Score, projectVersionDescriptionEvaluationResult.f1Score) &&
        Objects.equals(this.summary, projectVersionDescriptionEvaluationResult.summary);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectVersionDescriptionEvaluationResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectVersionDescriptionEvaluationResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectVersionDescriptionEvaluationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectVersionDescriptionEvaluationResult is not found in the empty JSON string", ProjectVersionDescriptionEvaluationResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectVersionDescriptionEvaluationResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectVersionDescriptionEvaluationResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectVersionDescriptionEvaluationResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectVersionDescriptionEvaluationResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectVersionDescriptionEvaluationResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectVersionDescriptionEvaluationResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectVersionDescriptionEvaluationResult>() {
           @Override
           public void write(JsonWriter out, ProjectVersionDescriptionEvaluationResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectVersionDescriptionEvaluationResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectVersionDescriptionEvaluationResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectVersionDescriptionEvaluationResult
   * @throws IOException if the JSON string is invalid with respect to ProjectVersionDescriptionEvaluationResult
   */
  public static ProjectVersionDescriptionEvaluationResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectVersionDescriptionEvaluationResult.class);
  }

  /**
   * Convert an instance of ProjectVersionDescriptionEvaluationResult to an JSON string
   *
   * @return JSON string
   */
