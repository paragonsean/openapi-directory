...
public class Celebrity {
  ...
  public Celebrity urls(List urls) {
    this.urls = urls;
    return this;
  }
  ...
  public Celebrity name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Celebrity face(CelebrityFace face) {
    this.face = face;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CelebrityFace getFace() {
    return face;
  }

  public void setFace(CelebrityFace face) {
    this.face = face;
  }


  public Celebrity matchConfidence(Float matchConfidence) {
  ...
  public Celebrity knownGender(KnownGender knownGender) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.urls, celebrity.urls) &&
        Objects.equals(this.name, celebrity.name) &&
        Objects.equals(this.id, celebrity.id) &&
        Objects.equals(this.face, celebrity.face) &&
        Objects.equals(this.matchConfidence, celebrity.matchConfidence) &&
        Objects.equals(this.knownGender, celebrity.knownGender);
  }

  @Override
  public int hashCode() {
    return Objects.hash(urls, name, id, face, matchConfidence, knownGender);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Celebrity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Celebrity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Celebrity is not found in the empty JSON string", Celebrity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Celebrity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Celebrity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Face") != null && !jsonObj.get("Face").isJsonNull()) {
        CelebrityFace.validateJsonElement(jsonObj.get("Face"));
      }
      // validate the optional field `MatchConfidence`
      if (jsonObj.get("MatchConfidence") != null && !jsonObj.get("MatchConfidence").isJsonNull()) {
        Float.validateJsonElement(jsonObj.get("MatchConfidence"));
      }
      // validate the optional field `KnownGender`
      if (jsonObj.get("KnownGender") != null && !jsonObj.get("KnownGender").isJsonNull()) {
        KnownGender.validateJsonElement(jsonObj.get("KnownGender"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Celebrity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Celebrity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Celebrity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Celebrity.class));

       return (TypeAdapter<T>) new TypeAdapter<Celebrity>() {
           @Override
           public void write(JsonWriter out, Celebrity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Celebrity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Celebrity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Celebrity
   * @throws IOException if the JSON string is invalid with respect to Celebrity
   */
  public static Celebrity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Celebrity.class);
  }

  /**
   * Convert an instance of Celebrity to an JSON string
   *
   * @return JSON string
   */
