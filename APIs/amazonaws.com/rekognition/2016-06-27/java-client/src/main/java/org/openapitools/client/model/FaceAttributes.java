...
/**
 * Gets or Sets FaceAttributes
 */
@JsonAdapter(FaceAttributes.Adapter.class)
public enum FaceAttributes {
  ...
  public static FaceAttributes fromValue(String value) {
    for (FaceAttributes b : FaceAttributes.values()) {
  ...
  public static class Adapter extends TypeAdapter<FaceAttributes> {
    @Override
    public void write(final JsonWriter jsonWriter, final FaceAttributes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FaceAttributes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FaceAttributes.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FaceAttributes.fromValue(value);
  }
}
