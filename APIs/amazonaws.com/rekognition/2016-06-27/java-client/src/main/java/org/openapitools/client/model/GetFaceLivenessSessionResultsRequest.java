...
public class GetFaceLivenessSessionResultsRequest {
  ...
  public GetFaceLivenessSessionResultsRequest sessionId(String sessionId) {
  ...
  public boolean equals(Object o) {
    ...
    GetFaceLivenessSessionResultsRequest getFaceLivenessSessionResultsRequest = (GetFaceLivenessSessionResultsRequest) o;
    return Objects.equals(this.sessionId, getFaceLivenessSessionResultsRequest.sessionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFaceLivenessSessionResultsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFaceLivenessSessionResultsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFaceLivenessSessionResultsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFaceLivenessSessionResultsRequest is not found in the empty JSON string", GetFaceLivenessSessionResultsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFaceLivenessSessionResultsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFaceLivenessSessionResultsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFaceLivenessSessionResultsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFaceLivenessSessionResultsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFaceLivenessSessionResultsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFaceLivenessSessionResultsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFaceLivenessSessionResultsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFaceLivenessSessionResultsRequest>() {
           @Override
           public void write(JsonWriter out, GetFaceLivenessSessionResultsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFaceLivenessSessionResultsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFaceLivenessSessionResultsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFaceLivenessSessionResultsRequest
   * @throws IOException if the JSON string is invalid with respect to GetFaceLivenessSessionResultsRequest
   */
  public static GetFaceLivenessSessionResultsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFaceLivenessSessionResultsRequest.class);
  }

  /**
   * Convert an instance of GetFaceLivenessSessionResultsRequest to an JSON string
   *
   * @return JSON string
   */
