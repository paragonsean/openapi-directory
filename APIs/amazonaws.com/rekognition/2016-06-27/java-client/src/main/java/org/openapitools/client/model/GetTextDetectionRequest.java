...
public class GetTextDetectionRequest {
  ...
  public GetTextDetectionRequest() {
  }

  public GetTextDetectionRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetTextDetectionRequest maxResults(Integer maxResults) {
  ...
  public GetTextDetectionRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetTextDetectionRequest getTextDetectionRequest = (GetTextDetectionRequest) o;
    return Objects.equals(this.jobId, getTextDetectionRequest.jobId) &&
        Objects.equals(this.maxResults, getTextDetectionRequest.maxResults) &&
        Objects.equals(this.nextToken, getTextDetectionRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTextDetectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTextDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTextDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTextDetectionRequest is not found in the empty JSON string", GetTextDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTextDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTextDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTextDetectionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTextDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTextDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTextDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTextDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTextDetectionRequest>() {
           @Override
           public void write(JsonWriter out, GetTextDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTextDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTextDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTextDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to GetTextDetectionRequest
   */
  public static GetTextDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTextDetectionRequest.class);
  }

  /**
   * Convert an instance of GetTextDetectionRequest to an JSON string
   *
   * @return JSON string
   */
