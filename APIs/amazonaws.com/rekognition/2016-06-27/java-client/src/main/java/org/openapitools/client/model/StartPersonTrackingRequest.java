...
public class StartPersonTrackingRequest {
  ...
  private StartPersonTrackingRequestVideo video;
  ...
  private StartPersonTrackingRequestNotificationChannel notificationChannel;

  public static final String SERIALIZED_NAME_JOB_TAG = "JobTag";
  @SerializedName(SERIALIZED_NAME_JOB_TAG)
  private String jobTag;

  public StartPersonTrackingRequest() {
  }

  public StartPersonTrackingRequest video(StartPersonTrackingRequestVideo video) {
    this.video = video;
    return this;
  }
  ...
  public StartPersonTrackingRequestVideo getVideo() {
    return video;
  }

  public void setVideo(StartPersonTrackingRequestVideo video) {
    this.video = video;
  }


  public StartPersonTrackingRequest clientRequestToken(String clientRequestToken) {
  ...
  public StartPersonTrackingRequest notificationChannel(StartPersonTrackingRequestNotificationChannel notificationChannel) {
   ...
   */
  @javax.annotation.Nullable
  public StartPersonTrackingRequestNotificationChannel getNotificationChannel() {
    return notificationChannel;
  }

  public void setNotificationChannel(StartPersonTrackingRequestNotificationChannel notificationChannel) {
    this.notificationChannel = notificationChannel;
  }


  public StartPersonTrackingRequest jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartPersonTrackingRequest startPersonTrackingRequest = (StartPersonTrackingRequest) o;
    return Objects.equals(this.video, startPersonTrackingRequest.video) &&
        Objects.equals(this.clientRequestToken, startPersonTrackingRequest.clientRequestToken) &&
        Objects.equals(this.notificationChannel, startPersonTrackingRequest.notificationChannel) &&
        Objects.equals(this.jobTag, startPersonTrackingRequest.jobTag);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartPersonTrackingRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartPersonTrackingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartPersonTrackingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartPersonTrackingRequest is not found in the empty JSON string", StartPersonTrackingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartPersonTrackingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartPersonTrackingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartPersonTrackingRequest.openapiRequiredFields) {
      ...
      StartPersonTrackingRequestVideo.validateJsonElement(jsonObj.get("Video"));
      ...
      if (jsonObj.get("NotificationChannel") != null && !jsonObj.get("NotificationChannel").isJsonNull()) {
        StartPersonTrackingRequestNotificationChannel.validateJsonElement(jsonObj.get("NotificationChannel"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartPersonTrackingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartPersonTrackingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartPersonTrackingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartPersonTrackingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartPersonTrackingRequest>() {
           @Override
           public void write(JsonWriter out, StartPersonTrackingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartPersonTrackingRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartPersonTrackingRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartPersonTrackingRequest
   * @throws IOException if the JSON string is invalid with respect to StartPersonTrackingRequest
   */
  public static StartPersonTrackingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartPersonTrackingRequest.class);
  }

  /**
   * Convert an instance of StartPersonTrackingRequest to an JSON string
   *
   * @return JSON string
   */
