...
/**
 * CreateStreamProcessorRequestOutput
 */
...
public class CreateStreamProcessorRequestOutput {
  ...
  public CreateStreamProcessorRequestOutput() {
  }

  public CreateStreamProcessorRequestOutput kinesisDataStream(StreamProcessorOutputKinesisDataStream kinesisDataStream) {
  ...
  public CreateStreamProcessorRequestOutput s3Destination(StreamProcessorOutputS3Destination s3Destination) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamProcessorRequestOutput createStreamProcessorRequestOutput = (CreateStreamProcessorRequestOutput) o;
    return Objects.equals(this.kinesisDataStream, createStreamProcessorRequestOutput.kinesisDataStream) &&
        Objects.equals(this.s3Destination, createStreamProcessorRequestOutput.s3Destination);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStreamProcessorRequestOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamProcessorRequestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamProcessorRequestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamProcessorRequestOutput is not found in the empty JSON string", CreateStreamProcessorRequestOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamProcessorRequestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamProcessorRequestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamProcessorRequestOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamProcessorRequestOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamProcessorRequestOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamProcessorRequestOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamProcessorRequestOutput>() {
           @Override
           public void write(JsonWriter out, CreateStreamProcessorRequestOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamProcessorRequestOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamProcessorRequestOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamProcessorRequestOutput
   * @throws IOException if the JSON string is invalid with respect to CreateStreamProcessorRequestOutput
   */
  public static CreateStreamProcessorRequestOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamProcessorRequestOutput.class);
  }

  /**
   * Convert an instance of CreateStreamProcessorRequestOutput to an JSON string
   *
   * @return JSON string
   */
