...
public class SearchUsersResponseSearchedUser {
  public static final String SERIALIZED_NAME_USER_ID = "UserId";
  @SerializedName(SERIALIZED_NAME_USER_ID)
  private String userId;

  public SearchUsersResponseSearchedUser() {
  }

  public SearchUsersResponseSearchedUser userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchUsersResponseSearchedUser searchUsersResponseSearchedUser = (SearchUsersResponseSearchedUser) o;
    return Objects.equals(this.userId, searchUsersResponseSearchedUser.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchUsersResponseSearchedUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchUsersResponseSearchedUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchUsersResponseSearchedUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchUsersResponseSearchedUser is not found in the empty JSON string", SearchUsersResponseSearchedUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchUsersResponseSearchedUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchUsersResponseSearchedUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchUsersResponseSearchedUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchUsersResponseSearchedUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchUsersResponseSearchedUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchUsersResponseSearchedUser.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchUsersResponseSearchedUser>() {
           @Override
           public void write(JsonWriter out, SearchUsersResponseSearchedUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchUsersResponseSearchedUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchUsersResponseSearchedUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchUsersResponseSearchedUser
   * @throws IOException if the JSON string is invalid with respect to SearchUsersResponseSearchedUser
   */
  public static SearchUsersResponseSearchedUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchUsersResponseSearchedUser.class);
  }

  /**
   * Convert an instance of SearchUsersResponseSearchedUser to an JSON string
   *
   * @return JSON string
   */
