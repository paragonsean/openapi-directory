...
public class CelebrityDetailBoundingBox {
  ...
  public CelebrityDetailBoundingBox() {
  }

  public CelebrityDetailBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public CelebrityDetailBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public CelebrityDetailBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public CelebrityDetailBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CelebrityDetailBoundingBox celebrityDetailBoundingBox = (CelebrityDetailBoundingBox) o;
    return Objects.equals(this.width, celebrityDetailBoundingBox.width) &&
        Objects.equals(this.height, celebrityDetailBoundingBox.height) &&
        Objects.equals(this.left, celebrityDetailBoundingBox.left) &&
        Objects.equals(this.top, celebrityDetailBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class CelebrityDetailBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CelebrityDetailBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CelebrityDetailBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CelebrityDetailBoundingBox is not found in the empty JSON string", CelebrityDetailBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CelebrityDetailBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CelebrityDetailBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CelebrityDetailBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CelebrityDetailBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CelebrityDetailBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CelebrityDetailBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<CelebrityDetailBoundingBox>() {
           @Override
           public void write(JsonWriter out, CelebrityDetailBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CelebrityDetailBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CelebrityDetailBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CelebrityDetailBoundingBox
   * @throws IOException if the JSON string is invalid with respect to CelebrityDetailBoundingBox
   */
  public static CelebrityDetailBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CelebrityDetailBoundingBox.class);
  }

  /**
   * Convert an instance of CelebrityDetailBoundingBox to an JSON string
   *
   * @return JSON string
   */
