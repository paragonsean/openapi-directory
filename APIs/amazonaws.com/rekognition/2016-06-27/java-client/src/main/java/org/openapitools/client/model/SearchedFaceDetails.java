...
public class SearchedFaceDetails {
  ...
  public SearchedFaceDetails() {
  }

  public SearchedFaceDetails faceDetail(FaceDetail faceDetail) {
  ...
  public boolean equals(Object o) {
    ...
    SearchedFaceDetails searchedFaceDetails = (SearchedFaceDetails) o;
    return Objects.equals(this.faceDetail, searchedFaceDetails.faceDetail);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchedFaceDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchedFaceDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchedFaceDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchedFaceDetails is not found in the empty JSON string", SearchedFaceDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchedFaceDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchedFaceDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchedFaceDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchedFaceDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchedFaceDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchedFaceDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchedFaceDetails>() {
           @Override
           public void write(JsonWriter out, SearchedFaceDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchedFaceDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchedFaceDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchedFaceDetails
   * @throws IOException if the JSON string is invalid with respect to SearchedFaceDetails
   */
  public static SearchedFaceDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchedFaceDetails.class);
  }

  /**
   * Convert an instance of SearchedFaceDetails to an JSON string
   *
   * @return JSON string
   */
