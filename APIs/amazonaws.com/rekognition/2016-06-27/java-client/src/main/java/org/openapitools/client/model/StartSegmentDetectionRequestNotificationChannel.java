...
/**
 * StartSegmentDetectionRequestNotificationChannel
 */
...
public class StartSegmentDetectionRequestNotificationChannel {
  ...
  public StartSegmentDetectionRequestNotificationChannel() {
  }

  public StartSegmentDetectionRequestNotificationChannel snSTopicArn(String snSTopicArn) {
  ...
  public StartSegmentDetectionRequestNotificationChannel roleArn(String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartSegmentDetectionRequestNotificationChannel startSegmentDetectionRequestNotificationChannel = (StartSegmentDetectionRequestNotificationChannel) o;
    return Objects.equals(this.snSTopicArn, startSegmentDetectionRequestNotificationChannel.snSTopicArn) &&
        Objects.equals(this.roleArn, startSegmentDetectionRequestNotificationChannel.roleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartSegmentDetectionRequestNotificationChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSegmentDetectionRequestNotificationChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSegmentDetectionRequestNotificationChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSegmentDetectionRequestNotificationChannel is not found in the empty JSON string", StartSegmentDetectionRequestNotificationChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSegmentDetectionRequestNotificationChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSegmentDetectionRequestNotificationChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartSegmentDetectionRequestNotificationChannel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSegmentDetectionRequestNotificationChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSegmentDetectionRequestNotificationChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSegmentDetectionRequestNotificationChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSegmentDetectionRequestNotificationChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSegmentDetectionRequestNotificationChannel>() {
           @Override
           public void write(JsonWriter out, StartSegmentDetectionRequestNotificationChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSegmentDetectionRequestNotificationChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSegmentDetectionRequestNotificationChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSegmentDetectionRequestNotificationChannel
   * @throws IOException if the JSON string is invalid with respect to StartSegmentDetectionRequestNotificationChannel
   */
  public static StartSegmentDetectionRequestNotificationChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSegmentDetectionRequestNotificationChannel.class);
  }

  /**
   * Convert an instance of StartSegmentDetectionRequestNotificationChannel to an JSON string
   *
   * @return JSON string
   */
