...
public class PersonDetail {
  ...
  public PersonDetail index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public PersonDetail boundingBox(PersonDetailBoundingBox boundingBox) {
  ...
  public PersonDetail face(PersonDetailFace face) {
    this.face = face;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.index, personDetail.index) &&
        Objects.equals(this.boundingBox, personDetail.boundingBox) &&
        Objects.equals(this.face, personDetail.face);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonDetail is not found in the empty JSON string", PersonDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonDetail>() {
           @Override
           public void write(JsonWriter out, PersonDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonDetail
   * @throws IOException if the JSON string is invalid with respect to PersonDetail
   */
  public static PersonDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonDetail.class);
  }

  /**
   * Convert an instance of PersonDetail to an JSON string
   *
   * @return JSON string
   */
