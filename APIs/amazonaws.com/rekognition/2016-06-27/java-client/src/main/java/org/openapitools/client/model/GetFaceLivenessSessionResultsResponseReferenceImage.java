...
/**
 * GetFaceLivenessSessionResultsResponseReferenceImage
 */
...
public class GetFaceLivenessSessionResultsResponseReferenceImage {
  ...
  public GetFaceLivenessSessionResultsResponseReferenceImage() {
  }

  public GetFaceLivenessSessionResultsResponseReferenceImage bytes(String bytes) {
    this.bytes = bytes;
    return this;
  }
  ...
  public GetFaceLivenessSessionResultsResponseReferenceImage s3Object(S3Object s3Object) {
  ...
  public GetFaceLivenessSessionResultsResponseReferenceImage boundingBox(BoundingBox boundingBox) {
  ...
  public boolean equals(Object o) {
    ...
    GetFaceLivenessSessionResultsResponseReferenceImage getFaceLivenessSessionResultsResponseReferenceImage = (GetFaceLivenessSessionResultsResponseReferenceImage) o;
    return Objects.equals(this.bytes, getFaceLivenessSessionResultsResponseReferenceImage.bytes) &&
        Objects.equals(this.s3Object, getFaceLivenessSessionResultsResponseReferenceImage.s3Object) &&
        Objects.equals(this.boundingBox, getFaceLivenessSessionResultsResponseReferenceImage.boundingBox);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFaceLivenessSessionResultsResponseReferenceImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFaceLivenessSessionResultsResponseReferenceImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFaceLivenessSessionResultsResponseReferenceImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFaceLivenessSessionResultsResponseReferenceImage is not found in the empty JSON string", GetFaceLivenessSessionResultsResponseReferenceImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFaceLivenessSessionResultsResponseReferenceImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFaceLivenessSessionResultsResponseReferenceImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFaceLivenessSessionResultsResponseReferenceImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFaceLivenessSessionResultsResponseReferenceImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFaceLivenessSessionResultsResponseReferenceImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFaceLivenessSessionResultsResponseReferenceImage.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFaceLivenessSessionResultsResponseReferenceImage>() {
           @Override
           public void write(JsonWriter out, GetFaceLivenessSessionResultsResponseReferenceImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFaceLivenessSessionResultsResponseReferenceImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFaceLivenessSessionResultsResponseReferenceImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFaceLivenessSessionResultsResponseReferenceImage
   * @throws IOException if the JSON string is invalid with respect to GetFaceLivenessSessionResultsResponseReferenceImage
   */
  public static GetFaceLivenessSessionResultsResponseReferenceImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFaceLivenessSessionResultsResponseReferenceImage.class);
  }

  /**
   * Convert an instance of GetFaceLivenessSessionResultsResponseReferenceImage to an JSON string
   *
   * @return JSON string
   */
