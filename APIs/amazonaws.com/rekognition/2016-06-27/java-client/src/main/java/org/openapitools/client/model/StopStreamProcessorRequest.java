...
public class StopStreamProcessorRequest {
  ...
  public StopStreamProcessorRequest() {
  }

  public StopStreamProcessorRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StopStreamProcessorRequest stopStreamProcessorRequest = (StopStreamProcessorRequest) o;
    return Objects.equals(this.name, stopStreamProcessorRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopStreamProcessorRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopStreamProcessorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopStreamProcessorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopStreamProcessorRequest is not found in the empty JSON string", StopStreamProcessorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopStreamProcessorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopStreamProcessorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopStreamProcessorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopStreamProcessorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopStreamProcessorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopStreamProcessorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopStreamProcessorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StopStreamProcessorRequest>() {
           @Override
           public void write(JsonWriter out, StopStreamProcessorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopStreamProcessorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopStreamProcessorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopStreamProcessorRequest
   * @throws IOException if the JSON string is invalid with respect to StopStreamProcessorRequest
   */
  public static StopStreamProcessorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopStreamProcessorRequest.class);
  }

  /**
   * Convert an instance of StopStreamProcessorRequest to an JSON string
   *
   * @return JSON string
   */
