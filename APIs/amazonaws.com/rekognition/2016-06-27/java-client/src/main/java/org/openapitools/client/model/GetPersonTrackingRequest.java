...
import org.openapitools.client.model.PersonTrackingSortBy;
...
public class GetPersonTrackingRequest {
  ...
  private PersonTrackingSortBy sortBy;

  public GetPersonTrackingRequest() {
  }

  public GetPersonTrackingRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetPersonTrackingRequest maxResults(Integer maxResults) {
  ...
  public GetPersonTrackingRequest nextToken(String nextToken) {
  ...
  public GetPersonTrackingRequest sortBy(PersonTrackingSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PersonTrackingSortBy getSortBy() {
    return sortBy;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPersonTrackingRequest getPersonTrackingRequest = (GetPersonTrackingRequest) o;
    return Objects.equals(this.jobId, getPersonTrackingRequest.jobId) &&
        Objects.equals(this.maxResults, getPersonTrackingRequest.maxResults) &&
        Objects.equals(this.nextToken, getPersonTrackingRequest.nextToken) &&
        Objects.equals(this.sortBy, getPersonTrackingRequest.sortBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, maxResults, nextToken, sortBy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPersonTrackingRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPersonTrackingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPersonTrackingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPersonTrackingRequest is not found in the empty JSON string", GetPersonTrackingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPersonTrackingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPersonTrackingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPersonTrackingRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("SortBy") != null && !jsonObj.get("SortBy").isJsonNull()) {
        PersonTrackingSortBy.validateJsonElement(jsonObj.get("SortBy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPersonTrackingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPersonTrackingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPersonTrackingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPersonTrackingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPersonTrackingRequest>() {
           @Override
           public void write(JsonWriter out, GetPersonTrackingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPersonTrackingRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPersonTrackingRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPersonTrackingRequest
   * @throws IOException if the JSON string is invalid with respect to GetPersonTrackingRequest
   */
  public static GetPersonTrackingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPersonTrackingRequest.class);
  }

  /**
   * Convert an instance of GetPersonTrackingRequest to an JSON string
   *
   * @return JSON string
   */
