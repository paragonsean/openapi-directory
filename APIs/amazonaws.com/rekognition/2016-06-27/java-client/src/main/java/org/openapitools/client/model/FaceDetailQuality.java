...
public class FaceDetailQuality {
  ...
  public FaceDetailQuality() {
  }

  public FaceDetailQuality brightness(Float brightness) {
  ...
  public FaceDetailQuality sharpness(Float sharpness) {
  ...
  public boolean equals(Object o) {
    ...
    FaceDetailQuality faceDetailQuality = (FaceDetailQuality) o;
    return Objects.equals(this.brightness, faceDetailQuality.brightness) &&
        Objects.equals(this.sharpness, faceDetailQuality.sharpness);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetailQuality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceDetailQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceDetailQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceDetailQuality is not found in the empty JSON string", FaceDetailQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceDetailQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetailQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceDetailQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceDetailQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceDetailQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceDetailQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceDetailQuality>() {
           @Override
           public void write(JsonWriter out, FaceDetailQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceDetailQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceDetailQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceDetailQuality
   * @throws IOException if the JSON string is invalid with respect to FaceDetailQuality
   */
  public static FaceDetailQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceDetailQuality.class);
  }

  /**
   * Convert an instance of FaceDetailQuality to an JSON string
   *
   * @return JSON string
   */
