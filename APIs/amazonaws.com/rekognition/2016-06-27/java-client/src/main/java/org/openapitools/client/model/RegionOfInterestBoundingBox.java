...
public class RegionOfInterestBoundingBox {
  ...
  public RegionOfInterestBoundingBox() {
  }

  public RegionOfInterestBoundingBox width(Float width) {
    this.width = width;
    return this;
  }
  ...
  public RegionOfInterestBoundingBox height(Float height) {
    this.height = height;
    return this;
  }
  ...
  public RegionOfInterestBoundingBox left(Float left) {
    this.left = left;
    return this;
  }
  ...
  public RegionOfInterestBoundingBox top(Float top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegionOfInterestBoundingBox regionOfInterestBoundingBox = (RegionOfInterestBoundingBox) o;
    return Objects.equals(this.width, regionOfInterestBoundingBox.width) &&
        Objects.equals(this.height, regionOfInterestBoundingBox.height) &&
        Objects.equals(this.left, regionOfInterestBoundingBox.left) &&
        Objects.equals(this.top, regionOfInterestBoundingBox.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegionOfInterestBoundingBox {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegionOfInterestBoundingBox
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegionOfInterestBoundingBox.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegionOfInterestBoundingBox is not found in the empty JSON string", RegionOfInterestBoundingBox.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegionOfInterestBoundingBox.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegionOfInterestBoundingBox` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegionOfInterestBoundingBox.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegionOfInterestBoundingBox' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegionOfInterestBoundingBox> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegionOfInterestBoundingBox.class));

       return (TypeAdapter<T>) new TypeAdapter<RegionOfInterestBoundingBox>() {
           @Override
           public void write(JsonWriter out, RegionOfInterestBoundingBox value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegionOfInterestBoundingBox read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegionOfInterestBoundingBox given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegionOfInterestBoundingBox
   * @throws IOException if the JSON string is invalid with respect to RegionOfInterestBoundingBox
   */
  public static RegionOfInterestBoundingBox fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegionOfInterestBoundingBox.class);
  }

  /**
   * Convert an instance of RegionOfInterestBoundingBox to an JSON string
   *
   * @return JSON string
   */
