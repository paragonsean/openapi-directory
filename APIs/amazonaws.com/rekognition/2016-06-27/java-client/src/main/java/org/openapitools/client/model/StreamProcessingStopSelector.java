...
public class StreamProcessingStopSelector {
  ...
  public StreamProcessingStopSelector maxDurationInSeconds(Integer maxDurationInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    StreamProcessingStopSelector streamProcessingStopSelector = (StreamProcessingStopSelector) o;
    return Objects.equals(this.maxDurationInSeconds, streamProcessingStopSelector.maxDurationInSeconds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxDurationInSeconds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamProcessingStopSelector {\n");
  ...
  static {
    ...
    openapiFields.add("MaxDurationInSeconds");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamProcessingStopSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamProcessingStopSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamProcessingStopSelector is not found in the empty JSON string", StreamProcessingStopSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamProcessingStopSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamProcessingStopSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `MaxDurationInSeconds`
      if (jsonObj.get("MaxDurationInSeconds") != null && !jsonObj.get("MaxDurationInSeconds").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("MaxDurationInSeconds"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamProcessingStopSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamProcessingStopSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamProcessingStopSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamProcessingStopSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamProcessingStopSelector>() {
           @Override
           public void write(JsonWriter out, StreamProcessingStopSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamProcessingStopSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamProcessingStopSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamProcessingStopSelector
   * @throws IOException if the JSON string is invalid with respect to StreamProcessingStopSelector
   */
  public static StreamProcessingStopSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamProcessingStopSelector.class);
  }

  /**
   * Convert an instance of StreamProcessingStopSelector to an JSON string
   *
   * @return JSON string
   */
