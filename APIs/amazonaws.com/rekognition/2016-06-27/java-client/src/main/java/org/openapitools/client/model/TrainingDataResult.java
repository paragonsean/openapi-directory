...
public class TrainingDataResult {
  ...
  public TrainingDataResult input(TrainingDataResultInput input) {
    this.input = input;
    return this;
  }
  ...
  public TrainingDataResult output(TrainingDataResultOutput output) {
    this.output = output;
    return this;
  }
  ...
  public TrainingDataResult validation(TrainingDataResultValidation validation) {
  ...
  public boolean equals(Object o) {
    ...
    TrainingDataResult trainingDataResult = (TrainingDataResult) o;
    return Objects.equals(this.input, trainingDataResult.input) &&
        Objects.equals(this.output, trainingDataResult.output) &&
        Objects.equals(this.validation, trainingDataResult.validation);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrainingDataResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrainingDataResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrainingDataResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrainingDataResult is not found in the empty JSON string", TrainingDataResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrainingDataResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrainingDataResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrainingDataResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrainingDataResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrainingDataResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrainingDataResult.class));

       return (TypeAdapter<T>) new TypeAdapter<TrainingDataResult>() {
           @Override
           public void write(JsonWriter out, TrainingDataResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrainingDataResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrainingDataResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrainingDataResult
   * @throws IOException if the JSON string is invalid with respect to TrainingDataResult
   */
  public static TrainingDataResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrainingDataResult.class);
  }

  /**
   * Convert an instance of TrainingDataResult to an JSON string
   *
   * @return JSON string
   */
