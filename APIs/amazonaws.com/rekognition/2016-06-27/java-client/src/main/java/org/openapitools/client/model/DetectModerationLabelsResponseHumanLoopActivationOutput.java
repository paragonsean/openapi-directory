...
public class DetectModerationLabelsResponseHumanLoopActivationOutput {
  ...
  public DetectModerationLabelsResponseHumanLoopActivationOutput() {
  }

  public DetectModerationLabelsResponseHumanLoopActivationOutput humanLoopArn(String humanLoopArn) {
  ...
  public DetectModerationLabelsResponseHumanLoopActivationOutput humanLoopActivationReasons(List humanLoopActivationReasons) {
  ...
  public DetectModerationLabelsResponseHumanLoopActivationOutput humanLoopActivationConditionsEvaluationResults(String humanLoopActivationConditionsEvaluationResults) {
  ...
  public boolean equals(Object o) {
    ...
    DetectModerationLabelsResponseHumanLoopActivationOutput detectModerationLabelsResponseHumanLoopActivationOutput = (DetectModerationLabelsResponseHumanLoopActivationOutput) o;
    return Objects.equals(this.humanLoopArn, detectModerationLabelsResponseHumanLoopActivationOutput.humanLoopArn) &&
        Objects.equals(this.humanLoopActivationReasons, detectModerationLabelsResponseHumanLoopActivationOutput.humanLoopActivationReasons) &&
        Objects.equals(this.humanLoopActivationConditionsEvaluationResults, detectModerationLabelsResponseHumanLoopActivationOutput.humanLoopActivationConditionsEvaluationResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectModerationLabelsResponseHumanLoopActivationOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectModerationLabelsResponseHumanLoopActivationOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectModerationLabelsResponseHumanLoopActivationOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectModerationLabelsResponseHumanLoopActivationOutput is not found in the empty JSON string", DetectModerationLabelsResponseHumanLoopActivationOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectModerationLabelsResponseHumanLoopActivationOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectModerationLabelsResponseHumanLoopActivationOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectModerationLabelsResponseHumanLoopActivationOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectModerationLabelsResponseHumanLoopActivationOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectModerationLabelsResponseHumanLoopActivationOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectModerationLabelsResponseHumanLoopActivationOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectModerationLabelsResponseHumanLoopActivationOutput>() {
           @Override
           public void write(JsonWriter out, DetectModerationLabelsResponseHumanLoopActivationOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectModerationLabelsResponseHumanLoopActivationOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectModerationLabelsResponseHumanLoopActivationOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectModerationLabelsResponseHumanLoopActivationOutput
   * @throws IOException if the JSON string is invalid with respect to DetectModerationLabelsResponseHumanLoopActivationOutput
   */
  public static DetectModerationLabelsResponseHumanLoopActivationOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectModerationLabelsResponseHumanLoopActivationOutput.class);
  }

  /**
   * Convert an instance of DetectModerationLabelsResponseHumanLoopActivationOutput to an JSON string
   *
   * @return JSON string
   */
