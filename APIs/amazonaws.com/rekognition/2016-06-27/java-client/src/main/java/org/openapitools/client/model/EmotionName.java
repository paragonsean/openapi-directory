...
/**
 * Gets or Sets EmotionName
 */
@JsonAdapter(EmotionName.Adapter.class)
public enum EmotionName {
  ...
  public static EmotionName fromValue(String value) {
    for (EmotionName b : EmotionName.values()) {
  ...
  public static class Adapter extends TypeAdapter<EmotionName> {
    @Override
    public void write(final JsonWriter jsonWriter, final EmotionName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EmotionName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EmotionName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EmotionName.fromValue(value);
  }
}
