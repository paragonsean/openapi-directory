...
import org.openapitools.client.model.GetFaceDetectionResponseVideoMetadata;
...
public class GetFaceDetectionResponse {
  ...
  private GetFaceDetectionResponseVideoMetadata videoMetadata;
  ...
  public GetFaceDetectionResponse jobStatus(VideoJobStatus jobStatus) {
  ...
  public GetFaceDetectionResponse statusMessage(String statusMessage) {
  ...
  public GetFaceDetectionResponse videoMetadata(GetFaceDetectionResponseVideoMetadata videoMetadata) {
   ...
   */
  @javax.annotation.Nullable
  public GetFaceDetectionResponseVideoMetadata getVideoMetadata() {
    return videoMetadata;
  }

  public void setVideoMetadata(GetFaceDetectionResponseVideoMetadata videoMetadata) {
    this.videoMetadata = videoMetadata;
  }


  public GetFaceDetectionResponse nextToken(String nextToken) {
  ...
  public GetFaceDetectionResponse faces(List faces) {
    this.faces = faces;
    return this;
  }
  ...
  public GetFaceDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetFaceDetectionResponse video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public GetFaceDetectionResponse jobTag(String jobTag) {
    this.jobTag = jobTag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetFaceDetectionResponse getFaceDetectionResponse = (GetFaceDetectionResponse) o;
    return Objects.equals(this.jobStatus, getFaceDetectionResponse.jobStatus) &&
        Objects.equals(this.statusMessage, getFaceDetectionResponse.statusMessage) &&
        Objects.equals(this.videoMetadata, getFaceDetectionResponse.videoMetadata) &&
        Objects.equals(this.nextToken, getFaceDetectionResponse.nextToken) &&
        Objects.equals(this.faces, getFaceDetectionResponse.faces) &&
        Objects.equals(this.jobId, getFaceDetectionResponse.jobId) &&
        Objects.equals(this.video, getFaceDetectionResponse.video) &&
        Objects.equals(this.jobTag, getFaceDetectionResponse.jobTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobStatus, statusMessage, videoMetadata, nextToken, faces, jobId, video, jobTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetFaceDetectionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFaceDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFaceDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFaceDetectionResponse is not found in the empty JSON string", GetFaceDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFaceDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFaceDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("VideoMetadata") != null && !jsonObj.get("VideoMetadata").isJsonNull()) {
        GetFaceDetectionResponseVideoMetadata.validateJsonElement(jsonObj.get("VideoMetadata"));
      }
      // validate the optional field `NextToken`
      if (jsonObj.get("NextToken") != null && !jsonObj.get("NextToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("NextToken"));
      }
      // validate the optional field `Faces`
      if (jsonObj.get("Faces") != null && !jsonObj.get("Faces").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Faces"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFaceDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFaceDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFaceDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFaceDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFaceDetectionResponse>() {
           @Override
           public void write(JsonWriter out, GetFaceDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFaceDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFaceDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFaceDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to GetFaceDetectionResponse
   */
  public static GetFaceDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFaceDetectionResponse.class);
  }

  /**
   * Convert an instance of GetFaceDetectionResponse to an JSON string
   *
   * @return JSON string
   */
