...
/**
 * Gets or Sets FaceSearchSortBy
 */
@JsonAdapter(FaceSearchSortBy.Adapter.class)
public enum FaceSearchSortBy {
  ...
  public static FaceSearchSortBy fromValue(String value) {
    for (FaceSearchSortBy b : FaceSearchSortBy.values()) {
  ...
  public static class Adapter extends TypeAdapter<FaceSearchSortBy> {
    @Override
    public void write(final JsonWriter jsonWriter, final FaceSearchSortBy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FaceSearchSortBy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FaceSearchSortBy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FaceSearchSortBy.fromValue(value);
  }
}
