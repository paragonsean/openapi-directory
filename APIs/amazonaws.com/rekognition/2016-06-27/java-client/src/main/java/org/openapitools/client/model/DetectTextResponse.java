...
public class DetectTextResponse {
  ...
  public DetectTextResponse textDetections(List textDetections) {
  ...
  public DetectTextResponse textModelVersion(String textModelVersion) {
  ...
  public boolean equals(Object o) {
    ...
    DetectTextResponse detectTextResponse = (DetectTextResponse) o;
    return Objects.equals(this.textDetections, detectTextResponse.textDetections) &&
        Objects.equals(this.textModelVersion, detectTextResponse.textModelVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(textDetections, textModelVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectTextResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectTextResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectTextResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectTextResponse is not found in the empty JSON string", DetectTextResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectTextResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectTextResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectTextResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectTextResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectTextResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectTextResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectTextResponse>() {
           @Override
           public void write(JsonWriter out, DetectTextResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectTextResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectTextResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectTextResponse
   * @throws IOException if the JSON string is invalid with respect to DetectTextResponse
   */
  public static DetectTextResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectTextResponse.class);
  }

  /**
   * Convert an instance of DetectTextResponse to an JSON string
   *
   * @return JSON string
   */
