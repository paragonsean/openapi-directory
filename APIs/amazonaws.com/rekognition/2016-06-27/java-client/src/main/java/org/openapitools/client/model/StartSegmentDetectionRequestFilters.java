...
import org.openapitools.client.model.StartSegmentDetectionFiltersShotFilter;
import org.openapitools.client.model.StartSegmentDetectionFiltersTechnicalCueFilter;
...
public class StartSegmentDetectionRequestFilters {
  public static final String SERIALIZED_NAME_TECHNICAL_CUE_FILTER = "TechnicalCueFilter";
  @SerializedName(SERIALIZED_NAME_TECHNICAL_CUE_FILTER)
  private StartSegmentDetectionFiltersTechnicalCueFilter technicalCueFilter;

  public static final String SERIALIZED_NAME_SHOT_FILTER = "ShotFilter";
  @SerializedName(SERIALIZED_NAME_SHOT_FILTER)
  private StartSegmentDetectionFiltersShotFilter shotFilter;

  public StartSegmentDetectionRequestFilters() {
  }

  public StartSegmentDetectionRequestFilters technicalCueFilter(StartSegmentDetectionFiltersTechnicalCueFilter technicalCueFilter) {
    this.technicalCueFilter = technicalCueFilter;
    return this;
  }

  /**
   * Get technicalCueFilter
   * @return technicalCueFilter
   */
  @javax.annotation.Nullable
  public StartSegmentDetectionFiltersTechnicalCueFilter getTechnicalCueFilter() {
    return technicalCueFilter;
  }

  public void setTechnicalCueFilter(StartSegmentDetectionFiltersTechnicalCueFilter technicalCueFilter) {
    this.technicalCueFilter = technicalCueFilter;
  }


  public StartSegmentDetectionRequestFilters shotFilter(StartSegmentDetectionFiltersShotFilter shotFilter) {
   ...
   */
  @javax.annotation.Nullable
  public StartSegmentDetectionFiltersShotFilter getShotFilter() {
    return shotFilter;
  }

  public void setShotFilter(StartSegmentDetectionFiltersShotFilter shotFilter) {
    this.shotFilter = shotFilter;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartSegmentDetectionRequestFilters startSegmentDetectionRequestFilters = (StartSegmentDetectionRequestFilters) o;
    return Objects.equals(this.technicalCueFilter, startSegmentDetectionRequestFilters.technicalCueFilter) &&
        Objects.equals(this.shotFilter, startSegmentDetectionRequestFilters.shotFilter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(technicalCueFilter, shotFilter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartSegmentDetectionRequestFilters {\n");
    sb.append("    technicalCueFilter: ").append(toIndentedString(technicalCueFilter)).append("\n");
    sb.append("    shotFilter: ").append(toIndentedString(shotFilter)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("TechnicalCueFilter");
    openapiFields.add("ShotFilter");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSegmentDetectionRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSegmentDetectionRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSegmentDetectionRequestFilters is not found in the empty JSON string", StartSegmentDetectionRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSegmentDetectionRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSegmentDetectionRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `TechnicalCueFilter`
      if (jsonObj.get("TechnicalCueFilter") != null && !jsonObj.get("TechnicalCueFilter").isJsonNull()) {
        StartSegmentDetectionFiltersTechnicalCueFilter.validateJsonElement(jsonObj.get("TechnicalCueFilter"));
      }
      // validate the optional field `ShotFilter`
      if (jsonObj.get("ShotFilter") != null && !jsonObj.get("ShotFilter").isJsonNull()) {
        StartSegmentDetectionFiltersShotFilter.validateJsonElement(jsonObj.get("ShotFilter"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSegmentDetectionRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSegmentDetectionRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSegmentDetectionRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSegmentDetectionRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSegmentDetectionRequestFilters>() {
           @Override
           public void write(JsonWriter out, StartSegmentDetectionRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSegmentDetectionRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSegmentDetectionRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSegmentDetectionRequestFilters
   * @throws IOException if the JSON string is invalid with respect to StartSegmentDetectionRequestFilters
   */
  public static StartSegmentDetectionRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSegmentDetectionRequestFilters.class);
  }

  /**
   * Convert an instance of StartSegmentDetectionRequestFilters to an JSON string
   *
   * @return JSON string
   */
