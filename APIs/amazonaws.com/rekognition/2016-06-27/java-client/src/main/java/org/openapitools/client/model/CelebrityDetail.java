...
public class CelebrityDetail {
  ...
  public CelebrityDetail urls(List urls) {
    this.urls = urls;
    return this;
  }
  ...
  public CelebrityDetail name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CelebrityDetail id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CelebrityDetail confidence(Float confidence) {
  ...
  public CelebrityDetail boundingBox(CelebrityDetailBoundingBox boundingBox) {
   ...
   */
  @javax.annotation.Nullable
  public CelebrityDetailBoundingBox getBoundingBox() {
    return boundingBox;
  }

  public void setBoundingBox(CelebrityDetailBoundingBox boundingBox) {
    this.boundingBox = boundingBox;
  }


  public CelebrityDetail face(CelebrityDetailFace face) {
    this.face = face;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CelebrityDetailFace getFace() {
    return face;
  }

  public void setFace(CelebrityDetailFace face) {
    this.face = face;
  }


  public CelebrityDetail knownGender(GetCelebrityInfoResponseKnownGender knownGender) {
  ...
  public boolean equals(Object o) {
    ...
    CelebrityDetail celebrityDetail = (CelebrityDetail) o;
    return Objects.equals(this.urls, celebrityDetail.urls) &&
        Objects.equals(this.name, celebrityDetail.name) &&
        Objects.equals(this.id, celebrityDetail.id) &&
        Objects.equals(this.confidence, celebrityDetail.confidence) &&
        Objects.equals(this.boundingBox, celebrityDetail.boundingBox) &&
        Objects.equals(this.face, celebrityDetail.face) &&
        Objects.equals(this.knownGender, celebrityDetail.knownGender);
  }

  @Override
  public int hashCode() {
    return Objects.hash(urls, name, id, confidence, boundingBox, face, knownGender);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CelebrityDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CelebrityDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CelebrityDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CelebrityDetail is not found in the empty JSON string", CelebrityDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CelebrityDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CelebrityDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("BoundingBox") != null && !jsonObj.get("BoundingBox").isJsonNull()) {
        CelebrityDetailBoundingBox.validateJsonElement(jsonObj.get("BoundingBox"));
      }
      // validate the optional field `Face`
      if (jsonObj.get("Face") != null && !jsonObj.get("Face").isJsonNull()) {
        CelebrityDetailFace.validateJsonElement(jsonObj.get("Face"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CelebrityDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CelebrityDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CelebrityDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CelebrityDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<CelebrityDetail>() {
           @Override
           public void write(JsonWriter out, CelebrityDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CelebrityDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CelebrityDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CelebrityDetail
   * @throws IOException if the JSON string is invalid with respect to CelebrityDetail
   */
  public static CelebrityDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CelebrityDetail.class);
  }

  /**
   * Convert an instance of CelebrityDetail to an JSON string
   *
   * @return JSON string
   */
