...
public class StartLabelDetectionResponse {
  ...
  public StartLabelDetectionResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartLabelDetectionResponse startLabelDetectionResponse = (StartLabelDetectionResponse) o;
    return Objects.equals(this.jobId, startLabelDetectionResponse.jobId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartLabelDetectionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartLabelDetectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartLabelDetectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartLabelDetectionResponse is not found in the empty JSON string", StartLabelDetectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartLabelDetectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartLabelDetectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartLabelDetectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartLabelDetectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartLabelDetectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartLabelDetectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartLabelDetectionResponse>() {
           @Override
           public void write(JsonWriter out, StartLabelDetectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartLabelDetectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartLabelDetectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartLabelDetectionResponse
   * @throws IOException if the JSON string is invalid with respect to StartLabelDetectionResponse
   */
  public static StartLabelDetectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartLabelDetectionResponse.class);
  }

  /**
   * Convert an instance of StartLabelDetectionResponse to an JSON string
   *
   * @return JSON string
   */
