...
public class DetectProtectiveEquipmentRequestSummarizationAttributes {
  ...
  public DetectProtectiveEquipmentRequestSummarizationAttributes() {
  }

  public DetectProtectiveEquipmentRequestSummarizationAttributes minConfidence(Float minConfidence) {
  ...
  public DetectProtectiveEquipmentRequestSummarizationAttributes requiredEquipmentTypes(List requiredEquipmentTypes) {
  ...
  public boolean equals(Object o) {
    ...
    DetectProtectiveEquipmentRequestSummarizationAttributes detectProtectiveEquipmentRequestSummarizationAttributes = (DetectProtectiveEquipmentRequestSummarizationAttributes) o;
    return Objects.equals(this.minConfidence, detectProtectiveEquipmentRequestSummarizationAttributes.minConfidence) &&
        Objects.equals(this.requiredEquipmentTypes, detectProtectiveEquipmentRequestSummarizationAttributes.requiredEquipmentTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectProtectiveEquipmentRequestSummarizationAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectProtectiveEquipmentRequestSummarizationAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectProtectiveEquipmentRequestSummarizationAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectProtectiveEquipmentRequestSummarizationAttributes is not found in the empty JSON string", DetectProtectiveEquipmentRequestSummarizationAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectProtectiveEquipmentRequestSummarizationAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectProtectiveEquipmentRequestSummarizationAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectProtectiveEquipmentRequestSummarizationAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectProtectiveEquipmentRequestSummarizationAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectProtectiveEquipmentRequestSummarizationAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectProtectiveEquipmentRequestSummarizationAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectProtectiveEquipmentRequestSummarizationAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectProtectiveEquipmentRequestSummarizationAttributes>() {
           @Override
           public void write(JsonWriter out, DetectProtectiveEquipmentRequestSummarizationAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectProtectiveEquipmentRequestSummarizationAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectProtectiveEquipmentRequestSummarizationAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectProtectiveEquipmentRequestSummarizationAttributes
   * @throws IOException if the JSON string is invalid with respect to DetectProtectiveEquipmentRequestSummarizationAttributes
   */
  public static DetectProtectiveEquipmentRequestSummarizationAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectProtectiveEquipmentRequestSummarizationAttributes.class);
  }

  /**
   * Convert an instance of DetectProtectiveEquipmentRequestSummarizationAttributes to an JSON string
   *
   * @return JSON string
   */
