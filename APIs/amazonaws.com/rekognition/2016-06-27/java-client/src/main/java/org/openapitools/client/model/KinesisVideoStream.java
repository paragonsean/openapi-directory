...
public class KinesisVideoStream {
  ...
  public KinesisVideoStream arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KinesisVideoStream kinesisVideoStream = (KinesisVideoStream) o;
    return Objects.equals(this.arn, kinesisVideoStream.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class KinesisVideoStream {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KinesisVideoStream
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KinesisVideoStream.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KinesisVideoStream is not found in the empty JSON string", KinesisVideoStream.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KinesisVideoStream.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KinesisVideoStream` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KinesisVideoStream.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KinesisVideoStream' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KinesisVideoStream> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KinesisVideoStream.class));

       return (TypeAdapter<T>) new TypeAdapter<KinesisVideoStream>() {
           @Override
           public void write(JsonWriter out, KinesisVideoStream value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KinesisVideoStream read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KinesisVideoStream given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KinesisVideoStream
   * @throws IOException if the JSON string is invalid with respect to KinesisVideoStream
   */
  public static KinesisVideoStream fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KinesisVideoStream.class);
  }

  /**
   * Convert an instance of KinesisVideoStream to an JSON string
   *
   * @return JSON string
   */
