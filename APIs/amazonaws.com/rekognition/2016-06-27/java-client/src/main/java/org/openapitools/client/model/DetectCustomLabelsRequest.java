...
public class DetectCustomLabelsRequest {
  ...
  public DetectCustomLabelsRequest() {
  }

  public DetectCustomLabelsRequest projectVersionArn(String projectVersionArn) {
  ...
  public DetectCustomLabelsRequest image(Image image) {
    this.image = image;
    return this;
  }
  ...
  public DetectCustomLabelsRequest maxResults(Integer maxResults) {
  ...
  public DetectCustomLabelsRequest minConfidence(Float minConfidence) {
  ...
  public boolean equals(Object o) {
    ...
    DetectCustomLabelsRequest detectCustomLabelsRequest = (DetectCustomLabelsRequest) o;
    return Objects.equals(this.projectVersionArn, detectCustomLabelsRequest.projectVersionArn) &&
        Objects.equals(this.image, detectCustomLabelsRequest.image) &&
        Objects.equals(this.maxResults, detectCustomLabelsRequest.maxResults) &&
        Objects.equals(this.minConfidence, detectCustomLabelsRequest.minConfidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectVersionArn, image, maxResults, minConfidence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectCustomLabelsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectCustomLabelsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectCustomLabelsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectCustomLabelsRequest is not found in the empty JSON string", DetectCustomLabelsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectCustomLabelsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectCustomLabelsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectCustomLabelsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectCustomLabelsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectCustomLabelsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectCustomLabelsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectCustomLabelsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectCustomLabelsRequest>() {
           @Override
           public void write(JsonWriter out, DetectCustomLabelsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectCustomLabelsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectCustomLabelsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectCustomLabelsRequest
   * @throws IOException if the JSON string is invalid with respect to DetectCustomLabelsRequest
   */
  public static DetectCustomLabelsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectCustomLabelsRequest.class);
  }

  /**
   * Convert an instance of DetectCustomLabelsRequest to an JSON string
   *
   * @return JSON string
   */
