...
public class DatasetStats {
  ...
  public DatasetStats labeledEntries(Integer labeledEntries) {
  ...
  public DatasetStats totalEntries(Integer totalEntries) {
  ...
  public DatasetStats totalLabels(Integer totalLabels) {
  ...
  public DatasetStats errorEntries(Integer errorEntries) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.labeledEntries, datasetStats.labeledEntries) &&
        Objects.equals(this.totalEntries, datasetStats.totalEntries) &&
        Objects.equals(this.totalLabels, datasetStats.totalLabels) &&
        Objects.equals(this.errorEntries, datasetStats.errorEntries);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetStats is not found in the empty JSON string", DatasetStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetStats.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetStats>() {
           @Override
           public void write(JsonWriter out, DatasetStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetStats
   * @throws IOException if the JSON string is invalid with respect to DatasetStats
   */
  public static DatasetStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetStats.class);
  }

  /**
   * Convert an instance of DatasetStats to an JSON string
   *
   * @return JSON string
   */
