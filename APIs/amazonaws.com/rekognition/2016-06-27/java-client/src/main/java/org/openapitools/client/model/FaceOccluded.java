...
public class FaceOccluded {
  ...
  public FaceOccluded value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public FaceOccluded confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    FaceOccluded faceOccluded = (FaceOccluded) o;
    return Objects.equals(this.value, faceOccluded.value) &&
        Objects.equals(this.confidence, faceOccluded.confidence);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FaceOccluded
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaceOccluded.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FaceOccluded is not found in the empty JSON string", FaceOccluded.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaceOccluded.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceOccluded` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FaceOccluded.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FaceOccluded' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FaceOccluded> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FaceOccluded.class));

       return (TypeAdapter<T>) new TypeAdapter<FaceOccluded>() {
           @Override
           public void write(JsonWriter out, FaceOccluded value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FaceOccluded read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FaceOccluded given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FaceOccluded
   * @throws IOException if the JSON string is invalid with respect to FaceOccluded
   */
  public static FaceOccluded fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FaceOccluded.class);
  }

  /**
   * Convert an instance of FaceOccluded to an JSON string
   *
   * @return JSON string
   */
