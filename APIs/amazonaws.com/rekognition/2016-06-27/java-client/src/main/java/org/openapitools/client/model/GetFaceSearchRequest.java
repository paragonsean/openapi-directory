...
import org.openapitools.client.model.FaceSearchSortBy;
...
public class GetFaceSearchRequest {
  ...
  private FaceSearchSortBy sortBy;

  public GetFaceSearchRequest() {
  }

  public GetFaceSearchRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetFaceSearchRequest maxResults(Integer maxResults) {
  ...
  public GetFaceSearchRequest nextToken(String nextToken) {
  ...
  public GetFaceSearchRequest sortBy(FaceSearchSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public FaceSearchSortBy getSortBy() {
    return sortBy;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetFaceSearchRequest getFaceSearchRequest = (GetFaceSearchRequest) o;
    return Objects.equals(this.jobId, getFaceSearchRequest.jobId) &&
        Objects.equals(this.maxResults, getFaceSearchRequest.maxResults) &&
        Objects.equals(this.nextToken, getFaceSearchRequest.nextToken) &&
        Objects.equals(this.sortBy, getFaceSearchRequest.sortBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFaceSearchRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFaceSearchRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFaceSearchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFaceSearchRequest is not found in the empty JSON string", GetFaceSearchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFaceSearchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFaceSearchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFaceSearchRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("SortBy") != null && !jsonObj.get("SortBy").isJsonNull()) {
        FaceSearchSortBy.validateJsonElement(jsonObj.get("SortBy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFaceSearchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFaceSearchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFaceSearchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFaceSearchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFaceSearchRequest>() {
           @Override
           public void write(JsonWriter out, GetFaceSearchRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFaceSearchRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFaceSearchRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFaceSearchRequest
   * @throws IOException if the JSON string is invalid with respect to GetFaceSearchRequest
   */
  public static GetFaceSearchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFaceSearchRequest.class);
  }

  /**
   * Convert an instance of GetFaceSearchRequest to an JSON string
   *
   * @return JSON string
   */
