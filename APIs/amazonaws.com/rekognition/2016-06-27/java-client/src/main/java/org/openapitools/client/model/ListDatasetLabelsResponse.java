...
public class ListDatasetLabelsResponse {
  public static final String SERIALIZED_NAME_DATASET_LABEL_DESCRIPTIONS = "DatasetLabelDescriptions";
  @SerializedName(SERIALIZED_NAME_DATASET_LABEL_DESCRIPTIONS)
  private List datasetLabelDescriptions;
  ...
  public ListDatasetLabelsResponse datasetLabelDescriptions(List datasetLabelDescriptions) {
    this.datasetLabelDescriptions = datasetLabelDescriptions;
    return this;
  }

  /**
   * Get datasetLabelDescriptions
   * @return datasetLabelDescriptions
   */
  @javax.annotation.Nullable
  public List getDatasetLabelDescriptions() {
    return datasetLabelDescriptions;
  }

  public void setDatasetLabelDescriptions(List datasetLabelDescriptions) {
    this.datasetLabelDescriptions = datasetLabelDescriptions;
  }


  public ListDatasetLabelsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListDatasetLabelsResponse listDatasetLabelsResponse = (ListDatasetLabelsResponse) o;
    return Objects.equals(this.datasetLabelDescriptions, listDatasetLabelsResponse.datasetLabelDescriptions) &&
        Objects.equals(this.nextToken, listDatasetLabelsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datasetLabelDescriptions, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListDatasetLabelsResponse {\n");
    sb.append("    datasetLabelDescriptions: ").append(toIndentedString(datasetLabelDescriptions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("DatasetLabelDescriptions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDatasetLabelsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDatasetLabelsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDatasetLabelsResponse is not found in the empty JSON string", ListDatasetLabelsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDatasetLabelsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDatasetLabelsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DatasetLabelDescriptions`
      if (jsonObj.get("DatasetLabelDescriptions") != null && !jsonObj.get("DatasetLabelDescriptions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("DatasetLabelDescriptions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDatasetLabelsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDatasetLabelsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDatasetLabelsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDatasetLabelsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDatasetLabelsResponse>() {
           @Override
           public void write(JsonWriter out, ListDatasetLabelsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDatasetLabelsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDatasetLabelsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDatasetLabelsResponse
   * @throws IOException if the JSON string is invalid with respect to ListDatasetLabelsResponse
   */
  public static ListDatasetLabelsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDatasetLabelsResponse.class);
  }

  /**
   * Convert an instance of ListDatasetLabelsResponse to an JSON string
   *
   * @return JSON string
   */
