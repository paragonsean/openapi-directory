...
public class TestingData {
  ...
  public TestingData assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public TestingData autoCreate(Boolean autoCreate) {
  ...
  public boolean equals(Object o) {
    ...
    TestingData testingData = (TestingData) o;
    return Objects.equals(this.assets, testingData.assets) &&
        Objects.equals(this.autoCreate, testingData.autoCreate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestingData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestingData is not found in the empty JSON string", TestingData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestingData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestingData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestingData.class));

       return (TypeAdapter<T>) new TypeAdapter<TestingData>() {
           @Override
           public void write(JsonWriter out, TestingData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestingData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestingData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestingData
   * @throws IOException if the JSON string is invalid with respect to TestingData
   */
  public static TestingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestingData.class);
  }

  /**
   * Convert an instance of TestingData to an JSON string
   *
   * @return JSON string
   */
