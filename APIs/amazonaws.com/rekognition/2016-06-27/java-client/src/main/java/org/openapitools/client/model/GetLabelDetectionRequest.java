...
public class GetLabelDetectionRequest {
  ...
  public GetLabelDetectionRequest() {
  }

  public GetLabelDetectionRequest jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public GetLabelDetectionRequest maxResults(Integer maxResults) {
  ...
  public GetLabelDetectionRequest nextToken(String nextToken) {
  ...
  public GetLabelDetectionRequest sortBy(LabelDetectionSortBy sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public GetLabelDetectionRequest aggregateBy(LabelDetectionAggregateBy aggregateBy) {
  ...
  public boolean equals(Object o) {
    ...
    GetLabelDetectionRequest getLabelDetectionRequest = (GetLabelDetectionRequest) o;
    return Objects.equals(this.jobId, getLabelDetectionRequest.jobId) &&
        Objects.equals(this.maxResults, getLabelDetectionRequest.maxResults) &&
        Objects.equals(this.nextToken, getLabelDetectionRequest.nextToken) &&
        Objects.equals(this.sortBy, getLabelDetectionRequest.sortBy) &&
        Objects.equals(this.aggregateBy, getLabelDetectionRequest.aggregateBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, maxResults, nextToken, sortBy, aggregateBy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLabelDetectionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLabelDetectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLabelDetectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLabelDetectionRequest is not found in the empty JSON string", GetLabelDetectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLabelDetectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLabelDetectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetLabelDetectionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLabelDetectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLabelDetectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLabelDetectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLabelDetectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLabelDetectionRequest>() {
           @Override
           public void write(JsonWriter out, GetLabelDetectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLabelDetectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLabelDetectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLabelDetectionRequest
   * @throws IOException if the JSON string is invalid with respect to GetLabelDetectionRequest
   */
  public static GetLabelDetectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLabelDetectionRequest.class);
  }

  /**
   * Convert an instance of GetLabelDetectionRequest to an JSON string
   *
   * @return JSON string
   */
