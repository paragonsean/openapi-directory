...
public class DetectProtectiveEquipmentResponse {
  public static final String SERIALIZED_NAME_PROTECTIVE_EQUIPMENT_MODEL_VERSION = "ProtectiveEquipmentModelVersion";
  @SerializedName(SERIALIZED_NAME_PROTECTIVE_EQUIPMENT_MODEL_VERSION)
  ...
  private DetectProtectiveEquipmentResponseSummary summary;

  public DetectProtectiveEquipmentResponse() {
  }

  public DetectProtectiveEquipmentResponse protectiveEquipmentModelVersion(String protectiveEquipmentModelVersion) {
    this.protectiveEquipmentModelVersion = protectiveEquipmentModelVersion;
    return this;
  }

  /**
   * Get protectiveEquipmentModelVersion
  ...
  public DetectProtectiveEquipmentResponse persons(List persons) {
  ...
  public DetectProtectiveEquipmentResponse summary(DetectProtectiveEquipmentResponseSummary summary) {
   ...
   */
  @javax.annotation.Nullable
  public DetectProtectiveEquipmentResponseSummary getSummary() {
    return summary;
  }

  public void setSummary(DetectProtectiveEquipmentResponseSummary summary) {
    this.summary = summary;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectProtectiveEquipmentResponse detectProtectiveEquipmentResponse = (DetectProtectiveEquipmentResponse) o;
    return Objects.equals(this.protectiveEquipmentModelVersion, detectProtectiveEquipmentResponse.protectiveEquipmentModelVersion) &&
        Objects.equals(this.persons, detectProtectiveEquipmentResponse.persons) &&
        Objects.equals(this.summary, detectProtectiveEquipmentResponse.summary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(protectiveEquipmentModelVersion, persons, summary);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectProtectiveEquipmentResponse {\n");
    sb.append("    protectiveEquipmentModelVersion: ").append(toIndentedString(protectiveEquipmentModelVersion)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ProtectiveEquipmentModelVersion");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectProtectiveEquipmentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectProtectiveEquipmentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectProtectiveEquipmentResponse is not found in the empty JSON string", DetectProtectiveEquipmentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectProtectiveEquipmentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectProtectiveEquipmentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ProtectiveEquipmentModelVersion`
      if (jsonObj.get("ProtectiveEquipmentModelVersion") != null && !jsonObj.get("ProtectiveEquipmentModelVersion").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("ProtectiveEquipmentModelVersion"));
      }
      ...
      if (jsonObj.get("Summary") != null && !jsonObj.get("Summary").isJsonNull()) {
        DetectProtectiveEquipmentResponseSummary.validateJsonElement(jsonObj.get("Summary"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectProtectiveEquipmentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectProtectiveEquipmentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectProtectiveEquipmentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectProtectiveEquipmentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectProtectiveEquipmentResponse>() {
           @Override
           public void write(JsonWriter out, DetectProtectiveEquipmentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectProtectiveEquipmentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectProtectiveEquipmentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectProtectiveEquipmentResponse
   * @throws IOException if the JSON string is invalid with respect to DetectProtectiveEquipmentResponse
   */
  public static DetectProtectiveEquipmentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectProtectiveEquipmentResponse.class);
  }

  /**
   * Convert an instance of DetectProtectiveEquipmentResponse to an JSON string
   *
   * @return JSON string
   */
