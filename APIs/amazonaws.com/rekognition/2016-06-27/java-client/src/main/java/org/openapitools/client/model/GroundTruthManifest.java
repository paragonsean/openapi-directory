...
public class GroundTruthManifest {
  ...
  public GroundTruthManifest s3Object(S3Object s3Object) {
  ...
  public boolean equals(Object o) {
    ...
    GroundTruthManifest groundTruthManifest = (GroundTruthManifest) o;
    return Objects.equals(this.s3Object, groundTruthManifest.s3Object);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroundTruthManifest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroundTruthManifest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroundTruthManifest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroundTruthManifest is not found in the empty JSON string", GroundTruthManifest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroundTruthManifest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroundTruthManifest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroundTruthManifest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroundTruthManifest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroundTruthManifest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroundTruthManifest.class));

       return (TypeAdapter<T>) new TypeAdapter<GroundTruthManifest>() {
           @Override
           public void write(JsonWriter out, GroundTruthManifest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroundTruthManifest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GroundTruthManifest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GroundTruthManifest
   * @throws IOException if the JSON string is invalid with respect to GroundTruthManifest
   */
  public static GroundTruthManifest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroundTruthManifest.class);
  }

  /**
   * Convert an instance of GroundTruthManifest to an JSON string
   *
   * @return JSON string
   */
