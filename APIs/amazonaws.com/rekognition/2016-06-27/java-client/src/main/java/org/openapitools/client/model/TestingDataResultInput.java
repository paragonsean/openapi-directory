...
public class TestingDataResultInput {
  ...
  public TestingDataResultInput() {
  }

  public TestingDataResultInput assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public TestingDataResultInput autoCreate(Boolean autoCreate) {
  ...
  public boolean equals(Object o) {
    ...
    TestingDataResultInput testingDataResultInput = (TestingDataResultInput) o;
    return Objects.equals(this.assets, testingDataResultInput.assets) &&
        Objects.equals(this.autoCreate, testingDataResultInput.autoCreate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assets, autoCreate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestingDataResultInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestingDataResultInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestingDataResultInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestingDataResultInput is not found in the empty JSON string", TestingDataResultInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestingDataResultInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestingDataResultInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestingDataResultInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestingDataResultInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestingDataResultInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestingDataResultInput.class));

       return (TypeAdapter<T>) new TypeAdapter<TestingDataResultInput>() {
           @Override
           public void write(JsonWriter out, TestingDataResultInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestingDataResultInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestingDataResultInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestingDataResultInput
   * @throws IOException if the JSON string is invalid with respect to TestingDataResultInput
   */
  public static TestingDataResultInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestingDataResultInput.class);
  }

  /**
   * Convert an instance of TestingDataResultInput to an JSON string
   *
   * @return JSON string
   */
