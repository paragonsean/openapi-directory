...
public class ProtectiveEquipmentPerson {
  ...
  private ProtectiveEquipmentPersonBoundingBox boundingBox;
  ...
  public ProtectiveEquipmentPerson bodyParts(List bodyParts) {
  ...
  public ProtectiveEquipmentPerson boundingBox(ProtectiveEquipmentPersonBoundingBox boundingBox) {
   ...
   */
  @javax.annotation.Nullable
  public ProtectiveEquipmentPersonBoundingBox getBoundingBox() {
    return boundingBox;
  }

  public void setBoundingBox(ProtectiveEquipmentPersonBoundingBox boundingBox) {
    this.boundingBox = boundingBox;
  }


  public ProtectiveEquipmentPerson confidence(Float confidence) {
  ...
  public ProtectiveEquipmentPerson id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProtectiveEquipmentPerson protectiveEquipmentPerson = (ProtectiveEquipmentPerson) o;
    return Objects.equals(this.bodyParts, protectiveEquipmentPerson.bodyParts) &&
        Objects.equals(this.boundingBox, protectiveEquipmentPerson.boundingBox) &&
        Objects.equals(this.confidence, protectiveEquipmentPerson.confidence) &&
        Objects.equals(this.id, protectiveEquipmentPerson.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bodyParts, boundingBox, confidence, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProtectiveEquipmentPerson {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProtectiveEquipmentPerson
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProtectiveEquipmentPerson.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProtectiveEquipmentPerson is not found in the empty JSON string", ProtectiveEquipmentPerson.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProtectiveEquipmentPerson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProtectiveEquipmentPerson` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `BodyParts`
      if (jsonObj.get("BodyParts") != null && !jsonObj.get("BodyParts").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("BodyParts"));
      }
      // validate the optional field `BoundingBox`
      if (jsonObj.get("BoundingBox") != null && !jsonObj.get("BoundingBox").isJsonNull()) {
        ProtectiveEquipmentPersonBoundingBox.validateJsonElement(jsonObj.get("BoundingBox"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProtectiveEquipmentPerson.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProtectiveEquipmentPerson' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProtectiveEquipmentPerson> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProtectiveEquipmentPerson.class));

       return (TypeAdapter<T>) new TypeAdapter<ProtectiveEquipmentPerson>() {
           @Override
           public void write(JsonWriter out, ProtectiveEquipmentPerson value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProtectiveEquipmentPerson read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProtectiveEquipmentPerson given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProtectiveEquipmentPerson
   * @throws IOException if the JSON string is invalid with respect to ProtectiveEquipmentPerson
   */
  public static ProtectiveEquipmentPerson fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProtectiveEquipmentPerson.class);
  }

  /**
   * Convert an instance of ProtectiveEquipmentPerson to an JSON string
   *
   * @return JSON string
   */
