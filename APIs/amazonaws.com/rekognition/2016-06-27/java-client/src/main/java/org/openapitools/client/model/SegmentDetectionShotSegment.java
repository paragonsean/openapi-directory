...
public class SegmentDetectionShotSegment {
  ...
  public SegmentDetectionShotSegment() {
  }

  public SegmentDetectionShotSegment index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public SegmentDetectionShotSegment confidence(Float confidence) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentDetectionShotSegment segmentDetectionShotSegment = (SegmentDetectionShotSegment) o;
    return Objects.equals(this.index, segmentDetectionShotSegment.index) &&
        Objects.equals(this.confidence, segmentDetectionShotSegment.confidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(index, confidence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SegmentDetectionShotSegment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SegmentDetectionShotSegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SegmentDetectionShotSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentDetectionShotSegment is not found in the empty JSON string", SegmentDetectionShotSegment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentDetectionShotSegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentDetectionShotSegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentDetectionShotSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentDetectionShotSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentDetectionShotSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentDetectionShotSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentDetectionShotSegment>() {
           @Override
           public void write(JsonWriter out, SegmentDetectionShotSegment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SegmentDetectionShotSegment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SegmentDetectionShotSegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SegmentDetectionShotSegment
   * @throws IOException if the JSON string is invalid with respect to SegmentDetectionShotSegment
   */
  public static SegmentDetectionShotSegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentDetectionShotSegment.class);
  }

  /**
   * Convert an instance of SegmentDetectionShotSegment to an JSON string
   *
   * @return JSON string
   */
