...
public class GetContentModerationResponseVideoMetadata {
  ...
  public GetContentModerationResponseVideoMetadata() {
  }

  public GetContentModerationResponseVideoMetadata codec(String codec) {
    this.codec = codec;
    return this;
  }
  ...
  public GetContentModerationResponseVideoMetadata durationMillis(Integer durationMillis) {
  ...
  public GetContentModerationResponseVideoMetadata format(String format) {
    this.format = format;
    return this;
  }
  ...
  public GetContentModerationResponseVideoMetadata frameRate(Float frameRate) {
  ...
  public GetContentModerationResponseVideoMetadata frameHeight(Integer frameHeight) {
  ...
  public GetContentModerationResponseVideoMetadata frameWidth(Integer frameWidth) {
  ...
  public GetContentModerationResponseVideoMetadata colorRange(VideoColorRange colorRange) {
  ...
  public boolean equals(Object o) {
    ...
    GetContentModerationResponseVideoMetadata getContentModerationResponseVideoMetadata = (GetContentModerationResponseVideoMetadata) o;
    return Objects.equals(this.codec, getContentModerationResponseVideoMetadata.codec) &&
        Objects.equals(this.durationMillis, getContentModerationResponseVideoMetadata.durationMillis) &&
        Objects.equals(this.format, getContentModerationResponseVideoMetadata.format) &&
        Objects.equals(this.frameRate, getContentModerationResponseVideoMetadata.frameRate) &&
        Objects.equals(this.frameHeight, getContentModerationResponseVideoMetadata.frameHeight) &&
        Objects.equals(this.frameWidth, getContentModerationResponseVideoMetadata.frameWidth) &&
        Objects.equals(this.colorRange, getContentModerationResponseVideoMetadata.colorRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetContentModerationResponseVideoMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetContentModerationResponseVideoMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetContentModerationResponseVideoMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetContentModerationResponseVideoMetadata is not found in the empty JSON string", GetContentModerationResponseVideoMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetContentModerationResponseVideoMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetContentModerationResponseVideoMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetContentModerationResponseVideoMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetContentModerationResponseVideoMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetContentModerationResponseVideoMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetContentModerationResponseVideoMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetContentModerationResponseVideoMetadata>() {
           @Override
           public void write(JsonWriter out, GetContentModerationResponseVideoMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetContentModerationResponseVideoMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetContentModerationResponseVideoMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetContentModerationResponseVideoMetadata
   * @throws IOException if the JSON string is invalid with respect to GetContentModerationResponseVideoMetadata
   */
  public static GetContentModerationResponseVideoMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetContentModerationResponseVideoMetadata.class);
  }

  /**
   * Convert an instance of GetContentModerationResponseVideoMetadata to an JSON string
   *
   * @return JSON string
   */
