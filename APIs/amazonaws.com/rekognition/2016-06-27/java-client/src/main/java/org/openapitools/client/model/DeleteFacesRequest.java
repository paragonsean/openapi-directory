...
public class DeleteFacesRequest {
  ...
  public DeleteFacesRequest collectionId(String collectionId) {
  ...
  public DeleteFacesRequest faceIds(List faceIds) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFacesRequest deleteFacesRequest = (DeleteFacesRequest) o;
    return Objects.equals(this.collectionId, deleteFacesRequest.collectionId) &&
        Objects.equals(this.faceIds, deleteFacesRequest.faceIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, faceIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteFacesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFacesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFacesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFacesRequest is not found in the empty JSON string", DeleteFacesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFacesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFacesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFacesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFacesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFacesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFacesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFacesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFacesRequest>() {
           @Override
           public void write(JsonWriter out, DeleteFacesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFacesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFacesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFacesRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteFacesRequest
   */
  public static DeleteFacesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFacesRequest.class);
  }

  /**
   * Convert an instance of DeleteFacesRequest to an JSON string
   *
   * @return JSON string
   */
