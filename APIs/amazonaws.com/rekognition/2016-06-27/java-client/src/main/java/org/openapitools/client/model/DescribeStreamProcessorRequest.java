...
public class DescribeStreamProcessorRequest {
  ...
  public DescribeStreamProcessorRequest() {
  }

  public DescribeStreamProcessorRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeStreamProcessorRequest describeStreamProcessorRequest = (DescribeStreamProcessorRequest) o;
    return Objects.equals(this.name, describeStreamProcessorRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeStreamProcessorRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeStreamProcessorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeStreamProcessorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeStreamProcessorRequest is not found in the empty JSON string", DescribeStreamProcessorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeStreamProcessorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeStreamProcessorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeStreamProcessorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeStreamProcessorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeStreamProcessorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeStreamProcessorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeStreamProcessorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeStreamProcessorRequest>() {
           @Override
           public void write(JsonWriter out, DescribeStreamProcessorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeStreamProcessorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeStreamProcessorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeStreamProcessorRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeStreamProcessorRequest
   */
  public static DescribeStreamProcessorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeStreamProcessorRequest.class);
  }

  /**
   * Convert an instance of DescribeStreamProcessorRequest to an JSON string
   *
   * @return JSON string
   */
