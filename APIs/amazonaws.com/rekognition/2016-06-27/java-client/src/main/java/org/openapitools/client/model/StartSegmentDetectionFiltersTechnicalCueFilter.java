...
/**
 * StartSegmentDetectionFiltersTechnicalCueFilter
 */
...
public class StartSegmentDetectionFiltersTechnicalCueFilter {
  ...
  public StartSegmentDetectionFiltersTechnicalCueFilter() {
  }

  public StartSegmentDetectionFiltersTechnicalCueFilter minSegmentConfidence(Float minSegmentConfidence) {
  ...
  public StartSegmentDetectionFiltersTechnicalCueFilter blackFrame(StartTechnicalCueDetectionFilterBlackFrame blackFrame) {
  ...
  public boolean equals(Object o) {
    ...
    StartSegmentDetectionFiltersTechnicalCueFilter startSegmentDetectionFiltersTechnicalCueFilter = (StartSegmentDetectionFiltersTechnicalCueFilter) o;
    return Objects.equals(this.minSegmentConfidence, startSegmentDetectionFiltersTechnicalCueFilter.minSegmentConfidence) &&
        Objects.equals(this.blackFrame, startSegmentDetectionFiltersTechnicalCueFilter.blackFrame);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartSegmentDetectionFiltersTechnicalCueFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSegmentDetectionFiltersTechnicalCueFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSegmentDetectionFiltersTechnicalCueFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSegmentDetectionFiltersTechnicalCueFilter is not found in the empty JSON string", StartSegmentDetectionFiltersTechnicalCueFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSegmentDetectionFiltersTechnicalCueFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSegmentDetectionFiltersTechnicalCueFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSegmentDetectionFiltersTechnicalCueFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSegmentDetectionFiltersTechnicalCueFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSegmentDetectionFiltersTechnicalCueFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSegmentDetectionFiltersTechnicalCueFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSegmentDetectionFiltersTechnicalCueFilter>() {
           @Override
           public void write(JsonWriter out, StartSegmentDetectionFiltersTechnicalCueFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSegmentDetectionFiltersTechnicalCueFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSegmentDetectionFiltersTechnicalCueFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSegmentDetectionFiltersTechnicalCueFilter
   * @throws IOException if the JSON string is invalid with respect to StartSegmentDetectionFiltersTechnicalCueFilter
   */
  public static StartSegmentDetectionFiltersTechnicalCueFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSegmentDetectionFiltersTechnicalCueFilter.class);
  }

  /**
   * Convert an instance of StartSegmentDetectionFiltersTechnicalCueFilter to an JSON string
   *
   * @return JSON string
   */
