...
public class ProtectiveEquipmentBodyPart {
  ...
  public static final String SERIALIZED_NAME_EQUIPMENT_DETECTIONS = "EquipmentDetections";
  @SerializedName(SERIALIZED_NAME_EQUIPMENT_DETECTIONS)
  private List equipmentDetections;

  public ProtectiveEquipmentBodyPart() {
  }

  public ProtectiveEquipmentBodyPart name(BodyPart name) {
    this.name = name;
    return this;
  }
  ...
  public ProtectiveEquipmentBodyPart confidence(Float confidence) {
  ...
  public ProtectiveEquipmentBodyPart equipmentDetections(List equipmentDetections) {
    this.equipmentDetections = equipmentDetections;
    return this;
  }

  /**
   * Get equipmentDetections
   * @return equipmentDetections
   */
  @javax.annotation.Nullable
  public List getEquipmentDetections() {
    return equipmentDetections;
  }

  public void setEquipmentDetections(List equipmentDetections) {
    this.equipmentDetections = equipmentDetections;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProtectiveEquipmentBodyPart protectiveEquipmentBodyPart = (ProtectiveEquipmentBodyPart) o;
    return Objects.equals(this.name, protectiveEquipmentBodyPart.name) &&
        Objects.equals(this.confidence, protectiveEquipmentBodyPart.confidence) &&
        Objects.equals(this.equipmentDetections, protectiveEquipmentBodyPart.equipmentDetections);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, confidence, equipmentDetections);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProtectiveEquipmentBodyPart {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    confidence: ").append(toIndentedString(confidence)).append("\n");
    sb.append("    equipmentDetections: ").append(toIndentedString(equipmentDetections)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("EquipmentDetections");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProtectiveEquipmentBodyPart
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProtectiveEquipmentBodyPart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProtectiveEquipmentBodyPart is not found in the empty JSON string", ProtectiveEquipmentBodyPart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProtectiveEquipmentBodyPart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProtectiveEquipmentBodyPart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Name`
      if (jsonObj.get("Name") != null && !jsonObj.get("Name").isJsonNull()) {
        BodyPart.validateJsonElement(jsonObj.get("Name"));
      }
      ...
      // validate the optional field `EquipmentDetections`
      if (jsonObj.get("EquipmentDetections") != null && !jsonObj.get("EquipmentDetections").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("EquipmentDetections"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProtectiveEquipmentBodyPart.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProtectiveEquipmentBodyPart' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProtectiveEquipmentBodyPart> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProtectiveEquipmentBodyPart.class));

       return (TypeAdapter<T>) new TypeAdapter<ProtectiveEquipmentBodyPart>() {
           @Override
           public void write(JsonWriter out, ProtectiveEquipmentBodyPart value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProtectiveEquipmentBodyPart read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProtectiveEquipmentBodyPart given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProtectiveEquipmentBodyPart
   * @throws IOException if the JSON string is invalid with respect to ProtectiveEquipmentBodyPart
   */
  public static ProtectiveEquipmentBodyPart fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProtectiveEquipmentBodyPart.class);
  }

  /**
   * Convert an instance of ProtectiveEquipmentBodyPart to an JSON string
   *
   * @return JSON string
   */
