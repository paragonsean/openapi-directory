...
import org.openapitools.client.model.DetectProtectiveEquipmentRequestImage;
import org.openapitools.client.model.DetectProtectiveEquipmentRequestSummarizationAttributes;
...
public class DetectProtectiveEquipmentRequest {
  ...
  private DetectProtectiveEquipmentRequestImage image;

  public static final String SERIALIZED_NAME_SUMMARIZATION_ATTRIBUTES = "SummarizationAttributes";
  @SerializedName(SERIALIZED_NAME_SUMMARIZATION_ATTRIBUTES)
  private DetectProtectiveEquipmentRequestSummarizationAttributes summarizationAttributes;

  public DetectProtectiveEquipmentRequest() {
  }

  public DetectProtectiveEquipmentRequest image(DetectProtectiveEquipmentRequestImage image) {
    this.image = image;
    return this;
  }
  ...
  public DetectProtectiveEquipmentRequestImage getImage() {
    return image;
  }

  public void setImage(DetectProtectiveEquipmentRequestImage image) {
    this.image = image;
  }


  public DetectProtectiveEquipmentRequest summarizationAttributes(DetectProtectiveEquipmentRequestSummarizationAttributes summarizationAttributes) {
    this.summarizationAttributes = summarizationAttributes;
    return this;
  }

  /**
   * Get summarizationAttributes
   * @return summarizationAttributes
   */
  @javax.annotation.Nullable
  public DetectProtectiveEquipmentRequestSummarizationAttributes getSummarizationAttributes() {
    return summarizationAttributes;
  }

  public void setSummarizationAttributes(DetectProtectiveEquipmentRequestSummarizationAttributes summarizationAttributes) {
    this.summarizationAttributes = summarizationAttributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    DetectProtectiveEquipmentRequest detectProtectiveEquipmentRequest = (DetectProtectiveEquipmentRequest) o;
    return Objects.equals(this.image, detectProtectiveEquipmentRequest.image) &&
        Objects.equals(this.summarizationAttributes, detectProtectiveEquipmentRequest.summarizationAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(image, summarizationAttributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectProtectiveEquipmentRequest {\n");
    sb.append("    image: ").append(toIndentedString(image)).append("\n");
    sb.append("    summarizationAttributes: ").append(toIndentedString(summarizationAttributes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("SummarizationAttributes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectProtectiveEquipmentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectProtectiveEquipmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectProtectiveEquipmentRequest is not found in the empty JSON string", DetectProtectiveEquipmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectProtectiveEquipmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectProtectiveEquipmentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DetectProtectiveEquipmentRequest.openapiRequiredFields) {
      ...
      DetectProtectiveEquipmentRequestImage.validateJsonElement(jsonObj.get("Image"));
      // validate the optional field `SummarizationAttributes`
      if (jsonObj.get("SummarizationAttributes") != null && !jsonObj.get("SummarizationAttributes").isJsonNull()) {
        DetectProtectiveEquipmentRequestSummarizationAttributes.validateJsonElement(jsonObj.get("SummarizationAttributes"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectProtectiveEquipmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectProtectiveEquipmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectProtectiveEquipmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectProtectiveEquipmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectProtectiveEquipmentRequest>() {
           @Override
           public void write(JsonWriter out, DetectProtectiveEquipmentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectProtectiveEquipmentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectProtectiveEquipmentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectProtectiveEquipmentRequest
   * @throws IOException if the JSON string is invalid with respect to DetectProtectiveEquipmentRequest
   */
  public static DetectProtectiveEquipmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectProtectiveEquipmentRequest.class);
  }

  /**
   * Convert an instance of DetectProtectiveEquipmentRequest to an JSON string
   *
   * @return JSON string
   */
