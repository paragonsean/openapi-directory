...
public class MatchedUser {
  ...
  public MatchedUser userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public MatchedUser userStatus(UserStatus userStatus) {
  ...
  public boolean equals(Object o) {
    ...
    MatchedUser matchedUser = (MatchedUser) o;
    return Objects.equals(this.userId, matchedUser.userId) &&
        Objects.equals(this.userStatus, matchedUser.userStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MatchedUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchedUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MatchedUser is not found in the empty JSON string", MatchedUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchedUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchedUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MatchedUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MatchedUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MatchedUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MatchedUser.class));

       return (TypeAdapter<T>) new TypeAdapter<MatchedUser>() {
           @Override
           public void write(JsonWriter out, MatchedUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MatchedUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MatchedUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MatchedUser
   * @throws IOException if the JSON string is invalid with respect to MatchedUser
   */
  public static MatchedUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MatchedUser.class);
  }

  /**
   * Convert an instance of MatchedUser to an JSON string
   *
   * @return JSON string
   */
