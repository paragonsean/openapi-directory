...
public class ImageQuality {
  ...
  public ImageQuality brightness(Float brightness) {
  ...
  public ImageQuality sharpness(Float sharpness) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.brightness, imageQuality.brightness) &&
        Objects.equals(this.sharpness, imageQuality.sharpness);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImageQuality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImageQuality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageQuality is not found in the empty JSON string", ImageQuality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImageQuality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImageQuality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageQuality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageQuality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageQuality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageQuality.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageQuality>() {
           @Override
           public void write(JsonWriter out, ImageQuality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImageQuality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImageQuality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImageQuality
   * @throws IOException if the JSON string is invalid with respect to ImageQuality
   */
  public static ImageQuality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageQuality.class);
  }

  /**
   * Convert an instance of ImageQuality to an JSON string
   *
   * @return JSON string
   */
