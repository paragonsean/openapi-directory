...
/**
 * StartStreamProcessorRequestStartSelector
 */
...
public class StartStreamProcessorRequestStartSelector {
  ...
  public StartStreamProcessorRequestStartSelector() {
  }

  public StartStreamProcessorRequestStartSelector kvSStreamStartSelector(StreamProcessingStartSelectorKVSStreamStartSelector kvSStreamStartSelector) {
  ...
  public boolean equals(Object o) {
    ...
    StartStreamProcessorRequestStartSelector startStreamProcessorRequestStartSelector = (StartStreamProcessorRequestStartSelector) o;
    return Objects.equals(this.kvSStreamStartSelector, startStreamProcessorRequestStartSelector.kvSStreamStartSelector);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartStreamProcessorRequestStartSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartStreamProcessorRequestStartSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartStreamProcessorRequestStartSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartStreamProcessorRequestStartSelector is not found in the empty JSON string", StartStreamProcessorRequestStartSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartStreamProcessorRequestStartSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartStreamProcessorRequestStartSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartStreamProcessorRequestStartSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartStreamProcessorRequestStartSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartStreamProcessorRequestStartSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartStreamProcessorRequestStartSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<StartStreamProcessorRequestStartSelector>() {
           @Override
           public void write(JsonWriter out, StartStreamProcessorRequestStartSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartStreamProcessorRequestStartSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartStreamProcessorRequestStartSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartStreamProcessorRequestStartSelector
   * @throws IOException if the JSON string is invalid with respect to StartStreamProcessorRequestStartSelector
   */
  public static StartStreamProcessorRequestStartSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartStreamProcessorRequestStartSelector.class);
  }

  /**
   * Convert an instance of StartStreamProcessorRequestStartSelector to an JSON string
   *
   * @return JSON string
   */
