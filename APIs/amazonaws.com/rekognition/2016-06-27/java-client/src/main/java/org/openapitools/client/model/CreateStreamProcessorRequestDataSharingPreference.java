...
public class CreateStreamProcessorRequestDataSharingPreference {
  public static final String SERIALIZED_NAME_OPT_IN = "OptIn";
  @SerializedName(SERIALIZED_NAME_OPT_IN)
  private Boolean optIn;

  public CreateStreamProcessorRequestDataSharingPreference() {
  }

  public CreateStreamProcessorRequestDataSharingPreference optIn(Boolean optIn) {
    this.optIn = optIn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamProcessorRequestDataSharingPreference createStreamProcessorRequestDataSharingPreference = (CreateStreamProcessorRequestDataSharingPreference) o;
    return Objects.equals(this.optIn, createStreamProcessorRequestDataSharingPreference.optIn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStreamProcessorRequestDataSharingPreference {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamProcessorRequestDataSharingPreference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamProcessorRequestDataSharingPreference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamProcessorRequestDataSharingPreference is not found in the empty JSON string", CreateStreamProcessorRequestDataSharingPreference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamProcessorRequestDataSharingPreference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamProcessorRequestDataSharingPreference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateStreamProcessorRequestDataSharingPreference.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamProcessorRequestDataSharingPreference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamProcessorRequestDataSharingPreference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamProcessorRequestDataSharingPreference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamProcessorRequestDataSharingPreference.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamProcessorRequestDataSharingPreference>() {
           @Override
           public void write(JsonWriter out, CreateStreamProcessorRequestDataSharingPreference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamProcessorRequestDataSharingPreference read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamProcessorRequestDataSharingPreference given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamProcessorRequestDataSharingPreference
   * @throws IOException if the JSON string is invalid with respect to CreateStreamProcessorRequestDataSharingPreference
   */
  public static CreateStreamProcessorRequestDataSharingPreference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamProcessorRequestDataSharingPreference.class);
  }

  /**
   * Convert an instance of CreateStreamProcessorRequestDataSharingPreference to an JSON string
   *
   * @return JSON string
   */
