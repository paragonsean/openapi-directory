...
/**
 * CreateProjectVersionRequestOutputConfig
 */
...
public class CreateProjectVersionRequestOutputConfig {
  ...
  public CreateProjectVersionRequestOutputConfig() {
  }

  public CreateProjectVersionRequestOutputConfig s3Bucket(String s3Bucket) {
  ...
  public CreateProjectVersionRequestOutputConfig s3KeyPrefix(String s3KeyPrefix) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectVersionRequestOutputConfig createProjectVersionRequestOutputConfig = (CreateProjectVersionRequestOutputConfig) o;
    return Objects.equals(this.s3Bucket, createProjectVersionRequestOutputConfig.s3Bucket) &&
        Objects.equals(this.s3KeyPrefix, createProjectVersionRequestOutputConfig.s3KeyPrefix);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectVersionRequestOutputConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectVersionRequestOutputConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectVersionRequestOutputConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectVersionRequestOutputConfig is not found in the empty JSON string", CreateProjectVersionRequestOutputConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectVersionRequestOutputConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectVersionRequestOutputConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectVersionRequestOutputConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectVersionRequestOutputConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectVersionRequestOutputConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectVersionRequestOutputConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectVersionRequestOutputConfig>() {
           @Override
           public void write(JsonWriter out, CreateProjectVersionRequestOutputConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectVersionRequestOutputConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectVersionRequestOutputConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectVersionRequestOutputConfig
   * @throws IOException if the JSON string is invalid with respect to CreateProjectVersionRequestOutputConfig
   */
  public static CreateProjectVersionRequestOutputConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectVersionRequestOutputConfig.class);
  }

  /**
   * Convert an instance of CreateProjectVersionRequestOutputConfig to an JSON string
   *
   * @return JSON string
   */
