...
/**
 * Gets or Sets DatasetStatusMessageCode
 */
@JsonAdapter(DatasetStatusMessageCode.Adapter.class)
public enum DatasetStatusMessageCode {
  ...
  DatasetStatusMessageCode(String value) {
    this.value = value;
  }
  ...
  public static DatasetStatusMessageCode fromValue(String value) {
    for (DatasetStatusMessageCode b : DatasetStatusMessageCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<DatasetStatusMessageCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final DatasetStatusMessageCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DatasetStatusMessageCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DatasetStatusMessageCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DatasetStatusMessageCode.fromValue(value);
  }
}
