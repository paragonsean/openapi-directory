...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://rekognition.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://rekognition.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2016-06-27/Javascript'
        };
