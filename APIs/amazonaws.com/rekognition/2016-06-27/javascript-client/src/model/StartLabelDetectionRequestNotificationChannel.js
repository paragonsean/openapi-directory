...
/**
 * The StartLabelDetectionRequestNotificationChannel model module.
 * @module model/StartLabelDetectionRequestNotificationChannel
 * @version 2016-06-27
 */
class StartLabelDetectionRequestNotificationChannel {
    /**
     * Constructs a new <code>StartLabelDetectionRequestNotificationChannel</code>.
     * @alias module:model/StartLabelDetectionRequestNotificationChannel
    ...
    constructor(sNSTopicArn, roleArn) { 
        ...
        StartLabelDetectionRequestNotificationChannel.initialize(this, sNSTopicArn, roleArn);
    }
    ...
    /**
     * Constructs a <code>StartLabelDetectionRequestNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartLabelDetectionRequestNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StartLabelDetectionRequestNotificationChannel} The populated <code>StartLabelDetectionRequestNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartLabelDetectionRequestNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StartLabelDetectionRequestNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartLabelDetectionRequestNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartLabelDetectionRequestNotificationChannel.RequiredProperties) {
...
StartLabelDetectionRequestNotificationChannel.RequiredProperties = ["SNSTopicArn", "RoleArn"];

/**
 * @member {String} SNSTopicArn
 */
StartLabelDetectionRequestNotificationChannel.prototype['SNSTopicArn'] = undefined;

/**
 * @member {String} RoleArn
 */
StartLabelDetectionRequestNotificationChannel.prototype['RoleArn'] = undefined;
...
export default StartLabelDetectionRequestNotificationChannel;
