...
import SearchedFaceDetails from './SearchedFaceDetails';

/**
 * The SearchUsersByImageResponseSearchedFace model module.
 * @module model/SearchUsersByImageResponseSearchedFace
 * @version 2016-06-27
 */
class SearchUsersByImageResponseSearchedFace {
    /**
     * Constructs a new <code>SearchUsersByImageResponseSearchedFace</code>.
     * @alias module:model/SearchUsersByImageResponseSearchedFace
     * @implements module:model/SearchedFaceDetails
     */
    constructor() { 
        SearchedFaceDetails.initialize(this);
        SearchUsersByImageResponseSearchedFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchUsersByImageResponseSearchedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchUsersByImageResponseSearchedFace} obj Optional instance to populate.
     * @return {module:model/SearchUsersByImageResponseSearchedFace} The populated <code>SearchUsersByImageResponseSearchedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchUsersByImageResponseSearchedFace();
            SearchedFaceDetails.constructFromObject(data, obj);

            if (data.hasOwnProperty('FaceDetail')) {
                obj['FaceDetail'] = FaceDetail.constructFromObject(data['FaceDetail']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchUsersByImageResponseSearchedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchUsersByImageResponseSearchedFace</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FaceDetail`
        if (data['FaceDetail']) { // data not null
          FaceDetail.validateJSON(data['FaceDetail']);
        }
...
/**
 * @member {module:model/FaceDetail} FaceDetail
 */
SearchUsersByImageResponseSearchedFace.prototype['FaceDetail'] = undefined;


// Implement SearchedFaceDetails interface:
/**
 * @member {module:model/FaceDetail} FaceDetail
 */
SearchedFaceDetails.prototype['FaceDetail'] = undefined;




export default SearchUsersByImageResponseSearchedFace;
