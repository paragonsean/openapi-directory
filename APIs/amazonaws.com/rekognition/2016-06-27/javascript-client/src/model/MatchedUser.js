...
/**
 * The MatchedUser model module.
 * @module model/MatchedUser
 * @version 2016-06-27
 */
class MatchedUser {
    /**
     * Constructs a new <code>MatchedUser</code>.
     * Contains metadata for a UserID matched with a given face.
     * @alias module:model/MatchedUser
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MatchedUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MatchedUser} obj Optional instance to populate.
     * @return {module:model/MatchedUser} The populated <code>MatchedUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MatchedUser();
    ...
    /**
     * Validates the JSON data with respect to <code>MatchedUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchedUser</code>.
     */
