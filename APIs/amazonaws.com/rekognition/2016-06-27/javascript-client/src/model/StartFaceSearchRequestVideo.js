...
/**
 * The StartFaceSearchRequestVideo model module.
 * @module model/StartFaceSearchRequestVideo
 * @version 2016-06-27
 */
class StartFaceSearchRequestVideo {
    /**
     * Constructs a new <code>StartFaceSearchRequestVideo</code>.
     * @alias module:model/StartFaceSearchRequestVideo
     * @implements module:model/Video
     */
    constructor() { 
        Video.initialize(this);
        StartFaceSearchRequestVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartFaceSearchRequestVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceSearchRequestVideo} obj Optional instance to populate.
     * @return {module:model/StartFaceSearchRequestVideo} The populated <code>StartFaceSearchRequestVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceSearchRequestVideo();
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceSearchRequestVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceSearchRequestVideo</code>.
     */
 ...
 */
StartFaceSearchRequestVideo.prototype['S3Object'] = undefined;
...
export default StartFaceSearchRequestVideo;
