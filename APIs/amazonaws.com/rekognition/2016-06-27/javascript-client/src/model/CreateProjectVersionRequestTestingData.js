...
/**
 * The CreateProjectVersionRequestTestingData model module.
 * @module model/CreateProjectVersionRequestTestingData
 * @version 2016-06-27
 */
class CreateProjectVersionRequestTestingData {
    /**
     * Constructs a new <code>CreateProjectVersionRequestTestingData</code>.
     * @alias module:model/CreateProjectVersionRequestTestingData
     * @implements module:model/TestingData
     */
    constructor() { 
        TestingData.initialize(this);
        CreateProjectVersionRequestTestingData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateProjectVersionRequestTestingData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProjectVersionRequestTestingData} obj Optional instance to populate.
     * @return {module:model/CreateProjectVersionRequestTestingData} The populated <code>CreateProjectVersionRequestTestingData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProjectVersionRequestTestingData();
            TestingData.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProjectVersionRequestTestingData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProjectVersionRequestTestingData</code>.
     */
 ...
 * @member {Array} Assets
 */
CreateProjectVersionRequestTestingData.prototype['Assets'] = undefined;

/**
 * @member {Boolean} AutoCreate
 */
CreateProjectVersionRequestTestingData.prototype['AutoCreate'] = undefined;


// Implement TestingData interface:
/**
 * @member {Array} Assets
 */
TestingData.prototype['Assets'] = undefined;
/**
 * @member {Boolean} AutoCreate
 */
TestingData.prototype['AutoCreate'] = undefined;




export default CreateProjectVersionRequestTestingData;
