...
/**
 * The DetectLabelsSettingsImageProperties model module.
 * @module model/DetectLabelsSettingsImageProperties
 * @version 2016-06-27
 */
class DetectLabelsSettingsImageProperties {
    /**
     * Constructs a new <code>DetectLabelsSettingsImageProperties</code>.
     * @alias module:model/DetectLabelsSettingsImageProperties
     * @implements module:model/DetectLabelsImagePropertiesSettings
     */
    constructor() { 
        DetectLabelsImagePropertiesSettings.initialize(this);
        DetectLabelsSettingsImageProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsSettingsImageProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsSettingsImageProperties} obj Optional instance to populate.
     * @return {module:model/DetectLabelsSettingsImageProperties} The populated <code>DetectLabelsSettingsImageProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsSettingsImageProperties();
            DetectLabelsImagePropertiesSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsSettingsImageProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsSettingsImageProperties</code>.
     */
 ...
 */
DetectLabelsSettingsImageProperties.prototype['MaxDominantColors'] = undefined;


// Implement DetectLabelsImagePropertiesSettings interface:
/**
 * @member {Number} MaxDominantColors
 */
...
export default DetectLabelsSettingsImageProperties;
