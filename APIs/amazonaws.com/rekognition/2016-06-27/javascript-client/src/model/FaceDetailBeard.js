...
/**
 * The FaceDetailBeard model module.
 * @module model/FaceDetailBeard
 * @version 2016-06-27
 */
class FaceDetailBeard {
    /**
     * Constructs a new <code>FaceDetailBeard</code>.
     * @alias module:model/FaceDetailBeard
     * @implements module:model/Beard
     */
    constructor() { 
        Beard.initialize(this);
        FaceDetailBeard.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailBeard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailBeard} obj Optional instance to populate.
     * @return {module:model/FaceDetailBeard} The populated <code>FaceDetailBeard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailBeard();
            Beard.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailBeard</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailBeard</code>.
     */
 ...
 */
FaceDetailBeard.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailBeard.prototype['Confidence'] = undefined;


// Implement Beard interface:
/**
 * @member {Boolean} Value
 */
...
export default FaceDetailBeard;
