...
/**
 * The StartCelebrityRecognitionResponse model module.
 * @module model/StartCelebrityRecognitionResponse
 * @version 2016-06-27
 */
class StartCelebrityRecognitionResponse {
    /**
     * Constructs a new <code>StartCelebrityRecognitionResponse</code>.
     * @alias module:model/StartCelebrityRecognitionResponse
     */
    constructor() { 
        
        StartCelebrityRecognitionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartCelebrityRecognitionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartCelebrityRecognitionResponse} obj Optional instance to populate.
     * @return {module:model/StartCelebrityRecognitionResponse} The populated <code>StartCelebrityRecognitionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartCelebrityRecognitionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartCelebrityRecognitionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartCelebrityRecognitionResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartCelebrityRecognitionResponse.prototype['JobId'] = undefined;
...
export default StartCelebrityRecognitionResponse;
