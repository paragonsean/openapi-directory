...
/**
 * The ListStreamProcessorsRequest model module.
 * @module model/ListStreamProcessorsRequest
 * @version 2016-06-27
 */
class ListStreamProcessorsRequest {
    /**
     * Constructs a new <code>ListStreamProcessorsRequest</code>.
     * @alias module:model/ListStreamProcessorsRequest
     */
    constructor() { 
        
        ListStreamProcessorsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListStreamProcessorsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStreamProcessorsRequest} obj Optional instance to populate.
     * @return {module:model/ListStreamProcessorsRequest} The populated <code>ListStreamProcessorsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStreamProcessorsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListStreamProcessorsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStreamProcessorsRequest</code>.
     */
 ...
 */
ListStreamProcessorsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListStreamProcessorsRequest.prototype['MaxResults'] = undefined;
...
export default ListStreamProcessorsRequest;
