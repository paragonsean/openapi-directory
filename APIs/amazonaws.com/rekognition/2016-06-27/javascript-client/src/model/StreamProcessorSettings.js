...
/**
 * The StreamProcessorSettings model module.
 * @module model/StreamProcessorSettings
 * @version 2016-06-27
 */
class StreamProcessorSettings {
    /**
     * Constructs a new <code>StreamProcessorSettings</code>.
     ...
     * @alias module:model/StreamProcessorSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamProcessorSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorSettings} obj Optional instance to populate.
     * @return {module:model/StreamProcessorSettings} The populated <code>StreamProcessorSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorSettings</code>.
     */
...
export default StreamProcessorSettings;
