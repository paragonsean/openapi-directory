...
import GetLabelDetectionRequestMetadata from './GetLabelDetectionRequestMetadata';
import LabelDetectionAggregateBy from './LabelDetectionAggregateBy';
import LabelDetectionSortBy from './LabelDetectionSortBy';

/**
 * The GetLabelDetectionResponseGetRequestMetadata model module.
 * @module model/GetLabelDetectionResponseGetRequestMetadata
 * @version 2016-06-27
 */
class GetLabelDetectionResponseGetRequestMetadata {
    /**
     * Constructs a new <code>GetLabelDetectionResponseGetRequestMetadata</code>.
     * @alias module:model/GetLabelDetectionResponseGetRequestMetadata
     * @implements module:model/GetLabelDetectionRequestMetadata
     */
    constructor() { 
        GetLabelDetectionRequestMetadata.initialize(this);
        GetLabelDetectionResponseGetRequestMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLabelDetectionResponseGetRequestMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLabelDetectionResponseGetRequestMetadata} obj Optional instance to populate.
     * @return {module:model/GetLabelDetectionResponseGetRequestMetadata} The populated <code>GetLabelDetectionResponseGetRequestMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLabelDetectionResponseGetRequestMetadata();
            GetLabelDetectionRequestMetadata.constructFromObject(data, obj);

            if (data.hasOwnProperty('SortBy')) {
                obj['SortBy'] = ApiClient.convertToType(data['SortBy'], LabelDetectionSortBy);
            }
            if (data.hasOwnProperty('AggregateBy')) {
                obj['AggregateBy'] = ApiClient.convertToType(data['AggregateBy'], LabelDetectionAggregateBy);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLabelDetectionResponseGetRequestMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLabelDetectionResponseGetRequestMetadata</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SortBy`
        if (data['SortBy']) { // data not null
          LabelDetectionSortBy.validateJSON(data['SortBy']);
        }
        // validate the optional field `AggregateBy`
        if (data['AggregateBy']) { // data not null
          LabelDetectionAggregateBy.validateJSON(data['AggregateBy']);
        }
...
/**
 * @member {module:model/LabelDetectionSortBy} SortBy
 */
GetLabelDetectionResponseGetRequestMetadata.prototype['SortBy'] = undefined;

/**
 * @member {module:model/LabelDetectionAggregateBy} AggregateBy
 */
GetLabelDetectionResponseGetRequestMetadata.prototype['AggregateBy'] = undefined;


// Implement GetLabelDetectionRequestMetadata interface:
/**
 * @member {module:model/LabelDetectionSortBy} SortBy
 */
GetLabelDetectionRequestMetadata.prototype['SortBy'] = undefined;
/**
 * @member {module:model/LabelDetectionAggregateBy} AggregateBy
 */
GetLabelDetectionRequestMetadata.prototype['AggregateBy'] = undefined;




export default GetLabelDetectionResponseGetRequestMetadata;
