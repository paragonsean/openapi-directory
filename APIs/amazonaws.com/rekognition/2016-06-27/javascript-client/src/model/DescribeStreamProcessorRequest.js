...
/**
 * The DescribeStreamProcessorRequest model module.
 * @module model/DescribeStreamProcessorRequest
 * @version 2016-06-27
 */
class DescribeStreamProcessorRequest {
    /**
     * Constructs a new <code>DescribeStreamProcessorRequest</code>.
     * @alias module:model/DescribeStreamProcessorRequest
     * @param name {String} 
     */
    constructor(name) { 
        
        DescribeStreamProcessorRequest.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DescribeStreamProcessorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeStreamProcessorRequest} obj Optional instance to populate.
     * @return {module:model/DescribeStreamProcessorRequest} The populated <code>DescribeStreamProcessorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeStreamProcessorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeStreamProcessorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeStreamProcessorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeStreamProcessorRequest.RequiredProperties) {
...
DescribeStreamProcessorRequest.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
DescribeStreamProcessorRequest.prototype['Name'] = undefined;
...
export default DescribeStreamProcessorRequest;
