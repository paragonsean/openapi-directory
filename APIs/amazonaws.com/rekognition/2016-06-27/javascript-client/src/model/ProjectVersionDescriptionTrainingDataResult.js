...
/**
 * The ProjectVersionDescriptionTrainingDataResult model module.
 * @module model/ProjectVersionDescriptionTrainingDataResult
 * @version 2016-06-27
 */
class ProjectVersionDescriptionTrainingDataResult {
    /**
     * Constructs a new <code>ProjectVersionDescriptionTrainingDataResult</code>.
     * @alias module:model/ProjectVersionDescriptionTrainingDataResult
     * @implements module:model/TrainingDataResult
     */
    constructor() { 
        TrainingDataResult.initialize(this);
        ProjectVersionDescriptionTrainingDataResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectVersionDescriptionTrainingDataResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectVersionDescriptionTrainingDataResult} obj Optional instance to populate.
     * @return {module:model/ProjectVersionDescriptionTrainingDataResult} The populated <code>ProjectVersionDescriptionTrainingDataResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectVersionDescriptionTrainingDataResult();
            TrainingDataResult.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectVersionDescriptionTrainingDataResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectVersionDescriptionTrainingDataResult</code>.
     */
 ...
 */
ProjectVersionDescriptionTrainingDataResult.prototype['Input'] = undefined;

/**
 * @member {module:model/TrainingDataResultOutput} Output
 */
ProjectVersionDescriptionTrainingDataResult.prototype['Output'] = undefined;

/**
 * @member {module:model/TrainingDataResultValidation} Validation
 */
ProjectVersionDescriptionTrainingDataResult.prototype['Validation'] = undefined;


// Implement TrainingDataResult interface:
/**
 * @member {module:model/TrainingDataResultInput} Input
 */
...
export default ProjectVersionDescriptionTrainingDataResult;
