...
/**
 * The ProtectiveEquipmentSummarizationAttributes model module.
 * @module model/ProtectiveEquipmentSummarizationAttributes
 * @version 2016-06-27
 */
class ProtectiveEquipmentSummarizationAttributes {
    /**
     * Constructs a new <code>ProtectiveEquipmentSummarizationAttributes</code>.
     ...
     * @alias module:model/ProtectiveEquipmentSummarizationAttributes
    ...
    /**
     * Constructs a <code>ProtectiveEquipmentSummarizationAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProtectiveEquipmentSummarizationAttributes} obj Optional instance to populate.
     * @return {module:model/ProtectiveEquipmentSummarizationAttributes} The populated <code>ProtectiveEquipmentSummarizationAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProtectiveEquipmentSummarizationAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>ProtectiveEquipmentSummarizationAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProtectiveEquipmentSummarizationAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProtectiveEquipmentSummarizationAttributes.RequiredProperties) {
...
ProtectiveEquipmentSummarizationAttributes.RequiredProperties = ["MinConfidence", "RequiredEquipmentTypes"];
...
export default ProtectiveEquipmentSummarizationAttributes;
