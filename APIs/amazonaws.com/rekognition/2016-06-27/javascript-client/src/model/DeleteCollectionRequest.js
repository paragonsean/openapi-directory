...
/**
 * The DeleteCollectionRequest model module.
 * @module model/DeleteCollectionRequest
 * @version 2016-06-27
 */
class DeleteCollectionRequest {
    /**
     * Constructs a new <code>DeleteCollectionRequest</code>.
     * @alias module:model/DeleteCollectionRequest
     * @param collectionId {String} 
     */
    constructor(collectionId) { 
        
        DeleteCollectionRequest.initialize(this, collectionId);
    }
     ...
     */
    static initialize(obj, collectionId) { 
        obj['CollectionId'] = collectionId;
    }

    /**
     * Constructs a <code>DeleteCollectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteCollectionRequest} obj Optional instance to populate.
     * @return {module:model/DeleteCollectionRequest} The populated <code>DeleteCollectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteCollectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteCollectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteCollectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteCollectionRequest.RequiredProperties) {
...
DeleteCollectionRequest.RequiredProperties = ["CollectionId"];

/**
 * @member {String} CollectionId
 */
DeleteCollectionRequest.prototype['CollectionId'] = undefined;
