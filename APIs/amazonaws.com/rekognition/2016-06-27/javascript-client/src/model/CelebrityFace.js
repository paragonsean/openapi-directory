...
/**
 * The CelebrityFace model module.
 * @module model/CelebrityFace
 * @version 2016-06-27
 */
class CelebrityFace {
    /**
     * Constructs a new <code>CelebrityFace</code>.
     * @alias module:model/CelebrityFace
     * @implements module:model/ComparedFace
     */
    constructor() { 
        ComparedFace.initialize(this);
        CelebrityFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CelebrityFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CelebrityFace} obj Optional instance to populate.
     * @return {module:model/CelebrityFace} The populated <code>CelebrityFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CelebrityFace();
            ComparedFace.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CelebrityFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CelebrityFace</code>.
     */
 ...
 */
CelebrityFace.prototype['BoundingBox'] = undefined;

/**
 * @member {Number} Confidence
 */
CelebrityFace.prototype['Confidence'] = undefined;

/**
 * @member {Array} Landmarks
 */
CelebrityFace.prototype['Landmarks'] = undefined;

/**
 * @member {module:model/ComparedFacePose} Pose
 */
CelebrityFace.prototype['Pose'] = undefined;

/**
 * @member {module:model/ComparedFaceQuality} Quality
 */
CelebrityFace.prototype['Quality'] = undefined;

/**
 * @member {Array} Emotions
 */
CelebrityFace.prototype['Emotions'] = undefined;

/**
 * @member {module:model/ComparedFaceSmile} Smile
 */
CelebrityFace.prototype['Smile'] = undefined;


// Implement ComparedFace interface:
/**
 * @member {module:model/ComparedFaceBoundingBox} BoundingBox
 */
