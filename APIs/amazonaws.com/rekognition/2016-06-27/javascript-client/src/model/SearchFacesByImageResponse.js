...
import SearchFacesByImageResponseSearchedFaceBoundingBox from './SearchFacesByImageResponseSearchedFaceBoundingBox';

/**
 * The SearchFacesByImageResponse model module.
 * @module model/SearchFacesByImageResponse
 * @version 2016-06-27
 */
class SearchFacesByImageResponse {
    /**
     * Constructs a new <code>SearchFacesByImageResponse</code>.
     * @alias module:model/SearchFacesByImageResponse
     */
    constructor() { 
        
        SearchFacesByImageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchFacesByImageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchFacesByImageResponse} obj Optional instance to populate.
     * @return {module:model/SearchFacesByImageResponse} The populated <code>SearchFacesByImageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchFacesByImageResponse();

            if (data.hasOwnProperty('SearchedFaceBoundingBox')) {
                obj['SearchedFaceBoundingBox'] = SearchFacesByImageResponseSearchedFaceBoundingBox.constructFromObject(data['SearchedFaceBoundingBox']);
            }
            if (data.hasOwnProperty('SearchedFaceConfidence')) {
                obj['SearchedFaceConfidence'] = ApiClient.convertToType(data['SearchedFaceConfidence'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchFacesByImageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchFacesByImageResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SearchedFaceBoundingBox`
        if (data['SearchedFaceBoundingBox']) { // data not null
          SearchFacesByImageResponseSearchedFaceBoundingBox.validateJSON(data['SearchedFaceBoundingBox']);
        }
        // validate the optional field `SearchedFaceConfidence`
        if (data['SearchedFaceConfidence']) { // data not null
          Number.validateJSON(data['SearchedFaceConfidence']);
        }
...
/**
 * @member {module:model/SearchFacesByImageResponseSearchedFaceBoundingBox} SearchedFaceBoundingBox
 */
SearchFacesByImageResponse.prototype['SearchedFaceBoundingBox'] = undefined;

/**
 * @member {Number} SearchedFaceConfidence
 */
SearchFacesByImageResponse.prototype['SearchedFaceConfidence'] = undefined;

/**
 * @member {Array} FaceMatches
 */
SearchFacesByImageResponse.prototype['FaceMatches'] = undefined;

/**
 * @member {String} FaceModelVersion
 */
SearchFacesByImageResponse.prototype['FaceModelVersion'] = undefined;
...
export default SearchFacesByImageResponse;
