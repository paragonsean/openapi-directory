...
/**
 * The TestingDataResultInput model module.
 * @module model/TestingDataResultInput
 * @version 2016-06-27
 */
class TestingDataResultInput {
    /**
     * Constructs a new <code>TestingDataResultInput</code>.
     * @alias module:model/TestingDataResultInput
     * @implements module:model/TestingData
     */
    constructor() { 
        TestingData.initialize(this);
        TestingDataResultInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestingDataResultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestingDataResultInput} obj Optional instance to populate.
     * @return {module:model/TestingDataResultInput} The populated <code>TestingDataResultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestingDataResultInput();
    ...
    /**
     * Validates the JSON data with respect to <code>TestingDataResultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestingDataResultInput</code>.
     */
 ...
 * @member {Array} Assets
 */
TestingDataResultInput.prototype['Assets'] = undefined;

/**
 * @member {Boolean} AutoCreate
 */
TestingDataResultInput.prototype['AutoCreate'] = undefined;
...
export default TestingDataResultInput;
