...
import StartPersonTrackingRequestNotificationChannel from './StartPersonTrackingRequestNotificationChannel';
import StartPersonTrackingRequestVideo from './StartPersonTrackingRequestVideo';

/**
 * The StartPersonTrackingRequest model module.
 * @module model/StartPersonTrackingRequest
 * @version 2016-06-27
 */
class StartPersonTrackingRequest {
    /**
     * Constructs a new <code>StartPersonTrackingRequest</code>.
     * @alias module:model/StartPersonTrackingRequest
     * @param video {module:model/StartPersonTrackingRequestVideo} 
     */
    constructor(video) { 
        
        StartPersonTrackingRequest.initialize(this, video);
    }
    ...
    /**
     * Constructs a <code>StartPersonTrackingRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPersonTrackingRequest} obj Optional instance to populate.
     * @return {module:model/StartPersonTrackingRequest} The populated <code>StartPersonTrackingRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPersonTrackingRequest();

            if (data.hasOwnProperty('Video')) {
                obj['Video'] = StartPersonTrackingRequestVideo.constructFromObject(data['Video']);
            }
            ...
            if (data.hasOwnProperty('NotificationChannel')) {
                obj['NotificationChannel'] = StartPersonTrackingRequestNotificationChannel.constructFromObject(data['NotificationChannel']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StartPersonTrackingRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPersonTrackingRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartPersonTrackingRequest.RequiredProperties) {
        ...
        if (data['Video']) { // data not null
          StartPersonTrackingRequestVideo.validateJSON(data['Video']);
        }
        ...
        if (data['NotificationChannel']) { // data not null
          StartPersonTrackingRequestNotificationChannel.validateJSON(data['NotificationChannel']);
        }
...
StartPersonTrackingRequest.RequiredProperties = ["Video"];

/**
 * @member {module:model/StartPersonTrackingRequestVideo} Video
 */
StartPersonTrackingRequest.prototype['Video'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
StartPersonTrackingRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {module:model/StartPersonTrackingRequestNotificationChannel} NotificationChannel
 */
StartPersonTrackingRequest.prototype['NotificationChannel'] = undefined;

/**
 * @member {String} JobTag
 */
StartPersonTrackingRequest.prototype['JobTag'] = undefined;
...
export default StartPersonTrackingRequest;
