...
/**
 * The DetectLabelsImagePropertiesQuality model module.
 * @module model/DetectLabelsImagePropertiesQuality
 * @version 2016-06-27
 */
class DetectLabelsImagePropertiesQuality {
    /**
     * Constructs a new <code>DetectLabelsImagePropertiesQuality</code>.
     * @alias module:model/DetectLabelsImagePropertiesQuality
     * @implements module:model/DetectLabelsImageQuality
     */
    constructor() { 
        DetectLabelsImageQuality.initialize(this);
        DetectLabelsImagePropertiesQuality.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsImagePropertiesQuality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImagePropertiesQuality} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImagePropertiesQuality} The populated <code>DetectLabelsImagePropertiesQuality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImagePropertiesQuality();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImagePropertiesQuality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImagePropertiesQuality</code>.
     */
 ...
 */
DetectLabelsImagePropertiesQuality.prototype['Brightness'] = undefined;

/**
 * @member {Number} Sharpness
 */
DetectLabelsImagePropertiesQuality.prototype['Sharpness'] = undefined;

/**
 * @member {Number} Contrast
 */
DetectLabelsImagePropertiesQuality.prototype['Contrast'] = undefined;
...
export default DetectLabelsImagePropertiesQuality;
