...
/**
 * The UnsuccessfulFaceDisassociation model module.
 * @module model/UnsuccessfulFaceDisassociation
 * @version 2016-06-27
 */
class UnsuccessfulFaceDisassociation {
    /**
     * Constructs a new <code>UnsuccessfulFaceDisassociation</code>.
     * Contains metadata like FaceId, UserID, and Reasons, for a face that was unsuccessfully disassociated.
     * @alias module:model/UnsuccessfulFaceDisassociation
     */
    constructor() { 
        
        UnsuccessfulFaceDisassociation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnsuccessfulFaceDisassociation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnsuccessfulFaceDisassociation} obj Optional instance to populate.
     * @return {module:model/UnsuccessfulFaceDisassociation} The populated <code>UnsuccessfulFaceDisassociation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnsuccessfulFaceDisassociation();
    ...
    /**
     * Validates the JSON data with respect to <code>UnsuccessfulFaceDisassociation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnsuccessfulFaceDisassociation</code>.
     */
 ...
 */
UnsuccessfulFaceDisassociation.prototype['FaceId'] = undefined;

/**
 * @member {String} UserId
 */
UnsuccessfulFaceDisassociation.prototype['UserId'] = undefined;

/**
 * @member {Array} Reasons
 */
UnsuccessfulFaceDisassociation.prototype['Reasons'] = undefined;
...
export default UnsuccessfulFaceDisassociation;
