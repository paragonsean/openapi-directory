...
import DatasetLabelDescriptionLabelStats from './DatasetLabelDescriptionLabelStats';

/**
 * The DatasetLabelDescription model module.
 * @module model/DatasetLabelDescription
 * @version 2016-06-27
 */
class DatasetLabelDescription {
    /**
     * Constructs a new <code>DatasetLabelDescription</code>.
     *  Describes a dataset label. For more information, see &lt;a&gt;ListDatasetLabels&lt;/a&gt;. 
     * @alias module:model/DatasetLabelDescription
     */
    constructor() { 
        
        DatasetLabelDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatasetLabelDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatasetLabelDescription} obj Optional instance to populate.
     * @return {module:model/DatasetLabelDescription} The populated <code>DatasetLabelDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatasetLabelDescription();
            ...
            if (data.hasOwnProperty('LabelStats')) {
                obj['LabelStats'] = DatasetLabelDescriptionLabelStats.constructFromObject(data['LabelStats']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatasetLabelDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatasetLabelDescription</code>.
     */
    static validateJSON(data) {
        // validate the optional field `LabelName`
        if (data['LabelName']) { // data not null
          String.validateJSON(data['LabelName']);
        }
        // validate the optional field `LabelStats`
        if (data['LabelStats']) { // data not null
          DatasetLabelDescriptionLabelStats.validateJSON(data['LabelStats']);
        }
 ...
 */
DatasetLabelDescription.prototype['LabelName'] = undefined;

/**
 * @member {module:model/DatasetLabelDescriptionLabelStats} LabelStats
 */
DatasetLabelDescription.prototype['LabelStats'] = undefined;
...
export default DatasetLabelDescription;
