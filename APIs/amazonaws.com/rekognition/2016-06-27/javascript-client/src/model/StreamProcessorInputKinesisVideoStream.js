...
/**
 * The StreamProcessorInputKinesisVideoStream model module.
 * @module model/StreamProcessorInputKinesisVideoStream
 * @version 2016-06-27
 */
class StreamProcessorInputKinesisVideoStream {
    /**
     * Constructs a new <code>StreamProcessorInputKinesisVideoStream</code>.
     * @alias module:model/StreamProcessorInputKinesisVideoStream
     * @implements module:model/KinesisVideoStream
     */
    constructor() { 
        KinesisVideoStream.initialize(this);
        StreamProcessorInputKinesisVideoStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamProcessorInputKinesisVideoStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorInputKinesisVideoStream} obj Optional instance to populate.
     * @return {module:model/StreamProcessorInputKinesisVideoStream} The populated <code>StreamProcessorInputKinesisVideoStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorInputKinesisVideoStream();
            KinesisVideoStream.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorInputKinesisVideoStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorInputKinesisVideoStream</code>.
     */
 ...
 * @member {String} Arn
 */
StreamProcessorInputKinesisVideoStream.prototype['Arn'] = undefined;


// Implement KinesisVideoStream interface:
/**
 * @member {String} Arn
 */
KinesisVideoStream.prototype['Arn'] = undefined;




export default StreamProcessorInputKinesisVideoStream;
