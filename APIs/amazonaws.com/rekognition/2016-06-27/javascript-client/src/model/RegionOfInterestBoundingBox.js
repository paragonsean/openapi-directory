...
/**
 * The RegionOfInterestBoundingBox model module.
 * @module model/RegionOfInterestBoundingBox
 * @version 2016-06-27
 */
class RegionOfInterestBoundingBox {
    /**
     * Constructs a new <code>RegionOfInterestBoundingBox</code>.
     * @alias module:model/RegionOfInterestBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        RegionOfInterestBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegionOfInterestBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegionOfInterestBoundingBox} obj Optional instance to populate.
     * @return {module:model/RegionOfInterestBoundingBox} The populated <code>RegionOfInterestBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegionOfInterestBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>RegionOfInterestBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegionOfInterestBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
RegionOfInterestBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
RegionOfInterestBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
RegionOfInterestBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
RegionOfInterestBoundingBox.prototype['Top'] = undefined;
...
export default RegionOfInterestBoundingBox;
