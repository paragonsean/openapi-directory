...
/**
 * The FaceDetailEyeDirection model module.
 * @module model/FaceDetailEyeDirection
 * @version 2016-06-27
 */
class FaceDetailEyeDirection {
    /**
     * Constructs a new <code>FaceDetailEyeDirection</code>.
     * @alias module:model/FaceDetailEyeDirection
     * @implements module:model/EyeDirection
     */
    constructor() { 
        EyeDirection.initialize(this);
        FaceDetailEyeDirection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailEyeDirection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailEyeDirection} obj Optional instance to populate.
     * @return {module:model/FaceDetailEyeDirection} The populated <code>FaceDetailEyeDirection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailEyeDirection();
            EyeDirection.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailEyeDirection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailEyeDirection</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Yaw`
        if (data['Yaw']) { // data not null
          Number.validateJSON(data['Yaw']);
        }
        // validate the optional field `Pitch`
        if (data['Pitch']) { // data not null
          Number.validateJSON(data['Pitch']);
        }
 ...
 * @member {Number} Yaw
 */
FaceDetailEyeDirection.prototype['Yaw'] = undefined;

/**
 * @member {Number} Pitch
 */
FaceDetailEyeDirection.prototype['Pitch'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailEyeDirection.prototype['Confidence'] = undefined;


// Implement EyeDirection interface:
/**
 * @member {Number} Yaw
 */
EyeDirection.prototype['Yaw'] = undefined;
/**
 * @member {Number} Pitch
 */
EyeDirection.prototype['Pitch'] = undefined;
/**
 * @member {Number} Confidence
 */
EyeDirection.prototype['Confidence'] = undefined;




export default FaceDetailEyeDirection;
