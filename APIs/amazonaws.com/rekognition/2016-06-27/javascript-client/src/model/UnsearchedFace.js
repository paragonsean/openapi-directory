...
/**
 * The UnsearchedFace model module.
 * @module model/UnsearchedFace
 * @version 2016-06-27
 */
class UnsearchedFace {
    /**
     * Constructs a new <code>UnsearchedFace</code>.
     ...
     * @alias module:model/UnsearchedFace
     */
    constructor() { 
        
        UnsearchedFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnsearchedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnsearchedFace} obj Optional instance to populate.
     * @return {module:model/UnsearchedFace} The populated <code>UnsearchedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnsearchedFace();

            if (data.hasOwnProperty('FaceDetails')) {
                obj['FaceDetails'] = FaceDetail.constructFromObject(data['FaceDetails']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UnsearchedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnsearchedFace</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FaceDetails`
        if (data['FaceDetails']) { // data not null
          FaceDetail.validateJSON(data['FaceDetails']);
        }
...
/**
 * @member {module:model/FaceDetail} FaceDetails
 */
UnsearchedFace.prototype['FaceDetails'] = undefined;

/**
 * @member {Array} Reasons
 */
UnsearchedFace.prototype['Reasons'] = undefined;
