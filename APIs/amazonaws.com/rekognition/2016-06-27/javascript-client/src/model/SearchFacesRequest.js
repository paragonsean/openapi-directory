...
/**
 * The SearchFacesRequest model module.
 * @module model/SearchFacesRequest
 * @version 2016-06-27
 */
class SearchFacesRequest {
    /**
     * Constructs a new <code>SearchFacesRequest</code>.
     * @alias module:model/SearchFacesRequest
     * @param collectionId {String} 
     * @param faceId {String} 
     */
    constructor(collectionId, faceId) { 
        
        SearchFacesRequest.initialize(this, collectionId, faceId);
    }
     ...
     */
    static initialize(obj, collectionId, faceId) { 
        obj['CollectionId'] = collectionId;
        obj['FaceId'] = faceId;
    }

    /**
     * Constructs a <code>SearchFacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchFacesRequest} obj Optional instance to populate.
     * @return {module:model/SearchFacesRequest} The populated <code>SearchFacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchFacesRequest();
            ...
            if (data.hasOwnProperty('MaxFaces')) {
                obj['MaxFaces'] = ApiClient.convertToType(data['MaxFaces'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchFacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchFacesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SearchFacesRequest.RequiredProperties) {
        ...
        if (data['MaxFaces']) { // data not null
          Number.validateJSON(data['MaxFaces']);
        }
...
SearchFacesRequest.RequiredProperties = ["CollectionId", "FaceId"];

/**
 * @member {String} CollectionId
 */
SearchFacesRequest.prototype['CollectionId'] = undefined;

/**
 * @member {String} FaceId
 */
SearchFacesRequest.prototype['FaceId'] = undefined;

/**
 * @member {Number} MaxFaces
 */
SearchFacesRequest.prototype['MaxFaces'] = undefined;

/**
 * @member {Number} FaceMatchThreshold
 */
SearchFacesRequest.prototype['FaceMatchThreshold'] = undefined;
...
export default SearchFacesRequest;
