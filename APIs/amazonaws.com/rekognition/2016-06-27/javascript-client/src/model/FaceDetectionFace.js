...
/**
 * The FaceDetectionFace model module.
 * @module model/FaceDetectionFace
 * @version 2016-06-27
 */
class FaceDetectionFace {
    /**
     * Constructs a new <code>FaceDetectionFace</code>.
     * @alias module:model/FaceDetectionFace
     * @implements module:model/FaceDetail
     */
    constructor() { 
        FaceDetail.initialize(this);
        FaceDetectionFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetectionFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetectionFace} obj Optional instance to populate.
     * @return {module:model/FaceDetectionFace} The populated <code>FaceDetectionFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetectionFace();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetectionFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetectionFace</code>.
     */
 ...
 */
FaceDetectionFace.prototype['BoundingBox'] = undefined;

/**
 * @member {module:model/FaceDetailAgeRange} AgeRange
 */
FaceDetectionFace.prototype['AgeRange'] = undefined;

/**
 * @member {module:model/FaceDetailSmile} Smile
 */
FaceDetectionFace.prototype['Smile'] = undefined;

/**
 * @member {module:model/FaceDetailEyeglasses} Eyeglasses
 */
FaceDetectionFace.prototype['Eyeglasses'] = undefined;

/**
 * @member {module:model/FaceDetailSunglasses} Sunglasses
 */
FaceDetectionFace.prototype['Sunglasses'] = undefined;

/**
 * @member {module:model/FaceDetailGender} Gender
 */
FaceDetectionFace.prototype['Gender'] = undefined;

/**
 * @member {module:model/FaceDetailBeard} Beard
 */
FaceDetectionFace.prototype['Beard'] = undefined;

/**
 * @member {module:model/FaceDetailMustache} Mustache
 */
FaceDetectionFace.prototype['Mustache'] = undefined;

/**
 * @member {module:model/FaceDetailEyesOpen} EyesOpen
 */
FaceDetectionFace.prototype['EyesOpen'] = undefined;

/**
 * @member {module:model/FaceDetailMouthOpen} MouthOpen
 */
FaceDetectionFace.prototype['MouthOpen'] = undefined;

/**
 * @member {Array} Emotions
 */
FaceDetectionFace.prototype['Emotions'] = undefined;

/**
 * @member {Array} Landmarks
 */
FaceDetectionFace.prototype['Landmarks'] = undefined;

/**
 * @member {module:model/FaceDetailPose} Pose
 */
FaceDetectionFace.prototype['Pose'] = undefined;

/**
 * @member {module:model/FaceDetailQuality} Quality
 */
FaceDetectionFace.prototype['Quality'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetectionFace.prototype['Confidence'] = undefined;

/**
 * @member {module:model/FaceDetailFaceOccluded} FaceOccluded
 */
FaceDetectionFace.prototype['FaceOccluded'] = undefined;

/**
 * @member {module:model/FaceDetailEyeDirection} EyeDirection
 */
FaceDetectionFace.prototype['EyeDirection'] = undefined;
...
export default FaceDetectionFace;
