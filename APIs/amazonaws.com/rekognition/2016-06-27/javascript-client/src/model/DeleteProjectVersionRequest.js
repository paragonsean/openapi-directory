...
/**
 * The DeleteProjectVersionRequest model module.
 * @module model/DeleteProjectVersionRequest
 * @version 2016-06-27
 */
class DeleteProjectVersionRequest {
    /**
     * Constructs a new <code>DeleteProjectVersionRequest</code>.
     * @alias module:model/DeleteProjectVersionRequest
     * @param projectVersionArn {String} 
     */
    constructor(projectVersionArn) { 
        
        DeleteProjectVersionRequest.initialize(this, projectVersionArn);
    }
    ...
    /**
     * Constructs a <code>DeleteProjectVersionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteProjectVersionRequest} obj Optional instance to populate.
     * @return {module:model/DeleteProjectVersionRequest} The populated <code>DeleteProjectVersionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteProjectVersionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteProjectVersionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteProjectVersionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteProjectVersionRequest.RequiredProperties) {
...
DeleteProjectVersionRequest.RequiredProperties = ["ProjectVersionArn"];

/**
 * @member {String} ProjectVersionArn
 */
DeleteProjectVersionRequest.prototype['ProjectVersionArn'] = undefined;
...
export default DeleteProjectVersionRequest;
