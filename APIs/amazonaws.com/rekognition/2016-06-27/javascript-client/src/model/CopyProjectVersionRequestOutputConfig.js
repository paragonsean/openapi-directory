...
/**
 * The CopyProjectVersionRequestOutputConfig model module.
 * @module model/CopyProjectVersionRequestOutputConfig
 * @version 2016-06-27
 */
class CopyProjectVersionRequestOutputConfig {
    /**
     * Constructs a new <code>CopyProjectVersionRequestOutputConfig</code>.
     * @alias module:model/CopyProjectVersionRequestOutputConfig
     * @implements module:model/OutputConfig
     */
    constructor() { 
        OutputConfig.initialize(this);
        CopyProjectVersionRequestOutputConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CopyProjectVersionRequestOutputConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyProjectVersionRequestOutputConfig} obj Optional instance to populate.
     * @return {module:model/CopyProjectVersionRequestOutputConfig} The populated <code>CopyProjectVersionRequestOutputConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyProjectVersionRequestOutputConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyProjectVersionRequestOutputConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyProjectVersionRequestOutputConfig</code>.
     */
 ...
 */
CopyProjectVersionRequestOutputConfig.prototype['S3Bucket'] = undefined;

/**
 * @member {String} S3KeyPrefix
 */
CopyProjectVersionRequestOutputConfig.prototype['S3KeyPrefix'] = undefined;
 ...
 * @member {String} S3KeyPrefix
 */
OutputConfig.prototype['S3KeyPrefix'] = undefined;




export default CopyProjectVersionRequestOutputConfig;
