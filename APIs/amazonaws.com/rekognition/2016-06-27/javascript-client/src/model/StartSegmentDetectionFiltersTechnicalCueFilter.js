...
import StartTechnicalCueDetectionFilterBlackFrame from './StartTechnicalCueDetectionFilterBlackFrame';

/**
 * The StartSegmentDetectionFiltersTechnicalCueFilter model module.
 * @module model/StartSegmentDetectionFiltersTechnicalCueFilter
 * @version 2016-06-27
 */
class StartSegmentDetectionFiltersTechnicalCueFilter {
    /**
     * Constructs a new <code>StartSegmentDetectionFiltersTechnicalCueFilter</code>.
     * @alias module:model/StartSegmentDetectionFiltersTechnicalCueFilter
     * @implements module:model/StartTechnicalCueDetectionFilter
     */
    constructor() { 
        StartTechnicalCueDetectionFilter.initialize(this);
        StartSegmentDetectionFiltersTechnicalCueFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartSegmentDetectionFiltersTechnicalCueFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSegmentDetectionFiltersTechnicalCueFilter} obj Optional instance to populate.
     * @return {module:model/StartSegmentDetectionFiltersTechnicalCueFilter} The populated <code>StartSegmentDetectionFiltersTechnicalCueFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSegmentDetectionFiltersTechnicalCueFilter();
            StartTechnicalCueDetectionFilter.constructFromObject(data, obj);

            if (data.hasOwnProperty('MinSegmentConfidence')) {
                obj['MinSegmentConfidence'] = ApiClient.convertToType(data['MinSegmentConfidence'], 'Number');
            }
            if (data.hasOwnProperty('BlackFrame')) {
                obj['BlackFrame'] = StartTechnicalCueDetectionFilterBlackFrame.constructFromObject(data['BlackFrame']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartSegmentDetectionFiltersTechnicalCueFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSegmentDetectionFiltersTechnicalCueFilter</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MinSegmentConfidence`
        if (data['MinSegmentConfidence']) { // data not null
          Number.validateJSON(data['MinSegmentConfidence']);
        }
        // validate the optional field `BlackFrame`
        if (data['BlackFrame']) { // data not null
          StartTechnicalCueDetectionFilterBlackFrame.validateJSON(data['BlackFrame']);
        }
...
/**
 * @member {Number} MinSegmentConfidence
 */
StartSegmentDetectionFiltersTechnicalCueFilter.prototype['MinSegmentConfidence'] = undefined;

/**
 * @member {module:model/StartTechnicalCueDetectionFilterBlackFrame} BlackFrame
 */
StartSegmentDetectionFiltersTechnicalCueFilter.prototype['BlackFrame'] = undefined;


// Implement StartTechnicalCueDetectionFilter interface:
/**
 * @member {Number} MinSegmentConfidence
 */
StartTechnicalCueDetectionFilter.prototype['MinSegmentConfidence'] = undefined;
/**
 * @member {module:model/StartTechnicalCueDetectionFilterBlackFrame} BlackFrame
 */
StartTechnicalCueDetectionFilter.prototype['BlackFrame'] = undefined;




export default StartSegmentDetectionFiltersTechnicalCueFilter;
