...
/**
 * The RecognizeCelebritiesResponse model module.
 * @module model/RecognizeCelebritiesResponse
 * @version 2016-06-27
 */
class RecognizeCelebritiesResponse {
    /**
     * Constructs a new <code>RecognizeCelebritiesResponse</code>.
     * @alias module:model/RecognizeCelebritiesResponse
     */
    constructor() { 
        
        RecognizeCelebritiesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RecognizeCelebritiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecognizeCelebritiesResponse} obj Optional instance to populate.
     * @return {module:model/RecognizeCelebritiesResponse} The populated <code>RecognizeCelebritiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecognizeCelebritiesResponse();

            if (data.hasOwnProperty('CelebrityFaces')) {
                obj['CelebrityFaces'] = ApiClient.convertToType(data['CelebrityFaces'], Array);
            }
            if (data.hasOwnProperty('UnrecognizedFaces')) {
                obj['UnrecognizedFaces'] = ApiClient.convertToType(data['UnrecognizedFaces'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RecognizeCelebritiesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecognizeCelebritiesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CelebrityFaces`
        if (data['CelebrityFaces']) { // data not null
          Array.validateJSON(data['CelebrityFaces']);
        }
        // validate the optional field `UnrecognizedFaces`
        if (data['UnrecognizedFaces']) { // data not null
          Array.validateJSON(data['UnrecognizedFaces']);
        }
...
/**
 * @member {Array} CelebrityFaces
 */
RecognizeCelebritiesResponse.prototype['CelebrityFaces'] = undefined;

/**
 * @member {Array} UnrecognizedFaces
 */
RecognizeCelebritiesResponse.prototype['UnrecognizedFaces'] = undefined;

/**
 * @member {module:model/OrientationCorrection} OrientationCorrection
 */
RecognizeCelebritiesResponse.prototype['OrientationCorrection'] = undefined;
...
export default RecognizeCelebritiesResponse;
