...
/**
 * The LabelAlias model module.
 * @module model/LabelAlias
 * @version 2016-06-27
 */
class LabelAlias {
    /**
     * Constructs a new <code>LabelAlias</code>.
     * A potential alias of for a given label.
     * @alias module:model/LabelAlias
     */
    constructor() { 
        
        LabelAlias.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LabelAlias</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LabelAlias} obj Optional instance to populate.
     * @return {module:model/LabelAlias} The populated <code>LabelAlias</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LabelAlias();
    ...
    /**
     * Validates the JSON data with respect to <code>LabelAlias</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LabelAlias</code>.
     */
 ...
 * @member {String} Name
 */
LabelAlias.prototype['Name'] = undefined;
