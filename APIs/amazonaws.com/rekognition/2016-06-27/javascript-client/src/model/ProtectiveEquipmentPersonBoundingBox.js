...
/**
 * The ProtectiveEquipmentPersonBoundingBox model module.
 * @module model/ProtectiveEquipmentPersonBoundingBox
 * @version 2016-06-27
 */
class ProtectiveEquipmentPersonBoundingBox {
    /**
     * Constructs a new <code>ProtectiveEquipmentPersonBoundingBox</code>.
     * @alias module:model/ProtectiveEquipmentPersonBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        ProtectiveEquipmentPersonBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProtectiveEquipmentPersonBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProtectiveEquipmentPersonBoundingBox} obj Optional instance to populate.
     * @return {module:model/ProtectiveEquipmentPersonBoundingBox} The populated <code>ProtectiveEquipmentPersonBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProtectiveEquipmentPersonBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>ProtectiveEquipmentPersonBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProtectiveEquipmentPersonBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
ProtectiveEquipmentPersonBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
ProtectiveEquipmentPersonBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
ProtectiveEquipmentPersonBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
ProtectiveEquipmentPersonBoundingBox.prototype['Top'] = undefined;
...
export default ProtectiveEquipmentPersonBoundingBox;
