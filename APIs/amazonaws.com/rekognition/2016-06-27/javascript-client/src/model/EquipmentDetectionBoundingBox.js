...
/**
 * The EquipmentDetectionBoundingBox model module.
 * @module model/EquipmentDetectionBoundingBox
 * @version 2016-06-27
 */
class EquipmentDetectionBoundingBox {
    /**
     * Constructs a new <code>EquipmentDetectionBoundingBox</code>.
     * @alias module:model/EquipmentDetectionBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        EquipmentDetectionBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EquipmentDetectionBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EquipmentDetectionBoundingBox} obj Optional instance to populate.
     * @return {module:model/EquipmentDetectionBoundingBox} The populated <code>EquipmentDetectionBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EquipmentDetectionBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>EquipmentDetectionBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EquipmentDetectionBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
EquipmentDetectionBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
EquipmentDetectionBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
EquipmentDetectionBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
EquipmentDetectionBoundingBox.prototype['Top'] = undefined;
...
export default EquipmentDetectionBoundingBox;
