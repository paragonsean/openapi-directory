...
/**
 * The SegmentDetectionTechnicalCueSegment model module.
 * @module model/SegmentDetectionTechnicalCueSegment
 * @version 2016-06-27
 */
class SegmentDetectionTechnicalCueSegment {
    /**
     * Constructs a new <code>SegmentDetectionTechnicalCueSegment</code>.
     * @alias module:model/SegmentDetectionTechnicalCueSegment
     * @implements module:model/TechnicalCueSegment
     */
    constructor() { 
        TechnicalCueSegment.initialize(this);
        SegmentDetectionTechnicalCueSegment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SegmentDetectionTechnicalCueSegment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SegmentDetectionTechnicalCueSegment} obj Optional instance to populate.
     * @return {module:model/SegmentDetectionTechnicalCueSegment} The populated <code>SegmentDetectionTechnicalCueSegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SegmentDetectionTechnicalCueSegment();
            TechnicalCueSegment.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SegmentDetectionTechnicalCueSegment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SegmentDetectionTechnicalCueSegment</code>.
     */
 ...
 */
SegmentDetectionTechnicalCueSegment.prototype['Type'] = undefined;

/**
 * @member {Number} Confidence
 */
SegmentDetectionTechnicalCueSegment.prototype['Confidence'] = undefined;


// Implement TechnicalCueSegment interface:
/**
 * @member {module:model/TechnicalCueType} Type
 */
...
export default SegmentDetectionTechnicalCueSegment;
