...
import ProtectiveEquipmentPersonBoundingBox from './ProtectiveEquipmentPersonBoundingBox';

/**
 * The ProtectiveEquipmentPerson model module.
 * @module model/ProtectiveEquipmentPerson
 * @version 2016-06-27
 */
class ProtectiveEquipmentPerson {
    /**
     * Constructs a new <code>ProtectiveEquipmentPerson</code>.
     ...
     * @alias module:model/ProtectiveEquipmentPerson
     */
    constructor() { 
        
        ProtectiveEquipmentPerson.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProtectiveEquipmentPerson</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProtectiveEquipmentPerson} obj Optional instance to populate.
     * @return {module:model/ProtectiveEquipmentPerson} The populated <code>ProtectiveEquipmentPerson</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProtectiveEquipmentPerson();

            if (data.hasOwnProperty('BodyParts')) {
                obj['BodyParts'] = ApiClient.convertToType(data['BodyParts'], Array);
            }
            if (data.hasOwnProperty('BoundingBox')) {
                obj['BoundingBox'] = ProtectiveEquipmentPersonBoundingBox.constructFromObject(data['BoundingBox']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ProtectiveEquipmentPerson</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProtectiveEquipmentPerson</code>.
     */
    static validateJSON(data) {
        // validate the optional field `BodyParts`
        if (data['BodyParts']) { // data not null
          Array.validateJSON(data['BodyParts']);
        }
        // validate the optional field `BoundingBox`
        if (data['BoundingBox']) { // data not null
          ProtectiveEquipmentPersonBoundingBox.validateJSON(data['BoundingBox']);
        }
...
/**
 * @member {Array} BodyParts
 */
ProtectiveEquipmentPerson.prototype['BodyParts'] = undefined;

/**
 * @member {module:model/ProtectiveEquipmentPersonBoundingBox} BoundingBox
 */
ProtectiveEquipmentPerson.prototype['BoundingBox'] = undefined;

/**
 * @member {Number} Confidence
 */
ProtectiveEquipmentPerson.prototype['Confidence'] = undefined;

/**
 * @member {Number} Id
 */
ProtectiveEquipmentPerson.prototype['Id'] = undefined;
...
export default ProtectiveEquipmentPerson;
