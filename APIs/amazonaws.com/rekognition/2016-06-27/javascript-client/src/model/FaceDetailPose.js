...
/**
 * The FaceDetailPose model module.
 * @module model/FaceDetailPose
 * @version 2016-06-27
 */
class FaceDetailPose {
    /**
     * Constructs a new <code>FaceDetailPose</code>.
     * @alias module:model/FaceDetailPose
     * @implements module:model/Pose
     */
    constructor() { 
        Pose.initialize(this);
        FaceDetailPose.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailPose</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailPose} obj Optional instance to populate.
     * @return {module:model/FaceDetailPose} The populated <code>FaceDetailPose</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailPose();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailPose</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailPose</code>.
     */
 ...
 * @member {Number} Roll
 */
FaceDetailPose.prototype['Roll'] = undefined;

/**
 * @member {Number} Yaw
 */
FaceDetailPose.prototype['Yaw'] = undefined;

/**
 * @member {Number} Pitch
 */
FaceDetailPose.prototype['Pitch'] = undefined;
