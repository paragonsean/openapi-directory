...
/**
 * The StreamProcessorOutputS3Destination model module.
 * @module model/StreamProcessorOutputS3Destination
 * @version 2016-06-27
 */
class StreamProcessorOutputS3Destination {
    /**
     * Constructs a new <code>StreamProcessorOutputS3Destination</code>.
     * @alias module:model/StreamProcessorOutputS3Destination
     * @implements module:model/S3Destination
     */
    constructor() { 
        S3Destination.initialize(this);
        StreamProcessorOutputS3Destination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamProcessorOutputS3Destination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorOutputS3Destination} obj Optional instance to populate.
     * @return {module:model/StreamProcessorOutputS3Destination} The populated <code>StreamProcessorOutputS3Destination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorOutputS3Destination();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorOutputS3Destination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorOutputS3Destination</code>.
     */
 ...
 */
StreamProcessorOutputS3Destination.prototype['Bucket'] = undefined;

/**
 * @member {String} KeyPrefix
 */
StreamProcessorOutputS3Destination.prototype['KeyPrefix'] = undefined;
...
export default StreamProcessorOutputS3Destination;
