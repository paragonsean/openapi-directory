...
/**
 * The CreateFaceLivenessSessionResponse model module.
 * @module model/CreateFaceLivenessSessionResponse
 * @version 2016-06-27
 */
class CreateFaceLivenessSessionResponse {
    /**
     * Constructs a new <code>CreateFaceLivenessSessionResponse</code>.
     * @alias module:model/CreateFaceLivenessSessionResponse
     * @param sessionId {String} 
     */
    constructor(sessionId) { 
        
        CreateFaceLivenessSessionResponse.initialize(this, sessionId);
    }
    ...
    /**
     * Constructs a <code>CreateFaceLivenessSessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFaceLivenessSessionResponse} obj Optional instance to populate.
     * @return {module:model/CreateFaceLivenessSessionResponse} The populated <code>CreateFaceLivenessSessionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFaceLivenessSessionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFaceLivenessSessionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFaceLivenessSessionResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFaceLivenessSessionResponse.RequiredProperties) {
...
CreateFaceLivenessSessionResponse.RequiredProperties = ["SessionId"];

/**
 * @member {String} SessionId
 */
CreateFaceLivenessSessionResponse.prototype['SessionId'] = undefined;
...
export default CreateFaceLivenessSessionResponse;
