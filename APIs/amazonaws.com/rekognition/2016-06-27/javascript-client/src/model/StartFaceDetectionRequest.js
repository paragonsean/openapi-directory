...
import StartFaceDetectionRequestNotificationChannel from './StartFaceDetectionRequestNotificationChannel';
import StartFaceDetectionRequestVideo from './StartFaceDetectionRequestVideo';

/**
 * The StartFaceDetectionRequest model module.
 * @module model/StartFaceDetectionRequest
 * @version 2016-06-27
 */
class StartFaceDetectionRequest {
    /**
     * Constructs a new <code>StartFaceDetectionRequest</code>.
     * @alias module:model/StartFaceDetectionRequest
     * @param video {module:model/StartFaceDetectionRequestVideo} 
     */
    constructor(video) { 
        
        StartFaceDetectionRequest.initialize(this, video);
    }
    ...
    /**
     * Constructs a <code>StartFaceDetectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceDetectionRequest} obj Optional instance to populate.
     * @return {module:model/StartFaceDetectionRequest} The populated <code>StartFaceDetectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceDetectionRequest();

            if (data.hasOwnProperty('Video')) {
                obj['Video'] = StartFaceDetectionRequestVideo.constructFromObject(data['Video']);
            }
            ...
            if (data.hasOwnProperty('NotificationChannel')) {
                obj['NotificationChannel'] = StartFaceDetectionRequestNotificationChannel.constructFromObject(data['NotificationChannel']);
            }
            if (data.hasOwnProperty('FaceAttributes')) {
                obj['FaceAttributes'] = ApiClient.convertToType(data['FaceAttributes'], FaceAttributes);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceDetectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceDetectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartFaceDetectionRequest.RequiredProperties) {
        ...
        if (data['Video']) { // data not null
          StartFaceDetectionRequestVideo.validateJSON(data['Video']);
        }
        ...
        if (data['NotificationChannel']) { // data not null
          StartFaceDetectionRequestNotificationChannel.validateJSON(data['NotificationChannel']);
        }
...
StartFaceDetectionRequest.RequiredProperties = ["Video"];

/**
 * @member {module:model/StartFaceDetectionRequestVideo} Video
 */
StartFaceDetectionRequest.prototype['Video'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
StartFaceDetectionRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {module:model/StartFaceDetectionRequestNotificationChannel} NotificationChannel
 */
StartFaceDetectionRequest.prototype['NotificationChannel'] = undefined;

/**
 * @member {module:model/FaceAttributes} FaceAttributes
 */
StartFaceDetectionRequest.prototype['FaceAttributes'] = undefined;

/**
 * @member {String} JobTag
 */
StartFaceDetectionRequest.prototype['JobTag'] = undefined;
...
export default StartFaceDetectionRequest;
