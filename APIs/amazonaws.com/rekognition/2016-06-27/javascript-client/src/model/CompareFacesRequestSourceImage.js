...
import ImageS3Object from './ImageS3Object';

/**
 * The CompareFacesRequestSourceImage model module.
 * @module model/CompareFacesRequestSourceImage
 * @version 2016-06-27
 */
class CompareFacesRequestSourceImage {
    /**
     * Constructs a new <code>CompareFacesRequestSourceImage</code>.
     * @alias module:model/CompareFacesRequestSourceImage
     * @implements module:model/Image
     */
    constructor() { 
        Image.initialize(this);
        CompareFacesRequestSourceImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompareFacesRequestSourceImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompareFacesRequestSourceImage} obj Optional instance to populate.
     * @return {module:model/CompareFacesRequestSourceImage} The populated <code>CompareFacesRequestSourceImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompareFacesRequestSourceImage();
            ...
            if (data.hasOwnProperty('S3Object')) {
                obj['S3Object'] = ImageS3Object.constructFromObject(data['S3Object']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CompareFacesRequestSourceImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompareFacesRequestSourceImage</code>.
     */
    static validateJSON(data) {
        ...
        if (data['S3Object']) { // data not null
          ImageS3Object.validateJSON(data['S3Object']);
        }
 ...
 * @member {String} Bytes
 */
CompareFacesRequestSourceImage.prototype['Bytes'] = undefined;

/**
 * @member {module:model/ImageS3Object} S3Object
 */
CompareFacesRequestSourceImage.prototype['S3Object'] = undefined;
 ...
 * @member {String} Bytes
 */
Image.prototype['Bytes'] = undefined;
/**
 * @member {module:model/ImageS3Object} S3Object
 */
Image.prototype['S3Object'] = undefined;




export default CompareFacesRequestSourceImage;
