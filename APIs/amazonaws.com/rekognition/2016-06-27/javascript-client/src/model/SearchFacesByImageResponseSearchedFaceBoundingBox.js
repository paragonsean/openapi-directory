...
/**
 * The SearchFacesByImageResponseSearchedFaceBoundingBox model module.
 * @module model/SearchFacesByImageResponseSearchedFaceBoundingBox
 * @version 2016-06-27
 */
class SearchFacesByImageResponseSearchedFaceBoundingBox {
    /**
     * Constructs a new <code>SearchFacesByImageResponseSearchedFaceBoundingBox</code>.
     * @alias module:model/SearchFacesByImageResponseSearchedFaceBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        SearchFacesByImageResponseSearchedFaceBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchFacesByImageResponseSearchedFaceBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchFacesByImageResponseSearchedFaceBoundingBox} obj Optional instance to populate.
     * @return {module:model/SearchFacesByImageResponseSearchedFaceBoundingBox} The populated <code>SearchFacesByImageResponseSearchedFaceBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchFacesByImageResponseSearchedFaceBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchFacesByImageResponseSearchedFaceBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchFacesByImageResponseSearchedFaceBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
SearchFacesByImageResponseSearchedFaceBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
SearchFacesByImageResponseSearchedFaceBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
SearchFacesByImageResponseSearchedFaceBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
SearchFacesByImageResponseSearchedFaceBoundingBox.prototype['Top'] = undefined;
...
export default SearchFacesByImageResponseSearchedFaceBoundingBox;
