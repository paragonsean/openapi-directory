...
import TechnicalCueType from './TechnicalCueType';

/**
 * The TechnicalCueSegment model module.
 * @module model/TechnicalCueSegment
 * @version 2016-06-27
 */
class TechnicalCueSegment {
    /**
     * Constructs a new <code>TechnicalCueSegment</code>.
     * Information about a technical cue segment. For more information, see &lt;a&gt;SegmentDetection&lt;/a&gt;.
     * @alias module:model/TechnicalCueSegment
     */
    constructor() { 
        
        TechnicalCueSegment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TechnicalCueSegment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TechnicalCueSegment} obj Optional instance to populate.
     * @return {module:model/TechnicalCueSegment} The populated <code>TechnicalCueSegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TechnicalCueSegment();

            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], TechnicalCueType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TechnicalCueSegment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TechnicalCueSegment</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Type`
        if (data['Type']) { // data not null
          TechnicalCueType.validateJSON(data['Type']);
        }
...
/**
 * @member {module:model/TechnicalCueType} Type
 */
TechnicalCueSegment.prototype['Type'] = undefined;

/**
 * @member {Number} Confidence
 */
TechnicalCueSegment.prototype['Confidence'] = undefined;
...
export default TechnicalCueSegment;
