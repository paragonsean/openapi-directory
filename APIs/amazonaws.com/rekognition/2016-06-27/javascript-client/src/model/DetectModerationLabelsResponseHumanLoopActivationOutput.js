...
/**
 * The DetectModerationLabelsResponseHumanLoopActivationOutput model module.
 * @module model/DetectModerationLabelsResponseHumanLoopActivationOutput
 * @version 2016-06-27
 */
class DetectModerationLabelsResponseHumanLoopActivationOutput {
    /**
     * Constructs a new <code>DetectModerationLabelsResponseHumanLoopActivationOutput</code>.
     * @alias module:model/DetectModerationLabelsResponseHumanLoopActivationOutput
     * @implements module:model/HumanLoopActivationOutput
     */
    constructor() { 
        HumanLoopActivationOutput.initialize(this);
        DetectModerationLabelsResponseHumanLoopActivationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectModerationLabelsResponseHumanLoopActivationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectModerationLabelsResponseHumanLoopActivationOutput} obj Optional instance to populate.
     * @return {module:model/DetectModerationLabelsResponseHumanLoopActivationOutput} The populated <code>DetectModerationLabelsResponseHumanLoopActivationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectModerationLabelsResponseHumanLoopActivationOutput();
            HumanLoopActivationOutput.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DetectModerationLabelsResponseHumanLoopActivationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectModerationLabelsResponseHumanLoopActivationOutput</code>.
     */
 ...
 */
DetectModerationLabelsResponseHumanLoopActivationOutput.prototype['HumanLoopArn'] = undefined;

/**
 * @member {Array} HumanLoopActivationReasons
 */
DetectModerationLabelsResponseHumanLoopActivationOutput.prototype['HumanLoopActivationReasons'] = undefined;

/**
 * @member {String} HumanLoopActivationConditionsEvaluationResults
 */
DetectModerationLabelsResponseHumanLoopActivationOutput.prototype['HumanLoopActivationConditionsEvaluationResults'] = undefined;


// Implement HumanLoopActivationOutput interface:
/**
 * @member {String} HumanLoopArn
 */
...
export default DetectModerationLabelsResponseHumanLoopActivationOutput;
