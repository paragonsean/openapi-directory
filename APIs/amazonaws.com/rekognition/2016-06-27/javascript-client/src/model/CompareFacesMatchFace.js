...
/**
 * The CompareFacesMatchFace model module.
 * @module model/CompareFacesMatchFace
 * @version 2016-06-27
 */
class CompareFacesMatchFace {
    /**
     * Constructs a new <code>CompareFacesMatchFace</code>.
     * @alias module:model/CompareFacesMatchFace
     * @implements module:model/ComparedFace
     */
    constructor() { 
        ComparedFace.initialize(this);
        CompareFacesMatchFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompareFacesMatchFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompareFacesMatchFace} obj Optional instance to populate.
     * @return {module:model/CompareFacesMatchFace} The populated <code>CompareFacesMatchFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompareFacesMatchFace();
    ...
    /**
     * Validates the JSON data with respect to <code>CompareFacesMatchFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompareFacesMatchFace</code>.
     */
 ...
 */
CompareFacesMatchFace.prototype['BoundingBox'] = undefined;

/**
 * @member {Number} Confidence
 */
CompareFacesMatchFace.prototype['Confidence'] = undefined;

/**
 * @member {Array} Landmarks
 */
CompareFacesMatchFace.prototype['Landmarks'] = undefined;

/**
 * @member {module:model/ComparedFacePose} Pose
 */
CompareFacesMatchFace.prototype['Pose'] = undefined;

/**
 * @member {module:model/ComparedFaceQuality} Quality
 */
CompareFacesMatchFace.prototype['Quality'] = undefined;

/**
 * @member {Array} Emotions
 */
CompareFacesMatchFace.prototype['Emotions'] = undefined;

/**
 * @member {module:model/ComparedFaceSmile} Smile
 */
CompareFacesMatchFace.prototype['Smile'] = undefined;
...
export default CompareFacesMatchFace;
