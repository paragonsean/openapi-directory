...
* @readonly
*/
export default class EmotionName {
    ...
    /**
    * Returns a <code>EmotionName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EmotionName} The enum <code>EmotionName</code> value.
    */
