...
/**
 * The DetectLabelsRequestImage model module.
 * @module model/DetectLabelsRequestImage
 * @version 2016-06-27
 */
class DetectLabelsRequestImage {
    /**
     * Constructs a new <code>DetectLabelsRequestImage</code>.
     * @alias module:model/DetectLabelsRequestImage
     * @implements module:model/Image
     */
    constructor() { 
        Image.initialize(this);
        DetectLabelsRequestImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsRequestImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsRequestImage} obj Optional instance to populate.
     * @return {module:model/DetectLabelsRequestImage} The populated <code>DetectLabelsRequestImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsRequestImage();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsRequestImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsRequestImage</code>.
     */
 ...
 * @member {String} Bytes
 */
DetectLabelsRequestImage.prototype['Bytes'] = undefined;

/**
 * @member {module:model/ImageS3Object} S3Object
 */
DetectLabelsRequestImage.prototype['S3Object'] = undefined;
...
export default DetectLabelsRequestImage;
