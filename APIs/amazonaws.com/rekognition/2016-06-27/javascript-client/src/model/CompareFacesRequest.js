...
import CompareFacesRequestTargetImage from './CompareFacesRequestTargetImage';
import QualityFilter from './QualityFilter';

/**
 * The CompareFacesRequest model module.
 * @module model/CompareFacesRequest
 * @version 2016-06-27
 */
class CompareFacesRequest {
    /**
     * Constructs a new <code>CompareFacesRequest</code>.
     * @alias module:model/CompareFacesRequest
     * @param sourceImage {module:model/CompareFacesRequestSourceImage} 
     * @param targetImage {module:model/CompareFacesRequestTargetImage} 
     */
    constructor(sourceImage, targetImage) { 
        
        CompareFacesRequest.initialize(this, sourceImage, targetImage);
    }
     ...
     */
    static initialize(obj, sourceImage, targetImage) { 
        obj['SourceImage'] = sourceImage;
        obj['TargetImage'] = targetImage;
    }

    /**
     * Constructs a <code>CompareFacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompareFacesRequest} obj Optional instance to populate.
     * @return {module:model/CompareFacesRequest} The populated <code>CompareFacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompareFacesRequest();

            if (data.hasOwnProperty('SourceImage')) {
                obj['SourceImage'] = CompareFacesRequestSourceImage.constructFromObject(data['SourceImage']);
            }
            if (data.hasOwnProperty('TargetImage')) {
                obj['TargetImage'] = CompareFacesRequestTargetImage.constructFromObject(data['TargetImage']);
            }
            if (data.hasOwnProperty('SimilarityThreshold')) {
                obj['SimilarityThreshold'] = ApiClient.convertToType(data['SimilarityThreshold'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CompareFacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompareFacesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CompareFacesRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `SourceImage`
        if (data['SourceImage']) { // data not null
          CompareFacesRequestSourceImage.validateJSON(data['SourceImage']);
        }
        // validate the optional field `TargetImage`
        if (data['TargetImage']) { // data not null
          CompareFacesRequestTargetImage.validateJSON(data['TargetImage']);
        }
        // validate the optional field `SimilarityThreshold`
        if (data['SimilarityThreshold']) { // data not null
          Number.validateJSON(data['SimilarityThreshold']);
        }
...
CompareFacesRequest.RequiredProperties = ["SourceImage", "TargetImage"];

/**
 * @member {module:model/CompareFacesRequestSourceImage} SourceImage
 */
CompareFacesRequest.prototype['SourceImage'] = undefined;

/**
 * @member {module:model/CompareFacesRequestTargetImage} TargetImage
 */
CompareFacesRequest.prototype['TargetImage'] = undefined;

/**
 * @member {Number} SimilarityThreshold
 */
CompareFacesRequest.prototype['SimilarityThreshold'] = undefined;

/**
 * @member {module:model/QualityFilter} QualityFilter
 */
CompareFacesRequest.prototype['QualityFilter'] = undefined;
...
export default CompareFacesRequest;
