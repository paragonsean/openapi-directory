...
/**
 * The DetectFacesRequest model module.
 * @module model/DetectFacesRequest
 * @version 2016-06-27
 */
class DetectFacesRequest {
    /**
     * Constructs a new <code>DetectFacesRequest</code>.
     * @alias module:model/DetectFacesRequest
     * @param image {module:model/CompareFacesRequestSourceImage} 
     */
    constructor(image) { 
        
        DetectFacesRequest.initialize(this, image);
    }
    ...
    /**
     * Constructs a <code>DetectFacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectFacesRequest} obj Optional instance to populate.
     * @return {module:model/DetectFacesRequest} The populated <code>DetectFacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectFacesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectFacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectFacesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectFacesRequest.RequiredProperties) {
...
DetectFacesRequest.RequiredProperties = ["Image"];

/**
 * @member {module:model/CompareFacesRequestSourceImage} Image
 */
DetectFacesRequest.prototype['Image'] = undefined;

/**
 * @member {Array} Attributes
 */
DetectFacesRequest.prototype['Attributes'] = undefined;
...
export default DetectFacesRequest;
