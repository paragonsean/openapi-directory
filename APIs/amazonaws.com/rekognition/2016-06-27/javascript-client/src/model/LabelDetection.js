...
import LabelDetectionLabel from './LabelDetectionLabel';

/**
 * The LabelDetection model module.
 * @module model/LabelDetection
 * @version 2016-06-27
 */
class LabelDetection {
    /**
     * Constructs a new <code>LabelDetection</code>.
     * Information about a label detected in a video analysis request and the time the label was detected in the video. 
     * @alias module:model/LabelDetection
     */
    constructor() { 
        
        LabelDetection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LabelDetection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LabelDetection} obj Optional instance to populate.
     * @return {module:model/LabelDetection} The populated <code>LabelDetection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LabelDetection();

            if (data.hasOwnProperty('Timestamp')) {
                obj['Timestamp'] = ApiClient.convertToType(data['Timestamp'], 'Number');
            }
            if (data.hasOwnProperty('Label')) {
                obj['Label'] = LabelDetectionLabel.constructFromObject(data['Label']);
            }
            if (data.hasOwnProperty('StartTimestampMillis')) {
                obj['StartTimestampMillis'] = ApiClient.convertToType(data['StartTimestampMillis'], 'Number');
            }
            if (data.hasOwnProperty('EndTimestampMillis')) {
                obj['EndTimestampMillis'] = ApiClient.convertToType(data['EndTimestampMillis'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LabelDetection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LabelDetection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Label']) { // data not null
          LabelDetectionLabel.validateJSON(data['Label']);
        }
        // validate the optional field `StartTimestampMillis`
        if (data['StartTimestampMillis']) { // data not null
          Number.validateJSON(data['StartTimestampMillis']);
        }
        // validate the optional field `EndTimestampMillis`
        if (data['EndTimestampMillis']) { // data not null
          Number.validateJSON(data['EndTimestampMillis']);
        }
 ...
 */
LabelDetection.prototype['Timestamp'] = undefined;

/**
 * @member {module:model/LabelDetectionLabel} Label
 */
LabelDetection.prototype['Label'] = undefined;

/**
 * @member {Number} StartTimestampMillis
 */
LabelDetection.prototype['StartTimestampMillis'] = undefined;

/**
 * @member {Number} EndTimestampMillis
 */
LabelDetection.prototype['EndTimestampMillis'] = undefined;

/**
 * @member {Number} DurationMillis
 */
LabelDetection.prototype['DurationMillis'] = undefined;
