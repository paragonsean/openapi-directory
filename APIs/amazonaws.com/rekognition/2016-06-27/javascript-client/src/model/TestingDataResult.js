...
import TestingDataResultInput from './TestingDataResultInput';
import TestingDataResultOutput from './TestingDataResultOutput';
import TestingDataResultValidation from './TestingDataResultValidation';

/**
 * The TestingDataResult model module.
 * @module model/TestingDataResult
 * @version 2016-06-27
 */
class TestingDataResult {
    /**
     * Constructs a new <code>TestingDataResult</code>.
     * Sagemaker Groundtruth format manifest files for the input, output and validation datasets that are used and created during testing.
     * @alias module:model/TestingDataResult
     */
    constructor() { 
        
        TestingDataResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestingDataResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestingDataResult} obj Optional instance to populate.
     * @return {module:model/TestingDataResult} The populated <code>TestingDataResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestingDataResult();

            if (data.hasOwnProperty('Input')) {
                obj['Input'] = TestingDataResultInput.constructFromObject(data['Input']);
            }
            if (data.hasOwnProperty('Output')) {
                obj['Output'] = TestingDataResultOutput.constructFromObject(data['Output']);
            }
            if (data.hasOwnProperty('Validation')) {
                obj['Validation'] = TestingDataResultValidation.constructFromObject(data['Validation']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TestingDataResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestingDataResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Input`
        if (data['Input']) { // data not null
          TestingDataResultInput.validateJSON(data['Input']);
        }
        // validate the optional field `Output`
        if (data['Output']) { // data not null
          TestingDataResultOutput.validateJSON(data['Output']);
        }
        // validate the optional field `Validation`
        if (data['Validation']) { // data not null
          TestingDataResultValidation.validateJSON(data['Validation']);
        }
...
/**
 * @member {module:model/TestingDataResultInput} Input
 */
TestingDataResult.prototype['Input'] = undefined;

/**
 * @member {module:model/TestingDataResultOutput} Output
 */
TestingDataResult.prototype['Output'] = undefined;

/**
 * @member {module:model/TestingDataResultValidation} Validation
 */
TestingDataResult.prototype['Validation'] = undefined;
...
export default TestingDataResult;
