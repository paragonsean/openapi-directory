...
/**
 * The SegmentDetectionShotSegment model module.
 * @module model/SegmentDetectionShotSegment
 * @version 2016-06-27
 */
class SegmentDetectionShotSegment {
    /**
     * Constructs a new <code>SegmentDetectionShotSegment</code>.
     * @alias module:model/SegmentDetectionShotSegment
     * @implements module:model/ShotSegment
     */
    constructor() { 
        ShotSegment.initialize(this);
        SegmentDetectionShotSegment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SegmentDetectionShotSegment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SegmentDetectionShotSegment} obj Optional instance to populate.
     * @return {module:model/SegmentDetectionShotSegment} The populated <code>SegmentDetectionShotSegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SegmentDetectionShotSegment();
            ShotSegment.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SegmentDetectionShotSegment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SegmentDetectionShotSegment</code>.
     */
 ...
 * @member {Number} Index
 */
SegmentDetectionShotSegment.prototype['Index'] = undefined;

/**
 * @member {Number} Confidence
 */
SegmentDetectionShotSegment.prototype['Confidence'] = undefined;


// Implement ShotSegment interface:
/**
 * @member {Number} Index
 */
ShotSegment.prototype['Index'] = undefined;
/**
 * @member {Number} Confidence
 */
ShotSegment.prototype['Confidence'] = undefined;




export default SegmentDetectionShotSegment;
