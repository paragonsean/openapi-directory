...
* @readonly
*/
export default class UnsearchedFaceReason {
    
        /**
         * value: "FACE_NOT_LARGEST"
         * @const
         */
    ...
    /**
    * Returns a <code>UnsearchedFaceReason</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UnsearchedFaceReason} The enum <code>UnsearchedFaceReason</code> value.
    */
