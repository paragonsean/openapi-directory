...
/**
 * The Mustache model module.
 * @module model/Mustache
 * @version 2016-06-27
 */
class Mustache {
    /**
     * Constructs a new <code>Mustache</code>.
     * Indicates whether or not the face has a mustache, and the confidence level in the determination.
     * @alias module:model/Mustache
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Mustache</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Mustache} obj Optional instance to populate.
     * @return {module:model/Mustache} The populated <code>Mustache</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Mustache();
    ...
    /**
     * Validates the JSON data with respect to <code>Mustache</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Mustache</code>.
     */
