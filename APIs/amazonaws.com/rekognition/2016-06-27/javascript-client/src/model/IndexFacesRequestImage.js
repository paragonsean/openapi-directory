...
/**
 * The IndexFacesRequestImage model module.
 * @module model/IndexFacesRequestImage
 * @version 2016-06-27
 */
class IndexFacesRequestImage {
    /**
     * Constructs a new <code>IndexFacesRequestImage</code>.
     * @alias module:model/IndexFacesRequestImage
     * @implements module:model/Image
     */
    constructor() { 
        Image.initialize(this);
        IndexFacesRequestImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IndexFacesRequestImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IndexFacesRequestImage} obj Optional instance to populate.
     * @return {module:model/IndexFacesRequestImage} The populated <code>IndexFacesRequestImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IndexFacesRequestImage();
    ...
    /**
     * Validates the JSON data with respect to <code>IndexFacesRequestImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IndexFacesRequestImage</code>.
     */
 ...
 * @member {String} Bytes
 */
IndexFacesRequestImage.prototype['Bytes'] = undefined;

/**
 * @member {module:model/ImageS3Object} S3Object
 */
IndexFacesRequestImage.prototype['S3Object'] = undefined;
...
export default IndexFacesRequestImage;
