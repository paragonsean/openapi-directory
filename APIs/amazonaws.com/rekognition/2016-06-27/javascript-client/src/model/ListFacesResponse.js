...
/**
 * The ListFacesResponse model module.
 * @module model/ListFacesResponse
 * @version 2016-06-27
 */
class ListFacesResponse {
    /**
     * Constructs a new <code>ListFacesResponse</code>.
     * @alias module:model/ListFacesResponse
     */
    constructor() { 
        
        ListFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFacesResponse} obj Optional instance to populate.
     * @return {module:model/ListFacesResponse} The populated <code>ListFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFacesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFacesResponse</code>.
     */
 ...
 * @member {Array} Faces
 */
ListFacesResponse.prototype['Faces'] = undefined;

/**
 * @member {String} NextToken
 */
ListFacesResponse.prototype['NextToken'] = undefined;

/**
 * @member {String} FaceModelVersion
 */
ListFacesResponse.prototype['FaceModelVersion'] = undefined;
...
export default ListFacesResponse;
