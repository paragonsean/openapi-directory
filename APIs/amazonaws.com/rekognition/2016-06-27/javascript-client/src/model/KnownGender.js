...
import KnownGenderType from './KnownGenderType';

/**
 * The KnownGender model module.
 * @module model/KnownGender
 * @version 2016-06-27
 */
class KnownGender {
    /**
     * Constructs a new <code>KnownGender</code>.
     ...
     * @alias module:model/KnownGender
     */
    constructor() { 
        
        KnownGender.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KnownGender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KnownGender} obj Optional instance to populate.
     * @return {module:model/KnownGender} The populated <code>KnownGender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KnownGender();

            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], KnownGenderType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>KnownGender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KnownGender</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Type`
        if (data['Type']) { // data not null
          KnownGenderType.validateJSON(data['Type']);
        }
...
/**
 * @member {module:model/KnownGenderType} Type
 */
KnownGender.prototype['Type'] = undefined;
