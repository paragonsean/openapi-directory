...
import FaceMatchFace from './FaceMatchFace';
...
class FaceMatch {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Face')) {
                obj['Face'] = FaceMatchFace.constructFromObject(data['Face']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FaceMatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceMatch</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Similarity`
        if (data['Similarity']) { // data not null
          Number.validateJSON(data['Similarity']);
        }
        // validate the optional field `Face`
        if (data['Face']) { // data not null
          FaceMatchFace.validateJSON(data['Face']);
        }
 ...
 */
FaceMatch.prototype['Similarity'] = undefined;

/**
 * @member {module:model/FaceMatchFace} Face
 */
FaceMatch.prototype['Face'] = undefined;
