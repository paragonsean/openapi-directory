...
import StreamProcessorStatus from './StreamProcessorStatus';

/**
 * The StreamProcessor model module.
 * @module model/StreamProcessor
 * @version 2016-06-27
 */
class StreamProcessor {
    /**
     * Constructs a new <code>StreamProcessor</code>.
     ...
     * @alias module:model/StreamProcessor
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamProcessor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessor} obj Optional instance to populate.
     * @return {module:model/StreamProcessor} The populated <code>StreamProcessor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessor();

            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], 'String');
            }
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], StreamProcessorStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessor</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Status']) { // data not null
          StreamProcessorStatus.validateJSON(data['Status']);
        }
 ...
 * @member {String} Name
 */
StreamProcessor.prototype['Name'] = undefined;

/**
 * @member {module:model/StreamProcessorStatus} Status
 */
StreamProcessor.prototype['Status'] = undefined;
