...
import CompareFacesRequestSourceImage from './CompareFacesRequestSourceImage';
import DetectModerationLabelsRequestHumanLoopConfig from './DetectModerationLabelsRequestHumanLoopConfig';

/**
 * The DetectModerationLabelsRequest model module.
 * @module model/DetectModerationLabelsRequest
 * @version 2016-06-27
 */
class DetectModerationLabelsRequest {
    /**
     * Constructs a new <code>DetectModerationLabelsRequest</code>.
     * @alias module:model/DetectModerationLabelsRequest
     * @param image {module:model/CompareFacesRequestSourceImage} 
     */
    constructor(image) { 
        
        DetectModerationLabelsRequest.initialize(this, image);
    }
    ...
    /**
     * Constructs a <code>DetectModerationLabelsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectModerationLabelsRequest} obj Optional instance to populate.
     * @return {module:model/DetectModerationLabelsRequest} The populated <code>DetectModerationLabelsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectModerationLabelsRequest();

            if (data.hasOwnProperty('Image')) {
                obj['Image'] = CompareFacesRequestSourceImage.constructFromObject(data['Image']);
            }
            ...
            if (data.hasOwnProperty('HumanLoopConfig')) {
                obj['HumanLoopConfig'] = DetectModerationLabelsRequestHumanLoopConfig.constructFromObject(data['HumanLoopConfig']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectModerationLabelsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectModerationLabelsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectModerationLabelsRequest.RequiredProperties) {
        ...
        if (data['Image']) { // data not null
          CompareFacesRequestSourceImage.validateJSON(data['Image']);
        }
        ...
        if (data['HumanLoopConfig']) { // data not null
          DetectModerationLabelsRequestHumanLoopConfig.validateJSON(data['HumanLoopConfig']);
        }
...
DetectModerationLabelsRequest.RequiredProperties = ["Image"];

/**
 * @member {module:model/CompareFacesRequestSourceImage} Image
 */
DetectModerationLabelsRequest.prototype['Image'] = undefined;

/**
 * @member {Number} MinConfidence
 */
DetectModerationLabelsRequest.prototype['MinConfidence'] = undefined;

/**
 * @member {module:model/DetectModerationLabelsRequestHumanLoopConfig} HumanLoopConfig
 */
DetectModerationLabelsRequest.prototype['HumanLoopConfig'] = undefined;
...
export default DetectModerationLabelsRequest;
