...
import StartContentModerationRequestNotificationChannel from './StartContentModerationRequestNotificationChannel';
import StartContentModerationRequestVideo from './StartContentModerationRequestVideo';

/**
 * The StartContentModerationRequest model module.
 * @module model/StartContentModerationRequest
 * @version 2016-06-27
 */
class StartContentModerationRequest {
    /**
     * Constructs a new <code>StartContentModerationRequest</code>.
     * @alias module:model/StartContentModerationRequest
     * @param video {module:model/StartContentModerationRequestVideo} 
     */
    constructor(video) { 
        
        StartContentModerationRequest.initialize(this, video);
    }
    ...
    /**
     * Constructs a <code>StartContentModerationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartContentModerationRequest} obj Optional instance to populate.
     * @return {module:model/StartContentModerationRequest} The populated <code>StartContentModerationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartContentModerationRequest();

            if (data.hasOwnProperty('Video')) {
                obj['Video'] = StartContentModerationRequestVideo.constructFromObject(data['Video']);
            }
            if (data.hasOwnProperty('MinConfidence')) {
                obj['MinConfidence'] = ApiClient.convertToType(data['MinConfidence'], 'Number');
            }
            ...
            if (data.hasOwnProperty('NotificationChannel')) {
                obj['NotificationChannel'] = StartContentModerationRequestNotificationChannel.constructFromObject(data['NotificationChannel']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StartContentModerationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartContentModerationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartContentModerationRequest.RequiredProperties) {
        ...
        if (data['Video']) { // data not null
          StartContentModerationRequestVideo.validateJSON(data['Video']);
        }
        // validate the optional field `MinConfidence`
        if (data['MinConfidence']) { // data not null
          Number.validateJSON(data['MinConfidence']);
        }
        ...
        if (data['NotificationChannel']) { // data not null
          StartContentModerationRequestNotificationChannel.validateJSON(data['NotificationChannel']);
        }
...
StartContentModerationRequest.RequiredProperties = ["Video"];

/**
 * @member {module:model/StartContentModerationRequestVideo} Video
 */
StartContentModerationRequest.prototype['Video'] = undefined;

/**
 * @member {Number} MinConfidence
 */
StartContentModerationRequest.prototype['MinConfidence'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
StartContentModerationRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {module:model/StartContentModerationRequestNotificationChannel} NotificationChannel
 */
StartContentModerationRequest.prototype['NotificationChannel'] = undefined;

/**
 * @member {String} JobTag
 */
StartContentModerationRequest.prototype['JobTag'] = undefined;
...
export default StartContentModerationRequest;
