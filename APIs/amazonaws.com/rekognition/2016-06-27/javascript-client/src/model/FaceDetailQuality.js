...
/**
 * The FaceDetailQuality model module.
 * @module model/FaceDetailQuality
 * @version 2016-06-27
 */
class FaceDetailQuality {
    /**
     * Constructs a new <code>FaceDetailQuality</code>.
     * @alias module:model/FaceDetailQuality
     * @implements module:model/ImageQuality
     */
    constructor() { 
        ImageQuality.initialize(this);
        FaceDetailQuality.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailQuality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailQuality} obj Optional instance to populate.
     * @return {module:model/FaceDetailQuality} The populated <code>FaceDetailQuality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailQuality();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailQuality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailQuality</code>.
     */
 ...
 */
FaceDetailQuality.prototype['Brightness'] = undefined;

/**
 * @member {Number} Sharpness
 */
FaceDetailQuality.prototype['Sharpness'] = undefined;
...
export default FaceDetailQuality;
