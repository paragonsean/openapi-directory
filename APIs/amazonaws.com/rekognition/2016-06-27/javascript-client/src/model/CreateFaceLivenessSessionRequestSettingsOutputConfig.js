...
import LivenessOutputConfig from './LivenessOutputConfig';

/**
 * The CreateFaceLivenessSessionRequestSettingsOutputConfig model module.
 * @module model/CreateFaceLivenessSessionRequestSettingsOutputConfig
 * @version 2016-06-27
 */
class CreateFaceLivenessSessionRequestSettingsOutputConfig {
    /**
     * Constructs a new <code>CreateFaceLivenessSessionRequestSettingsOutputConfig</code>.
     * @alias module:model/CreateFaceLivenessSessionRequestSettingsOutputConfig
     * @implements module:model/LivenessOutputConfig
     * @param s3Bucket {String} 
     */
    constructor(s3Bucket) { 
        LivenessOutputConfig.initialize(this, s3Bucket);
        CreateFaceLivenessSessionRequestSettingsOutputConfig.initialize(this, s3Bucket);
    }
    ...
    /**
     * Constructs a <code>CreateFaceLivenessSessionRequestSettingsOutputConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFaceLivenessSessionRequestSettingsOutputConfig} obj Optional instance to populate.
     * @return {module:model/CreateFaceLivenessSessionRequestSettingsOutputConfig} The populated <code>CreateFaceLivenessSessionRequestSettingsOutputConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFaceLivenessSessionRequestSettingsOutputConfig();
            LivenessOutputConfig.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFaceLivenessSessionRequestSettingsOutputConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFaceLivenessSessionRequestSettingsOutputConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFaceLivenessSessionRequestSettingsOutputConfig.RequiredProperties) {
...
CreateFaceLivenessSessionRequestSettingsOutputConfig.RequiredProperties = ["S3Bucket"];

/**
 * @member {String} S3Bucket
 */
CreateFaceLivenessSessionRequestSettingsOutputConfig.prototype['S3Bucket'] = undefined;

/**
 * @member {String} S3KeyPrefix
 */
CreateFaceLivenessSessionRequestSettingsOutputConfig.prototype['S3KeyPrefix'] = undefined;


// Implement LivenessOutputConfig interface:
/**
 * @member {String} S3Bucket
 */
...
export default CreateFaceLivenessSessionRequestSettingsOutputConfig;
