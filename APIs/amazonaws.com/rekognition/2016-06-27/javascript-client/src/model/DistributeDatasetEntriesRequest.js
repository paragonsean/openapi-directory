...
/**
 * The DistributeDatasetEntriesRequest model module.
 * @module model/DistributeDatasetEntriesRequest
 * @version 2016-06-27
 */
class DistributeDatasetEntriesRequest {
    /**
     * Constructs a new <code>DistributeDatasetEntriesRequest</code>.
     * @alias module:model/DistributeDatasetEntriesRequest
     * @param datasets {Array} 
     */
    constructor(datasets) { 
        
        DistributeDatasetEntriesRequest.initialize(this, datasets);
    }
     ...
     */
    static initialize(obj, datasets) { 
        obj['Datasets'] = datasets;
    }

    /**
     * Constructs a <code>DistributeDatasetEntriesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DistributeDatasetEntriesRequest} obj Optional instance to populate.
     * @return {module:model/DistributeDatasetEntriesRequest} The populated <code>DistributeDatasetEntriesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DistributeDatasetEntriesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DistributeDatasetEntriesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DistributeDatasetEntriesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DistributeDatasetEntriesRequest.RequiredProperties) {
...
DistributeDatasetEntriesRequest.RequiredProperties = ["Datasets"];

/**
 * @member {Array} Datasets
 */
DistributeDatasetEntriesRequest.prototype['Datasets'] = undefined;
...
export default DistributeDatasetEntriesRequest;
