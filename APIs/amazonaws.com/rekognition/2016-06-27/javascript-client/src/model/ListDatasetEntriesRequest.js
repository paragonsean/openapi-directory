...
/**
 * The ListDatasetEntriesRequest model module.
 * @module model/ListDatasetEntriesRequest
 * @version 2016-06-27
 */
class ListDatasetEntriesRequest {
    /**
     * Constructs a new <code>ListDatasetEntriesRequest</code>.
     * @alias module:model/ListDatasetEntriesRequest
     * @param datasetArn {String} 
     */
    constructor(datasetArn) { 
        
        ListDatasetEntriesRequest.initialize(this, datasetArn);
    }
    ...
    /**
     * Constructs a <code>ListDatasetEntriesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDatasetEntriesRequest} obj Optional instance to populate.
     * @return {module:model/ListDatasetEntriesRequest} The populated <code>ListDatasetEntriesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDatasetEntriesRequest();

            if (data.hasOwnProperty('DatasetArn')) {
                obj['DatasetArn'] = ApiClient.convertToType(data['DatasetArn'], 'String');
            }
            if (data.hasOwnProperty('ContainsLabels')) {
                obj['ContainsLabels'] = ApiClient.convertToType(data['ContainsLabels'], Array);
            }
            if (data.hasOwnProperty('Labeled')) {
                obj['Labeled'] = ApiClient.convertToType(data['Labeled'], 'Boolean');
            }
            if (data.hasOwnProperty('SourceRefContains')) {
                obj['SourceRefContains'] = ApiClient.convertToType(data['SourceRefContains'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListDatasetEntriesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDatasetEntriesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListDatasetEntriesRequest.RequiredProperties) {
        ...
        if (data['ContainsLabels']) { // data not null
          Array.validateJSON(data['ContainsLabels']);
        }
        // validate the optional field `Labeled`
        if (data['Labeled']) { // data not null
          Boolean.validateJSON(data['Labeled']);
        }
        // validate the optional field `SourceRefContains`
        if (data['SourceRefContains']) { // data not null
          String.validateJSON(data['SourceRefContains']);
        }
        // validate the optional field `HasErrors`
        if (data['HasErrors']) { // data not null
          Boolean.validateJSON(data['HasErrors']);
        }
...
ListDatasetEntriesRequest.RequiredProperties = ["DatasetArn"];

/**
 * @member {String} DatasetArn
 */
ListDatasetEntriesRequest.prototype['DatasetArn'] = undefined;

/**
 * @member {Array} ContainsLabels
 */
ListDatasetEntriesRequest.prototype['ContainsLabels'] = undefined;

/**
 * @member {Boolean} Labeled
 */
ListDatasetEntriesRequest.prototype['Labeled'] = undefined;

/**
 * @member {String} SourceRefContains
 */
ListDatasetEntriesRequest.prototype['SourceRefContains'] = undefined;

/**
 * @member {Boolean} HasErrors
 */
ListDatasetEntriesRequest.prototype['HasErrors'] = undefined;

/**
 * @member {String} NextToken
 */
ListDatasetEntriesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListDatasetEntriesRequest.prototype['MaxResults'] = undefined;
...
export default ListDatasetEntriesRequest;
