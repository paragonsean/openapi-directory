...
/**
 * The AssociateFacesRequest model module.
 * @module model/AssociateFacesRequest
 * @version 2016-06-27
 */
class AssociateFacesRequest {
    /**
     * Constructs a new <code>AssociateFacesRequest</code>.
     * @alias module:model/AssociateFacesRequest
     * @param collectionId {String} 
     * @param userId {String} 
     * @param faceIds {Array} 
     */
    constructor(collectionId, userId, faceIds) { 
        
        AssociateFacesRequest.initialize(this, collectionId, userId, faceIds);
    }
     ...
     */
    static initialize(obj, collectionId, userId, faceIds) { 
    ...
    /**
     * Constructs a <code>AssociateFacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateFacesRequest} obj Optional instance to populate.
     * @return {module:model/AssociateFacesRequest} The populated <code>AssociateFacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateFacesRequest();
            ...
            if (data.hasOwnProperty('FaceIds')) {
                obj['FaceIds'] = ApiClient.convertToType(data['FaceIds'], Array);
            }
            if (data.hasOwnProperty('UserMatchThreshold')) {
                obj['UserMatchThreshold'] = ApiClient.convertToType(data['UserMatchThreshold'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateFacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateFacesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateFacesRequest.RequiredProperties) {
        ...
        // validate the optional field `FaceIds`
        if (data['FaceIds']) { // data not null
          Array.validateJSON(data['FaceIds']);
        }
        // validate the optional field `UserMatchThreshold`
        if (data['UserMatchThreshold']) { // data not null
          Number.validateJSON(data['UserMatchThreshold']);
        }
...
AssociateFacesRequest.RequiredProperties = ["CollectionId", "UserId", "FaceIds"];

/**
 * @member {String} CollectionId
 */
AssociateFacesRequest.prototype['CollectionId'] = undefined;

/**
 * @member {String} UserId
 */
AssociateFacesRequest.prototype['UserId'] = undefined;

/**
 * @member {Array} FaceIds
 */
AssociateFacesRequest.prototype['FaceIds'] = undefined;

/**
 * @member {Number} UserMatchThreshold
 */
AssociateFacesRequest.prototype['UserMatchThreshold'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
AssociateFacesRequest.prototype['ClientRequestToken'] = undefined;
...
export default AssociateFacesRequest;
