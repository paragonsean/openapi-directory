...
class CreateUserRequest {
     ...
     * @param userId {String} 
     */
    constructor(collectionId, userId) { 
        
        CreateUserRequest.initialize(this, collectionId, userId);
    }
     ...
     */
    static initialize(obj, collectionId, userId) { 
...
CreateUserRequest.RequiredProperties = ["CollectionId", "UserId"];

/**
 * @member {String} CollectionId
 */
CreateUserRequest.prototype['CollectionId'] = undefined;
 ...
 */
CreateUserRequest.prototype['ClientRequestToken'] = undefined;
