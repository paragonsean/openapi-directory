...
/**
 * The ProjectVersionDescriptionManifestSummary model module.
 * @module model/ProjectVersionDescriptionManifestSummary
 * @version 2016-06-27
 */
class ProjectVersionDescriptionManifestSummary {
    /**
     * Constructs a new <code>ProjectVersionDescriptionManifestSummary</code>.
     * @alias module:model/ProjectVersionDescriptionManifestSummary
     * @implements module:model/GroundTruthManifest
     */
    constructor() { 
        GroundTruthManifest.initialize(this);
        ProjectVersionDescriptionManifestSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectVersionDescriptionManifestSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectVersionDescriptionManifestSummary} obj Optional instance to populate.
     * @return {module:model/ProjectVersionDescriptionManifestSummary} The populated <code>ProjectVersionDescriptionManifestSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectVersionDescriptionManifestSummary();
            GroundTruthManifest.constructFromObject(data, obj);

            if (data.hasOwnProperty('S3Object')) {
                obj['S3Object'] = S3Object.constructFromObject(data['S3Object']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectVersionDescriptionManifestSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectVersionDescriptionManifestSummary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `S3Object`
        if (data['S3Object']) { // data not null
          S3Object.validateJSON(data['S3Object']);
        }
...
/**
 * @member {module:model/S3Object} S3Object
 */
ProjectVersionDescriptionManifestSummary.prototype['S3Object'] = undefined;


// Implement GroundTruthManifest interface:
/**
 * @member {module:model/S3Object} S3Object
 */
GroundTruthManifest.prototype['S3Object'] = undefined;




export default ProjectVersionDescriptionManifestSummary;
