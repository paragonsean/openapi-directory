...
import FaceDetectionFace from './FaceDetectionFace';

/**
 * The FaceDetection model module.
 * @module model/FaceDetection
 * @version 2016-06-27
 */
class FaceDetection {
    /**
     * Constructs a new <code>FaceDetection</code>.
     * Information about a face detected in a video analysis request and the time the face was detected in the video. 
     * @alias module:model/FaceDetection
     */
    constructor() { 
        
        FaceDetection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetection} obj Optional instance to populate.
     * @return {module:model/FaceDetection} The populated <code>FaceDetection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetection();

            if (data.hasOwnProperty('Timestamp')) {
                obj['Timestamp'] = ApiClient.convertToType(data['Timestamp'], 'Number');
            }
            if (data.hasOwnProperty('Face')) {
                obj['Face'] = FaceDetectionFace.constructFromObject(data['Face']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Face']) { // data not null
          FaceDetectionFace.validateJSON(data['Face']);
        }
 ...
 */
FaceDetection.prototype['Timestamp'] = undefined;

/**
 * @member {module:model/FaceDetectionFace} Face
 */
FaceDetection.prototype['Face'] = undefined;
