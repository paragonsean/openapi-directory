...
/**
 * The TrainingDataResultValidation model module.
 * @module model/TrainingDataResultValidation
 * @version 2016-06-27
 */
class TrainingDataResultValidation {
    /**
     * Constructs a new <code>TrainingDataResultValidation</code>.
     * @alias module:model/TrainingDataResultValidation
     * @implements module:model/ValidationData
     */
    constructor() { 
        ValidationData.initialize(this);
        TrainingDataResultValidation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrainingDataResultValidation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrainingDataResultValidation} obj Optional instance to populate.
     * @return {module:model/TrainingDataResultValidation} The populated <code>TrainingDataResultValidation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrainingDataResultValidation();
    ...
    /**
     * Validates the JSON data with respect to <code>TrainingDataResultValidation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrainingDataResultValidation</code>.
     */
 ...
 * @member {Array} Assets
 */
TrainingDataResultValidation.prototype['Assets'] = undefined;
...
export default TrainingDataResultValidation;
