...
import GetContentModerationRequestMetadata from './GetContentModerationRequestMetadata';

/**
 * The GetContentModerationResponseGetRequestMetadata model module.
 * @module model/GetContentModerationResponseGetRequestMetadata
 * @version 2016-06-27
 */
class GetContentModerationResponseGetRequestMetadata {
    /**
     * Constructs a new <code>GetContentModerationResponseGetRequestMetadata</code>.
     * @alias module:model/GetContentModerationResponseGetRequestMetadata
     * @implements module:model/GetContentModerationRequestMetadata
     */
    constructor() { 
        GetContentModerationRequestMetadata.initialize(this);
        GetContentModerationResponseGetRequestMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetContentModerationResponseGetRequestMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetContentModerationResponseGetRequestMetadata} obj Optional instance to populate.
     * @return {module:model/GetContentModerationResponseGetRequestMetadata} The populated <code>GetContentModerationResponseGetRequestMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetContentModerationResponseGetRequestMetadata();
            GetContentModerationRequestMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetContentModerationResponseGetRequestMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetContentModerationResponseGetRequestMetadata</code>.
     */
 ...
 */
GetContentModerationResponseGetRequestMetadata.prototype['SortBy'] = undefined;

/**
 * @member {module:model/ContentModerationAggregateBy} AggregateBy
 */
GetContentModerationResponseGetRequestMetadata.prototype['AggregateBy'] = undefined;


// Implement GetContentModerationRequestMetadata interface:
/**
 * @member {module:model/ContentModerationSortBy} SortBy
 */
...
export default GetContentModerationResponseGetRequestMetadata;
