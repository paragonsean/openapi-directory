...
/**
 * The FaceOccluded model module.
 * @module model/FaceOccluded
 * @version 2016-06-27
 */
class FaceOccluded {
    /**
     * Constructs a new <code>FaceOccluded</code>.
     ...
     * @alias module:model/FaceOccluded
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FaceOccluded</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceOccluded} obj Optional instance to populate.
     * @return {module:model/FaceOccluded} The populated <code>FaceOccluded</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceOccluded();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceOccluded</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceOccluded</code>.
     */
