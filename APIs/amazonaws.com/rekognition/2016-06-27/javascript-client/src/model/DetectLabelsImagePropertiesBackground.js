...
import DetectLabelsImageBackgroundQuality from './DetectLabelsImageBackgroundQuality';

/**
 * The DetectLabelsImagePropertiesBackground model module.
 * @module model/DetectLabelsImagePropertiesBackground
 * @version 2016-06-27
 */
class DetectLabelsImagePropertiesBackground {
    /**
     * Constructs a new <code>DetectLabelsImagePropertiesBackground</code>.
     * @alias module:model/DetectLabelsImagePropertiesBackground
     * @implements module:model/DetectLabelsImageBackground
     */
    constructor() { 
        DetectLabelsImageBackground.initialize(this);
        DetectLabelsImagePropertiesBackground.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsImagePropertiesBackground</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImagePropertiesBackground} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImagePropertiesBackground} The populated <code>DetectLabelsImagePropertiesBackground</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImagePropertiesBackground();
            DetectLabelsImageBackground.constructFromObject(data, obj);

            if (data.hasOwnProperty('Quality')) {
                obj['Quality'] = DetectLabelsImageBackgroundQuality.constructFromObject(data['Quality']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImagePropertiesBackground</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImagePropertiesBackground</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Quality`
        if (data['Quality']) { // data not null
          DetectLabelsImageBackgroundQuality.validateJSON(data['Quality']);
        }
...
/**
 * @member {module:model/DetectLabelsImageBackgroundQuality} Quality
 */
DetectLabelsImagePropertiesBackground.prototype['Quality'] = undefined;

/**
 * @member {Array} DominantColors
 */
DetectLabelsImagePropertiesBackground.prototype['DominantColors'] = undefined;


// Implement DetectLabelsImageBackground interface:
/**
 * @member {module:model/DetectLabelsImageBackgroundQuality} Quality
 */
DetectLabelsImageBackground.prototype['Quality'] = undefined;
/**
 * @member {Array} DominantColors
 */
DetectLabelsImageBackground.prototype['DominantColors'] = undefined;




export default DetectLabelsImagePropertiesBackground;
