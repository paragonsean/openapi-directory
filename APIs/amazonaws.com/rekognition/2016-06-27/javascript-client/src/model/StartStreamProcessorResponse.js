...
/**
 * The StartStreamProcessorResponse model module.
 * @module model/StartStreamProcessorResponse
 * @version 2016-06-27
 */
class StartStreamProcessorResponse {
    /**
     * Constructs a new <code>StartStreamProcessorResponse</code>.
     * @alias module:model/StartStreamProcessorResponse
     */
    constructor() { 
        
        StartStreamProcessorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartStreamProcessorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartStreamProcessorResponse} obj Optional instance to populate.
     * @return {module:model/StartStreamProcessorResponse} The populated <code>StartStreamProcessorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartStreamProcessorResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartStreamProcessorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartStreamProcessorResponse</code>.
     */
 ...
 */
StartStreamProcessorResponse.prototype['SessionId'] = undefined;
...
export default StartStreamProcessorResponse;
