...
/**
 * The TestingDataResultOutput model module.
 * @module model/TestingDataResultOutput
 * @version 2016-06-27
 */
class TestingDataResultOutput {
    /**
     * Constructs a new <code>TestingDataResultOutput</code>.
     * @alias module:model/TestingDataResultOutput
     * @implements module:model/TestingData
     */
    constructor() { 
        TestingData.initialize(this);
        TestingDataResultOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestingDataResultOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestingDataResultOutput} obj Optional instance to populate.
     * @return {module:model/TestingDataResultOutput} The populated <code>TestingDataResultOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestingDataResultOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>TestingDataResultOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestingDataResultOutput</code>.
     */
 ...
 * @member {Array} Assets
 */
TestingDataResultOutput.prototype['Assets'] = undefined;

/**
 * @member {Boolean} AutoCreate
 */
TestingDataResultOutput.prototype['AutoCreate'] = undefined;
...
export default TestingDataResultOutput;
