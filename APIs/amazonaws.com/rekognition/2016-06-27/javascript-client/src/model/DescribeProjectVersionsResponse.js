...
/**
 * The DescribeProjectVersionsResponse model module.
 * @module model/DescribeProjectVersionsResponse
 * @version 2016-06-27
 */
class DescribeProjectVersionsResponse {
    /**
     * Constructs a new <code>DescribeProjectVersionsResponse</code>.
     * @alias module:model/DescribeProjectVersionsResponse
     */
    constructor() { 
        
        DescribeProjectVersionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeProjectVersionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeProjectVersionsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeProjectVersionsResponse} The populated <code>DescribeProjectVersionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeProjectVersionsResponse();

            if (data.hasOwnProperty('ProjectVersionDescriptions')) {
                obj['ProjectVersionDescriptions'] = ApiClient.convertToType(data['ProjectVersionDescriptions'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeProjectVersionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeProjectVersionsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProjectVersionDescriptions`
        if (data['ProjectVersionDescriptions']) { // data not null
          Array.validateJSON(data['ProjectVersionDescriptions']);
        }
...
/**
 * @member {Array} ProjectVersionDescriptions
 */
DescribeProjectVersionsResponse.prototype['ProjectVersionDescriptions'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeProjectVersionsResponse.prototype['NextToken'] = undefined;
...
export default DescribeProjectVersionsResponse;
