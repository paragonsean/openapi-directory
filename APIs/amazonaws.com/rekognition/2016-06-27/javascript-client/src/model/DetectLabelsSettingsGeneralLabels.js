...
/**
 * The DetectLabelsSettingsGeneralLabels model module.
 * @module model/DetectLabelsSettingsGeneralLabels
 * @version 2016-06-27
 */
class DetectLabelsSettingsGeneralLabels {
    /**
     * Constructs a new <code>DetectLabelsSettingsGeneralLabels</code>.
     * @alias module:model/DetectLabelsSettingsGeneralLabels
     * @implements module:model/GeneralLabelsSettings
     */
    constructor() { 
        GeneralLabelsSettings.initialize(this);
        DetectLabelsSettingsGeneralLabels.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsSettingsGeneralLabels</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsSettingsGeneralLabels} obj Optional instance to populate.
     * @return {module:model/DetectLabelsSettingsGeneralLabels} The populated <code>DetectLabelsSettingsGeneralLabels</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsSettingsGeneralLabels();
            GeneralLabelsSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsSettingsGeneralLabels</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsSettingsGeneralLabels</code>.
     */
 ...
 */
DetectLabelsSettingsGeneralLabels.prototype['LabelInclusionFilters'] = undefined;

/**
 * @member {Array} LabelExclusionFilters
 */
DetectLabelsSettingsGeneralLabels.prototype['LabelExclusionFilters'] = undefined;

/**
 * @member {Array} LabelCategoryInclusionFilters
 */
DetectLabelsSettingsGeneralLabels.prototype['LabelCategoryInclusionFilters'] = undefined;

/**
 * @member {Array} LabelCategoryExclusionFilters
 */
DetectLabelsSettingsGeneralLabels.prototype['LabelCategoryExclusionFilters'] = undefined;


// Implement GeneralLabelsSettings interface:
/**
 * @member {Array} LabelInclusionFilters
 */
...
export default DetectLabelsSettingsGeneralLabels;
