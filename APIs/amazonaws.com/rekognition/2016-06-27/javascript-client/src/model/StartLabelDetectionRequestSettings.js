...
/**
 * The StartLabelDetectionRequestSettings model module.
 * @module model/StartLabelDetectionRequestSettings
 * @version 2016-06-27
 */
class StartLabelDetectionRequestSettings {
    /**
     * Constructs a new <code>StartLabelDetectionRequestSettings</code>.
     * @alias module:model/StartLabelDetectionRequestSettings
     * @implements module:model/LabelDetectionSettings
     */
    constructor() { 
        LabelDetectionSettings.initialize(this);
        StartLabelDetectionRequestSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartLabelDetectionRequestSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartLabelDetectionRequestSettings} obj Optional instance to populate.
     * @return {module:model/StartLabelDetectionRequestSettings} The populated <code>StartLabelDetectionRequestSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartLabelDetectionRequestSettings();
            LabelDetectionSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StartLabelDetectionRequestSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartLabelDetectionRequestSettings</code>.
     */
 ...
 */
StartLabelDetectionRequestSettings.prototype['GeneralLabels'] = undefined;


// Implement LabelDetectionSettings interface:
/**
 * @member {module:model/GeneralLabelsSettings} GeneralLabels
 */
...
export default StartLabelDetectionRequestSettings;
