...
/**
 * The FaceDetailSmile model module.
 * @module model/FaceDetailSmile
 * @version 2016-06-27
 */
class FaceDetailSmile {
    /**
     * Constructs a new <code>FaceDetailSmile</code>.
     * @alias module:model/FaceDetailSmile
     * @implements module:model/Smile
     */
    constructor() { 
        Smile.initialize(this);
        FaceDetailSmile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailSmile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailSmile} obj Optional instance to populate.
     * @return {module:model/FaceDetailSmile} The populated <code>FaceDetailSmile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailSmile();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailSmile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailSmile</code>.
     */
 ...
 */
FaceDetailSmile.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailSmile.prototype['Confidence'] = undefined;
...
export default FaceDetailSmile;
