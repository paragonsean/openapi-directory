...
/**
 * The ProtectiveEquipmentSummary model module.
 * @module model/ProtectiveEquipmentSummary
 * @version 2016-06-27
 */
class ProtectiveEquipmentSummary {
    /**
     * Constructs a new <code>ProtectiveEquipmentSummary</code>.
     ...
     * @alias module:model/ProtectiveEquipmentSummary
     */
    constructor() { 
        
        ProtectiveEquipmentSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProtectiveEquipmentSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProtectiveEquipmentSummary} obj Optional instance to populate.
     * @return {module:model/ProtectiveEquipmentSummary} The populated <code>ProtectiveEquipmentSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProtectiveEquipmentSummary();

            if (data.hasOwnProperty('PersonsWithRequiredEquipment')) {
                obj['PersonsWithRequiredEquipment'] = ApiClient.convertToType(data['PersonsWithRequiredEquipment'], Array);
            }
            if (data.hasOwnProperty('PersonsWithoutRequiredEquipment')) {
                obj['PersonsWithoutRequiredEquipment'] = ApiClient.convertToType(data['PersonsWithoutRequiredEquipment'], Array);
            }
            if (data.hasOwnProperty('PersonsIndeterminate')) {
                obj['PersonsIndeterminate'] = ApiClient.convertToType(data['PersonsIndeterminate'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProtectiveEquipmentSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProtectiveEquipmentSummary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PersonsWithRequiredEquipment`
        if (data['PersonsWithRequiredEquipment']) { // data not null
          Array.validateJSON(data['PersonsWithRequiredEquipment']);
        }
        // validate the optional field `PersonsWithoutRequiredEquipment`
        if (data['PersonsWithoutRequiredEquipment']) { // data not null
          Array.validateJSON(data['PersonsWithoutRequiredEquipment']);
        }
        // validate the optional field `PersonsIndeterminate`
        if (data['PersonsIndeterminate']) { // data not null
          Array.validateJSON(data['PersonsIndeterminate']);
        }
...
/**
 * @member {Array} PersonsWithRequiredEquipment
 */
ProtectiveEquipmentSummary.prototype['PersonsWithRequiredEquipment'] = undefined;

/**
 * @member {Array} PersonsWithoutRequiredEquipment
 */
ProtectiveEquipmentSummary.prototype['PersonsWithoutRequiredEquipment'] = undefined;

/**
 * @member {Array} PersonsIndeterminate
 */
ProtectiveEquipmentSummary.prototype['PersonsIndeterminate'] = undefined;
...
export default ProtectiveEquipmentSummary;
