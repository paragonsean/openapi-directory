...
/**
 * The StartFaceDetectionResponse model module.
 * @module model/StartFaceDetectionResponse
 * @version 2016-06-27
 */
class StartFaceDetectionResponse {
    /**
     * Constructs a new <code>StartFaceDetectionResponse</code>.
     * @alias module:model/StartFaceDetectionResponse
     */
    constructor() { 
        
        StartFaceDetectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartFaceDetectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceDetectionResponse} obj Optional instance to populate.
     * @return {module:model/StartFaceDetectionResponse} The populated <code>StartFaceDetectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceDetectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceDetectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceDetectionResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartFaceDetectionResponse.prototype['JobId'] = undefined;
...
export default StartFaceDetectionResponse;
