...
/**
 * The FaceDetailBoundingBox model module.
 * @module model/FaceDetailBoundingBox
 * @version 2016-06-27
 */
class FaceDetailBoundingBox {
    /**
     * Constructs a new <code>FaceDetailBoundingBox</code>.
     * @alias module:model/FaceDetailBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        FaceDetailBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailBoundingBox} obj Optional instance to populate.
     * @return {module:model/FaceDetailBoundingBox} The populated <code>FaceDetailBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
FaceDetailBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
FaceDetailBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
FaceDetailBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
FaceDetailBoundingBox.prototype['Top'] = undefined;
...
export default FaceDetailBoundingBox;
