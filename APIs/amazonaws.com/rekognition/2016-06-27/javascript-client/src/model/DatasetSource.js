...
class DatasetSource {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('GroundTruthManifest')) {
                obj['GroundTruthManifest'] = GroundTruthManifest.constructFromObject(data['GroundTruthManifest']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['GroundTruthManifest']) { // data not null
          GroundTruthManifest.validateJSON(data['GroundTruthManifest']);
        }
...
/**
 * @member {module:model/GroundTruthManifest} GroundTruthManifest
 */
 ...
 */
DatasetSource.prototype['DatasetArn'] = undefined;
