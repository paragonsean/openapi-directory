...
/**
 * The StartContentModerationRequestVideo model module.
 * @module model/StartContentModerationRequestVideo
 * @version 2016-06-27
 */
class StartContentModerationRequestVideo {
    /**
     * Constructs a new <code>StartContentModerationRequestVideo</code>.
     * @alias module:model/StartContentModerationRequestVideo
     * @implements module:model/Video
     */
    constructor() { 
        Video.initialize(this);
        StartContentModerationRequestVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartContentModerationRequestVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartContentModerationRequestVideo} obj Optional instance to populate.
     * @return {module:model/StartContentModerationRequestVideo} The populated <code>StartContentModerationRequestVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartContentModerationRequestVideo();
    ...
    /**
     * Validates the JSON data with respect to <code>StartContentModerationRequestVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartContentModerationRequestVideo</code>.
     */
 ...
 */
StartContentModerationRequestVideo.prototype['S3Object'] = undefined;
...
export default StartContentModerationRequestVideo;
