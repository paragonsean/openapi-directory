...
/**
 * The FaceDetailGender model module.
 * @module model/FaceDetailGender
 * @version 2016-06-27
 */
class FaceDetailGender {
    /**
     * Constructs a new <code>FaceDetailGender</code>.
     * @alias module:model/FaceDetailGender
     * @implements module:model/Gender
     */
    constructor() { 
        Gender.initialize(this);
        FaceDetailGender.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailGender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailGender} obj Optional instance to populate.
     * @return {module:model/FaceDetailGender} The populated <code>FaceDetailGender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailGender();
            Gender.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailGender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailGender</code>.
     */
 ...
 */
FaceDetailGender.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailGender.prototype['Confidence'] = undefined;


// Implement Gender interface:
/**
 * @member {module:model/GenderType} Value
 */
...
export default FaceDetailGender;
