...
/**
 * The TrainingDataResultInput model module.
 * @module model/TrainingDataResultInput
 * @version 2016-06-27
 */
class TrainingDataResultInput {
    /**
     * Constructs a new <code>TrainingDataResultInput</code>.
     * @alias module:model/TrainingDataResultInput
     * @implements module:model/TrainingData
     */
    constructor() { 
        TrainingData.initialize(this);
        TrainingDataResultInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrainingDataResultInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrainingDataResultInput} obj Optional instance to populate.
     * @return {module:model/TrainingDataResultInput} The populated <code>TrainingDataResultInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrainingDataResultInput();
            TrainingData.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>TrainingDataResultInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrainingDataResultInput</code>.
     */
 ...
 * @member {Array} Assets
 */
TrainingDataResultInput.prototype['Assets'] = undefined;


// Implement TrainingData interface:
/**
 * @member {Array} Assets
 */
TrainingData.prototype['Assets'] = undefined;




export default TrainingDataResultInput;
