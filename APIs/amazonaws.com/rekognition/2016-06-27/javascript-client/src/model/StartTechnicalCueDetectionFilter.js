...
/**
 * The StartTechnicalCueDetectionFilter model module.
 * @module model/StartTechnicalCueDetectionFilter
 * @version 2016-06-27
 */
class StartTechnicalCueDetectionFilter {
    /**
     * Constructs a new <code>StartTechnicalCueDetectionFilter</code>.
     ...
     * @alias module:model/StartTechnicalCueDetectionFilter
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StartTechnicalCueDetectionFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTechnicalCueDetectionFilter} obj Optional instance to populate.
     * @return {module:model/StartTechnicalCueDetectionFilter} The populated <code>StartTechnicalCueDetectionFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTechnicalCueDetectionFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>StartTechnicalCueDetectionFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTechnicalCueDetectionFilter</code>.
     */
...
export default StartTechnicalCueDetectionFilter;
