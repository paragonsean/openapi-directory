...
/**
 * The SegmentTypeInfo model module.
 * @module model/SegmentTypeInfo
 * @version 2016-06-27
 */
class SegmentTypeInfo {
    /**
     * Constructs a new <code>SegmentTypeInfo</code>.
     ...
     * @alias module:model/SegmentTypeInfo
     */
    constructor() { 
        
        SegmentTypeInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SegmentTypeInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SegmentTypeInfo} obj Optional instance to populate.
     * @return {module:model/SegmentTypeInfo} The populated <code>SegmentTypeInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SegmentTypeInfo();

            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], SegmentType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SegmentTypeInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SegmentTypeInfo</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Type`
        if (data['Type']) { // data not null
          SegmentType.validateJSON(data['Type']);
        }
...
/**
 * @member {module:model/SegmentType} Type
 */
SegmentTypeInfo.prototype['Type'] = undefined;

/**
 * @member {String} ModelVersion
 */
SegmentTypeInfo.prototype['ModelVersion'] = undefined;
...
export default SegmentTypeInfo;
