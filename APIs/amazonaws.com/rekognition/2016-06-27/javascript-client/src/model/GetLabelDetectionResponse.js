...
import GetLabelDetectionResponseGetRequestMetadata from './GetLabelDetectionResponseGetRequestMetadata';
import Video from './Video';
import VideoJobStatus from './VideoJobStatus';

/**
 * The GetLabelDetectionResponse model module.
 * @module model/GetLabelDetectionResponse
 * @version 2016-06-27
 */
class GetLabelDetectionResponse {
    /**
     * Constructs a new <code>GetLabelDetectionResponse</code>.
     * @alias module:model/GetLabelDetectionResponse
     */
    constructor() { 
        
        GetLabelDetectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLabelDetectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLabelDetectionResponse} obj Optional instance to populate.
     * @return {module:model/GetLabelDetectionResponse} The populated <code>GetLabelDetectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLabelDetectionResponse();
            ...
            if (data.hasOwnProperty('GetRequestMetadata')) {
                obj['GetRequestMetadata'] = GetLabelDetectionResponseGetRequestMetadata.constructFromObject(data['GetRequestMetadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLabelDetectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLabelDetectionResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['GetRequestMetadata']) { // data not null
          GetLabelDetectionResponseGetRequestMetadata.validateJSON(data['GetRequestMetadata']);
        }
 ...
 */
GetLabelDetectionResponse.prototype['JobStatus'] = undefined;

/**
 * @member {String} StatusMessage
 */
GetLabelDetectionResponse.prototype['StatusMessage'] = undefined;

/**
 * @member {module:model/GetFaceDetectionResponseVideoMetadata} VideoMetadata
 */
GetLabelDetectionResponse.prototype['VideoMetadata'] = undefined;

/**
 * @member {String} NextToken
 */
GetLabelDetectionResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} Labels
 */
GetLabelDetectionResponse.prototype['Labels'] = undefined;

/**
 * @member {String} LabelModelVersion
 */
GetLabelDetectionResponse.prototype['LabelModelVersion'] = undefined;

/**
 * @member {String} JobId
 */
GetLabelDetectionResponse.prototype['JobId'] = undefined;

/**
 * @member {module:model/Video} Video
 */
GetLabelDetectionResponse.prototype['Video'] = undefined;

/**
 * @member {String} JobTag
 */
GetLabelDetectionResponse.prototype['JobTag'] = undefined;

/**
 * @member {module:model/GetLabelDetectionResponseGetRequestMetadata} GetRequestMetadata
 */
GetLabelDetectionResponse.prototype['GetRequestMetadata'] = undefined;
...
export default GetLabelDetectionResponse;
