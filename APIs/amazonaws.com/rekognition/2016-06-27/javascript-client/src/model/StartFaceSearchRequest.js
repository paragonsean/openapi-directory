...
import StartFaceSearchRequestNotificationChannel from './StartFaceSearchRequestNotificationChannel';
import StartFaceSearchRequestVideo from './StartFaceSearchRequestVideo';

/**
 * The StartFaceSearchRequest model module.
 * @module model/StartFaceSearchRequest
 * @version 2016-06-27
 */
class StartFaceSearchRequest {
    /**
     * Constructs a new <code>StartFaceSearchRequest</code>.
     * @alias module:model/StartFaceSearchRequest
     * @param video {module:model/StartFaceSearchRequestVideo} 
     * @param collectionId {String} 
     */
    constructor(video, collectionId) { 
        
        StartFaceSearchRequest.initialize(this, video, collectionId);
    }
     ...
     */
    static initialize(obj, video, collectionId) { 
        obj['Video'] = video;
        obj['CollectionId'] = collectionId;
    }

    /**
     * Constructs a <code>StartFaceSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceSearchRequest} obj Optional instance to populate.
     * @return {module:model/StartFaceSearchRequest} The populated <code>StartFaceSearchRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceSearchRequest();

            if (data.hasOwnProperty('Video')) {
                obj['Video'] = StartFaceSearchRequestVideo.constructFromObject(data['Video']);
            }
            if (data.hasOwnProperty('ClientRequestToken')) {
                obj['ClientRequestToken'] = ApiClient.convertToType(data['ClientRequestToken'], 'String');
            }
            if (data.hasOwnProperty('FaceMatchThreshold')) {
                obj['FaceMatchThreshold'] = ApiClient.convertToType(data['FaceMatchThreshold'], 'Number');
            }
            ...
            if (data.hasOwnProperty('NotificationChannel')) {
                obj['NotificationChannel'] = StartFaceSearchRequestNotificationChannel.constructFromObject(data['NotificationChannel']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceSearchRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceSearchRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartFaceSearchRequest.RequiredProperties) {
        ...
        if (data['Video']) { // data not null
          StartFaceSearchRequestVideo.validateJSON(data['Video']);
        }
        ...
        if (data['FaceMatchThreshold']) { // data not null
          Number.validateJSON(data['FaceMatchThreshold']);
        }
        ...
        if (data['NotificationChannel']) { // data not null
          StartFaceSearchRequestNotificationChannel.validateJSON(data['NotificationChannel']);
        }
...
StartFaceSearchRequest.RequiredProperties = ["Video", "CollectionId"];

/**
 * @member {module:model/StartFaceSearchRequestVideo} Video
 */
StartFaceSearchRequest.prototype['Video'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
StartFaceSearchRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {Number} FaceMatchThreshold
 */
StartFaceSearchRequest.prototype['FaceMatchThreshold'] = undefined;

/**
 * @member {String} CollectionId
 */
StartFaceSearchRequest.prototype['CollectionId'] = undefined;

/**
 * @member {module:model/StartFaceSearchRequestNotificationChannel} NotificationChannel
 */
StartFaceSearchRequest.prototype['NotificationChannel'] = undefined;

/**
 * @member {String} JobTag
 */
StartFaceSearchRequest.prototype['JobTag'] = undefined;
...
export default StartFaceSearchRequest;
