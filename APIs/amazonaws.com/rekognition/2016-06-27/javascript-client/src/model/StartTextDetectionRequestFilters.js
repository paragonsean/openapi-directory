...
/**
 * The StartTextDetectionRequestFilters model module.
 * @module model/StartTextDetectionRequestFilters
 * @version 2016-06-27
 */
class StartTextDetectionRequestFilters {
    /**
     * Constructs a new <code>StartTextDetectionRequestFilters</code>.
     * @alias module:model/StartTextDetectionRequestFilters
     * @implements module:model/StartTextDetectionFilters
     */
    constructor() { 
        StartTextDetectionFilters.initialize(this);
        StartTextDetectionRequestFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartTextDetectionRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTextDetectionRequestFilters} obj Optional instance to populate.
     * @return {module:model/StartTextDetectionRequestFilters} The populated <code>StartTextDetectionRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTextDetectionRequestFilters();
            StartTextDetectionFilters.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StartTextDetectionRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTextDetectionRequestFilters</code>.
     */
 ...
 */
StartTextDetectionRequestFilters.prototype['WordFilter'] = undefined;

/**
 * @member {Array} RegionsOfInterest
 */
StartTextDetectionRequestFilters.prototype['RegionsOfInterest'] = undefined;


// Implement StartTextDetectionFilters interface:
/**
 * @member {module:model/StartTextDetectionFiltersWordFilter} WordFilter
 */
...
export default StartTextDetectionRequestFilters;
