...
import FaceRecordFace from './FaceRecordFace';
import FaceRecordFaceDetail from './FaceRecordFaceDetail';

/**
 * The FaceRecord model module.
 * @module model/FaceRecord
 * @version 2016-06-27
 */
class FaceRecord {
    /**
     * Constructs a new <code>FaceRecord</code>.
     * Object containing both the face metadata (stored in the backend database), and facial attributes that are detected but aren&#39;t stored in the database.
     * @alias module:model/FaceRecord
     */
    constructor() { 
        
        FaceRecord.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceRecord</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceRecord} obj Optional instance to populate.
     * @return {module:model/FaceRecord} The populated <code>FaceRecord</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceRecord();

            if (data.hasOwnProperty('Face')) {
                obj['Face'] = FaceRecordFace.constructFromObject(data['Face']);
            }
            if (data.hasOwnProperty('FaceDetail')) {
                obj['FaceDetail'] = FaceRecordFaceDetail.constructFromObject(data['FaceDetail']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FaceRecord</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceRecord</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Face`
        if (data['Face']) { // data not null
          FaceRecordFace.validateJSON(data['Face']);
        }
        // validate the optional field `FaceDetail`
        if (data['FaceDetail']) { // data not null
          FaceRecordFaceDetail.validateJSON(data['FaceDetail']);
        }
...
/**
 * @member {module:model/FaceRecordFace} Face
 */
FaceRecord.prototype['Face'] = undefined;

/**
 * @member {module:model/FaceRecordFaceDetail} FaceDetail
 */
FaceRecord.prototype['FaceDetail'] = undefined;
