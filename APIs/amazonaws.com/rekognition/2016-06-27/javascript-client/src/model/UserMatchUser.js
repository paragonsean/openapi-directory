...
/**
 * The UserMatchUser model module.
 * @module model/UserMatchUser
 * @version 2016-06-27
 */
class UserMatchUser {
    /**
     * Constructs a new <code>UserMatchUser</code>.
     * @alias module:model/UserMatchUser
     * @implements module:model/MatchedUser
     */
    constructor() { 
        MatchedUser.initialize(this);
        UserMatchUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserMatchUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserMatchUser} obj Optional instance to populate.
     * @return {module:model/UserMatchUser} The populated <code>UserMatchUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserMatchUser();
            MatchedUser.constructFromObject(data, obj);

            if (data.hasOwnProperty('UserId')) {
                obj['UserId'] = ApiClient.convertToType(data['UserId'], 'String');
            }
            if (data.hasOwnProperty('UserStatus')) {
                obj['UserStatus'] = ApiClient.convertToType(data['UserStatus'], UserStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserMatchUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserMatchUser</code>.
     */
    static validateJSON(data) {
        ...
        if (data['UserStatus']) { // data not null
          UserStatus.validateJSON(data['UserStatus']);
        }
 ...
 */
UserMatchUser.prototype['UserId'] = undefined;

/**
 * @member {module:model/UserStatus} UserStatus
 */
UserMatchUser.prototype['UserStatus'] = undefined;


// Implement MatchedUser interface:
/**
 * @member {String} UserId
 */
MatchedUser.prototype['UserId'] = undefined;
/**
 * @member {module:model/UserStatus} UserStatus
 */
MatchedUser.prototype['UserStatus'] = undefined;




export default UserMatchUser;
