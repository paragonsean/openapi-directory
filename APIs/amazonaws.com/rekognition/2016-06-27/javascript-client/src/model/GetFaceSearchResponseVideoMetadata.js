...
import VideoColorRange from './VideoColorRange';
import VideoMetadata from './VideoMetadata';

/**
 * The GetFaceSearchResponseVideoMetadata model module.
 * @module model/GetFaceSearchResponseVideoMetadata
 * @version 2016-06-27
 */
class GetFaceSearchResponseVideoMetadata {
    /**
     * Constructs a new <code>GetFaceSearchResponseVideoMetadata</code>.
     * @alias module:model/GetFaceSearchResponseVideoMetadata
     * @implements module:model/VideoMetadata
     */
    constructor() { 
        VideoMetadata.initialize(this);
        GetFaceSearchResponseVideoMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFaceSearchResponseVideoMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceSearchResponseVideoMetadata} obj Optional instance to populate.
     * @return {module:model/GetFaceSearchResponseVideoMetadata} The populated <code>GetFaceSearchResponseVideoMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceSearchResponseVideoMetadata();
            VideoMetadata.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('FrameHeight')) {
                obj['FrameHeight'] = ApiClient.convertToType(data['FrameHeight'], 'Number');
            }
            if (data.hasOwnProperty('FrameWidth')) {
                obj['FrameWidth'] = ApiClient.convertToType(data['FrameWidth'], 'Number');
            }
            if (data.hasOwnProperty('ColorRange')) {
                obj['ColorRange'] = ApiClient.convertToType(data['ColorRange'], VideoColorRange);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceSearchResponseVideoMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceSearchResponseVideoMetadata</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Codec`
        if (data['Codec']) { // data not null
          String.validateJSON(data['Codec']);
        }
        ...
        if (data['FrameHeight']) { // data not null
          Number.validateJSON(data['FrameHeight']);
        }
        // validate the optional field `FrameWidth`
        if (data['FrameWidth']) { // data not null
          Number.validateJSON(data['FrameWidth']);
        }
        // validate the optional field `ColorRange`
        if (data['ColorRange']) { // data not null
          VideoColorRange.validateJSON(data['ColorRange']);
        }
 ...
 * @member {String} Codec
 */
GetFaceSearchResponseVideoMetadata.prototype['Codec'] = undefined;

/**
 * @member {Number} DurationMillis
 */
GetFaceSearchResponseVideoMetadata.prototype['DurationMillis'] = undefined;

/**
 * @member {String} Format
 */
GetFaceSearchResponseVideoMetadata.prototype['Format'] = undefined;

/**
 * @member {Number} FrameRate
 */
GetFaceSearchResponseVideoMetadata.prototype['FrameRate'] = undefined;

/**
 * @member {Number} FrameHeight
 */
GetFaceSearchResponseVideoMetadata.prototype['FrameHeight'] = undefined;

/**
 * @member {Number} FrameWidth
 */
GetFaceSearchResponseVideoMetadata.prototype['FrameWidth'] = undefined;

/**
 * @member {module:model/VideoColorRange} ColorRange
 */
GetFaceSearchResponseVideoMetadata.prototype['ColorRange'] = undefined;


// Implement VideoMetadata interface:
/**
 * @member {String} Codec
 */
VideoMetadata.prototype['Codec'] = undefined;
/**
 * @member {Number} DurationMillis
 */
VideoMetadata.prototype['DurationMillis'] = undefined;
/**
 * @member {String} Format
 */
VideoMetadata.prototype['Format'] = undefined;
/**
 * @member {Number} FrameRate
 */
VideoMetadata.prototype['FrameRate'] = undefined;
/**
 * @member {Number} FrameHeight
 */
VideoMetadata.prototype['FrameHeight'] = undefined;
/**
 * @member {Number} FrameWidth
 */
VideoMetadata.prototype['FrameWidth'] = undefined;
/**
 * @member {module:model/VideoColorRange} ColorRange
 */
VideoMetadata.prototype['ColorRange'] = undefined;




export default GetFaceSearchResponseVideoMetadata;
