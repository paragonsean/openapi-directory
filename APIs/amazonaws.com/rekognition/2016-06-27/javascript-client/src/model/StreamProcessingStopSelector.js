...
/**
 * The StreamProcessingStopSelector model module.
 * @module model/StreamProcessingStopSelector
 * @version 2016-06-27
 */
class StreamProcessingStopSelector {
    /**
     * Constructs a new <code>StreamProcessingStopSelector</code>.
     *  Specifies when to stop processing the stream. You can specify a maximum amount of time to process the video. 
     * @alias module:model/StreamProcessingStopSelector
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamProcessingStopSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessingStopSelector} obj Optional instance to populate.
     * @return {module:model/StreamProcessingStopSelector} The populated <code>StreamProcessingStopSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessingStopSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessingStopSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessingStopSelector</code>.
     */
...
export default StreamProcessingStopSelector;
