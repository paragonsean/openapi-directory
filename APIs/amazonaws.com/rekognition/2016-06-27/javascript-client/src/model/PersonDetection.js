...
import PersonDetectionPerson from './PersonDetectionPerson';

/**
 * The PersonDetection model module.
 * @module model/PersonDetection
 * @version 2016-06-27
 */
class PersonDetection {
    /**
     * Constructs a new <code>PersonDetection</code>.
     ...
     * @alias module:model/PersonDetection
     */
    constructor() { 
        
        PersonDetection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PersonDetection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PersonDetection} obj Optional instance to populate.
     * @return {module:model/PersonDetection} The populated <code>PersonDetection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonDetection();

            if (data.hasOwnProperty('Timestamp')) {
                obj['Timestamp'] = ApiClient.convertToType(data['Timestamp'], 'Number');
            }
            if (data.hasOwnProperty('Person')) {
                obj['Person'] = PersonDetectionPerson.constructFromObject(data['Person']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PersonDetection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PersonDetection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Person']) { // data not null
          PersonDetectionPerson.validateJSON(data['Person']);
        }
 ...
 */
PersonDetection.prototype['Timestamp'] = undefined;

/**
 * @member {module:model/PersonDetectionPerson} Person
 */
PersonDetection.prototype['Person'] = undefined;
