...
import GetFaceLivenessSessionResultsResponseReferenceImage from './GetFaceLivenessSessionResultsResponseReferenceImage';
import LivenessSessionStatus from './LivenessSessionStatus';

/**
 * The GetFaceLivenessSessionResultsResponse model module.
 * @module model/GetFaceLivenessSessionResultsResponse
 * @version 2016-06-27
 */
class GetFaceLivenessSessionResultsResponse {
    /**
     * Constructs a new <code>GetFaceLivenessSessionResultsResponse</code>.
     * @alias module:model/GetFaceLivenessSessionResultsResponse
     * @param sessionId {String} 
     * @param status {module:model/LivenessSessionStatus} 
     */
    constructor(sessionId, status) { 
        
        GetFaceLivenessSessionResultsResponse.initialize(this, sessionId, status);
    }
     ...
     */
    static initialize(obj, sessionId, status) { 
        obj['SessionId'] = sessionId;
        obj['Status'] = status;
    }

    /**
     * Constructs a <code>GetFaceLivenessSessionResultsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceLivenessSessionResultsResponse} obj Optional instance to populate.
     * @return {module:model/GetFaceLivenessSessionResultsResponse} The populated <code>GetFaceLivenessSessionResultsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceLivenessSessionResultsResponse();

            if (data.hasOwnProperty('SessionId')) {
                obj['SessionId'] = ApiClient.convertToType(data['SessionId'], 'String');
            }
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], LivenessSessionStatus);
            }
            if (data.hasOwnProperty('Confidence')) {
                obj['Confidence'] = ApiClient.convertToType(data['Confidence'], 'Number');
            }
            if (data.hasOwnProperty('ReferenceImage')) {
                obj['ReferenceImage'] = GetFaceLivenessSessionResultsResponseReferenceImage.constructFromObject(data['ReferenceImage']);
            }
            if (data.hasOwnProperty('AuditImages')) {
                obj['AuditImages'] = ApiClient.convertToType(data['AuditImages'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceLivenessSessionResultsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceLivenessSessionResultsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFaceLivenessSessionResultsResponse.RequiredProperties) {
        ...
        if (data['Status']) { // data not null
          LivenessSessionStatus.validateJSON(data['Status']);
        }
        ...
        if (data['ReferenceImage']) { // data not null
          GetFaceLivenessSessionResultsResponseReferenceImage.validateJSON(data['ReferenceImage']);
        }
        // validate the optional field `AuditImages`
        if (data['AuditImages']) { // data not null
          Array.validateJSON(data['AuditImages']);
        }
...
GetFaceLivenessSessionResultsResponse.RequiredProperties = ["SessionId", "Status"];

/**
 * @member {String} SessionId
 */
GetFaceLivenessSessionResultsResponse.prototype['SessionId'] = undefined;

/**
 * @member {module:model/LivenessSessionStatus} Status
 */
GetFaceLivenessSessionResultsResponse.prototype['Status'] = undefined;

/**
 * @member {Number} Confidence
 */
GetFaceLivenessSessionResultsResponse.prototype['Confidence'] = undefined;

/**
 * @member {module:model/GetFaceLivenessSessionResultsResponseReferenceImage} ReferenceImage
 */
GetFaceLivenessSessionResultsResponse.prototype['ReferenceImage'] = undefined;

/**
 * @member {Array} AuditImages
 */
GetFaceLivenessSessionResultsResponse.prototype['AuditImages'] = undefined;
...
export default GetFaceLivenessSessionResultsResponse;
