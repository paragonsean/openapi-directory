...
/**
 * The DeleteFacesRequest model module.
 * @module model/DeleteFacesRequest
 * @version 2016-06-27
 */
class DeleteFacesRequest {
    /**
     * Constructs a new <code>DeleteFacesRequest</code>.
     * @alias module:model/DeleteFacesRequest
     * @param collectionId {String} 
     * @param faceIds {Array} 
     */
    constructor(collectionId, faceIds) { 
        
        DeleteFacesRequest.initialize(this, collectionId, faceIds);
    }
     ...
     */
    static initialize(obj, collectionId, faceIds) { 
        obj['CollectionId'] = collectionId;
        obj['FaceIds'] = faceIds;
    }

    /**
     * Constructs a <code>DeleteFacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFacesRequest} obj Optional instance to populate.
     * @return {module:model/DeleteFacesRequest} The populated <code>DeleteFacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFacesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFacesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFacesRequest.RequiredProperties) {
...
DeleteFacesRequest.RequiredProperties = ["CollectionId", "FaceIds"];

/**
 * @member {String} CollectionId
 */
DeleteFacesRequest.prototype['CollectionId'] = undefined;

/**
 * @member {Array} FaceIds
 */
DeleteFacesRequest.prototype['FaceIds'] = undefined;
...
export default DeleteFacesRequest;
