...
/**
 * The StartStreamProcessorRequestStopSelector model module.
 * @module model/StartStreamProcessorRequestStopSelector
 * @version 2016-06-27
 */
class StartStreamProcessorRequestStopSelector {
    /**
     * Constructs a new <code>StartStreamProcessorRequestStopSelector</code>.
     * @alias module:model/StartStreamProcessorRequestStopSelector
     * @implements module:model/StreamProcessingStopSelector
     */
    constructor() { 
        StreamProcessingStopSelector.initialize(this);
        StartStreamProcessorRequestStopSelector.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartStreamProcessorRequestStopSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartStreamProcessorRequestStopSelector} obj Optional instance to populate.
     * @return {module:model/StartStreamProcessorRequestStopSelector} The populated <code>StartStreamProcessorRequestStopSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartStreamProcessorRequestStopSelector();
            StreamProcessingStopSelector.constructFromObject(data, obj);

            if (data.hasOwnProperty('MaxDurationInSeconds')) {
                obj['MaxDurationInSeconds'] = ApiClient.convertToType(data['MaxDurationInSeconds'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartStreamProcessorRequestStopSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartStreamProcessorRequestStopSelector</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MaxDurationInSeconds`
        if (data['MaxDurationInSeconds']) { // data not null
          Number.validateJSON(data['MaxDurationInSeconds']);
        }
 ...
 */
StartStreamProcessorRequestStopSelector.prototype['MaxDurationInSeconds'] = undefined;


// Implement StreamProcessingStopSelector interface:
/**
 * @member {Number} MaxDurationInSeconds
 */
StreamProcessingStopSelector.prototype['MaxDurationInSeconds'] = undefined;




export default StartStreamProcessorRequestStopSelector;
