...
/**
 * The StreamProcessorOutputKinesisDataStream model module.
 * @module model/StreamProcessorOutputKinesisDataStream
 * @version 2016-06-27
 */
class StreamProcessorOutputKinesisDataStream {
    /**
     * Constructs a new <code>StreamProcessorOutputKinesisDataStream</code>.
     * @alias module:model/StreamProcessorOutputKinesisDataStream
     * @implements module:model/KinesisDataStream
     */
    constructor() { 
        KinesisDataStream.initialize(this);
        StreamProcessorOutputKinesisDataStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamProcessorOutputKinesisDataStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorOutputKinesisDataStream} obj Optional instance to populate.
     * @return {module:model/StreamProcessorOutputKinesisDataStream} The populated <code>StreamProcessorOutputKinesisDataStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorOutputKinesisDataStream();
            KinesisDataStream.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorOutputKinesisDataStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorOutputKinesisDataStream</code>.
     */
 ...
 * @member {String} Arn
 */
StreamProcessorOutputKinesisDataStream.prototype['Arn'] = undefined;


// Implement KinesisDataStream interface:
/**
 * @member {String} Arn
 */
...
export default StreamProcessorOutputKinesisDataStream;
