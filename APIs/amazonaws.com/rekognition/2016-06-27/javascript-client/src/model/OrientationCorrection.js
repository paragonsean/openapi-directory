...
* @readonly
*/
export default class OrientationCorrection {
    ...
    /**
    * Returns a <code>OrientationCorrection</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OrientationCorrection} The enum <code>OrientationCorrection</code> value.
    */
