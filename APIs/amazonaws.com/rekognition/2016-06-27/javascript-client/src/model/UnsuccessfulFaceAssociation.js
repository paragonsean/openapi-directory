...
/**
 * The UnsuccessfulFaceAssociation model module.
 * @module model/UnsuccessfulFaceAssociation
 * @version 2016-06-27
 */
class UnsuccessfulFaceAssociation {
    /**
     * Constructs a new <code>UnsuccessfulFaceAssociation</code>.
     * Contains metadata like FaceId, UserID, and Reasons, for a face that was unsuccessfully associated.
     * @alias module:model/UnsuccessfulFaceAssociation
     */
    constructor() { 
        
        UnsuccessfulFaceAssociation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnsuccessfulFaceAssociation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnsuccessfulFaceAssociation} obj Optional instance to populate.
     * @return {module:model/UnsuccessfulFaceAssociation} The populated <code>UnsuccessfulFaceAssociation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnsuccessfulFaceAssociation();
    ...
    /**
     * Validates the JSON data with respect to <code>UnsuccessfulFaceAssociation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnsuccessfulFaceAssociation</code>.
     */
 ...
 */
UnsuccessfulFaceAssociation.prototype['FaceId'] = undefined;

/**
 * @member {String} UserId
 */
UnsuccessfulFaceAssociation.prototype['UserId'] = undefined;

/**
 * @member {Number} Confidence
 */
UnsuccessfulFaceAssociation.prototype['Confidence'] = undefined;

/**
 * @member {Array} Reasons
 */
UnsuccessfulFaceAssociation.prototype['Reasons'] = undefined;
...
export default UnsuccessfulFaceAssociation;
