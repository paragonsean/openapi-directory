...
/**
 * The GetFaceLivenessSessionResultsRequest model module.
 * @module model/GetFaceLivenessSessionResultsRequest
 * @version 2016-06-27
 */
class GetFaceLivenessSessionResultsRequest {
    /**
     * Constructs a new <code>GetFaceLivenessSessionResultsRequest</code>.
     * @alias module:model/GetFaceLivenessSessionResultsRequest
     * @param sessionId {String} 
     */
    constructor(sessionId) { 
        
        GetFaceLivenessSessionResultsRequest.initialize(this, sessionId);
    }
    ...
    /**
     * Constructs a <code>GetFaceLivenessSessionResultsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceLivenessSessionResultsRequest} obj Optional instance to populate.
     * @return {module:model/GetFaceLivenessSessionResultsRequest} The populated <code>GetFaceLivenessSessionResultsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceLivenessSessionResultsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceLivenessSessionResultsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceLivenessSessionResultsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFaceLivenessSessionResultsRequest.RequiredProperties) {
...
GetFaceLivenessSessionResultsRequest.RequiredProperties = ["SessionId"];

/**
 * @member {String} SessionId
 */
GetFaceLivenessSessionResultsRequest.prototype['SessionId'] = undefined;
...
export default GetFaceLivenessSessionResultsRequest;
