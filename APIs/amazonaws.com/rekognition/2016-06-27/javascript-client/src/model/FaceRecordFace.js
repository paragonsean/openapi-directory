...
import ComparedFaceBoundingBox from './ComparedFaceBoundingBox';
import Face from './Face';

/**
 * The FaceRecordFace model module.
 * @module model/FaceRecordFace
 * @version 2016-06-27
 */
class FaceRecordFace {
    /**
     * Constructs a new <code>FaceRecordFace</code>.
     * @alias module:model/FaceRecordFace
     * @implements module:model/Face
     */
    constructor() { 
        Face.initialize(this);
        FaceRecordFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceRecordFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceRecordFace} obj Optional instance to populate.
     * @return {module:model/FaceRecordFace} The populated <code>FaceRecordFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceRecordFace();
            Face.constructFromObject(data, obj);

            if (data.hasOwnProperty('FaceId')) {
                obj['FaceId'] = ApiClient.convertToType(data['FaceId'], 'String');
            }
            if (data.hasOwnProperty('BoundingBox')) {
                obj['BoundingBox'] = ComparedFaceBoundingBox.constructFromObject(data['BoundingBox']);
            }
            if (data.hasOwnProperty('ImageId')) {
                obj['ImageId'] = ApiClient.convertToType(data['ImageId'], 'String');
            }
            if (data.hasOwnProperty('ExternalImageId')) {
                obj['ExternalImageId'] = ApiClient.convertToType(data['ExternalImageId'], 'String');
            }
            if (data.hasOwnProperty('Confidence')) {
                obj['Confidence'] = ApiClient.convertToType(data['Confidence'], 'Number');
            }
            if (data.hasOwnProperty('IndexFacesModelVersion')) {
                obj['IndexFacesModelVersion'] = ApiClient.convertToType(data['IndexFacesModelVersion'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FaceRecordFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceRecordFace</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FaceId`
        if (data['FaceId']) { // data not null
          String.validateJSON(data['FaceId']);
        }
        // validate the optional field `BoundingBox`
        if (data['BoundingBox']) { // data not null
          ComparedFaceBoundingBox.validateJSON(data['BoundingBox']);
        }
        ...
        if (data['ExternalImageId']) { // data not null
          String.validateJSON(data['ExternalImageId']);
        }
        ...
        if (data['IndexFacesModelVersion']) { // data not null
          String.validateJSON(data['IndexFacesModelVersion']);
        }
 ...
 */
FaceRecordFace.prototype['FaceId'] = undefined;

/**
 * @member {module:model/ComparedFaceBoundingBox} BoundingBox
 */
FaceRecordFace.prototype['BoundingBox'] = undefined;

/**
 * @member {String} ImageId
 */
FaceRecordFace.prototype['ImageId'] = undefined;

/**
 * @member {String} ExternalImageId
 */
FaceRecordFace.prototype['ExternalImageId'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceRecordFace.prototype['Confidence'] = undefined;

/**
 * @member {String} IndexFacesModelVersion
 */
FaceRecordFace.prototype['IndexFacesModelVersion'] = undefined;

/**
 * @member {String} UserId
 */
FaceRecordFace.prototype['UserId'] = undefined;


// Implement Face interface:
/**
 * @member {String} FaceId
 */
Face.prototype['FaceId'] = undefined;
/**
 * @member {module:model/ComparedFaceBoundingBox} BoundingBox
 */
Face.prototype['BoundingBox'] = undefined;
/**
 * @member {String} ImageId
 */
Face.prototype['ImageId'] = undefined;
/**
 * @member {String} ExternalImageId
 */
Face.prototype['ExternalImageId'] = undefined;
/**
 * @member {Number} Confidence
 */
Face.prototype['Confidence'] = undefined;
/**
 * @member {String} IndexFacesModelVersion
 */
Face.prototype['IndexFacesModelVersion'] = undefined;
/**
 * @member {String} UserId
 */
Face.prototype['UserId'] = undefined;




export default FaceRecordFace;
