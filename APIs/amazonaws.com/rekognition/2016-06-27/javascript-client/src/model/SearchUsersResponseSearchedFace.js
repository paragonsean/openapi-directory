...
import SearchedFace from './SearchedFace';

/**
 * The SearchUsersResponseSearchedFace model module.
 * @module model/SearchUsersResponseSearchedFace
 * @version 2016-06-27
 */
class SearchUsersResponseSearchedFace {
    /**
     * Constructs a new <code>SearchUsersResponseSearchedFace</code>.
     * @alias module:model/SearchUsersResponseSearchedFace
     * @implements module:model/SearchedFace
     */
    constructor() { 
        SearchedFace.initialize(this);
        SearchUsersResponseSearchedFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchUsersResponseSearchedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchUsersResponseSearchedFace} obj Optional instance to populate.
     * @return {module:model/SearchUsersResponseSearchedFace} The populated <code>SearchUsersResponseSearchedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchUsersResponseSearchedFace();
            SearchedFace.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SearchUsersResponseSearchedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchUsersResponseSearchedFace</code>.
     */
 ...
 */
SearchUsersResponseSearchedFace.prototype['FaceId'] = undefined;


// Implement SearchedFace interface:
/**
 * @member {String} FaceId
 */
SearchedFace.prototype['FaceId'] = undefined;




export default SearchUsersResponseSearchedFace;
