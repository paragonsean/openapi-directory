...
/**
 * The DatasetDescriptionDatasetStats model module.
 * @module model/DatasetDescriptionDatasetStats
 * @version 2016-06-27
 */
class DatasetDescriptionDatasetStats {
    /**
     * Constructs a new <code>DatasetDescriptionDatasetStats</code>.
     * @alias module:model/DatasetDescriptionDatasetStats
     * @implements module:model/DatasetStats
     */
    constructor() { 
        DatasetStats.initialize(this);
        DatasetDescriptionDatasetStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatasetDescriptionDatasetStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatasetDescriptionDatasetStats} obj Optional instance to populate.
     * @return {module:model/DatasetDescriptionDatasetStats} The populated <code>DatasetDescriptionDatasetStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatasetDescriptionDatasetStats();
            DatasetStats.constructFromObject(data, obj);

            if (data.hasOwnProperty('LabeledEntries')) {
                obj['LabeledEntries'] = ApiClient.convertToType(data['LabeledEntries'], 'Number');
            }
            ...
            if (data.hasOwnProperty('ErrorEntries')) {
                obj['ErrorEntries'] = ApiClient.convertToType(data['ErrorEntries'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatasetDescriptionDatasetStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatasetDescriptionDatasetStats</code>.
     */
    static validateJSON(data) {
        // validate the optional field `LabeledEntries`
        if (data['LabeledEntries']) { // data not null
          Number.validateJSON(data['LabeledEntries']);
        }
        // validate the optional field `TotalEntries`
        if (data['TotalEntries']) { // data not null
          Number.validateJSON(data['TotalEntries']);
        }
        // validate the optional field `TotalLabels`
        if (data['TotalLabels']) { // data not null
          Number.validateJSON(data['TotalLabels']);
        }
        // validate the optional field `ErrorEntries`
        if (data['ErrorEntries']) { // data not null
          Number.validateJSON(data['ErrorEntries']);
        }
...
/**
 * @member {Number} LabeledEntries
 */
DatasetDescriptionDatasetStats.prototype['LabeledEntries'] = undefined;

/**
 * @member {Number} TotalEntries
 */
DatasetDescriptionDatasetStats.prototype['TotalEntries'] = undefined;

/**
 * @member {Number} TotalLabels
 */
DatasetDescriptionDatasetStats.prototype['TotalLabels'] = undefined;

/**
 * @member {Number} ErrorEntries
 */
DatasetDescriptionDatasetStats.prototype['ErrorEntries'] = undefined;


// Implement DatasetStats interface:
/**
 * @member {Number} LabeledEntries
 */
DatasetStats.prototype['LabeledEntries'] = undefined;
/**
 * @member {Number} TotalEntries
 */
DatasetStats.prototype['TotalEntries'] = undefined;
/**
 * @member {Number} TotalLabels
 */
DatasetStats.prototype['TotalLabels'] = undefined;
/**
 * @member {Number} ErrorEntries
 */
DatasetStats.prototype['ErrorEntries'] = undefined;




export default DatasetDescriptionDatasetStats;
