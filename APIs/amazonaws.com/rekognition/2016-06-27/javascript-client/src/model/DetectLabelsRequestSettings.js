...
import DetectLabelsSettingsGeneralLabels from './DetectLabelsSettingsGeneralLabels';
import DetectLabelsSettingsImageProperties from './DetectLabelsSettingsImageProperties';

/**
 * The DetectLabelsRequestSettings model module.
 * @module model/DetectLabelsRequestSettings
 * @version 2016-06-27
 */
class DetectLabelsRequestSettings {
    /**
     * Constructs a new <code>DetectLabelsRequestSettings</code>.
     * @alias module:model/DetectLabelsRequestSettings
     * @implements module:model/DetectLabelsSettings
     */
    constructor() { 
        DetectLabelsSettings.initialize(this);
        DetectLabelsRequestSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsRequestSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsRequestSettings} obj Optional instance to populate.
     * @return {module:model/DetectLabelsRequestSettings} The populated <code>DetectLabelsRequestSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsRequestSettings();
            DetectLabelsSettings.constructFromObject(data, obj);

            if (data.hasOwnProperty('GeneralLabels')) {
                obj['GeneralLabels'] = DetectLabelsSettingsGeneralLabels.constructFromObject(data['GeneralLabels']);
            }
            if (data.hasOwnProperty('ImageProperties')) {
                obj['ImageProperties'] = DetectLabelsSettingsImageProperties.constructFromObject(data['ImageProperties']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsRequestSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsRequestSettings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GeneralLabels`
        if (data['GeneralLabels']) { // data not null
          DetectLabelsSettingsGeneralLabels.validateJSON(data['GeneralLabels']);
        }
        // validate the optional field `ImageProperties`
        if (data['ImageProperties']) { // data not null
          DetectLabelsSettingsImageProperties.validateJSON(data['ImageProperties']);
        }
...
/**
 * @member {module:model/DetectLabelsSettingsGeneralLabels} GeneralLabels
 */
DetectLabelsRequestSettings.prototype['GeneralLabels'] = undefined;

/**
 * @member {module:model/DetectLabelsSettingsImageProperties} ImageProperties
 */
DetectLabelsRequestSettings.prototype['ImageProperties'] = undefined;


// Implement DetectLabelsSettings interface:
/**
 * @member {module:model/DetectLabelsSettingsGeneralLabels} GeneralLabels
 */
DetectLabelsSettings.prototype['GeneralLabels'] = undefined;
/**
 * @member {module:model/DetectLabelsSettingsImageProperties} ImageProperties
 */
DetectLabelsSettings.prototype['ImageProperties'] = undefined;




export default DetectLabelsRequestSettings;
