...
/**
 * The StartSegmentDetectionRequestFilters model module.
 * @module model/StartSegmentDetectionRequestFilters
 * @version 2016-06-27
 */
class StartSegmentDetectionRequestFilters {
    /**
     * Constructs a new <code>StartSegmentDetectionRequestFilters</code>.
     * @alias module:model/StartSegmentDetectionRequestFilters
     * @implements module:model/StartSegmentDetectionFilters
     */
    constructor() { 
        StartSegmentDetectionFilters.initialize(this);
        StartSegmentDetectionRequestFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartSegmentDetectionRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSegmentDetectionRequestFilters} obj Optional instance to populate.
     * @return {module:model/StartSegmentDetectionRequestFilters} The populated <code>StartSegmentDetectionRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSegmentDetectionRequestFilters();
            StartSegmentDetectionFilters.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StartSegmentDetectionRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSegmentDetectionRequestFilters</code>.
     */
 ...
 */
StartSegmentDetectionRequestFilters.prototype['TechnicalCueFilter'] = undefined;

/**
 * @member {module:model/StartSegmentDetectionFiltersShotFilter} ShotFilter
 */
StartSegmentDetectionRequestFilters.prototype['ShotFilter'] = undefined;


// Implement StartSegmentDetectionFilters interface:
/**
 * @member {module:model/StartSegmentDetectionFiltersTechnicalCueFilter} TechnicalCueFilter
 */
...
export default StartSegmentDetectionRequestFilters;
