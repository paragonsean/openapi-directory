...
/**
 * The DisassociateFacesRequest model module.
 * @module model/DisassociateFacesRequest
 * @version 2016-06-27
 */
class DisassociateFacesRequest {
    /**
     * Constructs a new <code>DisassociateFacesRequest</code>.
     * @alias module:model/DisassociateFacesRequest
    ...
    constructor(collectionId, userId, faceIds) { 
        ...
        DisassociateFacesRequest.initialize(this, collectionId, userId, faceIds);
    }
    ...
    /**
     * Constructs a <code>DisassociateFacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateFacesRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateFacesRequest} The populated <code>DisassociateFacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateFacesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateFacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateFacesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateFacesRequest.RequiredProperties) {
...
DisassociateFacesRequest.RequiredProperties = ["CollectionId", "UserId", "FaceIds"];

/**
 * @member {String} CollectionId
 */
DisassociateFacesRequest.prototype['CollectionId'] = undefined;

/**
 * @member {String} UserId
 */
DisassociateFacesRequest.prototype['UserId'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
DisassociateFacesRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {Array} FaceIds
 */
DisassociateFacesRequest.prototype['FaceIds'] = undefined;
...
export default DisassociateFacesRequest;
