...
import FaceOccluded from './FaceOccluded';

/**
 * The FaceDetailFaceOccluded model module.
 * @module model/FaceDetailFaceOccluded
 * @version 2016-06-27
 */
class FaceDetailFaceOccluded {
    /**
     * Constructs a new <code>FaceDetailFaceOccluded</code>.
     * @alias module:model/FaceDetailFaceOccluded
     * @implements module:model/FaceOccluded
     */
    constructor() { 
        FaceOccluded.initialize(this);
        FaceDetailFaceOccluded.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailFaceOccluded</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailFaceOccluded} obj Optional instance to populate.
     * @return {module:model/FaceDetailFaceOccluded} The populated <code>FaceDetailFaceOccluded</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailFaceOccluded();
            FaceOccluded.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailFaceOccluded</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailFaceOccluded</code>.
     */
 ...
 */
FaceDetailFaceOccluded.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailFaceOccluded.prototype['Confidence'] = undefined;


// Implement FaceOccluded interface:
/**
 * @member {Boolean} Value
 */
FaceOccluded.prototype['Value'] = undefined;
/**
 * @member {Number} Confidence
 */
FaceOccluded.prototype['Confidence'] = undefined;




export default FaceDetailFaceOccluded;
