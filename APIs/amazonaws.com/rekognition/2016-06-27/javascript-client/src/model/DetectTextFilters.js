...
/**
 * The DetectTextFilters model module.
 * @module model/DetectTextFilters
 * @version 2016-06-27
 */
class DetectTextFilters {
    /**
     * Constructs a new <code>DetectTextFilters</code>.
     ...
     * @alias module:model/DetectTextFilters
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DetectTextFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectTextFilters} obj Optional instance to populate.
     * @return {module:model/DetectTextFilters} The populated <code>DetectTextFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectTextFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectTextFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectTextFilters</code>.
     */
...
export default DetectTextFilters;
