...
import PersonTrackingSortBy from './PersonTrackingSortBy';

/**
 * The GetPersonTrackingRequest model module.
 * @module model/GetPersonTrackingRequest
 * @version 2016-06-27
 */
class GetPersonTrackingRequest {
    /**
     * Constructs a new <code>GetPersonTrackingRequest</code>.
     * @alias module:model/GetPersonTrackingRequest
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetPersonTrackingRequest.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetPersonTrackingRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPersonTrackingRequest} obj Optional instance to populate.
     * @return {module:model/GetPersonTrackingRequest} The populated <code>GetPersonTrackingRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPersonTrackingRequest();
            ...
            if (data.hasOwnProperty('SortBy')) {
                obj['SortBy'] = ApiClient.convertToType(data['SortBy'], PersonTrackingSortBy);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPersonTrackingRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPersonTrackingRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPersonTrackingRequest.RequiredProperties) {
        ...
        if (data['SortBy']) { // data not null
          PersonTrackingSortBy.validateJSON(data['SortBy']);
        }
...
GetPersonTrackingRequest.RequiredProperties = ["JobId"];

/**
 * @member {String} JobId
 */
GetPersonTrackingRequest.prototype['JobId'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetPersonTrackingRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetPersonTrackingRequest.prototype['NextToken'] = undefined;

/**
 * @member {module:model/PersonTrackingSortBy} SortBy
 */
GetPersonTrackingRequest.prototype['SortBy'] = undefined;
...
export default GetPersonTrackingRequest;
