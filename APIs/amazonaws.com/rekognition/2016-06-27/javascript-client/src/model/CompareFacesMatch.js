...
import CompareFacesMatchFace from './CompareFacesMatchFace';

/**
 * The CompareFacesMatch model module.
 * @module model/CompareFacesMatch
 * @version 2016-06-27
 */
class CompareFacesMatch {
    /**
     * Constructs a new <code>CompareFacesMatch</code>.
     ...
     * @alias module:model/CompareFacesMatch
     */
    constructor() { 
        
        CompareFacesMatch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompareFacesMatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompareFacesMatch} obj Optional instance to populate.
     * @return {module:model/CompareFacesMatch} The populated <code>CompareFacesMatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompareFacesMatch();
            ...
            if (data.hasOwnProperty('Face')) {
                obj['Face'] = CompareFacesMatchFace.constructFromObject(data['Face']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CompareFacesMatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompareFacesMatch</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Face']) { // data not null
          CompareFacesMatchFace.validateJSON(data['Face']);
        }
 ...
 */
CompareFacesMatch.prototype['Similarity'] = undefined;

/**
 * @member {module:model/CompareFacesMatchFace} Face
 */
CompareFacesMatch.prototype['Face'] = undefined;
...
export default CompareFacesMatch;
