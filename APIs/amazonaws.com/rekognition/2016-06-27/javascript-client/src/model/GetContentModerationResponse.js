...
import GetContentModerationResponseGetRequestMetadata from './GetContentModerationResponseGetRequestMetadata';
import GetContentModerationResponseVideoMetadata from './GetContentModerationResponseVideoMetadata';
import Video from './Video';
import VideoJobStatus from './VideoJobStatus';

/**
 * The GetContentModerationResponse model module.
 * @module model/GetContentModerationResponse
 * @version 2016-06-27
 */
class GetContentModerationResponse {
    /**
     * Constructs a new <code>GetContentModerationResponse</code>.
     * @alias module:model/GetContentModerationResponse
     */
    constructor() { 
        
        GetContentModerationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetContentModerationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetContentModerationResponse} obj Optional instance to populate.
     * @return {module:model/GetContentModerationResponse} The populated <code>GetContentModerationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetContentModerationResponse();
            ...
            if (data.hasOwnProperty('VideoMetadata')) {
                obj['VideoMetadata'] = GetContentModerationResponseVideoMetadata.constructFromObject(data['VideoMetadata']);
            }
            ...
            if (data.hasOwnProperty('GetRequestMetadata')) {
                obj['GetRequestMetadata'] = GetContentModerationResponseGetRequestMetadata.constructFromObject(data['GetRequestMetadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetContentModerationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetContentModerationResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VideoMetadata']) { // data not null
          GetContentModerationResponseVideoMetadata.validateJSON(data['VideoMetadata']);
        }
        ...
        if (data['GetRequestMetadata']) { // data not null
          GetContentModerationResponseGetRequestMetadata.validateJSON(data['GetRequestMetadata']);
        }
 ...
 */
GetContentModerationResponse.prototype['JobStatus'] = undefined;

/**
 * @member {String} StatusMessage
 */
GetContentModerationResponse.prototype['StatusMessage'] = undefined;

/**
 * @member {module:model/GetContentModerationResponseVideoMetadata} VideoMetadata
 */
GetContentModerationResponse.prototype['VideoMetadata'] = undefined;

/**
 * @member {Array} ModerationLabels
 */
GetContentModerationResponse.prototype['ModerationLabels'] = undefined;

/**
 * @member {String} NextToken
 */
GetContentModerationResponse.prototype['NextToken'] = undefined;

/**
 * @member {String} ModerationModelVersion
 */
GetContentModerationResponse.prototype['ModerationModelVersion'] = undefined;

/**
 * @member {String} JobId
 */
GetContentModerationResponse.prototype['JobId'] = undefined;

/**
 * @member {module:model/Video} Video
 */
GetContentModerationResponse.prototype['Video'] = undefined;

/**
 * @member {String} JobTag
 */
GetContentModerationResponse.prototype['JobTag'] = undefined;

/**
 * @member {module:model/GetContentModerationResponseGetRequestMetadata} GetRequestMetadata
 */
GetContentModerationResponse.prototype['GetRequestMetadata'] = undefined;
...
export default GetContentModerationResponse;
