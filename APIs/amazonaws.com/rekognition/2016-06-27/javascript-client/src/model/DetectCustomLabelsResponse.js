...
/**
 * The DetectCustomLabelsResponse model module.
 * @module model/DetectCustomLabelsResponse
 * @version 2016-06-27
 */
class DetectCustomLabelsResponse {
    /**
     * Constructs a new <code>DetectCustomLabelsResponse</code>.
     * @alias module:model/DetectCustomLabelsResponse
     */
    constructor() { 
        
        DetectCustomLabelsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectCustomLabelsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectCustomLabelsResponse} obj Optional instance to populate.
     * @return {module:model/DetectCustomLabelsResponse} The populated <code>DetectCustomLabelsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectCustomLabelsResponse();

            if (data.hasOwnProperty('CustomLabels')) {
                obj['CustomLabels'] = ApiClient.convertToType(data['CustomLabels'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectCustomLabelsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectCustomLabelsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CustomLabels`
        if (data['CustomLabels']) { // data not null
          Array.validateJSON(data['CustomLabels']);
        }
...
/**
 * @member {Array} CustomLabels
 */
DetectCustomLabelsResponse.prototype['CustomLabels'] = undefined;
...
export default DetectCustomLabelsResponse;
