...
/**
 * The ListStreamProcessorsResponse model module.
 * @module model/ListStreamProcessorsResponse
 * @version 2016-06-27
 */
class ListStreamProcessorsResponse {
    /**
     * Constructs a new <code>ListStreamProcessorsResponse</code>.
     * @alias module:model/ListStreamProcessorsResponse
     */
    constructor() { 
        
        ListStreamProcessorsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListStreamProcessorsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStreamProcessorsResponse} obj Optional instance to populate.
     * @return {module:model/ListStreamProcessorsResponse} The populated <code>ListStreamProcessorsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStreamProcessorsResponse();

            if (data.hasOwnProperty('NextToken')) {
                obj['NextToken'] = ApiClient.convertToType(data['NextToken'], 'String');
            }
            if (data.hasOwnProperty('StreamProcessors')) {
                obj['StreamProcessors'] = ApiClient.convertToType(data['StreamProcessors'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListStreamProcessorsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStreamProcessorsResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['StreamProcessors']) { // data not null
          Array.validateJSON(data['StreamProcessors']);
        }
 ...
 */
ListStreamProcessorsResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} StreamProcessors
 */
ListStreamProcessorsResponse.prototype['StreamProcessors'] = undefined;
...
export default ListStreamProcessorsResponse;
