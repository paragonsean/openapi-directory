...
/**
 * The StartProjectVersionRequest model module.
 * @module model/StartProjectVersionRequest
 * @version 2016-06-27
 */
class StartProjectVersionRequest {
    /**
     * Constructs a new <code>StartProjectVersionRequest</code>.
     * @alias module:model/StartProjectVersionRequest
     * @param projectVersionArn {String} 
     * @param minInferenceUnits {Number} 
     */
    constructor(projectVersionArn, minInferenceUnits) { 
        
        StartProjectVersionRequest.initialize(this, projectVersionArn, minInferenceUnits);
    }
     ...
     */
    static initialize(obj, projectVersionArn, minInferenceUnits) { 
        obj['ProjectVersionArn'] = projectVersionArn;
        obj['MinInferenceUnits'] = minInferenceUnits;
    }

    /**
     * Constructs a <code>StartProjectVersionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartProjectVersionRequest} obj Optional instance to populate.
     * @return {module:model/StartProjectVersionRequest} The populated <code>StartProjectVersionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartProjectVersionRequest();

            if (data.hasOwnProperty('ProjectVersionArn')) {
                obj['ProjectVersionArn'] = ApiClient.convertToType(data['ProjectVersionArn'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StartProjectVersionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartProjectVersionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartProjectVersionRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ProjectVersionArn`
        if (data['ProjectVersionArn']) { // data not null
          String.validateJSON(data['ProjectVersionArn']);
        }
...
StartProjectVersionRequest.RequiredProperties = ["ProjectVersionArn", "MinInferenceUnits"];

/**
 * @member {String} ProjectVersionArn
 */
StartProjectVersionRequest.prototype['ProjectVersionArn'] = undefined;

/**
 * @member {Number} MinInferenceUnits
 */
StartProjectVersionRequest.prototype['MinInferenceUnits'] = undefined;

/**
 * @member {Number} MaxInferenceUnits
 */
StartProjectVersionRequest.prototype['MaxInferenceUnits'] = undefined;
...
export default StartProjectVersionRequest;
