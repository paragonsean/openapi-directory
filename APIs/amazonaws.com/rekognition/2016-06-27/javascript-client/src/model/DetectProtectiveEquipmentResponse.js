...
import DetectProtectiveEquipmentResponseSummary from './DetectProtectiveEquipmentResponseSummary';

/**
 * The DetectProtectiveEquipmentResponse model module.
 * @module model/DetectProtectiveEquipmentResponse
 * @version 2016-06-27
 */
class DetectProtectiveEquipmentResponse {
    /**
     * Constructs a new <code>DetectProtectiveEquipmentResponse</code>.
     * @alias module:model/DetectProtectiveEquipmentResponse
     */
    constructor() { 
        
        DetectProtectiveEquipmentResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectProtectiveEquipmentResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectProtectiveEquipmentResponse} obj Optional instance to populate.
     * @return {module:model/DetectProtectiveEquipmentResponse} The populated <code>DetectProtectiveEquipmentResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectProtectiveEquipmentResponse();

            if (data.hasOwnProperty('ProtectiveEquipmentModelVersion')) {
                obj['ProtectiveEquipmentModelVersion'] = ApiClient.convertToType(data['ProtectiveEquipmentModelVersion'], 'String');
            }
            if (data.hasOwnProperty('Persons')) {
                obj['Persons'] = ApiClient.convertToType(data['Persons'], Array);
            }
            if (data.hasOwnProperty('Summary')) {
                obj['Summary'] = DetectProtectiveEquipmentResponseSummary.constructFromObject(data['Summary']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectProtectiveEquipmentResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectProtectiveEquipmentResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProtectiveEquipmentModelVersion`
        if (data['ProtectiveEquipmentModelVersion']) { // data not null
          String.validateJSON(data['ProtectiveEquipmentModelVersion']);
        }
        ...
        if (data['Summary']) { // data not null
          DetectProtectiveEquipmentResponseSummary.validateJSON(data['Summary']);
        }
...
/**
 * @member {String} ProtectiveEquipmentModelVersion
 */
DetectProtectiveEquipmentResponse.prototype['ProtectiveEquipmentModelVersion'] = undefined;

/**
 * @member {Array} Persons
 */
DetectProtectiveEquipmentResponse.prototype['Persons'] = undefined;

/**
 * @member {module:model/DetectProtectiveEquipmentResponseSummary} Summary
 */
DetectProtectiveEquipmentResponse.prototype['Summary'] = undefined;
...
export default DetectProtectiveEquipmentResponse;
