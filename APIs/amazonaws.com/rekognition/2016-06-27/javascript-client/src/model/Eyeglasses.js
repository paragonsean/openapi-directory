...
/**
 * The Eyeglasses model module.
 * @module model/Eyeglasses
 * @version 2016-06-27
 */
class Eyeglasses {
    /**
     * Constructs a new <code>Eyeglasses</code>.
     * Indicates whether or not the face is wearing eye glasses, and the confidence level in the determination.
     * @alias module:model/Eyeglasses
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Eyeglasses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Eyeglasses} obj Optional instance to populate.
     * @return {module:model/Eyeglasses} The populated <code>Eyeglasses</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Eyeglasses();
    ...
    /**
     * Validates the JSON data with respect to <code>Eyeglasses</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Eyeglasses</code>.
     */
