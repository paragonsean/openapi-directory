...
/**
 * The DetectLabelsResponseImageProperties model module.
 * @module model/DetectLabelsResponseImageProperties
 * @version 2016-06-27
 */
class DetectLabelsResponseImageProperties {
    /**
     * Constructs a new <code>DetectLabelsResponseImageProperties</code>.
     * @alias module:model/DetectLabelsResponseImageProperties
     * @implements module:model/DetectLabelsImageProperties
     */
    constructor() { 
        DetectLabelsImageProperties.initialize(this);
        DetectLabelsResponseImageProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsResponseImageProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsResponseImageProperties} obj Optional instance to populate.
     * @return {module:model/DetectLabelsResponseImageProperties} The populated <code>DetectLabelsResponseImageProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsResponseImageProperties();
            DetectLabelsImageProperties.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsResponseImageProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsResponseImageProperties</code>.
     */
 ...
 */
DetectLabelsResponseImageProperties.prototype['Quality'] = undefined;

/**
 * @member {Array} DominantColors
 */
DetectLabelsResponseImageProperties.prototype['DominantColors'] = undefined;

/**
 * @member {module:model/DetectLabelsImagePropertiesForeground} Foreground
 */
DetectLabelsResponseImageProperties.prototype['Foreground'] = undefined;

/**
 * @member {module:model/DetectLabelsImagePropertiesBackground} Background
 */
DetectLabelsResponseImageProperties.prototype['Background'] = undefined;


// Implement DetectLabelsImageProperties interface:
/**
 * @member {module:model/DetectLabelsImagePropertiesQuality} Quality
 */
...
export default DetectLabelsResponseImageProperties;
