...
/**
 * The StartPersonTrackingRequestNotificationChannel model module.
 * @module model/StartPersonTrackingRequestNotificationChannel
 * @version 2016-06-27
 */
class StartPersonTrackingRequestNotificationChannel {
    /**
     * Constructs a new <code>StartPersonTrackingRequestNotificationChannel</code>.
     * @alias module:model/StartPersonTrackingRequestNotificationChannel
    ...
    constructor(sNSTopicArn, roleArn) { 
        ...
        StartPersonTrackingRequestNotificationChannel.initialize(this, sNSTopicArn, roleArn);
    }
    ...
    /**
     * Constructs a <code>StartPersonTrackingRequestNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPersonTrackingRequestNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StartPersonTrackingRequestNotificationChannel} The populated <code>StartPersonTrackingRequestNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPersonTrackingRequestNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StartPersonTrackingRequestNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPersonTrackingRequestNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartPersonTrackingRequestNotificationChannel.RequiredProperties) {
...
StartPersonTrackingRequestNotificationChannel.RequiredProperties = ["SNSTopicArn", "RoleArn"];

/**
 * @member {String} SNSTopicArn
 */
StartPersonTrackingRequestNotificationChannel.prototype['SNSTopicArn'] = undefined;

/**
 * @member {String} RoleArn
 */
StartPersonTrackingRequestNotificationChannel.prototype['RoleArn'] = undefined;
...
export default StartPersonTrackingRequestNotificationChannel;
