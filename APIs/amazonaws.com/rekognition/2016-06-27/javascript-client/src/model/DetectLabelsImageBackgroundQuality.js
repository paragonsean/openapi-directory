...
/**
 * The DetectLabelsImageBackgroundQuality model module.
 * @module model/DetectLabelsImageBackgroundQuality
 * @version 2016-06-27
 */
class DetectLabelsImageBackgroundQuality {
    /**
     * Constructs a new <code>DetectLabelsImageBackgroundQuality</code>.
     * @alias module:model/DetectLabelsImageBackgroundQuality
     * @implements module:model/DetectLabelsImageQuality
     */
    constructor() { 
        DetectLabelsImageQuality.initialize(this);
        DetectLabelsImageBackgroundQuality.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsImageBackgroundQuality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImageBackgroundQuality} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImageBackgroundQuality} The populated <code>DetectLabelsImageBackgroundQuality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImageBackgroundQuality();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImageBackgroundQuality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImageBackgroundQuality</code>.
     */
 ...
 */
DetectLabelsImageBackgroundQuality.prototype['Brightness'] = undefined;

/**
 * @member {Number} Sharpness
 */
DetectLabelsImageBackgroundQuality.prototype['Sharpness'] = undefined;

/**
 * @member {Number} Contrast
 */
DetectLabelsImageBackgroundQuality.prototype['Contrast'] = undefined;
...
export default DetectLabelsImageBackgroundQuality;
