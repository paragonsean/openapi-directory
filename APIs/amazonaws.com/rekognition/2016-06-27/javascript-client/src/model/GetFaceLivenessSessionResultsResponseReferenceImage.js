...
/**
 * The GetFaceLivenessSessionResultsResponseReferenceImage model module.
 * @module model/GetFaceLivenessSessionResultsResponseReferenceImage
 * @version 2016-06-27
 */
class GetFaceLivenessSessionResultsResponseReferenceImage {
    /**
     * Constructs a new <code>GetFaceLivenessSessionResultsResponseReferenceImage</code>.
     * @alias module:model/GetFaceLivenessSessionResultsResponseReferenceImage
     * @implements module:model/AuditImage
     */
    constructor() { 
        AuditImage.initialize(this);
        GetFaceLivenessSessionResultsResponseReferenceImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFaceLivenessSessionResultsResponseReferenceImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceLivenessSessionResultsResponseReferenceImage} obj Optional instance to populate.
     * @return {module:model/GetFaceLivenessSessionResultsResponseReferenceImage} The populated <code>GetFaceLivenessSessionResultsResponseReferenceImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceLivenessSessionResultsResponseReferenceImage();
            AuditImage.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceLivenessSessionResultsResponseReferenceImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceLivenessSessionResultsResponseReferenceImage</code>.
     */
 ...
 * @member {String} Bytes
 */
GetFaceLivenessSessionResultsResponseReferenceImage.prototype['Bytes'] = undefined;

/**
 * @member {module:model/S3Object} S3Object
 */
GetFaceLivenessSessionResultsResponseReferenceImage.prototype['S3Object'] = undefined;

/**
 * @member {module:model/BoundingBox} BoundingBox
 */
GetFaceLivenessSessionResultsResponseReferenceImage.prototype['BoundingBox'] = undefined;


// Implement AuditImage interface:
/**
 * @member {String} Bytes
 */
AuditImage.prototype['Bytes'] = undefined;
/**
 * @member {module:model/S3Object} S3Object
 */
AuditImage.prototype['S3Object'] = undefined;
/**
 * @member {module:model/BoundingBox} BoundingBox
 */
AuditImage.prototype['BoundingBox'] = undefined;




export default GetFaceLivenessSessionResultsResponseReferenceImage;
