...
import UpdateDatasetEntriesRequestChanges from './UpdateDatasetEntriesRequestChanges';
...
class UpdateDatasetEntriesRequest {
     ...
     * @param changes {module:model/UpdateDatasetEntriesRequestChanges} 
     */
    constructor(datasetArn, changes) { 
        
        UpdateDatasetEntriesRequest.initialize(this, datasetArn, changes);
    }
     ...
     */
    static initialize(obj, datasetArn, changes) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Changes')) {
                obj['Changes'] = UpdateDatasetEntriesRequestChanges.constructFromObject(data['Changes']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Changes']) { // data not null
          UpdateDatasetEntriesRequestChanges.validateJSON(data['Changes']);
        }
...
UpdateDatasetEntriesRequest.RequiredProperties = ["DatasetArn", "Changes"];

/**
 * @member {String} DatasetArn
 */
UpdateDatasetEntriesRequest.prototype['DatasetArn'] = undefined;

/**
 * @member {module:model/UpdateDatasetEntriesRequestChanges} Changes
 */
