...
/**
 * The ListDatasetEntriesResponse model module.
 * @module model/ListDatasetEntriesResponse
 * @version 2016-06-27
 */
class ListDatasetEntriesResponse {
    /**
     * Constructs a new <code>ListDatasetEntriesResponse</code>.
     * @alias module:model/ListDatasetEntriesResponse
     */
    constructor() { 
        
        ListDatasetEntriesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDatasetEntriesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDatasetEntriesResponse} obj Optional instance to populate.
     * @return {module:model/ListDatasetEntriesResponse} The populated <code>ListDatasetEntriesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDatasetEntriesResponse();

            if (data.hasOwnProperty('DatasetEntries')) {
                obj['DatasetEntries'] = ApiClient.convertToType(data['DatasetEntries'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListDatasetEntriesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDatasetEntriesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DatasetEntries`
        if (data['DatasetEntries']) { // data not null
          Array.validateJSON(data['DatasetEntries']);
        }
...
/**
 * @member {Array} DatasetEntries
 */
ListDatasetEntriesResponse.prototype['DatasetEntries'] = undefined;

/**
 * @member {String} NextToken
 */
ListDatasetEntriesResponse.prototype['NextToken'] = undefined;
...
export default ListDatasetEntriesResponse;
