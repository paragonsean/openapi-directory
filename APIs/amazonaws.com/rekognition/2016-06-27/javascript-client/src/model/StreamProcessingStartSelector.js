...
/**
 * The StreamProcessingStartSelector model module.
 * @module model/StreamProcessingStartSelector
 * @version 2016-06-27
 */
class StreamProcessingStartSelector {
    /**
     * Constructs a new <code>StreamProcessingStartSelector</code>.
     * This is a required parameter for label detection stream processors and should not be used to start a face search stream processor.
     * @alias module:model/StreamProcessingStartSelector
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamProcessingStartSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessingStartSelector} obj Optional instance to populate.
     * @return {module:model/StreamProcessingStartSelector} The populated <code>StreamProcessingStartSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessingStartSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessingStartSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessingStartSelector</code>.
     */
...
export default StreamProcessingStartSelector;
