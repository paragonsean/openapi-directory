...
/**
 * The DescribeProjectsRequest model module.
 * @module model/DescribeProjectsRequest
 * @version 2016-06-27
 */
class DescribeProjectsRequest {
    /**
     * Constructs a new <code>DescribeProjectsRequest</code>.
     * @alias module:model/DescribeProjectsRequest
     */
    constructor() { 
        
        DescribeProjectsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeProjectsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeProjectsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeProjectsRequest} The populated <code>DescribeProjectsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeProjectsRequest();
            ...
            if (data.hasOwnProperty('ProjectNames')) {
                obj['ProjectNames'] = ApiClient.convertToType(data['ProjectNames'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeProjectsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeProjectsRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ProjectNames']) { // data not null
          Array.validateJSON(data['ProjectNames']);
        }
 ...
 */
DescribeProjectsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribeProjectsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {Array} ProjectNames
 */
DescribeProjectsRequest.prototype['ProjectNames'] = undefined;
...
export default DescribeProjectsRequest;
