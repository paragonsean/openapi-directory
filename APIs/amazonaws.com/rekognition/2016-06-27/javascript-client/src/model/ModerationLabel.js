...
/**
 * The ModerationLabel model module.
 * @module model/ModerationLabel
 * @version 2016-06-27
 */
class ModerationLabel {
    /**
     * Constructs a new <code>ModerationLabel</code>.
     * Provides information about a single type of inappropriate, unwanted, or offensive content found in an image or video. Each type of moderated content has a label within a hierarchical taxonomy. For more information, see Content moderation in the Amazon Rekognition Developer Guide.
     * @alias module:model/ModerationLabel
     */
    constructor() { 
        
        ModerationLabel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModerationLabel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModerationLabel} obj Optional instance to populate.
     * @return {module:model/ModerationLabel} The populated <code>ModerationLabel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModerationLabel();
    ...
    /**
     * Validates the JSON data with respect to <code>ModerationLabel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModerationLabel</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ParentName']) { // data not null
          String.validateJSON(data['ParentName']);
        }
 ...
 */
ModerationLabel.prototype['Confidence'] = undefined;

/**
 * @member {String} Name
 */
ModerationLabel.prototype['Name'] = undefined;

/**
 * @member {String} ParentName
 */
ModerationLabel.prototype['ParentName'] = undefined;
...
export default ModerationLabel;
