...
/**
 * The StartPersonTrackingRequestVideo model module.
 * @module model/StartPersonTrackingRequestVideo
 * @version 2016-06-27
 */
class StartPersonTrackingRequestVideo {
    /**
     * Constructs a new <code>StartPersonTrackingRequestVideo</code>.
     * @alias module:model/StartPersonTrackingRequestVideo
     * @implements module:model/Video
     */
    constructor() { 
        Video.initialize(this);
        StartPersonTrackingRequestVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartPersonTrackingRequestVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPersonTrackingRequestVideo} obj Optional instance to populate.
     * @return {module:model/StartPersonTrackingRequestVideo} The populated <code>StartPersonTrackingRequestVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPersonTrackingRequestVideo();
    ...
    /**
     * Validates the JSON data with respect to <code>StartPersonTrackingRequestVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPersonTrackingRequestVideo</code>.
     */
 ...
 */
StartPersonTrackingRequestVideo.prototype['S3Object'] = undefined;
...
export default StartPersonTrackingRequestVideo;
