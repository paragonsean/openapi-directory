...
/**
 * The GetCelebrityRecognitionResponseVideoMetadata model module.
 * @module model/GetCelebrityRecognitionResponseVideoMetadata
 * @version 2016-06-27
 */
class GetCelebrityRecognitionResponseVideoMetadata {
    /**
     * Constructs a new <code>GetCelebrityRecognitionResponseVideoMetadata</code>.
     * @alias module:model/GetCelebrityRecognitionResponseVideoMetadata
     * @implements module:model/VideoMetadata
     */
    constructor() { 
        VideoMetadata.initialize(this);
        GetCelebrityRecognitionResponseVideoMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCelebrityRecognitionResponseVideoMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCelebrityRecognitionResponseVideoMetadata} obj Optional instance to populate.
     * @return {module:model/GetCelebrityRecognitionResponseVideoMetadata} The populated <code>GetCelebrityRecognitionResponseVideoMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCelebrityRecognitionResponseVideoMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCelebrityRecognitionResponseVideoMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCelebrityRecognitionResponseVideoMetadata</code>.
     */
 ...
 * @member {String} Codec
 */
GetCelebrityRecognitionResponseVideoMetadata.prototype['Codec'] = undefined;

/**
 * @member {Number} DurationMillis
 */
GetCelebrityRecognitionResponseVideoMetadata.prototype['DurationMillis'] = undefined;

/**
 * @member {String} Format
 */
GetCelebrityRecognitionResponseVideoMetadata.prototype['Format'] = undefined;

/**
 * @member {Number} FrameRate
 */
GetCelebrityRecognitionResponseVideoMetadata.prototype['FrameRate'] = undefined;

/**
 * @member {Number} FrameHeight
 */
GetCelebrityRecognitionResponseVideoMetadata.prototype['FrameHeight'] = undefined;

/**
 * @member {Number} FrameWidth
 */
GetCelebrityRecognitionResponseVideoMetadata.prototype['FrameWidth'] = undefined;

/**
 * @member {module:model/VideoColorRange} ColorRange
 */
GetCelebrityRecognitionResponseVideoMetadata.prototype['ColorRange'] = undefined;
...
export default GetCelebrityRecognitionResponseVideoMetadata;
