...
import SearchUsersResponseSearchedFace from './SearchUsersResponseSearchedFace';
import SearchUsersResponseSearchedUser from './SearchUsersResponseSearchedUser';
...
class SearchUsersResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SearchedFace')) {
                obj['SearchedFace'] = SearchUsersResponseSearchedFace.constructFromObject(data['SearchedFace']);
            }
            if (data.hasOwnProperty('SearchedUser')) {
                obj['SearchedUser'] = SearchUsersResponseSearchedUser.constructFromObject(data['SearchedUser']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['SearchedFace']) { // data not null
          SearchUsersResponseSearchedFace.validateJSON(data['SearchedFace']);
        }
        // validate the optional field `SearchedUser`
        if (data['SearchedUser']) { // data not null
          SearchUsersResponseSearchedUser.validateJSON(data['SearchedUser']);
        }
 ...
 */
SearchUsersResponse.prototype['UserMatches'] = undefined;

/**
 * @member {String} FaceModelVersion
 */
SearchUsersResponse.prototype['FaceModelVersion'] = undefined;

/**
 * @member {module:model/SearchUsersResponseSearchedFace} SearchedFace
 */
SearchUsersResponse.prototype['SearchedFace'] = undefined;

/**
 * @member {module:model/SearchUsersResponseSearchedUser} SearchedUser
 */
SearchUsersResponse.prototype['SearchedUser'] = undefined;
