...
import CelebrityFace from './CelebrityFace';
import KnownGender from './KnownGender';

/**
 * The Celebrity model module.
 * @module model/Celebrity
 * @version 2016-06-27
 */
class Celebrity {
    /**
     * Constructs a new <code>Celebrity</code>.
     * Provides information about a celebrity recognized by the &lt;a&gt;RecognizeCelebrities&lt;/a&gt; operation.
     * @alias module:model/Celebrity
     */
    constructor() { 
        
        Celebrity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Celebrity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Celebrity} obj Optional instance to populate.
     * @return {module:model/Celebrity} The populated <code>Celebrity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Celebrity();
            ...
            if (data.hasOwnProperty('Face')) {
                obj['Face'] = CelebrityFace.constructFromObject(data['Face']);
            }
            if (data.hasOwnProperty('MatchConfidence')) {
                obj['MatchConfidence'] = ApiClient.convertToType(data['MatchConfidence'], 'Number');
            }
            if (data.hasOwnProperty('KnownGender')) {
                obj['KnownGender'] = KnownGender.constructFromObject(data['KnownGender']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Celebrity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Celebrity</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Face']) { // data not null
          CelebrityFace.validateJSON(data['Face']);
        }
        // validate the optional field `MatchConfidence`
        if (data['MatchConfidence']) { // data not null
          Number.validateJSON(data['MatchConfidence']);
        }
        // validate the optional field `KnownGender`
        if (data['KnownGender']) { // data not null
          KnownGender.validateJSON(data['KnownGender']);
        }
 ...
 * @member {Array} Urls
 */
Celebrity.prototype['Urls'] = undefined;

/**
 * @member {String} Name
 */
Celebrity.prototype['Name'] = undefined;

/**
 * @member {String} Id
 */
Celebrity.prototype['Id'] = undefined;

/**
 * @member {module:model/CelebrityFace} Face
 */
Celebrity.prototype['Face'] = undefined;

/**
 * @member {Number} MatchConfidence
 */
Celebrity.prototype['MatchConfidence'] = undefined;

/**
 * @member {module:model/KnownGender} KnownGender
 */
Celebrity.prototype['KnownGender'] = undefined;
