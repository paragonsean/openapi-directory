...
/**
 * The DisassociatedFace model module.
 * @module model/DisassociatedFace
 * @version 2016-06-27
 */
class DisassociatedFace {
    /**
     * Constructs a new <code>DisassociatedFace</code>.
     * Provides face metadata for the faces that are disassociated from a specific UserID.
     * @alias module:model/DisassociatedFace
     */
    constructor() { 
        
        DisassociatedFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociatedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociatedFace} obj Optional instance to populate.
     * @return {module:model/DisassociatedFace} The populated <code>DisassociatedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociatedFace();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociatedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociatedFace</code>.
     */
 ...
 */
DisassociatedFace.prototype['FaceId'] = undefined;
...
export default DisassociatedFace;
