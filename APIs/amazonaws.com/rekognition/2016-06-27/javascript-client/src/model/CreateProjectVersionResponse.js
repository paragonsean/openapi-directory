...
/**
 * The CreateProjectVersionResponse model module.
 * @module model/CreateProjectVersionResponse
 * @version 2016-06-27
 */
class CreateProjectVersionResponse {
    /**
     * Constructs a new <code>CreateProjectVersionResponse</code>.
     * @alias module:model/CreateProjectVersionResponse
     */
    constructor() { 
        
        CreateProjectVersionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateProjectVersionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProjectVersionResponse} obj Optional instance to populate.
     * @return {module:model/CreateProjectVersionResponse} The populated <code>CreateProjectVersionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProjectVersionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProjectVersionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProjectVersionResponse</code>.
     */
 ...
 */
CreateProjectVersionResponse.prototype['ProjectVersionArn'] = undefined;
...
export default CreateProjectVersionResponse;
