...
/**
 * The RecognizeCelebritiesRequest model module.
 * @module model/RecognizeCelebritiesRequest
 * @version 2016-06-27
 */
class RecognizeCelebritiesRequest {
    /**
     * Constructs a new <code>RecognizeCelebritiesRequest</code>.
     * @alias module:model/RecognizeCelebritiesRequest
     * @param image {module:model/CompareFacesRequestSourceImage} 
     */
    constructor(image) { 
        
        RecognizeCelebritiesRequest.initialize(this, image);
    }
    ...
    /**
     * Constructs a <code>RecognizeCelebritiesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecognizeCelebritiesRequest} obj Optional instance to populate.
     * @return {module:model/RecognizeCelebritiesRequest} The populated <code>RecognizeCelebritiesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecognizeCelebritiesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RecognizeCelebritiesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecognizeCelebritiesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RecognizeCelebritiesRequest.RequiredProperties) {
...
RecognizeCelebritiesRequest.RequiredProperties = ["Image"];

/**
 * @member {module:model/CompareFacesRequestSourceImage} Image
 */
RecognizeCelebritiesRequest.prototype['Image'] = undefined;
...
export default RecognizeCelebritiesRequest;
