...
/**
 * The TextDetectionResultTextDetection model module.
 * @module model/TextDetectionResultTextDetection
 * @version 2016-06-27
 */
class TextDetectionResultTextDetection {
    /**
     * Constructs a new <code>TextDetectionResultTextDetection</code>.
     * @alias module:model/TextDetectionResultTextDetection
     * @implements module:model/TextDetection
     */
    constructor() { 
        TextDetection.initialize(this);
        TextDetectionResultTextDetection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TextDetectionResultTextDetection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TextDetectionResultTextDetection} obj Optional instance to populate.
     * @return {module:model/TextDetectionResultTextDetection} The populated <code>TextDetectionResultTextDetection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TextDetectionResultTextDetection();
            TextDetection.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>TextDetectionResultTextDetection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TextDetectionResultTextDetection</code>.
     */
 ...
 */
TextDetectionResultTextDetection.prototype['DetectedText'] = undefined;

/**
 * @member {module:model/TextTypes} Type
 */
TextDetectionResultTextDetection.prototype['Type'] = undefined;

/**
 * @member {Number} Id
 */
TextDetectionResultTextDetection.prototype['Id'] = undefined;

/**
 * @member {Number} ParentId
 */
TextDetectionResultTextDetection.prototype['ParentId'] = undefined;

/**
 * @member {Number} Confidence
 */
TextDetectionResultTextDetection.prototype['Confidence'] = undefined;

/**
 * @member {module:model/TextDetectionGeometry} Geometry
 */
TextDetectionResultTextDetection.prototype['Geometry'] = undefined;


// Implement TextDetection interface:
/**
 * @member {String} DetectedText
 */
...
export default TextDetectionResultTextDetection;
