...
/**
 * The GetContentModerationRequest model module.
 * @module model/GetContentModerationRequest
 * @version 2016-06-27
 */
class GetContentModerationRequest {
    /**
     * Constructs a new <code>GetContentModerationRequest</code>.
     * @alias module:model/GetContentModerationRequest
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetContentModerationRequest.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetContentModerationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetContentModerationRequest} obj Optional instance to populate.
     * @return {module:model/GetContentModerationRequest} The populated <code>GetContentModerationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetContentModerationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetContentModerationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetContentModerationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetContentModerationRequest.RequiredProperties) {
...
GetContentModerationRequest.RequiredProperties = ["JobId"];

/**
 * @member {String} JobId
 */
GetContentModerationRequest.prototype['JobId'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetContentModerationRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetContentModerationRequest.prototype['NextToken'] = undefined;

/**
 * @member {module:model/ContentModerationSortBy} SortBy
 */
GetContentModerationRequest.prototype['SortBy'] = undefined;

/**
 * @member {module:model/ContentModerationAggregateBy} AggregateBy
 */
GetContentModerationRequest.prototype['AggregateBy'] = undefined;
...
export default GetContentModerationRequest;
