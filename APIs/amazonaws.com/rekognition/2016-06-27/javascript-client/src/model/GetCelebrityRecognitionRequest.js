...
import CelebrityRecognitionSortBy from './CelebrityRecognitionSortBy';

/**
 * The GetCelebrityRecognitionRequest model module.
 * @module model/GetCelebrityRecognitionRequest
 * @version 2016-06-27
 */
class GetCelebrityRecognitionRequest {
    /**
     * Constructs a new <code>GetCelebrityRecognitionRequest</code>.
     * @alias module:model/GetCelebrityRecognitionRequest
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetCelebrityRecognitionRequest.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetCelebrityRecognitionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCelebrityRecognitionRequest} obj Optional instance to populate.
     * @return {module:model/GetCelebrityRecognitionRequest} The populated <code>GetCelebrityRecognitionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCelebrityRecognitionRequest();
            ...
            if (data.hasOwnProperty('SortBy')) {
                obj['SortBy'] = ApiClient.convertToType(data['SortBy'], CelebrityRecognitionSortBy);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCelebrityRecognitionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCelebrityRecognitionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCelebrityRecognitionRequest.RequiredProperties) {
        ...
        if (data['SortBy']) { // data not null
          CelebrityRecognitionSortBy.validateJSON(data['SortBy']);
        }
...
GetCelebrityRecognitionRequest.RequiredProperties = ["JobId"];

/**
 * @member {String} JobId
 */
GetCelebrityRecognitionRequest.prototype['JobId'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetCelebrityRecognitionRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetCelebrityRecognitionRequest.prototype['NextToken'] = undefined;

/**
 * @member {module:model/CelebrityRecognitionSortBy} SortBy
 */
GetCelebrityRecognitionRequest.prototype['SortBy'] = undefined;
...
export default GetCelebrityRecognitionRequest;
