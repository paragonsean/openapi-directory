...
import StreamProcessorSettingsFaceSearch from './StreamProcessorSettingsFaceSearch';

/**
 * The CreateStreamProcessorRequestSettings model module.
 * @module model/CreateStreamProcessorRequestSettings
 * @version 2016-06-27
 */
class CreateStreamProcessorRequestSettings {
    /**
     * Constructs a new <code>CreateStreamProcessorRequestSettings</code>.
     * @alias module:model/CreateStreamProcessorRequestSettings
     * @implements module:model/StreamProcessorSettings
     */
    constructor() { 
        StreamProcessorSettings.initialize(this);
        CreateStreamProcessorRequestSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStreamProcessorRequestSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamProcessorRequestSettings} obj Optional instance to populate.
     * @return {module:model/CreateStreamProcessorRequestSettings} The populated <code>CreateStreamProcessorRequestSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamProcessorRequestSettings();
            StreamProcessorSettings.constructFromObject(data, obj);

            if (data.hasOwnProperty('FaceSearch')) {
                obj['FaceSearch'] = StreamProcessorSettingsFaceSearch.constructFromObject(data['FaceSearch']);
            }
            if (data.hasOwnProperty('ConnectedHome')) {
                obj['ConnectedHome'] = ConnectedHomeSettings.constructFromObject(data['ConnectedHome']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamProcessorRequestSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamProcessorRequestSettings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FaceSearch`
        if (data['FaceSearch']) { // data not null
          StreamProcessorSettingsFaceSearch.validateJSON(data['FaceSearch']);
        }
        // validate the optional field `ConnectedHome`
        if (data['ConnectedHome']) { // data not null
          ConnectedHomeSettings.validateJSON(data['ConnectedHome']);
        }
...
/**
 * @member {module:model/StreamProcessorSettingsFaceSearch} FaceSearch
 */
CreateStreamProcessorRequestSettings.prototype['FaceSearch'] = undefined;

/**
 * @member {module:model/ConnectedHomeSettings} ConnectedHome
 */
CreateStreamProcessorRequestSettings.prototype['ConnectedHome'] = undefined;


// Implement StreamProcessorSettings interface:
/**
 * @member {module:model/StreamProcessorSettingsFaceSearch} FaceSearch
 */
StreamProcessorSettings.prototype['FaceSearch'] = undefined;
/**
 * @member {module:model/ConnectedHomeSettings} ConnectedHome
 */
StreamProcessorSettings.prototype['ConnectedHome'] = undefined;




export default CreateStreamProcessorRequestSettings;
