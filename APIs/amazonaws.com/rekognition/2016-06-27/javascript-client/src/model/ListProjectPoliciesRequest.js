...
/**
 * The ListProjectPoliciesRequest model module.
 * @module model/ListProjectPoliciesRequest
 * @version 2016-06-27
 */
class ListProjectPoliciesRequest {
    /**
     * Constructs a new <code>ListProjectPoliciesRequest</code>.
     * @alias module:model/ListProjectPoliciesRequest
     * @param projectArn {String} 
     */
    constructor(projectArn) { 
        
        ListProjectPoliciesRequest.initialize(this, projectArn);
    }
    ...
    /**
     * Constructs a <code>ListProjectPoliciesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListProjectPoliciesRequest} obj Optional instance to populate.
     * @return {module:model/ListProjectPoliciesRequest} The populated <code>ListProjectPoliciesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListProjectPoliciesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListProjectPoliciesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListProjectPoliciesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListProjectPoliciesRequest.RequiredProperties) {
...
ListProjectPoliciesRequest.RequiredProperties = ["ProjectArn"];

/**
 * @member {String} ProjectArn
 */
ListProjectPoliciesRequest.prototype['ProjectArn'] = undefined;

/**
 * @member {String} NextToken
 */
ListProjectPoliciesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListProjectPoliciesRequest.prototype['MaxResults'] = undefined;
...
export default ListProjectPoliciesRequest;
