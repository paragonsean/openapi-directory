...
/**
 * The TestingDataResultValidation model module.
 * @module model/TestingDataResultValidation
 * @version 2016-06-27
 */
class TestingDataResultValidation {
    /**
     * Constructs a new <code>TestingDataResultValidation</code>.
     * @alias module:model/TestingDataResultValidation
     * @implements module:model/ValidationData
     */
    constructor() { 
        ValidationData.initialize(this);
        TestingDataResultValidation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestingDataResultValidation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestingDataResultValidation} obj Optional instance to populate.
     * @return {module:model/TestingDataResultValidation} The populated <code>TestingDataResultValidation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestingDataResultValidation();
            ValidationData.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>TestingDataResultValidation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestingDataResultValidation</code>.
     */
 ...
 * @member {Array} Assets
 */
TestingDataResultValidation.prototype['Assets'] = undefined;


// Implement ValidationData interface:
/**
 * @member {Array} Assets
 */
ValidationData.prototype['Assets'] = undefined;




export default TestingDataResultValidation;
