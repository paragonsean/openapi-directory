...
/**
 * The ListProjectPoliciesResponse model module.
 * @module model/ListProjectPoliciesResponse
 * @version 2016-06-27
 */
class ListProjectPoliciesResponse {
    /**
     * Constructs a new <code>ListProjectPoliciesResponse</code>.
     * @alias module:model/ListProjectPoliciesResponse
     */
    constructor() { 
        
        ListProjectPoliciesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListProjectPoliciesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListProjectPoliciesResponse} obj Optional instance to populate.
     * @return {module:model/ListProjectPoliciesResponse} The populated <code>ListProjectPoliciesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListProjectPoliciesResponse();

            if (data.hasOwnProperty('ProjectPolicies')) {
                obj['ProjectPolicies'] = ApiClient.convertToType(data['ProjectPolicies'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListProjectPoliciesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListProjectPoliciesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProjectPolicies`
        if (data['ProjectPolicies']) { // data not null
          Array.validateJSON(data['ProjectPolicies']);
        }
...
/**
 * @member {Array} ProjectPolicies
 */
ListProjectPoliciesResponse.prototype['ProjectPolicies'] = undefined;

/**
 * @member {String} NextToken
 */
ListProjectPoliciesResponse.prototype['NextToken'] = undefined;
...
export default ListProjectPoliciesResponse;
