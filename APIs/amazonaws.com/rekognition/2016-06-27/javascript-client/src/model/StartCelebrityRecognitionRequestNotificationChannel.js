...
/**
 * The StartCelebrityRecognitionRequestNotificationChannel model module.
 * @module model/StartCelebrityRecognitionRequestNotificationChannel
 * @version 2016-06-27
 */
class StartCelebrityRecognitionRequestNotificationChannel {
    /**
     * Constructs a new <code>StartCelebrityRecognitionRequestNotificationChannel</code>.
     * @alias module:model/StartCelebrityRecognitionRequestNotificationChannel
    ...
    constructor(sNSTopicArn, roleArn) { 
        ...
        StartCelebrityRecognitionRequestNotificationChannel.initialize(this, sNSTopicArn, roleArn);
    }
    ...
    /**
     * Constructs a <code>StartCelebrityRecognitionRequestNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartCelebrityRecognitionRequestNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StartCelebrityRecognitionRequestNotificationChannel} The populated <code>StartCelebrityRecognitionRequestNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartCelebrityRecognitionRequestNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StartCelebrityRecognitionRequestNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartCelebrityRecognitionRequestNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartCelebrityRecognitionRequestNotificationChannel.RequiredProperties) {
...
StartCelebrityRecognitionRequestNotificationChannel.RequiredProperties = ["SNSTopicArn", "RoleArn"];

/**
 * @member {String} SNSTopicArn
 */
StartCelebrityRecognitionRequestNotificationChannel.prototype['SNSTopicArn'] = undefined;

/**
 * @member {String} RoleArn
 */
StartCelebrityRecognitionRequestNotificationChannel.prototype['RoleArn'] = undefined;
...
export default StartCelebrityRecognitionRequestNotificationChannel;
