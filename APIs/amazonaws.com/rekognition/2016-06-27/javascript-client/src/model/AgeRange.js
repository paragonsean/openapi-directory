...
/**
 * The AgeRange model module.
 * @module model/AgeRange
 * @version 2016-06-27
 */
class AgeRange {
    /**
     * Constructs a new <code>AgeRange</code>.
     ...
     * @alias module:model/AgeRange
     */
    constructor() { 
        
        AgeRange.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AgeRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AgeRange} obj Optional instance to populate.
     * @return {module:model/AgeRange} The populated <code>AgeRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AgeRange();
    ...
    /**
     * Validates the JSON data with respect to <code>AgeRange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AgeRange</code>.
     */
 ...
 * @member {Number} Low
 */
AgeRange.prototype['Low'] = undefined;

/**
 * @member {Number} High
 */
AgeRange.prototype['High'] = undefined;
