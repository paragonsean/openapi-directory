...
import ProjectVersionStatus from './ProjectVersionStatus';

/**
 * The StartProjectVersionResponse model module.
 * @module model/StartProjectVersionResponse
 * @version 2016-06-27
 */
class StartProjectVersionResponse {
    /**
     * Constructs a new <code>StartProjectVersionResponse</code>.
     * @alias module:model/StartProjectVersionResponse
     */
    constructor() { 
        
        StartProjectVersionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartProjectVersionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartProjectVersionResponse} obj Optional instance to populate.
     * @return {module:model/StartProjectVersionResponse} The populated <code>StartProjectVersionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartProjectVersionResponse();

            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], ProjectVersionStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartProjectVersionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartProjectVersionResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Status`
        if (data['Status']) { // data not null
          ProjectVersionStatus.validateJSON(data['Status']);
        }
...
/**
 * @member {module:model/ProjectVersionStatus} Status
 */
StartProjectVersionResponse.prototype['Status'] = undefined;
...
export default StartProjectVersionResponse;
