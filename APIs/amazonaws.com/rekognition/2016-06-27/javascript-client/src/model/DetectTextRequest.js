...
import DetectTextRequestFilters from './DetectTextRequestFilters';
import DetectTextRequestImage from './DetectTextRequestImage';

/**
 * The DetectTextRequest model module.
 * @module model/DetectTextRequest
 * @version 2016-06-27
 */
class DetectTextRequest {
    /**
     * Constructs a new <code>DetectTextRequest</code>.
     * @alias module:model/DetectTextRequest
     * @param image {module:model/DetectTextRequestImage} 
     */
    constructor(image) { 
        
        DetectTextRequest.initialize(this, image);
    }
    ...
    /**
     * Constructs a <code>DetectTextRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectTextRequest} obj Optional instance to populate.
     * @return {module:model/DetectTextRequest} The populated <code>DetectTextRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectTextRequest();

            if (data.hasOwnProperty('Image')) {
                obj['Image'] = DetectTextRequestImage.constructFromObject(data['Image']);
            }
            if (data.hasOwnProperty('Filters')) {
                obj['Filters'] = DetectTextRequestFilters.constructFromObject(data['Filters']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectTextRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectTextRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectTextRequest.RequiredProperties) {
        ...
        if (data['Image']) { // data not null
          DetectTextRequestImage.validateJSON(data['Image']);
        }
        // validate the optional field `Filters`
        if (data['Filters']) { // data not null
          DetectTextRequestFilters.validateJSON(data['Filters']);
        }
...
DetectTextRequest.RequiredProperties = ["Image"];

/**
 * @member {module:model/DetectTextRequestImage} Image
 */
DetectTextRequest.prototype['Image'] = undefined;

/**
 * @member {module:model/DetectTextRequestFilters} Filters
 */
DetectTextRequest.prototype['Filters'] = undefined;
...
export default DetectTextRequest;
