...
/**
 * The FaceDetailEyesOpen model module.
 * @module model/FaceDetailEyesOpen
 * @version 2016-06-27
 */
class FaceDetailEyesOpen {
    /**
     * Constructs a new <code>FaceDetailEyesOpen</code>.
     * @alias module:model/FaceDetailEyesOpen
     * @implements module:model/EyeOpen
     */
    constructor() { 
        EyeOpen.initialize(this);
        FaceDetailEyesOpen.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailEyesOpen</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailEyesOpen} obj Optional instance to populate.
     * @return {module:model/FaceDetailEyesOpen} The populated <code>FaceDetailEyesOpen</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailEyesOpen();
            EyeOpen.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailEyesOpen</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailEyesOpen</code>.
     */
 ...
 */
FaceDetailEyesOpen.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailEyesOpen.prototype['Confidence'] = undefined;


// Implement EyeOpen interface:
/**
 * @member {Boolean} Value
 */
...
export default FaceDetailEyesOpen;
