...
/**
 * The DetectLabelsImageForegroundQuality model module.
 * @module model/DetectLabelsImageForegroundQuality
 * @version 2016-06-27
 */
class DetectLabelsImageForegroundQuality {
    /**
     * Constructs a new <code>DetectLabelsImageForegroundQuality</code>.
     * @alias module:model/DetectLabelsImageForegroundQuality
     * @implements module:model/DetectLabelsImageQuality
     */
    constructor() { 
        DetectLabelsImageQuality.initialize(this);
        DetectLabelsImageForegroundQuality.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsImageForegroundQuality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImageForegroundQuality} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImageForegroundQuality} The populated <code>DetectLabelsImageForegroundQuality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImageForegroundQuality();
            DetectLabelsImageQuality.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImageForegroundQuality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImageForegroundQuality</code>.
     */
 ...
 */
DetectLabelsImageForegroundQuality.prototype['Brightness'] = undefined;

/**
 * @member {Number} Sharpness
 */
DetectLabelsImageForegroundQuality.prototype['Sharpness'] = undefined;

/**
 * @member {Number} Contrast
 */
DetectLabelsImageForegroundQuality.prototype['Contrast'] = undefined;


// Implement DetectLabelsImageQuality interface:
/**
 * @member {Number} Brightness
 */
DetectLabelsImageQuality.prototype['Brightness'] = undefined;
/**
 * @member {Number} Sharpness
 */
DetectLabelsImageQuality.prototype['Sharpness'] = undefined;
/**
 * @member {Number} Contrast
 */
DetectLabelsImageQuality.prototype['Contrast'] = undefined;




export default DetectLabelsImageForegroundQuality;
