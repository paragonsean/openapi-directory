...
import GetFaceSearchResponseVideoMetadata from './GetFaceSearchResponseVideoMetadata';
import Video from './Video';
import VideoJobStatus from './VideoJobStatus';

/**
 * The GetFaceSearchResponse model module.
 * @module model/GetFaceSearchResponse
 * @version 2016-06-27
 */
class GetFaceSearchResponse {
    /**
     * Constructs a new <code>GetFaceSearchResponse</code>.
     * @alias module:model/GetFaceSearchResponse
     */
    constructor() { 
        
        GetFaceSearchResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFaceSearchResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceSearchResponse} obj Optional instance to populate.
     * @return {module:model/GetFaceSearchResponse} The populated <code>GetFaceSearchResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceSearchResponse();
            ...
            if (data.hasOwnProperty('VideoMetadata')) {
                obj['VideoMetadata'] = GetFaceSearchResponseVideoMetadata.constructFromObject(data['VideoMetadata']);
            }
            if (data.hasOwnProperty('Persons')) {
                obj['Persons'] = ApiClient.convertToType(data['Persons'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceSearchResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceSearchResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VideoMetadata']) { // data not null
          GetFaceSearchResponseVideoMetadata.validateJSON(data['VideoMetadata']);
        }
        // validate the optional field `Persons`
        if (data['Persons']) { // data not null
          Array.validateJSON(data['Persons']);
        }
 ...
 */
GetFaceSearchResponse.prototype['JobStatus'] = undefined;

/**
 * @member {String} StatusMessage
 */
GetFaceSearchResponse.prototype['StatusMessage'] = undefined;

/**
 * @member {String} NextToken
 */
GetFaceSearchResponse.prototype['NextToken'] = undefined;

/**
 * @member {module:model/GetFaceSearchResponseVideoMetadata} VideoMetadata
 */
GetFaceSearchResponse.prototype['VideoMetadata'] = undefined;

/**
 * @member {Array} Persons
 */
GetFaceSearchResponse.prototype['Persons'] = undefined;

/**
 * @member {String} JobId
 */
GetFaceSearchResponse.prototype['JobId'] = undefined;

/**
 * @member {module:model/Video} Video
 */
GetFaceSearchResponse.prototype['Video'] = undefined;

/**
 * @member {String} JobTag
 */
GetFaceSearchResponse.prototype['JobTag'] = undefined;
...
export default GetFaceSearchResponse;
