...
import DetectLabelsImagePropertiesBackground from './DetectLabelsImagePropertiesBackground';
import DetectLabelsImagePropertiesForeground from './DetectLabelsImagePropertiesForeground';
import DetectLabelsImagePropertiesQuality from './DetectLabelsImagePropertiesQuality';

/**
 * The DetectLabelsImageProperties model module.
 * @module model/DetectLabelsImageProperties
 * @version 2016-06-27
 */
class DetectLabelsImageProperties {
    /**
     * Constructs a new <code>DetectLabelsImageProperties</code>.
     ...
     * @alias module:model/DetectLabelsImageProperties
     */
    constructor() { 
        
        DetectLabelsImageProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsImageProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImageProperties} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImageProperties} The populated <code>DetectLabelsImageProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImageProperties();

            if (data.hasOwnProperty('Quality')) {
                obj['Quality'] = DetectLabelsImagePropertiesQuality.constructFromObject(data['Quality']);
            }
            ...
            if (data.hasOwnProperty('Foreground')) {
                obj['Foreground'] = DetectLabelsImagePropertiesForeground.constructFromObject(data['Foreground']);
            }
            if (data.hasOwnProperty('Background')) {
                obj['Background'] = DetectLabelsImagePropertiesBackground.constructFromObject(data['Background']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImageProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImageProperties</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Quality`
        if (data['Quality']) { // data not null
          DetectLabelsImagePropertiesQuality.validateJSON(data['Quality']);
        }
        // validate the optional field `DominantColors`
        if (data['DominantColors']) { // data not null
          Array.validateJSON(data['DominantColors']);
        }
        // validate the optional field `Foreground`
        if (data['Foreground']) { // data not null
          DetectLabelsImagePropertiesForeground.validateJSON(data['Foreground']);
        }
        // validate the optional field `Background`
        if (data['Background']) { // data not null
          DetectLabelsImagePropertiesBackground.validateJSON(data['Background']);
        }
...
/**
 * @member {module:model/DetectLabelsImagePropertiesQuality} Quality
 */
DetectLabelsImageProperties.prototype['Quality'] = undefined;

/**
 * @member {Array} DominantColors
 */
DetectLabelsImageProperties.prototype['DominantColors'] = undefined;

/**
 * @member {module:model/DetectLabelsImagePropertiesForeground} Foreground
 */
DetectLabelsImageProperties.prototype['Foreground'] = undefined;

/**
 * @member {module:model/DetectLabelsImagePropertiesBackground} Background
 */
DetectLabelsImageProperties.prototype['Background'] = undefined;
...
export default DetectLabelsImageProperties;
