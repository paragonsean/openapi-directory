...
/**
 * The BlackFrame model module.
 * @module model/BlackFrame
 * @version 2016-06-27
 */
class BlackFrame {
    /**
     * Constructs a new <code>BlackFrame</code>.
    ...
    /**
     * Constructs a <code>BlackFrame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlackFrame} obj Optional instance to populate.
     * @return {module:model/BlackFrame} The populated <code>BlackFrame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlackFrame();
    ...
    /**
     * Validates the JSON data with respect to <code>BlackFrame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlackFrame</code>.
     */
