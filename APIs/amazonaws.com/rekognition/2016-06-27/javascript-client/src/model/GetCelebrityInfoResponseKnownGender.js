...
/**
 * The GetCelebrityInfoResponseKnownGender model module.
 * @module model/GetCelebrityInfoResponseKnownGender
 * @version 2016-06-27
 */
class GetCelebrityInfoResponseKnownGender {
    /**
     * Constructs a new <code>GetCelebrityInfoResponseKnownGender</code>.
     * @alias module:model/GetCelebrityInfoResponseKnownGender
     * @implements module:model/KnownGender
     */
    constructor() { 
        KnownGender.initialize(this);
        GetCelebrityInfoResponseKnownGender.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCelebrityInfoResponseKnownGender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCelebrityInfoResponseKnownGender} obj Optional instance to populate.
     * @return {module:model/GetCelebrityInfoResponseKnownGender} The populated <code>GetCelebrityInfoResponseKnownGender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCelebrityInfoResponseKnownGender();
            KnownGender.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetCelebrityInfoResponseKnownGender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCelebrityInfoResponseKnownGender</code>.
     */
 ...
 */
GetCelebrityInfoResponseKnownGender.prototype['Type'] = undefined;


// Implement KnownGender interface:
/**
 * @member {module:model/KnownGenderType} Type
 */
...
export default GetCelebrityInfoResponseKnownGender;
