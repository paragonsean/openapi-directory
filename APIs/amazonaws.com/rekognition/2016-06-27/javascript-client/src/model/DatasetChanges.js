...
/**
 * The DatasetChanges model module.
 * @module model/DatasetChanges
 * @version 2016-06-27
 */
class DatasetChanges {
    /**
     * Constructs a new <code>DatasetChanges</code>.
     ...
     * @alias module:model/DatasetChanges
    ...
    /**
     * Constructs a <code>DatasetChanges</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatasetChanges} obj Optional instance to populate.
     * @return {module:model/DatasetChanges} The populated <code>DatasetChanges</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatasetChanges();
    ...
    /**
     * Validates the JSON data with respect to <code>DatasetChanges</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatasetChanges</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatasetChanges.RequiredProperties) {
...
DatasetChanges.RequiredProperties = ["GroundTruth"];
