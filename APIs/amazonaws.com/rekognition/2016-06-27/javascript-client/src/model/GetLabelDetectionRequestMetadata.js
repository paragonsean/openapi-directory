...
/**
 * The GetLabelDetectionRequestMetadata model module.
 * @module model/GetLabelDetectionRequestMetadata
 * @version 2016-06-27
 */
class GetLabelDetectionRequestMetadata {
    /**
     * Constructs a new <code>GetLabelDetectionRequestMetadata</code>.
     * Contains metadata about a label detection request, including the SortBy and AggregateBy options.
     * @alias module:model/GetLabelDetectionRequestMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>GetLabelDetectionRequestMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLabelDetectionRequestMetadata} obj Optional instance to populate.
     * @return {module:model/GetLabelDetectionRequestMetadata} The populated <code>GetLabelDetectionRequestMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLabelDetectionRequestMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLabelDetectionRequestMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLabelDetectionRequestMetadata</code>.
     */
...
export default GetLabelDetectionRequestMetadata;
