...
/**
 * The ProjectVersionDescriptionTestingDataResult model module.
 * @module model/ProjectVersionDescriptionTestingDataResult
 * @version 2016-06-27
 */
class ProjectVersionDescriptionTestingDataResult {
    /**
     * Constructs a new <code>ProjectVersionDescriptionTestingDataResult</code>.
     * @alias module:model/ProjectVersionDescriptionTestingDataResult
     * @implements module:model/TestingDataResult
     */
    constructor() { 
        TestingDataResult.initialize(this);
        ProjectVersionDescriptionTestingDataResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectVersionDescriptionTestingDataResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectVersionDescriptionTestingDataResult} obj Optional instance to populate.
     * @return {module:model/ProjectVersionDescriptionTestingDataResult} The populated <code>ProjectVersionDescriptionTestingDataResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectVersionDescriptionTestingDataResult();
            TestingDataResult.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectVersionDescriptionTestingDataResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectVersionDescriptionTestingDataResult</code>.
     */
 ...
 */
ProjectVersionDescriptionTestingDataResult.prototype['Input'] = undefined;

/**
 * @member {module:model/TestingDataResultOutput} Output
 */
ProjectVersionDescriptionTestingDataResult.prototype['Output'] = undefined;

/**
 * @member {module:model/TestingDataResultValidation} Validation
 */
ProjectVersionDescriptionTestingDataResult.prototype['Validation'] = undefined;


// Implement TestingDataResult interface:
/**
 * @member {module:model/TestingDataResultInput} Input
 */
...
export default ProjectVersionDescriptionTestingDataResult;
