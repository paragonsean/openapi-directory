...
/**
 * The TestingData model module.
 * @module model/TestingData
 * @version 2016-06-27
 */
class TestingData {
    /**
     * Constructs a new <code>TestingData</code>.
     ...
     * @alias module:model/TestingData
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TestingData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestingData} obj Optional instance to populate.
     * @return {module:model/TestingData} The populated <code>TestingData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestingData();
    ...
    /**
     * Validates the JSON data with respect to <code>TestingData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestingData</code>.
     */
