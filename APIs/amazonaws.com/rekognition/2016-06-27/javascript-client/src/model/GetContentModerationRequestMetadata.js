...
import ContentModerationAggregateBy from './ContentModerationAggregateBy';
import ContentModerationSortBy from './ContentModerationSortBy';

/**
 * The GetContentModerationRequestMetadata model module.
 * @module model/GetContentModerationRequestMetadata
 * @version 2016-06-27
 */
class GetContentModerationRequestMetadata {
    /**
     * Constructs a new <code>GetContentModerationRequestMetadata</code>.
     * Contains metadata about a content moderation request, including the SortBy and AggregateBy options.
     * @alias module:model/GetContentModerationRequestMetadata
     */
    constructor() { 
        
        GetContentModerationRequestMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetContentModerationRequestMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetContentModerationRequestMetadata} obj Optional instance to populate.
     * @return {module:model/GetContentModerationRequestMetadata} The populated <code>GetContentModerationRequestMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetContentModerationRequestMetadata();

            if (data.hasOwnProperty('SortBy')) {
                obj['SortBy'] = ApiClient.convertToType(data['SortBy'], ContentModerationSortBy);
            }
            if (data.hasOwnProperty('AggregateBy')) {
                obj['AggregateBy'] = ApiClient.convertToType(data['AggregateBy'], ContentModerationAggregateBy);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetContentModerationRequestMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetContentModerationRequestMetadata</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SortBy`
        if (data['SortBy']) { // data not null
          ContentModerationSortBy.validateJSON(data['SortBy']);
        }
        // validate the optional field `AggregateBy`
        if (data['AggregateBy']) { // data not null
          ContentModerationAggregateBy.validateJSON(data['AggregateBy']);
        }
...
/**
 * @member {module:model/ContentModerationSortBy} SortBy
 */
GetContentModerationRequestMetadata.prototype['SortBy'] = undefined;

/**
 * @member {module:model/ContentModerationAggregateBy} AggregateBy
 */
GetContentModerationRequestMetadata.prototype['AggregateBy'] = undefined;
...
export default GetContentModerationRequestMetadata;
