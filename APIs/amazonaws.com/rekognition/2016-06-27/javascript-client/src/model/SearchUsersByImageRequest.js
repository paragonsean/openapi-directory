...
/**
 * The SearchUsersByImageRequest model module.
 * @module model/SearchUsersByImageRequest
 * @version 2016-06-27
 */
class SearchUsersByImageRequest {
    /**
     * Constructs a new <code>SearchUsersByImageRequest</code>.
     * @alias module:model/SearchUsersByImageRequest
     * @param collectionId {String} 
     * @param image {module:model/Image} 
     */
    constructor(collectionId, image) { 
        
        SearchUsersByImageRequest.initialize(this, collectionId, image);
    }
     ...
     */
    static initialize(obj, collectionId, image) { 
        obj['CollectionId'] = collectionId;
        obj['Image'] = image;
    }

    /**
     * Constructs a <code>SearchUsersByImageRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchUsersByImageRequest} obj Optional instance to populate.
     * @return {module:model/SearchUsersByImageRequest} The populated <code>SearchUsersByImageRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchUsersByImageRequest();
            ...
            if (data.hasOwnProperty('QualityFilter')) {
                obj['QualityFilter'] = ApiClient.convertToType(data['QualityFilter'], QualityFilter);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchUsersByImageRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchUsersByImageRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SearchUsersByImageRequest.RequiredProperties) {
        ...
        // validate the optional field `MaxUsers`
        if (data['MaxUsers']) { // data not null
          Number.validateJSON(data['MaxUsers']);
        }
        // validate the optional field `QualityFilter`
        if (data['QualityFilter']) { // data not null
          QualityFilter.validateJSON(data['QualityFilter']);
        }
...
SearchUsersByImageRequest.RequiredProperties = ["CollectionId", "Image"];

/**
 * @member {String} CollectionId
 */
SearchUsersByImageRequest.prototype['CollectionId'] = undefined;

/**
 * @member {module:model/Image} Image
 */
SearchUsersByImageRequest.prototype['Image'] = undefined;

/**
 * @member {Number} UserMatchThreshold
 */
SearchUsersByImageRequest.prototype['UserMatchThreshold'] = undefined;

/**
 * @member {Number} MaxUsers
 */
SearchUsersByImageRequest.prototype['MaxUsers'] = undefined;

/**
 * @member {module:model/QualityFilter} QualityFilter
 */
SearchUsersByImageRequest.prototype['QualityFilter'] = undefined;
...
export default SearchUsersByImageRequest;
