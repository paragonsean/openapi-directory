...
/**
 * The DetectProtectiveEquipmentRequestImage model module.
 * @module model/DetectProtectiveEquipmentRequestImage
 * @version 2016-06-27
 */
class DetectProtectiveEquipmentRequestImage {
    /**
     * Constructs a new <code>DetectProtectiveEquipmentRequestImage</code>.
     * @alias module:model/DetectProtectiveEquipmentRequestImage
     * @implements module:model/Image
     */
    constructor() { 
        Image.initialize(this);
        DetectProtectiveEquipmentRequestImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectProtectiveEquipmentRequestImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectProtectiveEquipmentRequestImage} obj Optional instance to populate.
     * @return {module:model/DetectProtectiveEquipmentRequestImage} The populated <code>DetectProtectiveEquipmentRequestImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectProtectiveEquipmentRequestImage();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectProtectiveEquipmentRequestImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectProtectiveEquipmentRequestImage</code>.
     */
 ...
 * @member {String} Bytes
 */
DetectProtectiveEquipmentRequestImage.prototype['Bytes'] = undefined;

/**
 * @member {module:model/ImageS3Object} S3Object
 */
DetectProtectiveEquipmentRequestImage.prototype['S3Object'] = undefined;
...
export default DetectProtectiveEquipmentRequestImage;
