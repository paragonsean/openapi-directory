...
/**
 * The StartLabelDetectionRequestVideo model module.
 * @module model/StartLabelDetectionRequestVideo
 * @version 2016-06-27
 */
class StartLabelDetectionRequestVideo {
    /**
     * Constructs a new <code>StartLabelDetectionRequestVideo</code>.
     * @alias module:model/StartLabelDetectionRequestVideo
     * @implements module:model/Video
     */
    constructor() { 
        Video.initialize(this);
        StartLabelDetectionRequestVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartLabelDetectionRequestVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartLabelDetectionRequestVideo} obj Optional instance to populate.
     * @return {module:model/StartLabelDetectionRequestVideo} The populated <code>StartLabelDetectionRequestVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartLabelDetectionRequestVideo();
    ...
    /**
     * Validates the JSON data with respect to <code>StartLabelDetectionRequestVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartLabelDetectionRequestVideo</code>.
     */
 ...
 */
StartLabelDetectionRequestVideo.prototype['S3Object'] = undefined;
...
export default StartLabelDetectionRequestVideo;
