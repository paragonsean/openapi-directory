...
/**
 * The ValidationData model module.
 * @module model/ValidationData
 * @version 2016-06-27
 */
class ValidationData {
    /**
     * Constructs a new <code>ValidationData</code>.
     ...
     * @alias module:model/ValidationData
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ValidationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidationData} obj Optional instance to populate.
     * @return {module:model/ValidationData} The populated <code>ValidationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationData();
    ...
    /**
     * Validates the JSON data with respect to <code>ValidationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationData</code>.
     */
