...
/**
 * The InstanceBoundingBox model module.
 * @module model/InstanceBoundingBox
 * @version 2016-06-27
 */
class InstanceBoundingBox {
    /**
     * Constructs a new <code>InstanceBoundingBox</code>.
     * @alias module:model/InstanceBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        InstanceBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InstanceBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstanceBoundingBox} obj Optional instance to populate.
     * @return {module:model/InstanceBoundingBox} The populated <code>InstanceBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstanceBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>InstanceBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstanceBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
InstanceBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
InstanceBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
InstanceBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
InstanceBoundingBox.prototype['Top'] = undefined;
...
export default InstanceBoundingBox;
