...
/**
 * The GeneralLabelsSettings model module.
 * @module model/GeneralLabelsSettings
 * @version 2016-06-27
 */
class GeneralLabelsSettings {
    /**
     * Constructs a new <code>GeneralLabelsSettings</code>.
     ...
     * @alias module:model/GeneralLabelsSettings
     */
    constructor() { 
        
        GeneralLabelsSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GeneralLabelsSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeneralLabelsSettings} obj Optional instance to populate.
     * @return {module:model/GeneralLabelsSettings} The populated <code>GeneralLabelsSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeneralLabelsSettings();

            if (data.hasOwnProperty('LabelInclusionFilters')) {
                obj['LabelInclusionFilters'] = ApiClient.convertToType(data['LabelInclusionFilters'], Array);
            }
            if (data.hasOwnProperty('LabelExclusionFilters')) {
                obj['LabelExclusionFilters'] = ApiClient.convertToType(data['LabelExclusionFilters'], Array);
            }
            if (data.hasOwnProperty('LabelCategoryInclusionFilters')) {
                obj['LabelCategoryInclusionFilters'] = ApiClient.convertToType(data['LabelCategoryInclusionFilters'], Array);
            }
            if (data.hasOwnProperty('LabelCategoryExclusionFilters')) {
                obj['LabelCategoryExclusionFilters'] = ApiClient.convertToType(data['LabelCategoryExclusionFilters'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GeneralLabelsSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeneralLabelsSettings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `LabelInclusionFilters`
        if (data['LabelInclusionFilters']) { // data not null
          Array.validateJSON(data['LabelInclusionFilters']);
        }
        // validate the optional field `LabelExclusionFilters`
        if (data['LabelExclusionFilters']) { // data not null
          Array.validateJSON(data['LabelExclusionFilters']);
        }
        // validate the optional field `LabelCategoryInclusionFilters`
        if (data['LabelCategoryInclusionFilters']) { // data not null
          Array.validateJSON(data['LabelCategoryInclusionFilters']);
        }
        // validate the optional field `LabelCategoryExclusionFilters`
        if (data['LabelCategoryExclusionFilters']) { // data not null
          Array.validateJSON(data['LabelCategoryExclusionFilters']);
        }
...
/**
 * @member {Array} LabelInclusionFilters
 */
GeneralLabelsSettings.prototype['LabelInclusionFilters'] = undefined;

/**
 * @member {Array} LabelExclusionFilters
 */
GeneralLabelsSettings.prototype['LabelExclusionFilters'] = undefined;

/**
 * @member {Array} LabelCategoryInclusionFilters
 */
GeneralLabelsSettings.prototype['LabelCategoryInclusionFilters'] = undefined;

/**
 * @member {Array} LabelCategoryExclusionFilters
 */
GeneralLabelsSettings.prototype['LabelCategoryExclusionFilters'] = undefined;
...
export default GeneralLabelsSettings;
