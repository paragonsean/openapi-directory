...
/**
 * The EvaluationResultSummary model module.
 * @module model/EvaluationResultSummary
 * @version 2016-06-27
 */
class EvaluationResultSummary {
    /**
     * Constructs a new <code>EvaluationResultSummary</code>.
     * @alias module:model/EvaluationResultSummary
     * @implements module:model/Summary
     */
    constructor() { 
        Summary.initialize(this);
        EvaluationResultSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EvaluationResultSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EvaluationResultSummary} obj Optional instance to populate.
     * @return {module:model/EvaluationResultSummary} The populated <code>EvaluationResultSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EvaluationResultSummary();
            Summary.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EvaluationResultSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EvaluationResultSummary</code>.
     */
 ...
 */
EvaluationResultSummary.prototype['S3Object'] = undefined;
 ...
 * @member {module:model/S3Object} S3Object
 */
Summary.prototype['S3Object'] = undefined;
