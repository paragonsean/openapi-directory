...
/**
 * The FaceDetailMouthOpen model module.
 * @module model/FaceDetailMouthOpen
 * @version 2016-06-27
 */
class FaceDetailMouthOpen {
    /**
     * Constructs a new <code>FaceDetailMouthOpen</code>.
     * @alias module:model/FaceDetailMouthOpen
     * @implements module:model/MouthOpen
     */
    constructor() { 
        MouthOpen.initialize(this);
        FaceDetailMouthOpen.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailMouthOpen</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailMouthOpen} obj Optional instance to populate.
     * @return {module:model/FaceDetailMouthOpen} The populated <code>FaceDetailMouthOpen</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailMouthOpen();
            MouthOpen.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailMouthOpen</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailMouthOpen</code>.
     */
 ...
 */
FaceDetailMouthOpen.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailMouthOpen.prototype['Confidence'] = undefined;


// Implement MouthOpen interface:
/**
 * @member {Boolean} Value
 */
MouthOpen.prototype['Value'] = undefined;
/**
 * @member {Number} Confidence
 */
MouthOpen.prototype['Confidence'] = undefined;




export default FaceDetailMouthOpen;
