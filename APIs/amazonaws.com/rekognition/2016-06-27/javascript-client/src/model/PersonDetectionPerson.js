...
import PersonDetailBoundingBox from './PersonDetailBoundingBox';
import PersonDetailFace from './PersonDetailFace';

/**
 * The PersonDetectionPerson model module.
 * @module model/PersonDetectionPerson
 * @version 2016-06-27
 */
class PersonDetectionPerson {
    /**
     * Constructs a new <code>PersonDetectionPerson</code>.
     * @alias module:model/PersonDetectionPerson
     * @implements module:model/PersonDetail
     */
    constructor() { 
        PersonDetail.initialize(this);
        PersonDetectionPerson.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PersonDetectionPerson</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PersonDetectionPerson} obj Optional instance to populate.
     * @return {module:model/PersonDetectionPerson} The populated <code>PersonDetectionPerson</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonDetectionPerson();
            PersonDetail.constructFromObject(data, obj);

            if (data.hasOwnProperty('Index')) {
                obj['Index'] = ApiClient.convertToType(data['Index'], 'Number');
            }
            if (data.hasOwnProperty('BoundingBox')) {
                obj['BoundingBox'] = PersonDetailBoundingBox.constructFromObject(data['BoundingBox']);
            }
            if (data.hasOwnProperty('Face')) {
                obj['Face'] = PersonDetailFace.constructFromObject(data['Face']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PersonDetectionPerson</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PersonDetectionPerson</code>.
     */
    static validateJSON(data) {
        ...
        if (data['BoundingBox']) { // data not null
          PersonDetailBoundingBox.validateJSON(data['BoundingBox']);
        }
        // validate the optional field `Face`
        if (data['Face']) { // data not null
          PersonDetailFace.validateJSON(data['Face']);
        }
 ...
 * @member {Number} Index
 */
PersonDetectionPerson.prototype['Index'] = undefined;

/**
 * @member {module:model/PersonDetailBoundingBox} BoundingBox
 */
PersonDetectionPerson.prototype['BoundingBox'] = undefined;

/**
 * @member {module:model/PersonDetailFace} Face
 */
PersonDetectionPerson.prototype['Face'] = undefined;


// Implement PersonDetail interface:
/**
 * @member {Number} Index
 */
PersonDetail.prototype['Index'] = undefined;
/**
 * @member {module:model/PersonDetailBoundingBox} BoundingBox
 */
PersonDetail.prototype['BoundingBox'] = undefined;
/**
 * @member {module:model/PersonDetailFace} Face
 */
PersonDetail.prototype['Face'] = undefined;




export default PersonDetectionPerson;
