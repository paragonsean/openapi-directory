...
/**
 * The EquipmentDetectionCoversBodyPart model module.
 * @module model/EquipmentDetectionCoversBodyPart
 * @version 2016-06-27
 */
class EquipmentDetectionCoversBodyPart {
    /**
     * Constructs a new <code>EquipmentDetectionCoversBodyPart</code>.
     * @alias module:model/EquipmentDetectionCoversBodyPart
     * @implements module:model/CoversBodyPart
     */
    constructor() { 
        CoversBodyPart.initialize(this);
        EquipmentDetectionCoversBodyPart.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EquipmentDetectionCoversBodyPart</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EquipmentDetectionCoversBodyPart} obj Optional instance to populate.
     * @return {module:model/EquipmentDetectionCoversBodyPart} The populated <code>EquipmentDetectionCoversBodyPart</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EquipmentDetectionCoversBodyPart();
            CoversBodyPart.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EquipmentDetectionCoversBodyPart</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EquipmentDetectionCoversBodyPart</code>.
     */
 ...
 */
EquipmentDetectionCoversBodyPart.prototype['Confidence'] = undefined;

/**
 * @member {Boolean} Value
 */
EquipmentDetectionCoversBodyPart.prototype['Value'] = undefined;


// Implement CoversBodyPart interface:
/**
 * @member {Number} Confidence
 */
...
export default EquipmentDetectionCoversBodyPart;
