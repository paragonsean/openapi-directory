...
import DetectModerationLabelsResponseHumanLoopActivationOutput from './DetectModerationLabelsResponseHumanLoopActivationOutput';

/**
 * The DetectModerationLabelsResponse model module.
 * @module model/DetectModerationLabelsResponse
 * @version 2016-06-27
 */
class DetectModerationLabelsResponse {
    /**
     * Constructs a new <code>DetectModerationLabelsResponse</code>.
     * @alias module:model/DetectModerationLabelsResponse
     */
    constructor() { 
        
        DetectModerationLabelsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectModerationLabelsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectModerationLabelsResponse} obj Optional instance to populate.
     * @return {module:model/DetectModerationLabelsResponse} The populated <code>DetectModerationLabelsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectModerationLabelsResponse();

            if (data.hasOwnProperty('ModerationLabels')) {
                obj['ModerationLabels'] = ApiClient.convertToType(data['ModerationLabels'], Array);
            }
            if (data.hasOwnProperty('ModerationModelVersion')) {
                obj['ModerationModelVersion'] = ApiClient.convertToType(data['ModerationModelVersion'], 'String');
            }
            if (data.hasOwnProperty('HumanLoopActivationOutput')) {
                obj['HumanLoopActivationOutput'] = DetectModerationLabelsResponseHumanLoopActivationOutput.constructFromObject(data['HumanLoopActivationOutput']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectModerationLabelsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectModerationLabelsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ModerationLabels`
        if (data['ModerationLabels']) { // data not null
          Array.validateJSON(data['ModerationLabels']);
        }
        // validate the optional field `ModerationModelVersion`
        if (data['ModerationModelVersion']) { // data not null
          String.validateJSON(data['ModerationModelVersion']);
        }
        // validate the optional field `HumanLoopActivationOutput`
        if (data['HumanLoopActivationOutput']) { // data not null
          DetectModerationLabelsResponseHumanLoopActivationOutput.validateJSON(data['HumanLoopActivationOutput']);
        }
...
/**
 * @member {Array} ModerationLabels
 */
DetectModerationLabelsResponse.prototype['ModerationLabels'] = undefined;

/**
 * @member {String} ModerationModelVersion
 */
DetectModerationLabelsResponse.prototype['ModerationModelVersion'] = undefined;

/**
 * @member {module:model/DetectModerationLabelsResponseHumanLoopActivationOutput} HumanLoopActivationOutput
 */
DetectModerationLabelsResponse.prototype['HumanLoopActivationOutput'] = undefined;
...
export default DetectModerationLabelsResponse;
