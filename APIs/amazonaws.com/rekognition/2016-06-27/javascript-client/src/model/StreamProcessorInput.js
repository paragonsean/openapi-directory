...
import StreamProcessorInputKinesisVideoStream from './StreamProcessorInputKinesisVideoStream';

/**
 * The StreamProcessorInput model module.
 * @module model/StreamProcessorInput
 * @version 2016-06-27
 */
class StreamProcessorInput {
    /**
     * Constructs a new <code>StreamProcessorInput</code>.
     * Information about the source streaming video. 
     * @alias module:model/StreamProcessorInput
     */
    constructor() { 
        
        StreamProcessorInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamProcessorInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorInput} obj Optional instance to populate.
     * @return {module:model/StreamProcessorInput} The populated <code>StreamProcessorInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorInput();

            if (data.hasOwnProperty('KinesisVideoStream')) {
                obj['KinesisVideoStream'] = StreamProcessorInputKinesisVideoStream.constructFromObject(data['KinesisVideoStream']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `KinesisVideoStream`
        if (data['KinesisVideoStream']) { // data not null
          StreamProcessorInputKinesisVideoStream.validateJSON(data['KinesisVideoStream']);
        }
...
/**
 * @member {module:model/StreamProcessorInputKinesisVideoStream} KinesisVideoStream
 */
StreamProcessorInput.prototype['KinesisVideoStream'] = undefined;
...
export default StreamProcessorInput;
