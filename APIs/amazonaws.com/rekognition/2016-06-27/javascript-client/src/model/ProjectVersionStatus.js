...
* @readonly
*/
export default class ProjectVersionStatus {
    ...
    /**
    * Returns a <code>ProjectVersionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProjectVersionStatus} The enum <code>ProjectVersionStatus</code> value.
    */
