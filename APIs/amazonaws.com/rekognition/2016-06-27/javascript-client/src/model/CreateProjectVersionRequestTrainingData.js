...
/**
 * The CreateProjectVersionRequestTrainingData model module.
 * @module model/CreateProjectVersionRequestTrainingData
 * @version 2016-06-27
 */
class CreateProjectVersionRequestTrainingData {
    /**
     * Constructs a new <code>CreateProjectVersionRequestTrainingData</code>.
     * @alias module:model/CreateProjectVersionRequestTrainingData
     * @implements module:model/TrainingData
     */
    constructor() { 
        TrainingData.initialize(this);
        CreateProjectVersionRequestTrainingData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateProjectVersionRequestTrainingData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProjectVersionRequestTrainingData} obj Optional instance to populate.
     * @return {module:model/CreateProjectVersionRequestTrainingData} The populated <code>CreateProjectVersionRequestTrainingData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProjectVersionRequestTrainingData();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProjectVersionRequestTrainingData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProjectVersionRequestTrainingData</code>.
     */
 ...
 * @member {Array} Assets
 */
CreateProjectVersionRequestTrainingData.prototype['Assets'] = undefined;
...
export default CreateProjectVersionRequestTrainingData;
