...
/**
 * The FaceDetailSunglasses model module.
 * @module model/FaceDetailSunglasses
 * @version 2016-06-27
 */
class FaceDetailSunglasses {
    /**
     * Constructs a new <code>FaceDetailSunglasses</code>.
     * @alias module:model/FaceDetailSunglasses
     * @implements module:model/Sunglasses
     */
    constructor() { 
        Sunglasses.initialize(this);
        FaceDetailSunglasses.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailSunglasses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailSunglasses} obj Optional instance to populate.
     * @return {module:model/FaceDetailSunglasses} The populated <code>FaceDetailSunglasses</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailSunglasses();
            Sunglasses.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailSunglasses</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailSunglasses</code>.
     */
 ...
 */
FaceDetailSunglasses.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailSunglasses.prototype['Confidence'] = undefined;


// Implement Sunglasses interface:
/**
 * @member {Boolean} Value
 */
Sunglasses.prototype['Value'] = undefined;
/**
 * @member {Number} Confidence
 */
Sunglasses.prototype['Confidence'] = undefined;




export default FaceDetailSunglasses;
