...
/**
 * The PutProjectPolicyResponse model module.
 * @module model/PutProjectPolicyResponse
 * @version 2016-06-27
 */
class PutProjectPolicyResponse {
    /**
     * Constructs a new <code>PutProjectPolicyResponse</code>.
     * @alias module:model/PutProjectPolicyResponse
     */
    constructor() { 
        
        PutProjectPolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutProjectPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutProjectPolicyResponse} obj Optional instance to populate.
     * @return {module:model/PutProjectPolicyResponse} The populated <code>PutProjectPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutProjectPolicyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PutProjectPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutProjectPolicyResponse</code>.
     */
 ...
 */
PutProjectPolicyResponse.prototype['PolicyRevisionId'] = undefined;
...
export default PutProjectPolicyResponse;
