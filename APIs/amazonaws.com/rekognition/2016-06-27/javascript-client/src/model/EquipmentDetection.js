...
import EquipmentDetectionBoundingBox from './EquipmentDetectionBoundingBox';
import EquipmentDetectionCoversBodyPart from './EquipmentDetectionCoversBodyPart';
import ProtectiveEquipmentType from './ProtectiveEquipmentType';

/**
 * The EquipmentDetection model module.
 * @module model/EquipmentDetection
 * @version 2016-06-27
 */
class EquipmentDetection {
    /**
     * Constructs a new <code>EquipmentDetection</code>.
     ...
     * @alias module:model/EquipmentDetection
     */
    constructor() { 
        
        EquipmentDetection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EquipmentDetection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EquipmentDetection} obj Optional instance to populate.
     * @return {module:model/EquipmentDetection} The populated <code>EquipmentDetection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EquipmentDetection();

            if (data.hasOwnProperty('BoundingBox')) {
                obj['BoundingBox'] = EquipmentDetectionBoundingBox.constructFromObject(data['BoundingBox']);
            }
            if (data.hasOwnProperty('Confidence')) {
                obj['Confidence'] = ApiClient.convertToType(data['Confidence'], 'Number');
            }
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], ProtectiveEquipmentType);
            }
            if (data.hasOwnProperty('CoversBodyPart')) {
                obj['CoversBodyPart'] = EquipmentDetectionCoversBodyPart.constructFromObject(data['CoversBodyPart']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EquipmentDetection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EquipmentDetection</code>.
     */
    static validateJSON(data) {
        // validate the optional field `BoundingBox`
        if (data['BoundingBox']) { // data not null
          EquipmentDetectionBoundingBox.validateJSON(data['BoundingBox']);
        }
        ...
        if (data['Type']) { // data not null
          ProtectiveEquipmentType.validateJSON(data['Type']);
        }
        // validate the optional field `CoversBodyPart`
        if (data['CoversBodyPart']) { // data not null
          EquipmentDetectionCoversBodyPart.validateJSON(data['CoversBodyPart']);
        }
...
/**
 * @member {module:model/EquipmentDetectionBoundingBox} BoundingBox
 */
EquipmentDetection.prototype['BoundingBox'] = undefined;

/**
 * @member {Number} Confidence
 */
EquipmentDetection.prototype['Confidence'] = undefined;

/**
 * @member {module:model/ProtectiveEquipmentType} Type
 */
EquipmentDetection.prototype['Type'] = undefined;

/**
 * @member {module:model/EquipmentDetectionCoversBodyPart} CoversBodyPart
 */
EquipmentDetection.prototype['CoversBodyPart'] = undefined;
...
export default EquipmentDetection;
