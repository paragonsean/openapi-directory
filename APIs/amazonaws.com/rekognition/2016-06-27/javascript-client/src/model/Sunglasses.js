...
/**
 * The Sunglasses model module.
 * @module model/Sunglasses
 * @version 2016-06-27
 */
class Sunglasses {
    /**
     * Constructs a new <code>Sunglasses</code>.
     * Indicates whether or not the face is wearing sunglasses, and the confidence level in the determination.
     * @alias module:model/Sunglasses
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Sunglasses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Sunglasses} obj Optional instance to populate.
     * @return {module:model/Sunglasses} The populated <code>Sunglasses</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Sunglasses();
    ...
    /**
     * Validates the JSON data with respect to <code>Sunglasses</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Sunglasses</code>.
     */
