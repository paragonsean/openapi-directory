...
import UnindexedFaceFaceDetail from './UnindexedFaceFaceDetail';

/**
 * The UnindexedFace model module.
 * @module model/UnindexedFace
 * @version 2016-06-27
 */
class UnindexedFace {
    /**
     * Constructs a new <code>UnindexedFace</code>.
     ...
     * @alias module:model/UnindexedFace
     */
    constructor() { 
        
        UnindexedFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnindexedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnindexedFace} obj Optional instance to populate.
     * @return {module:model/UnindexedFace} The populated <code>UnindexedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnindexedFace();

            if (data.hasOwnProperty('Reasons')) {
                obj['Reasons'] = ApiClient.convertToType(data['Reasons'], Array);
            }
            if (data.hasOwnProperty('FaceDetail')) {
                obj['FaceDetail'] = UnindexedFaceFaceDetail.constructFromObject(data['FaceDetail']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UnindexedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnindexedFace</code>.
     */
    static validateJSON(data) {
        ...
        if (data['FaceDetail']) { // data not null
          UnindexedFaceFaceDetail.validateJSON(data['FaceDetail']);
        }
 ...
 */
UnindexedFace.prototype['Reasons'] = undefined;

/**
 * @member {module:model/UnindexedFaceFaceDetail} FaceDetail
 */
UnindexedFace.prototype['FaceDetail'] = undefined;
