...
/**
 * The StopStreamProcessorRequest model module.
 * @module model/StopStreamProcessorRequest
 * @version 2016-06-27
 */
class StopStreamProcessorRequest {
    /**
     * Constructs a new <code>StopStreamProcessorRequest</code>.
     * @alias module:model/StopStreamProcessorRequest
     * @param name {String} 
     */
    constructor(name) { 
        
        StopStreamProcessorRequest.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>StopStreamProcessorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopStreamProcessorRequest} obj Optional instance to populate.
     * @return {module:model/StopStreamProcessorRequest} The populated <code>StopStreamProcessorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopStreamProcessorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopStreamProcessorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopStreamProcessorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopStreamProcessorRequest.RequiredProperties) {
...
StopStreamProcessorRequest.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
StopStreamProcessorRequest.prototype['Name'] = undefined;
...
export default StopStreamProcessorRequest;
