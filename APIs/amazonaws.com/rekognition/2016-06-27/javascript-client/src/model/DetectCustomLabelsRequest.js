...
/**
 * The DetectCustomLabelsRequest model module.
 * @module model/DetectCustomLabelsRequest
 * @version 2016-06-27
 */
class DetectCustomLabelsRequest {
    /**
     * Constructs a new <code>DetectCustomLabelsRequest</code>.
     * @alias module:model/DetectCustomLabelsRequest
     * @param projectVersionArn {String} 
     * @param image {module:model/Image} 
     */
    constructor(projectVersionArn, image) { 
        
        DetectCustomLabelsRequest.initialize(this, projectVersionArn, image);
    }
     ...
     */
    static initialize(obj, projectVersionArn, image) { 
        obj['ProjectVersionArn'] = projectVersionArn;
        obj['Image'] = image;
    }

    /**
     * Constructs a <code>DetectCustomLabelsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectCustomLabelsRequest} obj Optional instance to populate.
     * @return {module:model/DetectCustomLabelsRequest} The populated <code>DetectCustomLabelsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectCustomLabelsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectCustomLabelsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectCustomLabelsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectCustomLabelsRequest.RequiredProperties) {
...
DetectCustomLabelsRequest.RequiredProperties = ["ProjectVersionArn", "Image"];

/**
 * @member {String} ProjectVersionArn
 */
DetectCustomLabelsRequest.prototype['ProjectVersionArn'] = undefined;

/**
 * @member {module:model/Image} Image
 */
DetectCustomLabelsRequest.prototype['Image'] = undefined;

/**
 * @member {Number} MaxResults
 */
DetectCustomLabelsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {Number} MinConfidence
 */
DetectCustomLabelsRequest.prototype['MinConfidence'] = undefined;
...
export default DetectCustomLabelsRequest;
