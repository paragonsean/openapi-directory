...
/**
 * The FaceDetailMustache model module.
 * @module model/FaceDetailMustache
 * @version 2016-06-27
 */
class FaceDetailMustache {
    /**
     * Constructs a new <code>FaceDetailMustache</code>.
     * @alias module:model/FaceDetailMustache
     * @implements module:model/Mustache
     */
    constructor() { 
        Mustache.initialize(this);
        FaceDetailMustache.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailMustache</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailMustache} obj Optional instance to populate.
     * @return {module:model/FaceDetailMustache} The populated <code>FaceDetailMustache</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailMustache();
            Mustache.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailMustache</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailMustache</code>.
     */
 ...
 */
FaceDetailMustache.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailMustache.prototype['Confidence'] = undefined;


// Implement Mustache interface:
/**
 * @member {Boolean} Value
 */
Mustache.prototype['Value'] = undefined;
/**
 * @member {Number} Confidence
 */
Mustache.prototype['Confidence'] = undefined;




export default FaceDetailMustache;
