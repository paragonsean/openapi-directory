...
/**
 * The Smile model module.
 * @module model/Smile
 * @version 2016-06-27
 */
class Smile {
    /**
     * Constructs a new <code>Smile</code>.
     * Indicates whether or not the face is smiling, and the confidence level in the determination.
     * @alias module:model/Smile
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Smile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Smile} obj Optional instance to populate.
     * @return {module:model/Smile} The populated <code>Smile</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Smile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Smile</code>.
     */
