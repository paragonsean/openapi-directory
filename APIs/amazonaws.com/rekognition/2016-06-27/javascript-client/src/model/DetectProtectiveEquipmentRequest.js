...
import DetectProtectiveEquipmentRequestImage from './DetectProtectiveEquipmentRequestImage';
import DetectProtectiveEquipmentRequestSummarizationAttributes from './DetectProtectiveEquipmentRequestSummarizationAttributes';

/**
 * The DetectProtectiveEquipmentRequest model module.
 * @module model/DetectProtectiveEquipmentRequest
 * @version 2016-06-27
 */
class DetectProtectiveEquipmentRequest {
    /**
     * Constructs a new <code>DetectProtectiveEquipmentRequest</code>.
     * @alias module:model/DetectProtectiveEquipmentRequest
     * @param image {module:model/DetectProtectiveEquipmentRequestImage} 
     */
    constructor(image) { 
        
        DetectProtectiveEquipmentRequest.initialize(this, image);
    }
    ...
    /**
     * Constructs a <code>DetectProtectiveEquipmentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectProtectiveEquipmentRequest} obj Optional instance to populate.
     * @return {module:model/DetectProtectiveEquipmentRequest} The populated <code>DetectProtectiveEquipmentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectProtectiveEquipmentRequest();

            if (data.hasOwnProperty('Image')) {
                obj['Image'] = DetectProtectiveEquipmentRequestImage.constructFromObject(data['Image']);
            }
            if (data.hasOwnProperty('SummarizationAttributes')) {
                obj['SummarizationAttributes'] = DetectProtectiveEquipmentRequestSummarizationAttributes.constructFromObject(data['SummarizationAttributes']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectProtectiveEquipmentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectProtectiveEquipmentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectProtectiveEquipmentRequest.RequiredProperties) {
        ...
        if (data['Image']) { // data not null
          DetectProtectiveEquipmentRequestImage.validateJSON(data['Image']);
        }
        // validate the optional field `SummarizationAttributes`
        if (data['SummarizationAttributes']) { // data not null
          DetectProtectiveEquipmentRequestSummarizationAttributes.validateJSON(data['SummarizationAttributes']);
        }
...
DetectProtectiveEquipmentRequest.RequiredProperties = ["Image"];

/**
 * @member {module:model/DetectProtectiveEquipmentRequestImage} Image
 */
DetectProtectiveEquipmentRequest.prototype['Image'] = undefined;

/**
 * @member {module:model/DetectProtectiveEquipmentRequestSummarizationAttributes} SummarizationAttributes
 */
DetectProtectiveEquipmentRequest.prototype['SummarizationAttributes'] = undefined;
...
export default DetectProtectiveEquipmentRequest;
