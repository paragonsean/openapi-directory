...
/**
 * The ListFacesRequest model module.
 * @module model/ListFacesRequest
 * @version 2016-06-27
 */
class ListFacesRequest {
    /**
     * Constructs a new <code>ListFacesRequest</code>.
     * @alias module:model/ListFacesRequest
     * @param collectionId {String} 
     */
    constructor(collectionId) { 
        
        ListFacesRequest.initialize(this, collectionId);
    }
    ...
    /**
     * Constructs a <code>ListFacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFacesRequest} obj Optional instance to populate.
     * @return {module:model/ListFacesRequest} The populated <code>ListFacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFacesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFacesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListFacesRequest.RequiredProperties) {
...
ListFacesRequest.RequiredProperties = ["CollectionId"];

/**
 * @member {String} CollectionId
 */
ListFacesRequest.prototype['CollectionId'] = undefined;

/**
 * @member {String} NextToken
 */
ListFacesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListFacesRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} UserId
 */
ListFacesRequest.prototype['UserId'] = undefined;

/**
 * @member {Array} FaceIds
 */
ListFacesRequest.prototype['FaceIds'] = undefined;
...
export default ListFacesRequest;
