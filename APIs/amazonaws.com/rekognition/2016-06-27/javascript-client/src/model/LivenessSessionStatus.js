...
* @readonly
*/
export default class LivenessSessionStatus {
    ...
    /**
    * Returns a <code>LivenessSessionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LivenessSessionStatus} The enum <code>LivenessSessionStatus</code> value.
    */
