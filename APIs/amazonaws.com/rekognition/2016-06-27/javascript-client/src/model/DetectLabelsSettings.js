...
/**
 * The DetectLabelsSettings model module.
 * @module model/DetectLabelsSettings
 * @version 2016-06-27
 */
class DetectLabelsSettings {
    /**
     * Constructs a new <code>DetectLabelsSettings</code>.
     ...
     * @alias module:model/DetectLabelsSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DetectLabelsSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsSettings} obj Optional instance to populate.
     * @return {module:model/DetectLabelsSettings} The populated <code>DetectLabelsSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsSettings</code>.
     */
...
export default DetectLabelsSettings;
