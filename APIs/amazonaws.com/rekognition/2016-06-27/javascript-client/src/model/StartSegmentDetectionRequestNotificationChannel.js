...
/**
 * The StartSegmentDetectionRequestNotificationChannel model module.
 * @module model/StartSegmentDetectionRequestNotificationChannel
 * @version 2016-06-27
 */
class StartSegmentDetectionRequestNotificationChannel {
    /**
     * Constructs a new <code>StartSegmentDetectionRequestNotificationChannel</code>.
     * @alias module:model/StartSegmentDetectionRequestNotificationChannel
    ...
    constructor(sNSTopicArn, roleArn) { 
        ...
        StartSegmentDetectionRequestNotificationChannel.initialize(this, sNSTopicArn, roleArn);
    }
    ...
    /**
     * Constructs a <code>StartSegmentDetectionRequestNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSegmentDetectionRequestNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StartSegmentDetectionRequestNotificationChannel} The populated <code>StartSegmentDetectionRequestNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSegmentDetectionRequestNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StartSegmentDetectionRequestNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSegmentDetectionRequestNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartSegmentDetectionRequestNotificationChannel.RequiredProperties) {
...
StartSegmentDetectionRequestNotificationChannel.RequiredProperties = ["SNSTopicArn", "RoleArn"];

/**
 * @member {String} SNSTopicArn
 */
StartSegmentDetectionRequestNotificationChannel.prototype['SNSTopicArn'] = undefined;

/**
 * @member {String} RoleArn
 */
StartSegmentDetectionRequestNotificationChannel.prototype['RoleArn'] = undefined;
...
export default StartSegmentDetectionRequestNotificationChannel;
