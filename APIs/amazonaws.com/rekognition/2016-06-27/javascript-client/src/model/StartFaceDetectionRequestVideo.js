...
import VideoS3Object from './VideoS3Object';

/**
 * The StartFaceDetectionRequestVideo model module.
 * @module model/StartFaceDetectionRequestVideo
 * @version 2016-06-27
 */
class StartFaceDetectionRequestVideo {
    /**
     * Constructs a new <code>StartFaceDetectionRequestVideo</code>.
     * @alias module:model/StartFaceDetectionRequestVideo
     * @implements module:model/Video
     */
    constructor() { 
        Video.initialize(this);
        StartFaceDetectionRequestVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartFaceDetectionRequestVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceDetectionRequestVideo} obj Optional instance to populate.
     * @return {module:model/StartFaceDetectionRequestVideo} The populated <code>StartFaceDetectionRequestVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceDetectionRequestVideo();
            Video.constructFromObject(data, obj);

            if (data.hasOwnProperty('S3Object')) {
                obj['S3Object'] = VideoS3Object.constructFromObject(data['S3Object']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceDetectionRequestVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceDetectionRequestVideo</code>.
     */
    static validateJSON(data) {
        // validate the optional field `S3Object`
        if (data['S3Object']) { // data not null
          VideoS3Object.validateJSON(data['S3Object']);
        }
...
/**
 * @member {module:model/VideoS3Object} S3Object
 */
StartFaceDetectionRequestVideo.prototype['S3Object'] = undefined;
 ...
 * @member {module:model/VideoS3Object} S3Object
 */
Video.prototype['S3Object'] = undefined;




export default StartFaceDetectionRequestVideo;
