...
import TextDetectionGeometry from './TextDetectionGeometry';
import TextTypes from './TextTypes';

/**
 * The TextDetection model module.
 * @module model/TextDetection
 * @version 2016-06-27
 */
class TextDetection {
    /**
     * Constructs a new <code>TextDetection</code>.
     ...
     * @alias module:model/TextDetection
     */
    constructor() { 
        
        TextDetection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TextDetection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TextDetection} obj Optional instance to populate.
     * @return {module:model/TextDetection} The populated <code>TextDetection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TextDetection();

            if (data.hasOwnProperty('DetectedText')) {
                obj['DetectedText'] = ApiClient.convertToType(data['DetectedText'], 'String');
            }
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], TextTypes);
            }
            ...
            if (data.hasOwnProperty('Geometry')) {
                obj['Geometry'] = TextDetectionGeometry.constructFromObject(data['Geometry']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TextDetection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TextDetection</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DetectedText`
        if (data['DetectedText']) { // data not null
          String.validateJSON(data['DetectedText']);
        }
        // validate the optional field `Type`
        if (data['Type']) { // data not null
          TextTypes.validateJSON(data['Type']);
        }
        ...
        if (data['ParentId']) { // data not null
          Number.validateJSON(data['ParentId']);
        }
        ...
        if (data['Geometry']) { // data not null
          TextDetectionGeometry.validateJSON(data['Geometry']);
        }
 ...
 */
TextDetection.prototype['DetectedText'] = undefined;

/**
 * @member {module:model/TextTypes} Type
 */
TextDetection.prototype['Type'] = undefined;

/**
 * @member {Number} Id
 */
TextDetection.prototype['Id'] = undefined;

/**
 * @member {Number} ParentId
 */
TextDetection.prototype['ParentId'] = undefined;

/**
 * @member {Number} Confidence
 */
TextDetection.prototype['Confidence'] = undefined;

/**
 * @member {module:model/TextDetectionGeometry} Geometry
 */
TextDetection.prototype['Geometry'] = undefined;
