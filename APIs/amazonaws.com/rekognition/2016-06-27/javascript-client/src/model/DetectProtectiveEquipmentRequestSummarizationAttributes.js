...
/**
 * The DetectProtectiveEquipmentRequestSummarizationAttributes model module.
 * @module model/DetectProtectiveEquipmentRequestSummarizationAttributes
 * @version 2016-06-27
 */
class DetectProtectiveEquipmentRequestSummarizationAttributes {
    /**
     * Constructs a new <code>DetectProtectiveEquipmentRequestSummarizationAttributes</code>.
     * @alias module:model/DetectProtectiveEquipmentRequestSummarizationAttributes
     * @implements module:model/ProtectiveEquipmentSummarizationAttributes
     * @param minConfidence {Number} 
     * @param requiredEquipmentTypes {Array} 
     */
    constructor(minConfidence, requiredEquipmentTypes) { 
        ProtectiveEquipmentSummarizationAttributes.initialize(this, minConfidence, requiredEquipmentTypes);
        DetectProtectiveEquipmentRequestSummarizationAttributes.initialize(this, minConfidence, requiredEquipmentTypes);
    }
     ...
     */
    static initialize(obj, minConfidence, requiredEquipmentTypes) { 
        obj['MinConfidence'] = minConfidence;
        obj['RequiredEquipmentTypes'] = requiredEquipmentTypes;
    }

    /**
     * Constructs a <code>DetectProtectiveEquipmentRequestSummarizationAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectProtectiveEquipmentRequestSummarizationAttributes} obj Optional instance to populate.
     * @return {module:model/DetectProtectiveEquipmentRequestSummarizationAttributes} The populated <code>DetectProtectiveEquipmentRequestSummarizationAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectProtectiveEquipmentRequestSummarizationAttributes();
            ProtectiveEquipmentSummarizationAttributes.constructFromObject(data, obj);

            if (data.hasOwnProperty('MinConfidence')) {
                obj['MinConfidence'] = ApiClient.convertToType(data['MinConfidence'], 'Number');
            }
            if (data.hasOwnProperty('RequiredEquipmentTypes')) {
                obj['RequiredEquipmentTypes'] = ApiClient.convertToType(data['RequiredEquipmentTypes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectProtectiveEquipmentRequestSummarizationAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectProtectiveEquipmentRequestSummarizationAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectProtectiveEquipmentRequestSummarizationAttributes.RequiredProperties) {
        ...
        // validate the optional field `RequiredEquipmentTypes`
        if (data['RequiredEquipmentTypes']) { // data not null
          Array.validateJSON(data['RequiredEquipmentTypes']);
        }
...
DetectProtectiveEquipmentRequestSummarizationAttributes.RequiredProperties = ["MinConfidence", "RequiredEquipmentTypes"];

/**
 * @member {Number} MinConfidence
 */
DetectProtectiveEquipmentRequestSummarizationAttributes.prototype['MinConfidence'] = undefined;

/**
 * @member {Array} RequiredEquipmentTypes
 */
DetectProtectiveEquipmentRequestSummarizationAttributes.prototype['RequiredEquipmentTypes'] = undefined;


// Implement ProtectiveEquipmentSummarizationAttributes interface:
/**
 * @member {Number} MinConfidence
 */
ProtectiveEquipmentSummarizationAttributes.prototype['MinConfidence'] = undefined;
/**
 * @member {Array} RequiredEquipmentTypes
 */
ProtectiveEquipmentSummarizationAttributes.prototype['RequiredEquipmentTypes'] = undefined;




export default DetectProtectiveEquipmentRequestSummarizationAttributes;
