...
* @readonly
*/
export default class QualityFilter {
    ...
    /**
    * Returns a <code>QualityFilter</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/QualityFilter} The enum <code>QualityFilter</code> value.
    */
