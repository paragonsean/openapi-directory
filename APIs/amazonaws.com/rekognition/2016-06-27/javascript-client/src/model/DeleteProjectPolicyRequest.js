...
/**
 * The DeleteProjectPolicyRequest model module.
 * @module model/DeleteProjectPolicyRequest
 * @version 2016-06-27
 */
class DeleteProjectPolicyRequest {
    /**
     * Constructs a new <code>DeleteProjectPolicyRequest</code>.
     * @alias module:model/DeleteProjectPolicyRequest
     * @param projectArn {String} 
     * @param policyName {String} 
     */
    constructor(projectArn, policyName) { 
        
        DeleteProjectPolicyRequest.initialize(this, projectArn, policyName);
    }
     ...
     */
    static initialize(obj, projectArn, policyName) { 
        obj['ProjectArn'] = projectArn;
        obj['PolicyName'] = policyName;
    }

    /**
     * Constructs a <code>DeleteProjectPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteProjectPolicyRequest} obj Optional instance to populate.
     * @return {module:model/DeleteProjectPolicyRequest} The populated <code>DeleteProjectPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteProjectPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteProjectPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteProjectPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteProjectPolicyRequest.RequiredProperties) {
...
DeleteProjectPolicyRequest.RequiredProperties = ["ProjectArn", "PolicyName"];

/**
 * @member {String} ProjectArn
 */
DeleteProjectPolicyRequest.prototype['ProjectArn'] = undefined;

/**
 * @member {String} PolicyName
 */
DeleteProjectPolicyRequest.prototype['PolicyName'] = undefined;

/**
 * @member {String} PolicyRevisionId
 */
DeleteProjectPolicyRequest.prototype['PolicyRevisionId'] = undefined;
...
export default DeleteProjectPolicyRequest;
