...
import OrientationCorrection from './OrientationCorrection';

/**
 * The DetectFacesResponse model module.
 * @module model/DetectFacesResponse
 * @version 2016-06-27
 */
class DetectFacesResponse {
    /**
     * Constructs a new <code>DetectFacesResponse</code>.
     * @alias module:model/DetectFacesResponse
     */
    constructor() { 
        
        DetectFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectFacesResponse} obj Optional instance to populate.
     * @return {module:model/DetectFacesResponse} The populated <code>DetectFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectFacesResponse();

            if (data.hasOwnProperty('FaceDetails')) {
                obj['FaceDetails'] = ApiClient.convertToType(data['FaceDetails'], Array);
            }
            if (data.hasOwnProperty('OrientationCorrection')) {
                obj['OrientationCorrection'] = ApiClient.convertToType(data['OrientationCorrection'], OrientationCorrection);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectFacesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FaceDetails`
        if (data['FaceDetails']) { // data not null
          Array.validateJSON(data['FaceDetails']);
        }
        // validate the optional field `OrientationCorrection`
        if (data['OrientationCorrection']) { // data not null
          OrientationCorrection.validateJSON(data['OrientationCorrection']);
        }
...
/**
 * @member {Array} FaceDetails
 */
DetectFacesResponse.prototype['FaceDetails'] = undefined;

/**
 * @member {module:model/OrientationCorrection} OrientationCorrection
 */
DetectFacesResponse.prototype['OrientationCorrection'] = undefined;
