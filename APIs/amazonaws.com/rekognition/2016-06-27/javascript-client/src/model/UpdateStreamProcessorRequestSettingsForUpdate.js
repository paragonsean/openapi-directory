...
import StreamProcessorSettingsForUpdateConnectedHomeForUpdate from './StreamProcessorSettingsForUpdateConnectedHomeForUpdate';

/**
 * The UpdateStreamProcessorRequestSettingsForUpdate model module.
 * @module model/UpdateStreamProcessorRequestSettingsForUpdate
 * @version 2016-06-27
 */
class UpdateStreamProcessorRequestSettingsForUpdate {
    /**
     * Constructs a new <code>UpdateStreamProcessorRequestSettingsForUpdate</code>.
     * @alias module:model/UpdateStreamProcessorRequestSettingsForUpdate
     * @implements module:model/StreamProcessorSettingsForUpdate
     */
    constructor() { 
        StreamProcessorSettingsForUpdate.initialize(this);
        UpdateStreamProcessorRequestSettingsForUpdate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateStreamProcessorRequestSettingsForUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateStreamProcessorRequestSettingsForUpdate} obj Optional instance to populate.
     * @return {module:model/UpdateStreamProcessorRequestSettingsForUpdate} The populated <code>UpdateStreamProcessorRequestSettingsForUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateStreamProcessorRequestSettingsForUpdate();
            StreamProcessorSettingsForUpdate.constructFromObject(data, obj);

            if (data.hasOwnProperty('ConnectedHomeForUpdate')) {
                obj['ConnectedHomeForUpdate'] = StreamProcessorSettingsForUpdateConnectedHomeForUpdate.constructFromObject(data['ConnectedHomeForUpdate']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateStreamProcessorRequestSettingsForUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateStreamProcessorRequestSettingsForUpdate</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ConnectedHomeForUpdate`
        if (data['ConnectedHomeForUpdate']) { // data not null
          StreamProcessorSettingsForUpdateConnectedHomeForUpdate.validateJSON(data['ConnectedHomeForUpdate']);
        }
...
/**
 * @member {module:model/StreamProcessorSettingsForUpdateConnectedHomeForUpdate} ConnectedHomeForUpdate
 */
UpdateStreamProcessorRequestSettingsForUpdate.prototype['ConnectedHomeForUpdate'] = undefined;


// Implement StreamProcessorSettingsForUpdate interface:
/**
 * @member {module:model/StreamProcessorSettingsForUpdateConnectedHomeForUpdate} ConnectedHomeForUpdate
 */
StreamProcessorSettingsForUpdate.prototype['ConnectedHomeForUpdate'] = undefined;




export default UpdateStreamProcessorRequestSettingsForUpdate;
