...
/**
 * The LabelDetectionSettings model module.
 * @module model/LabelDetectionSettings
 * @version 2016-06-27
 */
class LabelDetectionSettings {
    /**
     * Constructs a new <code>LabelDetectionSettings</code>.
     * Contains the specified filters that should be applied to a list of returned GENERAL_LABELS.
     * @alias module:model/LabelDetectionSettings
     */
    constructor() { 
        
        LabelDetectionSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LabelDetectionSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LabelDetectionSettings} obj Optional instance to populate.
     * @return {module:model/LabelDetectionSettings} The populated <code>LabelDetectionSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LabelDetectionSettings();

            if (data.hasOwnProperty('GeneralLabels')) {
                obj['GeneralLabels'] = GeneralLabelsSettings.constructFromObject(data['GeneralLabels']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LabelDetectionSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LabelDetectionSettings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GeneralLabels`
        if (data['GeneralLabels']) { // data not null
          GeneralLabelsSettings.validateJSON(data['GeneralLabels']);
        }
...
/**
 * @member {module:model/GeneralLabelsSettings} GeneralLabels
 */
LabelDetectionSettings.prototype['GeneralLabels'] = undefined;
...
export default LabelDetectionSettings;
