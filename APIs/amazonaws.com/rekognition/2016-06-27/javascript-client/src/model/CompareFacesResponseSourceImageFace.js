...
/**
 * The CompareFacesResponseSourceImageFace model module.
 * @module model/CompareFacesResponseSourceImageFace
 * @version 2016-06-27
 */
class CompareFacesResponseSourceImageFace {
    /**
     * Constructs a new <code>CompareFacesResponseSourceImageFace</code>.
     * @alias module:model/CompareFacesResponseSourceImageFace
     * @implements module:model/ComparedSourceImageFace
     */
    constructor() { 
        ComparedSourceImageFace.initialize(this);
        CompareFacesResponseSourceImageFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompareFacesResponseSourceImageFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompareFacesResponseSourceImageFace} obj Optional instance to populate.
     * @return {module:model/CompareFacesResponseSourceImageFace} The populated <code>CompareFacesResponseSourceImageFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompareFacesResponseSourceImageFace();
            ComparedSourceImageFace.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CompareFacesResponseSourceImageFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompareFacesResponseSourceImageFace</code>.
     */
 ...
 */
CompareFacesResponseSourceImageFace.prototype['BoundingBox'] = undefined;

/**
 * @member {Number} Confidence
 */
CompareFacesResponseSourceImageFace.prototype['Confidence'] = undefined;


// Implement ComparedSourceImageFace interface:
/**
 * @member {module:model/ComparedFaceBoundingBox} BoundingBox
 */
ComparedSourceImageFace.prototype['BoundingBox'] = undefined;
/**
 * @member {Number} Confidence
 */
ComparedSourceImageFace.prototype['Confidence'] = undefined;




export default CompareFacesResponseSourceImageFace;
