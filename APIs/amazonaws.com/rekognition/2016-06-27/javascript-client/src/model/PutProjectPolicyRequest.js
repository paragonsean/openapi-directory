...
/**
 * The PutProjectPolicyRequest model module.
 * @module model/PutProjectPolicyRequest
 * @version 2016-06-27
 */
class PutProjectPolicyRequest {
    /**
     * Constructs a new <code>PutProjectPolicyRequest</code>.
     * @alias module:model/PutProjectPolicyRequest
     * @param projectArn {String} 
     * @param policyName {String} 
     * @param policyDocument {String} 
     */
    constructor(projectArn, policyName, policyDocument) { 
        
        PutProjectPolicyRequest.initialize(this, projectArn, policyName, policyDocument);
    }
     ...
     */
    static initialize(obj, projectArn, policyName, policyDocument) { 
    ...
    /**
     * Constructs a <code>PutProjectPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutProjectPolicyRequest} obj Optional instance to populate.
     * @return {module:model/PutProjectPolicyRequest} The populated <code>PutProjectPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutProjectPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutProjectPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutProjectPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutProjectPolicyRequest.RequiredProperties) {
...
PutProjectPolicyRequest.RequiredProperties = ["ProjectArn", "PolicyName", "PolicyDocument"];

/**
 * @member {String} ProjectArn
 */
PutProjectPolicyRequest.prototype['ProjectArn'] = undefined;

/**
 * @member {String} PolicyName
 */
PutProjectPolicyRequest.prototype['PolicyName'] = undefined;

/**
 * @member {String} PolicyRevisionId
 */
PutProjectPolicyRequest.prototype['PolicyRevisionId'] = undefined;

/**
 * @member {String} PolicyDocument
 */
PutProjectPolicyRequest.prototype['PolicyDocument'] = undefined;
...
export default PutProjectPolicyRequest;
