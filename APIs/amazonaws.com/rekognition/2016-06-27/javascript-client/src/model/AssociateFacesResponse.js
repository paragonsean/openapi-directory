...
/**
 * The AssociateFacesResponse model module.
 * @module model/AssociateFacesResponse
 * @version 2016-06-27
 */
class AssociateFacesResponse {
    /**
     * Constructs a new <code>AssociateFacesResponse</code>.
     * @alias module:model/AssociateFacesResponse
     */
    constructor() { 
        
        AssociateFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateFacesResponse} obj Optional instance to populate.
     * @return {module:model/AssociateFacesResponse} The populated <code>AssociateFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateFacesResponse();

            if (data.hasOwnProperty('AssociatedFaces')) {
                obj['AssociatedFaces'] = ApiClient.convertToType(data['AssociatedFaces'], Array);
            }
            if (data.hasOwnProperty('UnsuccessfulFaceAssociations')) {
                obj['UnsuccessfulFaceAssociations'] = ApiClient.convertToType(data['UnsuccessfulFaceAssociations'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateFacesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AssociatedFaces`
        if (data['AssociatedFaces']) { // data not null
          Array.validateJSON(data['AssociatedFaces']);
        }
        // validate the optional field `UnsuccessfulFaceAssociations`
        if (data['UnsuccessfulFaceAssociations']) { // data not null
          Array.validateJSON(data['UnsuccessfulFaceAssociations']);
        }
...
/**
 * @member {Array} AssociatedFaces
 */
AssociateFacesResponse.prototype['AssociatedFaces'] = undefined;

/**
 * @member {Array} UnsuccessfulFaceAssociations
 */
AssociateFacesResponse.prototype['UnsuccessfulFaceAssociations'] = undefined;

/**
 * @member {module:model/UserStatus} UserStatus
 */
AssociateFacesResponse.prototype['UserStatus'] = undefined;
...
export default AssociateFacesResponse;
