...
/**
 * The DatasetLabelDescriptionLabelStats model module.
 * @module model/DatasetLabelDescriptionLabelStats
 * @version 2016-06-27
 */
class DatasetLabelDescriptionLabelStats {
    /**
     * Constructs a new <code>DatasetLabelDescriptionLabelStats</code>.
     * @alias module:model/DatasetLabelDescriptionLabelStats
     * @implements module:model/DatasetLabelStats
     */
    constructor() { 
        DatasetLabelStats.initialize(this);
        DatasetLabelDescriptionLabelStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatasetLabelDescriptionLabelStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatasetLabelDescriptionLabelStats} obj Optional instance to populate.
     * @return {module:model/DatasetLabelDescriptionLabelStats} The populated <code>DatasetLabelDescriptionLabelStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatasetLabelDescriptionLabelStats();
            DatasetLabelStats.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DatasetLabelDescriptionLabelStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatasetLabelDescriptionLabelStats</code>.
     */
 ...
 */
DatasetLabelDescriptionLabelStats.prototype['EntryCount'] = undefined;

/**
 * @member {Number} BoundingBoxCount
 */
DatasetLabelDescriptionLabelStats.prototype['BoundingBoxCount'] = undefined;


// Implement DatasetLabelStats interface:
/**
 * @member {Number} EntryCount
 */
...
export default DatasetLabelDescriptionLabelStats;
