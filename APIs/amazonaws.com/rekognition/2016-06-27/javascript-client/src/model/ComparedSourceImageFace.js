...
/**
 * The ComparedSourceImageFace model module.
 * @module model/ComparedSourceImageFace
 * @version 2016-06-27
 */
class ComparedSourceImageFace {
    /**
     * Constructs a new <code>ComparedSourceImageFace</code>.
     * Type that describes the face Amazon Rekognition chose to compare with the faces in the target. This contains a bounding box for the selected face and confidence level that the bounding box contains a face. Note that Amazon Rekognition selects the largest face in the source image for this comparison. 
     * @alias module:model/ComparedSourceImageFace
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ComparedSourceImageFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ComparedSourceImageFace} obj Optional instance to populate.
     * @return {module:model/ComparedSourceImageFace} The populated <code>ComparedSourceImageFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComparedSourceImageFace();
    ...
    /**
     * Validates the JSON data with respect to <code>ComparedSourceImageFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComparedSourceImageFace</code>.
     */
...
export default ComparedSourceImageFace;
