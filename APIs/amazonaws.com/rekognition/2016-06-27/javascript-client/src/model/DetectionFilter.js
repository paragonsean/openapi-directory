...
/**
 * The DetectionFilter model module.
 * @module model/DetectionFilter
 * @version 2016-06-27
 */
class DetectionFilter {
    /**
     * Constructs a new <code>DetectionFilter</code>.
     * A set of parameters that allow you to filter out certain results from your returned results.
     * @alias module:model/DetectionFilter
     */
    constructor() { 
        
        DetectionFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectionFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectionFilter} obj Optional instance to populate.
     * @return {module:model/DetectionFilter} The populated <code>DetectionFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectionFilter();

            if (data.hasOwnProperty('MinConfidence')) {
                obj['MinConfidence'] = ApiClient.convertToType(data['MinConfidence'], 'Number');
            }
            if (data.hasOwnProperty('MinBoundingBoxHeight')) {
                obj['MinBoundingBoxHeight'] = ApiClient.convertToType(data['MinBoundingBoxHeight'], 'Number');
            }
            if (data.hasOwnProperty('MinBoundingBoxWidth')) {
                obj['MinBoundingBoxWidth'] = ApiClient.convertToType(data['MinBoundingBoxWidth'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectionFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectionFilter</code>.
     */
    static validateJSON(data) {
        ...
        if (data['MinBoundingBoxHeight']) { // data not null
          Number.validateJSON(data['MinBoundingBoxHeight']);
        }
        // validate the optional field `MinBoundingBoxWidth`
        if (data['MinBoundingBoxWidth']) { // data not null
          Number.validateJSON(data['MinBoundingBoxWidth']);
        }
 ...
 */
DetectionFilter.prototype['MinConfidence'] = undefined;

/**
 * @member {Number} MinBoundingBoxHeight
 */
DetectionFilter.prototype['MinBoundingBoxHeight'] = undefined;

/**
 * @member {Number} MinBoundingBoxWidth
 */
DetectionFilter.prototype['MinBoundingBoxWidth'] = undefined;
