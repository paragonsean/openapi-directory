...
/**
 * The ComparedFaceBoundingBox model module.
 * @module model/ComparedFaceBoundingBox
 * @version 2016-06-27
 */
class ComparedFaceBoundingBox {
    /**
     * Constructs a new <code>ComparedFaceBoundingBox</code>.
     * @alias module:model/ComparedFaceBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        ComparedFaceBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ComparedFaceBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ComparedFaceBoundingBox} obj Optional instance to populate.
     * @return {module:model/ComparedFaceBoundingBox} The populated <code>ComparedFaceBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComparedFaceBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>ComparedFaceBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComparedFaceBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
ComparedFaceBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
ComparedFaceBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
ComparedFaceBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
ComparedFaceBoundingBox.prototype['Top'] = undefined;
...
export default ComparedFaceBoundingBox;
