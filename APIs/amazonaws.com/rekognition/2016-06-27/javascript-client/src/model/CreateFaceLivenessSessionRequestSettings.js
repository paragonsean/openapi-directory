...
import CreateFaceLivenessSessionRequestSettings from './CreateFaceLivenessSessionRequestSettings';
import CreateFaceLivenessSessionRequestSettingsOutputConfig from './CreateFaceLivenessSessionRequestSettingsOutputConfig';

/**
 * The CreateFaceLivenessSessionRequestSettings model module.
 * @module model/CreateFaceLivenessSessionRequestSettings
 * @version 2016-06-27
 */
class CreateFaceLivenessSessionRequestSettings {
    /**
     * Constructs a new <code>CreateFaceLivenessSessionRequestSettings</code>.
     * @alias module:model/CreateFaceLivenessSessionRequestSettings
     * @implements module:model/CreateFaceLivenessSessionRequestSettings
     */
    constructor() { 
        CreateFaceLivenessSessionRequestSettings.initialize(this);
        CreateFaceLivenessSessionRequestSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFaceLivenessSessionRequestSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFaceLivenessSessionRequestSettings} obj Optional instance to populate.
     * @return {module:model/CreateFaceLivenessSessionRequestSettings} The populated <code>CreateFaceLivenessSessionRequestSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFaceLivenessSessionRequestSettings();
            CreateFaceLivenessSessionRequestSettings.constructFromObject(data, obj);

            if (data.hasOwnProperty('OutputConfig')) {
                obj['OutputConfig'] = CreateFaceLivenessSessionRequestSettingsOutputConfig.constructFromObject(data['OutputConfig']);
            }
            if (data.hasOwnProperty('AuditImagesLimit')) {
                obj['AuditImagesLimit'] = ApiClient.convertToType(data['AuditImagesLimit'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFaceLivenessSessionRequestSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFaceLivenessSessionRequestSettings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `OutputConfig`
        if (data['OutputConfig']) { // data not null
          CreateFaceLivenessSessionRequestSettingsOutputConfig.validateJSON(data['OutputConfig']);
        }
        // validate the optional field `AuditImagesLimit`
        if (data['AuditImagesLimit']) { // data not null
          Number.validateJSON(data['AuditImagesLimit']);
        }
...
/**
 * @member {module:model/CreateFaceLivenessSessionRequestSettingsOutputConfig} OutputConfig
 */
CreateFaceLivenessSessionRequestSettings.prototype['OutputConfig'] = undefined;

/**
 * @member {Number} AuditImagesLimit
 */
CreateFaceLivenessSessionRequestSettings.prototype['AuditImagesLimit'] = undefined;


// Implement CreateFaceLivenessSessionRequestSettings interface:
/**
 * @member {module:model/CreateFaceLivenessSessionRequestSettingsOutputConfig} OutputConfig
 */
CreateFaceLivenessSessionRequestSettings.prototype['OutputConfig'] = undefined;
...
export default CreateFaceLivenessSessionRequestSettings;
