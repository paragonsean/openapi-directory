...
* @readonly
*/
export default class LandmarkType {
    ...
    /**
    * Returns a <code>LandmarkType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LandmarkType} The enum <code>LandmarkType</code> value.
    */
