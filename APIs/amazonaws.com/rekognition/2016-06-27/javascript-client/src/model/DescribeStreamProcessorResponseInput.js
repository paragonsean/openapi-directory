...
/**
 * The DescribeStreamProcessorResponseInput model module.
 * @module model/DescribeStreamProcessorResponseInput
 * @version 2016-06-27
 */
class DescribeStreamProcessorResponseInput {
    /**
     * Constructs a new <code>DescribeStreamProcessorResponseInput</code>.
     * @alias module:model/DescribeStreamProcessorResponseInput
     * @implements module:model/StreamProcessorInput
     */
    constructor() { 
        StreamProcessorInput.initialize(this);
        DescribeStreamProcessorResponseInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeStreamProcessorResponseInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeStreamProcessorResponseInput} obj Optional instance to populate.
     * @return {module:model/DescribeStreamProcessorResponseInput} The populated <code>DescribeStreamProcessorResponseInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeStreamProcessorResponseInput();
            StreamProcessorInput.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeStreamProcessorResponseInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeStreamProcessorResponseInput</code>.
     */
 ...
 */
DescribeStreamProcessorResponseInput.prototype['KinesisVideoStream'] = undefined;


// Implement StreamProcessorInput interface:
/**
 * @member {module:model/StreamProcessorInputKinesisVideoStream} KinesisVideoStream
 */
...
export default DescribeStreamProcessorResponseInput;
