...
/**
 * The DatasetLabelStats model module.
 * @module model/DatasetLabelStats
 * @version 2016-06-27
 */
class DatasetLabelStats {
    /**
     * Constructs a new <code>DatasetLabelStats</code>.
     *  Statistics about a label used in a dataset. For more information, see &lt;a&gt;DatasetLabelDescription&lt;/a&gt;. 
     * @alias module:model/DatasetLabelStats
     */
    constructor() { 
        
        DatasetLabelStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatasetLabelStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatasetLabelStats} obj Optional instance to populate.
     * @return {module:model/DatasetLabelStats} The populated <code>DatasetLabelStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatasetLabelStats();

            if (data.hasOwnProperty('EntryCount')) {
                obj['EntryCount'] = ApiClient.convertToType(data['EntryCount'], 'Number');
            }
            if (data.hasOwnProperty('BoundingBoxCount')) {
                obj['BoundingBoxCount'] = ApiClient.convertToType(data['BoundingBoxCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatasetLabelStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatasetLabelStats</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EntryCount`
        if (data['EntryCount']) { // data not null
          Number.validateJSON(data['EntryCount']);
        }
        // validate the optional field `BoundingBoxCount`
        if (data['BoundingBoxCount']) { // data not null
          Number.validateJSON(data['BoundingBoxCount']);
        }
 ...
 */
DatasetLabelStats.prototype['EntryCount'] = undefined;

/**
 * @member {Number} BoundingBoxCount
 */
DatasetLabelStats.prototype['BoundingBoxCount'] = undefined;
...
export default DatasetLabelStats;
