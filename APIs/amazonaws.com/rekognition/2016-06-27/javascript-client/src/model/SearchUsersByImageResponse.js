...
import SearchUsersByImageResponseSearchedFace from './SearchUsersByImageResponseSearchedFace';

/**
 * The SearchUsersByImageResponse model module.
 * @module model/SearchUsersByImageResponse
 * @version 2016-06-27
 */
class SearchUsersByImageResponse {
    /**
     * Constructs a new <code>SearchUsersByImageResponse</code>.
     * @alias module:model/SearchUsersByImageResponse
     */
    constructor() { 
        
        SearchUsersByImageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchUsersByImageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchUsersByImageResponse} obj Optional instance to populate.
     * @return {module:model/SearchUsersByImageResponse} The populated <code>SearchUsersByImageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchUsersByImageResponse();

            if (data.hasOwnProperty('UserMatches')) {
                obj['UserMatches'] = ApiClient.convertToType(data['UserMatches'], Array);
            }
            if (data.hasOwnProperty('FaceModelVersion')) {
                obj['FaceModelVersion'] = ApiClient.convertToType(data['FaceModelVersion'], 'String');
            }
            if (data.hasOwnProperty('SearchedFace')) {
                obj['SearchedFace'] = SearchUsersByImageResponseSearchedFace.constructFromObject(data['SearchedFace']);
            }
            if (data.hasOwnProperty('UnsearchedFaces')) {
                obj['UnsearchedFaces'] = ApiClient.convertToType(data['UnsearchedFaces'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchUsersByImageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchUsersByImageResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserMatches`
        if (data['UserMatches']) { // data not null
          Array.validateJSON(data['UserMatches']);
        }
        // validate the optional field `FaceModelVersion`
        if (data['FaceModelVersion']) { // data not null
          String.validateJSON(data['FaceModelVersion']);
        }
        // validate the optional field `SearchedFace`
        if (data['SearchedFace']) { // data not null
          SearchUsersByImageResponseSearchedFace.validateJSON(data['SearchedFace']);
        }
        // validate the optional field `UnsearchedFaces`
        if (data['UnsearchedFaces']) { // data not null
          Array.validateJSON(data['UnsearchedFaces']);
        }
...
/**
 * @member {Array} UserMatches
 */
SearchUsersByImageResponse.prototype['UserMatches'] = undefined;

/**
 * @member {String} FaceModelVersion
 */
SearchUsersByImageResponse.prototype['FaceModelVersion'] = undefined;

/**
 * @member {module:model/SearchUsersByImageResponseSearchedFace} SearchedFace
 */
SearchUsersByImageResponse.prototype['SearchedFace'] = undefined;

/**
 * @member {Array} UnsearchedFaces
 */
SearchUsersByImageResponse.prototype['UnsearchedFaces'] = undefined;
...
export default SearchUsersByImageResponse;
