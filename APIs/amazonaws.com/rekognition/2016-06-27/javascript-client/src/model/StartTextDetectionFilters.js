...
import StartTextDetectionFiltersWordFilter from './StartTextDetectionFiltersWordFilter';

/**
 * The StartTextDetectionFilters model module.
 * @module model/StartTextDetectionFilters
 * @version 2016-06-27
 */
class StartTextDetectionFilters {
    /**
     * Constructs a new <code>StartTextDetectionFilters</code>.
     ...
     * @alias module:model/StartTextDetectionFilters
     */
    constructor() { 
        
        StartTextDetectionFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartTextDetectionFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTextDetectionFilters} obj Optional instance to populate.
     * @return {module:model/StartTextDetectionFilters} The populated <code>StartTextDetectionFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTextDetectionFilters();

            if (data.hasOwnProperty('WordFilter')) {
                obj['WordFilter'] = StartTextDetectionFiltersWordFilter.constructFromObject(data['WordFilter']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StartTextDetectionFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTextDetectionFilters</code>.
     */
    static validateJSON(data) {
        // validate the optional field `WordFilter`
        if (data['WordFilter']) { // data not null
          StartTextDetectionFiltersWordFilter.validateJSON(data['WordFilter']);
        }
...
/**
 * @member {module:model/StartTextDetectionFiltersWordFilter} WordFilter
 */
StartTextDetectionFilters.prototype['WordFilter'] = undefined;

/**
 * @member {Array} RegionsOfInterest
 */
StartTextDetectionFilters.prototype['RegionsOfInterest'] = undefined;
...
export default StartTextDetectionFilters;
