...
/**
 * The CelebrityDetailBoundingBox model module.
 * @module model/CelebrityDetailBoundingBox
 * @version 2016-06-27
 */
class CelebrityDetailBoundingBox {
    /**
     * Constructs a new <code>CelebrityDetailBoundingBox</code>.
     * @alias module:model/CelebrityDetailBoundingBox
     * @implements module:model/BoundingBox
     */
    constructor() { 
        BoundingBox.initialize(this);
        CelebrityDetailBoundingBox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CelebrityDetailBoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CelebrityDetailBoundingBox} obj Optional instance to populate.
     * @return {module:model/CelebrityDetailBoundingBox} The populated <code>CelebrityDetailBoundingBox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CelebrityDetailBoundingBox();
    ...
    /**
     * Validates the JSON data with respect to <code>CelebrityDetailBoundingBox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CelebrityDetailBoundingBox</code>.
     */
 ...
 * @member {Number} Width
 */
CelebrityDetailBoundingBox.prototype['Width'] = undefined;

/**
 * @member {Number} Height
 */
CelebrityDetailBoundingBox.prototype['Height'] = undefined;

/**
 * @member {Number} Left
 */
CelebrityDetailBoundingBox.prototype['Left'] = undefined;

/**
 * @member {Number} Top
 */
CelebrityDetailBoundingBox.prototype['Top'] = undefined;
...
export default CelebrityDetailBoundingBox;
