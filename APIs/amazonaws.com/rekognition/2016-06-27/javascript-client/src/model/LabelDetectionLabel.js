...
/**
 * The LabelDetectionLabel model module.
 * @module model/LabelDetectionLabel
 * @version 2016-06-27
 */
class LabelDetectionLabel {
    /**
     * Constructs a new <code>LabelDetectionLabel</code>.
     * @alias module:model/LabelDetectionLabel
     * @implements module:model/Label
     */
    constructor() { 
        Label.initialize(this);
        LabelDetectionLabel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LabelDetectionLabel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LabelDetectionLabel} obj Optional instance to populate.
     * @return {module:model/LabelDetectionLabel} The populated <code>LabelDetectionLabel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LabelDetectionLabel();
    ...
    /**
     * Validates the JSON data with respect to <code>LabelDetectionLabel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LabelDetectionLabel</code>.
     */
 ...
 * @member {String} Name
 */
LabelDetectionLabel.prototype['Name'] = undefined;

/**
 * @member {Number} Confidence
 */
LabelDetectionLabel.prototype['Confidence'] = undefined;

/**
 * @member {Array} Instances
 */
LabelDetectionLabel.prototype['Instances'] = undefined;

/**
 * @member {Array} Parents
 */
LabelDetectionLabel.prototype['Parents'] = undefined;

/**
 * @member {Array} Aliases
 */
LabelDetectionLabel.prototype['Aliases'] = undefined;

/**
 * @member {Array} Categories
 */
LabelDetectionLabel.prototype['Categories'] = undefined;
 ...
 * @member {Number} Confidence
 */
Label.prototype['Confidence'] = undefined;
/**
 * @member {Array} Instances
 */
Label.prototype['Instances'] = undefined;
/**
 * @member {Array} Parents
 */
Label.prototype['Parents'] = undefined;
/**
 * @member {Array} Aliases
 */
Label.prototype['Aliases'] = undefined;
/**
 * @member {Array} Categories
 */
Label.prototype['Categories'] = undefined;




export default LabelDetectionLabel;
