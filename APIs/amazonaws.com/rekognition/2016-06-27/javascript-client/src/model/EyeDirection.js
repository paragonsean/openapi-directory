...
/**
 * The EyeDirection model module.
 * @module model/EyeDirection
 * @version 2016-06-27
 */
class EyeDirection {
    /**
     * Constructs a new <code>EyeDirection</code>.
     * Indicates the direction the eyes are gazing in (independent of the head pose) as determined by its pitch and yaw. 
     * @alias module:model/EyeDirection
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EyeDirection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EyeDirection} obj Optional instance to populate.
     * @return {module:model/EyeDirection} The populated <code>EyeDirection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EyeDirection();
    ...
    /**
     * Validates the JSON data with respect to <code>EyeDirection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EyeDirection</code>.
     */
