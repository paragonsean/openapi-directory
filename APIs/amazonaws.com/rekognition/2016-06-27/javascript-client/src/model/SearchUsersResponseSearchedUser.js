...
/**
 * The SearchUsersResponseSearchedUser model module.
 * @module model/SearchUsersResponseSearchedUser
 * @version 2016-06-27
 */
class SearchUsersResponseSearchedUser {
    /**
     * Constructs a new <code>SearchUsersResponseSearchedUser</code>.
     * @alias module:model/SearchUsersResponseSearchedUser
     * @implements module:model/SearchedUser
     */
    constructor() { 
        SearchedUser.initialize(this);
        SearchUsersResponseSearchedUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchUsersResponseSearchedUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchUsersResponseSearchedUser} obj Optional instance to populate.
     * @return {module:model/SearchUsersResponseSearchedUser} The populated <code>SearchUsersResponseSearchedUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchUsersResponseSearchedUser();
            SearchedUser.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SearchUsersResponseSearchedUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchUsersResponseSearchedUser</code>.
     */
 ...
 */
SearchUsersResponseSearchedUser.prototype['UserId'] = undefined;


// Implement SearchedUser interface:
/**
 * @member {String} UserId
 */
SearchedUser.prototype['UserId'] = undefined;




export default SearchUsersResponseSearchedUser;
