...
/**
 * The ProjectVersionDescriptionEvaluationResult model module.
 * @module model/ProjectVersionDescriptionEvaluationResult
 * @version 2016-06-27
 */
class ProjectVersionDescriptionEvaluationResult {
    /**
     * Constructs a new <code>ProjectVersionDescriptionEvaluationResult</code>.
     * @alias module:model/ProjectVersionDescriptionEvaluationResult
     * @implements module:model/EvaluationResult
     */
    constructor() { 
        EvaluationResult.initialize(this);
        ProjectVersionDescriptionEvaluationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectVersionDescriptionEvaluationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectVersionDescriptionEvaluationResult} obj Optional instance to populate.
     * @return {module:model/ProjectVersionDescriptionEvaluationResult} The populated <code>ProjectVersionDescriptionEvaluationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectVersionDescriptionEvaluationResult();
            EvaluationResult.constructFromObject(data, obj);

            if (data.hasOwnProperty('F1Score')) {
                obj['F1Score'] = ApiClient.convertToType(data['F1Score'], 'Number');
            }
            if (data.hasOwnProperty('Summary')) {
                obj['Summary'] = EvaluationResultSummary.constructFromObject(data['Summary']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectVersionDescriptionEvaluationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectVersionDescriptionEvaluationResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Summary']) { // data not null
          EvaluationResultSummary.validateJSON(data['Summary']);
        }
 ...
 */
ProjectVersionDescriptionEvaluationResult.prototype['F1Score'] = undefined;

/**
 * @member {module:model/EvaluationResultSummary} Summary
 */
ProjectVersionDescriptionEvaluationResult.prototype['Summary'] = undefined;


// Implement EvaluationResult interface:
/**
 * @member {Number} F1Score
 */
EvaluationResult.prototype['F1Score'] = undefined;
/**
 * @member {module:model/EvaluationResultSummary} Summary
 */
EvaluationResult.prototype['Summary'] = undefined;




export default ProjectVersionDescriptionEvaluationResult;
