...
/**
 * The GetTextDetectionRequest model module.
 * @module model/GetTextDetectionRequest
 * @version 2016-06-27
 */
class GetTextDetectionRequest {
    /**
     * Constructs a new <code>GetTextDetectionRequest</code>.
     * @alias module:model/GetTextDetectionRequest
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetTextDetectionRequest.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetTextDetectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTextDetectionRequest} obj Optional instance to populate.
     * @return {module:model/GetTextDetectionRequest} The populated <code>GetTextDetectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTextDetectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTextDetectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTextDetectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetTextDetectionRequest.RequiredProperties) {
...
GetTextDetectionRequest.RequiredProperties = ["JobId"];

/**
 * @member {String} JobId
 */
GetTextDetectionRequest.prototype['JobId'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetTextDetectionRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetTextDetectionRequest.prototype['NextToken'] = undefined;
...
export default GetTextDetectionRequest;
