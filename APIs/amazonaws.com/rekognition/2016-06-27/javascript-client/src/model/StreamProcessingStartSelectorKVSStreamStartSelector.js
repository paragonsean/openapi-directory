...
/**
 * The StreamProcessingStartSelectorKVSStreamStartSelector model module.
 * @module model/StreamProcessingStartSelectorKVSStreamStartSelector
 * @version 2016-06-27
 */
class StreamProcessingStartSelectorKVSStreamStartSelector {
    /**
     * Constructs a new <code>StreamProcessingStartSelectorKVSStreamStartSelector</code>.
     * @alias module:model/StreamProcessingStartSelectorKVSStreamStartSelector
     * @implements module:model/KinesisVideoStreamStartSelector
     */
    constructor() { 
        KinesisVideoStreamStartSelector.initialize(this);
        StreamProcessingStartSelectorKVSStreamStartSelector.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamProcessingStartSelectorKVSStreamStartSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessingStartSelectorKVSStreamStartSelector} obj Optional instance to populate.
     * @return {module:model/StreamProcessingStartSelectorKVSStreamStartSelector} The populated <code>StreamProcessingStartSelectorKVSStreamStartSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessingStartSelectorKVSStreamStartSelector();
            KinesisVideoStreamStartSelector.constructFromObject(data, obj);

            if (data.hasOwnProperty('ProducerTimestamp')) {
                obj['ProducerTimestamp'] = ApiClient.convertToType(data['ProducerTimestamp'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessingStartSelectorKVSStreamStartSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessingStartSelectorKVSStreamStartSelector</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProducerTimestamp`
        if (data['ProducerTimestamp']) { // data not null
          Number.validateJSON(data['ProducerTimestamp']);
        }
...
/**
 * @member {Number} ProducerTimestamp
 */
StreamProcessingStartSelectorKVSStreamStartSelector.prototype['ProducerTimestamp'] = undefined;

/**
 * @member {String} FragmentNumber
 */
StreamProcessingStartSelectorKVSStreamStartSelector.prototype['FragmentNumber'] = undefined;


// Implement KinesisVideoStreamStartSelector interface:
/**
 * @member {Number} ProducerTimestamp
 */
KinesisVideoStreamStartSelector.prototype['ProducerTimestamp'] = undefined;
/**
 * @member {String} FragmentNumber
 */
KinesisVideoStreamStartSelector.prototype['FragmentNumber'] = undefined;




export default StreamProcessingStartSelectorKVSStreamStartSelector;
