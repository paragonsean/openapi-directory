...
/**
 * The KinesisVideoStream model module.
 * @module model/KinesisVideoStream
 * @version 2016-06-27
 */
class KinesisVideoStream {
    /**
     * Constructs a new <code>KinesisVideoStream</code>.
     * Kinesis video stream stream that provides the source streaming video for a Amazon Rekognition Video stream processor. For more information, see CreateStreamProcessor in the Amazon Rekognition Developer Guide.
     * @alias module:model/KinesisVideoStream
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>KinesisVideoStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KinesisVideoStream} obj Optional instance to populate.
     * @return {module:model/KinesisVideoStream} The populated <code>KinesisVideoStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KinesisVideoStream();
    ...
    /**
     * Validates the JSON data with respect to <code>KinesisVideoStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KinesisVideoStream</code>.
     */
