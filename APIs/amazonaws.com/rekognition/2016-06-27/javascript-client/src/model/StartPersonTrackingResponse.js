...
/**
 * The StartPersonTrackingResponse model module.
 * @module model/StartPersonTrackingResponse
 * @version 2016-06-27
 */
class StartPersonTrackingResponse {
    /**
     * Constructs a new <code>StartPersonTrackingResponse</code>.
     * @alias module:model/StartPersonTrackingResponse
     */
    constructor() { 
        
        StartPersonTrackingResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartPersonTrackingResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPersonTrackingResponse} obj Optional instance to populate.
     * @return {module:model/StartPersonTrackingResponse} The populated <code>StartPersonTrackingResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPersonTrackingResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartPersonTrackingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPersonTrackingResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartPersonTrackingResponse.prototype['JobId'] = undefined;
...
export default StartPersonTrackingResponse;
