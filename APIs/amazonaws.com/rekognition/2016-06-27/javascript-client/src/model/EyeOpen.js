...
/**
 * The EyeOpen model module.
 * @module model/EyeOpen
 * @version 2016-06-27
 */
class EyeOpen {
    /**
     * Constructs a new <code>EyeOpen</code>.
     * Indicates whether or not the eyes on the face are open, and the confidence level in the determination.
     * @alias module:model/EyeOpen
     */
    constructor() { 
        
        EyeOpen.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EyeOpen</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EyeOpen} obj Optional instance to populate.
     * @return {module:model/EyeOpen} The populated <code>EyeOpen</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>EyeOpen</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EyeOpen</code>.
     */
 ...
 */
EyeOpen.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
EyeOpen.prototype['Confidence'] = undefined;
