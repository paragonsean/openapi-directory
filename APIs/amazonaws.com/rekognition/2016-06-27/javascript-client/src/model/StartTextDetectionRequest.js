...
import StartTextDetectionRequestFilters from './StartTextDetectionRequestFilters';
import Video from './Video';

/**
 * The StartTextDetectionRequest model module.
 * @module model/StartTextDetectionRequest
 * @version 2016-06-27
 */
class StartTextDetectionRequest {
    /**
     * Constructs a new <code>StartTextDetectionRequest</code>.
     * @alias module:model/StartTextDetectionRequest
     * @param video {module:model/Video} 
     */
    constructor(video) { 
        
        StartTextDetectionRequest.initialize(this, video);
    }
    ...
    /**
     * Constructs a <code>StartTextDetectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTextDetectionRequest} obj Optional instance to populate.
     * @return {module:model/StartTextDetectionRequest} The populated <code>StartTextDetectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTextDetectionRequest();
            ...
            if (data.hasOwnProperty('Filters')) {
                obj['Filters'] = StartTextDetectionRequestFilters.constructFromObject(data['Filters']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartTextDetectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTextDetectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartTextDetectionRequest.RequiredProperties) {
        ...
        if (data['Filters']) { // data not null
          StartTextDetectionRequestFilters.validateJSON(data['Filters']);
        }
...
StartTextDetectionRequest.RequiredProperties = ["Video"];

/**
 * @member {module:model/Video} Video
 */
StartTextDetectionRequest.prototype['Video'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
StartTextDetectionRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {module:model/NotificationChannel} NotificationChannel
 */
StartTextDetectionRequest.prototype['NotificationChannel'] = undefined;

/**
 * @member {String} JobTag
 */
StartTextDetectionRequest.prototype['JobTag'] = undefined;

/**
 * @member {module:model/StartTextDetectionRequestFilters} Filters
 */
StartTextDetectionRequest.prototype['Filters'] = undefined;
...
export default StartTextDetectionRequest;
