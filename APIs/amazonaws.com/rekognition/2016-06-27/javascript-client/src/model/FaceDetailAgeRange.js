...
/**
 * The FaceDetailAgeRange model module.
 * @module model/FaceDetailAgeRange
 * @version 2016-06-27
 */
class FaceDetailAgeRange {
    /**
     * Constructs a new <code>FaceDetailAgeRange</code>.
     * @alias module:model/FaceDetailAgeRange
     * @implements module:model/AgeRange
     */
    constructor() { 
        AgeRange.initialize(this);
        FaceDetailAgeRange.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailAgeRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailAgeRange} obj Optional instance to populate.
     * @return {module:model/FaceDetailAgeRange} The populated <code>FaceDetailAgeRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailAgeRange();
            AgeRange.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailAgeRange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailAgeRange</code>.
     */
 ...
 * @member {Number} Low
 */
FaceDetailAgeRange.prototype['Low'] = undefined;

/**
 * @member {Number} High
 */
FaceDetailAgeRange.prototype['High'] = undefined;


// Implement AgeRange interface:
/**
 * @member {Number} Low
 */
...
export default FaceDetailAgeRange;
