...
import TrainingDataResultInput from './TrainingDataResultInput';
import TrainingDataResultOutput from './TrainingDataResultOutput';
import TrainingDataResultValidation from './TrainingDataResultValidation';

/**
 * The TrainingDataResult model module.
 * @module model/TrainingDataResult
 * @version 2016-06-27
 */
class TrainingDataResult {
    /**
     * Constructs a new <code>TrainingDataResult</code>.
     * Sagemaker Groundtruth format manifest files for the input, output and validation datasets that are used and created during testing.
     * @alias module:model/TrainingDataResult
     */
    constructor() { 
        
        TrainingDataResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrainingDataResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrainingDataResult} obj Optional instance to populate.
     * @return {module:model/TrainingDataResult} The populated <code>TrainingDataResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrainingDataResult();

            if (data.hasOwnProperty('Input')) {
                obj['Input'] = TrainingDataResultInput.constructFromObject(data['Input']);
            }
            if (data.hasOwnProperty('Output')) {
                obj['Output'] = TrainingDataResultOutput.constructFromObject(data['Output']);
            }
            if (data.hasOwnProperty('Validation')) {
                obj['Validation'] = TrainingDataResultValidation.constructFromObject(data['Validation']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TrainingDataResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrainingDataResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Input`
        if (data['Input']) { // data not null
          TrainingDataResultInput.validateJSON(data['Input']);
        }
        // validate the optional field `Output`
        if (data['Output']) { // data not null
          TrainingDataResultOutput.validateJSON(data['Output']);
        }
        // validate the optional field `Validation`
        if (data['Validation']) { // data not null
          TrainingDataResultValidation.validateJSON(data['Validation']);
        }
...
/**
 * @member {module:model/TrainingDataResultInput} Input
 */
TrainingDataResult.prototype['Input'] = undefined;

/**
 * @member {module:model/TrainingDataResultOutput} Output
 */
TrainingDataResult.prototype['Output'] = undefined;

/**
 * @member {module:model/TrainingDataResultValidation} Validation
 */
TrainingDataResult.prototype['Validation'] = undefined;
...
export default TrainingDataResult;
