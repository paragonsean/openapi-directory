...
class Emotion {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], EmotionName);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Type']) { // data not null
          EmotionName.validateJSON(data['Type']);
        }
...
/**
 * @member {module:model/EmotionName} Type
 */
Emotion.prototype['Type'] = undefined;

/**
 * @member {Number} Confidence
 */
Emotion.prototype['Confidence'] = undefined;
