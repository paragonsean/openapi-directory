...
/**
 * The SearchedFaceDetails model module.
 * @module model/SearchedFaceDetails
 * @version 2016-06-27
 */
class SearchedFaceDetails {
    /**
     * Constructs a new <code>SearchedFaceDetails</code>.
     * Contains data regarding the input face used for a search.
     * @alias module:model/SearchedFaceDetails
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SearchedFaceDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchedFaceDetails} obj Optional instance to populate.
     * @return {module:model/SearchedFaceDetails} The populated <code>SearchedFaceDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchedFaceDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchedFaceDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchedFaceDetails</code>.
     */
...
export default SearchedFaceDetails;
