...
/**
 * The SearchedUser model module.
 * @module model/SearchedUser
 * @version 2016-06-27
 */
class SearchedUser {
    /**
     * Constructs a new <code>SearchedUser</code>.
     * Contains metadata about a User searched for within a collection.
     * @alias module:model/SearchedUser
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SearchedUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchedUser} obj Optional instance to populate.
     * @return {module:model/SearchedUser} The populated <code>SearchedUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchedUser();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchedUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchedUser</code>.
     */
