...
import FaceSearchSortBy from './FaceSearchSortBy';

/**
 * The GetFaceSearchRequest model module.
 * @module model/GetFaceSearchRequest
 * @version 2016-06-27
 */
class GetFaceSearchRequest {
    /**
     * Constructs a new <code>GetFaceSearchRequest</code>.
     * @alias module:model/GetFaceSearchRequest
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetFaceSearchRequest.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetFaceSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceSearchRequest} obj Optional instance to populate.
     * @return {module:model/GetFaceSearchRequest} The populated <code>GetFaceSearchRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceSearchRequest();
            ...
            if (data.hasOwnProperty('SortBy')) {
                obj['SortBy'] = ApiClient.convertToType(data['SortBy'], FaceSearchSortBy);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceSearchRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceSearchRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFaceSearchRequest.RequiredProperties) {
        ...
        if (data['SortBy']) { // data not null
          FaceSearchSortBy.validateJSON(data['SortBy']);
        }
...
GetFaceSearchRequest.RequiredProperties = ["JobId"];

/**
 * @member {String} JobId
 */
GetFaceSearchRequest.prototype['JobId'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetFaceSearchRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetFaceSearchRequest.prototype['NextToken'] = undefined;

/**
 * @member {module:model/FaceSearchSortBy} SortBy
 */
GetFaceSearchRequest.prototype['SortBy'] = undefined;
...
export default GetFaceSearchRequest;
