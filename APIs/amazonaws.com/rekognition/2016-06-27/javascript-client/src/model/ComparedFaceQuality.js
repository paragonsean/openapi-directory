...
/**
 * The ComparedFaceQuality model module.
 * @module model/ComparedFaceQuality
 * @version 2016-06-27
 */
class ComparedFaceQuality {
    /**
     * Constructs a new <code>ComparedFaceQuality</code>.
     * @alias module:model/ComparedFaceQuality
     * @implements module:model/ImageQuality
     */
    constructor() { 
        ImageQuality.initialize(this);
        ComparedFaceQuality.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ComparedFaceQuality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ComparedFaceQuality} obj Optional instance to populate.
     * @return {module:model/ComparedFaceQuality} The populated <code>ComparedFaceQuality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComparedFaceQuality();
            ImageQuality.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ComparedFaceQuality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComparedFaceQuality</code>.
     */
 ...
 */
ComparedFaceQuality.prototype['Brightness'] = undefined;

/**
 * @member {Number} Sharpness
 */
ComparedFaceQuality.prototype['Sharpness'] = undefined;


// Implement ImageQuality interface:
/**
 * @member {Number} Brightness
 */
ImageQuality.prototype['Brightness'] = undefined;
/**
 * @member {Number} Sharpness
 */
ImageQuality.prototype['Sharpness'] = undefined;




export default ComparedFaceQuality;
