...
/**
 * The GetCelebrityInfoRequest model module.
 * @module model/GetCelebrityInfoRequest
 * @version 2016-06-27
 */
class GetCelebrityInfoRequest {
    /**
     * Constructs a new <code>GetCelebrityInfoRequest</code>.
     * @alias module:model/GetCelebrityInfoRequest
     * @param id {String} 
     */
    constructor(id) { 
        
        GetCelebrityInfoRequest.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>GetCelebrityInfoRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCelebrityInfoRequest} obj Optional instance to populate.
     * @return {module:model/GetCelebrityInfoRequest} The populated <code>GetCelebrityInfoRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCelebrityInfoRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCelebrityInfoRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCelebrityInfoRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCelebrityInfoRequest.RequiredProperties) {
...
GetCelebrityInfoRequest.RequiredProperties = ["Id"];

/**
 * @member {String} Id
 */
GetCelebrityInfoRequest.prototype['Id'] = undefined;
...
export default GetCelebrityInfoRequest;
