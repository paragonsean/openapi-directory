...
/**
 * The UpdateDatasetEntriesRequestChanges model module.
 * @module model/UpdateDatasetEntriesRequestChanges
 * @version 2016-06-27
 */
class UpdateDatasetEntriesRequestChanges {
    /**
     * Constructs a new <code>UpdateDatasetEntriesRequestChanges</code>.
     * @alias module:model/UpdateDatasetEntriesRequestChanges
     * @implements module:model/DatasetChanges
     * @param groundTruth {String} 
     */
    constructor(groundTruth) { 
        DatasetChanges.initialize(this, groundTruth);
        UpdateDatasetEntriesRequestChanges.initialize(this, groundTruth);
    }
     ...
     */
    static initialize(obj, groundTruth) { 
        obj['GroundTruth'] = groundTruth;
    }

    /**
     * Constructs a <code>UpdateDatasetEntriesRequestChanges</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDatasetEntriesRequestChanges} obj Optional instance to populate.
     * @return {module:model/UpdateDatasetEntriesRequestChanges} The populated <code>UpdateDatasetEntriesRequestChanges</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDatasetEntriesRequestChanges();
            DatasetChanges.constructFromObject(data, obj);

            if (data.hasOwnProperty('GroundTruth')) {
                obj['GroundTruth'] = ApiClient.convertToType(data['GroundTruth'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDatasetEntriesRequestChanges</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDatasetEntriesRequestChanges</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateDatasetEntriesRequestChanges.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `GroundTruth`
        if (data['GroundTruth']) { // data not null
          String.validateJSON(data['GroundTruth']);
        }
...
UpdateDatasetEntriesRequestChanges.RequiredProperties = ["GroundTruth"];

/**
 * @member {String} GroundTruth
 */
UpdateDatasetEntriesRequestChanges.prototype['GroundTruth'] = undefined;


// Implement DatasetChanges interface:
/**
 * @member {String} GroundTruth
 */
DatasetChanges.prototype['GroundTruth'] = undefined;




export default UpdateDatasetEntriesRequestChanges;
