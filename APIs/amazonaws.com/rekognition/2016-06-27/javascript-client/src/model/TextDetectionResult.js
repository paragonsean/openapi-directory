...
import TextDetectionResultTextDetection from './TextDetectionResultTextDetection';
...
class TextDetectionResult {
    ...
    constructor() { 
        ...
        TextDetectionResult.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TextDetectionResult();

            if (data.hasOwnProperty('Timestamp')) {
                obj['Timestamp'] = ApiClient.convertToType(data['Timestamp'], 'Number');
            }
            if (data.hasOwnProperty('TextDetection')) {
                obj['TextDetection'] = TextDetectionResultTextDetection.constructFromObject(data['TextDetection']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TextDetectionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TextDetectionResult</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `TextDetection`
        if (data['TextDetection']) { // data not null
          TextDetectionResultTextDetection.validateJSON(data['TextDetection']);
        }
 ...
 */
TextDetectionResult.prototype['Timestamp'] = undefined;

/**
 * @member {module:model/TextDetectionResultTextDetection} TextDetection
 */
TextDetectionResult.prototype['TextDetection'] = undefined;
...
export default TextDetectionResult;
