...
/**
 * The SearchFacesByImageRequest model module.
 * @module model/SearchFacesByImageRequest
 * @version 2016-06-27
 */
class SearchFacesByImageRequest {
    /**
     * Constructs a new <code>SearchFacesByImageRequest</code>.
     * @alias module:model/SearchFacesByImageRequest
     * @param collectionId {String} 
     * @param image {module:model/CompareFacesRequestSourceImage} 
     */
    constructor(collectionId, image) { 
        
        SearchFacesByImageRequest.initialize(this, collectionId, image);
    }
    ...
    /**
     * Constructs a <code>SearchFacesByImageRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchFacesByImageRequest} obj Optional instance to populate.
     * @return {module:model/SearchFacesByImageRequest} The populated <code>SearchFacesByImageRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchFacesByImageRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchFacesByImageRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchFacesByImageRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SearchFacesByImageRequest.RequiredProperties) {
...
SearchFacesByImageRequest.RequiredProperties = ["CollectionId", "Image"];

/**
 * @member {String} CollectionId
 */
SearchFacesByImageRequest.prototype['CollectionId'] = undefined;

/**
 * @member {module:model/CompareFacesRequestSourceImage} Image
 */
SearchFacesByImageRequest.prototype['Image'] = undefined;

/**
 * @member {Number} MaxFaces
 */
SearchFacesByImageRequest.prototype['MaxFaces'] = undefined;

/**
 * @member {Number} FaceMatchThreshold
 */
SearchFacesByImageRequest.prototype['FaceMatchThreshold'] = undefined;

/**
 * @member {module:model/QualityFilter} QualityFilter
 */
SearchFacesByImageRequest.prototype['QualityFilter'] = undefined;
...
export default SearchFacesByImageRequest;
