...
/**
 * The SearchFacesResponse model module.
 * @module model/SearchFacesResponse
 * @version 2016-06-27
 */
class SearchFacesResponse {
    /**
     * Constructs a new <code>SearchFacesResponse</code>.
     * @alias module:model/SearchFacesResponse
     */
    constructor() { 
        
        SearchFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchFacesResponse} obj Optional instance to populate.
     * @return {module:model/SearchFacesResponse} The populated <code>SearchFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchFacesResponse();

            if (data.hasOwnProperty('SearchedFaceId')) {
                obj['SearchedFaceId'] = ApiClient.convertToType(data['SearchedFaceId'], 'String');
            }
            if (data.hasOwnProperty('FaceMatches')) {
                obj['FaceMatches'] = ApiClient.convertToType(data['FaceMatches'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchFacesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SearchedFaceId`
        if (data['SearchedFaceId']) { // data not null
          String.validateJSON(data['SearchedFaceId']);
        }
        // validate the optional field `FaceMatches`
        if (data['FaceMatches']) { // data not null
          Array.validateJSON(data['FaceMatches']);
        }
...
/**
 * @member {String} SearchedFaceId
 */
SearchFacesResponse.prototype['SearchedFaceId'] = undefined;

/**
 * @member {Array} FaceMatches
 */
SearchFacesResponse.prototype['FaceMatches'] = undefined;

/**
 * @member {String} FaceModelVersion
 */
SearchFacesResponse.prototype['FaceModelVersion'] = undefined;
...
export default SearchFacesResponse;
