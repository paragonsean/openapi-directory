...
/**
 * The ProjectVersionDescriptionOutputConfig model module.
 * @module model/ProjectVersionDescriptionOutputConfig
 * @version 2016-06-27
 */
class ProjectVersionDescriptionOutputConfig {
    /**
     * Constructs a new <code>ProjectVersionDescriptionOutputConfig</code>.
     * @alias module:model/ProjectVersionDescriptionOutputConfig
     * @implements module:model/OutputConfig
     */
    constructor() { 
        OutputConfig.initialize(this);
        ProjectVersionDescriptionOutputConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectVersionDescriptionOutputConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectVersionDescriptionOutputConfig} obj Optional instance to populate.
     * @return {module:model/ProjectVersionDescriptionOutputConfig} The populated <code>ProjectVersionDescriptionOutputConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectVersionDescriptionOutputConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectVersionDescriptionOutputConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectVersionDescriptionOutputConfig</code>.
     */
 ...
 */
ProjectVersionDescriptionOutputConfig.prototype['S3Bucket'] = undefined;

/**
 * @member {String} S3KeyPrefix
 */
ProjectVersionDescriptionOutputConfig.prototype['S3KeyPrefix'] = undefined;
...
export default ProjectVersionDescriptionOutputConfig;
