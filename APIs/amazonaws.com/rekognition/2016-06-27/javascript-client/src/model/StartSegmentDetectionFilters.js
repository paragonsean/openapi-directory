...
import StartSegmentDetectionFiltersShotFilter from './StartSegmentDetectionFiltersShotFilter';
import StartSegmentDetectionFiltersTechnicalCueFilter from './StartSegmentDetectionFiltersTechnicalCueFilter';

/**
 * The StartSegmentDetectionFilters model module.
 * @module model/StartSegmentDetectionFilters
 * @version 2016-06-27
 */
class StartSegmentDetectionFilters {
    /**
     * Constructs a new <code>StartSegmentDetectionFilters</code>.
     * Filters applied to the technical cue or shot detection segments. For more information, see &lt;a&gt;StartSegmentDetection&lt;/a&gt;. 
     * @alias module:model/StartSegmentDetectionFilters
     */
    constructor() { 
        
        StartSegmentDetectionFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartSegmentDetectionFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSegmentDetectionFilters} obj Optional instance to populate.
     * @return {module:model/StartSegmentDetectionFilters} The populated <code>StartSegmentDetectionFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSegmentDetectionFilters();

            if (data.hasOwnProperty('TechnicalCueFilter')) {
                obj['TechnicalCueFilter'] = StartSegmentDetectionFiltersTechnicalCueFilter.constructFromObject(data['TechnicalCueFilter']);
            }
            if (data.hasOwnProperty('ShotFilter')) {
                obj['ShotFilter'] = StartSegmentDetectionFiltersShotFilter.constructFromObject(data['ShotFilter']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartSegmentDetectionFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSegmentDetectionFilters</code>.
     */
    static validateJSON(data) {
        // validate the optional field `TechnicalCueFilter`
        if (data['TechnicalCueFilter']) { // data not null
          StartSegmentDetectionFiltersTechnicalCueFilter.validateJSON(data['TechnicalCueFilter']);
        }
        // validate the optional field `ShotFilter`
        if (data['ShotFilter']) { // data not null
          StartSegmentDetectionFiltersShotFilter.validateJSON(data['ShotFilter']);
        }
...
/**
 * @member {module:model/StartSegmentDetectionFiltersTechnicalCueFilter} TechnicalCueFilter
 */
StartSegmentDetectionFilters.prototype['TechnicalCueFilter'] = undefined;

/**
 * @member {module:model/StartSegmentDetectionFiltersShotFilter} ShotFilter
 */
StartSegmentDetectionFilters.prototype['ShotFilter'] = undefined;
...
export default StartSegmentDetectionFilters;
