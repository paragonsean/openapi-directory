...
/**
 * The ListDatasetLabelsRequest model module.
 * @module model/ListDatasetLabelsRequest
 * @version 2016-06-27
 */
class ListDatasetLabelsRequest {
    /**
     * Constructs a new <code>ListDatasetLabelsRequest</code>.
     * @alias module:model/ListDatasetLabelsRequest
     * @param datasetArn {String} 
     */
    constructor(datasetArn) { 
        
        ListDatasetLabelsRequest.initialize(this, datasetArn);
    }
    ...
    /**
     * Constructs a <code>ListDatasetLabelsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDatasetLabelsRequest} obj Optional instance to populate.
     * @return {module:model/ListDatasetLabelsRequest} The populated <code>ListDatasetLabelsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDatasetLabelsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDatasetLabelsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDatasetLabelsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListDatasetLabelsRequest.RequiredProperties) {
...
ListDatasetLabelsRequest.RequiredProperties = ["DatasetArn"];

/**
 * @member {String} DatasetArn
 */
ListDatasetLabelsRequest.prototype['DatasetArn'] = undefined;

/**
 * @member {String} NextToken
 */
ListDatasetLabelsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListDatasetLabelsRequest.prototype['MaxResults'] = undefined;
...
export default ListDatasetLabelsRequest;
