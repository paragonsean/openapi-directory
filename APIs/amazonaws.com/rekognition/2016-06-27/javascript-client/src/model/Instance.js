...
import InstanceBoundingBox from './InstanceBoundingBox';
...
class Instance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('BoundingBox')) {
                obj['BoundingBox'] = InstanceBoundingBox.constructFromObject(data['BoundingBox']);
            }
            if (data.hasOwnProperty('Confidence')) {
                obj['Confidence'] = ApiClient.convertToType(data['Confidence'], 'Number');
            }
            if (data.hasOwnProperty('DominantColors')) {
                obj['DominantColors'] = ApiClient.convertToType(data['DominantColors'], Array);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['BoundingBox']) { // data not null
          InstanceBoundingBox.validateJSON(data['BoundingBox']);
        }
        ...
        if (data['DominantColors']) { // data not null
          Array.validateJSON(data['DominantColors']);
        }
...
/**
 * @member {module:model/InstanceBoundingBox} BoundingBox
 */
Instance.prototype['BoundingBox'] = undefined;

/**
 * @member {Number} Confidence
 */
Instance.prototype['Confidence'] = undefined;

/**
 * @member {Array} DominantColors
 */
Instance.prototype['DominantColors'] = undefined;
