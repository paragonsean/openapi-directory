...
/**
 * The ContentModerationDetectionModerationLabel model module.
 * @module model/ContentModerationDetectionModerationLabel
 * @version 2016-06-27
 */
class ContentModerationDetectionModerationLabel {
    /**
     * Constructs a new <code>ContentModerationDetectionModerationLabel</code>.
     * @alias module:model/ContentModerationDetectionModerationLabel
     * @implements module:model/ModerationLabel
     */
    constructor() { 
        ModerationLabel.initialize(this);
        ContentModerationDetectionModerationLabel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentModerationDetectionModerationLabel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentModerationDetectionModerationLabel} obj Optional instance to populate.
     * @return {module:model/ContentModerationDetectionModerationLabel} The populated <code>ContentModerationDetectionModerationLabel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentModerationDetectionModerationLabel();
            ModerationLabel.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ContentModerationDetectionModerationLabel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentModerationDetectionModerationLabel</code>.
     */
 ...
 */
ContentModerationDetectionModerationLabel.prototype['Confidence'] = undefined;

/**
 * @member {String} Name
 */
ContentModerationDetectionModerationLabel.prototype['Name'] = undefined;

/**
 * @member {String} ParentName
 */
ContentModerationDetectionModerationLabel.prototype['ParentName'] = undefined;


// Implement ModerationLabel interface:
/**
 * @member {Number} Confidence
 */
...
export default ContentModerationDetectionModerationLabel;
