...
/**
 * The DetectTextRequestFilters model module.
 * @module model/DetectTextRequestFilters
 * @version 2016-06-27
 */
class DetectTextRequestFilters {
    /**
     * Constructs a new <code>DetectTextRequestFilters</code>.
     * @alias module:model/DetectTextRequestFilters
     * @implements module:model/DetectTextFilters
     */
    constructor() { 
        DetectTextFilters.initialize(this);
        DetectTextRequestFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectTextRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectTextRequestFilters} obj Optional instance to populate.
     * @return {module:model/DetectTextRequestFilters} The populated <code>DetectTextRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectTextRequestFilters();
            DetectTextFilters.constructFromObject(data, obj);

            if (data.hasOwnProperty('WordFilter')) {
                obj['WordFilter'] = DetectionFilter.constructFromObject(data['WordFilter']);
            }
            if (data.hasOwnProperty('RegionsOfInterest')) {
                obj['RegionsOfInterest'] = ApiClient.convertToType(data['RegionsOfInterest'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectTextRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectTextRequestFilters</code>.
     */
    static validateJSON(data) {
        // validate the optional field `WordFilter`
        if (data['WordFilter']) { // data not null
          DetectionFilter.validateJSON(data['WordFilter']);
        }
        // validate the optional field `RegionsOfInterest`
        if (data['RegionsOfInterest']) { // data not null
          Array.validateJSON(data['RegionsOfInterest']);
        }
...
/**
 * @member {module:model/DetectionFilter} WordFilter
 */
DetectTextRequestFilters.prototype['WordFilter'] = undefined;

/**
 * @member {Array} RegionsOfInterest
 */
DetectTextRequestFilters.prototype['RegionsOfInterest'] = undefined;


// Implement DetectTextFilters interface:
/**
 * @member {module:model/DetectionFilter} WordFilter
 */
DetectTextFilters.prototype['WordFilter'] = undefined;
/**
 * @member {Array} RegionsOfInterest
 */
DetectTextFilters.prototype['RegionsOfInterest'] = undefined;




export default DetectTextRequestFilters;
