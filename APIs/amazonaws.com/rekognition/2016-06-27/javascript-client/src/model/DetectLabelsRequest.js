...
import DetectLabelsRequestImage from './DetectLabelsRequestImage';
import DetectLabelsRequestSettings from './DetectLabelsRequestSettings';

/**
 * The DetectLabelsRequest model module.
 * @module model/DetectLabelsRequest
 * @version 2016-06-27
 */
class DetectLabelsRequest {
    /**
     * Constructs a new <code>DetectLabelsRequest</code>.
     * @alias module:model/DetectLabelsRequest
     * @param image {module:model/DetectLabelsRequestImage} 
     */
    constructor(image) { 
        
        DetectLabelsRequest.initialize(this, image);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsRequest} obj Optional instance to populate.
     * @return {module:model/DetectLabelsRequest} The populated <code>DetectLabelsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsRequest();

            if (data.hasOwnProperty('Image')) {
                obj['Image'] = DetectLabelsRequestImage.constructFromObject(data['Image']);
            }
            if (data.hasOwnProperty('MaxLabels')) {
                obj['MaxLabels'] = ApiClient.convertToType(data['MaxLabels'], 'Number');
            }
            ...
            if (data.hasOwnProperty('Settings')) {
                obj['Settings'] = DetectLabelsRequestSettings.constructFromObject(data['Settings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectLabelsRequest.RequiredProperties) {
        ...
        if (data['Image']) { // data not null
          DetectLabelsRequestImage.validateJSON(data['Image']);
        }
        // validate the optional field `MaxLabels`
        if (data['MaxLabels']) { // data not null
          Number.validateJSON(data['MaxLabels']);
        }
        ...
        if (data['Settings']) { // data not null
          DetectLabelsRequestSettings.validateJSON(data['Settings']);
        }
...
DetectLabelsRequest.RequiredProperties = ["Image"];

/**
 * @member {module:model/DetectLabelsRequestImage} Image
 */
DetectLabelsRequest.prototype['Image'] = undefined;

/**
 * @member {Number} MaxLabels
 */
DetectLabelsRequest.prototype['MaxLabels'] = undefined;

/**
 * @member {Number} MinConfidence
 */
DetectLabelsRequest.prototype['MinConfidence'] = undefined;

/**
 * @member {Array} Features
 */
DetectLabelsRequest.prototype['Features'] = undefined;

/**
 * @member {module:model/DetectLabelsRequestSettings} Settings
 */
DetectLabelsRequest.prototype['Settings'] = undefined;
...
export default DetectLabelsRequest;
