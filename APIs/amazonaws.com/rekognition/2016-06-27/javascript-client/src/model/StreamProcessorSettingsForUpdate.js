...
/**
 * The StreamProcessorSettingsForUpdate model module.
 * @module model/StreamProcessorSettingsForUpdate
 * @version 2016-06-27
 */
class StreamProcessorSettingsForUpdate {
    /**
     * Constructs a new <code>StreamProcessorSettingsForUpdate</code>.
     ...
     * @alias module:model/StreamProcessorSettingsForUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamProcessorSettingsForUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorSettingsForUpdate} obj Optional instance to populate.
     * @return {module:model/StreamProcessorSettingsForUpdate} The populated <code>StreamProcessorSettingsForUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorSettingsForUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorSettingsForUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorSettingsForUpdate</code>.
     */
...
export default StreamProcessorSettingsForUpdate;
