...
/**
 * The FaceMatchFace model module.
 * @module model/FaceMatchFace
 * @version 2016-06-27
 */
class FaceMatchFace {
    /**
     * Constructs a new <code>FaceMatchFace</code>.
     * @alias module:model/FaceMatchFace
     * @implements module:model/Face
     */
    constructor() { 
        Face.initialize(this);
        FaceMatchFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceMatchFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceMatchFace} obj Optional instance to populate.
     * @return {module:model/FaceMatchFace} The populated <code>FaceMatchFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceMatchFace();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceMatchFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceMatchFace</code>.
     */
 ...
 */
FaceMatchFace.prototype['FaceId'] = undefined;

/**
 * @member {module:model/ComparedFaceBoundingBox} BoundingBox
 */
FaceMatchFace.prototype['BoundingBox'] = undefined;

/**
 * @member {String} ImageId
 */
FaceMatchFace.prototype['ImageId'] = undefined;

/**
 * @member {String} ExternalImageId
 */
FaceMatchFace.prototype['ExternalImageId'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceMatchFace.prototype['Confidence'] = undefined;

/**
 * @member {String} IndexFacesModelVersion
 */
FaceMatchFace.prototype['IndexFacesModelVersion'] = undefined;

/**
 * @member {String} UserId
 */
FaceMatchFace.prototype['UserId'] = undefined;
