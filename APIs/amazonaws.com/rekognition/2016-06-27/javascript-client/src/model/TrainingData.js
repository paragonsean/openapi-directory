...
/**
 * The TrainingData model module.
 * @module model/TrainingData
 * @version 2016-06-27
 */
class TrainingData {
    /**
     * Constructs a new <code>TrainingData</code>.
     * The dataset used for training.
     * @alias module:model/TrainingData
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TrainingData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrainingData} obj Optional instance to populate.
     * @return {module:model/TrainingData} The populated <code>TrainingData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrainingData();
    ...
    /**
     * Validates the JSON data with respect to <code>TrainingData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrainingData</code>.
     */
