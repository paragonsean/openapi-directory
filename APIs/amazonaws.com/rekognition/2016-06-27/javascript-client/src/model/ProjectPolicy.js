...
/**
 * The ProjectPolicy model module.
 * @module model/ProjectPolicy
 * @version 2016-06-27
 */
class ProjectPolicy {
    /**
     * Constructs a new <code>ProjectPolicy</code>.
     * &lt;p&gt;Describes a project policy in the response from &lt;a&gt;ListProjectPolicies&lt;/a&gt;. &lt;/p&gt; &lt;p&gt; &lt;/p&gt;
     * @alias module:model/ProjectPolicy
     */
    constructor() { 
        
        ProjectPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectPolicy} obj Optional instance to populate.
     * @return {module:model/ProjectPolicy} The populated <code>ProjectPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectPolicy</code>.
     */
 ...
 */
ProjectPolicy.prototype['ProjectArn'] = undefined;

/**
 * @member {String} PolicyName
 */
ProjectPolicy.prototype['PolicyName'] = undefined;

/**
 * @member {String} PolicyRevisionId
 */
ProjectPolicy.prototype['PolicyRevisionId'] = undefined;

/**
 * @member {String} PolicyDocument
 */
ProjectPolicy.prototype['PolicyDocument'] = undefined;

/**
 * @member {Date} CreationTimestamp
 */
ProjectPolicy.prototype['CreationTimestamp'] = undefined;

/**
 * @member {Date} LastUpdatedTimestamp
 */
ProjectPolicy.prototype['LastUpdatedTimestamp'] = undefined;
