...
import GetFaceDetectionResponseVideoMetadata from './GetFaceDetectionResponseVideoMetadata';
import Video from './Video';
import VideoJobStatus from './VideoJobStatus';

/**
 * The GetFaceDetectionResponse model module.
 * @module model/GetFaceDetectionResponse
 * @version 2016-06-27
 */
class GetFaceDetectionResponse {
    /**
     * Constructs a new <code>GetFaceDetectionResponse</code>.
     * @alias module:model/GetFaceDetectionResponse
     */
    constructor() { 
        
        GetFaceDetectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFaceDetectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceDetectionResponse} obj Optional instance to populate.
     * @return {module:model/GetFaceDetectionResponse} The populated <code>GetFaceDetectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceDetectionResponse();
            ...
            if (data.hasOwnProperty('VideoMetadata')) {
                obj['VideoMetadata'] = GetFaceDetectionResponseVideoMetadata.constructFromObject(data['VideoMetadata']);
            }
            if (data.hasOwnProperty('NextToken')) {
                obj['NextToken'] = ApiClient.convertToType(data['NextToken'], 'String');
            }
            if (data.hasOwnProperty('Faces')) {
                obj['Faces'] = ApiClient.convertToType(data['Faces'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceDetectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceDetectionResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VideoMetadata']) { // data not null
          GetFaceDetectionResponseVideoMetadata.validateJSON(data['VideoMetadata']);
        }
 ...
 */
GetFaceDetectionResponse.prototype['JobStatus'] = undefined;

/**
 * @member {String} StatusMessage
 */
GetFaceDetectionResponse.prototype['StatusMessage'] = undefined;

/**
 * @member {module:model/GetFaceDetectionResponseVideoMetadata} VideoMetadata
 */
GetFaceDetectionResponse.prototype['VideoMetadata'] = undefined;

/**
 * @member {String} NextToken
 */
GetFaceDetectionResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} Faces
 */
GetFaceDetectionResponse.prototype['Faces'] = undefined;

/**
 * @member {String} JobId
 */
GetFaceDetectionResponse.prototype['JobId'] = undefined;

/**
 * @member {module:model/Video} Video
 */
GetFaceDetectionResponse.prototype['Video'] = undefined;

/**
 * @member {String} JobTag
 */
GetFaceDetectionResponse.prototype['JobTag'] = undefined;
...
export default GetFaceDetectionResponse;
