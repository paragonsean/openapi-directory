...
import CustomLabelGeometry from './CustomLabelGeometry';
...
class CustomLabel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Geometry')) {
                obj['Geometry'] = CustomLabelGeometry.constructFromObject(data['Geometry']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Geometry']) { // data not null
          CustomLabelGeometry.validateJSON(data['Geometry']);
        }
 ...
 * @member {String} Name
 */
CustomLabel.prototype['Name'] = undefined;

/**
 * @member {Number} Confidence
 */
CustomLabel.prototype['Confidence'] = undefined;

/**
 * @member {module:model/CustomLabelGeometry} Geometry
 */
CustomLabel.prototype['Geometry'] = undefined;
