...
/**
 * The DisassociateFacesResponse model module.
 * @module model/DisassociateFacesResponse
 * @version 2016-06-27
 */
class DisassociateFacesResponse {
    /**
     * Constructs a new <code>DisassociateFacesResponse</code>.
     * @alias module:model/DisassociateFacesResponse
     */
    constructor() { 
        
        DisassociateFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociateFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateFacesResponse} obj Optional instance to populate.
     * @return {module:model/DisassociateFacesResponse} The populated <code>DisassociateFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateFacesResponse();

            if (data.hasOwnProperty('DisassociatedFaces')) {
                obj['DisassociatedFaces'] = ApiClient.convertToType(data['DisassociatedFaces'], Array);
            }
            if (data.hasOwnProperty('UnsuccessfulFaceDisassociations')) {
                obj['UnsuccessfulFaceDisassociations'] = ApiClient.convertToType(data['UnsuccessfulFaceDisassociations'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateFacesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DisassociatedFaces`
        if (data['DisassociatedFaces']) { // data not null
          Array.validateJSON(data['DisassociatedFaces']);
        }
        // validate the optional field `UnsuccessfulFaceDisassociations`
        if (data['UnsuccessfulFaceDisassociations']) { // data not null
          Array.validateJSON(data['UnsuccessfulFaceDisassociations']);
        }
...
/**
 * @member {Array} DisassociatedFaces
 */
DisassociateFacesResponse.prototype['DisassociatedFaces'] = undefined;

/**
 * @member {Array} UnsuccessfulFaceDisassociations
 */
DisassociateFacesResponse.prototype['UnsuccessfulFaceDisassociations'] = undefined;

/**
 * @member {module:model/UserStatus} UserStatus
 */
DisassociateFacesResponse.prototype['UserStatus'] = undefined;
...
export default DisassociateFacesResponse;
