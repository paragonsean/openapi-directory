...
/**
 * The GroundTruthManifest model module.
 * @module model/GroundTruthManifest
 * @version 2016-06-27
 */
class GroundTruthManifest {
    /**
     * Constructs a new <code>GroundTruthManifest</code>.
     * The S3 bucket that contains an Amazon Sagemaker Ground Truth format manifest file. 
     * @alias module:model/GroundTruthManifest
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>GroundTruthManifest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroundTruthManifest} obj Optional instance to populate.
     * @return {module:model/GroundTruthManifest} The populated <code>GroundTruthManifest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroundTruthManifest();
    ...
    /**
     * Validates the JSON data with respect to <code>GroundTruthManifest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroundTruthManifest</code>.
     */
...
export default GroundTruthManifest;
