...
import CreateProjectVersionRequestOutputConfig from './CreateProjectVersionRequestOutputConfig';
import CreateProjectVersionRequestTestingData from './CreateProjectVersionRequestTestingData';
import CreateProjectVersionRequestTrainingData from './CreateProjectVersionRequestTrainingData';

/**
 * The CreateProjectVersionRequest model module.
 * @module model/CreateProjectVersionRequest
 * @version 2016-06-27
 */
class CreateProjectVersionRequest {
    /**
     * Constructs a new <code>CreateProjectVersionRequest</code>.
     * @alias module:model/CreateProjectVersionRequest
     * @param projectArn {String} 
     * @param versionName {String} 
     * @param outputConfig {module:model/CreateProjectVersionRequestOutputConfig} 
     */
    constructor(projectArn, versionName, outputConfig) { 
        
        CreateProjectVersionRequest.initialize(this, projectArn, versionName, outputConfig);
    }
     ...
     */
    static initialize(obj, projectArn, versionName, outputConfig) { 
    ...
    /**
     * Constructs a <code>CreateProjectVersionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProjectVersionRequest} obj Optional instance to populate.
     * @return {module:model/CreateProjectVersionRequest} The populated <code>CreateProjectVersionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProjectVersionRequest();
            ...
            if (data.hasOwnProperty('OutputConfig')) {
                obj['OutputConfig'] = CreateProjectVersionRequestOutputConfig.constructFromObject(data['OutputConfig']);
            }
            if (data.hasOwnProperty('TrainingData')) {
                obj['TrainingData'] = CreateProjectVersionRequestTrainingData.constructFromObject(data['TrainingData']);
            }
            if (data.hasOwnProperty('TestingData')) {
                obj['TestingData'] = CreateProjectVersionRequestTestingData.constructFromObject(data['TestingData']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProjectVersionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProjectVersionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateProjectVersionRequest.RequiredProperties) {
        ...
        if (data['OutputConfig']) { // data not null
          CreateProjectVersionRequestOutputConfig.validateJSON(data['OutputConfig']);
        }
        // validate the optional field `TrainingData`
        if (data['TrainingData']) { // data not null
          CreateProjectVersionRequestTrainingData.validateJSON(data['TrainingData']);
        }
        // validate the optional field `TestingData`
        if (data['TestingData']) { // data not null
          CreateProjectVersionRequestTestingData.validateJSON(data['TestingData']);
        }
...
CreateProjectVersionRequest.RequiredProperties = ["ProjectArn", "VersionName", "OutputConfig"];

/**
 * @member {String} ProjectArn
 */
CreateProjectVersionRequest.prototype['ProjectArn'] = undefined;

/**
 * @member {String} VersionName
 */
CreateProjectVersionRequest.prototype['VersionName'] = undefined;

/**
 * @member {module:model/CreateProjectVersionRequestOutputConfig} OutputConfig
 */
CreateProjectVersionRequest.prototype['OutputConfig'] = undefined;

/**
 * @member {module:model/CreateProjectVersionRequestTrainingData} TrainingData
 */
CreateProjectVersionRequest.prototype['TrainingData'] = undefined;

/**
 * @member {module:model/CreateProjectVersionRequestTestingData} TestingData
 */
CreateProjectVersionRequest.prototype['TestingData'] = undefined;

/**
 * @member {Object} Tags
 */
CreateProjectVersionRequest.prototype['Tags'] = undefined;

/**
 * @member {String} KmsKeyId
 */
CreateProjectVersionRequest.prototype['KmsKeyId'] = undefined;
...
export default CreateProjectVersionRequest;
