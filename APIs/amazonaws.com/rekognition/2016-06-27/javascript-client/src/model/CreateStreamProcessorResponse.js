...
/**
 * The CreateStreamProcessorResponse model module.
 * @module model/CreateStreamProcessorResponse
 * @version 2016-06-27
 */
class CreateStreamProcessorResponse {
    /**
     * Constructs a new <code>CreateStreamProcessorResponse</code>.
     * @alias module:model/CreateStreamProcessorResponse
     */
    constructor() { 
        
        CreateStreamProcessorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStreamProcessorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamProcessorResponse} obj Optional instance to populate.
     * @return {module:model/CreateStreamProcessorResponse} The populated <code>CreateStreamProcessorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamProcessorResponse();

            if (data.hasOwnProperty('StreamProcessorArn')) {
                obj['StreamProcessorArn'] = ApiClient.convertToType(data['StreamProcessorArn'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamProcessorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamProcessorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `StreamProcessorArn`
        if (data['StreamProcessorArn']) { // data not null
          String.validateJSON(data['StreamProcessorArn']);
        }
...
/**
 * @member {String} StreamProcessorArn
 */
CreateStreamProcessorResponse.prototype['StreamProcessorArn'] = undefined;
...
export default CreateStreamProcessorResponse;
