...
class Landmark {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], LandmarkType);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Type']) { // data not null
          LandmarkType.validateJSON(data['Type']);
        }
...
/**
 * @member {module:model/LandmarkType} Type
 */
 ...
 * @member {Number} X
 */
Landmark.prototype['X'] = undefined;

/**
 * @member {Number} Y
 */
Landmark.prototype['Y'] = undefined;
