...
/**
 * The StopProjectVersionRequest model module.
 * @module model/StopProjectVersionRequest
 * @version 2016-06-27
 */
class StopProjectVersionRequest {
    /**
     * Constructs a new <code>StopProjectVersionRequest</code>.
     * @alias module:model/StopProjectVersionRequest
     * @param projectVersionArn {String} 
     */
    constructor(projectVersionArn) { 
        
        StopProjectVersionRequest.initialize(this, projectVersionArn);
    }
     ...
     */
    static initialize(obj, projectVersionArn) { 
        obj['ProjectVersionArn'] = projectVersionArn;
    }

    /**
     * Constructs a <code>StopProjectVersionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopProjectVersionRequest} obj Optional instance to populate.
     * @return {module:model/StopProjectVersionRequest} The populated <code>StopProjectVersionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopProjectVersionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopProjectVersionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopProjectVersionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopProjectVersionRequest.RequiredProperties) {
...
StopProjectVersionRequest.RequiredProperties = ["ProjectVersionArn"];

/**
 * @member {String} ProjectVersionArn
 */
StopProjectVersionRequest.prototype['ProjectVersionArn'] = undefined;
...
export default StopProjectVersionRequest;
