...
/**
 * The LabelCategory model module.
 * @module model/LabelCategory
 * @version 2016-06-27
 */
class LabelCategory {
    /**
     * Constructs a new <code>LabelCategory</code>.
     * The category that applies to a given label.
     * @alias module:model/LabelCategory
     */
    constructor() { 
        
        LabelCategory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LabelCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LabelCategory} obj Optional instance to populate.
     * @return {module:model/LabelCategory} The populated <code>LabelCategory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LabelCategory();
    ...
    /**
     * Validates the JSON data with respect to <code>LabelCategory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LabelCategory</code>.
     */
 ...
 * @member {String} Name
 */
LabelCategory.prototype['Name'] = undefined;
