...
import CelebrityDetailBoundingBox from './CelebrityDetailBoundingBox';
import CelebrityDetailFace from './CelebrityDetailFace';
import GetCelebrityInfoResponseKnownGender from './GetCelebrityInfoResponseKnownGender';

/**
 * The CelebrityDetail model module.
 * @module model/CelebrityDetail
 * @version 2016-06-27
 */
class CelebrityDetail {
    /**
     * Constructs a new <code>CelebrityDetail</code>.
     * Information about a recognized celebrity.
     * @alias module:model/CelebrityDetail
     */
    constructor() { 
        
        CelebrityDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CelebrityDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CelebrityDetail} obj Optional instance to populate.
     * @return {module:model/CelebrityDetail} The populated <code>CelebrityDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CelebrityDetail();
            ...
            if (data.hasOwnProperty('BoundingBox')) {
                obj['BoundingBox'] = CelebrityDetailBoundingBox.constructFromObject(data['BoundingBox']);
            }
            if (data.hasOwnProperty('Face')) {
                obj['Face'] = CelebrityDetailFace.constructFromObject(data['Face']);
            }
            if (data.hasOwnProperty('KnownGender')) {
                obj['KnownGender'] = GetCelebrityInfoResponseKnownGender.constructFromObject(data['KnownGender']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CelebrityDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CelebrityDetail</code>.
     */
    static validateJSON(data) {
        ...
        if (data['BoundingBox']) { // data not null
          CelebrityDetailBoundingBox.validateJSON(data['BoundingBox']);
        }
        // validate the optional field `Face`
        if (data['Face']) { // data not null
          CelebrityDetailFace.validateJSON(data['Face']);
        }
        // validate the optional field `KnownGender`
        if (data['KnownGender']) { // data not null
          GetCelebrityInfoResponseKnownGender.validateJSON(data['KnownGender']);
        }
 ...
 * @member {Array} Urls
 */
CelebrityDetail.prototype['Urls'] = undefined;

/**
 * @member {String} Name
 */
CelebrityDetail.prototype['Name'] = undefined;

/**
 * @member {String} Id
 */
CelebrityDetail.prototype['Id'] = undefined;

/**
 * @member {Number} Confidence
 */
CelebrityDetail.prototype['Confidence'] = undefined;

/**
 * @member {module:model/CelebrityDetailBoundingBox} BoundingBox
 */
CelebrityDetail.prototype['BoundingBox'] = undefined;

/**
 * @member {module:model/CelebrityDetailFace} Face
 */
CelebrityDetail.prototype['Face'] = undefined;

/**
 * @member {module:model/GetCelebrityInfoResponseKnownGender} KnownGender
 */
CelebrityDetail.prototype['KnownGender'] = undefined;
