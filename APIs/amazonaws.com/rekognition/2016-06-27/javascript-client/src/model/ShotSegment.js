...
/**
 * The ShotSegment model module.
 * @module model/ShotSegment
 * @version 2016-06-27
 */
class ShotSegment {
    /**
     * Constructs a new <code>ShotSegment</code>.
     * Information about a shot detection segment detected in a video. For more information, see &lt;a&gt;SegmentDetection&lt;/a&gt;.
     * @alias module:model/ShotSegment
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ShotSegment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShotSegment} obj Optional instance to populate.
     * @return {module:model/ShotSegment} The populated <code>ShotSegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShotSegment();
    ...
    /**
     * Validates the JSON data with respect to <code>ShotSegment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShotSegment</code>.
     */
