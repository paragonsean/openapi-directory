...
/**
 * The DescribeCollectionRequest model module.
 * @module model/DescribeCollectionRequest
 * @version 2016-06-27
 */
class DescribeCollectionRequest {
    /**
     * Constructs a new <code>DescribeCollectionRequest</code>.
     * @alias module:model/DescribeCollectionRequest
     * @param collectionId {String} 
     */
    constructor(collectionId) { 
        
        DescribeCollectionRequest.initialize(this, collectionId);
    }
    ...
    /**
     * Constructs a <code>DescribeCollectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCollectionRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCollectionRequest} The populated <code>DescribeCollectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCollectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCollectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCollectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeCollectionRequest.RequiredProperties) {
...
DescribeCollectionRequest.RequiredProperties = ["CollectionId"];

/**
 * @member {String} CollectionId
 */
DescribeCollectionRequest.prototype['CollectionId'] = undefined;
...
export default DescribeCollectionRequest;
