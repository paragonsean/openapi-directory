...
/**
 * The StartTextDetectionFiltersWordFilter model module.
 * @module model/StartTextDetectionFiltersWordFilter
 * @version 2016-06-27
 */
class StartTextDetectionFiltersWordFilter {
    /**
     * Constructs a new <code>StartTextDetectionFiltersWordFilter</code>.
     * @alias module:model/StartTextDetectionFiltersWordFilter
     * @implements module:model/DetectionFilter
     */
    constructor() { 
        DetectionFilter.initialize(this);
        StartTextDetectionFiltersWordFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartTextDetectionFiltersWordFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTextDetectionFiltersWordFilter} obj Optional instance to populate.
     * @return {module:model/StartTextDetectionFiltersWordFilter} The populated <code>StartTextDetectionFiltersWordFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTextDetectionFiltersWordFilter();
            DetectionFilter.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StartTextDetectionFiltersWordFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTextDetectionFiltersWordFilter</code>.
     */
 ...
 */
StartTextDetectionFiltersWordFilter.prototype['MinConfidence'] = undefined;

/**
 * @member {Number} MinBoundingBoxHeight
 */
StartTextDetectionFiltersWordFilter.prototype['MinBoundingBoxHeight'] = undefined;

/**
 * @member {Number} MinBoundingBoxWidth
 */
StartTextDetectionFiltersWordFilter.prototype['MinBoundingBoxWidth'] = undefined;


// Implement DetectionFilter interface:
/**
 * @member {Number} MinConfidence
 */
...
export default StartTextDetectionFiltersWordFilter;
