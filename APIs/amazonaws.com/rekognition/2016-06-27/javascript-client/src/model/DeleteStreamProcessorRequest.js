...
/**
 * The DeleteStreamProcessorRequest model module.
 * @module model/DeleteStreamProcessorRequest
 * @version 2016-06-27
 */
class DeleteStreamProcessorRequest {
    /**
     * Constructs a new <code>DeleteStreamProcessorRequest</code>.
     * @alias module:model/DeleteStreamProcessorRequest
     * @param name {String} 
     */
    constructor(name) { 
        
        DeleteStreamProcessorRequest.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DeleteStreamProcessorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteStreamProcessorRequest} obj Optional instance to populate.
     * @return {module:model/DeleteStreamProcessorRequest} The populated <code>DeleteStreamProcessorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteStreamProcessorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteStreamProcessorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteStreamProcessorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteStreamProcessorRequest.RequiredProperties) {
...
DeleteStreamProcessorRequest.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
DeleteStreamProcessorRequest.prototype['Name'] = undefined;
...
export default DeleteStreamProcessorRequest;
