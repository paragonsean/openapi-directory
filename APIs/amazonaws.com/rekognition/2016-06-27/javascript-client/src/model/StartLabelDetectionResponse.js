...
/**
 * The StartLabelDetectionResponse model module.
 * @module model/StartLabelDetectionResponse
 * @version 2016-06-27
 */
class StartLabelDetectionResponse {
    /**
     * Constructs a new <code>StartLabelDetectionResponse</code>.
     * @alias module:model/StartLabelDetectionResponse
     */
    constructor() { 
        
        StartLabelDetectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartLabelDetectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartLabelDetectionResponse} obj Optional instance to populate.
     * @return {module:model/StartLabelDetectionResponse} The populated <code>StartLabelDetectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartLabelDetectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartLabelDetectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartLabelDetectionResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartLabelDetectionResponse.prototype['JobId'] = undefined;
...
export default StartLabelDetectionResponse;
