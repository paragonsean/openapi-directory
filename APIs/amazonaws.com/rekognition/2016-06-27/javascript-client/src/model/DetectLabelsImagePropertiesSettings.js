...
/**
 * The DetectLabelsImagePropertiesSettings model module.
 * @module model/DetectLabelsImagePropertiesSettings
 * @version 2016-06-27
 */
class DetectLabelsImagePropertiesSettings {
    /**
     * Constructs a new <code>DetectLabelsImagePropertiesSettings</code>.
     * Settings for the IMAGE_PROPERTIES feature type.
     * @alias module:model/DetectLabelsImagePropertiesSettings
     */
    constructor() { 
        
        DetectLabelsImagePropertiesSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsImagePropertiesSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImagePropertiesSettings} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImagePropertiesSettings} The populated <code>DetectLabelsImagePropertiesSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImagePropertiesSettings();

            if (data.hasOwnProperty('MaxDominantColors')) {
                obj['MaxDominantColors'] = ApiClient.convertToType(data['MaxDominantColors'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImagePropertiesSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImagePropertiesSettings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MaxDominantColors`
        if (data['MaxDominantColors']) { // data not null
          Number.validateJSON(data['MaxDominantColors']);
        }
...
/**
 * @member {Number} MaxDominantColors
 */
DetectLabelsImagePropertiesSettings.prototype['MaxDominantColors'] = undefined;
...
export default DetectLabelsImagePropertiesSettings;
