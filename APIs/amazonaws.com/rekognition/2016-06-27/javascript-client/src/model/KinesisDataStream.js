...
/**
 * The KinesisDataStream model module.
 * @module model/KinesisDataStream
 * @version 2016-06-27
 */
class KinesisDataStream {
    /**
     * Constructs a new <code>KinesisDataStream</code>.
     * The Kinesis data stream Amazon Rekognition to which the analysis results of a Amazon Rekognition stream processor are streamed. For more information, see CreateStreamProcessor in the Amazon Rekognition Developer Guide.
     * @alias module:model/KinesisDataStream
     */
    constructor() { 
        
        KinesisDataStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KinesisDataStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KinesisDataStream} obj Optional instance to populate.
     * @return {module:model/KinesisDataStream} The populated <code>KinesisDataStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KinesisDataStream();
    ...
    /**
     * Validates the JSON data with respect to <code>KinesisDataStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KinesisDataStream</code>.
     */
 ...
 * @member {String} Arn
 */
KinesisDataStream.prototype['Arn'] = undefined;
