...
/**
 * The CompareFacesRequestTargetImage model module.
 * @module model/CompareFacesRequestTargetImage
 * @version 2016-06-27
 */
class CompareFacesRequestTargetImage {
    /**
     * Constructs a new <code>CompareFacesRequestTargetImage</code>.
     * @alias module:model/CompareFacesRequestTargetImage
     * @implements module:model/Image
     */
    constructor() { 
        Image.initialize(this);
        CompareFacesRequestTargetImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompareFacesRequestTargetImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompareFacesRequestTargetImage} obj Optional instance to populate.
     * @return {module:model/CompareFacesRequestTargetImage} The populated <code>CompareFacesRequestTargetImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompareFacesRequestTargetImage();
    ...
    /**
     * Validates the JSON data with respect to <code>CompareFacesRequestTargetImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompareFacesRequestTargetImage</code>.
     */
 ...
 * @member {String} Bytes
 */
CompareFacesRequestTargetImage.prototype['Bytes'] = undefined;

/**
 * @member {module:model/ImageS3Object} S3Object
 */
CompareFacesRequestTargetImage.prototype['S3Object'] = undefined;
...
export default CompareFacesRequestTargetImage;
