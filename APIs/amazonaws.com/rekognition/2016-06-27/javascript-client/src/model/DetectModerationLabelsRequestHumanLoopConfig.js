...
/**
 * The DetectModerationLabelsRequestHumanLoopConfig model module.
 * @module model/DetectModerationLabelsRequestHumanLoopConfig
 * @version 2016-06-27
 */
class DetectModerationLabelsRequestHumanLoopConfig {
    /**
     * Constructs a new <code>DetectModerationLabelsRequestHumanLoopConfig</code>.
     * @alias module:model/DetectModerationLabelsRequestHumanLoopConfig
    ...
    constructor(humanLoopName, flowDefinitionArn) { 
        ...
        DetectModerationLabelsRequestHumanLoopConfig.initialize(this, humanLoopName, flowDefinitionArn);
    }
    ...
    /**
     * Constructs a <code>DetectModerationLabelsRequestHumanLoopConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectModerationLabelsRequestHumanLoopConfig} obj Optional instance to populate.
     * @return {module:model/DetectModerationLabelsRequestHumanLoopConfig} The populated <code>DetectModerationLabelsRequestHumanLoopConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectModerationLabelsRequestHumanLoopConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectModerationLabelsRequestHumanLoopConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectModerationLabelsRequestHumanLoopConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetectModerationLabelsRequestHumanLoopConfig.RequiredProperties) {
...
DetectModerationLabelsRequestHumanLoopConfig.RequiredProperties = ["HumanLoopName", "FlowDefinitionArn"];

/**
 * @member {String} HumanLoopName
 */
DetectModerationLabelsRequestHumanLoopConfig.prototype['HumanLoopName'] = undefined;

/**
 * @member {String} FlowDefinitionArn
 */
DetectModerationLabelsRequestHumanLoopConfig.prototype['FlowDefinitionArn'] = undefined;

/**
 * @member {module:model/HumanLoopConfigDataAttributes} DataAttributes
 */
DetectModerationLabelsRequestHumanLoopConfig.prototype['DataAttributes'] = undefined;
...
export default DetectModerationLabelsRequestHumanLoopConfig;
