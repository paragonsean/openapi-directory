...
/**
 * The FaceSearchSettings model module.
 * @module model/FaceSearchSettings
 * @version 2016-06-27
 */
class FaceSearchSettings {
    /**
     * Constructs a new <code>FaceSearchSettings</code>.
     ...
     * @alias module:model/FaceSearchSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FaceSearchSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceSearchSettings} obj Optional instance to populate.
     * @return {module:model/FaceSearchSettings} The populated <code>FaceSearchSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceSearchSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>FaceSearchSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceSearchSettings</code>.
     */
...
export default FaceSearchSettings;
