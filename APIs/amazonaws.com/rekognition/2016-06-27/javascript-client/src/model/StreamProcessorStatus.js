...
* @readonly
*/
export default class StreamProcessorStatus {
    ...
    /**
    * Returns a <code>StreamProcessorStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StreamProcessorStatus} The enum <code>StreamProcessorStatus</code> value.
    */
