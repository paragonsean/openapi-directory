...
/**
 * The StreamProcessorNotificationChannel model module.
 * @module model/StreamProcessorNotificationChannel
 * @version 2016-06-27
 */
class StreamProcessorNotificationChannel {
    /**
     * Constructs a new <code>StreamProcessorNotificationChannel</code>.
     ...
     * @alias module:model/StreamProcessorNotificationChannel
     * @param sNSTopicArn {String} 
     */
    constructor(sNSTopicArn) { 
        
        StreamProcessorNotificationChannel.initialize(this, sNSTopicArn);
    }
    ...
    /**
     * Constructs a <code>StreamProcessorNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StreamProcessorNotificationChannel} The populated <code>StreamProcessorNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StreamProcessorNotificationChannel.RequiredProperties) {
...
StreamProcessorNotificationChannel.RequiredProperties = ["SNSTopicArn"];

/**
 * @member {String} SNSTopicArn
 */
StreamProcessorNotificationChannel.prototype['SNSTopicArn'] = undefined;
...
export default StreamProcessorNotificationChannel;
