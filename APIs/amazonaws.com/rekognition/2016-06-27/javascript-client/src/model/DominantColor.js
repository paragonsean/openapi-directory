...
/**
 * The DominantColor model module.
 * @module model/DominantColor
 * @version 2016-06-27
 */
class DominantColor {
    /**
     * Constructs a new <code>DominantColor</code>.
     * A description of the dominant colors in an image.
     * @alias module:model/DominantColor
     */
    constructor() { 
        
        DominantColor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DominantColor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DominantColor} obj Optional instance to populate.
     * @return {module:model/DominantColor} The populated <code>DominantColor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DominantColor();
            ...
            if (data.hasOwnProperty('HexCode')) {
                obj['HexCode'] = ApiClient.convertToType(data['HexCode'], 'String');
            }
            if (data.hasOwnProperty('CSSColor')) {
                obj['CSSColor'] = ApiClient.convertToType(data['CSSColor'], 'String');
            }
            if (data.hasOwnProperty('SimplifiedColor')) {
                obj['SimplifiedColor'] = ApiClient.convertToType(data['SimplifiedColor'], 'String');
            }
            if (data.hasOwnProperty('PixelPercent')) {
                obj['PixelPercent'] = ApiClient.convertToType(data['PixelPercent'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DominantColor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DominantColor</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Red`
        if (data['Red']) { // data not null
          Number.validateJSON(data['Red']);
        }
        // validate the optional field `Blue`
        if (data['Blue']) { // data not null
          Number.validateJSON(data['Blue']);
        }
        // validate the optional field `Green`
        if (data['Green']) { // data not null
          Number.validateJSON(data['Green']);
        }
        // validate the optional field `HexCode`
        if (data['HexCode']) { // data not null
          String.validateJSON(data['HexCode']);
        }
        // validate the optional field `CSSColor`
        if (data['CSSColor']) { // data not null
          String.validateJSON(data['CSSColor']);
        }
        // validate the optional field `SimplifiedColor`
        if (data['SimplifiedColor']) { // data not null
          String.validateJSON(data['SimplifiedColor']);
        }
        // validate the optional field `PixelPercent`
        if (data['PixelPercent']) { // data not null
          Number.validateJSON(data['PixelPercent']);
        }
 ...
 * @member {Number} Red
 */
DominantColor.prototype['Red'] = undefined;

/**
 * @member {Number} Blue
 */
DominantColor.prototype['Blue'] = undefined;

/**
 * @member {Number} Green
 */
DominantColor.prototype['Green'] = undefined;

/**
 * @member {String} HexCode
 */
DominantColor.prototype['HexCode'] = undefined;

/**
 * @member {String} CSSColor
 */
DominantColor.prototype['CSSColor'] = undefined;

/**
 * @member {String} SimplifiedColor
 */
DominantColor.prototype['SimplifiedColor'] = undefined;

/**
 * @member {Number} PixelPercent
 */
DominantColor.prototype['PixelPercent'] = undefined;
