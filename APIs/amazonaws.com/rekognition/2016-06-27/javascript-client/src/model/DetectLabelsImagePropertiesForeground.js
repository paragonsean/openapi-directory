...
import DetectLabelsImageForegroundQuality from './DetectLabelsImageForegroundQuality';

/**
 * The DetectLabelsImagePropertiesForeground model module.
 * @module model/DetectLabelsImagePropertiesForeground
 * @version 2016-06-27
 */
class DetectLabelsImagePropertiesForeground {
    /**
     * Constructs a new <code>DetectLabelsImagePropertiesForeground</code>.
     * @alias module:model/DetectLabelsImagePropertiesForeground
     * @implements module:model/DetectLabelsImageForeground
     */
    constructor() { 
        DetectLabelsImageForeground.initialize(this);
        DetectLabelsImagePropertiesForeground.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsImagePropertiesForeground</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImagePropertiesForeground} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImagePropertiesForeground} The populated <code>DetectLabelsImagePropertiesForeground</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImagePropertiesForeground();
            DetectLabelsImageForeground.constructFromObject(data, obj);

            if (data.hasOwnProperty('Quality')) {
                obj['Quality'] = DetectLabelsImageForegroundQuality.constructFromObject(data['Quality']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImagePropertiesForeground</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImagePropertiesForeground</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Quality`
        if (data['Quality']) { // data not null
          DetectLabelsImageForegroundQuality.validateJSON(data['Quality']);
        }
...
/**
 * @member {module:model/DetectLabelsImageForegroundQuality} Quality
 */
DetectLabelsImagePropertiesForeground.prototype['Quality'] = undefined;

/**
 * @member {Array} DominantColors
 */
DetectLabelsImagePropertiesForeground.prototype['DominantColors'] = undefined;


// Implement DetectLabelsImageForeground interface:
/**
 * @member {module:model/DetectLabelsImageForegroundQuality} Quality
 */
DetectLabelsImageForeground.prototype['Quality'] = undefined;
/**
 * @member {Array} DominantColors
 */
DetectLabelsImageForeground.prototype['DominantColors'] = undefined;




export default DetectLabelsImagePropertiesForeground;
