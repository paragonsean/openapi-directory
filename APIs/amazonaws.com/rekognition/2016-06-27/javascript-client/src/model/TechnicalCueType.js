...
* @readonly
*/
export default class TechnicalCueType {
    ...
    /**
    * Returns a <code>TechnicalCueType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TechnicalCueType} The enum <code>TechnicalCueType</code> value.
    */
