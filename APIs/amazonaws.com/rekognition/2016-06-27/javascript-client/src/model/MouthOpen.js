...
/**
 * The MouthOpen model module.
 * @module model/MouthOpen
 * @version 2016-06-27
 */
class MouthOpen {
    /**
     * Constructs a new <code>MouthOpen</code>.
     * Indicates whether or not the mouth on the face is open, and the confidence level in the determination.
     * @alias module:model/MouthOpen
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MouthOpen</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MouthOpen} obj Optional instance to populate.
     * @return {module:model/MouthOpen} The populated <code>MouthOpen</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MouthOpen();
    ...
    /**
     * Validates the JSON data with respect to <code>MouthOpen</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MouthOpen</code>.
     */
