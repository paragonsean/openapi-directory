...
* @readonly
*/
export default class KnownGenderType {
    ...
    /**
    * Returns a <code>KnownGenderType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KnownGenderType} The enum <code>KnownGenderType</code> value.
    */
