...
import PersonMatchPerson from './PersonMatchPerson';

/**
 * The PersonMatch model module.
 * @module model/PersonMatch
 * @version 2016-06-27
 */
class PersonMatch {
    /**
     * Constructs a new <code>PersonMatch</code>.
     ...
     * @alias module:model/PersonMatch
     */
    constructor() { 
        
        PersonMatch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PersonMatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PersonMatch} obj Optional instance to populate.
     * @return {module:model/PersonMatch} The populated <code>PersonMatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonMatch();

            if (data.hasOwnProperty('Timestamp')) {
                obj['Timestamp'] = ApiClient.convertToType(data['Timestamp'], 'Number');
            }
            if (data.hasOwnProperty('Person')) {
                obj['Person'] = PersonMatchPerson.constructFromObject(data['Person']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PersonMatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PersonMatch</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Person']) { // data not null
          PersonMatchPerson.validateJSON(data['Person']);
        }
 ...
 */
PersonMatch.prototype['Timestamp'] = undefined;

/**
 * @member {module:model/PersonMatchPerson} Person
 */
PersonMatch.prototype['Person'] = undefined;

/**
 * @member {Array} FaceMatches
 */
PersonMatch.prototype['FaceMatches'] = undefined;
