...
/**
 * The UnsuccessfulFaceDeletion model module.
 * @module model/UnsuccessfulFaceDeletion
 * @version 2016-06-27
 */
class UnsuccessfulFaceDeletion {
    /**
     * Constructs a new <code>UnsuccessfulFaceDeletion</code>.
     * Contains metadata like FaceId, UserID, and Reasons, for a face that was unsuccessfully deleted.
     * @alias module:model/UnsuccessfulFaceDeletion
     */
    constructor() { 
        
        UnsuccessfulFaceDeletion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnsuccessfulFaceDeletion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnsuccessfulFaceDeletion} obj Optional instance to populate.
     * @return {module:model/UnsuccessfulFaceDeletion} The populated <code>UnsuccessfulFaceDeletion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnsuccessfulFaceDeletion();
    ...
    /**
     * Validates the JSON data with respect to <code>UnsuccessfulFaceDeletion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnsuccessfulFaceDeletion</code>.
     */
 ...
 */
UnsuccessfulFaceDeletion.prototype['FaceId'] = undefined;

/**
 * @member {String} UserId
 */
UnsuccessfulFaceDeletion.prototype['UserId'] = undefined;

/**
 * @member {Array} Reasons
 */
UnsuccessfulFaceDeletion.prototype['Reasons'] = undefined;
...
export default UnsuccessfulFaceDeletion;
