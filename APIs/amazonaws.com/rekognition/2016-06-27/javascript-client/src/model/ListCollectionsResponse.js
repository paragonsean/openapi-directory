...
class ListCollectionsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CollectionIds')) {
                obj['CollectionIds'] = ApiClient.convertToType(data['CollectionIds'], Array);
            }
            if (data.hasOwnProperty('NextToken')) {
                obj['NextToken'] = ApiClient.convertToType(data['NextToken'], 'String');
            }
            if (data.hasOwnProperty('FaceModelVersions')) {
                obj['FaceModelVersions'] = ApiClient.convertToType(data['FaceModelVersions'], Array);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['CollectionIds']) { // data not null
          Array.validateJSON(data['CollectionIds']);
        }
        ...
        if (data['FaceModelVersions']) { // data not null
          Array.validateJSON(data['FaceModelVersions']);
        }
 ...
 */
ListCollectionsResponse.prototype['CollectionIds'] = undefined;
...
/**
 * @member {Array} FaceModelVersions
 */
ListCollectionsResponse.prototype['FaceModelVersions'] = undefined;
