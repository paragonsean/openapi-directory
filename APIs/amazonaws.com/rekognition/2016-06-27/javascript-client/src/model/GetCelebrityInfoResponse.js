...
/**
 * The GetCelebrityInfoResponse model module.
 * @module model/GetCelebrityInfoResponse
 * @version 2016-06-27
 */
class GetCelebrityInfoResponse {
    /**
     * Constructs a new <code>GetCelebrityInfoResponse</code>.
     * @alias module:model/GetCelebrityInfoResponse
     */
    constructor() { 
        
        GetCelebrityInfoResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCelebrityInfoResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCelebrityInfoResponse} obj Optional instance to populate.
     * @return {module:model/GetCelebrityInfoResponse} The populated <code>GetCelebrityInfoResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCelebrityInfoResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCelebrityInfoResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCelebrityInfoResponse</code>.
     */
 ...
 * @member {Array} Urls
 */
GetCelebrityInfoResponse.prototype['Urls'] = undefined;

/**
 * @member {String} Name
 */
GetCelebrityInfoResponse.prototype['Name'] = undefined;

/**
 * @member {module:model/GetCelebrityInfoResponseKnownGender} KnownGender
 */
GetCelebrityInfoResponse.prototype['KnownGender'] = undefined;
...
export default GetCelebrityInfoResponse;
