...
/**
 * The DescribeStreamProcessorResponseOutput model module.
 * @module model/DescribeStreamProcessorResponseOutput
 * @version 2016-06-27
 */
class DescribeStreamProcessorResponseOutput {
    /**
     * Constructs a new <code>DescribeStreamProcessorResponseOutput</code>.
     * @alias module:model/DescribeStreamProcessorResponseOutput
     * @implements module:model/StreamProcessorOutput
     */
    constructor() { 
        StreamProcessorOutput.initialize(this);
        DescribeStreamProcessorResponseOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeStreamProcessorResponseOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeStreamProcessorResponseOutput} obj Optional instance to populate.
     * @return {module:model/DescribeStreamProcessorResponseOutput} The populated <code>DescribeStreamProcessorResponseOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeStreamProcessorResponseOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeStreamProcessorResponseOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeStreamProcessorResponseOutput</code>.
     */
 ...
 */
DescribeStreamProcessorResponseOutput.prototype['KinesisDataStream'] = undefined;

/**
 * @member {module:model/StreamProcessorOutputS3Destination} S3Destination
 */
DescribeStreamProcessorResponseOutput.prototype['S3Destination'] = undefined;
...
export default DescribeStreamProcessorResponseOutput;
