...
/**
 * The CustomLabelGeometry model module.
 * @module model/CustomLabelGeometry
 * @version 2016-06-27
 */
class CustomLabelGeometry {
    /**
     * Constructs a new <code>CustomLabelGeometry</code>.
     * @alias module:model/CustomLabelGeometry
     * @implements module:model/Geometry
     */
    constructor() { 
        Geometry.initialize(this);
        CustomLabelGeometry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomLabelGeometry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomLabelGeometry} obj Optional instance to populate.
     * @return {module:model/CustomLabelGeometry} The populated <code>CustomLabelGeometry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomLabelGeometry();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomLabelGeometry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomLabelGeometry</code>.
     */
 ...
 */
CustomLabelGeometry.prototype['BoundingBox'] = undefined;

/**
 * @member {Array} Polygon
 */
CustomLabelGeometry.prototype['Polygon'] = undefined;
...
export default CustomLabelGeometry;
