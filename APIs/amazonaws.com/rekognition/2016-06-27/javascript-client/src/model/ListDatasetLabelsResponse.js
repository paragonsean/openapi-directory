...
/**
 * The ListDatasetLabelsResponse model module.
 * @module model/ListDatasetLabelsResponse
 * @version 2016-06-27
 */
class ListDatasetLabelsResponse {
    /**
     * Constructs a new <code>ListDatasetLabelsResponse</code>.
     * @alias module:model/ListDatasetLabelsResponse
     */
    constructor() { 
        
        ListDatasetLabelsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDatasetLabelsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDatasetLabelsResponse} obj Optional instance to populate.
     * @return {module:model/ListDatasetLabelsResponse} The populated <code>ListDatasetLabelsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDatasetLabelsResponse();

            if (data.hasOwnProperty('DatasetLabelDescriptions')) {
                obj['DatasetLabelDescriptions'] = ApiClient.convertToType(data['DatasetLabelDescriptions'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListDatasetLabelsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDatasetLabelsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DatasetLabelDescriptions`
        if (data['DatasetLabelDescriptions']) { // data not null
          Array.validateJSON(data['DatasetLabelDescriptions']);
        }
...
/**
 * @member {Array} DatasetLabelDescriptions
 */
ListDatasetLabelsResponse.prototype['DatasetLabelDescriptions'] = undefined;

/**
 * @member {String} NextToken
 */
ListDatasetLabelsResponse.prototype['NextToken'] = undefined;
...
export default ListDatasetLabelsResponse;
