...
/**
 * The StartCelebrityRecognitionRequestVideo model module.
 * @module model/StartCelebrityRecognitionRequestVideo
 * @version 2016-06-27
 */
class StartCelebrityRecognitionRequestVideo {
    /**
     * Constructs a new <code>StartCelebrityRecognitionRequestVideo</code>.
     * @alias module:model/StartCelebrityRecognitionRequestVideo
     * @implements module:model/Video
     */
    constructor() { 
        Video.initialize(this);
        StartCelebrityRecognitionRequestVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartCelebrityRecognitionRequestVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartCelebrityRecognitionRequestVideo} obj Optional instance to populate.
     * @return {module:model/StartCelebrityRecognitionRequestVideo} The populated <code>StartCelebrityRecognitionRequestVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartCelebrityRecognitionRequestVideo();
    ...
    /**
     * Validates the JSON data with respect to <code>StartCelebrityRecognitionRequestVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartCelebrityRecognitionRequestVideo</code>.
     */
 ...
 */
StartCelebrityRecognitionRequestVideo.prototype['S3Object'] = undefined;
...
export default StartCelebrityRecognitionRequestVideo;
