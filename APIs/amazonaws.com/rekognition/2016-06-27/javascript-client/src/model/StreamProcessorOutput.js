...
/**
 * The StreamProcessorOutput model module.
 * @module model/StreamProcessorOutput
 * @version 2016-06-27
 */
class StreamProcessorOutput {
    /**
     * Constructs a new <code>StreamProcessorOutput</code>.
     * Information about the Amazon Kinesis Data Streams stream to which a Amazon Rekognition Video stream processor streams the results of a video analysis. For more information, see CreateStreamProcessor in the Amazon Rekognition Developer Guide.
     * @alias module:model/StreamProcessorOutput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamProcessorOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorOutput} obj Optional instance to populate.
     * @return {module:model/StreamProcessorOutput} The populated <code>StreamProcessorOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorOutput</code>.
     */
...
export default StreamProcessorOutput;
