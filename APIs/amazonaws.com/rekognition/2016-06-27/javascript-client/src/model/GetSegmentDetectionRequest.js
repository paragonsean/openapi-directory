...
/**
 * The GetSegmentDetectionRequest model module.
 * @module model/GetSegmentDetectionRequest
 * @version 2016-06-27
 */
class GetSegmentDetectionRequest {
    /**
     * Constructs a new <code>GetSegmentDetectionRequest</code>.
     * @alias module:model/GetSegmentDetectionRequest
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetSegmentDetectionRequest.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetSegmentDetectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSegmentDetectionRequest} obj Optional instance to populate.
     * @return {module:model/GetSegmentDetectionRequest} The populated <code>GetSegmentDetectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSegmentDetectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSegmentDetectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSegmentDetectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetSegmentDetectionRequest.RequiredProperties) {
...
GetSegmentDetectionRequest.RequiredProperties = ["JobId"];

/**
 * @member {String} JobId
 */
GetSegmentDetectionRequest.prototype['JobId'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetSegmentDetectionRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetSegmentDetectionRequest.prototype['NextToken'] = undefined;
...
export default GetSegmentDetectionRequest;
