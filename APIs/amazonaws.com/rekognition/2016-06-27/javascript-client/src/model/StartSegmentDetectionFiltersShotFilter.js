...
/**
 * The StartSegmentDetectionFiltersShotFilter model module.
 * @module model/StartSegmentDetectionFiltersShotFilter
 * @version 2016-06-27
 */
class StartSegmentDetectionFiltersShotFilter {
    /**
     * Constructs a new <code>StartSegmentDetectionFiltersShotFilter</code>.
     * @alias module:model/StartSegmentDetectionFiltersShotFilter
     * @implements module:model/StartShotDetectionFilter
     */
    constructor() { 
        StartShotDetectionFilter.initialize(this);
        StartSegmentDetectionFiltersShotFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartSegmentDetectionFiltersShotFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSegmentDetectionFiltersShotFilter} obj Optional instance to populate.
     * @return {module:model/StartSegmentDetectionFiltersShotFilter} The populated <code>StartSegmentDetectionFiltersShotFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSegmentDetectionFiltersShotFilter();
            StartShotDetectionFilter.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StartSegmentDetectionFiltersShotFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSegmentDetectionFiltersShotFilter</code>.
     */
 ...
 */
StartSegmentDetectionFiltersShotFilter.prototype['MinSegmentConfidence'] = undefined;


// Implement StartShotDetectionFilter interface:
/**
 * @member {Number} MinSegmentConfidence
 */
StartShotDetectionFilter.prototype['MinSegmentConfidence'] = undefined;




export default StartSegmentDetectionFiltersShotFilter;
