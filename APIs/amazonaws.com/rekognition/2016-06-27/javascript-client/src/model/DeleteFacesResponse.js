...
/**
 * The DeleteFacesResponse model module.
 * @module model/DeleteFacesResponse
 * @version 2016-06-27
 */
class DeleteFacesResponse {
    /**
     * Constructs a new <code>DeleteFacesResponse</code>.
     * @alias module:model/DeleteFacesResponse
     */
    constructor() { 
        
        DeleteFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFacesResponse} obj Optional instance to populate.
     * @return {module:model/DeleteFacesResponse} The populated <code>DeleteFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFacesResponse();

            if (data.hasOwnProperty('DeletedFaces')) {
                obj['DeletedFaces'] = ApiClient.convertToType(data['DeletedFaces'], Array);
            }
            if (data.hasOwnProperty('UnsuccessfulFaceDeletions')) {
                obj['UnsuccessfulFaceDeletions'] = ApiClient.convertToType(data['UnsuccessfulFaceDeletions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFacesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DeletedFaces`
        if (data['DeletedFaces']) { // data not null
          Array.validateJSON(data['DeletedFaces']);
        }
        // validate the optional field `UnsuccessfulFaceDeletions`
        if (data['UnsuccessfulFaceDeletions']) { // data not null
          Array.validateJSON(data['UnsuccessfulFaceDeletions']);
        }
...
/**
 * @member {Array} DeletedFaces
 */
DeleteFacesResponse.prototype['DeletedFaces'] = undefined;

/**
 * @member {Array} UnsuccessfulFaceDeletions
 */
DeleteFacesResponse.prototype['UnsuccessfulFaceDeletions'] = undefined;
...
export default DeleteFacesResponse;
