...
/**
 * The StartFaceDetectionRequestNotificationChannel model module.
 * @module model/StartFaceDetectionRequestNotificationChannel
 * @version 2016-06-27
 */
class StartFaceDetectionRequestNotificationChannel {
    /**
     * Constructs a new <code>StartFaceDetectionRequestNotificationChannel</code>.
     * @alias module:model/StartFaceDetectionRequestNotificationChannel
    ...
    constructor(sNSTopicArn, roleArn) { 
        ...
        StartFaceDetectionRequestNotificationChannel.initialize(this, sNSTopicArn, roleArn);
    }
    ...
    /**
     * Constructs a <code>StartFaceDetectionRequestNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceDetectionRequestNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StartFaceDetectionRequestNotificationChannel} The populated <code>StartFaceDetectionRequestNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceDetectionRequestNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceDetectionRequestNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceDetectionRequestNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartFaceDetectionRequestNotificationChannel.RequiredProperties) {
...
StartFaceDetectionRequestNotificationChannel.RequiredProperties = ["SNSTopicArn", "RoleArn"];

/**
 * @member {String} SNSTopicArn
 */
StartFaceDetectionRequestNotificationChannel.prototype['SNSTopicArn'] = undefined;

/**
 * @member {String} RoleArn
 */
StartFaceDetectionRequestNotificationChannel.prototype['RoleArn'] = undefined;
...
export default StartFaceDetectionRequestNotificationChannel;
