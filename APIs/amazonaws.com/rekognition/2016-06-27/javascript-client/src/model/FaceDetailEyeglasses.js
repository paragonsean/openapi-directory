...
/**
 * The FaceDetailEyeglasses model module.
 * @module model/FaceDetailEyeglasses
 * @version 2016-06-27
 */
class FaceDetailEyeglasses {
    /**
     * Constructs a new <code>FaceDetailEyeglasses</code>.
     * @alias module:model/FaceDetailEyeglasses
     * @implements module:model/Eyeglasses
     */
    constructor() { 
        Eyeglasses.initialize(this);
        FaceDetailEyeglasses.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FaceDetailEyeglasses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FaceDetailEyeglasses} obj Optional instance to populate.
     * @return {module:model/FaceDetailEyeglasses} The populated <code>FaceDetailEyeglasses</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FaceDetailEyeglasses();
            Eyeglasses.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>FaceDetailEyeglasses</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FaceDetailEyeglasses</code>.
     */
 ...
 */
FaceDetailEyeglasses.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
FaceDetailEyeglasses.prototype['Confidence'] = undefined;


// Implement Eyeglasses interface:
/**
 * @member {Boolean} Value
 */
Eyeglasses.prototype['Value'] = undefined;
/**
 * @member {Number} Confidence
 */
Eyeglasses.prototype['Confidence'] = undefined;




export default FaceDetailEyeglasses;
