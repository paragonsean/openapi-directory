...
/**
 * The StartContentModerationResponse model module.
 * @module model/StartContentModerationResponse
 * @version 2016-06-27
 */
class StartContentModerationResponse {
    /**
     * Constructs a new <code>StartContentModerationResponse</code>.
     * @alias module:model/StartContentModerationResponse
     */
    constructor() { 
        
        StartContentModerationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartContentModerationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartContentModerationResponse} obj Optional instance to populate.
     * @return {module:model/StartContentModerationResponse} The populated <code>StartContentModerationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartContentModerationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartContentModerationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartContentModerationResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartContentModerationResponse.prototype['JobId'] = undefined;
...
export default StartContentModerationResponse;
