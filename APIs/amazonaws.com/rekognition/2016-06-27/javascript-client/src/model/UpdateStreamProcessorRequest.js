...
import CreateStreamProcessorRequestDataSharingPreference from './CreateStreamProcessorRequestDataSharingPreference';
import UpdateStreamProcessorRequestSettingsForUpdate from './UpdateStreamProcessorRequestSettingsForUpdate';

/**
 * The UpdateStreamProcessorRequest model module.
 * @module model/UpdateStreamProcessorRequest
 * @version 2016-06-27
 */
class UpdateStreamProcessorRequest {
    /**
     * Constructs a new <code>UpdateStreamProcessorRequest</code>.
     * @alias module:model/UpdateStreamProcessorRequest
     * @param name {String} 
     */
    constructor(name) { 
        
        UpdateStreamProcessorRequest.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>UpdateStreamProcessorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateStreamProcessorRequest} obj Optional instance to populate.
     * @return {module:model/UpdateStreamProcessorRequest} The populated <code>UpdateStreamProcessorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateStreamProcessorRequest();

            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], 'String');
            }
            if (data.hasOwnProperty('SettingsForUpdate')) {
                obj['SettingsForUpdate'] = UpdateStreamProcessorRequestSettingsForUpdate.constructFromObject(data['SettingsForUpdate']);
            }
            if (data.hasOwnProperty('RegionsOfInterestForUpdate')) {
                obj['RegionsOfInterestForUpdate'] = ApiClient.convertToType(data['RegionsOfInterestForUpdate'], Array);
            }
            if (data.hasOwnProperty('DataSharingPreferenceForUpdate')) {
                obj['DataSharingPreferenceForUpdate'] = CreateStreamProcessorRequestDataSharingPreference.constructFromObject(data['DataSharingPreferenceForUpdate']);
            }
            if (data.hasOwnProperty('ParametersToDelete')) {
                obj['ParametersToDelete'] = ApiClient.convertToType(data['ParametersToDelete'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateStreamProcessorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateStreamProcessorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateStreamProcessorRequest.RequiredProperties) {
        ...
        if (data['SettingsForUpdate']) { // data not null
          UpdateStreamProcessorRequestSettingsForUpdate.validateJSON(data['SettingsForUpdate']);
        }
        // validate the optional field `RegionsOfInterestForUpdate`
        if (data['RegionsOfInterestForUpdate']) { // data not null
          Array.validateJSON(data['RegionsOfInterestForUpdate']);
        }
        // validate the optional field `DataSharingPreferenceForUpdate`
        if (data['DataSharingPreferenceForUpdate']) { // data not null
          CreateStreamProcessorRequestDataSharingPreference.validateJSON(data['DataSharingPreferenceForUpdate']);
        }
        // validate the optional field `ParametersToDelete`
        if (data['ParametersToDelete']) { // data not null
          Array.validateJSON(data['ParametersToDelete']);
        }
...
UpdateStreamProcessorRequest.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
UpdateStreamProcessorRequest.prototype['Name'] = undefined;

/**
 * @member {module:model/UpdateStreamProcessorRequestSettingsForUpdate} SettingsForUpdate
 */
UpdateStreamProcessorRequest.prototype['SettingsForUpdate'] = undefined;

/**
 * @member {Array} RegionsOfInterestForUpdate
 */
UpdateStreamProcessorRequest.prototype['RegionsOfInterestForUpdate'] = undefined;

/**
 * @member {module:model/CreateStreamProcessorRequestDataSharingPreference} DataSharingPreferenceForUpdate
 */
UpdateStreamProcessorRequest.prototype['DataSharingPreferenceForUpdate'] = undefined;

/**
 * @member {Array} ParametersToDelete
 */
UpdateStreamProcessorRequest.prototype['ParametersToDelete'] = undefined;
...
export default UpdateStreamProcessorRequest;
