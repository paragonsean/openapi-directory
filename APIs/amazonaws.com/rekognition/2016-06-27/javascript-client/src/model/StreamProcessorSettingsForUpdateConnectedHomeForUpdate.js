...
/**
 * The StreamProcessorSettingsForUpdateConnectedHomeForUpdate model module.
 * @module model/StreamProcessorSettingsForUpdateConnectedHomeForUpdate
 * @version 2016-06-27
 */
class StreamProcessorSettingsForUpdateConnectedHomeForUpdate {
    /**
     * Constructs a new <code>StreamProcessorSettingsForUpdateConnectedHomeForUpdate</code>.
     * @alias module:model/StreamProcessorSettingsForUpdateConnectedHomeForUpdate
     * @implements module:model/ConnectedHomeSettingsForUpdate
     */
    constructor() { 
        ConnectedHomeSettingsForUpdate.initialize(this);
        StreamProcessorSettingsForUpdateConnectedHomeForUpdate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamProcessorSettingsForUpdateConnectedHomeForUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorSettingsForUpdateConnectedHomeForUpdate} obj Optional instance to populate.
     * @return {module:model/StreamProcessorSettingsForUpdateConnectedHomeForUpdate} The populated <code>StreamProcessorSettingsForUpdateConnectedHomeForUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorSettingsForUpdateConnectedHomeForUpdate();
            ConnectedHomeSettingsForUpdate.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorSettingsForUpdateConnectedHomeForUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorSettingsForUpdateConnectedHomeForUpdate</code>.
     */
 ...
 * @member {Array} Labels
 */
StreamProcessorSettingsForUpdateConnectedHomeForUpdate.prototype['Labels'] = undefined;

/**
 * @member {Number} MinConfidence
 */
StreamProcessorSettingsForUpdateConnectedHomeForUpdate.prototype['MinConfidence'] = undefined;


// Implement ConnectedHomeSettingsForUpdate interface:
/**
 * @member {Array} Labels
 */
ConnectedHomeSettingsForUpdate.prototype['Labels'] = undefined;
/**
 * @member {Number} MinConfidence
 */
ConnectedHomeSettingsForUpdate.prototype['MinConfidence'] = undefined;




export default StreamProcessorSettingsForUpdateConnectedHomeForUpdate;
