...
/**
 * The GetFaceDetectionResponseVideoMetadata model module.
 * @module model/GetFaceDetectionResponseVideoMetadata
 * @version 2016-06-27
 */
class GetFaceDetectionResponseVideoMetadata {
    /**
     * Constructs a new <code>GetFaceDetectionResponseVideoMetadata</code>.
     * @alias module:model/GetFaceDetectionResponseVideoMetadata
     * @implements module:model/VideoMetadata
     */
    constructor() { 
        VideoMetadata.initialize(this);
        GetFaceDetectionResponseVideoMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFaceDetectionResponseVideoMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFaceDetectionResponseVideoMetadata} obj Optional instance to populate.
     * @return {module:model/GetFaceDetectionResponseVideoMetadata} The populated <code>GetFaceDetectionResponseVideoMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFaceDetectionResponseVideoMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFaceDetectionResponseVideoMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFaceDetectionResponseVideoMetadata</code>.
     */
 ...
 * @member {String} Codec
 */
GetFaceDetectionResponseVideoMetadata.prototype['Codec'] = undefined;

/**
 * @member {Number} DurationMillis
 */
GetFaceDetectionResponseVideoMetadata.prototype['DurationMillis'] = undefined;

/**
 * @member {String} Format
 */
GetFaceDetectionResponseVideoMetadata.prototype['Format'] = undefined;

/**
 * @member {Number} FrameRate
 */
GetFaceDetectionResponseVideoMetadata.prototype['FrameRate'] = undefined;

/**
 * @member {Number} FrameHeight
 */
GetFaceDetectionResponseVideoMetadata.prototype['FrameHeight'] = undefined;

/**
 * @member {Number} FrameWidth
 */
GetFaceDetectionResponseVideoMetadata.prototype['FrameWidth'] = undefined;

/**
 * @member {module:model/VideoColorRange} ColorRange
 */
GetFaceDetectionResponseVideoMetadata.prototype['ColorRange'] = undefined;
...
export default GetFaceDetectionResponseVideoMetadata;
