...
/**
 * The StartTextDetectionResponse model module.
 * @module model/StartTextDetectionResponse
 * @version 2016-06-27
 */
class StartTextDetectionResponse {
    /**
     * Constructs a new <code>StartTextDetectionResponse</code>.
     * @alias module:model/StartTextDetectionResponse
     */
    constructor() { 
        
        StartTextDetectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartTextDetectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTextDetectionResponse} obj Optional instance to populate.
     * @return {module:model/StartTextDetectionResponse} The populated <code>StartTextDetectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTextDetectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartTextDetectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTextDetectionResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartTextDetectionResponse.prototype['JobId'] = undefined;
...
export default StartTextDetectionResponse;
