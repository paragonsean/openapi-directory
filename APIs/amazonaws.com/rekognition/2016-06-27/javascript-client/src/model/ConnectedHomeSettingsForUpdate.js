...
/**
 * The ConnectedHomeSettingsForUpdate model module.
 * @module model/ConnectedHomeSettingsForUpdate
 * @version 2016-06-27
 */
class ConnectedHomeSettingsForUpdate {
    /**
     * Constructs a new <code>ConnectedHomeSettingsForUpdate</code>.
     ...
     * @alias module:model/ConnectedHomeSettingsForUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ConnectedHomeSettingsForUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectedHomeSettingsForUpdate} obj Optional instance to populate.
     * @return {module:model/ConnectedHomeSettingsForUpdate} The populated <code>ConnectedHomeSettingsForUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectedHomeSettingsForUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectedHomeSettingsForUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectedHomeSettingsForUpdate</code>.
     */
...
export default ConnectedHomeSettingsForUpdate;
