...
/**
 * The DistributeDataset model module.
 * @module model/DistributeDataset
 * @version 2016-06-27
 */
class DistributeDataset {
    /**
     * Constructs a new <code>DistributeDataset</code>.
     ...
     * @alias module:model/DistributeDataset
     * @param arn {String} 
     */
    constructor(arn) { 
        
        DistributeDataset.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DistributeDataset</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DistributeDataset} obj Optional instance to populate.
     * @return {module:model/DistributeDataset} The populated <code>DistributeDataset</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DistributeDataset();
    ...
    /**
     * Validates the JSON data with respect to <code>DistributeDataset</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DistributeDataset</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DistributeDataset.RequiredProperties) {
...
DistributeDataset.RequiredProperties = ["Arn"];

/**
 * @member {String} Arn
 */
DistributeDataset.prototype['Arn'] = undefined;
...
export default DistributeDataset;
