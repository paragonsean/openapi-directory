...
/**
 * The AssociatedFace model module.
 * @module model/AssociatedFace
 * @version 2016-06-27
 */
class AssociatedFace {
    /**
     * Constructs a new <code>AssociatedFace</code>.
     * Provides face metadata for the faces that are associated to a specific UserID.
     * @alias module:model/AssociatedFace
     */
    constructor() { 
        
        AssociatedFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociatedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociatedFace} obj Optional instance to populate.
     * @return {module:model/AssociatedFace} The populated <code>AssociatedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociatedFace();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociatedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociatedFace</code>.
     */
 ...
 */
AssociatedFace.prototype['FaceId'] = undefined;
