...
/**
 * The CelebrityDetailFace model module.
 * @module model/CelebrityDetailFace
 * @version 2016-06-27
 */
class CelebrityDetailFace {
    /**
     * Constructs a new <code>CelebrityDetailFace</code>.
     * @alias module:model/CelebrityDetailFace
     * @implements module:model/FaceDetail
     */
    constructor() { 
        FaceDetail.initialize(this);
        CelebrityDetailFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CelebrityDetailFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CelebrityDetailFace} obj Optional instance to populate.
     * @return {module:model/CelebrityDetailFace} The populated <code>CelebrityDetailFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CelebrityDetailFace();
    ...
    /**
     * Validates the JSON data with respect to <code>CelebrityDetailFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CelebrityDetailFace</code>.
     */
 ...
 */
CelebrityDetailFace.prototype['BoundingBox'] = undefined;

/**
 * @member {module:model/FaceDetailAgeRange} AgeRange
 */
CelebrityDetailFace.prototype['AgeRange'] = undefined;

/**
 * @member {module:model/FaceDetailSmile} Smile
 */
CelebrityDetailFace.prototype['Smile'] = undefined;

/**
 * @member {module:model/FaceDetailEyeglasses} Eyeglasses
 */
CelebrityDetailFace.prototype['Eyeglasses'] = undefined;

/**
 * @member {module:model/FaceDetailSunglasses} Sunglasses
 */
CelebrityDetailFace.prototype['Sunglasses'] = undefined;

/**
 * @member {module:model/FaceDetailGender} Gender
 */
CelebrityDetailFace.prototype['Gender'] = undefined;

/**
 * @member {module:model/FaceDetailBeard} Beard
 */
CelebrityDetailFace.prototype['Beard'] = undefined;

/**
 * @member {module:model/FaceDetailMustache} Mustache
 */
CelebrityDetailFace.prototype['Mustache'] = undefined;

/**
 * @member {module:model/FaceDetailEyesOpen} EyesOpen
 */
CelebrityDetailFace.prototype['EyesOpen'] = undefined;

/**
 * @member {module:model/FaceDetailMouthOpen} MouthOpen
 */
CelebrityDetailFace.prototype['MouthOpen'] = undefined;

/**
 * @member {Array} Emotions
 */
CelebrityDetailFace.prototype['Emotions'] = undefined;

/**
 * @member {Array} Landmarks
 */
CelebrityDetailFace.prototype['Landmarks'] = undefined;

/**
 * @member {module:model/FaceDetailPose} Pose
 */
CelebrityDetailFace.prototype['Pose'] = undefined;

/**
 * @member {module:model/FaceDetailQuality} Quality
 */
CelebrityDetailFace.prototype['Quality'] = undefined;

/**
 * @member {Number} Confidence
 */
CelebrityDetailFace.prototype['Confidence'] = undefined;

/**
 * @member {module:model/FaceDetailFaceOccluded} FaceOccluded
 */
CelebrityDetailFace.prototype['FaceOccluded'] = undefined;

/**
 * @member {module:model/FaceDetailEyeDirection} EyeDirection
 */
CelebrityDetailFace.prototype['EyeDirection'] = undefined;
...
export default CelebrityDetailFace;
