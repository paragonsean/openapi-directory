...
/**
 * The StartFaceSearchResponse model module.
 * @module model/StartFaceSearchResponse
 * @version 2016-06-27
 */
class StartFaceSearchResponse {
    /**
     * Constructs a new <code>StartFaceSearchResponse</code>.
     * @alias module:model/StartFaceSearchResponse
     */
    constructor() { 
        
        StartFaceSearchResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartFaceSearchResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceSearchResponse} obj Optional instance to populate.
     * @return {module:model/StartFaceSearchResponse} The populated <code>StartFaceSearchResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceSearchResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceSearchResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceSearchResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartFaceSearchResponse.prototype['JobId'] = undefined;
...
export default StartFaceSearchResponse;
