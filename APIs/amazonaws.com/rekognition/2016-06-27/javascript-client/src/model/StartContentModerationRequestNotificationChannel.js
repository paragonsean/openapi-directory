...
/**
 * The StartContentModerationRequestNotificationChannel model module.
 * @module model/StartContentModerationRequestNotificationChannel
 * @version 2016-06-27
 */
class StartContentModerationRequestNotificationChannel {
    /**
     * Constructs a new <code>StartContentModerationRequestNotificationChannel</code>.
     * @alias module:model/StartContentModerationRequestNotificationChannel
    ...
    constructor(sNSTopicArn, roleArn) { 
        ...
        StartContentModerationRequestNotificationChannel.initialize(this, sNSTopicArn, roleArn);
    }
    ...
    /**
     * Constructs a <code>StartContentModerationRequestNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartContentModerationRequestNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StartContentModerationRequestNotificationChannel} The populated <code>StartContentModerationRequestNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartContentModerationRequestNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StartContentModerationRequestNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartContentModerationRequestNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartContentModerationRequestNotificationChannel.RequiredProperties) {
...
StartContentModerationRequestNotificationChannel.RequiredProperties = ["SNSTopicArn", "RoleArn"];

/**
 * @member {String} SNSTopicArn
 */
StartContentModerationRequestNotificationChannel.prototype['SNSTopicArn'] = undefined;

/**
 * @member {String} RoleArn
 */
StartContentModerationRequestNotificationChannel.prototype['RoleArn'] = undefined;
...
export default StartContentModerationRequestNotificationChannel;
