...
/**
 * The DetectLabelsImageQuality model module.
 * @module model/DetectLabelsImageQuality
 * @version 2016-06-27
 */
class DetectLabelsImageQuality {
    /**
     * Constructs a new <code>DetectLabelsImageQuality</code>.
     * The quality of an image provided for label detection, with regard to brightness, sharpness, and contrast.
     * @alias module:model/DetectLabelsImageQuality
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DetectLabelsImageQuality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImageQuality} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImageQuality} The populated <code>DetectLabelsImageQuality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImageQuality();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImageQuality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImageQuality</code>.
     */
...
export default DetectLabelsImageQuality;
