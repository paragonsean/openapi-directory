...
import StartStreamProcessorRequestStartSelector from './StartStreamProcessorRequestStartSelector';
import StartStreamProcessorRequestStopSelector from './StartStreamProcessorRequestStopSelector';

/**
 * The StartStreamProcessorRequest model module.
 * @module model/StartStreamProcessorRequest
 * @version 2016-06-27
 */
class StartStreamProcessorRequest {
    /**
     * Constructs a new <code>StartStreamProcessorRequest</code>.
     * @alias module:model/StartStreamProcessorRequest
     * @param name {String} 
     */
    constructor(name) { 
        
        StartStreamProcessorRequest.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>StartStreamProcessorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartStreamProcessorRequest} obj Optional instance to populate.
     * @return {module:model/StartStreamProcessorRequest} The populated <code>StartStreamProcessorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartStreamProcessorRequest();

            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], 'String');
            }
            if (data.hasOwnProperty('StartSelector')) {
                obj['StartSelector'] = StartStreamProcessorRequestStartSelector.constructFromObject(data['StartSelector']);
            }
            if (data.hasOwnProperty('StopSelector')) {
                obj['StopSelector'] = StartStreamProcessorRequestStopSelector.constructFromObject(data['StopSelector']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartStreamProcessorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartStreamProcessorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartStreamProcessorRequest.RequiredProperties) {
        ...
        if (data['StartSelector']) { // data not null
          StartStreamProcessorRequestStartSelector.validateJSON(data['StartSelector']);
        }
        // validate the optional field `StopSelector`
        if (data['StopSelector']) { // data not null
          StartStreamProcessorRequestStopSelector.validateJSON(data['StopSelector']);
        }
...
StartStreamProcessorRequest.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
StartStreamProcessorRequest.prototype['Name'] = undefined;

/**
 * @member {module:model/StartStreamProcessorRequestStartSelector} StartSelector
 */
StartStreamProcessorRequest.prototype['StartSelector'] = undefined;

/**
 * @member {module:model/StartStreamProcessorRequestStopSelector} StopSelector
 */
StartStreamProcessorRequest.prototype['StopSelector'] = undefined;
...
export default StartStreamProcessorRequest;
