...
/**
 * The CreateStreamProcessorRequestDataSharingPreference model module.
 * @module model/CreateStreamProcessorRequestDataSharingPreference
 * @version 2016-06-27
 */
class CreateStreamProcessorRequestDataSharingPreference {
    /**
     * Constructs a new <code>CreateStreamProcessorRequestDataSharingPreference</code>.
     * @alias module:model/CreateStreamProcessorRequestDataSharingPreference
     * @implements module:model/StreamProcessorDataSharingPreference
     * @param optIn {Boolean} 
     */
    constructor(optIn) { 
        StreamProcessorDataSharingPreference.initialize(this, optIn);
        CreateStreamProcessorRequestDataSharingPreference.initialize(this, optIn);
    }
    ...
    /**
     * Constructs a <code>CreateStreamProcessorRequestDataSharingPreference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamProcessorRequestDataSharingPreference} obj Optional instance to populate.
     * @return {module:model/CreateStreamProcessorRequestDataSharingPreference} The populated <code>CreateStreamProcessorRequestDataSharingPreference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamProcessorRequestDataSharingPreference();
            StreamProcessorDataSharingPreference.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamProcessorRequestDataSharingPreference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamProcessorRequestDataSharingPreference</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateStreamProcessorRequestDataSharingPreference.RequiredProperties) {
...
CreateStreamProcessorRequestDataSharingPreference.RequiredProperties = ["OptIn"];

/**
 * @member {Boolean} OptIn
 */
CreateStreamProcessorRequestDataSharingPreference.prototype['OptIn'] = undefined;


// Implement StreamProcessorDataSharingPreference interface:
/**
 * @member {Boolean} OptIn
 */
...
export default CreateStreamProcessorRequestDataSharingPreference;
