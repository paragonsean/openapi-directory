...
/**
 * The DescribeProjectsResponse model module.
 * @module model/DescribeProjectsResponse
 * @version 2016-06-27
 */
class DescribeProjectsResponse {
    /**
     * Constructs a new <code>DescribeProjectsResponse</code>.
     * @alias module:model/DescribeProjectsResponse
     */
    constructor() { 
        
        DescribeProjectsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeProjectsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeProjectsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeProjectsResponse} The populated <code>DescribeProjectsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeProjectsResponse();

            if (data.hasOwnProperty('ProjectDescriptions')) {
                obj['ProjectDescriptions'] = ApiClient.convertToType(data['ProjectDescriptions'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeProjectsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeProjectsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProjectDescriptions`
        if (data['ProjectDescriptions']) { // data not null
          Array.validateJSON(data['ProjectDescriptions']);
        }
...
/**
 * @member {Array} ProjectDescriptions
 */
DescribeProjectsResponse.prototype['ProjectDescriptions'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeProjectsResponse.prototype['NextToken'] = undefined;
...
export default DescribeProjectsResponse;
