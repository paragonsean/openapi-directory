...
import UserMatchUser from './UserMatchUser';

/**
 * The UserMatch model module.
 * @module model/UserMatch
 * @version 2016-06-27
 */
class UserMatch {
    /**
     * Constructs a new <code>UserMatch</code>.
     * Provides UserID metadata along with the confidence in the match of this UserID with the input face.
     * @alias module:model/UserMatch
     */
    constructor() { 
        
        UserMatch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserMatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserMatch} obj Optional instance to populate.
     * @return {module:model/UserMatch} The populated <code>UserMatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserMatch();

            if (data.hasOwnProperty('Similarity')) {
                obj['Similarity'] = ApiClient.convertToType(data['Similarity'], 'Number');
            }
            if (data.hasOwnProperty('User')) {
                obj['User'] = UserMatchUser.constructFromObject(data['User']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserMatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserMatch</code>.
     */
    static validateJSON(data) {
        ...
        if (data['User']) { // data not null
          UserMatchUser.validateJSON(data['User']);
        }
 ...
 */
UserMatch.prototype['Similarity'] = undefined;

/**
 * @member {module:model/UserMatchUser} User
 */
UserMatch.prototype['User'] = undefined;
