...
/**
 * The GetSegmentDetectionResponse model module.
 * @module model/GetSegmentDetectionResponse
 * @version 2016-06-27
 */
class GetSegmentDetectionResponse {
    /**
     * Constructs a new <code>GetSegmentDetectionResponse</code>.
     * @alias module:model/GetSegmentDetectionResponse
     */
    constructor() { 
        
        GetSegmentDetectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSegmentDetectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSegmentDetectionResponse} obj Optional instance to populate.
     * @return {module:model/GetSegmentDetectionResponse} The populated <code>GetSegmentDetectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSegmentDetectionResponse();

            if (data.hasOwnProperty('JobStatus')) {
                obj['JobStatus'] = ApiClient.convertToType(data['JobStatus'], VideoJobStatus);
            }
            if (data.hasOwnProperty('StatusMessage')) {
                obj['StatusMessage'] = ApiClient.convertToType(data['StatusMessage'], 'String');
            }
            if (data.hasOwnProperty('VideoMetadata')) {
                obj['VideoMetadata'] = ApiClient.convertToType(data['VideoMetadata'], Array);
            }
            if (data.hasOwnProperty('AudioMetadata')) {
                obj['AudioMetadata'] = ApiClient.convertToType(data['AudioMetadata'], Array);
            }
            ...
            if (data.hasOwnProperty('SelectedSegmentTypes')) {
                obj['SelectedSegmentTypes'] = ApiClient.convertToType(data['SelectedSegmentTypes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSegmentDetectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSegmentDetectionResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `JobStatus`
        if (data['JobStatus']) { // data not null
          VideoJobStatus.validateJSON(data['JobStatus']);
        }
        ...
        if (data['VideoMetadata']) { // data not null
          Array.validateJSON(data['VideoMetadata']);
        }
        // validate the optional field `AudioMetadata`
        if (data['AudioMetadata']) { // data not null
          Array.validateJSON(data['AudioMetadata']);
        }
        ...
        // validate the optional field `SelectedSegmentTypes`
        if (data['SelectedSegmentTypes']) { // data not null
          Array.validateJSON(data['SelectedSegmentTypes']);
        }
...
/**
 * @member {module:model/VideoJobStatus} JobStatus
 */
GetSegmentDetectionResponse.prototype['JobStatus'] = undefined;

/**
 * @member {String} StatusMessage
 */
GetSegmentDetectionResponse.prototype['StatusMessage'] = undefined;

/**
 * @member {Array} VideoMetadata
 */
GetSegmentDetectionResponse.prototype['VideoMetadata'] = undefined;

/**
 * @member {Array} AudioMetadata
 */
GetSegmentDetectionResponse.prototype['AudioMetadata'] = undefined;

/**
 * @member {String} NextToken
 */
GetSegmentDetectionResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} Segments
 */
GetSegmentDetectionResponse.prototype['Segments'] = undefined;

/**
 * @member {Array} SelectedSegmentTypes
 */
GetSegmentDetectionResponse.prototype['SelectedSegmentTypes'] = undefined;

/**
 * @member {String} JobId
 */
GetSegmentDetectionResponse.prototype['JobId'] = undefined;

/**
 * @member {module:model/Video} Video
 */
GetSegmentDetectionResponse.prototype['Video'] = undefined;

/**
 * @member {String} JobTag
 */
GetSegmentDetectionResponse.prototype['JobTag'] = undefined;
...
export default GetSegmentDetectionResponse;
