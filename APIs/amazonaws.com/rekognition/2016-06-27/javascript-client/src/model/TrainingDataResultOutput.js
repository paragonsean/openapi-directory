...
/**
 * The TrainingDataResultOutput model module.
 * @module model/TrainingDataResultOutput
 * @version 2016-06-27
 */
class TrainingDataResultOutput {
    /**
     * Constructs a new <code>TrainingDataResultOutput</code>.
     * @alias module:model/TrainingDataResultOutput
     * @implements module:model/TrainingData
     */
    constructor() { 
        TrainingData.initialize(this);
        TrainingDataResultOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrainingDataResultOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrainingDataResultOutput} obj Optional instance to populate.
     * @return {module:model/TrainingDataResultOutput} The populated <code>TrainingDataResultOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrainingDataResultOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>TrainingDataResultOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrainingDataResultOutput</code>.
     */
 ...
 * @member {Array} Assets
 */
TrainingDataResultOutput.prototype['Assets'] = undefined;
...
export default TrainingDataResultOutput;
