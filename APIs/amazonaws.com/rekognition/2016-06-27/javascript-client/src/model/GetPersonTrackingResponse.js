...
/**
 * The GetPersonTrackingResponse model module.
 * @module model/GetPersonTrackingResponse
 * @version 2016-06-27
 */
class GetPersonTrackingResponse {
    /**
     * Constructs a new <code>GetPersonTrackingResponse</code>.
     * @alias module:model/GetPersonTrackingResponse
     */
    constructor() { 
        
        GetPersonTrackingResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPersonTrackingResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPersonTrackingResponse} obj Optional instance to populate.
     * @return {module:model/GetPersonTrackingResponse} The populated <code>GetPersonTrackingResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPersonTrackingResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPersonTrackingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPersonTrackingResponse</code>.
     */
 ...
 */
GetPersonTrackingResponse.prototype['JobStatus'] = undefined;

/**
 * @member {String} StatusMessage
 */
GetPersonTrackingResponse.prototype['StatusMessage'] = undefined;

/**
 * @member {module:model/GetCelebrityRecognitionResponseVideoMetadata} VideoMetadata
 */
GetPersonTrackingResponse.prototype['VideoMetadata'] = undefined;

/**
 * @member {String} NextToken
 */
GetPersonTrackingResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} Persons
 */
GetPersonTrackingResponse.prototype['Persons'] = undefined;

/**
 * @member {String} JobId
 */
GetPersonTrackingResponse.prototype['JobId'] = undefined;

/**
 * @member {module:model/Video} Video
 */
GetPersonTrackingResponse.prototype['Video'] = undefined;

/**
 * @member {String} JobTag
 */
GetPersonTrackingResponse.prototype['JobTag'] = undefined;
...
export default GetPersonTrackingResponse;
