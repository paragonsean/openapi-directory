...
import ComparedFacePose from './ComparedFacePose';
import ComparedFaceQuality from './ComparedFaceQuality';
import ComparedFaceSmile from './ComparedFaceSmile';

/**
 * The ComparedFace model module.
 * @module model/ComparedFace
 * @version 2016-06-27
 */
class ComparedFace {
    /**
     * Constructs a new <code>ComparedFace</code>.
     ...
     * @alias module:model/ComparedFace
     */
    constructor() { 
        
        ComparedFace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ComparedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ComparedFace} obj Optional instance to populate.
     * @return {module:model/ComparedFace} The populated <code>ComparedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComparedFace();
            ...
            if (data.hasOwnProperty('Pose')) {
                obj['Pose'] = ComparedFacePose.constructFromObject(data['Pose']);
            }
            if (data.hasOwnProperty('Quality')) {
                obj['Quality'] = ComparedFaceQuality.constructFromObject(data['Quality']);
            }
            if (data.hasOwnProperty('Emotions')) {
                obj['Emotions'] = ApiClient.convertToType(data['Emotions'], Array);
            }
            if (data.hasOwnProperty('Smile')) {
                obj['Smile'] = ComparedFaceSmile.constructFromObject(data['Smile']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ComparedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComparedFace</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Pose']) { // data not null
          ComparedFacePose.validateJSON(data['Pose']);
        }
        // validate the optional field `Quality`
        if (data['Quality']) { // data not null
          ComparedFaceQuality.validateJSON(data['Quality']);
        }
        ...
        if (data['Smile']) { // data not null
          ComparedFaceSmile.validateJSON(data['Smile']);
        }
 ...
 */
ComparedFace.prototype['BoundingBox'] = undefined;

/**
 * @member {Number} Confidence
 */
ComparedFace.prototype['Confidence'] = undefined;

/**
 * @member {Array} Landmarks
 */
ComparedFace.prototype['Landmarks'] = undefined;

/**
 * @member {module:model/ComparedFacePose} Pose
 */
ComparedFace.prototype['Pose'] = undefined;

/**
 * @member {module:model/ComparedFaceQuality} Quality
 */
ComparedFace.prototype['Quality'] = undefined;

/**
 * @member {Array} Emotions
 */
ComparedFace.prototype['Emotions'] = undefined;

/**
 * @member {module:model/ComparedFaceSmile} Smile
 */
ComparedFace.prototype['Smile'] = undefined;
