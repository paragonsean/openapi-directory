...
/**
 * The DetectLabelsImageForeground model module.
 * @module model/DetectLabelsImageForeground
 * @version 2016-06-27
 */
class DetectLabelsImageForeground {
    /**
     * Constructs a new <code>DetectLabelsImageForeground</code>.
     * The foreground of the image with regard to image quality and dominant colors.
     * @alias module:model/DetectLabelsImageForeground
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DetectLabelsImageForeground</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImageForeground} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImageForeground} The populated <code>DetectLabelsImageForeground</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImageForeground();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImageForeground</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImageForeground</code>.
     */
...
export default DetectLabelsImageForeground;
