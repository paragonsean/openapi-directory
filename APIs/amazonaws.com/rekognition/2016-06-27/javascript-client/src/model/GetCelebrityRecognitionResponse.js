...
import GetCelebrityRecognitionResponseVideoMetadata from './GetCelebrityRecognitionResponseVideoMetadata';
import Video from './Video';
import VideoJobStatus from './VideoJobStatus';

/**
 * The GetCelebrityRecognitionResponse model module.
 * @module model/GetCelebrityRecognitionResponse
 * @version 2016-06-27
 */
class GetCelebrityRecognitionResponse {
    /**
     * Constructs a new <code>GetCelebrityRecognitionResponse</code>.
     * @alias module:model/GetCelebrityRecognitionResponse
     */
    constructor() { 
        
        GetCelebrityRecognitionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCelebrityRecognitionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCelebrityRecognitionResponse} obj Optional instance to populate.
     * @return {module:model/GetCelebrityRecognitionResponse} The populated <code>GetCelebrityRecognitionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCelebrityRecognitionResponse();
            ...
            if (data.hasOwnProperty('VideoMetadata')) {
                obj['VideoMetadata'] = GetCelebrityRecognitionResponseVideoMetadata.constructFromObject(data['VideoMetadata']);
            }
            if (data.hasOwnProperty('NextToken')) {
                obj['NextToken'] = ApiClient.convertToType(data['NextToken'], 'String');
            }
            if (data.hasOwnProperty('Celebrities')) {
                obj['Celebrities'] = ApiClient.convertToType(data['Celebrities'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCelebrityRecognitionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCelebrityRecognitionResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VideoMetadata']) { // data not null
          GetCelebrityRecognitionResponseVideoMetadata.validateJSON(data['VideoMetadata']);
        }
        // validate the optional field `NextToken`
        if (data['NextToken']) { // data not null
          String.validateJSON(data['NextToken']);
        }
        // validate the optional field `Celebrities`
        if (data['Celebrities']) { // data not null
          Array.validateJSON(data['Celebrities']);
        }
 ...
 */
GetCelebrityRecognitionResponse.prototype['JobStatus'] = undefined;

/**
 * @member {String} StatusMessage
 */
GetCelebrityRecognitionResponse.prototype['StatusMessage'] = undefined;

/**
 * @member {module:model/GetCelebrityRecognitionResponseVideoMetadata} VideoMetadata
 */
GetCelebrityRecognitionResponse.prototype['VideoMetadata'] = undefined;

/**
 * @member {String} NextToken
 */
GetCelebrityRecognitionResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} Celebrities
 */
GetCelebrityRecognitionResponse.prototype['Celebrities'] = undefined;

/**
 * @member {String} JobId
 */
GetCelebrityRecognitionResponse.prototype['JobId'] = undefined;

/**
 * @member {module:model/Video} Video
 */
GetCelebrityRecognitionResponse.prototype['Video'] = undefined;

/**
 * @member {String} JobTag
 */
GetCelebrityRecognitionResponse.prototype['JobTag'] = undefined;
...
export default GetCelebrityRecognitionResponse;
