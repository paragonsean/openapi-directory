...
/**
 * The ImageQuality model module.
 * @module model/ImageQuality
 * @version 2016-06-27
 */
class ImageQuality {
    /**
     * Constructs a new <code>ImageQuality</code>.
     * Identifies face image brightness and sharpness. 
     * @alias module:model/ImageQuality
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ImageQuality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageQuality} obj Optional instance to populate.
     * @return {module:model/ImageQuality} The populated <code>ImageQuality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageQuality();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageQuality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageQuality</code>.
     */
