...
/**
 * The StreamProcessorSettingsFaceSearch model module.
 * @module model/StreamProcessorSettingsFaceSearch
 * @version 2016-06-27
 */
class StreamProcessorSettingsFaceSearch {
    /**
     * Constructs a new <code>StreamProcessorSettingsFaceSearch</code>.
     * @alias module:model/StreamProcessorSettingsFaceSearch
     * @implements module:model/FaceSearchSettings
     */
    constructor() { 
        FaceSearchSettings.initialize(this);
        StreamProcessorSettingsFaceSearch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamProcessorSettingsFaceSearch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorSettingsFaceSearch} obj Optional instance to populate.
     * @return {module:model/StreamProcessorSettingsFaceSearch} The populated <code>StreamProcessorSettingsFaceSearch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorSettingsFaceSearch();
            FaceSearchSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorSettingsFaceSearch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorSettingsFaceSearch</code>.
     */
 ...
 */
StreamProcessorSettingsFaceSearch.prototype['CollectionId'] = undefined;

/**
 * @member {Number} FaceMatchThreshold
 */
StreamProcessorSettingsFaceSearch.prototype['FaceMatchThreshold'] = undefined;


// Implement FaceSearchSettings interface:
/**
 * @member {String} CollectionId
 */
FaceSearchSettings.prototype['CollectionId'] = undefined;
/**
 * @member {Number} FaceMatchThreshold
 */
FaceSearchSettings.prototype['FaceMatchThreshold'] = undefined;




export default StreamProcessorSettingsFaceSearch;
