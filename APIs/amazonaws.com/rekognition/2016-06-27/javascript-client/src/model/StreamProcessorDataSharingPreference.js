...
/**
 * The StreamProcessorDataSharingPreference model module.
 * @module model/StreamProcessorDataSharingPreference
 * @version 2016-06-27
 */
class StreamProcessorDataSharingPreference {
    /**
     * Constructs a new <code>StreamProcessorDataSharingPreference</code>.
     ...
     * @alias module:model/StreamProcessorDataSharingPreference
     * @param optIn {Boolean} 
     */
    constructor(optIn) { 
        
        StreamProcessorDataSharingPreference.initialize(this, optIn);
    }
     ...
     */
    static initialize(obj, optIn) { 
        obj['OptIn'] = optIn;
    }

    /**
     * Constructs a <code>StreamProcessorDataSharingPreference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamProcessorDataSharingPreference} obj Optional instance to populate.
     * @return {module:model/StreamProcessorDataSharingPreference} The populated <code>StreamProcessorDataSharingPreference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamProcessorDataSharingPreference();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamProcessorDataSharingPreference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamProcessorDataSharingPreference</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StreamProcessorDataSharingPreference.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `OptIn`
        if (data['OptIn']) { // data not null
          Boolean.validateJSON(data['OptIn']);
        }
...
StreamProcessorDataSharingPreference.RequiredProperties = ["OptIn"];

/**
 * @member {Boolean} OptIn
 */
StreamProcessorDataSharingPreference.prototype['OptIn'] = undefined;
...
export default StreamProcessorDataSharingPreference;
