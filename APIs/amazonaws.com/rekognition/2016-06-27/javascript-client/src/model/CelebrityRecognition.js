...
import CelebrityRecognitionCelebrity from './CelebrityRecognitionCelebrity';

/**
 * The CelebrityRecognition model module.
 * @module model/CelebrityRecognition
 * @version 2016-06-27
 */
class CelebrityRecognition {
    /**
     * Constructs a new <code>CelebrityRecognition</code>.
     * Information about a detected celebrity and the time the celebrity was detected in a stored video. For more information, see GetCelebrityRecognition in the Amazon Rekognition Developer Guide.
     * @alias module:model/CelebrityRecognition
     */
    constructor() { 
        
        CelebrityRecognition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CelebrityRecognition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CelebrityRecognition} obj Optional instance to populate.
     * @return {module:model/CelebrityRecognition} The populated <code>CelebrityRecognition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CelebrityRecognition();

            if (data.hasOwnProperty('Timestamp')) {
                obj['Timestamp'] = ApiClient.convertToType(data['Timestamp'], 'Number');
            }
            if (data.hasOwnProperty('Celebrity')) {
                obj['Celebrity'] = CelebrityRecognitionCelebrity.constructFromObject(data['Celebrity']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CelebrityRecognition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CelebrityRecognition</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Celebrity']) { // data not null
          CelebrityRecognitionCelebrity.validateJSON(data['Celebrity']);
        }
 ...
 */
CelebrityRecognition.prototype['Timestamp'] = undefined;

/**
 * @member {module:model/CelebrityRecognitionCelebrity} Celebrity
 */
CelebrityRecognition.prototype['Celebrity'] = undefined;
