...
/**
 * The StartFaceSearchRequestNotificationChannel model module.
 * @module model/StartFaceSearchRequestNotificationChannel
 * @version 2016-06-27
 */
class StartFaceSearchRequestNotificationChannel {
    /**
     * Constructs a new <code>StartFaceSearchRequestNotificationChannel</code>.
     * @alias module:model/StartFaceSearchRequestNotificationChannel
    ...
    constructor(sNSTopicArn, roleArn) { 
        ...
        StartFaceSearchRequestNotificationChannel.initialize(this, sNSTopicArn, roleArn);
    }
    ...
    /**
     * Constructs a <code>StartFaceSearchRequestNotificationChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFaceSearchRequestNotificationChannel} obj Optional instance to populate.
     * @return {module:model/StartFaceSearchRequestNotificationChannel} The populated <code>StartFaceSearchRequestNotificationChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFaceSearchRequestNotificationChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>StartFaceSearchRequestNotificationChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFaceSearchRequestNotificationChannel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartFaceSearchRequestNotificationChannel.RequiredProperties) {
...
StartFaceSearchRequestNotificationChannel.RequiredProperties = ["SNSTopicArn", "RoleArn"];

/**
 * @member {String} SNSTopicArn
 */
StartFaceSearchRequestNotificationChannel.prototype['SNSTopicArn'] = undefined;

/**
 * @member {String} RoleArn
 */
StartFaceSearchRequestNotificationChannel.prototype['RoleArn'] = undefined;
...
export default StartFaceSearchRequestNotificationChannel;
