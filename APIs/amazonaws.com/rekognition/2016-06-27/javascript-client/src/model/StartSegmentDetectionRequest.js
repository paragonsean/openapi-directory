...
import StartSegmentDetectionRequestFilters from './StartSegmentDetectionRequestFilters';
import StartSegmentDetectionRequestNotificationChannel from './StartSegmentDetectionRequestNotificationChannel';
import Video from './Video';

/**
 * The StartSegmentDetectionRequest model module.
 * @module model/StartSegmentDetectionRequest
 * @version 2016-06-27
 */
class StartSegmentDetectionRequest {
    /**
     * Constructs a new <code>StartSegmentDetectionRequest</code>.
     * @alias module:model/StartSegmentDetectionRequest
     * @param video {module:model/Video} 
     * @param segmentTypes {Array} 
     */
    constructor(video, segmentTypes) { 
        
        StartSegmentDetectionRequest.initialize(this, video, segmentTypes);
    }
     ...
     */
    static initialize(obj, video, segmentTypes) { 
        obj['Video'] = video;
        obj['SegmentTypes'] = segmentTypes;
    }

    /**
     * Constructs a <code>StartSegmentDetectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSegmentDetectionRequest} obj Optional instance to populate.
     * @return {module:model/StartSegmentDetectionRequest} The populated <code>StartSegmentDetectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSegmentDetectionRequest();
            ...
            if (data.hasOwnProperty('NotificationChannel')) {
                obj['NotificationChannel'] = StartSegmentDetectionRequestNotificationChannel.constructFromObject(data['NotificationChannel']);
            }
            if (data.hasOwnProperty('JobTag')) {
                obj['JobTag'] = ApiClient.convertToType(data['JobTag'], 'String');
            }
            if (data.hasOwnProperty('Filters')) {
                obj['Filters'] = StartSegmentDetectionRequestFilters.constructFromObject(data['Filters']);
            }
            if (data.hasOwnProperty('SegmentTypes')) {
                obj['SegmentTypes'] = ApiClient.convertToType(data['SegmentTypes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartSegmentDetectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSegmentDetectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartSegmentDetectionRequest.RequiredProperties) {
        ...
        if (data['NotificationChannel']) { // data not null
          StartSegmentDetectionRequestNotificationChannel.validateJSON(data['NotificationChannel']);
        }
        ...
        if (data['Filters']) { // data not null
          StartSegmentDetectionRequestFilters.validateJSON(data['Filters']);
        }
        // validate the optional field `SegmentTypes`
        if (data['SegmentTypes']) { // data not null
          Array.validateJSON(data['SegmentTypes']);
        }
...
StartSegmentDetectionRequest.RequiredProperties = ["Video", "SegmentTypes"];

/**
 * @member {module:model/Video} Video
 */
StartSegmentDetectionRequest.prototype['Video'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
StartSegmentDetectionRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {module:model/StartSegmentDetectionRequestNotificationChannel} NotificationChannel
 */
StartSegmentDetectionRequest.prototype['NotificationChannel'] = undefined;

/**
 * @member {String} JobTag
 */
StartSegmentDetectionRequest.prototype['JobTag'] = undefined;

/**
 * @member {module:model/StartSegmentDetectionRequestFilters} Filters
 */
StartSegmentDetectionRequest.prototype['Filters'] = undefined;

/**
 * @member {Array} SegmentTypes
 */
StartSegmentDetectionRequest.prototype['SegmentTypes'] = undefined;
...
export default StartSegmentDetectionRequest;
