...
/**
 * The ComparedFaceSmile model module.
 * @module model/ComparedFaceSmile
 * @version 2016-06-27
 */
class ComparedFaceSmile {
    /**
     * Constructs a new <code>ComparedFaceSmile</code>.
     * @alias module:model/ComparedFaceSmile
     * @implements module:model/Smile
     */
    constructor() { 
        Smile.initialize(this);
        ComparedFaceSmile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ComparedFaceSmile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ComparedFaceSmile} obj Optional instance to populate.
     * @return {module:model/ComparedFaceSmile} The populated <code>ComparedFaceSmile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComparedFaceSmile();
            Smile.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ComparedFaceSmile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComparedFaceSmile</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Value`
        if (data['Value']) { // data not null
          Boolean.validateJSON(data['Value']);
        }
 ...
 */
ComparedFaceSmile.prototype['Value'] = undefined;

/**
 * @member {Number} Confidence
 */
ComparedFaceSmile.prototype['Confidence'] = undefined;


// Implement Smile interface:
/**
 * @member {Boolean} Value
 */
Smile.prototype['Value'] = undefined;
/**
 * @member {Number} Confidence
 */
Smile.prototype['Confidence'] = undefined;




export default ComparedFaceSmile;
