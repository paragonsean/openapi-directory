...
/**
 * The StopProjectVersionResponse model module.
 * @module model/StopProjectVersionResponse
 * @version 2016-06-27
 */
class StopProjectVersionResponse {
    /**
     * Constructs a new <code>StopProjectVersionResponse</code>.
     * @alias module:model/StopProjectVersionResponse
     */
    constructor() { 
        
        StopProjectVersionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopProjectVersionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopProjectVersionResponse} obj Optional instance to populate.
     * @return {module:model/StopProjectVersionResponse} The populated <code>StopProjectVersionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopProjectVersionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StopProjectVersionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopProjectVersionResponse</code>.
     */
 ...
 */
StopProjectVersionResponse.prototype['Status'] = undefined;
...
export default StopProjectVersionResponse;
