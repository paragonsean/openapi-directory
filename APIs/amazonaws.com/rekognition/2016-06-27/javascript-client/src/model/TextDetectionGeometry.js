...
/**
 * The TextDetectionGeometry model module.
 * @module model/TextDetectionGeometry
 * @version 2016-06-27
 */
class TextDetectionGeometry {
    /**
     * Constructs a new <code>TextDetectionGeometry</code>.
     * @alias module:model/TextDetectionGeometry
     * @implements module:model/Geometry
     */
    constructor() { 
        Geometry.initialize(this);
        TextDetectionGeometry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TextDetectionGeometry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TextDetectionGeometry} obj Optional instance to populate.
     * @return {module:model/TextDetectionGeometry} The populated <code>TextDetectionGeometry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TextDetectionGeometry();
    ...
    /**
     * Validates the JSON data with respect to <code>TextDetectionGeometry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TextDetectionGeometry</code>.
     */
 ...
 */
TextDetectionGeometry.prototype['BoundingBox'] = undefined;

/**
 * @member {Array} Polygon
 */
TextDetectionGeometry.prototype['Polygon'] = undefined;
...
export default TextDetectionGeometry;
