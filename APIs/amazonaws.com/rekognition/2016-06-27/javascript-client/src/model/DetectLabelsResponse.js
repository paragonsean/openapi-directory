...
import DetectLabelsResponseImageProperties from './DetectLabelsResponseImageProperties';
import OrientationCorrection from './OrientationCorrection';

/**
 * The DetectLabelsResponse model module.
 * @module model/DetectLabelsResponse
 * @version 2016-06-27
 */
class DetectLabelsResponse {
    /**
     * Constructs a new <code>DetectLabelsResponse</code>.
     * @alias module:model/DetectLabelsResponse
     */
    constructor() { 
        
        DetectLabelsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectLabelsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsResponse} obj Optional instance to populate.
     * @return {module:model/DetectLabelsResponse} The populated <code>DetectLabelsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsResponse();
            ...
            if (data.hasOwnProperty('LabelModelVersion')) {
                obj['LabelModelVersion'] = ApiClient.convertToType(data['LabelModelVersion'], 'String');
            }
            if (data.hasOwnProperty('ImageProperties')) {
                obj['ImageProperties'] = DetectLabelsResponseImageProperties.constructFromObject(data['ImageProperties']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['LabelModelVersion']) { // data not null
          String.validateJSON(data['LabelModelVersion']);
        }
        // validate the optional field `ImageProperties`
        if (data['ImageProperties']) { // data not null
          DetectLabelsResponseImageProperties.validateJSON(data['ImageProperties']);
        }
 ...
 * @member {Array} Labels
 */
DetectLabelsResponse.prototype['Labels'] = undefined;

/**
 * @member {module:model/OrientationCorrection} OrientationCorrection
 */
DetectLabelsResponse.prototype['OrientationCorrection'] = undefined;

/**
 * @member {String} LabelModelVersion
 */
DetectLabelsResponse.prototype['LabelModelVersion'] = undefined;

/**
 * @member {module:model/DetectLabelsResponseImageProperties} ImageProperties
 */
DetectLabelsResponse.prototype['ImageProperties'] = undefined;
...
export default DetectLabelsResponse;
