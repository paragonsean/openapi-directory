...
/**
 * The LivenessOutputConfig model module.
 * @module model/LivenessOutputConfig
 * @version 2016-06-27
 */
class LivenessOutputConfig {
    /**
     * Constructs a new <code>LivenessOutputConfig</code>.
     ...
     * @alias module:model/LivenessOutputConfig
     * @param s3Bucket {String} 
     */
    constructor(s3Bucket) { 
        
        LivenessOutputConfig.initialize(this, s3Bucket);
    }
    ...
    /**
     * Constructs a <code>LivenessOutputConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LivenessOutputConfig} obj Optional instance to populate.
     * @return {module:model/LivenessOutputConfig} The populated <code>LivenessOutputConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LivenessOutputConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>LivenessOutputConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LivenessOutputConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LivenessOutputConfig.RequiredProperties) {
...
LivenessOutputConfig.RequiredProperties = ["S3Bucket"];

/**
 * @member {String} S3Bucket
 */
LivenessOutputConfig.prototype['S3Bucket'] = undefined;

/**
 * @member {String} S3KeyPrefix
 */
LivenessOutputConfig.prototype['S3KeyPrefix'] = undefined;
...
export default LivenessOutputConfig;
