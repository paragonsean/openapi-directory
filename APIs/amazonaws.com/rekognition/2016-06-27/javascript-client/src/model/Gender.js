...
class Gender {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Value')) {
                obj['Value'] = ApiClient.convertToType(data['Value'], GenderType);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Value']) { // data not null
          GenderType.validateJSON(data['Value']);
        }
...
/**
 * @member {module:model/GenderType} Value
 */
 ...
 */
Gender.prototype['Confidence'] = undefined;
