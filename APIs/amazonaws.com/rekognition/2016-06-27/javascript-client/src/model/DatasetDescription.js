...
import DatasetDescriptionDatasetStats from './DatasetDescriptionDatasetStats';
import DatasetStatus from './DatasetStatus';
import DatasetStatusMessageCode from './DatasetStatusMessageCode';
...
class DatasetDescription {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('StatusMessageCode')) {
                obj['StatusMessageCode'] = ApiClient.convertToType(data['StatusMessageCode'], DatasetStatusMessageCode);
            }
            if (data.hasOwnProperty('DatasetStats')) {
                obj['DatasetStats'] = DatasetDescriptionDatasetStats.constructFromObject(data['DatasetStats']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['StatusMessageCode']) { // data not null
          DatasetStatusMessageCode.validateJSON(data['StatusMessageCode']);
        }
        // validate the optional field `DatasetStats`
        if (data['DatasetStats']) { // data not null
          DatasetDescriptionDatasetStats.validateJSON(data['DatasetStats']);
        }
...
/**
 * @member {module:model/DatasetStatusMessageCode} StatusMessageCode
 */
DatasetDescription.prototype['StatusMessageCode'] = undefined;

/**
 * @member {module:model/DatasetDescriptionDatasetStats} DatasetStats
 */
DatasetDescription.prototype['DatasetStats'] = undefined;
