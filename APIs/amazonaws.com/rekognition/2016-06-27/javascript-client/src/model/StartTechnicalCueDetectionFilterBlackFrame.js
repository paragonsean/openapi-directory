...
/**
 * The StartTechnicalCueDetectionFilterBlackFrame model module.
 * @module model/StartTechnicalCueDetectionFilterBlackFrame
 * @version 2016-06-27
 */
class StartTechnicalCueDetectionFilterBlackFrame {
    /**
     * Constructs a new <code>StartTechnicalCueDetectionFilterBlackFrame</code>.
     * @alias module:model/StartTechnicalCueDetectionFilterBlackFrame
     * @implements module:model/BlackFrame
     */
    constructor() { 
        BlackFrame.initialize(this);
        StartTechnicalCueDetectionFilterBlackFrame.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartTechnicalCueDetectionFilterBlackFrame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTechnicalCueDetectionFilterBlackFrame} obj Optional instance to populate.
     * @return {module:model/StartTechnicalCueDetectionFilterBlackFrame} The populated <code>StartTechnicalCueDetectionFilterBlackFrame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTechnicalCueDetectionFilterBlackFrame();
            BlackFrame.constructFromObject(data, obj);

            if (data.hasOwnProperty('MaxPixelThreshold')) {
                obj['MaxPixelThreshold'] = ApiClient.convertToType(data['MaxPixelThreshold'], 'Number');
            }
            if (data.hasOwnProperty('MinCoveragePercentage')) {
                obj['MinCoveragePercentage'] = ApiClient.convertToType(data['MinCoveragePercentage'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartTechnicalCueDetectionFilterBlackFrame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTechnicalCueDetectionFilterBlackFrame</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MaxPixelThreshold`
        if (data['MaxPixelThreshold']) { // data not null
          Number.validateJSON(data['MaxPixelThreshold']);
        }
        // validate the optional field `MinCoveragePercentage`
        if (data['MinCoveragePercentage']) { // data not null
          Number.validateJSON(data['MinCoveragePercentage']);
        }
...
/**
 * @member {Number} MaxPixelThreshold
 */
StartTechnicalCueDetectionFilterBlackFrame.prototype['MaxPixelThreshold'] = undefined;

/**
 * @member {Number} MinCoveragePercentage
 */
StartTechnicalCueDetectionFilterBlackFrame.prototype['MinCoveragePercentage'] = undefined;


// Implement BlackFrame interface:
/**
 * @member {Number} MaxPixelThreshold
 */
BlackFrame.prototype['MaxPixelThreshold'] = undefined;
/**
 * @member {Number} MinCoveragePercentage
 */
BlackFrame.prototype['MinCoveragePercentage'] = undefined;




export default StartTechnicalCueDetectionFilterBlackFrame;
