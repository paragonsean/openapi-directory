...
/**
 * The DetectProtectiveEquipmentResponseSummary model module.
 * @module model/DetectProtectiveEquipmentResponseSummary
 * @version 2016-06-27
 */
class DetectProtectiveEquipmentResponseSummary {
    /**
     * Constructs a new <code>DetectProtectiveEquipmentResponseSummary</code>.
     * @alias module:model/DetectProtectiveEquipmentResponseSummary
     * @implements module:model/ProtectiveEquipmentSummary
     */
    constructor() { 
        ProtectiveEquipmentSummary.initialize(this);
        DetectProtectiveEquipmentResponseSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectProtectiveEquipmentResponseSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectProtectiveEquipmentResponseSummary} obj Optional instance to populate.
     * @return {module:model/DetectProtectiveEquipmentResponseSummary} The populated <code>DetectProtectiveEquipmentResponseSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectProtectiveEquipmentResponseSummary();
            ProtectiveEquipmentSummary.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DetectProtectiveEquipmentResponseSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectProtectiveEquipmentResponseSummary</code>.
     */
 ...
 */
DetectProtectiveEquipmentResponseSummary.prototype['PersonsWithRequiredEquipment'] = undefined;

/**
 * @member {Array} PersonsWithoutRequiredEquipment
 */
DetectProtectiveEquipmentResponseSummary.prototype['PersonsWithoutRequiredEquipment'] = undefined;

/**
 * @member {Array} PersonsIndeterminate
 */
DetectProtectiveEquipmentResponseSummary.prototype['PersonsIndeterminate'] = undefined;


// Implement ProtectiveEquipmentSummary interface:
/**
 * @member {Array} PersonsWithRequiredEquipment
 */
...
export default DetectProtectiveEquipmentResponseSummary;
