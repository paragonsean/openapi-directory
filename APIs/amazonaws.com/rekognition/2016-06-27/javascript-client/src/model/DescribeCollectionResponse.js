...
/**
 * The DescribeCollectionResponse model module.
 * @module model/DescribeCollectionResponse
 * @version 2016-06-27
 */
class DescribeCollectionResponse {
    /**
     * Constructs a new <code>DescribeCollectionResponse</code>.
     * @alias module:model/DescribeCollectionResponse
     */
    constructor() { 
        
        DescribeCollectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCollectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCollectionResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCollectionResponse} The populated <code>DescribeCollectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCollectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCollectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCollectionResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FaceCount`
        if (data['FaceCount']) { // data not null
          Number.validateJSON(data['FaceCount']);
        }
 ...
 */
DescribeCollectionResponse.prototype['FaceCount'] = undefined;

/**
 * @member {String} FaceModelVersion
 */
DescribeCollectionResponse.prototype['FaceModelVersion'] = undefined;

/**
 * @member {String} CollectionARN
 */
DescribeCollectionResponse.prototype['CollectionARN'] = undefined;

/**
 * @member {Date} CreationTimestamp
 */
DescribeCollectionResponse.prototype['CreationTimestamp'] = undefined;

/**
 * @member {Number} UserCount
 */
DescribeCollectionResponse.prototype['UserCount'] = undefined;
...
export default DescribeCollectionResponse;
