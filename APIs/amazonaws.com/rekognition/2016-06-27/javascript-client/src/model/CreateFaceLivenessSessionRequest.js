...
/**
 * The CreateFaceLivenessSessionRequest model module.
 * @module model/CreateFaceLivenessSessionRequest
 * @version 2016-06-27
 */
class CreateFaceLivenessSessionRequest {
    /**
     * Constructs a new <code>CreateFaceLivenessSessionRequest</code>.
     * @alias module:model/CreateFaceLivenessSessionRequest
     */
    constructor() { 
        
        CreateFaceLivenessSessionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFaceLivenessSessionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFaceLivenessSessionRequest} obj Optional instance to populate.
     * @return {module:model/CreateFaceLivenessSessionRequest} The populated <code>CreateFaceLivenessSessionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFaceLivenessSessionRequest();

            if (data.hasOwnProperty('KmsKeyId')) {
                obj['KmsKeyId'] = ApiClient.convertToType(data['KmsKeyId'], 'String');
            }
            if (data.hasOwnProperty('Settings')) {
                obj['Settings'] = CreateFaceLivenessSessionRequestSettings.constructFromObject(data['Settings']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFaceLivenessSessionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFaceLivenessSessionRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Settings']) { // data not null
          CreateFaceLivenessSessionRequestSettings.validateJSON(data['Settings']);
        }
 ...
 */
CreateFaceLivenessSessionRequest.prototype['KmsKeyId'] = undefined;

/**
 * @member {module:model/CreateFaceLivenessSessionRequestSettings} Settings
 */
CreateFaceLivenessSessionRequest.prototype['Settings'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
CreateFaceLivenessSessionRequest.prototype['ClientRequestToken'] = undefined;
...
export default CreateFaceLivenessSessionRequest;
