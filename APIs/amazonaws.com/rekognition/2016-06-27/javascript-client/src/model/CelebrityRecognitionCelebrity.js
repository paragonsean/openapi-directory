...
/**
 * The CelebrityRecognitionCelebrity model module.
 * @module model/CelebrityRecognitionCelebrity
 * @version 2016-06-27
 */
class CelebrityRecognitionCelebrity {
    /**
     * Constructs a new <code>CelebrityRecognitionCelebrity</code>.
     * @alias module:model/CelebrityRecognitionCelebrity
     * @implements module:model/CelebrityDetail
     */
    constructor() { 
        CelebrityDetail.initialize(this);
        CelebrityRecognitionCelebrity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CelebrityRecognitionCelebrity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CelebrityRecognitionCelebrity} obj Optional instance to populate.
     * @return {module:model/CelebrityRecognitionCelebrity} The populated <code>CelebrityRecognitionCelebrity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CelebrityRecognitionCelebrity();
            CelebrityDetail.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CelebrityRecognitionCelebrity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CelebrityRecognitionCelebrity</code>.
     */
 ...
 * @member {Array} Urls
 */
CelebrityRecognitionCelebrity.prototype['Urls'] = undefined;

/**
 * @member {String} Name
 */
CelebrityRecognitionCelebrity.prototype['Name'] = undefined;

/**
 * @member {String} Id
 */
CelebrityRecognitionCelebrity.prototype['Id'] = undefined;

/**
 * @member {Number} Confidence
 */
CelebrityRecognitionCelebrity.prototype['Confidence'] = undefined;

/**
 * @member {module:model/CelebrityDetailBoundingBox} BoundingBox
 */
CelebrityRecognitionCelebrity.prototype['BoundingBox'] = undefined;

/**
 * @member {module:model/CelebrityDetailFace} Face
 */
CelebrityRecognitionCelebrity.prototype['Face'] = undefined;

/**
 * @member {module:model/GetCelebrityInfoResponseKnownGender} KnownGender
 */
CelebrityRecognitionCelebrity.prototype['KnownGender'] = undefined;


// Implement CelebrityDetail interface:
/**
 * @member {Array} Urls
 */
...
export default CelebrityRecognitionCelebrity;
