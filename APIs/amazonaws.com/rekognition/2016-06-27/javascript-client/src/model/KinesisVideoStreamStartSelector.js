...
/**
 * The KinesisVideoStreamStartSelector model module.
 * @module model/KinesisVideoStreamStartSelector
 * @version 2016-06-27
 */
class KinesisVideoStreamStartSelector {
    /**
     * Constructs a new <code>KinesisVideoStreamStartSelector</code>.
     ...
     * @alias module:model/KinesisVideoStreamStartSelector
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>KinesisVideoStreamStartSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KinesisVideoStreamStartSelector} obj Optional instance to populate.
     * @return {module:model/KinesisVideoStreamStartSelector} The populated <code>KinesisVideoStreamStartSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KinesisVideoStreamStartSelector();
    ...
    /**
     * Validates the JSON data with respect to <code>KinesisVideoStreamStartSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KinesisVideoStreamStartSelector</code>.
     */
...
export default KinesisVideoStreamStartSelector;
