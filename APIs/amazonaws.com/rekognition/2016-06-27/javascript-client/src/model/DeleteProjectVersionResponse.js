...
/**
 * The DeleteProjectVersionResponse model module.
 * @module model/DeleteProjectVersionResponse
 * @version 2016-06-27
 */
class DeleteProjectVersionResponse {
    /**
     * Constructs a new <code>DeleteProjectVersionResponse</code>.
     * @alias module:model/DeleteProjectVersionResponse
     */
    constructor() { 
        
        DeleteProjectVersionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteProjectVersionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteProjectVersionResponse} obj Optional instance to populate.
     * @return {module:model/DeleteProjectVersionResponse} The populated <code>DeleteProjectVersionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteProjectVersionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteProjectVersionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteProjectVersionResponse</code>.
     */
 ...
 */
DeleteProjectVersionResponse.prototype['Status'] = undefined;
...
export default DeleteProjectVersionResponse;
