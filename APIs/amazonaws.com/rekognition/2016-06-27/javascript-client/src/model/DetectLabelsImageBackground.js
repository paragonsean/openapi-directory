...
/**
 * The DetectLabelsImageBackground model module.
 * @module model/DetectLabelsImageBackground
 * @version 2016-06-27
 */
class DetectLabelsImageBackground {
    /**
     * Constructs a new <code>DetectLabelsImageBackground</code>.
     * The background of the image with regard to image quality and dominant colors.
     * @alias module:model/DetectLabelsImageBackground
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DetectLabelsImageBackground</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectLabelsImageBackground} obj Optional instance to populate.
     * @return {module:model/DetectLabelsImageBackground} The populated <code>DetectLabelsImageBackground</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectLabelsImageBackground();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectLabelsImageBackground</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectLabelsImageBackground</code>.
     */
...
export default DetectLabelsImageBackground;
