...
import StreamProcessingStartSelectorKVSStreamStartSelector from './StreamProcessingStartSelectorKVSStreamStartSelector';

/**
 * The StartStreamProcessorRequestStartSelector model module.
 * @module model/StartStreamProcessorRequestStartSelector
 * @version 2016-06-27
 */
class StartStreamProcessorRequestStartSelector {
    /**
     * Constructs a new <code>StartStreamProcessorRequestStartSelector</code>.
     * @alias module:model/StartStreamProcessorRequestStartSelector
     * @implements module:model/StreamProcessingStartSelector
     */
    constructor() { 
        StreamProcessingStartSelector.initialize(this);
        StartStreamProcessorRequestStartSelector.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartStreamProcessorRequestStartSelector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartStreamProcessorRequestStartSelector} obj Optional instance to populate.
     * @return {module:model/StartStreamProcessorRequestStartSelector} The populated <code>StartStreamProcessorRequestStartSelector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartStreamProcessorRequestStartSelector();
            StreamProcessingStartSelector.constructFromObject(data, obj);

            if (data.hasOwnProperty('KVSStreamStartSelector')) {
                obj['KVSStreamStartSelector'] = StreamProcessingStartSelectorKVSStreamStartSelector.constructFromObject(data['KVSStreamStartSelector']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartStreamProcessorRequestStartSelector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartStreamProcessorRequestStartSelector</code>.
     */
    static validateJSON(data) {
        // validate the optional field `KVSStreamStartSelector`
        if (data['KVSStreamStartSelector']) { // data not null
          StreamProcessingStartSelectorKVSStreamStartSelector.validateJSON(data['KVSStreamStartSelector']);
        }
...
/**
 * @member {module:model/StreamProcessingStartSelectorKVSStreamStartSelector} KVSStreamStartSelector
 */
StartStreamProcessorRequestStartSelector.prototype['KVSStreamStartSelector'] = undefined;


// Implement StreamProcessingStartSelector interface:
/**
 * @member {module:model/StreamProcessingStartSelectorKVSStreamStartSelector} KVSStreamStartSelector
 */
StreamProcessingStartSelector.prototype['KVSStreamStartSelector'] = undefined;




export default StartStreamProcessorRequestStartSelector;
