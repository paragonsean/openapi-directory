...
/**
 * The GetLabelDetectionRequest model module.
 * @module model/GetLabelDetectionRequest
 * @version 2016-06-27
 */
class GetLabelDetectionRequest {
    /**
     * Constructs a new <code>GetLabelDetectionRequest</code>.
     * @alias module:model/GetLabelDetectionRequest
     * @param jobId {String} 
     */
    constructor(jobId) { 
        
        GetLabelDetectionRequest.initialize(this, jobId);
    }
    ...
    /**
     * Constructs a <code>GetLabelDetectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLabelDetectionRequest} obj Optional instance to populate.
     * @return {module:model/GetLabelDetectionRequest} The populated <code>GetLabelDetectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLabelDetectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLabelDetectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLabelDetectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetLabelDetectionRequest.RequiredProperties) {
...
GetLabelDetectionRequest.RequiredProperties = ["JobId"];

/**
 * @member {String} JobId
 */
GetLabelDetectionRequest.prototype['JobId'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetLabelDetectionRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetLabelDetectionRequest.prototype['NextToken'] = undefined;

/**
 * @member {module:model/LabelDetectionSortBy} SortBy
 */
GetLabelDetectionRequest.prototype['SortBy'] = undefined;

/**
 * @member {module:model/LabelDetectionAggregateBy} AggregateBy
 */
GetLabelDetectionRequest.prototype['AggregateBy'] = undefined;
...
export default GetLabelDetectionRequest;
