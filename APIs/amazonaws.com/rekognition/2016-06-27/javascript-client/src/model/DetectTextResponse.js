...
/**
 * The DetectTextResponse model module.
 * @module model/DetectTextResponse
 * @version 2016-06-27
 */
class DetectTextResponse {
    /**
     * Constructs a new <code>DetectTextResponse</code>.
     * @alias module:model/DetectTextResponse
     */
    constructor() { 
        
        DetectTextResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectTextResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectTextResponse} obj Optional instance to populate.
     * @return {module:model/DetectTextResponse} The populated <code>DetectTextResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectTextResponse();

            if (data.hasOwnProperty('TextDetections')) {
                obj['TextDetections'] = ApiClient.convertToType(data['TextDetections'], Array);
            }
            if (data.hasOwnProperty('TextModelVersion')) {
                obj['TextModelVersion'] = ApiClient.convertToType(data['TextModelVersion'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetectTextResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectTextResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `TextDetections`
        if (data['TextDetections']) { // data not null
          Array.validateJSON(data['TextDetections']);
        }
        // validate the optional field `TextModelVersion`
        if (data['TextModelVersion']) { // data not null
          String.validateJSON(data['TextModelVersion']);
        }
...
/**
 * @member {Array} TextDetections
 */
DetectTextResponse.prototype['TextDetections'] = undefined;

/**
 * @member {String} TextModelVersion
 */
DetectTextResponse.prototype['TextModelVersion'] = undefined;
