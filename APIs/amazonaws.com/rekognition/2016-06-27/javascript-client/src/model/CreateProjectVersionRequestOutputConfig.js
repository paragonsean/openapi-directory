...
/**
 * The CreateProjectVersionRequestOutputConfig model module.
 * @module model/CreateProjectVersionRequestOutputConfig
 * @version 2016-06-27
 */
class CreateProjectVersionRequestOutputConfig {
    /**
     * Constructs a new <code>CreateProjectVersionRequestOutputConfig</code>.
     * @alias module:model/CreateProjectVersionRequestOutputConfig
     * @implements module:model/OutputConfig
     */
    constructor() { 
        OutputConfig.initialize(this);
        CreateProjectVersionRequestOutputConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateProjectVersionRequestOutputConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProjectVersionRequestOutputConfig} obj Optional instance to populate.
     * @return {module:model/CreateProjectVersionRequestOutputConfig} The populated <code>CreateProjectVersionRequestOutputConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProjectVersionRequestOutputConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProjectVersionRequestOutputConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProjectVersionRequestOutputConfig</code>.
     */
 ...
 */
CreateProjectVersionRequestOutputConfig.prototype['S3Bucket'] = undefined;

/**
 * @member {String} S3KeyPrefix
 */
CreateProjectVersionRequestOutputConfig.prototype['S3KeyPrefix'] = undefined;
...
export default CreateProjectVersionRequestOutputConfig;
