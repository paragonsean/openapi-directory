...
/**
 * The SearchedFace model module.
 * @module model/SearchedFace
 * @version 2016-06-27
 */
class SearchedFace {
    /**
     * Constructs a new <code>SearchedFace</code>.
     * Provides face metadata such as FaceId, BoundingBox, Confidence of the input face used for search.
     * @alias module:model/SearchedFace
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SearchedFace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchedFace} obj Optional instance to populate.
     * @return {module:model/SearchedFace} The populated <code>SearchedFace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchedFace();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchedFace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchedFace</code>.
     */
