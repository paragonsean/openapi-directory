...
/**
 * The CreateStreamProcessorRequestInput model module.
 * @module model/CreateStreamProcessorRequestInput
 * @version 2016-06-27
 */
class CreateStreamProcessorRequestInput {
    /**
     * Constructs a new <code>CreateStreamProcessorRequestInput</code>.
     * @alias module:model/CreateStreamProcessorRequestInput
     * @implements module:model/StreamProcessorInput
     */
    constructor() { 
        StreamProcessorInput.initialize(this);
        CreateStreamProcessorRequestInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStreamProcessorRequestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamProcessorRequestInput} obj Optional instance to populate.
     * @return {module:model/CreateStreamProcessorRequestInput} The populated <code>CreateStreamProcessorRequestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamProcessorRequestInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamProcessorRequestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamProcessorRequestInput</code>.
     */
 ...
 */
CreateStreamProcessorRequestInput.prototype['KinesisVideoStream'] = undefined;
...
export default CreateStreamProcessorRequestInput;
