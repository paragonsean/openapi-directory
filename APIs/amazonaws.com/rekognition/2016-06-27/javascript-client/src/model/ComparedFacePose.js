...
/**
 * The ComparedFacePose model module.
 * @module model/ComparedFacePose
 * @version 2016-06-27
 */
class ComparedFacePose {
    /**
     * Constructs a new <code>ComparedFacePose</code>.
     * @alias module:model/ComparedFacePose
     * @implements module:model/Pose
     */
    constructor() { 
        Pose.initialize(this);
        ComparedFacePose.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ComparedFacePose</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ComparedFacePose} obj Optional instance to populate.
     * @return {module:model/ComparedFacePose} The populated <code>ComparedFacePose</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ComparedFacePose();
            Pose.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ComparedFacePose</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComparedFacePose</code>.
     */
 ...
 * @member {Number} Roll
 */
ComparedFacePose.prototype['Roll'] = undefined;

/**
 * @member {Number} Yaw
 */
ComparedFacePose.prototype['Yaw'] = undefined;

/**
 * @member {Number} Pitch
 */
ComparedFacePose.prototype['Pitch'] = undefined;


// Implement Pose interface:
/**
 * @member {Number} Roll
 */
...
export default ComparedFacePose;
