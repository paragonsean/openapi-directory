...
/**
 * The CopyProjectVersionResponse model module.
 * @module model/CopyProjectVersionResponse
 * @version 2016-06-27
 */
class CopyProjectVersionResponse {
    /**
     * Constructs a new <code>CopyProjectVersionResponse</code>.
     * @alias module:model/CopyProjectVersionResponse
     */
    constructor() { 
        
        CopyProjectVersionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CopyProjectVersionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyProjectVersionResponse} obj Optional instance to populate.
     * @return {module:model/CopyProjectVersionResponse} The populated <code>CopyProjectVersionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyProjectVersionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyProjectVersionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyProjectVersionResponse</code>.
     */
 ...
 */
CopyProjectVersionResponse.prototype['ProjectVersionArn'] = undefined;
...
export default CopyProjectVersionResponse;
