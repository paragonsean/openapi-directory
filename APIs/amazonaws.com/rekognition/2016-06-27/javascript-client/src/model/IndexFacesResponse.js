...
/**
 * The IndexFacesResponse model module.
 * @module model/IndexFacesResponse
 * @version 2016-06-27
 */
class IndexFacesResponse {
    /**
     * Constructs a new <code>IndexFacesResponse</code>.
     * @alias module:model/IndexFacesResponse
     */
    constructor() { 
        
        IndexFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IndexFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IndexFacesResponse} obj Optional instance to populate.
     * @return {module:model/IndexFacesResponse} The populated <code>IndexFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IndexFacesResponse();

            if (data.hasOwnProperty('FaceRecords')) {
                obj['FaceRecords'] = ApiClient.convertToType(data['FaceRecords'], Array);
            }
            ...
            if (data.hasOwnProperty('UnindexedFaces')) {
                obj['UnindexedFaces'] = ApiClient.convertToType(data['UnindexedFaces'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IndexFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IndexFacesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FaceRecords`
        if (data['FaceRecords']) { // data not null
          Array.validateJSON(data['FaceRecords']);
        }
        ...
        if (data['UnindexedFaces']) { // data not null
          Array.validateJSON(data['UnindexedFaces']);
        }
...
/**
 * @member {Array} FaceRecords
 */
IndexFacesResponse.prototype['FaceRecords'] = undefined;

/**
 * @member {module:model/OrientationCorrection} OrientationCorrection
 */
IndexFacesResponse.prototype['OrientationCorrection'] = undefined;

/**
 * @member {String} FaceModelVersion
 */
IndexFacesResponse.prototype['FaceModelVersion'] = undefined;

/**
 * @member {Array} UnindexedFaces
 */
IndexFacesResponse.prototype['UnindexedFaces'] = undefined;
...
export default IndexFacesResponse;
