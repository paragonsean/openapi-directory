...
import CompareFacesResponseSourceImageFace from './CompareFacesResponseSourceImageFace';
import OrientationCorrection from './OrientationCorrection';

/**
 * The CompareFacesResponse model module.
 * @module model/CompareFacesResponse
 * @version 2016-06-27
 */
class CompareFacesResponse {
    /**
     * Constructs a new <code>CompareFacesResponse</code>.
     * @alias module:model/CompareFacesResponse
     */
    constructor() { 
        
        CompareFacesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompareFacesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompareFacesResponse} obj Optional instance to populate.
     * @return {module:model/CompareFacesResponse} The populated <code>CompareFacesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompareFacesResponse();

            if (data.hasOwnProperty('SourceImageFace')) {
                obj['SourceImageFace'] = CompareFacesResponseSourceImageFace.constructFromObject(data['SourceImageFace']);
            }
            if (data.hasOwnProperty('FaceMatches')) {
                obj['FaceMatches'] = ApiClient.convertToType(data['FaceMatches'], Array);
            }
            if (data.hasOwnProperty('UnmatchedFaces')) {
                obj['UnmatchedFaces'] = ApiClient.convertToType(data['UnmatchedFaces'], Array);
            }
            if (data.hasOwnProperty('SourceImageOrientationCorrection')) {
                obj['SourceImageOrientationCorrection'] = ApiClient.convertToType(data['SourceImageOrientationCorrection'], OrientationCorrection);
            }
            if (data.hasOwnProperty('TargetImageOrientationCorrection')) {
                obj['TargetImageOrientationCorrection'] = ApiClient.convertToType(data['TargetImageOrientationCorrection'], OrientationCorrection);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CompareFacesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompareFacesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SourceImageFace`
        if (data['SourceImageFace']) { // data not null
          CompareFacesResponseSourceImageFace.validateJSON(data['SourceImageFace']);
        }
        ...
        if (data['UnmatchedFaces']) { // data not null
          Array.validateJSON(data['UnmatchedFaces']);
        }
        // validate the optional field `SourceImageOrientationCorrection`
        if (data['SourceImageOrientationCorrection']) { // data not null
          OrientationCorrection.validateJSON(data['SourceImageOrientationCorrection']);
        }
        // validate the optional field `TargetImageOrientationCorrection`
        if (data['TargetImageOrientationCorrection']) { // data not null
          OrientationCorrection.validateJSON(data['TargetImageOrientationCorrection']);
        }
...
/**
 * @member {module:model/CompareFacesResponseSourceImageFace} SourceImageFace
 */
CompareFacesResponse.prototype['SourceImageFace'] = undefined;

/**
 * @member {Array} FaceMatches
 */
CompareFacesResponse.prototype['FaceMatches'] = undefined;

/**
 * @member {Array} UnmatchedFaces
 */
CompareFacesResponse.prototype['UnmatchedFaces'] = undefined;

/**
 * @member {module:model/OrientationCorrection} SourceImageOrientationCorrection
 */
CompareFacesResponse.prototype['SourceImageOrientationCorrection'] = undefined;

/**
 * @member {module:model/OrientationCorrection} TargetImageOrientationCorrection
 */
CompareFacesResponse.prototype['TargetImageOrientationCorrection'] = undefined;
...
export default CompareFacesResponse;
