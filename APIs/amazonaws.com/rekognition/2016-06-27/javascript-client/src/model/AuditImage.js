...
/**
 * The AuditImage model module.
 * @module model/AuditImage
 * @version 2016-06-27
 */
class AuditImage {
    /**
     * Constructs a new <code>AuditImage</code>.
    ...
    /**
     * Constructs a <code>AuditImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuditImage} obj Optional instance to populate.
     * @return {module:model/AuditImage} The populated <code>AuditImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuditImage();
    ...
    /**
     * Validates the JSON data with respect to <code>AuditImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuditImage</code>.
     */
