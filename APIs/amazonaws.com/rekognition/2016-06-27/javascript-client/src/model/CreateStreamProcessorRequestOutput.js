...
import StreamProcessorOutputKinesisDataStream from './StreamProcessorOutputKinesisDataStream';
import StreamProcessorOutputS3Destination from './StreamProcessorOutputS3Destination';

/**
 * The CreateStreamProcessorRequestOutput model module.
 * @module model/CreateStreamProcessorRequestOutput
 * @version 2016-06-27
 */
class CreateStreamProcessorRequestOutput {
    /**
     * Constructs a new <code>CreateStreamProcessorRequestOutput</code>.
     * @alias module:model/CreateStreamProcessorRequestOutput
     * @implements module:model/StreamProcessorOutput
     */
    constructor() { 
        StreamProcessorOutput.initialize(this);
        CreateStreamProcessorRequestOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStreamProcessorRequestOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamProcessorRequestOutput} obj Optional instance to populate.
     * @return {module:model/CreateStreamProcessorRequestOutput} The populated <code>CreateStreamProcessorRequestOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamProcessorRequestOutput();
            StreamProcessorOutput.constructFromObject(data, obj);

            if (data.hasOwnProperty('KinesisDataStream')) {
                obj['KinesisDataStream'] = StreamProcessorOutputKinesisDataStream.constructFromObject(data['KinesisDataStream']);
            }
            if (data.hasOwnProperty('S3Destination')) {
                obj['S3Destination'] = StreamProcessorOutputS3Destination.constructFromObject(data['S3Destination']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamProcessorRequestOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamProcessorRequestOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `KinesisDataStream`
        if (data['KinesisDataStream']) { // data not null
          StreamProcessorOutputKinesisDataStream.validateJSON(data['KinesisDataStream']);
        }
        // validate the optional field `S3Destination`
        if (data['S3Destination']) { // data not null
          StreamProcessorOutputS3Destination.validateJSON(data['S3Destination']);
        }
...
/**
 * @member {module:model/StreamProcessorOutputKinesisDataStream} KinesisDataStream
 */
CreateStreamProcessorRequestOutput.prototype['KinesisDataStream'] = undefined;

/**
 * @member {module:model/StreamProcessorOutputS3Destination} S3Destination
 */
CreateStreamProcessorRequestOutput.prototype['S3Destination'] = undefined;


// Implement StreamProcessorOutput interface:
/**
 * @member {module:model/StreamProcessorOutputKinesisDataStream} KinesisDataStream
 */
StreamProcessorOutput.prototype['KinesisDataStream'] = undefined;
/**
 * @member {module:model/StreamProcessorOutputS3Destination} S3Destination
 */
StreamProcessorOutput.prototype['S3Destination'] = undefined;




export default CreateStreamProcessorRequestOutput;
