...
/**
 * The CoversBodyPart model module.
 * @module model/CoversBodyPart
 * @version 2016-06-27
 */
class CoversBodyPart {
    /**
     * Constructs a new <code>CoversBodyPart</code>.
     ...
     * @alias module:model/CoversBodyPart
     */
    constructor() { 
        
        CoversBodyPart.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CoversBodyPart</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CoversBodyPart} obj Optional instance to populate.
     * @return {module:model/CoversBodyPart} The populated <code>CoversBodyPart</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CoversBodyPart();
    ...
    /**
     * Validates the JSON data with respect to <code>CoversBodyPart</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CoversBodyPart</code>.
     */
 ...
 */
CoversBodyPart.prototype['Confidence'] = undefined;

/**
 * @member {Boolean} Value
 */
CoversBodyPart.prototype['Value'] = undefined;
