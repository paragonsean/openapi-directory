...
/**
 * The StartSegmentDetectionResponse model module.
 * @module model/StartSegmentDetectionResponse
 * @version 2016-06-27
 */
class StartSegmentDetectionResponse {
    /**
     * Constructs a new <code>StartSegmentDetectionResponse</code>.
     * @alias module:model/StartSegmentDetectionResponse
     */
    constructor() { 
        
        StartSegmentDetectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartSegmentDetectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSegmentDetectionResponse} obj Optional instance to populate.
     * @return {module:model/StartSegmentDetectionResponse} The populated <code>StartSegmentDetectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSegmentDetectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartSegmentDetectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSegmentDetectionResponse</code>.
     */
 ...
 * @member {String} JobId
 */
StartSegmentDetectionResponse.prototype['JobId'] = undefined;
...
export default StartSegmentDetectionResponse;
