...
/**
 * The DetectTextRequestImage model module.
 * @module model/DetectTextRequestImage
 * @version 2016-06-27
 */
class DetectTextRequestImage {
    /**
     * Constructs a new <code>DetectTextRequestImage</code>.
     * @alias module:model/DetectTextRequestImage
     * @implements module:model/Image
     */
    constructor() { 
        Image.initialize(this);
        DetectTextRequestImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetectTextRequestImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetectTextRequestImage} obj Optional instance to populate.
     * @return {module:model/DetectTextRequestImage} The populated <code>DetectTextRequestImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetectTextRequestImage();
    ...
    /**
     * Validates the JSON data with respect to <code>DetectTextRequestImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetectTextRequestImage</code>.
     */
 ...
 * @member {String} Bytes
 */
DetectTextRequestImage.prototype['Bytes'] = undefined;

/**
 * @member {module:model/ImageS3Object} S3Object
 */
DetectTextRequestImage.prototype['S3Object'] = undefined;
...
export default DetectTextRequestImage;
