...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CelebrityRecognitionCelebrity();
  });
  ...
  describe('CelebrityRecognitionCelebrity', function() {
    it('should create an instance of CelebrityRecognitionCelebrity', function() {
      // uncomment below and update the code to test CelebrityRecognitionCelebrity
      //var instance = new AmazonRekognition.CelebrityRecognitionCelebrity();
      //expect(instance).to.be.a(AmazonRekognition.CelebrityRecognitionCelebrity);
    });
    ...
    it('should have the property knownGender (base name: "KnownGender")', function() {
      // uncomment below and update the code to test the property knownGender
      //var instance = new AmazonRekognition.CelebrityRecognitionCelebrity();
      //expect(instance).to.be();
    });
