...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CelebrityDetail();
  });
  ...
  describe('CelebrityDetail', function() {
    it('should create an instance of CelebrityDetail', function() {
      // uncomment below and update the code to test CelebrityDetail
      //var instance = new AmazonRekognition.CelebrityDetail();
      //expect(instance).to.be.a(AmazonRekognition.CelebrityDetail);
    });
