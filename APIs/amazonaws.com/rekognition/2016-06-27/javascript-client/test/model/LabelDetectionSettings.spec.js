...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.LabelDetectionSettings();
  });
  ...
  describe('LabelDetectionSettings', function() {
    it('should create an instance of LabelDetectionSettings', function() {
      // uncomment below and update the code to test LabelDetectionSettings
      //var instance = new AmazonRekognition.LabelDetectionSettings();
      //expect(instance).to.be.a(AmazonRekognition.LabelDetectionSettings);
    });

    it('should have the property generalLabels (base name: "GeneralLabels")', function() {
      // uncomment below and update the code to test the property generalLabels
      //var instance = new AmazonRekognition.LabelDetectionSettings();
