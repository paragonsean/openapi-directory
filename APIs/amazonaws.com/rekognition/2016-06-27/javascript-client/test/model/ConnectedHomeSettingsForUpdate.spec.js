...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ConnectedHomeSettingsForUpdate();
  });
  ...
  describe('ConnectedHomeSettingsForUpdate', function() {
    it('should create an instance of ConnectedHomeSettingsForUpdate', function() {
      // uncomment below and update the code to test ConnectedHomeSettingsForUpdate
      //var instance = new AmazonRekognition.ConnectedHomeSettingsForUpdate();
      //expect(instance).to.be.a(AmazonRekognition.ConnectedHomeSettingsForUpdate);
    });
