...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ComparedFacePose();
  });
  ...
  describe('ComparedFacePose', function() {
    it('should create an instance of ComparedFacePose', function() {
      // uncomment below and update the code to test ComparedFacePose
      //var instance = new AmazonRekognition.ComparedFacePose();
      //expect(instance).to.be.a(AmazonRekognition.ComparedFacePose);
    });
