...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectTextFilters();
  });
  ...
  describe('DetectTextFilters', function() {
    it('should create an instance of DetectTextFilters', function() {
      // uncomment below and update the code to test DetectTextFilters
      //var instance = new AmazonRekognition.DetectTextFilters();
      //expect(instance).to.be.a(AmazonRekognition.DetectTextFilters);
    });
