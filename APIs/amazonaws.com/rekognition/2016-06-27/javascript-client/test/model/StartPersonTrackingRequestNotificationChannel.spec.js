...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartPersonTrackingRequestNotificationChannel();
  });
  ...
  describe('StartPersonTrackingRequestNotificationChannel', function() {
    it('should create an instance of StartPersonTrackingRequestNotificationChannel', function() {
      // uncomment below and update the code to test StartPersonTrackingRequestNotificationChannel
      //var instance = new AmazonRekognition.StartPersonTrackingRequestNotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.StartPersonTrackingRequestNotificationChannel);
    });
