...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartContentModerationRequestVideo();
  });
  ...
  describe('StartContentModerationRequestVideo', function() {
    it('should create an instance of StartContentModerationRequestVideo', function() {
      // uncomment below and update the code to test StartContentModerationRequestVideo
      //var instance = new AmazonRekognition.StartContentModerationRequestVideo();
      //expect(instance).to.be.a(AmazonRekognition.StartContentModerationRequestVideo);
    });
