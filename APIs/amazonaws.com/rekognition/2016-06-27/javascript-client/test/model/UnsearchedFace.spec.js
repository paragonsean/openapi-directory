...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UnsearchedFace();
  });
  ...
  describe('UnsearchedFace', function() {
    it('should create an instance of UnsearchedFace', function() {
      // uncomment below and update the code to test UnsearchedFace
      //var instance = new AmazonRekognition.UnsearchedFace();
      //expect(instance).to.be.a(AmazonRekognition.UnsearchedFace);
    });
