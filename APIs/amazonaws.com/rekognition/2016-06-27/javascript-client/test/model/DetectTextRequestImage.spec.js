...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectTextRequestImage();
  });
  ...
  describe('DetectTextRequestImage', function() {
    it('should create an instance of DetectTextRequestImage', function() {
      // uncomment below and update the code to test DetectTextRequestImage
      //var instance = new AmazonRekognition.DetectTextRequestImage();
      //expect(instance).to.be.a(AmazonRekognition.DetectTextRequestImage);
    });
