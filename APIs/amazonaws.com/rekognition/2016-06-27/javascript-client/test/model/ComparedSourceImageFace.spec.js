...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ComparedSourceImageFace();
  });
  ...
  describe('ComparedSourceImageFace', function() {
    it('should create an instance of ComparedSourceImageFace', function() {
      // uncomment below and update the code to test ComparedSourceImageFace
      //var instance = new AmazonRekognition.ComparedSourceImageFace();
      //expect(instance).to.be.a(AmazonRekognition.ComparedSourceImageFace);
    });
