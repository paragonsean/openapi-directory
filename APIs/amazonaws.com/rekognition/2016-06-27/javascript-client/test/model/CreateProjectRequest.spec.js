...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateProjectRequest();
  });
  ...
  describe('CreateProjectRequest', function() {
    it('should create an instance of CreateProjectRequest', function() {
      ...
      //var instance = new AmazonRekognition.CreateProjectRequest();
      //expect(instance).to.be.a(AmazonRekognition.CreateProjectRequest);
    });
