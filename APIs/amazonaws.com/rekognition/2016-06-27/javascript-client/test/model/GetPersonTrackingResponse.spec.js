...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetPersonTrackingResponse();
  });
  ...
  describe('GetPersonTrackingResponse', function() {
    it('should create an instance of GetPersonTrackingResponse', function() {
      // uncomment below and update the code to test GetPersonTrackingResponse
      //var instance = new AmazonRekognition.GetPersonTrackingResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetPersonTrackingResponse);
    });
