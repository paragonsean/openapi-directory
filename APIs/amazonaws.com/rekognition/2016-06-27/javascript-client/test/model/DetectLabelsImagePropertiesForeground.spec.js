...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImagePropertiesForeground();
  });
  ...
  describe('DetectLabelsImagePropertiesForeground', function() {
    it('should create an instance of DetectLabelsImagePropertiesForeground', function() {
      // uncomment below and update the code to test DetectLabelsImagePropertiesForeground
      //var instance = new AmazonRekognition.DetectLabelsImagePropertiesForeground();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImagePropertiesForeground);
    });
