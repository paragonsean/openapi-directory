...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetDescription();
  });
  ...
  describe('DatasetDescription', function() {
    it('should create an instance of DatasetDescription', function() {
      // uncomment below and update the code to test DatasetDescription
      //var instance = new AmazonRekognition.DatasetDescription();
      //expect(instance).to.be.a(AmazonRekognition.DatasetDescription);
    });
