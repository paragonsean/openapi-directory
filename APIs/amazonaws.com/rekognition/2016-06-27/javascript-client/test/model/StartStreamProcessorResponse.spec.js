...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartStreamProcessorResponse();
  });
  ...
  describe('StartStreamProcessorResponse', function() {
    it('should create an instance of StartStreamProcessorResponse', function() {
      // uncomment below and update the code to test StartStreamProcessorResponse
      //var instance = new AmazonRekognition.StartStreamProcessorResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartStreamProcessorResponse);
    });
