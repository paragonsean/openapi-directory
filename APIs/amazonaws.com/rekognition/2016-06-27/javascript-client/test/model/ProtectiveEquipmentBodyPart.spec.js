...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProtectiveEquipmentBodyPart();
  });
  ...
  describe('ProtectiveEquipmentBodyPart', function() {
    it('should create an instance of ProtectiveEquipmentBodyPart', function() {
      // uncomment below and update the code to test ProtectiveEquipmentBodyPart
      //var instance = new AmazonRekognition.ProtectiveEquipmentBodyPart();
      //expect(instance).to.be.a(AmazonRekognition.ProtectiveEquipmentBodyPart);
    });
    ...
    it('should have the property equipmentDetections (base name: "EquipmentDetections")', function() {
      // uncomment below and update the code to test the property equipmentDetections
      //var instance = new AmazonRekognition.ProtectiveEquipmentBodyPart();
      //expect(instance).to.be();
    });
