...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectModerationLabelsResponse();
  });
  ...
  describe('DetectModerationLabelsResponse', function() {
    it('should create an instance of DetectModerationLabelsResponse', function() {
      // uncomment below and update the code to test DetectModerationLabelsResponse
      //var instance = new AmazonRekognition.DetectModerationLabelsResponse();
      //expect(instance).to.be.a(AmazonRekognition.DetectModerationLabelsResponse);
    });
