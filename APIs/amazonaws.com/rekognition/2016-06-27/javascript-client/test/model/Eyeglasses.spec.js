...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.Eyeglasses();
  });
  ...
  describe('Eyeglasses', function() {
    it('should create an instance of Eyeglasses', function() {
      // uncomment below and update the code to test Eyeglasses
      //var instance = new AmazonRekognition.Eyeglasses();
      //expect(instance).to.be.a(AmazonRekognition.Eyeglasses);
    });
