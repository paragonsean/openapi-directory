...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonRekognition.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListTagsForResourceResponse);
    });
