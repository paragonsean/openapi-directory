...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CustomLabel();
  });
  ...
  describe('CustomLabel', function() {
    it('should create an instance of CustomLabel', function() {
      // uncomment below and update the code to test CustomLabel
      //var instance = new AmazonRekognition.CustomLabel();
      //expect(instance).to.be.a(AmazonRekognition.CustomLabel);
    });
