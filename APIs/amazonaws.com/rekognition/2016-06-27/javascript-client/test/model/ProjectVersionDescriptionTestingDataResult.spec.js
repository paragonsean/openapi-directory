...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectVersionDescriptionTestingDataResult();
  });
  ...
  describe('ProjectVersionDescriptionTestingDataResult', function() {
    it('should create an instance of ProjectVersionDescriptionTestingDataResult', function() {
      // uncomment below and update the code to test ProjectVersionDescriptionTestingDataResult
      //var instance = new AmazonRekognition.ProjectVersionDescriptionTestingDataResult();
      //expect(instance).to.be.a(AmazonRekognition.ProjectVersionDescriptionTestingDataResult);
    });
