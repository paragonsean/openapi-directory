...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeProjectVersionsRequest();
  });
  ...
  describe('DescribeProjectVersionsRequest', function() {
    it('should create an instance of DescribeProjectVersionsRequest', function() {
      // uncomment below and update the code to test DescribeProjectVersionsRequest
      //var instance = new AmazonRekognition.DescribeProjectVersionsRequest();
      //expect(instance).to.be.a(AmazonRekognition.DescribeProjectVersionsRequest);
    });
    ...
    it('should have the property versionNames (base name: "VersionNames")', function() {
      // uncomment below and update the code to test the property versionNames
      //var instance = new AmazonRekognition.DescribeProjectVersionsRequest();
      //expect(instance).to.be();
    });
