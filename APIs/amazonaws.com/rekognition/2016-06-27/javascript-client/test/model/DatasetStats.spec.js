...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetStats();
  });
  ...
  describe('DatasetStats', function() {
    it('should create an instance of DatasetStats', function() {
      // uncomment below and update the code to test DatasetStats
      //var instance = new AmazonRekognition.DatasetStats();
      //expect(instance).to.be.a(AmazonRekognition.DatasetStats);
    });

    it('should have the property labeledEntries (base name: "LabeledEntries")', function() {
      // uncomment below and update the code to test the property labeledEntries
      //var instance = new AmazonRekognition.DatasetStats();
      //expect(instance).to.be();
    });

    it('should have the property totalEntries (base name: "TotalEntries")', function() {
    ...
    it('should have the property errorEntries (base name: "ErrorEntries")', function() {
      // uncomment below and update the code to test the property errorEntries
      //var instance = new AmazonRekognition.DatasetStats();
      //expect(instance).to.be();
    });
