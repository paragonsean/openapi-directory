...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UnsuccessfulFaceAssociation();
  });
  ...
  describe('UnsuccessfulFaceAssociation', function() {
    it('should create an instance of UnsuccessfulFaceAssociation', function() {
      // uncomment below and update the code to test UnsuccessfulFaceAssociation
      //var instance = new AmazonRekognition.UnsuccessfulFaceAssociation();
      //expect(instance).to.be.a(AmazonRekognition.UnsuccessfulFaceAssociation);
    });
