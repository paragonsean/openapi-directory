...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImageBackground();
  });
  ...
  describe('DetectLabelsImageBackground', function() {
    it('should create an instance of DetectLabelsImageBackground', function() {
      // uncomment below and update the code to test DetectLabelsImageBackground
      //var instance = new AmazonRekognition.DetectLabelsImageBackground();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImageBackground);
    });
