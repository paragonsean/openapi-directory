...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailBeard();
  });
  ...
  describe('FaceDetailBeard', function() {
    it('should create an instance of FaceDetailBeard', function() {
      // uncomment below and update the code to test FaceDetailBeard
      //var instance = new AmazonRekognition.FaceDetailBeard();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailBeard);
    });
