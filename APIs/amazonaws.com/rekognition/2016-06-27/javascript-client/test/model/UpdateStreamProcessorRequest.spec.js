...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UpdateStreamProcessorRequest();
  });
  ...
  describe('UpdateStreamProcessorRequest', function() {
    it('should create an instance of UpdateStreamProcessorRequest', function() {
      // uncomment below and update the code to test UpdateStreamProcessorRequest
      //var instance = new AmazonRekognition.UpdateStreamProcessorRequest();
      //expect(instance).to.be.a(AmazonRekognition.UpdateStreamProcessorRequest);
    });
    ...
    it('should have the property settingsForUpdate (base name: "SettingsForUpdate")', function() {
      // uncomment below and update the code to test the property settingsForUpdate
      //var instance = new AmazonRekognition.UpdateStreamProcessorRequest();
      //expect(instance).to.be();
    });

    it('should have the property regionsOfInterestForUpdate (base name: "RegionsOfInterestForUpdate")', function() {
      // uncomment below and update the code to test the property regionsOfInterestForUpdate
      //var instance = new AmazonRekognition.UpdateStreamProcessorRequest();
      //expect(instance).to.be();
    });

    it('should have the property dataSharingPreferenceForUpdate (base name: "DataSharingPreferenceForUpdate")', function() {
      // uncomment below and update the code to test the property dataSharingPreferenceForUpdate
      //var instance = new AmazonRekognition.UpdateStreamProcessorRequest();
      //expect(instance).to.be();
    });

    it('should have the property parametersToDelete (base name: "ParametersToDelete")', function() {
      // uncomment below and update the code to test the property parametersToDelete
      //var instance = new AmazonRekognition.UpdateStreamProcessorRequest();
      //expect(instance).to.be();
    });
