...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CompareFacesRequestTargetImage();
  });
  ...
  describe('CompareFacesRequestTargetImage', function() {
    it('should create an instance of CompareFacesRequestTargetImage', function() {
      // uncomment below and update the code to test CompareFacesRequestTargetImage
      //var instance = new AmazonRekognition.CompareFacesRequestTargetImage();
      //expect(instance).to.be.a(AmazonRekognition.CompareFacesRequestTargetImage);
    });
