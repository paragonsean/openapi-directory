...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateFaceLivenessSessionRequest();
  });
  ...
  describe('CreateFaceLivenessSessionRequest', function() {
    it('should create an instance of CreateFaceLivenessSessionRequest', function() {
      // uncomment below and update the code to test CreateFaceLivenessSessionRequest
      //var instance = new AmazonRekognition.CreateFaceLivenessSessionRequest();
      //expect(instance).to.be.a(AmazonRekognition.CreateFaceLivenessSessionRequest);
    });
