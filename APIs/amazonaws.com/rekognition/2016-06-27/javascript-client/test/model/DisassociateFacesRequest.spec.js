...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DisassociateFacesRequest();
  });
  ...
  describe('DisassociateFacesRequest', function() {
    it('should create an instance of DisassociateFacesRequest', function() {
      // uncomment below and update the code to test DisassociateFacesRequest
      //var instance = new AmazonRekognition.DisassociateFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.DisassociateFacesRequest);
    });
