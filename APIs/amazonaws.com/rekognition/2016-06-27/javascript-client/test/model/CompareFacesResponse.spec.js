...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CompareFacesResponse();
  });
  ...
  describe('CompareFacesResponse', function() {
    it('should create an instance of CompareFacesResponse', function() {
      // uncomment below and update the code to test CompareFacesResponse
      //var instance = new AmazonRekognition.CompareFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.CompareFacesResponse);
    });

    it('should have the property sourceImageFace (base name: "SourceImageFace")', function() {
      // uncomment below and update the code to test the property sourceImageFace
      //var instance = new AmazonRekognition.CompareFacesResponse();
      //expect(instance).to.be();
    });

    it('should have the property faceMatches (base name: "FaceMatches")', function() {
      // uncomment below and update the code to test the property faceMatches
      //var instance = new AmazonRekognition.CompareFacesResponse();
      //expect(instance).to.be();
    });

    it('should have the property unmatchedFaces (base name: "UnmatchedFaces")', function() {
      // uncomment below and update the code to test the property unmatchedFaces
      //var instance = new AmazonRekognition.CompareFacesResponse();
      //expect(instance).to.be();
    });

    it('should have the property sourceImageOrientationCorrection (base name: "SourceImageOrientationCorrection")', function() {
      // uncomment below and update the code to test the property sourceImageOrientationCorrection
      //var instance = new AmazonRekognition.CompareFacesResponse();
      //expect(instance).to.be();
    });

    it('should have the property targetImageOrientationCorrection (base name: "TargetImageOrientationCorrection")', function() {
      // uncomment below and update the code to test the property targetImageOrientationCorrection
      //var instance = new AmazonRekognition.CompareFacesResponse();
      //expect(instance).to.be();
    });
