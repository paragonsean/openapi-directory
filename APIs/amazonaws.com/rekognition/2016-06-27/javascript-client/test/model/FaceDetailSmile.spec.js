...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailSmile();
  });
  ...
  describe('FaceDetailSmile', function() {
    it('should create an instance of FaceDetailSmile', function() {
      // uncomment below and update the code to test FaceDetailSmile
      //var instance = new AmazonRekognition.FaceDetailSmile();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailSmile);
    });
