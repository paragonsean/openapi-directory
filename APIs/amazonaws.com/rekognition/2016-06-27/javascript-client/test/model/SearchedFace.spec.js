...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchedFace();
  });
  ...
  describe('SearchedFace', function() {
    it('should create an instance of SearchedFace', function() {
      // uncomment below and update the code to test SearchedFace
      //var instance = new AmazonRekognition.SearchedFace();
      //expect(instance).to.be.a(AmazonRekognition.SearchedFace);
    });
