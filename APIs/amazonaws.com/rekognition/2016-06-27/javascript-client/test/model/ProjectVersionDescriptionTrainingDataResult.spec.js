...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectVersionDescriptionTrainingDataResult();
  });
  ...
  describe('ProjectVersionDescriptionTrainingDataResult', function() {
    it('should create an instance of ProjectVersionDescriptionTrainingDataResult', function() {
      // uncomment below and update the code to test ProjectVersionDescriptionTrainingDataResult
      //var instance = new AmazonRekognition.ProjectVersionDescriptionTrainingDataResult();
      //expect(instance).to.be.a(AmazonRekognition.ProjectVersionDescriptionTrainingDataResult);
    });
