...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchUsersByImageRequest();
  });
  ...
  describe('SearchUsersByImageRequest', function() {
    it('should create an instance of SearchUsersByImageRequest', function() {
      // uncomment below and update the code to test SearchUsersByImageRequest
      //var instance = new AmazonRekognition.SearchUsersByImageRequest();
      //expect(instance).to.be.a(AmazonRekognition.SearchUsersByImageRequest);
    });
