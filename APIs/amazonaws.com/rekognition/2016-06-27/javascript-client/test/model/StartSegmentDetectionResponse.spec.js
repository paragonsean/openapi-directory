...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartSegmentDetectionResponse();
  });
  ...
  describe('StartSegmentDetectionResponse', function() {
    it('should create an instance of StartSegmentDetectionResponse', function() {
      // uncomment below and update the code to test StartSegmentDetectionResponse
      //var instance = new AmazonRekognition.StartSegmentDetectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartSegmentDetectionResponse);
    });
