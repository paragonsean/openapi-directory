...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessingStopSelector();
  });
  ...
  describe('StreamProcessingStopSelector', function() {
    it('should create an instance of StreamProcessingStopSelector', function() {
      // uncomment below and update the code to test StreamProcessingStopSelector
      //var instance = new AmazonRekognition.StreamProcessingStopSelector();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessingStopSelector);
    });
