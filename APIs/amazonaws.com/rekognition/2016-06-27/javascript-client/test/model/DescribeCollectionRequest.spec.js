...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeCollectionRequest();
  });
  ...
  describe('DescribeCollectionRequest', function() {
    it('should create an instance of DescribeCollectionRequest', function() {
      // uncomment below and update the code to test DescribeCollectionRequest
      //var instance = new AmazonRekognition.DescribeCollectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.DescribeCollectionRequest);
    });
