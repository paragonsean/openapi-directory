...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetPersonTrackingRequest();
  });
  ...
  describe('GetPersonTrackingRequest', function() {
    it('should create an instance of GetPersonTrackingRequest', function() {
      // uncomment below and update the code to test GetPersonTrackingRequest
      //var instance = new AmazonRekognition.GetPersonTrackingRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetPersonTrackingRequest);
    });
