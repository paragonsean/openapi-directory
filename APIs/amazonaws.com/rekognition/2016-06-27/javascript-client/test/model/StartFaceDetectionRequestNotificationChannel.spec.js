...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceDetectionRequestNotificationChannel();
  });
  ...
  describe('StartFaceDetectionRequestNotificationChannel', function() {
    it('should create an instance of StartFaceDetectionRequestNotificationChannel', function() {
      // uncomment below and update the code to test StartFaceDetectionRequestNotificationChannel
      //var instance = new AmazonRekognition.StartFaceDetectionRequestNotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceDetectionRequestNotificationChannel);
    });
