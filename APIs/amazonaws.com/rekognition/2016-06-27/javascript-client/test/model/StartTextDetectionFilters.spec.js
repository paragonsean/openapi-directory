...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartTextDetectionFilters();
  });
  ...
  describe('StartTextDetectionFilters', function() {
    it('should create an instance of StartTextDetectionFilters', function() {
      // uncomment below and update the code to test StartTextDetectionFilters
      //var instance = new AmazonRekognition.StartTextDetectionFilters();
      //expect(instance).to.be.a(AmazonRekognition.StartTextDetectionFilters);
    });
