...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetContentModerationResponseVideoMetadata();
  });
  ...
  describe('GetContentModerationResponseVideoMetadata', function() {
    it('should create an instance of GetContentModerationResponseVideoMetadata', function() {
      // uncomment below and update the code to test GetContentModerationResponseVideoMetadata
      //var instance = new AmazonRekognition.GetContentModerationResponseVideoMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetContentModerationResponseVideoMetadata);
    });
