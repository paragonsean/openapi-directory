...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailGender();
  });
  ...
  describe('FaceDetailGender', function() {
    it('should create an instance of FaceDetailGender', function() {
      // uncomment below and update the code to test FaceDetailGender
      //var instance = new AmazonRekognition.FaceDetailGender();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailGender);
    });
