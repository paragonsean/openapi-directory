...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.EyeDirection();
  });
  ...
  describe('EyeDirection', function() {
    it('should create an instance of EyeDirection', function() {
      // uncomment below and update the code to test EyeDirection
      //var instance = new AmazonRekognition.EyeDirection();
      //expect(instance).to.be.a(AmazonRekognition.EyeDirection);
    });
