...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TextDetectionResult();
  });
  ...
  describe('TextDetectionResult', function() {
    it('should create an instance of TextDetectionResult', function() {
      ...
      //var instance = new AmazonRekognition.TextDetectionResult();
      //expect(instance).to.be.a(AmazonRekognition.TextDetectionResult);
    });
    ...
    it('should have the property textDetection (base name: "TextDetection")', function() {
      // uncomment below and update the code to test the property textDetection
      //var instance = new AmazonRekognition.TextDetectionResult();
      //expect(instance).to.be();
    });
