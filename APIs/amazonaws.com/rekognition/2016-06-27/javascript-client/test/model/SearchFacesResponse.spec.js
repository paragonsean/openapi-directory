...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchFacesResponse();
  });
  ...
  describe('SearchFacesResponse', function() {
    it('should create an instance of SearchFacesResponse', function() {
      // uncomment below and update the code to test SearchFacesResponse
      //var instance = new AmazonRekognition.SearchFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.SearchFacesResponse);
    });

    it('should have the property searchedFaceId (base name: "SearchedFaceId")', function() {
      // uncomment below and update the code to test the property searchedFaceId
      //var instance = new AmazonRekognition.SearchFacesResponse();
