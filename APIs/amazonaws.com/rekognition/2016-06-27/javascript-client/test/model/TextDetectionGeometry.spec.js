...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TextDetectionGeometry();
  });
  ...
  describe('TextDetectionGeometry', function() {
    it('should create an instance of TextDetectionGeometry', function() {
      // uncomment below and update the code to test TextDetectionGeometry
      //var instance = new AmazonRekognition.TextDetectionGeometry();
      //expect(instance).to.be.a(AmazonRekognition.TextDetectionGeometry);
    });
