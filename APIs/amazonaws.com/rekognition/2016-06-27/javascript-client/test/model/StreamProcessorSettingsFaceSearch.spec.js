...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorSettingsFaceSearch();
  });
  ...
  describe('StreamProcessorSettingsFaceSearch', function() {
    it('should create an instance of StreamProcessorSettingsFaceSearch', function() {
      // uncomment below and update the code to test StreamProcessorSettingsFaceSearch
      //var instance = new AmazonRekognition.StreamProcessorSettingsFaceSearch();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorSettingsFaceSearch);
    });
