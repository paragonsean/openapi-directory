...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceDetectionRequest();
  });
  ...
  describe('GetFaceDetectionRequest', function() {
    it('should create an instance of GetFaceDetectionRequest', function() {
      // uncomment below and update the code to test GetFaceDetectionRequest
      //var instance = new AmazonRekognition.GetFaceDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceDetectionRequest);
    });
