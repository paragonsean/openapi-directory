...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.RecognizeCelebritiesResponse();
  });
  ...
  describe('RecognizeCelebritiesResponse', function() {
    it('should create an instance of RecognizeCelebritiesResponse', function() {
      // uncomment below and update the code to test RecognizeCelebritiesResponse
      //var instance = new AmazonRekognition.RecognizeCelebritiesResponse();
      //expect(instance).to.be.a(AmazonRekognition.RecognizeCelebritiesResponse);
    });

    it('should have the property celebrityFaces (base name: "CelebrityFaces")', function() {
      // uncomment below and update the code to test the property celebrityFaces
      //var instance = new AmazonRekognition.RecognizeCelebritiesResponse();
      //expect(instance).to.be();
    });

    it('should have the property unrecognizedFaces (base name: "UnrecognizedFaces")', function() {
      // uncomment below and update the code to test the property unrecognizedFaces
      //var instance = new AmazonRekognition.RecognizeCelebritiesResponse();
      //expect(instance).to.be();
    });

    it('should have the property orientationCorrection (base name: "OrientationCorrection")', function() {
      // uncomment below and update the code to test the property orientationCorrection
      //var instance = new AmazonRekognition.RecognizeCelebritiesResponse();
      //expect(instance).to.be();
    });
