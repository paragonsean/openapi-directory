...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImageForeground();
  });
  ...
  describe('DetectLabelsImageForeground', function() {
    it('should create an instance of DetectLabelsImageForeground', function() {
      // uncomment below and update the code to test DetectLabelsImageForeground
      //var instance = new AmazonRekognition.DetectLabelsImageForeground();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImageForeground);
    });
