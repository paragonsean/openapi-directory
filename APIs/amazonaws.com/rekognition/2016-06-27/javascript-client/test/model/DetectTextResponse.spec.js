...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectTextResponse();
  });
  ...
  describe('DetectTextResponse', function() {
    it('should create an instance of DetectTextResponse', function() {
      // uncomment below and update the code to test DetectTextResponse
      //var instance = new AmazonRekognition.DetectTextResponse();
      //expect(instance).to.be.a(AmazonRekognition.DetectTextResponse);
    });

    it('should have the property textDetections (base name: "TextDetections")', function() {
      // uncomment below and update the code to test the property textDetections
      //var instance = new AmazonRekognition.DetectTextResponse();
      //expect(instance).to.be();
    });

    it('should have the property textModelVersion (base name: "TextModelVersion")', function() {
      // uncomment below and update the code to test the property textModelVersion
      //var instance = new AmazonRekognition.DetectTextResponse();
      //expect(instance).to.be();
    });
