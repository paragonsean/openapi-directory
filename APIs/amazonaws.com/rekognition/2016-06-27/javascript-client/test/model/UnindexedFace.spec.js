...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UnindexedFace();
  });
  ...
  describe('UnindexedFace', function() {
    it('should create an instance of UnindexedFace', function() {
      // uncomment below and update the code to test UnindexedFace
      //var instance = new AmazonRekognition.UnindexedFace();
      //expect(instance).to.be.a(AmazonRekognition.UnindexedFace);
    });
