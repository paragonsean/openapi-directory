...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchUsersByImageResponseSearchedFace();
  });
  ...
  describe('SearchUsersByImageResponseSearchedFace', function() {
    it('should create an instance of SearchUsersByImageResponseSearchedFace', function() {
      // uncomment below and update the code to test SearchUsersByImageResponseSearchedFace
      //var instance = new AmazonRekognition.SearchUsersByImageResponseSearchedFace();
      //expect(instance).to.be.a(AmazonRekognition.SearchUsersByImageResponseSearchedFace);
    });
