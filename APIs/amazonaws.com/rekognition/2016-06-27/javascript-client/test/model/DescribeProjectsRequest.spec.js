...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeProjectsRequest();
  });
  ...
  describe('DescribeProjectsRequest', function() {
    it('should create an instance of DescribeProjectsRequest', function() {
      // uncomment below and update the code to test DescribeProjectsRequest
      //var instance = new AmazonRekognition.DescribeProjectsRequest();
      //expect(instance).to.be.a(AmazonRekognition.DescribeProjectsRequest);
    });
    ...
    it('should have the property projectNames (base name: "ProjectNames")', function() {
      // uncomment below and update the code to test the property projectNames
      //var instance = new AmazonRekognition.DescribeProjectsRequest();
      //expect(instance).to.be();
    });
