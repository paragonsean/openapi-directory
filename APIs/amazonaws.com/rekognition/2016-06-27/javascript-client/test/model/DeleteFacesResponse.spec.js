...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteFacesResponse();
  });
  ...
  describe('DeleteFacesResponse', function() {
    it('should create an instance of DeleteFacesResponse', function() {
      // uncomment below and update the code to test DeleteFacesResponse
      //var instance = new AmazonRekognition.DeleteFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.DeleteFacesResponse);
    });

    it('should have the property deletedFaces (base name: "DeletedFaces")', function() {
      // uncomment below and update the code to test the property deletedFaces
      //var instance = new AmazonRekognition.DeleteFacesResponse();
      //expect(instance).to.be();
    });

    it('should have the property unsuccessfulFaceDeletions (base name: "UnsuccessfulFaceDeletions")', function() {
      // uncomment below and update the code to test the property unsuccessfulFaceDeletions
      //var instance = new AmazonRekognition.DeleteFacesResponse();
      //expect(instance).to.be();
    });
