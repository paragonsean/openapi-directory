...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetCelebrityInfoResponse();
  });
  ...
  describe('GetCelebrityInfoResponse', function() {
    it('should create an instance of GetCelebrityInfoResponse', function() {
      // uncomment below and update the code to test GetCelebrityInfoResponse
      //var instance = new AmazonRekognition.GetCelebrityInfoResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetCelebrityInfoResponse);
    });
