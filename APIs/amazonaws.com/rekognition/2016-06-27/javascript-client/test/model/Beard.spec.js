...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.Beard();
  });
  ...
  describe('Beard', function() {
    it('should create an instance of Beard', function() {
      // uncomment below and update the code to test Beard
      //var instance = new AmazonRekognition.Beard();
      //expect(instance).to.be.a(AmazonRekognition.Beard);
    });
