...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.EquipmentDetection();
  });
  ...
  describe('EquipmentDetection', function() {
    it('should create an instance of EquipmentDetection', function() {
      // uncomment below and update the code to test EquipmentDetection
      //var instance = new AmazonRekognition.EquipmentDetection();
      //expect(instance).to.be.a(AmazonRekognition.EquipmentDetection);
    });
    ...
    it('should have the property coversBodyPart (base name: "CoversBodyPart")', function() {
      // uncomment below and update the code to test the property coversBodyPart
      //var instance = new AmazonRekognition.EquipmentDetection();
      //expect(instance).to.be();
    });
