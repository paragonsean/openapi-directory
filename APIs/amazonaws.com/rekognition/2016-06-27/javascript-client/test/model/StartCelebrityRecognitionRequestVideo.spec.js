...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartCelebrityRecognitionRequestVideo();
  });
  ...
  describe('StartCelebrityRecognitionRequestVideo', function() {
    it('should create an instance of StartCelebrityRecognitionRequestVideo', function() {
      // uncomment below and update the code to test StartCelebrityRecognitionRequestVideo
      //var instance = new AmazonRekognition.StartCelebrityRecognitionRequestVideo();
      //expect(instance).to.be.a(AmazonRekognition.StartCelebrityRecognitionRequestVideo);
    });
