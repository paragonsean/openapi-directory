...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorSettings();
  });
  ...
  describe('StreamProcessorSettings', function() {
    it('should create an instance of StreamProcessorSettings', function() {
      // uncomment below and update the code to test StreamProcessorSettings
      //var instance = new AmazonRekognition.StreamProcessorSettings();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorSettings);
    });

    it('should have the property faceSearch (base name: "FaceSearch")', function() {
      // uncomment below and update the code to test the property faceSearch
      //var instance = new AmazonRekognition.StreamProcessorSettings();
      //expect(instance).to.be();
    });

    it('should have the property connectedHome (base name: "ConnectedHome")', function() {
      // uncomment below and update the code to test the property connectedHome
      //var instance = new AmazonRekognition.StreamProcessorSettings();
      //expect(instance).to.be();
    });
