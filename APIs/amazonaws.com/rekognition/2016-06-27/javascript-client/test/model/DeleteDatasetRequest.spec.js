...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteDatasetRequest();
  });
  ...
  describe('DeleteDatasetRequest', function() {
    it('should create an instance of DeleteDatasetRequest', function() {
      ...
      //var instance = new AmazonRekognition.DeleteDatasetRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteDatasetRequest);
    });
