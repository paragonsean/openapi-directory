...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateDatasetResponse();
  });
  ...
  describe('CreateDatasetResponse', function() {
    it('should create an instance of CreateDatasetResponse', function() {
      ...
      //var instance = new AmazonRekognition.CreateDatasetResponse();
      //expect(instance).to.be.a(AmazonRekognition.CreateDatasetResponse);
    });
