...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailBoundingBox();
  });
  ...
  describe('FaceDetailBoundingBox', function() {
    it('should create an instance of FaceDetailBoundingBox', function() {
      // uncomment below and update the code to test FaceDetailBoundingBox
      //var instance = new AmazonRekognition.FaceDetailBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailBoundingBox);
    });
