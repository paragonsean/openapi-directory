...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateProjectResponse();
  });
  ...
  describe('CreateProjectResponse', function() {
    it('should create an instance of CreateProjectResponse', function() {
      ...
      //var instance = new AmazonRekognition.CreateProjectResponse();
      //expect(instance).to.be.a(AmazonRekognition.CreateProjectResponse);
    });
