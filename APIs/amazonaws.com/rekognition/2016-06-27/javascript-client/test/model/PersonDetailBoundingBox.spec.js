...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PersonDetailBoundingBox();
  });
  ...
  describe('PersonDetailBoundingBox', function() {
    it('should create an instance of PersonDetailBoundingBox', function() {
      // uncomment below and update the code to test PersonDetailBoundingBox
      //var instance = new AmazonRekognition.PersonDetailBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.PersonDetailBoundingBox);
    });
