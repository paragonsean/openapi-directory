...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsSettingsImageProperties();
  });
  ...
  describe('DetectLabelsSettingsImageProperties', function() {
    it('should create an instance of DetectLabelsSettingsImageProperties', function() {
      // uncomment below and update the code to test DetectLabelsSettingsImageProperties
      //var instance = new AmazonRekognition.DetectLabelsSettingsImageProperties();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsSettingsImageProperties);
    });
