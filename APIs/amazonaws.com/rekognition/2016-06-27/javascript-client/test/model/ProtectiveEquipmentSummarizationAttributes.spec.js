...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProtectiveEquipmentSummarizationAttributes();
  });
  ...
  describe('ProtectiveEquipmentSummarizationAttributes', function() {
    it('should create an instance of ProtectiveEquipmentSummarizationAttributes', function() {
      // uncomment below and update the code to test ProtectiveEquipmentSummarizationAttributes
      //var instance = new AmazonRekognition.ProtectiveEquipmentSummarizationAttributes();
      //expect(instance).to.be.a(AmazonRekognition.ProtectiveEquipmentSummarizationAttributes);
    });
    ...
    it('should have the property requiredEquipmentTypes (base name: "RequiredEquipmentTypes")', function() {
      // uncomment below and update the code to test the property requiredEquipmentTypes
      //var instance = new AmazonRekognition.ProtectiveEquipmentSummarizationAttributes();
      //expect(instance).to.be();
    });
