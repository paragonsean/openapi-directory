...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.RecognizeCelebritiesRequest();
  });
  ...
  describe('RecognizeCelebritiesRequest', function() {
    it('should create an instance of RecognizeCelebritiesRequest', function() {
      // uncomment below and update the code to test RecognizeCelebritiesRequest
      //var instance = new AmazonRekognition.RecognizeCelebritiesRequest();
      //expect(instance).to.be.a(AmazonRekognition.RecognizeCelebritiesRequest);
    });
