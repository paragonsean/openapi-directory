...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.MatchedUser();
  });
  ...
  describe('MatchedUser', function() {
    it('should create an instance of MatchedUser', function() {
      // uncomment below and update the code to test MatchedUser
      //var instance = new AmazonRekognition.MatchedUser();
      //expect(instance).to.be.a(AmazonRekognition.MatchedUser);
    });
