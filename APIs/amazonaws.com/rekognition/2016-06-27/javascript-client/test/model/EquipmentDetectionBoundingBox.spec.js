...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.EquipmentDetectionBoundingBox();
  });
  ...
  describe('EquipmentDetectionBoundingBox', function() {
    it('should create an instance of EquipmentDetectionBoundingBox', function() {
      // uncomment below and update the code to test EquipmentDetectionBoundingBox
      //var instance = new AmazonRekognition.EquipmentDetectionBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.EquipmentDetectionBoundingBox);
    });
