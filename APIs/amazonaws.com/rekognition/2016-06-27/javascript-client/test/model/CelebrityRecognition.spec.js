...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CelebrityRecognition();
  });
  ...
  describe('CelebrityRecognition', function() {
    it('should create an instance of CelebrityRecognition', function() {
      // uncomment below and update the code to test CelebrityRecognition
      //var instance = new AmazonRekognition.CelebrityRecognition();
      //expect(instance).to.be.a(AmazonRekognition.CelebrityRecognition);
    });
