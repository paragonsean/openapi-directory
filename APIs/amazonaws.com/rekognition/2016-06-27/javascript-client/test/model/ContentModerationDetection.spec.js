...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ContentModerationDetection();
  });
  ...
  describe('ContentModerationDetection', function() {
    it('should create an instance of ContentModerationDetection', function() {
      // uncomment below and update the code to test ContentModerationDetection
      //var instance = new AmazonRekognition.ContentModerationDetection();
      //expect(instance).to.be.a(AmazonRekognition.ContentModerationDetection);
    });
    ...
    it('should have the property moderationLabel (base name: "ModerationLabel")', function() {
      // uncomment below and update the code to test the property moderationLabel
      //var instance = new AmazonRekognition.ContentModerationDetection();
      //expect(instance).to.be();
    });
