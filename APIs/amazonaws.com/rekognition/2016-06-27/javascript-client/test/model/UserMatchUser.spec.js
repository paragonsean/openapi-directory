...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UserMatchUser();
  });
  ...
  describe('UserMatchUser', function() {
    it('should create an instance of UserMatchUser', function() {
      // uncomment below and update the code to test UserMatchUser
      //var instance = new AmazonRekognition.UserMatchUser();
      //expect(instance).to.be.a(AmazonRekognition.UserMatchUser);
    });
