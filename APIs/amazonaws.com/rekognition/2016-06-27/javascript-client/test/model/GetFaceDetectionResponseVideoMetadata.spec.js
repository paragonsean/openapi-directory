...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceDetectionResponseVideoMetadata();
  });
  ...
  describe('GetFaceDetectionResponseVideoMetadata', function() {
    it('should create an instance of GetFaceDetectionResponseVideoMetadata', function() {
      // uncomment below and update the code to test GetFaceDetectionResponseVideoMetadata
      //var instance = new AmazonRekognition.GetFaceDetectionResponseVideoMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceDetectionResponseVideoMetadata);
    });
