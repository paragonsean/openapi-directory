...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instance = new AmazonRekognition.CreateUserRequest();
      //expect(instance).to.be.a(AmazonRekognition.CreateUserRequest);
    });
