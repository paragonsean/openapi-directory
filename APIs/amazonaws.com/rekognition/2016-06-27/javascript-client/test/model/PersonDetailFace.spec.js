...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PersonDetailFace();
  });
  ...
  describe('PersonDetailFace', function() {
    it('should create an instance of PersonDetailFace', function() {
      // uncomment below and update the code to test PersonDetailFace
      //var instance = new AmazonRekognition.PersonDetailFace();
      //expect(instance).to.be.a(AmazonRekognition.PersonDetailFace);
    });
