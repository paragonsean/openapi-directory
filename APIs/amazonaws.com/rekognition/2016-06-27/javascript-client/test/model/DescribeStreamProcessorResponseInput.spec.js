...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeStreamProcessorResponseInput();
  });
  ...
  describe('DescribeStreamProcessorResponseInput', function() {
    it('should create an instance of DescribeStreamProcessorResponseInput', function() {
      // uncomment below and update the code to test DescribeStreamProcessorResponseInput
      //var instance = new AmazonRekognition.DescribeStreamProcessorResponseInput();
      //expect(instance).to.be.a(AmazonRekognition.DescribeStreamProcessorResponseInput);
    });
