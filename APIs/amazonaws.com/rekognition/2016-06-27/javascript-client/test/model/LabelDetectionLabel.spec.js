...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.LabelDetectionLabel();
  });
  ...
  describe('LabelDetectionLabel', function() {
    it('should create an instance of LabelDetectionLabel', function() {
      // uncomment below and update the code to test LabelDetectionLabel
      //var instance = new AmazonRekognition.LabelDetectionLabel();
      //expect(instance).to.be.a(AmazonRekognition.LabelDetectionLabel);
    });
