...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceLivenessSessionResultsRequest();
  });
  ...
  describe('GetFaceLivenessSessionResultsRequest', function() {
    it('should create an instance of GetFaceLivenessSessionResultsRequest', function() {
      // uncomment below and update the code to test GetFaceLivenessSessionResultsRequest
      //var instance = new AmazonRekognition.GetFaceLivenessSessionResultsRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceLivenessSessionResultsRequest);
    });
