...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsSettingsGeneralLabels();
  });
  ...
  describe('DetectLabelsSettingsGeneralLabels', function() {
    it('should create an instance of DetectLabelsSettingsGeneralLabels', function() {
      // uncomment below and update the code to test DetectLabelsSettingsGeneralLabels
      //var instance = new AmazonRekognition.DetectLabelsSettingsGeneralLabels();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsSettingsGeneralLabels);
    });

    it('should have the property labelInclusionFilters (base name: "LabelInclusionFilters")', function() {
      // uncomment below and update the code to test the property labelInclusionFilters
      //var instance = new AmazonRekognition.DetectLabelsSettingsGeneralLabels();
      //expect(instance).to.be();
    });

    it('should have the property labelExclusionFilters (base name: "LabelExclusionFilters")', function() {
      // uncomment below and update the code to test the property labelExclusionFilters
      //var instance = new AmazonRekognition.DetectLabelsSettingsGeneralLabels();
      //expect(instance).to.be();
    });

    it('should have the property labelCategoryInclusionFilters (base name: "LabelCategoryInclusionFilters")', function() {
      // uncomment below and update the code to test the property labelCategoryInclusionFilters
      //var instance = new AmazonRekognition.DetectLabelsSettingsGeneralLabels();
      //expect(instance).to.be();
    });

    it('should have the property labelCategoryExclusionFilters (base name: "LabelCategoryExclusionFilters")', function() {
      // uncomment below and update the code to test the property labelCategoryExclusionFilters
      //var instance = new AmazonRekognition.DetectLabelsSettingsGeneralLabels();
      //expect(instance).to.be();
    });
