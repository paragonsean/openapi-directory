...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateFaceLivenessSessionResponse();
  });
  ...
  describe('CreateFaceLivenessSessionResponse', function() {
    it('should create an instance of CreateFaceLivenessSessionResponse', function() {
      // uncomment below and update the code to test CreateFaceLivenessSessionResponse
      //var instance = new AmazonRekognition.CreateFaceLivenessSessionResponse();
      //expect(instance).to.be.a(AmazonRekognition.CreateFaceLivenessSessionResponse);
    });
