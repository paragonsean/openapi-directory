...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartLabelDetectionRequestVideo();
  });
  ...
  describe('StartLabelDetectionRequestVideo', function() {
    it('should create an instance of StartLabelDetectionRequestVideo', function() {
      // uncomment below and update the code to test StartLabelDetectionRequestVideo
      //var instance = new AmazonRekognition.StartLabelDetectionRequestVideo();
      //expect(instance).to.be.a(AmazonRekognition.StartLabelDetectionRequestVideo);
    });
