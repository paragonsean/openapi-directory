...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteFacesRequest();
  });
  ...
  describe('DeleteFacesRequest', function() {
    it('should create an instance of DeleteFacesRequest', function() {
      // uncomment below and update the code to test DeleteFacesRequest
      //var instance = new AmazonRekognition.DeleteFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteFacesRequest);
    });
