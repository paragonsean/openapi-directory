...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartStreamProcessorRequest();
  });
  ...
  describe('StartStreamProcessorRequest', function() {
    it('should create an instance of StartStreamProcessorRequest', function() {
      // uncomment below and update the code to test StartStreamProcessorRequest
      //var instance = new AmazonRekognition.StartStreamProcessorRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartStreamProcessorRequest);
    });
    ...
    it('should have the property startSelector (base name: "StartSelector")', function() {
      // uncomment below and update the code to test the property startSelector
      //var instance = new AmazonRekognition.StartStreamProcessorRequest();
      //expect(instance).to.be();
    });

    it('should have the property stopSelector (base name: "StopSelector")', function() {
      // uncomment below and update the code to test the property stopSelector
      //var instance = new AmazonRekognition.StartStreamProcessorRequest();
      //expect(instance).to.be();
    });
