...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateStreamProcessorRequestInput();
  });
  ...
  describe('CreateStreamProcessorRequestInput', function() {
    it('should create an instance of CreateStreamProcessorRequestInput', function() {
      // uncomment below and update the code to test CreateStreamProcessorRequestInput
      //var instance = new AmazonRekognition.CreateStreamProcessorRequestInput();
      //expect(instance).to.be.a(AmazonRekognition.CreateStreamProcessorRequestInput);
    });
