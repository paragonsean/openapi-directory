...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CopyProjectVersionRequestOutputConfig();
  });
  ...
  describe('CopyProjectVersionRequestOutputConfig', function() {
    it('should create an instance of CopyProjectVersionRequestOutputConfig', function() {
      // uncomment below and update the code to test CopyProjectVersionRequestOutputConfig
      //var instance = new AmazonRekognition.CopyProjectVersionRequestOutputConfig();
      //expect(instance).to.be.a(AmazonRekognition.CopyProjectVersionRequestOutputConfig);
    });
