...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetSource();
  });
  ...
  describe('DatasetSource', function() {
    it('should create an instance of DatasetSource', function() {
      // uncomment below and update the code to test DatasetSource
      //var instance = new AmazonRekognition.DatasetSource();
      //expect(instance).to.be.a(AmazonRekognition.DatasetSource);
    });
