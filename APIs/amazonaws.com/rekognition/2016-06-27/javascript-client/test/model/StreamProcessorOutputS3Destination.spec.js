...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorOutputS3Destination();
  });
  ...
  describe('StreamProcessorOutputS3Destination', function() {
    it('should create an instance of StreamProcessorOutputS3Destination', function() {
      // uncomment below and update the code to test StreamProcessorOutputS3Destination
      //var instance = new AmazonRekognition.StreamProcessorOutputS3Destination();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorOutputS3Destination);
    });
