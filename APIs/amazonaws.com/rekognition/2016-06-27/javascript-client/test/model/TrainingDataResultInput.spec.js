...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TrainingDataResultInput();
  });
  ...
  describe('TrainingDataResultInput', function() {
    it('should create an instance of TrainingDataResultInput', function() {
      // uncomment below and update the code to test TrainingDataResultInput
      //var instance = new AmazonRekognition.TrainingDataResultInput();
      //expect(instance).to.be.a(AmazonRekognition.TrainingDataResultInput);
    });
