...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.AssociatedFace();
  });
  ...
  describe('AssociatedFace', function() {
    it('should create an instance of AssociatedFace', function() {
      // uncomment below and update the code to test AssociatedFace
      //var instance = new AmazonRekognition.AssociatedFace();
      //expect(instance).to.be.a(AmazonRekognition.AssociatedFace);
    });
