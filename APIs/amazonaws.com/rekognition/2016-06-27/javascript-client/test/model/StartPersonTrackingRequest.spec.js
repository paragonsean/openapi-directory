...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartPersonTrackingRequest();
  });
  ...
  describe('StartPersonTrackingRequest', function() {
    it('should create an instance of StartPersonTrackingRequest', function() {
      // uncomment below and update the code to test StartPersonTrackingRequest
      //var instance = new AmazonRekognition.StartPersonTrackingRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartPersonTrackingRequest);
    });
