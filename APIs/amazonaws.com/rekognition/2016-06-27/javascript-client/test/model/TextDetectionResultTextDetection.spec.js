...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TextDetectionResultTextDetection();
  });
  ...
  describe('TextDetectionResultTextDetection', function() {
    it('should create an instance of TextDetectionResultTextDetection', function() {
      // uncomment below and update the code to test TextDetectionResultTextDetection
      //var instance = new AmazonRekognition.TextDetectionResultTextDetection();
      //expect(instance).to.be.a(AmazonRekognition.TextDetectionResultTextDetection);
    });

    it('should have the property detectedText (base name: "DetectedText")', function() {
      // uncomment below and update the code to test the property detectedText
      //var instance = new AmazonRekognition.TextDetectionResultTextDetection();
