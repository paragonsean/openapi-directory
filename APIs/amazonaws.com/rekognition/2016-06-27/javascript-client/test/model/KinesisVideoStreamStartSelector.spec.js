...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.KinesisVideoStreamStartSelector();
  });
  ...
  describe('KinesisVideoStreamStartSelector', function() {
    it('should create an instance of KinesisVideoStreamStartSelector', function() {
      // uncomment below and update the code to test KinesisVideoStreamStartSelector
      //var instance = new AmazonRekognition.KinesisVideoStreamStartSelector();
      //expect(instance).to.be.a(AmazonRekognition.KinesisVideoStreamStartSelector);
    });
