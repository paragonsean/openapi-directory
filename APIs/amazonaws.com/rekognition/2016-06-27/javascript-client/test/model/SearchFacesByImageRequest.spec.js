...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchFacesByImageRequest();
  });
  ...
  describe('SearchFacesByImageRequest', function() {
    it('should create an instance of SearchFacesByImageRequest', function() {
      // uncomment below and update the code to test SearchFacesByImageRequest
      //var instance = new AmazonRekognition.SearchFacesByImageRequest();
      //expect(instance).to.be.a(AmazonRekognition.SearchFacesByImageRequest);
    });
