...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetLabelDescriptionLabelStats();
  });
  ...
  describe('DatasetLabelDescriptionLabelStats', function() {
    it('should create an instance of DatasetLabelDescriptionLabelStats', function() {
      // uncomment below and update the code to test DatasetLabelDescriptionLabelStats
      //var instance = new AmazonRekognition.DatasetLabelDescriptionLabelStats();
      //expect(instance).to.be.a(AmazonRekognition.DatasetLabelDescriptionLabelStats);
    });
    ...
    it('should have the property boundingBoxCount (base name: "BoundingBoxCount")', function() {
      // uncomment below and update the code to test the property boundingBoxCount
      //var instance = new AmazonRekognition.DatasetLabelDescriptionLabelStats();
      //expect(instance).to.be();
    });
