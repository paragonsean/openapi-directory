...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectFacesRequest();
  });
  ...
  describe('DetectFacesRequest', function() {
    it('should create an instance of DetectFacesRequest', function() {
      // uncomment below and update the code to test DetectFacesRequest
      //var instance = new AmazonRekognition.DetectFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.DetectFacesRequest);
    });
