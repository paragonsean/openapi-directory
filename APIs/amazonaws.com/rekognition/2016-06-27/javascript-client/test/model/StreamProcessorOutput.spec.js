...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorOutput();
  });
  ...
  describe('StreamProcessorOutput', function() {
    it('should create an instance of StreamProcessorOutput', function() {
      // uncomment below and update the code to test StreamProcessorOutput
      //var instance = new AmazonRekognition.StreamProcessorOutput();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorOutput);
    });
