...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceLivenessSessionResultsResponseReferenceImage();
  });
  ...
  describe('GetFaceLivenessSessionResultsResponseReferenceImage', function() {
    it('should create an instance of GetFaceLivenessSessionResultsResponseReferenceImage', function() {
      // uncomment below and update the code to test GetFaceLivenessSessionResultsResponseReferenceImage
      //var instance = new AmazonRekognition.GetFaceLivenessSessionResultsResponseReferenceImage();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceLivenessSessionResultsResponseReferenceImage);
    });
