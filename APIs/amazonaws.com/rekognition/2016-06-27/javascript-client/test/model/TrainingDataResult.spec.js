...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TrainingDataResult();
  });
  ...
  describe('TrainingDataResult', function() {
    it('should create an instance of TrainingDataResult', function() {
      // uncomment below and update the code to test TrainingDataResult
      //var instance = new AmazonRekognition.TrainingDataResult();
      //expect(instance).to.be.a(AmazonRekognition.TrainingDataResult);
    });
