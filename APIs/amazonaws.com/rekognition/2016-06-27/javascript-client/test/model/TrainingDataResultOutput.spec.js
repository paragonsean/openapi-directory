...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TrainingDataResultOutput();
  });
  ...
  describe('TrainingDataResultOutput', function() {
    it('should create an instance of TrainingDataResultOutput', function() {
      // uncomment below and update the code to test TrainingDataResultOutput
      //var instance = new AmazonRekognition.TrainingDataResultOutput();
      //expect(instance).to.be.a(AmazonRekognition.TrainingDataResultOutput);
    });
