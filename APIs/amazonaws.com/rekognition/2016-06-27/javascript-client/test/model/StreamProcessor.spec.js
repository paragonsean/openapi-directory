...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessor();
  });
  ...
  describe('StreamProcessor', function() {
    it('should create an instance of StreamProcessor', function() {
      // uncomment below and update the code to test StreamProcessor
      //var instance = new AmazonRekognition.StreamProcessor();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessor);
    });
