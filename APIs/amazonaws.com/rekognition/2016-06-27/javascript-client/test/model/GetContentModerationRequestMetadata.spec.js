...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetContentModerationRequestMetadata();
  });
  ...
  describe('GetContentModerationRequestMetadata', function() {
    it('should create an instance of GetContentModerationRequestMetadata', function() {
      // uncomment below and update the code to test GetContentModerationRequestMetadata
      //var instance = new AmazonRekognition.GetContentModerationRequestMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetContentModerationRequestMetadata);
    });
