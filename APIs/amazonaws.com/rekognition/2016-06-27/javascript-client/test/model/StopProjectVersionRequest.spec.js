...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StopProjectVersionRequest();
  });
  ...
  describe('StopProjectVersionRequest', function() {
    it('should create an instance of StopProjectVersionRequest', function() {
      // uncomment below and update the code to test StopProjectVersionRequest
      //var instance = new AmazonRekognition.StopProjectVersionRequest();
      //expect(instance).to.be.a(AmazonRekognition.StopProjectVersionRequest);
    });
