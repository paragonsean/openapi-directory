...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectProtectiveEquipmentRequestImage();
  });
  ...
  describe('DetectProtectiveEquipmentRequestImage', function() {
    it('should create an instance of DetectProtectiveEquipmentRequestImage', function() {
      // uncomment below and update the code to test DetectProtectiveEquipmentRequestImage
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentRequestImage();
      //expect(instance).to.be.a(AmazonRekognition.DetectProtectiveEquipmentRequestImage);
    });
