...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorSettingsForUpdateConnectedHomeForUpdate();
  });
  ...
  describe('StreamProcessorSettingsForUpdateConnectedHomeForUpdate', function() {
    it('should create an instance of StreamProcessorSettingsForUpdateConnectedHomeForUpdate', function() {
      // uncomment below and update the code to test StreamProcessorSettingsForUpdateConnectedHomeForUpdate
      //var instance = new AmazonRekognition.StreamProcessorSettingsForUpdateConnectedHomeForUpdate();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorSettingsForUpdateConnectedHomeForUpdate);
    });
