...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartTechnicalCueDetectionFilter();
  });
  ...
  describe('StartTechnicalCueDetectionFilter', function() {
    it('should create an instance of StartTechnicalCueDetectionFilter', function() {
      // uncomment below and update the code to test StartTechnicalCueDetectionFilter
      //var instance = new AmazonRekognition.StartTechnicalCueDetectionFilter();
      //expect(instance).to.be.a(AmazonRekognition.StartTechnicalCueDetectionFilter);
    });
