...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonRekognition.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonRekognition.UntagResourceRequest);
    });
