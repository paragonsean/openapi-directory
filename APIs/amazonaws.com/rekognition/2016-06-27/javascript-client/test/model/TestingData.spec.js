...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TestingData();
  });
  ...
  describe('TestingData', function() {
    it('should create an instance of TestingData', function() {
      // uncomment below and update the code to test TestingData
      //var instance = new AmazonRekognition.TestingData();
      //expect(instance).to.be.a(AmazonRekognition.TestingData);
    });
