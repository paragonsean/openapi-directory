...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TextDetection();
  });
  ...
  describe('TextDetection', function() {
    it('should create an instance of TextDetection', function() {
      // uncomment below and update the code to test TextDetection
      //var instance = new AmazonRekognition.TextDetection();
      //expect(instance).to.be.a(AmazonRekognition.TextDetection);
    });
