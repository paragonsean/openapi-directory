...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailMouthOpen();
  });
  ...
  describe('FaceDetailMouthOpen', function() {
    it('should create an instance of FaceDetailMouthOpen', function() {
      // uncomment below and update the code to test FaceDetailMouthOpen
      //var instance = new AmazonRekognition.FaceDetailMouthOpen();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailMouthOpen);
    });
