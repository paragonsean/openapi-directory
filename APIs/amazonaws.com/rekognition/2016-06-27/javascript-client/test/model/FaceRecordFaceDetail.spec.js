...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceRecordFaceDetail();
  });
  ...
  describe('FaceRecordFaceDetail', function() {
    it('should create an instance of FaceRecordFaceDetail', function() {
      // uncomment below and update the code to test FaceRecordFaceDetail
      //var instance = new AmazonRekognition.FaceRecordFaceDetail();
      //expect(instance).to.be.a(AmazonRekognition.FaceRecordFaceDetail);
    });
