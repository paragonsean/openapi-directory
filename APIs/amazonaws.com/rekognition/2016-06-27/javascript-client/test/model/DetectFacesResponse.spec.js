...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectFacesResponse();
  });
  ...
  describe('DetectFacesResponse', function() {
    it('should create an instance of DetectFacesResponse', function() {
      // uncomment below and update the code to test DetectFacesResponse
      //var instance = new AmazonRekognition.DetectFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.DetectFacesResponse);
    });

    it('should have the property faceDetails (base name: "FaceDetails")', function() {
      // uncomment below and update the code to test the property faceDetails
      //var instance = new AmazonRekognition.DetectFacesResponse();
