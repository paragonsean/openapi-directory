...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateProjectVersionResponse();
  });
  ...
  describe('CreateProjectVersionResponse', function() {
    it('should create an instance of CreateProjectVersionResponse', function() {
      // uncomment below and update the code to test CreateProjectVersionResponse
      //var instance = new AmazonRekognition.CreateProjectVersionResponse();
      //expect(instance).to.be.a(AmazonRekognition.CreateProjectVersionResponse);
    });

    it('should have the property projectVersionArn (base name: "ProjectVersionArn")', function() {
      // uncomment below and update the code to test the property projectVersionArn
      //var instance = new AmazonRekognition.CreateProjectVersionResponse();
