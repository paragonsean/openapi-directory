...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsResponse();
  });
  ...
  describe('DetectLabelsResponse', function() {
    it('should create an instance of DetectLabelsResponse', function() {
      // uncomment below and update the code to test DetectLabelsResponse
      //var instance = new AmazonRekognition.DetectLabelsResponse();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsResponse);
    });
