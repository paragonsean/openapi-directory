...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartShotDetectionFilter();
  });
  ...
  describe('StartShotDetectionFilter', function() {
    it('should create an instance of StartShotDetectionFilter', function() {
      // uncomment below and update the code to test StartShotDetectionFilter
      //var instance = new AmazonRekognition.StartShotDetectionFilter();
      //expect(instance).to.be.a(AmazonRekognition.StartShotDetectionFilter);
    });
