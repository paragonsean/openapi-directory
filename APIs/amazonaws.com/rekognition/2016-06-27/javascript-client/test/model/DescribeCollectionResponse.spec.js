...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeCollectionResponse();
  });
  ...
  describe('DescribeCollectionResponse', function() {
    it('should create an instance of DescribeCollectionResponse', function() {
      // uncomment below and update the code to test DescribeCollectionResponse
      //var instance = new AmazonRekognition.DescribeCollectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.DescribeCollectionResponse);
    });
