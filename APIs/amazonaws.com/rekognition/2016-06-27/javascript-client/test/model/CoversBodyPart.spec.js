...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CoversBodyPart();
  });
  ...
  describe('CoversBodyPart', function() {
    it('should create an instance of CoversBodyPart', function() {
      // uncomment below and update the code to test CoversBodyPart
      //var instance = new AmazonRekognition.CoversBodyPart();
      //expect(instance).to.be.a(AmazonRekognition.CoversBodyPart);
    });
