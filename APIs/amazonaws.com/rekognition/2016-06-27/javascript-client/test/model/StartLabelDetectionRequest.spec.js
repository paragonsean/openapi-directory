...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartLabelDetectionRequest();
  });
  ...
  describe('StartLabelDetectionRequest', function() {
    it('should create an instance of StartLabelDetectionRequest', function() {
      // uncomment below and update the code to test StartLabelDetectionRequest
      //var instance = new AmazonRekognition.StartLabelDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartLabelDetectionRequest);
    });
