...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonRekognition.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListTagsForResourceRequest);
    });
