...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DominantColor();
  });
  ...
  describe('DominantColor', function() {
    it('should create an instance of DominantColor', function() {
      // uncomment below and update the code to test DominantColor
      //var instance = new AmazonRekognition.DominantColor();
      //expect(instance).to.be.a(AmazonRekognition.DominantColor);
    });
    ...
    it('should have the property hexCode (base name: "HexCode")', function() {
      // uncomment below and update the code to test the property hexCode
      //var instance = new AmazonRekognition.DominantColor();
      //expect(instance).to.be();
    });

    it('should have the property cSSColor (base name: "CSSColor")', function() {
      // uncomment below and update the code to test the property cSSColor
      //var instance = new AmazonRekognition.DominantColor();
      //expect(instance).to.be();
    });

    it('should have the property simplifiedColor (base name: "SimplifiedColor")', function() {
      // uncomment below and update the code to test the property simplifiedColor
      //var instance = new AmazonRekognition.DominantColor();
      //expect(instance).to.be();
    });

    it('should have the property pixelPercent (base name: "PixelPercent")', function() {
      // uncomment below and update the code to test the property pixelPercent
      //var instance = new AmazonRekognition.DominantColor();
      //expect(instance).to.be();
    });
