...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailFaceOccluded();
  });
  ...
  describe('FaceDetailFaceOccluded', function() {
    it('should create an instance of FaceDetailFaceOccluded', function() {
      // uncomment below and update the code to test FaceDetailFaceOccluded
      //var instance = new AmazonRekognition.FaceDetailFaceOccluded();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailFaceOccluded);
    });
