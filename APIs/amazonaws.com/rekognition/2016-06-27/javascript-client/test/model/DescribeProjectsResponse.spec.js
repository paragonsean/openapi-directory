...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeProjectsResponse();
  });
  ...
  describe('DescribeProjectsResponse', function() {
    it('should create an instance of DescribeProjectsResponse', function() {
      // uncomment below and update the code to test DescribeProjectsResponse
      //var instance = new AmazonRekognition.DescribeProjectsResponse();
      //expect(instance).to.be.a(AmazonRekognition.DescribeProjectsResponse);
    });

    it('should have the property projectDescriptions (base name: "ProjectDescriptions")', function() {
      // uncomment below and update the code to test the property projectDescriptions
      //var instance = new AmazonRekognition.DescribeProjectsResponse();
