...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateProjectVersionRequestOutputConfig();
  });
  ...
  describe('CreateProjectVersionRequestOutputConfig', function() {
    it('should create an instance of CreateProjectVersionRequestOutputConfig', function() {
      // uncomment below and update the code to test CreateProjectVersionRequestOutputConfig
      //var instance = new AmazonRekognition.CreateProjectVersionRequestOutputConfig();
      //expect(instance).to.be.a(AmazonRekognition.CreateProjectVersionRequestOutputConfig);
    });
