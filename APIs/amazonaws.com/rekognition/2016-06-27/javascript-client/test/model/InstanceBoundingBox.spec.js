...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.InstanceBoundingBox();
  });
  ...
  describe('InstanceBoundingBox', function() {
    it('should create an instance of InstanceBoundingBox', function() {
      // uncomment below and update the code to test InstanceBoundingBox
      //var instance = new AmazonRekognition.InstanceBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.InstanceBoundingBox);
    });
