...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.Mustache();
  });
  ...
  describe('Mustache', function() {
    it('should create an instance of Mustache', function() {
      // uncomment below and update the code to test Mustache
      //var instance = new AmazonRekognition.Mustache();
      //expect(instance).to.be.a(AmazonRekognition.Mustache);
    });
