...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateStreamProcessorResponse();
  });
  ...
  describe('CreateStreamProcessorResponse', function() {
    it('should create an instance of CreateStreamProcessorResponse', function() {
      // uncomment below and update the code to test CreateStreamProcessorResponse
      //var instance = new AmazonRekognition.CreateStreamProcessorResponse();
      //expect(instance).to.be.a(AmazonRekognition.CreateStreamProcessorResponse);
    });

    it('should have the property streamProcessorArn (base name: "StreamProcessorArn")', function() {
      // uncomment below and update the code to test the property streamProcessorArn
      //var instance = new AmazonRekognition.CreateStreamProcessorResponse();
