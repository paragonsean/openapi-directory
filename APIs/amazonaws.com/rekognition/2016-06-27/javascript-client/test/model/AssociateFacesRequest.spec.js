...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.AssociateFacesRequest();
  });
  ...
  describe('AssociateFacesRequest', function() {
    it('should create an instance of AssociateFacesRequest', function() {
      // uncomment below and update the code to test AssociateFacesRequest
      //var instance = new AmazonRekognition.AssociateFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.AssociateFacesRequest);
    });
