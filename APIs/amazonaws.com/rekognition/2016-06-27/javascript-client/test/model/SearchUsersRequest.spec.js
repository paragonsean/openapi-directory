...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchUsersRequest();
  });
  ...
  describe('SearchUsersRequest', function() {
    it('should create an instance of SearchUsersRequest', function() {
      // uncomment below and update the code to test SearchUsersRequest
      //var instance = new AmazonRekognition.SearchUsersRequest();
      //expect(instance).to.be.a(AmazonRekognition.SearchUsersRequest);
    });
    ...
    it('should have the property userMatchThreshold (base name: "UserMatchThreshold")', function() {
      // uncomment below and update the code to test the property userMatchThreshold
      //var instance = new AmazonRekognition.SearchUsersRequest();
      //expect(instance).to.be();
    });
