...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartSegmentDetectionRequest();
  });
  ...
  describe('StartSegmentDetectionRequest', function() {
    it('should create an instance of StartSegmentDetectionRequest', function() {
      // uncomment below and update the code to test StartSegmentDetectionRequest
      //var instance = new AmazonRekognition.StartSegmentDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartSegmentDetectionRequest);
    });
    ...
    it('should have the property segmentTypes (base name: "SegmentTypes")', function() {
      // uncomment below and update the code to test the property segmentTypes
      //var instance = new AmazonRekognition.StartSegmentDetectionRequest();
      //expect(instance).to.be();
    });
