...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartTextDetectionResponse();
  });
  ...
  describe('StartTextDetectionResponse', function() {
    it('should create an instance of StartTextDetectionResponse', function() {
      // uncomment below and update the code to test StartTextDetectionResponse
      //var instance = new AmazonRekognition.StartTextDetectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartTextDetectionResponse);
    });
