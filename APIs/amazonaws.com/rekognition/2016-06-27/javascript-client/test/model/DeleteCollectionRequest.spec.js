...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteCollectionRequest();
  });
  ...
  describe('DeleteCollectionRequest', function() {
    it('should create an instance of DeleteCollectionRequest', function() {
      ...
      //var instance = new AmazonRekognition.DeleteCollectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteCollectionRequest);
    });
