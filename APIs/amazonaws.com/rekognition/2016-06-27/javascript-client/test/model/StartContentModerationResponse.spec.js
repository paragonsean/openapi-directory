...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartContentModerationResponse();
  });
  ...
  describe('StartContentModerationResponse', function() {
    it('should create an instance of StartContentModerationResponse', function() {
      // uncomment below and update the code to test StartContentModerationResponse
      //var instance = new AmazonRekognition.StartContentModerationResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartContentModerationResponse);
    });
