...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.Sunglasses();
  });
  ...
  describe('Sunglasses', function() {
    it('should create an instance of Sunglasses', function() {
      // uncomment below and update the code to test Sunglasses
      //var instance = new AmazonRekognition.Sunglasses();
      //expect(instance).to.be.a(AmazonRekognition.Sunglasses);
    });
