...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetMetadata();
  });
  ...
  describe('DatasetMetadata', function() {
    it('should create an instance of DatasetMetadata', function() {
      ...
      //var instance = new AmazonRekognition.DatasetMetadata();
      //expect(instance).to.be.a(AmazonRekognition.DatasetMetadata);
    });
