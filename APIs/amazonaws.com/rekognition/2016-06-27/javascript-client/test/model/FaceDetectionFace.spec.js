...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetectionFace();
  });
  ...
  describe('FaceDetectionFace', function() {
    it('should create an instance of FaceDetectionFace', function() {
      // uncomment below and update the code to test FaceDetectionFace
      //var instance = new AmazonRekognition.FaceDetectionFace();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetectionFace);
    });
