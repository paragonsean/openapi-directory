...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetCelebrityRecognitionResponse();
  });
  ...
  describe('GetCelebrityRecognitionResponse', function() {
    it('should create an instance of GetCelebrityRecognitionResponse', function() {
      // uncomment below and update the code to test GetCelebrityRecognitionResponse
      //var instance = new AmazonRekognition.GetCelebrityRecognitionResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetCelebrityRecognitionResponse);
    });
