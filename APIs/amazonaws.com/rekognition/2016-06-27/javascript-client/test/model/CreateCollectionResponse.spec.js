...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateCollectionResponse();
  });
  ...
  describe('CreateCollectionResponse', function() {
    it('should create an instance of CreateCollectionResponse', function() {
      // uncomment below and update the code to test CreateCollectionResponse
      //var instance = new AmazonRekognition.CreateCollectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.CreateCollectionResponse);
    });
    ...
    it('should have the property faceModelVersion (base name: "FaceModelVersion")', function() {
      // uncomment below and update the code to test the property faceModelVersion
      //var instance = new AmazonRekognition.CreateCollectionResponse();
      //expect(instance).to.be();
    });
