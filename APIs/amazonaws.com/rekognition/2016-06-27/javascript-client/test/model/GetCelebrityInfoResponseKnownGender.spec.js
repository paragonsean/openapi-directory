...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetCelebrityInfoResponseKnownGender();
  });
  ...
  describe('GetCelebrityInfoResponseKnownGender', function() {
    it('should create an instance of GetCelebrityInfoResponseKnownGender', function() {
      // uncomment below and update the code to test GetCelebrityInfoResponseKnownGender
      //var instance = new AmazonRekognition.GetCelebrityInfoResponseKnownGender();
      //expect(instance).to.be.a(AmazonRekognition.GetCelebrityInfoResponseKnownGender);
    });
