...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsRequest();
  });
  ...
  describe('DetectLabelsRequest', function() {
    it('should create an instance of DetectLabelsRequest', function() {
      // uncomment below and update the code to test DetectLabelsRequest
      //var instance = new AmazonRekognition.DetectLabelsRequest();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsRequest);
    });
    ...
    it('should have the property maxLabels (base name: "MaxLabels")', function() {
      // uncomment below and update the code to test the property maxLabels
      //var instance = new AmazonRekognition.DetectLabelsRequest();
      //expect(instance).to.be();
    });
