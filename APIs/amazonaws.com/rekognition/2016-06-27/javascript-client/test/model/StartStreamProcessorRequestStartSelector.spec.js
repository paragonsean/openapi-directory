...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartStreamProcessorRequestStartSelector();
  });
  ...
  describe('StartStreamProcessorRequestStartSelector', function() {
    it('should create an instance of StartStreamProcessorRequestStartSelector', function() {
      // uncomment below and update the code to test StartStreamProcessorRequestStartSelector
      //var instance = new AmazonRekognition.StartStreamProcessorRequestStartSelector();
      //expect(instance).to.be.a(AmazonRekognition.StartStreamProcessorRequestStartSelector);
    });
