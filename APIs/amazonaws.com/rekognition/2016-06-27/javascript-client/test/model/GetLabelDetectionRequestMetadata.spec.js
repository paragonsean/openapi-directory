...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetLabelDetectionRequestMetadata();
  });
  ...
  describe('GetLabelDetectionRequestMetadata', function() {
    it('should create an instance of GetLabelDetectionRequestMetadata', function() {
      // uncomment below and update the code to test GetLabelDetectionRequestMetadata
      //var instance = new AmazonRekognition.GetLabelDetectionRequestMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetLabelDetectionRequestMetadata);
    });
