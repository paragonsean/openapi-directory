...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteProjectVersionRequest();
  });
  ...
  describe('DeleteProjectVersionRequest', function() {
    it('should create an instance of DeleteProjectVersionRequest', function() {
      // uncomment below and update the code to test DeleteProjectVersionRequest
      //var instance = new AmazonRekognition.DeleteProjectVersionRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteProjectVersionRequest);
    });
