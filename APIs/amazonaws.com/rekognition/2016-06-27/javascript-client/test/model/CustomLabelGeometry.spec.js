...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CustomLabelGeometry();
  });
  ...
  describe('CustomLabelGeometry', function() {
    it('should create an instance of CustomLabelGeometry', function() {
      // uncomment below and update the code to test CustomLabelGeometry
      //var instance = new AmazonRekognition.CustomLabelGeometry();
      //expect(instance).to.be.a(AmazonRekognition.CustomLabelGeometry);
    });
