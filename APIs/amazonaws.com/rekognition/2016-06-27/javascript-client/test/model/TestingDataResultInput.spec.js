...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TestingDataResultInput();
  });
  ...
  describe('TestingDataResultInput', function() {
    it('should create an instance of TestingDataResultInput', function() {
      // uncomment below and update the code to test TestingDataResultInput
      //var instance = new AmazonRekognition.TestingDataResultInput();
      //expect(instance).to.be.a(AmazonRekognition.TestingDataResultInput);
    });
