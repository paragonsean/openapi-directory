...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListDatasetLabelsResponse();
  });
  ...
  describe('ListDatasetLabelsResponse', function() {
    it('should create an instance of ListDatasetLabelsResponse', function() {
      // uncomment below and update the code to test ListDatasetLabelsResponse
      //var instance = new AmazonRekognition.ListDatasetLabelsResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListDatasetLabelsResponse);
    });

    it('should have the property datasetLabelDescriptions (base name: "DatasetLabelDescriptions")', function() {
      // uncomment below and update the code to test the property datasetLabelDescriptions
      //var instance = new AmazonRekognition.ListDatasetLabelsResponse();
