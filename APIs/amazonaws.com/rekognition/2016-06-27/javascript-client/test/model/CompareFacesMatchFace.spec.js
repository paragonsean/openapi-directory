...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CompareFacesMatchFace();
  });
  ...
  describe('CompareFacesMatchFace', function() {
    it('should create an instance of CompareFacesMatchFace', function() {
      // uncomment below and update the code to test CompareFacesMatchFace
      //var instance = new AmazonRekognition.CompareFacesMatchFace();
      //expect(instance).to.be.a(AmazonRekognition.CompareFacesMatchFace);
    });
