...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartSegmentDetectionFiltersTechnicalCueFilter();
  });
  ...
  describe('StartSegmentDetectionFiltersTechnicalCueFilter', function() {
    it('should create an instance of StartSegmentDetectionFiltersTechnicalCueFilter', function() {
      // uncomment below and update the code to test StartSegmentDetectionFiltersTechnicalCueFilter
      //var instance = new AmazonRekognition.StartSegmentDetectionFiltersTechnicalCueFilter();
      //expect(instance).to.be.a(AmazonRekognition.StartSegmentDetectionFiltersTechnicalCueFilter);
    });
    ...
    it('should have the property blackFrame (base name: "BlackFrame")', function() {
      // uncomment below and update the code to test the property blackFrame
      //var instance = new AmazonRekognition.StartSegmentDetectionFiltersTechnicalCueFilter();
      //expect(instance).to.be();
    });
