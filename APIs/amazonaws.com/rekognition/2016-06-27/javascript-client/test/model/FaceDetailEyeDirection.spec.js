...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailEyeDirection();
  });
  ...
  describe('FaceDetailEyeDirection', function() {
    it('should create an instance of FaceDetailEyeDirection', function() {
      // uncomment below and update the code to test FaceDetailEyeDirection
      //var instance = new AmazonRekognition.FaceDetailEyeDirection();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailEyeDirection);
    });
