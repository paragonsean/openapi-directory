...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GroundTruthManifest();
  });
  ...
  describe('GroundTruthManifest', function() {
    it('should create an instance of GroundTruthManifest', function() {
      // uncomment below and update the code to test GroundTruthManifest
      //var instance = new AmazonRekognition.GroundTruthManifest();
      //expect(instance).to.be.a(AmazonRekognition.GroundTruthManifest);
    });
