...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchedUser();
  });
  ...
  describe('SearchedUser', function() {
    it('should create an instance of SearchedUser', function() {
      // uncomment below and update the code to test SearchedUser
      //var instance = new AmazonRekognition.SearchedUser();
      //expect(instance).to.be.a(AmazonRekognition.SearchedUser);
    });
