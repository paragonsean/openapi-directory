...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProtectiveEquipmentPerson();
  });
  ...
  describe('ProtectiveEquipmentPerson', function() {
    it('should create an instance of ProtectiveEquipmentPerson', function() {
      // uncomment below and update the code to test ProtectiveEquipmentPerson
      //var instance = new AmazonRekognition.ProtectiveEquipmentPerson();
      //expect(instance).to.be.a(AmazonRekognition.ProtectiveEquipmentPerson);
    });
