...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetLabelDetectionResponseGetRequestMetadata();
  });
  ...
  describe('GetLabelDetectionResponseGetRequestMetadata', function() {
    it('should create an instance of GetLabelDetectionResponseGetRequestMetadata', function() {
      // uncomment below and update the code to test GetLabelDetectionResponseGetRequestMetadata
      //var instance = new AmazonRekognition.GetLabelDetectionResponseGetRequestMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetLabelDetectionResponseGetRequestMetadata);
    });
