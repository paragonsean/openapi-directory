...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ComparedFace();
  });
  ...
  describe('ComparedFace', function() {
    it('should create an instance of ComparedFace', function() {
      // uncomment below and update the code to test ComparedFace
      //var instance = new AmazonRekognition.ComparedFace();
      //expect(instance).to.be.a(AmazonRekognition.ComparedFace);
    });
