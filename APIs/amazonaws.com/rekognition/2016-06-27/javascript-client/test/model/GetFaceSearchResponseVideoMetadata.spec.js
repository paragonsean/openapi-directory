...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceSearchResponseVideoMetadata();
  });
  ...
  describe('GetFaceSearchResponseVideoMetadata', function() {
    it('should create an instance of GetFaceSearchResponseVideoMetadata', function() {
      // uncomment below and update the code to test GetFaceSearchResponseVideoMetadata
      //var instance = new AmazonRekognition.GetFaceSearchResponseVideoMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceSearchResponseVideoMetadata);
    });
