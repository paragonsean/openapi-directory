...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeDatasetResponse();
  });
  ...
  describe('DescribeDatasetResponse', function() {
    it('should create an instance of DescribeDatasetResponse', function() {
      ...
      //var instance = new AmazonRekognition.DescribeDatasetResponse();
      //expect(instance).to.be.a(AmazonRekognition.DescribeDatasetResponse);
    });
