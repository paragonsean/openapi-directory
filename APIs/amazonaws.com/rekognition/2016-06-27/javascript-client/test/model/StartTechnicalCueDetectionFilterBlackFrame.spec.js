...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartTechnicalCueDetectionFilterBlackFrame();
  });
  ...
  describe('StartTechnicalCueDetectionFilterBlackFrame', function() {
    it('should create an instance of StartTechnicalCueDetectionFilterBlackFrame', function() {
      // uncomment below and update the code to test StartTechnicalCueDetectionFilterBlackFrame
      //var instance = new AmazonRekognition.StartTechnicalCueDetectionFilterBlackFrame();
      //expect(instance).to.be.a(AmazonRekognition.StartTechnicalCueDetectionFilterBlackFrame);
    });

    it('should have the property maxPixelThreshold (base name: "MaxPixelThreshold")', function() {
      // uncomment below and update the code to test the property maxPixelThreshold
      //var instance = new AmazonRekognition.StartTechnicalCueDetectionFilterBlackFrame();
      //expect(instance).to.be();
    });

    it('should have the property minCoveragePercentage (base name: "MinCoveragePercentage")', function() {
      // uncomment below and update the code to test the property minCoveragePercentage
      //var instance = new AmazonRekognition.StartTechnicalCueDetectionFilterBlackFrame();
      //expect(instance).to.be();
    });
