...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectVersionDescriptionEvaluationResult();
  });
  ...
  describe('ProjectVersionDescriptionEvaluationResult', function() {
    it('should create an instance of ProjectVersionDescriptionEvaluationResult', function() {
      // uncomment below and update the code to test ProjectVersionDescriptionEvaluationResult
      //var instance = new AmazonRekognition.ProjectVersionDescriptionEvaluationResult();
      //expect(instance).to.be.a(AmazonRekognition.ProjectVersionDescriptionEvaluationResult);
    });
