...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateDatasetRequestDatasetSource();
  });
  ...
  describe('CreateDatasetRequestDatasetSource', function() {
    it('should create an instance of CreateDatasetRequestDatasetSource', function() {
      // uncomment below and update the code to test CreateDatasetRequestDatasetSource
      //var instance = new AmazonRekognition.CreateDatasetRequestDatasetSource();
      //expect(instance).to.be.a(AmazonRekognition.CreateDatasetRequestDatasetSource);
    });

    it('should have the property groundTruthManifest (base name: "GroundTruthManifest")', function() {
      // uncomment below and update the code to test the property groundTruthManifest
      //var instance = new AmazonRekognition.CreateDatasetRequestDatasetSource();
