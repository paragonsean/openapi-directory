...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetection();
  });
  ...
  describe('FaceDetection', function() {
    it('should create an instance of FaceDetection', function() {
      // uncomment below and update the code to test FaceDetection
      //var instance = new AmazonRekognition.FaceDetection();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetection);
    });
