...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UnsuccessfulFaceDisassociation();
  });
  ...
  describe('UnsuccessfulFaceDisassociation', function() {
    it('should create an instance of UnsuccessfulFaceDisassociation', function() {
      // uncomment below and update the code to test UnsuccessfulFaceDisassociation
      //var instance = new AmazonRekognition.UnsuccessfulFaceDisassociation();
      //expect(instance).to.be.a(AmazonRekognition.UnsuccessfulFaceDisassociation);
    });
