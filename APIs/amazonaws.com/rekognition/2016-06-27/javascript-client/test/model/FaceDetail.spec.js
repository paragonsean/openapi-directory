...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetail();
  });
  ...
  describe('FaceDetail', function() {
    it('should create an instance of FaceDetail', function() {
      // uncomment below and update the code to test FaceDetail
      //var instance = new AmazonRekognition.FaceDetail();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetail);
    });
