...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.IndexFacesRequestImage();
  });
  ...
  describe('IndexFacesRequestImage', function() {
    it('should create an instance of IndexFacesRequestImage', function() {
      // uncomment below and update the code to test IndexFacesRequestImage
      //var instance = new AmazonRekognition.IndexFacesRequestImage();
      //expect(instance).to.be.a(AmazonRekognition.IndexFacesRequestImage);
    });
