...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectProtectiveEquipmentResponseSummary();
  });
  ...
  describe('DetectProtectiveEquipmentResponseSummary', function() {
    it('should create an instance of DetectProtectiveEquipmentResponseSummary', function() {
      // uncomment below and update the code to test DetectProtectiveEquipmentResponseSummary
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentResponseSummary();
      //expect(instance).to.be.a(AmazonRekognition.DetectProtectiveEquipmentResponseSummary);
    });

    it('should have the property personsWithRequiredEquipment (base name: "PersonsWithRequiredEquipment")', function() {
      // uncomment below and update the code to test the property personsWithRequiredEquipment
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentResponseSummary();
      //expect(instance).to.be();
    });

    it('should have the property personsWithoutRequiredEquipment (base name: "PersonsWithoutRequiredEquipment")', function() {
      // uncomment below and update the code to test the property personsWithoutRequiredEquipment
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentResponseSummary();
      //expect(instance).to.be();
    });

    it('should have the property personsIndeterminate (base name: "PersonsIndeterminate")', function() {
      // uncomment below and update the code to test the property personsIndeterminate
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentResponseSummary();
      //expect(instance).to.be();
    });
