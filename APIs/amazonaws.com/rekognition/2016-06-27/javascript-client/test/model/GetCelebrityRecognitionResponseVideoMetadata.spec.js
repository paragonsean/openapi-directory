...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetCelebrityRecognitionResponseVideoMetadata();
  });
  ...
  describe('GetCelebrityRecognitionResponseVideoMetadata', function() {
    it('should create an instance of GetCelebrityRecognitionResponseVideoMetadata', function() {
      // uncomment below and update the code to test GetCelebrityRecognitionResponseVideoMetadata
      //var instance = new AmazonRekognition.GetCelebrityRecognitionResponseVideoMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetCelebrityRecognitionResponseVideoMetadata);
    });
    ...
    it('should have the property frameHeight (base name: "FrameHeight")', function() {
      // uncomment below and update the code to test the property frameHeight
      //var instance = new AmazonRekognition.GetCelebrityRecognitionResponseVideoMetadata();
      //expect(instance).to.be();
    });

    it('should have the property frameWidth (base name: "FrameWidth")', function() {
      // uncomment below and update the code to test the property frameWidth
      //var instance = new AmazonRekognition.GetCelebrityRecognitionResponseVideoMetadata();
      //expect(instance).to.be();
    });
