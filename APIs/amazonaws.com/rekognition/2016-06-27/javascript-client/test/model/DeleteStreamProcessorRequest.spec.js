...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteStreamProcessorRequest();
  });
  ...
  describe('DeleteStreamProcessorRequest', function() {
    it('should create an instance of DeleteStreamProcessorRequest', function() {
      // uncomment below and update the code to test DeleteStreamProcessorRequest
      //var instance = new AmazonRekognition.DeleteStreamProcessorRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteStreamProcessorRequest);
    });
