...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CopyProjectVersionResponse();
  });
  ...
  describe('CopyProjectVersionResponse', function() {
    it('should create an instance of CopyProjectVersionResponse', function() {
      // uncomment below and update the code to test CopyProjectVersionResponse
      //var instance = new AmazonRekognition.CopyProjectVersionResponse();
      //expect(instance).to.be.a(AmazonRekognition.CopyProjectVersionResponse);
    });
