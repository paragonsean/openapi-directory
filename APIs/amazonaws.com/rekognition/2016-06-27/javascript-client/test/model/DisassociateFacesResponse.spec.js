...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DisassociateFacesResponse();
  });
  ...
  describe('DisassociateFacesResponse', function() {
    it('should create an instance of DisassociateFacesResponse', function() {
      // uncomment below and update the code to test DisassociateFacesResponse
      //var instance = new AmazonRekognition.DisassociateFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.DisassociateFacesResponse);
    });

    it('should have the property disassociatedFaces (base name: "DisassociatedFaces")', function() {
      // uncomment below and update the code to test the property disassociatedFaces
      //var instance = new AmazonRekognition.DisassociateFacesResponse();
      //expect(instance).to.be();
    });

    it('should have the property unsuccessfulFaceDisassociations (base name: "UnsuccessfulFaceDisassociations")', function() {
      // uncomment below and update the code to test the property unsuccessfulFaceDisassociations
      //var instance = new AmazonRekognition.DisassociateFacesResponse();
      //expect(instance).to.be();
    });
