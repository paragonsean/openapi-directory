...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UnsuccessfulFaceDeletion();
  });
  ...
  describe('UnsuccessfulFaceDeletion', function() {
    it('should create an instance of UnsuccessfulFaceDeletion', function() {
      // uncomment below and update the code to test UnsuccessfulFaceDeletion
      //var instance = new AmazonRekognition.UnsuccessfulFaceDeletion();
      //expect(instance).to.be.a(AmazonRekognition.UnsuccessfulFaceDeletion);
    });
