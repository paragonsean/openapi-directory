...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ModerationLabel();
  });
  ...
  describe('ModerationLabel', function() {
    it('should create an instance of ModerationLabel', function() {
      // uncomment below and update the code to test ModerationLabel
      //var instance = new AmazonRekognition.ModerationLabel();
      //expect(instance).to.be.a(AmazonRekognition.ModerationLabel);
    });
