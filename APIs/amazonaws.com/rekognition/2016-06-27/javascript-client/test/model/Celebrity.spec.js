...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.Celebrity();
  });
  ...
  describe('Celebrity', function() {
    it('should create an instance of Celebrity', function() {
      // uncomment below and update the code to test Celebrity
      //var instance = new AmazonRekognition.Celebrity();
      //expect(instance).to.be.a(AmazonRekognition.Celebrity);
    });
