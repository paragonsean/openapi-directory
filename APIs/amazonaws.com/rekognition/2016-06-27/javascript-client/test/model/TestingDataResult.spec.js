...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TestingDataResult();
  });
  ...
  describe('TestingDataResult', function() {
    it('should create an instance of TestingDataResult', function() {
      // uncomment below and update the code to test TestingDataResult
      //var instance = new AmazonRekognition.TestingDataResult();
      //expect(instance).to.be.a(AmazonRekognition.TestingDataResult);
    });
