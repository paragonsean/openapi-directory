...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartTextDetectionRequestFilters();
  });
  ...
  describe('StartTextDetectionRequestFilters', function() {
    it('should create an instance of StartTextDetectionRequestFilters', function() {
      // uncomment below and update the code to test StartTextDetectionRequestFilters
      //var instance = new AmazonRekognition.StartTextDetectionRequestFilters();
      //expect(instance).to.be.a(AmazonRekognition.StartTextDetectionRequestFilters);
    });
