...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonRekognition.TagResourceRequest();
      //expect(instance).to.be.a(AmazonRekognition.TagResourceRequest);
    });
