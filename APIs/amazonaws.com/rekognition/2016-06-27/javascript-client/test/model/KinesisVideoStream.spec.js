...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.KinesisVideoStream();
  });
  ...
  describe('KinesisVideoStream', function() {
    it('should create an instance of KinesisVideoStream', function() {
      // uncomment below and update the code to test KinesisVideoStream
      //var instance = new AmazonRekognition.KinesisVideoStream();
      //expect(instance).to.be.a(AmazonRekognition.KinesisVideoStream);
    });
