...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectDescription();
  });
  ...
  describe('ProjectDescription', function() {
    it('should create an instance of ProjectDescription', function() {
      // uncomment below and update the code to test ProjectDescription
      //var instance = new AmazonRekognition.ProjectDescription();
      //expect(instance).to.be.a(AmazonRekognition.ProjectDescription);
    });
