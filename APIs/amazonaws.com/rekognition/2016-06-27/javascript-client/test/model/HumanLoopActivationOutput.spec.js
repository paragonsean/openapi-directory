...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.HumanLoopActivationOutput();
  });
  ...
  describe('HumanLoopActivationOutput', function() {
    it('should create an instance of HumanLoopActivationOutput', function() {
      ...
      //var instance = new AmazonRekognition.HumanLoopActivationOutput();
      //expect(instance).to.be.a(AmazonRekognition.HumanLoopActivationOutput);
    });
