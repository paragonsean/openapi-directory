...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetDescriptionDatasetStats();
  });
  ...
  describe('DatasetDescriptionDatasetStats', function() {
    it('should create an instance of DatasetDescriptionDatasetStats', function() {
      // uncomment below and update the code to test DatasetDescriptionDatasetStats
      //var instance = new AmazonRekognition.DatasetDescriptionDatasetStats();
      //expect(instance).to.be.a(AmazonRekognition.DatasetDescriptionDatasetStats);
    });
