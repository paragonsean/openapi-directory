...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeDatasetRequest();
  });
  ...
  describe('DescribeDatasetRequest', function() {
    it('should create an instance of DescribeDatasetRequest', function() {
      ...
      //var instance = new AmazonRekognition.DescribeDatasetRequest();
      //expect(instance).to.be.a(AmazonRekognition.DescribeDatasetRequest);
    });
