...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetCelebrityInfoRequest();
  });
  ...
  describe('GetCelebrityInfoRequest', function() {
    it('should create an instance of GetCelebrityInfoRequest', function() {
      // uncomment below and update the code to test GetCelebrityInfoRequest
      //var instance = new AmazonRekognition.GetCelebrityInfoRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetCelebrityInfoRequest);
    });
