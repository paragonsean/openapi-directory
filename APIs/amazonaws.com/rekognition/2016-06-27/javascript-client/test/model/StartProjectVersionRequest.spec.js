...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartProjectVersionRequest();
  });
  ...
  describe('StartProjectVersionRequest', function() {
    it('should create an instance of StartProjectVersionRequest', function() {
      // uncomment below and update the code to test StartProjectVersionRequest
      //var instance = new AmazonRekognition.StartProjectVersionRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartProjectVersionRequest);
    });
