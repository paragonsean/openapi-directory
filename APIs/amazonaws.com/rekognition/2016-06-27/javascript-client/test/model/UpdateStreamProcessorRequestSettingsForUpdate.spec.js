...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UpdateStreamProcessorRequestSettingsForUpdate();
  });
  ...
  describe('UpdateStreamProcessorRequestSettingsForUpdate', function() {
    it('should create an instance of UpdateStreamProcessorRequestSettingsForUpdate', function() {
      // uncomment below and update the code to test UpdateStreamProcessorRequestSettingsForUpdate
      //var instance = new AmazonRekognition.UpdateStreamProcessorRequestSettingsForUpdate();
      //expect(instance).to.be.a(AmazonRekognition.UpdateStreamProcessorRequestSettingsForUpdate);
    });
