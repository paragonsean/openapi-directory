...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.AudioMetadata();
  });
  ...
  describe('AudioMetadata', function() {
    it('should create an instance of AudioMetadata', function() {
      // uncomment below and update the code to test AudioMetadata
      //var instance = new AmazonRekognition.AudioMetadata();
      //expect(instance).to.be.a(AmazonRekognition.AudioMetadata);
    });
    ...
    it('should have the property numberOfChannels (base name: "NumberOfChannels")', function() {
      // uncomment below and update the code to test the property numberOfChannels
      //var instance = new AmazonRekognition.AudioMetadata();
      //expect(instance).to.be();
    });
