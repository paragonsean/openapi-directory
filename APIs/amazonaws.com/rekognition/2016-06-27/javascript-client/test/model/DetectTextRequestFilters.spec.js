...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectTextRequestFilters();
  });
  ...
  describe('DetectTextRequestFilters', function() {
    it('should create an instance of DetectTextRequestFilters', function() {
      // uncomment below and update the code to test DetectTextRequestFilters
      //var instance = new AmazonRekognition.DetectTextRequestFilters();
      //expect(instance).to.be.a(AmazonRekognition.DetectTextRequestFilters);
    });

    it('should have the property wordFilter (base name: "WordFilter")', function() {
      // uncomment below and update the code to test the property wordFilter
      //var instance = new AmazonRekognition.DetectTextRequestFilters();
