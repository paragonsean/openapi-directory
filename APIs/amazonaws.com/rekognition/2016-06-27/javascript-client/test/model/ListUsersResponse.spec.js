...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListUsersResponse();
  });
  ...
  describe('ListUsersResponse', function() {
    it('should create an instance of ListUsersResponse', function() {
      // uncomment below and update the code to test ListUsersResponse
      //var instance = new AmazonRekognition.ListUsersResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListUsersResponse);
    });
