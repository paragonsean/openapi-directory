...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CompareFacesRequest();
  });
  ...
  describe('CompareFacesRequest', function() {
    it('should create an instance of CompareFacesRequest', function() {
      // uncomment below and update the code to test CompareFacesRequest
      //var instance = new AmazonRekognition.CompareFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.CompareFacesRequest);
    });
    ...
    it('should have the property similarityThreshold (base name: "SimilarityThreshold")', function() {
      // uncomment below and update the code to test the property similarityThreshold
      //var instance = new AmazonRekognition.CompareFacesRequest();
      //expect(instance).to.be();
    });
