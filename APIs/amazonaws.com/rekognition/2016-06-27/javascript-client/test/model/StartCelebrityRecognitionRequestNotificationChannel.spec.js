...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartCelebrityRecognitionRequestNotificationChannel();
  });
  ...
  describe('StartCelebrityRecognitionRequestNotificationChannel', function() {
    it('should create an instance of StartCelebrityRecognitionRequestNotificationChannel', function() {
      // uncomment below and update the code to test StartCelebrityRecognitionRequestNotificationChannel
      //var instance = new AmazonRekognition.StartCelebrityRecognitionRequestNotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.StartCelebrityRecognitionRequestNotificationChannel);
    });
