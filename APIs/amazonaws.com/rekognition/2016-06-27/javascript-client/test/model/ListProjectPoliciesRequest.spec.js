...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListProjectPoliciesRequest();
  });
  ...
  describe('ListProjectPoliciesRequest', function() {
    it('should create an instance of ListProjectPoliciesRequest', function() {
      // uncomment below and update the code to test ListProjectPoliciesRequest
      //var instance = new AmazonRekognition.ListProjectPoliciesRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListProjectPoliciesRequest);
    });
