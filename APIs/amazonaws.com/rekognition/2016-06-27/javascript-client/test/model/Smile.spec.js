...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.Smile();
  });
  ...
  describe('Smile', function() {
    it('should create an instance of Smile', function() {
      // uncomment below and update the code to test Smile
      //var instance = new AmazonRekognition.Smile();
      //expect(instance).to.be.a(AmazonRekognition.Smile);
    });
