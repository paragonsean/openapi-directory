...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetContentModerationResponseGetRequestMetadata();
  });
  ...
  describe('GetContentModerationResponseGetRequestMetadata', function() {
    it('should create an instance of GetContentModerationResponseGetRequestMetadata', function() {
      // uncomment below and update the code to test GetContentModerationResponseGetRequestMetadata
      //var instance = new AmazonRekognition.GetContentModerationResponseGetRequestMetadata();
      //expect(instance).to.be.a(AmazonRekognition.GetContentModerationResponseGetRequestMetadata);
    });
