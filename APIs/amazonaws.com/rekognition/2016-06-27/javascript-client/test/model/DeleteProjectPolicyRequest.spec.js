...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteProjectPolicyRequest();
  });
  ...
  describe('DeleteProjectPolicyRequest', function() {
    it('should create an instance of DeleteProjectPolicyRequest', function() {
      // uncomment below and update the code to test DeleteProjectPolicyRequest
      //var instance = new AmazonRekognition.DeleteProjectPolicyRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteProjectPolicyRequest);
    });
