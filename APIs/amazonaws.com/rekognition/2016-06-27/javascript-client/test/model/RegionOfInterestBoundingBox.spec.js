...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.RegionOfInterestBoundingBox();
  });
  ...
  describe('RegionOfInterestBoundingBox', function() {
    it('should create an instance of RegionOfInterestBoundingBox', function() {
      // uncomment below and update the code to test RegionOfInterestBoundingBox
      //var instance = new AmazonRekognition.RegionOfInterestBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.RegionOfInterestBoundingBox);
    });
