...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.MouthOpen();
  });
  ...
  describe('MouthOpen', function() {
    it('should create an instance of MouthOpen', function() {
      // uncomment below and update the code to test MouthOpen
      //var instance = new AmazonRekognition.MouthOpen();
      //expect(instance).to.be.a(AmazonRekognition.MouthOpen);
    });
