...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.RegionOfInterest();
  });
  ...
  describe('RegionOfInterest', function() {
    it('should create an instance of RegionOfInterest', function() {
      ...
      //var instance = new AmazonRekognition.RegionOfInterest();
      //expect(instance).to.be.a(AmazonRekognition.RegionOfInterest);
    });
