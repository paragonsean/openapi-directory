...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorInput();
  });
  ...
  describe('StreamProcessorInput', function() {
    it('should create an instance of StreamProcessorInput', function() {
      // uncomment below and update the code to test StreamProcessorInput
      //var instance = new AmazonRekognition.StreamProcessorInput();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorInput);
    });

    it('should have the property kinesisVideoStream (base name: "KinesisVideoStream")', function() {
      // uncomment below and update the code to test the property kinesisVideoStream
      //var instance = new AmazonRekognition.StreamProcessorInput();
