...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.LivenessOutputConfig();
  });
  ...
  describe('LivenessOutputConfig', function() {
    it('should create an instance of LivenessOutputConfig', function() {
      // uncomment below and update the code to test LivenessOutputConfig
      //var instance = new AmazonRekognition.LivenessOutputConfig();
      //expect(instance).to.be.a(AmazonRekognition.LivenessOutputConfig);
    });
