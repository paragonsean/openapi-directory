...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.AuditImage();
  });
  ...
  describe('AuditImage', function() {
    it('should create an instance of AuditImage', function() {
      // uncomment below and update the code to test AuditImage
      //var instance = new AmazonRekognition.AuditImage();
      //expect(instance).to.be.a(AmazonRekognition.AuditImage);
    });
