...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ConnectedHomeSettings();
  });
  ...
  describe('ConnectedHomeSettings', function() {
    it('should create an instance of ConnectedHomeSettings', function() {
      // uncomment below and update the code to test ConnectedHomeSettings
      //var instance = new AmazonRekognition.ConnectedHomeSettings();
      //expect(instance).to.be.a(AmazonRekognition.ConnectedHomeSettings);
    });
