...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CompareFacesMatch();
  });
  ...
  describe('CompareFacesMatch', function() {
    it('should create an instance of CompareFacesMatch', function() {
      // uncomment below and update the code to test CompareFacesMatch
      //var instance = new AmazonRekognition.CompareFacesMatch();
      //expect(instance).to.be.a(AmazonRekognition.CompareFacesMatch);
    });
