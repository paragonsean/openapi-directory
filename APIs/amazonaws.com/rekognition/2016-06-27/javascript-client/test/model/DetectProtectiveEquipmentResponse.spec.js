...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectProtectiveEquipmentResponse();
  });
  ...
  describe('DetectProtectiveEquipmentResponse', function() {
    it('should create an instance of DetectProtectiveEquipmentResponse', function() {
      // uncomment below and update the code to test DetectProtectiveEquipmentResponse
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentResponse();
      //expect(instance).to.be.a(AmazonRekognition.DetectProtectiveEquipmentResponse);
    });

    it('should have the property protectiveEquipmentModelVersion (base name: "ProtectiveEquipmentModelVersion")', function() {
      // uncomment below and update the code to test the property protectiveEquipmentModelVersion
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentResponse();
