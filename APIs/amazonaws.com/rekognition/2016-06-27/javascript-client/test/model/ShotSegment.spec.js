...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ShotSegment();
  });
  ...
  describe('ShotSegment', function() {
    it('should create an instance of ShotSegment', function() {
      // uncomment below and update the code to test ShotSegment
      //var instance = new AmazonRekognition.ShotSegment();
      //expect(instance).to.be.a(AmazonRekognition.ShotSegment);
    });
