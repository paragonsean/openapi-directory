...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchFacesByImageResponse();
  });
  ...
  describe('SearchFacesByImageResponse', function() {
    it('should create an instance of SearchFacesByImageResponse', function() {
      // uncomment below and update the code to test SearchFacesByImageResponse
      //var instance = new AmazonRekognition.SearchFacesByImageResponse();
      //expect(instance).to.be.a(AmazonRekognition.SearchFacesByImageResponse);
    });

    it('should have the property searchedFaceBoundingBox (base name: "SearchedFaceBoundingBox")', function() {
      // uncomment below and update the code to test the property searchedFaceBoundingBox
      //var instance = new AmazonRekognition.SearchFacesByImageResponse();
      //expect(instance).to.be();
    });

    it('should have the property searchedFaceConfidence (base name: "SearchedFaceConfidence")', function() {
      // uncomment below and update the code to test the property searchedFaceConfidence
      //var instance = new AmazonRekognition.SearchFacesByImageResponse();
      //expect(instance).to.be();
    });
