...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectTextRequest();
  });
  ...
  describe('DetectTextRequest', function() {
    it('should create an instance of DetectTextRequest', function() {
      // uncomment below and update the code to test DetectTextRequest
      //var instance = new AmazonRekognition.DetectTextRequest();
      //expect(instance).to.be.a(AmazonRekognition.DetectTextRequest);
    });
