...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteProjectVersionResponse();
  });
  ...
  describe('DeleteProjectVersionResponse', function() {
    it('should create an instance of DeleteProjectVersionResponse', function() {
      // uncomment below and update the code to test DeleteProjectVersionResponse
      //var instance = new AmazonRekognition.DeleteProjectVersionResponse();
      //expect(instance).to.be.a(AmazonRekognition.DeleteProjectVersionResponse);
    });
