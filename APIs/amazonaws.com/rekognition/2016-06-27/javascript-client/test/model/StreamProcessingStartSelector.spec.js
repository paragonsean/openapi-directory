...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessingStartSelector();
  });
  ...
  describe('StreamProcessingStartSelector', function() {
    it('should create an instance of StreamProcessingStartSelector', function() {
      // uncomment below and update the code to test StreamProcessingStartSelector
      //var instance = new AmazonRekognition.StreamProcessingStartSelector();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessingStartSelector);
    });

    it('should have the property kVSStreamStartSelector (base name: "KVSStreamStartSelector")', function() {
      // uncomment below and update the code to test the property kVSStreamStartSelector
      //var instance = new AmazonRekognition.StreamProcessingStartSelector();
