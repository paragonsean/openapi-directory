...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ComparedFaceBoundingBox();
  });
  ...
  describe('ComparedFaceBoundingBox', function() {
    it('should create an instance of ComparedFaceBoundingBox', function() {
      // uncomment below and update the code to test ComparedFaceBoundingBox
      //var instance = new AmazonRekognition.ComparedFaceBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.ComparedFaceBoundingBox);
    });
