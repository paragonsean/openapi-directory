...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateStreamProcessorRequest();
  });
  ...
  describe('CreateStreamProcessorRequest', function() {
    it('should create an instance of CreateStreamProcessorRequest', function() {
      // uncomment below and update the code to test CreateStreamProcessorRequest
      //var instance = new AmazonRekognition.CreateStreamProcessorRequest();
      //expect(instance).to.be.a(AmazonRekognition.CreateStreamProcessorRequest);
    });
    ...
    it('should have the property dataSharingPreference (base name: "DataSharingPreference")', function() {
      // uncomment below and update the code to test the property dataSharingPreference
      //var instance = new AmazonRekognition.CreateStreamProcessorRequest();
      //expect(instance).to.be();
    });
