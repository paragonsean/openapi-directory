...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchUsersResponse();
  });
  ...
  describe('SearchUsersResponse', function() {
    it('should create an instance of SearchUsersResponse', function() {
      ...
      //var instance = new AmazonRekognition.SearchUsersResponse();
      //expect(instance).to.be.a(AmazonRekognition.SearchUsersResponse);
    });
    ...
    it('should have the property searchedUser (base name: "SearchedUser")', function() {
      // uncomment below and update the code to test the property searchedUser
      //var instance = new AmazonRekognition.SearchUsersResponse();
      //expect(instance).to.be();
    });
