...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProtectiveEquipmentPersonBoundingBox();
  });
  ...
  describe('ProtectiveEquipmentPersonBoundingBox', function() {
    it('should create an instance of ProtectiveEquipmentPersonBoundingBox', function() {
      // uncomment below and update the code to test ProtectiveEquipmentPersonBoundingBox
      //var instance = new AmazonRekognition.ProtectiveEquipmentPersonBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.ProtectiveEquipmentPersonBoundingBox);
    });
