...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CompareFacesRequestSourceImage();
  });
  ...
  describe('CompareFacesRequestSourceImage', function() {
    it('should create an instance of CompareFacesRequestSourceImage', function() {
      // uncomment below and update the code to test CompareFacesRequestSourceImage
      //var instance = new AmazonRekognition.CompareFacesRequestSourceImage();
      //expect(instance).to.be.a(AmazonRekognition.CompareFacesRequestSourceImage);
    });
