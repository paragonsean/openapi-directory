...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DistributeDatasetEntriesRequest();
  });
  ...
  describe('DistributeDatasetEntriesRequest', function() {
    it('should create an instance of DistributeDatasetEntriesRequest', function() {
      // uncomment below and update the code to test DistributeDatasetEntriesRequest
      //var instance = new AmazonRekognition.DistributeDatasetEntriesRequest();
      //expect(instance).to.be.a(AmazonRekognition.DistributeDatasetEntriesRequest);
    });
