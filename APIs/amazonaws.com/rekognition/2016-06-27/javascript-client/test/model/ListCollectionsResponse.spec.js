...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListCollectionsResponse();
  });
  ...
  describe('ListCollectionsResponse', function() {
    it('should create an instance of ListCollectionsResponse', function() {
      ...
      //var instance = new AmazonRekognition.ListCollectionsResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListCollectionsResponse);
    });
    ...
    it('should have the property faceModelVersions (base name: "FaceModelVersions")', function() {
      // uncomment below and update the code to test the property faceModelVersions
      //var instance = new AmazonRekognition.ListCollectionsResponse();
      //expect(instance).to.be();
    });
