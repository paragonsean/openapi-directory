...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StopStreamProcessorRequest();
  });
  ...
  describe('StopStreamProcessorRequest', function() {
    it('should create an instance of StopStreamProcessorRequest', function() {
      // uncomment below and update the code to test StopStreamProcessorRequest
      //var instance = new AmazonRekognition.StopStreamProcessorRequest();
      //expect(instance).to.be.a(AmazonRekognition.StopStreamProcessorRequest);
    });
