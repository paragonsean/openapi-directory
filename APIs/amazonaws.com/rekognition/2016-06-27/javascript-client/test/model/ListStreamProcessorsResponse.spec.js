...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListStreamProcessorsResponse();
  });
  ...
  describe('ListStreamProcessorsResponse', function() {
    it('should create an instance of ListStreamProcessorsResponse', function() {
      // uncomment below and update the code to test ListStreamProcessorsResponse
      //var instance = new AmazonRekognition.ListStreamProcessorsResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListStreamProcessorsResponse);
    });
    ...
    it('should have the property streamProcessors (base name: "StreamProcessors")', function() {
      // uncomment below and update the code to test the property streamProcessors
      //var instance = new AmazonRekognition.ListStreamProcessorsResponse();
      //expect(instance).to.be();
    });
