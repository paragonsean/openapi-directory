...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PutProjectPolicyRequest();
  });
  ...
  describe('PutProjectPolicyRequest', function() {
    it('should create an instance of PutProjectPolicyRequest', function() {
      // uncomment below and update the code to test PutProjectPolicyRequest
      //var instance = new AmazonRekognition.PutProjectPolicyRequest();
      //expect(instance).to.be.a(AmazonRekognition.PutProjectPolicyRequest);
    });
