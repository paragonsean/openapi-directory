...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartCelebrityRecognitionRequest();
  });
  ...
  describe('StartCelebrityRecognitionRequest', function() {
    it('should create an instance of StartCelebrityRecognitionRequest', function() {
      // uncomment below and update the code to test StartCelebrityRecognitionRequest
      //var instance = new AmazonRekognition.StartCelebrityRecognitionRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartCelebrityRecognitionRequest);
    });
