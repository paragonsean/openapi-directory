...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PersonDetectionPerson();
  });
  ...
  describe('PersonDetectionPerson', function() {
    it('should create an instance of PersonDetectionPerson', function() {
      // uncomment below and update the code to test PersonDetectionPerson
      //var instance = new AmazonRekognition.PersonDetectionPerson();
      //expect(instance).to.be.a(AmazonRekognition.PersonDetectionPerson);
    });
