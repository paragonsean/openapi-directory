...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.EyeOpen();
  });
  ...
  describe('EyeOpen', function() {
    it('should create an instance of EyeOpen', function() {
      // uncomment below and update the code to test EyeOpen
      //var instance = new AmazonRekognition.EyeOpen();
      //expect(instance).to.be.a(AmazonRekognition.EyeOpen);
    });
