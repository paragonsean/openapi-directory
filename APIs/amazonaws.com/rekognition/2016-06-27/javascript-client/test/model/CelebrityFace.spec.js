...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CelebrityFace();
  });
  ...
  describe('CelebrityFace', function() {
    it('should create an instance of CelebrityFace', function() {
      // uncomment below and update the code to test CelebrityFace
      //var instance = new AmazonRekognition.CelebrityFace();
      //expect(instance).to.be.a(AmazonRekognition.CelebrityFace);
    });
