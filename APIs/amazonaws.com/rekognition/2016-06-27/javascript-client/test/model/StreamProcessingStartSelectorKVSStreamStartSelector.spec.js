...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessingStartSelectorKVSStreamStartSelector();
  });
  ...
  describe('StreamProcessingStartSelectorKVSStreamStartSelector', function() {
    it('should create an instance of StreamProcessingStartSelectorKVSStreamStartSelector', function() {
      // uncomment below and update the code to test StreamProcessingStartSelectorKVSStreamStartSelector
      //var instance = new AmazonRekognition.StreamProcessingStartSelectorKVSStreamStartSelector();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessingStartSelectorKVSStreamStartSelector);
    });
