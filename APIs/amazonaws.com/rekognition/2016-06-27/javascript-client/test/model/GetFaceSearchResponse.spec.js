...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceSearchResponse();
  });
  ...
  describe('GetFaceSearchResponse', function() {
    it('should create an instance of GetFaceSearchResponse', function() {
      // uncomment below and update the code to test GetFaceSearchResponse
      //var instance = new AmazonRekognition.GetFaceSearchResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceSearchResponse);
    });
