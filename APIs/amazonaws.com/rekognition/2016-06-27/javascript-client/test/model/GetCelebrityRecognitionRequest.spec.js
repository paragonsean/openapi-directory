...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetCelebrityRecognitionRequest();
  });
  ...
  describe('GetCelebrityRecognitionRequest', function() {
    it('should create an instance of GetCelebrityRecognitionRequest', function() {
      // uncomment below and update the code to test GetCelebrityRecognitionRequest
      //var instance = new AmazonRekognition.GetCelebrityRecognitionRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetCelebrityRecognitionRequest);
    });
