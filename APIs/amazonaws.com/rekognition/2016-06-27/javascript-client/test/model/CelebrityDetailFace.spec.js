...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CelebrityDetailFace();
  });
  ...
  describe('CelebrityDetailFace', function() {
    it('should create an instance of CelebrityDetailFace', function() {
      // uncomment below and update the code to test CelebrityDetailFace
      //var instance = new AmazonRekognition.CelebrityDetailFace();
      //expect(instance).to.be.a(AmazonRekognition.CelebrityDetailFace);
    });
