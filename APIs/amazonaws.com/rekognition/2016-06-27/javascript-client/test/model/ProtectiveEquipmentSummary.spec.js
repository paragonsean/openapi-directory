...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProtectiveEquipmentSummary();
  });
  ...
  describe('ProtectiveEquipmentSummary', function() {
    it('should create an instance of ProtectiveEquipmentSummary', function() {
      // uncomment below and update the code to test ProtectiveEquipmentSummary
      //var instance = new AmazonRekognition.ProtectiveEquipmentSummary();
      //expect(instance).to.be.a(AmazonRekognition.ProtectiveEquipmentSummary);
    });
