...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.EvaluationResult();
  });
  ...
  describe('EvaluationResult', function() {
    it('should create an instance of EvaluationResult', function() {
      ...
      //var instance = new AmazonRekognition.EvaluationResult();
      //expect(instance).to.be.a(AmazonRekognition.EvaluationResult);
    });
