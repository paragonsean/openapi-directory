...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.IndexFacesRequest();
  });
  ...
  describe('IndexFacesRequest', function() {
    it('should create an instance of IndexFacesRequest', function() {
      // uncomment below and update the code to test IndexFacesRequest
      //var instance = new AmazonRekognition.IndexFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.IndexFacesRequest);
    });
    ...
    it('should have the property detectionAttributes (base name: "DetectionAttributes")', function() {
      // uncomment below and update the code to test the property detectionAttributes
      //var instance = new AmazonRekognition.IndexFacesRequest();
      //expect(instance).to.be();
    });

    it('should have the property maxFaces (base name: "MaxFaces")', function() {
      // uncomment below and update the code to test the property maxFaces
      //var instance = new AmazonRekognition.IndexFacesRequest();
      //expect(instance).to.be();
    });

    it('should have the property qualityFilter (base name: "QualityFilter")', function() {
      // uncomment below and update the code to test the property qualityFilter
      //var instance = new AmazonRekognition.IndexFacesRequest();
      //expect(instance).to.be();
    });
