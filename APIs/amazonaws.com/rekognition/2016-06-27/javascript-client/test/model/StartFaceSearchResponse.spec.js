...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceSearchResponse();
  });
  ...
  describe('StartFaceSearchResponse', function() {
    it('should create an instance of StartFaceSearchResponse', function() {
      // uncomment below and update the code to test StartFaceSearchResponse
      //var instance = new AmazonRekognition.StartFaceSearchResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceSearchResponse);
    });
