...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectPolicy();
  });
  ...
  describe('ProjectPolicy', function() {
    it('should create an instance of ProjectPolicy', function() {
      // uncomment below and update the code to test ProjectPolicy
      //var instance = new AmazonRekognition.ProjectPolicy();
      //expect(instance).to.be.a(AmazonRekognition.ProjectPolicy);
    });
