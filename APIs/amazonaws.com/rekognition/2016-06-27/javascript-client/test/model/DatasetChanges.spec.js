...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetChanges();
  });
  ...
  describe('DatasetChanges', function() {
    it('should create an instance of DatasetChanges', function() {
      // uncomment below and update the code to test DatasetChanges
      //var instance = new AmazonRekognition.DatasetChanges();
      //expect(instance).to.be.a(AmazonRekognition.DatasetChanges);
    });
