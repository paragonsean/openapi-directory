...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceDetectionResponse();
  });
  ...
  describe('StartFaceDetectionResponse', function() {
    it('should create an instance of StartFaceDetectionResponse', function() {
      // uncomment below and update the code to test StartFaceDetectionResponse
      //var instance = new AmazonRekognition.StartFaceDetectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceDetectionResponse);
    });
