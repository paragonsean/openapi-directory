...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImageForegroundQuality();
  });
  ...
  describe('DetectLabelsImageForegroundQuality', function() {
    it('should create an instance of DetectLabelsImageForegroundQuality', function() {
      // uncomment below and update the code to test DetectLabelsImageForegroundQuality
      //var instance = new AmazonRekognition.DetectLabelsImageForegroundQuality();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImageForegroundQuality);
    });
