...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartLabelDetectionRequestNotificationChannel();
  });
  ...
  describe('StartLabelDetectionRequestNotificationChannel', function() {
    it('should create an instance of StartLabelDetectionRequestNotificationChannel', function() {
      // uncomment below and update the code to test StartLabelDetectionRequestNotificationChannel
      //var instance = new AmazonRekognition.StartLabelDetectionRequestNotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.StartLabelDetectionRequestNotificationChannel);
    });
