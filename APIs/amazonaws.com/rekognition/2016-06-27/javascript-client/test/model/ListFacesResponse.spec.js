...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListFacesResponse();
  });
  ...
  describe('ListFacesResponse', function() {
    it('should create an instance of ListFacesResponse', function() {
      // uncomment below and update the code to test ListFacesResponse
      //var instance = new AmazonRekognition.ListFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListFacesResponse);
    });
