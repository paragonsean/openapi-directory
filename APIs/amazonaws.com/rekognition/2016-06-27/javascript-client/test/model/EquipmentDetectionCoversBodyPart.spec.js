...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.EquipmentDetectionCoversBodyPart();
  });
  ...
  describe('EquipmentDetectionCoversBodyPart', function() {
    it('should create an instance of EquipmentDetectionCoversBodyPart', function() {
      // uncomment below and update the code to test EquipmentDetectionCoversBodyPart
      //var instance = new AmazonRekognition.EquipmentDetectionCoversBodyPart();
      //expect(instance).to.be.a(AmazonRekognition.EquipmentDetectionCoversBodyPart);
    });
