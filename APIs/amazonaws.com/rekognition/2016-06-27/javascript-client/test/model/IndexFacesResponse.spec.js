...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.IndexFacesResponse();
  });
  ...
  describe('IndexFacesResponse', function() {
    it('should create an instance of IndexFacesResponse', function() {
      // uncomment below and update the code to test IndexFacesResponse
      //var instance = new AmazonRekognition.IndexFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.IndexFacesResponse);
    });

    it('should have the property faceRecords (base name: "FaceRecords")', function() {
      // uncomment below and update the code to test the property faceRecords
      //var instance = new AmazonRekognition.IndexFacesResponse();
    ...
    it('should have the property unindexedFaces (base name: "UnindexedFaces")', function() {
      // uncomment below and update the code to test the property unindexedFaces
      //var instance = new AmazonRekognition.IndexFacesResponse();
      //expect(instance).to.be();
    });
