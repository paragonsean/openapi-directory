...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetTextDetectionResponse();
  });
  ...
  describe('GetTextDetectionResponse', function() {
    it('should create an instance of GetTextDetectionResponse', function() {
      // uncomment below and update the code to test GetTextDetectionResponse
      //var instance = new AmazonRekognition.GetTextDetectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetTextDetectionResponse);
    });
