...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ComparedFaceQuality();
  });
  ...
  describe('ComparedFaceQuality', function() {
    it('should create an instance of ComparedFaceQuality', function() {
      // uncomment below and update the code to test ComparedFaceQuality
      //var instance = new AmazonRekognition.ComparedFaceQuality();
      //expect(instance).to.be.a(AmazonRekognition.ComparedFaceQuality);
    });
