...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteProjectResponse();
  });
  ...
  describe('DeleteProjectResponse', function() {
    it('should create an instance of DeleteProjectResponse', function() {
      ...
      //var instance = new AmazonRekognition.DeleteProjectResponse();
      //expect(instance).to.be.a(AmazonRekognition.DeleteProjectResponse);
    });
