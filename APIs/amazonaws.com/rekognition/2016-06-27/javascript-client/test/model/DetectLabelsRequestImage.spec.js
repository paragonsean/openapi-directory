...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsRequestImage();
  });
  ...
  describe('DetectLabelsRequestImage', function() {
    it('should create an instance of DetectLabelsRequestImage', function() {
      // uncomment below and update the code to test DetectLabelsRequestImage
      //var instance = new AmazonRekognition.DetectLabelsRequestImage();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsRequestImage);
    });
