...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UpdateDatasetEntriesRequestChanges();
  });
  ...
  describe('UpdateDatasetEntriesRequestChanges', function() {
    it('should create an instance of UpdateDatasetEntriesRequestChanges', function() {
      // uncomment below and update the code to test UpdateDatasetEntriesRequestChanges
      //var instance = new AmazonRekognition.UpdateDatasetEntriesRequestChanges();
      //expect(instance).to.be.a(AmazonRekognition.UpdateDatasetEntriesRequestChanges);
    });
