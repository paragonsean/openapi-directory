...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DistributeDataset();
  });
  ...
  describe('DistributeDataset', function() {
    it('should create an instance of DistributeDataset', function() {
      // uncomment below and update the code to test DistributeDataset
      //var instance = new AmazonRekognition.DistributeDataset();
      //expect(instance).to.be.a(AmazonRekognition.DistributeDataset);
    });
