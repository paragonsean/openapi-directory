...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TestingDataResultOutput();
  });
  ...
  describe('TestingDataResultOutput', function() {
    it('should create an instance of TestingDataResultOutput', function() {
      // uncomment below and update the code to test TestingDataResultOutput
      //var instance = new AmazonRekognition.TestingDataResultOutput();
      //expect(instance).to.be.a(AmazonRekognition.TestingDataResultOutput);
    });
