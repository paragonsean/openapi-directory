...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetLabelStats();
  });
  ...
  describe('DatasetLabelStats', function() {
    it('should create an instance of DatasetLabelStats', function() {
      // uncomment below and update the code to test DatasetLabelStats
      //var instance = new AmazonRekognition.DatasetLabelStats();
      //expect(instance).to.be.a(AmazonRekognition.DatasetLabelStats);
    });
