...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateFaceLivenessSessionRequestSettings();
  });
  ...
  describe('CreateFaceLivenessSessionRequestSettings', function() {
    it('should create an instance of CreateFaceLivenessSessionRequestSettings', function() {
      // uncomment below and update the code to test CreateFaceLivenessSessionRequestSettings
      //var instance = new AmazonRekognition.CreateFaceLivenessSessionRequestSettings();
      //expect(instance).to.be.a(AmazonRekognition.CreateFaceLivenessSessionRequestSettings);
    });
    ...
    it('should have the property auditImagesLimit (base name: "AuditImagesLimit")', function() {
      // uncomment below and update the code to test the property auditImagesLimit
      //var instance = new AmazonRekognition.CreateFaceLivenessSessionRequestSettings();
      //expect(instance).to.be();
    });
