...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TrainingData();
  });
  ...
  describe('TrainingData', function() {
    it('should create an instance of TrainingData', function() {
      // uncomment below and update the code to test TrainingData
      //var instance = new AmazonRekognition.TrainingData();
      //expect(instance).to.be.a(AmazonRekognition.TrainingData);
    });
