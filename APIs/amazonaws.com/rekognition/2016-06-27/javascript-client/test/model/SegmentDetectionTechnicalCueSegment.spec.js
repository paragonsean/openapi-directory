...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SegmentDetectionTechnicalCueSegment();
  });
  ...
  describe('SegmentDetectionTechnicalCueSegment', function() {
    it('should create an instance of SegmentDetectionTechnicalCueSegment', function() {
      // uncomment below and update the code to test SegmentDetectionTechnicalCueSegment
      //var instance = new AmazonRekognition.SegmentDetectionTechnicalCueSegment();
      //expect(instance).to.be.a(AmazonRekognition.SegmentDetectionTechnicalCueSegment);
    });
