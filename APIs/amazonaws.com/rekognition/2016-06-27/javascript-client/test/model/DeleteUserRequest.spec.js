...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteUserRequest();
  });
  ...
  describe('DeleteUserRequest', function() {
    it('should create an instance of DeleteUserRequest', function() {
      ...
      //var instance = new AmazonRekognition.DeleteUserRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteUserRequest);
    });
