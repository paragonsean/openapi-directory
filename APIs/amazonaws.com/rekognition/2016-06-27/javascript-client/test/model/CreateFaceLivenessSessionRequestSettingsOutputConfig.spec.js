...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateFaceLivenessSessionRequestSettingsOutputConfig();
  });
  ...
  describe('CreateFaceLivenessSessionRequestSettingsOutputConfig', function() {
    it('should create an instance of CreateFaceLivenessSessionRequestSettingsOutputConfig', function() {
      // uncomment below and update the code to test CreateFaceLivenessSessionRequestSettingsOutputConfig
      //var instance = new AmazonRekognition.CreateFaceLivenessSessionRequestSettingsOutputConfig();
      //expect(instance).to.be.a(AmazonRekognition.CreateFaceLivenessSessionRequestSettingsOutputConfig);
    });
