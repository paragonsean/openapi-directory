...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListDatasetEntriesRequest();
  });
  ...
  describe('ListDatasetEntriesRequest', function() {
    it('should create an instance of ListDatasetEntriesRequest', function() {
      // uncomment below and update the code to test ListDatasetEntriesRequest
      //var instance = new AmazonRekognition.ListDatasetEntriesRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListDatasetEntriesRequest);
    });
    ...
    it('should have the property containsLabels (base name: "ContainsLabels")', function() {
      // uncomment below and update the code to test the property containsLabels
      //var instance = new AmazonRekognition.ListDatasetEntriesRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceRefContains (base name: "SourceRefContains")', function() {
      // uncomment below and update the code to test the property sourceRefContains
      //var instance = new AmazonRekognition.ListDatasetEntriesRequest();
      //expect(instance).to.be();
    });
