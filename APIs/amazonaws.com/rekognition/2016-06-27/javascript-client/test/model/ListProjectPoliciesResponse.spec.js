...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListProjectPoliciesResponse();
  });
  ...
  describe('ListProjectPoliciesResponse', function() {
    it('should create an instance of ListProjectPoliciesResponse', function() {
      // uncomment below and update the code to test ListProjectPoliciesResponse
      //var instance = new AmazonRekognition.ListProjectPoliciesResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListProjectPoliciesResponse);
    });

    it('should have the property projectPolicies (base name: "ProjectPolicies")', function() {
      // uncomment below and update the code to test the property projectPolicies
      //var instance = new AmazonRekognition.ListProjectPoliciesResponse();
