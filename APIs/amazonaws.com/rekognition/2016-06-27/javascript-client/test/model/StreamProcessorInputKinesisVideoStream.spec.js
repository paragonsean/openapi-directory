...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorInputKinesisVideoStream();
  });
  ...
  describe('StreamProcessorInputKinesisVideoStream', function() {
    it('should create an instance of StreamProcessorInputKinesisVideoStream', function() {
      // uncomment below and update the code to test StreamProcessorInputKinesisVideoStream
      //var instance = new AmazonRekognition.StreamProcessorInputKinesisVideoStream();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorInputKinesisVideoStream);
    });
