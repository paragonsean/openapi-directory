...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartLabelDetectionRequestSettings();
  });
  ...
  describe('StartLabelDetectionRequestSettings', function() {
    it('should create an instance of StartLabelDetectionRequestSettings', function() {
      // uncomment below and update the code to test StartLabelDetectionRequestSettings
      //var instance = new AmazonRekognition.StartLabelDetectionRequestSettings();
      //expect(instance).to.be.a(AmazonRekognition.StartLabelDetectionRequestSettings);
    });
