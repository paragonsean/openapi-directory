...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorDataSharingPreference();
  });
  ...
  describe('StreamProcessorDataSharingPreference', function() {
    it('should create an instance of StreamProcessorDataSharingPreference', function() {
      // uncomment below and update the code to test StreamProcessorDataSharingPreference
      //var instance = new AmazonRekognition.StreamProcessorDataSharingPreference();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorDataSharingPreference);
    });
