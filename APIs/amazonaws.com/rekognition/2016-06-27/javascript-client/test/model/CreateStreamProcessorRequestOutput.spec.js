...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateStreamProcessorRequestOutput();
  });
  ...
  describe('CreateStreamProcessorRequestOutput', function() {
    it('should create an instance of CreateStreamProcessorRequestOutput', function() {
      // uncomment below and update the code to test CreateStreamProcessorRequestOutput
      //var instance = new AmazonRekognition.CreateStreamProcessorRequestOutput();
      //expect(instance).to.be.a(AmazonRekognition.CreateStreamProcessorRequestOutput);
    });
