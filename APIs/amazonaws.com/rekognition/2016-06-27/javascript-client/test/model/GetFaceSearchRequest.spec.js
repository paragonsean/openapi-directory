...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceSearchRequest();
  });
  ...
  describe('GetFaceSearchRequest', function() {
    it('should create an instance of GetFaceSearchRequest', function() {
      // uncomment below and update the code to test GetFaceSearchRequest
      //var instance = new AmazonRekognition.GetFaceSearchRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceSearchRequest);
    });
