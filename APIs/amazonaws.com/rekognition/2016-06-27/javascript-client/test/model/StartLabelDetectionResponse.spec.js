...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartLabelDetectionResponse();
  });
  ...
  describe('StartLabelDetectionResponse', function() {
    it('should create an instance of StartLabelDetectionResponse', function() {
      // uncomment below and update the code to test StartLabelDetectionResponse
      //var instance = new AmazonRekognition.StartLabelDetectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartLabelDetectionResponse);
    });
