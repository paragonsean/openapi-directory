...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceDetectionResponse();
  });
  ...
  describe('GetFaceDetectionResponse', function() {
    it('should create an instance of GetFaceDetectionResponse', function() {
      // uncomment below and update the code to test GetFaceDetectionResponse
      //var instance = new AmazonRekognition.GetFaceDetectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceDetectionResponse);
    });
