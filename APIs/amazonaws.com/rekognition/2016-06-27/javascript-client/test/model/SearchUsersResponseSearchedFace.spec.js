...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchUsersResponseSearchedFace();
  });
  ...
  describe('SearchUsersResponseSearchedFace', function() {
    it('should create an instance of SearchUsersResponseSearchedFace', function() {
      // uncomment below and update the code to test SearchUsersResponseSearchedFace
      //var instance = new AmazonRekognition.SearchUsersResponseSearchedFace();
      //expect(instance).to.be.a(AmazonRekognition.SearchUsersResponseSearchedFace);
    });
