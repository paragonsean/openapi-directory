...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceSearchRequestVideo();
  });
  ...
  describe('StartFaceSearchRequestVideo', function() {
    it('should create an instance of StartFaceSearchRequestVideo', function() {
      // uncomment below and update the code to test StartFaceSearchRequestVideo
      //var instance = new AmazonRekognition.StartFaceSearchRequestVideo();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceSearchRequestVideo);
    });
