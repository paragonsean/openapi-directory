...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.BlackFrame();
  });
  ...
  describe('BlackFrame', function() {
    it('should create an instance of BlackFrame', function() {
      // uncomment below and update the code to test BlackFrame
      //var instance = new AmazonRekognition.BlackFrame();
      //expect(instance).to.be.a(AmazonRekognition.BlackFrame);
    });
