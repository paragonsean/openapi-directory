...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.LabelCategory();
  });
  ...
  describe('LabelCategory', function() {
    it('should create an instance of LabelCategory', function() {
      // uncomment below and update the code to test LabelCategory
      //var instance = new AmazonRekognition.LabelCategory();
      //expect(instance).to.be.a(AmazonRekognition.LabelCategory);
    });
