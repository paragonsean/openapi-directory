...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImagePropertiesQuality();
  });
  ...
  describe('DetectLabelsImagePropertiesQuality', function() {
    it('should create an instance of DetectLabelsImagePropertiesQuality', function() {
      // uncomment below and update the code to test DetectLabelsImagePropertiesQuality
      //var instance = new AmazonRekognition.DetectLabelsImagePropertiesQuality();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImagePropertiesQuality);
    });
