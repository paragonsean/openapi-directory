...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchFacesByImageResponseSearchedFaceBoundingBox();
  });
  ...
  describe('SearchFacesByImageResponseSearchedFaceBoundingBox', function() {
    it('should create an instance of SearchFacesByImageResponseSearchedFaceBoundingBox', function() {
      // uncomment below and update the code to test SearchFacesByImageResponseSearchedFaceBoundingBox
      //var instance = new AmazonRekognition.SearchFacesByImageResponseSearchedFaceBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.SearchFacesByImageResponseSearchedFaceBoundingBox);
    });
