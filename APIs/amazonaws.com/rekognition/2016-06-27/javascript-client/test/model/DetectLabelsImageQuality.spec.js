...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImageQuality();
  });
  ...
  describe('DetectLabelsImageQuality', function() {
    it('should create an instance of DetectLabelsImageQuality', function() {
      // uncomment below and update the code to test DetectLabelsImageQuality
      //var instance = new AmazonRekognition.DetectLabelsImageQuality();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImageQuality);
    });
