...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsSettings();
  });
  ...
  describe('DetectLabelsSettings', function() {
    it('should create an instance of DetectLabelsSettings', function() {
      // uncomment below and update the code to test DetectLabelsSettings
      //var instance = new AmazonRekognition.DetectLabelsSettings();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsSettings);
    });
