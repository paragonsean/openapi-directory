...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceSearchRequestNotificationChannel();
  });
  ...
  describe('StartFaceSearchRequestNotificationChannel', function() {
    it('should create an instance of StartFaceSearchRequestNotificationChannel', function() {
      // uncomment below and update the code to test StartFaceSearchRequestNotificationChannel
      //var instance = new AmazonRekognition.StartFaceSearchRequestNotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceSearchRequestNotificationChannel);
    });
