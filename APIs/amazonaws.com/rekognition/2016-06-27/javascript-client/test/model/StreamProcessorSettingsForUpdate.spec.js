...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorSettingsForUpdate();
  });
  ...
  describe('StreamProcessorSettingsForUpdate', function() {
    it('should create an instance of StreamProcessorSettingsForUpdate', function() {
      // uncomment below and update the code to test StreamProcessorSettingsForUpdate
      //var instance = new AmazonRekognition.StreamProcessorSettingsForUpdate();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorSettingsForUpdate);
    });

    it('should have the property connectedHomeForUpdate (base name: "ConnectedHomeForUpdate")', function() {
      // uncomment below and update the code to test the property connectedHomeForUpdate
      //var instance = new AmazonRekognition.StreamProcessorSettingsForUpdate();
