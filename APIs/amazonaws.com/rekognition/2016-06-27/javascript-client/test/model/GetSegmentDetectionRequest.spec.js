...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetSegmentDetectionRequest();
  });
  ...
  describe('GetSegmentDetectionRequest', function() {
    it('should create an instance of GetSegmentDetectionRequest', function() {
      // uncomment below and update the code to test GetSegmentDetectionRequest
      //var instance = new AmazonRekognition.GetSegmentDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetSegmentDetectionRequest);
    });
