...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StopProjectVersionResponse();
  });
  ...
  describe('StopProjectVersionResponse', function() {
    it('should create an instance of StopProjectVersionResponse', function() {
      // uncomment below and update the code to test StopProjectVersionResponse
      //var instance = new AmazonRekognition.StopProjectVersionResponse();
      //expect(instance).to.be.a(AmazonRekognition.StopProjectVersionResponse);
    });
