...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteCollectionResponse();
  });
  ...
  describe('DeleteCollectionResponse', function() {
    it('should create an instance of DeleteCollectionResponse', function() {
      ...
      //var instance = new AmazonRekognition.DeleteCollectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.DeleteCollectionResponse);
    });
