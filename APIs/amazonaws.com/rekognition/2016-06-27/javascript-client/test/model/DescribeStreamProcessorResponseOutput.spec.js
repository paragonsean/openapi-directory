...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeStreamProcessorResponseOutput();
  });
  ...
  describe('DescribeStreamProcessorResponseOutput', function() {
    it('should create an instance of DescribeStreamProcessorResponseOutput', function() {
      // uncomment below and update the code to test DescribeStreamProcessorResponseOutput
      //var instance = new AmazonRekognition.DescribeStreamProcessorResponseOutput();
      //expect(instance).to.be.a(AmazonRekognition.DescribeStreamProcessorResponseOutput);
    });

    it('should have the property kinesisDataStream (base name: "KinesisDataStream")', function() {
      // uncomment below and update the code to test the property kinesisDataStream
      //var instance = new AmazonRekognition.DescribeStreamProcessorResponseOutput();
