...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DeleteProjectRequest();
  });
  ...
  describe('DeleteProjectRequest', function() {
    it('should create an instance of DeleteProjectRequest', function() {
      ...
      //var instance = new AmazonRekognition.DeleteProjectRequest();
      //expect(instance).to.be.a(AmazonRekognition.DeleteProjectRequest);
    });
