...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.KinesisDataStream();
  });
  ...
  describe('KinesisDataStream', function() {
    it('should create an instance of KinesisDataStream', function() {
      // uncomment below and update the code to test KinesisDataStream
      //var instance = new AmazonRekognition.KinesisDataStream();
      //expect(instance).to.be.a(AmazonRekognition.KinesisDataStream);
    });
