...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartSegmentDetectionFilters();
  });
  ...
  describe('StartSegmentDetectionFilters', function() {
    it('should create an instance of StartSegmentDetectionFilters', function() {
      // uncomment below and update the code to test StartSegmentDetectionFilters
      //var instance = new AmazonRekognition.StartSegmentDetectionFilters();
      //expect(instance).to.be.a(AmazonRekognition.StartSegmentDetectionFilters);
    });
