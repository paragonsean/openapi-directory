...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateProjectVersionRequestTrainingData();
  });
  ...
  describe('CreateProjectVersionRequestTrainingData', function() {
    it('should create an instance of CreateProjectVersionRequestTrainingData', function() {
      // uncomment below and update the code to test CreateProjectVersionRequestTrainingData
      //var instance = new AmazonRekognition.CreateProjectVersionRequestTrainingData();
      //expect(instance).to.be.a(AmazonRekognition.CreateProjectVersionRequestTrainingData);
    });
