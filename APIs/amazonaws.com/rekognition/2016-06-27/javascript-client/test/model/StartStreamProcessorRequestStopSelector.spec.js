...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartStreamProcessorRequestStopSelector();
  });
  ...
  describe('StartStreamProcessorRequestStopSelector', function() {
    it('should create an instance of StartStreamProcessorRequestStopSelector', function() {
      // uncomment below and update the code to test StartStreamProcessorRequestStopSelector
      //var instance = new AmazonRekognition.StartStreamProcessorRequestStopSelector();
      //expect(instance).to.be.a(AmazonRekognition.StartStreamProcessorRequestStopSelector);
    });

    it('should have the property maxDurationInSeconds (base name: "MaxDurationInSeconds")', function() {
      // uncomment below and update the code to test the property maxDurationInSeconds
      //var instance = new AmazonRekognition.StartStreamProcessorRequestStopSelector();
