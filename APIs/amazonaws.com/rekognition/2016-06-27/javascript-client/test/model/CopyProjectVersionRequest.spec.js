...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CopyProjectVersionRequest();
  });
  ...
  describe('CopyProjectVersionRequest', function() {
    it('should create an instance of CopyProjectVersionRequest', function() {
      // uncomment below and update the code to test CopyProjectVersionRequest
      //var instance = new AmazonRekognition.CopyProjectVersionRequest();
      //expect(instance).to.be.a(AmazonRekognition.CopyProjectVersionRequest);
    });

    it('should have the property sourceProjectArn (base name: "SourceProjectArn")', function() {
      // uncomment below and update the code to test the property sourceProjectArn
      //var instance = new AmazonRekognition.CopyProjectVersionRequest();
    ...
    it('should have the property destinationProjectArn (base name: "DestinationProjectArn")', function() {
      // uncomment below and update the code to test the property destinationProjectArn
      //var instance = new AmazonRekognition.CopyProjectVersionRequest();
      //expect(instance).to.be();
    });
