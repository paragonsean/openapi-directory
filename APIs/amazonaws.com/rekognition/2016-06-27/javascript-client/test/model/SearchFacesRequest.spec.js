...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchFacesRequest();
  });
  ...
  describe('SearchFacesRequest', function() {
    it('should create an instance of SearchFacesRequest', function() {
      // uncomment below and update the code to test SearchFacesRequest
      //var instance = new AmazonRekognition.SearchFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.SearchFacesRequest);
    });
