...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartPersonTrackingRequestVideo();
  });
  ...
  describe('StartPersonTrackingRequestVideo', function() {
    it('should create an instance of StartPersonTrackingRequestVideo', function() {
      // uncomment below and update the code to test StartPersonTrackingRequestVideo
      //var instance = new AmazonRekognition.StartPersonTrackingRequestVideo();
      //expect(instance).to.be.a(AmazonRekognition.StartPersonTrackingRequestVideo);
    });
