...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SegmentTypeInfo();
  });
  ...
  describe('SegmentTypeInfo', function() {
    it('should create an instance of SegmentTypeInfo', function() {
      // uncomment below and update the code to test SegmentTypeInfo
      //var instance = new AmazonRekognition.SegmentTypeInfo();
      //expect(instance).to.be.a(AmazonRekognition.SegmentTypeInfo);
    });
