...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateProjectVersionRequest();
  });
  ...
  describe('CreateProjectVersionRequest', function() {
    it('should create an instance of CreateProjectVersionRequest', function() {
      // uncomment below and update the code to test CreateProjectVersionRequest
      //var instance = new AmazonRekognition.CreateProjectVersionRequest();
      //expect(instance).to.be.a(AmazonRekognition.CreateProjectVersionRequest);
    });
    ...
    it('should have the property trainingData (base name: "TrainingData")', function() {
      // uncomment below and update the code to test the property trainingData
      //var instance = new AmazonRekognition.CreateProjectVersionRequest();
      //expect(instance).to.be();
    });

    it('should have the property testingData (base name: "TestingData")', function() {
      // uncomment below and update the code to test the property testingData
      //var instance = new AmazonRekognition.CreateProjectVersionRequest();
      //expect(instance).to.be();
    });
