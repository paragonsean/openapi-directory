...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PersonDetection();
  });
  ...
  describe('PersonDetection', function() {
    it('should create an instance of PersonDetection', function() {
      // uncomment below and update the code to test PersonDetection
      //var instance = new AmazonRekognition.PersonDetection();
      //expect(instance).to.be.a(AmazonRekognition.PersonDetection);
    });
