...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartSegmentDetectionRequestFilters();
  });
  ...
  describe('StartSegmentDetectionRequestFilters', function() {
    it('should create an instance of StartSegmentDetectionRequestFilters', function() {
      // uncomment below and update the code to test StartSegmentDetectionRequestFilters
      //var instance = new AmazonRekognition.StartSegmentDetectionRequestFilters();
      //expect(instance).to.be.a(AmazonRekognition.StartSegmentDetectionRequestFilters);
    });

    it('should have the property technicalCueFilter (base name: "TechnicalCueFilter")', function() {
      // uncomment below and update the code to test the property technicalCueFilter
      //var instance = new AmazonRekognition.StartSegmentDetectionRequestFilters();
      //expect(instance).to.be();
    });

    it('should have the property shotFilter (base name: "ShotFilter")', function() {
      // uncomment below and update the code to test the property shotFilter
      //var instance = new AmazonRekognition.StartSegmentDetectionRequestFilters();
      //expect(instance).to.be();
    });
