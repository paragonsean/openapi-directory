...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetLabelDetectionRequest();
  });
  ...
  describe('GetLabelDetectionRequest', function() {
    it('should create an instance of GetLabelDetectionRequest', function() {
      // uncomment below and update the code to test GetLabelDetectionRequest
      //var instance = new AmazonRekognition.GetLabelDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetLabelDetectionRequest);
    });
