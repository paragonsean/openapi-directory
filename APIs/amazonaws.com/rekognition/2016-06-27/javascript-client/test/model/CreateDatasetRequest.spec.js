...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateDatasetRequest();
  });
  ...
  describe('CreateDatasetRequest', function() {
    it('should create an instance of CreateDatasetRequest', function() {
      ...
      //var instance = new AmazonRekognition.CreateDatasetRequest();
      //expect(instance).to.be.a(AmazonRekognition.CreateDatasetRequest);
    });
