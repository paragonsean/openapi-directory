...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectCustomLabelsRequest();
  });
  ...
  describe('DetectCustomLabelsRequest', function() {
    it('should create an instance of DetectCustomLabelsRequest', function() {
      // uncomment below and update the code to test DetectCustomLabelsRequest
      //var instance = new AmazonRekognition.DetectCustomLabelsRequest();
      //expect(instance).to.be.a(AmazonRekognition.DetectCustomLabelsRequest);
    });
