...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetContentModerationResponse();
  });
  ...
  describe('GetContentModerationResponse', function() {
    it('should create an instance of GetContentModerationResponse', function() {
      // uncomment below and update the code to test GetContentModerationResponse
      //var instance = new AmazonRekognition.GetContentModerationResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetContentModerationResponse);
    });
    ...
    it('should have the property moderationLabels (base name: "ModerationLabels")', function() {
      // uncomment below and update the code to test the property moderationLabels
      //var instance = new AmazonRekognition.GetContentModerationResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property moderationModelVersion (base name: "ModerationModelVersion")', function() {
      // uncomment below and update the code to test the property moderationModelVersion
      //var instance = new AmazonRekognition.GetContentModerationResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property getRequestMetadata (base name: "GetRequestMetadata")', function() {
      // uncomment below and update the code to test the property getRequestMetadata
      //var instance = new AmazonRekognition.GetContentModerationResponse();
      //expect(instance).to.be();
    });
