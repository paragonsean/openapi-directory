...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeStreamProcessorRequest();
  });
  ...
  describe('DescribeStreamProcessorRequest', function() {
    it('should create an instance of DescribeStreamProcessorRequest', function() {
      // uncomment below and update the code to test DescribeStreamProcessorRequest
      //var instance = new AmazonRekognition.DescribeStreamProcessorRequest();
      //expect(instance).to.be.a(AmazonRekognition.DescribeStreamProcessorRequest);
    });
