...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsRequestSettings();
  });
  ...
  describe('DetectLabelsRequestSettings', function() {
    it('should create an instance of DetectLabelsRequestSettings', function() {
      // uncomment below and update the code to test DetectLabelsRequestSettings
      //var instance = new AmazonRekognition.DetectLabelsRequestSettings();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsRequestSettings);
    });
