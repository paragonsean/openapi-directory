...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailAgeRange();
  });
  ...
  describe('FaceDetailAgeRange', function() {
    it('should create an instance of FaceDetailAgeRange', function() {
      // uncomment below and update the code to test FaceDetailAgeRange
      //var instance = new AmazonRekognition.FaceDetailAgeRange();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailAgeRange);
    });
