...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailSunglasses();
  });
  ...
  describe('FaceDetailSunglasses', function() {
    it('should create an instance of FaceDetailSunglasses', function() {
      // uncomment below and update the code to test FaceDetailSunglasses
      //var instance = new AmazonRekognition.FaceDetailSunglasses();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailSunglasses);
    });
