...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UserMatch();
  });
  ...
  describe('UserMatch', function() {
    it('should create an instance of UserMatch', function() {
      // uncomment below and update the code to test UserMatch
      //var instance = new AmazonRekognition.UserMatch();
      //expect(instance).to.be.a(AmazonRekognition.UserMatch);
    });
