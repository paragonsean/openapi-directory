...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectModerationLabelsRequest();
  });
  ...
  describe('DetectModerationLabelsRequest', function() {
    it('should create an instance of DetectModerationLabelsRequest', function() {
      // uncomment below and update the code to test DetectModerationLabelsRequest
      //var instance = new AmazonRekognition.DetectModerationLabelsRequest();
      //expect(instance).to.be.a(AmazonRekognition.DetectModerationLabelsRequest);
    });
