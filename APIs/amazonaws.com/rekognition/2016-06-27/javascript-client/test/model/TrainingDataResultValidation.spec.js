...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TrainingDataResultValidation();
  });
  ...
  describe('TrainingDataResultValidation', function() {
    it('should create an instance of TrainingDataResultValidation', function() {
      // uncomment below and update the code to test TrainingDataResultValidation
      //var instance = new AmazonRekognition.TrainingDataResultValidation();
      //expect(instance).to.be.a(AmazonRekognition.TrainingDataResultValidation);
    });
