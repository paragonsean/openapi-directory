...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceRecord();
  });
  ...
  describe('FaceRecord', function() {
    it('should create an instance of FaceRecord', function() {
      // uncomment below and update the code to test FaceRecord
      //var instance = new AmazonRekognition.FaceRecord();
      //expect(instance).to.be.a(AmazonRekognition.FaceRecord);
    });
