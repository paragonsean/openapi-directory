...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchUsersResponseSearchedUser();
  });
  ...
  describe('SearchUsersResponseSearchedUser', function() {
    it('should create an instance of SearchUsersResponseSearchedUser', function() {
      // uncomment below and update the code to test SearchUsersResponseSearchedUser
      //var instance = new AmazonRekognition.SearchUsersResponseSearchedUser();
      //expect(instance).to.be.a(AmazonRekognition.SearchUsersResponseSearchedUser);
    });
