...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceSearchRequest();
  });
  ...
  describe('StartFaceSearchRequest', function() {
    it('should create an instance of StartFaceSearchRequest', function() {
      // uncomment below and update the code to test StartFaceSearchRequest
      //var instance = new AmazonRekognition.StartFaceSearchRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceSearchRequest);
    });
    ...
    it('should have the property faceMatchThreshold (base name: "FaceMatchThreshold")', function() {
      // uncomment below and update the code to test the property faceMatchThreshold
      //var instance = new AmazonRekognition.StartFaceSearchRequest();
      //expect(instance).to.be();
    });
