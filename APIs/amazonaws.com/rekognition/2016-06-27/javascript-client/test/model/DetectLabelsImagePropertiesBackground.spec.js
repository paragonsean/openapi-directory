...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImagePropertiesBackground();
  });
  ...
  describe('DetectLabelsImagePropertiesBackground', function() {
    it('should create an instance of DetectLabelsImagePropertiesBackground', function() {
      // uncomment below and update the code to test DetectLabelsImagePropertiesBackground
      //var instance = new AmazonRekognition.DetectLabelsImagePropertiesBackground();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImagePropertiesBackground);
    });
