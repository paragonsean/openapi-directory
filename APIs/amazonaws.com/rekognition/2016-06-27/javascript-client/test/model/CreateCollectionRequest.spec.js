...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateCollectionRequest();
  });
  ...
  describe('CreateCollectionRequest', function() {
    it('should create an instance of CreateCollectionRequest', function() {
      ...
      //var instance = new AmazonRekognition.CreateCollectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.CreateCollectionRequest);
    });
