...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImageProperties();
  });
  ...
  describe('DetectLabelsImageProperties', function() {
    it('should create an instance of DetectLabelsImageProperties', function() {
      // uncomment below and update the code to test DetectLabelsImageProperties
      //var instance = new AmazonRekognition.DetectLabelsImageProperties();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImageProperties);
    });
