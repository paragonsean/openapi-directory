...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchUsersByImageResponse();
  });
  ...
  describe('SearchUsersByImageResponse', function() {
    it('should create an instance of SearchUsersByImageResponse', function() {
      // uncomment below and update the code to test SearchUsersByImageResponse
      //var instance = new AmazonRekognition.SearchUsersByImageResponse();
      //expect(instance).to.be.a(AmazonRekognition.SearchUsersByImageResponse);
    });

    it('should have the property userMatches (base name: "UserMatches")', function() {
      // uncomment below and update the code to test the property userMatches
      //var instance = new AmazonRekognition.SearchUsersByImageResponse();
    ...
    it('should have the property searchedFace (base name: "SearchedFace")', function() {
      // uncomment below and update the code to test the property searchedFace
      //var instance = new AmazonRekognition.SearchUsersByImageResponse();
      //expect(instance).to.be();
    });

    it('should have the property unsearchedFaces (base name: "UnsearchedFaces")', function() {
      // uncomment below and update the code to test the property unsearchedFaces
      //var instance = new AmazonRekognition.SearchUsersByImageResponse();
      //expect(instance).to.be();
    });
