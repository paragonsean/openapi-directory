...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceSearchSettings();
  });
  ...
  describe('FaceSearchSettings', function() {
    it('should create an instance of FaceSearchSettings', function() {
      // uncomment below and update the code to test FaceSearchSettings
      //var instance = new AmazonRekognition.FaceSearchSettings();
      //expect(instance).to.be.a(AmazonRekognition.FaceSearchSettings);
    });
