...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.HumanLoopConfig();
  });
  ...
  describe('HumanLoopConfig', function() {
    it('should create an instance of HumanLoopConfig', function() {
      ...
      //var instance = new AmazonRekognition.HumanLoopConfig();
      //expect(instance).to.be.a(AmazonRekognition.HumanLoopConfig);
    });
