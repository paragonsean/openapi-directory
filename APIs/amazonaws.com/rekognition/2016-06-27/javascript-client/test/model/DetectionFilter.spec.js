...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectionFilter();
  });
  ...
  describe('DetectionFilter', function() {
    it('should create an instance of DetectionFilter', function() {
      // uncomment below and update the code to test DetectionFilter
      //var instance = new AmazonRekognition.DetectionFilter();
      //expect(instance).to.be.a(AmazonRekognition.DetectionFilter);
    });
