...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.EvaluationResultSummary();
  });
  ...
  describe('EvaluationResultSummary', function() {
    it('should create an instance of EvaluationResultSummary', function() {
      // uncomment below and update the code to test EvaluationResultSummary
      //var instance = new AmazonRekognition.EvaluationResultSummary();
      //expect(instance).to.be.a(AmazonRekognition.EvaluationResultSummary);
    });
