...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.UpdateDatasetEntriesRequest();
  });
  ...
  describe('UpdateDatasetEntriesRequest', function() {
    it('should create an instance of UpdateDatasetEntriesRequest', function() {
      ...
      //var instance = new AmazonRekognition.UpdateDatasetEntriesRequest();
      //expect(instance).to.be.a(AmazonRekognition.UpdateDatasetEntriesRequest);
    });
