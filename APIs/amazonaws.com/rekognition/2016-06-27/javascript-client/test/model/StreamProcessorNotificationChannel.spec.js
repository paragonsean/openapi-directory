...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorNotificationChannel();
  });
  ...
  describe('StreamProcessorNotificationChannel', function() {
    it('should create an instance of StreamProcessorNotificationChannel', function() {
      // uncomment below and update the code to test StreamProcessorNotificationChannel
      //var instance = new AmazonRekognition.StreamProcessorNotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorNotificationChannel);
    });
