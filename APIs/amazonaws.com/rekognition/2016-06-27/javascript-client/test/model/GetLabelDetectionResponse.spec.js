...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetLabelDetectionResponse();
  });
  ...
  describe('GetLabelDetectionResponse', function() {
    it('should create an instance of GetLabelDetectionResponse', function() {
      // uncomment below and update the code to test GetLabelDetectionResponse
      //var instance = new AmazonRekognition.GetLabelDetectionResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetLabelDetectionResponse);
    });
    ...
    it('should have the property labelModelVersion (base name: "LabelModelVersion")', function() {
      // uncomment below and update the code to test the property labelModelVersion
      //var instance = new AmazonRekognition.GetLabelDetectionResponse();
      //expect(instance).to.be();
    });
