...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceDetectionRequestVideo();
  });
  ...
  describe('StartFaceDetectionRequestVideo', function() {
    it('should create an instance of StartFaceDetectionRequestVideo', function() {
      // uncomment below and update the code to test StartFaceDetectionRequestVideo
      //var instance = new AmazonRekognition.StartFaceDetectionRequestVideo();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceDetectionRequestVideo);
    });
