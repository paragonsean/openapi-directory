...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListFacesRequest();
  });
  ...
  describe('ListFacesRequest', function() {
    it('should create an instance of ListFacesRequest', function() {
      // uncomment below and update the code to test ListFacesRequest
      //var instance = new AmazonRekognition.ListFacesRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListFacesRequest);
    });
