...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartCelebrityRecognitionResponse();
  });
  ...
  describe('StartCelebrityRecognitionResponse', function() {
    it('should create an instance of StartCelebrityRecognitionResponse', function() {
      // uncomment below and update the code to test StartCelebrityRecognitionResponse
      //var instance = new AmazonRekognition.StartCelebrityRecognitionResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartCelebrityRecognitionResponse);
    });
