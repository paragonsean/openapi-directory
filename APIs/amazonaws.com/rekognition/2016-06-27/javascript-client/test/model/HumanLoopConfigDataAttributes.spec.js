...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.HumanLoopConfigDataAttributes();
  });
  ...
  describe('HumanLoopConfigDataAttributes', function() {
    it('should create an instance of HumanLoopConfigDataAttributes', function() {
      // uncomment below and update the code to test HumanLoopConfigDataAttributes
      //var instance = new AmazonRekognition.HumanLoopConfigDataAttributes();
      //expect(instance).to.be.a(AmazonRekognition.HumanLoopConfigDataAttributes);
    });

    it('should have the property contentClassifiers (base name: "ContentClassifiers")', function() {
      // uncomment below and update the code to test the property contentClassifiers
      //var instance = new AmazonRekognition.HumanLoopConfigDataAttributes();
