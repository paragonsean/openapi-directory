...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ContentModerationDetectionModerationLabel();
  });
  ...
  describe('ContentModerationDetectionModerationLabel', function() {
    it('should create an instance of ContentModerationDetectionModerationLabel', function() {
      // uncomment below and update the code to test ContentModerationDetectionModerationLabel
      //var instance = new AmazonRekognition.ContentModerationDetectionModerationLabel();
      //expect(instance).to.be.a(AmazonRekognition.ContentModerationDetectionModerationLabel);
    });
