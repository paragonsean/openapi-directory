...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartSegmentDetectionFiltersShotFilter();
  });
  ...
  describe('StartSegmentDetectionFiltersShotFilter', function() {
    it('should create an instance of StartSegmentDetectionFiltersShotFilter', function() {
      // uncomment below and update the code to test StartSegmentDetectionFiltersShotFilter
      //var instance = new AmazonRekognition.StartSegmentDetectionFiltersShotFilter();
      //expect(instance).to.be.a(AmazonRekognition.StartSegmentDetectionFiltersShotFilter);
    });

    it('should have the property minSegmentConfidence (base name: "MinSegmentConfidence")', function() {
      // uncomment below and update the code to test the property minSegmentConfidence
      //var instance = new AmazonRekognition.StartSegmentDetectionFiltersShotFilter();
