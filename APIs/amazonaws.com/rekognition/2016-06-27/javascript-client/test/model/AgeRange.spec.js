...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.AgeRange();
  });
  ...
  describe('AgeRange', function() {
    it('should create an instance of AgeRange', function() {
      // uncomment below and update the code to test AgeRange
      //var instance = new AmazonRekognition.AgeRange();
      //expect(instance).to.be.a(AmazonRekognition.AgeRange);
    });
