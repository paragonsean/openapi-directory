...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartContentModerationRequest();
  });
  ...
  describe('StartContentModerationRequest', function() {
    it('should create an instance of StartContentModerationRequest', function() {
      // uncomment below and update the code to test StartContentModerationRequest
      //var instance = new AmazonRekognition.StartContentModerationRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartContentModerationRequest);
    });
