...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeProjectVersionsResponse();
  });
  ...
  describe('DescribeProjectVersionsResponse', function() {
    it('should create an instance of DescribeProjectVersionsResponse', function() {
      // uncomment below and update the code to test DescribeProjectVersionsResponse
      //var instance = new AmazonRekognition.DescribeProjectVersionsResponse();
      //expect(instance).to.be.a(AmazonRekognition.DescribeProjectVersionsResponse);
    });

    it('should have the property projectVersionDescriptions (base name: "ProjectVersionDescriptions")', function() {
      // uncomment below and update the code to test the property projectVersionDescriptions
      //var instance = new AmazonRekognition.DescribeProjectVersionsResponse();
