...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TestingDataResultValidation();
  });
  ...
  describe('TestingDataResultValidation', function() {
    it('should create an instance of TestingDataResultValidation', function() {
      // uncomment below and update the code to test TestingDataResultValidation
      //var instance = new AmazonRekognition.TestingDataResultValidation();
      //expect(instance).to.be.a(AmazonRekognition.TestingDataResultValidation);
    });
