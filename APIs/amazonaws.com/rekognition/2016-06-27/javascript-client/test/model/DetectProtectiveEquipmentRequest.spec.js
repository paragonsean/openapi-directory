...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectProtectiveEquipmentRequest();
  });
  ...
  describe('DetectProtectiveEquipmentRequest', function() {
    it('should create an instance of DetectProtectiveEquipmentRequest', function() {
      // uncomment below and update the code to test DetectProtectiveEquipmentRequest
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentRequest();
      //expect(instance).to.be.a(AmazonRekognition.DetectProtectiveEquipmentRequest);
    });
    ...
    it('should have the property summarizationAttributes (base name: "SummarizationAttributes")', function() {
      // uncomment below and update the code to test the property summarizationAttributes
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentRequest();
      //expect(instance).to.be();
    });
