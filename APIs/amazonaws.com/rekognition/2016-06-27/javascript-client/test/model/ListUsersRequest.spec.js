...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListUsersRequest();
  });
  ...
  describe('ListUsersRequest', function() {
    it('should create an instance of ListUsersRequest', function() {
      ...
      //var instance = new AmazonRekognition.ListUsersRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListUsersRequest);
    });
