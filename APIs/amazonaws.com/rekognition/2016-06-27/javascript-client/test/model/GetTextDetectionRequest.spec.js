...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetTextDetectionRequest();
  });
  ...
  describe('GetTextDetectionRequest', function() {
    it('should create an instance of GetTextDetectionRequest', function() {
      // uncomment below and update the code to test GetTextDetectionRequest
      //var instance = new AmazonRekognition.GetTextDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetTextDetectionRequest);
    });
