...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartTextDetectionFiltersWordFilter();
  });
  ...
  describe('StartTextDetectionFiltersWordFilter', function() {
    it('should create an instance of StartTextDetectionFiltersWordFilter', function() {
      // uncomment below and update the code to test StartTextDetectionFiltersWordFilter
      //var instance = new AmazonRekognition.StartTextDetectionFiltersWordFilter();
      //expect(instance).to.be.a(AmazonRekognition.StartTextDetectionFiltersWordFilter);
    });

    it('should have the property minConfidence (base name: "MinConfidence")', function() {
      // uncomment below and update the code to test the property minConfidence
      //var instance = new AmazonRekognition.StartTextDetectionFiltersWordFilter();
      //expect(instance).to.be();
    });

    it('should have the property minBoundingBoxHeight (base name: "MinBoundingBoxHeight")', function() {
      // uncomment below and update the code to test the property minBoundingBoxHeight
      //var instance = new AmazonRekognition.StartTextDetectionFiltersWordFilter();
      //expect(instance).to.be();
    });

    it('should have the property minBoundingBoxWidth (base name: "MinBoundingBoxWidth")', function() {
      // uncomment below and update the code to test the property minBoundingBoxWidth
      //var instance = new AmazonRekognition.StartTextDetectionFiltersWordFilter();
      //expect(instance).to.be();
    });
