...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailEyeglasses();
  });
  ...
  describe('FaceDetailEyeglasses', function() {
    it('should create an instance of FaceDetailEyeglasses', function() {
      // uncomment below and update the code to test FaceDetailEyeglasses
      //var instance = new AmazonRekognition.FaceDetailEyeglasses();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailEyeglasses);
    });
