...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartTextDetectionRequest();
  });
  ...
  describe('StartTextDetectionRequest', function() {
    it('should create an instance of StartTextDetectionRequest', function() {
      // uncomment below and update the code to test StartTextDetectionRequest
      //var instance = new AmazonRekognition.StartTextDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartTextDetectionRequest);
    });
