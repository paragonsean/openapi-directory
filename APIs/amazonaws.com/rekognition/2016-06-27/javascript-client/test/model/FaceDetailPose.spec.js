...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailPose();
  });
  ...
  describe('FaceDetailPose', function() {
    it('should create an instance of FaceDetailPose', function() {
      // uncomment below and update the code to test FaceDetailPose
      //var instance = new AmazonRekognition.FaceDetailPose();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailPose);
    });
