...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImagePropertiesSettings();
  });
  ...
  describe('DetectLabelsImagePropertiesSettings', function() {
    it('should create an instance of DetectLabelsImagePropertiesSettings', function() {
      // uncomment below and update the code to test DetectLabelsImagePropertiesSettings
      //var instance = new AmazonRekognition.DetectLabelsImagePropertiesSettings();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImagePropertiesSettings);
    });

    it('should have the property maxDominantColors (base name: "MaxDominantColors")', function() {
      // uncomment below and update the code to test the property maxDominantColors
      //var instance = new AmazonRekognition.DetectLabelsImagePropertiesSettings();
