...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartPersonTrackingResponse();
  });
  ...
  describe('StartPersonTrackingResponse', function() {
    it('should create an instance of StartPersonTrackingResponse', function() {
      // uncomment below and update the code to test StartPersonTrackingResponse
      //var instance = new AmazonRekognition.StartPersonTrackingResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartPersonTrackingResponse);
    });
