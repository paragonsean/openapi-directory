...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateStreamProcessorRequestSettings();
  });
  ...
  describe('CreateStreamProcessorRequestSettings', function() {
    it('should create an instance of CreateStreamProcessorRequestSettings', function() {
      // uncomment below and update the code to test CreateStreamProcessorRequestSettings
      //var instance = new AmazonRekognition.CreateStreamProcessorRequestSettings();
      //expect(instance).to.be.a(AmazonRekognition.CreateStreamProcessorRequestSettings);
    });
