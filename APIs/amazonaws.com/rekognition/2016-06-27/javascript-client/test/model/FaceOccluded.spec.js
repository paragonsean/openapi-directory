...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceOccluded();
  });
  ...
  describe('FaceOccluded', function() {
    it('should create an instance of FaceOccluded', function() {
      // uncomment below and update the code to test FaceOccluded
      //var instance = new AmazonRekognition.FaceOccluded();
      //expect(instance).to.be.a(AmazonRekognition.FaceOccluded);
    });
