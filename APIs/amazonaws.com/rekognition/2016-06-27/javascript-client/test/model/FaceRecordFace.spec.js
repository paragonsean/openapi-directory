...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceRecordFace();
  });
  ...
  describe('FaceRecordFace', function() {
    it('should create an instance of FaceRecordFace', function() {
      // uncomment below and update the code to test FaceRecordFace
      //var instance = new AmazonRekognition.FaceRecordFace();
      //expect(instance).to.be.a(AmazonRekognition.FaceRecordFace);
    });
