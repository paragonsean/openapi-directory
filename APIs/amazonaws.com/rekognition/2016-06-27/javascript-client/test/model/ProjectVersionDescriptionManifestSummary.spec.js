...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectVersionDescriptionManifestSummary();
  });
  ...
  describe('ProjectVersionDescriptionManifestSummary', function() {
    it('should create an instance of ProjectVersionDescriptionManifestSummary', function() {
      // uncomment below and update the code to test ProjectVersionDescriptionManifestSummary
      //var instance = new AmazonRekognition.ProjectVersionDescriptionManifestSummary();
      //expect(instance).to.be.a(AmazonRekognition.ProjectVersionDescriptionManifestSummary);
    });
