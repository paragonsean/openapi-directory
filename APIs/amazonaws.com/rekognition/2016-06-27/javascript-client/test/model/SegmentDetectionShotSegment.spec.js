...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SegmentDetectionShotSegment();
  });
  ...
  describe('SegmentDetectionShotSegment', function() {
    it('should create an instance of SegmentDetectionShotSegment', function() {
      // uncomment below and update the code to test SegmentDetectionShotSegment
      //var instance = new AmazonRekognition.SegmentDetectionShotSegment();
      //expect(instance).to.be.a(AmazonRekognition.SegmentDetectionShotSegment);
    });
