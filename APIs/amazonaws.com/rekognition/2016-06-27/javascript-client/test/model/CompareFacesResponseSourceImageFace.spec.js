...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CompareFacesResponseSourceImageFace();
  });
  ...
  describe('CompareFacesResponseSourceImageFace', function() {
    it('should create an instance of CompareFacesResponseSourceImageFace', function() {
      // uncomment below and update the code to test CompareFacesResponseSourceImageFace
      //var instance = new AmazonRekognition.CompareFacesResponseSourceImageFace();
      //expect(instance).to.be.a(AmazonRekognition.CompareFacesResponseSourceImageFace);
    });
