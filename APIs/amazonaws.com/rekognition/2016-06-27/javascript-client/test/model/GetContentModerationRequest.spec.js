...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetContentModerationRequest();
  });
  ...
  describe('GetContentModerationRequest', function() {
    it('should create an instance of GetContentModerationRequest', function() {
      // uncomment below and update the code to test GetContentModerationRequest
      //var instance = new AmazonRekognition.GetContentModerationRequest();
      //expect(instance).to.be.a(AmazonRekognition.GetContentModerationRequest);
    });
