...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsImageBackgroundQuality();
  });
  ...
  describe('DetectLabelsImageBackgroundQuality', function() {
    it('should create an instance of DetectLabelsImageBackgroundQuality', function() {
      // uncomment below and update the code to test DetectLabelsImageBackgroundQuality
      //var instance = new AmazonRekognition.DetectLabelsImageBackgroundQuality();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsImageBackgroundQuality);
    });
