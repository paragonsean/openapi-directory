...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PutProjectPolicyResponse();
  });
  ...
  describe('PutProjectPolicyResponse', function() {
    it('should create an instance of PutProjectPolicyResponse', function() {
      // uncomment below and update the code to test PutProjectPolicyResponse
      //var instance = new AmazonRekognition.PutProjectPolicyResponse();
      //expect(instance).to.be.a(AmazonRekognition.PutProjectPolicyResponse);
    });
