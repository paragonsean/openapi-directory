...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartProjectVersionResponse();
  });
  ...
  describe('StartProjectVersionResponse', function() {
    it('should create an instance of StartProjectVersionResponse', function() {
      // uncomment below and update the code to test StartProjectVersionResponse
      //var instance = new AmazonRekognition.StartProjectVersionResponse();
      //expect(instance).to.be.a(AmazonRekognition.StartProjectVersionResponse);
    });
