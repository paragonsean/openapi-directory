...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GeneralLabelsSettings();
  });
  ...
  describe('GeneralLabelsSettings', function() {
    it('should create an instance of GeneralLabelsSettings', function() {
      // uncomment below and update the code to test GeneralLabelsSettings
      //var instance = new AmazonRekognition.GeneralLabelsSettings();
      //expect(instance).to.be.a(AmazonRekognition.GeneralLabelsSettings);
    });
