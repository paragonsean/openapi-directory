...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.AssociateFacesResponse();
  });
  ...
  describe('AssociateFacesResponse', function() {
    it('should create an instance of AssociateFacesResponse', function() {
      // uncomment below and update the code to test AssociateFacesResponse
      //var instance = new AmazonRekognition.AssociateFacesResponse();
      //expect(instance).to.be.a(AmazonRekognition.AssociateFacesResponse);
    });

    it('should have the property associatedFaces (base name: "AssociatedFaces")', function() {
      // uncomment below and update the code to test the property associatedFaces
      //var instance = new AmazonRekognition.AssociateFacesResponse();
      //expect(instance).to.be();
    });

    it('should have the property unsuccessfulFaceAssociations (base name: "UnsuccessfulFaceAssociations")', function() {
      // uncomment below and update the code to test the property unsuccessfulFaceAssociations
      //var instance = new AmazonRekognition.AssociateFacesResponse();
      //expect(instance).to.be();
    });
