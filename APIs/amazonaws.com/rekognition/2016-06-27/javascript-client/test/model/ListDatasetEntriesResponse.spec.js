...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListDatasetEntriesResponse();
  });
  ...
  describe('ListDatasetEntriesResponse', function() {
    it('should create an instance of ListDatasetEntriesResponse', function() {
      // uncomment below and update the code to test ListDatasetEntriesResponse
      //var instance = new AmazonRekognition.ListDatasetEntriesResponse();
      //expect(instance).to.be.a(AmazonRekognition.ListDatasetEntriesResponse);
    });

    it('should have the property datasetEntries (base name: "DatasetEntries")', function() {
      // uncomment below and update the code to test the property datasetEntries
      //var instance = new AmazonRekognition.ListDatasetEntriesResponse();
