...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StreamProcessorOutputKinesisDataStream();
  });
  ...
  describe('StreamProcessorOutputKinesisDataStream', function() {
    it('should create an instance of StreamProcessorOutputKinesisDataStream', function() {
      // uncomment below and update the code to test StreamProcessorOutputKinesisDataStream
      //var instance = new AmazonRekognition.StreamProcessorOutputKinesisDataStream();
      //expect(instance).to.be.a(AmazonRekognition.StreamProcessorOutputKinesisDataStream);
    });
