...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.LabelAlias();
  });
  ...
  describe('LabelAlias', function() {
    it('should create an instance of LabelAlias', function() {
      // uncomment below and update the code to test LabelAlias
      //var instance = new AmazonRekognition.LabelAlias();
      //expect(instance).to.be.a(AmazonRekognition.LabelAlias);
    });
