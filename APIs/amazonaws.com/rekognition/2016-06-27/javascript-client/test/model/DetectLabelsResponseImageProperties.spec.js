...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectLabelsResponseImageProperties();
  });
  ...
  describe('DetectLabelsResponseImageProperties', function() {
    it('should create an instance of DetectLabelsResponseImageProperties', function() {
      // uncomment below and update the code to test DetectLabelsResponseImageProperties
      //var instance = new AmazonRekognition.DetectLabelsResponseImageProperties();
      //expect(instance).to.be.a(AmazonRekognition.DetectLabelsResponseImageProperties);
    });
