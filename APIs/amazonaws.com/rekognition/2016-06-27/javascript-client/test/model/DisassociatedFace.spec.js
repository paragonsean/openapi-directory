...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DisassociatedFace();
  });
  ...
  describe('DisassociatedFace', function() {
    it('should create an instance of DisassociatedFace', function() {
      // uncomment below and update the code to test DisassociatedFace
      //var instance = new AmazonRekognition.DisassociatedFace();
      //expect(instance).to.be.a(AmazonRekognition.DisassociatedFace);
    });
