...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.SearchedFaceDetails();
  });
  ...
  describe('SearchedFaceDetails', function() {
    it('should create an instance of SearchedFaceDetails', function() {
      // uncomment below and update the code to test SearchedFaceDetails
      //var instance = new AmazonRekognition.SearchedFaceDetails();
      //expect(instance).to.be.a(AmazonRekognition.SearchedFaceDetails);
    });

    it('should have the property faceDetail (base name: "FaceDetail")', function() {
      // uncomment below and update the code to test the property faceDetail
      //var instance = new AmazonRekognition.SearchedFaceDetails();
