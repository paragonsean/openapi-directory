...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListDatasetLabelsRequest();
  });
  ...
  describe('ListDatasetLabelsRequest', function() {
    it('should create an instance of ListDatasetLabelsRequest', function() {
      // uncomment below and update the code to test ListDatasetLabelsRequest
      //var instance = new AmazonRekognition.ListDatasetLabelsRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListDatasetLabelsRequest);
    });
