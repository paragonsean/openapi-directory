...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceMatchFace();
  });
  ...
  describe('FaceMatchFace', function() {
    it('should create an instance of FaceMatchFace', function() {
      // uncomment below and update the code to test FaceMatchFace
      //var instance = new AmazonRekognition.FaceMatchFace();
      //expect(instance).to.be.a(AmazonRekognition.FaceMatchFace);
    });
    ...
    it('should have the property externalImageId (base name: "ExternalImageId")', function() {
      // uncomment below and update the code to test the property externalImageId
      //var instance = new AmazonRekognition.FaceMatchFace();
      //expect(instance).to.be();
    });
    ...
    it('should have the property indexFacesModelVersion (base name: "IndexFacesModelVersion")', function() {
      // uncomment below and update the code to test the property indexFacesModelVersion
      //var instance = new AmazonRekognition.FaceMatchFace();
      //expect(instance).to.be();
    });
