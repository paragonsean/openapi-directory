...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectModerationLabelsResponseHumanLoopActivationOutput();
  });
  ...
  describe('DetectModerationLabelsResponseHumanLoopActivationOutput', function() {
    it('should create an instance of DetectModerationLabelsResponseHumanLoopActivationOutput', function() {
      // uncomment below and update the code to test DetectModerationLabelsResponseHumanLoopActivationOutput
      //var instance = new AmazonRekognition.DetectModerationLabelsResponseHumanLoopActivationOutput();
      //expect(instance).to.be.a(AmazonRekognition.DetectModerationLabelsResponseHumanLoopActivationOutput);
    });
