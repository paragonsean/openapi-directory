...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.TechnicalCueSegment();
  });
  ...
  describe('TechnicalCueSegment', function() {
    it('should create an instance of TechnicalCueSegment', function() {
      // uncomment below and update the code to test TechnicalCueSegment
      //var instance = new AmazonRekognition.TechnicalCueSegment();
      //expect(instance).to.be.a(AmazonRekognition.TechnicalCueSegment);
    });
