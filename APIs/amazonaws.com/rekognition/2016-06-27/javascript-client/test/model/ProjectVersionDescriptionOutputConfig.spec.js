...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectVersionDescriptionOutputConfig();
  });
  ...
  describe('ProjectVersionDescriptionOutputConfig', function() {
    it('should create an instance of ProjectVersionDescriptionOutputConfig', function() {
      // uncomment below and update the code to test ProjectVersionDescriptionOutputConfig
      //var instance = new AmazonRekognition.ProjectVersionDescriptionOutputConfig();
      //expect(instance).to.be.a(AmazonRekognition.ProjectVersionDescriptionOutputConfig);
    });
