...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.HumanLoopDataAttributes();
  });
  ...
  describe('HumanLoopDataAttributes', function() {
    it('should create an instance of HumanLoopDataAttributes', function() {
      ...
      //var instance = new AmazonRekognition.HumanLoopDataAttributes();
      //expect(instance).to.be.a(AmazonRekognition.HumanLoopDataAttributes);
    });
