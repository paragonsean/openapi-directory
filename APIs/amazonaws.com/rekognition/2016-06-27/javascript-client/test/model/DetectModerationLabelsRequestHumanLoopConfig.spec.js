...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectModerationLabelsRequestHumanLoopConfig();
  });
  ...
  describe('DetectModerationLabelsRequestHumanLoopConfig', function() {
    it('should create an instance of DetectModerationLabelsRequestHumanLoopConfig', function() {
      // uncomment below and update the code to test DetectModerationLabelsRequestHumanLoopConfig
      //var instance = new AmazonRekognition.DetectModerationLabelsRequestHumanLoopConfig();
      //expect(instance).to.be.a(AmazonRekognition.DetectModerationLabelsRequestHumanLoopConfig);
    });
