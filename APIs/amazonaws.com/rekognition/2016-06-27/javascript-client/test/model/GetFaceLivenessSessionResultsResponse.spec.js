...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GetFaceLivenessSessionResultsResponse();
  });
  ...
  describe('GetFaceLivenessSessionResultsResponse', function() {
    it('should create an instance of GetFaceLivenessSessionResultsResponse', function() {
      // uncomment below and update the code to test GetFaceLivenessSessionResultsResponse
      //var instance = new AmazonRekognition.GetFaceLivenessSessionResultsResponse();
      //expect(instance).to.be.a(AmazonRekognition.GetFaceLivenessSessionResultsResponse);
    });
    ...
    it('should have the property referenceImage (base name: "ReferenceImage")', function() {
      // uncomment below and update the code to test the property referenceImage
      //var instance = new AmazonRekognition.GetFaceLivenessSessionResultsResponse();
      //expect(instance).to.be();
    });

    it('should have the property auditImages (base name: "AuditImages")', function() {
      // uncomment below and update the code to test the property auditImages
      //var instance = new AmazonRekognition.GetFaceLivenessSessionResultsResponse();
      //expect(instance).to.be();
    });
