...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DescribeDatasetResponseDatasetDescription();
  });
  ...
  describe('DescribeDatasetResponseDatasetDescription', function() {
    it('should create an instance of DescribeDatasetResponseDatasetDescription', function() {
      // uncomment below and update the code to test DescribeDatasetResponseDatasetDescription
      //var instance = new AmazonRekognition.DescribeDatasetResponseDatasetDescription();
      //expect(instance).to.be.a(AmazonRekognition.DescribeDatasetResponseDatasetDescription);
    });
    ...
    it('should have the property statusMessageCode (base name: "StatusMessageCode")', function() {
      // uncomment below and update the code to test the property statusMessageCode
      //var instance = new AmazonRekognition.DescribeDatasetResponseDatasetDescription();
      //expect(instance).to.be();
    });

    it('should have the property datasetStats (base name: "DatasetStats")', function() {
      // uncomment below and update the code to test the property datasetStats
      //var instance = new AmazonRekognition.DescribeDatasetResponseDatasetDescription();
      //expect(instance).to.be();
    });
