...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ValidationData();
  });
  ...
  describe('ValidationData', function() {
    it('should create an instance of ValidationData', function() {
      // uncomment below and update the code to test ValidationData
      //var instance = new AmazonRekognition.ValidationData();
      //expect(instance).to.be.a(AmazonRekognition.ValidationData);
    });
