...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailQuality();
  });
  ...
  describe('FaceDetailQuality', function() {
    it('should create an instance of FaceDetailQuality', function() {
      // uncomment below and update the code to test FaceDetailQuality
      //var instance = new AmazonRekognition.FaceDetailQuality();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailQuality);
    });
