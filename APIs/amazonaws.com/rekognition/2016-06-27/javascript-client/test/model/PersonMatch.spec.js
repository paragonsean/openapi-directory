...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PersonMatch();
  });
  ...
  describe('PersonMatch', function() {
    it('should create an instance of PersonMatch', function() {
      // uncomment below and update the code to test PersonMatch
      //var instance = new AmazonRekognition.PersonMatch();
      //expect(instance).to.be.a(AmazonRekognition.PersonMatch);
    });
