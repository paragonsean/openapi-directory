...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailMustache();
  });
  ...
  describe('FaceDetailMustache', function() {
    it('should create an instance of FaceDetailMustache', function() {
      // uncomment below and update the code to test FaceDetailMustache
      //var instance = new AmazonRekognition.FaceDetailMustache();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailMustache);
    });
