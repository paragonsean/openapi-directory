...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CelebrityDetailBoundingBox();
  });
  ...
  describe('CelebrityDetailBoundingBox', function() {
    it('should create an instance of CelebrityDetailBoundingBox', function() {
      // uncomment below and update the code to test CelebrityDetailBoundingBox
      //var instance = new AmazonRekognition.CelebrityDetailBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.CelebrityDetailBoundingBox);
    });
