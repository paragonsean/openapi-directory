...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectCustomLabelsResponse();
  });
  ...
  describe('DetectCustomLabelsResponse', function() {
    it('should create an instance of DetectCustomLabelsResponse', function() {
      // uncomment below and update the code to test DetectCustomLabelsResponse
      //var instance = new AmazonRekognition.DetectCustomLabelsResponse();
      //expect(instance).to.be.a(AmazonRekognition.DetectCustomLabelsResponse);
    });
