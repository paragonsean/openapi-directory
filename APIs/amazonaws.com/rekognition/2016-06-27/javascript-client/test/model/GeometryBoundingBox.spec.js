...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.GeometryBoundingBox();
  });
  ...
  describe('GeometryBoundingBox', function() {
    it('should create an instance of GeometryBoundingBox', function() {
      ...
      //var instance = new AmazonRekognition.GeometryBoundingBox();
      //expect(instance).to.be.a(AmazonRekognition.GeometryBoundingBox);
    });
