...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.FaceDetailEyesOpen();
  });
  ...
  describe('FaceDetailEyesOpen', function() {
    it('should create an instance of FaceDetailEyesOpen', function() {
      // uncomment below and update the code to test FaceDetailEyesOpen
      //var instance = new AmazonRekognition.FaceDetailEyesOpen();
      //expect(instance).to.be.a(AmazonRekognition.FaceDetailEyesOpen);
    });
