...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListCollectionsRequest();
  });
  ...
  describe('ListCollectionsRequest', function() {
    it('should create an instance of ListCollectionsRequest', function() {
      ...
      //var instance = new AmazonRekognition.ListCollectionsRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListCollectionsRequest);
    });
