...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateProjectVersionRequestTestingData();
  });
  ...
  describe('CreateProjectVersionRequestTestingData', function() {
    it('should create an instance of CreateProjectVersionRequestTestingData', function() {
      // uncomment below and update the code to test CreateProjectVersionRequestTestingData
      //var instance = new AmazonRekognition.CreateProjectVersionRequestTestingData();
      //expect(instance).to.be.a(AmazonRekognition.CreateProjectVersionRequestTestingData);
    });
