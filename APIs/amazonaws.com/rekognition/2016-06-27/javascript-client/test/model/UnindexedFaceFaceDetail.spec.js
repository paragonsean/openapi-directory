...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.AmazonRekognition);
  }
}(this, function(expect, AmazonRekognition) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new AmazonRekognition.UnindexedFaceFaceDetail();
  });
  ...
  describe('UnindexedFaceFaceDetail', function() {
    it('should create an instance of UnindexedFaceFaceDetail', function() {
      // uncomment below and update the code to test UnindexedFaceFaceDetail
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be.a(AmazonRekognition.UnindexedFaceFaceDetail);
    });
    ...
    it('should have the property eyeglasses (base name: "Eyeglasses")', function() {
      // uncomment below and update the code to test the property eyeglasses
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });

    it('should have the property sunglasses (base name: "Sunglasses")', function() {
      // uncomment below and update the code to test the property sunglasses
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property beard (base name: "Beard")', function() {
      // uncomment below and update the code to test the property beard
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });

    it('should have the property mustache (base name: "Mustache")', function() {
      // uncomment below and update the code to test the property mustache
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });

    it('should have the property eyesOpen (base name: "EyesOpen")', function() {
      // uncomment below and update the code to test the property eyesOpen
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });

    it('should have the property mouthOpen (base name: "MouthOpen")', function() {
      // uncomment below and update the code to test the property mouthOpen
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property faceOccluded (base name: "FaceOccluded")', function() {
      // uncomment below and update the code to test the property faceOccluded
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });

    it('should have the property eyeDirection (base name: "EyeDirection")', function() {
      // uncomment below and update the code to test the property eyeDirection
      //var instance = new AmazonRekognition.UnindexedFaceFaceDetail();
      //expect(instance).to.be();
    });
