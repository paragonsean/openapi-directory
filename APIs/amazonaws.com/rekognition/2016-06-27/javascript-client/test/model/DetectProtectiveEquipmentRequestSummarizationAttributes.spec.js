...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DetectProtectiveEquipmentRequestSummarizationAttributes();
  });
  ...
  describe('DetectProtectiveEquipmentRequestSummarizationAttributes', function() {
    it('should create an instance of DetectProtectiveEquipmentRequestSummarizationAttributes', function() {
      // uncomment below and update the code to test DetectProtectiveEquipmentRequestSummarizationAttributes
      //var instance = new AmazonRekognition.DetectProtectiveEquipmentRequestSummarizationAttributes();
      //expect(instance).to.be.a(AmazonRekognition.DetectProtectiveEquipmentRequestSummarizationAttributes);
    });
