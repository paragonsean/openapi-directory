...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ListStreamProcessorsRequest();
  });
  ...
  describe('ListStreamProcessorsRequest', function() {
    it('should create an instance of ListStreamProcessorsRequest', function() {
      // uncomment below and update the code to test ListStreamProcessorsRequest
      //var instance = new AmazonRekognition.ListStreamProcessorsRequest();
      //expect(instance).to.be.a(AmazonRekognition.ListStreamProcessorsRequest);
    });
