...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartFaceDetectionRequest();
  });
  ...
  describe('StartFaceDetectionRequest', function() {
    it('should create an instance of StartFaceDetectionRequest', function() {
      // uncomment below and update the code to test StartFaceDetectionRequest
      //var instance = new AmazonRekognition.StartFaceDetectionRequest();
      //expect(instance).to.be.a(AmazonRekognition.StartFaceDetectionRequest);
    });
