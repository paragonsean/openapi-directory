...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.StartContentModerationRequestNotificationChannel();
  });
  ...
  describe('StartContentModerationRequestNotificationChannel', function() {
    it('should create an instance of StartContentModerationRequestNotificationChannel', function() {
      // uncomment below and update the code to test StartContentModerationRequestNotificationChannel
      //var instance = new AmazonRekognition.StartContentModerationRequestNotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.StartContentModerationRequestNotificationChannel);
    });
