...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.DatasetLabelDescription();
  });
  ...
  describe('DatasetLabelDescription', function() {
    it('should create an instance of DatasetLabelDescription', function() {
      // uncomment below and update the code to test DatasetLabelDescription
      //var instance = new AmazonRekognition.DatasetLabelDescription();
      //expect(instance).to.be.a(AmazonRekognition.DatasetLabelDescription);
    });
