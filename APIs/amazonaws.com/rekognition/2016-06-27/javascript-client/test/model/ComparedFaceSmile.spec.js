...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ComparedFaceSmile();
  });
  ...
  describe('ComparedFaceSmile', function() {
    it('should create an instance of ComparedFaceSmile', function() {
      // uncomment below and update the code to test ComparedFaceSmile
      //var instance = new AmazonRekognition.ComparedFaceSmile();
      //expect(instance).to.be.a(AmazonRekognition.ComparedFaceSmile);
    });
