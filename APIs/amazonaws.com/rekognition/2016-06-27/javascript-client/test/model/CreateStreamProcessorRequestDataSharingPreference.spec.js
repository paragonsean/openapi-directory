...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.CreateStreamProcessorRequestDataSharingPreference();
  });
  ...
  describe('CreateStreamProcessorRequestDataSharingPreference', function() {
    it('should create an instance of CreateStreamProcessorRequestDataSharingPreference', function() {
      // uncomment below and update the code to test CreateStreamProcessorRequestDataSharingPreference
      //var instance = new AmazonRekognition.CreateStreamProcessorRequestDataSharingPreference();
      //expect(instance).to.be.a(AmazonRekognition.CreateStreamProcessorRequestDataSharingPreference);
    });
