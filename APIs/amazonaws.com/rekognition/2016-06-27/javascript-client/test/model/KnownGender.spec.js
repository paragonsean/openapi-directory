...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.KnownGender();
  });
  ...
  describe('KnownGender', function() {
    it('should create an instance of KnownGender', function() {
      // uncomment below and update the code to test KnownGender
      //var instance = new AmazonRekognition.KnownGender();
      //expect(instance).to.be.a(AmazonRekognition.KnownGender);
    });
