...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.NotificationChannel();
  });
  ...
  describe('NotificationChannel', function() {
    it('should create an instance of NotificationChannel', function() {
      // uncomment below and update the code to test NotificationChannel
      //var instance = new AmazonRekognition.NotificationChannel();
      //expect(instance).to.be.a(AmazonRekognition.NotificationChannel);
    });
