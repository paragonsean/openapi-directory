...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.PersonMatchPerson();
  });
  ...
  describe('PersonMatchPerson', function() {
    it('should create an instance of PersonMatchPerson', function() {
      // uncomment below and update the code to test PersonMatchPerson
      //var instance = new AmazonRekognition.PersonMatchPerson();
      //expect(instance).to.be.a(AmazonRekognition.PersonMatchPerson);
    });
