...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ImageQuality();
  });
  ...
  describe('ImageQuality', function() {
    it('should create an instance of ImageQuality', function() {
      // uncomment below and update the code to test ImageQuality
      //var instance = new AmazonRekognition.ImageQuality();
      //expect(instance).to.be.a(AmazonRekognition.ImageQuality);
    });
