...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRekognition.ProjectVersionDescription();
  });
  ...
  describe('ProjectVersionDescription', function() {
    it('should create an instance of ProjectVersionDescription', function() {
      // uncomment below and update the code to test ProjectVersionDescription
      //var instance = new AmazonRekognition.ProjectVersionDescription();
      //expect(instance).to.be.a(AmazonRekognition.ProjectVersionDescription);
    });
    ...
    it('should have the property billableTrainingTimeInSeconds (base name: "BillableTrainingTimeInSeconds")', function() {
      // uncomment below and update the code to test the property billableTrainingTimeInSeconds
      //var instance = new AmazonRekognition.ProjectVersionDescription();
      //expect(instance).to.be();
    });

    it('should have the property trainingEndTimestamp (base name: "TrainingEndTimestamp")', function() {
      // uncomment below and update the code to test the property trainingEndTimestamp
      //var instance = new AmazonRekognition.ProjectVersionDescription();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trainingDataResult (base name: "TrainingDataResult")', function() {
      // uncomment below and update the code to test the property trainingDataResult
      //var instance = new AmazonRekognition.ProjectVersionDescription();
      //expect(instance).to.be();
    });

    it('should have the property testingDataResult (base name: "TestingDataResult")', function() {
      // uncomment below and update the code to test the property testingDataResult
      //var instance = new AmazonRekognition.ProjectVersionDescription();
      //expect(instance).to.be();
    });
    ...
    it('should have the property manifestSummary (base name: "ManifestSummary")', function() {
      // uncomment below and update the code to test the property manifestSummary
      //var instance = new AmazonRekognition.ProjectVersionDescription();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceProjectVersionArn (base name: "SourceProjectVersionArn")', function() {
      // uncomment below and update the code to test the property sourceProjectVersionArn
      //var instance = new AmazonRekognition.ProjectVersionDescription();
      //expect(instance).to.be();
    });
