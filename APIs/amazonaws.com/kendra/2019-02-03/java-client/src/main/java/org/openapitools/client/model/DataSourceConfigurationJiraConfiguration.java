...
public class DataSourceConfigurationJiraConfiguration {
  ...
  public DataSourceConfigurationJiraConfiguration() {
  }

  public DataSourceConfigurationJiraConfiguration jiraAccountUrl(String jiraAccountUrl) {
  ...
  public DataSourceConfigurationJiraConfiguration secretArn(String secretArn) {
  ...
  public DataSourceConfigurationJiraConfiguration useChangeLog(Boolean useChangeLog) {
  ...
  public DataSourceConfigurationJiraConfiguration project(List project) {
  ...
  public DataSourceConfigurationJiraConfiguration issueType(List issueType) {
  ...
  public DataSourceConfigurationJiraConfiguration status(List status) {
    this.status = status;
    return this;
  }
  ...
  public DataSourceConfigurationJiraConfiguration issueSubEntityFilter(List issueSubEntityFilter) {
  ...
  public DataSourceConfigurationJiraConfiguration attachmentFieldMappings(List attachmentFieldMappings) {
  ...
  public DataSourceConfigurationJiraConfiguration commentFieldMappings(List commentFieldMappings) {
  ...
  public DataSourceConfigurationJiraConfiguration issueFieldMappings(List issueFieldMappings) {
  ...
  public DataSourceConfigurationJiraConfiguration projectFieldMappings(List projectFieldMappings) {
  ...
  public DataSourceConfigurationJiraConfiguration workLogFieldMappings(List workLogFieldMappings) {
  ...
  public DataSourceConfigurationJiraConfiguration inclusionPatterns(List inclusionPatterns) {
  ...
  public DataSourceConfigurationJiraConfiguration exclusionPatterns(List exclusionPatterns) {
  ...
  public DataSourceConfigurationJiraConfiguration vpcConfiguration(JiraConfigurationVpcConfiguration vpcConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    DataSourceConfigurationJiraConfiguration dataSourceConfigurationJiraConfiguration = (DataSourceConfigurationJiraConfiguration) o;
    return Objects.equals(this.jiraAccountUrl, dataSourceConfigurationJiraConfiguration.jiraAccountUrl) &&
        Objects.equals(this.secretArn, dataSourceConfigurationJiraConfiguration.secretArn) &&
        Objects.equals(this.useChangeLog, dataSourceConfigurationJiraConfiguration.useChangeLog) &&
        Objects.equals(this.project, dataSourceConfigurationJiraConfiguration.project) &&
        Objects.equals(this.issueType, dataSourceConfigurationJiraConfiguration.issueType) &&
        Objects.equals(this.status, dataSourceConfigurationJiraConfiguration.status) &&
        Objects.equals(this.issueSubEntityFilter, dataSourceConfigurationJiraConfiguration.issueSubEntityFilter) &&
        Objects.equals(this.attachmentFieldMappings, dataSourceConfigurationJiraConfiguration.attachmentFieldMappings) &&
        Objects.equals(this.commentFieldMappings, dataSourceConfigurationJiraConfiguration.commentFieldMappings) &&
        Objects.equals(this.issueFieldMappings, dataSourceConfigurationJiraConfiguration.issueFieldMappings) &&
        Objects.equals(this.projectFieldMappings, dataSourceConfigurationJiraConfiguration.projectFieldMappings) &&
        Objects.equals(this.workLogFieldMappings, dataSourceConfigurationJiraConfiguration.workLogFieldMappings) &&
        Objects.equals(this.inclusionPatterns, dataSourceConfigurationJiraConfiguration.inclusionPatterns) &&
        Objects.equals(this.exclusionPatterns, dataSourceConfigurationJiraConfiguration.exclusionPatterns) &&
        Objects.equals(this.vpcConfiguration, dataSourceConfigurationJiraConfiguration.vpcConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSourceConfigurationJiraConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataSourceConfigurationJiraConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataSourceConfigurationJiraConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataSourceConfigurationJiraConfiguration is not found in the empty JSON string", DataSourceConfigurationJiraConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataSourceConfigurationJiraConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataSourceConfigurationJiraConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataSourceConfigurationJiraConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataSourceConfigurationJiraConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataSourceConfigurationJiraConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataSourceConfigurationJiraConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataSourceConfigurationJiraConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<DataSourceConfigurationJiraConfiguration>() {
           @Override
           public void write(JsonWriter out, DataSourceConfigurationJiraConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataSourceConfigurationJiraConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataSourceConfigurationJiraConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataSourceConfigurationJiraConfiguration
   * @throws IOException if the JSON string is invalid with respect to DataSourceConfigurationJiraConfiguration
   */
  public static DataSourceConfigurationJiraConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataSourceConfigurationJiraConfiguration.class);
  }

  /**
   * Convert an instance of DataSourceConfigurationJiraConfiguration to an JSON string
   *
   * @return JSON string
   */
