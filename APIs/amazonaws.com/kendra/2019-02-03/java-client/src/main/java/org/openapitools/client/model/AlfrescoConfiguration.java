...
public class AlfrescoConfiguration {
  ...
  public AlfrescoConfiguration siteUrl(String siteUrl) {
  ...
  public AlfrescoConfiguration siteId(String siteId) {
    this.siteId = siteId;
    return this;
  }
  ...
  public AlfrescoConfiguration secretArn(String secretArn) {
  ...
  public AlfrescoConfiguration sslCertificateS3Path(AlfrescoConfigurationSslCertificateS3Path sslCertificateS3Path) {
  ...
  public AlfrescoConfiguration crawlSystemFolders(Boolean crawlSystemFolders) {
  ...
  public AlfrescoConfiguration crawlComments(Boolean crawlComments) {
  ...
  public AlfrescoConfiguration entityFilter(List entityFilter) {
  ...
  public AlfrescoConfiguration documentLibraryFieldMappings(List documentLibraryFieldMappings) {
  ...
  public AlfrescoConfiguration blogFieldMappings(List blogFieldMappings) {
  ...
  public AlfrescoConfiguration wikiFieldMappings(List wikiFieldMappings) {
  ...
  public AlfrescoConfiguration inclusionPatterns(List inclusionPatterns) {
  ...
  public AlfrescoConfiguration exclusionPatterns(List exclusionPatterns) {
  ...
  public AlfrescoConfiguration vpcConfiguration(AlfrescoConfigurationVpcConfiguration vpcConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    AlfrescoConfiguration alfrescoConfiguration = (AlfrescoConfiguration) o;
    return Objects.equals(this.siteUrl, alfrescoConfiguration.siteUrl) &&
        Objects.equals(this.siteId, alfrescoConfiguration.siteId) &&
        Objects.equals(this.secretArn, alfrescoConfiguration.secretArn) &&
        Objects.equals(this.sslCertificateS3Path, alfrescoConfiguration.sslCertificateS3Path) &&
        Objects.equals(this.crawlSystemFolders, alfrescoConfiguration.crawlSystemFolders) &&
        Objects.equals(this.crawlComments, alfrescoConfiguration.crawlComments) &&
        Objects.equals(this.entityFilter, alfrescoConfiguration.entityFilter) &&
        Objects.equals(this.documentLibraryFieldMappings, alfrescoConfiguration.documentLibraryFieldMappings) &&
        Objects.equals(this.blogFieldMappings, alfrescoConfiguration.blogFieldMappings) &&
        Objects.equals(this.wikiFieldMappings, alfrescoConfiguration.wikiFieldMappings) &&
        Objects.equals(this.inclusionPatterns, alfrescoConfiguration.inclusionPatterns) &&
        Objects.equals(this.exclusionPatterns, alfrescoConfiguration.exclusionPatterns) &&
        Objects.equals(this.vpcConfiguration, alfrescoConfiguration.vpcConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlfrescoConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlfrescoConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlfrescoConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlfrescoConfiguration is not found in the empty JSON string", AlfrescoConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlfrescoConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlfrescoConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AlfrescoConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlfrescoConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlfrescoConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlfrescoConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlfrescoConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<AlfrescoConfiguration>() {
           @Override
           public void write(JsonWriter out, AlfrescoConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlfrescoConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlfrescoConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlfrescoConfiguration
   * @throws IOException if the JSON string is invalid with respect to AlfrescoConfiguration
   */
  public static AlfrescoConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlfrescoConfiguration.class);
  }

  /**
   * Convert an instance of AlfrescoConfiguration to an JSON string
   *
   * @return JSON string
   */
