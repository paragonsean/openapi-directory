...
public class QueryRequestAttributeFilter {
  ...
  public QueryRequestAttributeFilter() {
  }

  public QueryRequestAttributeFilter andAllFilters(List andAllFilters) {
  ...
  public QueryRequestAttributeFilter orAllFilters(List orAllFilters) {
  ...
  public QueryRequestAttributeFilter notFilter(AttributeFilterNotFilter notFilter) {
  ...
  public QueryRequestAttributeFilter equalsTo(AttributeFilterEqualsTo equalsTo) {
  ...
  public QueryRequestAttributeFilter containsAll(AttributeFilterContainsAll containsAll) {
  ...
  public QueryRequestAttributeFilter containsAny(AttributeFilterContainsAny containsAny) {
  ...
  public QueryRequestAttributeFilter greaterThan(AttributeFilterGreaterThan greaterThan) {
  ...
  public QueryRequestAttributeFilter greaterThanOrEquals(AttributeFilterGreaterThanOrEquals greaterThanOrEquals) {
  ...
  public QueryRequestAttributeFilter lessThan(AttributeFilterLessThan lessThan) {
  ...
  public QueryRequestAttributeFilter lessThanOrEquals(AttributeFilterLessThanOrEquals lessThanOrEquals) {
  ...
  public boolean equals(Object o) {
    ...
    QueryRequestAttributeFilter queryRequestAttributeFilter = (QueryRequestAttributeFilter) o;
    return Objects.equals(this.andAllFilters, queryRequestAttributeFilter.andAllFilters) &&
        Objects.equals(this.orAllFilters, queryRequestAttributeFilter.orAllFilters) &&
        Objects.equals(this.notFilter, queryRequestAttributeFilter.notFilter) &&
        Objects.equals(this.equalsTo, queryRequestAttributeFilter.equalsTo) &&
        Objects.equals(this.containsAll, queryRequestAttributeFilter.containsAll) &&
        Objects.equals(this.containsAny, queryRequestAttributeFilter.containsAny) &&
        Objects.equals(this.greaterThan, queryRequestAttributeFilter.greaterThan) &&
        Objects.equals(this.greaterThanOrEquals, queryRequestAttributeFilter.greaterThanOrEquals) &&
        Objects.equals(this.lessThan, queryRequestAttributeFilter.lessThan) &&
        Objects.equals(this.lessThanOrEquals, queryRequestAttributeFilter.lessThanOrEquals);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueryRequestAttributeFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryRequestAttributeFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryRequestAttributeFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryRequestAttributeFilter is not found in the empty JSON string", QueryRequestAttributeFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueryRequestAttributeFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryRequestAttributeFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryRequestAttributeFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryRequestAttributeFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryRequestAttributeFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryRequestAttributeFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryRequestAttributeFilter>() {
           @Override
           public void write(JsonWriter out, QueryRequestAttributeFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueryRequestAttributeFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QueryRequestAttributeFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryRequestAttributeFilter
   * @throws IOException if the JSON string is invalid with respect to QueryRequestAttributeFilter
   */
  public static QueryRequestAttributeFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryRequestAttributeFilter.class);
  }

  /**
   * Convert an instance of QueryRequestAttributeFilter to an JSON string
   *
   * @return JSON string
   */
