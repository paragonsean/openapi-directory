...
public class ConfluenceSpaceConfiguration {
  ...
  public ConfluenceSpaceConfiguration crawlPersonalSpaces(Boolean crawlPersonalSpaces) {
  ...
  public ConfluenceSpaceConfiguration crawlArchivedSpaces(Boolean crawlArchivedSpaces) {
  ...
  public ConfluenceSpaceConfiguration includeSpaces(List includeSpaces) {
  ...
  public ConfluenceSpaceConfiguration excludeSpaces(List excludeSpaces) {
  ...
  public ConfluenceSpaceConfiguration spaceFieldMappings(List spaceFieldMappings) {
  ...
  public boolean equals(Object o) {
    ...
    ConfluenceSpaceConfiguration confluenceSpaceConfiguration = (ConfluenceSpaceConfiguration) o;
    return Objects.equals(this.crawlPersonalSpaces, confluenceSpaceConfiguration.crawlPersonalSpaces) &&
        Objects.equals(this.crawlArchivedSpaces, confluenceSpaceConfiguration.crawlArchivedSpaces) &&
        Objects.equals(this.includeSpaces, confluenceSpaceConfiguration.includeSpaces) &&
        Objects.equals(this.excludeSpaces, confluenceSpaceConfiguration.excludeSpaces) &&
        Objects.equals(this.spaceFieldMappings, confluenceSpaceConfiguration.spaceFieldMappings);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfluenceSpaceConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfluenceSpaceConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfluenceSpaceConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfluenceSpaceConfiguration is not found in the empty JSON string", ConfluenceSpaceConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfluenceSpaceConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfluenceSpaceConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfluenceSpaceConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfluenceSpaceConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfluenceSpaceConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfluenceSpaceConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfluenceSpaceConfiguration>() {
           @Override
           public void write(JsonWriter out, ConfluenceSpaceConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfluenceSpaceConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfluenceSpaceConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfluenceSpaceConfiguration
   * @throws IOException if the JSON string is invalid with respect to ConfluenceSpaceConfiguration
   */
  public static ConfluenceSpaceConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfluenceSpaceConfiguration.class);
  }

  /**
   * Convert an instance of ConfluenceSpaceConfiguration to an JSON string
   *
   * @return JSON string
   */
