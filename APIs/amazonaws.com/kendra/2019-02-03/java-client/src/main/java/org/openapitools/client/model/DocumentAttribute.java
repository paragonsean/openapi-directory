...
public class DocumentAttribute {
  ...
  public DocumentAttribute value(DocumentAttributeValue value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, documentAttribute.key) &&
        Objects.equals(this.value, documentAttribute.value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentAttribute is not found in the empty JSON string", DocumentAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (String requiredField : DocumentAttribute.openapiRequiredFields) {
