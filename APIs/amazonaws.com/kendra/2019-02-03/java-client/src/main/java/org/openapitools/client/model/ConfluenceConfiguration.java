...
public class ConfluenceConfiguration {
  ...
  public ConfluenceConfiguration serverUrl(String serverUrl) {
  ...
  public ConfluenceConfiguration secretArn(String secretArn) {
  ...
  public ConfluenceConfiguration version(ConfluenceVersion version) {
  ...
  public ConfluenceConfiguration spaceConfiguration(ConfluenceConfigurationSpaceConfiguration spaceConfiguration) {
  ...
  public ConfluenceConfiguration pageConfiguration(ConfluenceConfigurationPageConfiguration pageConfiguration) {
  ...
  public ConfluenceConfiguration blogConfiguration(ConfluenceConfigurationBlogConfiguration blogConfiguration) {
  ...
  public ConfluenceConfiguration attachmentConfiguration(ConfluenceConfigurationAttachmentConfiguration attachmentConfiguration) {
  ...
  public ConfluenceConfiguration vpcConfiguration(ConfluenceConfigurationVpcConfiguration vpcConfiguration) {
  ...
  public ConfluenceConfiguration inclusionPatterns(List inclusionPatterns) {
  ...
  public ConfluenceConfiguration exclusionPatterns(List exclusionPatterns) {
  ...
  public ConfluenceConfiguration proxyConfiguration(ConfluenceConfigurationProxyConfiguration proxyConfiguration) {
  ...
  public ConfluenceConfiguration authenticationType(ConfluenceAuthenticationType authenticationType) {
  ...
  public boolean equals(Object o) {
    ...
    ConfluenceConfiguration confluenceConfiguration = (ConfluenceConfiguration) o;
    return Objects.equals(this.serverUrl, confluenceConfiguration.serverUrl) &&
        Objects.equals(this.secretArn, confluenceConfiguration.secretArn) &&
        Objects.equals(this.version, confluenceConfiguration.version) &&
        Objects.equals(this.spaceConfiguration, confluenceConfiguration.spaceConfiguration) &&
        Objects.equals(this.pageConfiguration, confluenceConfiguration.pageConfiguration) &&
        Objects.equals(this.blogConfiguration, confluenceConfiguration.blogConfiguration) &&
        Objects.equals(this.attachmentConfiguration, confluenceConfiguration.attachmentConfiguration) &&
        Objects.equals(this.vpcConfiguration, confluenceConfiguration.vpcConfiguration) &&
        Objects.equals(this.inclusionPatterns, confluenceConfiguration.inclusionPatterns) &&
        Objects.equals(this.exclusionPatterns, confluenceConfiguration.exclusionPatterns) &&
        Objects.equals(this.proxyConfiguration, confluenceConfiguration.proxyConfiguration) &&
        Objects.equals(this.authenticationType, confluenceConfiguration.authenticationType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfluenceConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfluenceConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfluenceConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfluenceConfiguration is not found in the empty JSON string", ConfluenceConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfluenceConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfluenceConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfluenceConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfluenceConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfluenceConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfluenceConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfluenceConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfluenceConfiguration>() {
           @Override
           public void write(JsonWriter out, ConfluenceConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfluenceConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfluenceConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfluenceConfiguration
   * @throws IOException if the JSON string is invalid with respect to ConfluenceConfiguration
   */
  public static ConfluenceConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfluenceConfiguration.class);
  }

  /**
   * Convert an instance of ConfluenceConfiguration to an JSON string
   *
   * @return JSON string
   */
