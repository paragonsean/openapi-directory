...
public class GitHubConfiguration {
  ...
  public GitHubConfiguration saaSConfiguration(GitHubConfigurationSaaSConfiguration saaSConfiguration) {
  ...
  public GitHubConfiguration onPremiseConfiguration(GitHubConfigurationOnPremiseConfiguration onPremiseConfiguration) {
  ...
  public GitHubConfiguration type(Type type) {
    this.type = type;
    return this;
  }
  ...
  public GitHubConfiguration secretArn(String secretArn) {
  ...
  public GitHubConfiguration useChangeLog(Boolean useChangeLog) {
  ...
  public GitHubConfiguration gitHubDocumentCrawlProperties(GitHubConfigurationGitHubDocumentCrawlProperties gitHubDocumentCrawlProperties) {
  ...
  public GitHubConfiguration repositoryFilter(List repositoryFilter) {
  ...
  public GitHubConfiguration inclusionFolderNamePatterns(List inclusionFolderNamePatterns) {
  ...
  public GitHubConfiguration inclusionFileTypePatterns(List inclusionFileTypePatterns) {
  ...
  public GitHubConfiguration inclusionFileNamePatterns(List inclusionFileNamePatterns) {
  ...
  public GitHubConfiguration exclusionFolderNamePatterns(List exclusionFolderNamePatterns) {
  ...
  public GitHubConfiguration exclusionFileTypePatterns(List exclusionFileTypePatterns) {
  ...
  public GitHubConfiguration exclusionFileNamePatterns(List exclusionFileNamePatterns) {
  ...
  public GitHubConfiguration vpcConfiguration(GitHubConfigurationVpcConfiguration vpcConfiguration) {
  ...
  public GitHubConfiguration gitHubRepositoryConfigurationFieldMappings(List gitHubRepositoryConfigurationFieldMappings) {
  ...
  public GitHubConfiguration gitHubCommitConfigurationFieldMappings(List gitHubCommitConfigurationFieldMappings) {
  ...
  public GitHubConfiguration gitHubIssueDocumentConfigurationFieldMappings(List gitHubIssueDocumentConfigurationFieldMappings) {
  ...
  public GitHubConfiguration gitHubIssueCommentConfigurationFieldMappings(List gitHubIssueCommentConfigurationFieldMappings) {
  ...
  public GitHubConfiguration gitHubIssueAttachmentConfigurationFieldMappings(List gitHubIssueAttachmentConfigurationFieldMappings) {
  ...
  public GitHubConfiguration gitHubPullRequestCommentConfigurationFieldMappings(List gitHubPullRequestCommentConfigurationFieldMappings) {
  ...
  public GitHubConfiguration gitHubPullRequestDocumentConfigurationFieldMappings(List gitHubPullRequestDocumentConfigurationFieldMappings) {
  ...
  public GitHubConfiguration gitHubPullRequestDocumentAttachmentConfigurationFieldMappings(List gitHubPullRequestDocumentAttachmentConfigurationFieldMappings) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.saaSConfiguration, gitHubConfiguration.saaSConfiguration) &&
        Objects.equals(this.onPremiseConfiguration, gitHubConfiguration.onPremiseConfiguration) &&
        Objects.equals(this.type, gitHubConfiguration.type) &&
        Objects.equals(this.secretArn, gitHubConfiguration.secretArn) &&
        Objects.equals(this.useChangeLog, gitHubConfiguration.useChangeLog) &&
        Objects.equals(this.gitHubDocumentCrawlProperties, gitHubConfiguration.gitHubDocumentCrawlProperties) &&
        Objects.equals(this.repositoryFilter, gitHubConfiguration.repositoryFilter) &&
        Objects.equals(this.inclusionFolderNamePatterns, gitHubConfiguration.inclusionFolderNamePatterns) &&
        Objects.equals(this.inclusionFileTypePatterns, gitHubConfiguration.inclusionFileTypePatterns) &&
        Objects.equals(this.inclusionFileNamePatterns, gitHubConfiguration.inclusionFileNamePatterns) &&
        Objects.equals(this.exclusionFolderNamePatterns, gitHubConfiguration.exclusionFolderNamePatterns) &&
        Objects.equals(this.exclusionFileTypePatterns, gitHubConfiguration.exclusionFileTypePatterns) &&
        Objects.equals(this.exclusionFileNamePatterns, gitHubConfiguration.exclusionFileNamePatterns) &&
        Objects.equals(this.vpcConfiguration, gitHubConfiguration.vpcConfiguration) &&
        Objects.equals(this.gitHubRepositoryConfigurationFieldMappings, gitHubConfiguration.gitHubRepositoryConfigurationFieldMappings) &&
        Objects.equals(this.gitHubCommitConfigurationFieldMappings, gitHubConfiguration.gitHubCommitConfigurationFieldMappings) &&
        Objects.equals(this.gitHubIssueDocumentConfigurationFieldMappings, gitHubConfiguration.gitHubIssueDocumentConfigurationFieldMappings) &&
        Objects.equals(this.gitHubIssueCommentConfigurationFieldMappings, gitHubConfiguration.gitHubIssueCommentConfigurationFieldMappings) &&
        Objects.equals(this.gitHubIssueAttachmentConfigurationFieldMappings, gitHubConfiguration.gitHubIssueAttachmentConfigurationFieldMappings) &&
        Objects.equals(this.gitHubPullRequestCommentConfigurationFieldMappings, gitHubConfiguration.gitHubPullRequestCommentConfigurationFieldMappings) &&
        Objects.equals(this.gitHubPullRequestDocumentConfigurationFieldMappings, gitHubConfiguration.gitHubPullRequestDocumentConfigurationFieldMappings) &&
        Objects.equals(this.gitHubPullRequestDocumentAttachmentConfigurationFieldMappings, gitHubConfiguration.gitHubPullRequestDocumentAttachmentConfigurationFieldMappings);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GitHubConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GitHubConfiguration is not found in the empty JSON string", GitHubConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GitHubConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GitHubConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GitHubConfiguration>() {
           @Override
           public void write(JsonWriter out, GitHubConfiguration value) throws IOException {
