...
public class TemplateConfiguration {
  ...
  public TemplateConfiguration template(Object template) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.template, templateConfiguration.template);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
