...
public class DataSourceConfigurationQuipConfiguration {
  ...
  public DataSourceConfigurationQuipConfiguration() {
  }

  public DataSourceConfigurationQuipConfiguration domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DataSourceConfigurationQuipConfiguration secretArn(String secretArn) {
  ...
  public DataSourceConfigurationQuipConfiguration crawlFileComments(Boolean crawlFileComments) {
  ...
  public DataSourceConfigurationQuipConfiguration crawlChatRooms(Boolean crawlChatRooms) {
  ...
  public DataSourceConfigurationQuipConfiguration crawlAttachments(Boolean crawlAttachments) {
  ...
  public DataSourceConfigurationQuipConfiguration folderIds(List folderIds) {
  ...
  public DataSourceConfigurationQuipConfiguration threadFieldMappings(List threadFieldMappings) {
  ...
  public DataSourceConfigurationQuipConfiguration messageFieldMappings(List messageFieldMappings) {
  ...
  public DataSourceConfigurationQuipConfiguration attachmentFieldMappings(List attachmentFieldMappings) {
  ...
  public DataSourceConfigurationQuipConfiguration inclusionPatterns(List inclusionPatterns) {
  ...
  public DataSourceConfigurationQuipConfiguration exclusionPatterns(List exclusionPatterns) {
  ...
  public DataSourceConfigurationQuipConfiguration vpcConfiguration(QuipConfigurationVpcConfiguration vpcConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    DataSourceConfigurationQuipConfiguration dataSourceConfigurationQuipConfiguration = (DataSourceConfigurationQuipConfiguration) o;
    return Objects.equals(this.domain, dataSourceConfigurationQuipConfiguration.domain) &&
        Objects.equals(this.secretArn, dataSourceConfigurationQuipConfiguration.secretArn) &&
        Objects.equals(this.crawlFileComments, dataSourceConfigurationQuipConfiguration.crawlFileComments) &&
        Objects.equals(this.crawlChatRooms, dataSourceConfigurationQuipConfiguration.crawlChatRooms) &&
        Objects.equals(this.crawlAttachments, dataSourceConfigurationQuipConfiguration.crawlAttachments) &&
        Objects.equals(this.folderIds, dataSourceConfigurationQuipConfiguration.folderIds) &&
        Objects.equals(this.threadFieldMappings, dataSourceConfigurationQuipConfiguration.threadFieldMappings) &&
        Objects.equals(this.messageFieldMappings, dataSourceConfigurationQuipConfiguration.messageFieldMappings) &&
        Objects.equals(this.attachmentFieldMappings, dataSourceConfigurationQuipConfiguration.attachmentFieldMappings) &&
        Objects.equals(this.inclusionPatterns, dataSourceConfigurationQuipConfiguration.inclusionPatterns) &&
        Objects.equals(this.exclusionPatterns, dataSourceConfigurationQuipConfiguration.exclusionPatterns) &&
        Objects.equals(this.vpcConfiguration, dataSourceConfigurationQuipConfiguration.vpcConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSourceConfigurationQuipConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataSourceConfigurationQuipConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataSourceConfigurationQuipConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataSourceConfigurationQuipConfiguration is not found in the empty JSON string", DataSourceConfigurationQuipConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataSourceConfigurationQuipConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataSourceConfigurationQuipConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataSourceConfigurationQuipConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataSourceConfigurationQuipConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataSourceConfigurationQuipConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataSourceConfigurationQuipConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataSourceConfigurationQuipConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<DataSourceConfigurationQuipConfiguration>() {
           @Override
           public void write(JsonWriter out, DataSourceConfigurationQuipConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataSourceConfigurationQuipConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataSourceConfigurationQuipConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataSourceConfigurationQuipConfiguration
   * @throws IOException if the JSON string is invalid with respect to DataSourceConfigurationQuipConfiguration
   */
  public static DataSourceConfigurationQuipConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataSourceConfigurationQuipConfiguration.class);
  }

  /**
   * Convert an instance of DataSourceConfigurationQuipConfiguration to an JSON string
   *
   * @return JSON string
   */
