...
public class AttributeSuggestionsGetConfigAttributeFilter {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter() {
  }

  public AttributeSuggestionsGetConfigAttributeFilter andAllFilters(List andAllFilters) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter orAllFilters(List orAllFilters) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter notFilter(AttributeFilterNotFilter notFilter) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter equalsTo(AttributeFilterEqualsTo equalsTo) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter containsAll(AttributeFilterContainsAll containsAll) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter containsAny(AttributeFilterContainsAny containsAny) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter greaterThan(AttributeFilterGreaterThan greaterThan) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter greaterThanOrEquals(AttributeFilterGreaterThanOrEquals greaterThanOrEquals) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter lessThan(AttributeFilterLessThan lessThan) {
  ...
  public AttributeSuggestionsGetConfigAttributeFilter lessThanOrEquals(AttributeFilterLessThanOrEquals lessThanOrEquals) {
  ...
  public boolean equals(Object o) {
    ...
    AttributeSuggestionsGetConfigAttributeFilter attributeSuggestionsGetConfigAttributeFilter = (AttributeSuggestionsGetConfigAttributeFilter) o;
    return Objects.equals(this.andAllFilters, attributeSuggestionsGetConfigAttributeFilter.andAllFilters) &&
        Objects.equals(this.orAllFilters, attributeSuggestionsGetConfigAttributeFilter.orAllFilters) &&
        Objects.equals(this.notFilter, attributeSuggestionsGetConfigAttributeFilter.notFilter) &&
        Objects.equals(this.equalsTo, attributeSuggestionsGetConfigAttributeFilter.equalsTo) &&
        Objects.equals(this.containsAll, attributeSuggestionsGetConfigAttributeFilter.containsAll) &&
        Objects.equals(this.containsAny, attributeSuggestionsGetConfigAttributeFilter.containsAny) &&
        Objects.equals(this.greaterThan, attributeSuggestionsGetConfigAttributeFilter.greaterThan) &&
        Objects.equals(this.greaterThanOrEquals, attributeSuggestionsGetConfigAttributeFilter.greaterThanOrEquals) &&
        Objects.equals(this.lessThan, attributeSuggestionsGetConfigAttributeFilter.lessThan) &&
        Objects.equals(this.lessThanOrEquals, attributeSuggestionsGetConfigAttributeFilter.lessThanOrEquals);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributeSuggestionsGetConfigAttributeFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttributeSuggestionsGetConfigAttributeFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttributeSuggestionsGetConfigAttributeFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributeSuggestionsGetConfigAttributeFilter is not found in the empty JSON string", AttributeSuggestionsGetConfigAttributeFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttributeSuggestionsGetConfigAttributeFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributeSuggestionsGetConfigAttributeFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributeSuggestionsGetConfigAttributeFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributeSuggestionsGetConfigAttributeFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributeSuggestionsGetConfigAttributeFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributeSuggestionsGetConfigAttributeFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributeSuggestionsGetConfigAttributeFilter>() {
           @Override
           public void write(JsonWriter out, AttributeSuggestionsGetConfigAttributeFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttributeSuggestionsGetConfigAttributeFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttributeSuggestionsGetConfigAttributeFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttributeSuggestionsGetConfigAttributeFilter
   * @throws IOException if the JSON string is invalid with respect to AttributeSuggestionsGetConfigAttributeFilter
   */
  public static AttributeSuggestionsGetConfigAttributeFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributeSuggestionsGetConfigAttributeFilter.class);
  }

  /**
   * Convert an instance of AttributeSuggestionsGetConfigAttributeFilter to an JSON string
   *
   * @return JSON string
   */
