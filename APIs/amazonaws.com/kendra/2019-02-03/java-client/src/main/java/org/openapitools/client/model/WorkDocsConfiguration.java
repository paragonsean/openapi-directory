...
public class WorkDocsConfiguration {
  ...
  public WorkDocsConfiguration() {
  }

  public WorkDocsConfiguration organizationId(String organizationId) {
  ...
  public WorkDocsConfiguration crawlComments(Boolean crawlComments) {
  ...
  public WorkDocsConfiguration useChangeLog(Boolean useChangeLog) {
  ...
  public WorkDocsConfiguration inclusionPatterns(List inclusionPatterns) {
  ...
  public WorkDocsConfiguration exclusionPatterns(List exclusionPatterns) {
  ...
  public WorkDocsConfiguration fieldMappings(List fieldMappings) {
  ...
  public boolean equals(Object o) {
    ...
    WorkDocsConfiguration workDocsConfiguration = (WorkDocsConfiguration) o;
    return Objects.equals(this.organizationId, workDocsConfiguration.organizationId) &&
        Objects.equals(this.crawlComments, workDocsConfiguration.crawlComments) &&
        Objects.equals(this.useChangeLog, workDocsConfiguration.useChangeLog) &&
        Objects.equals(this.inclusionPatterns, workDocsConfiguration.inclusionPatterns) &&
        Objects.equals(this.exclusionPatterns, workDocsConfiguration.exclusionPatterns) &&
        Objects.equals(this.fieldMappings, workDocsConfiguration.fieldMappings);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkDocsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkDocsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkDocsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkDocsConfiguration is not found in the empty JSON string", WorkDocsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkDocsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkDocsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkDocsConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkDocsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkDocsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkDocsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkDocsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkDocsConfiguration>() {
           @Override
           public void write(JsonWriter out, WorkDocsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkDocsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WorkDocsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkDocsConfiguration
   * @throws IOException if the JSON string is invalid with respect to WorkDocsConfiguration
   */
  public static WorkDocsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkDocsConfiguration.class);
  }

  /**
   * Convert an instance of WorkDocsConfiguration to an JSON string
   *
   * @return JSON string
   */
