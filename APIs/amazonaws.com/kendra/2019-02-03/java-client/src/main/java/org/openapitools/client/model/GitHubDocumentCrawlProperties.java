...
public class GitHubDocumentCrawlProperties {
  ...
  public GitHubDocumentCrawlProperties crawlRepositoryDocuments(Boolean crawlRepositoryDocuments) {
  ...
  public GitHubDocumentCrawlProperties crawlIssue(Boolean crawlIssue) {
  ...
  public GitHubDocumentCrawlProperties crawlIssueComment(Boolean crawlIssueComment) {
  ...
  public GitHubDocumentCrawlProperties crawlIssueCommentAttachment(Boolean crawlIssueCommentAttachment) {
  ...
  public GitHubDocumentCrawlProperties crawlPullRequest(Boolean crawlPullRequest) {
  ...
  public GitHubDocumentCrawlProperties crawlPullRequestComment(Boolean crawlPullRequestComment) {
  ...
  public GitHubDocumentCrawlProperties crawlPullRequestCommentAttachment(Boolean crawlPullRequestCommentAttachment) {
  ...
  public boolean equals(Object o) {
    ...
    GitHubDocumentCrawlProperties gitHubDocumentCrawlProperties = (GitHubDocumentCrawlProperties) o;
    return Objects.equals(this.crawlRepositoryDocuments, gitHubDocumentCrawlProperties.crawlRepositoryDocuments) &&
        Objects.equals(this.crawlIssue, gitHubDocumentCrawlProperties.crawlIssue) &&
        Objects.equals(this.crawlIssueComment, gitHubDocumentCrawlProperties.crawlIssueComment) &&
        Objects.equals(this.crawlIssueCommentAttachment, gitHubDocumentCrawlProperties.crawlIssueCommentAttachment) &&
        Objects.equals(this.crawlPullRequest, gitHubDocumentCrawlProperties.crawlPullRequest) &&
        Objects.equals(this.crawlPullRequestComment, gitHubDocumentCrawlProperties.crawlPullRequestComment) &&
        Objects.equals(this.crawlPullRequestCommentAttachment, gitHubDocumentCrawlProperties.crawlPullRequestCommentAttachment);
  }
  ...
  public String toString() {
    ...
    sb.append("class GitHubDocumentCrawlProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GitHubDocumentCrawlProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GitHubDocumentCrawlProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GitHubDocumentCrawlProperties is not found in the empty JSON string", GitHubDocumentCrawlProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GitHubDocumentCrawlProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GitHubDocumentCrawlProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GitHubDocumentCrawlProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GitHubDocumentCrawlProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GitHubDocumentCrawlProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GitHubDocumentCrawlProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<GitHubDocumentCrawlProperties>() {
           @Override
           public void write(JsonWriter out, GitHubDocumentCrawlProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GitHubDocumentCrawlProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GitHubDocumentCrawlProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GitHubDocumentCrawlProperties
   * @throws IOException if the JSON string is invalid with respect to GitHubDocumentCrawlProperties
   */
  public static GitHubDocumentCrawlProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GitHubDocumentCrawlProperties.class);
  }

  /**
   * Convert an instance of GitHubDocumentCrawlProperties to an JSON string
   *
   * @return JSON string
   */
