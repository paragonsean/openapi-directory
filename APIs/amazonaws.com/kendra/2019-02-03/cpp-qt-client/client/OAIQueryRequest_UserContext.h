...
/*
 * OAIQueryRequest_UserContext.h
 *
 * 
 */

#ifndef OAIQueryRequest_UserContext_H
#define OAIQueryRequest_UserContext_H
...
class OAIQueryRequest_UserContext : public OAIObject {
public:
    OAIQueryRequest_UserContext();
    OAIQueryRequest_UserContext(QString json);
    ~OAIQueryRequest_UserContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryRequest_UserContext)

#endif // OAIQueryRequest_UserContext_H
