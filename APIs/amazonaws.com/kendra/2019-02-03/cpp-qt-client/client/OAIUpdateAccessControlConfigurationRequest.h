...
/*
 * OAIUpdateAccessControlConfigurationRequest.h
 *
 * 
 */

#ifndef OAIUpdateAccessControlConfigurationRequest_H
#define OAIUpdateAccessControlConfigurationRequest_H
...
class OAIUpdateAccessControlConfigurationRequest : public OAIObject {
public:
    OAIUpdateAccessControlConfigurationRequest();
    OAIUpdateAccessControlConfigurationRequest(QString json);
    ~OAIUpdateAccessControlConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccessControlConfigurationRequest)

#endif // OAIUpdateAccessControlConfigurationRequest_H
