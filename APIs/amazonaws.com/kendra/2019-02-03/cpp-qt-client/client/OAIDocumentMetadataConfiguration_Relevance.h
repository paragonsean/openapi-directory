...
/*
 * OAIDocumentMetadataConfiguration_Relevance.h
 *
 * 
 */

#ifndef OAIDocumentMetadataConfiguration_Relevance_H
#define OAIDocumentMetadataConfiguration_Relevance_H
...
class OAIDocumentMetadataConfiguration_Relevance : public OAIObject {
public:
    OAIDocumentMetadataConfiguration_Relevance();
    OAIDocumentMetadataConfiguration_Relevance(QString json);
    ~OAIDocumentMetadataConfiguration_Relevance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentMetadataConfiguration_Relevance)

#endif // OAIDocumentMetadataConfiguration_Relevance_H
