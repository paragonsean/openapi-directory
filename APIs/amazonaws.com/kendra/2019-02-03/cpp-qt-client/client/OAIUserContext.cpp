...
QString OAIUserContext::getToken() const {
    return m_token;
}
void OAIUserContext::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIUserContext::is_token_Set() const{
    return m_token_isSet;
}

bool OAIUserContext::is_token_Valid() const{
    return m_token_isValid;
}

QString OAIUserContext::getUserId() const {
    return m_user_id;
}
void OAIUserContext::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIUserContext::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIUserContext::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QList OAIUserContext::getGroups() const {
    return m_groups;
}
void OAIUserContext::setGroups(const QList &groups) {
    m_groups = groups;
    m_groups_isSet = true;
}

bool OAIUserContext::is_groups_Set() const{
    return m_groups_isSet;
}

bool OAIUserContext::is_groups_Valid() const{
    return m_groups_isValid;
}

QList OAIUserContext::getDataSourceGroups() const {
    return m_data_source_groups;
}
void OAIUserContext::setDataSourceGroups(const QList &data_source_groups) {
    m_data_source_groups = data_source_groups;
    m_data_source_groups_isSet = true;
}

bool OAIUserContext::is_data_source_groups_Set() const{
    return m_data_source_groups_isSet;
}

bool OAIUserContext::is_data_source_groups_Valid() const{
