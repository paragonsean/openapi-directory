...
#ifndef OAIFeaturedResultsSet_H
#define OAIFeaturedResultsSet_H
...
class OAIFeaturedResultsSet : public OAIObject {
public:
    OAIFeaturedResultsSet();
    OAIFeaturedResultsSet(QString json);
    ~OAIFeaturedResultsSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeaturedResultsSet)

#endif // OAIFeaturedResultsSet_H
