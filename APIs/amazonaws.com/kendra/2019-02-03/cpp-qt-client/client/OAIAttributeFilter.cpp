...
QList OAIAttributeFilter::getAndAllFilters() const {
    return m_and_all_filters;
}
void OAIAttributeFilter::setAndAllFilters(const QList &and_all_filters) {
    m_and_all_filters = and_all_filters;
    m_and_all_filters_isSet = true;
}

bool OAIAttributeFilter::is_and_all_filters_Set() const{
    return m_and_all_filters_isSet;
}

bool OAIAttributeFilter::is_and_all_filters_Valid() const{
    return m_and_all_filters_isValid;
}

QList OAIAttributeFilter::getOrAllFilters() const {
    return m_or_all_filters;
}
void OAIAttributeFilter::setOrAllFilters(const QList &or_all_filters) {
    m_or_all_filters = or_all_filters;
    m_or_all_filters_isSet = true;
}

bool OAIAttributeFilter::is_or_all_filters_Set() const{
    return m_or_all_filters_isSet;
}

bool OAIAttributeFilter::is_or_all_filters_Valid() const{
    return m_or_all_filters_isValid;
}

OAIAttributeFilter_NotFilter OAIAttributeFilter::getNotFilter() const {
    return m_not_filter;
}
void OAIAttributeFilter::setNotFilter(const OAIAttributeFilter_NotFilter &not_filter) {
    m_not_filter = not_filter;
    m_not_filter_isSet = true;
}

bool OAIAttributeFilter::is_not_filter_Set() const{
    return m_not_filter_isSet;
}

bool OAIAttributeFilter::is_not_filter_Valid() const{
    return m_not_filter_isValid;
}

OAIAttributeFilter_EqualsTo OAIAttributeFilter::getEqualsTo() const {
    return m_equals_to;
}
void OAIAttributeFilter::setEqualsTo(const OAIAttributeFilter_EqualsTo &equals_to) {
    m_equals_to = equals_to;
    m_equals_to_isSet = true;
}

bool OAIAttributeFilter::is_equals_to_Set() const{
    return m_equals_to_isSet;
}

bool OAIAttributeFilter::is_equals_to_Valid() const{
    return m_equals_to_isValid;
}

OAIAttributeFilter_ContainsAll OAIAttributeFilter::getContainsAll() const {
    return m_contains_all;
}
void OAIAttributeFilter::setContainsAll(const OAIAttributeFilter_ContainsAll &contains_all) {
    m_contains_all = contains_all;
    m_contains_all_isSet = true;
}

bool OAIAttributeFilter::is_contains_all_Set() const{
    return m_contains_all_isSet;
}

bool OAIAttributeFilter::is_contains_all_Valid() const{
    return m_contains_all_isValid;
}

OAIAttributeFilter_ContainsAny OAIAttributeFilter::getContainsAny() const {
    return m_contains_any;
}
void OAIAttributeFilter::setContainsAny(const OAIAttributeFilter_ContainsAny &contains_any) {
    m_contains_any = contains_any;
    m_contains_any_isSet = true;
}

bool OAIAttributeFilter::is_contains_any_Set() const{
    return m_contains_any_isSet;
}

bool OAIAttributeFilter::is_contains_any_Valid() const{
    return m_contains_any_isValid;
}

OAIAttributeFilter_GreaterThan OAIAttributeFilter::getGreaterThan() const {
    return m_greater_than;
}
void OAIAttributeFilter::setGreaterThan(const OAIAttributeFilter_GreaterThan &greater_than) {
    m_greater_than = greater_than;
    m_greater_than_isSet = true;
}

bool OAIAttributeFilter::is_greater_than_Set() const{
    return m_greater_than_isSet;
}

bool OAIAttributeFilter::is_greater_than_Valid() const{
    return m_greater_than_isValid;
}

OAIAttributeFilter_GreaterThanOrEquals OAIAttributeFilter::getGreaterThanOrEquals() const {
    return m_greater_than_or_equals;
}
void OAIAttributeFilter::setGreaterThanOrEquals(const OAIAttributeFilter_GreaterThanOrEquals &greater_than_or_equals) {
    m_greater_than_or_equals = greater_than_or_equals;
    m_greater_than_or_equals_isSet = true;
}

bool OAIAttributeFilter::is_greater_than_or_equals_Set() const{
    return m_greater_than_or_equals_isSet;
}

bool OAIAttributeFilter::is_greater_than_or_equals_Valid() const{
    return m_greater_than_or_equals_isValid;
}

OAIAttributeFilter_LessThan OAIAttributeFilter::getLessThan() const {
    return m_less_than;
}
void OAIAttributeFilter::setLessThan(const OAIAttributeFilter_LessThan &less_than) {
    m_less_than = less_than;
    m_less_than_isSet = true;
}

bool OAIAttributeFilter::is_less_than_Set() const{
    return m_less_than_isSet;
}

bool OAIAttributeFilter::is_less_than_Valid() const{
    return m_less_than_isValid;
}

OAIAttributeFilter_LessThanOrEquals OAIAttributeFilter::getLessThanOrEquals() const {
    return m_less_than_or_equals;
}
void OAIAttributeFilter::setLessThanOrEquals(const OAIAttributeFilter_LessThanOrEquals &less_than_or_equals) {
    m_less_than_or_equals = less_than_or_equals;
    m_less_than_or_equals_isSet = true;
}

bool OAIAttributeFilter::is_less_than_or_equals_Set() const{
    return m_less_than_or_equals_isSet;
}

bool OAIAttributeFilter::is_less_than_or_equals_Valid() const{
