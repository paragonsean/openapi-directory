...
/*
 * OAIDataSourceConfiguration_S3Configuration.h
 *
 * 
 */

#ifndef OAIDataSourceConfiguration_S3Configuration_H
#define OAIDataSourceConfiguration_S3Configuration_H
...
class OAIDataSourceConfiguration_S3Configuration : public OAIObject {
public:
    OAIDataSourceConfiguration_S3Configuration();
    OAIDataSourceConfiguration_S3Configuration(QString json);
    ~OAIDataSourceConfiguration_S3Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceConfiguration_S3Configuration)

#endif // OAIDataSourceConfiguration_S3Configuration_H
