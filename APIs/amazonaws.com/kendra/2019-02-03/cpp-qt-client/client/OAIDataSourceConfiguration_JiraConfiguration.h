...
/*
 * OAIDataSourceConfiguration_JiraConfiguration.h
 *
 * 
 */

#ifndef OAIDataSourceConfiguration_JiraConfiguration_H
#define OAIDataSourceConfiguration_JiraConfiguration_H
...
class OAIDataSourceConfiguration_JiraConfiguration : public OAIObject {
public:
    OAIDataSourceConfiguration_JiraConfiguration();
    OAIDataSourceConfiguration_JiraConfiguration(QString json);
    ~OAIDataSourceConfiguration_JiraConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceConfiguration_JiraConfiguration)

#endif // OAIDataSourceConfiguration_JiraConfiguration_H
