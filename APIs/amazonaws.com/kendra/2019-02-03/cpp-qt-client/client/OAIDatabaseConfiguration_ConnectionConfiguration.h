...
/*
 * OAIDatabaseConfiguration_ConnectionConfiguration.h
 *
 * 
 */

#ifndef OAIDatabaseConfiguration_ConnectionConfiguration_H
#define OAIDatabaseConfiguration_ConnectionConfiguration_H
...
class OAIDatabaseConfiguration_ConnectionConfiguration : public OAIObject {
public:
    OAIDatabaseConfiguration_ConnectionConfiguration();
    OAIDatabaseConfiguration_ConnectionConfiguration(QString json);
    ~OAIDatabaseConfiguration_ConnectionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseConfiguration_ConnectionConfiguration)

#endif // OAIDatabaseConfiguration_ConnectionConfiguration_H
