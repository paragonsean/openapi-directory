...
/*
 * OAIAttributeFilter_NotFilter.h
 *
 * 
 */

#ifndef OAIAttributeFilter_NotFilter_H
#define OAIAttributeFilter_NotFilter_H
...
class OAIAttributeFilter_NotFilter : public OAIObject {
public:
    OAIAttributeFilter_NotFilter();
    OAIAttributeFilter_NotFilter(QString json);
    ~OAIAttributeFilter_NotFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeFilter_NotFilter)

#endif // OAIAttributeFilter_NotFilter_H
