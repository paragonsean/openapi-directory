...
/*
 * OAIDataSourceConfiguration_SlackConfiguration.h
 *
 * 
 */

#ifndef OAIDataSourceConfiguration_SlackConfiguration_H
#define OAIDataSourceConfiguration_SlackConfiguration_H
...
class OAIDataSourceConfiguration_SlackConfiguration : public OAIObject {
public:
    OAIDataSourceConfiguration_SlackConfiguration();
    OAIDataSourceConfiguration_SlackConfiguration(QString json);
    ~OAIDataSourceConfiguration_SlackConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceConfiguration_SlackConfiguration)

#endif // OAIDataSourceConfiguration_SlackConfiguration_H
