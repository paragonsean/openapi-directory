...
#ifndef OAIRelevance_H
#define OAIRelevance_H
...
class OAIRelevance : public OAIObject {
public:
    OAIRelevance();
    OAIRelevance(QString json);
    ~OAIRelevance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelevance)

#endif // OAIRelevance_H
