...
/*
 * OAIDataSourceConfiguration_BoxConfiguration.h
 *
 * 
 */

#ifndef OAIDataSourceConfiguration_BoxConfiguration_H
#define OAIDataSourceConfiguration_BoxConfiguration_H
...
class OAIDataSourceConfiguration_BoxConfiguration : public OAIObject {
public:
    OAIDataSourceConfiguration_BoxConfiguration();
    OAIDataSourceConfiguration_BoxConfiguration(QString json);
    ~OAIDataSourceConfiguration_BoxConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceConfiguration_BoxConfiguration)

#endif // OAIDataSourceConfiguration_BoxConfiguration_H
