...
#ifndef OAIAlfrescoConfiguration_H
#define OAIAlfrescoConfiguration_H
...
class OAIAlfrescoConfiguration : public OAIObject {
public:
    OAIAlfrescoConfiguration();
    OAIAlfrescoConfiguration(QString json);
    ~OAIAlfrescoConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlfrescoConfiguration)

#endif // OAIAlfrescoConfiguration_H
