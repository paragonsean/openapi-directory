...
/*
 * OAIInlineCustomDocumentEnrichmentConfiguration_Condition.h
 *
 * 
 */

#ifndef OAIInlineCustomDocumentEnrichmentConfiguration_Condition_H
#define OAIInlineCustomDocumentEnrichmentConfiguration_Condition_H
...
class OAIInlineCustomDocumentEnrichmentConfiguration_Condition : public OAIObject {
public:
    OAIInlineCustomDocumentEnrichmentConfiguration_Condition();
    OAIInlineCustomDocumentEnrichmentConfiguration_Condition(QString json);
    ~OAIInlineCustomDocumentEnrichmentConfiguration_Condition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInlineCustomDocumentEnrichmentConfiguration_Condition)

#endif // OAIInlineCustomDocumentEnrichmentConfiguration_Condition_H
