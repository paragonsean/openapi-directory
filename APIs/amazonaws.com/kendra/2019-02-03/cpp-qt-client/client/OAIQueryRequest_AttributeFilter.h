...
/*
 * OAIQueryRequest_AttributeFilter.h
 *
 * 
 */

#ifndef OAIQueryRequest_AttributeFilter_H
#define OAIQueryRequest_AttributeFilter_H
...
class OAIQueryRequest_AttributeFilter : public OAIObject {
public:
    OAIQueryRequest_AttributeFilter();
    OAIQueryRequest_AttributeFilter(QString json);
    ~OAIQueryRequest_AttributeFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryRequest_AttributeFilter)

#endif // OAIQueryRequest_AttributeFilter_H
