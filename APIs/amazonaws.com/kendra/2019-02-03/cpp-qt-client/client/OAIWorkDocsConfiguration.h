...
#ifndef OAIWorkDocsConfiguration_H
#define OAIWorkDocsConfiguration_H
...
class OAIWorkDocsConfiguration : public OAIObject {
public:
    OAIWorkDocsConfiguration();
    OAIWorkDocsConfiguration(QString json);
    ~OAIWorkDocsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkDocsConfiguration)

#endif // OAIWorkDocsConfiguration_H
