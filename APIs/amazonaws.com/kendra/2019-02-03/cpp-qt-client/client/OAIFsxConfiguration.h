...
/*
 * OAIFsxConfiguration.h
 *
 * Provides the configuration information to connect to Amazon FSx as your data source.
 */

#ifndef OAIFsxConfiguration_H
#define OAIFsxConfiguration_H
...
class OAIFsxConfiguration : public OAIObject {
public:
    OAIFsxConfiguration();
    OAIFsxConfiguration(QString json);
    ~OAIFsxConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFsxConfiguration)

#endif // OAIFsxConfiguration_H
