...
/*
 * OAIDataSourceConfiguration_DatabaseConfiguration.h
 *
 * 
 */

#ifndef OAIDataSourceConfiguration_DatabaseConfiguration_H
#define OAIDataSourceConfiguration_DatabaseConfiguration_H
...
class OAIDataSourceConfiguration_DatabaseConfiguration : public OAIObject {
public:
    OAIDataSourceConfiguration_DatabaseConfiguration();
    OAIDataSourceConfiguration_DatabaseConfiguration(QString json);
    ~OAIDataSourceConfiguration_DatabaseConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceConfiguration_DatabaseConfiguration)

#endif // OAIDataSourceConfiguration_DatabaseConfiguration_H
