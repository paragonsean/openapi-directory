...
/*
 * OAIDataSourceConfiguration_GitHubConfiguration.h
 *
 * 
 */

#ifndef OAIDataSourceConfiguration_GitHubConfiguration_H
#define OAIDataSourceConfiguration_GitHubConfiguration_H
...
class OAIDataSourceConfiguration_GitHubConfiguration : public OAIObject {
public:
    OAIDataSourceConfiguration_GitHubConfiguration();
    OAIDataSourceConfiguration_GitHubConfiguration(QString json);
    ~OAIDataSourceConfiguration_GitHubConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceConfiguration_GitHubConfiguration)

#endif // OAIDataSourceConfiguration_GitHubConfiguration_H
