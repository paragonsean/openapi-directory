...
OAIDocumentAttribute_Value::OAIDocumentAttribute_Value(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentAttribute_Value::OAIDocumentAttribute_Value() {
    this->initializeModel();
}

OAIDocumentAttribute_Value::~OAIDocumentAttribute_Value() {}

void OAIDocumentAttribute_Value::initializeModel() {
...
void OAIDocumentAttribute_Value::fromJson(QString jsonString) {
...
void OAIDocumentAttribute_Value::fromJsonObject(QJsonObject json) {
...
QString OAIDocumentAttribute_Value::asJson() const {
...
QJsonObject OAIDocumentAttribute_Value::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDocumentAttribute_Value::getStringValue() const {
    return m_string_value;
}
void OAIDocumentAttribute_Value::setStringValue(const QString &string_value) {
    m_string_value = string_value;
    m_string_value_isSet = true;
}

bool OAIDocumentAttribute_Value::is_string_value_Set() const{
    return m_string_value_isSet;
}

bool OAIDocumentAttribute_Value::is_string_value_Valid() const{
    return m_string_value_isValid;
}

QList OAIDocumentAttribute_Value::getStringListValue() const {
    return m_string_list_value;
}
void OAIDocumentAttribute_Value::setStringListValue(const QList &string_list_value) {
    m_string_list_value = string_list_value;
    m_string_list_value_isSet = true;
}

bool OAIDocumentAttribute_Value::is_string_list_value_Set() const{
    return m_string_list_value_isSet;
}

bool OAIDocumentAttribute_Value::is_string_list_value_Valid() const{
    return m_string_list_value_isValid;
}

qint32 OAIDocumentAttribute_Value::getLongValue() const {
    return m_long_value;
}
void OAIDocumentAttribute_Value::setLongValue(const qint32 &long_value) {
    m_long_value = long_value;
    m_long_value_isSet = true;
}

bool OAIDocumentAttribute_Value::is_long_value_Set() const{
    return m_long_value_isSet;
}

bool OAIDocumentAttribute_Value::is_long_value_Valid() const{
    return m_long_value_isValid;
}

QDateTime OAIDocumentAttribute_Value::getDateValue() const {
    return m_date_value;
}
void OAIDocumentAttribute_Value::setDateValue(const QDateTime &date_value) {
    m_date_value = date_value;
    m_date_value_isSet = true;
}

bool OAIDocumentAttribute_Value::is_date_value_Set() const{
    return m_date_value_isSet;
}

bool OAIDocumentAttribute_Value::is_date_value_Valid() const{
    return m_date_value_isValid;
}

bool OAIDocumentAttribute_Value::isSet() const {
...
bool OAIDocumentAttribute_Value::isValid() const {
