...
class UpdateIndexRequestCapacityUnits(Model):
    ...
    def __init__(self, storage_capacity_units: int=None, query_capacity_units: int=None):
        """UpdateIndexRequestCapacityUnits - a model defined in OpenAPI

        :param storage_capacity_units: The storage_capacity_units of this UpdateIndexRequestCapacityUnits.
        :param query_capacity_units: The query_capacity_units of this UpdateIndexRequestCapacityUnits.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateIndexRequestCapacityUnits':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateIndexRequest_CapacityUnits of this UpdateIndexRequestCapacityUnits.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def storage_capacity_units(self):
        """Gets the storage_capacity_units of this UpdateIndexRequestCapacityUnits.


        :return: The storage_capacity_units of this UpdateIndexRequestCapacityUnits.
        :rtype: int
        """
    ...
    def storage_capacity_units(self, storage_capacity_units):
        """Sets the storage_capacity_units of this UpdateIndexRequestCapacityUnits.
    ...
    def query_capacity_units(self):
        """Gets the query_capacity_units of this UpdateIndexRequestCapacityUnits.


        :return: The query_capacity_units of this UpdateIndexRequestCapacityUnits.
        :rtype: int
        """
    ...
    def query_capacity_units(self, query_capacity_units):
        """Sets the query_capacity_units of this UpdateIndexRequestCapacityUnits.
