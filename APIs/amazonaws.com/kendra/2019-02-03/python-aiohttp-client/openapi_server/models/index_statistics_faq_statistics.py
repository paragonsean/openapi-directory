...
class IndexStatisticsFaqStatistics(Model):
    ...
    def __init__(self, indexed_question_answers_count: int=None):
        """IndexStatisticsFaqStatistics - a model defined in OpenAPI

        :param indexed_question_answers_count: The indexed_question_answers_count of this IndexStatisticsFaqStatistics.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'IndexStatisticsFaqStatistics':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The IndexStatistics_FaqStatistics of this IndexStatisticsFaqStatistics.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def indexed_question_answers_count(self):
        """Gets the indexed_question_answers_count of this IndexStatisticsFaqStatistics.


        :return: The indexed_question_answers_count of this IndexStatisticsFaqStatistics.
        :rtype: int
        """
    ...
    def indexed_question_answers_count(self, indexed_question_answers_count):
        """Sets the indexed_question_answers_count of this IndexStatisticsFaqStatistics.
