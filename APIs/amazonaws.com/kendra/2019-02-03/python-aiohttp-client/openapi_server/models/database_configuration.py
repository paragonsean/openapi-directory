...
class DatabaseConfiguration(Model):
    ...
    def __init__(self, database_engine_type: DatabaseEngineType=None, connection_configuration: DatabaseConfigurationConnectionConfiguration=None, vpc_configuration: DataSourceVpcConfiguration=None, column_configuration: DatabaseConfigurationColumnConfiguration=None, acl_configuration: DatabaseConfigurationAclConfiguration=None, sql_configuration: DatabaseConfigurationSqlConfiguration=None):
        ...
        :param database_engine_type: The database_engine_type of this DatabaseConfiguration.
        :param connection_configuration: The connection_configuration of this DatabaseConfiguration.
        :param vpc_configuration: The vpc_configuration of this DatabaseConfiguration.
        :param column_configuration: The column_configuration of this DatabaseConfiguration.
        :param acl_configuration: The acl_configuration of this DatabaseConfiguration.
        :param sql_configuration: The sql_configuration of this DatabaseConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DatabaseConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DatabaseConfiguration of this DatabaseConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def database_engine_type(self):
        """Gets the database_engine_type of this DatabaseConfiguration.


        :return: The database_engine_type of this DatabaseConfiguration.
    ...
    def database_engine_type(self, database_engine_type):
        """Sets the database_engine_type of this DatabaseConfiguration.
    ...
    def connection_configuration(self):
        """Gets the connection_configuration of this DatabaseConfiguration.


        :return: The connection_configuration of this DatabaseConfiguration.
    ...
    def connection_configuration(self, connection_configuration):
        """Sets the connection_configuration of this DatabaseConfiguration.
    ...
    def vpc_configuration(self):
        """Gets the vpc_configuration of this DatabaseConfiguration.


        :return: The vpc_configuration of this DatabaseConfiguration.
    ...
    def vpc_configuration(self, vpc_configuration):
        """Sets the vpc_configuration of this DatabaseConfiguration.
    ...
    def column_configuration(self):
        """Gets the column_configuration of this DatabaseConfiguration.


        :return: The column_configuration of this DatabaseConfiguration.
    ...
    def column_configuration(self, column_configuration):
        """Sets the column_configuration of this DatabaseConfiguration.
    ...
    def acl_configuration(self):
        """Gets the acl_configuration of this DatabaseConfiguration.


        :return: The acl_configuration of this DatabaseConfiguration.
    ...
    def acl_configuration(self, acl_configuration):
        """Sets the acl_configuration of this DatabaseConfiguration.
    ...
    def sql_configuration(self):
        """Gets the sql_configuration of this DatabaseConfiguration.


        :return: The sql_configuration of this DatabaseConfiguration.
    ...
    def sql_configuration(self, sql_configuration):
        """Sets the sql_configuration of this DatabaseConfiguration.
