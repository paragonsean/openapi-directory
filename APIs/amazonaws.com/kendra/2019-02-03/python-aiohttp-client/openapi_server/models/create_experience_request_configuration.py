...
class CreateExperienceRequestConfiguration(Model):
    ...
    def __init__(self, content_source_configuration: ExperienceConfigurationContentSourceConfiguration=None, user_identity_configuration: ExperienceConfigurationUserIdentityConfiguration=None):
        """CreateExperienceRequestConfiguration - a model defined in OpenAPI

        :param content_source_configuration: The content_source_configuration of this CreateExperienceRequestConfiguration.
        :param user_identity_configuration: The user_identity_configuration of this CreateExperienceRequestConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateExperienceRequestConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateExperienceRequest_Configuration of this CreateExperienceRequestConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def content_source_configuration(self):
        """Gets the content_source_configuration of this CreateExperienceRequestConfiguration.


        :return: The content_source_configuration of this CreateExperienceRequestConfiguration.
    ...
    def content_source_configuration(self, content_source_configuration):
        """Sets the content_source_configuration of this CreateExperienceRequestConfiguration.
    ...
    def user_identity_configuration(self):
        """Gets the user_identity_configuration of this CreateExperienceRequestConfiguration.


        :return: The user_identity_configuration of this CreateExperienceRequestConfiguration.
    ...
    def user_identity_configuration(self, user_identity_configuration):
        """Sets the user_identity_configuration of this CreateExperienceRequestConfiguration.
