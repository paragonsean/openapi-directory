...
/**
 * The AttributeSuggestionsGetConfigAttributeFilter model module.
 * @module model/AttributeSuggestionsGetConfigAttributeFilter
 * @version 2019-02-03
 */
class AttributeSuggestionsGetConfigAttributeFilter {
    /**
     * Constructs a new <code>AttributeSuggestionsGetConfigAttributeFilter</code>.
     * @alias module:model/AttributeSuggestionsGetConfigAttributeFilter
     * @implements module:model/AttributeFilter
     */
    constructor() { 
        AttributeFilter.initialize(this);
        AttributeSuggestionsGetConfigAttributeFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttributeSuggestionsGetConfigAttributeFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttributeSuggestionsGetConfigAttributeFilter} obj Optional instance to populate.
     * @return {module:model/AttributeSuggestionsGetConfigAttributeFilter} The populated <code>AttributeSuggestionsGetConfigAttributeFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttributeSuggestionsGetConfigAttributeFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>AttributeSuggestionsGetConfigAttributeFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttributeSuggestionsGetConfigAttributeFilter</code>.
     */
 ...
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['AndAllFilters'] = undefined;

/**
 * @member {Array} OrAllFilters
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['OrAllFilters'] = undefined;

/**
 * @member {module:model/AttributeFilterNotFilter} NotFilter
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['NotFilter'] = undefined;

/**
 * @member {module:model/AttributeFilterEqualsTo} EqualsTo
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['EqualsTo'] = undefined;

/**
 * @member {module:model/AttributeFilterContainsAll} ContainsAll
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['ContainsAll'] = undefined;

/**
 * @member {module:model/AttributeFilterContainsAny} ContainsAny
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['ContainsAny'] = undefined;

/**
 * @member {module:model/AttributeFilterGreaterThan} GreaterThan
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['GreaterThan'] = undefined;

/**
 * @member {module:model/AttributeFilterGreaterThanOrEquals} GreaterThanOrEquals
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['GreaterThanOrEquals'] = undefined;

/**
 * @member {module:model/AttributeFilterLessThan} LessThan
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['LessThan'] = undefined;

/**
 * @member {module:model/AttributeFilterLessThanOrEquals} LessThanOrEquals
 */
AttributeSuggestionsGetConfigAttributeFilter.prototype['LessThanOrEquals'] = undefined;
...
export default AttributeSuggestionsGetConfigAttributeFilter;
