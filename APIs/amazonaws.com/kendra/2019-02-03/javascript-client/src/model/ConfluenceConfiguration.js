...
/**
 * The ConfluenceConfiguration model module.
 * @module model/ConfluenceConfiguration
 * @version 2019-02-03
 */
class ConfluenceConfiguration {
    /**
     * Constructs a new <code>ConfluenceConfiguration</code>.
     * Provides the configuration information to connect to Confluence as your data source.
     * @alias module:model/ConfluenceConfiguration
    ...
    /**
     * Constructs a <code>ConfluenceConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfluenceConfiguration} obj Optional instance to populate.
     * @return {module:model/ConfluenceConfiguration} The populated <code>ConfluenceConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfluenceConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfluenceConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfluenceConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConfluenceConfiguration.RequiredProperties) {
...
ConfluenceConfiguration.RequiredProperties = ["ServerUrl", "SecretArn", "Version"];
...
export default ConfluenceConfiguration;
