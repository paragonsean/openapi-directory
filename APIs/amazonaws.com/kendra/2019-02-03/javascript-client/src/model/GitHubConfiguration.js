...
/**
 * The GitHubConfiguration model module.
 * @module model/GitHubConfiguration
 * @version 2019-02-03
 */
class GitHubConfiguration {
    /**
     * Constructs a new <code>GitHubConfiguration</code>.
     * Provides the configuration information to connect to GitHub as your data source.
     * @alias module:model/GitHubConfiguration
    ...
    /**
     * Constructs a <code>GitHubConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GitHubConfiguration} obj Optional instance to populate.
     * @return {module:model/GitHubConfiguration} The populated <code>GitHubConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GitHubConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>GitHubConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GitHubConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GitHubConfiguration.RequiredProperties) {
...
GitHubConfiguration.RequiredProperties = ["SecretArn"];
