...
/**
 * The DescribeDataSourceResponseConfiguration model module.
 * @module model/DescribeDataSourceResponseConfiguration
 * @version 2019-02-03
 */
class DescribeDataSourceResponseConfiguration {
    /**
     * Constructs a new <code>DescribeDataSourceResponseConfiguration</code>.
     * @alias module:model/DescribeDataSourceResponseConfiguration
     * @implements module:model/DataSourceConfiguration
     */
    constructor() { 
        DataSourceConfiguration.initialize(this);
        DescribeDataSourceResponseConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeDataSourceResponseConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeDataSourceResponseConfiguration} obj Optional instance to populate.
     * @return {module:model/DescribeDataSourceResponseConfiguration} The populated <code>DescribeDataSourceResponseConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeDataSourceResponseConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeDataSourceResponseConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeDataSourceResponseConfiguration</code>.
     */
 ...
 */
DescribeDataSourceResponseConfiguration.prototype['S3Configuration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationSharePointConfiguration} SharePointConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['SharePointConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationDatabaseConfiguration} DatabaseConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['DatabaseConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationSalesforceConfiguration} SalesforceConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['SalesforceConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationOneDriveConfiguration} OneDriveConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['OneDriveConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationServiceNowConfiguration} ServiceNowConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['ServiceNowConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationConfluenceConfiguration} ConfluenceConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['ConfluenceConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationGoogleDriveConfiguration} GoogleDriveConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['GoogleDriveConfiguration'] = undefined;

/**
 * @member {module:model/WebCrawlerConfiguration} WebCrawlerConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['WebCrawlerConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationWorkDocsConfiguration} WorkDocsConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['WorkDocsConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationFsxConfiguration} FsxConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['FsxConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationSlackConfiguration} SlackConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['SlackConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationBoxConfiguration} BoxConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['BoxConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationQuipConfiguration} QuipConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['QuipConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationJiraConfiguration} JiraConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['JiraConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationGitHubConfiguration} GitHubConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['GitHubConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationAlfrescoConfiguration} AlfrescoConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['AlfrescoConfiguration'] = undefined;

/**
 * @member {module:model/DataSourceConfigurationTemplateConfiguration} TemplateConfiguration
 */
DescribeDataSourceResponseConfiguration.prototype['TemplateConfiguration'] = undefined;
...
export default DescribeDataSourceResponseConfiguration;
