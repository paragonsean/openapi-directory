...
/**
 * The DataSourceConfigurationSharePointConfiguration model module.
 * @module model/DataSourceConfigurationSharePointConfiguration
 * @version 2019-02-03
 */
class DataSourceConfigurationSharePointConfiguration {
    /**
     * Constructs a new <code>DataSourceConfigurationSharePointConfiguration</code>.
     * @alias module:model/DataSourceConfigurationSharePointConfiguration
     * @implements module:model/SharePointConfiguration
    ...
    constructor(sharePointVersion, urls, secretArn) { 
        ...
        DataSourceConfigurationSharePointConfiguration.initialize(this, sharePointVersion, urls, secretArn);
    }
    ...
    /**
     * Constructs a <code>DataSourceConfigurationSharePointConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataSourceConfigurationSharePointConfiguration} obj Optional instance to populate.
     * @return {module:model/DataSourceConfigurationSharePointConfiguration} The populated <code>DataSourceConfigurationSharePointConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataSourceConfigurationSharePointConfiguration();
            SharePointConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DataSourceConfigurationSharePointConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataSourceConfigurationSharePointConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DataSourceConfigurationSharePointConfiguration.RequiredProperties) {
...
DataSourceConfigurationSharePointConfiguration.RequiredProperties = ["SharePointVersion", "Urls", "SecretArn"];

/**
 * @member {module:model/SharePointVersion} SharePointVersion
 */
DataSourceConfigurationSharePointConfiguration.prototype['SharePointVersion'] = undefined;

/**
 * @member {Array} Urls
 */
DataSourceConfigurationSharePointConfiguration.prototype['Urls'] = undefined;

/**
 * @member {String} SecretArn
 */
DataSourceConfigurationSharePointConfiguration.prototype['SecretArn'] = undefined;

/**
 * @member {Boolean} CrawlAttachments
 */
DataSourceConfigurationSharePointConfiguration.prototype['CrawlAttachments'] = undefined;

/**
 * @member {Boolean} UseChangeLog
 */
DataSourceConfigurationSharePointConfiguration.prototype['UseChangeLog'] = undefined;

/**
 * @member {Array} InclusionPatterns
 */
DataSourceConfigurationSharePointConfiguration.prototype['InclusionPatterns'] = undefined;

/**
 * @member {Array} ExclusionPatterns
 */
DataSourceConfigurationSharePointConfiguration.prototype['ExclusionPatterns'] = undefined;

/**
 * @member {module:model/SharePointConfigurationVpcConfiguration} VpcConfiguration
 */
DataSourceConfigurationSharePointConfiguration.prototype['VpcConfiguration'] = undefined;

/**
 * @member {Array} FieldMappings
 */
DataSourceConfigurationSharePointConfiguration.prototype['FieldMappings'] = undefined;

/**
 * @member {String} DocumentTitleFieldName
 */
DataSourceConfigurationSharePointConfiguration.prototype['DocumentTitleFieldName'] = undefined;

/**
 * @member {Boolean} DisableLocalGroups
 */
DataSourceConfigurationSharePointConfiguration.prototype['DisableLocalGroups'] = undefined;

/**
 * @member {module:model/SharePointConfigurationSslCertificateS3Path} SslCertificateS3Path
 */
DataSourceConfigurationSharePointConfiguration.prototype['SslCertificateS3Path'] = undefined;

/**
 * @member {module:model/SharePointOnlineAuthenticationType} AuthenticationType
 */
DataSourceConfigurationSharePointConfiguration.prototype['AuthenticationType'] = undefined;

/**
 * @member {module:model/SharePointConfigurationProxyConfiguration} ProxyConfiguration
 */
DataSourceConfigurationSharePointConfiguration.prototype['ProxyConfiguration'] = undefined;


// Implement SharePointConfiguration interface:
/**
 * @member {module:model/SharePointVersion} SharePointVersion
 */
...
export default DataSourceConfigurationSharePointConfiguration;
