...
/**
 * The DataSourceConfigurationSlackConfiguration model module.
 * @module model/DataSourceConfigurationSlackConfiguration
 * @version 2019-02-03
 */
class DataSourceConfigurationSlackConfiguration {
    /**
     * Constructs a new <code>DataSourceConfigurationSlackConfiguration</code>.
     * @alias module:model/DataSourceConfigurationSlackConfiguration
     * @implements module:model/SlackConfiguration
     * @param teamId {String} 
    ...
    constructor(teamId, secretArn, slackEntityList, sinceCrawlDate) { 
        ...
        DataSourceConfigurationSlackConfiguration.initialize(this, teamId, secretArn, slackEntityList, sinceCrawlDate);
    }
    ...
    /**
     * Constructs a <code>DataSourceConfigurationSlackConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataSourceConfigurationSlackConfiguration} obj Optional instance to populate.
     * @return {module:model/DataSourceConfigurationSlackConfiguration} The populated <code>DataSourceConfigurationSlackConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataSourceConfigurationSlackConfiguration();
            SlackConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DataSourceConfigurationSlackConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataSourceConfigurationSlackConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DataSourceConfigurationSlackConfiguration.RequiredProperties) {
...
DataSourceConfigurationSlackConfiguration.RequiredProperties = ["TeamId", "SecretArn", "SlackEntityList", "SinceCrawlDate"];

/**
 * @member {String} TeamId
 */
DataSourceConfigurationSlackConfiguration.prototype['TeamId'] = undefined;

/**
 * @member {String} SecretArn
 */
DataSourceConfigurationSlackConfiguration.prototype['SecretArn'] = undefined;

/**
 * @member {module:model/SlackConfigurationVpcConfiguration} VpcConfiguration
 */
DataSourceConfigurationSlackConfiguration.prototype['VpcConfiguration'] = undefined;

/**
 * @member {Array} SlackEntityList
 */
DataSourceConfigurationSlackConfiguration.prototype['SlackEntityList'] = undefined;

/**
 * @member {Boolean} UseChangeLog
 */
DataSourceConfigurationSlackConfiguration.prototype['UseChangeLog'] = undefined;

/**
 * @member {Boolean} CrawlBotMessage
 */
DataSourceConfigurationSlackConfiguration.prototype['CrawlBotMessage'] = undefined;

/**
 * @member {Boolean} ExcludeArchived
 */
DataSourceConfigurationSlackConfiguration.prototype['ExcludeArchived'] = undefined;

/**
 * @member {String} SinceCrawlDate
 */
DataSourceConfigurationSlackConfiguration.prototype['SinceCrawlDate'] = undefined;

/**
 * @member {Number} LookBackPeriod
 */
DataSourceConfigurationSlackConfiguration.prototype['LookBackPeriod'] = undefined;

/**
 * @member {Array} PrivateChannelFilter
 */
DataSourceConfigurationSlackConfiguration.prototype['PrivateChannelFilter'] = undefined;

/**
 * @member {Array} PublicChannelFilter
 */
DataSourceConfigurationSlackConfiguration.prototype['PublicChannelFilter'] = undefined;

/**
 * @member {Array} InclusionPatterns
 */
DataSourceConfigurationSlackConfiguration.prototype['InclusionPatterns'] = undefined;

/**
 * @member {Array} ExclusionPatterns
 */
DataSourceConfigurationSlackConfiguration.prototype['ExclusionPatterns'] = undefined;

/**
 * @member {Array} FieldMappings
 */
DataSourceConfigurationSlackConfiguration.prototype['FieldMappings'] = undefined;


// Implement SlackConfiguration interface:
/**
 * @member {String} TeamId
 */
...
export default DataSourceConfigurationSlackConfiguration;
