...
/**
 * The GitHubDocumentCrawlProperties model module.
 * @module model/GitHubDocumentCrawlProperties
 * @version 2019-02-03
 */
class GitHubDocumentCrawlProperties {
    /**
     * Constructs a new <code>GitHubDocumentCrawlProperties</code>.
     ...
     * @alias module:model/GitHubDocumentCrawlProperties
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>GitHubDocumentCrawlProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GitHubDocumentCrawlProperties} obj Optional instance to populate.
     * @return {module:model/GitHubDocumentCrawlProperties} The populated <code>GitHubDocumentCrawlProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GitHubDocumentCrawlProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>GitHubDocumentCrawlProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GitHubDocumentCrawlProperties</code>.
     */
...
export default GitHubDocumentCrawlProperties;
