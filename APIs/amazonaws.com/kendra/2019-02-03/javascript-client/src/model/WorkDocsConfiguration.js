...
/**
 * The WorkDocsConfiguration model module.
 * @module model/WorkDocsConfiguration
 * @version 2019-02-03
 */
class WorkDocsConfiguration {
    /**
     * Constructs a new <code>WorkDocsConfiguration</code>.
     ...
     * @alias module:model/WorkDocsConfiguration
    ...
    /**
     * Constructs a <code>WorkDocsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkDocsConfiguration} obj Optional instance to populate.
     * @return {module:model/WorkDocsConfiguration} The populated <code>WorkDocsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkDocsConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkDocsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkDocsConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkDocsConfiguration.RequiredProperties) {
...
WorkDocsConfiguration.RequiredProperties = ["OrganizationId"];
...
export default WorkDocsConfiguration;
