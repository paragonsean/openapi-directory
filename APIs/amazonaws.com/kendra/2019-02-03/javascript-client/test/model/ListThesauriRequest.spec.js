...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.ListThesauriRequest();
  });
  ...
  describe('ListThesauriRequest', function() {
    it('should create an instance of ListThesauriRequest', function() {
      // uncomment below and update the code to test ListThesauriRequest
      //var instance = new AwsKendraFrontendService.ListThesauriRequest();
      //expect(instance).to.be.a(AwsKendraFrontendService.ListThesauriRequest);
    });
