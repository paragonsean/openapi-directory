...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.SuggestableConfig();
  });
  ...
  describe('SuggestableConfig', function() {
    it('should create an instance of SuggestableConfig', function() {
      // uncomment below and update the code to test SuggestableConfig
      //var instance = new AwsKendraFrontendService.SuggestableConfig();
      //expect(instance).to.be.a(AwsKendraFrontendService.SuggestableConfig);
    });
