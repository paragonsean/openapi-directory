...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.TimeRange();
  });
  ...
  describe('TimeRange', function() {
    it('should create an instance of TimeRange', function() {
      ...
      //var instance = new AwsKendraFrontendService.TimeRange();
      //expect(instance).to.be.a(AwsKendraFrontendService.TimeRange);
    });
