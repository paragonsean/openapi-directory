...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.DescribeDataSourceResponse();
  });
  ...
  describe('DescribeDataSourceResponse', function() {
    it('should create an instance of DescribeDataSourceResponse', function() {
      // uncomment below and update the code to test DescribeDataSourceResponse
      //var instance = new AwsKendraFrontendService.DescribeDataSourceResponse();
      //expect(instance).to.be.a(AwsKendraFrontendService.DescribeDataSourceResponse);
    });
