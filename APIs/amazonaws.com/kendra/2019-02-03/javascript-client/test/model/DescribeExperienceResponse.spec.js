...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.DescribeExperienceResponse();
  });
  ...
  describe('DescribeExperienceResponse', function() {
    it('should create an instance of DescribeExperienceResponse', function() {
      // uncomment below and update the code to test DescribeExperienceResponse
      //var instance = new AwsKendraFrontendService.DescribeExperienceResponse();
      //expect(instance).to.be.a(AwsKendraFrontendService.DescribeExperienceResponse);
    });
