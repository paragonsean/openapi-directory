...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.SuggestionHighlight();
  });
  ...
  describe('SuggestionHighlight', function() {
    it('should create an instance of SuggestionHighlight', function() {
      // uncomment below and update the code to test SuggestionHighlight
      //var instance = new AwsKendraFrontendService.SuggestionHighlight();
      //expect(instance).to.be.a(AwsKendraFrontendService.SuggestionHighlight);
    });
