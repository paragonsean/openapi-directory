...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.Principal();
  });
  ...
  describe('Principal', function() {
    it('should create an instance of Principal', function() {
      ...
      //var instance = new AwsKendraFrontendService.Principal();
      //expect(instance).to.be.a(AwsKendraFrontendService.Principal);
    });
