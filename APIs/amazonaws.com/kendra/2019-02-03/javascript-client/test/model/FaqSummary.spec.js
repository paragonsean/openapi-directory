...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.FaqSummary();
  });
  ...
  describe('FaqSummary', function() {
    it('should create an instance of FaqSummary', function() {
      // uncomment below and update the code to test FaqSummary
      //var instance = new AwsKendraFrontendService.FaqSummary();
      //expect(instance).to.be.a(AwsKendraFrontendService.FaqSummary);
    });
