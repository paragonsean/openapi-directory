...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.DescribeFaqResponse();
  });
  ...
  describe('DescribeFaqResponse', function() {
    it('should create an instance of DescribeFaqResponse', function() {
      // uncomment below and update the code to test DescribeFaqResponse
      //var instance = new AwsKendraFrontendService.DescribeFaqResponse();
      //expect(instance).to.be.a(AwsKendraFrontendService.DescribeFaqResponse);
    });
