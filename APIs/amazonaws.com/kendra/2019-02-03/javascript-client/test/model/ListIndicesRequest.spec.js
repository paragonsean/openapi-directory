...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.ListIndicesRequest();
  });
  ...
  describe('ListIndicesRequest', function() {
    it('should create an instance of ListIndicesRequest', function() {
      // uncomment below and update the code to test ListIndicesRequest
      //var instance = new AwsKendraFrontendService.ListIndicesRequest();
      //expect(instance).to.be.a(AwsKendraFrontendService.ListIndicesRequest);
    });
