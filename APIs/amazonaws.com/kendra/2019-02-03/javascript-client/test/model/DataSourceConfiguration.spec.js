...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.DataSourceConfiguration();
  });
  ...
  describe('DataSourceConfiguration', function() {
    it('should create an instance of DataSourceConfiguration', function() {
      // uncomment below and update the code to test DataSourceConfiguration
      //var instance = new AwsKendraFrontendService.DataSourceConfiguration();
      //expect(instance).to.be.a(AwsKendraFrontendService.DataSourceConfiguration);
    });
