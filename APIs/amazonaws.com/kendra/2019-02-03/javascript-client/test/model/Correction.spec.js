...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.Correction();
  });
  ...
  describe('Correction', function() {
    it('should create an instance of Correction', function() {
      ...
      //var instance = new AwsKendraFrontendService.Correction();
      //expect(instance).to.be.a(AwsKendraFrontendService.Correction);
    });
    ...
    it('should have the property correctedTerm (base name: "CorrectedTerm")', function() {
      // uncomment below and update the code to test the property correctedTerm
      //var instance = new AwsKendraFrontendService.Correction();
      //expect(instance).to.be();
    });
