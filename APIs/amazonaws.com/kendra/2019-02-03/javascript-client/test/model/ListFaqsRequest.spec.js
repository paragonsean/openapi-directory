...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.ListFaqsRequest();
  });
  ...
  describe('ListFaqsRequest', function() {
    it('should create an instance of ListFaqsRequest', function() {
      // uncomment below and update the code to test ListFaqsRequest
      //var instance = new AwsKendraFrontendService.ListFaqsRequest();
      //expect(instance).to.be.a(AwsKendraFrontendService.ListFaqsRequest);
    });
