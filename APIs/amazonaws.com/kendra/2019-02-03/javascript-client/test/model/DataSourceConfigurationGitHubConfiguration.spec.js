...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.DataSourceConfigurationGitHubConfiguration();
  });
  ...
  describe('DataSourceConfigurationGitHubConfiguration', function() {
    it('should create an instance of DataSourceConfigurationGitHubConfiguration', function() {
      // uncomment below and update the code to test DataSourceConfigurationGitHubConfiguration
      //var instance = new AwsKendraFrontendService.DataSourceConfigurationGitHubConfiguration();
      //expect(instance).to.be.a(AwsKendraFrontendService.DataSourceConfigurationGitHubConfiguration);
    });
