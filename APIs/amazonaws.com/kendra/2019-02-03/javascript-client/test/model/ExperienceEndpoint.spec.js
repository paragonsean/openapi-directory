...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.ExperienceEndpoint();
  });
  ...
  describe('ExperienceEndpoint', function() {
    it('should create an instance of ExperienceEndpoint', function() {
      // uncomment below and update the code to test ExperienceEndpoint
      //var instance = new AwsKendraFrontendService.ExperienceEndpoint();
      //expect(instance).to.be.a(AwsKendraFrontendService.ExperienceEndpoint);
    });
