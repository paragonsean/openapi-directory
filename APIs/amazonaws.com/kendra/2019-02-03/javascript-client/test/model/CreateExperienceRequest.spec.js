...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKendraFrontendService.CreateExperienceRequest();
  });
  ...
  describe('CreateExperienceRequest', function() {
    it('should create an instance of CreateExperienceRequest', function() {
      // uncomment below and update the code to test CreateExperienceRequest
      //var instance = new AwsKendraFrontendService.CreateExperienceRequest();
      //expect(instance).to.be.a(AwsKendraFrontendService.CreateExperienceRequest);
    });
