...
/**
 * The RDSDataSpec model module.
 * @module model/RDSDataSpec
 * @version 2014-12-12
 */
class RDSDataSpec {
    /**
     * Constructs a new <code>RDSDataSpec</code>.
     * The data specification of an Amazon Relational Database Service (Amazon RDS) &lt;code&gt;DataSource&lt;/code&gt;.
     * @alias module:model/RDSDataSpec
    ...
    /**
     * Constructs a <code>RDSDataSpec</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RDSDataSpec} obj Optional instance to populate.
     * @return {module:model/RDSDataSpec} The populated <code>RDSDataSpec</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RDSDataSpec();
    ...
    /**
     * Validates the JSON data with respect to <code>RDSDataSpec</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RDSDataSpec</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RDSDataSpec.RequiredProperties) {
...
RDSDataSpec.RequiredProperties = ["DatabaseInformation", "SelectSqlQuery", "DatabaseCredentials", "S3StagingLocation", "ResourceRole", "ServiceRole", "SubnetId", "SecurityGroupIds"];
