...
import MLModelFilterVariable from './MLModelFilterVariable';
import SortOrder from './SortOrder';

/**
 * The DescribeMLModelsInput model module.
 * @module model/DescribeMLModelsInput
 * @version 2014-12-12
 */
class DescribeMLModelsInput {
    /**
     * Constructs a new <code>DescribeMLModelsInput</code>.
     * @alias module:model/DescribeMLModelsInput
     */
    constructor() { 
        
        DescribeMLModelsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMLModelsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMLModelsInput} obj Optional instance to populate.
     * @return {module:model/DescribeMLModelsInput} The populated <code>DescribeMLModelsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMLModelsInput();

            if (data.hasOwnProperty('FilterVariable')) {
                obj['FilterVariable'] = ApiClient.convertToType(data['FilterVariable'], MLModelFilterVariable);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMLModelsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMLModelsInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FilterVariable`
        if (data['FilterVariable']) { // data not null
          MLModelFilterVariable.validateJSON(data['FilterVariable']);
        }
...
/**
 * @member {module:model/MLModelFilterVariable} FilterVariable
 */
DescribeMLModelsInput.prototype['FilterVariable'] = undefined;

/**
 * @member {String} EQ
 */
DescribeMLModelsInput.prototype['EQ'] = undefined;

/**
 * @member {String} GT
 */
DescribeMLModelsInput.prototype['GT'] = undefined;

/**
 * @member {String} LT
 */
DescribeMLModelsInput.prototype['LT'] = undefined;

/**
 * @member {String} GE
 */
DescribeMLModelsInput.prototype['GE'] = undefined;

/**
 * @member {String} LE
 */
DescribeMLModelsInput.prototype['LE'] = undefined;

/**
 * @member {String} NE
 */
DescribeMLModelsInput.prototype['NE'] = undefined;

/**
 * @member {String} Prefix
 */
DescribeMLModelsInput.prototype['Prefix'] = undefined;

/**
 * @member {module:model/SortOrder} SortOrder
 */
DescribeMLModelsInput.prototype['SortOrder'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeMLModelsInput.prototype['NextToken'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeMLModelsInput.prototype['Limit'] = undefined;
...
export default DescribeMLModelsInput;
