...
**dataLocationS3** | **String** |  | [optional] 
**dataRearrangement** | **String** |  | [optional] 
**createdByIamUser** | **String** |  | [optional] 
**createdAt** | **Date** |  | [optional] 
**lastUpdatedAt** | **Date** |  | [optional] 
**dataSizeInBytes** | **Number** |  | [optional] 
**numberOfFiles** | **Number** |  | [optional] 
...
**computeStatistics** | **Boolean** |  | [optional] 
**computeTime** | **Number** | Long integer type that is a 64-bit signed number. | [optional] 
**finishedAt** | **Date** | A timestamp represented in epoch time. | [optional] 
**startedAt** | **Date** | A timestamp represented in epoch time. | [optional] 
