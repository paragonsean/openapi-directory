...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.CreateDataSourceFromS3Input();
  });
  ...
  describe('CreateDataSourceFromS3Input', function() {
    it('should create an instance of CreateDataSourceFromS3Input', function() {
      // uncomment below and update the code to test CreateDataSourceFromS3Input
      //var instance = new AmazonMachineLearning.CreateDataSourceFromS3Input();
      //expect(instance).to.be.a(AmazonMachineLearning.CreateDataSourceFromS3Input);
    });
