...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.GetDataSourceInput();
  });
  ...
  describe('GetDataSourceInput', function() {
    it('should create an instance of GetDataSourceInput', function() {
      // uncomment below and update the code to test GetDataSourceInput
      //var instance = new AmazonMachineLearning.GetDataSourceInput();
      //expect(instance).to.be.a(AmazonMachineLearning.GetDataSourceInput);
    });
