...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.DescribeMLModelsInput();
  });
  ...
  describe('DescribeMLModelsInput', function() {
    it('should create an instance of DescribeMLModelsInput', function() {
      // uncomment below and update the code to test DescribeMLModelsInput
      //var instance = new AmazonMachineLearning.DescribeMLModelsInput();
      //expect(instance).to.be.a(AmazonMachineLearning.DescribeMLModelsInput);
    });
