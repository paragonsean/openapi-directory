...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.GetDataSourceOutput();
  });
  ...
  describe('GetDataSourceOutput', function() {
    it('should create an instance of GetDataSourceOutput', function() {
      // uncomment below and update the code to test GetDataSourceOutput
      //var instance = new AmazonMachineLearning.GetDataSourceOutput();
      //expect(instance).to.be.a(AmazonMachineLearning.GetDataSourceOutput);
    });
    ...
    it('should have the property dataSourceSchema (base name: "DataSourceSchema")', function() {
      // uncomment below and update the code to test the property dataSourceSchema
      //var instance = new AmazonMachineLearning.GetDataSourceOutput();
      //expect(instance).to.be();
    });
