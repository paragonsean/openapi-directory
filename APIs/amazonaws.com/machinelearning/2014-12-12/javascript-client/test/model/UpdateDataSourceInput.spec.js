...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.UpdateDataSourceInput();
  });
  ...
  describe('UpdateDataSourceInput', function() {
    it('should create an instance of UpdateDataSourceInput', function() {
      // uncomment below and update the code to test UpdateDataSourceInput
      //var instance = new AmazonMachineLearning.UpdateDataSourceInput();
      //expect(instance).to.be.a(AmazonMachineLearning.UpdateDataSourceInput);
    });
