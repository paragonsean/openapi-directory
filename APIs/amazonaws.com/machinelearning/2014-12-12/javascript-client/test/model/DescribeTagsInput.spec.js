...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.DescribeTagsInput();
  });
  ...
  describe('DescribeTagsInput', function() {
    it('should create an instance of DescribeTagsInput', function() {
      ...
      //var instance = new AmazonMachineLearning.DescribeTagsInput();
      //expect(instance).to.be.a(AmazonMachineLearning.DescribeTagsInput);
    });
