...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.DescribeEvaluationsInput();
  });
  ...
  describe('DescribeEvaluationsInput', function() {
    it('should create an instance of DescribeEvaluationsInput', function() {
      // uncomment below and update the code to test DescribeEvaluationsInput
      //var instance = new AmazonMachineLearning.DescribeEvaluationsInput();
      //expect(instance).to.be.a(AmazonMachineLearning.DescribeEvaluationsInput);
    });
