...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.AddTagsOutput();
  });
  ...
  describe('AddTagsOutput', function() {
    it('should create an instance of AddTagsOutput', function() {
      ...
      //var instance = new AmazonMachineLearning.AddTagsOutput();
      //expect(instance).to.be.a(AmazonMachineLearning.AddTagsOutput);
    });
