...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.AddTagsInput();
  });
  ...
  describe('AddTagsInput', function() {
    it('should create an instance of AddTagsInput', function() {
      ...
      //var instance = new AmazonMachineLearning.AddTagsInput();
      //expect(instance).to.be.a(AmazonMachineLearning.AddTagsInput);
    });
