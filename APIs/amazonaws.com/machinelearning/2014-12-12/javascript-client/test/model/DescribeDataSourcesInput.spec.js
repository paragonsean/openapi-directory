...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.DescribeDataSourcesInput();
  });
  ...
  describe('DescribeDataSourcesInput', function() {
    it('should create an instance of DescribeDataSourcesInput', function() {
      // uncomment below and update the code to test DescribeDataSourcesInput
      //var instance = new AmazonMachineLearning.DescribeDataSourcesInput();
      //expect(instance).to.be.a(AmazonMachineLearning.DescribeDataSourcesInput);
    });
