...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.DescribeTagsOutput();
  });
  ...
  describe('DescribeTagsOutput', function() {
    it('should create an instance of DescribeTagsOutput', function() {
      ...
      //var instance = new AmazonMachineLearning.DescribeTagsOutput();
      //expect(instance).to.be.a(AmazonMachineLearning.DescribeTagsOutput);
    });
