...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.CreateDataSourceFromRDSInput();
  });
  ...
  describe('CreateDataSourceFromRDSInput', function() {
    it('should create an instance of CreateDataSourceFromRDSInput', function() {
      // uncomment below and update the code to test CreateDataSourceFromRDSInput
      //var instance = new AmazonMachineLearning.CreateDataSourceFromRDSInput();
      //expect(instance).to.be.a(AmazonMachineLearning.CreateDataSourceFromRDSInput);
    });
    ...
    it('should have the property rDSData (base name: "RDSData")', function() {
      // uncomment below and update the code to test the property rDSData
      //var instance = new AmazonMachineLearning.CreateDataSourceFromRDSInput();
      //expect(instance).to.be();
    });
