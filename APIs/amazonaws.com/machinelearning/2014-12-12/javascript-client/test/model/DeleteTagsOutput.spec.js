...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMachineLearning.DeleteTagsOutput();
  });
  ...
  describe('DeleteTagsOutput', function() {
    it('should create an instance of DeleteTagsOutput', function() {
      // uncomment below and update the code to test DeleteTagsOutput
      //var instance = new AmazonMachineLearning.DeleteTagsOutput();
      //expect(instance).to.be.a(AmazonMachineLearning.DeleteTagsOutput);
    });
