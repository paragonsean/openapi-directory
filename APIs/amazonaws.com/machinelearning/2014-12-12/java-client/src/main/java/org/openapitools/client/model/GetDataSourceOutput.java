...
public class GetDataSourceOutput {
  ...
  public static final String SERIALIZED_NAME_DATA_SOURCE_SCHEMA = "DataSourceSchema";
  @SerializedName(SERIALIZED_NAME_DATA_SOURCE_SCHEMA)
  private String dataSourceSchema;

  public GetDataSourceOutput() {
  }

  public GetDataSourceOutput dataSourceId(String dataSourceId) {
  ...
  public GetDataSourceOutput dataLocationS3(String dataLocationS3) {
  ...
  public GetDataSourceOutput dataRearrangement(String dataRearrangement) {
  ...
  public GetDataSourceOutput createdByIamUser(String createdByIamUser) {
  ...
  public GetDataSourceOutput createdAt(OffsetDateTime createdAt) {
  ...
  public GetDataSourceOutput lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public GetDataSourceOutput dataSizeInBytes(Integer dataSizeInBytes) {
  ...
  public GetDataSourceOutput numberOfFiles(Integer numberOfFiles) {
  ...
  public GetDataSourceOutput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetDataSourceOutput status(EntityStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetDataSourceOutput logUri(String logUri) {
    this.logUri = logUri;
    return this;
  }
  ...
  public GetDataSourceOutput message(String message) {
  ...
  public GetDataSourceOutput redshiftMetadata(RedshiftMetadata redshiftMetadata) {
  ...
  public GetDataSourceOutput rdSMetadata(RDSMetadata rdSMetadata) {
  ...
  public GetDataSourceOutput roleARN(String roleARN) {
  ...
  public GetDataSourceOutput computeStatistics(Boolean computeStatistics) {
  ...
  public GetDataSourceOutput computeTime(Integer computeTime) {
  ...
  public GetDataSourceOutput finishedAt(OffsetDateTime finishedAt) {
  ...
  public GetDataSourceOutput startedAt(OffsetDateTime startedAt) {
  ...
  public GetDataSourceOutput dataSourceSchema(String dataSourceSchema) {
  ...
  public boolean equals(Object o) {
    ...
    GetDataSourceOutput getDataSourceOutput = (GetDataSourceOutput) o;
    return Objects.equals(this.dataSourceId, getDataSourceOutput.dataSourceId) &&
        Objects.equals(this.dataLocationS3, getDataSourceOutput.dataLocationS3) &&
        Objects.equals(this.dataRearrangement, getDataSourceOutput.dataRearrangement) &&
        Objects.equals(this.createdByIamUser, getDataSourceOutput.createdByIamUser) &&
        Objects.equals(this.createdAt, getDataSourceOutput.createdAt) &&
        Objects.equals(this.lastUpdatedAt, getDataSourceOutput.lastUpdatedAt) &&
        Objects.equals(this.dataSizeInBytes, getDataSourceOutput.dataSizeInBytes) &&
        Objects.equals(this.numberOfFiles, getDataSourceOutput.numberOfFiles) &&
        Objects.equals(this.name, getDataSourceOutput.name) &&
        Objects.equals(this.status, getDataSourceOutput.status) &&
        Objects.equals(this.logUri, getDataSourceOutput.logUri) &&
        Objects.equals(this.message, getDataSourceOutput.message) &&
        Objects.equals(this.redshiftMetadata, getDataSourceOutput.redshiftMetadata) &&
        Objects.equals(this.rdSMetadata, getDataSourceOutput.rdSMetadata) &&
        Objects.equals(this.roleARN, getDataSourceOutput.roleARN) &&
        Objects.equals(this.computeStatistics, getDataSourceOutput.computeStatistics) &&
        Objects.equals(this.computeTime, getDataSourceOutput.computeTime) &&
        Objects.equals(this.finishedAt, getDataSourceOutput.finishedAt) &&
        Objects.equals(this.startedAt, getDataSourceOutput.startedAt) &&
        Objects.equals(this.dataSourceSchema, getDataSourceOutput.dataSourceSchema);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataSourceId, dataLocationS3, dataRearrangement, createdByIamUser, createdAt, lastUpdatedAt, dataSizeInBytes, numberOfFiles, name, status, logUri, message, redshiftMetadata, rdSMetadata, roleARN, computeStatistics, computeTime, finishedAt, startedAt, dataSourceSchema);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDataSourceOutput {\n");
    ...
    sb.append("    dataSourceSchema: ").append(toIndentedString(dataSourceSchema)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DataSourceSchema");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDataSourceOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDataSourceOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDataSourceOutput is not found in the empty JSON string", GetDataSourceOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDataSourceOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDataSourceOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("DataSourceSchema") != null && !jsonObj.get("DataSourceSchema").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("DataSourceSchema"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDataSourceOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDataSourceOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDataSourceOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDataSourceOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDataSourceOutput>() {
           @Override
           public void write(JsonWriter out, GetDataSourceOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDataSourceOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDataSourceOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDataSourceOutput
   * @throws IOException if the JSON string is invalid with respect to GetDataSourceOutput
   */
  public static GetDataSourceOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDataSourceOutput.class);
  }

  /**
   * Convert an instance of GetDataSourceOutput to an JSON string
   *
   * @return JSON string
   */
