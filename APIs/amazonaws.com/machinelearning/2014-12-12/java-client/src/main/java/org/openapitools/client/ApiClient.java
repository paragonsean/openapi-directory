...
public class ApiClient {
    ...
    private String basePath = "http://machinelearning.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2014-12-12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://machinelearning.us-east-1.amazonaws.com
