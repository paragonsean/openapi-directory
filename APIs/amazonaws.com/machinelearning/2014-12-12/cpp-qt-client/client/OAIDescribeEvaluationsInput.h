...
/*
 * OAIDescribeEvaluationsInput.h
 *
 * 
 */

#ifndef OAIDescribeEvaluationsInput_H
#define OAIDescribeEvaluationsInput_H
...
class OAIDescribeEvaluationsInput : public OAIObject {
public:
    OAIDescribeEvaluationsInput();
    OAIDescribeEvaluationsInput(QString json);
    ~OAIDescribeEvaluationsInput() override;
    ...
    OAIEvaluationFilterVariable getFilterVariable() const;
    void setFilterVariable(const OAIEvaluationFilterVariable &filter_variable);
...
private:
    ...
    OAIEvaluationFilterVariable m_filter_variable;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEvaluationsInput)

#endif // OAIDescribeEvaluationsInput_H
