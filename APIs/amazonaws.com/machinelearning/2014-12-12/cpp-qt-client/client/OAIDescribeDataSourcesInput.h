...
/*
 * OAIDescribeDataSourcesInput.h
 *
 * 
 */

#ifndef OAIDescribeDataSourcesInput_H
#define OAIDescribeDataSourcesInput_H
...
class OAIDescribeDataSourcesInput : public OAIObject {
public:
    OAIDescribeDataSourcesInput();
    OAIDescribeDataSourcesInput(QString json);
    ~OAIDescribeDataSourcesInput() override;
    ...
    OAIDataSourceFilterVariable getFilterVariable() const;
    void setFilterVariable(const OAIDataSourceFilterVariable &filter_variable);
...
private:
    ...
    OAIDataSourceFilterVariable m_filter_variable;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDataSourcesInput)

#endif // OAIDescribeDataSourcesInput_H
