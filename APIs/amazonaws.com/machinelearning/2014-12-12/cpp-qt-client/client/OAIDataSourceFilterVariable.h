...
#ifndef OAIDataSourceFilterVariable_H
#define OAIDataSourceFilterVariable_H
...
class OAIDataSourceFilterVariable : public OAIEnum {
public:
    OAIDataSourceFilterVariable();
    OAIDataSourceFilterVariable(QString json);
    ~OAIDataSourceFilterVariable() override;
    ...
    enum class eOAIDataSourceFilterVariable {
    ...
    OAIDataSourceFilterVariable::eOAIDataSourceFilterVariable getValue() const;
    void setValue(const OAIDataSourceFilterVariable::eOAIDataSourceFilterVariable& value);
...
private:
    ...
    eOAIDataSourceFilterVariable m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceFilterVariable)

#endif // OAIDataSourceFilterVariable_H
