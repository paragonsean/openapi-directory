...
/*
 * OAIRedshiftDataSpec.h
 *
 * Describes the data specification of an Amazon Redshift &lt;code&gt;DataSource&lt;/code&gt;.
 */

#ifndef OAIRedshiftDataSpec_H
#define OAIRedshiftDataSpec_H
...
class OAIRedshiftDataSpec : public OAIObject {
public:
    OAIRedshiftDataSpec();
    OAIRedshiftDataSpec(QString json);
    ~OAIRedshiftDataSpec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedshiftDataSpec)

#endif // OAIRedshiftDataSpec_H
