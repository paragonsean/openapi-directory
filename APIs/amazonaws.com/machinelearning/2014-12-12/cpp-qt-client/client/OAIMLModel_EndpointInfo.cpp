...
OAIMLModel_EndpointInfo::OAIMLModel_EndpointInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMLModel_EndpointInfo::OAIMLModel_EndpointInfo() {
    this->initializeModel();
}

OAIMLModel_EndpointInfo::~OAIMLModel_EndpointInfo() {}

void OAIMLModel_EndpointInfo::initializeModel() {
...
void OAIMLModel_EndpointInfo::fromJson(QString jsonString) {
...
void OAIMLModel_EndpointInfo::fromJsonObject(QJsonObject json) {
...
QString OAIMLModel_EndpointInfo::asJson() const {
...
QJsonObject OAIMLModel_EndpointInfo::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMLModel_EndpointInfo::getPeakRequestsPerSecond() const {
    return m_peak_requests_per_second;
}
void OAIMLModel_EndpointInfo::setPeakRequestsPerSecond(const qint32 &peak_requests_per_second) {
    m_peak_requests_per_second = peak_requests_per_second;
    m_peak_requests_per_second_isSet = true;
}

bool OAIMLModel_EndpointInfo::is_peak_requests_per_second_Set() const{
    return m_peak_requests_per_second_isSet;
}

bool OAIMLModel_EndpointInfo::is_peak_requests_per_second_Valid() const{
    return m_peak_requests_per_second_isValid;
}

QDateTime OAIMLModel_EndpointInfo::getCreatedAt() const {
    return m_created_at;
}
void OAIMLModel_EndpointInfo::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIMLModel_EndpointInfo::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIMLModel_EndpointInfo::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIMLModel_EndpointInfo::getEndpointUrl() const {
    return m_endpoint_url;
}
void OAIMLModel_EndpointInfo::setEndpointUrl(const QString &endpoint_url) {
    m_endpoint_url = endpoint_url;
    m_endpoint_url_isSet = true;
}

bool OAIMLModel_EndpointInfo::is_endpoint_url_Set() const{
    return m_endpoint_url_isSet;
}

bool OAIMLModel_EndpointInfo::is_endpoint_url_Valid() const{
    return m_endpoint_url_isValid;
}

OAIRealtimeEndpointStatus OAIMLModel_EndpointInfo::getEndpointStatus() const {
    return m_endpoint_status;
}
void OAIMLModel_EndpointInfo::setEndpointStatus(const OAIRealtimeEndpointStatus &endpoint_status) {
    m_endpoint_status = endpoint_status;
    m_endpoint_status_isSet = true;
}

bool OAIMLModel_EndpointInfo::is_endpoint_status_Set() const{
    return m_endpoint_status_isSet;
}

bool OAIMLModel_EndpointInfo::is_endpoint_status_Valid() const{
    return m_endpoint_status_isValid;
}

bool OAIMLModel_EndpointInfo::isSet() const {
...
bool OAIMLModel_EndpointInfo::isValid() const {
