...
#ifndef OAIRDSDataSpec_H
#define OAIRDSDataSpec_H
...
class OAIRDSDataSpec : public OAIObject {
public:
    OAIRDSDataSpec();
    OAIRDSDataSpec(QString json);
    ~OAIRDSDataSpec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRDSDataSpec)

#endif // OAIRDSDataSpec_H
