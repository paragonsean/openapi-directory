...
class OAIGetDataSourceOutput : public OAIObject {
public:
    OAIGetDataSourceOutput();
    OAIGetDataSourceOutput(QString json);
    ~OAIGetDataSourceOutput() override;
    ...
    QString getDataSourceSchema() const;
    void setDataSourceSchema(const QString &data_source_schema);
    bool is_data_source_schema_Set() const;
    bool is_data_source_schema_Valid() const;
...
private:
    ...
    QString m_data_source_schema;
    bool m_data_source_schema_isSet;
    bool m_data_source_schema_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDataSourceOutput)

#endif // OAIGetDataSourceOutput_H
