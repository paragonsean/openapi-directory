...
OAIRedshiftDataSpec::OAIRedshiftDataSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRedshiftDataSpec::OAIRedshiftDataSpec() {
    this->initializeModel();
}

OAIRedshiftDataSpec::~OAIRedshiftDataSpec() {}

void OAIRedshiftDataSpec::initializeModel() {
...
void OAIRedshiftDataSpec::fromJson(QString jsonString) {
...
void OAIRedshiftDataSpec::fromJsonObject(QJsonObject json) {
...
QString OAIRedshiftDataSpec::asJson() const {
...
QJsonObject OAIRedshiftDataSpec::asJsonObject() const {
    QJsonObject obj;
...
OAIRedshiftDataSpec_DatabaseInformation OAIRedshiftDataSpec::getDatabaseInformation() const {
    return m_database_information;
}
void OAIRedshiftDataSpec::setDatabaseInformation(const OAIRedshiftDataSpec_DatabaseInformation &database_information) {
    m_database_information = database_information;
    m_database_information_isSet = true;
}

bool OAIRedshiftDataSpec::is_database_information_Set() const{
    return m_database_information_isSet;
}

bool OAIRedshiftDataSpec::is_database_information_Valid() const{
    return m_database_information_isValid;
}

QString OAIRedshiftDataSpec::getSelectSqlQuery() const {
    return m_select_sql_query;
}
void OAIRedshiftDataSpec::setSelectSqlQuery(const QString &select_sql_query) {
    m_select_sql_query = select_sql_query;
    m_select_sql_query_isSet = true;
}

bool OAIRedshiftDataSpec::is_select_sql_query_Set() const{
    return m_select_sql_query_isSet;
}

bool OAIRedshiftDataSpec::is_select_sql_query_Valid() const{
    return m_select_sql_query_isValid;
}

OAIRedshiftDataSpec_DatabaseCredentials OAIRedshiftDataSpec::getDatabaseCredentials() const {
    return m_database_credentials;
}
void OAIRedshiftDataSpec::setDatabaseCredentials(const OAIRedshiftDataSpec_DatabaseCredentials &database_credentials) {
    m_database_credentials = database_credentials;
    m_database_credentials_isSet = true;
}

bool OAIRedshiftDataSpec::is_database_credentials_Set() const{
    return m_database_credentials_isSet;
}

bool OAIRedshiftDataSpec::is_database_credentials_Valid() const{
    return m_database_credentials_isValid;
}

QString OAIRedshiftDataSpec::getS3StagingLocation() const {
    return m_s3_staging_location;
}
void OAIRedshiftDataSpec::setS3StagingLocation(const QString &s3_staging_location) {
    m_s3_staging_location = s3_staging_location;
    m_s3_staging_location_isSet = true;
}

bool OAIRedshiftDataSpec::is_s3_staging_location_Set() const{
    return m_s3_staging_location_isSet;
}

bool OAIRedshiftDataSpec::is_s3_staging_location_Valid() const{
    return m_s3_staging_location_isValid;
}

QString OAIRedshiftDataSpec::getDataRearrangement() const {
    return m_data_rearrangement;
}
void OAIRedshiftDataSpec::setDataRearrangement(const QString &data_rearrangement) {
    m_data_rearrangement = data_rearrangement;
    m_data_rearrangement_isSet = true;
}

bool OAIRedshiftDataSpec::is_data_rearrangement_Set() const{
    return m_data_rearrangement_isSet;
}

bool OAIRedshiftDataSpec::is_data_rearrangement_Valid() const{
    return m_data_rearrangement_isValid;
}

QString OAIRedshiftDataSpec::getDataSchema() const {
    return m_data_schema;
}
void OAIRedshiftDataSpec::setDataSchema(const QString &data_schema) {
    m_data_schema = data_schema;
    m_data_schema_isSet = true;
}

bool OAIRedshiftDataSpec::is_data_schema_Set() const{
    return m_data_schema_isSet;
}

bool OAIRedshiftDataSpec::is_data_schema_Valid() const{
    return m_data_schema_isValid;
}

QString OAIRedshiftDataSpec::getDataSchemaUri() const {
    return m_data_schema_uri;
}
void OAIRedshiftDataSpec::setDataSchemaUri(const QString &data_schema_uri) {
    m_data_schema_uri = data_schema_uri;
    m_data_schema_uri_isSet = true;
}

bool OAIRedshiftDataSpec::is_data_schema_uri_Set() const{
    return m_data_schema_uri_isSet;
}

bool OAIRedshiftDataSpec::is_data_schema_uri_Valid() const{
    return m_data_schema_uri_isValid;
}

bool OAIRedshiftDataSpec::isSet() const {
...
bool OAIRedshiftDataSpec::isValid() const {
