...
namespace OpenAPI {
class OAIGetEvaluationOutput_PerformanceMetrics;

class OAIGetEvaluationOutput : public OAIObject {
public:
    OAIGetEvaluationOutput();
    OAIGetEvaluationOutput(QString json);
    ~OAIGetEvaluationOutput() override;
    ...
    OAIGetEvaluationOutput_PerformanceMetrics getPerformanceMetrics() const;
    void setPerformanceMetrics(const OAIGetEvaluationOutput_PerformanceMetrics &performance_metrics);
...
private:
    ...
    OAIGetEvaluationOutput_PerformanceMetrics m_performance_metrics;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEvaluationOutput)

#endif // OAIGetEvaluationOutput_H
