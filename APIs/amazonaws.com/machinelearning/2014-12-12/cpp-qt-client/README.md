...
QString Example::create(){
    QString obj;
OAIAddTagsInput Example::create(){
    OAIAddTagsInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      OAIAddTagsInput oai_add_tags_input = create(); // OAIAddTagsInput | 
      ...
      apiInstance.addTags(x_amz_targetoai_add_tags_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
