...
class RedshiftDatabase(Model):
    ...
    def __init__(self, database_name: str=None, cluster_identifier: str=None):
        """RedshiftDatabase - a model defined in OpenAPI

        :param database_name: The database_name of this RedshiftDatabase.
        :param cluster_identifier: The cluster_identifier of this RedshiftDatabase.
        """
        self.openapi_types = {
            'database_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RedshiftDatabase':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RedshiftDatabase of this RedshiftDatabase.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def database_name(self):
        """Gets the database_name of this RedshiftDatabase.

        The name of a database hosted on an Amazon Redshift cluster.

        :return: The database_name of this RedshiftDatabase.
        :rtype: str
        """
    ...
    def database_name(self, database_name):
        """Sets the database_name of this RedshiftDatabase.
    ...
    def cluster_identifier(self):
        """Gets the cluster_identifier of this RedshiftDatabase.

        The ID of an Amazon Redshift cluster.

        :return: The cluster_identifier of this RedshiftDatabase.
        :rtype: str
        """
    ...
    def cluster_identifier(self, cluster_identifier):
        """Sets the cluster_identifier of this RedshiftDatabase.
