...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::acceptInboundCrossClusterSearchConnectionSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::acceptInboundCrossClusterSearchConnectionSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString connection_id = create(); // QString | The id of the inbound connection that you want to accept.
      ...
      apiInstance.acceptInboundCrossClusterSearchConnection(connection_idx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
