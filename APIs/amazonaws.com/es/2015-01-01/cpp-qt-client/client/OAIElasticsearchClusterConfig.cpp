...
#include "OAIElasticsearchClusterConfig.h"
...
OAIElasticsearchClusterConfig::OAIElasticsearchClusterConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIElasticsearchClusterConfig::OAIElasticsearchClusterConfig() {
    this->initializeModel();
}

OAIElasticsearchClusterConfig::~OAIElasticsearchClusterConfig() {}

void OAIElasticsearchClusterConfig::initializeModel() {
...
void OAIElasticsearchClusterConfig::fromJson(QString jsonString) {
...
void OAIElasticsearchClusterConfig::fromJsonObject(QJsonObject json) {
...
QString OAIElasticsearchClusterConfig::asJson() const {
...
QJsonObject OAIElasticsearchClusterConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIESPartitionInstanceType OAIElasticsearchClusterConfig::getInstanceType() const {
    return m_instance_type;
}
void OAIElasticsearchClusterConfig::setInstanceType(const OAIESPartitionInstanceType &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIElasticsearchClusterConfig::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

qint32 OAIElasticsearchClusterConfig::getInstanceCount() const {
    return m_instance_count;
}
void OAIElasticsearchClusterConfig::setInstanceCount(const qint32 &instance_count) {
    m_instance_count = instance_count;
    m_instance_count_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_instance_count_Set() const{
    return m_instance_count_isSet;
}

bool OAIElasticsearchClusterConfig::is_instance_count_Valid() const{
    return m_instance_count_isValid;
}

bool OAIElasticsearchClusterConfig::getDedicatedMasterEnabled() const {
    return m_dedicated_master_enabled;
}
void OAIElasticsearchClusterConfig::setDedicatedMasterEnabled(const bool &dedicated_master_enabled) {
    m_dedicated_master_enabled = dedicated_master_enabled;
    m_dedicated_master_enabled_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_dedicated_master_enabled_Set() const{
    return m_dedicated_master_enabled_isSet;
}

bool OAIElasticsearchClusterConfig::is_dedicated_master_enabled_Valid() const{
    return m_dedicated_master_enabled_isValid;
}

bool OAIElasticsearchClusterConfig::getZoneAwarenessEnabled() const {
    return m_zone_awareness_enabled;
}
void OAIElasticsearchClusterConfig::setZoneAwarenessEnabled(const bool &zone_awareness_enabled) {
    m_zone_awareness_enabled = zone_awareness_enabled;
    m_zone_awareness_enabled_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_zone_awareness_enabled_Set() const{
    return m_zone_awareness_enabled_isSet;
}

bool OAIElasticsearchClusterConfig::is_zone_awareness_enabled_Valid() const{
    return m_zone_awareness_enabled_isValid;
}

OAICreateElasticsearchDomain_request_ElasticsearchClusterConfig_ZoneAwarenessConfig OAIElasticsearchClusterConfig::getZoneAwarenessConfig() const {
    return m_zone_awareness_config;
}
void OAIElasticsearchClusterConfig::setZoneAwarenessConfig(const OAICreateElasticsearchDomain_request_ElasticsearchClusterConfig_ZoneAwarenessConfig &zone_awareness_config) {
    m_zone_awareness_config = zone_awareness_config;
    m_zone_awareness_config_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_zone_awareness_config_Set() const{
    return m_zone_awareness_config_isSet;
}

bool OAIElasticsearchClusterConfig::is_zone_awareness_config_Valid() const{
    return m_zone_awareness_config_isValid;
}

OAIESPartitionInstanceType OAIElasticsearchClusterConfig::getDedicatedMasterType() const {
    return m_dedicated_master_type;
}
void OAIElasticsearchClusterConfig::setDedicatedMasterType(const OAIESPartitionInstanceType &dedicated_master_type) {
    m_dedicated_master_type = dedicated_master_type;
    m_dedicated_master_type_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_dedicated_master_type_Set() const{
    return m_dedicated_master_type_isSet;
}

bool OAIElasticsearchClusterConfig::is_dedicated_master_type_Valid() const{
    return m_dedicated_master_type_isValid;
}

qint32 OAIElasticsearchClusterConfig::getDedicatedMasterCount() const {
    return m_dedicated_master_count;
}
void OAIElasticsearchClusterConfig::setDedicatedMasterCount(const qint32 &dedicated_master_count) {
    m_dedicated_master_count = dedicated_master_count;
    m_dedicated_master_count_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_dedicated_master_count_Set() const{
    return m_dedicated_master_count_isSet;
}

bool OAIElasticsearchClusterConfig::is_dedicated_master_count_Valid() const{
    return m_dedicated_master_count_isValid;
}

bool OAIElasticsearchClusterConfig::getWarmEnabled() const {
    return m_warm_enabled;
}
void OAIElasticsearchClusterConfig::setWarmEnabled(const bool &warm_enabled) {
    m_warm_enabled = warm_enabled;
    m_warm_enabled_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_warm_enabled_Set() const{
    return m_warm_enabled_isSet;
}

bool OAIElasticsearchClusterConfig::is_warm_enabled_Valid() const{
    return m_warm_enabled_isValid;
}

OAIESWarmPartitionInstanceType OAIElasticsearchClusterConfig::getWarmType() const {
    return m_warm_type;
}
void OAIElasticsearchClusterConfig::setWarmType(const OAIESWarmPartitionInstanceType &warm_type) {
    m_warm_type = warm_type;
    m_warm_type_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_warm_type_Set() const{
    return m_warm_type_isSet;
}

bool OAIElasticsearchClusterConfig::is_warm_type_Valid() const{
    return m_warm_type_isValid;
}

qint32 OAIElasticsearchClusterConfig::getWarmCount() const {
    return m_warm_count;
}
void OAIElasticsearchClusterConfig::setWarmCount(const qint32 &warm_count) {
    m_warm_count = warm_count;
    m_warm_count_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_warm_count_Set() const{
    return m_warm_count_isSet;
}

bool OAIElasticsearchClusterConfig::is_warm_count_Valid() const{
    return m_warm_count_isValid;
}

OAICreateElasticsearchDomain_request_ElasticsearchClusterConfig_ColdStorageOptions OAIElasticsearchClusterConfig::getColdStorageOptions() const {
    return m_cold_storage_options;
}
void OAIElasticsearchClusterConfig::setColdStorageOptions(const OAICreateElasticsearchDomain_request_ElasticsearchClusterConfig_ColdStorageOptions &cold_storage_options) {
    m_cold_storage_options = cold_storage_options;
    m_cold_storage_options_isSet = true;
}

bool OAIElasticsearchClusterConfig::is_cold_storage_options_Set() const{
    return m_cold_storage_options_isSet;
}

bool OAIElasticsearchClusterConfig::is_cold_storage_options_Valid() const{
    return m_cold_storage_options_isValid;
}

bool OAIElasticsearchClusterConfig::isSet() const {
...
bool OAIElasticsearchClusterConfig::isValid() const {
