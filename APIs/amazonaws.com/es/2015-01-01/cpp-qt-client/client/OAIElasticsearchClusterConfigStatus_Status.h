...
/*
 * OAIElasticsearchClusterConfigStatus_Status.h
 *
 * 
 */

#ifndef OAIElasticsearchClusterConfigStatus_Status_H
#define OAIElasticsearchClusterConfigStatus_Status_H
...
class OAIElasticsearchClusterConfigStatus_Status : public OAIObject {
public:
    OAIElasticsearchClusterConfigStatus_Status();
    OAIElasticsearchClusterConfigStatus_Status(QString json);
    ~OAIElasticsearchClusterConfigStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchClusterConfigStatus_Status)

#endif // OAIElasticsearchClusterConfigStatus_Status_H
