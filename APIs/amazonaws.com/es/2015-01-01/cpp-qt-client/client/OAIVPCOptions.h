...
#ifndef OAIVPCOptions_H
#define OAIVPCOptions_H
...
class OAIVPCOptions : public OAIObject {
public:
    OAIVPCOptions();
    OAIVPCOptions(QString json);
    ~OAIVPCOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVPCOptions)

#endif // OAIVPCOptions_H
