...
/*
 * OAIPurchaseReservedElasticsearchInstanceOfferingRequest.h
 *
 * Container for parameters to &lt;code&gt;PurchaseReservedElasticsearchInstanceOffering&lt;/code&gt;
 */

#ifndef OAIPurchaseReservedElasticsearchInstanceOfferingRequest_H
#define OAIPurchaseReservedElasticsearchInstanceOfferingRequest_H
...
class OAIPurchaseReservedElasticsearchInstanceOfferingRequest : public OAIObject {
public:
    OAIPurchaseReservedElasticsearchInstanceOfferingRequest();
    OAIPurchaseReservedElasticsearchInstanceOfferingRequest(QString json);
    ~OAIPurchaseReservedElasticsearchInstanceOfferingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseReservedElasticsearchInstanceOfferingRequest)

#endif // OAIPurchaseReservedElasticsearchInstanceOfferingRequest_H
