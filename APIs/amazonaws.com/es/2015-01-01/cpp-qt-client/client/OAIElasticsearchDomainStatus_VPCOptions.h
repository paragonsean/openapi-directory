...
/*
 * OAIElasticsearchDomainStatus_VPCOptions.h
 *
 * 
 */

#ifndef OAIElasticsearchDomainStatus_VPCOptions_H
#define OAIElasticsearchDomainStatus_VPCOptions_H
...
class OAIElasticsearchDomainStatus_VPCOptions : public OAIObject {
public:
    OAIElasticsearchDomainStatus_VPCOptions();
    OAIElasticsearchDomainStatus_VPCOptions(QString json);
    ~OAIElasticsearchDomainStatus_VPCOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchDomainStatus_VPCOptions)

#endif // OAIElasticsearchDomainStatus_VPCOptions_H
