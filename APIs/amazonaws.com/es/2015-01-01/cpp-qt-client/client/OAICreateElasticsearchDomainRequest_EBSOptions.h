...
/*
 * OAICreateElasticsearchDomainRequest_EBSOptions.h
 *
 * 
 */

#ifndef OAICreateElasticsearchDomainRequest_EBSOptions_H
#define OAICreateElasticsearchDomainRequest_EBSOptions_H
...
class OAICreateElasticsearchDomainRequest_EBSOptions : public OAIObject {
public:
    OAICreateElasticsearchDomainRequest_EBSOptions();
    OAICreateElasticsearchDomainRequest_EBSOptions(QString json);
    ~OAICreateElasticsearchDomainRequest_EBSOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateElasticsearchDomainRequest_EBSOptions)

#endif // OAICreateElasticsearchDomainRequest_EBSOptions_H
