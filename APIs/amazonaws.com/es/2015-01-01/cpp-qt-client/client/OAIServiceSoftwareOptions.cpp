...
#include "OAIServiceSoftwareOptions.h"
...
OAIServiceSoftwareOptions::OAIServiceSoftwareOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceSoftwareOptions::OAIServiceSoftwareOptions() {
    this->initializeModel();
}

OAIServiceSoftwareOptions::~OAIServiceSoftwareOptions() {}

void OAIServiceSoftwareOptions::initializeModel() {
...
void OAIServiceSoftwareOptions::fromJson(QString jsonString) {
...
void OAIServiceSoftwareOptions::fromJsonObject(QJsonObject json) {
...
QString OAIServiceSoftwareOptions::asJson() const {
...
QJsonObject OAIServiceSoftwareOptions::asJsonObject() const {
    QJsonObject obj;
...
QString OAIServiceSoftwareOptions::getCurrentVersion() const {
    return m_current_version;
}
void OAIServiceSoftwareOptions::setCurrentVersion(const QString &current_version) {
    m_current_version = current_version;
    m_current_version_isSet = true;
}

bool OAIServiceSoftwareOptions::is_current_version_Set() const{
    return m_current_version_isSet;
}

bool OAIServiceSoftwareOptions::is_current_version_Valid() const{
    return m_current_version_isValid;
}

QString OAIServiceSoftwareOptions::getNewVersion() const {
    return m_new_version;
}
void OAIServiceSoftwareOptions::setNewVersion(const QString &new_version) {
    m_new_version = new_version;
    m_new_version_isSet = true;
}

bool OAIServiceSoftwareOptions::is_new_version_Set() const{
    return m_new_version_isSet;
}

bool OAIServiceSoftwareOptions::is_new_version_Valid() const{
    return m_new_version_isValid;
}

bool OAIServiceSoftwareOptions::getUpdateAvailable() const {
    return m_update_available;
}
void OAIServiceSoftwareOptions::setUpdateAvailable(const bool &update_available) {
    m_update_available = update_available;
    m_update_available_isSet = true;
}

bool OAIServiceSoftwareOptions::is_update_available_Set() const{
    return m_update_available_isSet;
}

bool OAIServiceSoftwareOptions::is_update_available_Valid() const{
    return m_update_available_isValid;
}

bool OAIServiceSoftwareOptions::getCancellable() const {
    return m_cancellable;
}
void OAIServiceSoftwareOptions::setCancellable(const bool &cancellable) {
    m_cancellable = cancellable;
    m_cancellable_isSet = true;
}

bool OAIServiceSoftwareOptions::is_cancellable_Set() const{
    return m_cancellable_isSet;
}

bool OAIServiceSoftwareOptions::is_cancellable_Valid() const{
    return m_cancellable_isValid;
}

OAIDeploymentStatus OAIServiceSoftwareOptions::getUpdateStatus() const {
    return m_update_status;
}
void OAIServiceSoftwareOptions::setUpdateStatus(const OAIDeploymentStatus &update_status) {
    m_update_status = update_status;
    m_update_status_isSet = true;
}

bool OAIServiceSoftwareOptions::is_update_status_Set() const{
    return m_update_status_isSet;
}

bool OAIServiceSoftwareOptions::is_update_status_Valid() const{
    return m_update_status_isValid;
}

QString OAIServiceSoftwareOptions::getDescription() const {
    return m_description;
}
void OAIServiceSoftwareOptions::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIServiceSoftwareOptions::is_description_Set() const{
    return m_description_isSet;
}

bool OAIServiceSoftwareOptions::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIServiceSoftwareOptions::getAutomatedUpdateDate() const {
    return m_automated_update_date;
}
void OAIServiceSoftwareOptions::setAutomatedUpdateDate(const QDateTime &automated_update_date) {
    m_automated_update_date = automated_update_date;
    m_automated_update_date_isSet = true;
}

bool OAIServiceSoftwareOptions::is_automated_update_date_Set() const{
    return m_automated_update_date_isSet;
}

bool OAIServiceSoftwareOptions::is_automated_update_date_Valid() const{
    return m_automated_update_date_isValid;
}

bool OAIServiceSoftwareOptions::getOptionalDeployment() const {
    return m_optional_deployment;
}
void OAIServiceSoftwareOptions::setOptionalDeployment(const bool &optional_deployment) {
    m_optional_deployment = optional_deployment;
    m_optional_deployment_isSet = true;
}

bool OAIServiceSoftwareOptions::is_optional_deployment_Set() const{
    return m_optional_deployment_isSet;
}

bool OAIServiceSoftwareOptions::is_optional_deployment_Valid() const{
    return m_optional_deployment_isValid;
}

bool OAIServiceSoftwareOptions::isSet() const {
...
bool OAIServiceSoftwareOptions::isValid() const {
