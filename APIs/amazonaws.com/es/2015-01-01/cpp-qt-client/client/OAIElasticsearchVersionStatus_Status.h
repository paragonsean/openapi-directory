...
/*
 * OAIElasticsearchVersionStatus_Status.h
 *
 * 
 */

#ifndef OAIElasticsearchVersionStatus_Status_H
#define OAIElasticsearchVersionStatus_Status_H
...
class OAIElasticsearchVersionStatus_Status : public OAIObject {
public:
    OAIElasticsearchVersionStatus_Status();
    OAIElasticsearchVersionStatus_Status(QString json);
    ~OAIElasticsearchVersionStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchVersionStatus_Status)

#endif // OAIElasticsearchVersionStatus_Status_H
