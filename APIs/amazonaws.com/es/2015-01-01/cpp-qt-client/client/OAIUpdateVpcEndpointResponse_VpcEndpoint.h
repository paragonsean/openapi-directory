...
/*
 * OAIUpdateVpcEndpointResponse_VpcEndpoint.h
 *
 * 
 */

#ifndef OAIUpdateVpcEndpointResponse_VpcEndpoint_H
#define OAIUpdateVpcEndpointResponse_VpcEndpoint_H
...
class OAIUpdateVpcEndpointResponse_VpcEndpoint : public OAIObject {
public:
    OAIUpdateVpcEndpointResponse_VpcEndpoint();
    OAIUpdateVpcEndpointResponse_VpcEndpoint(QString json);
    ~OAIUpdateVpcEndpointResponse_VpcEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVpcEndpointResponse_VpcEndpoint)

#endif // OAIUpdateVpcEndpointResponse_VpcEndpoint_H
