...
/*
 * OAIElasticsearchDomainStatus_EBSOptions.h
 *
 * 
 */

#ifndef OAIElasticsearchDomainStatus_EBSOptions_H
#define OAIElasticsearchDomainStatus_EBSOptions_H
...
class OAIElasticsearchDomainStatus_EBSOptions : public OAIObject {
public:
    OAIElasticsearchDomainStatus_EBSOptions();
    OAIElasticsearchDomainStatus_EBSOptions(QString json);
    ~OAIElasticsearchDomainStatus_EBSOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchDomainStatus_EBSOptions)

#endif // OAIElasticsearchDomainStatus_EBSOptions_H
