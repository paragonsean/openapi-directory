...
OAICreateElasticsearchDomain_request_AdvancedSecurityOptions_MasterUserOptions OAIAdvancedSecurityOptionsInput::getMasterUserOptions() const {
    return m_master_user_options;
}
void OAIAdvancedSecurityOptionsInput::setMasterUserOptions(const OAICreateElasticsearchDomain_request_AdvancedSecurityOptions_MasterUserOptions &master_user_options) {
...
OAICreateElasticsearchDomain_request_AdvancedSecurityOptions_SAMLOptions OAIAdvancedSecurityOptionsInput::getSamlOptions() const {
    return m_saml_options;
}
void OAIAdvancedSecurityOptionsInput::setSamlOptions(const OAICreateElasticsearchDomain_request_AdvancedSecurityOptions_SAMLOptions &saml_options) {
