...
/*
 * OAIAdvancedSecurityOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAIAdvancedSecurityOptionsStatus_Status_H
#define OAIAdvancedSecurityOptionsStatus_Status_H
...
class OAIAdvancedSecurityOptionsStatus_Status : public OAIObject {
public:
    OAIAdvancedSecurityOptionsStatus_Status();
    OAIAdvancedSecurityOptionsStatus_Status(QString json);
    ~OAIAdvancedSecurityOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedSecurityOptionsStatus_Status)

#endif // OAIAdvancedSecurityOptionsStatus_Status_H
