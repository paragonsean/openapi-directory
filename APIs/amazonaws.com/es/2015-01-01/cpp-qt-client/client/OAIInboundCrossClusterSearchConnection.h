...
/*
 * OAIInboundCrossClusterSearchConnection.h
 *
 * Specifies details of an inbound connection.
 */

#ifndef OAIInboundCrossClusterSearchConnection_H
#define OAIInboundCrossClusterSearchConnection_H
...
class OAIInboundCrossClusterSearchConnection : public OAIObject {
public:
    OAIInboundCrossClusterSearchConnection();
    OAIInboundCrossClusterSearchConnection(QString json);
    ~OAIInboundCrossClusterSearchConnection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInboundCrossClusterSearchConnection)

#endif // OAIInboundCrossClusterSearchConnection_H
