...
OAIDeletePackageResponse_PackageDetails::OAIDeletePackageResponse_PackageDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePackageResponse_PackageDetails::OAIDeletePackageResponse_PackageDetails() {
    this->initializeModel();
}

OAIDeletePackageResponse_PackageDetails::~OAIDeletePackageResponse_PackageDetails() {}

void OAIDeletePackageResponse_PackageDetails::initializeModel() {
...
void OAIDeletePackageResponse_PackageDetails::fromJson(QString jsonString) {
...
void OAIDeletePackageResponse_PackageDetails::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePackageResponse_PackageDetails::asJson() const {
...
QJsonObject OAIDeletePackageResponse_PackageDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeletePackageResponse_PackageDetails::getPackageId() const {
    return m_package_id;
}
void OAIDeletePackageResponse_PackageDetails::setPackageId(const QString &package_id) {
    m_package_id = package_id;
    m_package_id_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_id_Set() const{
    return m_package_id_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_id_Valid() const{
    return m_package_id_isValid;
}

QString OAIDeletePackageResponse_PackageDetails::getPackageName() const {
    return m_package_name;
}
void OAIDeletePackageResponse_PackageDetails::setPackageName(const QString &package_name) {
    m_package_name = package_name;
    m_package_name_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_name_Set() const{
    return m_package_name_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_name_Valid() const{
    return m_package_name_isValid;
}

OAIPackageType OAIDeletePackageResponse_PackageDetails::getPackageType() const {
    return m_package_type;
}
void OAIDeletePackageResponse_PackageDetails::setPackageType(const OAIPackageType &package_type) {
    m_package_type = package_type;
    m_package_type_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_type_Set() const{
    return m_package_type_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_type_Valid() const{
    return m_package_type_isValid;
}

QString OAIDeletePackageResponse_PackageDetails::getPackageDescription() const {
    return m_package_description;
}
void OAIDeletePackageResponse_PackageDetails::setPackageDescription(const QString &package_description) {
    m_package_description = package_description;
    m_package_description_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_description_Set() const{
    return m_package_description_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_description_Valid() const{
    return m_package_description_isValid;
}

OAIPackageStatus OAIDeletePackageResponse_PackageDetails::getPackageStatus() const {
    return m_package_status;
}
void OAIDeletePackageResponse_PackageDetails::setPackageStatus(const OAIPackageStatus &package_status) {
    m_package_status = package_status;
    m_package_status_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_status_Set() const{
    return m_package_status_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_package_status_Valid() const{
    return m_package_status_isValid;
}

QDateTime OAIDeletePackageResponse_PackageDetails::getCreatedAt() const {
    return m_created_at;
}
void OAIDeletePackageResponse_PackageDetails::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIDeletePackageResponse_PackageDetails::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIDeletePackageResponse_PackageDetails::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

QString OAIDeletePackageResponse_PackageDetails::getAvailablePackageVersion() const {
    return m_available_package_version;
}
void OAIDeletePackageResponse_PackageDetails::setAvailablePackageVersion(const QString &available_package_version) {
    m_available_package_version = available_package_version;
    m_available_package_version_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_available_package_version_Set() const{
    return m_available_package_version_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_available_package_version_Valid() const{
    return m_available_package_version_isValid;
}

OAIDomainPackageDetails_ErrorDetails OAIDeletePackageResponse_PackageDetails::getErrorDetails() const {
    return m_error_details;
}
void OAIDeletePackageResponse_PackageDetails::setErrorDetails(const OAIDomainPackageDetails_ErrorDetails &error_details) {
    m_error_details = error_details;
    m_error_details_isSet = true;
}

bool OAIDeletePackageResponse_PackageDetails::is_error_details_Set() const{
    return m_error_details_isSet;
}

bool OAIDeletePackageResponse_PackageDetails::is_error_details_Valid() const{
    return m_error_details_isValid;
}

bool OAIDeletePackageResponse_PackageDetails::isSet() const {
...
bool OAIDeletePackageResponse_PackageDetails::isValid() const {
