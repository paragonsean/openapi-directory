...
/*
 * OAIElasticsearchClusterConfigStatus_Options.h
 *
 * 
 */

#ifndef OAIElasticsearchClusterConfigStatus_Options_H
#define OAIElasticsearchClusterConfigStatus_Options_H
...
class OAIElasticsearchClusterConfigStatus_Options : public OAIObject {
public:
    OAIElasticsearchClusterConfigStatus_Options();
    OAIElasticsearchClusterConfigStatus_Options(QString json);
    ~OAIElasticsearchClusterConfigStatus_Options() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchClusterConfigStatus_Options)

#endif // OAIElasticsearchClusterConfigStatus_Options_H
