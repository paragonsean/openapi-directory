...
/*
 * OAICreateOutboundCrossClusterSearchConnectionResponse.h
 *
...
#ifndef OAICreateOutboundCrossClusterSearchConnectionResponse_H
#define OAICreateOutboundCrossClusterSearchConnectionResponse_H
...
class OAICreateOutboundCrossClusterSearchConnectionResponse_ConnectionStatus;

class OAICreateOutboundCrossClusterSearchConnectionResponse : public OAIObject {
public:
    OAICreateOutboundCrossClusterSearchConnectionResponse();
    OAICreateOutboundCrossClusterSearchConnectionResponse(QString json);
    ~OAICreateOutboundCrossClusterSearchConnectionResponse() override;
    ...
    OAICreateOutboundCrossClusterSearchConnectionResponse_ConnectionStatus getConnectionStatus() const;
    void setConnectionStatus(const OAICreateOutboundCrossClusterSearchConnectionResponse_ConnectionStatus &connection_status);
...
private:
    ...
    OAICreateOutboundCrossClusterSearchConnectionResponse_ConnectionStatus m_connection_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOutboundCrossClusterSearchConnectionResponse)

#endif // OAICreateOutboundCrossClusterSearchConnectionResponse_H
