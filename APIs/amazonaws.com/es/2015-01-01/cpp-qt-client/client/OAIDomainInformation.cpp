...
QString OAIDomainInformation::getOwnerId() const {
    return m_owner_id;
}
void OAIDomainInformation::setOwnerId(const QString &owner_id) {
    m_owner_id = owner_id;
    m_owner_id_isSet = true;
}

bool OAIDomainInformation::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAIDomainInformation::is_owner_id_Valid() const{
    return m_owner_id_isValid;
}

QString OAIDomainInformation::getDomainName() const {
    return m_domain_name;
}
void OAIDomainInformation::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIDomainInformation::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIDomainInformation::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIDomainInformation::getRegion() const {
    return m_region;
}
void OAIDomainInformation::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDomainInformation::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDomainInformation::is_region_Valid() const{
