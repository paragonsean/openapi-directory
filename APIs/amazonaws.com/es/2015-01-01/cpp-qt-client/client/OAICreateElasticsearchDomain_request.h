...
/*
 * OAICreateElasticsearchDomain_request.h
 *
 * 
 */

#ifndef OAICreateElasticsearchDomain_request_H
#define OAICreateElasticsearchDomain_request_H
...
class OAICreateElasticsearchDomain_request_AutoTuneOptions;
class OAITag;

class OAICreateElasticsearchDomain_request : public OAIObject {
public:
    OAICreateElasticsearchDomain_request();
    OAICreateElasticsearchDomain_request(QString json);
    ~OAICreateElasticsearchDomain_request() override;
    ...
    OAICreateElasticsearchDomain_request_AutoTuneOptions getAutoTuneOptions() const;
    void setAutoTuneOptions(const OAICreateElasticsearchDomain_request_AutoTuneOptions &auto_tune_options);
...
private:
    ...
    OAICreateElasticsearchDomain_request_AutoTuneOptions m_auto_tune_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateElasticsearchDomain_request)

#endif // OAICreateElasticsearchDomain_request_H
