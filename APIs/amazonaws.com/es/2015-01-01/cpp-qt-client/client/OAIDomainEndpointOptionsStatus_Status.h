...
/*
 * OAIDomainEndpointOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAIDomainEndpointOptionsStatus_Status_H
#define OAIDomainEndpointOptionsStatus_Status_H
...
class OAIDomainEndpointOptionsStatus_Status : public OAIObject {
public:
    OAIDomainEndpointOptionsStatus_Status();
    OAIDomainEndpointOptionsStatus_Status(QString json);
    ~OAIDomainEndpointOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainEndpointOptionsStatus_Status)

#endif // OAIDomainEndpointOptionsStatus_Status_H
