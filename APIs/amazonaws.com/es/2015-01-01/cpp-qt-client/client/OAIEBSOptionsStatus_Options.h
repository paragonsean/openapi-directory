...
/*
 * OAIEBSOptionsStatus_Options.h
 *
 * 
 */

#ifndef OAIEBSOptionsStatus_Options_H
#define OAIEBSOptionsStatus_Options_H
...
class OAIEBSOptionsStatus_Options : public OAIObject {
public:
    OAIEBSOptionsStatus_Options();
    OAIEBSOptionsStatus_Options(QString json);
    ~OAIEBSOptionsStatus_Options() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEBSOptionsStatus_Options)

#endif // OAIEBSOptionsStatus_Options_H
