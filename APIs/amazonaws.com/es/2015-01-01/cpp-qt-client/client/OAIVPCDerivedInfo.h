...
#ifndef OAIVPCDerivedInfo_H
#define OAIVPCDerivedInfo_H
...
class OAIVPCDerivedInfo : public OAIObject {
public:
    OAIVPCDerivedInfo();
    OAIVPCDerivedInfo(QString json);
    ~OAIVPCDerivedInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVPCDerivedInfo)

#endif // OAIVPCDerivedInfo_H
