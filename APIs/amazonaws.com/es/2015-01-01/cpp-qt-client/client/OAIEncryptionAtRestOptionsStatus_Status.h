...
/*
 * OAIEncryptionAtRestOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAIEncryptionAtRestOptionsStatus_Status_H
#define OAIEncryptionAtRestOptionsStatus_Status_H
...
class OAIEncryptionAtRestOptionsStatus_Status : public OAIObject {
public:
    OAIEncryptionAtRestOptionsStatus_Status();
    OAIEncryptionAtRestOptionsStatus_Status(QString json);
    ~OAIEncryptionAtRestOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncryptionAtRestOptionsStatus_Status)

#endif // OAIEncryptionAtRestOptionsStatus_Status_H
