...
#ifndef OAIPackageDetails_H
#define OAIPackageDetails_H
...
class OAIPackageDetails : public OAIObject {
public:
    OAIPackageDetails();
    OAIPackageDetails(QString json);
    ~OAIPackageDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageDetails)

#endif // OAIPackageDetails_H
