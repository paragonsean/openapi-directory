...
/*
 * OAIAssociatePackageResponse_DomainPackageDetails.h
 *
 * 
 */

#ifndef OAIAssociatePackageResponse_DomainPackageDetails_H
#define OAIAssociatePackageResponse_DomainPackageDetails_H
...
class OAIAssociatePackageResponse_DomainPackageDetails : public OAIObject {
public:
    OAIAssociatePackageResponse_DomainPackageDetails();
    OAIAssociatePackageResponse_DomainPackageDetails(QString json);
    ~OAIAssociatePackageResponse_DomainPackageDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociatePackageResponse_DomainPackageDetails)

#endif // OAIAssociatePackageResponse_DomainPackageDetails_H
