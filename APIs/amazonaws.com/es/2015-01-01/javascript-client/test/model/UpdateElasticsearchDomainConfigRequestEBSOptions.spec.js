...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.UpdateElasticsearchDomainConfigRequestEBSOptions();
  });
  ...
  describe('UpdateElasticsearchDomainConfigRequestEBSOptions', function() {
    it('should create an instance of UpdateElasticsearchDomainConfigRequestEBSOptions', function() {
      // uncomment below and update the code to test UpdateElasticsearchDomainConfigRequestEBSOptions
      //var instance = new AmazonElasticsearchService.UpdateElasticsearchDomainConfigRequestEBSOptions();
      //expect(instance).to.be.a(AmazonElasticsearchService.UpdateElasticsearchDomainConfigRequestEBSOptions);
    });
