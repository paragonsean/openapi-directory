...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.EBSOptions();
  });
  ...
  describe('EBSOptions', function() {
    it('should create an instance of EBSOptions', function() {
      // uncomment below and update the code to test EBSOptions
      //var instance = new AmazonElasticsearchService.EBSOptions();
      //expect(instance).to.be.a(AmazonElasticsearchService.EBSOptions);
    });
