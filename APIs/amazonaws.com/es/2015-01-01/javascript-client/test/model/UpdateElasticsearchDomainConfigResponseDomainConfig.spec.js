...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.UpdateElasticsearchDomainConfigResponseDomainConfig();
  });
  ...
  describe('UpdateElasticsearchDomainConfigResponseDomainConfig', function() {
    it('should create an instance of UpdateElasticsearchDomainConfigResponseDomainConfig', function() {
      // uncomment below and update the code to test UpdateElasticsearchDomainConfigResponseDomainConfig
      //var instance = new AmazonElasticsearchService.UpdateElasticsearchDomainConfigResponseDomainConfig();
      //expect(instance).to.be.a(AmazonElasticsearchService.UpdateElasticsearchDomainConfigResponseDomainConfig);
    });
