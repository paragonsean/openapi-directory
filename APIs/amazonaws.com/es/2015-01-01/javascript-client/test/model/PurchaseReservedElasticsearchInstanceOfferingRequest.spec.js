...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.PurchaseReservedElasticsearchInstanceOfferingRequest();
  });
  ...
  describe('PurchaseReservedElasticsearchInstanceOfferingRequest', function() {
    it('should create an instance of PurchaseReservedElasticsearchInstanceOfferingRequest', function() {
      // uncomment below and update the code to test PurchaseReservedElasticsearchInstanceOfferingRequest
      //var instance = new AmazonElasticsearchService.PurchaseReservedElasticsearchInstanceOfferingRequest();
      //expect(instance).to.be.a(AmazonElasticsearchService.PurchaseReservedElasticsearchInstanceOfferingRequest);
    });
