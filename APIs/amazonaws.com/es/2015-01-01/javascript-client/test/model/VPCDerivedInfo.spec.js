...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.VPCDerivedInfo();
  });
  ...
  describe('VPCDerivedInfo', function() {
    it('should create an instance of VPCDerivedInfo', function() {
      ...
      //var instance = new AmazonElasticsearchService.VPCDerivedInfo();
      //expect(instance).to.be.a(AmazonElasticsearchService.VPCDerivedInfo);
    });
