...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.DescribeElasticsearchDomainConfigResponseDomainConfig();
  });
  ...
  describe('DescribeElasticsearchDomainConfigResponseDomainConfig', function() {
    it('should create an instance of DescribeElasticsearchDomainConfigResponseDomainConfig', function() {
      // uncomment below and update the code to test DescribeElasticsearchDomainConfigResponseDomainConfig
      //var instance = new AmazonElasticsearchService.DescribeElasticsearchDomainConfigResponseDomainConfig();
      //expect(instance).to.be.a(AmazonElasticsearchService.DescribeElasticsearchDomainConfigResponseDomainConfig);
    });
