...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.Filter();
  });
  ...
  describe('Filter', function() {
    it('should create an instance of Filter', function() {
      ...
      //var instance = new AmazonElasticsearchService.Filter();
      //expect(instance).to.be.a(AmazonElasticsearchService.Filter);
    });
