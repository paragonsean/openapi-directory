...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.ElasticsearchDomainStatusEBSOptions();
  });
  ...
  describe('ElasticsearchDomainStatusEBSOptions', function() {
    it('should create an instance of ElasticsearchDomainStatusEBSOptions', function() {
      // uncomment below and update the code to test ElasticsearchDomainStatusEBSOptions
      //var instance = new AmazonElasticsearchService.ElasticsearchDomainStatusEBSOptions();
      //expect(instance).to.be.a(AmazonElasticsearchService.ElasticsearchDomainStatusEBSOptions);
    });
