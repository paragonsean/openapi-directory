...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.DescribeElasticsearchDomainResponseDomainStatus();
  });
  ...
  describe('DescribeElasticsearchDomainResponseDomainStatus', function() {
    it('should create an instance of DescribeElasticsearchDomainResponseDomainStatus', function() {
      // uncomment below and update the code to test DescribeElasticsearchDomainResponseDomainStatus
      //var instance = new AmazonElasticsearchService.DescribeElasticsearchDomainResponseDomainStatus();
      //expect(instance).to.be.a(AmazonElasticsearchService.DescribeElasticsearchDomainResponseDomainStatus);
    });
