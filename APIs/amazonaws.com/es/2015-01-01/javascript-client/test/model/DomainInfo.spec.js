...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.DomainInfo();
  });
  ...
  describe('DomainInfo', function() {
    it('should create an instance of DomainInfo', function() {
      // uncomment below and update the code to test DomainInfo
      //var instance = new AmazonElasticsearchService.DomainInfo();
      //expect(instance).to.be.a(AmazonElasticsearchService.DomainInfo);
    });
