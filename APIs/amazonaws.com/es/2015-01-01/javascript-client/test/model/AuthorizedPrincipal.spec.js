...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.AuthorizedPrincipal();
  });
  ...
  describe('AuthorizedPrincipal', function() {
    it('should create an instance of AuthorizedPrincipal', function() {
      // uncomment below and update the code to test AuthorizedPrincipal
      //var instance = new AmazonElasticsearchService.AuthorizedPrincipal();
      //expect(instance).to.be.a(AmazonElasticsearchService.AuthorizedPrincipal);
    });
