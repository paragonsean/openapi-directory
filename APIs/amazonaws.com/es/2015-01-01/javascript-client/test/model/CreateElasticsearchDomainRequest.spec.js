...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.CreateElasticsearchDomainRequest();
  });
  ...
  describe('CreateElasticsearchDomainRequest', function() {
    it('should create an instance of CreateElasticsearchDomainRequest', function() {
      // uncomment below and update the code to test CreateElasticsearchDomainRequest
      //var instance = new AmazonElasticsearchService.CreateElasticsearchDomainRequest();
      //expect(instance).to.be.a(AmazonElasticsearchService.CreateElasticsearchDomainRequest);
    });
