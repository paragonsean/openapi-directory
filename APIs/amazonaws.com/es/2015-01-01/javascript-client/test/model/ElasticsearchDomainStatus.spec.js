...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.ElasticsearchDomainStatus();
  });
  ...
  describe('ElasticsearchDomainStatus', function() {
    it('should create an instance of ElasticsearchDomainStatus', function() {
      // uncomment below and update the code to test ElasticsearchDomainStatus
      //var instance = new AmazonElasticsearchService.ElasticsearchDomainStatus();
      //expect(instance).to.be.a(AmazonElasticsearchService.ElasticsearchDomainStatus);
    });
