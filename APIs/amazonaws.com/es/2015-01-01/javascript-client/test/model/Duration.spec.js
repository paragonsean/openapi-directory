...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.Duration();
  });
  ...
  describe('Duration', function() {
    it('should create an instance of Duration', function() {
      ...
      //var instance = new AmazonElasticsearchService.Duration();
      //expect(instance).to.be.a(AmazonElasticsearchService.Duration);
    });
