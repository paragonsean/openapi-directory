...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.CreateElasticsearchDomainResponseDomainStatus();
  });
  ...
  describe('CreateElasticsearchDomainResponseDomainStatus', function() {
    it('should create an instance of CreateElasticsearchDomainResponseDomainStatus', function() {
      // uncomment below and update the code to test CreateElasticsearchDomainResponseDomainStatus
      //var instance = new AmazonElasticsearchService.CreateElasticsearchDomainResponseDomainStatus();
      //expect(instance).to.be.a(AmazonElasticsearchService.CreateElasticsearchDomainResponseDomainStatus);
    });
