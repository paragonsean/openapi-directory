...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.ElasticsearchDomainStatusVPCOptions();
  });
  ...
  describe('ElasticsearchDomainStatusVPCOptions', function() {
    it('should create an instance of ElasticsearchDomainStatusVPCOptions', function() {
      // uncomment below and update the code to test ElasticsearchDomainStatusVPCOptions
      //var instance = new AmazonElasticsearchService.ElasticsearchDomainStatusVPCOptions();
      //expect(instance).to.be.a(AmazonElasticsearchService.ElasticsearchDomainStatusVPCOptions);
    });
