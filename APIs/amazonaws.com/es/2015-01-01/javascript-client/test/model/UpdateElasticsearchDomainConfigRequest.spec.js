...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.UpdateElasticsearchDomainConfigRequest();
  });
  ...
  describe('UpdateElasticsearchDomainConfigRequest', function() {
    it('should create an instance of UpdateElasticsearchDomainConfigRequest', function() {
      // uncomment below and update the code to test UpdateElasticsearchDomainConfigRequest
      //var instance = new AmazonElasticsearchService.UpdateElasticsearchDomainConfigRequest();
      //expect(instance).to.be.a(AmazonElasticsearchService.UpdateElasticsearchDomainConfigRequest);
    });
