...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticsearchService.EBSOptionsStatusOptions();
  });
  ...
  describe('EBSOptionsStatusOptions', function() {
    it('should create an instance of EBSOptionsStatusOptions', function() {
      // uncomment below and update the code to test EBSOptionsStatusOptions
      //var instance = new AmazonElasticsearchService.EBSOptionsStatusOptions();
      //expect(instance).to.be.a(AmazonElasticsearchService.EBSOptionsStatusOptions);
    });
