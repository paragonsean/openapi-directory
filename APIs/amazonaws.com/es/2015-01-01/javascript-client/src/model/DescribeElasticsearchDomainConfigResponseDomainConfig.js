...
/**
 * The DescribeElasticsearchDomainConfigResponseDomainConfig model module.
 * @module model/DescribeElasticsearchDomainConfigResponseDomainConfig
 * @version 2015-01-01
 */
class DescribeElasticsearchDomainConfigResponseDomainConfig {
    /**
     * Constructs a new <code>DescribeElasticsearchDomainConfigResponseDomainConfig</code>.
     * @alias module:model/DescribeElasticsearchDomainConfigResponseDomainConfig
     * @implements module:model/ElasticsearchDomainConfig
     */
    constructor() { 
        ElasticsearchDomainConfig.initialize(this);
        DescribeElasticsearchDomainConfigResponseDomainConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeElasticsearchDomainConfigResponseDomainConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeElasticsearchDomainConfigResponseDomainConfig} obj Optional instance to populate.
     * @return {module:model/DescribeElasticsearchDomainConfigResponseDomainConfig} The populated <code>DescribeElasticsearchDomainConfigResponseDomainConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeElasticsearchDomainConfigResponseDomainConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeElasticsearchDomainConfigResponseDomainConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeElasticsearchDomainConfigResponseDomainConfig</code>.
     */
 ...
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['ElasticsearchVersion'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigElasticsearchClusterConfig} ElasticsearchClusterConfig
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['ElasticsearchClusterConfig'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigEBSOptions} EBSOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['EBSOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigAccessPolicies} AccessPolicies
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['AccessPolicies'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigSnapshotOptions} SnapshotOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['SnapshotOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigVPCOptions} VPCOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['VPCOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigCognitoOptions} CognitoOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['CognitoOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigEncryptionAtRestOptions} EncryptionAtRestOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['EncryptionAtRestOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigNodeToNodeEncryptionOptions} NodeToNodeEncryptionOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['NodeToNodeEncryptionOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigAdvancedOptions} AdvancedOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['AdvancedOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigLogPublishingOptions} LogPublishingOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['LogPublishingOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigDomainEndpointOptions} DomainEndpointOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['DomainEndpointOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigAdvancedSecurityOptions} AdvancedSecurityOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['AdvancedSecurityOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainConfigAutoTuneOptions} AutoTuneOptions
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['AutoTuneOptions'] = undefined;

/**
 * @member {module:model/ElasticsearchDomainStatusChangeProgressDetails} ChangeProgressDetails
 */
DescribeElasticsearchDomainConfigResponseDomainConfig.prototype['ChangeProgressDetails'] = undefined;
...
export default DescribeElasticsearchDomainConfigResponseDomainConfig;
