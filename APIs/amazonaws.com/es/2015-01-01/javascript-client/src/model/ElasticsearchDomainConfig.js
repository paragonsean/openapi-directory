...
/**
 * The ElasticsearchDomainConfig model module.
 * @module model/ElasticsearchDomainConfig
 * @version 2015-01-01
 */
class ElasticsearchDomainConfig {
    /**
     * Constructs a new <code>ElasticsearchDomainConfig</code>.
     * The configuration of an Elasticsearch domain.
     * @alias module:model/ElasticsearchDomainConfig
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ElasticsearchDomainConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ElasticsearchDomainConfig} obj Optional instance to populate.
     * @return {module:model/ElasticsearchDomainConfig} The populated <code>ElasticsearchDomainConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ElasticsearchDomainConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>ElasticsearchDomainConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ElasticsearchDomainConfig</code>.
     */
...
export default ElasticsearchDomainConfig;
