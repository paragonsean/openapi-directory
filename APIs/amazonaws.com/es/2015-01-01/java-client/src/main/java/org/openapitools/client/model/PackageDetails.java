...
public class PackageDetails {
  ...
  public PackageDetails packageID(String packageID) {
  ...
  public PackageDetails packageName(String packageName) {
  ...
  public PackageDetails packageType(PackageType packageType) {
  ...
  public PackageDetails packageDescription(String packageDescription) {
  ...
  public PackageDetails packageStatus(PackageStatus packageStatus) {
  ...
  public PackageDetails createdAt(OffsetDateTime createdAt) {
  ...
  public PackageDetails lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public PackageDetails availablePackageVersion(String availablePackageVersion) {
  ...
  public PackageDetails errorDetails(DomainPackageDetailsErrorDetails errorDetails) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.packageID, packageDetails.packageID) &&
        Objects.equals(this.packageName, packageDetails.packageName) &&
        Objects.equals(this.packageType, packageDetails.packageType) &&
        Objects.equals(this.packageDescription, packageDetails.packageDescription) &&
        Objects.equals(this.packageStatus, packageDetails.packageStatus) &&
        Objects.equals(this.createdAt, packageDetails.createdAt) &&
        Objects.equals(this.lastUpdatedAt, packageDetails.lastUpdatedAt) &&
        Objects.equals(this.availablePackageVersion, packageDetails.availablePackageVersion) &&
        Objects.equals(this.errorDetails, packageDetails.errorDetails);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageDetails is not found in the empty JSON string", PackageDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PackageDetails>() {
           @Override
