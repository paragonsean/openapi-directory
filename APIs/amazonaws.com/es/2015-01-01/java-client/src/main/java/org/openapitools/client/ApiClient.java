...
public class ApiClient {
    ...
    private String basePath = "http://es.us-east-1.amazonaws.com";
    ...
    new ServerConfiguration(
      "http://es.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://es.{region}.amazonaws.com.cn",
      "The Amazon Elasticsearch Service endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2015-01-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://es.us-east-1.amazonaws.com
