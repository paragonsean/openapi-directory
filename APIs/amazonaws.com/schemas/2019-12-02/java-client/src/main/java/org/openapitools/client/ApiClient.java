...
public class ApiClient {
    ...
    private String basePath = "http://schemas.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://schemas.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://schemas.{region}.amazonaws.com",
      "The Schemas multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://schemas.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://schemas.{region}.amazonaws.com.cn",
      "The Schemas endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-12-02/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://schemas.us-east-1.amazonaws.com
