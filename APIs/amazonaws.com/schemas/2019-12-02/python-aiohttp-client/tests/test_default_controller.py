...
async def test_create_discoverer(client):
    """Test case for create_discoverer

    
    """
    body = {"CrossAccount":"","Description":"","SourceArn":"","Tags":""}
    headers = { 
...
async def test_create_registry(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/registries/name/{registry_name}'.format(registry_name='registry_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_schema(client):
    ...
    """
    body = {"Type":"","Description":"","Content":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/v1/registries/name/{registry_name}/schemas/name/{schema_name}'.format(registry_name='registry_name_example', schema_name='schema_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_discoverer(client):
    """Test case for delete_discoverer
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/discoverers/id/{discoverer_id}'.format(discoverer_id='discoverer_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_resource_policy(client):
    ...
    """
    params = [('registryName', 'registry_name_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_delete_schema_version(client):
    """Test case for delete_schema_version
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/registries/name/{registry_name}/schemas/name/{schema_name}/version/{schema_version}'.format(registry_name='registry_name_example', schema_name='schema_name_example', schema_version='schema_version_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_code_binding(client):
    """Test case for describe_code_binding

    
    """
    params = [('schemaVersion', 'schema_version_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='GET',
        path='/v1/registries/name/{registry_name}/schemas/name/{schema_name}/language/{language}'.format(language='language_example', registry_name='registry_name_example', schema_name='schema_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_discoverer(client):
    """Test case for describe_discoverer
...
async def test_describe_registry(client):
    """Test case for describe_registry
...
async def test_describe_schema(client):
    """Test case for describe_schema
...
async def test_export_schema(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/registries/name/{registry_name}/schemas/name/{schema_name}/export#type'.format(registry_name='registry_name_example', schema_name='schema_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_code_binding_source(client):
    """Test case for get_code_binding_source
    ...
    response = await client.request(
        method='GET',
        path='/v1/registries/name/{registry_name}/schemas/name/{schema_name}/language/{language}/source'.format(language='language_example', registry_name='registry_name_example', schema_name='schema_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_discovered_schema(client):
    """Test case for get_discovered_schema
...
async def test_list_discoverers(client):
    """Test case for list_discoverers

    
    """
    params = [('discovererIdPrefix', 'discoverer_id_prefix_example'),
                    ('limit', 56),
                    ('nextToken', 'next_token_example'),
                    ('sourceArnPrefix', 'source_arn_prefix_example'),
                    ('Limit', 'limit_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_registries(client):
    ...
    params = [('limit', 56),
                    ('nextToken', 'next_token_example'),
                    ('registryNamePrefix', 'registry_name_prefix_example'),
                    ('scope', 'scope_example'),
                    ('Limit', 'limit_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
...
async def test_list_schema_versions(client):
    """Test case for list_schema_versions
    ...
    response = await client.request(
        method='GET',
        path='/v1/registries/name/{registry_name}/schemas/name/{schema_name}/versions'.format(registry_name='registry_name_example', schema_name='schema_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_schemas(client):
    ...
    params = [('limit', 56),
                    ('nextToken', 'next_token_example'),
                    ('schemaNamePrefix', 'schema_name_prefix_example'),
                    ('Limit', 'limit_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='GET',
        path='/v1/registries/name/{registry_name}/schemas'.format(registry_name='registry_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_code_binding(client):
    """Test case for put_code_binding
...
async def test_search_schemas(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/registries/name/{registry_name}/schemas/search#keywords'.format(registry_name='registry_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_discoverer(client):
    """Test case for start_discoverer
    ...
    response = await client.request(
        method='POST',
        path='/v1/discoverers/id/{discoverer_id}/start'.format(discoverer_id='discoverer_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stop_discoverer(client):
    """Test case for stop_discoverer
    ...
    response = await client.request(
        method='POST',
        path='/v1/discoverers/id/{discoverer_id}/stop'.format(discoverer_id='discoverer_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_discoverer(client):
    """Test case for update_discoverer

    
    """
    body = {"CrossAccount":"","Description":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_schema(client):
    ...
    """
    body = {"Type":"","Description":"","ClientTokenId":"","Content":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
