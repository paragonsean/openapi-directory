...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Schemas.SearchSchemasResponse();
  });
  ...
  describe('SearchSchemasResponse', function() {
    it('should create an instance of SearchSchemasResponse', function() {
      // uncomment below and update the code to test SearchSchemasResponse
      //var instance = new Schemas.SearchSchemasResponse();
      //expect(instance).to.be.a(Schemas.SearchSchemasResponse);
    });
