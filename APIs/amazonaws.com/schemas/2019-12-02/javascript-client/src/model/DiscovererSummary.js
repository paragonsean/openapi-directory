...
/**
 * The DiscovererSummary model module.
 * @module model/DiscovererSummary
 * @version 2019-12-02
 */
class DiscovererSummary {
    /**
     * Constructs a new <code>DiscovererSummary</code>.
     * @alias module:model/DiscovererSummary
     */
    constructor() { 
        
        DiscovererSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DiscovererSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DiscovererSummary} obj Optional instance to populate.
     * @return {module:model/DiscovererSummary} The populated <code>DiscovererSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DiscovererSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>DiscovererSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DiscovererSummary</code>.
     */
 ...
 */
DiscovererSummary.prototype['DiscovererArn'] = undefined;

/**
 * @member {String} DiscovererId
 */
DiscovererSummary.prototype['DiscovererId'] = undefined;

/**
 * @member {String} SourceArn
 */
DiscovererSummary.prototype['SourceArn'] = undefined;

/**
 * @member {module:model/DiscovererState} State
 */
DiscovererSummary.prototype['State'] = undefined;

/**
 * @member {Boolean} CrossAccount
 */
DiscovererSummary.prototype['CrossAccount'] = undefined;

/**
 * @member {Object} Tags
 */
DiscovererSummary.prototype['Tags'] = undefined;
...
export default DiscovererSummary;
