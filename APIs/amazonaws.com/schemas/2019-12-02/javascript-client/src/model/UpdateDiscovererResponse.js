...
/**
 * The UpdateDiscovererResponse model module.
 * @module model/UpdateDiscovererResponse
 * @version 2019-12-02
 */
class UpdateDiscovererResponse {
    /**
     * Constructs a new <code>UpdateDiscovererResponse</code>.
     * @alias module:model/UpdateDiscovererResponse
     */
    constructor() { 
        
        UpdateDiscovererResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateDiscovererResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDiscovererResponse} obj Optional instance to populate.
     * @return {module:model/UpdateDiscovererResponse} The populated <code>UpdateDiscovererResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDiscovererResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDiscovererResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDiscovererResponse</code>.
     */
 ...
 */
UpdateDiscovererResponse.prototype['Description'] = undefined;

/**
 * @member {String} DiscovererArn
 */
UpdateDiscovererResponse.prototype['DiscovererArn'] = undefined;

/**
 * @member {String} DiscovererId
 */
UpdateDiscovererResponse.prototype['DiscovererId'] = undefined;

/**
 * @member {String} SourceArn
 */
UpdateDiscovererResponse.prototype['SourceArn'] = undefined;

/**
 * @member {module:model/DiscovererState} State
 */
UpdateDiscovererResponse.prototype['State'] = undefined;

/**
 * @member {Boolean} CrossAccount
 */
UpdateDiscovererResponse.prototype['CrossAccount'] = undefined;

/**
 * @member {Object} Tags
 */
UpdateDiscovererResponse.prototype['Tags'] = undefined;
...
export default UpdateDiscovererResponse;
