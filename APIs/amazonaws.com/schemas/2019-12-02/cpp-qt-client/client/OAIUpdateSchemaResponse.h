...
/*
 * OAIUpdateSchemaResponse.h
 *
 * 
 */

#ifndef OAIUpdateSchemaResponse_H
#define OAIUpdateSchemaResponse_H
...
class OAIUpdateSchemaResponse : public OAIObject {
public:
    OAIUpdateSchemaResponse();
    OAIUpdateSchemaResponse(QString json);
    ~OAIUpdateSchemaResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSchemaResponse)

#endif // OAIUpdateSchemaResponse_H
