...
qint32 OAIInstance::getAmiLaunchIndex() const {
    return m_ami_launch_index;
}
void OAIInstance::setAmiLaunchIndex(const qint32 &ami_launch_index) {
    m_ami_launch_index = ami_launch_index;
    m_ami_launch_index_isSet = true;
}

bool OAIInstance::is_ami_launch_index_Set() const{
    return m_ami_launch_index_isSet;
}

bool OAIInstance::is_ami_launch_index_Valid() const{
    return m_ami_launch_index_isValid;
}

QList OAIInstance::getBlockDeviceMappings() const {
    return m_block_device_mappings;
}
void OAIInstance::setBlockDeviceMappings(const QList &block_device_mappings) {
    m_block_device_mappings = block_device_mappings;
    m_block_device_mappings_isSet = true;
}

bool OAIInstance::is_block_device_mappings_Set() const{
    return m_block_device_mappings_isSet;
}

bool OAIInstance::is_block_device_mappings_Valid() const{
    return m_block_device_mappings_isValid;
}

OAIInstance_cpuOptions OAIInstance::getCpuOptions() const {
    return m_cpu_options;
}
void OAIInstance::setCpuOptions(const OAIInstance_cpuOptions &cpu_options) {
    m_cpu_options = cpu_options;
    m_cpu_options_isSet = true;
}

bool OAIInstance::is_cpu_options_Set() const{
    return m_cpu_options_isSet;
}

bool OAIInstance::is_cpu_options_Valid() const{
    return m_cpu_options_isValid;
}

QDateTime OAIInstance::getCreatedAt() const {
    return m_created_at;
}
void OAIInstance::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIInstance::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIInstance::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIInstance::getImageId() const {
    return m_image_id;
}
void OAIInstance::setImageId(const QString &image_id) {
    m_image_id = image_id;
    m_image_id_isSet = true;
}

bool OAIInstance::is_image_id_Set() const{
    return m_image_id_isSet;
}

bool OAIInstance::is_image_id_Valid() const{
...
QString OAIInstance::getPrivateIpAddress() const {
    return m_private_ip_address;
}
void OAIInstance::setPrivateIpAddress(const QString &private_ip_address) {
    m_private_ip_address = private_ip_address;
    m_private_ip_address_isSet = true;
}

bool OAIInstance::is_private_ip_address_Set() const{
    return m_private_ip_address_isSet;
}

bool OAIInstance::is_private_ip_address_Valid() const{
...
QString OAIInstance::getRootDeviceName() const {
    return m_root_device_name;
}
void OAIInstance::setRootDeviceName(const QString &root_device_name) {
    m_root_device_name = root_device_name;
    m_root_device_name_isSet = true;
}

bool OAIInstance::is_root_device_name_Set() const{
    return m_root_device_name_isSet;
}

bool OAIInstance::is_root_device_name_Valid() const{
    return m_root_device_name_isValid;
}

QList OAIInstance::getSecurityGroups() const {
    return m_security_groups;
}
void OAIInstance::setSecurityGroups(const QList &security_groups) {
    m_security_groups = security_groups;
    m_security_groups_isSet = true;
}

bool OAIInstance::is_security_groups_Set() const{
    return m_security_groups_isSet;
}

bool OAIInstance::is_security_groups_Valid() const{
    return m_security_groups_isValid;
}

OAIInstanceState OAIInstance::getState() const {
    return m_state;
}
void OAIInstance::setState(const OAIInstanceState &state) {
    m_state = state;
    m_state_isSet = true;
}
...
QDateTime OAIInstance::getUpdatedAt() const {
    return m_updated_at;
}
void OAIInstance::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIInstance::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIInstance::is_updated_at_Valid() const{
