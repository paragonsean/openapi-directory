...
/*
 * OAIInstanceSummary_instance.h
 *
 * 
 */

#ifndef OAIInstanceSummary_instance_H
#define OAIInstanceSummary_instance_H
...
class OAIInstanceSummary_instance : public OAIObject {
public:
    OAIInstanceSummary_instance();
    OAIInstanceSummary_instance(QString json);
    ~OAIInstanceSummary_instance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceSummary_instance)

#endif // OAIInstanceSummary_instance_H
