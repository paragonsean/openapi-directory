...
OAIDescribeDeviceOutput_software::OAIDescribeDeviceOutput_software(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeDeviceOutput_software::OAIDescribeDeviceOutput_software() {
    this->initializeModel();
}

OAIDescribeDeviceOutput_software::~OAIDescribeDeviceOutput_software() {}

void OAIDescribeDeviceOutput_software::initializeModel() {
...
void OAIDescribeDeviceOutput_software::fromJson(QString jsonString) {
...
void OAIDescribeDeviceOutput_software::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeDeviceOutput_software::asJson() const {
...
QJsonObject OAIDescribeDeviceOutput_software::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeDeviceOutput_software::getInstallState() const {
    return m_install_state;
}
void OAIDescribeDeviceOutput_software::setInstallState(const QString &install_state) {
    m_install_state = install_state;
    m_install_state_isSet = true;
}

bool OAIDescribeDeviceOutput_software::is_install_state_Set() const{
    return m_install_state_isSet;
}

bool OAIDescribeDeviceOutput_software::is_install_state_Valid() const{
    return m_install_state_isValid;
}

QString OAIDescribeDeviceOutput_software::getInstalledVersion() const {
    return m_installed_version;
}
void OAIDescribeDeviceOutput_software::setInstalledVersion(const QString &installed_version) {
    m_installed_version = installed_version;
    m_installed_version_isSet = true;
}

bool OAIDescribeDeviceOutput_software::is_installed_version_Set() const{
    return m_installed_version_isSet;
}

bool OAIDescribeDeviceOutput_software::is_installed_version_Valid() const{
    return m_installed_version_isValid;
}

QString OAIDescribeDeviceOutput_software::getInstallingVersion() const {
    return m_installing_version;
}
void OAIDescribeDeviceOutput_software::setInstallingVersion(const QString &installing_version) {
    m_installing_version = installing_version;
    m_installing_version_isSet = true;
}

bool OAIDescribeDeviceOutput_software::is_installing_version_Set() const{
    return m_installing_version_isSet;
}

bool OAIDescribeDeviceOutput_software::is_installing_version_Valid() const{
    return m_installing_version_isValid;
}

bool OAIDescribeDeviceOutput_software::isSet() const {
...
bool OAIDescribeDeviceOutput_software::isValid() const {
