...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://snow-device-management.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://snow-device-management.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-08-04/Javascript'
        };
