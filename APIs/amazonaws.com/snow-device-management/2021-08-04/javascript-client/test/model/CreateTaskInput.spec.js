...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSnowDeviceManagement.CreateTaskInput();
  });
  ...
  describe('CreateTaskInput', function() {
    it('should create an instance of CreateTaskInput', function() {
      // uncomment below and update the code to test CreateTaskInput
      //var instance = new AwsSnowDeviceManagement.CreateTaskInput();
      //expect(instance).to.be.a(AwsSnowDeviceManagement.CreateTaskInput);
    });
