...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSnowDeviceManagement.InstanceSummary();
  });
  ...
  describe('InstanceSummary', function() {
    it('should create an instance of InstanceSummary', function() {
      // uncomment below and update the code to test InstanceSummary
      //var instance = new AwsSnowDeviceManagement.InstanceSummary();
      //expect(instance).to.be.a(AwsSnowDeviceManagement.InstanceSummary);
    });
