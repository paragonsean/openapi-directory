...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSnowDeviceManagement.Instance();
  });
  ...
  describe('Instance', function() {
    it('should create an instance of Instance', function() {
      ...
      //var instance = new AwsSnowDeviceManagement.Instance();
      //expect(instance).to.be.a(AwsSnowDeviceManagement.Instance);
    });
