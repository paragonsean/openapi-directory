...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSnowDeviceManagement.TaskSummary();
  });
  ...
  describe('TaskSummary', function() {
    it('should create an instance of TaskSummary', function() {
      // uncomment below and update the code to test TaskSummary
      //var instance = new AwsSnowDeviceManagement.TaskSummary();
      //expect(instance).to.be.a(AwsSnowDeviceManagement.TaskSummary);
    });
