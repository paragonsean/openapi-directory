...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSnowDeviceManagement.ListTasksOutput();
  });
  ...
  describe('ListTasksOutput', function() {
    it('should create an instance of ListTasksOutput', function() {
      // uncomment below and update the code to test ListTasksOutput
      //var instance = new AwsSnowDeviceManagement.ListTasksOutput();
      //expect(instance).to.be.a(AwsSnowDeviceManagement.ListTasksOutput);
    });
