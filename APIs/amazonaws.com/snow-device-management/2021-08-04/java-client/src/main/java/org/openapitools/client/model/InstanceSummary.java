...
public class InstanceSummary {
  ...
  private InstanceSummaryInstance instance;
  ...
  public InstanceSummary instance(InstanceSummaryInstance instance) {
  ...
  public InstanceSummaryInstance getInstance() {
    return instance;
  }

  public void setInstance(InstanceSummaryInstance instance) {
    this.instance = instance;
  }


  public InstanceSummary lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instance, instanceSummary.instance) &&
        Objects.equals(this.lastUpdatedAt, instanceSummary.lastUpdatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instance, lastUpdatedAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("instance") != null && !jsonObj.get("instance").isJsonNull()) {
        InstanceSummaryInstance.validateJsonElement(jsonObj.get("instance"));
      }
