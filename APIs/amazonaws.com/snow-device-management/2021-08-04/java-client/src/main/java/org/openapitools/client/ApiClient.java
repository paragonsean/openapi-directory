...
public class ApiClient {
    ...
    private String basePath = "http://snow-device-management.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-08-04/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://snow-device-management.us-east-1.amazonaws.com
