...
class Instance(Model):
    ...
    def __init__(self, ami_launch_index: int=None, block_device_mappings: List=None, cpu_options: InstanceCpuOptions=None, created_at: datetime=None, image_id: str=None, instance_id: str=None, instance_type: str=None, private_ip_address: str=None, public_ip_address: str=None, root_device_name: str=None, security_groups: List=None, state: InstanceState=None, updated_at: datetime=None):
        ...
        :param ami_launch_index: The ami_launch_index of this Instance.
        :param block_device_mappings: The block_device_mappings of this Instance.
        :param cpu_options: The cpu_options of this Instance.
        ...
        :param private_ip_address: The private_ip_address of this Instance.
        :param public_ip_address: The public_ip_address of this Instance.
        :param root_device_name: The root_device_name of this Instance.
    ...
    def ami_launch_index(self):
        """Gets the ami_launch_index of this Instance.


        :return: The ami_launch_index of this Instance.
        :rtype: int
        """
    ...
    def ami_launch_index(self, ami_launch_index):
        """Sets the ami_launch_index of this Instance.
    ...
    def block_device_mappings(self):
        """Gets the block_device_mappings of this Instance.


        :return: The block_device_mappings of this Instance.
        :rtype: List
        """
    ...
    def block_device_mappings(self, block_device_mappings):
        """Sets the block_device_mappings of this Instance.
    ...
    def cpu_options(self):
        """Gets the cpu_options of this Instance.


        :return: The cpu_options of this Instance.
    ...
    def cpu_options(self, cpu_options):
        """Sets the cpu_options of this Instance.
    ...
    def private_ip_address(self):
        """Gets the private_ip_address of this Instance.


        :return: The private_ip_address of this Instance.
        :rtype: str
        """
    ...
    def root_device_name(self):
        """Gets the root_device_name of this Instance.


        :return: The root_device_name of this Instance.
        :rtype: str
        """
    ...
    def root_device_name(self, root_device_name):
        """Sets the root_device_name of this Instance.
