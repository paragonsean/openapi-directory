...
public class HealthCheckCustomConfig {
  ...
  public HealthCheckCustomConfig failureThreshold(Integer failureThreshold) {
  ...
  public boolean equals(Object o) {
    ...
    HealthCheckCustomConfig healthCheckCustomConfig = (HealthCheckCustomConfig) o;
    return Objects.equals(this.failureThreshold, healthCheckCustomConfig.failureThreshold);
  }
  ...
  public String toString() {
    ...
    sb.append("class HealthCheckCustomConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HealthCheckCustomConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HealthCheckCustomConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HealthCheckCustomConfig is not found in the empty JSON string", HealthCheckCustomConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HealthCheckCustomConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HealthCheckCustomConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HealthCheckCustomConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HealthCheckCustomConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HealthCheckCustomConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HealthCheckCustomConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<HealthCheckCustomConfig>() {
           @Override
           public void write(JsonWriter out, HealthCheckCustomConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HealthCheckCustomConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HealthCheckCustomConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HealthCheckCustomConfig
   * @throws IOException if the JSON string is invalid with respect to HealthCheckCustomConfig
   */
  public static HealthCheckCustomConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HealthCheckCustomConfig.class);
  }

  /**
   * Convert an instance of HealthCheckCustomConfig to an JSON string
   *
   * @return JSON string
   */
