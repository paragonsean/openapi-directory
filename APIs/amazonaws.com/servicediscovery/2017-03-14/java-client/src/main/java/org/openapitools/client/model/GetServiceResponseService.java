...
public class GetServiceResponseService {
  ...
  public GetServiceResponseService() {
  }

  public GetServiceResponseService id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetServiceResponseService arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetServiceResponseService name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetServiceResponseService namespaceId(String namespaceId) {
  ...
  public GetServiceResponseService description(String description) {
  ...
  public GetServiceResponseService instanceCount(Integer instanceCount) {
  ...
  public GetServiceResponseService dnsConfig(ServiceDnsConfig dnsConfig) {
  ...
  public GetServiceResponseService type(ServiceType type) {
    this.type = type;
    return this;
  }
  ...
  public GetServiceResponseService healthCheckConfig(ServiceHealthCheckConfig healthCheckConfig) {
  ...
  public GetServiceResponseService healthCheckCustomConfig(ServiceHealthCheckCustomConfig healthCheckCustomConfig) {
  ...
  public GetServiceResponseService createDate(OffsetDateTime createDate) {
  ...
  public GetServiceResponseService creatorRequestId(String creatorRequestId) {
  ...
  public boolean equals(Object o) {
    ...
    GetServiceResponseService getServiceResponseService = (GetServiceResponseService) o;
    return Objects.equals(this.id, getServiceResponseService.id) &&
        Objects.equals(this.arn, getServiceResponseService.arn) &&
        Objects.equals(this.name, getServiceResponseService.name) &&
        Objects.equals(this.namespaceId, getServiceResponseService.namespaceId) &&
        Objects.equals(this.description, getServiceResponseService.description) &&
        Objects.equals(this.instanceCount, getServiceResponseService.instanceCount) &&
        Objects.equals(this.dnsConfig, getServiceResponseService.dnsConfig) &&
        Objects.equals(this.type, getServiceResponseService.type) &&
        Objects.equals(this.healthCheckConfig, getServiceResponseService.healthCheckConfig) &&
        Objects.equals(this.healthCheckCustomConfig, getServiceResponseService.healthCheckCustomConfig) &&
        Objects.equals(this.createDate, getServiceResponseService.createDate) &&
        Objects.equals(this.creatorRequestId, getServiceResponseService.creatorRequestId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetServiceResponseService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetServiceResponseService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetServiceResponseService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetServiceResponseService is not found in the empty JSON string", GetServiceResponseService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetServiceResponseService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetServiceResponseService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetServiceResponseService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetServiceResponseService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetServiceResponseService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetServiceResponseService.class));

       return (TypeAdapter<T>) new TypeAdapter<GetServiceResponseService>() {
           @Override
           public void write(JsonWriter out, GetServiceResponseService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetServiceResponseService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetServiceResponseService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetServiceResponseService
   * @throws IOException if the JSON string is invalid with respect to GetServiceResponseService
   */
  public static GetServiceResponseService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetServiceResponseService.class);
  }

  /**
   * Convert an instance of GetServiceResponseService to an JSON string
   *
   * @return JSON string
   */
