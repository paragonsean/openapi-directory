...
async def test_create_http_namespace(client):
    """Test case for create_http_namespace

    
    """
    body = {"Description":"","CreatorRequestId":"","Tags":"","Name":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.CreateHttpNamespace',
        headers=headers,
        json=body,
        )
...
async def test_create_private_dns_namespace(client):
    """Test case for create_private_dns_namespace

    
    """
    body = {"Description":"","Vpc":"","Properties":{"DnsProperties":{"SOA":{"TTL":""}}},"CreatorRequestId":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePrivateDnsNamespace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_public_dns_namespace(client):
    """Test case for create_public_dns_namespace

    
    """
    body = {"Description":"","Properties":{"DnsProperties":{"SOA":{"TTL":""}}},"CreatorRequestId":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePublicDnsNamespace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_service(client):
    ...
    """
    body = {"Type":"","Description":"","HealthCheckCustomConfig":{"FailureThreshold":""},"DnsConfig":{"DnsRecords":"","RoutingPolicy":"","NamespaceId":""},"NamespaceId":"","HealthCheckConfig":{"Type":"","ResourcePath":"","FailureThreshold":""},"CreatorRequestId":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.CreateService',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_namespace(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.DeleteNamespace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_service(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.DeleteService',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deregister_instance(client):
    """Test case for deregister_instance

    
    """
    body = {"InstanceId":"","ServiceId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.DeregisterInstance',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_discover_instances(client):
    """Test case for discover_instances

    
    """
    body = {"NamespaceName":"","OptionalParameters":"","ServiceName":"","MaxResults":"","HealthStatus":"","QueryParameters":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.DiscoverInstances',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_instance(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.GetInstance',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_instances_health_status(client):
    """Test case for get_instances_health_status

    
    """
    body = {"Instances":"","NextToken":"","MaxResults":"","ServiceId":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.GetInstancesHealthStatus',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_get_namespace(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.GetNamespace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_operation(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.GetOperation',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_service(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.GetService',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_instances(client):
    ...
    """
    body = {"NextToken":"","MaxResults":"","ServiceId":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.ListInstances',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_namespaces(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.ListNamespaces',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_operations(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.ListOperations',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_services(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.ListServices',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_register_instance(client):
    """Test case for register_instance

    
    """
    body = {"InstanceId":"","Attributes":"","CreatorRequestId":"","ServiceId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.RegisterInstance',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_http_namespace(client):
    """Test case for update_http_namespace

    
    """
    body = {"UpdaterRequestId":"","Id":"","Namespace":{"Description":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateHttpNamespace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_instance_custom_health_status(client):
    """Test case for update_instance_custom_health_status

    
    """
    body = {"Status":"","InstanceId":"","ServiceId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateInstanceCustomHealthStatus',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_private_dns_namespace(client):
    """Test case for update_private_dns_namespace

    
    """
    body = {"UpdaterRequestId":"","Id":"","Namespace":{"Description":"","Properties":{"DnsProperties":{"SOA":{"TTL":""}}}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.UpdatePrivateDnsNamespace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_public_dns_namespace(client):
    """Test case for update_public_dns_namespace
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.UpdatePublicDnsNamespace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_service(client):
    ...
    """
    body = {"Service":{"Description":"","DnsConfig":{"DnsRecords":""},"HealthCheckConfig":{"Type":"","ResourcePath":"","FailureThreshold":""}},"Id":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateService',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
