...
/*
 * OAIService_HealthCheckConfig.h
 *
 * 
 */

#ifndef OAIService_HealthCheckConfig_H
#define OAIService_HealthCheckConfig_H
...
class OAIService_HealthCheckConfig : public OAIObject {
public:
    OAIService_HealthCheckConfig();
    OAIService_HealthCheckConfig(QString json);
    ~OAIService_HealthCheckConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIService_HealthCheckConfig)

#endif // OAIService_HealthCheckConfig_H
