...
OAIService_DnsConfig::OAIService_DnsConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIService_DnsConfig::OAIService_DnsConfig() {
    this->initializeModel();
}

OAIService_DnsConfig::~OAIService_DnsConfig() {}

void OAIService_DnsConfig::initializeModel() {
...
void OAIService_DnsConfig::fromJson(QString jsonString) {
...
void OAIService_DnsConfig::fromJsonObject(QJsonObject json) {
...
QString OAIService_DnsConfig::asJson() const {
...
QJsonObject OAIService_DnsConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIService_DnsConfig::getNamespaceId() const {
    return m_namespace_id;
}
void OAIService_DnsConfig::setNamespaceId(const QString &namespace_id) {
    m_namespace_id = namespace_id;
    m_namespace_id_isSet = true;
}

bool OAIService_DnsConfig::is_namespace_id_Set() const{
    return m_namespace_id_isSet;
}

bool OAIService_DnsConfig::is_namespace_id_Valid() const{
    return m_namespace_id_isValid;
}

OAIRoutingPolicy OAIService_DnsConfig::getRoutingPolicy() const {
    return m_routing_policy;
}
void OAIService_DnsConfig::setRoutingPolicy(const OAIRoutingPolicy &routing_policy) {
    m_routing_policy = routing_policy;
    m_routing_policy_isSet = true;
}

bool OAIService_DnsConfig::is_routing_policy_Set() const{
    return m_routing_policy_isSet;
}

bool OAIService_DnsConfig::is_routing_policy_Valid() const{
    return m_routing_policy_isValid;
}

QList OAIService_DnsConfig::getDnsRecords() const {
    return m_dns_records;
}
void OAIService_DnsConfig::setDnsRecords(const QList &dns_records) {
    m_dns_records = dns_records;
    m_dns_records_isSet = true;
}

bool OAIService_DnsConfig::is_dns_records_Set() const{
    return m_dns_records_isSet;
}

bool OAIService_DnsConfig::is_dns_records_Valid() const{
    return m_dns_records_isValid;
}

bool OAIService_DnsConfig::isSet() const {
...
bool OAIService_DnsConfig::isValid() const {
