...
QString OAIService::getNamespaceId() const {
    return m_namespace_id;
}
void OAIService::setNamespaceId(const QString &namespace_id) {
    m_namespace_id = namespace_id;
    m_namespace_id_isSet = true;
}

bool OAIService::is_namespace_id_Set() const{
    return m_namespace_id_isSet;
}

bool OAIService::is_namespace_id_Valid() const{
...
qint32 OAIService::getInstanceCount() const {
    return m_instance_count;
}
void OAIService::setInstanceCount(const qint32 &instance_count) {
    m_instance_count = instance_count;
    m_instance_count_isSet = true;
}

bool OAIService::is_instance_count_Set() const{
    return m_instance_count_isSet;
}

bool OAIService::is_instance_count_Valid() const{
    return m_instance_count_isValid;
}

OAIService_DnsConfig OAIService::getDnsConfig() const {
    return m_dns_config;
}
void OAIService::setDnsConfig(const OAIService_DnsConfig &dns_config) {
    m_dns_config = dns_config;
    m_dns_config_isSet = true;
}

bool OAIService::is_dns_config_Set() const{
    return m_dns_config_isSet;
}

bool OAIService::is_dns_config_Valid() const{
    return m_dns_config_isValid;
}

OAIServiceType OAIService::getType() const {
    return m_type;
}
void OAIService::setType(const OAIServiceType &type) {
    m_type = type;
    m_type_isSet = true;
}
...
OAIService_HealthCheckConfig OAIService::getHealthCheckConfig() const {
    return m_health_check_config;
}
void OAIService::setHealthCheckConfig(const OAIService_HealthCheckConfig &health_check_config) {
    m_health_check_config = health_check_config;
    m_health_check_config_isSet = true;
}

bool OAIService::is_health_check_config_Set() const{
    return m_health_check_config_isSet;
}

bool OAIService::is_health_check_config_Valid() const{
    return m_health_check_config_isValid;
}

OAIService_HealthCheckCustomConfig OAIService::getHealthCheckCustomConfig() const {
    return m_health_check_custom_config;
}
void OAIService::setHealthCheckCustomConfig(const OAIService_HealthCheckCustomConfig &health_check_custom_config) {
    m_health_check_custom_config = health_check_custom_config;
    m_health_check_custom_config_isSet = true;
}

bool OAIService::is_health_check_custom_config_Set() const{
    return m_health_check_custom_config_isSet;
}

bool OAIService::is_health_check_custom_config_Valid() const{
    return m_health_check_custom_config_isValid;
}

QDateTime OAIService::getCreateDate() const {
    return m_create_date;
}
void OAIService::setCreateDate(const QDateTime &create_date) {
    m_create_date = create_date;
    m_create_date_isSet = true;
}

bool OAIService::is_create_date_Set() const{
    return m_create_date_isSet;
}

bool OAIService::is_create_date_Valid() const{
    return m_create_date_isValid;
}

QString OAIService::getCreatorRequestId() const {
    return m_creator_request_id;
}
void OAIService::setCreatorRequestId(const QString &creator_request_id) {
    m_creator_request_id = creator_request_id;
    m_creator_request_id_isSet = true;
}

bool OAIService::is_creator_request_id_Set() const{
    return m_creator_request_id_isSet;
}

bool OAIService::is_creator_request_id_Valid() const{
