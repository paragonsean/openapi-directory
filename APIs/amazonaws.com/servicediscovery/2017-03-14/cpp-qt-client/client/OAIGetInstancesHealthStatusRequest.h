...
/*
 * OAIGetInstancesHealthStatusRequest.h
 *
 * 
 */

#ifndef OAIGetInstancesHealthStatusRequest_H
#define OAIGetInstancesHealthStatusRequest_H
...
class OAIGetInstancesHealthStatusRequest : public OAIObject {
public:
    OAIGetInstancesHealthStatusRequest();
    OAIGetInstancesHealthStatusRequest(QString json);
    ~OAIGetInstancesHealthStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInstancesHealthStatusRequest)

#endif // OAIGetInstancesHealthStatusRequest_H
