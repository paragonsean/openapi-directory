...
/*
 * OAIGetNamespaceResponse_Namespace.h
 *
 * 
 */

#ifndef OAIGetNamespaceResponse_Namespace_H
#define OAIGetNamespaceResponse_Namespace_H
...
class OAIGetNamespaceResponse_Namespace : public OAIObject {
public:
    OAIGetNamespaceResponse_Namespace();
    OAIGetNamespaceResponse_Namespace(QString json);
    ~OAIGetNamespaceResponse_Namespace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetNamespaceResponse_Namespace)

#endif // OAIGetNamespaceResponse_Namespace_H
