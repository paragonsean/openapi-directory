...
/*
 * OAIGetServiceResponse_Service.h
 *
 * 
 */

#ifndef OAIGetServiceResponse_Service_H
#define OAIGetServiceResponse_Service_H
...
class OAIGetServiceResponse_Service : public OAIObject {
public:
    OAIGetServiceResponse_Service();
    OAIGetServiceResponse_Service(QString json);
    ~OAIGetServiceResponse_Service() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceResponse_Service)

#endif // OAIGetServiceResponse_Service_H
