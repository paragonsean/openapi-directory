...
/*
 * OAIDeregisterInstanceRequest.h
 *
 * 
 */

#ifndef OAIDeregisterInstanceRequest_H
#define OAIDeregisterInstanceRequest_H
...
class OAIDeregisterInstanceRequest : public OAIObject {
public:
    OAIDeregisterInstanceRequest();
    OAIDeregisterInstanceRequest(QString json);
    ~OAIDeregisterInstanceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterInstanceRequest)

#endif // OAIDeregisterInstanceRequest_H
