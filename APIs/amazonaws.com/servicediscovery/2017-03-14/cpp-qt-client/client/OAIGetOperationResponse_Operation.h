...
/*
 * OAIGetOperationResponse_Operation.h
 *
 * 
 */

#ifndef OAIGetOperationResponse_Operation_H
#define OAIGetOperationResponse_Operation_H
...
class OAIGetOperationResponse_Operation : public OAIObject {
public:
    OAIGetOperationResponse_Operation();
    OAIGetOperationResponse_Operation(QString json);
    ~OAIGetOperationResponse_Operation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOperationResponse_Operation)

#endif // OAIGetOperationResponse_Operation_H
