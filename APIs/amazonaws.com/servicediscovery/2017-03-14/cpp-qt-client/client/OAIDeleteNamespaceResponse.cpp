...
QString OAIDeleteNamespaceResponse::getOperationId() const {
    return m_operation_id;
}
void OAIDeleteNamespaceResponse::setOperationId(const QString &operation_id) {
    m_operation_id = operation_id;
    m_operation_id_isSet = true;
}

bool OAIDeleteNamespaceResponse::is_operation_id_Set() const{
    return m_operation_id_isSet;
}

bool OAIDeleteNamespaceResponse::is_operation_id_Valid() const{
