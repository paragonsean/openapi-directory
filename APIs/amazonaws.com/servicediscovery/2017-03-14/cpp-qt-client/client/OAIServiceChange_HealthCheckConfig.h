...
/*
 * OAIServiceChange_HealthCheckConfig.h
 *
 * 
 */

#ifndef OAIServiceChange_HealthCheckConfig_H
#define OAIServiceChange_HealthCheckConfig_H
...
class OAIServiceChange_HealthCheckConfig : public OAIObject {
public:
    OAIServiceChange_HealthCheckConfig();
    OAIServiceChange_HealthCheckConfig(QString json);
    ~OAIServiceChange_HealthCheckConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceChange_HealthCheckConfig)

#endif // OAIServiceChange_HealthCheckConfig_H
