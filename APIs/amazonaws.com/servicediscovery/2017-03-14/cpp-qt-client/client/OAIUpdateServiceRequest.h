...
namespace OpenAPI {
class OAIUpdateServiceRequest_Service;
...
public:
    ...
    OAIUpdateServiceRequest_Service getService() const;
    void setService(const OAIUpdateServiceRequest_Service &service);
...
private:
    ...
    OAIUpdateServiceRequest_Service m_service;
