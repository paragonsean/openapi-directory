...
QList OAIListServicesRequest::getFilters() const {
    return m_filters;
}
void OAIListServicesRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListServicesRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListServicesRequest::is_filters_Valid() const{
