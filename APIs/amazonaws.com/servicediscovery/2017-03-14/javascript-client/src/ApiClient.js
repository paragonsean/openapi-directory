...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://servicediscovery.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://servicediscovery.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-03-14/Javascript'
        };
