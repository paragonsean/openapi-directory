...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.ServiceHealthCheckConfig();
  });
  ...
  describe('ServiceHealthCheckConfig', function() {
    it('should create an instance of ServiceHealthCheckConfig', function() {
      // uncomment below and update the code to test ServiceHealthCheckConfig
      //var instance = new AwsCloudMap.ServiceHealthCheckConfig();
      //expect(instance).to.be.a(AwsCloudMap.ServiceHealthCheckConfig);
    });
