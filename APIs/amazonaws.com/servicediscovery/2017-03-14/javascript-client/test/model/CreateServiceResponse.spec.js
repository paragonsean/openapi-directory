...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.CreateServiceResponse();
  });
  ...
  describe('CreateServiceResponse', function() {
    it('should create an instance of CreateServiceResponse', function() {
      ...
      //var instance = new AwsCloudMap.CreateServiceResponse();
      //expect(instance).to.be.a(AwsCloudMap.CreateServiceResponse);
    });
