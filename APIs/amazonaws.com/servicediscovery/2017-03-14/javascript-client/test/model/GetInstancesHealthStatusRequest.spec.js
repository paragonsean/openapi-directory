...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.GetInstancesHealthStatusRequest();
  });
  ...
  describe('GetInstancesHealthStatusRequest', function() {
    it('should create an instance of GetInstancesHealthStatusRequest', function() {
      // uncomment below and update the code to test GetInstancesHealthStatusRequest
      //var instance = new AwsCloudMap.GetInstancesHealthStatusRequest();
      //expect(instance).to.be.a(AwsCloudMap.GetInstancesHealthStatusRequest);
    });
