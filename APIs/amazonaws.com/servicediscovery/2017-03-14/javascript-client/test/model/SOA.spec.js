...
(function(root, factory) {
  ...
  describe('SOA', function() {
    it('should create an instance of SOA', function() {
      // uncomment below and update the code to test SOA
      //var instance = new AwsCloudMap.SOA();
      //expect(instance).to.be.a(AwsCloudMap.SOA);
    });
