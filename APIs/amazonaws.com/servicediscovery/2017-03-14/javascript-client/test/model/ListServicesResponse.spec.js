...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.ListServicesResponse();
  });
  ...
  describe('ListServicesResponse', function() {
    it('should create an instance of ListServicesResponse', function() {
      ...
      //var instance = new AwsCloudMap.ListServicesResponse();
      //expect(instance).to.be.a(AwsCloudMap.ListServicesResponse);
    });
