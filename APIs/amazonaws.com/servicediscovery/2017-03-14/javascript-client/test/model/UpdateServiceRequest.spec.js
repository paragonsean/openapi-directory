...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.UpdateServiceRequest();
  });
  ...
  describe('UpdateServiceRequest', function() {
    it('should create an instance of UpdateServiceRequest', function() {
      ...
      //var instance = new AwsCloudMap.UpdateServiceRequest();
      //expect(instance).to.be.a(AwsCloudMap.UpdateServiceRequest);
    });
