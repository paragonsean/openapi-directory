...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.ListInstancesRequest();
  });
  ...
  describe('ListInstancesRequest', function() {
    it('should create an instance of ListInstancesRequest', function() {
      ...
      //var instance = new AwsCloudMap.ListInstancesRequest();
      //expect(instance).to.be.a(AwsCloudMap.ListInstancesRequest);
    });
