...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.HttpInstanceSummary();
  });
  ...
  describe('HttpInstanceSummary', function() {
    it('should create an instance of HttpInstanceSummary', function() {
      // uncomment below and update the code to test HttpInstanceSummary
      //var instance = new AwsCloudMap.HttpInstanceSummary();
      //expect(instance).to.be.a(AwsCloudMap.HttpInstanceSummary);
    });
