...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.HealthCheckConfig();
  });
  ...
  describe('HealthCheckConfig', function() {
    it('should create an instance of HealthCheckConfig', function() {
      // uncomment below and update the code to test HealthCheckConfig
      //var instance = new AwsCloudMap.HealthCheckConfig();
      //expect(instance).to.be.a(AwsCloudMap.HealthCheckConfig);
    });
