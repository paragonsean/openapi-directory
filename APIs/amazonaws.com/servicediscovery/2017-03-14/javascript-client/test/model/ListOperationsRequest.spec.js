...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.ListOperationsRequest();
  });
  ...
  describe('ListOperationsRequest', function() {
    it('should create an instance of ListOperationsRequest', function() {
      ...
      //var instance = new AwsCloudMap.ListOperationsRequest();
      //expect(instance).to.be.a(AwsCloudMap.ListOperationsRequest);
    });
