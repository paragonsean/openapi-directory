...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.ListNamespacesRequest();
  });
  ...
  describe('ListNamespacesRequest', function() {
    it('should create an instance of ListNamespacesRequest', function() {
      // uncomment below and update the code to test ListNamespacesRequest
      //var instance = new AwsCloudMap.ListNamespacesRequest();
      //expect(instance).to.be.a(AwsCloudMap.ListNamespacesRequest);
    });
