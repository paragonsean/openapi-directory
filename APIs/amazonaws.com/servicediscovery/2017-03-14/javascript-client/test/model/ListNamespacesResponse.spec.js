...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudMap.ListNamespacesResponse();
  });
  ...
  describe('ListNamespacesResponse', function() {
    it('should create an instance of ListNamespacesResponse', function() {
      ...
      //var instance = new AwsCloudMap.ListNamespacesResponse();
      //expect(instance).to.be.a(AwsCloudMap.ListNamespacesResponse);
    });
