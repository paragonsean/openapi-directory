...
class Example : public QObject {
    Q_OBJECT
    OAICreateAssistant_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateAssistant_request Example::create(){
    OAICreateAssistant_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createAssistantSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createAssistantSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateAssistant_request oai_create_assistant_request = create(); // OAICreateAssistant_request | 
      ...
      apiInstance.createAssistant(oai_create_assistant_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
