...
#ifndef OAIContentData_H
#define OAIContentData_H
...
class OAIContentData : public OAIObject {
public:
    OAIContentData();
    OAIContentData(QString json);
    ~OAIContentData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentData)

#endif // OAIContentData_H
