...
/*
 * OAIContentReference.h
 *
 * Reference information about the content.
 */

#ifndef OAIContentReference_H
#define OAIContentReference_H
...
class OAIContentReference : public OAIObject {
public:
    OAIContentReference();
    OAIContentReference(QString json);
    ~OAIContentReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentReference)

#endif // OAIContentReference_H
