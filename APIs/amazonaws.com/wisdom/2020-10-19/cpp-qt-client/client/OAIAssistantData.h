...
#ifndef OAIAssistantData_H
#define OAIAssistantData_H
...
class OAIAssistantData : public OAIObject {
public:
    OAIAssistantData();
    OAIAssistantData(QString json);
    ~OAIAssistantData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssistantData)

#endif // OAIAssistantData_H
