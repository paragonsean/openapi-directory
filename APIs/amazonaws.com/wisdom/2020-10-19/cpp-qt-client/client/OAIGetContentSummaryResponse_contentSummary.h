...
/*
 * OAIGetContentSummaryResponse_contentSummary.h
 *
 * 
 */

#ifndef OAIGetContentSummaryResponse_contentSummary_H
#define OAIGetContentSummaryResponse_contentSummary_H
...
class OAIGetContentSummaryResponse_contentSummary : public OAIObject {
public:
    OAIGetContentSummaryResponse_contentSummary();
    OAIGetContentSummaryResponse_contentSummary(QString json);
    ~OAIGetContentSummaryResponse_contentSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetContentSummaryResponse_contentSummary)

#endif // OAIGetContentSummaryResponse_contentSummary_H
