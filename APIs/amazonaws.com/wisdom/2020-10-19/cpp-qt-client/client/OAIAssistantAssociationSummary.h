...
/*
 * OAIAssistantAssociationSummary.h
 *
 * Summary information about the assistant association.
 */

#ifndef OAIAssistantAssociationSummary_H
#define OAIAssistantAssociationSummary_H
...
namespace OpenAPI {
class OAIAssistantAssociationSummary_associationData;

class OAIAssistantAssociationSummary : public OAIObject {
public:
    OAIAssistantAssociationSummary();
    OAIAssistantAssociationSummary(QString json);
    ~OAIAssistantAssociationSummary() override;
    ...
    OAIAssistantAssociationSummary_associationData getAssociationData() const;
    void setAssociationData(const OAIAssistantAssociationSummary_associationData &association_data);
...
private:
    ...
    OAIAssistantAssociationSummary_associationData m_association_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssistantAssociationSummary)

#endif // OAIAssistantAssociationSummary_H
