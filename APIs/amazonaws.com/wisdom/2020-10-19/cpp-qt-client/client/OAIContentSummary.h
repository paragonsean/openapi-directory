...
#ifndef OAIContentSummary_H
#define OAIContentSummary_H
...
class OAIContentSummary : public OAIObject {
public:
    OAIContentSummary();
    OAIContentSummary(QString json);
    ~OAIContentSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentSummary)

#endif // OAIContentSummary_H
