...
public class UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase() {
  }

  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase description(String description) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase knowledgeBaseArn(String knowledgeBaseArn) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase knowledgeBaseId(String knowledgeBaseId) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase knowledgeBaseType(KnowledgeBaseType knowledgeBaseType) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase lastContentModificationTime(OffsetDateTime lastContentModificationTime) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase renderingConfiguration(CreateKnowledgeBaseRequestRenderingConfiguration renderingConfiguration) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase serverSideEncryptionConfiguration(AssistantDataServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase sourceConfiguration(KnowledgeBaseDataSourceConfiguration sourceConfiguration) {
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase status(KnowledgeBaseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase updateKnowledgeBaseTemplateUriResponseKnowledgeBase = (UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase) o;
    return Objects.equals(this.description, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.description) &&
        Objects.equals(this.knowledgeBaseArn, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.knowledgeBaseArn) &&
        Objects.equals(this.knowledgeBaseId, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.knowledgeBaseId) &&
        Objects.equals(this.knowledgeBaseType, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.knowledgeBaseType) &&
        Objects.equals(this.lastContentModificationTime, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.lastContentModificationTime) &&
        Objects.equals(this.name, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.name) &&
        Objects.equals(this.renderingConfiguration, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.renderingConfiguration) &&
        Objects.equals(this.serverSideEncryptionConfiguration, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.serverSideEncryptionConfiguration) &&
        Objects.equals(this.sourceConfiguration, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.sourceConfiguration) &&
        Objects.equals(this.status, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.status) &&
        Objects.equals(this.tags, updateKnowledgeBaseTemplateUriResponseKnowledgeBase.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase is not found in the empty JSON string", UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase>() {
           @Override
           public void write(JsonWriter out, UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase
   * @throws IOException if the JSON string is invalid with respect to UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase
   */
  public static UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase.class);
  }

  /**
   * Convert an instance of UpdateKnowledgeBaseTemplateUriResponseKnowledgeBase to an JSON string
   *
   * @return JSON string
   */
