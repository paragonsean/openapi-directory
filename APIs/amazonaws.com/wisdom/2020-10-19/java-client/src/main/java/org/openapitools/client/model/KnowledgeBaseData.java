...
public class KnowledgeBaseData {
  ...
  public KnowledgeBaseData description(String description) {
  ...
  public KnowledgeBaseData knowledgeBaseArn(String knowledgeBaseArn) {
  ...
  public KnowledgeBaseData knowledgeBaseId(String knowledgeBaseId) {
  ...
  public KnowledgeBaseData knowledgeBaseType(KnowledgeBaseType knowledgeBaseType) {
  ...
  public KnowledgeBaseData lastContentModificationTime(OffsetDateTime lastContentModificationTime) {
  ...
  public KnowledgeBaseData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public KnowledgeBaseData renderingConfiguration(CreateKnowledgeBaseRequestRenderingConfiguration renderingConfiguration) {
  ...
  public KnowledgeBaseData serverSideEncryptionConfiguration(AssistantDataServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public KnowledgeBaseData sourceConfiguration(KnowledgeBaseDataSourceConfiguration sourceConfiguration) {
  ...
  public KnowledgeBaseData status(KnowledgeBaseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public KnowledgeBaseData tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KnowledgeBaseData knowledgeBaseData = (KnowledgeBaseData) o;
    return Objects.equals(this.description, knowledgeBaseData.description) &&
        Objects.equals(this.knowledgeBaseArn, knowledgeBaseData.knowledgeBaseArn) &&
        Objects.equals(this.knowledgeBaseId, knowledgeBaseData.knowledgeBaseId) &&
        Objects.equals(this.knowledgeBaseType, knowledgeBaseData.knowledgeBaseType) &&
        Objects.equals(this.lastContentModificationTime, knowledgeBaseData.lastContentModificationTime) &&
        Objects.equals(this.name, knowledgeBaseData.name) &&
        Objects.equals(this.renderingConfiguration, knowledgeBaseData.renderingConfiguration) &&
        Objects.equals(this.serverSideEncryptionConfiguration, knowledgeBaseData.serverSideEncryptionConfiguration) &&
        Objects.equals(this.sourceConfiguration, knowledgeBaseData.sourceConfiguration) &&
        Objects.equals(this.status, knowledgeBaseData.status) &&
        Objects.equals(this.tags, knowledgeBaseData.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class KnowledgeBaseData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KnowledgeBaseData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KnowledgeBaseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KnowledgeBaseData is not found in the empty JSON string", KnowledgeBaseData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KnowledgeBaseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KnowledgeBaseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KnowledgeBaseData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KnowledgeBaseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KnowledgeBaseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KnowledgeBaseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KnowledgeBaseData.class));

       return (TypeAdapter<T>) new TypeAdapter<KnowledgeBaseData>() {
           @Override
           public void write(JsonWriter out, KnowledgeBaseData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KnowledgeBaseData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KnowledgeBaseData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KnowledgeBaseData
   * @throws IOException if the JSON string is invalid with respect to KnowledgeBaseData
   */
  public static KnowledgeBaseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KnowledgeBaseData.class);
  }

  /**
   * Convert an instance of KnowledgeBaseData to an JSON string
   *
   * @return JSON string
   */
