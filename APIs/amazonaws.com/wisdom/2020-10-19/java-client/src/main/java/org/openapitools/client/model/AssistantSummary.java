...
public class AssistantSummary {
  ...
  public AssistantSummary() {
  }

  public AssistantSummary assistantArn(String assistantArn) {
  ...
  public AssistantSummary assistantId(String assistantId) {
  ...
  public AssistantSummary description(String description) {
  ...
  public AssistantSummary integrationConfiguration(AssistantDataIntegrationConfiguration integrationConfiguration) {
  ...
  public AssistantSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AssistantSummary serverSideEncryptionConfiguration(AssistantDataServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public AssistantSummary status(AssistantStatus status) {
    this.status = status;
    return this;
  }
  ...
  public AssistantSummary tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public AssistantSummary type(AssistantType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssistantSummary assistantSummary = (AssistantSummary) o;
    return Objects.equals(this.assistantArn, assistantSummary.assistantArn) &&
        Objects.equals(this.assistantId, assistantSummary.assistantId) &&
        Objects.equals(this.description, assistantSummary.description) &&
        Objects.equals(this.integrationConfiguration, assistantSummary.integrationConfiguration) &&
        Objects.equals(this.name, assistantSummary.name) &&
        Objects.equals(this.serverSideEncryptionConfiguration, assistantSummary.serverSideEncryptionConfiguration) &&
        Objects.equals(this.status, assistantSummary.status) &&
        Objects.equals(this.tags, assistantSummary.tags) &&
        Objects.equals(this.type, assistantSummary.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssistantSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssistantSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssistantSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssistantSummary is not found in the empty JSON string", AssistantSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssistantSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssistantSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssistantSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssistantSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssistantSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssistantSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssistantSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<AssistantSummary>() {
           @Override
           public void write(JsonWriter out, AssistantSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssistantSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssistantSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssistantSummary
   * @throws IOException if the JSON string is invalid with respect to AssistantSummary
   */
  public static AssistantSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssistantSummary.class);
  }

  /**
   * Convert an instance of AssistantSummary to an JSON string
   *
   * @return JSON string
   */
