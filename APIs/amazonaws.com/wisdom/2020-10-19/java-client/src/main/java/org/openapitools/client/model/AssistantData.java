...
public class AssistantData {
  ...
  public AssistantData assistantArn(String assistantArn) {
  ...
  public AssistantData assistantId(String assistantId) {
  ...
  public AssistantData description(String description) {
  ...
  public AssistantData integrationConfiguration(AssistantDataIntegrationConfiguration integrationConfiguration) {
  ...
  public AssistantData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AssistantData serverSideEncryptionConfiguration(AssistantDataServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public AssistantData status(AssistantStatus status) {
    this.status = status;
    return this;
  }
  ...
  public AssistantData tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public AssistantData type(AssistantType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssistantData assistantData = (AssistantData) o;
    return Objects.equals(this.assistantArn, assistantData.assistantArn) &&
        Objects.equals(this.assistantId, assistantData.assistantId) &&
        Objects.equals(this.description, assistantData.description) &&
        Objects.equals(this.integrationConfiguration, assistantData.integrationConfiguration) &&
        Objects.equals(this.name, assistantData.name) &&
        Objects.equals(this.serverSideEncryptionConfiguration, assistantData.serverSideEncryptionConfiguration) &&
        Objects.equals(this.status, assistantData.status) &&
        Objects.equals(this.tags, assistantData.tags) &&
        Objects.equals(this.type, assistantData.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssistantData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssistantData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssistantData is not found in the empty JSON string", AssistantData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssistantData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssistantData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssistantData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssistantData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssistantData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssistantData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssistantData.class));

       return (TypeAdapter<T>) new TypeAdapter<AssistantData>() {
           @Override
           public void write(JsonWriter out, AssistantData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssistantData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssistantData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssistantData
   * @throws IOException if the JSON string is invalid with respect to AssistantData
   */
  public static AssistantData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssistantData.class);
  }

  /**
   * Convert an instance of AssistantData to an JSON string
   *
   * @return JSON string
   */
