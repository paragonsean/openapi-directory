...
import org.openapitools.client.model.KnowledgeBaseSummarySourceConfiguration;
...
public class KnowledgeBaseSummary {
  ...
  private KnowledgeBaseSummarySourceConfiguration sourceConfiguration;
  ...
  public KnowledgeBaseSummary description(String description) {
  ...
  public KnowledgeBaseSummary knowledgeBaseArn(String knowledgeBaseArn) {
  ...
  public KnowledgeBaseSummary knowledgeBaseId(String knowledgeBaseId) {
  ...
  public KnowledgeBaseSummary knowledgeBaseType(KnowledgeBaseType knowledgeBaseType) {
  ...
  public KnowledgeBaseSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public KnowledgeBaseSummary renderingConfiguration(CreateKnowledgeBaseRequestRenderingConfiguration renderingConfiguration) {
  ...
  public KnowledgeBaseSummary serverSideEncryptionConfiguration(AssistantDataServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public KnowledgeBaseSummary sourceConfiguration(KnowledgeBaseSummarySourceConfiguration sourceConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public KnowledgeBaseSummarySourceConfiguration getSourceConfiguration() {
    return sourceConfiguration;
  }

  public void setSourceConfiguration(KnowledgeBaseSummarySourceConfiguration sourceConfiguration) {
    this.sourceConfiguration = sourceConfiguration;
  }


  public KnowledgeBaseSummary status(KnowledgeBaseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public KnowledgeBaseSummary tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KnowledgeBaseSummary knowledgeBaseSummary = (KnowledgeBaseSummary) o;
    return Objects.equals(this.description, knowledgeBaseSummary.description) &&
        Objects.equals(this.knowledgeBaseArn, knowledgeBaseSummary.knowledgeBaseArn) &&
        Objects.equals(this.knowledgeBaseId, knowledgeBaseSummary.knowledgeBaseId) &&
        Objects.equals(this.knowledgeBaseType, knowledgeBaseSummary.knowledgeBaseType) &&
        Objects.equals(this.name, knowledgeBaseSummary.name) &&
        Objects.equals(this.renderingConfiguration, knowledgeBaseSummary.renderingConfiguration) &&
        Objects.equals(this.serverSideEncryptionConfiguration, knowledgeBaseSummary.serverSideEncryptionConfiguration) &&
        Objects.equals(this.sourceConfiguration, knowledgeBaseSummary.sourceConfiguration) &&
        Objects.equals(this.status, knowledgeBaseSummary.status) &&
        Objects.equals(this.tags, knowledgeBaseSummary.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, knowledgeBaseArn, knowledgeBaseId, knowledgeBaseType, name, renderingConfiguration, serverSideEncryptionConfiguration, sourceConfiguration, status, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KnowledgeBaseSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KnowledgeBaseSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KnowledgeBaseSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KnowledgeBaseSummary is not found in the empty JSON string", KnowledgeBaseSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KnowledgeBaseSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KnowledgeBaseSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KnowledgeBaseSummary.openapiRequiredFields) {
      ...
      if (jsonObj.get("sourceConfiguration") != null && !jsonObj.get("sourceConfiguration").isJsonNull()) {
        KnowledgeBaseSummarySourceConfiguration.validateJsonElement(jsonObj.get("sourceConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KnowledgeBaseSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KnowledgeBaseSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KnowledgeBaseSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KnowledgeBaseSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<KnowledgeBaseSummary>() {
           @Override
           public void write(JsonWriter out, KnowledgeBaseSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KnowledgeBaseSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KnowledgeBaseSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KnowledgeBaseSummary
   * @throws IOException if the JSON string is invalid with respect to KnowledgeBaseSummary
   */
  public static KnowledgeBaseSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KnowledgeBaseSummary.class);
  }

  /**
   * Convert an instance of KnowledgeBaseSummary to an JSON string
   *
   * @return JSON string
   */
