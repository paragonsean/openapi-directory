...
public class CreateSessionResponse {
  ...
  private CreateSessionResponseSession session;

  public CreateSessionResponse() {
  }

  public CreateSessionResponse session(CreateSessionResponseSession session) {
  ...
  public CreateSessionResponseSession getSession() {
    return session;
  }

  public void setSession(CreateSessionResponseSession session) {
    this.session = session;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("session") != null && !jsonObj.get("session").isJsonNull()) {
        CreateSessionResponseSession.validateJsonElement(jsonObj.get("session"));
      }
  }
