...
|**knowledgeBaseType** | [**KnowledgeBaseTypeEnum**](#KnowledgeBaseTypeEnum) | The type of knowledge base. Only CUSTOM knowledge bases allow you to upload your own content. EXTERNAL knowledge bases support integrations with third-party systems whose content is synchronized automatically.  |  |
