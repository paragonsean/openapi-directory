...
class CreateAssistantAssociationResponse(Model):
    ...
    def __init__(self, assistant_association: CreateAssistantAssociationResponseAssistantAssociation=None):
        """CreateAssistantAssociationResponse - a model defined in OpenAPI

        :param assistant_association: The assistant_association of this CreateAssistantAssociationResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateAssistantAssociationResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateAssistantAssociationResponse of this CreateAssistantAssociationResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def assistant_association(self):
        """Gets the assistant_association of this CreateAssistantAssociationResponse.


        :return: The assistant_association of this CreateAssistantAssociationResponse.
    ...
    def assistant_association(self, assistant_association):
        """Sets the assistant_association of this CreateAssistantAssociationResponse.
