...
async def test_create_assistant(client):
    ...
    """
    body = {"serverSideEncryptionConfiguration":{"kmsKeyId":""},"clientToken":"","name":"","description":"","type":"","tags":""}
    headers = { 
...
async def test_create_assistant_association(client):
    """Test case for create_assistant_association

    
    """
    body = {"clientToken":"","associationType":"","association":{"knowledgeBaseId":""},"tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/assistants/{assistant_id}/associations'.format(assistant_id='assistant_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_content(client):
    ...
    """
    body = {"metadata":"","overrideLinkOutUri":"","uploadId":"","clientToken":"","name":"","title":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/knowledgeBases/{knowledge_base_id}/contents'.format(knowledge_base_id='knowledge_base_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_knowledge_base(client):
    ...
    """
    body = {"renderingConfiguration":{"templateUri":""},"serverSideEncryptionConfiguration":{"kmsKeyId":""},"sourceConfiguration":{"appIntegrations":{"appIntegrationArn":"","objectFields":""}},"clientToken":"","name":"","description":"","knowledgeBaseType":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_session(client):
    ...
    """
    body = {"clientToken":"","name":"","description":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/assistants/{assistant_id}/sessions'.format(assistant_id='assistant_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_assistant(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/assistants/{assistant_id}'.format(assistant_id='assistant_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_assistant_association(client):
    """Test case for delete_assistant_association
    ...
    response = await client.request(
        method='DELETE',
        path='/assistants/{assistant_id}/associations/{assistant_association_id}'.format(assistant_association_id='assistant_association_id_example', assistant_id='assistant_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_content(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/knowledgeBases/{knowledge_base_id}/contents/{content_id}'.format(content_id='content_id_example', knowledge_base_id='knowledge_base_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_knowledge_base(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/knowledgeBases/{knowledge_base_id}'.format(knowledge_base_id='knowledge_base_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_assistant_association(client):
    """Test case for get_assistant_association
...
async def test_get_content_summary(client):
    """Test case for get_content_summary
    ...
    response = await client.request(
        method='GET',
        path='/knowledgeBases/{knowledge_base_id}/contents/{content_id}/summary'.format(content_id='content_id_example', knowledge_base_id='knowledge_base_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_knowledge_base(client):
...
async def test_get_recommendations(client):
    ...
    response = await client.request(
        method='GET',
        path='/assistants/{assistant_id}/sessions/{session_id}/recommendations'.format(assistant_id='assistant_id_example', session_id='session_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_session(client):
    ...
    response = await client.request(
        method='GET',
        path='/assistants/{assistant_id}/sessions/{session_id}'.format(assistant_id='assistant_id_example', session_id='session_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_assistant_associations(client):
    """Test case for list_assistant_associations
...
async def test_list_contents(client):
...
async def test_notify_recommendations_received(client):
    """Test case for notify_recommendations_received
    ...
    response = await client.request(
        method='POST',
        path='/assistants/{assistant_id}/sessions/{session_id}/recommendations/notify'.format(assistant_id='assistant_id_example', session_id='session_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_query_assistant(client):
    """Test case for query_assistant

    
    """
    body = {"maxResults":"","nextToken":"","queryText":""}
    ...
    response = await client.request(
        method='POST',
        path='/assistants/{assistant_id}/query'.format(assistant_id='assistant_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_remove_knowledge_base_template_uri(client):
    """Test case for remove_knowledge_base_template_uri
    ...
    response = await client.request(
        method='DELETE',
        path='/knowledgeBases/{knowledge_base_id}/templateUri'.format(knowledge_base_id='knowledge_base_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_search_content(client):
    ...
    response = await client.request(
        method='POST',
        path='/knowledgeBases/{knowledge_base_id}/search'.format(knowledge_base_id='knowledge_base_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_search_sessions(client):
    ...
    response = await client.request(
        method='POST',
        path='/assistants/{assistant_id}/searchSessions'.format(assistant_id='assistant_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_start_content_upload(client):
    """Test case for start_content_upload
    ...
    response = await client.request(
        method='POST',
        path='/knowledgeBases/{knowledge_base_id}/upload'.format(knowledge_base_id='knowledge_base_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_content(client):
    ...
    """
    body = {"revisionId":"","metadata":"","removeOverrideLinkOutUri":"","overrideLinkOutUri":"","uploadId":"","title":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_knowledge_base_template_uri(client):
    """Test case for update_knowledge_base_template_uri
