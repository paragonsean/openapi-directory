...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.ContentData();
  });
  ...
  describe('ContentData', function() {
    it('should create an instance of ContentData', function() {
      // uncomment below and update the code to test ContentData
      //var instance = new AmazonConnectWisdomService.ContentData();
      //expect(instance).to.be.a(AmazonConnectWisdomService.ContentData);
    });
