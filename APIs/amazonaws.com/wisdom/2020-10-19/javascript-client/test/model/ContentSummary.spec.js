...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.ContentSummary();
  });
  ...
  describe('ContentSummary', function() {
    it('should create an instance of ContentSummary', function() {
      // uncomment below and update the code to test ContentSummary
      //var instance = new AmazonConnectWisdomService.ContentSummary();
      //expect(instance).to.be.a(AmazonConnectWisdomService.ContentSummary);
    });
