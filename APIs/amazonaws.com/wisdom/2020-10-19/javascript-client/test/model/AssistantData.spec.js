...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.AssistantData();
  });
  ...
  describe('AssistantData', function() {
    it('should create an instance of AssistantData', function() {
      // uncomment below and update the code to test AssistantData
      //var instance = new AmazonConnectWisdomService.AssistantData();
      //expect(instance).to.be.a(AmazonConnectWisdomService.AssistantData);
    });
