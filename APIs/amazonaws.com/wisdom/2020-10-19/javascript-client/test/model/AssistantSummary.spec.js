...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.AssistantSummary();
  });
  ...
  describe('AssistantSummary', function() {
    it('should create an instance of AssistantSummary', function() {
      // uncomment below and update the code to test AssistantSummary
      //var instance = new AmazonConnectWisdomService.AssistantSummary();
      //expect(instance).to.be.a(AmazonConnectWisdomService.AssistantSummary);
    });
