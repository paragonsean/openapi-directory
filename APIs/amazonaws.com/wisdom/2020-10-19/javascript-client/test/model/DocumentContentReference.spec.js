...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.DocumentContentReference();
  });
  ...
  describe('DocumentContentReference', function() {
    it('should create an instance of DocumentContentReference', function() {
      // uncomment below and update the code to test DocumentContentReference
      //var instance = new AmazonConnectWisdomService.DocumentContentReference();
      //expect(instance).to.be.a(AmazonConnectWisdomService.DocumentContentReference);
    });
