...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.Filter();
  });
  ...
  describe('Filter', function() {
    it('should create an instance of Filter', function() {
      ...
      //var instance = new AmazonConnectWisdomService.Filter();
      //expect(instance).to.be.a(AmazonConnectWisdomService.Filter);
    });
