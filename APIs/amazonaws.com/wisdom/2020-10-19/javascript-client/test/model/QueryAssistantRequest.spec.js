...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.QueryAssistantRequest();
  });
  ...
  describe('QueryAssistantRequest', function() {
    it('should create an instance of QueryAssistantRequest', function() {
      // uncomment below and update the code to test QueryAssistantRequest
      //var instance = new AmazonConnectWisdomService.QueryAssistantRequest();
      //expect(instance).to.be.a(AmazonConnectWisdomService.QueryAssistantRequest);
    });
