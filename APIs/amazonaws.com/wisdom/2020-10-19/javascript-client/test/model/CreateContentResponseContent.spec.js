...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.CreateContentResponseContent();
  });
  ...
  describe('CreateContentResponseContent', function() {
    it('should create an instance of CreateContentResponseContent', function() {
      // uncomment below and update the code to test CreateContentResponseContent
      //var instance = new AmazonConnectWisdomService.CreateContentResponseContent();
      //expect(instance).to.be.a(AmazonConnectWisdomService.CreateContentResponseContent);
    });
    ...
    it('should have the property linkOutUri (base name: "linkOutUri")', function() {
      // uncomment below and update the code to test the property linkOutUri
      //var instance = new AmazonConnectWisdomService.CreateContentResponseContent();
      //expect(instance).to.be();
    });
