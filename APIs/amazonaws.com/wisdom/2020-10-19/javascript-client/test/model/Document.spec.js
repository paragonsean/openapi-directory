...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.Document();
  });
  ...
  describe('Document', function() {
    it('should create an instance of Document', function() {
      ...
      //var instance = new AmazonConnectWisdomService.Document();
      //expect(instance).to.be.a(AmazonConnectWisdomService.Document);
    });
