...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.ContentReference();
  });
  ...
  describe('ContentReference', function() {
    it('should create an instance of ContentReference', function() {
      // uncomment below and update the code to test ContentReference
      //var instance = new AmazonConnectWisdomService.ContentReference();
      //expect(instance).to.be.a(AmazonConnectWisdomService.ContentReference);
    });
