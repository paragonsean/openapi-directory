...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectWisdomService.ResultData();
  });
  ...
  describe('ResultData', function() {
    it('should create an instance of ResultData', function() {
      // uncomment below and update the code to test ResultData
      //var instance = new AmazonConnectWisdomService.ResultData();
      //expect(instance).to.be.a(AmazonConnectWisdomService.ResultData);
    });
