...
/*
 * OAISubscribeToEventRequest.h
 *
 * 
 */

#ifndef OAISubscribeToEventRequest_H
#define OAISubscribeToEventRequest_H
...
class OAISubscribeToEventRequest : public OAIObject {
public:
    OAISubscribeToEventRequest();
    OAISubscribeToEventRequest(QString json);
    ~OAISubscribeToEventRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscribeToEventRequest)

#endif // OAISubscribeToEventRequest_H
