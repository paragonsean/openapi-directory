...
OAIScopeType OAIScope::getKey() const {
    return m_key;
}
void OAIScope::setKey(const OAIScopeType &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIScope::is_key_Set() const{
    return m_key_isSet;
}

bool OAIScope::is_key_Valid() const{
    return m_key_isValid;
}

QString OAIScope::getValue() const {
    return m_value;
}
void OAIScope::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIScope::is_value_Set() const{
    return m_value_isSet;
}

bool OAIScope::is_value_Valid() const{
