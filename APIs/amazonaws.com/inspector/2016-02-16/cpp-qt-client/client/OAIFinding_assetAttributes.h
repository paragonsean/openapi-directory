...
/*
 * OAIFinding_assetAttributes.h
 *
 * 
 */

#ifndef OAIFinding_assetAttributes_H
#define OAIFinding_assetAttributes_H
...
class OAIFinding_assetAttributes : public OAIObject {
public:
    OAIFinding_assetAttributes();
    OAIFinding_assetAttributes(QString json);
    ~OAIFinding_assetAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFinding_assetAttributes)

#endif // OAIFinding_assetAttributes_H
