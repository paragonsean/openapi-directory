...
OAIAssetAttributes::OAIAssetAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssetAttributes::OAIAssetAttributes() {
    this->initializeModel();
}

OAIAssetAttributes::~OAIAssetAttributes() {}

void OAIAssetAttributes::initializeModel() {
...
void OAIAssetAttributes::fromJson(QString jsonString) {
...
void OAIAssetAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIAssetAttributes::asJson() const {
...
QJsonObject OAIAssetAttributes::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAssetAttributes::getSchemaVersion() const {
    return m_schema_version;
}
void OAIAssetAttributes::setSchemaVersion(const qint32 &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAIAssetAttributes::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAIAssetAttributes::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

QString OAIAssetAttributes::getAgentId() const {
    return m_agent_id;
}
void OAIAssetAttributes::setAgentId(const QString &agent_id) {
    m_agent_id = agent_id;
    m_agent_id_isSet = true;
}

bool OAIAssetAttributes::is_agent_id_Set() const{
    return m_agent_id_isSet;
}

bool OAIAssetAttributes::is_agent_id_Valid() const{
    return m_agent_id_isValid;
}

QString OAIAssetAttributes::getAutoScalingGroup() const {
    return m_auto_scaling_group;
}
void OAIAssetAttributes::setAutoScalingGroup(const QString &auto_scaling_group) {
    m_auto_scaling_group = auto_scaling_group;
    m_auto_scaling_group_isSet = true;
}

bool OAIAssetAttributes::is_auto_scaling_group_Set() const{
    return m_auto_scaling_group_isSet;
}

bool OAIAssetAttributes::is_auto_scaling_group_Valid() const{
    return m_auto_scaling_group_isValid;
}

QString OAIAssetAttributes::getAmiId() const {
    return m_ami_id;
}
void OAIAssetAttributes::setAmiId(const QString &ami_id) {
    m_ami_id = ami_id;
    m_ami_id_isSet = true;
}

bool OAIAssetAttributes::is_ami_id_Set() const{
    return m_ami_id_isSet;
}

bool OAIAssetAttributes::is_ami_id_Valid() const{
    return m_ami_id_isValid;
}

QString OAIAssetAttributes::getHostname() const {
    return m_hostname;
}
void OAIAssetAttributes::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAIAssetAttributes::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAIAssetAttributes::is_hostname_Valid() const{
    return m_hostname_isValid;
}

QList OAIAssetAttributes::getIpv4Addresses() const {
    return m_ipv4_addresses;
}
void OAIAssetAttributes::setIpv4Addresses(const QList &ipv4_addresses) {
    m_ipv4_addresses = ipv4_addresses;
    m_ipv4_addresses_isSet = true;
}

bool OAIAssetAttributes::is_ipv4_addresses_Set() const{
    return m_ipv4_addresses_isSet;
}

bool OAIAssetAttributes::is_ipv4_addresses_Valid() const{
    return m_ipv4_addresses_isValid;
}

QList OAIAssetAttributes::getTags() const {
    return m_tags;
}
void OAIAssetAttributes::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIAssetAttributes::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIAssetAttributes::is_tags_Valid() const{
    return m_tags_isValid;
}

QList OAIAssetAttributes::getNetworkInterfaces() const {
    return m_network_interfaces;
}
void OAIAssetAttributes::setNetworkInterfaces(const QList &network_interfaces) {
    m_network_interfaces = network_interfaces;
    m_network_interfaces_isSet = true;
}

bool OAIAssetAttributes::is_network_interfaces_Set() const{
    return m_network_interfaces_isSet;
}

bool OAIAssetAttributes::is_network_interfaces_Valid() const{
    return m_network_interfaces_isValid;
}

bool OAIAssetAttributes::isSet() const {
...
bool OAIAssetAttributes::isValid() const {
