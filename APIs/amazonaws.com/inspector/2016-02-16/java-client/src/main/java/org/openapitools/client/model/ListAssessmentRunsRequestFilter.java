...
public class ListAssessmentRunsRequestFilter {
  ...
  public ListAssessmentRunsRequestFilter() {
  }

  public ListAssessmentRunsRequestFilter namePattern(String namePattern) {
  ...
  public ListAssessmentRunsRequestFilter states(List states) {
    this.states = states;
    return this;
  }
  ...
  public ListAssessmentRunsRequestFilter durationRange(AssessmentRunFilterDurationRange durationRange) {
  ...
  public ListAssessmentRunsRequestFilter rulesPackageArns(List rulesPackageArns) {
  ...
  public ListAssessmentRunsRequestFilter startTimeRange(AssessmentRunFilterStartTimeRange startTimeRange) {
  ...
  public ListAssessmentRunsRequestFilter completionTimeRange(AssessmentRunFilterCompletionTimeRange completionTimeRange) {
  ...
  public ListAssessmentRunsRequestFilter stateChangeTimeRange(AssessmentRunFilterStateChangeTimeRange stateChangeTimeRange) {
  ...
  public boolean equals(Object o) {
    ...
    ListAssessmentRunsRequestFilter listAssessmentRunsRequestFilter = (ListAssessmentRunsRequestFilter) o;
    return Objects.equals(this.namePattern, listAssessmentRunsRequestFilter.namePattern) &&
        Objects.equals(this.states, listAssessmentRunsRequestFilter.states) &&
        Objects.equals(this.durationRange, listAssessmentRunsRequestFilter.durationRange) &&
        Objects.equals(this.rulesPackageArns, listAssessmentRunsRequestFilter.rulesPackageArns) &&
        Objects.equals(this.startTimeRange, listAssessmentRunsRequestFilter.startTimeRange) &&
        Objects.equals(this.completionTimeRange, listAssessmentRunsRequestFilter.completionTimeRange) &&
        Objects.equals(this.stateChangeTimeRange, listAssessmentRunsRequestFilter.stateChangeTimeRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAssessmentRunsRequestFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAssessmentRunsRequestFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAssessmentRunsRequestFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAssessmentRunsRequestFilter is not found in the empty JSON string", ListAssessmentRunsRequestFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAssessmentRunsRequestFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAssessmentRunsRequestFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAssessmentRunsRequestFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAssessmentRunsRequestFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAssessmentRunsRequestFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAssessmentRunsRequestFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAssessmentRunsRequestFilter>() {
           @Override
           public void write(JsonWriter out, ListAssessmentRunsRequestFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAssessmentRunsRequestFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAssessmentRunsRequestFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAssessmentRunsRequestFilter
   * @throws IOException if the JSON string is invalid with respect to ListAssessmentRunsRequestFilter
   */
  public static ListAssessmentRunsRequestFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAssessmentRunsRequestFilter.class);
  }

  /**
   * Convert an instance of ListAssessmentRunsRequestFilter to an JSON string
   *
   * @return JSON string
   */
