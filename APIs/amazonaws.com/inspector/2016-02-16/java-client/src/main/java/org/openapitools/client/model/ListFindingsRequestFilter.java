...
public class ListFindingsRequestFilter {
  ...
  public ListFindingsRequestFilter() {
  }

  public ListFindingsRequestFilter agentIds(List agentIds) {
  ...
  public ListFindingsRequestFilter autoScalingGroups(List autoScalingGroups) {
  ...
  public ListFindingsRequestFilter ruleNames(List ruleNames) {
  ...
  public ListFindingsRequestFilter severities(List severities) {
  ...
  public ListFindingsRequestFilter rulesPackageArns(List rulesPackageArns) {
  ...
  public ListFindingsRequestFilter attributes(List attributes) {
  ...
  public ListFindingsRequestFilter userAttributes(List userAttributes) {
  ...
  public ListFindingsRequestFilter creationTimeRange(FindingFilterCreationTimeRange creationTimeRange) {
  ...
  public boolean equals(Object o) {
    ...
    ListFindingsRequestFilter listFindingsRequestFilter = (ListFindingsRequestFilter) o;
    return Objects.equals(this.agentIds, listFindingsRequestFilter.agentIds) &&
        Objects.equals(this.autoScalingGroups, listFindingsRequestFilter.autoScalingGroups) &&
        Objects.equals(this.ruleNames, listFindingsRequestFilter.ruleNames) &&
        Objects.equals(this.severities, listFindingsRequestFilter.severities) &&
        Objects.equals(this.rulesPackageArns, listFindingsRequestFilter.rulesPackageArns) &&
        Objects.equals(this.attributes, listFindingsRequestFilter.attributes) &&
        Objects.equals(this.userAttributes, listFindingsRequestFilter.userAttributes) &&
        Objects.equals(this.creationTimeRange, listFindingsRequestFilter.creationTimeRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListFindingsRequestFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFindingsRequestFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFindingsRequestFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFindingsRequestFilter is not found in the empty JSON string", ListFindingsRequestFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFindingsRequestFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFindingsRequestFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFindingsRequestFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFindingsRequestFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFindingsRequestFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFindingsRequestFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFindingsRequestFilter>() {
           @Override
           public void write(JsonWriter out, ListFindingsRequestFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFindingsRequestFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFindingsRequestFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFindingsRequestFilter
   * @throws IOException if the JSON string is invalid with respect to ListFindingsRequestFilter
   */
  public static ListFindingsRequestFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFindingsRequestFilter.class);
  }

  /**
   * Convert an instance of ListFindingsRequestFilter to an JSON string
   *
   * @return JSON string
   */
