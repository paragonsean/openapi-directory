...
public class Scope {
  ...
  public Scope key(ScopeType key) {
    this.key = key;
    return this;
  }
  ...
  public ScopeType getKey() {
    return key;
  }

  public void setKey(ScopeType key) {
    this.key = key;
  }
  ...
  public boolean equals(Object o) {
    ...
    Scope scope = (Scope) o;
    return Objects.equals(this.key, scope.key) &&
        Objects.equals(this.value, scope.value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("key") != null && !jsonObj.get("key").isJsonNull()) {
        ScopeType.validateJsonElement(jsonObj.get("key"));
      }
