...
public class EventSubscription {
  ...
  public EventSubscription event(InspectorEvent event) {
    this.event = event;
    return this;
  }
  ...
  public EventSubscription subscribedAt(OffsetDateTime subscribedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.event, eventSubscription.event) &&
        Objects.equals(this.subscribedAt, eventSubscription.subscribedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(event, subscribedAt);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("subscribedAt");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `subscribedAt`
      OffsetDateTime.validateJsonElement(jsonObj.get("subscribedAt"));
  }
