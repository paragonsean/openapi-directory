...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInspector.PrivateIp();
  });
  ...
  describe('PrivateIp', function() {
    it('should create an instance of PrivateIp', function() {
      // uncomment below and update the code to test PrivateIp
      //var instance = new AmazonInspector.PrivateIp();
      //expect(instance).to.be.a(AmazonInspector.PrivateIp);
    });
