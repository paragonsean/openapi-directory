...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.LoRaWANGatewayMetadata();
  });
  ...
  describe('LoRaWANGatewayMetadata', function() {
    it('should create an instance of LoRaWANGatewayMetadata', function() {
      // uncomment below and update the code to test LoRaWANGatewayMetadata
      //var instance = new AwsIoTWireless.LoRaWANGatewayMetadata();
      //expect(instance).to.be.a(AwsIoTWireless.LoRaWANGatewayMetadata);
    });
