...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.SidewalkDeviceMetadata();
  });
  ...
  describe('SidewalkDeviceMetadata', function() {
    it('should create an instance of SidewalkDeviceMetadata', function() {
      // uncomment below and update the code to test SidewalkDeviceMetadata
      //var instance = new AwsIoTWireless.SidewalkDeviceMetadata();
      //expect(instance).to.be.a(AwsIoTWireless.SidewalkDeviceMetadata);
    });
