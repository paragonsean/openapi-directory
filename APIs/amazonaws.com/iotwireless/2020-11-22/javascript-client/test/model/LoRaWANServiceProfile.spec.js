...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.LoRaWANServiceProfile();
  });
  ...
  describe('LoRaWANServiceProfile', function() {
    it('should create an instance of LoRaWANServiceProfile', function() {
      // uncomment below and update the code to test LoRaWANServiceProfile
      //var instance = new AwsIoTWireless.LoRaWANServiceProfile();
      //expect(instance).to.be.a(AwsIoTWireless.LoRaWANServiceProfile);
    });
