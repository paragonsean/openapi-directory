...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.Destinations();
  });
  ...
  describe('Destinations', function() {
    it('should create an instance of Destinations', function() {
      // uncomment below and update the code to test Destinations
      //var instance = new AwsIoTWireless.Destinations();
      //expect(instance).to.be.a(AwsIoTWireless.Destinations);
    });
