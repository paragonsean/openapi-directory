...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.GetServiceEndpointResponse();
  });
  ...
  describe('GetServiceEndpointResponse', function() {
    it('should create an instance of GetServiceEndpointResponse', function() {
      // uncomment below and update the code to test GetServiceEndpointResponse
      //var instance = new AwsIoTWireless.GetServiceEndpointResponse();
      //expect(instance).to.be.a(AwsIoTWireless.GetServiceEndpointResponse);
    });
