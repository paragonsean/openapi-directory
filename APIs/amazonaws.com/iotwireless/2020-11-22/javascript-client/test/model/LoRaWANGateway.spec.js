...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.LoRaWANGateway();
  });
  ...
  describe('LoRaWANGateway', function() {
    it('should create an instance of LoRaWANGateway', function() {
      // uncomment below and update the code to test LoRaWANGateway
      //var instance = new AwsIoTWireless.LoRaWANGateway();
      //expect(instance).to.be.a(AwsIoTWireless.LoRaWANGateway);
    });
