...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.GlobalIdentity();
  });
  ...
  describe('GlobalIdentity', function() {
    it('should create an instance of GlobalIdentity', function() {
      // uncomment below and update the code to test GlobalIdentity
      //var instance = new AwsIoTWireless.GlobalIdentity();
      //expect(instance).to.be.a(AwsIoTWireless.GlobalIdentity);
    });
