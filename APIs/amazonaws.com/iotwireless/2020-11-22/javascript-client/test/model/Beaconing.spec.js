...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.Beaconing();
  });
  ...
  describe('Beaconing', function() {
    it('should create an instance of Beaconing', function() {
      // uncomment below and update the code to test Beaconing
      //var instance = new AwsIoTWireless.Beaconing();
      //expect(instance).to.be.a(AwsIoTWireless.Beaconing);
    });
