...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTWireless.WiFiAccessPoint();
  });
  ...
  describe('WiFiAccessPoint', function() {
    it('should create an instance of WiFiAccessPoint', function() {
      // uncomment below and update the code to test WiFiAccessPoint
      //var instance = new AwsIoTWireless.WiFiAccessPoint();
      //expect(instance).to.be.a(AwsIoTWireless.WiFiAccessPoint);
    });
