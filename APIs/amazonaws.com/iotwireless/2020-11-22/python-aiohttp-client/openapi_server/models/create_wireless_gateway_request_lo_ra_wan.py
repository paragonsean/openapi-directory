...
class CreateWirelessGatewayRequestLoRaWAN(Model):
    ...
    def __init__(self, gateway_eui: str=None, rf_region: str=None, join_eui_filters: List[List[str]]=None, net_id_filters: List[str]=None, sub_bands: List[int]=None, beaconing: CreateWirelessGatewayRequestLoRaWANBeaconing=None, max_eirp: float=None):
        """CreateWirelessGatewayRequestLoRaWAN - a model defined in OpenAPI

        :param gateway_eui: The gateway_eui of this CreateWirelessGatewayRequestLoRaWAN.
        :param rf_region: The rf_region of this CreateWirelessGatewayRequestLoRaWAN.
        :param join_eui_filters: The join_eui_filters of this CreateWirelessGatewayRequestLoRaWAN.
        :param net_id_filters: The net_id_filters of this CreateWirelessGatewayRequestLoRaWAN.
        :param sub_bands: The sub_bands of this CreateWirelessGatewayRequestLoRaWAN.
        :param beaconing: The beaconing of this CreateWirelessGatewayRequestLoRaWAN.
        :param max_eirp: The max_eirp of this CreateWirelessGatewayRequestLoRaWAN.
        """
        self.openapi_types = {
            'gateway_eui': str,
            'rf_region': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateWirelessGatewayRequestLoRaWAN':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateWirelessGatewayRequest_LoRaWAN of this CreateWirelessGatewayRequestLoRaWAN.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_eui(self):
        """Gets the gateway_eui of this CreateWirelessGatewayRequestLoRaWAN.


        :return: The gateway_eui of this CreateWirelessGatewayRequestLoRaWAN.
        :rtype: str
        """
    ...
    def gateway_eui(self, gateway_eui):
        """Sets the gateway_eui of this CreateWirelessGatewayRequestLoRaWAN.
    ...
    @property
    def rf_region(self):
        """Gets the rf_region of this CreateWirelessGatewayRequestLoRaWAN.


        :return: The rf_region of this CreateWirelessGatewayRequestLoRaWAN.
        :rtype: str
        """
    ...
    def rf_region(self, rf_region):
        """Sets the rf_region of this CreateWirelessGatewayRequestLoRaWAN.
    ...
    def join_eui_filters(self):
        """Gets the join_eui_filters of this CreateWirelessGatewayRequestLoRaWAN.

        A list of JoinEuiRange used by LoRa gateways to filter LoRa frames.

        :return: The join_eui_filters of this CreateWirelessGatewayRequestLoRaWAN.
        :rtype: List[List[str]]
        """
    ...
    def join_eui_filters(self, join_eui_filters):
        """Sets the join_eui_filters of this CreateWirelessGatewayRequestLoRaWAN.
    ...
    def net_id_filters(self):
        """Gets the net_id_filters of this CreateWirelessGatewayRequestLoRaWAN.

        A list of NetId values that are used by LoRa gateways to filter the uplink frames.

        :return: The net_id_filters of this CreateWirelessGatewayRequestLoRaWAN.
        :rtype: List[str]
        """
    ...
    def net_id_filters(self, net_id_filters):
        """Sets the net_id_filters of this CreateWirelessGatewayRequestLoRaWAN.
    ...
    @property
    def sub_bands(self):
        """Gets the sub_bands of this CreateWirelessGatewayRequestLoRaWAN.

        A list of integer indicating which sub bands are supported by LoRa gateway.

        :return: The sub_bands of this CreateWirelessGatewayRequestLoRaWAN.
        :rtype: List[int]
        """
    ...
    def sub_bands(self, sub_bands):
        """Sets the sub_bands of this CreateWirelessGatewayRequestLoRaWAN.
    ...
    @property
    def beaconing(self):
        """Gets the beaconing of this CreateWirelessGatewayRequestLoRaWAN.


        :return: The beaconing of this CreateWirelessGatewayRequestLoRaWAN.
    ...
    def beaconing(self, beaconing):
        """Sets the beaconing of this CreateWirelessGatewayRequestLoRaWAN.
    ...
    @property
    def max_eirp(self):
        """Gets the max_eirp of this CreateWirelessGatewayRequestLoRaWAN.


        :return: The max_eirp of this CreateWirelessGatewayRequestLoRaWAN.
        :rtype: float
        """
    ...
    def max_eirp(self, max_eirp):
        """Sets the max_eirp of this CreateWirelessGatewayRequestLoRaWAN.
