...
class Gnss(Model):
    ...
    def __init__(self, payload: str=None, capture_time: float=None, capture_time_accuracy: float=None, assist_position: List=None, assist_altitude: float=None, use2_d_solver: bool=None):
        """Gnss - a model defined in OpenAPI

        :param payload: The payload of this Gnss.
        :param capture_time: The capture_time of this Gnss.
        :param capture_time_accuracy: The capture_time_accuracy of this Gnss.
        :param assist_position: The assist_position of this Gnss.
        :param assist_altitude: The assist_altitude of this Gnss.
        :param use2_d_solver: The use2_d_solver of this Gnss.
        """
        self.openapi_types = {
            'payload': str,
            'capture_time': float,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Gnss':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Gnss of this Gnss.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def payload(self):
        """Gets the payload of this Gnss.


        :return: The payload of this Gnss.
        :rtype: str
        """
    ...
    def capture_time(self):
        """Gets the capture_time of this Gnss.


        :return: The capture_time of this Gnss.
        :rtype: float
        """
    ...
    def capture_time(self, capture_time):
        """Sets the capture_time of this Gnss.
    ...
    def capture_time_accuracy(self):
        """Gets the capture_time_accuracy of this Gnss.


        :return: The capture_time_accuracy of this Gnss.
        :rtype: float
        """
    ...
    def capture_time_accuracy(self, capture_time_accuracy):
        """Sets the capture_time_accuracy of this Gnss.
    ...
    def assist_position(self):
        """Gets the assist_position of this Gnss.


        :return: The assist_position of this Gnss.
        :rtype: List
        """
    ...
    def assist_position(self, assist_position):
        """Sets the assist_position of this Gnss.
    ...
    def assist_altitude(self):
        """Gets the assist_altitude of this Gnss.


        :return: The assist_altitude of this Gnss.
        :rtype: float
        """
    ...
    def assist_altitude(self, assist_altitude):
        """Sets the assist_altitude of this Gnss.
    ...
    def use2_d_solver(self):
        """Gets the use2_d_solver of this Gnss.


        :return: The use2_d_solver of this Gnss.
        :rtype: bool
        """
    ...
    def use2_d_solver(self, use2_d_solver):
        """Sets the use2_d_solver of this Gnss.
