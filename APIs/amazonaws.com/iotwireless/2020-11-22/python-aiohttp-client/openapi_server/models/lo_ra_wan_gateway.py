...
class LoRaWANGateway(Model):
    ...
    def __init__(self, gateway_eui: str=None, rf_region: str=None, join_eui_filters: List[List[str]]=None, net_id_filters: List[str]=None, sub_bands: List[int]=None, beaconing: CreateWirelessGatewayRequestLoRaWANBeaconing=None, max_eirp: float=None):
        """LoRaWANGateway - a model defined in OpenAPI

        :param gateway_eui: The gateway_eui of this LoRaWANGateway.
        :param rf_region: The rf_region of this LoRaWANGateway.
        :param join_eui_filters: The join_eui_filters of this LoRaWANGateway.
        :param net_id_filters: The net_id_filters of this LoRaWANGateway.
        :param sub_bands: The sub_bands of this LoRaWANGateway.
        :param beaconing: The beaconing of this LoRaWANGateway.
        :param max_eirp: The max_eirp of this LoRaWANGateway.
        """
        self.openapi_types = {
            'gateway_eui': str,
            'rf_region': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'LoRaWANGateway':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The LoRaWANGateway of this LoRaWANGateway.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_eui(self):
        """Gets the gateway_eui of this LoRaWANGateway.


        :return: The gateway_eui of this LoRaWANGateway.
        :rtype: str
        """
    ...
    def gateway_eui(self, gateway_eui):
        """Sets the gateway_eui of this LoRaWANGateway.
    ...
    @property
    def rf_region(self):
        """Gets the rf_region of this LoRaWANGateway.


        :return: The rf_region of this LoRaWANGateway.
        :rtype: str
        """
    ...
    def rf_region(self, rf_region):
        """Sets the rf_region of this LoRaWANGateway.
    ...
    def join_eui_filters(self):
        """Gets the join_eui_filters of this LoRaWANGateway.

        A list of JoinEuiRange used by LoRa gateways to filter LoRa frames.

        :return: The join_eui_filters of this LoRaWANGateway.
        :rtype: List[List[str]]
        """
    ...
    def join_eui_filters(self, join_eui_filters):
        """Sets the join_eui_filters of this LoRaWANGateway.
    ...
    def net_id_filters(self):
        """Gets the net_id_filters of this LoRaWANGateway.

        A list of NetId values that are used by LoRa gateways to filter the uplink frames.

        :return: The net_id_filters of this LoRaWANGateway.
        :rtype: List[str]
        """
    ...
    def net_id_filters(self, net_id_filters):
        """Sets the net_id_filters of this LoRaWANGateway.
    ...
    @property
    def sub_bands(self):
        """Gets the sub_bands of this LoRaWANGateway.

        A list of integer indicating which sub bands are supported by LoRa gateway.

        :return: The sub_bands of this LoRaWANGateway.
        :rtype: List[int]
        """
    ...
    def sub_bands(self, sub_bands):
        """Sets the sub_bands of this LoRaWANGateway.
    ...
    @property
    def beaconing(self):
        """Gets the beaconing of this LoRaWANGateway.


        :return: The beaconing of this LoRaWANGateway.
    ...
    def beaconing(self, beaconing):
        """Sets the beaconing of this LoRaWANGateway.
    ...
    @property
    def max_eirp(self):
        """Gets the max_eirp of this LoRaWANGateway.


        :return: The max_eirp of this LoRaWANGateway.
        :rtype: float
        """
    ...
    def max_eirp(self, max_eirp):
        """Sets the max_eirp of this LoRaWANGateway.
