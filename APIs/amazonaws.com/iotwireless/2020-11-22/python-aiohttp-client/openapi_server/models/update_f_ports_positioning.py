...
class UpdateFPortsPositioning(Model):
    ...
    def __init__(self, clock_sync: int=None, stream: int=None, gnss: int=None):
        """UpdateFPortsPositioning - a model defined in OpenAPI

        :param clock_sync: The clock_sync of this UpdateFPortsPositioning.
        :param stream: The stream of this UpdateFPortsPositioning.
        :param gnss: The gnss of this UpdateFPortsPositioning.
        """
        self.openapi_types = {
            'clock_sync': int,
            'stream': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateFPortsPositioning':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateFPorts_Positioning of this UpdateFPortsPositioning.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def clock_sync(self):
        """Gets the clock_sync of this UpdateFPortsPositioning.

        The Fport value.

        :return: The clock_sync of this UpdateFPortsPositioning.
        :rtype: int
        """
    ...
    def clock_sync(self, clock_sync):
        """Sets the clock_sync of this UpdateFPortsPositioning.
    ...
    @property
    def stream(self):
        """Gets the stream of this UpdateFPortsPositioning.

        The Fport value.

        :return: The stream of this UpdateFPortsPositioning.
        :rtype: int
        """
        return self._stream
    ...
    def stream(self, stream):
        """Sets the stream of this UpdateFPortsPositioning.
    ...
    @property
    def gnss(self):
        """Gets the gnss of this UpdateFPortsPositioning.

        The Fport value.

        :return: The gnss of this UpdateFPortsPositioning.
        :rtype: int
        """
        return self._gnss
    ...
    @gnss.setter
    def gnss(self, gnss):
        """Sets the gnss of this UpdateFPortsPositioning.
