...
class WirelessGatewayStatisticsLoRaWAN(Model):
    ...
    def __init__(self, gateway_eui: str=None, rf_region: str=None, join_eui_filters: List[List[str]]=None, net_id_filters: List[str]=None, sub_bands: List[int]=None, beaconing: CreateWirelessGatewayRequestLoRaWANBeaconing=None, max_eirp: float=None):
        """WirelessGatewayStatisticsLoRaWAN - a model defined in OpenAPI

        :param gateway_eui: The gateway_eui of this WirelessGatewayStatisticsLoRaWAN.
        :param rf_region: The rf_region of this WirelessGatewayStatisticsLoRaWAN.
        :param join_eui_filters: The join_eui_filters of this WirelessGatewayStatisticsLoRaWAN.
        :param net_id_filters: The net_id_filters of this WirelessGatewayStatisticsLoRaWAN.
        :param sub_bands: The sub_bands of this WirelessGatewayStatisticsLoRaWAN.
        :param beaconing: The beaconing of this WirelessGatewayStatisticsLoRaWAN.
        :param max_eirp: The max_eirp of this WirelessGatewayStatisticsLoRaWAN.
        """
        self.openapi_types = {
            'gateway_eui': str,
            'rf_region': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'WirelessGatewayStatisticsLoRaWAN':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The WirelessGatewayStatistics_LoRaWAN of this WirelessGatewayStatisticsLoRaWAN.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gateway_eui(self):
        """Gets the gateway_eui of this WirelessGatewayStatisticsLoRaWAN.


        :return: The gateway_eui of this WirelessGatewayStatisticsLoRaWAN.
        :rtype: str
        """
    ...
    def gateway_eui(self, gateway_eui):
        """Sets the gateway_eui of this WirelessGatewayStatisticsLoRaWAN.
    ...
    @property
    def rf_region(self):
        """Gets the rf_region of this WirelessGatewayStatisticsLoRaWAN.


        :return: The rf_region of this WirelessGatewayStatisticsLoRaWAN.
        :rtype: str
        """
    ...
    def rf_region(self, rf_region):
        """Sets the rf_region of this WirelessGatewayStatisticsLoRaWAN.
    ...
    def join_eui_filters(self):
        """Gets the join_eui_filters of this WirelessGatewayStatisticsLoRaWAN.

        A list of JoinEuiRange used by LoRa gateways to filter LoRa frames.

        :return: The join_eui_filters of this WirelessGatewayStatisticsLoRaWAN.
        :rtype: List[List[str]]
        """
    ...
    def join_eui_filters(self, join_eui_filters):
        """Sets the join_eui_filters of this WirelessGatewayStatisticsLoRaWAN.
    ...
    def net_id_filters(self):
        """Gets the net_id_filters of this WirelessGatewayStatisticsLoRaWAN.

        A list of NetId values that are used by LoRa gateways to filter the uplink frames.

        :return: The net_id_filters of this WirelessGatewayStatisticsLoRaWAN.
        :rtype: List[str]
        """
    ...
    def net_id_filters(self, net_id_filters):
        """Sets the net_id_filters of this WirelessGatewayStatisticsLoRaWAN.
    ...
    @property
    def sub_bands(self):
        """Gets the sub_bands of this WirelessGatewayStatisticsLoRaWAN.

        A list of integer indicating which sub bands are supported by LoRa gateway.

        :return: The sub_bands of this WirelessGatewayStatisticsLoRaWAN.
        :rtype: List[int]
        """
    ...
    def sub_bands(self, sub_bands):
        """Sets the sub_bands of this WirelessGatewayStatisticsLoRaWAN.
    ...
    @property
    def beaconing(self):
        """Gets the beaconing of this WirelessGatewayStatisticsLoRaWAN.


        :return: The beaconing of this WirelessGatewayStatisticsLoRaWAN.
    ...
    def beaconing(self, beaconing):
        """Sets the beaconing of this WirelessGatewayStatisticsLoRaWAN.
    ...
    @property
    def max_eirp(self):
        """Gets the max_eirp of this WirelessGatewayStatisticsLoRaWAN.


        :return: The max_eirp of this WirelessGatewayStatisticsLoRaWAN.
        :rtype: float
        """
    ...
    def max_eirp(self, max_eirp):
        """Sets the max_eirp of this WirelessGatewayStatisticsLoRaWAN.
