...
/*
 * OAICreateWirelessGatewayRequest_LoRaWAN.h
 *
 * 
 */

#ifndef OAICreateWirelessGatewayRequest_LoRaWAN_H
#define OAICreateWirelessGatewayRequest_LoRaWAN_H
...
class OAICreateWirelessGatewayRequest_LoRaWAN : public OAIObject {
public:
    OAICreateWirelessGatewayRequest_LoRaWAN();
    OAICreateWirelessGatewayRequest_LoRaWAN(QString json);
    ~OAICreateWirelessGatewayRequest_LoRaWAN() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWirelessGatewayRequest_LoRaWAN)

#endif // OAICreateWirelessGatewayRequest_LoRaWAN_H
