...
/*
 * OAIUpdateFPorts_Positioning.h
 *
 * 
 */

#ifndef OAIUpdateFPorts_Positioning_H
#define OAIUpdateFPorts_Positioning_H
...
class OAIUpdateFPorts_Positioning : public OAIObject {
public:
    OAIUpdateFPorts_Positioning();
    OAIUpdateFPorts_Positioning(QString json);
    ~OAIUpdateFPorts_Positioning() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFPorts_Positioning)

#endif // OAIUpdateFPorts_Positioning_H
