...
/*
 * OAISidewalkGetStartImportInfo.h
 *
 * Sidewalk-related information for devices in an import task that are being onboarded.
 */

#ifndef OAISidewalkGetStartImportInfo_H
#define OAISidewalkGetStartImportInfo_H
...
class OAISidewalkGetStartImportInfo : public OAIObject {
public:
    OAISidewalkGetStartImportInfo();
    OAISidewalkGetStartImportInfo(QString json);
    ~OAISidewalkGetStartImportInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISidewalkGetStartImportInfo)

#endif // OAISidewalkGetStartImportInfo_H
