...
#ifndef OAIAbpV1_0_x_H
#define OAIAbpV1_0_x_H
...
class OAIAbpV1_0_x : public OAIObject {
public:
    OAIAbpV1_0_x();
    OAIAbpV1_0_x(QString json);
    ~OAIAbpV1_0_x() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAbpV1_0_x)

#endif // OAIAbpV1_0_x_H
