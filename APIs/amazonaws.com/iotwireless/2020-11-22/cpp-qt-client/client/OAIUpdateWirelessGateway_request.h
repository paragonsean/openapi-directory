...
/*
 * OAIUpdateWirelessGateway_request.h
 *
 * 
 */

#ifndef OAIUpdateWirelessGateway_request_H
#define OAIUpdateWirelessGateway_request_H
...
class OAIUpdateWirelessGateway_request : public OAIObject {
public:
    OAIUpdateWirelessGateway_request();
    OAIUpdateWirelessGateway_request(QString json);
    ~OAIUpdateWirelessGateway_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWirelessGateway_request)

#endif // OAIUpdateWirelessGateway_request_H
