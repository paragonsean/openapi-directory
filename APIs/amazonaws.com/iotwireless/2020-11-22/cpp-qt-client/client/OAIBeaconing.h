...
#ifndef OAIBeaconing_H
#define OAIBeaconing_H
...
class OAIBeaconing : public OAIObject {
public:
    OAIBeaconing();
    OAIBeaconing(QString json);
    ~OAIBeaconing() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBeaconing)

#endif // OAIBeaconing_H
