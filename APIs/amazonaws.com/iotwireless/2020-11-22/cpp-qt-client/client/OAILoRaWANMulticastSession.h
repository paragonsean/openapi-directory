...
/*
 * OAILoRaWANMulticastSession.h
 *
 * The LoRaWAN information used with the multicast session.
 */

#ifndef OAILoRaWANMulticastSession_H
#define OAILoRaWANMulticastSession_H
...
class OAILoRaWANMulticastSession : public OAIObject {
public:
    OAILoRaWANMulticastSession();
    OAILoRaWANMulticastSession(QString json);
    ~OAILoRaWANMulticastSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoRaWANMulticastSession)

#endif // OAILoRaWANMulticastSession_H
