...
/*
 * OAILoRaWANFuotaTask.h
 *
 * The LoRaWAN information used with a FUOTA task.
 */

#ifndef OAILoRaWANFuotaTask_H
#define OAILoRaWANFuotaTask_H
...
class OAILoRaWANFuotaTask : public OAIObject {
public:
    OAILoRaWANFuotaTask();
    OAILoRaWANFuotaTask(QString json);
    ~OAILoRaWANFuotaTask() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoRaWANFuotaTask)

#endif // OAILoRaWANFuotaTask_H
