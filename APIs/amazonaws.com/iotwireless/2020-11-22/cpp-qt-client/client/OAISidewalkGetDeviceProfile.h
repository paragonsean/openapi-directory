...
/*
 * OAISidewalkGetDeviceProfile.h
 *
 * Gets information about a Sidewalk device profile.
 */

#ifndef OAISidewalkGetDeviceProfile_H
#define OAISidewalkGetDeviceProfile_H
...
class OAISidewalkGetDeviceProfile : public OAIObject {
public:
    OAISidewalkGetDeviceProfile();
    OAISidewalkGetDeviceProfile(QString json);
    ~OAISidewalkGetDeviceProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISidewalkGetDeviceProfile)

#endif // OAISidewalkGetDeviceProfile_H
