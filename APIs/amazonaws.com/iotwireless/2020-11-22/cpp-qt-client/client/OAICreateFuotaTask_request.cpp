...
OAICreateFuotaTask_request::OAICreateFuotaTask_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFuotaTask_request::OAICreateFuotaTask_request() {
    this->initializeModel();
}

OAICreateFuotaTask_request::~OAICreateFuotaTask_request() {}

void OAICreateFuotaTask_request::initializeModel() {
...
void OAICreateFuotaTask_request::fromJson(QString jsonString) {
...
void OAICreateFuotaTask_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateFuotaTask_request::asJson() const {
...
QJsonObject OAICreateFuotaTask_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateFuotaTask_request::getName() const {
    return m_name;
}
void OAICreateFuotaTask_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateFuotaTask_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateFuotaTask_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateFuotaTask_request::getDescription() const {
    return m_description;
}
void OAICreateFuotaTask_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateFuotaTask_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateFuotaTask_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateFuotaTask_request::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreateFuotaTask_request::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreateFuotaTask_request::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreateFuotaTask_request::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAICreateFuotaTask_request_LoRaWAN OAICreateFuotaTask_request::getLoRaWan() const {
    return m_lo_ra_wan;
}
void OAICreateFuotaTask_request::setLoRaWan(const OAICreateFuotaTask_request_LoRaWAN &lo_ra_wan) {
    m_lo_ra_wan = lo_ra_wan;
    m_lo_ra_wan_isSet = true;
}

bool OAICreateFuotaTask_request::is_lo_ra_wan_Set() const{
    return m_lo_ra_wan_isSet;
}

bool OAICreateFuotaTask_request::is_lo_ra_wan_Valid() const{
    return m_lo_ra_wan_isValid;
}

QString OAICreateFuotaTask_request::getFirmwareUpdateImage() const {
    return m_firmware_update_image;
}
void OAICreateFuotaTask_request::setFirmwareUpdateImage(const QString &firmware_update_image) {
    m_firmware_update_image = firmware_update_image;
    m_firmware_update_image_isSet = true;
}

bool OAICreateFuotaTask_request::is_firmware_update_image_Set() const{
    return m_firmware_update_image_isSet;
}

bool OAICreateFuotaTask_request::is_firmware_update_image_Valid() const{
    return m_firmware_update_image_isValid;
}

QString OAICreateFuotaTask_request::getFirmwareUpdateRole() const {
    return m_firmware_update_role;
}
void OAICreateFuotaTask_request::setFirmwareUpdateRole(const QString &firmware_update_role) {
    m_firmware_update_role = firmware_update_role;
    m_firmware_update_role_isSet = true;
}

bool OAICreateFuotaTask_request::is_firmware_update_role_Set() const{
    return m_firmware_update_role_isSet;
}

bool OAICreateFuotaTask_request::is_firmware_update_role_Valid() const{
    return m_firmware_update_role_isValid;
}

QList<OAITag> OAICreateFuotaTask_request::getTags() const {
    return m_tags;
}
void OAICreateFuotaTask_request::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateFuotaTask_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateFuotaTask_request::is_tags_Valid() const{
    return m_tags_isValid;
}

qint32 OAICreateFuotaTask_request::getRedundancyPercent() const {
    return m_redundancy_percent;
}
void OAICreateFuotaTask_request::setRedundancyPercent(const qint32 &redundancy_percent) {
    m_redundancy_percent = redundancy_percent;
    m_redundancy_percent_isSet = true;
}

bool OAICreateFuotaTask_request::is_redundancy_percent_Set() const{
    return m_redundancy_percent_isSet;
}

bool OAICreateFuotaTask_request::is_redundancy_percent_Valid() const{
    return m_redundancy_percent_isValid;
}

qint32 OAICreateFuotaTask_request::getFragmentSizeBytes() const {
    return m_fragment_size_bytes;
}
void OAICreateFuotaTask_request::setFragmentSizeBytes(const qint32 &fragment_size_bytes) {
    m_fragment_size_bytes = fragment_size_bytes;
    m_fragment_size_bytes_isSet = true;
}

bool OAICreateFuotaTask_request::is_fragment_size_bytes_Set() const{
    return m_fragment_size_bytes_isSet;
}

bool OAICreateFuotaTask_request::is_fragment_size_bytes_Valid() const{
    return m_fragment_size_bytes_isValid;
}

qint32 OAICreateFuotaTask_request::getFragmentIntervalMs() const {
    return m_fragment_interval_ms;
}
void OAICreateFuotaTask_request::setFragmentIntervalMs(const qint32 &fragment_interval_ms) {
    m_fragment_interval_ms = fragment_interval_ms;
    m_fragment_interval_ms_isSet = true;
}

bool OAICreateFuotaTask_request::is_fragment_interval_ms_Set() const{
    return m_fragment_interval_ms_isSet;
}

bool OAICreateFuotaTask_request::is_fragment_interval_ms_Valid() const{
    return m_fragment_interval_ms_isValid;
}

bool OAICreateFuotaTask_request::isSet() const {
...
bool OAICreateFuotaTask_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_firmware_update_image_isValid && m_firmware_update_role_isValid && true;
}
