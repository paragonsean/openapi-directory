...
/*
 * OAIGetPositionEstimate_request_CellTowers.h
 *
 * The cell towers that were used to perform the measurements.
 */

#ifndef OAIGetPositionEstimate_request_CellTowers_H
#define OAIGetPositionEstimate_request_CellTowers_H
...
class OAIGetPositionEstimate_request_CellTowers : public OAIObject {
public:
    OAIGetPositionEstimate_request_CellTowers();
    OAIGetPositionEstimate_request_CellTowers(QString json);
    ~OAIGetPositionEstimate_request_CellTowers() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPositionEstimate_request_CellTowers)

#endif // OAIGetPositionEstimate_request_CellTowers_H
