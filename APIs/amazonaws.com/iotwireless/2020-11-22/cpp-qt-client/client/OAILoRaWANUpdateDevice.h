...
/*
 * OAILoRaWANUpdateDevice.h
 *
 * LoRaWAN object for update functions.
 */

#ifndef OAILoRaWANUpdateDevice_H
#define OAILoRaWANUpdateDevice_H
...
class OAILoRaWANUpdateDevice : public OAIObject {
public:
    OAILoRaWANUpdateDevice();
    OAILoRaWANUpdateDevice(QString json);
    ~OAILoRaWANUpdateDevice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoRaWANUpdateDevice)

#endif // OAILoRaWANUpdateDevice_H
