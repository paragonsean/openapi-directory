...
#include "OAIWirelessGatewayStatistics_LoRaWAN.h"
...
OAIWirelessGatewayStatistics_LoRaWAN::OAIWirelessGatewayStatistics_LoRaWAN(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWirelessGatewayStatistics_LoRaWAN::OAIWirelessGatewayStatistics_LoRaWAN() {
    this->initializeModel();
}

OAIWirelessGatewayStatistics_LoRaWAN::~OAIWirelessGatewayStatistics_LoRaWAN() {}

void OAIWirelessGatewayStatistics_LoRaWAN::initializeModel() {
...
void OAIWirelessGatewayStatistics_LoRaWAN::fromJson(QString jsonString) {
...
void OAIWirelessGatewayStatistics_LoRaWAN::fromJsonObject(QJsonObject json) {
...
QString OAIWirelessGatewayStatistics_LoRaWAN::asJson() const {
...
QJsonObject OAIWirelessGatewayStatistics_LoRaWAN::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWirelessGatewayStatistics_LoRaWAN::getGatewayEui() const {
    return m_gateway_eui;
}
void OAIWirelessGatewayStatistics_LoRaWAN::setGatewayEui(const QString &gateway_eui) {
    m_gateway_eui = gateway_eui;
    m_gateway_eui_isSet = true;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_gateway_eui_Set() const{
    return m_gateway_eui_isSet;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_gateway_eui_Valid() const{
    return m_gateway_eui_isValid;
}

QString OAIWirelessGatewayStatistics_LoRaWAN::getRfRegion() const {
    return m_rf_region;
}
void OAIWirelessGatewayStatistics_LoRaWAN::setRfRegion(const QString &rf_region) {
    m_rf_region = rf_region;
    m_rf_region_isSet = true;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_rf_region_Set() const{
    return m_rf_region_isSet;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_rf_region_Valid() const{
    return m_rf_region_isValid;
}

QList<QList> OAIWirelessGatewayStatistics_LoRaWAN::getJoinEuiFilters() const {
    return m_join_eui_filters;
}
void OAIWirelessGatewayStatistics_LoRaWAN::setJoinEuiFilters(const QList<QList> &join_eui_filters) {
    m_join_eui_filters = join_eui_filters;
    m_join_eui_filters_isSet = true;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_join_eui_filters_Set() const{
    return m_join_eui_filters_isSet;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_join_eui_filters_Valid() const{
    return m_join_eui_filters_isValid;
}

QList<QString> OAIWirelessGatewayStatistics_LoRaWAN::getNetIdFilters() const {
    return m_net_id_filters;
}
void OAIWirelessGatewayStatistics_LoRaWAN::setNetIdFilters(const QList<QString> &net_id_filters) {
    m_net_id_filters = net_id_filters;
    m_net_id_filters_isSet = true;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_net_id_filters_Set() const{
    return m_net_id_filters_isSet;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_net_id_filters_Valid() const{
    return m_net_id_filters_isValid;
}

QList<qint32> OAIWirelessGatewayStatistics_LoRaWAN::getSubBands() const {
    return m_sub_bands;
}
void OAIWirelessGatewayStatistics_LoRaWAN::setSubBands(const QList<qint32> &sub_bands) {
    m_sub_bands = sub_bands;
    m_sub_bands_isSet = true;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_sub_bands_Set() const{
    return m_sub_bands_isSet;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_sub_bands_Valid() const{
    return m_sub_bands_isValid;
}

OAICreateWirelessGateway_request_LoRaWAN_Beaconing OAIWirelessGatewayStatistics_LoRaWAN::getBeaconing() const {
    return m_beaconing;
}
void OAIWirelessGatewayStatistics_LoRaWAN::setBeaconing(const OAICreateWirelessGateway_request_LoRaWAN_Beaconing &beaconing) {
    m_beaconing = beaconing;
    m_beaconing_isSet = true;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_beaconing_Set() const{
    return m_beaconing_isSet;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_beaconing_Valid() const{
    return m_beaconing_isValid;
}

float OAIWirelessGatewayStatistics_LoRaWAN::getMaxEirp() const {
    return m_max_eirp;
}
void OAIWirelessGatewayStatistics_LoRaWAN::setMaxEirp(const float &max_eirp) {
    m_max_eirp = max_eirp;
    m_max_eirp_isSet = true;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_max_eirp_Set() const{
    return m_max_eirp_isSet;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::is_max_eirp_Valid() const{
    return m_max_eirp_isValid;
}

bool OAIWirelessGatewayStatistics_LoRaWAN::isSet() const {
...
bool OAIWirelessGatewayStatistics_LoRaWAN::isValid() const {
