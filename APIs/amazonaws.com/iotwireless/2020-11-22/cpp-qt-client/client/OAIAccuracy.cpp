...
OAIAccuracy::OAIAccuracy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccuracy::OAIAccuracy() {
    this->initializeModel();
}

OAIAccuracy::~OAIAccuracy() {}

void OAIAccuracy::initializeModel() {
...
void OAIAccuracy::fromJson(QString jsonString) {
...
void OAIAccuracy::fromJsonObject(QJsonObject json) {
...
QString OAIAccuracy::asJson() const {
...
QJsonObject OAIAccuracy::asJsonObject() const {
    QJsonObject obj;
...
float OAIAccuracy::getHorizontalAccuracy() const {
    return m_horizontal_accuracy;
}
void OAIAccuracy::setHorizontalAccuracy(const float &horizontal_accuracy) {
    m_horizontal_accuracy = horizontal_accuracy;
    m_horizontal_accuracy_isSet = true;
}

bool OAIAccuracy::is_horizontal_accuracy_Set() const{
    return m_horizontal_accuracy_isSet;
}

bool OAIAccuracy::is_horizontal_accuracy_Valid() const{
    return m_horizontal_accuracy_isValid;
}

float OAIAccuracy::getVerticalAccuracy() const {
    return m_vertical_accuracy;
}
void OAIAccuracy::setVerticalAccuracy(const float &vertical_accuracy) {
    m_vertical_accuracy = vertical_accuracy;
    m_vertical_accuracy_isSet = true;
}

bool OAIAccuracy::is_vertical_accuracy_Set() const{
    return m_vertical_accuracy_isSet;
}

bool OAIAccuracy::is_vertical_accuracy_Valid() const{
    return m_vertical_accuracy_isValid;
}

bool OAIAccuracy::isSet() const {
...
bool OAIAccuracy::isValid() const {
