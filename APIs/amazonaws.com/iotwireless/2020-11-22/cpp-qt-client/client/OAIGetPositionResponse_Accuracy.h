...
/*
 * OAIGetPositionResponse_Accuracy.h
 *
 * 
 */

#ifndef OAIGetPositionResponse_Accuracy_H
#define OAIGetPositionResponse_Accuracy_H
...
class OAIGetPositionResponse_Accuracy : public OAIObject {
public:
    OAIGetPositionResponse_Accuracy();
    OAIGetPositionResponse_Accuracy(QString json);
    ~OAIGetPositionResponse_Accuracy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPositionResponse_Accuracy)

#endif // OAIGetPositionResponse_Accuracy_H
