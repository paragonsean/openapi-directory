...
qint32 OAICdmaLocalId::getCdmaChannel() const {
    return m_cdma_channel;
}
void OAICdmaLocalId::setCdmaChannel(const qint32 &cdma_channel) {
    m_cdma_channel = cdma_channel;
    m_cdma_channel_isSet = true;
}

bool OAICdmaLocalId::is_cdma_channel_Set() const{
    return m_cdma_channel_isSet;
}

bool OAICdmaLocalId::is_cdma_channel_Valid() const{
