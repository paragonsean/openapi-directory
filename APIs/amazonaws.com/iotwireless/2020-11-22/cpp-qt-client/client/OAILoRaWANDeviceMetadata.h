...
/*
 * OAILoRaWANDeviceMetadata.h
 *
 * LoRaWAN device metatdata.
 */

#ifndef OAILoRaWANDeviceMetadata_H
#define OAILoRaWANDeviceMetadata_H
...
class OAILoRaWANDeviceMetadata : public OAIObject {
public:
    OAILoRaWANDeviceMetadata();
    OAILoRaWANDeviceMetadata(QString json);
    ~OAILoRaWANDeviceMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoRaWANDeviceMetadata)

#endif // OAILoRaWANDeviceMetadata_H
