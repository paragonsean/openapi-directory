...
/*
 * OAICreateNetworkAnalyzerConfigurationRequest.h
 *
 * 
 */

#ifndef OAICreateNetworkAnalyzerConfigurationRequest_H
#define OAICreateNetworkAnalyzerConfigurationRequest_H
...
class OAICreateNetworkAnalyzerConfigurationRequest : public OAIObject {
public:
    OAICreateNetworkAnalyzerConfigurationRequest();
    OAICreateNetworkAnalyzerConfigurationRequest(QString json);
    ~OAICreateNetworkAnalyzerConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkAnalyzerConfigurationRequest)

#endif // OAICreateNetworkAnalyzerConfigurationRequest_H
