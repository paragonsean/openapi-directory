...
/*
 * OAIWirelessDeviceImportTask.h
 *
 * Information about an import task for wireless devices.
 */

#ifndef OAIWirelessDeviceImportTask_H
#define OAIWirelessDeviceImportTask_H
...
namespace OpenAPI {
class OAIWirelessDeviceImportTask_Sidewalk;

class OAIWirelessDeviceImportTask : public OAIObject {
public:
    OAIWirelessDeviceImportTask();
    OAIWirelessDeviceImportTask(QString json);
    ~OAIWirelessDeviceImportTask() override;
    ...
    OAIWirelessDeviceImportTask_Sidewalk getSidewalk() const;
    void setSidewalk(const OAIWirelessDeviceImportTask_Sidewalk &sidewalk);
...
private:
    ...
    OAIWirelessDeviceImportTask_Sidewalk m_sidewalk;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWirelessDeviceImportTask)

#endif // OAIWirelessDeviceImportTask_H
