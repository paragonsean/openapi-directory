...
/*
 * OAIUpdateResourceEventConfiguration_request_ConnectionStatus.h
 *
 * Connection status event configuration object for enabling or disabling topic.
 */

#ifndef OAIUpdateResourceEventConfiguration_request_ConnectionStatus_H
#define OAIUpdateResourceEventConfiguration_request_ConnectionStatus_H
...
class OAIUpdateResourceEventConfiguration_request_ConnectionStatus : public OAIObject {
public:
    OAIUpdateResourceEventConfiguration_request_ConnectionStatus();
    OAIUpdateResourceEventConfiguration_request_ConnectionStatus(QString json);
    ~OAIUpdateResourceEventConfiguration_request_ConnectionStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResourceEventConfiguration_request_ConnectionStatus)

#endif // OAIUpdateResourceEventConfiguration_request_ConnectionStatus_H
