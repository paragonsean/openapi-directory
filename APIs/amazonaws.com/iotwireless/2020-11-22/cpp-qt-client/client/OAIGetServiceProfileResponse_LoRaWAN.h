...
/*
 * OAIGetServiceProfileResponse_LoRaWAN.h
 *
 * 
 */

#ifndef OAIGetServiceProfileResponse_LoRaWAN_H
#define OAIGetServiceProfileResponse_LoRaWAN_H
...
class OAIGetServiceProfileResponse_LoRaWAN : public OAIObject {
public:
    OAIGetServiceProfileResponse_LoRaWAN();
    OAIGetServiceProfileResponse_LoRaWAN(QString json);
    ~OAIGetServiceProfileResponse_LoRaWAN() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceProfileResponse_LoRaWAN)

#endif // OAIGetServiceProfileResponse_LoRaWAN_H
