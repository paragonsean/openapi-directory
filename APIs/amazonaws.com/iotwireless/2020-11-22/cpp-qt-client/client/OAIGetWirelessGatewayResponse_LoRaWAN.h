...
/*
 * OAIGetWirelessGatewayResponse_LoRaWAN.h
 *
 * 
 */

#ifndef OAIGetWirelessGatewayResponse_LoRaWAN_H
#define OAIGetWirelessGatewayResponse_LoRaWAN_H
...
class OAIGetWirelessGatewayResponse_LoRaWAN : public OAIObject {
public:
    OAIGetWirelessGatewayResponse_LoRaWAN();
    OAIGetWirelessGatewayResponse_LoRaWAN(QString json);
    ~OAIGetWirelessGatewayResponse_LoRaWAN() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWirelessGatewayResponse_LoRaWAN)

#endif // OAIGetWirelessGatewayResponse_LoRaWAN_H
