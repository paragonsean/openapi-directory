...
/*
 * OAIFPorts_Positioning.h
 *
 * 
 */

#ifndef OAIFPorts_Positioning_H
#define OAIFPorts_Positioning_H
...
class OAIFPorts_Positioning : public OAIObject {
public:
    OAIFPorts_Positioning();
    OAIFPorts_Positioning(QString json);
    ~OAIFPorts_Positioning() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFPorts_Positioning)

#endif // OAIFPorts_Positioning_H
