...
/*
 * OAIUpdateWirelessDeviceRequest_LoRaWAN.h
 *
 * 
 */

#ifndef OAIUpdateWirelessDeviceRequest_LoRaWAN_H
#define OAIUpdateWirelessDeviceRequest_LoRaWAN_H
...
class OAIUpdateWirelessDeviceRequest_LoRaWAN : public OAIObject {
public:
    OAIUpdateWirelessDeviceRequest_LoRaWAN();
    OAIUpdateWirelessDeviceRequest_LoRaWAN(QString json);
    ~OAIUpdateWirelessDeviceRequest_LoRaWAN() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWirelessDeviceRequest_LoRaWAN)

#endif // OAIUpdateWirelessDeviceRequest_LoRaWAN_H
