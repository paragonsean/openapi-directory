...
OAIGetPositionEstimateRequest_Gnss::OAIGetPositionEstimateRequest_Gnss(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPositionEstimateRequest_Gnss::OAIGetPositionEstimateRequest_Gnss() {
    this->initializeModel();
}

OAIGetPositionEstimateRequest_Gnss::~OAIGetPositionEstimateRequest_Gnss() {}

void OAIGetPositionEstimateRequest_Gnss::initializeModel() {
...
void OAIGetPositionEstimateRequest_Gnss::fromJson(QString jsonString) {
...
void OAIGetPositionEstimateRequest_Gnss::fromJsonObject(QJsonObject json) {
...
QString OAIGetPositionEstimateRequest_Gnss::asJson() const {
...
QJsonObject OAIGetPositionEstimateRequest_Gnss::asJsonObject() const {
    QJsonObject obj;
    if (m_payload_isSet) {
...
QString OAIGetPositionEstimateRequest_Gnss::getPayload() const {
    return m_payload;
}
void OAIGetPositionEstimateRequest_Gnss::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIGetPositionEstimateRequest_Gnss::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIGetPositionEstimateRequest_Gnss::is_payload_Valid() const{
    return m_payload_isValid;
}

float OAIGetPositionEstimateRequest_Gnss::getCaptureTime() const {
    return m_capture_time;
}
void OAIGetPositionEstimateRequest_Gnss::setCaptureTime(const float &capture_time) {
    m_capture_time = capture_time;
    m_capture_time_isSet = true;
}

bool OAIGetPositionEstimateRequest_Gnss::is_capture_time_Set() const{
    return m_capture_time_isSet;
}

bool OAIGetPositionEstimateRequest_Gnss::is_capture_time_Valid() const{
    return m_capture_time_isValid;
}

float OAIGetPositionEstimateRequest_Gnss::getCaptureTimeAccuracy() const {
    return m_capture_time_accuracy;
}
void OAIGetPositionEstimateRequest_Gnss::setCaptureTimeAccuracy(const float &capture_time_accuracy) {
    m_capture_time_accuracy = capture_time_accuracy;
    m_capture_time_accuracy_isSet = true;
}

bool OAIGetPositionEstimateRequest_Gnss::is_capture_time_accuracy_Set() const{
    return m_capture_time_accuracy_isSet;
}

bool OAIGetPositionEstimateRequest_Gnss::is_capture_time_accuracy_Valid() const{
    return m_capture_time_accuracy_isValid;
}

QList OAIGetPositionEstimateRequest_Gnss::getAssistPosition() const {
    return m_assist_position;
}
void OAIGetPositionEstimateRequest_Gnss::setAssistPosition(const QList &assist_position) {
    m_assist_position = assist_position;
    m_assist_position_isSet = true;
}

bool OAIGetPositionEstimateRequest_Gnss::is_assist_position_Set() const{
    return m_assist_position_isSet;
}

bool OAIGetPositionEstimateRequest_Gnss::is_assist_position_Valid() const{
    return m_assist_position_isValid;
}

float OAIGetPositionEstimateRequest_Gnss::getAssistAltitude() const {
    return m_assist_altitude;
}
void OAIGetPositionEstimateRequest_Gnss::setAssistAltitude(const float &assist_altitude) {
    m_assist_altitude = assist_altitude;
    m_assist_altitude_isSet = true;
}

bool OAIGetPositionEstimateRequest_Gnss::is_assist_altitude_Set() const{
    return m_assist_altitude_isSet;
}

bool OAIGetPositionEstimateRequest_Gnss::is_assist_altitude_Valid() const{
    return m_assist_altitude_isValid;
}

bool OAIGetPositionEstimateRequest_Gnss::getUse2DSolver() const {
    return m_use2_d_solver;
}
void OAIGetPositionEstimateRequest_Gnss::setUse2DSolver(const bool &use2_d_solver) {
    m_use2_d_solver = use2_d_solver;
    m_use2_d_solver_isSet = true;
}

bool OAIGetPositionEstimateRequest_Gnss::is_use2_d_solver_Set() const{
    return m_use2_d_solver_isSet;
}

bool OAIGetPositionEstimateRequest_Gnss::is_use2_d_solver_Valid() const{
    return m_use2_d_solver_isValid;
}

bool OAIGetPositionEstimateRequest_Gnss::isSet() const {
...
bool OAIGetPositionEstimateRequest_Gnss::isValid() const {
