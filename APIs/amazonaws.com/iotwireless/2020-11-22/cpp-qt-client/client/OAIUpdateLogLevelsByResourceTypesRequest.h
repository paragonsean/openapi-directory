...
/*
 * OAIUpdateLogLevelsByResourceTypesRequest.h
 *
 * 
 */

#ifndef OAIUpdateLogLevelsByResourceTypesRequest_H
#define OAIUpdateLogLevelsByResourceTypesRequest_H
...
class OAIUpdateLogLevelsByResourceTypesRequest : public OAIObject {
public:
    OAIUpdateLogLevelsByResourceTypesRequest();
    OAIUpdateLogLevelsByResourceTypesRequest(QString json);
    ~OAIUpdateLogLevelsByResourceTypesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLogLevelsByResourceTypesRequest)

#endif // OAIUpdateLogLevelsByResourceTypesRequest_H
