...
/*
 * OAICreateDestination_request.h
 *
 * 
 */

#ifndef OAICreateDestination_request_H
#define OAICreateDestination_request_H
...
class OAICreateDestination_request : public OAIObject {
public:
    OAICreateDestination_request();
    OAICreateDestination_request(QString json);
    ~OAICreateDestination_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDestination_request)

#endif // OAICreateDestination_request_H
