...
/*
 * OAIGetDeviceProfileResponse_LoRaWAN.h
 *
 * 
 */

#ifndef OAIGetDeviceProfileResponse_LoRaWAN_H
#define OAIGetDeviceProfileResponse_LoRaWAN_H
...
class OAIGetDeviceProfileResponse_LoRaWAN : public OAIObject {
public:
    OAIGetDeviceProfileResponse_LoRaWAN();
    OAIGetDeviceProfileResponse_LoRaWAN(QString json);
    ~OAIGetDeviceProfileResponse_LoRaWAN() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDeviceProfileResponse_LoRaWAN)

#endif // OAIGetDeviceProfileResponse_LoRaWAN_H
