...
/*
 * OAIUpdateWirelessDeviceRequest.h
 *
 * 
 */

#ifndef OAIUpdateWirelessDeviceRequest_H
#define OAIUpdateWirelessDeviceRequest_H
...
namespace OpenAPI {
class OAIUpdateWirelessDeviceRequest_LoRaWAN;

class OAIUpdateWirelessDeviceRequest : public OAIObject {
public:
    OAIUpdateWirelessDeviceRequest();
    OAIUpdateWirelessDeviceRequest(QString json);
    ~OAIUpdateWirelessDeviceRequest() override;
    ...
    OAIUpdateWirelessDeviceRequest_LoRaWAN getLoRaWan() const;
    void setLoRaWan(const OAIUpdateWirelessDeviceRequest_LoRaWAN &lo_ra_wan);
...
private:
    ...
    OAIUpdateWirelessDeviceRequest_LoRaWAN m_lo_ra_wan;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWirelessDeviceRequest)

#endif // OAIUpdateWirelessDeviceRequest_H
