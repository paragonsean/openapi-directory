...
OAIUpdateFuotaTask_request::OAIUpdateFuotaTask_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFuotaTask_request::OAIUpdateFuotaTask_request() {
    this->initializeModel();
}

OAIUpdateFuotaTask_request::~OAIUpdateFuotaTask_request() {}

void OAIUpdateFuotaTask_request::initializeModel() {
...
void OAIUpdateFuotaTask_request::fromJson(QString jsonString) {
...
void OAIUpdateFuotaTask_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFuotaTask_request::asJson() const {
...
QJsonObject OAIUpdateFuotaTask_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateFuotaTask_request::getName() const {
    return m_name;
}
void OAIUpdateFuotaTask_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateFuotaTask_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateFuotaTask_request::getDescription() const {
    return m_description;
}
void OAIUpdateFuotaTask_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateFuotaTask_request::is_description_Valid() const{
    return m_description_isValid;
}

OAICreateFuotaTask_request_LoRaWAN OAIUpdateFuotaTask_request::getLoRaWan() const {
    return m_lo_ra_wan;
}
void OAIUpdateFuotaTask_request::setLoRaWan(const OAICreateFuotaTask_request_LoRaWAN &lo_ra_wan) {
    m_lo_ra_wan = lo_ra_wan;
    m_lo_ra_wan_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_lo_ra_wan_Set() const{
    return m_lo_ra_wan_isSet;
}

bool OAIUpdateFuotaTask_request::is_lo_ra_wan_Valid() const{
    return m_lo_ra_wan_isValid;
}

QString OAIUpdateFuotaTask_request::getFirmwareUpdateImage() const {
    return m_firmware_update_image;
}
void OAIUpdateFuotaTask_request::setFirmwareUpdateImage(const QString &firmware_update_image) {
    m_firmware_update_image = firmware_update_image;
    m_firmware_update_image_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_firmware_update_image_Set() const{
    return m_firmware_update_image_isSet;
}

bool OAIUpdateFuotaTask_request::is_firmware_update_image_Valid() const{
    return m_firmware_update_image_isValid;
}

QString OAIUpdateFuotaTask_request::getFirmwareUpdateRole() const {
    return m_firmware_update_role;
}
void OAIUpdateFuotaTask_request::setFirmwareUpdateRole(const QString &firmware_update_role) {
    m_firmware_update_role = firmware_update_role;
    m_firmware_update_role_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_firmware_update_role_Set() const{
    return m_firmware_update_role_isSet;
}

bool OAIUpdateFuotaTask_request::is_firmware_update_role_Valid() const{
    return m_firmware_update_role_isValid;
}

qint32 OAIUpdateFuotaTask_request::getRedundancyPercent() const {
    return m_redundancy_percent;
}
void OAIUpdateFuotaTask_request::setRedundancyPercent(const qint32 &redundancy_percent) {
    m_redundancy_percent = redundancy_percent;
    m_redundancy_percent_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_redundancy_percent_Set() const{
    return m_redundancy_percent_isSet;
}

bool OAIUpdateFuotaTask_request::is_redundancy_percent_Valid() const{
    return m_redundancy_percent_isValid;
}

qint32 OAIUpdateFuotaTask_request::getFragmentSizeBytes() const {
    return m_fragment_size_bytes;
}
void OAIUpdateFuotaTask_request::setFragmentSizeBytes(const qint32 &fragment_size_bytes) {
    m_fragment_size_bytes = fragment_size_bytes;
    m_fragment_size_bytes_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_fragment_size_bytes_Set() const{
    return m_fragment_size_bytes_isSet;
}

bool OAIUpdateFuotaTask_request::is_fragment_size_bytes_Valid() const{
    return m_fragment_size_bytes_isValid;
}

qint32 OAIUpdateFuotaTask_request::getFragmentIntervalMs() const {
    return m_fragment_interval_ms;
}
void OAIUpdateFuotaTask_request::setFragmentIntervalMs(const qint32 &fragment_interval_ms) {
    m_fragment_interval_ms = fragment_interval_ms;
    m_fragment_interval_ms_isSet = true;
}

bool OAIUpdateFuotaTask_request::is_fragment_interval_ms_Set() const{
    return m_fragment_interval_ms_isSet;
}

bool OAIUpdateFuotaTask_request::is_fragment_interval_ms_Valid() const{
    return m_fragment_interval_ms_isValid;
}

bool OAIUpdateFuotaTask_request::isSet() const {
...
bool OAIUpdateFuotaTask_request::isValid() const {
