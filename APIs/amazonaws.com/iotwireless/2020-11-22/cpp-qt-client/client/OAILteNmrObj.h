...
#ifndef OAILteNmrObj_H
#define OAILteNmrObj_H
...
class OAILteNmrObj : public OAIObject {
public:
    OAILteNmrObj();
    OAILteNmrObj(QString json);
    ~OAILteNmrObj() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILteNmrObj)

#endif // OAILteNmrObj_H
