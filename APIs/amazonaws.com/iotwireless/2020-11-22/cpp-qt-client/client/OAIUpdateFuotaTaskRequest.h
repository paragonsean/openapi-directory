...
/*
 * OAIUpdateFuotaTaskRequest.h
 *
 * 
 */

#ifndef OAIUpdateFuotaTaskRequest_H
#define OAIUpdateFuotaTaskRequest_H
...
class OAIUpdateFuotaTaskRequest : public OAIObject {
public:
    OAIUpdateFuotaTaskRequest();
    OAIUpdateFuotaTaskRequest(QString json);
    ~OAIUpdateFuotaTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFuotaTaskRequest)

#endif // OAIUpdateFuotaTaskRequest_H
