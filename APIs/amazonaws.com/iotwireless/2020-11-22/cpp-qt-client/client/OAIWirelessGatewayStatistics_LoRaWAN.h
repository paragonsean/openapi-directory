...
/*
 * OAIWirelessGatewayStatistics_LoRaWAN.h
 *
 * 
 */

#ifndef OAIWirelessGatewayStatistics_LoRaWAN_H
#define OAIWirelessGatewayStatistics_LoRaWAN_H
...
class OAIWirelessGatewayStatistics_LoRaWAN : public OAIObject {
public:
    OAIWirelessGatewayStatistics_LoRaWAN();
    OAIWirelessGatewayStatistics_LoRaWAN(QString json);
    ~OAIWirelessGatewayStatistics_LoRaWAN() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWirelessGatewayStatistics_LoRaWAN)

#endif // OAIWirelessGatewayStatistics_LoRaWAN_H
