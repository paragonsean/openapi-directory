...
/*
 * OAIUpdateLogLevelsByResourceTypes_request.h
 *
 * 
 */

#ifndef OAIUpdateLogLevelsByResourceTypes_request_H
#define OAIUpdateLogLevelsByResourceTypes_request_H
...
class OAIUpdateLogLevelsByResourceTypes_request : public OAIObject {
public:
    OAIUpdateLogLevelsByResourceTypes_request();
    OAIUpdateLogLevelsByResourceTypes_request(QString json);
    ~OAIUpdateLogLevelsByResourceTypes_request() override;
    ...
    QString getDefaultLogLevel() const;
    void setDefaultLogLevel(const QString &default_log_level);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLogLevelsByResourceTypes_request)

#endif // OAIUpdateLogLevelsByResourceTypes_request_H
