...
#include "OAICreateWirelessGatewayRequest_LoRaWAN.h"
...
OAICreateWirelessGatewayRequest_LoRaWAN::OAICreateWirelessGatewayRequest_LoRaWAN(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateWirelessGatewayRequest_LoRaWAN::OAICreateWirelessGatewayRequest_LoRaWAN() {
    this->initializeModel();
}

OAICreateWirelessGatewayRequest_LoRaWAN::~OAICreateWirelessGatewayRequest_LoRaWAN() {}

void OAICreateWirelessGatewayRequest_LoRaWAN::initializeModel() {
...
void OAICreateWirelessGatewayRequest_LoRaWAN::fromJson(QString jsonString) {
...
void OAICreateWirelessGatewayRequest_LoRaWAN::fromJsonObject(QJsonObject json) {
...
QString OAICreateWirelessGatewayRequest_LoRaWAN::asJson() const {
...
QJsonObject OAICreateWirelessGatewayRequest_LoRaWAN::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateWirelessGatewayRequest_LoRaWAN::getGatewayEui() const {
    return m_gateway_eui;
}
void OAICreateWirelessGatewayRequest_LoRaWAN::setGatewayEui(const QString &gateway_eui) {
    m_gateway_eui = gateway_eui;
    m_gateway_eui_isSet = true;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_gateway_eui_Set() const{
    return m_gateway_eui_isSet;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_gateway_eui_Valid() const{
    return m_gateway_eui_isValid;
}

QString OAICreateWirelessGatewayRequest_LoRaWAN::getRfRegion() const {
    return m_rf_region;
}
void OAICreateWirelessGatewayRequest_LoRaWAN::setRfRegion(const QString &rf_region) {
    m_rf_region = rf_region;
    m_rf_region_isSet = true;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_rf_region_Set() const{
    return m_rf_region_isSet;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_rf_region_Valid() const{
    return m_rf_region_isValid;
}

QList<QList> OAICreateWirelessGatewayRequest_LoRaWAN::getJoinEuiFilters() const {
    return m_join_eui_filters;
}
void OAICreateWirelessGatewayRequest_LoRaWAN::setJoinEuiFilters(const QList<QList> &join_eui_filters) {
    m_join_eui_filters = join_eui_filters;
    m_join_eui_filters_isSet = true;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_join_eui_filters_Set() const{
    return m_join_eui_filters_isSet;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_join_eui_filters_Valid() const{
    return m_join_eui_filters_isValid;
}

QList<QString> OAICreateWirelessGatewayRequest_LoRaWAN::getNetIdFilters() const {
    return m_net_id_filters;
}
void OAICreateWirelessGatewayRequest_LoRaWAN::setNetIdFilters(const QList<QString> &net_id_filters) {
    m_net_id_filters = net_id_filters;
    m_net_id_filters_isSet = true;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_net_id_filters_Set() const{
    return m_net_id_filters_isSet;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_net_id_filters_Valid() const{
    return m_net_id_filters_isValid;
}

QList<qint32> OAICreateWirelessGatewayRequest_LoRaWAN::getSubBands() const {
    return m_sub_bands;
}
void OAICreateWirelessGatewayRequest_LoRaWAN::setSubBands(const QList<qint32> &sub_bands) {
    m_sub_bands = sub_bands;
    m_sub_bands_isSet = true;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_sub_bands_Set() const{
    return m_sub_bands_isSet;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_sub_bands_Valid() const{
    return m_sub_bands_isValid;
}

OAICreateWirelessGateway_request_LoRaWAN_Beaconing OAICreateWirelessGatewayRequest_LoRaWAN::getBeaconing() const {
    return m_beaconing;
}
void OAICreateWirelessGatewayRequest_LoRaWAN::setBeaconing(const OAICreateWirelessGateway_request_LoRaWAN_Beaconing &beaconing) {
    m_beaconing = beaconing;
    m_beaconing_isSet = true;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_beaconing_Set() const{
    return m_beaconing_isSet;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_beaconing_Valid() const{
    return m_beaconing_isValid;
}

float OAICreateWirelessGatewayRequest_LoRaWAN::getMaxEirp() const {
    return m_max_eirp;
}
void OAICreateWirelessGatewayRequest_LoRaWAN::setMaxEirp(const float &max_eirp) {
    m_max_eirp = max_eirp;
    m_max_eirp_isSet = true;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_max_eirp_Set() const{
    return m_max_eirp_isSet;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::is_max_eirp_Valid() const{
    return m_max_eirp_isValid;
}

bool OAICreateWirelessGatewayRequest_LoRaWAN::isSet() const {
...
bool OAICreateWirelessGatewayRequest_LoRaWAN::isValid() const {
