...
/*
 * OAIUpdateDestinationRequest.h
 *
 * 
 */

#ifndef OAIUpdateDestinationRequest_H
#define OAIUpdateDestinationRequest_H
...
class OAIUpdateDestinationRequest : public OAIObject {
public:
    OAIUpdateDestinationRequest();
    OAIUpdateDestinationRequest(QString json);
    ~OAIUpdateDestinationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDestinationRequest)

#endif // OAIUpdateDestinationRequest_H
