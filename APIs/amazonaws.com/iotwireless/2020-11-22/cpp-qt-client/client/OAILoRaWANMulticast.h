...
/*
 * OAILoRaWANMulticast.h
 *
 * The LoRaWAN information that is to be used with the multicast group.
 */

#ifndef OAILoRaWANMulticast_H
#define OAILoRaWANMulticast_H
...
class OAILoRaWANMulticast : public OAIObject {
public:
    OAILoRaWANMulticast();
    OAILoRaWANMulticast(QString json);
    ~OAILoRaWANMulticast() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoRaWANMulticast)

#endif // OAILoRaWANMulticast_H
