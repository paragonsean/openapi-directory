...
/*
 * OAIGetDestinationResponse.h
 *
 * 
 */

#ifndef OAIGetDestinationResponse_H
#define OAIGetDestinationResponse_H
...
class OAIGetDestinationResponse : public OAIObject {
public:
    OAIGetDestinationResponse();
    OAIGetDestinationResponse(QString json);
    ~OAIGetDestinationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDestinationResponse)

#endif // OAIGetDestinationResponse_H
