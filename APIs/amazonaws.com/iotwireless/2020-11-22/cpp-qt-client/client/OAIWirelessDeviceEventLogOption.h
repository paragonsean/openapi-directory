...
/*
 * OAIWirelessDeviceEventLogOption.h
 *
...
#ifndef OAIWirelessDeviceEventLogOption_H
#define OAIWirelessDeviceEventLogOption_H
...
class OAIWirelessDeviceEventLogOption : public OAIObject {
public:
    OAIWirelessDeviceEventLogOption();
    OAIWirelessDeviceEventLogOption(QString json);
    ~OAIWirelessDeviceEventLogOption() override;
    ...
    OAIWirelessDeviceEvent getEvent() const;
    void setEvent(const OAIWirelessDeviceEvent &event);
...
private:
    ...
    OAIWirelessDeviceEvent m_event;
    bool m_event_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWirelessDeviceEventLogOption)

#endif // OAIWirelessDeviceEventLogOption_H
