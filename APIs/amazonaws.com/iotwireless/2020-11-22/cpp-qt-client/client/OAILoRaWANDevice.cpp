...
OAILoRaWANDevice::OAILoRaWANDevice(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoRaWANDevice::OAILoRaWANDevice() {
    this->initializeModel();
}

OAILoRaWANDevice::~OAILoRaWANDevice() {}

void OAILoRaWANDevice::initializeModel() {
...
void OAILoRaWANDevice::fromJson(QString jsonString) {
...
void OAILoRaWANDevice::fromJsonObject(QJsonObject json) {
...
QString OAILoRaWANDevice::asJson() const {
...
QJsonObject OAILoRaWANDevice::asJsonObject() const {
    QJsonObject obj;
    if (m_dev_eui_isSet) {
...
QString OAILoRaWANDevice::getDevEui() const {
    return m_dev_eui;
}
void OAILoRaWANDevice::setDevEui(const QString &dev_eui) {
    m_dev_eui = dev_eui;
    m_dev_eui_isSet = true;
}

bool OAILoRaWANDevice::is_dev_eui_Set() const{
    return m_dev_eui_isSet;
}

bool OAILoRaWANDevice::is_dev_eui_Valid() const{
    return m_dev_eui_isValid;
}

QString OAILoRaWANDevice::getDeviceProfileId() const {
    return m_device_profile_id;
}
void OAILoRaWANDevice::setDeviceProfileId(const QString &device_profile_id) {
    m_device_profile_id = device_profile_id;
    m_device_profile_id_isSet = true;
}

bool OAILoRaWANDevice::is_device_profile_id_Set() const{
    return m_device_profile_id_isSet;
}

bool OAILoRaWANDevice::is_device_profile_id_Valid() const{
    return m_device_profile_id_isValid;
}

QString OAILoRaWANDevice::getServiceProfileId() const {
    return m_service_profile_id;
}
void OAILoRaWANDevice::setServiceProfileId(const QString &service_profile_id) {
    m_service_profile_id = service_profile_id;
    m_service_profile_id_isSet = true;
}

bool OAILoRaWANDevice::is_service_profile_id_Set() const{
    return m_service_profile_id_isSet;
}

bool OAILoRaWANDevice::is_service_profile_id_Valid() const{
    return m_service_profile_id_isValid;
}

OAICreateWirelessDevice_request_LoRaWAN_OtaaV1_1 OAILoRaWANDevice::getOtaaV11() const {
    return m_otaa_v1_1;
}
void OAILoRaWANDevice::setOtaaV11(const OAICreateWirelessDevice_request_LoRaWAN_OtaaV1_1 &otaa_v1_1) {
    m_otaa_v1_1 = otaa_v1_1;
    m_otaa_v1_1_isSet = true;
}

bool OAILoRaWANDevice::is_otaa_v1_1_Set() const{
    return m_otaa_v1_1_isSet;
}

bool OAILoRaWANDevice::is_otaa_v1_1_Valid() const{
    return m_otaa_v1_1_isValid;
}

OAICreateWirelessDevice_request_LoRaWAN_OtaaV1_0_x OAILoRaWANDevice::getOtaaV10X() const {
    return m_otaa_v1_0_x;
}
void OAILoRaWANDevice::setOtaaV10X(const OAICreateWirelessDevice_request_LoRaWAN_OtaaV1_0_x &otaa_v1_0_x) {
    m_otaa_v1_0_x = otaa_v1_0_x;
    m_otaa_v1_0_x_isSet = true;
}

bool OAILoRaWANDevice::is_otaa_v1_0_x_Set() const{
    return m_otaa_v1_0_x_isSet;
}

bool OAILoRaWANDevice::is_otaa_v1_0_x_Valid() const{
    return m_otaa_v1_0_x_isValid;
}

OAICreateWirelessDevice_request_LoRaWAN_AbpV1_1 OAILoRaWANDevice::getAbpV11() const {
    return m_abp_v1_1;
}
void OAILoRaWANDevice::setAbpV11(const OAICreateWirelessDevice_request_LoRaWAN_AbpV1_1 &abp_v1_1) {
    m_abp_v1_1 = abp_v1_1;
    m_abp_v1_1_isSet = true;
}

bool OAILoRaWANDevice::is_abp_v1_1_Set() const{
    return m_abp_v1_1_isSet;
}

bool OAILoRaWANDevice::is_abp_v1_1_Valid() const{
    return m_abp_v1_1_isValid;
}

OAICreateWirelessDevice_request_LoRaWAN_AbpV1_0_x OAILoRaWANDevice::getAbpV10X() const {
    return m_abp_v1_0_x;
}
void OAILoRaWANDevice::setAbpV10X(const OAICreateWirelessDevice_request_LoRaWAN_AbpV1_0_x &abp_v1_0_x) {
    m_abp_v1_0_x = abp_v1_0_x;
    m_abp_v1_0_x_isSet = true;
}

bool OAILoRaWANDevice::is_abp_v1_0_x_Set() const{
    return m_abp_v1_0_x_isSet;
}

bool OAILoRaWANDevice::is_abp_v1_0_x_Valid() const{
    return m_abp_v1_0_x_isValid;
}

OAIFPorts OAILoRaWANDevice::getFPorts() const {
    return m_f_ports;
}
void OAILoRaWANDevice::setFPorts(const OAIFPorts &f_ports) {
    m_f_ports = f_ports;
    m_f_ports_isSet = true;
}

bool OAILoRaWANDevice::is_f_ports_Set() const{
    return m_f_ports_isSet;
}

bool OAILoRaWANDevice::is_f_ports_Valid() const{
    return m_f_ports_isValid;
}

bool OAILoRaWANDevice::isSet() const {
...
bool OAILoRaWANDevice::isValid() const {
