...
OAIAbpV1_0_x::OAIAbpV1_0_x(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAbpV1_0_x::OAIAbpV1_0_x() {
    this->initializeModel();
}

OAIAbpV1_0_x::~OAIAbpV1_0_x() {}

void OAIAbpV1_0_x::initializeModel() {
...
void OAIAbpV1_0_x::fromJson(QString jsonString) {
...
void OAIAbpV1_0_x::fromJsonObject(QJsonObject json) {
...
QString OAIAbpV1_0_x::asJson() const {
...
QJsonObject OAIAbpV1_0_x::asJsonObject() const {
    QJsonObject obj;
    if (m_dev_addr_isSet) {
...
QString OAIAbpV1_0_x::getDevAddr() const {
    return m_dev_addr;
}
void OAIAbpV1_0_x::setDevAddr(const QString &dev_addr) {
    m_dev_addr = dev_addr;
    m_dev_addr_isSet = true;
}

bool OAIAbpV1_0_x::is_dev_addr_Set() const{
    return m_dev_addr_isSet;
}

bool OAIAbpV1_0_x::is_dev_addr_Valid() const{
    return m_dev_addr_isValid;
}

OAIAbpV1_0_x_SessionKeys OAIAbpV1_0_x::getSessionKeys() const {
    return m_session_keys;
}
void OAIAbpV1_0_x::setSessionKeys(const OAIAbpV1_0_x_SessionKeys &session_keys) {
    m_session_keys = session_keys;
    m_session_keys_isSet = true;
}

bool OAIAbpV1_0_x::is_session_keys_Set() const{
    return m_session_keys_isSet;
}

bool OAIAbpV1_0_x::is_session_keys_Valid() const{
    return m_session_keys_isValid;
}

qint32 OAIAbpV1_0_x::getFCntStart() const {
    return m_f_cnt_start;
}
void OAIAbpV1_0_x::setFCntStart(const qint32 &f_cnt_start) {
    m_f_cnt_start = f_cnt_start;
    m_f_cnt_start_isSet = true;
}

bool OAIAbpV1_0_x::is_f_cnt_start_Set() const{
    return m_f_cnt_start_isSet;
}

bool OAIAbpV1_0_x::is_f_cnt_start_Valid() const{
    return m_f_cnt_start_isValid;
}

bool OAIAbpV1_0_x::isSet() const {
...
bool OAIAbpV1_0_x::isValid() const {
