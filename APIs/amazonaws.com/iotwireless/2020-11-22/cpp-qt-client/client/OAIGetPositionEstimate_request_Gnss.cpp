...
OAIGetPositionEstimate_request_Gnss::OAIGetPositionEstimate_request_Gnss(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPositionEstimate_request_Gnss::OAIGetPositionEstimate_request_Gnss() {
    this->initializeModel();
}

OAIGetPositionEstimate_request_Gnss::~OAIGetPositionEstimate_request_Gnss() {}

void OAIGetPositionEstimate_request_Gnss::initializeModel() {
...
void OAIGetPositionEstimate_request_Gnss::fromJson(QString jsonString) {
...
void OAIGetPositionEstimate_request_Gnss::fromJsonObject(QJsonObject json) {
...
QString OAIGetPositionEstimate_request_Gnss::asJson() const {
...
QJsonObject OAIGetPositionEstimate_request_Gnss::asJsonObject() const {
    QJsonObject obj;
    if (m_payload_isSet) {
...
QString OAIGetPositionEstimate_request_Gnss::getPayload() const {
    return m_payload;
}
void OAIGetPositionEstimate_request_Gnss::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIGetPositionEstimate_request_Gnss::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIGetPositionEstimate_request_Gnss::is_payload_Valid() const{
    return m_payload_isValid;
}

float OAIGetPositionEstimate_request_Gnss::getCaptureTime() const {
    return m_capture_time;
}
void OAIGetPositionEstimate_request_Gnss::setCaptureTime(const float &capture_time) {
    m_capture_time = capture_time;
    m_capture_time_isSet = true;
}

bool OAIGetPositionEstimate_request_Gnss::is_capture_time_Set() const{
    return m_capture_time_isSet;
}

bool OAIGetPositionEstimate_request_Gnss::is_capture_time_Valid() const{
    return m_capture_time_isValid;
}

float OAIGetPositionEstimate_request_Gnss::getCaptureTimeAccuracy() const {
    return m_capture_time_accuracy;
}
void OAIGetPositionEstimate_request_Gnss::setCaptureTimeAccuracy(const float &capture_time_accuracy) {
    m_capture_time_accuracy = capture_time_accuracy;
    m_capture_time_accuracy_isSet = true;
}

bool OAIGetPositionEstimate_request_Gnss::is_capture_time_accuracy_Set() const{
    return m_capture_time_accuracy_isSet;
}

bool OAIGetPositionEstimate_request_Gnss::is_capture_time_accuracy_Valid() const{
    return m_capture_time_accuracy_isValid;
}

QList OAIGetPositionEstimate_request_Gnss::getAssistPosition() const {
    return m_assist_position;
}
void OAIGetPositionEstimate_request_Gnss::setAssistPosition(const QList &assist_position) {
    m_assist_position = assist_position;
    m_assist_position_isSet = true;
}

bool OAIGetPositionEstimate_request_Gnss::is_assist_position_Set() const{
    return m_assist_position_isSet;
}

bool OAIGetPositionEstimate_request_Gnss::is_assist_position_Valid() const{
    return m_assist_position_isValid;
}

float OAIGetPositionEstimate_request_Gnss::getAssistAltitude() const {
    return m_assist_altitude;
}
void OAIGetPositionEstimate_request_Gnss::setAssistAltitude(const float &assist_altitude) {
    m_assist_altitude = assist_altitude;
    m_assist_altitude_isSet = true;
}

bool OAIGetPositionEstimate_request_Gnss::is_assist_altitude_Set() const{
    return m_assist_altitude_isSet;
}

bool OAIGetPositionEstimate_request_Gnss::is_assist_altitude_Valid() const{
    return m_assist_altitude_isValid;
}

bool OAIGetPositionEstimate_request_Gnss::getUse2DSolver() const {
    return m_use2_d_solver;
}
void OAIGetPositionEstimate_request_Gnss::setUse2DSolver(const bool &use2_d_solver) {
    m_use2_d_solver = use2_d_solver;
    m_use2_d_solver_isSet = true;
}

bool OAIGetPositionEstimate_request_Gnss::is_use2_d_solver_Set() const{
    return m_use2_d_solver_isSet;
}

bool OAIGetPositionEstimate_request_Gnss::is_use2_d_solver_Valid() const{
    return m_use2_d_solver_isValid;
}

bool OAIGetPositionEstimate_request_Gnss::isSet() const {
...
bool OAIGetPositionEstimate_request_Gnss::isValid() const {
