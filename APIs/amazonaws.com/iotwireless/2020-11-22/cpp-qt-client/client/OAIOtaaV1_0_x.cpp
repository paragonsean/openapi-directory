...
OAIOtaaV1_0_x::OAIOtaaV1_0_x(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOtaaV1_0_x::OAIOtaaV1_0_x() {
    this->initializeModel();
}

OAIOtaaV1_0_x::~OAIOtaaV1_0_x() {}

void OAIOtaaV1_0_x::initializeModel() {
...
void OAIOtaaV1_0_x::fromJson(QString jsonString) {
...
void OAIOtaaV1_0_x::fromJsonObject(QJsonObject json) {
...
QString OAIOtaaV1_0_x::asJson() const {
...
QJsonObject OAIOtaaV1_0_x::asJsonObject() const {
    QJsonObject obj;
    if (m_app_key_isSet) {
...
QString OAIOtaaV1_0_x::getAppKey() const {
    return m_app_key;
}
void OAIOtaaV1_0_x::setAppKey(const QString &app_key) {
    m_app_key = app_key;
    m_app_key_isSet = true;
}

bool OAIOtaaV1_0_x::is_app_key_Set() const{
    return m_app_key_isSet;
}

bool OAIOtaaV1_0_x::is_app_key_Valid() const{
    return m_app_key_isValid;
}

QString OAIOtaaV1_0_x::getAppEui() const {
    return m_app_eui;
}
void OAIOtaaV1_0_x::setAppEui(const QString &app_eui) {
    m_app_eui = app_eui;
    m_app_eui_isSet = true;
}

bool OAIOtaaV1_0_x::is_app_eui_Set() const{
    return m_app_eui_isSet;
}

bool OAIOtaaV1_0_x::is_app_eui_Valid() const{
    return m_app_eui_isValid;
}

QString OAIOtaaV1_0_x::getGenAppKey() const {
    return m_gen_app_key;
}
void OAIOtaaV1_0_x::setGenAppKey(const QString &gen_app_key) {
    m_gen_app_key = gen_app_key;
    m_gen_app_key_isSet = true;
}

bool OAIOtaaV1_0_x::is_gen_app_key_Set() const{
    return m_gen_app_key_isSet;
}

bool OAIOtaaV1_0_x::is_gen_app_key_Valid() const{
    return m_gen_app_key_isValid;
}

bool OAIOtaaV1_0_x::isSet() const {
...
bool OAIOtaaV1_0_x::isValid() const {
