...
/*
 * OAICreateFuotaTask_request.h
 *
 * 
 */

#ifndef OAICreateFuotaTask_request_H
#define OAICreateFuotaTask_request_H
...
class OAICreateFuotaTask_request : public OAIObject {
public:
    OAICreateFuotaTask_request();
    OAICreateFuotaTask_request(QString json);
    ~OAICreateFuotaTask_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFuotaTask_request)

#endif // OAICreateFuotaTask_request_H
