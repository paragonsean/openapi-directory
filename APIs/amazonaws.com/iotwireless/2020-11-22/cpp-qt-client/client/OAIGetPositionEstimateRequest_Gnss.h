...
/*
 * OAIGetPositionEstimateRequest_Gnss.h
 *
 * 
 */

#ifndef OAIGetPositionEstimateRequest_Gnss_H
#define OAIGetPositionEstimateRequest_Gnss_H
...
class OAIGetPositionEstimateRequest_Gnss : public OAIObject {
public:
    OAIGetPositionEstimateRequest_Gnss();
    OAIGetPositionEstimateRequest_Gnss(QString json);
    ~OAIGetPositionEstimateRequest_Gnss() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPositionEstimateRequest_Gnss)

#endif // OAIGetPositionEstimateRequest_Gnss_H
