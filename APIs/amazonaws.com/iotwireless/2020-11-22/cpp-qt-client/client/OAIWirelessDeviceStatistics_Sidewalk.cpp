...
OAIWirelessDeviceStatistics_Sidewalk::OAIWirelessDeviceStatistics_Sidewalk(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWirelessDeviceStatistics_Sidewalk::OAIWirelessDeviceStatistics_Sidewalk() {
    this->initializeModel();
}

OAIWirelessDeviceStatistics_Sidewalk::~OAIWirelessDeviceStatistics_Sidewalk() {}

void OAIWirelessDeviceStatistics_Sidewalk::initializeModel() {
...
void OAIWirelessDeviceStatistics_Sidewalk::fromJson(QString jsonString) {
...
void OAIWirelessDeviceStatistics_Sidewalk::fromJsonObject(QJsonObject json) {
...
QString OAIWirelessDeviceStatistics_Sidewalk::asJson() const {
...
QJsonObject OAIWirelessDeviceStatistics_Sidewalk::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWirelessDeviceStatistics_Sidewalk::getAmazonId() const {
    return m_amazon_id;
}
void OAIWirelessDeviceStatistics_Sidewalk::setAmazonId(const QString &amazon_id) {
    m_amazon_id = amazon_id;
    m_amazon_id_isSet = true;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_amazon_id_Set() const{
    return m_amazon_id_isSet;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_amazon_id_Valid() const{
    return m_amazon_id_isValid;
}

QString OAIWirelessDeviceStatistics_Sidewalk::getSidewalkId() const {
    return m_sidewalk_id;
}
void OAIWirelessDeviceStatistics_Sidewalk::setSidewalkId(const QString &sidewalk_id) {
    m_sidewalk_id = sidewalk_id;
    m_sidewalk_id_isSet = true;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_sidewalk_id_Set() const{
    return m_sidewalk_id_isSet;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_sidewalk_id_Valid() const{
    return m_sidewalk_id_isValid;
}

QString OAIWirelessDeviceStatistics_Sidewalk::getSidewalkManufacturingSn() const {
    return m_sidewalk_manufacturing_sn;
}
void OAIWirelessDeviceStatistics_Sidewalk::setSidewalkManufacturingSn(const QString &sidewalk_manufacturing_sn) {
    m_sidewalk_manufacturing_sn = sidewalk_manufacturing_sn;
    m_sidewalk_manufacturing_sn_isSet = true;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_sidewalk_manufacturing_sn_Set() const{
    return m_sidewalk_manufacturing_sn_isSet;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_sidewalk_manufacturing_sn_Valid() const{
    return m_sidewalk_manufacturing_sn_isValid;
}

QList OAIWirelessDeviceStatistics_Sidewalk::getDeviceCertificates() const {
    return m_device_certificates;
}
void OAIWirelessDeviceStatistics_Sidewalk::setDeviceCertificates(const QList &device_certificates) {
    m_device_certificates = device_certificates;
    m_device_certificates_isSet = true;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_device_certificates_Set() const{
    return m_device_certificates_isSet;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_device_certificates_Valid() const{
    return m_device_certificates_isValid;
}

QString OAIWirelessDeviceStatistics_Sidewalk::getDeviceProfileId() const {
    return m_device_profile_id;
}
void OAIWirelessDeviceStatistics_Sidewalk::setDeviceProfileId(const QString &device_profile_id) {
    m_device_profile_id = device_profile_id;
    m_device_profile_id_isSet = true;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_device_profile_id_Set() const{
    return m_device_profile_id_isSet;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_device_profile_id_Valid() const{
    return m_device_profile_id_isValid;
}

OAIWirelessDeviceSidewalkStatus OAIWirelessDeviceStatistics_Sidewalk::getStatus() const {
    return m_status;
}
void OAIWirelessDeviceStatistics_Sidewalk::setStatus(const OAIWirelessDeviceSidewalkStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWirelessDeviceStatistics_Sidewalk::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIWirelessDeviceStatistics_Sidewalk::isSet() const {
...
bool OAIWirelessDeviceStatistics_Sidewalk::isValid() const {
