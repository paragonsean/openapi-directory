...
/*
 * OAIGetPositionEstimateRequest_CellTowers.h
 *
 * 
 */

#ifndef OAIGetPositionEstimateRequest_CellTowers_H
#define OAIGetPositionEstimateRequest_CellTowers_H
...
class OAIGetPositionEstimateRequest_CellTowers : public OAIObject {
public:
    OAIGetPositionEstimateRequest_CellTowers();
    OAIGetPositionEstimateRequest_CellTowers(QString json);
    ~OAIGetPositionEstimateRequest_CellTowers() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPositionEstimateRequest_CellTowers)

#endif // OAIGetPositionEstimateRequest_CellTowers_H
