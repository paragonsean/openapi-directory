...
OAILoRaWANGateway::OAILoRaWANGateway(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoRaWANGateway::OAILoRaWANGateway() {
    this->initializeModel();
}

OAILoRaWANGateway::~OAILoRaWANGateway() {}

void OAILoRaWANGateway::initializeModel() {
...
void OAILoRaWANGateway::fromJson(QString jsonString) {
...
void OAILoRaWANGateway::fromJsonObject(QJsonObject json) {
...
QString OAILoRaWANGateway::asJson() const {
...
QJsonObject OAILoRaWANGateway::asJsonObject() const {
    QJsonObject obj;
...
QString OAILoRaWANGateway::getGatewayEui() const {
    return m_gateway_eui;
}
void OAILoRaWANGateway::setGatewayEui(const QString &gateway_eui) {
    m_gateway_eui = gateway_eui;
    m_gateway_eui_isSet = true;
}

bool OAILoRaWANGateway::is_gateway_eui_Set() const{
    return m_gateway_eui_isSet;
}

bool OAILoRaWANGateway::is_gateway_eui_Valid() const{
    return m_gateway_eui_isValid;
}

QString OAILoRaWANGateway::getRfRegion() const {
    return m_rf_region;
}
void OAILoRaWANGateway::setRfRegion(const QString &rf_region) {
    m_rf_region = rf_region;
    m_rf_region_isSet = true;
}

bool OAILoRaWANGateway::is_rf_region_Set() const{
    return m_rf_region_isSet;
}

bool OAILoRaWANGateway::is_rf_region_Valid() const{
    return m_rf_region_isValid;
}

QList<QList> OAILoRaWANGateway::getJoinEuiFilters() const {
    return m_join_eui_filters;
}
void OAILoRaWANGateway::setJoinEuiFilters(const QList<QList> &join_eui_filters) {
    m_join_eui_filters = join_eui_filters;
    m_join_eui_filters_isSet = true;
}

bool OAILoRaWANGateway::is_join_eui_filters_Set() const{
    return m_join_eui_filters_isSet;
}

bool OAILoRaWANGateway::is_join_eui_filters_Valid() const{
    return m_join_eui_filters_isValid;
}

QList<QString> OAILoRaWANGateway::getNetIdFilters() const {
    return m_net_id_filters;
}
void OAILoRaWANGateway::setNetIdFilters(const QList<QString> &net_id_filters) {
    m_net_id_filters = net_id_filters;
    m_net_id_filters_isSet = true;
}

bool OAILoRaWANGateway::is_net_id_filters_Set() const{
    return m_net_id_filters_isSet;
}

bool OAILoRaWANGateway::is_net_id_filters_Valid() const{
    return m_net_id_filters_isValid;
}

QList<qint32> OAILoRaWANGateway::getSubBands() const {
    return m_sub_bands;
}
void OAILoRaWANGateway::setSubBands(const QList<qint32> &sub_bands) {
    m_sub_bands = sub_bands;
    m_sub_bands_isSet = true;
}

bool OAILoRaWANGateway::is_sub_bands_Set() const{
    return m_sub_bands_isSet;
}

bool OAILoRaWANGateway::is_sub_bands_Valid() const{
    return m_sub_bands_isValid;
}

OAICreateWirelessGateway_request_LoRaWAN_Beaconing OAILoRaWANGateway::getBeaconing() const {
    return m_beaconing;
}
void OAILoRaWANGateway::setBeaconing(const OAICreateWirelessGateway_request_LoRaWAN_Beaconing &beaconing) {
    m_beaconing = beaconing;
    m_beaconing_isSet = true;
}

bool OAILoRaWANGateway::is_beaconing_Set() const{
    return m_beaconing_isSet;
}

bool OAILoRaWANGateway::is_beaconing_Valid() const{
    return m_beaconing_isValid;
}

float OAILoRaWANGateway::getMaxEirp() const {
    return m_max_eirp;
}
void OAILoRaWANGateway::setMaxEirp(const float &max_eirp) {
    m_max_eirp = max_eirp;
    m_max_eirp_isSet = true;
}

bool OAILoRaWANGateway::is_max_eirp_Set() const{
    return m_max_eirp_isSet;
}

bool OAILoRaWANGateway::is_max_eirp_Valid() const{
    return m_max_eirp_isValid;
}

bool OAILoRaWANGateway::isSet() const {
...
bool OAILoRaWANGateway::isValid() const {
