...
/*
 * OAIGetPositionEstimate_request_Gnss.h
 *
 * Global navigation satellite system (GNSS) object used for positioning.
 */

#ifndef OAIGetPositionEstimate_request_Gnss_H
#define OAIGetPositionEstimate_request_Gnss_H
...
class OAIGetPositionEstimate_request_Gnss : public OAIObject {
public:
    OAIGetPositionEstimate_request_Gnss();
    OAIGetPositionEstimate_request_Gnss(QString json);
    ~OAIGetPositionEstimate_request_Gnss() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPositionEstimate_request_Gnss)

#endif // OAIGetPositionEstimate_request_Gnss_H
