...
/*
 * OAIGetResourceEventConfigurationResponse_ConnectionStatus.h
 *
 * 
 */

#ifndef OAIGetResourceEventConfigurationResponse_ConnectionStatus_H
#define OAIGetResourceEventConfigurationResponse_ConnectionStatus_H
...
class OAIGetResourceEventConfigurationResponse_ConnectionStatus : public OAIObject {
public:
    OAIGetResourceEventConfigurationResponse_ConnectionStatus();
    OAIGetResourceEventConfigurationResponse_ConnectionStatus(QString json);
    ~OAIGetResourceEventConfigurationResponse_ConnectionStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourceEventConfigurationResponse_ConnectionStatus)

#endif // OAIGetResourceEventConfigurationResponse_ConnectionStatus_H
