...
OAISidewalkDevice::OAISidewalkDevice(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISidewalkDevice::OAISidewalkDevice() {
    this->initializeModel();
}

OAISidewalkDevice::~OAISidewalkDevice() {}

void OAISidewalkDevice::initializeModel() {
...
void OAISidewalkDevice::fromJson(QString jsonString) {
...
void OAISidewalkDevice::fromJsonObject(QJsonObject json) {
...
QString OAISidewalkDevice::asJson() const {
...
QJsonObject OAISidewalkDevice::asJsonObject() const {
    QJsonObject obj;
...
QString OAISidewalkDevice::getAmazonId() const {
    return m_amazon_id;
}
void OAISidewalkDevice::setAmazonId(const QString &amazon_id) {
    m_amazon_id = amazon_id;
    m_amazon_id_isSet = true;
}

bool OAISidewalkDevice::is_amazon_id_Set() const{
    return m_amazon_id_isSet;
}

bool OAISidewalkDevice::is_amazon_id_Valid() const{
    return m_amazon_id_isValid;
}

QString OAISidewalkDevice::getSidewalkId() const {
    return m_sidewalk_id;
}
void OAISidewalkDevice::setSidewalkId(const QString &sidewalk_id) {
    m_sidewalk_id = sidewalk_id;
    m_sidewalk_id_isSet = true;
}

bool OAISidewalkDevice::is_sidewalk_id_Set() const{
    return m_sidewalk_id_isSet;
}

bool OAISidewalkDevice::is_sidewalk_id_Valid() const{
    return m_sidewalk_id_isValid;
}

QString OAISidewalkDevice::getSidewalkManufacturingSn() const {
    return m_sidewalk_manufacturing_sn;
}
void OAISidewalkDevice::setSidewalkManufacturingSn(const QString &sidewalk_manufacturing_sn) {
    m_sidewalk_manufacturing_sn = sidewalk_manufacturing_sn;
    m_sidewalk_manufacturing_sn_isSet = true;
}

bool OAISidewalkDevice::is_sidewalk_manufacturing_sn_Set() const{
    return m_sidewalk_manufacturing_sn_isSet;
}

bool OAISidewalkDevice::is_sidewalk_manufacturing_sn_Valid() const{
    return m_sidewalk_manufacturing_sn_isValid;
}

QList OAISidewalkDevice::getDeviceCertificates() const {
    return m_device_certificates;
}
void OAISidewalkDevice::setDeviceCertificates(const QList &device_certificates) {
    m_device_certificates = device_certificates;
    m_device_certificates_isSet = true;
}

bool OAISidewalkDevice::is_device_certificates_Set() const{
    return m_device_certificates_isSet;
}

bool OAISidewalkDevice::is_device_certificates_Valid() const{
    return m_device_certificates_isValid;
}

QList OAISidewalkDevice::getPrivateKeys() const {
    return m_private_keys;
}
void OAISidewalkDevice::setPrivateKeys(const QList &private_keys) {
    m_private_keys = private_keys;
    m_private_keys_isSet = true;
}

bool OAISidewalkDevice::is_private_keys_Set() const{
    return m_private_keys_isSet;
}

bool OAISidewalkDevice::is_private_keys_Valid() const{
    return m_private_keys_isValid;
}

QString OAISidewalkDevice::getDeviceProfileId() const {
    return m_device_profile_id;
}
void OAISidewalkDevice::setDeviceProfileId(const QString &device_profile_id) {
    m_device_profile_id = device_profile_id;
    m_device_profile_id_isSet = true;
}

bool OAISidewalkDevice::is_device_profile_id_Set() const{
    return m_device_profile_id_isSet;
}

bool OAISidewalkDevice::is_device_profile_id_Valid() const{
    return m_device_profile_id_isValid;
}

QString OAISidewalkDevice::getCertificateId() const {
    return m_certificate_id;
}
void OAISidewalkDevice::setCertificateId(const QString &certificate_id) {
    m_certificate_id = certificate_id;
    m_certificate_id_isSet = true;
}

bool OAISidewalkDevice::is_certificate_id_Set() const{
    return m_certificate_id_isSet;
}

bool OAISidewalkDevice::is_certificate_id_Valid() const{
    return m_certificate_id_isValid;
}

OAIWirelessDeviceSidewalkStatus OAISidewalkDevice::getStatus() const {
    return m_status;
}
void OAISidewalkDevice::setStatus(const OAIWirelessDeviceSidewalkStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISidewalkDevice::is_status_Set() const{
    return m_status_isSet;
}

bool OAISidewalkDevice::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISidewalkDevice::isSet() const {
...
bool OAISidewalkDevice::isValid() const {
