...
/*
 * OAIGetFuotaTaskResponse.h
 *
 * 
 */

#ifndef OAIGetFuotaTaskResponse_H
#define OAIGetFuotaTaskResponse_H
...
namespace OpenAPI {
class OAILoRaWANFuotaTaskGetInfo;

class OAIGetFuotaTaskResponse : public OAIObject {
public:
    OAIGetFuotaTaskResponse();
    OAIGetFuotaTaskResponse(QString json);
    ~OAIGetFuotaTaskResponse() override;
    ...
    OAIFuotaTaskStatus getStatus() const;
    void setStatus(const OAIFuotaTaskStatus &status);
    ...
    OAILoRaWANFuotaTaskGetInfo getLoRaWan() const;
    void setLoRaWan(const OAILoRaWANFuotaTaskGetInfo &lo_ra_wan);
...
private:
    ...
    OAILoRaWANFuotaTaskGetInfo m_lo_ra_wan;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFuotaTaskResponse)

#endif // OAIGetFuotaTaskResponse_H
