...
QString OAIDeviceProfile::getArn() const {
    return m_arn;
}
void OAIDeviceProfile::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeviceProfile::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeviceProfile::is_arn_Valid() const{
