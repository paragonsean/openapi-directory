...
public class SessionKeysAbpV11 {
  ...
  public SessionKeysAbpV11() {
  }

  public SessionKeysAbpV11 fnwkSIntKey(String fnwkSIntKey) {
  ...
  public SessionKeysAbpV11 snwkSIntKey(String snwkSIntKey) {
  ...
  public SessionKeysAbpV11 nwkSEncKey(String nwkSEncKey) {
  ...
  public SessionKeysAbpV11 appSKey(String appSKey) {
  ...
  public boolean equals(Object o) {
    ...
    SessionKeysAbpV11 sessionKeysAbpV11 = (SessionKeysAbpV11) o;
    return Objects.equals(this.fnwkSIntKey, sessionKeysAbpV11.fnwkSIntKey) &&
        Objects.equals(this.snwkSIntKey, sessionKeysAbpV11.snwkSIntKey) &&
        Objects.equals(this.nwkSEncKey, sessionKeysAbpV11.nwkSEncKey) &&
        Objects.equals(this.appSKey, sessionKeysAbpV11.appSKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionKeysAbpV11 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SessionKeysAbpV11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SessionKeysAbpV11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionKeysAbpV11 is not found in the empty JSON string", SessionKeysAbpV11.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SessionKeysAbpV11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SessionKeysAbpV11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionKeysAbpV11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionKeysAbpV11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionKeysAbpV11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionKeysAbpV11.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionKeysAbpV11>() {
           @Override
           public void write(JsonWriter out, SessionKeysAbpV11 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SessionKeysAbpV11 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SessionKeysAbpV11 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SessionKeysAbpV11
   * @throws IOException if the JSON string is invalid with respect to SessionKeysAbpV11
   */
  public static SessionKeysAbpV11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionKeysAbpV11.class);
  }

  /**
   * Convert an instance of SessionKeysAbpV11 to an JSON string
   *
   * @return JSON string
   */
