...
public class GetPositionEstimateRequestGnss {
  ...
  public GetPositionEstimateRequestGnss() {
  }

  public GetPositionEstimateRequestGnss payload(String payload) {
  ...
  public GetPositionEstimateRequestGnss captureTime(Float captureTime) {
  ...
  public GetPositionEstimateRequestGnss captureTimeAccuracy(Float captureTimeAccuracy) {
  ...
  public GetPositionEstimateRequestGnss assistPosition(List assistPosition) {
  ...
  public GetPositionEstimateRequestGnss assistAltitude(Float assistAltitude) {
  ...
  public GetPositionEstimateRequestGnss use2DSolver(Boolean use2DSolver) {
  ...
  public boolean equals(Object o) {
    ...
    GetPositionEstimateRequestGnss getPositionEstimateRequestGnss = (GetPositionEstimateRequestGnss) o;
    return Objects.equals(this.payload, getPositionEstimateRequestGnss.payload) &&
        Objects.equals(this.captureTime, getPositionEstimateRequestGnss.captureTime) &&
        Objects.equals(this.captureTimeAccuracy, getPositionEstimateRequestGnss.captureTimeAccuracy) &&
        Objects.equals(this.assistPosition, getPositionEstimateRequestGnss.assistPosition) &&
        Objects.equals(this.assistAltitude, getPositionEstimateRequestGnss.assistAltitude) &&
        Objects.equals(this.use2DSolver, getPositionEstimateRequestGnss.use2DSolver);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPositionEstimateRequestGnss {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPositionEstimateRequestGnss
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPositionEstimateRequestGnss.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPositionEstimateRequestGnss is not found in the empty JSON string", GetPositionEstimateRequestGnss.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPositionEstimateRequestGnss.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPositionEstimateRequestGnss` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPositionEstimateRequestGnss.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPositionEstimateRequestGnss.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPositionEstimateRequestGnss' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPositionEstimateRequestGnss> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPositionEstimateRequestGnss.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPositionEstimateRequestGnss>() {
           @Override
           public void write(JsonWriter out, GetPositionEstimateRequestGnss value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPositionEstimateRequestGnss read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPositionEstimateRequestGnss given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPositionEstimateRequestGnss
   * @throws IOException if the JSON string is invalid with respect to GetPositionEstimateRequestGnss
   */
  public static GetPositionEstimateRequestGnss fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPositionEstimateRequestGnss.class);
  }

  /**
   * Convert an instance of GetPositionEstimateRequestGnss to an JSON string
   *
   * @return JSON string
   */
