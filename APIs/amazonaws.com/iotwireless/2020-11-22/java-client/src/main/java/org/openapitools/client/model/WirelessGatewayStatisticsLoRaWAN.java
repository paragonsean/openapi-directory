...
public class WirelessGatewayStatisticsLoRaWAN {
  ...
  public WirelessGatewayStatisticsLoRaWAN() {
  }

  public WirelessGatewayStatisticsLoRaWAN gatewayEui(String gatewayEui) {
  ...
  public WirelessGatewayStatisticsLoRaWAN rfRegion(String rfRegion) {
  ...
  public WirelessGatewayStatisticsLoRaWAN joinEuiFilters(List<List<String>> joinEuiFilters) {
    this.joinEuiFilters = joinEuiFilters;
    return this;
  }

  public WirelessGatewayStatisticsLoRaWAN addJoinEuiFiltersItem(List<String> joinEuiFiltersItem) {
  ...
  public WirelessGatewayStatisticsLoRaWAN netIdFilters(List<String> netIdFilters) {
    this.netIdFilters = netIdFilters;
    return this;
  }

  public WirelessGatewayStatisticsLoRaWAN addNetIdFiltersItem(String netIdFiltersItem) {
  ...
  public WirelessGatewayStatisticsLoRaWAN subBands(List<Integer> subBands) {
    this.subBands = subBands;
    return this;
  }

  public WirelessGatewayStatisticsLoRaWAN addSubBandsItem(Integer subBandsItem) {
  ...
  public WirelessGatewayStatisticsLoRaWAN beaconing(CreateWirelessGatewayRequestLoRaWANBeaconing beaconing) {
  ...
  public WirelessGatewayStatisticsLoRaWAN maxEirp(Float maxEirp) {
  ...
  public boolean equals(Object o) {
    ...
    WirelessGatewayStatisticsLoRaWAN wirelessGatewayStatisticsLoRaWAN = (WirelessGatewayStatisticsLoRaWAN) o;
    return Objects.equals(this.gatewayEui, wirelessGatewayStatisticsLoRaWAN.gatewayEui) &&
        Objects.equals(this.rfRegion, wirelessGatewayStatisticsLoRaWAN.rfRegion) &&
        Objects.equals(this.joinEuiFilters, wirelessGatewayStatisticsLoRaWAN.joinEuiFilters) &&
        Objects.equals(this.netIdFilters, wirelessGatewayStatisticsLoRaWAN.netIdFilters) &&
        Objects.equals(this.subBands, wirelessGatewayStatisticsLoRaWAN.subBands) &&
        Objects.equals(this.beaconing, wirelessGatewayStatisticsLoRaWAN.beaconing) &&
        Objects.equals(this.maxEirp, wirelessGatewayStatisticsLoRaWAN.maxEirp);
  }
  ...
  public String toString() {
    ...
    sb.append("class WirelessGatewayStatisticsLoRaWAN {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WirelessGatewayStatisticsLoRaWAN
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WirelessGatewayStatisticsLoRaWAN.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WirelessGatewayStatisticsLoRaWAN is not found in the empty JSON string", WirelessGatewayStatisticsLoRaWAN.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WirelessGatewayStatisticsLoRaWAN.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WirelessGatewayStatisticsLoRaWAN` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WirelessGatewayStatisticsLoRaWAN.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WirelessGatewayStatisticsLoRaWAN' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WirelessGatewayStatisticsLoRaWAN> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WirelessGatewayStatisticsLoRaWAN.class));

       return (TypeAdapter<T>) new TypeAdapter<WirelessGatewayStatisticsLoRaWAN>() {
           @Override
           public void write(JsonWriter out, WirelessGatewayStatisticsLoRaWAN value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WirelessGatewayStatisticsLoRaWAN read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WirelessGatewayStatisticsLoRaWAN given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WirelessGatewayStatisticsLoRaWAN
   * @throws IOException if the JSON string is invalid with respect to WirelessGatewayStatisticsLoRaWAN
   */
  public static WirelessGatewayStatisticsLoRaWAN fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WirelessGatewayStatisticsLoRaWAN.class);
  }

  /**
   * Convert an instance of WirelessGatewayStatisticsLoRaWAN to an JSON string
   *
   * @return JSON string
   */
