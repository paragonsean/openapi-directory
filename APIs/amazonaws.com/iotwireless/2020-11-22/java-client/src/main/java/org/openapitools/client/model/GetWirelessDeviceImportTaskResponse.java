...
public class GetWirelessDeviceImportTaskResponse {
  ...
  private GetWirelessDeviceImportTaskResponseSidewalk sidewalk;
  ...
  public GetWirelessDeviceImportTaskResponse() {
  }

  public GetWirelessDeviceImportTaskResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetWirelessDeviceImportTaskResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetWirelessDeviceImportTaskResponse destinationName(String destinationName) {
  ...
  public GetWirelessDeviceImportTaskResponse sidewalk(GetWirelessDeviceImportTaskResponseSidewalk sidewalk) {
   ...
   */
  @javax.annotation.Nullable
  public GetWirelessDeviceImportTaskResponseSidewalk getSidewalk() {
    return sidewalk;
  }

  public void setSidewalk(GetWirelessDeviceImportTaskResponseSidewalk sidewalk) {
    this.sidewalk = sidewalk;
  }


  public GetWirelessDeviceImportTaskResponse creationTime(OffsetDateTime creationTime) {
  ...
  public GetWirelessDeviceImportTaskResponse status(ImportTaskStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetWirelessDeviceImportTaskResponse statusReason(String statusReason) {
  ...
  public GetWirelessDeviceImportTaskResponse initializedImportedDeviceCount(Integer initializedImportedDeviceCount) {
  ...
  public GetWirelessDeviceImportTaskResponse pendingImportedDeviceCount(Integer pendingImportedDeviceCount) {
  ...
  public GetWirelessDeviceImportTaskResponse onboardedImportedDeviceCount(Integer onboardedImportedDeviceCount) {
  ...
  public GetWirelessDeviceImportTaskResponse failedImportedDeviceCount(Integer failedImportedDeviceCount) {
  ...
  public boolean equals(Object o) {
    ...
    GetWirelessDeviceImportTaskResponse getWirelessDeviceImportTaskResponse = (GetWirelessDeviceImportTaskResponse) o;
    return Objects.equals(this.id, getWirelessDeviceImportTaskResponse.id) &&
        Objects.equals(this.arn, getWirelessDeviceImportTaskResponse.arn) &&
        Objects.equals(this.destinationName, getWirelessDeviceImportTaskResponse.destinationName) &&
        Objects.equals(this.sidewalk, getWirelessDeviceImportTaskResponse.sidewalk) &&
        Objects.equals(this.creationTime, getWirelessDeviceImportTaskResponse.creationTime) &&
        Objects.equals(this.status, getWirelessDeviceImportTaskResponse.status) &&
        Objects.equals(this.statusReason, getWirelessDeviceImportTaskResponse.statusReason) &&
        Objects.equals(this.initializedImportedDeviceCount, getWirelessDeviceImportTaskResponse.initializedImportedDeviceCount) &&
        Objects.equals(this.pendingImportedDeviceCount, getWirelessDeviceImportTaskResponse.pendingImportedDeviceCount) &&
        Objects.equals(this.onboardedImportedDeviceCount, getWirelessDeviceImportTaskResponse.onboardedImportedDeviceCount) &&
        Objects.equals(this.failedImportedDeviceCount, getWirelessDeviceImportTaskResponse.failedImportedDeviceCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetWirelessDeviceImportTaskResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetWirelessDeviceImportTaskResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWirelessDeviceImportTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetWirelessDeviceImportTaskResponse is not found in the empty JSON string", GetWirelessDeviceImportTaskResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWirelessDeviceImportTaskResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetWirelessDeviceImportTaskResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Sidewalk") != null && !jsonObj.get("Sidewalk").isJsonNull()) {
        GetWirelessDeviceImportTaskResponseSidewalk.validateJsonElement(jsonObj.get("Sidewalk"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetWirelessDeviceImportTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetWirelessDeviceImportTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetWirelessDeviceImportTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetWirelessDeviceImportTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetWirelessDeviceImportTaskResponse>() {
           @Override
           public void write(JsonWriter out, GetWirelessDeviceImportTaskResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetWirelessDeviceImportTaskResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetWirelessDeviceImportTaskResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetWirelessDeviceImportTaskResponse
   * @throws IOException if the JSON string is invalid with respect to GetWirelessDeviceImportTaskResponse
   */
  public static GetWirelessDeviceImportTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetWirelessDeviceImportTaskResponse.class);
  }

  /**
   * Convert an instance of GetWirelessDeviceImportTaskResponse to an JSON string
   *
   * @return JSON string
   */
