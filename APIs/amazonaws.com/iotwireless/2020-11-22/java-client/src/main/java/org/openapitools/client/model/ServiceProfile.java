...
public class ServiceProfile {
  ...
  public ServiceProfile arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ServiceProfile id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, serviceProfile.arn) &&
        Objects.equals(this.name, serviceProfile.name) &&
        Objects.equals(this.id, serviceProfile.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, name, id);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
