...
public class ApiClient {
    ...
    private String basePath = "http://api.iotwireless.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://api.iotwireless.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://api.iotwireless.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://api.iotwireless.{region}.amazonaws.com.cn",
      "The AWS IoT Wireless endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-11-22/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.iotwireless.us-east-1.amazonaws.com
