...
public class CreateWirelessGatewayRequestLoRaWAN {
  ...
  public CreateWirelessGatewayRequestLoRaWAN() {
  }

  public CreateWirelessGatewayRequestLoRaWAN gatewayEui(String gatewayEui) {
  ...
  public CreateWirelessGatewayRequestLoRaWAN rfRegion(String rfRegion) {
  ...
  public CreateWirelessGatewayRequestLoRaWAN joinEuiFilters(List<List<String>> joinEuiFilters) {
    this.joinEuiFilters = joinEuiFilters;
    return this;
  }

  public CreateWirelessGatewayRequestLoRaWAN addJoinEuiFiltersItem(List<String> joinEuiFiltersItem) {
  ...
  public CreateWirelessGatewayRequestLoRaWAN netIdFilters(List<String> netIdFilters) {
    this.netIdFilters = netIdFilters;
    return this;
  }

  public CreateWirelessGatewayRequestLoRaWAN addNetIdFiltersItem(String netIdFiltersItem) {
  ...
  public CreateWirelessGatewayRequestLoRaWAN subBands(List<Integer> subBands) {
    this.subBands = subBands;
    return this;
  }

  public CreateWirelessGatewayRequestLoRaWAN addSubBandsItem(Integer subBandsItem) {
  ...
  public CreateWirelessGatewayRequestLoRaWAN beaconing(CreateWirelessGatewayRequestLoRaWANBeaconing beaconing) {
  ...
  public CreateWirelessGatewayRequestLoRaWAN maxEirp(Float maxEirp) {
  ...
  public boolean equals(Object o) {
    ...
    CreateWirelessGatewayRequestLoRaWAN createWirelessGatewayRequestLoRaWAN = (CreateWirelessGatewayRequestLoRaWAN) o;
    return Objects.equals(this.gatewayEui, createWirelessGatewayRequestLoRaWAN.gatewayEui) &&
        Objects.equals(this.rfRegion, createWirelessGatewayRequestLoRaWAN.rfRegion) &&
        Objects.equals(this.joinEuiFilters, createWirelessGatewayRequestLoRaWAN.joinEuiFilters) &&
        Objects.equals(this.netIdFilters, createWirelessGatewayRequestLoRaWAN.netIdFilters) &&
        Objects.equals(this.subBands, createWirelessGatewayRequestLoRaWAN.subBands) &&
        Objects.equals(this.beaconing, createWirelessGatewayRequestLoRaWAN.beaconing) &&
        Objects.equals(this.maxEirp, createWirelessGatewayRequestLoRaWAN.maxEirp);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateWirelessGatewayRequestLoRaWAN {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWirelessGatewayRequestLoRaWAN
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWirelessGatewayRequestLoRaWAN.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWirelessGatewayRequestLoRaWAN is not found in the empty JSON string", CreateWirelessGatewayRequestLoRaWAN.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWirelessGatewayRequestLoRaWAN.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWirelessGatewayRequestLoRaWAN` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWirelessGatewayRequestLoRaWAN.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWirelessGatewayRequestLoRaWAN' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWirelessGatewayRequestLoRaWAN> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWirelessGatewayRequestLoRaWAN.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWirelessGatewayRequestLoRaWAN>() {
           @Override
           public void write(JsonWriter out, CreateWirelessGatewayRequestLoRaWAN value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateWirelessGatewayRequestLoRaWAN read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateWirelessGatewayRequestLoRaWAN given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateWirelessGatewayRequestLoRaWAN
   * @throws IOException if the JSON string is invalid with respect to CreateWirelessGatewayRequestLoRaWAN
   */
  public static CreateWirelessGatewayRequestLoRaWAN fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWirelessGatewayRequestLoRaWAN.class);
  }

  /**
   * Convert an instance of CreateWirelessGatewayRequestLoRaWAN to an JSON string
   *
   * @return JSON string
   */
