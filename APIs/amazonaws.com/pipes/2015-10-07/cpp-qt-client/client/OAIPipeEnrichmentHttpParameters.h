...
/*
 * OAIPipeEnrichmentHttpParameters.h
 *
 * These are custom parameter to be used when the target is an API Gateway REST APIs or EventBridge ApiDestinations. In the latter case, these are merged with any InvocationParameters specified on the Connection, with any values from the Connection taking precedence.
 */

#ifndef OAIPipeEnrichmentHttpParameters_H
#define OAIPipeEnrichmentHttpParameters_H
...
class OAIPipeEnrichmentHttpParameters : public OAIObject {
public:
    OAIPipeEnrichmentHttpParameters();
    OAIPipeEnrichmentHttpParameters(QString json);
    ~OAIPipeEnrichmentHttpParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeEnrichmentHttpParameters)

#endif // OAIPipeEnrichmentHttpParameters_H
