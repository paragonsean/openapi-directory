...
/*
 * OAIUpdatePipe_request_EnrichmentParameters_HttpParameters.h
 *
 * 
 */

#ifndef OAIUpdatePipe_request_EnrichmentParameters_HttpParameters_H
#define OAIUpdatePipe_request_EnrichmentParameters_HttpParameters_H
...
class OAIUpdatePipe_request_EnrichmentParameters_HttpParameters : public OAIObject {
public:
    OAIUpdatePipe_request_EnrichmentParameters_HttpParameters();
    OAIUpdatePipe_request_EnrichmentParameters_HttpParameters(QString json);
    ~OAIUpdatePipe_request_EnrichmentParameters_HttpParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipe_request_EnrichmentParameters_HttpParameters)

#endif // OAIUpdatePipe_request_EnrichmentParameters_HttpParameters_H
