...
/*
 * OAIUpdatePipeSourceSqsQueueParameters.h
 *
 * The parameters for using a Amazon SQS stream as a source.
 */

#ifndef OAIUpdatePipeSourceSqsQueueParameters_H
#define OAIUpdatePipeSourceSqsQueueParameters_H
...
class OAIUpdatePipeSourceSqsQueueParameters : public OAIObject {
public:
    OAIUpdatePipeSourceSqsQueueParameters();
    OAIUpdatePipeSourceSqsQueueParameters(QString json);
    ~OAIUpdatePipeSourceSqsQueueParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipeSourceSqsQueueParameters)

#endif // OAIUpdatePipeSourceSqsQueueParameters_H
