...
/*
 * OAIStopPipeResponse.h
 *
 * 
 */

#ifndef OAIStopPipeResponse_H
#define OAIStopPipeResponse_H
...
class OAIStopPipeResponse : public OAIObject {
public:
    OAIStopPipeResponse();
    OAIStopPipeResponse(QString json);
    ~OAIStopPipeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopPipeResponse)

#endif // OAIStopPipeResponse_H
