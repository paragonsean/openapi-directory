...
/*
 * OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters.h
 *
 * 
 */

#ifndef OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters_H
#define OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters_H
...
class OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters : public OAIObject {
public:
    OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters();
    OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters(QString json);
    ~OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters)

#endif // OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters_H
