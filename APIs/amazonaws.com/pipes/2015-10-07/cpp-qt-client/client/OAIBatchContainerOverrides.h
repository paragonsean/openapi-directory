...
/*
 * OAIBatchContainerOverrides.h
 *
 * The overrides that are sent to a container.
 */

#ifndef OAIBatchContainerOverrides_H
#define OAIBatchContainerOverrides_H
...
class OAIBatchContainerOverrides : public OAIObject {
public:
    OAIBatchContainerOverrides();
    OAIBatchContainerOverrides(QString json);
    ~OAIBatchContainerOverrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchContainerOverrides)

#endif // OAIBatchContainerOverrides_H
