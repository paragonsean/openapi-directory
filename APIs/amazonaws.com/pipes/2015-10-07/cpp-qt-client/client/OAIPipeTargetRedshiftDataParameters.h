...
/*
 * OAIPipeTargetRedshiftDataParameters.h
 *
...
#ifndef OAIPipeTargetRedshiftDataParameters_H
#define OAIPipeTargetRedshiftDataParameters_H
...
class OAIPipeTargetRedshiftDataParameters : public OAIObject {
public:
    OAIPipeTargetRedshiftDataParameters();
    OAIPipeTargetRedshiftDataParameters(QString json);
    ~OAIPipeTargetRedshiftDataParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeTargetRedshiftDataParameters)

#endif // OAIPipeTargetRedshiftDataParameters_H
