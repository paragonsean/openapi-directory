...
/*
 * OAICreatePipe_request_SourceParameters_SqsQueueParameters.h
 *
 * 
 */

#ifndef OAICreatePipe_request_SourceParameters_SqsQueueParameters_H
#define OAICreatePipe_request_SourceParameters_SqsQueueParameters_H
...
class OAICreatePipe_request_SourceParameters_SqsQueueParameters : public OAIObject {
public:
    OAICreatePipe_request_SourceParameters_SqsQueueParameters();
    OAICreatePipe_request_SourceParameters_SqsQueueParameters(QString json);
    ~OAICreatePipe_request_SourceParameters_SqsQueueParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipe_request_SourceParameters_SqsQueueParameters)

#endif // OAICreatePipe_request_SourceParameters_SqsQueueParameters_H
