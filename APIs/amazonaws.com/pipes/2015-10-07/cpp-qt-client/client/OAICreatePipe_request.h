...
/*
 * OAICreatePipe_request.h
 *
 * 
 */

#ifndef OAICreatePipe_request_H
#define OAICreatePipe_request_H
...
class OAICreatePipe_request_SourceParameters;
class OAIUpdatePipe_request_TargetParameters;

class OAICreatePipe_request : public OAIObject {
public:
    OAICreatePipe_request();
    OAICreatePipe_request(QString json);
    ~OAICreatePipe_request() override;
    ...
    OAICreatePipe_request_SourceParameters getSourceParameters() const;
    void setSourceParameters(const OAICreatePipe_request_SourceParameters &source_parameters);
...
private:
    ...
    OAICreatePipe_request_SourceParameters m_source_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipe_request)

#endif // OAICreatePipe_request_H
