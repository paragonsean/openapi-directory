...
/*
 * OAIUpdatePipe_request_TargetParameters.h
 *
 * The parameters required to set up a target for your pipe.
 */

#ifndef OAIUpdatePipe_request_TargetParameters_H
#define OAIUpdatePipe_request_TargetParameters_H
...
class OAIUpdatePipe_request_TargetParameters : public OAIObject {
public:
    OAIUpdatePipe_request_TargetParameters();
    OAIUpdatePipe_request_TargetParameters(QString json);
    ~OAIUpdatePipe_request_TargetParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipe_request_TargetParameters)

#endif // OAIUpdatePipe_request_TargetParameters_H
