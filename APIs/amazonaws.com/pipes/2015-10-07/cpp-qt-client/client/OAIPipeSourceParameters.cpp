...
#include "OAIPipeSourceParameters.h"
...
OAIPipeSourceParameters::OAIPipeSourceParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipeSourceParameters::OAIPipeSourceParameters() {
    this->initializeModel();
}

OAIPipeSourceParameters::~OAIPipeSourceParameters() {}

void OAIPipeSourceParameters::initializeModel() {
...
void OAIPipeSourceParameters::fromJson(QString jsonString) {
...
void OAIPipeSourceParameters::fromJsonObject(QJsonObject json) {
...
QString OAIPipeSourceParameters::asJson() const {
...
QJsonObject OAIPipeSourceParameters::asJsonObject() const {
    QJsonObject obj;
...
OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters OAIPipeSourceParameters::getActiveMqBrokerParameters() const {
    return m_active_mq_broker_parameters;
}
void OAIPipeSourceParameters::setActiveMqBrokerParameters(const OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters &active_mq_broker_parameters) {
    m_active_mq_broker_parameters = active_mq_broker_parameters;
    m_active_mq_broker_parameters_isSet = true;
}

bool OAIPipeSourceParameters::is_active_mq_broker_parameters_Set() const{
    return m_active_mq_broker_parameters_isSet;
}

bool OAIPipeSourceParameters::is_active_mq_broker_parameters_Valid() const{
    return m_active_mq_broker_parameters_isValid;
}

OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters OAIPipeSourceParameters::getDynamoDbStreamParameters() const {
    return m_dynamo_db_stream_parameters;
}
void OAIPipeSourceParameters::setDynamoDbStreamParameters(const OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters &dynamo_db_stream_parameters) {
    m_dynamo_db_stream_parameters = dynamo_db_stream_parameters;
    m_dynamo_db_stream_parameters_isSet = true;
}

bool OAIPipeSourceParameters::is_dynamo_db_stream_parameters_Set() const{
    return m_dynamo_db_stream_parameters_isSet;
}

bool OAIPipeSourceParameters::is_dynamo_db_stream_parameters_Valid() const{
    return m_dynamo_db_stream_parameters_isValid;
}

OAIUpdatePipe_request_SourceParameters_FilterCriteria OAIPipeSourceParameters::getFilterCriteria() const {
    return m_filter_criteria;
}
void OAIPipeSourceParameters::setFilterCriteria(const OAIUpdatePipe_request_SourceParameters_FilterCriteria &filter_criteria) {
    m_filter_criteria = filter_criteria;
    m_filter_criteria_isSet = true;
}

bool OAIPipeSourceParameters::is_filter_criteria_Set() const{
    return m_filter_criteria_isSet;
}

bool OAIPipeSourceParameters::is_filter_criteria_Valid() const{
    return m_filter_criteria_isValid;
}

OAICreatePipe_request_SourceParameters_KinesisStreamParameters OAIPipeSourceParameters::getKinesisStreamParameters() const {
    return m_kinesis_stream_parameters;
}
void OAIPipeSourceParameters::setKinesisStreamParameters(const OAICreatePipe_request_SourceParameters_KinesisStreamParameters &kinesis_stream_parameters) {
    m_kinesis_stream_parameters = kinesis_stream_parameters;
    m_kinesis_stream_parameters_isSet = true;
}

bool OAIPipeSourceParameters::is_kinesis_stream_parameters_Set() const{
    return m_kinesis_stream_parameters_isSet;
}

bool OAIPipeSourceParameters::is_kinesis_stream_parameters_Valid() const{
    return m_kinesis_stream_parameters_isValid;
}

OAICreatePipe_request_SourceParameters_ManagedStreamingKafkaParameters OAIPipeSourceParameters::getManagedStreamingKafkaParameters() const {
    return m_managed_streaming_kafka_parameters;
}
void OAIPipeSourceParameters::setManagedStreamingKafkaParameters(const OAICreatePipe_request_SourceParameters_ManagedStreamingKafkaParameters &managed_streaming_kafka_parameters) {
    m_managed_streaming_kafka_parameters = managed_streaming_kafka_parameters;
    m_managed_streaming_kafka_parameters_isSet = true;
}

bool OAIPipeSourceParameters::is_managed_streaming_kafka_parameters_Set() const{
    return m_managed_streaming_kafka_parameters_isSet;
}

bool OAIPipeSourceParameters::is_managed_streaming_kafka_parameters_Valid() const{
    return m_managed_streaming_kafka_parameters_isValid;
}

OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters OAIPipeSourceParameters::getRabbitMqBrokerParameters() const {
    return m_rabbit_mq_broker_parameters;
}
void OAIPipeSourceParameters::setRabbitMqBrokerParameters(const OAICreatePipe_request_SourceParameters_RabbitMQBrokerParameters &rabbit_mq_broker_parameters) {
    m_rabbit_mq_broker_parameters = rabbit_mq_broker_parameters;
    m_rabbit_mq_broker_parameters_isSet = true;
}

bool OAIPipeSourceParameters::is_rabbit_mq_broker_parameters_Set() const{
    return m_rabbit_mq_broker_parameters_isSet;
}

bool OAIPipeSourceParameters::is_rabbit_mq_broker_parameters_Valid() const{
    return m_rabbit_mq_broker_parameters_isValid;
}

OAICreatePipe_request_SourceParameters_SelfManagedKafkaParameters OAIPipeSourceParameters::getSelfManagedKafkaParameters() const {
    return m_self_managed_kafka_parameters;
}
void OAIPipeSourceParameters::setSelfManagedKafkaParameters(const OAICreatePipe_request_SourceParameters_SelfManagedKafkaParameters &self_managed_kafka_parameters) {
    m_self_managed_kafka_parameters = self_managed_kafka_parameters;
    m_self_managed_kafka_parameters_isSet = true;
}

bool OAIPipeSourceParameters::is_self_managed_kafka_parameters_Set() const{
    return m_self_managed_kafka_parameters_isSet;
}

bool OAIPipeSourceParameters::is_self_managed_kafka_parameters_Valid() const{
    return m_self_managed_kafka_parameters_isValid;
}

OAICreatePipe_request_SourceParameters_SqsQueueParameters OAIPipeSourceParameters::getSqsQueueParameters() const {
    return m_sqs_queue_parameters;
}
void OAIPipeSourceParameters::setSqsQueueParameters(const OAICreatePipe_request_SourceParameters_SqsQueueParameters &sqs_queue_parameters) {
    m_sqs_queue_parameters = sqs_queue_parameters;
    m_sqs_queue_parameters_isSet = true;
}

bool OAIPipeSourceParameters::is_sqs_queue_parameters_Set() const{
    return m_sqs_queue_parameters_isSet;
}

bool OAIPipeSourceParameters::is_sqs_queue_parameters_Valid() const{
    return m_sqs_queue_parameters_isValid;
}

bool OAIPipeSourceParameters::isSet() const {
...
bool OAIPipeSourceParameters::isValid() const {
