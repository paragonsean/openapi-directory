...
/*
 * OAIUpdatePipeSourceManagedStreamingKafkaParameters.h
 *
 * The parameters for using an MSK stream as a source.
 */

#ifndef OAIUpdatePipeSourceManagedStreamingKafkaParameters_H
#define OAIUpdatePipeSourceManagedStreamingKafkaParameters_H
...
class OAIUpdatePipeSourceManagedStreamingKafkaParameters : public OAIObject {
public:
    OAIUpdatePipeSourceManagedStreamingKafkaParameters();
    OAIUpdatePipeSourceManagedStreamingKafkaParameters(QString json);
    ~OAIUpdatePipeSourceManagedStreamingKafkaParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipeSourceManagedStreamingKafkaParameters)

#endif // OAIUpdatePipeSourceManagedStreamingKafkaParameters_H
