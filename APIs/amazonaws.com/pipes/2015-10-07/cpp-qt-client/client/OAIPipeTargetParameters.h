...
/*
 * OAIPipeTargetParameters.h
 *
 * The parameters required to set up a target for your pipe.
 */

#ifndef OAIPipeTargetParameters_H
#define OAIPipeTargetParameters_H
...
class OAIPipeTargetParameters : public OAIObject {
public:
    OAIPipeTargetParameters();
    OAIPipeTargetParameters(QString json);
    ~OAIPipeTargetParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeTargetParameters)

#endif // OAIPipeTargetParameters_H
