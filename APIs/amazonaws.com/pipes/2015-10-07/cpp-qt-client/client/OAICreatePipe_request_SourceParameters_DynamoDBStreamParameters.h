...
/*
 * OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters.h
 *
 * 
 */

#ifndef OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters_H
#define OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters_H

#include <QJsonObject>

#include "OAIDynamoDBStreamStartPosition.h"
...
class OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters : public OAIObject {
public:
    OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters();
    OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters(QString json);
    ~OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters() override;
    ...
    OAIDynamoDBStreamStartPosition getStartingPosition() const;
    void setStartingPosition(const OAIDynamoDBStreamStartPosition &starting_position);
...
private:
    ...
    OAIDynamoDBStreamStartPosition m_starting_position;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters)

#endif // OAICreatePipe_request_SourceParameters_DynamoDBStreamParameters_H
