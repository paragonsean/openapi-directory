...
/*
 * OAIPipeSourceSqsQueueParameters.h
 *
 * The parameters for using a Amazon SQS stream as a source.
 */

#ifndef OAIPipeSourceSqsQueueParameters_H
#define OAIPipeSourceSqsQueueParameters_H
...
class OAIPipeSourceSqsQueueParameters : public OAIObject {
public:
    OAIPipeSourceSqsQueueParameters();
    OAIPipeSourceSqsQueueParameters(QString json);
    ~OAIPipeSourceSqsQueueParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeSourceSqsQueueParameters)

#endif // OAIPipeSourceSqsQueueParameters_H
