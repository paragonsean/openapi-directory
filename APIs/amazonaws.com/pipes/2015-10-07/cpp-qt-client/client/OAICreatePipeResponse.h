...
/*
 * OAICreatePipeResponse.h
 *
 * 
 */

#ifndef OAICreatePipeResponse_H
#define OAICreatePipeResponse_H
...
class OAICreatePipeResponse : public OAIObject {
public:
    OAICreatePipeResponse();
    OAICreatePipeResponse(QString json);
    ~OAICreatePipeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipeResponse)

#endif // OAICreatePipeResponse_H
