...
/*
 * OAIPipeSourceActiveMQBrokerParameters.h
 *
 * The parameters for using an Active MQ broker as a source.
 */

#ifndef OAIPipeSourceActiveMQBrokerParameters_H
#define OAIPipeSourceActiveMQBrokerParameters_H
...
class OAIPipeSourceActiveMQBrokerParameters : public OAIObject {
public:
    OAIPipeSourceActiveMQBrokerParameters();
    OAIPipeSourceActiveMQBrokerParameters(QString json);
    ~OAIPipeSourceActiveMQBrokerParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeSourceActiveMQBrokerParameters)

#endif // OAIPipeSourceActiveMQBrokerParameters_H
