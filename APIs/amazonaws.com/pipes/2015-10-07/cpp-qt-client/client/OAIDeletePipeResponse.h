...
/*
 * OAIDeletePipeResponse.h
 *
 * 
 */

#ifndef OAIDeletePipeResponse_H
#define OAIDeletePipeResponse_H
...
class OAIDeletePipeResponse : public OAIObject {
public:
    OAIDeletePipeResponse();
    OAIDeletePipeResponse(QString json);
    ~OAIDeletePipeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePipeResponse)

#endif // OAIDeletePipeResponse_H
