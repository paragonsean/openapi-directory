...
/*
 * OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters.h
 *
 * 
 */

#ifndef OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters_H
#define OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters_H
...
class OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters : public OAIObject {
public:
    OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters();
    OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters(QString json);
    ~OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters)

#endif // OAIUpdatePipe_request_SourceParameters_KinesisStreamParameters_H
