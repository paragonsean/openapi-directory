...
/*
 * OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters.h
 *
 * 
 */

#ifndef OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters_H
#define OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters_H
...
class OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters : public OAIObject {
public:
    OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters();
    OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters(QString json);
    ~OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters)

#endif // OAICreatePipe_request_SourceParameters_ActiveMQBrokerParameters_H
