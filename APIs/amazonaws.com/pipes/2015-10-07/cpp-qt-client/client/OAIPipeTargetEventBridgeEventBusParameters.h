...
/*
 * OAIPipeTargetEventBridgeEventBusParameters.h
 *
 * The parameters for using an EventBridge event bus as a target.
 */

#ifndef OAIPipeTargetEventBridgeEventBusParameters_H
#define OAIPipeTargetEventBridgeEventBusParameters_H
...
class OAIPipeTargetEventBridgeEventBusParameters : public OAIObject {
public:
    OAIPipeTargetEventBridgeEventBusParameters();
    OAIPipeTargetEventBridgeEventBusParameters(QString json);
    ~OAIPipeTargetEventBridgeEventBusParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeTargetEventBridgeEventBusParameters)

#endif // OAIPipeTargetEventBridgeEventBusParameters_H
