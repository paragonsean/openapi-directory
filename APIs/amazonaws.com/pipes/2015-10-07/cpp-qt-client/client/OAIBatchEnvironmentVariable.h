...
#ifndef OAIBatchEnvironmentVariable_H
#define OAIBatchEnvironmentVariable_H
...
class OAIBatchEnvironmentVariable : public OAIObject {
public:
    OAIBatchEnvironmentVariable();
    OAIBatchEnvironmentVariable(QString json);
    ~OAIBatchEnvironmentVariable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchEnvironmentVariable)

#endif // OAIBatchEnvironmentVariable_H
