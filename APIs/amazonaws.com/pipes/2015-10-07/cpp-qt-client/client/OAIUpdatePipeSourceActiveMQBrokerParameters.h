...
/*
 * OAIUpdatePipeSourceActiveMQBrokerParameters.h
 *
 * The parameters for using an Active MQ broker as a source.
 */

#ifndef OAIUpdatePipeSourceActiveMQBrokerParameters_H
#define OAIUpdatePipeSourceActiveMQBrokerParameters_H
...
class OAIUpdatePipeSourceActiveMQBrokerParameters : public OAIObject {
public:
    OAIUpdatePipeSourceActiveMQBrokerParameters();
    OAIUpdatePipeSourceActiveMQBrokerParameters(QString json);
    ~OAIUpdatePipeSourceActiveMQBrokerParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipeSourceActiveMQBrokerParameters)

#endif // OAIUpdatePipeSourceActiveMQBrokerParameters_H
