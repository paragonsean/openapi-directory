...
/*
 * OAIUpdatePipeSourceRabbitMQBrokerParameters.h
 *
 * The parameters for using a Rabbit MQ broker as a source.
 */

#ifndef OAIUpdatePipeSourceRabbitMQBrokerParameters_H
#define OAIUpdatePipeSourceRabbitMQBrokerParameters_H
...
class OAIUpdatePipeSourceRabbitMQBrokerParameters : public OAIObject {
public:
    OAIUpdatePipeSourceRabbitMQBrokerParameters();
    OAIUpdatePipeSourceRabbitMQBrokerParameters(QString json);
    ~OAIUpdatePipeSourceRabbitMQBrokerParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipeSourceRabbitMQBrokerParameters)

#endif // OAIUpdatePipeSourceRabbitMQBrokerParameters_H
