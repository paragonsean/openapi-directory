...
/*
 * OAIPipeTargetEcsTaskParameters_Overrides.h
 *
 * 
 */

#ifndef OAIPipeTargetEcsTaskParameters_Overrides_H
#define OAIPipeTargetEcsTaskParameters_Overrides_H
...
class OAIPipeTargetEcsTaskParameters_Overrides : public OAIObject {
public:
    OAIPipeTargetEcsTaskParameters_Overrides();
    OAIPipeTargetEcsTaskParameters_Overrides(QString json);
    ~OAIPipeTargetEcsTaskParameters_Overrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipeTargetEcsTaskParameters_Overrides)

#endif // OAIPipeTargetEcsTaskParameters_Overrides_H
