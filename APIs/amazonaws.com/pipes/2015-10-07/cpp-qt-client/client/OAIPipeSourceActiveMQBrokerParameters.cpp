...
#include "OAIPipeSourceActiveMQBrokerParameters.h"
...
OAIPipeSourceActiveMQBrokerParameters::OAIPipeSourceActiveMQBrokerParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipeSourceActiveMQBrokerParameters::OAIPipeSourceActiveMQBrokerParameters() {
    this->initializeModel();
}

OAIPipeSourceActiveMQBrokerParameters::~OAIPipeSourceActiveMQBrokerParameters() {}

void OAIPipeSourceActiveMQBrokerParameters::initializeModel() {
...
void OAIPipeSourceActiveMQBrokerParameters::fromJson(QString jsonString) {
...
void OAIPipeSourceActiveMQBrokerParameters::fromJsonObject(QJsonObject json) {
...
QString OAIPipeSourceActiveMQBrokerParameters::asJson() const {
...
QJsonObject OAIPipeSourceActiveMQBrokerParameters::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPipeSourceActiveMQBrokerParameters::getBatchSize() const {
    return m_batch_size;
}
void OAIPipeSourceActiveMQBrokerParameters::setBatchSize(const qint32 &batch_size) {
    m_batch_size = batch_size;
    m_batch_size_isSet = true;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_batch_size_Set() const{
    return m_batch_size_isSet;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_batch_size_Valid() const{
    return m_batch_size_isValid;
}

OAIPipeSourceActiveMQBrokerParameters_Credentials OAIPipeSourceActiveMQBrokerParameters::getCredentials() const {
    return m_credentials;
}
void OAIPipeSourceActiveMQBrokerParameters::setCredentials(const OAIPipeSourceActiveMQBrokerParameters_Credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_credentials_Valid() const{
    return m_credentials_isValid;
}

qint32 OAIPipeSourceActiveMQBrokerParameters::getMaximumBatchingWindowInSeconds() const {
    return m_maximum_batching_window_in_seconds;
}
void OAIPipeSourceActiveMQBrokerParameters::setMaximumBatchingWindowInSeconds(const qint32 &maximum_batching_window_in_seconds) {
    m_maximum_batching_window_in_seconds = maximum_batching_window_in_seconds;
    m_maximum_batching_window_in_seconds_isSet = true;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_maximum_batching_window_in_seconds_Set() const{
    return m_maximum_batching_window_in_seconds_isSet;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_maximum_batching_window_in_seconds_Valid() const{
    return m_maximum_batching_window_in_seconds_isValid;
}

QString OAIPipeSourceActiveMQBrokerParameters::getQueueName() const {
    return m_queue_name;
}
void OAIPipeSourceActiveMQBrokerParameters::setQueueName(const QString &queue_name) {
    m_queue_name = queue_name;
    m_queue_name_isSet = true;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_queue_name_Set() const{
    return m_queue_name_isSet;
}

bool OAIPipeSourceActiveMQBrokerParameters::is_queue_name_Valid() const{
    return m_queue_name_isValid;
}

bool OAIPipeSourceActiveMQBrokerParameters::isSet() const {
...
bool OAIPipeSourceActiveMQBrokerParameters::isValid() const {
