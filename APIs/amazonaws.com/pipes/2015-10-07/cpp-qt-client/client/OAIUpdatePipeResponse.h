...
/*
 * OAIUpdatePipeResponse.h
 *
 * 
 */

#ifndef OAIUpdatePipeResponse_H
#define OAIUpdatePipeResponse_H
...
class OAIUpdatePipeResponse : public OAIObject {
public:
    OAIUpdatePipeResponse();
    OAIUpdatePipeResponse(QString json);
    ~OAIUpdatePipeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePipeResponse)

#endif // OAIUpdatePipeResponse_H
