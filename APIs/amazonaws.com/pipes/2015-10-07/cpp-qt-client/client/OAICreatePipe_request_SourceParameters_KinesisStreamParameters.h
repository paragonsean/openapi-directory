...
/*
 * OAICreatePipe_request_SourceParameters_KinesisStreamParameters.h
 *
 * 
 */

#ifndef OAICreatePipe_request_SourceParameters_KinesisStreamParameters_H
#define OAICreatePipe_request_SourceParameters_KinesisStreamParameters_H
...
class OAICreatePipe_request_SourceParameters_KinesisStreamParameters : public OAIObject {
public:
    OAICreatePipe_request_SourceParameters_KinesisStreamParameters();
    OAICreatePipe_request_SourceParameters_KinesisStreamParameters(QString json);
    ~OAICreatePipe_request_SourceParameters_KinesisStreamParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipe_request_SourceParameters_KinesisStreamParameters)

#endif // OAICreatePipe_request_SourceParameters_KinesisStreamParameters_H
