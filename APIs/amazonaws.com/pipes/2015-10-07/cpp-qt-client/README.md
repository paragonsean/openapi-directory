...
QString Example::create(){
    QString obj;
OAICreatePipe_request Example::create(){
    OAICreatePipe_request obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createPipeSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createPipeSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString name = create(); // QString | The name of the pipe.
      ...
      OAICreatePipe_request oai_create_pipe_request = create(); // OAICreatePipe_request | 
      ...
      apiInstance.createPipe(nameoai_create_pipe_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
