...
* @readonly
*/
export default class PipeTargetInvocationType {
    ...
    /**
    * Returns a <code>PipeTargetInvocationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PipeTargetInvocationType} The enum <code>PipeTargetInvocationType</code> value.
    */
