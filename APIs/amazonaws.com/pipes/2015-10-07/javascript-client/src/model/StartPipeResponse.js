...
/**
 * The StartPipeResponse model module.
 * @module model/StartPipeResponse
 * @version 2015-10-07
 */
class StartPipeResponse {
    /**
     * Constructs a new <code>StartPipeResponse</code>.
     * @alias module:model/StartPipeResponse
     */
    constructor() { 
        
        StartPipeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartPipeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartPipeResponse} obj Optional instance to populate.
     * @return {module:model/StartPipeResponse} The populated <code>StartPipeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartPipeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartPipeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartPipeResponse</code>.
     */
 ...
 * @member {String} Arn
 */
StartPipeResponse.prototype['Arn'] = undefined;

/**
 * @member {Date} CreationTime
 */
StartPipeResponse.prototype['CreationTime'] = undefined;

/**
 * @member {module:model/PipeState} CurrentState
 */
StartPipeResponse.prototype['CurrentState'] = undefined;

/**
 * @member {module:model/RequestedPipeState} DesiredState
 */
StartPipeResponse.prototype['DesiredState'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
StartPipeResponse.prototype['LastModifiedTime'] = undefined;

/**
 * @member {String} Name
 */
StartPipeResponse.prototype['Name'] = undefined;
...
export default StartPipeResponse;
