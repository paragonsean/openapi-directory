...
* @readonly
*/
export default class MSKStartPosition {
    ...
    /**
    * Returns a <code>MSKStartPosition</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MSKStartPosition} The enum <code>MSKStartPosition</code> value.
    */
