...
* @readonly
*/
export default class RequestedPipeState {
    ...
    /**
    * Returns a <code>RequestedPipeState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RequestedPipeState} The enum <code>RequestedPipeState</code> value.
    */
