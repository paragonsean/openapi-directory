...
/**
 * The DeletePipeResponse model module.
 * @module model/DeletePipeResponse
 * @version 2015-10-07
 */
class DeletePipeResponse {
    /**
     * Constructs a new <code>DeletePipeResponse</code>.
     * @alias module:model/DeletePipeResponse
     */
    constructor() { 
        
        DeletePipeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeletePipeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePipeResponse} obj Optional instance to populate.
     * @return {module:model/DeletePipeResponse} The populated <code>DeletePipeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePipeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePipeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePipeResponse</code>.
     */
 ...
 * @member {String} Arn
 */
DeletePipeResponse.prototype['Arn'] = undefined;

/**
 * @member {Date} CreationTime
 */
DeletePipeResponse.prototype['CreationTime'] = undefined;

/**
 * @member {module:model/PipeState} CurrentState
 */
DeletePipeResponse.prototype['CurrentState'] = undefined;

/**
 * @member {module:model/RequestedPipeStateDescribeResponse} DesiredState
 */
DeletePipeResponse.prototype['DesiredState'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
DeletePipeResponse.prototype['LastModifiedTime'] = undefined;

/**
 * @member {String} Name
 */
DeletePipeResponse.prototype['Name'] = undefined;
...
export default DeletePipeResponse;
