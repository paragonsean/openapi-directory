...
/**
 * The CreatePipeResponse model module.
 * @module model/CreatePipeResponse
 * @version 2015-10-07
 */
class CreatePipeResponse {
    /**
     * Constructs a new <code>CreatePipeResponse</code>.
     * @alias module:model/CreatePipeResponse
     */
    constructor() { 
        
        CreatePipeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePipeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePipeResponse} obj Optional instance to populate.
     * @return {module:model/CreatePipeResponse} The populated <code>CreatePipeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePipeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePipeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePipeResponse</code>.
     */
 ...
 * @member {String} Arn
 */
CreatePipeResponse.prototype['Arn'] = undefined;

/**
 * @member {Date} CreationTime
 */
CreatePipeResponse.prototype['CreationTime'] = undefined;

/**
 * @member {module:model/PipeState} CurrentState
 */
CreatePipeResponse.prototype['CurrentState'] = undefined;

/**
 * @member {module:model/RequestedPipeState} DesiredState
 */
CreatePipeResponse.prototype['DesiredState'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
CreatePipeResponse.prototype['LastModifiedTime'] = undefined;

/**
 * @member {String} Name
 */
CreatePipeResponse.prototype['Name'] = undefined;
...
export default CreatePipeResponse;
