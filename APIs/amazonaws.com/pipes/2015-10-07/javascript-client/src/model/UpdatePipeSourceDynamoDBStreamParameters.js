...
/**
 * The UpdatePipeSourceDynamoDBStreamParameters model module.
 * @module model/UpdatePipeSourceDynamoDBStreamParameters
 * @version 2015-10-07
 */
class UpdatePipeSourceDynamoDBStreamParameters {
    /**
     * Constructs a new <code>UpdatePipeSourceDynamoDBStreamParameters</code>.
     * The parameters for using a DynamoDB stream as a source.
     * @alias module:model/UpdatePipeSourceDynamoDBStreamParameters
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UpdatePipeSourceDynamoDBStreamParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePipeSourceDynamoDBStreamParameters} obj Optional instance to populate.
     * @return {module:model/UpdatePipeSourceDynamoDBStreamParameters} The populated <code>UpdatePipeSourceDynamoDBStreamParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePipeSourceDynamoDBStreamParameters();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePipeSourceDynamoDBStreamParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePipeSourceDynamoDBStreamParameters</code>.
     */
...
export default UpdatePipeSourceDynamoDBStreamParameters;
