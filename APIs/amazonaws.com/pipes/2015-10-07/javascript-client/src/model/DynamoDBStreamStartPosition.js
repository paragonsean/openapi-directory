...
* @readonly
*/
export default class DynamoDBStreamStartPosition {
    ...
    /**
    * Returns a <code>DynamoDBStreamStartPosition</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DynamoDBStreamStartPosition} The enum <code>DynamoDBStreamStartPosition</code> value.
    */
