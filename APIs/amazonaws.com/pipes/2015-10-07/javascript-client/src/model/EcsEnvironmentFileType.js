...
* @readonly
*/
export default class EcsEnvironmentFileType {
    ...
    /**
    * Returns a <code>EcsEnvironmentFileType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EcsEnvironmentFileType} The enum <code>EcsEnvironmentFileType</code> value.
    */
