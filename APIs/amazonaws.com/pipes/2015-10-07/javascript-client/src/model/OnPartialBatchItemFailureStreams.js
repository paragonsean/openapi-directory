...
* @readonly
*/
export default class OnPartialBatchItemFailureStreams {
    
        /**
         * value: "AUTOMATIC_BISECT"
         * @const
         */
    ...
    /**
    * Returns a <code>OnPartialBatchItemFailureStreams</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OnPartialBatchItemFailureStreams} The enum <code>OnPartialBatchItemFailureStreams</code> value.
    */
