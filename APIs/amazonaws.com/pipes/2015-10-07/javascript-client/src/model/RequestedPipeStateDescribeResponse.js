...
* @readonly
*/
export default class RequestedPipeStateDescribeResponse {
    ...
    /**
    * Returns a <code>RequestedPipeStateDescribeResponse</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RequestedPipeStateDescribeResponse} The enum <code>RequestedPipeStateDescribeResponse</code> value.
    */
