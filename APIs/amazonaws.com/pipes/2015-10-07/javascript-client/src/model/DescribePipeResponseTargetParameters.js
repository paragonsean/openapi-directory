...
/**
 * The DescribePipeResponseTargetParameters model module.
 * @module model/DescribePipeResponseTargetParameters
 * @version 2015-10-07
 */
class DescribePipeResponseTargetParameters {
    /**
     * Constructs a new <code>DescribePipeResponseTargetParameters</code>.
     * @alias module:model/DescribePipeResponseTargetParameters
     * @implements module:model/PipeTargetParameters
     */
    constructor() { 
        PipeTargetParameters.initialize(this);
        DescribePipeResponseTargetParameters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePipeResponseTargetParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePipeResponseTargetParameters} obj Optional instance to populate.
     * @return {module:model/DescribePipeResponseTargetParameters} The populated <code>DescribePipeResponseTargetParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePipeResponseTargetParameters();
            PipeTargetParameters.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePipeResponseTargetParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePipeResponseTargetParameters</code>.
     */
 ...
 */
DescribePipeResponseTargetParameters.prototype['StepFunctionStateMachineParameters'] = undefined;


// Implement PipeTargetParameters interface:
/**
 * @member {module:model/UpdatePipeRequestTargetParametersBatchJobParameters} BatchJobParameters
 */
...
export default DescribePipeResponseTargetParameters;
