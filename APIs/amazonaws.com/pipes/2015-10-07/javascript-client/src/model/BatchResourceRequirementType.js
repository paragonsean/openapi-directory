...
* @readonly
*/
export default class BatchResourceRequirementType {
    ...
    /**
    * Returns a <code>BatchResourceRequirementType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BatchResourceRequirementType} The enum <code>BatchResourceRequirementType</code> value.
    */
