...
/**
 * The UpdatePipeSourceKinesisStreamParameters model module.
 * @module model/UpdatePipeSourceKinesisStreamParameters
 * @version 2015-10-07
 */
class UpdatePipeSourceKinesisStreamParameters {
    /**
     * Constructs a new <code>UpdatePipeSourceKinesisStreamParameters</code>.
     * The parameters for using a Kinesis stream as a source.
     * @alias module:model/UpdatePipeSourceKinesisStreamParameters
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UpdatePipeSourceKinesisStreamParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePipeSourceKinesisStreamParameters} obj Optional instance to populate.
     * @return {module:model/UpdatePipeSourceKinesisStreamParameters} The populated <code>UpdatePipeSourceKinesisStreamParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePipeSourceKinesisStreamParameters();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePipeSourceKinesisStreamParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePipeSourceKinesisStreamParameters</code>.
     */
...
export default UpdatePipeSourceKinesisStreamParameters;
