...
/**
 * The UpdatePipeRequestTargetParametersEcsTaskParameters model module.
 * @module model/UpdatePipeRequestTargetParametersEcsTaskParameters
 * @version 2015-10-07
 */
class UpdatePipeRequestTargetParametersEcsTaskParameters {
    /**
     * Constructs a new <code>UpdatePipeRequestTargetParametersEcsTaskParameters</code>.
     * @alias module:model/UpdatePipeRequestTargetParametersEcsTaskParameters
     * @implements module:model/PipeTargetEcsTaskParameters
     * @param taskDefinitionArn {String} 
     */
    constructor(taskDefinitionArn) { 
        PipeTargetEcsTaskParameters.initialize(this, taskDefinitionArn);
        UpdatePipeRequestTargetParametersEcsTaskParameters.initialize(this, taskDefinitionArn);
    }
    ...
    /**
     * Constructs a <code>UpdatePipeRequestTargetParametersEcsTaskParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePipeRequestTargetParametersEcsTaskParameters} obj Optional instance to populate.
     * @return {module:model/UpdatePipeRequestTargetParametersEcsTaskParameters} The populated <code>UpdatePipeRequestTargetParametersEcsTaskParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePipeRequestTargetParametersEcsTaskParameters();
            PipeTargetEcsTaskParameters.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePipeRequestTargetParametersEcsTaskParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePipeRequestTargetParametersEcsTaskParameters</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePipeRequestTargetParametersEcsTaskParameters.RequiredProperties) {
...
UpdatePipeRequestTargetParametersEcsTaskParameters.RequiredProperties = ["TaskDefinitionArn"];

/**
 * @member {Array} CapacityProviderStrategy
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['CapacityProviderStrategy'] = undefined;

/**
 * @member {Boolean} EnableECSManagedTags
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['EnableECSManagedTags'] = undefined;

/**
 * @member {Boolean} EnableExecuteCommand
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['EnableExecuteCommand'] = undefined;

/**
 * @member {String} Group
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['Group'] = undefined;

/**
 * @member {module:model/LaunchType} LaunchType
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['LaunchType'] = undefined;

/**
 * @member {module:model/PipeTargetEcsTaskParametersNetworkConfiguration} NetworkConfiguration
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['NetworkConfiguration'] = undefined;

/**
 * @member {module:model/PipeTargetEcsTaskParametersOverrides} Overrides
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['Overrides'] = undefined;

/**
 * @member {Array} PlacementConstraints
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['PlacementConstraints'] = undefined;

/**
 * @member {Array} PlacementStrategy
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['PlacementStrategy'] = undefined;

/**
 * @member {String} PlatformVersion
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['PlatformVersion'] = undefined;

/**
 * @member {module:model/PropagateTags} PropagateTags
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['PropagateTags'] = undefined;

/**
 * @member {String} ReferenceId
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['ReferenceId'] = undefined;

/**
 * @member {Array} Tags
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['Tags'] = undefined;

/**
 * @member {Number} TaskCount
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['TaskCount'] = undefined;

/**
 * @member {String} TaskDefinitionArn
 */
UpdatePipeRequestTargetParametersEcsTaskParameters.prototype['TaskDefinitionArn'] = undefined;


// Implement PipeTargetEcsTaskParameters interface:
/**
 * @member {Array} CapacityProviderStrategy
 */
...
export default UpdatePipeRequestTargetParametersEcsTaskParameters;
