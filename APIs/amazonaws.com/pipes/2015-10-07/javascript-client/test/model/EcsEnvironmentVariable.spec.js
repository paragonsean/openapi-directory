...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.EcsEnvironmentVariable();
  });
  ...
  describe('EcsEnvironmentVariable', function() {
    it('should create an instance of EcsEnvironmentVariable', function() {
      // uncomment below and update the code to test EcsEnvironmentVariable
      //var instance = new AmazonEventBridgePipes.EcsEnvironmentVariable();
      //expect(instance).to.be.a(AmazonEventBridgePipes.EcsEnvironmentVariable);
    });
