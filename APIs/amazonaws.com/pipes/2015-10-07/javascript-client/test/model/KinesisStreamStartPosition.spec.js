...
(function(root, factory) {
  ...
  describe('KinesisStreamStartPosition', function() {
    it('should create an instance of KinesisStreamStartPosition', function() {
      // uncomment below and update the code to test KinesisStreamStartPosition
      //var instance = new AmazonEventBridgePipes.KinesisStreamStartPosition();
      //expect(instance).to.be.a(AmazonEventBridgePipes.KinesisStreamStartPosition);
    });
