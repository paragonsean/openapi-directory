...
(function(root, factory) {
  ...
  describe('RequestedPipeStateDescribeResponse', function() {
    it('should create an instance of RequestedPipeStateDescribeResponse', function() {
      // uncomment below and update the code to test RequestedPipeStateDescribeResponse
      //var instance = new AmazonEventBridgePipes.RequestedPipeStateDescribeResponse();
      //expect(instance).to.be.a(AmazonEventBridgePipes.RequestedPipeStateDescribeResponse);
    });
