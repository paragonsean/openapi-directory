...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.NetworkConfigurationAwsvpcConfiguration();
  });
  ...
  describe('NetworkConfigurationAwsvpcConfiguration', function() {
    it('should create an instance of NetworkConfigurationAwsvpcConfiguration', function() {
      ...
      //var instance = new AmazonEventBridgePipes.NetworkConfigurationAwsvpcConfiguration();
      //expect(instance).to.be.a(AmazonEventBridgePipes.NetworkConfigurationAwsvpcConfiguration);
    });
