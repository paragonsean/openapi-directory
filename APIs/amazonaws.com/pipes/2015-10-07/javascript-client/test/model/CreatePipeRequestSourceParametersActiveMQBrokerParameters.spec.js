...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.CreatePipeRequestSourceParametersActiveMQBrokerParameters();
  });
  ...
  describe('CreatePipeRequestSourceParametersActiveMQBrokerParameters', function() {
    it('should create an instance of CreatePipeRequestSourceParametersActiveMQBrokerParameters', function() {
      // uncomment below and update the code to test CreatePipeRequestSourceParametersActiveMQBrokerParameters
      //var instance = new AmazonEventBridgePipes.CreatePipeRequestSourceParametersActiveMQBrokerParameters();
      //expect(instance).to.be.a(AmazonEventBridgePipes.CreatePipeRequestSourceParametersActiveMQBrokerParameters);
    });
