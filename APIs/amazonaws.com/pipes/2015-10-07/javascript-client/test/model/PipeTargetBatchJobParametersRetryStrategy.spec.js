...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PipeTargetBatchJobParametersRetryStrategy();
  });
  ...
  describe('PipeTargetBatchJobParametersRetryStrategy', function() {
    it('should create an instance of PipeTargetBatchJobParametersRetryStrategy', function() {
      // uncomment below and update the code to test PipeTargetBatchJobParametersRetryStrategy
      //var instance = new AmazonEventBridgePipes.PipeTargetBatchJobParametersRetryStrategy();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeTargetBatchJobParametersRetryStrategy);
    });
