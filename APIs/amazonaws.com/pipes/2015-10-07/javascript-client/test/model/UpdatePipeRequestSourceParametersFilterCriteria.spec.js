...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.UpdatePipeRequestSourceParametersFilterCriteria();
  });
  ...
  describe('UpdatePipeRequestSourceParametersFilterCriteria', function() {
    it('should create an instance of UpdatePipeRequestSourceParametersFilterCriteria', function() {
      // uncomment below and update the code to test UpdatePipeRequestSourceParametersFilterCriteria
      //var instance = new AmazonEventBridgePipes.UpdatePipeRequestSourceParametersFilterCriteria();
      //expect(instance).to.be.a(AmazonEventBridgePipes.UpdatePipeRequestSourceParametersFilterCriteria);
    });
