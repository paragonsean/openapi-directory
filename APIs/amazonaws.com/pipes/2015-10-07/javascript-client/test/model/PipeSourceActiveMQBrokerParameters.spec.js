...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PipeSourceActiveMQBrokerParameters();
  });
  ...
  describe('PipeSourceActiveMQBrokerParameters', function() {
    it('should create an instance of PipeSourceActiveMQBrokerParameters', function() {
      // uncomment below and update the code to test PipeSourceActiveMQBrokerParameters
      //var instance = new AmazonEventBridgePipes.PipeSourceActiveMQBrokerParameters();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeSourceActiveMQBrokerParameters);
    });
