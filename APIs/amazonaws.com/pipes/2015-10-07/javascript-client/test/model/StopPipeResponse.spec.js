...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.StopPipeResponse();
  });
  ...
  describe('StopPipeResponse', function() {
    it('should create an instance of StopPipeResponse', function() {
      // uncomment below and update the code to test StopPipeResponse
      //var instance = new AmazonEventBridgePipes.StopPipeResponse();
      //expect(instance).to.be.a(AmazonEventBridgePipes.StopPipeResponse);
    });
