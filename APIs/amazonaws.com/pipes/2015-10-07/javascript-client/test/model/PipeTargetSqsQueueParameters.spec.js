...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PipeTargetSqsQueueParameters();
  });
  ...
  describe('PipeTargetSqsQueueParameters', function() {
    it('should create an instance of PipeTargetSqsQueueParameters', function() {
      // uncomment below and update the code to test PipeTargetSqsQueueParameters
      //var instance = new AmazonEventBridgePipes.PipeTargetSqsQueueParameters();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeTargetSqsQueueParameters);
    });
