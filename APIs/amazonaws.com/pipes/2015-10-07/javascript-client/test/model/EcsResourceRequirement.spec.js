...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.EcsResourceRequirement();
  });
  ...
  describe('EcsResourceRequirement', function() {
    it('should create an instance of EcsResourceRequirement', function() {
      // uncomment below and update the code to test EcsResourceRequirement
      //var instance = new AmazonEventBridgePipes.EcsResourceRequirement();
      //expect(instance).to.be.a(AmazonEventBridgePipes.EcsResourceRequirement);
    });
