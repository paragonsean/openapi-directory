...
(function(root, factory) {
  ...
  describe('EcsEnvironmentFileType', function() {
    it('should create an instance of EcsEnvironmentFileType', function() {
      // uncomment below and update the code to test EcsEnvironmentFileType
      //var instance = new AmazonEventBridgePipes.EcsEnvironmentFileType();
      //expect(instance).to.be.a(AmazonEventBridgePipes.EcsEnvironmentFileType);
    });
