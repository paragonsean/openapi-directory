...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.BatchResourceRequirement();
  });
  ...
  describe('BatchResourceRequirement', function() {
    it('should create an instance of BatchResourceRequirement', function() {
      // uncomment below and update the code to test BatchResourceRequirement
      //var instance = new AmazonEventBridgePipes.BatchResourceRequirement();
      //expect(instance).to.be.a(AmazonEventBridgePipes.BatchResourceRequirement);
    });
