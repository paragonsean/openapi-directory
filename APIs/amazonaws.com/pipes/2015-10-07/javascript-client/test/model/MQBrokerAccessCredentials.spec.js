...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.MQBrokerAccessCredentials();
  });
  ...
  describe('MQBrokerAccessCredentials', function() {
    it('should create an instance of MQBrokerAccessCredentials', function() {
      // uncomment below and update the code to test MQBrokerAccessCredentials
      //var instance = new AmazonEventBridgePipes.MQBrokerAccessCredentials();
      //expect(instance).to.be.a(AmazonEventBridgePipes.MQBrokerAccessCredentials);
    });
