...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.StartPipeResponse();
  });
  ...
  describe('StartPipeResponse', function() {
    it('should create an instance of StartPipeResponse', function() {
      // uncomment below and update the code to test StartPipeResponse
      //var instance = new AmazonEventBridgePipes.StartPipeResponse();
      //expect(instance).to.be.a(AmazonEventBridgePipes.StartPipeResponse);
    });
