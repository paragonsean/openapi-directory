...
(function(root, factory) {
  ...
  describe('SelfManagedKafkaStartPosition', function() {
    it('should create an instance of SelfManagedKafkaStartPosition', function() {
      // uncomment below and update the code to test SelfManagedKafkaStartPosition
      //var instance = new AmazonEventBridgePipes.SelfManagedKafkaStartPosition();
      //expect(instance).to.be.a(AmazonEventBridgePipes.SelfManagedKafkaStartPosition);
    });
