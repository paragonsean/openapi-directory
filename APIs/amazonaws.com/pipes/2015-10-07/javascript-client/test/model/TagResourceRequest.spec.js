...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonEventBridgePipes.TagResourceRequest();
      //expect(instance).to.be.a(AmazonEventBridgePipes.TagResourceRequest);
    });
