...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.EcsEnvironmentFile();
  });
  ...
  describe('EcsEnvironmentFile', function() {
    it('should create an instance of EcsEnvironmentFile', function() {
      // uncomment below and update the code to test EcsEnvironmentFile
      //var instance = new AmazonEventBridgePipes.EcsEnvironmentFile();
      //expect(instance).to.be.a(AmazonEventBridgePipes.EcsEnvironmentFile);
    });
