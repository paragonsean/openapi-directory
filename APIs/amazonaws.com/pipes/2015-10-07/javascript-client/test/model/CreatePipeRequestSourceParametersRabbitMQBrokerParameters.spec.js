...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.CreatePipeRequestSourceParametersRabbitMQBrokerParameters();
  });
  ...
  describe('CreatePipeRequestSourceParametersRabbitMQBrokerParameters', function() {
    it('should create an instance of CreatePipeRequestSourceParametersRabbitMQBrokerParameters', function() {
      // uncomment below and update the code to test CreatePipeRequestSourceParametersRabbitMQBrokerParameters
      //var instance = new AmazonEventBridgePipes.CreatePipeRequestSourceParametersRabbitMQBrokerParameters();
      //expect(instance).to.be.a(AmazonEventBridgePipes.CreatePipeRequestSourceParametersRabbitMQBrokerParameters);
    });
