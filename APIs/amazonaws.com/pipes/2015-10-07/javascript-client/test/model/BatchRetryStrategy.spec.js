...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.BatchRetryStrategy();
  });
  ...
  describe('BatchRetryStrategy', function() {
    it('should create an instance of BatchRetryStrategy', function() {
      ...
      //var instance = new AmazonEventBridgePipes.BatchRetryStrategy();
      //expect(instance).to.be.a(AmazonEventBridgePipes.BatchRetryStrategy);
    });
