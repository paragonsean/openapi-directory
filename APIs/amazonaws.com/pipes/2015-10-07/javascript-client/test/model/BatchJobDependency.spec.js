...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.BatchJobDependency();
  });
  ...
  describe('BatchJobDependency', function() {
    it('should create an instance of BatchJobDependency', function() {
      // uncomment below and update the code to test BatchJobDependency
      //var instance = new AmazonEventBridgePipes.BatchJobDependency();
      //expect(instance).to.be.a(AmazonEventBridgePipes.BatchJobDependency);
    });
