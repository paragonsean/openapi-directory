...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PlacementConstraint();
  });
  ...
  describe('PlacementConstraint', function() {
    it('should create an instance of PlacementConstraint', function() {
      ...
      //var instance = new AmazonEventBridgePipes.PlacementConstraint();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PlacementConstraint);
    });
