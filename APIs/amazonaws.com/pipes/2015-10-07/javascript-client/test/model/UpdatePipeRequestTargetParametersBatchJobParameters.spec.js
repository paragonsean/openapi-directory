...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.UpdatePipeRequestTargetParametersBatchJobParameters();
  });
  ...
  describe('UpdatePipeRequestTargetParametersBatchJobParameters', function() {
    it('should create an instance of UpdatePipeRequestTargetParametersBatchJobParameters', function() {
      // uncomment below and update the code to test UpdatePipeRequestTargetParametersBatchJobParameters
      //var instance = new AmazonEventBridgePipes.UpdatePipeRequestTargetParametersBatchJobParameters();
      //expect(instance).to.be.a(AmazonEventBridgePipes.UpdatePipeRequestTargetParametersBatchJobParameters);
    });
