...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PipeTargetEcsTaskParameters();
  });
  ...
  describe('PipeTargetEcsTaskParameters', function() {
    it('should create an instance of PipeTargetEcsTaskParameters', function() {
      // uncomment below and update the code to test PipeTargetEcsTaskParameters
      //var instance = new AmazonEventBridgePipes.PipeTargetEcsTaskParameters();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeTargetEcsTaskParameters);
    });
