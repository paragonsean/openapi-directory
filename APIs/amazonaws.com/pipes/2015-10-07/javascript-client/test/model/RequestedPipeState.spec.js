...
(function(root, factory) {
  ...
  describe('RequestedPipeState', function() {
    it('should create an instance of RequestedPipeState', function() {
      // uncomment below and update the code to test RequestedPipeState
      //var instance = new AmazonEventBridgePipes.RequestedPipeState();
      //expect(instance).to.be.a(AmazonEventBridgePipes.RequestedPipeState);
    });
