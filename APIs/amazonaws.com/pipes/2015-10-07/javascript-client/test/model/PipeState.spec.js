...
(function(root, factory) {
  ...
  describe('PipeState', function() {
    it('should create an instance of PipeState', function() {
      // uncomment below and update the code to test PipeState
      //var instance = new AmazonEventBridgePipes.PipeState();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeState);
    });
