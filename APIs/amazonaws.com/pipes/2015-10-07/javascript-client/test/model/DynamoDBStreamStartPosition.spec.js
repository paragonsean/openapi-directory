...
(function(root, factory) {
  ...
  describe('DynamoDBStreamStartPosition', function() {
    it('should create an instance of DynamoDBStreamStartPosition', function() {
      // uncomment below and update the code to test DynamoDBStreamStartPosition
      //var instance = new AmazonEventBridgePipes.DynamoDBStreamStartPosition();
      //expect(instance).to.be.a(AmazonEventBridgePipes.DynamoDBStreamStartPosition);
    });
