...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PipeTargetEcsTaskParametersOverrides();
  });
  ...
  describe('PipeTargetEcsTaskParametersOverrides', function() {
    it('should create an instance of PipeTargetEcsTaskParametersOverrides', function() {
      // uncomment below and update the code to test PipeTargetEcsTaskParametersOverrides
      //var instance = new AmazonEventBridgePipes.PipeTargetEcsTaskParametersOverrides();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeTargetEcsTaskParametersOverrides);
    });
