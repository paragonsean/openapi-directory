...
(function(root, factory) {
  ...
  describe('MSKStartPosition', function() {
    it('should create an instance of MSKStartPosition', function() {
      // uncomment below and update the code to test MSKStartPosition
      //var instance = new AmazonEventBridgePipes.MSKStartPosition();
      //expect(instance).to.be.a(AmazonEventBridgePipes.MSKStartPosition);
    });
