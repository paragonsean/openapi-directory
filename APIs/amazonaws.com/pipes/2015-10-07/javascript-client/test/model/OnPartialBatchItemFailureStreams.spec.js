...
(function(root, factory) {
  ...
  describe('OnPartialBatchItemFailureStreams', function() {
    it('should create an instance of OnPartialBatchItemFailureStreams', function() {
      // uncomment below and update the code to test OnPartialBatchItemFailureStreams
      //var instance = new AmazonEventBridgePipes.OnPartialBatchItemFailureStreams();
      //expect(instance).to.be.a(AmazonEventBridgePipes.OnPartialBatchItemFailureStreams);
    });
