...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.ListPipesResponse();
  });
  ...
  describe('ListPipesResponse', function() {
    it('should create an instance of ListPipesResponse', function() {
      // uncomment below and update the code to test ListPipesResponse
      //var instance = new AmazonEventBridgePipes.ListPipesResponse();
      //expect(instance).to.be.a(AmazonEventBridgePipes.ListPipesResponse);
    });
    ...
    it('should have the property pipes (base name: "Pipes")', function() {
      // uncomment below and update the code to test the property pipes
      //var instance = new AmazonEventBridgePipes.ListPipesResponse();
      //expect(instance).to.be();
    });
