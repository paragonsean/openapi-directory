...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PipeTargetBatchJobParametersContainerOverrides();
  });
  ...
  describe('PipeTargetBatchJobParametersContainerOverrides', function() {
    it('should create an instance of PipeTargetBatchJobParametersContainerOverrides', function() {
      // uncomment below and update the code to test PipeTargetBatchJobParametersContainerOverrides
      //var instance = new AmazonEventBridgePipes.PipeTargetBatchJobParametersContainerOverrides();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeTargetBatchJobParametersContainerOverrides);
    });
