...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.BatchContainerOverrides();
  });
  ...
  describe('BatchContainerOverrides', function() {
    it('should create an instance of BatchContainerOverrides', function() {
      // uncomment below and update the code to test BatchContainerOverrides
      //var instance = new AmazonEventBridgePipes.BatchContainerOverrides();
      //expect(instance).to.be.a(AmazonEventBridgePipes.BatchContainerOverrides);
    });
