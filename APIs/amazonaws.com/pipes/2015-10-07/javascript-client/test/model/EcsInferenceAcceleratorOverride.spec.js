...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.EcsInferenceAcceleratorOverride();
  });
  ...
  describe('EcsInferenceAcceleratorOverride', function() {
    it('should create an instance of EcsInferenceAcceleratorOverride', function() {
      // uncomment below and update the code to test EcsInferenceAcceleratorOverride
      //var instance = new AmazonEventBridgePipes.EcsInferenceAcceleratorOverride();
      //expect(instance).to.be.a(AmazonEventBridgePipes.EcsInferenceAcceleratorOverride);
    });
