...
(function(root, factory) {
  ...
  describe('EcsResourceRequirementType', function() {
    it('should create an instance of EcsResourceRequirementType', function() {
      // uncomment below and update the code to test EcsResourceRequirementType
      //var instance = new AmazonEventBridgePipes.EcsResourceRequirementType();
      //expect(instance).to.be.a(AmazonEventBridgePipes.EcsResourceRequirementType);
    });
