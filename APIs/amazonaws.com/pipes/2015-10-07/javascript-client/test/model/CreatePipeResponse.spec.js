...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.CreatePipeResponse();
  });
  ...
  describe('CreatePipeResponse', function() {
    it('should create an instance of CreatePipeResponse', function() {
      // uncomment below and update the code to test CreatePipeResponse
      //var instance = new AmazonEventBridgePipes.CreatePipeResponse();
      //expect(instance).to.be.a(AmazonEventBridgePipes.CreatePipeResponse);
    });
