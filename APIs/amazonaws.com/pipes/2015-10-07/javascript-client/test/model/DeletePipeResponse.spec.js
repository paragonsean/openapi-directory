...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.DeletePipeResponse();
  });
  ...
  describe('DeletePipeResponse', function() {
    it('should create an instance of DeletePipeResponse', function() {
      // uncomment below and update the code to test DeletePipeResponse
      //var instance = new AmazonEventBridgePipes.DeletePipeResponse();
      //expect(instance).to.be.a(AmazonEventBridgePipes.DeletePipeResponse);
    });
