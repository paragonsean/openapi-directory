...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.SageMakerPipelineParameter();
  });
  ...
  describe('SageMakerPipelineParameter', function() {
    it('should create an instance of SageMakerPipelineParameter', function() {
      ...
      //var instance = new AmazonEventBridgePipes.SageMakerPipelineParameter();
      //expect(instance).to.be.a(AmazonEventBridgePipes.SageMakerPipelineParameter);
    });
