...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.EcsContainerOverride();
  });
  ...
  describe('EcsContainerOverride', function() {
    it('should create an instance of EcsContainerOverride', function() {
      // uncomment below and update the code to test EcsContainerOverride
      //var instance = new AmazonEventBridgePipes.EcsContainerOverride();
      //expect(instance).to.be.a(AmazonEventBridgePipes.EcsContainerOverride);
    });
