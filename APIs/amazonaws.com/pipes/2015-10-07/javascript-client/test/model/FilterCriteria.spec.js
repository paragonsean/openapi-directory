...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.FilterCriteria();
  });
  ...
  describe('FilterCriteria', function() {
    it('should create an instance of FilterCriteria', function() {
      ...
      //var instance = new AmazonEventBridgePipes.FilterCriteria();
      //expect(instance).to.be.a(AmazonEventBridgePipes.FilterCriteria);
    });
