...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.BatchArrayProperties();
  });
  ...
  describe('BatchArrayProperties', function() {
    it('should create an instance of BatchArrayProperties', function() {
      ...
      //var instance = new AmazonEventBridgePipes.BatchArrayProperties();
      //expect(instance).to.be.a(AmazonEventBridgePipes.BatchArrayProperties);
    });
