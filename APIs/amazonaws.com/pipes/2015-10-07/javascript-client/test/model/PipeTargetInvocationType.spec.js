...
(function(root, factory) {
  ...
  describe('PipeTargetInvocationType', function() {
    it('should create an instance of PipeTargetInvocationType', function() {
      // uncomment below and update the code to test PipeTargetInvocationType
      //var instance = new AmazonEventBridgePipes.PipeTargetInvocationType();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PipeTargetInvocationType);
    });
