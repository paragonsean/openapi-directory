...
(function(root, factory) {
  ...
  describe('BatchResourceRequirementType', function() {
    it('should create an instance of BatchResourceRequirementType', function() {
      // uncomment below and update the code to test BatchResourceRequirementType
      //var instance = new AmazonEventBridgePipes.BatchResourceRequirementType();
      //expect(instance).to.be.a(AmazonEventBridgePipes.BatchResourceRequirementType);
    });
