...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.PlacementStrategy();
  });
  ...
  describe('PlacementStrategy', function() {
    it('should create an instance of PlacementStrategy', function() {
      ...
      //var instance = new AmazonEventBridgePipes.PlacementStrategy();
      //expect(instance).to.be.a(AmazonEventBridgePipes.PlacementStrategy);
    });
