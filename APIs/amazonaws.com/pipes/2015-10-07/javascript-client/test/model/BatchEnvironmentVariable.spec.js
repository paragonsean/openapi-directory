...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.BatchEnvironmentVariable();
  });
  ...
  describe('BatchEnvironmentVariable', function() {
    it('should create an instance of BatchEnvironmentVariable', function() {
      // uncomment below and update the code to test BatchEnvironmentVariable
      //var instance = new AmazonEventBridgePipes.BatchEnvironmentVariable();
      //expect(instance).to.be.a(AmazonEventBridgePipes.BatchEnvironmentVariable);
    });
