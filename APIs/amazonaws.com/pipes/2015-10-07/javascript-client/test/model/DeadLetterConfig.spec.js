...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.DeadLetterConfig();
  });
  ...
  describe('DeadLetterConfig', function() {
    it('should create an instance of DeadLetterConfig', function() {
      ...
      //var instance = new AmazonEventBridgePipes.DeadLetterConfig();
      //expect(instance).to.be.a(AmazonEventBridgePipes.DeadLetterConfig);
    });
