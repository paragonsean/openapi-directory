...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonEventBridgePipes.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonEventBridgePipes.ListTagsForResourceResponse);
    });
