...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgePipes.UpdatePipeRequestTargetParametersSqsQueueParameters();
  });
  ...
  describe('UpdatePipeRequestTargetParametersSqsQueueParameters', function() {
    it('should create an instance of UpdatePipeRequestTargetParametersSqsQueueParameters', function() {
      // uncomment below and update the code to test UpdatePipeRequestTargetParametersSqsQueueParameters
      //var instance = new AmazonEventBridgePipes.UpdatePipeRequestTargetParametersSqsQueueParameters();
      //expect(instance).to.be.a(AmazonEventBridgePipes.UpdatePipeRequestTargetParametersSqsQueueParameters);
    });
