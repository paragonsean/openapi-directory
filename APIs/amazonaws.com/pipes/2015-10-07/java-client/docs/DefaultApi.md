...
<a id="createPipe"></a>
# **createPipe**
> CreatePipeResponse createPipe(name, createPipeRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
<a id="deletePipe"></a>
# **deletePipe**
> DeletePipeResponse deletePipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DeletePipeResponse result = apiInstance.deletePipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#deletePipe");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="describePipe"></a>
# **describePipe**
> DescribePipeResponse describePipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      DescribePipeResponse result = apiInstance.describePipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#describePipe");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="listPipes"></a>
# **listPipes**
> ListPipesResponse listPipes(xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, currentState, desiredState, limit, namePrefix, nextToken, sourcePrefix, targetPrefix)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzSignature = "xAmzSignature_example"; // String | 
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    String currentState = "RUNNING"; // String | The state the pipe is in.
    String desiredState = "RUNNING"; // String | The state the pipe should be in.
    Integer limit = 56; // Integer | The maximum number of pipes to include in the response.
    String namePrefix = "namePrefix_example"; // String | A value that will return a subset of the pipes associated with this account. For example, <code>\"NamePrefix\": \"ABC\"</code> will return all endpoints with \"ABC\" in the name.
    String nextToken = "nextToken_example"; // String | If <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an HTTP 400 InvalidToken error.
    String sourcePrefix = "sourcePrefix_example"; // String | The prefix matching the pipe source.
    String targetPrefix = "targetPrefix_example"; // String | The prefix matching the pipe target.
    try {
      ListPipesResponse result = apiInstance.listPipes(xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, currentState, desiredState, limit, namePrefix, nextToken, sourcePrefix, targetPrefix);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#listPipes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **xAmzSignature** | **String**|  | [optional] |
| **xAmzSignedHeaders** | **String**|  | [optional] |
| **currentState** | **String**| The state the pipe is in. | [optional] [enum: RUNNING, STOPPED, CREATING, UPDATING, DELETING, STARTING, STOPPING, CREATE_FAILED, UPDATE_FAILED, START_FAILED, STOP_FAILED] |
| **desiredState** | **String**| The state the pipe should be in. | [optional] [enum: RUNNING, STOPPED] |
| **limit** | **Integer**| The maximum number of pipes to include in the response. | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String | The ARN of the pipe for which you want to view tags.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
...
<a id="startPipe"></a>
# **startPipe**
> StartPipeResponse startPipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      StartPipeResponse result = apiInstance.startPipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#startPipe");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="stopPipe"></a>
# **stopPipe**
> StopPipeResponse stopPipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      StopPipeResponse result = apiInstance.stopPipe(name, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#stopPipe");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String | The ARN of the pipe.
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String resourceArn = "resourceArn_example"; // String | The ARN of the pipe.
    List<String> tagKeys = Arrays.asList(); // List<String> | The list of tag keys to remove from the pipe.
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
...
|------------- | ------------- | ------------- | -------------|
| **resourceArn** | **String**| The ARN of the pipe. | |
| **tagKeys** | [**List&lt;String&gt;**](String.md)| The list of tag keys to remove from the pipe. | |
| **xAmzContentSha256** | **String**|  | [optional] |
| **xAmzDate** | **String**|  | [optional] |
| **xAmzAlgorithm** | **String**|  | [optional] |
| **xAmzCredential** | **String**|  | [optional] |
...
<a id="updatePipe"></a>
# **updatePipe**
> UpdatePipeResponse updatePipe(name, updatePipeRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String name = "name_example"; // String | The name of the pipe.
    UpdatePipeRequest updatePipeRequest = new UpdatePipeRequest(); // UpdatePipeRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      UpdatePipeResponse result = apiInstance.updatePipe(name, updatePipeRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#updatePipe");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
