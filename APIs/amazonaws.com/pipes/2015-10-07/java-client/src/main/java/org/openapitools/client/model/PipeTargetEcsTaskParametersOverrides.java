...
public class PipeTargetEcsTaskParametersOverrides {
  ...
  public PipeTargetEcsTaskParametersOverrides() {
  }

  public PipeTargetEcsTaskParametersOverrides containerOverrides(List containerOverrides) {
  ...
  public PipeTargetEcsTaskParametersOverrides cpu(String cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public PipeTargetEcsTaskParametersOverrides ephemeralStorage(EcsTaskOverrideEphemeralStorage ephemeralStorage) {
  ...
  public PipeTargetEcsTaskParametersOverrides executionRoleArn(String executionRoleArn) {
  ...
  public PipeTargetEcsTaskParametersOverrides inferenceAcceleratorOverrides(List inferenceAcceleratorOverrides) {
  ...
  public PipeTargetEcsTaskParametersOverrides memory(String memory) {
    this.memory = memory;
    return this;
  }
  ...
  public PipeTargetEcsTaskParametersOverrides taskRoleArn(String taskRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    PipeTargetEcsTaskParametersOverrides pipeTargetEcsTaskParametersOverrides = (PipeTargetEcsTaskParametersOverrides) o;
    return Objects.equals(this.containerOverrides, pipeTargetEcsTaskParametersOverrides.containerOverrides) &&
        Objects.equals(this.cpu, pipeTargetEcsTaskParametersOverrides.cpu) &&
        Objects.equals(this.ephemeralStorage, pipeTargetEcsTaskParametersOverrides.ephemeralStorage) &&
        Objects.equals(this.executionRoleArn, pipeTargetEcsTaskParametersOverrides.executionRoleArn) &&
        Objects.equals(this.inferenceAcceleratorOverrides, pipeTargetEcsTaskParametersOverrides.inferenceAcceleratorOverrides) &&
        Objects.equals(this.memory, pipeTargetEcsTaskParametersOverrides.memory) &&
        Objects.equals(this.taskRoleArn, pipeTargetEcsTaskParametersOverrides.taskRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipeTargetEcsTaskParametersOverrides {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipeTargetEcsTaskParametersOverrides
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipeTargetEcsTaskParametersOverrides.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipeTargetEcsTaskParametersOverrides is not found in the empty JSON string", PipeTargetEcsTaskParametersOverrides.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipeTargetEcsTaskParametersOverrides.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipeTargetEcsTaskParametersOverrides` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipeTargetEcsTaskParametersOverrides.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipeTargetEcsTaskParametersOverrides' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipeTargetEcsTaskParametersOverrides> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipeTargetEcsTaskParametersOverrides.class));

       return (TypeAdapter<T>) new TypeAdapter<PipeTargetEcsTaskParametersOverrides>() {
           @Override
           public void write(JsonWriter out, PipeTargetEcsTaskParametersOverrides value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipeTargetEcsTaskParametersOverrides read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipeTargetEcsTaskParametersOverrides given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipeTargetEcsTaskParametersOverrides
   * @throws IOException if the JSON string is invalid with respect to PipeTargetEcsTaskParametersOverrides
   */
  public static PipeTargetEcsTaskParametersOverrides fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipeTargetEcsTaskParametersOverrides.class);
  }

  /**
   * Convert an instance of PipeTargetEcsTaskParametersOverrides to an JSON string
   *
   * @return JSON string
   */
