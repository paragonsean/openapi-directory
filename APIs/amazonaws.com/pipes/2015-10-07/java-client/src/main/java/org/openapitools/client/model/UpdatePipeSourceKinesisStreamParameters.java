...
public class UpdatePipeSourceKinesisStreamParameters {
  ...
  public UpdatePipeSourceKinesisStreamParameters batchSize(Integer batchSize) {
  ...
  public UpdatePipeSourceKinesisStreamParameters deadLetterConfig(PipeSourceDynamoDBStreamParametersDeadLetterConfig deadLetterConfig) {
  ...
  public UpdatePipeSourceKinesisStreamParameters maximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
  ...
  public UpdatePipeSourceKinesisStreamParameters maximumRecordAgeInSeconds(Integer maximumRecordAgeInSeconds) {
  ...
  public UpdatePipeSourceKinesisStreamParameters maximumRetryAttempts(Integer maximumRetryAttempts) {
  ...
  public UpdatePipeSourceKinesisStreamParameters onPartialBatchItemFailure(OnPartialBatchItemFailureStreams onPartialBatchItemFailure) {
  ...
  public UpdatePipeSourceKinesisStreamParameters parallelizationFactor(Integer parallelizationFactor) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePipeSourceKinesisStreamParameters updatePipeSourceKinesisStreamParameters = (UpdatePipeSourceKinesisStreamParameters) o;
    return Objects.equals(this.batchSize, updatePipeSourceKinesisStreamParameters.batchSize) &&
        Objects.equals(this.deadLetterConfig, updatePipeSourceKinesisStreamParameters.deadLetterConfig) &&
        Objects.equals(this.maximumBatchingWindowInSeconds, updatePipeSourceKinesisStreamParameters.maximumBatchingWindowInSeconds) &&
        Objects.equals(this.maximumRecordAgeInSeconds, updatePipeSourceKinesisStreamParameters.maximumRecordAgeInSeconds) &&
        Objects.equals(this.maximumRetryAttempts, updatePipeSourceKinesisStreamParameters.maximumRetryAttempts) &&
        Objects.equals(this.onPartialBatchItemFailure, updatePipeSourceKinesisStreamParameters.onPartialBatchItemFailure) &&
        Objects.equals(this.parallelizationFactor, updatePipeSourceKinesisStreamParameters.parallelizationFactor);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePipeSourceKinesisStreamParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePipeSourceKinesisStreamParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePipeSourceKinesisStreamParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePipeSourceKinesisStreamParameters is not found in the empty JSON string", UpdatePipeSourceKinesisStreamParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePipeSourceKinesisStreamParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePipeSourceKinesisStreamParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePipeSourceKinesisStreamParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePipeSourceKinesisStreamParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePipeSourceKinesisStreamParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePipeSourceKinesisStreamParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePipeSourceKinesisStreamParameters>() {
           @Override
           public void write(JsonWriter out, UpdatePipeSourceKinesisStreamParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePipeSourceKinesisStreamParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePipeSourceKinesisStreamParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePipeSourceKinesisStreamParameters
   * @throws IOException if the JSON string is invalid with respect to UpdatePipeSourceKinesisStreamParameters
   */
  public static UpdatePipeSourceKinesisStreamParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePipeSourceKinesisStreamParameters.class);
  }

  /**
   * Convert an instance of UpdatePipeSourceKinesisStreamParameters to an JSON string
   *
   * @return JSON string
   */
