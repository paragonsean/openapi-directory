...
public class PipeSourceKinesisStreamParameters {
  ...
  public PipeSourceKinesisStreamParameters() {
  }

  public PipeSourceKinesisStreamParameters batchSize(Integer batchSize) {
  ...
  public PipeSourceKinesisStreamParameters deadLetterConfig(PipeSourceDynamoDBStreamParametersDeadLetterConfig deadLetterConfig) {
  ...
  public PipeSourceKinesisStreamParameters maximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
  ...
  public PipeSourceKinesisStreamParameters maximumRecordAgeInSeconds(Integer maximumRecordAgeInSeconds) {
  ...
  public PipeSourceKinesisStreamParameters maximumRetryAttempts(Integer maximumRetryAttempts) {
  ...
  public PipeSourceKinesisStreamParameters onPartialBatchItemFailure(OnPartialBatchItemFailureStreams onPartialBatchItemFailure) {
  ...
  public PipeSourceKinesisStreamParameters parallelizationFactor(Integer parallelizationFactor) {
  ...
  public PipeSourceKinesisStreamParameters startingPosition(KinesisStreamStartPosition startingPosition) {
  ...
  public PipeSourceKinesisStreamParameters startingPositionTimestamp(OffsetDateTime startingPositionTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    PipeSourceKinesisStreamParameters pipeSourceKinesisStreamParameters = (PipeSourceKinesisStreamParameters) o;
    return Objects.equals(this.batchSize, pipeSourceKinesisStreamParameters.batchSize) &&
        Objects.equals(this.deadLetterConfig, pipeSourceKinesisStreamParameters.deadLetterConfig) &&
        Objects.equals(this.maximumBatchingWindowInSeconds, pipeSourceKinesisStreamParameters.maximumBatchingWindowInSeconds) &&
        Objects.equals(this.maximumRecordAgeInSeconds, pipeSourceKinesisStreamParameters.maximumRecordAgeInSeconds) &&
        Objects.equals(this.maximumRetryAttempts, pipeSourceKinesisStreamParameters.maximumRetryAttempts) &&
        Objects.equals(this.onPartialBatchItemFailure, pipeSourceKinesisStreamParameters.onPartialBatchItemFailure) &&
        Objects.equals(this.parallelizationFactor, pipeSourceKinesisStreamParameters.parallelizationFactor) &&
        Objects.equals(this.startingPosition, pipeSourceKinesisStreamParameters.startingPosition) &&
        Objects.equals(this.startingPositionTimestamp, pipeSourceKinesisStreamParameters.startingPositionTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipeSourceKinesisStreamParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipeSourceKinesisStreamParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipeSourceKinesisStreamParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipeSourceKinesisStreamParameters is not found in the empty JSON string", PipeSourceKinesisStreamParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipeSourceKinesisStreamParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipeSourceKinesisStreamParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PipeSourceKinesisStreamParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipeSourceKinesisStreamParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipeSourceKinesisStreamParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipeSourceKinesisStreamParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipeSourceKinesisStreamParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<PipeSourceKinesisStreamParameters>() {
           @Override
           public void write(JsonWriter out, PipeSourceKinesisStreamParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipeSourceKinesisStreamParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipeSourceKinesisStreamParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipeSourceKinesisStreamParameters
   * @throws IOException if the JSON string is invalid with respect to PipeSourceKinesisStreamParameters
   */
  public static PipeSourceKinesisStreamParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipeSourceKinesisStreamParameters.class);
  }

  /**
   * Convert an instance of PipeSourceKinesisStreamParameters to an JSON string
   *
   * @return JSON string
   */
