...
public class UpdatePipeRequestTargetParameters {
  ...
  public UpdatePipeRequestTargetParameters() {
  }

  public UpdatePipeRequestTargetParameters batchJobParameters(UpdatePipeRequestTargetParametersBatchJobParameters batchJobParameters) {
  ...
  public UpdatePipeRequestTargetParameters cloudWatchLogsParameters(UpdatePipeRequestTargetParametersCloudWatchLogsParameters cloudWatchLogsParameters) {
  ...
  public UpdatePipeRequestTargetParameters ecsTaskParameters(UpdatePipeRequestTargetParametersEcsTaskParameters ecsTaskParameters) {
  ...
  public UpdatePipeRequestTargetParameters eventBridgeEventBusParameters(UpdatePipeRequestTargetParametersEventBridgeEventBusParameters eventBridgeEventBusParameters) {
  ...
  public UpdatePipeRequestTargetParameters httpParameters(UpdatePipeRequestTargetParametersHttpParameters httpParameters) {
  ...
  public UpdatePipeRequestTargetParameters inputTemplate(String inputTemplate) {
  ...
  public UpdatePipeRequestTargetParameters kinesisStreamParameters(UpdatePipeRequestTargetParametersKinesisStreamParameters kinesisStreamParameters) {
  ...
  public UpdatePipeRequestTargetParameters lambdaFunctionParameters(UpdatePipeRequestTargetParametersLambdaFunctionParameters lambdaFunctionParameters) {
  ...
  public UpdatePipeRequestTargetParameters redshiftDataParameters(UpdatePipeRequestTargetParametersRedshiftDataParameters redshiftDataParameters) {
  ...
  public UpdatePipeRequestTargetParameters sageMakerPipelineParameters(UpdatePipeRequestTargetParametersSageMakerPipelineParameters sageMakerPipelineParameters) {
  ...
  public UpdatePipeRequestTargetParameters sqsQueueParameters(UpdatePipeRequestTargetParametersSqsQueueParameters sqsQueueParameters) {
  ...
  public UpdatePipeRequestTargetParameters stepFunctionStateMachineParameters(UpdatePipeRequestTargetParametersStepFunctionStateMachineParameters stepFunctionStateMachineParameters) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePipeRequestTargetParameters updatePipeRequestTargetParameters = (UpdatePipeRequestTargetParameters) o;
    return Objects.equals(this.batchJobParameters, updatePipeRequestTargetParameters.batchJobParameters) &&
        Objects.equals(this.cloudWatchLogsParameters, updatePipeRequestTargetParameters.cloudWatchLogsParameters) &&
        Objects.equals(this.ecsTaskParameters, updatePipeRequestTargetParameters.ecsTaskParameters) &&
        Objects.equals(this.eventBridgeEventBusParameters, updatePipeRequestTargetParameters.eventBridgeEventBusParameters) &&
        Objects.equals(this.httpParameters, updatePipeRequestTargetParameters.httpParameters) &&
        Objects.equals(this.inputTemplate, updatePipeRequestTargetParameters.inputTemplate) &&
        Objects.equals(this.kinesisStreamParameters, updatePipeRequestTargetParameters.kinesisStreamParameters) &&
        Objects.equals(this.lambdaFunctionParameters, updatePipeRequestTargetParameters.lambdaFunctionParameters) &&
        Objects.equals(this.redshiftDataParameters, updatePipeRequestTargetParameters.redshiftDataParameters) &&
        Objects.equals(this.sageMakerPipelineParameters, updatePipeRequestTargetParameters.sageMakerPipelineParameters) &&
        Objects.equals(this.sqsQueueParameters, updatePipeRequestTargetParameters.sqsQueueParameters) &&
        Objects.equals(this.stepFunctionStateMachineParameters, updatePipeRequestTargetParameters.stepFunctionStateMachineParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePipeRequestTargetParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePipeRequestTargetParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePipeRequestTargetParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePipeRequestTargetParameters is not found in the empty JSON string", UpdatePipeRequestTargetParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePipeRequestTargetParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePipeRequestTargetParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePipeRequestTargetParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePipeRequestTargetParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePipeRequestTargetParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePipeRequestTargetParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePipeRequestTargetParameters>() {
           @Override
           public void write(JsonWriter out, UpdatePipeRequestTargetParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePipeRequestTargetParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePipeRequestTargetParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePipeRequestTargetParameters
   * @throws IOException if the JSON string is invalid with respect to UpdatePipeRequestTargetParameters
   */
  public static UpdatePipeRequestTargetParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePipeRequestTargetParameters.class);
  }

  /**
   * Convert an instance of UpdatePipeRequestTargetParameters to an JSON string
   *
   * @return JSON string
   */
