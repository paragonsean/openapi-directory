...
public class PipeSourceDynamoDBStreamParameters {
  ...
  public PipeSourceDynamoDBStreamParameters batchSize(Integer batchSize) {
  ...
  public PipeSourceDynamoDBStreamParameters deadLetterConfig(PipeSourceDynamoDBStreamParametersDeadLetterConfig deadLetterConfig) {
  ...
  public PipeSourceDynamoDBStreamParameters maximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
  ...
  public PipeSourceDynamoDBStreamParameters maximumRecordAgeInSeconds(Integer maximumRecordAgeInSeconds) {
  ...
  public PipeSourceDynamoDBStreamParameters maximumRetryAttempts(Integer maximumRetryAttempts) {
  ...
  public PipeSourceDynamoDBStreamParameters onPartialBatchItemFailure(OnPartialBatchItemFailureStreams onPartialBatchItemFailure) {
  ...
  public PipeSourceDynamoDBStreamParameters parallelizationFactor(Integer parallelizationFactor) {
  ...
  public PipeSourceDynamoDBStreamParameters startingPosition(DynamoDBStreamStartPosition startingPosition) {
  ...
  public boolean equals(Object o) {
    ...
    PipeSourceDynamoDBStreamParameters pipeSourceDynamoDBStreamParameters = (PipeSourceDynamoDBStreamParameters) o;
    return Objects.equals(this.batchSize, pipeSourceDynamoDBStreamParameters.batchSize) &&
        Objects.equals(this.deadLetterConfig, pipeSourceDynamoDBStreamParameters.deadLetterConfig) &&
        Objects.equals(this.maximumBatchingWindowInSeconds, pipeSourceDynamoDBStreamParameters.maximumBatchingWindowInSeconds) &&
        Objects.equals(this.maximumRecordAgeInSeconds, pipeSourceDynamoDBStreamParameters.maximumRecordAgeInSeconds) &&
        Objects.equals(this.maximumRetryAttempts, pipeSourceDynamoDBStreamParameters.maximumRetryAttempts) &&
        Objects.equals(this.onPartialBatchItemFailure, pipeSourceDynamoDBStreamParameters.onPartialBatchItemFailure) &&
        Objects.equals(this.parallelizationFactor, pipeSourceDynamoDBStreamParameters.parallelizationFactor) &&
        Objects.equals(this.startingPosition, pipeSourceDynamoDBStreamParameters.startingPosition);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipeSourceDynamoDBStreamParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipeSourceDynamoDBStreamParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipeSourceDynamoDBStreamParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipeSourceDynamoDBStreamParameters is not found in the empty JSON string", PipeSourceDynamoDBStreamParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipeSourceDynamoDBStreamParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipeSourceDynamoDBStreamParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PipeSourceDynamoDBStreamParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipeSourceDynamoDBStreamParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipeSourceDynamoDBStreamParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipeSourceDynamoDBStreamParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipeSourceDynamoDBStreamParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<PipeSourceDynamoDBStreamParameters>() {
           @Override
           public void write(JsonWriter out, PipeSourceDynamoDBStreamParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipeSourceDynamoDBStreamParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipeSourceDynamoDBStreamParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipeSourceDynamoDBStreamParameters
   * @throws IOException if the JSON string is invalid with respect to PipeSourceDynamoDBStreamParameters
   */
  public static PipeSourceDynamoDBStreamParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipeSourceDynamoDBStreamParameters.class);
  }

  /**
   * Convert an instance of PipeSourceDynamoDBStreamParameters to an JSON string
   *
   * @return JSON string
   */
