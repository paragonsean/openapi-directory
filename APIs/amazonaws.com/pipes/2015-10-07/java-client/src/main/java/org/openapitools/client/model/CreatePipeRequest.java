...
public class CreatePipeRequest {
  ...
  private CreatePipeRequestSourceParameters sourceParameters;
  ...
  public CreatePipeRequest description(String description) {
  ...
  public CreatePipeRequest desiredState(DesiredStateEnum desiredState) {
  ...
  public CreatePipeRequest enrichment(String enrichment) {
  ...
  public CreatePipeRequest enrichmentParameters(UpdatePipeRequestEnrichmentParameters enrichmentParameters) {
  ...
  public CreatePipeRequest roleArn(String roleArn) {
  ...
  public CreatePipeRequest source(String source) {
    this.source = source;
    return this;
  }
  ...
  public CreatePipeRequest sourceParameters(CreatePipeRequestSourceParameters sourceParameters) {
   ...
   */
  @javax.annotation.Nullable
  public CreatePipeRequestSourceParameters getSourceParameters() {
    return sourceParameters;
  }

  public void setSourceParameters(CreatePipeRequestSourceParameters sourceParameters) {
    this.sourceParameters = sourceParameters;
  }


  public CreatePipeRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreatePipeRequest putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public CreatePipeRequest target(String target) {
    this.target = target;
    return this;
  }
  ...
  public CreatePipeRequest targetParameters(UpdatePipeRequestTargetParameters targetParameters) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePipeRequest createPipeRequest = (CreatePipeRequest) o;
    return Objects.equals(this.description, createPipeRequest.description) &&
        Objects.equals(this.desiredState, createPipeRequest.desiredState) &&
        Objects.equals(this.enrichment, createPipeRequest.enrichment) &&
        Objects.equals(this.enrichmentParameters, createPipeRequest.enrichmentParameters) &&
        Objects.equals(this.roleArn, createPipeRequest.roleArn) &&
        Objects.equals(this.source, createPipeRequest.source) &&
        Objects.equals(this.sourceParameters, createPipeRequest.sourceParameters) &&
        Objects.equals(this.tags, createPipeRequest.tags) &&
        Objects.equals(this.target, createPipeRequest.target) &&
        Objects.equals(this.targetParameters, createPipeRequest.targetParameters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, desiredState, enrichment, enrichmentParameters, roleArn, source, sourceParameters, tags, target, targetParameters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePipeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePipeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePipeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePipeRequest is not found in the empty JSON string", CreatePipeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePipeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePipeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePipeRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("SourceParameters") != null && !jsonObj.get("SourceParameters").isJsonNull()) {
        CreatePipeRequestSourceParameters.validateJsonElement(jsonObj.get("SourceParameters"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePipeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePipeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePipeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePipeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePipeRequest>() {
           @Override
           public void write(JsonWriter out, CreatePipeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePipeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePipeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePipeRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePipeRequest
   */
  public static CreatePipeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePipeRequest.class);
  }

  /**
   * Convert an instance of CreatePipeRequest to an JSON string
   *
   * @return JSON string
   */
