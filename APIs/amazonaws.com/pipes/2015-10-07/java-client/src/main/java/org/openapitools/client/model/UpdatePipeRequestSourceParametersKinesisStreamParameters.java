...
public class UpdatePipeRequestSourceParametersKinesisStreamParameters {
  ...
  public UpdatePipeRequestSourceParametersKinesisStreamParameters() {
  }

  public UpdatePipeRequestSourceParametersKinesisStreamParameters batchSize(Integer batchSize) {
  ...
  public UpdatePipeRequestSourceParametersKinesisStreamParameters deadLetterConfig(PipeSourceDynamoDBStreamParametersDeadLetterConfig deadLetterConfig) {
  ...
  public UpdatePipeRequestSourceParametersKinesisStreamParameters maximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
  ...
  public UpdatePipeRequestSourceParametersKinesisStreamParameters maximumRecordAgeInSeconds(Integer maximumRecordAgeInSeconds) {
  ...
  public UpdatePipeRequestSourceParametersKinesisStreamParameters maximumRetryAttempts(Integer maximumRetryAttempts) {
  ...
  public UpdatePipeRequestSourceParametersKinesisStreamParameters onPartialBatchItemFailure(OnPartialBatchItemFailureStreams onPartialBatchItemFailure) {
  ...
  public UpdatePipeRequestSourceParametersKinesisStreamParameters parallelizationFactor(Integer parallelizationFactor) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePipeRequestSourceParametersKinesisStreamParameters updatePipeRequestSourceParametersKinesisStreamParameters = (UpdatePipeRequestSourceParametersKinesisStreamParameters) o;
    return Objects.equals(this.batchSize, updatePipeRequestSourceParametersKinesisStreamParameters.batchSize) &&
        Objects.equals(this.deadLetterConfig, updatePipeRequestSourceParametersKinesisStreamParameters.deadLetterConfig) &&
        Objects.equals(this.maximumBatchingWindowInSeconds, updatePipeRequestSourceParametersKinesisStreamParameters.maximumBatchingWindowInSeconds) &&
        Objects.equals(this.maximumRecordAgeInSeconds, updatePipeRequestSourceParametersKinesisStreamParameters.maximumRecordAgeInSeconds) &&
        Objects.equals(this.maximumRetryAttempts, updatePipeRequestSourceParametersKinesisStreamParameters.maximumRetryAttempts) &&
        Objects.equals(this.onPartialBatchItemFailure, updatePipeRequestSourceParametersKinesisStreamParameters.onPartialBatchItemFailure) &&
        Objects.equals(this.parallelizationFactor, updatePipeRequestSourceParametersKinesisStreamParameters.parallelizationFactor);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePipeRequestSourceParametersKinesisStreamParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePipeRequestSourceParametersKinesisStreamParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePipeRequestSourceParametersKinesisStreamParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePipeRequestSourceParametersKinesisStreamParameters is not found in the empty JSON string", UpdatePipeRequestSourceParametersKinesisStreamParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePipeRequestSourceParametersKinesisStreamParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePipeRequestSourceParametersKinesisStreamParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePipeRequestSourceParametersKinesisStreamParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePipeRequestSourceParametersKinesisStreamParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePipeRequestSourceParametersKinesisStreamParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePipeRequestSourceParametersKinesisStreamParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePipeRequestSourceParametersKinesisStreamParameters>() {
           @Override
           public void write(JsonWriter out, UpdatePipeRequestSourceParametersKinesisStreamParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePipeRequestSourceParametersKinesisStreamParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePipeRequestSourceParametersKinesisStreamParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePipeRequestSourceParametersKinesisStreamParameters
   * @throws IOException if the JSON string is invalid with respect to UpdatePipeRequestSourceParametersKinesisStreamParameters
   */
  public static UpdatePipeRequestSourceParametersKinesisStreamParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePipeRequestSourceParametersKinesisStreamParameters.class);
  }

  /**
   * Convert an instance of UpdatePipeRequestSourceParametersKinesisStreamParameters to an JSON string
   *
   * @return JSON string
   */
