...
public class UpdatePipeRequestSourceParametersDynamoDBStreamParameters {
  ...
  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters() {
  }

  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters batchSize(Integer batchSize) {
  ...
  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters deadLetterConfig(PipeSourceDynamoDBStreamParametersDeadLetterConfig deadLetterConfig) {
  ...
  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters maximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
  ...
  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters maximumRecordAgeInSeconds(Integer maximumRecordAgeInSeconds) {
  ...
  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters maximumRetryAttempts(Integer maximumRetryAttempts) {
  ...
  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters onPartialBatchItemFailure(OnPartialBatchItemFailureStreams onPartialBatchItemFailure) {
  ...
  public UpdatePipeRequestSourceParametersDynamoDBStreamParameters parallelizationFactor(Integer parallelizationFactor) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePipeRequestSourceParametersDynamoDBStreamParameters updatePipeRequestSourceParametersDynamoDBStreamParameters = (UpdatePipeRequestSourceParametersDynamoDBStreamParameters) o;
    return Objects.equals(this.batchSize, updatePipeRequestSourceParametersDynamoDBStreamParameters.batchSize) &&
        Objects.equals(this.deadLetterConfig, updatePipeRequestSourceParametersDynamoDBStreamParameters.deadLetterConfig) &&
        Objects.equals(this.maximumBatchingWindowInSeconds, updatePipeRequestSourceParametersDynamoDBStreamParameters.maximumBatchingWindowInSeconds) &&
        Objects.equals(this.maximumRecordAgeInSeconds, updatePipeRequestSourceParametersDynamoDBStreamParameters.maximumRecordAgeInSeconds) &&
        Objects.equals(this.maximumRetryAttempts, updatePipeRequestSourceParametersDynamoDBStreamParameters.maximumRetryAttempts) &&
        Objects.equals(this.onPartialBatchItemFailure, updatePipeRequestSourceParametersDynamoDBStreamParameters.onPartialBatchItemFailure) &&
        Objects.equals(this.parallelizationFactor, updatePipeRequestSourceParametersDynamoDBStreamParameters.parallelizationFactor);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePipeRequestSourceParametersDynamoDBStreamParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePipeRequestSourceParametersDynamoDBStreamParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePipeRequestSourceParametersDynamoDBStreamParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePipeRequestSourceParametersDynamoDBStreamParameters is not found in the empty JSON string", UpdatePipeRequestSourceParametersDynamoDBStreamParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePipeRequestSourceParametersDynamoDBStreamParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePipeRequestSourceParametersDynamoDBStreamParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePipeRequestSourceParametersDynamoDBStreamParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePipeRequestSourceParametersDynamoDBStreamParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePipeRequestSourceParametersDynamoDBStreamParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePipeRequestSourceParametersDynamoDBStreamParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePipeRequestSourceParametersDynamoDBStreamParameters>() {
           @Override
           public void write(JsonWriter out, UpdatePipeRequestSourceParametersDynamoDBStreamParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePipeRequestSourceParametersDynamoDBStreamParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePipeRequestSourceParametersDynamoDBStreamParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePipeRequestSourceParametersDynamoDBStreamParameters
   * @throws IOException if the JSON string is invalid with respect to UpdatePipeRequestSourceParametersDynamoDBStreamParameters
   */
  public static UpdatePipeRequestSourceParametersDynamoDBStreamParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePipeRequestSourceParametersDynamoDBStreamParameters.class);
  }

  /**
   * Convert an instance of UpdatePipeRequestSourceParametersDynamoDBStreamParameters to an JSON string
   *
   * @return JSON string
   */
