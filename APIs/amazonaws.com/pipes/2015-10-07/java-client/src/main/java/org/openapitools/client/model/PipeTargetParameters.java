...
public class PipeTargetParameters {
  ...
  public PipeTargetParameters batchJobParameters(UpdatePipeRequestTargetParametersBatchJobParameters batchJobParameters) {
  ...
  public PipeTargetParameters cloudWatchLogsParameters(UpdatePipeRequestTargetParametersCloudWatchLogsParameters cloudWatchLogsParameters) {
  ...
  public PipeTargetParameters ecsTaskParameters(UpdatePipeRequestTargetParametersEcsTaskParameters ecsTaskParameters) {
  ...
  public PipeTargetParameters eventBridgeEventBusParameters(UpdatePipeRequestTargetParametersEventBridgeEventBusParameters eventBridgeEventBusParameters) {
  ...
  public PipeTargetParameters httpParameters(UpdatePipeRequestTargetParametersHttpParameters httpParameters) {
  ...
  public PipeTargetParameters inputTemplate(String inputTemplate) {
  ...
  public PipeTargetParameters kinesisStreamParameters(UpdatePipeRequestTargetParametersKinesisStreamParameters kinesisStreamParameters) {
  ...
  public PipeTargetParameters lambdaFunctionParameters(UpdatePipeRequestTargetParametersLambdaFunctionParameters lambdaFunctionParameters) {
  ...
  public PipeTargetParameters redshiftDataParameters(UpdatePipeRequestTargetParametersRedshiftDataParameters redshiftDataParameters) {
  ...
  public PipeTargetParameters sageMakerPipelineParameters(UpdatePipeRequestTargetParametersSageMakerPipelineParameters sageMakerPipelineParameters) {
  ...
  public PipeTargetParameters sqsQueueParameters(UpdatePipeRequestTargetParametersSqsQueueParameters sqsQueueParameters) {
  ...
  public PipeTargetParameters stepFunctionStateMachineParameters(UpdatePipeRequestTargetParametersStepFunctionStateMachineParameters stepFunctionStateMachineParameters) {
  ...
  public boolean equals(Object o) {
    ...
    PipeTargetParameters pipeTargetParameters = (PipeTargetParameters) o;
    return Objects.equals(this.batchJobParameters, pipeTargetParameters.batchJobParameters) &&
        Objects.equals(this.cloudWatchLogsParameters, pipeTargetParameters.cloudWatchLogsParameters) &&
        Objects.equals(this.ecsTaskParameters, pipeTargetParameters.ecsTaskParameters) &&
        Objects.equals(this.eventBridgeEventBusParameters, pipeTargetParameters.eventBridgeEventBusParameters) &&
        Objects.equals(this.httpParameters, pipeTargetParameters.httpParameters) &&
        Objects.equals(this.inputTemplate, pipeTargetParameters.inputTemplate) &&
        Objects.equals(this.kinesisStreamParameters, pipeTargetParameters.kinesisStreamParameters) &&
        Objects.equals(this.lambdaFunctionParameters, pipeTargetParameters.lambdaFunctionParameters) &&
        Objects.equals(this.redshiftDataParameters, pipeTargetParameters.redshiftDataParameters) &&
        Objects.equals(this.sageMakerPipelineParameters, pipeTargetParameters.sageMakerPipelineParameters) &&
        Objects.equals(this.sqsQueueParameters, pipeTargetParameters.sqsQueueParameters) &&
        Objects.equals(this.stepFunctionStateMachineParameters, pipeTargetParameters.stepFunctionStateMachineParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipeTargetParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipeTargetParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipeTargetParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipeTargetParameters is not found in the empty JSON string", PipeTargetParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipeTargetParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipeTargetParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipeTargetParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipeTargetParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipeTargetParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipeTargetParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<PipeTargetParameters>() {
           @Override
           public void write(JsonWriter out, PipeTargetParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipeTargetParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipeTargetParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipeTargetParameters
   * @throws IOException if the JSON string is invalid with respect to PipeTargetParameters
   */
  public static PipeTargetParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipeTargetParameters.class);
  }

  /**
   * Convert an instance of PipeTargetParameters to an JSON string
   *
   * @return JSON string
   */
