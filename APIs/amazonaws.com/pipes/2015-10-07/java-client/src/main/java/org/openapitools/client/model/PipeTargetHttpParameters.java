...
public class PipeTargetHttpParameters {
  ...
  public PipeTargetHttpParameters headerParameters(Map headerParameters) {
  ...
  public PipeTargetHttpParameters pathParameterValues(List pathParameterValues) {
  ...
  public PipeTargetHttpParameters queryStringParameters(Map queryStringParameters) {
  ...
  public boolean equals(Object o) {
    ...
    PipeTargetHttpParameters pipeTargetHttpParameters = (PipeTargetHttpParameters) o;
    return Objects.equals(this.headerParameters, pipeTargetHttpParameters.headerParameters) &&
        Objects.equals(this.pathParameterValues, pipeTargetHttpParameters.pathParameterValues) &&
        Objects.equals(this.queryStringParameters, pipeTargetHttpParameters.queryStringParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipeTargetHttpParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipeTargetHttpParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipeTargetHttpParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipeTargetHttpParameters is not found in the empty JSON string", PipeTargetHttpParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipeTargetHttpParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipeTargetHttpParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipeTargetHttpParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipeTargetHttpParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipeTargetHttpParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipeTargetHttpParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<PipeTargetHttpParameters>() {
           @Override
           public void write(JsonWriter out, PipeTargetHttpParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipeTargetHttpParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipeTargetHttpParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipeTargetHttpParameters
   * @throws IOException if the JSON string is invalid with respect to PipeTargetHttpParameters
   */
  public static PipeTargetHttpParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipeTargetHttpParameters.class);
  }

  /**
   * Convert an instance of PipeTargetHttpParameters to an JSON string
   *
   * @return JSON string
   */
