...
import org.openapitools.client.model.DynamoDBStreamStartPosition;
...
public class CreatePipeRequestSourceParametersDynamoDBStreamParameters {
  ...
  private DynamoDBStreamStartPosition startingPosition;

  public CreatePipeRequestSourceParametersDynamoDBStreamParameters() {
  }

  public CreatePipeRequestSourceParametersDynamoDBStreamParameters batchSize(Integer batchSize) {
  ...
  public CreatePipeRequestSourceParametersDynamoDBStreamParameters deadLetterConfig(PipeSourceDynamoDBStreamParametersDeadLetterConfig deadLetterConfig) {
  ...
  public CreatePipeRequestSourceParametersDynamoDBStreamParameters maximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
  ...
  public CreatePipeRequestSourceParametersDynamoDBStreamParameters maximumRecordAgeInSeconds(Integer maximumRecordAgeInSeconds) {
  ...
  public CreatePipeRequestSourceParametersDynamoDBStreamParameters maximumRetryAttempts(Integer maximumRetryAttempts) {
  ...
  public CreatePipeRequestSourceParametersDynamoDBStreamParameters onPartialBatchItemFailure(OnPartialBatchItemFailureStreams onPartialBatchItemFailure) {
  ...
  public CreatePipeRequestSourceParametersDynamoDBStreamParameters parallelizationFactor(Integer parallelizationFactor) {
  ...
  public CreatePipeRequestSourceParametersDynamoDBStreamParameters startingPosition(DynamoDBStreamStartPosition startingPosition) {
  ...
  public DynamoDBStreamStartPosition getStartingPosition() {
    return startingPosition;
  }

  public void setStartingPosition(DynamoDBStreamStartPosition startingPosition) {
    this.startingPosition = startingPosition;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePipeRequestSourceParametersDynamoDBStreamParameters createPipeRequestSourceParametersDynamoDBStreamParameters = (CreatePipeRequestSourceParametersDynamoDBStreamParameters) o;
    return Objects.equals(this.batchSize, createPipeRequestSourceParametersDynamoDBStreamParameters.batchSize) &&
        Objects.equals(this.deadLetterConfig, createPipeRequestSourceParametersDynamoDBStreamParameters.deadLetterConfig) &&
        Objects.equals(this.maximumBatchingWindowInSeconds, createPipeRequestSourceParametersDynamoDBStreamParameters.maximumBatchingWindowInSeconds) &&
        Objects.equals(this.maximumRecordAgeInSeconds, createPipeRequestSourceParametersDynamoDBStreamParameters.maximumRecordAgeInSeconds) &&
        Objects.equals(this.maximumRetryAttempts, createPipeRequestSourceParametersDynamoDBStreamParameters.maximumRetryAttempts) &&
        Objects.equals(this.onPartialBatchItemFailure, createPipeRequestSourceParametersDynamoDBStreamParameters.onPartialBatchItemFailure) &&
        Objects.equals(this.parallelizationFactor, createPipeRequestSourceParametersDynamoDBStreamParameters.parallelizationFactor) &&
        Objects.equals(this.startingPosition, createPipeRequestSourceParametersDynamoDBStreamParameters.startingPosition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(batchSize, deadLetterConfig, maximumBatchingWindowInSeconds, maximumRecordAgeInSeconds, maximumRetryAttempts, onPartialBatchItemFailure, parallelizationFactor, startingPosition);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePipeRequestSourceParametersDynamoDBStreamParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePipeRequestSourceParametersDynamoDBStreamParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePipeRequestSourceParametersDynamoDBStreamParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePipeRequestSourceParametersDynamoDBStreamParameters is not found in the empty JSON string", CreatePipeRequestSourceParametersDynamoDBStreamParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePipeRequestSourceParametersDynamoDBStreamParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePipeRequestSourceParametersDynamoDBStreamParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePipeRequestSourceParametersDynamoDBStreamParameters.openapiRequiredFields) {
      ...
      DynamoDBStreamStartPosition.validateJsonElement(jsonObj.get("StartingPosition"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePipeRequestSourceParametersDynamoDBStreamParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePipeRequestSourceParametersDynamoDBStreamParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePipeRequestSourceParametersDynamoDBStreamParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePipeRequestSourceParametersDynamoDBStreamParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePipeRequestSourceParametersDynamoDBStreamParameters>() {
           @Override
           public void write(JsonWriter out, CreatePipeRequestSourceParametersDynamoDBStreamParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePipeRequestSourceParametersDynamoDBStreamParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePipeRequestSourceParametersDynamoDBStreamParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePipeRequestSourceParametersDynamoDBStreamParameters
   * @throws IOException if the JSON string is invalid with respect to CreatePipeRequestSourceParametersDynamoDBStreamParameters
   */
  public static CreatePipeRequestSourceParametersDynamoDBStreamParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePipeRequestSourceParametersDynamoDBStreamParameters.class);
  }

  /**
   * Convert an instance of CreatePipeRequestSourceParametersDynamoDBStreamParameters to an JSON string
   *
   * @return JSON string
   */
