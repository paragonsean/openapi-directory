...
|**tags** | **Map&lt;String, String&gt;** | The tags assigned to the job run. |  [optional] |
|**executionTimeoutMinutes** | **Integer** | The maximum duration for the job run to run. If the job run runs beyond this duration, it will be automatically cancelled. |  [optional] |
