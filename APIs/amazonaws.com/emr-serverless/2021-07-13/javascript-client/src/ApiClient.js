...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://emr-serverless.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://emr-serverless.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-07-13/Javascript'
        };
