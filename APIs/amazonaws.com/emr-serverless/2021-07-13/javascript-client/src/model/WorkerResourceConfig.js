...
/**
 * The WorkerResourceConfig model module.
 * @module model/WorkerResourceConfig
 * @version 2021-07-13
 */
class WorkerResourceConfig {
    /**
     * Constructs a new <code>WorkerResourceConfig</code>.
     * The cumulative configuration requirements for every worker instance of the worker type.
     * @alias module:model/WorkerResourceConfig
     * @param cpu {String} 
     * @param memory {String} 
     */
    ...
    /**
     * Constructs a <code>WorkerResourceConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkerResourceConfig} obj Optional instance to populate.
     * @return {module:model/WorkerResourceConfig} The populated <code>WorkerResourceConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkerResourceConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkerResourceConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkerResourceConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkerResourceConfig.RequiredProperties) {
...
WorkerResourceConfig.RequiredProperties = ["cpu", "memory"];
...
export default WorkerResourceConfig;
