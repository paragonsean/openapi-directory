...
/**
 * The CreateApplicationRequestNetworkConfiguration model module.
 * @module model/CreateApplicationRequestNetworkConfiguration
 * @version 2021-07-13
 */
class CreateApplicationRequestNetworkConfiguration {
    /**
     * Constructs a new <code>CreateApplicationRequestNetworkConfiguration</code>.
     * @alias module:model/CreateApplicationRequestNetworkConfiguration
     * @implements module:model/NetworkConfiguration
     */
    constructor() { 
        NetworkConfiguration.initialize(this);
        CreateApplicationRequestNetworkConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateApplicationRequestNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateApplicationRequestNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateApplicationRequestNetworkConfiguration} The populated <code>CreateApplicationRequestNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateApplicationRequestNetworkConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateApplicationRequestNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateApplicationRequestNetworkConfiguration</code>.
     */
 ...
 */
CreateApplicationRequestNetworkConfiguration.prototype['subnetIds'] = undefined;

/**
 * @member {Array} securityGroupIds
 */
CreateApplicationRequestNetworkConfiguration.prototype['securityGroupIds'] = undefined;
...
export default CreateApplicationRequestNetworkConfiguration;
