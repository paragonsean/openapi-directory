...
/**
 * The MaximumAllowedResources model module.
 * @module model/MaximumAllowedResources
 * @version 2021-07-13
 */
class MaximumAllowedResources {
    /**
     * Constructs a new <code>MaximumAllowedResources</code>.
     * The maximum allowed cumulative resources for an application. No new resources will be created once the limit is hit.
     * @alias module:model/MaximumAllowedResources
     * @param cpu {String} 
     * @param memory {String} 
     */
    ...
    /**
     * Constructs a <code>MaximumAllowedResources</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MaximumAllowedResources} obj Optional instance to populate.
     * @return {module:model/MaximumAllowedResources} The populated <code>MaximumAllowedResources</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MaximumAllowedResources();
    ...
    /**
     * Validates the JSON data with respect to <code>MaximumAllowedResources</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MaximumAllowedResources</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MaximumAllowedResources.RequiredProperties) {
...
MaximumAllowedResources.RequiredProperties = ["cpu", "memory"];
...
export default MaximumAllowedResources;
