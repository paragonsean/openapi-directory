...
/**
 * The UpdateApplicationRequestImageConfiguration model module.
 * @module model/UpdateApplicationRequestImageConfiguration
 * @version 2021-07-13
 */
class UpdateApplicationRequestImageConfiguration {
    /**
     * Constructs a new <code>UpdateApplicationRequestImageConfiguration</code>.
     * @alias module:model/UpdateApplicationRequestImageConfiguration
     * @implements module:model/ImageConfigurationInput
     */
    constructor() { 
        ImageConfigurationInput.initialize(this);
        UpdateApplicationRequestImageConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateApplicationRequestImageConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApplicationRequestImageConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateApplicationRequestImageConfiguration} The populated <code>UpdateApplicationRequestImageConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApplicationRequestImageConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApplicationRequestImageConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApplicationRequestImageConfiguration</code>.
     */
 ...
 */
UpdateApplicationRequestImageConfiguration.prototype['imageUri'] = undefined;
...
export default UpdateApplicationRequestImageConfiguration;
