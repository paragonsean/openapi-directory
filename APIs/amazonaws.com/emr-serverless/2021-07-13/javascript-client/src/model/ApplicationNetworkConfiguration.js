...
/**
 * The ApplicationNetworkConfiguration model module.
 * @module model/ApplicationNetworkConfiguration
 * @version 2021-07-13
 */
class ApplicationNetworkConfiguration {
    /**
     * Constructs a new <code>ApplicationNetworkConfiguration</code>.
     * @alias module:model/ApplicationNetworkConfiguration
     * @implements module:model/NetworkConfiguration
     */
    constructor() { 
        NetworkConfiguration.initialize(this);
        ApplicationNetworkConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApplicationNetworkConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationNetworkConfiguration} obj Optional instance to populate.
     * @return {module:model/ApplicationNetworkConfiguration} The populated <code>ApplicationNetworkConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationNetworkConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationNetworkConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationNetworkConfiguration</code>.
     */
 ...
 */
ApplicationNetworkConfiguration.prototype['subnetIds'] = undefined;

/**
 * @member {Array} securityGroupIds
 */
ApplicationNetworkConfiguration.prototype['securityGroupIds'] = undefined;
...
export default ApplicationNetworkConfiguration;
