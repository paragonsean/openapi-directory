...
/**
 * The WorkerTypeSpecificationInputImageConfiguration model module.
 * @module model/WorkerTypeSpecificationInputImageConfiguration
 * @version 2021-07-13
 */
class WorkerTypeSpecificationInputImageConfiguration {
    /**
     * Constructs a new <code>WorkerTypeSpecificationInputImageConfiguration</code>.
     * @alias module:model/WorkerTypeSpecificationInputImageConfiguration
     * @implements module:model/ImageConfigurationInput
     */
    constructor() { 
        ImageConfigurationInput.initialize(this);
        WorkerTypeSpecificationInputImageConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WorkerTypeSpecificationInputImageConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkerTypeSpecificationInputImageConfiguration} obj Optional instance to populate.
     * @return {module:model/WorkerTypeSpecificationInputImageConfiguration} The populated <code>WorkerTypeSpecificationInputImageConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkerTypeSpecificationInputImageConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkerTypeSpecificationInputImageConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkerTypeSpecificationInputImageConfiguration</code>.
     */
 ...
 */
WorkerTypeSpecificationInputImageConfiguration.prototype['imageUri'] = undefined;
...
export default WorkerTypeSpecificationInputImageConfiguration;
