...
/**
 * The AutoStopConfig model module.
 * @module model/AutoStopConfig
 * @version 2021-07-13
 */
class AutoStopConfig {
    /**
     * Constructs a new <code>AutoStopConfig</code>.
     * The configuration for an application to automatically stop after a certain amount of time being idle.
     * @alias module:model/AutoStopConfig
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AutoStopConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoStopConfig} obj Optional instance to populate.
     * @return {module:model/AutoStopConfig} The populated <code>AutoStopConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoStopConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>AutoStopConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoStopConfig</code>.
     */
