...
/**
 * The ImageConfigurationInput model module.
 * @module model/ImageConfigurationInput
 * @version 2021-07-13
 */
class ImageConfigurationInput {
    /**
     * Constructs a new <code>ImageConfigurationInput</code>.
     * The image configuration.
     * @alias module:model/ImageConfigurationInput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ImageConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageConfigurationInput} obj Optional instance to populate.
     * @return {module:model/ImageConfigurationInput} The populated <code>ImageConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageConfigurationInput</code>.
     */
...
export default ImageConfigurationInput;
