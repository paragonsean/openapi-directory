...
(function(root, factory) {
  ...
  describe('ApplicationState', function() {
    it('should create an instance of ApplicationState', function() {
      // uncomment below and update the code to test ApplicationState
      //var instance = new EmrServerless.ApplicationState();
      //expect(instance).to.be.a(EmrServerless.ApplicationState);
    });
