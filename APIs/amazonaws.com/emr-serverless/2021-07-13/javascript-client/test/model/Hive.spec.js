...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.Hive();
  });
  ...
  describe('Hive', function() {
    it('should create an instance of Hive', function() {
      // uncomment below and update the code to test Hive
      //var instance = new EmrServerless.Hive();
      //expect(instance).to.be.a(EmrServerless.Hive);
    });
    ...
    it('should have the property initQueryFile (base name: "initQueryFile")', function() {
      // uncomment below and update the code to test the property initQueryFile
      //var instance = new EmrServerless.Hive();
      //expect(instance).to.be();
    });
