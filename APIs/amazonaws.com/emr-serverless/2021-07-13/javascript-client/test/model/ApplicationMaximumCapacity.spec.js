...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ApplicationMaximumCapacity();
  });
  ...
  describe('ApplicationMaximumCapacity', function() {
    it('should create an instance of ApplicationMaximumCapacity', function() {
      // uncomment below and update the code to test ApplicationMaximumCapacity
      //var instance = new EmrServerless.ApplicationMaximumCapacity();
      //expect(instance).to.be.a(EmrServerless.ApplicationMaximumCapacity);
    });
