...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.UpdateApplicationRequestMaximumCapacity();
  });
  ...
  describe('UpdateApplicationRequestMaximumCapacity', function() {
    it('should create an instance of UpdateApplicationRequestMaximumCapacity', function() {
      // uncomment below and update the code to test UpdateApplicationRequestMaximumCapacity
      //var instance = new EmrServerless.UpdateApplicationRequestMaximumCapacity();
      //expect(instance).to.be.a(EmrServerless.UpdateApplicationRequestMaximumCapacity);
    });
