...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ListJobRunsResponse();
  });
  ...
  describe('ListJobRunsResponse', function() {
    it('should create an instance of ListJobRunsResponse', function() {
      ...
      //var instance = new EmrServerless.ListJobRunsResponse();
      //expect(instance).to.be.a(EmrServerless.ListJobRunsResponse);
    });
