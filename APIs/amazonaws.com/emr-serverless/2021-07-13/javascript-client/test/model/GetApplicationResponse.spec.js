...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.GetApplicationResponse();
  });
  ...
  describe('GetApplicationResponse', function() {
    it('should create an instance of GetApplicationResponse', function() {
      ...
      //var instance = new EmrServerless.GetApplicationResponse();
      //expect(instance).to.be.a(EmrServerless.GetApplicationResponse);
    });
