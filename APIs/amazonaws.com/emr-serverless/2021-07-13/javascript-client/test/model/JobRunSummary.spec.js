...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.JobRunSummary();
  });
  ...
  describe('JobRunSummary', function() {
    it('should create an instance of JobRunSummary', function() {
      // uncomment below and update the code to test JobRunSummary
      //var instance = new EmrServerless.JobRunSummary();
      //expect(instance).to.be.a(EmrServerless.JobRunSummary);
    });
