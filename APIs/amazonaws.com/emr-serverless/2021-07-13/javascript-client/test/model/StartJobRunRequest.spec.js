...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.StartJobRunRequest();
  });
  ...
  describe('StartJobRunRequest', function() {
    it('should create an instance of StartJobRunRequest', function() {
      // uncomment below and update the code to test StartJobRunRequest
      //var instance = new EmrServerless.StartJobRunRequest();
      //expect(instance).to.be.a(EmrServerless.StartJobRunRequest);
    });
