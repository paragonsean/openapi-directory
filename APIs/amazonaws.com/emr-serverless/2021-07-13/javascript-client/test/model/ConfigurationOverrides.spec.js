...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ConfigurationOverrides();
  });
  ...
  describe('ConfigurationOverrides', function() {
    it('should create an instance of ConfigurationOverrides', function() {
      // uncomment below and update the code to test ConfigurationOverrides
      //var instance = new EmrServerless.ConfigurationOverrides();
      //expect(instance).to.be.a(EmrServerless.ConfigurationOverrides);
    });
