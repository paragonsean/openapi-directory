...
(function(root, factory) {
  ...
  describe('JobRunState', function() {
    it('should create an instance of JobRunState', function() {
      // uncomment below and update the code to test JobRunState
      //var instance = new EmrServerless.JobRunState();
      //expect(instance).to.be.a(EmrServerless.JobRunState);
    });
