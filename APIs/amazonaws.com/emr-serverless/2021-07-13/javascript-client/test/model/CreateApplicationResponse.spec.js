...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.CreateApplicationResponse();
  });
  ...
  describe('CreateApplicationResponse', function() {
    it('should create an instance of CreateApplicationResponse', function() {
      ...
      //var instance = new EmrServerless.CreateApplicationResponse();
      //expect(instance).to.be.a(EmrServerless.CreateApplicationResponse);
    });
