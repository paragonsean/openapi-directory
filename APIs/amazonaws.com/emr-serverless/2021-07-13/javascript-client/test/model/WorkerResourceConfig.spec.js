...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.WorkerResourceConfig();
  });
  ...
  describe('WorkerResourceConfig', function() {
    it('should create an instance of WorkerResourceConfig', function() {
      // uncomment below and update the code to test WorkerResourceConfig
      //var instance = new EmrServerless.WorkerResourceConfig();
      //expect(instance).to.be.a(EmrServerless.WorkerResourceConfig);
    });
