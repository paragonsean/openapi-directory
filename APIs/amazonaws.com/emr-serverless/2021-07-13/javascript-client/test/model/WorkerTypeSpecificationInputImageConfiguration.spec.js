...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.WorkerTypeSpecificationInputImageConfiguration();
  });
  ...
  describe('WorkerTypeSpecificationInputImageConfiguration', function() {
    it('should create an instance of WorkerTypeSpecificationInputImageConfiguration', function() {
      // uncomment below and update the code to test WorkerTypeSpecificationInputImageConfiguration
      //var instance = new EmrServerless.WorkerTypeSpecificationInputImageConfiguration();
      //expect(instance).to.be.a(EmrServerless.WorkerTypeSpecificationInputImageConfiguration);
    });
