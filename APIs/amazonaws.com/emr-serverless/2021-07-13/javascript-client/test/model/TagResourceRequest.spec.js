...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new EmrServerless.TagResourceRequest();
      //expect(instance).to.be.a(EmrServerless.TagResourceRequest);
    });
