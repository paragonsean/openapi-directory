...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.CloudWatchLoggingConfiguration();
  });
  ...
  describe('CloudWatchLoggingConfiguration', function() {
    it('should create an instance of CloudWatchLoggingConfiguration', function() {
      // uncomment below and update the code to test CloudWatchLoggingConfiguration
      //var instance = new EmrServerless.CloudWatchLoggingConfiguration();
      //expect(instance).to.be.a(EmrServerless.CloudWatchLoggingConfiguration);
    });
