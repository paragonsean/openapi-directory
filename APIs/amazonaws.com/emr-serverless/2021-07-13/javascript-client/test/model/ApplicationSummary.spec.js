...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ApplicationSummary();
  });
  ...
  describe('ApplicationSummary', function() {
    it('should create an instance of ApplicationSummary', function() {
      ...
      //var instance = new EmrServerless.ApplicationSummary();
      //expect(instance).to.be.a(EmrServerless.ApplicationSummary);
    });
