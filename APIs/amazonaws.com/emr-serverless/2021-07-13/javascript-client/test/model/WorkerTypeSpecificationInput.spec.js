...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.WorkerTypeSpecificationInput();
  });
  ...
  describe('WorkerTypeSpecificationInput', function() {
    it('should create an instance of WorkerTypeSpecificationInput', function() {
      // uncomment below and update the code to test WorkerTypeSpecificationInput
      //var instance = new EmrServerless.WorkerTypeSpecificationInput();
      //expect(instance).to.be.a(EmrServerless.WorkerTypeSpecificationInput);
    });
