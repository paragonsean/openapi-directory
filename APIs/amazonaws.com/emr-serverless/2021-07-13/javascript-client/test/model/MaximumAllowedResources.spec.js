...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.MaximumAllowedResources();
  });
  ...
  describe('MaximumAllowedResources', function() {
    it('should create an instance of MaximumAllowedResources', function() {
      // uncomment below and update the code to test MaximumAllowedResources
      //var instance = new EmrServerless.MaximumAllowedResources();
      //expect(instance).to.be.a(EmrServerless.MaximumAllowedResources);
    });
