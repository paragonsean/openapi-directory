...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.JobRunConfigurationOverrides();
  });
  ...
  describe('JobRunConfigurationOverrides', function() {
    it('should create an instance of JobRunConfigurationOverrides', function() {
      // uncomment below and update the code to test JobRunConfigurationOverrides
      //var instance = new EmrServerless.JobRunConfigurationOverrides();
      //expect(instance).to.be.a(EmrServerless.JobRunConfigurationOverrides);
    });
