...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.StartJobRunResponse();
  });
  ...
  describe('StartJobRunResponse', function() {
    it('should create an instance of StartJobRunResponse', function() {
      // uncomment below and update the code to test StartJobRunResponse
      //var instance = new EmrServerless.StartJobRunResponse();
      //expect(instance).to.be.a(EmrServerless.StartJobRunResponse);
    });
