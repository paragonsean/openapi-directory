...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.WorkerTypeSpecificationImageConfiguration();
  });
  ...
  describe('WorkerTypeSpecificationImageConfiguration', function() {
    it('should create an instance of WorkerTypeSpecificationImageConfiguration', function() {
      // uncomment below and update the code to test WorkerTypeSpecificationImageConfiguration
      //var instance = new EmrServerless.WorkerTypeSpecificationImageConfiguration();
      //expect(instance).to.be.a(EmrServerless.WorkerTypeSpecificationImageConfiguration);
    });
