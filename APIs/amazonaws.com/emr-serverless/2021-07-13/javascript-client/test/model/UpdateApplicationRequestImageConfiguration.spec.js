...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.UpdateApplicationRequestImageConfiguration();
  });
  ...
  describe('UpdateApplicationRequestImageConfiguration', function() {
    it('should create an instance of UpdateApplicationRequestImageConfiguration', function() {
      // uncomment below and update the code to test UpdateApplicationRequestImageConfiguration
      //var instance = new EmrServerless.UpdateApplicationRequestImageConfiguration();
      //expect(instance).to.be.a(EmrServerless.UpdateApplicationRequestImageConfiguration);
    });
