...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ApplicationAutoStartConfiguration();
  });
  ...
  describe('ApplicationAutoStartConfiguration', function() {
    it('should create an instance of ApplicationAutoStartConfiguration', function() {
      // uncomment below and update the code to test ApplicationAutoStartConfiguration
      //var instance = new EmrServerless.ApplicationAutoStartConfiguration();
      //expect(instance).to.be.a(EmrServerless.ApplicationAutoStartConfiguration);
    });
