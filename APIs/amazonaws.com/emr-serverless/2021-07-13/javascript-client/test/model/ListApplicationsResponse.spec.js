...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ListApplicationsResponse();
  });
  ...
  describe('ListApplicationsResponse', function() {
    it('should create an instance of ListApplicationsResponse', function() {
      ...
      //var instance = new EmrServerless.ListApplicationsResponse();
      //expect(instance).to.be.a(EmrServerless.ListApplicationsResponse);
    });
