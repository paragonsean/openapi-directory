...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.InitialCapacityConfig();
  });
  ...
  describe('InitialCapacityConfig', function() {
    it('should create an instance of InitialCapacityConfig', function() {
      // uncomment below and update the code to test InitialCapacityConfig
      //var instance = new EmrServerless.InitialCapacityConfig();
      //expect(instance).to.be.a(EmrServerless.InitialCapacityConfig);
    });
    ...
    it('should have the property workerConfiguration (base name: "workerConfiguration")', function() {
      // uncomment below and update the code to test the property workerConfiguration
      //var instance = new EmrServerless.InitialCapacityConfig();
      //expect(instance).to.be();
    });
