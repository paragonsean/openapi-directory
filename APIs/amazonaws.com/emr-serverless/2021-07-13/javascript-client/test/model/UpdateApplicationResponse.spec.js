...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.UpdateApplicationResponse();
  });
  ...
  describe('UpdateApplicationResponse', function() {
    it('should create an instance of UpdateApplicationResponse', function() {
      ...
      //var instance = new EmrServerless.UpdateApplicationResponse();
      //expect(instance).to.be.a(EmrServerless.UpdateApplicationResponse);
    });
