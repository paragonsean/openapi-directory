...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.NetworkConfiguration();
  });
  ...
  describe('NetworkConfiguration', function() {
    it('should create an instance of NetworkConfiguration', function() {
      ...
      //var instance = new EmrServerless.NetworkConfiguration();
      //expect(instance).to.be.a(EmrServerless.NetworkConfiguration);
    });
