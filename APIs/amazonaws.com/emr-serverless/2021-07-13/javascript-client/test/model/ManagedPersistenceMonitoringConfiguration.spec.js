...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ManagedPersistenceMonitoringConfiguration();
  });
  ...
  describe('ManagedPersistenceMonitoringConfiguration', function() {
    it('should create an instance of ManagedPersistenceMonitoringConfiguration', function() {
      // uncomment below and update the code to test ManagedPersistenceMonitoringConfiguration
      //var instance = new EmrServerless.ManagedPersistenceMonitoringConfiguration();
      //expect(instance).to.be.a(EmrServerless.ManagedPersistenceMonitoringConfiguration);
    });
