...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.StartJobRunRequestConfigurationOverrides();
  });
  ...
  describe('StartJobRunRequestConfigurationOverrides', function() {
    it('should create an instance of StartJobRunRequestConfigurationOverrides', function() {
      // uncomment below and update the code to test StartJobRunRequestConfigurationOverrides
      //var instance = new EmrServerless.StartJobRunRequestConfigurationOverrides();
      //expect(instance).to.be.a(EmrServerless.StartJobRunRequestConfigurationOverrides);
    });
