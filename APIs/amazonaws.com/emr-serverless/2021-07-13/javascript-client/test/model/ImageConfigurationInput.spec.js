...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ImageConfigurationInput();
  });
  ...
  describe('ImageConfigurationInput', function() {
    it('should create an instance of ImageConfigurationInput', function() {
      // uncomment below and update the code to test ImageConfigurationInput
      //var instance = new EmrServerless.ImageConfigurationInput();
      //expect(instance).to.be.a(EmrServerless.ImageConfigurationInput);
    });
