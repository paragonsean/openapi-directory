...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.GetApplicationResponseApplication();
  });
  ...
  describe('GetApplicationResponseApplication', function() {
    it('should create an instance of GetApplicationResponseApplication', function() {
      // uncomment below and update the code to test GetApplicationResponseApplication
      //var instance = new EmrServerless.GetApplicationResponseApplication();
      //expect(instance).to.be.a(EmrServerless.GetApplicationResponseApplication);
    });
