...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.StartJobRunRequestJobDriverSparkSubmit();
  });
  ...
  describe('StartJobRunRequestJobDriverSparkSubmit', function() {
    it('should create an instance of StartJobRunRequestJobDriverSparkSubmit', function() {
      // uncomment below and update the code to test StartJobRunRequestJobDriverSparkSubmit
      //var instance = new EmrServerless.StartJobRunRequestJobDriverSparkSubmit();
      //expect(instance).to.be.a(EmrServerless.StartJobRunRequestJobDriverSparkSubmit);
    });
