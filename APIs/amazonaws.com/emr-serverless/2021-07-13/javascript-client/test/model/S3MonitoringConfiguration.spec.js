...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.S3MonitoringConfiguration();
  });
  ...
  describe('S3MonitoringConfiguration', function() {
    it('should create an instance of S3MonitoringConfiguration', function() {
      // uncomment below and update the code to test S3MonitoringConfiguration
      //var instance = new EmrServerless.S3MonitoringConfiguration();
      //expect(instance).to.be.a(EmrServerless.S3MonitoringConfiguration);
    });
