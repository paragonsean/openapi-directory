...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.AutoStopConfig();
  });
  ...
  describe('AutoStopConfig', function() {
    it('should create an instance of AutoStopConfig', function() {
      // uncomment below and update the code to test AutoStopConfig
      //var instance = new EmrServerless.AutoStopConfig();
      //expect(instance).to.be.a(EmrServerless.AutoStopConfig);
    });
