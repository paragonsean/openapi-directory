...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.MonitoringConfigurationS3MonitoringConfiguration();
  });
  ...
  describe('MonitoringConfigurationS3MonitoringConfiguration', function() {
    it('should create an instance of MonitoringConfigurationS3MonitoringConfiguration', function() {
      // uncomment below and update the code to test MonitoringConfigurationS3MonitoringConfiguration
      //var instance = new EmrServerless.MonitoringConfigurationS3MonitoringConfiguration();
      //expect(instance).to.be.a(EmrServerless.MonitoringConfigurationS3MonitoringConfiguration);
    });
