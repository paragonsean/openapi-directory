...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.JobRunBilledResourceUtilization();
  });
  ...
  describe('JobRunBilledResourceUtilization', function() {
    it('should create an instance of JobRunBilledResourceUtilization', function() {
      // uncomment below and update the code to test JobRunBilledResourceUtilization
      //var instance = new EmrServerless.JobRunBilledResourceUtilization();
      //expect(instance).to.be.a(EmrServerless.JobRunBilledResourceUtilization);
    });
