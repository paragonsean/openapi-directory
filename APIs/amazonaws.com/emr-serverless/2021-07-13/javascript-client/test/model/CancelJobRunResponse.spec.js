...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.CancelJobRunResponse();
  });
  ...
  describe('CancelJobRunResponse', function() {
    it('should create an instance of CancelJobRunResponse', function() {
      // uncomment below and update the code to test CancelJobRunResponse
      //var instance = new EmrServerless.CancelJobRunResponse();
      //expect(instance).to.be.a(EmrServerless.CancelJobRunResponse);
    });
