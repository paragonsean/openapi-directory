...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ApplicationImageConfiguration();
  });
  ...
  describe('ApplicationImageConfiguration', function() {
    it('should create an instance of ApplicationImageConfiguration', function() {
      // uncomment below and update the code to test ApplicationImageConfiguration
      //var instance = new EmrServerless.ApplicationImageConfiguration();
      //expect(instance).to.be.a(EmrServerless.ApplicationImageConfiguration);
    });
    ...
    it('should have the property resolvedImageDigest (base name: "resolvedImageDigest")', function() {
      // uncomment below and update the code to test the property resolvedImageDigest
      //var instance = new EmrServerless.ApplicationImageConfiguration();
      //expect(instance).to.be();
    });
