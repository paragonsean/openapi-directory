...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.StartJobRunRequestJobDriverHive();
  });
  ...
  describe('StartJobRunRequestJobDriverHive', function() {
    it('should create an instance of StartJobRunRequestJobDriverHive', function() {
      // uncomment below and update the code to test StartJobRunRequestJobDriverHive
      //var instance = new EmrServerless.StartJobRunRequestJobDriverHive();
      //expect(instance).to.be.a(EmrServerless.StartJobRunRequestJobDriverHive);
    });
