...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.CreateApplicationRequestAutoStartConfiguration();
  });
  ...
  describe('CreateApplicationRequestAutoStartConfiguration', function() {
    it('should create an instance of CreateApplicationRequestAutoStartConfiguration', function() {
      // uncomment below and update the code to test CreateApplicationRequestAutoStartConfiguration
      //var instance = new EmrServerless.CreateApplicationRequestAutoStartConfiguration();
      //expect(instance).to.be.a(EmrServerless.CreateApplicationRequestAutoStartConfiguration);
    });
