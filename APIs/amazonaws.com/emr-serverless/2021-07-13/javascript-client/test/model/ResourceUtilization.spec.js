...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ResourceUtilization();
  });
  ...
  describe('ResourceUtilization', function() {
    it('should create an instance of ResourceUtilization', function() {
      // uncomment below and update the code to test ResourceUtilization
      //var instance = new EmrServerless.ResourceUtilization();
      //expect(instance).to.be.a(EmrServerless.ResourceUtilization);
    });
