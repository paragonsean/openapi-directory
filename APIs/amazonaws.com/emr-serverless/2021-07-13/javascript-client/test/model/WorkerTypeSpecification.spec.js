...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.WorkerTypeSpecification();
  });
  ...
  describe('WorkerTypeSpecification', function() {
    it('should create an instance of WorkerTypeSpecification', function() {
      // uncomment below and update the code to test WorkerTypeSpecification
      //var instance = new EmrServerless.WorkerTypeSpecification();
      //expect(instance).to.be.a(EmrServerless.WorkerTypeSpecification);
    });
