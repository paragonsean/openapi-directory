...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.JobRunJobDriver();
  });
  ...
  describe('JobRunJobDriver', function() {
    it('should create an instance of JobRunJobDriver', function() {
      // uncomment below and update the code to test JobRunJobDriver
      //var instance = new EmrServerless.JobRunJobDriver();
      //expect(instance).to.be.a(EmrServerless.JobRunJobDriver);
    });

    it('should have the property sparkSubmit (base name: "sparkSubmit")', function() {
      // uncomment below and update the code to test the property sparkSubmit
      //var instance = new EmrServerless.JobRunJobDriver();
      //expect(instance).to.be();
    });

    it('should have the property hive (base name: "hive")', function() {
      // uncomment below and update the code to test the property hive
      //var instance = new EmrServerless.JobRunJobDriver();
      //expect(instance).to.be();
    });
