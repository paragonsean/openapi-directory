...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ApplicationNetworkConfiguration();
  });
  ...
  describe('ApplicationNetworkConfiguration', function() {
    it('should create an instance of ApplicationNetworkConfiguration', function() {
      // uncomment below and update the code to test ApplicationNetworkConfiguration
      //var instance = new EmrServerless.ApplicationNetworkConfiguration();
      //expect(instance).to.be.a(EmrServerless.ApplicationNetworkConfiguration);
    });
