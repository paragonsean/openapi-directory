...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ImageConfiguration();
  });
  ...
  describe('ImageConfiguration', function() {
    it('should create an instance of ImageConfiguration', function() {
      // uncomment below and update the code to test ImageConfiguration
      //var instance = new EmrServerless.ImageConfiguration();
      //expect(instance).to.be.a(EmrServerless.ImageConfiguration);
    });
