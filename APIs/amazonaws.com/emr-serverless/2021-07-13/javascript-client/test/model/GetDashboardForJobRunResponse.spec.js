...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.GetDashboardForJobRunResponse();
  });
  ...
  describe('GetDashboardForJobRunResponse', function() {
    it('should create an instance of GetDashboardForJobRunResponse', function() {
      // uncomment below and update the code to test GetDashboardForJobRunResponse
      //var instance = new EmrServerless.GetDashboardForJobRunResponse();
      //expect(instance).to.be.a(EmrServerless.GetDashboardForJobRunResponse);
    });
