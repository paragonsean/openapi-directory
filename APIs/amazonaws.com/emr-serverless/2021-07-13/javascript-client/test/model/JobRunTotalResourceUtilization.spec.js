...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.JobRunTotalResourceUtilization();
  });
  ...
  describe('JobRunTotalResourceUtilization', function() {
    it('should create an instance of JobRunTotalResourceUtilization', function() {
      // uncomment below and update the code to test JobRunTotalResourceUtilization
      //var instance = new EmrServerless.JobRunTotalResourceUtilization();
      //expect(instance).to.be.a(EmrServerless.JobRunTotalResourceUtilization);
    });
