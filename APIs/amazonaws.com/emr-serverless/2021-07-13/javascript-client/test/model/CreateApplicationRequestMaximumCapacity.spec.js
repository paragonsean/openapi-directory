...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.CreateApplicationRequestMaximumCapacity();
  });
  ...
  describe('CreateApplicationRequestMaximumCapacity', function() {
    it('should create an instance of CreateApplicationRequestMaximumCapacity', function() {
      // uncomment below and update the code to test CreateApplicationRequestMaximumCapacity
      //var instance = new EmrServerless.CreateApplicationRequestMaximumCapacity();
      //expect(instance).to.be.a(EmrServerless.CreateApplicationRequestMaximumCapacity);
    });
