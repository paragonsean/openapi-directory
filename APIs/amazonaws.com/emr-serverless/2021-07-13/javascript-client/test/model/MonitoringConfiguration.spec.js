...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.MonitoringConfiguration();
  });
  ...
  describe('MonitoringConfiguration', function() {
    it('should create an instance of MonitoringConfiguration', function() {
      // uncomment below and update the code to test MonitoringConfiguration
      //var instance = new EmrServerless.MonitoringConfiguration();
      //expect(instance).to.be.a(EmrServerless.MonitoringConfiguration);
    });

    it('should have the property s3MonitoringConfiguration (base name: "s3MonitoringConfiguration")', function() {
      // uncomment below and update the code to test the property s3MonitoringConfiguration
      //var instance = new EmrServerless.MonitoringConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property managedPersistenceMonitoringConfiguration (base name: "managedPersistenceMonitoringConfiguration")', function() {
      // uncomment below and update the code to test the property managedPersistenceMonitoringConfiguration
      //var instance = new EmrServerless.MonitoringConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property cloudWatchLoggingConfiguration (base name: "cloudWatchLoggingConfiguration")', function() {
      // uncomment below and update the code to test the property cloudWatchLoggingConfiguration
      //var instance = new EmrServerless.MonitoringConfiguration();
      //expect(instance).to.be();
    });
