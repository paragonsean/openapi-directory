...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.InitialCapacityConfigWorkerConfiguration();
  });
  ...
  describe('InitialCapacityConfigWorkerConfiguration', function() {
    it('should create an instance of InitialCapacityConfigWorkerConfiguration', function() {
      // uncomment below and update the code to test InitialCapacityConfigWorkerConfiguration
      //var instance = new EmrServerless.InitialCapacityConfigWorkerConfiguration();
      //expect(instance).to.be.a(EmrServerless.InitialCapacityConfigWorkerConfiguration);
    });
