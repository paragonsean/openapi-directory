...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ApplicationAutoStopConfiguration();
  });
  ...
  describe('ApplicationAutoStopConfiguration', function() {
    it('should create an instance of ApplicationAutoStopConfiguration', function() {
      // uncomment below and update the code to test ApplicationAutoStopConfiguration
      //var instance = new EmrServerless.ApplicationAutoStopConfiguration();
      //expect(instance).to.be.a(EmrServerless.ApplicationAutoStopConfiguration);
    });
