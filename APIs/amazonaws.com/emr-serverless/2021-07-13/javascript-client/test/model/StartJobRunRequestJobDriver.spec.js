...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.StartJobRunRequestJobDriver();
  });
  ...
  describe('StartJobRunRequestJobDriver', function() {
    it('should create an instance of StartJobRunRequestJobDriver', function() {
      // uncomment below and update the code to test StartJobRunRequestJobDriver
      //var instance = new EmrServerless.StartJobRunRequestJobDriver();
      //expect(instance).to.be.a(EmrServerless.StartJobRunRequestJobDriver);
    });
