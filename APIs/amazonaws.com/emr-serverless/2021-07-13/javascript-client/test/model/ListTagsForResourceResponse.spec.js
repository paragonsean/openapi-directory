...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new EmrServerless.ListTagsForResourceResponse();
      //expect(instance).to.be.a(EmrServerless.ListTagsForResourceResponse);
    });
