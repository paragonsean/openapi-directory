...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.SparkSubmit();
  });
  ...
  describe('SparkSubmit', function() {
    it('should create an instance of SparkSubmit', function() {
      // uncomment below and update the code to test SparkSubmit
      //var instance = new EmrServerless.SparkSubmit();
      //expect(instance).to.be.a(EmrServerless.SparkSubmit);
    });
    ...
    it('should have the property entryPointArguments (base name: "entryPointArguments")', function() {
      // uncomment below and update the code to test the property entryPointArguments
      //var instance = new EmrServerless.SparkSubmit();
      //expect(instance).to.be();
    });

    it('should have the property sparkSubmitParameters (base name: "sparkSubmitParameters")', function() {
      // uncomment below and update the code to test the property sparkSubmitParameters
      //var instance = new EmrServerless.SparkSubmit();
      //expect(instance).to.be();
    });
