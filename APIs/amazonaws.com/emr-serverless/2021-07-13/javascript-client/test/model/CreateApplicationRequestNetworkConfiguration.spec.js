...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.CreateApplicationRequestNetworkConfiguration();
  });
  ...
  describe('CreateApplicationRequestNetworkConfiguration', function() {
    it('should create an instance of CreateApplicationRequestNetworkConfiguration', function() {
      // uncomment below and update the code to test CreateApplicationRequestNetworkConfiguration
      //var instance = new EmrServerless.CreateApplicationRequestNetworkConfiguration();
      //expect(instance).to.be.a(EmrServerless.CreateApplicationRequestNetworkConfiguration);
    });
