...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.MonitoringConfigurationManagedPersistenceMonitoringConfiguration();
  });
  ...
  describe('MonitoringConfigurationManagedPersistenceMonitoringConfiguration', function() {
    it('should create an instance of MonitoringConfigurationManagedPersistenceMonitoringConfiguration', function() {
      // uncomment below and update the code to test MonitoringConfigurationManagedPersistenceMonitoringConfiguration
      //var instance = new EmrServerless.MonitoringConfigurationManagedPersistenceMonitoringConfiguration();
      //expect(instance).to.be.a(EmrServerless.MonitoringConfigurationManagedPersistenceMonitoringConfiguration);
    });
