...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.GetJobRunResponse();
  });
  ...
  describe('GetJobRunResponse', function() {
    it('should create an instance of GetJobRunResponse', function() {
      // uncomment below and update the code to test GetJobRunResponse
      //var instance = new EmrServerless.GetJobRunResponse();
      //expect(instance).to.be.a(EmrServerless.GetJobRunResponse);
    });
