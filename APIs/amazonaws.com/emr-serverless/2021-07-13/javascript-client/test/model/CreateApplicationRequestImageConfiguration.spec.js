...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.CreateApplicationRequestImageConfiguration();
  });
  ...
  describe('CreateApplicationRequestImageConfiguration', function() {
    it('should create an instance of CreateApplicationRequestImageConfiguration', function() {
      // uncomment below and update the code to test CreateApplicationRequestImageConfiguration
      //var instance = new EmrServerless.CreateApplicationRequestImageConfiguration();
      //expect(instance).to.be.a(EmrServerless.CreateApplicationRequestImageConfiguration);
    });
