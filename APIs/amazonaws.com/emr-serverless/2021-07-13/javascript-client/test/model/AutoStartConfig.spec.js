...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmrServerless.AutoStartConfig();
  });
  ...
  describe('AutoStartConfig', function() {
    it('should create an instance of AutoStartConfig', function() {
      // uncomment below and update the code to test AutoStartConfig
      //var instance = new EmrServerless.AutoStartConfig();
      //expect(instance).to.be.a(EmrServerless.AutoStartConfig);
    });
