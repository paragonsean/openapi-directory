...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::cancelJobRunSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::cancelJobRunSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString application_id = create(); // QString | The ID of the application on which the job run will be canceled.
      ...
      QString job_run_id = create(); // QString | The ID of the job run to cancel.
      ...
      apiInstance.cancelJobRun(application_idjob_run_idx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
