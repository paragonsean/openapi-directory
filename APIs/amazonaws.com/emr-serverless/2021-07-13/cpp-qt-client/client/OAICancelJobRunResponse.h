...
/*
 * OAICancelJobRunResponse.h
 *
 * 
 */

#ifndef OAICancelJobRunResponse_H
#define OAICancelJobRunResponse_H
...
class OAICancelJobRunResponse : public OAIObject {
public:
    OAICancelJobRunResponse();
    OAICancelJobRunResponse(QString json);
    ~OAICancelJobRunResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelJobRunResponse)

#endif // OAICancelJobRunResponse_H
