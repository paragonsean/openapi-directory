...
/*
 * OAIWorkerResourceConfig.h
 *
 * The cumulative configuration requirements for every worker instance of the worker type.
 */

#ifndef OAIWorkerResourceConfig_H
#define OAIWorkerResourceConfig_H
...
class OAIWorkerResourceConfig : public OAIObject {
public:
    OAIWorkerResourceConfig();
    OAIWorkerResourceConfig(QString json);
    ~OAIWorkerResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkerResourceConfig)

#endif // OAIWorkerResourceConfig_H
