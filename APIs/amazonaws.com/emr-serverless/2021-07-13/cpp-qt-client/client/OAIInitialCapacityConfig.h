...
/*
 * OAIInitialCapacityConfig.h
 *
 * The initial capacity configuration per worker.
 */

#ifndef OAIInitialCapacityConfig_H
#define OAIInitialCapacityConfig_H
...
namespace OpenAPI {
class OAIInitialCapacityConfig_workerConfiguration;

class OAIInitialCapacityConfig : public OAIObject {
public:
    OAIInitialCapacityConfig();
    OAIInitialCapacityConfig(QString json);
    ~OAIInitialCapacityConfig() override;
    ...
    OAIInitialCapacityConfig_workerConfiguration getWorkerConfiguration() const;
    void setWorkerConfiguration(const OAIInitialCapacityConfig_workerConfiguration &worker_configuration);
    bool is_worker_configuration_Set() const;
    bool is_worker_configuration_Valid() const;
...
private:
    ...
    OAIInitialCapacityConfig_workerConfiguration m_worker_configuration;
    bool m_worker_configuration_isSet;
    bool m_worker_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIInitialCapacityConfig)

#endif // OAIInitialCapacityConfig_H
