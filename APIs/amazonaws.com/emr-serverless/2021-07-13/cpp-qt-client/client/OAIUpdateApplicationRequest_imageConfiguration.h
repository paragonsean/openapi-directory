...
/*
 * OAIUpdateApplicationRequest_imageConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateApplicationRequest_imageConfiguration_H
#define OAIUpdateApplicationRequest_imageConfiguration_H
...
class OAIUpdateApplicationRequest_imageConfiguration : public OAIObject {
public:
    OAIUpdateApplicationRequest_imageConfiguration();
    OAIUpdateApplicationRequest_imageConfiguration(QString json);
    ~OAIUpdateApplicationRequest_imageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApplicationRequest_imageConfiguration)

#endif // OAIUpdateApplicationRequest_imageConfiguration_H
