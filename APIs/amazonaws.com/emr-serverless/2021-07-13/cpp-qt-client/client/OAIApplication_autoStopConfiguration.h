...
/*
 * OAIApplication_autoStopConfiguration.h
 *
 * 
 */

#ifndef OAIApplication_autoStopConfiguration_H
#define OAIApplication_autoStopConfiguration_H
...
class OAIApplication_autoStopConfiguration : public OAIObject {
public:
    OAIApplication_autoStopConfiguration();
    OAIApplication_autoStopConfiguration(QString json);
    ~OAIApplication_autoStopConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplication_autoStopConfiguration)

#endif // OAIApplication_autoStopConfiguration_H
