...
/*
 * OAIImageConfiguration.h
 *
 * The applied image configuration.
 */

#ifndef OAIImageConfiguration_H
#define OAIImageConfiguration_H
...
class OAIImageConfiguration : public OAIObject {
public:
    OAIImageConfiguration();
    OAIImageConfiguration(QString json);
    ~OAIImageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageConfiguration)

#endif // OAIImageConfiguration_H
