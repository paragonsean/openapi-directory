...
class OAIStartJobRunRequest_configurationOverrides;
...
public:
    ...
    OAIStartJobRunRequest_configurationOverrides getConfigurationOverrides() const;
    void setConfigurationOverrides(const OAIStartJobRunRequest_configurationOverrides &configuration_overrides);
...
private:
    ...
    OAIStartJobRunRequest_configurationOverrides m_configuration_overrides;
