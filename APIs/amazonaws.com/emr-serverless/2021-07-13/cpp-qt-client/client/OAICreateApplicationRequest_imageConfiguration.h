...
/*
 * OAICreateApplicationRequest_imageConfiguration.h
 *
 * 
 */

#ifndef OAICreateApplicationRequest_imageConfiguration_H
#define OAICreateApplicationRequest_imageConfiguration_H
...
class OAICreateApplicationRequest_imageConfiguration : public OAIObject {
public:
    OAICreateApplicationRequest_imageConfiguration();
    OAICreateApplicationRequest_imageConfiguration(QString json);
    ~OAICreateApplicationRequest_imageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplicationRequest_imageConfiguration)

#endif // OAICreateApplicationRequest_imageConfiguration_H
