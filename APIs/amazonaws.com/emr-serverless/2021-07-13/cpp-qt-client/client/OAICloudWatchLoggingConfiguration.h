...
/*
 * OAICloudWatchLoggingConfiguration.h
 *
 * The Amazon CloudWatch configuration for monitoring logs. You can configure your jobs to send log information to CloudWatch.
 */

#ifndef OAICloudWatchLoggingConfiguration_H
#define OAICloudWatchLoggingConfiguration_H
...
class OAICloudWatchLoggingConfiguration : public OAIObject {
public:
    OAICloudWatchLoggingConfiguration();
    OAICloudWatchLoggingConfiguration(QString json);
    ~OAICloudWatchLoggingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudWatchLoggingConfiguration)

#endif // OAICloudWatchLoggingConfiguration_H
