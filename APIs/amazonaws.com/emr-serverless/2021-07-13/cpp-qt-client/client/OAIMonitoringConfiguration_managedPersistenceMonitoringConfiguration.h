...
/*
 * OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration.h
 *
 * 
 */

#ifndef OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration_H
#define OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration_H
...
class OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration : public OAIObject {
public:
    OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration();
    OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration(QString json);
    ~OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration)

#endif // OAIMonitoringConfiguration_managedPersistenceMonitoringConfiguration_H
