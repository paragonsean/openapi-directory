...
/*
 * OAIWorkerTypeSpecificationInput_imageConfiguration.h
 *
 * 
 */

#ifndef OAIWorkerTypeSpecificationInput_imageConfiguration_H
#define OAIWorkerTypeSpecificationInput_imageConfiguration_H
...
class OAIWorkerTypeSpecificationInput_imageConfiguration : public OAIObject {
public:
    OAIWorkerTypeSpecificationInput_imageConfiguration();
    OAIWorkerTypeSpecificationInput_imageConfiguration(QString json);
    ~OAIWorkerTypeSpecificationInput_imageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkerTypeSpecificationInput_imageConfiguration)

#endif // OAIWorkerTypeSpecificationInput_imageConfiguration_H
