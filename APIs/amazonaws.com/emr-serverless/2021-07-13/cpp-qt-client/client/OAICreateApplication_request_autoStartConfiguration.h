...
/*
 * OAICreateApplication_request_autoStartConfiguration.h
 *
 * The configuration for an application to automatically start on job submission.
 */

#ifndef OAICreateApplication_request_autoStartConfiguration_H
#define OAICreateApplication_request_autoStartConfiguration_H
...
class OAICreateApplication_request_autoStartConfiguration : public OAIObject {
public:
    OAICreateApplication_request_autoStartConfiguration();
    OAICreateApplication_request_autoStartConfiguration(QString json);
    ~OAICreateApplication_request_autoStartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplication_request_autoStartConfiguration)

#endif // OAICreateApplication_request_autoStartConfiguration_H
