...
OAICreateApplicationRequest_maximumCapacity::OAICreateApplicationRequest_maximumCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApplicationRequest_maximumCapacity::OAICreateApplicationRequest_maximumCapacity() {
    this->initializeModel();
}

OAICreateApplicationRequest_maximumCapacity::~OAICreateApplicationRequest_maximumCapacity() {}

void OAICreateApplicationRequest_maximumCapacity::initializeModel() {
...
void OAICreateApplicationRequest_maximumCapacity::fromJson(QString jsonString) {
...
void OAICreateApplicationRequest_maximumCapacity::fromJsonObject(QJsonObject json) {
...
QString OAICreateApplicationRequest_maximumCapacity::asJson() const {
...
QJsonObject OAICreateApplicationRequest_maximumCapacity::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu_isSet) {
...
QString OAICreateApplicationRequest_maximumCapacity::getCpu() const {
    return m_cpu;
}
void OAICreateApplicationRequest_maximumCapacity::setCpu(const QString &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAICreateApplicationRequest_maximumCapacity::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAICreateApplicationRequest_maximumCapacity::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QString OAICreateApplicationRequest_maximumCapacity::getMemory() const {
    return m_memory;
}
void OAICreateApplicationRequest_maximumCapacity::setMemory(const QString &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAICreateApplicationRequest_maximumCapacity::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAICreateApplicationRequest_maximumCapacity::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAICreateApplicationRequest_maximumCapacity::getDisk() const {
    return m_disk;
}
void OAICreateApplicationRequest_maximumCapacity::setDisk(const QString &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAICreateApplicationRequest_maximumCapacity::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAICreateApplicationRequest_maximumCapacity::is_disk_Valid() const{
    return m_disk_isValid;
}

bool OAICreateApplicationRequest_maximumCapacity::isSet() const {
...
bool OAICreateApplicationRequest_maximumCapacity::isValid() const {
