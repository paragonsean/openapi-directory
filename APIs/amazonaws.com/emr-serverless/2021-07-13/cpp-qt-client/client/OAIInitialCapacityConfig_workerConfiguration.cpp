...
#include "OAIInitialCapacityConfig_workerConfiguration.h"
...
OAIInitialCapacityConfig_workerConfiguration::OAIInitialCapacityConfig_workerConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitialCapacityConfig_workerConfiguration::OAIInitialCapacityConfig_workerConfiguration() {
    this->initializeModel();
}

OAIInitialCapacityConfig_workerConfiguration::~OAIInitialCapacityConfig_workerConfiguration() {}

void OAIInitialCapacityConfig_workerConfiguration::initializeModel() {
...
void OAIInitialCapacityConfig_workerConfiguration::fromJson(QString jsonString) {
...
void OAIInitialCapacityConfig_workerConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIInitialCapacityConfig_workerConfiguration::asJson() const {
...
QJsonObject OAIInitialCapacityConfig_workerConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu_isSet) {
...
QString OAIInitialCapacityConfig_workerConfiguration::getCpu() const {
    return m_cpu;
}
void OAIInitialCapacityConfig_workerConfiguration::setCpu(const QString &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIInitialCapacityConfig_workerConfiguration::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIInitialCapacityConfig_workerConfiguration::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QString OAIInitialCapacityConfig_workerConfiguration::getMemory() const {
    return m_memory;
}
void OAIInitialCapacityConfig_workerConfiguration::setMemory(const QString &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIInitialCapacityConfig_workerConfiguration::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIInitialCapacityConfig_workerConfiguration::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAIInitialCapacityConfig_workerConfiguration::getDisk() const {
    return m_disk;
}
void OAIInitialCapacityConfig_workerConfiguration::setDisk(const QString &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAIInitialCapacityConfig_workerConfiguration::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAIInitialCapacityConfig_workerConfiguration::is_disk_Valid() const{
    return m_disk_isValid;
}

bool OAIInitialCapacityConfig_workerConfiguration::isSet() const {
...
bool OAIInitialCapacityConfig_workerConfiguration::isValid() const {
