...
/*
 * OAIAutoStartConfig.h
 *
 * The configuration for an application to automatically start on job submission.
 */

#ifndef OAIAutoStartConfig_H
#define OAIAutoStartConfig_H
...
class OAIAutoStartConfig : public OAIObject {
public:
    OAIAutoStartConfig();
    OAIAutoStartConfig(QString json);
    ~OAIAutoStartConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoStartConfig)

#endif // OAIAutoStartConfig_H
