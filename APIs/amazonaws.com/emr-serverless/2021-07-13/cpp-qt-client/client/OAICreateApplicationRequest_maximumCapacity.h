...
/*
 * OAICreateApplicationRequest_maximumCapacity.h
 *
 * 
 */

#ifndef OAICreateApplicationRequest_maximumCapacity_H
#define OAICreateApplicationRequest_maximumCapacity_H
...
class OAICreateApplicationRequest_maximumCapacity : public OAIObject {
public:
    OAICreateApplicationRequest_maximumCapacity();
    OAICreateApplicationRequest_maximumCapacity(QString json);
    ~OAICreateApplicationRequest_maximumCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplicationRequest_maximumCapacity)

#endif // OAICreateApplicationRequest_maximumCapacity_H
