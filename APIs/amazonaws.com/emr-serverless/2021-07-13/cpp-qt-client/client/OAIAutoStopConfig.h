...
#ifndef OAIAutoStopConfig_H
#define OAIAutoStopConfig_H
...
class OAIAutoStopConfig : public OAIObject {
public:
    OAIAutoStopConfig();
    OAIAutoStopConfig(QString json);
    ~OAIAutoStopConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoStopConfig)

#endif // OAIAutoStopConfig_H
