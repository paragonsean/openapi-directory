...
#include "OAIMaximumAllowedResources.h"
...
OAIMaximumAllowedResources::OAIMaximumAllowedResources(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMaximumAllowedResources::OAIMaximumAllowedResources() {
    this->initializeModel();
}

OAIMaximumAllowedResources::~OAIMaximumAllowedResources() {}

void OAIMaximumAllowedResources::initializeModel() {
...
void OAIMaximumAllowedResources::fromJson(QString jsonString) {
...
void OAIMaximumAllowedResources::fromJsonObject(QJsonObject json) {
...
QString OAIMaximumAllowedResources::asJson() const {
...
QJsonObject OAIMaximumAllowedResources::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu_isSet) {
...
QString OAIMaximumAllowedResources::getCpu() const {
    return m_cpu;
}
void OAIMaximumAllowedResources::setCpu(const QString &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIMaximumAllowedResources::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIMaximumAllowedResources::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QString OAIMaximumAllowedResources::getMemory() const {
    return m_memory;
}
void OAIMaximumAllowedResources::setMemory(const QString &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIMaximumAllowedResources::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIMaximumAllowedResources::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAIMaximumAllowedResources::getDisk() const {
    return m_disk;
}
void OAIMaximumAllowedResources::setDisk(const QString &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAIMaximumAllowedResources::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAIMaximumAllowedResources::is_disk_Valid() const{
    return m_disk_isValid;
}

bool OAIMaximumAllowedResources::isSet() const {
...
bool OAIMaximumAllowedResources::isValid() const {
