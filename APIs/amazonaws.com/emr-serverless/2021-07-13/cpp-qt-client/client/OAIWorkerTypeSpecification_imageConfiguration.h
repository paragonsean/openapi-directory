...
/*
 * OAIWorkerTypeSpecification_imageConfiguration.h
 *
 * 
 */

#ifndef OAIWorkerTypeSpecification_imageConfiguration_H
#define OAIWorkerTypeSpecification_imageConfiguration_H
...
class OAIWorkerTypeSpecification_imageConfiguration : public OAIObject {
public:
    OAIWorkerTypeSpecification_imageConfiguration();
    OAIWorkerTypeSpecification_imageConfiguration(QString json);
    ~OAIWorkerTypeSpecification_imageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkerTypeSpecification_imageConfiguration)

#endif // OAIWorkerTypeSpecification_imageConfiguration_H
