...
/*
 * OAIImageConfigurationInput.h
 *
 * The image configuration.
 */

#ifndef OAIImageConfigurationInput_H
#define OAIImageConfigurationInput_H
...
class OAIImageConfigurationInput : public OAIObject {
public:
    OAIImageConfigurationInput();
    OAIImageConfigurationInput(QString json);
    ~OAIImageConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageConfigurationInput)

#endif // OAIImageConfigurationInput_H
