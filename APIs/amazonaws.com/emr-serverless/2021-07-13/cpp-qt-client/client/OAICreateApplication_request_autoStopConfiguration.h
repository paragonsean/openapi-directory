...
/*
 * OAICreateApplication_request_autoStopConfiguration.h
 *
 * The configuration for an application to automatically stop after a certain amount of time being idle.
 */

#ifndef OAICreateApplication_request_autoStopConfiguration_H
#define OAICreateApplication_request_autoStopConfiguration_H
...
class OAICreateApplication_request_autoStopConfiguration : public OAIObject {
public:
    OAICreateApplication_request_autoStopConfiguration();
    OAICreateApplication_request_autoStopConfiguration(QString json);
    ~OAICreateApplication_request_autoStopConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplication_request_autoStopConfiguration)

#endif // OAICreateApplication_request_autoStopConfiguration_H
