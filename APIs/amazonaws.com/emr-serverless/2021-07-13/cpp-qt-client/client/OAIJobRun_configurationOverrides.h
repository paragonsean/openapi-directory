...
/*
 * OAIJobRun_configurationOverrides.h
 *
 * 
 */

#ifndef OAIJobRun_configurationOverrides_H
#define OAIJobRun_configurationOverrides_H
...
class OAIJobRun_configurationOverrides : public OAIObject {
public:
    OAIJobRun_configurationOverrides();
    OAIJobRun_configurationOverrides(QString json);
    ~OAIJobRun_configurationOverrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobRun_configurationOverrides)

#endif // OAIJobRun_configurationOverrides_H
