...
/*
 * OAIJobRun_totalResourceUtilization.h
 *
 * 
 */

#ifndef OAIJobRun_totalResourceUtilization_H
#define OAIJobRun_totalResourceUtilization_H
...
class OAIJobRun_totalResourceUtilization : public OAIObject {
public:
    OAIJobRun_totalResourceUtilization();
    OAIJobRun_totalResourceUtilization(QString json);
    ~OAIJobRun_totalResourceUtilization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobRun_totalResourceUtilization)

#endif // OAIJobRun_totalResourceUtilization_H
