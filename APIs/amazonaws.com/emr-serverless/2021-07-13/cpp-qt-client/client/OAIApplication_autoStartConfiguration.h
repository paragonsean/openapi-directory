...
/*
 * OAIApplication_autoStartConfiguration.h
 *
 * 
 */

#ifndef OAIApplication_autoStartConfiguration_H
#define OAIApplication_autoStartConfiguration_H
...
class OAIApplication_autoStartConfiguration : public OAIObject {
public:
    OAIApplication_autoStartConfiguration();
    OAIApplication_autoStartConfiguration(QString json);
    ~OAIApplication_autoStartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplication_autoStartConfiguration)

#endif // OAIApplication_autoStartConfiguration_H
