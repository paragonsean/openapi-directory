...
/*
 * OAIApplication_maximumCapacity.h
 *
 * 
 */

#ifndef OAIApplication_maximumCapacity_H
#define OAIApplication_maximumCapacity_H
...
class OAIApplication_maximumCapacity : public OAIObject {
public:
    OAIApplication_maximumCapacity();
    OAIApplication_maximumCapacity(QString json);
    ~OAIApplication_maximumCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplication_maximumCapacity)

#endif // OAIApplication_maximumCapacity_H
