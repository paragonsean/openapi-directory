...
OAIJobRun_configurationOverrides::OAIJobRun_configurationOverrides(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobRun_configurationOverrides::OAIJobRun_configurationOverrides() {
    this->initializeModel();
}

OAIJobRun_configurationOverrides::~OAIJobRun_configurationOverrides() {}

void OAIJobRun_configurationOverrides::initializeModel() {
...
void OAIJobRun_configurationOverrides::fromJson(QString jsonString) {
...
void OAIJobRun_configurationOverrides::fromJsonObject(QJsonObject json) {
...
QString OAIJobRun_configurationOverrides::asJson() const {
...
QJsonObject OAIJobRun_configurationOverrides::asJsonObject() const {
    QJsonObject obj;
...
QList OAIJobRun_configurationOverrides::getApplicationConfiguration() const {
    return m_application_configuration;
}
void OAIJobRun_configurationOverrides::setApplicationConfiguration(const QList &application_configuration) {
    m_application_configuration = application_configuration;
    m_application_configuration_isSet = true;
}

bool OAIJobRun_configurationOverrides::is_application_configuration_Set() const{
    return m_application_configuration_isSet;
}

bool OAIJobRun_configurationOverrides::is_application_configuration_Valid() const{
    return m_application_configuration_isValid;
}

OAIStartJobRun_request_configurationOverrides_monitoringConfiguration OAIJobRun_configurationOverrides::getMonitoringConfiguration() const {
    return m_monitoring_configuration;
}
void OAIJobRun_configurationOverrides::setMonitoringConfiguration(const OAIStartJobRun_request_configurationOverrides_monitoringConfiguration &monitoring_configuration) {
    m_monitoring_configuration = monitoring_configuration;
    m_monitoring_configuration_isSet = true;
}

bool OAIJobRun_configurationOverrides::is_monitoring_configuration_Set() const{
    return m_monitoring_configuration_isSet;
}

bool OAIJobRun_configurationOverrides::is_monitoring_configuration_Valid() const{
    return m_monitoring_configuration_isValid;
}

bool OAIJobRun_configurationOverrides::isSet() const {
...
bool OAIJobRun_configurationOverrides::isValid() const {
