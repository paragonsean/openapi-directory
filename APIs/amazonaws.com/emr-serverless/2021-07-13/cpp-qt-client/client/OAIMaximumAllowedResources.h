...
/*
 * OAIMaximumAllowedResources.h
 *
 * The maximum allowed cumulative resources for an application. No new resources will be created once the limit is hit.
 */

#ifndef OAIMaximumAllowedResources_H
#define OAIMaximumAllowedResources_H
...
class OAIMaximumAllowedResources : public OAIObject {
public:
    OAIMaximumAllowedResources();
    OAIMaximumAllowedResources(QString json);
    ~OAIMaximumAllowedResources() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMaximumAllowedResources)

#endif // OAIMaximumAllowedResources_H
