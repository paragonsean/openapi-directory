...
/*
 * OAIStartJobRun_request_jobDriver_sparkSubmit.h
 *
 * 
 */

#ifndef OAIStartJobRun_request_jobDriver_sparkSubmit_H
#define OAIStartJobRun_request_jobDriver_sparkSubmit_H
...
class OAIStartJobRun_request_jobDriver_sparkSubmit : public OAIObject {
public:
    OAIStartJobRun_request_jobDriver_sparkSubmit();
    OAIStartJobRun_request_jobDriver_sparkSubmit(QString json);
    ~OAIStartJobRun_request_jobDriver_sparkSubmit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartJobRun_request_jobDriver_sparkSubmit)

#endif // OAIStartJobRun_request_jobDriver_sparkSubmit_H
