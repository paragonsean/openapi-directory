...
OAIApplication_networkConfiguration::OAIApplication_networkConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplication_networkConfiguration::OAIApplication_networkConfiguration() {
    this->initializeModel();
}

OAIApplication_networkConfiguration::~OAIApplication_networkConfiguration() {}

void OAIApplication_networkConfiguration::initializeModel() {
...
void OAIApplication_networkConfiguration::fromJson(QString jsonString) {
...
void OAIApplication_networkConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIApplication_networkConfiguration::asJson() const {
...
QJsonObject OAIApplication_networkConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIApplication_networkConfiguration::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIApplication_networkConfiguration::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIApplication_networkConfiguration::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIApplication_networkConfiguration::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIApplication_networkConfiguration::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIApplication_networkConfiguration::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIApplication_networkConfiguration::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIApplication_networkConfiguration::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

bool OAIApplication_networkConfiguration::isSet() const {
...
bool OAIApplication_networkConfiguration::isValid() const {
