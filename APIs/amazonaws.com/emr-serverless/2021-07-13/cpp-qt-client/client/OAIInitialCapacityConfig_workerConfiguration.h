...
/*
 * OAIInitialCapacityConfig_workerConfiguration.h
 *
 * 
 */

#ifndef OAIInitialCapacityConfig_workerConfiguration_H
#define OAIInitialCapacityConfig_workerConfiguration_H
...
class OAIInitialCapacityConfig_workerConfiguration : public OAIObject {
public:
    OAIInitialCapacityConfig_workerConfiguration();
    OAIInitialCapacityConfig_workerConfiguration(QString json);
    ~OAIInitialCapacityConfig_workerConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitialCapacityConfig_workerConfiguration)

#endif // OAIInitialCapacityConfig_workerConfiguration_H
