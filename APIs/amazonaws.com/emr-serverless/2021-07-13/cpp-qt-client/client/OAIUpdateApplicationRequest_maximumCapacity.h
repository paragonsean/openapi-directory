...
/*
 * OAIUpdateApplicationRequest_maximumCapacity.h
 *
 * 
 */

#ifndef OAIUpdateApplicationRequest_maximumCapacity_H
#define OAIUpdateApplicationRequest_maximumCapacity_H
...
class OAIUpdateApplicationRequest_maximumCapacity : public OAIObject {
public:
    OAIUpdateApplicationRequest_maximumCapacity();
    OAIUpdateApplicationRequest_maximumCapacity(QString json);
    ~OAIUpdateApplicationRequest_maximumCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApplicationRequest_maximumCapacity)

#endif // OAIUpdateApplicationRequest_maximumCapacity_H
