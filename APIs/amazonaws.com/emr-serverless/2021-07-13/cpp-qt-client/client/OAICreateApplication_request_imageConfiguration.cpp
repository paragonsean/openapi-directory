...
OAICreateApplication_request_imageConfiguration::OAICreateApplication_request_imageConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApplication_request_imageConfiguration::OAICreateApplication_request_imageConfiguration() {
    this->initializeModel();
}

OAICreateApplication_request_imageConfiguration::~OAICreateApplication_request_imageConfiguration() {}

void OAICreateApplication_request_imageConfiguration::initializeModel() {

    m_image_uri_isSet = false;
    m_image_uri_isValid = false;
}

void OAICreateApplication_request_imageConfiguration::fromJson(QString jsonString) {
...
void OAICreateApplication_request_imageConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateApplication_request_imageConfiguration::asJson() const {
...
QJsonObject OAICreateApplication_request_imageConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateApplication_request_imageConfiguration::getImageUri() const {
    return m_image_uri;
}
void OAICreateApplication_request_imageConfiguration::setImageUri(const QString &image_uri) {
    m_image_uri = image_uri;
    m_image_uri_isSet = true;
}

bool OAICreateApplication_request_imageConfiguration::is_image_uri_Set() const{
    return m_image_uri_isSet;
}

bool OAICreateApplication_request_imageConfiguration::is_image_uri_Valid() const{
    return m_image_uri_isValid;
}

bool OAICreateApplication_request_imageConfiguration::isSet() const {
...
bool OAICreateApplication_request_imageConfiguration::isValid() const {
