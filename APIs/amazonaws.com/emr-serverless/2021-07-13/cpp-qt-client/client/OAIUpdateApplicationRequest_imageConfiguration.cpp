...
OAIUpdateApplicationRequest_imageConfiguration::OAIUpdateApplicationRequest_imageConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateApplicationRequest_imageConfiguration::OAIUpdateApplicationRequest_imageConfiguration() {
    this->initializeModel();
}

OAIUpdateApplicationRequest_imageConfiguration::~OAIUpdateApplicationRequest_imageConfiguration() {}

void OAIUpdateApplicationRequest_imageConfiguration::initializeModel() {

    m_image_uri_isSet = false;
    m_image_uri_isValid = false;
}

void OAIUpdateApplicationRequest_imageConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateApplicationRequest_imageConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateApplicationRequest_imageConfiguration::asJson() const {
...
QJsonObject OAIUpdateApplicationRequest_imageConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateApplicationRequest_imageConfiguration::getImageUri() const {
    return m_image_uri;
}
void OAIUpdateApplicationRequest_imageConfiguration::setImageUri(const QString &image_uri) {
    m_image_uri = image_uri;
    m_image_uri_isSet = true;
}

bool OAIUpdateApplicationRequest_imageConfiguration::is_image_uri_Set() const{
    return m_image_uri_isSet;
}

bool OAIUpdateApplicationRequest_imageConfiguration::is_image_uri_Valid() const{
    return m_image_uri_isValid;
}

bool OAIUpdateApplicationRequest_imageConfiguration::isSet() const {
...
bool OAIUpdateApplicationRequest_imageConfiguration::isValid() const {
