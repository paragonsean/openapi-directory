...
/*
 * OAICreateApplicationRequest_networkConfiguration.h
 *
 * 
 */

#ifndef OAICreateApplicationRequest_networkConfiguration_H
#define OAICreateApplicationRequest_networkConfiguration_H
...
class OAICreateApplicationRequest_networkConfiguration : public OAIObject {
public:
    OAICreateApplicationRequest_networkConfiguration();
    OAICreateApplicationRequest_networkConfiguration(QString json);
    ~OAICreateApplicationRequest_networkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplicationRequest_networkConfiguration)

#endif // OAICreateApplicationRequest_networkConfiguration_H
