...
OAIApplication_maximumCapacity::OAIApplication_maximumCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplication_maximumCapacity::OAIApplication_maximumCapacity() {
    this->initializeModel();
}

OAIApplication_maximumCapacity::~OAIApplication_maximumCapacity() {}

void OAIApplication_maximumCapacity::initializeModel() {
...
void OAIApplication_maximumCapacity::fromJson(QString jsonString) {
...
void OAIApplication_maximumCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIApplication_maximumCapacity::asJson() const {
...
QJsonObject OAIApplication_maximumCapacity::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu_isSet) {
...
QString OAIApplication_maximumCapacity::getCpu() const {
    return m_cpu;
}
void OAIApplication_maximumCapacity::setCpu(const QString &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIApplication_maximumCapacity::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIApplication_maximumCapacity::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QString OAIApplication_maximumCapacity::getMemory() const {
    return m_memory;
}
void OAIApplication_maximumCapacity::setMemory(const QString &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIApplication_maximumCapacity::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIApplication_maximumCapacity::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAIApplication_maximumCapacity::getDisk() const {
    return m_disk;
}
void OAIApplication_maximumCapacity::setDisk(const QString &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAIApplication_maximumCapacity::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAIApplication_maximumCapacity::is_disk_Valid() const{
    return m_disk_isValid;
}

bool OAIApplication_maximumCapacity::isSet() const {
...
bool OAIApplication_maximumCapacity::isValid() const {
