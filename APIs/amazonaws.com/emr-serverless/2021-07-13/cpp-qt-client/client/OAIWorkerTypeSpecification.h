...
/*
 * OAIWorkerTypeSpecification.h
 *
 * The specifications for a worker type.
 */

#ifndef OAIWorkerTypeSpecification_H
#define OAIWorkerTypeSpecification_H
...
namespace OpenAPI {
class OAIWorkerTypeSpecification_imageConfiguration;

class OAIWorkerTypeSpecification : public OAIObject {
public:
    OAIWorkerTypeSpecification();
    OAIWorkerTypeSpecification(QString json);
    ~OAIWorkerTypeSpecification() override;
    ...
    OAIWorkerTypeSpecification_imageConfiguration getImageConfiguration() const;
    void setImageConfiguration(const OAIWorkerTypeSpecification_imageConfiguration &image_configuration);
...
private:
    ...
    OAIWorkerTypeSpecification_imageConfiguration m_image_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkerTypeSpecification)

#endif // OAIWorkerTypeSpecification_H
