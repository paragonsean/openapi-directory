...
/*
 * OAIS3MonitoringConfiguration.h
 *
...
#ifndef OAIS3MonitoringConfiguration_H
#define OAIS3MonitoringConfiguration_H
...
class OAIS3MonitoringConfiguration : public OAIObject {
public:
    OAIS3MonitoringConfiguration();
    OAIS3MonitoringConfiguration(QString json);
    ~OAIS3MonitoringConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3MonitoringConfiguration)

#endif // OAIS3MonitoringConfiguration_H
