...
/*
 * OAIGetDashboardForJobRunResponse.h
 *
 * 
 */

#ifndef OAIGetDashboardForJobRunResponse_H
#define OAIGetDashboardForJobRunResponse_H
...
class OAIGetDashboardForJobRunResponse : public OAIObject {
public:
    OAIGetDashboardForJobRunResponse();
    OAIGetDashboardForJobRunResponse(QString json);
    ~OAIGetDashboardForJobRunResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDashboardForJobRunResponse)

#endif // OAIGetDashboardForJobRunResponse_H
