...
#include "OAICloudWatchLoggingConfiguration.h"
...
OAICloudWatchLoggingConfiguration::OAICloudWatchLoggingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICloudWatchLoggingConfiguration::OAICloudWatchLoggingConfiguration() {
    this->initializeModel();
}

OAICloudWatchLoggingConfiguration::~OAICloudWatchLoggingConfiguration() {}

void OAICloudWatchLoggingConfiguration::initializeModel() {
...
void OAICloudWatchLoggingConfiguration::fromJson(QString jsonString) {
...
void OAICloudWatchLoggingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICloudWatchLoggingConfiguration::asJson() const {
...
QJsonObject OAICloudWatchLoggingConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAICloudWatchLoggingConfiguration::getEnabled() const {
    return m_enabled;
}
void OAICloudWatchLoggingConfiguration::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAICloudWatchLoggingConfiguration::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAICloudWatchLoggingConfiguration::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAICloudWatchLoggingConfiguration::getLogGroupName() const {
    return m_log_group_name;
}
void OAICloudWatchLoggingConfiguration::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAICloudWatchLoggingConfiguration::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAICloudWatchLoggingConfiguration::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

QString OAICloudWatchLoggingConfiguration::getLogStreamNamePrefix() const {
    return m_log_stream_name_prefix;
}
void OAICloudWatchLoggingConfiguration::setLogStreamNamePrefix(const QString &log_stream_name_prefix) {
    m_log_stream_name_prefix = log_stream_name_prefix;
    m_log_stream_name_prefix_isSet = true;
}

bool OAICloudWatchLoggingConfiguration::is_log_stream_name_prefix_Set() const{
    return m_log_stream_name_prefix_isSet;
}

bool OAICloudWatchLoggingConfiguration::is_log_stream_name_prefix_Valid() const{
    return m_log_stream_name_prefix_isValid;
}

QString OAICloudWatchLoggingConfiguration::getEncryptionKeyArn() const {
    return m_encryption_key_arn;
}
void OAICloudWatchLoggingConfiguration::setEncryptionKeyArn(const QString &encryption_key_arn) {
    m_encryption_key_arn = encryption_key_arn;
    m_encryption_key_arn_isSet = true;
}

bool OAICloudWatchLoggingConfiguration::is_encryption_key_arn_Set() const{
    return m_encryption_key_arn_isSet;
}

bool OAICloudWatchLoggingConfiguration::is_encryption_key_arn_Valid() const{
    return m_encryption_key_arn_isValid;
}

QMap OAICloudWatchLoggingConfiguration::getLogTypes() const {
    return m_log_types;
}
void OAICloudWatchLoggingConfiguration::setLogTypes(const QMap &log_types) {
    m_log_types = log_types;
    m_log_types_isSet = true;
}

bool OAICloudWatchLoggingConfiguration::is_log_types_Set() const{
    return m_log_types_isSet;
}

bool OAICloudWatchLoggingConfiguration::is_log_types_Valid() const{
    return m_log_types_isValid;
}

bool OAICloudWatchLoggingConfiguration::isSet() const {
...
bool OAICloudWatchLoggingConfiguration::isValid() const {
