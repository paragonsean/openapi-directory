...
/*
 * OAICreateApplication_request_networkConfiguration.h
 *
 * The network configuration for customer VPC connectivity.
 */

#ifndef OAICreateApplication_request_networkConfiguration_H
#define OAICreateApplication_request_networkConfiguration_H
...
class OAICreateApplication_request_networkConfiguration : public OAIObject {
public:
    OAICreateApplication_request_networkConfiguration();
    OAICreateApplication_request_networkConfiguration(QString json);
    ~OAICreateApplication_request_networkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplication_request_networkConfiguration)

#endif // OAICreateApplication_request_networkConfiguration_H
