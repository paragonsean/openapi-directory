...
QString OAIApplication::getReleaseLabel() const {
    return m_release_label;
}
void OAIApplication::setReleaseLabel(const QString &release_label) {
    m_release_label = release_label;
    m_release_label_isSet = true;
}

bool OAIApplication::is_release_label_Set() const{
    return m_release_label_isSet;
}

bool OAIApplication::is_release_label_Valid() const{
...
OAIApplicationState OAIApplication::getState() const {
    return m_state;
}
void OAIApplication::setState(const OAIApplicationState &state) {
    m_state = state;
    m_state_isSet = true;
}
...
QString OAIApplication::getStateDetails() const {
    return m_state_details;
}
void OAIApplication::setStateDetails(const QString &state_details) {
    m_state_details = state_details;
    m_state_details_isSet = true;
}

bool OAIApplication::is_state_details_Set() const{
    return m_state_details_isSet;
}

bool OAIApplication::is_state_details_Valid() const{
    return m_state_details_isValid;
}

QMap OAIApplication::getInitialCapacity() const {
    return m_initial_capacity;
}
void OAIApplication::setInitialCapacity(const QMap &initial_capacity) {
    m_initial_capacity = initial_capacity;
    m_initial_capacity_isSet = true;
}

bool OAIApplication::is_initial_capacity_Set() const{
    return m_initial_capacity_isSet;
}

bool OAIApplication::is_initial_capacity_Valid() const{
    return m_initial_capacity_isValid;
}

OAIApplication_maximumCapacity OAIApplication::getMaximumCapacity() const {
    return m_maximum_capacity;
}
void OAIApplication::setMaximumCapacity(const OAIApplication_maximumCapacity &maximum_capacity) {
    m_maximum_capacity = maximum_capacity;
    m_maximum_capacity_isSet = true;
}

bool OAIApplication::is_maximum_capacity_Set() const{
    return m_maximum_capacity_isSet;
}

bool OAIApplication::is_maximum_capacity_Valid() const{
...
OAIApplication_autoStartConfiguration OAIApplication::getAutoStartConfiguration() const {
    return m_auto_start_configuration;
}
void OAIApplication::setAutoStartConfiguration(const OAIApplication_autoStartConfiguration &auto_start_configuration) {
    m_auto_start_configuration = auto_start_configuration;
    m_auto_start_configuration_isSet = true;
}

bool OAIApplication::is_auto_start_configuration_Set() const{
    return m_auto_start_configuration_isSet;
}

bool OAIApplication::is_auto_start_configuration_Valid() const{
    return m_auto_start_configuration_isValid;
}

OAIApplication_autoStopConfiguration OAIApplication::getAutoStopConfiguration() const {
    return m_auto_stop_configuration;
}
void OAIApplication::setAutoStopConfiguration(const OAIApplication_autoStopConfiguration &auto_stop_configuration) {
    m_auto_stop_configuration = auto_stop_configuration;
    m_auto_stop_configuration_isSet = true;
}

bool OAIApplication::is_auto_stop_configuration_Set() const{
    return m_auto_stop_configuration_isSet;
}

bool OAIApplication::is_auto_stop_configuration_Valid() const{
    return m_auto_stop_configuration_isValid;
}

OAIApplication_networkConfiguration OAIApplication::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAIApplication::setNetworkConfiguration(const OAIApplication_networkConfiguration &network_configuration) {
    m_network_configuration = network_configuration;
    m_network_configuration_isSet = true;
}

bool OAIApplication::is_network_configuration_Set() const{
    return m_network_configuration_isSet;
}

bool OAIApplication::is_network_configuration_Valid() const{
    return m_network_configuration_isValid;
}

OAIArchitecture OAIApplication::getArchitecture() const {
    return m_architecture;
}
void OAIApplication::setArchitecture(const OAIArchitecture &architecture) {
    m_architecture = architecture;
    m_architecture_isSet = true;
}

bool OAIApplication::is_architecture_Set() const{
    return m_architecture_isSet;
}

bool OAIApplication::is_architecture_Valid() const{
    return m_architecture_isValid;
}

OAIApplication_imageConfiguration OAIApplication::getImageConfiguration() const {
    return m_image_configuration;
}
void OAIApplication::setImageConfiguration(const OAIApplication_imageConfiguration &image_configuration) {
    m_image_configuration = image_configuration;
    m_image_configuration_isSet = true;
}

bool OAIApplication::is_image_configuration_Set() const{
    return m_image_configuration_isSet;
}

bool OAIApplication::is_image_configuration_Valid() const{
    return m_image_configuration_isValid;
}

QMap OAIApplication::getWorkerTypeSpecifications() const {
    return m_worker_type_specifications;
}
void OAIApplication::setWorkerTypeSpecifications(const QMap &worker_type_specifications) {
    m_worker_type_specifications = worker_type_specifications;
    m_worker_type_specifications_isSet = true;
}

bool OAIApplication::is_worker_type_specifications_Set() const{
    return m_worker_type_specifications_isSet;
}

bool OAIApplication::is_worker_type_specifications_Valid() const{
