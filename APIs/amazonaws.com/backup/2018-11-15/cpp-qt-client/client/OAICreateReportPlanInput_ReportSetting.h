...
/*
 * OAICreateReportPlanInput_ReportSetting.h
 *
 * 
 */

#ifndef OAICreateReportPlanInput_ReportSetting_H
#define OAICreateReportPlanInput_ReportSetting_H
...
class OAICreateReportPlanInput_ReportSetting : public OAIObject {
public:
    OAICreateReportPlanInput_ReportSetting();
    OAICreateReportPlanInput_ReportSetting(QString json);
    ~OAICreateReportPlanInput_ReportSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateReportPlanInput_ReportSetting)

#endif // OAICreateReportPlanInput_ReportSetting_H
