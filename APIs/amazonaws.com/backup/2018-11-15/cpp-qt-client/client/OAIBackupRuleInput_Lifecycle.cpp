...
OAIBackupRuleInput_Lifecycle::OAIBackupRuleInput_Lifecycle(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackupRuleInput_Lifecycle::OAIBackupRuleInput_Lifecycle() {
    this->initializeModel();
}

OAIBackupRuleInput_Lifecycle::~OAIBackupRuleInput_Lifecycle() {}

void OAIBackupRuleInput_Lifecycle::initializeModel() {
...
void OAIBackupRuleInput_Lifecycle::fromJson(QString jsonString) {
...
void OAIBackupRuleInput_Lifecycle::fromJsonObject(QJsonObject json) {
...
QString OAIBackupRuleInput_Lifecycle::asJson() const {
...
QJsonObject OAIBackupRuleInput_Lifecycle::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIBackupRuleInput_Lifecycle::getMoveToColdStorageAfterDays() const {
    return m_move_to_cold_storage_after_days;
}
void OAIBackupRuleInput_Lifecycle::setMoveToColdStorageAfterDays(const qint32 &move_to_cold_storage_after_days) {
    m_move_to_cold_storage_after_days = move_to_cold_storage_after_days;
    m_move_to_cold_storage_after_days_isSet = true;
}

bool OAIBackupRuleInput_Lifecycle::is_move_to_cold_storage_after_days_Set() const{
    return m_move_to_cold_storage_after_days_isSet;
}

bool OAIBackupRuleInput_Lifecycle::is_move_to_cold_storage_after_days_Valid() const{
    return m_move_to_cold_storage_after_days_isValid;
}

qint32 OAIBackupRuleInput_Lifecycle::getDeleteAfterDays() const {
    return m_delete_after_days;
}
void OAIBackupRuleInput_Lifecycle::setDeleteAfterDays(const qint32 &delete_after_days) {
    m_delete_after_days = delete_after_days;
    m_delete_after_days_isSet = true;
}

bool OAIBackupRuleInput_Lifecycle::is_delete_after_days_Set() const{
    return m_delete_after_days_isSet;
}

bool OAIBackupRuleInput_Lifecycle::is_delete_after_days_Valid() const{
    return m_delete_after_days_isValid;
}

bool OAIBackupRuleInput_Lifecycle::isSet() const {
...
bool OAIBackupRuleInput_Lifecycle::isValid() const {
