...
/*
 * OAIGetBackupSelectionOutput_BackupSelection.h
 *
 * 
 */

#ifndef OAIGetBackupSelectionOutput_BackupSelection_H
#define OAIGetBackupSelectionOutput_BackupSelection_H
...
class OAIGetBackupSelectionOutput_BackupSelection : public OAIObject {
public:
    OAIGetBackupSelectionOutput_BackupSelection();
    OAIGetBackupSelectionOutput_BackupSelection(QString json);
    ~OAIGetBackupSelectionOutput_BackupSelection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBackupSelectionOutput_BackupSelection)

#endif // OAIGetBackupSelectionOutput_BackupSelection_H
