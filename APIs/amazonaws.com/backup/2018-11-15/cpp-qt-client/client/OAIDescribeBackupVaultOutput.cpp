...
OAIDescribeBackupVaultOutput::OAIDescribeBackupVaultOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBackupVaultOutput::OAIDescribeBackupVaultOutput() {
    this->initializeModel();
}

OAIDescribeBackupVaultOutput::~OAIDescribeBackupVaultOutput() {}

void OAIDescribeBackupVaultOutput::initializeModel() {
...
void OAIDescribeBackupVaultOutput::fromJson(QString jsonString) {
...
void OAIDescribeBackupVaultOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBackupVaultOutput::asJson() const {
...
QJsonObject OAIDescribeBackupVaultOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBackupVaultOutput::getBackupVaultName() const {
    return m_backup_vault_name;
}
void OAIDescribeBackupVaultOutput::setBackupVaultName(const QString &backup_vault_name) {
    m_backup_vault_name = backup_vault_name;
    m_backup_vault_name_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_backup_vault_name_Set() const{
    return m_backup_vault_name_isSet;
}

bool OAIDescribeBackupVaultOutput::is_backup_vault_name_Valid() const{
    return m_backup_vault_name_isValid;
}

QString OAIDescribeBackupVaultOutput::getBackupVaultArn() const {
    return m_backup_vault_arn;
}
void OAIDescribeBackupVaultOutput::setBackupVaultArn(const QString &backup_vault_arn) {
    m_backup_vault_arn = backup_vault_arn;
    m_backup_vault_arn_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_backup_vault_arn_Set() const{
    return m_backup_vault_arn_isSet;
}

bool OAIDescribeBackupVaultOutput::is_backup_vault_arn_Valid() const{
    return m_backup_vault_arn_isValid;
}

QString OAIDescribeBackupVaultOutput::getEncryptionKeyArn() const {
    return m_encryption_key_arn;
}
void OAIDescribeBackupVaultOutput::setEncryptionKeyArn(const QString &encryption_key_arn) {
    m_encryption_key_arn = encryption_key_arn;
    m_encryption_key_arn_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_encryption_key_arn_Set() const{
    return m_encryption_key_arn_isSet;
}

bool OAIDescribeBackupVaultOutput::is_encryption_key_arn_Valid() const{
    return m_encryption_key_arn_isValid;
}

QDateTime OAIDescribeBackupVaultOutput::getCreationDate() const {
    return m_creation_date;
}
void OAIDescribeBackupVaultOutput::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIDescribeBackupVaultOutput::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIDescribeBackupVaultOutput::getCreatorRequestId() const {
    return m_creator_request_id;
}
void OAIDescribeBackupVaultOutput::setCreatorRequestId(const QString &creator_request_id) {
    m_creator_request_id = creator_request_id;
    m_creator_request_id_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_creator_request_id_Set() const{
    return m_creator_request_id_isSet;
}

bool OAIDescribeBackupVaultOutput::is_creator_request_id_Valid() const{
    return m_creator_request_id_isValid;
}

qint32 OAIDescribeBackupVaultOutput::getNumberOfRecoveryPoints() const {
    return m_number_of_recovery_points;
}
void OAIDescribeBackupVaultOutput::setNumberOfRecoveryPoints(const qint32 &number_of_recovery_points) {
    m_number_of_recovery_points = number_of_recovery_points;
    m_number_of_recovery_points_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_number_of_recovery_points_Set() const{
    return m_number_of_recovery_points_isSet;
}

bool OAIDescribeBackupVaultOutput::is_number_of_recovery_points_Valid() const{
    return m_number_of_recovery_points_isValid;
}

bool OAIDescribeBackupVaultOutput::getLocked() const {
    return m_locked;
}
void OAIDescribeBackupVaultOutput::setLocked(const bool &locked) {
    m_locked = locked;
    m_locked_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_locked_Set() const{
    return m_locked_isSet;
}

bool OAIDescribeBackupVaultOutput::is_locked_Valid() const{
    return m_locked_isValid;
}

qint32 OAIDescribeBackupVaultOutput::getMinRetentionDays() const {
    return m_min_retention_days;
}
void OAIDescribeBackupVaultOutput::setMinRetentionDays(const qint32 &min_retention_days) {
    m_min_retention_days = min_retention_days;
    m_min_retention_days_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_min_retention_days_Set() const{
    return m_min_retention_days_isSet;
}

bool OAIDescribeBackupVaultOutput::is_min_retention_days_Valid() const{
    return m_min_retention_days_isValid;
}

qint32 OAIDescribeBackupVaultOutput::getMaxRetentionDays() const {
    return m_max_retention_days;
}
void OAIDescribeBackupVaultOutput::setMaxRetentionDays(const qint32 &max_retention_days) {
    m_max_retention_days = max_retention_days;
    m_max_retention_days_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_max_retention_days_Set() const{
    return m_max_retention_days_isSet;
}

bool OAIDescribeBackupVaultOutput::is_max_retention_days_Valid() const{
    return m_max_retention_days_isValid;
}

QDateTime OAIDescribeBackupVaultOutput::getLockDate() const {
    return m_lock_date;
}
void OAIDescribeBackupVaultOutput::setLockDate(const QDateTime &lock_date) {
    m_lock_date = lock_date;
    m_lock_date_isSet = true;
}

bool OAIDescribeBackupVaultOutput::is_lock_date_Set() const{
    return m_lock_date_isSet;
}

bool OAIDescribeBackupVaultOutput::is_lock_date_Valid() const{
    return m_lock_date_isValid;
}

bool OAIDescribeBackupVaultOutput::isSet() const {
...
bool OAIDescribeBackupVaultOutput::isValid() const {
