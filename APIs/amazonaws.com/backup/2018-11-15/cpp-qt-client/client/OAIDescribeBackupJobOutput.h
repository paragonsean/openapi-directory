...
/*
 * OAIDescribeBackupJobOutput.h
 *
 * 
 */

#ifndef OAIDescribeBackupJobOutput_H
#define OAIDescribeBackupJobOutput_H

#include <QJsonObject>

#include "OAIBackupJobState.h"
#include "OAIDescribeBackupJobOutput_CreatedBy.h"
#include <QDateTime>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIDescribeBackupJobOutput_CreatedBy;

class OAIDescribeBackupJobOutput : public OAIObject {
public:
    OAIDescribeBackupJobOutput();
    OAIDescribeBackupJobOutput(QString json);
    ~OAIDescribeBackupJobOutput() override;
    ...
    OAIDescribeBackupJobOutput_CreatedBy getCreatedBy() const;
    void setCreatedBy(const OAIDescribeBackupJobOutput_CreatedBy &created_by);
...
private:
    ...
    OAIDescribeBackupJobOutput_CreatedBy m_created_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBackupJobOutput)

#endif // OAIDescribeBackupJobOutput_H
