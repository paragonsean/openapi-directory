...
/*
 * OAIStartBackupJobInput.h
 *
 * 
 */

#ifndef OAIStartBackupJobInput_H
#define OAIStartBackupJobInput_H

#include <QJsonObject>

#include "OAIStartBackupJobInput_Lifecycle.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIStartBackupJobInput_Lifecycle;

class OAIStartBackupJobInput : public OAIObject {
public:
    OAIStartBackupJobInput();
    OAIStartBackupJobInput(QString json);
    ~OAIStartBackupJobInput() override;
    ...
    OAIStartBackupJobInput_Lifecycle getLifecycle() const;
    void setLifecycle(const OAIStartBackupJobInput_Lifecycle &lifecycle);
...
private:
    ...
    OAIStartBackupJobInput_Lifecycle m_lifecycle;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartBackupJobInput)

#endif // OAIStartBackupJobInput_H
