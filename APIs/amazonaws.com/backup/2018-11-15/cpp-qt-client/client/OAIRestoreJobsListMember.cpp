...
#include "OAIRestoreJobsListMember.h"
...
OAIRestoreJobsListMember::OAIRestoreJobsListMember(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreJobsListMember::OAIRestoreJobsListMember() {
    this->initializeModel();
}

OAIRestoreJobsListMember::~OAIRestoreJobsListMember() {}

void OAIRestoreJobsListMember::initializeModel() {
...
void OAIRestoreJobsListMember::fromJson(QString jsonString) {
...
void OAIRestoreJobsListMember::fromJsonObject(QJsonObject json) {
...
QString OAIRestoreJobsListMember::asJson() const {
...
QJsonObject OAIRestoreJobsListMember::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRestoreJobsListMember::getAccountId() const {
    return m_account_id;
}
void OAIRestoreJobsListMember::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIRestoreJobsListMember::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIRestoreJobsListMember::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIRestoreJobsListMember::getRestoreJobId() const {
    return m_restore_job_id;
}
void OAIRestoreJobsListMember::setRestoreJobId(const QString &restore_job_id) {
    m_restore_job_id = restore_job_id;
    m_restore_job_id_isSet = true;
}

bool OAIRestoreJobsListMember::is_restore_job_id_Set() const{
    return m_restore_job_id_isSet;
}

bool OAIRestoreJobsListMember::is_restore_job_id_Valid() const{
    return m_restore_job_id_isValid;
}

QString OAIRestoreJobsListMember::getRecoveryPointArn() const {
    return m_recovery_point_arn;
}
void OAIRestoreJobsListMember::setRecoveryPointArn(const QString &recovery_point_arn) {
    m_recovery_point_arn = recovery_point_arn;
    m_recovery_point_arn_isSet = true;
}

bool OAIRestoreJobsListMember::is_recovery_point_arn_Set() const{
    return m_recovery_point_arn_isSet;
}

bool OAIRestoreJobsListMember::is_recovery_point_arn_Valid() const{
    return m_recovery_point_arn_isValid;
}

QDateTime OAIRestoreJobsListMember::getCreationDate() const {
    return m_creation_date;
}
void OAIRestoreJobsListMember::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIRestoreJobsListMember::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIRestoreJobsListMember::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAIRestoreJobsListMember::getCompletionDate() const {
    return m_completion_date;
}
void OAIRestoreJobsListMember::setCompletionDate(const QDateTime &completion_date) {
    m_completion_date = completion_date;
    m_completion_date_isSet = true;
}

bool OAIRestoreJobsListMember::is_completion_date_Set() const{
    return m_completion_date_isSet;
}

bool OAIRestoreJobsListMember::is_completion_date_Valid() const{
    return m_completion_date_isValid;
}

OAIRestoreJobStatus OAIRestoreJobsListMember::getStatus() const {
    return m_status;
}
void OAIRestoreJobsListMember::setStatus(const OAIRestoreJobStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRestoreJobsListMember::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRestoreJobsListMember::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIRestoreJobsListMember::getStatusMessage() const {
    return m_status_message;
}
void OAIRestoreJobsListMember::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIRestoreJobsListMember::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIRestoreJobsListMember::is_status_message_Valid() const{
    return m_status_message_isValid;
}

QString OAIRestoreJobsListMember::getPercentDone() const {
    return m_percent_done;
}
void OAIRestoreJobsListMember::setPercentDone(const QString &percent_done) {
    m_percent_done = percent_done;
    m_percent_done_isSet = true;
}

bool OAIRestoreJobsListMember::is_percent_done_Set() const{
    return m_percent_done_isSet;
}

bool OAIRestoreJobsListMember::is_percent_done_Valid() const{
    return m_percent_done_isValid;
}

qint32 OAIRestoreJobsListMember::getBackupSizeInBytes() const {
    return m_backup_size_in_bytes;
}
void OAIRestoreJobsListMember::setBackupSizeInBytes(const qint32 &backup_size_in_bytes) {
    m_backup_size_in_bytes = backup_size_in_bytes;
    m_backup_size_in_bytes_isSet = true;
}

bool OAIRestoreJobsListMember::is_backup_size_in_bytes_Set() const{
    return m_backup_size_in_bytes_isSet;
}

bool OAIRestoreJobsListMember::is_backup_size_in_bytes_Valid() const{
    return m_backup_size_in_bytes_isValid;
}

QString OAIRestoreJobsListMember::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAIRestoreJobsListMember::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAIRestoreJobsListMember::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAIRestoreJobsListMember::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

qint32 OAIRestoreJobsListMember::getExpectedCompletionTimeMinutes() const {
    return m_expected_completion_time_minutes;
}
void OAIRestoreJobsListMember::setExpectedCompletionTimeMinutes(const qint32 &expected_completion_time_minutes) {
    m_expected_completion_time_minutes = expected_completion_time_minutes;
    m_expected_completion_time_minutes_isSet = true;
}

bool OAIRestoreJobsListMember::is_expected_completion_time_minutes_Set() const{
    return m_expected_completion_time_minutes_isSet;
}

bool OAIRestoreJobsListMember::is_expected_completion_time_minutes_Valid() const{
    return m_expected_completion_time_minutes_isValid;
}

QString OAIRestoreJobsListMember::getCreatedResourceArn() const {
    return m_created_resource_arn;
}
void OAIRestoreJobsListMember::setCreatedResourceArn(const QString &created_resource_arn) {
    m_created_resource_arn = created_resource_arn;
    m_created_resource_arn_isSet = true;
}

bool OAIRestoreJobsListMember::is_created_resource_arn_Set() const{
    return m_created_resource_arn_isSet;
}

bool OAIRestoreJobsListMember::is_created_resource_arn_Valid() const{
    return m_created_resource_arn_isValid;
}

QString OAIRestoreJobsListMember::getResourceType() const {
    return m_resource_type;
}
void OAIRestoreJobsListMember::setResourceType(const QString &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAIRestoreJobsListMember::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAIRestoreJobsListMember::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

bool OAIRestoreJobsListMember::isSet() const {
...
bool OAIRestoreJobsListMember::isValid() const {
