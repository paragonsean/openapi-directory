...
#ifndef OAIReportSetting_H
#define OAIReportSetting_H
...
class OAIReportSetting : public OAIObject {
public:
    OAIReportSetting();
    OAIReportSetting(QString json);
    ~OAIReportSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportSetting)

#endif // OAIReportSetting_H
