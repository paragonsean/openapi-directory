...
/*
 * OAIStartBackupJobInput_Lifecycle.h
 *
 * 
 */

#ifndef OAIStartBackupJobInput_Lifecycle_H
#define OAIStartBackupJobInput_Lifecycle_H
...
class OAIStartBackupJobInput_Lifecycle : public OAIObject {
public:
    OAIStartBackupJobInput_Lifecycle();
    OAIStartBackupJobInput_Lifecycle(QString json);
    ~OAIStartBackupJobInput_Lifecycle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartBackupJobInput_Lifecycle)

#endif // OAIStartBackupJobInput_Lifecycle_H
