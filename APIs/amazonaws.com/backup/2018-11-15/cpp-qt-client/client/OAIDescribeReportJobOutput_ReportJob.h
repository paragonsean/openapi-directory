...
/*
 * OAIDescribeReportJobOutput_ReportJob.h
 *
 * 
 */

#ifndef OAIDescribeReportJobOutput_ReportJob_H
#define OAIDescribeReportJobOutput_ReportJob_H
...
class OAIDescribeReportJobOutput_ReportJob : public OAIObject {
public:
    OAIDescribeReportJobOutput_ReportJob();
    OAIDescribeReportJobOutput_ReportJob(QString json);
    ~OAIDescribeReportJobOutput_ReportJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeReportJobOutput_ReportJob)

#endif // OAIDescribeReportJobOutput_ReportJob_H
