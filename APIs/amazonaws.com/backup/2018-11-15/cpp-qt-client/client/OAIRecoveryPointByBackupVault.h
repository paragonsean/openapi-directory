...
/*
 * OAIRecoveryPointByBackupVault.h
 *
 * Contains detailed information about the recovery points stored in a backup vault.
 */

#ifndef OAIRecoveryPointByBackupVault_H
#define OAIRecoveryPointByBackupVault_H
...
namespace OpenAPI {
class OAIRecoveryPointByBackupVault_CreatedBy;
class OAIDescribeRecoveryPointOutput_CalculatedLifecycle;
class OAIBackupRule_Lifecycle;

class OAIRecoveryPointByBackupVault : public OAIObject {
public:
    OAIRecoveryPointByBackupVault();
    OAIRecoveryPointByBackupVault(QString json);
    ~OAIRecoveryPointByBackupVault() override;
    ...
    OAIRecoveryPointByBackupVault_CreatedBy getCreatedBy() const;
    void setCreatedBy(const OAIRecoveryPointByBackupVault_CreatedBy &created_by);
...
private:
    ...
    OAIRecoveryPointByBackupVault_CreatedBy m_created_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecoveryPointByBackupVault)

#endif // OAIRecoveryPointByBackupVault_H
