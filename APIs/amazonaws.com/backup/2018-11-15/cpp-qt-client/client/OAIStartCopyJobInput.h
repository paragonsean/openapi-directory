...
/*
 * OAIStartCopyJobInput.h
 *
 * 
 */

#ifndef OAIStartCopyJobInput_H
#define OAIStartCopyJobInput_H
...
class OAIStartCopyJobInput : public OAIObject {
public:
    OAIStartCopyJobInput();
    OAIStartCopyJobInput(QString json);
    ~OAIStartCopyJobInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartCopyJobInput)

#endif // OAIStartCopyJobInput_H
