...
/*
 * OAIBackupRule_Lifecycle.h
 *
 * 
 */

#ifndef OAIBackupRule_Lifecycle_H
#define OAIBackupRule_Lifecycle_H
...
class OAIBackupRule_Lifecycle : public OAIObject {
public:
    OAIBackupRule_Lifecycle();
    OAIBackupRule_Lifecycle(QString json);
    ~OAIBackupRule_Lifecycle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackupRule_Lifecycle)

#endif // OAIBackupRule_Lifecycle_H
