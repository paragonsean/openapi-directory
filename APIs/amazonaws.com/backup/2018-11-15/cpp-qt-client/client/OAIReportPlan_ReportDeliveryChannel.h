...
/*
 * OAIReportPlan_ReportDeliveryChannel.h
 *
 * 
 */

#ifndef OAIReportPlan_ReportDeliveryChannel_H
#define OAIReportPlan_ReportDeliveryChannel_H
...
class OAIReportPlan_ReportDeliveryChannel : public OAIObject {
public:
    OAIReportPlan_ReportDeliveryChannel();
    OAIReportPlan_ReportDeliveryChannel(QString json);
    ~OAIReportPlan_ReportDeliveryChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportPlan_ReportDeliveryChannel)

#endif // OAIReportPlan_ReportDeliveryChannel_H
