...
OAIStartBackupJobInput_Lifecycle::OAIStartBackupJobInput_Lifecycle(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartBackupJobInput_Lifecycle::OAIStartBackupJobInput_Lifecycle() {
    this->initializeModel();
}

OAIStartBackupJobInput_Lifecycle::~OAIStartBackupJobInput_Lifecycle() {}

void OAIStartBackupJobInput_Lifecycle::initializeModel() {
...
void OAIStartBackupJobInput_Lifecycle::fromJson(QString jsonString) {
...
void OAIStartBackupJobInput_Lifecycle::fromJsonObject(QJsonObject json) {
...
QString OAIStartBackupJobInput_Lifecycle::asJson() const {
...
QJsonObject OAIStartBackupJobInput_Lifecycle::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIStartBackupJobInput_Lifecycle::getMoveToColdStorageAfterDays() const {
    return m_move_to_cold_storage_after_days;
}
void OAIStartBackupJobInput_Lifecycle::setMoveToColdStorageAfterDays(const qint32 &move_to_cold_storage_after_days) {
    m_move_to_cold_storage_after_days = move_to_cold_storage_after_days;
    m_move_to_cold_storage_after_days_isSet = true;
}

bool OAIStartBackupJobInput_Lifecycle::is_move_to_cold_storage_after_days_Set() const{
    return m_move_to_cold_storage_after_days_isSet;
}

bool OAIStartBackupJobInput_Lifecycle::is_move_to_cold_storage_after_days_Valid() const{
    return m_move_to_cold_storage_after_days_isValid;
}

qint32 OAIStartBackupJobInput_Lifecycle::getDeleteAfterDays() const {
    return m_delete_after_days;
}
void OAIStartBackupJobInput_Lifecycle::setDeleteAfterDays(const qint32 &delete_after_days) {
    m_delete_after_days = delete_after_days;
    m_delete_after_days_isSet = true;
}

bool OAIStartBackupJobInput_Lifecycle::is_delete_after_days_Set() const{
    return m_delete_after_days_isSet;
}

bool OAIStartBackupJobInput_Lifecycle::is_delete_after_days_Valid() const{
    return m_delete_after_days_isValid;
}

bool OAIStartBackupJobInput_Lifecycle::isSet() const {
...
bool OAIStartBackupJobInput_Lifecycle::isValid() const {
