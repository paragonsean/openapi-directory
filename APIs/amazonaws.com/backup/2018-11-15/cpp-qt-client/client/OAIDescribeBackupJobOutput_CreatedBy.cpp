...
OAIDescribeBackupJobOutput_CreatedBy::OAIDescribeBackupJobOutput_CreatedBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBackupJobOutput_CreatedBy::OAIDescribeBackupJobOutput_CreatedBy() {
    this->initializeModel();
}

OAIDescribeBackupJobOutput_CreatedBy::~OAIDescribeBackupJobOutput_CreatedBy() {}

void OAIDescribeBackupJobOutput_CreatedBy::initializeModel() {
...
void OAIDescribeBackupJobOutput_CreatedBy::fromJson(QString jsonString) {
...
void OAIDescribeBackupJobOutput_CreatedBy::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBackupJobOutput_CreatedBy::asJson() const {
...
QJsonObject OAIDescribeBackupJobOutput_CreatedBy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBackupJobOutput_CreatedBy::getBackupPlanId() const {
    return m_backup_plan_id;
}
void OAIDescribeBackupJobOutput_CreatedBy::setBackupPlanId(const QString &backup_plan_id) {
    m_backup_plan_id = backup_plan_id;
    m_backup_plan_id_isSet = true;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_plan_id_Set() const{
    return m_backup_plan_id_isSet;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_plan_id_Valid() const{
    return m_backup_plan_id_isValid;
}

QString OAIDescribeBackupJobOutput_CreatedBy::getBackupPlanArn() const {
    return m_backup_plan_arn;
}
void OAIDescribeBackupJobOutput_CreatedBy::setBackupPlanArn(const QString &backup_plan_arn) {
    m_backup_plan_arn = backup_plan_arn;
    m_backup_plan_arn_isSet = true;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_plan_arn_Set() const{
    return m_backup_plan_arn_isSet;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_plan_arn_Valid() const{
    return m_backup_plan_arn_isValid;
}

QString OAIDescribeBackupJobOutput_CreatedBy::getBackupPlanVersion() const {
    return m_backup_plan_version;
}
void OAIDescribeBackupJobOutput_CreatedBy::setBackupPlanVersion(const QString &backup_plan_version) {
    m_backup_plan_version = backup_plan_version;
    m_backup_plan_version_isSet = true;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_plan_version_Set() const{
    return m_backup_plan_version_isSet;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_plan_version_Valid() const{
    return m_backup_plan_version_isValid;
}

QString OAIDescribeBackupJobOutput_CreatedBy::getBackupRuleId() const {
    return m_backup_rule_id;
}
void OAIDescribeBackupJobOutput_CreatedBy::setBackupRuleId(const QString &backup_rule_id) {
    m_backup_rule_id = backup_rule_id;
    m_backup_rule_id_isSet = true;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_rule_id_Set() const{
    return m_backup_rule_id_isSet;
}

bool OAIDescribeBackupJobOutput_CreatedBy::is_backup_rule_id_Valid() const{
    return m_backup_rule_id_isValid;
}

bool OAIDescribeBackupJobOutput_CreatedBy::isSet() const {
...
bool OAIDescribeBackupJobOutput_CreatedBy::isValid() const {
