...
/*
 * OAIReportDestination.h
 *
 * Contains information from your report job about your report destination.
 */

#ifndef OAIReportDestination_H
#define OAIReportDestination_H
...
class OAIReportDestination : public OAIObject {
public:
    OAIReportDestination();
    OAIReportDestination(QString json);
    ~OAIReportDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportDestination)

#endif // OAIReportDestination_H
