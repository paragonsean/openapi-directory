...
/*
 * OAIUpdateRecoveryPointLifecycleOutput_Lifecycle.h
 *
 * 
 */

#ifndef OAIUpdateRecoveryPointLifecycleOutput_Lifecycle_H
#define OAIUpdateRecoveryPointLifecycleOutput_Lifecycle_H
...
class OAIUpdateRecoveryPointLifecycleOutput_Lifecycle : public OAIObject {
public:
    OAIUpdateRecoveryPointLifecycleOutput_Lifecycle();
    OAIUpdateRecoveryPointLifecycleOutput_Lifecycle(QString json);
    ~OAIUpdateRecoveryPointLifecycleOutput_Lifecycle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRecoveryPointLifecycleOutput_Lifecycle)

#endif // OAIUpdateRecoveryPointLifecycleOutput_Lifecycle_H
