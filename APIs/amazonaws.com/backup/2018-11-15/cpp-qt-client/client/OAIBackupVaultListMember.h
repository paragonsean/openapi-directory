...
/*
 * OAIBackupVaultListMember.h
 *
 * Contains metadata about a backup vault.
 */

#ifndef OAIBackupVaultListMember_H
#define OAIBackupVaultListMember_H
...
class OAIBackupVaultListMember : public OAIObject {
public:
    OAIBackupVaultListMember();
    OAIBackupVaultListMember(QString json);
    ~OAIBackupVaultListMember() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackupVaultListMember)

#endif // OAIBackupVaultListMember_H
