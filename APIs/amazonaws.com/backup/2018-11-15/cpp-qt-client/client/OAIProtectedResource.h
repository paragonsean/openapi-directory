...
/*
 * OAIProtectedResource.h
 *
 * A structure that contains information about a backed-up resource.
 */

#ifndef OAIProtectedResource_H
#define OAIProtectedResource_H
...
class OAIProtectedResource : public OAIObject {
public:
    OAIProtectedResource();
    OAIProtectedResource(QString json);
    ~OAIProtectedResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProtectedResource)

#endif // OAIProtectedResource_H
