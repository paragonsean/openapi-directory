...
OAIBackupJob::OAIBackupJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackupJob::OAIBackupJob() {
    this->initializeModel();
}

OAIBackupJob::~OAIBackupJob() {}

void OAIBackupJob::initializeModel() {
...
void OAIBackupJob::fromJson(QString jsonString) {
...
void OAIBackupJob::fromJsonObject(QJsonObject json) {
...
QString OAIBackupJob::asJson() const {
...
QJsonObject OAIBackupJob::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBackupJob::getAccountId() const {
    return m_account_id;
}
void OAIBackupJob::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIBackupJob::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIBackupJob::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIBackupJob::getBackupJobId() const {
    return m_backup_job_id;
}
void OAIBackupJob::setBackupJobId(const QString &backup_job_id) {
    m_backup_job_id = backup_job_id;
    m_backup_job_id_isSet = true;
}

bool OAIBackupJob::is_backup_job_id_Set() const{
    return m_backup_job_id_isSet;
}

bool OAIBackupJob::is_backup_job_id_Valid() const{
    return m_backup_job_id_isValid;
}

QString OAIBackupJob::getBackupVaultName() const {
    return m_backup_vault_name;
}
void OAIBackupJob::setBackupVaultName(const QString &backup_vault_name) {
    m_backup_vault_name = backup_vault_name;
    m_backup_vault_name_isSet = true;
}

bool OAIBackupJob::is_backup_vault_name_Set() const{
    return m_backup_vault_name_isSet;
}

bool OAIBackupJob::is_backup_vault_name_Valid() const{
    return m_backup_vault_name_isValid;
}

QString OAIBackupJob::getBackupVaultArn() const {
    return m_backup_vault_arn;
}
void OAIBackupJob::setBackupVaultArn(const QString &backup_vault_arn) {
    m_backup_vault_arn = backup_vault_arn;
    m_backup_vault_arn_isSet = true;
}

bool OAIBackupJob::is_backup_vault_arn_Set() const{
    return m_backup_vault_arn_isSet;
}

bool OAIBackupJob::is_backup_vault_arn_Valid() const{
    return m_backup_vault_arn_isValid;
}

QString OAIBackupJob::getRecoveryPointArn() const {
    return m_recovery_point_arn;
}
void OAIBackupJob::setRecoveryPointArn(const QString &recovery_point_arn) {
    m_recovery_point_arn = recovery_point_arn;
    m_recovery_point_arn_isSet = true;
}

bool OAIBackupJob::is_recovery_point_arn_Set() const{
    return m_recovery_point_arn_isSet;
}

bool OAIBackupJob::is_recovery_point_arn_Valid() const{
    return m_recovery_point_arn_isValid;
}

QString OAIBackupJob::getResourceArn() const {
    return m_resource_arn;
}
void OAIBackupJob::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIBackupJob::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIBackupJob::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QDateTime OAIBackupJob::getCreationDate() const {
    return m_creation_date;
}
void OAIBackupJob::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIBackupJob::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIBackupJob::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAIBackupJob::getCompletionDate() const {
    return m_completion_date;
}
void OAIBackupJob::setCompletionDate(const QDateTime &completion_date) {
    m_completion_date = completion_date;
    m_completion_date_isSet = true;
}

bool OAIBackupJob::is_completion_date_Set() const{
    return m_completion_date_isSet;
}

bool OAIBackupJob::is_completion_date_Valid() const{
    return m_completion_date_isValid;
}

OAIBackupJobState OAIBackupJob::getState() const {
    return m_state;
}
void OAIBackupJob::setState(const OAIBackupJobState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIBackupJob::is_state_Set() const{
    return m_state_isSet;
}

bool OAIBackupJob::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIBackupJob::getStatusMessage() const {
    return m_status_message;
}
void OAIBackupJob::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIBackupJob::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIBackupJob::is_status_message_Valid() const{
    return m_status_message_isValid;
}

QString OAIBackupJob::getPercentDone() const {
    return m_percent_done;
}
void OAIBackupJob::setPercentDone(const QString &percent_done) {
    m_percent_done = percent_done;
    m_percent_done_isSet = true;
}

bool OAIBackupJob::is_percent_done_Set() const{
    return m_percent_done_isSet;
}

bool OAIBackupJob::is_percent_done_Valid() const{
    return m_percent_done_isValid;
}

qint32 OAIBackupJob::getBackupSizeInBytes() const {
    return m_backup_size_in_bytes;
}
void OAIBackupJob::setBackupSizeInBytes(const qint32 &backup_size_in_bytes) {
    m_backup_size_in_bytes = backup_size_in_bytes;
    m_backup_size_in_bytes_isSet = true;
}

bool OAIBackupJob::is_backup_size_in_bytes_Set() const{
    return m_backup_size_in_bytes_isSet;
}

bool OAIBackupJob::is_backup_size_in_bytes_Valid() const{
    return m_backup_size_in_bytes_isValid;
}

QString OAIBackupJob::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAIBackupJob::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAIBackupJob::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAIBackupJob::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

OAIBackupJob_CreatedBy OAIBackupJob::getCreatedBy() const {
    return m_created_by;
}
void OAIBackupJob::setCreatedBy(const OAIBackupJob_CreatedBy &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIBackupJob::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIBackupJob::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QDateTime OAIBackupJob::getExpectedCompletionDate() const {
    return m_expected_completion_date;
}
void OAIBackupJob::setExpectedCompletionDate(const QDateTime &expected_completion_date) {
    m_expected_completion_date = expected_completion_date;
    m_expected_completion_date_isSet = true;
}

bool OAIBackupJob::is_expected_completion_date_Set() const{
    return m_expected_completion_date_isSet;
}

bool OAIBackupJob::is_expected_completion_date_Valid() const{
    return m_expected_completion_date_isValid;
}

QDateTime OAIBackupJob::getStartBy() const {
    return m_start_by;
}
void OAIBackupJob::setStartBy(const QDateTime &start_by) {
    m_start_by = start_by;
    m_start_by_isSet = true;
}

bool OAIBackupJob::is_start_by_Set() const{
    return m_start_by_isSet;
}

bool OAIBackupJob::is_start_by_Valid() const{
    return m_start_by_isValid;
}

QString OAIBackupJob::getResourceType() const {
    return m_resource_type;
}
void OAIBackupJob::setResourceType(const QString &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAIBackupJob::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAIBackupJob::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

qint32 OAIBackupJob::getBytesTransferred() const {
    return m_bytes_transferred;
}
void OAIBackupJob::setBytesTransferred(const qint32 &bytes_transferred) {
    m_bytes_transferred = bytes_transferred;
    m_bytes_transferred_isSet = true;
}

bool OAIBackupJob::is_bytes_transferred_Set() const{
    return m_bytes_transferred_isSet;
}

bool OAIBackupJob::is_bytes_transferred_Valid() const{
    return m_bytes_transferred_isValid;
}

QMap OAIBackupJob::getBackupOptions() const {
    return m_backup_options;
}
void OAIBackupJob::setBackupOptions(const QMap &backup_options) {
    m_backup_options = backup_options;
    m_backup_options_isSet = true;
}

bool OAIBackupJob::is_backup_options_Set() const{
    return m_backup_options_isSet;
}

bool OAIBackupJob::is_backup_options_Valid() const{
    return m_backup_options_isValid;
}

QString OAIBackupJob::getBackupType() const {
    return m_backup_type;
}
void OAIBackupJob::setBackupType(const QString &backup_type) {
    m_backup_type = backup_type;
    m_backup_type_isSet = true;
}

bool OAIBackupJob::is_backup_type_Set() const{
    return m_backup_type_isSet;
}

bool OAIBackupJob::is_backup_type_Valid() const{
    return m_backup_type_isValid;
}

QString OAIBackupJob::getParentJobId() const {
    return m_parent_job_id;
}
void OAIBackupJob::setParentJobId(const QString &parent_job_id) {
    m_parent_job_id = parent_job_id;
    m_parent_job_id_isSet = true;
}

bool OAIBackupJob::is_parent_job_id_Set() const{
    return m_parent_job_id_isSet;
}

bool OAIBackupJob::is_parent_job_id_Valid() const{
    return m_parent_job_id_isValid;
}

bool OAIBackupJob::getIsParent() const {
    return m_is_parent;
}
void OAIBackupJob::setIsParent(const bool &is_parent) {
    m_is_parent = is_parent;
    m_is_parent_isSet = true;
}

bool OAIBackupJob::is_is_parent_Set() const{
    return m_is_parent_isSet;
}

bool OAIBackupJob::is_is_parent_Valid() const{
    return m_is_parent_isValid;
}

QString OAIBackupJob::getResourceName() const {
    return m_resource_name;
}
void OAIBackupJob::setResourceName(const QString &resource_name) {
    m_resource_name = resource_name;
    m_resource_name_isSet = true;
}

bool OAIBackupJob::is_resource_name_Set() const{
    return m_resource_name_isSet;
}

bool OAIBackupJob::is_resource_name_Valid() const{
    return m_resource_name_isValid;
}

bool OAIBackupJob::isSet() const {
...
bool OAIBackupJob::isValid() const {
