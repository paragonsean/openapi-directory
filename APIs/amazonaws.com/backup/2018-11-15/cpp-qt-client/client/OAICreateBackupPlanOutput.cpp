...
OAICreateBackupPlanOutput::OAICreateBackupPlanOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBackupPlanOutput::OAICreateBackupPlanOutput() {
    this->initializeModel();
}

OAICreateBackupPlanOutput::~OAICreateBackupPlanOutput() {}

void OAICreateBackupPlanOutput::initializeModel() {
...
void OAICreateBackupPlanOutput::fromJson(QString jsonString) {
...
void OAICreateBackupPlanOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateBackupPlanOutput::asJson() const {
...
QJsonObject OAICreateBackupPlanOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBackupPlanOutput::getBackupPlanId() const {
    return m_backup_plan_id;
}
void OAICreateBackupPlanOutput::setBackupPlanId(const QString &backup_plan_id) {
    m_backup_plan_id = backup_plan_id;
    m_backup_plan_id_isSet = true;
}

bool OAICreateBackupPlanOutput::is_backup_plan_id_Set() const{
    return m_backup_plan_id_isSet;
}

bool OAICreateBackupPlanOutput::is_backup_plan_id_Valid() const{
    return m_backup_plan_id_isValid;
}

QString OAICreateBackupPlanOutput::getBackupPlanArn() const {
    return m_backup_plan_arn;
}
void OAICreateBackupPlanOutput::setBackupPlanArn(const QString &backup_plan_arn) {
    m_backup_plan_arn = backup_plan_arn;
    m_backup_plan_arn_isSet = true;
}

bool OAICreateBackupPlanOutput::is_backup_plan_arn_Set() const{
    return m_backup_plan_arn_isSet;
}

bool OAICreateBackupPlanOutput::is_backup_plan_arn_Valid() const{
    return m_backup_plan_arn_isValid;
}

QDateTime OAICreateBackupPlanOutput::getCreationDate() const {
    return m_creation_date;
}
void OAICreateBackupPlanOutput::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreateBackupPlanOutput::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreateBackupPlanOutput::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAICreateBackupPlanOutput::getVersionId() const {
    return m_version_id;
}
void OAICreateBackupPlanOutput::setVersionId(const QString &version_id) {
    m_version_id = version_id;
    m_version_id_isSet = true;
}

bool OAICreateBackupPlanOutput::is_version_id_Set() const{
    return m_version_id_isSet;
}

bool OAICreateBackupPlanOutput::is_version_id_Valid() const{
    return m_version_id_isValid;
}

QList OAICreateBackupPlanOutput::getAdvancedBackupSettings() const {
    return m_advanced_backup_settings;
}
void OAICreateBackupPlanOutput::setAdvancedBackupSettings(const QList &advanced_backup_settings) {
    m_advanced_backup_settings = advanced_backup_settings;
    m_advanced_backup_settings_isSet = true;
}

bool OAICreateBackupPlanOutput::is_advanced_backup_settings_Set() const{
    return m_advanced_backup_settings_isSet;
}

bool OAICreateBackupPlanOutput::is_advanced_backup_settings_Valid() const{
    return m_advanced_backup_settings_isValid;
}

bool OAICreateBackupPlanOutput::isSet() const {
...
bool OAICreateBackupPlanOutput::isValid() const {
