...
/*
 * OAIBackupRuleInput_Lifecycle.h
 *
 * 
 */

#ifndef OAIBackupRuleInput_Lifecycle_H
#define OAIBackupRuleInput_Lifecycle_H
...
class OAIBackupRuleInput_Lifecycle : public OAIObject {
public:
    OAIBackupRuleInput_Lifecycle();
    OAIBackupRuleInput_Lifecycle(QString json);
    ~OAIBackupRuleInput_Lifecycle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackupRuleInput_Lifecycle)

#endif // OAIBackupRuleInput_Lifecycle_H
