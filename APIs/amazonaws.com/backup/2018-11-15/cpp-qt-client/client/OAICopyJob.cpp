...
OAICopyJob::OAICopyJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyJob::OAICopyJob() {
    this->initializeModel();
}

OAICopyJob::~OAICopyJob() {}

void OAICopyJob::initializeModel() {
...
void OAICopyJob::fromJson(QString jsonString) {
...
void OAICopyJob::fromJsonObject(QJsonObject json) {
...
QString OAICopyJob::asJson() const {
...
QJsonObject OAICopyJob::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopyJob::getAccountId() const {
    return m_account_id;
}
void OAICopyJob::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICopyJob::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICopyJob::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAICopyJob::getCopyJobId() const {
    return m_copy_job_id;
}
void OAICopyJob::setCopyJobId(const QString &copy_job_id) {
    m_copy_job_id = copy_job_id;
    m_copy_job_id_isSet = true;
}

bool OAICopyJob::is_copy_job_id_Set() const{
    return m_copy_job_id_isSet;
}

bool OAICopyJob::is_copy_job_id_Valid() const{
    return m_copy_job_id_isValid;
}

QString OAICopyJob::getSourceBackupVaultArn() const {
    return m_source_backup_vault_arn;
}
void OAICopyJob::setSourceBackupVaultArn(const QString &source_backup_vault_arn) {
    m_source_backup_vault_arn = source_backup_vault_arn;
    m_source_backup_vault_arn_isSet = true;
}

bool OAICopyJob::is_source_backup_vault_arn_Set() const{
    return m_source_backup_vault_arn_isSet;
}

bool OAICopyJob::is_source_backup_vault_arn_Valid() const{
    return m_source_backup_vault_arn_isValid;
}

QString OAICopyJob::getSourceRecoveryPointArn() const {
    return m_source_recovery_point_arn;
}
void OAICopyJob::setSourceRecoveryPointArn(const QString &source_recovery_point_arn) {
    m_source_recovery_point_arn = source_recovery_point_arn;
    m_source_recovery_point_arn_isSet = true;
}

bool OAICopyJob::is_source_recovery_point_arn_Set() const{
    return m_source_recovery_point_arn_isSet;
}

bool OAICopyJob::is_source_recovery_point_arn_Valid() const{
    return m_source_recovery_point_arn_isValid;
}

QString OAICopyJob::getDestinationBackupVaultArn() const {
    return m_destination_backup_vault_arn;
}
void OAICopyJob::setDestinationBackupVaultArn(const QString &destination_backup_vault_arn) {
    m_destination_backup_vault_arn = destination_backup_vault_arn;
    m_destination_backup_vault_arn_isSet = true;
}

bool OAICopyJob::is_destination_backup_vault_arn_Set() const{
    return m_destination_backup_vault_arn_isSet;
}

bool OAICopyJob::is_destination_backup_vault_arn_Valid() const{
    return m_destination_backup_vault_arn_isValid;
}

QString OAICopyJob::getDestinationRecoveryPointArn() const {
    return m_destination_recovery_point_arn;
}
void OAICopyJob::setDestinationRecoveryPointArn(const QString &destination_recovery_point_arn) {
    m_destination_recovery_point_arn = destination_recovery_point_arn;
    m_destination_recovery_point_arn_isSet = true;
}

bool OAICopyJob::is_destination_recovery_point_arn_Set() const{
    return m_destination_recovery_point_arn_isSet;
}

bool OAICopyJob::is_destination_recovery_point_arn_Valid() const{
    return m_destination_recovery_point_arn_isValid;
}

QString OAICopyJob::getResourceArn() const {
    return m_resource_arn;
}
void OAICopyJob::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAICopyJob::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAICopyJob::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QDateTime OAICopyJob::getCreationDate() const {
    return m_creation_date;
}
void OAICopyJob::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICopyJob::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICopyJob::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAICopyJob::getCompletionDate() const {
    return m_completion_date;
}
void OAICopyJob::setCompletionDate(const QDateTime &completion_date) {
    m_completion_date = completion_date;
    m_completion_date_isSet = true;
}

bool OAICopyJob::is_completion_date_Set() const{
    return m_completion_date_isSet;
}

bool OAICopyJob::is_completion_date_Valid() const{
    return m_completion_date_isValid;
}

OAICopyJobState OAICopyJob::getState() const {
    return m_state;
}
void OAICopyJob::setState(const OAICopyJobState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICopyJob::is_state_Set() const{
    return m_state_isSet;
}

bool OAICopyJob::is_state_Valid() const{
    return m_state_isValid;
}

QString OAICopyJob::getStatusMessage() const {
    return m_status_message;
}
void OAICopyJob::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAICopyJob::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAICopyJob::is_status_message_Valid() const{
    return m_status_message_isValid;
}

qint32 OAICopyJob::getBackupSizeInBytes() const {
    return m_backup_size_in_bytes;
}
void OAICopyJob::setBackupSizeInBytes(const qint32 &backup_size_in_bytes) {
    m_backup_size_in_bytes = backup_size_in_bytes;
    m_backup_size_in_bytes_isSet = true;
}

bool OAICopyJob::is_backup_size_in_bytes_Set() const{
    return m_backup_size_in_bytes_isSet;
}

bool OAICopyJob::is_backup_size_in_bytes_Valid() const{
    return m_backup_size_in_bytes_isValid;
}

QString OAICopyJob::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAICopyJob::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAICopyJob::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAICopyJob::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

OAIRecoveryPointCreator OAICopyJob::getCreatedBy() const {
    return m_created_by;
}
void OAICopyJob::setCreatedBy(const OAIRecoveryPointCreator &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAICopyJob::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAICopyJob::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAICopyJob::getResourceType() const {
    return m_resource_type;
}
void OAICopyJob::setResourceType(const QString &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAICopyJob::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAICopyJob::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

QString OAICopyJob::getParentJobId() const {
    return m_parent_job_id;
}
void OAICopyJob::setParentJobId(const QString &parent_job_id) {
    m_parent_job_id = parent_job_id;
    m_parent_job_id_isSet = true;
}

bool OAICopyJob::is_parent_job_id_Set() const{
    return m_parent_job_id_isSet;
}

bool OAICopyJob::is_parent_job_id_Valid() const{
    return m_parent_job_id_isValid;
}

bool OAICopyJob::getIsParent() const {
    return m_is_parent;
}
void OAICopyJob::setIsParent(const bool &is_parent) {
    m_is_parent = is_parent;
    m_is_parent_isSet = true;
}

bool OAICopyJob::is_is_parent_Set() const{
    return m_is_parent_isSet;
}

bool OAICopyJob::is_is_parent_Valid() const{
    return m_is_parent_isValid;
}

QString OAICopyJob::getCompositeMemberIdentifier() const {
    return m_composite_member_identifier;
}
void OAICopyJob::setCompositeMemberIdentifier(const QString &composite_member_identifier) {
    m_composite_member_identifier = composite_member_identifier;
    m_composite_member_identifier_isSet = true;
}

bool OAICopyJob::is_composite_member_identifier_Set() const{
    return m_composite_member_identifier_isSet;
}

bool OAICopyJob::is_composite_member_identifier_Valid() const{
    return m_composite_member_identifier_isValid;
}

qint32 OAICopyJob::getNumberOfChildJobs() const {
    return m_number_of_child_jobs;
}
void OAICopyJob::setNumberOfChildJobs(const qint32 &number_of_child_jobs) {
    m_number_of_child_jobs = number_of_child_jobs;
    m_number_of_child_jobs_isSet = true;
}

bool OAICopyJob::is_number_of_child_jobs_Set() const{
    return m_number_of_child_jobs_isSet;
}

bool OAICopyJob::is_number_of_child_jobs_Valid() const{
    return m_number_of_child_jobs_isValid;
}

QMap OAICopyJob::getChildJobsInState() const {
    return m_child_jobs_in_state;
}
void OAICopyJob::setChildJobsInState(const QMap &child_jobs_in_state) {
    m_child_jobs_in_state = child_jobs_in_state;
    m_child_jobs_in_state_isSet = true;
}

bool OAICopyJob::is_child_jobs_in_state_Set() const{
    return m_child_jobs_in_state_isSet;
}

bool OAICopyJob::is_child_jobs_in_state_Valid() const{
    return m_child_jobs_in_state_isValid;
}

QString OAICopyJob::getResourceName() const {
    return m_resource_name;
}
void OAICopyJob::setResourceName(const QString &resource_name) {
    m_resource_name = resource_name;
    m_resource_name_isSet = true;
}

bool OAICopyJob::is_resource_name_Set() const{
    return m_resource_name_isSet;
}

bool OAICopyJob::is_resource_name_Valid() const{
    return m_resource_name_isValid;
}

bool OAICopyJob::isSet() const {
