...
#ifndef OAIBackupSelection_H
#define OAIBackupSelection_H
...
class OAIBackupSelection : public OAIObject {
public:
    OAIBackupSelection();
    OAIBackupSelection(QString json);
    ~OAIBackupSelection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackupSelection)

#endif // OAIBackupSelection_H
