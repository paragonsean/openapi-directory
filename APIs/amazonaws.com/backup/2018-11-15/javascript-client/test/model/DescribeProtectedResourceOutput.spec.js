...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBackup.DescribeProtectedResourceOutput();
  });
  ...
  describe('DescribeProtectedResourceOutput', function() {
    it('should create an instance of DescribeProtectedResourceOutput', function() {
      // uncomment below and update the code to test DescribeProtectedResourceOutput
      //var instance = new AwsBackup.DescribeProtectedResourceOutput();
      //expect(instance).to.be.a(AwsBackup.DescribeProtectedResourceOutput);
    });
