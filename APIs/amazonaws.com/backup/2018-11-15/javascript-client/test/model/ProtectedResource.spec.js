...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBackup.ProtectedResource();
  });
  ...
  describe('ProtectedResource', function() {
    it('should create an instance of ProtectedResource', function() {
      // uncomment below and update the code to test ProtectedResource
      //var instance = new AwsBackup.ProtectedResource();
      //expect(instance).to.be.a(AwsBackup.ProtectedResource);
    });
