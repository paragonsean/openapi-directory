...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBackup.ControlInputParameter();
  });
  ...
  describe('ControlInputParameter', function() {
    it('should create an instance of ControlInputParameter', function() {
      // uncomment below and update the code to test ControlInputParameter
      //var instance = new AwsBackup.ControlInputParameter();
      //expect(instance).to.be.a(AwsBackup.ControlInputParameter);
    });
