...
/**
 * The CreateBackupSelectionRequestBackupSelection model module.
 * @module model/CreateBackupSelectionRequestBackupSelection
 * @version 2018-11-15
 */
class CreateBackupSelectionRequestBackupSelection {
    /**
     * Constructs a new <code>CreateBackupSelectionRequestBackupSelection</code>.
     ...
     * @alias module:model/CreateBackupSelectionRequestBackupSelection
     */
    constructor() { 
        
        CreateBackupSelectionRequestBackupSelection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBackupSelectionRequestBackupSelection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBackupSelectionRequestBackupSelection} obj Optional instance to populate.
     * @return {module:model/CreateBackupSelectionRequestBackupSelection} The populated <code>CreateBackupSelectionRequestBackupSelection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBackupSelectionRequestBackupSelection();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBackupSelectionRequestBackupSelection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBackupSelectionRequestBackupSelection</code>.
     */
 ...
 */
CreateBackupSelectionRequestBackupSelection.prototype['SelectionName'] = undefined;

/**
 * @member {String} IamRoleArn
 */
CreateBackupSelectionRequestBackupSelection.prototype['IamRoleArn'] = undefined;

/**
 * @member {Array} Resources
 */
CreateBackupSelectionRequestBackupSelection.prototype['Resources'] = undefined;

/**
 * @member {Array} ListOfTags
 */
CreateBackupSelectionRequestBackupSelection.prototype['ListOfTags'] = undefined;

/**
 * @member {Array} NotResources
 */
CreateBackupSelectionRequestBackupSelection.prototype['NotResources'] = undefined;

/**
 * @member {module:model/CreateBackupSelectionRequestBackupSelectionConditions} Conditions
 */
CreateBackupSelectionRequestBackupSelection.prototype['Conditions'] = undefined;
...
export default CreateBackupSelectionRequestBackupSelection;
