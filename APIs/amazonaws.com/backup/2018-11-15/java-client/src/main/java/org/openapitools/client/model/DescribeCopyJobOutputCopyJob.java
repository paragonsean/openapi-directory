...
public class DescribeCopyJobOutputCopyJob {
  ...
  public DescribeCopyJobOutputCopyJob() {
  }

  public DescribeCopyJobOutputCopyJob accountId(String accountId) {
  ...
  public DescribeCopyJobOutputCopyJob copyJobId(String copyJobId) {
  ...
  public DescribeCopyJobOutputCopyJob sourceBackupVaultArn(String sourceBackupVaultArn) {
  ...
  public DescribeCopyJobOutputCopyJob sourceRecoveryPointArn(String sourceRecoveryPointArn) {
  ...
  public DescribeCopyJobOutputCopyJob destinationBackupVaultArn(String destinationBackupVaultArn) {
  ...
  public DescribeCopyJobOutputCopyJob destinationRecoveryPointArn(String destinationRecoveryPointArn) {
  ...
  public DescribeCopyJobOutputCopyJob resourceArn(String resourceArn) {
  ...
  public DescribeCopyJobOutputCopyJob creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeCopyJobOutputCopyJob completionDate(OffsetDateTime completionDate) {
  ...
  public DescribeCopyJobOutputCopyJob state(CopyJobState state) {
    this.state = state;
    return this;
  }
  ...
  public DescribeCopyJobOutputCopyJob statusMessage(String statusMessage) {
  ...
  public DescribeCopyJobOutputCopyJob backupSizeInBytes(Integer backupSizeInBytes) {
  ...
  public DescribeCopyJobOutputCopyJob iamRoleArn(String iamRoleArn) {
  ...
  public DescribeCopyJobOutputCopyJob createdBy(RecoveryPointCreator createdBy) {
  ...
  public DescribeCopyJobOutputCopyJob resourceType(String resourceType) {
  ...
  public DescribeCopyJobOutputCopyJob parentJobId(String parentJobId) {
  ...
  public DescribeCopyJobOutputCopyJob isParent(Boolean isParent) {
  ...
  public DescribeCopyJobOutputCopyJob compositeMemberIdentifier(String compositeMemberIdentifier) {
  ...
  public DescribeCopyJobOutputCopyJob numberOfChildJobs(Integer numberOfChildJobs) {
  ...
  public DescribeCopyJobOutputCopyJob childJobsInState(Map childJobsInState) {
  ...
  public DescribeCopyJobOutputCopyJob resourceName(String resourceName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCopyJobOutputCopyJob describeCopyJobOutputCopyJob = (DescribeCopyJobOutputCopyJob) o;
    return Objects.equals(this.accountId, describeCopyJobOutputCopyJob.accountId) &&
        Objects.equals(this.copyJobId, describeCopyJobOutputCopyJob.copyJobId) &&
        Objects.equals(this.sourceBackupVaultArn, describeCopyJobOutputCopyJob.sourceBackupVaultArn) &&
        Objects.equals(this.sourceRecoveryPointArn, describeCopyJobOutputCopyJob.sourceRecoveryPointArn) &&
        Objects.equals(this.destinationBackupVaultArn, describeCopyJobOutputCopyJob.destinationBackupVaultArn) &&
        Objects.equals(this.destinationRecoveryPointArn, describeCopyJobOutputCopyJob.destinationRecoveryPointArn) &&
        Objects.equals(this.resourceArn, describeCopyJobOutputCopyJob.resourceArn) &&
        Objects.equals(this.creationDate, describeCopyJobOutputCopyJob.creationDate) &&
        Objects.equals(this.completionDate, describeCopyJobOutputCopyJob.completionDate) &&
        Objects.equals(this.state, describeCopyJobOutputCopyJob.state) &&
        Objects.equals(this.statusMessage, describeCopyJobOutputCopyJob.statusMessage) &&
        Objects.equals(this.backupSizeInBytes, describeCopyJobOutputCopyJob.backupSizeInBytes) &&
        Objects.equals(this.iamRoleArn, describeCopyJobOutputCopyJob.iamRoleArn) &&
        Objects.equals(this.createdBy, describeCopyJobOutputCopyJob.createdBy) &&
        Objects.equals(this.resourceType, describeCopyJobOutputCopyJob.resourceType) &&
        Objects.equals(this.parentJobId, describeCopyJobOutputCopyJob.parentJobId) &&
        Objects.equals(this.isParent, describeCopyJobOutputCopyJob.isParent) &&
        Objects.equals(this.compositeMemberIdentifier, describeCopyJobOutputCopyJob.compositeMemberIdentifier) &&
        Objects.equals(this.numberOfChildJobs, describeCopyJobOutputCopyJob.numberOfChildJobs) &&
        Objects.equals(this.childJobsInState, describeCopyJobOutputCopyJob.childJobsInState) &&
        Objects.equals(this.resourceName, describeCopyJobOutputCopyJob.resourceName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeCopyJobOutputCopyJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCopyJobOutputCopyJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCopyJobOutputCopyJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCopyJobOutputCopyJob is not found in the empty JSON string", DescribeCopyJobOutputCopyJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCopyJobOutputCopyJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCopyJobOutputCopyJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCopyJobOutputCopyJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCopyJobOutputCopyJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCopyJobOutputCopyJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCopyJobOutputCopyJob.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCopyJobOutputCopyJob>() {
           @Override
           public void write(JsonWriter out, DescribeCopyJobOutputCopyJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCopyJobOutputCopyJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCopyJobOutputCopyJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCopyJobOutputCopyJob
   * @throws IOException if the JSON string is invalid with respect to DescribeCopyJobOutputCopyJob
   */
  public static DescribeCopyJobOutputCopyJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCopyJobOutputCopyJob.class);
  }

  /**
   * Convert an instance of DescribeCopyJobOutputCopyJob to an JSON string
   *
   * @return JSON string
   */
