...
public class ApiClient {
    ...
    private String basePath = "http://backup.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://backup.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://backup.{region}.amazonaws.com",
      "The AWS Backup multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://backup.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://backup.{region}.amazonaws.com.cn",
      "The AWS Backup endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-11-15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://backup.us-east-1.amazonaws.com
