...
public class DescribeRecoveryPointOutput {
  ...
  private DescribeRecoveryPointOutputCreatedBy createdBy;
  ...
  private DescribeRecoveryPointOutputLifecycle lifecycle;
  ...
  public DescribeRecoveryPointOutput() {
  }

  public DescribeRecoveryPointOutput recoveryPointArn(String recoveryPointArn) {
  ...
  public DescribeRecoveryPointOutput backupVaultName(String backupVaultName) {
  ...
  public DescribeRecoveryPointOutput backupVaultArn(String backupVaultArn) {
  ...
  public DescribeRecoveryPointOutput sourceBackupVaultArn(String sourceBackupVaultArn) {
  ...
  public DescribeRecoveryPointOutput resourceArn(String resourceArn) {
  ...
  public DescribeRecoveryPointOutput resourceType(String resourceType) {
  ...
  public DescribeRecoveryPointOutput createdBy(DescribeRecoveryPointOutputCreatedBy createdBy) {
   ...
   */
  @javax.annotation.Nullable
  public DescribeRecoveryPointOutputCreatedBy getCreatedBy() {
    return createdBy;
  }

  public void setCreatedBy(DescribeRecoveryPointOutputCreatedBy createdBy) {
    this.createdBy = createdBy;
  }


  public DescribeRecoveryPointOutput iamRoleArn(String iamRoleArn) {
  ...
  public DescribeRecoveryPointOutput status(RecoveryPointStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeRecoveryPointOutput statusMessage(String statusMessage) {
  ...
  public DescribeRecoveryPointOutput creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeRecoveryPointOutput completionDate(OffsetDateTime completionDate) {
  ...
  public DescribeRecoveryPointOutput backupSizeInBytes(Integer backupSizeInBytes) {
  ...
  public DescribeRecoveryPointOutput calculatedLifecycle(DescribeRecoveryPointOutputCalculatedLifecycle calculatedLifecycle) {
  ...
  public DescribeRecoveryPointOutput lifecycle(DescribeRecoveryPointOutputLifecycle lifecycle) {
   ...
   */
  @javax.annotation.Nullable
  public DescribeRecoveryPointOutputLifecycle getLifecycle() {
    return lifecycle;
  }

  public void setLifecycle(DescribeRecoveryPointOutputLifecycle lifecycle) {
    this.lifecycle = lifecycle;
  }


  public DescribeRecoveryPointOutput encryptionKeyArn(String encryptionKeyArn) {
  ...
  public DescribeRecoveryPointOutput isEncrypted(Boolean isEncrypted) {
  ...
  public DescribeRecoveryPointOutput storageClass(StorageClass storageClass) {
  ...
  public DescribeRecoveryPointOutput lastRestoreTime(OffsetDateTime lastRestoreTime) {
  ...
  public DescribeRecoveryPointOutput parentRecoveryPointArn(String parentRecoveryPointArn) {
  ...
  public DescribeRecoveryPointOutput compositeMemberIdentifier(String compositeMemberIdentifier) {
  ...
  public DescribeRecoveryPointOutput isParent(Boolean isParent) {
  ...
  public DescribeRecoveryPointOutput resourceName(String resourceName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeRecoveryPointOutput describeRecoveryPointOutput = (DescribeRecoveryPointOutput) o;
    return Objects.equals(this.recoveryPointArn, describeRecoveryPointOutput.recoveryPointArn) &&
        Objects.equals(this.backupVaultName, describeRecoveryPointOutput.backupVaultName) &&
        Objects.equals(this.backupVaultArn, describeRecoveryPointOutput.backupVaultArn) &&
        Objects.equals(this.sourceBackupVaultArn, describeRecoveryPointOutput.sourceBackupVaultArn) &&
        Objects.equals(this.resourceArn, describeRecoveryPointOutput.resourceArn) &&
        Objects.equals(this.resourceType, describeRecoveryPointOutput.resourceType) &&
        Objects.equals(this.createdBy, describeRecoveryPointOutput.createdBy) &&
        Objects.equals(this.iamRoleArn, describeRecoveryPointOutput.iamRoleArn) &&
        Objects.equals(this.status, describeRecoveryPointOutput.status) &&
        Objects.equals(this.statusMessage, describeRecoveryPointOutput.statusMessage) &&
        Objects.equals(this.creationDate, describeRecoveryPointOutput.creationDate) &&
        Objects.equals(this.completionDate, describeRecoveryPointOutput.completionDate) &&
        Objects.equals(this.backupSizeInBytes, describeRecoveryPointOutput.backupSizeInBytes) &&
        Objects.equals(this.calculatedLifecycle, describeRecoveryPointOutput.calculatedLifecycle) &&
        Objects.equals(this.lifecycle, describeRecoveryPointOutput.lifecycle) &&
        Objects.equals(this.encryptionKeyArn, describeRecoveryPointOutput.encryptionKeyArn) &&
        Objects.equals(this.isEncrypted, describeRecoveryPointOutput.isEncrypted) &&
        Objects.equals(this.storageClass, describeRecoveryPointOutput.storageClass) &&
        Objects.equals(this.lastRestoreTime, describeRecoveryPointOutput.lastRestoreTime) &&
        Objects.equals(this.parentRecoveryPointArn, describeRecoveryPointOutput.parentRecoveryPointArn) &&
        Objects.equals(this.compositeMemberIdentifier, describeRecoveryPointOutput.compositeMemberIdentifier) &&
        Objects.equals(this.isParent, describeRecoveryPointOutput.isParent) &&
        Objects.equals(this.resourceName, describeRecoveryPointOutput.resourceName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recoveryPointArn, backupVaultName, backupVaultArn, sourceBackupVaultArn, resourceArn, resourceType, createdBy, iamRoleArn, status, statusMessage, creationDate, completionDate, backupSizeInBytes, calculatedLifecycle, lifecycle, encryptionKeyArn, isEncrypted, storageClass, lastRestoreTime, parentRecoveryPointArn, compositeMemberIdentifier, isParent, resourceName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeRecoveryPointOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRecoveryPointOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRecoveryPointOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRecoveryPointOutput is not found in the empty JSON string", DescribeRecoveryPointOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRecoveryPointOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRecoveryPointOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("CreatedBy") != null && !jsonObj.get("CreatedBy").isJsonNull()) {
        DescribeRecoveryPointOutputCreatedBy.validateJsonElement(jsonObj.get("CreatedBy"));
      }
      ...
      if (jsonObj.get("Lifecycle") != null && !jsonObj.get("Lifecycle").isJsonNull()) {
        DescribeRecoveryPointOutputLifecycle.validateJsonElement(jsonObj.get("Lifecycle"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRecoveryPointOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRecoveryPointOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRecoveryPointOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRecoveryPointOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRecoveryPointOutput>() {
           @Override
           public void write(JsonWriter out, DescribeRecoveryPointOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRecoveryPointOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRecoveryPointOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRecoveryPointOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeRecoveryPointOutput
   */
  public static DescribeRecoveryPointOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRecoveryPointOutput.class);
  }

  /**
   * Convert an instance of DescribeRecoveryPointOutput to an JSON string
   *
   * @return JSON string
   */
