...
public class DescribeBackupJobOutput {
  ...
  private DescribeBackupJobOutputCreatedBy createdBy;
  ...
  public DescribeBackupJobOutput() {
  }

  public DescribeBackupJobOutput accountId(String accountId) {
  ...
  public DescribeBackupJobOutput backupJobId(String backupJobId) {
  ...
  public DescribeBackupJobOutput backupVaultName(String backupVaultName) {
  ...
  public DescribeBackupJobOutput backupVaultArn(String backupVaultArn) {
  ...
  public DescribeBackupJobOutput recoveryPointArn(String recoveryPointArn) {
  ...
  public DescribeBackupJobOutput resourceArn(String resourceArn) {
  ...
  public DescribeBackupJobOutput creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeBackupJobOutput completionDate(OffsetDateTime completionDate) {
  ...
  public DescribeBackupJobOutput state(BackupJobState state) {
    this.state = state;
    return this;
  }
  ...
  public DescribeBackupJobOutput statusMessage(String statusMessage) {
  ...
  public DescribeBackupJobOutput percentDone(String percentDone) {
  ...
  public DescribeBackupJobOutput backupSizeInBytes(Integer backupSizeInBytes) {
  ...
  public DescribeBackupJobOutput iamRoleArn(String iamRoleArn) {
  ...
  public DescribeBackupJobOutput createdBy(DescribeBackupJobOutputCreatedBy createdBy) {
   ...
   */
  @javax.annotation.Nullable
  public DescribeBackupJobOutputCreatedBy getCreatedBy() {
    return createdBy;
  }

  public void setCreatedBy(DescribeBackupJobOutputCreatedBy createdBy) {
    this.createdBy = createdBy;
  }


  public DescribeBackupJobOutput resourceType(String resourceType) {
  ...
  public DescribeBackupJobOutput bytesTransferred(Integer bytesTransferred) {
  ...
  public DescribeBackupJobOutput expectedCompletionDate(OffsetDateTime expectedCompletionDate) {
  ...
  public DescribeBackupJobOutput startBy(OffsetDateTime startBy) {
  ...
  public DescribeBackupJobOutput backupOptions(Map backupOptions) {
  ...
  public DescribeBackupJobOutput backupType(String backupType) {
  ...
  public DescribeBackupJobOutput parentJobId(String parentJobId) {
  ...
  public DescribeBackupJobOutput isParent(Boolean isParent) {
  ...
  public DescribeBackupJobOutput numberOfChildJobs(Integer numberOfChildJobs) {
  ...
  public DescribeBackupJobOutput childJobsInState(Map childJobsInState) {
  ...
  public DescribeBackupJobOutput resourceName(String resourceName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeBackupJobOutput describeBackupJobOutput = (DescribeBackupJobOutput) o;
    return Objects.equals(this.accountId, describeBackupJobOutput.accountId) &&
        Objects.equals(this.backupJobId, describeBackupJobOutput.backupJobId) &&
        Objects.equals(this.backupVaultName, describeBackupJobOutput.backupVaultName) &&
        Objects.equals(this.backupVaultArn, describeBackupJobOutput.backupVaultArn) &&
        Objects.equals(this.recoveryPointArn, describeBackupJobOutput.recoveryPointArn) &&
        Objects.equals(this.resourceArn, describeBackupJobOutput.resourceArn) &&
        Objects.equals(this.creationDate, describeBackupJobOutput.creationDate) &&
        Objects.equals(this.completionDate, describeBackupJobOutput.completionDate) &&
        Objects.equals(this.state, describeBackupJobOutput.state) &&
        Objects.equals(this.statusMessage, describeBackupJobOutput.statusMessage) &&
        Objects.equals(this.percentDone, describeBackupJobOutput.percentDone) &&
        Objects.equals(this.backupSizeInBytes, describeBackupJobOutput.backupSizeInBytes) &&
        Objects.equals(this.iamRoleArn, describeBackupJobOutput.iamRoleArn) &&
        Objects.equals(this.createdBy, describeBackupJobOutput.createdBy) &&
        Objects.equals(this.resourceType, describeBackupJobOutput.resourceType) &&
        Objects.equals(this.bytesTransferred, describeBackupJobOutput.bytesTransferred) &&
        Objects.equals(this.expectedCompletionDate, describeBackupJobOutput.expectedCompletionDate) &&
        Objects.equals(this.startBy, describeBackupJobOutput.startBy) &&
        Objects.equals(this.backupOptions, describeBackupJobOutput.backupOptions) &&
        Objects.equals(this.backupType, describeBackupJobOutput.backupType) &&
        Objects.equals(this.parentJobId, describeBackupJobOutput.parentJobId) &&
        Objects.equals(this.isParent, describeBackupJobOutput.isParent) &&
        Objects.equals(this.numberOfChildJobs, describeBackupJobOutput.numberOfChildJobs) &&
        Objects.equals(this.childJobsInState, describeBackupJobOutput.childJobsInState) &&
        Objects.equals(this.resourceName, describeBackupJobOutput.resourceName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeBackupJobOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBackupJobOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBackupJobOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBackupJobOutput is not found in the empty JSON string", DescribeBackupJobOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBackupJobOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBackupJobOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("CreatedBy") != null && !jsonObj.get("CreatedBy").isJsonNull()) {
        DescribeBackupJobOutputCreatedBy.validateJsonElement(jsonObj.get("CreatedBy"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBackupJobOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBackupJobOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBackupJobOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBackupJobOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBackupJobOutput>() {
           @Override
           public void write(JsonWriter out, DescribeBackupJobOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBackupJobOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBackupJobOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBackupJobOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeBackupJobOutput
   */
  public static DescribeBackupJobOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBackupJobOutput.class);
  }

  /**
   * Convert an instance of DescribeBackupJobOutput to an JSON string
   *
   * @return JSON string
   */
