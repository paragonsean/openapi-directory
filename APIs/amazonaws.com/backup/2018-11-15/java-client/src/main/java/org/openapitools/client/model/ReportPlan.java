...
public class ReportPlan {
  ...
  public ReportPlan reportPlanArn(String reportPlanArn) {
  ...
  public ReportPlan reportPlanName(String reportPlanName) {
  ...
  public ReportPlan reportPlanDescription(String reportPlanDescription) {
  ...
  public ReportPlan reportSetting(CreateReportPlanInputReportSetting reportSetting) {
  ...
  public ReportPlan reportDeliveryChannel(ReportPlanReportDeliveryChannel reportDeliveryChannel) {
  ...
  public ReportPlan deploymentStatus(String deploymentStatus) {
  ...
  public ReportPlan creationTime(OffsetDateTime creationTime) {
  ...
  public ReportPlan lastAttemptedExecutionTime(OffsetDateTime lastAttemptedExecutionTime) {
  ...
  public ReportPlan lastSuccessfulExecutionTime(OffsetDateTime lastSuccessfulExecutionTime) {
  ...
  public boolean equals(Object o) {
    ...
    ReportPlan reportPlan = (ReportPlan) o;
    return Objects.equals(this.reportPlanArn, reportPlan.reportPlanArn) &&
        Objects.equals(this.reportPlanName, reportPlan.reportPlanName) &&
        Objects.equals(this.reportPlanDescription, reportPlan.reportPlanDescription) &&
        Objects.equals(this.reportSetting, reportPlan.reportSetting) &&
        Objects.equals(this.reportDeliveryChannel, reportPlan.reportDeliveryChannel) &&
        Objects.equals(this.deploymentStatus, reportPlan.deploymentStatus) &&
        Objects.equals(this.creationTime, reportPlan.creationTime) &&
        Objects.equals(this.lastAttemptedExecutionTime, reportPlan.lastAttemptedExecutionTime) &&
        Objects.equals(this.lastSuccessfulExecutionTime, reportPlan.lastSuccessfulExecutionTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportPlan
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportPlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportPlan is not found in the empty JSON string", ReportPlan.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportPlan.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportPlan` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportPlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportPlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportPlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportPlan.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportPlan>() {
           @Override
           public void write(JsonWriter out, ReportPlan value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportPlan read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportPlan given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportPlan
   * @throws IOException if the JSON string is invalid with respect to ReportPlan
   */
  public static ReportPlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportPlan.class);
  }

  /**
   * Convert an instance of ReportPlan to an JSON string
   *
   * @return JSON string
   */
