...
public class RestoreJobsListMember {
  ...
  public RestoreJobsListMember accountId(String accountId) {
  ...
  public RestoreJobsListMember restoreJobId(String restoreJobId) {
  ...
  public RestoreJobsListMember recoveryPointArn(String recoveryPointArn) {
  ...
  public RestoreJobsListMember creationDate(OffsetDateTime creationDate) {
  ...
  public RestoreJobsListMember completionDate(OffsetDateTime completionDate) {
  ...
  public RestoreJobsListMember status(RestoreJobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public RestoreJobsListMember statusMessage(String statusMessage) {
  ...
  public RestoreJobsListMember percentDone(String percentDone) {
  ...
  public RestoreJobsListMember backupSizeInBytes(Integer backupSizeInBytes) {
  ...
  public RestoreJobsListMember iamRoleArn(String iamRoleArn) {
  ...
  public RestoreJobsListMember expectedCompletionTimeMinutes(Integer expectedCompletionTimeMinutes) {
  ...
  public RestoreJobsListMember createdResourceArn(String createdResourceArn) {
  ...
  public RestoreJobsListMember resourceType(String resourceType) {
  ...
  public boolean equals(Object o) {
    ...
    RestoreJobsListMember restoreJobsListMember = (RestoreJobsListMember) o;
    return Objects.equals(this.accountId, restoreJobsListMember.accountId) &&
        Objects.equals(this.restoreJobId, restoreJobsListMember.restoreJobId) &&
        Objects.equals(this.recoveryPointArn, restoreJobsListMember.recoveryPointArn) &&
        Objects.equals(this.creationDate, restoreJobsListMember.creationDate) &&
        Objects.equals(this.completionDate, restoreJobsListMember.completionDate) &&
        Objects.equals(this.status, restoreJobsListMember.status) &&
        Objects.equals(this.statusMessage, restoreJobsListMember.statusMessage) &&
        Objects.equals(this.percentDone, restoreJobsListMember.percentDone) &&
        Objects.equals(this.backupSizeInBytes, restoreJobsListMember.backupSizeInBytes) &&
        Objects.equals(this.iamRoleArn, restoreJobsListMember.iamRoleArn) &&
        Objects.equals(this.expectedCompletionTimeMinutes, restoreJobsListMember.expectedCompletionTimeMinutes) &&
        Objects.equals(this.createdResourceArn, restoreJobsListMember.createdResourceArn) &&
        Objects.equals(this.resourceType, restoreJobsListMember.resourceType);
  }
  ...
  public String toString() {
    ...
    sb.append("class RestoreJobsListMember {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RestoreJobsListMember
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestoreJobsListMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RestoreJobsListMember is not found in the empty JSON string", RestoreJobsListMember.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RestoreJobsListMember.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestoreJobsListMember` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RestoreJobsListMember.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RestoreJobsListMember' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RestoreJobsListMember> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RestoreJobsListMember.class));

       return (TypeAdapter<T>) new TypeAdapter<RestoreJobsListMember>() {
           @Override
           public void write(JsonWriter out, RestoreJobsListMember value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RestoreJobsListMember read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RestoreJobsListMember given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RestoreJobsListMember
   * @throws IOException if the JSON string is invalid with respect to RestoreJobsListMember
   */
  public static RestoreJobsListMember fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RestoreJobsListMember.class);
  }

  /**
   * Convert an instance of RestoreJobsListMember to an JSON string
   *
   * @return JSON string
   */
