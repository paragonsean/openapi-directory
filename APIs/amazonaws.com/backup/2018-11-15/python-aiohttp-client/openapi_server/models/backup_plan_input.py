...
class BackupPlanInput(Model):
    ...
    def __init__(self, backup_plan_name: str=None, rules: List=None, advanced_backup_settings: List=None):
        """BackupPlanInput - a model defined in OpenAPI

        :param backup_plan_name: The backup_plan_name of this BackupPlanInput.
        :param rules: The rules of this BackupPlanInput.
        :param advanced_backup_settings: The advanced_backup_settings of this BackupPlanInput.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BackupPlanInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BackupPlanInput of this BackupPlanInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def backup_plan_name(self):
        """Gets the backup_plan_name of this BackupPlanInput.


        :return: The backup_plan_name of this BackupPlanInput.
        :rtype: str
        """
    ...
    def backup_plan_name(self, backup_plan_name):
        """Sets the backup_plan_name of this BackupPlanInput.
    ...
    @property
    def rules(self):
        """Gets the rules of this BackupPlanInput.


        :return: The rules of this BackupPlanInput.
        :rtype: List
        """
        return self._rules
    ...
    def rules(self, rules):
        """Sets the rules of this BackupPlanInput.
    ...
    def advanced_backup_settings(self):
        """Gets the advanced_backup_settings of this BackupPlanInput.


        :return: The advanced_backup_settings of this BackupPlanInput.
        :rtype: List
        """
    ...
    def advanced_backup_settings(self, advanced_backup_settings):
        """Sets the advanced_backup_settings of this BackupPlanInput.
