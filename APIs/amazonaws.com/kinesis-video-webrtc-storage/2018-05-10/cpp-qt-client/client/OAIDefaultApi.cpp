...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("joinStorageSession", defaultConf);
    _serverIndices.insert("joinStorageSession", 0);
}
...
void OAIDefaultApi::joinStorageSession(const OAIJoinStorageSession_request &oai_join_storage_session_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["joinStorageSession"][_serverIndices.value("joinStorageSession")].URL()+"/joinStorageSession");
...

    {
        ...
        QByteArray output = oai_join_storage_session_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::joinStorageSessionCallback);
...
void OAIDefaultApi::joinStorageSessionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT joinStorageSessionSignal();
        Q_EMIT joinStorageSessionSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT joinStorageSessionSignalE(error_type, error_str);
        Q_EMIT joinStorageSessionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT joinStorageSessionSignalError(error_type, error_str);
        Q_EMIT joinStorageSessionSignalErrorFull(worker, error_type, error_str);
    }
}
