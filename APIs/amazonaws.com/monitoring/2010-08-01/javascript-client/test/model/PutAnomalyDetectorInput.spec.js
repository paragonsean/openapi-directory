...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.PutAnomalyDetectorInput();
  });
  ...
  describe('PutAnomalyDetectorInput', function() {
    it('should create an instance of PutAnomalyDetectorInput', function() {
      // uncomment below and update the code to test PutAnomalyDetectorInput
      //var instance = new AmazonCloudWatch.PutAnomalyDetectorInput();
      //expect(instance).to.be.a(AmazonCloudWatch.PutAnomalyDetectorInput);
    });
