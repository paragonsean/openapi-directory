...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.DescribeAlarmsForMetricInput();
  });
  ...
  describe('DescribeAlarmsForMetricInput', function() {
    it('should create an instance of DescribeAlarmsForMetricInput', function() {
      // uncomment below and update the code to test DescribeAlarmsForMetricInput
      //var instance = new AmazonCloudWatch.DescribeAlarmsForMetricInput();
      //expect(instance).to.be.a(AmazonCloudWatch.DescribeAlarmsForMetricInput);
    });
