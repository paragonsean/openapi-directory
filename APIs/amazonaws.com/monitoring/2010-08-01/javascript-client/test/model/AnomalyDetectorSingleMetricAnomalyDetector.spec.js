...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.AnomalyDetectorSingleMetricAnomalyDetector();
  });
  ...
  describe('AnomalyDetectorSingleMetricAnomalyDetector', function() {
    it('should create an instance of AnomalyDetectorSingleMetricAnomalyDetector', function() {
      // uncomment below and update the code to test AnomalyDetectorSingleMetricAnomalyDetector
      //var instance = new AmazonCloudWatch.AnomalyDetectorSingleMetricAnomalyDetector();
      //expect(instance).to.be.a(AmazonCloudWatch.AnomalyDetectorSingleMetricAnomalyDetector);
    });
