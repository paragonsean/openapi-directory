...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.MetricStat();
  });
  ...
  describe('MetricStat', function() {
    it('should create an instance of MetricStat', function() {
      // uncomment below and update the code to test MetricStat
      //var instance = new AmazonCloudWatch.MetricStat();
      //expect(instance).to.be.a(AmazonCloudWatch.MetricStat);
    });
