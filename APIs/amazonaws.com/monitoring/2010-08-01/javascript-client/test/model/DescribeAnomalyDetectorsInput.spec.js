...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.DescribeAnomalyDetectorsInput();
  });
  ...
  describe('DescribeAnomalyDetectorsInput', function() {
    it('should create an instance of DescribeAnomalyDetectorsInput', function() {
      // uncomment below and update the code to test DescribeAnomalyDetectorsInput
      //var instance = new AmazonCloudWatch.DescribeAnomalyDetectorsInput();
      //expect(instance).to.be.a(AmazonCloudWatch.DescribeAnomalyDetectorsInput);
    });
    ...
    it('should have the property anomalyDetectorTypes (base name: "AnomalyDetectorTypes")', function() {
      // uncomment below and update the code to test the property anomalyDetectorTypes
      //var instance = new AmazonCloudWatch.DescribeAnomalyDetectorsInput();
      //expect(instance).to.be();
    });
