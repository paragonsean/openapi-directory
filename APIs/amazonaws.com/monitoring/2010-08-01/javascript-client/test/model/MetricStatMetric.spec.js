...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.MetricStatMetric();
  });
  ...
  describe('MetricStatMetric', function() {
    it('should create an instance of MetricStatMetric', function() {
      // uncomment below and update the code to test MetricStatMetric
      //var instance = new AmazonCloudWatch.MetricStatMetric();
      //expect(instance).to.be.a(AmazonCloudWatch.MetricStatMetric);
    });
