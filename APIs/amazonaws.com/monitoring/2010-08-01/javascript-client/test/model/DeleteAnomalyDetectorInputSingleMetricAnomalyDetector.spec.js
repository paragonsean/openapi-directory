...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.DeleteAnomalyDetectorInputSingleMetricAnomalyDetector();
  });
  ...
  describe('DeleteAnomalyDetectorInputSingleMetricAnomalyDetector', function() {
    it('should create an instance of DeleteAnomalyDetectorInputSingleMetricAnomalyDetector', function() {
      // uncomment below and update the code to test DeleteAnomalyDetectorInputSingleMetricAnomalyDetector
      //var instance = new AmazonCloudWatch.DeleteAnomalyDetectorInputSingleMetricAnomalyDetector();
      //expect(instance).to.be.a(AmazonCloudWatch.DeleteAnomalyDetectorInputSingleMetricAnomalyDetector);
    });
