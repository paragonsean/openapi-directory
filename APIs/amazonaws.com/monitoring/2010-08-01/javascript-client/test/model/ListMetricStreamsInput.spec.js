...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.ListMetricStreamsInput();
  });
  ...
  describe('ListMetricStreamsInput', function() {
    it('should create an instance of ListMetricStreamsInput', function() {
      // uncomment below and update the code to test ListMetricStreamsInput
      //var instance = new AmazonCloudWatch.ListMetricStreamsInput();
      //expect(instance).to.be.a(AmazonCloudWatch.ListMetricStreamsInput);
    });
