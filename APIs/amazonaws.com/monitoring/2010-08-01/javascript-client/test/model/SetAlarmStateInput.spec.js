...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.SetAlarmStateInput();
  });
  ...
  describe('SetAlarmStateInput', function() {
    it('should create an instance of SetAlarmStateInput', function() {
      // uncomment below and update the code to test SetAlarmStateInput
      //var instance = new AmazonCloudWatch.SetAlarmStateInput();
      //expect(instance).to.be.a(AmazonCloudWatch.SetAlarmStateInput);
    });
