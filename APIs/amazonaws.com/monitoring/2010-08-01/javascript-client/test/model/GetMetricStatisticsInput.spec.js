...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.GetMetricStatisticsInput();
  });
  ...
  describe('GetMetricStatisticsInput', function() {
    it('should create an instance of GetMetricStatisticsInput', function() {
      // uncomment below and update the code to test GetMetricStatisticsInput
      //var instance = new AmazonCloudWatch.GetMetricStatisticsInput();
      //expect(instance).to.be.a(AmazonCloudWatch.GetMetricStatisticsInput);
    });
