...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.PutCompositeAlarmInput();
  });
  ...
  describe('PutCompositeAlarmInput', function() {
    it('should create an instance of PutCompositeAlarmInput', function() {
      // uncomment below and update the code to test PutCompositeAlarmInput
      //var instance = new AmazonCloudWatch.PutCompositeAlarmInput();
      //expect(instance).to.be.a(AmazonCloudWatch.PutCompositeAlarmInput);
    });
