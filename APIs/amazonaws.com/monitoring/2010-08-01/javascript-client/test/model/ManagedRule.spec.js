...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.ManagedRule();
  });
  ...
  describe('ManagedRule', function() {
    it('should create an instance of ManagedRule', function() {
      // uncomment below and update the code to test ManagedRule
      //var instance = new AmazonCloudWatch.ManagedRule();
      //expect(instance).to.be.a(AmazonCloudWatch.ManagedRule);
    });
