...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.MetricStreamEntry();
  });
  ...
  describe('MetricStreamEntry', function() {
    it('should create an instance of MetricStreamEntry', function() {
      // uncomment below and update the code to test MetricStreamEntry
      //var instance = new AmazonCloudWatch.MetricStreamEntry();
      //expect(instance).to.be.a(AmazonCloudWatch.MetricStreamEntry);
    });
