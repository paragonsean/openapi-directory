...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.ListManagedInsightRulesInput();
  });
  ...
  describe('ListManagedInsightRulesInput', function() {
    it('should create an instance of ListManagedInsightRulesInput', function() {
      // uncomment below and update the code to test ListManagedInsightRulesInput
      //var instance = new AmazonCloudWatch.ListManagedInsightRulesInput();
      //expect(instance).to.be.a(AmazonCloudWatch.ListManagedInsightRulesInput);
    });
