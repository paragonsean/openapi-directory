...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.SingleMetricAnomalyDetector();
  });
  ...
  describe('SingleMetricAnomalyDetector', function() {
    it('should create an instance of SingleMetricAnomalyDetector', function() {
      // uncomment below and update the code to test SingleMetricAnomalyDetector
      //var instance = new AmazonCloudWatch.SingleMetricAnomalyDetector();
      //expect(instance).to.be.a(AmazonCloudWatch.SingleMetricAnomalyDetector);
    });
