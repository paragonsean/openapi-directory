...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.PutAnomalyDetectorInputSingleMetricAnomalyDetector();
  });
  ...
  describe('PutAnomalyDetectorInputSingleMetricAnomalyDetector', function() {
    it('should create an instance of PutAnomalyDetectorInputSingleMetricAnomalyDetector', function() {
      // uncomment below and update the code to test PutAnomalyDetectorInputSingleMetricAnomalyDetector
      //var instance = new AmazonCloudWatch.PutAnomalyDetectorInputSingleMetricAnomalyDetector();
      //expect(instance).to.be.a(AmazonCloudWatch.PutAnomalyDetectorInputSingleMetricAnomalyDetector);
    });
