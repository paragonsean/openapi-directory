...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.PutMetricStreamInput();
  });
  ...
  describe('PutMetricStreamInput', function() {
    it('should create an instance of PutMetricStreamInput', function() {
      // uncomment below and update the code to test PutMetricStreamInput
      //var instance = new AmazonCloudWatch.PutMetricStreamInput();
      //expect(instance).to.be.a(AmazonCloudWatch.PutMetricStreamInput);
    });
