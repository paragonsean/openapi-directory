...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatch.GETDeleteAnomalyDetectorSingleMetricAnomalyDetectorParameter();
  });
  ...
  describe('GETDeleteAnomalyDetectorSingleMetricAnomalyDetectorParameter', function() {
    it('should create an instance of GETDeleteAnomalyDetectorSingleMetricAnomalyDetectorParameter', function() {
      // uncomment below and update the code to test GETDeleteAnomalyDetectorSingleMetricAnomalyDetectorParameter
      //var instance = new AmazonCloudWatch.GETDeleteAnomalyDetectorSingleMetricAnomalyDetectorParameter();
      //expect(instance).to.be.a(AmazonCloudWatch.GETDeleteAnomalyDetectorSingleMetricAnomalyDetectorParameter);
    });
