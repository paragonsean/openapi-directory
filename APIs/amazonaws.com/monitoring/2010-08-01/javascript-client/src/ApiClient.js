...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://monitoring.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://monitoring.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2010-08-01/Javascript'
        };
