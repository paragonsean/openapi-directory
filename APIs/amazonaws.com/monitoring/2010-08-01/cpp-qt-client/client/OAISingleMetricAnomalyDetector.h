...
/*
 * OAISingleMetricAnomalyDetector.h
 *
 * Designates the CloudWatch metric and statistic that provides the time series the anomaly detector uses as input.
 */

#ifndef OAISingleMetricAnomalyDetector_H
#define OAISingleMetricAnomalyDetector_H
...
class OAISingleMetricAnomalyDetector : public OAIObject {
public:
    OAISingleMetricAnomalyDetector();
    OAISingleMetricAnomalyDetector(QString json);
    ~OAISingleMetricAnomalyDetector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISingleMetricAnomalyDetector)

#endif // OAISingleMetricAnomalyDetector_H
