...
/*
 * OAIPutCompositeAlarmInput.h
 *
 * 
 */

#ifndef OAIPutCompositeAlarmInput_H
#define OAIPutCompositeAlarmInput_H
...
class OAIPutCompositeAlarmInput : public OAIObject {
public:
    OAIPutCompositeAlarmInput();
    OAIPutCompositeAlarmInput(QString json);
    ~OAIPutCompositeAlarmInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutCompositeAlarmInput)

#endif // OAIPutCompositeAlarmInput_H
