...
/*
 * OAIMetricDataQuery_MetricStat.h
 *
 * 
 */

#ifndef OAIMetricDataQuery_MetricStat_H
#define OAIMetricDataQuery_MetricStat_H
...
class OAIMetricDataQuery_MetricStat : public OAIObject {
public:
    OAIMetricDataQuery_MetricStat();
    OAIMetricDataQuery_MetricStat(QString json);
    ~OAIMetricDataQuery_MetricStat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricDataQuery_MetricStat)

#endif // OAIMetricDataQuery_MetricStat_H
