...
/*
 * OAIMetricStreamStatisticsMetric.h
 *
 * This object contains the information for one metric that is to be streamed with additional statistics.
 */

#ifndef OAIMetricStreamStatisticsMetric_H
#define OAIMetricStreamStatisticsMetric_H
...
class OAIMetricStreamStatisticsMetric : public OAIObject {
public:
    OAIMetricStreamStatisticsMetric();
    OAIMetricStreamStatisticsMetric(QString json);
    ~OAIMetricStreamStatisticsMetric() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricStreamStatisticsMetric)

#endif // OAIMetricStreamStatisticsMetric_H
