...
/*
 * OAIMetricDatum_StatisticValues.h
 *
 * 
 */

#ifndef OAIMetricDatum_StatisticValues_H
#define OAIMetricDatum_StatisticValues_H
...
class OAIMetricDatum_StatisticValues : public OAIObject {
public:
    OAIMetricDatum_StatisticValues();
    OAIMetricDatum_StatisticValues(QString json);
    ~OAIMetricDatum_StatisticValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricDatum_StatisticValues)

#endif // OAIMetricDatum_StatisticValues_H
