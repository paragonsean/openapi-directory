...
/*
 * OAIPutAnomalyDetectorInput_Configuration.h
 *
 * 
 */

#ifndef OAIPutAnomalyDetectorInput_Configuration_H
#define OAIPutAnomalyDetectorInput_Configuration_H
...
class OAIPutAnomalyDetectorInput_Configuration : public OAIObject {
public:
    OAIPutAnomalyDetectorInput_Configuration();
    OAIPutAnomalyDetectorInput_Configuration(QString json);
    ~OAIPutAnomalyDetectorInput_Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutAnomalyDetectorInput_Configuration)

#endif // OAIPutAnomalyDetectorInput_Configuration_H
