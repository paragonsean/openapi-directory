...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.CreateScheduleInputTarget();
  });
  ...
  describe('CreateScheduleInputTarget', function() {
    it('should create an instance of CreateScheduleInputTarget', function() {
      // uncomment below and update the code to test CreateScheduleInputTarget
      //var instance = new AmazonEventBridgeScheduler.CreateScheduleInputTarget();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.CreateScheduleInputTarget);
    });
