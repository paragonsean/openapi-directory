...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.AwsVpcConfiguration();
  });
  ...
  describe('AwsVpcConfiguration', function() {
    it('should create an instance of AwsVpcConfiguration', function() {
      // uncomment below and update the code to test AwsVpcConfiguration
      //var instance = new AmazonEventBridgeScheduler.AwsVpcConfiguration();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.AwsVpcConfiguration);
    });
