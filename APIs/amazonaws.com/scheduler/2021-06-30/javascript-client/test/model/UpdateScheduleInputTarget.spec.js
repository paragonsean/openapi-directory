...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.UpdateScheduleInputTarget();
  });
  ...
  describe('UpdateScheduleInputTarget', function() {
    it('should create an instance of UpdateScheduleInputTarget', function() {
      // uncomment below and update the code to test UpdateScheduleInputTarget
      //var instance = new AmazonEventBridgeScheduler.UpdateScheduleInputTarget();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.UpdateScheduleInputTarget);
    });
