...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.Target();
  });
  ...
  describe('Target', function() {
    it('should create an instance of Target', function() {
      ...
      //var instance = new AmazonEventBridgeScheduler.Target();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.Target);
    });
