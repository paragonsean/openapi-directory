...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.UpdateScheduleRequestTargetEcsParameters();
  });
  ...
  describe('UpdateScheduleRequestTargetEcsParameters', function() {
    it('should create an instance of UpdateScheduleRequestTargetEcsParameters', function() {
      // uncomment below and update the code to test UpdateScheduleRequestTargetEcsParameters
      //var instance = new AmazonEventBridgeScheduler.UpdateScheduleRequestTargetEcsParameters();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.UpdateScheduleRequestTargetEcsParameters);
    });
