...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.GetScheduleOutputTarget();
  });
  ...
  describe('GetScheduleOutputTarget', function() {
    it('should create an instance of GetScheduleOutputTarget', function() {
      // uncomment below and update the code to test GetScheduleOutputTarget
      //var instance = new AmazonEventBridgeScheduler.GetScheduleOutputTarget();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.GetScheduleOutputTarget);
    });
