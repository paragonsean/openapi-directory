...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.GetScheduleGroupOutput();
  });
  ...
  describe('GetScheduleGroupOutput', function() {
    it('should create an instance of GetScheduleGroupOutput', function() {
      // uncomment below and update the code to test GetScheduleGroupOutput
      //var instance = new AmazonEventBridgeScheduler.GetScheduleGroupOutput();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.GetScheduleGroupOutput);
    });
