...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEventBridgeScheduler.ListSchedulesOutput();
  });
  ...
  describe('ListSchedulesOutput', function() {
    it('should create an instance of ListSchedulesOutput', function() {
      // uncomment below and update the code to test ListSchedulesOutput
      //var instance = new AmazonEventBridgeScheduler.ListSchedulesOutput();
      //expect(instance).to.be.a(AmazonEventBridgeScheduler.ListSchedulesOutput);
    });
