...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://scheduler.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://scheduler.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-06-30/Javascript'
        };
