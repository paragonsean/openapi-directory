...
/**
 * The CreateScheduleRequest model module.
 * @module model/CreateScheduleRequest
 * @version 2021-06-30
 */
class CreateScheduleRequest {
    /**
     * Constructs a new <code>CreateScheduleRequest</code>.
     * @alias module:model/CreateScheduleRequest
    ...
    constructor(flexibleTimeWindow, scheduleExpression, target) { 
        ...
        CreateScheduleRequest.initialize(this, flexibleTimeWindow, scheduleExpression, target);
    }
    ...
    /**
     * Constructs a <code>CreateScheduleRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScheduleRequest} obj Optional instance to populate.
     * @return {module:model/CreateScheduleRequest} The populated <code>CreateScheduleRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScheduleRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScheduleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScheduleRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateScheduleRequest.RequiredProperties) {
...
CreateScheduleRequest.RequiredProperties = ["FlexibleTimeWindow", "ScheduleExpression", "Target"];

/**
 * Specifies the action that EventBridge Scheduler applies to the schedule after the schedule completes invoking the target.
 * @member {module:model/CreateScheduleRequest.ActionAfterCompletionEnum} ActionAfterCompletion
 */
CreateScheduleRequest.prototype['ActionAfterCompletion'] = undefined;

/**
 *  Unique, case-sensitive identifier you provide to ensure the idempotency of the request. If you do not specify a client token, EventBridge Scheduler uses a randomly generated token for the request to ensure idempotency. 
 * @member {String} ClientToken
 */
CreateScheduleRequest.prototype['ClientToken'] = undefined;

/**
 * The description you specify for the schedule.
 * @member {String} Description
 */
CreateScheduleRequest.prototype['Description'] = undefined;
 ...
 * @member {Date} EndDate
 */
CreateScheduleRequest.prototype['EndDate'] = undefined;

/**
 * @member {module:model/UpdateScheduleRequestFlexibleTimeWindow} FlexibleTimeWindow
 */
CreateScheduleRequest.prototype['FlexibleTimeWindow'] = undefined;

/**
 * The name of the schedule group to associate with this schedule. If you omit this, the default schedule group is used.
 * @member {String} GroupName
 */
CreateScheduleRequest.prototype['GroupName'] = undefined;

/**
 * The Amazon Resource Name (ARN) for the customer managed KMS key that EventBridge Scheduler will use to encrypt and decrypt your data.
 * @member {String} KmsKeyArn
 */
CreateScheduleRequest.prototype['KmsKeyArn'] = undefined;

/**
 * <p> The expression that defines when the schedule runs. The following formats are supported. </p> <ul> <li> <p> <code>at</code> expression - <code>at(yyyy-mm-ddThh:mm:ss)</code> </p> </li> <li> <p> <code>rate</code> expression - <code>rate(value unit)</code> </p> </li> <li> <p> <code>cron</code> expression - <code>cron(fields)</code> </p> </li> </ul> <p> You can use <code>at</code> expressions to create one-time schedules that invoke a target once, at the time and in the time zone, that you specify. You can use <code>rate</code> and <code>cron</code> expressions to create recurring schedules. Rate-based schedules are useful when you want to invoke a target at regular intervals, such as every 15 minutes or every five days. Cron-based schedules are useful when you want to invoke a target periodically at a specific time, such as at 8:00 am (UTC+0) every 1st day of the month. </p> <p> A <code>cron</code> expression consists of six fields separated by white spaces: <code>(minutes hours day_of_month month day_of_week year)</code>. </p> <p> A <code>rate</code> expression consists of a <i>value</i> as a positive integer, and a <i>unit</i> with the following options: <code>minute</code> | <code>minutes</code> | <code>hour</code> | <code>hours</code> | <code>day</code> | <code>days</code> </p> <p> For more information and examples, see <a href=\"https://docs.aws.amazon.com/scheduler/latest/UserGuide/schedule-types.html\">Schedule types on EventBridge Scheduler</a> in the <i>EventBridge Scheduler User Guide</i>. </p>
 * @member {String} ScheduleExpression
 */
CreateScheduleRequest.prototype['ScheduleExpression'] = undefined;

/**
 * The timezone in which the scheduling expression is evaluated.
 * @member {String} ScheduleExpressionTimezone
 */
CreateScheduleRequest.prototype['ScheduleExpressionTimezone'] = undefined;
 ...
 */
CreateScheduleRequest.prototype['StartDate'] = undefined;

/**
 * Specifies whether the schedule is enabled or disabled.
 * @member {module:model/CreateScheduleRequest.StateEnum} State
 */
CreateScheduleRequest.prototype['State'] = undefined;

/**
 * @member {module:model/UpdateScheduleRequestTarget} Target
 */
CreateScheduleRequest.prototype['Target'] = undefined;
 ...
 * @readonly
 */
CreateScheduleRequest['ActionAfterCompletionEnum'] = {
 ...
 * @readonly
 */
CreateScheduleRequest['StateEnum'] = {
