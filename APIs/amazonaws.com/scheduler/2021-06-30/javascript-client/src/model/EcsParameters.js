...
/**
 * The EcsParameters model module.
 * @module model/EcsParameters
 * @version 2021-06-30
 */
class EcsParameters {
    /**
     * Constructs a new <code>EcsParameters</code>.
     ...
     * @alias module:model/EcsParameters
    ...
    /**
     * Constructs a <code>EcsParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EcsParameters} obj Optional instance to populate.
     * @return {module:model/EcsParameters} The populated <code>EcsParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EcsParameters();
    ...
    /**
     * Validates the JSON data with respect to <code>EcsParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EcsParameters</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EcsParameters.RequiredProperties) {
...
EcsParameters.RequiredProperties = ["TaskDefinitionArn"];
