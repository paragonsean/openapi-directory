...
public class UpdateScheduleInputTarget {
  ...
  public UpdateScheduleInputTarget() {
  }

  public UpdateScheduleInputTarget arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateScheduleInputTarget deadLetterConfig(UpdateScheduleRequestTargetDeadLetterConfig deadLetterConfig) {
  ...
  public UpdateScheduleInputTarget ecsParameters(UpdateScheduleRequestTargetEcsParameters ecsParameters) {
  ...
  public UpdateScheduleInputTarget eventBridgeParameters(UpdateScheduleRequestTargetEventBridgeParameters eventBridgeParameters) {
  ...
  public UpdateScheduleInputTarget input(String input) {
    this.input = input;
    return this;
  }
  ...
  public UpdateScheduleInputTarget kinesisParameters(UpdateScheduleRequestTargetKinesisParameters kinesisParameters) {
  ...
  public UpdateScheduleInputTarget retryPolicy(UpdateScheduleRequestTargetRetryPolicy retryPolicy) {
  ...
  public UpdateScheduleInputTarget roleArn(String roleArn) {
  ...
  public UpdateScheduleInputTarget sageMakerPipelineParameters(UpdateScheduleRequestTargetSageMakerPipelineParameters sageMakerPipelineParameters) {
  ...
  public UpdateScheduleInputTarget sqsParameters(UpdateScheduleRequestTargetSqsParameters sqsParameters) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateScheduleInputTarget updateScheduleInputTarget = (UpdateScheduleInputTarget) o;
    return Objects.equals(this.arn, updateScheduleInputTarget.arn) &&
        Objects.equals(this.deadLetterConfig, updateScheduleInputTarget.deadLetterConfig) &&
        Objects.equals(this.ecsParameters, updateScheduleInputTarget.ecsParameters) &&
        Objects.equals(this.eventBridgeParameters, updateScheduleInputTarget.eventBridgeParameters) &&
        Objects.equals(this.input, updateScheduleInputTarget.input) &&
        Objects.equals(this.kinesisParameters, updateScheduleInputTarget.kinesisParameters) &&
        Objects.equals(this.retryPolicy, updateScheduleInputTarget.retryPolicy) &&
        Objects.equals(this.roleArn, updateScheduleInputTarget.roleArn) &&
        Objects.equals(this.sageMakerPipelineParameters, updateScheduleInputTarget.sageMakerPipelineParameters) &&
        Objects.equals(this.sqsParameters, updateScheduleInputTarget.sqsParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateScheduleInputTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateScheduleInputTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateScheduleInputTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateScheduleInputTarget is not found in the empty JSON string", UpdateScheduleInputTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateScheduleInputTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateScheduleInputTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateScheduleInputTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateScheduleInputTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateScheduleInputTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateScheduleInputTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateScheduleInputTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateScheduleInputTarget>() {
           @Override
           public void write(JsonWriter out, UpdateScheduleInputTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateScheduleInputTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateScheduleInputTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateScheduleInputTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateScheduleInputTarget
   */
  public static UpdateScheduleInputTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateScheduleInputTarget.class);
  }

  /**
   * Convert an instance of UpdateScheduleInputTarget to an JSON string
   *
   * @return JSON string
   */
