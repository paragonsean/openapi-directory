...
public class UpdateScheduleRequestTarget {
  ...
  public UpdateScheduleRequestTarget() {
  }

  public UpdateScheduleRequestTarget arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateScheduleRequestTarget deadLetterConfig(UpdateScheduleRequestTargetDeadLetterConfig deadLetterConfig) {
  ...
  public UpdateScheduleRequestTarget ecsParameters(UpdateScheduleRequestTargetEcsParameters ecsParameters) {
  ...
  public UpdateScheduleRequestTarget eventBridgeParameters(UpdateScheduleRequestTargetEventBridgeParameters eventBridgeParameters) {
  ...
  public UpdateScheduleRequestTarget input(String input) {
    this.input = input;
    return this;
  }
  ...
  public UpdateScheduleRequestTarget kinesisParameters(UpdateScheduleRequestTargetKinesisParameters kinesisParameters) {
  ...
  public UpdateScheduleRequestTarget retryPolicy(UpdateScheduleRequestTargetRetryPolicy retryPolicy) {
  ...
  public UpdateScheduleRequestTarget roleArn(String roleArn) {
  ...
  public UpdateScheduleRequestTarget sageMakerPipelineParameters(UpdateScheduleRequestTargetSageMakerPipelineParameters sageMakerPipelineParameters) {
  ...
  public UpdateScheduleRequestTarget sqsParameters(UpdateScheduleRequestTargetSqsParameters sqsParameters) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateScheduleRequestTarget updateScheduleRequestTarget = (UpdateScheduleRequestTarget) o;
    return Objects.equals(this.arn, updateScheduleRequestTarget.arn) &&
        Objects.equals(this.deadLetterConfig, updateScheduleRequestTarget.deadLetterConfig) &&
        Objects.equals(this.ecsParameters, updateScheduleRequestTarget.ecsParameters) &&
        Objects.equals(this.eventBridgeParameters, updateScheduleRequestTarget.eventBridgeParameters) &&
        Objects.equals(this.input, updateScheduleRequestTarget.input) &&
        Objects.equals(this.kinesisParameters, updateScheduleRequestTarget.kinesisParameters) &&
        Objects.equals(this.retryPolicy, updateScheduleRequestTarget.retryPolicy) &&
        Objects.equals(this.roleArn, updateScheduleRequestTarget.roleArn) &&
        Objects.equals(this.sageMakerPipelineParameters, updateScheduleRequestTarget.sageMakerPipelineParameters) &&
        Objects.equals(this.sqsParameters, updateScheduleRequestTarget.sqsParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateScheduleRequestTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateScheduleRequestTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateScheduleRequestTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateScheduleRequestTarget is not found in the empty JSON string", UpdateScheduleRequestTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateScheduleRequestTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateScheduleRequestTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateScheduleRequestTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateScheduleRequestTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateScheduleRequestTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateScheduleRequestTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateScheduleRequestTarget>() {
           @Override
           public void write(JsonWriter out, UpdateScheduleRequestTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateScheduleRequestTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateScheduleRequestTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateScheduleRequestTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateScheduleRequestTarget
   */
  public static UpdateScheduleRequestTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateScheduleRequestTarget.class);
  }

  /**
   * Convert an instance of UpdateScheduleRequestTarget to an JSON string
   *
   * @return JSON string
   */
