...
public class CreateScheduleInputTarget {
  ...
  public CreateScheduleInputTarget() {
  }

  public CreateScheduleInputTarget arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateScheduleInputTarget deadLetterConfig(UpdateScheduleRequestTargetDeadLetterConfig deadLetterConfig) {
  ...
  public CreateScheduleInputTarget ecsParameters(UpdateScheduleRequestTargetEcsParameters ecsParameters) {
  ...
  public CreateScheduleInputTarget eventBridgeParameters(UpdateScheduleRequestTargetEventBridgeParameters eventBridgeParameters) {
  ...
  public CreateScheduleInputTarget input(String input) {
    this.input = input;
    return this;
  }
  ...
  public CreateScheduleInputTarget kinesisParameters(UpdateScheduleRequestTargetKinesisParameters kinesisParameters) {
  ...
  public CreateScheduleInputTarget retryPolicy(UpdateScheduleRequestTargetRetryPolicy retryPolicy) {
  ...
  public CreateScheduleInputTarget roleArn(String roleArn) {
  ...
  public CreateScheduleInputTarget sageMakerPipelineParameters(UpdateScheduleRequestTargetSageMakerPipelineParameters sageMakerPipelineParameters) {
  ...
  public CreateScheduleInputTarget sqsParameters(UpdateScheduleRequestTargetSqsParameters sqsParameters) {
  ...
  public boolean equals(Object o) {
    ...
    CreateScheduleInputTarget createScheduleInputTarget = (CreateScheduleInputTarget) o;
    return Objects.equals(this.arn, createScheduleInputTarget.arn) &&
        Objects.equals(this.deadLetterConfig, createScheduleInputTarget.deadLetterConfig) &&
        Objects.equals(this.ecsParameters, createScheduleInputTarget.ecsParameters) &&
        Objects.equals(this.eventBridgeParameters, createScheduleInputTarget.eventBridgeParameters) &&
        Objects.equals(this.input, createScheduleInputTarget.input) &&
        Objects.equals(this.kinesisParameters, createScheduleInputTarget.kinesisParameters) &&
        Objects.equals(this.retryPolicy, createScheduleInputTarget.retryPolicy) &&
        Objects.equals(this.roleArn, createScheduleInputTarget.roleArn) &&
        Objects.equals(this.sageMakerPipelineParameters, createScheduleInputTarget.sageMakerPipelineParameters) &&
        Objects.equals(this.sqsParameters, createScheduleInputTarget.sqsParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateScheduleInputTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateScheduleInputTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateScheduleInputTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateScheduleInputTarget is not found in the empty JSON string", CreateScheduleInputTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateScheduleInputTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateScheduleInputTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateScheduleInputTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateScheduleInputTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateScheduleInputTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateScheduleInputTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateScheduleInputTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateScheduleInputTarget>() {
           @Override
           public void write(JsonWriter out, CreateScheduleInputTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateScheduleInputTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateScheduleInputTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateScheduleInputTarget
   * @throws IOException if the JSON string is invalid with respect to CreateScheduleInputTarget
   */
  public static CreateScheduleInputTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateScheduleInputTarget.class);
  }

  /**
   * Convert an instance of CreateScheduleInputTarget to an JSON string
   *
   * @return JSON string
   */
