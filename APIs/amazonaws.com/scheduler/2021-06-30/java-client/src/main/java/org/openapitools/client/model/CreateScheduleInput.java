...
import org.openapitools.client.model.CreateScheduleInputTarget;
...
public class CreateScheduleInput {
  ...
  private CreateScheduleInputTarget target;

  public CreateScheduleInput() {
  }

  public CreateScheduleInput actionAfterCompletion(ActionAfterCompletion actionAfterCompletion) {
  ...
  public CreateScheduleInput clientToken(String clientToken) {
  ...
  public CreateScheduleInput description(String description) {
  ...
  public CreateScheduleInput endDate(OffsetDateTime endDate) {
  ...
  public CreateScheduleInput flexibleTimeWindow(GetScheduleOutputFlexibleTimeWindow flexibleTimeWindow) {
  ...
  public CreateScheduleInput groupName(String groupName) {
  ...
  public CreateScheduleInput kmsKeyArn(String kmsKeyArn) {
  ...
  public CreateScheduleInput scheduleExpression(String scheduleExpression) {
  ...
  public CreateScheduleInput scheduleExpressionTimezone(String scheduleExpressionTimezone) {
  ...
  public CreateScheduleInput startDate(OffsetDateTime startDate) {
  ...
  public CreateScheduleInput state(ScheduleState state) {
    this.state = state;
    return this;
  }
  ...
  public CreateScheduleInput target(CreateScheduleInputTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public CreateScheduleInputTarget getTarget() {
    return target;
  }

  public void setTarget(CreateScheduleInputTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateScheduleInput createScheduleInput = (CreateScheduleInput) o;
    return Objects.equals(this.actionAfterCompletion, createScheduleInput.actionAfterCompletion) &&
        Objects.equals(this.clientToken, createScheduleInput.clientToken) &&
        Objects.equals(this.description, createScheduleInput.description) &&
        Objects.equals(this.endDate, createScheduleInput.endDate) &&
        Objects.equals(this.flexibleTimeWindow, createScheduleInput.flexibleTimeWindow) &&
        Objects.equals(this.groupName, createScheduleInput.groupName) &&
        Objects.equals(this.kmsKeyArn, createScheduleInput.kmsKeyArn) &&
        Objects.equals(this.scheduleExpression, createScheduleInput.scheduleExpression) &&
        Objects.equals(this.scheduleExpressionTimezone, createScheduleInput.scheduleExpressionTimezone) &&
        Objects.equals(this.startDate, createScheduleInput.startDate) &&
        Objects.equals(this.state, createScheduleInput.state) &&
        Objects.equals(this.target, createScheduleInput.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateScheduleInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateScheduleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateScheduleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateScheduleInput is not found in the empty JSON string", CreateScheduleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateScheduleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateScheduleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateScheduleInput.openapiRequiredFields) {
      ...
      CreateScheduleInputTarget.validateJsonElement(jsonObj.get("Target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateScheduleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateScheduleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateScheduleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateScheduleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateScheduleInput>() {
           @Override
           public void write(JsonWriter out, CreateScheduleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateScheduleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateScheduleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateScheduleInput
   * @throws IOException if the JSON string is invalid with respect to CreateScheduleInput
   */
  public static CreateScheduleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateScheduleInput.class);
  }

  /**
   * Convert an instance of CreateScheduleInput to an JSON string
   *
   * @return JSON string
   */
