...
public class GetScheduleOutputTarget {
  ...
  public GetScheduleOutputTarget() {
  }

  public GetScheduleOutputTarget arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetScheduleOutputTarget deadLetterConfig(UpdateScheduleRequestTargetDeadLetterConfig deadLetterConfig) {
  ...
  public GetScheduleOutputTarget ecsParameters(UpdateScheduleRequestTargetEcsParameters ecsParameters) {
  ...
  public GetScheduleOutputTarget eventBridgeParameters(UpdateScheduleRequestTargetEventBridgeParameters eventBridgeParameters) {
  ...
  public GetScheduleOutputTarget input(String input) {
    this.input = input;
    return this;
  }
  ...
  public GetScheduleOutputTarget kinesisParameters(UpdateScheduleRequestTargetKinesisParameters kinesisParameters) {
  ...
  public GetScheduleOutputTarget retryPolicy(UpdateScheduleRequestTargetRetryPolicy retryPolicy) {
  ...
  public GetScheduleOutputTarget roleArn(String roleArn) {
  ...
  public GetScheduleOutputTarget sageMakerPipelineParameters(UpdateScheduleRequestTargetSageMakerPipelineParameters sageMakerPipelineParameters) {
  ...
  public GetScheduleOutputTarget sqsParameters(UpdateScheduleRequestTargetSqsParameters sqsParameters) {
  ...
  public boolean equals(Object o) {
    ...
    GetScheduleOutputTarget getScheduleOutputTarget = (GetScheduleOutputTarget) o;
    return Objects.equals(this.arn, getScheduleOutputTarget.arn) &&
        Objects.equals(this.deadLetterConfig, getScheduleOutputTarget.deadLetterConfig) &&
        Objects.equals(this.ecsParameters, getScheduleOutputTarget.ecsParameters) &&
        Objects.equals(this.eventBridgeParameters, getScheduleOutputTarget.eventBridgeParameters) &&
        Objects.equals(this.input, getScheduleOutputTarget.input) &&
        Objects.equals(this.kinesisParameters, getScheduleOutputTarget.kinesisParameters) &&
        Objects.equals(this.retryPolicy, getScheduleOutputTarget.retryPolicy) &&
        Objects.equals(this.roleArn, getScheduleOutputTarget.roleArn) &&
        Objects.equals(this.sageMakerPipelineParameters, getScheduleOutputTarget.sageMakerPipelineParameters) &&
        Objects.equals(this.sqsParameters, getScheduleOutputTarget.sqsParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetScheduleOutputTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetScheduleOutputTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetScheduleOutputTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetScheduleOutputTarget is not found in the empty JSON string", GetScheduleOutputTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetScheduleOutputTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetScheduleOutputTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetScheduleOutputTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetScheduleOutputTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetScheduleOutputTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetScheduleOutputTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetScheduleOutputTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<GetScheduleOutputTarget>() {
           @Override
           public void write(JsonWriter out, GetScheduleOutputTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetScheduleOutputTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetScheduleOutputTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetScheduleOutputTarget
   * @throws IOException if the JSON string is invalid with respect to GetScheduleOutputTarget
   */
  public static GetScheduleOutputTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetScheduleOutputTarget.class);
  }

  /**
   * Convert an instance of GetScheduleOutputTarget to an JSON string
   *
   * @return JSON string
   */
