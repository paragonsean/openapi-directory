...
/*
 * OAIUpdateSchedule_request.h
 *
 * 
 */

#ifndef OAIUpdateSchedule_request_H
#define OAIUpdateSchedule_request_H
...
class OAIUpdateSchedule_request : public OAIObject {
public:
    OAIUpdateSchedule_request();
    OAIUpdateSchedule_request(QString json);
    ~OAIUpdateSchedule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSchedule_request)

#endif // OAIUpdateSchedule_request_H
