...
/*
 * OAIFlexibleTimeWindow.h
 *
 * Allows you to configure a time window during which EventBridge Scheduler invokes the schedule.
 */

#ifndef OAIFlexibleTimeWindow_H
#define OAIFlexibleTimeWindow_H
...
class OAIFlexibleTimeWindow : public OAIObject {
public:
    OAIFlexibleTimeWindow();
    OAIFlexibleTimeWindow(QString json);
    ~OAIFlexibleTimeWindow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlexibleTimeWindow)

#endif // OAIFlexibleTimeWindow_H
