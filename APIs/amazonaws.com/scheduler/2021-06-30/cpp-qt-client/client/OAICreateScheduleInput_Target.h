...
/*
 * OAICreateScheduleInput_Target.h
 *
 * 
 */

#ifndef OAICreateScheduleInput_Target_H
#define OAICreateScheduleInput_Target_H
...
class OAICreateScheduleInput_Target : public OAIObject {
public:
    OAICreateScheduleInput_Target();
    OAICreateScheduleInput_Target(QString json);
    ~OAICreateScheduleInput_Target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScheduleInput_Target)

#endif // OAICreateScheduleInput_Target_H
