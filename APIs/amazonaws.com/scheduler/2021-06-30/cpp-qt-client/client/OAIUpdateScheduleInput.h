...
/*
 * OAIUpdateScheduleInput.h
 *
 * 
 */

#ifndef OAIUpdateScheduleInput_H
#define OAIUpdateScheduleInput_H
...
class OAIUpdateScheduleInput_Target;

class OAIUpdateScheduleInput : public OAIObject {
public:
    OAIUpdateScheduleInput();
    OAIUpdateScheduleInput(QString json);
    ~OAIUpdateScheduleInput() override;
    ...
    OAIUpdateScheduleInput_Target getTarget() const;
    void setTarget(const OAIUpdateScheduleInput_Target &target);
...
private:
    ...
    OAIUpdateScheduleInput_Target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateScheduleInput)

#endif // OAIUpdateScheduleInput_H
