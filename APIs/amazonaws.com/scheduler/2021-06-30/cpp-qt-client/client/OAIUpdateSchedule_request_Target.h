...
/*
 * OAIUpdateSchedule_request_Target.h
 *
 * The schedule&#39;s target. EventBridge Scheduler supports templated target that invoke common API operations, as well as universal targets that you can customize to invoke over 6,000 API operations across more than 270 services. You can only specify one templated or universal target for a schedule.
 */

#ifndef OAIUpdateSchedule_request_Target_H
#define OAIUpdateSchedule_request_Target_H
...
class OAIUpdateSchedule_request_Target : public OAIObject {
public:
    OAIUpdateSchedule_request_Target();
    OAIUpdateSchedule_request_Target(QString json);
    ~OAIUpdateSchedule_request_Target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSchedule_request_Target)

#endif // OAIUpdateSchedule_request_Target_H
