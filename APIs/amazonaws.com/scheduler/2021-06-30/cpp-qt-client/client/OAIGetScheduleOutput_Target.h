...
/*
 * OAIGetScheduleOutput_Target.h
 *
 * 
 */

#ifndef OAIGetScheduleOutput_Target_H
#define OAIGetScheduleOutput_Target_H
...
class OAIGetScheduleOutput_Target : public OAIObject {
public:
    OAIGetScheduleOutput_Target();
    OAIGetScheduleOutput_Target(QString json);
    ~OAIGetScheduleOutput_Target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetScheduleOutput_Target)

#endif // OAIGetScheduleOutput_Target_H
