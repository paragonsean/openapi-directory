...
/*
 * OAIUpdateSchedule_request_Target_EcsParameters.h
 *
 * 
 */

#ifndef OAIUpdateSchedule_request_Target_EcsParameters_H
#define OAIUpdateSchedule_request_Target_EcsParameters_H
...
class OAIUpdateSchedule_request_Target_EcsParameters : public OAIObject {
public:
    OAIUpdateSchedule_request_Target_EcsParameters();
    OAIUpdateSchedule_request_Target_EcsParameters(QString json);
    ~OAIUpdateSchedule_request_Target_EcsParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSchedule_request_Target_EcsParameters)

#endif // OAIUpdateSchedule_request_Target_EcsParameters_H
