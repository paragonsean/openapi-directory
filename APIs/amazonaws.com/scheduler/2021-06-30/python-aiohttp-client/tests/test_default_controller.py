...
async def test_create_schedule(client):
    ...
    """
    body = openapi_server.CreateScheduleRequest()
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/schedules/{name}'.format(name='name_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_schedule_group(client):
    """Test case for create_schedule_group

    
    """
    body = openapi_server.CreateScheduleGroupRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/schedule-groups/{name}'.format(name='name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_schedule_group(client):
    """Test case for delete_schedule_group
...
async def test_get_schedule_group(client):
    """Test case for get_schedule_group
...
async def test_list_schedule_groups(client):
    """Test case for list_schedule_groups
...
async def test_list_schedules(client):
    ...
    """
    params = [('ScheduleGroup', 'schedule_group_example'),
                    ('MaxResults', 56),
                    ('NamePrefix', 'name_prefix_example'),
                    ('NextToken', 'next_token_example'),
                    ('State', 'state_example')]
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/tags/{resource_arn_tag_key}'.format(resource_arn='resource_arn_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_schedule(client):
    ...
    """
    body = openapi_server.UpdateScheduleRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
