...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfiguration();
  });
  ...
  describe('MediaInsightsPipelineConfiguration', function() {
    it('should create an instance of MediaInsightsPipelineConfiguration', function() {
      // uncomment below and update the code to test MediaInsightsPipelineConfiguration
      //var instance = new AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfiguration();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfiguration);
    });
