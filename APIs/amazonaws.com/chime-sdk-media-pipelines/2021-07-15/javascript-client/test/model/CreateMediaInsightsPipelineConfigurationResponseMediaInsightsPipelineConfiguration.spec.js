...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration();
  });
  ...
  describe('CreateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration', function() {
    it('should create an instance of CreateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration', function() {
      // uncomment below and update the code to test CreateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
      //var instance = new AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration);
    });
