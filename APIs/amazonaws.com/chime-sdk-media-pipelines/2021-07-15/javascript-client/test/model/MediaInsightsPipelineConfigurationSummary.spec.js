...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfigurationSummary();
  });
  ...
  describe('MediaInsightsPipelineConfigurationSummary', function() {
    it('should create an instance of MediaInsightsPipelineConfigurationSummary', function() {
      // uncomment below and update the code to test MediaInsightsPipelineConfigurationSummary
      //var instance = new AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfigurationSummary();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfigurationSummary);
    });
