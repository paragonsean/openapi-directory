...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.ArtifactsConfiguration();
  });
  ...
  describe('ArtifactsConfiguration', function() {
    it('should create an instance of ArtifactsConfiguration', function() {
      // uncomment below and update the code to test ArtifactsConfiguration
      //var instance = new AmazonChimeSdkMediaPipelines.ArtifactsConfiguration();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.ArtifactsConfiguration);
    });
