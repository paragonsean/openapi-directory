...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.KeywordMatchConfiguration();
  });
  ...
  describe('KeywordMatchConfiguration', function() {
    it('should create an instance of KeywordMatchConfiguration', function() {
      // uncomment below and update the code to test KeywordMatchConfiguration
      //var instance = new AmazonChimeSdkMediaPipelines.KeywordMatchConfiguration();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.KeywordMatchConfiguration);
    });
