...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration();
  });
  ...
  describe('UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration', function() {
    it('should create an instance of UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration', function() {
      // uncomment below and update the code to test UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
      //var instance = new AmazonChimeSdkMediaPipelines.UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration);
    });
