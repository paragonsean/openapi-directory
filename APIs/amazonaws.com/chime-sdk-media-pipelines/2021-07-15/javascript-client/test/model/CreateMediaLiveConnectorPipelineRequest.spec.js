...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.CreateMediaLiveConnectorPipelineRequest();
  });
  ...
  describe('CreateMediaLiveConnectorPipelineRequest', function() {
    it('should create an instance of CreateMediaLiveConnectorPipelineRequest', function() {
      // uncomment below and update the code to test CreateMediaLiveConnectorPipelineRequest
      //var instance = new AmazonChimeSdkMediaPipelines.CreateMediaLiveConnectorPipelineRequest();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.CreateMediaLiveConnectorPipelineRequest);
    });
