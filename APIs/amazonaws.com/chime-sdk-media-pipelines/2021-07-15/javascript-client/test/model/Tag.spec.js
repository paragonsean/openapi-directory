...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AmazonChimeSdkMediaPipelines.Tag();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.Tag);
    });
