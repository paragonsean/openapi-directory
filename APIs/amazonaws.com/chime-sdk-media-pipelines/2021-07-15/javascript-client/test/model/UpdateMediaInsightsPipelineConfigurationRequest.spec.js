...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.UpdateMediaInsightsPipelineConfigurationRequest();
  });
  ...
  describe('UpdateMediaInsightsPipelineConfigurationRequest', function() {
    it('should create an instance of UpdateMediaInsightsPipelineConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateMediaInsightsPipelineConfigurationRequest
      //var instance = new AmazonChimeSdkMediaPipelines.UpdateMediaInsightsPipelineConfigurationRequest();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.UpdateMediaInsightsPipelineConfigurationRequest);
    });
