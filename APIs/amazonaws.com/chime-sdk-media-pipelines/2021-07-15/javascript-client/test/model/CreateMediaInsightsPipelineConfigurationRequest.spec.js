...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineConfigurationRequest();
  });
  ...
  describe('CreateMediaInsightsPipelineConfigurationRequest', function() {
    it('should create an instance of CreateMediaInsightsPipelineConfigurationRequest', function() {
      // uncomment below and update the code to test CreateMediaInsightsPipelineConfigurationRequest
      //var instance = new AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineConfigurationRequest();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineConfigurationRequest);
    });
