...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.TimestampRange();
  });
  ...
  describe('TimestampRange', function() {
    it('should create an instance of TimestampRange', function() {
      ...
      //var instance = new AmazonChimeSdkMediaPipelines.TimestampRange();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.TimestampRange);
    });
