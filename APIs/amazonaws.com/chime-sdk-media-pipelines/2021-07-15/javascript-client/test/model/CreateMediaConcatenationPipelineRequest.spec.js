...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.CreateMediaConcatenationPipelineRequest();
  });
  ...
  describe('CreateMediaConcatenationPipelineRequest', function() {
    it('should create an instance of CreateMediaConcatenationPipelineRequest', function() {
      // uncomment below and update the code to test CreateMediaConcatenationPipelineRequest
      //var instance = new AmazonChimeSdkMediaPipelines.CreateMediaConcatenationPipelineRequest();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.CreateMediaConcatenationPipelineRequest);
    });
