...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.MediaPipelineMediaInsightsPipeline();
  });
  ...
  describe('MediaPipelineMediaInsightsPipeline', function() {
    it('should create an instance of MediaPipelineMediaInsightsPipeline', function() {
      // uncomment below and update the code to test MediaPipelineMediaInsightsPipeline
      //var instance = new AmazonChimeSdkMediaPipelines.MediaPipelineMediaInsightsPipeline();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.MediaPipelineMediaInsightsPipeline);
    });
