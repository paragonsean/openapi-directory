...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.ChannelDefinition();
  });
  ...
  describe('ChannelDefinition', function() {
    it('should create an instance of ChannelDefinition', function() {
      // uncomment below and update the code to test ChannelDefinition
      //var instance = new AmazonChimeSdkMediaPipelines.ChannelDefinition();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.ChannelDefinition);
    });
