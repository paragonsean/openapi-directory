...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.ArtifactsConcatenationConfiguration();
  });
  ...
  describe('ArtifactsConcatenationConfiguration', function() {
    it('should create an instance of ArtifactsConcatenationConfiguration', function() {
      // uncomment below and update the code to test ArtifactsConcatenationConfiguration
      //var instance = new AmazonChimeSdkMediaPipelines.ArtifactsConcatenationConfiguration();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.ArtifactsConcatenationConfiguration);
    });
