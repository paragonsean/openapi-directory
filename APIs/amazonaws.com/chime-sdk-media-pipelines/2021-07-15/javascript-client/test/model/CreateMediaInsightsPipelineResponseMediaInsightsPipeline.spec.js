...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineResponseMediaInsightsPipeline();
  });
  ...
  describe('CreateMediaInsightsPipelineResponseMediaInsightsPipeline', function() {
    it('should create an instance of CreateMediaInsightsPipelineResponseMediaInsightsPipeline', function() {
      // uncomment below and update the code to test CreateMediaInsightsPipelineResponseMediaInsightsPipeline
      //var instance = new AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineResponseMediaInsightsPipeline();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.CreateMediaInsightsPipelineResponseMediaInsightsPipeline);
    });
