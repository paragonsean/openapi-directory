...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration();
  });
  ...
  describe('MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration', function() {
    it('should create an instance of MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration', function() {
      // uncomment below and update the code to test MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration
      //var instance = new AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration();
      //expect(instance).to.be.a(AmazonChimeSdkMediaPipelines.MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration);
    });
