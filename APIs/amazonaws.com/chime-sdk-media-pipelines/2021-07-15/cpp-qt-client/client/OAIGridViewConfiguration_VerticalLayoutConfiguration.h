...
/*
 * OAIGridViewConfiguration_VerticalLayoutConfiguration.h
 *
 * 
 */

#ifndef OAIGridViewConfiguration_VerticalLayoutConfiguration_H
#define OAIGridViewConfiguration_VerticalLayoutConfiguration_H
...
class OAIGridViewConfiguration_VerticalLayoutConfiguration : public OAIObject {
public:
    OAIGridViewConfiguration_VerticalLayoutConfiguration();
    OAIGridViewConfiguration_VerticalLayoutConfiguration(QString json);
    ~OAIGridViewConfiguration_VerticalLayoutConfiguration() override;
    ...
    OAIVerticalTilePosition getTilePosition() const;
    void setTilePosition(const OAIVerticalTilePosition &tile_position);
...
private:
    ...
    OAIVerticalTilePosition m_tile_position;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGridViewConfiguration_VerticalLayoutConfiguration)

#endif // OAIGridViewConfiguration_VerticalLayoutConfiguration_H
