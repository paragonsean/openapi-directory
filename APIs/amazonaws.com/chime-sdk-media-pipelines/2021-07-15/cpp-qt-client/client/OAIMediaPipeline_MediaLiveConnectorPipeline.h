...
/*
 * OAIMediaPipeline_MediaLiveConnectorPipeline.h
 *
 * 
 */

#ifndef OAIMediaPipeline_MediaLiveConnectorPipeline_H
#define OAIMediaPipeline_MediaLiveConnectorPipeline_H
...
class OAIMediaPipeline_MediaLiveConnectorPipeline : public OAIObject {
public:
    OAIMediaPipeline_MediaLiveConnectorPipeline();
    OAIMediaPipeline_MediaLiveConnectorPipeline(QString json);
    ~OAIMediaPipeline_MediaLiveConnectorPipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaPipeline_MediaLiveConnectorPipeline)

#endif // OAIMediaPipeline_MediaLiveConnectorPipeline_H
