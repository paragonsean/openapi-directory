...
/*
 * OAIArtifactsConcatenationConfiguration.h
 *
 * The configuration for the artifacts concatenation.
 */

#ifndef OAIArtifactsConcatenationConfiguration_H
#define OAIArtifactsConcatenationConfiguration_H
...
class OAIArtifactsConcatenationConfiguration : public OAIObject {
public:
    OAIArtifactsConcatenationConfiguration();
    OAIArtifactsConcatenationConfiguration(QString json);
    ~OAIArtifactsConcatenationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactsConcatenationConfiguration)

#endif // OAIArtifactsConcatenationConfiguration_H
