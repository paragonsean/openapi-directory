...
/*
 * OAIMediaPipeline_MediaInsightsPipeline.h
 *
 * 
 */

#ifndef OAIMediaPipeline_MediaInsightsPipeline_H
#define OAIMediaPipeline_MediaInsightsPipeline_H
...
class OAIMediaPipeline_MediaInsightsPipeline : public OAIObject {
public:
    OAIMediaPipeline_MediaInsightsPipeline();
    OAIMediaPipeline_MediaInsightsPipeline(QString json);
    ~OAIMediaPipeline_MediaInsightsPipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaPipeline_MediaInsightsPipeline)

#endif // OAIMediaPipeline_MediaInsightsPipeline_H
