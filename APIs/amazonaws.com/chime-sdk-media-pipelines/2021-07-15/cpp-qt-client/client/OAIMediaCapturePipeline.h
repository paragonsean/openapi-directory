...
class OAIMediaCapturePipeline : public OAIObject {
public:
    OAIMediaCapturePipeline();
    OAIMediaCapturePipeline(QString json);
    ~OAIMediaCapturePipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaCapturePipeline)

#endif // OAIMediaCapturePipeline_H
