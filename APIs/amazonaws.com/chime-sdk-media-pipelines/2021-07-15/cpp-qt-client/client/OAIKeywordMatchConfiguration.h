...
/*
 * OAIKeywordMatchConfiguration.h
 *
 * A structure that contains the settings for a keyword match task.
 */

#ifndef OAIKeywordMatchConfiguration_H
#define OAIKeywordMatchConfiguration_H
...
class OAIKeywordMatchConfiguration : public OAIObject {
public:
    OAIKeywordMatchConfiguration();
    OAIKeywordMatchConfiguration(QString json);
    ~OAIKeywordMatchConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeywordMatchConfiguration)

#endif // OAIKeywordMatchConfiguration_H
