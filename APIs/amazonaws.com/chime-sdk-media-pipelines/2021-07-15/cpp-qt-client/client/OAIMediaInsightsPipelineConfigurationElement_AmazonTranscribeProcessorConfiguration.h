...
/*
 * OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration.h
 *
 * 
 */

#ifndef OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration_H
#define OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration_H
...
class OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration : public OAIObject {
public:
    OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration();
    OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration(QString json);
    ~OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration)

#endif // OAIMediaInsightsPipelineConfigurationElement_AmazonTranscribeProcessorConfiguration_H
