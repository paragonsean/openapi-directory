...
#ifndef OAIMediaPipeline_H
#define OAIMediaPipeline_H
...
class OAIMediaPipeline : public OAIObject {
public:
    OAIMediaPipeline();
    OAIMediaPipeline(QString json);
    ~OAIMediaPipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaPipeline)

#endif // OAIMediaPipeline_H
