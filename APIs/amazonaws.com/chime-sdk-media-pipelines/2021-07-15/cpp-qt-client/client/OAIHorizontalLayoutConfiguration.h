...
/*
 * OAIHorizontalLayoutConfiguration.h
 *
 * Defines the configuration settings for the horizontal layout.
 */

#ifndef OAIHorizontalLayoutConfiguration_H
#define OAIHorizontalLayoutConfiguration_H
...
class OAIHorizontalLayoutConfiguration : public OAIObject {
public:
    OAIHorizontalLayoutConfiguration();
    OAIHorizontalLayoutConfiguration(QString json);
    ~OAIHorizontalLayoutConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHorizontalLayoutConfiguration)

#endif // OAIHorizontalLayoutConfiguration_H
