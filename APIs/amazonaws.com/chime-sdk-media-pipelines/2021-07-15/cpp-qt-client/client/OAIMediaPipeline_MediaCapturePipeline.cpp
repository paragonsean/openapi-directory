...
OAIMediaPipeline_MediaCapturePipeline::OAIMediaPipeline_MediaCapturePipeline(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMediaPipeline_MediaCapturePipeline::OAIMediaPipeline_MediaCapturePipeline() {
    this->initializeModel();
}

OAIMediaPipeline_MediaCapturePipeline::~OAIMediaPipeline_MediaCapturePipeline() {}

void OAIMediaPipeline_MediaCapturePipeline::initializeModel() {
...
void OAIMediaPipeline_MediaCapturePipeline::fromJson(QString jsonString) {
...
void OAIMediaPipeline_MediaCapturePipeline::fromJsonObject(QJsonObject json) {
...
QString OAIMediaPipeline_MediaCapturePipeline::asJson() const {
...
QJsonObject OAIMediaPipeline_MediaCapturePipeline::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMediaPipeline_MediaCapturePipeline::getMediaPipelineId() const {
    return m_media_pipeline_id;
}
void OAIMediaPipeline_MediaCapturePipeline::setMediaPipelineId(const QString &media_pipeline_id) {
    m_media_pipeline_id = media_pipeline_id;
    m_media_pipeline_id_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_media_pipeline_id_Set() const{
    return m_media_pipeline_id_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_media_pipeline_id_Valid() const{
    return m_media_pipeline_id_isValid;
}

QString OAIMediaPipeline_MediaCapturePipeline::getMediaPipelineArn() const {
    return m_media_pipeline_arn;
}
void OAIMediaPipeline_MediaCapturePipeline::setMediaPipelineArn(const QString &media_pipeline_arn) {
    m_media_pipeline_arn = media_pipeline_arn;
    m_media_pipeline_arn_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_media_pipeline_arn_Set() const{
    return m_media_pipeline_arn_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_media_pipeline_arn_Valid() const{
    return m_media_pipeline_arn_isValid;
}

OAIMediaPipelineSourceType OAIMediaPipeline_MediaCapturePipeline::getSourceType() const {
    return m_source_type;
}
void OAIMediaPipeline_MediaCapturePipeline::setSourceType(const OAIMediaPipelineSourceType &source_type) {
    m_source_type = source_type;
    m_source_type_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_source_type_Set() const{
    return m_source_type_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_source_type_Valid() const{
    return m_source_type_isValid;
}

QString OAIMediaPipeline_MediaCapturePipeline::getSourceArn() const {
    return m_source_arn;
}
void OAIMediaPipeline_MediaCapturePipeline::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

OAIMediaPipelineStatus OAIMediaPipeline_MediaCapturePipeline::getStatus() const {
    return m_status;
}
void OAIMediaPipeline_MediaCapturePipeline::setStatus(const OAIMediaPipelineStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_status_Valid() const{
    return m_status_isValid;
}

OAIMediaPipelineSinkType OAIMediaPipeline_MediaCapturePipeline::getSinkType() const {
    return m_sink_type;
}
void OAIMediaPipeline_MediaCapturePipeline::setSinkType(const OAIMediaPipelineSinkType &sink_type) {
    m_sink_type = sink_type;
    m_sink_type_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_sink_type_Set() const{
    return m_sink_type_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_sink_type_Valid() const{
    return m_sink_type_isValid;
}

QString OAIMediaPipeline_MediaCapturePipeline::getSinkArn() const {
    return m_sink_arn;
}
void OAIMediaPipeline_MediaCapturePipeline::setSinkArn(const QString &sink_arn) {
    m_sink_arn = sink_arn;
    m_sink_arn_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_sink_arn_Set() const{
    return m_sink_arn_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_sink_arn_Valid() const{
    return m_sink_arn_isValid;
}

QDateTime OAIMediaPipeline_MediaCapturePipeline::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIMediaPipeline_MediaCapturePipeline::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIMediaPipeline_MediaCapturePipeline::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIMediaPipeline_MediaCapturePipeline::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

OAICreateMediaCapturePipelineRequest_ChimeSdkMeetingConfiguration OAIMediaPipeline_MediaCapturePipeline::getChimeSdkMeetingConfiguration() const {
    return m_chime_sdk_meeting_configuration;
}
void OAIMediaPipeline_MediaCapturePipeline::setChimeSdkMeetingConfiguration(const OAICreateMediaCapturePipelineRequest_ChimeSdkMeetingConfiguration &chime_sdk_meeting_configuration) {
    m_chime_sdk_meeting_configuration = chime_sdk_meeting_configuration;
    m_chime_sdk_meeting_configuration_isSet = true;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_chime_sdk_meeting_configuration_Set() const{
    return m_chime_sdk_meeting_configuration_isSet;
}

bool OAIMediaPipeline_MediaCapturePipeline::is_chime_sdk_meeting_configuration_Valid() const{
    return m_chime_sdk_meeting_configuration_isValid;
}

bool OAIMediaPipeline_MediaCapturePipeline::isSet() const {
...
bool OAIMediaPipeline_MediaCapturePipeline::isValid() const {
