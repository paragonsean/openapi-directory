...
#include "OAIVerticalLayoutConfiguration.h"
...
OAIVerticalLayoutConfiguration::OAIVerticalLayoutConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerticalLayoutConfiguration::OAIVerticalLayoutConfiguration() {
    this->initializeModel();
}

OAIVerticalLayoutConfiguration::~OAIVerticalLayoutConfiguration() {}

void OAIVerticalLayoutConfiguration::initializeModel() {
...
void OAIVerticalLayoutConfiguration::fromJson(QString jsonString) {
...
void OAIVerticalLayoutConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIVerticalLayoutConfiguration::asJson() const {
...
QJsonObject OAIVerticalLayoutConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAITileOrder OAIVerticalLayoutConfiguration::getTileOrder() const {
    return m_tile_order;
}
void OAIVerticalLayoutConfiguration::setTileOrder(const OAITileOrder &tile_order) {
    m_tile_order = tile_order;
    m_tile_order_isSet = true;
}

bool OAIVerticalLayoutConfiguration::is_tile_order_Set() const{
    return m_tile_order_isSet;
}

bool OAIVerticalLayoutConfiguration::is_tile_order_Valid() const{
    return m_tile_order_isValid;
}

OAIVerticalTilePosition OAIVerticalLayoutConfiguration::getTilePosition() const {
    return m_tile_position;
}
void OAIVerticalLayoutConfiguration::setTilePosition(const OAIVerticalTilePosition &tile_position) {
    m_tile_position = tile_position;
    m_tile_position_isSet = true;
}

bool OAIVerticalLayoutConfiguration::is_tile_position_Set() const{
    return m_tile_position_isSet;
}

bool OAIVerticalLayoutConfiguration::is_tile_position_Valid() const{
    return m_tile_position_isValid;
}

qint32 OAIVerticalLayoutConfiguration::getTileCount() const {
    return m_tile_count;
}
void OAIVerticalLayoutConfiguration::setTileCount(const qint32 &tile_count) {
    m_tile_count = tile_count;
    m_tile_count_isSet = true;
}

bool OAIVerticalLayoutConfiguration::is_tile_count_Set() const{
    return m_tile_count_isSet;
}

bool OAIVerticalLayoutConfiguration::is_tile_count_Valid() const{
    return m_tile_count_isValid;
}

QString OAIVerticalLayoutConfiguration::getTileAspectRatio() const {
    return m_tile_aspect_ratio;
}
void OAIVerticalLayoutConfiguration::setTileAspectRatio(const QString &tile_aspect_ratio) {
    m_tile_aspect_ratio = tile_aspect_ratio;
    m_tile_aspect_ratio_isSet = true;
}

bool OAIVerticalLayoutConfiguration::is_tile_aspect_ratio_Set() const{
    return m_tile_aspect_ratio_isSet;
}

bool OAIVerticalLayoutConfiguration::is_tile_aspect_ratio_Valid() const{
    return m_tile_aspect_ratio_isValid;
}

bool OAIVerticalLayoutConfiguration::isSet() const {
...
bool OAIVerticalLayoutConfiguration::isValid() const {
