...
/*
 * OAIVerticalLayoutConfiguration.h
 *
 * Defines the configuration settings for a vertial layout.
 */

#ifndef OAIVerticalLayoutConfiguration_H
#define OAIVerticalLayoutConfiguration_H
...
class OAIVerticalLayoutConfiguration : public OAIObject {
public:
    OAIVerticalLayoutConfiguration();
    OAIVerticalLayoutConfiguration(QString json);
    ~OAIVerticalLayoutConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerticalLayoutConfiguration)

#endif // OAIVerticalLayoutConfiguration_H
