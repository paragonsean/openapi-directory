...
/*
 * OAIMediaInsightsPipelineConfiguration.h
 *
 * A structure that contains the configuration settings for a media insights pipeline.
 */

#ifndef OAIMediaInsightsPipelineConfiguration_H
#define OAIMediaInsightsPipelineConfiguration_H
...
class OAIMediaInsightsPipelineConfiguration : public OAIObject {
public:
    OAIMediaInsightsPipelineConfiguration();
    OAIMediaInsightsPipelineConfiguration(QString json);
    ~OAIMediaInsightsPipelineConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaInsightsPipelineConfiguration)

#endif // OAIMediaInsightsPipelineConfiguration_H
