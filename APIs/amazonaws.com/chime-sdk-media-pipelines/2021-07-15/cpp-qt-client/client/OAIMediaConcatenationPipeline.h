...
/*
 * OAIMediaConcatenationPipeline.h
 *
 * Concatenates audio and video data from one or more data streams.
 */

#ifndef OAIMediaConcatenationPipeline_H
#define OAIMediaConcatenationPipeline_H
...
class OAIMediaConcatenationPipeline : public OAIObject {
public:
    OAIMediaConcatenationPipeline();
    OAIMediaConcatenationPipeline(QString json);
    ~OAIMediaConcatenationPipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaConcatenationPipeline)

#endif // OAIMediaConcatenationPipeline_H
