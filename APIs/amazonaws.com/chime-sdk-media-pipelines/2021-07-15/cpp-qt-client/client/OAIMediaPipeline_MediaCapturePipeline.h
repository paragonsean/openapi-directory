...
/*
 * OAIMediaPipeline_MediaCapturePipeline.h
 *
 * 
 */

#ifndef OAIMediaPipeline_MediaCapturePipeline_H
#define OAIMediaPipeline_MediaCapturePipeline_H
...
class OAIMediaPipeline_MediaCapturePipeline : public OAIObject {
public:
    OAIMediaPipeline_MediaCapturePipeline();
    OAIMediaPipeline_MediaCapturePipeline(QString json);
    ~OAIMediaPipeline_MediaCapturePipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaPipeline_MediaCapturePipeline)

#endif // OAIMediaPipeline_MediaCapturePipeline_H
