...
#include "OAIHorizontalLayoutConfiguration.h"
...
OAIHorizontalLayoutConfiguration::OAIHorizontalLayoutConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHorizontalLayoutConfiguration::OAIHorizontalLayoutConfiguration() {
    this->initializeModel();
}

OAIHorizontalLayoutConfiguration::~OAIHorizontalLayoutConfiguration() {}

void OAIHorizontalLayoutConfiguration::initializeModel() {
...
void OAIHorizontalLayoutConfiguration::fromJson(QString jsonString) {
...
void OAIHorizontalLayoutConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIHorizontalLayoutConfiguration::asJson() const {
...
QJsonObject OAIHorizontalLayoutConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAITileOrder OAIHorizontalLayoutConfiguration::getTileOrder() const {
    return m_tile_order;
}
void OAIHorizontalLayoutConfiguration::setTileOrder(const OAITileOrder &tile_order) {
    m_tile_order = tile_order;
    m_tile_order_isSet = true;
}

bool OAIHorizontalLayoutConfiguration::is_tile_order_Set() const{
    return m_tile_order_isSet;
}

bool OAIHorizontalLayoutConfiguration::is_tile_order_Valid() const{
    return m_tile_order_isValid;
}

OAIHorizontalTilePosition OAIHorizontalLayoutConfiguration::getTilePosition() const {
    return m_tile_position;
}
void OAIHorizontalLayoutConfiguration::setTilePosition(const OAIHorizontalTilePosition &tile_position) {
    m_tile_position = tile_position;
    m_tile_position_isSet = true;
}

bool OAIHorizontalLayoutConfiguration::is_tile_position_Set() const{
    return m_tile_position_isSet;
}

bool OAIHorizontalLayoutConfiguration::is_tile_position_Valid() const{
    return m_tile_position_isValid;
}

qint32 OAIHorizontalLayoutConfiguration::getTileCount() const {
    return m_tile_count;
}
void OAIHorizontalLayoutConfiguration::setTileCount(const qint32 &tile_count) {
    m_tile_count = tile_count;
    m_tile_count_isSet = true;
}

bool OAIHorizontalLayoutConfiguration::is_tile_count_Set() const{
    return m_tile_count_isSet;
}

bool OAIHorizontalLayoutConfiguration::is_tile_count_Valid() const{
    return m_tile_count_isValid;
}

QString OAIHorizontalLayoutConfiguration::getTileAspectRatio() const {
    return m_tile_aspect_ratio;
}
void OAIHorizontalLayoutConfiguration::setTileAspectRatio(const QString &tile_aspect_ratio) {
    m_tile_aspect_ratio = tile_aspect_ratio;
    m_tile_aspect_ratio_isSet = true;
}

bool OAIHorizontalLayoutConfiguration::is_tile_aspect_ratio_Set() const{
    return m_tile_aspect_ratio_isSet;
}

bool OAIHorizontalLayoutConfiguration::is_tile_aspect_ratio_Valid() const{
    return m_tile_aspect_ratio_isValid;
}

bool OAIHorizontalLayoutConfiguration::isSet() const {
...
bool OAIHorizontalLayoutConfiguration::isValid() const {
