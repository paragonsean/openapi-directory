...
/*
 * OAIGridViewConfiguration.h
 *
 * Specifies the type of grid layout.
 */

#ifndef OAIGridViewConfiguration_H
#define OAIGridViewConfiguration_H
...
class OAIGridViewConfiguration : public OAIObject {
public:
    OAIGridViewConfiguration();
    OAIGridViewConfiguration(QString json);
    ~OAIGridViewConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGridViewConfiguration)

#endif // OAIGridViewConfiguration_H
