...
/*
 * OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration.h
 *
 * A structure that contains the runtime settings for recording a Kinesis video stream.
 */

#ifndef OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration_H
#define OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration_H
...
class OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration : public OAIObject {
public:
    OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration();
    OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration(QString json);
    ~OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration)

#endif // OAIKinesisVideoStreamRecordingSourceRuntimeConfiguration_H
