...
/*
 * OAIMediaPipeline_MediaConcatenationPipeline.h
 *
 * 
 */

#ifndef OAIMediaPipeline_MediaConcatenationPipeline_H
#define OAIMediaPipeline_MediaConcatenationPipeline_H
...
class OAIMediaPipeline_MediaConcatenationPipeline : public OAIObject {
public:
    OAIMediaPipeline_MediaConcatenationPipeline();
    OAIMediaPipeline_MediaConcatenationPipeline(QString json);
    ~OAIMediaPipeline_MediaConcatenationPipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaPipeline_MediaConcatenationPipeline)

#endif // OAIMediaPipeline_MediaConcatenationPipeline_H
