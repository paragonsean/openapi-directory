...
/*
 * OAICreateMediaConcatenationPipelineRequest.h
 *
 * 
 */

#ifndef OAICreateMediaConcatenationPipelineRequest_H
#define OAICreateMediaConcatenationPipelineRequest_H
...
class OAICreateMediaConcatenationPipelineRequest : public OAIObject {
public:
    OAICreateMediaConcatenationPipelineRequest();
    OAICreateMediaConcatenationPipelineRequest(QString json);
    ~OAICreateMediaConcatenationPipelineRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMediaConcatenationPipelineRequest)

#endif // OAICreateMediaConcatenationPipelineRequest_H
