...
#include "OAIStreamChannelDefinition.h"
...
OAIStreamChannelDefinition::OAIStreamChannelDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamChannelDefinition::OAIStreamChannelDefinition() {
    this->initializeModel();
}

OAIStreamChannelDefinition::~OAIStreamChannelDefinition() {}

void OAIStreamChannelDefinition::initializeModel() {
...
void OAIStreamChannelDefinition::fromJson(QString jsonString) {
...
void OAIStreamChannelDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIStreamChannelDefinition::asJson() const {
...
QJsonObject OAIStreamChannelDefinition::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIStreamChannelDefinition::getNumberOfChannels() const {
    return m_number_of_channels;
}
void OAIStreamChannelDefinition::setNumberOfChannels(const qint32 &number_of_channels) {
    m_number_of_channels = number_of_channels;
    m_number_of_channels_isSet = true;
}

bool OAIStreamChannelDefinition::is_number_of_channels_Set() const{
    return m_number_of_channels_isSet;
}

bool OAIStreamChannelDefinition::is_number_of_channels_Valid() const{
    return m_number_of_channels_isValid;
}

QList OAIStreamChannelDefinition::getChannelDefinitions() const {
    return m_channel_definitions;
}
void OAIStreamChannelDefinition::setChannelDefinitions(const QList &channel_definitions) {
    m_channel_definitions = channel_definitions;
    m_channel_definitions_isSet = true;
}

bool OAIStreamChannelDefinition::is_channel_definitions_Set() const{
    return m_channel_definitions_isSet;
}

bool OAIStreamChannelDefinition::is_channel_definitions_Valid() const{
    return m_channel_definitions_isValid;
}

bool OAIStreamChannelDefinition::isSet() const {
...
bool OAIStreamChannelDefinition::isValid() const {
