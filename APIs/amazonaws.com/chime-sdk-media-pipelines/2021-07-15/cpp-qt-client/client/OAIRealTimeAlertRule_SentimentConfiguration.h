...
/*
 * OAIRealTimeAlertRule_SentimentConfiguration.h
 *
 * 
 */

#ifndef OAIRealTimeAlertRule_SentimentConfiguration_H
#define OAIRealTimeAlertRule_SentimentConfiguration_H
...
class OAIRealTimeAlertRule_SentimentConfiguration : public OAIObject {
public:
    OAIRealTimeAlertRule_SentimentConfiguration();
    OAIRealTimeAlertRule_SentimentConfiguration(QString json);
    ~OAIRealTimeAlertRule_SentimentConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRealTimeAlertRule_SentimentConfiguration)

#endif // OAIRealTimeAlertRule_SentimentConfiguration_H
