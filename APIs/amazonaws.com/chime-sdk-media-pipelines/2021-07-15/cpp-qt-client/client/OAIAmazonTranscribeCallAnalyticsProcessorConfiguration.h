...
/*
 * OAIAmazonTranscribeCallAnalyticsProcessorConfiguration.h
 *
 * A structure that contains the configuration settings for an Amazon Transcribe call analytics processor.
 */

#ifndef OAIAmazonTranscribeCallAnalyticsProcessorConfiguration_H
#define OAIAmazonTranscribeCallAnalyticsProcessorConfiguration_H
...
class OAIAmazonTranscribeCallAnalyticsProcessorConfiguration : public OAIObject {
public:
    OAIAmazonTranscribeCallAnalyticsProcessorConfiguration();
    OAIAmazonTranscribeCallAnalyticsProcessorConfiguration(QString json);
    ~OAIAmazonTranscribeCallAnalyticsProcessorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmazonTranscribeCallAnalyticsProcessorConfiguration)

#endif // OAIAmazonTranscribeCallAnalyticsProcessorConfiguration_H
