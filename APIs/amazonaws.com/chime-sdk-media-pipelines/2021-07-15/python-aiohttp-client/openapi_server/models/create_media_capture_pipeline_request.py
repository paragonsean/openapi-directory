...
class CreateMediaCapturePipelineRequest(Model):
    ...
    def __init__(self, source_type: str=None, source_arn: str=None, sink_type: str=None, sink_arn: str=None, client_request_token: str=None, chime_sdk_meeting_configuration: CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration=None, tags: List[Tag]=None):
        ...
        :param tags: The tags of this CreateMediaCapturePipelineRequest.
        """
        self.openapi_types = {
            'source_type': str,
            'source_arn': str,
    ...
    @property
    def tags(self):
        """Gets the tags of this CreateMediaCapturePipelineRequest.

        The tag key-value pairs.

        :return: The tags of this CreateMediaCapturePipelineRequest.
        :rtype: List[Tag]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this CreateMediaCapturePipelineRequest.
