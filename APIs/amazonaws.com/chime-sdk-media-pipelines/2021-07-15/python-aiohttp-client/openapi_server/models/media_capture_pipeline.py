...
class MediaCapturePipeline(Model):
    ...
    def __init__(self, media_pipeline_id: str=None, media_pipeline_arn: str=None, source_type: MediaPipelineSourceType=None, source_arn: str=None, status: MediaPipelineStatus=None, sink_type: MediaPipelineSinkType=None, sink_arn: str=None, created_timestamp: datetime=None, updated_timestamp: datetime=None, chime_sdk_meeting_configuration: CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration=None):
        ...
        :param media_pipeline_arn: The media_pipeline_arn of this MediaCapturePipeline.
    ...
    def media_pipeline_arn(self):
        """Gets the media_pipeline_arn of this MediaCapturePipeline.


        :return: The media_pipeline_arn of this MediaCapturePipeline.
        :rtype: str
        """
    ...
    def media_pipeline_arn(self, media_pipeline_arn):
        """Sets the media_pipeline_arn of this MediaCapturePipeline.
