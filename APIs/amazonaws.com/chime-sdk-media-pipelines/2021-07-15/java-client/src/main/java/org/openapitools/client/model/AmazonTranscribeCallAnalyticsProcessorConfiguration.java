...
public class AmazonTranscribeCallAnalyticsProcessorConfiguration {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration languageCode(CallAnalyticsLanguageCode languageCode) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration vocabularyName(String vocabularyName) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration vocabularyFilterName(String vocabularyFilterName) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration vocabularyFilterMethod(VocabularyFilterMethod vocabularyFilterMethod) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration languageModelName(String languageModelName) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration enablePartialResultsStabilization(Boolean enablePartialResultsStabilization) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration partialResultsStability(PartialResultsStability partialResultsStability) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration contentIdentificationType(ContentType contentIdentificationType) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration contentRedactionType(ContentType contentRedactionType) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration piiEntityTypes(String piiEntityTypes) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration filterPartialResults(Boolean filterPartialResults) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration postCallAnalyticsSettings(AmazonTranscribeCallAnalyticsProcessorConfigurationPostCallAnalyticsSettings postCallAnalyticsSettings) {
  ...
  public AmazonTranscribeCallAnalyticsProcessorConfiguration callAnalyticsStreamCategories(List callAnalyticsStreamCategories) {
  ...
  public boolean equals(Object o) {
    ...
    AmazonTranscribeCallAnalyticsProcessorConfiguration amazonTranscribeCallAnalyticsProcessorConfiguration = (AmazonTranscribeCallAnalyticsProcessorConfiguration) o;
    return Objects.equals(this.languageCode, amazonTranscribeCallAnalyticsProcessorConfiguration.languageCode) &&
        Objects.equals(this.vocabularyName, amazonTranscribeCallAnalyticsProcessorConfiguration.vocabularyName) &&
        Objects.equals(this.vocabularyFilterName, amazonTranscribeCallAnalyticsProcessorConfiguration.vocabularyFilterName) &&
        Objects.equals(this.vocabularyFilterMethod, amazonTranscribeCallAnalyticsProcessorConfiguration.vocabularyFilterMethod) &&
        Objects.equals(this.languageModelName, amazonTranscribeCallAnalyticsProcessorConfiguration.languageModelName) &&
        Objects.equals(this.enablePartialResultsStabilization, amazonTranscribeCallAnalyticsProcessorConfiguration.enablePartialResultsStabilization) &&
        Objects.equals(this.partialResultsStability, amazonTranscribeCallAnalyticsProcessorConfiguration.partialResultsStability) &&
        Objects.equals(this.contentIdentificationType, amazonTranscribeCallAnalyticsProcessorConfiguration.contentIdentificationType) &&
        Objects.equals(this.contentRedactionType, amazonTranscribeCallAnalyticsProcessorConfiguration.contentRedactionType) &&
        Objects.equals(this.piiEntityTypes, amazonTranscribeCallAnalyticsProcessorConfiguration.piiEntityTypes) &&
        Objects.equals(this.filterPartialResults, amazonTranscribeCallAnalyticsProcessorConfiguration.filterPartialResults) &&
        Objects.equals(this.postCallAnalyticsSettings, amazonTranscribeCallAnalyticsProcessorConfiguration.postCallAnalyticsSettings) &&
        Objects.equals(this.callAnalyticsStreamCategories, amazonTranscribeCallAnalyticsProcessorConfiguration.callAnalyticsStreamCategories);
  }
  ...
  public String toString() {
    ...
    sb.append("class AmazonTranscribeCallAnalyticsProcessorConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmazonTranscribeCallAnalyticsProcessorConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmazonTranscribeCallAnalyticsProcessorConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonTranscribeCallAnalyticsProcessorConfiguration is not found in the empty JSON string", AmazonTranscribeCallAnalyticsProcessorConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AmazonTranscribeCallAnalyticsProcessorConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AmazonTranscribeCallAnalyticsProcessorConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmazonTranscribeCallAnalyticsProcessorConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonTranscribeCallAnalyticsProcessorConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonTranscribeCallAnalyticsProcessorConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonTranscribeCallAnalyticsProcessorConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonTranscribeCallAnalyticsProcessorConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonTranscribeCallAnalyticsProcessorConfiguration>() {
           @Override
           public void write(JsonWriter out, AmazonTranscribeCallAnalyticsProcessorConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AmazonTranscribeCallAnalyticsProcessorConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AmazonTranscribeCallAnalyticsProcessorConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AmazonTranscribeCallAnalyticsProcessorConfiguration
   * @throws IOException if the JSON string is invalid with respect to AmazonTranscribeCallAnalyticsProcessorConfiguration
   */
  public static AmazonTranscribeCallAnalyticsProcessorConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonTranscribeCallAnalyticsProcessorConfiguration.class);
  }

  /**
   * Convert an instance of AmazonTranscribeCallAnalyticsProcessorConfiguration to an JSON string
   *
   * @return JSON string
   */
