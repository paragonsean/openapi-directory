...
public class GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration() {
  }

  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationName(String mediaInsightsPipelineConfigurationName) {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationArn(String mediaInsightsPipelineConfigurationArn) {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration resourceAccessRoleArn(String resourceAccessRoleArn) {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration realTimeAlertConfiguration(MediaInsightsPipelineConfigurationRealTimeAlertConfiguration realTimeAlertConfiguration) {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration elements(List elements) {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationId(String mediaInsightsPipelineConfigurationId) {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration = (GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration) o;
    return Objects.equals(this.mediaInsightsPipelineConfigurationName, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationName) &&
        Objects.equals(this.mediaInsightsPipelineConfigurationArn, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationArn) &&
        Objects.equals(this.resourceAccessRoleArn, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.resourceAccessRoleArn) &&
        Objects.equals(this.realTimeAlertConfiguration, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.realTimeAlertConfiguration) &&
        Objects.equals(this.elements, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.elements) &&
        Objects.equals(this.mediaInsightsPipelineConfigurationId, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationId) &&
        Objects.equals(this.createdTimestamp, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, getMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.updatedTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration is not found in the empty JSON string", GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration>() {
           @Override
           public void write(JsonWriter out, GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
   * @throws IOException if the JSON string is invalid with respect to GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
   */
  public static GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.class);
  }

  /**
   * Convert an instance of GetMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration to an JSON string
   *
   * @return JSON string
   */
