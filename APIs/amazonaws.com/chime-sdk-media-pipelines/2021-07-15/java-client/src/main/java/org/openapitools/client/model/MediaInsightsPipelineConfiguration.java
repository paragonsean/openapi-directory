...
public class MediaInsightsPipelineConfiguration {
  ...
  public MediaInsightsPipelineConfiguration() {
  }

  public MediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationName(String mediaInsightsPipelineConfigurationName) {
  ...
  public MediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationArn(String mediaInsightsPipelineConfigurationArn) {
  ...
  public MediaInsightsPipelineConfiguration resourceAccessRoleArn(String resourceAccessRoleArn) {
  ...
  public MediaInsightsPipelineConfiguration realTimeAlertConfiguration(MediaInsightsPipelineConfigurationRealTimeAlertConfiguration realTimeAlertConfiguration) {
  ...
  public MediaInsightsPipelineConfiguration elements(List elements) {
  ...
  public MediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationId(String mediaInsightsPipelineConfigurationId) {
  ...
  public MediaInsightsPipelineConfiguration createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public MediaInsightsPipelineConfiguration updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    MediaInsightsPipelineConfiguration mediaInsightsPipelineConfiguration = (MediaInsightsPipelineConfiguration) o;
    return Objects.equals(this.mediaInsightsPipelineConfigurationName, mediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationName) &&
        Objects.equals(this.mediaInsightsPipelineConfigurationArn, mediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationArn) &&
        Objects.equals(this.resourceAccessRoleArn, mediaInsightsPipelineConfiguration.resourceAccessRoleArn) &&
        Objects.equals(this.realTimeAlertConfiguration, mediaInsightsPipelineConfiguration.realTimeAlertConfiguration) &&
        Objects.equals(this.elements, mediaInsightsPipelineConfiguration.elements) &&
        Objects.equals(this.mediaInsightsPipelineConfigurationId, mediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationId) &&
        Objects.equals(this.createdTimestamp, mediaInsightsPipelineConfiguration.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, mediaInsightsPipelineConfiguration.updatedTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaInsightsPipelineConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaInsightsPipelineConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaInsightsPipelineConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaInsightsPipelineConfiguration is not found in the empty JSON string", MediaInsightsPipelineConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaInsightsPipelineConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaInsightsPipelineConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaInsightsPipelineConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaInsightsPipelineConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaInsightsPipelineConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaInsightsPipelineConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaInsightsPipelineConfiguration>() {
           @Override
           public void write(JsonWriter out, MediaInsightsPipelineConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaInsightsPipelineConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaInsightsPipelineConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaInsightsPipelineConfiguration
   * @throws IOException if the JSON string is invalid with respect to MediaInsightsPipelineConfiguration
   */
  public static MediaInsightsPipelineConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaInsightsPipelineConfiguration.class);
  }

  /**
   * Convert an instance of MediaInsightsPipelineConfiguration to an JSON string
   *
   * @return JSON string
   */
