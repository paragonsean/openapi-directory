...
public class GetMediaCapturePipelineResponseMediaCapturePipeline {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline() {
  }

  public GetMediaCapturePipelineResponseMediaCapturePipeline mediaPipelineId(String mediaPipelineId) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline mediaPipelineArn(String mediaPipelineArn) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline sourceType(MediaPipelineSourceType sourceType) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline sourceArn(String sourceArn) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline status(MediaPipelineStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline sinkType(MediaPipelineSinkType sinkType) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline sinkArn(String sinkArn) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public GetMediaCapturePipelineResponseMediaCapturePipeline chimeSdkMeetingConfiguration(CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration chimeSdkMeetingConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    GetMediaCapturePipelineResponseMediaCapturePipeline getMediaCapturePipelineResponseMediaCapturePipeline = (GetMediaCapturePipelineResponseMediaCapturePipeline) o;
    return Objects.equals(this.mediaPipelineId, getMediaCapturePipelineResponseMediaCapturePipeline.mediaPipelineId) &&
        Objects.equals(this.mediaPipelineArn, getMediaCapturePipelineResponseMediaCapturePipeline.mediaPipelineArn) &&
        Objects.equals(this.sourceType, getMediaCapturePipelineResponseMediaCapturePipeline.sourceType) &&
        Objects.equals(this.sourceArn, getMediaCapturePipelineResponseMediaCapturePipeline.sourceArn) &&
        Objects.equals(this.status, getMediaCapturePipelineResponseMediaCapturePipeline.status) &&
        Objects.equals(this.sinkType, getMediaCapturePipelineResponseMediaCapturePipeline.sinkType) &&
        Objects.equals(this.sinkArn, getMediaCapturePipelineResponseMediaCapturePipeline.sinkArn) &&
        Objects.equals(this.createdTimestamp, getMediaCapturePipelineResponseMediaCapturePipeline.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, getMediaCapturePipelineResponseMediaCapturePipeline.updatedTimestamp) &&
        Objects.equals(this.chimeSdkMeetingConfiguration, getMediaCapturePipelineResponseMediaCapturePipeline.chimeSdkMeetingConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMediaCapturePipelineResponseMediaCapturePipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMediaCapturePipelineResponseMediaCapturePipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMediaCapturePipelineResponseMediaCapturePipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMediaCapturePipelineResponseMediaCapturePipeline is not found in the empty JSON string", GetMediaCapturePipelineResponseMediaCapturePipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMediaCapturePipelineResponseMediaCapturePipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMediaCapturePipelineResponseMediaCapturePipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMediaCapturePipelineResponseMediaCapturePipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMediaCapturePipelineResponseMediaCapturePipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMediaCapturePipelineResponseMediaCapturePipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMediaCapturePipelineResponseMediaCapturePipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMediaCapturePipelineResponseMediaCapturePipeline>() {
           @Override
           public void write(JsonWriter out, GetMediaCapturePipelineResponseMediaCapturePipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMediaCapturePipelineResponseMediaCapturePipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMediaCapturePipelineResponseMediaCapturePipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMediaCapturePipelineResponseMediaCapturePipeline
   * @throws IOException if the JSON string is invalid with respect to GetMediaCapturePipelineResponseMediaCapturePipeline
   */
  public static GetMediaCapturePipelineResponseMediaCapturePipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMediaCapturePipelineResponseMediaCapturePipeline.class);
  }

  /**
   * Convert an instance of GetMediaCapturePipelineResponseMediaCapturePipeline to an JSON string
   *
   * @return JSON string
   */
