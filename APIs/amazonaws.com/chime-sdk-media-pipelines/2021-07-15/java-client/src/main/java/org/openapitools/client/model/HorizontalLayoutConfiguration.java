...
public class HorizontalLayoutConfiguration {
  ...
  public HorizontalLayoutConfiguration() {
  }

  public HorizontalLayoutConfiguration tileOrder(TileOrder tileOrder) {
  ...
  public HorizontalLayoutConfiguration tilePosition(HorizontalTilePosition tilePosition) {
  ...
  public HorizontalLayoutConfiguration tileCount(Integer tileCount) {
  ...
  public HorizontalLayoutConfiguration tileAspectRatio(String tileAspectRatio) {
  ...
  public boolean equals(Object o) {
    ...
    HorizontalLayoutConfiguration horizontalLayoutConfiguration = (HorizontalLayoutConfiguration) o;
    return Objects.equals(this.tileOrder, horizontalLayoutConfiguration.tileOrder) &&
        Objects.equals(this.tilePosition, horizontalLayoutConfiguration.tilePosition) &&
        Objects.equals(this.tileCount, horizontalLayoutConfiguration.tileCount) &&
        Objects.equals(this.tileAspectRatio, horizontalLayoutConfiguration.tileAspectRatio);
  }
  ...
  public String toString() {
    ...
    sb.append("class HorizontalLayoutConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HorizontalLayoutConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HorizontalLayoutConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HorizontalLayoutConfiguration is not found in the empty JSON string", HorizontalLayoutConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HorizontalLayoutConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HorizontalLayoutConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HorizontalLayoutConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HorizontalLayoutConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HorizontalLayoutConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HorizontalLayoutConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<HorizontalLayoutConfiguration>() {
           @Override
           public void write(JsonWriter out, HorizontalLayoutConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HorizontalLayoutConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HorizontalLayoutConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HorizontalLayoutConfiguration
   * @throws IOException if the JSON string is invalid with respect to HorizontalLayoutConfiguration
   */
  public static HorizontalLayoutConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HorizontalLayoutConfiguration.class);
  }

  /**
   * Convert an instance of HorizontalLayoutConfiguration to an JSON string
   *
   * @return JSON string
   */
