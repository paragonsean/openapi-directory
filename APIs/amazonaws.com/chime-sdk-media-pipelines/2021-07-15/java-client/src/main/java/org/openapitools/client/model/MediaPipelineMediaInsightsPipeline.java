...
public class MediaPipelineMediaInsightsPipeline {
  ...
  public MediaPipelineMediaInsightsPipeline() {
  }

  public MediaPipelineMediaInsightsPipeline mediaPipelineId(String mediaPipelineId) {
  ...
  public MediaPipelineMediaInsightsPipeline mediaPipelineArn(String mediaPipelineArn) {
  ...
  public MediaPipelineMediaInsightsPipeline mediaInsightsPipelineConfigurationArn(String mediaInsightsPipelineConfigurationArn) {
  ...
  public MediaPipelineMediaInsightsPipeline status(MediaPipelineStatus status) {
    this.status = status;
    return this;
  }
  ...
  public MediaPipelineMediaInsightsPipeline kinesisVideoStreamSourceRuntimeConfiguration(MediaInsightsPipelineKinesisVideoStreamSourceRuntimeConfiguration kinesisVideoStreamSourceRuntimeConfiguration) {
  ...
  public MediaPipelineMediaInsightsPipeline mediaInsightsRuntimeMetadata(Map mediaInsightsRuntimeMetadata) {
  ...
  public MediaPipelineMediaInsightsPipeline kinesisVideoStreamRecordingSourceRuntimeConfiguration(MediaInsightsPipelineKinesisVideoStreamRecordingSourceRuntimeConfiguration kinesisVideoStreamRecordingSourceRuntimeConfiguration) {
  ...
  public MediaPipelineMediaInsightsPipeline s3RecordingSinkRuntimeConfiguration(MediaInsightsPipelineS3RecordingSinkRuntimeConfiguration s3RecordingSinkRuntimeConfiguration) {
  ...
  public MediaPipelineMediaInsightsPipeline createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    MediaPipelineMediaInsightsPipeline mediaPipelineMediaInsightsPipeline = (MediaPipelineMediaInsightsPipeline) o;
    return Objects.equals(this.mediaPipelineId, mediaPipelineMediaInsightsPipeline.mediaPipelineId) &&
        Objects.equals(this.mediaPipelineArn, mediaPipelineMediaInsightsPipeline.mediaPipelineArn) &&
        Objects.equals(this.mediaInsightsPipelineConfigurationArn, mediaPipelineMediaInsightsPipeline.mediaInsightsPipelineConfigurationArn) &&
        Objects.equals(this.status, mediaPipelineMediaInsightsPipeline.status) &&
        Objects.equals(this.kinesisVideoStreamSourceRuntimeConfiguration, mediaPipelineMediaInsightsPipeline.kinesisVideoStreamSourceRuntimeConfiguration) &&
        Objects.equals(this.mediaInsightsRuntimeMetadata, mediaPipelineMediaInsightsPipeline.mediaInsightsRuntimeMetadata) &&
        Objects.equals(this.kinesisVideoStreamRecordingSourceRuntimeConfiguration, mediaPipelineMediaInsightsPipeline.kinesisVideoStreamRecordingSourceRuntimeConfiguration) &&
        Objects.equals(this.s3RecordingSinkRuntimeConfiguration, mediaPipelineMediaInsightsPipeline.s3RecordingSinkRuntimeConfiguration) &&
        Objects.equals(this.createdTimestamp, mediaPipelineMediaInsightsPipeline.createdTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaPipelineMediaInsightsPipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaPipelineMediaInsightsPipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaPipelineMediaInsightsPipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaPipelineMediaInsightsPipeline is not found in the empty JSON string", MediaPipelineMediaInsightsPipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaPipelineMediaInsightsPipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaPipelineMediaInsightsPipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaPipelineMediaInsightsPipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaPipelineMediaInsightsPipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaPipelineMediaInsightsPipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaPipelineMediaInsightsPipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaPipelineMediaInsightsPipeline>() {
           @Override
           public void write(JsonWriter out, MediaPipelineMediaInsightsPipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaPipelineMediaInsightsPipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaPipelineMediaInsightsPipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaPipelineMediaInsightsPipeline
   * @throws IOException if the JSON string is invalid with respect to MediaPipelineMediaInsightsPipeline
   */
  public static MediaPipelineMediaInsightsPipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaPipelineMediaInsightsPipeline.class);
  }

  /**
   * Convert an instance of MediaPipelineMediaInsightsPipeline to an JSON string
   *
   * @return JSON string
   */
