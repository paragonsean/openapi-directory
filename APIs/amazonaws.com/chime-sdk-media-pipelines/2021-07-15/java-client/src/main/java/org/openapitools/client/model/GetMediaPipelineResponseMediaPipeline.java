...
public class GetMediaPipelineResponseMediaPipeline {
  ...
  public GetMediaPipelineResponseMediaPipeline() {
  }

  public GetMediaPipelineResponseMediaPipeline mediaCapturePipeline(MediaPipelineMediaCapturePipeline mediaCapturePipeline) {
  ...
  public GetMediaPipelineResponseMediaPipeline mediaLiveConnectorPipeline(MediaPipelineMediaLiveConnectorPipeline mediaLiveConnectorPipeline) {
  ...
  public GetMediaPipelineResponseMediaPipeline mediaConcatenationPipeline(MediaPipelineMediaConcatenationPipeline mediaConcatenationPipeline) {
  ...
  public GetMediaPipelineResponseMediaPipeline mediaInsightsPipeline(MediaPipelineMediaInsightsPipeline mediaInsightsPipeline) {
  ...
  public boolean equals(Object o) {
    ...
    GetMediaPipelineResponseMediaPipeline getMediaPipelineResponseMediaPipeline = (GetMediaPipelineResponseMediaPipeline) o;
    return Objects.equals(this.mediaCapturePipeline, getMediaPipelineResponseMediaPipeline.mediaCapturePipeline) &&
        Objects.equals(this.mediaLiveConnectorPipeline, getMediaPipelineResponseMediaPipeline.mediaLiveConnectorPipeline) &&
        Objects.equals(this.mediaConcatenationPipeline, getMediaPipelineResponseMediaPipeline.mediaConcatenationPipeline) &&
        Objects.equals(this.mediaInsightsPipeline, getMediaPipelineResponseMediaPipeline.mediaInsightsPipeline);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMediaPipelineResponseMediaPipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMediaPipelineResponseMediaPipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMediaPipelineResponseMediaPipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMediaPipelineResponseMediaPipeline is not found in the empty JSON string", GetMediaPipelineResponseMediaPipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMediaPipelineResponseMediaPipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMediaPipelineResponseMediaPipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMediaPipelineResponseMediaPipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMediaPipelineResponseMediaPipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMediaPipelineResponseMediaPipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMediaPipelineResponseMediaPipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMediaPipelineResponseMediaPipeline>() {
           @Override
           public void write(JsonWriter out, GetMediaPipelineResponseMediaPipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMediaPipelineResponseMediaPipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMediaPipelineResponseMediaPipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMediaPipelineResponseMediaPipeline
   * @throws IOException if the JSON string is invalid with respect to GetMediaPipelineResponseMediaPipeline
   */
  public static GetMediaPipelineResponseMediaPipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMediaPipelineResponseMediaPipeline.class);
  }

  /**
   * Convert an instance of GetMediaPipelineResponseMediaPipeline to an JSON string
   *
   * @return JSON string
   */
