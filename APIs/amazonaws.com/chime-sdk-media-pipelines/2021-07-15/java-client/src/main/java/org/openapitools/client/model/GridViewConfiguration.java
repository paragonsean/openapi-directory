...
public class GridViewConfiguration {
  ...
  public GridViewConfiguration contentShareLayout(ContentShareLayoutOption contentShareLayout) {
  ...
  public GridViewConfiguration presenterOnlyConfiguration(GridViewConfigurationPresenterOnlyConfiguration presenterOnlyConfiguration) {
  ...
  public GridViewConfiguration activeSpeakerOnlyConfiguration(GridViewConfigurationActiveSpeakerOnlyConfiguration activeSpeakerOnlyConfiguration) {
  ...
  public GridViewConfiguration horizontalLayoutConfiguration(GridViewConfigurationHorizontalLayoutConfiguration horizontalLayoutConfiguration) {
  ...
  public GridViewConfiguration verticalLayoutConfiguration(GridViewConfigurationVerticalLayoutConfiguration verticalLayoutConfiguration) {
  ...
  public GridViewConfiguration videoAttribute(GridViewConfigurationVideoAttribute videoAttribute) {
  ...
  public GridViewConfiguration canvasOrientation(CanvasOrientation canvasOrientation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contentShareLayout, gridViewConfiguration.contentShareLayout) &&
        Objects.equals(this.presenterOnlyConfiguration, gridViewConfiguration.presenterOnlyConfiguration) &&
        Objects.equals(this.activeSpeakerOnlyConfiguration, gridViewConfiguration.activeSpeakerOnlyConfiguration) &&
        Objects.equals(this.horizontalLayoutConfiguration, gridViewConfiguration.horizontalLayoutConfiguration) &&
        Objects.equals(this.verticalLayoutConfiguration, gridViewConfiguration.verticalLayoutConfiguration) &&
        Objects.equals(this.videoAttribute, gridViewConfiguration.videoAttribute) &&
        Objects.equals(this.canvasOrientation, gridViewConfiguration.canvasOrientation);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GridViewConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GridViewConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GridViewConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GridViewConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GridViewConfiguration.openapiRequiredFields) {
