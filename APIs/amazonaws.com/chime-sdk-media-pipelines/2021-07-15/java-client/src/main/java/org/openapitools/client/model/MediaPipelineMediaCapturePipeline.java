...
public class MediaPipelineMediaCapturePipeline {
  ...
  public MediaPipelineMediaCapturePipeline() {
  }

  public MediaPipelineMediaCapturePipeline mediaPipelineId(String mediaPipelineId) {
  ...
  public MediaPipelineMediaCapturePipeline mediaPipelineArn(String mediaPipelineArn) {
  ...
  public MediaPipelineMediaCapturePipeline sourceType(MediaPipelineSourceType sourceType) {
  ...
  public MediaPipelineMediaCapturePipeline sourceArn(String sourceArn) {
  ...
  public MediaPipelineMediaCapturePipeline status(MediaPipelineStatus status) {
    this.status = status;
    return this;
  }
  ...
  public MediaPipelineMediaCapturePipeline sinkType(MediaPipelineSinkType sinkType) {
  ...
  public MediaPipelineMediaCapturePipeline sinkArn(String sinkArn) {
  ...
  public MediaPipelineMediaCapturePipeline createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public MediaPipelineMediaCapturePipeline updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public MediaPipelineMediaCapturePipeline chimeSdkMeetingConfiguration(CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration chimeSdkMeetingConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    MediaPipelineMediaCapturePipeline mediaPipelineMediaCapturePipeline = (MediaPipelineMediaCapturePipeline) o;
    return Objects.equals(this.mediaPipelineId, mediaPipelineMediaCapturePipeline.mediaPipelineId) &&
        Objects.equals(this.mediaPipelineArn, mediaPipelineMediaCapturePipeline.mediaPipelineArn) &&
        Objects.equals(this.sourceType, mediaPipelineMediaCapturePipeline.sourceType) &&
        Objects.equals(this.sourceArn, mediaPipelineMediaCapturePipeline.sourceArn) &&
        Objects.equals(this.status, mediaPipelineMediaCapturePipeline.status) &&
        Objects.equals(this.sinkType, mediaPipelineMediaCapturePipeline.sinkType) &&
        Objects.equals(this.sinkArn, mediaPipelineMediaCapturePipeline.sinkArn) &&
        Objects.equals(this.createdTimestamp, mediaPipelineMediaCapturePipeline.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, mediaPipelineMediaCapturePipeline.updatedTimestamp) &&
        Objects.equals(this.chimeSdkMeetingConfiguration, mediaPipelineMediaCapturePipeline.chimeSdkMeetingConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaPipelineMediaCapturePipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaPipelineMediaCapturePipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaPipelineMediaCapturePipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaPipelineMediaCapturePipeline is not found in the empty JSON string", MediaPipelineMediaCapturePipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaPipelineMediaCapturePipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaPipelineMediaCapturePipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaPipelineMediaCapturePipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaPipelineMediaCapturePipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaPipelineMediaCapturePipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaPipelineMediaCapturePipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaPipelineMediaCapturePipeline>() {
           @Override
           public void write(JsonWriter out, MediaPipelineMediaCapturePipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaPipelineMediaCapturePipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaPipelineMediaCapturePipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaPipelineMediaCapturePipeline
   * @throws IOException if the JSON string is invalid with respect to MediaPipelineMediaCapturePipeline
   */
  public static MediaPipelineMediaCapturePipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaPipelineMediaCapturePipeline.class);
  }

  /**
   * Convert an instance of MediaPipelineMediaCapturePipeline to an JSON string
   *
   * @return JSON string
   */
