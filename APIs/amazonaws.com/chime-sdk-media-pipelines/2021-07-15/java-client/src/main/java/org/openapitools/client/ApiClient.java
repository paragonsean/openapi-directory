...
public class ApiClient {
    ...
    private String basePath = "http://media-pipelines-chime.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://media-pipelines-chime.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://media-pipelines-chime.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://media-pipelines-chime.{region}.amazonaws.com.cn",
      "The Amazon Chime SDK Media Pipelines endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-07-15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://media-pipelines-chime.us-east-1.amazonaws.com
