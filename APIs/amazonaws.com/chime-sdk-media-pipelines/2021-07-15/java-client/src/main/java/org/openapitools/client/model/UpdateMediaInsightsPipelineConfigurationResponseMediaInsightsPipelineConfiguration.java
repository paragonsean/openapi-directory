...
public class UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration() {
  }

  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationName(String mediaInsightsPipelineConfigurationName) {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationArn(String mediaInsightsPipelineConfigurationArn) {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration resourceAccessRoleArn(String resourceAccessRoleArn) {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration realTimeAlertConfiguration(MediaInsightsPipelineConfigurationRealTimeAlertConfiguration realTimeAlertConfiguration) {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration elements(List elements) {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration mediaInsightsPipelineConfigurationId(String mediaInsightsPipelineConfigurationId) {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration = (UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration) o;
    return Objects.equals(this.mediaInsightsPipelineConfigurationName, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationName) &&
        Objects.equals(this.mediaInsightsPipelineConfigurationArn, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationArn) &&
        Objects.equals(this.resourceAccessRoleArn, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.resourceAccessRoleArn) &&
        Objects.equals(this.realTimeAlertConfiguration, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.realTimeAlertConfiguration) &&
        Objects.equals(this.elements, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.elements) &&
        Objects.equals(this.mediaInsightsPipelineConfigurationId, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.mediaInsightsPipelineConfigurationId) &&
        Objects.equals(this.createdTimestamp, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, updateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.updatedTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration is not found in the empty JSON string", UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration
   */
  public static UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration.class);
  }

  /**
   * Convert an instance of UpdateMediaInsightsPipelineConfigurationResponseMediaInsightsPipelineConfiguration to an JSON string
   *
   * @return JSON string
   */
