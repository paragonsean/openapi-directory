...
/**
 * The MultipartReadSetUploadListItem model module.
 * @module model/MultipartReadSetUploadListItem
 * @version 2022-11-28
 */
class MultipartReadSetUploadListItem {
    /**
     * Constructs a new <code>MultipartReadSetUploadListItem</code>.
     *  Part of the response to ListMultipartReadSetUploads, excluding completed and aborted multipart uploads. 
     * @alias module:model/MultipartReadSetUploadListItem
     * @param sequenceStoreId {String} 
     * @param uploadId {String} 
     * @param sourceFileType {module:model/FileType} 
     * @param subjectId {String} 
     * @param sampleId {String} 
     * @param generatedFrom {String} 
     * @param referenceArn {String} 
     * @param creationTime {Date} 
     */
    constructor(sequenceStoreId, uploadId, sourceFileType, subjectId, sampleId, generatedFrom, referenceArn, creationTime) { 
        
        MultipartReadSetUploadListItem.initialize(this, sequenceStoreId, uploadId, sourceFileType, subjectId, sampleId, generatedFrom, referenceArn, creationTime);
    }
     ...
     */
    static initialize(obj, sequenceStoreId, uploadId, sourceFileType, subjectId, sampleId, generatedFrom, referenceArn, creationTime) { 
        obj['sequenceStoreId'] = sequenceStoreId;
        obj['uploadId'] = uploadId;
        obj['sourceFileType'] = sourceFileType;
        obj['subjectId'] = subjectId;
        obj['sampleId'] = sampleId;
        obj['generatedFrom'] = generatedFrom;
        obj['referenceArn'] = referenceArn;
        obj['creationTime'] = creationTime;
    }

    /**
     * Constructs a <code>MultipartReadSetUploadListItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MultipartReadSetUploadListItem} obj Optional instance to populate.
     * @return {module:model/MultipartReadSetUploadListItem} The populated <code>MultipartReadSetUploadListItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MultipartReadSetUploadListItem();
    ...
    /**
     * Validates the JSON data with respect to <code>MultipartReadSetUploadListItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MultipartReadSetUploadListItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MultipartReadSetUploadListItem.RequiredProperties) {
...
MultipartReadSetUploadListItem.RequiredProperties = ["sequenceStoreId", "uploadId", "sourceFileType", "subjectId", "sampleId", "generatedFrom", "referenceArn", "creationTime"];

/**
 * @member {String} sequenceStoreId
 */
MultipartReadSetUploadListItem.prototype['sequenceStoreId'] = undefined;

/**
 * @member {String} uploadId
 */
MultipartReadSetUploadListItem.prototype['uploadId'] = undefined;

/**
 * @member {module:model/FileType} sourceFileType
 */
MultipartReadSetUploadListItem.prototype['sourceFileType'] = undefined;

/**
 * @member {String} subjectId
 */
MultipartReadSetUploadListItem.prototype['subjectId'] = undefined;

/**
 * @member {String} sampleId
 */
MultipartReadSetUploadListItem.prototype['sampleId'] = undefined;

/**
 * @member {String} generatedFrom
 */
MultipartReadSetUploadListItem.prototype['generatedFrom'] = undefined;

/**
 * @member {String} referenceArn
 */
MultipartReadSetUploadListItem.prototype['referenceArn'] = undefined;

/**
 * @member {String} name
 */
MultipartReadSetUploadListItem.prototype['name'] = undefined;

/**
 * @member {String} description
 */
MultipartReadSetUploadListItem.prototype['description'] = undefined;

/**
 * @member {Object} tags
 */
MultipartReadSetUploadListItem.prototype['tags'] = undefined;

/**
 * @member {Date} creationTime
 */
MultipartReadSetUploadListItem.prototype['creationTime'] = undefined;
...
export default MultipartReadSetUploadListItem;
