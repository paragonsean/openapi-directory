...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.GetReadSetImportJobResponse();
  });
  ...
  describe('GetReadSetImportJobResponse', function() {
    it('should create an instance of GetReadSetImportJobResponse', function() {
      // uncomment below and update the code to test GetReadSetImportJobResponse
      //var instance = new AmazonOmics.GetReadSetImportJobResponse();
      //expect(instance).to.be.a(AmazonOmics.GetReadSetImportJobResponse);
    });
