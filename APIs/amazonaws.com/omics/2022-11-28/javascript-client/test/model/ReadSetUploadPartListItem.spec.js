...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ReadSetUploadPartListItem();
  });
  ...
  describe('ReadSetUploadPartListItem', function() {
    it('should create an instance of ReadSetUploadPartListItem', function() {
      // uncomment below and update the code to test ReadSetUploadPartListItem
      //var instance = new AmazonOmics.ReadSetUploadPartListItem();
      //expect(instance).to.be.a(AmazonOmics.ReadSetUploadPartListItem);
    });
