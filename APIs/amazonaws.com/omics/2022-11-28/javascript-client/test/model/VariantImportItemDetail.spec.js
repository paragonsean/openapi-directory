...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.VariantImportItemDetail();
  });
  ...
  describe('VariantImportItemDetail', function() {
    it('should create an instance of VariantImportItemDetail', function() {
      // uncomment below and update the code to test VariantImportItemDetail
      //var instance = new AmazonOmics.VariantImportItemDetail();
      //expect(instance).to.be.a(AmazonOmics.VariantImportItemDetail);
    });
