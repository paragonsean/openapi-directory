...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.GetReferenceImportJobResponse();
  });
  ...
  describe('GetReferenceImportJobResponse', function() {
    it('should create an instance of GetReferenceImportJobResponse', function() {
      // uncomment below and update the code to test GetReferenceImportJobResponse
      //var instance = new AmazonOmics.GetReferenceImportJobResponse();
      //expect(instance).to.be.a(AmazonOmics.GetReferenceImportJobResponse);
    });
