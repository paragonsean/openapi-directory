...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ReadSetFiles();
  });
  ...
  describe('ReadSetFiles', function() {
    it('should create an instance of ReadSetFiles', function() {
      // uncomment below and update the code to test ReadSetFiles
      //var instance = new AmazonOmics.ReadSetFiles();
      //expect(instance).to.be.a(AmazonOmics.ReadSetFiles);
    });
