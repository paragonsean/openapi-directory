...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ReferenceListItem();
  });
  ...
  describe('ReferenceListItem', function() {
    it('should create an instance of ReferenceListItem', function() {
      // uncomment below and update the code to test ReferenceListItem
      //var instance = new AmazonOmics.ReferenceListItem();
      //expect(instance).to.be.a(AmazonOmics.ReferenceListItem);
    });
