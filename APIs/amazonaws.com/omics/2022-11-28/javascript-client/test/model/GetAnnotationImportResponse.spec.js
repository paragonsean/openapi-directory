...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.GetAnnotationImportResponse();
  });
  ...
  describe('GetAnnotationImportResponse', function() {
    it('should create an instance of GetAnnotationImportResponse', function() {
      // uncomment below and update the code to test GetAnnotationImportResponse
      //var instance = new AmazonOmics.GetAnnotationImportResponse();
      //expect(instance).to.be.a(AmazonOmics.GetAnnotationImportResponse);
    });
