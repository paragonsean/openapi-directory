...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ReferenceStoreFilter();
  });
  ...
  describe('ReferenceStoreFilter', function() {
    it('should create an instance of ReferenceStoreFilter', function() {
      // uncomment below and update the code to test ReferenceStoreFilter
      //var instance = new AmazonOmics.ReferenceStoreFilter();
      //expect(instance).to.be.a(AmazonOmics.ReferenceStoreFilter);
    });
