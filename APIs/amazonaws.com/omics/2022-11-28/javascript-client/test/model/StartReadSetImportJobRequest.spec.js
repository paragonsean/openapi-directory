...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.StartReadSetImportJobRequest();
  });
  ...
  describe('StartReadSetImportJobRequest', function() {
    it('should create an instance of StartReadSetImportJobRequest', function() {
      // uncomment below and update the code to test StartReadSetImportJobRequest
      //var instance = new AmazonOmics.StartReadSetImportJobRequest();
      //expect(instance).to.be.a(AmazonOmics.StartReadSetImportJobRequest);
    });
