...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.TaskListItem();
  });
  ...
  describe('TaskListItem', function() {
    it('should create an instance of TaskListItem', function() {
      // uncomment below and update the code to test TaskListItem
      //var instance = new AmazonOmics.TaskListItem();
      //expect(instance).to.be.a(AmazonOmics.TaskListItem);
    });
