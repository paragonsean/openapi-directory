...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ReferenceFilter();
  });
  ...
  describe('ReferenceFilter', function() {
    it('should create an instance of ReferenceFilter', function() {
      // uncomment below and update the code to test ReferenceFilter
      //var instance = new AmazonOmics.ReferenceFilter();
      //expect(instance).to.be.a(AmazonOmics.ReferenceFilter);
    });
