...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.GetVariantImportResponse();
  });
  ...
  describe('GetVariantImportResponse', function() {
    it('should create an instance of GetVariantImportResponse', function() {
      // uncomment below and update the code to test GetVariantImportResponse
      //var instance = new AmazonOmics.GetVariantImportResponse();
      //expect(instance).to.be.a(AmazonOmics.GetVariantImportResponse);
    });
