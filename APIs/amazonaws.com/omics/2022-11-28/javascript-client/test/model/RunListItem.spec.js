...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.RunListItem();
  });
  ...
  describe('RunListItem', function() {
    it('should create an instance of RunListItem', function() {
      // uncomment below and update the code to test RunListItem
      //var instance = new AmazonOmics.RunListItem();
      //expect(instance).to.be.a(AmazonOmics.RunListItem);
    });
