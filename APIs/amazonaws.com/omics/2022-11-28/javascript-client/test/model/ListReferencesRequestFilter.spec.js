...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ListReferencesRequestFilter();
  });
  ...
  describe('ListReferencesRequestFilter', function() {
    it('should create an instance of ListReferencesRequestFilter', function() {
      // uncomment below and update the code to test ListReferencesRequestFilter
      //var instance = new AmazonOmics.ListReferencesRequestFilter();
      //expect(instance).to.be.a(AmazonOmics.ListReferencesRequestFilter);
    });
