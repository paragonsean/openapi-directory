...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.SequenceStoreFilter();
  });
  ...
  describe('SequenceStoreFilter', function() {
    it('should create an instance of SequenceStoreFilter', function() {
      // uncomment below and update the code to test SequenceStoreFilter
      //var instance = new AmazonOmics.SequenceStoreFilter();
      //expect(instance).to.be.a(AmazonOmics.SequenceStoreFilter);
    });
