...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ExportReadSetFilter();
  });
  ...
  describe('ExportReadSetFilter', function() {
    it('should create an instance of ExportReadSetFilter', function() {
      // uncomment below and update the code to test ExportReadSetFilter
      //var instance = new AmazonOmics.ExportReadSetFilter();
      //expect(instance).to.be.a(AmazonOmics.ExportReadSetFilter);
    });
