...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.WorkflowListItem();
  });
  ...
  describe('WorkflowListItem', function() {
    it('should create an instance of WorkflowListItem', function() {
      // uncomment below and update the code to test WorkflowListItem
      //var instance = new AmazonOmics.WorkflowListItem();
      //expect(instance).to.be.a(AmazonOmics.WorkflowListItem);
    });
