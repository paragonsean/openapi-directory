...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ImportReadSetFilter();
  });
  ...
  describe('ImportReadSetFilter', function() {
    it('should create an instance of ImportReadSetFilter', function() {
      // uncomment below and update the code to test ImportReadSetFilter
      //var instance = new AmazonOmics.ImportReadSetFilter();
      //expect(instance).to.be.a(AmazonOmics.ImportReadSetFilter);
    });
