...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.SourceFiles();
  });
  ...
  describe('SourceFiles', function() {
    it('should create an instance of SourceFiles', function() {
      // uncomment below and update the code to test SourceFiles
      //var instance = new AmazonOmics.SourceFiles();
      //expect(instance).to.be.a(AmazonOmics.SourceFiles);
    });
