...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ListReferencesResponse();
  });
  ...
  describe('ListReferencesResponse', function() {
    it('should create an instance of ListReferencesResponse', function() {
      // uncomment below and update the code to test ListReferencesResponse
      //var instance = new AmazonOmics.ListReferencesResponse();
      //expect(instance).to.be.a(AmazonOmics.ListReferencesResponse);
    });
