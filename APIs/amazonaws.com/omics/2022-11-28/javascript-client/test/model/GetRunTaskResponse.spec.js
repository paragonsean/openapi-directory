...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.GetRunTaskResponse();
  });
  ...
  describe('GetRunTaskResponse', function() {
    it('should create an instance of GetRunTaskResponse', function() {
      // uncomment below and update the code to test GetRunTaskResponse
      //var instance = new AmazonOmics.GetRunTaskResponse();
      //expect(instance).to.be.a(AmazonOmics.GetRunTaskResponse);
    });
    ...
    it('should have the property logStream (base name: "logStream")', function() {
      // uncomment below and update the code to test the property logStream
      //var instance = new AmazonOmics.GetRunTaskResponse();
      //expect(instance).to.be();
    });
