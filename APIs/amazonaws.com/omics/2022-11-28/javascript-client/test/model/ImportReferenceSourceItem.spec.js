...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ImportReferenceSourceItem();
  });
  ...
  describe('ImportReferenceSourceItem', function() {
    it('should create an instance of ImportReferenceSourceItem', function() {
      // uncomment below and update the code to test ImportReferenceSourceItem
      //var instance = new AmazonOmics.ImportReferenceSourceItem();
      //expect(instance).to.be.a(AmazonOmics.ImportReferenceSourceItem);
    });
