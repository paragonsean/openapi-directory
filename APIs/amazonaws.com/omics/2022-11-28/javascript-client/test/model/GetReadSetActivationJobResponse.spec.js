...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.GetReadSetActivationJobResponse();
  });
  ...
  describe('GetReadSetActivationJobResponse', function() {
    it('should create an instance of GetReadSetActivationJobResponse', function() {
      // uncomment below and update the code to test GetReadSetActivationJobResponse
      //var instance = new AmazonOmics.GetReadSetActivationJobResponse();
      //expect(instance).to.be.a(AmazonOmics.GetReadSetActivationJobResponse);
    });
