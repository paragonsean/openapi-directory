...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ImportReferenceFilter();
  });
  ...
  describe('ImportReferenceFilter', function() {
    it('should create an instance of ImportReferenceFilter', function() {
      // uncomment below and update the code to test ImportReferenceFilter
      //var instance = new AmazonOmics.ImportReferenceFilter();
      //expect(instance).to.be.a(AmazonOmics.ImportReferenceFilter);
    });
