...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.ActivateReadSetFilter();
  });
  ...
  describe('ActivateReadSetFilter', function() {
    it('should create an instance of ActivateReadSetFilter', function() {
      // uncomment below and update the code to test ActivateReadSetFilter
      //var instance = new AmazonOmics.ActivateReadSetFilter();
      //expect(instance).to.be.a(AmazonOmics.ActivateReadSetFilter);
    });
