...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.StartReadSetExportJobRequest();
  });
  ...
  describe('StartReadSetExportJobRequest', function() {
    it('should create an instance of StartReadSetExportJobRequest', function() {
      // uncomment below and update the code to test StartReadSetExportJobRequest
      //var instance = new AmazonOmics.StartReadSetExportJobRequest();
      //expect(instance).to.be.a(AmazonOmics.StartReadSetExportJobRequest);
    });
