...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOmics.AnnotationImportJobItem();
  });
  ...
  describe('AnnotationImportJobItem', function() {
    it('should create an instance of AnnotationImportJobItem', function() {
      // uncomment below and update the code to test AnnotationImportJobItem
      //var instance = new AmazonOmics.AnnotationImportJobItem();
      //expect(instance).to.be.a(AmazonOmics.AnnotationImportJobItem);
    });
