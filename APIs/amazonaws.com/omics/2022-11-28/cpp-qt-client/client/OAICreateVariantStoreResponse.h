...
/*
 * OAICreateVariantStoreResponse.h
 *
 * 
 */

#ifndef OAICreateVariantStoreResponse_H
#define OAICreateVariantStoreResponse_H
...
class OAICreateVariantStoreResponse : public OAIObject {
public:
    OAICreateVariantStoreResponse();
    OAICreateVariantStoreResponse(QString json);
    ~OAICreateVariantStoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVariantStoreResponse)

#endif // OAICreateVariantStoreResponse_H
