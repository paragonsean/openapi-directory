...
OAIReadSetFilter::OAIReadSetFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReadSetFilter::OAIReadSetFilter() {
    this->initializeModel();
}

OAIReadSetFilter::~OAIReadSetFilter() {}

void OAIReadSetFilter::initializeModel() {
...
void OAIReadSetFilter::fromJson(QString jsonString) {
...
void OAIReadSetFilter::fromJsonObject(QJsonObject json) {
...
QString OAIReadSetFilter::asJson() const {
...
QJsonObject OAIReadSetFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIReadSetFilter::getName() const {
    return m_name;
}
void OAIReadSetFilter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIReadSetFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIReadSetFilter::is_name_Valid() const{
    return m_name_isValid;
}

OAIReadSetStatus OAIReadSetFilter::getStatus() const {
    return m_status;
}
void OAIReadSetFilter::setStatus(const OAIReadSetStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIReadSetFilter::is_status_Set() const{
    return m_status_isSet;
}

bool OAIReadSetFilter::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIReadSetFilter::getReferenceArn() const {
    return m_reference_arn;
}
void OAIReadSetFilter::setReferenceArn(const QString &reference_arn) {
    m_reference_arn = reference_arn;
    m_reference_arn_isSet = true;
}

bool OAIReadSetFilter::is_reference_arn_Set() const{
    return m_reference_arn_isSet;
}

bool OAIReadSetFilter::is_reference_arn_Valid() const{
    return m_reference_arn_isValid;
}

QDateTime OAIReadSetFilter::getCreatedAfter() const {
    return m_created_after;
}
void OAIReadSetFilter::setCreatedAfter(const QDateTime &created_after) {
    m_created_after = created_after;
    m_created_after_isSet = true;
}

bool OAIReadSetFilter::is_created_after_Set() const{
    return m_created_after_isSet;
}

bool OAIReadSetFilter::is_created_after_Valid() const{
    return m_created_after_isValid;
}

QDateTime OAIReadSetFilter::getCreatedBefore() const {
    return m_created_before;
}
void OAIReadSetFilter::setCreatedBefore(const QDateTime &created_before) {
    m_created_before = created_before;
    m_created_before_isSet = true;
}

bool OAIReadSetFilter::is_created_before_Set() const{
    return m_created_before_isSet;
}

bool OAIReadSetFilter::is_created_before_Valid() const{
    return m_created_before_isValid;
}

QString OAIReadSetFilter::getSampleId() const {
    return m_sample_id;
}
void OAIReadSetFilter::setSampleId(const QString &sample_id) {
    m_sample_id = sample_id;
    m_sample_id_isSet = true;
}

bool OAIReadSetFilter::is_sample_id_Set() const{
    return m_sample_id_isSet;
}

bool OAIReadSetFilter::is_sample_id_Valid() const{
    return m_sample_id_isValid;
}

QString OAIReadSetFilter::getSubjectId() const {
    return m_subject_id;
}
void OAIReadSetFilter::setSubjectId(const QString &subject_id) {
    m_subject_id = subject_id;
    m_subject_id_isSet = true;
}

bool OAIReadSetFilter::is_subject_id_Set() const{
    return m_subject_id_isSet;
}

bool OAIReadSetFilter::is_subject_id_Valid() const{
    return m_subject_id_isValid;
}

QString OAIReadSetFilter::getGeneratedFrom() const {
    return m_generated_from;
}
void OAIReadSetFilter::setGeneratedFrom(const QString &generated_from) {
    m_generated_from = generated_from;
    m_generated_from_isSet = true;
}

bool OAIReadSetFilter::is_generated_from_Set() const{
    return m_generated_from_isSet;
}

bool OAIReadSetFilter::is_generated_from_Valid() const{
    return m_generated_from_isValid;
}

OAICreationType OAIReadSetFilter::getCreationType() const {
    return m_creation_type;
}
void OAIReadSetFilter::setCreationType(const OAICreationType &creation_type) {
    m_creation_type = creation_type;
    m_creation_type_isSet = true;
}

bool OAIReadSetFilter::is_creation_type_Set() const{
    return m_creation_type_isSet;
}

bool OAIReadSetFilter::is_creation_type_Valid() const{
    return m_creation_type_isValid;
}

bool OAIReadSetFilter::isSet() const {
...
bool OAIReadSetFilter::isValid() const {
