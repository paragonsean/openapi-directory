...
/*
 * OAIGetAnnotationStoreResponse.h
 *
 * 
 */

#ifndef OAIGetAnnotationStoreResponse_H
#define OAIGetAnnotationStoreResponse_H
...
class OAIGetAnnotationStoreResponse_storeOptions;

class OAIGetAnnotationStoreResponse : public OAIObject {
public:
    OAIGetAnnotationStoreResponse();
    OAIGetAnnotationStoreResponse(QString json);
    ~OAIGetAnnotationStoreResponse() override;
    ...
    OAIGetAnnotationStoreResponse_storeOptions getStoreOptions() const;
    void setStoreOptions(const OAIGetAnnotationStoreResponse_storeOptions &store_options);
...
private:
    ...
    OAIGetAnnotationStoreResponse_storeOptions m_store_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAnnotationStoreResponse)

#endif // OAIGetAnnotationStoreResponse_H
