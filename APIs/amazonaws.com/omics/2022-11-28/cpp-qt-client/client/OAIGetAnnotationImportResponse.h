...
/*
 * OAIGetAnnotationImportResponse.h
 *
 * 
 */

#ifndef OAIGetAnnotationImportResponse_H
#define OAIGetAnnotationImportResponse_H
...
namespace OpenAPI {
class OAIFormatOptions;

class OAIGetAnnotationImportResponse : public OAIObject {
public:
    OAIGetAnnotationImportResponse();
    OAIGetAnnotationImportResponse(QString json);
    ~OAIGetAnnotationImportResponse() override;
    ...
    OAIFormatOptions getFormatOptions() const;
    void setFormatOptions(const OAIFormatOptions &format_options);
...
private:
    ...
    OAIFormatOptions m_format_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAnnotationImportResponse)

#endif // OAIGetAnnotationImportResponse_H
