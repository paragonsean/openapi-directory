...
/*
 * OAIVariantStoreItem.h
 *
 * A variant store.
 */

#ifndef OAIVariantStoreItem_H
#define OAIVariantStoreItem_H
...
class OAIVariantStoreItem : public OAIObject {
public:
    OAIVariantStoreItem();
    OAIVariantStoreItem(QString json);
    ~OAIVariantStoreItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariantStoreItem)

#endif // OAIVariantStoreItem_H
