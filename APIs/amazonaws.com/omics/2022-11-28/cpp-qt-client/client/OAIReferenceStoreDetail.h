...
/*
 * OAIReferenceStoreDetail.h
 *
 * Details about a reference store.
 */

#ifndef OAIReferenceStoreDetail_H
#define OAIReferenceStoreDetail_H
...
class OAIReferenceStoreDetail : public OAIObject {
public:
    OAIReferenceStoreDetail();
    OAIReferenceStoreDetail(QString json);
    ~OAIReferenceStoreDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceStoreDetail)

#endif // OAIReferenceStoreDetail_H
