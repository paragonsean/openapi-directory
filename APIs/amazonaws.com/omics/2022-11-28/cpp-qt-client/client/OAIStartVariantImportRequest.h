...
/*
 * OAIStartVariantImportRequest.h
 *
 * 
 */

#ifndef OAIStartVariantImportRequest_H
#define OAIStartVariantImportRequest_H
...
class OAIStartVariantImportRequest : public OAIObject {
public:
    OAIStartVariantImportRequest();
    OAIStartVariantImportRequest(QString json);
    ~OAIStartVariantImportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartVariantImportRequest)

#endif // OAIStartVariantImportRequest_H
