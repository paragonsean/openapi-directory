...
OAIListReadSetsRequest_filter::OAIListReadSetsRequest_filter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListReadSetsRequest_filter::OAIListReadSetsRequest_filter() {
    this->initializeModel();
}

OAIListReadSetsRequest_filter::~OAIListReadSetsRequest_filter() {}

void OAIListReadSetsRequest_filter::initializeModel() {
...
void OAIListReadSetsRequest_filter::fromJson(QString jsonString) {
...
void OAIListReadSetsRequest_filter::fromJsonObject(QJsonObject json) {
...
QString OAIListReadSetsRequest_filter::asJson() const {
...
QJsonObject OAIListReadSetsRequest_filter::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIListReadSetsRequest_filter::getName() const {
    return m_name;
}
void OAIListReadSetsRequest_filter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIListReadSetsRequest_filter::is_name_Valid() const{
    return m_name_isValid;
}

OAIReadSetStatus OAIListReadSetsRequest_filter::getStatus() const {
    return m_status;
}
void OAIListReadSetsRequest_filter::setStatus(const OAIReadSetStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_status_Set() const{
    return m_status_isSet;
}

bool OAIListReadSetsRequest_filter::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIListReadSetsRequest_filter::getReferenceArn() const {
    return m_reference_arn;
}
void OAIListReadSetsRequest_filter::setReferenceArn(const QString &reference_arn) {
    m_reference_arn = reference_arn;
    m_reference_arn_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_reference_arn_Set() const{
    return m_reference_arn_isSet;
}

bool OAIListReadSetsRequest_filter::is_reference_arn_Valid() const{
    return m_reference_arn_isValid;
}

QDateTime OAIListReadSetsRequest_filter::getCreatedAfter() const {
    return m_created_after;
}
void OAIListReadSetsRequest_filter::setCreatedAfter(const QDateTime &created_after) {
    m_created_after = created_after;
    m_created_after_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_created_after_Set() const{
    return m_created_after_isSet;
}

bool OAIListReadSetsRequest_filter::is_created_after_Valid() const{
    return m_created_after_isValid;
}

QDateTime OAIListReadSetsRequest_filter::getCreatedBefore() const {
    return m_created_before;
}
void OAIListReadSetsRequest_filter::setCreatedBefore(const QDateTime &created_before) {
    m_created_before = created_before;
    m_created_before_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_created_before_Set() const{
    return m_created_before_isSet;
}

bool OAIListReadSetsRequest_filter::is_created_before_Valid() const{
    return m_created_before_isValid;
}

QString OAIListReadSetsRequest_filter::getSampleId() const {
    return m_sample_id;
}
void OAIListReadSetsRequest_filter::setSampleId(const QString &sample_id) {
    m_sample_id = sample_id;
    m_sample_id_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_sample_id_Set() const{
    return m_sample_id_isSet;
}

bool OAIListReadSetsRequest_filter::is_sample_id_Valid() const{
    return m_sample_id_isValid;
}

QString OAIListReadSetsRequest_filter::getSubjectId() const {
    return m_subject_id;
}
void OAIListReadSetsRequest_filter::setSubjectId(const QString &subject_id) {
    m_subject_id = subject_id;
    m_subject_id_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_subject_id_Set() const{
    return m_subject_id_isSet;
}

bool OAIListReadSetsRequest_filter::is_subject_id_Valid() const{
    return m_subject_id_isValid;
}

QString OAIListReadSetsRequest_filter::getGeneratedFrom() const {
    return m_generated_from;
}
void OAIListReadSetsRequest_filter::setGeneratedFrom(const QString &generated_from) {
    m_generated_from = generated_from;
    m_generated_from_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_generated_from_Set() const{
    return m_generated_from_isSet;
}

bool OAIListReadSetsRequest_filter::is_generated_from_Valid() const{
    return m_generated_from_isValid;
}

OAICreationType OAIListReadSetsRequest_filter::getCreationType() const {
    return m_creation_type;
}
void OAIListReadSetsRequest_filter::setCreationType(const OAICreationType &creation_type) {
    m_creation_type = creation_type;
    m_creation_type_isSet = true;
}

bool OAIListReadSetsRequest_filter::is_creation_type_Set() const{
    return m_creation_type_isSet;
}

bool OAIListReadSetsRequest_filter::is_creation_type_Valid() const{
    return m_creation_type_isValid;
}

bool OAIListReadSetsRequest_filter::isSet() const {
...
bool OAIListReadSetsRequest_filter::isValid() const {
