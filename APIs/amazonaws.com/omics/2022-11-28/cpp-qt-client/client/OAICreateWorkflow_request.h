...
/*
 * OAICreateWorkflow_request.h
 *
 * 
 */

#ifndef OAICreateWorkflow_request_H
#define OAICreateWorkflow_request_H
...
class OAICreateWorkflow_request : public OAIObject {
public:
    OAICreateWorkflow_request();
    OAICreateWorkflow_request(QString json);
    ~OAICreateWorkflow_request() override;
    ...
    QMap<QString, OAIWorkflowParameter> getParameterTemplate() const;
    void setParameterTemplate(const QMap<QString, OAIWorkflowParameter> &parameter_template);
    ...
    QString getAccelerators() const;
    void setAccelerators(const QString &accelerators);
...
private:
    ...
    QMap<QString, OAIWorkflowParameter> m_parameter_template;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorkflow_request)

#endif // OAICreateWorkflow_request_H
