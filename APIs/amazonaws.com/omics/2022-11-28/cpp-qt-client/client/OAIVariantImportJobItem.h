...
/*
 * OAIVariantImportJobItem.h
 *
 * A variant import job.
 */

#ifndef OAIVariantImportJobItem_H
#define OAIVariantImportJobItem_H
...
class OAIVariantImportJobItem : public OAIObject {
public:
    OAIVariantImportJobItem();
    OAIVariantImportJobItem(QString json);
    ~OAIVariantImportJobItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariantImportJobItem)

#endif // OAIVariantImportJobItem_H
