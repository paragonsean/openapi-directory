...
/*
 * OAIGetVariantStoreResponse.h
 *
 * 
 */

#ifndef OAIGetVariantStoreResponse_H
#define OAIGetVariantStoreResponse_H
...
class OAIGetVariantStoreResponse : public OAIObject {
public:
    OAIGetVariantStoreResponse();
    OAIGetVariantStoreResponse(QString json);
    ~OAIGetVariantStoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVariantStoreResponse)

#endif // OAIGetVariantStoreResponse_H
