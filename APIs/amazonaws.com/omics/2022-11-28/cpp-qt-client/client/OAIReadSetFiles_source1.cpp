...
OAIReadSetFiles_source1::OAIReadSetFiles_source1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReadSetFiles_source1::OAIReadSetFiles_source1() {
    this->initializeModel();
}

OAIReadSetFiles_source1::~OAIReadSetFiles_source1() {}

void OAIReadSetFiles_source1::initializeModel() {
...
void OAIReadSetFiles_source1::fromJson(QString jsonString) {
...
void OAIReadSetFiles_source1::fromJsonObject(QJsonObject json) {
...
QString OAIReadSetFiles_source1::asJson() const {
...
QJsonObject OAIReadSetFiles_source1::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIReadSetFiles_source1::getTotalParts() const {
    return m_total_parts;
}
void OAIReadSetFiles_source1::setTotalParts(const qint32 &total_parts) {
    m_total_parts = total_parts;
    m_total_parts_isSet = true;
}

bool OAIReadSetFiles_source1::is_total_parts_Set() const{
    return m_total_parts_isSet;
}

bool OAIReadSetFiles_source1::is_total_parts_Valid() const{
    return m_total_parts_isValid;
}

qint32 OAIReadSetFiles_source1::getPartSize() const {
    return m_part_size;
}
void OAIReadSetFiles_source1::setPartSize(const qint32 &part_size) {
    m_part_size = part_size;
    m_part_size_isSet = true;
}

bool OAIReadSetFiles_source1::is_part_size_Set() const{
    return m_part_size_isSet;
}

bool OAIReadSetFiles_source1::is_part_size_Valid() const{
    return m_part_size_isValid;
}

qint32 OAIReadSetFiles_source1::getContentLength() const {
    return m_content_length;
}
void OAIReadSetFiles_source1::setContentLength(const qint32 &content_length) {
    m_content_length = content_length;
    m_content_length_isSet = true;
}

bool OAIReadSetFiles_source1::is_content_length_Set() const{
    return m_content_length_isSet;
}

bool OAIReadSetFiles_source1::is_content_length_Valid() const{
    return m_content_length_isValid;
}

bool OAIReadSetFiles_source1::isSet() const {
...
bool OAIReadSetFiles_source1::isValid() const {
