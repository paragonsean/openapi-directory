...
/*
 * OAITsvOptions_readOptions.h
 *
 * 
 */

#ifndef OAITsvOptions_readOptions_H
#define OAITsvOptions_readOptions_H
...
class OAITsvOptions_readOptions : public OAIObject {
public:
    OAITsvOptions_readOptions();
    OAITsvOptions_readOptions(QString json);
    ~OAITsvOptions_readOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITsvOptions_readOptions)

#endif // OAITsvOptions_readOptions_H
