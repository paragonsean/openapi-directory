...
public class ReadSetFilter {
  ...
  public ReadSetFilter() {
  }

  public ReadSetFilter name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ReadSetFilter status(ReadSetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ReadSetFilter referenceArn(String referenceArn) {
  ...
  public ReadSetFilter createdAfter(OffsetDateTime createdAfter) {
  ...
  public ReadSetFilter createdBefore(OffsetDateTime createdBefore) {
  ...
  public ReadSetFilter sampleId(String sampleId) {
  ...
  public ReadSetFilter subjectId(String subjectId) {
  ...
  public ReadSetFilter generatedFrom(String generatedFrom) {
  ...
  public ReadSetFilter creationType(CreationType creationType) {
  ...
  public boolean equals(Object o) {
    ...
    ReadSetFilter readSetFilter = (ReadSetFilter) o;
    return Objects.equals(this.name, readSetFilter.name) &&
        Objects.equals(this.status, readSetFilter.status) &&
        Objects.equals(this.referenceArn, readSetFilter.referenceArn) &&
        Objects.equals(this.createdAfter, readSetFilter.createdAfter) &&
        Objects.equals(this.createdBefore, readSetFilter.createdBefore) &&
        Objects.equals(this.sampleId, readSetFilter.sampleId) &&
        Objects.equals(this.subjectId, readSetFilter.subjectId) &&
        Objects.equals(this.generatedFrom, readSetFilter.generatedFrom) &&
        Objects.equals(this.creationType, readSetFilter.creationType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReadSetFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReadSetFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadSetFilter is not found in the empty JSON string", ReadSetFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReadSetFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReadSetFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadSetFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadSetFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadSetFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadSetFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadSetFilter>() {
           @Override
           public void write(JsonWriter out, ReadSetFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReadSetFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReadSetFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReadSetFilter
   * @throws IOException if the JSON string is invalid with respect to ReadSetFilter
   */
  public static ReadSetFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadSetFilter.class);
  }

  /**
   * Convert an instance of ReadSetFilter to an JSON string
   *
   * @return JSON string
   */
