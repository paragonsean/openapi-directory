...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDbStreams.RecordUserIdentity();
  });
  ...
  describe('RecordUserIdentity', function() {
    it('should create an instance of RecordUserIdentity', function() {
      // uncomment below and update the code to test RecordUserIdentity
      //var instance = new AmazonDynamoDbStreams.RecordUserIdentity();
      //expect(instance).to.be.a(AmazonDynamoDbStreams.RecordUserIdentity);
    });
