...
/**
 * The RecordDynamodb model module.
 * @module model/RecordDynamodb
 * @version 2012-08-10
 */
class RecordDynamodb {
    /**
     * Constructs a new <code>RecordDynamodb</code>.
     * @alias module:model/RecordDynamodb
     * @implements module:model/StreamRecord
     */
    constructor() { 
        StreamRecord.initialize(this);
        RecordDynamodb.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RecordDynamodb</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecordDynamodb} obj Optional instance to populate.
     * @return {module:model/RecordDynamodb} The populated <code>RecordDynamodb</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordDynamodb();
            StreamRecord.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RecordDynamodb</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecordDynamodb</code>.
     */
 ...
 */
RecordDynamodb.prototype['ApproximateCreationDateTime'] = undefined;

/**
 * @member {Object} Keys
 */
RecordDynamodb.prototype['Keys'] = undefined;

/**
 * @member {Object} NewImage
 */
RecordDynamodb.prototype['NewImage'] = undefined;

/**
 * @member {Object} OldImage
 */
RecordDynamodb.prototype['OldImage'] = undefined;

/**
 * @member {String} SequenceNumber
 */
RecordDynamodb.prototype['SequenceNumber'] = undefined;

/**
 * @member {Number} SizeBytes
 */
RecordDynamodb.prototype['SizeBytes'] = undefined;

/**
 * @member {module:model/StreamViewType} StreamViewType
 */
RecordDynamodb.prototype['StreamViewType'] = undefined;


// Implement StreamRecord interface:
/**
 * @member {Date} ApproximateCreationDateTime
 */
