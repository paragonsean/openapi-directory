...
QString Example::create(){
    QString obj;
OAIDescribeStreamInput Example::create(){
    OAIDescribeStreamInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::describeStreamSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::describeStreamSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIDescribeStreamInput oai_describe_stream_input = create(); // OAIDescribeStreamInput | 
      ...
      apiInstance.describeStream(x_amz_targetoai_describe_stream_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
