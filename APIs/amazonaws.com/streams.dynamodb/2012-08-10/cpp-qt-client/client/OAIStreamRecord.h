...
#ifndef OAIStreamRecord_H
#define OAIStreamRecord_H
...
class OAIStreamRecord : public OAIObject {
public:
    OAIStreamRecord();
    OAIStreamRecord(QString json);
    ~OAIStreamRecord() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamRecord)

#endif // OAIStreamRecord_H
