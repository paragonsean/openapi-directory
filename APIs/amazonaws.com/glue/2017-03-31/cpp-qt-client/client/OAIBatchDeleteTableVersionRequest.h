...
/*
 * OAIBatchDeleteTableVersionRequest.h
 *
 * 
 */

#ifndef OAIBatchDeleteTableVersionRequest_H
#define OAIBatchDeleteTableVersionRequest_H
...
class OAIBatchDeleteTableVersionRequest : public OAIObject {
public:
    OAIBatchDeleteTableVersionRequest();
    OAIBatchDeleteTableVersionRequest(QString json);
    ~OAIBatchDeleteTableVersionRequest() override;
    ...
    QList getVersionIds() const;
    void setVersionIds(const QList &version_ids);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeleteTableVersionRequest)

#endif // OAIBatchDeleteTableVersionRequest_H
