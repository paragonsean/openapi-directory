...
#ifndef OAIRenameField_H
#define OAIRenameField_H
...
class OAIRenameField : public OAIObject {
public:
    OAIRenameField();
    OAIRenameField(QString json);
    ~OAIRenameField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRenameField)

#endif // OAIRenameField_H
