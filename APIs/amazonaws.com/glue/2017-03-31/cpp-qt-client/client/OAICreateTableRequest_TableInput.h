...
/*
 * OAICreateTableRequest_TableInput.h
 *
 * 
 */

#ifndef OAICreateTableRequest_TableInput_H
#define OAICreateTableRequest_TableInput_H
...
class OAICreateTableRequest_TableInput : public OAIObject {
public:
    OAICreateTableRequest_TableInput();
    OAICreateTableRequest_TableInput(QString json);
    ~OAICreateTableRequest_TableInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_TableInput)

#endif // OAICreateTableRequest_TableInput_H
