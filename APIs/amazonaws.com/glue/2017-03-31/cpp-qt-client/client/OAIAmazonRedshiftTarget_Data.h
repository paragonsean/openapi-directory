...
/*
 * OAIAmazonRedshiftTarget_Data.h
 *
 * 
 */

#ifndef OAIAmazonRedshiftTarget_Data_H
#define OAIAmazonRedshiftTarget_Data_H
...
class OAIAmazonRedshiftTarget_Data : public OAIObject {
public:
    OAIAmazonRedshiftTarget_Data();
    OAIAmazonRedshiftTarget_Data(QString json);
    ~OAIAmazonRedshiftTarget_Data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmazonRedshiftTarget_Data)

#endif // OAIAmazonRedshiftTarget_Data_H
