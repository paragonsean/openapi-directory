...
/*
 * OAIGetUnfilteredTableMetadataResponse_Table.h
 *
 * 
 */

#ifndef OAIGetUnfilteredTableMetadataResponse_Table_H
#define OAIGetUnfilteredTableMetadataResponse_Table_H
...
class OAIGetUnfilteredTableMetadataResponse_Table : public OAIObject {
public:
    OAIGetUnfilteredTableMetadataResponse_Table();
    OAIGetUnfilteredTableMetadataResponse_Table(QString json);
    ~OAIGetUnfilteredTableMetadataResponse_Table() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUnfilteredTableMetadataResponse_Table)

#endif // OAIGetUnfilteredTableMetadataResponse_Table_H
