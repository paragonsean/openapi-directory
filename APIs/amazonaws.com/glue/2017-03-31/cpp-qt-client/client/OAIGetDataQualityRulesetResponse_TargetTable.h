...
/*
 * OAIGetDataQualityRulesetResponse_TargetTable.h
 *
 * 
 */

#ifndef OAIGetDataQualityRulesetResponse_TargetTable_H
#define OAIGetDataQualityRulesetResponse_TargetTable_H
...
class OAIGetDataQualityRulesetResponse_TargetTable : public OAIObject {
public:
    OAIGetDataQualityRulesetResponse_TargetTable();
    OAIGetDataQualityRulesetResponse_TargetTable(QString json);
    ~OAIGetDataQualityRulesetResponse_TargetTable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataQualityRulesetResponse_TargetTable)

#endif // OAIGetDataQualityRulesetResponse_TargetTable_H
