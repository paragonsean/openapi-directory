...
/*
 * OAIUpdateSourceControlFromJobRequest.h
 *
 * 
 */

#ifndef OAIUpdateSourceControlFromJobRequest_H
#define OAIUpdateSourceControlFromJobRequest_H
...
class OAIUpdateSourceControlFromJobRequest : public OAIObject {
public:
    OAIUpdateSourceControlFromJobRequest();
    OAIUpdateSourceControlFromJobRequest(QString json);
    ~OAIUpdateSourceControlFromJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSourceControlFromJobRequest)

#endif // OAIUpdateSourceControlFromJobRequest_H
