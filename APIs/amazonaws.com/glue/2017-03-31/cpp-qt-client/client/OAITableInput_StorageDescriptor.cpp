...
OAITableInput_StorageDescriptor::OAITableInput_StorageDescriptor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITableInput_StorageDescriptor::OAITableInput_StorageDescriptor() {
    this->initializeModel();
}

OAITableInput_StorageDescriptor::~OAITableInput_StorageDescriptor() {}

void OAITableInput_StorageDescriptor::initializeModel() {
...
void OAITableInput_StorageDescriptor::fromJson(QString jsonString) {
...
void OAITableInput_StorageDescriptor::fromJsonObject(QJsonObject json) {
...
QString OAITableInput_StorageDescriptor::asJson() const {
...
QJsonObject OAITableInput_StorageDescriptor::asJsonObject() const {
    QJsonObject obj;
    if (m_columns.isSet()) {
...
QList OAITableInput_StorageDescriptor::getColumns() const {
    return m_columns;
}
void OAITableInput_StorageDescriptor::setColumns(const QList &columns) {
    m_columns = columns;
    m_columns_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_columns_Set() const{
    return m_columns_isSet;
}

bool OAITableInput_StorageDescriptor::is_columns_Valid() const{
    return m_columns_isValid;
}

QString OAITableInput_StorageDescriptor::getLocation() const {
    return m_location;
}
void OAITableInput_StorageDescriptor::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_location_Set() const{
    return m_location_isSet;
}

bool OAITableInput_StorageDescriptor::is_location_Valid() const{
    return m_location_isValid;
}

QList OAITableInput_StorageDescriptor::getAdditionalLocations() const {
    return m_additional_locations;
}
void OAITableInput_StorageDescriptor::setAdditionalLocations(const QList &additional_locations) {
    m_additional_locations = additional_locations;
    m_additional_locations_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_additional_locations_Set() const{
    return m_additional_locations_isSet;
}

bool OAITableInput_StorageDescriptor::is_additional_locations_Valid() const{
    return m_additional_locations_isValid;
}

QString OAITableInput_StorageDescriptor::getInputFormat() const {
    return m_input_format;
}
void OAITableInput_StorageDescriptor::setInputFormat(const QString &input_format) {
    m_input_format = input_format;
    m_input_format_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_input_format_Set() const{
    return m_input_format_isSet;
}

bool OAITableInput_StorageDescriptor::is_input_format_Valid() const{
    return m_input_format_isValid;
}

QString OAITableInput_StorageDescriptor::getOutputFormat() const {
    return m_output_format;
}
void OAITableInput_StorageDescriptor::setOutputFormat(const QString &output_format) {
    m_output_format = output_format;
    m_output_format_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_output_format_Set() const{
    return m_output_format_isSet;
}

bool OAITableInput_StorageDescriptor::is_output_format_Valid() const{
    return m_output_format_isValid;
}

bool OAITableInput_StorageDescriptor::getCompressed() const {
    return m_compressed;
}
void OAITableInput_StorageDescriptor::setCompressed(const bool &compressed) {
    m_compressed = compressed;
    m_compressed_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_compressed_Set() const{
    return m_compressed_isSet;
}

bool OAITableInput_StorageDescriptor::is_compressed_Valid() const{
    return m_compressed_isValid;
}

qint32 OAITableInput_StorageDescriptor::getNumberOfBuckets() const {
    return m_number_of_buckets;
}
void OAITableInput_StorageDescriptor::setNumberOfBuckets(const qint32 &number_of_buckets) {
    m_number_of_buckets = number_of_buckets;
    m_number_of_buckets_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_number_of_buckets_Set() const{
    return m_number_of_buckets_isSet;
}

bool OAITableInput_StorageDescriptor::is_number_of_buckets_Valid() const{
    return m_number_of_buckets_isValid;
}

OAIStorageDescriptor_SerdeInfo OAITableInput_StorageDescriptor::getSerdeInfo() const {
    return m_serde_info;
}
void OAITableInput_StorageDescriptor::setSerdeInfo(const OAIStorageDescriptor_SerdeInfo &serde_info) {
    m_serde_info = serde_info;
    m_serde_info_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_serde_info_Set() const{
    return m_serde_info_isSet;
}

bool OAITableInput_StorageDescriptor::is_serde_info_Valid() const{
    return m_serde_info_isValid;
}

QList OAITableInput_StorageDescriptor::getBucketColumns() const {
    return m_bucket_columns;
}
void OAITableInput_StorageDescriptor::setBucketColumns(const QList &bucket_columns) {
    m_bucket_columns = bucket_columns;
    m_bucket_columns_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_bucket_columns_Set() const{
    return m_bucket_columns_isSet;
}

bool OAITableInput_StorageDescriptor::is_bucket_columns_Valid() const{
    return m_bucket_columns_isValid;
}

QList OAITableInput_StorageDescriptor::getSortColumns() const {
    return m_sort_columns;
}
void OAITableInput_StorageDescriptor::setSortColumns(const QList &sort_columns) {
    m_sort_columns = sort_columns;
    m_sort_columns_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_sort_columns_Set() const{
    return m_sort_columns_isSet;
}

bool OAITableInput_StorageDescriptor::is_sort_columns_Valid() const{
    return m_sort_columns_isValid;
}

QMap OAITableInput_StorageDescriptor::getParameters() const {
    return m_parameters;
}
void OAITableInput_StorageDescriptor::setParameters(const QMap &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAITableInput_StorageDescriptor::is_parameters_Valid() const{
    return m_parameters_isValid;
}

OAIStorageDescriptor_SkewedInfo OAITableInput_StorageDescriptor::getSkewedInfo() const {
    return m_skewed_info;
}
void OAITableInput_StorageDescriptor::setSkewedInfo(const OAIStorageDescriptor_SkewedInfo &skewed_info) {
    m_skewed_info = skewed_info;
    m_skewed_info_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_skewed_info_Set() const{
    return m_skewed_info_isSet;
}

bool OAITableInput_StorageDescriptor::is_skewed_info_Valid() const{
    return m_skewed_info_isValid;
}

bool OAITableInput_StorageDescriptor::getStoredAsSubDirectories() const {
    return m_stored_as_sub_directories;
}
void OAITableInput_StorageDescriptor::setStoredAsSubDirectories(const bool &stored_as_sub_directories) {
    m_stored_as_sub_directories = stored_as_sub_directories;
    m_stored_as_sub_directories_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_stored_as_sub_directories_Set() const{
    return m_stored_as_sub_directories_isSet;
}

bool OAITableInput_StorageDescriptor::is_stored_as_sub_directories_Valid() const{
    return m_stored_as_sub_directories_isValid;
}

OAIStorageDescriptor_SchemaReference OAITableInput_StorageDescriptor::getSchemaReference() const {
    return m_schema_reference;
}
void OAITableInput_StorageDescriptor::setSchemaReference(const OAIStorageDescriptor_SchemaReference &schema_reference) {
    m_schema_reference = schema_reference;
    m_schema_reference_isSet = true;
}

bool OAITableInput_StorageDescriptor::is_schema_reference_Set() const{
    return m_schema_reference_isSet;
}

bool OAITableInput_StorageDescriptor::is_schema_reference_Valid() const{
    return m_schema_reference_isValid;
}

bool OAITableInput_StorageDescriptor::isSet() const {
...
bool OAITableInput_StorageDescriptor::isValid() const {
