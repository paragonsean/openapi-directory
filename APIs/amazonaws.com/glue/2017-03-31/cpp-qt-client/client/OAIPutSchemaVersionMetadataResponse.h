...
/*
 * OAIPutSchemaVersionMetadataResponse.h
 *
 * 
 */

#ifndef OAIPutSchemaVersionMetadataResponse_H
#define OAIPutSchemaVersionMetadataResponse_H
...
class OAIPutSchemaVersionMetadataResponse : public OAIObject {
public:
    OAIPutSchemaVersionMetadataResponse();
    OAIPutSchemaVersionMetadataResponse(QString json);
    ~OAIPutSchemaVersionMetadataResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSchemaVersionMetadataResponse)

#endif // OAIPutSchemaVersionMetadataResponse_H
