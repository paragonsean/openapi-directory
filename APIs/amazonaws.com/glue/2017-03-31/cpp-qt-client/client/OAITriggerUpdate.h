...
#ifndef OAITriggerUpdate_H
#define OAITriggerUpdate_H
...
class OAITriggerUpdate : public OAIObject {
public:
    OAITriggerUpdate();
    OAITriggerUpdate(QString json);
    ~OAITriggerUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITriggerUpdate)

#endif // OAITriggerUpdate_H
