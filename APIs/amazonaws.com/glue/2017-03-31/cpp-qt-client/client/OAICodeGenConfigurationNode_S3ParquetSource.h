...
/*
 * OAICodeGenConfigurationNode_S3ParquetSource.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_S3ParquetSource_H
#define OAICodeGenConfigurationNode_S3ParquetSource_H
...
class OAICodeGenConfigurationNode_S3ParquetSource : public OAIObject {
public:
    OAICodeGenConfigurationNode_S3ParquetSource();
    OAICodeGenConfigurationNode_S3ParquetSource(QString json);
    ~OAICodeGenConfigurationNode_S3ParquetSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_S3ParquetSource)

#endif // OAICodeGenConfigurationNode_S3ParquetSource_H
