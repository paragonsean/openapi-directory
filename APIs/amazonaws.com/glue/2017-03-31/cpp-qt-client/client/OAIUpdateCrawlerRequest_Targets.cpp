...
OAIUpdateCrawlerRequest_Targets::OAIUpdateCrawlerRequest_Targets(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCrawlerRequest_Targets::OAIUpdateCrawlerRequest_Targets() {
    this->initializeModel();
}

OAIUpdateCrawlerRequest_Targets::~OAIUpdateCrawlerRequest_Targets() {}

void OAIUpdateCrawlerRequest_Targets::initializeModel() {
...
void OAIUpdateCrawlerRequest_Targets::fromJson(QString jsonString) {
...
void OAIUpdateCrawlerRequest_Targets::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCrawlerRequest_Targets::asJson() const {
...
QJsonObject OAIUpdateCrawlerRequest_Targets::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateCrawlerRequest_Targets::getS3Targets() const {
    return m_s3_targets;
}
void OAIUpdateCrawlerRequest_Targets::setS3Targets(const QList &s3_targets) {
    m_s3_targets = s3_targets;
    m_s3_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_s3_targets_Set() const{
    return m_s3_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_s3_targets_Valid() const{
    return m_s3_targets_isValid;
}

QList OAIUpdateCrawlerRequest_Targets::getJdbcTargets() const {
    return m_jdbc_targets;
}
void OAIUpdateCrawlerRequest_Targets::setJdbcTargets(const QList &jdbc_targets) {
    m_jdbc_targets = jdbc_targets;
    m_jdbc_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_jdbc_targets_Set() const{
    return m_jdbc_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_jdbc_targets_Valid() const{
    return m_jdbc_targets_isValid;
}

QList OAIUpdateCrawlerRequest_Targets::getMongoDbTargets() const {
    return m_mongo_db_targets;
}
void OAIUpdateCrawlerRequest_Targets::setMongoDbTargets(const QList &mongo_db_targets) {
    m_mongo_db_targets = mongo_db_targets;
    m_mongo_db_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_mongo_db_targets_Set() const{
    return m_mongo_db_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_mongo_db_targets_Valid() const{
    return m_mongo_db_targets_isValid;
}

QList OAIUpdateCrawlerRequest_Targets::getDynamoDbTargets() const {
    return m_dynamo_db_targets;
}
void OAIUpdateCrawlerRequest_Targets::setDynamoDbTargets(const QList &dynamo_db_targets) {
    m_dynamo_db_targets = dynamo_db_targets;
    m_dynamo_db_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_dynamo_db_targets_Set() const{
    return m_dynamo_db_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_dynamo_db_targets_Valid() const{
    return m_dynamo_db_targets_isValid;
}

QList OAIUpdateCrawlerRequest_Targets::getCatalogTargets() const {
    return m_catalog_targets;
}
void OAIUpdateCrawlerRequest_Targets::setCatalogTargets(const QList &catalog_targets) {
    m_catalog_targets = catalog_targets;
    m_catalog_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_catalog_targets_Set() const{
    return m_catalog_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_catalog_targets_Valid() const{
    return m_catalog_targets_isValid;
}

QList OAIUpdateCrawlerRequest_Targets::getDeltaTargets() const {
    return m_delta_targets;
}
void OAIUpdateCrawlerRequest_Targets::setDeltaTargets(const QList &delta_targets) {
    m_delta_targets = delta_targets;
    m_delta_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_delta_targets_Set() const{
    return m_delta_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_delta_targets_Valid() const{
    return m_delta_targets_isValid;
}

QList OAIUpdateCrawlerRequest_Targets::getIcebergTargets() const {
    return m_iceberg_targets;
}
void OAIUpdateCrawlerRequest_Targets::setIcebergTargets(const QList &iceberg_targets) {
    m_iceberg_targets = iceberg_targets;
    m_iceberg_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_iceberg_targets_Set() const{
    return m_iceberg_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_iceberg_targets_Valid() const{
    return m_iceberg_targets_isValid;
}

QList OAIUpdateCrawlerRequest_Targets::getHudiTargets() const {
    return m_hudi_targets;
}
void OAIUpdateCrawlerRequest_Targets::setHudiTargets(const QList &hudi_targets) {
    m_hudi_targets = hudi_targets;
    m_hudi_targets_isSet = true;
}

bool OAIUpdateCrawlerRequest_Targets::is_hudi_targets_Set() const{
    return m_hudi_targets_isSet;
}

bool OAIUpdateCrawlerRequest_Targets::is_hudi_targets_Valid() const{
    return m_hudi_targets_isValid;
}

bool OAIUpdateCrawlerRequest_Targets::isSet() const {
...
bool OAIUpdateCrawlerRequest_Targets::isValid() const {
