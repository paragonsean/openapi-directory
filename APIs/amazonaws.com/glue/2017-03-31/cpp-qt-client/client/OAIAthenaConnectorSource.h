...
/*
 * OAIAthenaConnectorSource.h
 *
 * Specifies a connector to an Amazon Athena data source.
 */

#ifndef OAIAthenaConnectorSource_H
#define OAIAthenaConnectorSource_H
...
class OAIAthenaConnectorSource : public OAIObject {
public:
    OAIAthenaConnectorSource();
    OAIAthenaConnectorSource(QString json);
    ~OAIAthenaConnectorSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAthenaConnectorSource)

#endif // OAIAthenaConnectorSource_H
