...
OAIPartitionInput::OAIPartitionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPartitionInput::OAIPartitionInput() {
    this->initializeModel();
}

OAIPartitionInput::~OAIPartitionInput() {}

void OAIPartitionInput::initializeModel() {
...
void OAIPartitionInput::fromJson(QString jsonString) {
...
void OAIPartitionInput::fromJsonObject(QJsonObject json) {
...
QString OAIPartitionInput::asJson() const {
...
QJsonObject OAIPartitionInput::asJsonObject() const {
    QJsonObject obj;
    if (m_values.isSet()) {
...
QList OAIPartitionInput::getValues() const {
    return m_values;
}
void OAIPartitionInput::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIPartitionInput::is_values_Set() const{
    return m_values_isSet;
}

bool OAIPartitionInput::is_values_Valid() const{
    return m_values_isValid;
}

QDateTime OAIPartitionInput::getLastAccessTime() const {
    return m_last_access_time;
}
void OAIPartitionInput::setLastAccessTime(const QDateTime &last_access_time) {
    m_last_access_time = last_access_time;
    m_last_access_time_isSet = true;
}

bool OAIPartitionInput::is_last_access_time_Set() const{
    return m_last_access_time_isSet;
}

bool OAIPartitionInput::is_last_access_time_Valid() const{
    return m_last_access_time_isValid;
}

OAIPartitionInput_StorageDescriptor OAIPartitionInput::getStorageDescriptor() const {
    return m_storage_descriptor;
}
void OAIPartitionInput::setStorageDescriptor(const OAIPartitionInput_StorageDescriptor &storage_descriptor) {
    m_storage_descriptor = storage_descriptor;
    m_storage_descriptor_isSet = true;
}

bool OAIPartitionInput::is_storage_descriptor_Set() const{
    return m_storage_descriptor_isSet;
}

bool OAIPartitionInput::is_storage_descriptor_Valid() const{
    return m_storage_descriptor_isValid;
}

QMap OAIPartitionInput::getParameters() const {
    return m_parameters;
}
void OAIPartitionInput::setParameters(const QMap &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIPartitionInput::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIPartitionInput::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QDateTime OAIPartitionInput::getLastAnalyzedTime() const {
    return m_last_analyzed_time;
}
void OAIPartitionInput::setLastAnalyzedTime(const QDateTime &last_analyzed_time) {
    m_last_analyzed_time = last_analyzed_time;
    m_last_analyzed_time_isSet = true;
}

bool OAIPartitionInput::is_last_analyzed_time_Set() const{
    return m_last_analyzed_time_isSet;
}

bool OAIPartitionInput::is_last_analyzed_time_Valid() const{
    return m_last_analyzed_time_isValid;
}

bool OAIPartitionInput::isSet() const {
...
bool OAIPartitionInput::isValid() const {
