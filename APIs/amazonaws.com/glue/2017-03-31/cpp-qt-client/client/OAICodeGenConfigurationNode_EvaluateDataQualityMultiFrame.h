...
/*
 * OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame_H
#define OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame_H
...
class OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame : public OAIObject {
public:
    OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame();
    OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame(QString json);
    ~OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame)

#endif // OAICodeGenConfigurationNode_EvaluateDataQualityMultiFrame_H
