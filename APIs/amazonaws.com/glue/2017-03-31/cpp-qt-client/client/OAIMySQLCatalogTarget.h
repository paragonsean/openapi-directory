...
/*
 * OAIMySQLCatalogTarget.h
 *
 * Specifies a target that uses MySQL.
 */

#ifndef OAIMySQLCatalogTarget_H
#define OAIMySQLCatalogTarget_H
...
class OAIMySQLCatalogTarget : public OAIObject {
public:
    OAIMySQLCatalogTarget();
    OAIMySQLCatalogTarget(QString json);
    ~OAIMySQLCatalogTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMySQLCatalogTarget)

#endif // OAIMySQLCatalogTarget_H
