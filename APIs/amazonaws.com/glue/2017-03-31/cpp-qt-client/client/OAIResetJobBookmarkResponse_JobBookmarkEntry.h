...
/*
 * OAIResetJobBookmarkResponse_JobBookmarkEntry.h
 *
 * 
 */

#ifndef OAIResetJobBookmarkResponse_JobBookmarkEntry_H
#define OAIResetJobBookmarkResponse_JobBookmarkEntry_H
...
class OAIResetJobBookmarkResponse_JobBookmarkEntry : public OAIObject {
public:
    OAIResetJobBookmarkResponse_JobBookmarkEntry();
    OAIResetJobBookmarkResponse_JobBookmarkEntry(QString json);
    ~OAIResetJobBookmarkResponse_JobBookmarkEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetJobBookmarkResponse_JobBookmarkEntry)

#endif // OAIResetJobBookmarkResponse_JobBookmarkEntry_H
