...
/*
 * OAIBatchUpdatePartitionRequestEntry_PartitionInput.h
 *
 * 
 */

#ifndef OAIBatchUpdatePartitionRequestEntry_PartitionInput_H
#define OAIBatchUpdatePartitionRequestEntry_PartitionInput_H
...
class OAIBatchUpdatePartitionRequestEntry_PartitionInput : public OAIObject {
public:
    OAIBatchUpdatePartitionRequestEntry_PartitionInput();
    OAIBatchUpdatePartitionRequestEntry_PartitionInput(QString json);
    ~OAIBatchUpdatePartitionRequestEntry_PartitionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdatePartitionRequestEntry_PartitionInput)

#endif // OAIBatchUpdatePartitionRequestEntry_PartitionInput_H
