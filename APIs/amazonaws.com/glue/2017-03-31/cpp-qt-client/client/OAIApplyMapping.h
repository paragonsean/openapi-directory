...
#ifndef OAIApplyMapping_H
#define OAIApplyMapping_H
...
class OAIApplyMapping : public OAIObject {
public:
    OAIApplyMapping();
    OAIApplyMapping(QString json);
    ~OAIApplyMapping() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplyMapping)

#endif // OAIApplyMapping_H
