...
/*
 * OAIGetTableResponse_Table.h
 *
 * 
 */

#ifndef OAIGetTableResponse_Table_H
#define OAIGetTableResponse_Table_H
...
class OAIGetTableResponse_Table : public OAIObject {
public:
    OAIGetTableResponse_Table();
    OAIGetTableResponse_Table(QString json);
    ~OAIGetTableResponse_Table() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableResponse_Table)

#endif // OAIGetTableResponse_Table_H
