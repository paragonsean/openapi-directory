...
QString OAITable::getDatabaseName() const {
    return m_database_name;
}
void OAITable::setDatabaseName(const QString &database_name) {
    m_database_name = database_name;
    m_database_name_isSet = true;
}

bool OAITable::is_database_name_Set() const{
    return m_database_name_isSet;
}

bool OAITable::is_database_name_Valid() const{
...
QString OAITable::getOwner() const {
    return m_owner;
}
void OAITable::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAITable::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAITable::is_owner_Valid() const{
    return m_owner_isValid;
}

QDateTime OAITable::getCreateTime() const {
    return m_create_time;
}
void OAITable::setCreateTime(const QDateTime &create_time) {
...
QDateTime OAITable::getUpdateTime() const {
    return m_update_time;
}
void OAITable::setUpdateTime(const QDateTime &update_time) {
...
QDateTime OAITable::getLastAccessTime() const {
    return m_last_access_time;
}
void OAITable::setLastAccessTime(const QDateTime &last_access_time) {
    m_last_access_time = last_access_time;
    m_last_access_time_isSet = true;
}

bool OAITable::is_last_access_time_Set() const{
    return m_last_access_time_isSet;
}

bool OAITable::is_last_access_time_Valid() const{
    return m_last_access_time_isValid;
}

QDateTime OAITable::getLastAnalyzedTime() const {
    return m_last_analyzed_time;
}
void OAITable::setLastAnalyzedTime(const QDateTime &last_analyzed_time) {
    m_last_analyzed_time = last_analyzed_time;
    m_last_analyzed_time_isSet = true;
}

bool OAITable::is_last_analyzed_time_Set() const{
    return m_last_analyzed_time_isSet;
}

bool OAITable::is_last_analyzed_time_Valid() const{
    return m_last_analyzed_time_isValid;
}

qint32 OAITable::getRetention() const {
    return m_retention;
}
void OAITable::setRetention(const qint32 &retention) {
    m_retention = retention;
    m_retention_isSet = true;
}

bool OAITable::is_retention_Set() const{
    return m_retention_isSet;
}

bool OAITable::is_retention_Valid() const{
    return m_retention_isValid;
}

OAITableInput_StorageDescriptor OAITable::getStorageDescriptor() const {
    return m_storage_descriptor;
}
void OAITable::setStorageDescriptor(const OAITableInput_StorageDescriptor &storage_descriptor) {
    m_storage_descriptor = storage_descriptor;
    m_storage_descriptor_isSet = true;
}

bool OAITable::is_storage_descriptor_Set() const{
    return m_storage_descriptor_isSet;
}

bool OAITable::is_storage_descriptor_Valid() const{
    return m_storage_descriptor_isValid;
}

QList OAITable::getPartitionKeys() const {
    return m_partition_keys;
}
void OAITable::setPartitionKeys(const QList &partition_keys) {
    m_partition_keys = partition_keys;
    m_partition_keys_isSet = true;
}

bool OAITable::is_partition_keys_Set() const{
    return m_partition_keys_isSet;
}

bool OAITable::is_partition_keys_Valid() const{
    return m_partition_keys_isValid;
}

QString OAITable::getViewOriginalText() const {
    return m_view_original_text;
}
void OAITable::setViewOriginalText(const QString &view_original_text) {
    m_view_original_text = view_original_text;
    m_view_original_text_isSet = true;
}

bool OAITable::is_view_original_text_Set() const{
    return m_view_original_text_isSet;
}

bool OAITable::is_view_original_text_Valid() const{
    return m_view_original_text_isValid;
}

QString OAITable::getViewExpandedText() const {
    return m_view_expanded_text;
}
void OAITable::setViewExpandedText(const QString &view_expanded_text) {
    m_view_expanded_text = view_expanded_text;
    m_view_expanded_text_isSet = true;
}

bool OAITable::is_view_expanded_text_Set() const{
    return m_view_expanded_text_isSet;
}

bool OAITable::is_view_expanded_text_Valid() const{
    return m_view_expanded_text_isValid;
}

QString OAITable::getTableType() const {
    return m_table_type;
}
void OAITable::setTableType(const QString &table_type) {
    m_table_type = table_type;
    m_table_type_isSet = true;
}

bool OAITable::is_table_type_Set() const{
    return m_table_type_isSet;
}

bool OAITable::is_table_type_Valid() const{
    return m_table_type_isValid;
}

QMap OAITable::getParameters() const {
    return m_parameters;
}
void OAITable::setParameters(const QMap &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAITable::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAITable::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QString OAITable::getCreatedBy() const {
    return m_created_by;
}
void OAITable::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAITable::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAITable::is_created_by_Valid() const{
    return m_created_by_isValid;
}

bool OAITable::getIsRegisteredWithLakeFormation() const {
    return m_is_registered_with_lake_formation;
}
void OAITable::setIsRegisteredWithLakeFormation(const bool &is_registered_with_lake_formation) {
    m_is_registered_with_lake_formation = is_registered_with_lake_formation;
    m_is_registered_with_lake_formation_isSet = true;
}

bool OAITable::is_is_registered_with_lake_formation_Set() const{
    return m_is_registered_with_lake_formation_isSet;
}

bool OAITable::is_is_registered_with_lake_formation_Valid() const{
    return m_is_registered_with_lake_formation_isValid;
}

OAITableInput_TargetTable OAITable::getTargetTable() const {
    return m_target_table;
}
void OAITable::setTargetTable(const OAITableInput_TargetTable &target_table) {
    m_target_table = target_table;
    m_target_table_isSet = true;
}

bool OAITable::is_target_table_Set() const{
    return m_target_table_isSet;
}

bool OAITable::is_target_table_Valid() const{
    return m_target_table_isValid;
}

QString OAITable::getCatalogId() const {
    return m_catalog_id;
}
void OAITable::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAITable::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAITable::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

QString OAITable::getVersionId() const {
    return m_version_id;
}
void OAITable::setVersionId(const QString &version_id) {
    m_version_id = version_id;
    m_version_id_isSet = true;
}

bool OAITable::is_version_id_Set() const{
    return m_version_id_isSet;
}

bool OAITable::is_version_id_Valid() const{
    return m_version_id_isValid;
}

OAITable_FederatedTable OAITable::getFederatedTable() const {
    return m_federated_table;
}
void OAITable::setFederatedTable(const OAITable_FederatedTable &federated_table) {
    m_federated_table = federated_table;
    m_federated_table_isSet = true;
}

bool OAITable::is_federated_table_Set() const{
    return m_federated_table_isSet;
}

bool OAITable::is_federated_table_Valid() const{
