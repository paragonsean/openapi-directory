...
#ifndef OAISchemaId_H
#define OAISchemaId_H
...
class OAISchemaId : public OAIObject {
public:
    OAISchemaId();
    OAISchemaId(QString json);
    ~OAISchemaId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchemaId)
