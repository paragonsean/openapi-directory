...
/*
 * OAIPartitionInput_StorageDescriptor.h
 *
 * 
 */

#ifndef OAIPartitionInput_StorageDescriptor_H
#define OAIPartitionInput_StorageDescriptor_H
...
class OAIPartitionInput_StorageDescriptor : public OAIObject {
public:
    OAIPartitionInput_StorageDescriptor();
    OAIPartitionInput_StorageDescriptor(QString json);
    ~OAIPartitionInput_StorageDescriptor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionInput_StorageDescriptor)

#endif // OAIPartitionInput_StorageDescriptor_H
