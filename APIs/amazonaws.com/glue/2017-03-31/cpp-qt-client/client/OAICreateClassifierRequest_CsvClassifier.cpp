...
OAICreateClassifierRequest_CsvClassifier::OAICreateClassifierRequest_CsvClassifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateClassifierRequest_CsvClassifier::OAICreateClassifierRequest_CsvClassifier() {
    this->initializeModel();
}

OAICreateClassifierRequest_CsvClassifier::~OAICreateClassifierRequest_CsvClassifier() {}

void OAICreateClassifierRequest_CsvClassifier::initializeModel() {
...
void OAICreateClassifierRequest_CsvClassifier::fromJson(QString jsonString) {
...
void OAICreateClassifierRequest_CsvClassifier::fromJsonObject(QJsonObject json) {
...
QString OAICreateClassifierRequest_CsvClassifier::asJson() const {
...
QJsonObject OAICreateClassifierRequest_CsvClassifier::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateClassifierRequest_CsvClassifier::getName() const {
    return m_name;
}
void OAICreateClassifierRequest_CsvClassifier::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateClassifierRequest_CsvClassifier::getDelimiter() const {
    return m_delimiter;
}
void OAICreateClassifierRequest_CsvClassifier::setDelimiter(const QString &delimiter) {
    m_delimiter = delimiter;
    m_delimiter_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_delimiter_Set() const{
    return m_delimiter_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_delimiter_Valid() const{
    return m_delimiter_isValid;
}

QString OAICreateClassifierRequest_CsvClassifier::getQuoteSymbol() const {
    return m_quote_symbol;
}
void OAICreateClassifierRequest_CsvClassifier::setQuoteSymbol(const QString &quote_symbol) {
    m_quote_symbol = quote_symbol;
    m_quote_symbol_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_quote_symbol_Set() const{
    return m_quote_symbol_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_quote_symbol_Valid() const{
    return m_quote_symbol_isValid;
}

OAICsvHeaderOption OAICreateClassifierRequest_CsvClassifier::getContainsHeader() const {
    return m_contains_header;
}
void OAICreateClassifierRequest_CsvClassifier::setContainsHeader(const OAICsvHeaderOption &contains_header) {
    m_contains_header = contains_header;
    m_contains_header_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_contains_header_Set() const{
    return m_contains_header_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_contains_header_Valid() const{
    return m_contains_header_isValid;
}

QList OAICreateClassifierRequest_CsvClassifier::getHeader() const {
    return m_header;
}
void OAICreateClassifierRequest_CsvClassifier::setHeader(const QList &header) {
    m_header = header;
    m_header_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_header_Set() const{
    return m_header_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_header_Valid() const{
    return m_header_isValid;
}

bool OAICreateClassifierRequest_CsvClassifier::getDisableValueTrimming() const {
    return m_disable_value_trimming;
}
void OAICreateClassifierRequest_CsvClassifier::setDisableValueTrimming(const bool &disable_value_trimming) {
    m_disable_value_trimming = disable_value_trimming;
    m_disable_value_trimming_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_disable_value_trimming_Set() const{
    return m_disable_value_trimming_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_disable_value_trimming_Valid() const{
    return m_disable_value_trimming_isValid;
}

bool OAICreateClassifierRequest_CsvClassifier::getAllowSingleColumn() const {
    return m_allow_single_column;
}
void OAICreateClassifierRequest_CsvClassifier::setAllowSingleColumn(const bool &allow_single_column) {
    m_allow_single_column = allow_single_column;
    m_allow_single_column_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_allow_single_column_Set() const{
    return m_allow_single_column_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_allow_single_column_Valid() const{
    return m_allow_single_column_isValid;
}

bool OAICreateClassifierRequest_CsvClassifier::getCustomDatatypeConfigured() const {
    return m_custom_datatype_configured;
}
void OAICreateClassifierRequest_CsvClassifier::setCustomDatatypeConfigured(const bool &custom_datatype_configured) {
    m_custom_datatype_configured = custom_datatype_configured;
    m_custom_datatype_configured_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_custom_datatype_configured_Set() const{
    return m_custom_datatype_configured_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_custom_datatype_configured_Valid() const{
    return m_custom_datatype_configured_isValid;
}

QList OAICreateClassifierRequest_CsvClassifier::getCustomDatatypes() const {
    return m_custom_datatypes;
}
void OAICreateClassifierRequest_CsvClassifier::setCustomDatatypes(const QList &custom_datatypes) {
    m_custom_datatypes = custom_datatypes;
    m_custom_datatypes_isSet = true;
}

bool OAICreateClassifierRequest_CsvClassifier::is_custom_datatypes_Set() const{
    return m_custom_datatypes_isSet;
}

bool OAICreateClassifierRequest_CsvClassifier::is_custom_datatypes_Valid() const{
    return m_custom_datatypes_isValid;
}

bool OAICreateClassifierRequest_CsvClassifier::isSet() const {
...
bool OAICreateClassifierRequest_CsvClassifier::isValid() const {
