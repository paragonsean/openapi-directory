...
/*
 * OAIBasicCatalogTarget.h
 *
 * Specifies a target that uses a Glue Data Catalog table.
 */

#ifndef OAIBasicCatalogTarget_H
#define OAIBasicCatalogTarget_H
...
class OAIBasicCatalogTarget : public OAIObject {
public:
    OAIBasicCatalogTarget();
    OAIBasicCatalogTarget(QString json);
    ~OAIBasicCatalogTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasicCatalogTarget)

#endif // OAIBasicCatalogTarget_H
