...
OAIDataSource_GlueTable::OAIDataSource_GlueTable(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataSource_GlueTable::OAIDataSource_GlueTable() {
    this->initializeModel();
}

OAIDataSource_GlueTable::~OAIDataSource_GlueTable() {}

void OAIDataSource_GlueTable::initializeModel() {
...
void OAIDataSource_GlueTable::fromJson(QString jsonString) {
...
void OAIDataSource_GlueTable::fromJsonObject(QJsonObject json) {
...
QString OAIDataSource_GlueTable::asJson() const {
...
QJsonObject OAIDataSource_GlueTable::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDataSource_GlueTable::getDatabaseName() const {
    return m_database_name;
}
void OAIDataSource_GlueTable::setDatabaseName(const QString &database_name) {
    m_database_name = database_name;
    m_database_name_isSet = true;
}

bool OAIDataSource_GlueTable::is_database_name_Set() const{
    return m_database_name_isSet;
}

bool OAIDataSource_GlueTable::is_database_name_Valid() const{
    return m_database_name_isValid;
}

QString OAIDataSource_GlueTable::getTableName() const {
    return m_table_name;
}
void OAIDataSource_GlueTable::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIDataSource_GlueTable::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIDataSource_GlueTable::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAIDataSource_GlueTable::getCatalogId() const {
    return m_catalog_id;
}
void OAIDataSource_GlueTable::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAIDataSource_GlueTable::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAIDataSource_GlueTable::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

QString OAIDataSource_GlueTable::getConnectionName() const {
    return m_connection_name;
}
void OAIDataSource_GlueTable::setConnectionName(const QString &connection_name) {
    m_connection_name = connection_name;
    m_connection_name_isSet = true;
}

bool OAIDataSource_GlueTable::is_connection_name_Set() const{
    return m_connection_name_isSet;
}

bool OAIDataSource_GlueTable::is_connection_name_Valid() const{
    return m_connection_name_isValid;
}

QMap OAIDataSource_GlueTable::getAdditionalOptions() const {
    return m_additional_options;
}
void OAIDataSource_GlueTable::setAdditionalOptions(const QMap &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAIDataSource_GlueTable::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAIDataSource_GlueTable::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

bool OAIDataSource_GlueTable::isSet() const {
...
bool OAIDataSource_GlueTable::isValid() const {
