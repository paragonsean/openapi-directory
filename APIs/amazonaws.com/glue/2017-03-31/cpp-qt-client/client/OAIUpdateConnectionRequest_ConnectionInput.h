...
/*
 * OAIUpdateConnectionRequest_ConnectionInput.h
 *
 * 
 */

#ifndef OAIUpdateConnectionRequest_ConnectionInput_H
#define OAIUpdateConnectionRequest_ConnectionInput_H
...
class OAIUpdateConnectionRequest_ConnectionInput : public OAIObject {
public:
    OAIUpdateConnectionRequest_ConnectionInput();
    OAIUpdateConnectionRequest_ConnectionInput(QString json);
    ~OAIUpdateConnectionRequest_ConnectionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateConnectionRequest_ConnectionInput)

#endif // OAIUpdateConnectionRequest_ConnectionInput_H
