...
#include "OAITransformFilterCriteria.h"
...
OAITransformFilterCriteria::OAITransformFilterCriteria(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransformFilterCriteria::OAITransformFilterCriteria() {
    this->initializeModel();
}

OAITransformFilterCriteria::~OAITransformFilterCriteria() {}

void OAITransformFilterCriteria::initializeModel() {
...
void OAITransformFilterCriteria::fromJson(QString jsonString) {
...
void OAITransformFilterCriteria::fromJsonObject(QJsonObject json) {
...
QString OAITransformFilterCriteria::asJson() const {
...
QJsonObject OAITransformFilterCriteria::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAITransformFilterCriteria::getName() const {
    return m_name;
}
void OAITransformFilterCriteria::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITransformFilterCriteria::is_name_Set() const{
    return m_name_isSet;
}

bool OAITransformFilterCriteria::is_name_Valid() const{
    return m_name_isValid;
}

OAITransformType OAITransformFilterCriteria::getTransformType() const {
    return m_transform_type;
}
void OAITransformFilterCriteria::setTransformType(const OAITransformType &transform_type) {
    m_transform_type = transform_type;
    m_transform_type_isSet = true;
}

bool OAITransformFilterCriteria::is_transform_type_Set() const{
    return m_transform_type_isSet;
}

bool OAITransformFilterCriteria::is_transform_type_Valid() const{
    return m_transform_type_isValid;
}

OAITransformStatusType OAITransformFilterCriteria::getStatus() const {
    return m_status;
}
void OAITransformFilterCriteria::setStatus(const OAITransformStatusType &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITransformFilterCriteria::is_status_Set() const{
    return m_status_isSet;
}

bool OAITransformFilterCriteria::is_status_Valid() const{
    return m_status_isValid;
}

QString OAITransformFilterCriteria::getGlueVersion() const {
    return m_glue_version;
}
void OAITransformFilterCriteria::setGlueVersion(const QString &glue_version) {
    m_glue_version = glue_version;
    m_glue_version_isSet = true;
}

bool OAITransformFilterCriteria::is_glue_version_Set() const{
    return m_glue_version_isSet;
}

bool OAITransformFilterCriteria::is_glue_version_Valid() const{
    return m_glue_version_isValid;
}

QDateTime OAITransformFilterCriteria::getCreatedBefore() const {
    return m_created_before;
}
void OAITransformFilterCriteria::setCreatedBefore(const QDateTime &created_before) {
    m_created_before = created_before;
    m_created_before_isSet = true;
}

bool OAITransformFilterCriteria::is_created_before_Set() const{
    return m_created_before_isSet;
}

bool OAITransformFilterCriteria::is_created_before_Valid() const{
    return m_created_before_isValid;
}

QDateTime OAITransformFilterCriteria::getCreatedAfter() const {
    return m_created_after;
}
void OAITransformFilterCriteria::setCreatedAfter(const QDateTime &created_after) {
    m_created_after = created_after;
    m_created_after_isSet = true;
}

bool OAITransformFilterCriteria::is_created_after_Set() const{
    return m_created_after_isSet;
}

bool OAITransformFilterCriteria::is_created_after_Valid() const{
    return m_created_after_isValid;
}

QDateTime OAITransformFilterCriteria::getLastModifiedBefore() const {
    return m_last_modified_before;
}
void OAITransformFilterCriteria::setLastModifiedBefore(const QDateTime &last_modified_before) {
    m_last_modified_before = last_modified_before;
    m_last_modified_before_isSet = true;
}

bool OAITransformFilterCriteria::is_last_modified_before_Set() const{
    return m_last_modified_before_isSet;
}

bool OAITransformFilterCriteria::is_last_modified_before_Valid() const{
    return m_last_modified_before_isValid;
}

QDateTime OAITransformFilterCriteria::getLastModifiedAfter() const {
    return m_last_modified_after;
}
void OAITransformFilterCriteria::setLastModifiedAfter(const QDateTime &last_modified_after) {
    m_last_modified_after = last_modified_after;
    m_last_modified_after_isSet = true;
}

bool OAITransformFilterCriteria::is_last_modified_after_Set() const{
    return m_last_modified_after_isSet;
}

bool OAITransformFilterCriteria::is_last_modified_after_Valid() const{
    return m_last_modified_after_isValid;
}

QList OAITransformFilterCriteria::getSchema() const {
    return m_schema;
}
void OAITransformFilterCriteria::setSchema(const QList &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAITransformFilterCriteria::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAITransformFilterCriteria::is_schema_Valid() const{
    return m_schema_isValid;
}

bool OAITransformFilterCriteria::isSet() const {
...
bool OAITransformFilterCriteria::isValid() const {
