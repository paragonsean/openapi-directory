...
#ifndef OAISelectFields_H
#define OAISelectFields_H
...
class OAISelectFields : public OAIObject {
public:
    OAISelectFields();
    OAISelectFields(QString json);
    ~OAISelectFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISelectFields)

#endif // OAISelectFields_H
