...
/*
 * OAICreatePartitionRequest_PartitionInput.h
 *
 * 
 */

#ifndef OAICreatePartitionRequest_PartitionInput_H
#define OAICreatePartitionRequest_PartitionInput_H
...
class OAICreatePartitionRequest_PartitionInput : public OAIObject {
public:
    OAICreatePartitionRequest_PartitionInput();
    OAICreatePartitionRequest_PartitionInput(QString json);
    ~OAICreatePartitionRequest_PartitionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePartitionRequest_PartitionInput)

#endif // OAICreatePartitionRequest_PartitionInput_H
