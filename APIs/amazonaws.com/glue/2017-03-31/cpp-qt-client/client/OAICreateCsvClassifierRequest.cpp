...
#include "OAICreateCsvClassifierRequest.h"
...
OAICreateCsvClassifierRequest::OAICreateCsvClassifierRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCsvClassifierRequest::OAICreateCsvClassifierRequest() {
    this->initializeModel();
}

OAICreateCsvClassifierRequest::~OAICreateCsvClassifierRequest() {}

void OAICreateCsvClassifierRequest::initializeModel() {
...
void OAICreateCsvClassifierRequest::fromJson(QString jsonString) {
...
void OAICreateCsvClassifierRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateCsvClassifierRequest::asJson() const {
...
QJsonObject OAICreateCsvClassifierRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateCsvClassifierRequest::getName() const {
    return m_name;
}
void OAICreateCsvClassifierRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateCsvClassifierRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateCsvClassifierRequest::getDelimiter() const {
    return m_delimiter;
}
void OAICreateCsvClassifierRequest::setDelimiter(const QString &delimiter) {
    m_delimiter = delimiter;
    m_delimiter_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_delimiter_Set() const{
    return m_delimiter_isSet;
}

bool OAICreateCsvClassifierRequest::is_delimiter_Valid() const{
    return m_delimiter_isValid;
}

QString OAICreateCsvClassifierRequest::getQuoteSymbol() const {
    return m_quote_symbol;
}
void OAICreateCsvClassifierRequest::setQuoteSymbol(const QString &quote_symbol) {
    m_quote_symbol = quote_symbol;
    m_quote_symbol_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_quote_symbol_Set() const{
    return m_quote_symbol_isSet;
}

bool OAICreateCsvClassifierRequest::is_quote_symbol_Valid() const{
    return m_quote_symbol_isValid;
}

OAICsvHeaderOption OAICreateCsvClassifierRequest::getContainsHeader() const {
    return m_contains_header;
}
void OAICreateCsvClassifierRequest::setContainsHeader(const OAICsvHeaderOption &contains_header) {
    m_contains_header = contains_header;
    m_contains_header_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_contains_header_Set() const{
    return m_contains_header_isSet;
}

bool OAICreateCsvClassifierRequest::is_contains_header_Valid() const{
    return m_contains_header_isValid;
}

QList OAICreateCsvClassifierRequest::getHeader() const {
    return m_header;
}
void OAICreateCsvClassifierRequest::setHeader(const QList &header) {
    m_header = header;
    m_header_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_header_Set() const{
    return m_header_isSet;
}

bool OAICreateCsvClassifierRequest::is_header_Valid() const{
    return m_header_isValid;
}

bool OAICreateCsvClassifierRequest::getDisableValueTrimming() const {
    return m_disable_value_trimming;
}
void OAICreateCsvClassifierRequest::setDisableValueTrimming(const bool &disable_value_trimming) {
    m_disable_value_trimming = disable_value_trimming;
    m_disable_value_trimming_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_disable_value_trimming_Set() const{
    return m_disable_value_trimming_isSet;
}

bool OAICreateCsvClassifierRequest::is_disable_value_trimming_Valid() const{
    return m_disable_value_trimming_isValid;
}

bool OAICreateCsvClassifierRequest::getAllowSingleColumn() const {
    return m_allow_single_column;
}
void OAICreateCsvClassifierRequest::setAllowSingleColumn(const bool &allow_single_column) {
    m_allow_single_column = allow_single_column;
    m_allow_single_column_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_allow_single_column_Set() const{
    return m_allow_single_column_isSet;
}

bool OAICreateCsvClassifierRequest::is_allow_single_column_Valid() const{
    return m_allow_single_column_isValid;
}

bool OAICreateCsvClassifierRequest::getCustomDatatypeConfigured() const {
    return m_custom_datatype_configured;
}
void OAICreateCsvClassifierRequest::setCustomDatatypeConfigured(const bool &custom_datatype_configured) {
    m_custom_datatype_configured = custom_datatype_configured;
    m_custom_datatype_configured_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_custom_datatype_configured_Set() const{
    return m_custom_datatype_configured_isSet;
}

bool OAICreateCsvClassifierRequest::is_custom_datatype_configured_Valid() const{
    return m_custom_datatype_configured_isValid;
}

QList OAICreateCsvClassifierRequest::getCustomDatatypes() const {
    return m_custom_datatypes;
}
void OAICreateCsvClassifierRequest::setCustomDatatypes(const QList &custom_datatypes) {
    m_custom_datatypes = custom_datatypes;
    m_custom_datatypes_isSet = true;
}

bool OAICreateCsvClassifierRequest::is_custom_datatypes_Set() const{
    return m_custom_datatypes_isSet;
}

bool OAICreateCsvClassifierRequest::is_custom_datatypes_Valid() const{
    return m_custom_datatypes_isValid;
}

bool OAICreateCsvClassifierRequest::isSet() const {
...
bool OAICreateCsvClassifierRequest::isValid() const {
