...
/*
 * OAIDeleteColumnStatisticsForTableRequest.h
 *
 * 
 */

#ifndef OAIDeleteColumnStatisticsForTableRequest_H
#define OAIDeleteColumnStatisticsForTableRequest_H
...
class OAIDeleteColumnStatisticsForTableRequest : public OAIObject {
public:
    OAIDeleteColumnStatisticsForTableRequest();
    OAIDeleteColumnStatisticsForTableRequest(QString json);
    ~OAIDeleteColumnStatisticsForTableRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteColumnStatisticsForTableRequest)

#endif // OAIDeleteColumnStatisticsForTableRequest_H
