...
#ifndef OAICsvClassifier_H
#define OAICsvClassifier_H
...
class OAICsvClassifier : public OAIObject {
public:
    OAICsvClassifier();
    OAICsvClassifier(QString json);
    ~OAICsvClassifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICsvClassifier)

#endif // OAICsvClassifier_H
