...
/*
 * OAISchemaVersionListItem.h
 *
 * An object containing the details about a schema version.
 */

#ifndef OAISchemaVersionListItem_H
#define OAISchemaVersionListItem_H
...
class OAISchemaVersionListItem : public OAIObject {
public:
    OAISchemaVersionListItem();
    OAISchemaVersionListItem(QString json);
    ~OAISchemaVersionListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchemaVersionListItem)

#endif // OAISchemaVersionListItem_H
