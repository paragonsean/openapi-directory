...
/*
 * OAIJDBCConnectorTarget.h
 *
 * Specifies a data target that writes to Amazon S3 in Apache Parquet columnar storage.
 */

#ifndef OAIJDBCConnectorTarget_H
#define OAIJDBCConnectorTarget_H
...
class OAIJDBCConnectorTarget : public OAIObject {
public:
    OAIJDBCConnectorTarget();
    OAIJDBCConnectorTarget(QString json);
    ~OAIJDBCConnectorTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJDBCConnectorTarget)

#endif // OAIJDBCConnectorTarget_H
