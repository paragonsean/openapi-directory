...
/*
 * OAIGetTriggerResponse_Trigger.h
 *
 * 
 */

#ifndef OAIGetTriggerResponse_Trigger_H
#define OAIGetTriggerResponse_Trigger_H
...
class OAIGetTriggerResponse_Trigger : public OAIObject {
public:
    OAIGetTriggerResponse_Trigger();
    OAIGetTriggerResponse_Trigger(QString json);
    ~OAIGetTriggerResponse_Trigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTriggerResponse_Trigger)

#endif // OAIGetTriggerResponse_Trigger_H
