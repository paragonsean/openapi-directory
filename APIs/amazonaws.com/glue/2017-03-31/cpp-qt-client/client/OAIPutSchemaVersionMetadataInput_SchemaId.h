...
/*
 * OAIPutSchemaVersionMetadataInput_SchemaId.h
 *
 * 
 */

#ifndef OAIPutSchemaVersionMetadataInput_SchemaId_H
#define OAIPutSchemaVersionMetadataInput_SchemaId_H
...
class OAIPutSchemaVersionMetadataInput_SchemaId : public OAIObject {
public:
    OAIPutSchemaVersionMetadataInput_SchemaId();
    OAIPutSchemaVersionMetadataInput_SchemaId(QString json);
    ~OAIPutSchemaVersionMetadataInput_SchemaId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSchemaVersionMetadataInput_SchemaId)

#endif // OAIPutSchemaVersionMetadataInput_SchemaId_H
