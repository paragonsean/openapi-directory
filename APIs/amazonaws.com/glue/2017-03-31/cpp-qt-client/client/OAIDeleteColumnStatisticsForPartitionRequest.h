...
/*
 * OAIDeleteColumnStatisticsForPartitionRequest.h
 *
 * 
 */

#ifndef OAIDeleteColumnStatisticsForPartitionRequest_H
#define OAIDeleteColumnStatisticsForPartitionRequest_H
...
class OAIDeleteColumnStatisticsForPartitionRequest : public OAIObject {
public:
    OAIDeleteColumnStatisticsForPartitionRequest();
    OAIDeleteColumnStatisticsForPartitionRequest(QString json);
    ~OAIDeleteColumnStatisticsForPartitionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteColumnStatisticsForPartitionRequest)

#endif // OAIDeleteColumnStatisticsForPartitionRequest_H
