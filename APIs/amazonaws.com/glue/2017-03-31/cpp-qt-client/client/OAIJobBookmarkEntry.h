...
/*
 * OAIJobBookmarkEntry.h
 *
 * Defines a point that a job can resume processing.
 */

#ifndef OAIJobBookmarkEntry_H
#define OAIJobBookmarkEntry_H
...
class OAIJobBookmarkEntry : public OAIObject {
public:
    OAIJobBookmarkEntry();
    OAIJobBookmarkEntry(QString json);
    ~OAIJobBookmarkEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobBookmarkEntry)

#endif // OAIJobBookmarkEntry_H
