...
#ifndef OAIS3CsvSource_H
#define OAIS3CsvSource_H
...
class OAIS3CsvSource : public OAIObject {
public:
    OAIS3CsvSource();
    OAIS3CsvSource(QString json);
    ~OAIS3CsvSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3CsvSource)

#endif // OAIS3CsvSource_H
