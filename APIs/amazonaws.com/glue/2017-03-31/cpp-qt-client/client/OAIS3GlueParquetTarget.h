...
/*
 * OAIS3GlueParquetTarget.h
 *
 * Specifies a data target that writes to Amazon S3 in Apache Parquet columnar storage.
 */

#ifndef OAIS3GlueParquetTarget_H
#define OAIS3GlueParquetTarget_H
...
class OAIS3GlueParquetTarget : public OAIObject {
public:
    OAIS3GlueParquetTarget();
    OAIS3GlueParquetTarget(QString json);
    ~OAIS3GlueParquetTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3GlueParquetTarget)

#endif // OAIS3GlueParquetTarget_H
