...
QString OAIUpdateSchemaResponse::getRegistryName() const {
    return m_registry_name;
}
void OAIUpdateSchemaResponse::setRegistryName(const QString &registry_name) {
    m_registry_name = registry_name;
    m_registry_name_isSet = true;
}

bool OAIUpdateSchemaResponse::is_registry_name_Set() const{
    return m_registry_name_isSet;
}

bool OAIUpdateSchemaResponse::is_registry_name_Valid() const{
