...
#include "OAICatalogHudiSource.h"
...
OAICatalogHudiSource::OAICatalogHudiSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICatalogHudiSource::OAICatalogHudiSource() {
    this->initializeModel();
}

OAICatalogHudiSource::~OAICatalogHudiSource() {}

void OAICatalogHudiSource::initializeModel() {
...
void OAICatalogHudiSource::fromJson(QString jsonString) {
...
void OAICatalogHudiSource::fromJsonObject(QJsonObject json) {
...
QString OAICatalogHudiSource::asJson() const {
...
QJsonObject OAICatalogHudiSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICatalogHudiSource::getName() const {
    return m_name;
}
void OAICatalogHudiSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICatalogHudiSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAICatalogHudiSource::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICatalogHudiSource::getDatabase() const {
    return m_database;
}
void OAICatalogHudiSource::setDatabase(const QString &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAICatalogHudiSource::is_database_Set() const{
    return m_database_isSet;
}

bool OAICatalogHudiSource::is_database_Valid() const{
    return m_database_isValid;
}

QString OAICatalogHudiSource::getTable() const {
    return m_table;
}
void OAICatalogHudiSource::setTable(const QString &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAICatalogHudiSource::is_table_Set() const{
    return m_table_isSet;
}

bool OAICatalogHudiSource::is_table_Valid() const{
    return m_table_isValid;
}

QMap OAICatalogHudiSource::getAdditionalHudiOptions() const {
    return m_additional_hudi_options;
}
void OAICatalogHudiSource::setAdditionalHudiOptions(const QMap &additional_hudi_options) {
    m_additional_hudi_options = additional_hudi_options;
    m_additional_hudi_options_isSet = true;
}

bool OAICatalogHudiSource::is_additional_hudi_options_Set() const{
    return m_additional_hudi_options_isSet;
}

bool OAICatalogHudiSource::is_additional_hudi_options_Valid() const{
    return m_additional_hudi_options_isValid;
}

QList OAICatalogHudiSource::getOutputSchemas() const {
    return m_output_schemas;
}
void OAICatalogHudiSource::setOutputSchemas(const QList &output_schemas) {
    m_output_schemas = output_schemas;
    m_output_schemas_isSet = true;
}

bool OAICatalogHudiSource::is_output_schemas_Set() const{
    return m_output_schemas_isSet;
}

bool OAICatalogHudiSource::is_output_schemas_Valid() const{
    return m_output_schemas_isValid;
}

bool OAICatalogHudiSource::isSet() const {
...
bool OAICatalogHudiSource::isValid() const {
