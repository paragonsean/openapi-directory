...
/*
 * OAIGetSchemaByDefinitionInput_SchemaId.h
 *
 * 
 */

#ifndef OAIGetSchemaByDefinitionInput_SchemaId_H
#define OAIGetSchemaByDefinitionInput_SchemaId_H
...
class OAIGetSchemaByDefinitionInput_SchemaId : public OAIObject {
public:
    OAIGetSchemaByDefinitionInput_SchemaId();
    OAIGetSchemaByDefinitionInput_SchemaId(QString json);
    ~OAIGetSchemaByDefinitionInput_SchemaId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSchemaByDefinitionInput_SchemaId)

#endif // OAIGetSchemaByDefinitionInput_SchemaId_H
