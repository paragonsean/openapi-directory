...
#ifndef OAISchemaListItem_H
#define OAISchemaListItem_H
...
class OAISchemaListItem : public OAIObject {
public:
    OAISchemaListItem();
    OAISchemaListItem(QString json);
    ~OAISchemaListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchemaListItem)

#endif // OAISchemaListItem_H
