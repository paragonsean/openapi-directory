...
/*
 * OAIUpdateTriggerResponse_Trigger.h
 *
 * 
 */

#ifndef OAIUpdateTriggerResponse_Trigger_H
#define OAIUpdateTriggerResponse_Trigger_H
...
class OAIUpdateTriggerResponse_Trigger : public OAIObject {
public:
    OAIUpdateTriggerResponse_Trigger();
    OAIUpdateTriggerResponse_Trigger(QString json);
    ~OAIUpdateTriggerResponse_Trigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTriggerResponse_Trigger)

#endif // OAIUpdateTriggerResponse_Trigger_H
