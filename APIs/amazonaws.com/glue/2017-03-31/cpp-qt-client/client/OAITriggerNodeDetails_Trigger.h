...
/*
 * OAITriggerNodeDetails_Trigger.h
 *
 * 
 */

#ifndef OAITriggerNodeDetails_Trigger_H
#define OAITriggerNodeDetails_Trigger_H
...
class OAITriggerNodeDetails_Trigger : public OAIObject {
public:
    OAITriggerNodeDetails_Trigger();
    OAITriggerNodeDetails_Trigger(QString json);
    ~OAITriggerNodeDetails_Trigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITriggerNodeDetails_Trigger)

#endif // OAITriggerNodeDetails_Trigger_H
