...
QString OAICreateSessionResponse_Session::getId() const {
    return m_id;
}
void OAICreateSessionResponse_Session::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateSessionResponse_Session::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateSessionResponse_Session::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAICreateSessionResponse_Session::getCreatedOn() const {
    return m_created_on;
}
void OAICreateSessionResponse_Session::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAICreateSessionResponse_Session::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAICreateSessionResponse_Session::is_created_on_Valid() const{
    return m_created_on_isValid;
}

OAISessionStatus OAICreateSessionResponse_Session::getStatus() const {
    return m_status;
}
void OAICreateSessionResponse_Session::setStatus(const OAISessionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateSessionResponse_Session::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateSessionResponse_Session::is_status_Valid() const{
    return m_status_isValid;
}

QString OAICreateSessionResponse_Session::getErrorMessage() const {
    return m_error_message;
}
void OAICreateSessionResponse_Session::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAICreateSessionResponse_Session::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAICreateSessionResponse_Session::is_error_message_Valid() const{
...
QString OAICreateSessionResponse_Session::getRole() const {
    return m_role;
}
void OAICreateSessionResponse_Session::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAICreateSessionResponse_Session::is_role_Set() const{
    return m_role_isSet;
}

bool OAICreateSessionResponse_Session::is_role_Valid() const{
    return m_role_isValid;
}

OAISession_Command OAICreateSessionResponse_Session::getCommand() const {
    return m_command;
}
void OAICreateSessionResponse_Session::setCommand(const OAISession_Command &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAICreateSessionResponse_Session::is_command_Set() const{
    return m_command_isSet;
}

bool OAICreateSessionResponse_Session::is_command_Valid() const{
    return m_command_isValid;
}

QMap OAICreateSessionResponse_Session::getDefaultArguments() const {
    return m_default_arguments;
}
void OAICreateSessionResponse_Session::setDefaultArguments(const QMap &default_arguments) {
    m_default_arguments = default_arguments;
    m_default_arguments_isSet = true;
}

bool OAICreateSessionResponse_Session::is_default_arguments_Set() const{
    return m_default_arguments_isSet;
}

bool OAICreateSessionResponse_Session::is_default_arguments_Valid() const{
    return m_default_arguments_isValid;
}

OAISession_Connections OAICreateSessionResponse_Session::getConnections() const {
    return m_connections;
}
void OAICreateSessionResponse_Session::setConnections(const OAISession_Connections &connections) {
    m_connections = connections;
    m_connections_isSet = true;
}

bool OAICreateSessionResponse_Session::is_connections_Set() const{
    return m_connections_isSet;
}

bool OAICreateSessionResponse_Session::is_connections_Valid() const{
    return m_connections_isValid;
}

double OAICreateSessionResponse_Session::getProgress() const {
    return m_progress;
}
void OAICreateSessionResponse_Session::setProgress(const double &progress) {
    m_progress = progress;
    m_progress_isSet = true;
}

bool OAICreateSessionResponse_Session::is_progress_Set() const{
    return m_progress_isSet;
}

bool OAICreateSessionResponse_Session::is_progress_Valid() const{
    return m_progress_isValid;
}

double OAICreateSessionResponse_Session::getMaxCapacity() const {
    return m_max_capacity;
}
void OAICreateSessionResponse_Session::setMaxCapacity(const double &max_capacity) {
    m_max_capacity = max_capacity;
    m_max_capacity_isSet = true;
}

bool OAICreateSessionResponse_Session::is_max_capacity_Set() const{
    return m_max_capacity_isSet;
}

bool OAICreateSessionResponse_Session::is_max_capacity_Valid() const{
    return m_max_capacity_isValid;
}

QString OAICreateSessionResponse_Session::getSecurityConfiguration() const {
    return m_security_configuration;
}
void OAICreateSessionResponse_Session::setSecurityConfiguration(const QString &security_configuration) {
    m_security_configuration = security_configuration;
    m_security_configuration_isSet = true;
}

bool OAICreateSessionResponse_Session::is_security_configuration_Set() const{
    return m_security_configuration_isSet;
}

bool OAICreateSessionResponse_Session::is_security_configuration_Valid() const{
    return m_security_configuration_isValid;
}

QString OAICreateSessionResponse_Session::getGlueVersion() const {
    return m_glue_version;
}
void OAICreateSessionResponse_Session::setGlueVersion(const QString &glue_version) {
    m_glue_version = glue_version;
    m_glue_version_isSet = true;
}

bool OAICreateSessionResponse_Session::is_glue_version_Set() const{
    return m_glue_version_isSet;
}

bool OAICreateSessionResponse_Session::is_glue_version_Valid() const{
