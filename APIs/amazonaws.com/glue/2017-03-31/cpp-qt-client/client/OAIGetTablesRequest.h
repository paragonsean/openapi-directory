...
/*
 * OAIGetTablesRequest.h
 *
 * 
 */

#ifndef OAIGetTablesRequest_H
#define OAIGetTablesRequest_H
...
class OAIGetTablesRequest : public OAIObject {
public:
    OAIGetTablesRequest();
    OAIGetTablesRequest(QString json);
    ~OAIGetTablesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTablesRequest)

#endif // OAIGetTablesRequest_H
