...
#include "OAIJDBCConnectorOptions.h"
...
OAIJDBCConnectorOptions::OAIJDBCConnectorOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJDBCConnectorOptions::OAIJDBCConnectorOptions() {
    this->initializeModel();
}

OAIJDBCConnectorOptions::~OAIJDBCConnectorOptions() {}

void OAIJDBCConnectorOptions::initializeModel() {
...
void OAIJDBCConnectorOptions::fromJson(QString jsonString) {
...
void OAIJDBCConnectorOptions::fromJsonObject(QJsonObject json) {
...
QString OAIJDBCConnectorOptions::asJson() const {
...
QJsonObject OAIJDBCConnectorOptions::asJsonObject() const {
    QJsonObject obj;
...
QString OAIJDBCConnectorOptions::getFilterPredicate() const {
    return m_filter_predicate;
}
void OAIJDBCConnectorOptions::setFilterPredicate(const QString &filter_predicate) {
    m_filter_predicate = filter_predicate;
    m_filter_predicate_isSet = true;
}

bool OAIJDBCConnectorOptions::is_filter_predicate_Set() const{
    return m_filter_predicate_isSet;
}

bool OAIJDBCConnectorOptions::is_filter_predicate_Valid() const{
    return m_filter_predicate_isValid;
}

QString OAIJDBCConnectorOptions::getPartitionColumn() const {
    return m_partition_column;
}
void OAIJDBCConnectorOptions::setPartitionColumn(const QString &partition_column) {
    m_partition_column = partition_column;
    m_partition_column_isSet = true;
}

bool OAIJDBCConnectorOptions::is_partition_column_Set() const{
    return m_partition_column_isSet;
}

bool OAIJDBCConnectorOptions::is_partition_column_Valid() const{
    return m_partition_column_isValid;
}

qint32 OAIJDBCConnectorOptions::getLowerBound() const {
    return m_lower_bound;
}
void OAIJDBCConnectorOptions::setLowerBound(const qint32 &lower_bound) {
    m_lower_bound = lower_bound;
    m_lower_bound_isSet = true;
}

bool OAIJDBCConnectorOptions::is_lower_bound_Set() const{
    return m_lower_bound_isSet;
}

bool OAIJDBCConnectorOptions::is_lower_bound_Valid() const{
    return m_lower_bound_isValid;
}

qint32 OAIJDBCConnectorOptions::getUpperBound() const {
    return m_upper_bound;
}
void OAIJDBCConnectorOptions::setUpperBound(const qint32 &upper_bound) {
    m_upper_bound = upper_bound;
    m_upper_bound_isSet = true;
}

bool OAIJDBCConnectorOptions::is_upper_bound_Set() const{
    return m_upper_bound_isSet;
}

bool OAIJDBCConnectorOptions::is_upper_bound_Valid() const{
    return m_upper_bound_isValid;
}

qint32 OAIJDBCConnectorOptions::getNumPartitions() const {
    return m_num_partitions;
}
void OAIJDBCConnectorOptions::setNumPartitions(const qint32 &num_partitions) {
    m_num_partitions = num_partitions;
    m_num_partitions_isSet = true;
}

bool OAIJDBCConnectorOptions::is_num_partitions_Set() const{
    return m_num_partitions_isSet;
}

bool OAIJDBCConnectorOptions::is_num_partitions_Valid() const{
    return m_num_partitions_isValid;
}

QList OAIJDBCConnectorOptions::getJobBookmarkKeys() const {
    return m_job_bookmark_keys;
}
void OAIJDBCConnectorOptions::setJobBookmarkKeys(const QList &job_bookmark_keys) {
    m_job_bookmark_keys = job_bookmark_keys;
    m_job_bookmark_keys_isSet = true;
}

bool OAIJDBCConnectorOptions::is_job_bookmark_keys_Set() const{
    return m_job_bookmark_keys_isSet;
}

bool OAIJDBCConnectorOptions::is_job_bookmark_keys_Valid() const{
    return m_job_bookmark_keys_isValid;
}

QString OAIJDBCConnectorOptions::getJobBookmarkKeysSortOrder() const {
    return m_job_bookmark_keys_sort_order;
}
void OAIJDBCConnectorOptions::setJobBookmarkKeysSortOrder(const QString &job_bookmark_keys_sort_order) {
    m_job_bookmark_keys_sort_order = job_bookmark_keys_sort_order;
    m_job_bookmark_keys_sort_order_isSet = true;
}

bool OAIJDBCConnectorOptions::is_job_bookmark_keys_sort_order_Set() const{
    return m_job_bookmark_keys_sort_order_isSet;
}

bool OAIJDBCConnectorOptions::is_job_bookmark_keys_sort_order_Valid() const{
    return m_job_bookmark_keys_sort_order_isValid;
}

QMap OAIJDBCConnectorOptions::getDataTypeMapping() const {
    return m_data_type_mapping;
}
void OAIJDBCConnectorOptions::setDataTypeMapping(const QMap &data_type_mapping) {
    m_data_type_mapping = data_type_mapping;
    m_data_type_mapping_isSet = true;
}

bool OAIJDBCConnectorOptions::is_data_type_mapping_Set() const{
    return m_data_type_mapping_isSet;
}

bool OAIJDBCConnectorOptions::is_data_type_mapping_Valid() const{
    return m_data_type_mapping_isValid;
}

bool OAIJDBCConnectorOptions::isSet() const {
...
bool OAIJDBCConnectorOptions::isValid() const {
