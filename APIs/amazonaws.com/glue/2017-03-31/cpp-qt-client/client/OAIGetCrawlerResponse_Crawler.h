...
/*
 * OAIGetCrawlerResponse_Crawler.h
 *
 * 
 */

#ifndef OAIGetCrawlerResponse_Crawler_H
#define OAIGetCrawlerResponse_Crawler_H
...
class OAIGetCrawlerResponse_Crawler : public OAIObject {
public:
    OAIGetCrawlerResponse_Crawler();
    OAIGetCrawlerResponse_Crawler(QString json);
    ~OAIGetCrawlerResponse_Crawler() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCrawlerResponse_Crawler)

#endif // OAIGetCrawlerResponse_Crawler_H
