...
#ifndef OAISplitFields_H
#define OAISplitFields_H
...
class OAISplitFields : public OAIObject {
public:
    OAISplitFields();
    OAISplitFields(QString json);
    ~OAISplitFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISplitFields)

#endif // OAISplitFields_H
