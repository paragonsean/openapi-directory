...
/*
 * OAIGetUserDefinedFunctionRequest.h
 *
 * 
 */

#ifndef OAIGetUserDefinedFunctionRequest_H
#define OAIGetUserDefinedFunctionRequest_H
...
class OAIGetUserDefinedFunctionRequest : public OAIObject {
public:
    OAIGetUserDefinedFunctionRequest();
    OAIGetUserDefinedFunctionRequest(QString json);
    ~OAIGetUserDefinedFunctionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserDefinedFunctionRequest)

#endif // OAIGetUserDefinedFunctionRequest_H
