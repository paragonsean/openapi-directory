...
/*
 * OAIGetUnfilteredPartitionMetadataResponse_Partition.h
 *
 * 
 */

#ifndef OAIGetUnfilteredPartitionMetadataResponse_Partition_H
#define OAIGetUnfilteredPartitionMetadataResponse_Partition_H
...
class OAIGetUnfilteredPartitionMetadataResponse_Partition : public OAIObject {
public:
    OAIGetUnfilteredPartitionMetadataResponse_Partition();
    OAIGetUnfilteredPartitionMetadataResponse_Partition(QString json);
    ~OAIGetUnfilteredPartitionMetadataResponse_Partition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUnfilteredPartitionMetadataResponse_Partition)

#endif // OAIGetUnfilteredPartitionMetadataResponse_Partition_H
