...
#ifndef OAIPredecessor_H
#define OAIPredecessor_H
...
class OAIPredecessor : public OAIObject {
public:
    OAIPredecessor();
    OAIPredecessor(QString json);
    ~OAIPredecessor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPredecessor)

#endif // OAIPredecessor_H
