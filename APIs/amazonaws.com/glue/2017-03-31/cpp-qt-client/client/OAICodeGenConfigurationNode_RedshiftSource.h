...
/*
 * OAICodeGenConfigurationNode_RedshiftSource.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_RedshiftSource_H
#define OAICodeGenConfigurationNode_RedshiftSource_H
...
class OAICodeGenConfigurationNode_RedshiftSource : public OAIObject {
public:
    OAICodeGenConfigurationNode_RedshiftSource();
    OAICodeGenConfigurationNode_RedshiftSource(QString json);
    ~OAICodeGenConfigurationNode_RedshiftSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_RedshiftSource)

#endif // OAICodeGenConfigurationNode_RedshiftSource_H
