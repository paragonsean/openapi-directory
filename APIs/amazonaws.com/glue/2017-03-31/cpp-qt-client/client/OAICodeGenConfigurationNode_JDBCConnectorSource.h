...
/*
 * OAICodeGenConfigurationNode_JDBCConnectorSource.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_JDBCConnectorSource_H
#define OAICodeGenConfigurationNode_JDBCConnectorSource_H
...
class OAICodeGenConfigurationNode_JDBCConnectorSource : public OAIObject {
public:
    OAICodeGenConfigurationNode_JDBCConnectorSource();
    OAICodeGenConfigurationNode_JDBCConnectorSource(QString json);
    ~OAICodeGenConfigurationNode_JDBCConnectorSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_JDBCConnectorSource)

#endif // OAICodeGenConfigurationNode_JDBCConnectorSource_H
