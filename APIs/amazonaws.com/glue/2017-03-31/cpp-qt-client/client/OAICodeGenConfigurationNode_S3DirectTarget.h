...
/*
 * OAICodeGenConfigurationNode_S3DirectTarget.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_S3DirectTarget_H
#define OAICodeGenConfigurationNode_S3DirectTarget_H
...
class OAICodeGenConfigurationNode_S3DirectTarget : public OAIObject {
public:
    OAICodeGenConfigurationNode_S3DirectTarget();
    OAICodeGenConfigurationNode_S3DirectTarget(QString json);
    ~OAICodeGenConfigurationNode_S3DirectTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_S3DirectTarget)

#endif // OAICodeGenConfigurationNode_S3DirectTarget_H
