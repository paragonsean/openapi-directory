...
QString OAICreateJobRequest::getName() const {
    return m_name;
}
void OAICreateJobRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateJobRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateJobRequest::is_name_Valid() const{
...
QString OAICreateJobRequest::getLogUri() const {
    return m_log_uri;
}
void OAICreateJobRequest::setLogUri(const QString &log_uri) {
    m_log_uri = log_uri;
    m_log_uri_isSet = true;
}

bool OAICreateJobRequest::is_log_uri_Set() const{
    return m_log_uri_isSet;
}

bool OAICreateJobRequest::is_log_uri_Valid() const{
...
OAICreateJobRequest_ExecutionProperty OAICreateJobRequest::getExecutionProperty() const {
    return m_execution_property;
}
void OAICreateJobRequest::setExecutionProperty(const OAICreateJobRequest_ExecutionProperty &execution_property) {
    m_execution_property = execution_property;
    m_execution_property_isSet = true;
}

bool OAICreateJobRequest::is_execution_property_Set() const{
    return m_execution_property_isSet;
}

bool OAICreateJobRequest::is_execution_property_Valid() const{
    return m_execution_property_isValid;
}

OAICreateJobRequest_Command OAICreateJobRequest::getCommand() const {
    return m_command;
}
void OAICreateJobRequest::setCommand(const OAICreateJobRequest_Command &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAICreateJobRequest::is_command_Set() const{
    return m_command_isSet;
}

bool OAICreateJobRequest::is_command_Valid() const{
    return m_command_isValid;
}

QMap OAICreateJobRequest::getDefaultArguments() const {
    return m_default_arguments;
}
void OAICreateJobRequest::setDefaultArguments(const QMap &default_arguments) {
    m_default_arguments = default_arguments;
    m_default_arguments_isSet = true;
}

bool OAICreateJobRequest::is_default_arguments_Set() const{
    return m_default_arguments_isSet;
}

bool OAICreateJobRequest::is_default_arguments_Valid() const{
    return m_default_arguments_isValid;
}

QMap OAICreateJobRequest::getNonOverridableArguments() const {
    return m_non_overridable_arguments;
}
void OAICreateJobRequest::setNonOverridableArguments(const QMap &non_overridable_arguments) {
    m_non_overridable_arguments = non_overridable_arguments;
    m_non_overridable_arguments_isSet = true;
}

bool OAICreateJobRequest::is_non_overridable_arguments_Set() const{
    return m_non_overridable_arguments_isSet;
}

bool OAICreateJobRequest::is_non_overridable_arguments_Valid() const{
    return m_non_overridable_arguments_isValid;
}

OAICreateJobRequest_Connections OAICreateJobRequest::getConnections() const {
    return m_connections;
}
void OAICreateJobRequest::setConnections(const OAICreateJobRequest_Connections &connections) {
    m_connections = connections;
    m_connections_isSet = true;
}

bool OAICreateJobRequest::is_connections_Set() const{
    return m_connections_isSet;
}

bool OAICreateJobRequest::is_connections_Valid() const{
    return m_connections_isValid;
}

qint32 OAICreateJobRequest::getMaxRetries() const {
    return m_max_retries;
}
void OAICreateJobRequest::setMaxRetries(const qint32 &max_retries) {
    m_max_retries = max_retries;
    m_max_retries_isSet = true;
}

bool OAICreateJobRequest::is_max_retries_Set() const{
    return m_max_retries_isSet;
}

bool OAICreateJobRequest::is_max_retries_Valid() const{
    return m_max_retries_isValid;
}

qint32 OAICreateJobRequest::getAllocatedCapacity() const {
    return m_allocated_capacity;
}
void OAICreateJobRequest::setAllocatedCapacity(const qint32 &allocated_capacity) {
    m_allocated_capacity = allocated_capacity;
    m_allocated_capacity_isSet = true;
}

bool OAICreateJobRequest::is_allocated_capacity_Set() const{
    return m_allocated_capacity_isSet;
}

bool OAICreateJobRequest::is_allocated_capacity_Valid() const{
    return m_allocated_capacity_isValid;
}

qint32 OAICreateJobRequest::getTimeout() const {
    return m_timeout;
}
void OAICreateJobRequest::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAICreateJobRequest::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAICreateJobRequest::is_timeout_Valid() const{
    return m_timeout_isValid;
}

double OAICreateJobRequest::getMaxCapacity() const {
    return m_max_capacity;
}
void OAICreateJobRequest::setMaxCapacity(const double &max_capacity) {
    m_max_capacity = max_capacity;
    m_max_capacity_isSet = true;
}

bool OAICreateJobRequest::is_max_capacity_Set() const{
    return m_max_capacity_isSet;
}

bool OAICreateJobRequest::is_max_capacity_Valid() const{
    return m_max_capacity_isValid;
}

QString OAICreateJobRequest::getSecurityConfiguration() const {
    return m_security_configuration;
}
void OAICreateJobRequest::setSecurityConfiguration(const QString &security_configuration) {
    m_security_configuration = security_configuration;
    m_security_configuration_isSet = true;
}

bool OAICreateJobRequest::is_security_configuration_Set() const{
    return m_security_configuration_isSet;
}

bool OAICreateJobRequest::is_security_configuration_Valid() const{
...
OAICreateJobRequest_NotificationProperty OAICreateJobRequest::getNotificationProperty() const {
    return m_notification_property;
}
void OAICreateJobRequest::setNotificationProperty(const OAICreateJobRequest_NotificationProperty &notification_property) {
    m_notification_property = notification_property;
    m_notification_property_isSet = true;
}

bool OAICreateJobRequest::is_notification_property_Set() const{
    return m_notification_property_isSet;
}

bool OAICreateJobRequest::is_notification_property_Valid() const{
    return m_notification_property_isValid;
}

QString OAICreateJobRequest::getGlueVersion() const {
    return m_glue_version;
}
void OAICreateJobRequest::setGlueVersion(const QString &glue_version) {
    m_glue_version = glue_version;
    m_glue_version_isSet = true;
}

bool OAICreateJobRequest::is_glue_version_Set() const{
    return m_glue_version_isSet;
}

bool OAICreateJobRequest::is_glue_version_Valid() const{
    return m_glue_version_isValid;
}

qint32 OAICreateJobRequest::getNumberOfWorkers() const {
    return m_number_of_workers;
}
void OAICreateJobRequest::setNumberOfWorkers(const qint32 &number_of_workers) {
    m_number_of_workers = number_of_workers;
    m_number_of_workers_isSet = true;
}

bool OAICreateJobRequest::is_number_of_workers_Set() const{
    return m_number_of_workers_isSet;
}

bool OAICreateJobRequest::is_number_of_workers_Valid() const{
    return m_number_of_workers_isValid;
}

OAIWorkerType OAICreateJobRequest::getWorkerType() const {
    return m_worker_type;
}
void OAICreateJobRequest::setWorkerType(const OAIWorkerType &worker_type) {
    m_worker_type = worker_type;
    m_worker_type_isSet = true;
}

bool OAICreateJobRequest::is_worker_type_Set() const{
    return m_worker_type_isSet;
}

bool OAICreateJobRequest::is_worker_type_Valid() const{
    return m_worker_type_isValid;
}

QMap OAICreateJobRequest::getCodeGenConfigurationNodes() const {
    return m_code_gen_configuration_nodes;
}
void OAICreateJobRequest::setCodeGenConfigurationNodes(const QMap &code_gen_configuration_nodes) {
    m_code_gen_configuration_nodes = code_gen_configuration_nodes;
    m_code_gen_configuration_nodes_isSet = true;
}

bool OAICreateJobRequest::is_code_gen_configuration_nodes_Set() const{
    return m_code_gen_configuration_nodes_isSet;
}

bool OAICreateJobRequest::is_code_gen_configuration_nodes_Valid() const{
    return m_code_gen_configuration_nodes_isValid;
}

OAIExecutionClass OAICreateJobRequest::getExecutionClass() const {
    return m_execution_class;
}
void OAICreateJobRequest::setExecutionClass(const OAIExecutionClass &execution_class) {
    m_execution_class = execution_class;
    m_execution_class_isSet = true;
}

bool OAICreateJobRequest::is_execution_class_Set() const{
    return m_execution_class_isSet;
}

bool OAICreateJobRequest::is_execution_class_Valid() const{
    return m_execution_class_isValid;
}

OAICreateJobRequest_SourceControlDetails OAICreateJobRequest::getSourceControlDetails() const {
    return m_source_control_details;
}
void OAICreateJobRequest::setSourceControlDetails(const OAICreateJobRequest_SourceControlDetails &source_control_details) {
    m_source_control_details = source_control_details;
    m_source_control_details_isSet = true;
}

bool OAICreateJobRequest::is_source_control_details_Set() const{
    return m_source_control_details_isSet;
}

bool OAICreateJobRequest::is_source_control_details_Valid() const{
...
bool OAICreateJobRequest::isValid() const {
    ...
    return m_name_isValid && m_role_isValid && m_command_isValid && true;
}
