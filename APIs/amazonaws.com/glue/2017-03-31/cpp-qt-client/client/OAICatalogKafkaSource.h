...
/*
 * OAICatalogKafkaSource.h
 *
 * Specifies an Apache Kafka data store in the Data Catalog.
 */

#ifndef OAICatalogKafkaSource_H
#define OAICatalogKafkaSource_H
...
class OAICatalogKafkaSource : public OAIObject {
public:
    OAICatalogKafkaSource();
    OAICatalogKafkaSource(QString json);
    ~OAICatalogKafkaSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogKafkaSource)

#endif // OAICatalogKafkaSource_H
