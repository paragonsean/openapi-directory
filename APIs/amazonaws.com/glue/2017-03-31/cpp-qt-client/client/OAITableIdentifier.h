...
/*
 * OAITableIdentifier.h
 *
 * A structure that describes a target table for resource linking.
 */

#ifndef OAITableIdentifier_H
#define OAITableIdentifier_H
...
class OAITableIdentifier : public OAIObject {
public:
    OAITableIdentifier();
    OAITableIdentifier(QString json);
    ~OAITableIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableIdentifier)

#endif // OAITableIdentifier_H
