...
/*
 * OAIGetSchemaInput_SchemaId.h
 *
 * 
 */

#ifndef OAIGetSchemaInput_SchemaId_H
#define OAIGetSchemaInput_SchemaId_H
...
class OAIGetSchemaInput_SchemaId : public OAIObject {
public:
    OAIGetSchemaInput_SchemaId();
    OAIGetSchemaInput_SchemaId(QString json);
    ~OAIGetSchemaInput_SchemaId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSchemaInput_SchemaId)

#endif // OAIGetSchemaInput_SchemaId_H
