...
/*
 * OAICodeGenConfigurationNode_RedshiftTarget.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_RedshiftTarget_H
#define OAICodeGenConfigurationNode_RedshiftTarget_H
...
class OAICodeGenConfigurationNode_RedshiftTarget : public OAIObject {
public:
    OAICodeGenConfigurationNode_RedshiftTarget();
    OAICodeGenConfigurationNode_RedshiftTarget(QString json);
    ~OAICodeGenConfigurationNode_RedshiftTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_RedshiftTarget)

#endif // OAICodeGenConfigurationNode_RedshiftTarget_H
