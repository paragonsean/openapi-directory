...
/*
 * OAISparkConnectorSource.h
 *
 * Specifies a connector to an Apache Spark data source.
 */

#ifndef OAISparkConnectorSource_H
#define OAISparkConnectorSource_H
...
class OAISparkConnectorSource : public OAIObject {
public:
    OAISparkConnectorSource();
    OAISparkConnectorSource(QString json);
    ~OAISparkConnectorSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISparkConnectorSource)

#endif // OAISparkConnectorSource_H
