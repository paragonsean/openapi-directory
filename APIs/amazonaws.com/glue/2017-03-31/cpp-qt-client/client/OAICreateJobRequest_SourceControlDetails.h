...
/*
 * OAICreateJobRequest_SourceControlDetails.h
 *
 * 
 */

#ifndef OAICreateJobRequest_SourceControlDetails_H
#define OAICreateJobRequest_SourceControlDetails_H
...
class OAICreateJobRequest_SourceControlDetails : public OAIObject {
public:
    OAICreateJobRequest_SourceControlDetails();
    OAICreateJobRequest_SourceControlDetails(QString json);
    ~OAICreateJobRequest_SourceControlDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobRequest_SourceControlDetails)

#endif // OAICreateJobRequest_SourceControlDetails_H
