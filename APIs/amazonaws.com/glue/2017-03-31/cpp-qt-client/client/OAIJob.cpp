...
QString OAIJob::getLogUri() const {
    return m_log_uri;
}
void OAIJob::setLogUri(const QString &log_uri) {
    m_log_uri = log_uri;
    m_log_uri_isSet = true;
}

bool OAIJob::is_log_uri_Set() const{
    return m_log_uri_isSet;
}

bool OAIJob::is_log_uri_Valid() const{
...
QDateTime OAIJob::getCreatedOn() const {
    return m_created_on;
}
void OAIJob::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIJob::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIJob::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QDateTime OAIJob::getLastModifiedOn() const {
    return m_last_modified_on;
}
void OAIJob::setLastModifiedOn(const QDateTime &last_modified_on) {
    m_last_modified_on = last_modified_on;
    m_last_modified_on_isSet = true;
}

bool OAIJob::is_last_modified_on_Set() const{
    return m_last_modified_on_isSet;
}

bool OAIJob::is_last_modified_on_Valid() const{
    return m_last_modified_on_isValid;
}

OAICreateJobRequest_ExecutionProperty OAIJob::getExecutionProperty() const {
    return m_execution_property;
}
void OAIJob::setExecutionProperty(const OAICreateJobRequest_ExecutionProperty &execution_property) {
    m_execution_property = execution_property;
    m_execution_property_isSet = true;
}

bool OAIJob::is_execution_property_Set() const{
    return m_execution_property_isSet;
}

bool OAIJob::is_execution_property_Valid() const{
    return m_execution_property_isValid;
}

OAICreateJobRequest_Command OAIJob::getCommand() const {
    return m_command;
}
void OAIJob::setCommand(const OAICreateJobRequest_Command &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAIJob::is_command_Set() const{
    return m_command_isSet;
}

bool OAIJob::is_command_Valid() const{
    return m_command_isValid;
}

QMap OAIJob::getDefaultArguments() const {
    return m_default_arguments;
}
void OAIJob::setDefaultArguments(const QMap &default_arguments) {
    m_default_arguments = default_arguments;
    m_default_arguments_isSet = true;
}

bool OAIJob::is_default_arguments_Set() const{
    return m_default_arguments_isSet;
}

bool OAIJob::is_default_arguments_Valid() const{
    return m_default_arguments_isValid;
}

QMap OAIJob::getNonOverridableArguments() const {
    return m_non_overridable_arguments;
}
void OAIJob::setNonOverridableArguments(const QMap &non_overridable_arguments) {
    m_non_overridable_arguments = non_overridable_arguments;
    m_non_overridable_arguments_isSet = true;
}

bool OAIJob::is_non_overridable_arguments_Set() const{
    return m_non_overridable_arguments_isSet;
}

bool OAIJob::is_non_overridable_arguments_Valid() const{
    return m_non_overridable_arguments_isValid;
}

OAICreateJobRequest_Connections OAIJob::getConnections() const {
    return m_connections;
}
void OAIJob::setConnections(const OAICreateJobRequest_Connections &connections) {
    m_connections = connections;
    m_connections_isSet = true;
}

bool OAIJob::is_connections_Set() const{
    return m_connections_isSet;
}

bool OAIJob::is_connections_Valid() const{
    return m_connections_isValid;
}

qint32 OAIJob::getMaxRetries() const {
    return m_max_retries;
}
void OAIJob::setMaxRetries(const qint32 &max_retries) {
    m_max_retries = max_retries;
    m_max_retries_isSet = true;
}

bool OAIJob::is_max_retries_Set() const{
    return m_max_retries_isSet;
}

bool OAIJob::is_max_retries_Valid() const{
    return m_max_retries_isValid;
}

qint32 OAIJob::getAllocatedCapacity() const {
    return m_allocated_capacity;
}
void OAIJob::setAllocatedCapacity(const qint32 &allocated_capacity) {
    m_allocated_capacity = allocated_capacity;
    m_allocated_capacity_isSet = true;
}

bool OAIJob::is_allocated_capacity_Set() const{
    return m_allocated_capacity_isSet;
}

bool OAIJob::is_allocated_capacity_Valid() const{
    return m_allocated_capacity_isValid;
}

qint32 OAIJob::getTimeout() const {
    return m_timeout;
}
void OAIJob::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIJob::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIJob::is_timeout_Valid() const{
    return m_timeout_isValid;
}

double OAIJob::getMaxCapacity() const {
    return m_max_capacity;
}
void OAIJob::setMaxCapacity(const double &max_capacity) {
    m_max_capacity = max_capacity;
    m_max_capacity_isSet = true;
}

bool OAIJob::is_max_capacity_Set() const{
    return m_max_capacity_isSet;
}

bool OAIJob::is_max_capacity_Valid() const{
    return m_max_capacity_isValid;
}

OAIWorkerType OAIJob::getWorkerType() const {
    return m_worker_type;
}
void OAIJob::setWorkerType(const OAIWorkerType &worker_type) {
    m_worker_type = worker_type;
    m_worker_type_isSet = true;
}

bool OAIJob::is_worker_type_Set() const{
    return m_worker_type_isSet;
}

bool OAIJob::is_worker_type_Valid() const{
    return m_worker_type_isValid;
}

qint32 OAIJob::getNumberOfWorkers() const {
    return m_number_of_workers;
}
void OAIJob::setNumberOfWorkers(const qint32 &number_of_workers) {
    m_number_of_workers = number_of_workers;
    m_number_of_workers_isSet = true;
}

bool OAIJob::is_number_of_workers_Set() const{
    return m_number_of_workers_isSet;
}

bool OAIJob::is_number_of_workers_Valid() const{
    return m_number_of_workers_isValid;
}

QString OAIJob::getSecurityConfiguration() const {
    return m_security_configuration;
}
void OAIJob::setSecurityConfiguration(const QString &security_configuration) {
    m_security_configuration = security_configuration;
    m_security_configuration_isSet = true;
}

bool OAIJob::is_security_configuration_Set() const{
    return m_security_configuration_isSet;
}

bool OAIJob::is_security_configuration_Valid() const{
    return m_security_configuration_isValid;
}

OAICreateJobRequest_NotificationProperty OAIJob::getNotificationProperty() const {
    return m_notification_property;
}
void OAIJob::setNotificationProperty(const OAICreateJobRequest_NotificationProperty &notification_property) {
    m_notification_property = notification_property;
    m_notification_property_isSet = true;
}

bool OAIJob::is_notification_property_Set() const{
    return m_notification_property_isSet;
}

bool OAIJob::is_notification_property_Valid() const{
    return m_notification_property_isValid;
}

QString OAIJob::getGlueVersion() const {
    return m_glue_version;
}
void OAIJob::setGlueVersion(const QString &glue_version) {
    m_glue_version = glue_version;
    m_glue_version_isSet = true;
}

bool OAIJob::is_glue_version_Set() const{
    return m_glue_version_isSet;
}

bool OAIJob::is_glue_version_Valid() const{
    return m_glue_version_isValid;
}

QMap OAIJob::getCodeGenConfigurationNodes() const {
    return m_code_gen_configuration_nodes;
}
void OAIJob::setCodeGenConfigurationNodes(const QMap &code_gen_configuration_nodes) {
    m_code_gen_configuration_nodes = code_gen_configuration_nodes;
    m_code_gen_configuration_nodes_isSet = true;
}

bool OAIJob::is_code_gen_configuration_nodes_Set() const{
    return m_code_gen_configuration_nodes_isSet;
}

bool OAIJob::is_code_gen_configuration_nodes_Valid() const{
    return m_code_gen_configuration_nodes_isValid;
}

OAIExecutionClass OAIJob::getExecutionClass() const {
    return m_execution_class;
}
void OAIJob::setExecutionClass(const OAIExecutionClass &execution_class) {
    m_execution_class = execution_class;
    m_execution_class_isSet = true;
}

bool OAIJob::is_execution_class_Set() const{
    return m_execution_class_isSet;
}

bool OAIJob::is_execution_class_Valid() const{
    return m_execution_class_isValid;
}

OAICreateJobRequest_SourceControlDetails OAIJob::getSourceControlDetails() const {
    return m_source_control_details;
}
void OAIJob::setSourceControlDetails(const OAICreateJobRequest_SourceControlDetails &source_control_details) {
    m_source_control_details = source_control_details;
    m_source_control_details_isSet = true;
}

bool OAIJob::is_source_control_details_Set() const{
    return m_source_control_details_isSet;
}

bool OAIJob::is_source_control_details_Valid() const{
