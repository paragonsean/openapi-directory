...
#include "OAIDirectKafkaSource.h"
...
OAIDirectKafkaSource::OAIDirectKafkaSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirectKafkaSource::OAIDirectKafkaSource() {
    this->initializeModel();
}

OAIDirectKafkaSource::~OAIDirectKafkaSource() {}

void OAIDirectKafkaSource::initializeModel() {
...
void OAIDirectKafkaSource::fromJson(QString jsonString) {
...
void OAIDirectKafkaSource::fromJsonObject(QJsonObject json) {
...
QString OAIDirectKafkaSource::asJson() const {
...
QJsonObject OAIDirectKafkaSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDirectKafkaSource::getName() const {
    return m_name;
}
void OAIDirectKafkaSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDirectKafkaSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDirectKafkaSource::is_name_Valid() const{
    return m_name_isValid;
}

OAICatalogKafkaSource_StreamingOptions OAIDirectKafkaSource::getStreamingOptions() const {
    return m_streaming_options;
}
void OAIDirectKafkaSource::setStreamingOptions(const OAICatalogKafkaSource_StreamingOptions &streaming_options) {
    m_streaming_options = streaming_options;
    m_streaming_options_isSet = true;
}

bool OAIDirectKafkaSource::is_streaming_options_Set() const{
    return m_streaming_options_isSet;
}

bool OAIDirectKafkaSource::is_streaming_options_Valid() const{
    return m_streaming_options_isValid;
}

qint32 OAIDirectKafkaSource::getWindowSize() const {
    return m_window_size;
}
void OAIDirectKafkaSource::setWindowSize(const qint32 &window_size) {
    m_window_size = window_size;
    m_window_size_isSet = true;
}

bool OAIDirectKafkaSource::is_window_size_Set() const{
    return m_window_size_isSet;
}

bool OAIDirectKafkaSource::is_window_size_Valid() const{
    return m_window_size_isValid;
}

bool OAIDirectKafkaSource::getDetectSchema() const {
    return m_detect_schema;
}
void OAIDirectKafkaSource::setDetectSchema(const bool &detect_schema) {
    m_detect_schema = detect_schema;
    m_detect_schema_isSet = true;
}

bool OAIDirectKafkaSource::is_detect_schema_Set() const{
    return m_detect_schema_isSet;
}

bool OAIDirectKafkaSource::is_detect_schema_Valid() const{
    return m_detect_schema_isValid;
}

OAICatalogKafkaSource_DataPreviewOptions OAIDirectKafkaSource::getDataPreviewOptions() const {
    return m_data_preview_options;
}
void OAIDirectKafkaSource::setDataPreviewOptions(const OAICatalogKafkaSource_DataPreviewOptions &data_preview_options) {
    m_data_preview_options = data_preview_options;
    m_data_preview_options_isSet = true;
}

bool OAIDirectKafkaSource::is_data_preview_options_Set() const{
    return m_data_preview_options_isSet;
}

bool OAIDirectKafkaSource::is_data_preview_options_Valid() const{
    return m_data_preview_options_isValid;
}

bool OAIDirectKafkaSource::isSet() const {
...
bool OAIDirectKafkaSource::isValid() const {
