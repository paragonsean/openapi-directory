...
/*
 * OAIUpdateCsvClassifierRequest.h
 *
 * Specifies a custom CSV classifier to be updated.
 */

#ifndef OAIUpdateCsvClassifierRequest_H
#define OAIUpdateCsvClassifierRequest_H
...
class OAIUpdateCsvClassifierRequest : public OAIObject {
public:
    OAIUpdateCsvClassifierRequest();
    OAIUpdateCsvClassifierRequest(QString json);
    ~OAIUpdateCsvClassifierRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCsvClassifierRequest)

#endif // OAIUpdateCsvClassifierRequest_H
