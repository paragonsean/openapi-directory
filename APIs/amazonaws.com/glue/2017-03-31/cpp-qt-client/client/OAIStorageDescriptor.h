...
/*
 * OAIStorageDescriptor.h
 *
 * Describes the physical storage of table data.
 */

#ifndef OAIStorageDescriptor_H
#define OAIStorageDescriptor_H
...
class OAIStorageDescriptor : public OAIObject {
public:
    OAIStorageDescriptor();
    OAIStorageDescriptor(QString json);
    ~OAIStorageDescriptor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStorageDescriptor)

#endif // OAIStorageDescriptor_H
