...
/*
 * OAICodeGenConfigurationNode_DirectKafkaSource.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_DirectKafkaSource_H
#define OAICodeGenConfigurationNode_DirectKafkaSource_H
...
class OAICodeGenConfigurationNode_DirectKafkaSource : public OAIObject {
public:
    OAICodeGenConfigurationNode_DirectKafkaSource();
    OAICodeGenConfigurationNode_DirectKafkaSource(QString json);
    ~OAICodeGenConfigurationNode_DirectKafkaSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_DirectKafkaSource)

#endif // OAICodeGenConfigurationNode_DirectKafkaSource_H
