...
/*
 * OAIGetMLTransformResponse.h
 *
 * 
 */

#ifndef OAIGetMLTransformResponse_H
#define OAIGetMLTransformResponse_H
...
namespace OpenAPI {
class OAIGetMLTransformResponse_Parameters;
class OAIGetMLTransformResponse_EvaluationMetrics;
class OAICreateMLTransformRequest_TransformEncryption;

class OAIGetMLTransformResponse : public OAIObject {
public:
    OAIGetMLTransformResponse();
    OAIGetMLTransformResponse(QString json);
    ~OAIGetMLTransformResponse() override;
    ...
    OAIGetMLTransformResponse_Parameters getParameters() const;
    void setParameters(const OAIGetMLTransformResponse_Parameters &parameters);
    bool is_parameters_Set() const;
    bool is_parameters_Valid() const;

    OAIGetMLTransformResponse_EvaluationMetrics getEvaluationMetrics() const;
    void setEvaluationMetrics(const OAIGetMLTransformResponse_EvaluationMetrics &evaluation_metrics);
...
private:
    ...
    OAIGetMLTransformResponse_Parameters m_parameters;
    bool m_parameters_isSet;
    bool m_parameters_isValid;

    OAIGetMLTransformResponse_EvaluationMetrics m_evaluation_metrics;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMLTransformResponse)

#endif // OAIGetMLTransformResponse_H
