...
OAIGetTableResponse_Table::OAIGetTableResponse_Table(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTableResponse_Table::OAIGetTableResponse_Table() {
    this->initializeModel();
}

OAIGetTableResponse_Table::~OAIGetTableResponse_Table() {}

void OAIGetTableResponse_Table::initializeModel() {
...
void OAIGetTableResponse_Table::fromJson(QString jsonString) {
...
void OAIGetTableResponse_Table::fromJsonObject(QJsonObject json) {
...
QString OAIGetTableResponse_Table::asJson() const {
...
QJsonObject OAIGetTableResponse_Table::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIGetTableResponse_Table::getName() const {
    return m_name;
}
void OAIGetTableResponse_Table::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetTableResponse_Table::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetTableResponse_Table::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGetTableResponse_Table::getDatabaseName() const {
    return m_database_name;
}
void OAIGetTableResponse_Table::setDatabaseName(const QString &database_name) {
    m_database_name = database_name;
    m_database_name_isSet = true;
}

bool OAIGetTableResponse_Table::is_database_name_Set() const{
    return m_database_name_isSet;
}

bool OAIGetTableResponse_Table::is_database_name_Valid() const{
    return m_database_name_isValid;
}

QString OAIGetTableResponse_Table::getDescription() const {
    return m_description;
}
void OAIGetTableResponse_Table::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetTableResponse_Table::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetTableResponse_Table::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGetTableResponse_Table::getOwner() const {
    return m_owner;
}
void OAIGetTableResponse_Table::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIGetTableResponse_Table::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIGetTableResponse_Table::is_owner_Valid() const{
    return m_owner_isValid;
}

QDateTime OAIGetTableResponse_Table::getCreateTime() const {
    return m_create_time;
}
void OAIGetTableResponse_Table::setCreateTime(const QDateTime &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIGetTableResponse_Table::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIGetTableResponse_Table::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QDateTime OAIGetTableResponse_Table::getUpdateTime() const {
    return m_update_time;
}
void OAIGetTableResponse_Table::setUpdateTime(const QDateTime &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIGetTableResponse_Table::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIGetTableResponse_Table::is_update_time_Valid() const{
    return m_update_time_isValid;
}

QDateTime OAIGetTableResponse_Table::getLastAccessTime() const {
    return m_last_access_time;
}
void OAIGetTableResponse_Table::setLastAccessTime(const QDateTime &last_access_time) {
    m_last_access_time = last_access_time;
    m_last_access_time_isSet = true;
}

bool OAIGetTableResponse_Table::is_last_access_time_Set() const{
    return m_last_access_time_isSet;
}

bool OAIGetTableResponse_Table::is_last_access_time_Valid() const{
    return m_last_access_time_isValid;
}

QDateTime OAIGetTableResponse_Table::getLastAnalyzedTime() const {
    return m_last_analyzed_time;
}
void OAIGetTableResponse_Table::setLastAnalyzedTime(const QDateTime &last_analyzed_time) {
    m_last_analyzed_time = last_analyzed_time;
    m_last_analyzed_time_isSet = true;
}

bool OAIGetTableResponse_Table::is_last_analyzed_time_Set() const{
    return m_last_analyzed_time_isSet;
}

bool OAIGetTableResponse_Table::is_last_analyzed_time_Valid() const{
    return m_last_analyzed_time_isValid;
}

qint32 OAIGetTableResponse_Table::getRetention() const {
    return m_retention;
}
void OAIGetTableResponse_Table::setRetention(const qint32 &retention) {
    m_retention = retention;
    m_retention_isSet = true;
}

bool OAIGetTableResponse_Table::is_retention_Set() const{
    return m_retention_isSet;
}

bool OAIGetTableResponse_Table::is_retention_Valid() const{
    return m_retention_isValid;
}

OAITableInput_StorageDescriptor OAIGetTableResponse_Table::getStorageDescriptor() const {
    return m_storage_descriptor;
}
void OAIGetTableResponse_Table::setStorageDescriptor(const OAITableInput_StorageDescriptor &storage_descriptor) {
    m_storage_descriptor = storage_descriptor;
    m_storage_descriptor_isSet = true;
}

bool OAIGetTableResponse_Table::is_storage_descriptor_Set() const{
    return m_storage_descriptor_isSet;
}

bool OAIGetTableResponse_Table::is_storage_descriptor_Valid() const{
    return m_storage_descriptor_isValid;
}

QList OAIGetTableResponse_Table::getPartitionKeys() const {
    return m_partition_keys;
}
void OAIGetTableResponse_Table::setPartitionKeys(const QList &partition_keys) {
    m_partition_keys = partition_keys;
    m_partition_keys_isSet = true;
}

bool OAIGetTableResponse_Table::is_partition_keys_Set() const{
    return m_partition_keys_isSet;
}

bool OAIGetTableResponse_Table::is_partition_keys_Valid() const{
    return m_partition_keys_isValid;
}

QString OAIGetTableResponse_Table::getViewOriginalText() const {
    return m_view_original_text;
}
void OAIGetTableResponse_Table::setViewOriginalText(const QString &view_original_text) {
    m_view_original_text = view_original_text;
    m_view_original_text_isSet = true;
}

bool OAIGetTableResponse_Table::is_view_original_text_Set() const{
    return m_view_original_text_isSet;
}

bool OAIGetTableResponse_Table::is_view_original_text_Valid() const{
    return m_view_original_text_isValid;
}

QString OAIGetTableResponse_Table::getViewExpandedText() const {
    return m_view_expanded_text;
}
void OAIGetTableResponse_Table::setViewExpandedText(const QString &view_expanded_text) {
    m_view_expanded_text = view_expanded_text;
    m_view_expanded_text_isSet = true;
}

bool OAIGetTableResponse_Table::is_view_expanded_text_Set() const{
    return m_view_expanded_text_isSet;
}

bool OAIGetTableResponse_Table::is_view_expanded_text_Valid() const{
    return m_view_expanded_text_isValid;
}

QString OAIGetTableResponse_Table::getTableType() const {
    return m_table_type;
}
void OAIGetTableResponse_Table::setTableType(const QString &table_type) {
    m_table_type = table_type;
    m_table_type_isSet = true;
}

bool OAIGetTableResponse_Table::is_table_type_Set() const{
    return m_table_type_isSet;
}

bool OAIGetTableResponse_Table::is_table_type_Valid() const{
    return m_table_type_isValid;
}

QMap OAIGetTableResponse_Table::getParameters() const {
    return m_parameters;
}
void OAIGetTableResponse_Table::setParameters(const QMap &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIGetTableResponse_Table::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIGetTableResponse_Table::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QString OAIGetTableResponse_Table::getCreatedBy() const {
    return m_created_by;
}
void OAIGetTableResponse_Table::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIGetTableResponse_Table::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIGetTableResponse_Table::is_created_by_Valid() const{
    return m_created_by_isValid;
}

bool OAIGetTableResponse_Table::getIsRegisteredWithLakeFormation() const {
    return m_is_registered_with_lake_formation;
}
void OAIGetTableResponse_Table::setIsRegisteredWithLakeFormation(const bool &is_registered_with_lake_formation) {
    m_is_registered_with_lake_formation = is_registered_with_lake_formation;
    m_is_registered_with_lake_formation_isSet = true;
}

bool OAIGetTableResponse_Table::is_is_registered_with_lake_formation_Set() const{
    return m_is_registered_with_lake_formation_isSet;
}

bool OAIGetTableResponse_Table::is_is_registered_with_lake_formation_Valid() const{
    return m_is_registered_with_lake_formation_isValid;
}

OAITableInput_TargetTable OAIGetTableResponse_Table::getTargetTable() const {
    return m_target_table;
}
void OAIGetTableResponse_Table::setTargetTable(const OAITableInput_TargetTable &target_table) {
    m_target_table = target_table;
    m_target_table_isSet = true;
}

bool OAIGetTableResponse_Table::is_target_table_Set() const{
    return m_target_table_isSet;
}

bool OAIGetTableResponse_Table::is_target_table_Valid() const{
    return m_target_table_isValid;
}

QString OAIGetTableResponse_Table::getCatalogId() const {
    return m_catalog_id;
}
void OAIGetTableResponse_Table::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAIGetTableResponse_Table::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAIGetTableResponse_Table::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

QString OAIGetTableResponse_Table::getVersionId() const {
    return m_version_id;
}
void OAIGetTableResponse_Table::setVersionId(const QString &version_id) {
    m_version_id = version_id;
    m_version_id_isSet = true;
}

bool OAIGetTableResponse_Table::is_version_id_Set() const{
    return m_version_id_isSet;
}

bool OAIGetTableResponse_Table::is_version_id_Valid() const{
    return m_version_id_isValid;
}

OAITable_FederatedTable OAIGetTableResponse_Table::getFederatedTable() const {
    return m_federated_table;
}
void OAIGetTableResponse_Table::setFederatedTable(const OAITable_FederatedTable &federated_table) {
    m_federated_table = federated_table;
    m_federated_table_isSet = true;
}

bool OAIGetTableResponse_Table::is_federated_table_Set() const{
    return m_federated_table_isSet;
}

bool OAIGetTableResponse_Table::is_federated_table_Valid() const{
    return m_federated_table_isValid;
}

bool OAIGetTableResponse_Table::isSet() const {
...
bool OAIGetTableResponse_Table::isValid() const {
