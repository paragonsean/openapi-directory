...
/*
 * OAIDeleteRegistryInput_RegistryId.h
 *
 * 
 */

#ifndef OAIDeleteRegistryInput_RegistryId_H
#define OAIDeleteRegistryInput_RegistryId_H
...
class OAIDeleteRegistryInput_RegistryId : public OAIObject {
public:
    OAIDeleteRegistryInput_RegistryId();
    OAIDeleteRegistryInput_RegistryId(QString json);
    ~OAIDeleteRegistryInput_RegistryId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRegistryInput_RegistryId)

#endif // OAIDeleteRegistryInput_RegistryId_H
