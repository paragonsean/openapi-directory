...
#include "OAISnowflakeNodeData.h"
...
OAISnowflakeNodeData::OAISnowflakeNodeData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISnowflakeNodeData::OAISnowflakeNodeData() {
    this->initializeModel();
}

OAISnowflakeNodeData::~OAISnowflakeNodeData() {}

void OAISnowflakeNodeData::initializeModel() {
...
void OAISnowflakeNodeData::fromJson(QString jsonString) {
...
void OAISnowflakeNodeData::fromJsonObject(QJsonObject json) {
...
QString OAISnowflakeNodeData::asJson() const {
...
QJsonObject OAISnowflakeNodeData::asJsonObject() const {
    QJsonObject obj;
...
QString OAISnowflakeNodeData::getSourceType() const {
    return m_source_type;
}
void OAISnowflakeNodeData::setSourceType(const QString &source_type) {
    m_source_type = source_type;
    m_source_type_isSet = true;
}

bool OAISnowflakeNodeData::is_source_type_Set() const{
    return m_source_type_isSet;
}

bool OAISnowflakeNodeData::is_source_type_Valid() const{
    return m_source_type_isValid;
}

OAISnowflakeNodeData_Connection OAISnowflakeNodeData::getConnection() const {
    return m_connection;
}
void OAISnowflakeNodeData::setConnection(const OAISnowflakeNodeData_Connection &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAISnowflakeNodeData::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAISnowflakeNodeData::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAISnowflakeNodeData::getSchema() const {
    return m_schema;
}
void OAISnowflakeNodeData::setSchema(const QString &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAISnowflakeNodeData::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAISnowflakeNodeData::is_schema_Valid() const{
    return m_schema_isValid;
}

QString OAISnowflakeNodeData::getTable() const {
    return m_table;
}
void OAISnowflakeNodeData::setTable(const QString &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAISnowflakeNodeData::is_table_Set() const{
    return m_table_isSet;
}

bool OAISnowflakeNodeData::is_table_Valid() const{
    return m_table_isValid;
}

QString OAISnowflakeNodeData::getDatabase() const {
    return m_database;
}
void OAISnowflakeNodeData::setDatabase(const QString &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAISnowflakeNodeData::is_database_Set() const{
    return m_database_isSet;
}

bool OAISnowflakeNodeData::is_database_Valid() const{
    return m_database_isValid;
}

QString OAISnowflakeNodeData::getTempDir() const {
    return m_temp_dir;
}
void OAISnowflakeNodeData::setTempDir(const QString &temp_dir) {
    m_temp_dir = temp_dir;
    m_temp_dir_isSet = true;
}

bool OAISnowflakeNodeData::is_temp_dir_Set() const{
    return m_temp_dir_isSet;
}

bool OAISnowflakeNodeData::is_temp_dir_Valid() const{
    return m_temp_dir_isValid;
}

OAISnowflakeNodeData_IamRole OAISnowflakeNodeData::getIamRole() const {
    return m_iam_role;
}
void OAISnowflakeNodeData::setIamRole(const OAISnowflakeNodeData_IamRole &iam_role) {
    m_iam_role = iam_role;
    m_iam_role_isSet = true;
}

bool OAISnowflakeNodeData::is_iam_role_Set() const{
    return m_iam_role_isSet;
}

bool OAISnowflakeNodeData::is_iam_role_Valid() const{
    return m_iam_role_isValid;
}

QMap OAISnowflakeNodeData::getAdditionalOptions() const {
    return m_additional_options;
}
void OAISnowflakeNodeData::setAdditionalOptions(const QMap &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAISnowflakeNodeData::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAISnowflakeNodeData::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

QString OAISnowflakeNodeData::getSampleQuery() const {
    return m_sample_query;
}
void OAISnowflakeNodeData::setSampleQuery(const QString &sample_query) {
    m_sample_query = sample_query;
    m_sample_query_isSet = true;
}

bool OAISnowflakeNodeData::is_sample_query_Set() const{
    return m_sample_query_isSet;
}

bool OAISnowflakeNodeData::is_sample_query_Valid() const{
    return m_sample_query_isValid;
}

QString OAISnowflakeNodeData::getPreAction() const {
    return m_pre_action;
}
void OAISnowflakeNodeData::setPreAction(const QString &pre_action) {
    m_pre_action = pre_action;
    m_pre_action_isSet = true;
}

bool OAISnowflakeNodeData::is_pre_action_Set() const{
    return m_pre_action_isSet;
}

bool OAISnowflakeNodeData::is_pre_action_Valid() const{
    return m_pre_action_isValid;
}

QString OAISnowflakeNodeData::getPostAction() const {
    return m_post_action;
}
void OAISnowflakeNodeData::setPostAction(const QString &post_action) {
    m_post_action = post_action;
    m_post_action_isSet = true;
}

bool OAISnowflakeNodeData::is_post_action_Set() const{
    return m_post_action_isSet;
}

bool OAISnowflakeNodeData::is_post_action_Valid() const{
    return m_post_action_isValid;
}

QString OAISnowflakeNodeData::getAction() const {
    return m_action;
}
void OAISnowflakeNodeData::setAction(const QString &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAISnowflakeNodeData::is_action_Set() const{
    return m_action_isSet;
}

bool OAISnowflakeNodeData::is_action_Valid() const{
    return m_action_isValid;
}

bool OAISnowflakeNodeData::getUpsert() const {
    return m_upsert;
}
void OAISnowflakeNodeData::setUpsert(const bool &upsert) {
    m_upsert = upsert;
    m_upsert_isSet = true;
}

bool OAISnowflakeNodeData::is_upsert_Set() const{
    return m_upsert_isSet;
}

bool OAISnowflakeNodeData::is_upsert_Valid() const{
    return m_upsert_isValid;
}

QString OAISnowflakeNodeData::getMergeAction() const {
    return m_merge_action;
}
void OAISnowflakeNodeData::setMergeAction(const QString &merge_action) {
    m_merge_action = merge_action;
    m_merge_action_isSet = true;
}

bool OAISnowflakeNodeData::is_merge_action_Set() const{
    return m_merge_action_isSet;
}

bool OAISnowflakeNodeData::is_merge_action_Valid() const{
    return m_merge_action_isValid;
}

QString OAISnowflakeNodeData::getMergeWhenMatched() const {
    return m_merge_when_matched;
}
void OAISnowflakeNodeData::setMergeWhenMatched(const QString &merge_when_matched) {
    m_merge_when_matched = merge_when_matched;
    m_merge_when_matched_isSet = true;
}

bool OAISnowflakeNodeData::is_merge_when_matched_Set() const{
    return m_merge_when_matched_isSet;
}

bool OAISnowflakeNodeData::is_merge_when_matched_Valid() const{
    return m_merge_when_matched_isValid;
}

QString OAISnowflakeNodeData::getMergeWhenNotMatched() const {
    return m_merge_when_not_matched;
}
void OAISnowflakeNodeData::setMergeWhenNotMatched(const QString &merge_when_not_matched) {
    m_merge_when_not_matched = merge_when_not_matched;
    m_merge_when_not_matched_isSet = true;
}

bool OAISnowflakeNodeData::is_merge_when_not_matched_Set() const{
    return m_merge_when_not_matched_isSet;
}

bool OAISnowflakeNodeData::is_merge_when_not_matched_Valid() const{
    return m_merge_when_not_matched_isValid;
}

QString OAISnowflakeNodeData::getMergeClause() const {
    return m_merge_clause;
}
void OAISnowflakeNodeData::setMergeClause(const QString &merge_clause) {
    m_merge_clause = merge_clause;
    m_merge_clause_isSet = true;
}

bool OAISnowflakeNodeData::is_merge_clause_Set() const{
    return m_merge_clause_isSet;
}

bool OAISnowflakeNodeData::is_merge_clause_Valid() const{
    return m_merge_clause_isValid;
}

QString OAISnowflakeNodeData::getStagingTable() const {
    return m_staging_table;
}
void OAISnowflakeNodeData::setStagingTable(const QString &staging_table) {
    m_staging_table = staging_table;
    m_staging_table_isSet = true;
}

bool OAISnowflakeNodeData::is_staging_table_Set() const{
    return m_staging_table_isSet;
}

bool OAISnowflakeNodeData::is_staging_table_Valid() const{
    return m_staging_table_isValid;
}

QList OAISnowflakeNodeData::getSelectedColumns() const {
    return m_selected_columns;
}
void OAISnowflakeNodeData::setSelectedColumns(const QList &selected_columns) {
    m_selected_columns = selected_columns;
    m_selected_columns_isSet = true;
}

bool OAISnowflakeNodeData::is_selected_columns_Set() const{
    return m_selected_columns_isSet;
}

bool OAISnowflakeNodeData::is_selected_columns_Valid() const{
    return m_selected_columns_isValid;
}

bool OAISnowflakeNodeData::getAutoPushdown() const {
    return m_auto_pushdown;
}
void OAISnowflakeNodeData::setAutoPushdown(const bool &auto_pushdown) {
    m_auto_pushdown = auto_pushdown;
    m_auto_pushdown_isSet = true;
}

bool OAISnowflakeNodeData::is_auto_pushdown_Set() const{
    return m_auto_pushdown_isSet;
}

bool OAISnowflakeNodeData::is_auto_pushdown_Valid() const{
    return m_auto_pushdown_isValid;
}

QList OAISnowflakeNodeData::getTableSchema() const {
    return m_table_schema;
}
void OAISnowflakeNodeData::setTableSchema(const QList &table_schema) {
    m_table_schema = table_schema;
    m_table_schema_isSet = true;
}

bool OAISnowflakeNodeData::is_table_schema_Set() const{
    return m_table_schema_isSet;
}

bool OAISnowflakeNodeData::is_table_schema_Valid() const{
    return m_table_schema_isValid;
}

bool OAISnowflakeNodeData::isSet() const {
...
bool OAISnowflakeNodeData::isValid() const {
