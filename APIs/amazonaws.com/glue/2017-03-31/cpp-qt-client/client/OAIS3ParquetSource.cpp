...
OAIS3ParquetSource::OAIS3ParquetSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3ParquetSource::OAIS3ParquetSource() {
    this->initializeModel();
}

OAIS3ParquetSource::~OAIS3ParquetSource() {}

void OAIS3ParquetSource::initializeModel() {
...
void OAIS3ParquetSource::fromJson(QString jsonString) {
...
void OAIS3ParquetSource::fromJsonObject(QJsonObject json) {
...
QString OAIS3ParquetSource::asJson() const {
...
QJsonObject OAIS3ParquetSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIS3ParquetSource::getName() const {
    return m_name;
}
void OAIS3ParquetSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIS3ParquetSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAIS3ParquetSource::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIS3ParquetSource::getPaths() const {
    return m_paths;
}
void OAIS3ParquetSource::setPaths(const QList &paths) {
    m_paths = paths;
    m_paths_isSet = true;
}

bool OAIS3ParquetSource::is_paths_Set() const{
    return m_paths_isSet;
}

bool OAIS3ParquetSource::is_paths_Valid() const{
    return m_paths_isValid;
}

OAIParquetCompressionType OAIS3ParquetSource::getCompressionType() const {
    return m_compression_type;
}
void OAIS3ParquetSource::setCompressionType(const OAIParquetCompressionType &compression_type) {
    m_compression_type = compression_type;
    m_compression_type_isSet = true;
}

bool OAIS3ParquetSource::is_compression_type_Set() const{
    return m_compression_type_isSet;
}

bool OAIS3ParquetSource::is_compression_type_Valid() const{
    return m_compression_type_isValid;
}

QList OAIS3ParquetSource::getExclusions() const {
    return m_exclusions;
}
void OAIS3ParquetSource::setExclusions(const QList &exclusions) {
    m_exclusions = exclusions;
    m_exclusions_isSet = true;
}

bool OAIS3ParquetSource::is_exclusions_Set() const{
    return m_exclusions_isSet;
}

bool OAIS3ParquetSource::is_exclusions_Valid() const{
    return m_exclusions_isValid;
}

QString OAIS3ParquetSource::getGroupSize() const {
    return m_group_size;
}
void OAIS3ParquetSource::setGroupSize(const QString &group_size) {
    m_group_size = group_size;
    m_group_size_isSet = true;
}

bool OAIS3ParquetSource::is_group_size_Set() const{
    return m_group_size_isSet;
}

bool OAIS3ParquetSource::is_group_size_Valid() const{
    return m_group_size_isValid;
}

QString OAIS3ParquetSource::getGroupFiles() const {
    return m_group_files;
}
void OAIS3ParquetSource::setGroupFiles(const QString &group_files) {
    m_group_files = group_files;
    m_group_files_isSet = true;
}

bool OAIS3ParquetSource::is_group_files_Set() const{
    return m_group_files_isSet;
}

bool OAIS3ParquetSource::is_group_files_Valid() const{
    return m_group_files_isValid;
}

bool OAIS3ParquetSource::getRecurse() const {
    return m_recurse;
}
void OAIS3ParquetSource::setRecurse(const bool &recurse) {
    m_recurse = recurse;
    m_recurse_isSet = true;
}

bool OAIS3ParquetSource::is_recurse_Set() const{
    return m_recurse_isSet;
}

bool OAIS3ParquetSource::is_recurse_Valid() const{
    return m_recurse_isValid;
}

qint32 OAIS3ParquetSource::getMaxBand() const {
    return m_max_band;
}
void OAIS3ParquetSource::setMaxBand(const qint32 &max_band) {
    m_max_band = max_band;
    m_max_band_isSet = true;
}

bool OAIS3ParquetSource::is_max_band_Set() const{
    return m_max_band_isSet;
}

bool OAIS3ParquetSource::is_max_band_Valid() const{
    return m_max_band_isValid;
}

qint32 OAIS3ParquetSource::getMaxFilesInBand() const {
    return m_max_files_in_band;
}
void OAIS3ParquetSource::setMaxFilesInBand(const qint32 &max_files_in_band) {
    m_max_files_in_band = max_files_in_band;
    m_max_files_in_band_isSet = true;
}

bool OAIS3ParquetSource::is_max_files_in_band_Set() const{
    return m_max_files_in_band_isSet;
}

bool OAIS3ParquetSource::is_max_files_in_band_Valid() const{
    return m_max_files_in_band_isValid;
}

OAIS3CsvSource_AdditionalOptions OAIS3ParquetSource::getAdditionalOptions() const {
    return m_additional_options;
}
void OAIS3ParquetSource::setAdditionalOptions(const OAIS3CsvSource_AdditionalOptions &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAIS3ParquetSource::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAIS3ParquetSource::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

QList OAIS3ParquetSource::getOutputSchemas() const {
    return m_output_schemas;
}
void OAIS3ParquetSource::setOutputSchemas(const QList &output_schemas) {
    m_output_schemas = output_schemas;
    m_output_schemas_isSet = true;
}

bool OAIS3ParquetSource::is_output_schemas_Set() const{
    return m_output_schemas_isSet;
}

bool OAIS3ParquetSource::is_output_schemas_Valid() const{
    return m_output_schemas_isValid;
}

bool OAIS3ParquetSource::isSet() const {
...
bool OAIS3ParquetSource::isValid() const {
