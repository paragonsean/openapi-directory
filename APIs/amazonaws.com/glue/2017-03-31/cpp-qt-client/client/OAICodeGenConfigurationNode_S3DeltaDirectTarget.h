...
/*
 * OAICodeGenConfigurationNode_S3DeltaDirectTarget.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_S3DeltaDirectTarget_H
#define OAICodeGenConfigurationNode_S3DeltaDirectTarget_H
...
class OAICodeGenConfigurationNode_S3DeltaDirectTarget : public OAIObject {
public:
    OAICodeGenConfigurationNode_S3DeltaDirectTarget();
    OAICodeGenConfigurationNode_S3DeltaDirectTarget(QString json);
    ~OAICodeGenConfigurationNode_S3DeltaDirectTarget() override;
    ...
    OAIDeltaTargetCompressionType getCompression() const;
    void setCompression(const OAIDeltaTargetCompressionType &compression);
...
private:
    ...
    OAIDeltaTargetCompressionType m_compression;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_S3DeltaDirectTarget)

#endif // OAICodeGenConfigurationNode_S3DeltaDirectTarget_H
