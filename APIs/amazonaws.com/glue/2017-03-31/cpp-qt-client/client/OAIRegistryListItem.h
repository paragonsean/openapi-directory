...
/*
 * OAIRegistryListItem.h
 *
 * A structure containing the details for a registry.
 */

#ifndef OAIRegistryListItem_H
#define OAIRegistryListItem_H
...
class OAIRegistryListItem : public OAIObject {
public:
    OAIRegistryListItem();
    OAIRegistryListItem(QString json);
    ~OAIRegistryListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegistryListItem)

#endif // OAIRegistryListItem_H
