...
/*
 * OAIGetTableRequest.h
 *
 * 
 */

#ifndef OAIGetTableRequest_H
#define OAIGetTableRequest_H
...
class OAIGetTableRequest : public OAIObject {
public:
    OAIGetTableRequest();
    OAIGetTableRequest(QString json);
    ~OAIGetTableRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableRequest)

#endif // OAIGetTableRequest_H
