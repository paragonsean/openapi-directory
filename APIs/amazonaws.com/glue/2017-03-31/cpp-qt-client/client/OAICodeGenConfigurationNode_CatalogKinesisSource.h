...
/*
 * OAICodeGenConfigurationNode_CatalogKinesisSource.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_CatalogKinesisSource_H
#define OAICodeGenConfigurationNode_CatalogKinesisSource_H
...
class OAICodeGenConfigurationNode_CatalogKinesisSource : public OAIObject {
public:
    OAICodeGenConfigurationNode_CatalogKinesisSource();
    OAICodeGenConfigurationNode_CatalogKinesisSource(QString json);
    ~OAICodeGenConfigurationNode_CatalogKinesisSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_CatalogKinesisSource)

#endif // OAICodeGenConfigurationNode_CatalogKinesisSource_H
