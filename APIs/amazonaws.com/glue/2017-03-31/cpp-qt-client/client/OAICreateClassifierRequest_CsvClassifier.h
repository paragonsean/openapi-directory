...
/*
 * OAICreateClassifierRequest_CsvClassifier.h
 *
 * 
 */

#ifndef OAICreateClassifierRequest_CsvClassifier_H
#define OAICreateClassifierRequest_CsvClassifier_H
...
class OAICreateClassifierRequest_CsvClassifier : public OAIObject {
public:
    OAICreateClassifierRequest_CsvClassifier();
    OAICreateClassifierRequest_CsvClassifier(QString json);
    ~OAICreateClassifierRequest_CsvClassifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClassifierRequest_CsvClassifier)

#endif // OAICreateClassifierRequest_CsvClassifier_H
