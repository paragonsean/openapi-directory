...
QString OAIAggregate::getName() const {
    return m_name;
}
void OAIAggregate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAggregate::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAggregate::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIAggregate::getInputs() const {
    return m_inputs;
}
void OAIAggregate::setInputs(const QList &inputs) {
    m_inputs = inputs;
    m_inputs_isSet = true;
}

bool OAIAggregate::is_inputs_Set() const{
    return m_inputs_isSet;
}

bool OAIAggregate::is_inputs_Valid() const{
    return m_inputs_isValid;
}

QList OAIAggregate::getGroups() const {
    return m_groups;
}
void OAIAggregate::setGroups(const QList &groups) {
    m_groups = groups;
    m_groups_isSet = true;
}

bool OAIAggregate::is_groups_Set() const{
    return m_groups_isSet;
}

bool OAIAggregate::is_groups_Valid() const{
    return m_groups_isValid;
}

QList OAIAggregate::getAggs() const {
    return m_aggs;
}
void OAIAggregate::setAggs(const QList &aggs) {
    m_aggs = aggs;
    m_aggs_isSet = true;
}

bool OAIAggregate::is_aggs_Set() const{
    return m_aggs_isSet;
}

bool OAIAggregate::is_aggs_Valid() const{
