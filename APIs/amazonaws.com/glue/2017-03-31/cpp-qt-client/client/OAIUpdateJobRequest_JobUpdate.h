...
/*
 * OAIUpdateJobRequest_JobUpdate.h
 *
 * 
 */

#ifndef OAIUpdateJobRequest_JobUpdate_H
#define OAIUpdateJobRequest_JobUpdate_H
...
class OAIUpdateJobRequest_JobUpdate : public OAIObject {
public:
    OAIUpdateJobRequest_JobUpdate();
    OAIUpdateJobRequest_JobUpdate(QString json);
    ~OAIUpdateJobRequest_JobUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateJobRequest_JobUpdate)

#endif // OAIUpdateJobRequest_JobUpdate_H
