...
/*
 * OAIFederatedDatabase.h
 *
 * A database that points to an entity outside the Glue Data Catalog.
 */

#ifndef OAIFederatedDatabase_H
#define OAIFederatedDatabase_H
...
class OAIFederatedDatabase : public OAIObject {
public:
    OAIFederatedDatabase();
    OAIFederatedDatabase(QString json);
    ~OAIFederatedDatabase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFederatedDatabase)

#endif // OAIFederatedDatabase_H
