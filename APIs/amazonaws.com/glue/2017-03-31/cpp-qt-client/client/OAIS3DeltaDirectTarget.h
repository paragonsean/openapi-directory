...
/*
 * OAIS3DeltaDirectTarget.h
 *
 * Specifies a target that writes to a Delta Lake data source in Amazon S3.
 */

#ifndef OAIS3DeltaDirectTarget_H
#define OAIS3DeltaDirectTarget_H
...
class OAIS3DeltaDirectTarget : public OAIObject {
public:
    OAIS3DeltaDirectTarget();
    OAIS3DeltaDirectTarget(QString json);
    ~OAIS3DeltaDirectTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3DeltaDirectTarget)

#endif // OAIS3DeltaDirectTarget_H
