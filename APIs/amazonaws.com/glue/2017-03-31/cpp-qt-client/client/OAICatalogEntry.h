...
#ifndef OAICatalogEntry_H
#define OAICatalogEntry_H
...
class OAICatalogEntry : public OAIObject {
public:
    OAICatalogEntry();
    OAICatalogEntry(QString json);
    ~OAICatalogEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogEntry)

#endif // OAICatalogEntry_H
