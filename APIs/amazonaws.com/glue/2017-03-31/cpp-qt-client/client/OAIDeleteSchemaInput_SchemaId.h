...
/*
 * OAIDeleteSchemaInput_SchemaId.h
 *
 * 
 */

#ifndef OAIDeleteSchemaInput_SchemaId_H
#define OAIDeleteSchemaInput_SchemaId_H
...
class OAIDeleteSchemaInput_SchemaId : public OAIObject {
public:
    OAIDeleteSchemaInput_SchemaId();
    OAIDeleteSchemaInput_SchemaId(QString json);
    ~OAIDeleteSchemaInput_SchemaId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSchemaInput_SchemaId)

#endif // OAIDeleteSchemaInput_SchemaId_H
