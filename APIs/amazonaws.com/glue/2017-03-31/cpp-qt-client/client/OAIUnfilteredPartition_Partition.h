...
/*
 * OAIUnfilteredPartition_Partition.h
 *
 * 
 */

#ifndef OAIUnfilteredPartition_Partition_H
#define OAIUnfilteredPartition_Partition_H
...
class OAIUnfilteredPartition_Partition : public OAIObject {
public:
    OAIUnfilteredPartition_Partition();
    OAIUnfilteredPartition_Partition(QString json);
    ~OAIUnfilteredPartition_Partition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnfilteredPartition_Partition)

#endif // OAIUnfilteredPartition_Partition_H
