...
/*
 * OAICodeGenConfigurationNode_AthenaConnectorSource.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_AthenaConnectorSource_H
#define OAICodeGenConfigurationNode_AthenaConnectorSource_H
...
class OAICodeGenConfigurationNode_AthenaConnectorSource : public OAIObject {
public:
    OAICodeGenConfigurationNode_AthenaConnectorSource();
    OAICodeGenConfigurationNode_AthenaConnectorSource(QString json);
    ~OAICodeGenConfigurationNode_AthenaConnectorSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_AthenaConnectorSource)

#endif // OAICodeGenConfigurationNode_AthenaConnectorSource_H
