...
/*
 * OAICreateCrawlerRequest.h
 *
 * 
 */

#ifndef OAICreateCrawlerRequest_H
#define OAICreateCrawlerRequest_H
...
namespace OpenAPI {
class OAICreateCrawlerRequest_Targets;
...
class OAICreateCrawlerRequest : public OAIObject {
public:
    OAICreateCrawlerRequest();
    OAICreateCrawlerRequest(QString json);
    ~OAICreateCrawlerRequest() override;
    ...
    OAICreateCrawlerRequest_Targets getTargets() const;
    void setTargets(const OAICreateCrawlerRequest_Targets &targets);
...
private:
    ...
    OAICreateCrawlerRequest_Targets m_targets;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCrawlerRequest)

#endif // OAICreateCrawlerRequest_H
