...
/*
 * OAIGetStatementRequest.h
 *
 * 
 */

#ifndef OAIGetStatementRequest_H
#define OAIGetStatementRequest_H
...
class OAIGetStatementRequest : public OAIObject {
public:
    OAIGetStatementRequest();
    OAIGetStatementRequest(QString json);
    ~OAIGetStatementRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStatementRequest)

#endif // OAIGetStatementRequest_H
