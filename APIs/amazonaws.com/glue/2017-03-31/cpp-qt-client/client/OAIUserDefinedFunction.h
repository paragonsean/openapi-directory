...
/*
 * OAIUserDefinedFunction.h
 *
 * Represents the equivalent of a Hive user-defined function (&lt;code&gt;UDF&lt;/code&gt;) definition.
 */

#ifndef OAIUserDefinedFunction_H
#define OAIUserDefinedFunction_H
...
class OAIUserDefinedFunction : public OAIObject {
public:
    OAIUserDefinedFunction();
    OAIUserDefinedFunction(QString json);
    ~OAIUserDefinedFunction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserDefinedFunction)

#endif // OAIUserDefinedFunction_H
