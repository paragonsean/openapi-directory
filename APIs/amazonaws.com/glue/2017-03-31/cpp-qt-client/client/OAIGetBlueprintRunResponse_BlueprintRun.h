...
/*
 * OAIGetBlueprintRunResponse_BlueprintRun.h
 *
 * 
 */

#ifndef OAIGetBlueprintRunResponse_BlueprintRun_H
#define OAIGetBlueprintRunResponse_BlueprintRun_H
...
class OAIGetBlueprintRunResponse_BlueprintRun : public OAIObject {
public:
    OAIGetBlueprintRunResponse_BlueprintRun();
    OAIGetBlueprintRunResponse_BlueprintRun(QString json);
    ~OAIGetBlueprintRunResponse_BlueprintRun() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBlueprintRunResponse_BlueprintRun)

#endif // OAIGetBlueprintRunResponse_BlueprintRun_H
