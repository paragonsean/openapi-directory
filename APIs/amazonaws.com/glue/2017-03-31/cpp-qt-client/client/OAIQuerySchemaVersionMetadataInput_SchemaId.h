...
/*
 * OAIQuerySchemaVersionMetadataInput_SchemaId.h
 *
 * 
 */

#ifndef OAIQuerySchemaVersionMetadataInput_SchemaId_H
#define OAIQuerySchemaVersionMetadataInput_SchemaId_H
...
class OAIQuerySchemaVersionMetadataInput_SchemaId : public OAIObject {
public:
    OAIQuerySchemaVersionMetadataInput_SchemaId();
    OAIQuerySchemaVersionMetadataInput_SchemaId(QString json);
    ~OAIQuerySchemaVersionMetadataInput_SchemaId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuerySchemaVersionMetadataInput_SchemaId)

#endif // OAIQuerySchemaVersionMetadataInput_SchemaId_H
