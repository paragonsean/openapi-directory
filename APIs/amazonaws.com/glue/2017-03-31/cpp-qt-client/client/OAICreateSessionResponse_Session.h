...
/*
 * OAICreateSessionResponse_Session.h
 *
 * 
 */

#ifndef OAICreateSessionResponse_Session_H
#define OAICreateSessionResponse_Session_H
...
class OAICreateSessionResponse_Session : public OAIObject {
public:
    OAICreateSessionResponse_Session();
    OAICreateSessionResponse_Session(QString json);
    ~OAICreateSessionResponse_Session() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSessionResponse_Session)

#endif // OAICreateSessionResponse_Session_H
