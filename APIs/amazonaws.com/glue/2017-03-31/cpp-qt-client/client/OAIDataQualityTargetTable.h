...
/*
 * OAIDataQualityTargetTable.h
 *
 * An object representing an Glue table.
 */

#ifndef OAIDataQualityTargetTable_H
#define OAIDataQualityTargetTable_H
...
class OAIDataQualityTargetTable : public OAIObject {
public:
    OAIDataQualityTargetTable();
    OAIDataQualityTargetTable(QString json);
    ~OAIDataQualityTargetTable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataQualityTargetTable)

#endif // OAIDataQualityTargetTable_H
