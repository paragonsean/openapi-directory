...
#ifndef OAIHudiTarget_H
#define OAIHudiTarget_H
...
class OAIHudiTarget : public OAIObject {
public:
    OAIHudiTarget();
    OAIHudiTarget(QString json);
    ~OAIHudiTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHudiTarget)

#endif // OAIHudiTarget_H
