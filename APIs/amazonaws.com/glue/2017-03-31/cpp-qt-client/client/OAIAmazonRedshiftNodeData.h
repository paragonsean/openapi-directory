...
/*
 * OAIAmazonRedshiftNodeData.h
 *
 * Specifies an Amazon Redshift node.
 */

#ifndef OAIAmazonRedshiftNodeData_H
#define OAIAmazonRedshiftNodeData_H
...
class OAIAmazonRedshiftNodeData : public OAIObject {
public:
    OAIAmazonRedshiftNodeData();
    OAIAmazonRedshiftNodeData(QString json);
    ~OAIAmazonRedshiftNodeData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmazonRedshiftNodeData)

#endif // OAIAmazonRedshiftNodeData_H
