...
/*
 * OAICatalogKinesisSource.h
 *
 * Specifies a Kinesis data source in the Glue Data Catalog.
 */

#ifndef OAICatalogKinesisSource_H
#define OAICatalogKinesisSource_H
...
class OAICatalogKinesisSource : public OAIObject {
public:
    OAICatalogKinesisSource();
    OAICatalogKinesisSource(QString json);
    ~OAICatalogKinesisSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalogKinesisSource)

#endif // OAICatalogKinesisSource_H
