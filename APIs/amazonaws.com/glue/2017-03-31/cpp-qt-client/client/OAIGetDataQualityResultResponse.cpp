...
OAIGetDataQualityResultResponse::OAIGetDataQualityResultResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDataQualityResultResponse::OAIGetDataQualityResultResponse() {
    this->initializeModel();
}

OAIGetDataQualityResultResponse::~OAIGetDataQualityResultResponse() {}

void OAIGetDataQualityResultResponse::initializeModel() {
...
void OAIGetDataQualityResultResponse::fromJson(QString jsonString) {
...
void OAIGetDataQualityResultResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetDataQualityResultResponse::asJson() const {
...
QJsonObject OAIGetDataQualityResultResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDataQualityResultResponse::getResultId() const {
    return m_result_id;
}
void OAIGetDataQualityResultResponse::setResultId(const QString &result_id) {
    m_result_id = result_id;
    m_result_id_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_result_id_Set() const{
    return m_result_id_isSet;
}

bool OAIGetDataQualityResultResponse::is_result_id_Valid() const{
    return m_result_id_isValid;
}

double OAIGetDataQualityResultResponse::getScore() const {
    return m_score;
}
void OAIGetDataQualityResultResponse::setScore(const double &score) {
    m_score = score;
    m_score_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_score_Set() const{
    return m_score_isSet;
}

bool OAIGetDataQualityResultResponse::is_score_Valid() const{
    return m_score_isValid;
}

OAIGetDataQualityResultResponse_DataSource OAIGetDataQualityResultResponse::getDataSource() const {
    return m_data_source;
}
void OAIGetDataQualityResultResponse::setDataSource(const OAIGetDataQualityResultResponse_DataSource &data_source) {
    m_data_source = data_source;
    m_data_source_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_data_source_Set() const{
    return m_data_source_isSet;
}

bool OAIGetDataQualityResultResponse::is_data_source_Valid() const{
    return m_data_source_isValid;
}

QString OAIGetDataQualityResultResponse::getRulesetName() const {
    return m_ruleset_name;
}
void OAIGetDataQualityResultResponse::setRulesetName(const QString &ruleset_name) {
    m_ruleset_name = ruleset_name;
    m_ruleset_name_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_ruleset_name_Set() const{
    return m_ruleset_name_isSet;
}

bool OAIGetDataQualityResultResponse::is_ruleset_name_Valid() const{
    return m_ruleset_name_isValid;
}

QString OAIGetDataQualityResultResponse::getEvaluationContext() const {
    return m_evaluation_context;
}
void OAIGetDataQualityResultResponse::setEvaluationContext(const QString &evaluation_context) {
    m_evaluation_context = evaluation_context;
    m_evaluation_context_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_evaluation_context_Set() const{
    return m_evaluation_context_isSet;
}

bool OAIGetDataQualityResultResponse::is_evaluation_context_Valid() const{
    return m_evaluation_context_isValid;
}

QDateTime OAIGetDataQualityResultResponse::getStartedOn() const {
    return m_started_on;
}
void OAIGetDataQualityResultResponse::setStartedOn(const QDateTime &started_on) {
    m_started_on = started_on;
    m_started_on_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_started_on_Set() const{
    return m_started_on_isSet;
}

bool OAIGetDataQualityResultResponse::is_started_on_Valid() const{
    return m_started_on_isValid;
}

QDateTime OAIGetDataQualityResultResponse::getCompletedOn() const {
    return m_completed_on;
}
void OAIGetDataQualityResultResponse::setCompletedOn(const QDateTime &completed_on) {
    m_completed_on = completed_on;
    m_completed_on_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_completed_on_Set() const{
    return m_completed_on_isSet;
}

bool OAIGetDataQualityResultResponse::is_completed_on_Valid() const{
    return m_completed_on_isValid;
}

QString OAIGetDataQualityResultResponse::getJobName() const {
    return m_job_name;
}
void OAIGetDataQualityResultResponse::setJobName(const QString &job_name) {
    m_job_name = job_name;
    m_job_name_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_job_name_Set() const{
    return m_job_name_isSet;
}

bool OAIGetDataQualityResultResponse::is_job_name_Valid() const{
    return m_job_name_isValid;
}

QString OAIGetDataQualityResultResponse::getJobRunId() const {
    return m_job_run_id;
}
void OAIGetDataQualityResultResponse::setJobRunId(const QString &job_run_id) {
    m_job_run_id = job_run_id;
    m_job_run_id_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_job_run_id_Set() const{
    return m_job_run_id_isSet;
}

bool OAIGetDataQualityResultResponse::is_job_run_id_Valid() const{
    return m_job_run_id_isValid;
}

QString OAIGetDataQualityResultResponse::getRulesetEvaluationRunId() const {
    return m_ruleset_evaluation_run_id;
}
void OAIGetDataQualityResultResponse::setRulesetEvaluationRunId(const QString &ruleset_evaluation_run_id) {
    m_ruleset_evaluation_run_id = ruleset_evaluation_run_id;
    m_ruleset_evaluation_run_id_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_ruleset_evaluation_run_id_Set() const{
    return m_ruleset_evaluation_run_id_isSet;
}

bool OAIGetDataQualityResultResponse::is_ruleset_evaluation_run_id_Valid() const{
    return m_ruleset_evaluation_run_id_isValid;
}

QList OAIGetDataQualityResultResponse::getRuleResults() const {
    return m_rule_results;
}
void OAIGetDataQualityResultResponse::setRuleResults(const QList &rule_results) {
    m_rule_results = rule_results;
    m_rule_results_isSet = true;
}

bool OAIGetDataQualityResultResponse::is_rule_results_Set() const{
    return m_rule_results_isSet;
}

bool OAIGetDataQualityResultResponse::is_rule_results_Valid() const{
    return m_rule_results_isValid;
}

bool OAIGetDataQualityResultResponse::isSet() const {
...
bool OAIGetDataQualityResultResponse::isValid() const {
