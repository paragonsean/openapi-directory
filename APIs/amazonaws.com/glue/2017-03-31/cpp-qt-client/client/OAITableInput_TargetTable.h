...
/*
 * OAITableInput_TargetTable.h
 *
 * 
 */

#ifndef OAITableInput_TargetTable_H
#define OAITableInput_TargetTable_H
...
class OAITableInput_TargetTable : public OAIObject {
public:
    OAITableInput_TargetTable();
    OAITableInput_TargetTable(QString json);
    ~OAITableInput_TargetTable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableInput_TargetTable)

#endif // OAITableInput_TargetTable_H
