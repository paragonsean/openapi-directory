...
OAITaskType OAITaskRunProperties::getTaskType() const {
    return m_task_type;
}
void OAITaskRunProperties::setTaskType(const OAITaskType &task_type) {
    m_task_type = task_type;
    m_task_type_isSet = true;
}

bool OAITaskRunProperties::is_task_type_Set() const{
    return m_task_type_isSet;
}

bool OAITaskRunProperties::is_task_type_Valid() const{
    return m_task_type_isValid;
}

OAITaskRunProperties_ImportLabelsTaskRunProperties OAITaskRunProperties::getImportLabelsTaskRunProperties() const {
    return m_import_labels_task_run_properties;
}
void OAITaskRunProperties::setImportLabelsTaskRunProperties(const OAITaskRunProperties_ImportLabelsTaskRunProperties &import_labels_task_run_properties) {
    m_import_labels_task_run_properties = import_labels_task_run_properties;
    m_import_labels_task_run_properties_isSet = true;
}

bool OAITaskRunProperties::is_import_labels_task_run_properties_Set() const{
    return m_import_labels_task_run_properties_isSet;
}

bool OAITaskRunProperties::is_import_labels_task_run_properties_Valid() const{
    return m_import_labels_task_run_properties_isValid;
}

OAITaskRunProperties_ExportLabelsTaskRunProperties OAITaskRunProperties::getExportLabelsTaskRunProperties() const {
    return m_export_labels_task_run_properties;
}
void OAITaskRunProperties::setExportLabelsTaskRunProperties(const OAITaskRunProperties_ExportLabelsTaskRunProperties &export_labels_task_run_properties) {
    m_export_labels_task_run_properties = export_labels_task_run_properties;
    m_export_labels_task_run_properties_isSet = true;
}

bool OAITaskRunProperties::is_export_labels_task_run_properties_Set() const{
    return m_export_labels_task_run_properties_isSet;
}

bool OAITaskRunProperties::is_export_labels_task_run_properties_Valid() const{
    return m_export_labels_task_run_properties_isValid;
}

OAITaskRunProperties_LabelingSetGenerationTaskRunProperties OAITaskRunProperties::getLabelingSetGenerationTaskRunProperties() const {
    return m_labeling_set_generation_task_run_properties;
}
void OAITaskRunProperties::setLabelingSetGenerationTaskRunProperties(const OAITaskRunProperties_LabelingSetGenerationTaskRunProperties &labeling_set_generation_task_run_properties) {
...
bool OAITaskRunProperties::is_labeling_set_generation_task_run_properties_Set() const{
    return m_labeling_set_generation_task_run_properties_isSet;
}

bool OAITaskRunProperties::is_labeling_set_generation_task_run_properties_Valid() const{
    return m_labeling_set_generation_task_run_properties_isValid;
}

OAITaskRunProperties_FindMatchesTaskRunProperties OAITaskRunProperties::getFindMatchesTaskRunProperties() const {
    return m_find_matches_task_run_properties;
}
void OAITaskRunProperties::setFindMatchesTaskRunProperties(const OAITaskRunProperties_FindMatchesTaskRunProperties &find_matches_task_run_properties) {
    m_find_matches_task_run_properties = find_matches_task_run_properties;
    m_find_matches_task_run_properties_isSet = true;
}

bool OAITaskRunProperties::is_find_matches_task_run_properties_Set() const{
    return m_find_matches_task_run_properties_isSet;
}

bool OAITaskRunProperties::is_find_matches_task_run_properties_Valid() const{
