...
/*
 * OAIJDBCConnectorSource_AdditionalOptions.h
 *
 * 
 */

#ifndef OAIJDBCConnectorSource_AdditionalOptions_H
#define OAIJDBCConnectorSource_AdditionalOptions_H
...
class OAIJDBCConnectorSource_AdditionalOptions : public OAIObject {
public:
    OAIJDBCConnectorSource_AdditionalOptions();
    OAIJDBCConnectorSource_AdditionalOptions(QString json);
    ~OAIJDBCConnectorSource_AdditionalOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJDBCConnectorSource_AdditionalOptions)

#endif // OAIJDBCConnectorSource_AdditionalOptions_H
