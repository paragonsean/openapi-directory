...
/*
 * OAICreateConnectionRequest_ConnectionInput.h
 *
 * 
 */

#ifndef OAICreateConnectionRequest_ConnectionInput_H
#define OAICreateConnectionRequest_ConnectionInput_H
...
namespace OpenAPI {
class OAIConnectionInput_PhysicalConnectionRequirements;

class OAICreateConnectionRequest_ConnectionInput : public OAIObject {
public:
    OAICreateConnectionRequest_ConnectionInput();
    OAICreateConnectionRequest_ConnectionInput(QString json);
    ~OAICreateConnectionRequest_ConnectionInput() override;
    ...
    OAIConnectionInput_PhysicalConnectionRequirements getPhysicalConnectionRequirements() const;
    void setPhysicalConnectionRequirements(const OAIConnectionInput_PhysicalConnectionRequirements &physical_connection_requirements);
...
private:
    ...
    OAIConnectionInput_PhysicalConnectionRequirements m_physical_connection_requirements;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConnectionRequest_ConnectionInput)

#endif // OAICreateConnectionRequest_ConnectionInput_H
