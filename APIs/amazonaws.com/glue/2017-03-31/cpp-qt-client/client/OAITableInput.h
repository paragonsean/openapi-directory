...
#ifndef OAITableInput_H
#define OAITableInput_H
...
class OAITableInput : public OAIObject {
public:
    OAITableInput();
    OAITableInput(QString json);
    ~OAITableInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableInput)

#endif // OAITableInput_H
