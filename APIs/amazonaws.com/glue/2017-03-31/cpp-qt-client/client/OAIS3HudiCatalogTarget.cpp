...
#include "OAIS3HudiCatalogTarget.h"
...
OAIS3HudiCatalogTarget::OAIS3HudiCatalogTarget(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3HudiCatalogTarget::OAIS3HudiCatalogTarget() {
    this->initializeModel();
}

OAIS3HudiCatalogTarget::~OAIS3HudiCatalogTarget() {}

void OAIS3HudiCatalogTarget::initializeModel() {
...
void OAIS3HudiCatalogTarget::fromJson(QString jsonString) {
...
void OAIS3HudiCatalogTarget::fromJsonObject(QJsonObject json) {
...
QString OAIS3HudiCatalogTarget::asJson() const {
...
QJsonObject OAIS3HudiCatalogTarget::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIS3HudiCatalogTarget::getName() const {
    return m_name;
}
void OAIS3HudiCatalogTarget::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIS3HudiCatalogTarget::is_name_Set() const{
    return m_name_isSet;
}

bool OAIS3HudiCatalogTarget::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIS3HudiCatalogTarget::getInputs() const {
    return m_inputs;
}
void OAIS3HudiCatalogTarget::setInputs(const QList &inputs) {
    m_inputs = inputs;
    m_inputs_isSet = true;
}

bool OAIS3HudiCatalogTarget::is_inputs_Set() const{
    return m_inputs_isSet;
}

bool OAIS3HudiCatalogTarget::is_inputs_Valid() const{
    return m_inputs_isValid;
}

QList OAIS3HudiCatalogTarget::getPartitionKeys() const {
    return m_partition_keys;
}
void OAIS3HudiCatalogTarget::setPartitionKeys(const QList &partition_keys) {
    m_partition_keys = partition_keys;
    m_partition_keys_isSet = true;
}

bool OAIS3HudiCatalogTarget::is_partition_keys_Set() const{
    return m_partition_keys_isSet;
}

bool OAIS3HudiCatalogTarget::is_partition_keys_Valid() const{
    return m_partition_keys_isValid;
}

QString OAIS3HudiCatalogTarget::getTable() const {
    return m_table;
}
void OAIS3HudiCatalogTarget::setTable(const QString &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAIS3HudiCatalogTarget::is_table_Set() const{
    return m_table_isSet;
}

bool OAIS3HudiCatalogTarget::is_table_Valid() const{
    return m_table_isValid;
}

QString OAIS3HudiCatalogTarget::getDatabase() const {
    return m_database;
}
void OAIS3HudiCatalogTarget::setDatabase(const QString &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAIS3HudiCatalogTarget::is_database_Set() const{
    return m_database_isSet;
}

bool OAIS3HudiCatalogTarget::is_database_Valid() const{
    return m_database_isValid;
}

QMap OAIS3HudiCatalogTarget::getAdditionalOptions() const {
    return m_additional_options;
}
void OAIS3HudiCatalogTarget::setAdditionalOptions(const QMap &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAIS3HudiCatalogTarget::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAIS3HudiCatalogTarget::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

OAIS3CatalogTarget_SchemaChangePolicy OAIS3HudiCatalogTarget::getSchemaChangePolicy() const {
    return m_schema_change_policy;
}
void OAIS3HudiCatalogTarget::setSchemaChangePolicy(const OAIS3CatalogTarget_SchemaChangePolicy &schema_change_policy) {
    m_schema_change_policy = schema_change_policy;
    m_schema_change_policy_isSet = true;
}

bool OAIS3HudiCatalogTarget::is_schema_change_policy_Set() const{
    return m_schema_change_policy_isSet;
}

bool OAIS3HudiCatalogTarget::is_schema_change_policy_Valid() const{
    return m_schema_change_policy_isValid;
}

bool OAIS3HudiCatalogTarget::isSet() const {
...
bool OAIS3HudiCatalogTarget::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_inputs_isValid && m_table_isValid && m_database_isValid && m_additional_options_isValid && true;
}
