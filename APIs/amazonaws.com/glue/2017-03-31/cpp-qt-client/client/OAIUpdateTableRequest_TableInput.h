...
/*
 * OAIUpdateTableRequest_TableInput.h
 *
 * 
 */

#ifndef OAIUpdateTableRequest_TableInput_H
#define OAIUpdateTableRequest_TableInput_H
...
class OAIUpdateTableRequest_TableInput : public OAIObject {
public:
    OAIUpdateTableRequest_TableInput();
    OAIUpdateTableRequest_TableInput(QString json);
    ~OAIUpdateTableRequest_TableInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableRequest_TableInput)

#endif // OAIUpdateTableRequest_TableInput_H
