...
OAIClassifier_CsvClassifier::OAIClassifier_CsvClassifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClassifier_CsvClassifier::OAIClassifier_CsvClassifier() {
    this->initializeModel();
}

OAIClassifier_CsvClassifier::~OAIClassifier_CsvClassifier() {}

void OAIClassifier_CsvClassifier::initializeModel() {
...
void OAIClassifier_CsvClassifier::fromJson(QString jsonString) {
...
void OAIClassifier_CsvClassifier::fromJsonObject(QJsonObject json) {
...
QString OAIClassifier_CsvClassifier::asJson() const {
...
QJsonObject OAIClassifier_CsvClassifier::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIClassifier_CsvClassifier::getName() const {
    return m_name;
}
void OAIClassifier_CsvClassifier::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_name_Set() const{
    return m_name_isSet;
}

bool OAIClassifier_CsvClassifier::is_name_Valid() const{
    return m_name_isValid;
}

QDateTime OAIClassifier_CsvClassifier::getCreationTime() const {
    return m_creation_time;
}
void OAIClassifier_CsvClassifier::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIClassifier_CsvClassifier::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAIClassifier_CsvClassifier::getLastUpdated() const {
    return m_last_updated;
}
void OAIClassifier_CsvClassifier::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIClassifier_CsvClassifier::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

qint32 OAIClassifier_CsvClassifier::getVersion() const {
    return m_version;
}
void OAIClassifier_CsvClassifier::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_version_Set() const{
    return m_version_isSet;
}

bool OAIClassifier_CsvClassifier::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIClassifier_CsvClassifier::getDelimiter() const {
    return m_delimiter;
}
void OAIClassifier_CsvClassifier::setDelimiter(const QString &delimiter) {
    m_delimiter = delimiter;
    m_delimiter_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_delimiter_Set() const{
    return m_delimiter_isSet;
}

bool OAIClassifier_CsvClassifier::is_delimiter_Valid() const{
    return m_delimiter_isValid;
}

QString OAIClassifier_CsvClassifier::getQuoteSymbol() const {
    return m_quote_symbol;
}
void OAIClassifier_CsvClassifier::setQuoteSymbol(const QString &quote_symbol) {
    m_quote_symbol = quote_symbol;
    m_quote_symbol_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_quote_symbol_Set() const{
    return m_quote_symbol_isSet;
}

bool OAIClassifier_CsvClassifier::is_quote_symbol_Valid() const{
    return m_quote_symbol_isValid;
}

OAICsvHeaderOption OAIClassifier_CsvClassifier::getContainsHeader() const {
    return m_contains_header;
}
void OAIClassifier_CsvClassifier::setContainsHeader(const OAICsvHeaderOption &contains_header) {
    m_contains_header = contains_header;
    m_contains_header_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_contains_header_Set() const{
    return m_contains_header_isSet;
}

bool OAIClassifier_CsvClassifier::is_contains_header_Valid() const{
    return m_contains_header_isValid;
}

QList OAIClassifier_CsvClassifier::getHeader() const {
    return m_header;
}
void OAIClassifier_CsvClassifier::setHeader(const QList &header) {
    m_header = header;
    m_header_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_header_Set() const{
    return m_header_isSet;
}

bool OAIClassifier_CsvClassifier::is_header_Valid() const{
    return m_header_isValid;
}

bool OAIClassifier_CsvClassifier::getDisableValueTrimming() const {
    return m_disable_value_trimming;
}
void OAIClassifier_CsvClassifier::setDisableValueTrimming(const bool &disable_value_trimming) {
    m_disable_value_trimming = disable_value_trimming;
    m_disable_value_trimming_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_disable_value_trimming_Set() const{
    return m_disable_value_trimming_isSet;
}

bool OAIClassifier_CsvClassifier::is_disable_value_trimming_Valid() const{
    return m_disable_value_trimming_isValid;
}

bool OAIClassifier_CsvClassifier::getAllowSingleColumn() const {
    return m_allow_single_column;
}
void OAIClassifier_CsvClassifier::setAllowSingleColumn(const bool &allow_single_column) {
    m_allow_single_column = allow_single_column;
    m_allow_single_column_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_allow_single_column_Set() const{
    return m_allow_single_column_isSet;
}

bool OAIClassifier_CsvClassifier::is_allow_single_column_Valid() const{
    return m_allow_single_column_isValid;
}

bool OAIClassifier_CsvClassifier::getCustomDatatypeConfigured() const {
    return m_custom_datatype_configured;
}
void OAIClassifier_CsvClassifier::setCustomDatatypeConfigured(const bool &custom_datatype_configured) {
    m_custom_datatype_configured = custom_datatype_configured;
    m_custom_datatype_configured_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_custom_datatype_configured_Set() const{
    return m_custom_datatype_configured_isSet;
}

bool OAIClassifier_CsvClassifier::is_custom_datatype_configured_Valid() const{
    return m_custom_datatype_configured_isValid;
}

QList OAIClassifier_CsvClassifier::getCustomDatatypes() const {
    return m_custom_datatypes;
}
void OAIClassifier_CsvClassifier::setCustomDatatypes(const QList &custom_datatypes) {
    m_custom_datatypes = custom_datatypes;
    m_custom_datatypes_isSet = true;
}

bool OAIClassifier_CsvClassifier::is_custom_datatypes_Set() const{
    return m_custom_datatypes_isSet;
}

bool OAIClassifier_CsvClassifier::is_custom_datatypes_Valid() const{
    return m_custom_datatypes_isValid;
}

bool OAIClassifier_CsvClassifier::isSet() const {
...
bool OAIClassifier_CsvClassifier::isValid() const {
