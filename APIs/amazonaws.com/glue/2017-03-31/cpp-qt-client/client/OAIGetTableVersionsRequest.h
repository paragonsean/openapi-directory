...
/*
 * OAIGetTableVersionsRequest.h
 *
 * 
 */

#ifndef OAIGetTableVersionsRequest_H
#define OAIGetTableVersionsRequest_H
...
class OAIGetTableVersionsRequest : public OAIObject {
public:
    OAIGetTableVersionsRequest();
    OAIGetTableVersionsRequest(QString json);
    ~OAIGetTableVersionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableVersionsRequest)

#endif // OAIGetTableVersionsRequest_H
