...
OAICodeGenConfigurationNode_S3JsonSource::OAICodeGenConfigurationNode_S3JsonSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICodeGenConfigurationNode_S3JsonSource::OAICodeGenConfigurationNode_S3JsonSource() {
    this->initializeModel();
}

OAICodeGenConfigurationNode_S3JsonSource::~OAICodeGenConfigurationNode_S3JsonSource() {}

void OAICodeGenConfigurationNode_S3JsonSource::initializeModel() {
...
void OAICodeGenConfigurationNode_S3JsonSource::fromJson(QString jsonString) {
...
void OAICodeGenConfigurationNode_S3JsonSource::fromJsonObject(QJsonObject json) {
...
QString OAICodeGenConfigurationNode_S3JsonSource::asJson() const {
...
QJsonObject OAICodeGenConfigurationNode_S3JsonSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICodeGenConfigurationNode_S3JsonSource::getName() const {
    return m_name;
}
void OAICodeGenConfigurationNode_S3JsonSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICodeGenConfigurationNode_S3JsonSource::getPaths() const {
    return m_paths;
}
void OAICodeGenConfigurationNode_S3JsonSource::setPaths(const QList &paths) {
    m_paths = paths;
    m_paths_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_paths_Set() const{
    return m_paths_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_paths_Valid() const{
    return m_paths_isValid;
}

OAICompressionType OAICodeGenConfigurationNode_S3JsonSource::getCompressionType() const {
    return m_compression_type;
}
void OAICodeGenConfigurationNode_S3JsonSource::setCompressionType(const OAICompressionType &compression_type) {
    m_compression_type = compression_type;
    m_compression_type_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_compression_type_Set() const{
    return m_compression_type_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_compression_type_Valid() const{
    return m_compression_type_isValid;
}

QList OAICodeGenConfigurationNode_S3JsonSource::getExclusions() const {
    return m_exclusions;
}
void OAICodeGenConfigurationNode_S3JsonSource::setExclusions(const QList &exclusions) {
    m_exclusions = exclusions;
    m_exclusions_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_exclusions_Set() const{
    return m_exclusions_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_exclusions_Valid() const{
    return m_exclusions_isValid;
}

QString OAICodeGenConfigurationNode_S3JsonSource::getGroupSize() const {
    return m_group_size;
}
void OAICodeGenConfigurationNode_S3JsonSource::setGroupSize(const QString &group_size) {
    m_group_size = group_size;
    m_group_size_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_group_size_Set() const{
    return m_group_size_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_group_size_Valid() const{
    return m_group_size_isValid;
}

QString OAICodeGenConfigurationNode_S3JsonSource::getGroupFiles() const {
    return m_group_files;
}
void OAICodeGenConfigurationNode_S3JsonSource::setGroupFiles(const QString &group_files) {
    m_group_files = group_files;
    m_group_files_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_group_files_Set() const{
    return m_group_files_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_group_files_Valid() const{
    return m_group_files_isValid;
}

bool OAICodeGenConfigurationNode_S3JsonSource::getRecurse() const {
    return m_recurse;
}
void OAICodeGenConfigurationNode_S3JsonSource::setRecurse(const bool &recurse) {
    m_recurse = recurse;
    m_recurse_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_recurse_Set() const{
    return m_recurse_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_recurse_Valid() const{
    return m_recurse_isValid;
}

qint32 OAICodeGenConfigurationNode_S3JsonSource::getMaxBand() const {
    return m_max_band;
}
void OAICodeGenConfigurationNode_S3JsonSource::setMaxBand(const qint32 &max_band) {
    m_max_band = max_band;
    m_max_band_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_max_band_Set() const{
    return m_max_band_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_max_band_Valid() const{
    return m_max_band_isValid;
}

qint32 OAICodeGenConfigurationNode_S3JsonSource::getMaxFilesInBand() const {
    return m_max_files_in_band;
}
void OAICodeGenConfigurationNode_S3JsonSource::setMaxFilesInBand(const qint32 &max_files_in_band) {
    m_max_files_in_band = max_files_in_band;
    m_max_files_in_band_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_max_files_in_band_Set() const{
    return m_max_files_in_band_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_max_files_in_band_Valid() const{
    return m_max_files_in_band_isValid;
}

OAIS3CsvSource_AdditionalOptions OAICodeGenConfigurationNode_S3JsonSource::getAdditionalOptions() const {
    return m_additional_options;
}
void OAICodeGenConfigurationNode_S3JsonSource::setAdditionalOptions(const OAIS3CsvSource_AdditionalOptions &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

QString OAICodeGenConfigurationNode_S3JsonSource::getJsonPath() const {
    return m_json_path;
}
void OAICodeGenConfigurationNode_S3JsonSource::setJsonPath(const QString &json_path) {
    m_json_path = json_path;
    m_json_path_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_json_path_Set() const{
    return m_json_path_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_json_path_Valid() const{
    return m_json_path_isValid;
}

bool OAICodeGenConfigurationNode_S3JsonSource::getMultiline() const {
    return m_multiline;
}
void OAICodeGenConfigurationNode_S3JsonSource::setMultiline(const bool &multiline) {
    m_multiline = multiline;
    m_multiline_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_multiline_Set() const{
    return m_multiline_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_multiline_Valid() const{
    return m_multiline_isValid;
}

QList OAICodeGenConfigurationNode_S3JsonSource::getOutputSchemas() const {
    return m_output_schemas;
}
void OAICodeGenConfigurationNode_S3JsonSource::setOutputSchemas(const QList &output_schemas) {
    m_output_schemas = output_schemas;
    m_output_schemas_isSet = true;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_output_schemas_Set() const{
    return m_output_schemas_isSet;
}

bool OAICodeGenConfigurationNode_S3JsonSource::is_output_schemas_Valid() const{
    return m_output_schemas_isValid;
}

bool OAICodeGenConfigurationNode_S3JsonSource::isSet() const {
...
bool OAICodeGenConfigurationNode_S3JsonSource::isValid() const {
