...
#include "OAICatalogKafkaSource.h"
...
OAICatalogKafkaSource::OAICatalogKafkaSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICatalogKafkaSource::OAICatalogKafkaSource() {
    this->initializeModel();
}

OAICatalogKafkaSource::~OAICatalogKafkaSource() {}

void OAICatalogKafkaSource::initializeModel() {
...
void OAICatalogKafkaSource::fromJson(QString jsonString) {
...
void OAICatalogKafkaSource::fromJsonObject(QJsonObject json) {
...
QString OAICatalogKafkaSource::asJson() const {
...
QJsonObject OAICatalogKafkaSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICatalogKafkaSource::getName() const {
    return m_name;
}
void OAICatalogKafkaSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICatalogKafkaSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAICatalogKafkaSource::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICatalogKafkaSource::getWindowSize() const {
    return m_window_size;
}
void OAICatalogKafkaSource::setWindowSize(const qint32 &window_size) {
    m_window_size = window_size;
    m_window_size_isSet = true;
}

bool OAICatalogKafkaSource::is_window_size_Set() const{
    return m_window_size_isSet;
}

bool OAICatalogKafkaSource::is_window_size_Valid() const{
    return m_window_size_isValid;
}

bool OAICatalogKafkaSource::getDetectSchema() const {
    return m_detect_schema;
}
void OAICatalogKafkaSource::setDetectSchema(const bool &detect_schema) {
    m_detect_schema = detect_schema;
    m_detect_schema_isSet = true;
}

bool OAICatalogKafkaSource::is_detect_schema_Set() const{
    return m_detect_schema_isSet;
}

bool OAICatalogKafkaSource::is_detect_schema_Valid() const{
    return m_detect_schema_isValid;
}

QString OAICatalogKafkaSource::getTable() const {
    return m_table;
}
void OAICatalogKafkaSource::setTable(const QString &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAICatalogKafkaSource::is_table_Set() const{
    return m_table_isSet;
}

bool OAICatalogKafkaSource::is_table_Valid() const{
    return m_table_isValid;
}

QString OAICatalogKafkaSource::getDatabase() const {
    return m_database;
}
void OAICatalogKafkaSource::setDatabase(const QString &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAICatalogKafkaSource::is_database_Set() const{
    return m_database_isSet;
}

bool OAICatalogKafkaSource::is_database_Valid() const{
    return m_database_isValid;
}

OAICatalogKafkaSource_StreamingOptions OAICatalogKafkaSource::getStreamingOptions() const {
    return m_streaming_options;
}
void OAICatalogKafkaSource::setStreamingOptions(const OAICatalogKafkaSource_StreamingOptions &streaming_options) {
    m_streaming_options = streaming_options;
    m_streaming_options_isSet = true;
}

bool OAICatalogKafkaSource::is_streaming_options_Set() const{
    return m_streaming_options_isSet;
}

bool OAICatalogKafkaSource::is_streaming_options_Valid() const{
    return m_streaming_options_isValid;
}

OAICatalogKafkaSource_DataPreviewOptions OAICatalogKafkaSource::getDataPreviewOptions() const {
    return m_data_preview_options;
}
void OAICatalogKafkaSource::setDataPreviewOptions(const OAICatalogKafkaSource_DataPreviewOptions &data_preview_options) {
    m_data_preview_options = data_preview_options;
    m_data_preview_options_isSet = true;
}

bool OAICatalogKafkaSource::is_data_preview_options_Set() const{
    return m_data_preview_options_isSet;
}

bool OAICatalogKafkaSource::is_data_preview_options_Valid() const{
    return m_data_preview_options_isValid;
}

bool OAICatalogKafkaSource::isSet() const {
...
bool OAICatalogKafkaSource::isValid() const {
