...
/*
 * OAISparkConnectorTarget.h
 *
 * Specifies a target that uses an Apache Spark connector.
 */

#ifndef OAISparkConnectorTarget_H
#define OAISparkConnectorTarget_H
...
class OAISparkConnectorTarget : public OAIObject {
public:
    OAISparkConnectorTarget();
    OAISparkConnectorTarget(QString json);
    ~OAISparkConnectorTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISparkConnectorTarget)

#endif // OAISparkConnectorTarget_H
