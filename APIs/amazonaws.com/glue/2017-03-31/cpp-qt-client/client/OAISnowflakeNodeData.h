...
/*
 * OAISnowflakeNodeData.h
 *
 * Specifies configuration for Snowflake nodes in Glue Studio.
 */

#ifndef OAISnowflakeNodeData_H
#define OAISnowflakeNodeData_H
...
class OAISnowflakeNodeData : public OAIObject {
public:
    OAISnowflakeNodeData();
    OAISnowflakeNodeData(QString json);
    ~OAISnowflakeNodeData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnowflakeNodeData)

#endif // OAISnowflakeNodeData_H
