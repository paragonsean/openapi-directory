...
OAIS3HudiSource::OAIS3HudiSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3HudiSource::OAIS3HudiSource() {
    this->initializeModel();
}

OAIS3HudiSource::~OAIS3HudiSource() {}

void OAIS3HudiSource::initializeModel() {
...
void OAIS3HudiSource::fromJson(QString jsonString) {
...
void OAIS3HudiSource::fromJsonObject(QJsonObject json) {
...
QString OAIS3HudiSource::asJson() const {
...
QJsonObject OAIS3HudiSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIS3HudiSource::getName() const {
    return m_name;
}
void OAIS3HudiSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIS3HudiSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAIS3HudiSource::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIS3HudiSource::getPaths() const {
    return m_paths;
}
void OAIS3HudiSource::setPaths(const QList &paths) {
    m_paths = paths;
    m_paths_isSet = true;
}

bool OAIS3HudiSource::is_paths_Set() const{
    return m_paths_isSet;
}

bool OAIS3HudiSource::is_paths_Valid() const{
    return m_paths_isValid;
}

QMap OAIS3HudiSource::getAdditionalHudiOptions() const {
    return m_additional_hudi_options;
}
void OAIS3HudiSource::setAdditionalHudiOptions(const QMap &additional_hudi_options) {
    m_additional_hudi_options = additional_hudi_options;
    m_additional_hudi_options_isSet = true;
}

bool OAIS3HudiSource::is_additional_hudi_options_Set() const{
    return m_additional_hudi_options_isSet;
}

bool OAIS3HudiSource::is_additional_hudi_options_Valid() const{
    return m_additional_hudi_options_isValid;
}

OAIS3HudiSource_AdditionalOptions OAIS3HudiSource::getAdditionalOptions() const {
    return m_additional_options;
}
void OAIS3HudiSource::setAdditionalOptions(const OAIS3HudiSource_AdditionalOptions &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAIS3HudiSource::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAIS3HudiSource::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

QList OAIS3HudiSource::getOutputSchemas() const {
    return m_output_schemas;
}
void OAIS3HudiSource::setOutputSchemas(const QList &output_schemas) {
    m_output_schemas = output_schemas;
    m_output_schemas_isSet = true;
}

bool OAIS3HudiSource::is_output_schemas_Set() const{
    return m_output_schemas_isSet;
}

bool OAIS3HudiSource::is_output_schemas_Valid() const{
    return m_output_schemas_isValid;
}

bool OAIS3HudiSource::isSet() const {
...
bool OAIS3HudiSource::isValid() const {
