...
/*
 * OAIDeleteTableVersionRequest.h
 *
 * 
 */

#ifndef OAIDeleteTableVersionRequest_H
#define OAIDeleteTableVersionRequest_H
...
class OAIDeleteTableVersionRequest : public OAIObject {
public:
    OAIDeleteTableVersionRequest();
    OAIDeleteTableVersionRequest(QString json);
    ~OAIDeleteTableVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTableVersionRequest)

#endif // OAIDeleteTableVersionRequest_H
