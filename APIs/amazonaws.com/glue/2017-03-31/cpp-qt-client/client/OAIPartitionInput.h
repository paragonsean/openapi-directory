...
#ifndef OAIPartitionInput_H
#define OAIPartitionInput_H
...
class OAIPartitionInput : public OAIObject {
public:
    OAIPartitionInput();
    OAIPartitionInput(QString json);
    ~OAIPartitionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionInput)

#endif // OAIPartitionInput_H
