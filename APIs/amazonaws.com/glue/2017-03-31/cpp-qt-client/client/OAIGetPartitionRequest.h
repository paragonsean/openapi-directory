...
/*
 * OAIGetPartitionRequest.h
 *
 * 
 */

#ifndef OAIGetPartitionRequest_H
#define OAIGetPartitionRequest_H
...
class OAIGetPartitionRequest : public OAIObject {
public:
    OAIGetPartitionRequest();
    OAIGetPartitionRequest(QString json);
    ~OAIGetPartitionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPartitionRequest)

#endif // OAIGetPartitionRequest_H
