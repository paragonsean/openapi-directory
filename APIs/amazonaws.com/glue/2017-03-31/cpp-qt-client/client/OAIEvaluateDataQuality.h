...
/*
 * OAIEvaluateDataQuality.h
 *
 * Specifies your data quality evaluation criteria.
 */

#ifndef OAIEvaluateDataQuality_H
#define OAIEvaluateDataQuality_H
...
class OAIEvaluateDataQuality : public OAIObject {
public:
    OAIEvaluateDataQuality();
    OAIEvaluateDataQuality(QString json);
    ~OAIEvaluateDataQuality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluateDataQuality)

#endif // OAIEvaluateDataQuality_H
