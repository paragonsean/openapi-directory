...
#include "OAIGetJobResponse_Job.h"
...
OAIGetJobResponse_Job::OAIGetJobResponse_Job(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetJobResponse_Job::OAIGetJobResponse_Job() {
    this->initializeModel();
}

OAIGetJobResponse_Job::~OAIGetJobResponse_Job() {}

void OAIGetJobResponse_Job::initializeModel() {
...
void OAIGetJobResponse_Job::fromJson(QString jsonString) {
...
void OAIGetJobResponse_Job::fromJsonObject(QJsonObject json) {
...
QString OAIGetJobResponse_Job::asJson() const {
...
QJsonObject OAIGetJobResponse_Job::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIGetJobResponse_Job::getName() const {
    return m_name;
}
void OAIGetJobResponse_Job::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetJobResponse_Job::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetJobResponse_Job::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGetJobResponse_Job::getDescription() const {
    return m_description;
}
void OAIGetJobResponse_Job::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetJobResponse_Job::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetJobResponse_Job::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGetJobResponse_Job::getLogUri() const {
    return m_log_uri;
}
void OAIGetJobResponse_Job::setLogUri(const QString &log_uri) {
    m_log_uri = log_uri;
    m_log_uri_isSet = true;
}

bool OAIGetJobResponse_Job::is_log_uri_Set() const{
    return m_log_uri_isSet;
}

bool OAIGetJobResponse_Job::is_log_uri_Valid() const{
    return m_log_uri_isValid;
}

QString OAIGetJobResponse_Job::getRole() const {
    return m_role;
}
void OAIGetJobResponse_Job::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIGetJobResponse_Job::is_role_Set() const{
    return m_role_isSet;
}

bool OAIGetJobResponse_Job::is_role_Valid() const{
    return m_role_isValid;
}

QDateTime OAIGetJobResponse_Job::getCreatedOn() const {
    return m_created_on;
}
void OAIGetJobResponse_Job::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIGetJobResponse_Job::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIGetJobResponse_Job::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QDateTime OAIGetJobResponse_Job::getLastModifiedOn() const {
    return m_last_modified_on;
}
void OAIGetJobResponse_Job::setLastModifiedOn(const QDateTime &last_modified_on) {
    m_last_modified_on = last_modified_on;
    m_last_modified_on_isSet = true;
}

bool OAIGetJobResponse_Job::is_last_modified_on_Set() const{
    return m_last_modified_on_isSet;
}

bool OAIGetJobResponse_Job::is_last_modified_on_Valid() const{
    return m_last_modified_on_isValid;
}

OAICreateJobRequest_ExecutionProperty OAIGetJobResponse_Job::getExecutionProperty() const {
    return m_execution_property;
}
void OAIGetJobResponse_Job::setExecutionProperty(const OAICreateJobRequest_ExecutionProperty &execution_property) {
    m_execution_property = execution_property;
    m_execution_property_isSet = true;
}

bool OAIGetJobResponse_Job::is_execution_property_Set() const{
    return m_execution_property_isSet;
}

bool OAIGetJobResponse_Job::is_execution_property_Valid() const{
    return m_execution_property_isValid;
}

OAICreateJobRequest_Command OAIGetJobResponse_Job::getCommand() const {
    return m_command;
}
void OAIGetJobResponse_Job::setCommand(const OAICreateJobRequest_Command &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAIGetJobResponse_Job::is_command_Set() const{
    return m_command_isSet;
}

bool OAIGetJobResponse_Job::is_command_Valid() const{
    return m_command_isValid;
}

QMap OAIGetJobResponse_Job::getDefaultArguments() const {
    return m_default_arguments;
}
void OAIGetJobResponse_Job::setDefaultArguments(const QMap &default_arguments) {
    m_default_arguments = default_arguments;
    m_default_arguments_isSet = true;
}

bool OAIGetJobResponse_Job::is_default_arguments_Set() const{
    return m_default_arguments_isSet;
}

bool OAIGetJobResponse_Job::is_default_arguments_Valid() const{
    return m_default_arguments_isValid;
}

QMap OAIGetJobResponse_Job::getNonOverridableArguments() const {
    return m_non_overridable_arguments;
}
void OAIGetJobResponse_Job::setNonOverridableArguments(const QMap &non_overridable_arguments) {
    m_non_overridable_arguments = non_overridable_arguments;
    m_non_overridable_arguments_isSet = true;
}

bool OAIGetJobResponse_Job::is_non_overridable_arguments_Set() const{
    return m_non_overridable_arguments_isSet;
}

bool OAIGetJobResponse_Job::is_non_overridable_arguments_Valid() const{
    return m_non_overridable_arguments_isValid;
}

OAICreateJobRequest_Connections OAIGetJobResponse_Job::getConnections() const {
    return m_connections;
}
void OAIGetJobResponse_Job::setConnections(const OAICreateJobRequest_Connections &connections) {
    m_connections = connections;
    m_connections_isSet = true;
}

bool OAIGetJobResponse_Job::is_connections_Set() const{
    return m_connections_isSet;
}

bool OAIGetJobResponse_Job::is_connections_Valid() const{
    return m_connections_isValid;
}

qint32 OAIGetJobResponse_Job::getMaxRetries() const {
    return m_max_retries;
}
void OAIGetJobResponse_Job::setMaxRetries(const qint32 &max_retries) {
    m_max_retries = max_retries;
    m_max_retries_isSet = true;
}

bool OAIGetJobResponse_Job::is_max_retries_Set() const{
    return m_max_retries_isSet;
}

bool OAIGetJobResponse_Job::is_max_retries_Valid() const{
    return m_max_retries_isValid;
}

qint32 OAIGetJobResponse_Job::getAllocatedCapacity() const {
    return m_allocated_capacity;
}
void OAIGetJobResponse_Job::setAllocatedCapacity(const qint32 &allocated_capacity) {
    m_allocated_capacity = allocated_capacity;
    m_allocated_capacity_isSet = true;
}

bool OAIGetJobResponse_Job::is_allocated_capacity_Set() const{
    return m_allocated_capacity_isSet;
}

bool OAIGetJobResponse_Job::is_allocated_capacity_Valid() const{
    return m_allocated_capacity_isValid;
}

qint32 OAIGetJobResponse_Job::getTimeout() const {
    return m_timeout;
}
void OAIGetJobResponse_Job::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGetJobResponse_Job::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGetJobResponse_Job::is_timeout_Valid() const{
    return m_timeout_isValid;
}

double OAIGetJobResponse_Job::getMaxCapacity() const {
    return m_max_capacity;
}
void OAIGetJobResponse_Job::setMaxCapacity(const double &max_capacity) {
    m_max_capacity = max_capacity;
    m_max_capacity_isSet = true;
}

bool OAIGetJobResponse_Job::is_max_capacity_Set() const{
    return m_max_capacity_isSet;
}

bool OAIGetJobResponse_Job::is_max_capacity_Valid() const{
    return m_max_capacity_isValid;
}

OAIWorkerType OAIGetJobResponse_Job::getWorkerType() const {
    return m_worker_type;
}
void OAIGetJobResponse_Job::setWorkerType(const OAIWorkerType &worker_type) {
    m_worker_type = worker_type;
    m_worker_type_isSet = true;
}

bool OAIGetJobResponse_Job::is_worker_type_Set() const{
    return m_worker_type_isSet;
}

bool OAIGetJobResponse_Job::is_worker_type_Valid() const{
    return m_worker_type_isValid;
}

qint32 OAIGetJobResponse_Job::getNumberOfWorkers() const {
    return m_number_of_workers;
}
void OAIGetJobResponse_Job::setNumberOfWorkers(const qint32 &number_of_workers) {
    m_number_of_workers = number_of_workers;
    m_number_of_workers_isSet = true;
}

bool OAIGetJobResponse_Job::is_number_of_workers_Set() const{
    return m_number_of_workers_isSet;
}

bool OAIGetJobResponse_Job::is_number_of_workers_Valid() const{
    return m_number_of_workers_isValid;
}

QString OAIGetJobResponse_Job::getSecurityConfiguration() const {
    return m_security_configuration;
}
void OAIGetJobResponse_Job::setSecurityConfiguration(const QString &security_configuration) {
    m_security_configuration = security_configuration;
    m_security_configuration_isSet = true;
}

bool OAIGetJobResponse_Job::is_security_configuration_Set() const{
    return m_security_configuration_isSet;
}

bool OAIGetJobResponse_Job::is_security_configuration_Valid() const{
    return m_security_configuration_isValid;
}

OAICreateJobRequest_NotificationProperty OAIGetJobResponse_Job::getNotificationProperty() const {
    return m_notification_property;
}
void OAIGetJobResponse_Job::setNotificationProperty(const OAICreateJobRequest_NotificationProperty &notification_property) {
    m_notification_property = notification_property;
    m_notification_property_isSet = true;
}

bool OAIGetJobResponse_Job::is_notification_property_Set() const{
    return m_notification_property_isSet;
}

bool OAIGetJobResponse_Job::is_notification_property_Valid() const{
    return m_notification_property_isValid;
}

QString OAIGetJobResponse_Job::getGlueVersion() const {
    return m_glue_version;
}
void OAIGetJobResponse_Job::setGlueVersion(const QString &glue_version) {
    m_glue_version = glue_version;
    m_glue_version_isSet = true;
}

bool OAIGetJobResponse_Job::is_glue_version_Set() const{
    return m_glue_version_isSet;
}

bool OAIGetJobResponse_Job::is_glue_version_Valid() const{
    return m_glue_version_isValid;
}

QMap OAIGetJobResponse_Job::getCodeGenConfigurationNodes() const {
    return m_code_gen_configuration_nodes;
}
void OAIGetJobResponse_Job::setCodeGenConfigurationNodes(const QMap &code_gen_configuration_nodes) {
    m_code_gen_configuration_nodes = code_gen_configuration_nodes;
    m_code_gen_configuration_nodes_isSet = true;
}

bool OAIGetJobResponse_Job::is_code_gen_configuration_nodes_Set() const{
    return m_code_gen_configuration_nodes_isSet;
}

bool OAIGetJobResponse_Job::is_code_gen_configuration_nodes_Valid() const{
    return m_code_gen_configuration_nodes_isValid;
}

OAIExecutionClass OAIGetJobResponse_Job::getExecutionClass() const {
    return m_execution_class;
}
void OAIGetJobResponse_Job::setExecutionClass(const OAIExecutionClass &execution_class) {
    m_execution_class = execution_class;
    m_execution_class_isSet = true;
}

bool OAIGetJobResponse_Job::is_execution_class_Set() const{
    return m_execution_class_isSet;
}

bool OAIGetJobResponse_Job::is_execution_class_Valid() const{
    return m_execution_class_isValid;
}

OAICreateJobRequest_SourceControlDetails OAIGetJobResponse_Job::getSourceControlDetails() const {
    return m_source_control_details;
}
void OAIGetJobResponse_Job::setSourceControlDetails(const OAICreateJobRequest_SourceControlDetails &source_control_details) {
    m_source_control_details = source_control_details;
    m_source_control_details_isSet = true;
}

bool OAIGetJobResponse_Job::is_source_control_details_Set() const{
    return m_source_control_details_isSet;
}

bool OAIGetJobResponse_Job::is_source_control_details_Valid() const{
    return m_source_control_details_isValid;
}

bool OAIGetJobResponse_Job::isSet() const {
...
bool OAIGetJobResponse_Job::isValid() const {
