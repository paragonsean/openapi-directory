...
OAIDatabaseInput::OAIDatabaseInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseInput::OAIDatabaseInput() {
    this->initializeModel();
}

OAIDatabaseInput::~OAIDatabaseInput() {}

void OAIDatabaseInput::initializeModel() {
...
void OAIDatabaseInput::fromJson(QString jsonString) {
...
void OAIDatabaseInput::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseInput::asJson() const {
...
QJsonObject OAIDatabaseInput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDatabaseInput::getName() const {
    return m_name;
}
void OAIDatabaseInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDatabaseInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDatabaseInput::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDatabaseInput::getDescription() const {
    return m_description;
}
void OAIDatabaseInput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDatabaseInput::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDatabaseInput::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDatabaseInput::getLocationUri() const {
    return m_location_uri;
}
void OAIDatabaseInput::setLocationUri(const QString &location_uri) {
    m_location_uri = location_uri;
    m_location_uri_isSet = true;
}

bool OAIDatabaseInput::is_location_uri_Set() const{
    return m_location_uri_isSet;
}

bool OAIDatabaseInput::is_location_uri_Valid() const{
    return m_location_uri_isValid;
}

QMap OAIDatabaseInput::getParameters() const {
    return m_parameters;
}
void OAIDatabaseInput::setParameters(const QMap &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIDatabaseInput::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIDatabaseInput::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QList OAIDatabaseInput::getCreateTableDefaultPermissions() const {
    return m_create_table_default_permissions;
}
void OAIDatabaseInput::setCreateTableDefaultPermissions(const QList &create_table_default_permissions) {
    m_create_table_default_permissions = create_table_default_permissions;
    m_create_table_default_permissions_isSet = true;
}

bool OAIDatabaseInput::is_create_table_default_permissions_Set() const{
    return m_create_table_default_permissions_isSet;
}

bool OAIDatabaseInput::is_create_table_default_permissions_Valid() const{
    return m_create_table_default_permissions_isValid;
}

OAIDatabaseInput_TargetDatabase OAIDatabaseInput::getTargetDatabase() const {
    return m_target_database;
}
void OAIDatabaseInput::setTargetDatabase(const OAIDatabaseInput_TargetDatabase &target_database) {
    m_target_database = target_database;
    m_target_database_isSet = true;
}

bool OAIDatabaseInput::is_target_database_Set() const{
    return m_target_database_isSet;
}

bool OAIDatabaseInput::is_target_database_Valid() const{
    return m_target_database_isValid;
}

OAIDatabaseInput_FederatedDatabase OAIDatabaseInput::getFederatedDatabase() const {
    return m_federated_database;
}
void OAIDatabaseInput::setFederatedDatabase(const OAIDatabaseInput_FederatedDatabase &federated_database) {
    m_federated_database = federated_database;
    m_federated_database_isSet = true;
}

bool OAIDatabaseInput::is_federated_database_Set() const{
    return m_federated_database_isSet;
}

bool OAIDatabaseInput::is_federated_database_Valid() const{
    return m_federated_database_isValid;
}

bool OAIDatabaseInput::isSet() const {
...
bool OAIDatabaseInput::isValid() const {
