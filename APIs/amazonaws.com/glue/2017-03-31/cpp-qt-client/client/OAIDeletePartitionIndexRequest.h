...
/*
 * OAIDeletePartitionIndexRequest.h
 *
 * 
 */

#ifndef OAIDeletePartitionIndexRequest_H
#define OAIDeletePartitionIndexRequest_H
...
class OAIDeletePartitionIndexRequest : public OAIObject {
public:
    OAIDeletePartitionIndexRequest();
    OAIDeletePartitionIndexRequest(QString json);
    ~OAIDeletePartitionIndexRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePartitionIndexRequest)

#endif // OAIDeletePartitionIndexRequest_H
