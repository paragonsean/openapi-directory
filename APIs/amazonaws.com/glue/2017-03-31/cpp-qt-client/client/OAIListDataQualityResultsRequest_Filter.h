...
/*
 * OAIListDataQualityResultsRequest_Filter.h
 *
 * 
 */

#ifndef OAIListDataQualityResultsRequest_Filter_H
#define OAIListDataQualityResultsRequest_Filter_H
...
class OAIListDataQualityResultsRequest_Filter : public OAIObject {
public:
    OAIListDataQualityResultsRequest_Filter();
    OAIListDataQualityResultsRequest_Filter(QString json);
    ~OAIListDataQualityResultsRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDataQualityResultsRequest_Filter)

#endif // OAIListDataQualityResultsRequest_Filter_H
