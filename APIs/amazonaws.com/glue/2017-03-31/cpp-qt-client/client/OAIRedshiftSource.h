...
#ifndef OAIRedshiftSource_H
#define OAIRedshiftSource_H
...
class OAIRedshiftSource : public OAIObject {
public:
    OAIRedshiftSource();
    OAIRedshiftSource(QString json);
    ~OAIRedshiftSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedshiftSource)

#endif // OAIRedshiftSource_H
