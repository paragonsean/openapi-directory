...
/*
 * OAICodeGenConfigurationNode_S3HudiDirectTarget.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_S3HudiDirectTarget_H
#define OAICodeGenConfigurationNode_S3HudiDirectTarget_H
...
class OAICodeGenConfigurationNode_S3HudiDirectTarget : public OAIObject {
public:
    OAICodeGenConfigurationNode_S3HudiDirectTarget();
    OAICodeGenConfigurationNode_S3HudiDirectTarget(QString json);
    ~OAICodeGenConfigurationNode_S3HudiDirectTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_S3HudiDirectTarget)

#endif // OAICodeGenConfigurationNode_S3HudiDirectTarget_H
