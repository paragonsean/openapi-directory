...
OAISnowflakeSource_Data::OAISnowflakeSource_Data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISnowflakeSource_Data::OAISnowflakeSource_Data() {
    this->initializeModel();
}

OAISnowflakeSource_Data::~OAISnowflakeSource_Data() {}

void OAISnowflakeSource_Data::initializeModel() {
...
void OAISnowflakeSource_Data::fromJson(QString jsonString) {
...
void OAISnowflakeSource_Data::fromJsonObject(QJsonObject json) {
...
QString OAISnowflakeSource_Data::asJson() const {
...
QJsonObject OAISnowflakeSource_Data::asJsonObject() const {
    QJsonObject obj;
...
QString OAISnowflakeSource_Data::getSourceType() const {
    return m_source_type;
}
void OAISnowflakeSource_Data::setSourceType(const QString &source_type) {
    m_source_type = source_type;
    m_source_type_isSet = true;
}

bool OAISnowflakeSource_Data::is_source_type_Set() const{
    return m_source_type_isSet;
}

bool OAISnowflakeSource_Data::is_source_type_Valid() const{
    return m_source_type_isValid;
}

OAISnowflakeNodeData_Connection OAISnowflakeSource_Data::getConnection() const {
    return m_connection;
}
void OAISnowflakeSource_Data::setConnection(const OAISnowflakeNodeData_Connection &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAISnowflakeSource_Data::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAISnowflakeSource_Data::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAISnowflakeSource_Data::getSchema() const {
    return m_schema;
}
void OAISnowflakeSource_Data::setSchema(const QString &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAISnowflakeSource_Data::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAISnowflakeSource_Data::is_schema_Valid() const{
    return m_schema_isValid;
}

QString OAISnowflakeSource_Data::getTable() const {
    return m_table;
}
void OAISnowflakeSource_Data::setTable(const QString &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAISnowflakeSource_Data::is_table_Set() const{
    return m_table_isSet;
}

bool OAISnowflakeSource_Data::is_table_Valid() const{
    return m_table_isValid;
}

QString OAISnowflakeSource_Data::getDatabase() const {
    return m_database;
}
void OAISnowflakeSource_Data::setDatabase(const QString &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAISnowflakeSource_Data::is_database_Set() const{
    return m_database_isSet;
}

bool OAISnowflakeSource_Data::is_database_Valid() const{
    return m_database_isValid;
}

QString OAISnowflakeSource_Data::getTempDir() const {
    return m_temp_dir;
}
void OAISnowflakeSource_Data::setTempDir(const QString &temp_dir) {
    m_temp_dir = temp_dir;
    m_temp_dir_isSet = true;
}

bool OAISnowflakeSource_Data::is_temp_dir_Set() const{
    return m_temp_dir_isSet;
}

bool OAISnowflakeSource_Data::is_temp_dir_Valid() const{
    return m_temp_dir_isValid;
}

OAISnowflakeNodeData_IamRole OAISnowflakeSource_Data::getIamRole() const {
    return m_iam_role;
}
void OAISnowflakeSource_Data::setIamRole(const OAISnowflakeNodeData_IamRole &iam_role) {
    m_iam_role = iam_role;
    m_iam_role_isSet = true;
}

bool OAISnowflakeSource_Data::is_iam_role_Set() const{
    return m_iam_role_isSet;
}

bool OAISnowflakeSource_Data::is_iam_role_Valid() const{
    return m_iam_role_isValid;
}

QMap OAISnowflakeSource_Data::getAdditionalOptions() const {
    return m_additional_options;
}
void OAISnowflakeSource_Data::setAdditionalOptions(const QMap &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAISnowflakeSource_Data::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAISnowflakeSource_Data::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

QString OAISnowflakeSource_Data::getSampleQuery() const {
    return m_sample_query;
}
void OAISnowflakeSource_Data::setSampleQuery(const QString &sample_query) {
    m_sample_query = sample_query;
    m_sample_query_isSet = true;
}

bool OAISnowflakeSource_Data::is_sample_query_Set() const{
    return m_sample_query_isSet;
}

bool OAISnowflakeSource_Data::is_sample_query_Valid() const{
    return m_sample_query_isValid;
}

QString OAISnowflakeSource_Data::getPreAction() const {
    return m_pre_action;
}
void OAISnowflakeSource_Data::setPreAction(const QString &pre_action) {
    m_pre_action = pre_action;
    m_pre_action_isSet = true;
}

bool OAISnowflakeSource_Data::is_pre_action_Set() const{
    return m_pre_action_isSet;
}

bool OAISnowflakeSource_Data::is_pre_action_Valid() const{
    return m_pre_action_isValid;
}

QString OAISnowflakeSource_Data::getPostAction() const {
    return m_post_action;
}
void OAISnowflakeSource_Data::setPostAction(const QString &post_action) {
    m_post_action = post_action;
    m_post_action_isSet = true;
}

bool OAISnowflakeSource_Data::is_post_action_Set() const{
    return m_post_action_isSet;
}

bool OAISnowflakeSource_Data::is_post_action_Valid() const{
    return m_post_action_isValid;
}

QString OAISnowflakeSource_Data::getAction() const {
    return m_action;
}
void OAISnowflakeSource_Data::setAction(const QString &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAISnowflakeSource_Data::is_action_Set() const{
    return m_action_isSet;
}

bool OAISnowflakeSource_Data::is_action_Valid() const{
    return m_action_isValid;
}

bool OAISnowflakeSource_Data::getUpsert() const {
    return m_upsert;
}
void OAISnowflakeSource_Data::setUpsert(const bool &upsert) {
    m_upsert = upsert;
    m_upsert_isSet = true;
}

bool OAISnowflakeSource_Data::is_upsert_Set() const{
    return m_upsert_isSet;
}

bool OAISnowflakeSource_Data::is_upsert_Valid() const{
    return m_upsert_isValid;
}

QString OAISnowflakeSource_Data::getMergeAction() const {
    return m_merge_action;
}
void OAISnowflakeSource_Data::setMergeAction(const QString &merge_action) {
    m_merge_action = merge_action;
    m_merge_action_isSet = true;
}

bool OAISnowflakeSource_Data::is_merge_action_Set() const{
    return m_merge_action_isSet;
}

bool OAISnowflakeSource_Data::is_merge_action_Valid() const{
    return m_merge_action_isValid;
}

QString OAISnowflakeSource_Data::getMergeWhenMatched() const {
    return m_merge_when_matched;
}
void OAISnowflakeSource_Data::setMergeWhenMatched(const QString &merge_when_matched) {
    m_merge_when_matched = merge_when_matched;
    m_merge_when_matched_isSet = true;
}

bool OAISnowflakeSource_Data::is_merge_when_matched_Set() const{
    return m_merge_when_matched_isSet;
}

bool OAISnowflakeSource_Data::is_merge_when_matched_Valid() const{
    return m_merge_when_matched_isValid;
}

QString OAISnowflakeSource_Data::getMergeWhenNotMatched() const {
    return m_merge_when_not_matched;
}
void OAISnowflakeSource_Data::setMergeWhenNotMatched(const QString &merge_when_not_matched) {
    m_merge_when_not_matched = merge_when_not_matched;
    m_merge_when_not_matched_isSet = true;
}

bool OAISnowflakeSource_Data::is_merge_when_not_matched_Set() const{
    return m_merge_when_not_matched_isSet;
}

bool OAISnowflakeSource_Data::is_merge_when_not_matched_Valid() const{
    return m_merge_when_not_matched_isValid;
}

QString OAISnowflakeSource_Data::getMergeClause() const {
    return m_merge_clause;
}
void OAISnowflakeSource_Data::setMergeClause(const QString &merge_clause) {
    m_merge_clause = merge_clause;
    m_merge_clause_isSet = true;
}

bool OAISnowflakeSource_Data::is_merge_clause_Set() const{
    return m_merge_clause_isSet;
}

bool OAISnowflakeSource_Data::is_merge_clause_Valid() const{
    return m_merge_clause_isValid;
}

QString OAISnowflakeSource_Data::getStagingTable() const {
    return m_staging_table;
}
void OAISnowflakeSource_Data::setStagingTable(const QString &staging_table) {
    m_staging_table = staging_table;
    m_staging_table_isSet = true;
}

bool OAISnowflakeSource_Data::is_staging_table_Set() const{
    return m_staging_table_isSet;
}

bool OAISnowflakeSource_Data::is_staging_table_Valid() const{
    return m_staging_table_isValid;
}

QList OAISnowflakeSource_Data::getSelectedColumns() const {
    return m_selected_columns;
}
void OAISnowflakeSource_Data::setSelectedColumns(const QList &selected_columns) {
    m_selected_columns = selected_columns;
    m_selected_columns_isSet = true;
}

bool OAISnowflakeSource_Data::is_selected_columns_Set() const{
    return m_selected_columns_isSet;
}

bool OAISnowflakeSource_Data::is_selected_columns_Valid() const{
    return m_selected_columns_isValid;
}

bool OAISnowflakeSource_Data::getAutoPushdown() const {
    return m_auto_pushdown;
}
void OAISnowflakeSource_Data::setAutoPushdown(const bool &auto_pushdown) {
    m_auto_pushdown = auto_pushdown;
    m_auto_pushdown_isSet = true;
}

bool OAISnowflakeSource_Data::is_auto_pushdown_Set() const{
    return m_auto_pushdown_isSet;
}

bool OAISnowflakeSource_Data::is_auto_pushdown_Valid() const{
    return m_auto_pushdown_isValid;
}

QList OAISnowflakeSource_Data::getTableSchema() const {
    return m_table_schema;
}
void OAISnowflakeSource_Data::setTableSchema(const QList &table_schema) {
    m_table_schema = table_schema;
    m_table_schema_isSet = true;
}

bool OAISnowflakeSource_Data::is_table_schema_Set() const{
    return m_table_schema_isSet;
}

bool OAISnowflakeSource_Data::is_table_schema_Valid() const{
    return m_table_schema_isValid;
}

bool OAISnowflakeSource_Data::isSet() const {
...
bool OAISnowflakeSource_Data::isValid() const {
