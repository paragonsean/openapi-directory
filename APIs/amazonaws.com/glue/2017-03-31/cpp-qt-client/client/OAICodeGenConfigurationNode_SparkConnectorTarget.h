...
/*
 * OAICodeGenConfigurationNode_SparkConnectorTarget.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_SparkConnectorTarget_H
#define OAICodeGenConfigurationNode_SparkConnectorTarget_H
...
class OAICodeGenConfigurationNode_SparkConnectorTarget : public OAIObject {
public:
    OAICodeGenConfigurationNode_SparkConnectorTarget();
    OAICodeGenConfigurationNode_SparkConnectorTarget(QString json);
    ~OAICodeGenConfigurationNode_SparkConnectorTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_SparkConnectorTarget)

#endif // OAICodeGenConfigurationNode_SparkConnectorTarget_H
