...
/*
 * OAICreateDevEndpointResponse.h
 *
 * 
 */

#ifndef OAICreateDevEndpointResponse_H
#define OAICreateDevEndpointResponse_H
...
class OAICreateDevEndpointResponse : public OAIObject {
public:
    OAICreateDevEndpointResponse();
    OAICreateDevEndpointResponse(QString json);
    ~OAICreateDevEndpointResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDevEndpointResponse)

#endif // OAICreateDevEndpointResponse_H
