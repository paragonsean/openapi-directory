...
#ifndef OAIDevEndpoint_H
#define OAIDevEndpoint_H
...
class OAIDevEndpoint : public OAIObject {
public:
    OAIDevEndpoint();
    OAIDevEndpoint(QString json);
    ~OAIDevEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDevEndpoint)

#endif // OAIDevEndpoint_H
