...
QString OAIDatabase::getDescription() const {
    return m_description;
}
void OAIDatabase::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDatabase::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDatabase::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDatabase::getLocationUri() const {
    return m_location_uri;
}
void OAIDatabase::setLocationUri(const QString &location_uri) {
    m_location_uri = location_uri;
    m_location_uri_isSet = true;
}

bool OAIDatabase::is_location_uri_Set() const{
    return m_location_uri_isSet;
}

bool OAIDatabase::is_location_uri_Valid() const{
    return m_location_uri_isValid;
}

QMap OAIDatabase::getParameters() const {
    return m_parameters;
}
void OAIDatabase::setParameters(const QMap &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIDatabase::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIDatabase::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QDateTime OAIDatabase::getCreateTime() const {
    return m_create_time;
}
void OAIDatabase::setCreateTime(const QDateTime &create_time) {
...
QList OAIDatabase::getCreateTableDefaultPermissions() const {
    return m_create_table_default_permissions;
}
void OAIDatabase::setCreateTableDefaultPermissions(const QList &create_table_default_permissions) {
    m_create_table_default_permissions = create_table_default_permissions;
    m_create_table_default_permissions_isSet = true;
}

bool OAIDatabase::is_create_table_default_permissions_Set() const{
    return m_create_table_default_permissions_isSet;
}

bool OAIDatabase::is_create_table_default_permissions_Valid() const{
    return m_create_table_default_permissions_isValid;
}

OAIDatabaseInput_TargetDatabase OAIDatabase::getTargetDatabase() const {
    return m_target_database;
}
void OAIDatabase::setTargetDatabase(const OAIDatabaseInput_TargetDatabase &target_database) {
    m_target_database = target_database;
    m_target_database_isSet = true;
}

bool OAIDatabase::is_target_database_Set() const{
    return m_target_database_isSet;
}

bool OAIDatabase::is_target_database_Valid() const{
    return m_target_database_isValid;
}

QString OAIDatabase::getCatalogId() const {
    return m_catalog_id;
}
void OAIDatabase::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAIDatabase::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAIDatabase::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

OAIDatabaseInput_FederatedDatabase OAIDatabase::getFederatedDatabase() const {
    return m_federated_database;
}
void OAIDatabase::setFederatedDatabase(const OAIDatabaseInput_FederatedDatabase &federated_database) {
    m_federated_database = federated_database;
    m_federated_database_isSet = true;
}

bool OAIDatabase::is_federated_database_Set() const{
    return m_federated_database_isSet;
}

bool OAIDatabase::is_federated_database_Valid() const{
