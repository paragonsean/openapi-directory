...
/*
 * OAIDevEndpointCustomLibraries.h
 *
 * Custom libraries to be loaded into a development endpoint.
 */

#ifndef OAIDevEndpointCustomLibraries_H
#define OAIDevEndpointCustomLibraries_H
...
class OAIDevEndpointCustomLibraries : public OAIObject {
public:
    OAIDevEndpointCustomLibraries();
    OAIDevEndpointCustomLibraries(QString json);
    ~OAIDevEndpointCustomLibraries() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDevEndpointCustomLibraries)

#endif // OAIDevEndpointCustomLibraries_H
