...
/*
 * OAICodeGenConfigurationNode_S3JsonSource.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_S3JsonSource_H
#define OAICodeGenConfigurationNode_S3JsonSource_H
...
class OAICodeGenConfigurationNode_S3JsonSource : public OAIObject {
public:
    OAICodeGenConfigurationNode_S3JsonSource();
    OAICodeGenConfigurationNode_S3JsonSource(QString json);
    ~OAICodeGenConfigurationNode_S3JsonSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_S3JsonSource)

#endif // OAICodeGenConfigurationNode_S3JsonSource_H
