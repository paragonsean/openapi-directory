...
/*
 * OAIGetSchemaByDefinitionInput.h
 *
 * 
 */

#ifndef OAIGetSchemaByDefinitionInput_H
#define OAIGetSchemaByDefinitionInput_H
...
class OAIGetSchemaByDefinitionInput : public OAIObject {
public:
    OAIGetSchemaByDefinitionInput();
    OAIGetSchemaByDefinitionInput(QString json);
    ~OAIGetSchemaByDefinitionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSchemaByDefinitionInput)

#endif // OAIGetSchemaByDefinitionInput_H
