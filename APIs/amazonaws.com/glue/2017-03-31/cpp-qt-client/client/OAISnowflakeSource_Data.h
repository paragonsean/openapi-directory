...
/*
 * OAISnowflakeSource_Data.h
 *
 * 
 */

#ifndef OAISnowflakeSource_Data_H
#define OAISnowflakeSource_Data_H
...
class OAISnowflakeSource_Data : public OAIObject {
public:
    OAISnowflakeSource_Data();
    OAISnowflakeSource_Data(QString json);
    ~OAISnowflakeSource_Data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnowflakeSource_Data)

#endif // OAISnowflakeSource_Data_H
