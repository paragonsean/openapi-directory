...
/*
 * OAIUpdateClassifierRequest_CsvClassifier.h
 *
 * 
 */

#ifndef OAIUpdateClassifierRequest_CsvClassifier_H
#define OAIUpdateClassifierRequest_CsvClassifier_H
...
class OAIUpdateClassifierRequest_CsvClassifier : public OAIObject {
public:
    OAIUpdateClassifierRequest_CsvClassifier();
    OAIUpdateClassifierRequest_CsvClassifier(QString json);
    ~OAIUpdateClassifierRequest_CsvClassifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClassifierRequest_CsvClassifier)

#endif // OAIUpdateClassifierRequest_CsvClassifier_H
