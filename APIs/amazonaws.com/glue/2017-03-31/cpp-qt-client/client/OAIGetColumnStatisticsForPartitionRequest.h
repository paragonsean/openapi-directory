...
/*
 * OAIGetColumnStatisticsForPartitionRequest.h
 *
 * 
 */

#ifndef OAIGetColumnStatisticsForPartitionRequest_H
#define OAIGetColumnStatisticsForPartitionRequest_H
...
class OAIGetColumnStatisticsForPartitionRequest : public OAIObject {
public:
    OAIGetColumnStatisticsForPartitionRequest();
    OAIGetColumnStatisticsForPartitionRequest(QString json);
    ~OAIGetColumnStatisticsForPartitionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetColumnStatisticsForPartitionRequest)

#endif // OAIGetColumnStatisticsForPartitionRequest_H
