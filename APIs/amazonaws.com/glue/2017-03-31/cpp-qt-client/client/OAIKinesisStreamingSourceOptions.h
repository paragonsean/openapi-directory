...
/*
 * OAIKinesisStreamingSourceOptions.h
 *
 * Additional options for the Amazon Kinesis streaming data source.
 */

#ifndef OAIKinesisStreamingSourceOptions_H
#define OAIKinesisStreamingSourceOptions_H
...
class OAIKinesisStreamingSourceOptions : public OAIObject {
public:
    OAIKinesisStreamingSourceOptions();
    OAIKinesisStreamingSourceOptions(QString json);
    ~OAIKinesisStreamingSourceOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKinesisStreamingSourceOptions)

#endif // OAIKinesisStreamingSourceOptions_H
