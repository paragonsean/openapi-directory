...
QString OAIWorkflowRun::getWorkflowRunId() const {
    return m_workflow_run_id;
}
void OAIWorkflowRun::setWorkflowRunId(const QString &workflow_run_id) {
    m_workflow_run_id = workflow_run_id;
    m_workflow_run_id_isSet = true;
}

bool OAIWorkflowRun::is_workflow_run_id_Set() const{
    return m_workflow_run_id_isSet;
}

bool OAIWorkflowRun::is_workflow_run_id_Valid() const{
    return m_workflow_run_id_isValid;
}

QString OAIWorkflowRun::getPreviousRunId() const {
    return m_previous_run_id;
}
void OAIWorkflowRun::setPreviousRunId(const QString &previous_run_id) {
    m_previous_run_id = previous_run_id;
    m_previous_run_id_isSet = true;
}

bool OAIWorkflowRun::is_previous_run_id_Set() const{
    return m_previous_run_id_isSet;
}

bool OAIWorkflowRun::is_previous_run_id_Valid() const{
    return m_previous_run_id_isValid;
}

QMap OAIWorkflowRun::getWorkflowRunProperties() const {
    return m_workflow_run_properties;
}
void OAIWorkflowRun::setWorkflowRunProperties(const QMap &workflow_run_properties) {
    m_workflow_run_properties = workflow_run_properties;
    m_workflow_run_properties_isSet = true;
}

bool OAIWorkflowRun::is_workflow_run_properties_Set() const{
    return m_workflow_run_properties_isSet;
}

bool OAIWorkflowRun::is_workflow_run_properties_Valid() const{
    return m_workflow_run_properties_isValid;
}

QDateTime OAIWorkflowRun::getStartedOn() const {
    return m_started_on;
}
void OAIWorkflowRun::setStartedOn(const QDateTime &started_on) {
    m_started_on = started_on;
    m_started_on_isSet = true;
}

bool OAIWorkflowRun::is_started_on_Set() const{
    return m_started_on_isSet;
}

bool OAIWorkflowRun::is_started_on_Valid() const{
    return m_started_on_isValid;
}

QDateTime OAIWorkflowRun::getCompletedOn() const {
    return m_completed_on;
}
void OAIWorkflowRun::setCompletedOn(const QDateTime &completed_on) {
    m_completed_on = completed_on;
    m_completed_on_isSet = true;
}

bool OAIWorkflowRun::is_completed_on_Set() const{
    return m_completed_on_isSet;
}

bool OAIWorkflowRun::is_completed_on_Valid() const{
    return m_completed_on_isValid;
}

OAIWorkflowRunStatus OAIWorkflowRun::getStatus() const {
    return m_status;
}
void OAIWorkflowRun::setStatus(const OAIWorkflowRunStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWorkflowRun::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWorkflowRun::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIWorkflowRun::getErrorMessage() const {
    return m_error_message;
}
void OAIWorkflowRun::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIWorkflowRun::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIWorkflowRun::is_error_message_Valid() const{
    return m_error_message_isValid;
}

OAIWorkflowRun_Statistics OAIWorkflowRun::getStatistics() const {
    return m_statistics;
}
void OAIWorkflowRun::setStatistics(const OAIWorkflowRun_Statistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAIWorkflowRun::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAIWorkflowRun::is_statistics_Valid() const{
    return m_statistics_isValid;
}

OAIWorkflow_Graph OAIWorkflowRun::getGraph() const {
    return m_graph;
}
void OAIWorkflowRun::setGraph(const OAIWorkflow_Graph &graph) {
    m_graph = graph;
    m_graph_isSet = true;
}

bool OAIWorkflowRun::is_graph_Set() const{
    return m_graph_isSet;
}

bool OAIWorkflowRun::is_graph_Valid() const{
    return m_graph_isValid;
}

OAIWorkflowRun_StartingEventBatchCondition OAIWorkflowRun::getStartingEventBatchCondition() const {
    return m_starting_event_batch_condition;
}
void OAIWorkflowRun::setStartingEventBatchCondition(const OAIWorkflowRun_StartingEventBatchCondition &starting_event_batch_condition) {
    m_starting_event_batch_condition = starting_event_batch_condition;
    m_starting_event_batch_condition_isSet = true;
}

bool OAIWorkflowRun::is_starting_event_batch_condition_Set() const{
    return m_starting_event_batch_condition_isSet;
}

bool OAIWorkflowRun::is_starting_event_batch_condition_Valid() const{
