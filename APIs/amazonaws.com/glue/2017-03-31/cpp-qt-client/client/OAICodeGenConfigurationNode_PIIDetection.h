...
/*
 * OAICodeGenConfigurationNode_PIIDetection.h
 *
 * 
 */

#ifndef OAICodeGenConfigurationNode_PIIDetection_H
#define OAICodeGenConfigurationNode_PIIDetection_H
...
class OAICodeGenConfigurationNode_PIIDetection : public OAIObject {
public:
    OAICodeGenConfigurationNode_PIIDetection();
    OAICodeGenConfigurationNode_PIIDetection(QString json);
    ~OAICodeGenConfigurationNode_PIIDetection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeGenConfigurationNode_PIIDetection)

#endif // OAICodeGenConfigurationNode_PIIDetection_H
