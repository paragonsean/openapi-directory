...
OAIS3CsvSource::OAIS3CsvSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3CsvSource::OAIS3CsvSource() {
    this->initializeModel();
}

OAIS3CsvSource::~OAIS3CsvSource() {}

void OAIS3CsvSource::initializeModel() {
...
void OAIS3CsvSource::fromJson(QString jsonString) {
...
void OAIS3CsvSource::fromJsonObject(QJsonObject json) {
...
QString OAIS3CsvSource::asJson() const {
...
QJsonObject OAIS3CsvSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIS3CsvSource::getName() const {
    return m_name;
}
void OAIS3CsvSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIS3CsvSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAIS3CsvSource::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIS3CsvSource::getPaths() const {
    return m_paths;
}
void OAIS3CsvSource::setPaths(const QList &paths) {
    m_paths = paths;
    m_paths_isSet = true;
}

bool OAIS3CsvSource::is_paths_Set() const{
    return m_paths_isSet;
}

bool OAIS3CsvSource::is_paths_Valid() const{
    return m_paths_isValid;
}

OAICompressionType OAIS3CsvSource::getCompressionType() const {
    return m_compression_type;
}
void OAIS3CsvSource::setCompressionType(const OAICompressionType &compression_type) {
    m_compression_type = compression_type;
    m_compression_type_isSet = true;
}

bool OAIS3CsvSource::is_compression_type_Set() const{
    return m_compression_type_isSet;
}

bool OAIS3CsvSource::is_compression_type_Valid() const{
    return m_compression_type_isValid;
}

QList OAIS3CsvSource::getExclusions() const {
    return m_exclusions;
}
void OAIS3CsvSource::setExclusions(const QList &exclusions) {
    m_exclusions = exclusions;
    m_exclusions_isSet = true;
}

bool OAIS3CsvSource::is_exclusions_Set() const{
    return m_exclusions_isSet;
}

bool OAIS3CsvSource::is_exclusions_Valid() const{
    return m_exclusions_isValid;
}

QString OAIS3CsvSource::getGroupSize() const {
    return m_group_size;
}
void OAIS3CsvSource::setGroupSize(const QString &group_size) {
    m_group_size = group_size;
    m_group_size_isSet = true;
}

bool OAIS3CsvSource::is_group_size_Set() const{
    return m_group_size_isSet;
}

bool OAIS3CsvSource::is_group_size_Valid() const{
    return m_group_size_isValid;
}

QString OAIS3CsvSource::getGroupFiles() const {
    return m_group_files;
}
void OAIS3CsvSource::setGroupFiles(const QString &group_files) {
    m_group_files = group_files;
    m_group_files_isSet = true;
}

bool OAIS3CsvSource::is_group_files_Set() const{
    return m_group_files_isSet;
}

bool OAIS3CsvSource::is_group_files_Valid() const{
    return m_group_files_isValid;
}

bool OAIS3CsvSource::getRecurse() const {
    return m_recurse;
}
void OAIS3CsvSource::setRecurse(const bool &recurse) {
    m_recurse = recurse;
    m_recurse_isSet = true;
}

bool OAIS3CsvSource::is_recurse_Set() const{
    return m_recurse_isSet;
}

bool OAIS3CsvSource::is_recurse_Valid() const{
    return m_recurse_isValid;
}

qint32 OAIS3CsvSource::getMaxBand() const {
    return m_max_band;
}
void OAIS3CsvSource::setMaxBand(const qint32 &max_band) {
    m_max_band = max_band;
    m_max_band_isSet = true;
}

bool OAIS3CsvSource::is_max_band_Set() const{
    return m_max_band_isSet;
}

bool OAIS3CsvSource::is_max_band_Valid() const{
    return m_max_band_isValid;
}

qint32 OAIS3CsvSource::getMaxFilesInBand() const {
    return m_max_files_in_band;
}
void OAIS3CsvSource::setMaxFilesInBand(const qint32 &max_files_in_band) {
    m_max_files_in_band = max_files_in_band;
    m_max_files_in_band_isSet = true;
}

bool OAIS3CsvSource::is_max_files_in_band_Set() const{
    return m_max_files_in_band_isSet;
}

bool OAIS3CsvSource::is_max_files_in_band_Valid() const{
    return m_max_files_in_band_isValid;
}

OAIS3CsvSource_AdditionalOptions OAIS3CsvSource::getAdditionalOptions() const {
    return m_additional_options;
}
void OAIS3CsvSource::setAdditionalOptions(const OAIS3CsvSource_AdditionalOptions &additional_options) {
    m_additional_options = additional_options;
    m_additional_options_isSet = true;
}

bool OAIS3CsvSource::is_additional_options_Set() const{
    return m_additional_options_isSet;
}

bool OAIS3CsvSource::is_additional_options_Valid() const{
    return m_additional_options_isValid;
}

OAISeparator OAIS3CsvSource::getSeparator() const {
    return m_separator;
}
void OAIS3CsvSource::setSeparator(const OAISeparator &separator) {
    m_separator = separator;
    m_separator_isSet = true;
}

bool OAIS3CsvSource::is_separator_Set() const{
    return m_separator_isSet;
}

bool OAIS3CsvSource::is_separator_Valid() const{
    return m_separator_isValid;
}

QString OAIS3CsvSource::getEscaper() const {
    return m_escaper;
}
void OAIS3CsvSource::setEscaper(const QString &escaper) {
    m_escaper = escaper;
    m_escaper_isSet = true;
}

bool OAIS3CsvSource::is_escaper_Set() const{
    return m_escaper_isSet;
}

bool OAIS3CsvSource::is_escaper_Valid() const{
    return m_escaper_isValid;
}

OAIQuoteChar OAIS3CsvSource::getQuoteChar() const {
    return m_quote_char;
}
void OAIS3CsvSource::setQuoteChar(const OAIQuoteChar &quote_char) {
    m_quote_char = quote_char;
    m_quote_char_isSet = true;
}

bool OAIS3CsvSource::is_quote_char_Set() const{
    return m_quote_char_isSet;
}

bool OAIS3CsvSource::is_quote_char_Valid() const{
    return m_quote_char_isValid;
}

bool OAIS3CsvSource::getMultiline() const {
    return m_multiline;
}
void OAIS3CsvSource::setMultiline(const bool &multiline) {
    m_multiline = multiline;
    m_multiline_isSet = true;
}

bool OAIS3CsvSource::is_multiline_Set() const{
    return m_multiline_isSet;
}

bool OAIS3CsvSource::is_multiline_Valid() const{
    return m_multiline_isValid;
}

bool OAIS3CsvSource::getWithHeader() const {
    return m_with_header;
}
void OAIS3CsvSource::setWithHeader(const bool &with_header) {
    m_with_header = with_header;
    m_with_header_isSet = true;
}

bool OAIS3CsvSource::is_with_header_Set() const{
    return m_with_header_isSet;
}

bool OAIS3CsvSource::is_with_header_Valid() const{
    return m_with_header_isValid;
}

bool OAIS3CsvSource::getWriteHeader() const {
    return m_write_header;
}
void OAIS3CsvSource::setWriteHeader(const bool &write_header) {
    m_write_header = write_header;
    m_write_header_isSet = true;
}

bool OAIS3CsvSource::is_write_header_Set() const{
    return m_write_header_isSet;
}

bool OAIS3CsvSource::is_write_header_Valid() const{
    return m_write_header_isValid;
}

bool OAIS3CsvSource::getSkipFirst() const {
    return m_skip_first;
}
void OAIS3CsvSource::setSkipFirst(const bool &skip_first) {
    m_skip_first = skip_first;
    m_skip_first_isSet = true;
}

bool OAIS3CsvSource::is_skip_first_Set() const{
    return m_skip_first_isSet;
}

bool OAIS3CsvSource::is_skip_first_Valid() const{
    return m_skip_first_isValid;
}

bool OAIS3CsvSource::getOptimizePerformance() const {
    return m_optimize_performance;
}
void OAIS3CsvSource::setOptimizePerformance(const bool &optimize_performance) {
    m_optimize_performance = optimize_performance;
    m_optimize_performance_isSet = true;
}

bool OAIS3CsvSource::is_optimize_performance_Set() const{
    return m_optimize_performance_isSet;
}

bool OAIS3CsvSource::is_optimize_performance_Valid() const{
    return m_optimize_performance_isValid;
}

QList OAIS3CsvSource::getOutputSchemas() const {
    return m_output_schemas;
}
void OAIS3CsvSource::setOutputSchemas(const QList &output_schemas) {
    m_output_schemas = output_schemas;
    m_output_schemas_isSet = true;
}

bool OAIS3CsvSource::is_output_schemas_Set() const{
    return m_output_schemas_isSet;
}

bool OAIS3CsvSource::is_output_schemas_Valid() const{
    return m_output_schemas_isValid;
}

bool OAIS3CsvSource::isSet() const {
...
bool OAIS3CsvSource::isValid() const {
