...
/*
 * OAIS3ParquetSource.h
 *
 * Specifies an Apache Parquet data store stored in Amazon S3.
 */

#ifndef OAIS3ParquetSource_H
#define OAIS3ParquetSource_H
...
class OAIS3ParquetSource : public OAIObject {
public:
    OAIS3ParquetSource();
    OAIS3ParquetSource(QString json);
    ~OAIS3ParquetSource() override;
    ...
    OAIParquetCompressionType getCompressionType() const;
    void setCompressionType(const OAIParquetCompressionType &compression_type);
...
private:
    ...
    OAIParquetCompressionType m_compression_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3ParquetSource)

#endif // OAIS3ParquetSource_H
