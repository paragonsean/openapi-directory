...
/*
 * OAIWorkflowRunStatistics.h
 *
 * Workflow run statistics provides statistics about the workflow run.
 */

#ifndef OAIWorkflowRunStatistics_H
#define OAIWorkflowRunStatistics_H
...
class OAIWorkflowRunStatistics : public OAIObject {
public:
    OAIWorkflowRunStatistics();
    OAIWorkflowRunStatistics(QString json);
    ~OAIWorkflowRunStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowRunStatistics)

#endif // OAIWorkflowRunStatistics_H
