...
OAIWorkflowRun_Statistics::OAIWorkflowRun_Statistics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorkflowRun_Statistics::OAIWorkflowRun_Statistics() {
    this->initializeModel();
}

OAIWorkflowRun_Statistics::~OAIWorkflowRun_Statistics() {}

void OAIWorkflowRun_Statistics::initializeModel() {
...
void OAIWorkflowRun_Statistics::fromJson(QString jsonString) {
...
void OAIWorkflowRun_Statistics::fromJsonObject(QJsonObject json) {
...
QString OAIWorkflowRun_Statistics::asJson() const {
...
QJsonObject OAIWorkflowRun_Statistics::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIWorkflowRun_Statistics::getTotalActions() const {
    return m_total_actions;
}
void OAIWorkflowRun_Statistics::setTotalActions(const qint32 &total_actions) {
    m_total_actions = total_actions;
    m_total_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_total_actions_Set() const{
    return m_total_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_total_actions_Valid() const{
    return m_total_actions_isValid;
}

qint32 OAIWorkflowRun_Statistics::getTimeoutActions() const {
    return m_timeout_actions;
}
void OAIWorkflowRun_Statistics::setTimeoutActions(const qint32 &timeout_actions) {
    m_timeout_actions = timeout_actions;
    m_timeout_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_timeout_actions_Set() const{
    return m_timeout_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_timeout_actions_Valid() const{
    return m_timeout_actions_isValid;
}

qint32 OAIWorkflowRun_Statistics::getFailedActions() const {
    return m_failed_actions;
}
void OAIWorkflowRun_Statistics::setFailedActions(const qint32 &failed_actions) {
    m_failed_actions = failed_actions;
    m_failed_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_failed_actions_Set() const{
    return m_failed_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_failed_actions_Valid() const{
    return m_failed_actions_isValid;
}

qint32 OAIWorkflowRun_Statistics::getStoppedActions() const {
    return m_stopped_actions;
}
void OAIWorkflowRun_Statistics::setStoppedActions(const qint32 &stopped_actions) {
    m_stopped_actions = stopped_actions;
    m_stopped_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_stopped_actions_Set() const{
    return m_stopped_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_stopped_actions_Valid() const{
    return m_stopped_actions_isValid;
}

qint32 OAIWorkflowRun_Statistics::getSucceededActions() const {
    return m_succeeded_actions;
}
void OAIWorkflowRun_Statistics::setSucceededActions(const qint32 &succeeded_actions) {
    m_succeeded_actions = succeeded_actions;
    m_succeeded_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_succeeded_actions_Set() const{
    return m_succeeded_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_succeeded_actions_Valid() const{
    return m_succeeded_actions_isValid;
}

qint32 OAIWorkflowRun_Statistics::getRunningActions() const {
    return m_running_actions;
}
void OAIWorkflowRun_Statistics::setRunningActions(const qint32 &running_actions) {
    m_running_actions = running_actions;
    m_running_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_running_actions_Set() const{
    return m_running_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_running_actions_Valid() const{
    return m_running_actions_isValid;
}

qint32 OAIWorkflowRun_Statistics::getErroredActions() const {
    return m_errored_actions;
}
void OAIWorkflowRun_Statistics::setErroredActions(const qint32 &errored_actions) {
    m_errored_actions = errored_actions;
    m_errored_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_errored_actions_Set() const{
    return m_errored_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_errored_actions_Valid() const{
    return m_errored_actions_isValid;
}

qint32 OAIWorkflowRun_Statistics::getWaitingActions() const {
    return m_waiting_actions;
}
void OAIWorkflowRun_Statistics::setWaitingActions(const qint32 &waiting_actions) {
    m_waiting_actions = waiting_actions;
    m_waiting_actions_isSet = true;
}

bool OAIWorkflowRun_Statistics::is_waiting_actions_Set() const{
    return m_waiting_actions_isSet;
}

bool OAIWorkflowRun_Statistics::is_waiting_actions_Valid() const{
    return m_waiting_actions_isValid;
}

bool OAIWorkflowRun_Statistics::isSet() const {
...
bool OAIWorkflowRun_Statistics::isValid() const {
