...
/*
 * OAIGetColumnStatisticsForTableRequest.h
 *
 * 
 */

#ifndef OAIGetColumnStatisticsForTableRequest_H
#define OAIGetColumnStatisticsForTableRequest_H
...
class OAIGetColumnStatisticsForTableRequest : public OAIObject {
public:
    OAIGetColumnStatisticsForTableRequest();
    OAIGetColumnStatisticsForTableRequest(QString json);
    ~OAIGetColumnStatisticsForTableRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetColumnStatisticsForTableRequest)

#endif // OAIGetColumnStatisticsForTableRequest_H
