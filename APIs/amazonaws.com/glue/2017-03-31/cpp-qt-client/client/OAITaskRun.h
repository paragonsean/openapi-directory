...
public:
    ...
    OAITaskRun_Properties getProperties() const;
    void setProperties(const OAITaskRun_Properties &properties);
...
private:
    ...
    OAITaskRun_Properties m_properties;
