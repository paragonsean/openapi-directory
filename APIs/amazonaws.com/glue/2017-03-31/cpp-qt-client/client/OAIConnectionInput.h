...
/*
 * OAIConnectionInput.h
 *
 * A structure that is used to specify a connection to create or update.
 */

#ifndef OAIConnectionInput_H
#define OAIConnectionInput_H
...
class OAIConnectionInput : public OAIObject {
public:
    OAIConnectionInput();
    OAIConnectionInput(QString json);
    ~OAIConnectionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionInput)

#endif // OAIConnectionInput_H
