...
/*
 * OAIGetSessionResponse_Session.h
 *
 * 
 */

#ifndef OAIGetSessionResponse_Session_H
#define OAIGetSessionResponse_Session_H
...
class OAIGetSessionResponse_Session : public OAIObject {
public:
    OAIGetSessionResponse_Session();
    OAIGetSessionResponse_Session(QString json);
    ~OAIGetSessionResponse_Session() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSessionResponse_Session)

#endif // OAIGetSessionResponse_Session_H
