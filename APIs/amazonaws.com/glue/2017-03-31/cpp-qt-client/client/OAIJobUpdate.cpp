...
OAIJobUpdate::OAIJobUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobUpdate::OAIJobUpdate() {
    this->initializeModel();
}

OAIJobUpdate::~OAIJobUpdate() {}

void OAIJobUpdate::initializeModel() {
...
void OAIJobUpdate::fromJson(QString jsonString) {
...
void OAIJobUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIJobUpdate::asJson() const {
...
QJsonObject OAIJobUpdate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIJobUpdate::getDescription() const {
    return m_description;
}
void OAIJobUpdate::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIJobUpdate::is_description_Set() const{
    return m_description_isSet;
}

bool OAIJobUpdate::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIJobUpdate::getLogUri() const {
    return m_log_uri;
}
void OAIJobUpdate::setLogUri(const QString &log_uri) {
    m_log_uri = log_uri;
    m_log_uri_isSet = true;
}

bool OAIJobUpdate::is_log_uri_Set() const{
    return m_log_uri_isSet;
}

bool OAIJobUpdate::is_log_uri_Valid() const{
    return m_log_uri_isValid;
}

QString OAIJobUpdate::getRole() const {
    return m_role;
}
void OAIJobUpdate::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIJobUpdate::is_role_Set() const{
    return m_role_isSet;
}

bool OAIJobUpdate::is_role_Valid() const{
    return m_role_isValid;
}

OAICreateJobRequest_ExecutionProperty OAIJobUpdate::getExecutionProperty() const {
    return m_execution_property;
}
void OAIJobUpdate::setExecutionProperty(const OAICreateJobRequest_ExecutionProperty &execution_property) {
    m_execution_property = execution_property;
    m_execution_property_isSet = true;
}

bool OAIJobUpdate::is_execution_property_Set() const{
    return m_execution_property_isSet;
}

bool OAIJobUpdate::is_execution_property_Valid() const{
    return m_execution_property_isValid;
}

OAIJobUpdate_Command OAIJobUpdate::getCommand() const {
    return m_command;
}
void OAIJobUpdate::setCommand(const OAIJobUpdate_Command &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAIJobUpdate::is_command_Set() const{
    return m_command_isSet;
}

bool OAIJobUpdate::is_command_Valid() const{
    return m_command_isValid;
}

QMap OAIJobUpdate::getDefaultArguments() const {
    return m_default_arguments;
}
void OAIJobUpdate::setDefaultArguments(const QMap &default_arguments) {
    m_default_arguments = default_arguments;
    m_default_arguments_isSet = true;
}

bool OAIJobUpdate::is_default_arguments_Set() const{
    return m_default_arguments_isSet;
}

bool OAIJobUpdate::is_default_arguments_Valid() const{
    return m_default_arguments_isValid;
}

QMap OAIJobUpdate::getNonOverridableArguments() const {
    return m_non_overridable_arguments;
}
void OAIJobUpdate::setNonOverridableArguments(const QMap &non_overridable_arguments) {
    m_non_overridable_arguments = non_overridable_arguments;
    m_non_overridable_arguments_isSet = true;
}

bool OAIJobUpdate::is_non_overridable_arguments_Set() const{
    return m_non_overridable_arguments_isSet;
}

bool OAIJobUpdate::is_non_overridable_arguments_Valid() const{
    return m_non_overridable_arguments_isValid;
}

OAICreateJobRequest_Connections OAIJobUpdate::getConnections() const {
    return m_connections;
}
void OAIJobUpdate::setConnections(const OAICreateJobRequest_Connections &connections) {
    m_connections = connections;
    m_connections_isSet = true;
}

bool OAIJobUpdate::is_connections_Set() const{
    return m_connections_isSet;
}

bool OAIJobUpdate::is_connections_Valid() const{
    return m_connections_isValid;
}

qint32 OAIJobUpdate::getMaxRetries() const {
    return m_max_retries;
}
void OAIJobUpdate::setMaxRetries(const qint32 &max_retries) {
    m_max_retries = max_retries;
    m_max_retries_isSet = true;
}

bool OAIJobUpdate::is_max_retries_Set() const{
    return m_max_retries_isSet;
}

bool OAIJobUpdate::is_max_retries_Valid() const{
    return m_max_retries_isValid;
}

qint32 OAIJobUpdate::getAllocatedCapacity() const {
    return m_allocated_capacity;
}
void OAIJobUpdate::setAllocatedCapacity(const qint32 &allocated_capacity) {
    m_allocated_capacity = allocated_capacity;
    m_allocated_capacity_isSet = true;
}

bool OAIJobUpdate::is_allocated_capacity_Set() const{
    return m_allocated_capacity_isSet;
}

bool OAIJobUpdate::is_allocated_capacity_Valid() const{
    return m_allocated_capacity_isValid;
}

qint32 OAIJobUpdate::getTimeout() const {
    return m_timeout;
}
void OAIJobUpdate::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIJobUpdate::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIJobUpdate::is_timeout_Valid() const{
    return m_timeout_isValid;
}

double OAIJobUpdate::getMaxCapacity() const {
    return m_max_capacity;
}
void OAIJobUpdate::setMaxCapacity(const double &max_capacity) {
    m_max_capacity = max_capacity;
    m_max_capacity_isSet = true;
}

bool OAIJobUpdate::is_max_capacity_Set() const{
    return m_max_capacity_isSet;
}

bool OAIJobUpdate::is_max_capacity_Valid() const{
    return m_max_capacity_isValid;
}

OAIWorkerType OAIJobUpdate::getWorkerType() const {
    return m_worker_type;
}
void OAIJobUpdate::setWorkerType(const OAIWorkerType &worker_type) {
    m_worker_type = worker_type;
    m_worker_type_isSet = true;
}

bool OAIJobUpdate::is_worker_type_Set() const{
    return m_worker_type_isSet;
}

bool OAIJobUpdate::is_worker_type_Valid() const{
    return m_worker_type_isValid;
}

qint32 OAIJobUpdate::getNumberOfWorkers() const {
    return m_number_of_workers;
}
void OAIJobUpdate::setNumberOfWorkers(const qint32 &number_of_workers) {
    m_number_of_workers = number_of_workers;
    m_number_of_workers_isSet = true;
}

bool OAIJobUpdate::is_number_of_workers_Set() const{
    return m_number_of_workers_isSet;
}

bool OAIJobUpdate::is_number_of_workers_Valid() const{
    return m_number_of_workers_isValid;
}

QString OAIJobUpdate::getSecurityConfiguration() const {
    return m_security_configuration;
}
void OAIJobUpdate::setSecurityConfiguration(const QString &security_configuration) {
    m_security_configuration = security_configuration;
    m_security_configuration_isSet = true;
}

bool OAIJobUpdate::is_security_configuration_Set() const{
    return m_security_configuration_isSet;
}

bool OAIJobUpdate::is_security_configuration_Valid() const{
    return m_security_configuration_isValid;
}

OAIJobUpdate_NotificationProperty OAIJobUpdate::getNotificationProperty() const {
    return m_notification_property;
}
void OAIJobUpdate::setNotificationProperty(const OAIJobUpdate_NotificationProperty &notification_property) {
    m_notification_property = notification_property;
    m_notification_property_isSet = true;
}

bool OAIJobUpdate::is_notification_property_Set() const{
    return m_notification_property_isSet;
}

bool OAIJobUpdate::is_notification_property_Valid() const{
    return m_notification_property_isValid;
}

QString OAIJobUpdate::getGlueVersion() const {
    return m_glue_version;
}
void OAIJobUpdate::setGlueVersion(const QString &glue_version) {
    m_glue_version = glue_version;
    m_glue_version_isSet = true;
}

bool OAIJobUpdate::is_glue_version_Set() const{
    return m_glue_version_isSet;
}

bool OAIJobUpdate::is_glue_version_Valid() const{
    return m_glue_version_isValid;
}

QMap OAIJobUpdate::getCodeGenConfigurationNodes() const {
    return m_code_gen_configuration_nodes;
}
void OAIJobUpdate::setCodeGenConfigurationNodes(const QMap &code_gen_configuration_nodes) {
    m_code_gen_configuration_nodes = code_gen_configuration_nodes;
    m_code_gen_configuration_nodes_isSet = true;
}

bool OAIJobUpdate::is_code_gen_configuration_nodes_Set() const{
    return m_code_gen_configuration_nodes_isSet;
}

bool OAIJobUpdate::is_code_gen_configuration_nodes_Valid() const{
    return m_code_gen_configuration_nodes_isValid;
}

OAIExecutionClass OAIJobUpdate::getExecutionClass() const {
    return m_execution_class;
}
void OAIJobUpdate::setExecutionClass(const OAIExecutionClass &execution_class) {
    m_execution_class = execution_class;
    m_execution_class_isSet = true;
}

bool OAIJobUpdate::is_execution_class_Set() const{
    return m_execution_class_isSet;
}

bool OAIJobUpdate::is_execution_class_Valid() const{
    return m_execution_class_isValid;
}

OAICreateJobRequest_SourceControlDetails OAIJobUpdate::getSourceControlDetails() const {
    return m_source_control_details;
}
void OAIJobUpdate::setSourceControlDetails(const OAICreateJobRequest_SourceControlDetails &source_control_details) {
    m_source_control_details = source_control_details;
    m_source_control_details_isSet = true;
}

bool OAIJobUpdate::is_source_control_details_Set() const{
    return m_source_control_details_isSet;
}

bool OAIJobUpdate::is_source_control_details_Valid() const{
    return m_source_control_details_isValid;
}

bool OAIJobUpdate::isSet() const {
...
bool OAIJobUpdate::isValid() const {
