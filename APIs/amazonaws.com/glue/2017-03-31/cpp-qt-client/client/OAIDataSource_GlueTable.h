...
/*
 * OAIDataSource_GlueTable.h
 *
 * 
 */

#ifndef OAIDataSource_GlueTable_H
#define OAIDataSource_GlueTable_H
...
class OAIDataSource_GlueTable : public OAIObject {
public:
    OAIDataSource_GlueTable();
    OAIDataSource_GlueTable(QString json);
    ~OAIDataSource_GlueTable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSource_GlueTable)

#endif // OAIDataSource_GlueTable_H
