...
/*
 * OAIGetBlueprintRunRequest.h
 *
 * 
 */

#ifndef OAIGetBlueprintRunRequest_H
#define OAIGetBlueprintRunRequest_H
...
class OAIGetBlueprintRunRequest : public OAIObject {
public:
    OAIGetBlueprintRunRequest();
    OAIGetBlueprintRunRequest(QString json);
    ~OAIGetBlueprintRunRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBlueprintRunRequest)

#endif // OAIGetBlueprintRunRequest_H
