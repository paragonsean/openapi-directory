...
/*
 * OAIGetJobResponse_Job.h
 *
 * 
 */

#ifndef OAIGetJobResponse_Job_H
#define OAIGetJobResponse_Job_H
...
class OAIGetJobResponse_Job : public OAIObject {
public:
    OAIGetJobResponse_Job();
    OAIGetJobResponse_Job(QString json);
    ~OAIGetJobResponse_Job() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobResponse_Job)

#endif // OAIGetJobResponse_Job_H
