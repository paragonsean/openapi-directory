...
/*
 * OAIS3HudiCatalogTarget.h
 *
 * Specifies a target that writes to a Hudi data source in the Glue Data Catalog.
 */

#ifndef OAIS3HudiCatalogTarget_H
#define OAIS3HudiCatalogTarget_H
...
class OAIS3HudiCatalogTarget : public OAIObject {
public:
    OAIS3HudiCatalogTarget();
    OAIS3HudiCatalogTarget(QString json);
    ~OAIS3HudiCatalogTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3HudiCatalogTarget)

#endif // OAIS3HudiCatalogTarget_H
