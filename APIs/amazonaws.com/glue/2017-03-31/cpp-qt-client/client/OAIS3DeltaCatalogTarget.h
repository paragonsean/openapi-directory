...
/*
 * OAIS3DeltaCatalogTarget.h
 *
 * Specifies a target that writes to a Delta Lake data source in the Glue Data Catalog.
 */

#ifndef OAIS3DeltaCatalogTarget_H
#define OAIS3DeltaCatalogTarget_H
...
class OAIS3DeltaCatalogTarget : public OAIObject {
public:
    OAIS3DeltaCatalogTarget();
    OAIS3DeltaCatalogTarget(QString json);
    ~OAIS3DeltaCatalogTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3DeltaCatalogTarget)

#endif // OAIS3DeltaCatalogTarget_H
