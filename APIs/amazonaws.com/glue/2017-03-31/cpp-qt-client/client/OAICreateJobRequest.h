...
class OAICreateJobRequest_Command;
class OAICreateJobRequest_Connections;
class OAICreateJobRequest_NotificationProperty;
...
public:
    ...
    OAICreateJobRequest_Command getCommand() const;
    void setCommand(const OAICreateJobRequest_Command &command);
    ...
    OAICreateJobRequest_NotificationProperty getNotificationProperty() const;
    void setNotificationProperty(const OAICreateJobRequest_NotificationProperty &notification_property);
...
private:
    ...
    OAICreateJobRequest_Command m_command;
    ...
    OAICreateJobRequest_NotificationProperty m_notification_property;
