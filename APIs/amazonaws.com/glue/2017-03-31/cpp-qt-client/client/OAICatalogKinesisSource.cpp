...
#include "OAICatalogKinesisSource.h"
...
OAICatalogKinesisSource::OAICatalogKinesisSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICatalogKinesisSource::OAICatalogKinesisSource() {
    this->initializeModel();
}

OAICatalogKinesisSource::~OAICatalogKinesisSource() {}

void OAICatalogKinesisSource::initializeModel() {
...
void OAICatalogKinesisSource::fromJson(QString jsonString) {
...
void OAICatalogKinesisSource::fromJsonObject(QJsonObject json) {
...
QString OAICatalogKinesisSource::asJson() const {
...
QJsonObject OAICatalogKinesisSource::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICatalogKinesisSource::getName() const {
    return m_name;
}
void OAICatalogKinesisSource::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICatalogKinesisSource::is_name_Set() const{
    return m_name_isSet;
}

bool OAICatalogKinesisSource::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICatalogKinesisSource::getWindowSize() const {
    return m_window_size;
}
void OAICatalogKinesisSource::setWindowSize(const qint32 &window_size) {
    m_window_size = window_size;
    m_window_size_isSet = true;
}

bool OAICatalogKinesisSource::is_window_size_Set() const{
    return m_window_size_isSet;
}

bool OAICatalogKinesisSource::is_window_size_Valid() const{
    return m_window_size_isValid;
}

bool OAICatalogKinesisSource::getDetectSchema() const {
    return m_detect_schema;
}
void OAICatalogKinesisSource::setDetectSchema(const bool &detect_schema) {
    m_detect_schema = detect_schema;
    m_detect_schema_isSet = true;
}

bool OAICatalogKinesisSource::is_detect_schema_Set() const{
    return m_detect_schema_isSet;
}

bool OAICatalogKinesisSource::is_detect_schema_Valid() const{
    return m_detect_schema_isValid;
}

QString OAICatalogKinesisSource::getTable() const {
    return m_table;
}
void OAICatalogKinesisSource::setTable(const QString &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAICatalogKinesisSource::is_table_Set() const{
    return m_table_isSet;
}

bool OAICatalogKinesisSource::is_table_Valid() const{
    return m_table_isValid;
}

QString OAICatalogKinesisSource::getDatabase() const {
    return m_database;
}
void OAICatalogKinesisSource::setDatabase(const QString &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAICatalogKinesisSource::is_database_Set() const{
    return m_database_isSet;
}

bool OAICatalogKinesisSource::is_database_Valid() const{
    return m_database_isValid;
}

OAICatalogKinesisSource_StreamingOptions OAICatalogKinesisSource::getStreamingOptions() const {
    return m_streaming_options;
}
void OAICatalogKinesisSource::setStreamingOptions(const OAICatalogKinesisSource_StreamingOptions &streaming_options) {
    m_streaming_options = streaming_options;
    m_streaming_options_isSet = true;
}

bool OAICatalogKinesisSource::is_streaming_options_Set() const{
    return m_streaming_options_isSet;
}

bool OAICatalogKinesisSource::is_streaming_options_Valid() const{
    return m_streaming_options_isValid;
}

OAICatalogKinesisSource_DataPreviewOptions OAICatalogKinesisSource::getDataPreviewOptions() const {
    return m_data_preview_options;
}
void OAICatalogKinesisSource::setDataPreviewOptions(const OAICatalogKinesisSource_DataPreviewOptions &data_preview_options) {
    m_data_preview_options = data_preview_options;
    m_data_preview_options_isSet = true;
}

bool OAICatalogKinesisSource::is_data_preview_options_Set() const{
    return m_data_preview_options_isSet;
}

bool OAICatalogKinesisSource::is_data_preview_options_Valid() const{
    return m_data_preview_options_isValid;
}

bool OAICatalogKinesisSource::isSet() const {
...
bool OAICatalogKinesisSource::isValid() const {
