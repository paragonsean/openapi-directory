...
OAIGetMLTransformResponse::OAIGetMLTransformResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMLTransformResponse::OAIGetMLTransformResponse() {
    this->initializeModel();
}

OAIGetMLTransformResponse::~OAIGetMLTransformResponse() {}

void OAIGetMLTransformResponse::initializeModel() {
...
void OAIGetMLTransformResponse::fromJson(QString jsonString) {
...
void OAIGetMLTransformResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetMLTransformResponse::asJson() const {
...
QJsonObject OAIGetMLTransformResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetMLTransformResponse::getTransformId() const {
    return m_transform_id;
}
void OAIGetMLTransformResponse::setTransformId(const QString &transform_id) {
    m_transform_id = transform_id;
    m_transform_id_isSet = true;
}

bool OAIGetMLTransformResponse::is_transform_id_Set() const{
    return m_transform_id_isSet;
}

bool OAIGetMLTransformResponse::is_transform_id_Valid() const{
    return m_transform_id_isValid;
}

QString OAIGetMLTransformResponse::getName() const {
    return m_name;
}
void OAIGetMLTransformResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetMLTransformResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetMLTransformResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGetMLTransformResponse::getDescription() const {
    return m_description;
}
void OAIGetMLTransformResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetMLTransformResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetMLTransformResponse::is_description_Valid() const{
    return m_description_isValid;
}

OAITransformStatusType OAIGetMLTransformResponse::getStatus() const {
    return m_status;
}
void OAIGetMLTransformResponse::setStatus(const OAITransformStatusType &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetMLTransformResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetMLTransformResponse::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIGetMLTransformResponse::getCreatedOn() const {
    return m_created_on;
}
void OAIGetMLTransformResponse::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIGetMLTransformResponse::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIGetMLTransformResponse::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QDateTime OAIGetMLTransformResponse::getLastModifiedOn() const {
    return m_last_modified_on;
}
void OAIGetMLTransformResponse::setLastModifiedOn(const QDateTime &last_modified_on) {
    m_last_modified_on = last_modified_on;
    m_last_modified_on_isSet = true;
}

bool OAIGetMLTransformResponse::is_last_modified_on_Set() const{
    return m_last_modified_on_isSet;
}

bool OAIGetMLTransformResponse::is_last_modified_on_Valid() const{
    return m_last_modified_on_isValid;
}

QList OAIGetMLTransformResponse::getInputRecordTables() const {
    return m_input_record_tables;
}
void OAIGetMLTransformResponse::setInputRecordTables(const QList &input_record_tables) {
    m_input_record_tables = input_record_tables;
    m_input_record_tables_isSet = true;
}

bool OAIGetMLTransformResponse::is_input_record_tables_Set() const{
    return m_input_record_tables_isSet;
}

bool OAIGetMLTransformResponse::is_input_record_tables_Valid() const{
    return m_input_record_tables_isValid;
}

OAIGetMLTransformResponse_Parameters OAIGetMLTransformResponse::getParameters() const {
    return m_parameters;
}
void OAIGetMLTransformResponse::setParameters(const OAIGetMLTransformResponse_Parameters &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIGetMLTransformResponse::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIGetMLTransformResponse::is_parameters_Valid() const{
    return m_parameters_isValid;
}

OAIGetMLTransformResponse_EvaluationMetrics OAIGetMLTransformResponse::getEvaluationMetrics() const {
    return m_evaluation_metrics;
}
void OAIGetMLTransformResponse::setEvaluationMetrics(const OAIGetMLTransformResponse_EvaluationMetrics &evaluation_metrics) {
    m_evaluation_metrics = evaluation_metrics;
    m_evaluation_metrics_isSet = true;
}

bool OAIGetMLTransformResponse::is_evaluation_metrics_Set() const{
    return m_evaluation_metrics_isSet;
}

bool OAIGetMLTransformResponse::is_evaluation_metrics_Valid() const{
    return m_evaluation_metrics_isValid;
}

qint32 OAIGetMLTransformResponse::getLabelCount() const {
    return m_label_count;
}
void OAIGetMLTransformResponse::setLabelCount(const qint32 &label_count) {
    m_label_count = label_count;
    m_label_count_isSet = true;
}

bool OAIGetMLTransformResponse::is_label_count_Set() const{
    return m_label_count_isSet;
}

bool OAIGetMLTransformResponse::is_label_count_Valid() const{
    return m_label_count_isValid;
}

QList OAIGetMLTransformResponse::getSchema() const {
    return m_schema;
}
void OAIGetMLTransformResponse::setSchema(const QList &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAIGetMLTransformResponse::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAIGetMLTransformResponse::is_schema_Valid() const{
    return m_schema_isValid;
}

QString OAIGetMLTransformResponse::getRole() const {
    return m_role;
}
void OAIGetMLTransformResponse::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIGetMLTransformResponse::is_role_Set() const{
    return m_role_isSet;
}

bool OAIGetMLTransformResponse::is_role_Valid() const{
    return m_role_isValid;
}

QString OAIGetMLTransformResponse::getGlueVersion() const {
    return m_glue_version;
}
void OAIGetMLTransformResponse::setGlueVersion(const QString &glue_version) {
    m_glue_version = glue_version;
    m_glue_version_isSet = true;
}

bool OAIGetMLTransformResponse::is_glue_version_Set() const{
    return m_glue_version_isSet;
}

bool OAIGetMLTransformResponse::is_glue_version_Valid() const{
    return m_glue_version_isValid;
}

double OAIGetMLTransformResponse::getMaxCapacity() const {
    return m_max_capacity;
}
void OAIGetMLTransformResponse::setMaxCapacity(const double &max_capacity) {
    m_max_capacity = max_capacity;
    m_max_capacity_isSet = true;
}

bool OAIGetMLTransformResponse::is_max_capacity_Set() const{
    return m_max_capacity_isSet;
}

bool OAIGetMLTransformResponse::is_max_capacity_Valid() const{
    return m_max_capacity_isValid;
}

OAIWorkerType OAIGetMLTransformResponse::getWorkerType() const {
    return m_worker_type;
}
void OAIGetMLTransformResponse::setWorkerType(const OAIWorkerType &worker_type) {
    m_worker_type = worker_type;
    m_worker_type_isSet = true;
}

bool OAIGetMLTransformResponse::is_worker_type_Set() const{
    return m_worker_type_isSet;
}

bool OAIGetMLTransformResponse::is_worker_type_Valid() const{
    return m_worker_type_isValid;
}

qint32 OAIGetMLTransformResponse::getNumberOfWorkers() const {
    return m_number_of_workers;
}
void OAIGetMLTransformResponse::setNumberOfWorkers(const qint32 &number_of_workers) {
    m_number_of_workers = number_of_workers;
    m_number_of_workers_isSet = true;
}

bool OAIGetMLTransformResponse::is_number_of_workers_Set() const{
    return m_number_of_workers_isSet;
}

bool OAIGetMLTransformResponse::is_number_of_workers_Valid() const{
    return m_number_of_workers_isValid;
}

qint32 OAIGetMLTransformResponse::getTimeout() const {
    return m_timeout;
}
void OAIGetMLTransformResponse::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIGetMLTransformResponse::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIGetMLTransformResponse::is_timeout_Valid() const{
    return m_timeout_isValid;
}

qint32 OAIGetMLTransformResponse::getMaxRetries() const {
    return m_max_retries;
}
void OAIGetMLTransformResponse::setMaxRetries(const qint32 &max_retries) {
    m_max_retries = max_retries;
    m_max_retries_isSet = true;
}

bool OAIGetMLTransformResponse::is_max_retries_Set() const{
    return m_max_retries_isSet;
}

bool OAIGetMLTransformResponse::is_max_retries_Valid() const{
    return m_max_retries_isValid;
}

OAICreateMLTransformRequest_TransformEncryption OAIGetMLTransformResponse::getTransformEncryption() const {
    return m_transform_encryption;
}
void OAIGetMLTransformResponse::setTransformEncryption(const OAICreateMLTransformRequest_TransformEncryption &transform_encryption) {
    m_transform_encryption = transform_encryption;
    m_transform_encryption_isSet = true;
}

bool OAIGetMLTransformResponse::is_transform_encryption_Set() const{
    return m_transform_encryption_isSet;
}

bool OAIGetMLTransformResponse::is_transform_encryption_Valid() const{
    return m_transform_encryption_isValid;
}

bool OAIGetMLTransformResponse::isSet() const {
...
bool OAIGetMLTransformResponse::isValid() const {
