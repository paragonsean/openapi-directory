...
/**
 * AmazonRedshiftSourceData
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class AmazonRedshiftSourceData {
  ...
  public AmazonRedshiftSourceData() {
  }

  public AmazonRedshiftSourceData accessType(String accessType) {
  ...
  public AmazonRedshiftSourceData sourceType(String sourceType) {
  ...
  public AmazonRedshiftSourceData connection(AmazonRedshiftNodeDataConnection connection) {
  ...
  public AmazonRedshiftSourceData schema(AmazonRedshiftNodeDataSchema schema) {
    this.schema = schema;
    return this;
  }
  ...
  public AmazonRedshiftSourceData table(AmazonRedshiftNodeDataTable table) {
    this.table = table;
    return this;
  }
  ...
  public AmazonRedshiftSourceData catalogDatabase(AmazonRedshiftNodeDataCatalogDatabase catalogDatabase) {
  ...
  public AmazonRedshiftSourceData catalogTable(AmazonRedshiftNodeDataCatalogTable catalogTable) {
  ...
  public AmazonRedshiftSourceData catalogRedshiftSchema(String catalogRedshiftSchema) {
  ...
  public AmazonRedshiftSourceData catalogRedshiftTable(String catalogRedshiftTable) {
  ...
  public AmazonRedshiftSourceData tempDir(String tempDir) {
  ...
  public AmazonRedshiftSourceData iamRole(AmazonRedshiftNodeDataIamRole iamRole) {
  ...
  public AmazonRedshiftSourceData advancedOptions(List advancedOptions) {
  ...
  public AmazonRedshiftSourceData sampleQuery(String sampleQuery) {
  ...
  public AmazonRedshiftSourceData preAction(String preAction) {
  ...
  public AmazonRedshiftSourceData postAction(String postAction) {
  ...
  public AmazonRedshiftSourceData action(String action) {
    this.action = action;
    return this;
  }
  ...
  public AmazonRedshiftSourceData tablePrefix(String tablePrefix) {
  ...
  public AmazonRedshiftSourceData upsert(Boolean upsert) {
    this.upsert = upsert;
    return this;
  }
  ...
  public AmazonRedshiftSourceData mergeAction(String mergeAction) {
  ...
  public AmazonRedshiftSourceData mergeWhenMatched(String mergeWhenMatched) {
  ...
  public AmazonRedshiftSourceData mergeWhenNotMatched(String mergeWhenNotMatched) {
  ...
  public AmazonRedshiftSourceData mergeClause(String mergeClause) {
  ...
  public AmazonRedshiftSourceData crawlerConnection(String crawlerConnection) {
  ...
  public AmazonRedshiftSourceData tableSchema(List tableSchema) {
  ...
  public AmazonRedshiftSourceData stagingTable(String stagingTable) {
  ...
  public AmazonRedshiftSourceData selectedColumns(List selectedColumns) {
  ...
  public boolean equals(Object o) {
    ...
    AmazonRedshiftSourceData amazonRedshiftSourceData = (AmazonRedshiftSourceData) o;
    return Objects.equals(this.accessType, amazonRedshiftSourceData.accessType) &&
        Objects.equals(this.sourceType, amazonRedshiftSourceData.sourceType) &&
        Objects.equals(this.connection, amazonRedshiftSourceData.connection) &&
        Objects.equals(this.schema, amazonRedshiftSourceData.schema) &&
        Objects.equals(this.table, amazonRedshiftSourceData.table) &&
        Objects.equals(this.catalogDatabase, amazonRedshiftSourceData.catalogDatabase) &&
        Objects.equals(this.catalogTable, amazonRedshiftSourceData.catalogTable) &&
        Objects.equals(this.catalogRedshiftSchema, amazonRedshiftSourceData.catalogRedshiftSchema) &&
        Objects.equals(this.catalogRedshiftTable, amazonRedshiftSourceData.catalogRedshiftTable) &&
        Objects.equals(this.tempDir, amazonRedshiftSourceData.tempDir) &&
        Objects.equals(this.iamRole, amazonRedshiftSourceData.iamRole) &&
        Objects.equals(this.advancedOptions, amazonRedshiftSourceData.advancedOptions) &&
        Objects.equals(this.sampleQuery, amazonRedshiftSourceData.sampleQuery) &&
        Objects.equals(this.preAction, amazonRedshiftSourceData.preAction) &&
        Objects.equals(this.postAction, amazonRedshiftSourceData.postAction) &&
        Objects.equals(this.action, amazonRedshiftSourceData.action) &&
        Objects.equals(this.tablePrefix, amazonRedshiftSourceData.tablePrefix) &&
        Objects.equals(this.upsert, amazonRedshiftSourceData.upsert) &&
        Objects.equals(this.mergeAction, amazonRedshiftSourceData.mergeAction) &&
        Objects.equals(this.mergeWhenMatched, amazonRedshiftSourceData.mergeWhenMatched) &&
        Objects.equals(this.mergeWhenNotMatched, amazonRedshiftSourceData.mergeWhenNotMatched) &&
        Objects.equals(this.mergeClause, amazonRedshiftSourceData.mergeClause) &&
        Objects.equals(this.crawlerConnection, amazonRedshiftSourceData.crawlerConnection) &&
        Objects.equals(this.tableSchema, amazonRedshiftSourceData.tableSchema) &&
        Objects.equals(this.stagingTable, amazonRedshiftSourceData.stagingTable) &&
        Objects.equals(this.selectedColumns, amazonRedshiftSourceData.selectedColumns);
  }
  ...
  public String toString() {
    ...
    sb.append("class AmazonRedshiftSourceData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmazonRedshiftSourceData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmazonRedshiftSourceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonRedshiftSourceData is not found in the empty JSON string", AmazonRedshiftSourceData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AmazonRedshiftSourceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AmazonRedshiftSourceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonRedshiftSourceData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonRedshiftSourceData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonRedshiftSourceData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonRedshiftSourceData.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonRedshiftSourceData>() {
           @Override
           public void write(JsonWriter out, AmazonRedshiftSourceData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AmazonRedshiftSourceData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AmazonRedshiftSourceData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AmazonRedshiftSourceData
   * @throws IOException if the JSON string is invalid with respect to AmazonRedshiftSourceData
   */
  public static AmazonRedshiftSourceData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonRedshiftSourceData.class);
  }

  /**
   * Convert an instance of AmazonRedshiftSourceData to an JSON string
   *
   * @return JSON string
   */
