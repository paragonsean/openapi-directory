...
public class S3JsonSource {
  ...
  public S3JsonSource name(String name) {
    this.name = name;
    return this;
  }
  ...
  public S3JsonSource paths(List paths) {
    this.paths = paths;
    return this;
  }
  ...
  public S3JsonSource compressionType(CompressionType compressionType) {
  ...
  public S3JsonSource exclusions(List exclusions) {
  ...
  public S3JsonSource groupSize(String groupSize) {
  ...
  public S3JsonSource groupFiles(String groupFiles) {
  ...
  public S3JsonSource recurse(Boolean recurse) {
  ...
  public S3JsonSource maxBand(Integer maxBand) {
  ...
  public S3JsonSource maxFilesInBand(Integer maxFilesInBand) {
  ...
  public S3JsonSource additionalOptions(S3CsvSourceAdditionalOptions additionalOptions) {
  ...
  public S3JsonSource jsonPath(String jsonPath) {
  ...
  public S3JsonSource multiline(Boolean multiline) {
  ...
  public S3JsonSource outputSchemas(List outputSchemas) {
  ...
  public boolean equals(Object o) {
    ...
    S3JsonSource s3JsonSource = (S3JsonSource) o;
    return Objects.equals(this.name, s3JsonSource.name) &&
        Objects.equals(this.paths, s3JsonSource.paths) &&
        Objects.equals(this.compressionType, s3JsonSource.compressionType) &&
        Objects.equals(this.exclusions, s3JsonSource.exclusions) &&
        Objects.equals(this.groupSize, s3JsonSource.groupSize) &&
        Objects.equals(this.groupFiles, s3JsonSource.groupFiles) &&
        Objects.equals(this.recurse, s3JsonSource.recurse) &&
        Objects.equals(this.maxBand, s3JsonSource.maxBand) &&
        Objects.equals(this.maxFilesInBand, s3JsonSource.maxFilesInBand) &&
        Objects.equals(this.additionalOptions, s3JsonSource.additionalOptions) &&
        Objects.equals(this.jsonPath, s3JsonSource.jsonPath) &&
        Objects.equals(this.multiline, s3JsonSource.multiline) &&
        Objects.equals(this.outputSchemas, s3JsonSource.outputSchemas);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3JsonSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3JsonSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3JsonSource is not found in the empty JSON string", S3JsonSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3JsonSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3JsonSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3JsonSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3JsonSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3JsonSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3JsonSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3JsonSource.class));

       return (TypeAdapter<T>) new TypeAdapter<S3JsonSource>() {
           @Override
           public void write(JsonWriter out, S3JsonSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3JsonSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3JsonSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3JsonSource
   * @throws IOException if the JSON string is invalid with respect to S3JsonSource
   */
  public static S3JsonSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3JsonSource.class);
  }

  /**
   * Convert an instance of S3JsonSource to an JSON string
   *
   * @return JSON string
   */
