...
public class FindMatchesMetrics {
  ...
  public FindMatchesMetrics areaUnderPRCurve(Double areaUnderPRCurve) {
  ...
  public FindMatchesMetrics precision(Double precision) {
  ...
  public FindMatchesMetrics recall(Double recall) {
    this.recall = recall;
    return this;
  }
  ...
  public FindMatchesMetrics F1(Double F1) {
    this.F1 = F1;
    return this;
  }
  ...
  public FindMatchesMetrics confusionMatrix(FindMatchesMetricsConfusionMatrix confusionMatrix) {
  ...
  public FindMatchesMetrics columnImportances(List columnImportances) {
  ...
  public boolean equals(Object o) {
    ...
    FindMatchesMetrics findMatchesMetrics = (FindMatchesMetrics) o;
    return Objects.equals(this.areaUnderPRCurve, findMatchesMetrics.areaUnderPRCurve) &&
        Objects.equals(this.precision, findMatchesMetrics.precision) &&
        Objects.equals(this.recall, findMatchesMetrics.recall) &&
        Objects.equals(this.F1, findMatchesMetrics.F1) &&
        Objects.equals(this.confusionMatrix, findMatchesMetrics.confusionMatrix) &&
        Objects.equals(this.columnImportances, findMatchesMetrics.columnImportances);
  }
  ...
  public String toString() {
    ...
    sb.append("class FindMatchesMetrics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FindMatchesMetrics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FindMatchesMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FindMatchesMetrics is not found in the empty JSON string", FindMatchesMetrics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FindMatchesMetrics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FindMatchesMetrics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FindMatchesMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FindMatchesMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FindMatchesMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FindMatchesMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<FindMatchesMetrics>() {
           @Override
           public void write(JsonWriter out, FindMatchesMetrics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FindMatchesMetrics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FindMatchesMetrics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FindMatchesMetrics
   * @throws IOException if the JSON string is invalid with respect to FindMatchesMetrics
   */
  public static FindMatchesMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FindMatchesMetrics.class);
  }

  /**
   * Convert an instance of FindMatchesMetrics to an JSON string
   *
   * @return JSON string
   */
