...
public class StorageDescriptor {
  ...
  public StorageDescriptor columns(List columns) {
  ...
  public StorageDescriptor location(String location) {
  ...
  public StorageDescriptor additionalLocations(List additionalLocations) {
  ...
  public StorageDescriptor inputFormat(String inputFormat) {
  ...
  public StorageDescriptor outputFormat(String outputFormat) {
  ...
  public StorageDescriptor compressed(Boolean compressed) {
  ...
  public StorageDescriptor numberOfBuckets(Integer numberOfBuckets) {
  ...
  public StorageDescriptor serdeInfo(StorageDescriptorSerdeInfo serdeInfo) {
  ...
  public StorageDescriptor bucketColumns(List bucketColumns) {
  ...
  public StorageDescriptor sortColumns(List sortColumns) {
  ...
  public StorageDescriptor parameters(Map parameters) {
  ...
  public StorageDescriptor skewedInfo(StorageDescriptorSkewedInfo skewedInfo) {
  ...
  public StorageDescriptor storedAsSubDirectories(Boolean storedAsSubDirectories) {
  ...
  public StorageDescriptor schemaReference(StorageDescriptorSchemaReference schemaReference) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, storageDescriptor.columns) &&
        ...
        Objects.equals(this.additionalLocations, storageDescriptor.additionalLocations) &&
        ...
        Objects.equals(this.schemaReference, storageDescriptor.schemaReference);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StorageDescriptor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StorageDescriptor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StorageDescriptor is not found in the empty JSON string", StorageDescriptor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StorageDescriptor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StorageDescriptor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StorageDescriptor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StorageDescriptor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StorageDescriptor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StorageDescriptor.class));

       return (TypeAdapter<T>) new TypeAdapter<StorageDescriptor>() {
           @Override
           public void write(JsonWriter out, StorageDescriptor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StorageDescriptor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StorageDescriptor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StorageDescriptor
   * @throws IOException if the JSON string is invalid with respect to StorageDescriptor
   */
  public static StorageDescriptor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StorageDescriptor.class);
  }

  /**
   * Convert an instance of StorageDescriptor to an JSON string
   *
   * @return JSON string
   */
