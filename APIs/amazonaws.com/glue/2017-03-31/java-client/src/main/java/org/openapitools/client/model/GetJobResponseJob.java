...
public class GetJobResponseJob {
  ...
  public GetJobResponseJob() {
  }

  public GetJobResponseJob name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetJobResponseJob description(String description) {
  ...
  public GetJobResponseJob logUri(String logUri) {
    this.logUri = logUri;
    return this;
  }
  ...
  public GetJobResponseJob role(String role) {
    this.role = role;
    return this;
  }
  ...
  public GetJobResponseJob createdOn(OffsetDateTime createdOn) {
  ...
  public GetJobResponseJob lastModifiedOn(OffsetDateTime lastModifiedOn) {
  ...
  public GetJobResponseJob executionProperty(CreateJobRequestExecutionProperty executionProperty) {
  ...
  public GetJobResponseJob command(CreateJobRequestCommand command) {
  ...
  public GetJobResponseJob defaultArguments(Map defaultArguments) {
  ...
  public GetJobResponseJob nonOverridableArguments(Map nonOverridableArguments) {
  ...
  public GetJobResponseJob connections(CreateJobRequestConnections connections) {
  ...
  public GetJobResponseJob maxRetries(Integer maxRetries) {
  ...
  public GetJobResponseJob allocatedCapacity(Integer allocatedCapacity) {
  ...
  public GetJobResponseJob timeout(Integer timeout) {
  ...
  public GetJobResponseJob maxCapacity(Double maxCapacity) {
  ...
  public GetJobResponseJob workerType(WorkerType workerType) {
  ...
  public GetJobResponseJob numberOfWorkers(Integer numberOfWorkers) {
  ...
  public GetJobResponseJob securityConfiguration(String securityConfiguration) {
  ...
  public GetJobResponseJob notificationProperty(CreateJobRequestNotificationProperty notificationProperty) {
  ...
  public GetJobResponseJob glueVersion(String glueVersion) {
  ...
  public GetJobResponseJob codeGenConfigurationNodes(Map codeGenConfigurationNodes) {
  ...
  public GetJobResponseJob executionClass(ExecutionClass executionClass) {
  ...
  public GetJobResponseJob sourceControlDetails(CreateJobRequestSourceControlDetails sourceControlDetails) {
  ...
  public boolean equals(Object o) {
    ...
    GetJobResponseJob getJobResponseJob = (GetJobResponseJob) o;
    return Objects.equals(this.name, getJobResponseJob.name) &&
        Objects.equals(this.description, getJobResponseJob.description) &&
        Objects.equals(this.logUri, getJobResponseJob.logUri) &&
        Objects.equals(this.role, getJobResponseJob.role) &&
        Objects.equals(this.createdOn, getJobResponseJob.createdOn) &&
        Objects.equals(this.lastModifiedOn, getJobResponseJob.lastModifiedOn) &&
        Objects.equals(this.executionProperty, getJobResponseJob.executionProperty) &&
        Objects.equals(this.command, getJobResponseJob.command) &&
        Objects.equals(this.defaultArguments, getJobResponseJob.defaultArguments) &&
        Objects.equals(this.nonOverridableArguments, getJobResponseJob.nonOverridableArguments) &&
        Objects.equals(this.connections, getJobResponseJob.connections) &&
        Objects.equals(this.maxRetries, getJobResponseJob.maxRetries) &&
        Objects.equals(this.allocatedCapacity, getJobResponseJob.allocatedCapacity) &&
        Objects.equals(this.timeout, getJobResponseJob.timeout) &&
        Objects.equals(this.maxCapacity, getJobResponseJob.maxCapacity) &&
        Objects.equals(this.workerType, getJobResponseJob.workerType) &&
        Objects.equals(this.numberOfWorkers, getJobResponseJob.numberOfWorkers) &&
        Objects.equals(this.securityConfiguration, getJobResponseJob.securityConfiguration) &&
        Objects.equals(this.notificationProperty, getJobResponseJob.notificationProperty) &&
        Objects.equals(this.glueVersion, getJobResponseJob.glueVersion) &&
        Objects.equals(this.codeGenConfigurationNodes, getJobResponseJob.codeGenConfigurationNodes) &&
        Objects.equals(this.executionClass, getJobResponseJob.executionClass) &&
        Objects.equals(this.sourceControlDetails, getJobResponseJob.sourceControlDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetJobResponseJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetJobResponseJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetJobResponseJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetJobResponseJob is not found in the empty JSON string", GetJobResponseJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetJobResponseJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetJobResponseJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetJobResponseJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetJobResponseJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetJobResponseJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetJobResponseJob.class));

       return (TypeAdapter<T>) new TypeAdapter<GetJobResponseJob>() {
           @Override
           public void write(JsonWriter out, GetJobResponseJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetJobResponseJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetJobResponseJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetJobResponseJob
   * @throws IOException if the JSON string is invalid with respect to GetJobResponseJob
   */
  public static GetJobResponseJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetJobResponseJob.class);
  }

  /**
   * Convert an instance of GetJobResponseJob to an JSON string
   *
   * @return JSON string
   */
