...
/**
 * JDBCConnectorSourceAdditionalOptions
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class JDBCConnectorSourceAdditionalOptions {
  ...
  public JDBCConnectorSourceAdditionalOptions() {
  }

  public JDBCConnectorSourceAdditionalOptions filterPredicate(String filterPredicate) {
  ...
  public JDBCConnectorSourceAdditionalOptions partitionColumn(String partitionColumn) {
  ...
  public JDBCConnectorSourceAdditionalOptions lowerBound(Integer lowerBound) {
  ...
  public JDBCConnectorSourceAdditionalOptions upperBound(Integer upperBound) {
  ...
  public JDBCConnectorSourceAdditionalOptions numPartitions(Integer numPartitions) {
  ...
  public JDBCConnectorSourceAdditionalOptions jobBookmarkKeys(List jobBookmarkKeys) {
  ...
  public JDBCConnectorSourceAdditionalOptions jobBookmarkKeysSortOrder(String jobBookmarkKeysSortOrder) {
  ...
  public JDBCConnectorSourceAdditionalOptions dataTypeMapping(Map dataTypeMapping) {
  ...
  public boolean equals(Object o) {
    ...
    JDBCConnectorSourceAdditionalOptions jdBCConnectorSourceAdditionalOptions = (JDBCConnectorSourceAdditionalOptions) o;
    return Objects.equals(this.filterPredicate, jdBCConnectorSourceAdditionalOptions.filterPredicate) &&
        Objects.equals(this.partitionColumn, jdBCConnectorSourceAdditionalOptions.partitionColumn) &&
        Objects.equals(this.lowerBound, jdBCConnectorSourceAdditionalOptions.lowerBound) &&
        Objects.equals(this.upperBound, jdBCConnectorSourceAdditionalOptions.upperBound) &&
        Objects.equals(this.numPartitions, jdBCConnectorSourceAdditionalOptions.numPartitions) &&
        Objects.equals(this.jobBookmarkKeys, jdBCConnectorSourceAdditionalOptions.jobBookmarkKeys) &&
        Objects.equals(this.jobBookmarkKeysSortOrder, jdBCConnectorSourceAdditionalOptions.jobBookmarkKeysSortOrder) &&
        Objects.equals(this.dataTypeMapping, jdBCConnectorSourceAdditionalOptions.dataTypeMapping);
  }
  ...
  public String toString() {
    ...
    sb.append("class JDBCConnectorSourceAdditionalOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JDBCConnectorSourceAdditionalOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JDBCConnectorSourceAdditionalOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JDBCConnectorSourceAdditionalOptions is not found in the empty JSON string", JDBCConnectorSourceAdditionalOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JDBCConnectorSourceAdditionalOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JDBCConnectorSourceAdditionalOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JDBCConnectorSourceAdditionalOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JDBCConnectorSourceAdditionalOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JDBCConnectorSourceAdditionalOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JDBCConnectorSourceAdditionalOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<JDBCConnectorSourceAdditionalOptions>() {
           @Override
           public void write(JsonWriter out, JDBCConnectorSourceAdditionalOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JDBCConnectorSourceAdditionalOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JDBCConnectorSourceAdditionalOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JDBCConnectorSourceAdditionalOptions
   * @throws IOException if the JSON string is invalid with respect to JDBCConnectorSourceAdditionalOptions
   */
  public static JDBCConnectorSourceAdditionalOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JDBCConnectorSourceAdditionalOptions.class);
  }

  /**
   * Convert an instance of JDBCConnectorSourceAdditionalOptions to an JSON string
   *
   * @return JSON string
   */
