...
public class CreateCsvClassifierRequest {
  ...
  public CreateCsvClassifierRequest() {
  }

  public CreateCsvClassifierRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateCsvClassifierRequest delimiter(String delimiter) {
  ...
  public CreateCsvClassifierRequest quoteSymbol(String quoteSymbol) {
  ...
  public CreateCsvClassifierRequest containsHeader(CsvHeaderOption containsHeader) {
  ...
  public CreateCsvClassifierRequest header(List header) {
    this.header = header;
    return this;
  }
  ...
  public CreateCsvClassifierRequest disableValueTrimming(Boolean disableValueTrimming) {
  ...
  public CreateCsvClassifierRequest allowSingleColumn(Boolean allowSingleColumn) {
  ...
  public CreateCsvClassifierRequest customDatatypeConfigured(Boolean customDatatypeConfigured) {
  ...
  public CreateCsvClassifierRequest customDatatypes(List customDatatypes) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCsvClassifierRequest createCsvClassifierRequest = (CreateCsvClassifierRequest) o;
    return Objects.equals(this.name, createCsvClassifierRequest.name) &&
        Objects.equals(this.delimiter, createCsvClassifierRequest.delimiter) &&
        Objects.equals(this.quoteSymbol, createCsvClassifierRequest.quoteSymbol) &&
        Objects.equals(this.containsHeader, createCsvClassifierRequest.containsHeader) &&
        Objects.equals(this.header, createCsvClassifierRequest.header) &&
        Objects.equals(this.disableValueTrimming, createCsvClassifierRequest.disableValueTrimming) &&
        Objects.equals(this.allowSingleColumn, createCsvClassifierRequest.allowSingleColumn) &&
        Objects.equals(this.customDatatypeConfigured, createCsvClassifierRequest.customDatatypeConfigured) &&
        Objects.equals(this.customDatatypes, createCsvClassifierRequest.customDatatypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCsvClassifierRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCsvClassifierRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCsvClassifierRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCsvClassifierRequest is not found in the empty JSON string", CreateCsvClassifierRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCsvClassifierRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCsvClassifierRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCsvClassifierRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCsvClassifierRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCsvClassifierRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCsvClassifierRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCsvClassifierRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCsvClassifierRequest>() {
           @Override
           public void write(JsonWriter out, CreateCsvClassifierRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCsvClassifierRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCsvClassifierRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCsvClassifierRequest
   * @throws IOException if the JSON string is invalid with respect to CreateCsvClassifierRequest
   */
  public static CreateCsvClassifierRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCsvClassifierRequest.class);
  }

  /**
   * Convert an instance of CreateCsvClassifierRequest to an JSON string
   *
   * @return JSON string
   */
