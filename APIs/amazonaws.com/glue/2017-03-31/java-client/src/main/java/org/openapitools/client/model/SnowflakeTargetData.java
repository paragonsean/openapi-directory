...
public class SnowflakeTargetData {
  ...
  public SnowflakeTargetData() {
  }

  public SnowflakeTargetData sourceType(String sourceType) {
  ...
  public SnowflakeTargetData connection(SnowflakeNodeDataConnection connection) {
  ...
  public SnowflakeTargetData schema(String schema) {
    this.schema = schema;
    return this;
  }
  ...
  public SnowflakeTargetData table(String table) {
    this.table = table;
    return this;
  }
  ...
  public SnowflakeTargetData database(String database) {
  ...
  public SnowflakeTargetData tempDir(String tempDir) {
  ...
  public SnowflakeTargetData iamRole(SnowflakeNodeDataIamRole iamRole) {
  ...
  public SnowflakeTargetData additionalOptions(Map additionalOptions) {
  ...
  public SnowflakeTargetData sampleQuery(String sampleQuery) {
  ...
  public SnowflakeTargetData preAction(String preAction) {
  ...
  public SnowflakeTargetData postAction(String postAction) {
  ...
  public SnowflakeTargetData action(String action) {
    this.action = action;
    return this;
  }
  ...
  public SnowflakeTargetData upsert(Boolean upsert) {
    this.upsert = upsert;
    return this;
  }
  ...
  public SnowflakeTargetData mergeAction(String mergeAction) {
  ...
  public SnowflakeTargetData mergeWhenMatched(String mergeWhenMatched) {
  ...
  public SnowflakeTargetData mergeWhenNotMatched(String mergeWhenNotMatched) {
  ...
  public SnowflakeTargetData mergeClause(String mergeClause) {
  ...
  public SnowflakeTargetData stagingTable(String stagingTable) {
  ...
  public SnowflakeTargetData selectedColumns(List selectedColumns) {
  ...
  public SnowflakeTargetData autoPushdown(Boolean autoPushdown) {
  ...
  public SnowflakeTargetData tableSchema(List tableSchema) {
  ...
  public boolean equals(Object o) {
    ...
    SnowflakeTargetData snowflakeTargetData = (SnowflakeTargetData) o;
    return Objects.equals(this.sourceType, snowflakeTargetData.sourceType) &&
        Objects.equals(this.connection, snowflakeTargetData.connection) &&
        Objects.equals(this.schema, snowflakeTargetData.schema) &&
        Objects.equals(this.table, snowflakeTargetData.table) &&
        Objects.equals(this.database, snowflakeTargetData.database) &&
        Objects.equals(this.tempDir, snowflakeTargetData.tempDir) &&
        Objects.equals(this.iamRole, snowflakeTargetData.iamRole) &&
        Objects.equals(this.additionalOptions, snowflakeTargetData.additionalOptions) &&
        Objects.equals(this.sampleQuery, snowflakeTargetData.sampleQuery) &&
        Objects.equals(this.preAction, snowflakeTargetData.preAction) &&
        Objects.equals(this.postAction, snowflakeTargetData.postAction) &&
        Objects.equals(this.action, snowflakeTargetData.action) &&
        Objects.equals(this.upsert, snowflakeTargetData.upsert) &&
        Objects.equals(this.mergeAction, snowflakeTargetData.mergeAction) &&
        Objects.equals(this.mergeWhenMatched, snowflakeTargetData.mergeWhenMatched) &&
        Objects.equals(this.mergeWhenNotMatched, snowflakeTargetData.mergeWhenNotMatched) &&
        Objects.equals(this.mergeClause, snowflakeTargetData.mergeClause) &&
        Objects.equals(this.stagingTable, snowflakeTargetData.stagingTable) &&
        Objects.equals(this.selectedColumns, snowflakeTargetData.selectedColumns) &&
        Objects.equals(this.autoPushdown, snowflakeTargetData.autoPushdown) &&
        Objects.equals(this.tableSchema, snowflakeTargetData.tableSchema);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnowflakeTargetData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SnowflakeTargetData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SnowflakeTargetData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnowflakeTargetData is not found in the empty JSON string", SnowflakeTargetData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SnowflakeTargetData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SnowflakeTargetData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnowflakeTargetData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnowflakeTargetData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnowflakeTargetData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnowflakeTargetData.class));

       return (TypeAdapter<T>) new TypeAdapter<SnowflakeTargetData>() {
           @Override
           public void write(JsonWriter out, SnowflakeTargetData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SnowflakeTargetData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SnowflakeTargetData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SnowflakeTargetData
   * @throws IOException if the JSON string is invalid with respect to SnowflakeTargetData
   */
  public static SnowflakeTargetData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnowflakeTargetData.class);
  }

  /**
   * Convert an instance of SnowflakeTargetData to an JSON string
   *
   * @return JSON string
   */
