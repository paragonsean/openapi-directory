...
public class ColumnStatisticsData {
  ...
  public ColumnStatisticsData type(ColumnStatisticsType type) {
    this.type = type;
    return this;
  }
  ...
  public ColumnStatisticsData booleanColumnStatisticsData(ColumnStatisticsDataBooleanColumnStatisticsData booleanColumnStatisticsData) {
  ...
  public ColumnStatisticsData dateColumnStatisticsData(ColumnStatisticsDataDateColumnStatisticsData dateColumnStatisticsData) {
  ...
  public ColumnStatisticsData decimalColumnStatisticsData(ColumnStatisticsDataDecimalColumnStatisticsData decimalColumnStatisticsData) {
  ...
  public ColumnStatisticsData doubleColumnStatisticsData(ColumnStatisticsDataDoubleColumnStatisticsData doubleColumnStatisticsData) {
  ...
  public ColumnStatisticsData longColumnStatisticsData(ColumnStatisticsDataLongColumnStatisticsData longColumnStatisticsData) {
  ...
  public ColumnStatisticsData stringColumnStatisticsData(ColumnStatisticsDataStringColumnStatisticsData stringColumnStatisticsData) {
  ...
  public ColumnStatisticsData binaryColumnStatisticsData(ColumnStatisticsDataBinaryColumnStatisticsData binaryColumnStatisticsData) {
  ...
  public boolean equals(Object o) {
    ...
    ColumnStatisticsData columnStatisticsData = (ColumnStatisticsData) o;
    return Objects.equals(this.type, columnStatisticsData.type) &&
        Objects.equals(this.booleanColumnStatisticsData, columnStatisticsData.booleanColumnStatisticsData) &&
        Objects.equals(this.dateColumnStatisticsData, columnStatisticsData.dateColumnStatisticsData) &&
        Objects.equals(this.decimalColumnStatisticsData, columnStatisticsData.decimalColumnStatisticsData) &&
        Objects.equals(this.doubleColumnStatisticsData, columnStatisticsData.doubleColumnStatisticsData) &&
        Objects.equals(this.longColumnStatisticsData, columnStatisticsData.longColumnStatisticsData) &&
        Objects.equals(this.stringColumnStatisticsData, columnStatisticsData.stringColumnStatisticsData) &&
        Objects.equals(this.binaryColumnStatisticsData, columnStatisticsData.binaryColumnStatisticsData);
  }
  ...
  public String toString() {
    ...
    sb.append("class ColumnStatisticsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColumnStatisticsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColumnStatisticsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ColumnStatisticsData is not found in the empty JSON string", ColumnStatisticsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColumnStatisticsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColumnStatisticsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ColumnStatisticsData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColumnStatisticsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColumnStatisticsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ColumnStatisticsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ColumnStatisticsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ColumnStatisticsData>() {
           @Override
           public void write(JsonWriter out, ColumnStatisticsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ColumnStatisticsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ColumnStatisticsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ColumnStatisticsData
   * @throws IOException if the JSON string is invalid with respect to ColumnStatisticsData
   */
  public static ColumnStatisticsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ColumnStatisticsData.class);
  }

  /**
   * Convert an instance of ColumnStatisticsData to an JSON string
   *
   * @return JSON string
   */
