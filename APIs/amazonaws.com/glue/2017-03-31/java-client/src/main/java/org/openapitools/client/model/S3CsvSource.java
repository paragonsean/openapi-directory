...
public class S3CsvSource {
  ...
  public S3CsvSource name(String name) {
    this.name = name;
    return this;
  }
  ...
  public S3CsvSource paths(List paths) {
    this.paths = paths;
    return this;
  }
  ...
  public S3CsvSource compressionType(CompressionType compressionType) {
  ...
  public S3CsvSource exclusions(List exclusions) {
  ...
  public S3CsvSource groupSize(String groupSize) {
  ...
  public S3CsvSource groupFiles(String groupFiles) {
  ...
  public S3CsvSource recurse(Boolean recurse) {
  ...
  public S3CsvSource maxBand(Integer maxBand) {
  ...
  public S3CsvSource maxFilesInBand(Integer maxFilesInBand) {
  ...
  public S3CsvSource additionalOptions(S3CsvSourceAdditionalOptions additionalOptions) {
  ...
  public S3CsvSource separator(Separator separator) {
  ...
  public S3CsvSource escaper(String escaper) {
  ...
  public S3CsvSource quoteChar(QuoteChar quoteChar) {
  ...
  public S3CsvSource multiline(Boolean multiline) {
  ...
  public S3CsvSource withHeader(Boolean withHeader) {
  ...
  public S3CsvSource writeHeader(Boolean writeHeader) {
  ...
  public S3CsvSource skipFirst(Boolean skipFirst) {
  ...
  public S3CsvSource optimizePerformance(Boolean optimizePerformance) {
  ...
  public S3CsvSource outputSchemas(List outputSchemas) {
  ...
  public boolean equals(Object o) {
    ...
    S3CsvSource s3CsvSource = (S3CsvSource) o;
    return Objects.equals(this.name, s3CsvSource.name) &&
        Objects.equals(this.paths, s3CsvSource.paths) &&
        Objects.equals(this.compressionType, s3CsvSource.compressionType) &&
        Objects.equals(this.exclusions, s3CsvSource.exclusions) &&
        Objects.equals(this.groupSize, s3CsvSource.groupSize) &&
        Objects.equals(this.groupFiles, s3CsvSource.groupFiles) &&
        Objects.equals(this.recurse, s3CsvSource.recurse) &&
        Objects.equals(this.maxBand, s3CsvSource.maxBand) &&
        Objects.equals(this.maxFilesInBand, s3CsvSource.maxFilesInBand) &&
        Objects.equals(this.additionalOptions, s3CsvSource.additionalOptions) &&
        Objects.equals(this.separator, s3CsvSource.separator) &&
        Objects.equals(this.escaper, s3CsvSource.escaper) &&
        Objects.equals(this.quoteChar, s3CsvSource.quoteChar) &&
        Objects.equals(this.multiline, s3CsvSource.multiline) &&
        Objects.equals(this.withHeader, s3CsvSource.withHeader) &&
        Objects.equals(this.writeHeader, s3CsvSource.writeHeader) &&
        Objects.equals(this.skipFirst, s3CsvSource.skipFirst) &&
        Objects.equals(this.optimizePerformance, s3CsvSource.optimizePerformance) &&
        Objects.equals(this.outputSchemas, s3CsvSource.outputSchemas);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3CsvSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3CsvSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3CsvSource is not found in the empty JSON string", S3CsvSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3CsvSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3CsvSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3CsvSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3CsvSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3CsvSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3CsvSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3CsvSource.class));

       return (TypeAdapter<T>) new TypeAdapter<S3CsvSource>() {
           @Override
           public void write(JsonWriter out, S3CsvSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3CsvSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3CsvSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3CsvSource
   * @throws IOException if the JSON string is invalid with respect to S3CsvSource
   */
  public static S3CsvSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3CsvSource.class);
  }

  /**
   * Convert an instance of S3CsvSource to an JSON string
   *
   * @return JSON string
   */
