...
/**
 * GetClassifierResponseClassifier
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class GetClassifierResponseClassifier {
  ...
  public GetClassifierResponseClassifier() {
  }

  public GetClassifierResponseClassifier grokClassifier(ClassifierGrokClassifier grokClassifier) {
  ...
  public GetClassifierResponseClassifier xmLClassifier(ClassifierXMLClassifier xmLClassifier) {
  ...
  public GetClassifierResponseClassifier jsonClassifier(ClassifierJsonClassifier jsonClassifier) {
  ...
  public GetClassifierResponseClassifier csvClassifier(ClassifierCsvClassifier csvClassifier) {
  ...
  public boolean equals(Object o) {
    ...
    GetClassifierResponseClassifier getClassifierResponseClassifier = (GetClassifierResponseClassifier) o;
    return Objects.equals(this.grokClassifier, getClassifierResponseClassifier.grokClassifier) &&
        Objects.equals(this.xmLClassifier, getClassifierResponseClassifier.xmLClassifier) &&
        Objects.equals(this.jsonClassifier, getClassifierResponseClassifier.jsonClassifier) &&
        Objects.equals(this.csvClassifier, getClassifierResponseClassifier.csvClassifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetClassifierResponseClassifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetClassifierResponseClassifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetClassifierResponseClassifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetClassifierResponseClassifier is not found in the empty JSON string", GetClassifierResponseClassifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetClassifierResponseClassifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetClassifierResponseClassifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetClassifierResponseClassifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetClassifierResponseClassifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetClassifierResponseClassifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetClassifierResponseClassifier.class));

       return (TypeAdapter<T>) new TypeAdapter<GetClassifierResponseClassifier>() {
           @Override
           public void write(JsonWriter out, GetClassifierResponseClassifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetClassifierResponseClassifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetClassifierResponseClassifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetClassifierResponseClassifier
   * @throws IOException if the JSON string is invalid with respect to GetClassifierResponseClassifier
   */
  public static GetClassifierResponseClassifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetClassifierResponseClassifier.class);
  }

  /**
   * Convert an instance of GetClassifierResponseClassifier to an JSON string
   *
   * @return JSON string
   */
