...
public class SnowflakeNodeData {
  ...
  public SnowflakeNodeData() {
  }

  public SnowflakeNodeData sourceType(String sourceType) {
  ...
  public SnowflakeNodeData connection(SnowflakeNodeDataConnection connection) {
  ...
  public SnowflakeNodeData schema(String schema) {
    this.schema = schema;
    return this;
  }
  ...
  public SnowflakeNodeData table(String table) {
    this.table = table;
    return this;
  }
  ...
  public SnowflakeNodeData database(String database) {
  ...
  public SnowflakeNodeData tempDir(String tempDir) {
  ...
  public SnowflakeNodeData iamRole(SnowflakeNodeDataIamRole iamRole) {
  ...
  public SnowflakeNodeData additionalOptions(Map additionalOptions) {
  ...
  public SnowflakeNodeData sampleQuery(String sampleQuery) {
  ...
  public SnowflakeNodeData preAction(String preAction) {
  ...
  public SnowflakeNodeData postAction(String postAction) {
  ...
  public SnowflakeNodeData action(String action) {
    this.action = action;
    return this;
  }
  ...
  public SnowflakeNodeData upsert(Boolean upsert) {
    this.upsert = upsert;
    return this;
  }
  ...
  public SnowflakeNodeData mergeAction(String mergeAction) {
  ...
  public SnowflakeNodeData mergeWhenMatched(String mergeWhenMatched) {
  ...
  public SnowflakeNodeData mergeWhenNotMatched(String mergeWhenNotMatched) {
  ...
  public SnowflakeNodeData mergeClause(String mergeClause) {
  ...
  public SnowflakeNodeData stagingTable(String stagingTable) {
  ...
  public SnowflakeNodeData selectedColumns(List selectedColumns) {
  ...
  public SnowflakeNodeData autoPushdown(Boolean autoPushdown) {
  ...
  public SnowflakeNodeData tableSchema(List tableSchema) {
  ...
  public boolean equals(Object o) {
    ...
    SnowflakeNodeData snowflakeNodeData = (SnowflakeNodeData) o;
    return Objects.equals(this.sourceType, snowflakeNodeData.sourceType) &&
        Objects.equals(this.connection, snowflakeNodeData.connection) &&
        Objects.equals(this.schema, snowflakeNodeData.schema) &&
        Objects.equals(this.table, snowflakeNodeData.table) &&
        Objects.equals(this.database, snowflakeNodeData.database) &&
        Objects.equals(this.tempDir, snowflakeNodeData.tempDir) &&
        Objects.equals(this.iamRole, snowflakeNodeData.iamRole) &&
        Objects.equals(this.additionalOptions, snowflakeNodeData.additionalOptions) &&
        Objects.equals(this.sampleQuery, snowflakeNodeData.sampleQuery) &&
        Objects.equals(this.preAction, snowflakeNodeData.preAction) &&
        Objects.equals(this.postAction, snowflakeNodeData.postAction) &&
        Objects.equals(this.action, snowflakeNodeData.action) &&
        Objects.equals(this.upsert, snowflakeNodeData.upsert) &&
        Objects.equals(this.mergeAction, snowflakeNodeData.mergeAction) &&
        Objects.equals(this.mergeWhenMatched, snowflakeNodeData.mergeWhenMatched) &&
        Objects.equals(this.mergeWhenNotMatched, snowflakeNodeData.mergeWhenNotMatched) &&
        Objects.equals(this.mergeClause, snowflakeNodeData.mergeClause) &&
        Objects.equals(this.stagingTable, snowflakeNodeData.stagingTable) &&
        Objects.equals(this.selectedColumns, snowflakeNodeData.selectedColumns) &&
        Objects.equals(this.autoPushdown, snowflakeNodeData.autoPushdown) &&
        Objects.equals(this.tableSchema, snowflakeNodeData.tableSchema);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnowflakeNodeData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SnowflakeNodeData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SnowflakeNodeData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnowflakeNodeData is not found in the empty JSON string", SnowflakeNodeData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SnowflakeNodeData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SnowflakeNodeData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnowflakeNodeData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnowflakeNodeData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnowflakeNodeData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnowflakeNodeData.class));

       return (TypeAdapter<T>) new TypeAdapter<SnowflakeNodeData>() {
           @Override
           public void write(JsonWriter out, SnowflakeNodeData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SnowflakeNodeData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SnowflakeNodeData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SnowflakeNodeData
   * @throws IOException if the JSON string is invalid with respect to SnowflakeNodeData
   */
  public static SnowflakeNodeData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnowflakeNodeData.class);
  }

  /**
   * Convert an instance of SnowflakeNodeData to an JSON string
   *
   * @return JSON string
   */
