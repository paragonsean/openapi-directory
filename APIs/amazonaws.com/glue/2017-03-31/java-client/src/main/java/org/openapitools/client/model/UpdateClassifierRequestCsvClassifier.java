...
/**
 * UpdateClassifierRequestCsvClassifier
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class UpdateClassifierRequestCsvClassifier {
  ...
  public UpdateClassifierRequestCsvClassifier() {
  }

  public UpdateClassifierRequestCsvClassifier name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateClassifierRequestCsvClassifier delimiter(String delimiter) {
  ...
  public UpdateClassifierRequestCsvClassifier quoteSymbol(String quoteSymbol) {
  ...
  public UpdateClassifierRequestCsvClassifier containsHeader(CsvHeaderOption containsHeader) {
  ...
  public UpdateClassifierRequestCsvClassifier header(List header) {
    this.header = header;
    return this;
  }
  ...
  public UpdateClassifierRequestCsvClassifier disableValueTrimming(Boolean disableValueTrimming) {
  ...
  public UpdateClassifierRequestCsvClassifier allowSingleColumn(Boolean allowSingleColumn) {
  ...
  public UpdateClassifierRequestCsvClassifier customDatatypeConfigured(Boolean customDatatypeConfigured) {
  ...
  public UpdateClassifierRequestCsvClassifier customDatatypes(List customDatatypes) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateClassifierRequestCsvClassifier updateClassifierRequestCsvClassifier = (UpdateClassifierRequestCsvClassifier) o;
    return Objects.equals(this.name, updateClassifierRequestCsvClassifier.name) &&
        Objects.equals(this.delimiter, updateClassifierRequestCsvClassifier.delimiter) &&
        Objects.equals(this.quoteSymbol, updateClassifierRequestCsvClassifier.quoteSymbol) &&
        Objects.equals(this.containsHeader, updateClassifierRequestCsvClassifier.containsHeader) &&
        Objects.equals(this.header, updateClassifierRequestCsvClassifier.header) &&
        Objects.equals(this.disableValueTrimming, updateClassifierRequestCsvClassifier.disableValueTrimming) &&
        Objects.equals(this.allowSingleColumn, updateClassifierRequestCsvClassifier.allowSingleColumn) &&
        Objects.equals(this.customDatatypeConfigured, updateClassifierRequestCsvClassifier.customDatatypeConfigured) &&
        Objects.equals(this.customDatatypes, updateClassifierRequestCsvClassifier.customDatatypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateClassifierRequestCsvClassifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateClassifierRequestCsvClassifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateClassifierRequestCsvClassifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateClassifierRequestCsvClassifier is not found in the empty JSON string", UpdateClassifierRequestCsvClassifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateClassifierRequestCsvClassifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateClassifierRequestCsvClassifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateClassifierRequestCsvClassifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateClassifierRequestCsvClassifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateClassifierRequestCsvClassifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateClassifierRequestCsvClassifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateClassifierRequestCsvClassifier.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateClassifierRequestCsvClassifier>() {
           @Override
           public void write(JsonWriter out, UpdateClassifierRequestCsvClassifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateClassifierRequestCsvClassifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateClassifierRequestCsvClassifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateClassifierRequestCsvClassifier
   * @throws IOException if the JSON string is invalid with respect to UpdateClassifierRequestCsvClassifier
   */
  public static UpdateClassifierRequestCsvClassifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateClassifierRequestCsvClassifier.class);
  }

  /**
   * Convert an instance of UpdateClassifierRequestCsvClassifier to an JSON string
   *
   * @return JSON string
   */
