...
public class CsvClassifier {
  ...
  public CsvClassifier name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CsvClassifier creationTime(OffsetDateTime creationTime) {
  ...
  public CsvClassifier lastUpdated(OffsetDateTime lastUpdated) {
  ...
  public CsvClassifier version(Integer version) {
  ...
  public CsvClassifier delimiter(String delimiter) {
  ...
  public CsvClassifier quoteSymbol(String quoteSymbol) {
  ...
  public CsvClassifier containsHeader(CsvHeaderOption containsHeader) {
  ...
  public CsvClassifier header(List header) {
    this.header = header;
    return this;
  }
  ...
  public CsvClassifier disableValueTrimming(Boolean disableValueTrimming) {
  ...
  public CsvClassifier allowSingleColumn(Boolean allowSingleColumn) {
  ...
  public CsvClassifier customDatatypeConfigured(Boolean customDatatypeConfigured) {
  ...
  public CsvClassifier customDatatypes(List customDatatypes) {
  ...
  public boolean equals(Object o) {
    ...
    CsvClassifier csvClassifier = (CsvClassifier) o;
    return Objects.equals(this.name, csvClassifier.name) &&
        Objects.equals(this.creationTime, csvClassifier.creationTime) &&
        Objects.equals(this.lastUpdated, csvClassifier.lastUpdated) &&
        Objects.equals(this.version, csvClassifier.version) &&
        Objects.equals(this.delimiter, csvClassifier.delimiter) &&
        Objects.equals(this.quoteSymbol, csvClassifier.quoteSymbol) &&
        Objects.equals(this.containsHeader, csvClassifier.containsHeader) &&
        Objects.equals(this.header, csvClassifier.header) &&
        Objects.equals(this.disableValueTrimming, csvClassifier.disableValueTrimming) &&
        Objects.equals(this.allowSingleColumn, csvClassifier.allowSingleColumn) &&
        Objects.equals(this.customDatatypeConfigured, csvClassifier.customDatatypeConfigured) &&
        Objects.equals(this.customDatatypes, csvClassifier.customDatatypes);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CsvClassifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CsvClassifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CsvClassifier is not found in the empty JSON string", CsvClassifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CsvClassifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CsvClassifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CsvClassifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CsvClassifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CsvClassifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CsvClassifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CsvClassifier.class));

       return (TypeAdapter<T>) new TypeAdapter<CsvClassifier>() {
           @Override
           public void write(JsonWriter out, CsvClassifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CsvClassifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CsvClassifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CsvClassifier
   * @throws IOException if the JSON string is invalid with respect to CsvClassifier
   */
  public static CsvClassifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CsvClassifier.class);
  }

  /**
   * Convert an instance of CsvClassifier to an JSON string
   *
   * @return JSON string
   */
