...
public class GetTableResponseTable {
  ...
  public GetTableResponseTable() {
  }

  public GetTableResponseTable name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetTableResponseTable databaseName(String databaseName) {
  ...
  public GetTableResponseTable description(String description) {
  ...
  public GetTableResponseTable owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GetTableResponseTable createTime(OffsetDateTime createTime) {
  ...
  public GetTableResponseTable updateTime(OffsetDateTime updateTime) {
  ...
  public GetTableResponseTable lastAccessTime(OffsetDateTime lastAccessTime) {
  ...
  public GetTableResponseTable lastAnalyzedTime(OffsetDateTime lastAnalyzedTime) {
  ...
  public GetTableResponseTable retention(Integer retention) {
  ...
  public GetTableResponseTable storageDescriptor(TableInputStorageDescriptor storageDescriptor) {
  ...
  public GetTableResponseTable partitionKeys(List partitionKeys) {
  ...
  public GetTableResponseTable viewOriginalText(String viewOriginalText) {
  ...
  public GetTableResponseTable viewExpandedText(String viewExpandedText) {
  ...
  public GetTableResponseTable tableType(String tableType) {
  ...
  public GetTableResponseTable parameters(Map parameters) {
  ...
  public GetTableResponseTable createdBy(String createdBy) {
  ...
  public GetTableResponseTable isRegisteredWithLakeFormation(Boolean isRegisteredWithLakeFormation) {
  ...
  public GetTableResponseTable targetTable(TableInputTargetTable targetTable) {
  ...
  public GetTableResponseTable catalogId(String catalogId) {
  ...
  public GetTableResponseTable versionId(String versionId) {
  ...
  public GetTableResponseTable federatedTable(TableFederatedTable federatedTable) {
  ...
  public boolean equals(Object o) {
    ...
    GetTableResponseTable getTableResponseTable = (GetTableResponseTable) o;
    return Objects.equals(this.name, getTableResponseTable.name) &&
        Objects.equals(this.databaseName, getTableResponseTable.databaseName) &&
        Objects.equals(this.description, getTableResponseTable.description) &&
        Objects.equals(this.owner, getTableResponseTable.owner) &&
        Objects.equals(this.createTime, getTableResponseTable.createTime) &&
        Objects.equals(this.updateTime, getTableResponseTable.updateTime) &&
        Objects.equals(this.lastAccessTime, getTableResponseTable.lastAccessTime) &&
        Objects.equals(this.lastAnalyzedTime, getTableResponseTable.lastAnalyzedTime) &&
        Objects.equals(this.retention, getTableResponseTable.retention) &&
        Objects.equals(this.storageDescriptor, getTableResponseTable.storageDescriptor) &&
        Objects.equals(this.partitionKeys, getTableResponseTable.partitionKeys) &&
        Objects.equals(this.viewOriginalText, getTableResponseTable.viewOriginalText) &&
        Objects.equals(this.viewExpandedText, getTableResponseTable.viewExpandedText) &&
        Objects.equals(this.tableType, getTableResponseTable.tableType) &&
        Objects.equals(this.parameters, getTableResponseTable.parameters) &&
        Objects.equals(this.createdBy, getTableResponseTable.createdBy) &&
        Objects.equals(this.isRegisteredWithLakeFormation, getTableResponseTable.isRegisteredWithLakeFormation) &&
        Objects.equals(this.targetTable, getTableResponseTable.targetTable) &&
        Objects.equals(this.catalogId, getTableResponseTable.catalogId) &&
        Objects.equals(this.versionId, getTableResponseTable.versionId) &&
        Objects.equals(this.federatedTable, getTableResponseTable.federatedTable);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTableResponseTable {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTableResponseTable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTableResponseTable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTableResponseTable is not found in the empty JSON string", GetTableResponseTable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTableResponseTable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTableResponseTable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTableResponseTable.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTableResponseTable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTableResponseTable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTableResponseTable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTableResponseTable.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTableResponseTable>() {
           @Override
           public void write(JsonWriter out, GetTableResponseTable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTableResponseTable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTableResponseTable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTableResponseTable
   * @throws IOException if the JSON string is invalid with respect to GetTableResponseTable
   */
  public static GetTableResponseTable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTableResponseTable.class);
  }

  /**
   * Convert an instance of GetTableResponseTable to an JSON string
   *
   * @return JSON string
   */
