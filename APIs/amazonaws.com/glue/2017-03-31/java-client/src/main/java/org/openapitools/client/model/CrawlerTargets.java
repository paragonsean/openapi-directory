...
public class CrawlerTargets {
  ...
  public CrawlerTargets s3Targets(List s3Targets) {
  ...
  public CrawlerTargets jdbcTargets(List jdbcTargets) {
  ...
  public CrawlerTargets mongoDBTargets(List mongoDBTargets) {
  ...
  public CrawlerTargets dynamoDBTargets(List dynamoDBTargets) {
  ...
  public CrawlerTargets catalogTargets(List catalogTargets) {
  ...
  public CrawlerTargets deltaTargets(List deltaTargets) {
  ...
  public CrawlerTargets icebergTargets(List icebergTargets) {
  ...
  public CrawlerTargets hudiTargets(List hudiTargets) {
  ...
  public boolean equals(Object o) {
    ...
    CrawlerTargets crawlerTargets = (CrawlerTargets) o;
    return Objects.equals(this.s3Targets, crawlerTargets.s3Targets) &&
        Objects.equals(this.jdbcTargets, crawlerTargets.jdbcTargets) &&
        Objects.equals(this.mongoDBTargets, crawlerTargets.mongoDBTargets) &&
        Objects.equals(this.dynamoDBTargets, crawlerTargets.dynamoDBTargets) &&
        Objects.equals(this.catalogTargets, crawlerTargets.catalogTargets) &&
        Objects.equals(this.deltaTargets, crawlerTargets.deltaTargets) &&
        Objects.equals(this.icebergTargets, crawlerTargets.icebergTargets) &&
        Objects.equals(this.hudiTargets, crawlerTargets.hudiTargets);
  }
  ...
  public String toString() {
    ...
    sb.append("class CrawlerTargets {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CrawlerTargets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CrawlerTargets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CrawlerTargets is not found in the empty JSON string", CrawlerTargets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CrawlerTargets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CrawlerTargets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CrawlerTargets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CrawlerTargets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CrawlerTargets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CrawlerTargets.class));

       return (TypeAdapter<T>) new TypeAdapter<CrawlerTargets>() {
           @Override
           public void write(JsonWriter out, CrawlerTargets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CrawlerTargets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CrawlerTargets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CrawlerTargets
   * @throws IOException if the JSON string is invalid with respect to CrawlerTargets
   */
  public static CrawlerTargets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CrawlerTargets.class);
  }

  /**
   * Convert an instance of CrawlerTargets to an JSON string
   *
   * @return JSON string
   */
