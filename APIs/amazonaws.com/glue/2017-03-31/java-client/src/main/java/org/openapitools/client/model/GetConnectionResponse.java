...
public class GetConnectionResponse {
  ...
  private GetConnectionResponseConnection connection;

  public GetConnectionResponse() {
  }

  public GetConnectionResponse connection(GetConnectionResponseConnection connection) {
  ...
  public GetConnectionResponseConnection getConnection() {
    return connection;
  }

  public void setConnection(GetConnectionResponseConnection connection) {
    this.connection = connection;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connection, getConnectionResponse.connection);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Connection") != null && !jsonObj.get("Connection").isJsonNull()) {
        GetConnectionResponseConnection.validateJsonElement(jsonObj.get("Connection"));
      }
  }
