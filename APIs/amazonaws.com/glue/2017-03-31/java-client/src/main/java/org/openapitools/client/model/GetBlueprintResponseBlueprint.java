...
/**
 * GetBlueprintResponseBlueprint
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class GetBlueprintResponseBlueprint {
  ...
  public GetBlueprintResponseBlueprint() {
  }

  public GetBlueprintResponseBlueprint name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetBlueprintResponseBlueprint description(String description) {
  ...
  public GetBlueprintResponseBlueprint createdOn(OffsetDateTime createdOn) {
  ...
  public GetBlueprintResponseBlueprint lastModifiedOn(OffsetDateTime lastModifiedOn) {
  ...
  public GetBlueprintResponseBlueprint parameterSpec(String parameterSpec) {
  ...
  public GetBlueprintResponseBlueprint blueprintLocation(String blueprintLocation) {
  ...
  public GetBlueprintResponseBlueprint blueprintServiceLocation(String blueprintServiceLocation) {
  ...
  public GetBlueprintResponseBlueprint status(BlueprintStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetBlueprintResponseBlueprint errorMessage(String errorMessage) {
  ...
  public GetBlueprintResponseBlueprint lastActiveDefinition(BlueprintLastActiveDefinition lastActiveDefinition) {
  ...
  public boolean equals(Object o) {
    ...
    GetBlueprintResponseBlueprint getBlueprintResponseBlueprint = (GetBlueprintResponseBlueprint) o;
    return Objects.equals(this.name, getBlueprintResponseBlueprint.name) &&
        Objects.equals(this.description, getBlueprintResponseBlueprint.description) &&
        Objects.equals(this.createdOn, getBlueprintResponseBlueprint.createdOn) &&
        Objects.equals(this.lastModifiedOn, getBlueprintResponseBlueprint.lastModifiedOn) &&
        Objects.equals(this.parameterSpec, getBlueprintResponseBlueprint.parameterSpec) &&
        Objects.equals(this.blueprintLocation, getBlueprintResponseBlueprint.blueprintLocation) &&
        Objects.equals(this.blueprintServiceLocation, getBlueprintResponseBlueprint.blueprintServiceLocation) &&
        Objects.equals(this.status, getBlueprintResponseBlueprint.status) &&
        Objects.equals(this.errorMessage, getBlueprintResponseBlueprint.errorMessage) &&
        Objects.equals(this.lastActiveDefinition, getBlueprintResponseBlueprint.lastActiveDefinition);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBlueprintResponseBlueprint {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBlueprintResponseBlueprint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBlueprintResponseBlueprint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBlueprintResponseBlueprint is not found in the empty JSON string", GetBlueprintResponseBlueprint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBlueprintResponseBlueprint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBlueprintResponseBlueprint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBlueprintResponseBlueprint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBlueprintResponseBlueprint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBlueprintResponseBlueprint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBlueprintResponseBlueprint.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBlueprintResponseBlueprint>() {
           @Override
           public void write(JsonWriter out, GetBlueprintResponseBlueprint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBlueprintResponseBlueprint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBlueprintResponseBlueprint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBlueprintResponseBlueprint
   * @throws IOException if the JSON string is invalid with respect to GetBlueprintResponseBlueprint
   */
  public static GetBlueprintResponseBlueprint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlueprintResponseBlueprint.class);
  }

  /**
   * Convert an instance of GetBlueprintResponseBlueprint to an JSON string
   *
   * @return JSON string
   */
