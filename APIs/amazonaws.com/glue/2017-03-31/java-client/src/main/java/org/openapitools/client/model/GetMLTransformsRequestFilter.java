...
public class GetMLTransformsRequestFilter {
  ...
  public GetMLTransformsRequestFilter() {
  }

  public GetMLTransformsRequestFilter name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetMLTransformsRequestFilter transformType(TransformType transformType) {
  ...
  public GetMLTransformsRequestFilter status(TransformStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public GetMLTransformsRequestFilter glueVersion(String glueVersion) {
  ...
  public GetMLTransformsRequestFilter createdBefore(OffsetDateTime createdBefore) {
  ...
  public GetMLTransformsRequestFilter createdAfter(OffsetDateTime createdAfter) {
  ...
  public GetMLTransformsRequestFilter lastModifiedBefore(OffsetDateTime lastModifiedBefore) {
  ...
  public GetMLTransformsRequestFilter lastModifiedAfter(OffsetDateTime lastModifiedAfter) {
  ...
  public GetMLTransformsRequestFilter schema(List schema) {
    this.schema = schema;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetMLTransformsRequestFilter getMLTransformsRequestFilter = (GetMLTransformsRequestFilter) o;
    return Objects.equals(this.name, getMLTransformsRequestFilter.name) &&
        Objects.equals(this.transformType, getMLTransformsRequestFilter.transformType) &&
        Objects.equals(this.status, getMLTransformsRequestFilter.status) &&
        Objects.equals(this.glueVersion, getMLTransformsRequestFilter.glueVersion) &&
        Objects.equals(this.createdBefore, getMLTransformsRequestFilter.createdBefore) &&
        Objects.equals(this.createdAfter, getMLTransformsRequestFilter.createdAfter) &&
        Objects.equals(this.lastModifiedBefore, getMLTransformsRequestFilter.lastModifiedBefore) &&
        Objects.equals(this.lastModifiedAfter, getMLTransformsRequestFilter.lastModifiedAfter) &&
        Objects.equals(this.schema, getMLTransformsRequestFilter.schema);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMLTransformsRequestFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMLTransformsRequestFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMLTransformsRequestFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMLTransformsRequestFilter is not found in the empty JSON string", GetMLTransformsRequestFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMLTransformsRequestFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMLTransformsRequestFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMLTransformsRequestFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMLTransformsRequestFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMLTransformsRequestFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMLTransformsRequestFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMLTransformsRequestFilter>() {
           @Override
           public void write(JsonWriter out, GetMLTransformsRequestFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMLTransformsRequestFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMLTransformsRequestFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMLTransformsRequestFilter
   * @throws IOException if the JSON string is invalid with respect to GetMLTransformsRequestFilter
   */
  public static GetMLTransformsRequestFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMLTransformsRequestFilter.class);
  }

  /**
   * Convert an instance of GetMLTransformsRequestFilter to an JSON string
   *
   * @return JSON string
   */
