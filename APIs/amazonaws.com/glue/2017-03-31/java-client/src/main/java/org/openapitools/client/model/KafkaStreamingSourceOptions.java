...
public class KafkaStreamingSourceOptions {
  ...
  public KafkaStreamingSourceOptions bootstrapServers(String bootstrapServers) {
  ...
  public KafkaStreamingSourceOptions securityProtocol(String securityProtocol) {
  ...
  public KafkaStreamingSourceOptions connectionName(String connectionName) {
  ...
  public KafkaStreamingSourceOptions topicName(String topicName) {
  ...
  public KafkaStreamingSourceOptions assign(String assign) {
    this.assign = assign;
    return this;
  }
  ...
  public KafkaStreamingSourceOptions subscribePattern(String subscribePattern) {
  ...
  public KafkaStreamingSourceOptions classification(String classification) {
  ...
  public KafkaStreamingSourceOptions delimiter(String delimiter) {
  ...
  public KafkaStreamingSourceOptions startingOffsets(String startingOffsets) {
  ...
  public KafkaStreamingSourceOptions endingOffsets(String endingOffsets) {
  ...
  public KafkaStreamingSourceOptions pollTimeoutMs(Integer pollTimeoutMs) {
  ...
  public KafkaStreamingSourceOptions numRetries(Integer numRetries) {
  ...
  public KafkaStreamingSourceOptions retryIntervalMs(Integer retryIntervalMs) {
  ...
  public KafkaStreamingSourceOptions maxOffsetsPerTrigger(Integer maxOffsetsPerTrigger) {
  ...
  public KafkaStreamingSourceOptions minPartitions(Integer minPartitions) {
  ...
  public KafkaStreamingSourceOptions includeHeaders(Boolean includeHeaders) {
  ...
  public KafkaStreamingSourceOptions addRecordTimestamp(String addRecordTimestamp) {
  ...
  public KafkaStreamingSourceOptions emitConsumerLagMetrics(String emitConsumerLagMetrics) {
  ...
  public KafkaStreamingSourceOptions startingTimestamp(OffsetDateTime startingTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    KafkaStreamingSourceOptions kafkaStreamingSourceOptions = (KafkaStreamingSourceOptions) o;
    return Objects.equals(this.bootstrapServers, kafkaStreamingSourceOptions.bootstrapServers) &&
        Objects.equals(this.securityProtocol, kafkaStreamingSourceOptions.securityProtocol) &&
        Objects.equals(this.connectionName, kafkaStreamingSourceOptions.connectionName) &&
        Objects.equals(this.topicName, kafkaStreamingSourceOptions.topicName) &&
        Objects.equals(this.assign, kafkaStreamingSourceOptions.assign) &&
        Objects.equals(this.subscribePattern, kafkaStreamingSourceOptions.subscribePattern) &&
        Objects.equals(this.classification, kafkaStreamingSourceOptions.classification) &&
        Objects.equals(this.delimiter, kafkaStreamingSourceOptions.delimiter) &&
        Objects.equals(this.startingOffsets, kafkaStreamingSourceOptions.startingOffsets) &&
        Objects.equals(this.endingOffsets, kafkaStreamingSourceOptions.endingOffsets) &&
        Objects.equals(this.pollTimeoutMs, kafkaStreamingSourceOptions.pollTimeoutMs) &&
        Objects.equals(this.numRetries, kafkaStreamingSourceOptions.numRetries) &&
        Objects.equals(this.retryIntervalMs, kafkaStreamingSourceOptions.retryIntervalMs) &&
        Objects.equals(this.maxOffsetsPerTrigger, kafkaStreamingSourceOptions.maxOffsetsPerTrigger) &&
        Objects.equals(this.minPartitions, kafkaStreamingSourceOptions.minPartitions) &&
        Objects.equals(this.includeHeaders, kafkaStreamingSourceOptions.includeHeaders) &&
        Objects.equals(this.addRecordTimestamp, kafkaStreamingSourceOptions.addRecordTimestamp) &&
        Objects.equals(this.emitConsumerLagMetrics, kafkaStreamingSourceOptions.emitConsumerLagMetrics) &&
        Objects.equals(this.startingTimestamp, kafkaStreamingSourceOptions.startingTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class KafkaStreamingSourceOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KafkaStreamingSourceOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KafkaStreamingSourceOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KafkaStreamingSourceOptions is not found in the empty JSON string", KafkaStreamingSourceOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KafkaStreamingSourceOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KafkaStreamingSourceOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KafkaStreamingSourceOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KafkaStreamingSourceOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KafkaStreamingSourceOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KafkaStreamingSourceOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<KafkaStreamingSourceOptions>() {
           @Override
           public void write(JsonWriter out, KafkaStreamingSourceOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KafkaStreamingSourceOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KafkaStreamingSourceOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KafkaStreamingSourceOptions
   * @throws IOException if the JSON string is invalid with respect to KafkaStreamingSourceOptions
   */
  public static KafkaStreamingSourceOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KafkaStreamingSourceOptions.class);
  }

  /**
   * Convert an instance of KafkaStreamingSourceOptions to an JSON string
   *
   * @return JSON string
   */
