...
/**
 * TableInputStorageDescriptor
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class TableInputStorageDescriptor {
  ...
  public TableInputStorageDescriptor() {
  }

  public TableInputStorageDescriptor columns(List columns) {
  ...
  public TableInputStorageDescriptor location(String location) {
  ...
  public TableInputStorageDescriptor additionalLocations(List additionalLocations) {
  ...
  public TableInputStorageDescriptor inputFormat(String inputFormat) {
  ...
  public TableInputStorageDescriptor outputFormat(String outputFormat) {
  ...
  public TableInputStorageDescriptor compressed(Boolean compressed) {
  ...
  public TableInputStorageDescriptor numberOfBuckets(Integer numberOfBuckets) {
  ...
  public TableInputStorageDescriptor serdeInfo(StorageDescriptorSerdeInfo serdeInfo) {
  ...
  public TableInputStorageDescriptor bucketColumns(List bucketColumns) {
  ...
  public TableInputStorageDescriptor sortColumns(List sortColumns) {
  ...
  public TableInputStorageDescriptor parameters(Map parameters) {
  ...
  public TableInputStorageDescriptor skewedInfo(StorageDescriptorSkewedInfo skewedInfo) {
  ...
  public TableInputStorageDescriptor storedAsSubDirectories(Boolean storedAsSubDirectories) {
  ...
  public TableInputStorageDescriptor schemaReference(StorageDescriptorSchemaReference schemaReference) {
  ...
  public boolean equals(Object o) {
    ...
    TableInputStorageDescriptor tableInputStorageDescriptor = (TableInputStorageDescriptor) o;
    return Objects.equals(this.columns, tableInputStorageDescriptor.columns) &&
        Objects.equals(this.location, tableInputStorageDescriptor.location) &&
        Objects.equals(this.additionalLocations, tableInputStorageDescriptor.additionalLocations) &&
        Objects.equals(this.inputFormat, tableInputStorageDescriptor.inputFormat) &&
        Objects.equals(this.outputFormat, tableInputStorageDescriptor.outputFormat) &&
        Objects.equals(this.compressed, tableInputStorageDescriptor.compressed) &&
        Objects.equals(this.numberOfBuckets, tableInputStorageDescriptor.numberOfBuckets) &&
        Objects.equals(this.serdeInfo, tableInputStorageDescriptor.serdeInfo) &&
        Objects.equals(this.bucketColumns, tableInputStorageDescriptor.bucketColumns) &&
        Objects.equals(this.sortColumns, tableInputStorageDescriptor.sortColumns) &&
        Objects.equals(this.parameters, tableInputStorageDescriptor.parameters) &&
        Objects.equals(this.skewedInfo, tableInputStorageDescriptor.skewedInfo) &&
        Objects.equals(this.storedAsSubDirectories, tableInputStorageDescriptor.storedAsSubDirectories) &&
        Objects.equals(this.schemaReference, tableInputStorageDescriptor.schemaReference);
  }
  ...
  public String toString() {
    ...
    sb.append("class TableInputStorageDescriptor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TableInputStorageDescriptor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TableInputStorageDescriptor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TableInputStorageDescriptor is not found in the empty JSON string", TableInputStorageDescriptor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TableInputStorageDescriptor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TableInputStorageDescriptor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TableInputStorageDescriptor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TableInputStorageDescriptor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TableInputStorageDescriptor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TableInputStorageDescriptor.class));

       return (TypeAdapter<T>) new TypeAdapter<TableInputStorageDescriptor>() {
           @Override
           public void write(JsonWriter out, TableInputStorageDescriptor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TableInputStorageDescriptor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TableInputStorageDescriptor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TableInputStorageDescriptor
   * @throws IOException if the JSON string is invalid with respect to TableInputStorageDescriptor
   */
  public static TableInputStorageDescriptor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TableInputStorageDescriptor.class);
  }

  /**
   * Convert an instance of TableInputStorageDescriptor to an JSON string
   *
   * @return JSON string
   */
