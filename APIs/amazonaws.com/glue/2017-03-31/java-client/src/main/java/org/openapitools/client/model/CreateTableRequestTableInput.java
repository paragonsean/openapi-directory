...
/**
 * CreateTableRequestTableInput
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class CreateTableRequestTableInput {
  ...
  public CreateTableRequestTableInput() {
  }

  public CreateTableRequestTableInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateTableRequestTableInput description(String description) {
  ...
  public CreateTableRequestTableInput owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public CreateTableRequestTableInput lastAccessTime(OffsetDateTime lastAccessTime) {
  ...
  public CreateTableRequestTableInput lastAnalyzedTime(OffsetDateTime lastAnalyzedTime) {
  ...
  public CreateTableRequestTableInput retention(Integer retention) {
  ...
  public CreateTableRequestTableInput storageDescriptor(TableInputStorageDescriptor storageDescriptor) {
  ...
  public CreateTableRequestTableInput partitionKeys(List partitionKeys) {
  ...
  public CreateTableRequestTableInput viewOriginalText(String viewOriginalText) {
  ...
  public CreateTableRequestTableInput viewExpandedText(String viewExpandedText) {
  ...
  public CreateTableRequestTableInput tableType(String tableType) {
  ...
  public CreateTableRequestTableInput parameters(Map parameters) {
  ...
  public CreateTableRequestTableInput targetTable(TableInputTargetTable targetTable) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTableRequestTableInput createTableRequestTableInput = (CreateTableRequestTableInput) o;
    return Objects.equals(this.name, createTableRequestTableInput.name) &&
        Objects.equals(this.description, createTableRequestTableInput.description) &&
        Objects.equals(this.owner, createTableRequestTableInput.owner) &&
        Objects.equals(this.lastAccessTime, createTableRequestTableInput.lastAccessTime) &&
        Objects.equals(this.lastAnalyzedTime, createTableRequestTableInput.lastAnalyzedTime) &&
        Objects.equals(this.retention, createTableRequestTableInput.retention) &&
        Objects.equals(this.storageDescriptor, createTableRequestTableInput.storageDescriptor) &&
        Objects.equals(this.partitionKeys, createTableRequestTableInput.partitionKeys) &&
        Objects.equals(this.viewOriginalText, createTableRequestTableInput.viewOriginalText) &&
        Objects.equals(this.viewExpandedText, createTableRequestTableInput.viewExpandedText) &&
        Objects.equals(this.tableType, createTableRequestTableInput.tableType) &&
        Objects.equals(this.parameters, createTableRequestTableInput.parameters) &&
        Objects.equals(this.targetTable, createTableRequestTableInput.targetTable);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTableRequestTableInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTableRequestTableInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTableRequestTableInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTableRequestTableInput is not found in the empty JSON string", CreateTableRequestTableInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTableRequestTableInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTableRequestTableInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateTableRequestTableInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTableRequestTableInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTableRequestTableInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTableRequestTableInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTableRequestTableInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTableRequestTableInput>() {
           @Override
           public void write(JsonWriter out, CreateTableRequestTableInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTableRequestTableInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTableRequestTableInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTableRequestTableInput
   * @throws IOException if the JSON string is invalid with respect to CreateTableRequestTableInput
   */
  public static CreateTableRequestTableInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTableRequestTableInput.class);
  }

  /**
   * Convert an instance of CreateTableRequestTableInput to an JSON string
   *
   * @return JSON string
   */
