...
public class DevEndpoint {
  ...
  public DevEndpoint endpointName(String endpointName) {
  ...
  public DevEndpoint roleArn(String roleArn) {
  ...
  public DevEndpoint securityGroupIds(List securityGroupIds) {
  ...
  public DevEndpoint subnetId(String subnetId) {
  ...
  public DevEndpoint yarnEndpointAddress(String yarnEndpointAddress) {
  ...
  public DevEndpoint privateAddress(String privateAddress) {
  ...
  public DevEndpoint zeppelinRemoteSparkInterpreterPort(Integer zeppelinRemoteSparkInterpreterPort) {
  ...
  public DevEndpoint publicAddress(String publicAddress) {
  ...
  public DevEndpoint status(String status) {
    this.status = status;
    return this;
  }
  ...
  public DevEndpoint workerType(WorkerType workerType) {
  ...
  public DevEndpoint glueVersion(String glueVersion) {
  ...
  public DevEndpoint numberOfWorkers(Integer numberOfWorkers) {
  ...
  public DevEndpoint numberOfNodes(Integer numberOfNodes) {
  ...
  public DevEndpoint availabilityZone(String availabilityZone) {
  ...
  public DevEndpoint vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public DevEndpoint extraPythonLibsS3Path(String extraPythonLibsS3Path) {
  ...
  public DevEndpoint extraJarsS3Path(String extraJarsS3Path) {
  ...
  public DevEndpoint failureReason(String failureReason) {
  ...
  public DevEndpoint lastUpdateStatus(String lastUpdateStatus) {
  ...
  public DevEndpoint createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public DevEndpoint lastModifiedTimestamp(OffsetDateTime lastModifiedTimestamp) {
  ...
  public DevEndpoint publicKey(String publicKey) {
  ...
  public DevEndpoint publicKeys(List publicKeys) {
  ...
  public DevEndpoint securityConfiguration(String securityConfiguration) {
  ...
  public DevEndpoint arguments(Map arguments) {
  ...
  public boolean equals(Object o) {
    ...
    DevEndpoint devEndpoint = (DevEndpoint) o;
    return Objects.equals(this.endpointName, devEndpoint.endpointName) &&
        Objects.equals(this.roleArn, devEndpoint.roleArn) &&
        Objects.equals(this.securityGroupIds, devEndpoint.securityGroupIds) &&
        Objects.equals(this.subnetId, devEndpoint.subnetId) &&
        Objects.equals(this.yarnEndpointAddress, devEndpoint.yarnEndpointAddress) &&
        Objects.equals(this.privateAddress, devEndpoint.privateAddress) &&
        Objects.equals(this.zeppelinRemoteSparkInterpreterPort, devEndpoint.zeppelinRemoteSparkInterpreterPort) &&
        Objects.equals(this.publicAddress, devEndpoint.publicAddress) &&
        Objects.equals(this.status, devEndpoint.status) &&
        Objects.equals(this.workerType, devEndpoint.workerType) &&
        Objects.equals(this.glueVersion, devEndpoint.glueVersion) &&
        Objects.equals(this.numberOfWorkers, devEndpoint.numberOfWorkers) &&
        Objects.equals(this.numberOfNodes, devEndpoint.numberOfNodes) &&
        Objects.equals(this.availabilityZone, devEndpoint.availabilityZone) &&
        Objects.equals(this.vpcId, devEndpoint.vpcId) &&
        Objects.equals(this.extraPythonLibsS3Path, devEndpoint.extraPythonLibsS3Path) &&
        Objects.equals(this.extraJarsS3Path, devEndpoint.extraJarsS3Path) &&
        Objects.equals(this.failureReason, devEndpoint.failureReason) &&
        Objects.equals(this.lastUpdateStatus, devEndpoint.lastUpdateStatus) &&
        Objects.equals(this.createdTimestamp, devEndpoint.createdTimestamp) &&
        Objects.equals(this.lastModifiedTimestamp, devEndpoint.lastModifiedTimestamp) &&
        Objects.equals(this.publicKey, devEndpoint.publicKey) &&
        Objects.equals(this.publicKeys, devEndpoint.publicKeys) &&
        Objects.equals(this.securityConfiguration, devEndpoint.securityConfiguration) &&
        Objects.equals(this.arguments, devEndpoint.arguments);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DevEndpoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DevEndpoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DevEndpoint is not found in the empty JSON string", DevEndpoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DevEndpoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DevEndpoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DevEndpoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DevEndpoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DevEndpoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DevEndpoint.class));

       return (TypeAdapter<T>) new TypeAdapter<DevEndpoint>() {
           @Override
           public void write(JsonWriter out, DevEndpoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DevEndpoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DevEndpoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DevEndpoint
   * @throws IOException if the JSON string is invalid with respect to DevEndpoint
   */
  public static DevEndpoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DevEndpoint.class);
  }

  /**
   * Convert an instance of DevEndpoint to an JSON string
   *
   * @return JSON string
   */
