...
/**
 * CodeGenConfigurationNodeS3JsonSource
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class CodeGenConfigurationNodeS3JsonSource {
  ...
  public CodeGenConfigurationNodeS3JsonSource() {
  }

  public CodeGenConfigurationNodeS3JsonSource name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CodeGenConfigurationNodeS3JsonSource paths(List paths) {
    this.paths = paths;
    return this;
  }
  ...
  public CodeGenConfigurationNodeS3JsonSource compressionType(CompressionType compressionType) {
  ...
  public CodeGenConfigurationNodeS3JsonSource exclusions(List exclusions) {
  ...
  public CodeGenConfigurationNodeS3JsonSource groupSize(String groupSize) {
  ...
  public CodeGenConfigurationNodeS3JsonSource groupFiles(String groupFiles) {
  ...
  public CodeGenConfigurationNodeS3JsonSource recurse(Boolean recurse) {
  ...
  public CodeGenConfigurationNodeS3JsonSource maxBand(Integer maxBand) {
  ...
  public CodeGenConfigurationNodeS3JsonSource maxFilesInBand(Integer maxFilesInBand) {
  ...
  public CodeGenConfigurationNodeS3JsonSource additionalOptions(S3CsvSourceAdditionalOptions additionalOptions) {
  ...
  public CodeGenConfigurationNodeS3JsonSource jsonPath(String jsonPath) {
  ...
  public CodeGenConfigurationNodeS3JsonSource multiline(Boolean multiline) {
  ...
  public CodeGenConfigurationNodeS3JsonSource outputSchemas(List outputSchemas) {
  ...
  public boolean equals(Object o) {
    ...
    CodeGenConfigurationNodeS3JsonSource codeGenConfigurationNodeS3JsonSource = (CodeGenConfigurationNodeS3JsonSource) o;
    return Objects.equals(this.name, codeGenConfigurationNodeS3JsonSource.name) &&
        Objects.equals(this.paths, codeGenConfigurationNodeS3JsonSource.paths) &&
        Objects.equals(this.compressionType, codeGenConfigurationNodeS3JsonSource.compressionType) &&
        Objects.equals(this.exclusions, codeGenConfigurationNodeS3JsonSource.exclusions) &&
        Objects.equals(this.groupSize, codeGenConfigurationNodeS3JsonSource.groupSize) &&
        Objects.equals(this.groupFiles, codeGenConfigurationNodeS3JsonSource.groupFiles) &&
        Objects.equals(this.recurse, codeGenConfigurationNodeS3JsonSource.recurse) &&
        Objects.equals(this.maxBand, codeGenConfigurationNodeS3JsonSource.maxBand) &&
        Objects.equals(this.maxFilesInBand, codeGenConfigurationNodeS3JsonSource.maxFilesInBand) &&
        Objects.equals(this.additionalOptions, codeGenConfigurationNodeS3JsonSource.additionalOptions) &&
        Objects.equals(this.jsonPath, codeGenConfigurationNodeS3JsonSource.jsonPath) &&
        Objects.equals(this.multiline, codeGenConfigurationNodeS3JsonSource.multiline) &&
        Objects.equals(this.outputSchemas, codeGenConfigurationNodeS3JsonSource.outputSchemas);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, paths, compressionType, exclusions, groupSize, groupFiles, recurse, maxBand, maxFilesInBand, additionalOptions, jsonPath, multiline, outputSchemas);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CodeGenConfigurationNodeS3JsonSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodeGenConfigurationNodeS3JsonSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodeGenConfigurationNodeS3JsonSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodeGenConfigurationNodeS3JsonSource is not found in the empty JSON string", CodeGenConfigurationNodeS3JsonSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodeGenConfigurationNodeS3JsonSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodeGenConfigurationNodeS3JsonSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodeGenConfigurationNodeS3JsonSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodeGenConfigurationNodeS3JsonSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodeGenConfigurationNodeS3JsonSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodeGenConfigurationNodeS3JsonSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodeGenConfigurationNodeS3JsonSource.class));

       return (TypeAdapter<T>) new TypeAdapter<CodeGenConfigurationNodeS3JsonSource>() {
           @Override
           public void write(JsonWriter out, CodeGenConfigurationNodeS3JsonSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodeGenConfigurationNodeS3JsonSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CodeGenConfigurationNodeS3JsonSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CodeGenConfigurationNodeS3JsonSource
   * @throws IOException if the JSON string is invalid with respect to CodeGenConfigurationNodeS3JsonSource
   */
  public static CodeGenConfigurationNodeS3JsonSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodeGenConfigurationNodeS3JsonSource.class);
  }

  /**
   * Convert an instance of CodeGenConfigurationNodeS3JsonSource to an JSON string
   *
   * @return JSON string
   */
