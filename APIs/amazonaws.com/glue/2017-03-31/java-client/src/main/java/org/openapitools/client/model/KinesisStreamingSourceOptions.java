...
public class KinesisStreamingSourceOptions {
  ...
  public KinesisStreamingSourceOptions endpointUrl(String endpointUrl) {
  ...
  public KinesisStreamingSourceOptions streamName(String streamName) {
  ...
  public KinesisStreamingSourceOptions classification(String classification) {
  ...
  public KinesisStreamingSourceOptions delimiter(String delimiter) {
  ...
  public KinesisStreamingSourceOptions startingPosition(StartingPosition startingPosition) {
  ...
  public KinesisStreamingSourceOptions maxFetchTimeInMs(Integer maxFetchTimeInMs) {
  ...
  public KinesisStreamingSourceOptions maxFetchRecordsPerShard(Integer maxFetchRecordsPerShard) {
  ...
  public KinesisStreamingSourceOptions maxRecordPerRead(Integer maxRecordPerRead) {
  ...
  public KinesisStreamingSourceOptions addIdleTimeBetweenReads(Boolean addIdleTimeBetweenReads) {
  ...
  public KinesisStreamingSourceOptions idleTimeBetweenReadsInMs(Integer idleTimeBetweenReadsInMs) {
  ...
  public KinesisStreamingSourceOptions describeShardInterval(Integer describeShardInterval) {
  ...
  public KinesisStreamingSourceOptions numRetries(Integer numRetries) {
  ...
  public KinesisStreamingSourceOptions retryIntervalMs(Integer retryIntervalMs) {
  ...
  public KinesisStreamingSourceOptions maxRetryIntervalMs(Integer maxRetryIntervalMs) {
  ...
  public KinesisStreamingSourceOptions avoidEmptyBatches(Boolean avoidEmptyBatches) {
  ...
  public KinesisStreamingSourceOptions streamArn(String streamArn) {
  ...
  public KinesisStreamingSourceOptions roleArn(String roleArn) {
  ...
  public KinesisStreamingSourceOptions roleSessionName(String roleSessionName) {
  ...
  public KinesisStreamingSourceOptions addRecordTimestamp(String addRecordTimestamp) {
  ...
  public KinesisStreamingSourceOptions emitConsumerLagMetrics(String emitConsumerLagMetrics) {
  ...
  public KinesisStreamingSourceOptions startingTimestamp(OffsetDateTime startingTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    KinesisStreamingSourceOptions kinesisStreamingSourceOptions = (KinesisStreamingSourceOptions) o;
    return Objects.equals(this.endpointUrl, kinesisStreamingSourceOptions.endpointUrl) &&
        Objects.equals(this.streamName, kinesisStreamingSourceOptions.streamName) &&
        Objects.equals(this.classification, kinesisStreamingSourceOptions.classification) &&
        Objects.equals(this.delimiter, kinesisStreamingSourceOptions.delimiter) &&
        Objects.equals(this.startingPosition, kinesisStreamingSourceOptions.startingPosition) &&
        Objects.equals(this.maxFetchTimeInMs, kinesisStreamingSourceOptions.maxFetchTimeInMs) &&
        Objects.equals(this.maxFetchRecordsPerShard, kinesisStreamingSourceOptions.maxFetchRecordsPerShard) &&
        Objects.equals(this.maxRecordPerRead, kinesisStreamingSourceOptions.maxRecordPerRead) &&
        Objects.equals(this.addIdleTimeBetweenReads, kinesisStreamingSourceOptions.addIdleTimeBetweenReads) &&
        Objects.equals(this.idleTimeBetweenReadsInMs, kinesisStreamingSourceOptions.idleTimeBetweenReadsInMs) &&
        Objects.equals(this.describeShardInterval, kinesisStreamingSourceOptions.describeShardInterval) &&
        Objects.equals(this.numRetries, kinesisStreamingSourceOptions.numRetries) &&
        Objects.equals(this.retryIntervalMs, kinesisStreamingSourceOptions.retryIntervalMs) &&
        Objects.equals(this.maxRetryIntervalMs, kinesisStreamingSourceOptions.maxRetryIntervalMs) &&
        Objects.equals(this.avoidEmptyBatches, kinesisStreamingSourceOptions.avoidEmptyBatches) &&
        Objects.equals(this.streamArn, kinesisStreamingSourceOptions.streamArn) &&
        Objects.equals(this.roleArn, kinesisStreamingSourceOptions.roleArn) &&
        Objects.equals(this.roleSessionName, kinesisStreamingSourceOptions.roleSessionName) &&
        Objects.equals(this.addRecordTimestamp, kinesisStreamingSourceOptions.addRecordTimestamp) &&
        Objects.equals(this.emitConsumerLagMetrics, kinesisStreamingSourceOptions.emitConsumerLagMetrics) &&
        Objects.equals(this.startingTimestamp, kinesisStreamingSourceOptions.startingTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class KinesisStreamingSourceOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KinesisStreamingSourceOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KinesisStreamingSourceOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KinesisStreamingSourceOptions is not found in the empty JSON string", KinesisStreamingSourceOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KinesisStreamingSourceOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KinesisStreamingSourceOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KinesisStreamingSourceOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KinesisStreamingSourceOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KinesisStreamingSourceOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KinesisStreamingSourceOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<KinesisStreamingSourceOptions>() {
           @Override
           public void write(JsonWriter out, KinesisStreamingSourceOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KinesisStreamingSourceOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KinesisStreamingSourceOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KinesisStreamingSourceOptions
   * @throws IOException if the JSON string is invalid with respect to KinesisStreamingSourceOptions
   */
  public static KinesisStreamingSourceOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KinesisStreamingSourceOptions.class);
  }

  /**
   * Convert an instance of KinesisStreamingSourceOptions to an JSON string
   *
   * @return JSON string
   */
