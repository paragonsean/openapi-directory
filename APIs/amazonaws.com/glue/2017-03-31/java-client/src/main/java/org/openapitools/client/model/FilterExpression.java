...
public class FilterExpression {
  ...
  public FilterExpression operation(FilterOperation operation) {
  ...
  public FilterExpression negated(Boolean negated) {
  ...
  public FilterExpression values(List values) {
    this.values = values;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.operation, filterExpression.operation) &&
        Objects.equals(this.negated, filterExpression.negated) &&
        Objects.equals(this.values, filterExpression.values);
  }

  @Override
  public int hashCode() {
    return Objects.hash(operation, negated, values);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : FilterExpression.openapiRequiredFields) {
      ...
      FilterOperation.validateJsonElement(jsonObj.get("Operation"));
