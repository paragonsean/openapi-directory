...
/**
 * AmazonRedshiftTargetData
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class AmazonRedshiftTargetData {
  ...
  public AmazonRedshiftTargetData() {
  }

  public AmazonRedshiftTargetData accessType(String accessType) {
  ...
  public AmazonRedshiftTargetData sourceType(String sourceType) {
  ...
  public AmazonRedshiftTargetData connection(AmazonRedshiftNodeDataConnection connection) {
  ...
  public AmazonRedshiftTargetData schema(AmazonRedshiftNodeDataSchema schema) {
    this.schema = schema;
    return this;
  }
  ...
  public AmazonRedshiftTargetData table(AmazonRedshiftNodeDataTable table) {
    this.table = table;
    return this;
  }
  ...
  public AmazonRedshiftTargetData catalogDatabase(AmazonRedshiftNodeDataCatalogDatabase catalogDatabase) {
  ...
  public AmazonRedshiftTargetData catalogTable(AmazonRedshiftNodeDataCatalogTable catalogTable) {
  ...
  public AmazonRedshiftTargetData catalogRedshiftSchema(String catalogRedshiftSchema) {
  ...
  public AmazonRedshiftTargetData catalogRedshiftTable(String catalogRedshiftTable) {
  ...
  public AmazonRedshiftTargetData tempDir(String tempDir) {
  ...
  public AmazonRedshiftTargetData iamRole(AmazonRedshiftNodeDataIamRole iamRole) {
  ...
  public AmazonRedshiftTargetData advancedOptions(List advancedOptions) {
  ...
  public AmazonRedshiftTargetData sampleQuery(String sampleQuery) {
  ...
  public AmazonRedshiftTargetData preAction(String preAction) {
  ...
  public AmazonRedshiftTargetData postAction(String postAction) {
  ...
  public AmazonRedshiftTargetData action(String action) {
    this.action = action;
    return this;
  }
  ...
  public AmazonRedshiftTargetData tablePrefix(String tablePrefix) {
  ...
  public AmazonRedshiftTargetData upsert(Boolean upsert) {
    this.upsert = upsert;
    return this;
  }
  ...
  public AmazonRedshiftTargetData mergeAction(String mergeAction) {
  ...
  public AmazonRedshiftTargetData mergeWhenMatched(String mergeWhenMatched) {
  ...
  public AmazonRedshiftTargetData mergeWhenNotMatched(String mergeWhenNotMatched) {
  ...
  public AmazonRedshiftTargetData mergeClause(String mergeClause) {
  ...
  public AmazonRedshiftTargetData crawlerConnection(String crawlerConnection) {
  ...
  public AmazonRedshiftTargetData tableSchema(List tableSchema) {
  ...
  public AmazonRedshiftTargetData stagingTable(String stagingTable) {
  ...
  public AmazonRedshiftTargetData selectedColumns(List selectedColumns) {
  ...
  public boolean equals(Object o) {
    ...
    AmazonRedshiftTargetData amazonRedshiftTargetData = (AmazonRedshiftTargetData) o;
    return Objects.equals(this.accessType, amazonRedshiftTargetData.accessType) &&
        Objects.equals(this.sourceType, amazonRedshiftTargetData.sourceType) &&
        Objects.equals(this.connection, amazonRedshiftTargetData.connection) &&
        Objects.equals(this.schema, amazonRedshiftTargetData.schema) &&
        Objects.equals(this.table, amazonRedshiftTargetData.table) &&
        Objects.equals(this.catalogDatabase, amazonRedshiftTargetData.catalogDatabase) &&
        Objects.equals(this.catalogTable, amazonRedshiftTargetData.catalogTable) &&
        Objects.equals(this.catalogRedshiftSchema, amazonRedshiftTargetData.catalogRedshiftSchema) &&
        Objects.equals(this.catalogRedshiftTable, amazonRedshiftTargetData.catalogRedshiftTable) &&
        Objects.equals(this.tempDir, amazonRedshiftTargetData.tempDir) &&
        Objects.equals(this.iamRole, amazonRedshiftTargetData.iamRole) &&
        Objects.equals(this.advancedOptions, amazonRedshiftTargetData.advancedOptions) &&
        Objects.equals(this.sampleQuery, amazonRedshiftTargetData.sampleQuery) &&
        Objects.equals(this.preAction, amazonRedshiftTargetData.preAction) &&
        Objects.equals(this.postAction, amazonRedshiftTargetData.postAction) &&
        Objects.equals(this.action, amazonRedshiftTargetData.action) &&
        Objects.equals(this.tablePrefix, amazonRedshiftTargetData.tablePrefix) &&
        Objects.equals(this.upsert, amazonRedshiftTargetData.upsert) &&
        Objects.equals(this.mergeAction, amazonRedshiftTargetData.mergeAction) &&
        Objects.equals(this.mergeWhenMatched, amazonRedshiftTargetData.mergeWhenMatched) &&
        Objects.equals(this.mergeWhenNotMatched, amazonRedshiftTargetData.mergeWhenNotMatched) &&
        Objects.equals(this.mergeClause, amazonRedshiftTargetData.mergeClause) &&
        Objects.equals(this.crawlerConnection, amazonRedshiftTargetData.crawlerConnection) &&
        Objects.equals(this.tableSchema, amazonRedshiftTargetData.tableSchema) &&
        Objects.equals(this.stagingTable, amazonRedshiftTargetData.stagingTable) &&
        Objects.equals(this.selectedColumns, amazonRedshiftTargetData.selectedColumns);
  }
  ...
  public String toString() {
    ...
    sb.append("class AmazonRedshiftTargetData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmazonRedshiftTargetData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmazonRedshiftTargetData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonRedshiftTargetData is not found in the empty JSON string", AmazonRedshiftTargetData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AmazonRedshiftTargetData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AmazonRedshiftTargetData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonRedshiftTargetData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonRedshiftTargetData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonRedshiftTargetData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonRedshiftTargetData.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonRedshiftTargetData>() {
           @Override
           public void write(JsonWriter out, AmazonRedshiftTargetData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AmazonRedshiftTargetData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AmazonRedshiftTargetData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AmazonRedshiftTargetData
   * @throws IOException if the JSON string is invalid with respect to AmazonRedshiftTargetData
   */
  public static AmazonRedshiftTargetData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonRedshiftTargetData.class);
  }

  /**
   * Convert an instance of AmazonRedshiftTargetData to an JSON string
   *
   * @return JSON string
   */
