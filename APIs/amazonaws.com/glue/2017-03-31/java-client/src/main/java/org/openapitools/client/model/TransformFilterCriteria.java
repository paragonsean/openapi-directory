...
public class TransformFilterCriteria {
  ...
  public TransformFilterCriteria name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TransformFilterCriteria transformType(TransformType transformType) {
  ...
  public TransformFilterCriteria status(TransformStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public TransformFilterCriteria glueVersion(String glueVersion) {
  ...
  public TransformFilterCriteria createdBefore(OffsetDateTime createdBefore) {
  ...
  public TransformFilterCriteria createdAfter(OffsetDateTime createdAfter) {
  ...
  public TransformFilterCriteria lastModifiedBefore(OffsetDateTime lastModifiedBefore) {
  ...
  public TransformFilterCriteria lastModifiedAfter(OffsetDateTime lastModifiedAfter) {
  ...
  public TransformFilterCriteria schema(List schema) {
    this.schema = schema;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TransformFilterCriteria transformFilterCriteria = (TransformFilterCriteria) o;
    return Objects.equals(this.name, transformFilterCriteria.name) &&
        Objects.equals(this.transformType, transformFilterCriteria.transformType) &&
        Objects.equals(this.status, transformFilterCriteria.status) &&
        Objects.equals(this.glueVersion, transformFilterCriteria.glueVersion) &&
        Objects.equals(this.createdBefore, transformFilterCriteria.createdBefore) &&
        Objects.equals(this.createdAfter, transformFilterCriteria.createdAfter) &&
        Objects.equals(this.lastModifiedBefore, transformFilterCriteria.lastModifiedBefore) &&
        Objects.equals(this.lastModifiedAfter, transformFilterCriteria.lastModifiedAfter) &&
        Objects.equals(this.schema, transformFilterCriteria.schema);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransformFilterCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransformFilterCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransformFilterCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransformFilterCriteria is not found in the empty JSON string", TransformFilterCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransformFilterCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransformFilterCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransformFilterCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransformFilterCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransformFilterCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransformFilterCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<TransformFilterCriteria>() {
           @Override
           public void write(JsonWriter out, TransformFilterCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransformFilterCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransformFilterCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransformFilterCriteria
   * @throws IOException if the JSON string is invalid with respect to TransformFilterCriteria
   */
  public static TransformFilterCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransformFilterCriteria.class);
  }

  /**
   * Convert an instance of TransformFilterCriteria to an JSON string
   *
   * @return JSON string
   */
