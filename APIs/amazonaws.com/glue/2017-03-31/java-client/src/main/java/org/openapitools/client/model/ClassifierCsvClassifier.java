...
public class ClassifierCsvClassifier {
  ...
  public ClassifierCsvClassifier name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ClassifierCsvClassifier creationTime(OffsetDateTime creationTime) {
  ...
  public ClassifierCsvClassifier lastUpdated(OffsetDateTime lastUpdated) {
  ...
  public ClassifierCsvClassifier version(Integer version) {
  ...
  public ClassifierCsvClassifier delimiter(String delimiter) {
  ...
  public ClassifierCsvClassifier quoteSymbol(String quoteSymbol) {
  ...
  public ClassifierCsvClassifier containsHeader(CsvHeaderOption containsHeader) {
  ...
  public ClassifierCsvClassifier header(List header) {
    this.header = header;
    return this;
  }
  ...
  public ClassifierCsvClassifier disableValueTrimming(Boolean disableValueTrimming) {
  ...
  public ClassifierCsvClassifier allowSingleColumn(Boolean allowSingleColumn) {
  ...
  public ClassifierCsvClassifier customDatatypeConfigured(Boolean customDatatypeConfigured) {
  ...
  public ClassifierCsvClassifier customDatatypes(List customDatatypes) {
  ...
  public boolean equals(Object o) {
    ...
    ClassifierCsvClassifier classifierCsvClassifier = (ClassifierCsvClassifier) o;
    return Objects.equals(this.name, classifierCsvClassifier.name) &&
        Objects.equals(this.creationTime, classifierCsvClassifier.creationTime) &&
        Objects.equals(this.lastUpdated, classifierCsvClassifier.lastUpdated) &&
        Objects.equals(this.version, classifierCsvClassifier.version) &&
        Objects.equals(this.delimiter, classifierCsvClassifier.delimiter) &&
        Objects.equals(this.quoteSymbol, classifierCsvClassifier.quoteSymbol) &&
        Objects.equals(this.containsHeader, classifierCsvClassifier.containsHeader) &&
        Objects.equals(this.header, classifierCsvClassifier.header) &&
        Objects.equals(this.disableValueTrimming, classifierCsvClassifier.disableValueTrimming) &&
        Objects.equals(this.allowSingleColumn, classifierCsvClassifier.allowSingleColumn) &&
        Objects.equals(this.customDatatypeConfigured, classifierCsvClassifier.customDatatypeConfigured) &&
        Objects.equals(this.customDatatypes, classifierCsvClassifier.customDatatypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, creationTime, lastUpdated, version, delimiter, quoteSymbol, containsHeader, header, disableValueTrimming, allowSingleColumn, customDatatypeConfigured, customDatatypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ClassifierCsvClassifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClassifierCsvClassifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClassifierCsvClassifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClassifierCsvClassifier is not found in the empty JSON string", ClassifierCsvClassifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClassifierCsvClassifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClassifierCsvClassifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ClassifierCsvClassifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClassifierCsvClassifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClassifierCsvClassifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClassifierCsvClassifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClassifierCsvClassifier.class));

       return (TypeAdapter<T>) new TypeAdapter<ClassifierCsvClassifier>() {
           @Override
           public void write(JsonWriter out, ClassifierCsvClassifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClassifierCsvClassifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClassifierCsvClassifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClassifierCsvClassifier
   * @throws IOException if the JSON string is invalid with respect to ClassifierCsvClassifier
   */
  public static ClassifierCsvClassifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClassifierCsvClassifier.class);
  }

  /**
   * Convert an instance of ClassifierCsvClassifier to an JSON string
   *
   * @return JSON string
   */
