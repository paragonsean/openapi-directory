...
public class UpdateCsvClassifierRequest {
  ...
  public UpdateCsvClassifierRequest() {
  }

  public UpdateCsvClassifierRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateCsvClassifierRequest delimiter(String delimiter) {
  ...
  public UpdateCsvClassifierRequest quoteSymbol(String quoteSymbol) {
  ...
  public UpdateCsvClassifierRequest containsHeader(CsvHeaderOption containsHeader) {
  ...
  public UpdateCsvClassifierRequest header(List header) {
    this.header = header;
    return this;
  }
  ...
  public UpdateCsvClassifierRequest disableValueTrimming(Boolean disableValueTrimming) {
  ...
  public UpdateCsvClassifierRequest allowSingleColumn(Boolean allowSingleColumn) {
  ...
  public UpdateCsvClassifierRequest customDatatypeConfigured(Boolean customDatatypeConfigured) {
  ...
  public UpdateCsvClassifierRequest customDatatypes(List customDatatypes) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCsvClassifierRequest updateCsvClassifierRequest = (UpdateCsvClassifierRequest) o;
    return Objects.equals(this.name, updateCsvClassifierRequest.name) &&
        Objects.equals(this.delimiter, updateCsvClassifierRequest.delimiter) &&
        Objects.equals(this.quoteSymbol, updateCsvClassifierRequest.quoteSymbol) &&
        Objects.equals(this.containsHeader, updateCsvClassifierRequest.containsHeader) &&
        Objects.equals(this.header, updateCsvClassifierRequest.header) &&
        Objects.equals(this.disableValueTrimming, updateCsvClassifierRequest.disableValueTrimming) &&
        Objects.equals(this.allowSingleColumn, updateCsvClassifierRequest.allowSingleColumn) &&
        Objects.equals(this.customDatatypeConfigured, updateCsvClassifierRequest.customDatatypeConfigured) &&
        Objects.equals(this.customDatatypes, updateCsvClassifierRequest.customDatatypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCsvClassifierRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCsvClassifierRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCsvClassifierRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCsvClassifierRequest is not found in the empty JSON string", UpdateCsvClassifierRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCsvClassifierRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCsvClassifierRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCsvClassifierRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCsvClassifierRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCsvClassifierRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCsvClassifierRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCsvClassifierRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCsvClassifierRequest>() {
           @Override
           public void write(JsonWriter out, UpdateCsvClassifierRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCsvClassifierRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCsvClassifierRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCsvClassifierRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateCsvClassifierRequest
   */
  public static UpdateCsvClassifierRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCsvClassifierRequest.class);
  }

  /**
   * Convert an instance of UpdateCsvClassifierRequest to an JSON string
   *
   * @return JSON string
   */
