...
/**
 * UpdateCrawlerRequestTargets
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class UpdateCrawlerRequestTargets {
  ...
  public UpdateCrawlerRequestTargets() {
  }

  public UpdateCrawlerRequestTargets s3Targets(List s3Targets) {
  ...
  public UpdateCrawlerRequestTargets jdbcTargets(List jdbcTargets) {
  ...
  public UpdateCrawlerRequestTargets mongoDBTargets(List mongoDBTargets) {
  ...
  public UpdateCrawlerRequestTargets dynamoDBTargets(List dynamoDBTargets) {
  ...
  public UpdateCrawlerRequestTargets catalogTargets(List catalogTargets) {
  ...
  public UpdateCrawlerRequestTargets deltaTargets(List deltaTargets) {
  ...
  public UpdateCrawlerRequestTargets icebergTargets(List icebergTargets) {
  ...
  public UpdateCrawlerRequestTargets hudiTargets(List hudiTargets) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCrawlerRequestTargets updateCrawlerRequestTargets = (UpdateCrawlerRequestTargets) o;
    return Objects.equals(this.s3Targets, updateCrawlerRequestTargets.s3Targets) &&
        Objects.equals(this.jdbcTargets, updateCrawlerRequestTargets.jdbcTargets) &&
        Objects.equals(this.mongoDBTargets, updateCrawlerRequestTargets.mongoDBTargets) &&
        Objects.equals(this.dynamoDBTargets, updateCrawlerRequestTargets.dynamoDBTargets) &&
        Objects.equals(this.catalogTargets, updateCrawlerRequestTargets.catalogTargets) &&
        Objects.equals(this.deltaTargets, updateCrawlerRequestTargets.deltaTargets) &&
        Objects.equals(this.icebergTargets, updateCrawlerRequestTargets.icebergTargets) &&
        Objects.equals(this.hudiTargets, updateCrawlerRequestTargets.hudiTargets);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCrawlerRequestTargets {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCrawlerRequestTargets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCrawlerRequestTargets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCrawlerRequestTargets is not found in the empty JSON string", UpdateCrawlerRequestTargets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCrawlerRequestTargets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCrawlerRequestTargets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCrawlerRequestTargets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCrawlerRequestTargets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCrawlerRequestTargets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCrawlerRequestTargets.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCrawlerRequestTargets>() {
           @Override
           public void write(JsonWriter out, UpdateCrawlerRequestTargets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCrawlerRequestTargets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCrawlerRequestTargets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCrawlerRequestTargets
   * @throws IOException if the JSON string is invalid with respect to UpdateCrawlerRequestTargets
   */
  public static UpdateCrawlerRequestTargets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCrawlerRequestTargets.class);
  }

  /**
   * Convert an instance of UpdateCrawlerRequestTargets to an JSON string
   *
   * @return JSON string
   */
