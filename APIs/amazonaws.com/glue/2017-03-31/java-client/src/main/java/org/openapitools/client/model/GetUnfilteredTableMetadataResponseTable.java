...
/**
 * GetUnfilteredTableMetadataResponseTable
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:23:19.587194-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class GetUnfilteredTableMetadataResponseTable {
  ...
  public GetUnfilteredTableMetadataResponseTable() {
  }

  public GetUnfilteredTableMetadataResponseTable name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetUnfilteredTableMetadataResponseTable databaseName(String databaseName) {
  ...
  public GetUnfilteredTableMetadataResponseTable description(String description) {
  ...
  public GetUnfilteredTableMetadataResponseTable owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GetUnfilteredTableMetadataResponseTable createTime(OffsetDateTime createTime) {
  ...
  public GetUnfilteredTableMetadataResponseTable updateTime(OffsetDateTime updateTime) {
  ...
  public GetUnfilteredTableMetadataResponseTable lastAccessTime(OffsetDateTime lastAccessTime) {
  ...
  public GetUnfilteredTableMetadataResponseTable lastAnalyzedTime(OffsetDateTime lastAnalyzedTime) {
  ...
  public GetUnfilteredTableMetadataResponseTable retention(Integer retention) {
  ...
  public GetUnfilteredTableMetadataResponseTable storageDescriptor(TableInputStorageDescriptor storageDescriptor) {
  ...
  public GetUnfilteredTableMetadataResponseTable partitionKeys(List partitionKeys) {
  ...
  public GetUnfilteredTableMetadataResponseTable viewOriginalText(String viewOriginalText) {
  ...
  public GetUnfilteredTableMetadataResponseTable viewExpandedText(String viewExpandedText) {
  ...
  public GetUnfilteredTableMetadataResponseTable tableType(String tableType) {
  ...
  public GetUnfilteredTableMetadataResponseTable parameters(Map parameters) {
  ...
  public GetUnfilteredTableMetadataResponseTable createdBy(String createdBy) {
  ...
  public GetUnfilteredTableMetadataResponseTable isRegisteredWithLakeFormation(Boolean isRegisteredWithLakeFormation) {
  ...
  public GetUnfilteredTableMetadataResponseTable targetTable(TableInputTargetTable targetTable) {
  ...
  public GetUnfilteredTableMetadataResponseTable catalogId(String catalogId) {
  ...
  public GetUnfilteredTableMetadataResponseTable versionId(String versionId) {
  ...
  public GetUnfilteredTableMetadataResponseTable federatedTable(TableFederatedTable federatedTable) {
  ...
  public boolean equals(Object o) {
    ...
    GetUnfilteredTableMetadataResponseTable getUnfilteredTableMetadataResponseTable = (GetUnfilteredTableMetadataResponseTable) o;
    return Objects.equals(this.name, getUnfilteredTableMetadataResponseTable.name) &&
        Objects.equals(this.databaseName, getUnfilteredTableMetadataResponseTable.databaseName) &&
        Objects.equals(this.description, getUnfilteredTableMetadataResponseTable.description) &&
        Objects.equals(this.owner, getUnfilteredTableMetadataResponseTable.owner) &&
        Objects.equals(this.createTime, getUnfilteredTableMetadataResponseTable.createTime) &&
        Objects.equals(this.updateTime, getUnfilteredTableMetadataResponseTable.updateTime) &&
        Objects.equals(this.lastAccessTime, getUnfilteredTableMetadataResponseTable.lastAccessTime) &&
        Objects.equals(this.lastAnalyzedTime, getUnfilteredTableMetadataResponseTable.lastAnalyzedTime) &&
        Objects.equals(this.retention, getUnfilteredTableMetadataResponseTable.retention) &&
        Objects.equals(this.storageDescriptor, getUnfilteredTableMetadataResponseTable.storageDescriptor) &&
        Objects.equals(this.partitionKeys, getUnfilteredTableMetadataResponseTable.partitionKeys) &&
        Objects.equals(this.viewOriginalText, getUnfilteredTableMetadataResponseTable.viewOriginalText) &&
        Objects.equals(this.viewExpandedText, getUnfilteredTableMetadataResponseTable.viewExpandedText) &&
        Objects.equals(this.tableType, getUnfilteredTableMetadataResponseTable.tableType) &&
        Objects.equals(this.parameters, getUnfilteredTableMetadataResponseTable.parameters) &&
        Objects.equals(this.createdBy, getUnfilteredTableMetadataResponseTable.createdBy) &&
        Objects.equals(this.isRegisteredWithLakeFormation, getUnfilteredTableMetadataResponseTable.isRegisteredWithLakeFormation) &&
        Objects.equals(this.targetTable, getUnfilteredTableMetadataResponseTable.targetTable) &&
        Objects.equals(this.catalogId, getUnfilteredTableMetadataResponseTable.catalogId) &&
        Objects.equals(this.versionId, getUnfilteredTableMetadataResponseTable.versionId) &&
        Objects.equals(this.federatedTable, getUnfilteredTableMetadataResponseTable.federatedTable);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUnfilteredTableMetadataResponseTable {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUnfilteredTableMetadataResponseTable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUnfilteredTableMetadataResponseTable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUnfilteredTableMetadataResponseTable is not found in the empty JSON string", GetUnfilteredTableMetadataResponseTable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUnfilteredTableMetadataResponseTable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUnfilteredTableMetadataResponseTable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUnfilteredTableMetadataResponseTable.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUnfilteredTableMetadataResponseTable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUnfilteredTableMetadataResponseTable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUnfilteredTableMetadataResponseTable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUnfilteredTableMetadataResponseTable.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUnfilteredTableMetadataResponseTable>() {
           @Override
           public void write(JsonWriter out, GetUnfilteredTableMetadataResponseTable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUnfilteredTableMetadataResponseTable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUnfilteredTableMetadataResponseTable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUnfilteredTableMetadataResponseTable
   * @throws IOException if the JSON string is invalid with respect to GetUnfilteredTableMetadataResponseTable
   */
  public static GetUnfilteredTableMetadataResponseTable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUnfilteredTableMetadataResponseTable.class);
  }

  /**
   * Convert an instance of GetUnfilteredTableMetadataResponseTable to an JSON string
   *
   * @return JSON string
   */
