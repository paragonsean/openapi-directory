...
async def test_create_call_analytics_category(client):
    """Test case for create_call_analytics_category

    
    """
    body = {"InputType":"","CategoryName":"","Rules":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.CreateCallAnalyticsCategory',
        headers=headers,
        json=body,
        )
...
async def test_create_language_model(client):
    """Test case for create_language_model

    
    """
    body = {"LanguageCode":"","ModelName":"","BaseModelName":"","InputDataConfig":{"DataAccessRoleArn":"","TuningDataS3Uri":"","S3Uri":""},"Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.CreateLanguageModel',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_medical_vocabulary(client):
    """Test case for create_medical_vocabulary

    
    """
    body = {"LanguageCode":"","VocabularyName":"","Tags":"","VocabularyFileUri":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.CreateMedicalVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_vocabulary(client):
    ...
    """
    body = {"LanguageCode":"","VocabularyName":"","DataAccessRoleArn":"","Phrases":"","Tags":"","VocabularyFileUri":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.CreateVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_vocabulary_filter(client):
    """Test case for create_vocabulary_filter

    
    """
    body = {"LanguageCode":"","DataAccessRoleArn":"","VocabularyFilterName":"","VocabularyFilterFileUri":"","Words":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.CreateVocabularyFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_call_analytics_category(client):
    """Test case for delete_call_analytics_category
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteCallAnalyticsCategory',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_call_analytics_job(client):
    """Test case for delete_call_analytics_job
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteCallAnalyticsJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_language_model(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteLanguageModel',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_medical_transcription_job(client):
    """Test case for delete_medical_transcription_job
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteMedicalTranscriptionJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_medical_vocabulary(client):
    """Test case for delete_medical_vocabulary
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteMedicalVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_transcription_job(client):
    """Test case for delete_transcription_job
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteTranscriptionJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_vocabulary(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_vocabulary_filter(client):
    """Test case for delete_vocabulary_filter
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DeleteVocabularyFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_language_model(client):
    """Test case for describe_language_model
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.DescribeLanguageModel',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_call_analytics_category(client):
    """Test case for get_call_analytics_category
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.GetCallAnalyticsCategory',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_call_analytics_job(client):
    """Test case for get_call_analytics_job
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.GetCallAnalyticsJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_medical_transcription_job(client):
    """Test case for get_medical_transcription_job
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.GetMedicalTranscriptionJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_medical_vocabulary(client):
    """Test case for get_medical_vocabulary
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.GetMedicalVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_transcription_job(client):
    """Test case for get_transcription_job
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.GetTranscriptionJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_vocabulary(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.GetVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_vocabulary_filter(client):
    """Test case for get_vocabulary_filter
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.GetVocabularyFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_call_analytics_categories(client):
    """Test case for list_call_analytics_categories
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListCallAnalyticsCategories',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_call_analytics_jobs(client):
    """Test case for list_call_analytics_jobs
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListCallAnalyticsJobs',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_language_models(client):
    """Test case for list_language_models

    
    """
    body = {"StatusEquals":"","NextToken":"","MaxResults":"","NameContains":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListLanguageModels',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_medical_transcription_jobs(client):
    """Test case for list_medical_transcription_jobs
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListMedicalTranscriptionJobs',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_medical_vocabularies(client):
    """Test case for list_medical_vocabularies

    
    """
    body = {"NextToken":"","StateEquals":"","MaxResults":"","NameContains":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListMedicalVocabularies',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_transcription_jobs(client):
    """Test case for list_transcription_jobs
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListTranscriptionJobs',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_vocabularies(client):
    """Test case for list_vocabularies
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListVocabularies',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_vocabulary_filters(client):
    """Test case for list_vocabulary_filters
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.ListVocabularyFilters',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_start_call_analytics_job(client):
    """Test case for start_call_analytics_job

    
    """
    body = {"DataAccessRoleArn":"","CallAnalyticsJobName":"","Media":{"MediaFileUri":"","RedactedMediaFileUri":""},"ChannelDefinitions":"","OutputLocation":"","OutputEncryptionKMSKeyId":"","Settings":{"ContentRedaction":{"RedactionType":"","PiiEntityTypes":"","RedactionOutput":""},"LanguageModelName":"","VocabularyName":"","VocabularyFilterName":"","LanguageIdSettings":"","VocabularyFilterMethod":"","LanguageOptions":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.StartCallAnalyticsJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_medical_transcription_job(client):
    """Test case for start_medical_transcription_job

    
    """
    body = {"MediaFormat":"","OutputBucketName":"","Media":{"MediaFileUri":"","RedactedMediaFileUri":""},"MediaSampleRateHertz":"","MedicalTranscriptionJobName":"","OutputEncryptionKMSKeyId":"","Specialty":"","LanguageCode":"","Type":"","KMSEncryptionContext":"","ContentIdentificationType":"","OutputKey":"","Settings":{"MaxSpeakerLabels":"","VocabularyName":"","MaxAlternatives":"","ChannelIdentification":"","ShowAlternatives":"","ShowSpeakerLabels":""},"Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.StartMedicalTranscriptionJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_transcription_job(client):
    """Test case for start_transcription_job

    
    """
    body = {"MediaFormat":"","IdentifyMultipleLanguages":"","OutputBucketName":"","Media":{"MediaFileUri":"","RedactedMediaFileUri":""},"ToxicityDetection":"","MediaSampleRateHertz":"","IdentifyLanguage":"","OutputEncryptionKMSKeyId":"","LanguageOptions":"","ContentRedaction":{"RedactionType":"","PiiEntityTypes":"","RedactionOutput":""},"TranscriptionJobName":"","LanguageCode":"","JobExecutionSettings":{"DataAccessRoleArn":"","AllowDeferredExecution":""},"KMSEncryptionContext":"","ModelSettings":{"LanguageModelName":""},"Subtitles":{"OutputStartIndex":"","Formats":""},"LanguageIdSettings":"","OutputKey":"","Settings":{"MaxSpeakerLabels":"","VocabularyName":"","MaxAlternatives":"","ChannelIdentification":"","VocabularyFilterName":"","ShowAlternatives":"","VocabularyFilterMethod":"","ShowSpeakerLabels":""},"Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.StartTranscriptionJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_call_analytics_category(client):
    """Test case for update_call_analytics_category
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.UpdateCallAnalyticsCategory',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_medical_vocabulary(client):
    """Test case for update_medical_vocabulary

    
    """
    body = {"LanguageCode":"","VocabularyName":"","VocabularyFileUri":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.UpdateMedicalVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_vocabulary(client):
    """Test case for update_vocabulary

    
    """
    body = {"LanguageCode":"","VocabularyName":"","DataAccessRoleArn":"","Phrases":"","VocabularyFileUri":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.UpdateVocabulary',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_vocabulary_filter(client):
    """Test case for update_vocabulary_filter

    
    """
    body = {"DataAccessRoleArn":"","VocabularyFilterName":"","VocabularyFilterFileUri":"","Words":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Transcribe.UpdateVocabularyFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
