...
public class StartMedicalTranscriptionJobRequestSettings {
  ...
  public StartMedicalTranscriptionJobRequestSettings() {
  }

  public StartMedicalTranscriptionJobRequestSettings showSpeakerLabels(Boolean showSpeakerLabels) {
  ...
  public StartMedicalTranscriptionJobRequestSettings maxSpeakerLabels(Integer maxSpeakerLabels) {
  ...
  public StartMedicalTranscriptionJobRequestSettings channelIdentification(Boolean channelIdentification) {
  ...
  public StartMedicalTranscriptionJobRequestSettings showAlternatives(Boolean showAlternatives) {
  ...
  public StartMedicalTranscriptionJobRequestSettings maxAlternatives(Integer maxAlternatives) {
  ...
  public StartMedicalTranscriptionJobRequestSettings vocabularyName(String vocabularyName) {
  ...
  public boolean equals(Object o) {
    ...
    StartMedicalTranscriptionJobRequestSettings startMedicalTranscriptionJobRequestSettings = (StartMedicalTranscriptionJobRequestSettings) o;
    return Objects.equals(this.showSpeakerLabels, startMedicalTranscriptionJobRequestSettings.showSpeakerLabels) &&
        Objects.equals(this.maxSpeakerLabels, startMedicalTranscriptionJobRequestSettings.maxSpeakerLabels) &&
        Objects.equals(this.channelIdentification, startMedicalTranscriptionJobRequestSettings.channelIdentification) &&
        Objects.equals(this.showAlternatives, startMedicalTranscriptionJobRequestSettings.showAlternatives) &&
        Objects.equals(this.maxAlternatives, startMedicalTranscriptionJobRequestSettings.maxAlternatives) &&
        Objects.equals(this.vocabularyName, startMedicalTranscriptionJobRequestSettings.vocabularyName);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartMedicalTranscriptionJobRequestSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartMedicalTranscriptionJobRequestSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartMedicalTranscriptionJobRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartMedicalTranscriptionJobRequestSettings is not found in the empty JSON string", StartMedicalTranscriptionJobRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartMedicalTranscriptionJobRequestSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartMedicalTranscriptionJobRequestSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartMedicalTranscriptionJobRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartMedicalTranscriptionJobRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartMedicalTranscriptionJobRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartMedicalTranscriptionJobRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<StartMedicalTranscriptionJobRequestSettings>() {
           @Override
           public void write(JsonWriter out, StartMedicalTranscriptionJobRequestSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartMedicalTranscriptionJobRequestSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartMedicalTranscriptionJobRequestSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartMedicalTranscriptionJobRequestSettings
   * @throws IOException if the JSON string is invalid with respect to StartMedicalTranscriptionJobRequestSettings
   */
  public static StartMedicalTranscriptionJobRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartMedicalTranscriptionJobRequestSettings.class);
  }

  /**
   * Convert an instance of StartMedicalTranscriptionJobRequestSettings to an JSON string
   *
   * @return JSON string
   */
