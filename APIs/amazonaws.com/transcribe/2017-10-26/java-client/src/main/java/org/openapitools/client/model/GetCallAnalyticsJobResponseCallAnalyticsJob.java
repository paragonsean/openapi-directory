...
public class GetCallAnalyticsJobResponseCallAnalyticsJob {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob() {
  }

  public GetCallAnalyticsJobResponseCallAnalyticsJob callAnalyticsJobName(String callAnalyticsJobName) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob callAnalyticsJobStatus(CallAnalyticsJobStatus callAnalyticsJobStatus) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob languageCode(LanguageCode languageCode) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob mediaSampleRateHertz(Integer mediaSampleRateHertz) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob mediaFormat(MediaFormat mediaFormat) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob media(CallAnalyticsJobMedia media) {
    this.media = media;
    return this;
  }
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob transcript(Transcript transcript) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob startTime(OffsetDateTime startTime) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob creationTime(OffsetDateTime creationTime) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob completionTime(OffsetDateTime completionTime) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob failureReason(String failureReason) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob dataAccessRoleArn(String dataAccessRoleArn) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob identifiedLanguageScore(Float identifiedLanguageScore) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob settings(CallAnalyticsJobSettings settings) {
  ...
  public GetCallAnalyticsJobResponseCallAnalyticsJob channelDefinitions(List channelDefinitions) {
  ...
  public boolean equals(Object o) {
    ...
    GetCallAnalyticsJobResponseCallAnalyticsJob getCallAnalyticsJobResponseCallAnalyticsJob = (GetCallAnalyticsJobResponseCallAnalyticsJob) o;
    return Objects.equals(this.callAnalyticsJobName, getCallAnalyticsJobResponseCallAnalyticsJob.callAnalyticsJobName) &&
        Objects.equals(this.callAnalyticsJobStatus, getCallAnalyticsJobResponseCallAnalyticsJob.callAnalyticsJobStatus) &&
        Objects.equals(this.languageCode, getCallAnalyticsJobResponseCallAnalyticsJob.languageCode) &&
        Objects.equals(this.mediaSampleRateHertz, getCallAnalyticsJobResponseCallAnalyticsJob.mediaSampleRateHertz) &&
        Objects.equals(this.mediaFormat, getCallAnalyticsJobResponseCallAnalyticsJob.mediaFormat) &&
        Objects.equals(this.media, getCallAnalyticsJobResponseCallAnalyticsJob.media) &&
        Objects.equals(this.transcript, getCallAnalyticsJobResponseCallAnalyticsJob.transcript) &&
        Objects.equals(this.startTime, getCallAnalyticsJobResponseCallAnalyticsJob.startTime) &&
        Objects.equals(this.creationTime, getCallAnalyticsJobResponseCallAnalyticsJob.creationTime) &&
        Objects.equals(this.completionTime, getCallAnalyticsJobResponseCallAnalyticsJob.completionTime) &&
        Objects.equals(this.failureReason, getCallAnalyticsJobResponseCallAnalyticsJob.failureReason) &&
        Objects.equals(this.dataAccessRoleArn, getCallAnalyticsJobResponseCallAnalyticsJob.dataAccessRoleArn) &&
        Objects.equals(this.identifiedLanguageScore, getCallAnalyticsJobResponseCallAnalyticsJob.identifiedLanguageScore) &&
        Objects.equals(this.settings, getCallAnalyticsJobResponseCallAnalyticsJob.settings) &&
        Objects.equals(this.channelDefinitions, getCallAnalyticsJobResponseCallAnalyticsJob.channelDefinitions);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCallAnalyticsJobResponseCallAnalyticsJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCallAnalyticsJobResponseCallAnalyticsJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCallAnalyticsJobResponseCallAnalyticsJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCallAnalyticsJobResponseCallAnalyticsJob is not found in the empty JSON string", GetCallAnalyticsJobResponseCallAnalyticsJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCallAnalyticsJobResponseCallAnalyticsJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCallAnalyticsJobResponseCallAnalyticsJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCallAnalyticsJobResponseCallAnalyticsJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCallAnalyticsJobResponseCallAnalyticsJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCallAnalyticsJobResponseCallAnalyticsJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCallAnalyticsJobResponseCallAnalyticsJob.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCallAnalyticsJobResponseCallAnalyticsJob>() {
           @Override
           public void write(JsonWriter out, GetCallAnalyticsJobResponseCallAnalyticsJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCallAnalyticsJobResponseCallAnalyticsJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCallAnalyticsJobResponseCallAnalyticsJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCallAnalyticsJobResponseCallAnalyticsJob
   * @throws IOException if the JSON string is invalid with respect to GetCallAnalyticsJobResponseCallAnalyticsJob
   */
  public static GetCallAnalyticsJobResponseCallAnalyticsJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCallAnalyticsJobResponseCallAnalyticsJob.class);
  }

  /**
   * Convert an instance of GetCallAnalyticsJobResponseCallAnalyticsJob to an JSON string
   *
   * @return JSON string
   */
