...
public class MedicalTranscriptionSetting {
  ...
  public MedicalTranscriptionSetting showSpeakerLabels(Boolean showSpeakerLabels) {
  ...
  public MedicalTranscriptionSetting maxSpeakerLabels(Integer maxSpeakerLabels) {
  ...
  public MedicalTranscriptionSetting channelIdentification(Boolean channelIdentification) {
  ...
  public MedicalTranscriptionSetting showAlternatives(Boolean showAlternatives) {
  ...
  public MedicalTranscriptionSetting maxAlternatives(Integer maxAlternatives) {
  ...
  public MedicalTranscriptionSetting vocabularyName(String vocabularyName) {
  ...
  public boolean equals(Object o) {
    ...
    MedicalTranscriptionSetting medicalTranscriptionSetting = (MedicalTranscriptionSetting) o;
    return Objects.equals(this.showSpeakerLabels, medicalTranscriptionSetting.showSpeakerLabels) &&
        Objects.equals(this.maxSpeakerLabels, medicalTranscriptionSetting.maxSpeakerLabels) &&
        Objects.equals(this.channelIdentification, medicalTranscriptionSetting.channelIdentification) &&
        Objects.equals(this.showAlternatives, medicalTranscriptionSetting.showAlternatives) &&
        Objects.equals(this.maxAlternatives, medicalTranscriptionSetting.maxAlternatives) &&
        Objects.equals(this.vocabularyName, medicalTranscriptionSetting.vocabularyName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MedicalTranscriptionSetting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MedicalTranscriptionSetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MedicalTranscriptionSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MedicalTranscriptionSetting is not found in the empty JSON string", MedicalTranscriptionSetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MedicalTranscriptionSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MedicalTranscriptionSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MedicalTranscriptionSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MedicalTranscriptionSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MedicalTranscriptionSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MedicalTranscriptionSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<MedicalTranscriptionSetting>() {
           @Override
           public void write(JsonWriter out, MedicalTranscriptionSetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MedicalTranscriptionSetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MedicalTranscriptionSetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MedicalTranscriptionSetting
   * @throws IOException if the JSON string is invalid with respect to MedicalTranscriptionSetting
   */
  public static MedicalTranscriptionSetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MedicalTranscriptionSetting.class);
  }

  /**
   * Convert an instance of MedicalTranscriptionSetting to an JSON string
   *
   * @return JSON string
   */
