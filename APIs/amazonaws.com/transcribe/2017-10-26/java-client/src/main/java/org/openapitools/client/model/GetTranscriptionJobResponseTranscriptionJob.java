...
public class GetTranscriptionJobResponseTranscriptionJob {
  ...
  public GetTranscriptionJobResponseTranscriptionJob() {
  }

  public GetTranscriptionJobResponseTranscriptionJob transcriptionJobName(String transcriptionJobName) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob transcriptionJobStatus(TranscriptionJobStatus transcriptionJobStatus) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob languageCode(LanguageCode languageCode) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob mediaSampleRateHertz(Integer mediaSampleRateHertz) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob mediaFormat(MediaFormat mediaFormat) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob media(TranscriptionJobMedia media) {
    this.media = media;
    return this;
  }
  ...
  public GetTranscriptionJobResponseTranscriptionJob transcript(TranscriptionJobTranscript transcript) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob startTime(OffsetDateTime startTime) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob creationTime(OffsetDateTime creationTime) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob completionTime(OffsetDateTime completionTime) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob failureReason(String failureReason) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob settings(TranscriptionJobSettings settings) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob modelSettings(TranscriptionJobModelSettings modelSettings) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob jobExecutionSettings(TranscriptionJobJobExecutionSettings jobExecutionSettings) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob contentRedaction(TranscriptionJobContentRedaction contentRedaction) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob identifyLanguage(Boolean identifyLanguage) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob identifyMultipleLanguages(Boolean identifyMultipleLanguages) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob languageOptions(List languageOptions) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob identifiedLanguageScore(Float identifiedLanguageScore) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob languageCodes(List languageCodes) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GetTranscriptionJobResponseTranscriptionJob subtitles(TranscriptionJobSubtitles subtitles) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob languageIdSettings(Map languageIdSettings) {
  ...
  public GetTranscriptionJobResponseTranscriptionJob toxicityDetection(List toxicityDetection) {
  ...
  public boolean equals(Object o) {
    ...
    GetTranscriptionJobResponseTranscriptionJob getTranscriptionJobResponseTranscriptionJob = (GetTranscriptionJobResponseTranscriptionJob) o;
    return Objects.equals(this.transcriptionJobName, getTranscriptionJobResponseTranscriptionJob.transcriptionJobName) &&
        Objects.equals(this.transcriptionJobStatus, getTranscriptionJobResponseTranscriptionJob.transcriptionJobStatus) &&
        Objects.equals(this.languageCode, getTranscriptionJobResponseTranscriptionJob.languageCode) &&
        Objects.equals(this.mediaSampleRateHertz, getTranscriptionJobResponseTranscriptionJob.mediaSampleRateHertz) &&
        Objects.equals(this.mediaFormat, getTranscriptionJobResponseTranscriptionJob.mediaFormat) &&
        Objects.equals(this.media, getTranscriptionJobResponseTranscriptionJob.media) &&
        Objects.equals(this.transcript, getTranscriptionJobResponseTranscriptionJob.transcript) &&
        Objects.equals(this.startTime, getTranscriptionJobResponseTranscriptionJob.startTime) &&
        Objects.equals(this.creationTime, getTranscriptionJobResponseTranscriptionJob.creationTime) &&
        Objects.equals(this.completionTime, getTranscriptionJobResponseTranscriptionJob.completionTime) &&
        Objects.equals(this.failureReason, getTranscriptionJobResponseTranscriptionJob.failureReason) &&
        Objects.equals(this.settings, getTranscriptionJobResponseTranscriptionJob.settings) &&
        Objects.equals(this.modelSettings, getTranscriptionJobResponseTranscriptionJob.modelSettings) &&
        Objects.equals(this.jobExecutionSettings, getTranscriptionJobResponseTranscriptionJob.jobExecutionSettings) &&
        Objects.equals(this.contentRedaction, getTranscriptionJobResponseTranscriptionJob.contentRedaction) &&
        Objects.equals(this.identifyLanguage, getTranscriptionJobResponseTranscriptionJob.identifyLanguage) &&
        Objects.equals(this.identifyMultipleLanguages, getTranscriptionJobResponseTranscriptionJob.identifyMultipleLanguages) &&
        Objects.equals(this.languageOptions, getTranscriptionJobResponseTranscriptionJob.languageOptions) &&
        Objects.equals(this.identifiedLanguageScore, getTranscriptionJobResponseTranscriptionJob.identifiedLanguageScore) &&
        Objects.equals(this.languageCodes, getTranscriptionJobResponseTranscriptionJob.languageCodes) &&
        Objects.equals(this.tags, getTranscriptionJobResponseTranscriptionJob.tags) &&
        Objects.equals(this.subtitles, getTranscriptionJobResponseTranscriptionJob.subtitles) &&
        Objects.equals(this.languageIdSettings, getTranscriptionJobResponseTranscriptionJob.languageIdSettings) &&
        Objects.equals(this.toxicityDetection, getTranscriptionJobResponseTranscriptionJob.toxicityDetection);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTranscriptionJobResponseTranscriptionJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTranscriptionJobResponseTranscriptionJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTranscriptionJobResponseTranscriptionJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTranscriptionJobResponseTranscriptionJob is not found in the empty JSON string", GetTranscriptionJobResponseTranscriptionJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTranscriptionJobResponseTranscriptionJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTranscriptionJobResponseTranscriptionJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTranscriptionJobResponseTranscriptionJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTranscriptionJobResponseTranscriptionJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTranscriptionJobResponseTranscriptionJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTranscriptionJobResponseTranscriptionJob.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTranscriptionJobResponseTranscriptionJob>() {
           @Override
           public void write(JsonWriter out, GetTranscriptionJobResponseTranscriptionJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTranscriptionJobResponseTranscriptionJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTranscriptionJobResponseTranscriptionJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTranscriptionJobResponseTranscriptionJob
   * @throws IOException if the JSON string is invalid with respect to GetTranscriptionJobResponseTranscriptionJob
   */
  public static GetTranscriptionJobResponseTranscriptionJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTranscriptionJobResponseTranscriptionJob.class);
  }

  /**
   * Convert an instance of GetTranscriptionJobResponseTranscriptionJob to an JSON string
   *
   * @return JSON string
   */
