...
public class StartCallAnalyticsJobResponseCallAnalyticsJob {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob() {
  }

  public StartCallAnalyticsJobResponseCallAnalyticsJob callAnalyticsJobName(String callAnalyticsJobName) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob callAnalyticsJobStatus(CallAnalyticsJobStatus callAnalyticsJobStatus) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob languageCode(LanguageCode languageCode) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob mediaSampleRateHertz(Integer mediaSampleRateHertz) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob mediaFormat(MediaFormat mediaFormat) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob media(CallAnalyticsJobMedia media) {
    this.media = media;
    return this;
  }
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob transcript(Transcript transcript) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob startTime(OffsetDateTime startTime) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob creationTime(OffsetDateTime creationTime) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob completionTime(OffsetDateTime completionTime) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob failureReason(String failureReason) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob dataAccessRoleArn(String dataAccessRoleArn) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob identifiedLanguageScore(Float identifiedLanguageScore) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob settings(CallAnalyticsJobSettings settings) {
  ...
  public StartCallAnalyticsJobResponseCallAnalyticsJob channelDefinitions(List channelDefinitions) {
  ...
  public boolean equals(Object o) {
    ...
    StartCallAnalyticsJobResponseCallAnalyticsJob startCallAnalyticsJobResponseCallAnalyticsJob = (StartCallAnalyticsJobResponseCallAnalyticsJob) o;
    return Objects.equals(this.callAnalyticsJobName, startCallAnalyticsJobResponseCallAnalyticsJob.callAnalyticsJobName) &&
        Objects.equals(this.callAnalyticsJobStatus, startCallAnalyticsJobResponseCallAnalyticsJob.callAnalyticsJobStatus) &&
        Objects.equals(this.languageCode, startCallAnalyticsJobResponseCallAnalyticsJob.languageCode) &&
        Objects.equals(this.mediaSampleRateHertz, startCallAnalyticsJobResponseCallAnalyticsJob.mediaSampleRateHertz) &&
        Objects.equals(this.mediaFormat, startCallAnalyticsJobResponseCallAnalyticsJob.mediaFormat) &&
        Objects.equals(this.media, startCallAnalyticsJobResponseCallAnalyticsJob.media) &&
        Objects.equals(this.transcript, startCallAnalyticsJobResponseCallAnalyticsJob.transcript) &&
        Objects.equals(this.startTime, startCallAnalyticsJobResponseCallAnalyticsJob.startTime) &&
        Objects.equals(this.creationTime, startCallAnalyticsJobResponseCallAnalyticsJob.creationTime) &&
        Objects.equals(this.completionTime, startCallAnalyticsJobResponseCallAnalyticsJob.completionTime) &&
        Objects.equals(this.failureReason, startCallAnalyticsJobResponseCallAnalyticsJob.failureReason) &&
        Objects.equals(this.dataAccessRoleArn, startCallAnalyticsJobResponseCallAnalyticsJob.dataAccessRoleArn) &&
        Objects.equals(this.identifiedLanguageScore, startCallAnalyticsJobResponseCallAnalyticsJob.identifiedLanguageScore) &&
        Objects.equals(this.settings, startCallAnalyticsJobResponseCallAnalyticsJob.settings) &&
        Objects.equals(this.channelDefinitions, startCallAnalyticsJobResponseCallAnalyticsJob.channelDefinitions);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartCallAnalyticsJobResponseCallAnalyticsJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartCallAnalyticsJobResponseCallAnalyticsJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartCallAnalyticsJobResponseCallAnalyticsJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartCallAnalyticsJobResponseCallAnalyticsJob is not found in the empty JSON string", StartCallAnalyticsJobResponseCallAnalyticsJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartCallAnalyticsJobResponseCallAnalyticsJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartCallAnalyticsJobResponseCallAnalyticsJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartCallAnalyticsJobResponseCallAnalyticsJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartCallAnalyticsJobResponseCallAnalyticsJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartCallAnalyticsJobResponseCallAnalyticsJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartCallAnalyticsJobResponseCallAnalyticsJob.class));

       return (TypeAdapter<T>) new TypeAdapter<StartCallAnalyticsJobResponseCallAnalyticsJob>() {
           @Override
           public void write(JsonWriter out, StartCallAnalyticsJobResponseCallAnalyticsJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartCallAnalyticsJobResponseCallAnalyticsJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartCallAnalyticsJobResponseCallAnalyticsJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartCallAnalyticsJobResponseCallAnalyticsJob
   * @throws IOException if the JSON string is invalid with respect to StartCallAnalyticsJobResponseCallAnalyticsJob
   */
  public static StartCallAnalyticsJobResponseCallAnalyticsJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartCallAnalyticsJobResponseCallAnalyticsJob.class);
  }

  /**
   * Convert an instance of StartCallAnalyticsJobResponseCallAnalyticsJob to an JSON string
   *
   * @return JSON string
   */
