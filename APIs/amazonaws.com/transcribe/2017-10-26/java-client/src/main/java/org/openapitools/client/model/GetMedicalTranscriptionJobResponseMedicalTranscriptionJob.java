...
public class GetMedicalTranscriptionJobResponseMedicalTranscriptionJob {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob() {
  }

  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob medicalTranscriptionJobName(String medicalTranscriptionJobName) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob transcriptionJobStatus(TranscriptionJobStatus transcriptionJobStatus) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob languageCode(LanguageCode languageCode) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob mediaSampleRateHertz(Integer mediaSampleRateHertz) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob mediaFormat(MediaFormat mediaFormat) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob media(Media media) {
    this.media = media;
    return this;
  }
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob transcript(MedicalTranscriptionJobTranscript transcript) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob startTime(OffsetDateTime startTime) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob creationTime(OffsetDateTime creationTime) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob completionTime(OffsetDateTime completionTime) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob failureReason(String failureReason) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob settings(MedicalTranscriptionJobSettings settings) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob contentIdentificationType(MedicalContentIdentificationType contentIdentificationType) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob specialty(Specialty specialty) {
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob type(Type type) {
    this.type = type;
    return this;
  }
  ...
  public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetMedicalTranscriptionJobResponseMedicalTranscriptionJob getMedicalTranscriptionJobResponseMedicalTranscriptionJob = (GetMedicalTranscriptionJobResponseMedicalTranscriptionJob) o;
    return Objects.equals(this.medicalTranscriptionJobName, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.medicalTranscriptionJobName) &&
        Objects.equals(this.transcriptionJobStatus, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.transcriptionJobStatus) &&
        Objects.equals(this.languageCode, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.languageCode) &&
        Objects.equals(this.mediaSampleRateHertz, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.mediaSampleRateHertz) &&
        Objects.equals(this.mediaFormat, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.mediaFormat) &&
        Objects.equals(this.media, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.media) &&
        Objects.equals(this.transcript, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.transcript) &&
        Objects.equals(this.startTime, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.startTime) &&
        Objects.equals(this.creationTime, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.creationTime) &&
        Objects.equals(this.completionTime, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.completionTime) &&
        Objects.equals(this.failureReason, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.failureReason) &&
        Objects.equals(this.settings, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.settings) &&
        Objects.equals(this.contentIdentificationType, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.contentIdentificationType) &&
        Objects.equals(this.specialty, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.specialty) &&
        Objects.equals(this.type, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.type) &&
        Objects.equals(this.tags, getMedicalTranscriptionJobResponseMedicalTranscriptionJob.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMedicalTranscriptionJobResponseMedicalTranscriptionJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMedicalTranscriptionJobResponseMedicalTranscriptionJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMedicalTranscriptionJobResponseMedicalTranscriptionJob is not found in the empty JSON string", GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMedicalTranscriptionJobResponseMedicalTranscriptionJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMedicalTranscriptionJobResponseMedicalTranscriptionJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMedicalTranscriptionJobResponseMedicalTranscriptionJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMedicalTranscriptionJobResponseMedicalTranscriptionJob>() {
           @Override
           public void write(JsonWriter out, GetMedicalTranscriptionJobResponseMedicalTranscriptionJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMedicalTranscriptionJobResponseMedicalTranscriptionJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMedicalTranscriptionJobResponseMedicalTranscriptionJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMedicalTranscriptionJobResponseMedicalTranscriptionJob
   * @throws IOException if the JSON string is invalid with respect to GetMedicalTranscriptionJobResponseMedicalTranscriptionJob
   */
  public static GetMedicalTranscriptionJobResponseMedicalTranscriptionJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.class);
  }

  /**
   * Convert an instance of GetMedicalTranscriptionJobResponseMedicalTranscriptionJob to an JSON string
   *
   * @return JSON string
   */
