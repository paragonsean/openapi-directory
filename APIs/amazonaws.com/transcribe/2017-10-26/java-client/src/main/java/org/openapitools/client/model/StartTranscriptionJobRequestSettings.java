...
public class StartTranscriptionJobRequestSettings {
  ...
  public StartTranscriptionJobRequestSettings() {
  }

  public StartTranscriptionJobRequestSettings vocabularyName(String vocabularyName) {
  ...
  public StartTranscriptionJobRequestSettings showSpeakerLabels(Boolean showSpeakerLabels) {
  ...
  public StartTranscriptionJobRequestSettings maxSpeakerLabels(Integer maxSpeakerLabels) {
  ...
  public StartTranscriptionJobRequestSettings channelIdentification(Boolean channelIdentification) {
  ...
  public StartTranscriptionJobRequestSettings showAlternatives(Boolean showAlternatives) {
  ...
  public StartTranscriptionJobRequestSettings maxAlternatives(Integer maxAlternatives) {
  ...
  public StartTranscriptionJobRequestSettings vocabularyFilterName(String vocabularyFilterName) {
  ...
  public StartTranscriptionJobRequestSettings vocabularyFilterMethod(VocabularyFilterMethod vocabularyFilterMethod) {
  ...
  public boolean equals(Object o) {
    ...
    StartTranscriptionJobRequestSettings startTranscriptionJobRequestSettings = (StartTranscriptionJobRequestSettings) o;
    return Objects.equals(this.vocabularyName, startTranscriptionJobRequestSettings.vocabularyName) &&
        Objects.equals(this.showSpeakerLabels, startTranscriptionJobRequestSettings.showSpeakerLabels) &&
        Objects.equals(this.maxSpeakerLabels, startTranscriptionJobRequestSettings.maxSpeakerLabels) &&
        Objects.equals(this.channelIdentification, startTranscriptionJobRequestSettings.channelIdentification) &&
        Objects.equals(this.showAlternatives, startTranscriptionJobRequestSettings.showAlternatives) &&
        Objects.equals(this.maxAlternatives, startTranscriptionJobRequestSettings.maxAlternatives) &&
        Objects.equals(this.vocabularyFilterName, startTranscriptionJobRequestSettings.vocabularyFilterName) &&
        Objects.equals(this.vocabularyFilterMethod, startTranscriptionJobRequestSettings.vocabularyFilterMethod);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartTranscriptionJobRequestSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTranscriptionJobRequestSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTranscriptionJobRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTranscriptionJobRequestSettings is not found in the empty JSON string", StartTranscriptionJobRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTranscriptionJobRequestSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTranscriptionJobRequestSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTranscriptionJobRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTranscriptionJobRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTranscriptionJobRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTranscriptionJobRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTranscriptionJobRequestSettings>() {
           @Override
           public void write(JsonWriter out, StartTranscriptionJobRequestSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTranscriptionJobRequestSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTranscriptionJobRequestSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTranscriptionJobRequestSettings
   * @throws IOException if the JSON string is invalid with respect to StartTranscriptionJobRequestSettings
   */
  public static StartTranscriptionJobRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTranscriptionJobRequestSettings.class);
  }

  /**
   * Convert an instance of StartTranscriptionJobRequestSettings to an JSON string
   *
   * @return JSON string
   */
