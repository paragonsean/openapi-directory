...
/*
 * OAINonTalkTimeFilter_RelativeTimeRange.h
 *
 * 
 */

#ifndef OAINonTalkTimeFilter_RelativeTimeRange_H
#define OAINonTalkTimeFilter_RelativeTimeRange_H
...
class OAINonTalkTimeFilter_RelativeTimeRange : public OAIObject {
public:
    OAINonTalkTimeFilter_RelativeTimeRange();
    OAINonTalkTimeFilter_RelativeTimeRange(QString json);
    ~OAINonTalkTimeFilter_RelativeTimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINonTalkTimeFilter_RelativeTimeRange)

#endif // OAINonTalkTimeFilter_RelativeTimeRange_H
