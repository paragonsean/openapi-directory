...
/*
 * OAIStartTranscriptionJobRequest_ContentRedaction.h
 *
 * 
 */

#ifndef OAIStartTranscriptionJobRequest_ContentRedaction_H
#define OAIStartTranscriptionJobRequest_ContentRedaction_H
...
class OAIStartTranscriptionJobRequest_ContentRedaction : public OAIObject {
public:
    OAIStartTranscriptionJobRequest_ContentRedaction();
    OAIStartTranscriptionJobRequest_ContentRedaction(QString json);
    ~OAIStartTranscriptionJobRequest_ContentRedaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTranscriptionJobRequest_ContentRedaction)

#endif // OAIStartTranscriptionJobRequest_ContentRedaction_H
