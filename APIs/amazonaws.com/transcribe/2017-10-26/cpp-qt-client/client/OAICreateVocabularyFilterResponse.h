...
/*
 * OAICreateVocabularyFilterResponse.h
 *
 * 
 */

#ifndef OAICreateVocabularyFilterResponse_H
#define OAICreateVocabularyFilterResponse_H
...
class OAICreateVocabularyFilterResponse : public OAIObject {
public:
    OAICreateVocabularyFilterResponse();
    OAICreateVocabularyFilterResponse(QString json);
    ~OAICreateVocabularyFilterResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVocabularyFilterResponse)

#endif // OAICreateVocabularyFilterResponse_H
