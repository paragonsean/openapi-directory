...
/*
 * OAIStartMedicalTranscriptionJobRequest_Settings.h
 *
 * 
 */

#ifndef OAIStartMedicalTranscriptionJobRequest_Settings_H
#define OAIStartMedicalTranscriptionJobRequest_Settings_H
...
class OAIStartMedicalTranscriptionJobRequest_Settings : public OAIObject {
public:
    OAIStartMedicalTranscriptionJobRequest_Settings();
    OAIStartMedicalTranscriptionJobRequest_Settings(QString json);
    ~OAIStartMedicalTranscriptionJobRequest_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMedicalTranscriptionJobRequest_Settings)

#endif // OAIStartMedicalTranscriptionJobRequest_Settings_H
