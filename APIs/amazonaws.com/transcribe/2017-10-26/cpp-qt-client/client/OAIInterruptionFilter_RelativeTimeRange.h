...
/*
 * OAIInterruptionFilter_RelativeTimeRange.h
 *
 * 
 */

#ifndef OAIInterruptionFilter_RelativeTimeRange_H
#define OAIInterruptionFilter_RelativeTimeRange_H
...
class OAIInterruptionFilter_RelativeTimeRange : public OAIObject {
public:
    OAIInterruptionFilter_RelativeTimeRange();
    OAIInterruptionFilter_RelativeTimeRange(QString json);
    ~OAIInterruptionFilter_RelativeTimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInterruptionFilter_RelativeTimeRange)

#endif // OAIInterruptionFilter_RelativeTimeRange_H
