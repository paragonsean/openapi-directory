...
/*
 * OAIStartTranscriptionJobRequest_Settings.h
 *
 * 
 */

#ifndef OAIStartTranscriptionJobRequest_Settings_H
#define OAIStartTranscriptionJobRequest_Settings_H
...
class OAIStartTranscriptionJobRequest_Settings : public OAIObject {
public:
    OAIStartTranscriptionJobRequest_Settings();
    OAIStartTranscriptionJobRequest_Settings(QString json);
    ~OAIStartTranscriptionJobRequest_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTranscriptionJobRequest_Settings)

#endif // OAIStartTranscriptionJobRequest_Settings_H
