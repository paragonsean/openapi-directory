...
/*
 * OAICreateLanguageModelRequest_InputDataConfig.h
 *
 * 
 */

#ifndef OAICreateLanguageModelRequest_InputDataConfig_H
#define OAICreateLanguageModelRequest_InputDataConfig_H
...
class OAICreateLanguageModelRequest_InputDataConfig : public OAIObject {
public:
    OAICreateLanguageModelRequest_InputDataConfig();
    OAICreateLanguageModelRequest_InputDataConfig(QString json);
    ~OAICreateLanguageModelRequest_InputDataConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLanguageModelRequest_InputDataConfig)

#endif // OAICreateLanguageModelRequest_InputDataConfig_H
