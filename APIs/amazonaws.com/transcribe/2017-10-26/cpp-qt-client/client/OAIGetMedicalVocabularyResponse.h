...
/*
 * OAIGetMedicalVocabularyResponse.h
 *
 * 
 */

#ifndef OAIGetMedicalVocabularyResponse_H
#define OAIGetMedicalVocabularyResponse_H
...
class OAIGetMedicalVocabularyResponse : public OAIObject {
public:
    OAIGetMedicalVocabularyResponse();
    OAIGetMedicalVocabularyResponse(QString json);
    ~OAIGetMedicalVocabularyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMedicalVocabularyResponse)

#endif // OAIGetMedicalVocabularyResponse_H
