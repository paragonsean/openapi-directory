...
/*
 * OAILanguageModel_InputDataConfig.h
 *
 * 
 */

#ifndef OAILanguageModel_InputDataConfig_H
#define OAILanguageModel_InputDataConfig_H
...
class OAILanguageModel_InputDataConfig : public OAIObject {
public:
    OAILanguageModel_InputDataConfig();
    OAILanguageModel_InputDataConfig(QString json);
    ~OAILanguageModel_InputDataConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILanguageModel_InputDataConfig)

#endif // OAILanguageModel_InputDataConfig_H
