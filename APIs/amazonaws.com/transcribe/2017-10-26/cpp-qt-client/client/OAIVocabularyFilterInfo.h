...
#ifndef OAIVocabularyFilterInfo_H
#define OAIVocabularyFilterInfo_H
...
class OAIVocabularyFilterInfo : public OAIObject {
public:
    OAIVocabularyFilterInfo();
    OAIVocabularyFilterInfo(QString json);
    ~OAIVocabularyFilterInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVocabularyFilterInfo)

#endif // OAIVocabularyFilterInfo_H
