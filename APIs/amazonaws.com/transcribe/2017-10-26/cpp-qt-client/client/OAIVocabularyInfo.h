...
#ifndef OAIVocabularyInfo_H
#define OAIVocabularyInfo_H
...
class OAIVocabularyInfo : public OAIObject {
public:
    OAIVocabularyInfo();
    OAIVocabularyInfo(QString json);
    ~OAIVocabularyInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVocabularyInfo)

#endif // OAIVocabularyInfo_H
