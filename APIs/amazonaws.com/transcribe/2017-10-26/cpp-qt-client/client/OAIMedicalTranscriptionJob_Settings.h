...
/*
 * OAIMedicalTranscriptionJob_Settings.h
 *
 * 
 */

#ifndef OAIMedicalTranscriptionJob_Settings_H
#define OAIMedicalTranscriptionJob_Settings_H
...
class OAIMedicalTranscriptionJob_Settings : public OAIObject {
public:
    OAIMedicalTranscriptionJob_Settings();
    OAIMedicalTranscriptionJob_Settings(QString json);
    ~OAIMedicalTranscriptionJob_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedicalTranscriptionJob_Settings)

#endif // OAIMedicalTranscriptionJob_Settings_H
