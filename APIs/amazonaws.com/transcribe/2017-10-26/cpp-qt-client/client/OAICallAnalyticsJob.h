...
#ifndef OAICallAnalyticsJob_H
#define OAICallAnalyticsJob_H
...
class OAICallAnalyticsJob : public OAIObject {
public:
    OAICallAnalyticsJob();
    OAICallAnalyticsJob(QString json);
    ~OAICallAnalyticsJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICallAnalyticsJob)

#endif // OAICallAnalyticsJob_H
