...
/*
 * OAITranscriptionJob_ContentRedaction.h
 *
 * 
 */

#ifndef OAITranscriptionJob_ContentRedaction_H
#define OAITranscriptionJob_ContentRedaction_H
...
class OAITranscriptionJob_ContentRedaction : public OAIObject {
public:
    OAITranscriptionJob_ContentRedaction();
    OAITranscriptionJob_ContentRedaction(QString json);
    ~OAITranscriptionJob_ContentRedaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscriptionJob_ContentRedaction)

#endif // OAITranscriptionJob_ContentRedaction_H
