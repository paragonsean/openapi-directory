...
#ifndef OAICategoryProperties_H
#define OAICategoryProperties_H
...
class OAICategoryProperties : public OAIObject {
public:
    OAICategoryProperties();
    OAICategoryProperties(QString json);
    ~OAICategoryProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoryProperties)

#endif // OAICategoryProperties_H
