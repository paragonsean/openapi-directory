...
OAITranscriptionJob_Settings::OAITranscriptionJob_Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscriptionJob_Settings::OAITranscriptionJob_Settings() {
    this->initializeModel();
}

OAITranscriptionJob_Settings::~OAITranscriptionJob_Settings() {}

void OAITranscriptionJob_Settings::initializeModel() {
...
void OAITranscriptionJob_Settings::fromJson(QString jsonString) {
...
void OAITranscriptionJob_Settings::fromJsonObject(QJsonObject json) {
...
QString OAITranscriptionJob_Settings::asJson() const {
...
QJsonObject OAITranscriptionJob_Settings::asJsonObject() const {
    QJsonObject obj;
...
QString OAITranscriptionJob_Settings::getVocabularyName() const {
    return m_vocabulary_name;
}
void OAITranscriptionJob_Settings::setVocabularyName(const QString &vocabulary_name) {
    m_vocabulary_name = vocabulary_name;
    m_vocabulary_name_isSet = true;
}

bool OAITranscriptionJob_Settings::is_vocabulary_name_Set() const{
    return m_vocabulary_name_isSet;
}

bool OAITranscriptionJob_Settings::is_vocabulary_name_Valid() const{
    return m_vocabulary_name_isValid;
}

bool OAITranscriptionJob_Settings::getShowSpeakerLabels() const {
    return m_show_speaker_labels;
}
void OAITranscriptionJob_Settings::setShowSpeakerLabels(const bool &show_speaker_labels) {
    m_show_speaker_labels = show_speaker_labels;
    m_show_speaker_labels_isSet = true;
}

bool OAITranscriptionJob_Settings::is_show_speaker_labels_Set() const{
    return m_show_speaker_labels_isSet;
}

bool OAITranscriptionJob_Settings::is_show_speaker_labels_Valid() const{
    return m_show_speaker_labels_isValid;
}

qint32 OAITranscriptionJob_Settings::getMaxSpeakerLabels() const {
    return m_max_speaker_labels;
}
void OAITranscriptionJob_Settings::setMaxSpeakerLabels(const qint32 &max_speaker_labels) {
    m_max_speaker_labels = max_speaker_labels;
    m_max_speaker_labels_isSet = true;
}

bool OAITranscriptionJob_Settings::is_max_speaker_labels_Set() const{
    return m_max_speaker_labels_isSet;
}

bool OAITranscriptionJob_Settings::is_max_speaker_labels_Valid() const{
    return m_max_speaker_labels_isValid;
}

bool OAITranscriptionJob_Settings::getChannelIdentification() const {
    return m_channel_identification;
}
void OAITranscriptionJob_Settings::setChannelIdentification(const bool &channel_identification) {
    m_channel_identification = channel_identification;
    m_channel_identification_isSet = true;
}

bool OAITranscriptionJob_Settings::is_channel_identification_Set() const{
    return m_channel_identification_isSet;
}

bool OAITranscriptionJob_Settings::is_channel_identification_Valid() const{
    return m_channel_identification_isValid;
}

bool OAITranscriptionJob_Settings::getShowAlternatives() const {
    return m_show_alternatives;
}
void OAITranscriptionJob_Settings::setShowAlternatives(const bool &show_alternatives) {
    m_show_alternatives = show_alternatives;
    m_show_alternatives_isSet = true;
}

bool OAITranscriptionJob_Settings::is_show_alternatives_Set() const{
    return m_show_alternatives_isSet;
}

bool OAITranscriptionJob_Settings::is_show_alternatives_Valid() const{
    return m_show_alternatives_isValid;
}

qint32 OAITranscriptionJob_Settings::getMaxAlternatives() const {
    return m_max_alternatives;
}
void OAITranscriptionJob_Settings::setMaxAlternatives(const qint32 &max_alternatives) {
    m_max_alternatives = max_alternatives;
    m_max_alternatives_isSet = true;
}

bool OAITranscriptionJob_Settings::is_max_alternatives_Set() const{
    return m_max_alternatives_isSet;
}

bool OAITranscriptionJob_Settings::is_max_alternatives_Valid() const{
    return m_max_alternatives_isValid;
}

QString OAITranscriptionJob_Settings::getVocabularyFilterName() const {
    return m_vocabulary_filter_name;
}
void OAITranscriptionJob_Settings::setVocabularyFilterName(const QString &vocabulary_filter_name) {
    m_vocabulary_filter_name = vocabulary_filter_name;
    m_vocabulary_filter_name_isSet = true;
}

bool OAITranscriptionJob_Settings::is_vocabulary_filter_name_Set() const{
    return m_vocabulary_filter_name_isSet;
}

bool OAITranscriptionJob_Settings::is_vocabulary_filter_name_Valid() const{
    return m_vocabulary_filter_name_isValid;
}

OAIVocabularyFilterMethod OAITranscriptionJob_Settings::getVocabularyFilterMethod() const {
    return m_vocabulary_filter_method;
}
void OAITranscriptionJob_Settings::setVocabularyFilterMethod(const OAIVocabularyFilterMethod &vocabulary_filter_method) {
    m_vocabulary_filter_method = vocabulary_filter_method;
    m_vocabulary_filter_method_isSet = true;
}

bool OAITranscriptionJob_Settings::is_vocabulary_filter_method_Set() const{
    return m_vocabulary_filter_method_isSet;
}

bool OAITranscriptionJob_Settings::is_vocabulary_filter_method_Valid() const{
    return m_vocabulary_filter_method_isValid;
}

bool OAITranscriptionJob_Settings::isSet() const {
...
bool OAITranscriptionJob_Settings::isValid() const {
