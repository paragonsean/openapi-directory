...
/*
 * OAICreateLanguageModelRequest.h
 *
 * 
 */

#ifndef OAICreateLanguageModelRequest_H
#define OAICreateLanguageModelRequest_H
...
namespace OpenAPI {
class OAICreateLanguageModelRequest_InputDataConfig;

class OAICreateLanguageModelRequest : public OAIObject {
public:
    OAICreateLanguageModelRequest();
    OAICreateLanguageModelRequest(QString json);
    ~OAICreateLanguageModelRequest() override;
    ...
    OAICreateLanguageModelRequest_InputDataConfig getInputDataConfig() const;
    void setInputDataConfig(const OAICreateLanguageModelRequest_InputDataConfig &input_data_config);
...
private:
    ...
    OAICreateLanguageModelRequest_InputDataConfig m_input_data_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLanguageModelRequest)

#endif // OAICreateLanguageModelRequest_H
