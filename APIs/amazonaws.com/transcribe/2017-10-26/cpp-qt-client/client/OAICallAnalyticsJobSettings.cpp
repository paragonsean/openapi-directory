...
#include "OAICallAnalyticsJobSettings.h"
...
OAICallAnalyticsJobSettings::OAICallAnalyticsJobSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICallAnalyticsJobSettings::OAICallAnalyticsJobSettings() {
    this->initializeModel();
}

OAICallAnalyticsJobSettings::~OAICallAnalyticsJobSettings() {}

void OAICallAnalyticsJobSettings::initializeModel() {
...
void OAICallAnalyticsJobSettings::fromJson(QString jsonString) {
...
void OAICallAnalyticsJobSettings::fromJsonObject(QJsonObject json) {
...
QString OAICallAnalyticsJobSettings::asJson() const {
...
QJsonObject OAICallAnalyticsJobSettings::asJsonObject() const {
    QJsonObject obj;
...
QString OAICallAnalyticsJobSettings::getVocabularyName() const {
    return m_vocabulary_name;
}
void OAICallAnalyticsJobSettings::setVocabularyName(const QString &vocabulary_name) {
    m_vocabulary_name = vocabulary_name;
    m_vocabulary_name_isSet = true;
}

bool OAICallAnalyticsJobSettings::is_vocabulary_name_Set() const{
    return m_vocabulary_name_isSet;
}

bool OAICallAnalyticsJobSettings::is_vocabulary_name_Valid() const{
    return m_vocabulary_name_isValid;
}

QString OAICallAnalyticsJobSettings::getVocabularyFilterName() const {
    return m_vocabulary_filter_name;
}
void OAICallAnalyticsJobSettings::setVocabularyFilterName(const QString &vocabulary_filter_name) {
    m_vocabulary_filter_name = vocabulary_filter_name;
    m_vocabulary_filter_name_isSet = true;
}

bool OAICallAnalyticsJobSettings::is_vocabulary_filter_name_Set() const{
    return m_vocabulary_filter_name_isSet;
}

bool OAICallAnalyticsJobSettings::is_vocabulary_filter_name_Valid() const{
    return m_vocabulary_filter_name_isValid;
}

OAIVocabularyFilterMethod OAICallAnalyticsJobSettings::getVocabularyFilterMethod() const {
    return m_vocabulary_filter_method;
}
void OAICallAnalyticsJobSettings::setVocabularyFilterMethod(const OAIVocabularyFilterMethod &vocabulary_filter_method) {
    m_vocabulary_filter_method = vocabulary_filter_method;
    m_vocabulary_filter_method_isSet = true;
}

bool OAICallAnalyticsJobSettings::is_vocabulary_filter_method_Set() const{
    return m_vocabulary_filter_method_isSet;
}

bool OAICallAnalyticsJobSettings::is_vocabulary_filter_method_Valid() const{
    return m_vocabulary_filter_method_isValid;
}

QString OAICallAnalyticsJobSettings::getLanguageModelName() const {
    return m_language_model_name;
}
void OAICallAnalyticsJobSettings::setLanguageModelName(const QString &language_model_name) {
    m_language_model_name = language_model_name;
    m_language_model_name_isSet = true;
}

bool OAICallAnalyticsJobSettings::is_language_model_name_Set() const{
    return m_language_model_name_isSet;
}

bool OAICallAnalyticsJobSettings::is_language_model_name_Valid() const{
    return m_language_model_name_isValid;
}

OAIContentRedaction OAICallAnalyticsJobSettings::getContentRedaction() const {
    return m_content_redaction;
}
void OAICallAnalyticsJobSettings::setContentRedaction(const OAIContentRedaction &content_redaction) {
    m_content_redaction = content_redaction;
    m_content_redaction_isSet = true;
}

bool OAICallAnalyticsJobSettings::is_content_redaction_Set() const{
    return m_content_redaction_isSet;
}

bool OAICallAnalyticsJobSettings::is_content_redaction_Valid() const{
    return m_content_redaction_isValid;
}

QList OAICallAnalyticsJobSettings::getLanguageOptions() const {
    return m_language_options;
}
void OAICallAnalyticsJobSettings::setLanguageOptions(const QList &language_options) {
    m_language_options = language_options;
    m_language_options_isSet = true;
}

bool OAICallAnalyticsJobSettings::is_language_options_Set() const{
    return m_language_options_isSet;
}

bool OAICallAnalyticsJobSettings::is_language_options_Valid() const{
    return m_language_options_isValid;
}

QMap OAICallAnalyticsJobSettings::getLanguageIdSettings() const {
    return m_language_id_settings;
}
void OAICallAnalyticsJobSettings::setLanguageIdSettings(const QMap &language_id_settings) {
    m_language_id_settings = language_id_settings;
    m_language_id_settings_isSet = true;
}

bool OAICallAnalyticsJobSettings::is_language_id_settings_Set() const{
    return m_language_id_settings_isSet;
}

bool OAICallAnalyticsJobSettings::is_language_id_settings_Valid() const{
    return m_language_id_settings_isValid;
}

bool OAICallAnalyticsJobSettings::isSet() const {
...
bool OAICallAnalyticsJobSettings::isValid() const {
