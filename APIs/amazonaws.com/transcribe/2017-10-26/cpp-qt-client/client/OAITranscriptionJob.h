...
#ifndef OAITranscriptionJob_H
#define OAITranscriptionJob_H
...
class OAITranscriptionJob : public OAIObject {
public:
    OAITranscriptionJob();
    OAITranscriptionJob(QString json);
    ~OAITranscriptionJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscriptionJob)

#endif // OAITranscriptionJob_H
