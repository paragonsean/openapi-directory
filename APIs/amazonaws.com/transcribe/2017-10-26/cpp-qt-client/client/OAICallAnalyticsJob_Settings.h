...
/*
 * OAICallAnalyticsJob_Settings.h
 *
 * 
 */

#ifndef OAICallAnalyticsJob_Settings_H
#define OAICallAnalyticsJob_Settings_H
...
class OAICallAnalyticsJob_Settings : public OAIObject {
public:
    OAICallAnalyticsJob_Settings();
    OAICallAnalyticsJob_Settings(QString json);
    ~OAICallAnalyticsJob_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICallAnalyticsJob_Settings)

#endif // OAICallAnalyticsJob_Settings_H
