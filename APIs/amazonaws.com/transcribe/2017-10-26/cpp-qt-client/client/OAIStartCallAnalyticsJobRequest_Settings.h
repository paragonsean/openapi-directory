...
/*
 * OAIStartCallAnalyticsJobRequest_Settings.h
 *
 * 
 */

#ifndef OAIStartCallAnalyticsJobRequest_Settings_H
#define OAIStartCallAnalyticsJobRequest_Settings_H
...
class OAIStartCallAnalyticsJobRequest_Settings : public OAIObject {
public:
    OAIStartCallAnalyticsJobRequest_Settings();
    OAIStartCallAnalyticsJobRequest_Settings(QString json);
    ~OAIStartCallAnalyticsJobRequest_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartCallAnalyticsJobRequest_Settings)

#endif // OAIStartCallAnalyticsJobRequest_Settings_H
