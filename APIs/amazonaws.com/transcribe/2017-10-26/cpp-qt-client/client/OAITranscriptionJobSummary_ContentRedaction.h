...
/*
 * OAITranscriptionJobSummary_ContentRedaction.h
 *
 * 
 */

#ifndef OAITranscriptionJobSummary_ContentRedaction_H
#define OAITranscriptionJobSummary_ContentRedaction_H
...
class OAITranscriptionJobSummary_ContentRedaction : public OAIObject {
public:
    OAITranscriptionJobSummary_ContentRedaction();
    OAITranscriptionJobSummary_ContentRedaction(QString json);
    ~OAITranscriptionJobSummary_ContentRedaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscriptionJobSummary_ContentRedaction)

#endif // OAITranscriptionJobSummary_ContentRedaction_H
