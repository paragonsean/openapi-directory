...
/*
 * OAICreateVocabularyResponse.h
 *
 * 
 */

#ifndef OAICreateVocabularyResponse_H
#define OAICreateVocabularyResponse_H
...
class OAICreateVocabularyResponse : public OAIObject {
public:
    OAICreateVocabularyResponse();
    OAICreateVocabularyResponse(QString json);
    ~OAICreateVocabularyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVocabularyResponse)

#endif // OAICreateVocabularyResponse_H
