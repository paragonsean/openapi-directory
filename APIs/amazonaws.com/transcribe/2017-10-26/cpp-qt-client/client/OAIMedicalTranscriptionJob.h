...
#ifndef OAIMedicalTranscriptionJob_H
#define OAIMedicalTranscriptionJob_H
...
class OAIMedicalTranscriptionJob : public OAIObject {
public:
    OAIMedicalTranscriptionJob();
    OAIMedicalTranscriptionJob(QString json);
    ~OAIMedicalTranscriptionJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedicalTranscriptionJob)

#endif // OAIMedicalTranscriptionJob_H
