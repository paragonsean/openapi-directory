...
/*
 * OAIUpdateMedicalVocabularyResponse.h
 *
 * 
 */

#ifndef OAIUpdateMedicalVocabularyResponse_H
#define OAIUpdateMedicalVocabularyResponse_H
...
class OAIUpdateMedicalVocabularyResponse : public OAIObject {
public:
    OAIUpdateMedicalVocabularyResponse();
    OAIUpdateMedicalVocabularyResponse(QString json);
    ~OAIUpdateMedicalVocabularyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMedicalVocabularyResponse)

#endif // OAIUpdateMedicalVocabularyResponse_H
