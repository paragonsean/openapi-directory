...
/*
 * OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob.h
 *
 * 
 */

#ifndef OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob_H
#define OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob_H
...
#include "OAIMedicalTranscriptionJob_Settings.h"
...
namespace OpenAPI {
class OAIMedia;
class OAIMedicalTranscriptionJob_Transcript;
class OAIMedicalTranscriptionJob_Settings;

class OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob : public OAIObject {
public:
    OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob();
    OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob(QString json);
    ~OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob() override;
    ...
    OAIMedicalTranscriptionJob_Transcript getTranscript() const;
    void setTranscript(const OAIMedicalTranscriptionJob_Transcript &transcript);
    ...
    OAIMedicalTranscriptionJob_Settings getSettings() const;
    void setSettings(const OAIMedicalTranscriptionJob_Settings &settings);
...
private:
    ...
    OAIMedicalTranscriptionJob_Transcript m_transcript;
    ...
    OAIMedicalTranscriptionJob_Settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob)

#endif // OAIStartMedicalTranscriptionJobResponse_MedicalTranscriptionJob_H
