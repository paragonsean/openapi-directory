...
OAITranscriptionJob::OAITranscriptionJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscriptionJob::OAITranscriptionJob() {
    this->initializeModel();
}

OAITranscriptionJob::~OAITranscriptionJob() {}

void OAITranscriptionJob::initializeModel() {
...
void OAITranscriptionJob::fromJson(QString jsonString) {
...
void OAITranscriptionJob::fromJsonObject(QJsonObject json) {
...
QString OAITranscriptionJob::asJson() const {
...
QJsonObject OAITranscriptionJob::asJsonObject() const {
    QJsonObject obj;
...
QString OAITranscriptionJob::getTranscriptionJobName() const {
    return m_transcription_job_name;
}
void OAITranscriptionJob::setTranscriptionJobName(const QString &transcription_job_name) {
    m_transcription_job_name = transcription_job_name;
    m_transcription_job_name_isSet = true;
}

bool OAITranscriptionJob::is_transcription_job_name_Set() const{
    return m_transcription_job_name_isSet;
}

bool OAITranscriptionJob::is_transcription_job_name_Valid() const{
    return m_transcription_job_name_isValid;
}

OAITranscriptionJobStatus OAITranscriptionJob::getTranscriptionJobStatus() const {
    return m_transcription_job_status;
}
void OAITranscriptionJob::setTranscriptionJobStatus(const OAITranscriptionJobStatus &transcription_job_status) {
    m_transcription_job_status = transcription_job_status;
    m_transcription_job_status_isSet = true;
}

bool OAITranscriptionJob::is_transcription_job_status_Set() const{
    return m_transcription_job_status_isSet;
}

bool OAITranscriptionJob::is_transcription_job_status_Valid() const{
    return m_transcription_job_status_isValid;
}

OAILanguageCode OAITranscriptionJob::getLanguageCode() const {
    return m_language_code;
}
void OAITranscriptionJob::setLanguageCode(const OAILanguageCode &language_code) {
    m_language_code = language_code;
    m_language_code_isSet = true;
}

bool OAITranscriptionJob::is_language_code_Set() const{
    return m_language_code_isSet;
}

bool OAITranscriptionJob::is_language_code_Valid() const{
    return m_language_code_isValid;
}

qint32 OAITranscriptionJob::getMediaSampleRateHertz() const {
    return m_media_sample_rate_hertz;
}
void OAITranscriptionJob::setMediaSampleRateHertz(const qint32 &media_sample_rate_hertz) {
    m_media_sample_rate_hertz = media_sample_rate_hertz;
    m_media_sample_rate_hertz_isSet = true;
}

bool OAITranscriptionJob::is_media_sample_rate_hertz_Set() const{
    return m_media_sample_rate_hertz_isSet;
}

bool OAITranscriptionJob::is_media_sample_rate_hertz_Valid() const{
    return m_media_sample_rate_hertz_isValid;
}

OAIMediaFormat OAITranscriptionJob::getMediaFormat() const {
    return m_media_format;
}
void OAITranscriptionJob::setMediaFormat(const OAIMediaFormat &media_format) {
    m_media_format = media_format;
    m_media_format_isSet = true;
}

bool OAITranscriptionJob::is_media_format_Set() const{
    return m_media_format_isSet;
}

bool OAITranscriptionJob::is_media_format_Valid() const{
    return m_media_format_isValid;
}

OAITranscriptionJob_Media OAITranscriptionJob::getMedia() const {
    return m_media;
}
void OAITranscriptionJob::setMedia(const OAITranscriptionJob_Media &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAITranscriptionJob::is_media_Set() const{
    return m_media_isSet;
}

bool OAITranscriptionJob::is_media_Valid() const{
    return m_media_isValid;
}

OAITranscriptionJob_Transcript OAITranscriptionJob::getTranscript() const {
    return m_transcript;
}
void OAITranscriptionJob::setTranscript(const OAITranscriptionJob_Transcript &transcript) {
    m_transcript = transcript;
    m_transcript_isSet = true;
}

bool OAITranscriptionJob::is_transcript_Set() const{
    return m_transcript_isSet;
}

bool OAITranscriptionJob::is_transcript_Valid() const{
    return m_transcript_isValid;
}

QDateTime OAITranscriptionJob::getStartTime() const {
    return m_start_time;
}
void OAITranscriptionJob::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAITranscriptionJob::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAITranscriptionJob::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAITranscriptionJob::getCreationTime() const {
    return m_creation_time;
}
void OAITranscriptionJob::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAITranscriptionJob::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAITranscriptionJob::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAITranscriptionJob::getCompletionTime() const {
    return m_completion_time;
}
void OAITranscriptionJob::setCompletionTime(const QDateTime &completion_time) {
    m_completion_time = completion_time;
    m_completion_time_isSet = true;
}

bool OAITranscriptionJob::is_completion_time_Set() const{
    return m_completion_time_isSet;
}

bool OAITranscriptionJob::is_completion_time_Valid() const{
    return m_completion_time_isValid;
}

QString OAITranscriptionJob::getFailureReason() const {
    return m_failure_reason;
}
void OAITranscriptionJob::setFailureReason(const QString &failure_reason) {
    m_failure_reason = failure_reason;
    m_failure_reason_isSet = true;
}

bool OAITranscriptionJob::is_failure_reason_Set() const{
    return m_failure_reason_isSet;
}

bool OAITranscriptionJob::is_failure_reason_Valid() const{
    return m_failure_reason_isValid;
}

OAITranscriptionJob_Settings OAITranscriptionJob::getSettings() const {
    return m_settings;
}
void OAITranscriptionJob::setSettings(const OAITranscriptionJob_Settings &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAITranscriptionJob::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAITranscriptionJob::is_settings_Valid() const{
    return m_settings_isValid;
}

OAITranscriptionJob_ModelSettings OAITranscriptionJob::getModelSettings() const {
    return m_model_settings;
}
void OAITranscriptionJob::setModelSettings(const OAITranscriptionJob_ModelSettings &model_settings) {
    m_model_settings = model_settings;
    m_model_settings_isSet = true;
}

bool OAITranscriptionJob::is_model_settings_Set() const{
    return m_model_settings_isSet;
}

bool OAITranscriptionJob::is_model_settings_Valid() const{
    return m_model_settings_isValid;
}

OAITranscriptionJob_JobExecutionSettings OAITranscriptionJob::getJobExecutionSettings() const {
    return m_job_execution_settings;
}
void OAITranscriptionJob::setJobExecutionSettings(const OAITranscriptionJob_JobExecutionSettings &job_execution_settings) {
    m_job_execution_settings = job_execution_settings;
    m_job_execution_settings_isSet = true;
}

bool OAITranscriptionJob::is_job_execution_settings_Set() const{
    return m_job_execution_settings_isSet;
}

bool OAITranscriptionJob::is_job_execution_settings_Valid() const{
    return m_job_execution_settings_isValid;
}

OAITranscriptionJob_ContentRedaction OAITranscriptionJob::getContentRedaction() const {
    return m_content_redaction;
}
void OAITranscriptionJob::setContentRedaction(const OAITranscriptionJob_ContentRedaction &content_redaction) {
    m_content_redaction = content_redaction;
    m_content_redaction_isSet = true;
}

bool OAITranscriptionJob::is_content_redaction_Set() const{
    return m_content_redaction_isSet;
}

bool OAITranscriptionJob::is_content_redaction_Valid() const{
    return m_content_redaction_isValid;
}

bool OAITranscriptionJob::getIdentifyLanguage() const {
    return m_identify_language;
}
void OAITranscriptionJob::setIdentifyLanguage(const bool &identify_language) {
    m_identify_language = identify_language;
    m_identify_language_isSet = true;
}

bool OAITranscriptionJob::is_identify_language_Set() const{
    return m_identify_language_isSet;
}

bool OAITranscriptionJob::is_identify_language_Valid() const{
    return m_identify_language_isValid;
}

bool OAITranscriptionJob::getIdentifyMultipleLanguages() const {
    return m_identify_multiple_languages;
}
void OAITranscriptionJob::setIdentifyMultipleLanguages(const bool &identify_multiple_languages) {
    m_identify_multiple_languages = identify_multiple_languages;
    m_identify_multiple_languages_isSet = true;
}

bool OAITranscriptionJob::is_identify_multiple_languages_Set() const{
    return m_identify_multiple_languages_isSet;
}

bool OAITranscriptionJob::is_identify_multiple_languages_Valid() const{
    return m_identify_multiple_languages_isValid;
}

QList OAITranscriptionJob::getLanguageOptions() const {
    return m_language_options;
}
void OAITranscriptionJob::setLanguageOptions(const QList &language_options) {
    m_language_options = language_options;
    m_language_options_isSet = true;
}

bool OAITranscriptionJob::is_language_options_Set() const{
    return m_language_options_isSet;
}

bool OAITranscriptionJob::is_language_options_Valid() const{
    return m_language_options_isValid;
}

float OAITranscriptionJob::getIdentifiedLanguageScore() const {
    return m_identified_language_score;
}
void OAITranscriptionJob::setIdentifiedLanguageScore(const float &identified_language_score) {
    m_identified_language_score = identified_language_score;
    m_identified_language_score_isSet = true;
}

bool OAITranscriptionJob::is_identified_language_score_Set() const{
    return m_identified_language_score_isSet;
}

bool OAITranscriptionJob::is_identified_language_score_Valid() const{
    return m_identified_language_score_isValid;
}

QList OAITranscriptionJob::getLanguageCodes() const {
    return m_language_codes;
}
void OAITranscriptionJob::setLanguageCodes(const QList &language_codes) {
    m_language_codes = language_codes;
    m_language_codes_isSet = true;
}

bool OAITranscriptionJob::is_language_codes_Set() const{
    return m_language_codes_isSet;
}

bool OAITranscriptionJob::is_language_codes_Valid() const{
    return m_language_codes_isValid;
}

QList OAITranscriptionJob::getTags() const {
    return m_tags;
}
void OAITranscriptionJob::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITranscriptionJob::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITranscriptionJob::is_tags_Valid() const{
    return m_tags_isValid;
}

OAITranscriptionJob_Subtitles OAITranscriptionJob::getSubtitles() const {
    return m_subtitles;
}
void OAITranscriptionJob::setSubtitles(const OAITranscriptionJob_Subtitles &subtitles) {
    m_subtitles = subtitles;
    m_subtitles_isSet = true;
}

bool OAITranscriptionJob::is_subtitles_Set() const{
    return m_subtitles_isSet;
}

bool OAITranscriptionJob::is_subtitles_Valid() const{
    return m_subtitles_isValid;
}

QMap OAITranscriptionJob::getLanguageIdSettings() const {
    return m_language_id_settings;
}
void OAITranscriptionJob::setLanguageIdSettings(const QMap &language_id_settings) {
    m_language_id_settings = language_id_settings;
    m_language_id_settings_isSet = true;
}

bool OAITranscriptionJob::is_language_id_settings_Set() const{
    return m_language_id_settings_isSet;
}

bool OAITranscriptionJob::is_language_id_settings_Valid() const{
    return m_language_id_settings_isValid;
}

QList OAITranscriptionJob::getToxicityDetection() const {
    return m_toxicity_detection;
}
void OAITranscriptionJob::setToxicityDetection(const QList &toxicity_detection) {
    m_toxicity_detection = toxicity_detection;
    m_toxicity_detection_isSet = true;
}

bool OAITranscriptionJob::is_toxicity_detection_Set() const{
    return m_toxicity_detection_isSet;
}

bool OAITranscriptionJob::is_toxicity_detection_Valid() const{
    return m_toxicity_detection_isValid;
}

bool OAITranscriptionJob::isSet() const {
...
bool OAITranscriptionJob::isValid() const {
