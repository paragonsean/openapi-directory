...
QString OAIInputDataConfig::getTuningDataS3Uri() const {
    return m_tuning_data_s3_uri;
}
void OAIInputDataConfig::setTuningDataS3Uri(const QString &tuning_data_s3_uri) {
    m_tuning_data_s3_uri = tuning_data_s3_uri;
    m_tuning_data_s3_uri_isSet = true;
}

bool OAIInputDataConfig::is_tuning_data_s3_uri_Set() const{
    return m_tuning_data_s3_uri_isSet;
}

bool OAIInputDataConfig::is_tuning_data_s3_uri_Valid() const{
    return m_tuning_data_s3_uri_isValid;
}

QString OAIInputDataConfig::getDataAccessRoleArn() const {
    return m_data_access_role_arn;
}
void OAIInputDataConfig::setDataAccessRoleArn(const QString &data_access_role_arn) {
    m_data_access_role_arn = data_access_role_arn;
    m_data_access_role_arn_isSet = true;
}

bool OAIInputDataConfig::is_data_access_role_arn_Set() const{
    return m_data_access_role_arn_isSet;
}

bool OAIInputDataConfig::is_data_access_role_arn_Valid() const{
