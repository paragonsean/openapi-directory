...
/*
 * OAIGetVocabularyFilterResponse.h
 *
 * 
 */

#ifndef OAIGetVocabularyFilterResponse_H
#define OAIGetVocabularyFilterResponse_H
...
class OAIGetVocabularyFilterResponse : public OAIObject {
public:
    OAIGetVocabularyFilterResponse();
    OAIGetVocabularyFilterResponse(QString json);
    ~OAIGetVocabularyFilterResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVocabularyFilterResponse)

#endif // OAIGetVocabularyFilterResponse_H
