...
/*
 * OAIGetVocabularyResponse.h
 *
 * 
 */

#ifndef OAIGetVocabularyResponse_H
#define OAIGetVocabularyResponse_H
...
class OAIGetVocabularyResponse : public OAIObject {
public:
    OAIGetVocabularyResponse();
    OAIGetVocabularyResponse(QString json);
    ~OAIGetVocabularyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVocabularyResponse)

#endif // OAIGetVocabularyResponse_H
