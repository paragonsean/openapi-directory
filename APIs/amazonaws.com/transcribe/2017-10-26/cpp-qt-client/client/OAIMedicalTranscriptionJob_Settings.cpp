...
OAIMedicalTranscriptionJob_Settings::OAIMedicalTranscriptionJob_Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMedicalTranscriptionJob_Settings::OAIMedicalTranscriptionJob_Settings() {
    this->initializeModel();
}

OAIMedicalTranscriptionJob_Settings::~OAIMedicalTranscriptionJob_Settings() {}

void OAIMedicalTranscriptionJob_Settings::initializeModel() {
...
void OAIMedicalTranscriptionJob_Settings::fromJson(QString jsonString) {
...
void OAIMedicalTranscriptionJob_Settings::fromJsonObject(QJsonObject json) {
...
QString OAIMedicalTranscriptionJob_Settings::asJson() const {
...
QJsonObject OAIMedicalTranscriptionJob_Settings::asJsonObject() const {
    QJsonObject obj;
...
bool OAIMedicalTranscriptionJob_Settings::getShowSpeakerLabels() const {
    return m_show_speaker_labels;
}
void OAIMedicalTranscriptionJob_Settings::setShowSpeakerLabels(const bool &show_speaker_labels) {
    m_show_speaker_labels = show_speaker_labels;
    m_show_speaker_labels_isSet = true;
}

bool OAIMedicalTranscriptionJob_Settings::is_show_speaker_labels_Set() const{
    return m_show_speaker_labels_isSet;
}

bool OAIMedicalTranscriptionJob_Settings::is_show_speaker_labels_Valid() const{
    return m_show_speaker_labels_isValid;
}

qint32 OAIMedicalTranscriptionJob_Settings::getMaxSpeakerLabels() const {
    return m_max_speaker_labels;
}
void OAIMedicalTranscriptionJob_Settings::setMaxSpeakerLabels(const qint32 &max_speaker_labels) {
    m_max_speaker_labels = max_speaker_labels;
    m_max_speaker_labels_isSet = true;
}

bool OAIMedicalTranscriptionJob_Settings::is_max_speaker_labels_Set() const{
    return m_max_speaker_labels_isSet;
}

bool OAIMedicalTranscriptionJob_Settings::is_max_speaker_labels_Valid() const{
    return m_max_speaker_labels_isValid;
}

bool OAIMedicalTranscriptionJob_Settings::getChannelIdentification() const {
    return m_channel_identification;
}
void OAIMedicalTranscriptionJob_Settings::setChannelIdentification(const bool &channel_identification) {
    m_channel_identification = channel_identification;
    m_channel_identification_isSet = true;
}

bool OAIMedicalTranscriptionJob_Settings::is_channel_identification_Set() const{
    return m_channel_identification_isSet;
}

bool OAIMedicalTranscriptionJob_Settings::is_channel_identification_Valid() const{
    return m_channel_identification_isValid;
}

bool OAIMedicalTranscriptionJob_Settings::getShowAlternatives() const {
    return m_show_alternatives;
}
void OAIMedicalTranscriptionJob_Settings::setShowAlternatives(const bool &show_alternatives) {
    m_show_alternatives = show_alternatives;
    m_show_alternatives_isSet = true;
}

bool OAIMedicalTranscriptionJob_Settings::is_show_alternatives_Set() const{
    return m_show_alternatives_isSet;
}

bool OAIMedicalTranscriptionJob_Settings::is_show_alternatives_Valid() const{
    return m_show_alternatives_isValid;
}

qint32 OAIMedicalTranscriptionJob_Settings::getMaxAlternatives() const {
    return m_max_alternatives;
}
void OAIMedicalTranscriptionJob_Settings::setMaxAlternatives(const qint32 &max_alternatives) {
    m_max_alternatives = max_alternatives;
    m_max_alternatives_isSet = true;
}

bool OAIMedicalTranscriptionJob_Settings::is_max_alternatives_Set() const{
    return m_max_alternatives_isSet;
}

bool OAIMedicalTranscriptionJob_Settings::is_max_alternatives_Valid() const{
    return m_max_alternatives_isValid;
}

QString OAIMedicalTranscriptionJob_Settings::getVocabularyName() const {
    return m_vocabulary_name;
}
void OAIMedicalTranscriptionJob_Settings::setVocabularyName(const QString &vocabulary_name) {
    m_vocabulary_name = vocabulary_name;
    m_vocabulary_name_isSet = true;
}

bool OAIMedicalTranscriptionJob_Settings::is_vocabulary_name_Set() const{
    return m_vocabulary_name_isSet;
}

bool OAIMedicalTranscriptionJob_Settings::is_vocabulary_name_Valid() const{
    return m_vocabulary_name_isValid;
}

bool OAIMedicalTranscriptionJob_Settings::isSet() const {
...
bool OAIMedicalTranscriptionJob_Settings::isValid() const {
