...
/*
 * OAIGetCallAnalyticsCategoryResponse_CategoryProperties.h
 *
 * 
 */

#ifndef OAIGetCallAnalyticsCategoryResponse_CategoryProperties_H
#define OAIGetCallAnalyticsCategoryResponse_CategoryProperties_H
...
class OAIGetCallAnalyticsCategoryResponse_CategoryProperties : public OAIObject {
public:
    OAIGetCallAnalyticsCategoryResponse_CategoryProperties();
    OAIGetCallAnalyticsCategoryResponse_CategoryProperties(QString json);
    ~OAIGetCallAnalyticsCategoryResponse_CategoryProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCallAnalyticsCategoryResponse_CategoryProperties)

#endif // OAIGetCallAnalyticsCategoryResponse_CategoryProperties_H
