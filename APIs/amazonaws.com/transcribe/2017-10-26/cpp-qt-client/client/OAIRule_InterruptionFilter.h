...
/*
 * OAIRule_InterruptionFilter.h
 *
 * 
 */

#ifndef OAIRule_InterruptionFilter_H
#define OAIRule_InterruptionFilter_H
...
class OAIRule_InterruptionFilter : public OAIObject {
public:
    OAIRule_InterruptionFilter();
    OAIRule_InterruptionFilter(QString json);
    ~OAIRule_InterruptionFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRule_InterruptionFilter)

#endif // OAIRule_InterruptionFilter_H
