...
OAIRule_SentimentFilter::OAIRule_SentimentFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRule_SentimentFilter::OAIRule_SentimentFilter() {
    this->initializeModel();
}

OAIRule_SentimentFilter::~OAIRule_SentimentFilter() {}

void OAIRule_SentimentFilter::initializeModel() {
...
void OAIRule_SentimentFilter::fromJson(QString jsonString) {
...
void OAIRule_SentimentFilter::fromJsonObject(QJsonObject json) {
...
QString OAIRule_SentimentFilter::asJson() const {
...
QJsonObject OAIRule_SentimentFilter::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRule_SentimentFilter::getSentiments() const {
    return m_sentiments;
}
void OAIRule_SentimentFilter::setSentiments(const QList &sentiments) {
    m_sentiments = sentiments;
    m_sentiments_isSet = true;
}

bool OAIRule_SentimentFilter::is_sentiments_Set() const{
    return m_sentiments_isSet;
}

bool OAIRule_SentimentFilter::is_sentiments_Valid() const{
    return m_sentiments_isValid;
}

OAISentimentFilter_AbsoluteTimeRange OAIRule_SentimentFilter::getAbsoluteTimeRange() const {
    return m_absolute_time_range;
}
void OAIRule_SentimentFilter::setAbsoluteTimeRange(const OAISentimentFilter_AbsoluteTimeRange &absolute_time_range) {
    m_absolute_time_range = absolute_time_range;
    m_absolute_time_range_isSet = true;
}

bool OAIRule_SentimentFilter::is_absolute_time_range_Set() const{
    return m_absolute_time_range_isSet;
}

bool OAIRule_SentimentFilter::is_absolute_time_range_Valid() const{
    return m_absolute_time_range_isValid;
}

OAISentimentFilter_RelativeTimeRange OAIRule_SentimentFilter::getRelativeTimeRange() const {
    return m_relative_time_range;
}
void OAIRule_SentimentFilter::setRelativeTimeRange(const OAISentimentFilter_RelativeTimeRange &relative_time_range) {
    m_relative_time_range = relative_time_range;
    m_relative_time_range_isSet = true;
}

bool OAIRule_SentimentFilter::is_relative_time_range_Set() const{
    return m_relative_time_range_isSet;
}

bool OAIRule_SentimentFilter::is_relative_time_range_Valid() const{
    return m_relative_time_range_isValid;
}

OAIParticipantRole OAIRule_SentimentFilter::getParticipantRole() const {
    return m_participant_role;
}
void OAIRule_SentimentFilter::setParticipantRole(const OAIParticipantRole &participant_role) {
    m_participant_role = participant_role;
    m_participant_role_isSet = true;
}

bool OAIRule_SentimentFilter::is_participant_role_Set() const{
    return m_participant_role_isSet;
}

bool OAIRule_SentimentFilter::is_participant_role_Valid() const{
    return m_participant_role_isValid;
}

bool OAIRule_SentimentFilter::getNegate() const {
    return m_negate;
}
void OAIRule_SentimentFilter::setNegate(const bool &negate) {
    m_negate = negate;
    m_negate_isSet = true;
}

bool OAIRule_SentimentFilter::is_negate_Set() const{
    return m_negate_isSet;
}

bool OAIRule_SentimentFilter::is_negate_Valid() const{
    return m_negate_isValid;
}

bool OAIRule_SentimentFilter::isSet() const {
...
bool OAIRule_SentimentFilter::isValid() const {
