...
/*
 * OAICreateCallAnalyticsCategoryResponse_CategoryProperties.h
 *
 * 
 */

#ifndef OAICreateCallAnalyticsCategoryResponse_CategoryProperties_H
#define OAICreateCallAnalyticsCategoryResponse_CategoryProperties_H
...
class OAICreateCallAnalyticsCategoryResponse_CategoryProperties : public OAIObject {
public:
    OAICreateCallAnalyticsCategoryResponse_CategoryProperties();
    OAICreateCallAnalyticsCategoryResponse_CategoryProperties(QString json);
    ~OAICreateCallAnalyticsCategoryResponse_CategoryProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCallAnalyticsCategoryResponse_CategoryProperties)

#endif // OAICreateCallAnalyticsCategoryResponse_CategoryProperties_H
