...
/*
 * OAIUpdateVocabularyFilterResponse.h
 *
 * 
 */

#ifndef OAIUpdateVocabularyFilterResponse_H
#define OAIUpdateVocabularyFilterResponse_H
...
class OAIUpdateVocabularyFilterResponse : public OAIObject {
public:
    OAIUpdateVocabularyFilterResponse();
    OAIUpdateVocabularyFilterResponse(QString json);
    ~OAIUpdateVocabularyFilterResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVocabularyFilterResponse)

#endif // OAIUpdateVocabularyFilterResponse_H
