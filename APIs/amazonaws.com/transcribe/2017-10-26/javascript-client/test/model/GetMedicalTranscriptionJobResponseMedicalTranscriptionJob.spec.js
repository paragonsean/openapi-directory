...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.GetMedicalTranscriptionJobResponseMedicalTranscriptionJob();
  });
  ...
  describe('GetMedicalTranscriptionJobResponseMedicalTranscriptionJob', function() {
    it('should create an instance of GetMedicalTranscriptionJobResponseMedicalTranscriptionJob', function() {
      // uncomment below and update the code to test GetMedicalTranscriptionJobResponseMedicalTranscriptionJob
      //var instance = new AmazonTranscribeService.GetMedicalTranscriptionJobResponseMedicalTranscriptionJob();
      //expect(instance).to.be.a(AmazonTranscribeService.GetMedicalTranscriptionJobResponseMedicalTranscriptionJob);
    });
