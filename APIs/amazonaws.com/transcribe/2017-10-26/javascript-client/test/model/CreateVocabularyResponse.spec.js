...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CreateVocabularyResponse();
  });
  ...
  describe('CreateVocabularyResponse', function() {
    it('should create an instance of CreateVocabularyResponse', function() {
      // uncomment below and update the code to test CreateVocabularyResponse
      //var instance = new AmazonTranscribeService.CreateVocabularyResponse();
      //expect(instance).to.be.a(AmazonTranscribeService.CreateVocabularyResponse);
    });
