...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.VocabularyInfo();
  });
  ...
  describe('VocabularyInfo', function() {
    it('should create an instance of VocabularyInfo', function() {
      // uncomment below and update the code to test VocabularyInfo
      //var instance = new AmazonTranscribeService.VocabularyInfo();
      //expect(instance).to.be.a(AmazonTranscribeService.VocabularyInfo);
    });
    ...
    it('should have the property vocabularyState (base name: "VocabularyState")', function() {
      // uncomment below and update the code to test the property vocabularyState
      //var instance = new AmazonTranscribeService.VocabularyInfo();
      //expect(instance).to.be();
    });
