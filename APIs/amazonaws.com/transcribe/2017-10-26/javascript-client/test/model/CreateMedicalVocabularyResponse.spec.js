...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CreateMedicalVocabularyResponse();
  });
  ...
  describe('CreateMedicalVocabularyResponse', function() {
    it('should create an instance of CreateMedicalVocabularyResponse', function() {
      // uncomment below and update the code to test CreateMedicalVocabularyResponse
      //var instance = new AmazonTranscribeService.CreateMedicalVocabularyResponse();
      //expect(instance).to.be.a(AmazonTranscribeService.CreateMedicalVocabularyResponse);
    });
