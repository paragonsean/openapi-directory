...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.UpdateCallAnalyticsCategoryRequest();
  });
  ...
  describe('UpdateCallAnalyticsCategoryRequest', function() {
    it('should create an instance of UpdateCallAnalyticsCategoryRequest', function() {
      // uncomment below and update the code to test UpdateCallAnalyticsCategoryRequest
      //var instance = new AmazonTranscribeService.UpdateCallAnalyticsCategoryRequest();
      //expect(instance).to.be.a(AmazonTranscribeService.UpdateCallAnalyticsCategoryRequest);
    });
