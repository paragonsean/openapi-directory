...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.TranscriptionJobSummary();
  });
  ...
  describe('TranscriptionJobSummary', function() {
    it('should create an instance of TranscriptionJobSummary', function() {
      // uncomment below and update the code to test TranscriptionJobSummary
      //var instance = new AmazonTranscribeService.TranscriptionJobSummary();
      //expect(instance).to.be.a(AmazonTranscribeService.TranscriptionJobSummary);
    });
