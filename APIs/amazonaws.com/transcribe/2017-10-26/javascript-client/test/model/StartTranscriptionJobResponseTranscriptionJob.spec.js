...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.StartTranscriptionJobResponseTranscriptionJob();
  });
  ...
  describe('StartTranscriptionJobResponseTranscriptionJob', function() {
    it('should create an instance of StartTranscriptionJobResponseTranscriptionJob', function() {
      // uncomment below and update the code to test StartTranscriptionJobResponseTranscriptionJob
      //var instance = new AmazonTranscribeService.StartTranscriptionJobResponseTranscriptionJob();
      //expect(instance).to.be.a(AmazonTranscribeService.StartTranscriptionJobResponseTranscriptionJob);
    });
