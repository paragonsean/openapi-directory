...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CategoryProperties();
  });
  ...
  describe('CategoryProperties', function() {
    it('should create an instance of CategoryProperties', function() {
      // uncomment below and update the code to test CategoryProperties
      //var instance = new AmazonTranscribeService.CategoryProperties();
      //expect(instance).to.be.a(AmazonTranscribeService.CategoryProperties);
    });
