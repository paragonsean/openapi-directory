...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.UpdateVocabularyResponse();
  });
  ...
  describe('UpdateVocabularyResponse', function() {
    it('should create an instance of UpdateVocabularyResponse', function() {
      // uncomment below and update the code to test UpdateVocabularyResponse
      //var instance = new AmazonTranscribeService.UpdateVocabularyResponse();
      //expect(instance).to.be.a(AmazonTranscribeService.UpdateVocabularyResponse);
    });
