...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.GetCallAnalyticsJobResponseCallAnalyticsJob();
  });
  ...
  describe('GetCallAnalyticsJobResponseCallAnalyticsJob', function() {
    it('should create an instance of GetCallAnalyticsJobResponseCallAnalyticsJob', function() {
      // uncomment below and update the code to test GetCallAnalyticsJobResponseCallAnalyticsJob
      //var instance = new AmazonTranscribeService.GetCallAnalyticsJobResponseCallAnalyticsJob();
      //expect(instance).to.be.a(AmazonTranscribeService.GetCallAnalyticsJobResponseCallAnalyticsJob);
    });
