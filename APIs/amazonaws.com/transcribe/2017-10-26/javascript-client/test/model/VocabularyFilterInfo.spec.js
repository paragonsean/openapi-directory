...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.VocabularyFilterInfo();
  });
  ...
  describe('VocabularyFilterInfo', function() {
    it('should create an instance of VocabularyFilterInfo', function() {
      // uncomment below and update the code to test VocabularyFilterInfo
      //var instance = new AmazonTranscribeService.VocabularyFilterInfo();
      //expect(instance).to.be.a(AmazonTranscribeService.VocabularyFilterInfo);
    });
