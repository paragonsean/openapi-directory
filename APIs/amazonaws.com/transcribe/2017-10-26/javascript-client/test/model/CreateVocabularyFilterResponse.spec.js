...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CreateVocabularyFilterResponse();
  });
  ...
  describe('CreateVocabularyFilterResponse', function() {
    it('should create an instance of CreateVocabularyFilterResponse', function() {
      // uncomment below and update the code to test CreateVocabularyFilterResponse
      //var instance = new AmazonTranscribeService.CreateVocabularyFilterResponse();
      //expect(instance).to.be.a(AmazonTranscribeService.CreateVocabularyFilterResponse);
    });
