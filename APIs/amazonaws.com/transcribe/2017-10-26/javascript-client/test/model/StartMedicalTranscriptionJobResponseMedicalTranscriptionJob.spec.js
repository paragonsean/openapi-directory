...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.StartMedicalTranscriptionJobResponseMedicalTranscriptionJob();
  });
  ...
  describe('StartMedicalTranscriptionJobResponseMedicalTranscriptionJob', function() {
    it('should create an instance of StartMedicalTranscriptionJobResponseMedicalTranscriptionJob', function() {
      // uncomment below and update the code to test StartMedicalTranscriptionJobResponseMedicalTranscriptionJob
      //var instance = new AmazonTranscribeService.StartMedicalTranscriptionJobResponseMedicalTranscriptionJob();
      //expect(instance).to.be.a(AmazonTranscribeService.StartMedicalTranscriptionJobResponseMedicalTranscriptionJob);
    });
