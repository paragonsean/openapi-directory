...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.GetVocabularyResponse();
  });
  ...
  describe('GetVocabularyResponse', function() {
    it('should create an instance of GetVocabularyResponse', function() {
      // uncomment below and update the code to test GetVocabularyResponse
      //var instance = new AmazonTranscribeService.GetVocabularyResponse();
      //expect(instance).to.be.a(AmazonTranscribeService.GetVocabularyResponse);
    });
