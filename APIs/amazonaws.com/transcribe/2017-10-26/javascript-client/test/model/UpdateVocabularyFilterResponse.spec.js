...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.UpdateVocabularyFilterResponse();
  });
  ...
  describe('UpdateVocabularyFilterResponse', function() {
    it('should create an instance of UpdateVocabularyFilterResponse', function() {
      // uncomment below and update the code to test UpdateVocabularyFilterResponse
      //var instance = new AmazonTranscribeService.UpdateVocabularyFilterResponse();
      //expect(instance).to.be.a(AmazonTranscribeService.UpdateVocabularyFilterResponse);
    });
