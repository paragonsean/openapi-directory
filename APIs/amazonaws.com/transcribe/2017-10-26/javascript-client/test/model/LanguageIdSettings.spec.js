...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.LanguageIdSettings();
  });
  ...
  describe('LanguageIdSettings', function() {
    it('should create an instance of LanguageIdSettings', function() {
      // uncomment below and update the code to test LanguageIdSettings
      //var instance = new AmazonTranscribeService.LanguageIdSettings();
      //expect(instance).to.be.a(AmazonTranscribeService.LanguageIdSettings);
    });
