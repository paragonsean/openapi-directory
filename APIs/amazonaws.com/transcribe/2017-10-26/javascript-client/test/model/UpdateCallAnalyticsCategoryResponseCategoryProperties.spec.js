...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.UpdateCallAnalyticsCategoryResponseCategoryProperties();
  });
  ...
  describe('UpdateCallAnalyticsCategoryResponseCategoryProperties', function() {
    it('should create an instance of UpdateCallAnalyticsCategoryResponseCategoryProperties', function() {
      // uncomment below and update the code to test UpdateCallAnalyticsCategoryResponseCategoryProperties
      //var instance = new AmazonTranscribeService.UpdateCallAnalyticsCategoryResponseCategoryProperties();
      //expect(instance).to.be.a(AmazonTranscribeService.UpdateCallAnalyticsCategoryResponseCategoryProperties);
    });
