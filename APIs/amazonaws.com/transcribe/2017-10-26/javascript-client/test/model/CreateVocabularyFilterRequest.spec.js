...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CreateVocabularyFilterRequest();
  });
  ...
  describe('CreateVocabularyFilterRequest', function() {
    it('should create an instance of CreateVocabularyFilterRequest', function() {
      // uncomment below and update the code to test CreateVocabularyFilterRequest
      //var instance = new AmazonTranscribeService.CreateVocabularyFilterRequest();
      //expect(instance).to.be.a(AmazonTranscribeService.CreateVocabularyFilterRequest);
    });
    ...
    it('should have the property vocabularyFilterFileUri (base name: "VocabularyFilterFileUri")', function() {
      // uncomment below and update the code to test the property vocabularyFilterFileUri
      //var instance = new AmazonTranscribeService.CreateVocabularyFilterRequest();
      //expect(instance).to.be();
    });
