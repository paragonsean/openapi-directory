...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.TranscriptionJob();
  });
  ...
  describe('TranscriptionJob', function() {
    it('should create an instance of TranscriptionJob', function() {
      // uncomment below and update the code to test TranscriptionJob
      //var instance = new AmazonTranscribeService.TranscriptionJob();
      //expect(instance).to.be.a(AmazonTranscribeService.TranscriptionJob);
    });
