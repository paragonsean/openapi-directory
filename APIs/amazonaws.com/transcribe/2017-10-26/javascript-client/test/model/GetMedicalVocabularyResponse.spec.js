...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.GetMedicalVocabularyResponse();
  });
  ...
  describe('GetMedicalVocabularyResponse', function() {
    it('should create an instance of GetMedicalVocabularyResponse', function() {
      // uncomment below and update the code to test GetMedicalVocabularyResponse
      //var instance = new AmazonTranscribeService.GetMedicalVocabularyResponse();
      //expect(instance).to.be.a(AmazonTranscribeService.GetMedicalVocabularyResponse);
    });
