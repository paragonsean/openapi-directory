...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CreateCallAnalyticsCategoryRequest();
  });
  ...
  describe('CreateCallAnalyticsCategoryRequest', function() {
    it('should create an instance of CreateCallAnalyticsCategoryRequest', function() {
      // uncomment below and update the code to test CreateCallAnalyticsCategoryRequest
      //var instance = new AmazonTranscribeService.CreateCallAnalyticsCategoryRequest();
      //expect(instance).to.be.a(AmazonTranscribeService.CreateCallAnalyticsCategoryRequest);
    });
