...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.MedicalTranscriptionJobSummary();
  });
  ...
  describe('MedicalTranscriptionJobSummary', function() {
    it('should create an instance of MedicalTranscriptionJobSummary', function() {
      // uncomment below and update the code to test MedicalTranscriptionJobSummary
      //var instance = new AmazonTranscribeService.MedicalTranscriptionJobSummary();
      //expect(instance).to.be.a(AmazonTranscribeService.MedicalTranscriptionJobSummary);
    });
    ...
    it('should have the property outputLocationType (base name: "OutputLocationType")', function() {
      // uncomment below and update the code to test the property outputLocationType
      //var instance = new AmazonTranscribeService.MedicalTranscriptionJobSummary();
      //expect(instance).to.be();
    });
