...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.UpdateVocabularyRequest();
  });
  ...
  describe('UpdateVocabularyRequest', function() {
    it('should create an instance of UpdateVocabularyRequest', function() {
      // uncomment below and update the code to test UpdateVocabularyRequest
      //var instance = new AmazonTranscribeService.UpdateVocabularyRequest();
      //expect(instance).to.be.a(AmazonTranscribeService.UpdateVocabularyRequest);
    });
