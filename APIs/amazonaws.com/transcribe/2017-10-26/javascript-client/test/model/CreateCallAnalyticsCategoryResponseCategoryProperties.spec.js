...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CreateCallAnalyticsCategoryResponseCategoryProperties();
  });
  ...
  describe('CreateCallAnalyticsCategoryResponseCategoryProperties', function() {
    it('should create an instance of CreateCallAnalyticsCategoryResponseCategoryProperties', function() {
      // uncomment below and update the code to test CreateCallAnalyticsCategoryResponseCategoryProperties
      //var instance = new AmazonTranscribeService.CreateCallAnalyticsCategoryResponseCategoryProperties();
      //expect(instance).to.be.a(AmazonTranscribeService.CreateCallAnalyticsCategoryResponseCategoryProperties);
    });
