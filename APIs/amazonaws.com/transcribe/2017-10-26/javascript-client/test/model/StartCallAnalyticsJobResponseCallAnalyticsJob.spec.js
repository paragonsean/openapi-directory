...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.StartCallAnalyticsJobResponseCallAnalyticsJob();
  });
  ...
  describe('StartCallAnalyticsJobResponseCallAnalyticsJob', function() {
    it('should create an instance of StartCallAnalyticsJobResponseCallAnalyticsJob', function() {
      // uncomment below and update the code to test StartCallAnalyticsJobResponseCallAnalyticsJob
      //var instance = new AmazonTranscribeService.StartCallAnalyticsJobResponseCallAnalyticsJob();
      //expect(instance).to.be.a(AmazonTranscribeService.StartCallAnalyticsJobResponseCallAnalyticsJob);
    });
