...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTranscribeService.CallAnalyticsJob();
  });
  ...
  describe('CallAnalyticsJob', function() {
    it('should create an instance of CallAnalyticsJob', function() {
      // uncomment below and update the code to test CallAnalyticsJob
      //var instance = new AmazonTranscribeService.CallAnalyticsJob();
      //expect(instance).to.be.a(AmazonTranscribeService.CallAnalyticsJob);
    });
