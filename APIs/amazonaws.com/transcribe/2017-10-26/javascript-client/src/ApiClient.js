...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://transcribe.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://transcribe.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-10-26/Javascript'
        };
