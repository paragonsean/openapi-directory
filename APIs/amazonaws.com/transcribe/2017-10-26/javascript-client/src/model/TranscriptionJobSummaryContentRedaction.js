...
/**
 * The TranscriptionJobSummaryContentRedaction model module.
 * @module model/TranscriptionJobSummaryContentRedaction
 * @version 2017-10-26
 */
class TranscriptionJobSummaryContentRedaction {
    /**
     * Constructs a new <code>TranscriptionJobSummaryContentRedaction</code>.
     * @alias module:model/TranscriptionJobSummaryContentRedaction
    ...
    constructor(redactionType, redactionOutput) { 
        ...
        TranscriptionJobSummaryContentRedaction.initialize(this, redactionType, redactionOutput);
    }
    ...
    /**
     * Constructs a <code>TranscriptionJobSummaryContentRedaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TranscriptionJobSummaryContentRedaction} obj Optional instance to populate.
     * @return {module:model/TranscriptionJobSummaryContentRedaction} The populated <code>TranscriptionJobSummaryContentRedaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TranscriptionJobSummaryContentRedaction();
    ...
    /**
     * Validates the JSON data with respect to <code>TranscriptionJobSummaryContentRedaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TranscriptionJobSummaryContentRedaction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TranscriptionJobSummaryContentRedaction.RequiredProperties) {
...
TranscriptionJobSummaryContentRedaction.RequiredProperties = ["RedactionType", "RedactionOutput"];

/**
 * @member {module:model/RedactionType} RedactionType
 */
TranscriptionJobSummaryContentRedaction.prototype['RedactionType'] = undefined;

/**
 * @member {module:model/RedactionOutput} RedactionOutput
 */
TranscriptionJobSummaryContentRedaction.prototype['RedactionOutput'] = undefined;

/**
 * @member {Array} PiiEntityTypes
 */
TranscriptionJobSummaryContentRedaction.prototype['PiiEntityTypes'] = undefined;
...
export default TranscriptionJobSummaryContentRedaction;
