...
/**
 * The MedicalTranscriptionSetting model module.
 * @module model/MedicalTranscriptionSetting
 * @version 2017-10-26
 */
class MedicalTranscriptionSetting {
    /**
     * Constructs a new <code>MedicalTranscriptionSetting</code>.
     ...
     * @alias module:model/MedicalTranscriptionSetting
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MedicalTranscriptionSetting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MedicalTranscriptionSetting} obj Optional instance to populate.
     * @return {module:model/MedicalTranscriptionSetting} The populated <code>MedicalTranscriptionSetting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MedicalTranscriptionSetting();
    ...
    /**
     * Validates the JSON data with respect to <code>MedicalTranscriptionSetting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MedicalTranscriptionSetting</code>.
     */
...
export default MedicalTranscriptionSetting;
