...
/**
 * The MedicalTranscriptionJob model module.
 * @module model/MedicalTranscriptionJob
 * @version 2017-10-26
 */
class MedicalTranscriptionJob {
    /**
     * Constructs a new <code>MedicalTranscriptionJob</code>.
     ...
     * @alias module:model/MedicalTranscriptionJob
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MedicalTranscriptionJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MedicalTranscriptionJob} obj Optional instance to populate.
     * @return {module:model/MedicalTranscriptionJob} The populated <code>MedicalTranscriptionJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MedicalTranscriptionJob();
    ...
    /**
     * Validates the JSON data with respect to <code>MedicalTranscriptionJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MedicalTranscriptionJob</code>.
     */
...
export default MedicalTranscriptionJob;
