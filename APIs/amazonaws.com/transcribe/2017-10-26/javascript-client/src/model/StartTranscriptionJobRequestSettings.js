...
/**
 * The StartTranscriptionJobRequestSettings model module.
 * @module model/StartTranscriptionJobRequestSettings
 * @version 2017-10-26
 */
class StartTranscriptionJobRequestSettings {
    /**
     * Constructs a new <code>StartTranscriptionJobRequestSettings</code>.
     * @alias module:model/StartTranscriptionJobRequestSettings
     * @implements module:model/Settings
     */
    constructor() { 
        Settings.initialize(this);
        StartTranscriptionJobRequestSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartTranscriptionJobRequestSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartTranscriptionJobRequestSettings} obj Optional instance to populate.
     * @return {module:model/StartTranscriptionJobRequestSettings} The populated <code>StartTranscriptionJobRequestSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartTranscriptionJobRequestSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>StartTranscriptionJobRequestSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartTranscriptionJobRequestSettings</code>.
     */
 ...
 */
StartTranscriptionJobRequestSettings.prototype['VocabularyName'] = undefined;

/**
 * @member {Boolean} ShowSpeakerLabels
 */
StartTranscriptionJobRequestSettings.prototype['ShowSpeakerLabels'] = undefined;

/**
 * @member {Number} MaxSpeakerLabels
 */
StartTranscriptionJobRequestSettings.prototype['MaxSpeakerLabels'] = undefined;

/**
 * @member {Boolean} ChannelIdentification
 */
StartTranscriptionJobRequestSettings.prototype['ChannelIdentification'] = undefined;

/**
 * @member {Boolean} ShowAlternatives
 */
StartTranscriptionJobRequestSettings.prototype['ShowAlternatives'] = undefined;

/**
 * @member {Number} MaxAlternatives
 */
StartTranscriptionJobRequestSettings.prototype['MaxAlternatives'] = undefined;

/**
 * @member {String} VocabularyFilterName
 */
StartTranscriptionJobRequestSettings.prototype['VocabularyFilterName'] = undefined;

/**
 * @member {module:model/VocabularyFilterMethod} VocabularyFilterMethod
 */
StartTranscriptionJobRequestSettings.prototype['VocabularyFilterMethod'] = undefined;
...
export default StartTranscriptionJobRequestSettings;
