...
/**
 * The GetMedicalTranscriptionJobResponseMedicalTranscriptionJob model module.
 * @module model/GetMedicalTranscriptionJobResponseMedicalTranscriptionJob
 * @version 2017-10-26
 */
class GetMedicalTranscriptionJobResponseMedicalTranscriptionJob {
    /**
     * Constructs a new <code>GetMedicalTranscriptionJobResponseMedicalTranscriptionJob</code>.
     * @alias module:model/GetMedicalTranscriptionJobResponseMedicalTranscriptionJob
     * @implements module:model/MedicalTranscriptionJob
     */
    constructor() { 
        MedicalTranscriptionJob.initialize(this);
        GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetMedicalTranscriptionJobResponseMedicalTranscriptionJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMedicalTranscriptionJobResponseMedicalTranscriptionJob} obj Optional instance to populate.
     * @return {module:model/GetMedicalTranscriptionJobResponseMedicalTranscriptionJob} The populated <code>GetMedicalTranscriptionJobResponseMedicalTranscriptionJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMedicalTranscriptionJobResponseMedicalTranscriptionJob();
    ...
    /**
     * Validates the JSON data with respect to <code>GetMedicalTranscriptionJobResponseMedicalTranscriptionJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMedicalTranscriptionJobResponseMedicalTranscriptionJob</code>.
     */
 ...
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['MedicalTranscriptionJobName'] = undefined;

/**
 * @member {module:model/TranscriptionJobStatus} TranscriptionJobStatus
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['TranscriptionJobStatus'] = undefined;

/**
 * @member {module:model/LanguageCode} LanguageCode
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['LanguageCode'] = undefined;

/**
 * @member {Number} MediaSampleRateHertz
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['MediaSampleRateHertz'] = undefined;

/**
 * @member {module:model/MediaFormat} MediaFormat
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['MediaFormat'] = undefined;

/**
 * @member {module:model/Media} Media
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['Media'] = undefined;

/**
 * @member {module:model/MedicalTranscriptionJobTranscript} Transcript
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['Transcript'] = undefined;

/**
 * @member {Date} StartTime
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['StartTime'] = undefined;

/**
 * @member {Date} CreationTime
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['CreationTime'] = undefined;

/**
 * @member {Date} CompletionTime
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['CompletionTime'] = undefined;

/**
 * @member {String} FailureReason
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['FailureReason'] = undefined;

/**
 * @member {module:model/MedicalTranscriptionJobSettings} Settings
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['Settings'] = undefined;

/**
 * @member {module:model/MedicalContentIdentificationType} ContentIdentificationType
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['ContentIdentificationType'] = undefined;

/**
 * @member {module:model/Specialty} Specialty
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['Specialty'] = undefined;

/**
 * @member {module:model/Type} Type
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['Type'] = undefined;

/**
 * @member {Array} Tags
 */
GetMedicalTranscriptionJobResponseMedicalTranscriptionJob.prototype['Tags'] = undefined;
...
export default GetMedicalTranscriptionJobResponseMedicalTranscriptionJob;
