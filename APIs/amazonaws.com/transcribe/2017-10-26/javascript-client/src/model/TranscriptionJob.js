...
/**
 * The TranscriptionJob model module.
 * @module model/TranscriptionJob
 * @version 2017-10-26
 */
class TranscriptionJob {
    /**
     * Constructs a new <code>TranscriptionJob</code>.
     ...
     * @alias module:model/TranscriptionJob
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TranscriptionJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TranscriptionJob} obj Optional instance to populate.
     * @return {module:model/TranscriptionJob} The populated <code>TranscriptionJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TranscriptionJob();
    ...
    /**
     * Validates the JSON data with respect to <code>TranscriptionJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TranscriptionJob</code>.
     */
