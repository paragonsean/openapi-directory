...
/*
 * OAIRegisterConnectorRequest.h
 *
 * 
 */

#ifndef OAIRegisterConnectorRequest_H
#define OAIRegisterConnectorRequest_H
...
namespace OpenAPI {
class OAIRegisterConnectorRequest_connectorProvisioningConfig;

class OAIRegisterConnectorRequest : public OAIObject {
public:
    OAIRegisterConnectorRequest();
    OAIRegisterConnectorRequest(QString json);
    ~OAIRegisterConnectorRequest() override;
    ...
    OAIRegisterConnectorRequest_connectorProvisioningConfig getConnectorProvisioningConfig() const;
    void setConnectorProvisioningConfig(const OAIRegisterConnectorRequest_connectorProvisioningConfig &connector_provisioning_config);
...
private:
    ...
    OAIRegisterConnectorRequest_connectorProvisioningConfig m_connector_provisioning_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterConnectorRequest)

#endif // OAIRegisterConnectorRequest_H
