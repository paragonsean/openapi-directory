...
/*
 * OAIConnectorOAuthRequest.h
 *
 *  Used by select connectors for which the OAuth workflow is supported, such as Salesforce, Google Analytics, Marketo, Zendesk, and Slack. 
 */

#ifndef OAIConnectorOAuthRequest_H
#define OAIConnectorOAuthRequest_H
...
class OAIConnectorOAuthRequest : public OAIObject {
public:
    OAIConnectorOAuthRequest();
    OAIConnectorOAuthRequest(QString json);
    ~OAIConnectorOAuthRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectorOAuthRequest)

#endif // OAIConnectorOAuthRequest_H
