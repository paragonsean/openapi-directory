...
double OAIRange::getMaximum() const {
    return m_maximum;
}
void OAIRange::setMaximum(const double &maximum) {
    m_maximum = maximum;
    m_maximum_isSet = true;
}

bool OAIRange::is_maximum_Set() const{
    return m_maximum_isSet;
}

bool OAIRange::is_maximum_Valid() const{
    return m_maximum_isValid;
}

double OAIRange::getMinimum() const {
    return m_minimum;
}
void OAIRange::setMinimum(const double &minimum) {
    m_minimum = minimum;
    m_minimum_isSet = true;
}

bool OAIRange::is_minimum_Set() const{
    return m_minimum_isSet;
}

bool OAIRange::is_minimum_Valid() const{
