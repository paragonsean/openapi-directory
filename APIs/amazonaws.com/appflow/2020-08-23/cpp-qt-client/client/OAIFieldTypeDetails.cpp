...
OAIFieldTypeDetails::OAIFieldTypeDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFieldTypeDetails::OAIFieldTypeDetails() {
    this->initializeModel();
}

OAIFieldTypeDetails::~OAIFieldTypeDetails() {}

void OAIFieldTypeDetails::initializeModel() {
...
void OAIFieldTypeDetails::fromJson(QString jsonString) {
...
void OAIFieldTypeDetails::fromJsonObject(QJsonObject json) {
...
QString OAIFieldTypeDetails::asJson() const {
...
QJsonObject OAIFieldTypeDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFieldTypeDetails::getFieldType() const {
    return m_field_type;
}
void OAIFieldTypeDetails::setFieldType(const QString &field_type) {
    m_field_type = field_type;
    m_field_type_isSet = true;
}

bool OAIFieldTypeDetails::is_field_type_Set() const{
    return m_field_type_isSet;
}

bool OAIFieldTypeDetails::is_field_type_Valid() const{
    return m_field_type_isValid;
}

QList OAIFieldTypeDetails::getFilterOperators() const {
    return m_filter_operators;
}
void OAIFieldTypeDetails::setFilterOperators(const QList &filter_operators) {
    m_filter_operators = filter_operators;
    m_filter_operators_isSet = true;
}

bool OAIFieldTypeDetails::is_filter_operators_Set() const{
    return m_filter_operators_isSet;
}

bool OAIFieldTypeDetails::is_filter_operators_Valid() const{
    return m_filter_operators_isValid;
}

QList OAIFieldTypeDetails::getSupportedValues() const {
    return m_supported_values;
}
void OAIFieldTypeDetails::setSupportedValues(const QList &supported_values) {
    m_supported_values = supported_values;
    m_supported_values_isSet = true;
}

bool OAIFieldTypeDetails::is_supported_values_Set() const{
    return m_supported_values_isSet;
}

bool OAIFieldTypeDetails::is_supported_values_Valid() const{
    return m_supported_values_isValid;
}

QString OAIFieldTypeDetails::getValueRegexPattern() const {
    return m_value_regex_pattern;
}
void OAIFieldTypeDetails::setValueRegexPattern(const QString &value_regex_pattern) {
    m_value_regex_pattern = value_regex_pattern;
    m_value_regex_pattern_isSet = true;
}

bool OAIFieldTypeDetails::is_value_regex_pattern_Set() const{
    return m_value_regex_pattern_isSet;
}

bool OAIFieldTypeDetails::is_value_regex_pattern_Valid() const{
    return m_value_regex_pattern_isValid;
}

QString OAIFieldTypeDetails::getSupportedDateFormat() const {
    return m_supported_date_format;
}
void OAIFieldTypeDetails::setSupportedDateFormat(const QString &supported_date_format) {
    m_supported_date_format = supported_date_format;
    m_supported_date_format_isSet = true;
}

bool OAIFieldTypeDetails::is_supported_date_format_Set() const{
    return m_supported_date_format_isSet;
}

bool OAIFieldTypeDetails::is_supported_date_format_Valid() const{
    return m_supported_date_format_isValid;
}

OAIFieldTypeDetails_fieldValueRange OAIFieldTypeDetails::getFieldValueRange() const {
    return m_field_value_range;
}
void OAIFieldTypeDetails::setFieldValueRange(const OAIFieldTypeDetails_fieldValueRange &field_value_range) {
    m_field_value_range = field_value_range;
    m_field_value_range_isSet = true;
}

bool OAIFieldTypeDetails::is_field_value_range_Set() const{
    return m_field_value_range_isSet;
}

bool OAIFieldTypeDetails::is_field_value_range_Valid() const{
    return m_field_value_range_isValid;
}

OAIFieldTypeDetails_fieldLengthRange OAIFieldTypeDetails::getFieldLengthRange() const {
    return m_field_length_range;
}
void OAIFieldTypeDetails::setFieldLengthRange(const OAIFieldTypeDetails_fieldLengthRange &field_length_range) {
    m_field_length_range = field_length_range;
    m_field_length_range_isSet = true;
}

bool OAIFieldTypeDetails::is_field_length_range_Set() const{
    return m_field_length_range_isSet;
}

bool OAIFieldTypeDetails::is_field_length_range_Valid() const{
    return m_field_length_range_isValid;
}

bool OAIFieldTypeDetails::isSet() const {
...
bool OAIFieldTypeDetails::isValid() const {
