...
#include "OAIConnectorOperator.h"
...
OAIConnectorOperator::OAIConnectorOperator(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectorOperator::OAIConnectorOperator() {
    this->initializeModel();
}

OAIConnectorOperator::~OAIConnectorOperator() {}

void OAIConnectorOperator::initializeModel() {
...
void OAIConnectorOperator::fromJson(QString jsonString) {
...
void OAIConnectorOperator::fromJsonObject(QJsonObject json) {
...
QString OAIConnectorOperator::asJson() const {
...
QJsonObject OAIConnectorOperator::asJsonObject() const {
    QJsonObject obj;
...
OAIAmplitudeConnectorOperator OAIConnectorOperator::getAmplitude() const {
    return m_amplitude;
}
void OAIConnectorOperator::setAmplitude(const OAIAmplitudeConnectorOperator &amplitude) {
    m_amplitude = amplitude;
    m_amplitude_isSet = true;
}

bool OAIConnectorOperator::is_amplitude_Set() const{
    return m_amplitude_isSet;
}

bool OAIConnectorOperator::is_amplitude_Valid() const{
    return m_amplitude_isValid;
}

OAIDatadogConnectorOperator OAIConnectorOperator::getDatadog() const {
    return m_datadog;
}
void OAIConnectorOperator::setDatadog(const OAIDatadogConnectorOperator &datadog) {
    m_datadog = datadog;
    m_datadog_isSet = true;
}

bool OAIConnectorOperator::is_datadog_Set() const{
    return m_datadog_isSet;
}

bool OAIConnectorOperator::is_datadog_Valid() const{
    return m_datadog_isValid;
}

OAIDynatraceConnectorOperator OAIConnectorOperator::getDynatrace() const {
    return m_dynatrace;
}
void OAIConnectorOperator::setDynatrace(const OAIDynatraceConnectorOperator &dynatrace) {
    m_dynatrace = dynatrace;
    m_dynatrace_isSet = true;
}

bool OAIConnectorOperator::is_dynatrace_Set() const{
    return m_dynatrace_isSet;
}

bool OAIConnectorOperator::is_dynatrace_Valid() const{
    return m_dynatrace_isValid;
}

OAIGoogleAnalyticsConnectorOperator OAIConnectorOperator::getGoogleAnalytics() const {
    return m_google_analytics;
}
void OAIConnectorOperator::setGoogleAnalytics(const OAIGoogleAnalyticsConnectorOperator &google_analytics) {
    m_google_analytics = google_analytics;
    m_google_analytics_isSet = true;
}

bool OAIConnectorOperator::is_google_analytics_Set() const{
    return m_google_analytics_isSet;
}

bool OAIConnectorOperator::is_google_analytics_Valid() const{
    return m_google_analytics_isValid;
}

OAIInforNexusConnectorOperator OAIConnectorOperator::getInforNexus() const {
    return m_infor_nexus;
}
void OAIConnectorOperator::setInforNexus(const OAIInforNexusConnectorOperator &infor_nexus) {
    m_infor_nexus = infor_nexus;
    m_infor_nexus_isSet = true;
}

bool OAIConnectorOperator::is_infor_nexus_Set() const{
    return m_infor_nexus_isSet;
}

bool OAIConnectorOperator::is_infor_nexus_Valid() const{
    return m_infor_nexus_isValid;
}

OAIMarketoConnectorOperator OAIConnectorOperator::getMarketo() const {
    return m_marketo;
}
void OAIConnectorOperator::setMarketo(const OAIMarketoConnectorOperator &marketo) {
    m_marketo = marketo;
    m_marketo_isSet = true;
}

bool OAIConnectorOperator::is_marketo_Set() const{
    return m_marketo_isSet;
}

bool OAIConnectorOperator::is_marketo_Valid() const{
    return m_marketo_isValid;
}

OAIS3ConnectorOperator OAIConnectorOperator::getS3() const {
    return m_s3;
}
void OAIConnectorOperator::setS3(const OAIS3ConnectorOperator &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIConnectorOperator::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIConnectorOperator::is_s3_Valid() const{
    return m_s3_isValid;
}

OAISalesforceConnectorOperator OAIConnectorOperator::getSalesforce() const {
    return m_salesforce;
}
void OAIConnectorOperator::setSalesforce(const OAISalesforceConnectorOperator &salesforce) {
    m_salesforce = salesforce;
    m_salesforce_isSet = true;
}

bool OAIConnectorOperator::is_salesforce_Set() const{
    return m_salesforce_isSet;
}

bool OAIConnectorOperator::is_salesforce_Valid() const{
    return m_salesforce_isValid;
}

OAIServiceNowConnectorOperator OAIConnectorOperator::getServiceNow() const {
    return m_service_now;
}
void OAIConnectorOperator::setServiceNow(const OAIServiceNowConnectorOperator &service_now) {
    m_service_now = service_now;
    m_service_now_isSet = true;
}

bool OAIConnectorOperator::is_service_now_Set() const{
    return m_service_now_isSet;
}

bool OAIConnectorOperator::is_service_now_Valid() const{
    return m_service_now_isValid;
}

OAISingularConnectorOperator OAIConnectorOperator::getSingular() const {
    return m_singular;
}
void OAIConnectorOperator::setSingular(const OAISingularConnectorOperator &singular) {
    m_singular = singular;
    m_singular_isSet = true;
}

bool OAIConnectorOperator::is_singular_Set() const{
    return m_singular_isSet;
}

bool OAIConnectorOperator::is_singular_Valid() const{
    return m_singular_isValid;
}

OAISlackConnectorOperator OAIConnectorOperator::getSlack() const {
    return m_slack;
}
void OAIConnectorOperator::setSlack(const OAISlackConnectorOperator &slack) {
    m_slack = slack;
    m_slack_isSet = true;
}

bool OAIConnectorOperator::is_slack_Set() const{
    return m_slack_isSet;
}

bool OAIConnectorOperator::is_slack_Valid() const{
    return m_slack_isValid;
}

OAITrendmicroConnectorOperator OAIConnectorOperator::getTrendmicro() const {
    return m_trendmicro;
}
void OAIConnectorOperator::setTrendmicro(const OAITrendmicroConnectorOperator &trendmicro) {
    m_trendmicro = trendmicro;
    m_trendmicro_isSet = true;
}

bool OAIConnectorOperator::is_trendmicro_Set() const{
    return m_trendmicro_isSet;
}

bool OAIConnectorOperator::is_trendmicro_Valid() const{
    return m_trendmicro_isValid;
}

OAIVeevaConnectorOperator OAIConnectorOperator::getVeeva() const {
    return m_veeva;
}
void OAIConnectorOperator::setVeeva(const OAIVeevaConnectorOperator &veeva) {
    m_veeva = veeva;
    m_veeva_isSet = true;
}

bool OAIConnectorOperator::is_veeva_Set() const{
    return m_veeva_isSet;
}

bool OAIConnectorOperator::is_veeva_Valid() const{
    return m_veeva_isValid;
}

OAIZendeskConnectorOperator OAIConnectorOperator::getZendesk() const {
    return m_zendesk;
}
void OAIConnectorOperator::setZendesk(const OAIZendeskConnectorOperator &zendesk) {
    m_zendesk = zendesk;
    m_zendesk_isSet = true;
}

bool OAIConnectorOperator::is_zendesk_Set() const{
    return m_zendesk_isSet;
}

bool OAIConnectorOperator::is_zendesk_Valid() const{
    return m_zendesk_isValid;
}

OAISAPODataConnectorOperator OAIConnectorOperator::getSapoData() const {
    return m_sapo_data;
}
void OAIConnectorOperator::setSapoData(const OAISAPODataConnectorOperator &sapo_data) {
    m_sapo_data = sapo_data;
    m_sapo_data_isSet = true;
}

bool OAIConnectorOperator::is_sapo_data_Set() const{
    return m_sapo_data_isSet;
}

bool OAIConnectorOperator::is_sapo_data_Valid() const{
    return m_sapo_data_isValid;
}

OAIOperator OAIConnectorOperator::getCustomConnector() const {
    return m_custom_connector;
}
void OAIConnectorOperator::setCustomConnector(const OAIOperator &custom_connector) {
    m_custom_connector = custom_connector;
    m_custom_connector_isSet = true;
}

bool OAIConnectorOperator::is_custom_connector_Set() const{
    return m_custom_connector_isSet;
}

bool OAIConnectorOperator::is_custom_connector_Valid() const{
    return m_custom_connector_isValid;
}

OAIPardotConnectorOperator OAIConnectorOperator::getPardot() const {
    return m_pardot;
}
void OAIConnectorOperator::setPardot(const OAIPardotConnectorOperator &pardot) {
    m_pardot = pardot;
    m_pardot_isSet = true;
}

bool OAIConnectorOperator::is_pardot_Set() const{
    return m_pardot_isSet;
}

bool OAIConnectorOperator::is_pardot_Valid() const{
    return m_pardot_isValid;
}

bool OAIConnectorOperator::isSet() const {
...
bool OAIConnectorOperator::isValid() const {
