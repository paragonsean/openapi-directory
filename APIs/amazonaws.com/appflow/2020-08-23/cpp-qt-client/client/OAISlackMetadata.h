...
#ifndef OAISlackMetadata_H
#define OAISlackMetadata_H
...
class OAISlackMetadata : public OAIObject {
public:
    OAISlackMetadata();
    OAISlackMetadata(QString json);
    ~OAISlackMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlackMetadata)

#endif // OAISlackMetadata_H
