...
/*
 * OAIConnectorProfileProperties_Redshift.h
 *
 * 
 */

#ifndef OAIConnectorProfileProperties_Redshift_H
#define OAIConnectorProfileProperties_Redshift_H
...
class OAIConnectorProfileProperties_Redshift : public OAIObject {
public:
    OAIConnectorProfileProperties_Redshift();
    OAIConnectorProfileProperties_Redshift(QString json);
    ~OAIConnectorProfileProperties_Redshift() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectorProfileProperties_Redshift)

#endif // OAIConnectorProfileProperties_Redshift_H
