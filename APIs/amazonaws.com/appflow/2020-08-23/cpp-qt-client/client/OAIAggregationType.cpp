...
void OAIAggregationType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("None", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAggregationType::NONE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SingleFile", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAggregationType::SINGLEFILE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAggregationType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIAggregationType::NONE:
            val = "None";
            break;
        case eOAIAggregationType::SINGLEFILE:
            val = "SingleFile";
            break;
        default:
            break;
