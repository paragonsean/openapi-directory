...
OAIConnectorType OAISourceFlowConfig::getConnectorType() const {
    return m_connector_type;
}
void OAISourceFlowConfig::setConnectorType(const OAIConnectorType &connector_type) {
...
QString OAISourceFlowConfig::getApiVersion() const {
    return m_api_version;
}
void OAISourceFlowConfig::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAISourceFlowConfig::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAISourceFlowConfig::is_api_version_Valid() const{
...
OAICreateFlow_request_sourceFlowConfig_sourceConnectorProperties OAISourceFlowConfig::getSourceConnectorProperties() const {
    return m_source_connector_properties;
}
void OAISourceFlowConfig::setSourceConnectorProperties(const OAICreateFlow_request_sourceFlowConfig_sourceConnectorProperties &source_connector_properties) {
...
OAICreateFlow_request_sourceFlowConfig_incrementalPullConfig OAISourceFlowConfig::getIncrementalPullConfig() const {
    return m_incremental_pull_config;
}
void OAISourceFlowConfig::setIncrementalPullConfig(const OAICreateFlow_request_sourceFlowConfig_incrementalPullConfig &incremental_pull_config) {
