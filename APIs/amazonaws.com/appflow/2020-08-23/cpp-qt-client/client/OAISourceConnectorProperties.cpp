...
OAISourceConnectorProperties_Amplitude OAISourceConnectorProperties::getAmplitude() const {
    return m_amplitude;
}
void OAISourceConnectorProperties::setAmplitude(const OAISourceConnectorProperties_Amplitude &amplitude) {
    m_amplitude = amplitude;
    m_amplitude_isSet = true;
}

bool OAISourceConnectorProperties::is_amplitude_Set() const{
    return m_amplitude_isSet;
}

bool OAISourceConnectorProperties::is_amplitude_Valid() const{
    return m_amplitude_isValid;
}

OAISourceConnectorProperties_Datadog OAISourceConnectorProperties::getDatadog() const {
    return m_datadog;
}
void OAISourceConnectorProperties::setDatadog(const OAISourceConnectorProperties_Datadog &datadog) {
    m_datadog = datadog;
    m_datadog_isSet = true;
}

bool OAISourceConnectorProperties::is_datadog_Set() const{
    return m_datadog_isSet;
}

bool OAISourceConnectorProperties::is_datadog_Valid() const{
    return m_datadog_isValid;
}

OAISourceConnectorProperties_Dynatrace OAISourceConnectorProperties::getDynatrace() const {
    return m_dynatrace;
}
void OAISourceConnectorProperties::setDynatrace(const OAISourceConnectorProperties_Dynatrace &dynatrace) {
    m_dynatrace = dynatrace;
    m_dynatrace_isSet = true;
}

bool OAISourceConnectorProperties::is_dynatrace_Set() const{
    return m_dynatrace_isSet;
}

bool OAISourceConnectorProperties::is_dynatrace_Valid() const{
    return m_dynatrace_isValid;
}

OAISourceConnectorProperties_GoogleAnalytics OAISourceConnectorProperties::getGoogleAnalytics() const {
    return m_google_analytics;
}
void OAISourceConnectorProperties::setGoogleAnalytics(const OAISourceConnectorProperties_GoogleAnalytics &google_analytics) {
    m_google_analytics = google_analytics;
    m_google_analytics_isSet = true;
}

bool OAISourceConnectorProperties::is_google_analytics_Set() const{
    return m_google_analytics_isSet;
}

bool OAISourceConnectorProperties::is_google_analytics_Valid() const{
    return m_google_analytics_isValid;
}

OAISourceConnectorProperties_InforNexus OAISourceConnectorProperties::getInforNexus() const {
    return m_infor_nexus;
}
void OAISourceConnectorProperties::setInforNexus(const OAISourceConnectorProperties_InforNexus &infor_nexus) {
    m_infor_nexus = infor_nexus;
    m_infor_nexus_isSet = true;
}

bool OAISourceConnectorProperties::is_infor_nexus_Set() const{
    return m_infor_nexus_isSet;
}

bool OAISourceConnectorProperties::is_infor_nexus_Valid() const{
...
OAISourceConnectorProperties_Singular OAISourceConnectorProperties::getSingular() const {
    return m_singular;
}
void OAISourceConnectorProperties::setSingular(const OAISourceConnectorProperties_Singular &singular) {
    m_singular = singular;
    m_singular_isSet = true;
}

bool OAISourceConnectorProperties::is_singular_Set() const{
    return m_singular_isSet;
}

bool OAISourceConnectorProperties::is_singular_Valid() const{
    return m_singular_isValid;
}

OAISourceConnectorProperties_Slack OAISourceConnectorProperties::getSlack() const {
    return m_slack;
}
void OAISourceConnectorProperties::setSlack(const OAISourceConnectorProperties_Slack &slack) {
    m_slack = slack;
    m_slack_isSet = true;
}

bool OAISourceConnectorProperties::is_slack_Set() const{
    return m_slack_isSet;
}

bool OAISourceConnectorProperties::is_slack_Valid() const{
    return m_slack_isValid;
}

OAISourceConnectorProperties_Trendmicro OAISourceConnectorProperties::getTrendmicro() const {
    return m_trendmicro;
}
void OAISourceConnectorProperties::setTrendmicro(const OAISourceConnectorProperties_Trendmicro &trendmicro) {
    m_trendmicro = trendmicro;
    m_trendmicro_isSet = true;
}

bool OAISourceConnectorProperties::is_trendmicro_Set() const{
    return m_trendmicro_isSet;
}

bool OAISourceConnectorProperties::is_trendmicro_Valid() const{
    return m_trendmicro_isValid;
}

OAISourceConnectorProperties_Veeva OAISourceConnectorProperties::getVeeva() const {
    return m_veeva;
}
void OAISourceConnectorProperties::setVeeva(const OAISourceConnectorProperties_Veeva &veeva) {
    m_veeva = veeva;
    m_veeva_isSet = true;
}

bool OAISourceConnectorProperties::is_veeva_Set() const{
    return m_veeva_isSet;
}

bool OAISourceConnectorProperties::is_veeva_Valid() const{
...
OAISAPODataSourceProperties OAISourceConnectorProperties::getSapoData() const {
    return m_sapo_data;
}
void OAISourceConnectorProperties::setSapoData(const OAISAPODataSourceProperties &sapo_data) {
    m_sapo_data = sapo_data;
    m_sapo_data_isSet = true;
}

bool OAISourceConnectorProperties::is_sapo_data_Set() const{
    return m_sapo_data_isSet;
}

bool OAISourceConnectorProperties::is_sapo_data_Valid() const{
    return m_sapo_data_isValid;
}

OAICustomConnectorSourceProperties OAISourceConnectorProperties::getCustomConnector() const {
    return m_custom_connector;
}
void OAISourceConnectorProperties::setCustomConnector(const OAICustomConnectorSourceProperties &custom_connector) {
    m_custom_connector = custom_connector;
    m_custom_connector_isSet = true;
}

bool OAISourceConnectorProperties::is_custom_connector_Set() const{
    return m_custom_connector_isSet;
}

bool OAISourceConnectorProperties::is_custom_connector_Valid() const{
    return m_custom_connector_isValid;
}

OAISourceConnectorProperties_Pardot OAISourceConnectorProperties::getPardot() const {
    return m_pardot;
}
void OAISourceConnectorProperties::setPardot(const OAISourceConnectorProperties_Pardot &pardot) {
    m_pardot = pardot;
    m_pardot_isSet = true;
}

bool OAISourceConnectorProperties::is_pardot_Set() const{
    return m_pardot_isSet;
}

bool OAISourceConnectorProperties::is_pardot_Valid() const{
