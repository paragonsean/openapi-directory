...
OAICreateFlow_request_triggerConfig_triggerProperties OAITriggerConfig::getTriggerProperties() const {
    return m_trigger_properties;
}
void OAITriggerConfig::setTriggerProperties(const OAICreateFlow_request_triggerConfig_triggerProperties &trigger_properties) {
