...
OAIAuthenticationConfig_oAuth2Defaults::OAIAuthenticationConfig_oAuth2Defaults(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthenticationConfig_oAuth2Defaults::OAIAuthenticationConfig_oAuth2Defaults() {
    this->initializeModel();
}

OAIAuthenticationConfig_oAuth2Defaults::~OAIAuthenticationConfig_oAuth2Defaults() {}

void OAIAuthenticationConfig_oAuth2Defaults::initializeModel() {
...
void OAIAuthenticationConfig_oAuth2Defaults::fromJson(QString jsonString) {
...
void OAIAuthenticationConfig_oAuth2Defaults::fromJsonObject(QJsonObject json) {
...
QString OAIAuthenticationConfig_oAuth2Defaults::asJson() const {
...
QJsonObject OAIAuthenticationConfig_oAuth2Defaults::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAuthenticationConfig_oAuth2Defaults::getOauthScopes() const {
    return m_oauth_scopes;
}
void OAIAuthenticationConfig_oAuth2Defaults::setOauthScopes(const QList &oauth_scopes) {
    m_oauth_scopes = oauth_scopes;
    m_oauth_scopes_isSet = true;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_oauth_scopes_Set() const{
    return m_oauth_scopes_isSet;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_oauth_scopes_Valid() const{
    return m_oauth_scopes_isValid;
}

QList OAIAuthenticationConfig_oAuth2Defaults::getTokenUrls() const {
    return m_token_urls;
}
void OAIAuthenticationConfig_oAuth2Defaults::setTokenUrls(const QList &token_urls) {
    m_token_urls = token_urls;
    m_token_urls_isSet = true;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_token_urls_Set() const{
    return m_token_urls_isSet;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_token_urls_Valid() const{
    return m_token_urls_isValid;
}

QList OAIAuthenticationConfig_oAuth2Defaults::getAuthCodeUrls() const {
    return m_auth_code_urls;
}
void OAIAuthenticationConfig_oAuth2Defaults::setAuthCodeUrls(const QList &auth_code_urls) {
    m_auth_code_urls = auth_code_urls;
    m_auth_code_urls_isSet = true;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_auth_code_urls_Set() const{
    return m_auth_code_urls_isSet;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_auth_code_urls_Valid() const{
    return m_auth_code_urls_isValid;
}

QList OAIAuthenticationConfig_oAuth2Defaults::getOauth2GrantTypesSupported() const {
    return m_oauth2_grant_types_supported;
}
void OAIAuthenticationConfig_oAuth2Defaults::setOauth2GrantTypesSupported(const QList &oauth2_grant_types_supported) {
    m_oauth2_grant_types_supported = oauth2_grant_types_supported;
    m_oauth2_grant_types_supported_isSet = true;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_oauth2_grant_types_supported_Set() const{
    return m_oauth2_grant_types_supported_isSet;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_oauth2_grant_types_supported_Valid() const{
    return m_oauth2_grant_types_supported_isValid;
}

QList OAIAuthenticationConfig_oAuth2Defaults::getOauth2CustomProperties() const {
    return m_oauth2_custom_properties;
}
void OAIAuthenticationConfig_oAuth2Defaults::setOauth2CustomProperties(const QList &oauth2_custom_properties) {
    m_oauth2_custom_properties = oauth2_custom_properties;
    m_oauth2_custom_properties_isSet = true;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_oauth2_custom_properties_Set() const{
    return m_oauth2_custom_properties_isSet;
}

bool OAIAuthenticationConfig_oAuth2Defaults::is_oauth2_custom_properties_Valid() const{
    return m_oauth2_custom_properties_isValid;
}

bool OAIAuthenticationConfig_oAuth2Defaults::isSet() const {
...
bool OAIAuthenticationConfig_oAuth2Defaults::isValid() const {
