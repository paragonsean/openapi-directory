...
/*
 * OAIOAuth2Credentials.h
 *
 * The OAuth 2.0 credentials required for OAuth 2.0 authentication.
 */

#ifndef OAIOAuth2Credentials_H
#define OAIOAuth2Credentials_H
...
class OAIOAuth2Credentials : public OAIObject {
public:
    OAIOAuth2Credentials();
    OAIOAuth2Credentials(QString json);
    ~OAIOAuth2Credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOAuth2Credentials)

#endif // OAIOAuth2Credentials_H
