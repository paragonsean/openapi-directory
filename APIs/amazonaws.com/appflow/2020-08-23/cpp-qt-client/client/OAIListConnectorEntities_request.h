...
/*
 * OAIListConnectorEntities_request.h
 *
 * 
 */

#ifndef OAIListConnectorEntities_request_H
#define OAIListConnectorEntities_request_H
...
class OAIListConnectorEntities_request : public OAIObject {
public:
    OAIListConnectorEntities_request();
    OAIListConnectorEntities_request(QString json);
    ~OAIListConnectorEntities_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListConnectorEntities_request)

#endif // OAIListConnectorEntities_request_H
