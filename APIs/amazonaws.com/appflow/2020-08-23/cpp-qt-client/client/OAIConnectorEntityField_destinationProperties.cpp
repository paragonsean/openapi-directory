...
OAIConnectorEntityField_destinationProperties::OAIConnectorEntityField_destinationProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectorEntityField_destinationProperties::OAIConnectorEntityField_destinationProperties() {
    this->initializeModel();
}

OAIConnectorEntityField_destinationProperties::~OAIConnectorEntityField_destinationProperties() {}

void OAIConnectorEntityField_destinationProperties::initializeModel() {
...
void OAIConnectorEntityField_destinationProperties::fromJson(QString jsonString) {
...
void OAIConnectorEntityField_destinationProperties::fromJsonObject(QJsonObject json) {
...
QString OAIConnectorEntityField_destinationProperties::asJson() const {
...
QJsonObject OAIConnectorEntityField_destinationProperties::asJsonObject() const {
    QJsonObject obj;
...
bool OAIConnectorEntityField_destinationProperties::getIsCreatable() const {
    return m_is_creatable;
}
void OAIConnectorEntityField_destinationProperties::setIsCreatable(const bool &is_creatable) {
    m_is_creatable = is_creatable;
    m_is_creatable_isSet = true;
}

bool OAIConnectorEntityField_destinationProperties::is_is_creatable_Set() const{
    return m_is_creatable_isSet;
}

bool OAIConnectorEntityField_destinationProperties::is_is_creatable_Valid() const{
    return m_is_creatable_isValid;
}

bool OAIConnectorEntityField_destinationProperties::getIsNullable() const {
    return m_is_nullable;
}
void OAIConnectorEntityField_destinationProperties::setIsNullable(const bool &is_nullable) {
    m_is_nullable = is_nullable;
    m_is_nullable_isSet = true;
}

bool OAIConnectorEntityField_destinationProperties::is_is_nullable_Set() const{
    return m_is_nullable_isSet;
}

bool OAIConnectorEntityField_destinationProperties::is_is_nullable_Valid() const{
    return m_is_nullable_isValid;
}

bool OAIConnectorEntityField_destinationProperties::getIsUpsertable() const {
    return m_is_upsertable;
}
void OAIConnectorEntityField_destinationProperties::setIsUpsertable(const bool &is_upsertable) {
    m_is_upsertable = is_upsertable;
    m_is_upsertable_isSet = true;
}

bool OAIConnectorEntityField_destinationProperties::is_is_upsertable_Set() const{
    return m_is_upsertable_isSet;
}

bool OAIConnectorEntityField_destinationProperties::is_is_upsertable_Valid() const{
    return m_is_upsertable_isValid;
}

bool OAIConnectorEntityField_destinationProperties::getIsUpdatable() const {
    return m_is_updatable;
}
void OAIConnectorEntityField_destinationProperties::setIsUpdatable(const bool &is_updatable) {
    m_is_updatable = is_updatable;
    m_is_updatable_isSet = true;
}

bool OAIConnectorEntityField_destinationProperties::is_is_updatable_Set() const{
    return m_is_updatable_isSet;
}

bool OAIConnectorEntityField_destinationProperties::is_is_updatable_Valid() const{
    return m_is_updatable_isValid;
}

bool OAIConnectorEntityField_destinationProperties::getIsDefaultedOnCreate() const {
    return m_is_defaulted_on_create;
}
void OAIConnectorEntityField_destinationProperties::setIsDefaultedOnCreate(const bool &is_defaulted_on_create) {
    m_is_defaulted_on_create = is_defaulted_on_create;
    m_is_defaulted_on_create_isSet = true;
}

bool OAIConnectorEntityField_destinationProperties::is_is_defaulted_on_create_Set() const{
    return m_is_defaulted_on_create_isSet;
}

bool OAIConnectorEntityField_destinationProperties::is_is_defaulted_on_create_Valid() const{
    return m_is_defaulted_on_create_isValid;
}

QList OAIConnectorEntityField_destinationProperties::getSupportedWriteOperations() const {
    return m_supported_write_operations;
}
void OAIConnectorEntityField_destinationProperties::setSupportedWriteOperations(const QList &supported_write_operations) {
    m_supported_write_operations = supported_write_operations;
    m_supported_write_operations_isSet = true;
}

bool OAIConnectorEntityField_destinationProperties::is_supported_write_operations_Set() const{
    return m_supported_write_operations_isSet;
}

bool OAIConnectorEntityField_destinationProperties::is_supported_write_operations_Valid() const{
    return m_supported_write_operations_isValid;
}

bool OAIConnectorEntityField_destinationProperties::isSet() const {
...
bool OAIConnectorEntityField_destinationProperties::isValid() const {
