...
OAISalesforceDataTransferApi OAISourceConnectorProperties_Salesforce::getDataTransferApi() const {
    return m_data_transfer_api;
}
void OAISourceConnectorProperties_Salesforce::setDataTransferApi(const OAISalesforceDataTransferApi &data_transfer_api) {
    m_data_transfer_api = data_transfer_api;
    m_data_transfer_api_isSet = true;
}

bool OAISourceConnectorProperties_Salesforce::is_data_transfer_api_Set() const{
    return m_data_transfer_api_isSet;
}

bool OAISourceConnectorProperties_Salesforce::is_data_transfer_api_Valid() const{
