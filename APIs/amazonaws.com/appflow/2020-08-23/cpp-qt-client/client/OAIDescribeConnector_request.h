...
/*
 * OAIDescribeConnector_request.h
 *
 * 
 */

#ifndef OAIDescribeConnector_request_H
#define OAIDescribeConnector_request_H
...
class OAIDescribeConnector_request : public OAIObject {
public:
    OAIDescribeConnector_request();
    OAIDescribeConnector_request(QString json);
    ~OAIDescribeConnector_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConnector_request)

#endif // OAIDescribeConnector_request_H
