...
/*
 * OAIStartFlowRequest.h
 *
 * 
 */

#ifndef OAIStartFlowRequest_H
#define OAIStartFlowRequest_H
...
class OAIStartFlowRequest : public OAIObject {
public:
    OAIStartFlowRequest();
    OAIStartFlowRequest(QString json);
    ~OAIStartFlowRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFlowRequest)

#endif // OAIStartFlowRequest_H
