...
/*
 * OAIResetConnectorMetadataCacheRequest.h
 *
 * 
 */

#ifndef OAIResetConnectorMetadataCacheRequest_H
#define OAIResetConnectorMetadataCacheRequest_H
...
class OAIResetConnectorMetadataCacheRequest : public OAIObject {
public:
    OAIResetConnectorMetadataCacheRequest();
    OAIResetConnectorMetadataCacheRequest(QString json);
    ~OAIResetConnectorMetadataCacheRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetConnectorMetadataCacheRequest)

#endif // OAIResetConnectorMetadataCacheRequest_H
