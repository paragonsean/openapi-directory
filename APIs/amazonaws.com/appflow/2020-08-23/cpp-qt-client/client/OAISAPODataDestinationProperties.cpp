...
#include "OAISAPODataDestinationProperties.h"
...
OAISAPODataDestinationProperties::OAISAPODataDestinationProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISAPODataDestinationProperties::OAISAPODataDestinationProperties() {
    this->initializeModel();
}

OAISAPODataDestinationProperties::~OAISAPODataDestinationProperties() {}

void OAISAPODataDestinationProperties::initializeModel() {
...
void OAISAPODataDestinationProperties::fromJson(QString jsonString) {
...
void OAISAPODataDestinationProperties::fromJsonObject(QJsonObject json) {
...
QString OAISAPODataDestinationProperties::asJson() const {
...
QJsonObject OAISAPODataDestinationProperties::asJsonObject() const {
    QJsonObject obj;
...
QString OAISAPODataDestinationProperties::getObjectPath() const {
    return m_object_path;
}
void OAISAPODataDestinationProperties::setObjectPath(const QString &object_path) {
    m_object_path = object_path;
    m_object_path_isSet = true;
}

bool OAISAPODataDestinationProperties::is_object_path_Set() const{
    return m_object_path_isSet;
}

bool OAISAPODataDestinationProperties::is_object_path_Valid() const{
    return m_object_path_isValid;
}

OAISAPODataDestinationProperties_successResponseHandlingConfig OAISAPODataDestinationProperties::getSuccessResponseHandlingConfig() const {
    return m_success_response_handling_config;
}
void OAISAPODataDestinationProperties::setSuccessResponseHandlingConfig(const OAISAPODataDestinationProperties_successResponseHandlingConfig &success_response_handling_config) {
    m_success_response_handling_config = success_response_handling_config;
    m_success_response_handling_config_isSet = true;
}

bool OAISAPODataDestinationProperties::is_success_response_handling_config_Set() const{
    return m_success_response_handling_config_isSet;
}

bool OAISAPODataDestinationProperties::is_success_response_handling_config_Valid() const{
    return m_success_response_handling_config_isValid;
}

QList<QString> OAISAPODataDestinationProperties::getIdFieldNames() const {
    return m_id_field_names;
}
void OAISAPODataDestinationProperties::setIdFieldNames(const QList<QString> &id_field_names) {
    m_id_field_names = id_field_names;
    m_id_field_names_isSet = true;
}

bool OAISAPODataDestinationProperties::is_id_field_names_Set() const{
    return m_id_field_names_isSet;
}

bool OAISAPODataDestinationProperties::is_id_field_names_Valid() const{
    return m_id_field_names_isValid;
}

OAIErrorHandlingConfig OAISAPODataDestinationProperties::getErrorHandlingConfig() const {
    return m_error_handling_config;
}
void OAISAPODataDestinationProperties::setErrorHandlingConfig(const OAIErrorHandlingConfig &error_handling_config) {
    m_error_handling_config = error_handling_config;
    m_error_handling_config_isSet = true;
}

bool OAISAPODataDestinationProperties::is_error_handling_config_Set() const{
    return m_error_handling_config_isSet;
}

bool OAISAPODataDestinationProperties::is_error_handling_config_Valid() const{
    return m_error_handling_config_isValid;
}

OAIWriteOperationType OAISAPODataDestinationProperties::getWriteOperationType() const {
    return m_write_operation_type;
}
void OAISAPODataDestinationProperties::setWriteOperationType(const OAIWriteOperationType &write_operation_type) {
    m_write_operation_type = write_operation_type;
    m_write_operation_type_isSet = true;
}

bool OAISAPODataDestinationProperties::is_write_operation_type_Set() const{
    return m_write_operation_type_isSet;
}

bool OAISAPODataDestinationProperties::is_write_operation_type_Valid() const{
    return m_write_operation_type_isValid;
}

bool OAISAPODataDestinationProperties::isSet() const {
...
bool OAISAPODataDestinationProperties::isValid() const {
