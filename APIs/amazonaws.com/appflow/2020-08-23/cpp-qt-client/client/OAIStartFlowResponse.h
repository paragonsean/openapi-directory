...
/*
 * OAIStartFlowResponse.h
 *
 * 
 */

#ifndef OAIStartFlowResponse_H
#define OAIStartFlowResponse_H
...
class OAIStartFlowResponse : public OAIObject {
public:
    OAIStartFlowResponse();
    OAIStartFlowResponse(QString json);
    ~OAIStartFlowResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFlowResponse)

#endif // OAIStartFlowResponse_H
