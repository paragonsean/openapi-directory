...
/*
 * OAIDescribeConnectorEntity_request.h
 *
 * 
 */

#ifndef OAIDescribeConnectorEntity_request_H
#define OAIDescribeConnectorEntity_request_H
...
class OAIDescribeConnectorEntity_request : public OAIObject {
public:
    OAIDescribeConnectorEntity_request();
    OAIDescribeConnectorEntity_request(QString json);
    ~OAIDescribeConnectorEntity_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConnectorEntity_request)

#endif // OAIDescribeConnectorEntity_request_H
