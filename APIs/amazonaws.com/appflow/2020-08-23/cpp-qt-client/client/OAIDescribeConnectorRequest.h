...
/*
 * OAIDescribeConnectorRequest.h
 *
 * 
 */

#ifndef OAIDescribeConnectorRequest_H
#define OAIDescribeConnectorRequest_H
...
class OAIDescribeConnectorRequest : public OAIObject {
public:
    OAIDescribeConnectorRequest();
    OAIDescribeConnectorRequest(QString json);
    ~OAIDescribeConnectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConnectorRequest)

#endif // OAIDescribeConnectorRequest_H
