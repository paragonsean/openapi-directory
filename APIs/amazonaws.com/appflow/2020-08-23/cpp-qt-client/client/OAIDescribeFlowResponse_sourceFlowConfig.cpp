...
OAIDescribeFlowResponse_sourceFlowConfig::OAIDescribeFlowResponse_sourceFlowConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFlowResponse_sourceFlowConfig::OAIDescribeFlowResponse_sourceFlowConfig() {
    this->initializeModel();
}

OAIDescribeFlowResponse_sourceFlowConfig::~OAIDescribeFlowResponse_sourceFlowConfig() {}

void OAIDescribeFlowResponse_sourceFlowConfig::initializeModel() {
...
void OAIDescribeFlowResponse_sourceFlowConfig::fromJson(QString jsonString) {
...
void OAIDescribeFlowResponse_sourceFlowConfig::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFlowResponse_sourceFlowConfig::asJson() const {
...
QJsonObject OAIDescribeFlowResponse_sourceFlowConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIConnectorType OAIDescribeFlowResponse_sourceFlowConfig::getConnectorType() const {
    return m_connector_type;
}
void OAIDescribeFlowResponse_sourceFlowConfig::setConnectorType(const OAIConnectorType &connector_type) {
    m_connector_type = connector_type;
    m_connector_type_isSet = true;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_connector_type_Set() const{
    return m_connector_type_isSet;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_connector_type_Valid() const{
    return m_connector_type_isValid;
}

QString OAIDescribeFlowResponse_sourceFlowConfig::getApiVersion() const {
    return m_api_version;
}
void OAIDescribeFlowResponse_sourceFlowConfig::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_api_version_Valid() const{
    return m_api_version_isValid;
}

QString OAIDescribeFlowResponse_sourceFlowConfig::getConnectorProfileName() const {
    return m_connector_profile_name;
}
void OAIDescribeFlowResponse_sourceFlowConfig::setConnectorProfileName(const QString &connector_profile_name) {
    m_connector_profile_name = connector_profile_name;
    m_connector_profile_name_isSet = true;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_connector_profile_name_Set() const{
    return m_connector_profile_name_isSet;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_connector_profile_name_Valid() const{
    return m_connector_profile_name_isValid;
}

OAICreateFlow_request_sourceFlowConfig_sourceConnectorProperties OAIDescribeFlowResponse_sourceFlowConfig::getSourceConnectorProperties() const {
    return m_source_connector_properties;
}
void OAIDescribeFlowResponse_sourceFlowConfig::setSourceConnectorProperties(const OAICreateFlow_request_sourceFlowConfig_sourceConnectorProperties &source_connector_properties) {
    m_source_connector_properties = source_connector_properties;
    m_source_connector_properties_isSet = true;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_source_connector_properties_Set() const{
    return m_source_connector_properties_isSet;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_source_connector_properties_Valid() const{
    return m_source_connector_properties_isValid;
}

OAICreateFlow_request_sourceFlowConfig_incrementalPullConfig OAIDescribeFlowResponse_sourceFlowConfig::getIncrementalPullConfig() const {
    return m_incremental_pull_config;
}
void OAIDescribeFlowResponse_sourceFlowConfig::setIncrementalPullConfig(const OAICreateFlow_request_sourceFlowConfig_incrementalPullConfig &incremental_pull_config) {
    m_incremental_pull_config = incremental_pull_config;
    m_incremental_pull_config_isSet = true;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_incremental_pull_config_Set() const{
    return m_incremental_pull_config_isSet;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::is_incremental_pull_config_Valid() const{
    return m_incremental_pull_config_isValid;
}

bool OAIDescribeFlowResponse_sourceFlowConfig::isSet() const {
...
bool OAIDescribeFlowResponse_sourceFlowConfig::isValid() const {
