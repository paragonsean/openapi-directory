...
/*
 * OAICreateConnectorProfileRequest.h
 *
 * 
 */

#ifndef OAICreateConnectorProfileRequest_H
#define OAICreateConnectorProfileRequest_H

#include <QJsonObject>

#include "OAIConnectionMode.h"
#include "OAIConnectorType.h"
#include "OAICreateConnectorProfileRequest_connectorProfileConfig.h"
#include <QString>
...
namespace OpenAPI {
class OAICreateConnectorProfileRequest_connectorProfileConfig;

class OAICreateConnectorProfileRequest : public OAIObject {
public:
    OAICreateConnectorProfileRequest();
    OAICreateConnectorProfileRequest(QString json);
    ~OAICreateConnectorProfileRequest() override;
    ...
    OAICreateConnectorProfileRequest_connectorProfileConfig getConnectorProfileConfig() const;
    void setConnectorProfileConfig(const OAICreateConnectorProfileRequest_connectorProfileConfig &connector_profile_config);
...
private:
    ...
    OAICreateConnectorProfileRequest_connectorProfileConfig m_connector_profile_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConnectorProfileRequest)

#endif // OAICreateConnectorProfileRequest_H
