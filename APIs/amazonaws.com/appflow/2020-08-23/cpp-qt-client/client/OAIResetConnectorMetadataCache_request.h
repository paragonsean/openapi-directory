...
/*
 * OAIResetConnectorMetadataCache_request.h
 *
 * 
 */

#ifndef OAIResetConnectorMetadataCache_request_H
#define OAIResetConnectorMetadataCache_request_H
...
class OAIResetConnectorMetadataCache_request : public OAIObject {
public:
    OAIResetConnectorMetadataCache_request();
    OAIResetConnectorMetadataCache_request(QString json);
    ~OAIResetConnectorMetadataCache_request() override;
    ...
    QString getEntitiesPath() const;
    void setEntitiesPath(const QString &entities_path);
    bool is_entities_path_Set() const;
    bool is_entities_path_Valid() const;
...
private:
    ...
    QString m_entities_path;
    bool m_entities_path_isSet;
    bool m_entities_path_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetConnectorMetadataCache_request)

#endif // OAIResetConnectorMetadataCache_request_H
