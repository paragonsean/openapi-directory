...
/*
 * OAIListConnectorEntitiesRequest.h
 *
 * 
 */

#ifndef OAIListConnectorEntitiesRequest_H
#define OAIListConnectorEntitiesRequest_H
...
class OAIListConnectorEntitiesRequest : public OAIObject {
public:
    OAIListConnectorEntitiesRequest();
    OAIListConnectorEntitiesRequest(QString json);
    ~OAIListConnectorEntitiesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListConnectorEntitiesRequest)

#endif // OAIListConnectorEntitiesRequest_H
