...
/*
 * OAISuccessResponseHandlingConfig.h
 *
...
#ifndef OAISuccessResponseHandlingConfig_H
#define OAISuccessResponseHandlingConfig_H
...
class OAISuccessResponseHandlingConfig : public OAIObject {
public:
    OAISuccessResponseHandlingConfig();
    OAISuccessResponseHandlingConfig(QString json);
    ~OAISuccessResponseHandlingConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuccessResponseHandlingConfig)

#endif // OAISuccessResponseHandlingConfig_H
