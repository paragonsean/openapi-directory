...
#ifndef OAIGlueDataCatalogConfig_H
#define OAIGlueDataCatalogConfig_H
...
class OAIGlueDataCatalogConfig : public OAIObject {
public:
    OAIGlueDataCatalogConfig();
    OAIGlueDataCatalogConfig(QString json);
    ~OAIGlueDataCatalogConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlueDataCatalogConfig)

#endif // OAIGlueDataCatalogConfig_H
