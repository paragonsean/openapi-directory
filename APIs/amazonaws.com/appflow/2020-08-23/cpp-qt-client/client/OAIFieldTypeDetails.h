...
/*
 * OAIFieldTypeDetails.h
 *
 *  Contains details regarding the supported field type and the operators that can be applied for filtering. 
 */

#ifndef OAIFieldTypeDetails_H
#define OAIFieldTypeDetails_H
...
class OAIFieldTypeDetails : public OAIObject {
public:
    OAIFieldTypeDetails();
    OAIFieldTypeDetails(QString json);
    ~OAIFieldTypeDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldTypeDetails)

#endif // OAIFieldTypeDetails_H
