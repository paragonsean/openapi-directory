...
/*
 * OAIDestinationConnectorProperties.h
 *
 *  This stores the information that is required to query a particular connector. 
 */

#ifndef OAIDestinationConnectorProperties_H
#define OAIDestinationConnectorProperties_H
...
class OAIDestinationConnectorProperties : public OAIObject {
public:
    OAIDestinationConnectorProperties();
    OAIDestinationConnectorProperties(QString json);
    ~OAIDestinationConnectorProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationConnectorProperties)

#endif // OAIDestinationConnectorProperties_H
