...
class CreateConnectorProfileRequestConnectorProfileConfig(Model):
    ...
    def __init__(self, connector_profile_properties: CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileProperties=None, connector_profile_credentials: CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials=None):
        """CreateConnectorProfileRequestConnectorProfileConfig - a model defined in OpenAPI

        :param connector_profile_properties: The connector_profile_properties of this CreateConnectorProfileRequestConnectorProfileConfig.
        :param connector_profile_credentials: The connector_profile_credentials of this CreateConnectorProfileRequestConnectorProfileConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateConnectorProfileRequestConnectorProfileConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateConnectorProfileRequest_connectorProfileConfig of this CreateConnectorProfileRequestConnectorProfileConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def connector_profile_properties(self):
        """Gets the connector_profile_properties of this CreateConnectorProfileRequestConnectorProfileConfig.


        :return: The connector_profile_properties of this CreateConnectorProfileRequestConnectorProfileConfig.
    ...
    def connector_profile_properties(self, connector_profile_properties):
        """Sets the connector_profile_properties of this CreateConnectorProfileRequestConnectorProfileConfig.
    ...
    def connector_profile_credentials(self):
        """Gets the connector_profile_credentials of this CreateConnectorProfileRequestConnectorProfileConfig.


        :return: The connector_profile_credentials of this CreateConnectorProfileRequestConnectorProfileConfig.
    ...
    def connector_profile_credentials(self, connector_profile_credentials):
        """Sets the connector_profile_credentials of this CreateConnectorProfileRequestConnectorProfileConfig.
