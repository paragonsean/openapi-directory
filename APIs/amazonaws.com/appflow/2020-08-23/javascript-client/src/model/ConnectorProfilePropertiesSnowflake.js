...
/**
 * The ConnectorProfilePropertiesSnowflake model module.
 * @module model/ConnectorProfilePropertiesSnowflake
 * @version 2020-08-23
 */
class ConnectorProfilePropertiesSnowflake {
    /**
     * Constructs a new <code>ConnectorProfilePropertiesSnowflake</code>.
     * @alias module:model/ConnectorProfilePropertiesSnowflake
     * @implements module:model/SnowflakeConnectorProfileProperties
    ...
    constructor(warehouse, stage, bucketName) { 
        ...
        ConnectorProfilePropertiesSnowflake.initialize(this, warehouse, stage, bucketName);
    }
    ...
    /**
     * Constructs a <code>ConnectorProfilePropertiesSnowflake</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectorProfilePropertiesSnowflake} obj Optional instance to populate.
     * @return {module:model/ConnectorProfilePropertiesSnowflake} The populated <code>ConnectorProfilePropertiesSnowflake</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectorProfilePropertiesSnowflake();
            SnowflakeConnectorProfileProperties.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectorProfilePropertiesSnowflake</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectorProfilePropertiesSnowflake</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectorProfilePropertiesSnowflake.RequiredProperties) {
...
ConnectorProfilePropertiesSnowflake.RequiredProperties = ["warehouse", "stage", "bucketName"];

/**
 * @member {String} warehouse
 */
ConnectorProfilePropertiesSnowflake.prototype['warehouse'] = undefined;

/**
 * @member {String} stage
 */
ConnectorProfilePropertiesSnowflake.prototype['stage'] = undefined;

/**
 * @member {String} bucketName
 */
ConnectorProfilePropertiesSnowflake.prototype['bucketName'] = undefined;

/**
 * @member {String} bucketPrefix
 */
ConnectorProfilePropertiesSnowflake.prototype['bucketPrefix'] = undefined;

/**
 * @member {String} privateLinkServiceName
 */
ConnectorProfilePropertiesSnowflake.prototype['privateLinkServiceName'] = undefined;

/**
 * @member {String} accountName
 */
ConnectorProfilePropertiesSnowflake.prototype['accountName'] = undefined;

/**
 * @member {String} region
 */
ConnectorProfilePropertiesSnowflake.prototype['region'] = undefined;


// Implement SnowflakeConnectorProfileProperties interface:
/**
 * @member {String} warehouse
 */
...
export default ConnectorProfilePropertiesSnowflake;
