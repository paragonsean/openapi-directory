...
class UpdateFlowRequest {
     ...
     * @param destinationFlowConfigList {Array.<module:model/DestinationFlowConfig>}  The configuration that controls how Amazon AppFlow transfers data to the destination connector. 
    ...
    constructor(flowName, triggerConfig, sourceFlowConfig, destinationFlowConfigList, tasks) { 
        ...
        UpdateFlowRequest.initialize(this, flowName, triggerConfig, sourceFlowConfig, destinationFlowConfigList, tasks);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of UpdateFlowRequest.RequiredProperties) {
...
UpdateFlowRequest.RequiredProperties = ["flowName", "triggerConfig", "sourceFlowConfig", "destinationFlowConfigList", "tasks"];

/**
 *  The specified name of the flow. Spaces are not allowed. Use underscores (_) or hyphens (-) only. 
 * @member {String} flowName
 */
UpdateFlowRequest.prototype['flowName'] = undefined;

/**
 *  A description of the flow. 
 * @member {String} description
 */
UpdateFlowRequest.prototype['description'] = undefined;

/**
 * @member {module:model/CreateFlowRequestTriggerConfig} triggerConfig
 */
UpdateFlowRequest.prototype['triggerConfig'] = undefined;

/**
 * @member {module:model/CreateFlowRequestSourceFlowConfig} sourceFlowConfig
 */
UpdateFlowRequest.prototype['sourceFlowConfig'] = undefined;

/**
 *  The configuration that controls how Amazon AppFlow transfers data to the destination connector. 
 * @member {Array.<module:model/DestinationFlowConfig>} destinationFlowConfigList
 */
UpdateFlowRequest.prototype['destinationFlowConfigList'] = undefined;

/**
 *  A list of tasks that Amazon AppFlow performs while transferring the data in the flow run. 
 * @member {Array.<module:model/Task>} tasks
 */
UpdateFlowRequest.prototype['tasks'] = undefined;

/**
 * @member {module:model/CreateFlowRequestMetadataCatalogConfig} metadataCatalogConfig
 */
UpdateFlowRequest.prototype['metadataCatalogConfig'] = undefined;
 ...
 */
UpdateFlowRequest.prototype['clientToken'] = undefined;
