...
/**
 * The DestinationFlowConfigDestinationConnectorProperties model module.
 * @module model/DestinationFlowConfigDestinationConnectorProperties
 * @version 2020-08-23
 */
class DestinationFlowConfigDestinationConnectorProperties {
    /**
     * Constructs a new <code>DestinationFlowConfigDestinationConnectorProperties</code>.
     * @alias module:model/DestinationFlowConfigDestinationConnectorProperties
     * @implements module:model/DestinationConnectorProperties
     */
    constructor() { 
        DestinationConnectorProperties.initialize(this);
        DestinationFlowConfigDestinationConnectorProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DestinationFlowConfigDestinationConnectorProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DestinationFlowConfigDestinationConnectorProperties} obj Optional instance to populate.
     * @return {module:model/DestinationFlowConfigDestinationConnectorProperties} The populated <code>DestinationFlowConfigDestinationConnectorProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DestinationFlowConfigDestinationConnectorProperties();
            DestinationConnectorProperties.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DestinationFlowConfigDestinationConnectorProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DestinationFlowConfigDestinationConnectorProperties</code>.
     */
 ...
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['Redshift'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesS3} S3
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['S3'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesSalesforce} Salesforce
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['Salesforce'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesSnowflake} Snowflake
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['Snowflake'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesEventBridge} EventBridge
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['EventBridge'] = undefined;

/**
 * @member {Object} LookoutMetrics
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['LookoutMetrics'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesUpsolver} Upsolver
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['Upsolver'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesHoneycode} Honeycode
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['Honeycode'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesCustomerProfiles} CustomerProfiles
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['CustomerProfiles'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesZendesk} Zendesk
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['Zendesk'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesMarketo} Marketo
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['Marketo'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesCustomConnector} CustomConnector
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['CustomConnector'] = undefined;

/**
 * @member {module:model/DestinationConnectorPropertiesSAPOData} SAPOData
 */
DestinationFlowConfigDestinationConnectorProperties.prototype['SAPOData'] = undefined;


// Implement DestinationConnectorProperties interface:
/**
 * @member {module:model/DestinationConnectorPropertiesRedshift} Redshift
 */
...
export default DestinationFlowConfigDestinationConnectorProperties;
