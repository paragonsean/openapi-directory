...
/**
 * The ConnectorProfilePropertiesRedshift model module.
 * @module model/ConnectorProfilePropertiesRedshift
 * @version 2020-08-23
 */
class ConnectorProfilePropertiesRedshift {
    /**
     * Constructs a new <code>ConnectorProfilePropertiesRedshift</code>.
     * @alias module:model/ConnectorProfilePropertiesRedshift
     * @implements module:model/RedshiftConnectorProfileProperties
    ...
    constructor(bucketName, roleArn) { 
        ...
        ConnectorProfilePropertiesRedshift.initialize(this, bucketName, roleArn);
    }
    ...
    /**
     * Constructs a <code>ConnectorProfilePropertiesRedshift</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectorProfilePropertiesRedshift} obj Optional instance to populate.
     * @return {module:model/ConnectorProfilePropertiesRedshift} The populated <code>ConnectorProfilePropertiesRedshift</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectorProfilePropertiesRedshift();
            RedshiftConnectorProfileProperties.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectorProfilePropertiesRedshift</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectorProfilePropertiesRedshift</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectorProfilePropertiesRedshift.RequiredProperties) {
...
ConnectorProfilePropertiesRedshift.RequiredProperties = ["bucketName", "roleArn"];

/**
 * @member {String} databaseUrl
 */
ConnectorProfilePropertiesRedshift.prototype['databaseUrl'] = undefined;

/**
 * @member {String} bucketName
 */
ConnectorProfilePropertiesRedshift.prototype['bucketName'] = undefined;

/**
 * @member {String} bucketPrefix
 */
ConnectorProfilePropertiesRedshift.prototype['bucketPrefix'] = undefined;

/**
 * @member {String} roleArn
 */
ConnectorProfilePropertiesRedshift.prototype['roleArn'] = undefined;

/**
 * @member {String} dataApiRoleArn
 */
ConnectorProfilePropertiesRedshift.prototype['dataApiRoleArn'] = undefined;

/**
 * @member {Boolean} isRedshiftServerless
 */
ConnectorProfilePropertiesRedshift.prototype['isRedshiftServerless'] = undefined;

/**
 * @member {String} clusterIdentifier
 */
ConnectorProfilePropertiesRedshift.prototype['clusterIdentifier'] = undefined;

/**
 * @member {String} workgroupName
 */
ConnectorProfilePropertiesRedshift.prototype['workgroupName'] = undefined;

/**
 * @member {String} databaseName
 */
ConnectorProfilePropertiesRedshift.prototype['databaseName'] = undefined;


// Implement RedshiftConnectorProfileProperties interface:
/**
 * @member {String} databaseUrl
 */
...
export default ConnectorProfilePropertiesRedshift;
