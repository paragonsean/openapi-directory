...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.CustomConnectorProfileCredentials();
  });
  ...
  describe('CustomConnectorProfileCredentials', function() {
    it('should create an instance of CustomConnectorProfileCredentials', function() {
      // uncomment below and update the code to test CustomConnectorProfileCredentials
      //var instance = new AmazonAppflow.CustomConnectorProfileCredentials();
      //expect(instance).to.be.a(AmazonAppflow.CustomConnectorProfileCredentials);
    });
