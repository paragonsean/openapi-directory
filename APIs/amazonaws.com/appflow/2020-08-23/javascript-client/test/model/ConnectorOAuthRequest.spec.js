...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.ConnectorOAuthRequest();
  });
  ...
  describe('ConnectorOAuthRequest', function() {
    it('should create an instance of ConnectorOAuthRequest', function() {
      // uncomment below and update the code to test ConnectorOAuthRequest
      //var instance = new AmazonAppflow.ConnectorOAuthRequest();
      //expect(instance).to.be.a(AmazonAppflow.ConnectorOAuthRequest);
    });
