...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.ListConnectorsRequest();
  });
  ...
  describe('ListConnectorsRequest', function() {
    it('should create an instance of ListConnectorsRequest', function() {
      // uncomment below and update the code to test ListConnectorsRequest
      //var instance = new AmazonAppflow.ListConnectorsRequest();
      //expect(instance).to.be.a(AmazonAppflow.ListConnectorsRequest);
    });
