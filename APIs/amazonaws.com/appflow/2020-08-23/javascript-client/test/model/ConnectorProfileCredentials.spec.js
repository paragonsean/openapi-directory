...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.ConnectorProfileCredentials();
  });
  ...
  describe('ConnectorProfileCredentials', function() {
    it('should create an instance of ConnectorProfileCredentials', function() {
      // uncomment below and update the code to test ConnectorProfileCredentials
      //var instance = new AmazonAppflow.ConnectorProfileCredentials();
      //expect(instance).to.be.a(AmazonAppflow.ConnectorProfileCredentials);
    });
