...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.DestinationConnectorProperties();
  });
  ...
  describe('DestinationConnectorProperties', function() {
    it('should create an instance of DestinationConnectorProperties', function() {
      // uncomment below and update the code to test DestinationConnectorProperties
      //var instance = new AmazonAppflow.DestinationConnectorProperties();
      //expect(instance).to.be.a(AmazonAppflow.DestinationConnectorProperties);
    });
