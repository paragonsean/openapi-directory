...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.ListFlowsResponse();
  });
  ...
  describe('ListFlowsResponse', function() {
    it('should create an instance of ListFlowsResponse', function() {
      // uncomment below and update the code to test ListFlowsResponse
      //var instance = new AmazonAppflow.ListFlowsResponse();
      //expect(instance).to.be.a(AmazonAppflow.ListFlowsResponse);
    });
