...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.ConnectorProfileProperties();
  });
  ...
  describe('ConnectorProfileProperties', function() {
    it('should create an instance of ConnectorProfileProperties', function() {
      // uncomment below and update the code to test ConnectorProfileProperties
      //var instance = new AmazonAppflow.ConnectorProfileProperties();
      //expect(instance).to.be.a(AmazonAppflow.ConnectorProfileProperties);
    });
