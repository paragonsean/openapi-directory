...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.SourceConnectorProperties();
  });
  ...
  describe('SourceConnectorProperties', function() {
    it('should create an instance of SourceConnectorProperties', function() {
      // uncomment below and update the code to test SourceConnectorProperties
      //var instance = new AmazonAppflow.SourceConnectorProperties();
      //expect(instance).to.be.a(AmazonAppflow.SourceConnectorProperties);
    });
