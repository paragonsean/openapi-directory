...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.ListFlowsRequest();
  });
  ...
  describe('ListFlowsRequest', function() {
    it('should create an instance of ListFlowsRequest', function() {
      // uncomment below and update the code to test ListFlowsRequest
      //var instance = new AmazonAppflow.ListFlowsRequest();
      //expect(instance).to.be.a(AmazonAppflow.ListFlowsRequest);
    });
