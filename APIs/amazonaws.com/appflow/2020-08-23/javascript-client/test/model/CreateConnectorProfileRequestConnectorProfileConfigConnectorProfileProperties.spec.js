...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppflow.CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileProperties();
  });
  ...
  describe('CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileProperties', function() {
    it('should create an instance of CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileProperties', function() {
      // uncomment below and update the code to test CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileProperties
      //var instance = new AmazonAppflow.CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileProperties();
      //expect(instance).to.be.a(AmazonAppflow.CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileProperties);
    });
