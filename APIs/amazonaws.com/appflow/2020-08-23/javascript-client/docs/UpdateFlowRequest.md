# AmazonAppflow.UpdateFlowRequest
...
**destinationFlowConfigList** | [**[DestinationFlowConfig]**](DestinationFlowConfig.md) |  The configuration that controls how Amazon AppFlow transfers data to the destination connector.  | 
