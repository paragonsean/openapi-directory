...
public class ConnectorConfigurationAuthenticationConfig {
  ...
  public ConnectorConfigurationAuthenticationConfig() {
  }

  public ConnectorConfigurationAuthenticationConfig isBasicAuthSupported(Boolean isBasicAuthSupported) {
  ...
  public ConnectorConfigurationAuthenticationConfig isApiKeyAuthSupported(Boolean isApiKeyAuthSupported) {
  ...
  public ConnectorConfigurationAuthenticationConfig isOAuth2Supported(Boolean isOAuth2Supported) {
  ...
  public ConnectorConfigurationAuthenticationConfig isCustomAuthSupported(Boolean isCustomAuthSupported) {
  ...
  public ConnectorConfigurationAuthenticationConfig oAuth2Defaults(AuthenticationConfigOAuth2Defaults oAuth2Defaults) {
  ...
  public ConnectorConfigurationAuthenticationConfig customAuthConfigs(List customAuthConfigs) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectorConfigurationAuthenticationConfig connectorConfigurationAuthenticationConfig = (ConnectorConfigurationAuthenticationConfig) o;
    return Objects.equals(this.isBasicAuthSupported, connectorConfigurationAuthenticationConfig.isBasicAuthSupported) &&
        Objects.equals(this.isApiKeyAuthSupported, connectorConfigurationAuthenticationConfig.isApiKeyAuthSupported) &&
        Objects.equals(this.isOAuth2Supported, connectorConfigurationAuthenticationConfig.isOAuth2Supported) &&
        Objects.equals(this.isCustomAuthSupported, connectorConfigurationAuthenticationConfig.isCustomAuthSupported) &&
        Objects.equals(this.oAuth2Defaults, connectorConfigurationAuthenticationConfig.oAuth2Defaults) &&
        Objects.equals(this.customAuthConfigs, connectorConfigurationAuthenticationConfig.customAuthConfigs);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectorConfigurationAuthenticationConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectorConfigurationAuthenticationConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectorConfigurationAuthenticationConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectorConfigurationAuthenticationConfig is not found in the empty JSON string", ConnectorConfigurationAuthenticationConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectorConfigurationAuthenticationConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectorConfigurationAuthenticationConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectorConfigurationAuthenticationConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectorConfigurationAuthenticationConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectorConfigurationAuthenticationConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectorConfigurationAuthenticationConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectorConfigurationAuthenticationConfig>() {
           @Override
           public void write(JsonWriter out, ConnectorConfigurationAuthenticationConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectorConfigurationAuthenticationConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectorConfigurationAuthenticationConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectorConfigurationAuthenticationConfig
   * @throws IOException if the JSON string is invalid with respect to ConnectorConfigurationAuthenticationConfig
   */
  public static ConnectorConfigurationAuthenticationConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectorConfigurationAuthenticationConfig.class);
  }

  /**
   * Convert an instance of ConnectorConfigurationAuthenticationConfig to an JSON string
   *
   * @return JSON string
   */
