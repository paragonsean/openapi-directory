...
public class SupportedFieldTypeDetailsV1 {
  ...
  public SupportedFieldTypeDetailsV1 fieldType(String fieldType) {
  ...
  public SupportedFieldTypeDetailsV1 filterOperators(List filterOperators) {
  ...
  public SupportedFieldTypeDetailsV1 supportedValues(List supportedValues) {
  ...
  public SupportedFieldTypeDetailsV1 valueRegexPattern(String valueRegexPattern) {
  ...
  public SupportedFieldTypeDetailsV1 supportedDateFormat(String supportedDateFormat) {
  ...
  public SupportedFieldTypeDetailsV1 fieldValueRange(FieldTypeDetailsFieldValueRange fieldValueRange) {
  ...
  public SupportedFieldTypeDetailsV1 fieldLengthRange(FieldTypeDetailsFieldLengthRange fieldLengthRange) {
