...
public class OAuth2Defaults {
  ...
  public OAuth2Defaults oauthScopes(List oauthScopes) {
  ...
  public OAuth2Defaults tokenUrls(List tokenUrls) {
  ...
  public OAuth2Defaults authCodeUrls(List authCodeUrls) {
  ...
  public OAuth2Defaults oauth2GrantTypesSupported(List oauth2GrantTypesSupported) {
  ...
  public OAuth2Defaults oauth2CustomProperties(List oauth2CustomProperties) {
