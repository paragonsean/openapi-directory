...
public class CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials() {
  }

  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials amplitude(ConnectorProfileCredentialsAmplitude amplitude) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials datadog(ConnectorProfileCredentialsDatadog datadog) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials dynatrace(ConnectorProfileCredentialsDynatrace dynatrace) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials googleAnalytics(ConnectorProfileCredentialsGoogleAnalytics googleAnalytics) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials honeycode(ConnectorProfileCredentialsHoneycode honeycode) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials inforNexus(ConnectorProfileCredentialsInforNexus inforNexus) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials marketo(ConnectorProfileCredentialsMarketo marketo) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials redshift(ConnectorProfileCredentialsRedshift redshift) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials salesforce(ConnectorProfileCredentialsSalesforce salesforce) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials serviceNow(ConnectorProfileCredentialsServiceNow serviceNow) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials singular(ConnectorProfileCredentialsSingular singular) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials slack(ConnectorProfileCredentialsSlack slack) {
    this.slack = slack;
    return this;
  }
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials snowflake(ConnectorProfileCredentialsSnowflake snowflake) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials trendmicro(ConnectorProfileCredentialsTrendmicro trendmicro) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials veeva(ConnectorProfileCredentialsVeeva veeva) {
    this.veeva = veeva;
    return this;
  }
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials zendesk(ConnectorProfileCredentialsZendesk zendesk) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials saPOData(SAPODataConnectorProfileCredentials saPOData) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials customConnector(CustomConnectorProfileCredentials customConnector) {
  ...
  public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials pardot(ConnectorProfileCredentialsPardot pardot) {
    this.pardot = pardot;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials = (CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials) o;
    return Objects.equals(this.amplitude, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.amplitude) &&
        Objects.equals(this.datadog, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.datadog) &&
        Objects.equals(this.dynatrace, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.dynatrace) &&
        Objects.equals(this.googleAnalytics, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.googleAnalytics) &&
        Objects.equals(this.honeycode, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.honeycode) &&
        Objects.equals(this.inforNexus, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.inforNexus) &&
        Objects.equals(this.marketo, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.marketo) &&
        Objects.equals(this.redshift, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.redshift) &&
        Objects.equals(this.salesforce, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.salesforce) &&
        Objects.equals(this.serviceNow, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.serviceNow) &&
        Objects.equals(this.singular, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.singular) &&
        Objects.equals(this.slack, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.slack) &&
        Objects.equals(this.snowflake, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.snowflake) &&
        Objects.equals(this.trendmicro, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.trendmicro) &&
        Objects.equals(this.veeva, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.veeva) &&
        Objects.equals(this.zendesk, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.zendesk) &&
        Objects.equals(this.saPOData, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.saPOData) &&
        Objects.equals(this.customConnector, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.customConnector) &&
        Objects.equals(this.pardot, createConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.pardot);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials is not found in the empty JSON string", CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials>() {
           @Override
           public void write(JsonWriter out, CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials
   * @throws IOException if the JSON string is invalid with respect to CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials
   */
  public static CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials.class);
  }

  /**
   * Convert an instance of CreateConnectorProfileRequestConnectorProfileConfigConnectorProfileCredentials to an JSON string
   *
   * @return JSON string
   */
