...
public class DestinationFieldProperties {
  ...
  public DestinationFieldProperties isCreatable(Boolean isCreatable) {
  ...
  public DestinationFieldProperties isNullable(Boolean isNullable) {
  ...
  public DestinationFieldProperties isUpsertable(Boolean isUpsertable) {
  ...
  public DestinationFieldProperties isUpdatable(Boolean isUpdatable) {
  ...
  public DestinationFieldProperties isDefaultedOnCreate(Boolean isDefaultedOnCreate) {
  ...
  public DestinationFieldProperties supportedWriteOperations(List supportedWriteOperations) {
  ...
  public boolean equals(Object o) {
    ...
    DestinationFieldProperties destinationFieldProperties = (DestinationFieldProperties) o;
    return Objects.equals(this.isCreatable, destinationFieldProperties.isCreatable) &&
        Objects.equals(this.isNullable, destinationFieldProperties.isNullable) &&
        Objects.equals(this.isUpsertable, destinationFieldProperties.isUpsertable) &&
        Objects.equals(this.isUpdatable, destinationFieldProperties.isUpdatable) &&
        Objects.equals(this.isDefaultedOnCreate, destinationFieldProperties.isDefaultedOnCreate) &&
        Objects.equals(this.supportedWriteOperations, destinationFieldProperties.supportedWriteOperations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DestinationFieldProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinationFieldProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinationFieldProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationFieldProperties is not found in the empty JSON string", DestinationFieldProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinationFieldProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationFieldProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinationFieldProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinationFieldProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinationFieldProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinationFieldProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinationFieldProperties>() {
           @Override
           public void write(JsonWriter out, DestinationFieldProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinationFieldProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinationFieldProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinationFieldProperties
   * @throws IOException if the JSON string is invalid with respect to DestinationFieldProperties
   */
  public static DestinationFieldProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinationFieldProperties.class);
  }

  /**
   * Convert an instance of DestinationFieldProperties to an JSON string
   *
   * @return JSON string
   */
