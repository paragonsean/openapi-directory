...
public class FieldTypeDetails {
  ...
  public FieldTypeDetails fieldType(String fieldType) {
  ...
  public FieldTypeDetails filterOperators(List filterOperators) {
  ...
  public void setFilterOperators(List filterOperators) {
    this.filterOperators = filterOperators;
  }


  public FieldTypeDetails supportedValues(List supportedValues) {
  ...
  public void setSupportedValues(List supportedValues) {
    this.supportedValues = supportedValues;
  }


  public FieldTypeDetails valueRegexPattern(String valueRegexPattern) {
  ...
  public FieldTypeDetails supportedDateFormat(String supportedDateFormat) {
  ...
  public FieldTypeDetails fieldValueRange(FieldTypeDetailsFieldValueRange fieldValueRange) {
  ...
  public void setFieldValueRange(FieldTypeDetailsFieldValueRange fieldValueRange) {
    this.fieldValueRange = fieldValueRange;
  }


  public FieldTypeDetails fieldLengthRange(FieldTypeDetailsFieldLengthRange fieldLengthRange) {
  ...
  public void setFieldLengthRange(FieldTypeDetailsFieldLengthRange fieldLengthRange) {
    this.fieldLengthRange = fieldLengthRange;
  }
  ...
  public boolean equals(Object o) {
    ...
    FieldTypeDetails fieldTypeDetails = (FieldTypeDetails) o;
    return Objects.equals(this.fieldType, fieldTypeDetails.fieldType) &&
        Objects.equals(this.filterOperators, fieldTypeDetails.filterOperators) &&
        Objects.equals(this.supportedValues, fieldTypeDetails.supportedValues) &&
        Objects.equals(this.valueRegexPattern, fieldTypeDetails.valueRegexPattern) &&
        Objects.equals(this.supportedDateFormat, fieldTypeDetails.supportedDateFormat) &&
        Objects.equals(this.fieldValueRange, fieldTypeDetails.fieldValueRange) &&
        Objects.equals(this.fieldLengthRange, fieldTypeDetails.fieldLengthRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class FieldTypeDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FieldTypeDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FieldTypeDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FieldTypeDetails is not found in the empty JSON string", FieldTypeDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FieldTypeDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FieldTypeDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FieldTypeDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FieldTypeDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FieldTypeDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FieldTypeDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FieldTypeDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<FieldTypeDetails>() {
           @Override
           public void write(JsonWriter out, FieldTypeDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FieldTypeDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FieldTypeDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FieldTypeDetails
   * @throws IOException if the JSON string is invalid with respect to FieldTypeDetails
   */
  public static FieldTypeDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FieldTypeDetails.class);
  }

  /**
   * Convert an instance of FieldTypeDetails to an JSON string
   *
   * @return JSON string
   */
