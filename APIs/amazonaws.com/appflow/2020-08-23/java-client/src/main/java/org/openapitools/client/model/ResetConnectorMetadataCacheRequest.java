...
public class ResetConnectorMetadataCacheRequest {
  ...
  public ResetConnectorMetadataCacheRequest connectorProfileName(String connectorProfileName) {
  ...
  public ResetConnectorMetadataCacheRequest connectorType(ConnectorTypeEnum connectorType) {
  ...
  public ResetConnectorMetadataCacheRequest connectorEntityName(String connectorEntityName) {
  ...
  public ResetConnectorMetadataCacheRequest entitiesPath(String entitiesPath) {
  ...
  public ResetConnectorMetadataCacheRequest apiVersion(String apiVersion) {
