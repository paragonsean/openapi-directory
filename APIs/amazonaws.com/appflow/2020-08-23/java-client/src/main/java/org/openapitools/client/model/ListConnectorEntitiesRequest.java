...
public class ListConnectorEntitiesRequest {
  ...
  public ListConnectorEntitiesRequest connectorProfileName(String connectorProfileName) {
  ...
  public ListConnectorEntitiesRequest connectorType(ConnectorTypeEnum connectorType) {
  ...
  public ListConnectorEntitiesRequest entitiesPath(String entitiesPath) {
  ...
  public ListConnectorEntitiesRequest apiVersion(String apiVersion) {
  ...
  public ListConnectorEntitiesRequest maxResults(Integer maxResults) {
  ...
  public ListConnectorEntitiesRequest nextToken(String nextToken) {
