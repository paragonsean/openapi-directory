...
public class ConnectorProfileProperties {
  ...
  public ConnectorProfileProperties amplitude(Object amplitude) {
  ...
  public ConnectorProfileProperties datadog(ConnectorProfilePropertiesDatadog datadog) {
  ...
  public void setDatadog(ConnectorProfilePropertiesDatadog datadog) {
    this.datadog = datadog;
  }


  public ConnectorProfileProperties dynatrace(ConnectorProfilePropertiesDynatrace dynatrace) {
  ...
  public void setDynatrace(ConnectorProfilePropertiesDynatrace dynatrace) {
    this.dynatrace = dynatrace;
  }


  public ConnectorProfileProperties googleAnalytics(Object googleAnalytics) {
  ...
  public ConnectorProfileProperties honeycode(Object honeycode) {
  ...
  public void setHoneycode(Object honeycode) {
    this.honeycode = honeycode;
  }


  public ConnectorProfileProperties inforNexus(ConnectorProfilePropertiesInforNexus inforNexus) {
  ...
  public void setInforNexus(ConnectorProfilePropertiesInforNexus inforNexus) {
    this.inforNexus = inforNexus;
  }


  public ConnectorProfileProperties marketo(ConnectorProfilePropertiesMarketo marketo) {
  ...
  public void setMarketo(ConnectorProfilePropertiesMarketo marketo) {
    this.marketo = marketo;
  }


  public ConnectorProfileProperties redshift(ConnectorProfilePropertiesRedshift redshift) {
  ...
  public void setRedshift(ConnectorProfilePropertiesRedshift redshift) {
    this.redshift = redshift;
  }


  public ConnectorProfileProperties salesforce(ConnectorProfilePropertiesSalesforce salesforce) {
  ...
  public void setSalesforce(ConnectorProfilePropertiesSalesforce salesforce) {
    this.salesforce = salesforce;
  }


  public ConnectorProfileProperties serviceNow(ConnectorProfilePropertiesServiceNow serviceNow) {
  ...
  public void setServiceNow(ConnectorProfilePropertiesServiceNow serviceNow) {
    this.serviceNow = serviceNow;
  }


  public ConnectorProfileProperties singular(Object singular) {
  ...
  public ConnectorProfileProperties slack(ConnectorProfilePropertiesSlack slack) {
    this.slack = slack;
    return this;
  }
  ...
  public void setSlack(ConnectorProfilePropertiesSlack slack) {
    this.slack = slack;
  }


  public ConnectorProfileProperties snowflake(ConnectorProfilePropertiesSnowflake snowflake) {
  ...
  public void setSnowflake(ConnectorProfilePropertiesSnowflake snowflake) {
    this.snowflake = snowflake;
  }


  public ConnectorProfileProperties trendmicro(Object trendmicro) {
  ...
  public ConnectorProfileProperties veeva(ConnectorProfilePropertiesVeeva veeva) {
    this.veeva = veeva;
    return this;
  }
  ...
  public void setVeeva(ConnectorProfilePropertiesVeeva veeva) {
    this.veeva = veeva;
  }


  public ConnectorProfileProperties zendesk(ConnectorProfilePropertiesZendesk zendesk) {
  ...
  public void setZendesk(ConnectorProfilePropertiesZendesk zendesk) {
    this.zendesk = zendesk;
  }


  public ConnectorProfileProperties saPOData(SAPODataConnectorProfileProperties saPOData) {
  ...
  public ConnectorProfileProperties customConnector(ConnectorProfilePropertiesCustomConnector customConnector) {
  ...
  public void setCustomConnector(ConnectorProfilePropertiesCustomConnector customConnector) {
    this.customConnector = customConnector;
  }


  public ConnectorProfileProperties pardot(ConnectorProfilePropertiesPardot pardot) {
    this.pardot = pardot;
    return this;
  }
  ...
  public void setPardot(ConnectorProfilePropertiesPardot pardot) {
    this.pardot = pardot;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConnectorProfileProperties connectorProfileProperties = (ConnectorProfileProperties) o;
    return Objects.equals(this.amplitude, connectorProfileProperties.amplitude) &&
        Objects.equals(this.datadog, connectorProfileProperties.datadog) &&
        Objects.equals(this.dynatrace, connectorProfileProperties.dynatrace) &&
        Objects.equals(this.googleAnalytics, connectorProfileProperties.googleAnalytics) &&
        Objects.equals(this.honeycode, connectorProfileProperties.honeycode) &&
        Objects.equals(this.inforNexus, connectorProfileProperties.inforNexus) &&
        Objects.equals(this.marketo, connectorProfileProperties.marketo) &&
        Objects.equals(this.redshift, connectorProfileProperties.redshift) &&
        Objects.equals(this.salesforce, connectorProfileProperties.salesforce) &&
        Objects.equals(this.serviceNow, connectorProfileProperties.serviceNow) &&
        Objects.equals(this.singular, connectorProfileProperties.singular) &&
        Objects.equals(this.slack, connectorProfileProperties.slack) &&
        Objects.equals(this.snowflake, connectorProfileProperties.snowflake) &&
        Objects.equals(this.trendmicro, connectorProfileProperties.trendmicro) &&
        Objects.equals(this.veeva, connectorProfileProperties.veeva) &&
        Objects.equals(this.zendesk, connectorProfileProperties.zendesk) &&
        Objects.equals(this.saPOData, connectorProfileProperties.saPOData) &&
        Objects.equals(this.customConnector, connectorProfileProperties.customConnector) &&
        Objects.equals(this.pardot, connectorProfileProperties.pardot);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectorProfileProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectorProfileProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectorProfileProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectorProfileProperties is not found in the empty JSON string", ConnectorProfileProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectorProfileProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectorProfileProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectorProfileProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectorProfileProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectorProfileProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectorProfileProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectorProfileProperties>() {
           @Override
           public void write(JsonWriter out, ConnectorProfileProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectorProfileProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectorProfileProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectorProfileProperties
   * @throws IOException if the JSON string is invalid with respect to ConnectorProfileProperties
   */
  public static ConnectorProfileProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectorProfileProperties.class);
  }

  /**
   * Convert an instance of ConnectorProfileProperties to an JSON string
   *
   * @return JSON string
   */
