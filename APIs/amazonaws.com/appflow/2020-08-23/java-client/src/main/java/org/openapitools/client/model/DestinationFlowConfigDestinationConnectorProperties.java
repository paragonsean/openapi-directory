...
public class DestinationFlowConfigDestinationConnectorProperties {
  ...
  public DestinationFlowConfigDestinationConnectorProperties() {
  }

  public DestinationFlowConfigDestinationConnectorProperties redshift(DestinationConnectorPropertiesRedshift redshift) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties S3(DestinationConnectorPropertiesS3 S3) {
    this.S3 = S3;
    return this;
  }
  ...
  public DestinationFlowConfigDestinationConnectorProperties salesforce(DestinationConnectorPropertiesSalesforce salesforce) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties snowflake(DestinationConnectorPropertiesSnowflake snowflake) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties eventBridge(DestinationConnectorPropertiesEventBridge eventBridge) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties lookoutMetrics(Object lookoutMetrics) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties upsolver(DestinationConnectorPropertiesUpsolver upsolver) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties honeycode(DestinationConnectorPropertiesHoneycode honeycode) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties customerProfiles(DestinationConnectorPropertiesCustomerProfiles customerProfiles) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties zendesk(DestinationConnectorPropertiesZendesk zendesk) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties marketo(DestinationConnectorPropertiesMarketo marketo) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties customConnector(DestinationConnectorPropertiesCustomConnector customConnector) {
  ...
  public DestinationFlowConfigDestinationConnectorProperties saPOData(DestinationConnectorPropertiesSAPOData saPOData) {
  ...
  public boolean equals(Object o) {
    ...
    DestinationFlowConfigDestinationConnectorProperties destinationFlowConfigDestinationConnectorProperties = (DestinationFlowConfigDestinationConnectorProperties) o;
    return Objects.equals(this.redshift, destinationFlowConfigDestinationConnectorProperties.redshift) &&
        Objects.equals(this.S3, destinationFlowConfigDestinationConnectorProperties.S3) &&
        Objects.equals(this.salesforce, destinationFlowConfigDestinationConnectorProperties.salesforce) &&
        Objects.equals(this.snowflake, destinationFlowConfigDestinationConnectorProperties.snowflake) &&
        Objects.equals(this.eventBridge, destinationFlowConfigDestinationConnectorProperties.eventBridge) &&
        Objects.equals(this.lookoutMetrics, destinationFlowConfigDestinationConnectorProperties.lookoutMetrics) &&
        Objects.equals(this.upsolver, destinationFlowConfigDestinationConnectorProperties.upsolver) &&
        Objects.equals(this.honeycode, destinationFlowConfigDestinationConnectorProperties.honeycode) &&
        Objects.equals(this.customerProfiles, destinationFlowConfigDestinationConnectorProperties.customerProfiles) &&
        Objects.equals(this.zendesk, destinationFlowConfigDestinationConnectorProperties.zendesk) &&
        Objects.equals(this.marketo, destinationFlowConfigDestinationConnectorProperties.marketo) &&
        Objects.equals(this.customConnector, destinationFlowConfigDestinationConnectorProperties.customConnector) &&
        Objects.equals(this.saPOData, destinationFlowConfigDestinationConnectorProperties.saPOData);
  }
  ...
  public String toString() {
    ...
    sb.append("class DestinationFlowConfigDestinationConnectorProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinationFlowConfigDestinationConnectorProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinationFlowConfigDestinationConnectorProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationFlowConfigDestinationConnectorProperties is not found in the empty JSON string", DestinationFlowConfigDestinationConnectorProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinationFlowConfigDestinationConnectorProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationFlowConfigDestinationConnectorProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinationFlowConfigDestinationConnectorProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinationFlowConfigDestinationConnectorProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinationFlowConfigDestinationConnectorProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinationFlowConfigDestinationConnectorProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinationFlowConfigDestinationConnectorProperties>() {
           @Override
           public void write(JsonWriter out, DestinationFlowConfigDestinationConnectorProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinationFlowConfigDestinationConnectorProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinationFlowConfigDestinationConnectorProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinationFlowConfigDestinationConnectorProperties
   * @throws IOException if the JSON string is invalid with respect to DestinationFlowConfigDestinationConnectorProperties
   */
  public static DestinationFlowConfigDestinationConnectorProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinationFlowConfigDestinationConnectorProperties.class);
  }

  /**
   * Convert an instance of DestinationFlowConfigDestinationConnectorProperties to an JSON string
   *
   * @return JSON string
   */
