...
public class ConnectorProfileCredentialsSlack {
  ...
  public ConnectorProfileCredentialsSlack clientId(String clientId) {
  ...
  public ConnectorProfileCredentialsSlack clientSecret(String clientSecret) {
  ...
  public ConnectorProfileCredentialsSlack accessToken(String accessToken) {
  ...
  public ConnectorProfileCredentialsSlack oAuthRequest(GoogleAnalyticsConnectorProfileCredentialsOAuthRequest oAuthRequest) {
