...
public class ConnectorDetail {
  ...
  public ConnectorDetail connectorDescription(String connectorDescription) {
  ...
  public ConnectorDetail connectorName(String connectorName) {
  ...
  public ConnectorDetail connectorOwner(String connectorOwner) {
  ...
  public ConnectorDetail connectorVersion(String connectorVersion) {
  ...
  public ConnectorDetail applicationType(String applicationType) {
  ...
  public ConnectorDetail connectorType(ConnectorType connectorType) {
  ...
  public ConnectorDetail connectorLabel(String connectorLabel) {
  ...
  public ConnectorDetail registeredAt(OffsetDateTime registeredAt) {
  ...
  public ConnectorDetail registeredBy(String registeredBy) {
  ...
  public ConnectorDetail connectorProvisioningType(ConnectorProvisioningType connectorProvisioningType) {
  ...
  public ConnectorDetail connectorModes(List connectorModes) {
  ...
  public ConnectorDetail supportedDataTransferTypes(List supportedDataTransferTypes) {
