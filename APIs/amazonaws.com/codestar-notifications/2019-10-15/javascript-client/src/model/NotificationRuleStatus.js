...
* @readonly
*/
export default class NotificationRuleStatus {
    ...
    /**
    * Returns a <code>NotificationRuleStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NotificationRuleStatus} The enum <code>NotificationRuleStatus</code> value.
    */
