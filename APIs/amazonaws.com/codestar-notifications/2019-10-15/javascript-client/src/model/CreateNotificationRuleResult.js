...
/**
 * The CreateNotificationRuleResult model module.
 * @module model/CreateNotificationRuleResult
 * @version 2019-10-15
 */
class CreateNotificationRuleResult {
    /**
     * Constructs a new <code>CreateNotificationRuleResult</code>.
     * @alias module:model/CreateNotificationRuleResult
     */
    constructor() { 
        
        CreateNotificationRuleResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateNotificationRuleResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateNotificationRuleResult} obj Optional instance to populate.
     * @return {module:model/CreateNotificationRuleResult} The populated <code>CreateNotificationRuleResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateNotificationRuleResult();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNotificationRuleResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNotificationRuleResult</code>.
     */
 ...
 * @member {String} Arn
 */
CreateNotificationRuleResult.prototype['Arn'] = undefined;
...
export default CreateNotificationRuleResult;
