...
* @readonly
*/
export default class ListTargetsFilterName {
    ...
    /**
    * Returns a <code>ListTargetsFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ListTargetsFilterName} The enum <code>ListTargetsFilterName</code> value.
    */
