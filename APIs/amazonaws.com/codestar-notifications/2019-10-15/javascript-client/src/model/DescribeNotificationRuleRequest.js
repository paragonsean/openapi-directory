...
/**
 * The DescribeNotificationRuleRequest model module.
 * @module model/DescribeNotificationRuleRequest
 * @version 2019-10-15
 */
class DescribeNotificationRuleRequest {
    /**
     * Constructs a new <code>DescribeNotificationRuleRequest</code>.
     * @alias module:model/DescribeNotificationRuleRequest
     * @param arn {String} The Amazon Resource Name (ARN) of the notification rule.
     */
    constructor(arn) { 
        
        DescribeNotificationRuleRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DescribeNotificationRuleRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeNotificationRuleRequest} obj Optional instance to populate.
     * @return {module:model/DescribeNotificationRuleRequest} The populated <code>DescribeNotificationRuleRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeNotificationRuleRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeNotificationRuleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeNotificationRuleRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeNotificationRuleRequest.RequiredProperties) {
...
DescribeNotificationRuleRequest.RequiredProperties = ["Arn"];

/**
 * The Amazon Resource Name (ARN) of the notification rule.
 * @member {String} Arn
 */
DescribeNotificationRuleRequest.prototype['Arn'] = undefined;
...
export default DescribeNotificationRuleRequest;
