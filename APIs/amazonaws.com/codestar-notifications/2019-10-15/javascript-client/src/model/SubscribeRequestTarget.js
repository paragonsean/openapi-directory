...
/**
 * The SubscribeRequestTarget model module.
 * @module model/SubscribeRequestTarget
 * @version 2019-10-15
 */
class SubscribeRequestTarget {
    /**
     * Constructs a new <code>SubscribeRequestTarget</code>.
     * Information about the Chatbot topics or Chatbot clients associated with a notification rule.
     * @alias module:model/SubscribeRequestTarget
     */
    constructor() { 
        
        SubscribeRequestTarget.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubscribeRequestTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubscribeRequestTarget} obj Optional instance to populate.
     * @return {module:model/SubscribeRequestTarget} The populated <code>SubscribeRequestTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubscribeRequestTarget();
    ...
    /**
     * Validates the JSON data with respect to <code>SubscribeRequestTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscribeRequestTarget</code>.
     */
 ...
 */
SubscribeRequestTarget.prototype['TargetType'] = undefined;

/**
 * @member {String} TargetAddress
 */
SubscribeRequestTarget.prototype['TargetAddress'] = undefined;
...
export default SubscribeRequestTarget;
