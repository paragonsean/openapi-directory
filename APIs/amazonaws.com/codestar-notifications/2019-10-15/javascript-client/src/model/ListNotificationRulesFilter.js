...
import ListNotificationRulesFilterName from './ListNotificationRulesFilterName';

/**
 * The ListNotificationRulesFilter model module.
 * @module model/ListNotificationRulesFilter
 * @version 2019-10-15
 */
class ListNotificationRulesFilter {
    /**
     * Constructs a new <code>ListNotificationRulesFilter</code>.
     * Information about a filter to apply to the list of returned notification rules. You can filter by event type, owner, resource, or target.
     * @alias module:model/ListNotificationRulesFilter
     * @param name {module:model/ListNotificationRulesFilterName} 
     * @param value {String} 
     */
    constructor(name, value) { 
        
        ListNotificationRulesFilter.initialize(this, name, value);
    }
    ...
    /**
     * Constructs a <code>ListNotificationRulesFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListNotificationRulesFilter} obj Optional instance to populate.
     * @return {module:model/ListNotificationRulesFilter} The populated <code>ListNotificationRulesFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListNotificationRulesFilter();

            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], ListNotificationRulesFilterName);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListNotificationRulesFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListNotificationRulesFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListNotificationRulesFilter.RequiredProperties) {
        ...
        if (data['Name']) { // data not null
          ListNotificationRulesFilterName.validateJSON(data['Name']);
        }
...
ListNotificationRulesFilter.RequiredProperties = ["Name", "Value"];

/**
 * @member {module:model/ListNotificationRulesFilterName} Name
 */
ListNotificationRulesFilter.prototype['Name'] = undefined;

/**
 * @member {String} Value
 */
ListNotificationRulesFilter.prototype['Value'] = undefined;
...
export default ListNotificationRulesFilter;
