...
/**
 * The DeleteNotificationRuleRequest model module.
 * @module model/DeleteNotificationRuleRequest
 * @version 2019-10-15
 */
class DeleteNotificationRuleRequest {
    /**
     * Constructs a new <code>DeleteNotificationRuleRequest</code>.
     * @alias module:model/DeleteNotificationRuleRequest
     * @param arn {String} The Amazon Resource Name (ARN) of the notification rule you want to delete.
     */
    constructor(arn) { 
        
        DeleteNotificationRuleRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DeleteNotificationRuleRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteNotificationRuleRequest} obj Optional instance to populate.
     * @return {module:model/DeleteNotificationRuleRequest} The populated <code>DeleteNotificationRuleRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteNotificationRuleRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteNotificationRuleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteNotificationRuleRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteNotificationRuleRequest.RequiredProperties) {
...
DeleteNotificationRuleRequest.RequiredProperties = ["Arn"];

/**
 * The Amazon Resource Name (ARN) of the notification rule you want to delete.
 * @member {String} Arn
 */
DeleteNotificationRuleRequest.prototype['Arn'] = undefined;
...
export default DeleteNotificationRuleRequest;
