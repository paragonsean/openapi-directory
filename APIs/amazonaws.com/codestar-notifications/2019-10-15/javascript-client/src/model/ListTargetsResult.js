...
/**
 * The ListTargetsResult model module.
 * @module model/ListTargetsResult
 * @version 2019-10-15
 */
class ListTargetsResult {
    /**
     * Constructs a new <code>ListTargetsResult</code>.
     * @alias module:model/ListTargetsResult
     */
    constructor() { 
        
        ListTargetsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTargetsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTargetsResult} obj Optional instance to populate.
     * @return {module:model/ListTargetsResult} The populated <code>ListTargetsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTargetsResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTargetsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTargetsResult</code>.
     */
 ...
 */
ListTargetsResult.prototype['Targets'] = undefined;

/**
 * @member {String} NextToken
 */
ListTargetsResult.prototype['NextToken'] = undefined;
...
export default ListTargetsResult;
