...
class TargetSummary {
    ...
    static validateJSON(data) {
        ...
        if (data['TargetAddress']) { // data not null
          String.validateJSON(data['TargetAddress']);
        }
        ...
        if (data['TargetStatus']) { // data not null
          TargetStatus.validateJSON(data['TargetStatus']);
        }
 ...
 */
TargetSummary.prototype['TargetAddress'] = undefined;

/**
 * @member {String} TargetType
 */
TargetSummary.prototype['TargetType'] = undefined;

/**
 * @member {module:model/TargetStatus} TargetStatus
 */
TargetSummary.prototype['TargetStatus'] = undefined;
