...
class TagResourceRequest {
     ...
     * @param arn {String} The Amazon Resource Name (ARN) of the notification rule to tag.
     * @param tags {Object.<String, String>} The list of tags to associate with the resource. Tag key names cannot start with \"<code>aws</code>\".
     */
