...
import ListEventTypesFilterName from './ListEventTypesFilterName';

/**
 * The ListEventTypesFilter model module.
 * @module model/ListEventTypesFilter
 * @version 2019-10-15
 */
class ListEventTypesFilter {
    /**
     * Constructs a new <code>ListEventTypesFilter</code>.
     * Information about a filter to apply to the list of returned event types. You can filter by resource type or service name.
     * @alias module:model/ListEventTypesFilter
     * @param name {module:model/ListEventTypesFilterName} 
     * @param value {String} 
     */
    constructor(name, value) { 
        
        ListEventTypesFilter.initialize(this, name, value);
    }
    ...
    /**
     * Constructs a <code>ListEventTypesFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListEventTypesFilter} obj Optional instance to populate.
     * @return {module:model/ListEventTypesFilter} The populated <code>ListEventTypesFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListEventTypesFilter();

            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], ListEventTypesFilterName);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListEventTypesFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListEventTypesFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListEventTypesFilter.RequiredProperties) {
        ...
        if (data['Name']) { // data not null
          ListEventTypesFilterName.validateJSON(data['Name']);
        }
...
ListEventTypesFilter.RequiredProperties = ["Name", "Value"];

/**
 * @member {module:model/ListEventTypesFilterName} Name
 */
ListEventTypesFilter.prototype['Name'] = undefined;

/**
 * @member {String} Value
 */
ListEventTypesFilter.prototype['Value'] = undefined;
...
export default ListEventTypesFilter;
