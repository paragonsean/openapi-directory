...
* @readonly
*/
export default class ListEventTypesFilterName {
    ...
    /**
    * Returns a <code>ListEventTypesFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ListEventTypesFilterName} The enum <code>ListEventTypesFilterName</code> value.
    */
