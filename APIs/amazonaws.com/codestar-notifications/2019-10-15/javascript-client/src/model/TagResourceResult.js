...
/**
 * The TagResourceResult model module.
 * @module model/TagResourceResult
 * @version 2019-10-15
 */
class TagResourceResult {
    /**
     * Constructs a new <code>TagResourceResult</code>.
     * @alias module:model/TagResourceResult
     */
    constructor() { 
        
        TagResourceResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagResourceResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagResourceResult} obj Optional instance to populate.
     * @return {module:model/TagResourceResult} The populated <code>TagResourceResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagResourceResult();
    ...
    /**
     * Validates the JSON data with respect to <code>TagResourceResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagResourceResult</code>.
     */
 ...
 * @member {Object} Tags
 */
TagResourceResult.prototype['Tags'] = undefined;
...
export default TagResourceResult;
