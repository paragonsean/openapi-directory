...
/**
 * The SubscribeResult model module.
 * @module model/SubscribeResult
 * @version 2019-10-15
 */
class SubscribeResult {
    /**
     * Constructs a new <code>SubscribeResult</code>.
     * @alias module:model/SubscribeResult
     */
    constructor() { 
        
        SubscribeResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubscribeResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubscribeResult} obj Optional instance to populate.
     * @return {module:model/SubscribeResult} The populated <code>SubscribeResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubscribeResult();
    ...
    /**
     * Validates the JSON data with respect to <code>SubscribeResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscribeResult</code>.
     */
 ...
 * @member {String} Arn
 */
SubscribeResult.prototype['Arn'] = undefined;
