...
* @readonly
*/
export default class ListNotificationRulesFilterName {
    ...
    /**
    * Returns a <code>ListNotificationRulesFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ListNotificationRulesFilterName} The enum <code>ListNotificationRulesFilterName</code> value.
    */
