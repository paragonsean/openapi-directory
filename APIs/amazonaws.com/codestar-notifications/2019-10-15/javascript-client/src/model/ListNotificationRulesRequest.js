...
import ListNotificationRulesFilter from './ListNotificationRulesFilter';

/**
 * The ListNotificationRulesRequest model module.
 * @module model/ListNotificationRulesRequest
 * @version 2019-10-15
 */
class ListNotificationRulesRequest {
    /**
     * Constructs a new <code>ListNotificationRulesRequest</code>.
     * @alias module:model/ListNotificationRulesRequest
     */
    constructor() { 
        
        ListNotificationRulesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListNotificationRulesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListNotificationRulesRequest} obj Optional instance to populate.
     * @return {module:model/ListNotificationRulesRequest} The populated <code>ListNotificationRulesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListNotificationRulesRequest();

            if (data.hasOwnProperty('Filters')) {
                obj['Filters'] = ApiClient.convertToType(data['Filters'], [ListNotificationRulesFilter]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListNotificationRulesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListNotificationRulesRequest</code>.
     */
    static validateJSON(data) {
        if (data['Filters']) { // data not null
            ...
            for (const item of data['Filters']) {
                ListNotificationRulesFilter.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ListNotificationRulesFilter>} Filters
 */
ListNotificationRulesRequest.prototype['Filters'] = undefined;

/**
 * An enumeration token that, when provided in a request, returns the next batch of the results.
 * @member {String} NextToken
 */
ListNotificationRulesRequest.prototype['NextToken'] = undefined;

/**
 * A non-negative integer used to limit the number of returned results. The maximum number of results that can be returned is 100.
 * @member {Number} MaxResults
 */
ListNotificationRulesRequest.prototype['MaxResults'] = undefined;
...
export default ListNotificationRulesRequest;
