...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.DeleteNotificationRuleResult();
  });
  ...
  describe('DeleteNotificationRuleResult', function() {
    it('should create an instance of DeleteNotificationRuleResult', function() {
      // uncomment below and update the code to test DeleteNotificationRuleResult
      //var instance = new AwsCodeStarNotifications.DeleteNotificationRuleResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.DeleteNotificationRuleResult);
    });
