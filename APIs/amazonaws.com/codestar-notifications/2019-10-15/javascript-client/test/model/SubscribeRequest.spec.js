...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.SubscribeRequest();
  });
  ...
  describe('SubscribeRequest', function() {
    it('should create an instance of SubscribeRequest', function() {
      // uncomment below and update the code to test SubscribeRequest
      //var instance = new AwsCodeStarNotifications.SubscribeRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.SubscribeRequest);
    });
