...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.EventTypeSummary();
  });
  ...
  describe('EventTypeSummary', function() {
    it('should create an instance of EventTypeSummary', function() {
      // uncomment below and update the code to test EventTypeSummary
      //var instance = new AwsCodeStarNotifications.EventTypeSummary();
      //expect(instance).to.be.a(AwsCodeStarNotifications.EventTypeSummary);
    });
