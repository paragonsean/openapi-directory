...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListTargetsResult();
  });
  ...
  describe('ListTargetsResult', function() {
    it('should create an instance of ListTargetsResult', function() {
      // uncomment below and update the code to test ListTargetsResult
      //var instance = new AwsCodeStarNotifications.ListTargetsResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListTargetsResult);
    });
