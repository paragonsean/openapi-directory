...
(function(root, factory) {
  ...
  describe('ListNotificationRulesFilterName', function() {
    it('should create an instance of ListNotificationRulesFilterName', function() {
      // uncomment below and update the code to test ListNotificationRulesFilterName
      //var instance = new AwsCodeStarNotifications.ListNotificationRulesFilterName();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListNotificationRulesFilterName);
    });
