...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.UpdateNotificationRuleRequest();
  });
  ...
  describe('UpdateNotificationRuleRequest', function() {
    it('should create an instance of UpdateNotificationRuleRequest', function() {
      // uncomment below and update the code to test UpdateNotificationRuleRequest
      //var instance = new AwsCodeStarNotifications.UpdateNotificationRuleRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.UpdateNotificationRuleRequest);
    });
