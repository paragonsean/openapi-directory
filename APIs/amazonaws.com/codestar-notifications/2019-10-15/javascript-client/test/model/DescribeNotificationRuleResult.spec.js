...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.DescribeNotificationRuleResult();
  });
  ...
  describe('DescribeNotificationRuleResult', function() {
    it('should create an instance of DescribeNotificationRuleResult', function() {
      // uncomment below and update the code to test DescribeNotificationRuleResult
      //var instance = new AwsCodeStarNotifications.DescribeNotificationRuleResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.DescribeNotificationRuleResult);
    });
