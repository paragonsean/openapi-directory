...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListNotificationRulesResult();
  });
  ...
  describe('ListNotificationRulesResult', function() {
    it('should create an instance of ListNotificationRulesResult', function() {
      // uncomment below and update the code to test ListNotificationRulesResult
      //var instance = new AwsCodeStarNotifications.ListNotificationRulesResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListNotificationRulesResult);
    });
