...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.TagResourceResult();
  });
  ...
  describe('TagResourceResult', function() {
    it('should create an instance of TagResourceResult', function() {
      // uncomment below and update the code to test TagResourceResult
      //var instance = new AwsCodeStarNotifications.TagResourceResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.TagResourceResult);
    });
