...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListEventTypesResult();
  });
  ...
  describe('ListEventTypesResult', function() {
    it('should create an instance of ListEventTypesResult', function() {
      // uncomment below and update the code to test ListEventTypesResult
      //var instance = new AwsCodeStarNotifications.ListEventTypesResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListEventTypesResult);
    });
