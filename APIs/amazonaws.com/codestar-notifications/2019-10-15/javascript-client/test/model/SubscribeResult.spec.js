...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.SubscribeResult();
  });
  ...
  describe('SubscribeResult', function() {
    it('should create an instance of SubscribeResult', function() {
      // uncomment below and update the code to test SubscribeResult
      //var instance = new AwsCodeStarNotifications.SubscribeResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.SubscribeResult);
    });
