...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.UnsubscribeRequest();
  });
  ...
  describe('UnsubscribeRequest', function() {
    it('should create an instance of UnsubscribeRequest', function() {
      ...
      //var instance = new AwsCodeStarNotifications.UnsubscribeRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.UnsubscribeRequest);
    });
