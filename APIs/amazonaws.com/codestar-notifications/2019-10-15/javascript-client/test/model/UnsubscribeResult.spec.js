...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.UnsubscribeResult();
  });
  ...
  describe('UnsubscribeResult', function() {
    it('should create an instance of UnsubscribeResult', function() {
      // uncomment below and update the code to test UnsubscribeResult
      //var instance = new AwsCodeStarNotifications.UnsubscribeResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.UnsubscribeResult);
    });
