...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.DeleteTargetRequest();
  });
  ...
  describe('DeleteTargetRequest', function() {
    it('should create an instance of DeleteTargetRequest', function() {
      // uncomment below and update the code to test DeleteTargetRequest
      //var instance = new AwsCodeStarNotifications.DeleteTargetRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.DeleteTargetRequest);
    });
    ...
    it('should have the property forceUnsubscribeAll (base name: "ForceUnsubscribeAll")', function() {
      // uncomment below and update the code to test the property forceUnsubscribeAll
      //var instance = new AwsCodeStarNotifications.DeleteTargetRequest();
      //expect(instance).to.be();
    });
