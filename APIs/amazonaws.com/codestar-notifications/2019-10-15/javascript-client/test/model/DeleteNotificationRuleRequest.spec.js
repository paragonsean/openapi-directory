...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.DeleteNotificationRuleRequest();
  });
  ...
  describe('DeleteNotificationRuleRequest', function() {
    it('should create an instance of DeleteNotificationRuleRequest', function() {
      // uncomment below and update the code to test DeleteNotificationRuleRequest
      //var instance = new AwsCodeStarNotifications.DeleteNotificationRuleRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.DeleteNotificationRuleRequest);
    });
