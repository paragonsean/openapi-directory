...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AwsCodeStarNotifications.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListTagsForResourceRequest);
    });
