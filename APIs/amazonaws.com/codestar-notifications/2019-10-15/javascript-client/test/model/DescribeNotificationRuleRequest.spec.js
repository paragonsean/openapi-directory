...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.DescribeNotificationRuleRequest();
  });
  ...
  describe('DescribeNotificationRuleRequest', function() {
    it('should create an instance of DescribeNotificationRuleRequest', function() {
      // uncomment below and update the code to test DescribeNotificationRuleRequest
      //var instance = new AwsCodeStarNotifications.DescribeNotificationRuleRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.DescribeNotificationRuleRequest);
    });
