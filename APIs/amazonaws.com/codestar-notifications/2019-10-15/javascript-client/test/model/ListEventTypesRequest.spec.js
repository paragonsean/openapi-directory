...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListEventTypesRequest();
  });
  ...
  describe('ListEventTypesRequest', function() {
    it('should create an instance of ListEventTypesRequest', function() {
      // uncomment below and update the code to test ListEventTypesRequest
      //var instance = new AwsCodeStarNotifications.ListEventTypesRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListEventTypesRequest);
    });
