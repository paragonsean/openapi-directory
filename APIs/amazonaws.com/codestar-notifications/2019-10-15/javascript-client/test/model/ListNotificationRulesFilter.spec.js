...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListNotificationRulesFilter();
  });
  ...
  describe('ListNotificationRulesFilter', function() {
    it('should create an instance of ListNotificationRulesFilter', function() {
      // uncomment below and update the code to test ListNotificationRulesFilter
      //var instance = new AwsCodeStarNotifications.ListNotificationRulesFilter();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListNotificationRulesFilter);
    });
