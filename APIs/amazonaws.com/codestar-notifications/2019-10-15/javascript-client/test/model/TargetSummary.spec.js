...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.TargetSummary();
  });
  ...
  describe('TargetSummary', function() {
    it('should create an instance of TargetSummary', function() {
      // uncomment below and update the code to test TargetSummary
      //var instance = new AwsCodeStarNotifications.TargetSummary();
      //expect(instance).to.be.a(AwsCodeStarNotifications.TargetSummary);
    });
