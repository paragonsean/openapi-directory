...
(function(root, factory) {
  ...
  describe('TargetStatus', function() {
    it('should create an instance of TargetStatus', function() {
      // uncomment below and update the code to test TargetStatus
      //var instance = new AwsCodeStarNotifications.TargetStatus();
      //expect(instance).to.be.a(AwsCodeStarNotifications.TargetStatus);
    });
