...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.CreateNotificationRuleResult();
  });
  ...
  describe('CreateNotificationRuleResult', function() {
    it('should create an instance of CreateNotificationRuleResult', function() {
      // uncomment below and update the code to test CreateNotificationRuleResult
      //var instance = new AwsCodeStarNotifications.CreateNotificationRuleResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.CreateNotificationRuleResult);
    });
