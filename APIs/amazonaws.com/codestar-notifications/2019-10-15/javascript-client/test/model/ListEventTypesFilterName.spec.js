...
(function(root, factory) {
  ...
  describe('ListEventTypesFilterName', function() {
    it('should create an instance of ListEventTypesFilterName', function() {
      // uncomment below and update the code to test ListEventTypesFilterName
      //var instance = new AwsCodeStarNotifications.ListEventTypesFilterName();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListEventTypesFilterName);
    });
