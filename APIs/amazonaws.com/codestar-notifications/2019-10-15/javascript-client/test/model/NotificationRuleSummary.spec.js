...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.NotificationRuleSummary();
  });
  ...
  describe('NotificationRuleSummary', function() {
    it('should create an instance of NotificationRuleSummary', function() {
      // uncomment below and update the code to test NotificationRuleSummary
      //var instance = new AwsCodeStarNotifications.NotificationRuleSummary();
      //expect(instance).to.be.a(AwsCodeStarNotifications.NotificationRuleSummary);
    });
