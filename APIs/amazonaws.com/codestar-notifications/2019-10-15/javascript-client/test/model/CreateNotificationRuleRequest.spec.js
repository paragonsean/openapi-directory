...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.CreateNotificationRuleRequest();
  });
  ...
  describe('CreateNotificationRuleRequest', function() {
    it('should create an instance of CreateNotificationRuleRequest', function() {
      // uncomment below and update the code to test CreateNotificationRuleRequest
      //var instance = new AwsCodeStarNotifications.CreateNotificationRuleRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.CreateNotificationRuleRequest);
    });
