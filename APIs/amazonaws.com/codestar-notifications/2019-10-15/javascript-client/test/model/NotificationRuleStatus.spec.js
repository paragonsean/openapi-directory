...
(function(root, factory) {
  ...
  describe('NotificationRuleStatus', function() {
    it('should create an instance of NotificationRuleStatus', function() {
      // uncomment below and update the code to test NotificationRuleStatus
      //var instance = new AwsCodeStarNotifications.NotificationRuleStatus();
      //expect(instance).to.be.a(AwsCodeStarNotifications.NotificationRuleStatus);
    });
