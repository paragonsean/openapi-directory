...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsCodeStarNotifications.TagResourceRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.TagResourceRequest);
    });
