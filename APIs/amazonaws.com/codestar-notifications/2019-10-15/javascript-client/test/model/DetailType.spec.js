...
(function(root, factory) {
  ...
  describe('DetailType', function() {
    it('should create an instance of DetailType', function() {
      // uncomment below and update the code to test DetailType
      //var instance = new AwsCodeStarNotifications.DetailType();
      //expect(instance).to.be.a(AwsCodeStarNotifications.DetailType);
    });
