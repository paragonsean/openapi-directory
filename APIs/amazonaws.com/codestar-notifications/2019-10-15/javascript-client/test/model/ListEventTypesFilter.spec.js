...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListEventTypesFilter();
  });
  ...
  describe('ListEventTypesFilter', function() {
    it('should create an instance of ListEventTypesFilter', function() {
      // uncomment below and update the code to test ListEventTypesFilter
      //var instance = new AwsCodeStarNotifications.ListEventTypesFilter();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListEventTypesFilter);
    });
