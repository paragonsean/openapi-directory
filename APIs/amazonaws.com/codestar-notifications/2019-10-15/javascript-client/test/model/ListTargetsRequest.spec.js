...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListTargetsRequest();
  });
  ...
  describe('ListTargetsRequest', function() {
    it('should create an instance of ListTargetsRequest', function() {
      // uncomment below and update the code to test ListTargetsRequest
      //var instance = new AwsCodeStarNotifications.ListTargetsRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListTargetsRequest);
    });
