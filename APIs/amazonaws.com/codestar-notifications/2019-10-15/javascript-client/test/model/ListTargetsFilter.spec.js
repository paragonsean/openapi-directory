...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListTargetsFilter();
  });
  ...
  describe('ListTargetsFilter', function() {
    it('should create an instance of ListTargetsFilter', function() {
      // uncomment below and update the code to test ListTargetsFilter
      //var instance = new AwsCodeStarNotifications.ListTargetsFilter();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListTargetsFilter);
    });
