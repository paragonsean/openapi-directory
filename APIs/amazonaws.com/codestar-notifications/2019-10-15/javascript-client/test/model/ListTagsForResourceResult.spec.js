...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListTagsForResourceResult();
  });
  ...
  describe('ListTagsForResourceResult', function() {
    it('should create an instance of ListTagsForResourceResult', function() {
      ...
      //var instance = new AwsCodeStarNotifications.ListTagsForResourceResult();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListTagsForResourceResult);
    });
