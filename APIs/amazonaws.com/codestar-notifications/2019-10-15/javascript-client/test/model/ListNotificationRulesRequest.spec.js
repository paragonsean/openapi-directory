...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarNotifications.ListNotificationRulesRequest();
  });
  ...
  describe('ListNotificationRulesRequest', function() {
    it('should create an instance of ListNotificationRulesRequest', function() {
      // uncomment below and update the code to test ListNotificationRulesRequest
      //var instance = new AwsCodeStarNotifications.ListNotificationRulesRequest();
      //expect(instance).to.be.a(AwsCodeStarNotifications.ListNotificationRulesRequest);
    });
