...
public class DeleteNotificationRuleRequest {
  ...
  public DeleteNotificationRuleRequest() {
  }

  public DeleteNotificationRuleRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteNotificationRuleRequest deleteNotificationRuleRequest = (DeleteNotificationRuleRequest) o;
    return Objects.equals(this.arn, deleteNotificationRuleRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteNotificationRuleRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteNotificationRuleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteNotificationRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteNotificationRuleRequest is not found in the empty JSON string", DeleteNotificationRuleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteNotificationRuleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteNotificationRuleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteNotificationRuleRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteNotificationRuleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteNotificationRuleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteNotificationRuleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteNotificationRuleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteNotificationRuleRequest>() {
           @Override
           public void write(JsonWriter out, DeleteNotificationRuleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteNotificationRuleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteNotificationRuleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteNotificationRuleRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteNotificationRuleRequest
   */
  public static DeleteNotificationRuleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteNotificationRuleRequest.class);
  }

  /**
   * Convert an instance of DeleteNotificationRuleRequest to an JSON string
   *
   * @return JSON string
   */
