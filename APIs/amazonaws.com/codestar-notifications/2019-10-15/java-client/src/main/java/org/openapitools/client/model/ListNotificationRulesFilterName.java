...
/**
 * Gets or Sets ListNotificationRulesFilterName
 */
@JsonAdapter(ListNotificationRulesFilterName.Adapter.class)
public enum ListNotificationRulesFilterName {
  ...
  ListNotificationRulesFilterName(String value) {
    this.value = value;
  }
  ...
  public static ListNotificationRulesFilterName fromValue(String value) {
    for (ListNotificationRulesFilterName b : ListNotificationRulesFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<ListNotificationRulesFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final ListNotificationRulesFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ListNotificationRulesFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ListNotificationRulesFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ListNotificationRulesFilterName.fromValue(value);
  }
}
