...
/**
 * Gets or Sets ListTargetsFilterName
 */
@JsonAdapter(ListTargetsFilterName.Adapter.class)
public enum ListTargetsFilterName {
  ...
  ListTargetsFilterName(String value) {
    this.value = value;
  }
  ...
  public static ListTargetsFilterName fromValue(String value) {
    for (ListTargetsFilterName b : ListTargetsFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<ListTargetsFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final ListTargetsFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ListTargetsFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ListTargetsFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ListTargetsFilterName.fromValue(value);
  }
}
