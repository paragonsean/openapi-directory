...
import org.openapitools.client.model.ListTargetsFilter;
...
public class ListTargetsRequest {
  ...
  private List<ListTargetsFilter> filters = new ArrayList<>();
  ...
  public ListTargetsRequest filters(List<ListTargetsFilter> filters) {
    this.filters = filters;
    return this;
  }

  public ListTargetsRequest addFiltersItem(ListTargetsFilter filtersItem) {
  ...
  public void setFilters(List<ListTargetsFilter> filters) {
    this.filters = filters;
  }


  public ListTargetsRequest nextToken(String nextToken) {
  ...
  public ListTargetsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filters, listTargetsRequest.filters) &&
        Objects.equals(this.nextToken, listTargetsRequest.nextToken) &&
        Objects.equals(this.maxResults, listTargetsRequest.maxResults);
  }
      ...
      if (jsonObj.get("Filters") != null && !jsonObj.get("Filters").isJsonNull()) {
        ...
        if (jsonArrayfilters != null) {
          ...
          for (int i = 0; i < jsonArrayfilters.size(); i++) {
            ListTargetsFilter.validateJsonElement(jsonArrayfilters.get(i));
          };
        }
      }
