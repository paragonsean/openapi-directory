...
/**
 * Gets or Sets ListEventTypesFilterName
 */
@JsonAdapter(ListEventTypesFilterName.Adapter.class)
public enum ListEventTypesFilterName {
  ...
  ListEventTypesFilterName(String value) {
    this.value = value;
  }
  ...
  public static ListEventTypesFilterName fromValue(String value) {
    for (ListEventTypesFilterName b : ListEventTypesFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<ListEventTypesFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final ListEventTypesFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ListEventTypesFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ListEventTypesFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ListEventTypesFilterName.fromValue(value);
  }
}
