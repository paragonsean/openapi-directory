...
public class CreateNotificationRuleResult {
  ...
  public CreateNotificationRuleResult arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateNotificationRuleResult createNotificationRuleResult = (CreateNotificationRuleResult) o;
    return Objects.equals(this.arn, createNotificationRuleResult.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNotificationRuleResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNotificationRuleResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNotificationRuleResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNotificationRuleResult is not found in the empty JSON string", CreateNotificationRuleResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNotificationRuleResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNotificationRuleResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNotificationRuleResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNotificationRuleResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNotificationRuleResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNotificationRuleResult.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNotificationRuleResult>() {
           @Override
           public void write(JsonWriter out, CreateNotificationRuleResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNotificationRuleResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNotificationRuleResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNotificationRuleResult
   * @throws IOException if the JSON string is invalid with respect to CreateNotificationRuleResult
   */
  public static CreateNotificationRuleResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNotificationRuleResult.class);
  }

  /**
   * Convert an instance of CreateNotificationRuleResult to an JSON string
   *
   * @return JSON string
   */
