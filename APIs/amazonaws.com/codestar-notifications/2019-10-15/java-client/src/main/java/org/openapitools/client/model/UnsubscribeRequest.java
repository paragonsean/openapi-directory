...
public class UnsubscribeRequest {
  ...
  public UnsubscribeRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UnsubscribeRequest targetAddress(String targetAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, unsubscribeRequest.arn) &&
        Objects.equals(this.targetAddress, unsubscribeRequest.targetAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, targetAddress);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnsubscribeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnsubscribeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnsubscribeRequest is not found in the empty JSON string", UnsubscribeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnsubscribeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnsubscribeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnsubscribeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnsubscribeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnsubscribeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnsubscribeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnsubscribeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UnsubscribeRequest>() {
           @Override
           public void write(JsonWriter out, UnsubscribeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnsubscribeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnsubscribeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnsubscribeRequest
   * @throws IOException if the JSON string is invalid with respect to UnsubscribeRequest
   */
  public static UnsubscribeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnsubscribeRequest.class);
  }

  /**
   * Convert an instance of UnsubscribeRequest to an JSON string
   *
   * @return JSON string
   */
