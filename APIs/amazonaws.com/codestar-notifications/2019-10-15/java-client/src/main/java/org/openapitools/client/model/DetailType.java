 ...
 */
@JsonAdapter(DetailType.Adapter.class)
public enum DetailType {
  ...
  public static DetailType fromValue(String value) {
    for (DetailType b : DetailType.values()) {
  ...
  public static class Adapter extends TypeAdapter<DetailType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DetailType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DetailType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DetailType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DetailType.fromValue(value);
  }
}
