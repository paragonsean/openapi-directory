...
public class SubscribeRequestTarget {
  ...
  public SubscribeRequestTarget() {
  }

  public SubscribeRequestTarget targetType(String targetType) {
  ...
  public SubscribeRequestTarget targetAddress(String targetAddress) {
  ...
  public boolean equals(Object o) {
    ...
    SubscribeRequestTarget subscribeRequestTarget = (SubscribeRequestTarget) o;
    return Objects.equals(this.targetType, subscribeRequestTarget.targetType) &&
        Objects.equals(this.targetAddress, subscribeRequestTarget.targetAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscribeRequestTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubscribeRequestTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscribeRequestTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscribeRequestTarget is not found in the empty JSON string", SubscribeRequestTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscribeRequestTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscribeRequestTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscribeRequestTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscribeRequestTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscribeRequestTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscribeRequestTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscribeRequestTarget>() {
           @Override
           public void write(JsonWriter out, SubscribeRequestTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscribeRequestTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubscribeRequestTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubscribeRequestTarget
   * @throws IOException if the JSON string is invalid with respect to SubscribeRequestTarget
   */
  public static SubscribeRequestTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscribeRequestTarget.class);
  }

  /**
   * Convert an instance of SubscribeRequestTarget to an JSON string
   *
   * @return JSON string
   */
