...
public class ListTargetsResult {
  ...
  public ListTargetsResult targets(List targets) {
  ...
  public ListTargetsResult nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListTargetsResult listTargetsResult = (ListTargetsResult) o;
    return Objects.equals(this.targets, listTargetsResult.targets) &&
        Objects.equals(this.nextToken, listTargetsResult.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListTargetsResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTargetsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTargetsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTargetsResult is not found in the empty JSON string", ListTargetsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTargetsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTargetsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTargetsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTargetsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTargetsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTargetsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTargetsResult>() {
           @Override
           public void write(JsonWriter out, ListTargetsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTargetsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTargetsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTargetsResult
   * @throws IOException if the JSON string is invalid with respect to ListTargetsResult
   */
  public static ListTargetsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTargetsResult.class);
  }

  /**
   * Convert an instance of ListTargetsResult to an JSON string
   *
   * @return JSON string
   */
