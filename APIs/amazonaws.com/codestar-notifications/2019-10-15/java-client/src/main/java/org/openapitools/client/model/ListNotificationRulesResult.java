...
public class ListNotificationRulesResult {
  ...
  public ListNotificationRulesResult nextToken(String nextToken) {
  ...
  public ListNotificationRulesResult notificationRules(List notificationRules) {
  ...
  public boolean equals(Object o) {
    ...
    ListNotificationRulesResult listNotificationRulesResult = (ListNotificationRulesResult) o;
    return Objects.equals(this.nextToken, listNotificationRulesResult.nextToken) &&
        Objects.equals(this.notificationRules, listNotificationRulesResult.notificationRules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, notificationRules);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListNotificationRulesResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListNotificationRulesResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListNotificationRulesResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListNotificationRulesResult is not found in the empty JSON string", ListNotificationRulesResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListNotificationRulesResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListNotificationRulesResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("NotificationRules") != null && !jsonObj.get("NotificationRules").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("NotificationRules"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListNotificationRulesResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListNotificationRulesResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListNotificationRulesResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListNotificationRulesResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListNotificationRulesResult>() {
           @Override
           public void write(JsonWriter out, ListNotificationRulesResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListNotificationRulesResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListNotificationRulesResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListNotificationRulesResult
   * @throws IOException if the JSON string is invalid with respect to ListNotificationRulesResult
   */
  public static ListNotificationRulesResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListNotificationRulesResult.class);
  }

  /**
   * Convert an instance of ListNotificationRulesResult to an JSON string
   *
   * @return JSON string
   */
