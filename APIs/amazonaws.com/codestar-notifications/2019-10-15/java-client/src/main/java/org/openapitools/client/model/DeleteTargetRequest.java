...
public class DeleteTargetRequest {
  ...
  public static final String SERIALIZED_NAME_FORCE_UNSUBSCRIBE_ALL = "ForceUnsubscribeAll";
  @SerializedName(SERIALIZED_NAME_FORCE_UNSUBSCRIBE_ALL)
  private Boolean forceUnsubscribeAll;

  public DeleteTargetRequest() {
  }

  public DeleteTargetRequest targetAddress(String targetAddress) {
  ...
  public DeleteTargetRequest forceUnsubscribeAll(Boolean forceUnsubscribeAll) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.targetAddress, deleteTargetRequest.targetAddress) &&
        Objects.equals(this.forceUnsubscribeAll, deleteTargetRequest.forceUnsubscribeAll);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetAddress, forceUnsubscribeAll);
  }
  ...
  public String toString() {
    ...
    sb.append("    targetAddress: ").append("*").append("\n");
    sb.append("    forceUnsubscribeAll: ").append(toIndentedString(forceUnsubscribeAll)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ForceUnsubscribeAll");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTargetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTargetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTargetRequest is not found in the empty JSON string", DeleteTargetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTargetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTargetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteTargetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTargetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTargetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTargetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTargetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTargetRequest>() {
           @Override
           public void write(JsonWriter out, DeleteTargetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTargetRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTargetRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTargetRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteTargetRequest
   */
  public static DeleteTargetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTargetRequest.class);
  }

  /**
   * Convert an instance of DeleteTargetRequest to an JSON string
   *
   * @return JSON string
   */
