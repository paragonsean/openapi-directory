...
#include "OAIListEventTypesRequest.h"
...
OAIListEventTypesRequest::OAIListEventTypesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListEventTypesRequest::OAIListEventTypesRequest() {
    this->initializeModel();
}

OAIListEventTypesRequest::~OAIListEventTypesRequest() {}

void OAIListEventTypesRequest::initializeModel() {
...
void OAIListEventTypesRequest::fromJson(QString jsonString) {
...
void OAIListEventTypesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListEventTypesRequest::asJson() const {
...
QJsonObject OAIListEventTypesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAIListEventTypesRequest::getFilters() const {
    return m_filters;
}
void OAIListEventTypesRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListEventTypesRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListEventTypesRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

QString OAIListEventTypesRequest::getNextToken() const {
    return m_next_token;
}
void OAIListEventTypesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListEventTypesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListEventTypesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListEventTypesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListEventTypesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListEventTypesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListEventTypesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListEventTypesRequest::isSet() const {
...
bool OAIListEventTypesRequest::isValid() const {
