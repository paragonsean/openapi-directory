...
/*
 * OAISubscribe_request.h
 *
 * 
 */

#ifndef OAISubscribe_request_H
#define OAISubscribe_request_H

#include <QJsonObject>

#include "OAISubscribe_request_Target.h"
#include <QString>
...
namespace OpenAPI {
class OAISubscribe_request_Target;

class OAISubscribe_request : public OAIObject {
public:
    OAISubscribe_request();
    OAISubscribe_request(QString json);
    ~OAISubscribe_request() override;
    ...
    OAISubscribe_request_Target getTarget() const;
    void setTarget(const OAISubscribe_request_Target &target);
...
private:
    ...
    OAISubscribe_request_Target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscribe_request)

#endif // OAISubscribe_request_H
