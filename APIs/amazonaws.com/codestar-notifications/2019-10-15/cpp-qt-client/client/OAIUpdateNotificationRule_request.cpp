...
OAIUpdateNotificationRule_request::OAIUpdateNotificationRule_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNotificationRule_request::OAIUpdateNotificationRule_request() {
    this->initializeModel();
}

OAIUpdateNotificationRule_request::~OAIUpdateNotificationRule_request() {}

void OAIUpdateNotificationRule_request::initializeModel() {
...
void OAIUpdateNotificationRule_request::fromJson(QString jsonString) {
...
void OAIUpdateNotificationRule_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNotificationRule_request::asJson() const {
...
QJsonObject OAIUpdateNotificationRule_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateNotificationRule_request::getArn() const {
    return m_arn;
}
void OAIUpdateNotificationRule_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateNotificationRule_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateNotificationRule_request::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateNotificationRule_request::getName() const {
    return m_name;
}
void OAIUpdateNotificationRule_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateNotificationRule_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateNotificationRule_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateNotificationRule_request::getStatus() const {
    return m_status;
}
void OAIUpdateNotificationRule_request::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateNotificationRule_request::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateNotificationRule_request::is_status_Valid() const{
    return m_status_isValid;
}

QList<QString> OAIUpdateNotificationRule_request::getEventTypeIds() const {
    return m_event_type_ids;
}
void OAIUpdateNotificationRule_request::setEventTypeIds(const QList<QString> &event_type_ids) {
    m_event_type_ids = event_type_ids;
    m_event_type_ids_isSet = true;
}

bool OAIUpdateNotificationRule_request::is_event_type_ids_Set() const{
    return m_event_type_ids_isSet;
}

bool OAIUpdateNotificationRule_request::is_event_type_ids_Valid() const{
    return m_event_type_ids_isValid;
}

QList<OAITarget> OAIUpdateNotificationRule_request::getTargets() const {
    return m_targets;
}
void OAIUpdateNotificationRule_request::setTargets(const QList<OAITarget> &targets) {
    m_targets = targets;
    m_targets_isSet = true;
}

bool OAIUpdateNotificationRule_request::is_targets_Set() const{
    return m_targets_isSet;
}

bool OAIUpdateNotificationRule_request::is_targets_Valid() const{
    return m_targets_isValid;
}

QString OAIUpdateNotificationRule_request::getDetailType() const {
    return m_detail_type;
}
void OAIUpdateNotificationRule_request::setDetailType(const QString &detail_type) {
    m_detail_type = detail_type;
    m_detail_type_isSet = true;
}

bool OAIUpdateNotificationRule_request::is_detail_type_Set() const{
    return m_detail_type_isSet;
}

bool OAIUpdateNotificationRule_request::is_detail_type_Valid() const{
    return m_detail_type_isValid;
}

bool OAIUpdateNotificationRule_request::isSet() const {
...
bool OAIUpdateNotificationRule_request::isValid() const {
