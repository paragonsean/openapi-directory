...
/*
 * OAIListEventTypesResult.h
 *
 * 
 */

#ifndef OAIListEventTypesResult_H
#define OAIListEventTypesResult_H
...
class OAIListEventTypesResult : public OAIObject {
public:
    OAIListEventTypesResult();
    OAIListEventTypesResult(QString json);
    ~OAIListEventTypesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventTypesResult)

#endif // OAIListEventTypesResult_H
