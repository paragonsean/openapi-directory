...
/*
 * OAIListNotificationRulesFilterName.h
 *
 * 
 */

#ifndef OAIListNotificationRulesFilterName_H
#define OAIListNotificationRulesFilterName_H
...
class OAIListNotificationRulesFilterName : public OAIEnum {
public:
    OAIListNotificationRulesFilterName();
    OAIListNotificationRulesFilterName(QString json);
    ~OAIListNotificationRulesFilterName() override;
    ...
    enum class eOAIListNotificationRulesFilterName {
    ...
    OAIListNotificationRulesFilterName::eOAIListNotificationRulesFilterName getValue() const;
    void setValue(const OAIListNotificationRulesFilterName::eOAIListNotificationRulesFilterName& value);
...
private:
    ...
    eOAIListNotificationRulesFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNotificationRulesFilterName)

#endif // OAIListNotificationRulesFilterName_H
