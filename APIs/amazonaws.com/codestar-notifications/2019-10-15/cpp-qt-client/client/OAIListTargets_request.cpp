...
QList<OAIListTargetsFilter> OAIListTargets_request::getFilters() const {
    return m_filters;
}
void OAIListTargets_request::setFilters(const QList<OAIListTargetsFilter> &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListTargets_request::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListTargets_request::is_filters_Valid() const{
    return m_filters_isValid;
}

QString OAIListTargets_request::getNextToken() const {
    return m_next_token;
}
void OAIListTargets_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTargets_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTargets_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListTargets_request::getMaxResults() const {
    return m_max_results;
}
void OAIListTargets_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListTargets_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListTargets_request::is_max_results_Valid() const{
