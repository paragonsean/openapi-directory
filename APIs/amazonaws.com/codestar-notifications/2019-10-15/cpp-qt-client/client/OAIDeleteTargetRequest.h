...
/*
 * OAIDeleteTargetRequest.h
 *
 * 
 */

#ifndef OAIDeleteTargetRequest_H
#define OAIDeleteTargetRequest_H
...
class OAIDeleteTargetRequest : public OAIObject {
public:
    OAIDeleteTargetRequest();
    OAIDeleteTargetRequest(QString json);
    ~OAIDeleteTargetRequest() override;
    ...
    void setForceUnsubscribeAll(const bool &force_unsubscribe_all);
    bool is_force_unsubscribe_all_Set() const;
    bool is_force_unsubscribe_all_Valid() const;
...
private:
    ...
    bool m_force_unsubscribe_all;
    bool m_force_unsubscribe_all_isSet;
    bool m_force_unsubscribe_all_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTargetRequest)

#endif // OAIDeleteTargetRequest_H
