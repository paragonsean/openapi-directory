...
/*
 * OAIUpdateNotificationRuleRequest.h
 *
 * 
 */

#ifndef OAIUpdateNotificationRuleRequest_H
#define OAIUpdateNotificationRuleRequest_H
...
class OAIUpdateNotificationRuleRequest : public OAIObject {
public:
    OAIUpdateNotificationRuleRequest();
    OAIUpdateNotificationRuleRequest(QString json);
    ~OAIUpdateNotificationRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNotificationRuleRequest)

#endif // OAIUpdateNotificationRuleRequest_H
