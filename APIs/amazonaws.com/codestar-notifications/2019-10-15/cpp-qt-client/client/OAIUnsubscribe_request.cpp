...
OAIUnsubscribe_request::OAIUnsubscribe_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsubscribe_request::OAIUnsubscribe_request() {
    this->initializeModel();
}

OAIUnsubscribe_request::~OAIUnsubscribe_request() {}

void OAIUnsubscribe_request::initializeModel() {
...
void OAIUnsubscribe_request::fromJson(QString jsonString) {
...
void OAIUnsubscribe_request::fromJsonObject(QJsonObject json) {
...
QString OAIUnsubscribe_request::asJson() const {
...
QJsonObject OAIUnsubscribe_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUnsubscribe_request::getArn() const {
    return m_arn;
}
void OAIUnsubscribe_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUnsubscribe_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUnsubscribe_request::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUnsubscribe_request::getTargetAddress() const {
    return m_target_address;
}
void OAIUnsubscribe_request::setTargetAddress(const QString &target_address) {
    m_target_address = target_address;
    m_target_address_isSet = true;
}

bool OAIUnsubscribe_request::is_target_address_Set() const{
    return m_target_address_isSet;
}

bool OAIUnsubscribe_request::is_target_address_Valid() const{
    return m_target_address_isValid;
}

bool OAIUnsubscribe_request::isSet() const {
...
bool OAIUnsubscribe_request::isValid() const {
