...
#include "OAIListNotificationRulesFilter.h"
...
OAIListNotificationRulesFilter::OAIListNotificationRulesFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListNotificationRulesFilter::OAIListNotificationRulesFilter() {
    this->initializeModel();
}

OAIListNotificationRulesFilter::~OAIListNotificationRulesFilter() {}

void OAIListNotificationRulesFilter::initializeModel() {
...
void OAIListNotificationRulesFilter::fromJson(QString jsonString) {
...
void OAIListNotificationRulesFilter::fromJsonObject(QJsonObject json) {
...
QString OAIListNotificationRulesFilter::asJson() const {
...
QJsonObject OAIListNotificationRulesFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAIListNotificationRulesFilterName OAIListNotificationRulesFilter::getName() const {
    return m_name;
}
void OAIListNotificationRulesFilter::setName(const OAIListNotificationRulesFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIListNotificationRulesFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIListNotificationRulesFilter::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIListNotificationRulesFilter::getValue() const {
    return m_value;
}
void OAIListNotificationRulesFilter::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIListNotificationRulesFilter::is_value_Set() const{
    return m_value_isSet;
}

bool OAIListNotificationRulesFilter::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIListNotificationRulesFilter::isSet() const {
...
bool OAIListNotificationRulesFilter::isValid() const {
