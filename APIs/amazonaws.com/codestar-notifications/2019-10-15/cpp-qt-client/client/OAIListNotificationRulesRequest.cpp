...
#include "OAIListNotificationRulesRequest.h"
...
OAIListNotificationRulesRequest::OAIListNotificationRulesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListNotificationRulesRequest::OAIListNotificationRulesRequest() {
    this->initializeModel();
}

OAIListNotificationRulesRequest::~OAIListNotificationRulesRequest() {}

void OAIListNotificationRulesRequest::initializeModel() {
...
void OAIListNotificationRulesRequest::fromJson(QString jsonString) {
...
void OAIListNotificationRulesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListNotificationRulesRequest::asJson() const {
...
QJsonObject OAIListNotificationRulesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAIListNotificationRulesRequest::getFilters() const {
    return m_filters;
}
void OAIListNotificationRulesRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListNotificationRulesRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListNotificationRulesRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

QString OAIListNotificationRulesRequest::getNextToken() const {
    return m_next_token;
}
void OAIListNotificationRulesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListNotificationRulesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListNotificationRulesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListNotificationRulesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListNotificationRulesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListNotificationRulesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListNotificationRulesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListNotificationRulesRequest::isSet() const {
...
bool OAIListNotificationRulesRequest::isValid() const {
