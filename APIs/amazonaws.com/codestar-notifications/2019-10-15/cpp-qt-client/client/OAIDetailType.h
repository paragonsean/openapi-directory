...
#ifndef OAIDetailType_H
#define OAIDetailType_H
...
class OAIDetailType : public OAIEnum {
public:
    OAIDetailType();
    OAIDetailType(QString json);
    ~OAIDetailType() override;
    ...
    enum class eOAIDetailType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        BASIC, 
        FULL
    };
    OAIDetailType::eOAIDetailType getValue() const;
    void setValue(const OAIDetailType::eOAIDetailType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetailType)

#endif // OAIDetailType_H
