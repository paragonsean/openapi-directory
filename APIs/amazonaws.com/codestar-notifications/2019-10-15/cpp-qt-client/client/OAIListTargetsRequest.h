...
/*
 * OAIListTargetsRequest.h
 *
 * 
 */

#ifndef OAIListTargetsRequest_H
#define OAIListTargetsRequest_H
...
class OAIListTargetsRequest : public OAIObject {
public:
    OAIListTargetsRequest();
    OAIListTargetsRequest(QString json);
    ~OAIListTargetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTargetsRequest)

#endif // OAIListTargetsRequest_H
