...
/*
 * OAITagResourceResult.h
 *
 * 
 */

#ifndef OAITagResourceResult_H
#define OAITagResourceResult_H
...
class OAITagResourceResult : public OAIObject {
public:
    OAITagResourceResult();
    OAITagResourceResult(QString json);
    ~OAITagResourceResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagResourceResult)

#endif // OAITagResourceResult_H
