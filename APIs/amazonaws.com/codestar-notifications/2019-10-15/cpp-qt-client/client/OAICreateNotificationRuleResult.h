...
/*
 * OAICreateNotificationRuleResult.h
 *
 * 
 */

#ifndef OAICreateNotificationRuleResult_H
#define OAICreateNotificationRuleResult_H
...
class OAICreateNotificationRuleResult : public OAIObject {
public:
    OAICreateNotificationRuleResult();
    OAICreateNotificationRuleResult(QString json);
    ~OAICreateNotificationRuleResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNotificationRuleResult)

#endif // OAICreateNotificationRuleResult_H
