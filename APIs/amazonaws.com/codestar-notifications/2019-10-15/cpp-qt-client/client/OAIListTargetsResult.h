...
/*
 * OAIListTargetsResult.h
 *
 * 
 */

#ifndef OAIListTargetsResult_H
#define OAIListTargetsResult_H
...
class OAIListTargetsResult : public OAIObject {
public:
    OAIListTargetsResult();
    OAIListTargetsResult(QString json);
    ~OAIListTargetsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTargetsResult)

#endif // OAIListTargetsResult_H
