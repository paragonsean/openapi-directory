...
/*
 * OAIListNotificationRulesFilter.h
 *
 * Information about a filter to apply to the list of returned notification rules. You can filter by event type, owner, resource, or target.
 */

#ifndef OAIListNotificationRulesFilter_H
#define OAIListNotificationRulesFilter_H
...
class OAIListNotificationRulesFilter : public OAIObject {
public:
    OAIListNotificationRulesFilter();
    OAIListNotificationRulesFilter(QString json);
    ~OAIListNotificationRulesFilter() override;
    ...
    OAIListNotificationRulesFilterName getName() const;
    void setName(const OAIListNotificationRulesFilterName &name);
...
private:
    ...
    OAIListNotificationRulesFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNotificationRulesFilter)

#endif // OAIListNotificationRulesFilter_H
