...
/*
 * OAIListEventTypesRequest.h
 *
 * 
 */

#ifndef OAIListEventTypesRequest_H
#define OAIListEventTypesRequest_H
...
class OAIListEventTypesRequest : public OAIObject {
public:
    OAIListEventTypesRequest();
    OAIListEventTypesRequest(QString json);
    ~OAIListEventTypesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventTypesRequest)

#endif // OAIListEventTypesRequest_H
