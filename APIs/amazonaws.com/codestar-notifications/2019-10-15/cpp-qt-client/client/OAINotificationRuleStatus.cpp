...
OAINotificationRuleStatus::OAINotificationRuleStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotificationRuleStatus::OAINotificationRuleStatus() {
    this->initializeModel();
}

OAINotificationRuleStatus::~OAINotificationRuleStatus() {}

void OAINotificationRuleStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAINotificationRuleStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAINotificationRuleStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ENABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationRuleStatus::ENABLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationRuleStatus::DISABLED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAINotificationRuleStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAINotificationRuleStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAINotificationRuleStatus::ENABLED:
            val = "ENABLED";
            break;
        case eOAINotificationRuleStatus::DISABLED:
            val = "DISABLED";
            break;
        default:
            break;
...
QJsonValue OAINotificationRuleStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAINotificationRuleStatus::eOAINotificationRuleStatus OAINotificationRuleStatus::getValue() const {
    return m_value;
}

void OAINotificationRuleStatus::setValue(const OAINotificationRuleStatus::eOAINotificationRuleStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAINotificationRuleStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAINotificationRuleStatus::isValid() const {
