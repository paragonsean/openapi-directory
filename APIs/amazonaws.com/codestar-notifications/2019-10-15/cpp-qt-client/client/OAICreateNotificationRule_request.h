...
/*
 * OAICreateNotificationRule_request.h
 *
 * 
 */

#ifndef OAICreateNotificationRule_request_H
#define OAICreateNotificationRule_request_H
...
class OAICreateNotificationRule_request : public OAIObject {
public:
    OAICreateNotificationRule_request();
    OAICreateNotificationRule_request(QString json);
    ~OAICreateNotificationRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNotificationRule_request)

#endif // OAICreateNotificationRule_request_H
