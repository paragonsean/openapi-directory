...
#include "OAINotificationRuleSummary.h"
...
OAINotificationRuleSummary::OAINotificationRuleSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotificationRuleSummary::OAINotificationRuleSummary() {
    this->initializeModel();
}

OAINotificationRuleSummary::~OAINotificationRuleSummary() {}

void OAINotificationRuleSummary::initializeModel() {
...
void OAINotificationRuleSummary::fromJson(QString jsonString) {
...
void OAINotificationRuleSummary::fromJsonObject(QJsonObject json) {
...
QString OAINotificationRuleSummary::asJson() const {
...
QJsonObject OAINotificationRuleSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAINotificationRuleSummary::getId() const {
    return m_id;
}
void OAINotificationRuleSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINotificationRuleSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAINotificationRuleSummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINotificationRuleSummary::getArn() const {
    return m_arn;
}
void OAINotificationRuleSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAINotificationRuleSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAINotificationRuleSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAINotificationRuleSummary::isSet() const {
...
bool OAINotificationRuleSummary::isValid() const {
