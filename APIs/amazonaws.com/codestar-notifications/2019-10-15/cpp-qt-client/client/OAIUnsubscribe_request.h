...
/*
 * OAIUnsubscribe_request.h
 *
 * 
 */

#ifndef OAIUnsubscribe_request_H
#define OAIUnsubscribe_request_H
...
class OAIUnsubscribe_request : public OAIObject {
public:
    OAIUnsubscribe_request();
    OAIUnsubscribe_request(QString json);
    ~OAIUnsubscribe_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsubscribe_request)

#endif // OAIUnsubscribe_request_H
