...
/*
 * OAIDeleteNotificationRule_request.h
 *
 * 
 */

#ifndef OAIDeleteNotificationRule_request_H
#define OAIDeleteNotificationRule_request_H
...
class OAIDeleteNotificationRule_request : public OAIObject {
public:
    OAIDeleteNotificationRule_request();
    OAIDeleteNotificationRule_request(QString json);
    ~OAIDeleteNotificationRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNotificationRule_request)

#endif // OAIDeleteNotificationRule_request_H
