...
/*
 * OAIUnsubscribeResult.h
 *
 * 
 */

#ifndef OAIUnsubscribeResult_H
#define OAIUnsubscribeResult_H
...
class OAIUnsubscribeResult : public OAIObject {
public:
    OAIUnsubscribeResult();
    OAIUnsubscribeResult(QString json);
    ~OAIUnsubscribeResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsubscribeResult)

#endif // OAIUnsubscribeResult_H
