...
OAISubscribeResult::OAISubscribeResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubscribeResult::OAISubscribeResult() {
    this->initializeModel();
}

OAISubscribeResult::~OAISubscribeResult() {}

void OAISubscribeResult::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAISubscribeResult::fromJson(QString jsonString) {
...
void OAISubscribeResult::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAISubscribeResult::asJson() const {
...
QJsonObject OAISubscribeResult::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAISubscribeResult::getArn() const {
    return m_arn;
}
void OAISubscribeResult::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAISubscribeResult::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAISubscribeResult::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAISubscribeResult::isSet() const {
...
bool OAISubscribeResult::isValid() const {
