...
/*
 * OAIDescribeNotificationRule_request.h
 *
 * 
 */

#ifndef OAIDescribeNotificationRule_request_H
#define OAIDescribeNotificationRule_request_H
...
class OAIDescribeNotificationRule_request : public OAIObject {
public:
    OAIDescribeNotificationRule_request();
    OAIDescribeNotificationRule_request(QString json);
    ~OAIDescribeNotificationRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeNotificationRule_request)

#endif // OAIDescribeNotificationRule_request_H
