...
/*
 * OAIListEventTypes_request.h
 *
 * 
 */

#ifndef OAIListEventTypes_request_H
#define OAIListEventTypes_request_H
...
namespace OpenAPI {
class OAIListEventTypesFilter;

class OAIListEventTypes_request : public OAIObject {
public:
    OAIListEventTypes_request();
    OAIListEventTypes_request(QString json);
    ~OAIListEventTypes_request() override;
    ...
    QList<OAIListEventTypesFilter> getFilters() const;
    void setFilters(const QList<OAIListEventTypesFilter> &filters);
...
private:
    ...
    QList<OAIListEventTypesFilter> m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventTypes_request)

#endif // OAIListEventTypes_request_H
