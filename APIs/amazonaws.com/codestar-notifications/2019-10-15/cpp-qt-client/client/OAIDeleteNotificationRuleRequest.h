...
/*
 * OAIDeleteNotificationRuleRequest.h
 *
 * 
 */

#ifndef OAIDeleteNotificationRuleRequest_H
#define OAIDeleteNotificationRuleRequest_H
...
class OAIDeleteNotificationRuleRequest : public OAIObject {
public:
    OAIDeleteNotificationRuleRequest();
    OAIDeleteNotificationRuleRequest(QString json);
    ~OAIDeleteNotificationRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNotificationRuleRequest)

#endif // OAIDeleteNotificationRuleRequest_H
