...
OAIUnsubscribeResult::OAIUnsubscribeResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsubscribeResult::OAIUnsubscribeResult() {
    this->initializeModel();
}

OAIUnsubscribeResult::~OAIUnsubscribeResult() {}

void OAIUnsubscribeResult::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIUnsubscribeResult::fromJson(QString jsonString) {
...
void OAIUnsubscribeResult::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIUnsubscribeResult::asJson() const {
...
QJsonObject OAIUnsubscribeResult::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUnsubscribeResult::getArn() const {
    return m_arn;
}
void OAIUnsubscribeResult::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUnsubscribeResult::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUnsubscribeResult::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIUnsubscribeResult::isSet() const {
...
bool OAIUnsubscribeResult::isValid() const {
