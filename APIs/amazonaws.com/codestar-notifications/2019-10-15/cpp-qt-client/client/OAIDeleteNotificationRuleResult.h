...
/*
 * OAIDeleteNotificationRuleResult.h
 *
 * 
 */

#ifndef OAIDeleteNotificationRuleResult_H
#define OAIDeleteNotificationRuleResult_H
...
class OAIDeleteNotificationRuleResult : public OAIObject {
public:
    OAIDeleteNotificationRuleResult();
    OAIDeleteNotificationRuleResult(QString json);
    ~OAIDeleteNotificationRuleResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNotificationRuleResult)

#endif // OAIDeleteNotificationRuleResult_H
