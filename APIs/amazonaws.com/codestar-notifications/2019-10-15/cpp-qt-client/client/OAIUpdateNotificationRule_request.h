...
/*
 * OAIUpdateNotificationRule_request.h
 *
 * 
 */

#ifndef OAIUpdateNotificationRule_request_H
#define OAIUpdateNotificationRule_request_H
...
class OAIUpdateNotificationRule_request : public OAIObject {
public:
    OAIUpdateNotificationRule_request();
    OAIUpdateNotificationRule_request(QString json);
    ~OAIUpdateNotificationRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNotificationRule_request)

#endif // OAIUpdateNotificationRule_request_H
