...
OAITagResourceResult::OAITagResourceResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagResourceResult::OAITagResourceResult() {
    this->initializeModel();
}

OAITagResourceResult::~OAITagResourceResult() {}

void OAITagResourceResult::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITagResourceResult::fromJson(QString jsonString) {
...
void OAITagResourceResult::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAITagResourceResult::asJson() const {
...
QJsonObject OAITagResourceResult::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QMap OAITagResourceResult::getTags() const {
    return m_tags;
}
void OAITagResourceResult::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagResourceResult::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagResourceResult::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagResourceResult::isSet() const {
...
bool OAITagResourceResult::isValid() const {
