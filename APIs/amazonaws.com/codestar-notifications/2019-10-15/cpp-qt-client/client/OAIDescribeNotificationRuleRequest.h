...
/*
 * OAIDescribeNotificationRuleRequest.h
 *
 * 
 */

#ifndef OAIDescribeNotificationRuleRequest_H
#define OAIDescribeNotificationRuleRequest_H
...
class OAIDescribeNotificationRuleRequest : public OAIObject {
public:
    OAIDescribeNotificationRuleRequest();
    OAIDescribeNotificationRuleRequest(QString json);
    ~OAIDescribeNotificationRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeNotificationRuleRequest)

#endif // OAIDescribeNotificationRuleRequest_H
