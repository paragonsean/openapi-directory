...
OAIListTargetsResult::OAIListTargetsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTargetsResult::OAIListTargetsResult() {
    this->initializeModel();
}

OAIListTargetsResult::~OAIListTargetsResult() {}

void OAIListTargetsResult::initializeModel() {
...
void OAIListTargetsResult::fromJson(QString jsonString) {
...
void OAIListTargetsResult::fromJsonObject(QJsonObject json) {
...
QString OAIListTargetsResult::asJson() const {
...
QJsonObject OAIListTargetsResult::asJsonObject() const {
    QJsonObject obj;
    if (m_targets.isSet()) {
...
QList OAIListTargetsResult::getTargets() const {
    return m_targets;
}
void OAIListTargetsResult::setTargets(const QList &targets) {
    m_targets = targets;
    m_targets_isSet = true;
}

bool OAIListTargetsResult::is_targets_Set() const{
    return m_targets_isSet;
}

bool OAIListTargetsResult::is_targets_Valid() const{
    return m_targets_isValid;
}

QString OAIListTargetsResult::getNextToken() const {
    return m_next_token;
}
void OAIListTargetsResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTargetsResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTargetsResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListTargetsResult::isSet() const {
...
bool OAIListTargetsResult::isValid() const {
