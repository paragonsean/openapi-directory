...
OAIDescribeNotificationRule_request::OAIDescribeNotificationRule_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeNotificationRule_request::OAIDescribeNotificationRule_request() {
    this->initializeModel();
}

OAIDescribeNotificationRule_request::~OAIDescribeNotificationRule_request() {}

void OAIDescribeNotificationRule_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDescribeNotificationRule_request::fromJson(QString jsonString) {
...
void OAIDescribeNotificationRule_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIDescribeNotificationRule_request::asJson() const {
...
QJsonObject OAIDescribeNotificationRule_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDescribeNotificationRule_request::getArn() const {
    return m_arn;
}
void OAIDescribeNotificationRule_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeNotificationRule_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeNotificationRule_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDescribeNotificationRule_request::isSet() const {
...
bool OAIDescribeNotificationRule_request::isValid() const {
