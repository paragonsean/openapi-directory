...
OAIDeleteNotificationRule_request::OAIDeleteNotificationRule_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteNotificationRule_request::OAIDeleteNotificationRule_request() {
    this->initializeModel();
}

OAIDeleteNotificationRule_request::~OAIDeleteNotificationRule_request() {}

void OAIDeleteNotificationRule_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteNotificationRule_request::fromJson(QString jsonString) {
...
void OAIDeleteNotificationRule_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteNotificationRule_request::asJson() const {
...
QJsonObject OAIDeleteNotificationRule_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteNotificationRule_request::getArn() const {
    return m_arn;
}
void OAIDeleteNotificationRule_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteNotificationRule_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteNotificationRule_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteNotificationRule_request::isSet() const {
...
bool OAIDeleteNotificationRule_request::isValid() const {
