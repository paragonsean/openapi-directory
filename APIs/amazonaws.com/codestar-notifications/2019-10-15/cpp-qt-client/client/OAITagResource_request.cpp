...
QString OAITagResource_request::getArn() const {
    return m_arn;
}
void OAITagResource_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAITagResource_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAITagResource_request::is_arn_Valid() const{
