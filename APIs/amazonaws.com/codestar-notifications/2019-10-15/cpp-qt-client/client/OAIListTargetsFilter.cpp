...
#include "OAIListTargetsFilter.h"
...
OAIListTargetsFilter::OAIListTargetsFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTargetsFilter::OAIListTargetsFilter() {
    this->initializeModel();
}

OAIListTargetsFilter::~OAIListTargetsFilter() {}

void OAIListTargetsFilter::initializeModel() {
...
void OAIListTargetsFilter::fromJson(QString jsonString) {
...
void OAIListTargetsFilter::fromJsonObject(QJsonObject json) {
...
QString OAIListTargetsFilter::asJson() const {
...
QJsonObject OAIListTargetsFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAIListTargetsFilterName OAIListTargetsFilter::getName() const {
    return m_name;
}
void OAIListTargetsFilter::setName(const OAIListTargetsFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIListTargetsFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIListTargetsFilter::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIListTargetsFilter::getValue() const {
    return m_value;
}
void OAIListTargetsFilter::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIListTargetsFilter::is_value_Set() const{
    return m_value_isSet;
}

bool OAIListTargetsFilter::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIListTargetsFilter::isSet() const {
...
bool OAIListTargetsFilter::isValid() const {
