...
/*
 * OAIDeleteTarget_request.h
 *
 * 
 */

#ifndef OAIDeleteTarget_request_H
#define OAIDeleteTarget_request_H
...
class OAIDeleteTarget_request : public OAIObject {
public:
    OAIDeleteTarget_request();
    OAIDeleteTarget_request(QString json);
    ~OAIDeleteTarget_request() override;
    ...
    bool isForceUnsubscribeAll() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTarget_request)

#endif // OAIDeleteTarget_request_H
