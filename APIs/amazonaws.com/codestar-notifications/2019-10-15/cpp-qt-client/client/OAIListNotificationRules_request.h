...
/*
 * OAIListNotificationRules_request.h
 *
 * 
 */

#ifndef OAIListNotificationRules_request_H
#define OAIListNotificationRules_request_H
...
namespace OpenAPI {
class OAIListNotificationRulesFilter;

class OAIListNotificationRules_request : public OAIObject {
public:
    OAIListNotificationRules_request();
    OAIListNotificationRules_request(QString json);
    ~OAIListNotificationRules_request() override;
    ...
    QList<OAIListNotificationRulesFilter> getFilters() const;
    void setFilters(const QList<OAIListNotificationRulesFilter> &filters);
...
private:
    ...
    QList<OAIListNotificationRulesFilter> m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNotificationRules_request)

#endif // OAIListNotificationRules_request_H
