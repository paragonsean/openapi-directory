...
OAISubscribe_request_Target::OAISubscribe_request_Target(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubscribe_request_Target::OAISubscribe_request_Target() {
    this->initializeModel();
}

OAISubscribe_request_Target::~OAISubscribe_request_Target() {}

void OAISubscribe_request_Target::initializeModel() {
...
void OAISubscribe_request_Target::fromJson(QString jsonString) {
...
void OAISubscribe_request_Target::fromJsonObject(QJsonObject json) {
...
QString OAISubscribe_request_Target::asJson() const {
...
QJsonObject OAISubscribe_request_Target::asJsonObject() const {
    QJsonObject obj;
...
QString OAISubscribe_request_Target::getTargetType() const {
    return m_target_type;
}
void OAISubscribe_request_Target::setTargetType(const QString &target_type) {
    m_target_type = target_type;
    m_target_type_isSet = true;
}

bool OAISubscribe_request_Target::is_target_type_Set() const{
    return m_target_type_isSet;
}

bool OAISubscribe_request_Target::is_target_type_Valid() const{
    return m_target_type_isValid;
}

QString OAISubscribe_request_Target::getTargetAddress() const {
    return m_target_address;
}
void OAISubscribe_request_Target::setTargetAddress(const QString &target_address) {
    m_target_address = target_address;
    m_target_address_isSet = true;
}

bool OAISubscribe_request_Target::is_target_address_Set() const{
    return m_target_address_isSet;
}

bool OAISubscribe_request_Target::is_target_address_Valid() const{
    return m_target_address_isValid;
}

bool OAISubscribe_request_Target::isSet() const {
...
bool OAISubscribe_request_Target::isValid() const {
