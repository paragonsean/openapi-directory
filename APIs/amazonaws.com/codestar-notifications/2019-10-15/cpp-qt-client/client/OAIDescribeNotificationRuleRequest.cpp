...
#include "OAIDescribeNotificationRuleRequest.h"
...
OAIDescribeNotificationRuleRequest::OAIDescribeNotificationRuleRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeNotificationRuleRequest::OAIDescribeNotificationRuleRequest() {
    this->initializeModel();
}

OAIDescribeNotificationRuleRequest::~OAIDescribeNotificationRuleRequest() {}

void OAIDescribeNotificationRuleRequest::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDescribeNotificationRuleRequest::fromJson(QString jsonString) {
...
void OAIDescribeNotificationRuleRequest::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIDescribeNotificationRuleRequest::asJson() const {
...
QJsonObject OAIDescribeNotificationRuleRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDescribeNotificationRuleRequest::getArn() const {
    return m_arn;
}
void OAIDescribeNotificationRuleRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeNotificationRuleRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeNotificationRuleRequest::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDescribeNotificationRuleRequest::isSet() const {
...
bool OAIDescribeNotificationRuleRequest::isValid() const {
