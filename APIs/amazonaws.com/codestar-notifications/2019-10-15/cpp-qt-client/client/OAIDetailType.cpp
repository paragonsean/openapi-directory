...
OAIDetailType::OAIDetailType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetailType::OAIDetailType() {
    this->initializeModel();
}

OAIDetailType::~OAIDetailType() {}

void OAIDetailType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDetailType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDetailType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("BASIC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDetailType::BASIC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FULL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDetailType::FULL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDetailType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDetailType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDetailType::BASIC:
            val = "BASIC";
            break;
        case eOAIDetailType::FULL:
            val = "FULL";
            break;
        default:
            break;
...
QJsonValue OAIDetailType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDetailType::eOAIDetailType OAIDetailType::getValue() const {
    return m_value;
}

void OAIDetailType::setValue(const OAIDetailType::eOAIDetailType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDetailType::isSet() const {
    
    return m_value_isSet;
}

bool OAIDetailType::isValid() const {
