...
/*
 * OAISubscribeResult.h
 *
 * 
 */

#ifndef OAISubscribeResult_H
#define OAISubscribeResult_H
...
class OAISubscribeResult : public OAIObject {
public:
    OAISubscribeResult();
    OAISubscribeResult(QString json);
    ~OAISubscribeResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscribeResult)

#endif // OAISubscribeResult_H
