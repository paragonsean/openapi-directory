...
/*
 * OAIListEventTypesFilterName.h
 *
 * 
 */

#ifndef OAIListEventTypesFilterName_H
#define OAIListEventTypesFilterName_H
...
class OAIListEventTypesFilterName : public OAIEnum {
public:
    OAIListEventTypesFilterName();
    OAIListEventTypesFilterName(QString json);
    ~OAIListEventTypesFilterName() override;
    ...
    enum class eOAIListEventTypesFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RESOURCE_TYPE, 
        SERVICE_NAME
    };
    OAIListEventTypesFilterName::eOAIListEventTypesFilterName getValue() const;
    void setValue(const OAIListEventTypesFilterName::eOAIListEventTypesFilterName& value);
...
private:
    ...
    eOAIListEventTypesFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventTypesFilterName)

#endif // OAIListEventTypesFilterName_H
