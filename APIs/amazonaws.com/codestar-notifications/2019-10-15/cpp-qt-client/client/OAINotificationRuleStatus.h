...
/*
 * OAINotificationRuleStatus.h
 *
 * 
 */

#ifndef OAINotificationRuleStatus_H
#define OAINotificationRuleStatus_H
...
class OAINotificationRuleStatus : public OAIEnum {
public:
    OAINotificationRuleStatus();
    OAINotificationRuleStatus(QString json);
    ~OAINotificationRuleStatus() override;
    ...
    enum class eOAINotificationRuleStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLED, 
        DISABLED
    };
    OAINotificationRuleStatus::eOAINotificationRuleStatus getValue() const;
    void setValue(const OAINotificationRuleStatus::eOAINotificationRuleStatus& value);
...
private:
    ...
    eOAINotificationRuleStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationRuleStatus)

#endif // OAINotificationRuleStatus_H
