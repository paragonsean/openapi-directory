...
OAICreateNotificationRuleResult::OAICreateNotificationRuleResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateNotificationRuleResult::OAICreateNotificationRuleResult() {
    this->initializeModel();
}

OAICreateNotificationRuleResult::~OAICreateNotificationRuleResult() {}

void OAICreateNotificationRuleResult::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAICreateNotificationRuleResult::fromJson(QString jsonString) {
...
void OAICreateNotificationRuleResult::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAICreateNotificationRuleResult::asJson() const {
...
QJsonObject OAICreateNotificationRuleResult::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateNotificationRuleResult::getArn() const {
    return m_arn;
}
void OAICreateNotificationRuleResult::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateNotificationRuleResult::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateNotificationRuleResult::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAICreateNotificationRuleResult::isSet() const {
...
bool OAICreateNotificationRuleResult::isValid() const {
