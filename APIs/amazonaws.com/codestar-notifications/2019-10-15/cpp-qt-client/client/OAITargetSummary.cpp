...
QString OAITargetSummary::getTargetAddress() const {
    return m_target_address;
}
void OAITargetSummary::setTargetAddress(const QString &target_address) {
    m_target_address = target_address;
    m_target_address_isSet = true;
}

bool OAITargetSummary::is_target_address_Set() const{
    return m_target_address_isSet;
}

bool OAITargetSummary::is_target_address_Valid() const{
    return m_target_address_isValid;
}

QString OAITargetSummary::getTargetType() const {
    return m_target_type;
}
void OAITargetSummary::setTargetType(const QString &target_type) {
    m_target_type = target_type;
    m_target_type_isSet = true;
}

bool OAITargetSummary::is_target_type_Set() const{
    return m_target_type_isSet;
}

bool OAITargetSummary::is_target_type_Valid() const{
    return m_target_type_isValid;
}

OAITargetStatus OAITargetSummary::getTargetStatus() const {
    return m_target_status;
}
void OAITargetSummary::setTargetStatus(const OAITargetStatus &target_status) {
    m_target_status = target_status;
    m_target_status_isSet = true;
}

bool OAITargetSummary::is_target_status_Set() const{
    return m_target_status_isSet;
}

bool OAITargetSummary::is_target_status_Valid() const{
