...
OAIListEventTypes_request::OAIListEventTypes_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListEventTypes_request::OAIListEventTypes_request() {
    this->initializeModel();
}

OAIListEventTypes_request::~OAIListEventTypes_request() {}

void OAIListEventTypes_request::initializeModel() {
...
void OAIListEventTypes_request::fromJson(QString jsonString) {
...
void OAIListEventTypes_request::fromJsonObject(QJsonObject json) {
...
QString OAIListEventTypes_request::asJson() const {
...
QJsonObject OAIListEventTypes_request::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.size() > 0) {
...
QList<OAIListEventTypesFilter> OAIListEventTypes_request::getFilters() const {
    return m_filters;
}
void OAIListEventTypes_request::setFilters(const QList<OAIListEventTypesFilter> &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListEventTypes_request::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListEventTypes_request::is_filters_Valid() const{
    return m_filters_isValid;
}

QString OAIListEventTypes_request::getNextToken() const {
    return m_next_token;
}
void OAIListEventTypes_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListEventTypes_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListEventTypes_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListEventTypes_request::getMaxResults() const {
    return m_max_results;
}
void OAIListEventTypes_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListEventTypes_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListEventTypes_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListEventTypes_request::isSet() const {
...
bool OAIListEventTypes_request::isValid() const {
