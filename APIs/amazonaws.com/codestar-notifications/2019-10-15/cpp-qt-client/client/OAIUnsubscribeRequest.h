...
/*
 * OAIUnsubscribeRequest.h
 *
 * 
 */

#ifndef OAIUnsubscribeRequest_H
#define OAIUnsubscribeRequest_H
...
class OAIUnsubscribeRequest : public OAIObject {
public:
    OAIUnsubscribeRequest();
    OAIUnsubscribeRequest(QString json);
    ~OAIUnsubscribeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsubscribeRequest)

#endif // OAIUnsubscribeRequest_H
