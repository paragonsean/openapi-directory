...
/*
 * OAIListTargetsFilterName.h
 *
 * 
 */

#ifndef OAIListTargetsFilterName_H
#define OAIListTargetsFilterName_H
...
class OAIListTargetsFilterName : public OAIEnum {
public:
    OAIListTargetsFilterName();
    OAIListTargetsFilterName(QString json);
    ~OAIListTargetsFilterName() override;
    ...
    enum class eOAIListTargetsFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TYPE, 
        ADDRESS, 
        STATUS
    };
    OAIListTargetsFilterName::eOAIListTargetsFilterName getValue() const;
    void setValue(const OAIListTargetsFilterName::eOAIListTargetsFilterName& value);
...
private:
    ...
    eOAIListTargetsFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTargetsFilterName)

#endif // OAIListTargetsFilterName_H
