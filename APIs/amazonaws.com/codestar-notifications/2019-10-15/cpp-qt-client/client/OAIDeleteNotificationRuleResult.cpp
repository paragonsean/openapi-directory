...
OAIDeleteNotificationRuleResult::OAIDeleteNotificationRuleResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteNotificationRuleResult::OAIDeleteNotificationRuleResult() {
    this->initializeModel();
}

OAIDeleteNotificationRuleResult::~OAIDeleteNotificationRuleResult() {}

void OAIDeleteNotificationRuleResult::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteNotificationRuleResult::fromJson(QString jsonString) {
...
void OAIDeleteNotificationRuleResult::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteNotificationRuleResult::asJson() const {
...
QJsonObject OAIDeleteNotificationRuleResult::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteNotificationRuleResult::getArn() const {
    return m_arn;
}
void OAIDeleteNotificationRuleResult::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteNotificationRuleResult::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteNotificationRuleResult::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteNotificationRuleResult::isSet() const {
...
bool OAIDeleteNotificationRuleResult::isValid() const {
