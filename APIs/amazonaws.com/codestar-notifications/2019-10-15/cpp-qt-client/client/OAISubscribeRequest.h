...
/*
 * OAISubscribeRequest.h
 *
 * 
 */

#ifndef OAISubscribeRequest_H
#define OAISubscribeRequest_H
...
class OAISubscribeRequest : public OAIObject {
public:
    OAISubscribeRequest();
    OAISubscribeRequest(QString json);
    ~OAISubscribeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscribeRequest)

#endif // OAISubscribeRequest_H
