...
/*
 * OAINotificationRuleSummary.h
 *
 * Information about a specified notification rule.
 */

#ifndef OAINotificationRuleSummary_H
#define OAINotificationRuleSummary_H
...
class OAINotificationRuleSummary : public OAIObject {
public:
    OAINotificationRuleSummary();
    OAINotificationRuleSummary(QString json);
    ~OAINotificationRuleSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationRuleSummary)

#endif // OAINotificationRuleSummary_H
