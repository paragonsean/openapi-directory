...
/*
 * OAIListEventTypesFilter.h
 *
 * Information about a filter to apply to the list of returned event types. You can filter by resource type or service name.
 */

#ifndef OAIListEventTypesFilter_H
#define OAIListEventTypesFilter_H
...
class OAIListEventTypesFilter : public OAIObject {
public:
    OAIListEventTypesFilter();
    OAIListEventTypesFilter(QString json);
    ~OAIListEventTypesFilter() override;
    ...
    OAIListEventTypesFilterName getName() const;
    void setName(const OAIListEventTypesFilterName &name);
...
private:
    ...
    OAIListEventTypesFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventTypesFilter)

#endif // OAIListEventTypesFilter_H
