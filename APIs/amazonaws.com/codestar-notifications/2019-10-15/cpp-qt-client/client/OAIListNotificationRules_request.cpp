...
OAIListNotificationRules_request::OAIListNotificationRules_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListNotificationRules_request::OAIListNotificationRules_request() {
    this->initializeModel();
}

OAIListNotificationRules_request::~OAIListNotificationRules_request() {}

void OAIListNotificationRules_request::initializeModel() {
...
void OAIListNotificationRules_request::fromJson(QString jsonString) {
...
void OAIListNotificationRules_request::fromJsonObject(QJsonObject json) {
...
QString OAIListNotificationRules_request::asJson() const {
...
QJsonObject OAIListNotificationRules_request::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.size() > 0) {
...
QList<OAIListNotificationRulesFilter> OAIListNotificationRules_request::getFilters() const {
    return m_filters;
}
void OAIListNotificationRules_request::setFilters(const QList<OAIListNotificationRulesFilter> &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListNotificationRules_request::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListNotificationRules_request::is_filters_Valid() const{
    return m_filters_isValid;
}

QString OAIListNotificationRules_request::getNextToken() const {
    return m_next_token;
}
void OAIListNotificationRules_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListNotificationRules_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListNotificationRules_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListNotificationRules_request::getMaxResults() const {
    return m_max_results;
}
void OAIListNotificationRules_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListNotificationRules_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListNotificationRules_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListNotificationRules_request::isSet() const {
...
bool OAIListNotificationRules_request::isValid() const {
