...
public:
    ...
    QList<OAIListTargetsFilter> getFilters() const;
    void setFilters(const QList<OAIListTargetsFilter> &filters);
...
private:
    ...
    QList<OAIListTargetsFilter> m_filters;
