...
class SerializerOrcSerDe(Model):
    ...
    def __init__(self, stripe_size_bytes: int=None, block_size_bytes: int=None, row_index_stride: int=None, enable_padding: bool=None, padding_tolerance: float=None, compression: OrcCompression=None, bloom_filter_columns: List=None, bloom_filter_false_positive_probability: float=None, dictionary_key_threshold: float=None, format_version: OrcFormatVersion=None):
        """SerializerOrcSerDe - a model defined in OpenAPI

        :param stripe_size_bytes: The stripe_size_bytes of this SerializerOrcSerDe.
        :param block_size_bytes: The block_size_bytes of this SerializerOrcSerDe.
        :param row_index_stride: The row_index_stride of this SerializerOrcSerDe.
        :param enable_padding: The enable_padding of this SerializerOrcSerDe.
        :param padding_tolerance: The padding_tolerance of this SerializerOrcSerDe.
        :param compression: The compression of this SerializerOrcSerDe.
        :param bloom_filter_columns: The bloom_filter_columns of this SerializerOrcSerDe.
        :param bloom_filter_false_positive_probability: The bloom_filter_false_positive_probability of this SerializerOrcSerDe.
        :param dictionary_key_threshold: The dictionary_key_threshold of this SerializerOrcSerDe.
        :param format_version: The format_version of this SerializerOrcSerDe.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SerializerOrcSerDe':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Serializer_OrcSerDe of this SerializerOrcSerDe.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def stripe_size_bytes(self):
        """Gets the stripe_size_bytes of this SerializerOrcSerDe.


        :return: The stripe_size_bytes of this SerializerOrcSerDe.
        :rtype: int
        """
    ...
    def stripe_size_bytes(self, stripe_size_bytes):
        """Sets the stripe_size_bytes of this SerializerOrcSerDe.
    ...
    def block_size_bytes(self):
        """Gets the block_size_bytes of this SerializerOrcSerDe.


        :return: The block_size_bytes of this SerializerOrcSerDe.
        :rtype: int
        """
    ...
    def block_size_bytes(self, block_size_bytes):
        """Sets the block_size_bytes of this SerializerOrcSerDe.
    ...
    def row_index_stride(self):
        """Gets the row_index_stride of this SerializerOrcSerDe.


        :return: The row_index_stride of this SerializerOrcSerDe.
        :rtype: int
        """
    ...
    def row_index_stride(self, row_index_stride):
        """Sets the row_index_stride of this SerializerOrcSerDe.
    ...
    def enable_padding(self):
        """Gets the enable_padding of this SerializerOrcSerDe.


        :return: The enable_padding of this SerializerOrcSerDe.
        :rtype: bool
        """
    ...
    def enable_padding(self, enable_padding):
        """Sets the enable_padding of this SerializerOrcSerDe.
    ...
    def padding_tolerance(self):
        """Gets the padding_tolerance of this SerializerOrcSerDe.


        :return: The padding_tolerance of this SerializerOrcSerDe.
        :rtype: float
        """
    ...
    def padding_tolerance(self, padding_tolerance):
        """Sets the padding_tolerance of this SerializerOrcSerDe.
    ...
    def compression(self):
        """Gets the compression of this SerializerOrcSerDe.


        :return: The compression of this SerializerOrcSerDe.
    ...
    def compression(self, compression):
        """Sets the compression of this SerializerOrcSerDe.
    ...
    def bloom_filter_columns(self):
        """Gets the bloom_filter_columns of this SerializerOrcSerDe.


        :return: The bloom_filter_columns of this SerializerOrcSerDe.
        :rtype: List
        """
    ...
    def bloom_filter_columns(self, bloom_filter_columns):
        """Sets the bloom_filter_columns of this SerializerOrcSerDe.
    ...
    def bloom_filter_false_positive_probability(self):
        """Gets the bloom_filter_false_positive_probability of this SerializerOrcSerDe.


        :return: The bloom_filter_false_positive_probability of this SerializerOrcSerDe.
        :rtype: float
        """
    ...
    def bloom_filter_false_positive_probability(self, bloom_filter_false_positive_probability):
        """Sets the bloom_filter_false_positive_probability of this SerializerOrcSerDe.
    ...
    def dictionary_key_threshold(self):
        """Gets the dictionary_key_threshold of this SerializerOrcSerDe.


        :return: The dictionary_key_threshold of this SerializerOrcSerDe.
        :rtype: float
        """
    ...
    def dictionary_key_threshold(self, dictionary_key_threshold):
        """Sets the dictionary_key_threshold of this SerializerOrcSerDe.
    ...
    def format_version(self):
        """Gets the format_version of this SerializerOrcSerDe.


        :return: The format_version of this SerializerOrcSerDe.
    ...
    def format_version(self, format_version):
        """Sets the format_version of this SerializerOrcSerDe.
