...
public class SplunkDestinationUpdateS3Update {
  ...
  public SplunkDestinationUpdateS3Update() {
  }

  public SplunkDestinationUpdateS3Update roleARN(String roleARN) {
  ...
  public SplunkDestinationUpdateS3Update bucketARN(String bucketARN) {
  ...
  public SplunkDestinationUpdateS3Update prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public SplunkDestinationUpdateS3Update errorOutputPrefix(String errorOutputPrefix) {
  ...
  public SplunkDestinationUpdateS3Update bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public SplunkDestinationUpdateS3Update compressionFormat(CompressionFormat compressionFormat) {
  ...
  public SplunkDestinationUpdateS3Update encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public SplunkDestinationUpdateS3Update cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    SplunkDestinationUpdateS3Update splunkDestinationUpdateS3Update = (SplunkDestinationUpdateS3Update) o;
    return Objects.equals(this.roleARN, splunkDestinationUpdateS3Update.roleARN) &&
        Objects.equals(this.bucketARN, splunkDestinationUpdateS3Update.bucketARN) &&
        Objects.equals(this.prefix, splunkDestinationUpdateS3Update.prefix) &&
        Objects.equals(this.errorOutputPrefix, splunkDestinationUpdateS3Update.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, splunkDestinationUpdateS3Update.bufferingHints) &&
        Objects.equals(this.compressionFormat, splunkDestinationUpdateS3Update.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, splunkDestinationUpdateS3Update.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, splunkDestinationUpdateS3Update.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class SplunkDestinationUpdateS3Update {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SplunkDestinationUpdateS3Update
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SplunkDestinationUpdateS3Update.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SplunkDestinationUpdateS3Update is not found in the empty JSON string", SplunkDestinationUpdateS3Update.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SplunkDestinationUpdateS3Update.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SplunkDestinationUpdateS3Update` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SplunkDestinationUpdateS3Update.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SplunkDestinationUpdateS3Update' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SplunkDestinationUpdateS3Update> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SplunkDestinationUpdateS3Update.class));

       return (TypeAdapter<T>) new TypeAdapter<SplunkDestinationUpdateS3Update>() {
           @Override
           public void write(JsonWriter out, SplunkDestinationUpdateS3Update value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SplunkDestinationUpdateS3Update read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SplunkDestinationUpdateS3Update given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SplunkDestinationUpdateS3Update
   * @throws IOException if the JSON string is invalid with respect to SplunkDestinationUpdateS3Update
   */
  public static SplunkDestinationUpdateS3Update fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SplunkDestinationUpdateS3Update.class);
  }

  /**
   * Convert an instance of SplunkDestinationUpdateS3Update to an JSON string
   *
   * @return JSON string
   */
