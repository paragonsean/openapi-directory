...
public class DestinationDescriptionAmazonopensearchserviceDestinationDescription {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription() {
  }

  public DestinationDescriptionAmazonopensearchserviceDestinationDescription roleARN(String roleARN) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription domainARN(String domainARN) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription clusterEndpoint(String clusterEndpoint) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription indexName(String indexName) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription typeName(String typeName) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription indexRotationPeriod(AmazonopensearchserviceIndexRotationPeriod indexRotationPeriod) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription bufferingHints(AmazonopensearchserviceDestinationDescriptionBufferingHints bufferingHints) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription retryOptions(AmazonopensearchserviceDestinationDescriptionRetryOptions retryOptions) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription s3BackupMode(AmazonopensearchserviceS3BackupMode s3BackupMode) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription s3DestinationDescription(S3DestinationDescription s3DestinationDescription) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription processingConfiguration(ProcessingConfiguration processingConfiguration) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription cloudWatchLoggingOptions(CloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public DestinationDescriptionAmazonopensearchserviceDestinationDescription vpcConfigurationDescription(VpcConfigurationDescription vpcConfigurationDescription) {
  ...
  public boolean equals(Object o) {
    ...
    DestinationDescriptionAmazonopensearchserviceDestinationDescription destinationDescriptionAmazonopensearchserviceDestinationDescription = (DestinationDescriptionAmazonopensearchserviceDestinationDescription) o;
    return Objects.equals(this.roleARN, destinationDescriptionAmazonopensearchserviceDestinationDescription.roleARN) &&
        Objects.equals(this.domainARN, destinationDescriptionAmazonopensearchserviceDestinationDescription.domainARN) &&
        Objects.equals(this.clusterEndpoint, destinationDescriptionAmazonopensearchserviceDestinationDescription.clusterEndpoint) &&
        Objects.equals(this.indexName, destinationDescriptionAmazonopensearchserviceDestinationDescription.indexName) &&
        Objects.equals(this.typeName, destinationDescriptionAmazonopensearchserviceDestinationDescription.typeName) &&
        Objects.equals(this.indexRotationPeriod, destinationDescriptionAmazonopensearchserviceDestinationDescription.indexRotationPeriod) &&
        Objects.equals(this.bufferingHints, destinationDescriptionAmazonopensearchserviceDestinationDescription.bufferingHints) &&
        Objects.equals(this.retryOptions, destinationDescriptionAmazonopensearchserviceDestinationDescription.retryOptions) &&
        Objects.equals(this.s3BackupMode, destinationDescriptionAmazonopensearchserviceDestinationDescription.s3BackupMode) &&
        Objects.equals(this.s3DestinationDescription, destinationDescriptionAmazonopensearchserviceDestinationDescription.s3DestinationDescription) &&
        Objects.equals(this.processingConfiguration, destinationDescriptionAmazonopensearchserviceDestinationDescription.processingConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, destinationDescriptionAmazonopensearchserviceDestinationDescription.cloudWatchLoggingOptions) &&
        Objects.equals(this.vpcConfigurationDescription, destinationDescriptionAmazonopensearchserviceDestinationDescription.vpcConfigurationDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class DestinationDescriptionAmazonopensearchserviceDestinationDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinationDescriptionAmazonopensearchserviceDestinationDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinationDescriptionAmazonopensearchserviceDestinationDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationDescriptionAmazonopensearchserviceDestinationDescription is not found in the empty JSON string", DestinationDescriptionAmazonopensearchserviceDestinationDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinationDescriptionAmazonopensearchserviceDestinationDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationDescriptionAmazonopensearchserviceDestinationDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinationDescriptionAmazonopensearchserviceDestinationDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinationDescriptionAmazonopensearchserviceDestinationDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinationDescriptionAmazonopensearchserviceDestinationDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinationDescriptionAmazonopensearchserviceDestinationDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinationDescriptionAmazonopensearchserviceDestinationDescription>() {
           @Override
           public void write(JsonWriter out, DestinationDescriptionAmazonopensearchserviceDestinationDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinationDescriptionAmazonopensearchserviceDestinationDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinationDescriptionAmazonopensearchserviceDestinationDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinationDescriptionAmazonopensearchserviceDestinationDescription
   * @throws IOException if the JSON string is invalid with respect to DestinationDescriptionAmazonopensearchserviceDestinationDescription
   */
  public static DestinationDescriptionAmazonopensearchserviceDestinationDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinationDescriptionAmazonopensearchserviceDestinationDescription.class);
  }

  /**
   * Convert an instance of DestinationDescriptionAmazonopensearchserviceDestinationDescription to an JSON string
   *
   * @return JSON string
   */
