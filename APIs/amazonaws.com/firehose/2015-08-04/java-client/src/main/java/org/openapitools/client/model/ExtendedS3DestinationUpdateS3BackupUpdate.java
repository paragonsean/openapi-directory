...
public class ExtendedS3DestinationUpdateS3BackupUpdate {
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate() {
  }

  public ExtendedS3DestinationUpdateS3BackupUpdate roleARN(String roleARN) {
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate bucketARN(String bucketARN) {
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate errorOutputPrefix(String errorOutputPrefix) {
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate compressionFormat(CompressionFormat compressionFormat) {
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public ExtendedS3DestinationUpdateS3BackupUpdate cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    ExtendedS3DestinationUpdateS3BackupUpdate extendedS3DestinationUpdateS3BackupUpdate = (ExtendedS3DestinationUpdateS3BackupUpdate) o;
    return Objects.equals(this.roleARN, extendedS3DestinationUpdateS3BackupUpdate.roleARN) &&
        Objects.equals(this.bucketARN, extendedS3DestinationUpdateS3BackupUpdate.bucketARN) &&
        Objects.equals(this.prefix, extendedS3DestinationUpdateS3BackupUpdate.prefix) &&
        Objects.equals(this.errorOutputPrefix, extendedS3DestinationUpdateS3BackupUpdate.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, extendedS3DestinationUpdateS3BackupUpdate.bufferingHints) &&
        Objects.equals(this.compressionFormat, extendedS3DestinationUpdateS3BackupUpdate.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, extendedS3DestinationUpdateS3BackupUpdate.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, extendedS3DestinationUpdateS3BackupUpdate.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtendedS3DestinationUpdateS3BackupUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExtendedS3DestinationUpdateS3BackupUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtendedS3DestinationUpdateS3BackupUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExtendedS3DestinationUpdateS3BackupUpdate is not found in the empty JSON string", ExtendedS3DestinationUpdateS3BackupUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtendedS3DestinationUpdateS3BackupUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExtendedS3DestinationUpdateS3BackupUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtendedS3DestinationUpdateS3BackupUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtendedS3DestinationUpdateS3BackupUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtendedS3DestinationUpdateS3BackupUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtendedS3DestinationUpdateS3BackupUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtendedS3DestinationUpdateS3BackupUpdate>() {
           @Override
           public void write(JsonWriter out, ExtendedS3DestinationUpdateS3BackupUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExtendedS3DestinationUpdateS3BackupUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExtendedS3DestinationUpdateS3BackupUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtendedS3DestinationUpdateS3BackupUpdate
   * @throws IOException if the JSON string is invalid with respect to ExtendedS3DestinationUpdateS3BackupUpdate
   */
  public static ExtendedS3DestinationUpdateS3BackupUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtendedS3DestinationUpdateS3BackupUpdate.class);
  }

  /**
   * Convert an instance of ExtendedS3DestinationUpdateS3BackupUpdate to an JSON string
   *
   * @return JSON string
   */
