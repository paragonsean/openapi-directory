...
public class ElasticsearchDestinationUpdateS3Update {
  ...
  public ElasticsearchDestinationUpdateS3Update() {
  }

  public ElasticsearchDestinationUpdateS3Update roleARN(String roleARN) {
  ...
  public ElasticsearchDestinationUpdateS3Update bucketARN(String bucketARN) {
  ...
  public ElasticsearchDestinationUpdateS3Update prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public ElasticsearchDestinationUpdateS3Update errorOutputPrefix(String errorOutputPrefix) {
  ...
  public ElasticsearchDestinationUpdateS3Update bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public ElasticsearchDestinationUpdateS3Update compressionFormat(CompressionFormat compressionFormat) {
  ...
  public ElasticsearchDestinationUpdateS3Update encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public ElasticsearchDestinationUpdateS3Update cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    ElasticsearchDestinationUpdateS3Update elasticsearchDestinationUpdateS3Update = (ElasticsearchDestinationUpdateS3Update) o;
    return Objects.equals(this.roleARN, elasticsearchDestinationUpdateS3Update.roleARN) &&
        Objects.equals(this.bucketARN, elasticsearchDestinationUpdateS3Update.bucketARN) &&
        Objects.equals(this.prefix, elasticsearchDestinationUpdateS3Update.prefix) &&
        Objects.equals(this.errorOutputPrefix, elasticsearchDestinationUpdateS3Update.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, elasticsearchDestinationUpdateS3Update.bufferingHints) &&
        Objects.equals(this.compressionFormat, elasticsearchDestinationUpdateS3Update.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, elasticsearchDestinationUpdateS3Update.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, elasticsearchDestinationUpdateS3Update.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class ElasticsearchDestinationUpdateS3Update {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ElasticsearchDestinationUpdateS3Update
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ElasticsearchDestinationUpdateS3Update.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ElasticsearchDestinationUpdateS3Update is not found in the empty JSON string", ElasticsearchDestinationUpdateS3Update.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ElasticsearchDestinationUpdateS3Update.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ElasticsearchDestinationUpdateS3Update` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ElasticsearchDestinationUpdateS3Update.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ElasticsearchDestinationUpdateS3Update' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ElasticsearchDestinationUpdateS3Update> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ElasticsearchDestinationUpdateS3Update.class));

       return (TypeAdapter<T>) new TypeAdapter<ElasticsearchDestinationUpdateS3Update>() {
           @Override
           public void write(JsonWriter out, ElasticsearchDestinationUpdateS3Update value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ElasticsearchDestinationUpdateS3Update read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ElasticsearchDestinationUpdateS3Update given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ElasticsearchDestinationUpdateS3Update
   * @throws IOException if the JSON string is invalid with respect to ElasticsearchDestinationUpdateS3Update
   */
  public static ElasticsearchDestinationUpdateS3Update fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ElasticsearchDestinationUpdateS3Update.class);
  }

  /**
   * Convert an instance of ElasticsearchDestinationUpdateS3Update to an JSON string
   *
   * @return JSON string
   */
