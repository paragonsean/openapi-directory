...
public class OrcSerDe {
  ...
  public OrcSerDe stripeSizeBytes(Integer stripeSizeBytes) {
  ...
  public OrcSerDe blockSizeBytes(Integer blockSizeBytes) {
  ...
  public OrcSerDe rowIndexStride(Integer rowIndexStride) {
  ...
  public OrcSerDe enablePadding(Boolean enablePadding) {
  ...
  public OrcSerDe paddingTolerance(Double paddingTolerance) {
  ...
  public OrcSerDe compression(OrcCompression compression) {
  ...
  public OrcSerDe bloomFilterColumns(List bloomFilterColumns) {
  ...
  public OrcSerDe bloomFilterFalsePositiveProbability(Double bloomFilterFalsePositiveProbability) {
  ...
  public OrcSerDe dictionaryKeyThreshold(Double dictionaryKeyThreshold) {
  ...
  public OrcSerDe formatVersion(OrcFormatVersion formatVersion) {
  ...
  public boolean equals(Object o) {
    ...
    OrcSerDe orcSerDe = (OrcSerDe) o;
    return Objects.equals(this.stripeSizeBytes, orcSerDe.stripeSizeBytes) &&
        Objects.equals(this.blockSizeBytes, orcSerDe.blockSizeBytes) &&
        Objects.equals(this.rowIndexStride, orcSerDe.rowIndexStride) &&
        Objects.equals(this.enablePadding, orcSerDe.enablePadding) &&
        Objects.equals(this.paddingTolerance, orcSerDe.paddingTolerance) &&
        Objects.equals(this.compression, orcSerDe.compression) &&
        Objects.equals(this.bloomFilterColumns, orcSerDe.bloomFilterColumns) &&
        Objects.equals(this.bloomFilterFalsePositiveProbability, orcSerDe.bloomFilterFalsePositiveProbability) &&
        Objects.equals(this.dictionaryKeyThreshold, orcSerDe.dictionaryKeyThreshold) &&
        Objects.equals(this.formatVersion, orcSerDe.formatVersion);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrcSerDe
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrcSerDe.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrcSerDe is not found in the empty JSON string", OrcSerDe.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrcSerDe.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrcSerDe` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrcSerDe.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrcSerDe' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrcSerDe> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrcSerDe.class));

       return (TypeAdapter<T>) new TypeAdapter<OrcSerDe>() {
           @Override
           public void write(JsonWriter out, OrcSerDe value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrcSerDe read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrcSerDe given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrcSerDe
   * @throws IOException if the JSON string is invalid with respect to OrcSerDe
   */
  public static OrcSerDe fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrcSerDe.class);
  }

  /**
   * Convert an instance of OrcSerDe to an JSON string
   *
   * @return JSON string
   */
