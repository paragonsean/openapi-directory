...
public class SplunkDestinationDescription {
  ...
  public SplunkDestinationDescription heCEndpoint(String heCEndpoint) {
  ...
  public SplunkDestinationDescription heCEndpointType(HECEndpointType heCEndpointType) {
  ...
  public SplunkDestinationDescription heCToken(String heCToken) {
  ...
  public SplunkDestinationDescription heCAcknowledgmentTimeoutInSeconds(Integer heCAcknowledgmentTimeoutInSeconds) {
  ...
  public SplunkDestinationDescription retryOptions(SplunkDestinationDescriptionRetryOptions retryOptions) {
  ...
  public SplunkDestinationDescription s3BackupMode(SplunkS3BackupMode s3BackupMode) {
  ...
  public SplunkDestinationDescription s3DestinationDescription(SplunkDestinationDescriptionS3DestinationDescription s3DestinationDescription) {
  ...
  public SplunkDestinationDescription processingConfiguration(ExtendedS3DestinationConfigurationProcessingConfiguration processingConfiguration) {
  ...
  public SplunkDestinationDescription cloudWatchLoggingOptions(S3DestinationDescriptionCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    SplunkDestinationDescription splunkDestinationDescription = (SplunkDestinationDescription) o;
    return Objects.equals(this.heCEndpoint, splunkDestinationDescription.heCEndpoint) &&
        Objects.equals(this.heCEndpointType, splunkDestinationDescription.heCEndpointType) &&
        Objects.equals(this.heCToken, splunkDestinationDescription.heCToken) &&
        Objects.equals(this.heCAcknowledgmentTimeoutInSeconds, splunkDestinationDescription.heCAcknowledgmentTimeoutInSeconds) &&
        Objects.equals(this.retryOptions, splunkDestinationDescription.retryOptions) &&
        Objects.equals(this.s3BackupMode, splunkDestinationDescription.s3BackupMode) &&
        Objects.equals(this.s3DestinationDescription, splunkDestinationDescription.s3DestinationDescription) &&
        Objects.equals(this.processingConfiguration, splunkDestinationDescription.processingConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, splunkDestinationDescription.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class SplunkDestinationDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SplunkDestinationDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SplunkDestinationDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SplunkDestinationDescription is not found in the empty JSON string", SplunkDestinationDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SplunkDestinationDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SplunkDestinationDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SplunkDestinationDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SplunkDestinationDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SplunkDestinationDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SplunkDestinationDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<SplunkDestinationDescription>() {
           @Override
           public void write(JsonWriter out, SplunkDestinationDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SplunkDestinationDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SplunkDestinationDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SplunkDestinationDescription
   * @throws IOException if the JSON string is invalid with respect to SplunkDestinationDescription
   */
  public static SplunkDestinationDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SplunkDestinationDescription.class);
  }

  /**
   * Convert an instance of SplunkDestinationDescription to an JSON string
   *
   * @return JSON string
   */
