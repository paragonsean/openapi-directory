...
public class S3DestinationUpdate {
  ...
  public S3DestinationUpdate roleARN(String roleARN) {
  ...
  public S3DestinationUpdate bucketARN(String bucketARN) {
  ...
  public S3DestinationUpdate prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public S3DestinationUpdate errorOutputPrefix(String errorOutputPrefix) {
  ...
  public S3DestinationUpdate bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public S3DestinationUpdate compressionFormat(CompressionFormat compressionFormat) {
  ...
  public S3DestinationUpdate encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public S3DestinationUpdate cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    S3DestinationUpdate s3DestinationUpdate = (S3DestinationUpdate) o;
    return Objects.equals(this.roleARN, s3DestinationUpdate.roleARN) &&
        Objects.equals(this.bucketARN, s3DestinationUpdate.bucketARN) &&
        Objects.equals(this.prefix, s3DestinationUpdate.prefix) &&
        Objects.equals(this.errorOutputPrefix, s3DestinationUpdate.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, s3DestinationUpdate.bufferingHints) &&
        Objects.equals(this.compressionFormat, s3DestinationUpdate.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, s3DestinationUpdate.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, s3DestinationUpdate.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3DestinationUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3DestinationUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3DestinationUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3DestinationUpdate is not found in the empty JSON string", S3DestinationUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3DestinationUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3DestinationUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3DestinationUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3DestinationUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3DestinationUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3DestinationUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<S3DestinationUpdate>() {
           @Override
           public void write(JsonWriter out, S3DestinationUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3DestinationUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3DestinationUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3DestinationUpdate
   * @throws IOException if the JSON string is invalid with respect to S3DestinationUpdate
   */
  public static S3DestinationUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3DestinationUpdate.class);
  }

  /**
   * Convert an instance of S3DestinationUpdate to an JSON string
   *
   * @return JSON string
   */
