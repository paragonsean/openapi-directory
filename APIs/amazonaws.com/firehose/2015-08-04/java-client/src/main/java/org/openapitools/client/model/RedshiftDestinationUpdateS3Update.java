...
public class RedshiftDestinationUpdateS3Update {
  ...
  public RedshiftDestinationUpdateS3Update() {
  }

  public RedshiftDestinationUpdateS3Update roleARN(String roleARN) {
  ...
  public RedshiftDestinationUpdateS3Update bucketARN(String bucketARN) {
  ...
  public RedshiftDestinationUpdateS3Update prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public RedshiftDestinationUpdateS3Update errorOutputPrefix(String errorOutputPrefix) {
  ...
  public RedshiftDestinationUpdateS3Update bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public RedshiftDestinationUpdateS3Update compressionFormat(CompressionFormat compressionFormat) {
  ...
  public RedshiftDestinationUpdateS3Update encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public RedshiftDestinationUpdateS3Update cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    RedshiftDestinationUpdateS3Update redshiftDestinationUpdateS3Update = (RedshiftDestinationUpdateS3Update) o;
    return Objects.equals(this.roleARN, redshiftDestinationUpdateS3Update.roleARN) &&
        Objects.equals(this.bucketARN, redshiftDestinationUpdateS3Update.bucketARN) &&
        Objects.equals(this.prefix, redshiftDestinationUpdateS3Update.prefix) &&
        Objects.equals(this.errorOutputPrefix, redshiftDestinationUpdateS3Update.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, redshiftDestinationUpdateS3Update.bufferingHints) &&
        Objects.equals(this.compressionFormat, redshiftDestinationUpdateS3Update.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, redshiftDestinationUpdateS3Update.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, redshiftDestinationUpdateS3Update.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedshiftDestinationUpdateS3Update {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RedshiftDestinationUpdateS3Update
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedshiftDestinationUpdateS3Update.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedshiftDestinationUpdateS3Update is not found in the empty JSON string", RedshiftDestinationUpdateS3Update.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedshiftDestinationUpdateS3Update.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedshiftDestinationUpdateS3Update` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedshiftDestinationUpdateS3Update.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedshiftDestinationUpdateS3Update' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedshiftDestinationUpdateS3Update> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedshiftDestinationUpdateS3Update.class));

       return (TypeAdapter<T>) new TypeAdapter<RedshiftDestinationUpdateS3Update>() {
           @Override
           public void write(JsonWriter out, RedshiftDestinationUpdateS3Update value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RedshiftDestinationUpdateS3Update read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RedshiftDestinationUpdateS3Update given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RedshiftDestinationUpdateS3Update
   * @throws IOException if the JSON string is invalid with respect to RedshiftDestinationUpdateS3Update
   */
  public static RedshiftDestinationUpdateS3Update fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedshiftDestinationUpdateS3Update.class);
  }

  /**
   * Convert an instance of RedshiftDestinationUpdateS3Update to an JSON string
   *
   * @return JSON string
   */
