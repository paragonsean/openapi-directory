...
public class UpdateDestinationInputS3DestinationUpdate {
  ...
  public UpdateDestinationInputS3DestinationUpdate roleARN(String roleARN) {
  ...
  public UpdateDestinationInputS3DestinationUpdate bucketARN(String bucketARN) {
  ...
  public UpdateDestinationInputS3DestinationUpdate prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public UpdateDestinationInputS3DestinationUpdate errorOutputPrefix(String errorOutputPrefix) {
  ...
  public UpdateDestinationInputS3DestinationUpdate bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public UpdateDestinationInputS3DestinationUpdate compressionFormat(CompressionFormat compressionFormat) {
  ...
  public UpdateDestinationInputS3DestinationUpdate encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public UpdateDestinationInputS3DestinationUpdate cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDestinationInputS3DestinationUpdate updateDestinationInputS3DestinationUpdate = (UpdateDestinationInputS3DestinationUpdate) o;
    return Objects.equals(this.roleARN, updateDestinationInputS3DestinationUpdate.roleARN) &&
        Objects.equals(this.bucketARN, updateDestinationInputS3DestinationUpdate.bucketARN) &&
        Objects.equals(this.prefix, updateDestinationInputS3DestinationUpdate.prefix) &&
        Objects.equals(this.errorOutputPrefix, updateDestinationInputS3DestinationUpdate.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, updateDestinationInputS3DestinationUpdate.bufferingHints) &&
        Objects.equals(this.compressionFormat, updateDestinationInputS3DestinationUpdate.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, updateDestinationInputS3DestinationUpdate.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, updateDestinationInputS3DestinationUpdate.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDestinationInputS3DestinationUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDestinationInputS3DestinationUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDestinationInputS3DestinationUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDestinationInputS3DestinationUpdate is not found in the empty JSON string", UpdateDestinationInputS3DestinationUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDestinationInputS3DestinationUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDestinationInputS3DestinationUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDestinationInputS3DestinationUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDestinationInputS3DestinationUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDestinationInputS3DestinationUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDestinationInputS3DestinationUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDestinationInputS3DestinationUpdate>() {
           @Override
           public void write(JsonWriter out, UpdateDestinationInputS3DestinationUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDestinationInputS3DestinationUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDestinationInputS3DestinationUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDestinationInputS3DestinationUpdate
   * @throws IOException if the JSON string is invalid with respect to UpdateDestinationInputS3DestinationUpdate
   */
  public static UpdateDestinationInputS3DestinationUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDestinationInputS3DestinationUpdate.class);
  }

  /**
   * Convert an instance of UpdateDestinationInputS3DestinationUpdate to an JSON string
   *
   * @return JSON string
   */
