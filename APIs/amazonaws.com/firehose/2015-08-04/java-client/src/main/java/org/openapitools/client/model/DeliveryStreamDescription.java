...
public class DeliveryStreamDescription {
  ...
  public DeliveryStreamDescription deliveryStreamName(String deliveryStreamName) {
  ...
  public DeliveryStreamDescription deliveryStreamARN(String deliveryStreamARN) {
  ...
  public DeliveryStreamDescription deliveryStreamStatus(DeliveryStreamStatus deliveryStreamStatus) {
  ...
  public DeliveryStreamDescription failureDescription(DeliveryStreamEncryptionConfigurationFailureDescription failureDescription) {
  ...
  public DeliveryStreamDescription deliveryStreamEncryptionConfiguration(DeliveryStreamDescriptionDeliveryStreamEncryptionConfiguration deliveryStreamEncryptionConfiguration) {
  ...
  public DeliveryStreamDescription deliveryStreamType(DeliveryStreamType deliveryStreamType) {
  ...
  public DeliveryStreamDescription versionId(String versionId) {
  ...
  public DeliveryStreamDescription createTimestamp(OffsetDateTime createTimestamp) {
  ...
  public DeliveryStreamDescription lastUpdateTimestamp(OffsetDateTime lastUpdateTimestamp) {
  ...
  public DeliveryStreamDescription source(DeliveryStreamDescriptionSource source) {
    this.source = source;
    return this;
  }
  ...
  public DeliveryStreamDescription destinations(List destinations) {
  ...
  public DeliveryStreamDescription hasMoreDestinations(Boolean hasMoreDestinations) {
  ...
  public boolean equals(Object o) {
    ...
    DeliveryStreamDescription deliveryStreamDescription = (DeliveryStreamDescription) o;
    return Objects.equals(this.deliveryStreamName, deliveryStreamDescription.deliveryStreamName) &&
        Objects.equals(this.deliveryStreamARN, deliveryStreamDescription.deliveryStreamARN) &&
        Objects.equals(this.deliveryStreamStatus, deliveryStreamDescription.deliveryStreamStatus) &&
        Objects.equals(this.failureDescription, deliveryStreamDescription.failureDescription) &&
        Objects.equals(this.deliveryStreamEncryptionConfiguration, deliveryStreamDescription.deliveryStreamEncryptionConfiguration) &&
        Objects.equals(this.deliveryStreamType, deliveryStreamDescription.deliveryStreamType) &&
        Objects.equals(this.versionId, deliveryStreamDescription.versionId) &&
        Objects.equals(this.createTimestamp, deliveryStreamDescription.createTimestamp) &&
        Objects.equals(this.lastUpdateTimestamp, deliveryStreamDescription.lastUpdateTimestamp) &&
        Objects.equals(this.source, deliveryStreamDescription.source) &&
        Objects.equals(this.destinations, deliveryStreamDescription.destinations) &&
        Objects.equals(this.hasMoreDestinations, deliveryStreamDescription.hasMoreDestinations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeliveryStreamDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeliveryStreamDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeliveryStreamDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeliveryStreamDescription is not found in the empty JSON string", DeliveryStreamDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeliveryStreamDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeliveryStreamDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeliveryStreamDescription.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeliveryStreamDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeliveryStreamDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeliveryStreamDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeliveryStreamDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DeliveryStreamDescription>() {
           @Override
           public void write(JsonWriter out, DeliveryStreamDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeliveryStreamDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeliveryStreamDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeliveryStreamDescription
   * @throws IOException if the JSON string is invalid with respect to DeliveryStreamDescription
   */
  public static DeliveryStreamDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeliveryStreamDescription.class);
  }

  /**
   * Convert an instance of DeliveryStreamDescription to an JSON string
   *
   * @return JSON string
   */
