...
public class UpdateDestinationInputHttpEndpointDestinationUpdate {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate() {
  }

  public UpdateDestinationInputHttpEndpointDestinationUpdate endpointConfiguration(HttpEndpointDestinationUpdateEndpointConfiguration endpointConfiguration) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate bufferingHints(HttpEndpointDestinationDescriptionBufferingHints bufferingHints) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate cloudWatchLoggingOptions(CloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate requestConfiguration(HttpEndpointDestinationUpdateRequestConfiguration requestConfiguration) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate processingConfiguration(ProcessingConfiguration processingConfiguration) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate roleARN(String roleARN) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate retryOptions(HttpEndpointDestinationConfigurationRetryOptions retryOptions) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate s3BackupMode(HttpEndpointS3BackupMode s3BackupMode) {
  ...
  public UpdateDestinationInputHttpEndpointDestinationUpdate s3Update(S3DestinationUpdate s3Update) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDestinationInputHttpEndpointDestinationUpdate updateDestinationInputHttpEndpointDestinationUpdate = (UpdateDestinationInputHttpEndpointDestinationUpdate) o;
    return Objects.equals(this.endpointConfiguration, updateDestinationInputHttpEndpointDestinationUpdate.endpointConfiguration) &&
        Objects.equals(this.bufferingHints, updateDestinationInputHttpEndpointDestinationUpdate.bufferingHints) &&
        Objects.equals(this.cloudWatchLoggingOptions, updateDestinationInputHttpEndpointDestinationUpdate.cloudWatchLoggingOptions) &&
        Objects.equals(this.requestConfiguration, updateDestinationInputHttpEndpointDestinationUpdate.requestConfiguration) &&
        Objects.equals(this.processingConfiguration, updateDestinationInputHttpEndpointDestinationUpdate.processingConfiguration) &&
        Objects.equals(this.roleARN, updateDestinationInputHttpEndpointDestinationUpdate.roleARN) &&
        Objects.equals(this.retryOptions, updateDestinationInputHttpEndpointDestinationUpdate.retryOptions) &&
        Objects.equals(this.s3BackupMode, updateDestinationInputHttpEndpointDestinationUpdate.s3BackupMode) &&
        Objects.equals(this.s3Update, updateDestinationInputHttpEndpointDestinationUpdate.s3Update);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDestinationInputHttpEndpointDestinationUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDestinationInputHttpEndpointDestinationUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDestinationInputHttpEndpointDestinationUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDestinationInputHttpEndpointDestinationUpdate is not found in the empty JSON string", UpdateDestinationInputHttpEndpointDestinationUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDestinationInputHttpEndpointDestinationUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDestinationInputHttpEndpointDestinationUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDestinationInputHttpEndpointDestinationUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDestinationInputHttpEndpointDestinationUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDestinationInputHttpEndpointDestinationUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDestinationInputHttpEndpointDestinationUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDestinationInputHttpEndpointDestinationUpdate>() {
           @Override
           public void write(JsonWriter out, UpdateDestinationInputHttpEndpointDestinationUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDestinationInputHttpEndpointDestinationUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDestinationInputHttpEndpointDestinationUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDestinationInputHttpEndpointDestinationUpdate
   * @throws IOException if the JSON string is invalid with respect to UpdateDestinationInputHttpEndpointDestinationUpdate
   */
  public static UpdateDestinationInputHttpEndpointDestinationUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDestinationInputHttpEndpointDestinationUpdate.class);
  }

  /**
   * Convert an instance of UpdateDestinationInputHttpEndpointDestinationUpdate to an JSON string
   *
   * @return JSON string
   */
