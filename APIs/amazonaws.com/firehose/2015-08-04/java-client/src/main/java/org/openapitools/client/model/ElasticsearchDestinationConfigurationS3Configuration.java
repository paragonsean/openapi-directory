...
public class ElasticsearchDestinationConfigurationS3Configuration {
  ...
  public ElasticsearchDestinationConfigurationS3Configuration() {
  }

  public ElasticsearchDestinationConfigurationS3Configuration roleARN(String roleARN) {
  ...
  public ElasticsearchDestinationConfigurationS3Configuration bucketARN(String bucketARN) {
  ...
  public ElasticsearchDestinationConfigurationS3Configuration prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public ElasticsearchDestinationConfigurationS3Configuration errorOutputPrefix(String errorOutputPrefix) {
  ...
  public ElasticsearchDestinationConfigurationS3Configuration bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public ElasticsearchDestinationConfigurationS3Configuration compressionFormat(CompressionFormat compressionFormat) {
  ...
  public ElasticsearchDestinationConfigurationS3Configuration encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public ElasticsearchDestinationConfigurationS3Configuration cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    ElasticsearchDestinationConfigurationS3Configuration elasticsearchDestinationConfigurationS3Configuration = (ElasticsearchDestinationConfigurationS3Configuration) o;
    return Objects.equals(this.roleARN, elasticsearchDestinationConfigurationS3Configuration.roleARN) &&
        Objects.equals(this.bucketARN, elasticsearchDestinationConfigurationS3Configuration.bucketARN) &&
        Objects.equals(this.prefix, elasticsearchDestinationConfigurationS3Configuration.prefix) &&
        Objects.equals(this.errorOutputPrefix, elasticsearchDestinationConfigurationS3Configuration.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, elasticsearchDestinationConfigurationS3Configuration.bufferingHints) &&
        Objects.equals(this.compressionFormat, elasticsearchDestinationConfigurationS3Configuration.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, elasticsearchDestinationConfigurationS3Configuration.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, elasticsearchDestinationConfigurationS3Configuration.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class ElasticsearchDestinationConfigurationS3Configuration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ElasticsearchDestinationConfigurationS3Configuration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ElasticsearchDestinationConfigurationS3Configuration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ElasticsearchDestinationConfigurationS3Configuration is not found in the empty JSON string", ElasticsearchDestinationConfigurationS3Configuration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ElasticsearchDestinationConfigurationS3Configuration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ElasticsearchDestinationConfigurationS3Configuration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ElasticsearchDestinationConfigurationS3Configuration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ElasticsearchDestinationConfigurationS3Configuration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ElasticsearchDestinationConfigurationS3Configuration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ElasticsearchDestinationConfigurationS3Configuration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ElasticsearchDestinationConfigurationS3Configuration.class));

       return (TypeAdapter<T>) new TypeAdapter<ElasticsearchDestinationConfigurationS3Configuration>() {
           @Override
           public void write(JsonWriter out, ElasticsearchDestinationConfigurationS3Configuration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ElasticsearchDestinationConfigurationS3Configuration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ElasticsearchDestinationConfigurationS3Configuration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ElasticsearchDestinationConfigurationS3Configuration
   * @throws IOException if the JSON string is invalid with respect to ElasticsearchDestinationConfigurationS3Configuration
   */
  public static ElasticsearchDestinationConfigurationS3Configuration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ElasticsearchDestinationConfigurationS3Configuration.class);
  }

  /**
   * Convert an instance of ElasticsearchDestinationConfigurationS3Configuration to an JSON string
   *
   * @return JSON string
   */
