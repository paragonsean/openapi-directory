...
public class S3DestinationDescription {
  ...
  public S3DestinationDescription roleARN(String roleARN) {
  ...
  public S3DestinationDescription bucketARN(String bucketARN) {
  ...
  public S3DestinationDescription prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public S3DestinationDescription errorOutputPrefix(String errorOutputPrefix) {
  ...
  public S3DestinationDescription bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public S3DestinationDescription compressionFormat(CompressionFormat compressionFormat) {
  ...
  public S3DestinationDescription encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public S3DestinationDescription cloudWatchLoggingOptions(S3DestinationDescriptionCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    S3DestinationDescription s3DestinationDescription = (S3DestinationDescription) o;
    return Objects.equals(this.roleARN, s3DestinationDescription.roleARN) &&
        Objects.equals(this.bucketARN, s3DestinationDescription.bucketARN) &&
        Objects.equals(this.prefix, s3DestinationDescription.prefix) &&
        Objects.equals(this.errorOutputPrefix, s3DestinationDescription.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, s3DestinationDescription.bufferingHints) &&
        Objects.equals(this.compressionFormat, s3DestinationDescription.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, s3DestinationDescription.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, s3DestinationDescription.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3DestinationDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3DestinationDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3DestinationDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3DestinationDescription is not found in the empty JSON string", S3DestinationDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3DestinationDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3DestinationDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3DestinationDescription.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3DestinationDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3DestinationDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3DestinationDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3DestinationDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<S3DestinationDescription>() {
           @Override
           public void write(JsonWriter out, S3DestinationDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3DestinationDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3DestinationDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3DestinationDescription
   * @throws IOException if the JSON string is invalid with respect to S3DestinationDescription
   */
  public static S3DestinationDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3DestinationDescription.class);
  }

  /**
   * Convert an instance of S3DestinationDescription to an JSON string
   *
   * @return JSON string
   */
