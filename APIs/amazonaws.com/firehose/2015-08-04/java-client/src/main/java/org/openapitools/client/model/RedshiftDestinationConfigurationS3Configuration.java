...
public class RedshiftDestinationConfigurationS3Configuration {
  ...
  public RedshiftDestinationConfigurationS3Configuration() {
  }

  public RedshiftDestinationConfigurationS3Configuration roleARN(String roleARN) {
  ...
  public RedshiftDestinationConfigurationS3Configuration bucketARN(String bucketARN) {
  ...
  public RedshiftDestinationConfigurationS3Configuration prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public RedshiftDestinationConfigurationS3Configuration errorOutputPrefix(String errorOutputPrefix) {
  ...
  public RedshiftDestinationConfigurationS3Configuration bufferingHints(S3DestinationConfigurationBufferingHints bufferingHints) {
  ...
  public RedshiftDestinationConfigurationS3Configuration compressionFormat(CompressionFormat compressionFormat) {
  ...
  public RedshiftDestinationConfigurationS3Configuration encryptionConfiguration(S3DestinationConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public RedshiftDestinationConfigurationS3Configuration cloudWatchLoggingOptions(S3DestinationConfigurationCloudWatchLoggingOptions cloudWatchLoggingOptions) {
  ...
  public boolean equals(Object o) {
    ...
    RedshiftDestinationConfigurationS3Configuration redshiftDestinationConfigurationS3Configuration = (RedshiftDestinationConfigurationS3Configuration) o;
    return Objects.equals(this.roleARN, redshiftDestinationConfigurationS3Configuration.roleARN) &&
        Objects.equals(this.bucketARN, redshiftDestinationConfigurationS3Configuration.bucketARN) &&
        Objects.equals(this.prefix, redshiftDestinationConfigurationS3Configuration.prefix) &&
        Objects.equals(this.errorOutputPrefix, redshiftDestinationConfigurationS3Configuration.errorOutputPrefix) &&
        Objects.equals(this.bufferingHints, redshiftDestinationConfigurationS3Configuration.bufferingHints) &&
        Objects.equals(this.compressionFormat, redshiftDestinationConfigurationS3Configuration.compressionFormat) &&
        Objects.equals(this.encryptionConfiguration, redshiftDestinationConfigurationS3Configuration.encryptionConfiguration) &&
        Objects.equals(this.cloudWatchLoggingOptions, redshiftDestinationConfigurationS3Configuration.cloudWatchLoggingOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedshiftDestinationConfigurationS3Configuration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RedshiftDestinationConfigurationS3Configuration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedshiftDestinationConfigurationS3Configuration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedshiftDestinationConfigurationS3Configuration is not found in the empty JSON string", RedshiftDestinationConfigurationS3Configuration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedshiftDestinationConfigurationS3Configuration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedshiftDestinationConfigurationS3Configuration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RedshiftDestinationConfigurationS3Configuration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedshiftDestinationConfigurationS3Configuration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedshiftDestinationConfigurationS3Configuration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedshiftDestinationConfigurationS3Configuration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedshiftDestinationConfigurationS3Configuration.class));

       return (TypeAdapter<T>) new TypeAdapter<RedshiftDestinationConfigurationS3Configuration>() {
           @Override
           public void write(JsonWriter out, RedshiftDestinationConfigurationS3Configuration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RedshiftDestinationConfigurationS3Configuration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RedshiftDestinationConfigurationS3Configuration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RedshiftDestinationConfigurationS3Configuration
   * @throws IOException if the JSON string is invalid with respect to RedshiftDestinationConfigurationS3Configuration
   */
  public static RedshiftDestinationConfigurationS3Configuration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedshiftDestinationConfigurationS3Configuration.class);
  }

  /**
   * Convert an instance of RedshiftDestinationConfigurationS3Configuration to an JSON string
   *
   * @return JSON string
   */
