...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisFirehose.PutRecordOutput();
  });
  ...
  describe('PutRecordOutput', function() {
    it('should create an instance of PutRecordOutput', function() {
      // uncomment below and update the code to test PutRecordOutput
      //var instance = new AmazonKinesisFirehose.PutRecordOutput();
      //expect(instance).to.be.a(AmazonKinesisFirehose.PutRecordOutput);
    });
