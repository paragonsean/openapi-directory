...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisFirehose.ProcessorParameter();
  });
  ...
  describe('ProcessorParameter', function() {
    it('should create an instance of ProcessorParameter', function() {
      // uncomment below and update the code to test ProcessorParameter
      //var instance = new AmazonKinesisFirehose.ProcessorParameter();
      //expect(instance).to.be.a(AmazonKinesisFirehose.ProcessorParameter);
    });
