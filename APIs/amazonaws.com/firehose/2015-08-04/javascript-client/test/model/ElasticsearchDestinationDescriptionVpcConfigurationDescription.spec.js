...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisFirehose.ElasticsearchDestinationDescriptionVpcConfigurationDescription();
  });
  ...
  describe('ElasticsearchDestinationDescriptionVpcConfigurationDescription', function() {
    it('should create an instance of ElasticsearchDestinationDescriptionVpcConfigurationDescription', function() {
      // uncomment below and update the code to test ElasticsearchDestinationDescriptionVpcConfigurationDescription
      //var instance = new AmazonKinesisFirehose.ElasticsearchDestinationDescriptionVpcConfigurationDescription();
      //expect(instance).to.be.a(AmazonKinesisFirehose.ElasticsearchDestinationDescriptionVpcConfigurationDescription);
    });
