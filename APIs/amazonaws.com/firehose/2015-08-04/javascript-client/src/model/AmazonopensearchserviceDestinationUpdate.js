...
/**
 * The AmazonopensearchserviceDestinationUpdate model module.
 * @module model/AmazonopensearchserviceDestinationUpdate
 * @version 2015-08-04
 */
class AmazonopensearchserviceDestinationUpdate {
    /**
     * Constructs a new <code>AmazonopensearchserviceDestinationUpdate</code>.
     * Describes an update for a destination in Amazon OpenSearch Service.
     * @alias module:model/AmazonopensearchserviceDestinationUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AmazonopensearchserviceDestinationUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AmazonopensearchserviceDestinationUpdate} obj Optional instance to populate.
     * @return {module:model/AmazonopensearchserviceDestinationUpdate} The populated <code>AmazonopensearchserviceDestinationUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AmazonopensearchserviceDestinationUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>AmazonopensearchserviceDestinationUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AmazonopensearchserviceDestinationUpdate</code>.
     */
...
export default AmazonopensearchserviceDestinationUpdate;
