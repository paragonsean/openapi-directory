...
/**
 * The RedshiftDestinationUpdate model module.
 * @module model/RedshiftDestinationUpdate
 * @version 2015-08-04
 */
class RedshiftDestinationUpdate {
    /**
     * Constructs a new <code>RedshiftDestinationUpdate</code>.
     * Describes an update for a destination in Amazon Redshift.
     * @alias module:model/RedshiftDestinationUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RedshiftDestinationUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedshiftDestinationUpdate} obj Optional instance to populate.
     * @return {module:model/RedshiftDestinationUpdate} The populated <code>RedshiftDestinationUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedshiftDestinationUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>RedshiftDestinationUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedshiftDestinationUpdate</code>.
     */
...
export default RedshiftDestinationUpdate;
