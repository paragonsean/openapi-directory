...
/**
 * The SchemaConfiguration model module.
 * @module model/SchemaConfiguration
 * @version 2015-08-04
 */
class SchemaConfiguration {
    /**
     * Constructs a new <code>SchemaConfiguration</code>.
     ...
     * @alias module:model/SchemaConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SchemaConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SchemaConfiguration} obj Optional instance to populate.
     * @return {module:model/SchemaConfiguration} The populated <code>SchemaConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SchemaConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>SchemaConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SchemaConfiguration</code>.
     */
