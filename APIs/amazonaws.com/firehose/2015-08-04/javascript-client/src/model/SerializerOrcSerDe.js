...
/**
 * The SerializerOrcSerDe model module.
 * @module model/SerializerOrcSerDe
 * @version 2015-08-04
 */
class SerializerOrcSerDe {
    /**
     * Constructs a new <code>SerializerOrcSerDe</code>.
     * @alias module:model/SerializerOrcSerDe
     * @implements module:model/OrcSerDe
     */
    constructor() { 
        OrcSerDe.initialize(this);
        SerializerOrcSerDe.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SerializerOrcSerDe</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SerializerOrcSerDe} obj Optional instance to populate.
     * @return {module:model/SerializerOrcSerDe} The populated <code>SerializerOrcSerDe</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SerializerOrcSerDe();
            OrcSerDe.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SerializerOrcSerDe</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SerializerOrcSerDe</code>.
     */
 ...
 */
SerializerOrcSerDe.prototype['StripeSizeBytes'] = undefined;

/**
 * @member {Number} BlockSizeBytes
 */
SerializerOrcSerDe.prototype['BlockSizeBytes'] = undefined;

/**
 * @member {Number} RowIndexStride
 */
SerializerOrcSerDe.prototype['RowIndexStride'] = undefined;

/**
 * @member {Boolean} EnablePadding
 */
SerializerOrcSerDe.prototype['EnablePadding'] = undefined;

/**
 * @member {Number} PaddingTolerance
 */
SerializerOrcSerDe.prototype['PaddingTolerance'] = undefined;

/**
 * @member {module:model/OrcCompression} Compression
 */
SerializerOrcSerDe.prototype['Compression'] = undefined;

/**
 * @member {Array} BloomFilterColumns
 */
SerializerOrcSerDe.prototype['BloomFilterColumns'] = undefined;

/**
 * @member {Number} BloomFilterFalsePositiveProbability
 */
SerializerOrcSerDe.prototype['BloomFilterFalsePositiveProbability'] = undefined;

/**
 * @member {Number} DictionaryKeyThreshold
 */
SerializerOrcSerDe.prototype['DictionaryKeyThreshold'] = undefined;

/**
 * @member {module:model/OrcFormatVersion} FormatVersion
 */
SerializerOrcSerDe.prototype['FormatVersion'] = undefined;


// Implement OrcSerDe interface:
/**
 * @member {Number} StripeSizeBytes
 */
...
export default SerializerOrcSerDe;
