...
/**
 * The AmazonOpenSearchServerlessDestinationUpdate model module.
 * @module model/AmazonOpenSearchServerlessDestinationUpdate
 * @version 2015-08-04
 */
class AmazonOpenSearchServerlessDestinationUpdate {
    /**
     * Constructs a new <code>AmazonOpenSearchServerlessDestinationUpdate</code>.
     * Describes an update for a destination in the Serverless offering for Amazon OpenSearch Service.
     * @alias module:model/AmazonOpenSearchServerlessDestinationUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AmazonOpenSearchServerlessDestinationUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AmazonOpenSearchServerlessDestinationUpdate} obj Optional instance to populate.
     * @return {module:model/AmazonOpenSearchServerlessDestinationUpdate} The populated <code>AmazonOpenSearchServerlessDestinationUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AmazonOpenSearchServerlessDestinationUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>AmazonOpenSearchServerlessDestinationUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AmazonOpenSearchServerlessDestinationUpdate</code>.
     */
...
export default AmazonOpenSearchServerlessDestinationUpdate;
