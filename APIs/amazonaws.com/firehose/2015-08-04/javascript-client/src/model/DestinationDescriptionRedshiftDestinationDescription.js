...
/**
 * The DestinationDescriptionRedshiftDestinationDescription model module.
 * @module model/DestinationDescriptionRedshiftDestinationDescription
 * @version 2015-08-04
 */
class DestinationDescriptionRedshiftDestinationDescription {
    /**
     * Constructs a new <code>DestinationDescriptionRedshiftDestinationDescription</code>.
     * @alias module:model/DestinationDescriptionRedshiftDestinationDescription
     * @implements module:model/RedshiftDestinationDescription
    ...
    constructor(roleARN, clusterJDBCURL, copyCommand, username, s3DestinationDescription) { 
        ...
        DestinationDescriptionRedshiftDestinationDescription.initialize(this, roleARN, clusterJDBCURL, copyCommand, username, s3DestinationDescription);
    }
    ...
    /**
     * Constructs a <code>DestinationDescriptionRedshiftDestinationDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DestinationDescriptionRedshiftDestinationDescription} obj Optional instance to populate.
     * @return {module:model/DestinationDescriptionRedshiftDestinationDescription} The populated <code>DestinationDescriptionRedshiftDestinationDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DestinationDescriptionRedshiftDestinationDescription();
            RedshiftDestinationDescription.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DestinationDescriptionRedshiftDestinationDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DestinationDescriptionRedshiftDestinationDescription</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DestinationDescriptionRedshiftDestinationDescription.RequiredProperties) {
...
DestinationDescriptionRedshiftDestinationDescription.RequiredProperties = ["RoleARN", "ClusterJDBCURL", "CopyCommand", "Username", "S3DestinationDescription"];

/**
 * @member {String} RoleARN
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['RoleARN'] = undefined;

/**
 * @member {String} ClusterJDBCURL
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['ClusterJDBCURL'] = undefined;

/**
 * @member {module:model/RedshiftDestinationConfigurationCopyCommand} CopyCommand
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['CopyCommand'] = undefined;

/**
 * @member {String} Username
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['Username'] = undefined;

/**
 * @member {module:model/RedshiftDestinationConfigurationRetryOptions} RetryOptions
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['RetryOptions'] = undefined;

/**
 * @member {module:model/RedshiftDestinationDescriptionS3DestinationDescription} S3DestinationDescription
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['S3DestinationDescription'] = undefined;

/**
 * @member {module:model/ExtendedS3DestinationConfigurationProcessingConfiguration} ProcessingConfiguration
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['ProcessingConfiguration'] = undefined;

/**
 * @member {module:model/RedshiftS3BackupMode} S3BackupMode
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['S3BackupMode'] = undefined;

/**
 * @member {module:model/ExtendedS3DestinationDescriptionS3BackupDescription} S3BackupDescription
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['S3BackupDescription'] = undefined;

/**
 * @member {module:model/S3DestinationDescriptionCloudWatchLoggingOptions} CloudWatchLoggingOptions
 */
DestinationDescriptionRedshiftDestinationDescription.prototype['CloudWatchLoggingOptions'] = undefined;


// Implement RedshiftDestinationDescription interface:
/**
 * @member {String} RoleARN
 */
...
export default DestinationDescriptionRedshiftDestinationDescription;
