...
/**
 * The ExtendedS3DestinationUpdate model module.
 * @module model/ExtendedS3DestinationUpdate
 * @version 2015-08-04
 */
class ExtendedS3DestinationUpdate {
    /**
     * Constructs a new <code>ExtendedS3DestinationUpdate</code>.
     * Describes an update for a destination in Amazon S3.
     * @alias module:model/ExtendedS3DestinationUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ExtendedS3DestinationUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtendedS3DestinationUpdate} obj Optional instance to populate.
     * @return {module:model/ExtendedS3DestinationUpdate} The populated <code>ExtendedS3DestinationUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtendedS3DestinationUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>ExtendedS3DestinationUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtendedS3DestinationUpdate</code>.
     */
...
export default ExtendedS3DestinationUpdate;
