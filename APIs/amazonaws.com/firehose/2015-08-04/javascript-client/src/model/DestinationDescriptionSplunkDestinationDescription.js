...
import SplunkDestinationDescriptionS3DestinationDescription from './SplunkDestinationDescriptionS3DestinationDescription';
import SplunkS3BackupMode from './SplunkS3BackupMode';

/**
 * The DestinationDescriptionSplunkDestinationDescription model module.
 * @module model/DestinationDescriptionSplunkDestinationDescription
 * @version 2015-08-04
 */
class DestinationDescriptionSplunkDestinationDescription {
    /**
     * Constructs a new <code>DestinationDescriptionSplunkDestinationDescription</code>.
     * @alias module:model/DestinationDescriptionSplunkDestinationDescription
     * @implements module:model/SplunkDestinationDescription
     */
    constructor() { 
        SplunkDestinationDescription.initialize(this);
        DestinationDescriptionSplunkDestinationDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DestinationDescriptionSplunkDestinationDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DestinationDescriptionSplunkDestinationDescription} obj Optional instance to populate.
     * @return {module:model/DestinationDescriptionSplunkDestinationDescription} The populated <code>DestinationDescriptionSplunkDestinationDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DestinationDescriptionSplunkDestinationDescription();
            SplunkDestinationDescription.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('S3DestinationDescription')) {
                obj['S3DestinationDescription'] = SplunkDestinationDescriptionS3DestinationDescription.constructFromObject(data['S3DestinationDescription']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DestinationDescriptionSplunkDestinationDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DestinationDescriptionSplunkDestinationDescription</code>.
     */
    static validateJSON(data) {
        ...
        if (data['S3DestinationDescription']) { // data not null
          SplunkDestinationDescriptionS3DestinationDescription.validateJSON(data['S3DestinationDescription']);
        }
 ...
 */
DestinationDescriptionSplunkDestinationDescription.prototype['HECEndpoint'] = undefined;

/**
 * @member {module:model/HECEndpointType} HECEndpointType
 */
DestinationDescriptionSplunkDestinationDescription.prototype['HECEndpointType'] = undefined;

/**
 * @member {String} HECToken
 */
DestinationDescriptionSplunkDestinationDescription.prototype['HECToken'] = undefined;

/**
 * @member {Number} HECAcknowledgmentTimeoutInSeconds
 */
DestinationDescriptionSplunkDestinationDescription.prototype['HECAcknowledgmentTimeoutInSeconds'] = undefined;

/**
 * @member {module:model/SplunkDestinationDescriptionRetryOptions} RetryOptions
 */
DestinationDescriptionSplunkDestinationDescription.prototype['RetryOptions'] = undefined;

/**
 * @member {module:model/SplunkS3BackupMode} S3BackupMode
 */
DestinationDescriptionSplunkDestinationDescription.prototype['S3BackupMode'] = undefined;

/**
 * @member {module:model/SplunkDestinationDescriptionS3DestinationDescription} S3DestinationDescription
 */
DestinationDescriptionSplunkDestinationDescription.prototype['S3DestinationDescription'] = undefined;

/**
 * @member {module:model/ExtendedS3DestinationConfigurationProcessingConfiguration} ProcessingConfiguration
 */
DestinationDescriptionSplunkDestinationDescription.prototype['ProcessingConfiguration'] = undefined;

/**
 * @member {module:model/S3DestinationDescriptionCloudWatchLoggingOptions} CloudWatchLoggingOptions
 */
DestinationDescriptionSplunkDestinationDescription.prototype['CloudWatchLoggingOptions'] = undefined;


// Implement SplunkDestinationDescription interface:
/**
 * @member {String} HECEndpoint
 */
SplunkDestinationDescription.prototype['HECEndpoint'] = undefined;
/**
 * @member {module:model/HECEndpointType} HECEndpointType
 */
SplunkDestinationDescription.prototype['HECEndpointType'] = undefined;
/**
 * @member {String} HECToken
 */
SplunkDestinationDescription.prototype['HECToken'] = undefined;
/**
 * @member {Number} HECAcknowledgmentTimeoutInSeconds
 */
SplunkDestinationDescription.prototype['HECAcknowledgmentTimeoutInSeconds'] = undefined;
/**
 * @member {module:model/SplunkDestinationDescriptionRetryOptions} RetryOptions
 */
SplunkDestinationDescription.prototype['RetryOptions'] = undefined;
/**
 * @member {module:model/SplunkS3BackupMode} S3BackupMode
 */
SplunkDestinationDescription.prototype['S3BackupMode'] = undefined;
/**
 * @member {module:model/SplunkDestinationDescriptionS3DestinationDescription} S3DestinationDescription
 */
SplunkDestinationDescription.prototype['S3DestinationDescription'] = undefined;
/**
 * @member {module:model/ExtendedS3DestinationConfigurationProcessingConfiguration} ProcessingConfiguration
 */
SplunkDestinationDescription.prototype['ProcessingConfiguration'] = undefined;
/**
 * @member {module:model/S3DestinationDescriptionCloudWatchLoggingOptions} CloudWatchLoggingOptions
 */
SplunkDestinationDescription.prototype['CloudWatchLoggingOptions'] = undefined;




export default DestinationDescriptionSplunkDestinationDescription;
