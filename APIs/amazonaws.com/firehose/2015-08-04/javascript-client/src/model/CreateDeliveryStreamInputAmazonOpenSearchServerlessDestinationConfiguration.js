...
/**
 * The CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration model module.
 * @module model/CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration
 * @version 2015-08-04
 */
class CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration {
    /**
     * Constructs a new <code>CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration</code>.
     * @alias module:model/CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration
     * @implements module:model/AmazonOpenSearchServerlessDestinationConfiguration
    ...
    constructor(roleARN, indexName, s3Configuration) { 
        ...
        CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.initialize(this, roleARN, indexName, s3Configuration);
    }
    ...
    /**
     * Constructs a <code>CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration} The populated <code>CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration();
            AmazonOpenSearchServerlessDestinationConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.RequiredProperties) {
...
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.RequiredProperties = ["RoleARN", "IndexName", "S3Configuration"];

/**
 * @member {String} RoleARN
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['RoleARN'] = undefined;

/**
 * @member {String} CollectionEndpoint
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['CollectionEndpoint'] = undefined;

/**
 * @member {String} IndexName
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['IndexName'] = undefined;

/**
 * @member {module:model/AmazonOpenSearchServerlessDestinationConfigurationBufferingHints} BufferingHints
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['BufferingHints'] = undefined;

/**
 * @member {module:model/AmazonOpenSearchServerlessDestinationConfigurationRetryOptions} RetryOptions
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['RetryOptions'] = undefined;

/**
 * @member {module:model/AmazonOpenSearchServerlessS3BackupMode} S3BackupMode
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['S3BackupMode'] = undefined;

/**
 * @member {module:model/S3DestinationConfiguration} S3Configuration
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['S3Configuration'] = undefined;

/**
 * @member {module:model/ProcessingConfiguration} ProcessingConfiguration
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['ProcessingConfiguration'] = undefined;

/**
 * @member {module:model/CloudWatchLoggingOptions} CloudWatchLoggingOptions
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['CloudWatchLoggingOptions'] = undefined;

/**
 * @member {module:model/VpcConfiguration} VpcConfiguration
 */
CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration.prototype['VpcConfiguration'] = undefined;


// Implement AmazonOpenSearchServerlessDestinationConfiguration interface:
/**
 * @member {String} RoleARN
 */
...
export default CreateDeliveryStreamInputAmazonOpenSearchServerlessDestinationConfiguration;
