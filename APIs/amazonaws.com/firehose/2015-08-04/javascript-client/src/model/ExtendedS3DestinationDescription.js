...
/**
 * The ExtendedS3DestinationDescription model module.
 * @module model/ExtendedS3DestinationDescription
 * @version 2015-08-04
 */
class ExtendedS3DestinationDescription {
    /**
     * Constructs a new <code>ExtendedS3DestinationDescription</code>.
     * Describes a destination in Amazon S3.
     * @alias module:model/ExtendedS3DestinationDescription
    ...
    /**
     * Constructs a <code>ExtendedS3DestinationDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtendedS3DestinationDescription} obj Optional instance to populate.
     * @return {module:model/ExtendedS3DestinationDescription} The populated <code>ExtendedS3DestinationDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtendedS3DestinationDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>ExtendedS3DestinationDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtendedS3DestinationDescription</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExtendedS3DestinationDescription.RequiredProperties) {
...
ExtendedS3DestinationDescription.RequiredProperties = ["RoleARN", "BucketARN", "BufferingHints", "CompressionFormat", "EncryptionConfiguration"];
...
export default ExtendedS3DestinationDescription;
