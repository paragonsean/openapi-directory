...
/**
 * The CreateDeliveryStreamInputExtendedS3DestinationConfiguration model module.
 * @module model/CreateDeliveryStreamInputExtendedS3DestinationConfiguration
 * @version 2015-08-04
 */
class CreateDeliveryStreamInputExtendedS3DestinationConfiguration {
    /**
     * Constructs a new <code>CreateDeliveryStreamInputExtendedS3DestinationConfiguration</code>.
     * @alias module:model/CreateDeliveryStreamInputExtendedS3DestinationConfiguration
     * @implements module:model/ExtendedS3DestinationConfiguration
    ...
    constructor(roleARN, bucketARN) { 
        ...
        CreateDeliveryStreamInputExtendedS3DestinationConfiguration.initialize(this, roleARN, bucketARN);
    }
    ...
    /**
     * Constructs a <code>CreateDeliveryStreamInputExtendedS3DestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDeliveryStreamInputExtendedS3DestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateDeliveryStreamInputExtendedS3DestinationConfiguration} The populated <code>CreateDeliveryStreamInputExtendedS3DestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDeliveryStreamInputExtendedS3DestinationConfiguration();
            ExtendedS3DestinationConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDeliveryStreamInputExtendedS3DestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDeliveryStreamInputExtendedS3DestinationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDeliveryStreamInputExtendedS3DestinationConfiguration.RequiredProperties) {
...
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.RequiredProperties = ["RoleARN", "BucketARN"];

/**
 * @member {String} RoleARN
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['RoleARN'] = undefined;

/**
 * @member {String} BucketARN
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['BucketARN'] = undefined;

/**
 * @member {String} Prefix
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['Prefix'] = undefined;

/**
 * @member {String} ErrorOutputPrefix
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['ErrorOutputPrefix'] = undefined;

/**
 * @member {module:model/ExtendedS3DestinationConfigurationBufferingHints} BufferingHints
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['BufferingHints'] = undefined;

/**
 * @member {module:model/CompressionFormat} CompressionFormat
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['CompressionFormat'] = undefined;

/**
 * @member {module:model/S3DestinationConfigurationEncryptionConfiguration} EncryptionConfiguration
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['EncryptionConfiguration'] = undefined;

/**
 * @member {module:model/S3DestinationDescriptionCloudWatchLoggingOptions} CloudWatchLoggingOptions
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['CloudWatchLoggingOptions'] = undefined;

/**
 * @member {module:model/ExtendedS3DestinationConfigurationProcessingConfiguration} ProcessingConfiguration
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['ProcessingConfiguration'] = undefined;

/**
 * @member {module:model/S3BackupMode} S3BackupMode
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['S3BackupMode'] = undefined;

/**
 * @member {module:model/ExtendedS3DestinationConfigurationS3BackupConfiguration} S3BackupConfiguration
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['S3BackupConfiguration'] = undefined;
 ...
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['DataFormatConversionConfiguration'] = undefined;

/**
 * @member {module:model/ExtendedS3DestinationConfigurationDynamicPartitioningConfiguration} DynamicPartitioningConfiguration
 */
CreateDeliveryStreamInputExtendedS3DestinationConfiguration.prototype['DynamicPartitioningConfiguration'] = undefined;


// Implement ExtendedS3DestinationConfiguration interface:
/**
 * @member {String} RoleARN
 */
...
export default CreateDeliveryStreamInputExtendedS3DestinationConfiguration;
