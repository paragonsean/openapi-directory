...
/**
 * The SplunkDestinationDescription model module.
 * @module model/SplunkDestinationDescription
 * @version 2015-08-04
 */
class SplunkDestinationDescription {
    /**
     * Constructs a new <code>SplunkDestinationDescription</code>.
     * Describes a destination in Splunk.
     * @alias module:model/SplunkDestinationDescription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SplunkDestinationDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SplunkDestinationDescription} obj Optional instance to populate.
     * @return {module:model/SplunkDestinationDescription} The populated <code>SplunkDestinationDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SplunkDestinationDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>SplunkDestinationDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SplunkDestinationDescription</code>.
     */
...
export default SplunkDestinationDescription;
