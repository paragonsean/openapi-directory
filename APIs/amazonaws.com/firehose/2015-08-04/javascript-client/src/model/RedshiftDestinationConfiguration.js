...
/**
 * The RedshiftDestinationConfiguration model module.
 * @module model/RedshiftDestinationConfiguration
 * @version 2015-08-04
 */
class RedshiftDestinationConfiguration {
    /**
     * Constructs a new <code>RedshiftDestinationConfiguration</code>.
     * Describes the configuration of a destination in Amazon Redshift.
     * @alias module:model/RedshiftDestinationConfiguration
    ...
    /**
     * Constructs a <code>RedshiftDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedshiftDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/RedshiftDestinationConfiguration} The populated <code>RedshiftDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedshiftDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RedshiftDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedshiftDestinationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RedshiftDestinationConfiguration.RequiredProperties) {
...
RedshiftDestinationConfiguration.RequiredProperties = ["RoleARN", "ClusterJDBCURL", "CopyCommand", "Username", "Password", "S3Configuration"];
...
export default RedshiftDestinationConfiguration;
