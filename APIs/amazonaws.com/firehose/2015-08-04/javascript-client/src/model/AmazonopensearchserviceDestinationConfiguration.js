...
/**
 * The AmazonopensearchserviceDestinationConfiguration model module.
 * @module model/AmazonopensearchserviceDestinationConfiguration
 * @version 2015-08-04
 */
class AmazonopensearchserviceDestinationConfiguration {
    /**
     * Constructs a new <code>AmazonopensearchserviceDestinationConfiguration</code>.
     * Describes the configuration of a destination in Amazon OpenSearch Service
     * @alias module:model/AmazonopensearchserviceDestinationConfiguration
    ...
    /**
     * Constructs a <code>AmazonopensearchserviceDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AmazonopensearchserviceDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/AmazonopensearchserviceDestinationConfiguration} The populated <code>AmazonopensearchserviceDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AmazonopensearchserviceDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>AmazonopensearchserviceDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AmazonopensearchserviceDestinationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AmazonopensearchserviceDestinationConfiguration.RequiredProperties) {
...
AmazonopensearchserviceDestinationConfiguration.RequiredProperties = ["RoleARN", "IndexName", "S3Configuration"];
...
export default AmazonopensearchserviceDestinationConfiguration;
