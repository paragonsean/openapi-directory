...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://firehose.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://firehose.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2015-08-04/Javascript'
        };
