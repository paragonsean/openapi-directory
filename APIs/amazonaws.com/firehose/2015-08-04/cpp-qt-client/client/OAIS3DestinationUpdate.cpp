...
OAIS3DestinationUpdate::OAIS3DestinationUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3DestinationUpdate::OAIS3DestinationUpdate() {
    this->initializeModel();
}

OAIS3DestinationUpdate::~OAIS3DestinationUpdate() {}

void OAIS3DestinationUpdate::initializeModel() {
...
void OAIS3DestinationUpdate::fromJson(QString jsonString) {
...
void OAIS3DestinationUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIS3DestinationUpdate::asJson() const {
...
QJsonObject OAIS3DestinationUpdate::asJsonObject() const {
    QJsonObject obj;
    if (m_role_arn_isSet) {
...
QString OAIS3DestinationUpdate::getRoleArn() const {
    return m_role_arn;
}
void OAIS3DestinationUpdate::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIS3DestinationUpdate::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIS3DestinationUpdate::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIS3DestinationUpdate::getBucketArn() const {
    return m_bucket_arn;
}
void OAIS3DestinationUpdate::setBucketArn(const QString &bucket_arn) {
    m_bucket_arn = bucket_arn;
    m_bucket_arn_isSet = true;
}

bool OAIS3DestinationUpdate::is_bucket_arn_Set() const{
    return m_bucket_arn_isSet;
}

bool OAIS3DestinationUpdate::is_bucket_arn_Valid() const{
    return m_bucket_arn_isValid;
}

QString OAIS3DestinationUpdate::getPrefix() const {
    return m_prefix;
}
void OAIS3DestinationUpdate::setPrefix(const QString &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIS3DestinationUpdate::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIS3DestinationUpdate::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QString OAIS3DestinationUpdate::getErrorOutputPrefix() const {
    return m_error_output_prefix;
}
void OAIS3DestinationUpdate::setErrorOutputPrefix(const QString &error_output_prefix) {
    m_error_output_prefix = error_output_prefix;
    m_error_output_prefix_isSet = true;
}

bool OAIS3DestinationUpdate::is_error_output_prefix_Set() const{
    return m_error_output_prefix_isSet;
}

bool OAIS3DestinationUpdate::is_error_output_prefix_Valid() const{
    return m_error_output_prefix_isValid;
}

OAIS3DestinationConfiguration_BufferingHints OAIS3DestinationUpdate::getBufferingHints() const {
    return m_buffering_hints;
}
void OAIS3DestinationUpdate::setBufferingHints(const OAIS3DestinationConfiguration_BufferingHints &buffering_hints) {
    m_buffering_hints = buffering_hints;
    m_buffering_hints_isSet = true;
}

bool OAIS3DestinationUpdate::is_buffering_hints_Set() const{
    return m_buffering_hints_isSet;
}

bool OAIS3DestinationUpdate::is_buffering_hints_Valid() const{
    return m_buffering_hints_isValid;
}

OAICompressionFormat OAIS3DestinationUpdate::getCompressionFormat() const {
    return m_compression_format;
}
void OAIS3DestinationUpdate::setCompressionFormat(const OAICompressionFormat &compression_format) {
    m_compression_format = compression_format;
    m_compression_format_isSet = true;
}

bool OAIS3DestinationUpdate::is_compression_format_Set() const{
    return m_compression_format_isSet;
}

bool OAIS3DestinationUpdate::is_compression_format_Valid() const{
    return m_compression_format_isValid;
}

OAIS3DestinationConfiguration_EncryptionConfiguration OAIS3DestinationUpdate::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIS3DestinationUpdate::setEncryptionConfiguration(const OAIS3DestinationConfiguration_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIS3DestinationUpdate::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIS3DestinationUpdate::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAIS3DestinationConfiguration_CloudWatchLoggingOptions OAIS3DestinationUpdate::getCloudWatchLoggingOptions() const {
    return m_cloud_watch_logging_options;
}
void OAIS3DestinationUpdate::setCloudWatchLoggingOptions(const OAIS3DestinationConfiguration_CloudWatchLoggingOptions &cloud_watch_logging_options) {
    m_cloud_watch_logging_options = cloud_watch_logging_options;
    m_cloud_watch_logging_options_isSet = true;
}

bool OAIS3DestinationUpdate::is_cloud_watch_logging_options_Set() const{
    return m_cloud_watch_logging_options_isSet;
}

bool OAIS3DestinationUpdate::is_cloud_watch_logging_options_Valid() const{
    return m_cloud_watch_logging_options_isValid;
}

bool OAIS3DestinationUpdate::isSet() const {
...
bool OAIS3DestinationUpdate::isValid() const {
