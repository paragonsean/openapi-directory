...
#include "OAISplunkDestinationConfiguration.h"
...
OAISplunkDestinationConfiguration::OAISplunkDestinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISplunkDestinationConfiguration::OAISplunkDestinationConfiguration() {
    this->initializeModel();
}

OAISplunkDestinationConfiguration::~OAISplunkDestinationConfiguration() {}

void OAISplunkDestinationConfiguration::initializeModel() {
...
void OAISplunkDestinationConfiguration::fromJson(QString jsonString) {
...
void OAISplunkDestinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAISplunkDestinationConfiguration::asJson() const {
...
QJsonObject OAISplunkDestinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAISplunkDestinationConfiguration::getHecEndpoint() const {
    return m_hec_endpoint;
}
void OAISplunkDestinationConfiguration::setHecEndpoint(const QString &hec_endpoint) {
    m_hec_endpoint = hec_endpoint;
    m_hec_endpoint_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_hec_endpoint_Set() const{
    return m_hec_endpoint_isSet;
}

bool OAISplunkDestinationConfiguration::is_hec_endpoint_Valid() const{
    return m_hec_endpoint_isValid;
}

OAIHECEndpointType OAISplunkDestinationConfiguration::getHecEndpointType() const {
    return m_hec_endpoint_type;
}
void OAISplunkDestinationConfiguration::setHecEndpointType(const OAIHECEndpointType &hec_endpoint_type) {
    m_hec_endpoint_type = hec_endpoint_type;
    m_hec_endpoint_type_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_hec_endpoint_type_Set() const{
    return m_hec_endpoint_type_isSet;
}

bool OAISplunkDestinationConfiguration::is_hec_endpoint_type_Valid() const{
    return m_hec_endpoint_type_isValid;
}

QString OAISplunkDestinationConfiguration::getHecToken() const {
    return m_hec_token;
}
void OAISplunkDestinationConfiguration::setHecToken(const QString &hec_token) {
    m_hec_token = hec_token;
    m_hec_token_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_hec_token_Set() const{
    return m_hec_token_isSet;
}

bool OAISplunkDestinationConfiguration::is_hec_token_Valid() const{
    return m_hec_token_isValid;
}

qint32 OAISplunkDestinationConfiguration::getHecAcknowledgmentTimeoutInSeconds() const {
    return m_hec_acknowledgment_timeout_in_seconds;
}
void OAISplunkDestinationConfiguration::setHecAcknowledgmentTimeoutInSeconds(const qint32 &hec_acknowledgment_timeout_in_seconds) {
...
bool OAISplunkDestinationConfiguration::is_hec_acknowledgment_timeout_in_seconds_Set() const{
    return m_hec_acknowledgment_timeout_in_seconds_isSet;
}

bool OAISplunkDestinationConfiguration::is_hec_acknowledgment_timeout_in_seconds_Valid() const{
    return m_hec_acknowledgment_timeout_in_seconds_isValid;
}

OAISplunkDestinationConfiguration_RetryOptions OAISplunkDestinationConfiguration::getRetryOptions() const {
    return m_retry_options;
}
void OAISplunkDestinationConfiguration::setRetryOptions(const OAISplunkDestinationConfiguration_RetryOptions &retry_options) {
    m_retry_options = retry_options;
    m_retry_options_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_retry_options_Set() const{
    return m_retry_options_isSet;
}

bool OAISplunkDestinationConfiguration::is_retry_options_Valid() const{
    return m_retry_options_isValid;
}

OAISplunkS3BackupMode OAISplunkDestinationConfiguration::getS3BackupMode() const {
    return m_s3_backup_mode;
}
void OAISplunkDestinationConfiguration::setS3BackupMode(const OAISplunkS3BackupMode &s3_backup_mode) {
    m_s3_backup_mode = s3_backup_mode;
    m_s3_backup_mode_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_s3_backup_mode_Set() const{
    return m_s3_backup_mode_isSet;
}

bool OAISplunkDestinationConfiguration::is_s3_backup_mode_Valid() const{
    return m_s3_backup_mode_isValid;
}

OAIElasticsearchDestinationConfiguration_S3Configuration OAISplunkDestinationConfiguration::getS3Configuration() const {
    return m_s3_configuration;
}
void OAISplunkDestinationConfiguration::setS3Configuration(const OAIElasticsearchDestinationConfiguration_S3Configuration &s3_configuration) {
    m_s3_configuration = s3_configuration;
    m_s3_configuration_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_s3_configuration_Set() const{
    return m_s3_configuration_isSet;
}

bool OAISplunkDestinationConfiguration::is_s3_configuration_Valid() const{
    return m_s3_configuration_isValid;
}

OAIExtendedS3DestinationConfiguration_ProcessingConfiguration OAISplunkDestinationConfiguration::getProcessingConfiguration() const {
    return m_processing_configuration;
}
void OAISplunkDestinationConfiguration::setProcessingConfiguration(const OAIExtendedS3DestinationConfiguration_ProcessingConfiguration &processing_configuration) {
    m_processing_configuration = processing_configuration;
    m_processing_configuration_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_processing_configuration_Set() const{
    return m_processing_configuration_isSet;
}

bool OAISplunkDestinationConfiguration::is_processing_configuration_Valid() const{
    return m_processing_configuration_isValid;
}

OAIS3DestinationDescription_CloudWatchLoggingOptions OAISplunkDestinationConfiguration::getCloudWatchLoggingOptions() const {
    return m_cloud_watch_logging_options;
}
void OAISplunkDestinationConfiguration::setCloudWatchLoggingOptions(const OAIS3DestinationDescription_CloudWatchLoggingOptions &cloud_watch_logging_options) {
    m_cloud_watch_logging_options = cloud_watch_logging_options;
    m_cloud_watch_logging_options_isSet = true;
}

bool OAISplunkDestinationConfiguration::is_cloud_watch_logging_options_Set() const{
    return m_cloud_watch_logging_options_isSet;
}

bool OAISplunkDestinationConfiguration::is_cloud_watch_logging_options_Valid() const{
    return m_cloud_watch_logging_options_isValid;
}

bool OAISplunkDestinationConfiguration::isSet() const {
...
bool OAISplunkDestinationConfiguration::isValid() const {
