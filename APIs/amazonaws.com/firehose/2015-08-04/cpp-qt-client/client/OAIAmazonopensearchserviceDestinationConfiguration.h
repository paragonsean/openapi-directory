...
/*
 * OAIAmazonopensearchserviceDestinationConfiguration.h
 *
 * Describes the configuration of a destination in Amazon OpenSearch Service
 */

#ifndef OAIAmazonopensearchserviceDestinationConfiguration_H
#define OAIAmazonopensearchserviceDestinationConfiguration_H
...
namespace OpenAPI {
class OAIAmazonopensearchserviceDestinationConfiguration_BufferingHints;
...
class OAIAmazonopensearchserviceDestinationConfiguration : public OAIObject {
public:
    OAIAmazonopensearchserviceDestinationConfiguration();
    OAIAmazonopensearchserviceDestinationConfiguration(QString json);
    ~OAIAmazonopensearchserviceDestinationConfiguration() override;
    ...
    OAIAmazonopensearchserviceDestinationConfiguration_BufferingHints getBufferingHints() const;
    void setBufferingHints(const OAIAmazonopensearchserviceDestinationConfiguration_BufferingHints &buffering_hints);
...
private:
    ...
    OAIAmazonopensearchserviceDestinationConfiguration_BufferingHints m_buffering_hints;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmazonopensearchserviceDestinationConfiguration)

#endif // OAIAmazonopensearchserviceDestinationConfiguration_H
