...
/*
 * OAIUpdateDestinationInput_S3DestinationUpdate.h
 *
 * 
 */

#ifndef OAIUpdateDestinationInput_S3DestinationUpdate_H
#define OAIUpdateDestinationInput_S3DestinationUpdate_H
...
class OAIUpdateDestinationInput_S3DestinationUpdate : public OAIObject {
public:
    OAIUpdateDestinationInput_S3DestinationUpdate();
    OAIUpdateDestinationInput_S3DestinationUpdate(QString json);
    ~OAIUpdateDestinationInput_S3DestinationUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDestinationInput_S3DestinationUpdate)

#endif // OAIUpdateDestinationInput_S3DestinationUpdate_H
