...
QString OAIS3DestinationConfiguration::getRoleArn() const {
    return m_role_arn;
}
void OAIS3DestinationConfiguration::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIS3DestinationConfiguration::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIS3DestinationConfiguration::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIS3DestinationConfiguration::getBucketArn() const {
    return m_bucket_arn;
}
void OAIS3DestinationConfiguration::setBucketArn(const QString &bucket_arn) {
    m_bucket_arn = bucket_arn;
    m_bucket_arn_isSet = true;
}

bool OAIS3DestinationConfiguration::is_bucket_arn_Set() const{
    return m_bucket_arn_isSet;
}

bool OAIS3DestinationConfiguration::is_bucket_arn_Valid() const{
    return m_bucket_arn_isValid;
}

QString OAIS3DestinationConfiguration::getPrefix() const {
    return m_prefix;
}
void OAIS3DestinationConfiguration::setPrefix(const QString &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIS3DestinationConfiguration::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIS3DestinationConfiguration::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QString OAIS3DestinationConfiguration::getErrorOutputPrefix() const {
    return m_error_output_prefix;
}
void OAIS3DestinationConfiguration::setErrorOutputPrefix(const QString &error_output_prefix) {
    m_error_output_prefix = error_output_prefix;
    m_error_output_prefix_isSet = true;
}

bool OAIS3DestinationConfiguration::is_error_output_prefix_Set() const{
    return m_error_output_prefix_isSet;
}

bool OAIS3DestinationConfiguration::is_error_output_prefix_Valid() const{
    return m_error_output_prefix_isValid;
}

OAIS3DestinationConfiguration_BufferingHints OAIS3DestinationConfiguration::getBufferingHints() const {
    return m_buffering_hints;
}
void OAIS3DestinationConfiguration::setBufferingHints(const OAIS3DestinationConfiguration_BufferingHints &buffering_hints) {
    m_buffering_hints = buffering_hints;
    m_buffering_hints_isSet = true;
}

bool OAIS3DestinationConfiguration::is_buffering_hints_Set() const{
    return m_buffering_hints_isSet;
}

bool OAIS3DestinationConfiguration::is_buffering_hints_Valid() const{
    return m_buffering_hints_isValid;
}

OAICompressionFormat OAIS3DestinationConfiguration::getCompressionFormat() const {
    return m_compression_format;
}
void OAIS3DestinationConfiguration::setCompressionFormat(const OAICompressionFormat &compression_format) {
    m_compression_format = compression_format;
    m_compression_format_isSet = true;
}

bool OAIS3DestinationConfiguration::is_compression_format_Set() const{
    return m_compression_format_isSet;
}

bool OAIS3DestinationConfiguration::is_compression_format_Valid() const{
    return m_compression_format_isValid;
}

OAIS3DestinationConfiguration_EncryptionConfiguration OAIS3DestinationConfiguration::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIS3DestinationConfiguration::setEncryptionConfiguration(const OAIS3DestinationConfiguration_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIS3DestinationConfiguration::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIS3DestinationConfiguration::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAIS3DestinationConfiguration_CloudWatchLoggingOptions OAIS3DestinationConfiguration::getCloudWatchLoggingOptions() const {
    return m_cloud_watch_logging_options;
}
void OAIS3DestinationConfiguration::setCloudWatchLoggingOptions(const OAIS3DestinationConfiguration_CloudWatchLoggingOptions &cloud_watch_logging_options) {
    m_cloud_watch_logging_options = cloud_watch_logging_options;
    m_cloud_watch_logging_options_isSet = true;
}

bool OAIS3DestinationConfiguration::is_cloud_watch_logging_options_Set() const{
    return m_cloud_watch_logging_options_isSet;
}

bool OAIS3DestinationConfiguration::is_cloud_watch_logging_options_Valid() const{
