...
/*
 * OAICloudWatchLoggingOptions.h
 *
 * Describes the Amazon CloudWatch logging options for your delivery stream.
 */

#ifndef OAICloudWatchLoggingOptions_H
#define OAICloudWatchLoggingOptions_H
...
class OAICloudWatchLoggingOptions : public OAIObject {
public:
    OAICloudWatchLoggingOptions();
    OAICloudWatchLoggingOptions(QString json);
    ~OAICloudWatchLoggingOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudWatchLoggingOptions)

#endif // OAICloudWatchLoggingOptions_H
