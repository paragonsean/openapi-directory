...
/*
 * OAIDataFormatConversionConfiguration.h
 *
...
#ifndef OAIDataFormatConversionConfiguration_H
#define OAIDataFormatConversionConfiguration_H
...
class OAIDataFormatConversionConfiguration : public OAIObject {
public:
    OAIDataFormatConversionConfiguration();
    OAIDataFormatConversionConfiguration(QString json);
    ~OAIDataFormatConversionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataFormatConversionConfiguration)

#endif // OAIDataFormatConversionConfiguration_H
