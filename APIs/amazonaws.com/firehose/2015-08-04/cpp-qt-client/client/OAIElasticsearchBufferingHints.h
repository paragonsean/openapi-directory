...
/*
 * OAIElasticsearchBufferingHints.h
 *
 * Describes the buffering to perform before delivering data to the Amazon ES destination.
 */

#ifndef OAIElasticsearchBufferingHints_H
#define OAIElasticsearchBufferingHints_H
...
class OAIElasticsearchBufferingHints : public OAIObject {
public:
    OAIElasticsearchBufferingHints();
    OAIElasticsearchBufferingHints(QString json);
    ~OAIElasticsearchBufferingHints() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchBufferingHints)

#endif // OAIElasticsearchBufferingHints_H
