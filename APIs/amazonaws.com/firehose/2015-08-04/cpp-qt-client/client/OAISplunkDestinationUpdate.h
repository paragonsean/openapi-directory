...
/*
 * OAISplunkDestinationUpdate.h
 *
 * Describes an update for a destination in Splunk.
 */

#ifndef OAISplunkDestinationUpdate_H
#define OAISplunkDestinationUpdate_H
...
namespace OpenAPI {
class OAISplunkDestinationDescription_RetryOptions;
class OAISplunkDestinationUpdate_S3Update;
...
class OAISplunkDestinationUpdate : public OAIObject {
public:
    OAISplunkDestinationUpdate();
    OAISplunkDestinationUpdate(QString json);
    ~OAISplunkDestinationUpdate() override;
    ...
    OAISplunkDestinationDescription_RetryOptions getRetryOptions() const;
    void setRetryOptions(const OAISplunkDestinationDescription_RetryOptions &retry_options);
    ...
    OAISplunkDestinationUpdate_S3Update getS3Update() const;
    void setS3Update(const OAISplunkDestinationUpdate_S3Update &s3_update);
...
private:
    ...
    OAISplunkDestinationDescription_RetryOptions m_retry_options;
    ...
    OAISplunkDestinationUpdate_S3Update m_s3_update;
...
Q_DECLARE_METATYPE(OpenAPI::OAISplunkDestinationUpdate)

#endif // OAISplunkDestinationUpdate_H
