...
/*
 * OAIExtendedS3DestinationUpdate_S3BackupUpdate.h
 *
 * 
 */

#ifndef OAIExtendedS3DestinationUpdate_S3BackupUpdate_H
#define OAIExtendedS3DestinationUpdate_S3BackupUpdate_H
...
class OAIExtendedS3DestinationUpdate_S3BackupUpdate : public OAIObject {
public:
    OAIExtendedS3DestinationUpdate_S3BackupUpdate();
    OAIExtendedS3DestinationUpdate_S3BackupUpdate(QString json);
    ~OAIExtendedS3DestinationUpdate_S3BackupUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtendedS3DestinationUpdate_S3BackupUpdate)

#endif // OAIExtendedS3DestinationUpdate_S3BackupUpdate_H
