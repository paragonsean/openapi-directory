...
OAIS3DestinationDescription::OAIS3DestinationDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3DestinationDescription::OAIS3DestinationDescription() {
    this->initializeModel();
}

OAIS3DestinationDescription::~OAIS3DestinationDescription() {}

void OAIS3DestinationDescription::initializeModel() {
...
void OAIS3DestinationDescription::fromJson(QString jsonString) {
...
void OAIS3DestinationDescription::fromJsonObject(QJsonObject json) {
...
QString OAIS3DestinationDescription::asJson() const {
...
QJsonObject OAIS3DestinationDescription::asJsonObject() const {
    QJsonObject obj;
    if (m_role_arn_isSet) {
...
QString OAIS3DestinationDescription::getRoleArn() const {
    return m_role_arn;
}
void OAIS3DestinationDescription::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIS3DestinationDescription::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIS3DestinationDescription::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIS3DestinationDescription::getBucketArn() const {
    return m_bucket_arn;
}
void OAIS3DestinationDescription::setBucketArn(const QString &bucket_arn) {
    m_bucket_arn = bucket_arn;
    m_bucket_arn_isSet = true;
}

bool OAIS3DestinationDescription::is_bucket_arn_Set() const{
    return m_bucket_arn_isSet;
}

bool OAIS3DestinationDescription::is_bucket_arn_Valid() const{
    return m_bucket_arn_isValid;
}

QString OAIS3DestinationDescription::getPrefix() const {
    return m_prefix;
}
void OAIS3DestinationDescription::setPrefix(const QString &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIS3DestinationDescription::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIS3DestinationDescription::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QString OAIS3DestinationDescription::getErrorOutputPrefix() const {
    return m_error_output_prefix;
}
void OAIS3DestinationDescription::setErrorOutputPrefix(const QString &error_output_prefix) {
    m_error_output_prefix = error_output_prefix;
    m_error_output_prefix_isSet = true;
}

bool OAIS3DestinationDescription::is_error_output_prefix_Set() const{
    return m_error_output_prefix_isSet;
}

bool OAIS3DestinationDescription::is_error_output_prefix_Valid() const{
    return m_error_output_prefix_isValid;
}

OAIS3DestinationConfiguration_BufferingHints OAIS3DestinationDescription::getBufferingHints() const {
    return m_buffering_hints;
}
void OAIS3DestinationDescription::setBufferingHints(const OAIS3DestinationConfiguration_BufferingHints &buffering_hints) {
    m_buffering_hints = buffering_hints;
    m_buffering_hints_isSet = true;
}

bool OAIS3DestinationDescription::is_buffering_hints_Set() const{
    return m_buffering_hints_isSet;
}

bool OAIS3DestinationDescription::is_buffering_hints_Valid() const{
    return m_buffering_hints_isValid;
}

OAICompressionFormat OAIS3DestinationDescription::getCompressionFormat() const {
    return m_compression_format;
}
void OAIS3DestinationDescription::setCompressionFormat(const OAICompressionFormat &compression_format) {
    m_compression_format = compression_format;
    m_compression_format_isSet = true;
}

bool OAIS3DestinationDescription::is_compression_format_Set() const{
    return m_compression_format_isSet;
}

bool OAIS3DestinationDescription::is_compression_format_Valid() const{
    return m_compression_format_isValid;
}

OAIS3DestinationConfiguration_EncryptionConfiguration OAIS3DestinationDescription::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIS3DestinationDescription::setEncryptionConfiguration(const OAIS3DestinationConfiguration_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIS3DestinationDescription::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIS3DestinationDescription::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAIS3DestinationDescription_CloudWatchLoggingOptions OAIS3DestinationDescription::getCloudWatchLoggingOptions() const {
    return m_cloud_watch_logging_options;
}
void OAIS3DestinationDescription::setCloudWatchLoggingOptions(const OAIS3DestinationDescription_CloudWatchLoggingOptions &cloud_watch_logging_options) {
    m_cloud_watch_logging_options = cloud_watch_logging_options;
    m_cloud_watch_logging_options_isSet = true;
}

bool OAIS3DestinationDescription::is_cloud_watch_logging_options_Set() const{
    return m_cloud_watch_logging_options_isSet;
}

bool OAIS3DestinationDescription::is_cloud_watch_logging_options_Valid() const{
    return m_cloud_watch_logging_options_isValid;
}

bool OAIS3DestinationDescription::isSet() const {
...
bool OAIS3DestinationDescription::isValid() const {
