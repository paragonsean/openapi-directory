...
/*
 * OAIRedshiftDestinationUpdate_S3Update.h
 *
 * 
 */

#ifndef OAIRedshiftDestinationUpdate_S3Update_H
#define OAIRedshiftDestinationUpdate_S3Update_H
...
class OAIRedshiftDestinationUpdate_S3Update : public OAIObject {
public:
    OAIRedshiftDestinationUpdate_S3Update();
    OAIRedshiftDestinationUpdate_S3Update(QString json);
    ~OAIRedshiftDestinationUpdate_S3Update() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedshiftDestinationUpdate_S3Update)

#endif // OAIRedshiftDestinationUpdate_S3Update_H
