...
#ifndef OAIRetryOptions_H
#define OAIRetryOptions_H
...
class OAIRetryOptions : public OAIObject {
public:
    OAIRetryOptions();
    OAIRetryOptions(QString json);
    ~OAIRetryOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetryOptions)

#endif // OAIRetryOptions_H
