...
OAIOrcSerDe::OAIOrcSerDe(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrcSerDe::OAIOrcSerDe() {
    this->initializeModel();
}

OAIOrcSerDe::~OAIOrcSerDe() {}

void OAIOrcSerDe::initializeModel() {
...
void OAIOrcSerDe::fromJson(QString jsonString) {
...
void OAIOrcSerDe::fromJsonObject(QJsonObject json) {
...
QString OAIOrcSerDe::asJson() const {
...
QJsonObject OAIOrcSerDe::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIOrcSerDe::getStripeSizeBytes() const {
    return m_stripe_size_bytes;
}
void OAIOrcSerDe::setStripeSizeBytes(const qint32 &stripe_size_bytes) {
    m_stripe_size_bytes = stripe_size_bytes;
    m_stripe_size_bytes_isSet = true;
}

bool OAIOrcSerDe::is_stripe_size_bytes_Set() const{
    return m_stripe_size_bytes_isSet;
}

bool OAIOrcSerDe::is_stripe_size_bytes_Valid() const{
    return m_stripe_size_bytes_isValid;
}

qint32 OAIOrcSerDe::getBlockSizeBytes() const {
    return m_block_size_bytes;
}
void OAIOrcSerDe::setBlockSizeBytes(const qint32 &block_size_bytes) {
    m_block_size_bytes = block_size_bytes;
    m_block_size_bytes_isSet = true;
}

bool OAIOrcSerDe::is_block_size_bytes_Set() const{
    return m_block_size_bytes_isSet;
}

bool OAIOrcSerDe::is_block_size_bytes_Valid() const{
    return m_block_size_bytes_isValid;
}

qint32 OAIOrcSerDe::getRowIndexStride() const {
    return m_row_index_stride;
}
void OAIOrcSerDe::setRowIndexStride(const qint32 &row_index_stride) {
    m_row_index_stride = row_index_stride;
    m_row_index_stride_isSet = true;
}

bool OAIOrcSerDe::is_row_index_stride_Set() const{
    return m_row_index_stride_isSet;
}

bool OAIOrcSerDe::is_row_index_stride_Valid() const{
    return m_row_index_stride_isValid;
}

bool OAIOrcSerDe::getEnablePadding() const {
    return m_enable_padding;
}
void OAIOrcSerDe::setEnablePadding(const bool &enable_padding) {
    m_enable_padding = enable_padding;
    m_enable_padding_isSet = true;
}

bool OAIOrcSerDe::is_enable_padding_Set() const{
    return m_enable_padding_isSet;
}

bool OAIOrcSerDe::is_enable_padding_Valid() const{
    return m_enable_padding_isValid;
}

double OAIOrcSerDe::getPaddingTolerance() const {
    return m_padding_tolerance;
}
void OAIOrcSerDe::setPaddingTolerance(const double &padding_tolerance) {
    m_padding_tolerance = padding_tolerance;
    m_padding_tolerance_isSet = true;
}

bool OAIOrcSerDe::is_padding_tolerance_Set() const{
    return m_padding_tolerance_isSet;
}

bool OAIOrcSerDe::is_padding_tolerance_Valid() const{
    return m_padding_tolerance_isValid;
}

OAIOrcCompression OAIOrcSerDe::getCompression() const {
    return m_compression;
}
void OAIOrcSerDe::setCompression(const OAIOrcCompression &compression) {
    m_compression = compression;
    m_compression_isSet = true;
}

bool OAIOrcSerDe::is_compression_Set() const{
    return m_compression_isSet;
}

bool OAIOrcSerDe::is_compression_Valid() const{
    return m_compression_isValid;
}

QList OAIOrcSerDe::getBloomFilterColumns() const {
    return m_bloom_filter_columns;
}
void OAIOrcSerDe::setBloomFilterColumns(const QList &bloom_filter_columns) {
    m_bloom_filter_columns = bloom_filter_columns;
    m_bloom_filter_columns_isSet = true;
}

bool OAIOrcSerDe::is_bloom_filter_columns_Set() const{
    return m_bloom_filter_columns_isSet;
}

bool OAIOrcSerDe::is_bloom_filter_columns_Valid() const{
    return m_bloom_filter_columns_isValid;
}

double OAIOrcSerDe::getBloomFilterFalsePositiveProbability() const {
    return m_bloom_filter_false_positive_probability;
}
void OAIOrcSerDe::setBloomFilterFalsePositiveProbability(const double &bloom_filter_false_positive_probability) {
...
bool OAIOrcSerDe::is_bloom_filter_false_positive_probability_Set() const{
    return m_bloom_filter_false_positive_probability_isSet;
}

bool OAIOrcSerDe::is_bloom_filter_false_positive_probability_Valid() const{
    return m_bloom_filter_false_positive_probability_isValid;
}

double OAIOrcSerDe::getDictionaryKeyThreshold() const {
    return m_dictionary_key_threshold;
}
void OAIOrcSerDe::setDictionaryKeyThreshold(const double &dictionary_key_threshold) {
    m_dictionary_key_threshold = dictionary_key_threshold;
    m_dictionary_key_threshold_isSet = true;
}

bool OAIOrcSerDe::is_dictionary_key_threshold_Set() const{
    return m_dictionary_key_threshold_isSet;
}

bool OAIOrcSerDe::is_dictionary_key_threshold_Valid() const{
    return m_dictionary_key_threshold_isValid;
}

OAIOrcFormatVersion OAIOrcSerDe::getFormatVersion() const {
    return m_format_version;
}
void OAIOrcSerDe::setFormatVersion(const OAIOrcFormatVersion &format_version) {
    m_format_version = format_version;
    m_format_version_isSet = true;
}

bool OAIOrcSerDe::is_format_version_Set() const{
    return m_format_version_isSet;
}

bool OAIOrcSerDe::is_format_version_Valid() const{
    return m_format_version_isValid;
}

bool OAIOrcSerDe::isSet() const {
...
bool OAIOrcSerDe::isValid() const {
