...
/*
 * OAIHttpEndpointBufferingHints.h
 *
...
#ifndef OAIHttpEndpointBufferingHints_H
#define OAIHttpEndpointBufferingHints_H
...
class OAIHttpEndpointBufferingHints : public OAIObject {
public:
    OAIHttpEndpointBufferingHints();
    OAIHttpEndpointBufferingHints(QString json);
    ~OAIHttpEndpointBufferingHints() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpEndpointBufferingHints)

#endif // OAIHttpEndpointBufferingHints_H
