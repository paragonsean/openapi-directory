...
/*
 * OAIElasticsearchDestinationUpdate_S3Update.h
 *
 * 
 */

#ifndef OAIElasticsearchDestinationUpdate_S3Update_H
#define OAIElasticsearchDestinationUpdate_S3Update_H
...
class OAIElasticsearchDestinationUpdate_S3Update : public OAIObject {
public:
    OAIElasticsearchDestinationUpdate_S3Update();
    OAIElasticsearchDestinationUpdate_S3Update(QString json);
    ~OAIElasticsearchDestinationUpdate_S3Update() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchDestinationUpdate_S3Update)

#endif // OAIElasticsearchDestinationUpdate_S3Update_H
