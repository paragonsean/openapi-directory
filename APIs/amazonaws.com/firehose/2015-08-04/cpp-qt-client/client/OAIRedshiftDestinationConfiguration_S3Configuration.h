...
/*
 * OAIRedshiftDestinationConfiguration_S3Configuration.h
 *
 * 
 */

#ifndef OAIRedshiftDestinationConfiguration_S3Configuration_H
#define OAIRedshiftDestinationConfiguration_S3Configuration_H
...
class OAIRedshiftDestinationConfiguration_S3Configuration : public OAIObject {
public:
    OAIRedshiftDestinationConfiguration_S3Configuration();
    OAIRedshiftDestinationConfiguration_S3Configuration(QString json);
    ~OAIRedshiftDestinationConfiguration_S3Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedshiftDestinationConfiguration_S3Configuration)

#endif // OAIRedshiftDestinationConfiguration_S3Configuration_H
