...
#ifndef OAIParquetSerDe_H
#define OAIParquetSerDe_H
...
class OAIParquetSerDe : public OAIObject {
public:
    OAIParquetSerDe();
    OAIParquetSerDe(QString json);
    ~OAIParquetSerDe() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParquetSerDe)

#endif // OAIParquetSerDe_H
