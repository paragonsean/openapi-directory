...
/*
 * OAIS3DestinationDescription.h
 *
 * Describes a destination in Amazon S3.
 */

#ifndef OAIS3DestinationDescription_H
#define OAIS3DestinationDescription_H
...
class OAIS3DestinationDescription : public OAIObject {
public:
    OAIS3DestinationDescription();
    OAIS3DestinationDescription(QString json);
    ~OAIS3DestinationDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3DestinationDescription)

#endif // OAIS3DestinationDescription_H
