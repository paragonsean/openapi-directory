...
/*
 * OAIExtendedS3DestinationConfiguration_S3BackupConfiguration.h
 *
 * 
 */

#ifndef OAIExtendedS3DestinationConfiguration_S3BackupConfiguration_H
#define OAIExtendedS3DestinationConfiguration_S3BackupConfiguration_H
...
class OAIExtendedS3DestinationConfiguration_S3BackupConfiguration : public OAIObject {
public:
    OAIExtendedS3DestinationConfiguration_S3BackupConfiguration();
    OAIExtendedS3DestinationConfiguration_S3BackupConfiguration(QString json);
    ~OAIExtendedS3DestinationConfiguration_S3BackupConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtendedS3DestinationConfiguration_S3BackupConfiguration)

#endif // OAIExtendedS3DestinationConfiguration_S3BackupConfiguration_H
