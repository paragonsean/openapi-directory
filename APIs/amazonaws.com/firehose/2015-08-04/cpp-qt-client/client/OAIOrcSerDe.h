...
#ifndef OAIOrcSerDe_H
#define OAIOrcSerDe_H
...
class OAIOrcSerDe : public OAIObject {
public:
    OAIOrcSerDe();
    OAIOrcSerDe(QString json);
    ~OAIOrcSerDe() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrcSerDe)
