...
/*
 * OAISplunkDestinationUpdate_S3Update.h
 *
 * 
 */

#ifndef OAISplunkDestinationUpdate_S3Update_H
#define OAISplunkDestinationUpdate_S3Update_H
...
class OAISplunkDestinationUpdate_S3Update : public OAIObject {
public:
    OAISplunkDestinationUpdate_S3Update();
    OAISplunkDestinationUpdate_S3Update(QString json);
    ~OAISplunkDestinationUpdate_S3Update() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISplunkDestinationUpdate_S3Update)

#endif // OAISplunkDestinationUpdate_S3Update_H
