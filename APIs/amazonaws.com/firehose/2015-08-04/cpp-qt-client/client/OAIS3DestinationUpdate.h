...
/*
 * OAIS3DestinationUpdate.h
 *
 * Describes an update for a destination in Amazon S3.
 */

#ifndef OAIS3DestinationUpdate_H
#define OAIS3DestinationUpdate_H
...
class OAIS3DestinationUpdate : public OAIObject {
public:
    OAIS3DestinationUpdate();
    OAIS3DestinationUpdate(QString json);
    ~OAIS3DestinationUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3DestinationUpdate)

#endif // OAIS3DestinationUpdate_H
