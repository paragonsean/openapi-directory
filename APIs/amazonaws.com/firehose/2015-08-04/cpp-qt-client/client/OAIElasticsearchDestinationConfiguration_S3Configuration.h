...
/*
 * OAIElasticsearchDestinationConfiguration_S3Configuration.h
 *
 * 
 */

#ifndef OAIElasticsearchDestinationConfiguration_S3Configuration_H
#define OAIElasticsearchDestinationConfiguration_S3Configuration_H
...
class OAIElasticsearchDestinationConfiguration_S3Configuration : public OAIObject {
public:
    OAIElasticsearchDestinationConfiguration_S3Configuration();
    OAIElasticsearchDestinationConfiguration_S3Configuration(QString json);
    ~OAIElasticsearchDestinationConfiguration_S3Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticsearchDestinationConfiguration_S3Configuration)

#endif // OAIElasticsearchDestinationConfiguration_S3Configuration_H
