...
/*
 * OAIS3DestinationConfiguration.h
 *
 * Describes the configuration of a destination in Amazon S3.
 */

#ifndef OAIS3DestinationConfiguration_H
#define OAIS3DestinationConfiguration_H
...
class OAIS3DestinationConfiguration : public OAIObject {
public:
    OAIS3DestinationConfiguration();
    OAIS3DestinationConfiguration(QString json);
    ~OAIS3DestinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3DestinationConfiguration)

#endif // OAIS3DestinationConfiguration_H
