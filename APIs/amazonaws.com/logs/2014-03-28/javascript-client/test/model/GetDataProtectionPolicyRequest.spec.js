...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetDataProtectionPolicyRequest();
  });
  ...
  describe('GetDataProtectionPolicyRequest', function() {
    it('should create an instance of GetDataProtectionPolicyRequest', function() {
      // uncomment below and update the code to test GetDataProtectionPolicyRequest
      //var instance = new AmazonCloudWatchLogs.GetDataProtectionPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetDataProtectionPolicyRequest);
    });
