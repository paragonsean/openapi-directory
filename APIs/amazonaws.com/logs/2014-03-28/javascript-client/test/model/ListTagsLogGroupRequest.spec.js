...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ListTagsLogGroupRequest();
  });
  ...
  describe('ListTagsLogGroupRequest', function() {
    it('should create an instance of ListTagsLogGroupRequest', function() {
      // uncomment below and update the code to test ListTagsLogGroupRequest
      //var instance = new AmazonCloudWatchLogs.ListTagsLogGroupRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ListTagsLogGroupRequest);
    });
