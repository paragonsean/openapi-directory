...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeResourcePoliciesRequest();
  });
  ...
  describe('DescribeResourcePoliciesRequest', function() {
    it('should create an instance of DescribeResourcePoliciesRequest', function() {
      // uncomment below and update the code to test DescribeResourcePoliciesRequest
      //var instance = new AmazonCloudWatchLogs.DescribeResourcePoliciesRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeResourcePoliciesRequest);
    });
