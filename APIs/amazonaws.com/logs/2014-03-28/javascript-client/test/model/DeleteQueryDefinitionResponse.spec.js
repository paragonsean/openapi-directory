...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteQueryDefinitionResponse();
  });
  ...
  describe('DeleteQueryDefinitionResponse', function() {
    it('should create an instance of DeleteQueryDefinitionResponse', function() {
      // uncomment below and update the code to test DeleteQueryDefinitionResponse
      //var instance = new AmazonCloudWatchLogs.DeleteQueryDefinitionResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteQueryDefinitionResponse);
    });
