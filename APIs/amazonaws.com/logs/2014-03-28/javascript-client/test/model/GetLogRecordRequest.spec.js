...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetLogRecordRequest();
  });
  ...
  describe('GetLogRecordRequest', function() {
    it('should create an instance of GetLogRecordRequest', function() {
      // uncomment below and update the code to test GetLogRecordRequest
      //var instance = new AmazonCloudWatchLogs.GetLogRecordRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetLogRecordRequest);
    });

    it('should have the property logRecordPointer (base name: "logRecordPointer")', function() {
      // uncomment below and update the code to test the property logRecordPointer
      //var instance = new AmazonCloudWatchLogs.GetLogRecordRequest();
