...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetQueryResultsRequest();
  });
  ...
  describe('GetQueryResultsRequest', function() {
    it('should create an instance of GetQueryResultsRequest', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.GetQueryResultsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetQueryResultsRequest);
    });
