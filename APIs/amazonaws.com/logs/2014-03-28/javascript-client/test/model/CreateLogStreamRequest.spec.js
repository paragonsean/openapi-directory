...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.CreateLogStreamRequest();
  });
  ...
  describe('CreateLogStreamRequest', function() {
    it('should create an instance of CreateLogStreamRequest', function() {
      // uncomment below and update the code to test CreateLogStreamRequest
      //var instance = new AmazonCloudWatchLogs.CreateLogStreamRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.CreateLogStreamRequest);
    });
