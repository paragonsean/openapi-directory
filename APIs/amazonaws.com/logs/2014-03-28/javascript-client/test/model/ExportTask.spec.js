...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ExportTask();
  });
  ...
  describe('ExportTask', function() {
    it('should create an instance of ExportTask', function() {
      // uncomment below and update the code to test ExportTask
      //var instance = new AmazonCloudWatchLogs.ExportTask();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ExportTask);
    });
