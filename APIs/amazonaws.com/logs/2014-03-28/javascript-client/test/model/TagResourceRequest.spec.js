...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.TagResourceRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.TagResourceRequest);
    });
