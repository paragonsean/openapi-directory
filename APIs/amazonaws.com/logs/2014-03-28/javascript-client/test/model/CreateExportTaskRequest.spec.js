...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.CreateExportTaskRequest();
  });
  ...
  describe('CreateExportTaskRequest', function() {
    it('should create an instance of CreateExportTaskRequest', function() {
      // uncomment below and update the code to test CreateExportTaskRequest
      //var instance = new AmazonCloudWatchLogs.CreateExportTaskRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.CreateExportTaskRequest);
    });
    ...
    it('should have the property destinationPrefix (base name: "destinationPrefix")', function() {
      // uncomment below and update the code to test the property destinationPrefix
      //var instance = new AmazonCloudWatchLogs.CreateExportTaskRequest();
      //expect(instance).to.be();
    });
