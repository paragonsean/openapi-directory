...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteDestinationRequest();
  });
  ...
  describe('DeleteDestinationRequest', function() {
    it('should create an instance of DeleteDestinationRequest', function() {
      // uncomment below and update the code to test DeleteDestinationRequest
      //var instance = new AmazonCloudWatchLogs.DeleteDestinationRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteDestinationRequest);
    });
