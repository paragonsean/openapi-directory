...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.SearchedLogStream();
  });
  ...
  describe('SearchedLogStream', function() {
    it('should create an instance of SearchedLogStream', function() {
      // uncomment below and update the code to test SearchedLogStream
      //var instance = new AmazonCloudWatchLogs.SearchedLogStream();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.SearchedLogStream);
    });
    ...
    it('should have the property searchedCompletely (base name: "searchedCompletely")', function() {
      // uncomment below and update the code to test the property searchedCompletely
      //var instance = new AmazonCloudWatchLogs.SearchedLogStream();
      //expect(instance).to.be();
    });
