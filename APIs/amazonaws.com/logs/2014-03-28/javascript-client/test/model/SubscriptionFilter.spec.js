...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.SubscriptionFilter();
  });
  ...
  describe('SubscriptionFilter', function() {
    it('should create an instance of SubscriptionFilter', function() {
      // uncomment below and update the code to test SubscriptionFilter
      //var instance = new AmazonCloudWatchLogs.SubscriptionFilter();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.SubscriptionFilter);
    });
