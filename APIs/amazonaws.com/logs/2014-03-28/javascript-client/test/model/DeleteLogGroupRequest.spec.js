...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteLogGroupRequest();
  });
  ...
  describe('DeleteLogGroupRequest', function() {
    it('should create an instance of DeleteLogGroupRequest', function() {
      // uncomment below and update the code to test DeleteLogGroupRequest
      //var instance = new AmazonCloudWatchLogs.DeleteLogGroupRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteLogGroupRequest);
    });
