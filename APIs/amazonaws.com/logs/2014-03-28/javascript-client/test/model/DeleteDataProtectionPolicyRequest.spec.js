...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteDataProtectionPolicyRequest();
  });
  ...
  describe('DeleteDataProtectionPolicyRequest', function() {
    it('should create an instance of DeleteDataProtectionPolicyRequest', function() {
      // uncomment below and update the code to test DeleteDataProtectionPolicyRequest
      //var instance = new AmazonCloudWatchLogs.DeleteDataProtectionPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteDataProtectionPolicyRequest);
    });
