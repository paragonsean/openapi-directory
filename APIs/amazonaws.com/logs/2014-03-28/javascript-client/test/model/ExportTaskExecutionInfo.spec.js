...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ExportTaskExecutionInfo();
  });
  ...
  describe('ExportTaskExecutionInfo', function() {
    it('should create an instance of ExportTaskExecutionInfo', function() {
      // uncomment below and update the code to test ExportTaskExecutionInfo
      //var instance = new AmazonCloudWatchLogs.ExportTaskExecutionInfo();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ExportTaskExecutionInfo);
    });
