...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeQueriesResponse();
  });
  ...
  describe('DescribeQueriesResponse', function() {
    it('should create an instance of DescribeQueriesResponse', function() {
      // uncomment below and update the code to test DescribeQueriesResponse
      //var instance = new AmazonCloudWatchLogs.DescribeQueriesResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeQueriesResponse);
    });
