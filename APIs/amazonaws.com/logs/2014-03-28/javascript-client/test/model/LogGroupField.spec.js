...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.LogGroupField();
  });
  ...
  describe('LogGroupField', function() {
    it('should create an instance of LogGroupField', function() {
      // uncomment below and update the code to test LogGroupField
      //var instance = new AmazonCloudWatchLogs.LogGroupField();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.LogGroupField);
    });
