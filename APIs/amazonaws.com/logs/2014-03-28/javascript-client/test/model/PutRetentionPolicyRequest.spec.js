...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutRetentionPolicyRequest();
  });
  ...
  describe('PutRetentionPolicyRequest', function() {
    it('should create an instance of PutRetentionPolicyRequest', function() {
      // uncomment below and update the code to test PutRetentionPolicyRequest
      //var instance = new AmazonCloudWatchLogs.PutRetentionPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutRetentionPolicyRequest);
    });
