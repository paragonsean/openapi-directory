...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutDataProtectionPolicyResponse();
  });
  ...
  describe('PutDataProtectionPolicyResponse', function() {
    it('should create an instance of PutDataProtectionPolicyResponse', function() {
      // uncomment below and update the code to test PutDataProtectionPolicyResponse
      //var instance = new AmazonCloudWatchLogs.PutDataProtectionPolicyResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutDataProtectionPolicyResponse);
    });
