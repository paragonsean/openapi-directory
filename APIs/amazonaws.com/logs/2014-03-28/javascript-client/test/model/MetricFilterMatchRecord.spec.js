...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.MetricFilterMatchRecord();
  });
  ...
  describe('MetricFilterMatchRecord', function() {
    it('should create an instance of MetricFilterMatchRecord', function() {
      // uncomment below and update the code to test MetricFilterMatchRecord
      //var instance = new AmazonCloudWatchLogs.MetricFilterMatchRecord();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.MetricFilterMatchRecord);
    });
    ...
    it('should have the property extractedValues (base name: "extractedValues")', function() {
      // uncomment below and update the code to test the property extractedValues
      //var instance = new AmazonCloudWatchLogs.MetricFilterMatchRecord();
      //expect(instance).to.be();
    });
