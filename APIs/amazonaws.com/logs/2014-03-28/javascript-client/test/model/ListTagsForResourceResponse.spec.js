...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ListTagsForResourceResponse);
    });
