...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.Destination();
  });
  ...
  describe('Destination', function() {
    it('should create an instance of Destination', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.Destination();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.Destination);
    });
