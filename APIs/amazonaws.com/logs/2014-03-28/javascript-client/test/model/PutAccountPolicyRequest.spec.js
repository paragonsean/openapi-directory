...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutAccountPolicyRequest();
  });
  ...
  describe('PutAccountPolicyRequest', function() {
    it('should create an instance of PutAccountPolicyRequest', function() {
      // uncomment below and update the code to test PutAccountPolicyRequest
      //var instance = new AmazonCloudWatchLogs.PutAccountPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutAccountPolicyRequest);
    });
