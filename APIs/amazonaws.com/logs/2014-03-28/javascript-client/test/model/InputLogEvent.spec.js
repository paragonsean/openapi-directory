...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.InputLogEvent();
  });
  ...
  describe('InputLogEvent', function() {
    it('should create an instance of InputLogEvent', function() {
      // uncomment below and update the code to test InputLogEvent
      //var instance = new AmazonCloudWatchLogs.InputLogEvent();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.InputLogEvent);
    });
