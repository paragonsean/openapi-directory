...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.QueryStatistics();
  });
  ...
  describe('QueryStatistics', function() {
    it('should create an instance of QueryStatistics', function() {
      // uncomment below and update the code to test QueryStatistics
      //var instance = new AmazonCloudWatchLogs.QueryStatistics();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.QueryStatistics);
    });
