...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.StartQueryResponse();
  });
  ...
  describe('StartQueryResponse', function() {
    it('should create an instance of StartQueryResponse', function() {
      // uncomment below and update the code to test StartQueryResponse
      //var instance = new AmazonCloudWatchLogs.StartQueryResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.StartQueryResponse);
    });
