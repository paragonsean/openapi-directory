...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeAccountPoliciesResponse();
  });
  ...
  describe('DescribeAccountPoliciesResponse', function() {
    it('should create an instance of DescribeAccountPoliciesResponse', function() {
      // uncomment below and update the code to test DescribeAccountPoliciesResponse
      //var instance = new AmazonCloudWatchLogs.DescribeAccountPoliciesResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeAccountPoliciesResponse);
    });

    it('should have the property accountPolicies (base name: "accountPolicies")', function() {
      // uncomment below and update the code to test the property accountPolicies
      //var instance = new AmazonCloudWatchLogs.DescribeAccountPoliciesResponse();
