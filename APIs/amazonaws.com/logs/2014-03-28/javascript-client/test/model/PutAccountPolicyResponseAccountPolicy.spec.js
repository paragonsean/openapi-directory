...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutAccountPolicyResponseAccountPolicy();
  });
  ...
  describe('PutAccountPolicyResponseAccountPolicy', function() {
    it('should create an instance of PutAccountPolicyResponseAccountPolicy', function() {
      // uncomment below and update the code to test PutAccountPolicyResponseAccountPolicy
      //var instance = new AmazonCloudWatchLogs.PutAccountPolicyResponseAccountPolicy();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutAccountPolicyResponseAccountPolicy);
    });
