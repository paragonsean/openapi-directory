...
(function(root, factory) {
  ...
  describe('DataProtectionStatus', function() {
    it('should create an instance of DataProtectionStatus', function() {
      // uncomment below and update the code to test DataProtectionStatus
      //var instance = new AmazonCloudWatchLogs.DataProtectionStatus();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DataProtectionStatus);
    });
