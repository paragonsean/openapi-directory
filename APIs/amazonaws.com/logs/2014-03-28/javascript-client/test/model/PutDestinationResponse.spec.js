...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutDestinationResponse();
  });
  ...
  describe('PutDestinationResponse', function() {
    it('should create an instance of PutDestinationResponse', function() {
      // uncomment below and update the code to test PutDestinationResponse
      //var instance = new AmazonCloudWatchLogs.PutDestinationResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutDestinationResponse);
    });
