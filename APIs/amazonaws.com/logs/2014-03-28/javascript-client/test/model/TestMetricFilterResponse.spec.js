...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.TestMetricFilterResponse();
  });
  ...
  describe('TestMetricFilterResponse', function() {
    it('should create an instance of TestMetricFilterResponse', function() {
      // uncomment below and update the code to test TestMetricFilterResponse
      //var instance = new AmazonCloudWatchLogs.TestMetricFilterResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.TestMetricFilterResponse);
    });
