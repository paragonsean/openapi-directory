...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ListTagsForResourceRequest);
    });
