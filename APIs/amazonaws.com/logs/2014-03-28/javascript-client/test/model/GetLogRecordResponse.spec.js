...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetLogRecordResponse();
  });
  ...
  describe('GetLogRecordResponse', function() {
    it('should create an instance of GetLogRecordResponse', function() {
      // uncomment below and update the code to test GetLogRecordResponse
      //var instance = new AmazonCloudWatchLogs.GetLogRecordResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetLogRecordResponse);
    });

    it('should have the property logRecord (base name: "logRecord")', function() {
      // uncomment below and update the code to test the property logRecord
      //var instance = new AmazonCloudWatchLogs.GetLogRecordResponse();
