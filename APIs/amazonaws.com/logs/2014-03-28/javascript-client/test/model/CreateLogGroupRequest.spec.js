...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.CreateLogGroupRequest();
  });
  ...
  describe('CreateLogGroupRequest', function() {
    it('should create an instance of CreateLogGroupRequest', function() {
      // uncomment below and update the code to test CreateLogGroupRequest
      //var instance = new AmazonCloudWatchLogs.CreateLogGroupRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.CreateLogGroupRequest);
    });
