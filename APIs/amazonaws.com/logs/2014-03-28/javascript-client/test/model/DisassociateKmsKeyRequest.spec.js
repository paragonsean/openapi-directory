...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DisassociateKmsKeyRequest();
  });
  ...
  describe('DisassociateKmsKeyRequest', function() {
    it('should create an instance of DisassociateKmsKeyRequest', function() {
      // uncomment below and update the code to test DisassociateKmsKeyRequest
      //var instance = new AmazonCloudWatchLogs.DisassociateKmsKeyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DisassociateKmsKeyRequest);
    });
