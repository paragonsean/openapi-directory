...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeDestinationsResponse();
  });
  ...
  describe('DescribeDestinationsResponse', function() {
    it('should create an instance of DescribeDestinationsResponse', function() {
      // uncomment below and update the code to test DescribeDestinationsResponse
      //var instance = new AmazonCloudWatchLogs.DescribeDestinationsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeDestinationsResponse);
    });
