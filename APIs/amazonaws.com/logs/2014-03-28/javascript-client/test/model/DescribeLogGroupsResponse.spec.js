...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeLogGroupsResponse();
  });
  ...
  describe('DescribeLogGroupsResponse', function() {
    it('should create an instance of DescribeLogGroupsResponse', function() {
      // uncomment below and update the code to test DescribeLogGroupsResponse
      //var instance = new AmazonCloudWatchLogs.DescribeLogGroupsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeLogGroupsResponse);
    });
