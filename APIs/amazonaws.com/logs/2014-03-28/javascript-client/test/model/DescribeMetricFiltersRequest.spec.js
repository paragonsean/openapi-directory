...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeMetricFiltersRequest();
  });
  ...
  describe('DescribeMetricFiltersRequest', function() {
    it('should create an instance of DescribeMetricFiltersRequest', function() {
      // uncomment below and update the code to test DescribeMetricFiltersRequest
      //var instance = new AmazonCloudWatchLogs.DescribeMetricFiltersRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeMetricFiltersRequest);
    });
