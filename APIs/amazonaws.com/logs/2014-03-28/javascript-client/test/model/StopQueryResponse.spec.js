...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.StopQueryResponse();
  });
  ...
  describe('StopQueryResponse', function() {
    it('should create an instance of StopQueryResponse', function() {
      // uncomment below and update the code to test StopQueryResponse
      //var instance = new AmazonCloudWatchLogs.StopQueryResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.StopQueryResponse);
    });
