...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteRetentionPolicyRequest();
  });
  ...
  describe('DeleteRetentionPolicyRequest', function() {
    it('should create an instance of DeleteRetentionPolicyRequest', function() {
      // uncomment below and update the code to test DeleteRetentionPolicyRequest
      //var instance = new AmazonCloudWatchLogs.DeleteRetentionPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteRetentionPolicyRequest);
    });
