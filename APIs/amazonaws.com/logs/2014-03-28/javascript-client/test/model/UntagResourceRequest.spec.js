...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.UntagResourceRequest);
    });
