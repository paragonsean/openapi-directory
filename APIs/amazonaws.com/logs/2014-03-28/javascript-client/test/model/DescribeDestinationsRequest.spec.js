...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeDestinationsRequest();
  });
  ...
  describe('DescribeDestinationsRequest', function() {
    it('should create an instance of DescribeDestinationsRequest', function() {
      // uncomment below and update the code to test DescribeDestinationsRequest
      //var instance = new AmazonCloudWatchLogs.DescribeDestinationsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeDestinationsRequest);
    });

    it('should have the property destinationNamePrefix (base name: "DestinationNamePrefix")', function() {
      // uncomment below and update the code to test the property destinationNamePrefix
      //var instance = new AmazonCloudWatchLogs.DescribeDestinationsRequest();
