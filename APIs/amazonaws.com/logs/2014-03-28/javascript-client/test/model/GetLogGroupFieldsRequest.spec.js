...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetLogGroupFieldsRequest();
  });
  ...
  describe('GetLogGroupFieldsRequest', function() {
    it('should create an instance of GetLogGroupFieldsRequest', function() {
      // uncomment below and update the code to test GetLogGroupFieldsRequest
      //var instance = new AmazonCloudWatchLogs.GetLogGroupFieldsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetLogGroupFieldsRequest);
    });
