...
(function(root, factory) {
  ...
  describe('InheritedProperty', function() {
    it('should create an instance of InheritedProperty', function() {
      // uncomment below and update the code to test InheritedProperty
      //var instance = new AmazonCloudWatchLogs.InheritedProperty();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.InheritedProperty);
    });
