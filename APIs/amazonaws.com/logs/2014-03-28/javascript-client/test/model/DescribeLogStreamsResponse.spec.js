...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeLogStreamsResponse();
  });
  ...
  describe('DescribeLogStreamsResponse', function() {
    it('should create an instance of DescribeLogStreamsResponse', function() {
      // uncomment below and update the code to test DescribeLogStreamsResponse
      //var instance = new AmazonCloudWatchLogs.DescribeLogStreamsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeLogStreamsResponse);
    });

    it('should have the property logStreams (base name: "logStreams")', function() {
      // uncomment below and update the code to test the property logStreams
      //var instance = new AmazonCloudWatchLogs.DescribeLogStreamsResponse();
