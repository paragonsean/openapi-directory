...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetLogGroupFieldsResponse();
  });
  ...
  describe('GetLogGroupFieldsResponse', function() {
    it('should create an instance of GetLogGroupFieldsResponse', function() {
      // uncomment below and update the code to test GetLogGroupFieldsResponse
      //var instance = new AmazonCloudWatchLogs.GetLogGroupFieldsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetLogGroupFieldsResponse);
    });

    it('should have the property logGroupFields (base name: "logGroupFields")', function() {
      // uncomment below and update the code to test the property logGroupFields
      //var instance = new AmazonCloudWatchLogs.GetLogGroupFieldsResponse();
