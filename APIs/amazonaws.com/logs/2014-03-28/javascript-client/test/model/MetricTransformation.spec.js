...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.MetricTransformation();
  });
  ...
  describe('MetricTransformation', function() {
    it('should create an instance of MetricTransformation', function() {
      // uncomment below and update the code to test MetricTransformation
      //var instance = new AmazonCloudWatchLogs.MetricTransformation();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.MetricTransformation);
    });
