...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteResourcePolicyRequest();
  });
  ...
  describe('DeleteResourcePolicyRequest', function() {
    it('should create an instance of DeleteResourcePolicyRequest', function() {
      // uncomment below and update the code to test DeleteResourcePolicyRequest
      //var instance = new AmazonCloudWatchLogs.DeleteResourcePolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteResourcePolicyRequest);
    });
