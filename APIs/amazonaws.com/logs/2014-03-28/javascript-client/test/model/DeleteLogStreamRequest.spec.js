...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteLogStreamRequest();
  });
  ...
  describe('DeleteLogStreamRequest', function() {
    it('should create an instance of DeleteLogStreamRequest', function() {
      // uncomment below and update the code to test DeleteLogStreamRequest
      //var instance = new AmazonCloudWatchLogs.DeleteLogStreamRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteLogStreamRequest);
    });
