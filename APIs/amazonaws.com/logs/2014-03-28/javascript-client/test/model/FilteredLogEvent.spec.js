...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.FilteredLogEvent();
  });
  ...
  describe('FilteredLogEvent', function() {
    it('should create an instance of FilteredLogEvent', function() {
      // uncomment below and update the code to test FilteredLogEvent
      //var instance = new AmazonCloudWatchLogs.FilteredLogEvent();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.FilteredLogEvent);
    });
    ...
    it('should have the property ingestionTime (base name: "ingestionTime")', function() {
      // uncomment below and update the code to test the property ingestionTime
      //var instance = new AmazonCloudWatchLogs.FilteredLogEvent();
      //expect(instance).to.be();
    });
