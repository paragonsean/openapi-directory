...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ResourcePolicy();
  });
  ...
  describe('ResourcePolicy', function() {
    it('should create an instance of ResourcePolicy', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.ResourcePolicy();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ResourcePolicy);
    });
