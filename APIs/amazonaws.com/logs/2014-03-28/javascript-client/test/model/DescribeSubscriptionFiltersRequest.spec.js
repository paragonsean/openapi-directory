...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeSubscriptionFiltersRequest();
  });
  ...
  describe('DescribeSubscriptionFiltersRequest', function() {
    it('should create an instance of DescribeSubscriptionFiltersRequest', function() {
      // uncomment below and update the code to test DescribeSubscriptionFiltersRequest
      //var instance = new AmazonCloudWatchLogs.DescribeSubscriptionFiltersRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeSubscriptionFiltersRequest);
    });
    ...
    it('should have the property filterNamePrefix (base name: "filterNamePrefix")', function() {
      // uncomment below and update the code to test the property filterNamePrefix
      //var instance = new AmazonCloudWatchLogs.DescribeSubscriptionFiltersRequest();
      //expect(instance).to.be();
    });
