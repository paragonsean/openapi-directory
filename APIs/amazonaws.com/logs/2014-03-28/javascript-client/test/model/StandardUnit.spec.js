...
(function(root, factory) {
  ...
  describe('StandardUnit', function() {
    it('should create an instance of StandardUnit', function() {
      // uncomment below and update the code to test StandardUnit
      //var instance = new AmazonCloudWatchLogs.StandardUnit();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.StandardUnit);
    });
