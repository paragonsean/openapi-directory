...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteMetricFilterRequest();
  });
  ...
  describe('DeleteMetricFilterRequest', function() {
    it('should create an instance of DeleteMetricFilterRequest', function() {
      // uncomment below and update the code to test DeleteMetricFilterRequest
      //var instance = new AmazonCloudWatchLogs.DeleteMetricFilterRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteMetricFilterRequest);
    });
