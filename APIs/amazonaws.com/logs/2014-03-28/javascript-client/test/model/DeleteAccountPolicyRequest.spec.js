...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteAccountPolicyRequest();
  });
  ...
  describe('DeleteAccountPolicyRequest', function() {
    it('should create an instance of DeleteAccountPolicyRequest', function() {
      // uncomment below and update the code to test DeleteAccountPolicyRequest
      //var instance = new AmazonCloudWatchLogs.DeleteAccountPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteAccountPolicyRequest);
    });
