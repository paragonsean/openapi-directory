...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutAccountPolicyResponse();
  });
  ...
  describe('PutAccountPolicyResponse', function() {
    it('should create an instance of PutAccountPolicyResponse', function() {
      // uncomment below and update the code to test PutAccountPolicyResponse
      //var instance = new AmazonCloudWatchLogs.PutAccountPolicyResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutAccountPolicyResponse);
    });

    it('should have the property accountPolicy (base name: "accountPolicy")', function() {
      // uncomment below and update the code to test the property accountPolicy
      //var instance = new AmazonCloudWatchLogs.PutAccountPolicyResponse();
