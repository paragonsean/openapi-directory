...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteSubscriptionFilterRequest();
  });
  ...
  describe('DeleteSubscriptionFilterRequest', function() {
    it('should create an instance of DeleteSubscriptionFilterRequest', function() {
      // uncomment below and update the code to test DeleteSubscriptionFilterRequest
      //var instance = new AmazonCloudWatchLogs.DeleteSubscriptionFilterRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteSubscriptionFilterRequest);
    });
