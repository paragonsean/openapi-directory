...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.LogStream();
  });
  ...
  describe('LogStream', function() {
    it('should create an instance of LogStream', function() {
      // uncomment below and update the code to test LogStream
      //var instance = new AmazonCloudWatchLogs.LogStream();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.LogStream);
    });
    ...
    it('should have the property firstEventTimestamp (base name: "firstEventTimestamp")', function() {
      // uncomment below and update the code to test the property firstEventTimestamp
      //var instance = new AmazonCloudWatchLogs.LogStream();
      //expect(instance).to.be();
    });

    it('should have the property lastEventTimestamp (base name: "lastEventTimestamp")', function() {
      // uncomment below and update the code to test the property lastEventTimestamp
      //var instance = new AmazonCloudWatchLogs.LogStream();
      //expect(instance).to.be();
    });

    it('should have the property lastIngestionTime (base name: "lastIngestionTime")', function() {
      // uncomment below and update the code to test the property lastIngestionTime
      //var instance = new AmazonCloudWatchLogs.LogStream();
      //expect(instance).to.be();
    });

    it('should have the property uploadSequenceToken (base name: "uploadSequenceToken")', function() {
      // uncomment below and update the code to test the property uploadSequenceToken
      //var instance = new AmazonCloudWatchLogs.LogStream();
      //expect(instance).to.be();
    });
