...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetLogEventsRequest();
  });
  ...
  describe('GetLogEventsRequest', function() {
    it('should create an instance of GetLogEventsRequest', function() {
      // uncomment below and update the code to test GetLogEventsRequest
      //var instance = new AmazonCloudWatchLogs.GetLogEventsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetLogEventsRequest);
    });
    ...
    it('should have the property logGroupIdentifier (base name: "logGroupIdentifier")', function() {
      // uncomment below and update the code to test the property logGroupIdentifier
      //var instance = new AmazonCloudWatchLogs.GetLogEventsRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property startFromHead (base name: "startFromHead")', function() {
      // uncomment below and update the code to test the property startFromHead
      //var instance = new AmazonCloudWatchLogs.GetLogEventsRequest();
      //expect(instance).to.be();
    });

    it('should have the property unmask (base name: "unmask")', function() {
      // uncomment below and update the code to test the property unmask
      //var instance = new AmazonCloudWatchLogs.GetLogEventsRequest();
      //expect(instance).to.be();
    });
