...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutLogEventsResponseRejectedLogEventsInfo();
  });
  ...
  describe('PutLogEventsResponseRejectedLogEventsInfo', function() {
    it('should create an instance of PutLogEventsResponseRejectedLogEventsInfo', function() {
      // uncomment below and update the code to test PutLogEventsResponseRejectedLogEventsInfo
      //var instance = new AmazonCloudWatchLogs.PutLogEventsResponseRejectedLogEventsInfo();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutLogEventsResponseRejectedLogEventsInfo);
    });
