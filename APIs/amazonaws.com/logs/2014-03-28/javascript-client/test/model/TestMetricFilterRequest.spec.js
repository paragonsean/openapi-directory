...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.TestMetricFilterRequest();
  });
  ...
  describe('TestMetricFilterRequest', function() {
    it('should create an instance of TestMetricFilterRequest', function() {
      // uncomment below and update the code to test TestMetricFilterRequest
      //var instance = new AmazonCloudWatchLogs.TestMetricFilterRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.TestMetricFilterRequest);
    });
    ...
    it('should have the property logEventMessages (base name: "logEventMessages")', function() {
      // uncomment below and update the code to test the property logEventMessages
      //var instance = new AmazonCloudWatchLogs.TestMetricFilterRequest();
      //expect(instance).to.be();
    });
