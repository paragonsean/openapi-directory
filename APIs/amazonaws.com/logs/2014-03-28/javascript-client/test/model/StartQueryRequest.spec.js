...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.StartQueryRequest();
  });
  ...
  describe('StartQueryRequest', function() {
    it('should create an instance of StartQueryRequest', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.StartQueryRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.StartQueryRequest);
    });
    ...
    it('should have the property logGroupIdentifiers (base name: "logGroupIdentifiers")', function() {
      // uncomment below and update the code to test the property logGroupIdentifiers
      //var instance = new AmazonCloudWatchLogs.StartQueryRequest();
      //expect(instance).to.be();
    });
