...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutQueryDefinitionRequest();
  });
  ...
  describe('PutQueryDefinitionRequest', function() {
    it('should create an instance of PutQueryDefinitionRequest', function() {
      // uncomment below and update the code to test PutQueryDefinitionRequest
      //var instance = new AmazonCloudWatchLogs.PutQueryDefinitionRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutQueryDefinitionRequest);
    });
    ...
    it('should have the property logGroupNames (base name: "logGroupNames")', function() {
      // uncomment below and update the code to test the property logGroupNames
      //var instance = new AmazonCloudWatchLogs.PutQueryDefinitionRequest();
      //expect(instance).to.be();
    });
