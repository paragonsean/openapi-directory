...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetLogEventsResponse();
  });
  ...
  describe('GetLogEventsResponse', function() {
    it('should create an instance of GetLogEventsResponse', function() {
      // uncomment below and update the code to test GetLogEventsResponse
      //var instance = new AmazonCloudWatchLogs.GetLogEventsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetLogEventsResponse);
    });
    ...
    it('should have the property nextForwardToken (base name: "nextForwardToken")', function() {
      // uncomment below and update the code to test the property nextForwardToken
      //var instance = new AmazonCloudWatchLogs.GetLogEventsResponse();
      //expect(instance).to.be();
    });

    it('should have the property nextBackwardToken (base name: "nextBackwardToken")', function() {
      // uncomment below and update the code to test the property nextBackwardToken
      //var instance = new AmazonCloudWatchLogs.GetLogEventsResponse();
      //expect(instance).to.be();
    });
