...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DeleteQueryDefinitionRequest();
  });
  ...
  describe('DeleteQueryDefinitionRequest', function() {
    it('should create an instance of DeleteQueryDefinitionRequest', function() {
      // uncomment below and update the code to test DeleteQueryDefinitionRequest
      //var instance = new AmazonCloudWatchLogs.DeleteQueryDefinitionRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DeleteQueryDefinitionRequest);
    });
