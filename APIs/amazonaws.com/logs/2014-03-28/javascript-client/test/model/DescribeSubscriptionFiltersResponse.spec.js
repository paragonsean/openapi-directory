...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeSubscriptionFiltersResponse();
  });
  ...
  describe('DescribeSubscriptionFiltersResponse', function() {
    it('should create an instance of DescribeSubscriptionFiltersResponse', function() {
      // uncomment below and update the code to test DescribeSubscriptionFiltersResponse
      //var instance = new AmazonCloudWatchLogs.DescribeSubscriptionFiltersResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeSubscriptionFiltersResponse);
    });

    it('should have the property subscriptionFilters (base name: "subscriptionFilters")', function() {
      // uncomment below and update the code to test the property subscriptionFilters
      //var instance = new AmazonCloudWatchLogs.DescribeSubscriptionFiltersResponse();
