...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutSubscriptionFilterRequest();
  });
  ...
  describe('PutSubscriptionFilterRequest', function() {
    it('should create an instance of PutSubscriptionFilterRequest', function() {
      // uncomment below and update the code to test PutSubscriptionFilterRequest
      //var instance = new AmazonCloudWatchLogs.PutSubscriptionFilterRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutSubscriptionFilterRequest);
    });
    ...
    it('should have the property filterPattern (base name: "filterPattern")', function() {
      // uncomment below and update the code to test the property filterPattern
      //var instance = new AmazonCloudWatchLogs.PutSubscriptionFilterRequest();
      //expect(instance).to.be();
    });
