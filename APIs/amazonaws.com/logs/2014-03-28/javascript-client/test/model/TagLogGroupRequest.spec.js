...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.TagLogGroupRequest();
  });
  ...
  describe('TagLogGroupRequest', function() {
    it('should create an instance of TagLogGroupRequest', function() {
      // uncomment below and update the code to test TagLogGroupRequest
      //var instance = new AmazonCloudWatchLogs.TagLogGroupRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.TagLogGroupRequest);
    });
