...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutDestinationPolicyRequest();
  });
  ...
  describe('PutDestinationPolicyRequest', function() {
    it('should create an instance of PutDestinationPolicyRequest', function() {
      // uncomment below and update the code to test PutDestinationPolicyRequest
      //var instance = new AmazonCloudWatchLogs.PutDestinationPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutDestinationPolicyRequest);
    });
