...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetDataProtectionPolicyResponse();
  });
  ...
  describe('GetDataProtectionPolicyResponse', function() {
    it('should create an instance of GetDataProtectionPolicyResponse', function() {
      // uncomment below and update the code to test GetDataProtectionPolicyResponse
      //var instance = new AmazonCloudWatchLogs.GetDataProtectionPolicyResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetDataProtectionPolicyResponse);
    });
