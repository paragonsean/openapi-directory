...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeLogGroupsRequest();
  });
  ...
  describe('DescribeLogGroupsRequest', function() {
    it('should create an instance of DescribeLogGroupsRequest', function() {
      // uncomment below and update the code to test DescribeLogGroupsRequest
      //var instance = new AmazonCloudWatchLogs.DescribeLogGroupsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeLogGroupsRequest);
    });
    ...
    it('should have the property logGroupNamePrefix (base name: "logGroupNamePrefix")', function() {
      // uncomment below and update the code to test the property logGroupNamePrefix
      //var instance = new AmazonCloudWatchLogs.DescribeLogGroupsRequest();
      //expect(instance).to.be();
    });

    it('should have the property logGroupNamePattern (base name: "logGroupNamePattern")', function() {
      // uncomment below and update the code to test the property logGroupNamePattern
      //var instance = new AmazonCloudWatchLogs.DescribeLogGroupsRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property includeLinkedAccounts (base name: "includeLinkedAccounts")', function() {
      // uncomment below and update the code to test the property includeLinkedAccounts
      //var instance = new AmazonCloudWatchLogs.DescribeLogGroupsRequest();
      //expect(instance).to.be();
    });
