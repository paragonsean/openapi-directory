...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutResourcePolicyResponse();
  });
  ...
  describe('PutResourcePolicyResponse', function() {
    it('should create an instance of PutResourcePolicyResponse', function() {
      // uncomment below and update the code to test PutResourcePolicyResponse
      //var instance = new AmazonCloudWatchLogs.PutResourcePolicyResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutResourcePolicyResponse);
    });
