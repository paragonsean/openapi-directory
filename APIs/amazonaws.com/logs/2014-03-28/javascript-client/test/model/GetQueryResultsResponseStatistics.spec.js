...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.GetQueryResultsResponseStatistics();
  });
  ...
  describe('GetQueryResultsResponseStatistics', function() {
    it('should create an instance of GetQueryResultsResponseStatistics', function() {
      // uncomment below and update the code to test GetQueryResultsResponseStatistics
      //var instance = new AmazonCloudWatchLogs.GetQueryResultsResponseStatistics();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.GetQueryResultsResponseStatistics);
    });

    it('should have the property recordsMatched (base name: "recordsMatched")', function() {
      // uncomment below and update the code to test the property recordsMatched
      //var instance = new AmazonCloudWatchLogs.GetQueryResultsResponseStatistics();
