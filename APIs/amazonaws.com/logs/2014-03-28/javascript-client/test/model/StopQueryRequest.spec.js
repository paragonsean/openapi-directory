...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.StopQueryRequest();
  });
  ...
  describe('StopQueryRequest', function() {
    it('should create an instance of StopQueryRequest', function() {
      // uncomment below and update the code to test StopQueryRequest
      //var instance = new AmazonCloudWatchLogs.StopQueryRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.StopQueryRequest);
    });
