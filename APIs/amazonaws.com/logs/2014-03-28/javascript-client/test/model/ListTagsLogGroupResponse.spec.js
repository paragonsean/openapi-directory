...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ListTagsLogGroupResponse();
  });
  ...
  describe('ListTagsLogGroupResponse', function() {
    it('should create an instance of ListTagsLogGroupResponse', function() {
      // uncomment below and update the code to test ListTagsLogGroupResponse
      //var instance = new AmazonCloudWatchLogs.ListTagsLogGroupResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ListTagsLogGroupResponse);
    });
