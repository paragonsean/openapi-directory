...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.RejectedLogEventsInfo();
  });
  ...
  describe('RejectedLogEventsInfo', function() {
    it('should create an instance of RejectedLogEventsInfo', function() {
      // uncomment below and update the code to test RejectedLogEventsInfo
      //var instance = new AmazonCloudWatchLogs.RejectedLogEventsInfo();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.RejectedLogEventsInfo);
    });

    it('should have the property tooNewLogEventStartIndex (base name: "tooNewLogEventStartIndex")', function() {
      // uncomment below and update the code to test the property tooNewLogEventStartIndex
      //var instance = new AmazonCloudWatchLogs.RejectedLogEventsInfo();
      //expect(instance).to.be();
    });

    it('should have the property tooOldLogEventEndIndex (base name: "tooOldLogEventEndIndex")', function() {
      // uncomment below and update the code to test the property tooOldLogEventEndIndex
      //var instance = new AmazonCloudWatchLogs.RejectedLogEventsInfo();
      //expect(instance).to.be();
    });

    it('should have the property expiredLogEventEndIndex (base name: "expiredLogEventEndIndex")', function() {
      // uncomment below and update the code to test the property expiredLogEventEndIndex
      //var instance = new AmazonCloudWatchLogs.RejectedLogEventsInfo();
      //expect(instance).to.be();
    });
