...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutLogEventsRequest();
  });
  ...
  describe('PutLogEventsRequest', function() {
    it('should create an instance of PutLogEventsRequest', function() {
      // uncomment below and update the code to test PutLogEventsRequest
      //var instance = new AmazonCloudWatchLogs.PutLogEventsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutLogEventsRequest);
    });
    ...
    it('should have the property logEvents (base name: "logEvents")', function() {
      // uncomment below and update the code to test the property logEvents
      //var instance = new AmazonCloudWatchLogs.PutLogEventsRequest();
      //expect(instance).to.be();
    });

    it('should have the property sequenceToken (base name: "sequenceToken")', function() {
      // uncomment below and update the code to test the property sequenceToken
      //var instance = new AmazonCloudWatchLogs.PutLogEventsRequest();
      //expect(instance).to.be();
    });
