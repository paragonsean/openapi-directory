...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.MetricFilter();
  });
  ...
  describe('MetricFilter', function() {
    it('should create an instance of MetricFilter', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.MetricFilter();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.MetricFilter);
    });
