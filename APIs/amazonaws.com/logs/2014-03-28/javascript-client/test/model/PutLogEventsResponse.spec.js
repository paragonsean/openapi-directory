...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutLogEventsResponse();
  });
  ...
  describe('PutLogEventsResponse', function() {
    it('should create an instance of PutLogEventsResponse', function() {
      // uncomment below and update the code to test PutLogEventsResponse
      //var instance = new AmazonCloudWatchLogs.PutLogEventsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutLogEventsResponse);
    });

    it('should have the property nextSequenceToken (base name: "nextSequenceToken")', function() {
      // uncomment below and update the code to test the property nextSequenceToken
      //var instance = new AmazonCloudWatchLogs.PutLogEventsResponse();
      //expect(instance).to.be();
    });

    it('should have the property rejectedLogEventsInfo (base name: "rejectedLogEventsInfo")', function() {
      // uncomment below and update the code to test the property rejectedLogEventsInfo
      //var instance = new AmazonCloudWatchLogs.PutLogEventsResponse();
      //expect(instance).to.be();
    });
