...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.AssociateKmsKeyRequest();
  });
  ...
  describe('AssociateKmsKeyRequest', function() {
    it('should create an instance of AssociateKmsKeyRequest', function() {
      // uncomment below and update the code to test AssociateKmsKeyRequest
      //var instance = new AmazonCloudWatchLogs.AssociateKmsKeyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.AssociateKmsKeyRequest);
    });
