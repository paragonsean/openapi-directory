...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ResultField();
  });
  ...
  describe('ResultField', function() {
    it('should create an instance of ResultField', function() {
      // uncomment below and update the code to test ResultField
      //var instance = new AmazonCloudWatchLogs.ResultField();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ResultField);
    });
