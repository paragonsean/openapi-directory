...
(function(root, factory) {
  ...
  describe('ExportTaskStatusCode', function() {
    it('should create an instance of ExportTaskStatusCode', function() {
      // uncomment below and update the code to test ExportTaskStatusCode
      //var instance = new AmazonCloudWatchLogs.ExportTaskStatusCode();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ExportTaskStatusCode);
    });
