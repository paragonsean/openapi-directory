...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.OutputLogEvent();
  });
  ...
  describe('OutputLogEvent', function() {
    it('should create an instance of OutputLogEvent', function() {
      // uncomment below and update the code to test OutputLogEvent
      //var instance = new AmazonCloudWatchLogs.OutputLogEvent();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.OutputLogEvent);
    });
