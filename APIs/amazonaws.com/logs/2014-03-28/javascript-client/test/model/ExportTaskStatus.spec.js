...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.ExportTaskStatus();
  });
  ...
  describe('ExportTaskStatus', function() {
    it('should create an instance of ExportTaskStatus', function() {
      // uncomment below and update the code to test ExportTaskStatus
      //var instance = new AmazonCloudWatchLogs.ExportTaskStatus();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.ExportTaskStatus);
    });
