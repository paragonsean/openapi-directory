...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutMetricFilterRequest();
  });
  ...
  describe('PutMetricFilterRequest', function() {
    it('should create an instance of PutMetricFilterRequest', function() {
      // uncomment below and update the code to test PutMetricFilterRequest
      //var instance = new AmazonCloudWatchLogs.PutMetricFilterRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutMetricFilterRequest);
    });
    ...
    it('should have the property metricTransformations (base name: "metricTransformations")', function() {
      // uncomment below and update the code to test the property metricTransformations
      //var instance = new AmazonCloudWatchLogs.PutMetricFilterRequest();
      //expect(instance).to.be();
    });
