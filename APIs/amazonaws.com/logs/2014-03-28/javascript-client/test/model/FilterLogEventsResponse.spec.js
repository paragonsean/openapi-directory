...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.FilterLogEventsResponse();
  });
  ...
  describe('FilterLogEventsResponse', function() {
    it('should create an instance of FilterLogEventsResponse', function() {
      // uncomment below and update the code to test FilterLogEventsResponse
      //var instance = new AmazonCloudWatchLogs.FilterLogEventsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.FilterLogEventsResponse);
    });
    ...
    it('should have the property searchedLogStreams (base name: "searchedLogStreams")', function() {
      // uncomment below and update the code to test the property searchedLogStreams
      //var instance = new AmazonCloudWatchLogs.FilterLogEventsResponse();
      //expect(instance).to.be();
    });
