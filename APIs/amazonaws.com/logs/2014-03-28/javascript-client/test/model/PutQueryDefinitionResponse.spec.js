...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutQueryDefinitionResponse();
  });
  ...
  describe('PutQueryDefinitionResponse', function() {
    it('should create an instance of PutQueryDefinitionResponse', function() {
      // uncomment below and update the code to test PutQueryDefinitionResponse
      //var instance = new AmazonCloudWatchLogs.PutQueryDefinitionResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutQueryDefinitionResponse);
    });

    it('should have the property queryDefinitionId (base name: "queryDefinitionId")', function() {
      // uncomment below and update the code to test the property queryDefinitionId
      //var instance = new AmazonCloudWatchLogs.PutQueryDefinitionResponse();
