...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutDestinationRequest();
  });
  ...
  describe('PutDestinationRequest', function() {
    it('should create an instance of PutDestinationRequest', function() {
      // uncomment below and update the code to test PutDestinationRequest
      //var instance = new AmazonCloudWatchLogs.PutDestinationRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutDestinationRequest);
    });
