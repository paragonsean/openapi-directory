...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeAccountPoliciesRequest();
  });
  ...
  describe('DescribeAccountPoliciesRequest', function() {
    it('should create an instance of DescribeAccountPoliciesRequest', function() {
      // uncomment below and update the code to test DescribeAccountPoliciesRequest
      //var instance = new AmazonCloudWatchLogs.DescribeAccountPoliciesRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeAccountPoliciesRequest);
    });
