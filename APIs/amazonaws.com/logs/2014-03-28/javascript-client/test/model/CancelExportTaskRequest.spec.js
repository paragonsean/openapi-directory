...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.CancelExportTaskRequest();
  });
  ...
  describe('CancelExportTaskRequest', function() {
    it('should create an instance of CancelExportTaskRequest', function() {
      // uncomment below and update the code to test CancelExportTaskRequest
      //var instance = new AmazonCloudWatchLogs.CancelExportTaskRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.CancelExportTaskRequest);
    });
