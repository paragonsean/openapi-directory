...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.AccountPolicy();
  });
  ...
  describe('AccountPolicy', function() {
    it('should create an instance of AccountPolicy', function() {
      // uncomment below and update the code to test AccountPolicy
      //var instance = new AmazonCloudWatchLogs.AccountPolicy();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.AccountPolicy);
    });
