...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutDataProtectionPolicyRequest();
  });
  ...
  describe('PutDataProtectionPolicyRequest', function() {
    it('should create an instance of PutDataProtectionPolicyRequest', function() {
      // uncomment below and update the code to test PutDataProtectionPolicyRequest
      //var instance = new AmazonCloudWatchLogs.PutDataProtectionPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutDataProtectionPolicyRequest);
    });
