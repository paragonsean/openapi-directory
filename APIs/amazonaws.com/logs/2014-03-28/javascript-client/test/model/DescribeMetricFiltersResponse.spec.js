...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeMetricFiltersResponse();
  });
  ...
  describe('DescribeMetricFiltersResponse', function() {
    it('should create an instance of DescribeMetricFiltersResponse', function() {
      // uncomment below and update the code to test DescribeMetricFiltersResponse
      //var instance = new AmazonCloudWatchLogs.DescribeMetricFiltersResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeMetricFiltersResponse);
    });
