...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeQueriesRequest();
  });
  ...
  describe('DescribeQueriesRequest', function() {
    it('should create an instance of DescribeQueriesRequest', function() {
      // uncomment below and update the code to test DescribeQueriesRequest
      //var instance = new AmazonCloudWatchLogs.DescribeQueriesRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeQueriesRequest);
    });
