...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeExportTasksRequest();
  });
  ...
  describe('DescribeExportTasksRequest', function() {
    it('should create an instance of DescribeExportTasksRequest', function() {
      ...
      //var instance = new AmazonCloudWatchLogs.DescribeExportTasksRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeExportTasksRequest);
    });
