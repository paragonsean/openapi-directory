...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeLogStreamsRequest();
  });
  ...
  describe('DescribeLogStreamsRequest', function() {
    it('should create an instance of DescribeLogStreamsRequest', function() {
      // uncomment below and update the code to test DescribeLogStreamsRequest
      //var instance = new AmazonCloudWatchLogs.DescribeLogStreamsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeLogStreamsRequest);
    });
    ...
    it('should have the property logStreamNamePrefix (base name: "logStreamNamePrefix")', function() {
      // uncomment below and update the code to test the property logStreamNamePrefix
      //var instance = new AmazonCloudWatchLogs.DescribeLogStreamsRequest();
      //expect(instance).to.be();
    });
