...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeExportTasksResponse();
  });
  ...
  describe('DescribeExportTasksResponse', function() {
    it('should create an instance of DescribeExportTasksResponse', function() {
      // uncomment below and update the code to test DescribeExportTasksResponse
      //var instance = new AmazonCloudWatchLogs.DescribeExportTasksResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeExportTasksResponse);
    });

    it('should have the property exportTasks (base name: "exportTasks")', function() {
      // uncomment below and update the code to test the property exportTasks
      //var instance = new AmazonCloudWatchLogs.DescribeExportTasksResponse();
