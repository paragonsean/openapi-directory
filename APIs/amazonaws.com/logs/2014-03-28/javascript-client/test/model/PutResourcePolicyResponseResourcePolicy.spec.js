...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutResourcePolicyResponseResourcePolicy();
  });
  ...
  describe('PutResourcePolicyResponseResourcePolicy', function() {
    it('should create an instance of PutResourcePolicyResponseResourcePolicy', function() {
      // uncomment below and update the code to test PutResourcePolicyResponseResourcePolicy
      //var instance = new AmazonCloudWatchLogs.PutResourcePolicyResponseResourcePolicy();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutResourcePolicyResponseResourcePolicy);
    });
