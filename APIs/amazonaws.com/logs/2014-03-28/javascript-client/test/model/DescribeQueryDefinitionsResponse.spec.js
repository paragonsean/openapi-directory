...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeQueryDefinitionsResponse();
  });
  ...
  describe('DescribeQueryDefinitionsResponse', function() {
    it('should create an instance of DescribeQueryDefinitionsResponse', function() {
      // uncomment below and update the code to test DescribeQueryDefinitionsResponse
      //var instance = new AmazonCloudWatchLogs.DescribeQueryDefinitionsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeQueryDefinitionsResponse);
    });

    it('should have the property queryDefinitions (base name: "queryDefinitions")', function() {
      // uncomment below and update the code to test the property queryDefinitions
      //var instance = new AmazonCloudWatchLogs.DescribeQueryDefinitionsResponse();
