...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.CreateExportTaskResponse();
  });
  ...
  describe('CreateExportTaskResponse', function() {
    it('should create an instance of CreateExportTaskResponse', function() {
      // uncomment below and update the code to test CreateExportTaskResponse
      //var instance = new AmazonCloudWatchLogs.CreateExportTaskResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.CreateExportTaskResponse);
    });
