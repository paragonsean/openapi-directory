...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeResourcePoliciesResponse();
  });
  ...
  describe('DescribeResourcePoliciesResponse', function() {
    it('should create an instance of DescribeResourcePoliciesResponse', function() {
      // uncomment below and update the code to test DescribeResourcePoliciesResponse
      //var instance = new AmazonCloudWatchLogs.DescribeResourcePoliciesResponse();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeResourcePoliciesResponse);
    });
