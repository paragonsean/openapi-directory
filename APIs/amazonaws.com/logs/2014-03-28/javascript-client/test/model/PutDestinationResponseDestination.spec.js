...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.PutDestinationResponseDestination();
  });
  ...
  describe('PutDestinationResponseDestination', function() {
    it('should create an instance of PutDestinationResponseDestination', function() {
      // uncomment below and update the code to test PutDestinationResponseDestination
      //var instance = new AmazonCloudWatchLogs.PutDestinationResponseDestination();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.PutDestinationResponseDestination);
    });
