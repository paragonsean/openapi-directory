...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.DescribeQueryDefinitionsRequest();
  });
  ...
  describe('DescribeQueryDefinitionsRequest', function() {
    it('should create an instance of DescribeQueryDefinitionsRequest', function() {
      // uncomment below and update the code to test DescribeQueryDefinitionsRequest
      //var instance = new AmazonCloudWatchLogs.DescribeQueryDefinitionsRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.DescribeQueryDefinitionsRequest);
    });

    it('should have the property queryDefinitionNamePrefix (base name: "queryDefinitionNamePrefix")', function() {
      // uncomment below and update the code to test the property queryDefinitionNamePrefix
      //var instance = new AmazonCloudWatchLogs.DescribeQueryDefinitionsRequest();
