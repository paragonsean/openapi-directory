...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchLogs.UntagLogGroupRequest();
  });
  ...
  describe('UntagLogGroupRequest', function() {
    it('should create an instance of UntagLogGroupRequest', function() {
      // uncomment below and update the code to test UntagLogGroupRequest
      //var instance = new AmazonCloudWatchLogs.UntagLogGroupRequest();
      //expect(instance).to.be.a(AmazonCloudWatchLogs.UntagLogGroupRequest);
    });
