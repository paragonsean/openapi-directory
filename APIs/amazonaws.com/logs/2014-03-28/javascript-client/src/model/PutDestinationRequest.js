...
/**
 * The PutDestinationRequest model module.
 * @module model/PutDestinationRequest
 * @version 2014-03-28
 */
class PutDestinationRequest {
    /**
     * Constructs a new <code>PutDestinationRequest</code>.
     * @alias module:model/PutDestinationRequest
     * @param destinationName {String} 
     * @param targetArn {String} 
     * @param roleArn {String} 
     */
    constructor(destinationName, targetArn, roleArn) { 
        
        PutDestinationRequest.initialize(this, destinationName, targetArn, roleArn);
    }
     ...
     */
    static initialize(obj, destinationName, targetArn, roleArn) { 
    ...
    /**
     * Constructs a <code>PutDestinationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutDestinationRequest} obj Optional instance to populate.
     * @return {module:model/PutDestinationRequest} The populated <code>PutDestinationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutDestinationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutDestinationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutDestinationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutDestinationRequest.RequiredProperties) {
...
PutDestinationRequest.RequiredProperties = ["destinationName", "targetArn", "roleArn"];

/**
 * @member {String} destinationName
 */
PutDestinationRequest.prototype['destinationName'] = undefined;

/**
 * @member {String} targetArn
 */
PutDestinationRequest.prototype['targetArn'] = undefined;

/**
 * @member {String} roleArn
 */
PutDestinationRequest.prototype['roleArn'] = undefined;

/**
 * @member {Object} tags
 */
PutDestinationRequest.prototype['tags'] = undefined;
...
export default PutDestinationRequest;
