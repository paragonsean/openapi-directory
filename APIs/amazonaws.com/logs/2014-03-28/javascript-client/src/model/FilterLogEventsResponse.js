...
/**
 * The FilterLogEventsResponse model module.
 * @module model/FilterLogEventsResponse
 * @version 2014-03-28
 */
class FilterLogEventsResponse {
    /**
     * Constructs a new <code>FilterLogEventsResponse</code>.
     * @alias module:model/FilterLogEventsResponse
     */
    constructor() { 
        
        FilterLogEventsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FilterLogEventsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FilterLogEventsResponse} obj Optional instance to populate.
     * @return {module:model/FilterLogEventsResponse} The populated <code>FilterLogEventsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FilterLogEventsResponse();

            if (data.hasOwnProperty('events')) {
                obj['events'] = ApiClient.convertToType(data['events'], Array);
            }
            if (data.hasOwnProperty('searchedLogStreams')) {
                obj['searchedLogStreams'] = ApiClient.convertToType(data['searchedLogStreams'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FilterLogEventsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FilterLogEventsResponse</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `searchedLogStreams`
        if (data['searchedLogStreams']) { // data not null
          Array.validateJSON(data['searchedLogStreams']);
        }
 ...
 * @member {Array} events
 */
FilterLogEventsResponse.prototype['events'] = undefined;

/**
 * @member {Array} searchedLogStreams
 */
FilterLogEventsResponse.prototype['searchedLogStreams'] = undefined;

/**
 * @member {String} nextToken
 */
FilterLogEventsResponse.prototype['nextToken'] = undefined;
...
export default FilterLogEventsResponse;
