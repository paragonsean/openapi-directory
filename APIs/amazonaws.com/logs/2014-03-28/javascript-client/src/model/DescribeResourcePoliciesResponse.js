...
/**
 * The DescribeResourcePoliciesResponse model module.
 * @module model/DescribeResourcePoliciesResponse
 * @version 2014-03-28
 */
class DescribeResourcePoliciesResponse {
    /**
     * Constructs a new <code>DescribeResourcePoliciesResponse</code>.
     * @alias module:model/DescribeResourcePoliciesResponse
     */
    constructor() { 
        
        DescribeResourcePoliciesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeResourcePoliciesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeResourcePoliciesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeResourcePoliciesResponse} The populated <code>DescribeResourcePoliciesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeResourcePoliciesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeResourcePoliciesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeResourcePoliciesResponse</code>.
     */
 ...
 */
DescribeResourcePoliciesResponse.prototype['resourcePolicies'] = undefined;

/**
 * The token for the next set of items to return. The token expires after 24 hours.
 * @member {String} nextToken
 */
DescribeResourcePoliciesResponse.prototype['nextToken'] = undefined;
...
export default DescribeResourcePoliciesResponse;
