...
/**
 * The DeleteRetentionPolicyRequest model module.
 * @module model/DeleteRetentionPolicyRequest
 * @version 2014-03-28
 */
class DeleteRetentionPolicyRequest {
    /**
     * Constructs a new <code>DeleteRetentionPolicyRequest</code>.
     * @alias module:model/DeleteRetentionPolicyRequest
     * @param logGroupName {String} 
     */
    constructor(logGroupName) { 
        
        DeleteRetentionPolicyRequest.initialize(this, logGroupName);
    }
    ...
    /**
     * Constructs a <code>DeleteRetentionPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRetentionPolicyRequest} obj Optional instance to populate.
     * @return {module:model/DeleteRetentionPolicyRequest} The populated <code>DeleteRetentionPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRetentionPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRetentionPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRetentionPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteRetentionPolicyRequest.RequiredProperties) {
...
DeleteRetentionPolicyRequest.RequiredProperties = ["logGroupName"];

/**
 * @member {String} logGroupName
 */
DeleteRetentionPolicyRequest.prototype['logGroupName'] = undefined;
...
export default DeleteRetentionPolicyRequest;
