...
* @readonly
*/
export default class DataProtectionStatus {
    ...
    /**
    * Returns a <code>DataProtectionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DataProtectionStatus} The enum <code>DataProtectionStatus</code> value.
    */
