...
/**
 * The GetLogGroupFieldsResponse model module.
 * @module model/GetLogGroupFieldsResponse
 * @version 2014-03-28
 */
class GetLogGroupFieldsResponse {
    /**
     * Constructs a new <code>GetLogGroupFieldsResponse</code>.
     * @alias module:model/GetLogGroupFieldsResponse
     */
    constructor() { 
        
        GetLogGroupFieldsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLogGroupFieldsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLogGroupFieldsResponse} obj Optional instance to populate.
     * @return {module:model/GetLogGroupFieldsResponse} The populated <code>GetLogGroupFieldsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLogGroupFieldsResponse();

            if (data.hasOwnProperty('logGroupFields')) {
                obj['logGroupFields'] = ApiClient.convertToType(data['logGroupFields'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLogGroupFieldsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLogGroupFieldsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `logGroupFields`
        if (data['logGroupFields']) { // data not null
          Array.validateJSON(data['logGroupFields']);
        }
...
/**
 * @member {Array} logGroupFields
 */
GetLogGroupFieldsResponse.prototype['logGroupFields'] = undefined;
...
export default GetLogGroupFieldsResponse;
