...
/**
 * The ResultField model module.
 * @module model/ResultField
 * @version 2014-03-28
 */
class ResultField {
    /**
     * Constructs a new <code>ResultField</code>.
     ...
     * @alias module:model/ResultField
     */
    constructor() { 
        
        ResultField.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResultField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResultField} obj Optional instance to populate.
     * @return {module:model/ResultField} The populated <code>ResultField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResultField();
    ...
    /**
     * Validates the JSON data with respect to <code>ResultField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResultField</code>.
     */
 ...
 * @member {String} field
 */
ResultField.prototype['field'] = undefined;

/**
 * @member {String} value
 */
ResultField.prototype['value'] = undefined;
