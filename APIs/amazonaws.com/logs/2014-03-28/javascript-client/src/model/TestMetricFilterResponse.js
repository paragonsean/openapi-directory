...
/**
 * The TestMetricFilterResponse model module.
 * @module model/TestMetricFilterResponse
 * @version 2014-03-28
 */
class TestMetricFilterResponse {
    /**
     * Constructs a new <code>TestMetricFilterResponse</code>.
     * @alias module:model/TestMetricFilterResponse
     */
    constructor() { 
        
        TestMetricFilterResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestMetricFilterResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestMetricFilterResponse} obj Optional instance to populate.
     * @return {module:model/TestMetricFilterResponse} The populated <code>TestMetricFilterResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestMetricFilterResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>TestMetricFilterResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestMetricFilterResponse</code>.
     */
 ...
 */
TestMetricFilterResponse.prototype['matches'] = undefined;
...
export default TestMetricFilterResponse;
