...
class CancelExportTaskRequest {
    ...
    constructor(taskId) { 
        ...
        CancelExportTaskRequest.initialize(this, taskId);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CancelExportTaskRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelExportTaskRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelExportTaskRequest.RequiredProperties) {
...
CancelExportTaskRequest.RequiredProperties = ["taskId"];

/**
 * @member {String} taskId
 */
CancelExportTaskRequest.prototype['taskId'] = undefined;
