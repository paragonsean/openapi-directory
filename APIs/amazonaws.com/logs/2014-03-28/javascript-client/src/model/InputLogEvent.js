...
/**
 * The InputLogEvent model module.
 * @module model/InputLogEvent
 * @version 2014-03-28
 */
class InputLogEvent {
    /**
     * Constructs a new <code>InputLogEvent</code>.
     * Represents a log event, which is a record of activity that was recorded by the application or resource being monitored.
     * @alias module:model/InputLogEvent
     * @param timestamp {Number} 
     * @param message {String} 
     */
    constructor(timestamp, message) { 
        
        InputLogEvent.initialize(this, timestamp, message);
    }
     ...
     */
    static initialize(obj, timestamp, message) { 
        obj['timestamp'] = timestamp;
        obj['message'] = message;
    }

    /**
     * Constructs a <code>InputLogEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputLogEvent} obj Optional instance to populate.
     * @return {module:model/InputLogEvent} The populated <code>InputLogEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputLogEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>InputLogEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputLogEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InputLogEvent.RequiredProperties) {
...
InputLogEvent.RequiredProperties = ["timestamp", "message"];

/**
 * @member {Number} timestamp
 */
InputLogEvent.prototype['timestamp'] = undefined;

/**
 * @member {String} message
 */
InputLogEvent.prototype['message'] = undefined;
