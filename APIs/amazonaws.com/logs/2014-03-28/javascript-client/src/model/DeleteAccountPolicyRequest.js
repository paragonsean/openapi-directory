...
/**
 * The DeleteAccountPolicyRequest model module.
 * @module model/DeleteAccountPolicyRequest
 * @version 2014-03-28
 */
class DeleteAccountPolicyRequest {
    /**
     * Constructs a new <code>DeleteAccountPolicyRequest</code>.
     * @alias module:model/DeleteAccountPolicyRequest
     * @param policyName {String} 
     * @param policyType {module:model/PolicyType} 
     */
    constructor(policyName, policyType) { 
        
        DeleteAccountPolicyRequest.initialize(this, policyName, policyType);
    }
     ...
     */
    static initialize(obj, policyName, policyType) { 
        obj['policyName'] = policyName;
        obj['policyType'] = policyType;
    }

    /**
     * Constructs a <code>DeleteAccountPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAccountPolicyRequest} obj Optional instance to populate.
     * @return {module:model/DeleteAccountPolicyRequest} The populated <code>DeleteAccountPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAccountPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAccountPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAccountPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAccountPolicyRequest.RequiredProperties) {
...
DeleteAccountPolicyRequest.RequiredProperties = ["policyName", "policyType"];

/**
 * @member {String} policyName
 */
DeleteAccountPolicyRequest.prototype['policyName'] = undefined;

/**
 * @member {module:model/PolicyType} policyType
 */
DeleteAccountPolicyRequest.prototype['policyType'] = undefined;
...
export default DeleteAccountPolicyRequest;
