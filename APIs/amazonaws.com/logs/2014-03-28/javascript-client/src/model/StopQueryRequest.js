...
/**
 * The StopQueryRequest model module.
 * @module model/StopQueryRequest
 * @version 2014-03-28
 */
class StopQueryRequest {
    /**
     * Constructs a new <code>StopQueryRequest</code>.
     * @alias module:model/StopQueryRequest
     * @param queryId {String} 
     */
    constructor(queryId) { 
        
        StopQueryRequest.initialize(this, queryId);
    }
    ...
    /**
     * Constructs a <code>StopQueryRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopQueryRequest} obj Optional instance to populate.
     * @return {module:model/StopQueryRequest} The populated <code>StopQueryRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopQueryRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopQueryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopQueryRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopQueryRequest.RequiredProperties) {
...
StopQueryRequest.RequiredProperties = ["queryId"];

/**
 * @member {String} queryId
 */
StopQueryRequest.prototype['queryId'] = undefined;
...
export default StopQueryRequest;
