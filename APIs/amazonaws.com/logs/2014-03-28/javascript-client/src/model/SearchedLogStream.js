...
/**
 * The SearchedLogStream model module.
 * @module model/SearchedLogStream
 * @version 2014-03-28
 */
class SearchedLogStream {
    /**
     * Constructs a new <code>SearchedLogStream</code>.
     * Represents the search status of a log stream.
     * @alias module:model/SearchedLogStream
     */
    constructor() { 
        
        SearchedLogStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchedLogStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchedLogStream} obj Optional instance to populate.
     * @return {module:model/SearchedLogStream} The populated <code>SearchedLogStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchedLogStream();

            if (data.hasOwnProperty('logStreamName')) {
                obj['logStreamName'] = ApiClient.convertToType(data['logStreamName'], 'String');
            }
            if (data.hasOwnProperty('searchedCompletely')) {
                obj['searchedCompletely'] = ApiClient.convertToType(data['searchedCompletely'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchedLogStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchedLogStream</code>.
     */
    static validateJSON(data) {
        ...
        if (data['searchedCompletely']) { // data not null
          Boolean.validateJSON(data['searchedCompletely']);
        }
 ...
 */
SearchedLogStream.prototype['logStreamName'] = undefined;

/**
 * @member {Boolean} searchedCompletely
 */
SearchedLogStream.prototype['searchedCompletely'] = undefined;
...
export default SearchedLogStream;
