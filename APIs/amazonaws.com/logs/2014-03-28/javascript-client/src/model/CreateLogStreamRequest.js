...
/**
 * The CreateLogStreamRequest model module.
 * @module model/CreateLogStreamRequest
 * @version 2014-03-28
 */
class CreateLogStreamRequest {
    /**
     * Constructs a new <code>CreateLogStreamRequest</code>.
     * @alias module:model/CreateLogStreamRequest
     * @param logGroupName {String} 
     * @param logStreamName {String} 
     */
    constructor(logGroupName, logStreamName) { 
        
        CreateLogStreamRequest.initialize(this, logGroupName, logStreamName);
    }
    ...
    /**
     * Constructs a <code>CreateLogStreamRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLogStreamRequest} obj Optional instance to populate.
     * @return {module:model/CreateLogStreamRequest} The populated <code>CreateLogStreamRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLogStreamRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLogStreamRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLogStreamRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLogStreamRequest.RequiredProperties) {
...
CreateLogStreamRequest.RequiredProperties = ["logGroupName", "logStreamName"];

/**
 * @member {String} logGroupName
 */
CreateLogStreamRequest.prototype['logGroupName'] = undefined;

/**
 * @member {String} logStreamName
 */
CreateLogStreamRequest.prototype['logStreamName'] = undefined;
...
export default CreateLogStreamRequest;
