...
/**
 * The PutDestinationPolicyRequest model module.
 * @module model/PutDestinationPolicyRequest
 * @version 2014-03-28
 */
class PutDestinationPolicyRequest {
    /**
     * Constructs a new <code>PutDestinationPolicyRequest</code>.
     * @alias module:model/PutDestinationPolicyRequest
     * @param destinationName {String} 
     * @param accessPolicy {String} 
     */
    constructor(destinationName, accessPolicy) { 
        
        PutDestinationPolicyRequest.initialize(this, destinationName, accessPolicy);
    }
     ...
     */
    static initialize(obj, destinationName, accessPolicy) { 
        obj['destinationName'] = destinationName;
        obj['accessPolicy'] = accessPolicy;
    }

    /**
     * Constructs a <code>PutDestinationPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutDestinationPolicyRequest} obj Optional instance to populate.
     * @return {module:model/PutDestinationPolicyRequest} The populated <code>PutDestinationPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutDestinationPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutDestinationPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutDestinationPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutDestinationPolicyRequest.RequiredProperties) {
        ...
        if (data['forceUpdate']) { // data not null
          Boolean.validateJSON(data['forceUpdate']);
        }
...
PutDestinationPolicyRequest.RequiredProperties = ["destinationName", "accessPolicy"];

/**
 * @member {String} destinationName
 */
PutDestinationPolicyRequest.prototype['destinationName'] = undefined;

/**
 * @member {String} accessPolicy
 */
PutDestinationPolicyRequest.prototype['accessPolicy'] = undefined;

/**
 * @member {Boolean} forceUpdate
 */
PutDestinationPolicyRequest.prototype['forceUpdate'] = undefined;
...
export default PutDestinationPolicyRequest;
