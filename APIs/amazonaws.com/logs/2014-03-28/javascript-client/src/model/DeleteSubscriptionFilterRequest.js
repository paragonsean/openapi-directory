...
/**
 * The DeleteSubscriptionFilterRequest model module.
 * @module model/DeleteSubscriptionFilterRequest
 * @version 2014-03-28
 */
class DeleteSubscriptionFilterRequest {
    /**
     * Constructs a new <code>DeleteSubscriptionFilterRequest</code>.
     * @alias module:model/DeleteSubscriptionFilterRequest
     * @param logGroupName {String} 
     * @param filterName {String} 
     */
    constructor(logGroupName, filterName) { 
        
        DeleteSubscriptionFilterRequest.initialize(this, logGroupName, filterName);
    }
    ...
    /**
     * Constructs a <code>DeleteSubscriptionFilterRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteSubscriptionFilterRequest} obj Optional instance to populate.
     * @return {module:model/DeleteSubscriptionFilterRequest} The populated <code>DeleteSubscriptionFilterRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSubscriptionFilterRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSubscriptionFilterRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSubscriptionFilterRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteSubscriptionFilterRequest.RequiredProperties) {
...
DeleteSubscriptionFilterRequest.RequiredProperties = ["logGroupName", "filterName"];

/**
 * @member {String} logGroupName
 */
DeleteSubscriptionFilterRequest.prototype['logGroupName'] = undefined;

/**
 * @member {String} filterName
 */
DeleteSubscriptionFilterRequest.prototype['filterName'] = undefined;
...
export default DeleteSubscriptionFilterRequest;
