...
/**
 * The DescribeExportTasksResponse model module.
 * @module model/DescribeExportTasksResponse
 * @version 2014-03-28
 */
class DescribeExportTasksResponse {
    /**
     * Constructs a new <code>DescribeExportTasksResponse</code>.
     * @alias module:model/DescribeExportTasksResponse
     */
    constructor() { 
        
        DescribeExportTasksResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeExportTasksResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeExportTasksResponse} obj Optional instance to populate.
     * @return {module:model/DescribeExportTasksResponse} The populated <code>DescribeExportTasksResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeExportTasksResponse();

            if (data.hasOwnProperty('exportTasks')) {
                obj['exportTasks'] = ApiClient.convertToType(data['exportTasks'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeExportTasksResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeExportTasksResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `exportTasks`
        if (data['exportTasks']) { // data not null
          Array.validateJSON(data['exportTasks']);
        }
...
/**
 * @member {Array} exportTasks
 */
DescribeExportTasksResponse.prototype['exportTasks'] = undefined;

/**
 * The token for the next set of items to return. The token expires after 24 hours.
 * @member {String} nextToken
 */
DescribeExportTasksResponse.prototype['nextToken'] = undefined;
...
export default DescribeExportTasksResponse;
