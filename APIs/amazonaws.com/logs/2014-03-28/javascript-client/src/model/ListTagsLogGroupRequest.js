...
/**
 * The ListTagsLogGroupRequest model module.
 * @module model/ListTagsLogGroupRequest
 * @version 2014-03-28
 */
class ListTagsLogGroupRequest {
    /**
     * Constructs a new <code>ListTagsLogGroupRequest</code>.
     * Please use the generic tagging API model ListTagsForResourceRequest and ListTagsForResourceResponse
     * @alias module:model/ListTagsLogGroupRequest
     * @param logGroupName {String} 
     */
    constructor(logGroupName) { 
        
        ListTagsLogGroupRequest.initialize(this, logGroupName);
    }
     ...
     */
    static initialize(obj, logGroupName) { 
        obj['logGroupName'] = logGroupName;
    }

    /**
     * Constructs a <code>ListTagsLogGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTagsLogGroupRequest} obj Optional instance to populate.
     * @return {module:model/ListTagsLogGroupRequest} The populated <code>ListTagsLogGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTagsLogGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTagsLogGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTagsLogGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListTagsLogGroupRequest.RequiredProperties) {
...
ListTagsLogGroupRequest.RequiredProperties = ["logGroupName"];

/**
 * @member {String} logGroupName
 */
ListTagsLogGroupRequest.prototype['logGroupName'] = undefined;
...
export default ListTagsLogGroupRequest;
