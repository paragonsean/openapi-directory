...
/**
 * The DescribeLogGroupsResponse model module.
 * @module model/DescribeLogGroupsResponse
 * @version 2014-03-28
 */
class DescribeLogGroupsResponse {
    /**
     * Constructs a new <code>DescribeLogGroupsResponse</code>.
     * @alias module:model/DescribeLogGroupsResponse
     */
    constructor() { 
        
        DescribeLogGroupsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeLogGroupsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeLogGroupsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeLogGroupsResponse} The populated <code>DescribeLogGroupsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeLogGroupsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeLogGroupsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeLogGroupsResponse</code>.
     */
 ...
 */
DescribeLogGroupsResponse.prototype['logGroups'] = undefined;

/**
 * The token for the next set of items to return. The token expires after 24 hours.
 * @member {String} nextToken
 */
DescribeLogGroupsResponse.prototype['nextToken'] = undefined;
...
export default DescribeLogGroupsResponse;
