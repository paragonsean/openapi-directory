...
/**
 * The CreateLogGroupRequest model module.
 * @module model/CreateLogGroupRequest
 * @version 2014-03-28
 */
class CreateLogGroupRequest {
    /**
     * Constructs a new <code>CreateLogGroupRequest</code>.
     * @alias module:model/CreateLogGroupRequest
     * @param logGroupName {String} 
     */
    constructor(logGroupName) { 
        
        CreateLogGroupRequest.initialize(this, logGroupName);
    }
    ...
    /**
     * Constructs a <code>CreateLogGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLogGroupRequest} obj Optional instance to populate.
     * @return {module:model/CreateLogGroupRequest} The populated <code>CreateLogGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLogGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLogGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLogGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLogGroupRequest.RequiredProperties) {
...
CreateLogGroupRequest.RequiredProperties = ["logGroupName"];

/**
 * @member {String} logGroupName
 */
CreateLogGroupRequest.prototype['logGroupName'] = undefined;

/**
 * @member {String} kmsKeyId
 */
CreateLogGroupRequest.prototype['kmsKeyId'] = undefined;

/**
 * @member {Object} tags
 */
CreateLogGroupRequest.prototype['tags'] = undefined;
...
export default CreateLogGroupRequest;
