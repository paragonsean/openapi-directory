...
/**
 * The DescribeMetricFiltersRequest model module.
 * @module model/DescribeMetricFiltersRequest
 * @version 2014-03-28
 */
class DescribeMetricFiltersRequest {
    /**
     * Constructs a new <code>DescribeMetricFiltersRequest</code>.
     * @alias module:model/DescribeMetricFiltersRequest
     */
    constructor() { 
        
        DescribeMetricFiltersRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMetricFiltersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMetricFiltersRequest} obj Optional instance to populate.
     * @return {module:model/DescribeMetricFiltersRequest} The populated <code>DescribeMetricFiltersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMetricFiltersRequest();

            if (data.hasOwnProperty('logGroupName')) {
                obj['logGroupName'] = ApiClient.convertToType(data['logGroupName'], 'String');
            }
            if (data.hasOwnProperty('filterNamePrefix')) {
                obj['filterNamePrefix'] = ApiClient.convertToType(data['filterNamePrefix'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMetricFiltersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMetricFiltersRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['filterNamePrefix']) { // data not null
          String.validateJSON(data['filterNamePrefix']);
        }
 ...
 */
DescribeMetricFiltersRequest.prototype['logGroupName'] = undefined;

/**
 * @member {String} filterNamePrefix
 */
DescribeMetricFiltersRequest.prototype['filterNamePrefix'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeMetricFiltersRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} limit
 */
DescribeMetricFiltersRequest.prototype['limit'] = undefined;

/**
 * @member {String} metricName
 */
DescribeMetricFiltersRequest.prototype['metricName'] = undefined;

/**
 * @member {String} metricNamespace
 */
DescribeMetricFiltersRequest.prototype['metricNamespace'] = undefined;
...
export default DescribeMetricFiltersRequest;
