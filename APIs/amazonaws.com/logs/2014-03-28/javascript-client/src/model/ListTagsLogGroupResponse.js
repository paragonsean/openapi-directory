...
/**
 * The ListTagsLogGroupResponse model module.
 * @module model/ListTagsLogGroupResponse
 * @version 2014-03-28
 */
class ListTagsLogGroupResponse {
    /**
     * Constructs a new <code>ListTagsLogGroupResponse</code>.
     * Please use the generic tagging API model ListTagsForResourceRequest and ListTagsForResourceResponse
     * @alias module:model/ListTagsLogGroupResponse
     */
    constructor() { 
        
        ListTagsLogGroupResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTagsLogGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTagsLogGroupResponse} obj Optional instance to populate.
     * @return {module:model/ListTagsLogGroupResponse} The populated <code>ListTagsLogGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTagsLogGroupResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTagsLogGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTagsLogGroupResponse</code>.
     */
 ...
 * @member {Object} tags
 */
ListTagsLogGroupResponse.prototype['tags'] = undefined;
...
export default ListTagsLogGroupResponse;
