...
/**
 * The DescribeLogStreamsResponse model module.
 * @module model/DescribeLogStreamsResponse
 * @version 2014-03-28
 */
class DescribeLogStreamsResponse {
    /**
     * Constructs a new <code>DescribeLogStreamsResponse</code>.
     * @alias module:model/DescribeLogStreamsResponse
     */
    constructor() { 
        
        DescribeLogStreamsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeLogStreamsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeLogStreamsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeLogStreamsResponse} The populated <code>DescribeLogStreamsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeLogStreamsResponse();

            if (data.hasOwnProperty('logStreams')) {
                obj['logStreams'] = ApiClient.convertToType(data['logStreams'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeLogStreamsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeLogStreamsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `logStreams`
        if (data['logStreams']) { // data not null
          Array.validateJSON(data['logStreams']);
        }
...
/**
 * @member {Array} logStreams
 */
DescribeLogStreamsResponse.prototype['logStreams'] = undefined;

/**
 * The token for the next set of items to return. The token expires after 24 hours.
 * @member {String} nextToken
 */
DescribeLogStreamsResponse.prototype['nextToken'] = undefined;
...
export default DescribeLogStreamsResponse;
