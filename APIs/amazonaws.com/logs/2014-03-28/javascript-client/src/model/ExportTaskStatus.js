...
/**
 * The ExportTaskStatus model module.
 * @module model/ExportTaskStatus
 * @version 2014-03-28
 */
class ExportTaskStatus {
    /**
     * Constructs a new <code>ExportTaskStatus</code>.
     * @alias module:model/ExportTaskStatus
     * @implements module:model/ExportTaskStatus
     */
    constructor() { 
        ExportTaskStatus.initialize(this);
        ExportTaskStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExportTaskStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportTaskStatus} obj Optional instance to populate.
     * @return {module:model/ExportTaskStatus} The populated <code>ExportTaskStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportTaskStatus();
            ExportTaskStatus.constructFromObject(data, obj);

            if (data.hasOwnProperty('code')) {
                obj['code'] = ApiClient.convertToType(data['code'], ExportTaskStatusCode);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ExportTaskStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportTaskStatus</code>.
     */
    static validateJSON(data) {
        // validate the optional field `code`
        if (data['code']) { // data not null
          ExportTaskStatusCode.validateJSON(data['code']);
        }
...
/**
 * @member {module:model/ExportTaskStatusCode} code
 */
ExportTaskStatus.prototype['code'] = undefined;

/**
 * @member {String} message
 */
ExportTaskStatus.prototype['message'] = undefined;


// Implement ExportTaskStatus interface:
/**
 * @member {module:model/ExportTaskStatusCode} code
 */
ExportTaskStatus.prototype['code'] = undefined;
