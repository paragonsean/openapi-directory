...
/**
 * The CreateExportTaskResponse model module.
 * @module model/CreateExportTaskResponse
 * @version 2014-03-28
 */
class CreateExportTaskResponse {
    /**
     * Constructs a new <code>CreateExportTaskResponse</code>.
     * @alias module:model/CreateExportTaskResponse
     */
    constructor() { 
        
        CreateExportTaskResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateExportTaskResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateExportTaskResponse} obj Optional instance to populate.
     * @return {module:model/CreateExportTaskResponse} The populated <code>CreateExportTaskResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateExportTaskResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateExportTaskResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateExportTaskResponse</code>.
     */
 ...
 */
CreateExportTaskResponse.prototype['taskId'] = undefined;
...
export default CreateExportTaskResponse;
