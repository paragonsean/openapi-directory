...
/**
 * The DeleteQueryDefinitionResponse model module.
 * @module model/DeleteQueryDefinitionResponse
 * @version 2014-03-28
 */
class DeleteQueryDefinitionResponse {
    /**
     * Constructs a new <code>DeleteQueryDefinitionResponse</code>.
     * @alias module:model/DeleteQueryDefinitionResponse
     */
    constructor() { 
        
        DeleteQueryDefinitionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteQueryDefinitionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteQueryDefinitionResponse} obj Optional instance to populate.
     * @return {module:model/DeleteQueryDefinitionResponse} The populated <code>DeleteQueryDefinitionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteQueryDefinitionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteQueryDefinitionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteQueryDefinitionResponse</code>.
     */
 ...
 */
DeleteQueryDefinitionResponse.prototype['success'] = undefined;
...
export default DeleteQueryDefinitionResponse;
