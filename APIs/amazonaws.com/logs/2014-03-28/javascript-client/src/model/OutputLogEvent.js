...
/**
 * The OutputLogEvent model module.
 * @module model/OutputLogEvent
 * @version 2014-03-28
 */
class OutputLogEvent {
    /**
     * Constructs a new <code>OutputLogEvent</code>.
     * Represents a log event.
     * @alias module:model/OutputLogEvent
     */
    constructor() { 
        
        OutputLogEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OutputLogEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OutputLogEvent} obj Optional instance to populate.
     * @return {module:model/OutputLogEvent} The populated <code>OutputLogEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OutputLogEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>OutputLogEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OutputLogEvent</code>.
     */
 ...
 */
OutputLogEvent.prototype['timestamp'] = undefined;

/**
 * @member {String} message
 */
OutputLogEvent.prototype['message'] = undefined;

/**
 * @member {Number} ingestionTime
 */
OutputLogEvent.prototype['ingestionTime'] = undefined;
