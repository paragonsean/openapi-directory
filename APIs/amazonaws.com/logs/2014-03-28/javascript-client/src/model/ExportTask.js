...
class ExportTask {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = ExportTaskStatus.constructFromObject(data['status']);
            }
            if (data.hasOwnProperty('executionInfo')) {
                obj['executionInfo'] = ExportTaskExecutionInfo.constructFromObject(data['executionInfo']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['status']) { // data not null
          ExportTaskStatus.validateJSON(data['status']);
        }
        // validate the optional field `executionInfo`
        if (data['executionInfo']) { // data not null
          ExportTaskExecutionInfo.validateJSON(data['executionInfo']);
        }
 ...
 */
ExportTask.prototype['taskId'] = undefined;

/**
 * @member {String} taskName
 */
ExportTask.prototype['taskName'] = undefined;

/**
 * @member {String} logGroupName
 */
ExportTask.prototype['logGroupName'] = undefined;

/**
 * @member {Number} from
 */
ExportTask.prototype['from'] = undefined;

/**
 * @member {Number} to
 */
ExportTask.prototype['to'] = undefined;

/**
 * @member {String} destination
 */
ExportTask.prototype['destination'] = undefined;

/**
 * @member {String} destinationPrefix
 */
ExportTask.prototype['destinationPrefix'] = undefined;

/**
 * @member {module:model/ExportTaskStatus} status
 */
ExportTask.prototype['status'] = undefined;

/**
 * @member {module:model/ExportTaskExecutionInfo} executionInfo
 */
ExportTask.prototype['executionInfo'] = undefined;
