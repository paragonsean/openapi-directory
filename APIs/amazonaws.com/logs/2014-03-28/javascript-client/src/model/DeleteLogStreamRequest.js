...
/**
 * The DeleteLogStreamRequest model module.
 * @module model/DeleteLogStreamRequest
 * @version 2014-03-28
 */
class DeleteLogStreamRequest {
    /**
     * Constructs a new <code>DeleteLogStreamRequest</code>.
     * @alias module:model/DeleteLogStreamRequest
     * @param logGroupName {String} 
     * @param logStreamName {String} 
     */
    constructor(logGroupName, logStreamName) { 
        
        DeleteLogStreamRequest.initialize(this, logGroupName, logStreamName);
    }
     ...
     */
    static initialize(obj, logGroupName, logStreamName) { 
        obj['logGroupName'] = logGroupName;
        obj['logStreamName'] = logStreamName;
    }

    /**
     * Constructs a <code>DeleteLogStreamRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteLogStreamRequest} obj Optional instance to populate.
     * @return {module:model/DeleteLogStreamRequest} The populated <code>DeleteLogStreamRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteLogStreamRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteLogStreamRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteLogStreamRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteLogStreamRequest.RequiredProperties) {
...
DeleteLogStreamRequest.RequiredProperties = ["logGroupName", "logStreamName"];

/**
 * @member {String} logGroupName
 */
DeleteLogStreamRequest.prototype['logGroupName'] = undefined;

/**
 * @member {String} logStreamName
 */
DeleteLogStreamRequest.prototype['logStreamName'] = undefined;
...
export default DeleteLogStreamRequest;
