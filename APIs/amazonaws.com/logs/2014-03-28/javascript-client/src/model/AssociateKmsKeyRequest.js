...
/**
 * The AssociateKmsKeyRequest model module.
 * @module model/AssociateKmsKeyRequest
 * @version 2014-03-28
 */
class AssociateKmsKeyRequest {
    /**
     * Constructs a new <code>AssociateKmsKeyRequest</code>.
     * @alias module:model/AssociateKmsKeyRequest
     * @param kmsKeyId {String} 
     */
    constructor(kmsKeyId) { 
        
        AssociateKmsKeyRequest.initialize(this, kmsKeyId);
    }
    ...
    /**
     * Constructs a <code>AssociateKmsKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateKmsKeyRequest} obj Optional instance to populate.
     * @return {module:model/AssociateKmsKeyRequest} The populated <code>AssociateKmsKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateKmsKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateKmsKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateKmsKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateKmsKeyRequest.RequiredProperties) {
...
AssociateKmsKeyRequest.RequiredProperties = ["kmsKeyId"];

/**
 * @member {String} logGroupName
 */
AssociateKmsKeyRequest.prototype['logGroupName'] = undefined;

/**
 * @member {String} kmsKeyId
 */
AssociateKmsKeyRequest.prototype['kmsKeyId'] = undefined;

/**
 * @member {String} resourceIdentifier
 */
AssociateKmsKeyRequest.prototype['resourceIdentifier'] = undefined;
...
export default AssociateKmsKeyRequest;
