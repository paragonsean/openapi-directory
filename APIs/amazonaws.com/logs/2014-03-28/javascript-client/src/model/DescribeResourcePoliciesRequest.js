...
/**
 * The DescribeResourcePoliciesRequest model module.
 * @module model/DescribeResourcePoliciesRequest
 * @version 2014-03-28
 */
class DescribeResourcePoliciesRequest {
    /**
     * Constructs a new <code>DescribeResourcePoliciesRequest</code>.
     * @alias module:model/DescribeResourcePoliciesRequest
     */
    constructor() { 
        
        DescribeResourcePoliciesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeResourcePoliciesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeResourcePoliciesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeResourcePoliciesRequest} The populated <code>DescribeResourcePoliciesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeResourcePoliciesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeResourcePoliciesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeResourcePoliciesRequest</code>.
     */
 ...
 */
DescribeResourcePoliciesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} limit
 */
DescribeResourcePoliciesRequest.prototype['limit'] = undefined;
...
export default DescribeResourcePoliciesRequest;
