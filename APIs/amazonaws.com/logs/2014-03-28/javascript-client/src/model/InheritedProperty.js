...
* @readonly
*/
export default class InheritedProperty {
    
        /**
         * value: "ACCOUNT_DATA_PROTECTION"
         * @const
         */
    ...
    /**
    * Returns a <code>InheritedProperty</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InheritedProperty} The enum <code>InheritedProperty</code> value.
    */
