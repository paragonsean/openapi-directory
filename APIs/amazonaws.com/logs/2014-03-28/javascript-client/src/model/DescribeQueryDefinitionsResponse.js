...
/**
 * The DescribeQueryDefinitionsResponse model module.
 * @module model/DescribeQueryDefinitionsResponse
 * @version 2014-03-28
 */
class DescribeQueryDefinitionsResponse {
    /**
     * Constructs a new <code>DescribeQueryDefinitionsResponse</code>.
     * @alias module:model/DescribeQueryDefinitionsResponse
     */
    constructor() { 
        
        DescribeQueryDefinitionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeQueryDefinitionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeQueryDefinitionsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeQueryDefinitionsResponse} The populated <code>DescribeQueryDefinitionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeQueryDefinitionsResponse();

            if (data.hasOwnProperty('queryDefinitions')) {
                obj['queryDefinitions'] = ApiClient.convertToType(data['queryDefinitions'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeQueryDefinitionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeQueryDefinitionsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `queryDefinitions`
        if (data['queryDefinitions']) { // data not null
          Array.validateJSON(data['queryDefinitions']);
        }
...
/**
 * @member {Array} queryDefinitions
 */
DescribeQueryDefinitionsResponse.prototype['queryDefinitions'] = undefined;

/**
 * The token for the next set of items to return. The token expires after 24 hours.
 * @member {String} nextToken
 */
DescribeQueryDefinitionsResponse.prototype['nextToken'] = undefined;
...
export default DescribeQueryDefinitionsResponse;
