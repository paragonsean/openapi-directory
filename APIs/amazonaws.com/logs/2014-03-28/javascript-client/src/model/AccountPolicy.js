...
/**
 * The AccountPolicy model module.
 * @module model/AccountPolicy
 * @version 2014-03-28
 */
class AccountPolicy {
    /**
     * Constructs a new <code>AccountPolicy</code>.
     * A structure that contains information about one CloudWatch Logs account policy.
     * @alias module:model/AccountPolicy
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AccountPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountPolicy} obj Optional instance to populate.
     * @return {module:model/AccountPolicy} The populated <code>AccountPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountPolicy</code>.
     */
