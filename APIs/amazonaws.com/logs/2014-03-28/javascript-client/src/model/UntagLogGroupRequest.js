...
/**
 * The UntagLogGroupRequest model module.
 * @module model/UntagLogGroupRequest
 * @version 2014-03-28
 */
class UntagLogGroupRequest {
    /**
     * Constructs a new <code>UntagLogGroupRequest</code>.
     * Please use the generic tagging API model UntagResourceRequest
     * @alias module:model/UntagLogGroupRequest
     * @param logGroupName {String} 
     * @param tags {Array} 
     */
    constructor(logGroupName, tags) { 
        
        UntagLogGroupRequest.initialize(this, logGroupName, tags);
    }
     ...
     */
    static initialize(obj, logGroupName, tags) { 
        obj['logGroupName'] = logGroupName;
        obj['tags'] = tags;
    }

    /**
     * Constructs a <code>UntagLogGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagLogGroupRequest} obj Optional instance to populate.
     * @return {module:model/UntagLogGroupRequest} The populated <code>UntagLogGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagLogGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagLogGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagLogGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagLogGroupRequest.RequiredProperties) {
...
UntagLogGroupRequest.RequiredProperties = ["logGroupName", "tags"];

/**
 * @member {String} logGroupName
 */
UntagLogGroupRequest.prototype['logGroupName'] = undefined;

/**
 * @member {Array} tags
 */
UntagLogGroupRequest.prototype['tags'] = undefined;
...
export default UntagLogGroupRequest;
