...
/**
 * The PutRetentionPolicyRequest model module.
 * @module model/PutRetentionPolicyRequest
 * @version 2014-03-28
 */
class PutRetentionPolicyRequest {
    /**
     * Constructs a new <code>PutRetentionPolicyRequest</code>.
     * @alias module:model/PutRetentionPolicyRequest
     * @param logGroupName {String} 
     * @param retentionInDays {Number} <p>The number of days to retain the log events in the specified log group. Possible values are: 1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1096, 1827, 2192, 2557, 2922, 3288, and 3653.</p> <p>To set a log group so that its log events do not expire, use <a href=\"https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_DeleteRetentionPolicy.html\">DeleteRetentionPolicy</a>. </p>
     */
    constructor(logGroupName, retentionInDays) { 
        
        PutRetentionPolicyRequest.initialize(this, logGroupName, retentionInDays);
    }
     ...
     */
    static initialize(obj, logGroupName, retentionInDays) { 
        obj['logGroupName'] = logGroupName;
        obj['retentionInDays'] = retentionInDays;
    }

    /**
     * Constructs a <code>PutRetentionPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutRetentionPolicyRequest} obj Optional instance to populate.
     * @return {module:model/PutRetentionPolicyRequest} The populated <code>PutRetentionPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutRetentionPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutRetentionPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutRetentionPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutRetentionPolicyRequest.RequiredProperties) {
...
PutRetentionPolicyRequest.RequiredProperties = ["logGroupName", "retentionInDays"];

/**
 * @member {String} logGroupName
 */
PutRetentionPolicyRequest.prototype['logGroupName'] = undefined;
 ...
 */
PutRetentionPolicyRequest.prototype['retentionInDays'] = undefined;
...
export default PutRetentionPolicyRequest;
