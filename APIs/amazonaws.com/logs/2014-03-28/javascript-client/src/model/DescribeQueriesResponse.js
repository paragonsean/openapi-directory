...
/**
 * The DescribeQueriesResponse model module.
 * @module model/DescribeQueriesResponse
 * @version 2014-03-28
 */
class DescribeQueriesResponse {
    /**
     * Constructs a new <code>DescribeQueriesResponse</code>.
     * @alias module:model/DescribeQueriesResponse
     */
    constructor() { 
        
        DescribeQueriesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeQueriesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeQueriesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeQueriesResponse} The populated <code>DescribeQueriesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeQueriesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeQueriesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeQueriesResponse</code>.
     */
 ...
 */
DescribeQueriesResponse.prototype['queries'] = undefined;

/**
 * The token for the next set of items to return. The token expires after 24 hours.
 * @member {String} nextToken
 */
DescribeQueriesResponse.prototype['nextToken'] = undefined;
...
export default DescribeQueriesResponse;
