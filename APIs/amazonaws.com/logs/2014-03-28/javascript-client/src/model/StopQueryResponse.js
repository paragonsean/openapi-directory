...
/**
 * The StopQueryResponse model module.
 * @module model/StopQueryResponse
 * @version 2014-03-28
 */
class StopQueryResponse {
    /**
     * Constructs a new <code>StopQueryResponse</code>.
     * @alias module:model/StopQueryResponse
     */
    constructor() { 
        
        StopQueryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopQueryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopQueryResponse} obj Optional instance to populate.
     * @return {module:model/StopQueryResponse} The populated <code>StopQueryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopQueryResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StopQueryResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopQueryResponse</code>.
     */
 ...
 */
StopQueryResponse.prototype['success'] = undefined;
...
export default StopQueryResponse;
