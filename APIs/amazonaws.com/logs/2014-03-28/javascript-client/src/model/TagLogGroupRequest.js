...
/**
 * The TagLogGroupRequest model module.
 * @module model/TagLogGroupRequest
 * @version 2014-03-28
 */
class TagLogGroupRequest {
    /**
     * Constructs a new <code>TagLogGroupRequest</code>.
     * Please use the generic tagging API model TagResourceRequest
     * @alias module:model/TagLogGroupRequest
     * @param logGroupName {String} 
     * @param tags {Object} 
     */
    constructor(logGroupName, tags) { 
        
        TagLogGroupRequest.initialize(this, logGroupName, tags);
    }
    ...
    /**
     * Constructs a <code>TagLogGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagLogGroupRequest} obj Optional instance to populate.
     * @return {module:model/TagLogGroupRequest} The populated <code>TagLogGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagLogGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TagLogGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagLogGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TagLogGroupRequest.RequiredProperties) {
...
TagLogGroupRequest.RequiredProperties = ["logGroupName", "tags"];

/**
 * @member {String} logGroupName
 */
TagLogGroupRequest.prototype['logGroupName'] = undefined;

/**
 * @member {Object} tags
 */
TagLogGroupRequest.prototype['tags'] = undefined;
...
export default TagLogGroupRequest;
