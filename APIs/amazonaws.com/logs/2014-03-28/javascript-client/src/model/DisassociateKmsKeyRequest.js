...
/**
 * The DisassociateKmsKeyRequest model module.
 * @module model/DisassociateKmsKeyRequest
 * @version 2014-03-28
 */
class DisassociateKmsKeyRequest {
    /**
     * Constructs a new <code>DisassociateKmsKeyRequest</code>.
     * @alias module:model/DisassociateKmsKeyRequest
     */
    constructor() { 
        
        DisassociateKmsKeyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociateKmsKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateKmsKeyRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateKmsKeyRequest} The populated <code>DisassociateKmsKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateKmsKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateKmsKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateKmsKeyRequest</code>.
     */
 ...
 */
DisassociateKmsKeyRequest.prototype['logGroupName'] = undefined;

/**
 * @member {String} resourceIdentifier
 */
DisassociateKmsKeyRequest.prototype['resourceIdentifier'] = undefined;
...
export default DisassociateKmsKeyRequest;
