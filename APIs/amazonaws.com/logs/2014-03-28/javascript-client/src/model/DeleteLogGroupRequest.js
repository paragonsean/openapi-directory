...
/**
 * The DeleteLogGroupRequest model module.
 * @module model/DeleteLogGroupRequest
 * @version 2014-03-28
 */
class DeleteLogGroupRequest {
    /**
     * Constructs a new <code>DeleteLogGroupRequest</code>.
     * @alias module:model/DeleteLogGroupRequest
     * @param logGroupName {String} 
     */
    constructor(logGroupName) { 
        
        DeleteLogGroupRequest.initialize(this, logGroupName);
    }
    ...
    /**
     * Constructs a <code>DeleteLogGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteLogGroupRequest} obj Optional instance to populate.
     * @return {module:model/DeleteLogGroupRequest} The populated <code>DeleteLogGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteLogGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteLogGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteLogGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteLogGroupRequest.RequiredProperties) {
...
DeleteLogGroupRequest.RequiredProperties = ["logGroupName"];

/**
 * @member {String} logGroupName
 */
DeleteLogGroupRequest.prototype['logGroupName'] = undefined;
...
export default DeleteLogGroupRequest;
