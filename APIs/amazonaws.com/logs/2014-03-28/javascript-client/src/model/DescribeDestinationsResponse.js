...
/**
 * The DescribeDestinationsResponse model module.
 * @module model/DescribeDestinationsResponse
 * @version 2014-03-28
 */
class DescribeDestinationsResponse {
    /**
     * Constructs a new <code>DescribeDestinationsResponse</code>.
     * @alias module:model/DescribeDestinationsResponse
     */
    constructor() { 
        
        DescribeDestinationsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeDestinationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeDestinationsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeDestinationsResponse} The populated <code>DescribeDestinationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeDestinationsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeDestinationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeDestinationsResponse</code>.
     */
 ...
 */
DescribeDestinationsResponse.prototype['destinations'] = undefined;

/**
 * The token for the next set of items to return. The token expires after 24 hours.
 * @member {String} nextToken
 */
DescribeDestinationsResponse.prototype['nextToken'] = undefined;
...
export default DescribeDestinationsResponse;
