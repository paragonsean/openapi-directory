...
/**
 * The StartQueryResponse model module.
 * @module model/StartQueryResponse
 * @version 2014-03-28
 */
class StartQueryResponse {
    /**
     * Constructs a new <code>StartQueryResponse</code>.
     * @alias module:model/StartQueryResponse
     */
    constructor() { 
        
        StartQueryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartQueryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartQueryResponse} obj Optional instance to populate.
     * @return {module:model/StartQueryResponse} The populated <code>StartQueryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartQueryResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartQueryResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartQueryResponse</code>.
     */
 ...
 */
StartQueryResponse.prototype['queryId'] = undefined;
...
export default StartQueryResponse;
