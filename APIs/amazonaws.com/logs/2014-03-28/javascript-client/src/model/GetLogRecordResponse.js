...
/**
 * The GetLogRecordResponse model module.
 * @module model/GetLogRecordResponse
 * @version 2014-03-28
 */
class GetLogRecordResponse {
    /**
     * Constructs a new <code>GetLogRecordResponse</code>.
     * @alias module:model/GetLogRecordResponse
     */
    constructor() { 
        
        GetLogRecordResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLogRecordResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLogRecordResponse} obj Optional instance to populate.
     * @return {module:model/GetLogRecordResponse} The populated <code>GetLogRecordResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLogRecordResponse();

            if (data.hasOwnProperty('logRecord')) {
                obj['logRecord'] = ApiClient.convertToType(data['logRecord'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLogRecordResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLogRecordResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `logRecord`
        if (data['logRecord']) { // data not null
          Object.validateJSON(data['logRecord']);
        }
...
/**
 * @member {Object} logRecord
 */
GetLogRecordResponse.prototype['logRecord'] = undefined;
...
export default GetLogRecordResponse;
