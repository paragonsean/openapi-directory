...
public class AccountPolicy {
  ...
  public AccountPolicy policyName(String policyName) {
  ...
  public AccountPolicy policyDocument(String policyDocument) {
  ...
  public AccountPolicy lastUpdatedTime(Integer lastUpdatedTime) {
  ...
  public AccountPolicy policyType(PolicyType policyType) {
  ...
  public AccountPolicy scope(Scope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public AccountPolicy accountId(String accountId) {
  ...
  public boolean equals(Object o) {
    ...
    AccountPolicy accountPolicy = (AccountPolicy) o;
    return Objects.equals(this.policyName, accountPolicy.policyName) &&
        Objects.equals(this.policyDocument, accountPolicy.policyDocument) &&
        Objects.equals(this.lastUpdatedTime, accountPolicy.lastUpdatedTime) &&
        Objects.equals(this.policyType, accountPolicy.policyType) &&
        Objects.equals(this.scope, accountPolicy.scope) &&
        Objects.equals(this.accountId, accountPolicy.accountId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountPolicy is not found in the empty JSON string", AccountPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountPolicy>() {
           @Override
           public void write(JsonWriter out, AccountPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountPolicy
   * @throws IOException if the JSON string is invalid with respect to AccountPolicy
   */
  public static AccountPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountPolicy.class);
  }

  /**
   * Convert an instance of AccountPolicy to an JSON string
   *
   * @return JSON string
   */
