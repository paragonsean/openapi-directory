...
public class CreateLogStreamRequest {
  ...
  public CreateLogStreamRequest logGroupName(String logGroupName) {
  ...
  public CreateLogStreamRequest logStreamName(String logStreamName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logGroupName, createLogStreamRequest.logGroupName) &&
        Objects.equals(this.logStreamName, createLogStreamRequest.logStreamName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLogStreamRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLogStreamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLogStreamRequest is not found in the empty JSON string", CreateLogStreamRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLogStreamRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLogStreamRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLogStreamRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLogStreamRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLogStreamRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLogStreamRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLogStreamRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLogStreamRequest>() {
           @Override
           public void write(JsonWriter out, CreateLogStreamRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLogStreamRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLogStreamRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLogStreamRequest
   * @throws IOException if the JSON string is invalid with respect to CreateLogStreamRequest
   */
  public static CreateLogStreamRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLogStreamRequest.class);
  }

  /**
   * Convert an instance of CreateLogStreamRequest to an JSON string
   *
   * @return JSON string
   */
