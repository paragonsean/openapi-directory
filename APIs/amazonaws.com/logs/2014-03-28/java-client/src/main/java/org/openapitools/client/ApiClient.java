...
public class ApiClient {
    ...
    private String basePath = "http://logs.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2014-03-28/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://logs.us-east-1.amazonaws.com
