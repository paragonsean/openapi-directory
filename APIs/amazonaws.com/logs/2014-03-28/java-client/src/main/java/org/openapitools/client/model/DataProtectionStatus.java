...
/**
 * Gets or Sets DataProtectionStatus
 */
@JsonAdapter(DataProtectionStatus.Adapter.class)
public enum DataProtectionStatus {
  ...
  DataProtectionStatus(String value) {
    this.value = value;
  }
  ...
  public static DataProtectionStatus fromValue(String value) {
    for (DataProtectionStatus b : DataProtectionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<DataProtectionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final DataProtectionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DataProtectionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DataProtectionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DataProtectionStatus.fromValue(value);
  }
}
