...
public class DeleteLogStreamRequest {
  ...
  public DeleteLogStreamRequest logGroupName(String logGroupName) {
  ...
  public DeleteLogStreamRequest logStreamName(String logStreamName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logGroupName, deleteLogStreamRequest.logGroupName) &&
        Objects.equals(this.logStreamName, deleteLogStreamRequest.logStreamName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteLogStreamRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteLogStreamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteLogStreamRequest is not found in the empty JSON string", DeleteLogStreamRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteLogStreamRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteLogStreamRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteLogStreamRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteLogStreamRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteLogStreamRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteLogStreamRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteLogStreamRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteLogStreamRequest>() {
           @Override
           public void write(JsonWriter out, DeleteLogStreamRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteLogStreamRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteLogStreamRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteLogStreamRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteLogStreamRequest
   */
  public static DeleteLogStreamRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteLogStreamRequest.class);
  }

  /**
   * Convert an instance of DeleteLogStreamRequest to an JSON string
   *
   * @return JSON string
   */
