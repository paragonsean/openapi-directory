...
/**
 * Gets or Sets ExportTaskStatusCode
 */
@JsonAdapter(ExportTaskStatusCode.Adapter.class)
public enum ExportTaskStatusCode {
  ...
  ExportTaskStatusCode(String value) {
    this.value = value;
  }
  ...
  public static ExportTaskStatusCode fromValue(String value) {
    for (ExportTaskStatusCode b : ExportTaskStatusCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExportTaskStatusCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExportTaskStatusCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExportTaskStatusCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExportTaskStatusCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExportTaskStatusCode.fromValue(value);
  }
}
