...
public class LogGroupField {
  ...
  public LogGroupField() {
  }

  public LogGroupField name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LogGroupField percent(Integer percent) {
  ...
  public boolean equals(Object o) {
    ...
    LogGroupField logGroupField = (LogGroupField) o;
    return Objects.equals(this.name, logGroupField.name) &&
        Objects.equals(this.percent, logGroupField.percent);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogGroupField
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogGroupField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogGroupField is not found in the empty JSON string", LogGroupField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogGroupField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogGroupField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("percent") != null && !jsonObj.get("percent").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("percent"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogGroupField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogGroupField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogGroupField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogGroupField.class));

       return (TypeAdapter<T>) new TypeAdapter<LogGroupField>() {
           @Override
           public void write(JsonWriter out, LogGroupField value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogGroupField read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogGroupField given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogGroupField
   * @throws IOException if the JSON string is invalid with respect to LogGroupField
   */
  public static LogGroupField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogGroupField.class);
  }

  /**
   * Convert an instance of LogGroupField to an JSON string
   *
   * @return JSON string
   */
