...
public class DeleteLogGroupRequest {
  ...
  public DeleteLogGroupRequest logGroupName(String logGroupName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logGroupName, deleteLogGroupRequest.logGroupName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteLogGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteLogGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteLogGroupRequest is not found in the empty JSON string", DeleteLogGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteLogGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteLogGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteLogGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteLogGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteLogGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteLogGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteLogGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteLogGroupRequest>() {
           @Override
           public void write(JsonWriter out, DeleteLogGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteLogGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteLogGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteLogGroupRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteLogGroupRequest
   */
  public static DeleteLogGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteLogGroupRequest.class);
  }

  /**
   * Convert an instance of DeleteLogGroupRequest to an JSON string
   *
   * @return JSON string
   */
