...
public class GetLogGroupFieldsRequest {
  ...
  public GetLogGroupFieldsRequest logGroupName(String logGroupName) {
  ...
  public GetLogGroupFieldsRequest time(Integer time) {
    this.time = time;
    return this;
  }
  ...
  public GetLogGroupFieldsRequest logGroupIdentifier(String logGroupIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    GetLogGroupFieldsRequest getLogGroupFieldsRequest = (GetLogGroupFieldsRequest) o;
    return Objects.equals(this.logGroupName, getLogGroupFieldsRequest.logGroupName) &&
        Objects.equals(this.time, getLogGroupFieldsRequest.time) &&
        Objects.equals(this.logGroupIdentifier, getLogGroupFieldsRequest.logGroupIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logGroupName, time, logGroupIdentifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLogGroupFieldsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLogGroupFieldsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLogGroupFieldsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLogGroupFieldsRequest is not found in the empty JSON string", GetLogGroupFieldsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLogGroupFieldsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLogGroupFieldsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("time") != null && !jsonObj.get("time").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("time"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLogGroupFieldsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLogGroupFieldsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLogGroupFieldsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLogGroupFieldsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLogGroupFieldsRequest>() {
           @Override
           public void write(JsonWriter out, GetLogGroupFieldsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLogGroupFieldsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLogGroupFieldsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLogGroupFieldsRequest
   * @throws IOException if the JSON string is invalid with respect to GetLogGroupFieldsRequest
   */
  public static GetLogGroupFieldsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLogGroupFieldsRequest.class);
  }

  /**
   * Convert an instance of GetLogGroupFieldsRequest to an JSON string
   *
   * @return JSON string
   */
