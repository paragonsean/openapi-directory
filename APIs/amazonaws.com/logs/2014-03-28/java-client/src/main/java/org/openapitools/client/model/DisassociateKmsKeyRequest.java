...
public class DisassociateKmsKeyRequest {
  ...
  public DisassociateKmsKeyRequest() {
  }

  public DisassociateKmsKeyRequest logGroupName(String logGroupName) {
  ...
  public DisassociateKmsKeyRequest resourceIdentifier(String resourceIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateKmsKeyRequest disassociateKmsKeyRequest = (DisassociateKmsKeyRequest) o;
    return Objects.equals(this.logGroupName, disassociateKmsKeyRequest.logGroupName) &&
        Objects.equals(this.resourceIdentifier, disassociateKmsKeyRequest.resourceIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logGroupName, resourceIdentifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisassociateKmsKeyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateKmsKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateKmsKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateKmsKeyRequest is not found in the empty JSON string", DisassociateKmsKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateKmsKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateKmsKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateKmsKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateKmsKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateKmsKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateKmsKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateKmsKeyRequest>() {
           @Override
           public void write(JsonWriter out, DisassociateKmsKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateKmsKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateKmsKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateKmsKeyRequest
   * @throws IOException if the JSON string is invalid with respect to DisassociateKmsKeyRequest
   */
  public static DisassociateKmsKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateKmsKeyRequest.class);
  }

  /**
   * Convert an instance of DisassociateKmsKeyRequest to an JSON string
   *
   * @return JSON string
   */
