...
public class PutDataProtectionPolicyResponse {
  ...
  public PutDataProtectionPolicyResponse() {
  }

  public PutDataProtectionPolicyResponse logGroupIdentifier(String logGroupIdentifier) {
  ...
  public PutDataProtectionPolicyResponse policyDocument(String policyDocument) {
  ...
  public PutDataProtectionPolicyResponse lastUpdatedTime(Integer lastUpdatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    PutDataProtectionPolicyResponse putDataProtectionPolicyResponse = (PutDataProtectionPolicyResponse) o;
    return Objects.equals(this.logGroupIdentifier, putDataProtectionPolicyResponse.logGroupIdentifier) &&
        Objects.equals(this.policyDocument, putDataProtectionPolicyResponse.policyDocument) &&
        Objects.equals(this.lastUpdatedTime, putDataProtectionPolicyResponse.lastUpdatedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutDataProtectionPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDataProtectionPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDataProtectionPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDataProtectionPolicyResponse is not found in the empty JSON string", PutDataProtectionPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDataProtectionPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDataProtectionPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDataProtectionPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDataProtectionPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDataProtectionPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDataProtectionPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDataProtectionPolicyResponse>() {
           @Override
           public void write(JsonWriter out, PutDataProtectionPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDataProtectionPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDataProtectionPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDataProtectionPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to PutDataProtectionPolicyResponse
   */
  public static PutDataProtectionPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDataProtectionPolicyResponse.class);
  }

  /**
   * Convert an instance of PutDataProtectionPolicyResponse to an JSON string
   *
   * @return JSON string
   */
