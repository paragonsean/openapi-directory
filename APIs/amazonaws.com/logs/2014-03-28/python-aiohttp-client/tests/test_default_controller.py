...
async def test_associate_kms_key(client):
    """Test case for associate_kms_key

    
    """
    body = {"logGroupName":"","resourceIdentifier":"","kmsKeyId":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.AssociateKmsKey',
        headers=headers,
        json=body,
        )
...
async def test_cancel_export_task(client):
    """Test case for cancel_export_task
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.CancelExportTask',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_export_task(client):
    """Test case for create_export_task

    
    """
    body = {"logGroupName":"","destinationPrefix":"","logStreamNamePrefix":"","destination":"","taskName":"","from":"","to":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.CreateExportTask',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_log_group(client):
    """Test case for create_log_group
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.CreateLogGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_log_stream(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.CreateLogStream',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_account_policy(client):
    """Test case for delete_account_policy

    
    """
    body = {"policyName":"","policyType":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteAccountPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_data_protection_policy(client):
    """Test case for delete_data_protection_policy
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteDataProtectionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_destination(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteDestination',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_log_group(client):
    """Test case for delete_log_group
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteLogGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_log_stream(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteLogStream',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_metric_filter(client):
    """Test case for delete_metric_filter

    
    """
    body = {"logGroupName":"","filterName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteMetricFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_query_definition(client):
    """Test case for delete_query_definition

    
    """
    body = {"queryDefinitionId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteQueryDefinition',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_resource_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteResourcePolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_retention_policy(client):
    """Test case for delete_retention_policy
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteRetentionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_subscription_filter(client):
    """Test case for delete_subscription_filter
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DeleteSubscriptionFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_account_policies(client):
    """Test case for describe_account_policies

    
    """
    body = {"policyName":"","policyType":"","accountIdentifiers":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeAccountPolicies',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_destinations(client):
    """Test case for describe_destinations

    
    """
    body = {"nextToken":"","limit":"","DestinationNamePrefix":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeDestinations',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_export_tasks(client):
    ...
    """
    body = {"nextToken":"","limit":"","taskId":"","statusCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeExportTasks',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_log_groups(client):
    """Test case for describe_log_groups

    
    """
    body = {"logGroupNamePrefix":"","includeLinkedAccounts":"","nextToken":"","limit":"","logGroupNamePattern":"","accountIdentifiers":""}
    params = [('limit', 'limit_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeLogGroups',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_log_streams(client):
    """Test case for describe_log_streams

    
    """
    body = {"logGroupName":"","logStreamNamePrefix":"","nextToken":"","limit":"","orderBy":"","logGroupIdentifier":"","descending":""}
    params = [('limit', 'limit_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeLogStreams',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_metric_filters(client):
    """Test case for describe_metric_filters

    
    """
    body = {"metricName":"","logGroupName":"","nextToken":"","limit":"","metricNamespace":"","filterNamePrefix":""}
    params = [('limit', 'limit_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeMetricFilters',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_queries(client):
    """Test case for describe_queries

    
    """
    body = {"logGroupName":"","maxResults":"","nextToken":"nextToken","status":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeQueries',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_query_definitions(client):
    """Test case for describe_query_definitions

    
    """
    body = {"maxResults":"","nextToken":"nextToken","queryDefinitionNamePrefix":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeQueryDefinitions',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_resource_policies(client):
    """Test case for describe_resource_policies

    
    """
    body = {"nextToken":"nextToken","limit":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeResourcePolicies',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_subscription_filters(client):
    """Test case for describe_subscription_filters

    
    """
    body = {"logGroupName":"","nextToken":"","limit":"","filterNamePrefix":""}
    params = [('limit', 'limit_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DescribeSubscriptionFilters',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_disassociate_kms_key(client):
    """Test case for disassociate_kms_key

    
    """
    body = {"logGroupName":"","resourceIdentifier":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.DisassociateKmsKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_filter_log_events(client):
    """Test case for filter_log_events

    
    """
    body = {"filterPattern":"","logGroupName":"","logStreamNamePrefix":"","nextToken":"","limit":"","logStreamNames":"","startTime":"","interleaved":"","endTime":"","unmask":"","logGroupIdentifier":""}
    params = [('limit', 'limit_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.FilterLogEvents',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_get_data_protection_policy(client):
    """Test case for get_data_protection_policy
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.GetDataProtectionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_log_events(client):
    """Test case for get_log_events

    
    """
    body = {"startFromHead":"","logGroupName":"","logStreamName":"","nextToken":"","limit":"","startTime":"","endTime":"","unmask":"","logGroupIdentifier":""}
    params = [('limit', 'limit_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.GetLogEvents',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_get_log_group_fields(client):
    """Test case for get_log_group_fields

    
    """
    body = {"logGroupName":"","time":"","logGroupIdentifier":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.GetLogGroupFields',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_log_record(client):
    """Test case for get_log_record

    
    """
    body = {"unmask":"","logRecordPointer":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.GetLogRecord',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_query_results(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.GetQueryResults',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_tags_log_group(client):
    """Test case for list_tags_log_group
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.ListTagsLogGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_account_policy(client):
    """Test case for put_account_policy

    
    """
    body = {"policyDocument":"","policyName":"","policyType":"","scope":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutAccountPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_data_protection_policy(client):
    """Test case for put_data_protection_policy

    
    """
    body = {"policyDocument":"","logGroupIdentifier":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutDataProtectionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_destination(client):
    """Test case for put_destination

    
    """
    body = {"roleArn":"","destinationName":"","targetArn":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutDestination',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_destination_policy(client):
    """Test case for put_destination_policy

    
    """
    body = {"destinationName":"","accessPolicy":"","forceUpdate":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutDestinationPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_log_events(client):
    """Test case for put_log_events

    
    """
    body = {"logEvents":"","logGroupName":"","sequenceToken":"","logStreamName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutLogEvents',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_metric_filter(client):
    """Test case for put_metric_filter

    
    """
    body = {"filterPattern":"","metricTransformations":"","logGroupName":"","filterName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutMetricFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_query_definition(client):
    """Test case for put_query_definition

    
    """
    body = {"logGroupNames":"","queryDefinitionId":"","name":"","queryString":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutQueryDefinition',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_resource_policy(client):
    ...
    """
    body = {"policyDocument":"","policyName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutResourcePolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_retention_policy(client):
    """Test case for put_retention_policy

    
    """
    body = {"retentionInDays":0,"logGroupName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutRetentionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_subscription_filter(client):
    """Test case for put_subscription_filter

    
    """
    body = {"filterPattern":"","logGroupName":"","destinationArn":"","roleArn":"","filterName":"","distribution":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.PutSubscriptionFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_query(client):
    ...
    """
    body = {"logGroupIdentifiers":"","logGroupNames":"","logGroupName":"","limit":"","startTime":"","endTime":"","queryString":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.StartQuery',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stop_query(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.StopQuery',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_log_group(client):
    """Test case for tag_log_group

    
    """
    body = {"logGroupName":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.TagLogGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_test_metric_filter(client):
    """Test case for test_metric_filter

    
    """
    body = {"filterPattern":"filterPattern","logEventMessages":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.TestMetricFilter',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_log_group(client):
    """Test case for untag_log_group
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.UntagLogGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Logs_20140328.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
