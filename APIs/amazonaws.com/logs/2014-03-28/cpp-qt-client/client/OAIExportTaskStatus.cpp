...
OAIExportTaskStatus::OAIExportTaskStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportTaskStatus::OAIExportTaskStatus() {
    this->initializeModel();
}

OAIExportTaskStatus::~OAIExportTaskStatus() {}

void OAIExportTaskStatus::initializeModel() {
...
void OAIExportTaskStatus::fromJson(QString jsonString) {
...
void OAIExportTaskStatus::fromJsonObject(QJsonObject json) {
...
QString OAIExportTaskStatus::asJson() const {
...
QJsonObject OAIExportTaskStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_code.isSet()) {
...
OAIExportTaskStatusCode OAIExportTaskStatus::getCode() const {
    return m_code;
}
void OAIExportTaskStatus::setCode(const OAIExportTaskStatusCode &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIExportTaskStatus::is_code_Set() const{
    return m_code_isSet;
}

bool OAIExportTaskStatus::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIExportTaskStatus::getMessage() const {
    return m_message;
}
void OAIExportTaskStatus::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIExportTaskStatus::is_message_Set() const{
    return m_message_isSet;
}

bool OAIExportTaskStatus::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIExportTaskStatus::isSet() const {
...
bool OAIExportTaskStatus::isValid() const {
