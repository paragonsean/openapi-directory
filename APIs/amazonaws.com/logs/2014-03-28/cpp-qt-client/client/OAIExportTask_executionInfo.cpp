...
OAIExportTask_executionInfo::OAIExportTask_executionInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportTask_executionInfo::OAIExportTask_executionInfo() {
    this->initializeModel();
}

OAIExportTask_executionInfo::~OAIExportTask_executionInfo() {}

void OAIExportTask_executionInfo::initializeModel() {
...
void OAIExportTask_executionInfo::fromJson(QString jsonString) {
...
void OAIExportTask_executionInfo::fromJsonObject(QJsonObject json) {
...
QString OAIExportTask_executionInfo::asJson() const {
...
QJsonObject OAIExportTask_executionInfo::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIExportTask_executionInfo::getCreationTime() const {
    return m_creation_time;
}
void OAIExportTask_executionInfo::setCreationTime(const qint32 &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIExportTask_executionInfo::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIExportTask_executionInfo::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

qint32 OAIExportTask_executionInfo::getCompletionTime() const {
    return m_completion_time;
}
void OAIExportTask_executionInfo::setCompletionTime(const qint32 &completion_time) {
    m_completion_time = completion_time;
    m_completion_time_isSet = true;
}

bool OAIExportTask_executionInfo::is_completion_time_Set() const{
    return m_completion_time_isSet;
}

bool OAIExportTask_executionInfo::is_completion_time_Valid() const{
    return m_completion_time_isValid;
}

bool OAIExportTask_executionInfo::isSet() const {
...
bool OAIExportTask_executionInfo::isValid() const {
