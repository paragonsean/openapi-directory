...
/*
 * OAIGetQueryResultsResponse_statistics.h
 *
 * 
 */

#ifndef OAIGetQueryResultsResponse_statistics_H
#define OAIGetQueryResultsResponse_statistics_H
...
class OAIGetQueryResultsResponse_statistics : public OAIObject {
public:
    OAIGetQueryResultsResponse_statistics();
    OAIGetQueryResultsResponse_statistics(QString json);
    ~OAIGetQueryResultsResponse_statistics() override;
    ...
    void setRecordsMatched(const double &records_matched);
    bool is_records_matched_Set() const;
    bool is_records_matched_Valid() const;

    double getRecordsScanned() const;
    void setRecordsScanned(const double &records_scanned);
    bool is_records_scanned_Set() const;
    bool is_records_scanned_Valid() const;

    double getBytesScanned() const;
    void setBytesScanned(const double &bytes_scanned);
...
private:
    ...
    double m_records_matched;
    bool m_records_matched_isSet;
    bool m_records_matched_isValid;

    double m_records_scanned;
    bool m_records_scanned_isSet;
    bool m_records_scanned_isValid;

    double m_bytes_scanned;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetQueryResultsResponse_statistics)

#endif // OAIGetQueryResultsResponse_statistics_H
