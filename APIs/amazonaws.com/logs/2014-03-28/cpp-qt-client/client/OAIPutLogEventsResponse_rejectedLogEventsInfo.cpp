...
#include "OAIPutLogEventsResponse_rejectedLogEventsInfo.h"
...
OAIPutLogEventsResponse_rejectedLogEventsInfo::OAIPutLogEventsResponse_rejectedLogEventsInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutLogEventsResponse_rejectedLogEventsInfo::OAIPutLogEventsResponse_rejectedLogEventsInfo() {
    this->initializeModel();
}

OAIPutLogEventsResponse_rejectedLogEventsInfo::~OAIPutLogEventsResponse_rejectedLogEventsInfo() {}

void OAIPutLogEventsResponse_rejectedLogEventsInfo::initializeModel() {
...
void OAIPutLogEventsResponse_rejectedLogEventsInfo::fromJson(QString jsonString) {
...
void OAIPutLogEventsResponse_rejectedLogEventsInfo::fromJsonObject(QJsonObject json) {
...
QString OAIPutLogEventsResponse_rejectedLogEventsInfo::asJson() const {
...
QJsonObject OAIPutLogEventsResponse_rejectedLogEventsInfo::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPutLogEventsResponse_rejectedLogEventsInfo::getTooNewLogEventStartIndex() const {
    return m_too_new_log_event_start_index;
}
void OAIPutLogEventsResponse_rejectedLogEventsInfo::setTooNewLogEventStartIndex(const qint32 &too_new_log_event_start_index) {
    m_too_new_log_event_start_index = too_new_log_event_start_index;
    m_too_new_log_event_start_index_isSet = true;
}

bool OAIPutLogEventsResponse_rejectedLogEventsInfo::is_too_new_log_event_start_index_Set() const{
    return m_too_new_log_event_start_index_isSet;
}

bool OAIPutLogEventsResponse_rejectedLogEventsInfo::is_too_new_log_event_start_index_Valid() const{
    return m_too_new_log_event_start_index_isValid;
}

qint32 OAIPutLogEventsResponse_rejectedLogEventsInfo::getTooOldLogEventEndIndex() const {
    return m_too_old_log_event_end_index;
}
void OAIPutLogEventsResponse_rejectedLogEventsInfo::setTooOldLogEventEndIndex(const qint32 &too_old_log_event_end_index) {
    m_too_old_log_event_end_index = too_old_log_event_end_index;
    m_too_old_log_event_end_index_isSet = true;
}

bool OAIPutLogEventsResponse_rejectedLogEventsInfo::is_too_old_log_event_end_index_Set() const{
    return m_too_old_log_event_end_index_isSet;
}

bool OAIPutLogEventsResponse_rejectedLogEventsInfo::is_too_old_log_event_end_index_Valid() const{
    return m_too_old_log_event_end_index_isValid;
}

qint32 OAIPutLogEventsResponse_rejectedLogEventsInfo::getExpiredLogEventEndIndex() const {
    return m_expired_log_event_end_index;
}
void OAIPutLogEventsResponse_rejectedLogEventsInfo::setExpiredLogEventEndIndex(const qint32 &expired_log_event_end_index) {
    m_expired_log_event_end_index = expired_log_event_end_index;
    m_expired_log_event_end_index_isSet = true;
}

bool OAIPutLogEventsResponse_rejectedLogEventsInfo::is_expired_log_event_end_index_Set() const{
    return m_expired_log_event_end_index_isSet;
}

bool OAIPutLogEventsResponse_rejectedLogEventsInfo::is_expired_log_event_end_index_Valid() const{
    return m_expired_log_event_end_index_isValid;
}

bool OAIPutLogEventsResponse_rejectedLogEventsInfo::isSet() const {
...
bool OAIPutLogEventsResponse_rejectedLogEventsInfo::isValid() const {
