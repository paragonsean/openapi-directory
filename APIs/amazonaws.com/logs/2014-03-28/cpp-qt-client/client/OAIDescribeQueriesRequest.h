...
/*
 * OAIDescribeQueriesRequest.h
 *
 * 
 */

#ifndef OAIDescribeQueriesRequest_H
#define OAIDescribeQueriesRequest_H
...
class OAIDescribeQueriesRequest : public OAIObject {
public:
    OAIDescribeQueriesRequest();
    OAIDescribeQueriesRequest(QString json);
    ~OAIDescribeQueriesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeQueriesRequest)

#endif // OAIDescribeQueriesRequest_H
