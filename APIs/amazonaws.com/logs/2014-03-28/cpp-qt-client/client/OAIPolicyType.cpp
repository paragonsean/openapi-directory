...
void OAIPolicyType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("DATA_PROTECTION_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::DATA_PROTECTION_POLICY;
...
QString OAIPolicyType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPolicyType::DATA_PROTECTION_POLICY:
            val = "DATA_PROTECTION_POLICY";
            break;
        default:
            break;
    }
