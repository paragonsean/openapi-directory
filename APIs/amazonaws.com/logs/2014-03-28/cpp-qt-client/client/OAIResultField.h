...
#ifndef OAIResultField_H
#define OAIResultField_H
...
class OAIResultField : public OAIObject {
public:
    OAIResultField();
    OAIResultField(QString json);
    ~OAIResultField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResultField)

#endif // OAIResultField_H
