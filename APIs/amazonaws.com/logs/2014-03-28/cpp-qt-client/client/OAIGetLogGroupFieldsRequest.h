...
/*
 * OAIGetLogGroupFieldsRequest.h
 *
 * 
 */

#ifndef OAIGetLogGroupFieldsRequest_H
#define OAIGetLogGroupFieldsRequest_H
...
class OAIGetLogGroupFieldsRequest : public OAIObject {
public:
    OAIGetLogGroupFieldsRequest();
    OAIGetLogGroupFieldsRequest(QString json);
    ~OAIGetLogGroupFieldsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLogGroupFieldsRequest)

#endif // OAIGetLogGroupFieldsRequest_H
