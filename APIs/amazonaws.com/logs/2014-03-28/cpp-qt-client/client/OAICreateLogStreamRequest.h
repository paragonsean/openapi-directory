...
/*
 * OAICreateLogStreamRequest.h
 *
 * 
 */

#ifndef OAICreateLogStreamRequest_H
#define OAICreateLogStreamRequest_H
...
class OAICreateLogStreamRequest : public OAIObject {
public:
    OAICreateLogStreamRequest();
    OAICreateLogStreamRequest(QString json);
    ~OAICreateLogStreamRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLogStreamRequest)

#endif // OAICreateLogStreamRequest_H
