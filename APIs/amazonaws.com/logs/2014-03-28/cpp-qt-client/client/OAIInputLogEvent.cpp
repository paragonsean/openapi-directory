...
OAIInputLogEvent::OAIInputLogEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInputLogEvent::OAIInputLogEvent() {
    this->initializeModel();
}

OAIInputLogEvent::~OAIInputLogEvent() {}

void OAIInputLogEvent::initializeModel() {
...
void OAIInputLogEvent::fromJson(QString jsonString) {
...
void OAIInputLogEvent::fromJsonObject(QJsonObject json) {
...
QString OAIInputLogEvent::asJson() const {
...
QJsonObject OAIInputLogEvent::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIInputLogEvent::getTimestamp() const {
    return m_timestamp;
}
void OAIInputLogEvent::setTimestamp(const qint32 &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIInputLogEvent::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIInputLogEvent::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

QString OAIInputLogEvent::getMessage() const {
    return m_message;
}
void OAIInputLogEvent::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIInputLogEvent::is_message_Set() const{
    return m_message_isSet;
}

bool OAIInputLogEvent::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIInputLogEvent::isSet() const {
...
bool OAIInputLogEvent::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_timestamp_isValid && m_message_isValid && true;
}
