...
/*
 * OAIDescribeQueriesResponse.h
 *
 * 
 */

#ifndef OAIDescribeQueriesResponse_H
#define OAIDescribeQueriesResponse_H
...
class OAIDescribeQueriesResponse : public OAIObject {
public:
    OAIDescribeQueriesResponse();
    OAIDescribeQueriesResponse(QString json);
    ~OAIDescribeQueriesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeQueriesResponse)

#endif // OAIDescribeQueriesResponse_H
