...
/*
 * OAIDescribeResourcePoliciesRequest.h
 *
 * 
 */

#ifndef OAIDescribeResourcePoliciesRequest_H
#define OAIDescribeResourcePoliciesRequest_H
...
class OAIDescribeResourcePoliciesRequest : public OAIObject {
public:
    OAIDescribeResourcePoliciesRequest();
    OAIDescribeResourcePoliciesRequest(QString json);
    ~OAIDescribeResourcePoliciesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeResourcePoliciesRequest)

#endif // OAIDescribeResourcePoliciesRequest_H
