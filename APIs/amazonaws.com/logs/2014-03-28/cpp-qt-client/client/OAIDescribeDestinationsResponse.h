...
/*
 * OAIDescribeDestinationsResponse.h
 *
 * 
 */

#ifndef OAIDescribeDestinationsResponse_H
#define OAIDescribeDestinationsResponse_H
...
class OAIDescribeDestinationsResponse : public OAIObject {
public:
    OAIDescribeDestinationsResponse();
    OAIDescribeDestinationsResponse(QString json);
    ~OAIDescribeDestinationsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDestinationsResponse)

#endif // OAIDescribeDestinationsResponse_H
