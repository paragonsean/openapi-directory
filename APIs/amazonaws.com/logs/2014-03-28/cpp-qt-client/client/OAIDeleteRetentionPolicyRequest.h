...
/*
 * OAIDeleteRetentionPolicyRequest.h
 *
 * 
 */

#ifndef OAIDeleteRetentionPolicyRequest_H
#define OAIDeleteRetentionPolicyRequest_H
...
class OAIDeleteRetentionPolicyRequest : public OAIObject {
public:
    OAIDeleteRetentionPolicyRequest();
    OAIDeleteRetentionPolicyRequest(QString json);
    ~OAIDeleteRetentionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRetentionPolicyRequest)

#endif // OAIDeleteRetentionPolicyRequest_H
