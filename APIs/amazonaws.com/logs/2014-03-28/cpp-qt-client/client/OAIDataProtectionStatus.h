...
/*
 * OAIDataProtectionStatus.h
 *
 * 
 */

#ifndef OAIDataProtectionStatus_H
#define OAIDataProtectionStatus_H
...
class OAIDataProtectionStatus : public OAIEnum {
public:
    OAIDataProtectionStatus();
    OAIDataProtectionStatus(QString json);
    ~OAIDataProtectionStatus() override;
    ...
    enum class eOAIDataProtectionStatus {
    ...
    OAIDataProtectionStatus::eOAIDataProtectionStatus getValue() const;
    void setValue(const OAIDataProtectionStatus::eOAIDataProtectionStatus& value);
...
private:
    ...
    eOAIDataProtectionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataProtectionStatus)

#endif // OAIDataProtectionStatus_H
