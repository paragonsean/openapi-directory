...
OAITestMetricFilterResponse::OAITestMetricFilterResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestMetricFilterResponse::OAITestMetricFilterResponse() {
    this->initializeModel();
}

OAITestMetricFilterResponse::~OAITestMetricFilterResponse() {}

void OAITestMetricFilterResponse::initializeModel() {

    m_matches_isSet = false;
    m_matches_isValid = false;
}

void OAITestMetricFilterResponse::fromJson(QString jsonString) {
...
void OAITestMetricFilterResponse::fromJsonObject(QJsonObject json) {
...
QString OAITestMetricFilterResponse::asJson() const {
...
QJsonObject OAITestMetricFilterResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_matches.isSet()) {
...
QList OAITestMetricFilterResponse::getMatches() const {
    return m_matches;
}
void OAITestMetricFilterResponse::setMatches(const QList &matches) {
    m_matches = matches;
    m_matches_isSet = true;
}

bool OAITestMetricFilterResponse::is_matches_Set() const{
    return m_matches_isSet;
}

bool OAITestMetricFilterResponse::is_matches_Valid() const{
    return m_matches_isValid;
}

bool OAITestMetricFilterResponse::isSet() const {
...
bool OAITestMetricFilterResponse::isValid() const {
