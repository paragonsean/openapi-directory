...
OAIStopQueryRequest::OAIStopQueryRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopQueryRequest::OAIStopQueryRequest() {
    this->initializeModel();
}

OAIStopQueryRequest::~OAIStopQueryRequest() {}

void OAIStopQueryRequest::initializeModel() {

    m_query_id_isSet = false;
    m_query_id_isValid = false;
}

void OAIStopQueryRequest::fromJson(QString jsonString) {
...
void OAIStopQueryRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopQueryRequest::asJson() const {
...
QJsonObject OAIStopQueryRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_query_id_isSet) {
...
QString OAIStopQueryRequest::getQueryId() const {
    return m_query_id;
}
void OAIStopQueryRequest::setQueryId(const QString &query_id) {
    m_query_id = query_id;
    m_query_id_isSet = true;
}

bool OAIStopQueryRequest::is_query_id_Set() const{
    return m_query_id_isSet;
}

bool OAIStopQueryRequest::is_query_id_Valid() const{
    return m_query_id_isValid;
}

bool OAIStopQueryRequest::isSet() const {
...
bool OAIStopQueryRequest::isValid() const {
