...
/*
 * OAITestMetricFilterResponse.h
 *
 * 
 */

#ifndef OAITestMetricFilterResponse_H
#define OAITestMetricFilterResponse_H
...
class OAITestMetricFilterResponse : public OAIObject {
public:
    OAITestMetricFilterResponse();
    OAITestMetricFilterResponse(QString json);
    ~OAITestMetricFilterResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestMetricFilterResponse)

#endif // OAITestMetricFilterResponse_H
