...
/*
 * OAIUntagLogGroupRequest.h
 *
 * Please use the generic tagging API model UntagResourceRequest
 */

#ifndef OAIUntagLogGroupRequest_H
#define OAIUntagLogGroupRequest_H
...
class OAIUntagLogGroupRequest : public OAIObject {
public:
    OAIUntagLogGroupRequest();
    OAIUntagLogGroupRequest(QString json);
    ~OAIUntagLogGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagLogGroupRequest)

#endif // OAIUntagLogGroupRequest_H
