...
/*
 * OAICreateExportTaskRequest.h
 *
 * 
 */

#ifndef OAICreateExportTaskRequest_H
#define OAICreateExportTaskRequest_H
...
class OAICreateExportTaskRequest : public OAIObject {
public:
    OAICreateExportTaskRequest();
    OAICreateExportTaskRequest(QString json);
    ~OAICreateExportTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExportTaskRequest)

#endif // OAICreateExportTaskRequest_H
