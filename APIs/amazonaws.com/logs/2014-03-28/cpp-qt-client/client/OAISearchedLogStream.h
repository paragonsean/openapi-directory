...
/*
 * OAISearchedLogStream.h
 *
 * Represents the search status of a log stream.
 */

#ifndef OAISearchedLogStream_H
#define OAISearchedLogStream_H
...
class OAISearchedLogStream : public OAIObject {
public:
    OAISearchedLogStream();
    OAISearchedLogStream(QString json);
    ~OAISearchedLogStream() override;
    ...
    void setSearchedCompletely(const bool &searched_completely);
    bool is_searched_completely_Set() const;
    bool is_searched_completely_Valid() const;
...
private:
    ...
    bool m_searched_completely;
    bool m_searched_completely_isSet;
    bool m_searched_completely_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISearchedLogStream)

#endif // OAISearchedLogStream_H
