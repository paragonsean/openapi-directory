...
/*
 * OAICreateLogGroupRequest.h
 *
 * 
 */

#ifndef OAICreateLogGroupRequest_H
#define OAICreateLogGroupRequest_H
...
class OAICreateLogGroupRequest : public OAIObject {
public:
    OAICreateLogGroupRequest();
    OAICreateLogGroupRequest(QString json);
    ~OAICreateLogGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLogGroupRequest)

#endif // OAICreateLogGroupRequest_H
