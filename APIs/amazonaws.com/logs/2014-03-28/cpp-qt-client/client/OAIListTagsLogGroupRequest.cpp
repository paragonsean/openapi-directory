...
OAIListTagsLogGroupRequest::OAIListTagsLogGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTagsLogGroupRequest::OAIListTagsLogGroupRequest() {
    this->initializeModel();
}

OAIListTagsLogGroupRequest::~OAIListTagsLogGroupRequest() {}

void OAIListTagsLogGroupRequest::initializeModel() {

    m_log_group_name_isSet = false;
    m_log_group_name_isValid = false;
}

void OAIListTagsLogGroupRequest::fromJson(QString jsonString) {
...
void OAIListTagsLogGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListTagsLogGroupRequest::asJson() const {
...
QJsonObject OAIListTagsLogGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListTagsLogGroupRequest::getLogGroupName() const {
    return m_log_group_name;
}
void OAIListTagsLogGroupRequest::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAIListTagsLogGroupRequest::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAIListTagsLogGroupRequest::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

bool OAIListTagsLogGroupRequest::isSet() const {
...
bool OAIListTagsLogGroupRequest::isValid() const {
