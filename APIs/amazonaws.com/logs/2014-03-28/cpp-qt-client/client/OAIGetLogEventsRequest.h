...
/*
 * OAIGetLogEventsRequest.h
 *
 * 
 */

#ifndef OAIGetLogEventsRequest_H
#define OAIGetLogEventsRequest_H
...
class OAIGetLogEventsRequest : public OAIObject {
public:
    OAIGetLogEventsRequest();
    OAIGetLogEventsRequest(QString json);
    ~OAIGetLogEventsRequest() override;
    ...
    void setStartFromHead(const bool &start_from_head);
    bool is_start_from_head_Set() const;
    bool is_start_from_head_Valid() const;
...
private:
    ...
    bool m_start_from_head;
    bool m_start_from_head_isSet;
    bool m_start_from_head_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLogEventsRequest)

#endif // OAIGetLogEventsRequest_H
