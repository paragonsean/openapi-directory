...
/*
 * OAIDescribeLogGroupsRequest.h
 *
 * 
 */

#ifndef OAIDescribeLogGroupsRequest_H
#define OAIDescribeLogGroupsRequest_H
...
class OAIDescribeLogGroupsRequest : public OAIObject {
public:
    OAIDescribeLogGroupsRequest();
    OAIDescribeLogGroupsRequest(QString json);
    ~OAIDescribeLogGroupsRequest() override;
    ...
    QList getAccountIdentifiers() const;
    void setAccountIdentifiers(const QList &account_identifiers);
    bool is_account_identifiers_Set() const;
    bool is_account_identifiers_Valid() const;

    QString getLogGroupNamePrefix() const;
    void setLogGroupNamePrefix(const QString &log_group_name_prefix);
    bool is_log_group_name_prefix_Set() const;
    bool is_log_group_name_prefix_Valid() const;

    QString getLogGroupNamePattern() const;
    void setLogGroupNamePattern(const QString &log_group_name_pattern);
    bool is_log_group_name_pattern_Set() const;
    bool is_log_group_name_pattern_Valid() const;
...
private:
    ...
    QList m_account_identifiers;
    bool m_account_identifiers_isSet;
    bool m_account_identifiers_isValid;

    QString m_log_group_name_prefix;
    bool m_log_group_name_prefix_isSet;
    bool m_log_group_name_prefix_isValid;

    QString m_log_group_name_pattern;
    bool m_log_group_name_pattern_isSet;
    bool m_log_group_name_pattern_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLogGroupsRequest)

#endif // OAIDescribeLogGroupsRequest_H
