...
/*
 * OAIExportTask_executionInfo.h
 *
 * 
 */

#ifndef OAIExportTask_executionInfo_H
#define OAIExportTask_executionInfo_H
...
class OAIExportTask_executionInfo : public OAIObject {
public:
    OAIExportTask_executionInfo();
    OAIExportTask_executionInfo(QString json);
    ~OAIExportTask_executionInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportTask_executionInfo)

#endif // OAIExportTask_executionInfo_H
