...
/*
 * OAIStopQueryResponse.h
 *
 * 
 */

#ifndef OAIStopQueryResponse_H
#define OAIStopQueryResponse_H
...
class OAIStopQueryResponse : public OAIObject {
public:
    OAIStopQueryResponse();
    OAIStopQueryResponse(QString json);
    ~OAIStopQueryResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopQueryResponse)

#endif // OAIStopQueryResponse_H
