...
/*
 * OAIPutRetentionPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutRetentionPolicyRequest_H
#define OAIPutRetentionPolicyRequest_H
...
class OAIPutRetentionPolicyRequest : public OAIObject {
public:
    OAIPutRetentionPolicyRequest();
    OAIPutRetentionPolicyRequest(QString json);
    ~OAIPutRetentionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRetentionPolicyRequest)

#endif // OAIPutRetentionPolicyRequest_H
