...
/*
 * OAIPutDataProtectionPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutDataProtectionPolicyRequest_H
#define OAIPutDataProtectionPolicyRequest_H
...
class OAIPutDataProtectionPolicyRequest : public OAIObject {
public:
    OAIPutDataProtectionPolicyRequest();
    OAIPutDataProtectionPolicyRequest(QString json);
    ~OAIPutDataProtectionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDataProtectionPolicyRequest)

#endif // OAIPutDataProtectionPolicyRequest_H
