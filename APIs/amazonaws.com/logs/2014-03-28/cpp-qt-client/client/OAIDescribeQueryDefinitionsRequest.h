...
/*
 * OAIDescribeQueryDefinitionsRequest.h
 *
 * 
 */

#ifndef OAIDescribeQueryDefinitionsRequest_H
#define OAIDescribeQueryDefinitionsRequest_H
...
class OAIDescribeQueryDefinitionsRequest : public OAIObject {
public:
    OAIDescribeQueryDefinitionsRequest();
    OAIDescribeQueryDefinitionsRequest(QString json);
    ~OAIDescribeQueryDefinitionsRequest() override;
    ...
    QString getQueryDefinitionNamePrefix() const;
    void setQueryDefinitionNamePrefix(const QString &query_definition_name_prefix);
    bool is_query_definition_name_prefix_Set() const;
    bool is_query_definition_name_prefix_Valid() const;
...
private:
    ...
    QString m_query_definition_name_prefix;
    bool m_query_definition_name_prefix_isSet;
    bool m_query_definition_name_prefix_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeQueryDefinitionsRequest)

#endif // OAIDescribeQueryDefinitionsRequest_H
