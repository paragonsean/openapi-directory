...
/*
 * OAIDeleteLogStreamRequest.h
 *
 * 
 */

#ifndef OAIDeleteLogStreamRequest_H
#define OAIDeleteLogStreamRequest_H
...
class OAIDeleteLogStreamRequest : public OAIObject {
public:
    OAIDeleteLogStreamRequest();
    OAIDeleteLogStreamRequest(QString json);
    ~OAIDeleteLogStreamRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLogStreamRequest)

#endif // OAIDeleteLogStreamRequest_H
