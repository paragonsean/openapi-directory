...
#ifndef OAIAccountPolicy_H
#define OAIAccountPolicy_H
...
class OAIAccountPolicy : public OAIObject {
public:
    OAIAccountPolicy();
    OAIAccountPolicy(QString json);
    ~OAIAccountPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountPolicy)

#endif // OAIAccountPolicy_H
