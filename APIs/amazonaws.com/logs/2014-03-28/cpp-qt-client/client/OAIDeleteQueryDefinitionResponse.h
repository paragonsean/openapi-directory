...
/*
 * OAIDeleteQueryDefinitionResponse.h
 *
 * 
 */

#ifndef OAIDeleteQueryDefinitionResponse_H
#define OAIDeleteQueryDefinitionResponse_H
...
class OAIDeleteQueryDefinitionResponse : public OAIObject {
public:
    OAIDeleteQueryDefinitionResponse();
    OAIDeleteQueryDefinitionResponse(QString json);
    ~OAIDeleteQueryDefinitionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteQueryDefinitionResponse)

#endif // OAIDeleteQueryDefinitionResponse_H
