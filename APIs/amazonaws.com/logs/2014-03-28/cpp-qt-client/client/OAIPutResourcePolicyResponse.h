...
#include "OAIPutResourcePolicyResponse_resourcePolicy.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutResourcePolicyResponse_resourcePolicy;
...
public:
    ...
    OAIPutResourcePolicyResponse_resourcePolicy getResourcePolicy() const;
    void setResourcePolicy(const OAIPutResourcePolicyResponse_resourcePolicy &resource_policy);
...
private:
    ...
    OAIPutResourcePolicyResponse_resourcePolicy m_resource_policy;
