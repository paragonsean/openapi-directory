...
/*
 * OAIDescribeQueryDefinitionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeQueryDefinitionsResponse_H
#define OAIDescribeQueryDefinitionsResponse_H
...
class OAIDescribeQueryDefinitionsResponse : public OAIObject {
public:
    OAIDescribeQueryDefinitionsResponse();
    OAIDescribeQueryDefinitionsResponse(QString json);
    ~OAIDescribeQueryDefinitionsResponse() override;
    ...
    QList getQueryDefinitions() const;
    void setQueryDefinitions(const QList &query_definitions);
    bool is_query_definitions_Set() const;
    bool is_query_definitions_Valid() const;
...
private:
    ...
    QList m_query_definitions;
    bool m_query_definitions_isSet;
    bool m_query_definitions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeQueryDefinitionsResponse)

#endif // OAIDescribeQueryDefinitionsResponse_H
