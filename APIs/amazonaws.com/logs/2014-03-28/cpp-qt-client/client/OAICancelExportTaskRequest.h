...
/*
 * OAICancelExportTaskRequest.h
 *
 * 
 */

#ifndef OAICancelExportTaskRequest_H
#define OAICancelExportTaskRequest_H
...
class OAICancelExportTaskRequest : public OAIObject {
public:
    OAICancelExportTaskRequest();
    OAICancelExportTaskRequest(QString json);
    ~OAICancelExportTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelExportTaskRequest)

#endif // OAICancelExportTaskRequest_H
