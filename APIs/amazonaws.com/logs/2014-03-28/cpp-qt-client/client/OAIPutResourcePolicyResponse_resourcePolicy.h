...
/*
 * OAIPutResourcePolicyResponse_resourcePolicy.h
 *
 * 
 */

#ifndef OAIPutResourcePolicyResponse_resourcePolicy_H
#define OAIPutResourcePolicyResponse_resourcePolicy_H
...
class OAIPutResourcePolicyResponse_resourcePolicy : public OAIObject {
public:
    OAIPutResourcePolicyResponse_resourcePolicy();
    OAIPutResourcePolicyResponse_resourcePolicy(QString json);
    ~OAIPutResourcePolicyResponse_resourcePolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutResourcePolicyResponse_resourcePolicy)

#endif // OAIPutResourcePolicyResponse_resourcePolicy_H
