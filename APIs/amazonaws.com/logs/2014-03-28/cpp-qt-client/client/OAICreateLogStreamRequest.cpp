...
OAICreateLogStreamRequest::OAICreateLogStreamRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLogStreamRequest::OAICreateLogStreamRequest() {
    this->initializeModel();
}

OAICreateLogStreamRequest::~OAICreateLogStreamRequest() {}

void OAICreateLogStreamRequest::initializeModel() {
...
void OAICreateLogStreamRequest::fromJson(QString jsonString) {
...
void OAICreateLogStreamRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateLogStreamRequest::asJson() const {
...
QJsonObject OAICreateLogStreamRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateLogStreamRequest::getLogGroupName() const {
    return m_log_group_name;
}
void OAICreateLogStreamRequest::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAICreateLogStreamRequest::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAICreateLogStreamRequest::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

QString OAICreateLogStreamRequest::getLogStreamName() const {
    return m_log_stream_name;
}
void OAICreateLogStreamRequest::setLogStreamName(const QString &log_stream_name) {
    m_log_stream_name = log_stream_name;
    m_log_stream_name_isSet = true;
}

bool OAICreateLogStreamRequest::is_log_stream_name_Set() const{
    return m_log_stream_name_isSet;
}

bool OAICreateLogStreamRequest::is_log_stream_name_Valid() const{
    return m_log_stream_name_isValid;
}

bool OAICreateLogStreamRequest::isSet() const {
...
bool OAICreateLogStreamRequest::isValid() const {
