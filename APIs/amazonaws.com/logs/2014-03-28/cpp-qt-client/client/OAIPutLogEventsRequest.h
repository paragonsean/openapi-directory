...
/*
 * OAIPutLogEventsRequest.h
 *
 * 
 */

#ifndef OAIPutLogEventsRequest_H
#define OAIPutLogEventsRequest_H
...
class OAIPutLogEventsRequest : public OAIObject {
public:
    OAIPutLogEventsRequest();
    OAIPutLogEventsRequest(QString json);
    ~OAIPutLogEventsRequest() override;
    ...
    QList getLogEvents() const;
    void setLogEvents(const QList &log_events);
    bool is_log_events_Set() const;
    bool is_log_events_Valid() const;

    QString getSequenceToken() const;
    void setSequenceToken(const QString &sequence_token);
    bool is_sequence_token_Set() const;
    bool is_sequence_token_Valid() const;
...
private:
    ...
    QList m_log_events;
    bool m_log_events_isSet;
    bool m_log_events_isValid;

    QString m_sequence_token;
    bool m_sequence_token_isSet;
    bool m_sequence_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutLogEventsRequest)

#endif // OAIPutLogEventsRequest_H
