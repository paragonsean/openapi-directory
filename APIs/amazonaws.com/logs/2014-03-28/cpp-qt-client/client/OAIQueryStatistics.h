...
/*
 * OAIQueryStatistics.h
 *
 * Contains the number of log events scanned by the query, the number of log events that matched the query criteria, and the total number of bytes in the log events that were scanned.
 */

#ifndef OAIQueryStatistics_H
#define OAIQueryStatistics_H
...
class OAIQueryStatistics : public OAIObject {
public:
    OAIQueryStatistics();
    OAIQueryStatistics(QString json);
    ~OAIQueryStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryStatistics)

#endif // OAIQueryStatistics_H
