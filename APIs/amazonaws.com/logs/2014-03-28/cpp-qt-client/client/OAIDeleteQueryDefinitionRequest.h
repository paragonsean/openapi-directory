...
/*
 * OAIDeleteQueryDefinitionRequest.h
 *
 * 
 */

#ifndef OAIDeleteQueryDefinitionRequest_H
#define OAIDeleteQueryDefinitionRequest_H
...
class OAIDeleteQueryDefinitionRequest : public OAIObject {
public:
    OAIDeleteQueryDefinitionRequest();
    OAIDeleteQueryDefinitionRequest(QString json);
    ~OAIDeleteQueryDefinitionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteQueryDefinitionRequest)

#endif // OAIDeleteQueryDefinitionRequest_H
