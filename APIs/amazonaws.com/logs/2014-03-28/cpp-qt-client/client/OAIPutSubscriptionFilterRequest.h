...
/*
 * OAIPutSubscriptionFilterRequest.h
 *
 * 
 */

#ifndef OAIPutSubscriptionFilterRequest_H
#define OAIPutSubscriptionFilterRequest_H
...
class OAIPutSubscriptionFilterRequest : public OAIObject {
public:
    OAIPutSubscriptionFilterRequest();
    OAIPutSubscriptionFilterRequest(QString json);
    ~OAIPutSubscriptionFilterRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSubscriptionFilterRequest)

#endif // OAIPutSubscriptionFilterRequest_H
