...
/*
 * OAIDeleteDestinationRequest.h
 *
 * 
 */

#ifndef OAIDeleteDestinationRequest_H
#define OAIDeleteDestinationRequest_H
...
class OAIDeleteDestinationRequest : public OAIObject {
public:
    OAIDeleteDestinationRequest();
    OAIDeleteDestinationRequest(QString json);
    ~OAIDeleteDestinationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDestinationRequest)

#endif // OAIDeleteDestinationRequest_H
