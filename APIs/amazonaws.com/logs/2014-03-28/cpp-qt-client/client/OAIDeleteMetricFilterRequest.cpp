...
OAIDeleteMetricFilterRequest::OAIDeleteMetricFilterRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMetricFilterRequest::OAIDeleteMetricFilterRequest() {
    this->initializeModel();
}

OAIDeleteMetricFilterRequest::~OAIDeleteMetricFilterRequest() {}

void OAIDeleteMetricFilterRequest::initializeModel() {
...
void OAIDeleteMetricFilterRequest::fromJson(QString jsonString) {
...
void OAIDeleteMetricFilterRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteMetricFilterRequest::asJson() const {
...
QJsonObject OAIDeleteMetricFilterRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteMetricFilterRequest::getLogGroupName() const {
    return m_log_group_name;
}
void OAIDeleteMetricFilterRequest::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAIDeleteMetricFilterRequest::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAIDeleteMetricFilterRequest::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

QString OAIDeleteMetricFilterRequest::getFilterName() const {
    return m_filter_name;
}
void OAIDeleteMetricFilterRequest::setFilterName(const QString &filter_name) {
    m_filter_name = filter_name;
    m_filter_name_isSet = true;
}

bool OAIDeleteMetricFilterRequest::is_filter_name_Set() const{
    return m_filter_name_isSet;
}

bool OAIDeleteMetricFilterRequest::is_filter_name_Valid() const{
    return m_filter_name_isValid;
}

bool OAIDeleteMetricFilterRequest::isSet() const {
...
bool OAIDeleteMetricFilterRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_log_group_name_isValid && m_filter_name_isValid && true;
}
