...
/*
 * OAIDeleteSubscriptionFilterRequest.h
 *
 * 
 */

#ifndef OAIDeleteSubscriptionFilterRequest_H
#define OAIDeleteSubscriptionFilterRequest_H
...
class OAIDeleteSubscriptionFilterRequest : public OAIObject {
public:
    OAIDeleteSubscriptionFilterRequest();
    OAIDeleteSubscriptionFilterRequest(QString json);
    ~OAIDeleteSubscriptionFilterRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSubscriptionFilterRequest)

#endif // OAIDeleteSubscriptionFilterRequest_H
