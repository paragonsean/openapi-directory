...
#ifndef OAIQueryStatus_H
#define OAIQueryStatus_H
...
class OAIQueryStatus : public OAIEnum {
public:
    OAIQueryStatus();
    OAIQueryStatus(QString json);
    ~OAIQueryStatus() override;
    ...
    OAIQueryStatus::eOAIQueryStatus getValue() const;
    void setValue(const OAIQueryStatus::eOAIQueryStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryStatus)

#endif // OAIQueryStatus_H
