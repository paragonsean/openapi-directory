...
/*
 * OAIDescribeAccountPoliciesRequest.h
 *
 * 
 */

#ifndef OAIDescribeAccountPoliciesRequest_H
#define OAIDescribeAccountPoliciesRequest_H
...
class OAIDescribeAccountPoliciesRequest : public OAIObject {
public:
    OAIDescribeAccountPoliciesRequest();
    OAIDescribeAccountPoliciesRequest(QString json);
    ~OAIDescribeAccountPoliciesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountPoliciesRequest)

#endif // OAIDescribeAccountPoliciesRequest_H
