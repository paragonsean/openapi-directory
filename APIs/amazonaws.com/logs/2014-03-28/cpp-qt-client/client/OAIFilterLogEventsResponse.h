...
/*
 * OAIFilterLogEventsResponse.h
 *
 * 
 */

#ifndef OAIFilterLogEventsResponse_H
#define OAIFilterLogEventsResponse_H
...
class OAIFilterLogEventsResponse : public OAIObject {
public:
    OAIFilterLogEventsResponse();
    OAIFilterLogEventsResponse(QString json);
    ~OAIFilterLogEventsResponse() override;
    ...
    QList getSearchedLogStreams() const;
    void setSearchedLogStreams(const QList &searched_log_streams);
    bool is_searched_log_streams_Set() const;
    bool is_searched_log_streams_Valid() const;
...
private:
    ...
    QList m_searched_log_streams;
    bool m_searched_log_streams_isSet;
    bool m_searched_log_streams_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterLogEventsResponse)

#endif // OAIFilterLogEventsResponse_H
