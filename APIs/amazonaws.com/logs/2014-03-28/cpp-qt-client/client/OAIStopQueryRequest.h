...
/*
 * OAIStopQueryRequest.h
 *
 * 
 */

#ifndef OAIStopQueryRequest_H
#define OAIStopQueryRequest_H
...
class OAIStopQueryRequest : public OAIObject {
public:
    OAIStopQueryRequest();
    OAIStopQueryRequest(QString json);
    ~OAIStopQueryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopQueryRequest)

#endif // OAIStopQueryRequest_H
