...
OAIDescribeResourcePoliciesRequest::OAIDescribeResourcePoliciesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeResourcePoliciesRequest::OAIDescribeResourcePoliciesRequest() {
    this->initializeModel();
}

OAIDescribeResourcePoliciesRequest::~OAIDescribeResourcePoliciesRequest() {}

void OAIDescribeResourcePoliciesRequest::initializeModel() {
...
void OAIDescribeResourcePoliciesRequest::fromJson(QString jsonString) {
...
void OAIDescribeResourcePoliciesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeResourcePoliciesRequest::asJson() const {
...
QJsonObject OAIDescribeResourcePoliciesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeResourcePoliciesRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeResourcePoliciesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeResourcePoliciesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeResourcePoliciesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIDescribeResourcePoliciesRequest::getLimit() const {
    return m_limit;
}
void OAIDescribeResourcePoliciesRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeResourcePoliciesRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeResourcePoliciesRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIDescribeResourcePoliciesRequest::isSet() const {
...
bool OAIDescribeResourcePoliciesRequest::isValid() const {
