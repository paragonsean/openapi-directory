...
OAIDataProtectionStatus::OAIDataProtectionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataProtectionStatus::OAIDataProtectionStatus() {
    this->initializeModel();
}

OAIDataProtectionStatus::~OAIDataProtectionStatus() {}

void OAIDataProtectionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDataProtectionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDataProtectionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataProtectionStatus::ACTIVATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataProtectionStatus::DELETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ARCHIVED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataProtectionStatus::ARCHIVED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataProtectionStatus::DISABLED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDataProtectionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDataProtectionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDataProtectionStatus::ACTIVATED:
            val = "ACTIVATED";
            break;
        case eOAIDataProtectionStatus::DELETED:
            val = "DELETED";
            break;
        case eOAIDataProtectionStatus::ARCHIVED:
            val = "ARCHIVED";
            break;
        case eOAIDataProtectionStatus::DISABLED:
            val = "DISABLED";
            break;
        default:
            break;
...
QJsonValue OAIDataProtectionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDataProtectionStatus::eOAIDataProtectionStatus OAIDataProtectionStatus::getValue() const {
    return m_value;
}

void OAIDataProtectionStatus::setValue(const OAIDataProtectionStatus::eOAIDataProtectionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDataProtectionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIDataProtectionStatus::isValid() const {
