...
/*
 * OAIInheritedProperty.h
 *
 * 
 */

#ifndef OAIInheritedProperty_H
#define OAIInheritedProperty_H
...
class OAIInheritedProperty : public OAIEnum {
public:
    OAIInheritedProperty();
    OAIInheritedProperty(QString json);
    ~OAIInheritedProperty() override;
    ...
    enum class eOAIInheritedProperty {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACCOUNT_DATA_PROTECTION
    };
    OAIInheritedProperty::eOAIInheritedProperty getValue() const;
    void setValue(const OAIInheritedProperty::eOAIInheritedProperty& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIInheritedProperty)

#endif // OAIInheritedProperty_H
