...
/*
 * OAIStartQueryResponse.h
 *
 * 
 */

#ifndef OAIStartQueryResponse_H
#define OAIStartQueryResponse_H
...
class OAIStartQueryResponse : public OAIObject {
public:
    OAIStartQueryResponse();
    OAIStartQueryResponse(QString json);
    ~OAIStartQueryResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartQueryResponse)

#endif // OAIStartQueryResponse_H
