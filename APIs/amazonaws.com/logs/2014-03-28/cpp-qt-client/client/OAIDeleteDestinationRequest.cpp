...
OAIDeleteDestinationRequest::OAIDeleteDestinationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDestinationRequest::OAIDeleteDestinationRequest() {
    this->initializeModel();
}

OAIDeleteDestinationRequest::~OAIDeleteDestinationRequest() {}

void OAIDeleteDestinationRequest::initializeModel() {

    m_destination_name_isSet = false;
    m_destination_name_isValid = false;
}

void OAIDeleteDestinationRequest::fromJson(QString jsonString) {
...
void OAIDeleteDestinationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteDestinationRequest::asJson() const {
...
QJsonObject OAIDeleteDestinationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteDestinationRequest::getDestinationName() const {
    return m_destination_name;
}
void OAIDeleteDestinationRequest::setDestinationName(const QString &destination_name) {
    m_destination_name = destination_name;
    m_destination_name_isSet = true;
}

bool OAIDeleteDestinationRequest::is_destination_name_Set() const{
    return m_destination_name_isSet;
}

bool OAIDeleteDestinationRequest::is_destination_name_Valid() const{
    return m_destination_name_isValid;
}

bool OAIDeleteDestinationRequest::isSet() const {
...
bool OAIDeleteDestinationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_destination_name_isValid && true;
}
