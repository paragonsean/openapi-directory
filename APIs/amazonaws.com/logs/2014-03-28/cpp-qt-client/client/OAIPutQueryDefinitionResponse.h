...
/*
 * OAIPutQueryDefinitionResponse.h
 *
 * 
 */

#ifndef OAIPutQueryDefinitionResponse_H
#define OAIPutQueryDefinitionResponse_H
...
class OAIPutQueryDefinitionResponse : public OAIObject {
public:
    OAIPutQueryDefinitionResponse();
    OAIPutQueryDefinitionResponse(QString json);
    ~OAIPutQueryDefinitionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutQueryDefinitionResponse)

#endif // OAIPutQueryDefinitionResponse_H
