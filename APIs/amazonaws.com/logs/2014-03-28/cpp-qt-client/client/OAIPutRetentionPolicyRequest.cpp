...
OAIPutRetentionPolicyRequest::OAIPutRetentionPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRetentionPolicyRequest::OAIPutRetentionPolicyRequest() {
    this->initializeModel();
}

OAIPutRetentionPolicyRequest::~OAIPutRetentionPolicyRequest() {}

void OAIPutRetentionPolicyRequest::initializeModel() {
...
void OAIPutRetentionPolicyRequest::fromJson(QString jsonString) {
...
void OAIPutRetentionPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutRetentionPolicyRequest::asJson() const {
...
QJsonObject OAIPutRetentionPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutRetentionPolicyRequest::getLogGroupName() const {
    return m_log_group_name;
}
void OAIPutRetentionPolicyRequest::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAIPutRetentionPolicyRequest::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAIPutRetentionPolicyRequest::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

qint32 OAIPutRetentionPolicyRequest::getRetentionInDays() const {
    return m_retention_in_days;
}
void OAIPutRetentionPolicyRequest::setRetentionInDays(const qint32 &retention_in_days) {
    m_retention_in_days = retention_in_days;
    m_retention_in_days_isSet = true;
}

bool OAIPutRetentionPolicyRequest::is_retention_in_days_Set() const{
    return m_retention_in_days_isSet;
}

bool OAIPutRetentionPolicyRequest::is_retention_in_days_Valid() const{
    return m_retention_in_days_isValid;
}

bool OAIPutRetentionPolicyRequest::isSet() const {
...
bool OAIPutRetentionPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_log_group_name_isValid && m_retention_in_days_isValid && true;
}
