...
/*
 * OAIGetLogEventsResponse.h
 *
 * 
 */

#ifndef OAIGetLogEventsResponse_H
#define OAIGetLogEventsResponse_H
...
class OAIGetLogEventsResponse : public OAIObject {
public:
    OAIGetLogEventsResponse();
    OAIGetLogEventsResponse(QString json);
    ~OAIGetLogEventsResponse() override;
    ...
    QString getNextForwardToken() const;
    void setNextForwardToken(const QString &next_forward_token);
    bool is_next_forward_token_Set() const;
    bool is_next_forward_token_Valid() const;

    QString getNextBackwardToken() const;
    void setNextBackwardToken(const QString &next_backward_token);
    bool is_next_backward_token_Set() const;
    bool is_next_backward_token_Valid() const;
...
private:
    ...
    QString m_next_forward_token;
    bool m_next_forward_token_isSet;
    bool m_next_forward_token_isValid;

    QString m_next_backward_token;
    bool m_next_backward_token_isSet;
    bool m_next_backward_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetLogEventsResponse)

#endif // OAIGetLogEventsResponse_H
