...
QString OAIDescribeExportTasksRequest::getTaskId() const {
    return m_task_id;
}
void OAIDescribeExportTasksRequest::setTaskId(const QString &task_id) {
    m_task_id = task_id;
    m_task_id_isSet = true;
}

bool OAIDescribeExportTasksRequest::is_task_id_Set() const{
    return m_task_id_isSet;
}

bool OAIDescribeExportTasksRequest::is_task_id_Valid() const{
    return m_task_id_isValid;
}

OAIExportTaskStatusCode OAIDescribeExportTasksRequest::getStatusCode() const {
    return m_status_code;
}
void OAIDescribeExportTasksRequest::setStatusCode(const OAIExportTaskStatusCode &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIDescribeExportTasksRequest::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIDescribeExportTasksRequest::is_status_code_Valid() const{
...
qint32 OAIDescribeExportTasksRequest::getLimit() const {
    return m_limit;
}
void OAIDescribeExportTasksRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeExportTasksRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeExportTasksRequest::is_limit_Valid() const{
