...
/*
 * OAIDescribeExportTasksResponse.h
 *
 * 
 */

#ifndef OAIDescribeExportTasksResponse_H
#define OAIDescribeExportTasksResponse_H
...
class OAIDescribeExportTasksResponse : public OAIObject {
public:
    OAIDescribeExportTasksResponse();
    OAIDescribeExportTasksResponse(QString json);
    ~OAIDescribeExportTasksResponse() override;
    ...
    QList getExportTasks() const;
    void setExportTasks(const QList &export_tasks);
    bool is_export_tasks_Set() const;
    bool is_export_tasks_Valid() const;
...
private:
    ...
    QList m_export_tasks;
    bool m_export_tasks_isSet;
    bool m_export_tasks_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExportTasksResponse)

#endif // OAIDescribeExportTasksResponse_H
