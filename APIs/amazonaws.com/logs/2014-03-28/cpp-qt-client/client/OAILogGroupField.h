...
#ifndef OAILogGroupField_H
#define OAILogGroupField_H
...
class OAILogGroupField : public OAIObject {
public:
    OAILogGroupField();
    OAILogGroupField(QString json);
    ~OAILogGroupField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogGroupField)

#endif // OAILogGroupField_H
