...
/*
 * OAIDescribeLogStreamsResponse.h
 *
 * 
 */

#ifndef OAIDescribeLogStreamsResponse_H
#define OAIDescribeLogStreamsResponse_H
...
class OAIDescribeLogStreamsResponse : public OAIObject {
public:
    OAIDescribeLogStreamsResponse();
    OAIDescribeLogStreamsResponse(QString json);
    ~OAIDescribeLogStreamsResponse() override;
    ...
    QList getLogStreams() const;
    void setLogStreams(const QList &log_streams);
    bool is_log_streams_Set() const;
    bool is_log_streams_Valid() const;
...
private:
    ...
    QList m_log_streams;
    bool m_log_streams_isSet;
    bool m_log_streams_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLogStreamsResponse)

#endif // OAIDescribeLogStreamsResponse_H
