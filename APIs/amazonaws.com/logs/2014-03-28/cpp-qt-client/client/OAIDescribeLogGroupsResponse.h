...
/*
 * OAIDescribeLogGroupsResponse.h
 *
 * 
 */

#ifndef OAIDescribeLogGroupsResponse_H
#define OAIDescribeLogGroupsResponse_H
...
class OAIDescribeLogGroupsResponse : public OAIObject {
public:
    OAIDescribeLogGroupsResponse();
    OAIDescribeLogGroupsResponse(QString json);
    ~OAIDescribeLogGroupsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLogGroupsResponse)

#endif // OAIDescribeLogGroupsResponse_H
