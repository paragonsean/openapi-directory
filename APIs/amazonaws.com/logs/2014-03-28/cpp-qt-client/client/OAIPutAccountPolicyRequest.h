...
/*
 * OAIPutAccountPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutAccountPolicyRequest_H
#define OAIPutAccountPolicyRequest_H
...
class OAIPutAccountPolicyRequest : public OAIObject {
public:
    OAIPutAccountPolicyRequest();
    OAIPutAccountPolicyRequest(QString json);
    ~OAIPutAccountPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutAccountPolicyRequest)

#endif // OAIPutAccountPolicyRequest_H
