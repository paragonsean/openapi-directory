...
/*
 * OAIExportTaskExecutionInfo.h
 *
 * Represents the status of an export task.
 */

#ifndef OAIExportTaskExecutionInfo_H
#define OAIExportTaskExecutionInfo_H
...
class OAIExportTaskExecutionInfo : public OAIObject {
public:
    OAIExportTaskExecutionInfo();
    OAIExportTaskExecutionInfo(QString json);
    ~OAIExportTaskExecutionInfo() override;
    ...
    qint32 getCompletionTime() const;
    void setCompletionTime(const qint32 &completion_time);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportTaskExecutionInfo)

#endif // OAIExportTaskExecutionInfo_H
