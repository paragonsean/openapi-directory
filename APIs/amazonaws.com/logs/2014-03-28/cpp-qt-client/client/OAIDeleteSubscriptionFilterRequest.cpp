...
OAIDeleteSubscriptionFilterRequest::OAIDeleteSubscriptionFilterRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSubscriptionFilterRequest::OAIDeleteSubscriptionFilterRequest() {
    this->initializeModel();
}

OAIDeleteSubscriptionFilterRequest::~OAIDeleteSubscriptionFilterRequest() {}

void OAIDeleteSubscriptionFilterRequest::initializeModel() {
...
void OAIDeleteSubscriptionFilterRequest::fromJson(QString jsonString) {
...
void OAIDeleteSubscriptionFilterRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSubscriptionFilterRequest::asJson() const {
...
QJsonObject OAIDeleteSubscriptionFilterRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteSubscriptionFilterRequest::getLogGroupName() const {
    return m_log_group_name;
}
void OAIDeleteSubscriptionFilterRequest::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAIDeleteSubscriptionFilterRequest::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAIDeleteSubscriptionFilterRequest::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

QString OAIDeleteSubscriptionFilterRequest::getFilterName() const {
    return m_filter_name;
}
void OAIDeleteSubscriptionFilterRequest::setFilterName(const QString &filter_name) {
    m_filter_name = filter_name;
    m_filter_name_isSet = true;
}

bool OAIDeleteSubscriptionFilterRequest::is_filter_name_Set() const{
    return m_filter_name_isSet;
}

bool OAIDeleteSubscriptionFilterRequest::is_filter_name_Valid() const{
    return m_filter_name_isValid;
}

bool OAIDeleteSubscriptionFilterRequest::isSet() const {
...
bool OAIDeleteSubscriptionFilterRequest::isValid() const {
