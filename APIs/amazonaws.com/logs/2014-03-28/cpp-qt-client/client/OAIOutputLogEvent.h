...
#ifndef OAIOutputLogEvent_H
#define OAIOutputLogEvent_H
...
class OAIOutputLogEvent : public OAIObject {
public:
    OAIOutputLogEvent();
    OAIOutputLogEvent(QString json);
    ~OAIOutputLogEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputLogEvent)

#endif // OAIOutputLogEvent_H
