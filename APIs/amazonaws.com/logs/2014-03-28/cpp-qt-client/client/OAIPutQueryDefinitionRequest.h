...
/*
 * OAIPutQueryDefinitionRequest.h
 *
 * 
 */

#ifndef OAIPutQueryDefinitionRequest_H
#define OAIPutQueryDefinitionRequest_H
...
class OAIPutQueryDefinitionRequest : public OAIObject {
public:
    OAIPutQueryDefinitionRequest();
    OAIPutQueryDefinitionRequest(QString json);
    ~OAIPutQueryDefinitionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutQueryDefinitionRequest)

#endif // OAIPutQueryDefinitionRequest_H
