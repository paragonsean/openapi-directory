...
void OAIDistribution::initializeModel() {
    ...
    m_value = eOAIDistribution::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDistribution::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Random", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDistribution::RANDOM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ByLogStream", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDistribution::BYLOGSTREAM;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDistribution::fromJsonValue(QJsonValue json) {
...
QString OAIDistribution::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIDistribution::RANDOM:
            val = "Random";
            break;
        case eOAIDistribution::BYLOGSTREAM:
            val = "ByLogStream";
            break;
        default:
            break;
...
QJsonValue OAIDistribution::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDistribution::eOAIDistribution OAIDistribution::getValue() const {
    return m_value;
}

void OAIDistribution::setValue(const OAIDistribution::eOAIDistribution& value){
    m_value = value;
    m_value_isSet = true;
}
