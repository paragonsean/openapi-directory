...
/*
 * OAIGetLogRecordRequest.h
 *
 * 
 */

#ifndef OAIGetLogRecordRequest_H
#define OAIGetLogRecordRequest_H
...
class OAIGetLogRecordRequest : public OAIObject {
public:
    OAIGetLogRecordRequest();
    OAIGetLogRecordRequest(QString json);
    ~OAIGetLogRecordRequest() override;
    ...
    QString getLogRecordPointer() const;
    void setLogRecordPointer(const QString &log_record_pointer);
    bool is_log_record_pointer_Set() const;
    bool is_log_record_pointer_Valid() const;
...
private:
    ...
    QString m_log_record_pointer;
    bool m_log_record_pointer_isSet;
    bool m_log_record_pointer_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLogRecordRequest)

#endif // OAIGetLogRecordRequest_H
