...
/*
 * OAIDescribeLogStreamsRequest.h
 *
 * 
 */

#ifndef OAIDescribeLogStreamsRequest_H
#define OAIDescribeLogStreamsRequest_H
...
class OAIDescribeLogStreamsRequest : public OAIObject {
public:
    OAIDescribeLogStreamsRequest();
    OAIDescribeLogStreamsRequest(QString json);
    ~OAIDescribeLogStreamsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLogStreamsRequest)

#endif // OAIDescribeLogStreamsRequest_H
