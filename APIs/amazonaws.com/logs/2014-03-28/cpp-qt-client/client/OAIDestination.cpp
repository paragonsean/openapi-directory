...
QString OAIDestination::getTargetArn() const {
    return m_target_arn;
}
void OAIDestination::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIDestination::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIDestination::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QString OAIDestination::getRoleArn() const {
    return m_role_arn;
}
void OAIDestination::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIDestination::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIDestination::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIDestination::getAccessPolicy() const {
    return m_access_policy;
}
void OAIDestination::setAccessPolicy(const QString &access_policy) {
    m_access_policy = access_policy;
    m_access_policy_isSet = true;
}

bool OAIDestination::is_access_policy_Set() const{
    return m_access_policy_isSet;
}

bool OAIDestination::is_access_policy_Valid() const{
    return m_access_policy_isValid;
}

QString OAIDestination::getArn() const {
    return m_arn;
}
void OAIDestination::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDestination::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDestination::is_arn_Valid() const{
    return m_arn_isValid;
}

qint32 OAIDestination::getCreationTime() const {
    return m_creation_time;
}
void OAIDestination::setCreationTime(const qint32 &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIDestination::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIDestination::is_creation_time_Valid() const{
