...
#include "OAIInheritedProperty.h"
...
OAIInheritedProperty::OAIInheritedProperty(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInheritedProperty::OAIInheritedProperty() {
    this->initializeModel();
}

OAIInheritedProperty::~OAIInheritedProperty() {}

void OAIInheritedProperty::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIInheritedProperty::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIInheritedProperty::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACCOUNT_DATA_PROTECTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIInheritedProperty::ACCOUNT_DATA_PROTECTION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIInheritedProperty::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIInheritedProperty::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIInheritedProperty::ACCOUNT_DATA_PROTECTION:
            val = "ACCOUNT_DATA_PROTECTION";
            break;
        default:
            break;
    }
...
QJsonValue OAIInheritedProperty::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIInheritedProperty::eOAIInheritedProperty OAIInheritedProperty::getValue() const {
    return m_value;
}

void OAIInheritedProperty::setValue(const OAIInheritedProperty::eOAIInheritedProperty& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIInheritedProperty::isSet() const {
    
    return m_value_isSet;
}

bool OAIInheritedProperty::isValid() const {
