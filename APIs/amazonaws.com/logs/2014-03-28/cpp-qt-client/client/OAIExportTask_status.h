...
/*
 * OAIExportTask_status.h
 *
 * 
 */

#ifndef OAIExportTask_status_H
#define OAIExportTask_status_H
...
class OAIExportTask_status : public OAIObject {
public:
    OAIExportTask_status();
    OAIExportTask_status(QString json);
    ~OAIExportTask_status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportTask_status)

#endif // OAIExportTask_status_H
