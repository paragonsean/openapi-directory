...
/*
 * OAIAssociateKmsKeyRequest.h
 *
 * 
 */

#ifndef OAIAssociateKmsKeyRequest_H
#define OAIAssociateKmsKeyRequest_H
...
class OAIAssociateKmsKeyRequest : public OAIObject {
public:
    OAIAssociateKmsKeyRequest();
    OAIAssociateKmsKeyRequest(QString json);
    ~OAIAssociateKmsKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateKmsKeyRequest)

#endif // OAIAssociateKmsKeyRequest_H
