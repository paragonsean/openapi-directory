...
OAIDeleteRetentionPolicyRequest::OAIDeleteRetentionPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRetentionPolicyRequest::OAIDeleteRetentionPolicyRequest() {
    this->initializeModel();
}

OAIDeleteRetentionPolicyRequest::~OAIDeleteRetentionPolicyRequest() {}

void OAIDeleteRetentionPolicyRequest::initializeModel() {

    m_log_group_name_isSet = false;
    m_log_group_name_isValid = false;
}

void OAIDeleteRetentionPolicyRequest::fromJson(QString jsonString) {
...
void OAIDeleteRetentionPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRetentionPolicyRequest::asJson() const {
...
QJsonObject OAIDeleteRetentionPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRetentionPolicyRequest::getLogGroupName() const {
    return m_log_group_name;
}
void OAIDeleteRetentionPolicyRequest::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAIDeleteRetentionPolicyRequest::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAIDeleteRetentionPolicyRequest::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

bool OAIDeleteRetentionPolicyRequest::isSet() const {
...
bool OAIDeleteRetentionPolicyRequest::isValid() const {
