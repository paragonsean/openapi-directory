...
OAIDescribeDestinationsResponse::OAIDescribeDestinationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeDestinationsResponse::OAIDescribeDestinationsResponse() {
    this->initializeModel();
}

OAIDescribeDestinationsResponse::~OAIDescribeDestinationsResponse() {}

void OAIDescribeDestinationsResponse::initializeModel() {
...
void OAIDescribeDestinationsResponse::fromJson(QString jsonString) {
...
void OAIDescribeDestinationsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeDestinationsResponse::asJson() const {
...
QJsonObject OAIDescribeDestinationsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeDestinationsResponse::getDestinations() const {
    return m_destinations;
}
void OAIDescribeDestinationsResponse::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIDescribeDestinationsResponse::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIDescribeDestinationsResponse::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QString OAIDescribeDestinationsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeDestinationsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeDestinationsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeDestinationsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeDestinationsResponse::isSet() const {
...
bool OAIDescribeDestinationsResponse::isValid() const {
