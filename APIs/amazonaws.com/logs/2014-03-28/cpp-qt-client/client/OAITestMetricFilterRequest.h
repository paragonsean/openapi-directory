...
/*
 * OAITestMetricFilterRequest.h
 *
 * 
 */

#ifndef OAITestMetricFilterRequest_H
#define OAITestMetricFilterRequest_H
...
class OAITestMetricFilterRequest : public OAIObject {
public:
    OAITestMetricFilterRequest();
    OAITestMetricFilterRequest(QString json);
    ~OAITestMetricFilterRequest() override;
    ...
    QList getLogEventMessages() const;
    void setLogEventMessages(const QList &log_event_messages);
    bool is_log_event_messages_Set() const;
    bool is_log_event_messages_Valid() const;
...
private:
    ...
    QList m_log_event_messages;
    bool m_log_event_messages_isSet;
    bool m_log_event_messages_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITestMetricFilterRequest)

#endif // OAITestMetricFilterRequest_H
