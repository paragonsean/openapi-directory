...
OAIDeleteQueryDefinitionResponse::OAIDeleteQueryDefinitionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteQueryDefinitionResponse::OAIDeleteQueryDefinitionResponse() {
    this->initializeModel();
}

OAIDeleteQueryDefinitionResponse::~OAIDeleteQueryDefinitionResponse() {}

void OAIDeleteQueryDefinitionResponse::initializeModel() {

    m_success_isSet = false;
    m_success_isValid = false;
}

void OAIDeleteQueryDefinitionResponse::fromJson(QString jsonString) {
...
void OAIDeleteQueryDefinitionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteQueryDefinitionResponse::asJson() const {
...
QJsonObject OAIDeleteQueryDefinitionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_success_isSet) {
...
bool OAIDeleteQueryDefinitionResponse::getSuccess() const {
    return m_success;
}
void OAIDeleteQueryDefinitionResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIDeleteQueryDefinitionResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIDeleteQueryDefinitionResponse::is_success_Valid() const{
    return m_success_isValid;
}

bool OAIDeleteQueryDefinitionResponse::isSet() const {
...
bool OAIDeleteQueryDefinitionResponse::isValid() const {
