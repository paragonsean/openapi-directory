...
/*
 * OAIPutDestinationResponse_destination.h
 *
 * 
 */

#ifndef OAIPutDestinationResponse_destination_H
#define OAIPutDestinationResponse_destination_H
...
class OAIPutDestinationResponse_destination : public OAIObject {
public:
    OAIPutDestinationResponse_destination();
    OAIPutDestinationResponse_destination(QString json);
    ~OAIPutDestinationResponse_destination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDestinationResponse_destination)

#endif // OAIPutDestinationResponse_destination_H
