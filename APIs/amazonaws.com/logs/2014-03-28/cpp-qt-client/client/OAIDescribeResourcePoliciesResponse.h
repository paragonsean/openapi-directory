...
/*
 * OAIDescribeResourcePoliciesResponse.h
 *
 * 
 */

#ifndef OAIDescribeResourcePoliciesResponse_H
#define OAIDescribeResourcePoliciesResponse_H
...
class OAIDescribeResourcePoliciesResponse : public OAIObject {
public:
    OAIDescribeResourcePoliciesResponse();
    OAIDescribeResourcePoliciesResponse(QString json);
    ~OAIDescribeResourcePoliciesResponse() override;
    ...
    QList getResourcePolicies() const;
    void setResourcePolicies(const QList &resource_policies);
    bool is_resource_policies_Set() const;
    bool is_resource_policies_Valid() const;
...
private:
    ...
    QList m_resource_policies;
    bool m_resource_policies_isSet;
    bool m_resource_policies_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeResourcePoliciesResponse)

#endif // OAIDescribeResourcePoliciesResponse_H
