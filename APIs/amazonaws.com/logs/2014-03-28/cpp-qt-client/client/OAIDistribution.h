...
class OAIDistribution : public OAIEnum {
public:
    OAIDistribution();
    ...
    enum class eOAIDistribution {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RANDOM, 
        BYLOGSTREAM
    };
    OAIDistribution::eOAIDistribution getValue() const;
    void setValue(const OAIDistribution::eOAIDistribution& value);
