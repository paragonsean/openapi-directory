...
namespace OpenAPI {
class OAIGetQueryResultsResponse_statistics;
...
public:
    ...
    OAIGetQueryResultsResponse_statistics getStatistics() const;
    void setStatistics(const OAIGetQueryResultsResponse_statistics &statistics);
...
private:
    ...
    OAIGetQueryResultsResponse_statistics m_statistics;
