...
/*
 * OAIGetDataProtectionPolicyRequest.h
 *
 * 
 */

#ifndef OAIGetDataProtectionPolicyRequest_H
#define OAIGetDataProtectionPolicyRequest_H
...
class OAIGetDataProtectionPolicyRequest : public OAIObject {
public:
    OAIGetDataProtectionPolicyRequest();
    OAIGetDataProtectionPolicyRequest(QString json);
    ~OAIGetDataProtectionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataProtectionPolicyRequest)

#endif // OAIGetDataProtectionPolicyRequest_H
