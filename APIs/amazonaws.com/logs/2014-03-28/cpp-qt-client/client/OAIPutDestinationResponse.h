...
/*
 * OAIPutDestinationResponse.h
 *
 * 
 */

#ifndef OAIPutDestinationResponse_H
#define OAIPutDestinationResponse_H
...
namespace OpenAPI {
class OAIPutDestinationResponse_destination;

class OAIPutDestinationResponse : public OAIObject {
public:
    OAIPutDestinationResponse();
    OAIPutDestinationResponse(QString json);
    ~OAIPutDestinationResponse() override;
    ...
    OAIPutDestinationResponse_destination getDestination() const;
    void setDestination(const OAIPutDestinationResponse_destination &destination);
...
private:
    ...
    OAIPutDestinationResponse_destination m_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDestinationResponse)

#endif // OAIPutDestinationResponse_H
