...
#include "OAIExportTaskExecutionInfo.h"
...
OAIExportTaskExecutionInfo::OAIExportTaskExecutionInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportTaskExecutionInfo::OAIExportTaskExecutionInfo() {
    this->initializeModel();
}

OAIExportTaskExecutionInfo::~OAIExportTaskExecutionInfo() {}

void OAIExportTaskExecutionInfo::initializeModel() {
...
void OAIExportTaskExecutionInfo::fromJson(QString jsonString) {
...
void OAIExportTaskExecutionInfo::fromJsonObject(QJsonObject json) {
...
QString OAIExportTaskExecutionInfo::asJson() const {
...
QJsonObject OAIExportTaskExecutionInfo::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIExportTaskExecutionInfo::getCreationTime() const {
    return m_creation_time;
}
void OAIExportTaskExecutionInfo::setCreationTime(const qint32 &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIExportTaskExecutionInfo::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIExportTaskExecutionInfo::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

qint32 OAIExportTaskExecutionInfo::getCompletionTime() const {
    return m_completion_time;
}
void OAIExportTaskExecutionInfo::setCompletionTime(const qint32 &completion_time) {
    m_completion_time = completion_time;
    m_completion_time_isSet = true;
}

bool OAIExportTaskExecutionInfo::is_completion_time_Set() const{
    return m_completion_time_isSet;
}

bool OAIExportTaskExecutionInfo::is_completion_time_Valid() const{
    return m_completion_time_isValid;
}

bool OAIExportTaskExecutionInfo::isSet() const {
...
bool OAIExportTaskExecutionInfo::isValid() const {
