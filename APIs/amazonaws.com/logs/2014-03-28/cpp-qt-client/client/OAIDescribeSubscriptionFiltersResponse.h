...
/*
 * OAIDescribeSubscriptionFiltersResponse.h
 *
 * 
 */

#ifndef OAIDescribeSubscriptionFiltersResponse_H
#define OAIDescribeSubscriptionFiltersResponse_H
...
class OAIDescribeSubscriptionFiltersResponse : public OAIObject {
public:
    OAIDescribeSubscriptionFiltersResponse();
    OAIDescribeSubscriptionFiltersResponse(QString json);
    ~OAIDescribeSubscriptionFiltersResponse() override;
    ...
    QList getSubscriptionFilters() const;
    void setSubscriptionFilters(const QList &subscription_filters);
    bool is_subscription_filters_Set() const;
    bool is_subscription_filters_Valid() const;
...
private:
    ...
    QList m_subscription_filters;
    bool m_subscription_filters_isSet;
    bool m_subscription_filters_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSubscriptionFiltersResponse)

#endif // OAIDescribeSubscriptionFiltersResponse_H
