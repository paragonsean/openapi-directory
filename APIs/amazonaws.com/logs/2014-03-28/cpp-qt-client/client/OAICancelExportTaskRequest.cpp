...
OAICancelExportTaskRequest::OAICancelExportTaskRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelExportTaskRequest::OAICancelExportTaskRequest() {
    this->initializeModel();
}

OAICancelExportTaskRequest::~OAICancelExportTaskRequest() {}

void OAICancelExportTaskRequest::initializeModel() {

    m_task_id_isSet = false;
    m_task_id_isValid = false;
}

void OAICancelExportTaskRequest::fromJson(QString jsonString) {
...
void OAICancelExportTaskRequest::fromJsonObject(QJsonObject json) {
...
QString OAICancelExportTaskRequest::asJson() const {
...
QJsonObject OAICancelExportTaskRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_task_id_isSet) {
...
QString OAICancelExportTaskRequest::getTaskId() const {
    return m_task_id;
}
void OAICancelExportTaskRequest::setTaskId(const QString &task_id) {
    m_task_id = task_id;
    m_task_id_isSet = true;
}

bool OAICancelExportTaskRequest::is_task_id_Set() const{
    return m_task_id_isSet;
}

bool OAICancelExportTaskRequest::is_task_id_Valid() const{
    return m_task_id_isValid;
}

bool OAICancelExportTaskRequest::isSet() const {
...
bool OAICancelExportTaskRequest::isValid() const {
