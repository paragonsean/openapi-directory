...
/*
 * OAIDeleteDataProtectionPolicyRequest.h
 *
 * 
 */

#ifndef OAIDeleteDataProtectionPolicyRequest_H
#define OAIDeleteDataProtectionPolicyRequest_H
...
class OAIDeleteDataProtectionPolicyRequest : public OAIObject {
public:
    OAIDeleteDataProtectionPolicyRequest();
    OAIDeleteDataProtectionPolicyRequest(QString json);
    ~OAIDeleteDataProtectionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDataProtectionPolicyRequest)

#endif // OAIDeleteDataProtectionPolicyRequest_H
