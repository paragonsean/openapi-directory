...
/*
 * OAIDisassociateKmsKeyRequest.h
 *
 * 
 */

#ifndef OAIDisassociateKmsKeyRequest_H
#define OAIDisassociateKmsKeyRequest_H
...
class OAIDisassociateKmsKeyRequest : public OAIObject {
public:
    OAIDisassociateKmsKeyRequest();
    OAIDisassociateKmsKeyRequest(QString json);
    ~OAIDisassociateKmsKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateKmsKeyRequest)

#endif // OAIDisassociateKmsKeyRequest_H
