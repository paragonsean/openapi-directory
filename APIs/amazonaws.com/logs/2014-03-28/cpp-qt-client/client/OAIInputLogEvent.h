...
#ifndef OAIInputLogEvent_H
#define OAIInputLogEvent_H
...
class OAIInputLogEvent : public OAIObject {
public:
    OAIInputLogEvent();
    OAIInputLogEvent(QString json);
    ~OAIInputLogEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputLogEvent)

#endif // OAIInputLogEvent_H
