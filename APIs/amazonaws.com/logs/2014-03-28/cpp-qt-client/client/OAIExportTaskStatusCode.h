...
/*
 * OAIExportTaskStatusCode.h
 *
 * 
 */

#ifndef OAIExportTaskStatusCode_H
#define OAIExportTaskStatusCode_H
...
class OAIExportTaskStatusCode : public OAIEnum {
public:
    OAIExportTaskStatusCode();
    OAIExportTaskStatusCode(QString json);
    ~OAIExportTaskStatusCode() override;
    ...
    enum class eOAIExportTaskStatusCode {
    ...
    OAIExportTaskStatusCode::eOAIExportTaskStatusCode getValue() const;
    void setValue(const OAIExportTaskStatusCode::eOAIExportTaskStatusCode& value);
...
private:
    ...
    eOAIExportTaskStatusCode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportTaskStatusCode)

#endif // OAIExportTaskStatusCode_H
