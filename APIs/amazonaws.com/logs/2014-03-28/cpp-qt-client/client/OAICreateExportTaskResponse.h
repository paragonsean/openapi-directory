...
/*
 * OAICreateExportTaskResponse.h
 *
 * 
 */

#ifndef OAICreateExportTaskResponse_H
#define OAICreateExportTaskResponse_H
...
class OAICreateExportTaskResponse : public OAIObject {
public:
    OAICreateExportTaskResponse();
    OAICreateExportTaskResponse(QString json);
    ~OAICreateExportTaskResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExportTaskResponse)

#endif // OAICreateExportTaskResponse_H
