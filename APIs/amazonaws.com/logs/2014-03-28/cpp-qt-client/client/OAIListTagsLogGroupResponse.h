...
/*
 * OAIListTagsLogGroupResponse.h
 *
 * Please use the generic tagging API model ListTagsForResourceRequest and ListTagsForResourceResponse
 */

#ifndef OAIListTagsLogGroupResponse_H
#define OAIListTagsLogGroupResponse_H
...
class OAIListTagsLogGroupResponse : public OAIObject {
public:
    OAIListTagsLogGroupResponse();
    OAIListTagsLogGroupResponse(QString json);
    ~OAIListTagsLogGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTagsLogGroupResponse)

#endif // OAIListTagsLogGroupResponse_H
