...
OAIDescribeLogGroupsResponse::OAIDescribeLogGroupsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeLogGroupsResponse::OAIDescribeLogGroupsResponse() {
    this->initializeModel();
}

OAIDescribeLogGroupsResponse::~OAIDescribeLogGroupsResponse() {}

void OAIDescribeLogGroupsResponse::initializeModel() {
...
void OAIDescribeLogGroupsResponse::fromJson(QString jsonString) {
...
void OAIDescribeLogGroupsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeLogGroupsResponse::asJson() const {
...
QJsonObject OAIDescribeLogGroupsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeLogGroupsResponse::getLogGroups() const {
    return m_log_groups;
}
void OAIDescribeLogGroupsResponse::setLogGroups(const QList &log_groups) {
    m_log_groups = log_groups;
    m_log_groups_isSet = true;
}

bool OAIDescribeLogGroupsResponse::is_log_groups_Set() const{
    return m_log_groups_isSet;
}

bool OAIDescribeLogGroupsResponse::is_log_groups_Valid() const{
    return m_log_groups_isValid;
}

QString OAIDescribeLogGroupsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeLogGroupsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeLogGroupsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeLogGroupsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeLogGroupsResponse::isSet() const {
...
bool OAIDescribeLogGroupsResponse::isValid() const {
