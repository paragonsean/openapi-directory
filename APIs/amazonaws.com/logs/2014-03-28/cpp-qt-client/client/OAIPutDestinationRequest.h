...
/*
 * OAIPutDestinationRequest.h
 *
 * 
 */

#ifndef OAIPutDestinationRequest_H
#define OAIPutDestinationRequest_H
...
class OAIPutDestinationRequest : public OAIObject {
public:
    OAIPutDestinationRequest();
    OAIPutDestinationRequest(QString json);
    ~OAIPutDestinationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDestinationRequest)

#endif // OAIPutDestinationRequest_H
