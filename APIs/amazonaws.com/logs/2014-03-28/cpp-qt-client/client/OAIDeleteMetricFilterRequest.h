...
/*
 * OAIDeleteMetricFilterRequest.h
 *
 * 
 */

#ifndef OAIDeleteMetricFilterRequest_H
#define OAIDeleteMetricFilterRequest_H
...
class OAIDeleteMetricFilterRequest : public OAIObject {
public:
    OAIDeleteMetricFilterRequest();
    OAIDeleteMetricFilterRequest(QString json);
    ~OAIDeleteMetricFilterRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMetricFilterRequest)

#endif // OAIDeleteMetricFilterRequest_H
