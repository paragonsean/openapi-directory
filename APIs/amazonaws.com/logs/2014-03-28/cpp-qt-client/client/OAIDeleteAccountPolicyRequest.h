...
/*
 * OAIDeleteAccountPolicyRequest.h
 *
 * 
 */

#ifndef OAIDeleteAccountPolicyRequest_H
#define OAIDeleteAccountPolicyRequest_H
...
class OAIDeleteAccountPolicyRequest : public OAIObject {
public:
    OAIDeleteAccountPolicyRequest();
    OAIDeleteAccountPolicyRequest(QString json);
    ~OAIDeleteAccountPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAccountPolicyRequest)

#endif // OAIDeleteAccountPolicyRequest_H
