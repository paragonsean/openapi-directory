...
/*
 * OAIGetLogRecordResponse.h
 *
 * 
 */

#ifndef OAIGetLogRecordResponse_H
#define OAIGetLogRecordResponse_H
...
class OAIGetLogRecordResponse : public OAIObject {
public:
    OAIGetLogRecordResponse();
    OAIGetLogRecordResponse(QString json);
    ~OAIGetLogRecordResponse() override;
    ...
    QMap getLogRecord() const;
    void setLogRecord(const QMap &log_record);
    bool is_log_record_Set() const;
    bool is_log_record_Valid() const;
...
private:
    ...
    QMap m_log_record;
    bool m_log_record_isSet;
    bool m_log_record_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetLogRecordResponse)

#endif // OAIGetLogRecordResponse_H
