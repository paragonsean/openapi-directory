...
/*
 * OAIDescribeMetricFiltersResponse.h
 *
 * 
 */

#ifndef OAIDescribeMetricFiltersResponse_H
#define OAIDescribeMetricFiltersResponse_H
...
class OAIDescribeMetricFiltersResponse : public OAIObject {
public:
    OAIDescribeMetricFiltersResponse();
    OAIDescribeMetricFiltersResponse(QString json);
    ~OAIDescribeMetricFiltersResponse() override;
    ...
    QList getMetricFilters() const;
    void setMetricFilters(const QList &metric_filters);
    bool is_metric_filters_Set() const;
    bool is_metric_filters_Valid() const;
...
private:
    ...
    QList m_metric_filters;
    bool m_metric_filters_isSet;
    bool m_metric_filters_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMetricFiltersResponse)

#endif // OAIDescribeMetricFiltersResponse_H
