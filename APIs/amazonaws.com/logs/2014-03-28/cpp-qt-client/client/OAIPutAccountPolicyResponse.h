...
/*
 * OAIPutAccountPolicyResponse.h
 *
 * 
 */

#ifndef OAIPutAccountPolicyResponse_H
#define OAIPutAccountPolicyResponse_H

#include <QJsonObject>

#include "OAIPutAccountPolicyResponse_accountPolicy.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutAccountPolicyResponse_accountPolicy;

class OAIPutAccountPolicyResponse : public OAIObject {
public:
    OAIPutAccountPolicyResponse();
    OAIPutAccountPolicyResponse(QString json);
    ~OAIPutAccountPolicyResponse() override;
    ...
    OAIPutAccountPolicyResponse_accountPolicy getAccountPolicy() const;
    void setAccountPolicy(const OAIPutAccountPolicyResponse_accountPolicy &account_policy);
    bool is_account_policy_Set() const;
    bool is_account_policy_Valid() const;
...
private:
    ...
    OAIPutAccountPolicyResponse_accountPolicy m_account_policy;
    bool m_account_policy_isSet;
    bool m_account_policy_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutAccountPolicyResponse)

#endif // OAIPutAccountPolicyResponse_H
