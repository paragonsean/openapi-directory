...
/*
 * OAIDescribeAccountPoliciesResponse.h
 *
 * 
 */

#ifndef OAIDescribeAccountPoliciesResponse_H
#define OAIDescribeAccountPoliciesResponse_H
...
class OAIDescribeAccountPoliciesResponse : public OAIObject {
public:
    OAIDescribeAccountPoliciesResponse();
    OAIDescribeAccountPoliciesResponse(QString json);
    ~OAIDescribeAccountPoliciesResponse() override;
    ...
    QList getAccountPolicies() const;
    void setAccountPolicies(const QList &account_policies);
    bool is_account_policies_Set() const;
    bool is_account_policies_Valid() const;
...
private:
    ...
    QList m_account_policies;
    bool m_account_policies_isSet;
    bool m_account_policies_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountPoliciesResponse)

#endif // OAIDescribeAccountPoliciesResponse_H
