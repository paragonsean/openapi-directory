...
OAIPutDestinationRequest::OAIPutDestinationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDestinationRequest::OAIPutDestinationRequest() {
    this->initializeModel();
}

OAIPutDestinationRequest::~OAIPutDestinationRequest() {}

void OAIPutDestinationRequest::initializeModel() {
...
void OAIPutDestinationRequest::fromJson(QString jsonString) {
...
void OAIPutDestinationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutDestinationRequest::asJson() const {
...
QJsonObject OAIPutDestinationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutDestinationRequest::getDestinationName() const {
    return m_destination_name;
}
void OAIPutDestinationRequest::setDestinationName(const QString &destination_name) {
    m_destination_name = destination_name;
    m_destination_name_isSet = true;
}

bool OAIPutDestinationRequest::is_destination_name_Set() const{
    return m_destination_name_isSet;
}

bool OAIPutDestinationRequest::is_destination_name_Valid() const{
    return m_destination_name_isValid;
}

QString OAIPutDestinationRequest::getTargetArn() const {
    return m_target_arn;
}
void OAIPutDestinationRequest::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIPutDestinationRequest::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIPutDestinationRequest::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QString OAIPutDestinationRequest::getRoleArn() const {
    return m_role_arn;
}
void OAIPutDestinationRequest::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIPutDestinationRequest::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIPutDestinationRequest::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QMap OAIPutDestinationRequest::getTags() const {
    return m_tags;
}
void OAIPutDestinationRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPutDestinationRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPutDestinationRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIPutDestinationRequest::isSet() const {
...
bool OAIPutDestinationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_destination_name_isValid && m_target_arn_isValid && m_role_arn_isValid && true;
}
