...
/*
 * OAITagLogGroupRequest.h
 *
 * Please use the generic tagging API model TagResourceRequest
 */

#ifndef OAITagLogGroupRequest_H
#define OAITagLogGroupRequest_H
...
class OAITagLogGroupRequest : public OAIObject {
public:
    OAITagLogGroupRequest();
    OAITagLogGroupRequest(QString json);
    ~OAITagLogGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagLogGroupRequest)

#endif // OAITagLogGroupRequest_H
