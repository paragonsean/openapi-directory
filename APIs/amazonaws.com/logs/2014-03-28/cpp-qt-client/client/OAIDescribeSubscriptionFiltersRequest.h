...
/*
 * OAIDescribeSubscriptionFiltersRequest.h
 *
 * 
 */

#ifndef OAIDescribeSubscriptionFiltersRequest_H
#define OAIDescribeSubscriptionFiltersRequest_H
...
class OAIDescribeSubscriptionFiltersRequest : public OAIObject {
public:
    OAIDescribeSubscriptionFiltersRequest();
    OAIDescribeSubscriptionFiltersRequest(QString json);
    ~OAIDescribeSubscriptionFiltersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSubscriptionFiltersRequest)

#endif // OAIDescribeSubscriptionFiltersRequest_H
