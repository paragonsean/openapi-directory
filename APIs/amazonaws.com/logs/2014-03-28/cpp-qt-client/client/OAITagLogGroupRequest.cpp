...
OAITagLogGroupRequest::OAITagLogGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagLogGroupRequest::OAITagLogGroupRequest() {
    this->initializeModel();
}

OAITagLogGroupRequest::~OAITagLogGroupRequest() {}

void OAITagLogGroupRequest::initializeModel() {
...
void OAITagLogGroupRequest::fromJson(QString jsonString) {
...
void OAITagLogGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAITagLogGroupRequest::asJson() const {
...
QJsonObject OAITagLogGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAITagLogGroupRequest::getLogGroupName() const {
    return m_log_group_name;
}
void OAITagLogGroupRequest::setLogGroupName(const QString &log_group_name) {
    m_log_group_name = log_group_name;
    m_log_group_name_isSet = true;
}

bool OAITagLogGroupRequest::is_log_group_name_Set() const{
    return m_log_group_name_isSet;
}

bool OAITagLogGroupRequest::is_log_group_name_Valid() const{
    return m_log_group_name_isValid;
}

QMap OAITagLogGroupRequest::getTags() const {
    return m_tags;
}
void OAITagLogGroupRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagLogGroupRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagLogGroupRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagLogGroupRequest::isSet() const {
...
bool OAITagLogGroupRequest::isValid() const {
