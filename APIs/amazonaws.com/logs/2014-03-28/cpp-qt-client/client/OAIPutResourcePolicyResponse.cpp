...
OAIPutResourcePolicyResponse_resourcePolicy OAIPutResourcePolicyResponse::getResourcePolicy() const {
    return m_resource_policy;
}
void OAIPutResourcePolicyResponse::setResourcePolicy(const OAIPutResourcePolicyResponse_resourcePolicy &resource_policy) {
