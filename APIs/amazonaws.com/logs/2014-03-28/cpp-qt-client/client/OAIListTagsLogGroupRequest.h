...
class OAIListTagsLogGroupRequest : public OAIObject {
public:
    OAIListTagsLogGroupRequest();
    OAIListTagsLogGroupRequest(QString json);
    ~OAIListTagsLogGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTagsLogGroupRequest)

#endif // OAIListTagsLogGroupRequest_H
