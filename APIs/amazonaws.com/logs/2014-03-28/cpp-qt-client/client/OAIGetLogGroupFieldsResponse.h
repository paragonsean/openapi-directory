...
/*
 * OAIGetLogGroupFieldsResponse.h
 *
 * 
 */

#ifndef OAIGetLogGroupFieldsResponse_H
#define OAIGetLogGroupFieldsResponse_H
...
class OAIGetLogGroupFieldsResponse : public OAIObject {
public:
    OAIGetLogGroupFieldsResponse();
    OAIGetLogGroupFieldsResponse(QString json);
    ~OAIGetLogGroupFieldsResponse() override;
    ...
    QList getLogGroupFields() const;
    void setLogGroupFields(const QList &log_group_fields);
    bool is_log_group_fields_Set() const;
    bool is_log_group_fields_Valid() const;
...
private:
    ...
    QList m_log_group_fields;
    bool m_log_group_fields_isSet;
    bool m_log_group_fields_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetLogGroupFieldsResponse)

#endif // OAIGetLogGroupFieldsResponse_H
