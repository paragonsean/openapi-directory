...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('describeDimensionKeys', function() {
      it('should call describeDimensionKeys successfully', function(done) {
        //uncomment below and update the code to test describeDimensionKeys
        //instance.describeDimensionKeys(function(error) {
    ...
    describe('getDimensionKeyDetails', function() {
      it('should call getDimensionKeyDetails successfully', function(done) {
        //uncomment below and update the code to test getDimensionKeyDetails
        //instance.getDimensionKeyDetails(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getResourceMetadata', function() {
      it('should call getResourceMetadata successfully', function(done) {
        //uncomment below and update the code to test getResourceMetadata
        //instance.getResourceMetadata(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getResourceMetrics', function() {
      it('should call getResourceMetrics successfully', function(done) {
        //uncomment below and update the code to test getResourceMetrics
        //instance.getResourceMetrics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listAvailableResourceDimensions', function() {
      it('should call listAvailableResourceDimensions successfully', function(done) {
        //uncomment below and update the code to test listAvailableResourceDimensions
        //instance.listAvailableResourceDimensions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listAvailableResourceMetrics', function() {
      it('should call listAvailableResourceMetrics successfully', function(done) {
        //uncomment below and update the code to test listAvailableResourceMetrics
        //instance.listAvailableResourceMetrics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
