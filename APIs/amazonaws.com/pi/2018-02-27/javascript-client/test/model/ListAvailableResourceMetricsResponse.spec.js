...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.ListAvailableResourceMetricsResponse();
  });
  ...
  describe('ListAvailableResourceMetricsResponse', function() {
    it('should create an instance of ListAvailableResourceMetricsResponse', function() {
      // uncomment below and update the code to test ListAvailableResourceMetricsResponse
      //var instance = new AwsPerformanceInsights.ListAvailableResourceMetricsResponse();
      //expect(instance).to.be.a(AwsPerformanceInsights.ListAvailableResourceMetricsResponse);
    });
