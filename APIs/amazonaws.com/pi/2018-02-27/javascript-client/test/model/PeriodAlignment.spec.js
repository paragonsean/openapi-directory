...
(function(root, factory) {
  ...
  describe('PeriodAlignment', function() {
    it('should create an instance of PeriodAlignment', function() {
      // uncomment below and update the code to test PeriodAlignment
      //var instance = new AwsPerformanceInsights.PeriodAlignment();
      //expect(instance).to.be.a(AwsPerformanceInsights.PeriodAlignment);
    });
