...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.MetricDimensionGroups();
  });
  ...
  describe('MetricDimensionGroups', function() {
    it('should create an instance of MetricDimensionGroups', function() {
      // uncomment below and update the code to test MetricDimensionGroups
      //var instance = new AwsPerformanceInsights.MetricDimensionGroups();
      //expect(instance).to.be.a(AwsPerformanceInsights.MetricDimensionGroups);
    });
