...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.ListAvailableResourceDimensionsResponse();
  });
  ...
  describe('ListAvailableResourceDimensionsResponse', function() {
    it('should create an instance of ListAvailableResourceDimensionsResponse', function() {
      // uncomment below and update the code to test ListAvailableResourceDimensionsResponse
      //var instance = new AwsPerformanceInsights.ListAvailableResourceDimensionsResponse();
      //expect(instance).to.be.a(AwsPerformanceInsights.ListAvailableResourceDimensionsResponse);
    });
