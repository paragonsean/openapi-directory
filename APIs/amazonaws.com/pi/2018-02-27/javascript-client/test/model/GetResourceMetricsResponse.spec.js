...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.GetResourceMetricsResponse();
  });
  ...
  describe('GetResourceMetricsResponse', function() {
    it('should create an instance of GetResourceMetricsResponse', function() {
      // uncomment below and update the code to test GetResourceMetricsResponse
      //var instance = new AwsPerformanceInsights.GetResourceMetricsResponse();
      //expect(instance).to.be.a(AwsPerformanceInsights.GetResourceMetricsResponse);
    });
