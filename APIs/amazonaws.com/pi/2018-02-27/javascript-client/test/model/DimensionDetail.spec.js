...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DimensionDetail();
  });
  ...
  describe('DimensionDetail', function() {
    it('should create an instance of DimensionDetail', function() {
      // uncomment below and update the code to test DimensionDetail
      //var instance = new AwsPerformanceInsights.DimensionDetail();
      //expect(instance).to.be.a(AwsPerformanceInsights.DimensionDetail);
    });
