...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.GetResourceMetadataResponse();
  });
  ...
  describe('GetResourceMetadataResponse', function() {
    it('should create an instance of GetResourceMetadataResponse', function() {
      // uncomment below and update the code to test GetResourceMetadataResponse
      //var instance = new AwsPerformanceInsights.GetResourceMetadataResponse();
      //expect(instance).to.be.a(AwsPerformanceInsights.GetResourceMetadataResponse);
    });
