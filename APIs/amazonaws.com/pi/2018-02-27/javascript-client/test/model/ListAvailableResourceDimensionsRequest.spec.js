...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.ListAvailableResourceDimensionsRequest();
  });
  ...
  describe('ListAvailableResourceDimensionsRequest', function() {
    it('should create an instance of ListAvailableResourceDimensionsRequest', function() {
      // uncomment below and update the code to test ListAvailableResourceDimensionsRequest
      //var instance = new AwsPerformanceInsights.ListAvailableResourceDimensionsRequest();
      //expect(instance).to.be.a(AwsPerformanceInsights.ListAvailableResourceDimensionsRequest);
    });
