...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.GetResourceMetadataRequest();
  });
  ...
  describe('GetResourceMetadataRequest', function() {
    it('should create an instance of GetResourceMetadataRequest', function() {
      // uncomment below and update the code to test GetResourceMetadataRequest
      //var instance = new AwsPerformanceInsights.GetResourceMetadataRequest();
      //expect(instance).to.be.a(AwsPerformanceInsights.GetResourceMetadataRequest);
    });
