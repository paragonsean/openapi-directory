...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.GetDimensionKeyDetailsResponse();
  });
  ...
  describe('GetDimensionKeyDetailsResponse', function() {
    it('should create an instance of GetDimensionKeyDetailsResponse', function() {
      // uncomment below and update the code to test GetDimensionKeyDetailsResponse
      //var instance = new AwsPerformanceInsights.GetDimensionKeyDetailsResponse();
      //expect(instance).to.be.a(AwsPerformanceInsights.GetDimensionKeyDetailsResponse);
    });
