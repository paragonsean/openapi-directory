...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.ResponsePartitionKey();
  });
  ...
  describe('ResponsePartitionKey', function() {
    it('should create an instance of ResponsePartitionKey', function() {
      // uncomment below and update the code to test ResponsePartitionKey
      //var instance = new AwsPerformanceInsights.ResponsePartitionKey();
      //expect(instance).to.be.a(AwsPerformanceInsights.ResponsePartitionKey);
    });
