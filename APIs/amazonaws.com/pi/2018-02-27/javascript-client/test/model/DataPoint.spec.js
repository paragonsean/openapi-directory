...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DataPoint();
  });
  ...
  describe('DataPoint', function() {
    it('should create an instance of DataPoint', function() {
      ...
      //var instance = new AwsPerformanceInsights.DataPoint();
      //expect(instance).to.be.a(AwsPerformanceInsights.DataPoint);
    });
