...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.ListAvailableResourceMetricsRequest();
  });
  ...
  describe('ListAvailableResourceMetricsRequest', function() {
    it('should create an instance of ListAvailableResourceMetricsRequest', function() {
      // uncomment below and update the code to test ListAvailableResourceMetricsRequest
      //var instance = new AwsPerformanceInsights.ListAvailableResourceMetricsRequest();
      //expect(instance).to.be.a(AwsPerformanceInsights.ListAvailableResourceMetricsRequest);
    });
    ...
    it('should have the property metricTypes (base name: "MetricTypes")', function() {
      // uncomment below and update the code to test the property metricTypes
      //var instance = new AwsPerformanceInsights.ListAvailableResourceMetricsRequest();
      //expect(instance).to.be();
    });
