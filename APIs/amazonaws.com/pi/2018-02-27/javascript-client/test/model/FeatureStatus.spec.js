...
(function(root, factory) {
  ...
  describe('FeatureStatus', function() {
    it('should create an instance of FeatureStatus', function() {
      // uncomment below and update the code to test FeatureStatus
      //var instance = new AwsPerformanceInsights.FeatureStatus();
      //expect(instance).to.be.a(AwsPerformanceInsights.FeatureStatus);
    });
