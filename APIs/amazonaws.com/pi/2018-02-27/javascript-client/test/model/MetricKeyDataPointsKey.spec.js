...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.MetricKeyDataPointsKey();
  });
  ...
  describe('MetricKeyDataPointsKey', function() {
    it('should create an instance of MetricKeyDataPointsKey', function() {
      // uncomment below and update the code to test MetricKeyDataPointsKey
      //var instance = new AwsPerformanceInsights.MetricKeyDataPointsKey();
      //expect(instance).to.be.a(AwsPerformanceInsights.MetricKeyDataPointsKey);
    });
