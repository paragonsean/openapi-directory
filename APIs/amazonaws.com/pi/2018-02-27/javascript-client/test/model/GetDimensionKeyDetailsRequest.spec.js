...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.GetDimensionKeyDetailsRequest();
  });
  ...
  describe('GetDimensionKeyDetailsRequest', function() {
    it('should create an instance of GetDimensionKeyDetailsRequest', function() {
      // uncomment below and update the code to test GetDimensionKeyDetailsRequest
      //var instance = new AwsPerformanceInsights.GetDimensionKeyDetailsRequest();
      //expect(instance).to.be.a(AwsPerformanceInsights.GetDimensionKeyDetailsRequest);
    });
    ...
    it('should have the property groupIdentifier (base name: "GroupIdentifier")', function() {
      // uncomment below and update the code to test the property groupIdentifier
      //var instance = new AwsPerformanceInsights.GetDimensionKeyDetailsRequest();
      //expect(instance).to.be();
    });

    it('should have the property requestedDimensions (base name: "RequestedDimensions")', function() {
      // uncomment below and update the code to test the property requestedDimensions
      //var instance = new AwsPerformanceInsights.GetDimensionKeyDetailsRequest();
      //expect(instance).to.be();
    });
