...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DescribeDimensionKeysRequestPartitionBy();
  });
  ...
  describe('DescribeDimensionKeysRequestPartitionBy', function() {
    it('should create an instance of DescribeDimensionKeysRequestPartitionBy', function() {
      // uncomment below and update the code to test DescribeDimensionKeysRequestPartitionBy
      //var instance = new AwsPerformanceInsights.DescribeDimensionKeysRequestPartitionBy();
      //expect(instance).to.be.a(AwsPerformanceInsights.DescribeDimensionKeysRequestPartitionBy);
    });
