...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DescribeDimensionKeysRequest();
  });
  ...
  describe('DescribeDimensionKeysRequest', function() {
    it('should create an instance of DescribeDimensionKeysRequest', function() {
      // uncomment below and update the code to test DescribeDimensionKeysRequest
      //var instance = new AwsPerformanceInsights.DescribeDimensionKeysRequest();
      //expect(instance).to.be.a(AwsPerformanceInsights.DescribeDimensionKeysRequest);
    });
    ...
    it('should have the property partitionBy (base name: "PartitionBy")', function() {
      // uncomment below and update the code to test the property partitionBy
      //var instance = new AwsPerformanceInsights.DescribeDimensionKeysRequest();
      //expect(instance).to.be();
    });
