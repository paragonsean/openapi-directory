...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.MetricQuery();
  });
  ...
  describe('MetricQuery', function() {
    it('should create an instance of MetricQuery', function() {
      // uncomment below and update the code to test MetricQuery
      //var instance = new AwsPerformanceInsights.MetricQuery();
      //expect(instance).to.be.a(AwsPerformanceInsights.MetricQuery);
    });
