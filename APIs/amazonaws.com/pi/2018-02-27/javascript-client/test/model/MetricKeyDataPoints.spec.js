...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.MetricKeyDataPoints();
  });
  ...
  describe('MetricKeyDataPoints', function() {
    it('should create an instance of MetricKeyDataPoints', function() {
      // uncomment below and update the code to test MetricKeyDataPoints
      //var instance = new AwsPerformanceInsights.MetricKeyDataPoints();
      //expect(instance).to.be.a(AwsPerformanceInsights.MetricKeyDataPoints);
    });
