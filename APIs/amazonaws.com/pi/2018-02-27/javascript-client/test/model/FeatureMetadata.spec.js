...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.FeatureMetadata();
  });
  ...
  describe('FeatureMetadata', function() {
    it('should create an instance of FeatureMetadata', function() {
      // uncomment below and update the code to test FeatureMetadata
      //var instance = new AwsPerformanceInsights.FeatureMetadata();
      //expect(instance).to.be.a(AwsPerformanceInsights.FeatureMetadata);
    });
