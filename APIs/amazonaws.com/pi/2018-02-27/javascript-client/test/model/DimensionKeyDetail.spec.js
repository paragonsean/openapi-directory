...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DimensionKeyDetail();
  });
  ...
  describe('DimensionKeyDetail', function() {
    it('should create an instance of DimensionKeyDetail', function() {
      // uncomment below and update the code to test DimensionKeyDetail
      //var instance = new AwsPerformanceInsights.DimensionKeyDetail();
      //expect(instance).to.be.a(AwsPerformanceInsights.DimensionKeyDetail);
    });
