...
(function(root, factory) {
  ...
  describe('DetailStatus', function() {
    it('should create an instance of DetailStatus', function() {
      // uncomment below and update the code to test DetailStatus
      //var instance = new AwsPerformanceInsights.DetailStatus();
      //expect(instance).to.be.a(AwsPerformanceInsights.DetailStatus);
    });
