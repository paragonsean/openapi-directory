...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DimensionGroupDetail();
  });
  ...
  describe('DimensionGroupDetail', function() {
    it('should create an instance of DimensionGroupDetail', function() {
      // uncomment below and update the code to test DimensionGroupDetail
      //var instance = new AwsPerformanceInsights.DimensionGroupDetail();
      //expect(instance).to.be.a(AwsPerformanceInsights.DimensionGroupDetail);
    });
