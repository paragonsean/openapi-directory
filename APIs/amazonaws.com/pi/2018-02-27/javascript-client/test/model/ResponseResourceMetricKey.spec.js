...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.ResponseResourceMetricKey();
  });
  ...
  describe('ResponseResourceMetricKey', function() {
    it('should create an instance of ResponseResourceMetricKey', function() {
      // uncomment below and update the code to test ResponseResourceMetricKey
      //var instance = new AwsPerformanceInsights.ResponseResourceMetricKey();
      //expect(instance).to.be.a(AwsPerformanceInsights.ResponseResourceMetricKey);
    });
