...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.DimensionGroup();
  });
  ...
  describe('DimensionGroup', function() {
    it('should create an instance of DimensionGroup', function() {
      ...
      //var instance = new AwsPerformanceInsights.DimensionGroup();
      //expect(instance).to.be.a(AwsPerformanceInsights.DimensionGroup);
    });
