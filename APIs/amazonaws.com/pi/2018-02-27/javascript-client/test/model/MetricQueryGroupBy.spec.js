...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPerformanceInsights.MetricQueryGroupBy();
  });
  ...
  describe('MetricQueryGroupBy', function() {
    it('should create an instance of MetricQueryGroupBy', function() {
      // uncomment below and update the code to test MetricQueryGroupBy
      //var instance = new AwsPerformanceInsights.MetricQueryGroupBy();
      //expect(instance).to.be.a(AwsPerformanceInsights.MetricQueryGroupBy);
    });
