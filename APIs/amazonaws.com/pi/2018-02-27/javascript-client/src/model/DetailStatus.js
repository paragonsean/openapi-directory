...
* @readonly
*/
export default class DetailStatus {
    ...
    /**
    * Returns a <code>DetailStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DetailStatus} The enum <code>DetailStatus</code> value.
    */
