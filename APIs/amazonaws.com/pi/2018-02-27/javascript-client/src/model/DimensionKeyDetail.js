...
/**
 * The DimensionKeyDetail model module.
 * @module model/DimensionKeyDetail
 * @version 2018-02-27
 */
class DimensionKeyDetail {
    /**
     * Constructs a new <code>DimensionKeyDetail</code>.
     * An object that describes the details for a specified dimension.
     * @alias module:model/DimensionKeyDetail
     */
    constructor() { 
        
        DimensionKeyDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DimensionKeyDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DimensionKeyDetail} obj Optional instance to populate.
     * @return {module:model/DimensionKeyDetail} The populated <code>DimensionKeyDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DimensionKeyDetail();
            ...
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], DetailStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DimensionKeyDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DimensionKeyDetail</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Status']) { // data not null
          DetailStatus.validateJSON(data['Status']);
        }
 ...
 * @member {String} Value
 */
DimensionKeyDetail.prototype['Value'] = undefined;

/**
 * @member {String} Dimension
 */
DimensionKeyDetail.prototype['Dimension'] = undefined;

/**
 * @member {module:model/DetailStatus} Status
 */
DimensionKeyDetail.prototype['Status'] = undefined;
...
export default DimensionKeyDetail;
