...
/**
 * The GetDimensionKeyDetailsResponse model module.
 * @module model/GetDimensionKeyDetailsResponse
 * @version 2018-02-27
 */
class GetDimensionKeyDetailsResponse {
    /**
     * Constructs a new <code>GetDimensionKeyDetailsResponse</code>.
     * @alias module:model/GetDimensionKeyDetailsResponse
     */
    constructor() { 
        
        GetDimensionKeyDetailsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDimensionKeyDetailsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDimensionKeyDetailsResponse} obj Optional instance to populate.
     * @return {module:model/GetDimensionKeyDetailsResponse} The populated <code>GetDimensionKeyDetailsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDimensionKeyDetailsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDimensionKeyDetailsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDimensionKeyDetailsResponse</code>.
     */
 ...
 */
GetDimensionKeyDetailsResponse.prototype['Dimensions'] = undefined;
...
export default GetDimensionKeyDetailsResponse;
