...
/**
 * The ListAvailableResourceMetricsResponse model module.
 * @module model/ListAvailableResourceMetricsResponse
 * @version 2018-02-27
 */
class ListAvailableResourceMetricsResponse {
    /**
     * Constructs a new <code>ListAvailableResourceMetricsResponse</code>.
     * @alias module:model/ListAvailableResourceMetricsResponse
     */
    constructor() { 
        
        ListAvailableResourceMetricsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAvailableResourceMetricsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAvailableResourceMetricsResponse} obj Optional instance to populate.
     * @return {module:model/ListAvailableResourceMetricsResponse} The populated <code>ListAvailableResourceMetricsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAvailableResourceMetricsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAvailableResourceMetricsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAvailableResourceMetricsResponse</code>.
     */
 ...
 */
ListAvailableResourceMetricsResponse.prototype['Metrics'] = undefined;

/**
 * @member {String} NextToken
 */
ListAvailableResourceMetricsResponse.prototype['NextToken'] = undefined;
...
export default ListAvailableResourceMetricsResponse;
