...
/**
 * The DescribeDimensionKeysRequestGroupBy model module.
 * @module model/DescribeDimensionKeysRequestGroupBy
 * @version 2018-02-27
 */
class DescribeDimensionKeysRequestGroupBy {
    /**
     * Constructs a new <code>DescribeDimensionKeysRequestGroupBy</code>.
     * @alias module:model/DescribeDimensionKeysRequestGroupBy
     * @implements module:model/DimensionGroup
     * @param group {String} 
     */
    constructor(group) { 
        DimensionGroup.initialize(this, group);
        DescribeDimensionKeysRequestGroupBy.initialize(this, group);
    }
    ...
    /**
     * Constructs a <code>DescribeDimensionKeysRequestGroupBy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeDimensionKeysRequestGroupBy} obj Optional instance to populate.
     * @return {module:model/DescribeDimensionKeysRequestGroupBy} The populated <code>DescribeDimensionKeysRequestGroupBy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeDimensionKeysRequestGroupBy();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeDimensionKeysRequestGroupBy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeDimensionKeysRequestGroupBy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeDimensionKeysRequestGroupBy.RequiredProperties) {
...
DescribeDimensionKeysRequestGroupBy.RequiredProperties = ["Group"];

/**
 * @member {String} Group
 */
DescribeDimensionKeysRequestGroupBy.prototype['Group'] = undefined;

/**
 * @member {Array} Dimensions
 */
DescribeDimensionKeysRequestGroupBy.prototype['Dimensions'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeDimensionKeysRequestGroupBy.prototype['Limit'] = undefined;
...
export default DescribeDimensionKeysRequestGroupBy;
