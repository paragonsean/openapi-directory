...
* @readonly
*/
export default class PeriodAlignment {
    ...
    /**
    * Returns a <code>PeriodAlignment</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PeriodAlignment} The enum <code>PeriodAlignment</code> value.
    */
