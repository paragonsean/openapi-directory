...
/**
 * The ListAvailableResourceDimensionsRequest model module.
 * @module model/ListAvailableResourceDimensionsRequest
 * @version 2018-02-27
 */
class ListAvailableResourceDimensionsRequest {
    /**
     * Constructs a new <code>ListAvailableResourceDimensionsRequest</code>.
     * @alias module:model/ListAvailableResourceDimensionsRequest
     * @param serviceType {module:model/ServiceType} 
     * @param identifier {String} 
     * @param metrics {Array} 
     */
    constructor(serviceType, identifier, metrics) { 
        
        ListAvailableResourceDimensionsRequest.initialize(this, serviceType, identifier, metrics);
    }
     ...
     */
    static initialize(obj, serviceType, identifier, metrics) { 
    ...
    /**
     * Constructs a <code>ListAvailableResourceDimensionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAvailableResourceDimensionsRequest} obj Optional instance to populate.
     * @return {module:model/ListAvailableResourceDimensionsRequest} The populated <code>ListAvailableResourceDimensionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAvailableResourceDimensionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAvailableResourceDimensionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAvailableResourceDimensionsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAvailableResourceDimensionsRequest.RequiredProperties) {
...
ListAvailableResourceDimensionsRequest.RequiredProperties = ["ServiceType", "Identifier", "Metrics"];

/**
 * @member {module:model/ServiceType} ServiceType
 */
ListAvailableResourceDimensionsRequest.prototype['ServiceType'] = undefined;

/**
 * @member {String} Identifier
 */
ListAvailableResourceDimensionsRequest.prototype['Identifier'] = undefined;

/**
 * @member {Array} Metrics
 */
ListAvailableResourceDimensionsRequest.prototype['Metrics'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListAvailableResourceDimensionsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListAvailableResourceDimensionsRequest.prototype['NextToken'] = undefined;
...
export default ListAvailableResourceDimensionsRequest;
