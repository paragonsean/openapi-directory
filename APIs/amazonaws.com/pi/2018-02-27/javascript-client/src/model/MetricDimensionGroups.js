...
/**
 * The MetricDimensionGroups model module.
 * @module model/MetricDimensionGroups
 * @version 2018-02-27
 */
class MetricDimensionGroups {
    /**
     * Constructs a new <code>MetricDimensionGroups</code>.
     * The available dimension information for a metric type.
     * @alias module:model/MetricDimensionGroups
     */
    constructor() { 
        
        MetricDimensionGroups.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MetricDimensionGroups</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetricDimensionGroups} obj Optional instance to populate.
     * @return {module:model/MetricDimensionGroups} The populated <code>MetricDimensionGroups</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetricDimensionGroups();
    ...
    /**
     * Validates the JSON data with respect to <code>MetricDimensionGroups</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetricDimensionGroups</code>.
     */
 ...
 */
MetricDimensionGroups.prototype['Metric'] = undefined;

/**
 * @member {Array} Groups
 */
MetricDimensionGroups.prototype['Groups'] = undefined;
...
export default MetricDimensionGroups;
