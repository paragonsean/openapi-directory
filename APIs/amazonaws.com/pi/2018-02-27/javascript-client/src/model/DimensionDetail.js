...
/**
 * The DimensionDetail model module.
 * @module model/DimensionDetail
 * @version 2018-02-27
 */
class DimensionDetail {
    /**
     * Constructs a new <code>DimensionDetail</code>.
     * The information about a dimension.
     * @alias module:model/DimensionDetail
     */
    constructor() { 
        
        DimensionDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DimensionDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DimensionDetail} obj Optional instance to populate.
     * @return {module:model/DimensionDetail} The populated <code>DimensionDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DimensionDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>DimensionDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DimensionDetail</code>.
     */
 ...
 */
DimensionDetail.prototype['Identifier'] = undefined;
