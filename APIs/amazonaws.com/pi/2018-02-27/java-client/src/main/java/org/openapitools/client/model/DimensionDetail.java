...
public class DimensionDetail {
  ...
  public DimensionDetail identifier(String identifier) {
  ...
  public boolean equals(Object o) {
    ...
    DimensionDetail dimensionDetail = (DimensionDetail) o;
    return Objects.equals(this.identifier, dimensionDetail.identifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class DimensionDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DimensionDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DimensionDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DimensionDetail is not found in the empty JSON string", DimensionDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DimensionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DimensionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DimensionDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DimensionDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DimensionDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DimensionDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<DimensionDetail>() {
           @Override
           public void write(JsonWriter out, DimensionDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DimensionDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DimensionDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DimensionDetail
   * @throws IOException if the JSON string is invalid with respect to DimensionDetail
   */
  public static DimensionDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DimensionDetail.class);
  }

  /**
   * Convert an instance of DimensionDetail to an JSON string
   *
   * @return JSON string
   */
