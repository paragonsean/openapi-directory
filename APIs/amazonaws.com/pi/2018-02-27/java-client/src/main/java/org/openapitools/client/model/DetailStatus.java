 ...
 */
@JsonAdapter(DetailStatus.Adapter.class)
public enum DetailStatus {
  ...
  public static DetailStatus fromValue(String value) {
    for (DetailStatus b : DetailStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<DetailStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final DetailStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DetailStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DetailStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DetailStatus.fromValue(value);
  }
}
