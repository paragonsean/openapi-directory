...
/**
 * Gets or Sets PeriodAlignment
 */
@JsonAdapter(PeriodAlignment.Adapter.class)
public enum PeriodAlignment {
  ...
  public static PeriodAlignment fromValue(String value) {
    for (PeriodAlignment b : PeriodAlignment.values()) {
  ...
  public static class Adapter extends TypeAdapter<PeriodAlignment> {
    @Override
    public void write(final JsonWriter jsonWriter, final PeriodAlignment enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PeriodAlignment read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PeriodAlignment.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PeriodAlignment.fromValue(value);
  }
}
