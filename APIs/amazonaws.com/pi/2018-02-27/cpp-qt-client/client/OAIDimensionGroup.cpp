...
QString OAIDimensionGroup::getGroup() const {
    return m_group;
}
void OAIDimensionGroup::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIDimensionGroup::is_group_Set() const{
    return m_group_isSet;
}

bool OAIDimensionGroup::is_group_Valid() const{
    return m_group_isValid;
}

QList OAIDimensionGroup::getDimensions() const {
    return m_dimensions;
}
void OAIDimensionGroup::setDimensions(const QList &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIDimensionGroup::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIDimensionGroup::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

qint32 OAIDimensionGroup::getLimit() const {
    return m_limit;
}
void OAIDimensionGroup::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDimensionGroup::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDimensionGroup::is_limit_Valid() const{
