...
/*
 * OAIGetResourceMetricsResponse.h
 *
 * 
 */

#ifndef OAIGetResourceMetricsResponse_H
#define OAIGetResourceMetricsResponse_H
...
class OAIGetResourceMetricsResponse : public OAIObject {
public:
    OAIGetResourceMetricsResponse();
    OAIGetResourceMetricsResponse(QString json);
    ~OAIGetResourceMetricsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourceMetricsResponse)

#endif // OAIGetResourceMetricsResponse_H
