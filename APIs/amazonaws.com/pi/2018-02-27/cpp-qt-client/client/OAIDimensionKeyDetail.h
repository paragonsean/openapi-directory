...
/*
 * OAIDimensionKeyDetail.h
 *
 * An object that describes the details for a specified dimension.
 */

#ifndef OAIDimensionKeyDetail_H
#define OAIDimensionKeyDetail_H
...
class OAIDimensionKeyDetail : public OAIObject {
public:
    OAIDimensionKeyDetail();
    OAIDimensionKeyDetail(QString json);
    ~OAIDimensionKeyDetail() override;
    ...
    OAIDetailStatus getStatus() const;
    void setStatus(const OAIDetailStatus &status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDimensionKeyDetail)

#endif // OAIDimensionKeyDetail_H
