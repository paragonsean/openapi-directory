...
/*
 * OAIDescribeDimensionKeysRequest_PartitionBy.h
 *
 * 
 */

#ifndef OAIDescribeDimensionKeysRequest_PartitionBy_H
#define OAIDescribeDimensionKeysRequest_PartitionBy_H
...
class OAIDescribeDimensionKeysRequest_PartitionBy : public OAIObject {
public:
    OAIDescribeDimensionKeysRequest_PartitionBy();
    OAIDescribeDimensionKeysRequest_PartitionBy(QString json);
    ~OAIDescribeDimensionKeysRequest_PartitionBy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDimensionKeysRequest_PartitionBy)

#endif // OAIDescribeDimensionKeysRequest_PartitionBy_H
