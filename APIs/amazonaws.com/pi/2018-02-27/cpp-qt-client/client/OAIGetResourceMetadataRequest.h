...
/*
 * OAIGetResourceMetadataRequest.h
 *
 * 
 */

#ifndef OAIGetResourceMetadataRequest_H
#define OAIGetResourceMetadataRequest_H
...
class OAIGetResourceMetadataRequest : public OAIObject {
public:
    OAIGetResourceMetadataRequest();
    OAIGetResourceMetadataRequest(QString json);
    ~OAIGetResourceMetadataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourceMetadataRequest)

#endif // OAIGetResourceMetadataRequest_H
