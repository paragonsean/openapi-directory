...
/*
 * OAIMetricDimensionGroups.h
 *
 * The available dimension information for a metric type.
 */

#ifndef OAIMetricDimensionGroups_H
#define OAIMetricDimensionGroups_H
...
class OAIMetricDimensionGroups : public OAIObject {
public:
    OAIMetricDimensionGroups();
    OAIMetricDimensionGroups(QString json);
    ~OAIMetricDimensionGroups() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricDimensionGroups)

#endif // OAIMetricDimensionGroups_H
