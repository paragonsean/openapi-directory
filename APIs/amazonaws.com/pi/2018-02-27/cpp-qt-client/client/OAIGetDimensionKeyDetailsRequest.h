...
/*
 * OAIGetDimensionKeyDetailsRequest.h
 *
 * 
 */

#ifndef OAIGetDimensionKeyDetailsRequest_H
#define OAIGetDimensionKeyDetailsRequest_H
...
class OAIGetDimensionKeyDetailsRequest : public OAIObject {
public:
    OAIGetDimensionKeyDetailsRequest();
    OAIGetDimensionKeyDetailsRequest(QString json);
    ~OAIGetDimensionKeyDetailsRequest() override;
    ...
    QString getGroupIdentifier() const;
    void setGroupIdentifier(const QString &group_identifier);
    bool is_group_identifier_Set() const;
    bool is_group_identifier_Valid() const;

    QList getRequestedDimensions() const;
    void setRequestedDimensions(const QList &requested_dimensions);
    bool is_requested_dimensions_Set() const;
    bool is_requested_dimensions_Valid() const;
...
private:
    ...
    QString m_group_identifier;
    bool m_group_identifier_isSet;
    bool m_group_identifier_isValid;

    QList m_requested_dimensions;
    bool m_requested_dimensions_isSet;
    bool m_requested_dimensions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDimensionKeyDetailsRequest)

#endif // OAIGetDimensionKeyDetailsRequest_H
