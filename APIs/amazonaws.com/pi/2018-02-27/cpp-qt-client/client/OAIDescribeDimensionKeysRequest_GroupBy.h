...
/*
 * OAIDescribeDimensionKeysRequest_GroupBy.h
 *
 * 
 */

#ifndef OAIDescribeDimensionKeysRequest_GroupBy_H
#define OAIDescribeDimensionKeysRequest_GroupBy_H
...
class OAIDescribeDimensionKeysRequest_GroupBy : public OAIObject {
public:
    OAIDescribeDimensionKeysRequest_GroupBy();
    OAIDescribeDimensionKeysRequest_GroupBy(QString json);
    ~OAIDescribeDimensionKeysRequest_GroupBy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDimensionKeysRequest_GroupBy)

#endif // OAIDescribeDimensionKeysRequest_GroupBy_H
