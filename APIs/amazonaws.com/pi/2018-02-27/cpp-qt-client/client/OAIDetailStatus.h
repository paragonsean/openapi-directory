...
#ifndef OAIDetailStatus_H
#define OAIDetailStatus_H
...
class OAIDetailStatus : public OAIEnum {
public:
    OAIDetailStatus();
    OAIDetailStatus(QString json);
    ~OAIDetailStatus() override;
    ...
    enum class eOAIDetailStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AVAILABLE, 
        PROCESSING, 
        UNAVAILABLE
    };
    OAIDetailStatus::eOAIDetailStatus getValue() const;
    void setValue(const OAIDetailStatus::eOAIDetailStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetailStatus)

#endif // OAIDetailStatus_H
