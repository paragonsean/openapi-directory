...
/*
 * OAIMetricQuery_GroupBy.h
 *
 * 
 */

#ifndef OAIMetricQuery_GroupBy_H
#define OAIMetricQuery_GroupBy_H
...
class OAIMetricQuery_GroupBy : public OAIObject {
public:
    OAIMetricQuery_GroupBy();
    OAIMetricQuery_GroupBy(QString json);
    ~OAIMetricQuery_GroupBy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricQuery_GroupBy)

#endif // OAIMetricQuery_GroupBy_H
