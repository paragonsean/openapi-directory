...
#ifndef OAIResponsePartitionKey_H
#define OAIResponsePartitionKey_H
...
class OAIResponsePartitionKey : public OAIObject {
public:
    OAIResponsePartitionKey();
    OAIResponsePartitionKey(QString json);
    ~OAIResponsePartitionKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponsePartitionKey)

#endif // OAIResponsePartitionKey_H
