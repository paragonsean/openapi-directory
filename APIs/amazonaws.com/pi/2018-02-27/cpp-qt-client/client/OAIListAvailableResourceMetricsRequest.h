...
/*
 * OAIListAvailableResourceMetricsRequest.h
 *
 * 
 */

#ifndef OAIListAvailableResourceMetricsRequest_H
#define OAIListAvailableResourceMetricsRequest_H
...
class OAIListAvailableResourceMetricsRequest : public OAIObject {
public:
    OAIListAvailableResourceMetricsRequest();
    OAIListAvailableResourceMetricsRequest(QString json);
    ~OAIListAvailableResourceMetricsRequest() override;
    ...
    QList getMetricTypes() const;
    void setMetricTypes(const QList &metric_types);
    bool is_metric_types_Set() const;
    bool is_metric_types_Valid() const;
...
private:
    ...
    QList m_metric_types;
    bool m_metric_types_isSet;
    bool m_metric_types_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAvailableResourceMetricsRequest)

#endif // OAIListAvailableResourceMetricsRequest_H
