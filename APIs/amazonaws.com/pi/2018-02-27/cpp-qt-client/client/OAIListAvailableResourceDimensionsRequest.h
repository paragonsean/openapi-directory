...
/*
 * OAIListAvailableResourceDimensionsRequest.h
 *
 * 
 */

#ifndef OAIListAvailableResourceDimensionsRequest_H
#define OAIListAvailableResourceDimensionsRequest_H
...
class OAIListAvailableResourceDimensionsRequest : public OAIObject {
public:
    OAIListAvailableResourceDimensionsRequest();
    OAIListAvailableResourceDimensionsRequest(QString json);
    ~OAIListAvailableResourceDimensionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAvailableResourceDimensionsRequest)

#endif // OAIListAvailableResourceDimensionsRequest_H
