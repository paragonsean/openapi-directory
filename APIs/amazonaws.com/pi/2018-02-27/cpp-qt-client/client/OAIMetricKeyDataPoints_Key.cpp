...
OAIMetricKeyDataPoints_Key::OAIMetricKeyDataPoints_Key(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMetricKeyDataPoints_Key::OAIMetricKeyDataPoints_Key() {
    this->initializeModel();
}

OAIMetricKeyDataPoints_Key::~OAIMetricKeyDataPoints_Key() {}

void OAIMetricKeyDataPoints_Key::initializeModel() {
...
void OAIMetricKeyDataPoints_Key::fromJson(QString jsonString) {
...
void OAIMetricKeyDataPoints_Key::fromJsonObject(QJsonObject json) {
...
QString OAIMetricKeyDataPoints_Key::asJson() const {
...
QJsonObject OAIMetricKeyDataPoints_Key::asJsonObject() const {
    QJsonObject obj;
    if (m_metric_isSet) {
...
QString OAIMetricKeyDataPoints_Key::getMetric() const {
    return m_metric;
}
void OAIMetricKeyDataPoints_Key::setMetric(const QString &metric) {
    m_metric = metric;
    m_metric_isSet = true;
}

bool OAIMetricKeyDataPoints_Key::is_metric_Set() const{
    return m_metric_isSet;
}

bool OAIMetricKeyDataPoints_Key::is_metric_Valid() const{
    return m_metric_isValid;
}

QMap OAIMetricKeyDataPoints_Key::getDimensions() const {
    return m_dimensions;
}
void OAIMetricKeyDataPoints_Key::setDimensions(const QMap &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIMetricKeyDataPoints_Key::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIMetricKeyDataPoints_Key::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

bool OAIMetricKeyDataPoints_Key::isSet() const {
...
bool OAIMetricKeyDataPoints_Key::isValid() const {
