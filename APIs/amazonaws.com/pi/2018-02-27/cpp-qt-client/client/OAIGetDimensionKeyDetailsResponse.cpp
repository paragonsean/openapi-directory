...
OAIGetDimensionKeyDetailsResponse::OAIGetDimensionKeyDetailsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDimensionKeyDetailsResponse::OAIGetDimensionKeyDetailsResponse() {
    this->initializeModel();
}

OAIGetDimensionKeyDetailsResponse::~OAIGetDimensionKeyDetailsResponse() {}

void OAIGetDimensionKeyDetailsResponse::initializeModel() {

    m_dimensions_isSet = false;
    m_dimensions_isValid = false;
}

void OAIGetDimensionKeyDetailsResponse::fromJson(QString jsonString) {
...
void OAIGetDimensionKeyDetailsResponse::fromJsonObject(QJsonObject json) {

    m_dimensions_isValid = ::OpenAPI::fromJsonValue(m_dimensions, json[QString("Dimensions")]);
    m_dimensions_isSet = !json[QString("Dimensions")].isNull() && m_dimensions_isValid;
}

QString OAIGetDimensionKeyDetailsResponse::asJson() const {
...
QJsonObject OAIGetDimensionKeyDetailsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIGetDimensionKeyDetailsResponse::getDimensions() const {
    return m_dimensions;
}
void OAIGetDimensionKeyDetailsResponse::setDimensions(const QList &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIGetDimensionKeyDetailsResponse::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIGetDimensionKeyDetailsResponse::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

bool OAIGetDimensionKeyDetailsResponse::isSet() const {
...
bool OAIGetDimensionKeyDetailsResponse::isValid() const {
