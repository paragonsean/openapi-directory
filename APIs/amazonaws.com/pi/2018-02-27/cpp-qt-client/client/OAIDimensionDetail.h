...
/*
 * OAIDimensionDetail.h
 *
 * The information about a dimension.
 */

#ifndef OAIDimensionDetail_H
#define OAIDimensionDetail_H
...
class OAIDimensionDetail : public OAIObject {
public:
    OAIDimensionDetail();
    OAIDimensionDetail(QString json);
    ~OAIDimensionDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDimensionDetail)

#endif // OAIDimensionDetail_H
