...
/*
 * OAIResponseResourceMetricKey.h
 *
 * An object describing a Performance Insights metric and one or more dimensions for that metric.
 */

#ifndef OAIResponseResourceMetricKey_H
#define OAIResponseResourceMetricKey_H
...
class OAIResponseResourceMetricKey : public OAIObject {
public:
    OAIResponseResourceMetricKey();
    OAIResponseResourceMetricKey(QString json);
    ~OAIResponseResourceMetricKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseResourceMetricKey)

#endif // OAIResponseResourceMetricKey_H
