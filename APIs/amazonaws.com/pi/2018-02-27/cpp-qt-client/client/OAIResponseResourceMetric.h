...
/*
 * OAIResponseResourceMetric.h
 *
 * An object that contains the full name, description, and unit of a metric. 
 */

#ifndef OAIResponseResourceMetric_H
#define OAIResponseResourceMetric_H
...
class OAIResponseResourceMetric : public OAIObject {
public:
    OAIResponseResourceMetric();
    OAIResponseResourceMetric(QString json);
    ~OAIResponseResourceMetric() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseResourceMetric)

#endif // OAIResponseResourceMetric_H
