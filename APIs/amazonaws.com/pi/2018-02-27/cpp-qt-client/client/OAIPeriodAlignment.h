...
/*
 * OAIPeriodAlignment.h
 *
 * 
 */

#ifndef OAIPeriodAlignment_H
#define OAIPeriodAlignment_H
...
class OAIPeriodAlignment : public OAIEnum {
public:
    OAIPeriodAlignment();
    OAIPeriodAlignment(QString json);
    ~OAIPeriodAlignment() override;
    ...
    enum class eOAIPeriodAlignment {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        END_TIME, 
        START_TIME
    };
    OAIPeriodAlignment::eOAIPeriodAlignment getValue() const;
    void setValue(const OAIPeriodAlignment::eOAIPeriodAlignment& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPeriodAlignment)

#endif // OAIPeriodAlignment_H
