...
/*
 * OAIGetResourceMetadataResponse.h
 *
 * 
 */

#ifndef OAIGetResourceMetadataResponse_H
#define OAIGetResourceMetadataResponse_H
...
class OAIGetResourceMetadataResponse : public OAIObject {
public:
    OAIGetResourceMetadataResponse();
    OAIGetResourceMetadataResponse(QString json);
    ~OAIGetResourceMetadataResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourceMetadataResponse)

#endif // OAIGetResourceMetadataResponse_H
