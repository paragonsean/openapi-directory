...
/*
 * OAIListAvailableResourceDimensionsResponse.h
 *
 * 
 */

#ifndef OAIListAvailableResourceDimensionsResponse_H
#define OAIListAvailableResourceDimensionsResponse_H
...
class OAIListAvailableResourceDimensionsResponse : public OAIObject {
public:
    OAIListAvailableResourceDimensionsResponse();
    OAIListAvailableResourceDimensionsResponse(QString json);
    ~OAIListAvailableResourceDimensionsResponse() override;
    ...
    QList getMetricDimensions() const;
    void setMetricDimensions(const QList &metric_dimensions);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAvailableResourceDimensionsResponse)

#endif // OAIListAvailableResourceDimensionsResponse_H
