# AmazonAppIntegrationsService.CreateDataIntegrationRequest
...
**objectConfiguration** | **{String: Object}** | The configuration for what data should be pulled from the source. | [optional] 
