...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.CreateDataIntegrationRequestFileConfiguration();
  });
  ...
  describe('CreateDataIntegrationRequestFileConfiguration', function() {
    it('should create an instance of CreateDataIntegrationRequestFileConfiguration', function() {
      // uncomment below and update the code to test CreateDataIntegrationRequestFileConfiguration
      //var instance = new AmazonAppIntegrationsService.CreateDataIntegrationRequestFileConfiguration();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.CreateDataIntegrationRequestFileConfiguration);
    });
