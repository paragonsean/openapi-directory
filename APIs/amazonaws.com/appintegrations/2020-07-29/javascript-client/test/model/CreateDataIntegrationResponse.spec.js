...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.CreateDataIntegrationResponse();
  });
  ...
  describe('CreateDataIntegrationResponse', function() {
    it('should create an instance of CreateDataIntegrationResponse', function() {
      // uncomment below and update the code to test CreateDataIntegrationResponse
      //var instance = new AmazonAppIntegrationsService.CreateDataIntegrationResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.CreateDataIntegrationResponse);
    });
