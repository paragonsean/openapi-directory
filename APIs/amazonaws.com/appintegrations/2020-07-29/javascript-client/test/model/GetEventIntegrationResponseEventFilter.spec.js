...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.GetEventIntegrationResponseEventFilter();
  });
  ...
  describe('GetEventIntegrationResponseEventFilter', function() {
    it('should create an instance of GetEventIntegrationResponseEventFilter', function() {
      // uncomment below and update the code to test GetEventIntegrationResponseEventFilter
      //var instance = new AmazonAppIntegrationsService.GetEventIntegrationResponseEventFilter();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.GetEventIntegrationResponseEventFilter);
    });
