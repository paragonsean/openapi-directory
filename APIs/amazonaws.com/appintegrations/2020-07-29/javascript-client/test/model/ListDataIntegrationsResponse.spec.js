...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.ListDataIntegrationsResponse();
  });
  ...
  describe('ListDataIntegrationsResponse', function() {
    it('should create an instance of ListDataIntegrationsResponse', function() {
      // uncomment below and update the code to test ListDataIntegrationsResponse
      //var instance = new AmazonAppIntegrationsService.ListDataIntegrationsResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.ListDataIntegrationsResponse);
    });

    it('should have the property dataIntegrations (base name: "DataIntegrations")', function() {
      // uncomment below and update the code to test the property dataIntegrations
      //var instance = new AmazonAppIntegrationsService.ListDataIntegrationsResponse();
