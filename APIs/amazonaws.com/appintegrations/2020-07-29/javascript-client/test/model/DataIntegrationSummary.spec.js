...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.DataIntegrationSummary();
  });
  ...
  describe('DataIntegrationSummary', function() {
    it('should create an instance of DataIntegrationSummary', function() {
      // uncomment below and update the code to test DataIntegrationSummary
      //var instance = new AmazonAppIntegrationsService.DataIntegrationSummary();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.DataIntegrationSummary);
    });
