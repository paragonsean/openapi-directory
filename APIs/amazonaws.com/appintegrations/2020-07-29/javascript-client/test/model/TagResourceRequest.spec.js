...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonAppIntegrationsService.TagResourceRequest();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.TagResourceRequest);
    });
