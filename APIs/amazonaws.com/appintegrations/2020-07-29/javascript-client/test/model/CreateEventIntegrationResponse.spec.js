...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.CreateEventIntegrationResponse();
  });
  ...
  describe('CreateEventIntegrationResponse', function() {
    it('should create an instance of CreateEventIntegrationResponse', function() {
      // uncomment below and update the code to test CreateEventIntegrationResponse
      //var instance = new AmazonAppIntegrationsService.CreateEventIntegrationResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.CreateEventIntegrationResponse);
    });

    it('should have the property eventIntegrationArn (base name: "EventIntegrationArn")', function() {
      // uncomment below and update the code to test the property eventIntegrationArn
      //var instance = new AmazonAppIntegrationsService.CreateEventIntegrationResponse();
