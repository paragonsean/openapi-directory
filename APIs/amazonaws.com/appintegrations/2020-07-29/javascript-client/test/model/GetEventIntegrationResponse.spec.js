...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.GetEventIntegrationResponse();
  });
  ...
  describe('GetEventIntegrationResponse', function() {
    it('should create an instance of GetEventIntegrationResponse', function() {
      // uncomment below and update the code to test GetEventIntegrationResponse
      //var instance = new AmazonAppIntegrationsService.GetEventIntegrationResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.GetEventIntegrationResponse);
    });
