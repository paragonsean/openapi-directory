...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.CreateDataIntegrationRequest();
  });
  ...
  describe('CreateDataIntegrationRequest', function() {
    it('should create an instance of CreateDataIntegrationRequest', function() {
      // uncomment below and update the code to test CreateDataIntegrationRequest
      //var instance = new AmazonAppIntegrationsService.CreateDataIntegrationRequest();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.CreateDataIntegrationRequest);
    });
