...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.EventIntegration();
  });
  ...
  describe('EventIntegration', function() {
    it('should create an instance of EventIntegration', function() {
      // uncomment below and update the code to test EventIntegration
      //var instance = new AmazonAppIntegrationsService.EventIntegration();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.EventIntegration);
    });
