...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.GetDataIntegrationResponse();
  });
  ...
  describe('GetDataIntegrationResponse', function() {
    it('should create an instance of GetDataIntegrationResponse', function() {
      // uncomment below and update the code to test GetDataIntegrationResponse
      //var instance = new AmazonAppIntegrationsService.GetDataIntegrationResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.GetDataIntegrationResponse);
    });
    ...
    it('should have the property scheduleConfiguration (base name: "ScheduleConfiguration")', function() {
      // uncomment below and update the code to test the property scheduleConfiguration
      //var instance = new AmazonAppIntegrationsService.GetDataIntegrationResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property fileConfiguration (base name: "FileConfiguration")', function() {
      // uncomment below and update the code to test the property fileConfiguration
      //var instance = new AmazonAppIntegrationsService.GetDataIntegrationResponse();
      //expect(instance).to.be();
    });

    it('should have the property objectConfiguration (base name: "ObjectConfiguration")', function() {
      // uncomment below and update the code to test the property objectConfiguration
      //var instance = new AmazonAppIntegrationsService.GetDataIntegrationResponse();
      //expect(instance).to.be();
    });
