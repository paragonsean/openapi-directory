...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.UpdateEventIntegrationRequest();
  });
  ...
  describe('UpdateEventIntegrationRequest', function() {
    it('should create an instance of UpdateEventIntegrationRequest', function() {
      // uncomment below and update the code to test UpdateEventIntegrationRequest
      //var instance = new AmazonAppIntegrationsService.UpdateEventIntegrationRequest();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.UpdateEventIntegrationRequest);
    });
