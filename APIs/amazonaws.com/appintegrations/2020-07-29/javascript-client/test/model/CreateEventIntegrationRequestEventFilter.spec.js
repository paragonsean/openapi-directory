...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.CreateEventIntegrationRequestEventFilter();
  });
  ...
  describe('CreateEventIntegrationRequestEventFilter', function() {
    it('should create an instance of CreateEventIntegrationRequestEventFilter', function() {
      // uncomment below and update the code to test CreateEventIntegrationRequestEventFilter
      //var instance = new AmazonAppIntegrationsService.CreateEventIntegrationRequestEventFilter();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.CreateEventIntegrationRequestEventFilter);
    });
