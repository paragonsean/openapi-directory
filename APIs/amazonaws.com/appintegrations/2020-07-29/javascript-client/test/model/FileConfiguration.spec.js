...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.FileConfiguration();
  });
  ...
  describe('FileConfiguration', function() {
    it('should create an instance of FileConfiguration', function() {
      // uncomment below and update the code to test FileConfiguration
      //var instance = new AmazonAppIntegrationsService.FileConfiguration();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.FileConfiguration);
    });
