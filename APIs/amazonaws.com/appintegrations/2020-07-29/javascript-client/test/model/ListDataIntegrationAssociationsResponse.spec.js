...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.ListDataIntegrationAssociationsResponse();
  });
  ...
  describe('ListDataIntegrationAssociationsResponse', function() {
    it('should create an instance of ListDataIntegrationAssociationsResponse', function() {
      // uncomment below and update the code to test ListDataIntegrationAssociationsResponse
      //var instance = new AmazonAppIntegrationsService.ListDataIntegrationAssociationsResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.ListDataIntegrationAssociationsResponse);
    });

    it('should have the property dataIntegrationAssociations (base name: "DataIntegrationAssociations")', function() {
      // uncomment below and update the code to test the property dataIntegrationAssociations
      //var instance = new AmazonAppIntegrationsService.ListDataIntegrationAssociationsResponse();
