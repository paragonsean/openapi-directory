...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.ListEventIntegrationAssociationsResponse();
  });
  ...
  describe('ListEventIntegrationAssociationsResponse', function() {
    it('should create an instance of ListEventIntegrationAssociationsResponse', function() {
      // uncomment below and update the code to test ListEventIntegrationAssociationsResponse
      //var instance = new AmazonAppIntegrationsService.ListEventIntegrationAssociationsResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.ListEventIntegrationAssociationsResponse);
    });

    it('should have the property eventIntegrationAssociations (base name: "EventIntegrationAssociations")', function() {
      // uncomment below and update the code to test the property eventIntegrationAssociations
      //var instance = new AmazonAppIntegrationsService.ListEventIntegrationAssociationsResponse();
