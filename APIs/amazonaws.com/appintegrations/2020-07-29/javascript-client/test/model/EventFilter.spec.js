...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.EventFilter();
  });
  ...
  describe('EventFilter', function() {
    it('should create an instance of EventFilter', function() {
      ...
      //var instance = new AmazonAppIntegrationsService.EventFilter();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.EventFilter);
    });
