...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.ListEventIntegrationsResponse();
  });
  ...
  describe('ListEventIntegrationsResponse', function() {
    it('should create an instance of ListEventIntegrationsResponse', function() {
      // uncomment below and update the code to test ListEventIntegrationsResponse
      //var instance = new AmazonAppIntegrationsService.ListEventIntegrationsResponse();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.ListEventIntegrationsResponse);
    });

    it('should have the property eventIntegrations (base name: "EventIntegrations")', function() {
      // uncomment below and update the code to test the property eventIntegrations
      //var instance = new AmazonAppIntegrationsService.ListEventIntegrationsResponse();
