...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.UpdateDataIntegrationRequest();
  });
  ...
  describe('UpdateDataIntegrationRequest', function() {
    it('should create an instance of UpdateDataIntegrationRequest', function() {
      // uncomment below and update the code to test UpdateDataIntegrationRequest
      //var instance = new AmazonAppIntegrationsService.UpdateDataIntegrationRequest();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.UpdateDataIntegrationRequest);
    });
