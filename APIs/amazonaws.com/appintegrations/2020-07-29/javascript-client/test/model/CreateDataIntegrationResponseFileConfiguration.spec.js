...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppIntegrationsService.CreateDataIntegrationResponseFileConfiguration();
  });
  ...
  describe('CreateDataIntegrationResponseFileConfiguration', function() {
    it('should create an instance of CreateDataIntegrationResponseFileConfiguration', function() {
      // uncomment below and update the code to test CreateDataIntegrationResponseFileConfiguration
      //var instance = new AmazonAppIntegrationsService.CreateDataIntegrationResponseFileConfiguration();
      //expect(instance).to.be.a(AmazonAppIntegrationsService.CreateDataIntegrationResponseFileConfiguration);
    });
