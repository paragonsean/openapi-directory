...
/*
 * OAIUpdateDataIntegrationRequest.h
 *
 * 
 */

#ifndef OAIUpdateDataIntegrationRequest_H
#define OAIUpdateDataIntegrationRequest_H
...
class OAIUpdateDataIntegrationRequest : public OAIObject {
public:
    OAIUpdateDataIntegrationRequest();
    OAIUpdateDataIntegrationRequest(QString json);
    ~OAIUpdateDataIntegrationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDataIntegrationRequest)

#endif // OAIUpdateDataIntegrationRequest_H
