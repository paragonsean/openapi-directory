...
/*
 * OAIUpdateEventIntegration_request.h
 *
 * 
 */

#ifndef OAIUpdateEventIntegration_request_H
#define OAIUpdateEventIntegration_request_H
...
class OAIUpdateEventIntegration_request : public OAIObject {
public:
    OAIUpdateEventIntegration_request();
    OAIUpdateEventIntegration_request(QString json);
    ~OAIUpdateEventIntegration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventIntegration_request)

#endif // OAIUpdateEventIntegration_request_H
