...
/*
 * OAIGetEventIntegrationResponse.h
 *
 * 
 */

#ifndef OAIGetEventIntegrationResponse_H
#define OAIGetEventIntegrationResponse_H
...
class OAIGetEventIntegrationResponse : public OAIObject {
public:
    OAIGetEventIntegrationResponse();
    OAIGetEventIntegrationResponse(QString json);
    ~OAIGetEventIntegrationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventIntegrationResponse)

#endif // OAIGetEventIntegrationResponse_H
