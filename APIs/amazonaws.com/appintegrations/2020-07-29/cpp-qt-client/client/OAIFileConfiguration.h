...
/*
 * OAIFileConfiguration.h
 *
 * The configuration for what files should be pulled from the source.
 */

#ifndef OAIFileConfiguration_H
#define OAIFileConfiguration_H
...
class OAIFileConfiguration : public OAIObject {
public:
    OAIFileConfiguration();
    OAIFileConfiguration(QString json);
    ~OAIFileConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileConfiguration)

#endif // OAIFileConfiguration_H
