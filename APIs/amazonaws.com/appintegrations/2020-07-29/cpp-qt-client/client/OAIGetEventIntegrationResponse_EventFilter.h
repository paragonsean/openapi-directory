...
/*
 * OAIGetEventIntegrationResponse_EventFilter.h
 *
 * 
 */

#ifndef OAIGetEventIntegrationResponse_EventFilter_H
#define OAIGetEventIntegrationResponse_EventFilter_H
...
class OAIGetEventIntegrationResponse_EventFilter : public OAIObject {
public:
    OAIGetEventIntegrationResponse_EventFilter();
    OAIGetEventIntegrationResponse_EventFilter(QString json);
    ~OAIGetEventIntegrationResponse_EventFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventIntegrationResponse_EventFilter)

#endif // OAIGetEventIntegrationResponse_EventFilter_H
