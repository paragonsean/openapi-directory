...
/*
 * OAIUpdateEventIntegrationRequest.h
 *
 * 
 */

#ifndef OAIUpdateEventIntegrationRequest_H
#define OAIUpdateEventIntegrationRequest_H
...
class OAIUpdateEventIntegrationRequest : public OAIObject {
public:
    OAIUpdateEventIntegrationRequest();
    OAIUpdateEventIntegrationRequest(QString json);
    ~OAIUpdateEventIntegrationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventIntegrationRequest)

#endif // OAIUpdateEventIntegrationRequest_H
