...
/*
 * OAICreateDataIntegrationResponse_ScheduleConfiguration.h
 *
 * 
 */

#ifndef OAICreateDataIntegrationResponse_ScheduleConfiguration_H
#define OAICreateDataIntegrationResponse_ScheduleConfiguration_H
...
class OAICreateDataIntegrationResponse_ScheduleConfiguration : public OAIObject {
public:
    OAICreateDataIntegrationResponse_ScheduleConfiguration();
    OAICreateDataIntegrationResponse_ScheduleConfiguration(QString json);
    ~OAICreateDataIntegrationResponse_ScheduleConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataIntegrationResponse_ScheduleConfiguration)

#endif // OAICreateDataIntegrationResponse_ScheduleConfiguration_H
