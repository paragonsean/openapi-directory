...
async def test_create_data_integration(client):
    """Test case for create_data_integration

    
    """
    body = {"ScheduleConfig":{"FirstExecutionFrom":"","ScheduleExpression":"","Object":""},"FileConfiguration":{"Filters":"","Folders":""},"Description":"","SourceURI":"","ClientToken":"","ObjectConfiguration":"","KmsKey":"","Tags":"","Name":""}
    headers = { 
...
async def test_create_event_integration(client):
    """Test case for create_event_integration

    
    """
    body = {"Description":"","EventBridgeBus":"","ClientToken":"","EventFilter":{"Source":""},"Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_data_integration(client):
    """Test case for delete_data_integration
    ...
    response = await client.request(
        method='DELETE',
        path='/dataIntegrations/{identifier}'.format(identifier='identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_event_integration(client):
    """Test case for delete_event_integration
    ...
    response = await client.request(
        method='DELETE',
        path='/eventIntegrations/{name}'.format(name='name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_data_integration(client):
    """Test case for get_data_integration
...
async def test_get_event_integration(client):
    """Test case for get_event_integration
...
async def test_list_data_integration_associations(client):
    """Test case for list_data_integration_associations
    ...
    response = await client.request(
        method='GET',
        path='/dataIntegrations/{identifier}/associations'.format(identifier='identifier_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_data_integrations(client):
    """Test case for list_data_integrations
...
async def test_list_event_integration_associations(client):
    """Test case for list_event_integration_associations
    ...
    response = await client.request(
        method='GET',
        path='/eventIntegrations/{name}/associations'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_event_integrations(client):
    """Test case for list_event_integrations
...
async def test_update_data_integration(client):
    """Test case for update_data_integration
...
async def test_update_event_integration(client):
    """Test case for update_event_integration
