...
public class CreateEventIntegrationRequest {
  ...
  public CreateEventIntegrationRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateEventIntegrationRequest description(String description) {
  ...
  public CreateEventIntegrationRequest eventFilter(CreateEventIntegrationRequestEventFilter eventFilter) {
  ...
  public void setEventFilter(CreateEventIntegrationRequestEventFilter eventFilter) {
    this.eventFilter = eventFilter;
  }


  public CreateEventIntegrationRequest eventBridgeBus(String eventBridgeBus) {
  ...
  public CreateEventIntegrationRequest clientToken(String clientToken) {
  ...
  public CreateEventIntegrationRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }
