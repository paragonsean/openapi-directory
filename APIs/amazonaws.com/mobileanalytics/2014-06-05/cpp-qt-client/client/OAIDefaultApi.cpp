...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://mobileanalytics.{region}.amazonaws.com"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://mobileanalytics.{region}.amazonaws.com"),
    "The Amazon Mobile Analytics multi-region endpoint",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","us-east-1",
    QSet<QString>{ {"us-east-1"},{"us-east-2"},{"us-west-1"},{"us-west-2"},{"us-gov-west-1"},{"us-gov-east-1"},{"ca-central-1"},{"eu-north-1"},{"eu-west-1"},{"eu-west-2"},{"eu-west-3"},{"eu-central-1"},{"eu-south-1"},{"af-south-1"},{"ap-northeast-1"},{"ap-northeast-2"},{"ap-northeast-3"},{"ap-southeast-1"},{"ap-southeast-2"},{"ap-east-1"},{"ap-south-1"},{"sa-east-1"},{"me-south-1"} })}, }));
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://mobileanalytics.{region}.amazonaws.com.cn"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://mobileanalytics.{region}.amazonaws.com.cn"),
    "The Amazon Mobile Analytics endpoint for China (Beijing) and China (Ningxia)",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","cn-north-1",
    QSet<QString>{ {"cn-north-1"},{"cn-northwest-1"} })}, }));
...
void OAIDefaultApi::putEvents(const QString &x_amz_client_context, const OAIPutEvents_request &oai_put_events_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers, const ::OpenAPI::OptionalParam<QString> &x_amz_client_context_encoding) {
    QString fullPath = QString(_serverConfigs["putEvents"][_serverIndices.value("putEvents")].URL()+"/2014-06-05/events#x-amz-Client-Context");
    ...
    {
        if (!::OpenAPI::toStringValue(x_amz_client_context).isEmpty()) {
            input.headers.insert("x-amz-Client-Context", ::OpenAPI::toStringValue(x_amz_client_context));
        }
        }
    if (x_amz_client_context_encoding.hasValue())
    {
        if (!::OpenAPI::toStringValue(x_amz_client_context_encoding.value()).isEmpty()) {
            input.headers.insert("x-amz-Client-Context-Encoding", ::OpenAPI::toStringValue(x_amz_client_context_encoding.value()));
        }
        }
