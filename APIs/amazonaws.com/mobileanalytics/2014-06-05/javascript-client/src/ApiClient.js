...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://mobileanalytics.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://mobileanalytics.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2014-06-05/Javascript'
        };
