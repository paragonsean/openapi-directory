...
#include "OAIBatchWriteOperation.h"
...
OAIBatchWriteOperation::OAIBatchWriteOperation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchWriteOperation::OAIBatchWriteOperation() {
    this->initializeModel();
}

OAIBatchWriteOperation::~OAIBatchWriteOperation() {}

void OAIBatchWriteOperation::initializeModel() {
...
void OAIBatchWriteOperation::fromJson(QString jsonString) {
...
void OAIBatchWriteOperation::fromJsonObject(QJsonObject json) {
...
QString OAIBatchWriteOperation::asJson() const {
...
QJsonObject OAIBatchWriteOperation::asJsonObject() const {
    QJsonObject obj;
...
OAIBatchWriteOperation_CreateObject OAIBatchWriteOperation::getCreateObject() const {
    return m_create_object;
}
void OAIBatchWriteOperation::setCreateObject(const OAIBatchWriteOperation_CreateObject &create_object) {
    m_create_object = create_object;
    m_create_object_isSet = true;
}

bool OAIBatchWriteOperation::is_create_object_Set() const{
    return m_create_object_isSet;
}

bool OAIBatchWriteOperation::is_create_object_Valid() const{
    return m_create_object_isValid;
}

OAIBatchWriteOperation_AttachObject OAIBatchWriteOperation::getAttachObject() const {
    return m_attach_object;
}
void OAIBatchWriteOperation::setAttachObject(const OAIBatchWriteOperation_AttachObject &attach_object) {
    m_attach_object = attach_object;
    m_attach_object_isSet = true;
}

bool OAIBatchWriteOperation::is_attach_object_Set() const{
    return m_attach_object_isSet;
}

bool OAIBatchWriteOperation::is_attach_object_Valid() const{
    return m_attach_object_isValid;
}

OAIBatchWriteOperation_DetachObject OAIBatchWriteOperation::getDetachObject() const {
    return m_detach_object;
}
void OAIBatchWriteOperation::setDetachObject(const OAIBatchWriteOperation_DetachObject &detach_object) {
    m_detach_object = detach_object;
    m_detach_object_isSet = true;
}

bool OAIBatchWriteOperation::is_detach_object_Set() const{
    return m_detach_object_isSet;
}

bool OAIBatchWriteOperation::is_detach_object_Valid() const{
    return m_detach_object_isValid;
}

OAIBatchWriteOperation_UpdateObjectAttributes OAIBatchWriteOperation::getUpdateObjectAttributes() const {
    return m_update_object_attributes;
}
void OAIBatchWriteOperation::setUpdateObjectAttributes(const OAIBatchWriteOperation_UpdateObjectAttributes &update_object_attributes) {
    m_update_object_attributes = update_object_attributes;
    m_update_object_attributes_isSet = true;
}

bool OAIBatchWriteOperation::is_update_object_attributes_Set() const{
    return m_update_object_attributes_isSet;
}

bool OAIBatchWriteOperation::is_update_object_attributes_Valid() const{
    return m_update_object_attributes_isValid;
}

OAIBatchWriteOperation_DeleteObject OAIBatchWriteOperation::getDeleteObject() const {
    return m_delete_object;
}
void OAIBatchWriteOperation::setDeleteObject(const OAIBatchWriteOperation_DeleteObject &delete_object) {
    m_delete_object = delete_object;
    m_delete_object_isSet = true;
}

bool OAIBatchWriteOperation::is_delete_object_Set() const{
    return m_delete_object_isSet;
}

bool OAIBatchWriteOperation::is_delete_object_Valid() const{
    return m_delete_object_isValid;
}

OAIBatchWriteOperation_AddFacetToObject OAIBatchWriteOperation::getAddFacetToObject() const {
    return m_add_facet_to_object;
}
void OAIBatchWriteOperation::setAddFacetToObject(const OAIBatchWriteOperation_AddFacetToObject &add_facet_to_object) {
    m_add_facet_to_object = add_facet_to_object;
    m_add_facet_to_object_isSet = true;
}

bool OAIBatchWriteOperation::is_add_facet_to_object_Set() const{
    return m_add_facet_to_object_isSet;
}

bool OAIBatchWriteOperation::is_add_facet_to_object_Valid() const{
    return m_add_facet_to_object_isValid;
}

OAIBatchWriteOperation_RemoveFacetFromObject OAIBatchWriteOperation::getRemoveFacetFromObject() const {
    return m_remove_facet_from_object;
}
void OAIBatchWriteOperation::setRemoveFacetFromObject(const OAIBatchWriteOperation_RemoveFacetFromObject &remove_facet_from_object) {
    m_remove_facet_from_object = remove_facet_from_object;
    m_remove_facet_from_object_isSet = true;
}

bool OAIBatchWriteOperation::is_remove_facet_from_object_Set() const{
    return m_remove_facet_from_object_isSet;
}

bool OAIBatchWriteOperation::is_remove_facet_from_object_Valid() const{
    return m_remove_facet_from_object_isValid;
}

OAIBatchWriteOperation_AttachPolicy OAIBatchWriteOperation::getAttachPolicy() const {
    return m_attach_policy;
}
void OAIBatchWriteOperation::setAttachPolicy(const OAIBatchWriteOperation_AttachPolicy &attach_policy) {
    m_attach_policy = attach_policy;
    m_attach_policy_isSet = true;
}

bool OAIBatchWriteOperation::is_attach_policy_Set() const{
    return m_attach_policy_isSet;
}

bool OAIBatchWriteOperation::is_attach_policy_Valid() const{
    return m_attach_policy_isValid;
}

OAIBatchWriteOperation_DetachPolicy OAIBatchWriteOperation::getDetachPolicy() const {
    return m_detach_policy;
}
void OAIBatchWriteOperation::setDetachPolicy(const OAIBatchWriteOperation_DetachPolicy &detach_policy) {
    m_detach_policy = detach_policy;
    m_detach_policy_isSet = true;
}

bool OAIBatchWriteOperation::is_detach_policy_Set() const{
    return m_detach_policy_isSet;
}

bool OAIBatchWriteOperation::is_detach_policy_Valid() const{
    return m_detach_policy_isValid;
}

OAIBatchWriteOperation_CreateIndex OAIBatchWriteOperation::getCreateIndex() const {
    return m_create_index;
}
void OAIBatchWriteOperation::setCreateIndex(const OAIBatchWriteOperation_CreateIndex &create_index) {
    m_create_index = create_index;
    m_create_index_isSet = true;
}

bool OAIBatchWriteOperation::is_create_index_Set() const{
    return m_create_index_isSet;
}

bool OAIBatchWriteOperation::is_create_index_Valid() const{
    return m_create_index_isValid;
}

OAIBatchWriteOperation_AttachToIndex OAIBatchWriteOperation::getAttachToIndex() const {
    return m_attach_to_index;
}
void OAIBatchWriteOperation::setAttachToIndex(const OAIBatchWriteOperation_AttachToIndex &attach_to_index) {
    m_attach_to_index = attach_to_index;
    m_attach_to_index_isSet = true;
}

bool OAIBatchWriteOperation::is_attach_to_index_Set() const{
    return m_attach_to_index_isSet;
}

bool OAIBatchWriteOperation::is_attach_to_index_Valid() const{
    return m_attach_to_index_isValid;
}

OAIBatchWriteOperation_DetachFromIndex OAIBatchWriteOperation::getDetachFromIndex() const {
    return m_detach_from_index;
}
void OAIBatchWriteOperation::setDetachFromIndex(const OAIBatchWriteOperation_DetachFromIndex &detach_from_index) {
    m_detach_from_index = detach_from_index;
    m_detach_from_index_isSet = true;
}

bool OAIBatchWriteOperation::is_detach_from_index_Set() const{
    return m_detach_from_index_isSet;
}

bool OAIBatchWriteOperation::is_detach_from_index_Valid() const{
    return m_detach_from_index_isValid;
}

OAIBatchWriteOperation_AttachTypedLink OAIBatchWriteOperation::getAttachTypedLink() const {
    return m_attach_typed_link;
}
void OAIBatchWriteOperation::setAttachTypedLink(const OAIBatchWriteOperation_AttachTypedLink &attach_typed_link) {
    m_attach_typed_link = attach_typed_link;
    m_attach_typed_link_isSet = true;
}

bool OAIBatchWriteOperation::is_attach_typed_link_Set() const{
    return m_attach_typed_link_isSet;
}

bool OAIBatchWriteOperation::is_attach_typed_link_Valid() const{
    return m_attach_typed_link_isValid;
}

OAIBatchWriteOperation_DetachTypedLink OAIBatchWriteOperation::getDetachTypedLink() const {
    return m_detach_typed_link;
}
void OAIBatchWriteOperation::setDetachTypedLink(const OAIBatchWriteOperation_DetachTypedLink &detach_typed_link) {
    m_detach_typed_link = detach_typed_link;
    m_detach_typed_link_isSet = true;
}

bool OAIBatchWriteOperation::is_detach_typed_link_Set() const{
    return m_detach_typed_link_isSet;
}

bool OAIBatchWriteOperation::is_detach_typed_link_Valid() const{
    return m_detach_typed_link_isValid;
}

OAIBatchWriteOperation_UpdateLinkAttributes OAIBatchWriteOperation::getUpdateLinkAttributes() const {
    return m_update_link_attributes;
}
void OAIBatchWriteOperation::setUpdateLinkAttributes(const OAIBatchWriteOperation_UpdateLinkAttributes &update_link_attributes) {
    m_update_link_attributes = update_link_attributes;
    m_update_link_attributes_isSet = true;
}

bool OAIBatchWriteOperation::is_update_link_attributes_Set() const{
    return m_update_link_attributes_isSet;
}

bool OAIBatchWriteOperation::is_update_link_attributes_Valid() const{
    return m_update_link_attributes_isValid;
}

bool OAIBatchWriteOperation::isSet() const {
...
bool OAIBatchWriteOperation::isValid() const {
