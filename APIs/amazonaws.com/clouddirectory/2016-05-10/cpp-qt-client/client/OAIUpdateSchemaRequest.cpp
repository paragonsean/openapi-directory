...
QString OAIUpdateSchemaRequest::getName() const {
    return m_name;
}
void OAIUpdateSchemaRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateSchemaRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateSchemaRequest::is_name_Valid() const{
