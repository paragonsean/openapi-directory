...
OAIUpgradeAppliedSchema_request::OAIUpgradeAppliedSchema_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpgradeAppliedSchema_request::OAIUpgradeAppliedSchema_request() {
    this->initializeModel();
}

OAIUpgradeAppliedSchema_request::~OAIUpgradeAppliedSchema_request() {}

void OAIUpgradeAppliedSchema_request::initializeModel() {
...
void OAIUpgradeAppliedSchema_request::fromJson(QString jsonString) {
...
void OAIUpgradeAppliedSchema_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpgradeAppliedSchema_request::asJson() const {
...
QJsonObject OAIUpgradeAppliedSchema_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpgradeAppliedSchema_request::getPublishedSchemaArn() const {
    return m_published_schema_arn;
}
void OAIUpgradeAppliedSchema_request::setPublishedSchemaArn(const QString &published_schema_arn) {
    m_published_schema_arn = published_schema_arn;
    m_published_schema_arn_isSet = true;
}

bool OAIUpgradeAppliedSchema_request::is_published_schema_arn_Set() const{
    return m_published_schema_arn_isSet;
}

bool OAIUpgradeAppliedSchema_request::is_published_schema_arn_Valid() const{
    return m_published_schema_arn_isValid;
}

QString OAIUpgradeAppliedSchema_request::getDirectoryArn() const {
    return m_directory_arn;
}
void OAIUpgradeAppliedSchema_request::setDirectoryArn(const QString &directory_arn) {
    m_directory_arn = directory_arn;
    m_directory_arn_isSet = true;
}

bool OAIUpgradeAppliedSchema_request::is_directory_arn_Set() const{
    return m_directory_arn_isSet;
}

bool OAIUpgradeAppliedSchema_request::is_directory_arn_Valid() const{
    return m_directory_arn_isValid;
}

bool OAIUpgradeAppliedSchema_request::isDryRun() const {
    return m_dry_run;
}
void OAIUpgradeAppliedSchema_request::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIUpgradeAppliedSchema_request::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIUpgradeAppliedSchema_request::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIUpgradeAppliedSchema_request::isSet() const {
...
bool OAIUpgradeAppliedSchema_request::isValid() const {
