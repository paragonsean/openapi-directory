...
QString OAIUpdateSchema_request::getName() const {
    return m_name;
}
void OAIUpdateSchema_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateSchema_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateSchema_request::is_name_Valid() const{
