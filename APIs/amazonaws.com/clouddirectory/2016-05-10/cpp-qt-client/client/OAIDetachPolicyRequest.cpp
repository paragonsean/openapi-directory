...
OAIBatchDetachPolicy_PolicyReference OAIDetachPolicyRequest::getPolicyReference() const {
    return m_policy_reference;
}
void OAIDetachPolicyRequest::setPolicyReference(const OAIBatchDetachPolicy_PolicyReference &policy_reference) {
    m_policy_reference = policy_reference;
    m_policy_reference_isSet = true;
}

bool OAIDetachPolicyRequest::is_policy_reference_Set() const{
    return m_policy_reference_isSet;
}

bool OAIDetachPolicyRequest::is_policy_reference_Valid() const{
    return m_policy_reference_isValid;
}

OAIBatchDetachPolicy_ObjectReference OAIDetachPolicyRequest::getObjectReference() const {
    return m_object_reference;
}
void OAIDetachPolicyRequest::setObjectReference(const OAIBatchDetachPolicy_ObjectReference &object_reference) {
    m_object_reference = object_reference;
    m_object_reference_isSet = true;
}

bool OAIDetachPolicyRequest::is_object_reference_Set() const{
    return m_object_reference_isSet;
}

bool OAIDetachPolicyRequest::is_object_reference_Valid() const{
