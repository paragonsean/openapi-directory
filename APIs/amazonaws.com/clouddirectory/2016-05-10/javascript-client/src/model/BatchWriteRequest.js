...
import BatchWriteOperation from './BatchWriteOperation';
...
class BatchWriteRequest {
     ...
     * @param operations {Array.<module:model/BatchWriteOperation>} A list of operations that are part of the batch.
     */
    constructor(operations) { 
        
        BatchWriteRequest.initialize(this, operations);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Operations')) {
                obj['Operations'] = ApiClient.convertToType(data['Operations'], [BatchWriteOperation]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of BatchWriteRequest.RequiredProperties) {
        ...
        if (data['Operations']) { // data not null
            ...
            for (const item of data['Operations']) {
                BatchWriteOperation.validateJSON(item);
            };
        }
...
BatchWriteRequest.RequiredProperties = ["Operations"];

/**
 * A list of operations that are part of the batch.
 * @member {Array.<module:model/BatchWriteOperation>} Operations
 */
BatchWriteRequest.prototype['Operations'] = undefined;
