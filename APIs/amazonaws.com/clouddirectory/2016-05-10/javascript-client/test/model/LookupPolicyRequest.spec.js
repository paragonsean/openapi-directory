...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.LookupPolicyRequest();
  });
  ...
  describe('LookupPolicyRequest', function() {
    it('should create an instance of LookupPolicyRequest', function() {
      // uncomment below and update the code to test LookupPolicyRequest
      //var instance = new AmazonCloudDirectory.LookupPolicyRequest();
      //expect(instance).to.be.a(AmazonCloudDirectory.LookupPolicyRequest);
    });
