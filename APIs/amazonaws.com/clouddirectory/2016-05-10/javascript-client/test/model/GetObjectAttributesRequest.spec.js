...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.GetObjectAttributesRequest();
  });
  ...
  describe('GetObjectAttributesRequest', function() {
    it('should create an instance of GetObjectAttributesRequest', function() {
      // uncomment below and update the code to test GetObjectAttributesRequest
      //var instance = new AmazonCloudDirectory.GetObjectAttributesRequest();
      //expect(instance).to.be.a(AmazonCloudDirectory.GetObjectAttributesRequest);
    });
