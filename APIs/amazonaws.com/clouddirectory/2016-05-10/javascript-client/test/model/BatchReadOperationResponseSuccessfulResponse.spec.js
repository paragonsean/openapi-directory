...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperationResponseSuccessfulResponse();
  });
  ...
  describe('BatchReadOperationResponseSuccessfulResponse', function() {
    it('should create an instance of BatchReadOperationResponseSuccessfulResponse', function() {
      // uncomment below and update the code to test BatchReadOperationResponseSuccessfulResponse
      //var instance = new AmazonCloudDirectory.BatchReadOperationResponseSuccessfulResponse();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperationResponseSuccessfulResponse);
    });
