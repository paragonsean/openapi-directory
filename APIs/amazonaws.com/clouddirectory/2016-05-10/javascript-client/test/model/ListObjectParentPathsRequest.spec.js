...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.ListObjectParentPathsRequest();
  });
  ...
  describe('ListObjectParentPathsRequest', function() {
    it('should create an instance of ListObjectParentPathsRequest', function() {
      // uncomment below and update the code to test ListObjectParentPathsRequest
      //var instance = new AmazonCloudDirectory.ListObjectParentPathsRequest();
      //expect(instance).to.be.a(AmazonCloudDirectory.ListObjectParentPathsRequest);
    });
