...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperationListObjectPolicies();
  });
  ...
  describe('BatchReadOperationListObjectPolicies', function() {
    it('should create an instance of BatchReadOperationListObjectPolicies', function() {
      // uncomment below and update the code to test BatchReadOperationListObjectPolicies
      //var instance = new AmazonCloudDirectory.BatchReadOperationListObjectPolicies();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperationListObjectPolicies);
    });
