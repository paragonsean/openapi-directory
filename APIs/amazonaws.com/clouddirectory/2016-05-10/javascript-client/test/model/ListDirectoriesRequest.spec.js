...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.ListDirectoriesRequest();
  });
  ...
  describe('ListDirectoriesRequest', function() {
    it('should create an instance of ListDirectoriesRequest', function() {
      // uncomment below and update the code to test ListDirectoriesRequest
      //var instance = new AmazonCloudDirectory.ListDirectoriesRequest();
      //expect(instance).to.be.a(AmazonCloudDirectory.ListDirectoriesRequest);
    });
