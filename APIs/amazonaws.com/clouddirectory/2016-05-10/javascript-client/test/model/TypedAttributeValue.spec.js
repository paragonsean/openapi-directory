...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.TypedAttributeValue();
  });
  ...
  describe('TypedAttributeValue', function() {
    it('should create an instance of TypedAttributeValue', function() {
      // uncomment below and update the code to test TypedAttributeValue
      //var instance = new AmazonCloudDirectory.TypedAttributeValue();
      //expect(instance).to.be.a(AmazonCloudDirectory.TypedAttributeValue);
    });
