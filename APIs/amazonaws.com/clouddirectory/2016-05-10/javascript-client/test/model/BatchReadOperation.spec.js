...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperation();
  });
  ...
  describe('BatchReadOperation', function() {
    it('should create an instance of BatchReadOperation', function() {
      // uncomment below and update the code to test BatchReadOperation
      //var instance = new AmazonCloudDirectory.BatchReadOperation();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperation);
    });
