...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.ListFacetNamesRequest();
  });
  ...
  describe('ListFacetNamesRequest', function() {
    it('should create an instance of ListFacetNamesRequest', function() {
      // uncomment below and update the code to test ListFacetNamesRequest
      //var instance = new AmazonCloudDirectory.ListFacetNamesRequest();
      //expect(instance).to.be.a(AmazonCloudDirectory.ListFacetNamesRequest);
    });
