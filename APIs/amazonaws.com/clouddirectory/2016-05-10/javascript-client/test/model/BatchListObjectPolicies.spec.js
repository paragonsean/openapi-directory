...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchListObjectPolicies();
  });
  ...
  describe('BatchListObjectPolicies', function() {
    it('should create an instance of BatchListObjectPolicies', function() {
      // uncomment below and update the code to test BatchListObjectPolicies
      //var instance = new AmazonCloudDirectory.BatchListObjectPolicies();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchListObjectPolicies);
    });
