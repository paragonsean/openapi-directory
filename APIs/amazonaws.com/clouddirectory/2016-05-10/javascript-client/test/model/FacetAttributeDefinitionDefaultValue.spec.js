...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.FacetAttributeDefinitionDefaultValue();
  });
  ...
  describe('FacetAttributeDefinitionDefaultValue', function() {
    it('should create an instance of FacetAttributeDefinitionDefaultValue', function() {
      // uncomment below and update the code to test FacetAttributeDefinitionDefaultValue
      //var instance = new AmazonCloudDirectory.FacetAttributeDefinitionDefaultValue();
      //expect(instance).to.be.a(AmazonCloudDirectory.FacetAttributeDefinitionDefaultValue);
    });
