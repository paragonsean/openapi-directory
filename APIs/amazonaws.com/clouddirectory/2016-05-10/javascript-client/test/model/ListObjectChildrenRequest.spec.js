...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.ListObjectChildrenRequest();
  });
  ...
  describe('ListObjectChildrenRequest', function() {
    it('should create an instance of ListObjectChildrenRequest', function() {
      // uncomment below and update the code to test ListObjectChildrenRequest
      //var instance = new AmazonCloudDirectory.ListObjectChildrenRequest();
      //expect(instance).to.be.a(AmazonCloudDirectory.ListObjectChildrenRequest);
    });
