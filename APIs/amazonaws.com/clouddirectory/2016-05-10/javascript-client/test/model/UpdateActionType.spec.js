...
(function(root, factory) {
  ...
  describe('UpdateActionType', function() {
    it('should create an instance of UpdateActionType', function() {
      // uncomment below and update the code to test UpdateActionType
      //var instance = new AmazonCloudDirectory.UpdateActionType();
      //expect(instance).to.be.a(AmazonCloudDirectory.UpdateActionType);
    });
