...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.TypedAttributeValueRangeEndValue();
  });
  ...
  describe('TypedAttributeValueRangeEndValue', function() {
    it('should create an instance of TypedAttributeValueRangeEndValue', function() {
      // uncomment below and update the code to test TypedAttributeValueRangeEndValue
      //var instance = new AmazonCloudDirectory.TypedAttributeValueRangeEndValue();
      //expect(instance).to.be.a(AmazonCloudDirectory.TypedAttributeValueRangeEndValue);
    });
