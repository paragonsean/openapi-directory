...
public class TypedAttributeValue {
  ...
  public TypedAttributeValue stringValue(String stringValue) {
  ...
  public TypedAttributeValue binaryValue(String binaryValue) {
  ...
  public TypedAttributeValue booleanValue(Boolean booleanValue) {
  ...
  public TypedAttributeValue numberValue(String numberValue) {
  ...
  public TypedAttributeValue datetimeValue(OffsetDateTime datetimeValue) {
  ...
  public boolean equals(Object o) {
    ...
    TypedAttributeValue typedAttributeValue = (TypedAttributeValue) o;
    return Objects.equals(this.stringValue, typedAttributeValue.stringValue) &&
        Objects.equals(this.binaryValue, typedAttributeValue.binaryValue) &&
        Objects.equals(this.booleanValue, typedAttributeValue.booleanValue) &&
        Objects.equals(this.numberValue, typedAttributeValue.numberValue) &&
        Objects.equals(this.datetimeValue, typedAttributeValue.datetimeValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class TypedAttributeValue {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TypedAttributeValue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypedAttributeValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TypedAttributeValue is not found in the empty JSON string", TypedAttributeValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TypedAttributeValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TypedAttributeValue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypedAttributeValue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypedAttributeValue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypedAttributeValue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypedAttributeValue.class));

       return (TypeAdapter<T>) new TypeAdapter<TypedAttributeValue>() {
           @Override
           public void write(JsonWriter out, TypedAttributeValue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TypedAttributeValue read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TypedAttributeValue given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TypedAttributeValue
   * @throws IOException if the JSON string is invalid with respect to TypedAttributeValue
   */
  public static TypedAttributeValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypedAttributeValue.class);
  }

  /**
   * Convert an instance of TypedAttributeValue to an JSON string
   *
   * @return JSON string
   */
