...
public class BatchListIncomingTypedLinks {
  ...
  public BatchListIncomingTypedLinks() {
  }

  public BatchListIncomingTypedLinks objectReference(BatchListIncomingTypedLinksObjectReference objectReference) {
  ...
  public BatchListIncomingTypedLinks filterAttributeRanges(List filterAttributeRanges) {
  ...
  public BatchListIncomingTypedLinks filterTypedLink(BatchListIncomingTypedLinksFilterTypedLink filterTypedLink) {
  ...
  public BatchListIncomingTypedLinks nextToken(String nextToken) {
  ...
  public BatchListIncomingTypedLinks maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    BatchListIncomingTypedLinks batchListIncomingTypedLinks = (BatchListIncomingTypedLinks) o;
    return Objects.equals(this.objectReference, batchListIncomingTypedLinks.objectReference) &&
        Objects.equals(this.filterAttributeRanges, batchListIncomingTypedLinks.filterAttributeRanges) &&
        Objects.equals(this.filterTypedLink, batchListIncomingTypedLinks.filterTypedLink) &&
        Objects.equals(this.nextToken, batchListIncomingTypedLinks.nextToken) &&
        Objects.equals(this.maxResults, batchListIncomingTypedLinks.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchListIncomingTypedLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchListIncomingTypedLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchListIncomingTypedLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchListIncomingTypedLinks is not found in the empty JSON string", BatchListIncomingTypedLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchListIncomingTypedLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchListIncomingTypedLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchListIncomingTypedLinks.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchListIncomingTypedLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchListIncomingTypedLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchListIncomingTypedLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchListIncomingTypedLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchListIncomingTypedLinks>() {
           @Override
           public void write(JsonWriter out, BatchListIncomingTypedLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchListIncomingTypedLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchListIncomingTypedLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchListIncomingTypedLinks
   * @throws IOException if the JSON string is invalid with respect to BatchListIncomingTypedLinks
   */
  public static BatchListIncomingTypedLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchListIncomingTypedLinks.class);
  }

  /**
   * Convert an instance of BatchListIncomingTypedLinks to an JSON string
   *
   * @return JSON string
   */
