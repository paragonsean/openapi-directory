...
public class BatchReadOperation {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(listObjectAttributes, listObjectChildren, listAttachedIndices, listObjectParentPaths, getObjectInformation, getObjectAttributes, listObjectPolicies, listPolicyAttachments, lookupPolicy, listIndex, listOutgoingTypedLinks, listIncomingTypedLinks, getLinkAttributes);
  }
