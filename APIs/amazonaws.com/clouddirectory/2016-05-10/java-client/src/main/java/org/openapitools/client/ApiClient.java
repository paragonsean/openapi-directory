...
public class ApiClient {
    ...
    private String basePath = "http://clouddirectory.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-05-10/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://clouddirectory.us-east-1.amazonaws.com
