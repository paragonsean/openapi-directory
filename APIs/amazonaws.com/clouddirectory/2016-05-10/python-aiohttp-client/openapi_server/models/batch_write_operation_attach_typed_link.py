...
class BatchWriteOperationAttachTypedLink(Model):
    ...
    def __init__(self, source_object_reference: DetachTypedLinkRequestTypedLinkSpecifierSourceObjectReference=None, target_object_reference: DetachTypedLinkRequestTypedLinkSpecifierTargetObjectReference=None, typed_link_facet: DetachTypedLinkRequestTypedLinkSpecifierTypedLinkFacet=None, attributes: List=None):
        """BatchWriteOperationAttachTypedLink - a model defined in OpenAPI

        :param source_object_reference: The source_object_reference of this BatchWriteOperationAttachTypedLink.
        :param target_object_reference: The target_object_reference of this BatchWriteOperationAttachTypedLink.
        :param typed_link_facet: The typed_link_facet of this BatchWriteOperationAttachTypedLink.
        :param attributes: The attributes of this BatchWriteOperationAttachTypedLink.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BatchWriteOperationAttachTypedLink':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BatchWriteOperation_AttachTypedLink of this BatchWriteOperationAttachTypedLink.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def source_object_reference(self):
        """Gets the source_object_reference of this BatchWriteOperationAttachTypedLink.


        :return: The source_object_reference of this BatchWriteOperationAttachTypedLink.
    ...
    def source_object_reference(self, source_object_reference):
        """Sets the source_object_reference of this BatchWriteOperationAttachTypedLink.
    ...
    def target_object_reference(self):
        """Gets the target_object_reference of this BatchWriteOperationAttachTypedLink.


        :return: The target_object_reference of this BatchWriteOperationAttachTypedLink.
    ...
    def target_object_reference(self, target_object_reference):
        """Sets the target_object_reference of this BatchWriteOperationAttachTypedLink.
    ...
    def typed_link_facet(self):
        """Gets the typed_link_facet of this BatchWriteOperationAttachTypedLink.


        :return: The typed_link_facet of this BatchWriteOperationAttachTypedLink.
    ...
    def typed_link_facet(self, typed_link_facet):
        """Sets the typed_link_facet of this BatchWriteOperationAttachTypedLink.
    ...
    @property
    def attributes(self):
        """Gets the attributes of this BatchWriteOperationAttachTypedLink.


        :return: The attributes of this BatchWriteOperationAttachTypedLink.
        :rtype: List
        """
    ...
    def attributes(self, attributes):
        """Sets the attributes of this BatchWriteOperationAttachTypedLink.
