...
class BatchWriteOperationUpdateObjectAttributes(Model):
    ...
    def __init__(self, object_reference: BatchUpdateObjectAttributesObjectReference=None, attribute_updates: List=None):
        """BatchWriteOperationUpdateObjectAttributes - a model defined in OpenAPI

        :param object_reference: The object_reference of this BatchWriteOperationUpdateObjectAttributes.
        :param attribute_updates: The attribute_updates of this BatchWriteOperationUpdateObjectAttributes.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BatchWriteOperationUpdateObjectAttributes':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BatchWriteOperation_UpdateObjectAttributes of this BatchWriteOperationUpdateObjectAttributes.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def object_reference(self):
        """Gets the object_reference of this BatchWriteOperationUpdateObjectAttributes.


        :return: The object_reference of this BatchWriteOperationUpdateObjectAttributes.
    ...
    def object_reference(self, object_reference):
        """Sets the object_reference of this BatchWriteOperationUpdateObjectAttributes.
    ...
    def attribute_updates(self):
        """Gets the attribute_updates of this BatchWriteOperationUpdateObjectAttributes.


        :return: The attribute_updates of this BatchWriteOperationUpdateObjectAttributes.
        :rtype: List
        """
    ...
    def attribute_updates(self, attribute_updates):
        """Sets the attribute_updates of this BatchWriteOperationUpdateObjectAttributes.
