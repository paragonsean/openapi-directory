...
class BatchWriteOperationDetachFromIndex(Model):
    ...
    def __init__(self, index_reference: BatchDetachFromIndexIndexReference=None, target_reference: BatchDetachFromIndexTargetReference=None):
        """BatchWriteOperationDetachFromIndex - a model defined in OpenAPI

        :param index_reference: The index_reference of this BatchWriteOperationDetachFromIndex.
        :param target_reference: The target_reference of this BatchWriteOperationDetachFromIndex.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BatchWriteOperationDetachFromIndex':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BatchWriteOperation_DetachFromIndex of this BatchWriteOperationDetachFromIndex.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def index_reference(self):
        """Gets the index_reference of this BatchWriteOperationDetachFromIndex.


        :return: The index_reference of this BatchWriteOperationDetachFromIndex.
    ...
    def index_reference(self, index_reference):
        """Sets the index_reference of this BatchWriteOperationDetachFromIndex.
    ...
    def target_reference(self):
        """Gets the target_reference of this BatchWriteOperationDetachFromIndex.


        :return: The target_reference of this BatchWriteOperationDetachFromIndex.
    ...
    def target_reference(self, target_reference):
        """Sets the target_reference of this BatchWriteOperationDetachFromIndex.
