...
class GetObjectInformationRequest(Model):
    ...
    def __init__(self, object_reference: BatchGetObjectInformationObjectReference=None):
        """GetObjectInformationRequest - a model defined in OpenAPI

        :param object_reference: The object_reference of this GetObjectInformationRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetObjectInformationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetObjectInformationRequest of this GetObjectInformationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def object_reference(self):
        """Gets the object_reference of this GetObjectInformationRequest.


        :return: The object_reference of this GetObjectInformationRequest.
    ...
    def object_reference(self, object_reference):
        """Sets the object_reference of this GetObjectInformationRequest.
