...
class TypedLinkSpecifier(Model):
    ...
    def __init__(self, typed_link_facet: DetachTypedLinkRequestTypedLinkSpecifierTypedLinkFacet=None, source_object_reference: DetachTypedLinkRequestTypedLinkSpecifierSourceObjectReference=None, target_object_reference: DetachTypedLinkRequestTypedLinkSpecifierTargetObjectReference=None, identity_attribute_values: List=None):
        """TypedLinkSpecifier - a model defined in OpenAPI

        :param typed_link_facet: The typed_link_facet of this TypedLinkSpecifier.
        :param source_object_reference: The source_object_reference of this TypedLinkSpecifier.
        :param target_object_reference: The target_object_reference of this TypedLinkSpecifier.
        :param identity_attribute_values: The identity_attribute_values of this TypedLinkSpecifier.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TypedLinkSpecifier':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TypedLinkSpecifier of this TypedLinkSpecifier.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def typed_link_facet(self):
        """Gets the typed_link_facet of this TypedLinkSpecifier.


        :return: The typed_link_facet of this TypedLinkSpecifier.
    ...
    def typed_link_facet(self, typed_link_facet):
        """Sets the typed_link_facet of this TypedLinkSpecifier.
    ...
    def source_object_reference(self):
        """Gets the source_object_reference of this TypedLinkSpecifier.


        :return: The source_object_reference of this TypedLinkSpecifier.
    ...
    def source_object_reference(self, source_object_reference):
        """Sets the source_object_reference of this TypedLinkSpecifier.
    ...
    def target_object_reference(self):
        """Gets the target_object_reference of this TypedLinkSpecifier.


        :return: The target_object_reference of this TypedLinkSpecifier.
    ...
    def target_object_reference(self, target_object_reference):
        """Sets the target_object_reference of this TypedLinkSpecifier.
    ...
    def identity_attribute_values(self):
        """Gets the identity_attribute_values of this TypedLinkSpecifier.


        :return: The identity_attribute_values of this TypedLinkSpecifier.
        :rtype: List
        """
    ...
    def identity_attribute_values(self, identity_attribute_values):
        """Sets the identity_attribute_values of this TypedLinkSpecifier.
