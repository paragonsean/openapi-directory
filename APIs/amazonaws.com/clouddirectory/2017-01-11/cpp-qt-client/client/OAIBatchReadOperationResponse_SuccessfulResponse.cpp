...
OAIBatchReadSuccessfulResponse_ListObjectParents OAIBatchReadOperationResponse_SuccessfulResponse::getListObjectParents() const {
    return m_list_object_parents;
}
void OAIBatchReadOperationResponse_SuccessfulResponse::setListObjectParents(const OAIBatchReadSuccessfulResponse_ListObjectParents &list_object_parents) {
    m_list_object_parents = list_object_parents;
    m_list_object_parents_isSet = true;
}

bool OAIBatchReadOperationResponse_SuccessfulResponse::is_list_object_parents_Set() const{
    return m_list_object_parents_isSet;
}

bool OAIBatchReadOperationResponse_SuccessfulResponse::is_list_object_parents_Valid() const{
