...
QList OAIListObjectParentsResponse::getParentLinks() const {
    return m_parent_links;
}
void OAIListObjectParentsResponse::setParentLinks(const QList &parent_links) {
    m_parent_links = parent_links;
    m_parent_links_isSet = true;
}

bool OAIListObjectParentsResponse::is_parent_links_Set() const{
    return m_parent_links_isSet;
}

bool OAIListObjectParentsResponse::is_parent_links_Valid() const{
