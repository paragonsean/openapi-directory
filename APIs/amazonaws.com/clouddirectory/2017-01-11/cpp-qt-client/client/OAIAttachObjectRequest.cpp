...
#include "OAIAttachObjectRequest.h"
...
OAIAttachObjectRequest::OAIAttachObjectRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttachObjectRequest::OAIAttachObjectRequest() {
    this->initializeModel();
}

OAIAttachObjectRequest::~OAIAttachObjectRequest() {}

void OAIAttachObjectRequest::initializeModel() {
...
void OAIAttachObjectRequest::fromJson(QString jsonString) {
...
void OAIAttachObjectRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAttachObjectRequest::asJson() const {
...
QJsonObject OAIAttachObjectRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIAttachObjectRequest_ParentReference OAIAttachObjectRequest::getParentReference() const {
    return m_parent_reference;
}
void OAIAttachObjectRequest::setParentReference(const OAIAttachObjectRequest_ParentReference &parent_reference) {
    m_parent_reference = parent_reference;
    m_parent_reference_isSet = true;
}

bool OAIAttachObjectRequest::is_parent_reference_Set() const{
    return m_parent_reference_isSet;
}

bool OAIAttachObjectRequest::is_parent_reference_Valid() const{
    return m_parent_reference_isValid;
}

OAIAttachObjectRequest_ChildReference OAIAttachObjectRequest::getChildReference() const {
    return m_child_reference;
}
void OAIAttachObjectRequest::setChildReference(const OAIAttachObjectRequest_ChildReference &child_reference) {
    m_child_reference = child_reference;
    m_child_reference_isSet = true;
}

bool OAIAttachObjectRequest::is_child_reference_Set() const{
    return m_child_reference_isSet;
}

bool OAIAttachObjectRequest::is_child_reference_Valid() const{
    return m_child_reference_isValid;
}

QString OAIAttachObjectRequest::getLinkName() const {
    return m_link_name;
}
void OAIAttachObjectRequest::setLinkName(const QString &link_name) {
    m_link_name = link_name;
    m_link_name_isSet = true;
}

bool OAIAttachObjectRequest::is_link_name_Set() const{
    return m_link_name_isSet;
}

bool OAIAttachObjectRequest::is_link_name_Valid() const{
    return m_link_name_isValid;
}

bool OAIAttachObjectRequest::isSet() const {
...
bool OAIAttachObjectRequest::isValid() const {
