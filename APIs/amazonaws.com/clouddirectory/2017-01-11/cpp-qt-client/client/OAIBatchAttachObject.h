...
/*
 * OAIBatchAttachObject.h
 *
 * Represents the output of an &lt;a&gt;AttachObject&lt;/a&gt; operation.
 */

#ifndef OAIBatchAttachObject_H
#define OAIBatchAttachObject_H
...
class OAIBatchAttachObject : public OAIObject {
public:
    OAIBatchAttachObject();
    OAIBatchAttachObject(QString json);
    ~OAIBatchAttachObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchAttachObject)

#endif // OAIBatchAttachObject_H
