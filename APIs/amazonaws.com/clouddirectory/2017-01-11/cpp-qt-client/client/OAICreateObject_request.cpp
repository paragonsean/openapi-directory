...
OAICreateObject_request::OAICreateObject_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateObject_request::OAICreateObject_request() {
    this->initializeModel();
}

OAICreateObject_request::~OAICreateObject_request() {}

void OAICreateObject_request::initializeModel() {
...
void OAICreateObject_request::fromJson(QString jsonString) {
...
void OAICreateObject_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateObject_request::asJson() const {
...
QJsonObject OAICreateObject_request::asJsonObject() const {
    QJsonObject obj;
    if (m_schema_facets.size() > 0) {
...
QList<OAISchemaFacet> OAICreateObject_request::getSchemaFacets() const {
    return m_schema_facets;
}
void OAICreateObject_request::setSchemaFacets(const QList<OAISchemaFacet> &schema_facets) {
    m_schema_facets = schema_facets;
    m_schema_facets_isSet = true;
}

bool OAICreateObject_request::is_schema_facets_Set() const{
    return m_schema_facets_isSet;
}

bool OAICreateObject_request::is_schema_facets_Valid() const{
    return m_schema_facets_isValid;
}

QList<OAIAttributeKeyAndValue> OAICreateObject_request::getObjectAttributeList() const {
    return m_object_attribute_list;
}
void OAICreateObject_request::setObjectAttributeList(const QList<OAIAttributeKeyAndValue> &object_attribute_list) {
    m_object_attribute_list = object_attribute_list;
    m_object_attribute_list_isSet = true;
}

bool OAICreateObject_request::is_object_attribute_list_Set() const{
    return m_object_attribute_list_isSet;
}

bool OAICreateObject_request::is_object_attribute_list_Valid() const{
    return m_object_attribute_list_isValid;
}

OAIAddFacetToObject_request_ObjectReference OAICreateObject_request::getParentReference() const {
    return m_parent_reference;
}
void OAICreateObject_request::setParentReference(const OAIAddFacetToObject_request_ObjectReference &parent_reference) {
    m_parent_reference = parent_reference;
    m_parent_reference_isSet = true;
}

bool OAICreateObject_request::is_parent_reference_Set() const{
    return m_parent_reference_isSet;
}

bool OAICreateObject_request::is_parent_reference_Valid() const{
    return m_parent_reference_isValid;
}

QString OAICreateObject_request::getLinkName() const {
    return m_link_name;
}
void OAICreateObject_request::setLinkName(const QString &link_name) {
    m_link_name = link_name;
    m_link_name_isSet = true;
}

bool OAICreateObject_request::is_link_name_Set() const{
    return m_link_name_isSet;
}

bool OAICreateObject_request::is_link_name_Valid() const{
    return m_link_name_isValid;
}

bool OAICreateObject_request::isSet() const {
...
bool OAICreateObject_request::isValid() const {
