...
/*
 * OAIAttachObjectRequest.h
 *
 * 
 */

#ifndef OAIAttachObjectRequest_H
#define OAIAttachObjectRequest_H
...
class OAIAttachObjectRequest_ChildReference;

class OAIAttachObjectRequest : public OAIObject {
public:
    OAIAttachObjectRequest();
    OAIAttachObjectRequest(QString json);
    ~OAIAttachObjectRequest() override;
    ...
    OAIAttachObjectRequest_ChildReference getChildReference() const;
    void setChildReference(const OAIAttachObjectRequest_ChildReference &child_reference);
...
private:
    ...
    OAIAttachObjectRequest_ChildReference m_child_reference;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachObjectRequest)

#endif // OAIAttachObjectRequest_H
