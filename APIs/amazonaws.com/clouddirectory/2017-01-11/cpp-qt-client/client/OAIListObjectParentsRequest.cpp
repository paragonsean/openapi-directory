...
bool OAIListObjectParentsRequest::getIncludeAllLinksToEachParent() const {
    return m_include_all_links_to_each_parent;
}
void OAIListObjectParentsRequest::setIncludeAllLinksToEachParent(const bool &include_all_links_to_each_parent) {
    m_include_all_links_to_each_parent = include_all_links_to_each_parent;
    m_include_all_links_to_each_parent_isSet = true;
}

bool OAIListObjectParentsRequest::is_include_all_links_to_each_parent_Set() const{
    return m_include_all_links_to_each_parent_isSet;
}

bool OAIListObjectParentsRequest::is_include_all_links_to_each_parent_Valid() const{
