...
OAISchemaFacet::OAISchemaFacet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISchemaFacet::OAISchemaFacet() {
    this->initializeModel();
}

OAISchemaFacet::~OAISchemaFacet() {}

void OAISchemaFacet::initializeModel() {
...
void OAISchemaFacet::fromJson(QString jsonString) {
...
void OAISchemaFacet::fromJsonObject(QJsonObject json) {
...
QString OAISchemaFacet::asJson() const {
...
QJsonObject OAISchemaFacet::asJsonObject() const {
    QJsonObject obj;
...
QString OAISchemaFacet::getSchemaArn() const {
    return m_schema_arn;
}
void OAISchemaFacet::setSchemaArn(const QString &schema_arn) {
    m_schema_arn = schema_arn;
    m_schema_arn_isSet = true;
}

bool OAISchemaFacet::is_schema_arn_Set() const{
    return m_schema_arn_isSet;
}

bool OAISchemaFacet::is_schema_arn_Valid() const{
    return m_schema_arn_isValid;
}

QString OAISchemaFacet::getFacetName() const {
    return m_facet_name;
}
void OAISchemaFacet::setFacetName(const QString &facet_name) {
    m_facet_name = facet_name;
    m_facet_name_isSet = true;
}

bool OAISchemaFacet::is_facet_name_Set() const{
    return m_facet_name_isSet;
}

bool OAISchemaFacet::is_facet_name_Valid() const{
    return m_facet_name_isValid;
}

bool OAISchemaFacet::isSet() const {
...
bool OAISchemaFacet::isValid() const {
