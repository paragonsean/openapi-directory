...
async def list_managed_schema_arns(request: web.Request, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, max_results=None, next_token=None) -> web.Response:
    ...
    """
    body = ListManagedSchemaArnsRequest.from_dict(body)
    return web.Response(status=200)
...
async def list_object_parents(request: web.Request, x_amz_data_partition, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, x_amz_consistency_level=None, max_results=None, next_token=None) -> web.Response:
    ...
    """
    body = ListObjectParentsRequest.from_dict(body)
    return web.Response(status=200)
