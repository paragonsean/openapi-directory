...
class FacetAttributeUpdateAttribute(Model):
    ...
    def __init__(self, name: str=None, attribute_definition: FacetAttributeAttributeDefinition=None, attribute_reference: FacetAttributeAttributeReference=None, required_behavior: RequiredAttributeBehavior=None):
        """FacetAttributeUpdateAttribute - a model defined in OpenAPI

        :param name: The name of this FacetAttributeUpdateAttribute.
        :param attribute_definition: The attribute_definition of this FacetAttributeUpdateAttribute.
        :param attribute_reference: The attribute_reference of this FacetAttributeUpdateAttribute.
        :param required_behavior: The required_behavior of this FacetAttributeUpdateAttribute.
        """
        self.openapi_types = {
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FacetAttributeUpdateAttribute':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FacetAttributeUpdate_Attribute of this FacetAttributeUpdateAttribute.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this FacetAttributeUpdateAttribute.


        :return: The name of this FacetAttributeUpdateAttribute.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FacetAttributeUpdateAttribute.
    ...
    def attribute_definition(self):
        """Gets the attribute_definition of this FacetAttributeUpdateAttribute.


        :return: The attribute_definition of this FacetAttributeUpdateAttribute.
    ...
    def attribute_definition(self, attribute_definition):
        """Sets the attribute_definition of this FacetAttributeUpdateAttribute.
    ...
    def attribute_reference(self):
        """Gets the attribute_reference of this FacetAttributeUpdateAttribute.


        :return: The attribute_reference of this FacetAttributeUpdateAttribute.
    ...
    def attribute_reference(self, attribute_reference):
        """Sets the attribute_reference of this FacetAttributeUpdateAttribute.
    ...
    def required_behavior(self):
        """Gets the required_behavior of this FacetAttributeUpdateAttribute.


        :return: The required_behavior of this FacetAttributeUpdateAttribute.
    ...
    def required_behavior(self, required_behavior):
        """Sets the required_behavior of this FacetAttributeUpdateAttribute.
