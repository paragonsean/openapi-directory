...
async def test_create_facet(client):
    ...
    """
    body = {"ObjectType":"","Attributes":"","FacetStyle":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_managed_schema_arns(client):
    """Test case for list_managed_schema_arns
...
async def test_list_object_parents(client):
    ...
    """
    body = {"NextToken":"","ObjectReference":{"Selector":""},"MaxResults":"","IncludeAllLinksToEachParent":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
