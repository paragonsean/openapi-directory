...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://clouddirectory.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://clouddirectory.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-01-11/Javascript'
        };
