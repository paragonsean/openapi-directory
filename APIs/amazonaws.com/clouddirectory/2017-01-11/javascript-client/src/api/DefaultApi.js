...
export default class DefaultApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listManagedSchemaArns operation.
     * @callback module:api/DefaultApi~listManagedSchemaArnsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListManagedSchemaArnsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Lists the major version families of each managed schema. If a major version ARN is provided as SchemaArn, the minor version revisions in that family are listed instead.
     * @param {module:model/ListManagedSchemaArnsRequest} listManagedSchemaArnsRequest 
     * @param {Object} opts Optional parameters
     * @param {String} [xAmzContentSha256] 
     * @param {String} [xAmzDate] 
     * @param {String} [xAmzAlgorithm] 
     ...
     * @param {String} [maxResults] Pagination limit
     * @param {String} [nextToken] Pagination token
     * @param {module:api/DefaultApi~listManagedSchemaArnsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListManagedSchemaArnsResponse}
     */
    listManagedSchemaArns(listManagedSchemaArnsRequest, opts, callback) {
      opts = opts || {};
      let postBody = listManagedSchemaArnsRequest;
      // verify the required parameter 'listManagedSchemaArnsRequest' is set
      if (listManagedSchemaArnsRequest === undefined || listManagedSchemaArnsRequest === null) {
        throw new Error("Missing the required parameter 'listManagedSchemaArnsRequest' when calling listManagedSchemaArns");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ListManagedSchemaArnsResponse;
      return this.apiClient.callApi(
        '/amazonclouddirectory/2017-01-11/schema/managed', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} xAmzDataPartition The Amazon Resource Name (ARN) that is associated with the <a>Directory</a> where the object resides. For more information, see <a>arns</a>.
     * @param {module:model/ListObjectParentsRequest} listObjectParentsRequest 
     * @param {Object} opts Optional parameters
     * @param {String} [xAmzContentSha256] 
     * @param {String} [xAmzDate] 
     * @param {String} [xAmzAlgorithm] 
     ...
     */
    listObjectParents(xAmzDataPartition, listObjectParentsRequest, opts, callback) {
      opts = opts || {};
      let postBody = listObjectParentsRequest;
      // verify the required parameter 'xAmzDataPartition' is set
      if (xAmzDataPartition === undefined || xAmzDataPartition === null) {
      ...
      if (listObjectParentsRequest === undefined || listObjectParentsRequest === null) {
        throw new Error("Missing the required parameter 'listObjectParentsRequest' when calling listObjectParents");
      }
