...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.LinkAttributeActionAttributeUpdateValue();
  });
  ...
  describe('LinkAttributeActionAttributeUpdateValue', function() {
    it('should create an instance of LinkAttributeActionAttributeUpdateValue', function() {
      // uncomment below and update the code to test LinkAttributeActionAttributeUpdateValue
      //var instance = new AmazonCloudDirectory.LinkAttributeActionAttributeUpdateValue();
      //expect(instance).to.be.a(AmazonCloudDirectory.LinkAttributeActionAttributeUpdateValue);
    });
