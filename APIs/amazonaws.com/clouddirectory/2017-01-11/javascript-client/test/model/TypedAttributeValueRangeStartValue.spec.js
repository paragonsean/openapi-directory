...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.TypedAttributeValueRangeStartValue();
  });
  ...
  describe('TypedAttributeValueRangeStartValue', function() {
    it('should create an instance of TypedAttributeValueRangeStartValue', function() {
      // uncomment below and update the code to test TypedAttributeValueRangeStartValue
      //var instance = new AmazonCloudDirectory.TypedAttributeValueRangeStartValue();
      //expect(instance).to.be.a(AmazonCloudDirectory.TypedAttributeValueRangeStartValue);
    });
