...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.ListObjectPoliciesRequest();
  });
  ...
  describe('ListObjectPoliciesRequest', function() {
    it('should create an instance of ListObjectPoliciesRequest', function() {
      // uncomment below and update the code to test ListObjectPoliciesRequest
      //var instance = new AmazonCloudDirectory.ListObjectPoliciesRequest();
      //expect(instance).to.be.a(AmazonCloudDirectory.ListObjectPoliciesRequest);
    });
