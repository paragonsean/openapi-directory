...
(function(root, factory) {
  ...
  describe('BatchReadSuccessfulResponse', function() {
    ...
    it('should have the property listObjectParents (base name: "ListObjectParents")', function() {
      // uncomment below and update the code to test the property listObjectParents
      //var instance = new AmazonCloudDirectory.BatchReadSuccessfulResponse();
      //expect(instance).to.be();
    });
