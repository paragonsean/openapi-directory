...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.ObjectAttributeRange();
  });
  ...
  describe('ObjectAttributeRange', function() {
    it('should create an instance of ObjectAttributeRange', function() {
      // uncomment below and update the code to test ObjectAttributeRange
      //var instance = new AmazonCloudDirectory.ObjectAttributeRange();
      //expect(instance).to.be.a(AmazonCloudDirectory.ObjectAttributeRange);
    });
