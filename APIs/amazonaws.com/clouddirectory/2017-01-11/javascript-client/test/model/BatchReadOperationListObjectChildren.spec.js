...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperationListObjectChildren();
  });
  ...
  describe('BatchReadOperationListObjectChildren', function() {
    it('should create an instance of BatchReadOperationListObjectChildren', function() {
      // uncomment below and update the code to test BatchReadOperationListObjectChildren
      //var instance = new AmazonCloudDirectory.BatchReadOperationListObjectChildren();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperationListObjectChildren);
    });
