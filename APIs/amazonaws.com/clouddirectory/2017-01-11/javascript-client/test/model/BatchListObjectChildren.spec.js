...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchListObjectChildren();
  });
  ...
  describe('BatchListObjectChildren', function() {
    it('should create an instance of BatchListObjectChildren', function() {
      // uncomment below and update the code to test BatchListObjectChildren
      //var instance = new AmazonCloudDirectory.BatchListObjectChildren();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchListObjectChildren);
    });
