...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchLookupPolicy();
  });
  ...
  describe('BatchLookupPolicy', function() {
    it('should create an instance of BatchLookupPolicy', function() {
      // uncomment below and update the code to test BatchLookupPolicy
      //var instance = new AmazonCloudDirectory.BatchLookupPolicy();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchLookupPolicy);
    });
