...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperationListObjectParents();
  });
  ...
  describe('BatchReadOperationListObjectParents', function() {
    it('should create an instance of BatchReadOperationListObjectParents', function() {
      // uncomment below and update the code to test BatchReadOperationListObjectParents
      //var instance = new AmazonCloudDirectory.BatchReadOperationListObjectParents();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperationListObjectParents);
    });
