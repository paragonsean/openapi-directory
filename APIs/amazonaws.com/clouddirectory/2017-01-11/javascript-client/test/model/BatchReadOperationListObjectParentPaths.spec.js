...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperationListObjectParentPaths();
  });
  ...
  describe('BatchReadOperationListObjectParentPaths', function() {
    it('should create an instance of BatchReadOperationListObjectParentPaths', function() {
      // uncomment below and update the code to test BatchReadOperationListObjectParentPaths
      //var instance = new AmazonCloudDirectory.BatchReadOperationListObjectParentPaths();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperationListObjectParentPaths);
    });
