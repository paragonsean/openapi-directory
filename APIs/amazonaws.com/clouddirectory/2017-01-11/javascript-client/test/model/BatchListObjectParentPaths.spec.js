...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchListObjectParentPaths();
  });
  ...
  describe('BatchListObjectParentPaths', function() {
    it('should create an instance of BatchListObjectParentPaths', function() {
      // uncomment below and update the code to test BatchListObjectParentPaths
      //var instance = new AmazonCloudDirectory.BatchListObjectParentPaths();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchListObjectParentPaths);
    });
