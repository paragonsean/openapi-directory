...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperationLookupPolicy();
  });
  ...
  describe('BatchReadOperationLookupPolicy', function() {
    it('should create an instance of BatchReadOperationLookupPolicy', function() {
      // uncomment below and update the code to test BatchReadOperationLookupPolicy
      //var instance = new AmazonCloudDirectory.BatchReadOperationLookupPolicy();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperationLookupPolicy);
    });
