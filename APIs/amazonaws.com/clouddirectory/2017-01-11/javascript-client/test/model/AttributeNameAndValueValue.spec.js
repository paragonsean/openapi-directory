...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.AttributeNameAndValueValue();
  });
  ...
  describe('AttributeNameAndValueValue', function() {
    it('should create an instance of AttributeNameAndValueValue', function() {
      // uncomment below and update the code to test AttributeNameAndValueValue
      //var instance = new AmazonCloudDirectory.AttributeNameAndValueValue();
      //expect(instance).to.be.a(AmazonCloudDirectory.AttributeNameAndValueValue);
    });
