...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchWriteOperation();
  });
  ...
  describe('BatchWriteOperation', function() {
    it('should create an instance of BatchWriteOperation', function() {
      // uncomment below and update the code to test BatchWriteOperation
      //var instance = new AmazonCloudDirectory.BatchWriteOperation();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchWriteOperation);
    });
