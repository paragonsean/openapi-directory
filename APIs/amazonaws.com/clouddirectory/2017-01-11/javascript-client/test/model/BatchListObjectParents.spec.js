...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchListObjectParents();
  });
  ...
  describe('BatchListObjectParents', function() {
    it('should create an instance of BatchListObjectParents', function() {
      // uncomment below and update the code to test BatchListObjectParents
      //var instance = new AmazonCloudDirectory.BatchListObjectParents();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchListObjectParents);
    });
