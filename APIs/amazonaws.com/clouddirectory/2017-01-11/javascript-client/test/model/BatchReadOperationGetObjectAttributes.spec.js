...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudDirectory.BatchReadOperationGetObjectAttributes();
  });
  ...
  describe('BatchReadOperationGetObjectAttributes', function() {
    it('should create an instance of BatchReadOperationGetObjectAttributes', function() {
      // uncomment below and update the code to test BatchReadOperationGetObjectAttributes
      //var instance = new AmazonCloudDirectory.BatchReadOperationGetObjectAttributes();
      //expect(instance).to.be.a(AmazonCloudDirectory.BatchReadOperationGetObjectAttributes);
    });
