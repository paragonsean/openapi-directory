...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    ...
    describe('listManagedSchemaArns', function() {
      it('should call listManagedSchemaArns successfully', function(done) {
        //uncomment below and update the code to test listManagedSchemaArns
        //instance.listManagedSchemaArns(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
