...
|**schemaArn** | **String** | The response for &lt;code&gt;ListAppliedSchemaArns&lt;/code&gt; when this parameter is used will list all minor version ARNs for a major version. |  [optional] |
