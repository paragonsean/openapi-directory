...
<a id="getIceServerConfig"></a>
# **getIceServerConfig**
> GetIceServerConfigResponse getIceServerConfig(getIceServerConfigRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
|-------------|-------------|------------------|
| **200** | Success |  -  |
| **480** | InvalidClientException |  -  |
| **481** | SessionExpiredException |  -  |
| **482** | ClientLimitExceededException |  -  |
| **483** | ResourceNotFoundException |  -  |
| **484** | InvalidArgumentException |  -  |
| **485** | NotAuthorizedException |  -  |

<a id="sendAlexaOfferToMaster"></a>
# **sendAlexaOfferToMaster**
> SendAlexaOfferToMasterResponse sendAlexaOfferToMaster(sendAlexaOfferToMasterRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    SendAlexaOfferToMasterRequest sendAlexaOfferToMasterRequest = new SendAlexaOfferToMasterRequest(); // SendAlexaOfferToMasterRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      SendAlexaOfferToMasterResponse result = apiInstance.sendAlexaOfferToMaster(sendAlexaOfferToMasterRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#sendAlexaOfferToMaster");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
