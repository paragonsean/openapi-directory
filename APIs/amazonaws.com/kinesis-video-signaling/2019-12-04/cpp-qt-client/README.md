...
class Example : public QObject {
    Q_OBJECT
    OAIGetIceServerConfig_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAIGetIceServerConfig_request Example::create(){
    OAIGetIceServerConfig_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getIceServerConfigSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getIceServerConfigSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIGetIceServerConfig_request oai_get_ice_server_config_request = create(); // OAIGetIceServerConfig_request | 
      ...
      apiInstance.getIceServerConfig(oai_get_ice_server_config_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
