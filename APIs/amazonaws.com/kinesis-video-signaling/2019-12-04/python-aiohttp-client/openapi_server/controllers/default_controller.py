...
async def get_ice_server_config(request: web.Request, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    """
    body = GetIceServerConfigRequest.from_dict(body)
    return web.Response(status=200)


async def send_alexa_offer_to_master(request: web.Request, body, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    """
    body = SendAlexaOfferToMasterRequest.from_dict(body)
    return web.Response(status=200)
