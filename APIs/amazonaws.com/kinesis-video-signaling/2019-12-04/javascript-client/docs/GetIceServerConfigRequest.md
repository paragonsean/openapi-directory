# AmazonKinesisVideoSignalingChannels.GetIceServerConfigRequest
...
**service** | **String** | Specifies the desired service. Currently, &lt;code&gt;TURN&lt;/code&gt; is the only valid value. | [optional] 
