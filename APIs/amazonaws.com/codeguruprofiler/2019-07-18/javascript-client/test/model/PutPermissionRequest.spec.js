...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruProfiler.PutPermissionRequest();
  });
  ...
  describe('PutPermissionRequest', function() {
    it('should create an instance of PutPermissionRequest', function() {
      // uncomment below and update the code to test PutPermissionRequest
      //var instance = new AmazonCodeGuruProfiler.PutPermissionRequest();
      //expect(instance).to.be.a(AmazonCodeGuruProfiler.PutPermissionRequest);
    });
