...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruProfiler.RemovePermissionResponse();
  });
  ...
  describe('RemovePermissionResponse', function() {
    it('should create an instance of RemovePermissionResponse', function() {
      // uncomment below and update the code to test RemovePermissionResponse
      //var instance = new AmazonCodeGuruProfiler.RemovePermissionResponse();
      //expect(instance).to.be.a(AmazonCodeGuruProfiler.RemovePermissionResponse);
    });
