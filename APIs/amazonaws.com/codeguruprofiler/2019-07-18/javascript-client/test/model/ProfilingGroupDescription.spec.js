...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruProfiler.ProfilingGroupDescription();
  });
  ...
  describe('ProfilingGroupDescription', function() {
    it('should create an instance of ProfilingGroupDescription', function() {
      // uncomment below and update the code to test ProfilingGroupDescription
      //var instance = new AmazonCodeGuruProfiler.ProfilingGroupDescription();
      //expect(instance).to.be.a(AmazonCodeGuruProfiler.ProfilingGroupDescription);
    });
