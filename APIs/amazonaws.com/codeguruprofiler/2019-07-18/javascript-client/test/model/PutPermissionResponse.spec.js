...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruProfiler.PutPermissionResponse();
  });
  ...
  describe('PutPermissionResponse', function() {
    it('should create an instance of PutPermissionResponse', function() {
      // uncomment below and update the code to test PutPermissionResponse
      //var instance = new AmazonCodeGuruProfiler.PutPermissionResponse();
      //expect(instance).to.be.a(AmazonCodeGuruProfiler.PutPermissionResponse);
    });
