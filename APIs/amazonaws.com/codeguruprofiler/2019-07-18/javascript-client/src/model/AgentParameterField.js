...
* @readonly
*/
export default class AgentParameterField {
    ...
    /**
    * Returns a <code>AgentParameterField</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AgentParameterField} The enum <code>AgentParameterField</code> value.
    */
