...
public class ProfilingStatus {
  ...
  public ProfilingStatus latestAgentOrchestratedAt(OffsetDateTime latestAgentOrchestratedAt) {
  ...
  public ProfilingStatus latestAgentProfileReportedAt(OffsetDateTime latestAgentProfileReportedAt) {
  ...
  public ProfilingStatus latestAggregatedProfile(ProfilingStatusLatestAggregatedProfile latestAggregatedProfile) {
  ...
  public boolean equals(Object o) {
    ...
    ProfilingStatus profilingStatus = (ProfilingStatus) o;
    return Objects.equals(this.latestAgentOrchestratedAt, profilingStatus.latestAgentOrchestratedAt) &&
        Objects.equals(this.latestAgentProfileReportedAt, profilingStatus.latestAgentProfileReportedAt) &&
        Objects.equals(this.latestAggregatedProfile, profilingStatus.latestAggregatedProfile);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProfilingStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfilingStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfilingStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfilingStatus is not found in the empty JSON string", ProfilingStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfilingStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfilingStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfilingStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfilingStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfilingStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfilingStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfilingStatus>() {
           @Override
           public void write(JsonWriter out, ProfilingStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfilingStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfilingStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfilingStatus
   * @throws IOException if the JSON string is invalid with respect to ProfilingStatus
   */
  public static ProfilingStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfilingStatus.class);
  }

  /**
   * Convert an instance of ProfilingStatus to an JSON string
   *
   * @return JSON string
   */
