...
class Metric(Model):
    ...
    def __init__(self, frame_name: str=None, thread_states: List=None, type: MetricType=None):
        ...
        :param frame_name: The frame_name of this Metric.
        :param thread_states: The thread_states of this Metric.
    ...
    @property
    def frame_name(self):
        """Gets the frame_name of this Metric.


        :return: The frame_name of this Metric.
        :rtype: str
        """
    ...
    def frame_name(self, frame_name):
        """Sets the frame_name of this Metric.
    ...
    def thread_states(self):
        """Gets the thread_states of this Metric.


        :return: The thread_states of this Metric.
        :rtype: List
        """
    ...
    def thread_states(self, thread_states):
        """Sets the thread_states of this Metric.
