...
/*
 * OAIRemovePermissionResponse.h
 *
 * The structure representing the &lt;code&gt;removePermissionResponse&lt;/code&gt;.
 */

#ifndef OAIRemovePermissionResponse_H
#define OAIRemovePermissionResponse_H
...
class OAIRemovePermissionResponse : public OAIObject {
public:
    OAIRemovePermissionResponse();
    OAIRemovePermissionResponse(QString json);
    ~OAIRemovePermissionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemovePermissionResponse)

#endif // OAIRemovePermissionResponse_H
