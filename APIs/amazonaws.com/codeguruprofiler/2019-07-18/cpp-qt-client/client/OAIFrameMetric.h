...
#ifndef OAIFrameMetric_H
#define OAIFrameMetric_H
...
class OAIFrameMetric : public OAIObject {
public:
    OAIFrameMetric();
    OAIFrameMetric(QString json);
    ~OAIFrameMetric() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFrameMetric)

#endif // OAIFrameMetric_H
