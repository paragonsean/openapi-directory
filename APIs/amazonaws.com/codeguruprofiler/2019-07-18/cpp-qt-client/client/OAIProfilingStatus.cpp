...
OAIProfilingStatus::OAIProfilingStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProfilingStatus::OAIProfilingStatus() {
    this->initializeModel();
}

OAIProfilingStatus::~OAIProfilingStatus() {}

void OAIProfilingStatus::initializeModel() {
...
void OAIProfilingStatus::fromJson(QString jsonString) {
...
void OAIProfilingStatus::fromJsonObject(QJsonObject json) {
...
QString OAIProfilingStatus::asJson() const {
...
QJsonObject OAIProfilingStatus::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIProfilingStatus::getLatestAgentOrchestratedAt() const {
    return m_latest_agent_orchestrated_at;
}
void OAIProfilingStatus::setLatestAgentOrchestratedAt(const QDateTime &latest_agent_orchestrated_at) {
    m_latest_agent_orchestrated_at = latest_agent_orchestrated_at;
    m_latest_agent_orchestrated_at_isSet = true;
}

bool OAIProfilingStatus::is_latest_agent_orchestrated_at_Set() const{
    return m_latest_agent_orchestrated_at_isSet;
}

bool OAIProfilingStatus::is_latest_agent_orchestrated_at_Valid() const{
    return m_latest_agent_orchestrated_at_isValid;
}

QDateTime OAIProfilingStatus::getLatestAgentProfileReportedAt() const {
    return m_latest_agent_profile_reported_at;
}
void OAIProfilingStatus::setLatestAgentProfileReportedAt(const QDateTime &latest_agent_profile_reported_at) {
    m_latest_agent_profile_reported_at = latest_agent_profile_reported_at;
    m_latest_agent_profile_reported_at_isSet = true;
}

bool OAIProfilingStatus::is_latest_agent_profile_reported_at_Set() const{
    return m_latest_agent_profile_reported_at_isSet;
}

bool OAIProfilingStatus::is_latest_agent_profile_reported_at_Valid() const{
    return m_latest_agent_profile_reported_at_isValid;
}

OAIProfilingStatus_latestAggregatedProfile OAIProfilingStatus::getLatestAggregatedProfile() const {
    return m_latest_aggregated_profile;
}
void OAIProfilingStatus::setLatestAggregatedProfile(const OAIProfilingStatus_latestAggregatedProfile &latest_aggregated_profile) {
    m_latest_aggregated_profile = latest_aggregated_profile;
    m_latest_aggregated_profile_isSet = true;
}

bool OAIProfilingStatus::is_latest_aggregated_profile_Set() const{
    return m_latest_aggregated_profile_isSet;
}

bool OAIProfilingStatus::is_latest_aggregated_profile_Valid() const{
    return m_latest_aggregated_profile_isValid;
}

bool OAIProfilingStatus::isSet() const {
...
bool OAIProfilingStatus::isValid() const {
