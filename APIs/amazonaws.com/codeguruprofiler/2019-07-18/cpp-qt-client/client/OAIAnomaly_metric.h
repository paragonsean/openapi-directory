...
#ifndef OAIAnomaly_metric_H
#define OAIAnomaly_metric_H
...
class OAIAnomaly_metric : public OAIObject {
public:
    OAIAnomaly_metric();
    OAIAnomaly_metric(QString json);
    ~OAIAnomaly_metric() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnomaly_metric)

#endif // OAIAnomaly_metric_H
