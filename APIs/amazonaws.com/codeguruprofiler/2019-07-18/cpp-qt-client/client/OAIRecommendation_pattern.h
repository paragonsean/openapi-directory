...
/*
 * OAIRecommendation_pattern.h
 *
 * 
 */

#ifndef OAIRecommendation_pattern_H
#define OAIRecommendation_pattern_H
...
class OAIRecommendation_pattern : public OAIObject {
public:
    OAIRecommendation_pattern();
    OAIRecommendation_pattern(QString json);
    ~OAIRecommendation_pattern() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecommendation_pattern)

#endif // OAIRecommendation_pattern_H
