...
/*
 * OAIGetPolicyResponse.h
 *
 * The structure representing the &lt;code&gt;getPolicyResponse&lt;/code&gt;.
 */

#ifndef OAIGetPolicyResponse_H
#define OAIGetPolicyResponse_H
...
class OAIGetPolicyResponse : public OAIObject {
public:
    OAIGetPolicyResponse();
    OAIGetPolicyResponse(QString json);
    ~OAIGetPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyResponse)

#endif // OAIGetPolicyResponse_H
