...
/*
 * OAIUpdateProfilingGroupResponse_profilingGroup.h
 *
 * 
 */

#ifndef OAIUpdateProfilingGroupResponse_profilingGroup_H
#define OAIUpdateProfilingGroupResponse_profilingGroup_H
...
class OAIUpdateProfilingGroupResponse_profilingGroup : public OAIObject {
public:
    OAIUpdateProfilingGroupResponse_profilingGroup();
    OAIUpdateProfilingGroupResponse_profilingGroup(QString json);
    ~OAIUpdateProfilingGroupResponse_profilingGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProfilingGroupResponse_profilingGroup)

#endif // OAIUpdateProfilingGroupResponse_profilingGroup_H
