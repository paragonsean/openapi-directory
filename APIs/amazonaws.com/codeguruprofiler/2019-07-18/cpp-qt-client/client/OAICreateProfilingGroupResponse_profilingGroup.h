...
/*
 * OAICreateProfilingGroupResponse_profilingGroup.h
 *
 * 
 */

#ifndef OAICreateProfilingGroupResponse_profilingGroup_H
#define OAICreateProfilingGroupResponse_profilingGroup_H
...
class OAICreateProfilingGroupResponse_profilingGroup : public OAIObject {
public:
    OAICreateProfilingGroupResponse_profilingGroup();
    OAICreateProfilingGroupResponse_profilingGroup(QString json);
    ~OAICreateProfilingGroupResponse_profilingGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProfilingGroupResponse_profilingGroup)

#endif // OAICreateProfilingGroupResponse_profilingGroup_H
