...
public class Environments {
  ...
  public Environments items(List items) {
    this.items = items;
    return this;
  }
  ...
  public Environments nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, environments.items) &&
        Objects.equals(this.nextToken, environments.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Environments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Environments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Environments is not found in the empty JSON string", Environments.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Environments.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Environments` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Environments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Environments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Environments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Environments.class));

       return (TypeAdapter<T>) new TypeAdapter<Environments>() {
           @Override
           public void write(JsonWriter out, Environments value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Environments read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Environments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Environments
   * @throws IOException if the JSON string is invalid with respect to Environments
   */
  public static Environments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Environments.class);
  }

  /**
   * Convert an instance of Environments to an JSON string
   *
   * @return JSON string
   */
