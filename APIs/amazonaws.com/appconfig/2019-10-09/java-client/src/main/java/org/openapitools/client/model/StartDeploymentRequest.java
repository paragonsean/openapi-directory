...
public class StartDeploymentRequest {
  ...
  public StartDeploymentRequest deploymentStrategyId(String deploymentStrategyId) {
  ...
  public StartDeploymentRequest configurationProfileId(String configurationProfileId) {
  ...
  public StartDeploymentRequest configurationVersion(String configurationVersion) {
  ...
  public StartDeploymentRequest description(String description) {
  ...
  public StartDeploymentRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public StartDeploymentRequest kmsKeyIdentifier(String kmsKeyIdentifier) {
