...
public class CreateExtensionRequest {
  ...
  public CreateExtensionRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateExtensionRequest description(String description) {
  ...
  public CreateExtensionRequest actions(Map<String, List<Action>> actions) {
  ...
  public CreateExtensionRequest parameters(Map<String, Parameter> parameters) {
  ...
  public CreateExtensionRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }
