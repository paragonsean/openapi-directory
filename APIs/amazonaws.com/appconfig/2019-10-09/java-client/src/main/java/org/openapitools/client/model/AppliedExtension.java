...
public class AppliedExtension {
  ...
  public AppliedExtension extensionId(String extensionId) {
  ...
  public AppliedExtension extensionAssociationId(String extensionAssociationId) {
  ...
  public AppliedExtension versionNumber(Integer versionNumber) {
  ...
  public AppliedExtension parameters(Map parameters) {
