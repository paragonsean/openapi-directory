...
public class ExtensionAssociationSummary {
  ...
  public ExtensionAssociationSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExtensionAssociationSummary extensionArn(String extensionArn) {
  ...
  public ExtensionAssociationSummary resourceArn(String resourceArn) {
