...
public class DeploymentStrategy {
  ...
  public DeploymentStrategy id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DeploymentStrategy name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeploymentStrategy description(String description) {
  ...
  public DeploymentStrategy deploymentDurationInMinutes(Integer deploymentDurationInMinutes) {
  ...
  public DeploymentStrategy growthType(GrowthType growthType) {
  ...
  public DeploymentStrategy growthFactor(Float growthFactor) {
  ...
  public DeploymentStrategy finalBakeTimeInMinutes(Integer finalBakeTimeInMinutes) {
  ...
  public DeploymentStrategy replicateTo(ReplicateTo replicateTo) {
