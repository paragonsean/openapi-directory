...
public class ExtensionAssociation {
  ...
  public ExtensionAssociation id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExtensionAssociation extensionArn(String extensionArn) {
  ...
  public ExtensionAssociation resourceArn(String resourceArn) {
  ...
  public ExtensionAssociation arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ExtensionAssociation parameters(Map parameters) {
  ...
  public ExtensionAssociation extensionVersionNumber(Integer extensionVersionNumber) {
