...
public class UpdateDeploymentStrategyRequest {
  ...
  public UpdateDeploymentStrategyRequest description(String description) {
  ...
  public UpdateDeploymentStrategyRequest deploymentDurationInMinutes(Integer deploymentDurationInMinutes) {
  ...
  public UpdateDeploymentStrategyRequest finalBakeTimeInMinutes(Integer finalBakeTimeInMinutes) {
  ...
  public UpdateDeploymentStrategyRequest growthFactor(Float growthFactor) {
  ...
  public UpdateDeploymentStrategyRequest growthType(GrowthTypeEnum growthType) {
  ...
  public void setGrowthType(GrowthTypeEnum growthType) {
    this.growthType = growthType;
  }
