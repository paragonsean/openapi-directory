...
/*
 * OAIHostedConfigurationVersions.h
 *
 * 
 */

#ifndef OAIHostedConfigurationVersions_H
#define OAIHostedConfigurationVersions_H
...
class OAIHostedConfigurationVersions : public OAIObject {
public:
    OAIHostedConfigurationVersions();
    OAIHostedConfigurationVersions(QString json);
    ~OAIHostedConfigurationVersions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHostedConfigurationVersions)

#endif // OAIHostedConfigurationVersions_H
