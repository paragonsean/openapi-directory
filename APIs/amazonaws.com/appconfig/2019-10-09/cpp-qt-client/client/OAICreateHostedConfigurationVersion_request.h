...
/*
 * OAICreateHostedConfigurationVersion_request.h
 *
 * 
 */

#ifndef OAICreateHostedConfigurationVersion_request_H
#define OAICreateHostedConfigurationVersion_request_H
...
class OAICreateHostedConfigurationVersion_request : public OAIObject {
public:
    OAICreateHostedConfigurationVersion_request();
    OAICreateHostedConfigurationVersion_request(QString json);
    ~OAICreateHostedConfigurationVersion_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHostedConfigurationVersion_request)

#endif // OAICreateHostedConfigurationVersion_request_H
