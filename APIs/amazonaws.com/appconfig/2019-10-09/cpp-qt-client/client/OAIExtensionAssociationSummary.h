...
/*
 * OAIExtensionAssociationSummary.h
 *
...
#ifndef OAIExtensionAssociationSummary_H
#define OAIExtensionAssociationSummary_H
...
class OAIExtensionAssociationSummary : public OAIObject {
public:
    OAIExtensionAssociationSummary();
    OAIExtensionAssociationSummary(QString json);
    ~OAIExtensionAssociationSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtensionAssociationSummary)

#endif // OAIExtensionAssociationSummary_H
