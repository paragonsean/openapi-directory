...
#ifndef OAITriggeredBy_H
#define OAITriggeredBy_H
...
class OAITriggeredBy : public OAIEnum {
public:
    OAITriggeredBy();
    OAITriggeredBy(QString json);
    ~OAITriggeredBy() override;
    ...
    OAITriggeredBy::eOAITriggeredBy getValue() const;
    void setValue(const OAITriggeredBy::eOAITriggeredBy& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITriggeredBy)

#endif // OAITriggeredBy_H
