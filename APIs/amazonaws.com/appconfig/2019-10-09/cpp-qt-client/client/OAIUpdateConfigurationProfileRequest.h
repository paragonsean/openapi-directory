...
/*
 * OAIUpdateConfigurationProfileRequest.h
 *
 * 
 */

#ifndef OAIUpdateConfigurationProfileRequest_H
#define OAIUpdateConfigurationProfileRequest_H
...
class OAIUpdateConfigurationProfileRequest : public OAIObject {
public:
    OAIUpdateConfigurationProfileRequest();
    OAIUpdateConfigurationProfileRequest(QString json);
    ~OAIUpdateConfigurationProfileRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateConfigurationProfileRequest)

#endif // OAIUpdateConfigurationProfileRequest_H
