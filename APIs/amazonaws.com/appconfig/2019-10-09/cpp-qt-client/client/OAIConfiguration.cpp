...
QString OAIConfiguration::getContent() const {
    return m_content;
}
void OAIConfiguration::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIConfiguration::is_content_Set() const{
    return m_content_isSet;
}

bool OAIConfiguration::is_content_Valid() const{
