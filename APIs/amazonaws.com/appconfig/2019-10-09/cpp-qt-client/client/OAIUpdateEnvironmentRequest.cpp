...
QList OAIUpdateEnvironmentRequest::getMonitors() const {
    return m_monitors;
}
void OAIUpdateEnvironmentRequest::setMonitors(const QList &monitors) {
    m_monitors = monitors;
    m_monitors_isSet = true;
}

bool OAIUpdateEnvironmentRequest::is_monitors_Set() const{
    return m_monitors_isSet;
}

bool OAIUpdateEnvironmentRequest::is_monitors_Valid() const{
