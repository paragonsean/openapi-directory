...
/*
 * OAIExtensionAssociations.h
 *
 * 
 */

#ifndef OAIExtensionAssociations_H
#define OAIExtensionAssociations_H
...
class OAIExtensionAssociations : public OAIObject {
public:
    OAIExtensionAssociations();
    OAIExtensionAssociations(QString json);
    ~OAIExtensionAssociations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtensionAssociations)

#endif // OAIExtensionAssociations_H
