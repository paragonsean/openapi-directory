...
/*
 * OAIAppliedExtension.h
 *
 * An extension that was invoked during a deployment.
 */

#ifndef OAIAppliedExtension_H
#define OAIAppliedExtension_H
...
class OAIAppliedExtension : public OAIObject {
public:
    OAIAppliedExtension();
    OAIAppliedExtension(QString json);
    ~OAIAppliedExtension() override;
    ...
    QString getExtensionId() const;
    void setExtensionId(const QString &extension_id);
    bool is_extension_id_Set() const;
    bool is_extension_id_Valid() const;

    QString getExtensionAssociationId() const;
    void setExtensionAssociationId(const QString &extension_association_id);
    bool is_extension_association_id_Set() const;
    bool is_extension_association_id_Valid() const;
...
private:
    ...
    QString m_extension_id;
    bool m_extension_id_isSet;
    bool m_extension_id_isValid;

    QString m_extension_association_id;
    bool m_extension_association_id_isSet;
    bool m_extension_association_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppliedExtension)

#endif // OAIAppliedExtension_H
