...
/*
 * OAICreateExtensionRequest.h
 *
 * 
 */

#ifndef OAICreateExtensionRequest_H
#define OAICreateExtensionRequest_H
...
class OAICreateExtensionRequest : public OAIObject {
public:
    OAICreateExtensionRequest();
    OAICreateExtensionRequest(QString json);
    ~OAICreateExtensionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExtensionRequest)

#endif // OAICreateExtensionRequest_H
