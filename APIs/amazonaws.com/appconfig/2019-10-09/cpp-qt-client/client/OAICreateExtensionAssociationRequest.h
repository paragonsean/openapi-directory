...
/*
 * OAICreateExtensionAssociationRequest.h
 *
 * 
 */

#ifndef OAICreateExtensionAssociationRequest_H
#define OAICreateExtensionAssociationRequest_H
...
class OAICreateExtensionAssociationRequest : public OAIObject {
public:
    OAICreateExtensionAssociationRequest();
    OAICreateExtensionAssociationRequest(QString json);
    ~OAICreateExtensionAssociationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExtensionAssociationRequest)

#endif // OAICreateExtensionAssociationRequest_H
