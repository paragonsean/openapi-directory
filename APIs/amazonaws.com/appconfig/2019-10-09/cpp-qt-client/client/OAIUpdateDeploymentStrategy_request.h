...
/*
 * OAIUpdateDeploymentStrategy_request.h
 *
 * 
 */

#ifndef OAIUpdateDeploymentStrategy_request_H
#define OAIUpdateDeploymentStrategy_request_H
...
class OAIUpdateDeploymentStrategy_request : public OAIObject {
public:
    OAIUpdateDeploymentStrategy_request();
    OAIUpdateDeploymentStrategy_request(QString json);
    ~OAIUpdateDeploymentStrategy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDeploymentStrategy_request)

#endif // OAIUpdateDeploymentStrategy_request_H
