...
void OAIEnvironmentState::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("READY_FOR_DEPLOYMENT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEnvironmentState::READY_FOR_DEPLOYMENT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DEPLOYING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEnvironmentState::DEPLOYING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ROLLING_BACK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEnvironmentState::ROLLING_BACK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ROLLED_BACK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEnvironmentState::ROLLED_BACK;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIEnvironmentState::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIEnvironmentState::READY_FOR_DEPLOYMENT:
            val = "READY_FOR_DEPLOYMENT";
            break;
        case eOAIEnvironmentState::DEPLOYING:
            val = "DEPLOYING";
            break;
        case eOAIEnvironmentState::ROLLING_BACK:
            val = "ROLLING_BACK";
            break;
        case eOAIEnvironmentState::ROLLED_BACK:
            val = "ROLLED_BACK";
            break;
        default:
            break;
