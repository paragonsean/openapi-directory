...
#ifndef OAIGrowthType_H
#define OAIGrowthType_H
...
class OAIGrowthType : public OAIEnum {
public:
    OAIGrowthType();
    OAIGrowthType(QString json);
    ~OAIGrowthType() override;
    ...
    enum class eOAIGrowthType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LINEAR, 
        EXPONENTIAL
    };
    OAIGrowthType::eOAIGrowthType getValue() const;
    void setValue(const OAIGrowthType::eOAIGrowthType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrowthType)

#endif // OAIGrowthType_H
