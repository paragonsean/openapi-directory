...
/*
 * OAICreateConfigurationProfileRequest.h
 *
 * 
 */

#ifndef OAICreateConfigurationProfileRequest_H
#define OAICreateConfigurationProfileRequest_H
...
class OAICreateConfigurationProfileRequest : public OAIObject {
public:
    OAICreateConfigurationProfileRequest();
    OAICreateConfigurationProfileRequest(QString json);
    ~OAICreateConfigurationProfileRequest() override;
    ...
    QList getValidators() const;
    void setValidators(const QList &validators);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConfigurationProfileRequest)

#endif // OAICreateConfigurationProfileRequest_H
