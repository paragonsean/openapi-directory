...
/*
 * OAICreateDeploymentStrategyRequest.h
 *
 * 
 */

#ifndef OAICreateDeploymentStrategyRequest_H
#define OAICreateDeploymentStrategyRequest_H
...
class OAICreateDeploymentStrategyRequest : public OAIObject {
public:
    OAICreateDeploymentStrategyRequest();
    OAICreateDeploymentStrategyRequest(QString json);
    ~OAICreateDeploymentStrategyRequest() override;
    ...
    OAIReplicateTo getReplicateTo() const;
    void setReplicateTo(const OAIReplicateTo &replicate_to);
    bool is_replicate_to_Set() const;
    bool is_replicate_to_Valid() const;
...
private:
    ...
    OAIReplicateTo m_replicate_to;
    bool m_replicate_to_isSet;
    bool m_replicate_to_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDeploymentStrategyRequest)

#endif // OAICreateDeploymentStrategyRequest_H
