...
OAIDeploymentStrategies::OAIDeploymentStrategies(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeploymentStrategies::OAIDeploymentStrategies() {
    this->initializeModel();
}

OAIDeploymentStrategies::~OAIDeploymentStrategies() {}

void OAIDeploymentStrategies::initializeModel() {
...
void OAIDeploymentStrategies::fromJson(QString jsonString) {
...
void OAIDeploymentStrategies::fromJsonObject(QJsonObject json) {
...
QString OAIDeploymentStrategies::asJson() const {
...
QJsonObject OAIDeploymentStrategies::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIDeploymentStrategies::getItems() const {
    return m_items;
}
void OAIDeploymentStrategies::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIDeploymentStrategies::is_items_Set() const{
    return m_items_isSet;
}

bool OAIDeploymentStrategies::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIDeploymentStrategies::getNextToken() const {
    return m_next_token;
}
void OAIDeploymentStrategies::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDeploymentStrategies::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDeploymentStrategies::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDeploymentStrategies::isSet() const {
...
bool OAIDeploymentStrategies::isValid() const {
