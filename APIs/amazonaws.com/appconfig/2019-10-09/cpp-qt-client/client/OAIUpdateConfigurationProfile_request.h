...
/*
 * OAIUpdateConfigurationProfile_request.h
 *
 * 
 */

#ifndef OAIUpdateConfigurationProfile_request_H
#define OAIUpdateConfigurationProfile_request_H
...
class OAIUpdateConfigurationProfile_request : public OAIObject {
public:
    OAIUpdateConfigurationProfile_request();
    OAIUpdateConfigurationProfile_request(QString json);
    ~OAIUpdateConfigurationProfile_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateConfigurationProfile_request)

#endif // OAIUpdateConfigurationProfile_request_H
