...
QString OAIDeployments::getNextToken() const {
    return m_next_token;
}
void OAIDeployments::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDeployments::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDeployments::is_next_token_Valid() const{
