...
OAITriggeredBy::OAITriggeredBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITriggeredBy::OAITriggeredBy() {
    this->initializeModel();
}

OAITriggeredBy::~OAITriggeredBy() {}

void OAITriggeredBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITriggeredBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITriggeredBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("USER", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggeredBy::USER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("APPCONFIG", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggeredBy::APPCONFIG;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CLOUDWATCH_ALARM", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggeredBy::CLOUDWATCH_ALARM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INTERNAL_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAITriggeredBy::INTERNAL_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITriggeredBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITriggeredBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITriggeredBy::USER:
            val = "USER";
            break;
        case eOAITriggeredBy::APPCONFIG:
            val = "APPCONFIG";
            break;
        case eOAITriggeredBy::CLOUDWATCH_ALARM:
            val = "CLOUDWATCH_ALARM";
            break;
        case eOAITriggeredBy::INTERNAL_ERROR:
            val = "INTERNAL_ERROR";
            break;
        default:
            break;
...
QJsonValue OAITriggeredBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITriggeredBy::eOAITriggeredBy OAITriggeredBy::getValue() const {
    return m_value;
}

void OAITriggeredBy::setValue(const OAITriggeredBy::eOAITriggeredBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITriggeredBy::isSet() const {
    
    return m_value_isSet;
}

bool OAITriggeredBy::isValid() const {
