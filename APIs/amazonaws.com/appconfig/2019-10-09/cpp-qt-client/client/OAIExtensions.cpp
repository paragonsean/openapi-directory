...
QList OAIExtensions::getItems() const {
    return m_items;
}
void OAIExtensions::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIExtensions::is_items_Set() const{
    return m_items_isSet;
}

bool OAIExtensions::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIExtensions::getNextToken() const {
    return m_next_token;
}
void OAIExtensions::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIExtensions::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIExtensions::is_next_token_Valid() const{
