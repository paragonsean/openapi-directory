...
/*
 * OAICreateDeploymentStrategy_request.h
 *
 * 
 */

#ifndef OAICreateDeploymentStrategy_request_H
#define OAICreateDeploymentStrategy_request_H
...
class OAICreateDeploymentStrategy_request : public OAIObject {
public:
    OAICreateDeploymentStrategy_request();
    OAICreateDeploymentStrategy_request(QString json);
    ~OAICreateDeploymentStrategy_request() override;
    ...
    QString getGrowthType() const;
    void setGrowthType(const QString &growth_type);
    bool is_growth_type_Set() const;
    bool is_growth_type_Valid() const;

    QString getReplicateTo() const;
    void setReplicateTo(const QString &replicate_to);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDeploymentStrategy_request)

#endif // OAICreateDeploymentStrategy_request_H
