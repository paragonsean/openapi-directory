...
#include "OAICreateHostedConfigurationVersionRequest.h"
...
OAICreateHostedConfigurationVersionRequest::OAICreateHostedConfigurationVersionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateHostedConfigurationVersionRequest::OAICreateHostedConfigurationVersionRequest() {
    this->initializeModel();
}

OAICreateHostedConfigurationVersionRequest::~OAICreateHostedConfigurationVersionRequest() {}

void OAICreateHostedConfigurationVersionRequest::initializeModel() {

    m_content_isSet = false;
    m_content_isValid = false;
}

void OAICreateHostedConfigurationVersionRequest::fromJson(QString jsonString) {
...
void OAICreateHostedConfigurationVersionRequest::fromJsonObject(QJsonObject json) {

    m_content_isValid = ::OpenAPI::fromJsonValue(m_content, json[QString("Content")]);
    m_content_isSet = !json[QString("Content")].isNull() && m_content_isValid;
}

QString OAICreateHostedConfigurationVersionRequest::asJson() const {
...
QJsonObject OAICreateHostedConfigurationVersionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_content_isSet) {
...
QString OAICreateHostedConfigurationVersionRequest::getContent() const {
    return m_content;
}
void OAICreateHostedConfigurationVersionRequest::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAICreateHostedConfigurationVersionRequest::is_content_Set() const{
    return m_content_isSet;
}

bool OAICreateHostedConfigurationVersionRequest::is_content_Valid() const{
    return m_content_isValid;
}

bool OAICreateHostedConfigurationVersionRequest::isSet() const {
...
bool OAICreateHostedConfigurationVersionRequest::isValid() const {
