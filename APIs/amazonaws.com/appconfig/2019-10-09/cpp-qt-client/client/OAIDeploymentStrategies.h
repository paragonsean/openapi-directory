...
/*
 * OAIDeploymentStrategies.h
 *
 * 
 */

#ifndef OAIDeploymentStrategies_H
#define OAIDeploymentStrategies_H
...
class OAIDeploymentStrategies : public OAIObject {
public:
    OAIDeploymentStrategies();
    OAIDeploymentStrategies(QString json);
    ~OAIDeploymentStrategies() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentStrategies)

#endif // OAIDeploymentStrategies_H
