...
QList OAIApplications::getItems() const {
    return m_items;
}
void OAIApplications::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIApplications::is_items_Set() const{
    return m_items_isSet;
}

bool OAIApplications::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIApplications::getNextToken() const {
    return m_next_token;
}
void OAIApplications::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIApplications::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIApplications::is_next_token_Valid() const{
