...
/*
 * OAIDeploymentEventType.h
 *
 * 
 */

#ifndef OAIDeploymentEventType_H
#define OAIDeploymentEventType_H
...
class OAIDeploymentEventType : public OAIEnum {
public:
    OAIDeploymentEventType();
    OAIDeploymentEventType(QString json);
    ~OAIDeploymentEventType() override;
    ...
    enum class eOAIDeploymentEventType {
    ...
    OAIDeploymentEventType::eOAIDeploymentEventType getValue() const;
    void setValue(const OAIDeploymentEventType::eOAIDeploymentEventType& value);
...
private:
    ...
    eOAIDeploymentEventType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentEventType)

#endif // OAIDeploymentEventType_H
