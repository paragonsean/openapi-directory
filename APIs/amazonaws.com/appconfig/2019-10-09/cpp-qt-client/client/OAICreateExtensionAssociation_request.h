...
/*
 * OAICreateExtensionAssociation_request.h
 *
 * 
 */

#ifndef OAICreateExtensionAssociation_request_H
#define OAICreateExtensionAssociation_request_H
...
class OAICreateExtensionAssociation_request : public OAIObject {
public:
    OAICreateExtensionAssociation_request();
    OAICreateExtensionAssociation_request(QString json);
    ~OAICreateExtensionAssociation_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExtensionAssociation_request)

#endif // OAICreateExtensionAssociation_request_H
