...
/*
 * OAIUpdateExtensionAssociation_request.h
 *
 * 
 */

#ifndef OAIUpdateExtensionAssociation_request_H
#define OAIUpdateExtensionAssociation_request_H
...
class OAIUpdateExtensionAssociation_request : public OAIObject {
public:
    OAIUpdateExtensionAssociation_request();
    OAIUpdateExtensionAssociation_request(QString json);
    ~OAIUpdateExtensionAssociation_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExtensionAssociation_request)

#endif // OAIUpdateExtensionAssociation_request_H
