...
OAIEnvironments::OAIEnvironments(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnvironments::OAIEnvironments() {
    this->initializeModel();
}

OAIEnvironments::~OAIEnvironments() {}

void OAIEnvironments::initializeModel() {
...
void OAIEnvironments::fromJson(QString jsonString) {
...
void OAIEnvironments::fromJsonObject(QJsonObject json) {
...
QString OAIEnvironments::asJson() const {
...
QJsonObject OAIEnvironments::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIEnvironments::getItems() const {
    return m_items;
}
void OAIEnvironments::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIEnvironments::is_items_Set() const{
    return m_items_isSet;
}

bool OAIEnvironments::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIEnvironments::getNextToken() const {
    return m_next_token;
}
void OAIEnvironments::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIEnvironments::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIEnvironments::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIEnvironments::isSet() const {
...
bool OAIEnvironments::isValid() const {
