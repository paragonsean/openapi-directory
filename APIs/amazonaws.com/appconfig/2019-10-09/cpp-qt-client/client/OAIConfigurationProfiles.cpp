...
OAIConfigurationProfiles::OAIConfigurationProfiles(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfigurationProfiles::OAIConfigurationProfiles() {
    this->initializeModel();
}

OAIConfigurationProfiles::~OAIConfigurationProfiles() {}

void OAIConfigurationProfiles::initializeModel() {
...
void OAIConfigurationProfiles::fromJson(QString jsonString) {
...
void OAIConfigurationProfiles::fromJsonObject(QJsonObject json) {
...
QString OAIConfigurationProfiles::asJson() const {
...
QJsonObject OAIConfigurationProfiles::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIConfigurationProfiles::getItems() const {
    return m_items;
}
void OAIConfigurationProfiles::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIConfigurationProfiles::is_items_Set() const{
    return m_items_isSet;
}

bool OAIConfigurationProfiles::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIConfigurationProfiles::getNextToken() const {
    return m_next_token;
}
void OAIConfigurationProfiles::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIConfigurationProfiles::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIConfigurationProfiles::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIConfigurationProfiles::isSet() const {
...
bool OAIConfigurationProfiles::isValid() const {
