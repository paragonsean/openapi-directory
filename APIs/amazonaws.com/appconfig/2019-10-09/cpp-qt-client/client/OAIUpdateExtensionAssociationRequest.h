...
/*
 * OAIUpdateExtensionAssociationRequest.h
 *
 * 
 */

#ifndef OAIUpdateExtensionAssociationRequest_H
#define OAIUpdateExtensionAssociationRequest_H
...
class OAIUpdateExtensionAssociationRequest : public OAIObject {
public:
    OAIUpdateExtensionAssociationRequest();
    OAIUpdateExtensionAssociationRequest(QString json);
    ~OAIUpdateExtensionAssociationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExtensionAssociationRequest)

#endif // OAIUpdateExtensionAssociationRequest_H
