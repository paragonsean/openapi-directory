...
OAIValidatorType OAIValidator::getType() const {
    return m_type;
}
void OAIValidator::setType(const OAIValidatorType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIValidator::is_type_Set() const{
    return m_type_isSet;
}

bool OAIValidator::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIValidator::getContent() const {
    return m_content;
}
void OAIValidator::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIValidator::is_content_Set() const{
    return m_content_isSet;
}

bool OAIValidator::is_content_Valid() const{
