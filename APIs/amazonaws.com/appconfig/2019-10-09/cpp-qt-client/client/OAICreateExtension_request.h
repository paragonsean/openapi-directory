...
/*
 * OAICreateExtension_request.h
 *
 * 
 */

#ifndef OAICreateExtension_request_H
#define OAICreateExtension_request_H
...
class OAICreateExtension_request : public OAIObject {
public:
    OAICreateExtension_request();
    OAICreateExtension_request(QString json);
    ~OAICreateExtension_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExtension_request)

#endif // OAICreateExtension_request_H
