...
/*
 * OAIConfigurationProfileSummary.h
 *
 * A summary of a configuration profile.
 */

#ifndef OAIConfigurationProfileSummary_H
#define OAIConfigurationProfileSummary_H
...
class OAIConfigurationProfileSummary : public OAIObject {
public:
    OAIConfigurationProfileSummary();
    OAIConfigurationProfileSummary(QString json);
    ~OAIConfigurationProfileSummary() override;
    ...
    QList getValidatorTypes() const;
    void setValidatorTypes(const QList &validator_types);
    bool is_validator_types_Set() const;
    bool is_validator_types_Valid() const;
...
private:
    ...
    QList m_validator_types;
    bool m_validator_types_isSet;
    bool m_validator_types_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationProfileSummary)

#endif // OAIConfigurationProfileSummary_H
