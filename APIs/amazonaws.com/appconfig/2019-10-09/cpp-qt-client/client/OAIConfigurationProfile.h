...
/*
 * OAIConfigurationProfile.h
 *
 * 
 */

#ifndef OAIConfigurationProfile_H
#define OAIConfigurationProfile_H
...
class OAIConfigurationProfile : public OAIObject {
public:
    OAIConfigurationProfile();
    OAIConfigurationProfile(QString json);
    ~OAIConfigurationProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationProfile)

#endif // OAIConfigurationProfile_H
