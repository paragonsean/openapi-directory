...
/*
 * OAIStartDeployment_request.h
 *
 * 
 */

#ifndef OAIStartDeployment_request_H
#define OAIStartDeployment_request_H
...
class OAIStartDeployment_request : public OAIObject {
public:
    OAIStartDeployment_request();
    OAIStartDeployment_request(QString json);
    ~OAIStartDeployment_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartDeployment_request)

#endif // OAIStartDeployment_request_H
