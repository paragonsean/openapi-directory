...
/*
 * OAIUpdateDeploymentStrategyRequest.h
 *
 * 
 */

#ifndef OAIUpdateDeploymentStrategyRequest_H
#define OAIUpdateDeploymentStrategyRequest_H
...
class OAIUpdateDeploymentStrategyRequest : public OAIObject {
public:
    OAIUpdateDeploymentStrategyRequest();
    OAIUpdateDeploymentStrategyRequest(QString json);
    ~OAIUpdateDeploymentStrategyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDeploymentStrategyRequest)

#endif // OAIUpdateDeploymentStrategyRequest_H
