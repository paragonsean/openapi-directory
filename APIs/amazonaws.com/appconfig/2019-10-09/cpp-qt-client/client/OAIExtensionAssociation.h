...
/*
 * OAIExtensionAssociation.h
 *
 * 
 */

#ifndef OAIExtensionAssociation_H
#define OAIExtensionAssociation_H
...
class OAIExtensionAssociation : public OAIObject {
public:
    OAIExtensionAssociation();
    OAIExtensionAssociation(QString json);
    ~OAIExtensionAssociation() override;
    ...
    QString getExtensionArn() const;
    void setExtensionArn(const QString &extension_arn);
    bool is_extension_arn_Set() const;
    bool is_extension_arn_Valid() const;
    ...
    qint32 getExtensionVersionNumber() const;
    void setExtensionVersionNumber(const qint32 &extension_version_number);
    bool is_extension_version_number_Set() const;
    bool is_extension_version_number_Valid() const;
...
private:
    ...
    QString m_extension_arn;
    bool m_extension_arn_isSet;
    bool m_extension_arn_isValid;
    ...
    qint32 m_extension_version_number;
    bool m_extension_version_number_isSet;
    bool m_extension_version_number_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIExtensionAssociation)

#endif // OAIExtensionAssociation_H
