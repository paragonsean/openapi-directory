...
/*
 * OAIDeploymentStrategy.h
 *
 * 
 */

#ifndef OAIDeploymentStrategy_H
#define OAIDeploymentStrategy_H
...
class OAIDeploymentStrategy : public OAIObject {
public:
    OAIDeploymentStrategy();
    OAIDeploymentStrategy(QString json);
    ~OAIDeploymentStrategy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentStrategy)

#endif // OAIDeploymentStrategy_H
