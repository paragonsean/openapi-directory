...
#ifndef OAIEnvironments_H
#define OAIEnvironments_H
...
class OAIEnvironments : public OAIObject {
public:
    OAIEnvironments();
    OAIEnvironments(QString json);
    ~OAIEnvironments() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironments)

#endif // OAIEnvironments_H
