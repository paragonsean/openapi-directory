...
QList OAICreateEnvironmentRequest::getMonitors() const {
    return m_monitors;
}
void OAICreateEnvironmentRequest::setMonitors(const QList &monitors) {
    m_monitors = monitors;
    m_monitors_isSet = true;
}

bool OAICreateEnvironmentRequest::is_monitors_Set() const{
    return m_monitors_isSet;
}

bool OAICreateEnvironmentRequest::is_monitors_Valid() const{
