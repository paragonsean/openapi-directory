...
OAIHostedConfigurationVersion::OAIHostedConfigurationVersion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHostedConfigurationVersion::OAIHostedConfigurationVersion() {
    this->initializeModel();
}

OAIHostedConfigurationVersion::~OAIHostedConfigurationVersion() {}

void OAIHostedConfigurationVersion::initializeModel() {

    m_content_isSet = false;
    m_content_isValid = false;
}

void OAIHostedConfigurationVersion::fromJson(QString jsonString) {
...
void OAIHostedConfigurationVersion::fromJsonObject(QJsonObject json) {

    m_content_isValid = ::OpenAPI::fromJsonValue(m_content, json[QString("Content")]);
    m_content_isSet = !json[QString("Content")].isNull() && m_content_isValid;
}

QString OAIHostedConfigurationVersion::asJson() const {
...
QJsonObject OAIHostedConfigurationVersion::asJsonObject() const {
    QJsonObject obj;
    if (m_content_isSet) {
...
QString OAIHostedConfigurationVersion::getContent() const {
    return m_content;
}
void OAIHostedConfigurationVersion::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIHostedConfigurationVersion::is_content_Set() const{
    return m_content_isSet;
}

bool OAIHostedConfigurationVersion::is_content_Valid() const{
    return m_content_isValid;
}

bool OAIHostedConfigurationVersion::isSet() const {
...
bool OAIHostedConfigurationVersion::isValid() const {
