...
/*
 * OAIHostedConfigurationVersion.h
 *
 * 
 */

#ifndef OAIHostedConfigurationVersion_H
#define OAIHostedConfigurationVersion_H
...
class OAIHostedConfigurationVersion : public OAIObject {
public:
    OAIHostedConfigurationVersion();
    OAIHostedConfigurationVersion(QString json);
    ~OAIHostedConfigurationVersion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHostedConfigurationVersion)

#endif // OAIHostedConfigurationVersion_H
