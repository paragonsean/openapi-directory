...
#ifndef OAIValidatorType_H
#define OAIValidatorType_H
...
class OAIValidatorType : public OAIEnum {
public:
    OAIValidatorType();
    OAIValidatorType(QString json);
    ~OAIValidatorType() override;
    ...
    enum class eOAIValidatorType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        JSON_SCHEMA, 
        LAMBDA
    };
    OAIValidatorType::eOAIValidatorType getValue() const;
    void setValue(const OAIValidatorType::eOAIValidatorType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidatorType)

#endif // OAIValidatorType_H
