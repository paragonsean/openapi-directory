...
OAICreateHostedConfigurationVersion_request::OAICreateHostedConfigurationVersion_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateHostedConfigurationVersion_request::OAICreateHostedConfigurationVersion_request() {
    this->initializeModel();
}

OAICreateHostedConfigurationVersion_request::~OAICreateHostedConfigurationVersion_request() {}

void OAICreateHostedConfigurationVersion_request::initializeModel() {

    m_content_isSet = false;
    m_content_isValid = false;
}

void OAICreateHostedConfigurationVersion_request::fromJson(QString jsonString) {
...
void OAICreateHostedConfigurationVersion_request::fromJsonObject(QJsonObject json) {

    m_content_isValid = ::OpenAPI::fromJsonValue(m_content, json[QString("Content")]);
    m_content_isSet = !json[QString("Content")].isNull() && m_content_isValid;
}

QString OAICreateHostedConfigurationVersion_request::asJson() const {
...
QJsonObject OAICreateHostedConfigurationVersion_request::asJsonObject() const {
    QJsonObject obj;
    if (m_content_isSet) {
...
QString OAICreateHostedConfigurationVersion_request::getContent() const {
    return m_content;
}
void OAICreateHostedConfigurationVersion_request::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAICreateHostedConfigurationVersion_request::is_content_Set() const{
    return m_content_isSet;
}

bool OAICreateHostedConfigurationVersion_request::is_content_Valid() const{
    return m_content_isValid;
}

bool OAICreateHostedConfigurationVersion_request::isSet() const {
...
bool OAICreateHostedConfigurationVersion_request::isValid() const {
