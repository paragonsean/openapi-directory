...
QList<OAIMonitor> OAICreateEnvironment_request::getMonitors() const {
    return m_monitors;
}
void OAICreateEnvironment_request::setMonitors(const QList<OAIMonitor> &monitors) {
    m_monitors = monitors;
    m_monitors_isSet = true;
}

bool OAICreateEnvironment_request::is_monitors_Set() const{
    return m_monitors_isSet;
}

bool OAICreateEnvironment_request::is_monitors_Valid() const{
