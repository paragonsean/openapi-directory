...
OAIHostedConfigurationVersions::OAIHostedConfigurationVersions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHostedConfigurationVersions::OAIHostedConfigurationVersions() {
    this->initializeModel();
}

OAIHostedConfigurationVersions::~OAIHostedConfigurationVersions() {}

void OAIHostedConfigurationVersions::initializeModel() {
...
void OAIHostedConfigurationVersions::fromJson(QString jsonString) {
...
void OAIHostedConfigurationVersions::fromJsonObject(QJsonObject json) {
...
QString OAIHostedConfigurationVersions::asJson() const {
...
QJsonObject OAIHostedConfigurationVersions::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIHostedConfigurationVersions::getItems() const {
    return m_items;
}
void OAIHostedConfigurationVersions::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIHostedConfigurationVersions::is_items_Set() const{
    return m_items_isSet;
}

bool OAIHostedConfigurationVersions::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIHostedConfigurationVersions::getNextToken() const {
    return m_next_token;
}
void OAIHostedConfigurationVersions::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIHostedConfigurationVersions::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIHostedConfigurationVersions::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIHostedConfigurationVersions::isSet() const {
...
bool OAIHostedConfigurationVersions::isValid() const {
