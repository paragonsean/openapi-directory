...
/*
 * OAIConfigurationProfiles.h
 *
 * 
 */

#ifndef OAIConfigurationProfiles_H
#define OAIConfigurationProfiles_H
...
class OAIConfigurationProfiles : public OAIObject {
public:
    OAIConfigurationProfiles();
    OAIConfigurationProfiles(QString json);
    ~OAIConfigurationProfiles() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationProfiles)

#endif // OAIConfigurationProfiles_H
