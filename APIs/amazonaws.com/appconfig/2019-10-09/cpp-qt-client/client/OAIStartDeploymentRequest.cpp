...
OAIStartDeploymentRequest::OAIStartDeploymentRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartDeploymentRequest::OAIStartDeploymentRequest() {
    this->initializeModel();
}

OAIStartDeploymentRequest::~OAIStartDeploymentRequest() {}

void OAIStartDeploymentRequest::initializeModel() {
...
void OAIStartDeploymentRequest::fromJson(QString jsonString) {
...
void OAIStartDeploymentRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartDeploymentRequest::asJson() const {
...
QJsonObject OAIStartDeploymentRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartDeploymentRequest::getDeploymentStrategyId() const {
    return m_deployment_strategy_id;
}
void OAIStartDeploymentRequest::setDeploymentStrategyId(const QString &deployment_strategy_id) {
    m_deployment_strategy_id = deployment_strategy_id;
    m_deployment_strategy_id_isSet = true;
}

bool OAIStartDeploymentRequest::is_deployment_strategy_id_Set() const{
    return m_deployment_strategy_id_isSet;
}

bool OAIStartDeploymentRequest::is_deployment_strategy_id_Valid() const{
    return m_deployment_strategy_id_isValid;
}

QString OAIStartDeploymentRequest::getConfigurationProfileId() const {
    return m_configuration_profile_id;
}
void OAIStartDeploymentRequest::setConfigurationProfileId(const QString &configuration_profile_id) {
    m_configuration_profile_id = configuration_profile_id;
    m_configuration_profile_id_isSet = true;
}

bool OAIStartDeploymentRequest::is_configuration_profile_id_Set() const{
    return m_configuration_profile_id_isSet;
}

bool OAIStartDeploymentRequest::is_configuration_profile_id_Valid() const{
    return m_configuration_profile_id_isValid;
}

QString OAIStartDeploymentRequest::getConfigurationVersion() const {
    return m_configuration_version;
}
void OAIStartDeploymentRequest::setConfigurationVersion(const QString &configuration_version) {
    m_configuration_version = configuration_version;
    m_configuration_version_isSet = true;
}

bool OAIStartDeploymentRequest::is_configuration_version_Set() const{
    return m_configuration_version_isSet;
}

bool OAIStartDeploymentRequest::is_configuration_version_Valid() const{
    return m_configuration_version_isValid;
}

QString OAIStartDeploymentRequest::getDescription() const {
    return m_description;
}
void OAIStartDeploymentRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIStartDeploymentRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIStartDeploymentRequest::is_description_Valid() const{
    return m_description_isValid;
}

QMap OAIStartDeploymentRequest::getTags() const {
    return m_tags;
}
void OAIStartDeploymentRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIStartDeploymentRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIStartDeploymentRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIStartDeploymentRequest::getKmsKeyIdentifier() const {
    return m_kms_key_identifier;
}
void OAIStartDeploymentRequest::setKmsKeyIdentifier(const QString &kms_key_identifier) {
    m_kms_key_identifier = kms_key_identifier;
    m_kms_key_identifier_isSet = true;
}

bool OAIStartDeploymentRequest::is_kms_key_identifier_Set() const{
    return m_kms_key_identifier_isSet;
}

bool OAIStartDeploymentRequest::is_kms_key_identifier_Valid() const{
    return m_kms_key_identifier_isValid;
}

bool OAIStartDeploymentRequest::isSet() const {
...
bool OAIStartDeploymentRequest::isValid() const {
