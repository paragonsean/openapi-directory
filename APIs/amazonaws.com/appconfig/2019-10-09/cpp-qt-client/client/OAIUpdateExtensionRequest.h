...
/*
 * OAIUpdateExtensionRequest.h
 *
 * 
 */

#ifndef OAIUpdateExtensionRequest_H
#define OAIUpdateExtensionRequest_H
...
class OAIUpdateExtensionRequest : public OAIObject {
public:
    OAIUpdateExtensionRequest();
    OAIUpdateExtensionRequest(QString json);
    ~OAIUpdateExtensionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExtensionRequest)

#endif // OAIUpdateExtensionRequest_H
