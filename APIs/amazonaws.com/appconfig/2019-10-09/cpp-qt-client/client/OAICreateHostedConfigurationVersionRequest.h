...
/*
 * OAICreateHostedConfigurationVersionRequest.h
 *
 * 
 */

#ifndef OAICreateHostedConfigurationVersionRequest_H
#define OAICreateHostedConfigurationVersionRequest_H
...
class OAICreateHostedConfigurationVersionRequest : public OAIObject {
public:
    OAICreateHostedConfigurationVersionRequest();
    OAICreateHostedConfigurationVersionRequest(QString json);
    ~OAICreateHostedConfigurationVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHostedConfigurationVersionRequest)

#endif // OAICreateHostedConfigurationVersionRequest_H
