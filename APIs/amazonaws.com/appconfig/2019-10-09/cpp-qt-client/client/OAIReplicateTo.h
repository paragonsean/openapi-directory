...
#ifndef OAIReplicateTo_H
#define OAIReplicateTo_H
...
class OAIReplicateTo : public OAIEnum {
public:
    OAIReplicateTo();
    OAIReplicateTo(QString json);
    ~OAIReplicateTo() override;
    ...
    enum class eOAIReplicateTo {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NONE, 
        SSM_DOCUMENT
    };
    OAIReplicateTo::eOAIReplicateTo getValue() const;
    void setValue(const OAIReplicateTo::eOAIReplicateTo& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicateTo)

#endif // OAIReplicateTo_H
