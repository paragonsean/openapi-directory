# AmazonAppConfig.CreateDeploymentStrategyRequest
...
**replicateTo** | **String** | Save the deployment strategy to a Systems Manager (SSM) document. | [optional] 
**tags** | **{String: String}** | Metadata to assign to the deployment strategy. Tags help organize and categorize your AppConfig resources. Each tag consists of a key and an optional value, both of which you define. | [optional] 
