...
/**
 * The HostedConfigurationVersion model module.
 * @module model/HostedConfigurationVersion
 * @version 2019-10-09
 */
class HostedConfigurationVersion {
    /**
     * Constructs a new <code>HostedConfigurationVersion</code>.
     * @alias module:model/HostedConfigurationVersion
     */
    constructor() { 
        
        HostedConfigurationVersion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HostedConfigurationVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HostedConfigurationVersion} obj Optional instance to populate.
     * @return {module:model/HostedConfigurationVersion} The populated <code>HostedConfigurationVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HostedConfigurationVersion();
    ...
    /**
     * Validates the JSON data with respect to <code>HostedConfigurationVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HostedConfigurationVersion</code>.
     */
 ...
 */
HostedConfigurationVersion.prototype['Content'] = undefined;
...
export default HostedConfigurationVersion;
