...
/**
 * The ConfigurationProfiles model module.
 * @module model/ConfigurationProfiles
 * @version 2019-10-09
 */
class ConfigurationProfiles {
    /**
     * Constructs a new <code>ConfigurationProfiles</code>.
     * @alias module:model/ConfigurationProfiles
     */
    constructor() { 
        
        ConfigurationProfiles.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfigurationProfiles</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfigurationProfiles} obj Optional instance to populate.
     * @return {module:model/ConfigurationProfiles} The populated <code>ConfigurationProfiles</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigurationProfiles();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfigurationProfiles</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfigurationProfiles</code>.
     */
 ...
 * @member {Array} Items
 */
ConfigurationProfiles.prototype['Items'] = undefined;

/**
 * @member {String} NextToken
 */
ConfigurationProfiles.prototype['NextToken'] = undefined;
