...
class Validator {
     ...
     * @param type {module:model/ValidatorType} 
     * @param content {String} 
     */
    constructor(type, content) { 
        
        Validator.initialize(this, type, content);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], ValidatorType);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Type']) { // data not null
          ValidatorType.validateJSON(data['Type']);
        }
...
Validator.RequiredProperties = ["Type", "Content"];

/**
 * @member {module:model/ValidatorType} Type
 */
 ...
 */
Validator.prototype['Content'] = undefined;
