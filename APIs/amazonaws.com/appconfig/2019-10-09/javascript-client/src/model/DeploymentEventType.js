...
* @readonly
*/
export default class DeploymentEventType {
    ...
    /**
    * Returns a <code>DeploymentEventType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeploymentEventType} The enum <code>DeploymentEventType</code> value.
    */
