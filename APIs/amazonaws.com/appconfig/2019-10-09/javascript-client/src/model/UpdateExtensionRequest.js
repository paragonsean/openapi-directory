...
/**
 * The UpdateExtensionRequest model module.
 * @module model/UpdateExtensionRequest
 * @version 2019-10-09
 */
class UpdateExtensionRequest {
    /**
     * Constructs a new <code>UpdateExtensionRequest</code>.
     * @alias module:model/UpdateExtensionRequest
     */
    constructor() { 
        
        UpdateExtensionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateExtensionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateExtensionRequest} obj Optional instance to populate.
     * @return {module:model/UpdateExtensionRequest} The populated <code>UpdateExtensionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateExtensionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateExtensionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateExtensionRequest</code>.
     */
 ...
 */
UpdateExtensionRequest.prototype['Description'] = undefined;

/**
 * The actions defined in the extension.
 * @member {Object.<String, Array.<module:model/Action>>} Actions
 */
UpdateExtensionRequest.prototype['Actions'] = undefined;

/**
 * One or more parameters for the actions called by the extension.
 * @member {Object.<String, module:model/Parameter>} Parameters
 */
UpdateExtensionRequest.prototype['Parameters'] = undefined;

/**
 * The extension version number.
 * @member {Number} VersionNumber
 */
UpdateExtensionRequest.prototype['VersionNumber'] = undefined;
...
export default UpdateExtensionRequest;
