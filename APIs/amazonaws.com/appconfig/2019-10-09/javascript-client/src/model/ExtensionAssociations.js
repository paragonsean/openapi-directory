...
/**
 * The ExtensionAssociations model module.
 * @module model/ExtensionAssociations
 * @version 2019-10-09
 */
class ExtensionAssociations {
    /**
     * Constructs a new <code>ExtensionAssociations</code>.
     * @alias module:model/ExtensionAssociations
     */
    constructor() { 
        
        ExtensionAssociations.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExtensionAssociations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtensionAssociations} obj Optional instance to populate.
     * @return {module:model/ExtensionAssociations} The populated <code>ExtensionAssociations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtensionAssociations();
    ...
    /**
     * Validates the JSON data with respect to <code>ExtensionAssociations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtensionAssociations</code>.
     */
 ...
 * @member {Array} Items
 */
ExtensionAssociations.prototype['Items'] = undefined;

/**
 * @member {String} NextToken
 */
ExtensionAssociations.prototype['NextToken'] = undefined;
...
export default ExtensionAssociations;
