...
class TagResourceRequest {
     ...
     * @param tags {Object.<String, String>} The key-value string map. The valid character set is [a-zA-Z+-=._:/]. The tag key can be up to 128 characters and must not start with <code>aws:</code>. The tag value can be up to 256 characters.
     */
    constructor(tags) { 
