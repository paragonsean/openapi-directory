...
/**
 * The UpdateExtensionAssociationRequest model module.
 * @module model/UpdateExtensionAssociationRequest
 * @version 2019-10-09
 */
class UpdateExtensionAssociationRequest {
    /**
     * Constructs a new <code>UpdateExtensionAssociationRequest</code>.
     * @alias module:model/UpdateExtensionAssociationRequest
     */
    constructor() { 
        
        UpdateExtensionAssociationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateExtensionAssociationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateExtensionAssociationRequest} obj Optional instance to populate.
     * @return {module:model/UpdateExtensionAssociationRequest} The populated <code>UpdateExtensionAssociationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateExtensionAssociationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateExtensionAssociationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateExtensionAssociationRequest</code>.
     */
 ...
 */
UpdateExtensionAssociationRequest.prototype['Parameters'] = undefined;
...
export default UpdateExtensionAssociationRequest;
