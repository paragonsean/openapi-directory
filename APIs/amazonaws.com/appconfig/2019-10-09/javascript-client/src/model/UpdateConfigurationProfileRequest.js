...
/**
 * The UpdateConfigurationProfileRequest model module.
 * @module model/UpdateConfigurationProfileRequest
 * @version 2019-10-09
 */
class UpdateConfigurationProfileRequest {
    /**
     * Constructs a new <code>UpdateConfigurationProfileRequest</code>.
     * @alias module:model/UpdateConfigurationProfileRequest
     */
    constructor() { 
        
        UpdateConfigurationProfileRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateConfigurationProfileRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateConfigurationProfileRequest} obj Optional instance to populate.
     * @return {module:model/UpdateConfigurationProfileRequest} The populated <code>UpdateConfigurationProfileRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateConfigurationProfileRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateConfigurationProfileRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateConfigurationProfileRequest</code>.
     */
 ...
 * @member {String} Name
 */
UpdateConfigurationProfileRequest.prototype['Name'] = undefined;

/**
 * A description of the configuration profile.
 * @member {String} Description
 */
UpdateConfigurationProfileRequest.prototype['Description'] = undefined;
 ...
 */
UpdateConfigurationProfileRequest.prototype['RetrievalRoleArn'] = undefined;

/**
 * A list of methods for validating the configuration.
 * @member {Array.<module:model/Validator>} Validators
 */
UpdateConfigurationProfileRequest.prototype['Validators'] = undefined;
...
export default UpdateConfigurationProfileRequest;
