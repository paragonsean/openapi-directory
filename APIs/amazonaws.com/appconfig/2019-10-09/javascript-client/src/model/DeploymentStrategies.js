...
/**
 * The DeploymentStrategies model module.
 * @module model/DeploymentStrategies
 * @version 2019-10-09
 */
class DeploymentStrategies {
    /**
     * Constructs a new <code>DeploymentStrategies</code>.
     * @alias module:model/DeploymentStrategies
     */
    constructor() { 
        
        DeploymentStrategies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeploymentStrategies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeploymentStrategies} obj Optional instance to populate.
     * @return {module:model/DeploymentStrategies} The populated <code>DeploymentStrategies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeploymentStrategies();
    ...
    /**
     * Validates the JSON data with respect to <code>DeploymentStrategies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeploymentStrategies</code>.
     */
 ...
 * @member {Array} Items
 */
DeploymentStrategies.prototype['Items'] = undefined;

/**
 * @member {String} NextToken
 */
DeploymentStrategies.prototype['NextToken'] = undefined;
