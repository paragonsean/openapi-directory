...
/**
 * The ConfigurationProfileSummary model module.
 * @module model/ConfigurationProfileSummary
 * @version 2019-10-09
 */
class ConfigurationProfileSummary {
    /**
     * Constructs a new <code>ConfigurationProfileSummary</code>.
     * A summary of a configuration profile.
     * @alias module:model/ConfigurationProfileSummary
     */
    constructor() { 
        
        ConfigurationProfileSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfigurationProfileSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfigurationProfileSummary} obj Optional instance to populate.
     * @return {module:model/ConfigurationProfileSummary} The populated <code>ConfigurationProfileSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigurationProfileSummary();
            ...
            if (data.hasOwnProperty('ValidatorTypes')) {
                obj['ValidatorTypes'] = ApiClient.convertToType(data['ValidatorTypes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfigurationProfileSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfigurationProfileSummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ValidatorTypes']) { // data not null
          Array.validateJSON(data['ValidatorTypes']);
        }
 ...
 */
ConfigurationProfileSummary.prototype['ApplicationId'] = undefined;

/**
 * @member {String} Id
 */
ConfigurationProfileSummary.prototype['Id'] = undefined;

/**
 * @member {String} Name
 */
ConfigurationProfileSummary.prototype['Name'] = undefined;

/**
 * @member {String} LocationUri
 */
ConfigurationProfileSummary.prototype['LocationUri'] = undefined;

/**
 * @member {Array} ValidatorTypes
 */
ConfigurationProfileSummary.prototype['ValidatorTypes'] = undefined;

/**
 * @member {String} Type
 */
ConfigurationProfileSummary.prototype['Type'] = undefined;
...
export default ConfigurationProfileSummary;
