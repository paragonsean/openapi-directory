...
class Monitor {
    ...
    constructor(alarmArn) { 
        ...
        Monitor.initialize(this, alarmArn);
    }
     ...
     */
    static initialize(obj, alarmArn) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of Monitor.RequiredProperties) {
...
Monitor.RequiredProperties = ["AlarmArn"];

/**
 * @member {String} AlarmArn
 */
Monitor.prototype['AlarmArn'] = undefined;

/**
 * @member {String} AlarmRoleArn
 */
Monitor.prototype['AlarmRoleArn'] = undefined;
