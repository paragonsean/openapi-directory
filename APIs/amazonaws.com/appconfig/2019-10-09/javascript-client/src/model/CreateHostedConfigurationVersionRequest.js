...
/**
 * The CreateHostedConfigurationVersionRequest model module.
 * @module model/CreateHostedConfigurationVersionRequest
 * @version 2019-10-09
 */
class CreateHostedConfigurationVersionRequest {
    /**
     * Constructs a new <code>CreateHostedConfigurationVersionRequest</code>.
     * @alias module:model/CreateHostedConfigurationVersionRequest
     * @param content {String} The content of the configuration or the configuration data.
     */
    constructor(content) { 
        
        CreateHostedConfigurationVersionRequest.initialize(this, content);
    }
    ...
    /**
     * Constructs a <code>CreateHostedConfigurationVersionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateHostedConfigurationVersionRequest} obj Optional instance to populate.
     * @return {module:model/CreateHostedConfigurationVersionRequest} The populated <code>CreateHostedConfigurationVersionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateHostedConfigurationVersionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateHostedConfigurationVersionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateHostedConfigurationVersionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateHostedConfigurationVersionRequest.RequiredProperties) {
...
CreateHostedConfigurationVersionRequest.RequiredProperties = ["Content"];

/**
 * The content of the configuration or the configuration data.
 * @member {String} Content
 */
CreateHostedConfigurationVersionRequest.prototype['Content'] = undefined;
...
export default CreateHostedConfigurationVersionRequest;
