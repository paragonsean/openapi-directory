...
* @readonly
*/
export default class ReplicateTo {
    ...
    /**
    * Returns a <code>ReplicateTo</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReplicateTo} The enum <code>ReplicateTo</code> value.
    */
