...
export default class ActionPoint {
        ...
        /**
         * value: "PRE_CREATE_HOSTED_CONFIGURATION_VERSION"
         * @const
         */
        ...
        /**
         * value: "ON_DEPLOYMENT_ROLLED_BACK"
         * @const
         */
    ...
    /**
    * Returns a <code>ActionPoint</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ActionPoint} The enum <code>ActionPoint</code> value.
    */
