...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.HostedConfigurationVersions();
  });
  ...
  describe('HostedConfigurationVersions', function() {
    it('should create an instance of HostedConfigurationVersions', function() {
      // uncomment below and update the code to test HostedConfigurationVersions
      //var instance = new AmazonAppConfig.HostedConfigurationVersions();
      //expect(instance).to.be.a(AmazonAppConfig.HostedConfigurationVersions);
    });
