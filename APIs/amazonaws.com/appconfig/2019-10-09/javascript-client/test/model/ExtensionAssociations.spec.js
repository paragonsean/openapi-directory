...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ExtensionAssociations();
  });
  ...
  describe('ExtensionAssociations', function() {
    it('should create an instance of ExtensionAssociations', function() {
      // uncomment below and update the code to test ExtensionAssociations
      //var instance = new AmazonAppConfig.ExtensionAssociations();
      //expect(instance).to.be.a(AmazonAppConfig.ExtensionAssociations);
    });
