...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.UpdateConfigurationProfileRequest();
  });
  ...
  describe('UpdateConfigurationProfileRequest', function() {
    it('should create an instance of UpdateConfigurationProfileRequest', function() {
      // uncomment below and update the code to test UpdateConfigurationProfileRequest
      //var instance = new AmazonAppConfig.UpdateConfigurationProfileRequest();
      //expect(instance).to.be.a(AmazonAppConfig.UpdateConfigurationProfileRequest);
    });
    ...
    it('should have the property retrievalRoleArn (base name: "RetrievalRoleArn")', function() {
      // uncomment below and update the code to test the property retrievalRoleArn
      //var instance = new AmazonAppConfig.UpdateConfigurationProfileRequest();
      //expect(instance).to.be();
    });
