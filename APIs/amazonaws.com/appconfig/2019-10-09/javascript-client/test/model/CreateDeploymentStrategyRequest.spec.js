...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.CreateDeploymentStrategyRequest();
  });
  ...
  describe('CreateDeploymentStrategyRequest', function() {
    it('should create an instance of CreateDeploymentStrategyRequest', function() {
      // uncomment below and update the code to test CreateDeploymentStrategyRequest
      //var instance = new AmazonAppConfig.CreateDeploymentStrategyRequest();
      //expect(instance).to.be.a(AmazonAppConfig.CreateDeploymentStrategyRequest);
    });
    ...
    it('should have the property replicateTo (base name: "ReplicateTo")', function() {
      // uncomment below and update the code to test the property replicateTo
      //var instance = new AmazonAppConfig.CreateDeploymentStrategyRequest();
      //expect(instance).to.be();
    });
