...
(function(root, factory) {
  ...
  describe('ValidatorType', function() {
    it('should create an instance of ValidatorType', function() {
      // uncomment below and update the code to test ValidatorType
      //var instance = new AmazonAppConfig.ValidatorType();
      //expect(instance).to.be.a(AmazonAppConfig.ValidatorType);
    });
