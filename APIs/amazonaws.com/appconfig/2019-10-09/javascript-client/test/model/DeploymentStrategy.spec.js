...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.DeploymentStrategy();
  });
  ...
  describe('DeploymentStrategy', function() {
    it('should create an instance of DeploymentStrategy', function() {
      // uncomment below and update the code to test DeploymentStrategy
      //var instance = new AmazonAppConfig.DeploymentStrategy();
      //expect(instance).to.be.a(AmazonAppConfig.DeploymentStrategy);
    });
