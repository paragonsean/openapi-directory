...
(function(root, factory) {
  ...
  describe('ActionPoint', function() {
    it('should create an instance of ActionPoint', function() {
      // uncomment below and update the code to test ActionPoint
      //var instance = new AmazonAppConfig.ActionPoint();
      //expect(instance).to.be.a(AmazonAppConfig.ActionPoint);
    });
