...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ExtensionSummary();
  });
  ...
  describe('ExtensionSummary', function() {
    it('should create an instance of ExtensionSummary', function() {
      // uncomment below and update the code to test ExtensionSummary
      //var instance = new AmazonAppConfig.ExtensionSummary();
      //expect(instance).to.be.a(AmazonAppConfig.ExtensionSummary);
    });
