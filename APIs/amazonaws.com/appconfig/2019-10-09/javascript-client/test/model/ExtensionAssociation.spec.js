...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ExtensionAssociation();
  });
  ...
  describe('ExtensionAssociation', function() {
    it('should create an instance of ExtensionAssociation', function() {
      // uncomment below and update the code to test ExtensionAssociation
      //var instance = new AmazonAppConfig.ExtensionAssociation();
      //expect(instance).to.be.a(AmazonAppConfig.ExtensionAssociation);
    });
    ...
    it('should have the property extensionArn (base name: "ExtensionArn")', function() {
      // uncomment below and update the code to test the property extensionArn
      //var instance = new AmazonAppConfig.ExtensionAssociation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property extensionVersionNumber (base name: "ExtensionVersionNumber")', function() {
      // uncomment below and update the code to test the property extensionVersionNumber
      //var instance = new AmazonAppConfig.ExtensionAssociation();
      //expect(instance).to.be();
    });
