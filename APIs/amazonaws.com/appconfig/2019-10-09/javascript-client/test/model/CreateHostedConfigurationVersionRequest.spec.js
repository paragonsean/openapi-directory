...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.CreateHostedConfigurationVersionRequest();
  });
  ...
  describe('CreateHostedConfigurationVersionRequest', function() {
    it('should create an instance of CreateHostedConfigurationVersionRequest', function() {
      // uncomment below and update the code to test CreateHostedConfigurationVersionRequest
      //var instance = new AmazonAppConfig.CreateHostedConfigurationVersionRequest();
      //expect(instance).to.be.a(AmazonAppConfig.CreateHostedConfigurationVersionRequest);
    });
