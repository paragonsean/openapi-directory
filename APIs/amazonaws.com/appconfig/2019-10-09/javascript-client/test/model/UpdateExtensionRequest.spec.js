...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.UpdateExtensionRequest();
  });
  ...
  describe('UpdateExtensionRequest', function() {
    it('should create an instance of UpdateExtensionRequest', function() {
      // uncomment below and update the code to test UpdateExtensionRequest
      //var instance = new AmazonAppConfig.UpdateExtensionRequest();
      //expect(instance).to.be.a(AmazonAppConfig.UpdateExtensionRequest);
    });
