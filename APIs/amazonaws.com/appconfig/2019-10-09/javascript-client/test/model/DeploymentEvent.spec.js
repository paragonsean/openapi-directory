...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.DeploymentEvent();
  });
  ...
  describe('DeploymentEvent', function() {
    it('should create an instance of DeploymentEvent', function() {
      // uncomment below and update the code to test DeploymentEvent
      //var instance = new AmazonAppConfig.DeploymentEvent();
      //expect(instance).to.be.a(AmazonAppConfig.DeploymentEvent);
    });
    ...
    it('should have the property actionInvocations (base name: "ActionInvocations")', function() {
      // uncomment below and update the code to test the property actionInvocations
      //var instance = new AmazonAppConfig.DeploymentEvent();
      //expect(instance).to.be();
    });
