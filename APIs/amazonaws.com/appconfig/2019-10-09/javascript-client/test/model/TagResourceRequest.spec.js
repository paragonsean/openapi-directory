...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonAppConfig.TagResourceRequest();
      //expect(instance).to.be.a(AmazonAppConfig.TagResourceRequest);
    });
