...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.DeploymentStrategies();
  });
  ...
  describe('DeploymentStrategies', function() {
    it('should create an instance of DeploymentStrategies', function() {
      // uncomment below and update the code to test DeploymentStrategies
      //var instance = new AmazonAppConfig.DeploymentStrategies();
      //expect(instance).to.be.a(AmazonAppConfig.DeploymentStrategies);
    });
