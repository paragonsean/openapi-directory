...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.HostedConfigurationVersion();
  });
  ...
  describe('HostedConfigurationVersion', function() {
    it('should create an instance of HostedConfigurationVersion', function() {
      // uncomment below and update the code to test HostedConfigurationVersion
      //var instance = new AmazonAppConfig.HostedConfigurationVersion();
      //expect(instance).to.be.a(AmazonAppConfig.HostedConfigurationVersion);
    });
