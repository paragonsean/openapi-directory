...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ExtensionAssociationSummary();
  });
  ...
  describe('ExtensionAssociationSummary', function() {
    it('should create an instance of ExtensionAssociationSummary', function() {
      // uncomment below and update the code to test ExtensionAssociationSummary
      //var instance = new AmazonAppConfig.ExtensionAssociationSummary();
      //expect(instance).to.be.a(AmazonAppConfig.ExtensionAssociationSummary);
    });
