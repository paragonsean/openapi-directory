...
(function(root, factory) {
  ...
  describe('GrowthType', function() {
    it('should create an instance of GrowthType', function() {
      // uncomment below and update the code to test GrowthType
      //var instance = new AmazonAppConfig.GrowthType();
      //expect(instance).to.be.a(AmazonAppConfig.GrowthType);
    });
