...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ConfigurationProfile();
  });
  ...
  describe('ConfigurationProfile', function() {
    it('should create an instance of ConfigurationProfile', function() {
      // uncomment below and update the code to test ConfigurationProfile
      //var instance = new AmazonAppConfig.ConfigurationProfile();
      //expect(instance).to.be.a(AmazonAppConfig.ConfigurationProfile);
    });
