...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ConfigurationProfiles();
  });
  ...
  describe('ConfigurationProfiles', function() {
    it('should create an instance of ConfigurationProfiles', function() {
      // uncomment below and update the code to test ConfigurationProfiles
      //var instance = new AmazonAppConfig.ConfigurationProfiles();
      //expect(instance).to.be.a(AmazonAppConfig.ConfigurationProfiles);
    });
