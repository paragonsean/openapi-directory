...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.UpdateExtensionAssociationRequest();
  });
  ...
  describe('UpdateExtensionAssociationRequest', function() {
    it('should create an instance of UpdateExtensionAssociationRequest', function() {
      // uncomment below and update the code to test UpdateExtensionAssociationRequest
      //var instance = new AmazonAppConfig.UpdateExtensionAssociationRequest();
      //expect(instance).to.be.a(AmazonAppConfig.UpdateExtensionAssociationRequest);
    });
