...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.AppliedExtension();
  });
  ...
  describe('AppliedExtension', function() {
    it('should create an instance of AppliedExtension', function() {
      // uncomment below and update the code to test AppliedExtension
      //var instance = new AmazonAppConfig.AppliedExtension();
      //expect(instance).to.be.a(AmazonAppConfig.AppliedExtension);
    });
    ...
    it('should have the property extensionAssociationId (base name: "ExtensionAssociationId")', function() {
      // uncomment below and update the code to test the property extensionAssociationId
      //var instance = new AmazonAppConfig.AppliedExtension();
      //expect(instance).to.be();
    });
