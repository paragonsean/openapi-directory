...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.DeploymentSummary();
  });
  ...
  describe('DeploymentSummary', function() {
    it('should create an instance of DeploymentSummary', function() {
      ...
      //var instance = new AmazonAppConfig.DeploymentSummary();
      //expect(instance).to.be.a(AmazonAppConfig.DeploymentSummary);
    });
