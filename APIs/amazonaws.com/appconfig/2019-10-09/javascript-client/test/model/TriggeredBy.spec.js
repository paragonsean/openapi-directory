...
(function(root, factory) {
  ...
  describe('TriggeredBy', function() {
    it('should create an instance of TriggeredBy', function() {
      // uncomment below and update the code to test TriggeredBy
      //var instance = new AmazonAppConfig.TriggeredBy();
      //expect(instance).to.be.a(AmazonAppConfig.TriggeredBy);
    });
