...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.UpdateDeploymentStrategyRequest();
  });
  ...
  describe('UpdateDeploymentStrategyRequest', function() {
    it('should create an instance of UpdateDeploymentStrategyRequest', function() {
      // uncomment below and update the code to test UpdateDeploymentStrategyRequest
      //var instance = new AmazonAppConfig.UpdateDeploymentStrategyRequest();
      //expect(instance).to.be.a(AmazonAppConfig.UpdateDeploymentStrategyRequest);
    });
