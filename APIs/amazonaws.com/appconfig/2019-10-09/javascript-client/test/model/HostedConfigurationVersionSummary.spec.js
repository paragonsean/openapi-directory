...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.HostedConfigurationVersionSummary();
  });
  ...
  describe('HostedConfigurationVersionSummary', function() {
    it('should create an instance of HostedConfigurationVersionSummary', function() {
      // uncomment below and update the code to test HostedConfigurationVersionSummary
      //var instance = new AmazonAppConfig.HostedConfigurationVersionSummary();
      //expect(instance).to.be.a(AmazonAppConfig.HostedConfigurationVersionSummary);
    });
