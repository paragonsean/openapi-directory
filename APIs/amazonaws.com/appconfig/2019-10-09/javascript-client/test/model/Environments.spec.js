...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.Environments();
  });
  ...
  describe('Environments', function() {
    it('should create an instance of Environments', function() {
      // uncomment below and update the code to test Environments
      //var instance = new AmazonAppConfig.Environments();
      //expect(instance).to.be.a(AmazonAppConfig.Environments);
    });
