...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.CreateExtensionRequest();
  });
  ...
  describe('CreateExtensionRequest', function() {
    it('should create an instance of CreateExtensionRequest', function() {
      // uncomment below and update the code to test CreateExtensionRequest
      //var instance = new AmazonAppConfig.CreateExtensionRequest();
      //expect(instance).to.be.a(AmazonAppConfig.CreateExtensionRequest);
    });
