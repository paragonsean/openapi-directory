...
(function(root, factory) {
  ...
  describe('DeploymentEventType', function() {
    it('should create an instance of DeploymentEventType', function() {
      // uncomment below and update the code to test DeploymentEventType
      //var instance = new AmazonAppConfig.DeploymentEventType();
      //expect(instance).to.be.a(AmazonAppConfig.DeploymentEventType);
    });
