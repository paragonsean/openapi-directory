...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.UpdateEnvironmentRequest();
  });
  ...
  describe('UpdateEnvironmentRequest', function() {
    it('should create an instance of UpdateEnvironmentRequest', function() {
      ...
      //var instance = new AmazonAppConfig.UpdateEnvironmentRequest();
      //expect(instance).to.be.a(AmazonAppConfig.UpdateEnvironmentRequest);
    });
