...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.StartDeploymentRequest();
  });
  ...
  describe('StartDeploymentRequest', function() {
    it('should create an instance of StartDeploymentRequest', function() {
      ...
      //var instance = new AmazonAppConfig.StartDeploymentRequest();
      //expect(instance).to.be.a(AmazonAppConfig.StartDeploymentRequest);
    });
