...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.CreateExtensionAssociationRequest();
  });
  ...
  describe('CreateExtensionAssociationRequest', function() {
    it('should create an instance of CreateExtensionAssociationRequest', function() {
      // uncomment below and update the code to test CreateExtensionAssociationRequest
      //var instance = new AmazonAppConfig.CreateExtensionAssociationRequest();
      //expect(instance).to.be.a(AmazonAppConfig.CreateExtensionAssociationRequest);
    });
