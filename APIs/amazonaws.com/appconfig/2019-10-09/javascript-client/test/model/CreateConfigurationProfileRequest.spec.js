...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.CreateConfigurationProfileRequest();
  });
  ...
  describe('CreateConfigurationProfileRequest', function() {
    it('should create an instance of CreateConfigurationProfileRequest', function() {
      // uncomment below and update the code to test CreateConfigurationProfileRequest
      //var instance = new AmazonAppConfig.CreateConfigurationProfileRequest();
      //expect(instance).to.be.a(AmazonAppConfig.CreateConfigurationProfileRequest);
    });
