...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.CreateApplicationRequest();
  });
  ...
  describe('CreateApplicationRequest', function() {
    it('should create an instance of CreateApplicationRequest', function() {
      ...
      //var instance = new AmazonAppConfig.CreateApplicationRequest();
      //expect(instance).to.be.a(AmazonAppConfig.CreateApplicationRequest);
    });
