...
(function(root, factory) {
  ...
  describe('ReplicateTo', function() {
    it('should create an instance of ReplicateTo', function() {
      // uncomment below and update the code to test ReplicateTo
      //var instance = new AmazonAppConfig.ReplicateTo();
      //expect(instance).to.be.a(AmazonAppConfig.ReplicateTo);
    });
