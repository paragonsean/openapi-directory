...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ConfigurationProfileSummary();
  });
  ...
  describe('ConfigurationProfileSummary', function() {
    it('should create an instance of ConfigurationProfileSummary', function() {
      // uncomment below and update the code to test ConfigurationProfileSummary
      //var instance = new AmazonAppConfig.ConfigurationProfileSummary();
      //expect(instance).to.be.a(AmazonAppConfig.ConfigurationProfileSummary);
    });
    ...
    it('should have the property validatorTypes (base name: "ValidatorTypes")', function() {
      // uncomment below and update the code to test the property validatorTypes
      //var instance = new AmazonAppConfig.ConfigurationProfileSummary();
      //expect(instance).to.be();
    });
