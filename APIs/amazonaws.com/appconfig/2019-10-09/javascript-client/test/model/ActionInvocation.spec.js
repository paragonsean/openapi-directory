...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppConfig.ActionInvocation();
  });
  ...
  describe('ActionInvocation', function() {
    it('should create an instance of ActionInvocation', function() {
      // uncomment below and update the code to test ActionInvocation
      //var instance = new AmazonAppConfig.ActionInvocation();
      //expect(instance).to.be.a(AmazonAppConfig.ActionInvocation);
    });

    it('should have the property extensionIdentifier (base name: "ExtensionIdentifier")', function() {
      // uncomment below and update the code to test the property extensionIdentifier
      //var instance = new AmazonAppConfig.ActionInvocation();
