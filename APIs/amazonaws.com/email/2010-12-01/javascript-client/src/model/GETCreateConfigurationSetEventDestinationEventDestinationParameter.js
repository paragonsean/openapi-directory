...
/**
 * The GETCreateConfigurationSetEventDestinationEventDestinationParameter model module.
 * @module model/GETCreateConfigurationSetEventDestinationEventDestinationParameter
 * @version 2010-12-01
 */
class GETCreateConfigurationSetEventDestinationEventDestinationParameter {
    /**
     * Constructs a new <code>GETCreateConfigurationSetEventDestinationEventDestinationParameter</code>.
     ...
     * @alias module:model/GETCreateConfigurationSetEventDestinationEventDestinationParameter
     * @param name {String} 
     * @param matchingEventTypes {Array} 
     */
    constructor(name, matchingEventTypes) { 
        
        GETCreateConfigurationSetEventDestinationEventDestinationParameter.initialize(this, name, matchingEventTypes);
    }
    ...
    /**
     * Constructs a <code>GETCreateConfigurationSetEventDestinationEventDestinationParameter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GETCreateConfigurationSetEventDestinationEventDestinationParameter} obj Optional instance to populate.
     * @return {module:model/GETCreateConfigurationSetEventDestinationEventDestinationParameter} The populated <code>GETCreateConfigurationSetEventDestinationEventDestinationParameter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GETCreateConfigurationSetEventDestinationEventDestinationParameter();
    ...
    /**
     * Validates the JSON data with respect to <code>GETCreateConfigurationSetEventDestinationEventDestinationParameter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GETCreateConfigurationSetEventDestinationEventDestinationParameter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GETCreateConfigurationSetEventDestinationEventDestinationParameter.RequiredProperties) {
...
GETCreateConfigurationSetEventDestinationEventDestinationParameter.RequiredProperties = ["Name", "MatchingEventTypes"];

/**
 * @member {String} Name
 */
GETCreateConfigurationSetEventDestinationEventDestinationParameter.prototype['Name'] = undefined;

/**
 * @member {Boolean} Enabled
 */
GETCreateConfigurationSetEventDestinationEventDestinationParameter.prototype['Enabled'] = undefined;

/**
 * @member {Array} MatchingEventTypes
 */
GETCreateConfigurationSetEventDestinationEventDestinationParameter.prototype['MatchingEventTypes'] = undefined;
 ...
 */
GETCreateConfigurationSetEventDestinationEventDestinationParameter.prototype['KinesisFirehoseDestination'] = undefined;
 ...
 */
GETCreateConfigurationSetEventDestinationEventDestinationParameter.prototype['CloudWatchDestination'] = undefined;

/**
 * @member {module:model/GETCreateConfigurationSetEventDestinationEventDestinationParameterSNSDestination} SNSDestination
 */
GETCreateConfigurationSetEventDestinationEventDestinationParameter.prototype['SNSDestination'] = undefined;
...
export default GETCreateConfigurationSetEventDestinationEventDestinationParameter;
