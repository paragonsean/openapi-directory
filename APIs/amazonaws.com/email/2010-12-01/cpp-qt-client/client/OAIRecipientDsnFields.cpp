...
#include "OAIRecipientDsnFields.h"
...
OAIRecipientDsnFields::OAIRecipientDsnFields(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecipientDsnFields::OAIRecipientDsnFields() {
    this->initializeModel();
}

OAIRecipientDsnFields::~OAIRecipientDsnFields() {}

void OAIRecipientDsnFields::initializeModel() {
...
void OAIRecipientDsnFields::fromJson(QString jsonString) {
...
void OAIRecipientDsnFields::fromJsonObject(QJsonObject json) {
...
QString OAIRecipientDsnFields::asJson() const {
...
QJsonObject OAIRecipientDsnFields::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRecipientDsnFields::getFinalRecipient() const {
    return m_final_recipient;
}
void OAIRecipientDsnFields::setFinalRecipient(const QString &final_recipient) {
    m_final_recipient = final_recipient;
    m_final_recipient_isSet = true;
}

bool OAIRecipientDsnFields::is_final_recipient_Set() const{
    return m_final_recipient_isSet;
}

bool OAIRecipientDsnFields::is_final_recipient_Valid() const{
    return m_final_recipient_isValid;
}

OAIDsnAction OAIRecipientDsnFields::getAction() const {
    return m_action;
}
void OAIRecipientDsnFields::setAction(const OAIDsnAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIRecipientDsnFields::is_action_Set() const{
    return m_action_isSet;
}

bool OAIRecipientDsnFields::is_action_Valid() const{
    return m_action_isValid;
}

QString OAIRecipientDsnFields::getRemoteMta() const {
    return m_remote_mta;
}
void OAIRecipientDsnFields::setRemoteMta(const QString &remote_mta) {
    m_remote_mta = remote_mta;
    m_remote_mta_isSet = true;
}

bool OAIRecipientDsnFields::is_remote_mta_Set() const{
    return m_remote_mta_isSet;
}

bool OAIRecipientDsnFields::is_remote_mta_Valid() const{
    return m_remote_mta_isValid;
}

QString OAIRecipientDsnFields::getStatus() const {
    return m_status;
}
void OAIRecipientDsnFields::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRecipientDsnFields::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRecipientDsnFields::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIRecipientDsnFields::getDiagnosticCode() const {
    return m_diagnostic_code;
}
void OAIRecipientDsnFields::setDiagnosticCode(const QString &diagnostic_code) {
    m_diagnostic_code = diagnostic_code;
    m_diagnostic_code_isSet = true;
}

bool OAIRecipientDsnFields::is_diagnostic_code_Set() const{
    return m_diagnostic_code_isSet;
}

bool OAIRecipientDsnFields::is_diagnostic_code_Valid() const{
    return m_diagnostic_code_isValid;
}

QDateTime OAIRecipientDsnFields::getLastAttemptDate() const {
    return m_last_attempt_date;
}
void OAIRecipientDsnFields::setLastAttemptDate(const QDateTime &last_attempt_date) {
    m_last_attempt_date = last_attempt_date;
    m_last_attempt_date_isSet = true;
}

bool OAIRecipientDsnFields::is_last_attempt_date_Set() const{
    return m_last_attempt_date_isSet;
}

bool OAIRecipientDsnFields::is_last_attempt_date_Valid() const{
    return m_last_attempt_date_isValid;
}

QList OAIRecipientDsnFields::getExtensionFields() const {
    return m_extension_fields;
}
void OAIRecipientDsnFields::setExtensionFields(const QList &extension_fields) {
    m_extension_fields = extension_fields;
    m_extension_fields_isSet = true;
}

bool OAIRecipientDsnFields::is_extension_fields_Set() const{
    return m_extension_fields_isSet;
}

bool OAIRecipientDsnFields::is_extension_fields_Valid() const{
    return m_extension_fields_isValid;
}

bool OAIRecipientDsnFields::isSet() const {
...
bool OAIRecipientDsnFields::isValid() const {
