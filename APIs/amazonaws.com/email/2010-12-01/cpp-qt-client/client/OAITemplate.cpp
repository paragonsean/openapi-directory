...
QString OAITemplate::getTemplateName() const {
    return m_template_name;
}
void OAITemplate::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAITemplate::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAITemplate::is_template_name_Valid() const{
    return m_template_name_isValid;
}

QString OAITemplate::getSubjectPart() const {
    return m_subject_part;
}
void OAITemplate::setSubjectPart(const QString &subject_part) {
    m_subject_part = subject_part;
    m_subject_part_isSet = true;
}

bool OAITemplate::is_subject_part_Set() const{
    return m_subject_part_isSet;
}

bool OAITemplate::is_subject_part_Valid() const{
    return m_subject_part_isValid;
}

QString OAITemplate::getTextPart() const {
    return m_text_part;
}
void OAITemplate::setTextPart(const QString &text_part) {
    m_text_part = text_part;
    m_text_part_isSet = true;
}

bool OAITemplate::is_text_part_Set() const{
    return m_text_part_isSet;
}

bool OAITemplate::is_text_part_Valid() const{
    return m_text_part_isValid;
}

QString OAITemplate::getHtmlPart() const {
    return m_html_part;
}
void OAITemplate::setHtmlPart(const QString &html_part) {
    m_html_part = html_part;
    m_html_part_isSet = true;
}

bool OAITemplate::is_html_part_Set() const{
    return m_html_part_isSet;
}

bool OAITemplate::is_html_part_Valid() const{
