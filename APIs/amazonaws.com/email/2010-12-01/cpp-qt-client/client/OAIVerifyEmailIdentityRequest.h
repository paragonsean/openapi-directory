...
/*
 * OAIVerifyEmailIdentityRequest.h
 *
...
#ifndef OAIVerifyEmailIdentityRequest_H
#define OAIVerifyEmailIdentityRequest_H
...
class OAIVerifyEmailIdentityRequest : public OAIObject {
public:
    OAIVerifyEmailIdentityRequest();
    OAIVerifyEmailIdentityRequest(QString json);
    ~OAIVerifyEmailIdentityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyEmailIdentityRequest)

#endif // OAIVerifyEmailIdentityRequest_H
