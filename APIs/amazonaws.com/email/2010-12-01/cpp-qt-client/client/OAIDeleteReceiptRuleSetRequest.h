...
/*
 * OAIDeleteReceiptRuleSetRequest.h
 *
...
#ifndef OAIDeleteReceiptRuleSetRequest_H
#define OAIDeleteReceiptRuleSetRequest_H
...
class OAIDeleteReceiptRuleSetRequest : public OAIObject {
public:
    OAIDeleteReceiptRuleSetRequest();
    OAIDeleteReceiptRuleSetRequest(QString json);
    ~OAIDeleteReceiptRuleSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteReceiptRuleSetRequest)

#endif // OAIDeleteReceiptRuleSetRequest_H
