...
OAIGET_CreateConfigurationSetEventDestination_EventDestination_parameter_KinesisFirehoseDestination OAIEventDestination::getKinesisFirehoseDestination() const {
    return m_kinesis_firehose_destination;
}
void OAIEventDestination::setKinesisFirehoseDestination(const OAIGET_CreateConfigurationSetEventDestination_EventDestination_parameter_KinesisFirehoseDestination &kinesis_firehose_destination) {
...
OAIGET_CreateConfigurationSetEventDestination_EventDestination_parameter_CloudWatchDestination OAIEventDestination::getCloudWatchDestination() const {
    return m_cloud_watch_destination;
}
void OAIEventDestination::setCloudWatchDestination(const OAIGET_CreateConfigurationSetEventDestination_EventDestination_parameter_CloudWatchDestination &cloud_watch_destination) {
...
OAIGET_CreateConfigurationSetEventDestination_EventDestination_parameter_SNSDestination OAIEventDestination::getSnsDestination() const {
    return m_sns_destination;
}
void OAIEventDestination::setSnsDestination(const OAIGET_CreateConfigurationSetEventDestination_EventDestination_parameter_SNSDestination &sns_destination) {
