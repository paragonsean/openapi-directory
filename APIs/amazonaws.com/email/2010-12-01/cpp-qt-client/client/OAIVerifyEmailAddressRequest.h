...
/*
 * OAIVerifyEmailAddressRequest.h
 *
...
#ifndef OAIVerifyEmailAddressRequest_H
#define OAIVerifyEmailAddressRequest_H
...
class OAIVerifyEmailAddressRequest : public OAIObject {
public:
    OAIVerifyEmailAddressRequest();
    OAIVerifyEmailAddressRequest(QString json);
    ~OAIVerifyEmailAddressRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyEmailAddressRequest)

#endif // OAIVerifyEmailAddressRequest_H
