...
#ifndef OAIDeleteReceiptRuleRequest_H
#define OAIDeleteReceiptRuleRequest_H
...
class OAIDeleteReceiptRuleRequest : public OAIObject {
public:
    OAIDeleteReceiptRuleRequest();
    OAIDeleteReceiptRuleRequest(QString json);
    ~OAIDeleteReceiptRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteReceiptRuleRequest)

#endif // OAIDeleteReceiptRuleRequest_H
