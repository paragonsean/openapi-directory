...
/*
 * OAIReceiptAction_LambdaAction.h
 *
 * 
 */

#ifndef OAIReceiptAction_LambdaAction_H
#define OAIReceiptAction_LambdaAction_H
...
class OAIReceiptAction_LambdaAction : public OAIObject {
public:
    OAIReceiptAction_LambdaAction();
    OAIReceiptAction_LambdaAction(QString json);
    ~OAIReceiptAction_LambdaAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReceiptAction_LambdaAction)

#endif // OAIReceiptAction_LambdaAction_H
