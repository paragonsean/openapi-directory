...
#ifndef OAIReceiptRule_H
#define OAIReceiptRule_H
...
class OAIReceiptRule : public OAIObject {
public:
    OAIReceiptRule();
    OAIReceiptRule(QString json);
    ~OAIReceiptRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReceiptRule)

#endif // OAIReceiptRule_H
