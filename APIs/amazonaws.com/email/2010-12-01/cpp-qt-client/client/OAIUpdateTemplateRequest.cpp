...
OAITemplate OAIUpdateTemplateRequest::getRTemplate() const {
    return m_r_template;
}
void OAIUpdateTemplateRequest::setRTemplate(const OAITemplate &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAIUpdateTemplateRequest::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAIUpdateTemplateRequest::is_r_template_Valid() const{
