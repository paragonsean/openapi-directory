...
/*
 * OAISendBulkTemplatedEmailRequest.h
 *
...
#ifndef OAISendBulkTemplatedEmailRequest_H
#define OAISendBulkTemplatedEmailRequest_H
...
class OAISendBulkTemplatedEmailRequest : public OAIObject {
public:
    OAISendBulkTemplatedEmailRequest();
    OAISendBulkTemplatedEmailRequest(QString json);
    ~OAISendBulkTemplatedEmailRequest() override;
    ...
    QList getDefaultTags() const;
    void setDefaultTags(const QList &default_tags);
    ...
    QString getDefaultTemplateData() const;
    void setDefaultTemplateData(const QString &default_template_data);
    bool is_default_template_data_Set() const;
    bool is_default_template_data_Valid() const;
...
private:
    ...
    QString m_default_template_data;
    bool m_default_template_data_isSet;
    bool m_default_template_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendBulkTemplatedEmailRequest)

#endif // OAISendBulkTemplatedEmailRequest_H
