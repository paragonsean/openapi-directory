...
#ifndef OAIConfigurationSet_H
#define OAIConfigurationSet_H
...
class OAIConfigurationSet : public OAIObject {
public:
    OAIConfigurationSet();
    OAIConfigurationSet(QString json);
    ~OAIConfigurationSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationSet)

#endif // OAIConfigurationSet_H
