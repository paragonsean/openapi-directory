...
/*
 * OAIDescribeReceiptRuleSetRequest.h
 *
...
#ifndef OAIDescribeReceiptRuleSetRequest_H
#define OAIDescribeReceiptRuleSetRequest_H
...
class OAIDescribeReceiptRuleSetRequest : public OAIObject {
public:
    OAIDescribeReceiptRuleSetRequest();
    OAIDescribeReceiptRuleSetRequest(QString json);
    ~OAIDescribeReceiptRuleSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeReceiptRuleSetRequest)

#endif // OAIDescribeReceiptRuleSetRequest_H
