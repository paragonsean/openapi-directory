...
OAITemplate OAIGetTemplateResponse::getRTemplate() const {
    return m_r_template;
}
void OAIGetTemplateResponse::setRTemplate(const OAITemplate &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAIGetTemplateResponse::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAIGetTemplateResponse::is_r_template_Valid() const{
