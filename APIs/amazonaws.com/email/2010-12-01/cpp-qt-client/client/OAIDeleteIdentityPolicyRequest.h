...
/*
 * OAIDeleteIdentityPolicyRequest.h
 *
...
#ifndef OAIDeleteIdentityPolicyRequest_H
#define OAIDeleteIdentityPolicyRequest_H
...
class OAIDeleteIdentityPolicyRequest : public OAIObject {
public:
    OAIDeleteIdentityPolicyRequest();
    OAIDeleteIdentityPolicyRequest(QString json);
    ~OAIDeleteIdentityPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteIdentityPolicyRequest)

#endif // OAIDeleteIdentityPolicyRequest_H
