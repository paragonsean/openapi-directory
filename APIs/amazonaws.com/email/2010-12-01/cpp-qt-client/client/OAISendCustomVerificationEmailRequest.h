...
/*
 * OAISendCustomVerificationEmailRequest.h
 *
 * Represents a request to send a custom verification email to a specified recipient.
 */

#ifndef OAISendCustomVerificationEmailRequest_H
#define OAISendCustomVerificationEmailRequest_H
...
class OAISendCustomVerificationEmailRequest : public OAIObject {
public:
    OAISendCustomVerificationEmailRequest();
    OAISendCustomVerificationEmailRequest(QString json);
    ~OAISendCustomVerificationEmailRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendCustomVerificationEmailRequest)

#endif // OAISendCustomVerificationEmailRequest_H
