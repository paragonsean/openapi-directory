...
public class EventDestination {
  ...
  public EventDestination kinesisFirehoseDestination(GETCreateConfigurationSetEventDestinationEventDestinationParameterKinesisFirehoseDestination kinesisFirehoseDestination) {
  ...
  public EventDestination cloudWatchDestination(GETCreateConfigurationSetEventDestinationEventDestinationParameterCloudWatchDestination cloudWatchDestination) {
  ...
  public EventDestination snSDestination(GETCreateConfigurationSetEventDestinationEventDestinationParameterSNSDestination snSDestination) {
