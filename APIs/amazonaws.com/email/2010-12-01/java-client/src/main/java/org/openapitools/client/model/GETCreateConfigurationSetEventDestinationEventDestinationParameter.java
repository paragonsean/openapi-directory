...
public class GETCreateConfigurationSetEventDestinationEventDestinationParameter {
  ...
  public GETCreateConfigurationSetEventDestinationEventDestinationParameter() {
  }

  public GETCreateConfigurationSetEventDestinationEventDestinationParameter name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GETCreateConfigurationSetEventDestinationEventDestinationParameter enabled(Boolean enabled) {
  ...
  public GETCreateConfigurationSetEventDestinationEventDestinationParameter matchingEventTypes(List matchingEventTypes) {
  ...
  public GETCreateConfigurationSetEventDestinationEventDestinationParameter kinesisFirehoseDestination(GETCreateConfigurationSetEventDestinationEventDestinationParameterKinesisFirehoseDestination kinesisFirehoseDestination) {
  ...
  public GETCreateConfigurationSetEventDestinationEventDestinationParameter cloudWatchDestination(GETCreateConfigurationSetEventDestinationEventDestinationParameterCloudWatchDestination cloudWatchDestination) {
  ...
  public GETCreateConfigurationSetEventDestinationEventDestinationParameter snSDestination(GETCreateConfigurationSetEventDestinationEventDestinationParameterSNSDestination snSDestination) {
  ...
  public boolean equals(Object o) {
    ...
    GETCreateConfigurationSetEventDestinationEventDestinationParameter geTCreateConfigurationSetEventDestinationEventDestinationParameter = (GETCreateConfigurationSetEventDestinationEventDestinationParameter) o;
    return Objects.equals(this.name, geTCreateConfigurationSetEventDestinationEventDestinationParameter.name) &&
        Objects.equals(this.enabled, geTCreateConfigurationSetEventDestinationEventDestinationParameter.enabled) &&
        Objects.equals(this.matchingEventTypes, geTCreateConfigurationSetEventDestinationEventDestinationParameter.matchingEventTypes) &&
        Objects.equals(this.kinesisFirehoseDestination, geTCreateConfigurationSetEventDestinationEventDestinationParameter.kinesisFirehoseDestination) &&
        Objects.equals(this.cloudWatchDestination, geTCreateConfigurationSetEventDestinationEventDestinationParameter.cloudWatchDestination) &&
        Objects.equals(this.snSDestination, geTCreateConfigurationSetEventDestinationEventDestinationParameter.snSDestination);
  }
  ...
  public String toString() {
    ...
    sb.append("class GETCreateConfigurationSetEventDestinationEventDestinationParameter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GETCreateConfigurationSetEventDestinationEventDestinationParameter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GETCreateConfigurationSetEventDestinationEventDestinationParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETCreateConfigurationSetEventDestinationEventDestinationParameter is not found in the empty JSON string", GETCreateConfigurationSetEventDestinationEventDestinationParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GETCreateConfigurationSetEventDestinationEventDestinationParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GETCreateConfigurationSetEventDestinationEventDestinationParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GETCreateConfigurationSetEventDestinationEventDestinationParameter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETCreateConfigurationSetEventDestinationEventDestinationParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETCreateConfigurationSetEventDestinationEventDestinationParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETCreateConfigurationSetEventDestinationEventDestinationParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETCreateConfigurationSetEventDestinationEventDestinationParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<GETCreateConfigurationSetEventDestinationEventDestinationParameter>() {
           @Override
           public void write(JsonWriter out, GETCreateConfigurationSetEventDestinationEventDestinationParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GETCreateConfigurationSetEventDestinationEventDestinationParameter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GETCreateConfigurationSetEventDestinationEventDestinationParameter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GETCreateConfigurationSetEventDestinationEventDestinationParameter
   * @throws IOException if the JSON string is invalid with respect to GETCreateConfigurationSetEventDestinationEventDestinationParameter
   */
  public static GETCreateConfigurationSetEventDestinationEventDestinationParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETCreateConfigurationSetEventDestinationEventDestinationParameter.class);
  }

  /**
   * Convert an instance of GETCreateConfigurationSetEventDestinationEventDestinationParameter to an JSON string
   *
   * @return JSON string
   */
