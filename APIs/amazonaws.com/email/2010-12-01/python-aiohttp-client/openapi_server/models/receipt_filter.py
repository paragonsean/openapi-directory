...
class ReceiptFilter(Model):
    ...
    def __init__(self, name: str=None, ip_filter: GETCreateReceiptFilterFilterParameterIpFilter=None):
        """ReceiptFilter - a model defined in OpenAPI

        :param name: The name of this ReceiptFilter.
        :param ip_filter: The ip_filter of this ReceiptFilter.
        """
        self.openapi_types = {
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReceiptFilter':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ReceiptFilter of this ReceiptFilter.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this ReceiptFilter.


        :return: The name of this ReceiptFilter.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ReceiptFilter.
    ...
    @property
    def ip_filter(self):
        """Gets the ip_filter of this ReceiptFilter.


        :return: The ip_filter of this ReceiptFilter.
    ...
    def ip_filter(self, ip_filter):
        """Sets the ip_filter of this ReceiptFilter.
