...
public class ListEventsFilters {
  ...
  public ListEventsFilters() {
  }

  public ListEventsFilters insightId(String insightId) {
  ...
  public ListEventsFilters eventTimeRange(ListEventsRequestFiltersEventTimeRange eventTimeRange) {
  ...
  public ListEventsFilters eventClass(EventClass eventClass) {
  ...
  public ListEventsFilters eventSource(String eventSource) {
  ...
  public ListEventsFilters dataSource(EventDataSource dataSource) {
  ...
  public ListEventsFilters resourceCollection(ResourceCollection resourceCollection) {
  ...
  public boolean equals(Object o) {
    ...
    ListEventsFilters listEventsFilters = (ListEventsFilters) o;
    return Objects.equals(this.insightId, listEventsFilters.insightId) &&
        Objects.equals(this.eventTimeRange, listEventsFilters.eventTimeRange) &&
        Objects.equals(this.eventClass, listEventsFilters.eventClass) &&
        Objects.equals(this.eventSource, listEventsFilters.eventSource) &&
        Objects.equals(this.dataSource, listEventsFilters.dataSource) &&
        Objects.equals(this.resourceCollection, listEventsFilters.resourceCollection);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListEventsFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListEventsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListEventsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListEventsFilters is not found in the empty JSON string", ListEventsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListEventsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListEventsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListEventsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListEventsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListEventsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListEventsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ListEventsFilters>() {
           @Override
           public void write(JsonWriter out, ListEventsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListEventsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListEventsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListEventsFilters
   * @throws IOException if the JSON string is invalid with respect to ListEventsFilters
   */
  public static ListEventsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListEventsFilters.class);
  }

  /**
   * Convert an instance of ListEventsFilters to an JSON string
   *
   * @return JSON string
   */
