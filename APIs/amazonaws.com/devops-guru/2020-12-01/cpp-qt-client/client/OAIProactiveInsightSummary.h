...
/*
 * OAIProactiveInsightSummary.h
 *
 * Details about a proactive insight. This object is returned by &lt;code&gt;DescribeInsight.&lt;/code&gt; 
 */

#ifndef OAIProactiveInsightSummary_H
#define OAIProactiveInsightSummary_H
...
class OAIProactiveInsightSummary : public OAIObject {
public:
    OAIProactiveInsightSummary();
    OAIProactiveInsightSummary(QString json);
    ~OAIProactiveInsightSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProactiveInsightSummary)

#endif // OAIProactiveInsightSummary_H
