...
#include "OAIListEventsRequest_Filters.h"
...
OAIListEventsRequest_Filters::OAIListEventsRequest_Filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListEventsRequest_Filters::OAIListEventsRequest_Filters() {
    this->initializeModel();
}

OAIListEventsRequest_Filters::~OAIListEventsRequest_Filters() {}

void OAIListEventsRequest_Filters::initializeModel() {
...
void OAIListEventsRequest_Filters::fromJson(QString jsonString) {
...
void OAIListEventsRequest_Filters::fromJsonObject(QJsonObject json) {
...
QString OAIListEventsRequest_Filters::asJson() const {
...
QJsonObject OAIListEventsRequest_Filters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListEventsRequest_Filters::getInsightId() const {
    return m_insight_id;
}
void OAIListEventsRequest_Filters::setInsightId(const QString &insight_id) {
    m_insight_id = insight_id;
    m_insight_id_isSet = true;
}

bool OAIListEventsRequest_Filters::is_insight_id_Set() const{
    return m_insight_id_isSet;
}

bool OAIListEventsRequest_Filters::is_insight_id_Valid() const{
    return m_insight_id_isValid;
}

OAIListEvents_request_Filters_EventTimeRange OAIListEventsRequest_Filters::getEventTimeRange() const {
    return m_event_time_range;
}
void OAIListEventsRequest_Filters::setEventTimeRange(const OAIListEvents_request_Filters_EventTimeRange &event_time_range) {
    m_event_time_range = event_time_range;
    m_event_time_range_isSet = true;
}

bool OAIListEventsRequest_Filters::is_event_time_range_Set() const{
    return m_event_time_range_isSet;
}

bool OAIListEventsRequest_Filters::is_event_time_range_Valid() const{
    return m_event_time_range_isValid;
}

OAIEventClass OAIListEventsRequest_Filters::getEventClass() const {
    return m_event_class;
}
void OAIListEventsRequest_Filters::setEventClass(const OAIEventClass &event_class) {
    m_event_class = event_class;
    m_event_class_isSet = true;
}

bool OAIListEventsRequest_Filters::is_event_class_Set() const{
    return m_event_class_isSet;
}

bool OAIListEventsRequest_Filters::is_event_class_Valid() const{
    return m_event_class_isValid;
}

QString OAIListEventsRequest_Filters::getEventSource() const {
    return m_event_source;
}
void OAIListEventsRequest_Filters::setEventSource(const QString &event_source) {
    m_event_source = event_source;
    m_event_source_isSet = true;
}

bool OAIListEventsRequest_Filters::is_event_source_Set() const{
    return m_event_source_isSet;
}

bool OAIListEventsRequest_Filters::is_event_source_Valid() const{
    return m_event_source_isValid;
}

OAIEventDataSource OAIListEventsRequest_Filters::getDataSource() const {
    return m_data_source;
}
void OAIListEventsRequest_Filters::setDataSource(const OAIEventDataSource &data_source) {
    m_data_source = data_source;
    m_data_source_isSet = true;
}

bool OAIListEventsRequest_Filters::is_data_source_Set() const{
    return m_data_source_isSet;
}

bool OAIListEventsRequest_Filters::is_data_source_Valid() const{
    return m_data_source_isValid;
}

OAIResourceCollection OAIListEventsRequest_Filters::getResourceCollection() const {
    return m_resource_collection;
}
void OAIListEventsRequest_Filters::setResourceCollection(const OAIResourceCollection &resource_collection) {
    m_resource_collection = resource_collection;
    m_resource_collection_isSet = true;
}

bool OAIListEventsRequest_Filters::is_resource_collection_Set() const{
    return m_resource_collection_isSet;
}

bool OAIListEventsRequest_Filters::is_resource_collection_Valid() const{
    return m_resource_collection_isValid;
}

bool OAIListEventsRequest_Filters::isSet() const {
...
bool OAIListEventsRequest_Filters::isValid() const {
