...
/*
 * OAIListMonitoredResourcesFilters.h
 *
 *  Filters to determine which monitored resources you want to retrieve. You can filter by resource type or resource permission status. 
 */

#ifndef OAIListMonitoredResourcesFilters_H
#define OAIListMonitoredResourcesFilters_H
...
class OAIListMonitoredResourcesFilters : public OAIObject {
public:
    OAIListMonitoredResourcesFilters();
    OAIListMonitoredResourcesFilters(QString json);
    ~OAIListMonitoredResourcesFilters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMonitoredResourcesFilters)

#endif // OAIListMonitoredResourcesFilters_H
