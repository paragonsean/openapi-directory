...
/*
 * OAISearchInsights_request_Filters.h
 *
...
#ifndef OAISearchInsights_request_Filters_H
#define OAISearchInsights_request_Filters_H
...
class OAISearchInsights_request_Filters : public OAIObject {
public:
    OAISearchInsights_request_Filters();
    OAISearchInsights_request_Filters(QString json);
    ~OAISearchInsights_request_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchInsights_request_Filters)

#endif // OAISearchInsights_request_Filters_H
