...
/*
 * OAISearchOrganizationInsightsRequest_Filters.h
 *
 * 
 */

#ifndef OAISearchOrganizationInsightsRequest_Filters_H
#define OAISearchOrganizationInsightsRequest_Filters_H
...
class OAISearchOrganizationInsightsRequest_Filters : public OAIObject {
public:
    OAISearchOrganizationInsightsRequest_Filters();
    OAISearchOrganizationInsightsRequest_Filters(QString json);
    ~OAISearchOrganizationInsightsRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchOrganizationInsightsRequest_Filters)

#endif // OAISearchOrganizationInsightsRequest_Filters_H
