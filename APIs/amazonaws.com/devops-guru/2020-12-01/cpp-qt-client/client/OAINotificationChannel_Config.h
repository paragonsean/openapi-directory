...
/*
 * OAINotificationChannel_Config.h
 *
 * 
 */

#ifndef OAINotificationChannel_Config_H
#define OAINotificationChannel_Config_H
...
class OAINotificationChannel_Config : public OAIObject {
public:
    OAINotificationChannel_Config();
    OAINotificationChannel_Config(QString json);
    ~OAINotificationChannel_Config() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationChannel_Config)

#endif // OAINotificationChannel_Config_H
