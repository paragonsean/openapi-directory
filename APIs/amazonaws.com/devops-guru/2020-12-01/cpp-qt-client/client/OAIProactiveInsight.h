...
class OAIProactiveInsight : public OAIObject {
public:
    OAIProactiveInsight();
    OAIProactiveInsight(QString json);
    ~OAIProactiveInsight() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProactiveInsight)

#endif // OAIProactiveInsight_H
