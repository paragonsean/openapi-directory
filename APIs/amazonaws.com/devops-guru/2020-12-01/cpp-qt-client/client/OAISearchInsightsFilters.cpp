...
#include "OAISearchInsightsFilters.h"
...
OAISearchInsightsFilters::OAISearchInsightsFilters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchInsightsFilters::OAISearchInsightsFilters() {
    this->initializeModel();
}

OAISearchInsightsFilters::~OAISearchInsightsFilters() {}

void OAISearchInsightsFilters::initializeModel() {
...
void OAISearchInsightsFilters::fromJson(QString jsonString) {
...
void OAISearchInsightsFilters::fromJsonObject(QJsonObject json) {
...
QString OAISearchInsightsFilters::asJson() const {
...
QJsonObject OAISearchInsightsFilters::asJsonObject() const {
    QJsonObject obj;
...
QList OAISearchInsightsFilters::getSeverities() const {
    return m_severities;
}
void OAISearchInsightsFilters::setSeverities(const QList &severities) {
    m_severities = severities;
    m_severities_isSet = true;
}

bool OAISearchInsightsFilters::is_severities_Set() const{
    return m_severities_isSet;
}

bool OAISearchInsightsFilters::is_severities_Valid() const{
    return m_severities_isValid;
}

QList OAISearchInsightsFilters::getStatuses() const {
    return m_statuses;
}
void OAISearchInsightsFilters::setStatuses(const QList &statuses) {
    m_statuses = statuses;
    m_statuses_isSet = true;
}

bool OAISearchInsightsFilters::is_statuses_Set() const{
    return m_statuses_isSet;
}

bool OAISearchInsightsFilters::is_statuses_Valid() const{
    return m_statuses_isValid;
}

OAIResourceCollection OAISearchInsightsFilters::getResourceCollection() const {
    return m_resource_collection;
}
void OAISearchInsightsFilters::setResourceCollection(const OAIResourceCollection &resource_collection) {
    m_resource_collection = resource_collection;
    m_resource_collection_isSet = true;
}

bool OAISearchInsightsFilters::is_resource_collection_Set() const{
    return m_resource_collection_isSet;
}

bool OAISearchInsightsFilters::is_resource_collection_Valid() const{
    return m_resource_collection_isValid;
}

OAISearchInsights_request_Filters_ServiceCollection OAISearchInsightsFilters::getServiceCollection() const {
    return m_service_collection;
}
void OAISearchInsightsFilters::setServiceCollection(const OAISearchInsights_request_Filters_ServiceCollection &service_collection) {
    m_service_collection = service_collection;
    m_service_collection_isSet = true;
}

bool OAISearchInsightsFilters::is_service_collection_Set() const{
    return m_service_collection_isSet;
}

bool OAISearchInsightsFilters::is_service_collection_Valid() const{
    return m_service_collection_isValid;
}

bool OAISearchInsightsFilters::isSet() const {
...
bool OAISearchInsightsFilters::isValid() const {
