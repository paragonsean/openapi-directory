...
#ifndef OAIEventTimeRange_H
#define OAIEventTimeRange_H
...
class OAIEventTimeRange : public OAIObject {
public:
    OAIEventTimeRange();
    OAIEventTimeRange(QString json);
    ~OAIEventTimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventTimeRange)

#endif // OAIEventTimeRange_H
