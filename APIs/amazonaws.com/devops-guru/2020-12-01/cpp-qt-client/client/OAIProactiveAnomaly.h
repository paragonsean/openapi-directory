...
class OAIProactiveAnomaly_SourceMetadata;

class OAIProactiveAnomaly : public OAIObject {
public:
    OAIProactiveAnomaly();
    OAIProactiveAnomaly(QString json);
    ~OAIProactiveAnomaly() override;
    ...
    OAIProactiveAnomaly_SourceMetadata getSourceMetadata() const;
    void setSourceMetadata(const OAIProactiveAnomaly_SourceMetadata &source_metadata);
...
private:
    ...
    OAIProactiveAnomaly_SourceMetadata m_source_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProactiveAnomaly)

#endif // OAIProactiveAnomaly_H
