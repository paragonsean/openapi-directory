...
#include "OAIAccountHealth_Insight.h"
...
OAIAccountHealth_Insight::OAIAccountHealth_Insight(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountHealth_Insight::OAIAccountHealth_Insight() {
    this->initializeModel();
}

OAIAccountHealth_Insight::~OAIAccountHealth_Insight() {}

void OAIAccountHealth_Insight::initializeModel() {
...
void OAIAccountHealth_Insight::fromJson(QString jsonString) {
...
void OAIAccountHealth_Insight::fromJsonObject(QJsonObject json) {
...
QString OAIAccountHealth_Insight::asJson() const {
...
QJsonObject OAIAccountHealth_Insight::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAccountHealth_Insight::getOpenProactiveInsights() const {
    return m_open_proactive_insights;
}
void OAIAccountHealth_Insight::setOpenProactiveInsights(const qint32 &open_proactive_insights) {
    m_open_proactive_insights = open_proactive_insights;
    m_open_proactive_insights_isSet = true;
}

bool OAIAccountHealth_Insight::is_open_proactive_insights_Set() const{
    return m_open_proactive_insights_isSet;
}

bool OAIAccountHealth_Insight::is_open_proactive_insights_Valid() const{
    return m_open_proactive_insights_isValid;
}

qint32 OAIAccountHealth_Insight::getOpenReactiveInsights() const {
    return m_open_reactive_insights;
}
void OAIAccountHealth_Insight::setOpenReactiveInsights(const qint32 &open_reactive_insights) {
    m_open_reactive_insights = open_reactive_insights;
    m_open_reactive_insights_isSet = true;
}

bool OAIAccountHealth_Insight::is_open_reactive_insights_Set() const{
    return m_open_reactive_insights_isSet;
}

bool OAIAccountHealth_Insight::is_open_reactive_insights_Valid() const{
    return m_open_reactive_insights_isValid;
}

bool OAIAccountHealth_Insight::isSet() const {
...
bool OAIAccountHealth_Insight::isValid() const {
