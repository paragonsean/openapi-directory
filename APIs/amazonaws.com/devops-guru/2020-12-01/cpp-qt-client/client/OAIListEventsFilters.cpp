...
#include "OAIListEventsFilters.h"
...
OAIListEventsFilters::OAIListEventsFilters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListEventsFilters::OAIListEventsFilters() {
    this->initializeModel();
}

OAIListEventsFilters::~OAIListEventsFilters() {}

void OAIListEventsFilters::initializeModel() {
...
void OAIListEventsFilters::fromJson(QString jsonString) {
...
void OAIListEventsFilters::fromJsonObject(QJsonObject json) {
...
QString OAIListEventsFilters::asJson() const {
...
QJsonObject OAIListEventsFilters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListEventsFilters::getInsightId() const {
    return m_insight_id;
}
void OAIListEventsFilters::setInsightId(const QString &insight_id) {
    m_insight_id = insight_id;
    m_insight_id_isSet = true;
}

bool OAIListEventsFilters::is_insight_id_Set() const{
    return m_insight_id_isSet;
}

bool OAIListEventsFilters::is_insight_id_Valid() const{
    return m_insight_id_isValid;
}

OAIListEvents_request_Filters_EventTimeRange OAIListEventsFilters::getEventTimeRange() const {
    return m_event_time_range;
}
void OAIListEventsFilters::setEventTimeRange(const OAIListEvents_request_Filters_EventTimeRange &event_time_range) {
    m_event_time_range = event_time_range;
    m_event_time_range_isSet = true;
}

bool OAIListEventsFilters::is_event_time_range_Set() const{
    return m_event_time_range_isSet;
}

bool OAIListEventsFilters::is_event_time_range_Valid() const{
    return m_event_time_range_isValid;
}

OAIEventClass OAIListEventsFilters::getEventClass() const {
    return m_event_class;
}
void OAIListEventsFilters::setEventClass(const OAIEventClass &event_class) {
    m_event_class = event_class;
    m_event_class_isSet = true;
}

bool OAIListEventsFilters::is_event_class_Set() const{
    return m_event_class_isSet;
}

bool OAIListEventsFilters::is_event_class_Valid() const{
    return m_event_class_isValid;
}

QString OAIListEventsFilters::getEventSource() const {
    return m_event_source;
}
void OAIListEventsFilters::setEventSource(const QString &event_source) {
    m_event_source = event_source;
    m_event_source_isSet = true;
}

bool OAIListEventsFilters::is_event_source_Set() const{
    return m_event_source_isSet;
}

bool OAIListEventsFilters::is_event_source_Valid() const{
    return m_event_source_isValid;
}

OAIEventDataSource OAIListEventsFilters::getDataSource() const {
    return m_data_source;
}
void OAIListEventsFilters::setDataSource(const OAIEventDataSource &data_source) {
    m_data_source = data_source;
    m_data_source_isSet = true;
}

bool OAIListEventsFilters::is_data_source_Set() const{
    return m_data_source_isSet;
}

bool OAIListEventsFilters::is_data_source_Valid() const{
    return m_data_source_isValid;
}

OAIResourceCollection OAIListEventsFilters::getResourceCollection() const {
    return m_resource_collection;
}
void OAIListEventsFilters::setResourceCollection(const OAIResourceCollection &resource_collection) {
    m_resource_collection = resource_collection;
    m_resource_collection_isSet = true;
}

bool OAIListEventsFilters::is_resource_collection_Set() const{
    return m_resource_collection_isSet;
}

bool OAIListEventsFilters::is_resource_collection_Valid() const{
    return m_resource_collection_isValid;
}

bool OAIListEventsFilters::isSet() const {
...
bool OAIListEventsFilters::isValid() const {
