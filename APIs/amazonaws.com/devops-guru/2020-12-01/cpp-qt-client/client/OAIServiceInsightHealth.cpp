...
#include "OAIServiceInsightHealth.h"
...
OAIServiceInsightHealth::OAIServiceInsightHealth(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceInsightHealth::OAIServiceInsightHealth() {
    this->initializeModel();
}

OAIServiceInsightHealth::~OAIServiceInsightHealth() {}

void OAIServiceInsightHealth::initializeModel() {
...
void OAIServiceInsightHealth::fromJson(QString jsonString) {
...
void OAIServiceInsightHealth::fromJsonObject(QJsonObject json) {
...
QString OAIServiceInsightHealth::asJson() const {
...
QJsonObject OAIServiceInsightHealth::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIServiceInsightHealth::getOpenProactiveInsights() const {
    return m_open_proactive_insights;
}
void OAIServiceInsightHealth::setOpenProactiveInsights(const qint32 &open_proactive_insights) {
    m_open_proactive_insights = open_proactive_insights;
    m_open_proactive_insights_isSet = true;
}

bool OAIServiceInsightHealth::is_open_proactive_insights_Set() const{
    return m_open_proactive_insights_isSet;
}

bool OAIServiceInsightHealth::is_open_proactive_insights_Valid() const{
    return m_open_proactive_insights_isValid;
}

qint32 OAIServiceInsightHealth::getOpenReactiveInsights() const {
    return m_open_reactive_insights;
}
void OAIServiceInsightHealth::setOpenReactiveInsights(const qint32 &open_reactive_insights) {
    m_open_reactive_insights = open_reactive_insights;
    m_open_reactive_insights_isSet = true;
}

bool OAIServiceInsightHealth::is_open_reactive_insights_Set() const{
    return m_open_reactive_insights_isSet;
}

bool OAIServiceInsightHealth::is_open_reactive_insights_Valid() const{
    return m_open_reactive_insights_isValid;
}

bool OAIServiceInsightHealth::isSet() const {
...
bool OAIServiceInsightHealth::isValid() const {
