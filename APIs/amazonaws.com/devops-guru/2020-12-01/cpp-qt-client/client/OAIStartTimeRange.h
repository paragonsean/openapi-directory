...
#ifndef OAIStartTimeRange_H
#define OAIStartTimeRange_H
...
class OAIStartTimeRange : public OAIObject {
public:
    OAIStartTimeRange();
    OAIStartTimeRange(QString json);
    ~OAIStartTimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTimeRange)

#endif // OAIStartTimeRange_H
