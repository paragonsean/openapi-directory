...
/*
 * OAIProactiveOrganizationInsightSummary.h
 *
 * Details about a proactive insight. This object is returned by &lt;code&gt;DescribeInsight&lt;/code&gt;.
 */

#ifndef OAIProactiveOrganizationInsightSummary_H
#define OAIProactiveOrganizationInsightSummary_H
...
class OAIProactiveOrganizationInsightSummary : public OAIObject {
public:
    OAIProactiveOrganizationInsightSummary();
    OAIProactiveOrganizationInsightSummary(QString json);
    ~OAIProactiveOrganizationInsightSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProactiveOrganizationInsightSummary)

#endif // OAIProactiveOrganizationInsightSummary_H
