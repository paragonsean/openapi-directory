...
/*
 * OAIDescribeInsightResponse_ReactiveInsight.h
 *
 * 
 */

#ifndef OAIDescribeInsightResponse_ReactiveInsight_H
#define OAIDescribeInsightResponse_ReactiveInsight_H
...
class OAIDescribeInsightResponse_ReactiveInsight : public OAIObject {
public:
    OAIDescribeInsightResponse_ReactiveInsight();
    OAIDescribeInsightResponse_ReactiveInsight(QString json);
    ~OAIDescribeInsightResponse_ReactiveInsight() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeInsightResponse_ReactiveInsight)

#endif // OAIDescribeInsightResponse_ReactiveInsight_H
