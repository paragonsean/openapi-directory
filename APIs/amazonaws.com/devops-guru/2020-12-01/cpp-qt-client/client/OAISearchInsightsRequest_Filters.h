...
/*
 * OAISearchInsightsRequest_Filters.h
 *
 * 
 */

#ifndef OAISearchInsightsRequest_Filters_H
#define OAISearchInsightsRequest_Filters_H
...
class OAISearchInsightsRequest_Filters : public OAIObject {
public:
    OAISearchInsightsRequest_Filters();
    OAISearchInsightsRequest_Filters(QString json);
    ~OAISearchInsightsRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchInsightsRequest_Filters)

#endif // OAISearchInsightsRequest_Filters_H
