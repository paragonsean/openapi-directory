...
/*
 * OAIDescribeAnomalyResponse_ProactiveAnomaly.h
 *
 * 
 */

#ifndef OAIDescribeAnomalyResponse_ProactiveAnomaly_H
#define OAIDescribeAnomalyResponse_ProactiveAnomaly_H
...
class OAIDescribeAnomalyResponse_ProactiveAnomaly : public OAIObject {
public:
    OAIDescribeAnomalyResponse_ProactiveAnomaly();
    OAIDescribeAnomalyResponse_ProactiveAnomaly(QString json);
    ~OAIDescribeAnomalyResponse_ProactiveAnomaly() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAnomalyResponse_ProactiveAnomaly)

#endif // OAIDescribeAnomalyResponse_ProactiveAnomaly_H
