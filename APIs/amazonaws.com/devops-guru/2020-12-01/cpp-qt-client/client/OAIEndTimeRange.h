...
#ifndef OAIEndTimeRange_H
#define OAIEndTimeRange_H
...
class OAIEndTimeRange : public OAIObject {
public:
    OAIEndTimeRange();
    OAIEndTimeRange(QString json);
    ~OAIEndTimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndTimeRange)

#endif // OAIEndTimeRange_H
