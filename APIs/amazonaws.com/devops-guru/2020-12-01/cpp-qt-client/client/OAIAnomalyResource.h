...
#ifndef OAIAnomalyResource_H
#define OAIAnomalyResource_H
...
class OAIAnomalyResource : public OAIObject {
public:
    OAIAnomalyResource();
    OAIAnomalyResource(QString json);
    ~OAIAnomalyResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnomalyResource)

#endif // OAIAnomalyResource_H
