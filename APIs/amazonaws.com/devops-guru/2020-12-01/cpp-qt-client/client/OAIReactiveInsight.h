...
class OAIReactiveInsight : public OAIObject {
public:
    OAIReactiveInsight();
    OAIReactiveInsight(QString json);
    ~OAIReactiveInsight() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactiveInsight)

#endif // OAIReactiveInsight_H
