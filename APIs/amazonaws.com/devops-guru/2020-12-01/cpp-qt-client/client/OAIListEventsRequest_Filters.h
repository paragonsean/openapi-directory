...
/*
 * OAIListEventsRequest_Filters.h
 *
 * 
 */

#ifndef OAIListEventsRequest_Filters_H
#define OAIListEventsRequest_Filters_H
...
class OAIListEventsRequest_Filters : public OAIObject {
public:
    OAIListEventsRequest_Filters();
    OAIListEventsRequest_Filters(QString json);
    ~OAIListEventsRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventsRequest_Filters)

#endif // OAIListEventsRequest_Filters_H
