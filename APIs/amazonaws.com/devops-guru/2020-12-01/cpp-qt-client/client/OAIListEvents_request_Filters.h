...
/*
 * OAIListEvents_request_Filters.h
 *
 *  Filters you can use to specify which events are returned when &lt;code&gt;ListEvents&lt;/code&gt; is called. 
 */

#ifndef OAIListEvents_request_Filters_H
#define OAIListEvents_request_Filters_H
...
class OAIListEvents_request_Filters : public OAIObject {
public:
    OAIListEvents_request_Filters();
    OAIListEvents_request_Filters(QString json);
    ~OAIListEvents_request_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEvents_request_Filters)

#endif // OAIListEvents_request_Filters_H
