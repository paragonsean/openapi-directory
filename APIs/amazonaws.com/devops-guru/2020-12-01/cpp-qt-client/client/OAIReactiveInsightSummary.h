...
/*
 * OAIReactiveInsightSummary.h
 *
 *  Information about a reactive insight. This object is returned by &lt;code&gt;DescribeInsight.&lt;/code&gt; 
 */

#ifndef OAIReactiveInsightSummary_H
#define OAIReactiveInsightSummary_H
...
class OAIReactiveInsightSummary : public OAIObject {
public:
    OAIReactiveInsightSummary();
    OAIReactiveInsightSummary(QString json);
    ~OAIReactiveInsightSummary() override;
    ...
    QList getAssociatedResourceArns() const;
    void setAssociatedResourceArns(const QList &associated_resource_arns);
    bool is_associated_resource_arns_Set() const;
    bool is_associated_resource_arns_Valid() const;
...
private:
    ...
    QList m_associated_resource_arns;
    bool m_associated_resource_arns_isSet;
    bool m_associated_resource_arns_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIReactiveInsightSummary)

#endif // OAIReactiveInsightSummary_H
