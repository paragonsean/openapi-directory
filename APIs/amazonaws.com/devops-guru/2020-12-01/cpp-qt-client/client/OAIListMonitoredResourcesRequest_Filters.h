...
/*
 * OAIListMonitoredResourcesRequest_Filters.h
 *
 * 
 */

#ifndef OAIListMonitoredResourcesRequest_Filters_H
#define OAIListMonitoredResourcesRequest_Filters_H
...
class OAIListMonitoredResourcesRequest_Filters : public OAIObject {
public:
    OAIListMonitoredResourcesRequest_Filters();
    OAIListMonitoredResourcesRequest_Filters(QString json);
    ~OAIListMonitoredResourcesRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMonitoredResourcesRequest_Filters)

#endif // OAIListMonitoredResourcesRequest_Filters_H
