...
/*
 * OAIAddNotificationChannelRequest_Config.h
 *
 * 
 */

#ifndef OAIAddNotificationChannelRequest_Config_H
#define OAIAddNotificationChannelRequest_Config_H
...
class OAIAddNotificationChannelRequest_Config : public OAIObject {
public:
    OAIAddNotificationChannelRequest_Config();
    OAIAddNotificationChannelRequest_Config(QString json);
    ~OAIAddNotificationChannelRequest_Config() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddNotificationChannelRequest_Config)

#endif // OAIAddNotificationChannelRequest_Config_H
