...
/*
 * OAIAddNotificationChannel_request_Config.h
 *
 *  Information about notification channels you have configured with DevOps Guru. The one supported notification channel is Amazon Simple Notification Service (Amazon SNS).
 */

#ifndef OAIAddNotificationChannel_request_Config_H
#define OAIAddNotificationChannel_request_Config_H
...
class OAIAddNotificationChannel_request_Config : public OAIObject {
public:
    OAIAddNotificationChannel_request_Config();
    OAIAddNotificationChannel_request_Config(QString json);
    ~OAIAddNotificationChannel_request_Config() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddNotificationChannel_request_Config)

#endif // OAIAddNotificationChannel_request_Config_H
