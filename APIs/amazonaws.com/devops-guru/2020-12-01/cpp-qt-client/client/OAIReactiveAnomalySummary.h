...
/*
 * OAIReactiveAnomalySummary.h
 *
 * Details about a reactive anomaly. This object is returned by &lt;code&gt;DescribeAnomaly.&lt;/code&gt; 
 */

#ifndef OAIReactiveAnomalySummary_H
#define OAIReactiveAnomalySummary_H
...
class OAIReactiveAnomalySummary : public OAIObject {
public:
    OAIReactiveAnomalySummary();
    OAIReactiveAnomalySummary(QString json);
    ~OAIReactiveAnomalySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactiveAnomalySummary)

#endif // OAIReactiveAnomalySummary_H
