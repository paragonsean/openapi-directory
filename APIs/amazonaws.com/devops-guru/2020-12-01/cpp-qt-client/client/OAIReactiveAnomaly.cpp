...
OAIReactiveAnomaly::OAIReactiveAnomaly(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReactiveAnomaly::OAIReactiveAnomaly() {
    this->initializeModel();
}

OAIReactiveAnomaly::~OAIReactiveAnomaly() {}

void OAIReactiveAnomaly::initializeModel() {
...
void OAIReactiveAnomaly::fromJson(QString jsonString) {
...
void OAIReactiveAnomaly::fromJsonObject(QJsonObject json) {
...
QString OAIReactiveAnomaly::asJson() const {
...
QJsonObject OAIReactiveAnomaly::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIReactiveAnomaly::getId() const {
    return m_id;
}
void OAIReactiveAnomaly::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIReactiveAnomaly::is_id_Set() const{
    return m_id_isSet;
}

bool OAIReactiveAnomaly::is_id_Valid() const{
    return m_id_isValid;
}

OAIAnomalySeverity OAIReactiveAnomaly::getSeverity() const {
    return m_severity;
}
void OAIReactiveAnomaly::setSeverity(const OAIAnomalySeverity &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIReactiveAnomaly::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIReactiveAnomaly::is_severity_Valid() const{
    return m_severity_isValid;
}

OAIAnomalyStatus OAIReactiveAnomaly::getStatus() const {
    return m_status;
}
void OAIReactiveAnomaly::setStatus(const OAIAnomalyStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIReactiveAnomaly::is_status_Set() const{
    return m_status_isSet;
}

bool OAIReactiveAnomaly::is_status_Valid() const{
    return m_status_isValid;
}

OAIAnomalyTimeRange OAIReactiveAnomaly::getAnomalyTimeRange() const {
    return m_anomaly_time_range;
}
void OAIReactiveAnomaly::setAnomalyTimeRange(const OAIAnomalyTimeRange &anomaly_time_range) {
    m_anomaly_time_range = anomaly_time_range;
    m_anomaly_time_range_isSet = true;
}

bool OAIReactiveAnomaly::is_anomaly_time_range_Set() const{
    return m_anomaly_time_range_isSet;
}

bool OAIReactiveAnomaly::is_anomaly_time_range_Valid() const{
    return m_anomaly_time_range_isValid;
}

OAIProactiveAnomaly_AnomalyReportedTimeRange OAIReactiveAnomaly::getAnomalyReportedTimeRange() const {
    return m_anomaly_reported_time_range;
}
void OAIReactiveAnomaly::setAnomalyReportedTimeRange(const OAIProactiveAnomaly_AnomalyReportedTimeRange &anomaly_reported_time_range) {
    m_anomaly_reported_time_range = anomaly_reported_time_range;
    m_anomaly_reported_time_range_isSet = true;
}

bool OAIReactiveAnomaly::is_anomaly_reported_time_range_Set() const{
    return m_anomaly_reported_time_range_isSet;
}

bool OAIReactiveAnomaly::is_anomaly_reported_time_range_Valid() const{
    return m_anomaly_reported_time_range_isValid;
}

OAIProactiveAnomaly_SourceDetails OAIReactiveAnomaly::getSourceDetails() const {
    return m_source_details;
}
void OAIReactiveAnomaly::setSourceDetails(const OAIProactiveAnomaly_SourceDetails &source_details) {
    m_source_details = source_details;
    m_source_details_isSet = true;
}

bool OAIReactiveAnomaly::is_source_details_Set() const{
    return m_source_details_isSet;
}

bool OAIReactiveAnomaly::is_source_details_Valid() const{
    return m_source_details_isValid;
}

QString OAIReactiveAnomaly::getAssociatedInsightId() const {
    return m_associated_insight_id;
}
void OAIReactiveAnomaly::setAssociatedInsightId(const QString &associated_insight_id) {
    m_associated_insight_id = associated_insight_id;
    m_associated_insight_id_isSet = true;
}

bool OAIReactiveAnomaly::is_associated_insight_id_Set() const{
    return m_associated_insight_id_isSet;
}

bool OAIReactiveAnomaly::is_associated_insight_id_Valid() const{
    return m_associated_insight_id_isValid;
}

OAIResourceCollection OAIReactiveAnomaly::getResourceCollection() const {
    return m_resource_collection;
}
void OAIReactiveAnomaly::setResourceCollection(const OAIResourceCollection &resource_collection) {
    m_resource_collection = resource_collection;
    m_resource_collection_isSet = true;
}

bool OAIReactiveAnomaly::is_resource_collection_Set() const{
    return m_resource_collection_isSet;
}

bool OAIReactiveAnomaly::is_resource_collection_Valid() const{
    return m_resource_collection_isValid;
}

OAIAnomalyType OAIReactiveAnomaly::getType() const {
    return m_type;
}
void OAIReactiveAnomaly::setType(const OAIAnomalyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIReactiveAnomaly::is_type_Set() const{
    return m_type_isSet;
}

bool OAIReactiveAnomaly::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIReactiveAnomaly::getName() const {
    return m_name;
}
void OAIReactiveAnomaly::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIReactiveAnomaly::is_name_Set() const{
    return m_name_isSet;
}

bool OAIReactiveAnomaly::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIReactiveAnomaly::getDescription() const {
    return m_description;
}
void OAIReactiveAnomaly::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIReactiveAnomaly::is_description_Set() const{
    return m_description_isSet;
}

bool OAIReactiveAnomaly::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIReactiveAnomaly::getCausalAnomalyId() const {
    return m_causal_anomaly_id;
}
void OAIReactiveAnomaly::setCausalAnomalyId(const QString &causal_anomaly_id) {
    m_causal_anomaly_id = causal_anomaly_id;
    m_causal_anomaly_id_isSet = true;
}

bool OAIReactiveAnomaly::is_causal_anomaly_id_Set() const{
    return m_causal_anomaly_id_isSet;
}

bool OAIReactiveAnomaly::is_causal_anomaly_id_Valid() const{
    return m_causal_anomaly_id_isValid;
}

QList OAIReactiveAnomaly::getAnomalyResources() const {
    return m_anomaly_resources;
}
void OAIReactiveAnomaly::setAnomalyResources(const QList &anomaly_resources) {
    m_anomaly_resources = anomaly_resources;
    m_anomaly_resources_isSet = true;
}

bool OAIReactiveAnomaly::is_anomaly_resources_Set() const{
    return m_anomaly_resources_isSet;
}

bool OAIReactiveAnomaly::is_anomaly_resources_Valid() const{
    return m_anomaly_resources_isValid;
}

bool OAIReactiveAnomaly::isSet() const {
...
bool OAIReactiveAnomaly::isValid() const {
