...
#include "OAIAccountInsightHealth.h"
...
OAIAccountInsightHealth::OAIAccountInsightHealth(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountInsightHealth::OAIAccountInsightHealth() {
    this->initializeModel();
}

OAIAccountInsightHealth::~OAIAccountInsightHealth() {}

void OAIAccountInsightHealth::initializeModel() {
...
void OAIAccountInsightHealth::fromJson(QString jsonString) {
...
void OAIAccountInsightHealth::fromJsonObject(QJsonObject json) {
...
QString OAIAccountInsightHealth::asJson() const {
...
QJsonObject OAIAccountInsightHealth::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAccountInsightHealth::getOpenProactiveInsights() const {
    return m_open_proactive_insights;
}
void OAIAccountInsightHealth::setOpenProactiveInsights(const qint32 &open_proactive_insights) {
    m_open_proactive_insights = open_proactive_insights;
    m_open_proactive_insights_isSet = true;
}

bool OAIAccountInsightHealth::is_open_proactive_insights_Set() const{
    return m_open_proactive_insights_isSet;
}

bool OAIAccountInsightHealth::is_open_proactive_insights_Valid() const{
    return m_open_proactive_insights_isValid;
}

qint32 OAIAccountInsightHealth::getOpenReactiveInsights() const {
    return m_open_reactive_insights;
}
void OAIAccountInsightHealth::setOpenReactiveInsights(const qint32 &open_reactive_insights) {
    m_open_reactive_insights = open_reactive_insights;
    m_open_reactive_insights_isSet = true;
}

bool OAIAccountInsightHealth::is_open_reactive_insights_Set() const{
    return m_open_reactive_insights_isSet;
}

bool OAIAccountInsightHealth::is_open_reactive_insights_Valid() const{
    return m_open_reactive_insights_isValid;
}

bool OAIAccountInsightHealth::isSet() const {
...
bool OAIAccountInsightHealth::isValid() const {
