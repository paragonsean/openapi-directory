...
class OAIReactiveAnomaly : public OAIObject {
public:
    OAIReactiveAnomaly();
    OAIReactiveAnomaly(QString json);
    ~OAIReactiveAnomaly() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactiveAnomaly)

#endif // OAIReactiveAnomaly_H
