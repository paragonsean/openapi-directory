...
QString OAITagCollection::getAppBoundaryKey() const {
    return m_app_boundary_key;
}
void OAITagCollection::setAppBoundaryKey(const QString &app_boundary_key) {
    m_app_boundary_key = app_boundary_key;
    m_app_boundary_key_isSet = true;
}

bool OAITagCollection::is_app_boundary_key_Set() const{
    return m_app_boundary_key_isSet;
}

bool OAITagCollection::is_app_boundary_key_Valid() const{
    return m_app_boundary_key_isValid;
}

QList OAITagCollection::getTagValues() const {
    return m_tag_values;
}
void OAITagCollection::setTagValues(const QList &tag_values) {
    m_tag_values = tag_values;
    m_tag_values_isSet = true;
}

bool OAITagCollection::is_tag_values_Set() const{
    return m_tag_values_isSet;
}

bool OAITagCollection::is_tag_values_Valid() const{
