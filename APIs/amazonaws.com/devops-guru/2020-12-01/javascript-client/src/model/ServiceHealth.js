...
import ServiceHealthInsight from './ServiceHealthInsight';
...
class ServiceHealth {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Insight')) {
                obj['Insight'] = ServiceHealthInsight.constructFromObject(data['Insight']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Insight']) { // data not null
          ServiceHealthInsight.validateJSON(data['Insight']);
        }
 ...
 */
ServiceHealth.prototype['ServiceName'] = undefined;

/**
 * @member {module:model/ServiceHealthInsight} Insight
 */
ServiceHealth.prototype['Insight'] = undefined;

/**
 * @member {Number} AnalyzedResourceCount
 */
ServiceHealth.prototype['AnalyzedResourceCount'] = undefined;
