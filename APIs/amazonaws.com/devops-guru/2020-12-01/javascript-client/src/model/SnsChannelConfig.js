...
/**
 * The SnsChannelConfig model module.
 * @module model/SnsChannelConfig
 * @version 2020-12-01
 */
class SnsChannelConfig {
    /**
     * Constructs a new <code>SnsChannelConfig</code>.
     ...
     * @alias module:model/SnsChannelConfig
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SnsChannelConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SnsChannelConfig} obj Optional instance to populate.
     * @return {module:model/SnsChannelConfig} The populated <code>SnsChannelConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SnsChannelConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>SnsChannelConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SnsChannelConfig</code>.
     */
...
export default SnsChannelConfig;
