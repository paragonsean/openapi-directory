...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.ListEventsFilters();
  });
  ...
  describe('ListEventsFilters', function() {
    it('should create an instance of ListEventsFilters', function() {
      // uncomment below and update the code to test ListEventsFilters
      //var instance = new AmazonDevOpsGuru.ListEventsFilters();
      //expect(instance).to.be.a(AmazonDevOpsGuru.ListEventsFilters);
    });
    ...
    it('should have the property eventTimeRange (base name: "EventTimeRange")', function() {
      // uncomment below and update the code to test the property eventTimeRange
      //var instance = new AmazonDevOpsGuru.ListEventsFilters();
      //expect(instance).to.be();
    });
