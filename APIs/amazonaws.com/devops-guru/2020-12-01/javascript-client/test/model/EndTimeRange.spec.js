...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.EndTimeRange();
  });
  ...
  describe('EndTimeRange', function() {
    it('should create an instance of EndTimeRange', function() {
      // uncomment below and update the code to test EndTimeRange
      //var instance = new AmazonDevOpsGuru.EndTimeRange();
      //expect(instance).to.be.a(AmazonDevOpsGuru.EndTimeRange);
    });
