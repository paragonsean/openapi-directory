...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.GetCostEstimationResponse();
  });
  ...
  describe('GetCostEstimationResponse', function() {
    it('should create an instance of GetCostEstimationResponse', function() {
      // uncomment below and update the code to test GetCostEstimationResponse
      //var instance = new AmazonDevOpsGuru.GetCostEstimationResponse();
      //expect(instance).to.be.a(AmazonDevOpsGuru.GetCostEstimationResponse);
    });
