...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.ListMonitoredResourcesRequest();
  });
  ...
  describe('ListMonitoredResourcesRequest', function() {
    it('should create an instance of ListMonitoredResourcesRequest', function() {
      // uncomment below and update the code to test ListMonitoredResourcesRequest
      //var instance = new AmazonDevOpsGuru.ListMonitoredResourcesRequest();
      //expect(instance).to.be.a(AmazonDevOpsGuru.ListMonitoredResourcesRequest);
    });
