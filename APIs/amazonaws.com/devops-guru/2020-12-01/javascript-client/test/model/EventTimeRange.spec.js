...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.EventTimeRange();
  });
  ...
  describe('EventTimeRange', function() {
    it('should create an instance of EventTimeRange', function() {
      // uncomment below and update the code to test EventTimeRange
      //var instance = new AmazonDevOpsGuru.EventTimeRange();
      //expect(instance).to.be.a(AmazonDevOpsGuru.EventTimeRange);
    });
