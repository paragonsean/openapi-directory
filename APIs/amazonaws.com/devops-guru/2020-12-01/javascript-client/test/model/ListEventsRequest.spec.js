...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.ListEventsRequest();
  });
  ...
  describe('ListEventsRequest', function() {
    it('should create an instance of ListEventsRequest', function() {
      // uncomment below and update the code to test ListEventsRequest
      //var instance = new AmazonDevOpsGuru.ListEventsRequest();
      //expect(instance).to.be.a(AmazonDevOpsGuru.ListEventsRequest);
    });
