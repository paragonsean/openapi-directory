...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.ListEventsRequestFilters();
  });
  ...
  describe('ListEventsRequestFilters', function() {
    it('should create an instance of ListEventsRequestFilters', function() {
      // uncomment below and update the code to test ListEventsRequestFilters
      //var instance = new AmazonDevOpsGuru.ListEventsRequestFilters();
      //expect(instance).to.be.a(AmazonDevOpsGuru.ListEventsRequestFilters);
    });
