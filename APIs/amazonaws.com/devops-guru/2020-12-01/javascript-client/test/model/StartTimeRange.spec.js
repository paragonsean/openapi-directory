...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.StartTimeRange();
  });
  ...
  describe('StartTimeRange', function() {
    it('should create an instance of StartTimeRange', function() {
      // uncomment below and update the code to test StartTimeRange
      //var instance = new AmazonDevOpsGuru.StartTimeRange();
      //expect(instance).to.be.a(AmazonDevOpsGuru.StartTimeRange);
    });
