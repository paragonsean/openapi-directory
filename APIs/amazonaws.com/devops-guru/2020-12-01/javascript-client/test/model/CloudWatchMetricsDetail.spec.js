...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.CloudWatchMetricsDetail();
  });
  ...
  describe('CloudWatchMetricsDetail', function() {
    it('should create an instance of CloudWatchMetricsDetail', function() {
      // uncomment below and update the code to test CloudWatchMetricsDetail
      //var instance = new AmazonDevOpsGuru.CloudWatchMetricsDetail();
      //expect(instance).to.be.a(AmazonDevOpsGuru.CloudWatchMetricsDetail);
    });
    ...
    it('should have the property metricDataSummary (base name: "MetricDataSummary")', function() {
      // uncomment below and update the code to test the property metricDataSummary
      //var instance = new AmazonDevOpsGuru.CloudWatchMetricsDetail();
      //expect(instance).to.be();
    });
