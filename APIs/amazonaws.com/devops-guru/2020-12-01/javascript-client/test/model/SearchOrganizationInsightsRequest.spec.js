...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.SearchOrganizationInsightsRequest();
  });
  ...
  describe('SearchOrganizationInsightsRequest', function() {
    it('should create an instance of SearchOrganizationInsightsRequest', function() {
      // uncomment below and update the code to test SearchOrganizationInsightsRequest
      //var instance = new AmazonDevOpsGuru.SearchOrganizationInsightsRequest();
      //expect(instance).to.be.a(AmazonDevOpsGuru.SearchOrganizationInsightsRequest);
    });
