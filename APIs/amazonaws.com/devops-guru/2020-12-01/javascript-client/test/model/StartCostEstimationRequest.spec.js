...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDevOpsGuru.StartCostEstimationRequest();
  });
  ...
  describe('StartCostEstimationRequest', function() {
    it('should create an instance of StartCostEstimationRequest', function() {
      // uncomment below and update the code to test StartCostEstimationRequest
      //var instance = new AmazonDevOpsGuru.StartCostEstimationRequest();
      //expect(instance).to.be.a(AmazonDevOpsGuru.StartCostEstimationRequest);
    });
