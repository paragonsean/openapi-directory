...
class ListInsightsRequestStatusFilter(Model):
    ...
    def __init__(self, ongoing: ListInsightsRequestStatusFilterOngoing=None, closed: ListInsightsRequestStatusFilterClosed=None, any: ListInsightsRequestStatusFilterAny=None):
        """ListInsightsRequestStatusFilter - a model defined in OpenAPI

        :param ongoing: The ongoing of this ListInsightsRequestStatusFilter.
        :param closed: The closed of this ListInsightsRequestStatusFilter.
        :param any: The any of this ListInsightsRequestStatusFilter.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListInsightsRequestStatusFilter':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListInsightsRequest_StatusFilter of this ListInsightsRequestStatusFilter.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def ongoing(self):
        """Gets the ongoing of this ListInsightsRequestStatusFilter.


        :return: The ongoing of this ListInsightsRequestStatusFilter.
    ...
    def ongoing(self, ongoing):
        """Sets the ongoing of this ListInsightsRequestStatusFilter.
    ...
    @property
    def closed(self):
        """Gets the closed of this ListInsightsRequestStatusFilter.


        :return: The closed of this ListInsightsRequestStatusFilter.
    ...
    def closed(self, closed):
        """Sets the closed of this ListInsightsRequestStatusFilter.
    ...
    @property
    def any(self):
        """Gets the any of this ListInsightsRequestStatusFilter.


        :return: The any of this ListInsightsRequestStatusFilter.
    ...
    @any.setter
    def any(self, any):
        """Sets the any of this ListInsightsRequestStatusFilter.
