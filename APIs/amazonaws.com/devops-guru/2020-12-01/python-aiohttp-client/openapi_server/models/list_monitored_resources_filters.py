...
class ListMonitoredResourcesFilters(Model):
    ...
    def __init__(self, resource_permission: ResourcePermission=None, resource_type_filters: List=None):
        """ListMonitoredResourcesFilters - a model defined in OpenAPI

        :param resource_permission: The resource_permission of this ListMonitoredResourcesFilters.
        :param resource_type_filters: The resource_type_filters of this ListMonitoredResourcesFilters.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListMonitoredResourcesFilters':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListMonitoredResourcesFilters of this ListMonitoredResourcesFilters.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def resource_permission(self):
        """Gets the resource_permission of this ListMonitoredResourcesFilters.


        :return: The resource_permission of this ListMonitoredResourcesFilters.
    ...
    def resource_permission(self, resource_permission):
        """Sets the resource_permission of this ListMonitoredResourcesFilters.
    ...
    def resource_type_filters(self):
        """Gets the resource_type_filters of this ListMonitoredResourcesFilters.


        :return: The resource_type_filters of this ListMonitoredResourcesFilters.
        :rtype: List
        """
    ...
    def resource_type_filters(self, resource_type_filters):
        """Sets the resource_type_filters of this ListMonitoredResourcesFilters.
