...
class PerformanceInsightsReferenceComparisonValues(Model):
    ...
    def __init__(self, reference_scalar: PerformanceInsightsReferenceComparisonValuesReferenceScalar=None, reference_metric: PerformanceInsightsReferenceComparisonValuesReferenceMetric=None):
        """PerformanceInsightsReferenceComparisonValues - a model defined in OpenAPI

        :param reference_scalar: The reference_scalar of this PerformanceInsightsReferenceComparisonValues.
        :param reference_metric: The reference_metric of this PerformanceInsightsReferenceComparisonValues.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PerformanceInsightsReferenceComparisonValues':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PerformanceInsightsReferenceComparisonValues of this PerformanceInsightsReferenceComparisonValues.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def reference_scalar(self):
        """Gets the reference_scalar of this PerformanceInsightsReferenceComparisonValues.


        :return: The reference_scalar of this PerformanceInsightsReferenceComparisonValues.
    ...
    def reference_scalar(self, reference_scalar):
        """Sets the reference_scalar of this PerformanceInsightsReferenceComparisonValues.
    ...
    def reference_metric(self):
        """Gets the reference_metric of this PerformanceInsightsReferenceComparisonValues.


        :return: The reference_metric of this PerformanceInsightsReferenceComparisonValues.
    ...
    def reference_metric(self, reference_metric):
        """Sets the reference_metric of this PerformanceInsightsReferenceComparisonValues.
