...
async def test_add_notification_channel(client):
    """Test case for add_notification_channel

    
    """
    body = {"Config":{"Filters":{"MessageTypes":"","Severities":""},"Sns":{"TopicArn":""}}}
    headers = { 
...
async def test_delete_insight(client):
    """Test case for delete_insight
    ...
    response = await client.request(
        method='DELETE',
        path='/insights/{id}'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_account_health(client):
    """Test case for describe_account_health
...
async def test_describe_account_overview(client):
    """Test case for describe_account_overview
...
async def test_describe_anomaly(client):
    """Test case for describe_anomaly
    ...
    response = await client.request(
        method='GET',
        path='/anomalies/{id}'.format(id='id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_event_sources_config(client):
    """Test case for describe_event_sources_config
...
async def test_describe_feedback(client):
    """Test case for describe_feedback
...
async def test_describe_insight(client):
    """Test case for describe_insight
...
async def test_describe_organization_health(client):
    """Test case for describe_organization_health
...
async def test_describe_organization_overview(client):
    """Test case for describe_organization_overview

    
    """
    body = {"ToTime":"","AccountIds":"","FromTime":"","OrganizationalUnitIds":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_organization_resource_collection_health(client):
    """Test case for describe_organization_resource_collection_health

    
    """
    body = {"OrganizationResourceCollectionType":"","AccountIds":"","NextToken":"","MaxResults":"","OrganizationalUnitIds":""}
...
async def test_describe_resource_collection_health(client):
    """Test case for describe_resource_collection_health
    ...
    response = await client.request(
        method='GET',
        path='/accounts/health/resource-collection/{resource_collection_type}'.format(resource_collection_type='resource_collection_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_service_integration(client):
    """Test case for describe_service_integration
...
async def test_get_cost_estimation(client):
    """Test case for get_cost_estimation
...
async def test_get_resource_collection(client):
    """Test case for get_resource_collection
    ...
    response = await client.request(
        method='GET',
        path='/resource-collections/{resource_collection_type}'.format(resource_collection_type='resource_collection_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_anomalies_for_insight(client):
    """Test case for list_anomalies_for_insight

    
    """
    body = {"Filters":{"ServiceCollection":{"ServiceNames":""}},"AccountId":"","NextToken":"","MaxResults":"","StartTimeRange":{"ToTime":"","FromTime":""}}
    ...
    response = await client.request(
        method='POST',
        path='/anomalies/insight/{insight_id}'.format(insight_id='insight_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_anomalous_log_groups(client):
    """Test case for list_anomalous_log_groups

    
    """
    body = {"NextToken":"","MaxResults":"","InsightId":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_events(client):
    ...
    """
    body = {"Filters":{"EventClass":"","EventSource":"","EventTimeRange":{"ToTime":"","FromTime":""},"InsightId":"","DataSource":"","ResourceCollection":{"CloudFormation":{"StackNames":""},"Tags":""}},"AccountId":"","NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_insights(client):
    ...
    """
    body = {"NextToken":"","MaxResults":"","StatusFilter":{"Closed":{"Type":"","EndTimeRange":{"ToTime":"","FromTime":""}},"Ongoing":{"Type":""},"Any":{"Type":"","StartTimeRange":{"ToTime":"","FromTime":""}}}}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_monitored_resources(client):
    """Test case for list_monitored_resources

    
    """
    body = {"Filters":{"ResourceTypeFilters":"","ResourcePermission":""},"NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_organization_insights(client):
    """Test case for list_organization_insights

    
    """
    body = {"AccountIds":"","NextToken":"","MaxResults":"","StatusFilter":{"Closed":{"Type":"","EndTimeRange":{"ToTime":"","FromTime":""}},"Ongoing":{"Type":""},"Any":{"Type":"","StartTimeRange":{"ToTime":"","FromTime":""}}},"OrganizationalUnitIds":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_recommendations(client):
    ...
    """
    body = {"Locale":"","AccountId":"","NextToken":"","InsightId":""}
    params = [('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_put_feedback(client):
    ...
    """
    body = {"InsightFeedback":{"Feedback":"","Id":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_search_insights(client):
    """Test case for search_insights

    
    """
    body = {"Filters":{"ServiceCollection":{"ServiceNames":""},"Statuses":"","Severities":"","ResourceCollection":{"CloudFormation":{"StackNames":""},"Tags":""}},"Type":"","NextToken":"","MaxResults":"","StartTimeRange":{"ToTime":"","FromTime":""}}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_search_organization_insights(client):
    """Test case for search_organization_insights

    
    """
    body = {"Filters":{"ServiceCollection":{"ServiceNames":""},"Statuses":"","Severities":"","ResourceCollection":{"CloudFormation":{"StackNames":""},"Tags":""}},"Type":"","AccountIds":"","NextToken":"","MaxResults":"","StartTimeRange":{"ToTime":"","FromTime":""}}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_start_cost_estimation(client):
    """Test case for start_cost_estimation

    
    """
    body = {"ClientToken":"","ResourceCollection":{"CloudFormation":{"StackNames":""},"Tags":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_event_sources_config(client):
    """Test case for update_event_sources_config

    
    """
    body = {"EventSources":{"AmazonCodeGuruProfiler":{"Status":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_resource_collection(client):
    """Test case for update_resource_collection

    
    """
    body = {"Action":"","ResourceCollection":{"CloudFormation":{"StackNames":""},"Tags":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_service_integration(client):
    """Test case for update_service_integration

    
    """
    body = {"ServiceIntegration":{"OpsCenter":{"OptInStatus":""},"KMSServerSideEncryption":{"Type":"","KMSKeyId":"","OptInStatus":""},"LogsAnomalyDetection":{"OptInStatus":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
