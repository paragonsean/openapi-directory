...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.GetHostOutput();
  });
  ...
  describe('GetHostOutput', function() {
    it('should create an instance of GetHostOutput', function() {
      // uncomment below and update the code to test GetHostOutput
      //var instance = new AwsCodeStarConnections.GetHostOutput();
      //expect(instance).to.be.a(AwsCodeStarConnections.GetHostOutput);
    });
