...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.GetHostInput();
  });
  ...
  describe('GetHostInput', function() {
    it('should create an instance of GetHostInput', function() {
      // uncomment below and update the code to test GetHostInput
      //var instance = new AwsCodeStarConnections.GetHostInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.GetHostInput);
    });
