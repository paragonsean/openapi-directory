...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.ListConnectionsInput();
  });
  ...
  describe('ListConnectionsInput', function() {
    it('should create an instance of ListConnectionsInput', function() {
      // uncomment below and update the code to test ListConnectionsInput
      //var instance = new AwsCodeStarConnections.ListConnectionsInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.ListConnectionsInput);
    });

    it('should have the property providerTypeFilter (base name: "ProviderTypeFilter")', function() {
      // uncomment below and update the code to test the property providerTypeFilter
      //var instance = new AwsCodeStarConnections.ListConnectionsInput();
      //expect(instance).to.be();
    });

    it('should have the property hostArnFilter (base name: "HostArnFilter")', function() {
      // uncomment below and update the code to test the property hostArnFilter
      //var instance = new AwsCodeStarConnections.ListConnectionsInput();
      //expect(instance).to.be();
    });
