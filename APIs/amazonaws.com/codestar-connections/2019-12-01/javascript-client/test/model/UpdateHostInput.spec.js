...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.UpdateHostInput();
  });
  ...
  describe('UpdateHostInput', function() {
    it('should create an instance of UpdateHostInput', function() {
      // uncomment below and update the code to test UpdateHostInput
      //var instance = new AwsCodeStarConnections.UpdateHostInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.UpdateHostInput);
    });
