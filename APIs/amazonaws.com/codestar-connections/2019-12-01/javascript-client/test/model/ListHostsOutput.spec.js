...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.ListHostsOutput();
  });
  ...
  describe('ListHostsOutput', function() {
    it('should create an instance of ListHostsOutput', function() {
      // uncomment below and update the code to test ListHostsOutput
      //var instance = new AwsCodeStarConnections.ListHostsOutput();
      //expect(instance).to.be.a(AwsCodeStarConnections.ListHostsOutput);
    });
