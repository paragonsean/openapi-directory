...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.UpdateHostInputVpcConfiguration();
  });
  ...
  describe('UpdateHostInputVpcConfiguration', function() {
    it('should create an instance of UpdateHostInputVpcConfiguration', function() {
      // uncomment below and update the code to test UpdateHostInputVpcConfiguration
      //var instance = new AwsCodeStarConnections.UpdateHostInputVpcConfiguration();
      //expect(instance).to.be.a(AwsCodeStarConnections.UpdateHostInputVpcConfiguration);
    });
