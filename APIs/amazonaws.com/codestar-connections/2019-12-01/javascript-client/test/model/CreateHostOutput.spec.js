...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.CreateHostOutput();
  });
  ...
  describe('CreateHostOutput', function() {
    it('should create an instance of CreateHostOutput', function() {
      // uncomment below and update the code to test CreateHostOutput
      //var instance = new AwsCodeStarConnections.CreateHostOutput();
      //expect(instance).to.be.a(AwsCodeStarConnections.CreateHostOutput);
    });
