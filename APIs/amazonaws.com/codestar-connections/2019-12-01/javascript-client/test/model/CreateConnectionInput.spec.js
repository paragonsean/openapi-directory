...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.CreateConnectionInput();
  });
  ...
  describe('CreateConnectionInput', function() {
    it('should create an instance of CreateConnectionInput', function() {
      // uncomment below and update the code to test CreateConnectionInput
      //var instance = new AwsCodeStarConnections.CreateConnectionInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.CreateConnectionInput);
    });
