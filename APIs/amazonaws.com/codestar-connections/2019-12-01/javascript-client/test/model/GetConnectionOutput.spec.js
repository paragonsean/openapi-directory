...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.GetConnectionOutput();
  });
  ...
  describe('GetConnectionOutput', function() {
    it('should create an instance of GetConnectionOutput', function() {
      // uncomment below and update the code to test GetConnectionOutput
      //var instance = new AwsCodeStarConnections.GetConnectionOutput();
      //expect(instance).to.be.a(AwsCodeStarConnections.GetConnectionOutput);
    });
