...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.GetConnectionOutputConnection();
  });
  ...
  describe('GetConnectionOutputConnection', function() {
    it('should create an instance of GetConnectionOutputConnection', function() {
      // uncomment below and update the code to test GetConnectionOutputConnection
      //var instance = new AwsCodeStarConnections.GetConnectionOutputConnection();
      //expect(instance).to.be.a(AwsCodeStarConnections.GetConnectionOutputConnection);
    });
