...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.ListHostsInput();
  });
  ...
  describe('ListHostsInput', function() {
    it('should create an instance of ListHostsInput', function() {
      // uncomment below and update the code to test ListHostsInput
      //var instance = new AwsCodeStarConnections.ListHostsInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.ListHostsInput);
    });
