...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new AwsCodeStarConnections.TagResourceInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.TagResourceInput);
    });
