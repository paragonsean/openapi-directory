...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.CreateHostInput();
  });
  ...
  describe('CreateHostInput', function() {
    it('should create an instance of CreateHostInput', function() {
      // uncomment below and update the code to test CreateHostInput
      //var instance = new AwsCodeStarConnections.CreateHostInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.CreateHostInput);
    });
    ...
    it('should have the property providerEndpoint (base name: "ProviderEndpoint")', function() {
      // uncomment below and update the code to test the property providerEndpoint
      //var instance = new AwsCodeStarConnections.CreateHostInput();
      //expect(instance).to.be();
    });
