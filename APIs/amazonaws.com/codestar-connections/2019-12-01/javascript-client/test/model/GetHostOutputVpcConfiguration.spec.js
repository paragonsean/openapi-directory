...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.GetHostOutputVpcConfiguration();
  });
  ...
  describe('GetHostOutputVpcConfiguration', function() {
    it('should create an instance of GetHostOutputVpcConfiguration', function() {
      // uncomment below and update the code to test GetHostOutputVpcConfiguration
      //var instance = new AwsCodeStarConnections.GetHostOutputVpcConfiguration();
      //expect(instance).to.be.a(AwsCodeStarConnections.GetHostOutputVpcConfiguration);
    });
