...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.ListConnectionsOutput();
  });
  ...
  describe('ListConnectionsOutput', function() {
    it('should create an instance of ListConnectionsOutput', function() {
      // uncomment below and update the code to test ListConnectionsOutput
      //var instance = new AwsCodeStarConnections.ListConnectionsOutput();
      //expect(instance).to.be.a(AwsCodeStarConnections.ListConnectionsOutput);
    });
