...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.DeleteConnectionInput();
  });
  ...
  describe('DeleteConnectionInput', function() {
    it('should create an instance of DeleteConnectionInput', function() {
      // uncomment below and update the code to test DeleteConnectionInput
      //var instance = new AwsCodeStarConnections.DeleteConnectionInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.DeleteConnectionInput);
    });
