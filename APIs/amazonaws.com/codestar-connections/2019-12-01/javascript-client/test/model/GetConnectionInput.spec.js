...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.GetConnectionInput();
  });
  ...
  describe('GetConnectionInput', function() {
    it('should create an instance of GetConnectionInput', function() {
      // uncomment below and update the code to test GetConnectionInput
      //var instance = new AwsCodeStarConnections.GetConnectionInput();
      //expect(instance).to.be.a(AwsCodeStarConnections.GetConnectionInput);
    });
