...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.HostVpcConfiguration();
  });
  ...
  describe('HostVpcConfiguration', function() {
    it('should create an instance of HostVpcConfiguration', function() {
      // uncomment below and update the code to test HostVpcConfiguration
      //var instance = new AwsCodeStarConnections.HostVpcConfiguration();
      //expect(instance).to.be.a(AwsCodeStarConnections.HostVpcConfiguration);
    });
    ...
    it('should have the property tlsCertificate (base name: "TlsCertificate")', function() {
