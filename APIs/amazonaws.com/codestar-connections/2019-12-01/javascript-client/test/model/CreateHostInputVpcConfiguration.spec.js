...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.CreateHostInputVpcConfiguration();
  });
  ...
  describe('CreateHostInputVpcConfiguration', function() {
    it('should create an instance of CreateHostInputVpcConfiguration', function() {
      // uncomment below and update the code to test CreateHostInputVpcConfiguration
      //var instance = new AwsCodeStarConnections.CreateHostInputVpcConfiguration();
      //expect(instance).to.be.a(AwsCodeStarConnections.CreateHostInputVpcConfiguration);
    });
