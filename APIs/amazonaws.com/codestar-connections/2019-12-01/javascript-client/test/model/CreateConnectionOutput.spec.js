...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.CreateConnectionOutput();
  });
  ...
  describe('CreateConnectionOutput', function() {
    it('should create an instance of CreateConnectionOutput', function() {
      // uncomment below and update the code to test CreateConnectionOutput
      //var instance = new AwsCodeStarConnections.CreateConnectionOutput();
      //expect(instance).to.be.a(AwsCodeStarConnections.CreateConnectionOutput);
    });
