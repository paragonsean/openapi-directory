...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.VpcConfiguration();
  });
  ...
  describe('VpcConfiguration', function() {
    it('should create an instance of VpcConfiguration', function() {
      ...
      //var instance = new AwsCodeStarConnections.VpcConfiguration();
      //expect(instance).to.be.a(AwsCodeStarConnections.VpcConfiguration);
    });
