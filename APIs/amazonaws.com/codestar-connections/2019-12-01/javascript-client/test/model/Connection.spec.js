...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStarConnections.Connection();
  });
  ...
  describe('Connection', function() {
    it('should create an instance of Connection', function() {
      ...
      //var instance = new AwsCodeStarConnections.Connection();
      //expect(instance).to.be.a(AwsCodeStarConnections.Connection);
    });
