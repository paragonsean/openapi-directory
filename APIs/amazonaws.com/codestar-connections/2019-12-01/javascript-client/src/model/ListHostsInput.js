...
/**
 * The ListHostsInput model module.
 * @module model/ListHostsInput
 * @version 2019-12-01
 */
class ListHostsInput {
    /**
     * Constructs a new <code>ListHostsInput</code>.
     * @alias module:model/ListHostsInput
     */
    constructor() { 
        
        ListHostsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHostsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHostsInput} obj Optional instance to populate.
     * @return {module:model/ListHostsInput} The populated <code>ListHostsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHostsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListHostsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHostsInput</code>.
     */
 ...
 */
ListHostsInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListHostsInput.prototype['NextToken'] = undefined;
