...
/**
 * The CreateHostInputVpcConfiguration model module.
 * @module model/CreateHostInputVpcConfiguration
 * @version 2019-12-01
 */
class CreateHostInputVpcConfiguration {
    /**
     * Constructs a new <code>CreateHostInputVpcConfiguration</code>.
     * @alias module:model/CreateHostInputVpcConfiguration
    ...
    constructor(vpcId, subnetIds, securityGroupIds) { 
        ...
        CreateHostInputVpcConfiguration.initialize(this, vpcId, subnetIds, securityGroupIds);
    }
    ...
    /**
     * Constructs a <code>CreateHostInputVpcConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateHostInputVpcConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateHostInputVpcConfiguration} The populated <code>CreateHostInputVpcConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateHostInputVpcConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateHostInputVpcConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateHostInputVpcConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateHostInputVpcConfiguration.RequiredProperties) {
...
CreateHostInputVpcConfiguration.RequiredProperties = ["VpcId", "SubnetIds", "SecurityGroupIds"];

/**
 * @member {String} VpcId
 */
CreateHostInputVpcConfiguration.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
CreateHostInputVpcConfiguration.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} SecurityGroupIds
 */
CreateHostInputVpcConfiguration.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {String} TlsCertificate
 */
CreateHostInputVpcConfiguration.prototype['TlsCertificate'] = undefined;
...
export default CreateHostInputVpcConfiguration;
