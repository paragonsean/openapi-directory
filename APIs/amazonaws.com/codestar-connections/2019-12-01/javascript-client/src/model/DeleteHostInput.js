...
/**
 * The DeleteHostInput model module.
 * @module model/DeleteHostInput
 * @version 2019-12-01
 */
class DeleteHostInput {
    /**
     * Constructs a new <code>DeleteHostInput</code>.
     * @alias module:model/DeleteHostInput
     * @param hostArn {String} 
     */
    constructor(hostArn) { 
        
        DeleteHostInput.initialize(this, hostArn);
    }
    ...
    /**
     * Constructs a <code>DeleteHostInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteHostInput} obj Optional instance to populate.
     * @return {module:model/DeleteHostInput} The populated <code>DeleteHostInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteHostInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteHostInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteHostInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteHostInput.RequiredProperties) {
...
DeleteHostInput.RequiredProperties = ["HostArn"];

/**
 * @member {String} HostArn
 */
DeleteHostInput.prototype['HostArn'] = undefined;
...
export default DeleteHostInput;
