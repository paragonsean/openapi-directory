...
/**
 * The CreateConnectionInput model module.
 * @module model/CreateConnectionInput
 * @version 2019-12-01
 */
class CreateConnectionInput {
    /**
     * Constructs a new <code>CreateConnectionInput</code>.
     * @alias module:model/CreateConnectionInput
     * @param connectionName {String} 
     */
    constructor(connectionName) { 
        
        CreateConnectionInput.initialize(this, connectionName);
    }
     ...
     */
    static initialize(obj, connectionName) { 
        obj['ConnectionName'] = connectionName;
    }

    /**
     * Constructs a <code>CreateConnectionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateConnectionInput} obj Optional instance to populate.
     * @return {module:model/CreateConnectionInput} The populated <code>CreateConnectionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateConnectionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateConnectionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateConnectionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateConnectionInput.RequiredProperties) {
...
CreateConnectionInput.RequiredProperties = ["ConnectionName"];

/**
 * @member {module:model/ProviderType} ProviderType
 */
CreateConnectionInput.prototype['ProviderType'] = undefined;

/**
 * @member {String} ConnectionName
 */
CreateConnectionInput.prototype['ConnectionName'] = undefined;

/**
 * @member {Array} Tags
 */
CreateConnectionInput.prototype['Tags'] = undefined;

/**
 * @member {String} HostArn
 */
CreateConnectionInput.prototype['HostArn'] = undefined;
...
export default CreateConnectionInput;
