...
/**
 * The HostVpcConfiguration model module.
 * @module model/HostVpcConfiguration
 * @version 2019-12-01
 */
class HostVpcConfiguration {
    /**
     * Constructs a new <code>HostVpcConfiguration</code>.
     * @alias module:model/HostVpcConfiguration
    ...
    constructor(vpcId, subnetIds, securityGroupIds) { 
        ...
        HostVpcConfiguration.initialize(this, vpcId, subnetIds, securityGroupIds);
    }
    ...
    /**
     * Constructs a <code>HostVpcConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HostVpcConfiguration} obj Optional instance to populate.
     * @return {module:model/HostVpcConfiguration} The populated <code>HostVpcConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HostVpcConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>HostVpcConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HostVpcConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HostVpcConfiguration.RequiredProperties) {
...
HostVpcConfiguration.RequiredProperties = ["VpcId", "SubnetIds", "SecurityGroupIds"];

/**
 * @member {String} VpcId
 */
HostVpcConfiguration.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
HostVpcConfiguration.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} SecurityGroupIds
 */
HostVpcConfiguration.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {String} TlsCertificate
 */
HostVpcConfiguration.prototype['TlsCertificate'] = undefined;
...
export default HostVpcConfiguration;
