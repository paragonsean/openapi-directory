...
/**
 * The ListHostsOutput model module.
 * @module model/ListHostsOutput
 * @version 2019-12-01
 */
class ListHostsOutput {
    /**
     * Constructs a new <code>ListHostsOutput</code>.
     * @alias module:model/ListHostsOutput
     */
    constructor() { 
        
        ListHostsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHostsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHostsOutput} obj Optional instance to populate.
     * @return {module:model/ListHostsOutput} The populated <code>ListHostsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHostsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListHostsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHostsOutput</code>.
     */
 ...
 * @member {Array} Hosts
 */
ListHostsOutput.prototype['Hosts'] = undefined;

/**
 * @member {String} NextToken
 */
ListHostsOutput.prototype['NextToken'] = undefined;
...
export default ListHostsOutput;
