...
import GetConnectionOutputConnection from './GetConnectionOutputConnection';

/**
 * The GetConnectionOutput model module.
 * @module model/GetConnectionOutput
 * @version 2019-12-01
 */
class GetConnectionOutput {
    /**
     * Constructs a new <code>GetConnectionOutput</code>.
     * @alias module:model/GetConnectionOutput
     */
    constructor() { 
        
        GetConnectionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetConnectionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetConnectionOutput} obj Optional instance to populate.
     * @return {module:model/GetConnectionOutput} The populated <code>GetConnectionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetConnectionOutput();

            if (data.hasOwnProperty('Connection')) {
                obj['Connection'] = GetConnectionOutputConnection.constructFromObject(data['Connection']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetConnectionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetConnectionOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Connection`
        if (data['Connection']) { // data not null
          GetConnectionOutputConnection.validateJSON(data['Connection']);
        }
...
/**
 * @member {module:model/GetConnectionOutputConnection} Connection
 */
GetConnectionOutput.prototype['Connection'] = undefined;
...
export default GetConnectionOutput;
