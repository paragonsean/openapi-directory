...
/**
 * The ListConnectionsOutput model module.
 * @module model/ListConnectionsOutput
 * @version 2019-12-01
 */
class ListConnectionsOutput {
    /**
     * Constructs a new <code>ListConnectionsOutput</code>.
     * @alias module:model/ListConnectionsOutput
     */
    constructor() { 
        
        ListConnectionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListConnectionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListConnectionsOutput} obj Optional instance to populate.
     * @return {module:model/ListConnectionsOutput} The populated <code>ListConnectionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListConnectionsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListConnectionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConnectionsOutput</code>.
     */
 ...
 */
ListConnectionsOutput.prototype['Connections'] = undefined;

/**
 * @member {String} NextToken
 */
ListConnectionsOutput.prototype['NextToken'] = undefined;
...
export default ListConnectionsOutput;
