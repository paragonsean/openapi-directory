...
/**
 * The CreateConnectionOutput model module.
 * @module model/CreateConnectionOutput
 * @version 2019-12-01
 */
class CreateConnectionOutput {
    /**
     * Constructs a new <code>CreateConnectionOutput</code>.
     * @alias module:model/CreateConnectionOutput
     * @param connectionArn {String} 
     */
    constructor(connectionArn) { 
        
        CreateConnectionOutput.initialize(this, connectionArn);
    }
    ...
    /**
     * Constructs a <code>CreateConnectionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateConnectionOutput} obj Optional instance to populate.
     * @return {module:model/CreateConnectionOutput} The populated <code>CreateConnectionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateConnectionOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateConnectionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateConnectionOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateConnectionOutput.RequiredProperties) {
...
CreateConnectionOutput.RequiredProperties = ["ConnectionArn"];

/**
 * @member {String} ConnectionArn
 */
CreateConnectionOutput.prototype['ConnectionArn'] = undefined;

/**
 * @member {Array} Tags
 */
CreateConnectionOutput.prototype['Tags'] = undefined;
...
export default CreateConnectionOutput;
