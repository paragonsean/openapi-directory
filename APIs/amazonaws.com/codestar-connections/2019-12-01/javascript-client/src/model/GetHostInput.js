...
/**
 * The GetHostInput model module.
 * @module model/GetHostInput
 * @version 2019-12-01
 */
class GetHostInput {
    /**
     * Constructs a new <code>GetHostInput</code>.
     * @alias module:model/GetHostInput
     * @param hostArn {String} 
     */
    constructor(hostArn) { 
        
        GetHostInput.initialize(this, hostArn);
    }
    ...
    /**
     * Constructs a <code>GetHostInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetHostInput} obj Optional instance to populate.
     * @return {module:model/GetHostInput} The populated <code>GetHostInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetHostInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetHostInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHostInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetHostInput.RequiredProperties) {
...
GetHostInput.RequiredProperties = ["HostArn"];

/**
 * @member {String} HostArn
 */
GetHostInput.prototype['HostArn'] = undefined;
