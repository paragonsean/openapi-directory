...
/**
 * The ListConnectionsInput model module.
 * @module model/ListConnectionsInput
 * @version 2019-12-01
 */
class ListConnectionsInput {
    /**
     * Constructs a new <code>ListConnectionsInput</code>.
     * @alias module:model/ListConnectionsInput
     */
    constructor() { 
        
        ListConnectionsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListConnectionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListConnectionsInput} obj Optional instance to populate.
     * @return {module:model/ListConnectionsInput} The populated <code>ListConnectionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListConnectionsInput();

            if (data.hasOwnProperty('ProviderTypeFilter')) {
                obj['ProviderTypeFilter'] = ApiClient.convertToType(data['ProviderTypeFilter'], ProviderType);
            }
            if (data.hasOwnProperty('HostArnFilter')) {
                obj['HostArnFilter'] = ApiClient.convertToType(data['HostArnFilter'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListConnectionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConnectionsInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProviderTypeFilter`
        if (data['ProviderTypeFilter']) { // data not null
          ProviderType.validateJSON(data['ProviderTypeFilter']);
        }
        // validate the optional field `HostArnFilter`
        if (data['HostArnFilter']) { // data not null
          String.validateJSON(data['HostArnFilter']);
        }
...
/**
 * @member {module:model/ProviderType} ProviderTypeFilter
 */
ListConnectionsInput.prototype['ProviderTypeFilter'] = undefined;

/**
 * @member {String} HostArnFilter
 */
ListConnectionsInput.prototype['HostArnFilter'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListConnectionsInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListConnectionsInput.prototype['NextToken'] = undefined;
...
export default ListConnectionsInput;
