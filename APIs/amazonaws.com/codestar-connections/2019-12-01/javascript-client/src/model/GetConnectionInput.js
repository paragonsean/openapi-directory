...
/**
 * The GetConnectionInput model module.
 * @module model/GetConnectionInput
 * @version 2019-12-01
 */
class GetConnectionInput {
    /**
     * Constructs a new <code>GetConnectionInput</code>.
     * @alias module:model/GetConnectionInput
     * @param connectionArn {String} 
     */
    constructor(connectionArn) { 
        
        GetConnectionInput.initialize(this, connectionArn);
    }
    ...
    /**
     * Constructs a <code>GetConnectionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetConnectionInput} obj Optional instance to populate.
     * @return {module:model/GetConnectionInput} The populated <code>GetConnectionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetConnectionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetConnectionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetConnectionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetConnectionInput.RequiredProperties) {
...
GetConnectionInput.RequiredProperties = ["ConnectionArn"];

/**
 * @member {String} ConnectionArn
 */
GetConnectionInput.prototype['ConnectionArn'] = undefined;
