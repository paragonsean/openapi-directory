...
/**
 * The GetHostOutputVpcConfiguration model module.
 * @module model/GetHostOutputVpcConfiguration
 * @version 2019-12-01
 */
class GetHostOutputVpcConfiguration {
    /**
     * Constructs a new <code>GetHostOutputVpcConfiguration</code>.
     * @alias module:model/GetHostOutputVpcConfiguration
    ...
    constructor(vpcId, subnetIds, securityGroupIds) { 
        ...
        GetHostOutputVpcConfiguration.initialize(this, vpcId, subnetIds, securityGroupIds);
    }
    ...
    /**
     * Constructs a <code>GetHostOutputVpcConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetHostOutputVpcConfiguration} obj Optional instance to populate.
     * @return {module:model/GetHostOutputVpcConfiguration} The populated <code>GetHostOutputVpcConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetHostOutputVpcConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>GetHostOutputVpcConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHostOutputVpcConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetHostOutputVpcConfiguration.RequiredProperties) {
...
GetHostOutputVpcConfiguration.RequiredProperties = ["VpcId", "SubnetIds", "SecurityGroupIds"];

/**
 * @member {String} VpcId
 */
GetHostOutputVpcConfiguration.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
GetHostOutputVpcConfiguration.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} SecurityGroupIds
 */
GetHostOutputVpcConfiguration.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {String} TlsCertificate
 */
GetHostOutputVpcConfiguration.prototype['TlsCertificate'] = undefined;
...
export default GetHostOutputVpcConfiguration;
