...
import UpdateHostInputVpcConfiguration from './UpdateHostInputVpcConfiguration';

/**
 * The UpdateHostInput model module.
 * @module model/UpdateHostInput
 * @version 2019-12-01
 */
class UpdateHostInput {
    /**
     * Constructs a new <code>UpdateHostInput</code>.
     * @alias module:model/UpdateHostInput
     * @param hostArn {String} 
     */
    constructor(hostArn) { 
        
        UpdateHostInput.initialize(this, hostArn);
    }
     ...
     */
    static initialize(obj, hostArn) { 
        obj['HostArn'] = hostArn;
    }

    /**
     * Constructs a <code>UpdateHostInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateHostInput} obj Optional instance to populate.
     * @return {module:model/UpdateHostInput} The populated <code>UpdateHostInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateHostInput();
            ...
            if (data.hasOwnProperty('VpcConfiguration')) {
                obj['VpcConfiguration'] = UpdateHostInputVpcConfiguration.constructFromObject(data['VpcConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateHostInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateHostInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateHostInput.RequiredProperties) {
        ...
        if (data['VpcConfiguration']) { // data not null
          UpdateHostInputVpcConfiguration.validateJSON(data['VpcConfiguration']);
        }
...
UpdateHostInput.RequiredProperties = ["HostArn"];

/**
 * @member {String} HostArn
 */
UpdateHostInput.prototype['HostArn'] = undefined;

/**
 * @member {String} ProviderEndpoint
 */
UpdateHostInput.prototype['ProviderEndpoint'] = undefined;

/**
 * @member {module:model/UpdateHostInputVpcConfiguration} VpcConfiguration
 */
UpdateHostInput.prototype['VpcConfiguration'] = undefined;
...
export default UpdateHostInput;
