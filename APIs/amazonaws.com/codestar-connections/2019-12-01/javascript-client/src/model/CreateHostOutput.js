...
/**
 * The CreateHostOutput model module.
 * @module model/CreateHostOutput
 * @version 2019-12-01
 */
class CreateHostOutput {
    /**
     * Constructs a new <code>CreateHostOutput</code>.
     * @alias module:model/CreateHostOutput
     */
    constructor() { 
        
        CreateHostOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateHostOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateHostOutput} obj Optional instance to populate.
     * @return {module:model/CreateHostOutput} The populated <code>CreateHostOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateHostOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateHostOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateHostOutput</code>.
     */
 ...
 */
CreateHostOutput.prototype['HostArn'] = undefined;

/**
 * @member {Array.<module:model/Tag>} Tags
 */
CreateHostOutput.prototype['Tags'] = undefined;
...
export default CreateHostOutput;
