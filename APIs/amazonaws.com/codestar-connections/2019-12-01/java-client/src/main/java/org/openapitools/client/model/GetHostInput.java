...
public class GetHostInput {
  ...
  public GetHostInput hostArn(String hostArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetHostInput getHostInput = (GetHostInput) o;
    return Objects.equals(this.hostArn, getHostInput.hostArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hostArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetHostInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetHostInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetHostInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetHostInput is not found in the empty JSON string", GetHostInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetHostInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetHostInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetHostInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetHostInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetHostInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetHostInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetHostInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetHostInput>() {
           @Override
           public void write(JsonWriter out, GetHostInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetHostInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetHostInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetHostInput
   * @throws IOException if the JSON string is invalid with respect to GetHostInput
   */
  public static GetHostInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetHostInput.class);
  }

  /**
   * Convert an instance of GetHostInput to an JSON string
   *
   * @return JSON string
   */
