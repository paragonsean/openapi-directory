...
public class ListHostsOutput {
  ...
  public ListHostsOutput hosts(List hosts) {
    this.hosts = hosts;
    return this;
  }
  ...
  public ListHostsOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListHostsOutput listHostsOutput = (ListHostsOutput) o;
    return Objects.equals(this.hosts, listHostsOutput.hosts) &&
        Objects.equals(this.nextToken, listHostsOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hosts, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListHostsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListHostsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListHostsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListHostsOutput is not found in the empty JSON string", ListHostsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListHostsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListHostsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListHostsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListHostsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListHostsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListHostsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListHostsOutput>() {
           @Override
           public void write(JsonWriter out, ListHostsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListHostsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListHostsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListHostsOutput
   * @throws IOException if the JSON string is invalid with respect to ListHostsOutput
   */
  public static ListHostsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListHostsOutput.class);
  }

  /**
   * Convert an instance of ListHostsOutput to an JSON string
   *
   * @return JSON string
   */
