...
import org.openapitools.client.model.GetHostOutputVpcConfiguration;
...
public class GetHostOutput {
  ...
  private GetHostOutputVpcConfiguration vpcConfiguration;

  public GetHostOutput() {
  }

  public GetHostOutput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetHostOutput status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetHostOutput providerType(ProviderType providerType) {
  ...
  public GetHostOutput providerEndpoint(String providerEndpoint) {
  ...
  public GetHostOutput vpcConfiguration(GetHostOutputVpcConfiguration vpcConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public GetHostOutputVpcConfiguration getVpcConfiguration() {
    return vpcConfiguration;
  }

  public void setVpcConfiguration(GetHostOutputVpcConfiguration vpcConfiguration) {
    this.vpcConfiguration = vpcConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetHostOutput getHostOutput = (GetHostOutput) o;
    return Objects.equals(this.name, getHostOutput.name) &&
        Objects.equals(this.status, getHostOutput.status) &&
        Objects.equals(this.providerType, getHostOutput.providerType) &&
        Objects.equals(this.providerEndpoint, getHostOutput.providerEndpoint) &&
        Objects.equals(this.vpcConfiguration, getHostOutput.vpcConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, status, providerType, providerEndpoint, vpcConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetHostOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetHostOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetHostOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetHostOutput is not found in the empty JSON string", GetHostOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetHostOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetHostOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("VpcConfiguration") != null && !jsonObj.get("VpcConfiguration").isJsonNull()) {
        GetHostOutputVpcConfiguration.validateJsonElement(jsonObj.get("VpcConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetHostOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetHostOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetHostOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetHostOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetHostOutput>() {
           @Override
           public void write(JsonWriter out, GetHostOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetHostOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetHostOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetHostOutput
   * @throws IOException if the JSON string is invalid with respect to GetHostOutput
   */
  public static GetHostOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetHostOutput.class);
  }

  /**
   * Convert an instance of GetHostOutput to an JSON string
   *
   * @return JSON string
   */
