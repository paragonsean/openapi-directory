...
public class GetConnectionInput {
  ...
  public GetConnectionInput() {
  }

  public GetConnectionInput connectionArn(String connectionArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetConnectionInput getConnectionInput = (GetConnectionInput) o;
    return Objects.equals(this.connectionArn, getConnectionInput.connectionArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetConnectionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetConnectionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetConnectionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetConnectionInput is not found in the empty JSON string", GetConnectionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetConnectionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetConnectionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetConnectionInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetConnectionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetConnectionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetConnectionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetConnectionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetConnectionInput>() {
           @Override
           public void write(JsonWriter out, GetConnectionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetConnectionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetConnectionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetConnectionInput
   * @throws IOException if the JSON string is invalid with respect to GetConnectionInput
   */
  public static GetConnectionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetConnectionInput.class);
  }

  /**
   * Convert an instance of GetConnectionInput to an JSON string
   *
   * @return JSON string
   */
