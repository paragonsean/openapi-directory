...
public class CreateHostOutput {
  ...
  public CreateHostOutput hostArn(String hostArn) {
  ...
  public CreateHostOutput tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public CreateHostOutput addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateHostOutput createHostOutput = (CreateHostOutput) o;
    return Objects.equals(this.hostArn, createHostOutput.hostArn) &&
        Objects.equals(this.tags, createHostOutput.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hostArn, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateHostOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateHostOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateHostOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateHostOutput is not found in the empty JSON string", CreateHostOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateHostOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateHostOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateHostOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateHostOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateHostOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateHostOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateHostOutput>() {
           @Override
           public void write(JsonWriter out, CreateHostOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateHostOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateHostOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateHostOutput
   * @throws IOException if the JSON string is invalid with respect to CreateHostOutput
   */
  public static CreateHostOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateHostOutput.class);
  }

  /**
   * Convert an instance of CreateHostOutput to an JSON string
   *
   * @return JSON string
   */
