...
public class DeleteHostInput {
  ...
  public DeleteHostInput() {
  }

  public DeleteHostInput hostArn(String hostArn) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteHostInput deleteHostInput = (DeleteHostInput) o;
    return Objects.equals(this.hostArn, deleteHostInput.hostArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteHostInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteHostInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteHostInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteHostInput is not found in the empty JSON string", DeleteHostInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteHostInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteHostInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteHostInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteHostInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteHostInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteHostInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteHostInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteHostInput>() {
           @Override
           public void write(JsonWriter out, DeleteHostInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteHostInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteHostInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteHostInput
   * @throws IOException if the JSON string is invalid with respect to DeleteHostInput
   */
  public static DeleteHostInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteHostInput.class);
  }

  /**
   * Convert an instance of DeleteHostInput to an JSON string
   *
   * @return JSON string
   */
