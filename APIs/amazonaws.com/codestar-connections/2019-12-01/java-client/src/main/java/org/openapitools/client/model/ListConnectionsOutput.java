...
public class ListConnectionsOutput {
  ...
  public ListConnectionsOutput connections(List connections) {
  ...
  public ListConnectionsOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListConnectionsOutput listConnectionsOutput = (ListConnectionsOutput) o;
    return Objects.equals(this.connections, listConnectionsOutput.connections) &&
        Objects.equals(this.nextToken, listConnectionsOutput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListConnectionsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListConnectionsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListConnectionsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListConnectionsOutput is not found in the empty JSON string", ListConnectionsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListConnectionsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListConnectionsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListConnectionsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListConnectionsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListConnectionsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListConnectionsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListConnectionsOutput>() {
           @Override
           public void write(JsonWriter out, ListConnectionsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListConnectionsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListConnectionsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListConnectionsOutput
   * @throws IOException if the JSON string is invalid with respect to ListConnectionsOutput
   */
  public static ListConnectionsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListConnectionsOutput.class);
  }

  /**
   * Convert an instance of ListConnectionsOutput to an JSON string
   *
   * @return JSON string
   */
