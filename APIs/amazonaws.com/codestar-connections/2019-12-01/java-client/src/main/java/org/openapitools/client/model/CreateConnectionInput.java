...
public class CreateConnectionInput {
  ...
  public CreateConnectionInput() {
  }

  public CreateConnectionInput providerType(ProviderType providerType) {
  ...
  public CreateConnectionInput connectionName(String connectionName) {
  ...
  public CreateConnectionInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateConnectionInput hostArn(String hostArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateConnectionInput createConnectionInput = (CreateConnectionInput) o;
    return Objects.equals(this.providerType, createConnectionInput.providerType) &&
        Objects.equals(this.connectionName, createConnectionInput.connectionName) &&
        Objects.equals(this.tags, createConnectionInput.tags) &&
        Objects.equals(this.hostArn, createConnectionInput.hostArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerType, connectionName, tags, hostArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateConnectionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateConnectionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateConnectionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateConnectionInput is not found in the empty JSON string", CreateConnectionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateConnectionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateConnectionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateConnectionInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateConnectionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateConnectionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateConnectionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateConnectionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateConnectionInput>() {
           @Override
           public void write(JsonWriter out, CreateConnectionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateConnectionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateConnectionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateConnectionInput
   * @throws IOException if the JSON string is invalid with respect to CreateConnectionInput
   */
  public static CreateConnectionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateConnectionInput.class);
  }

  /**
   * Convert an instance of CreateConnectionInput to an JSON string
   *
   * @return JSON string
   */
