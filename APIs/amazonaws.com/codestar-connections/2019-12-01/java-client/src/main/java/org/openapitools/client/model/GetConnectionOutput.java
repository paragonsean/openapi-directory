...
import org.openapitools.client.model.GetConnectionOutputConnection;
...
public class GetConnectionOutput {
  ...
  private GetConnectionOutputConnection connection;

  public GetConnectionOutput() {
  }

  public GetConnectionOutput connection(GetConnectionOutputConnection connection) {
  ...
  public GetConnectionOutputConnection getConnection() {
    return connection;
  }

  public void setConnection(GetConnectionOutputConnection connection) {
    this.connection = connection;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetConnectionOutput getConnectionOutput = (GetConnectionOutput) o;
    return Objects.equals(this.connection, getConnectionOutput.connection);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetConnectionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetConnectionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetConnectionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetConnectionOutput is not found in the empty JSON string", GetConnectionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetConnectionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetConnectionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Connection`
      if (jsonObj.get("Connection") != null && !jsonObj.get("Connection").isJsonNull()) {
        GetConnectionOutputConnection.validateJsonElement(jsonObj.get("Connection"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetConnectionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetConnectionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetConnectionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetConnectionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetConnectionOutput>() {
           @Override
           public void write(JsonWriter out, GetConnectionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetConnectionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetConnectionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetConnectionOutput
   * @throws IOException if the JSON string is invalid with respect to GetConnectionOutput
   */
  public static GetConnectionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetConnectionOutput.class);
  }

  /**
   * Convert an instance of GetConnectionOutput to an JSON string
   *
   * @return JSON string
   */
