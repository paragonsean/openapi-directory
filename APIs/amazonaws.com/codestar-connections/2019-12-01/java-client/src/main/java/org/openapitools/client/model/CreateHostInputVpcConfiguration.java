...
public class CreateHostInputVpcConfiguration {
  ...
  public CreateHostInputVpcConfiguration() {
  }

  public CreateHostInputVpcConfiguration vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public CreateHostInputVpcConfiguration subnetIds(List subnetIds) {
  ...
  public CreateHostInputVpcConfiguration securityGroupIds(List securityGroupIds) {
  ...
  public CreateHostInputVpcConfiguration tlsCertificate(String tlsCertificate) {
  ...
  public boolean equals(Object o) {
    ...
    CreateHostInputVpcConfiguration createHostInputVpcConfiguration = (CreateHostInputVpcConfiguration) o;
    return Objects.equals(this.vpcId, createHostInputVpcConfiguration.vpcId) &&
        Objects.equals(this.subnetIds, createHostInputVpcConfiguration.subnetIds) &&
        Objects.equals(this.securityGroupIds, createHostInputVpcConfiguration.securityGroupIds) &&
        Objects.equals(this.tlsCertificate, createHostInputVpcConfiguration.tlsCertificate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateHostInputVpcConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateHostInputVpcConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateHostInputVpcConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateHostInputVpcConfiguration is not found in the empty JSON string", CreateHostInputVpcConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateHostInputVpcConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateHostInputVpcConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateHostInputVpcConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateHostInputVpcConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateHostInputVpcConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateHostInputVpcConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateHostInputVpcConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateHostInputVpcConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateHostInputVpcConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateHostInputVpcConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateHostInputVpcConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateHostInputVpcConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateHostInputVpcConfiguration
   */
  public static CreateHostInputVpcConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateHostInputVpcConfiguration.class);
  }

  /**
   * Convert an instance of CreateHostInputVpcConfiguration to an JSON string
   *
   * @return JSON string
   */
