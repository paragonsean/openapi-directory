...
public class HostVpcConfiguration {
  ...
  public HostVpcConfiguration() {
  }

  public HostVpcConfiguration vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public HostVpcConfiguration subnetIds(List subnetIds) {
  ...
  public HostVpcConfiguration securityGroupIds(List securityGroupIds) {
  ...
  public HostVpcConfiguration tlsCertificate(String tlsCertificate) {
  ...
  public boolean equals(Object o) {
    ...
    HostVpcConfiguration hostVpcConfiguration = (HostVpcConfiguration) o;
    return Objects.equals(this.vpcId, hostVpcConfiguration.vpcId) &&
        Objects.equals(this.subnetIds, hostVpcConfiguration.subnetIds) &&
        Objects.equals(this.securityGroupIds, hostVpcConfiguration.securityGroupIds) &&
        Objects.equals(this.tlsCertificate, hostVpcConfiguration.tlsCertificate);
  }
  ...
  public String toString() {
    ...
    sb.append("class HostVpcConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HostVpcConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HostVpcConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HostVpcConfiguration is not found in the empty JSON string", HostVpcConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HostVpcConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HostVpcConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HostVpcConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HostVpcConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HostVpcConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HostVpcConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HostVpcConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<HostVpcConfiguration>() {
           @Override
           public void write(JsonWriter out, HostVpcConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HostVpcConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HostVpcConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HostVpcConfiguration
   * @throws IOException if the JSON string is invalid with respect to HostVpcConfiguration
   */
  public static HostVpcConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HostVpcConfiguration.class);
  }

  /**
   * Convert an instance of HostVpcConfiguration to an JSON string
   *
   * @return JSON string
   */
