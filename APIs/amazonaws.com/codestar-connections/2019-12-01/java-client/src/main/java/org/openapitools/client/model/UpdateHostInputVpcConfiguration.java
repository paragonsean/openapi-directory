...
public class UpdateHostInputVpcConfiguration {
  ...
  public UpdateHostInputVpcConfiguration() {
  }

  public UpdateHostInputVpcConfiguration vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public UpdateHostInputVpcConfiguration subnetIds(List subnetIds) {
  ...
  public UpdateHostInputVpcConfiguration securityGroupIds(List securityGroupIds) {
  ...
  public UpdateHostInputVpcConfiguration tlsCertificate(String tlsCertificate) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateHostInputVpcConfiguration updateHostInputVpcConfiguration = (UpdateHostInputVpcConfiguration) o;
    return Objects.equals(this.vpcId, updateHostInputVpcConfiguration.vpcId) &&
        Objects.equals(this.subnetIds, updateHostInputVpcConfiguration.subnetIds) &&
        Objects.equals(this.securityGroupIds, updateHostInputVpcConfiguration.securityGroupIds) &&
        Objects.equals(this.tlsCertificate, updateHostInputVpcConfiguration.tlsCertificate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateHostInputVpcConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateHostInputVpcConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateHostInputVpcConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateHostInputVpcConfiguration is not found in the empty JSON string", UpdateHostInputVpcConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateHostInputVpcConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateHostInputVpcConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateHostInputVpcConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateHostInputVpcConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateHostInputVpcConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateHostInputVpcConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateHostInputVpcConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateHostInputVpcConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateHostInputVpcConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateHostInputVpcConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateHostInputVpcConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateHostInputVpcConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateHostInputVpcConfiguration
   */
  public static UpdateHostInputVpcConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateHostInputVpcConfiguration.class);
  }

  /**
   * Convert an instance of UpdateHostInputVpcConfiguration to an JSON string
   *
   * @return JSON string
   */
