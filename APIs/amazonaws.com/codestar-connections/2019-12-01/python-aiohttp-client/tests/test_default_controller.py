...
async def test_create_connection(client):
    ...
    """
    body = {"ConnectionName":"","HostArn":"","ProviderType":"","Tags":""}
    headers = { 
...
async def test_create_host(client):
    ...
    """
    body = {"ProviderEndpoint":"","ProviderType":"","VpcConfiguration":{"VpcId":"","SubnetIds":"","SecurityGroupIds":"","TlsCertificate":""},"Tags":[{"Value":"","Key":""},{"Value":"","Key":""},{"Value":"","Key":""},{"Value":"","Key":""},{"Value":"","Key":""}],"Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_connection(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.DeleteConnection',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_host(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.DeleteHost',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_connections(client):
    ...
    """
    body = {"NextToken":"","MaxResults":"","HostArnFilter":"","ProviderTypeFilter":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.ListConnections',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_hosts(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.ListHosts',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_host(client):
    ...
    """
    body = {"HostArn":"","ProviderEndpoint":"","VpcConfiguration":{"VpcId":"","SubnetIds":"","SecurityGroupIds":"","TlsCertificate":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=com.amazonaws.codestar.connections.CodeStar_connections_20191201.UpdateHost',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
