...
#ifndef OAIListHostsInput_H
#define OAIListHostsInput_H
...
class OAIListHostsInput : public OAIObject {
public:
    OAIListHostsInput();
    OAIListHostsInput(QString json);
    ~OAIListHostsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHostsInput)

#endif // OAIListHostsInput_H
