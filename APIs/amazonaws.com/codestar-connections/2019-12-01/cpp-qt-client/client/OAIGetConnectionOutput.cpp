...
OAIGetConnectionOutput::OAIGetConnectionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetConnectionOutput::OAIGetConnectionOutput() {
    this->initializeModel();
}

OAIGetConnectionOutput::~OAIGetConnectionOutput() {}

void OAIGetConnectionOutput::initializeModel() {

    m_connection_isSet = false;
    m_connection_isValid = false;
}

void OAIGetConnectionOutput::fromJson(QString jsonString) {
...
void OAIGetConnectionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetConnectionOutput::asJson() const {
...
QJsonObject OAIGetConnectionOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIGetConnectionOutput_Connection OAIGetConnectionOutput::getConnection() const {
    return m_connection;
}
void OAIGetConnectionOutput::setConnection(const OAIGetConnectionOutput_Connection &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIGetConnectionOutput::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIGetConnectionOutput::is_connection_Valid() const{
    return m_connection_isValid;
}

bool OAIGetConnectionOutput::isSet() const {
...
bool OAIGetConnectionOutput::isValid() const {
