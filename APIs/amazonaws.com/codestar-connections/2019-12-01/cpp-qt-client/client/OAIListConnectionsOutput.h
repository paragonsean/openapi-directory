...
/*
 * OAIListConnectionsOutput.h
 *
 * 
 */

#ifndef OAIListConnectionsOutput_H
#define OAIListConnectionsOutput_H
...
class OAIListConnectionsOutput : public OAIObject {
public:
    OAIListConnectionsOutput();
    OAIListConnectionsOutput(QString json);
    ~OAIListConnectionsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListConnectionsOutput)

#endif // OAIListConnectionsOutput_H
