...
OAIDeleteHostInput::OAIDeleteHostInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteHostInput::OAIDeleteHostInput() {
    this->initializeModel();
}

OAIDeleteHostInput::~OAIDeleteHostInput() {}

void OAIDeleteHostInput::initializeModel() {

    m_host_arn_isSet = false;
    m_host_arn_isValid = false;
}

void OAIDeleteHostInput::fromJson(QString jsonString) {
...
void OAIDeleteHostInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteHostInput::asJson() const {
...
QJsonObject OAIDeleteHostInput::asJsonObject() const {
    QJsonObject obj;
    if (m_host_arn_isSet) {
...
QString OAIDeleteHostInput::getHostArn() const {
    return m_host_arn;
}
void OAIDeleteHostInput::setHostArn(const QString &host_arn) {
    m_host_arn = host_arn;
    m_host_arn_isSet = true;
}

bool OAIDeleteHostInput::is_host_arn_Set() const{
    return m_host_arn_isSet;
}

bool OAIDeleteHostInput::is_host_arn_Valid() const{
    return m_host_arn_isValid;
}

bool OAIDeleteHostInput::isSet() const {
...
bool OAIDeleteHostInput::isValid() const {
