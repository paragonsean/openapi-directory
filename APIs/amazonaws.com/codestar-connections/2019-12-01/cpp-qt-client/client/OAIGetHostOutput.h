...
#ifndef OAIGetHostOutput_H
#define OAIGetHostOutput_H

#include <QJsonObject>

#include "OAIGetHostOutput_VpcConfiguration.h"
...
namespace OpenAPI {
class OAIGetHostOutput_VpcConfiguration;

class OAIGetHostOutput : public OAIObject {
public:
    OAIGetHostOutput();
    OAIGetHostOutput(QString json);
    ~OAIGetHostOutput() override;
    ...
    OAIGetHostOutput_VpcConfiguration getVpcConfiguration() const;
    void setVpcConfiguration(const OAIGetHostOutput_VpcConfiguration &vpc_configuration);
...
private:
    ...
    OAIGetHostOutput_VpcConfiguration m_vpc_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHostOutput)

#endif // OAIGetHostOutput_H
