...
/*
 * OAIHost_VpcConfiguration.h
 *
 * 
 */

#ifndef OAIHost_VpcConfiguration_H
#define OAIHost_VpcConfiguration_H
...
class OAIHost_VpcConfiguration : public OAIObject {
public:
    OAIHost_VpcConfiguration();
    OAIHost_VpcConfiguration(QString json);
    ~OAIHost_VpcConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHost_VpcConfiguration)

#endif // OAIHost_VpcConfiguration_H
