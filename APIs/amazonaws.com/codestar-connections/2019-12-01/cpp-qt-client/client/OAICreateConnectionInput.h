...
/*
 * OAICreateConnectionInput.h
 *
 * 
 */

#ifndef OAICreateConnectionInput_H
#define OAICreateConnectionInput_H
...
class OAICreateConnectionInput : public OAIObject {
public:
    OAICreateConnectionInput();
    OAICreateConnectionInput(QString json);
    ~OAICreateConnectionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConnectionInput)

#endif // OAICreateConnectionInput_H
