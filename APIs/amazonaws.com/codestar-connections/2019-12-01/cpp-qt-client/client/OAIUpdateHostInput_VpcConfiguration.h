...
/*
 * OAIUpdateHostInput_VpcConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateHostInput_VpcConfiguration_H
#define OAIUpdateHostInput_VpcConfiguration_H
...
class OAIUpdateHostInput_VpcConfiguration : public OAIObject {
public:
    OAIUpdateHostInput_VpcConfiguration();
    OAIUpdateHostInput_VpcConfiguration(QString json);
    ~OAIUpdateHostInput_VpcConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateHostInput_VpcConfiguration)

#endif // OAIUpdateHostInput_VpcConfiguration_H
