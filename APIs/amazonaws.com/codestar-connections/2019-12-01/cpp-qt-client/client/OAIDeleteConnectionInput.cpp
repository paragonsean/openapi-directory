...
OAIDeleteConnectionInput::OAIDeleteConnectionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteConnectionInput::OAIDeleteConnectionInput() {
    this->initializeModel();
}

OAIDeleteConnectionInput::~OAIDeleteConnectionInput() {}

void OAIDeleteConnectionInput::initializeModel() {

    m_connection_arn_isSet = false;
    m_connection_arn_isValid = false;
}

void OAIDeleteConnectionInput::fromJson(QString jsonString) {
...
void OAIDeleteConnectionInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteConnectionInput::asJson() const {
...
QJsonObject OAIDeleteConnectionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteConnectionInput::getConnectionArn() const {
    return m_connection_arn;
}
void OAIDeleteConnectionInput::setConnectionArn(const QString &connection_arn) {
    m_connection_arn = connection_arn;
    m_connection_arn_isSet = true;
}

bool OAIDeleteConnectionInput::is_connection_arn_Set() const{
    return m_connection_arn_isSet;
}

bool OAIDeleteConnectionInput::is_connection_arn_Valid() const{
    return m_connection_arn_isValid;
}

bool OAIDeleteConnectionInput::isSet() const {
...
bool OAIDeleteConnectionInput::isValid() const {
