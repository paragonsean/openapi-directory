...
/*
 * OAIGetConnectionInput.h
 *
 * 
 */

#ifndef OAIGetConnectionInput_H
#define OAIGetConnectionInput_H
...
class OAIGetConnectionInput : public OAIObject {
public:
    OAIGetConnectionInput();
    OAIGetConnectionInput(QString json);
    ~OAIGetConnectionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetConnectionInput)

#endif // OAIGetConnectionInput_H
