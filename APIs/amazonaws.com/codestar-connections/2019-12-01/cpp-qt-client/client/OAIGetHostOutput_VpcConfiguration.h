...
/*
 * OAIGetHostOutput_VpcConfiguration.h
 *
 * 
 */

#ifndef OAIGetHostOutput_VpcConfiguration_H
#define OAIGetHostOutput_VpcConfiguration_H
...
class OAIGetHostOutput_VpcConfiguration : public OAIObject {
public:
    OAIGetHostOutput_VpcConfiguration();
    OAIGetHostOutput_VpcConfiguration(QString json);
    ~OAIGetHostOutput_VpcConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHostOutput_VpcConfiguration)

#endif // OAIGetHostOutput_VpcConfiguration_H
