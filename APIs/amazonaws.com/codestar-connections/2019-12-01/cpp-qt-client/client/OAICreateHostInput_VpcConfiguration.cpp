...
OAICreateHostInput_VpcConfiguration::OAICreateHostInput_VpcConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateHostInput_VpcConfiguration::OAICreateHostInput_VpcConfiguration() {
    this->initializeModel();
}

OAICreateHostInput_VpcConfiguration::~OAICreateHostInput_VpcConfiguration() {}

void OAICreateHostInput_VpcConfiguration::initializeModel() {
...
void OAICreateHostInput_VpcConfiguration::fromJson(QString jsonString) {
...
void OAICreateHostInput_VpcConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateHostInput_VpcConfiguration::asJson() const {
...
QJsonObject OAICreateHostInput_VpcConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_vpc_id_isSet) {
...
QString OAICreateHostInput_VpcConfiguration::getVpcId() const {
    return m_vpc_id;
}
void OAICreateHostInput_VpcConfiguration::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAICreateHostInput_VpcConfiguration::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAICreateHostInput_VpcConfiguration::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QList OAICreateHostInput_VpcConfiguration::getSubnetIds() const {
    return m_subnet_ids;
}
void OAICreateHostInput_VpcConfiguration::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAICreateHostInput_VpcConfiguration::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAICreateHostInput_VpcConfiguration::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAICreateHostInput_VpcConfiguration::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAICreateHostInput_VpcConfiguration::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAICreateHostInput_VpcConfiguration::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAICreateHostInput_VpcConfiguration::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QString OAICreateHostInput_VpcConfiguration::getTlsCertificate() const {
    return m_tls_certificate;
}
void OAICreateHostInput_VpcConfiguration::setTlsCertificate(const QString &tls_certificate) {
    m_tls_certificate = tls_certificate;
    m_tls_certificate_isSet = true;
}

bool OAICreateHostInput_VpcConfiguration::is_tls_certificate_Set() const{
    return m_tls_certificate_isSet;
}

bool OAICreateHostInput_VpcConfiguration::is_tls_certificate_Valid() const{
    return m_tls_certificate_isValid;
}

bool OAICreateHostInput_VpcConfiguration::isSet() const {
...
bool OAICreateHostInput_VpcConfiguration::isValid() const {
