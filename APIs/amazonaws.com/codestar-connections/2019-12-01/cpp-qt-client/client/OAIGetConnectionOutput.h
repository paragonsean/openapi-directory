...
/*
 * OAIGetConnectionOutput.h
 *
 * 
 */

#ifndef OAIGetConnectionOutput_H
#define OAIGetConnectionOutput_H
...
namespace OpenAPI {
class OAIGetConnectionOutput_Connection;

class OAIGetConnectionOutput : public OAIObject {
public:
    OAIGetConnectionOutput();
    OAIGetConnectionOutput(QString json);
    ~OAIGetConnectionOutput() override;
    ...
    OAIGetConnectionOutput_Connection getConnection() const;
    void setConnection(const OAIGetConnectionOutput_Connection &connection);
...
private:
    ...
    OAIGetConnectionOutput_Connection m_connection;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetConnectionOutput)

#endif // OAIGetConnectionOutput_H
