...
OAIListConnectionsOutput::OAIListConnectionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListConnectionsOutput::OAIListConnectionsOutput() {
    this->initializeModel();
}

OAIListConnectionsOutput::~OAIListConnectionsOutput() {}

void OAIListConnectionsOutput::initializeModel() {
...
void OAIListConnectionsOutput::fromJson(QString jsonString) {
...
void OAIListConnectionsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListConnectionsOutput::asJson() const {
...
QJsonObject OAIListConnectionsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListConnectionsOutput::getConnections() const {
    return m_connections;
}
void OAIListConnectionsOutput::setConnections(const QList &connections) {
    m_connections = connections;
    m_connections_isSet = true;
}

bool OAIListConnectionsOutput::is_connections_Set() const{
    return m_connections_isSet;
}

bool OAIListConnectionsOutput::is_connections_Valid() const{
    return m_connections_isValid;
}

QString OAIListConnectionsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListConnectionsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListConnectionsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListConnectionsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListConnectionsOutput::isSet() const {
...
bool OAIListConnectionsOutput::isValid() const {
