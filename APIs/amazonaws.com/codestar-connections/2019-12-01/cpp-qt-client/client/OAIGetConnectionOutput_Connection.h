...
/*
 * OAIGetConnectionOutput_Connection.h
 *
 * 
 */

#ifndef OAIGetConnectionOutput_Connection_H
#define OAIGetConnectionOutput_Connection_H
...
class OAIGetConnectionOutput_Connection : public OAIObject {
public:
    OAIGetConnectionOutput_Connection();
    OAIGetConnectionOutput_Connection(QString json);
    ~OAIGetConnectionOutput_Connection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetConnectionOutput_Connection)

#endif // OAIGetConnectionOutput_Connection_H
