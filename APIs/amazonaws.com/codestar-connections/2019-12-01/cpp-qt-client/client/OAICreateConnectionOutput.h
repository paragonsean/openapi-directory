...
/*
 * OAICreateConnectionOutput.h
 *
 * 
 */

#ifndef OAICreateConnectionOutput_H
#define OAICreateConnectionOutput_H
...
class OAICreateConnectionOutput : public OAIObject {
public:
    OAICreateConnectionOutput();
    OAICreateConnectionOutput(QString json);
    ~OAICreateConnectionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConnectionOutput)

#endif // OAICreateConnectionOutput_H
