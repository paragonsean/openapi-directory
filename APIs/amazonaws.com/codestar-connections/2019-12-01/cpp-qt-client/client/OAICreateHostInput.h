...
/*
 * OAICreateHostInput.h
 *
 * 
 */

#ifndef OAICreateHostInput_H
#define OAICreateHostInput_H

#include <QJsonObject>

#include "OAICreateHostInput_VpcConfiguration.h"
...
namespace OpenAPI {
class OAICreateHostInput_VpcConfiguration;
class OAITag;

class OAICreateHostInput : public OAIObject {
public:
    OAICreateHostInput();
    OAICreateHostInput(QString json);
    ~OAICreateHostInput() override;
    ...
    OAICreateHostInput_VpcConfiguration getVpcConfiguration() const;
    void setVpcConfiguration(const OAICreateHostInput_VpcConfiguration &vpc_configuration);
...
private:
    ...
    OAICreateHostInput_VpcConfiguration m_vpc_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHostInput)

#endif // OAICreateHostInput_H
