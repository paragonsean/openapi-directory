...
OAIGetHostOutput_VpcConfiguration::OAIGetHostOutput_VpcConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetHostOutput_VpcConfiguration::OAIGetHostOutput_VpcConfiguration() {
    this->initializeModel();
}

OAIGetHostOutput_VpcConfiguration::~OAIGetHostOutput_VpcConfiguration() {}

void OAIGetHostOutput_VpcConfiguration::initializeModel() {
...
void OAIGetHostOutput_VpcConfiguration::fromJson(QString jsonString) {
...
void OAIGetHostOutput_VpcConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIGetHostOutput_VpcConfiguration::asJson() const {
...
QJsonObject OAIGetHostOutput_VpcConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_vpc_id_isSet) {
...
QString OAIGetHostOutput_VpcConfiguration::getVpcId() const {
    return m_vpc_id;
}
void OAIGetHostOutput_VpcConfiguration::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIGetHostOutput_VpcConfiguration::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIGetHostOutput_VpcConfiguration::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QList OAIGetHostOutput_VpcConfiguration::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIGetHostOutput_VpcConfiguration::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIGetHostOutput_VpcConfiguration::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIGetHostOutput_VpcConfiguration::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIGetHostOutput_VpcConfiguration::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIGetHostOutput_VpcConfiguration::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIGetHostOutput_VpcConfiguration::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIGetHostOutput_VpcConfiguration::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QString OAIGetHostOutput_VpcConfiguration::getTlsCertificate() const {
    return m_tls_certificate;
}
void OAIGetHostOutput_VpcConfiguration::setTlsCertificate(const QString &tls_certificate) {
    m_tls_certificate = tls_certificate;
    m_tls_certificate_isSet = true;
}

bool OAIGetHostOutput_VpcConfiguration::is_tls_certificate_Set() const{
    return m_tls_certificate_isSet;
}

bool OAIGetHostOutput_VpcConfiguration::is_tls_certificate_Valid() const{
    return m_tls_certificate_isValid;
}

bool OAIGetHostOutput_VpcConfiguration::isSet() const {
...
bool OAIGetHostOutput_VpcConfiguration::isValid() const {
