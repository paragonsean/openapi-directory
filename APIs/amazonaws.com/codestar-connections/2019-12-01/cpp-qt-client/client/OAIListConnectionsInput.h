...
/*
 * OAIListConnectionsInput.h
 *
 * 
 */

#ifndef OAIListConnectionsInput_H
#define OAIListConnectionsInput_H
...
class OAIListConnectionsInput : public OAIObject {
public:
    OAIListConnectionsInput();
    OAIListConnectionsInput(QString json);
    ~OAIListConnectionsInput() override;
    ...
    OAIProviderType getProviderTypeFilter() const;
    void setProviderTypeFilter(const OAIProviderType &provider_type_filter);
    bool is_provider_type_filter_Set() const;
    bool is_provider_type_filter_Valid() const;

    QString getHostArnFilter() const;
    void setHostArnFilter(const QString &host_arn_filter);
    bool is_host_arn_filter_Set() const;
    bool is_host_arn_filter_Valid() const;
...
private:
    ...
    OAIProviderType m_provider_type_filter;
    bool m_provider_type_filter_isSet;
    bool m_provider_type_filter_isValid;

    QString m_host_arn_filter;
    bool m_host_arn_filter_isSet;
    bool m_host_arn_filter_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListConnectionsInput)

#endif // OAIListConnectionsInput_H
