...
OAIGetConnectionInput::OAIGetConnectionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetConnectionInput::OAIGetConnectionInput() {
    this->initializeModel();
}

OAIGetConnectionInput::~OAIGetConnectionInput() {}

void OAIGetConnectionInput::initializeModel() {

    m_connection_arn_isSet = false;
    m_connection_arn_isValid = false;
}

void OAIGetConnectionInput::fromJson(QString jsonString) {
...
void OAIGetConnectionInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetConnectionInput::asJson() const {
...
QJsonObject OAIGetConnectionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetConnectionInput::getConnectionArn() const {
    return m_connection_arn;
}
void OAIGetConnectionInput::setConnectionArn(const QString &connection_arn) {
    m_connection_arn = connection_arn;
    m_connection_arn_isSet = true;
}

bool OAIGetConnectionInput::is_connection_arn_Set() const{
    return m_connection_arn_isSet;
}

bool OAIGetConnectionInput::is_connection_arn_Valid() const{
    return m_connection_arn_isValid;
}

bool OAIGetConnectionInput::isSet() const {
...
bool OAIGetConnectionInput::isValid() const {
