...
OAICreateHostOutput::OAICreateHostOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateHostOutput::OAICreateHostOutput() {
    this->initializeModel();
}

OAICreateHostOutput::~OAICreateHostOutput() {}

void OAICreateHostOutput::initializeModel() {
...
void OAICreateHostOutput::fromJson(QString jsonString) {
...
void OAICreateHostOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateHostOutput::asJson() const {
...
QJsonObject OAICreateHostOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_host_arn_isSet) {
...
QString OAICreateHostOutput::getHostArn() const {
    return m_host_arn;
}
void OAICreateHostOutput::setHostArn(const QString &host_arn) {
    m_host_arn = host_arn;
    m_host_arn_isSet = true;
}

bool OAICreateHostOutput::is_host_arn_Set() const{
    return m_host_arn_isSet;
}

bool OAICreateHostOutput::is_host_arn_Valid() const{
    return m_host_arn_isValid;
}

QList<OAITag> OAICreateHostOutput::getTags() const {
    return m_tags;
}
void OAICreateHostOutput::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateHostOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateHostOutput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateHostOutput::isSet() const {
...
bool OAICreateHostOutput::isValid() const {
