...
OAIHost_VpcConfiguration::OAIHost_VpcConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHost_VpcConfiguration::OAIHost_VpcConfiguration() {
    this->initializeModel();
}

OAIHost_VpcConfiguration::~OAIHost_VpcConfiguration() {}

void OAIHost_VpcConfiguration::initializeModel() {
...
void OAIHost_VpcConfiguration::fromJson(QString jsonString) {
...
void OAIHost_VpcConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIHost_VpcConfiguration::asJson() const {
...
QJsonObject OAIHost_VpcConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_vpc_id_isSet) {
...
QString OAIHost_VpcConfiguration::getVpcId() const {
    return m_vpc_id;
}
void OAIHost_VpcConfiguration::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIHost_VpcConfiguration::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIHost_VpcConfiguration::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QList OAIHost_VpcConfiguration::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIHost_VpcConfiguration::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIHost_VpcConfiguration::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIHost_VpcConfiguration::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIHost_VpcConfiguration::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIHost_VpcConfiguration::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIHost_VpcConfiguration::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIHost_VpcConfiguration::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QString OAIHost_VpcConfiguration::getTlsCertificate() const {
    return m_tls_certificate;
}
void OAIHost_VpcConfiguration::setTlsCertificate(const QString &tls_certificate) {
    m_tls_certificate = tls_certificate;
    m_tls_certificate_isSet = true;
}

bool OAIHost_VpcConfiguration::is_tls_certificate_Set() const{
    return m_tls_certificate_isSet;
}

bool OAIHost_VpcConfiguration::is_tls_certificate_Valid() const{
    return m_tls_certificate_isValid;
}

bool OAIHost_VpcConfiguration::isSet() const {
...
bool OAIHost_VpcConfiguration::isValid() const {
