...
QString OAIVpcConfiguration::getTlsCertificate() const {
    return m_tls_certificate;
}
void OAIVpcConfiguration::setTlsCertificate(const QString &tls_certificate) {
    m_tls_certificate = tls_certificate;
    m_tls_certificate_isSet = true;
}

bool OAIVpcConfiguration::is_tls_certificate_Set() const{
    return m_tls_certificate_isSet;
}

bool OAIVpcConfiguration::is_tls_certificate_Valid() const{
