...
OAICreateConnectionOutput::OAICreateConnectionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateConnectionOutput::OAICreateConnectionOutput() {
    this->initializeModel();
}

OAICreateConnectionOutput::~OAICreateConnectionOutput() {}

void OAICreateConnectionOutput::initializeModel() {
...
void OAICreateConnectionOutput::fromJson(QString jsonString) {
...
void OAICreateConnectionOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateConnectionOutput::asJson() const {
...
QJsonObject OAICreateConnectionOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateConnectionOutput::getConnectionArn() const {
    return m_connection_arn;
}
void OAICreateConnectionOutput::setConnectionArn(const QString &connection_arn) {
    m_connection_arn = connection_arn;
    m_connection_arn_isSet = true;
}

bool OAICreateConnectionOutput::is_connection_arn_Set() const{
    return m_connection_arn_isSet;
}

bool OAICreateConnectionOutput::is_connection_arn_Valid() const{
    return m_connection_arn_isValid;
}

QList OAICreateConnectionOutput::getTags() const {
    return m_tags;
}
void OAICreateConnectionOutput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateConnectionOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateConnectionOutput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateConnectionOutput::isSet() const {
...
bool OAICreateConnectionOutput::isValid() const {
