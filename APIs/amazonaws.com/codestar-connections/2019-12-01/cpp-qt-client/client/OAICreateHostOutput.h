...
/*
 * OAICreateHostOutput.h
 *
 * 
 */

#ifndef OAICreateHostOutput_H
#define OAICreateHostOutput_H
...
class OAICreateHostOutput : public OAIObject {
public:
    OAICreateHostOutput();
    OAICreateHostOutput(QString json);
    ~OAICreateHostOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHostOutput)

#endif // OAICreateHostOutput_H
