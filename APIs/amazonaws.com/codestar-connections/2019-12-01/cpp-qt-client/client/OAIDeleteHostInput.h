...
/*
 * OAIDeleteHostInput.h
 *
 * 
 */

#ifndef OAIDeleteHostInput_H
#define OAIDeleteHostInput_H
...
class OAIDeleteHostInput : public OAIObject {
public:
    OAIDeleteHostInput();
    OAIDeleteHostInput(QString json);
    ~OAIDeleteHostInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHostInput)

#endif // OAIDeleteHostInput_H
