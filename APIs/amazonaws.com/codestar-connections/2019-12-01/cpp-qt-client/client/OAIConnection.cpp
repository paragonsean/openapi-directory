...
QString OAIConnection::getConnectionName() const {
    return m_connection_name;
}
void OAIConnection::setConnectionName(const QString &connection_name) {
    m_connection_name = connection_name;
    m_connection_name_isSet = true;
}

bool OAIConnection::is_connection_name_Set() const{
    return m_connection_name_isSet;
}

bool OAIConnection::is_connection_name_Valid() const{
    return m_connection_name_isValid;
}

QString OAIConnection::getConnectionArn() const {
    return m_connection_arn;
}
void OAIConnection::setConnectionArn(const QString &connection_arn) {
    m_connection_arn = connection_arn;
    m_connection_arn_isSet = true;
}

bool OAIConnection::is_connection_arn_Set() const{
    return m_connection_arn_isSet;
}

bool OAIConnection::is_connection_arn_Valid() const{
    return m_connection_arn_isValid;
}

OAIProviderType OAIConnection::getProviderType() const {
    return m_provider_type;
}
void OAIConnection::setProviderType(const OAIProviderType &provider_type) {
    m_provider_type = provider_type;
    m_provider_type_isSet = true;
}

bool OAIConnection::is_provider_type_Set() const{
    return m_provider_type_isSet;
}

bool OAIConnection::is_provider_type_Valid() const{
    return m_provider_type_isValid;
}

QString OAIConnection::getOwnerAccountId() const {
    return m_owner_account_id;
}
void OAIConnection::setOwnerAccountId(const QString &owner_account_id) {
    m_owner_account_id = owner_account_id;
    m_owner_account_id_isSet = true;
}

bool OAIConnection::is_owner_account_id_Set() const{
    return m_owner_account_id_isSet;
}

bool OAIConnection::is_owner_account_id_Valid() const{
    return m_owner_account_id_isValid;
}

OAIConnectionStatus OAIConnection::getConnectionStatus() const {
    return m_connection_status;
}
void OAIConnection::setConnectionStatus(const OAIConnectionStatus &connection_status) {
    m_connection_status = connection_status;
    m_connection_status_isSet = true;
}

bool OAIConnection::is_connection_status_Set() const{
    return m_connection_status_isSet;
}

bool OAIConnection::is_connection_status_Valid() const{
    return m_connection_status_isValid;
}

QString OAIConnection::getHostArn() const {
    return m_host_arn;
}
void OAIConnection::setHostArn(const QString &host_arn) {
    m_host_arn = host_arn;
    m_host_arn_isSet = true;
}

bool OAIConnection::is_host_arn_Set() const{
    return m_host_arn_isSet;
}

bool OAIConnection::is_host_arn_Valid() const{
