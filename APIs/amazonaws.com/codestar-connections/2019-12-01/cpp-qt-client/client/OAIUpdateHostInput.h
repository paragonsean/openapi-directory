...
/*
 * OAIUpdateHostInput.h
 *
 * 
 */

#ifndef OAIUpdateHostInput_H
#define OAIUpdateHostInput_H
...
namespace OpenAPI {
class OAIUpdateHostInput_VpcConfiguration;

class OAIUpdateHostInput : public OAIObject {
public:
    OAIUpdateHostInput();
    OAIUpdateHostInput(QString json);
    ~OAIUpdateHostInput() override;
    ...
    OAIUpdateHostInput_VpcConfiguration getVpcConfiguration() const;
    void setVpcConfiguration(const OAIUpdateHostInput_VpcConfiguration &vpc_configuration);
...
private:
    ...
    OAIUpdateHostInput_VpcConfiguration m_vpc_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateHostInput)

#endif // OAIUpdateHostInput_H
