...
/*
 * OAIListHostsOutput.h
 *
 * 
 */

#ifndef OAIListHostsOutput_H
#define OAIListHostsOutput_H
...
class OAIListHostsOutput : public OAIObject {
public:
    OAIListHostsOutput();
    OAIListHostsOutput(QString json);
    ~OAIListHostsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHostsOutput)

#endif // OAIListHostsOutput_H
