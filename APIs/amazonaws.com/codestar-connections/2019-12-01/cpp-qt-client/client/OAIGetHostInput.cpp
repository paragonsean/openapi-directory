...
OAIGetHostInput::OAIGetHostInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetHostInput::OAIGetHostInput() {
    this->initializeModel();
}

OAIGetHostInput::~OAIGetHostInput() {}

void OAIGetHostInput::initializeModel() {

    m_host_arn_isSet = false;
    m_host_arn_isValid = false;
}

void OAIGetHostInput::fromJson(QString jsonString) {
...
void OAIGetHostInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetHostInput::asJson() const {
...
QJsonObject OAIGetHostInput::asJsonObject() const {
    QJsonObject obj;
    if (m_host_arn_isSet) {
...
QString OAIGetHostInput::getHostArn() const {
    return m_host_arn;
}
void OAIGetHostInput::setHostArn(const QString &host_arn) {
    m_host_arn = host_arn;
    m_host_arn_isSet = true;
}

bool OAIGetHostInput::is_host_arn_Set() const{
    return m_host_arn_isSet;
}

bool OAIGetHostInput::is_host_arn_Valid() const{
    return m_host_arn_isValid;
}

bool OAIGetHostInput::isSet() const {
...
bool OAIGetHostInput::isValid() const {
