...
#ifndef OAIGetHostInput_H
#define OAIGetHostInput_H
...
class OAIGetHostInput : public OAIObject {
public:
    OAIGetHostInput();
    OAIGetHostInput(QString json);
    ~OAIGetHostInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHostInput)

#endif // OAIGetHostInput_H
