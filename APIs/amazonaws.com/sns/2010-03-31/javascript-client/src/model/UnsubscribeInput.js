...
/**
 * The UnsubscribeInput model module.
 * @module model/UnsubscribeInput
 * @version 2010-03-31
 */
class UnsubscribeInput {
    /**
     * Constructs a new <code>UnsubscribeInput</code>.
     * Input for Unsubscribe action.
     * @alias module:model/UnsubscribeInput
     * @param subscriptionArn {String} 
     */
    constructor(subscriptionArn) { 
        
        UnsubscribeInput.initialize(this, subscriptionArn);
    }
    ...
    /**
     * Constructs a <code>UnsubscribeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnsubscribeInput} obj Optional instance to populate.
     * @return {module:model/UnsubscribeInput} The populated <code>UnsubscribeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnsubscribeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UnsubscribeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnsubscribeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UnsubscribeInput.RequiredProperties) {
...
UnsubscribeInput.RequiredProperties = ["SubscriptionArn"];

/**
 * @member {String} SubscriptionArn
 */
UnsubscribeInput.prototype['SubscriptionArn'] = undefined;
