...
/**
 * The OptInPhoneNumberInput model module.
 * @module model/OptInPhoneNumberInput
 * @version 2010-03-31
 */
class OptInPhoneNumberInput {
    /**
     * Constructs a new <code>OptInPhoneNumberInput</code>.
     * Input for the OptInPhoneNumber action.
     * @alias module:model/OptInPhoneNumberInput
     * @param phoneNumber {String} 
     */
    constructor(phoneNumber) { 
        
        OptInPhoneNumberInput.initialize(this, phoneNumber);
    }
    ...
    /**
     * Constructs a <code>OptInPhoneNumberInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptInPhoneNumberInput} obj Optional instance to populate.
     * @return {module:model/OptInPhoneNumberInput} The populated <code>OptInPhoneNumberInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptInPhoneNumberInput();
    ...
    /**
     * Validates the JSON data with respect to <code>OptInPhoneNumberInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OptInPhoneNumberInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OptInPhoneNumberInput.RequiredProperties) {
...
OptInPhoneNumberInput.RequiredProperties = ["phoneNumber"];

/**
 * @member {String} phoneNumber
 */
OptInPhoneNumberInput.prototype['phoneNumber'] = undefined;
...
export default OptInPhoneNumberInput;
