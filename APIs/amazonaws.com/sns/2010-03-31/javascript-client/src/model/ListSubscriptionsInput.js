...
/**
 * The ListSubscriptionsInput model module.
 * @module model/ListSubscriptionsInput
 * @version 2010-03-31
 */
class ListSubscriptionsInput {
    /**
     * Constructs a new <code>ListSubscriptionsInput</code>.
     * Input for ListSubscriptions action.
     * @alias module:model/ListSubscriptionsInput
     */
    constructor() { 
        
        ListSubscriptionsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSubscriptionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSubscriptionsInput} obj Optional instance to populate.
     * @return {module:model/ListSubscriptionsInput} The populated <code>ListSubscriptionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSubscriptionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSubscriptionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSubscriptionsInput</code>.
     */
 ...
 */
ListSubscriptionsInput.prototype['NextToken'] = undefined;
...
export default ListSubscriptionsInput;
