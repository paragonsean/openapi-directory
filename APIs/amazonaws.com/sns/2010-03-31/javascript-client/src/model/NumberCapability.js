...
* @readonly
*/
export default class NumberCapability {
    ...
    /**
    * Returns a <code>NumberCapability</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NumberCapability} The enum <code>NumberCapability</code> value.
    */
