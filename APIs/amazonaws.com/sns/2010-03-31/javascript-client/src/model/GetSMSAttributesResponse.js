...
/**
 * The GetSMSAttributesResponse model module.
 * @module model/GetSMSAttributesResponse
 * @version 2010-03-31
 */
class GetSMSAttributesResponse {
    /**
     * Constructs a new <code>GetSMSAttributesResponse</code>.
     * The response from the &lt;code&gt;GetSMSAttributes&lt;/code&gt; request.
     * @alias module:model/GetSMSAttributesResponse
     */
    constructor() { 
        
        GetSMSAttributesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSMSAttributesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSMSAttributesResponse} obj Optional instance to populate.
     * @return {module:model/GetSMSAttributesResponse} The populated <code>GetSMSAttributesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSMSAttributesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSMSAttributesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSMSAttributesResponse</code>.
     */
 ...
 */
GetSMSAttributesResponse.prototype['attributes'] = undefined;
...
export default GetSMSAttributesResponse;
