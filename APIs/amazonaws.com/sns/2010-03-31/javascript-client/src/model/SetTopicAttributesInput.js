...
/**
 * The SetTopicAttributesInput model module.
 * @module model/SetTopicAttributesInput
 * @version 2010-03-31
 */
class SetTopicAttributesInput {
    /**
     * Constructs a new <code>SetTopicAttributesInput</code>.
     * Input for SetTopicAttributes action.
     * @alias module:model/SetTopicAttributesInput
     * @param topicArn {String} 
     * @param attributeName {String} 
     */
    constructor(topicArn, attributeName) { 
        
        SetTopicAttributesInput.initialize(this, topicArn, attributeName);
    }
     ...
     */
    static initialize(obj, topicArn, attributeName) { 
        obj['TopicArn'] = topicArn;
        obj['AttributeName'] = attributeName;
    }

    /**
     * Constructs a <code>SetTopicAttributesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetTopicAttributesInput} obj Optional instance to populate.
     * @return {module:model/SetTopicAttributesInput} The populated <code>SetTopicAttributesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetTopicAttributesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>SetTopicAttributesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetTopicAttributesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetTopicAttributesInput.RequiredProperties) {
...
SetTopicAttributesInput.RequiredProperties = ["TopicArn", "AttributeName"];

/**
 * @member {String} TopicArn
 */
SetTopicAttributesInput.prototype['TopicArn'] = undefined;

/**
 * @member {String} AttributeName
 */
SetTopicAttributesInput.prototype['AttributeName'] = undefined;

/**
 * @member {String} AttributeValue
 */
SetTopicAttributesInput.prototype['AttributeValue'] = undefined;
...
export default SetTopicAttributesInput;
