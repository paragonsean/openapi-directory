...
* @readonly
*/
export default class SMSSandboxPhoneNumberVerificationStatus {
    ...
    /**
    * Returns a <code>SMSSandboxPhoneNumberVerificationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SMSSandboxPhoneNumberVerificationStatus} The enum <code>SMSSandboxPhoneNumberVerificationStatus</code> value.
    */
