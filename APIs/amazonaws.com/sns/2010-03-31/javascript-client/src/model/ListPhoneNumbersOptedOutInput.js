...
/**
 * The ListPhoneNumbersOptedOutInput model module.
 * @module model/ListPhoneNumbersOptedOutInput
 * @version 2010-03-31
 */
class ListPhoneNumbersOptedOutInput {
    /**
     * Constructs a new <code>ListPhoneNumbersOptedOutInput</code>.
     * The input for the &lt;code&gt;ListPhoneNumbersOptedOut&lt;/code&gt; action.
     * @alias module:model/ListPhoneNumbersOptedOutInput
     */
    constructor() { 
        
        ListPhoneNumbersOptedOutInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPhoneNumbersOptedOutInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPhoneNumbersOptedOutInput} obj Optional instance to populate.
     * @return {module:model/ListPhoneNumbersOptedOutInput} The populated <code>ListPhoneNumbersOptedOutInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPhoneNumbersOptedOutInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPhoneNumbersOptedOutInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPhoneNumbersOptedOutInput</code>.
     */
 ...
 */
ListPhoneNumbersOptedOutInput.prototype['nextToken'] = undefined;
...
export default ListPhoneNumbersOptedOutInput;
