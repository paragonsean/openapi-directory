...
/**
 * The DeleteTopicInput model module.
 * @module model/DeleteTopicInput
 * @version 2010-03-31
 */
class DeleteTopicInput {
    /**
     * Constructs a new <code>DeleteTopicInput</code>.
     * @alias module:model/DeleteTopicInput
     * @param topicArn {String} 
     */
    constructor(topicArn) { 
        
        DeleteTopicInput.initialize(this, topicArn);
    }
    ...
    /**
     * Constructs a <code>DeleteTopicInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTopicInput} obj Optional instance to populate.
     * @return {module:model/DeleteTopicInput} The populated <code>DeleteTopicInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTopicInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTopicInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTopicInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteTopicInput.RequiredProperties) {
...
DeleteTopicInput.RequiredProperties = ["TopicArn"];

/**
 * @member {String} TopicArn
 */
DeleteTopicInput.prototype['TopicArn'] = undefined;
...
export default DeleteTopicInput;
