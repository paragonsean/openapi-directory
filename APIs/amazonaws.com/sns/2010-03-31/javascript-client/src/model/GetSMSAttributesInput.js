...
/**
 * The GetSMSAttributesInput model module.
 * @module model/GetSMSAttributesInput
 * @version 2010-03-31
 */
class GetSMSAttributesInput {
    /**
     * Constructs a new <code>GetSMSAttributesInput</code>.
     * The input for the &lt;code&gt;GetSMSAttributes&lt;/code&gt; request.
     * @alias module:model/GetSMSAttributesInput
     */
    constructor() { 
        
        GetSMSAttributesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSMSAttributesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSMSAttributesInput} obj Optional instance to populate.
     * @return {module:model/GetSMSAttributesInput} The populated <code>GetSMSAttributesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSMSAttributesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSMSAttributesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSMSAttributesInput</code>.
     */
 ...
 */
GetSMSAttributesInput.prototype['attributes'] = undefined;
...
export default GetSMSAttributesInput;
