...
/**
 * The SetSubscriptionAttributesInput model module.
 * @module model/SetSubscriptionAttributesInput
 * @version 2010-03-31
 */
class SetSubscriptionAttributesInput {
    /**
     * Constructs a new <code>SetSubscriptionAttributesInput</code>.
     * Input for SetSubscriptionAttributes action.
     * @alias module:model/SetSubscriptionAttributesInput
     * @param subscriptionArn {String} 
     * @param attributeName {String} 
     */
    constructor(subscriptionArn, attributeName) { 
        
        SetSubscriptionAttributesInput.initialize(this, subscriptionArn, attributeName);
    }
     ...
     */
    static initialize(obj, subscriptionArn, attributeName) { 
        obj['SubscriptionArn'] = subscriptionArn;
        obj['AttributeName'] = attributeName;
    }

    /**
     * Constructs a <code>SetSubscriptionAttributesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetSubscriptionAttributesInput} obj Optional instance to populate.
     * @return {module:model/SetSubscriptionAttributesInput} The populated <code>SetSubscriptionAttributesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetSubscriptionAttributesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>SetSubscriptionAttributesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetSubscriptionAttributesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetSubscriptionAttributesInput.RequiredProperties) {
...
SetSubscriptionAttributesInput.RequiredProperties = ["SubscriptionArn", "AttributeName"];

/**
 * @member {String} SubscriptionArn
 */
SetSubscriptionAttributesInput.prototype['SubscriptionArn'] = undefined;

/**
 * @member {String} AttributeName
 */
SetSubscriptionAttributesInput.prototype['AttributeName'] = undefined;

/**
 * @member {String} AttributeValue
 */
SetSubscriptionAttributesInput.prototype['AttributeValue'] = undefined;
...
export default SetSubscriptionAttributesInput;
