...
/**
 * The CreateTopicResponse model module.
 * @module model/CreateTopicResponse
 * @version 2010-03-31
 */
class CreateTopicResponse {
    /**
     * Constructs a new <code>CreateTopicResponse</code>.
     * Response from CreateTopic action.
     * @alias module:model/CreateTopicResponse
     */
    constructor() { 
        
        CreateTopicResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTopicResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTopicResponse} obj Optional instance to populate.
     * @return {module:model/CreateTopicResponse} The populated <code>CreateTopicResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTopicResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTopicResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTopicResponse</code>.
     */
 ...
 */
CreateTopicResponse.prototype['TopicArn'] = undefined;
...
export default CreateTopicResponse;
