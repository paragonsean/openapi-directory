...
/**
 * The PutDataProtectionPolicyInput model module.
 * @module model/PutDataProtectionPolicyInput
 * @version 2010-03-31
 */
class PutDataProtectionPolicyInput {
    /**
     * Constructs a new <code>PutDataProtectionPolicyInput</code>.
     * @alias module:model/PutDataProtectionPolicyInput
     * @param resourceArn {String} 
     * @param dataProtectionPolicy {String} 
     */
    constructor(resourceArn, dataProtectionPolicy) { 
        
        PutDataProtectionPolicyInput.initialize(this, resourceArn, dataProtectionPolicy);
    }
     ...
     */
    static initialize(obj, resourceArn, dataProtectionPolicy) { 
        obj['ResourceArn'] = resourceArn;
        obj['DataProtectionPolicy'] = dataProtectionPolicy;
    }

    /**
     * Constructs a <code>PutDataProtectionPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutDataProtectionPolicyInput} obj Optional instance to populate.
     * @return {module:model/PutDataProtectionPolicyInput} The populated <code>PutDataProtectionPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutDataProtectionPolicyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutDataProtectionPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutDataProtectionPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutDataProtectionPolicyInput.RequiredProperties) {
...
PutDataProtectionPolicyInput.RequiredProperties = ["ResourceArn", "DataProtectionPolicy"];

/**
 * @member {String} ResourceArn
 */
PutDataProtectionPolicyInput.prototype['ResourceArn'] = undefined;

/**
 * @member {String} DataProtectionPolicy
 */
PutDataProtectionPolicyInput.prototype['DataProtectionPolicy'] = undefined;
...
export default PutDataProtectionPolicyInput;
