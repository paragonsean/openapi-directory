...
/**
 * The ListTopicsInput model module.
 * @module model/ListTopicsInput
 * @version 2010-03-31
 */
class ListTopicsInput {
    /**
     * Constructs a new <code>ListTopicsInput</code>.
     * @alias module:model/ListTopicsInput
     */
    constructor() { 
        
        ListTopicsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTopicsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTopicsInput} obj Optional instance to populate.
     * @return {module:model/ListTopicsInput} The populated <code>ListTopicsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTopicsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTopicsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTopicsInput</code>.
     */
 ...
 */
ListTopicsInput.prototype['NextToken'] = undefined;
...
export default ListTopicsInput;
