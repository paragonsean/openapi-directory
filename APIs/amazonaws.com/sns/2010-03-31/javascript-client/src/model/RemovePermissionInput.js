...
/**
 * The RemovePermissionInput model module.
 * @module model/RemovePermissionInput
 * @version 2010-03-31
 */
class RemovePermissionInput {
    /**
     * Constructs a new <code>RemovePermissionInput</code>.
     * Input for RemovePermission action.
     * @alias module:model/RemovePermissionInput
     * @param topicArn {String} 
     * @param label {String} 
     */
    constructor(topicArn, label) { 
        
        RemovePermissionInput.initialize(this, topicArn, label);
    }
     ...
     */
    static initialize(obj, topicArn, label) { 
        obj['TopicArn'] = topicArn;
        obj['Label'] = label;
    }

    /**
     * Constructs a <code>RemovePermissionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemovePermissionInput} obj Optional instance to populate.
     * @return {module:model/RemovePermissionInput} The populated <code>RemovePermissionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemovePermissionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RemovePermissionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemovePermissionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemovePermissionInput.RequiredProperties) {
...
RemovePermissionInput.RequiredProperties = ["TopicArn", "Label"];

/**
 * @member {String} TopicArn
 */
RemovePermissionInput.prototype['TopicArn'] = undefined;

/**
 * @member {String} Label
 */
RemovePermissionInput.prototype['Label'] = undefined;
...
export default RemovePermissionInput;
