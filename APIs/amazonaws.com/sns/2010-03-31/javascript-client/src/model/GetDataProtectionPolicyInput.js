...
/**
 * The GetDataProtectionPolicyInput model module.
 * @module model/GetDataProtectionPolicyInput
 * @version 2010-03-31
 */
class GetDataProtectionPolicyInput {
    /**
     * Constructs a new <code>GetDataProtectionPolicyInput</code>.
     * @alias module:model/GetDataProtectionPolicyInput
     * @param resourceArn {String} 
     */
    constructor(resourceArn) { 
        
        GetDataProtectionPolicyInput.initialize(this, resourceArn);
    }
    ...
    /**
     * Constructs a <code>GetDataProtectionPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDataProtectionPolicyInput} obj Optional instance to populate.
     * @return {module:model/GetDataProtectionPolicyInput} The populated <code>GetDataProtectionPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataProtectionPolicyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataProtectionPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataProtectionPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDataProtectionPolicyInput.RequiredProperties) {
...
GetDataProtectionPolicyInput.RequiredProperties = ["ResourceArn"];

/**
 * @member {String} ResourceArn
 */
GetDataProtectionPolicyInput.prototype['ResourceArn'] = undefined;
...
export default GetDataProtectionPolicyInput;
