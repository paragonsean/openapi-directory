...
/**
 * The ConfirmSubscriptionResponse model module.
 * @module model/ConfirmSubscriptionResponse
 * @version 2010-03-31
 */
class ConfirmSubscriptionResponse {
    /**
     * Constructs a new <code>ConfirmSubscriptionResponse</code>.
     * Response for ConfirmSubscriptions action.
     * @alias module:model/ConfirmSubscriptionResponse
     */
    constructor() { 
        
        ConfirmSubscriptionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmSubscriptionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmSubscriptionResponse} obj Optional instance to populate.
     * @return {module:model/ConfirmSubscriptionResponse} The populated <code>ConfirmSubscriptionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmSubscriptionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmSubscriptionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmSubscriptionResponse</code>.
     */
 ...
 */
ConfirmSubscriptionResponse.prototype['SubscriptionArn'] = undefined;
...
export default ConfirmSubscriptionResponse;
