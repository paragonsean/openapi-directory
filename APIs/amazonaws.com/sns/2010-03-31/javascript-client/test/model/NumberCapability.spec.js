...
(function(root, factory) {
  ...
  describe('NumberCapability', function() {
    it('should create an instance of NumberCapability', function() {
      // uncomment below and update the code to test NumberCapability
      //var instance = new AmazonSimpleNotificationService.NumberCapability();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.NumberCapability);
    });
