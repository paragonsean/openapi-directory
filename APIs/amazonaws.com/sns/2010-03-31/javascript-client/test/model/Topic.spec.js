...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.Topic();
  });
  ...
  describe('Topic', function() {
    it('should create an instance of Topic', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.Topic();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.Topic);
    });
