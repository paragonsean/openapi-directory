...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SetSMSAttributesInput();
  });
  ...
  describe('SetSMSAttributesInput', function() {
    it('should create an instance of SetSMSAttributesInput', function() {
      // uncomment below and update the code to test SetSMSAttributesInput
      //var instance = new AmazonSimpleNotificationService.SetSMSAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SetSMSAttributesInput);
    });
