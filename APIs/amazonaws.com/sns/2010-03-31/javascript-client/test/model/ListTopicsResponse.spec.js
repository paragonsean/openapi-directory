...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListTopicsResponse();
  });
  ...
  describe('ListTopicsResponse', function() {
    it('should create an instance of ListTopicsResponse', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.ListTopicsResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListTopicsResponse);
    });
