...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CreatePlatformApplicationResponse();
  });
  ...
  describe('CreatePlatformApplicationResponse', function() {
    it('should create an instance of CreatePlatformApplicationResponse', function() {
      // uncomment below and update the code to test CreatePlatformApplicationResponse
      //var instance = new AmazonSimpleNotificationService.CreatePlatformApplicationResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CreatePlatformApplicationResponse);
    });
