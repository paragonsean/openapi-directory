...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListSubscriptionsInput();
  });
  ...
  describe('ListSubscriptionsInput', function() {
    it('should create an instance of ListSubscriptionsInput', function() {
      // uncomment below and update the code to test ListSubscriptionsInput
      //var instance = new AmazonSimpleNotificationService.ListSubscriptionsInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListSubscriptionsInput);
    });
