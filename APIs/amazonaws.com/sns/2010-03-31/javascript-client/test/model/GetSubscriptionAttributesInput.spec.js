...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetSubscriptionAttributesInput();
  });
  ...
  describe('GetSubscriptionAttributesInput', function() {
    it('should create an instance of GetSubscriptionAttributesInput', function() {
      // uncomment below and update the code to test GetSubscriptionAttributesInput
      //var instance = new AmazonSimpleNotificationService.GetSubscriptionAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetSubscriptionAttributesInput);
    });
