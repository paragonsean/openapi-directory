...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CreatePlatformApplicationInput();
  });
  ...
  describe('CreatePlatformApplicationInput', function() {
    it('should create an instance of CreatePlatformApplicationInput', function() {
      // uncomment below and update the code to test CreatePlatformApplicationInput
      //var instance = new AmazonSimpleNotificationService.CreatePlatformApplicationInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CreatePlatformApplicationInput);
    });
