...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetTopicAttributesInput();
  });
  ...
  describe('GetTopicAttributesInput', function() {
    it('should create an instance of GetTopicAttributesInput', function() {
      // uncomment below and update the code to test GetTopicAttributesInput
      //var instance = new AmazonSimpleNotificationService.GetTopicAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetTopicAttributesInput);
    });
