...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetEndpointAttributesResponse();
  });
  ...
  describe('GetEndpointAttributesResponse', function() {
    it('should create an instance of GetEndpointAttributesResponse', function() {
      // uncomment below and update the code to test GetEndpointAttributesResponse
      //var instance = new AmazonSimpleNotificationService.GetEndpointAttributesResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetEndpointAttributesResponse);
    });
