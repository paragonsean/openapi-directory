...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListPhoneNumbersOptedOutResponse();
  });
  ...
  describe('ListPhoneNumbersOptedOutResponse', function() {
    it('should create an instance of ListPhoneNumbersOptedOutResponse', function() {
      // uncomment below and update the code to test ListPhoneNumbersOptedOutResponse
      //var instance = new AmazonSimpleNotificationService.ListPhoneNumbersOptedOutResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListPhoneNumbersOptedOutResponse);
    });
