...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetDataProtectionPolicyResponse();
  });
  ...
  describe('GetDataProtectionPolicyResponse', function() {
    it('should create an instance of GetDataProtectionPolicyResponse', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.GetDataProtectionPolicyResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetDataProtectionPolicyResponse);
    });
