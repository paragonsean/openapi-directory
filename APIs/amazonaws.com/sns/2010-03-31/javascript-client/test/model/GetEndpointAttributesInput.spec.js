...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetEndpointAttributesInput();
  });
  ...
  describe('GetEndpointAttributesInput', function() {
    it('should create an instance of GetEndpointAttributesInput', function() {
      // uncomment below and update the code to test GetEndpointAttributesInput
      //var instance = new AmazonSimpleNotificationService.GetEndpointAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetEndpointAttributesInput);
    });
