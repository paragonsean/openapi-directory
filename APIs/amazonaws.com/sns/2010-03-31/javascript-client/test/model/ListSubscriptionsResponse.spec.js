...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListSubscriptionsResponse();
  });
  ...
  describe('ListSubscriptionsResponse', function() {
    it('should create an instance of ListSubscriptionsResponse', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.ListSubscriptionsResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListSubscriptionsResponse);
    });
