...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ConfirmSubscriptionResponse();
  });
  ...
  describe('ConfirmSubscriptionResponse', function() {
    it('should create an instance of ConfirmSubscriptionResponse', function() {
      // uncomment below and update the code to test ConfirmSubscriptionResponse
      //var instance = new AmazonSimpleNotificationService.ConfirmSubscriptionResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ConfirmSubscriptionResponse);
    });
