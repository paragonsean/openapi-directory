...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PublishBatchResultEntry();
  });
  ...
  describe('PublishBatchResultEntry', function() {
    it('should create an instance of PublishBatchResultEntry', function() {
      // uncomment below and update the code to test PublishBatchResultEntry
      //var instance = new AmazonSimpleNotificationService.PublishBatchResultEntry();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PublishBatchResultEntry);
    });
