...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListPlatformApplicationsResponse();
  });
  ...
  describe('ListPlatformApplicationsResponse', function() {
    it('should create an instance of ListPlatformApplicationsResponse', function() {
      // uncomment below and update the code to test ListPlatformApplicationsResponse
      //var instance = new AmazonSimpleNotificationService.ListPlatformApplicationsResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListPlatformApplicationsResponse);
    });

    it('should have the property platformApplications (base name: "PlatformApplications")', function() {
      // uncomment below and update the code to test the property platformApplications
      //var instance = new AmazonSimpleNotificationService.ListPlatformApplicationsResponse();
