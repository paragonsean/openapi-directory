...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListSubscriptionsByTopicResponse();
  });
  ...
  describe('ListSubscriptionsByTopicResponse', function() {
    it('should create an instance of ListSubscriptionsByTopicResponse', function() {
      // uncomment below and update the code to test ListSubscriptionsByTopicResponse
      //var instance = new AmazonSimpleNotificationService.ListSubscriptionsByTopicResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListSubscriptionsByTopicResponse);
    });
