...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CheckIfPhoneNumberIsOptedOutResponse();
  });
  ...
  describe('CheckIfPhoneNumberIsOptedOutResponse', function() {
    it('should create an instance of CheckIfPhoneNumberIsOptedOutResponse', function() {
      // uncomment below and update the code to test CheckIfPhoneNumberIsOptedOutResponse
      //var instance = new AmazonSimpleNotificationService.CheckIfPhoneNumberIsOptedOutResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CheckIfPhoneNumberIsOptedOutResponse);
    });
