...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SubscribeInput();
  });
  ...
  describe('SubscribeInput', function() {
    it('should create an instance of SubscribeInput', function() {
      // uncomment below and update the code to test SubscribeInput
      //var instance = new AmazonSimpleNotificationService.SubscribeInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SubscribeInput);
    });
    ...
    it('should have the property returnSubscriptionArn (base name: "ReturnSubscriptionArn")', function() {
      // uncomment below and update the code to test the property returnSubscriptionArn
      //var instance = new AmazonSimpleNotificationService.SubscribeInput();
      //expect(instance).to.be();
    });
