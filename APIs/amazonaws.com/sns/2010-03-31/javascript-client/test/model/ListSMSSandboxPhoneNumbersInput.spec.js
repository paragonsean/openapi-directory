...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListSMSSandboxPhoneNumbersInput();
  });
  ...
  describe('ListSMSSandboxPhoneNumbersInput', function() {
    it('should create an instance of ListSMSSandboxPhoneNumbersInput', function() {
      // uncomment below and update the code to test ListSMSSandboxPhoneNumbersInput
      //var instance = new AmazonSimpleNotificationService.ListSMSSandboxPhoneNumbersInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListSMSSandboxPhoneNumbersInput);
    });
