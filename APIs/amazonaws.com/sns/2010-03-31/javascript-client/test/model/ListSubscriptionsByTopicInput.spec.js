...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListSubscriptionsByTopicInput();
  });
  ...
  describe('ListSubscriptionsByTopicInput', function() {
    it('should create an instance of ListSubscriptionsByTopicInput', function() {
      // uncomment below and update the code to test ListSubscriptionsByTopicInput
      //var instance = new AmazonSimpleNotificationService.ListSubscriptionsByTopicInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListSubscriptionsByTopicInput);
    });
