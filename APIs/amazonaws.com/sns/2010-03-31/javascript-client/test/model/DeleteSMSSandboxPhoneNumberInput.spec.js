...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.DeleteSMSSandboxPhoneNumberInput();
  });
  ...
  describe('DeleteSMSSandboxPhoneNumberInput', function() {
    it('should create an instance of DeleteSMSSandboxPhoneNumberInput', function() {
      // uncomment below and update the code to test DeleteSMSSandboxPhoneNumberInput
      //var instance = new AmazonSimpleNotificationService.DeleteSMSSandboxPhoneNumberInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.DeleteSMSSandboxPhoneNumberInput);
    });
