...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetSMSAttributesResponse();
  });
  ...
  describe('GetSMSAttributesResponse', function() {
    it('should create an instance of GetSMSAttributesResponse', function() {
      // uncomment below and update the code to test GetSMSAttributesResponse
      //var instance = new AmazonSimpleNotificationService.GetSMSAttributesResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetSMSAttributesResponse);
    });
