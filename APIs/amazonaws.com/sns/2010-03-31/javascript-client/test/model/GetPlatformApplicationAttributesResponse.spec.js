...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetPlatformApplicationAttributesResponse();
  });
  ...
  describe('GetPlatformApplicationAttributesResponse', function() {
    it('should create an instance of GetPlatformApplicationAttributesResponse', function() {
      // uncomment below and update the code to test GetPlatformApplicationAttributesResponse
      //var instance = new AmazonSimpleNotificationService.GetPlatformApplicationAttributesResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetPlatformApplicationAttributesResponse);
    });
