...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetSMSAttributesInput();
  });
  ...
  describe('GetSMSAttributesInput', function() {
    it('should create an instance of GetSMSAttributesInput', function() {
      // uncomment below and update the code to test GetSMSAttributesInput
      //var instance = new AmazonSimpleNotificationService.GetSMSAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetSMSAttributesInput);
    });
