...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SetEndpointAttributesInput();
  });
  ...
  describe('SetEndpointAttributesInput', function() {
    it('should create an instance of SetEndpointAttributesInput', function() {
      // uncomment below and update the code to test SetEndpointAttributesInput
      //var instance = new AmazonSimpleNotificationService.SetEndpointAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SetEndpointAttributesInput);
    });
