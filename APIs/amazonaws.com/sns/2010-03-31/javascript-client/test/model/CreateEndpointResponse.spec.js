...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CreateEndpointResponse();
  });
  ...
  describe('CreateEndpointResponse', function() {
    it('should create an instance of CreateEndpointResponse', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.CreateEndpointResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CreateEndpointResponse);
    });
