...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListTagsForResourceResponse);
    });
