...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListEndpointsByPlatformApplicationResponse();
  });
  ...
  describe('ListEndpointsByPlatformApplicationResponse', function() {
    it('should create an instance of ListEndpointsByPlatformApplicationResponse', function() {
      // uncomment below and update the code to test ListEndpointsByPlatformApplicationResponse
      //var instance = new AmazonSimpleNotificationService.ListEndpointsByPlatformApplicationResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListEndpointsByPlatformApplicationResponse);
    });
