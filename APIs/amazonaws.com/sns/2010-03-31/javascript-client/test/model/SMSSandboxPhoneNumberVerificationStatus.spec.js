...
(function(root, factory) {
  ...
  describe('SMSSandboxPhoneNumberVerificationStatus', function() {
    it('should create an instance of SMSSandboxPhoneNumberVerificationStatus', function() {
      // uncomment below and update the code to test SMSSandboxPhoneNumberVerificationStatus
      //var instance = new AmazonSimpleNotificationService.SMSSandboxPhoneNumberVerificationStatus();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SMSSandboxPhoneNumberVerificationStatus);
    });
