...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SetTopicAttributesInput();
  });
  ...
  describe('SetTopicAttributesInput', function() {
    it('should create an instance of SetTopicAttributesInput', function() {
      // uncomment below and update the code to test SetTopicAttributesInput
      //var instance = new AmazonSimpleNotificationService.SetTopicAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SetTopicAttributesInput);
    });
