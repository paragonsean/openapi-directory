...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CheckIfPhoneNumberIsOptedOutInput();
  });
  ...
  describe('CheckIfPhoneNumberIsOptedOutInput', function() {
    it('should create an instance of CheckIfPhoneNumberIsOptedOutInput', function() {
      // uncomment below and update the code to test CheckIfPhoneNumberIsOptedOutInput
      //var instance = new AmazonSimpleNotificationService.CheckIfPhoneNumberIsOptedOutInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CheckIfPhoneNumberIsOptedOutInput);
    });
