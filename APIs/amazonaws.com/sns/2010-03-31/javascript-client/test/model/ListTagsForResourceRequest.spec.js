...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListTagsForResourceRequest);
    });
