...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.OptInPhoneNumberInput();
  });
  ...
  describe('OptInPhoneNumberInput', function() {
    it('should create an instance of OptInPhoneNumberInput', function() {
      // uncomment below and update the code to test OptInPhoneNumberInput
      //var instance = new AmazonSimpleNotificationService.OptInPhoneNumberInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.OptInPhoneNumberInput);
    });
