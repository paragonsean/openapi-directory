...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListEndpointsByPlatformApplicationInput();
  });
  ...
  describe('ListEndpointsByPlatformApplicationInput', function() {
    it('should create an instance of ListEndpointsByPlatformApplicationInput', function() {
      // uncomment below and update the code to test ListEndpointsByPlatformApplicationInput
      //var instance = new AmazonSimpleNotificationService.ListEndpointsByPlatformApplicationInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListEndpointsByPlatformApplicationInput);
    });
