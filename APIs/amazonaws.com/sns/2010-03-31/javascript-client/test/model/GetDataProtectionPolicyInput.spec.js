...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetDataProtectionPolicyInput();
  });
  ...
  describe('GetDataProtectionPolicyInput', function() {
    it('should create an instance of GetDataProtectionPolicyInput', function() {
      // uncomment below and update the code to test GetDataProtectionPolicyInput
      //var instance = new AmazonSimpleNotificationService.GetDataProtectionPolicyInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetDataProtectionPolicyInput);
    });
