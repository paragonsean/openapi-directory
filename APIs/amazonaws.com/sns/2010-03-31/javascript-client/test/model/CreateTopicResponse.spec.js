...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CreateTopicResponse();
  });
  ...
  describe('CreateTopicResponse', function() {
    it('should create an instance of CreateTopicResponse', function() {
      // uncomment below and update the code to test CreateTopicResponse
      //var instance = new AmazonSimpleNotificationService.CreateTopicResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CreateTopicResponse);
    });
