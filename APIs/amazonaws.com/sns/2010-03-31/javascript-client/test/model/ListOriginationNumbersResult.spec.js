...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListOriginationNumbersResult();
  });
  ...
  describe('ListOriginationNumbersResult', function() {
    it('should create an instance of ListOriginationNumbersResult', function() {
      // uncomment below and update the code to test ListOriginationNumbersResult
      //var instance = new AmazonSimpleNotificationService.ListOriginationNumbersResult();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListOriginationNumbersResult);
    });
