...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PublishResponse();
  });
  ...
  describe('PublishResponse', function() {
    it('should create an instance of PublishResponse', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.PublishResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PublishResponse);
    });
