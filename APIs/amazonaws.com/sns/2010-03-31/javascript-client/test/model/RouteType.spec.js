...
(function(root, factory) {
  ...
  describe('RouteType', function() {
    it('should create an instance of RouteType', function() {
      // uncomment below and update the code to test RouteType
      //var instance = new AmazonSimpleNotificationService.RouteType();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.RouteType);
    });
