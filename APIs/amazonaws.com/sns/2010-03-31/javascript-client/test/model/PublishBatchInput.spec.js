...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PublishBatchInput();
  });
  ...
  describe('PublishBatchInput', function() {
    it('should create an instance of PublishBatchInput', function() {
      // uncomment below and update the code to test PublishBatchInput
      //var instance = new AmazonSimpleNotificationService.PublishBatchInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PublishBatchInput);
    });
    ...
    it('should have the property publishBatchRequestEntries (base name: "PublishBatchRequestEntries")', function() {
      // uncomment below and update the code to test the property publishBatchRequestEntries
      //var instance = new AmazonSimpleNotificationService.PublishBatchInput();
      //expect(instance).to.be();
    });
