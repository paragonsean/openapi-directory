...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.UntagResourceRequest);
    });
