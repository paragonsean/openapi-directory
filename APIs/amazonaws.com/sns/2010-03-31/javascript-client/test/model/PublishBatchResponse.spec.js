...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PublishBatchResponse();
  });
  ...
  describe('PublishBatchResponse', function() {
    it('should create an instance of PublishBatchResponse', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.PublishBatchResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PublishBatchResponse);
    });
