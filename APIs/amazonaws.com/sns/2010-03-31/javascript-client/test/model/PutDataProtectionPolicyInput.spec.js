...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PutDataProtectionPolicyInput();
  });
  ...
  describe('PutDataProtectionPolicyInput', function() {
    it('should create an instance of PutDataProtectionPolicyInput', function() {
      // uncomment below and update the code to test PutDataProtectionPolicyInput
      //var instance = new AmazonSimpleNotificationService.PutDataProtectionPolicyInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PutDataProtectionPolicyInput);
    });
