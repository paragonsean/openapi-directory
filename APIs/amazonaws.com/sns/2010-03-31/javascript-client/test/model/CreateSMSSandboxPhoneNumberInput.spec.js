...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CreateSMSSandboxPhoneNumberInput();
  });
  ...
  describe('CreateSMSSandboxPhoneNumberInput', function() {
    it('should create an instance of CreateSMSSandboxPhoneNumberInput', function() {
      // uncomment below and update the code to test CreateSMSSandboxPhoneNumberInput
      //var instance = new AmazonSimpleNotificationService.CreateSMSSandboxPhoneNumberInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CreateSMSSandboxPhoneNumberInput);
    });
