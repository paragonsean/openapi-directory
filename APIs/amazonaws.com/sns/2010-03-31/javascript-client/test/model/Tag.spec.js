...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.Tag();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.Tag);
    });
