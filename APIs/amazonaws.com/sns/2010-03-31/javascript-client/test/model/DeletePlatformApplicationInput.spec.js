...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.DeletePlatformApplicationInput();
  });
  ...
  describe('DeletePlatformApplicationInput', function() {
    it('should create an instance of DeletePlatformApplicationInput', function() {
      // uncomment below and update the code to test DeletePlatformApplicationInput
      //var instance = new AmazonSimpleNotificationService.DeletePlatformApplicationInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.DeletePlatformApplicationInput);
    });
