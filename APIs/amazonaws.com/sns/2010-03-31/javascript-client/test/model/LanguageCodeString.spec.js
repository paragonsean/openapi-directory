...
(function(root, factory) {
  ...
  describe('LanguageCodeString', function() {
    it('should create an instance of LanguageCodeString', function() {
      // uncomment below and update the code to test LanguageCodeString
      //var instance = new AmazonSimpleNotificationService.LanguageCodeString();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.LanguageCodeString);
    });
