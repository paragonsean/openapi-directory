...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetTopicAttributesResponse();
  });
  ...
  describe('GetTopicAttributesResponse', function() {
    it('should create an instance of GetTopicAttributesResponse', function() {
      // uncomment below and update the code to test GetTopicAttributesResponse
      //var instance = new AmazonSimpleNotificationService.GetTopicAttributesResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetTopicAttributesResponse);
    });
