...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PlatformApplication();
  });
  ...
  describe('PlatformApplication', function() {
    it('should create an instance of PlatformApplication', function() {
      // uncomment below and update the code to test PlatformApplication
      //var instance = new AmazonSimpleNotificationService.PlatformApplication();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PlatformApplication);
    });
