...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetSMSSandboxAccountStatusResult();
  });
  ...
  describe('GetSMSSandboxAccountStatusResult', function() {
    it('should create an instance of GetSMSSandboxAccountStatusResult', function() {
      // uncomment below and update the code to test GetSMSSandboxAccountStatusResult
      //var instance = new AmazonSimpleNotificationService.GetSMSSandboxAccountStatusResult();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetSMSSandboxAccountStatusResult);
    });

    it('should have the property isInSandbox (base name: "IsInSandbox")', function() {
      // uncomment below and update the code to test the property isInSandbox
      //var instance = new AmazonSimpleNotificationService.GetSMSSandboxAccountStatusResult();
