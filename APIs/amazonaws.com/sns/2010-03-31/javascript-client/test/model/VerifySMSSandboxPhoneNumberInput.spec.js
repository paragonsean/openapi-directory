...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.VerifySMSSandboxPhoneNumberInput();
  });
  ...
  describe('VerifySMSSandboxPhoneNumberInput', function() {
    it('should create an instance of VerifySMSSandboxPhoneNumberInput', function() {
      // uncomment below and update the code to test VerifySMSSandboxPhoneNumberInput
      //var instance = new AmazonSimpleNotificationService.VerifySMSSandboxPhoneNumberInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.VerifySMSSandboxPhoneNumberInput);
    });
    ...
    it('should have the property oneTimePassword (base name: "OneTimePassword")', function() {
      // uncomment below and update the code to test the property oneTimePassword
      //var instance = new AmazonSimpleNotificationService.VerifySMSSandboxPhoneNumberInput();
      //expect(instance).to.be();
    });
