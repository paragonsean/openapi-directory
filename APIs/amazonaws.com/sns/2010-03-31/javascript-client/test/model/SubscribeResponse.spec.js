...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SubscribeResponse();
  });
  ...
  describe('SubscribeResponse', function() {
    it('should create an instance of SubscribeResponse', function() {
      // uncomment below and update the code to test SubscribeResponse
      //var instance = new AmazonSimpleNotificationService.SubscribeResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SubscribeResponse);
    });
