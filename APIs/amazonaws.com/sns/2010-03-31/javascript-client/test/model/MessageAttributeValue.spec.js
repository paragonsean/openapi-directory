...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.MessageAttributeValue();
  });
  ...
  describe('MessageAttributeValue', function() {
    it('should create an instance of MessageAttributeValue', function() {
      // uncomment below and update the code to test MessageAttributeValue
      //var instance = new AmazonSimpleNotificationService.MessageAttributeValue();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.MessageAttributeValue);
    });
