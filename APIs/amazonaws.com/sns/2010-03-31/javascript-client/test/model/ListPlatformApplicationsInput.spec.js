...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListPlatformApplicationsInput();
  });
  ...
  describe('ListPlatformApplicationsInput', function() {
    it('should create an instance of ListPlatformApplicationsInput', function() {
      // uncomment below and update the code to test ListPlatformApplicationsInput
      //var instance = new AmazonSimpleNotificationService.ListPlatformApplicationsInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListPlatformApplicationsInput);
    });
