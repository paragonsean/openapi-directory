...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PhoneNumberInformation();
  });
  ...
  describe('PhoneNumberInformation', function() {
    it('should create an instance of PhoneNumberInformation', function() {
      // uncomment below and update the code to test PhoneNumberInformation
      //var instance = new AmazonSimpleNotificationService.PhoneNumberInformation();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PhoneNumberInformation);
    });
    ...
    it('should have the property iso2CountryCode (base name: "Iso2CountryCode")', function() {
      // uncomment below and update the code to test the property iso2CountryCode
      //var instance = new AmazonSimpleNotificationService.PhoneNumberInformation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberCapabilities (base name: "NumberCapabilities")', function() {
      // uncomment below and update the code to test the property numberCapabilities
      //var instance = new AmazonSimpleNotificationService.PhoneNumberInformation();
      //expect(instance).to.be();
    });
