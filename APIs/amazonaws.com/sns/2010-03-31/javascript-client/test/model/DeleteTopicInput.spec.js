...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.DeleteTopicInput();
  });
  ...
  describe('DeleteTopicInput', function() {
    it('should create an instance of DeleteTopicInput', function() {
      // uncomment below and update the code to test DeleteTopicInput
      //var instance = new AmazonSimpleNotificationService.DeleteTopicInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.DeleteTopicInput);
    });
