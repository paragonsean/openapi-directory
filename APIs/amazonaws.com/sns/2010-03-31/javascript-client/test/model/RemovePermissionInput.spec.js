...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.RemovePermissionInput();
  });
  ...
  describe('RemovePermissionInput', function() {
    it('should create an instance of RemovePermissionInput', function() {
      // uncomment below and update the code to test RemovePermissionInput
      //var instance = new AmazonSimpleNotificationService.RemovePermissionInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.RemovePermissionInput);
    });
