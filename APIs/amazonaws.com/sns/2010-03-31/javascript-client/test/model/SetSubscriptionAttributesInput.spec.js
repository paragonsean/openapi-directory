...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SetSubscriptionAttributesInput();
  });
  ...
  describe('SetSubscriptionAttributesInput', function() {
    it('should create an instance of SetSubscriptionAttributesInput', function() {
      // uncomment below and update the code to test SetSubscriptionAttributesInput
      //var instance = new AmazonSimpleNotificationService.SetSubscriptionAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SetSubscriptionAttributesInput);
    });
