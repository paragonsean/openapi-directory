...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.AddPermissionInput();
  });
  ...
  describe('AddPermissionInput', function() {
    it('should create an instance of AddPermissionInput', function() {
      // uncomment below and update the code to test AddPermissionInput
      //var instance = new AmazonSimpleNotificationService.AddPermissionInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.AddPermissionInput);
    });
