...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListOriginationNumbersRequest();
  });
  ...
  describe('ListOriginationNumbersRequest', function() {
    it('should create an instance of ListOriginationNumbersRequest', function() {
      // uncomment below and update the code to test ListOriginationNumbersRequest
      //var instance = new AmazonSimpleNotificationService.ListOriginationNumbersRequest();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListOriginationNumbersRequest);
    });
