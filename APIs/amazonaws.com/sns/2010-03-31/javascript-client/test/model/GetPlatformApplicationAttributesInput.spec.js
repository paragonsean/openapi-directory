...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetPlatformApplicationAttributesInput();
  });
  ...
  describe('GetPlatformApplicationAttributesInput', function() {
    it('should create an instance of GetPlatformApplicationAttributesInput', function() {
      // uncomment below and update the code to test GetPlatformApplicationAttributesInput
      //var instance = new AmazonSimpleNotificationService.GetPlatformApplicationAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetPlatformApplicationAttributesInput);
    });

    it('should have the property platformApplicationArn (base name: "PlatformApplicationArn")', function() {
      // uncomment below and update the code to test the property platformApplicationArn
      //var instance = new AmazonSimpleNotificationService.GetPlatformApplicationAttributesInput();
