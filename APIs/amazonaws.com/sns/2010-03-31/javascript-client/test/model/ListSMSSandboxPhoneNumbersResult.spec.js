...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListSMSSandboxPhoneNumbersResult();
  });
  ...
  describe('ListSMSSandboxPhoneNumbersResult', function() {
    it('should create an instance of ListSMSSandboxPhoneNumbersResult', function() {
      // uncomment below and update the code to test ListSMSSandboxPhoneNumbersResult
      //var instance = new AmazonSimpleNotificationService.ListSMSSandboxPhoneNumbersResult();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListSMSSandboxPhoneNumbersResult);
    });
