...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SetPlatformApplicationAttributesInput();
  });
  ...
  describe('SetPlatformApplicationAttributesInput', function() {
    it('should create an instance of SetPlatformApplicationAttributesInput', function() {
      // uncomment below and update the code to test SetPlatformApplicationAttributesInput
      //var instance = new AmazonSimpleNotificationService.SetPlatformApplicationAttributesInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SetPlatformApplicationAttributesInput);
    });
