...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListTopicsInput();
  });
  ...
  describe('ListTopicsInput', function() {
    it('should create an instance of ListTopicsInput', function() {
      // uncomment below and update the code to test ListTopicsInput
      //var instance = new AmazonSimpleNotificationService.ListTopicsInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListTopicsInput);
    });
