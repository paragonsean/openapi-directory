...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.GetSubscriptionAttributesResponse();
  });
  ...
  describe('GetSubscriptionAttributesResponse', function() {
    it('should create an instance of GetSubscriptionAttributesResponse', function() {
      // uncomment below and update the code to test GetSubscriptionAttributesResponse
      //var instance = new AmazonSimpleNotificationService.GetSubscriptionAttributesResponse();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.GetSubscriptionAttributesResponse);
    });
