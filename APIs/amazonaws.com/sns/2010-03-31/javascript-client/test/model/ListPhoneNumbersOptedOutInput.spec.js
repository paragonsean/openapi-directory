...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ListPhoneNumbersOptedOutInput();
  });
  ...
  describe('ListPhoneNumbersOptedOutInput', function() {
    it('should create an instance of ListPhoneNumbersOptedOutInput', function() {
      // uncomment below and update the code to test ListPhoneNumbersOptedOutInput
      //var instance = new AmazonSimpleNotificationService.ListPhoneNumbersOptedOutInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ListPhoneNumbersOptedOutInput);
    });
