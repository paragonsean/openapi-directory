...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CreatePlatformEndpointInput();
  });
  ...
  describe('CreatePlatformEndpointInput', function() {
    it('should create an instance of CreatePlatformEndpointInput', function() {
      // uncomment below and update the code to test CreatePlatformEndpointInput
      //var instance = new AmazonSimpleNotificationService.CreatePlatformEndpointInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CreatePlatformEndpointInput);
    });
    ...
    it('should have the property customUserData (base name: "CustomUserData")', function() {
      // uncomment below and update the code to test the property customUserData
      //var instance = new AmazonSimpleNotificationService.CreatePlatformEndpointInput();
      //expect(instance).to.be();
    });
