...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.CreateTopicInput();
  });
  ...
  describe('CreateTopicInput', function() {
    it('should create an instance of CreateTopicInput', function() {
      // uncomment below and update the code to test CreateTopicInput
      //var instance = new AmazonSimpleNotificationService.CreateTopicInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.CreateTopicInput);
    });
    ...
    it('should have the property dataProtectionPolicy (base name: "DataProtectionPolicy")', function() {
      // uncomment below and update the code to test the property dataProtectionPolicy
      //var instance = new AmazonSimpleNotificationService.CreateTopicInput();
      //expect(instance).to.be();
    });
