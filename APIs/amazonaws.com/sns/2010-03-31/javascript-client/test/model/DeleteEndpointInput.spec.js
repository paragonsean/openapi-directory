...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.DeleteEndpointInput();
  });
  ...
  describe('DeleteEndpointInput', function() {
    it('should create an instance of DeleteEndpointInput', function() {
      // uncomment below and update the code to test DeleteEndpointInput
      //var instance = new AmazonSimpleNotificationService.DeleteEndpointInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.DeleteEndpointInput);
    });
