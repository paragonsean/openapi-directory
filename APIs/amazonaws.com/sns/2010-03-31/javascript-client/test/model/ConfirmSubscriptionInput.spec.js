...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.ConfirmSubscriptionInput();
  });
  ...
  describe('ConfirmSubscriptionInput', function() {
    it('should create an instance of ConfirmSubscriptionInput', function() {
      // uncomment below and update the code to test ConfirmSubscriptionInput
      //var instance = new AmazonSimpleNotificationService.ConfirmSubscriptionInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.ConfirmSubscriptionInput);
    });
    ...
    it('should have the property authenticateOnUnsubscribe (base name: "AuthenticateOnUnsubscribe")', function() {
      // uncomment below and update the code to test the property authenticateOnUnsubscribe
      //var instance = new AmazonSimpleNotificationService.ConfirmSubscriptionInput();
      //expect(instance).to.be();
    });
