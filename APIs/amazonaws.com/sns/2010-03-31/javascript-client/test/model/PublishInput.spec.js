...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.PublishInput();
  });
  ...
  describe('PublishInput', function() {
    it('should create an instance of PublishInput', function() {
      // uncomment below and update the code to test PublishInput
      //var instance = new AmazonSimpleNotificationService.PublishInput();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.PublishInput);
    });
