...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.SMSSandboxPhoneNumber();
  });
  ...
  describe('SMSSandboxPhoneNumber', function() {
    it('should create an instance of SMSSandboxPhoneNumber', function() {
      // uncomment below and update the code to test SMSSandboxPhoneNumber
      //var instance = new AmazonSimpleNotificationService.SMSSandboxPhoneNumber();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.SMSSandboxPhoneNumber);
    });
