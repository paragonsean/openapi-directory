...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleNotificationService.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonSimpleNotificationService.TagResourceRequest();
      //expect(instance).to.be.a(AmazonSimpleNotificationService.TagResourceRequest);
    });
