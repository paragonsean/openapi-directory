...
/*
 * OAIGetSMSSandboxAccountStatusResult.h
 *
 * 
 */

#ifndef OAIGetSMSSandboxAccountStatusResult_H
#define OAIGetSMSSandboxAccountStatusResult_H
...
class OAIGetSMSSandboxAccountStatusResult : public OAIObject {
public:
    OAIGetSMSSandboxAccountStatusResult();
    OAIGetSMSSandboxAccountStatusResult(QString json);
    ~OAIGetSMSSandboxAccountStatusResult() override;
    ...
    bool getIsInSandbox() const;
    void setIsInSandbox(const bool &is_in_sandbox);
    bool is_is_in_sandbox_Set() const;
    bool is_is_in_sandbox_Valid() const;
...
private:
    ...
    bool m_is_in_sandbox;
    bool m_is_in_sandbox_isSet;
    bool m_is_in_sandbox_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetSMSSandboxAccountStatusResult)

#endif // OAIGetSMSSandboxAccountStatusResult_H
