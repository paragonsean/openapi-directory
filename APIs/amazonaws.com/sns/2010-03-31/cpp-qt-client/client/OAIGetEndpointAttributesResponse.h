...
/*
 * OAIGetEndpointAttributesResponse.h
 *
 * Response from GetEndpointAttributes of the EndpointArn.
 */

#ifndef OAIGetEndpointAttributesResponse_H
#define OAIGetEndpointAttributesResponse_H
...
class OAIGetEndpointAttributesResponse : public OAIObject {
public:
    OAIGetEndpointAttributesResponse();
    OAIGetEndpointAttributesResponse(QString json);
    ~OAIGetEndpointAttributesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEndpointAttributesResponse)

#endif // OAIGetEndpointAttributesResponse_H
