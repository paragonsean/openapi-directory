...
OAIListSMSSandboxPhoneNumbersResult::OAIListSMSSandboxPhoneNumbersResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSMSSandboxPhoneNumbersResult::OAIListSMSSandboxPhoneNumbersResult() {
    this->initializeModel();
}

OAIListSMSSandboxPhoneNumbersResult::~OAIListSMSSandboxPhoneNumbersResult() {}

void OAIListSMSSandboxPhoneNumbersResult::initializeModel() {
...
void OAIListSMSSandboxPhoneNumbersResult::fromJson(QString jsonString) {
...
void OAIListSMSSandboxPhoneNumbersResult::fromJsonObject(QJsonObject json) {
...
QString OAIListSMSSandboxPhoneNumbersResult::asJson() const {
...
QJsonObject OAIListSMSSandboxPhoneNumbersResult::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListSMSSandboxPhoneNumbersResult::getPhoneNumbers() const {
    return m_phone_numbers;
}
void OAIListSMSSandboxPhoneNumbersResult::setPhoneNumbers(const QList &phone_numbers) {
    m_phone_numbers = phone_numbers;
    m_phone_numbers_isSet = true;
}

bool OAIListSMSSandboxPhoneNumbersResult::is_phone_numbers_Set() const{
    return m_phone_numbers_isSet;
}

bool OAIListSMSSandboxPhoneNumbersResult::is_phone_numbers_Valid() const{
    return m_phone_numbers_isValid;
}

QString OAIListSMSSandboxPhoneNumbersResult::getNextToken() const {
    return m_next_token;
}
void OAIListSMSSandboxPhoneNumbersResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSMSSandboxPhoneNumbersResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSMSSandboxPhoneNumbersResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSMSSandboxPhoneNumbersResult::isSet() const {
...
bool OAIListSMSSandboxPhoneNumbersResult::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_phone_numbers_isValid && true;
}
