...
/*
 * OAISMSSandboxPhoneNumberVerificationStatus.h
 *
...
#ifndef OAISMSSandboxPhoneNumberVerificationStatus_H
#define OAISMSSandboxPhoneNumberVerificationStatus_H
...
class OAISMSSandboxPhoneNumberVerificationStatus : public OAIEnum {
public:
    OAISMSSandboxPhoneNumberVerificationStatus();
    OAISMSSandboxPhoneNumberVerificationStatus(QString json);
    ~OAISMSSandboxPhoneNumberVerificationStatus() override;
    ...
    enum class eOAISMSSandboxPhoneNumberVerificationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PENDING, 
        VERIFIED
    };
    OAISMSSandboxPhoneNumberVerificationStatus::eOAISMSSandboxPhoneNumberVerificationStatus getValue() const;
    void setValue(const OAISMSSandboxPhoneNumberVerificationStatus::eOAISMSSandboxPhoneNumberVerificationStatus& value);
...
private:
    ...
    eOAISMSSandboxPhoneNumberVerificationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMSSandboxPhoneNumberVerificationStatus)

#endif // OAISMSSandboxPhoneNumberVerificationStatus_H
