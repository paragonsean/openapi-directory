...
QString OAICreateTopicResponse::getTopicArn() const {
    return m_topic_arn;
}
void OAICreateTopicResponse::setTopicArn(const QString &topic_arn) {
    m_topic_arn = topic_arn;
    m_topic_arn_isSet = true;
}

bool OAICreateTopicResponse::is_topic_arn_Set() const{
    return m_topic_arn_isSet;
}

bool OAICreateTopicResponse::is_topic_arn_Valid() const{
