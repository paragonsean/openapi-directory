...
OAIListSubscriptionsByTopicResponse::OAIListSubscriptionsByTopicResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSubscriptionsByTopicResponse::OAIListSubscriptionsByTopicResponse() {
    this->initializeModel();
}

OAIListSubscriptionsByTopicResponse::~OAIListSubscriptionsByTopicResponse() {}

void OAIListSubscriptionsByTopicResponse::initializeModel() {
...
void OAIListSubscriptionsByTopicResponse::fromJson(QString jsonString) {
...
void OAIListSubscriptionsByTopicResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListSubscriptionsByTopicResponse::asJson() const {
...
QJsonObject OAIListSubscriptionsByTopicResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListSubscriptionsByTopicResponse::getSubscriptions() const {
    return m_subscriptions;
}
void OAIListSubscriptionsByTopicResponse::setSubscriptions(const QList &subscriptions) {
    m_subscriptions = subscriptions;
    m_subscriptions_isSet = true;
}

bool OAIListSubscriptionsByTopicResponse::is_subscriptions_Set() const{
    return m_subscriptions_isSet;
}

bool OAIListSubscriptionsByTopicResponse::is_subscriptions_Valid() const{
    return m_subscriptions_isValid;
}

QString OAIListSubscriptionsByTopicResponse::getNextToken() const {
    return m_next_token;
}
void OAIListSubscriptionsByTopicResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSubscriptionsByTopicResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSubscriptionsByTopicResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSubscriptionsByTopicResponse::isSet() const {
...
bool OAIListSubscriptionsByTopicResponse::isValid() const {
