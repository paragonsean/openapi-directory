...
/*
 * OAIGetSubscriptionAttributesInput.h
 *
 * Input for GetSubscriptionAttributes.
 */

#ifndef OAIGetSubscriptionAttributesInput_H
#define OAIGetSubscriptionAttributesInput_H
...
class OAIGetSubscriptionAttributesInput : public OAIObject {
public:
    OAIGetSubscriptionAttributesInput();
    OAIGetSubscriptionAttributesInput(QString json);
    ~OAIGetSubscriptionAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSubscriptionAttributesInput)

#endif // OAIGetSubscriptionAttributesInput_H
