...
OAIListTopicsInput::OAIListTopicsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTopicsInput::OAIListTopicsInput() {
    this->initializeModel();
}

OAIListTopicsInput::~OAIListTopicsInput() {}

void OAIListTopicsInput::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListTopicsInput::fromJson(QString jsonString) {
...
void OAIListTopicsInput::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListTopicsInput::asJson() const {
...
QJsonObject OAIListTopicsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListTopicsInput::getNextToken() const {
    return m_next_token;
}
void OAIListTopicsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTopicsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTopicsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListTopicsInput::isSet() const {
...
bool OAIListTopicsInput::isValid() const {
