...
/*
 * OAIListSubscriptionsInput.h
 *
 * Input for ListSubscriptions action.
 */

#ifndef OAIListSubscriptionsInput_H
#define OAIListSubscriptionsInput_H
...
class OAIListSubscriptionsInput : public OAIObject {
public:
    OAIListSubscriptionsInput();
    OAIListSubscriptionsInput(QString json);
    ~OAIListSubscriptionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSubscriptionsInput)

#endif // OAIListSubscriptionsInput_H
