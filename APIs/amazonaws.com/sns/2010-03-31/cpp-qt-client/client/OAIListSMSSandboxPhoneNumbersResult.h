...
/*
 * OAIListSMSSandboxPhoneNumbersResult.h
 *
 * 
 */

#ifndef OAIListSMSSandboxPhoneNumbersResult_H
#define OAIListSMSSandboxPhoneNumbersResult_H
...
class OAIListSMSSandboxPhoneNumbersResult : public OAIObject {
public:
    OAIListSMSSandboxPhoneNumbersResult();
    OAIListSMSSandboxPhoneNumbersResult(QString json);
    ~OAIListSMSSandboxPhoneNumbersResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSMSSandboxPhoneNumbersResult)

#endif // OAIListSMSSandboxPhoneNumbersResult_H
