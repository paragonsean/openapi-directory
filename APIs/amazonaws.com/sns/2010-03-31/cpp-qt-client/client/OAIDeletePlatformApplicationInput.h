...
/*
 * OAIDeletePlatformApplicationInput.h
 *
 * Input for DeletePlatformApplication action.
 */

#ifndef OAIDeletePlatformApplicationInput_H
#define OAIDeletePlatformApplicationInput_H
...
class OAIDeletePlatformApplicationInput : public OAIObject {
public:
    OAIDeletePlatformApplicationInput();
    OAIDeletePlatformApplicationInput(QString json);
    ~OAIDeletePlatformApplicationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePlatformApplicationInput)

#endif // OAIDeletePlatformApplicationInput_H
