...
OAIListSubscriptionsInput::OAIListSubscriptionsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSubscriptionsInput::OAIListSubscriptionsInput() {
    this->initializeModel();
}

OAIListSubscriptionsInput::~OAIListSubscriptionsInput() {}

void OAIListSubscriptionsInput::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListSubscriptionsInput::fromJson(QString jsonString) {
...
void OAIListSubscriptionsInput::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListSubscriptionsInput::asJson() const {
...
QJsonObject OAIListSubscriptionsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListSubscriptionsInput::getNextToken() const {
    return m_next_token;
}
void OAIListSubscriptionsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSubscriptionsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSubscriptionsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSubscriptionsInput::isSet() const {
...
bool OAIListSubscriptionsInput::isValid() const {
