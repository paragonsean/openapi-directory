...
/*
 * OAIGetEndpointAttributesInput.h
 *
 * Input for GetEndpointAttributes action.
 */

#ifndef OAIGetEndpointAttributesInput_H
#define OAIGetEndpointAttributesInput_H
...
class OAIGetEndpointAttributesInput : public OAIObject {
public:
    OAIGetEndpointAttributesInput();
    OAIGetEndpointAttributesInput(QString json);
    ~OAIGetEndpointAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEndpointAttributesInput)

#endif // OAIGetEndpointAttributesInput_H
