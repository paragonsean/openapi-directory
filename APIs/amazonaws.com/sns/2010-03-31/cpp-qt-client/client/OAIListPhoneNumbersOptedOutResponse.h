...
/*
 * OAIListPhoneNumbersOptedOutResponse.h
 *
 * The response from the &lt;code&gt;ListPhoneNumbersOptedOut&lt;/code&gt; action.
 */

#ifndef OAIListPhoneNumbersOptedOutResponse_H
#define OAIListPhoneNumbersOptedOutResponse_H
...
class OAIListPhoneNumbersOptedOutResponse : public OAIObject {
public:
    OAIListPhoneNumbersOptedOutResponse();
    OAIListPhoneNumbersOptedOutResponse(QString json);
    ~OAIListPhoneNumbersOptedOutResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPhoneNumbersOptedOutResponse)

#endif // OAIListPhoneNumbersOptedOutResponse_H
