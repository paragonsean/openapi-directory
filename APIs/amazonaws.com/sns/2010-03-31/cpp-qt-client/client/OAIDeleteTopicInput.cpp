...
OAIDeleteTopicInput::OAIDeleteTopicInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTopicInput::OAIDeleteTopicInput() {
    this->initializeModel();
}

OAIDeleteTopicInput::~OAIDeleteTopicInput() {}

void OAIDeleteTopicInput::initializeModel() {

    m_topic_arn_isSet = false;
    m_topic_arn_isValid = false;
}

void OAIDeleteTopicInput::fromJson(QString jsonString) {
...
void OAIDeleteTopicInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTopicInput::asJson() const {
...
QJsonObject OAIDeleteTopicInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteTopicInput::getTopicArn() const {
    return m_topic_arn;
}
void OAIDeleteTopicInput::setTopicArn(const QString &topic_arn) {
    m_topic_arn = topic_arn;
    m_topic_arn_isSet = true;
}

bool OAIDeleteTopicInput::is_topic_arn_Set() const{
    return m_topic_arn_isSet;
}

bool OAIDeleteTopicInput::is_topic_arn_Valid() const{
    return m_topic_arn_isValid;
}

bool OAIDeleteTopicInput::isSet() const {
...
bool OAIDeleteTopicInput::isValid() const {
