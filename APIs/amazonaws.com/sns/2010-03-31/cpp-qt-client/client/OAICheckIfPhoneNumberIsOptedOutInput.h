...
/*
 * OAICheckIfPhoneNumberIsOptedOutInput.h
 *
 * The input for the &lt;code&gt;CheckIfPhoneNumberIsOptedOut&lt;/code&gt; action.
 */

#ifndef OAICheckIfPhoneNumberIsOptedOutInput_H
#define OAICheckIfPhoneNumberIsOptedOutInput_H
...
class OAICheckIfPhoneNumberIsOptedOutInput : public OAIObject {
public:
    OAICheckIfPhoneNumberIsOptedOutInput();
    OAICheckIfPhoneNumberIsOptedOutInput(QString json);
    ~OAICheckIfPhoneNumberIsOptedOutInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckIfPhoneNumberIsOptedOutInput)

#endif // OAICheckIfPhoneNumberIsOptedOutInput_H
