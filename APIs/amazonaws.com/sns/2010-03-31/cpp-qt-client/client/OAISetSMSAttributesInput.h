...
/*
 * OAISetSMSAttributesInput.h
 *
 * The input for the SetSMSAttributes action.
 */

#ifndef OAISetSMSAttributesInput_H
#define OAISetSMSAttributesInput_H
...
class OAISetSMSAttributesInput : public OAIObject {
public:
    OAISetSMSAttributesInput();
    OAISetSMSAttributesInput(QString json);
    ~OAISetSMSAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetSMSAttributesInput)

#endif // OAISetSMSAttributesInput_H
