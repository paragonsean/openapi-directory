...
/*
 * OAISubscribeResponse.h
 *
 * Response for Subscribe action.
 */

#ifndef OAISubscribeResponse_H
#define OAISubscribeResponse_H
...
class OAISubscribeResponse : public OAIObject {
public:
    OAISubscribeResponse();
    OAISubscribeResponse(QString json);
    ~OAISubscribeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscribeResponse)

#endif // OAISubscribeResponse_H
