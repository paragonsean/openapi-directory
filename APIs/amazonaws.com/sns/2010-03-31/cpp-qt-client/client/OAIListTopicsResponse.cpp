...
QList OAIListTopicsResponse::getTopics() const {
    return m_topics;
}
void OAIListTopicsResponse::setTopics(const QList &topics) {
    m_topics = topics;
    m_topics_isSet = true;
}
...
QString OAIListTopicsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListTopicsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTopicsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTopicsResponse::is_next_token_Valid() const{
