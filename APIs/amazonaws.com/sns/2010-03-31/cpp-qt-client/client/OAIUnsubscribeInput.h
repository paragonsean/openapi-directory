...
/*
 * OAIUnsubscribeInput.h
 *
 * Input for Unsubscribe action.
 */

#ifndef OAIUnsubscribeInput_H
#define OAIUnsubscribeInput_H
...
class OAIUnsubscribeInput : public OAIObject {
public:
    OAIUnsubscribeInput();
    OAIUnsubscribeInput(QString json);
    ~OAIUnsubscribeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsubscribeInput)

#endif // OAIUnsubscribeInput_H
