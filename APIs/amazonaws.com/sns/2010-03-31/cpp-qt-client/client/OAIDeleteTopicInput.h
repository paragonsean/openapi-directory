...
/*
 * OAIDeleteTopicInput.h
 *
 * 
 */

#ifndef OAIDeleteTopicInput_H
#define OAIDeleteTopicInput_H
...
class OAIDeleteTopicInput : public OAIObject {
public:
    OAIDeleteTopicInput();
    OAIDeleteTopicInput(QString json);
    ~OAIDeleteTopicInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTopicInput)

#endif // OAIDeleteTopicInput_H
