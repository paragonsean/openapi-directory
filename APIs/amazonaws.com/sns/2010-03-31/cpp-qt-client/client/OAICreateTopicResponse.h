...
/*
 * OAICreateTopicResponse.h
 *
 * Response from CreateTopic action.
 */

#ifndef OAICreateTopicResponse_H
#define OAICreateTopicResponse_H
...
class OAICreateTopicResponse : public OAIObject {
public:
    OAICreateTopicResponse();
    OAICreateTopicResponse(QString json);
    ~OAICreateTopicResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTopicResponse)

#endif // OAICreateTopicResponse_H
