...
/*
 * OAIAddPermissionInput.h
 *
 * 
 */

#ifndef OAIAddPermissionInput_H
#define OAIAddPermissionInput_H
...
class OAIAddPermissionInput : public OAIObject {
public:
    OAIAddPermissionInput();
    OAIAddPermissionInput(QString json);
    ~OAIAddPermissionInput() override;
    ...
    QList getActionName() const;
    void setActionName(const QList &action_name);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddPermissionInput)

#endif // OAIAddPermissionInput_H
