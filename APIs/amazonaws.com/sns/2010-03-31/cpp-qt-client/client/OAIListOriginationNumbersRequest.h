...
/*
 * OAIListOriginationNumbersRequest.h
 *
 * 
 */

#ifndef OAIListOriginationNumbersRequest_H
#define OAIListOriginationNumbersRequest_H
...
class OAIListOriginationNumbersRequest : public OAIObject {
public:
    OAIListOriginationNumbersRequest();
    OAIListOriginationNumbersRequest(QString json);
    ~OAIListOriginationNumbersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOriginationNumbersRequest)

#endif // OAIListOriginationNumbersRequest_H
