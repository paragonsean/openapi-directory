...
/*
 * OAISetSubscriptionAttributesInput.h
 *
 * Input for SetSubscriptionAttributes action.
 */

#ifndef OAISetSubscriptionAttributesInput_H
#define OAISetSubscriptionAttributesInput_H
...
class OAISetSubscriptionAttributesInput : public OAIObject {
public:
    OAISetSubscriptionAttributesInput();
    OAISetSubscriptionAttributesInput(QString json);
    ~OAISetSubscriptionAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetSubscriptionAttributesInput)

#endif // OAISetSubscriptionAttributesInput_H
