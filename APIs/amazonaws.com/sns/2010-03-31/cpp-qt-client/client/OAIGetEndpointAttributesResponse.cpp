...
OAIGetEndpointAttributesResponse::OAIGetEndpointAttributesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEndpointAttributesResponse::OAIGetEndpointAttributesResponse() {
    this->initializeModel();
}

OAIGetEndpointAttributesResponse::~OAIGetEndpointAttributesResponse() {}

void OAIGetEndpointAttributesResponse::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAIGetEndpointAttributesResponse::fromJson(QString jsonString) {
...
void OAIGetEndpointAttributesResponse::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("Attributes")]);
    m_attributes_isSet = !json[QString("Attributes")].isNull() && m_attributes_isValid;
}

QString OAIGetEndpointAttributesResponse::asJson() const {
...
QJsonObject OAIGetEndpointAttributesResponse::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIGetEndpointAttributesResponse::getAttributes() const {
    return m_attributes;
}
void OAIGetEndpointAttributesResponse::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIGetEndpointAttributesResponse::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIGetEndpointAttributesResponse::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIGetEndpointAttributesResponse::isSet() const {
...
bool OAIGetEndpointAttributesResponse::isValid() const {
