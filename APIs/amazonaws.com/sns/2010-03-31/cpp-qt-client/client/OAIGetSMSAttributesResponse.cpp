...
OAIGetSMSAttributesResponse::OAIGetSMSAttributesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSMSAttributesResponse::OAIGetSMSAttributesResponse() {
    this->initializeModel();
}

OAIGetSMSAttributesResponse::~OAIGetSMSAttributesResponse() {}

void OAIGetSMSAttributesResponse::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAIGetSMSAttributesResponse::fromJson(QString jsonString) {
...
void OAIGetSMSAttributesResponse::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("attributes")]);
    m_attributes_isSet = !json[QString("attributes")].isNull() && m_attributes_isValid;
}

QString OAIGetSMSAttributesResponse::asJson() const {
...
QJsonObject OAIGetSMSAttributesResponse::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIGetSMSAttributesResponse::getAttributes() const {
    return m_attributes;
}
void OAIGetSMSAttributesResponse::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIGetSMSAttributesResponse::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIGetSMSAttributesResponse::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIGetSMSAttributesResponse::isSet() const {
...
bool OAIGetSMSAttributesResponse::isValid() const {
