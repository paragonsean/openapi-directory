...
/*
 * OAIGetSMSAttributesInput.h
 *
 * The input for the &lt;code&gt;GetSMSAttributes&lt;/code&gt; request.
 */

#ifndef OAIGetSMSAttributesInput_H
#define OAIGetSMSAttributesInput_H
...
class OAIGetSMSAttributesInput : public OAIObject {
public:
    OAIGetSMSAttributesInput();
    OAIGetSMSAttributesInput(QString json);
    ~OAIGetSMSAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSMSAttributesInput)

#endif // OAIGetSMSAttributesInput_H
