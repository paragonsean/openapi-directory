...
/*
 * OAIVerifySMSSandboxPhoneNumberInput.h
 *
 * 
 */

#ifndef OAIVerifySMSSandboxPhoneNumberInput_H
#define OAIVerifySMSSandboxPhoneNumberInput_H
...
class OAIVerifySMSSandboxPhoneNumberInput : public OAIObject {
public:
    OAIVerifySMSSandboxPhoneNumberInput();
    OAIVerifySMSSandboxPhoneNumberInput(QString json);
    ~OAIVerifySMSSandboxPhoneNumberInput() override;
    ...
    QString getOneTimePassword() const;
    void setOneTimePassword(const QString &one_time_password);
    bool is_one_time_password_Set() const;
    bool is_one_time_password_Valid() const;
...
private:
    ...
    QString m_one_time_password;
    bool m_one_time_password_isSet;
    bool m_one_time_password_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVerifySMSSandboxPhoneNumberInput)

#endif // OAIVerifySMSSandboxPhoneNumberInput_H
