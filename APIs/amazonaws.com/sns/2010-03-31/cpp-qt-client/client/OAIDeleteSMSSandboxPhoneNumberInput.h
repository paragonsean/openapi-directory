...
/*
 * OAIDeleteSMSSandboxPhoneNumberInput.h
 *
 * 
 */

#ifndef OAIDeleteSMSSandboxPhoneNumberInput_H
#define OAIDeleteSMSSandboxPhoneNumberInput_H
...
class OAIDeleteSMSSandboxPhoneNumberInput : public OAIObject {
public:
    OAIDeleteSMSSandboxPhoneNumberInput();
    OAIDeleteSMSSandboxPhoneNumberInput(QString json);
    ~OAIDeleteSMSSandboxPhoneNumberInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSMSSandboxPhoneNumberInput)

#endif // OAIDeleteSMSSandboxPhoneNumberInput_H
