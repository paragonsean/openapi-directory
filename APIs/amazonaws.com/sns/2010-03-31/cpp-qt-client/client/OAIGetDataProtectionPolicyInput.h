...
/*
 * OAIGetDataProtectionPolicyInput.h
 *
 * 
 */

#ifndef OAIGetDataProtectionPolicyInput_H
#define OAIGetDataProtectionPolicyInput_H
...
class OAIGetDataProtectionPolicyInput : public OAIObject {
public:
    OAIGetDataProtectionPolicyInput();
    OAIGetDataProtectionPolicyInput(QString json);
    ~OAIGetDataProtectionPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataProtectionPolicyInput)

#endif // OAIGetDataProtectionPolicyInput_H
