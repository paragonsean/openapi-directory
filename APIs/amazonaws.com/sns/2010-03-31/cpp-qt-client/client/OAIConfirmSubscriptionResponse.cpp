...
OAIConfirmSubscriptionResponse::OAIConfirmSubscriptionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfirmSubscriptionResponse::OAIConfirmSubscriptionResponse() {
    this->initializeModel();
}

OAIConfirmSubscriptionResponse::~OAIConfirmSubscriptionResponse() {}

void OAIConfirmSubscriptionResponse::initializeModel() {

    m_subscription_arn_isSet = false;
    m_subscription_arn_isValid = false;
}

void OAIConfirmSubscriptionResponse::fromJson(QString jsonString) {
...
void OAIConfirmSubscriptionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIConfirmSubscriptionResponse::asJson() const {
...
QJsonObject OAIConfirmSubscriptionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConfirmSubscriptionResponse::getSubscriptionArn() const {
    return m_subscription_arn;
}
void OAIConfirmSubscriptionResponse::setSubscriptionArn(const QString &subscription_arn) {
    m_subscription_arn = subscription_arn;
    m_subscription_arn_isSet = true;
}

bool OAIConfirmSubscriptionResponse::is_subscription_arn_Set() const{
    return m_subscription_arn_isSet;
}

bool OAIConfirmSubscriptionResponse::is_subscription_arn_Valid() const{
    return m_subscription_arn_isValid;
}

bool OAIConfirmSubscriptionResponse::isSet() const {
...
bool OAIConfirmSubscriptionResponse::isValid() const {
