...
/*
 * OAIListTopicsInput.h
 *
 * 
 */

#ifndef OAIListTopicsInput_H
#define OAIListTopicsInput_H
...
class OAIListTopicsInput : public OAIObject {
public:
    OAIListTopicsInput();
    OAIListTopicsInput(QString json);
    ~OAIListTopicsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTopicsInput)

#endif // OAIListTopicsInput_H
