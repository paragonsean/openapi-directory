...
/*
 * OAIRemovePermissionInput.h
 *
 * Input for RemovePermission action.
 */

#ifndef OAIRemovePermissionInput_H
#define OAIRemovePermissionInput_H
...
class OAIRemovePermissionInput : public OAIObject {
public:
    OAIRemovePermissionInput();
    OAIRemovePermissionInput(QString json);
    ~OAIRemovePermissionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemovePermissionInput)

#endif // OAIRemovePermissionInput_H
