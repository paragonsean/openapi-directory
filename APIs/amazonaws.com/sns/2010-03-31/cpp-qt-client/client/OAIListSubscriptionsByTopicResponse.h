...
/*
 * OAIListSubscriptionsByTopicResponse.h
 *
 * Response for ListSubscriptionsByTopic action.
 */

#ifndef OAIListSubscriptionsByTopicResponse_H
#define OAIListSubscriptionsByTopicResponse_H
...
class OAIListSubscriptionsByTopicResponse : public OAIObject {
public:
    OAIListSubscriptionsByTopicResponse();
    OAIListSubscriptionsByTopicResponse(QString json);
    ~OAIListSubscriptionsByTopicResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSubscriptionsByTopicResponse)

#endif // OAIListSubscriptionsByTopicResponse_H
