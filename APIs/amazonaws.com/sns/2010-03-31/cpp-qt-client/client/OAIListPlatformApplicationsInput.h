...
/*
 * OAIListPlatformApplicationsInput.h
 *
 * Input for ListPlatformApplications action.
 */

#ifndef OAIListPlatformApplicationsInput_H
#define OAIListPlatformApplicationsInput_H
...
class OAIListPlatformApplicationsInput : public OAIObject {
public:
    OAIListPlatformApplicationsInput();
    OAIListPlatformApplicationsInput(QString json);
    ~OAIListPlatformApplicationsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPlatformApplicationsInput)

#endif // OAIListPlatformApplicationsInput_H
