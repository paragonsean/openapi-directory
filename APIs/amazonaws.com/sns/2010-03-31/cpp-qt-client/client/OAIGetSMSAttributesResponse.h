...
/*
 * OAIGetSMSAttributesResponse.h
 *
 * The response from the &lt;code&gt;GetSMSAttributes&lt;/code&gt; request.
 */

#ifndef OAIGetSMSAttributesResponse_H
#define OAIGetSMSAttributesResponse_H
...
class OAIGetSMSAttributesResponse : public OAIObject {
public:
    OAIGetSMSAttributesResponse();
    OAIGetSMSAttributesResponse(QString json);
    ~OAIGetSMSAttributesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSMSAttributesResponse)

#endif // OAIGetSMSAttributesResponse_H
