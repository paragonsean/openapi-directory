...
/*
 * OAIPutDataProtectionPolicyInput.h
 *
 * 
 */

#ifndef OAIPutDataProtectionPolicyInput_H
#define OAIPutDataProtectionPolicyInput_H
...
class OAIPutDataProtectionPolicyInput : public OAIObject {
public:
    OAIPutDataProtectionPolicyInput();
    OAIPutDataProtectionPolicyInput(QString json);
    ~OAIPutDataProtectionPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDataProtectionPolicyInput)

#endif // OAIPutDataProtectionPolicyInput_H
