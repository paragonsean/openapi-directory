...
/*
 * OAIPlatformApplication.h
 *
 * Platform application object.
 */

#ifndef OAIPlatformApplication_H
#define OAIPlatformApplication_H
...
class OAIPlatformApplication : public OAIObject {
public:
    OAIPlatformApplication();
    OAIPlatformApplication(QString json);
    ~OAIPlatformApplication() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlatformApplication)

#endif // OAIPlatformApplication_H
