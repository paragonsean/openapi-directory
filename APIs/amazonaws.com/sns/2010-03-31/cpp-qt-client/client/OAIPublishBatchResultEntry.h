...
/*
 * OAIPublishBatchResultEntry.h
 *
 * Encloses data related to a successful message in a batch request for topic.
 */

#ifndef OAIPublishBatchResultEntry_H
#define OAIPublishBatchResultEntry_H
...
class OAIPublishBatchResultEntry : public OAIObject {
public:
    OAIPublishBatchResultEntry();
    OAIPublishBatchResultEntry(QString json);
    ~OAIPublishBatchResultEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishBatchResultEntry)

#endif // OAIPublishBatchResultEntry_H
