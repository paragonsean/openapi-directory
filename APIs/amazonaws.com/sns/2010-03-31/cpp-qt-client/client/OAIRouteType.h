...
#ifndef OAIRouteType_H
#define OAIRouteType_H
...
class OAIRouteType : public OAIEnum {
public:
    OAIRouteType();
    OAIRouteType(QString json);
    ~OAIRouteType() override;
    ...
    enum class eOAIRouteType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TRANSACTIONAL, 
        PROMOTIONAL, 
        PREMIUM
    };
    OAIRouteType::eOAIRouteType getValue() const;
    void setValue(const OAIRouteType::eOAIRouteType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteType)

#endif // OAIRouteType_H
