...
/*
 * OAICheckIfPhoneNumberIsOptedOutResponse.h
 *
 * The response from the &lt;code&gt;CheckIfPhoneNumberIsOptedOut&lt;/code&gt; action.
 */

#ifndef OAICheckIfPhoneNumberIsOptedOutResponse_H
#define OAICheckIfPhoneNumberIsOptedOutResponse_H
...
class OAICheckIfPhoneNumberIsOptedOutResponse : public OAIObject {
public:
    OAICheckIfPhoneNumberIsOptedOutResponse();
    OAICheckIfPhoneNumberIsOptedOutResponse(QString json);
    ~OAICheckIfPhoneNumberIsOptedOutResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckIfPhoneNumberIsOptedOutResponse)

#endif // OAICheckIfPhoneNumberIsOptedOutResponse_H
