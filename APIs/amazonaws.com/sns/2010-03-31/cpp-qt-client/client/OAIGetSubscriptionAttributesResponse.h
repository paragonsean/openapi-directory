...
/*
 * OAIGetSubscriptionAttributesResponse.h
 *
 * Response for GetSubscriptionAttributes action.
 */

#ifndef OAIGetSubscriptionAttributesResponse_H
#define OAIGetSubscriptionAttributesResponse_H
...
class OAIGetSubscriptionAttributesResponse : public OAIObject {
public:
    OAIGetSubscriptionAttributesResponse();
    OAIGetSubscriptionAttributesResponse(QString json);
    ~OAIGetSubscriptionAttributesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSubscriptionAttributesResponse)

#endif // OAIGetSubscriptionAttributesResponse_H
