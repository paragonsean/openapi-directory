...
/*
 * OAIListSubscriptionsByTopicInput.h
 *
 * Input for ListSubscriptionsByTopic action.
 */

#ifndef OAIListSubscriptionsByTopicInput_H
#define OAIListSubscriptionsByTopicInput_H
...
class OAIListSubscriptionsByTopicInput : public OAIObject {
public:
    OAIListSubscriptionsByTopicInput();
    OAIListSubscriptionsByTopicInput(QString json);
    ~OAIListSubscriptionsByTopicInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSubscriptionsByTopicInput)

#endif // OAIListSubscriptionsByTopicInput_H
