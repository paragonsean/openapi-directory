...
/*
 * OAIPublishBatchInput.h
 *
 * 
 */

#ifndef OAIPublishBatchInput_H
#define OAIPublishBatchInput_H
...
class OAIPublishBatchInput : public OAIObject {
public:
    OAIPublishBatchInput();
    OAIPublishBatchInput(QString json);
    ~OAIPublishBatchInput() override;
    ...
    QList getPublishBatchRequestEntries() const;
    void setPublishBatchRequestEntries(const QList &publish_batch_request_entries);
    bool is_publish_batch_request_entries_Set() const;
    bool is_publish_batch_request_entries_Valid() const;
...
private:
    ...
    QList m_publish_batch_request_entries;
    bool m_publish_batch_request_entries_isSet;
    bool m_publish_batch_request_entries_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPublishBatchInput)

#endif // OAIPublishBatchInput_H
