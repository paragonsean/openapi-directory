...
/*
 * OAICreatePlatformApplicationInput.h
 *
 * Input for CreatePlatformApplication action.
 */

#ifndef OAICreatePlatformApplicationInput_H
#define OAICreatePlatformApplicationInput_H
...
class OAICreatePlatformApplicationInput : public OAIObject {
public:
    OAICreatePlatformApplicationInput();
    OAICreatePlatformApplicationInput(QString json);
    ~OAICreatePlatformApplicationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePlatformApplicationInput)

#endif // OAICreatePlatformApplicationInput_H
