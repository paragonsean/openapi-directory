...
OAIGetTopicAttributesInput::OAIGetTopicAttributesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTopicAttributesInput::OAIGetTopicAttributesInput() {
    this->initializeModel();
}

OAIGetTopicAttributesInput::~OAIGetTopicAttributesInput() {}

void OAIGetTopicAttributesInput::initializeModel() {

    m_topic_arn_isSet = false;
    m_topic_arn_isValid = false;
}

void OAIGetTopicAttributesInput::fromJson(QString jsonString) {
...
void OAIGetTopicAttributesInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetTopicAttributesInput::asJson() const {
...
QJsonObject OAIGetTopicAttributesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetTopicAttributesInput::getTopicArn() const {
    return m_topic_arn;
}
void OAIGetTopicAttributesInput::setTopicArn(const QString &topic_arn) {
    m_topic_arn = topic_arn;
    m_topic_arn_isSet = true;
}

bool OAIGetTopicAttributesInput::is_topic_arn_Set() const{
    return m_topic_arn_isSet;
}

bool OAIGetTopicAttributesInput::is_topic_arn_Valid() const{
    return m_topic_arn_isValid;
}

bool OAIGetTopicAttributesInput::isSet() const {
...
bool OAIGetTopicAttributesInput::isValid() const {
