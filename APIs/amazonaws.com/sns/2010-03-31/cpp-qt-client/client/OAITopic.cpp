...
QString OAITopic::getTopicArn() const {
    return m_topic_arn;
}
void OAITopic::setTopicArn(const QString &topic_arn) {
    m_topic_arn = topic_arn;
    m_topic_arn_isSet = true;
}

bool OAITopic::is_topic_arn_Set() const{
    return m_topic_arn_isSet;
}

bool OAITopic::is_topic_arn_Valid() const{
