...
/*
 * OAIListPhoneNumbersOptedOutInput.h
 *
 * The input for the &lt;code&gt;ListPhoneNumbersOptedOut&lt;/code&gt; action.
 */

#ifndef OAIListPhoneNumbersOptedOutInput_H
#define OAIListPhoneNumbersOptedOutInput_H
...
class OAIListPhoneNumbersOptedOutInput : public OAIObject {
public:
    OAIListPhoneNumbersOptedOutInput();
    OAIListPhoneNumbersOptedOutInput(QString json);
    ~OAIListPhoneNumbersOptedOutInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPhoneNumbersOptedOutInput)

#endif // OAIListPhoneNumbersOptedOutInput_H
