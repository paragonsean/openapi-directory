...
/*
 * OAIOptInPhoneNumberInput.h
 *
 * Input for the OptInPhoneNumber action.
 */

#ifndef OAIOptInPhoneNumberInput_H
#define OAIOptInPhoneNumberInput_H
...
class OAIOptInPhoneNumberInput : public OAIObject {
public:
    OAIOptInPhoneNumberInput();
    OAIOptInPhoneNumberInput(QString json);
    ~OAIOptInPhoneNumberInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOptInPhoneNumberInput)

#endif // OAIOptInPhoneNumberInput_H
