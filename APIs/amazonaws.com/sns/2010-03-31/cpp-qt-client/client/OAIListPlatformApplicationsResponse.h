...
/*
 * OAIListPlatformApplicationsResponse.h
 *
 * Response for ListPlatformApplications action.
 */

#ifndef OAIListPlatformApplicationsResponse_H
#define OAIListPlatformApplicationsResponse_H
...
class OAIListPlatformApplicationsResponse : public OAIObject {
public:
    OAIListPlatformApplicationsResponse();
    OAIListPlatformApplicationsResponse(QString json);
    ~OAIListPlatformApplicationsResponse() override;
    ...
    QList getPlatformApplications() const;
    void setPlatformApplications(const QList &platform_applications);
    bool is_platform_applications_Set() const;
    bool is_platform_applications_Valid() const;
...
private:
    ...
    QList m_platform_applications;
    bool m_platform_applications_isSet;
    bool m_platform_applications_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPlatformApplicationsResponse)

#endif // OAIListPlatformApplicationsResponse_H
