...
OAISetSMSAttributesInput::OAISetSMSAttributesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetSMSAttributesInput::OAISetSMSAttributesInput() {
    this->initializeModel();
}

OAISetSMSAttributesInput::~OAISetSMSAttributesInput() {}

void OAISetSMSAttributesInput::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAISetSMSAttributesInput::fromJson(QString jsonString) {
...
void OAISetSMSAttributesInput::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("attributes")]);
    m_attributes_isSet = !json[QString("attributes")].isNull() && m_attributes_isValid;
}

QString OAISetSMSAttributesInput::asJson() const {
...
QJsonObject OAISetSMSAttributesInput::asJsonObject() const {
    QJsonObject obj;
...
QMap OAISetSMSAttributesInput::getAttributes() const {
    return m_attributes;
}
void OAISetSMSAttributesInput::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAISetSMSAttributesInput::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAISetSMSAttributesInput::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAISetSMSAttributesInput::isSet() const {
...
bool OAISetSMSAttributesInput::isValid() const {
