...
/*
 * OAICreateSMSSandboxPhoneNumberInput.h
 *
 * 
 */

#ifndef OAICreateSMSSandboxPhoneNumberInput_H
#define OAICreateSMSSandboxPhoneNumberInput_H
...
class OAICreateSMSSandboxPhoneNumberInput : public OAIObject {
public:
    OAICreateSMSSandboxPhoneNumberInput();
    OAICreateSMSSandboxPhoneNumberInput(QString json);
    ~OAICreateSMSSandboxPhoneNumberInput() override;
    ...
    OAILanguageCodeString getLanguageCode() const;
    void setLanguageCode(const OAILanguageCodeString &language_code);
...
private:
    ...
    OAILanguageCodeString m_language_code;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSMSSandboxPhoneNumberInput)

#endif // OAICreateSMSSandboxPhoneNumberInput_H
