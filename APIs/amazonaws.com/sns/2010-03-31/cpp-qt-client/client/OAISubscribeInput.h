...
#ifndef OAISubscribeInput_H
#define OAISubscribeInput_H
...
class OAISubscribeInput : public OAIObject {
public:
    OAISubscribeInput();
    OAISubscribeInput(QString json);
    ~OAISubscribeInput() override;
    ...
    void setReturnSubscriptionArn(const bool &return_subscription_arn);
    bool is_return_subscription_arn_Set() const;
    bool is_return_subscription_arn_Valid() const;
...
private:
    ...
    bool m_return_subscription_arn;
    bool m_return_subscription_arn_isSet;
    bool m_return_subscription_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISubscribeInput)

#endif // OAISubscribeInput_H
