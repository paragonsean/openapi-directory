...
OAISubscribeResponse::OAISubscribeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubscribeResponse::OAISubscribeResponse() {
    this->initializeModel();
}

OAISubscribeResponse::~OAISubscribeResponse() {}

void OAISubscribeResponse::initializeModel() {

    m_subscription_arn_isSet = false;
    m_subscription_arn_isValid = false;
}

void OAISubscribeResponse::fromJson(QString jsonString) {
...
void OAISubscribeResponse::fromJsonObject(QJsonObject json) {
...
QString OAISubscribeResponse::asJson() const {
...
QJsonObject OAISubscribeResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAISubscribeResponse::getSubscriptionArn() const {
    return m_subscription_arn;
}
void OAISubscribeResponse::setSubscriptionArn(const QString &subscription_arn) {
    m_subscription_arn = subscription_arn;
    m_subscription_arn_isSet = true;
}

bool OAISubscribeResponse::is_subscription_arn_Set() const{
    return m_subscription_arn_isSet;
}

bool OAISubscribeResponse::is_subscription_arn_Valid() const{
    return m_subscription_arn_isValid;
}

bool OAISubscribeResponse::isSet() const {
...
bool OAISubscribeResponse::isValid() const {
