...
OAIGetDataProtectionPolicyInput::OAIGetDataProtectionPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDataProtectionPolicyInput::OAIGetDataProtectionPolicyInput() {
    this->initializeModel();
}

OAIGetDataProtectionPolicyInput::~OAIGetDataProtectionPolicyInput() {}

void OAIGetDataProtectionPolicyInput::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIGetDataProtectionPolicyInput::fromJson(QString jsonString) {
...
void OAIGetDataProtectionPolicyInput::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceArn")]);
    m_resource_arn_isSet = !json[QString("ResourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIGetDataProtectionPolicyInput::asJson() const {
...
QJsonObject OAIGetDataProtectionPolicyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDataProtectionPolicyInput::getResourceArn() const {
    return m_resource_arn;
}
void OAIGetDataProtectionPolicyInput::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIGetDataProtectionPolicyInput::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIGetDataProtectionPolicyInput::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIGetDataProtectionPolicyInput::isSet() const {
...
bool OAIGetDataProtectionPolicyInput::isValid() const {
