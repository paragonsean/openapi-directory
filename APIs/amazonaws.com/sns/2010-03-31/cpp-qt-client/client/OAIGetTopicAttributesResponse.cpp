...
OAIGetTopicAttributesResponse::OAIGetTopicAttributesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTopicAttributesResponse::OAIGetTopicAttributesResponse() {
    this->initializeModel();
}

OAIGetTopicAttributesResponse::~OAIGetTopicAttributesResponse() {}

void OAIGetTopicAttributesResponse::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAIGetTopicAttributesResponse::fromJson(QString jsonString) {
...
void OAIGetTopicAttributesResponse::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("Attributes")]);
    m_attributes_isSet = !json[QString("Attributes")].isNull() && m_attributes_isValid;
}

QString OAIGetTopicAttributesResponse::asJson() const {
...
QJsonObject OAIGetTopicAttributesResponse::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIGetTopicAttributesResponse::getAttributes() const {
    return m_attributes;
}
void OAIGetTopicAttributesResponse::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIGetTopicAttributesResponse::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIGetTopicAttributesResponse::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIGetTopicAttributesResponse::isSet() const {
...
bool OAIGetTopicAttributesResponse::isValid() const {
