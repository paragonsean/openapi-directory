...
/*
 * OAIListSMSSandboxPhoneNumbersInput.h
 *
 * 
 */

#ifndef OAIListSMSSandboxPhoneNumbersInput_H
#define OAIListSMSSandboxPhoneNumbersInput_H
...
class OAIListSMSSandboxPhoneNumbersInput : public OAIObject {
public:
    OAIListSMSSandboxPhoneNumbersInput();
    OAIListSMSSandboxPhoneNumbersInput(QString json);
    ~OAIListSMSSandboxPhoneNumbersInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSMSSandboxPhoneNumbersInput)

#endif // OAIListSMSSandboxPhoneNumbersInput_H
