...
/*
 * OAIConfirmSubscriptionInput.h
 *
 * Input for ConfirmSubscription action.
 */

#ifndef OAIConfirmSubscriptionInput_H
#define OAIConfirmSubscriptionInput_H
...
class OAIConfirmSubscriptionInput : public OAIObject {
public:
    OAIConfirmSubscriptionInput();
    OAIConfirmSubscriptionInput(QString json);
    ~OAIConfirmSubscriptionInput() override;
    ...
    QString getAuthenticateOnUnsubscribe() const;
    void setAuthenticateOnUnsubscribe(const QString &authenticate_on_unsubscribe);
    bool is_authenticate_on_unsubscribe_Set() const;
    bool is_authenticate_on_unsubscribe_Valid() const;
...
private:
    ...
    QString m_authenticate_on_unsubscribe;
    bool m_authenticate_on_unsubscribe_isSet;
    bool m_authenticate_on_unsubscribe_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIConfirmSubscriptionInput)

#endif // OAIConfirmSubscriptionInput_H
