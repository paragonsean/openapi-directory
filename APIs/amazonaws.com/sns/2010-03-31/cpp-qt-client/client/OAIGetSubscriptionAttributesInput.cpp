...
OAIGetSubscriptionAttributesInput::OAIGetSubscriptionAttributesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSubscriptionAttributesInput::OAIGetSubscriptionAttributesInput() {
    this->initializeModel();
}

OAIGetSubscriptionAttributesInput::~OAIGetSubscriptionAttributesInput() {}

void OAIGetSubscriptionAttributesInput::initializeModel() {

    m_subscription_arn_isSet = false;
    m_subscription_arn_isValid = false;
}

void OAIGetSubscriptionAttributesInput::fromJson(QString jsonString) {
...
void OAIGetSubscriptionAttributesInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetSubscriptionAttributesInput::asJson() const {
...
QJsonObject OAIGetSubscriptionAttributesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSubscriptionAttributesInput::getSubscriptionArn() const {
    return m_subscription_arn;
}
void OAIGetSubscriptionAttributesInput::setSubscriptionArn(const QString &subscription_arn) {
    m_subscription_arn = subscription_arn;
    m_subscription_arn_isSet = true;
}

bool OAIGetSubscriptionAttributesInput::is_subscription_arn_Set() const{
    return m_subscription_arn_isSet;
}

bool OAIGetSubscriptionAttributesInput::is_subscription_arn_Valid() const{
    return m_subscription_arn_isValid;
}

bool OAIGetSubscriptionAttributesInput::isSet() const {
...
bool OAIGetSubscriptionAttributesInput::isValid() const {
