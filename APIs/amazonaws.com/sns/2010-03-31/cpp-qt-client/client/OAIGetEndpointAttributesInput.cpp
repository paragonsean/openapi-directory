...
OAIGetEndpointAttributesInput::OAIGetEndpointAttributesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEndpointAttributesInput::OAIGetEndpointAttributesInput() {
    this->initializeModel();
}

OAIGetEndpointAttributesInput::~OAIGetEndpointAttributesInput() {}

void OAIGetEndpointAttributesInput::initializeModel() {

    m_endpoint_arn_isSet = false;
    m_endpoint_arn_isValid = false;
}

void OAIGetEndpointAttributesInput::fromJson(QString jsonString) {
...
void OAIGetEndpointAttributesInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetEndpointAttributesInput::asJson() const {
...
QJsonObject OAIGetEndpointAttributesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetEndpointAttributesInput::getEndpointArn() const {
    return m_endpoint_arn;
}
void OAIGetEndpointAttributesInput::setEndpointArn(const QString &endpoint_arn) {
    m_endpoint_arn = endpoint_arn;
    m_endpoint_arn_isSet = true;
}

bool OAIGetEndpointAttributesInput::is_endpoint_arn_Set() const{
    return m_endpoint_arn_isSet;
}

bool OAIGetEndpointAttributesInput::is_endpoint_arn_Valid() const{
    return m_endpoint_arn_isValid;
}

bool OAIGetEndpointAttributesInput::isSet() const {
...
bool OAIGetEndpointAttributesInput::isValid() const {
