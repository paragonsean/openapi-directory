...
/*
 * OAINumberCapability.h
 *
 * Enum listing out all supported number capabilities.
 */

#ifndef OAINumberCapability_H
#define OAINumberCapability_H
...
class OAINumberCapability : public OAIEnum {
public:
    OAINumberCapability();
    OAINumberCapability(QString json);
    ~OAINumberCapability() override;
    ...
    enum class eOAINumberCapability {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SMS, 
        MMS, 
        VOICE
    };
    OAINumberCapability::eOAINumberCapability getValue() const;
    void setValue(const OAINumberCapability::eOAINumberCapability& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAINumberCapability)

#endif // OAINumberCapability_H
