 ...
 */
@JsonAdapter(NumberCapability.Adapter.class)
public enum NumberCapability {
  ...
  public static NumberCapability fromValue(String value) {
    for (NumberCapability b : NumberCapability.values()) {
  ...
  public static class Adapter extends TypeAdapter<NumberCapability> {
    @Override
    public void write(final JsonWriter jsonWriter, final NumberCapability enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NumberCapability read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NumberCapability.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NumberCapability.fromValue(value);
  }
}
