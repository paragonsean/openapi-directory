...
public class ApiClient {
    ...
    private String basePath = "http://sns.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://sns.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://sns.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://sns.{region}.amazonaws.com.cn",
      "The Amazon SNS endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2010-03-31/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://sns.us-east-1.amazonaws.com
