...
class SourceConfigDetails(Model):
    ...
    def __init__(self, antenna_demod_decode_details: ConfigDetailsAntennaDemodDecodeDetails=None, endpoint_details: EndpointDetails=None, s3_recording_details: ConfigDetailsS3RecordingDetails=None):
        """SourceConfigDetails - a model defined in OpenAPI

        :param antenna_demod_decode_details: The antenna_demod_decode_details of this SourceConfigDetails.
        :param endpoint_details: The endpoint_details of this SourceConfigDetails.
        :param s3_recording_details: The s3_recording_details of this SourceConfigDetails.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SourceConfigDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Source_configDetails of this SourceConfigDetails.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def antenna_demod_decode_details(self):
        """Gets the antenna_demod_decode_details of this SourceConfigDetails.


        :return: The antenna_demod_decode_details of this SourceConfigDetails.
    ...
    def antenna_demod_decode_details(self, antenna_demod_decode_details):
        """Sets the antenna_demod_decode_details of this SourceConfigDetails.
    ...
    def endpoint_details(self):
        """Gets the endpoint_details of this SourceConfigDetails.


        :return: The endpoint_details of this SourceConfigDetails.
    ...
    def endpoint_details(self, endpoint_details):
        """Sets the endpoint_details of this SourceConfigDetails.
    ...
    def s3_recording_details(self):
        """Gets the s3_recording_details of this SourceConfigDetails.


        :return: The s3_recording_details of this SourceConfigDetails.
    ...
    def s3_recording_details(self, s3_recording_details):
        """Sets the s3_recording_details of this SourceConfigDetails.
