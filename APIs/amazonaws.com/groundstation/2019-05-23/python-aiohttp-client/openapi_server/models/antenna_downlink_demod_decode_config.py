...
class AntennaDownlinkDemodDecodeConfig(Model):
    ...
    def __init__(self, decode_config: AntennaDownlinkDemodDecodeConfigDecodeConfig=None, demodulation_config: AntennaDownlinkDemodDecodeConfigDemodulationConfig=None, spectrum_config: AntennaDownlinkDemodDecodeConfigSpectrumConfig=None):
        """AntennaDownlinkDemodDecodeConfig - a model defined in OpenAPI

        :param decode_config: The decode_config of this AntennaDownlinkDemodDecodeConfig.
        :param demodulation_config: The demodulation_config of this AntennaDownlinkDemodDecodeConfig.
        :param spectrum_config: The spectrum_config of this AntennaDownlinkDemodDecodeConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AntennaDownlinkDemodDecodeConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AntennaDownlinkDemodDecodeConfig of this AntennaDownlinkDemodDecodeConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def decode_config(self):
        """Gets the decode_config of this AntennaDownlinkDemodDecodeConfig.


        :return: The decode_config of this AntennaDownlinkDemodDecodeConfig.
    ...
    def decode_config(self, decode_config):
        """Sets the decode_config of this AntennaDownlinkDemodDecodeConfig.
    ...
    def demodulation_config(self):
        """Gets the demodulation_config of this AntennaDownlinkDemodDecodeConfig.


        :return: The demodulation_config of this AntennaDownlinkDemodDecodeConfig.
    ...
    def demodulation_config(self, demodulation_config):
        """Sets the demodulation_config of this AntennaDownlinkDemodDecodeConfig.
    ...
    def spectrum_config(self):
        """Gets the spectrum_config of this AntennaDownlinkDemodDecodeConfig.


        :return: The spectrum_config of this AntennaDownlinkDemodDecodeConfig.
    ...
    def spectrum_config(self, spectrum_config):
        """Sets the spectrum_config of this AntennaDownlinkDemodDecodeConfig.
