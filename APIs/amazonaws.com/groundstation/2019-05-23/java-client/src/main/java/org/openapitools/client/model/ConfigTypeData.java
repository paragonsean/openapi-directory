...
public class ConfigTypeData {
  ...
  public ConfigTypeData antennaDownlinkConfig(CreateConfigRequestConfigDataAntennaDownlinkConfig antennaDownlinkConfig) {
  ...
  public ConfigTypeData antennaDownlinkDemodDecodeConfig(CreateConfigRequestConfigDataAntennaDownlinkDemodDecodeConfig antennaDownlinkDemodDecodeConfig) {
  ...
  public ConfigTypeData antennaUplinkConfig(CreateConfigRequestConfigDataAntennaUplinkConfig antennaUplinkConfig) {
  ...
  public ConfigTypeData dataflowEndpointConfig(CreateConfigRequestConfigDataDataflowEndpointConfig dataflowEndpointConfig) {
  ...
  public ConfigTypeData s3RecordingConfig(CreateConfigRequestConfigDataS3RecordingConfig s3RecordingConfig) {
  ...
  public ConfigTypeData trackingConfig(CreateConfigRequestConfigDataTrackingConfig trackingConfig) {
  ...
  public ConfigTypeData uplinkEchoConfig(CreateConfigRequestConfigDataUplinkEchoConfig uplinkEchoConfig) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigTypeData configTypeData = (ConfigTypeData) o;
    return Objects.equals(this.antennaDownlinkConfig, configTypeData.antennaDownlinkConfig) &&
        Objects.equals(this.antennaDownlinkDemodDecodeConfig, configTypeData.antennaDownlinkDemodDecodeConfig) &&
        Objects.equals(this.antennaUplinkConfig, configTypeData.antennaUplinkConfig) &&
        Objects.equals(this.dataflowEndpointConfig, configTypeData.dataflowEndpointConfig) &&
        Objects.equals(this.s3RecordingConfig, configTypeData.s3RecordingConfig) &&
        Objects.equals(this.trackingConfig, configTypeData.trackingConfig) &&
        Objects.equals(this.uplinkEchoConfig, configTypeData.uplinkEchoConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigTypeData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigTypeData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigTypeData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigTypeData is not found in the empty JSON string", ConfigTypeData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigTypeData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigTypeData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigTypeData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigTypeData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigTypeData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigTypeData.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigTypeData>() {
           @Override
           public void write(JsonWriter out, ConfigTypeData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfigTypeData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfigTypeData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfigTypeData
   * @throws IOException if the JSON string is invalid with respect to ConfigTypeData
   */
  public static ConfigTypeData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigTypeData.class);
  }

  /**
   * Convert an instance of ConfigTypeData to an JSON string
   *
   * @return JSON string
   */
