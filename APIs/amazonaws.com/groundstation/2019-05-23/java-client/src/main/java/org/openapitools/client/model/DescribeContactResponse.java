...
public class DescribeContactResponse {
  ...
  public static final String SERIALIZED_NAME_DATAFLOW_LIST = "dataflowList";
  @SerializedName(SERIALIZED_NAME_DATAFLOW_LIST)
  private List dataflowList;
  ...
  public DescribeContactResponse contactId(String contactId) {
  ...
  public DescribeContactResponse contactStatus(ContactStatus contactStatus) {
  ...
  public DescribeContactResponse dataflowList(List dataflowList) {
   ...
   */
  @javax.annotation.Nullable
  public List getDataflowList() {
    return dataflowList;
  }

  public void setDataflowList(List dataflowList) {
    this.dataflowList = dataflowList;
  }


  public DescribeContactResponse endTime(OffsetDateTime endTime) {
  ...
  public DescribeContactResponse errorMessage(String errorMessage) {
  ...
  public DescribeContactResponse groundStation(String groundStation) {
  ...
  public DescribeContactResponse maximumElevation(DescribeContactResponseMaximumElevation maximumElevation) {
  ...
  public DescribeContactResponse missionProfileArn(String missionProfileArn) {
  ...
  public DescribeContactResponse postPassEndTime(OffsetDateTime postPassEndTime) {
  ...
  public DescribeContactResponse prePassStartTime(OffsetDateTime prePassStartTime) {
  ...
  public DescribeContactResponse region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DescribeContactResponse satelliteArn(String satelliteArn) {
  ...
  public DescribeContactResponse startTime(OffsetDateTime startTime) {
  ...
  public DescribeContactResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeContactResponse describeContactResponse = (DescribeContactResponse) o;
    return Objects.equals(this.contactId, describeContactResponse.contactId) &&
        Objects.equals(this.contactStatus, describeContactResponse.contactStatus) &&
        Objects.equals(this.dataflowList, describeContactResponse.dataflowList) &&
        Objects.equals(this.endTime, describeContactResponse.endTime) &&
        Objects.equals(this.errorMessage, describeContactResponse.errorMessage) &&
        Objects.equals(this.groundStation, describeContactResponse.groundStation) &&
        Objects.equals(this.maximumElevation, describeContactResponse.maximumElevation) &&
        Objects.equals(this.missionProfileArn, describeContactResponse.missionProfileArn) &&
        Objects.equals(this.postPassEndTime, describeContactResponse.postPassEndTime) &&
        Objects.equals(this.prePassStartTime, describeContactResponse.prePassStartTime) &&
        Objects.equals(this.region, describeContactResponse.region) &&
        Objects.equals(this.satelliteArn, describeContactResponse.satelliteArn) &&
        Objects.equals(this.startTime, describeContactResponse.startTime) &&
        Objects.equals(this.tags, describeContactResponse.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contactId, contactStatus, dataflowList, endTime, errorMessage, groundStation, maximumElevation, missionProfileArn, postPassEndTime, prePassStartTime, region, satelliteArn, startTime, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeContactResponse {\n");
    sb.append("    contactId: ").append(toIndentedString(contactId)).append("\n");
    sb.append("    contactStatus: ").append(toIndentedString(contactStatus)).append("\n");
    sb.append("    dataflowList: ").append(toIndentedString(dataflowList)).append("\n");
  ...
  static {
    ...
    openapiFields.add("dataflowList");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeContactResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeContactResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeContactResponse is not found in the empty JSON string", DescribeContactResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeContactResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeContactResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dataflowList") != null && !jsonObj.get("dataflowList").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("dataflowList"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeContactResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeContactResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeContactResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeContactResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeContactResponse>() {
           @Override
           public void write(JsonWriter out, DescribeContactResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeContactResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeContactResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeContactResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeContactResponse
   */
  public static DescribeContactResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeContactResponse.class);
  }

  /**
   * Convert an instance of DescribeContactResponse to an JSON string
   *
   * @return JSON string
   */
