# AwsGroundStation.CreateEphemerisRequest
...
**expirationTime** | **Date** | An overall expiration time for the ephemeris in UTC, after which it will become &lt;code&gt;EXPIRED&lt;/code&gt;. | [optional] 
...
**tags** | **{String: String}** | Tags assigned to an ephemeris. | [optional] 
