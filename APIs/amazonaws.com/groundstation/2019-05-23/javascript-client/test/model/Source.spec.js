...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGroundStation.Source();
  });
  ...
  describe('Source', function() {
    it('should create an instance of Source', function() {
      ...
      //var instance = new AwsGroundStation.Source();
      //expect(instance).to.be.a(AwsGroundStation.Source);
    });

    it('should have the property configDetails (base name: "configDetails")', function() {
      // uncomment below and update the code to test the property configDetails
      //var instance = new AwsGroundStation.Source();
    ...
    it('should have the property dataflowSourceRegion (base name: "dataflowSourceRegion")', function() {
      // uncomment below and update the code to test the property dataflowSourceRegion
      //var instance = new AwsGroundStation.Source();
      //expect(instance).to.be();
    });
