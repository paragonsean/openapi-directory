...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGroundStation.EndpointDetailsSecurityDetails();
  });
  ...
  describe('EndpointDetailsSecurityDetails', function() {
    it('should create an instance of EndpointDetailsSecurityDetails', function() {
      // uncomment below and update the code to test EndpointDetailsSecurityDetails
      //var instance = new AwsGroundStation.EndpointDetailsSecurityDetails();
      //expect(instance).to.be.a(AwsGroundStation.EndpointDetailsSecurityDetails);
    });
