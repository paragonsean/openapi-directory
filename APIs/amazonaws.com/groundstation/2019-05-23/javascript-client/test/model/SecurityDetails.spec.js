...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGroundStation.SecurityDetails();
  });
  ...
  describe('SecurityDetails', function() {
    it('should create an instance of SecurityDetails', function() {
      // uncomment below and update the code to test SecurityDetails
      //var instance = new AwsGroundStation.SecurityDetails();
      //expect(instance).to.be.a(AwsGroundStation.SecurityDetails);
    });
