...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGroundStation.ComponentVersion();
  });
  ...
  describe('ComponentVersion', function() {
    it('should create an instance of ComponentVersion', function() {
      // uncomment below and update the code to test ComponentVersion
      //var instance = new AwsGroundStation.ComponentVersion();
      //expect(instance).to.be.a(AwsGroundStation.ComponentVersion);
    });
