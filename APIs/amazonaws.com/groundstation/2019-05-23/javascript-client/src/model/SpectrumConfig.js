...
/**
 * The SpectrumConfig model module.
 * @module model/SpectrumConfig
 * @version 2019-05-23
 */
class SpectrumConfig {
    /**
     * Constructs a new <code>SpectrumConfig</code>.
     * Object that describes a spectral &lt;code&gt;Config&lt;/code&gt;.
     * @alias module:model/SpectrumConfig
    ...
    /**
     * Constructs a <code>SpectrumConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SpectrumConfig} obj Optional instance to populate.
     * @return {module:model/SpectrumConfig} The populated <code>SpectrumConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SpectrumConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>SpectrumConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SpectrumConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SpectrumConfig.RequiredProperties) {
...
SpectrumConfig.RequiredProperties = ["bandwidth", "centerFrequency"];
