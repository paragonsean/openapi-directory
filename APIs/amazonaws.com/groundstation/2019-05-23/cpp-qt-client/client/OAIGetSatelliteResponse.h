...
/*
 * OAIGetSatelliteResponse.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIGetSatelliteResponse_H
#define OAIGetSatelliteResponse_H
...
class OAIGetSatelliteResponse : public OAIObject {
public:
    OAIGetSatelliteResponse();
    OAIGetSatelliteResponse(QString json);
    ~OAIGetSatelliteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSatelliteResponse)

#endif // OAIGetSatelliteResponse_H
