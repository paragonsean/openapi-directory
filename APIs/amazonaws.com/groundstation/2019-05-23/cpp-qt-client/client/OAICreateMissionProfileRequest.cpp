...
#include "OAICreateMissionProfileRequest.h"
...
OAICreateMissionProfileRequest::OAICreateMissionProfileRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMissionProfileRequest::OAICreateMissionProfileRequest() {
    this->initializeModel();
}

OAICreateMissionProfileRequest::~OAICreateMissionProfileRequest() {}

void OAICreateMissionProfileRequest::initializeModel() {
...
void OAICreateMissionProfileRequest::fromJson(QString jsonString) {
...
void OAICreateMissionProfileRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateMissionProfileRequest::asJson() const {
...
QJsonObject OAICreateMissionProfileRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateMissionProfileRequest::getContactPostPassDurationSeconds() const {
    return m_contact_post_pass_duration_seconds;
}
void OAICreateMissionProfileRequest::setContactPostPassDurationSeconds(const qint32 &contact_post_pass_duration_seconds) {
    m_contact_post_pass_duration_seconds = contact_post_pass_duration_seconds;
    m_contact_post_pass_duration_seconds_isSet = true;
}

bool OAICreateMissionProfileRequest::is_contact_post_pass_duration_seconds_Set() const{
    return m_contact_post_pass_duration_seconds_isSet;
}

bool OAICreateMissionProfileRequest::is_contact_post_pass_duration_seconds_Valid() const{
    return m_contact_post_pass_duration_seconds_isValid;
}

qint32 OAICreateMissionProfileRequest::getContactPrePassDurationSeconds() const {
    return m_contact_pre_pass_duration_seconds;
}
void OAICreateMissionProfileRequest::setContactPrePassDurationSeconds(const qint32 &contact_pre_pass_duration_seconds) {
    m_contact_pre_pass_duration_seconds = contact_pre_pass_duration_seconds;
    m_contact_pre_pass_duration_seconds_isSet = true;
}

bool OAICreateMissionProfileRequest::is_contact_pre_pass_duration_seconds_Set() const{
    return m_contact_pre_pass_duration_seconds_isSet;
}

bool OAICreateMissionProfileRequest::is_contact_pre_pass_duration_seconds_Valid() const{
    return m_contact_pre_pass_duration_seconds_isValid;
}

QList OAICreateMissionProfileRequest::getDataflowEdges() const {
    return m_dataflow_edges;
}
void OAICreateMissionProfileRequest::setDataflowEdges(const QList &dataflow_edges) {
    m_dataflow_edges = dataflow_edges;
    m_dataflow_edges_isSet = true;
}

bool OAICreateMissionProfileRequest::is_dataflow_edges_Set() const{
    return m_dataflow_edges_isSet;
}

bool OAICreateMissionProfileRequest::is_dataflow_edges_Valid() const{
    return m_dataflow_edges_isValid;
}

qint32 OAICreateMissionProfileRequest::getMinimumViableContactDurationSeconds() const {
    return m_minimum_viable_contact_duration_seconds;
}
void OAICreateMissionProfileRequest::setMinimumViableContactDurationSeconds(const qint32 &minimum_viable_contact_duration_seconds) {
...
bool OAICreateMissionProfileRequest::is_minimum_viable_contact_duration_seconds_Set() const{
    return m_minimum_viable_contact_duration_seconds_isSet;
}

bool OAICreateMissionProfileRequest::is_minimum_viable_contact_duration_seconds_Valid() const{
    return m_minimum_viable_contact_duration_seconds_isValid;
}

QString OAICreateMissionProfileRequest::getName() const {
    return m_name;
}
void OAICreateMissionProfileRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateMissionProfileRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateMissionProfileRequest::is_name_Valid() const{
    return m_name_isValid;
}

OAIGetMissionProfileResponse_streamsKmsKey OAICreateMissionProfileRequest::getStreamsKmsKey() const {
    return m_streams_kms_key;
}
void OAICreateMissionProfileRequest::setStreamsKmsKey(const OAIGetMissionProfileResponse_streamsKmsKey &streams_kms_key) {
    m_streams_kms_key = streams_kms_key;
    m_streams_kms_key_isSet = true;
}

bool OAICreateMissionProfileRequest::is_streams_kms_key_Set() const{
    return m_streams_kms_key_isSet;
}

bool OAICreateMissionProfileRequest::is_streams_kms_key_Valid() const{
    return m_streams_kms_key_isValid;
}

QString OAICreateMissionProfileRequest::getStreamsKmsRole() const {
    return m_streams_kms_role;
}
void OAICreateMissionProfileRequest::setStreamsKmsRole(const QString &streams_kms_role) {
    m_streams_kms_role = streams_kms_role;
    m_streams_kms_role_isSet = true;
}

bool OAICreateMissionProfileRequest::is_streams_kms_role_Set() const{
    return m_streams_kms_role_isSet;
}

bool OAICreateMissionProfileRequest::is_streams_kms_role_Valid() const{
    return m_streams_kms_role_isValid;
}

QMap OAICreateMissionProfileRequest::getTags() const {
    return m_tags;
}
void OAICreateMissionProfileRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateMissionProfileRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateMissionProfileRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateMissionProfileRequest::getTrackingConfigArn() const {
    return m_tracking_config_arn;
}
void OAICreateMissionProfileRequest::setTrackingConfigArn(const QString &tracking_config_arn) {
    m_tracking_config_arn = tracking_config_arn;
    m_tracking_config_arn_isSet = true;
}

bool OAICreateMissionProfileRequest::is_tracking_config_arn_Set() const{
    return m_tracking_config_arn_isSet;
}

bool OAICreateMissionProfileRequest::is_tracking_config_arn_Valid() const{
    return m_tracking_config_arn_isValid;
}

bool OAICreateMissionProfileRequest::isSet() const {
...
bool OAICreateMissionProfileRequest::isValid() const {
