...
public:
    ...
    QList getDataflowList() const;
    void setDataflowList(const QList &dataflow_list);
    bool is_dataflow_list_Set() const;
    bool is_dataflow_list_Valid() const;
...
private:
    ...
    QList m_dataflow_list;
    bool m_dataflow_list_isSet;
    bool m_dataflow_list_isValid;
