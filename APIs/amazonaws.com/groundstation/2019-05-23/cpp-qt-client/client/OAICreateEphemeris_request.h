...
/*
 * OAICreateEphemeris_request.h
 *
 * 
 */

#ifndef OAICreateEphemeris_request_H
#define OAICreateEphemeris_request_H
...
namespace OpenAPI {
class OAICreateEphemeris_request_ephemeris;

class OAICreateEphemeris_request : public OAIObject {
public:
    OAICreateEphemeris_request();
    OAICreateEphemeris_request(QString json);
    ~OAICreateEphemeris_request() override;
    ...
    OAICreateEphemeris_request_ephemeris getEphemeris() const;
    void setEphemeris(const OAICreateEphemeris_request_ephemeris &ephemeris);
...
private:
    ...
    OAICreateEphemeris_request_ephemeris m_ephemeris;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEphemeris_request)

#endif // OAICreateEphemeris_request_H
