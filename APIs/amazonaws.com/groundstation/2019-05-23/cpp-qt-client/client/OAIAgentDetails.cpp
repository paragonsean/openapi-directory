...
OAIAgentDetails::OAIAgentDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAgentDetails::OAIAgentDetails() {
    this->initializeModel();
}

OAIAgentDetails::~OAIAgentDetails() {}

void OAIAgentDetails::initializeModel() {
...
void OAIAgentDetails::fromJson(QString jsonString) {
...
void OAIAgentDetails::fromJsonObject(QJsonObject json) {
...
QString OAIAgentDetails::asJson() const {
...
QJsonObject OAIAgentDetails::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAgentDetails::getAgentCpuCores() const {
    return m_agent_cpu_cores;
}
void OAIAgentDetails::setAgentCpuCores(const QList &agent_cpu_cores) {
    m_agent_cpu_cores = agent_cpu_cores;
    m_agent_cpu_cores_isSet = true;
}

bool OAIAgentDetails::is_agent_cpu_cores_Set() const{
    return m_agent_cpu_cores_isSet;
}

bool OAIAgentDetails::is_agent_cpu_cores_Valid() const{
    return m_agent_cpu_cores_isValid;
}

QString OAIAgentDetails::getAgentVersion() const {
    return m_agent_version;
}
void OAIAgentDetails::setAgentVersion(const QString &agent_version) {
    m_agent_version = agent_version;
    m_agent_version_isSet = true;
}

bool OAIAgentDetails::is_agent_version_Set() const{
    return m_agent_version_isSet;
}

bool OAIAgentDetails::is_agent_version_Valid() const{
    return m_agent_version_isValid;
}

QList OAIAgentDetails::getComponentVersions() const {
    return m_component_versions;
}
void OAIAgentDetails::setComponentVersions(const QList &component_versions) {
    m_component_versions = component_versions;
    m_component_versions_isSet = true;
}

bool OAIAgentDetails::is_component_versions_Set() const{
    return m_component_versions_isSet;
}

bool OAIAgentDetails::is_component_versions_Valid() const{
    return m_component_versions_isValid;
}

QString OAIAgentDetails::getInstanceId() const {
    return m_instance_id;
}
void OAIAgentDetails::setInstanceId(const QString &instance_id) {
    m_instance_id = instance_id;
    m_instance_id_isSet = true;
}

bool OAIAgentDetails::is_instance_id_Set() const{
    return m_instance_id_isSet;
}

bool OAIAgentDetails::is_instance_id_Valid() const{
    return m_instance_id_isValid;
}

QString OAIAgentDetails::getInstanceType() const {
    return m_instance_type;
}
void OAIAgentDetails::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIAgentDetails::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIAgentDetails::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

QList OAIAgentDetails::getReservedCpuCores() const {
    return m_reserved_cpu_cores;
}
void OAIAgentDetails::setReservedCpuCores(const QList &reserved_cpu_cores) {
    m_reserved_cpu_cores = reserved_cpu_cores;
    m_reserved_cpu_cores_isSet = true;
}

bool OAIAgentDetails::is_reserved_cpu_cores_Set() const{
    return m_reserved_cpu_cores_isSet;
}

bool OAIAgentDetails::is_reserved_cpu_cores_Valid() const{
    return m_reserved_cpu_cores_isValid;
}

bool OAIAgentDetails::isSet() const {
...
bool OAIAgentDetails::isValid() const {
