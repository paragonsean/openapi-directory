...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsShield.SummarizedCounter();
  });
  ...
  describe('SummarizedCounter', function() {
    it('should create an instance of SummarizedCounter', function() {
      // uncomment below and update the code to test SummarizedCounter
      //var instance = new AwsShield.SummarizedCounter();
      //expect(instance).to.be.a(AwsShield.SummarizedCounter);
    });
