...
class SubscriptionLimitsProtectionGroupLimits(Model):
    ...
    def __init__(self, max_protection_groups: int=None, pattern_type_limits: ProtectionGroupLimitsPatternTypeLimits=None):
        """SubscriptionLimitsProtectionGroupLimits - a model defined in OpenAPI

        :param max_protection_groups: The max_protection_groups of this SubscriptionLimitsProtectionGroupLimits.
        :param pattern_type_limits: The pattern_type_limits of this SubscriptionLimitsProtectionGroupLimits.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SubscriptionLimitsProtectionGroupLimits':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SubscriptionLimits_ProtectionGroupLimits of this SubscriptionLimitsProtectionGroupLimits.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_protection_groups(self):
        """Gets the max_protection_groups of this SubscriptionLimitsProtectionGroupLimits.


        :return: The max_protection_groups of this SubscriptionLimitsProtectionGroupLimits.
        :rtype: int
        """
    ...
    def max_protection_groups(self, max_protection_groups):
        """Sets the max_protection_groups of this SubscriptionLimitsProtectionGroupLimits.
    ...
    def pattern_type_limits(self):
        """Gets the pattern_type_limits of this SubscriptionLimitsProtectionGroupLimits.


        :return: The pattern_type_limits of this SubscriptionLimitsProtectionGroupLimits.
    ...
    def pattern_type_limits(self, pattern_type_limits):
        """Sets the pattern_type_limits of this SubscriptionLimitsProtectionGroupLimits.
