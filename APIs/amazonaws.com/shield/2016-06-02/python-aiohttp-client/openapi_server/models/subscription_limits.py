...
class SubscriptionLimits(Model):
    ...
    def __init__(self, protection_limits: SubscriptionLimitsProtectionLimits=None, protection_group_limits: SubscriptionLimitsProtectionGroupLimits=None):
        """SubscriptionLimits - a model defined in OpenAPI

        :param protection_limits: The protection_limits of this SubscriptionLimits.
        :param protection_group_limits: The protection_group_limits of this SubscriptionLimits.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SubscriptionLimits':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SubscriptionLimits of this SubscriptionLimits.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def protection_limits(self):
        """Gets the protection_limits of this SubscriptionLimits.


        :return: The protection_limits of this SubscriptionLimits.
    ...
    def protection_limits(self, protection_limits):
        """Sets the protection_limits of this SubscriptionLimits.
    ...
    def protection_group_limits(self):
        """Gets the protection_group_limits of this SubscriptionLimits.


        :return: The protection_group_limits of this SubscriptionLimits.
    ...
    def protection_group_limits(self, protection_group_limits):
        """Sets the protection_group_limits of this SubscriptionLimits.
