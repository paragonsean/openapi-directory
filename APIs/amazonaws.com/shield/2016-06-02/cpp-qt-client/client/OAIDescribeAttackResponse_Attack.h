...
/*
 * OAIDescribeAttackResponse_Attack.h
 *
 * 
 */

#ifndef OAIDescribeAttackResponse_Attack_H
#define OAIDescribeAttackResponse_Attack_H
...
class OAIDescribeAttackResponse_Attack : public OAIObject {
public:
    OAIDescribeAttackResponse_Attack();
    OAIDescribeAttackResponse_Attack(QString json);
    ~OAIDescribeAttackResponse_Attack() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAttackResponse_Attack)

#endif // OAIDescribeAttackResponse_Attack_H
