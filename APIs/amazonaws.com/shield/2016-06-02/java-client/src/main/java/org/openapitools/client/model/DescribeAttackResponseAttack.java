...
public class DescribeAttackResponseAttack {
  ...
  public DescribeAttackResponseAttack() {
  }

  public DescribeAttackResponseAttack attackId(String attackId) {
  ...
  public DescribeAttackResponseAttack resourceArn(String resourceArn) {
  ...
  public DescribeAttackResponseAttack subResources(List subResources) {
  ...
  public DescribeAttackResponseAttack startTime(OffsetDateTime startTime) {
  ...
  public DescribeAttackResponseAttack endTime(OffsetDateTime endTime) {
  ...
  public DescribeAttackResponseAttack attackCounters(List attackCounters) {
  ...
  public DescribeAttackResponseAttack attackProperties(List attackProperties) {
  ...
  public DescribeAttackResponseAttack mitigations(List mitigations) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAttackResponseAttack describeAttackResponseAttack = (DescribeAttackResponseAttack) o;
    return Objects.equals(this.attackId, describeAttackResponseAttack.attackId) &&
        Objects.equals(this.resourceArn, describeAttackResponseAttack.resourceArn) &&
        Objects.equals(this.subResources, describeAttackResponseAttack.subResources) &&
        Objects.equals(this.startTime, describeAttackResponseAttack.startTime) &&
        Objects.equals(this.endTime, describeAttackResponseAttack.endTime) &&
        Objects.equals(this.attackCounters, describeAttackResponseAttack.attackCounters) &&
        Objects.equals(this.attackProperties, describeAttackResponseAttack.attackProperties) &&
        Objects.equals(this.mitigations, describeAttackResponseAttack.mitigations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAttackResponseAttack {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAttackResponseAttack
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAttackResponseAttack.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAttackResponseAttack is not found in the empty JSON string", DescribeAttackResponseAttack.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAttackResponseAttack.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAttackResponseAttack` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAttackResponseAttack.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAttackResponseAttack' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAttackResponseAttack> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAttackResponseAttack.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAttackResponseAttack>() {
           @Override
           public void write(JsonWriter out, DescribeAttackResponseAttack value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAttackResponseAttack read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAttackResponseAttack given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAttackResponseAttack
   * @throws IOException if the JSON string is invalid with respect to DescribeAttackResponseAttack
   */
  public static DescribeAttackResponseAttack fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAttackResponseAttack.class);
  }

  /**
   * Convert an instance of DescribeAttackResponseAttack to an JSON string
   *
   * @return JSON string
   */
