...
public class DescribeProtectionResponseProtection {
  ...
  public DescribeProtectionResponseProtection() {
  }

  public DescribeProtectionResponseProtection id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeProtectionResponseProtection name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeProtectionResponseProtection resourceArn(String resourceArn) {
  ...
  public DescribeProtectionResponseProtection healthCheckIds(List healthCheckIds) {
  ...
  public DescribeProtectionResponseProtection protectionArn(String protectionArn) {
  ...
  public DescribeProtectionResponseProtection applicationLayerAutomaticResponseConfiguration(ProtectionApplicationLayerAutomaticResponseConfiguration applicationLayerAutomaticResponseConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeProtectionResponseProtection describeProtectionResponseProtection = (DescribeProtectionResponseProtection) o;
    return Objects.equals(this.id, describeProtectionResponseProtection.id) &&
        Objects.equals(this.name, describeProtectionResponseProtection.name) &&
        Objects.equals(this.resourceArn, describeProtectionResponseProtection.resourceArn) &&
        Objects.equals(this.healthCheckIds, describeProtectionResponseProtection.healthCheckIds) &&
        Objects.equals(this.protectionArn, describeProtectionResponseProtection.protectionArn) &&
        Objects.equals(this.applicationLayerAutomaticResponseConfiguration, describeProtectionResponseProtection.applicationLayerAutomaticResponseConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeProtectionResponseProtection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeProtectionResponseProtection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeProtectionResponseProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeProtectionResponseProtection is not found in the empty JSON string", DescribeProtectionResponseProtection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeProtectionResponseProtection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeProtectionResponseProtection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeProtectionResponseProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeProtectionResponseProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeProtectionResponseProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeProtectionResponseProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeProtectionResponseProtection>() {
           @Override
           public void write(JsonWriter out, DescribeProtectionResponseProtection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeProtectionResponseProtection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeProtectionResponseProtection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeProtectionResponseProtection
   * @throws IOException if the JSON string is invalid with respect to DescribeProtectionResponseProtection
   */
  public static DescribeProtectionResponseProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeProtectionResponseProtection.class);
  }

  /**
   * Convert an instance of DescribeProtectionResponseProtection to an JSON string
   *
   * @return JSON string
   */
