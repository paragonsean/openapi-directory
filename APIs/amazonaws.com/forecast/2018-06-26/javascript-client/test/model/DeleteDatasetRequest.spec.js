...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.DeleteDatasetRequest();
  });
  ...
  describe('DeleteDatasetRequest', function() {
    it('should create an instance of DeleteDatasetRequest', function() {
      ...
      //var instance = new AmazonForecastService.DeleteDatasetRequest();
      //expect(instance).to.be.a(AmazonForecastService.DeleteDatasetRequest);
    });
