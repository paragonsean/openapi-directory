...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.AttributeConfig();
  });
  ...
  describe('AttributeConfig', function() {
    it('should create an instance of AttributeConfig', function() {
      // uncomment below and update the code to test AttributeConfig
      //var instance = new AmazonForecastService.AttributeConfig();
      //expect(instance).to.be.a(AmazonForecastService.AttributeConfig);
    });
