...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.CreateForecastRequest();
  });
  ...
  describe('CreateForecastRequest', function() {
    it('should create an instance of CreateForecastRequest', function() {
      // uncomment below and update the code to test CreateForecastRequest
      //var instance = new AmazonForecastService.CreateForecastRequest();
      //expect(instance).to.be.a(AmazonForecastService.CreateForecastRequest);
    });
