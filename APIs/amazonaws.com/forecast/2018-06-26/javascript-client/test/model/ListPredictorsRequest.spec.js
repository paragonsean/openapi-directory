...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListPredictorsRequest();
  });
  ...
  describe('ListPredictorsRequest', function() {
    it('should create an instance of ListPredictorsRequest', function() {
      // uncomment below and update the code to test ListPredictorsRequest
      //var instance = new AmazonForecastService.ListPredictorsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListPredictorsRequest);
    });
