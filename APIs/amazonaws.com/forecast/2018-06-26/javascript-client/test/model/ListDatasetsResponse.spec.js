...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListDatasetsResponse();
  });
  ...
  describe('ListDatasetsResponse', function() {
    it('should create an instance of ListDatasetsResponse', function() {
      ...
      //var instance = new AmazonForecastService.ListDatasetsResponse();
      //expect(instance).to.be.a(AmazonForecastService.ListDatasetsResponse);
    });
