...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.WhatIfAnalysisSummary();
  });
  ...
  describe('WhatIfAnalysisSummary', function() {
    it('should create an instance of WhatIfAnalysisSummary', function() {
      // uncomment below and update the code to test WhatIfAnalysisSummary
      //var instance = new AmazonForecastService.WhatIfAnalysisSummary();
      //expect(instance).to.be.a(AmazonForecastService.WhatIfAnalysisSummary);
    });
