...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListWhatIfForecastsRequest();
  });
  ...
  describe('ListWhatIfForecastsRequest', function() {
    it('should create an instance of ListWhatIfForecastsRequest', function() {
      // uncomment below and update the code to test ListWhatIfForecastsRequest
      //var instance = new AmazonForecastService.ListWhatIfForecastsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListWhatIfForecastsRequest);
    });
