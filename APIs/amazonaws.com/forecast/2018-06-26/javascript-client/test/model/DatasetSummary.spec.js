...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.DatasetSummary();
  });
  ...
  describe('DatasetSummary', function() {
    it('should create an instance of DatasetSummary', function() {
      ...
      //var instance = new AmazonForecastService.DatasetSummary();
      //expect(instance).to.be.a(AmazonForecastService.DatasetSummary);
    });
