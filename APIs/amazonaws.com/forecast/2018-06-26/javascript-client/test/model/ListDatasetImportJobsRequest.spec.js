...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListDatasetImportJobsRequest();
  });
  ...
  describe('ListDatasetImportJobsRequest', function() {
    it('should create an instance of ListDatasetImportJobsRequest', function() {
      // uncomment below and update the code to test ListDatasetImportJobsRequest
      //var instance = new AmazonForecastService.ListDatasetImportJobsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListDatasetImportJobsRequest);
    });
