...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.TimeAlignmentBoundary();
  });
  ...
  describe('TimeAlignmentBoundary', function() {
    it('should create an instance of TimeAlignmentBoundary', function() {
      // uncomment below and update the code to test TimeAlignmentBoundary
      //var instance = new AmazonForecastService.TimeAlignmentBoundary();
      //expect(instance).to.be.a(AmazonForecastService.TimeAlignmentBoundary);
    });
