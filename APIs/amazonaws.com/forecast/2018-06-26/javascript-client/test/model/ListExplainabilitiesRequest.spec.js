...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListExplainabilitiesRequest();
  });
  ...
  describe('ListExplainabilitiesRequest', function() {
    it('should create an instance of ListExplainabilitiesRequest', function() {
      // uncomment below and update the code to test ListExplainabilitiesRequest
      //var instance = new AmazonForecastService.ListExplainabilitiesRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListExplainabilitiesRequest);
    });
