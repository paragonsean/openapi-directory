...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListExplainabilityExportsRequest();
  });
  ...
  describe('ListExplainabilityExportsRequest', function() {
    it('should create an instance of ListExplainabilityExportsRequest', function() {
      // uncomment below and update the code to test ListExplainabilityExportsRequest
      //var instance = new AmazonForecastService.ListExplainabilityExportsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListExplainabilityExportsRequest);
    });
