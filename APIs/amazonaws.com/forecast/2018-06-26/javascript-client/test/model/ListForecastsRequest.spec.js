...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListForecastsRequest();
  });
  ...
  describe('ListForecastsRequest', function() {
    it('should create an instance of ListForecastsRequest', function() {
      // uncomment below and update the code to test ListForecastsRequest
      //var instance = new AmazonForecastService.ListForecastsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListForecastsRequest);
    });
