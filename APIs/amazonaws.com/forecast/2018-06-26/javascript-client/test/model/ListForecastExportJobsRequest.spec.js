...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListForecastExportJobsRequest();
  });
  ...
  describe('ListForecastExportJobsRequest', function() {
    it('should create an instance of ListForecastExportJobsRequest', function() {
      // uncomment below and update the code to test ListForecastExportJobsRequest
      //var instance = new AmazonForecastService.ListForecastExportJobsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListForecastExportJobsRequest);
    });
