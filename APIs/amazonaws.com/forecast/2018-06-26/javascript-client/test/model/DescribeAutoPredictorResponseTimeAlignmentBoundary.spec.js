...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.DescribeAutoPredictorResponseTimeAlignmentBoundary();
  });
  ...
  describe('DescribeAutoPredictorResponseTimeAlignmentBoundary', function() {
    it('should create an instance of DescribeAutoPredictorResponseTimeAlignmentBoundary', function() {
      // uncomment below and update the code to test DescribeAutoPredictorResponseTimeAlignmentBoundary
      //var instance = new AmazonForecastService.DescribeAutoPredictorResponseTimeAlignmentBoundary();
      //expect(instance).to.be.a(AmazonForecastService.DescribeAutoPredictorResponseTimeAlignmentBoundary);
    });
