...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.DataSource();
  });
  ...
  describe('DataSource', function() {
    it('should create an instance of DataSource', function() {
      ...
      //var instance = new AmazonForecastService.DataSource();
      //expect(instance).to.be.a(AmazonForecastService.DataSource);
    });
