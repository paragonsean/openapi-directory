...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListPredictorBacktestExportJobsRequest();
  });
  ...
  describe('ListPredictorBacktestExportJobsRequest', function() {
    it('should create an instance of ListPredictorBacktestExportJobsRequest', function() {
      // uncomment below and update the code to test ListPredictorBacktestExportJobsRequest
      //var instance = new AmazonForecastService.ListPredictorBacktestExportJobsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListPredictorBacktestExportJobsRequest);
    });
