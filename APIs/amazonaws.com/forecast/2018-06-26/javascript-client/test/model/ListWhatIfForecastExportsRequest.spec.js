...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListWhatIfForecastExportsRequest();
  });
  ...
  describe('ListWhatIfForecastExportsRequest', function() {
    it('should create an instance of ListWhatIfForecastExportsRequest', function() {
      // uncomment below and update the code to test ListWhatIfForecastExportsRequest
      //var instance = new AmazonForecastService.ListWhatIfForecastExportsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListWhatIfForecastExportsRequest);
    });
