...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.CreateMonitorRequest();
  });
  ...
  describe('CreateMonitorRequest', function() {
    it('should create an instance of CreateMonitorRequest', function() {
      // uncomment below and update the code to test CreateMonitorRequest
      //var instance = new AmazonForecastService.CreateMonitorRequest();
      //expect(instance).to.be.a(AmazonForecastService.CreateMonitorRequest);
    });
