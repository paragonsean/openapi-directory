...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.DataSourceS3Config();
  });
  ...
  describe('DataSourceS3Config', function() {
    it('should create an instance of DataSourceS3Config', function() {
      // uncomment below and update the code to test DataSourceS3Config
      //var instance = new AmazonForecastService.DataSourceS3Config();
      //expect(instance).to.be.a(AmazonForecastService.DataSourceS3Config);
    });
