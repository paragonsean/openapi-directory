...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListMonitorsRequest();
  });
  ...
  describe('ListMonitorsRequest', function() {
    it('should create an instance of ListMonitorsRequest', function() {
      // uncomment below and update the code to test ListMonitorsRequest
      //var instance = new AmazonForecastService.ListMonitorsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListMonitorsRequest);
    });
