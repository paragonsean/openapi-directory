...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListDatasetsRequest();
  });
  ...
  describe('ListDatasetsRequest', function() {
    it('should create an instance of ListDatasetsRequest', function() {
      ...
      //var instance = new AmazonForecastService.ListDatasetsRequest();
      //expect(instance).to.be.a(AmazonForecastService.ListDatasetsRequest);
    });
