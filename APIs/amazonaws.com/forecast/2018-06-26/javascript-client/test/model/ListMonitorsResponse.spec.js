...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.ListMonitorsResponse();
  });
  ...
  describe('ListMonitorsResponse', function() {
    it('should create an instance of ListMonitorsResponse', function() {
      // uncomment below and update the code to test ListMonitorsResponse
      //var instance = new AmazonForecastService.ListMonitorsResponse();
      //expect(instance).to.be.a(AmazonForecastService.ListMonitorsResponse);
    });
