...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonForecastService.EncryptionConfig();
  });
  ...
  describe('EncryptionConfig', function() {
    it('should create an instance of EncryptionConfig', function() {
      ...
      //var instance = new AmazonForecastService.EncryptionConfig();
      //expect(instance).to.be.a(AmazonForecastService.EncryptionConfig);
    });
