...
class DataConfig(Model):
    ...
    def __init__(self, dataset_group_arn: str=None, attribute_configs: List=None, additional_datasets: List=None):
        """DataConfig - a model defined in OpenAPI

        :param dataset_group_arn: The dataset_group_arn of this DataConfig.
        :param attribute_configs: The attribute_configs of this DataConfig.
        :param additional_datasets: The additional_datasets of this DataConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DataConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DataConfig of this DataConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def dataset_group_arn(self):
        """Gets the dataset_group_arn of this DataConfig.


        :return: The dataset_group_arn of this DataConfig.
        :rtype: str
        """
    ...
    def dataset_group_arn(self, dataset_group_arn):
        """Sets the dataset_group_arn of this DataConfig.
    ...
    def attribute_configs(self):
        """Gets the attribute_configs of this DataConfig.


        :return: The attribute_configs of this DataConfig.
        :rtype: List
        """
    ...
    def attribute_configs(self, attribute_configs):
        """Sets the attribute_configs of this DataConfig.
    ...
    def additional_datasets(self):
        """Gets the additional_datasets of this DataConfig.


        :return: The additional_datasets of this DataConfig.
        :rtype: List
        """
    ...
    def additional_datasets(self, additional_datasets):
        """Sets the additional_datasets of this DataConfig.
