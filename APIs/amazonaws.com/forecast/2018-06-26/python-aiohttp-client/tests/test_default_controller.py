...
async def test_create_auto_predictor(client):
    """Test case for create_auto_predictor

    
    """
    body = {"OptimizationMetric":"","PredictorName":"","ForecastDimensions":"","ForecastHorizon":"","ForecastFrequency":"","EncryptionConfig":{"KMSKeyArn":"","RoleArn":""},"TimeAlignmentBoundary":{"Month":"","DayOfWeek":"","Hour":"","DayOfMonth":""},"ForecastTypes":"","DataConfig":{"DatasetGroupArn":"","AdditionalDatasets":"","AttributeConfigs":""},"ExplainPredictor":"","ReferencePredictorArn":"","Tags":"","MonitorConfig":{"MonitorName":""}}
    headers = { 
...
async def test_create_dataset(client):
    ...
    """
    body = {"DataFrequency":"","DatasetName":"","Schema":{"Attributes":""},"DatasetType":"","Domain":"","EncryptionConfig":{"KMSKeyArn":"","RoleArn":""},"Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreateDataset',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_dataset_group(client):
    """Test case for create_dataset_group

    
    """
    body = {"DatasetArns":"","DatasetGroupName":"","Domain":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreateDatasetGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_dataset_import_job(client):
    """Test case for create_dataset_import_job

    
    """
    body = {"DatasetArn":"","TimeZone":"","UseGeolocationForTimeZone":"","Format":"","ImportMode":"","DatasetImportJobName":"","GeolocationFormat":"","TimestampFormat":"","Tags":"","DataSource":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreateDatasetImportJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_explainability(client):
    """Test case for create_explainability

    
    """
    body = {"ResourceArn":"","StartDateTime":"","EndDateTime":"","Schema":{"Attributes":""},"EnableVisualization":"","ExplainabilityName":"","ExplainabilityConfig":{"TimeSeriesGranularity":"","TimePointGranularity":""},"Tags":"","DataSource":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_explainability_export(client):
    """Test case for create_explainability_export

    
    """
    body = {"Destination":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}},"ExplainabilityArn":"","Format":"","ExplainabilityExportName":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreateExplainabilityExport',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_forecast(client):
    """Test case for create_forecast

    
    """
    body = {"ForecastName":"","TimeSeriesSelector":{"TimeSeriesIdentifiers":{"Format":"","Schema":{"Attributes":""},"DataSource":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}}}},"ForecastTypes":"","PredictorArn":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreateForecast',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_forecast_export_job(client):
    """Test case for create_forecast_export_job

    
    """
    body = {"Destination":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}},"Format":"","ForecastArn":"","ForecastExportJobName":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreateForecastExportJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_monitor(client):
    ...
    """
    body = {"ResourceArn":"","MonitorName":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_predictor(client):
    """Test case for create_predictor

    
    """
    body = {"OptimizationMetric":"","PredictorName":"","PerformAutoML":"","HPOConfig":{"ParameterRanges":{"CategoricalParameterRanges":"","IntegerParameterRanges":"","ContinuousParameterRanges":""}},"ForecastHorizon":"","InputDataConfig":{"DatasetGroupArn":"","SupplementaryFeatures":""},"EncryptionConfig":{"KMSKeyArn":"","RoleArn":""},"AutoMLOverrideStrategy":"","AlgorithmArn":"","PerformHPO":"","EvaluationParameters":{"NumberOfBacktestWindows":"","BackTestWindowOffset":""},"ForecastTypes":"","FeaturizationConfig":{"Featurizations":"","ForecastDimensions":"","ForecastFrequency":""},"TrainingParameters":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreatePredictor',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_predictor_backtest_export_job(client):
    """Test case for create_predictor_backtest_export_job

    
    """
    body = {"Destination":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}},"Format":"","PredictorArn":"","PredictorBacktestExportJobName":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.CreatePredictorBacktestExportJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_what_if_analysis(client):
    """Test case for create_what_if_analysis

    
    """
    body = {"TimeSeriesSelector":{"TimeSeriesIdentifiers":{"Format":"","Schema":{"Attributes":""},"DataSource":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}}}},"WhatIfAnalysisName":"","ForecastArn":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_what_if_forecast(client):
    """Test case for create_what_if_forecast

    
    """
    body = {"WhatIfForecastName":"","TimeSeriesTransformations":"","TimeSeriesReplacementsDataSource":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""},"Format":"","Schema":{"Attributes":""},"TimestampFormat":""},"WhatIfAnalysisArn":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_what_if_forecast_export(client):
    """Test case for create_what_if_forecast_export

    
    """
    body = {"Destination":{"S3Config":{"Path":"","KMSKeyArn":"","RoleArn":""}},"Format":"","WhatIfForecastExportName":"","WhatIfForecastArns":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_dataset(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteDataset',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_dataset_group(client):
    """Test case for delete_dataset_group

    
    """
    body = {"DatasetGroupArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteDatasetGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_dataset_import_job(client):
    """Test case for delete_dataset_import_job

    
    """
    body = {"DatasetImportJobArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteDatasetImportJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_explainability(client):
    """Test case for delete_explainability

    
    """
    body = {"ExplainabilityArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteExplainability',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_explainability_export(client):
    """Test case for delete_explainability_export

    
    """
    body = {"ExplainabilityExportArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteExplainabilityExport',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_forecast(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteForecast',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_forecast_export_job(client):
    """Test case for delete_forecast_export_job

    
    """
    body = {"ForecastExportJobArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_monitor(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteMonitor',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_predictor(client):
    """Test case for delete_predictor
...
async def test_delete_predictor_backtest_export_job(client):
    """Test case for delete_predictor_backtest_export_job

    
    """
    body = {"PredictorBacktestExportJobArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeletePredictorBacktestExportJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_resource_tree(client):
    """Test case for delete_resource_tree
...
async def test_delete_what_if_analysis(client):
    """Test case for delete_what_if_analysis

    
    """
    body = {"WhatIfAnalysisArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteWhatIfAnalysis',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_what_if_forecast(client):
    """Test case for delete_what_if_forecast

    
    """
    body = {"WhatIfForecastArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_what_if_forecast_export(client):
    """Test case for delete_what_if_forecast_export

    
    """
    body = {"WhatIfForecastExportArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DeleteWhatIfForecastExport',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_auto_predictor(client):
    """Test case for describe_auto_predictor
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DescribeAutoPredictor',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_dataset_group(client):
    """Test case for describe_dataset_group
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DescribeDatasetGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_dataset_import_job(client):
    """Test case for describe_dataset_import_job
...
async def test_describe_explainability(client):
    """Test case for describe_explainability
...
async def test_describe_explainability_export(client):
    """Test case for describe_explainability_export
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DescribeExplainabilityExport',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_forecast(client):
    """Test case for describe_forecast
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DescribeForecast',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_forecast_export_job(client):
    """Test case for describe_forecast_export_job
...
async def test_describe_monitor(client):
    """Test case for describe_monitor
...
async def test_describe_predictor(client):
    """Test case for describe_predictor
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DescribePredictor',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_predictor_backtest_export_job(client):
    """Test case for describe_predictor_backtest_export_job
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DescribePredictorBacktestExportJob',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_what_if_analysis(client):
    """Test case for describe_what_if_analysis
...
async def test_describe_what_if_forecast(client):
    """Test case for describe_what_if_forecast
...
async def test_describe_what_if_forecast_export(client):
    """Test case for describe_what_if_forecast_export
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.DescribeWhatIfForecastExport',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_accuracy_metrics(client):
    """Test case for get_accuracy_metrics
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.GetAccuracyMetrics',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_dataset_groups(client):
    """Test case for list_dataset_groups
...
async def test_list_dataset_import_jobs(client):
    """Test case for list_dataset_import_jobs
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListDatasetImportJobs',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_datasets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListDatasets',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_explainabilities(client):
    """Test case for list_explainabilities
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListExplainabilities',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_explainability_exports(client):
    """Test case for list_explainability_exports
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListExplainabilityExports',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_forecast_export_jobs(client):
    """Test case for list_forecast_export_jobs
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListForecastExportJobs',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_monitor_evaluations(client):
    """Test case for list_monitor_evaluations

    
    """
    body = {"Filters":"","NextToken":"","MonitorArn":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_predictor_backtest_export_jobs(client):
    """Test case for list_predictor_backtest_export_jobs
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListPredictorBacktestExportJobs',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_predictors(client):
    """Test case for list_predictors
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_what_if_analyses(client):
    """Test case for list_what_if_analyses
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListWhatIfAnalyses',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_what_if_forecast_exports(client):
    """Test case for list_what_if_forecast_exports
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ListWhatIfForecastExports',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_what_if_forecasts(client):
    """Test case for list_what_if_forecasts
...
async def test_resume_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.ResumeResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stop_resource(client):
    """Test case for stop_resource
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.StopResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonForecast.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_dataset_group(client):
    """Test case for update_dataset_group

    
    """
    body = {"DatasetArns":"","DatasetGroupArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
