...
public class EvaluationResult {
  ...
  public static final String SERIALIZED_NAME_TEST_WINDOWS = "TestWindows";
  @SerializedName(SERIALIZED_NAME_TEST_WINDOWS)
  private List testWindows;

  public EvaluationResult() {
  }

  public EvaluationResult algorithmArn(String algorithmArn) {
  ...
  public EvaluationResult testWindows(List testWindows) {
   ...
   */
  @javax.annotation.Nullable
  public List getTestWindows() {
    return testWindows;
  }

  public void setTestWindows(List testWindows) {
    this.testWindows = testWindows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.algorithmArn, evaluationResult.algorithmArn) &&
        Objects.equals(this.testWindows, evaluationResult.testWindows);
  }

  @Override
  public int hashCode() {
    return Objects.hash(algorithmArn, testWindows);
  }
  ...
  public String toString() {
    ...
    sb.append("    testWindows: ").append(toIndentedString(testWindows)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("TestWindows") != null && !jsonObj.get("TestWindows").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("TestWindows"));
      }
  }
