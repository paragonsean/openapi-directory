...
public class S3Config {
  ...
  public S3Config path(String path) {
    this.path = path;
    return this;
  }
  ...
  public S3Config kmSKeyArn(String kmSKeyArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.path, s3Config.path) &&
        Objects.equals(this.roleArn, s3Config.roleArn) &&
        Objects.equals(this.kmSKeyArn, s3Config.kmSKeyArn);
  }
