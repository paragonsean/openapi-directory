...
/*
 * OAIListMonitorEvaluationsRequest.h
 *
 * 
 */

#ifndef OAIListMonitorEvaluationsRequest_H
#define OAIListMonitorEvaluationsRequest_H
...
class OAIListMonitorEvaluationsRequest : public OAIObject {
public:
    OAIListMonitorEvaluationsRequest();
    OAIListMonitorEvaluationsRequest(QString json);
    ~OAIListMonitorEvaluationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMonitorEvaluationsRequest)

#endif // OAIListMonitorEvaluationsRequest_H
