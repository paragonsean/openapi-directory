...
#ifndef OAIMonitorInfo_H
#define OAIMonitorInfo_H
...
class OAIMonitorInfo : public OAIObject {
public:
    OAIMonitorInfo();
    OAIMonitorInfo(QString json);
    ~OAIMonitorInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitorInfo)

#endif // OAIMonitorInfo_H
