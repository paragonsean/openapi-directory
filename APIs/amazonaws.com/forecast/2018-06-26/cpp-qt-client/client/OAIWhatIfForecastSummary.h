...
#ifndef OAIWhatIfForecastSummary_H
#define OAIWhatIfForecastSummary_H
...
class OAIWhatIfForecastSummary : public OAIObject {
public:
    OAIWhatIfForecastSummary();
    OAIWhatIfForecastSummary(QString json);
    ~OAIWhatIfForecastSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWhatIfForecastSummary)

#endif // OAIWhatIfForecastSummary_H
