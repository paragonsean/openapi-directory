...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOn.RoleInfo();
  });
  ...
  describe('RoleInfo', function() {
    it('should create an instance of RoleInfo', function() {
      // uncomment below and update the code to test RoleInfo
      //var instance = new AwsSingleSignOn.RoleInfo();
      //expect(instance).to.be.a(AwsSingleSignOn.RoleInfo);
    });
