...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOn.ListAccountRolesResponse();
  });
  ...
  describe('ListAccountRolesResponse', function() {
    it('should create an instance of ListAccountRolesResponse', function() {
      // uncomment below and update the code to test ListAccountRolesResponse
      //var instance = new AwsSingleSignOn.ListAccountRolesResponse();
      //expect(instance).to.be.a(AwsSingleSignOn.ListAccountRolesResponse);
    });
    ...
    it('should have the property roleList (base name: "roleList")', function() {
      // uncomment below and update the code to test the property roleList
      //var instance = new AwsSingleSignOn.ListAccountRolesResponse();
      //expect(instance).to.be();
    });
