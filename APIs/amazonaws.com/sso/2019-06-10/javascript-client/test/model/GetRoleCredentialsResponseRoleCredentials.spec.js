...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOn.GetRoleCredentialsResponseRoleCredentials();
  });
  ...
  describe('GetRoleCredentialsResponseRoleCredentials', function() {
    it('should create an instance of GetRoleCredentialsResponseRoleCredentials', function() {
      // uncomment below and update the code to test GetRoleCredentialsResponseRoleCredentials
      //var instance = new AwsSingleSignOn.GetRoleCredentialsResponseRoleCredentials();
      //expect(instance).to.be.a(AwsSingleSignOn.GetRoleCredentialsResponseRoleCredentials);
    });
