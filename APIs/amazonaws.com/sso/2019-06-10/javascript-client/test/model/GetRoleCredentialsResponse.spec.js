...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOn.GetRoleCredentialsResponse();
  });
  ...
  describe('GetRoleCredentialsResponse', function() {
    it('should create an instance of GetRoleCredentialsResponse', function() {
      // uncomment below and update the code to test GetRoleCredentialsResponse
      //var instance = new AwsSingleSignOn.GetRoleCredentialsResponse();
      //expect(instance).to.be.a(AwsSingleSignOn.GetRoleCredentialsResponse);
    });

    it('should have the property roleCredentials (base name: "roleCredentials")', function() {
      // uncomment below and update the code to test the property roleCredentials
      //var instance = new AwsSingleSignOn.GetRoleCredentialsResponse();
