...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOn.ListAccountsResponse();
  });
  ...
  describe('ListAccountsResponse', function() {
    it('should create an instance of ListAccountsResponse', function() {
      ...
      //var instance = new AwsSingleSignOn.ListAccountsResponse();
      //expect(instance).to.be.a(AwsSingleSignOn.ListAccountsResponse);
    });
    ...
    it('should have the property accountList (base name: "accountList")', function() {
