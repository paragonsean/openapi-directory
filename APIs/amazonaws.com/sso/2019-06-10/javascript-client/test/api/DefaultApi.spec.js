...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOn.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('getRoleCredentials', function() {
      it('should call getRoleCredentials successfully', function(done) {
        //uncomment below and update the code to test getRoleCredentials
        //instance.getRoleCredentials(function(error) {
    ...
    describe('listAccountRoles', function() {
      it('should call listAccountRoles successfully', function(done) {
        //uncomment below and update the code to test listAccountRoles
        //instance.listAccountRoles(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
