...
/**
 * The RoleCredentials model module.
 * @module model/RoleCredentials
 * @version 2019-06-10
 */
class RoleCredentials {
    /**
     * Constructs a new <code>RoleCredentials</code>.
     * Provides information about the role credentials that are assigned to the user.
     * @alias module:model/RoleCredentials
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RoleCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoleCredentials} obj Optional instance to populate.
     * @return {module:model/RoleCredentials} The populated <code>RoleCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoleCredentials();
    ...
    /**
     * Validates the JSON data with respect to <code>RoleCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoleCredentials</code>.
     */
...
export default RoleCredentials;
