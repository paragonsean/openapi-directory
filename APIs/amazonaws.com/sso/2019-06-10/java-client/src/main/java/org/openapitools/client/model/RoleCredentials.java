...
public class RoleCredentials {
  ...
  public RoleCredentials accessKeyId(String accessKeyId) {
  ...
  public RoleCredentials secretAccessKey(String secretAccessKey) {
  ...
  public RoleCredentials sessionToken(String sessionToken) {
  ...
  public RoleCredentials expiration(Integer expiration) {
  ...
  public boolean equals(Object o) {
    ...
    RoleCredentials roleCredentials = (RoleCredentials) o;
    return Objects.equals(this.accessKeyId, roleCredentials.accessKeyId) &&
        Objects.equals(this.secretAccessKey, roleCredentials.secretAccessKey) &&
        Objects.equals(this.sessionToken, roleCredentials.sessionToken) &&
        Objects.equals(this.expiration, roleCredentials.expiration);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoleCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RoleCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoleCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RoleCredentials is not found in the empty JSON string", RoleCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoleCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RoleCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RoleCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RoleCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RoleCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RoleCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<RoleCredentials>() {
           @Override
           public void write(JsonWriter out, RoleCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RoleCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RoleCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RoleCredentials
   * @throws IOException if the JSON string is invalid with respect to RoleCredentials
   */
  public static RoleCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RoleCredentials.class);
  }

  /**
   * Convert an instance of RoleCredentials to an JSON string
   *
   * @return JSON string
   */
