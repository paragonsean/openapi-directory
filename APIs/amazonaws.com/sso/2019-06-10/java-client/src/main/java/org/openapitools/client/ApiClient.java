...
public class ApiClient {
    ...
    private String basePath = "http://portal.sso.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://portal.sso.{region}.amazonaws.com",
      "The SSO multi-region endpoint",
    ...
    new ServerConfiguration(
      "http://portal.sso.{region}.amazonaws.com.cn",
      "The SSO endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
          "cn-north-1",
    ...
    new ServerConfiguration(
      "https://portal.sso.{region}.amazonaws.com.cn",
      "The SSO endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://portal.sso.us-east-1.amazonaws.com
