...
/*
 * OAIRoleCredentials.h
 *
 * Provides information about the role credentials that are assigned to the user.
 */

#ifndef OAIRoleCredentials_H
#define OAIRoleCredentials_H
...
class OAIRoleCredentials : public OAIObject {
public:
    OAIRoleCredentials();
    OAIRoleCredentials(QString json);
    ~OAIRoleCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoleCredentials)

#endif // OAIRoleCredentials_H
