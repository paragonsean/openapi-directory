...
#ifndef OAIRoleInfo_H
#define OAIRoleInfo_H
...
class OAIRoleInfo : public OAIObject {
public:
    OAIRoleInfo();
    OAIRoleInfo(QString json);
    ~OAIRoleInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoleInfo)
