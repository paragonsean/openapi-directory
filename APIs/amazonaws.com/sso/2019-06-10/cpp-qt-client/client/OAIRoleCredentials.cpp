...
OAIRoleCredentials::OAIRoleCredentials(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRoleCredentials::OAIRoleCredentials() {
    this->initializeModel();
}

OAIRoleCredentials::~OAIRoleCredentials() {}

void OAIRoleCredentials::initializeModel() {
...
void OAIRoleCredentials::fromJson(QString jsonString) {
...
void OAIRoleCredentials::fromJsonObject(QJsonObject json) {
...
QString OAIRoleCredentials::asJson() const {
...
QJsonObject OAIRoleCredentials::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRoleCredentials::getAccessKeyId() const {
    return m_access_key_id;
}
void OAIRoleCredentials::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAIRoleCredentials::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAIRoleCredentials::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAIRoleCredentials::getSecretAccessKey() const {
    return m_secret_access_key;
}
void OAIRoleCredentials::setSecretAccessKey(const QString &secret_access_key) {
    m_secret_access_key = secret_access_key;
    m_secret_access_key_isSet = true;
}

bool OAIRoleCredentials::is_secret_access_key_Set() const{
    return m_secret_access_key_isSet;
}

bool OAIRoleCredentials::is_secret_access_key_Valid() const{
    return m_secret_access_key_isValid;
}

QString OAIRoleCredentials::getSessionToken() const {
    return m_session_token;
}
void OAIRoleCredentials::setSessionToken(const QString &session_token) {
    m_session_token = session_token;
    m_session_token_isSet = true;
}

bool OAIRoleCredentials::is_session_token_Set() const{
    return m_session_token_isSet;
}

bool OAIRoleCredentials::is_session_token_Valid() const{
    return m_session_token_isValid;
}

qint32 OAIRoleCredentials::getExpiration() const {
    return m_expiration;
}
void OAIRoleCredentials::setExpiration(const qint32 &expiration) {
    m_expiration = expiration;
    m_expiration_isSet = true;
}

bool OAIRoleCredentials::is_expiration_Set() const{
    return m_expiration_isSet;
}

bool OAIRoleCredentials::is_expiration_Valid() const{
    return m_expiration_isValid;
}

bool OAIRoleCredentials::isSet() const {
...
bool OAIRoleCredentials::isValid() const {
