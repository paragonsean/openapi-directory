...
public:
    ...
    QList getAccountList() const;
    void setAccountList(const QList &account_list);
    bool is_account_list_Set() const;
    bool is_account_list_Valid() const;
...
private:
    ...
    QList m_account_list;
    bool m_account_list_isSet;
    bool m_account_list_isValid;
};
