...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getRoleCredentialsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getRoleCredentialsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString role_name = create(); // QString | The friendly name of the role that is assigned to the user.
      ...
      QString account_id = create(); // QString | The identifier for the AWS account that is assigned to the user.
      ...
      QString x_amz_sso_bearer_token = create(); // QString | The token issued by the <code>CreateToken</code> API call. For more information, see <a href=\"https://docs.aws.amazon.com/singlesignon/latest/OIDCAPIReference/API_CreateToken.html\">CreateToken</a> in the <i>IAM Identity Center OIDC API Reference Guide</i>.
      ...
      apiInstance.getRoleCredentials(role_nameaccount_idx_amz_sso_bearer_tokenx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
