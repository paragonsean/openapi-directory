...
class ListWorldGenerationJobsRequest(Model):
    ...
    def __init__(self, next_token: str=None, max_results: int=None, filters: List[Filter]=None):
        """ListWorldGenerationJobsRequest - a model defined in OpenAPI

        :param next_token: The next_token of this ListWorldGenerationJobsRequest.
        :param max_results: The max_results of this ListWorldGenerationJobsRequest.
        :param filters: The filters of this ListWorldGenerationJobsRequest.
        """
        self.openapi_types = {
            'next_token': str,
            'max_results': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListWorldGenerationJobsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListWorldGenerationJobs_request of this ListWorldGenerationJobsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def next_token(self):
        """Gets the next_token of this ListWorldGenerationJobsRequest.
        ...
        :return: The next_token of this ListWorldGenerationJobsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListWorldGenerationJobsRequest.
    ...
    def max_results(self):
        """Gets the max_results of this ListWorldGenerationJobsRequest.
        ...
        :return: The max_results of this ListWorldGenerationJobsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListWorldGenerationJobsRequest.
    ...
    @property
    def filters(self):
        """Gets the filters of this ListWorldGenerationJobsRequest.

        Optional filters to limit results. You can use <code>status</code> and <code>templateId</code>.

        :return: The filters of this ListWorldGenerationJobsRequest.
        :rtype: List[Filter]
        """
    ...
    def filters(self, filters):
        """Sets the filters of this ListWorldGenerationJobsRequest.
