...
class CreateRobotApplicationVersionRequest(Model):
    ...
    def __init__(self, application: str=None, current_revision_id: str=None, s3_etags: List[str]=None, image_digest: str=None):
        """CreateRobotApplicationVersionRequest - a model defined in OpenAPI

        :param application: The application of this CreateRobotApplicationVersionRequest.
        :param current_revision_id: The current_revision_id of this CreateRobotApplicationVersionRequest.
        :param s3_etags: The s3_etags of this CreateRobotApplicationVersionRequest.
        :param image_digest: The image_digest of this CreateRobotApplicationVersionRequest.
        """
        self.openapi_types = {
            'application': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateRobotApplicationVersionRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateRobotApplicationVersion_request of this CreateRobotApplicationVersionRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def application(self):
        """Gets the application of this CreateRobotApplicationVersionRequest.

        The application information for the robot application.

        :return: The application of this CreateRobotApplicationVersionRequest.
        :rtype: str
        """
    ...
    def application(self, application):
        """Sets the application of this CreateRobotApplicationVersionRequest.
    ...
    def current_revision_id(self):
        """Gets the current_revision_id of this CreateRobotApplicationVersionRequest.

        The current revision id for the robot application. If you provide a value and it matches the latest revision ID, a new version will be created.

        :return: The current_revision_id of this CreateRobotApplicationVersionRequest.
        :rtype: str
        """
    ...
    def current_revision_id(self, current_revision_id):
        """Sets the current_revision_id of this CreateRobotApplicationVersionRequest.
    ...
    @property
    def s3_etags(self):
        """Gets the s3_etags of this CreateRobotApplicationVersionRequest.

        The Amazon S3 identifier for the zip file bundle that you use for your robot application.

        :return: The s3_etags of this CreateRobotApplicationVersionRequest.
        :rtype: List[str]
        """
    ...
    def s3_etags(self, s3_etags):
        """Sets the s3_etags of this CreateRobotApplicationVersionRequest.
    ...
    def image_digest(self):
        """Gets the image_digest of this CreateRobotApplicationVersionRequest.

        A SHA256 identifier for the Docker image that you use for your robot application.

        :return: The image_digest of this CreateRobotApplicationVersionRequest.
        :rtype: str
        """
    ...
    def image_digest(self, image_digest):
        """Sets the image_digest of this CreateRobotApplicationVersionRequest.
