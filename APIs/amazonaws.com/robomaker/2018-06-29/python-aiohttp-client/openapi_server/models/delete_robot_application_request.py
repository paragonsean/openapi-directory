...
class DeleteRobotApplicationRequest(Model):
    ...
    def __init__(self, application: str=None, application_version: str=None):
        """DeleteRobotApplicationRequest - a model defined in OpenAPI

        :param application: The application of this DeleteRobotApplicationRequest.
        :param application_version: The application_version of this DeleteRobotApplicationRequest.
        """
        self.openapi_types = {
            'application': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteRobotApplicationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteRobotApplication_request of this DeleteRobotApplicationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def application(self):
        """Gets the application of this DeleteRobotApplicationRequest.

        The Amazon Resource Name (ARN) of the the robot application.

        :return: The application of this DeleteRobotApplicationRequest.
        :rtype: str
        """
    ...
    def application(self, application):
        """Sets the application of this DeleteRobotApplicationRequest.
    ...
    def application_version(self):
        """Gets the application_version of this DeleteRobotApplicationRequest.

        The version of the robot application to delete.

        :return: The application_version of this DeleteRobotApplicationRequest.
        :rtype: str
        """
    ...
    def application_version(self, application_version):
        """Sets the application_version of this DeleteRobotApplicationRequest.
