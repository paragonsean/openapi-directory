...
class ListWorldsRequest(Model):
    ...
    def __init__(self, next_token: str=None, max_results: int=None, filters: List[Filter]=None):
        """ListWorldsRequest - a model defined in OpenAPI

        :param next_token: The next_token of this ListWorldsRequest.
        :param max_results: The max_results of this ListWorldsRequest.
        :param filters: The filters of this ListWorldsRequest.
        """
        self.openapi_types = {
            'next_token': str,
            'max_results': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListWorldsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListWorlds_request of this ListWorldsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def next_token(self):
        """Gets the next_token of this ListWorldsRequest.
        ...
        :return: The next_token of this ListWorldsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListWorldsRequest.
    ...
    def max_results(self):
        """Gets the max_results of this ListWorldsRequest.
        ...
        :return: The max_results of this ListWorldsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListWorldsRequest.
    ...
    @property
    def filters(self):
        """Gets the filters of this ListWorldsRequest.

        Optional filters to limit results. You can use <code>status</code>.

        :return: The filters of this ListWorldsRequest.
        :rtype: List[Filter]
        """
    ...
    def filters(self, filters):
        """Sets the filters of this ListWorldsRequest.
