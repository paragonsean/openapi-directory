...
class DescribeRobotApplicationRequest(Model):
    ...
    def __init__(self, application: str=None, application_version: str=None):
        """DescribeRobotApplicationRequest - a model defined in OpenAPI

        :param application: The application of this DescribeRobotApplicationRequest.
        :param application_version: The application_version of this DescribeRobotApplicationRequest.
        """
        self.openapi_types = {
            'application': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeRobotApplicationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeRobotApplication_request of this DescribeRobotApplicationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def application(self):
        """Gets the application of this DescribeRobotApplicationRequest.

        The Amazon Resource Name (ARN) of the robot application.

        :return: The application of this DescribeRobotApplicationRequest.
        :rtype: str
        """
    ...
    def application(self, application):
        """Sets the application of this DescribeRobotApplicationRequest.
    ...
    def application_version(self):
        """Gets the application_version of this DescribeRobotApplicationRequest.

        The version of the robot application to describe.

        :return: The application_version of this DescribeRobotApplicationRequest.
        :rtype: str
        """
    ...
    def application_version(self, application_version):
        """Sets the application_version of this DescribeRobotApplicationRequest.
