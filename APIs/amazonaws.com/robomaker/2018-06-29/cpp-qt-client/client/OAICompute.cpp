...
qint32 OAICompute::getSimulationUnitLimit() const {
    return m_simulation_unit_limit;
}
void OAICompute::setSimulationUnitLimit(const qint32 &simulation_unit_limit) {
    m_simulation_unit_limit = simulation_unit_limit;
    m_simulation_unit_limit_isSet = true;
}

bool OAICompute::is_simulation_unit_limit_Set() const{
    return m_simulation_unit_limit_isSet;
}

bool OAICompute::is_simulation_unit_limit_Valid() const{
...
qint32 OAICompute::getGpuUnitLimit() const {
    return m_gpu_unit_limit;
}
void OAICompute::setGpuUnitLimit(const qint32 &gpu_unit_limit) {
    m_gpu_unit_limit = gpu_unit_limit;
    m_gpu_unit_limit_isSet = true;
}

bool OAICompute::is_gpu_unit_limit_Set() const{
    return m_gpu_unit_limit_isSet;
}

bool OAICompute::is_gpu_unit_limit_Valid() const{
