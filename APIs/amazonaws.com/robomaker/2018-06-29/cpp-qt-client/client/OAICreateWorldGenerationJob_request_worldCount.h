...
/*
 * OAICreateWorldGenerationJob_request_worldCount.h
 *
...
#ifndef OAICreateWorldGenerationJob_request_worldCount_H
#define OAICreateWorldGenerationJob_request_worldCount_H
...
class OAICreateWorldGenerationJob_request_worldCount : public OAIObject {
public:
    OAICreateWorldGenerationJob_request_worldCount();
    OAICreateWorldGenerationJob_request_worldCount(QString json);
    ~OAICreateWorldGenerationJob_request_worldCount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorldGenerationJob_request_worldCount)

#endif // OAICreateWorldGenerationJob_request_worldCount_H
