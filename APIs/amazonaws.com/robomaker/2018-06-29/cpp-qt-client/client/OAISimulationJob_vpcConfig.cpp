...
OAISimulationJob_vpcConfig::OAISimulationJob_vpcConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISimulationJob_vpcConfig::OAISimulationJob_vpcConfig() {
    this->initializeModel();
}

OAISimulationJob_vpcConfig::~OAISimulationJob_vpcConfig() {}

void OAISimulationJob_vpcConfig::initializeModel() {
...
void OAISimulationJob_vpcConfig::fromJson(QString jsonString) {
...
void OAISimulationJob_vpcConfig::fromJsonObject(QJsonObject json) {
...
QString OAISimulationJob_vpcConfig::asJson() const {
...
QJsonObject OAISimulationJob_vpcConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_subnets.isSet()) {
...
QList OAISimulationJob_vpcConfig::getSubnets() const {
    return m_subnets;
}
void OAISimulationJob_vpcConfig::setSubnets(const QList &subnets) {
    m_subnets = subnets;
    m_subnets_isSet = true;
}

bool OAISimulationJob_vpcConfig::is_subnets_Set() const{
    return m_subnets_isSet;
}

bool OAISimulationJob_vpcConfig::is_subnets_Valid() const{
    return m_subnets_isValid;
}

QList OAISimulationJob_vpcConfig::getSecurityGroups() const {
    return m_security_groups;
}
void OAISimulationJob_vpcConfig::setSecurityGroups(const QList &security_groups) {
    m_security_groups = security_groups;
    m_security_groups_isSet = true;
}

bool OAISimulationJob_vpcConfig::is_security_groups_Set() const{
    return m_security_groups_isSet;
}

bool OAISimulationJob_vpcConfig::is_security_groups_Valid() const{
    return m_security_groups_isValid;
}

QString OAISimulationJob_vpcConfig::getVpcId() const {
    return m_vpc_id;
}
void OAISimulationJob_vpcConfig::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAISimulationJob_vpcConfig::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAISimulationJob_vpcConfig::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

bool OAISimulationJob_vpcConfig::getAssignPublicIp() const {
    return m_assign_public_ip;
}
void OAISimulationJob_vpcConfig::setAssignPublicIp(const bool &assign_public_ip) {
    m_assign_public_ip = assign_public_ip;
    m_assign_public_ip_isSet = true;
}

bool OAISimulationJob_vpcConfig::is_assign_public_ip_Set() const{
    return m_assign_public_ip_isSet;
}

bool OAISimulationJob_vpcConfig::is_assign_public_ip_Valid() const{
    return m_assign_public_ip_isValid;
}

bool OAISimulationJob_vpcConfig::isSet() const {
...
bool OAISimulationJob_vpcConfig::isValid() const {
