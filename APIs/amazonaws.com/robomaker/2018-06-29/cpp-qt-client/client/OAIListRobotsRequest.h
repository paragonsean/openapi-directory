...
#ifndef OAIListRobotsRequest_H
#define OAIListRobotsRequest_H
...
class OAIListRobotsRequest : public OAIObject {
public:
    OAIListRobotsRequest();
    OAIListRobotsRequest(QString json);
    ~OAIListRobotsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRobotsRequest)

#endif // OAIListRobotsRequest_H
