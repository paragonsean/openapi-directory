...
/*
 * OAIDescribeSimulationJobResponse_networkInterface.h
 *
 * 
 */

#ifndef OAIDescribeSimulationJobResponse_networkInterface_H
#define OAIDescribeSimulationJobResponse_networkInterface_H
...
class OAIDescribeSimulationJobResponse_networkInterface : public OAIObject {
public:
    OAIDescribeSimulationJobResponse_networkInterface();
    OAIDescribeSimulationJobResponse_networkInterface(QString json);
    ~OAIDescribeSimulationJobResponse_networkInterface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSimulationJobResponse_networkInterface)

#endif // OAIDescribeSimulationJobResponse_networkInterface_H
