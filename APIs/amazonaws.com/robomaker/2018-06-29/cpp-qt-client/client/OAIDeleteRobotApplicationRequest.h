...
/*
 * OAIDeleteRobotApplicationRequest.h
 *
 * 
 */

#ifndef OAIDeleteRobotApplicationRequest_H
#define OAIDeleteRobotApplicationRequest_H
...
class OAIDeleteRobotApplicationRequest : public OAIObject {
public:
    OAIDeleteRobotApplicationRequest();
    OAIDeleteRobotApplicationRequest(QString json);
    ~OAIDeleteRobotApplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRobotApplicationRequest)

#endif // OAIDeleteRobotApplicationRequest_H
