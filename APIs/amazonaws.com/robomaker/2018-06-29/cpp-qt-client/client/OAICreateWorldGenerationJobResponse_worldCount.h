...
/*
 * OAICreateWorldGenerationJobResponse_worldCount.h
 *
 * 
 */

#ifndef OAICreateWorldGenerationJobResponse_worldCount_H
#define OAICreateWorldGenerationJobResponse_worldCount_H
...
class OAICreateWorldGenerationJobResponse_worldCount : public OAIObject {
public:
    OAICreateWorldGenerationJobResponse_worldCount();
    OAICreateWorldGenerationJobResponse_worldCount(QString json);
    ~OAICreateWorldGenerationJobResponse_worldCount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWorldGenerationJobResponse_worldCount)

#endif // OAICreateWorldGenerationJobResponse_worldCount_H
