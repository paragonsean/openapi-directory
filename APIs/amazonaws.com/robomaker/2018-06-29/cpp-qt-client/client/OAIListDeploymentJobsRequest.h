...
/*
 * OAIListDeploymentJobsRequest.h
 *
...
#ifndef OAIListDeploymentJobsRequest_H
#define OAIListDeploymentJobsRequest_H
...
class OAIListDeploymentJobsRequest : public OAIObject {
public:
    OAIListDeploymentJobsRequest();
    OAIListDeploymentJobsRequest(QString json);
    ~OAIListDeploymentJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDeploymentJobsRequest)

#endif // OAIListDeploymentJobsRequest_H
