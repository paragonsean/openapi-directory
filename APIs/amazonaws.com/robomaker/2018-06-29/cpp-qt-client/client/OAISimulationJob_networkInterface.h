...
/*
 * OAISimulationJob_networkInterface.h
 *
 * 
 */

#ifndef OAISimulationJob_networkInterface_H
#define OAISimulationJob_networkInterface_H
...
class OAISimulationJob_networkInterface : public OAIObject {
public:
    OAISimulationJob_networkInterface();
    OAISimulationJob_networkInterface(QString json);
    ~OAISimulationJob_networkInterface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimulationJob_networkInterface)

#endif // OAISimulationJob_networkInterface_H
