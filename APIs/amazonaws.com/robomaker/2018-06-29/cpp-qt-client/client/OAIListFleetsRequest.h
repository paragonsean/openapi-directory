...
#ifndef OAIListFleetsRequest_H
#define OAIListFleetsRequest_H
...
class OAIListFleetsRequest : public OAIObject {
public:
    OAIListFleetsRequest();
    OAIListFleetsRequest(QString json);
    ~OAIListFleetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFleetsRequest)

#endif // OAIListFleetsRequest_H
