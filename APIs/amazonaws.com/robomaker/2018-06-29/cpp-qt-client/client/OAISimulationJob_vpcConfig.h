...
/*
 * OAISimulationJob_vpcConfig.h
 *
 * 
 */

#ifndef OAISimulationJob_vpcConfig_H
#define OAISimulationJob_vpcConfig_H
...
class OAISimulationJob_vpcConfig : public OAIObject {
public:
    OAISimulationJob_vpcConfig();
    OAISimulationJob_vpcConfig(QString json);
    ~OAISimulationJob_vpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimulationJob_vpcConfig)

#endif // OAISimulationJob_vpcConfig_H
