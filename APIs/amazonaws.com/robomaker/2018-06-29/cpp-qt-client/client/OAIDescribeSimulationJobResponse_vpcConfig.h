...
/*
 * OAIDescribeSimulationJobResponse_vpcConfig.h
 *
 * 
 */

#ifndef OAIDescribeSimulationJobResponse_vpcConfig_H
#define OAIDescribeSimulationJobResponse_vpcConfig_H
...
class OAIDescribeSimulationJobResponse_vpcConfig : public OAIObject {
public:
    OAIDescribeSimulationJobResponse_vpcConfig();
    OAIDescribeSimulationJobResponse_vpcConfig(QString json);
    ~OAIDescribeSimulationJobResponse_vpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSimulationJobResponse_vpcConfig)

#endif // OAIDescribeSimulationJobResponse_vpcConfig_H
