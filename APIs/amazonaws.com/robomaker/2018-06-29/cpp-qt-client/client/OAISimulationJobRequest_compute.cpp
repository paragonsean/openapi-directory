...
OAISimulationJobRequest_compute::OAISimulationJobRequest_compute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISimulationJobRequest_compute::OAISimulationJobRequest_compute() {
    this->initializeModel();
}

OAISimulationJobRequest_compute::~OAISimulationJobRequest_compute() {}

void OAISimulationJobRequest_compute::initializeModel() {
...
void OAISimulationJobRequest_compute::fromJson(QString jsonString) {
...
void OAISimulationJobRequest_compute::fromJsonObject(QJsonObject json) {
...
QString OAISimulationJobRequest_compute::asJson() const {
...
QJsonObject OAISimulationJobRequest_compute::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAISimulationJobRequest_compute::getSimulationUnitLimit() const {
    return m_simulation_unit_limit;
}
void OAISimulationJobRequest_compute::setSimulationUnitLimit(const qint32 &simulation_unit_limit) {
    m_simulation_unit_limit = simulation_unit_limit;
    m_simulation_unit_limit_isSet = true;
}

bool OAISimulationJobRequest_compute::is_simulation_unit_limit_Set() const{
    return m_simulation_unit_limit_isSet;
}

bool OAISimulationJobRequest_compute::is_simulation_unit_limit_Valid() const{
    return m_simulation_unit_limit_isValid;
}

OAIComputeType OAISimulationJobRequest_compute::getComputeType() const {
    return m_compute_type;
}
void OAISimulationJobRequest_compute::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAISimulationJobRequest_compute::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAISimulationJobRequest_compute::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

qint32 OAISimulationJobRequest_compute::getGpuUnitLimit() const {
    return m_gpu_unit_limit;
}
void OAISimulationJobRequest_compute::setGpuUnitLimit(const qint32 &gpu_unit_limit) {
    m_gpu_unit_limit = gpu_unit_limit;
    m_gpu_unit_limit_isSet = true;
}

bool OAISimulationJobRequest_compute::is_gpu_unit_limit_Set() const{
    return m_gpu_unit_limit_isSet;
}

bool OAISimulationJobRequest_compute::is_gpu_unit_limit_Valid() const{
    return m_gpu_unit_limit_isValid;
}

bool OAISimulationJobRequest_compute::isSet() const {
...
bool OAISimulationJobRequest_compute::isValid() const {
