...
OAISimulationJob::OAISimulationJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISimulationJob::OAISimulationJob() {
    this->initializeModel();
}

OAISimulationJob::~OAISimulationJob() {}

void OAISimulationJob::initializeModel() {
...
void OAISimulationJob::fromJson(QString jsonString) {
...
void OAISimulationJob::fromJsonObject(QJsonObject json) {
...
QString OAISimulationJob::asJson() const {
...
QJsonObject OAISimulationJob::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAISimulationJob::getArn() const {
    return m_arn;
}
void OAISimulationJob::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAISimulationJob::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAISimulationJob::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAISimulationJob::getName() const {
    return m_name;
}
void OAISimulationJob::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISimulationJob::is_name_Set() const{
    return m_name_isSet;
}

bool OAISimulationJob::is_name_Valid() const{
    return m_name_isValid;
}

OAISimulationJobStatus OAISimulationJob::getStatus() const {
    return m_status;
}
void OAISimulationJob::setStatus(const OAISimulationJobStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISimulationJob::is_status_Set() const{
    return m_status_isSet;
}

bool OAISimulationJob::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAISimulationJob::getLastStartedAt() const {
    return m_last_started_at;
}
void OAISimulationJob::setLastStartedAt(const QDateTime &last_started_at) {
    m_last_started_at = last_started_at;
    m_last_started_at_isSet = true;
}

bool OAISimulationJob::is_last_started_at_Set() const{
    return m_last_started_at_isSet;
}

bool OAISimulationJob::is_last_started_at_Valid() const{
    return m_last_started_at_isValid;
}

QDateTime OAISimulationJob::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAISimulationJob::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAISimulationJob::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAISimulationJob::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

OAIFailureBehavior OAISimulationJob::getFailureBehavior() const {
    return m_failure_behavior;
}
void OAISimulationJob::setFailureBehavior(const OAIFailureBehavior &failure_behavior) {
    m_failure_behavior = failure_behavior;
    m_failure_behavior_isSet = true;
}

bool OAISimulationJob::is_failure_behavior_Set() const{
    return m_failure_behavior_isSet;
}

bool OAISimulationJob::is_failure_behavior_Valid() const{
    return m_failure_behavior_isValid;
}

OAISimulationJobErrorCode OAISimulationJob::getFailureCode() const {
    return m_failure_code;
}
void OAISimulationJob::setFailureCode(const OAISimulationJobErrorCode &failure_code) {
    m_failure_code = failure_code;
    m_failure_code_isSet = true;
}

bool OAISimulationJob::is_failure_code_Set() const{
    return m_failure_code_isSet;
}

bool OAISimulationJob::is_failure_code_Valid() const{
    return m_failure_code_isValid;
}

QString OAISimulationJob::getFailureReason() const {
    return m_failure_reason;
}
void OAISimulationJob::setFailureReason(const QString &failure_reason) {
    m_failure_reason = failure_reason;
    m_failure_reason_isSet = true;
}

bool OAISimulationJob::is_failure_reason_Set() const{
    return m_failure_reason_isSet;
}

bool OAISimulationJob::is_failure_reason_Valid() const{
    return m_failure_reason_isValid;
}

QString OAISimulationJob::getClientRequestToken() const {
    return m_client_request_token;
}
void OAISimulationJob::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAISimulationJob::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAISimulationJob::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAIDescribeSimulationJobResponse_outputLocation OAISimulationJob::getOutputLocation() const {
    return m_output_location;
}
void OAISimulationJob::setOutputLocation(const OAIDescribeSimulationJobResponse_outputLocation &output_location) {
    m_output_location = output_location;
    m_output_location_isSet = true;
}

bool OAISimulationJob::is_output_location_Set() const{
    return m_output_location_isSet;
}

bool OAISimulationJob::is_output_location_Valid() const{
    return m_output_location_isValid;
}

OAICreateSimulationJobResponse_loggingConfig OAISimulationJob::getLoggingConfig() const {
    return m_logging_config;
}
void OAISimulationJob::setLoggingConfig(const OAICreateSimulationJobResponse_loggingConfig &logging_config) {
    m_logging_config = logging_config;
    m_logging_config_isSet = true;
}

bool OAISimulationJob::is_logging_config_Set() const{
    return m_logging_config_isSet;
}

bool OAISimulationJob::is_logging_config_Valid() const{
    return m_logging_config_isValid;
}

qint32 OAISimulationJob::getMaxJobDurationInSeconds() const {
    return m_max_job_duration_in_seconds;
}
void OAISimulationJob::setMaxJobDurationInSeconds(const qint32 &max_job_duration_in_seconds) {
    m_max_job_duration_in_seconds = max_job_duration_in_seconds;
    m_max_job_duration_in_seconds_isSet = true;
}

bool OAISimulationJob::is_max_job_duration_in_seconds_Set() const{
    return m_max_job_duration_in_seconds_isSet;
}

bool OAISimulationJob::is_max_job_duration_in_seconds_Valid() const{
    return m_max_job_duration_in_seconds_isValid;
}

qint32 OAISimulationJob::getSimulationTimeMillis() const {
    return m_simulation_time_millis;
}
void OAISimulationJob::setSimulationTimeMillis(const qint32 &simulation_time_millis) {
    m_simulation_time_millis = simulation_time_millis;
    m_simulation_time_millis_isSet = true;
}

bool OAISimulationJob::is_simulation_time_millis_Set() const{
    return m_simulation_time_millis_isSet;
}

bool OAISimulationJob::is_simulation_time_millis_Valid() const{
    return m_simulation_time_millis_isValid;
}

QString OAISimulationJob::getIamRole() const {
    return m_iam_role;
}
void OAISimulationJob::setIamRole(const QString &iam_role) {
    m_iam_role = iam_role;
    m_iam_role_isSet = true;
}

bool OAISimulationJob::is_iam_role_Set() const{
    return m_iam_role_isSet;
}

bool OAISimulationJob::is_iam_role_Valid() const{
    return m_iam_role_isValid;
}

QList OAISimulationJob::getRobotApplications() const {
    return m_robot_applications;
}
void OAISimulationJob::setRobotApplications(const QList &robot_applications) {
    m_robot_applications = robot_applications;
    m_robot_applications_isSet = true;
}

bool OAISimulationJob::is_robot_applications_Set() const{
    return m_robot_applications_isSet;
}

bool OAISimulationJob::is_robot_applications_Valid() const{
    return m_robot_applications_isValid;
}

QList OAISimulationJob::getSimulationApplications() const {
    return m_simulation_applications;
}
void OAISimulationJob::setSimulationApplications(const QList &simulation_applications) {
    m_simulation_applications = simulation_applications;
    m_simulation_applications_isSet = true;
}

bool OAISimulationJob::is_simulation_applications_Set() const{
    return m_simulation_applications_isSet;
}

bool OAISimulationJob::is_simulation_applications_Valid() const{
    return m_simulation_applications_isValid;
}

QList OAISimulationJob::getDataSources() const {
    return m_data_sources;
}
void OAISimulationJob::setDataSources(const QList &data_sources) {
    m_data_sources = data_sources;
    m_data_sources_isSet = true;
}

bool OAISimulationJob::is_data_sources_Set() const{
    return m_data_sources_isSet;
}

bool OAISimulationJob::is_data_sources_Valid() const{
    return m_data_sources_isValid;
}

QMap OAISimulationJob::getTags() const {
    return m_tags;
}
void OAISimulationJob::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAISimulationJob::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAISimulationJob::is_tags_Valid() const{
    return m_tags_isValid;
}

OAISimulationJob_vpcConfig OAISimulationJob::getVpcConfig() const {
    return m_vpc_config;
}
void OAISimulationJob::setVpcConfig(const OAISimulationJob_vpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAISimulationJob::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAISimulationJob::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

OAISimulationJob_networkInterface OAISimulationJob::getNetworkInterface() const {
    return m_network_interface;
}
void OAISimulationJob::setNetworkInterface(const OAISimulationJob_networkInterface &network_interface) {
    m_network_interface = network_interface;
    m_network_interface_isSet = true;
}

bool OAISimulationJob::is_network_interface_Set() const{
    return m_network_interface_isSet;
}

bool OAISimulationJob::is_network_interface_Valid() const{
    return m_network_interface_isValid;
}

OAISimulationJob_compute OAISimulationJob::getCompute() const {
    return m_compute;
}
void OAISimulationJob::setCompute(const OAISimulationJob_compute &compute) {
    m_compute = compute;
    m_compute_isSet = true;
}

bool OAISimulationJob::is_compute_Set() const{
    return m_compute_isSet;
}

bool OAISimulationJob::is_compute_Valid() const{
    return m_compute_isValid;
}

bool OAISimulationJob::isSet() const {
...
bool OAISimulationJob::isValid() const {
