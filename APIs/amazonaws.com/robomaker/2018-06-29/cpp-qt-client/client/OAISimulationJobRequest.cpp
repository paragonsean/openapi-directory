...
OAISimulationJobRequest::OAISimulationJobRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISimulationJobRequest::OAISimulationJobRequest() {
    this->initializeModel();
}

OAISimulationJobRequest::~OAISimulationJobRequest() {}

void OAISimulationJobRequest::initializeModel() {
...
void OAISimulationJobRequest::fromJson(QString jsonString) {
...
void OAISimulationJobRequest::fromJsonObject(QJsonObject json) {
...
QString OAISimulationJobRequest::asJson() const {
...
QJsonObject OAISimulationJobRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIOutputLocation OAISimulationJobRequest::getOutputLocation() const {
    return m_output_location;
}
void OAISimulationJobRequest::setOutputLocation(const OAIOutputLocation &output_location) {
    m_output_location = output_location;
    m_output_location_isSet = true;
}

bool OAISimulationJobRequest::is_output_location_Set() const{
    return m_output_location_isSet;
}

bool OAISimulationJobRequest::is_output_location_Valid() const{
    return m_output_location_isValid;
}

OAILoggingConfig OAISimulationJobRequest::getLoggingConfig() const {
    return m_logging_config;
}
void OAISimulationJobRequest::setLoggingConfig(const OAILoggingConfig &logging_config) {
    m_logging_config = logging_config;
    m_logging_config_isSet = true;
}

bool OAISimulationJobRequest::is_logging_config_Set() const{
    return m_logging_config_isSet;
}

bool OAISimulationJobRequest::is_logging_config_Valid() const{
    return m_logging_config_isValid;
}

qint32 OAISimulationJobRequest::getMaxJobDurationInSeconds() const {
    return m_max_job_duration_in_seconds;
}
void OAISimulationJobRequest::setMaxJobDurationInSeconds(const qint32 &max_job_duration_in_seconds) {
    m_max_job_duration_in_seconds = max_job_duration_in_seconds;
    m_max_job_duration_in_seconds_isSet = true;
}

bool OAISimulationJobRequest::is_max_job_duration_in_seconds_Set() const{
    return m_max_job_duration_in_seconds_isSet;
}

bool OAISimulationJobRequest::is_max_job_duration_in_seconds_Valid() const{
    return m_max_job_duration_in_seconds_isValid;
}

QString OAISimulationJobRequest::getIamRole() const {
    return m_iam_role;
}
void OAISimulationJobRequest::setIamRole(const QString &iam_role) {
    m_iam_role = iam_role;
    m_iam_role_isSet = true;
}

bool OAISimulationJobRequest::is_iam_role_Set() const{
    return m_iam_role_isSet;
}

bool OAISimulationJobRequest::is_iam_role_Valid() const{
    return m_iam_role_isValid;
}

OAIFailureBehavior OAISimulationJobRequest::getFailureBehavior() const {
    return m_failure_behavior;
}
void OAISimulationJobRequest::setFailureBehavior(const OAIFailureBehavior &failure_behavior) {
    m_failure_behavior = failure_behavior;
    m_failure_behavior_isSet = true;
}

bool OAISimulationJobRequest::is_failure_behavior_Set() const{
    return m_failure_behavior_isSet;
}

bool OAISimulationJobRequest::is_failure_behavior_Valid() const{
    return m_failure_behavior_isValid;
}

bool OAISimulationJobRequest::getUseDefaultApplications() const {
    return m_use_default_applications;
}
void OAISimulationJobRequest::setUseDefaultApplications(const bool &use_default_applications) {
    m_use_default_applications = use_default_applications;
    m_use_default_applications_isSet = true;
}

bool OAISimulationJobRequest::is_use_default_applications_Set() const{
    return m_use_default_applications_isSet;
}

bool OAISimulationJobRequest::is_use_default_applications_Valid() const{
    return m_use_default_applications_isValid;
}

QList OAISimulationJobRequest::getRobotApplications() const {
    return m_robot_applications;
}
void OAISimulationJobRequest::setRobotApplications(const QList &robot_applications) {
    m_robot_applications = robot_applications;
    m_robot_applications_isSet = true;
}

bool OAISimulationJobRequest::is_robot_applications_Set() const{
    return m_robot_applications_isSet;
}

bool OAISimulationJobRequest::is_robot_applications_Valid() const{
    return m_robot_applications_isValid;
}

QList OAISimulationJobRequest::getSimulationApplications() const {
    return m_simulation_applications;
}
void OAISimulationJobRequest::setSimulationApplications(const QList &simulation_applications) {
    m_simulation_applications = simulation_applications;
    m_simulation_applications_isSet = true;
}

bool OAISimulationJobRequest::is_simulation_applications_Set() const{
    return m_simulation_applications_isSet;
}

bool OAISimulationJobRequest::is_simulation_applications_Valid() const{
    return m_simulation_applications_isValid;
}

QList OAISimulationJobRequest::getDataSources() const {
    return m_data_sources;
}
void OAISimulationJobRequest::setDataSources(const QList &data_sources) {
    m_data_sources = data_sources;
    m_data_sources_isSet = true;
}

bool OAISimulationJobRequest::is_data_sources_Set() const{
    return m_data_sources_isSet;
}

bool OAISimulationJobRequest::is_data_sources_Valid() const{
    return m_data_sources_isValid;
}

OAIVPCConfig OAISimulationJobRequest::getVpcConfig() const {
    return m_vpc_config;
}
void OAISimulationJobRequest::setVpcConfig(const OAIVPCConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAISimulationJobRequest::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAISimulationJobRequest::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

OAISimulationJobRequest_compute OAISimulationJobRequest::getCompute() const {
    return m_compute;
}
void OAISimulationJobRequest::setCompute(const OAISimulationJobRequest_compute &compute) {
    m_compute = compute;
    m_compute_isSet = true;
}

bool OAISimulationJobRequest::is_compute_Set() const{
    return m_compute_isSet;
}

bool OAISimulationJobRequest::is_compute_Valid() const{
    return m_compute_isValid;
}

QMap OAISimulationJobRequest::getTags() const {
    return m_tags;
}
void OAISimulationJobRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAISimulationJobRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAISimulationJobRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAISimulationJobRequest::isSet() const {
...
bool OAISimulationJobRequest::isValid() const {
