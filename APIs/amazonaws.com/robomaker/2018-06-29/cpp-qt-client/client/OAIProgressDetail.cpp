...
OAIProgressDetail::OAIProgressDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProgressDetail::OAIProgressDetail() {
    this->initializeModel();
}

OAIProgressDetail::~OAIProgressDetail() {}

void OAIProgressDetail::initializeModel() {
...
void OAIProgressDetail::fromJson(QString jsonString) {
...
void OAIProgressDetail::fromJsonObject(QJsonObject json) {
...
QString OAIProgressDetail::asJson() const {
...
QJsonObject OAIProgressDetail::asJsonObject() const {
    QJsonObject obj;
...
OAIRobotDeploymentStep OAIProgressDetail::getCurrentProgress() const {
    return m_current_progress;
}
void OAIProgressDetail::setCurrentProgress(const OAIRobotDeploymentStep &current_progress) {
    m_current_progress = current_progress;
    m_current_progress_isSet = true;
}

bool OAIProgressDetail::is_current_progress_Set() const{
    return m_current_progress_isSet;
}

bool OAIProgressDetail::is_current_progress_Valid() const{
    return m_current_progress_isValid;
}

float OAIProgressDetail::getPercentDone() const {
    return m_percent_done;
}
void OAIProgressDetail::setPercentDone(const float &percent_done) {
    m_percent_done = percent_done;
    m_percent_done_isSet = true;
}

bool OAIProgressDetail::is_percent_done_Set() const{
    return m_percent_done_isSet;
}

bool OAIProgressDetail::is_percent_done_Valid() const{
    return m_percent_done_isValid;
}

qint32 OAIProgressDetail::getEstimatedTimeRemainingSeconds() const {
    return m_estimated_time_remaining_seconds;
}
void OAIProgressDetail::setEstimatedTimeRemainingSeconds(const qint32 &estimated_time_remaining_seconds) {
    m_estimated_time_remaining_seconds = estimated_time_remaining_seconds;
    m_estimated_time_remaining_seconds_isSet = true;
}

bool OAIProgressDetail::is_estimated_time_remaining_seconds_Set() const{
    return m_estimated_time_remaining_seconds_isSet;
}

bool OAIProgressDetail::is_estimated_time_remaining_seconds_Valid() const{
    return m_estimated_time_remaining_seconds_isValid;
}

QString OAIProgressDetail::getTargetResource() const {
    return m_target_resource;
}
void OAIProgressDetail::setTargetResource(const QString &target_resource) {
    m_target_resource = target_resource;
    m_target_resource_isSet = true;
}

bool OAIProgressDetail::is_target_resource_Set() const{
    return m_target_resource_isSet;
}

bool OAIProgressDetail::is_target_resource_Valid() const{
    return m_target_resource_isValid;
}

bool OAIProgressDetail::isSet() const {
...
bool OAIProgressDetail::isValid() const {
