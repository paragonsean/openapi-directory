...
#ifndef OAISyncDeploymentJobRequest_H
#define OAISyncDeploymentJobRequest_H
...
class OAISyncDeploymentJobRequest : public OAIObject {
public:
    OAISyncDeploymentJobRequest();
    OAISyncDeploymentJobRequest(QString json);
    ~OAISyncDeploymentJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISyncDeploymentJobRequest)

#endif // OAISyncDeploymentJobRequest_H
