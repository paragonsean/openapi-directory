...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://robomaker.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://robomaker.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-06-29/Javascript'
        };
