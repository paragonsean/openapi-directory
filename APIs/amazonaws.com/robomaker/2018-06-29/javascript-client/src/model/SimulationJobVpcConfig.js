...
/**
 * The SimulationJobVpcConfig model module.
 * @module model/SimulationJobVpcConfig
 * @version 2018-06-29
 */
class SimulationJobVpcConfig {
    /**
     * Constructs a new <code>SimulationJobVpcConfig</code>.
     * @alias module:model/SimulationJobVpcConfig
     * @implements module:model/VPCConfigResponse
     */
    constructor() { 
        VPCConfigResponse.initialize(this);
        SimulationJobVpcConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SimulationJobVpcConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimulationJobVpcConfig} obj Optional instance to populate.
     * @return {module:model/SimulationJobVpcConfig} The populated <code>SimulationJobVpcConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimulationJobVpcConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>SimulationJobVpcConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimulationJobVpcConfig</code>.
     */
 ...
 */
SimulationJobVpcConfig.prototype['subnets'] = undefined;

/**
 * @member {Array} securityGroups
 */
SimulationJobVpcConfig.prototype['securityGroups'] = undefined;

/**
 * @member {String} vpcId
 */
SimulationJobVpcConfig.prototype['vpcId'] = undefined;

/**
 * @member {Boolean} assignPublicIp
 */
SimulationJobVpcConfig.prototype['assignPublicIp'] = undefined;
...
export default SimulationJobVpcConfig;
