...
/**
 * The ListFleetsRequest model module.
 * @module model/ListFleetsRequest
 * @version 2018-06-29
 */
class ListFleetsRequest {
    /**
     * Constructs a new <code>ListFleetsRequest</code>.
     * @alias module:model/ListFleetsRequest
     */
    constructor() { 
        
        ListFleetsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFleetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFleetsRequest} obj Optional instance to populate.
     * @return {module:model/ListFleetsRequest} The populated <code>ListFleetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFleetsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFleetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFleetsRequest</code>.
     */
 ...
 */
ListFleetsRequest.prototype['nextToken'] = undefined;
 ...
 */
ListFleetsRequest.prototype['maxResults'] = undefined;
 ...
 */
ListFleetsRequest.prototype['filters'] = undefined;
...
export default ListFleetsRequest;
