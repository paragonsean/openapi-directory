...
/**
 * The WorldCount model module.
 * @module model/WorldCount
 * @version 2018-06-29
 */
class WorldCount {
    /**
     * Constructs a new <code>WorldCount</code>.
    ...
    /**
     * Constructs a <code>WorldCount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorldCount} obj Optional instance to populate.
     * @return {module:model/WorldCount} The populated <code>WorldCount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorldCount();
    ...
    /**
     * Validates the JSON data with respect to <code>WorldCount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorldCount</code>.
     */
