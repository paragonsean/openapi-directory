...
/**
 * The ListRobotsRequest model module.
 * @module model/ListRobotsRequest
 * @version 2018-06-29
 */
class ListRobotsRequest {
    /**
     * Constructs a new <code>ListRobotsRequest</code>.
     * @alias module:model/ListRobotsRequest
     */
    constructor() { 
        
        ListRobotsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRobotsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRobotsRequest} obj Optional instance to populate.
     * @return {module:model/ListRobotsRequest} The populated <code>ListRobotsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRobotsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRobotsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRobotsRequest</code>.
     */
 ...
 */
ListRobotsRequest.prototype['nextToken'] = undefined;
 ...
 */
ListRobotsRequest.prototype['maxResults'] = undefined;
 ...
 */
ListRobotsRequest.prototype['filters'] = undefined;
...
export default ListRobotsRequest;
