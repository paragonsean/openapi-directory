...
/**
 * The SimulationJobRequestCompute model module.
 * @module model/SimulationJobRequestCompute
 * @version 2018-06-29
 */
class SimulationJobRequestCompute {
    /**
     * Constructs a new <code>SimulationJobRequestCompute</code>.
     * @alias module:model/SimulationJobRequestCompute
     * @implements module:model/Compute
     */
    constructor() { 
        Compute.initialize(this);
        SimulationJobRequestCompute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SimulationJobRequestCompute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimulationJobRequestCompute} obj Optional instance to populate.
     * @return {module:model/SimulationJobRequestCompute} The populated <code>SimulationJobRequestCompute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimulationJobRequestCompute();
    ...
    /**
     * Validates the JSON data with respect to <code>SimulationJobRequestCompute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimulationJobRequestCompute</code>.
     */
 ...
 */
SimulationJobRequestCompute.prototype['simulationUnitLimit'] = undefined;

/**
 * @member {module:model/ComputeType} computeType
 */
SimulationJobRequestCompute.prototype['computeType'] = undefined;

/**
 * @member {Number} gpuUnitLimit
 */
SimulationJobRequestCompute.prototype['gpuUnitLimit'] = undefined;
...
export default SimulationJobRequestCompute;
