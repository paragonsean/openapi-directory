...
/**
 * The ListWorldGenerationJobsRequest model module.
 * @module model/ListWorldGenerationJobsRequest
 * @version 2018-06-29
 */
class ListWorldGenerationJobsRequest {
    /**
     * Constructs a new <code>ListWorldGenerationJobsRequest</code>.
     * @alias module:model/ListWorldGenerationJobsRequest
     */
    constructor() { 
        
        ListWorldGenerationJobsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListWorldGenerationJobsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListWorldGenerationJobsRequest} obj Optional instance to populate.
     * @return {module:model/ListWorldGenerationJobsRequest} The populated <code>ListWorldGenerationJobsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListWorldGenerationJobsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListWorldGenerationJobsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListWorldGenerationJobsRequest</code>.
     */
 ...
 */
ListWorldGenerationJobsRequest.prototype['nextToken'] = undefined;
 ...
 */
ListWorldGenerationJobsRequest.prototype['maxResults'] = undefined;

/**
 * Optional filters to limit results. You can use <code>status</code> and <code>templateId</code>.
 * @member {Array.<module:model/Filter>} filters
 */
ListWorldGenerationJobsRequest.prototype['filters'] = undefined;
...
export default ListWorldGenerationJobsRequest;
