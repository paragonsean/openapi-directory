...
/**
 * The DeploymentApplicationConfigLaunchConfig model module.
 * @module model/DeploymentApplicationConfigLaunchConfig
 * @version 2018-06-29
 */
class DeploymentApplicationConfigLaunchConfig {
    /**
     * Constructs a new <code>DeploymentApplicationConfigLaunchConfig</code>.
     * @alias module:model/DeploymentApplicationConfigLaunchConfig
     * @implements module:model/DeploymentLaunchConfig
    ...
    constructor(packageName, launchFile) { 
        ...
        DeploymentApplicationConfigLaunchConfig.initialize(this, packageName, launchFile);
    }
    ...
    /**
     * Constructs a <code>DeploymentApplicationConfigLaunchConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeploymentApplicationConfigLaunchConfig} obj Optional instance to populate.
     * @return {module:model/DeploymentApplicationConfigLaunchConfig} The populated <code>DeploymentApplicationConfigLaunchConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeploymentApplicationConfigLaunchConfig();
            DeploymentLaunchConfig.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DeploymentApplicationConfigLaunchConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeploymentApplicationConfigLaunchConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeploymentApplicationConfigLaunchConfig.RequiredProperties) {
...
DeploymentApplicationConfigLaunchConfig.RequiredProperties = ["packageName", "launchFile"];

/**
 * @member {String} packageName
 */
DeploymentApplicationConfigLaunchConfig.prototype['packageName'] = undefined;

/**
 * @member {String} preLaunchFile
 */
DeploymentApplicationConfigLaunchConfig.prototype['preLaunchFile'] = undefined;

/**
 * @member {String} launchFile
 */
DeploymentApplicationConfigLaunchConfig.prototype['launchFile'] = undefined;

/**
 * @member {String} postLaunchFile
 */
DeploymentApplicationConfigLaunchConfig.prototype['postLaunchFile'] = undefined;

/**
 * @member {Object} environmentVariables
 */
DeploymentApplicationConfigLaunchConfig.prototype['environmentVariables'] = undefined;


// Implement DeploymentLaunchConfig interface:
/**
 * @member {String} packageName
 */
...
export default DeploymentApplicationConfigLaunchConfig;
