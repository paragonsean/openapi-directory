...
/**
 * The ListSimulationJobBatchesRequest model module.
 * @module model/ListSimulationJobBatchesRequest
 * @version 2018-06-29
 */
class ListSimulationJobBatchesRequest {
    /**
     * Constructs a new <code>ListSimulationJobBatchesRequest</code>.
     * @alias module:model/ListSimulationJobBatchesRequest
     */
    constructor() { 
        
        ListSimulationJobBatchesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSimulationJobBatchesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSimulationJobBatchesRequest} obj Optional instance to populate.
     * @return {module:model/ListSimulationJobBatchesRequest} The populated <code>ListSimulationJobBatchesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSimulationJobBatchesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSimulationJobBatchesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSimulationJobBatchesRequest</code>.
     */
 ...
 */
ListSimulationJobBatchesRequest.prototype['nextToken'] = undefined;
 ...
 */
ListSimulationJobBatchesRequest.prototype['maxResults'] = undefined;

/**
 * Optional filters to limit results.
 * @member {Array.<module:model/Filter>} filters
 */
ListSimulationJobBatchesRequest.prototype['filters'] = undefined;
...
export default ListSimulationJobBatchesRequest;
