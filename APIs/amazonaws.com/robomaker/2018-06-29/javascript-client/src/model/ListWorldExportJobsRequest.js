...
/**
 * The ListWorldExportJobsRequest model module.
 * @module model/ListWorldExportJobsRequest
 * @version 2018-06-29
 */
class ListWorldExportJobsRequest {
    /**
     * Constructs a new <code>ListWorldExportJobsRequest</code>.
     * @alias module:model/ListWorldExportJobsRequest
     */
    constructor() { 
        
        ListWorldExportJobsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListWorldExportJobsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListWorldExportJobsRequest} obj Optional instance to populate.
     * @return {module:model/ListWorldExportJobsRequest} The populated <code>ListWorldExportJobsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListWorldExportJobsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListWorldExportJobsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListWorldExportJobsRequest</code>.
     */
 ...
 */
ListWorldExportJobsRequest.prototype['nextToken'] = undefined;
 ...
 */
ListWorldExportJobsRequest.prototype['maxResults'] = undefined;

/**
 * Optional filters to limit results. You can use <code>generationJobId</code> and <code>templateId</code>.
 * @member {Array.<module:model/Filter>} filters
 */
ListWorldExportJobsRequest.prototype['filters'] = undefined;
...
export default ListWorldExportJobsRequest;
