...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.DescribeSimulationJobResponseVpcConfig();
  });
  ...
  describe('DescribeSimulationJobResponseVpcConfig', function() {
    it('should create an instance of DescribeSimulationJobResponseVpcConfig', function() {
      // uncomment below and update the code to test DescribeSimulationJobResponseVpcConfig
      //var instance = new AwsRoboMaker.DescribeSimulationJobResponseVpcConfig();
      //expect(instance).to.be.a(AwsRoboMaker.DescribeSimulationJobResponseVpcConfig);
    });
