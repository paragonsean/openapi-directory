...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListWorldsRequest();
  });
  ...
  describe('ListWorldsRequest', function() {
    it('should create an instance of ListWorldsRequest', function() {
      // uncomment below and update the code to test ListWorldsRequest
      //var instance = new AwsRoboMaker.ListWorldsRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListWorldsRequest);
    });
