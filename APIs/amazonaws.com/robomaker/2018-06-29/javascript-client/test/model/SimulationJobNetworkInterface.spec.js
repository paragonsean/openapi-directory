...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.SimulationJobNetworkInterface();
  });
  ...
  describe('SimulationJobNetworkInterface', function() {
    it('should create an instance of SimulationJobNetworkInterface', function() {
      // uncomment below and update the code to test SimulationJobNetworkInterface
      //var instance = new AwsRoboMaker.SimulationJobNetworkInterface();
      //expect(instance).to.be.a(AwsRoboMaker.SimulationJobNetworkInterface);
    });
