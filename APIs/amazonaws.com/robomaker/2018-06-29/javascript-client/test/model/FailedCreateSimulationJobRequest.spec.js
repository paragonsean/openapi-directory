...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.FailedCreateSimulationJobRequest();
  });
  ...
  describe('FailedCreateSimulationJobRequest', function() {
    it('should create an instance of FailedCreateSimulationJobRequest', function() {
      // uncomment below and update the code to test FailedCreateSimulationJobRequest
      //var instance = new AwsRoboMaker.FailedCreateSimulationJobRequest();
      //expect(instance).to.be.a(AwsRoboMaker.FailedCreateSimulationJobRequest);
    });
