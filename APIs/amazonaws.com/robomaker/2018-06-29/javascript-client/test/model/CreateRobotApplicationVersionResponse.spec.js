...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.CreateRobotApplicationVersionResponse();
  });
  ...
  describe('CreateRobotApplicationVersionResponse', function() {
    it('should create an instance of CreateRobotApplicationVersionResponse', function() {
      // uncomment below and update the code to test CreateRobotApplicationVersionResponse
      //var instance = new AwsRoboMaker.CreateRobotApplicationVersionResponse();
      //expect(instance).to.be.a(AwsRoboMaker.CreateRobotApplicationVersionResponse);
    });
