...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListDeploymentJobsRequest();
  });
  ...
  describe('ListDeploymentJobsRequest', function() {
    it('should create an instance of ListDeploymentJobsRequest', function() {
      // uncomment below and update the code to test ListDeploymentJobsRequest
      //var instance = new AwsRoboMaker.ListDeploymentJobsRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListDeploymentJobsRequest);
    });
