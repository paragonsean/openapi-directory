...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListWorldGenerationJobsRequest();
  });
  ...
  describe('ListWorldGenerationJobsRequest', function() {
    it('should create an instance of ListWorldGenerationJobsRequest', function() {
      // uncomment below and update the code to test ListWorldGenerationJobsRequest
      //var instance = new AwsRoboMaker.ListWorldGenerationJobsRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListWorldGenerationJobsRequest);
    });
