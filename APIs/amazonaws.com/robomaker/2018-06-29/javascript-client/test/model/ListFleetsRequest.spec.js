...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListFleetsRequest();
  });
  ...
  describe('ListFleetsRequest', function() {
    it('should create an instance of ListFleetsRequest', function() {
      // uncomment below and update the code to test ListFleetsRequest
      //var instance = new AwsRoboMaker.ListFleetsRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListFleetsRequest);
    });
