...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.DescribeSimulationJobResponseNetworkInterface();
  });
  ...
  describe('DescribeSimulationJobResponseNetworkInterface', function() {
    it('should create an instance of DescribeSimulationJobResponseNetworkInterface', function() {
      // uncomment below and update the code to test DescribeSimulationJobResponseNetworkInterface
      //var instance = new AwsRoboMaker.DescribeSimulationJobResponseNetworkInterface();
      //expect(instance).to.be.a(AwsRoboMaker.DescribeSimulationJobResponseNetworkInterface);
    });
