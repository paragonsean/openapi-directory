...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.SyncDeploymentJobRequest();
  });
  ...
  describe('SyncDeploymentJobRequest', function() {
    it('should create an instance of SyncDeploymentJobRequest', function() {
      // uncomment below and update the code to test SyncDeploymentJobRequest
      //var instance = new AwsRoboMaker.SyncDeploymentJobRequest();
      //expect(instance).to.be.a(AwsRoboMaker.SyncDeploymentJobRequest);
    });
