...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListWorldExportJobsRequest();
  });
  ...
  describe('ListWorldExportJobsRequest', function() {
    it('should create an instance of ListWorldExportJobsRequest', function() {
      // uncomment below and update the code to test ListWorldExportJobsRequest
      //var instance = new AwsRoboMaker.ListWorldExportJobsRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListWorldExportJobsRequest);
    });
