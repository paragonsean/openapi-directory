...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListRobotsRequest();
  });
  ...
  describe('ListRobotsRequest', function() {
    it('should create an instance of ListRobotsRequest', function() {
      // uncomment below and update the code to test ListRobotsRequest
      //var instance = new AwsRoboMaker.ListRobotsRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListRobotsRequest);
    });
