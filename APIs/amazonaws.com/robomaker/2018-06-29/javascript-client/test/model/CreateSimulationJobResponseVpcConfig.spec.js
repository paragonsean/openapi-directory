...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.CreateSimulationJobResponseVpcConfig();
  });
  ...
  describe('CreateSimulationJobResponseVpcConfig', function() {
    it('should create an instance of CreateSimulationJobResponseVpcConfig', function() {
      // uncomment below and update the code to test CreateSimulationJobResponseVpcConfig
      //var instance = new AwsRoboMaker.CreateSimulationJobResponseVpcConfig();
      //expect(instance).to.be.a(AwsRoboMaker.CreateSimulationJobResponseVpcConfig);
    });
