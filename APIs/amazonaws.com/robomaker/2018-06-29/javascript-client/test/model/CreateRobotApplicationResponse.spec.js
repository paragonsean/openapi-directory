...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.CreateRobotApplicationResponse();
  });
  ...
  describe('CreateRobotApplicationResponse', function() {
    it('should create an instance of CreateRobotApplicationResponse', function() {
      // uncomment below and update the code to test CreateRobotApplicationResponse
      //var instance = new AwsRoboMaker.CreateRobotApplicationResponse();
      //expect(instance).to.be.a(AwsRoboMaker.CreateRobotApplicationResponse);
    });
