...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.DescribeRobotApplicationResponse();
  });
  ...
  describe('DescribeRobotApplicationResponse', function() {
    it('should create an instance of DescribeRobotApplicationResponse', function() {
      // uncomment below and update the code to test DescribeRobotApplicationResponse
      //var instance = new AwsRoboMaker.DescribeRobotApplicationResponse();
      //expect(instance).to.be.a(AwsRoboMaker.DescribeRobotApplicationResponse);
    });
