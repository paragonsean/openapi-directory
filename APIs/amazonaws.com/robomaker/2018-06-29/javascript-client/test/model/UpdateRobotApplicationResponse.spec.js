...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.UpdateRobotApplicationResponse();
  });
  ...
  describe('UpdateRobotApplicationResponse', function() {
    it('should create an instance of UpdateRobotApplicationResponse', function() {
      // uncomment below and update the code to test UpdateRobotApplicationResponse
      //var instance = new AwsRoboMaker.UpdateRobotApplicationResponse();
      //expect(instance).to.be.a(AwsRoboMaker.UpdateRobotApplicationResponse);
    });
