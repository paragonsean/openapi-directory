...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListSimulationJobsRequest();
  });
  ...
  describe('ListSimulationJobsRequest', function() {
    it('should create an instance of ListSimulationJobsRequest', function() {
      // uncomment below and update the code to test ListSimulationJobsRequest
      //var instance = new AwsRoboMaker.ListSimulationJobsRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListSimulationJobsRequest);
    });
