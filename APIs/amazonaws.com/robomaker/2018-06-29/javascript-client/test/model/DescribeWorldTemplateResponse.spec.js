...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.DescribeWorldTemplateResponse();
  });
  ...
  describe('DescribeWorldTemplateResponse', function() {
    it('should create an instance of DescribeWorldTemplateResponse', function() {
      // uncomment below and update the code to test DescribeWorldTemplateResponse
      //var instance = new AwsRoboMaker.DescribeWorldTemplateResponse();
      //expect(instance).to.be.a(AwsRoboMaker.DescribeWorldTemplateResponse);
    });
