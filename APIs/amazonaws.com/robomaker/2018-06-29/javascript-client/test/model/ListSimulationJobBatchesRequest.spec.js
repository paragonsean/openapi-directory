...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoboMaker.ListSimulationJobBatchesRequest();
  });
  ...
  describe('ListSimulationJobBatchesRequest', function() {
    it('should create an instance of ListSimulationJobBatchesRequest', function() {
      // uncomment below and update the code to test ListSimulationJobBatchesRequest
      //var instance = new AwsRoboMaker.ListSimulationJobBatchesRequest();
      //expect(instance).to.be.a(AwsRoboMaker.ListSimulationJobBatchesRequest);
    });
