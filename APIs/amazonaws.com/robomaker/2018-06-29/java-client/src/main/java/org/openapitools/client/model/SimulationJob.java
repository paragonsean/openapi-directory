...
public class SimulationJob {
  ...
  private SimulationJobVpcConfig vpcConfig;
  ...
  private SimulationJobNetworkInterface networkInterface;

  public static final String SERIALIZED_NAME_COMPUTE = "compute";
  @SerializedName(SERIALIZED_NAME_COMPUTE)
  private SimulationJobCompute compute;

  public SimulationJob() {
  }

  public SimulationJob arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public SimulationJob name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SimulationJob status(SimulationJobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SimulationJob lastStartedAt(OffsetDateTime lastStartedAt) {
  ...
  public SimulationJob lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public SimulationJob failureBehavior(FailureBehavior failureBehavior) {
  ...
  public SimulationJob failureCode(SimulationJobErrorCode failureCode) {
  ...
  public SimulationJob failureReason(String failureReason) {
  ...
  public SimulationJob clientRequestToken(String clientRequestToken) {
  ...
  public SimulationJob outputLocation(DescribeSimulationJobResponseOutputLocation outputLocation) {
  ...
  public SimulationJob loggingConfig(CreateSimulationJobResponseLoggingConfig loggingConfig) {
  ...
  public SimulationJob maxJobDurationInSeconds(Integer maxJobDurationInSeconds) {
  ...
  public SimulationJob simulationTimeMillis(Integer simulationTimeMillis) {
  ...
  public SimulationJob iamRole(String iamRole) {
  ...
  public SimulationJob robotApplications(List robotApplications) {
  ...
  public SimulationJob simulationApplications(List simulationApplications) {
  ...
  public SimulationJob dataSources(List dataSources) {
  ...
  public SimulationJob tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public SimulationJob vpcConfig(SimulationJobVpcConfig vpcConfig) {
   ...
   */
  @javax.annotation.Nullable
  public SimulationJobVpcConfig getVpcConfig() {
    return vpcConfig;
  }

  public void setVpcConfig(SimulationJobVpcConfig vpcConfig) {
    this.vpcConfig = vpcConfig;
  }


  public SimulationJob networkInterface(SimulationJobNetworkInterface networkInterface) {
   ...
   */
  @javax.annotation.Nullable
  public SimulationJobNetworkInterface getNetworkInterface() {
    return networkInterface;
  }

  public void setNetworkInterface(SimulationJobNetworkInterface networkInterface) {
    this.networkInterface = networkInterface;
  }


  public SimulationJob compute(SimulationJobCompute compute) {
   ...
   */
  @javax.annotation.Nullable
  public SimulationJobCompute getCompute() {
    return compute;
  }

  public void setCompute(SimulationJobCompute compute) {
    this.compute = compute;
  }
  ...
  public boolean equals(Object o) {
    ...
    SimulationJob simulationJob = (SimulationJob) o;
    return Objects.equals(this.arn, simulationJob.arn) &&
        Objects.equals(this.name, simulationJob.name) &&
        Objects.equals(this.status, simulationJob.status) &&
        Objects.equals(this.lastStartedAt, simulationJob.lastStartedAt) &&
        Objects.equals(this.lastUpdatedAt, simulationJob.lastUpdatedAt) &&
        Objects.equals(this.failureBehavior, simulationJob.failureBehavior) &&
        Objects.equals(this.failureCode, simulationJob.failureCode) &&
        Objects.equals(this.failureReason, simulationJob.failureReason) &&
        Objects.equals(this.clientRequestToken, simulationJob.clientRequestToken) &&
        Objects.equals(this.outputLocation, simulationJob.outputLocation) &&
        Objects.equals(this.loggingConfig, simulationJob.loggingConfig) &&
        Objects.equals(this.maxJobDurationInSeconds, simulationJob.maxJobDurationInSeconds) &&
        Objects.equals(this.simulationTimeMillis, simulationJob.simulationTimeMillis) &&
        Objects.equals(this.iamRole, simulationJob.iamRole) &&
        Objects.equals(this.robotApplications, simulationJob.robotApplications) &&
        Objects.equals(this.simulationApplications, simulationJob.simulationApplications) &&
        Objects.equals(this.dataSources, simulationJob.dataSources) &&
        Objects.equals(this.tags, simulationJob.tags) &&
        Objects.equals(this.vpcConfig, simulationJob.vpcConfig) &&
        Objects.equals(this.networkInterface, simulationJob.networkInterface) &&
        Objects.equals(this.compute, simulationJob.compute);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimulationJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimulationJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimulationJob is not found in the empty JSON string", SimulationJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimulationJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimulationJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimulationJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimulationJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimulationJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimulationJob.class));

       return (TypeAdapter<T>) new TypeAdapter<SimulationJob>() {
           @Override
           public void write(JsonWriter out, SimulationJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimulationJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SimulationJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SimulationJob
   * @throws IOException if the JSON string is invalid with respect to SimulationJob
   */
  public static SimulationJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimulationJob.class);
  }

  /**
   * Convert an instance of SimulationJob to an JSON string
   *
   * @return JSON string
   */
