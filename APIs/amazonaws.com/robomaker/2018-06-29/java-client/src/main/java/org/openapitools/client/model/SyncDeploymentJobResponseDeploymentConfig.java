...
public class SyncDeploymentJobResponseDeploymentConfig {
  ...
  public SyncDeploymentJobResponseDeploymentConfig() {
  }

  public SyncDeploymentJobResponseDeploymentConfig concurrentDeploymentPercentage(Integer concurrentDeploymentPercentage) {
  ...
  public SyncDeploymentJobResponseDeploymentConfig failureThresholdPercentage(Integer failureThresholdPercentage) {
  ...
  public SyncDeploymentJobResponseDeploymentConfig robotDeploymentTimeoutInSeconds(Integer robotDeploymentTimeoutInSeconds) {
  ...
  public SyncDeploymentJobResponseDeploymentConfig downloadConditionFile(CreateDeploymentJobRequestDeploymentConfigDownloadConditionFile downloadConditionFile) {
  ...
  public boolean equals(Object o) {
    ...
    SyncDeploymentJobResponseDeploymentConfig syncDeploymentJobResponseDeploymentConfig = (SyncDeploymentJobResponseDeploymentConfig) o;
    return Objects.equals(this.concurrentDeploymentPercentage, syncDeploymentJobResponseDeploymentConfig.concurrentDeploymentPercentage) &&
        Objects.equals(this.failureThresholdPercentage, syncDeploymentJobResponseDeploymentConfig.failureThresholdPercentage) &&
        Objects.equals(this.robotDeploymentTimeoutInSeconds, syncDeploymentJobResponseDeploymentConfig.robotDeploymentTimeoutInSeconds) &&
        Objects.equals(this.downloadConditionFile, syncDeploymentJobResponseDeploymentConfig.downloadConditionFile);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyncDeploymentJobResponseDeploymentConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SyncDeploymentJobResponseDeploymentConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SyncDeploymentJobResponseDeploymentConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncDeploymentJobResponseDeploymentConfig is not found in the empty JSON string", SyncDeploymentJobResponseDeploymentConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SyncDeploymentJobResponseDeploymentConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SyncDeploymentJobResponseDeploymentConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncDeploymentJobResponseDeploymentConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncDeploymentJobResponseDeploymentConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncDeploymentJobResponseDeploymentConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncDeploymentJobResponseDeploymentConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncDeploymentJobResponseDeploymentConfig>() {
           @Override
           public void write(JsonWriter out, SyncDeploymentJobResponseDeploymentConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SyncDeploymentJobResponseDeploymentConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SyncDeploymentJobResponseDeploymentConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SyncDeploymentJobResponseDeploymentConfig
   * @throws IOException if the JSON string is invalid with respect to SyncDeploymentJobResponseDeploymentConfig
   */
  public static SyncDeploymentJobResponseDeploymentConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncDeploymentJobResponseDeploymentConfig.class);
  }

  /**
   * Convert an instance of SyncDeploymentJobResponseDeploymentConfig to an JSON string
   *
   * @return JSON string
   */
