...
public class DeploymentLaunchConfig {
  ...
  public DeploymentLaunchConfig() {
  }

  public DeploymentLaunchConfig packageName(String packageName) {
  ...
  public DeploymentLaunchConfig preLaunchFile(String preLaunchFile) {
  ...
  public DeploymentLaunchConfig launchFile(String launchFile) {
  ...
  public DeploymentLaunchConfig postLaunchFile(String postLaunchFile) {
  ...
  public DeploymentLaunchConfig environmentVariables(Map environmentVariables) {
  ...
  public boolean equals(Object o) {
    ...
    DeploymentLaunchConfig deploymentLaunchConfig = (DeploymentLaunchConfig) o;
    return Objects.equals(this.packageName, deploymentLaunchConfig.packageName) &&
        Objects.equals(this.preLaunchFile, deploymentLaunchConfig.preLaunchFile) &&
        Objects.equals(this.launchFile, deploymentLaunchConfig.launchFile) &&
        Objects.equals(this.postLaunchFile, deploymentLaunchConfig.postLaunchFile) &&
        Objects.equals(this.environmentVariables, deploymentLaunchConfig.environmentVariables);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeploymentLaunchConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeploymentLaunchConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeploymentLaunchConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeploymentLaunchConfig is not found in the empty JSON string", DeploymentLaunchConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeploymentLaunchConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeploymentLaunchConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeploymentLaunchConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeploymentLaunchConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeploymentLaunchConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeploymentLaunchConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeploymentLaunchConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DeploymentLaunchConfig>() {
           @Override
           public void write(JsonWriter out, DeploymentLaunchConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeploymentLaunchConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeploymentLaunchConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeploymentLaunchConfig
   * @throws IOException if the JSON string is invalid with respect to DeploymentLaunchConfig
   */
  public static DeploymentLaunchConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeploymentLaunchConfig.class);
  }

  /**
   * Convert an instance of DeploymentLaunchConfig to an JSON string
   *
   * @return JSON string
   */
