...
public class SimulationJobRequest {
  ...
  public SimulationJobRequest() {
  }

  public SimulationJobRequest outputLocation(OutputLocation outputLocation) {
  ...
  public SimulationJobRequest loggingConfig(LoggingConfig loggingConfig) {
  ...
  public SimulationJobRequest maxJobDurationInSeconds(Integer maxJobDurationInSeconds) {
  ...
  public SimulationJobRequest iamRole(String iamRole) {
  ...
  public SimulationJobRequest failureBehavior(FailureBehavior failureBehavior) {
  ...
  public SimulationJobRequest useDefaultApplications(Boolean useDefaultApplications) {
  ...
  public SimulationJobRequest robotApplications(List robotApplications) {
  ...
  public SimulationJobRequest simulationApplications(List simulationApplications) {
  ...
  public SimulationJobRequest dataSources(List dataSources) {
  ...
  public SimulationJobRequest vpcConfig(VPCConfig vpcConfig) {
  ...
  public SimulationJobRequest compute(SimulationJobRequestCompute compute) {
  ...
  public SimulationJobRequest tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SimulationJobRequest simulationJobRequest = (SimulationJobRequest) o;
    return Objects.equals(this.outputLocation, simulationJobRequest.outputLocation) &&
        Objects.equals(this.loggingConfig, simulationJobRequest.loggingConfig) &&
        Objects.equals(this.maxJobDurationInSeconds, simulationJobRequest.maxJobDurationInSeconds) &&
        Objects.equals(this.iamRole, simulationJobRequest.iamRole) &&
        Objects.equals(this.failureBehavior, simulationJobRequest.failureBehavior) &&
        Objects.equals(this.useDefaultApplications, simulationJobRequest.useDefaultApplications) &&
        Objects.equals(this.robotApplications, simulationJobRequest.robotApplications) &&
        Objects.equals(this.simulationApplications, simulationJobRequest.simulationApplications) &&
        Objects.equals(this.dataSources, simulationJobRequest.dataSources) &&
        Objects.equals(this.vpcConfig, simulationJobRequest.vpcConfig) &&
        Objects.equals(this.compute, simulationJobRequest.compute) &&
        Objects.equals(this.tags, simulationJobRequest.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class SimulationJobRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimulationJobRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimulationJobRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimulationJobRequest is not found in the empty JSON string", SimulationJobRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimulationJobRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimulationJobRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimulationJobRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimulationJobRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimulationJobRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimulationJobRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimulationJobRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SimulationJobRequest>() {
           @Override
           public void write(JsonWriter out, SimulationJobRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimulationJobRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SimulationJobRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SimulationJobRequest
   * @throws IOException if the JSON string is invalid with respect to SimulationJobRequest
   */
  public static SimulationJobRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimulationJobRequest.class);
  }

  /**
   * Convert an instance of SimulationJobRequest to an JSON string
   *
   * @return JSON string
   */
