...
public class RobotApplicationConfig {
  ...
  private RobotApplicationConfigLaunchConfig launchConfig;
  ...
  public RobotApplicationConfig() {
  }

  public RobotApplicationConfig application(String application) {
  ...
  public RobotApplicationConfig applicationVersion(String applicationVersion) {
  ...
  public RobotApplicationConfig launchConfig(RobotApplicationConfigLaunchConfig launchConfig) {
   ...
   */
  @javax.annotation.Nonnull
  public RobotApplicationConfigLaunchConfig getLaunchConfig() {
    return launchConfig;
  }

  public void setLaunchConfig(RobotApplicationConfigLaunchConfig launchConfig) {
    this.launchConfig = launchConfig;
  }


  public RobotApplicationConfig uploadConfigurations(List uploadConfigurations) {
  ...
  public RobotApplicationConfig useDefaultUploadConfigurations(Boolean useDefaultUploadConfigurations) {
  ...
  public RobotApplicationConfig tools(List tools) {
    this.tools = tools;
    return this;
  }
  ...
  public RobotApplicationConfig useDefaultTools(Boolean useDefaultTools) {
  ...
  public boolean equals(Object o) {
    ...
    RobotApplicationConfig robotApplicationConfig = (RobotApplicationConfig) o;
    return Objects.equals(this.application, robotApplicationConfig.application) &&
        Objects.equals(this.applicationVersion, robotApplicationConfig.applicationVersion) &&
        Objects.equals(this.launchConfig, robotApplicationConfig.launchConfig) &&
        Objects.equals(this.uploadConfigurations, robotApplicationConfig.uploadConfigurations) &&
        Objects.equals(this.useDefaultUploadConfigurations, robotApplicationConfig.useDefaultUploadConfigurations) &&
        Objects.equals(this.tools, robotApplicationConfig.tools) &&
        Objects.equals(this.useDefaultTools, robotApplicationConfig.useDefaultTools);
  }

  @Override
  public int hashCode() {
    return Objects.hash(application, applicationVersion, launchConfig, uploadConfigurations, useDefaultUploadConfigurations, tools, useDefaultTools);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RobotApplicationConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RobotApplicationConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RobotApplicationConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RobotApplicationConfig is not found in the empty JSON string", RobotApplicationConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RobotApplicationConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RobotApplicationConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RobotApplicationConfig.openapiRequiredFields) {
      ...
      RobotApplicationConfigLaunchConfig.validateJsonElement(jsonObj.get("launchConfig"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RobotApplicationConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RobotApplicationConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RobotApplicationConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RobotApplicationConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<RobotApplicationConfig>() {
           @Override
           public void write(JsonWriter out, RobotApplicationConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RobotApplicationConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RobotApplicationConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RobotApplicationConfig
   * @throws IOException if the JSON string is invalid with respect to RobotApplicationConfig
   */
  public static RobotApplicationConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RobotApplicationConfig.class);
  }

  /**
   * Convert an instance of RobotApplicationConfig to an JSON string
   *
   * @return JSON string
   */
