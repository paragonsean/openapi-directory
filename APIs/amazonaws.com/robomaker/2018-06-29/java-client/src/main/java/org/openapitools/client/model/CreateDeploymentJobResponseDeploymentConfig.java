...
public class CreateDeploymentJobResponseDeploymentConfig {
  ...
  public CreateDeploymentJobResponseDeploymentConfig() {
  }

  public CreateDeploymentJobResponseDeploymentConfig concurrentDeploymentPercentage(Integer concurrentDeploymentPercentage) {
  ...
  public CreateDeploymentJobResponseDeploymentConfig failureThresholdPercentage(Integer failureThresholdPercentage) {
  ...
  public CreateDeploymentJobResponseDeploymentConfig robotDeploymentTimeoutInSeconds(Integer robotDeploymentTimeoutInSeconds) {
  ...
  public CreateDeploymentJobResponseDeploymentConfig downloadConditionFile(CreateDeploymentJobRequestDeploymentConfigDownloadConditionFile downloadConditionFile) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDeploymentJobResponseDeploymentConfig createDeploymentJobResponseDeploymentConfig = (CreateDeploymentJobResponseDeploymentConfig) o;
    return Objects.equals(this.concurrentDeploymentPercentage, createDeploymentJobResponseDeploymentConfig.concurrentDeploymentPercentage) &&
        Objects.equals(this.failureThresholdPercentage, createDeploymentJobResponseDeploymentConfig.failureThresholdPercentage) &&
        Objects.equals(this.robotDeploymentTimeoutInSeconds, createDeploymentJobResponseDeploymentConfig.robotDeploymentTimeoutInSeconds) &&
        Objects.equals(this.downloadConditionFile, createDeploymentJobResponseDeploymentConfig.downloadConditionFile);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDeploymentJobResponseDeploymentConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDeploymentJobResponseDeploymentConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDeploymentJobResponseDeploymentConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDeploymentJobResponseDeploymentConfig is not found in the empty JSON string", CreateDeploymentJobResponseDeploymentConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDeploymentJobResponseDeploymentConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDeploymentJobResponseDeploymentConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDeploymentJobResponseDeploymentConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDeploymentJobResponseDeploymentConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDeploymentJobResponseDeploymentConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDeploymentJobResponseDeploymentConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDeploymentJobResponseDeploymentConfig>() {
           @Override
           public void write(JsonWriter out, CreateDeploymentJobResponseDeploymentConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDeploymentJobResponseDeploymentConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDeploymentJobResponseDeploymentConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDeploymentJobResponseDeploymentConfig
   * @throws IOException if the JSON string is invalid with respect to CreateDeploymentJobResponseDeploymentConfig
   */
  public static CreateDeploymentJobResponseDeploymentConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDeploymentJobResponseDeploymentConfig.class);
  }

  /**
   * Convert an instance of CreateDeploymentJobResponseDeploymentConfig to an JSON string
   *
   * @return JSON string
   */
