...
|**filters** | [**List&lt;Filter&gt;**](Filter.md) | &lt;p&gt;Optional list of filters to limit results.&lt;/p&gt; &lt;p&gt;The filter name &lt;code&gt;name&lt;/code&gt; is supported. When filtering, you must use the complete value of the filtered item. You can use up to three filters.&lt;/p&gt; |  [optional] |
