...
class ReplacementEmailContent(Model):
    ...
    def __init__(self, replacement_template: ReplacementEmailContentReplacementTemplate=None):
        """ReplacementEmailContent - a model defined in OpenAPI

        :param replacement_template: The replacement_template of this ReplacementEmailContent.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReplacementEmailContent':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ReplacementEmailContent of this ReplacementEmailContent.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def replacement_template(self):
        """Gets the replacement_template of this ReplacementEmailContent.


        :return: The replacement_template of this ReplacementEmailContent.
    ...
    def replacement_template(self, replacement_template):
        """Sets the replacement_template of this ReplacementEmailContent.
