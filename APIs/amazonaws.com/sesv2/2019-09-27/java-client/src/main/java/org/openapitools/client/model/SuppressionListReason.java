 ...
 */
@JsonAdapter(SuppressionListReason.Adapter.class)
public enum SuppressionListReason {
  ...
  SuppressionListReason(String value) {
    this.value = value;
  }
  ...
  public static SuppressionListReason fromValue(String value) {
    for (SuppressionListReason b : SuppressionListReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<SuppressionListReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final SuppressionListReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SuppressionListReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SuppressionListReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SuppressionListReason.fromValue(value);
  }
}
