...
public class ListContactsRequest {
  ...
  private ListContactsRequestFilter filter;

  public ListContactsRequest() {
  }

  public ListContactsRequest filter(ListContactsRequestFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ListContactsRequestFilter getFilter() {
    return filter;
  }

  public void setFilter(ListContactsRequestFilter filter) {
    this.filter = filter;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Filter") != null && !jsonObj.get("Filter").isJsonNull()) {
        ListContactsRequestFilter.validateJsonElement(jsonObj.get("Filter"));
      }
  }
