...
|------------ | ------------- | ------------- | -------------|
|**filter** | **Map&lt;String, String&gt;** | An object that contains mapping between &lt;code&gt;ListRecommendationsFilterKey&lt;/code&gt; and &lt;code&gt;ListRecommendationFilterValue&lt;/code&gt; to filter by. |  [optional] |
