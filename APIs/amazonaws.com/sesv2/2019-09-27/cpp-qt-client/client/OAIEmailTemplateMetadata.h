...
/*
 * OAIEmailTemplateMetadata.h
 *
 * Contains information about an email template.
 */

#ifndef OAIEmailTemplateMetadata_H
#define OAIEmailTemplateMetadata_H
...
class OAIEmailTemplateMetadata : public OAIObject {
public:
    OAIEmailTemplateMetadata();
    OAIEmailTemplateMetadata(QString json);
    ~OAIEmailTemplateMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailTemplateMetadata)

#endif // OAIEmailTemplateMetadata_H
