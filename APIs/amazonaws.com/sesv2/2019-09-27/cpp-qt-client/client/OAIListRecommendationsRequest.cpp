...
QMap OAIListRecommendationsRequest::getFilter() const {
    return m_filter;
}
void OAIListRecommendationsRequest::setFilter(const QMap &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIListRecommendationsRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIListRecommendationsRequest::is_filter_Valid() const{
...
qint32 OAIListRecommendationsRequest::getPageSize() const {
    return m_page_size;
}
void OAIListRecommendationsRequest::setPageSize(const qint32 &page_size) {
    m_page_size = page_size;
    m_page_size_isSet = true;
}

bool OAIListRecommendationsRequest::is_page_size_Set() const{
    return m_page_size_isSet;
}

bool OAIListRecommendationsRequest::is_page_size_Valid() const{
