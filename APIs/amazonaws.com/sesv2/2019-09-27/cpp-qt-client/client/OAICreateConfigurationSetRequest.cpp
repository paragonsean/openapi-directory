...
OAISuppressionOptions OAICreateConfigurationSetRequest::getSuppressionOptions() const {
    return m_suppression_options;
}
void OAICreateConfigurationSetRequest::setSuppressionOptions(const OAISuppressionOptions &suppression_options) {
    m_suppression_options = suppression_options;
    m_suppression_options_isSet = true;
}

bool OAICreateConfigurationSetRequest::is_suppression_options_Set() const{
    return m_suppression_options_isSet;
}

bool OAICreateConfigurationSetRequest::is_suppression_options_Valid() const{
    return m_suppression_options_isValid;
}

OAICreateConfigurationSetRequest_VdmOptions OAICreateConfigurationSetRequest::getVdmOptions() const {
    return m_vdm_options;
}
void OAICreateConfigurationSetRequest::setVdmOptions(const OAICreateConfigurationSetRequest_VdmOptions &vdm_options) {
    m_vdm_options = vdm_options;
    m_vdm_options_isSet = true;
}

bool OAICreateConfigurationSetRequest::is_vdm_options_Set() const{
    return m_vdm_options_isSet;
}

bool OAICreateConfigurationSetRequest::is_vdm_options_Valid() const{
