...
#include "OAISendBulkEmailRequest.h"
...
OAISendBulkEmailRequest::OAISendBulkEmailRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendBulkEmailRequest::OAISendBulkEmailRequest() {
    this->initializeModel();
}

OAISendBulkEmailRequest::~OAISendBulkEmailRequest() {}

void OAISendBulkEmailRequest::initializeModel() {
...
void OAISendBulkEmailRequest::fromJson(QString jsonString) {
...
void OAISendBulkEmailRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendBulkEmailRequest::asJson() const {
...
QJsonObject OAISendBulkEmailRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISendBulkEmailRequest::getFromEmailAddress() const {
    return m_from_email_address;
}
void OAISendBulkEmailRequest::setFromEmailAddress(const QString &from_email_address) {
    m_from_email_address = from_email_address;
    m_from_email_address_isSet = true;
}

bool OAISendBulkEmailRequest::is_from_email_address_Set() const{
    return m_from_email_address_isSet;
}

bool OAISendBulkEmailRequest::is_from_email_address_Valid() const{
    return m_from_email_address_isValid;
}

QString OAISendBulkEmailRequest::getFromEmailAddressIdentityArn() const {
    return m_from_email_address_identity_arn;
}
void OAISendBulkEmailRequest::setFromEmailAddressIdentityArn(const QString &from_email_address_identity_arn) {
    m_from_email_address_identity_arn = from_email_address_identity_arn;
    m_from_email_address_identity_arn_isSet = true;
}

bool OAISendBulkEmailRequest::is_from_email_address_identity_arn_Set() const{
    return m_from_email_address_identity_arn_isSet;
}

bool OAISendBulkEmailRequest::is_from_email_address_identity_arn_Valid() const{
    return m_from_email_address_identity_arn_isValid;
}

QList OAISendBulkEmailRequest::getReplyToAddresses() const {
    return m_reply_to_addresses;
}
void OAISendBulkEmailRequest::setReplyToAddresses(const QList &reply_to_addresses) {
    m_reply_to_addresses = reply_to_addresses;
    m_reply_to_addresses_isSet = true;
}

bool OAISendBulkEmailRequest::is_reply_to_addresses_Set() const{
    return m_reply_to_addresses_isSet;
}

bool OAISendBulkEmailRequest::is_reply_to_addresses_Valid() const{
    return m_reply_to_addresses_isValid;
}

QString OAISendBulkEmailRequest::getFeedbackForwardingEmailAddress() const {
    return m_feedback_forwarding_email_address;
}
void OAISendBulkEmailRequest::setFeedbackForwardingEmailAddress(const QString &feedback_forwarding_email_address) {
    m_feedback_forwarding_email_address = feedback_forwarding_email_address;
    m_feedback_forwarding_email_address_isSet = true;
}

bool OAISendBulkEmailRequest::is_feedback_forwarding_email_address_Set() const{
    return m_feedback_forwarding_email_address_isSet;
}

bool OAISendBulkEmailRequest::is_feedback_forwarding_email_address_Valid() const{
    return m_feedback_forwarding_email_address_isValid;
}

QString OAISendBulkEmailRequest::getFeedbackForwardingEmailAddressIdentityArn() const {
    return m_feedback_forwarding_email_address_identity_arn;
}
void OAISendBulkEmailRequest::setFeedbackForwardingEmailAddressIdentityArn(const QString &feedback_forwarding_email_address_identity_arn) {
...
bool OAISendBulkEmailRequest::is_feedback_forwarding_email_address_identity_arn_Set() const{
    return m_feedback_forwarding_email_address_identity_arn_isSet;
}

bool OAISendBulkEmailRequest::is_feedback_forwarding_email_address_identity_arn_Valid() const{
    return m_feedback_forwarding_email_address_identity_arn_isValid;
}

QList OAISendBulkEmailRequest::getDefaultEmailTags() const {
    return m_default_email_tags;
}
void OAISendBulkEmailRequest::setDefaultEmailTags(const QList &default_email_tags) {
    m_default_email_tags = default_email_tags;
    m_default_email_tags_isSet = true;
}

bool OAISendBulkEmailRequest::is_default_email_tags_Set() const{
    return m_default_email_tags_isSet;
}

bool OAISendBulkEmailRequest::is_default_email_tags_Valid() const{
    return m_default_email_tags_isValid;
}

OAISendBulkEmailRequest_DefaultContent OAISendBulkEmailRequest::getDefaultContent() const {
    return m_default_content;
}
void OAISendBulkEmailRequest::setDefaultContent(const OAISendBulkEmailRequest_DefaultContent &default_content) {
    m_default_content = default_content;
    m_default_content_isSet = true;
}

bool OAISendBulkEmailRequest::is_default_content_Set() const{
    return m_default_content_isSet;
}

bool OAISendBulkEmailRequest::is_default_content_Valid() const{
    return m_default_content_isValid;
}

QList OAISendBulkEmailRequest::getBulkEmailEntries() const {
    return m_bulk_email_entries;
}
void OAISendBulkEmailRequest::setBulkEmailEntries(const QList &bulk_email_entries) {
    m_bulk_email_entries = bulk_email_entries;
    m_bulk_email_entries_isSet = true;
}

bool OAISendBulkEmailRequest::is_bulk_email_entries_Set() const{
    return m_bulk_email_entries_isSet;
}

bool OAISendBulkEmailRequest::is_bulk_email_entries_Valid() const{
    return m_bulk_email_entries_isValid;
}

QString OAISendBulkEmailRequest::getConfigurationSetName() const {
    return m_configuration_set_name;
}
void OAISendBulkEmailRequest::setConfigurationSetName(const QString &configuration_set_name) {
    m_configuration_set_name = configuration_set_name;
    m_configuration_set_name_isSet = true;
}

bool OAISendBulkEmailRequest::is_configuration_set_name_Set() const{
    return m_configuration_set_name_isSet;
}

bool OAISendBulkEmailRequest::is_configuration_set_name_Valid() const{
    return m_configuration_set_name_isValid;
}

bool OAISendBulkEmailRequest::isSet() const {
...
bool OAISendBulkEmailRequest::isValid() const {
