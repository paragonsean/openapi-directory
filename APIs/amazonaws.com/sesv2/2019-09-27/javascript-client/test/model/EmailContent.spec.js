...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleEmailService.EmailContent();
  });
  ...
  describe('EmailContent', function() {
    it('should create an instance of EmailContent', function() {
      ...
      //var instance = new AmazonSimpleEmailService.EmailContent();
      //expect(instance).to.be.a(AmazonSimpleEmailService.EmailContent);
    });
