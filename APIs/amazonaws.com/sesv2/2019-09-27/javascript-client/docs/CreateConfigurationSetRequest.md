# AmazonSimpleEmailService.CreateConfigurationSetRequest
...
**tags** | [**[Tag]**](Tag.md) | An array of objects that define the tags (keys and values) to associate with the configuration set. | [optional] 
