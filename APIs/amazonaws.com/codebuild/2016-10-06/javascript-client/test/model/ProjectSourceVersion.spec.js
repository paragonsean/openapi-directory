...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ProjectSourceVersion();
  });
  ...
  describe('ProjectSourceVersion', function() {
    it('should create an instance of ProjectSourceVersion', function() {
      // uncomment below and update the code to test ProjectSourceVersion
      //var instance = new AwsCodeBuild.ProjectSourceVersion();
      //expect(instance).to.be.a(AwsCodeBuild.ProjectSourceVersion);
    });
