...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.S3ReportExportConfig();
  });
  ...
  describe('S3ReportExportConfig', function() {
    it('should create an instance of S3ReportExportConfig', function() {
      // uncomment below and update the code to test S3ReportExportConfig
      //var instance = new AwsCodeBuild.S3ReportExportConfig();
      //expect(instance).to.be.a(AwsCodeBuild.S3ReportExportConfig);
    });
