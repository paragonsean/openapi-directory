...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.CreateProjectInput();
  });
  ...
  describe('CreateProjectInput', function() {
    it('should create an instance of CreateProjectInput', function() {
      // uncomment below and update the code to test CreateProjectInput
      //var instance = new AwsCodeBuild.CreateProjectInput();
      //expect(instance).to.be.a(AwsCodeBuild.CreateProjectInput);
    });
