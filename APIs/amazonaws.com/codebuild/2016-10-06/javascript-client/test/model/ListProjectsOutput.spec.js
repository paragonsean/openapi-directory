...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListProjectsOutput();
  });
  ...
  describe('ListProjectsOutput', function() {
    it('should create an instance of ListProjectsOutput', function() {
      // uncomment below and update the code to test ListProjectsOutput
      //var instance = new AwsCodeBuild.ListProjectsOutput();
      //expect(instance).to.be.a(AwsCodeBuild.ListProjectsOutput);
    });
