...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.CreateProjectInputSource();
  });
  ...
  describe('CreateProjectInputSource', function() {
    it('should create an instance of CreateProjectInputSource', function() {
      // uncomment below and update the code to test CreateProjectInputSource
      //var instance = new AwsCodeBuild.CreateProjectInputSource();
      //expect(instance).to.be.a(AwsCodeBuild.CreateProjectInputSource);
    });
