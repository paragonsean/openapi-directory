...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ReportGroupTrendStats();
  });
  ...
  describe('ReportGroupTrendStats', function() {
    it('should create an instance of ReportGroupTrendStats', function() {
      // uncomment below and update the code to test ReportGroupTrendStats
      //var instance = new AwsCodeBuild.ReportGroupTrendStats();
      //expect(instance).to.be.a(AwsCodeBuild.ReportGroupTrendStats);
    });
