...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.SourceCredentialsInfo();
  });
  ...
  describe('SourceCredentialsInfo', function() {
    it('should create an instance of SourceCredentialsInfo', function() {
      // uncomment below and update the code to test SourceCredentialsInfo
      //var instance = new AwsCodeBuild.SourceCredentialsInfo();
      //expect(instance).to.be.a(AwsCodeBuild.SourceCredentialsInfo);
    });
