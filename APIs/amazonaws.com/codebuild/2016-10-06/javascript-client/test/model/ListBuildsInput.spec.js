...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListBuildsInput();
  });
  ...
  describe('ListBuildsInput', function() {
    it('should create an instance of ListBuildsInput', function() {
      // uncomment below and update the code to test ListBuildsInput
      //var instance = new AwsCodeBuild.ListBuildsInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListBuildsInput);
    });
