...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ProjectSource();
  });
  ...
  describe('ProjectSource', function() {
    it('should create an instance of ProjectSource', function() {
      // uncomment below and update the code to test ProjectSource
      //var instance = new AwsCodeBuild.ProjectSource();
      //expect(instance).to.be.a(AwsCodeBuild.ProjectSource);
    });
