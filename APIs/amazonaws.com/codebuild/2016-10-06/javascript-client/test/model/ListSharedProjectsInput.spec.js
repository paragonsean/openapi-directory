...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListSharedProjectsInput();
  });
  ...
  describe('ListSharedProjectsInput', function() {
    it('should create an instance of ListSharedProjectsInput', function() {
      // uncomment below and update the code to test ListSharedProjectsInput
      //var instance = new AwsCodeBuild.ListSharedProjectsInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListSharedProjectsInput);
    });
