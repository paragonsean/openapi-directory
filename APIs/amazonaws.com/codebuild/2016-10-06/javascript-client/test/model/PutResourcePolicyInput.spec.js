...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.PutResourcePolicyInput();
  });
  ...
  describe('PutResourcePolicyInput', function() {
    it('should create an instance of PutResourcePolicyInput', function() {
      // uncomment below and update the code to test PutResourcePolicyInput
      //var instance = new AwsCodeBuild.PutResourcePolicyInput();
      //expect(instance).to.be.a(AwsCodeBuild.PutResourcePolicyInput);
    });
