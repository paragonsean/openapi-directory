...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListReportsOutput();
  });
  ...
  describe('ListReportsOutput', function() {
    it('should create an instance of ListReportsOutput', function() {
      // uncomment below and update the code to test ListReportsOutput
      //var instance = new AwsCodeBuild.ListReportsOutput();
      //expect(instance).to.be.a(AwsCodeBuild.ListReportsOutput);
    });
