...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListProjectsInput();
  });
  ...
  describe('ListProjectsInput', function() {
    it('should create an instance of ListProjectsInput', function() {
      // uncomment below and update the code to test ListProjectsInput
      //var instance = new AwsCodeBuild.ListProjectsInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListProjectsInput);
    });
