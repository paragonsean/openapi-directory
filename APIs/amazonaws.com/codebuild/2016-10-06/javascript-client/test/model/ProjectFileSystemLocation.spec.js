...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ProjectFileSystemLocation();
  });
  ...
  describe('ProjectFileSystemLocation', function() {
    it('should create an instance of ProjectFileSystemLocation', function() {
      // uncomment below and update the code to test ProjectFileSystemLocation
      //var instance = new AwsCodeBuild.ProjectFileSystemLocation();
      //expect(instance).to.be.a(AwsCodeBuild.ProjectFileSystemLocation);
    });
