...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.StartBuildBatchOutputBuildBatch();
  });
  ...
  describe('StartBuildBatchOutputBuildBatch', function() {
    it('should create an instance of StartBuildBatchOutputBuildBatch', function() {
      // uncomment below and update the code to test StartBuildBatchOutputBuildBatch
      //var instance = new AwsCodeBuild.StartBuildBatchOutputBuildBatch();
      //expect(instance).to.be.a(AwsCodeBuild.StartBuildBatchOutputBuildBatch);
    });
