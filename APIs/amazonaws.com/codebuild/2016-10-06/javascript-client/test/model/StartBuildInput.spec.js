...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.StartBuildInput();
  });
  ...
  describe('StartBuildInput', function() {
    it('should create an instance of StartBuildInput', function() {
      // uncomment below and update the code to test StartBuildInput
      //var instance = new AwsCodeBuild.StartBuildInput();
      //expect(instance).to.be.a(AwsCodeBuild.StartBuildInput);
    });
    ...
    it('should have the property reportBuildStatusOverride (base name: "reportBuildStatusOverride")', function() {
      // uncomment below and update the code to test the property reportBuildStatusOverride
      //var instance = new AwsCodeBuild.StartBuildInput();
      //expect(instance).to.be();
    });

    it('should have the property buildStatusConfigOverride (base name: "buildStatusConfigOverride")', function() {
      // uncomment below and update the code to test the property buildStatusConfigOverride
      //var instance = new AwsCodeBuild.StartBuildInput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property timeoutInMinutesOverride (base name: "timeoutInMinutesOverride")', function() {
      // uncomment below and update the code to test the property timeoutInMinutesOverride
      //var instance = new AwsCodeBuild.StartBuildInput();
      //expect(instance).to.be();
    });
