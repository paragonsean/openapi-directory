...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.DescribeTestCasesOutput();
  });
  ...
  describe('DescribeTestCasesOutput', function() {
    it('should create an instance of DescribeTestCasesOutput', function() {
      // uncomment below and update the code to test DescribeTestCasesOutput
      //var instance = new AwsCodeBuild.DescribeTestCasesOutput();
      //expect(instance).to.be.a(AwsCodeBuild.DescribeTestCasesOutput);
    });
