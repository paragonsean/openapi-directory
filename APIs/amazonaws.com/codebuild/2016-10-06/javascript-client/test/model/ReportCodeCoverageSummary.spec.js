...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ReportCodeCoverageSummary();
  });
  ...
  describe('ReportCodeCoverageSummary', function() {
    it('should create an instance of ReportCodeCoverageSummary', function() {
      // uncomment below and update the code to test ReportCodeCoverageSummary
      //var instance = new AwsCodeBuild.ReportCodeCoverageSummary();
      //expect(instance).to.be.a(AwsCodeBuild.ReportCodeCoverageSummary);
    });
