...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListBuildBatchesForProjectInput();
  });
  ...
  describe('ListBuildBatchesForProjectInput', function() {
    it('should create an instance of ListBuildBatchesForProjectInput', function() {
      // uncomment below and update the code to test ListBuildBatchesForProjectInput
      //var instance = new AwsCodeBuild.ListBuildBatchesForProjectInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListBuildBatchesForProjectInput);
    });
