...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.CreateProjectOutputProject();
  });
  ...
  describe('CreateProjectOutputProject', function() {
    it('should create an instance of CreateProjectOutputProject', function() {
      // uncomment below and update the code to test CreateProjectOutputProject
      //var instance = new AwsCodeBuild.CreateProjectOutputProject();
      //expect(instance).to.be.a(AwsCodeBuild.CreateProjectOutputProject);
    });
