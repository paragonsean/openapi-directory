...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.CloudWatchLogsConfig();
  });
  ...
  describe('CloudWatchLogsConfig', function() {
    it('should create an instance of CloudWatchLogsConfig', function() {
      // uncomment below and update the code to test CloudWatchLogsConfig
      //var instance = new AwsCodeBuild.CloudWatchLogsConfig();
      //expect(instance).to.be.a(AwsCodeBuild.CloudWatchLogsConfig);
    });
