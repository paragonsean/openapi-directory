...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListReportsInput();
  });
  ...
  describe('ListReportsInput', function() {
    it('should create an instance of ListReportsInput', function() {
      // uncomment below and update the code to test ListReportsInput
      //var instance = new AwsCodeBuild.ListReportsInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListReportsInput);
    });
