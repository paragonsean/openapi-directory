...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.GetReportGroupTrendOutputStats();
  });
  ...
  describe('GetReportGroupTrendOutputStats', function() {
    it('should create an instance of GetReportGroupTrendOutputStats', function() {
      // uncomment below and update the code to test GetReportGroupTrendOutputStats
      //var instance = new AwsCodeBuild.GetReportGroupTrendOutputStats();
      //expect(instance).to.be.a(AwsCodeBuild.GetReportGroupTrendOutputStats);
    });
