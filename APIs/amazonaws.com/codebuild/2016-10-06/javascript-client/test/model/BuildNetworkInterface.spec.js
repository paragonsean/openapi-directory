...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.BuildNetworkInterface();
  });
  ...
  describe('BuildNetworkInterface', function() {
    it('should create an instance of BuildNetworkInterface', function() {
      // uncomment below and update the code to test BuildNetworkInterface
      //var instance = new AwsCodeBuild.BuildNetworkInterface();
      //expect(instance).to.be.a(AwsCodeBuild.BuildNetworkInterface);
    });
