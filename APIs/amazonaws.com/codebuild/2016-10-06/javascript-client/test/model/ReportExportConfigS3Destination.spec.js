...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ReportExportConfigS3Destination();
  });
  ...
  describe('ReportExportConfigS3Destination', function() {
    it('should create an instance of ReportExportConfigS3Destination', function() {
      // uncomment below and update the code to test ReportExportConfigS3Destination
      //var instance = new AwsCodeBuild.ReportExportConfigS3Destination();
      //expect(instance).to.be.a(AwsCodeBuild.ReportExportConfigS3Destination);
    });
