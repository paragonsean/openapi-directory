...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ProjectVpcConfig();
  });
  ...
  describe('ProjectVpcConfig', function() {
    it('should create an instance of ProjectVpcConfig', function() {
      // uncomment below and update the code to test ProjectVpcConfig
      //var instance = new AwsCodeBuild.ProjectVpcConfig();
      //expect(instance).to.be.a(AwsCodeBuild.ProjectVpcConfig);
    });
