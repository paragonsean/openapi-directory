...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListBuildsForProjectInput();
  });
  ...
  describe('ListBuildsForProjectInput', function() {
    it('should create an instance of ListBuildsForProjectInput', function() {
      // uncomment below and update the code to test ListBuildsForProjectInput
      //var instance = new AwsCodeBuild.ListBuildsForProjectInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListBuildsForProjectInput);
    });
