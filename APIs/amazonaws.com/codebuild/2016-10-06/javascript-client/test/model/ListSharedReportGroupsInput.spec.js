...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListSharedReportGroupsInput();
  });
  ...
  describe('ListSharedReportGroupsInput', function() {
    it('should create an instance of ListSharedReportGroupsInput', function() {
      // uncomment below and update the code to test ListSharedReportGroupsInput
      //var instance = new AwsCodeBuild.ListSharedReportGroupsInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListSharedReportGroupsInput);
    });
