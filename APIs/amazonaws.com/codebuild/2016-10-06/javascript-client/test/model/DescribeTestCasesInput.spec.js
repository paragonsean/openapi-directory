...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.DescribeTestCasesInput();
  });
  ...
  describe('DescribeTestCasesInput', function() {
    it('should create an instance of DescribeTestCasesInput', function() {
      // uncomment below and update the code to test DescribeTestCasesInput
      //var instance = new AwsCodeBuild.DescribeTestCasesInput();
      //expect(instance).to.be.a(AwsCodeBuild.DescribeTestCasesInput);
    });
