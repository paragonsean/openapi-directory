...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.ListBuildBatchesInput();
  });
  ...
  describe('ListBuildBatchesInput', function() {
    it('should create an instance of ListBuildBatchesInput', function() {
      // uncomment below and update the code to test ListBuildBatchesInput
      //var instance = new AwsCodeBuild.ListBuildBatchesInput();
      //expect(instance).to.be.a(AwsCodeBuild.ListBuildBatchesInput);
    });
