...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.BuildSource();
  });
  ...
  describe('BuildSource', function() {
    it('should create an instance of BuildSource', function() {
      // uncomment below and update the code to test BuildSource
      //var instance = new AwsCodeBuild.BuildSource();
      //expect(instance).to.be.a(AwsCodeBuild.BuildSource);
    });
