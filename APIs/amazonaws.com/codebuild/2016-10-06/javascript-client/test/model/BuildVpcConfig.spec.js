...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.BuildVpcConfig();
  });
  ...
  describe('BuildVpcConfig', function() {
    it('should create an instance of BuildVpcConfig', function() {
      // uncomment below and update the code to test BuildVpcConfig
      //var instance = new AwsCodeBuild.BuildVpcConfig();
      //expect(instance).to.be.a(AwsCodeBuild.BuildVpcConfig);
    });
