...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.StartBuildOutputBuild();
  });
  ...
  describe('StartBuildOutputBuild', function() {
    it('should create an instance of StartBuildOutputBuild', function() {
      // uncomment below and update the code to test StartBuildOutputBuild
      //var instance = new AwsCodeBuild.StartBuildOutputBuild();
      //expect(instance).to.be.a(AwsCodeBuild.StartBuildOutputBuild);
    });
