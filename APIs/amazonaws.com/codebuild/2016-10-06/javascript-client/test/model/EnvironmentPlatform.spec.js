...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeBuild.EnvironmentPlatform();
  });
  ...
  describe('EnvironmentPlatform', function() {
    it('should create an instance of EnvironmentPlatform', function() {
      // uncomment below and update the code to test EnvironmentPlatform
      //var instance = new AwsCodeBuild.EnvironmentPlatform();
      //expect(instance).to.be.a(AwsCodeBuild.EnvironmentPlatform);
    });
