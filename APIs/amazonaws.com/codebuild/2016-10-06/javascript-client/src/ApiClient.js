...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://codebuild.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://codebuild.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2016-10-06/Javascript'
        };
