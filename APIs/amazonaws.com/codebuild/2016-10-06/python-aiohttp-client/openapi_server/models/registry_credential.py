...
class RegistryCredential(Model):
    ...
    def __init__(self, credential: str=None, credential_provider: CredentialProviderType=None):
        ...
        :param credential: The credential of this RegistryCredential.
        :param credential_provider: The credential_provider of this RegistryCredential.
        """
        self.openapi_types = {
            'credential': str,
    ...
    @property
    def credential(self):
        """Gets the credential of this RegistryCredential.


        :return: The credential of this RegistryCredential.
        :rtype: str
        """
    ...
    def credential(self, credential):
        """Sets the credential of this RegistryCredential.
    ...
    def credential_provider(self):
        """Gets the credential_provider of this RegistryCredential.


        :return: The credential_provider of this RegistryCredential.
    ...
    def credential_provider(self, credential_provider):
        """Sets the credential_provider of this RegistryCredential.
