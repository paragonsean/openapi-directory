...
public class CreateProjectInputEnvironment {
  ...
  public CreateProjectInputEnvironment() {
  }

  public CreateProjectInputEnvironment type(EnvironmentType type) {
    this.type = type;
    return this;
  }
  ...
  public CreateProjectInputEnvironment image(String image) {
    this.image = image;
    return this;
  }
  ...
  public CreateProjectInputEnvironment computeType(ComputeType computeType) {
  ...
  public CreateProjectInputEnvironment environmentVariables(List environmentVariables) {
  ...
  public CreateProjectInputEnvironment privilegedMode(Boolean privilegedMode) {
  ...
  public CreateProjectInputEnvironment certificate(String certificate) {
  ...
  public CreateProjectInputEnvironment registryCredential(ProjectEnvironmentRegistryCredential registryCredential) {
  ...
  public CreateProjectInputEnvironment imagePullCredentialsType(ImagePullCredentialsType imagePullCredentialsType) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectInputEnvironment createProjectInputEnvironment = (CreateProjectInputEnvironment) o;
    return Objects.equals(this.type, createProjectInputEnvironment.type) &&
        Objects.equals(this.image, createProjectInputEnvironment.image) &&
        Objects.equals(this.computeType, createProjectInputEnvironment.computeType) &&
        Objects.equals(this.environmentVariables, createProjectInputEnvironment.environmentVariables) &&
        Objects.equals(this.privilegedMode, createProjectInputEnvironment.privilegedMode) &&
        Objects.equals(this.certificate, createProjectInputEnvironment.certificate) &&
        Objects.equals(this.registryCredential, createProjectInputEnvironment.registryCredential) &&
        Objects.equals(this.imagePullCredentialsType, createProjectInputEnvironment.imagePullCredentialsType);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectInputEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectInputEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectInputEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectInputEnvironment is not found in the empty JSON string", CreateProjectInputEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectInputEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectInputEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateProjectInputEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectInputEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectInputEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectInputEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectInputEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectInputEnvironment>() {
           @Override
           public void write(JsonWriter out, CreateProjectInputEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectInputEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectInputEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectInputEnvironment
   * @throws IOException if the JSON string is invalid with respect to CreateProjectInputEnvironment
   */
  public static CreateProjectInputEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectInputEnvironment.class);
  }

  /**
   * Convert an instance of CreateProjectInputEnvironment to an JSON string
   *
   * @return JSON string
   */
