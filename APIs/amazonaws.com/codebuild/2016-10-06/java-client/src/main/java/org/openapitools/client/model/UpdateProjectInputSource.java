...
public class UpdateProjectInputSource {
  ...
  public UpdateProjectInputSource() {
  }

  public UpdateProjectInputSource type(SourceType type) {
    this.type = type;
    return this;
  }
  ...
  public UpdateProjectInputSource location(String location) {
  ...
  public UpdateProjectInputSource gitCloneDepth(Integer gitCloneDepth) {
  ...
  public UpdateProjectInputSource gitSubmodulesConfig(ProjectSourceGitSubmodulesConfig gitSubmodulesConfig) {
  ...
  public UpdateProjectInputSource buildspec(String buildspec) {
  ...
  public UpdateProjectInputSource auth(ProjectSourceAuth auth) {
    this.auth = auth;
    return this;
  }
  ...
  public UpdateProjectInputSource reportBuildStatus(Boolean reportBuildStatus) {
  ...
  public UpdateProjectInputSource buildStatusConfig(StartBuildInputBuildStatusConfigOverride buildStatusConfig) {
  ...
  public UpdateProjectInputSource insecureSsl(Boolean insecureSsl) {
  ...
  public UpdateProjectInputSource sourceIdentifier(String sourceIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateProjectInputSource updateProjectInputSource = (UpdateProjectInputSource) o;
    return Objects.equals(this.type, updateProjectInputSource.type) &&
        Objects.equals(this.location, updateProjectInputSource.location) &&
        Objects.equals(this.gitCloneDepth, updateProjectInputSource.gitCloneDepth) &&
        Objects.equals(this.gitSubmodulesConfig, updateProjectInputSource.gitSubmodulesConfig) &&
        Objects.equals(this.buildspec, updateProjectInputSource.buildspec) &&
        Objects.equals(this.auth, updateProjectInputSource.auth) &&
        Objects.equals(this.reportBuildStatus, updateProjectInputSource.reportBuildStatus) &&
        Objects.equals(this.buildStatusConfig, updateProjectInputSource.buildStatusConfig) &&
        Objects.equals(this.insecureSsl, updateProjectInputSource.insecureSsl) &&
        Objects.equals(this.sourceIdentifier, updateProjectInputSource.sourceIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateProjectInputSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProjectInputSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProjectInputSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProjectInputSource is not found in the empty JSON string", UpdateProjectInputSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProjectInputSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProjectInputSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateProjectInputSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProjectInputSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProjectInputSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProjectInputSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProjectInputSource.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProjectInputSource>() {
           @Override
           public void write(JsonWriter out, UpdateProjectInputSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProjectInputSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProjectInputSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProjectInputSource
   * @throws IOException if the JSON string is invalid with respect to UpdateProjectInputSource
   */
  public static UpdateProjectInputSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProjectInputSource.class);
  }

  /**
   * Convert an instance of UpdateProjectInputSource to an JSON string
   *
   * @return JSON string
   */
