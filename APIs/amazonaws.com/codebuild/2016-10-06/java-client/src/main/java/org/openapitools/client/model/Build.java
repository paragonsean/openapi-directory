...
public class Build {
  ...
  public Build endTime(OffsetDateTime endTime) {
  ...
  public Build currentPhase(String currentPhase) {
  ...
  public Build buildStatus(StatusType buildStatus) {
  ...
  public Build resolvedSourceVersion(String resolvedSourceVersion) {
  ...
  public Build projectName(String projectName) {
  ...
  public Build phases(List phases) {
    this.phases = phases;
    return this;
  }
  ...
  public Build source(BuildSource source) {
    this.source = source;
    return this;
  }
  ...
  public Build secondarySources(List secondarySources) {
  ...
  public Build secondarySourceVersions(List secondarySourceVersions) {
  ...
  public Build artifacts(BuildArtifacts artifacts) {
  ...
  public Build secondaryArtifacts(List secondaryArtifacts) {
  ...
  public Build cache(BuildCache cache) {
    this.cache = cache;
    return this;
  }
  ...
  public Build environment(BuildEnvironment environment) {
  ...
  public Build serviceRole(String serviceRole) {
  ...
  public Build logs(BuildLogs logs) {
    this.logs = logs;
    return this;
  }
  ...
  public Build timeoutInMinutes(Integer timeoutInMinutes) {
  ...
  public Build queuedTimeoutInMinutes(Integer queuedTimeoutInMinutes) {
  ...
  public Build buildComplete(Boolean buildComplete) {
  ...
  public Build initiator(String initiator) {
  ...
  public Build vpcConfig(BuildVpcConfig vpcConfig) {
  ...
  public Build networkInterface(BuildNetworkInterface networkInterface) {
  ...
  public Build encryptionKey(String encryptionKey) {
  ...
  public Build exportedEnvironmentVariables(List exportedEnvironmentVariables) {
  ...
  public Build reportArns(List reportArns) {
  ...
  public Build fileSystemLocations(List fileSystemLocations) {
  ...
  public Build debugSession(BuildDebugSession debugSession) {
  ...
  public Build buildBatchArn(String buildBatchArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, build.id) &&
        Objects.equals(this.arn, build.arn) &&
        Objects.equals(this.buildNumber, build.buildNumber) &&
        Objects.equals(this.startTime, build.startTime) &&
        Objects.equals(this.endTime, build.endTime) &&
        Objects.equals(this.currentPhase, build.currentPhase) &&
        Objects.equals(this.buildStatus, build.buildStatus) &&
        Objects.equals(this.sourceVersion, build.sourceVersion) &&
        Objects.equals(this.resolvedSourceVersion, build.resolvedSourceVersion) &&
        Objects.equals(this.projectName, build.projectName) &&
        Objects.equals(this.phases, build.phases) &&
        Objects.equals(this.source, build.source) &&
        Objects.equals(this.secondarySources, build.secondarySources) &&
        Objects.equals(this.secondarySourceVersions, build.secondarySourceVersions) &&
        Objects.equals(this.artifacts, build.artifacts) &&
        Objects.equals(this.secondaryArtifacts, build.secondaryArtifacts) &&
        Objects.equals(this.cache, build.cache) &&
        Objects.equals(this.environment, build.environment) &&
        Objects.equals(this.serviceRole, build.serviceRole) &&
        Objects.equals(this.logs, build.logs) &&
        Objects.equals(this.timeoutInMinutes, build.timeoutInMinutes) &&
        Objects.equals(this.queuedTimeoutInMinutes, build.queuedTimeoutInMinutes) &&
        Objects.equals(this.buildComplete, build.buildComplete) &&
        Objects.equals(this.initiator, build.initiator) &&
        Objects.equals(this.vpcConfig, build.vpcConfig) &&
        Objects.equals(this.networkInterface, build.networkInterface) &&
        Objects.equals(this.encryptionKey, build.encryptionKey) &&
        Objects.equals(this.exportedEnvironmentVariables, build.exportedEnvironmentVariables) &&
        Objects.equals(this.reportArns, build.reportArns) &&
        Objects.equals(this.fileSystemLocations, build.fileSystemLocations) &&
        Objects.equals(this.debugSession, build.debugSession) &&
        Objects.equals(this.buildBatchArn, build.buildBatchArn);
  }
