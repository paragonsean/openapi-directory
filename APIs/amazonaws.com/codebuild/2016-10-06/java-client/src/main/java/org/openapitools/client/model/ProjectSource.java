...
public class ProjectSource {
  ...
  public ProjectSource type(SourceType type) {
    this.type = type;
    return this;
  }
  ...
  public ProjectSource location(String location) {
  ...
  public ProjectSource gitCloneDepth(Integer gitCloneDepth) {
  ...
  public ProjectSource gitSubmodulesConfig(ProjectSourceGitSubmodulesConfig gitSubmodulesConfig) {
  ...
  public ProjectSource buildspec(String buildspec) {
  ...
  public ProjectSource auth(ProjectSourceAuth auth) {
    this.auth = auth;
    return this;
  }
  ...
  public ProjectSource reportBuildStatus(Boolean reportBuildStatus) {
  ...
  public ProjectSource buildStatusConfig(StartBuildInputBuildStatusConfigOverride buildStatusConfig) {
  ...
  public ProjectSource insecureSsl(Boolean insecureSsl) {
  ...
  public ProjectSource sourceIdentifier(String sourceIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectSource projectSource = (ProjectSource) o;
    return Objects.equals(this.type, projectSource.type) &&
        Objects.equals(this.location, projectSource.location) &&
        Objects.equals(this.gitCloneDepth, projectSource.gitCloneDepth) &&
        Objects.equals(this.gitSubmodulesConfig, projectSource.gitSubmodulesConfig) &&
        Objects.equals(this.buildspec, projectSource.buildspec) &&
        Objects.equals(this.auth, projectSource.auth) &&
        Objects.equals(this.reportBuildStatus, projectSource.reportBuildStatus) &&
        Objects.equals(this.buildStatusConfig, projectSource.buildStatusConfig) &&
        Objects.equals(this.insecureSsl, projectSource.insecureSsl) &&
        Objects.equals(this.sourceIdentifier, projectSource.sourceIdentifier);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectSource is not found in the empty JSON string", ProjectSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSource.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSource>() {
           @Override
           public void write(JsonWriter out, ProjectSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectSource
   * @throws IOException if the JSON string is invalid with respect to ProjectSource
   */
  public static ProjectSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSource.class);
  }

  /**
   * Convert an instance of ProjectSource to an JSON string
   *
   * @return JSON string
   */
