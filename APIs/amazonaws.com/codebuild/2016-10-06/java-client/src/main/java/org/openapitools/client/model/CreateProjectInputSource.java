...
public class CreateProjectInputSource {
  ...
  public CreateProjectInputSource() {
  }

  public CreateProjectInputSource type(SourceType type) {
    this.type = type;
    return this;
  }
  ...
  public CreateProjectInputSource location(String location) {
  ...
  public CreateProjectInputSource gitCloneDepth(Integer gitCloneDepth) {
  ...
  public CreateProjectInputSource gitSubmodulesConfig(ProjectSourceGitSubmodulesConfig gitSubmodulesConfig) {
  ...
  public CreateProjectInputSource buildspec(String buildspec) {
  ...
  public CreateProjectInputSource auth(ProjectSourceAuth auth) {
    this.auth = auth;
    return this;
  }
  ...
  public CreateProjectInputSource reportBuildStatus(Boolean reportBuildStatus) {
  ...
  public CreateProjectInputSource buildStatusConfig(StartBuildInputBuildStatusConfigOverride buildStatusConfig) {
  ...
  public CreateProjectInputSource insecureSsl(Boolean insecureSsl) {
  ...
  public CreateProjectInputSource sourceIdentifier(String sourceIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectInputSource createProjectInputSource = (CreateProjectInputSource) o;
    return Objects.equals(this.type, createProjectInputSource.type) &&
        Objects.equals(this.location, createProjectInputSource.location) &&
        Objects.equals(this.gitCloneDepth, createProjectInputSource.gitCloneDepth) &&
        Objects.equals(this.gitSubmodulesConfig, createProjectInputSource.gitSubmodulesConfig) &&
        Objects.equals(this.buildspec, createProjectInputSource.buildspec) &&
        Objects.equals(this.auth, createProjectInputSource.auth) &&
        Objects.equals(this.reportBuildStatus, createProjectInputSource.reportBuildStatus) &&
        Objects.equals(this.buildStatusConfig, createProjectInputSource.buildStatusConfig) &&
        Objects.equals(this.insecureSsl, createProjectInputSource.insecureSsl) &&
        Objects.equals(this.sourceIdentifier, createProjectInputSource.sourceIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectInputSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectInputSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectInputSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectInputSource is not found in the empty JSON string", CreateProjectInputSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectInputSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectInputSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateProjectInputSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectInputSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectInputSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectInputSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectInputSource.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectInputSource>() {
           @Override
           public void write(JsonWriter out, CreateProjectInputSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectInputSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectInputSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectInputSource
   * @throws IOException if the JSON string is invalid with respect to CreateProjectInputSource
   */
  public static CreateProjectInputSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectInputSource.class);
  }

  /**
   * Convert an instance of CreateProjectInputSource to an JSON string
   *
   * @return JSON string
   */
