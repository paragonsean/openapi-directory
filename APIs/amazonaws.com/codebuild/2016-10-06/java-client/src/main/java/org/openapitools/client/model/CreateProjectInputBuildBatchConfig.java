...
public class CreateProjectInputBuildBatchConfig {
  ...
  public CreateProjectInputBuildBatchConfig() {
  }

  public CreateProjectInputBuildBatchConfig serviceRole(String serviceRole) {
  ...
  public CreateProjectInputBuildBatchConfig combineArtifacts(Boolean combineArtifacts) {
  ...
  public CreateProjectInputBuildBatchConfig restrictions(ProjectBuildBatchConfigRestrictions restrictions) {
  ...
  public CreateProjectInputBuildBatchConfig timeoutInMins(Integer timeoutInMins) {
  ...
  public CreateProjectInputBuildBatchConfig batchReportMode(BatchReportModeType batchReportMode) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectInputBuildBatchConfig createProjectInputBuildBatchConfig = (CreateProjectInputBuildBatchConfig) o;
    return Objects.equals(this.serviceRole, createProjectInputBuildBatchConfig.serviceRole) &&
        Objects.equals(this.combineArtifacts, createProjectInputBuildBatchConfig.combineArtifacts) &&
        Objects.equals(this.restrictions, createProjectInputBuildBatchConfig.restrictions) &&
        Objects.equals(this.timeoutInMins, createProjectInputBuildBatchConfig.timeoutInMins) &&
        Objects.equals(this.batchReportMode, createProjectInputBuildBatchConfig.batchReportMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectInputBuildBatchConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectInputBuildBatchConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectInputBuildBatchConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectInputBuildBatchConfig is not found in the empty JSON string", CreateProjectInputBuildBatchConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectInputBuildBatchConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectInputBuildBatchConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectInputBuildBatchConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectInputBuildBatchConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectInputBuildBatchConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectInputBuildBatchConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectInputBuildBatchConfig>() {
           @Override
           public void write(JsonWriter out, CreateProjectInputBuildBatchConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectInputBuildBatchConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectInputBuildBatchConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectInputBuildBatchConfig
   * @throws IOException if the JSON string is invalid with respect to CreateProjectInputBuildBatchConfig
   */
  public static CreateProjectInputBuildBatchConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectInputBuildBatchConfig.class);
  }

  /**
   * Convert an instance of CreateProjectInputBuildBatchConfig to an JSON string
   *
   * @return JSON string
   */
