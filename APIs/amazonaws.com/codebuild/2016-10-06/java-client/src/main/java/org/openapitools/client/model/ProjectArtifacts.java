...
public class ProjectArtifacts {
  ...
  public ProjectArtifacts type(ArtifactsType type) {
    this.type = type;
    return this;
  }
  ...
  public ProjectArtifacts location(String location) {
  ...
  public ProjectArtifacts path(String path) {
    this.path = path;
    return this;
  }
  ...
  public ProjectArtifacts namespaceType(ArtifactNamespace namespaceType) {
  ...
  public ProjectArtifacts name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectArtifacts packaging(ArtifactPackaging packaging) {
  ...
  public ProjectArtifacts overrideArtifactName(Boolean overrideArtifactName) {
  ...
  public ProjectArtifacts encryptionDisabled(Boolean encryptionDisabled) {
  ...
  public ProjectArtifacts artifactIdentifier(String artifactIdentifier) {
  ...
  public ProjectArtifacts bucketOwnerAccess(BucketOwnerAccess bucketOwnerAccess) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectArtifacts projectArtifacts = (ProjectArtifacts) o;
    return Objects.equals(this.type, projectArtifacts.type) &&
        Objects.equals(this.location, projectArtifacts.location) &&
        Objects.equals(this.path, projectArtifacts.path) &&
        Objects.equals(this.namespaceType, projectArtifacts.namespaceType) &&
        Objects.equals(this.name, projectArtifacts.name) &&
        Objects.equals(this.packaging, projectArtifacts.packaging) &&
        Objects.equals(this.overrideArtifactName, projectArtifacts.overrideArtifactName) &&
        Objects.equals(this.encryptionDisabled, projectArtifacts.encryptionDisabled) &&
        Objects.equals(this.artifactIdentifier, projectArtifacts.artifactIdentifier) &&
        Objects.equals(this.bucketOwnerAccess, projectArtifacts.bucketOwnerAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectArtifacts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectArtifacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectArtifacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectArtifacts is not found in the empty JSON string", ProjectArtifacts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectArtifacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectArtifacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectArtifacts.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectArtifacts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectArtifacts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectArtifacts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectArtifacts.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectArtifacts>() {
           @Override
           public void write(JsonWriter out, ProjectArtifacts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectArtifacts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectArtifacts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectArtifacts
   * @throws IOException if the JSON string is invalid with respect to ProjectArtifacts
   */
  public static ProjectArtifacts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectArtifacts.class);
  }

  /**
   * Convert an instance of ProjectArtifacts to an JSON string
   *
   * @return JSON string
   */
