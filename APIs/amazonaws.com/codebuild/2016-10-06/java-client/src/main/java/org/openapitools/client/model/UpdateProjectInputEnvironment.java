...
public class UpdateProjectInputEnvironment {
  ...
  public UpdateProjectInputEnvironment() {
  }

  public UpdateProjectInputEnvironment type(EnvironmentType type) {
    this.type = type;
    return this;
  }
  ...
  public UpdateProjectInputEnvironment image(String image) {
    this.image = image;
    return this;
  }
  ...
  public UpdateProjectInputEnvironment computeType(ComputeType computeType) {
  ...
  public UpdateProjectInputEnvironment environmentVariables(List environmentVariables) {
  ...
  public UpdateProjectInputEnvironment privilegedMode(Boolean privilegedMode) {
  ...
  public UpdateProjectInputEnvironment certificate(String certificate) {
  ...
  public UpdateProjectInputEnvironment registryCredential(ProjectEnvironmentRegistryCredential registryCredential) {
  ...
  public UpdateProjectInputEnvironment imagePullCredentialsType(ImagePullCredentialsType imagePullCredentialsType) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateProjectInputEnvironment updateProjectInputEnvironment = (UpdateProjectInputEnvironment) o;
    return Objects.equals(this.type, updateProjectInputEnvironment.type) &&
        Objects.equals(this.image, updateProjectInputEnvironment.image) &&
        Objects.equals(this.computeType, updateProjectInputEnvironment.computeType) &&
        Objects.equals(this.environmentVariables, updateProjectInputEnvironment.environmentVariables) &&
        Objects.equals(this.privilegedMode, updateProjectInputEnvironment.privilegedMode) &&
        Objects.equals(this.certificate, updateProjectInputEnvironment.certificate) &&
        Objects.equals(this.registryCredential, updateProjectInputEnvironment.registryCredential) &&
        Objects.equals(this.imagePullCredentialsType, updateProjectInputEnvironment.imagePullCredentialsType);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateProjectInputEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProjectInputEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProjectInputEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProjectInputEnvironment is not found in the empty JSON string", UpdateProjectInputEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProjectInputEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProjectInputEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateProjectInputEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProjectInputEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProjectInputEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProjectInputEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProjectInputEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProjectInputEnvironment>() {
           @Override
           public void write(JsonWriter out, UpdateProjectInputEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProjectInputEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProjectInputEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProjectInputEnvironment
   * @throws IOException if the JSON string is invalid with respect to UpdateProjectInputEnvironment
   */
  public static UpdateProjectInputEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProjectInputEnvironment.class);
  }

  /**
   * Convert an instance of UpdateProjectInputEnvironment to an JSON string
   *
   * @return JSON string
   */
