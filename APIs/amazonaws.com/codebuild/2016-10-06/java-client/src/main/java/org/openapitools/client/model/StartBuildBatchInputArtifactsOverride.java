...
public class StartBuildBatchInputArtifactsOverride {
  ...
  public StartBuildBatchInputArtifactsOverride() {
  }

  public StartBuildBatchInputArtifactsOverride type(ArtifactsType type) {
    this.type = type;
    return this;
  }
  ...
  public StartBuildBatchInputArtifactsOverride location(String location) {
  ...
  public StartBuildBatchInputArtifactsOverride path(String path) {
    this.path = path;
    return this;
  }
  ...
  public StartBuildBatchInputArtifactsOverride namespaceType(ArtifactNamespace namespaceType) {
  ...
  public StartBuildBatchInputArtifactsOverride name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StartBuildBatchInputArtifactsOverride packaging(ArtifactPackaging packaging) {
  ...
  public StartBuildBatchInputArtifactsOverride overrideArtifactName(Boolean overrideArtifactName) {
  ...
  public StartBuildBatchInputArtifactsOverride encryptionDisabled(Boolean encryptionDisabled) {
  ...
  public StartBuildBatchInputArtifactsOverride artifactIdentifier(String artifactIdentifier) {
  ...
  public StartBuildBatchInputArtifactsOverride bucketOwnerAccess(BucketOwnerAccess bucketOwnerAccess) {
  ...
  public boolean equals(Object o) {
    ...
    StartBuildBatchInputArtifactsOverride startBuildBatchInputArtifactsOverride = (StartBuildBatchInputArtifactsOverride) o;
    return Objects.equals(this.type, startBuildBatchInputArtifactsOverride.type) &&
        Objects.equals(this.location, startBuildBatchInputArtifactsOverride.location) &&
        Objects.equals(this.path, startBuildBatchInputArtifactsOverride.path) &&
        Objects.equals(this.namespaceType, startBuildBatchInputArtifactsOverride.namespaceType) &&
        Objects.equals(this.name, startBuildBatchInputArtifactsOverride.name) &&
        Objects.equals(this.packaging, startBuildBatchInputArtifactsOverride.packaging) &&
        Objects.equals(this.overrideArtifactName, startBuildBatchInputArtifactsOverride.overrideArtifactName) &&
        Objects.equals(this.encryptionDisabled, startBuildBatchInputArtifactsOverride.encryptionDisabled) &&
        Objects.equals(this.artifactIdentifier, startBuildBatchInputArtifactsOverride.artifactIdentifier) &&
        Objects.equals(this.bucketOwnerAccess, startBuildBatchInputArtifactsOverride.bucketOwnerAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartBuildBatchInputArtifactsOverride {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartBuildBatchInputArtifactsOverride
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartBuildBatchInputArtifactsOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartBuildBatchInputArtifactsOverride is not found in the empty JSON string", StartBuildBatchInputArtifactsOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartBuildBatchInputArtifactsOverride.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartBuildBatchInputArtifactsOverride` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartBuildBatchInputArtifactsOverride.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartBuildBatchInputArtifactsOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartBuildBatchInputArtifactsOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartBuildBatchInputArtifactsOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartBuildBatchInputArtifactsOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<StartBuildBatchInputArtifactsOverride>() {
           @Override
           public void write(JsonWriter out, StartBuildBatchInputArtifactsOverride value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartBuildBatchInputArtifactsOverride read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartBuildBatchInputArtifactsOverride given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartBuildBatchInputArtifactsOverride
   * @throws IOException if the JSON string is invalid with respect to StartBuildBatchInputArtifactsOverride
   */
  public static StartBuildBatchInputArtifactsOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartBuildBatchInputArtifactsOverride.class);
  }

  /**
   * Convert an instance of StartBuildBatchInputArtifactsOverride to an JSON string
   *
   * @return JSON string
   */
