...
public class BuildEnvironment {
  ...
  public BuildEnvironment type(EnvironmentType type) {
    this.type = type;
    return this;
  }
  ...
  public BuildEnvironment image(String image) {
    this.image = image;
    return this;
  }
  ...
  public BuildEnvironment computeType(ComputeType computeType) {
  ...
  public BuildEnvironment environmentVariables(List environmentVariables) {
  ...
  public BuildEnvironment privilegedMode(Boolean privilegedMode) {
  ...
  public BuildEnvironment certificate(String certificate) {
  ...
  public BuildEnvironment registryCredential(ProjectEnvironmentRegistryCredential registryCredential) {
  ...
  public BuildEnvironment imagePullCredentialsType(ImagePullCredentialsType imagePullCredentialsType) {
  ...
  public boolean equals(Object o) {
    ...
    BuildEnvironment buildEnvironment = (BuildEnvironment) o;
    return Objects.equals(this.type, buildEnvironment.type) &&
        Objects.equals(this.image, buildEnvironment.image) &&
        Objects.equals(this.computeType, buildEnvironment.computeType) &&
        Objects.equals(this.environmentVariables, buildEnvironment.environmentVariables) &&
        Objects.equals(this.privilegedMode, buildEnvironment.privilegedMode) &&
        Objects.equals(this.certificate, buildEnvironment.certificate) &&
        Objects.equals(this.registryCredential, buildEnvironment.registryCredential) &&
        Objects.equals(this.imagePullCredentialsType, buildEnvironment.imagePullCredentialsType);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuildEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BuildEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BuildEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuildEnvironment is not found in the empty JSON string", BuildEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BuildEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuildEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BuildEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuildEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuildEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuildEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuildEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<BuildEnvironment>() {
           @Override
           public void write(JsonWriter out, BuildEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuildEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BuildEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BuildEnvironment
   * @throws IOException if the JSON string is invalid with respect to BuildEnvironment
   */
  public static BuildEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuildEnvironment.class);
  }

  /**
   * Convert an instance of BuildEnvironment to an JSON string
   *
   * @return JSON string
   */
