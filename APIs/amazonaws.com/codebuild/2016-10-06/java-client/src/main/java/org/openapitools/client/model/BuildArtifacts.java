...
public class BuildArtifacts {
  ...
  public BuildArtifacts location(String location) {
  ...
  public BuildArtifacts sha256sum(String sha256sum) {
  ...
  public BuildArtifacts md5sum(String md5sum) {
    this.md5sum = md5sum;
    return this;
  }
  ...
  public BuildArtifacts overrideArtifactName(Boolean overrideArtifactName) {
  ...
  public BuildArtifacts encryptionDisabled(Boolean encryptionDisabled) {
  ...
  public BuildArtifacts artifactIdentifier(String artifactIdentifier) {
  ...
  public BuildArtifacts bucketOwnerAccess(BucketOwnerAccess bucketOwnerAccess) {
  ...
  public boolean equals(Object o) {
    ...
    BuildArtifacts buildArtifacts = (BuildArtifacts) o;
    return Objects.equals(this.location, buildArtifacts.location) &&
        Objects.equals(this.sha256sum, buildArtifacts.sha256sum) &&
        Objects.equals(this.md5sum, buildArtifacts.md5sum) &&
        Objects.equals(this.overrideArtifactName, buildArtifacts.overrideArtifactName) &&
        Objects.equals(this.encryptionDisabled, buildArtifacts.encryptionDisabled) &&
        Objects.equals(this.artifactIdentifier, buildArtifacts.artifactIdentifier) &&
        Objects.equals(this.bucketOwnerAccess, buildArtifacts.bucketOwnerAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class BuildArtifacts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BuildArtifacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BuildArtifacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuildArtifacts is not found in the empty JSON string", BuildArtifacts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BuildArtifacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuildArtifacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuildArtifacts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuildArtifacts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuildArtifacts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuildArtifacts.class));

       return (TypeAdapter<T>) new TypeAdapter<BuildArtifacts>() {
           @Override
           public void write(JsonWriter out, BuildArtifacts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuildArtifacts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BuildArtifacts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BuildArtifacts
   * @throws IOException if the JSON string is invalid with respect to BuildArtifacts
   */
  public static BuildArtifacts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuildArtifacts.class);
  }

  /**
   * Convert an instance of BuildArtifacts to an JSON string
   *
   * @return JSON string
   */
