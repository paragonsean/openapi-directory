...
public class StopBuildOutputBuild {
  ...
  public StopBuildOutputBuild() {
  }

  public StopBuildOutputBuild id(String id) {
    this.id = id;
    return this;
  }
  ...
  public StopBuildOutputBuild arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StopBuildOutputBuild buildNumber(Integer buildNumber) {
  ...
  public StopBuildOutputBuild startTime(OffsetDateTime startTime) {
  ...
  public StopBuildOutputBuild endTime(OffsetDateTime endTime) {
  ...
  public StopBuildOutputBuild currentPhase(String currentPhase) {
  ...
  public StopBuildOutputBuild buildStatus(StatusType buildStatus) {
  ...
  public StopBuildOutputBuild sourceVersion(String sourceVersion) {
  ...
  public StopBuildOutputBuild resolvedSourceVersion(String resolvedSourceVersion) {
  ...
  public StopBuildOutputBuild projectName(String projectName) {
  ...
  public StopBuildOutputBuild phases(List phases) {
    this.phases = phases;
    return this;
  }
  ...
  public StopBuildOutputBuild source(BuildSource source) {
    this.source = source;
    return this;
  }
  ...
  public StopBuildOutputBuild secondarySources(List secondarySources) {
  ...
  public StopBuildOutputBuild secondarySourceVersions(List secondarySourceVersions) {
  ...
  public StopBuildOutputBuild artifacts(BuildArtifacts artifacts) {
  ...
  public StopBuildOutputBuild secondaryArtifacts(List secondaryArtifacts) {
  ...
  public StopBuildOutputBuild cache(BuildCache cache) {
    this.cache = cache;
    return this;
  }
  ...
  public StopBuildOutputBuild environment(BuildEnvironment environment) {
  ...
  public StopBuildOutputBuild serviceRole(String serviceRole) {
  ...
  public StopBuildOutputBuild logs(BuildLogs logs) {
    this.logs = logs;
    return this;
  }
  ...
  public StopBuildOutputBuild timeoutInMinutes(Integer timeoutInMinutes) {
  ...
  public StopBuildOutputBuild queuedTimeoutInMinutes(Integer queuedTimeoutInMinutes) {
  ...
  public StopBuildOutputBuild buildComplete(Boolean buildComplete) {
  ...
  public StopBuildOutputBuild initiator(String initiator) {
  ...
  public StopBuildOutputBuild vpcConfig(BuildVpcConfig vpcConfig) {
  ...
  public StopBuildOutputBuild networkInterface(BuildNetworkInterface networkInterface) {
  ...
  public StopBuildOutputBuild encryptionKey(String encryptionKey) {
  ...
  public StopBuildOutputBuild exportedEnvironmentVariables(List exportedEnvironmentVariables) {
  ...
  public StopBuildOutputBuild reportArns(List reportArns) {
  ...
  public StopBuildOutputBuild fileSystemLocations(List fileSystemLocations) {
  ...
  public StopBuildOutputBuild debugSession(BuildDebugSession debugSession) {
  ...
  public StopBuildOutputBuild buildBatchArn(String buildBatchArn) {
  ...
  public boolean equals(Object o) {
    ...
    StopBuildOutputBuild stopBuildOutputBuild = (StopBuildOutputBuild) o;
    return Objects.equals(this.id, stopBuildOutputBuild.id) &&
        Objects.equals(this.arn, stopBuildOutputBuild.arn) &&
        Objects.equals(this.buildNumber, stopBuildOutputBuild.buildNumber) &&
        Objects.equals(this.startTime, stopBuildOutputBuild.startTime) &&
        Objects.equals(this.endTime, stopBuildOutputBuild.endTime) &&
        Objects.equals(this.currentPhase, stopBuildOutputBuild.currentPhase) &&
        Objects.equals(this.buildStatus, stopBuildOutputBuild.buildStatus) &&
        Objects.equals(this.sourceVersion, stopBuildOutputBuild.sourceVersion) &&
        Objects.equals(this.resolvedSourceVersion, stopBuildOutputBuild.resolvedSourceVersion) &&
        Objects.equals(this.projectName, stopBuildOutputBuild.projectName) &&
        Objects.equals(this.phases, stopBuildOutputBuild.phases) &&
        Objects.equals(this.source, stopBuildOutputBuild.source) &&
        Objects.equals(this.secondarySources, stopBuildOutputBuild.secondarySources) &&
        Objects.equals(this.secondarySourceVersions, stopBuildOutputBuild.secondarySourceVersions) &&
        Objects.equals(this.artifacts, stopBuildOutputBuild.artifacts) &&
        Objects.equals(this.secondaryArtifacts, stopBuildOutputBuild.secondaryArtifacts) &&
        Objects.equals(this.cache, stopBuildOutputBuild.cache) &&
        Objects.equals(this.environment, stopBuildOutputBuild.environment) &&
        Objects.equals(this.serviceRole, stopBuildOutputBuild.serviceRole) &&
        Objects.equals(this.logs, stopBuildOutputBuild.logs) &&
        Objects.equals(this.timeoutInMinutes, stopBuildOutputBuild.timeoutInMinutes) &&
        Objects.equals(this.queuedTimeoutInMinutes, stopBuildOutputBuild.queuedTimeoutInMinutes) &&
        Objects.equals(this.buildComplete, stopBuildOutputBuild.buildComplete) &&
        Objects.equals(this.initiator, stopBuildOutputBuild.initiator) &&
        Objects.equals(this.vpcConfig, stopBuildOutputBuild.vpcConfig) &&
        Objects.equals(this.networkInterface, stopBuildOutputBuild.networkInterface) &&
        Objects.equals(this.encryptionKey, stopBuildOutputBuild.encryptionKey) &&
        Objects.equals(this.exportedEnvironmentVariables, stopBuildOutputBuild.exportedEnvironmentVariables) &&
        Objects.equals(this.reportArns, stopBuildOutputBuild.reportArns) &&
        Objects.equals(this.fileSystemLocations, stopBuildOutputBuild.fileSystemLocations) &&
        Objects.equals(this.debugSession, stopBuildOutputBuild.debugSession) &&
        Objects.equals(this.buildBatchArn, stopBuildOutputBuild.buildBatchArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopBuildOutputBuild {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopBuildOutputBuild
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopBuildOutputBuild.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopBuildOutputBuild is not found in the empty JSON string", StopBuildOutputBuild.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopBuildOutputBuild.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopBuildOutputBuild` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopBuildOutputBuild.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopBuildOutputBuild' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopBuildOutputBuild> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopBuildOutputBuild.class));

       return (TypeAdapter<T>) new TypeAdapter<StopBuildOutputBuild>() {
           @Override
           public void write(JsonWriter out, StopBuildOutputBuild value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopBuildOutputBuild read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopBuildOutputBuild given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopBuildOutputBuild
   * @throws IOException if the JSON string is invalid with respect to StopBuildOutputBuild
   */
  public static StopBuildOutputBuild fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopBuildOutputBuild.class);
  }

  /**
   * Convert an instance of StopBuildOutputBuild to an JSON string
   *
   * @return JSON string
   */
