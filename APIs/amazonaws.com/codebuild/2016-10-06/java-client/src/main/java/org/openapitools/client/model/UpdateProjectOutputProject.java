...
public class UpdateProjectOutputProject {
  ...
  public UpdateProjectOutputProject() {
  }

  public UpdateProjectOutputProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateProjectOutputProject arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateProjectOutputProject description(String description) {
  ...
  public UpdateProjectOutputProject source(ProjectSource source) {
    this.source = source;
    return this;
  }
  ...
  public UpdateProjectOutputProject secondarySources(List secondarySources) {
  ...
  public UpdateProjectOutputProject sourceVersion(String sourceVersion) {
  ...
  public UpdateProjectOutputProject secondarySourceVersions(List secondarySourceVersions) {
  ...
  public UpdateProjectOutputProject artifacts(CreateProjectInputArtifacts artifacts) {
  ...
  public UpdateProjectOutputProject secondaryArtifacts(List secondaryArtifacts) {
  ...
  public UpdateProjectOutputProject cache(ProjectCache cache) {
    this.cache = cache;
    return this;
  }
  ...
  public UpdateProjectOutputProject environment(ProjectEnvironment environment) {
  ...
  public UpdateProjectOutputProject serviceRole(String serviceRole) {
  ...
  public UpdateProjectOutputProject timeoutInMinutes(Integer timeoutInMinutes) {
  ...
  public UpdateProjectOutputProject queuedTimeoutInMinutes(Integer queuedTimeoutInMinutes) {
  ...
  public UpdateProjectOutputProject encryptionKey(String encryptionKey) {
  ...
  public UpdateProjectOutputProject tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateProjectOutputProject created(OffsetDateTime created) {
  ...
  public UpdateProjectOutputProject lastModified(OffsetDateTime lastModified) {
  ...
  public UpdateProjectOutputProject webhook(CreateWebhookOutputWebhook webhook) {
  ...
  public UpdateProjectOutputProject vpcConfig(ProjectVpcConfig vpcConfig) {
  ...
  public UpdateProjectOutputProject badge(ProjectBadge badge) {
    this.badge = badge;
    return this;
  }
  ...
  public UpdateProjectOutputProject logsConfig(ProjectLogsConfig logsConfig) {
  ...
  public UpdateProjectOutputProject fileSystemLocations(List fileSystemLocations) {
  ...
  public UpdateProjectOutputProject buildBatchConfig(CreateProjectInputBuildBatchConfig buildBatchConfig) {
  ...
  public UpdateProjectOutputProject concurrentBuildLimit(Integer concurrentBuildLimit) {
  ...
  public UpdateProjectOutputProject projectVisibility(ProjectVisibilityType projectVisibility) {
  ...
  public UpdateProjectOutputProject publicProjectAlias(String publicProjectAlias) {
  ...
  public UpdateProjectOutputProject resourceAccessRole(String resourceAccessRole) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateProjectOutputProject updateProjectOutputProject = (UpdateProjectOutputProject) o;
    return Objects.equals(this.name, updateProjectOutputProject.name) &&
        Objects.equals(this.arn, updateProjectOutputProject.arn) &&
        Objects.equals(this.description, updateProjectOutputProject.description) &&
        Objects.equals(this.source, updateProjectOutputProject.source) &&
        Objects.equals(this.secondarySources, updateProjectOutputProject.secondarySources) &&
        Objects.equals(this.sourceVersion, updateProjectOutputProject.sourceVersion) &&
        Objects.equals(this.secondarySourceVersions, updateProjectOutputProject.secondarySourceVersions) &&
        Objects.equals(this.artifacts, updateProjectOutputProject.artifacts) &&
        Objects.equals(this.secondaryArtifacts, updateProjectOutputProject.secondaryArtifacts) &&
        Objects.equals(this.cache, updateProjectOutputProject.cache) &&
        Objects.equals(this.environment, updateProjectOutputProject.environment) &&
        Objects.equals(this.serviceRole, updateProjectOutputProject.serviceRole) &&
        Objects.equals(this.timeoutInMinutes, updateProjectOutputProject.timeoutInMinutes) &&
        Objects.equals(this.queuedTimeoutInMinutes, updateProjectOutputProject.queuedTimeoutInMinutes) &&
        Objects.equals(this.encryptionKey, updateProjectOutputProject.encryptionKey) &&
        Objects.equals(this.tags, updateProjectOutputProject.tags) &&
        Objects.equals(this.created, updateProjectOutputProject.created) &&
        Objects.equals(this.lastModified, updateProjectOutputProject.lastModified) &&
        Objects.equals(this.webhook, updateProjectOutputProject.webhook) &&
        Objects.equals(this.vpcConfig, updateProjectOutputProject.vpcConfig) &&
        Objects.equals(this.badge, updateProjectOutputProject.badge) &&
        Objects.equals(this.logsConfig, updateProjectOutputProject.logsConfig) &&
        Objects.equals(this.fileSystemLocations, updateProjectOutputProject.fileSystemLocations) &&
        Objects.equals(this.buildBatchConfig, updateProjectOutputProject.buildBatchConfig) &&
        Objects.equals(this.concurrentBuildLimit, updateProjectOutputProject.concurrentBuildLimit) &&
        Objects.equals(this.projectVisibility, updateProjectOutputProject.projectVisibility) &&
        Objects.equals(this.publicProjectAlias, updateProjectOutputProject.publicProjectAlias) &&
        Objects.equals(this.resourceAccessRole, updateProjectOutputProject.resourceAccessRole);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateProjectOutputProject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProjectOutputProject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProjectOutputProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProjectOutputProject is not found in the empty JSON string", UpdateProjectOutputProject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProjectOutputProject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProjectOutputProject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProjectOutputProject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProjectOutputProject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProjectOutputProject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProjectOutputProject.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProjectOutputProject>() {
           @Override
           public void write(JsonWriter out, UpdateProjectOutputProject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProjectOutputProject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProjectOutputProject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProjectOutputProject
   * @throws IOException if the JSON string is invalid with respect to UpdateProjectOutputProject
   */
  public static UpdateProjectOutputProject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProjectOutputProject.class);
  }

  /**
   * Convert an instance of UpdateProjectOutputProject to an JSON string
   *
   * @return JSON string
   */
