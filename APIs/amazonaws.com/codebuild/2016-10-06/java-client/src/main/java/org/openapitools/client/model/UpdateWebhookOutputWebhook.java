...
public class UpdateWebhookOutputWebhook {
  ...
  public UpdateWebhookOutputWebhook() {
  }

  public UpdateWebhookOutputWebhook url(String url) {
    this.url = url;
    return this;
  }
  ...
  public UpdateWebhookOutputWebhook payloadUrl(String payloadUrl) {
  ...
  public UpdateWebhookOutputWebhook secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public UpdateWebhookOutputWebhook branchFilter(String branchFilter) {
  ...
  public UpdateWebhookOutputWebhook filterGroups(List filterGroups) {
  ...
  public UpdateWebhookOutputWebhook buildType(WebhookBuildType buildType) {
  ...
  public UpdateWebhookOutputWebhook lastModifiedSecret(OffsetDateTime lastModifiedSecret) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateWebhookOutputWebhook updateWebhookOutputWebhook = (UpdateWebhookOutputWebhook) o;
    return Objects.equals(this.url, updateWebhookOutputWebhook.url) &&
        Objects.equals(this.payloadUrl, updateWebhookOutputWebhook.payloadUrl) &&
        Objects.equals(this.secret, updateWebhookOutputWebhook.secret) &&
        Objects.equals(this.branchFilter, updateWebhookOutputWebhook.branchFilter) &&
        Objects.equals(this.filterGroups, updateWebhookOutputWebhook.filterGroups) &&
        Objects.equals(this.buildType, updateWebhookOutputWebhook.buildType) &&
        Objects.equals(this.lastModifiedSecret, updateWebhookOutputWebhook.lastModifiedSecret);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateWebhookOutputWebhook {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWebhookOutputWebhook
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWebhookOutputWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateWebhookOutputWebhook is not found in the empty JSON string", UpdateWebhookOutputWebhook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWebhookOutputWebhook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateWebhookOutputWebhook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWebhookOutputWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWebhookOutputWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWebhookOutputWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWebhookOutputWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWebhookOutputWebhook>() {
           @Override
           public void write(JsonWriter out, UpdateWebhookOutputWebhook value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWebhookOutputWebhook read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWebhookOutputWebhook given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWebhookOutputWebhook
   * @throws IOException if the JSON string is invalid with respect to UpdateWebhookOutputWebhook
   */
  public static UpdateWebhookOutputWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWebhookOutputWebhook.class);
  }

  /**
   * Convert an instance of UpdateWebhookOutputWebhook to an JSON string
   *
   * @return JSON string
   */
