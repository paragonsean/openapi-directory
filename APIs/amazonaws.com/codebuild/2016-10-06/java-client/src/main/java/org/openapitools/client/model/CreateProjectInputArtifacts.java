...
public class CreateProjectInputArtifacts {
  ...
  public CreateProjectInputArtifacts() {
  }

  public CreateProjectInputArtifacts type(ArtifactsType type) {
    this.type = type;
    return this;
  }
  ...
  public CreateProjectInputArtifacts location(String location) {
  ...
  public CreateProjectInputArtifacts path(String path) {
    this.path = path;
    return this;
  }
  ...
  public CreateProjectInputArtifacts namespaceType(ArtifactNamespace namespaceType) {
  ...
  public CreateProjectInputArtifacts name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateProjectInputArtifacts packaging(ArtifactPackaging packaging) {
  ...
  public CreateProjectInputArtifacts overrideArtifactName(Boolean overrideArtifactName) {
  ...
  public CreateProjectInputArtifacts encryptionDisabled(Boolean encryptionDisabled) {
  ...
  public CreateProjectInputArtifacts artifactIdentifier(String artifactIdentifier) {
  ...
  public CreateProjectInputArtifacts bucketOwnerAccess(BucketOwnerAccess bucketOwnerAccess) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectInputArtifacts createProjectInputArtifacts = (CreateProjectInputArtifacts) o;
    return Objects.equals(this.type, createProjectInputArtifacts.type) &&
        Objects.equals(this.location, createProjectInputArtifacts.location) &&
        Objects.equals(this.path, createProjectInputArtifacts.path) &&
        Objects.equals(this.namespaceType, createProjectInputArtifacts.namespaceType) &&
        Objects.equals(this.name, createProjectInputArtifacts.name) &&
        Objects.equals(this.packaging, createProjectInputArtifacts.packaging) &&
        Objects.equals(this.overrideArtifactName, createProjectInputArtifacts.overrideArtifactName) &&
        Objects.equals(this.encryptionDisabled, createProjectInputArtifacts.encryptionDisabled) &&
        Objects.equals(this.artifactIdentifier, createProjectInputArtifacts.artifactIdentifier) &&
        Objects.equals(this.bucketOwnerAccess, createProjectInputArtifacts.bucketOwnerAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectInputArtifacts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectInputArtifacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectInputArtifacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectInputArtifacts is not found in the empty JSON string", CreateProjectInputArtifacts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectInputArtifacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectInputArtifacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateProjectInputArtifacts.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectInputArtifacts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectInputArtifacts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectInputArtifacts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectInputArtifacts.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectInputArtifacts>() {
           @Override
           public void write(JsonWriter out, CreateProjectInputArtifacts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectInputArtifacts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectInputArtifacts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectInputArtifacts
   * @throws IOException if the JSON string is invalid with respect to CreateProjectInputArtifacts
   */
  public static CreateProjectInputArtifacts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectInputArtifacts.class);
  }

  /**
   * Convert an instance of CreateProjectInputArtifacts to an JSON string
   *
   * @return JSON string
   */
