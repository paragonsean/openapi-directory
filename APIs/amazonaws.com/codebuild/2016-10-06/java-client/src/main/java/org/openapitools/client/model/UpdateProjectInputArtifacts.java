...
public class UpdateProjectInputArtifacts {
  ...
  public UpdateProjectInputArtifacts() {
  }

  public UpdateProjectInputArtifacts type(ArtifactsType type) {
    this.type = type;
    return this;
  }
  ...
  public UpdateProjectInputArtifacts location(String location) {
  ...
  public UpdateProjectInputArtifacts path(String path) {
    this.path = path;
    return this;
  }
  ...
  public UpdateProjectInputArtifacts namespaceType(ArtifactNamespace namespaceType) {
  ...
  public UpdateProjectInputArtifacts name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateProjectInputArtifacts packaging(ArtifactPackaging packaging) {
  ...
  public UpdateProjectInputArtifacts overrideArtifactName(Boolean overrideArtifactName) {
  ...
  public UpdateProjectInputArtifacts encryptionDisabled(Boolean encryptionDisabled) {
  ...
  public UpdateProjectInputArtifacts artifactIdentifier(String artifactIdentifier) {
  ...
  public UpdateProjectInputArtifacts bucketOwnerAccess(BucketOwnerAccess bucketOwnerAccess) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateProjectInputArtifacts updateProjectInputArtifacts = (UpdateProjectInputArtifacts) o;
    return Objects.equals(this.type, updateProjectInputArtifacts.type) &&
        Objects.equals(this.location, updateProjectInputArtifacts.location) &&
        Objects.equals(this.path, updateProjectInputArtifacts.path) &&
        Objects.equals(this.namespaceType, updateProjectInputArtifacts.namespaceType) &&
        Objects.equals(this.name, updateProjectInputArtifacts.name) &&
        Objects.equals(this.packaging, updateProjectInputArtifacts.packaging) &&
        Objects.equals(this.overrideArtifactName, updateProjectInputArtifacts.overrideArtifactName) &&
        Objects.equals(this.encryptionDisabled, updateProjectInputArtifacts.encryptionDisabled) &&
        Objects.equals(this.artifactIdentifier, updateProjectInputArtifacts.artifactIdentifier) &&
        Objects.equals(this.bucketOwnerAccess, updateProjectInputArtifacts.bucketOwnerAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateProjectInputArtifacts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProjectInputArtifacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProjectInputArtifacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProjectInputArtifacts is not found in the empty JSON string", UpdateProjectInputArtifacts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProjectInputArtifacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProjectInputArtifacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateProjectInputArtifacts.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProjectInputArtifacts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProjectInputArtifacts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProjectInputArtifacts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProjectInputArtifacts.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProjectInputArtifacts>() {
           @Override
           public void write(JsonWriter out, UpdateProjectInputArtifacts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProjectInputArtifacts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProjectInputArtifacts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProjectInputArtifacts
   * @throws IOException if the JSON string is invalid with respect to UpdateProjectInputArtifacts
   */
  public static UpdateProjectInputArtifacts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProjectInputArtifacts.class);
  }

  /**
   * Convert an instance of UpdateProjectInputArtifacts to an JSON string
   *
   * @return JSON string
   */
