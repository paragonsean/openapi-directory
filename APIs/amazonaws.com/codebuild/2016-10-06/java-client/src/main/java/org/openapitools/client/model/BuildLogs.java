...
public class BuildLogs {
  ...
  public BuildLogs groupName(String groupName) {
  ...
  public BuildLogs streamName(String streamName) {
  ...
  public BuildLogs deepLink(String deepLink) {
  ...
  public BuildLogs s3DeepLink(String s3DeepLink) {
  ...
  public BuildLogs cloudWatchLogsArn(String cloudWatchLogsArn) {
  ...
  public BuildLogs s3LogsArn(String s3LogsArn) {
  ...
  public BuildLogs cloudWatchLogs(LogsLocationCloudWatchLogs cloudWatchLogs) {
  ...
  public BuildLogs s3Logs(LogsLocationS3Logs s3Logs) {
    this.s3Logs = s3Logs;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BuildLogs buildLogs = (BuildLogs) o;
    return Objects.equals(this.groupName, buildLogs.groupName) &&
        Objects.equals(this.streamName, buildLogs.streamName) &&
        Objects.equals(this.deepLink, buildLogs.deepLink) &&
        Objects.equals(this.s3DeepLink, buildLogs.s3DeepLink) &&
        Objects.equals(this.cloudWatchLogsArn, buildLogs.cloudWatchLogsArn) &&
        Objects.equals(this.s3LogsArn, buildLogs.s3LogsArn) &&
        Objects.equals(this.cloudWatchLogs, buildLogs.cloudWatchLogs) &&
        Objects.equals(this.s3Logs, buildLogs.s3Logs);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BuildLogs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BuildLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuildLogs is not found in the empty JSON string", BuildLogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BuildLogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuildLogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuildLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuildLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuildLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuildLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<BuildLogs>() {
           @Override
           public void write(JsonWriter out, BuildLogs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuildLogs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BuildLogs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BuildLogs
   * @throws IOException if the JSON string is invalid with respect to BuildLogs
   */
  public static BuildLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuildLogs.class);
  }

  /**
   * Convert an instance of BuildLogs to an JSON string
   *
   * @return JSON string
   */
