...
public class BuildBatch {
  ...
  public BuildBatch id(String id) {
    this.id = id;
    return this;
  }
  ...
  public BuildBatch arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public BuildBatch startTime(OffsetDateTime startTime) {
  ...
  public BuildBatch endTime(OffsetDateTime endTime) {
  ...
  public BuildBatch currentPhase(String currentPhase) {
  ...
  public BuildBatch buildBatchStatus(StatusType buildBatchStatus) {
  ...
  public BuildBatch sourceVersion(String sourceVersion) {
  ...
  public BuildBatch resolvedSourceVersion(String resolvedSourceVersion) {
  ...
  public BuildBatch projectName(String projectName) {
  ...
  public BuildBatch phases(List phases) {
    this.phases = phases;
    return this;
  }
  ...
  public BuildBatch source(ProjectSource source) {
    this.source = source;
    return this;
  }
  ...
  public BuildBatch secondarySources(List secondarySources) {
  ...
  public BuildBatch secondarySourceVersions(List secondarySourceVersions) {
  ...
  public BuildBatch artifacts(BuildBatchArtifacts artifacts) {
  ...
  public BuildBatch secondaryArtifacts(List secondaryArtifacts) {
  ...
  public BuildBatch cache(ProjectCache cache) {
    this.cache = cache;
    return this;
  }
  ...
  public BuildBatch environment(ProjectEnvironment environment) {
  ...
  public BuildBatch serviceRole(String serviceRole) {
  ...
  public BuildBatch logConfig(LogsConfig logConfig) {
  ...
  public BuildBatch buildTimeoutInMinutes(Integer buildTimeoutInMinutes) {
  ...
  public BuildBatch queuedTimeoutInMinutes(Integer queuedTimeoutInMinutes) {
  ...
  public BuildBatch complete(Boolean complete) {
  ...
  public BuildBatch initiator(String initiator) {
  ...
  public BuildBatch vpcConfig(VpcConfig vpcConfig) {
  ...
  public BuildBatch encryptionKey(String encryptionKey) {
  ...
  public BuildBatch buildBatchNumber(Integer buildBatchNumber) {
  ...
  public BuildBatch fileSystemLocations(List fileSystemLocations) {
  ...
  public BuildBatch buildBatchConfig(ProjectBuildBatchConfig buildBatchConfig) {
  ...
  public BuildBatch buildGroups(List buildGroups) {
  ...
  public BuildBatch debugSessionEnabled(Boolean debugSessionEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    BuildBatch buildBatch = (BuildBatch) o;
    return Objects.equals(this.id, buildBatch.id) &&
        Objects.equals(this.arn, buildBatch.arn) &&
        Objects.equals(this.startTime, buildBatch.startTime) &&
        Objects.equals(this.endTime, buildBatch.endTime) &&
        Objects.equals(this.currentPhase, buildBatch.currentPhase) &&
        Objects.equals(this.buildBatchStatus, buildBatch.buildBatchStatus) &&
        Objects.equals(this.sourceVersion, buildBatch.sourceVersion) &&
        Objects.equals(this.resolvedSourceVersion, buildBatch.resolvedSourceVersion) &&
        Objects.equals(this.projectName, buildBatch.projectName) &&
        Objects.equals(this.phases, buildBatch.phases) &&
        Objects.equals(this.source, buildBatch.source) &&
        Objects.equals(this.secondarySources, buildBatch.secondarySources) &&
        Objects.equals(this.secondarySourceVersions, buildBatch.secondarySourceVersions) &&
        Objects.equals(this.artifacts, buildBatch.artifacts) &&
        Objects.equals(this.secondaryArtifacts, buildBatch.secondaryArtifacts) &&
        Objects.equals(this.cache, buildBatch.cache) &&
        Objects.equals(this.environment, buildBatch.environment) &&
        Objects.equals(this.serviceRole, buildBatch.serviceRole) &&
        Objects.equals(this.logConfig, buildBatch.logConfig) &&
        Objects.equals(this.buildTimeoutInMinutes, buildBatch.buildTimeoutInMinutes) &&
        Objects.equals(this.queuedTimeoutInMinutes, buildBatch.queuedTimeoutInMinutes) &&
        Objects.equals(this.complete, buildBatch.complete) &&
        Objects.equals(this.initiator, buildBatch.initiator) &&
        Objects.equals(this.vpcConfig, buildBatch.vpcConfig) &&
        Objects.equals(this.encryptionKey, buildBatch.encryptionKey) &&
        Objects.equals(this.buildBatchNumber, buildBatch.buildBatchNumber) &&
        Objects.equals(this.fileSystemLocations, buildBatch.fileSystemLocations) &&
        Objects.equals(this.buildBatchConfig, buildBatch.buildBatchConfig) &&
        Objects.equals(this.buildGroups, buildBatch.buildGroups) &&
        Objects.equals(this.debugSessionEnabled, buildBatch.debugSessionEnabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BuildBatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BuildBatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuildBatch is not found in the empty JSON string", BuildBatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BuildBatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuildBatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuildBatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuildBatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuildBatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuildBatch.class));

       return (TypeAdapter<T>) new TypeAdapter<BuildBatch>() {
           @Override
           public void write(JsonWriter out, BuildBatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuildBatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BuildBatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BuildBatch
   * @throws IOException if the JSON string is invalid with respect to BuildBatch
   */
  public static BuildBatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuildBatch.class);
  }

  /**
   * Convert an instance of BuildBatch to an JSON string
   *
   * @return JSON string
   */
