...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIBatchDeleteBuildsInput create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIBatchDeleteBuildsInput Example::create(){
    OAIBatchDeleteBuildsInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::batchDeleteBuildsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::batchDeleteBuildsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIBatchDeleteBuildsInput oai_batch_delete_builds_input = create(); // OAIBatchDeleteBuildsInput | 
      ...
      apiInstance.batchDeleteBuilds(x_amz_targetoai_batch_delete_builds_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
