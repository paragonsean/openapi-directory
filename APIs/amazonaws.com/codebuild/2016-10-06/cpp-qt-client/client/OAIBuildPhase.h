...
#ifndef OAIBuildPhase_H
#define OAIBuildPhase_H
...
class OAIBuildPhase : public OAIObject {
public:
    OAIBuildPhase();
    OAIBuildPhase(QString json);
    ~OAIBuildPhase() override;
    ...
    OAIBuildPhaseType getPhaseType() const;
    void setPhaseType(const OAIBuildPhaseType &phase_type);
...
private:
    ...
    OAIBuildPhaseType m_phase_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuildPhase)

#endif // OAIBuildPhase_H
