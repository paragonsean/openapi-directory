...
/*
 * OAIProject_vpcConfig.h
 *
 * 
 */

#ifndef OAIProject_vpcConfig_H
#define OAIProject_vpcConfig_H
...
class OAIProject_vpcConfig : public OAIObject {
public:
    OAIProject_vpcConfig();
    OAIProject_vpcConfig(QString json);
    ~OAIProject_vpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProject_vpcConfig)

#endif // OAIProject_vpcConfig_H
