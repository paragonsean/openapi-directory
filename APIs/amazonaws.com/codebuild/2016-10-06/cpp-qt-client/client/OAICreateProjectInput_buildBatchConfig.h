...
/*
 * OAICreateProjectInput_buildBatchConfig.h
 *
 * 
 */

#ifndef OAICreateProjectInput_buildBatchConfig_H
#define OAICreateProjectInput_buildBatchConfig_H
...
class OAICreateProjectInput_buildBatchConfig : public OAIObject {
public:
    OAICreateProjectInput_buildBatchConfig();
    OAICreateProjectInput_buildBatchConfig(QString json);
    ~OAICreateProjectInput_buildBatchConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectInput_buildBatchConfig)

#endif // OAICreateProjectInput_buildBatchConfig_H
