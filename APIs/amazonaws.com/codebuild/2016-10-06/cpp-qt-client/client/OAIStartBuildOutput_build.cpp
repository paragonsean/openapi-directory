...
OAIStartBuildOutput_build::OAIStartBuildOutput_build(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartBuildOutput_build::OAIStartBuildOutput_build() {
    this->initializeModel();
}

OAIStartBuildOutput_build::~OAIStartBuildOutput_build() {}

void OAIStartBuildOutput_build::initializeModel() {
...
void OAIStartBuildOutput_build::fromJson(QString jsonString) {
...
void OAIStartBuildOutput_build::fromJsonObject(QJsonObject json) {
...
QString OAIStartBuildOutput_build::asJson() const {
...
QJsonObject OAIStartBuildOutput_build::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIStartBuildOutput_build::getId() const {
    return m_id;
}
void OAIStartBuildOutput_build::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStartBuildOutput_build::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStartBuildOutput_build::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIStartBuildOutput_build::getArn() const {
    return m_arn;
}
void OAIStartBuildOutput_build::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStartBuildOutput_build::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStartBuildOutput_build::is_arn_Valid() const{
    return m_arn_isValid;
}

qint32 OAIStartBuildOutput_build::getBuildNumber() const {
    return m_build_number;
}
void OAIStartBuildOutput_build::setBuildNumber(const qint32 &build_number) {
    m_build_number = build_number;
    m_build_number_isSet = true;
}

bool OAIStartBuildOutput_build::is_build_number_Set() const{
    return m_build_number_isSet;
}

bool OAIStartBuildOutput_build::is_build_number_Valid() const{
    return m_build_number_isValid;
}

QDateTime OAIStartBuildOutput_build::getStartTime() const {
    return m_start_time;
}
void OAIStartBuildOutput_build::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIStartBuildOutput_build::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIStartBuildOutput_build::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIStartBuildOutput_build::getEndTime() const {
    return m_end_time;
}
void OAIStartBuildOutput_build::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIStartBuildOutput_build::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIStartBuildOutput_build::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIStartBuildOutput_build::getCurrentPhase() const {
    return m_current_phase;
}
void OAIStartBuildOutput_build::setCurrentPhase(const QString &current_phase) {
    m_current_phase = current_phase;
    m_current_phase_isSet = true;
}

bool OAIStartBuildOutput_build::is_current_phase_Set() const{
    return m_current_phase_isSet;
}

bool OAIStartBuildOutput_build::is_current_phase_Valid() const{
    return m_current_phase_isValid;
}

OAIStatusType OAIStartBuildOutput_build::getBuildStatus() const {
    return m_build_status;
}
void OAIStartBuildOutput_build::setBuildStatus(const OAIStatusType &build_status) {
    m_build_status = build_status;
    m_build_status_isSet = true;
}

bool OAIStartBuildOutput_build::is_build_status_Set() const{
    return m_build_status_isSet;
}

bool OAIStartBuildOutput_build::is_build_status_Valid() const{
    return m_build_status_isValid;
}

QString OAIStartBuildOutput_build::getSourceVersion() const {
    return m_source_version;
}
void OAIStartBuildOutput_build::setSourceVersion(const QString &source_version) {
    m_source_version = source_version;
    m_source_version_isSet = true;
}

bool OAIStartBuildOutput_build::is_source_version_Set() const{
    return m_source_version_isSet;
}

bool OAIStartBuildOutput_build::is_source_version_Valid() const{
    return m_source_version_isValid;
}

QString OAIStartBuildOutput_build::getResolvedSourceVersion() const {
    return m_resolved_source_version;
}
void OAIStartBuildOutput_build::setResolvedSourceVersion(const QString &resolved_source_version) {
    m_resolved_source_version = resolved_source_version;
    m_resolved_source_version_isSet = true;
}

bool OAIStartBuildOutput_build::is_resolved_source_version_Set() const{
    return m_resolved_source_version_isSet;
}

bool OAIStartBuildOutput_build::is_resolved_source_version_Valid() const{
    return m_resolved_source_version_isValid;
}

QString OAIStartBuildOutput_build::getProjectName() const {
    return m_project_name;
}
void OAIStartBuildOutput_build::setProjectName(const QString &project_name) {
    m_project_name = project_name;
    m_project_name_isSet = true;
}

bool OAIStartBuildOutput_build::is_project_name_Set() const{
    return m_project_name_isSet;
}

bool OAIStartBuildOutput_build::is_project_name_Valid() const{
    return m_project_name_isValid;
}

QList OAIStartBuildOutput_build::getPhases() const {
    return m_phases;
}
void OAIStartBuildOutput_build::setPhases(const QList &phases) {
    m_phases = phases;
    m_phases_isSet = true;
}

bool OAIStartBuildOutput_build::is_phases_Set() const{
    return m_phases_isSet;
}

bool OAIStartBuildOutput_build::is_phases_Valid() const{
    return m_phases_isValid;
}

OAIBuild_source OAIStartBuildOutput_build::getSource() const {
    return m_source;
}
void OAIStartBuildOutput_build::setSource(const OAIBuild_source &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIStartBuildOutput_build::is_source_Set() const{
    return m_source_isSet;
}

bool OAIStartBuildOutput_build::is_source_Valid() const{
    return m_source_isValid;
}

QList OAIStartBuildOutput_build::getSecondarySources() const {
    return m_secondary_sources;
}
void OAIStartBuildOutput_build::setSecondarySources(const QList &secondary_sources) {
    m_secondary_sources = secondary_sources;
    m_secondary_sources_isSet = true;
}

bool OAIStartBuildOutput_build::is_secondary_sources_Set() const{
    return m_secondary_sources_isSet;
}

bool OAIStartBuildOutput_build::is_secondary_sources_Valid() const{
    return m_secondary_sources_isValid;
}

QList OAIStartBuildOutput_build::getSecondarySourceVersions() const {
    return m_secondary_source_versions;
}
void OAIStartBuildOutput_build::setSecondarySourceVersions(const QList &secondary_source_versions) {
    m_secondary_source_versions = secondary_source_versions;
    m_secondary_source_versions_isSet = true;
}

bool OAIStartBuildOutput_build::is_secondary_source_versions_Set() const{
    return m_secondary_source_versions_isSet;
}

bool OAIStartBuildOutput_build::is_secondary_source_versions_Valid() const{
    return m_secondary_source_versions_isValid;
}

OAIBuild_artifacts OAIStartBuildOutput_build::getArtifacts() const {
    return m_artifacts;
}
void OAIStartBuildOutput_build::setArtifacts(const OAIBuild_artifacts &artifacts) {
    m_artifacts = artifacts;
    m_artifacts_isSet = true;
}

bool OAIStartBuildOutput_build::is_artifacts_Set() const{
    return m_artifacts_isSet;
}

bool OAIStartBuildOutput_build::is_artifacts_Valid() const{
    return m_artifacts_isValid;
}

QList OAIStartBuildOutput_build::getSecondaryArtifacts() const {
    return m_secondary_artifacts;
}
void OAIStartBuildOutput_build::setSecondaryArtifacts(const QList &secondary_artifacts) {
    m_secondary_artifacts = secondary_artifacts;
    m_secondary_artifacts_isSet = true;
}

bool OAIStartBuildOutput_build::is_secondary_artifacts_Set() const{
    return m_secondary_artifacts_isSet;
}

bool OAIStartBuildOutput_build::is_secondary_artifacts_Valid() const{
    return m_secondary_artifacts_isValid;
}

OAIBuild_cache OAIStartBuildOutput_build::getCache() const {
    return m_cache;
}
void OAIStartBuildOutput_build::setCache(const OAIBuild_cache &cache) {
    m_cache = cache;
    m_cache_isSet = true;
}

bool OAIStartBuildOutput_build::is_cache_Set() const{
    return m_cache_isSet;
}

bool OAIStartBuildOutput_build::is_cache_Valid() const{
    return m_cache_isValid;
}

OAIBuild_environment OAIStartBuildOutput_build::getEnvironment() const {
    return m_environment;
}
void OAIStartBuildOutput_build::setEnvironment(const OAIBuild_environment &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAIStartBuildOutput_build::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAIStartBuildOutput_build::is_environment_Valid() const{
    return m_environment_isValid;
}

QString OAIStartBuildOutput_build::getServiceRole() const {
    return m_service_role;
}
void OAIStartBuildOutput_build::setServiceRole(const QString &service_role) {
    m_service_role = service_role;
    m_service_role_isSet = true;
}

bool OAIStartBuildOutput_build::is_service_role_Set() const{
    return m_service_role_isSet;
}

bool OAIStartBuildOutput_build::is_service_role_Valid() const{
    return m_service_role_isValid;
}

OAIBuild_logs OAIStartBuildOutput_build::getLogs() const {
    return m_logs;
}
void OAIStartBuildOutput_build::setLogs(const OAIBuild_logs &logs) {
    m_logs = logs;
    m_logs_isSet = true;
}

bool OAIStartBuildOutput_build::is_logs_Set() const{
    return m_logs_isSet;
}

bool OAIStartBuildOutput_build::is_logs_Valid() const{
    return m_logs_isValid;
}

qint32 OAIStartBuildOutput_build::getTimeoutInMinutes() const {
    return m_timeout_in_minutes;
}
void OAIStartBuildOutput_build::setTimeoutInMinutes(const qint32 &timeout_in_minutes) {
    m_timeout_in_minutes = timeout_in_minutes;
    m_timeout_in_minutes_isSet = true;
}

bool OAIStartBuildOutput_build::is_timeout_in_minutes_Set() const{
    return m_timeout_in_minutes_isSet;
}

bool OAIStartBuildOutput_build::is_timeout_in_minutes_Valid() const{
    return m_timeout_in_minutes_isValid;
}

qint32 OAIStartBuildOutput_build::getQueuedTimeoutInMinutes() const {
    return m_queued_timeout_in_minutes;
}
void OAIStartBuildOutput_build::setQueuedTimeoutInMinutes(const qint32 &queued_timeout_in_minutes) {
    m_queued_timeout_in_minutes = queued_timeout_in_minutes;
    m_queued_timeout_in_minutes_isSet = true;
}

bool OAIStartBuildOutput_build::is_queued_timeout_in_minutes_Set() const{
    return m_queued_timeout_in_minutes_isSet;
}

bool OAIStartBuildOutput_build::is_queued_timeout_in_minutes_Valid() const{
    return m_queued_timeout_in_minutes_isValid;
}

bool OAIStartBuildOutput_build::getBuildComplete() const {
    return m_build_complete;
}
void OAIStartBuildOutput_build::setBuildComplete(const bool &build_complete) {
    m_build_complete = build_complete;
    m_build_complete_isSet = true;
}

bool OAIStartBuildOutput_build::is_build_complete_Set() const{
    return m_build_complete_isSet;
}

bool OAIStartBuildOutput_build::is_build_complete_Valid() const{
    return m_build_complete_isValid;
}

QString OAIStartBuildOutput_build::getInitiator() const {
    return m_initiator;
}
void OAIStartBuildOutput_build::setInitiator(const QString &initiator) {
    m_initiator = initiator;
    m_initiator_isSet = true;
}

bool OAIStartBuildOutput_build::is_initiator_Set() const{
    return m_initiator_isSet;
}

bool OAIStartBuildOutput_build::is_initiator_Valid() const{
    return m_initiator_isValid;
}

OAIBuild_vpcConfig OAIStartBuildOutput_build::getVpcConfig() const {
    return m_vpc_config;
}
void OAIStartBuildOutput_build::setVpcConfig(const OAIBuild_vpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAIStartBuildOutput_build::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAIStartBuildOutput_build::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

OAIBuild_networkInterface OAIStartBuildOutput_build::getNetworkInterface() const {
    return m_network_interface;
}
void OAIStartBuildOutput_build::setNetworkInterface(const OAIBuild_networkInterface &network_interface) {
    m_network_interface = network_interface;
    m_network_interface_isSet = true;
}

bool OAIStartBuildOutput_build::is_network_interface_Set() const{
    return m_network_interface_isSet;
}

bool OAIStartBuildOutput_build::is_network_interface_Valid() const{
    return m_network_interface_isValid;
}

QString OAIStartBuildOutput_build::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIStartBuildOutput_build::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIStartBuildOutput_build::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIStartBuildOutput_build::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

QList OAIStartBuildOutput_build::getExportedEnvironmentVariables() const {
    return m_exported_environment_variables;
}
void OAIStartBuildOutput_build::setExportedEnvironmentVariables(const QList &exported_environment_variables) {
    m_exported_environment_variables = exported_environment_variables;
    m_exported_environment_variables_isSet = true;
}

bool OAIStartBuildOutput_build::is_exported_environment_variables_Set() const{
    return m_exported_environment_variables_isSet;
}

bool OAIStartBuildOutput_build::is_exported_environment_variables_Valid() const{
    return m_exported_environment_variables_isValid;
}

QList OAIStartBuildOutput_build::getReportArns() const {
    return m_report_arns;
}
void OAIStartBuildOutput_build::setReportArns(const QList &report_arns) {
    m_report_arns = report_arns;
    m_report_arns_isSet = true;
}

bool OAIStartBuildOutput_build::is_report_arns_Set() const{
    return m_report_arns_isSet;
}

bool OAIStartBuildOutput_build::is_report_arns_Valid() const{
    return m_report_arns_isValid;
}

QList OAIStartBuildOutput_build::getFileSystemLocations() const {
    return m_file_system_locations;
}
void OAIStartBuildOutput_build::setFileSystemLocations(const QList &file_system_locations) {
    m_file_system_locations = file_system_locations;
    m_file_system_locations_isSet = true;
}

bool OAIStartBuildOutput_build::is_file_system_locations_Set() const{
    return m_file_system_locations_isSet;
}

bool OAIStartBuildOutput_build::is_file_system_locations_Valid() const{
    return m_file_system_locations_isValid;
}

OAIBuild_debugSession OAIStartBuildOutput_build::getDebugSession() const {
    return m_debug_session;
}
void OAIStartBuildOutput_build::setDebugSession(const OAIBuild_debugSession &debug_session) {
    m_debug_session = debug_session;
    m_debug_session_isSet = true;
}

bool OAIStartBuildOutput_build::is_debug_session_Set() const{
    return m_debug_session_isSet;
}

bool OAIStartBuildOutput_build::is_debug_session_Valid() const{
    return m_debug_session_isValid;
}

QString OAIStartBuildOutput_build::getBuildBatchArn() const {
    return m_build_batch_arn;
}
void OAIStartBuildOutput_build::setBuildBatchArn(const QString &build_batch_arn) {
    m_build_batch_arn = build_batch_arn;
    m_build_batch_arn_isSet = true;
}

bool OAIStartBuildOutput_build::is_build_batch_arn_Set() const{
    return m_build_batch_arn_isSet;
}

bool OAIStartBuildOutput_build::is_build_batch_arn_Valid() const{
    return m_build_batch_arn_isValid;
}

bool OAIStartBuildOutput_build::isSet() const {
...
bool OAIStartBuildOutput_build::isValid() const {
