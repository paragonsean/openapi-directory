...
/*
 * OAICloudWatchLogsConfig.h
 *
 *  Information about CloudWatch Logs for a build project. 
 */

#ifndef OAICloudWatchLogsConfig_H
#define OAICloudWatchLogsConfig_H
...
class OAICloudWatchLogsConfig : public OAIObject {
public:
    OAICloudWatchLogsConfig();
    OAICloudWatchLogsConfig(QString json);
    ~OAICloudWatchLogsConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudWatchLogsConfig)

#endif // OAICloudWatchLogsConfig_H
