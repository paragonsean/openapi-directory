...
/*
 * OAIBuild_environment.h
 *
 * 
 */

#ifndef OAIBuild_environment_H
#define OAIBuild_environment_H
...
class OAIBuild_environment : public OAIObject {
public:
    OAIBuild_environment();
    OAIBuild_environment(QString json);
    ~OAIBuild_environment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuild_environment)

#endif // OAIBuild_environment_H
