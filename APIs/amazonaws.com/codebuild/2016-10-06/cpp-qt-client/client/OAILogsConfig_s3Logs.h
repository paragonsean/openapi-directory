...
/*
 * OAILogsConfig_s3Logs.h
 *
 * 
 */

#ifndef OAILogsConfig_s3Logs_H
#define OAILogsConfig_s3Logs_H
...
class OAILogsConfig_s3Logs : public OAIObject {
public:
    OAILogsConfig_s3Logs();
    OAILogsConfig_s3Logs(QString json);
    ~OAILogsConfig_s3Logs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogsConfig_s3Logs)

#endif // OAILogsConfig_s3Logs_H
