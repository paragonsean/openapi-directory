...
/*
 * OAITestReportSummary.h
 *
 *  Information about a test report. 
 */

#ifndef OAITestReportSummary_H
#define OAITestReportSummary_H
...
class OAITestReportSummary : public OAIObject {
public:
    OAITestReportSummary();
    OAITestReportSummary(QString json);
    ~OAITestReportSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestReportSummary)

#endif // OAITestReportSummary_H
