...
#ifndef OAIProject_source_H
#define OAIProject_source_H
...
class OAIProject_source : public OAIObject {
public:
    OAIProject_source();
    OAIProject_source(QString json);
    ~OAIProject_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProject_source)

#endif // OAIProject_source_H
