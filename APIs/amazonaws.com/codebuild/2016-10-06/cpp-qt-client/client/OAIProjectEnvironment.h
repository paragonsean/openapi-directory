...
/*
 * OAIProjectEnvironment.h
 *
 * Information about the build environment of the build project.
 */

#ifndef OAIProjectEnvironment_H
#define OAIProjectEnvironment_H
...
class OAIProjectEnvironment : public OAIObject {
public:
    OAIProjectEnvironment();
    OAIProjectEnvironment(QString json);
    ~OAIProjectEnvironment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectEnvironment)

#endif // OAIProjectEnvironment_H
