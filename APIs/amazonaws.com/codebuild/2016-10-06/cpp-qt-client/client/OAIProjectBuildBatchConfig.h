...
/*
 * OAIProjectBuildBatchConfig.h
 *
 * Contains configuration information about a batch build project.
 */

#ifndef OAIProjectBuildBatchConfig_H
#define OAIProjectBuildBatchConfig_H
...
class OAIProjectBuildBatchConfig : public OAIObject {
public:
    OAIProjectBuildBatchConfig();
    OAIProjectBuildBatchConfig(QString json);
    ~OAIProjectBuildBatchConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectBuildBatchConfig)

#endif // OAIProjectBuildBatchConfig_H
