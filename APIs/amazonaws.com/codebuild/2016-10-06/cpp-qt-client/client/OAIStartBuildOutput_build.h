...
/*
 * OAIStartBuildOutput_build.h
 *
 * 
 */

#ifndef OAIStartBuildOutput_build_H
#define OAIStartBuildOutput_build_H
...
class OAIStartBuildOutput_build : public OAIObject {
public:
    OAIStartBuildOutput_build();
    OAIStartBuildOutput_build(QString json);
    ~OAIStartBuildOutput_build() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartBuildOutput_build)

#endif // OAIStartBuildOutput_build_H
