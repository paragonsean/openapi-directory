...
OAIProject_source::OAIProject_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProject_source::OAIProject_source() {
    this->initializeModel();
}

OAIProject_source::~OAIProject_source() {}

void OAIProject_source::initializeModel() {
...
void OAIProject_source::fromJson(QString jsonString) {
...
void OAIProject_source::fromJsonObject(QJsonObject json) {
...
QString OAIProject_source::asJson() const {
...
QJsonObject OAIProject_source::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAISourceType OAIProject_source::getType() const {
    return m_type;
}
void OAIProject_source::setType(const OAISourceType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIProject_source::is_type_Set() const{
    return m_type_isSet;
}

bool OAIProject_source::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIProject_source::getLocation() const {
    return m_location;
}
void OAIProject_source::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIProject_source::is_location_Set() const{
    return m_location_isSet;
}

bool OAIProject_source::is_location_Valid() const{
    return m_location_isValid;
}

qint32 OAIProject_source::getGitCloneDepth() const {
    return m_git_clone_depth;
}
void OAIProject_source::setGitCloneDepth(const qint32 &git_clone_depth) {
    m_git_clone_depth = git_clone_depth;
    m_git_clone_depth_isSet = true;
}

bool OAIProject_source::is_git_clone_depth_Set() const{
    return m_git_clone_depth_isSet;
}

bool OAIProject_source::is_git_clone_depth_Valid() const{
    return m_git_clone_depth_isValid;
}

OAIProjectSource_gitSubmodulesConfig OAIProject_source::getGitSubmodulesConfig() const {
    return m_git_submodules_config;
}
void OAIProject_source::setGitSubmodulesConfig(const OAIProjectSource_gitSubmodulesConfig &git_submodules_config) {
    m_git_submodules_config = git_submodules_config;
    m_git_submodules_config_isSet = true;
}

bool OAIProject_source::is_git_submodules_config_Set() const{
    return m_git_submodules_config_isSet;
}

bool OAIProject_source::is_git_submodules_config_Valid() const{
    return m_git_submodules_config_isValid;
}

QString OAIProject_source::getBuildspec() const {
    return m_buildspec;
}
void OAIProject_source::setBuildspec(const QString &buildspec) {
    m_buildspec = buildspec;
    m_buildspec_isSet = true;
}

bool OAIProject_source::is_buildspec_Set() const{
    return m_buildspec_isSet;
}

bool OAIProject_source::is_buildspec_Valid() const{
    return m_buildspec_isValid;
}

OAIProjectSource_auth OAIProject_source::getAuth() const {
    return m_auth;
}
void OAIProject_source::setAuth(const OAIProjectSource_auth &auth) {
    m_auth = auth;
    m_auth_isSet = true;
}

bool OAIProject_source::is_auth_Set() const{
    return m_auth_isSet;
}

bool OAIProject_source::is_auth_Valid() const{
    return m_auth_isValid;
}

bool OAIProject_source::getReportBuildStatus() const {
    return m_report_build_status;
}
void OAIProject_source::setReportBuildStatus(const bool &report_build_status) {
    m_report_build_status = report_build_status;
    m_report_build_status_isSet = true;
}

bool OAIProject_source::is_report_build_status_Set() const{
    return m_report_build_status_isSet;
}

bool OAIProject_source::is_report_build_status_Valid() const{
    return m_report_build_status_isValid;
}

OAIStartBuildInput_buildStatusConfigOverride OAIProject_source::getBuildStatusConfig() const {
    return m_build_status_config;
}
void OAIProject_source::setBuildStatusConfig(const OAIStartBuildInput_buildStatusConfigOverride &build_status_config) {
    m_build_status_config = build_status_config;
    m_build_status_config_isSet = true;
}

bool OAIProject_source::is_build_status_config_Set() const{
    return m_build_status_config_isSet;
}

bool OAIProject_source::is_build_status_config_Valid() const{
    return m_build_status_config_isValid;
}

bool OAIProject_source::getInsecureSsl() const {
    return m_insecure_ssl;
}
void OAIProject_source::setInsecureSsl(const bool &insecure_ssl) {
    m_insecure_ssl = insecure_ssl;
    m_insecure_ssl_isSet = true;
}

bool OAIProject_source::is_insecure_ssl_Set() const{
    return m_insecure_ssl_isSet;
}

bool OAIProject_source::is_insecure_ssl_Valid() const{
    return m_insecure_ssl_isValid;
}

QString OAIProject_source::getSourceIdentifier() const {
    return m_source_identifier;
}
void OAIProject_source::setSourceIdentifier(const QString &source_identifier) {
    m_source_identifier = source_identifier;
    m_source_identifier_isSet = true;
}

bool OAIProject_source::is_source_identifier_Set() const{
    return m_source_identifier_isSet;
}

bool OAIProject_source::is_source_identifier_Valid() const{
    return m_source_identifier_isValid;
}

bool OAIProject_source::isSet() const {
...
bool OAIProject_source::isValid() const {
