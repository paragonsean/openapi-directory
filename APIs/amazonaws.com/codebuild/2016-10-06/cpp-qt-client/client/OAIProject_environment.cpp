...
OAIProject_environment::OAIProject_environment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProject_environment::OAIProject_environment() {
    this->initializeModel();
}

OAIProject_environment::~OAIProject_environment() {}

void OAIProject_environment::initializeModel() {
...
void OAIProject_environment::fromJson(QString jsonString) {
...
void OAIProject_environment::fromJsonObject(QJsonObject json) {
...
QString OAIProject_environment::asJson() const {
...
QJsonObject OAIProject_environment::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIEnvironmentType OAIProject_environment::getType() const {
    return m_type;
}
void OAIProject_environment::setType(const OAIEnvironmentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIProject_environment::is_type_Set() const{
    return m_type_isSet;
}

bool OAIProject_environment::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIProject_environment::getImage() const {
    return m_image;
}
void OAIProject_environment::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIProject_environment::is_image_Set() const{
    return m_image_isSet;
}

bool OAIProject_environment::is_image_Valid() const{
    return m_image_isValid;
}

OAIComputeType OAIProject_environment::getComputeType() const {
    return m_compute_type;
}
void OAIProject_environment::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIProject_environment::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIProject_environment::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QList OAIProject_environment::getEnvironmentVariables() const {
    return m_environment_variables;
}
void OAIProject_environment::setEnvironmentVariables(const QList &environment_variables) {
    m_environment_variables = environment_variables;
    m_environment_variables_isSet = true;
}

bool OAIProject_environment::is_environment_variables_Set() const{
    return m_environment_variables_isSet;
}

bool OAIProject_environment::is_environment_variables_Valid() const{
    return m_environment_variables_isValid;
}

bool OAIProject_environment::getPrivilegedMode() const {
    return m_privileged_mode;
}
void OAIProject_environment::setPrivilegedMode(const bool &privileged_mode) {
    m_privileged_mode = privileged_mode;
    m_privileged_mode_isSet = true;
}

bool OAIProject_environment::is_privileged_mode_Set() const{
    return m_privileged_mode_isSet;
}

bool OAIProject_environment::is_privileged_mode_Valid() const{
    return m_privileged_mode_isValid;
}

QString OAIProject_environment::getCertificate() const {
    return m_certificate;
}
void OAIProject_environment::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIProject_environment::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIProject_environment::is_certificate_Valid() const{
    return m_certificate_isValid;
}

OAIProjectEnvironment_registryCredential OAIProject_environment::getRegistryCredential() const {
    return m_registry_credential;
}
void OAIProject_environment::setRegistryCredential(const OAIProjectEnvironment_registryCredential &registry_credential) {
    m_registry_credential = registry_credential;
    m_registry_credential_isSet = true;
}

bool OAIProject_environment::is_registry_credential_Set() const{
    return m_registry_credential_isSet;
}

bool OAIProject_environment::is_registry_credential_Valid() const{
    return m_registry_credential_isValid;
}

OAIImagePullCredentialsType OAIProject_environment::getImagePullCredentialsType() const {
    return m_image_pull_credentials_type;
}
void OAIProject_environment::setImagePullCredentialsType(const OAIImagePullCredentialsType &image_pull_credentials_type) {
    m_image_pull_credentials_type = image_pull_credentials_type;
    m_image_pull_credentials_type_isSet = true;
}

bool OAIProject_environment::is_image_pull_credentials_type_Set() const{
    return m_image_pull_credentials_type_isSet;
}

bool OAIProject_environment::is_image_pull_credentials_type_Valid() const{
    return m_image_pull_credentials_type_isValid;
}

bool OAIProject_environment::isSet() const {
...
bool OAIProject_environment::isValid() const {
