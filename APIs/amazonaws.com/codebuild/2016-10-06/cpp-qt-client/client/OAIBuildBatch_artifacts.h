...
/*
 * OAIBuildBatch_artifacts.h
 *
 * 
 */

#ifndef OAIBuildBatch_artifacts_H
#define OAIBuildBatch_artifacts_H
...
class OAIBuildBatch_artifacts : public OAIObject {
public:
    OAIBuildBatch_artifacts();
    OAIBuildBatch_artifacts(QString json);
    ~OAIBuildBatch_artifacts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuildBatch_artifacts)

#endif // OAIBuildBatch_artifacts_H
