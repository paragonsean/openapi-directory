...
/*
 * OAIUpdateProjectInput_source.h
 *
 * 
 */

#ifndef OAIUpdateProjectInput_source_H
#define OAIUpdateProjectInput_source_H
...
class OAIUpdateProjectInput_source : public OAIObject {
public:
    OAIUpdateProjectInput_source();
    OAIUpdateProjectInput_source(QString json);
    ~OAIUpdateProjectInput_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProjectInput_source)

#endif // OAIUpdateProjectInput_source_H
