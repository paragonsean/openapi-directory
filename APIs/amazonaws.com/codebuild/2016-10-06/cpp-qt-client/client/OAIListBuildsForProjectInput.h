...
/*
 * OAIListBuildsForProjectInput.h
 *
 * 
 */

#ifndef OAIListBuildsForProjectInput_H
#define OAIListBuildsForProjectInput_H
...
class OAIListBuildsForProjectInput : public OAIObject {
public:
    OAIListBuildsForProjectInput();
    OAIListBuildsForProjectInput(QString json);
    ~OAIListBuildsForProjectInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBuildsForProjectInput)

#endif // OAIListBuildsForProjectInput_H
