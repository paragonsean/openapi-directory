...
/*
 * OAIBuild_artifacts.h
 *
 * 
 */

#ifndef OAIBuild_artifacts_H
#define OAIBuild_artifacts_H
...
class OAIBuild_artifacts : public OAIObject {
public:
    OAIBuild_artifacts();
    OAIBuild_artifacts(QString json);
    ~OAIBuild_artifacts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuild_artifacts)

#endif // OAIBuild_artifacts_H
