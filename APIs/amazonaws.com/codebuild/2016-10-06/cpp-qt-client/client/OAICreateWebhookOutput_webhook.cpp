...
OAICreateWebhookOutput_webhook::OAICreateWebhookOutput_webhook(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateWebhookOutput_webhook::OAICreateWebhookOutput_webhook() {
    this->initializeModel();
}

OAICreateWebhookOutput_webhook::~OAICreateWebhookOutput_webhook() {}

void OAICreateWebhookOutput_webhook::initializeModel() {
...
void OAICreateWebhookOutput_webhook::fromJson(QString jsonString) {
...
void OAICreateWebhookOutput_webhook::fromJsonObject(QJsonObject json) {
...
QString OAICreateWebhookOutput_webhook::asJson() const {
...
QJsonObject OAICreateWebhookOutput_webhook::asJsonObject() const {
    QJsonObject obj;
    if (m_url_isSet) {
...
QString OAICreateWebhookOutput_webhook::getUrl() const {
    return m_url;
}
void OAICreateWebhookOutput_webhook::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAICreateWebhookOutput_webhook::is_url_Set() const{
    return m_url_isSet;
}

bool OAICreateWebhookOutput_webhook::is_url_Valid() const{
    return m_url_isValid;
}

QString OAICreateWebhookOutput_webhook::getPayloadUrl() const {
    return m_payload_url;
}
void OAICreateWebhookOutput_webhook::setPayloadUrl(const QString &payload_url) {
    m_payload_url = payload_url;
    m_payload_url_isSet = true;
}

bool OAICreateWebhookOutput_webhook::is_payload_url_Set() const{
    return m_payload_url_isSet;
}

bool OAICreateWebhookOutput_webhook::is_payload_url_Valid() const{
    return m_payload_url_isValid;
}

QString OAICreateWebhookOutput_webhook::getSecret() const {
    return m_secret;
}
void OAICreateWebhookOutput_webhook::setSecret(const QString &secret) {
    m_secret = secret;
    m_secret_isSet = true;
}

bool OAICreateWebhookOutput_webhook::is_secret_Set() const{
    return m_secret_isSet;
}

bool OAICreateWebhookOutput_webhook::is_secret_Valid() const{
    return m_secret_isValid;
}

QString OAICreateWebhookOutput_webhook::getBranchFilter() const {
    return m_branch_filter;
}
void OAICreateWebhookOutput_webhook::setBranchFilter(const QString &branch_filter) {
    m_branch_filter = branch_filter;
    m_branch_filter_isSet = true;
}

bool OAICreateWebhookOutput_webhook::is_branch_filter_Set() const{
    return m_branch_filter_isSet;
}

bool OAICreateWebhookOutput_webhook::is_branch_filter_Valid() const{
    return m_branch_filter_isValid;
}

QList OAICreateWebhookOutput_webhook::getFilterGroups() const {
    return m_filter_groups;
}
void OAICreateWebhookOutput_webhook::setFilterGroups(const QList &filter_groups) {
    m_filter_groups = filter_groups;
    m_filter_groups_isSet = true;
}

bool OAICreateWebhookOutput_webhook::is_filter_groups_Set() const{
    return m_filter_groups_isSet;
}

bool OAICreateWebhookOutput_webhook::is_filter_groups_Valid() const{
    return m_filter_groups_isValid;
}

OAIWebhookBuildType OAICreateWebhookOutput_webhook::getBuildType() const {
    return m_build_type;
}
void OAICreateWebhookOutput_webhook::setBuildType(const OAIWebhookBuildType &build_type) {
    m_build_type = build_type;
    m_build_type_isSet = true;
}

bool OAICreateWebhookOutput_webhook::is_build_type_Set() const{
    return m_build_type_isSet;
}

bool OAICreateWebhookOutput_webhook::is_build_type_Valid() const{
    return m_build_type_isValid;
}

QDateTime OAICreateWebhookOutput_webhook::getLastModifiedSecret() const {
    return m_last_modified_secret;
}
void OAICreateWebhookOutput_webhook::setLastModifiedSecret(const QDateTime &last_modified_secret) {
    m_last_modified_secret = last_modified_secret;
    m_last_modified_secret_isSet = true;
}

bool OAICreateWebhookOutput_webhook::is_last_modified_secret_Set() const{
    return m_last_modified_secret_isSet;
}

bool OAICreateWebhookOutput_webhook::is_last_modified_secret_Valid() const{
    return m_last_modified_secret_isValid;
}

bool OAICreateWebhookOutput_webhook::isSet() const {
...
bool OAICreateWebhookOutput_webhook::isValid() const {
