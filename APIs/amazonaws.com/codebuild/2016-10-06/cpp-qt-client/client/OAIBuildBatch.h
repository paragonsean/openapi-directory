...
#ifndef OAIBuildBatch_H
#define OAIBuildBatch_H
...
class OAIBuildBatch : public OAIObject {
public:
    OAIBuildBatch();
    OAIBuildBatch(QString json);
    ~OAIBuildBatch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuildBatch)

#endif // OAIBuildBatch_H
