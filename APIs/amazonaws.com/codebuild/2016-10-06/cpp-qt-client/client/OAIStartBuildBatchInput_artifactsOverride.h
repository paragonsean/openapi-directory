...
/*
 * OAIStartBuildBatchInput_artifactsOverride.h
 *
 * 
 */

#ifndef OAIStartBuildBatchInput_artifactsOverride_H
#define OAIStartBuildBatchInput_artifactsOverride_H
...
class OAIStartBuildBatchInput_artifactsOverride : public OAIObject {
public:
    OAIStartBuildBatchInput_artifactsOverride();
    OAIStartBuildBatchInput_artifactsOverride(QString json);
    ~OAIStartBuildBatchInput_artifactsOverride() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartBuildBatchInput_artifactsOverride)

#endif // OAIStartBuildBatchInput_artifactsOverride_H
