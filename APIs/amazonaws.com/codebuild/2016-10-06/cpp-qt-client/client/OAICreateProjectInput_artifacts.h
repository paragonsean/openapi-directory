...
/*
 * OAICreateProjectInput_artifacts.h
 *
 * 
 */

#ifndef OAICreateProjectInput_artifacts_H
#define OAICreateProjectInput_artifacts_H
...
class OAICreateProjectInput_artifacts : public OAIObject {
public:
    OAICreateProjectInput_artifacts();
    OAICreateProjectInput_artifacts(QString json);
    ~OAICreateProjectInput_artifacts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectInput_artifacts)

#endif // OAICreateProjectInput_artifacts_H
