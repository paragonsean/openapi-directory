...
/*
 * OAIProject_environment.h
 *
 * 
 */

#ifndef OAIProject_environment_H
#define OAIProject_environment_H
...
class OAIProject_environment : public OAIObject {
public:
    OAIProject_environment();
    OAIProject_environment(QString json);
    ~OAIProject_environment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProject_environment)

#endif // OAIProject_environment_H
