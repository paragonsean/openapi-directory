...
OAICreateProjectInput_environment::OAICreateProjectInput_environment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateProjectInput_environment::OAICreateProjectInput_environment() {
    this->initializeModel();
}

OAICreateProjectInput_environment::~OAICreateProjectInput_environment() {}

void OAICreateProjectInput_environment::initializeModel() {
...
void OAICreateProjectInput_environment::fromJson(QString jsonString) {
...
void OAICreateProjectInput_environment::fromJsonObject(QJsonObject json) {
...
QString OAICreateProjectInput_environment::asJson() const {
...
QJsonObject OAICreateProjectInput_environment::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIEnvironmentType OAICreateProjectInput_environment::getType() const {
    return m_type;
}
void OAICreateProjectInput_environment::setType(const OAIEnvironmentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateProjectInput_environment::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateProjectInput_environment::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICreateProjectInput_environment::getImage() const {
    return m_image;
}
void OAICreateProjectInput_environment::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAICreateProjectInput_environment::is_image_Set() const{
    return m_image_isSet;
}

bool OAICreateProjectInput_environment::is_image_Valid() const{
    return m_image_isValid;
}

OAIComputeType OAICreateProjectInput_environment::getComputeType() const {
    return m_compute_type;
}
void OAICreateProjectInput_environment::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAICreateProjectInput_environment::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAICreateProjectInput_environment::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QList OAICreateProjectInput_environment::getEnvironmentVariables() const {
    return m_environment_variables;
}
void OAICreateProjectInput_environment::setEnvironmentVariables(const QList &environment_variables) {
    m_environment_variables = environment_variables;
    m_environment_variables_isSet = true;
}

bool OAICreateProjectInput_environment::is_environment_variables_Set() const{
    return m_environment_variables_isSet;
}

bool OAICreateProjectInput_environment::is_environment_variables_Valid() const{
    return m_environment_variables_isValid;
}

bool OAICreateProjectInput_environment::getPrivilegedMode() const {
    return m_privileged_mode;
}
void OAICreateProjectInput_environment::setPrivilegedMode(const bool &privileged_mode) {
    m_privileged_mode = privileged_mode;
    m_privileged_mode_isSet = true;
}

bool OAICreateProjectInput_environment::is_privileged_mode_Set() const{
    return m_privileged_mode_isSet;
}

bool OAICreateProjectInput_environment::is_privileged_mode_Valid() const{
    return m_privileged_mode_isValid;
}

QString OAICreateProjectInput_environment::getCertificate() const {
    return m_certificate;
}
void OAICreateProjectInput_environment::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAICreateProjectInput_environment::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAICreateProjectInput_environment::is_certificate_Valid() const{
    return m_certificate_isValid;
}

OAIProjectEnvironment_registryCredential OAICreateProjectInput_environment::getRegistryCredential() const {
    return m_registry_credential;
}
void OAICreateProjectInput_environment::setRegistryCredential(const OAIProjectEnvironment_registryCredential &registry_credential) {
    m_registry_credential = registry_credential;
    m_registry_credential_isSet = true;
}

bool OAICreateProjectInput_environment::is_registry_credential_Set() const{
    return m_registry_credential_isSet;
}

bool OAICreateProjectInput_environment::is_registry_credential_Valid() const{
    return m_registry_credential_isValid;
}

OAIImagePullCredentialsType OAICreateProjectInput_environment::getImagePullCredentialsType() const {
    return m_image_pull_credentials_type;
}
void OAICreateProjectInput_environment::setImagePullCredentialsType(const OAIImagePullCredentialsType &image_pull_credentials_type) {
    m_image_pull_credentials_type = image_pull_credentials_type;
    m_image_pull_credentials_type_isSet = true;
}

bool OAICreateProjectInput_environment::is_image_pull_credentials_type_Set() const{
    return m_image_pull_credentials_type_isSet;
}

bool OAICreateProjectInput_environment::is_image_pull_credentials_type_Valid() const{
    return m_image_pull_credentials_type_isValid;
}

bool OAICreateProjectInput_environment::isSet() const {
...
bool OAICreateProjectInput_environment::isValid() const {
