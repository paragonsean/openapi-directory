...
/*
 * OAICreateProjectInput_source.h
 *
 * 
 */

#ifndef OAICreateProjectInput_source_H
#define OAICreateProjectInput_source_H
...
class OAICreateProjectInput_source : public OAIObject {
public:
    OAICreateProjectInput_source();
    OAICreateProjectInput_source(QString json);
    ~OAICreateProjectInput_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectInput_source)

#endif // OAICreateProjectInput_source_H
