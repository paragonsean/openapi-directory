...
#ifndef OAIBuild_cache_H
#define OAIBuild_cache_H
...
class OAIBuild_cache : public OAIObject {
public:
    OAIBuild_cache();
    OAIBuild_cache(QString json);
    ~OAIBuild_cache() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuild_cache)

#endif // OAIBuild_cache_H
