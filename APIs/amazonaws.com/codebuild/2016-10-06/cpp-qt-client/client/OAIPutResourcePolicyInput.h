...
/*
 * OAIPutResourcePolicyInput.h
 *
 * 
 */

#ifndef OAIPutResourcePolicyInput_H
#define OAIPutResourcePolicyInput_H
...
class OAIPutResourcePolicyInput : public OAIObject {
public:
    OAIPutResourcePolicyInput();
    OAIPutResourcePolicyInput(QString json);
    ~OAIPutResourcePolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutResourcePolicyInput)

#endif // OAIPutResourcePolicyInput_H
