...
/*
 * OAIBuildStatusConfig.h
 *
 * Contains information that defines how the CodeBuild build project reports the build status to the source provider. 
 */

#ifndef OAIBuildStatusConfig_H
#define OAIBuildStatusConfig_H
...
class OAIBuildStatusConfig : public OAIObject {
public:
    OAIBuildStatusConfig();
    OAIBuildStatusConfig(QString json);
    ~OAIBuildStatusConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuildStatusConfig)

#endif // OAIBuildStatusConfig_H
