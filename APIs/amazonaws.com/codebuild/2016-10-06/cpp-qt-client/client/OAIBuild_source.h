...
#ifndef OAIBuild_source_H
#define OAIBuild_source_H
...
class OAIBuild_source : public OAIObject {
public:
    OAIBuild_source();
    OAIBuild_source(QString json);
    ~OAIBuild_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuild_source)

#endif // OAIBuild_source_H
