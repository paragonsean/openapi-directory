...
OAILogsConfig::OAILogsConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILogsConfig::OAILogsConfig() {
    this->initializeModel();
}

OAILogsConfig::~OAILogsConfig() {}

void OAILogsConfig::initializeModel() {
...
void OAILogsConfig::fromJson(QString jsonString) {
...
void OAILogsConfig::fromJsonObject(QJsonObject json) {
...
QString OAILogsConfig::asJson() const {
...
QJsonObject OAILogsConfig::asJsonObject() const {
    QJsonObject obj;
...
OAILogsConfig_cloudWatchLogs OAILogsConfig::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAILogsConfig::setCloudWatchLogs(const OAILogsConfig_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAILogsConfig::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAILogsConfig::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAILogsConfig_s3Logs OAILogsConfig::getS3Logs() const {
    return m_s3_logs;
}
void OAILogsConfig::setS3Logs(const OAILogsConfig_s3Logs &s3_logs) {
    m_s3_logs = s3_logs;
    m_s3_logs_isSet = true;
}

bool OAILogsConfig::is_s3_logs_Set() const{
    return m_s3_logs_isSet;
}

bool OAILogsConfig::is_s3_logs_Valid() const{
    return m_s3_logs_isValid;
}

bool OAILogsConfig::isSet() const {
...
bool OAILogsConfig::isValid() const {
