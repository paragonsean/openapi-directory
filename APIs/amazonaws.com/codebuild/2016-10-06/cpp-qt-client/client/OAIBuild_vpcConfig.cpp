...
OAIBuild_vpcConfig::OAIBuild_vpcConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBuild_vpcConfig::OAIBuild_vpcConfig() {
    this->initializeModel();
}

OAIBuild_vpcConfig::~OAIBuild_vpcConfig() {}

void OAIBuild_vpcConfig::initializeModel() {
...
void OAIBuild_vpcConfig::fromJson(QString jsonString) {
...
void OAIBuild_vpcConfig::fromJsonObject(QJsonObject json) {
...
QString OAIBuild_vpcConfig::asJson() const {
...
QJsonObject OAIBuild_vpcConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_vpc_id_isSet) {
...
QString OAIBuild_vpcConfig::getVpcId() const {
    return m_vpc_id;
}
void OAIBuild_vpcConfig::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIBuild_vpcConfig::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIBuild_vpcConfig::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QList OAIBuild_vpcConfig::getSubnets() const {
    return m_subnets;
}
void OAIBuild_vpcConfig::setSubnets(const QList &subnets) {
    m_subnets = subnets;
    m_subnets_isSet = true;
}

bool OAIBuild_vpcConfig::is_subnets_Set() const{
    return m_subnets_isSet;
}

bool OAIBuild_vpcConfig::is_subnets_Valid() const{
    return m_subnets_isValid;
}

QList OAIBuild_vpcConfig::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIBuild_vpcConfig::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIBuild_vpcConfig::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIBuild_vpcConfig::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

bool OAIBuild_vpcConfig::isSet() const {
...
bool OAIBuild_vpcConfig::isValid() const {
