...
/*
 * OAICreateProjectOutput_project.h
 *
 * 
 */

#ifndef OAICreateProjectOutput_project_H
#define OAICreateProjectOutput_project_H
...
class OAICreateProjectOutput_project : public OAIObject {
public:
    OAICreateProjectOutput_project();
    OAICreateProjectOutput_project(QString json);
    ~OAICreateProjectOutput_project() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectOutput_project)

#endif // OAICreateProjectOutput_project_H
