...
OAIBuildBatch_artifacts::OAIBuildBatch_artifacts(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBuildBatch_artifacts::OAIBuildBatch_artifacts() {
    this->initializeModel();
}

OAIBuildBatch_artifacts::~OAIBuildBatch_artifacts() {}

void OAIBuildBatch_artifacts::initializeModel() {
...
void OAIBuildBatch_artifacts::fromJson(QString jsonString) {
...
void OAIBuildBatch_artifacts::fromJsonObject(QJsonObject json) {
...
QString OAIBuildBatch_artifacts::asJson() const {
...
QJsonObject OAIBuildBatch_artifacts::asJsonObject() const {
    QJsonObject obj;
    if (m_location_isSet) {
...
QString OAIBuildBatch_artifacts::getLocation() const {
    return m_location;
}
void OAIBuildBatch_artifacts::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIBuildBatch_artifacts::is_location_Set() const{
    return m_location_isSet;
}

bool OAIBuildBatch_artifacts::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIBuildBatch_artifacts::getSha256sum() const {
    return m_sha256sum;
}
void OAIBuildBatch_artifacts::setSha256sum(const QString &sha256sum) {
    m_sha256sum = sha256sum;
    m_sha256sum_isSet = true;
}

bool OAIBuildBatch_artifacts::is_sha256sum_Set() const{
    return m_sha256sum_isSet;
}

bool OAIBuildBatch_artifacts::is_sha256sum_Valid() const{
    return m_sha256sum_isValid;
}

QString OAIBuildBatch_artifacts::getMd5sum() const {
    return m_md5sum;
}
void OAIBuildBatch_artifacts::setMd5sum(const QString &md5sum) {
    m_md5sum = md5sum;
    m_md5sum_isSet = true;
}

bool OAIBuildBatch_artifacts::is_md5sum_Set() const{
    return m_md5sum_isSet;
}

bool OAIBuildBatch_artifacts::is_md5sum_Valid() const{
    return m_md5sum_isValid;
}

bool OAIBuildBatch_artifacts::getOverrideArtifactName() const {
    return m_override_artifact_name;
}
void OAIBuildBatch_artifacts::setOverrideArtifactName(const bool &override_artifact_name) {
    m_override_artifact_name = override_artifact_name;
    m_override_artifact_name_isSet = true;
}

bool OAIBuildBatch_artifacts::is_override_artifact_name_Set() const{
    return m_override_artifact_name_isSet;
}

bool OAIBuildBatch_artifacts::is_override_artifact_name_Valid() const{
    return m_override_artifact_name_isValid;
}

bool OAIBuildBatch_artifacts::getEncryptionDisabled() const {
    return m_encryption_disabled;
}
void OAIBuildBatch_artifacts::setEncryptionDisabled(const bool &encryption_disabled) {
    m_encryption_disabled = encryption_disabled;
    m_encryption_disabled_isSet = true;
}

bool OAIBuildBatch_artifacts::is_encryption_disabled_Set() const{
    return m_encryption_disabled_isSet;
}

bool OAIBuildBatch_artifacts::is_encryption_disabled_Valid() const{
    return m_encryption_disabled_isValid;
}

QString OAIBuildBatch_artifacts::getArtifactIdentifier() const {
    return m_artifact_identifier;
}
void OAIBuildBatch_artifacts::setArtifactIdentifier(const QString &artifact_identifier) {
    m_artifact_identifier = artifact_identifier;
    m_artifact_identifier_isSet = true;
}

bool OAIBuildBatch_artifacts::is_artifact_identifier_Set() const{
    return m_artifact_identifier_isSet;
}

bool OAIBuildBatch_artifacts::is_artifact_identifier_Valid() const{
    return m_artifact_identifier_isValid;
}

OAIBucketOwnerAccess OAIBuildBatch_artifacts::getBucketOwnerAccess() const {
    return m_bucket_owner_access;
}
void OAIBuildBatch_artifacts::setBucketOwnerAccess(const OAIBucketOwnerAccess &bucket_owner_access) {
    m_bucket_owner_access = bucket_owner_access;
    m_bucket_owner_access_isSet = true;
}

bool OAIBuildBatch_artifacts::is_bucket_owner_access_Set() const{
    return m_bucket_owner_access_isSet;
}

bool OAIBuildBatch_artifacts::is_bucket_owner_access_Valid() const{
    return m_bucket_owner_access_isValid;
}

bool OAIBuildBatch_artifacts::isSet() const {
...
bool OAIBuildBatch_artifacts::isValid() const {
