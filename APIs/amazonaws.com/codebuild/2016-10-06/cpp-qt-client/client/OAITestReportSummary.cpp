...
#include "OAITestReportSummary.h"
...
OAITestReportSummary::OAITestReportSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestReportSummary::OAITestReportSummary() {
    this->initializeModel();
}

OAITestReportSummary::~OAITestReportSummary() {}

void OAITestReportSummary::initializeModel() {
...
void OAITestReportSummary::fromJson(QString jsonString) {
...
void OAITestReportSummary::fromJsonObject(QJsonObject json) {
...
QString OAITestReportSummary::asJson() const {
...
QJsonObject OAITestReportSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_total_isSet) {
...
qint32 OAITestReportSummary::getTotal() const {
    return m_total;
}
void OAITestReportSummary::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAITestReportSummary::is_total_Set() const{
    return m_total_isSet;
}

bool OAITestReportSummary::is_total_Valid() const{
    return m_total_isValid;
}

QMap OAITestReportSummary::getStatusCounts() const {
    return m_status_counts;
}
void OAITestReportSummary::setStatusCounts(const QMap &status_counts) {
    m_status_counts = status_counts;
    m_status_counts_isSet = true;
}

bool OAITestReportSummary::is_status_counts_Set() const{
    return m_status_counts_isSet;
}

bool OAITestReportSummary::is_status_counts_Valid() const{
    return m_status_counts_isValid;
}

qint32 OAITestReportSummary::getDurationInNanoSeconds() const {
    return m_duration_in_nano_seconds;
}
void OAITestReportSummary::setDurationInNanoSeconds(const qint32 &duration_in_nano_seconds) {
    m_duration_in_nano_seconds = duration_in_nano_seconds;
    m_duration_in_nano_seconds_isSet = true;
}

bool OAITestReportSummary::is_duration_in_nano_seconds_Set() const{
    return m_duration_in_nano_seconds_isSet;
}

bool OAITestReportSummary::is_duration_in_nano_seconds_Valid() const{
    return m_duration_in_nano_seconds_isValid;
}

bool OAITestReportSummary::isSet() const {
...
bool OAITestReportSummary::isValid() const {
