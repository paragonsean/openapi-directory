...
OAIUpdateProjectInput_environment::OAIUpdateProjectInput_environment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateProjectInput_environment::OAIUpdateProjectInput_environment() {
    this->initializeModel();
}

OAIUpdateProjectInput_environment::~OAIUpdateProjectInput_environment() {}

void OAIUpdateProjectInput_environment::initializeModel() {
...
void OAIUpdateProjectInput_environment::fromJson(QString jsonString) {
...
void OAIUpdateProjectInput_environment::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateProjectInput_environment::asJson() const {
...
QJsonObject OAIUpdateProjectInput_environment::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIEnvironmentType OAIUpdateProjectInput_environment::getType() const {
    return m_type;
}
void OAIUpdateProjectInput_environment::setType(const OAIEnvironmentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateProjectInput_environment::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIUpdateProjectInput_environment::getImage() const {
    return m_image;
}
void OAIUpdateProjectInput_environment::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_image_Set() const{
    return m_image_isSet;
}

bool OAIUpdateProjectInput_environment::is_image_Valid() const{
    return m_image_isValid;
}

OAIComputeType OAIUpdateProjectInput_environment::getComputeType() const {
    return m_compute_type;
}
void OAIUpdateProjectInput_environment::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIUpdateProjectInput_environment::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QList OAIUpdateProjectInput_environment::getEnvironmentVariables() const {
    return m_environment_variables;
}
void OAIUpdateProjectInput_environment::setEnvironmentVariables(const QList &environment_variables) {
    m_environment_variables = environment_variables;
    m_environment_variables_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_environment_variables_Set() const{
    return m_environment_variables_isSet;
}

bool OAIUpdateProjectInput_environment::is_environment_variables_Valid() const{
    return m_environment_variables_isValid;
}

bool OAIUpdateProjectInput_environment::getPrivilegedMode() const {
    return m_privileged_mode;
}
void OAIUpdateProjectInput_environment::setPrivilegedMode(const bool &privileged_mode) {
    m_privileged_mode = privileged_mode;
    m_privileged_mode_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_privileged_mode_Set() const{
    return m_privileged_mode_isSet;
}

bool OAIUpdateProjectInput_environment::is_privileged_mode_Valid() const{
    return m_privileged_mode_isValid;
}

QString OAIUpdateProjectInput_environment::getCertificate() const {
    return m_certificate;
}
void OAIUpdateProjectInput_environment::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIUpdateProjectInput_environment::is_certificate_Valid() const{
    return m_certificate_isValid;
}

OAIProjectEnvironment_registryCredential OAIUpdateProjectInput_environment::getRegistryCredential() const {
    return m_registry_credential;
}
void OAIUpdateProjectInput_environment::setRegistryCredential(const OAIProjectEnvironment_registryCredential &registry_credential) {
    m_registry_credential = registry_credential;
    m_registry_credential_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_registry_credential_Set() const{
    return m_registry_credential_isSet;
}

bool OAIUpdateProjectInput_environment::is_registry_credential_Valid() const{
    return m_registry_credential_isValid;
}

OAIImagePullCredentialsType OAIUpdateProjectInput_environment::getImagePullCredentialsType() const {
    return m_image_pull_credentials_type;
}
void OAIUpdateProjectInput_environment::setImagePullCredentialsType(const OAIImagePullCredentialsType &image_pull_credentials_type) {
    m_image_pull_credentials_type = image_pull_credentials_type;
    m_image_pull_credentials_type_isSet = true;
}

bool OAIUpdateProjectInput_environment::is_image_pull_credentials_type_Set() const{
    return m_image_pull_credentials_type_isSet;
}

bool OAIUpdateProjectInput_environment::is_image_pull_credentials_type_Valid() const{
    return m_image_pull_credentials_type_isValid;
}

bool OAIUpdateProjectInput_environment::isSet() const {
...
bool OAIUpdateProjectInput_environment::isValid() const {
