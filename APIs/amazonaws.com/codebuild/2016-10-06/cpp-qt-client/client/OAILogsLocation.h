...
#ifndef OAILogsLocation_H
#define OAILogsLocation_H
...
class OAILogsLocation : public OAIObject {
public:
    OAILogsLocation();
    OAILogsLocation(QString json);
    ~OAILogsLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogsLocation)

#endif // OAILogsLocation_H
