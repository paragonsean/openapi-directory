...
/*
 * OAIBuild_vpcConfig.h
 *
 * 
 */

#ifndef OAIBuild_vpcConfig_H
#define OAIBuild_vpcConfig_H
...
class OAIBuild_vpcConfig : public OAIObject {
public:
    OAIBuild_vpcConfig();
    OAIBuild_vpcConfig(QString json);
    ~OAIBuild_vpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuild_vpcConfig)

#endif // OAIBuild_vpcConfig_H
