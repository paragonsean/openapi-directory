...
#ifndef OAIS3LogsConfig_H
#define OAIS3LogsConfig_H
...
class OAIS3LogsConfig : public OAIObject {
public:
    OAIS3LogsConfig();
    OAIS3LogsConfig(QString json);
    ~OAIS3LogsConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3LogsConfig)

#endif // OAIS3LogsConfig_H
