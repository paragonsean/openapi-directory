...
OAIBuildArtifacts::OAIBuildArtifacts(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBuildArtifacts::OAIBuildArtifacts() {
    this->initializeModel();
}

OAIBuildArtifacts::~OAIBuildArtifacts() {}

void OAIBuildArtifacts::initializeModel() {
...
void OAIBuildArtifacts::fromJson(QString jsonString) {
...
void OAIBuildArtifacts::fromJsonObject(QJsonObject json) {
...
QString OAIBuildArtifacts::asJson() const {
...
QJsonObject OAIBuildArtifacts::asJsonObject() const {
    QJsonObject obj;
    if (m_location_isSet) {
...
QString OAIBuildArtifacts::getLocation() const {
    return m_location;
}
void OAIBuildArtifacts::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIBuildArtifacts::is_location_Set() const{
    return m_location_isSet;
}

bool OAIBuildArtifacts::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIBuildArtifacts::getSha256sum() const {
    return m_sha256sum;
}
void OAIBuildArtifacts::setSha256sum(const QString &sha256sum) {
    m_sha256sum = sha256sum;
    m_sha256sum_isSet = true;
}

bool OAIBuildArtifacts::is_sha256sum_Set() const{
    return m_sha256sum_isSet;
}

bool OAIBuildArtifacts::is_sha256sum_Valid() const{
    return m_sha256sum_isValid;
}

QString OAIBuildArtifacts::getMd5sum() const {
    return m_md5sum;
}
void OAIBuildArtifacts::setMd5sum(const QString &md5sum) {
    m_md5sum = md5sum;
    m_md5sum_isSet = true;
}

bool OAIBuildArtifacts::is_md5sum_Set() const{
    return m_md5sum_isSet;
}

bool OAIBuildArtifacts::is_md5sum_Valid() const{
    return m_md5sum_isValid;
}

bool OAIBuildArtifacts::getOverrideArtifactName() const {
    return m_override_artifact_name;
}
void OAIBuildArtifacts::setOverrideArtifactName(const bool &override_artifact_name) {
    m_override_artifact_name = override_artifact_name;
    m_override_artifact_name_isSet = true;
}

bool OAIBuildArtifacts::is_override_artifact_name_Set() const{
    return m_override_artifact_name_isSet;
}

bool OAIBuildArtifacts::is_override_artifact_name_Valid() const{
    return m_override_artifact_name_isValid;
}

bool OAIBuildArtifacts::getEncryptionDisabled() const {
    return m_encryption_disabled;
}
void OAIBuildArtifacts::setEncryptionDisabled(const bool &encryption_disabled) {
    m_encryption_disabled = encryption_disabled;
    m_encryption_disabled_isSet = true;
}

bool OAIBuildArtifacts::is_encryption_disabled_Set() const{
    return m_encryption_disabled_isSet;
}

bool OAIBuildArtifacts::is_encryption_disabled_Valid() const{
    return m_encryption_disabled_isValid;
}

QString OAIBuildArtifacts::getArtifactIdentifier() const {
    return m_artifact_identifier;
}
void OAIBuildArtifacts::setArtifactIdentifier(const QString &artifact_identifier) {
    m_artifact_identifier = artifact_identifier;
    m_artifact_identifier_isSet = true;
}

bool OAIBuildArtifacts::is_artifact_identifier_Set() const{
    return m_artifact_identifier_isSet;
}

bool OAIBuildArtifacts::is_artifact_identifier_Valid() const{
    return m_artifact_identifier_isValid;
}

OAIBucketOwnerAccess OAIBuildArtifacts::getBucketOwnerAccess() const {
    return m_bucket_owner_access;
}
void OAIBuildArtifacts::setBucketOwnerAccess(const OAIBucketOwnerAccess &bucket_owner_access) {
    m_bucket_owner_access = bucket_owner_access;
    m_bucket_owner_access_isSet = true;
}

bool OAIBuildArtifacts::is_bucket_owner_access_Set() const{
    return m_bucket_owner_access_isSet;
}

bool OAIBuildArtifacts::is_bucket_owner_access_Valid() const{
    return m_bucket_owner_access_isValid;
}

bool OAIBuildArtifacts::isSet() const {
...
bool OAIBuildArtifacts::isValid() const {
