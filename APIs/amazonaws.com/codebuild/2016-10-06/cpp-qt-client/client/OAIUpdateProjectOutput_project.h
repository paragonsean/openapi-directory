...
/*
 * OAIUpdateProjectOutput_project.h
 *
 * 
 */

#ifndef OAIUpdateProjectOutput_project_H
#define OAIUpdateProjectOutput_project_H
...
class OAIUpdateProjectOutput_project : public OAIObject {
public:
    OAIUpdateProjectOutput_project();
    OAIUpdateProjectOutput_project(QString json);
    ~OAIUpdateProjectOutput_project() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProjectOutput_project)

#endif // OAIUpdateProjectOutput_project_H
