...
/*
 * OAIStartBuildInput_artifactsOverride.h
 *
 * 
 */

#ifndef OAIStartBuildInput_artifactsOverride_H
#define OAIStartBuildInput_artifactsOverride_H
...
class OAIStartBuildInput_artifactsOverride : public OAIObject {
public:
    OAIStartBuildInput_artifactsOverride();
    OAIStartBuildInput_artifactsOverride(QString json);
    ~OAIStartBuildInput_artifactsOverride() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartBuildInput_artifactsOverride)

#endif // OAIStartBuildInput_artifactsOverride_H
