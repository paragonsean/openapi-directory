...
QString OAIBuildSummary::getArn() const {
    return m_arn;
}
void OAIBuildSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIBuildSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIBuildSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIBuildSummary::getRequestedOn() const {
    return m_requested_on;
}
void OAIBuildSummary::setRequestedOn(const QDateTime &requested_on) {
    m_requested_on = requested_on;
    m_requested_on_isSet = true;
}

bool OAIBuildSummary::is_requested_on_Set() const{
    return m_requested_on_isSet;
}

bool OAIBuildSummary::is_requested_on_Valid() const{
    return m_requested_on_isValid;
}

OAIStatusType OAIBuildSummary::getBuildStatus() const {
    return m_build_status;
}
void OAIBuildSummary::setBuildStatus(const OAIStatusType &build_status) {
    m_build_status = build_status;
    m_build_status_isSet = true;
}

bool OAIBuildSummary::is_build_status_Set() const{
    return m_build_status_isSet;
}

bool OAIBuildSummary::is_build_status_Valid() const{
    return m_build_status_isValid;
}

OAIBuildSummary_primaryArtifact OAIBuildSummary::getPrimaryArtifact() const {
    return m_primary_artifact;
}
void OAIBuildSummary::setPrimaryArtifact(const OAIBuildSummary_primaryArtifact &primary_artifact) {
    m_primary_artifact = primary_artifact;
    m_primary_artifact_isSet = true;
}

bool OAIBuildSummary::is_primary_artifact_Set() const{
    return m_primary_artifact_isSet;
}

bool OAIBuildSummary::is_primary_artifact_Valid() const{
    return m_primary_artifact_isValid;
}

QList OAIBuildSummary::getSecondaryArtifacts() const {
    return m_secondary_artifacts;
}
void OAIBuildSummary::setSecondaryArtifacts(const QList &secondary_artifacts) {
    m_secondary_artifacts = secondary_artifacts;
    m_secondary_artifacts_isSet = true;
}

bool OAIBuildSummary::is_secondary_artifacts_Set() const{
    return m_secondary_artifacts_isSet;
}

bool OAIBuildSummary::is_secondary_artifacts_Valid() const{
