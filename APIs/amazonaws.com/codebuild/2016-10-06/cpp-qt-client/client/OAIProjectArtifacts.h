...
/*
 * OAIProjectArtifacts.h
 *
 * Information about the build output artifacts for the build project.
 */

#ifndef OAIProjectArtifacts_H
#define OAIProjectArtifacts_H
...
class OAIProjectArtifacts : public OAIObject {
public:
    OAIProjectArtifacts();
    OAIProjectArtifacts(QString json);
    ~OAIProjectArtifacts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectArtifacts)

#endif // OAIProjectArtifacts_H
