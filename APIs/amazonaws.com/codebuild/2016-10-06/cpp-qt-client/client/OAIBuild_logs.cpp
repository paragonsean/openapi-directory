...
OAIBuild_logs::OAIBuild_logs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBuild_logs::OAIBuild_logs() {
    this->initializeModel();
}

OAIBuild_logs::~OAIBuild_logs() {}

void OAIBuild_logs::initializeModel() {
...
void OAIBuild_logs::fromJson(QString jsonString) {
...
void OAIBuild_logs::fromJsonObject(QJsonObject json) {
...
QString OAIBuild_logs::asJson() const {
...
QJsonObject OAIBuild_logs::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBuild_logs::getGroupName() const {
    return m_group_name;
}
void OAIBuild_logs::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIBuild_logs::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIBuild_logs::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIBuild_logs::getStreamName() const {
    return m_stream_name;
}
void OAIBuild_logs::setStreamName(const QString &stream_name) {
    m_stream_name = stream_name;
    m_stream_name_isSet = true;
}

bool OAIBuild_logs::is_stream_name_Set() const{
    return m_stream_name_isSet;
}

bool OAIBuild_logs::is_stream_name_Valid() const{
    return m_stream_name_isValid;
}

QString OAIBuild_logs::getDeepLink() const {
    return m_deep_link;
}
void OAIBuild_logs::setDeepLink(const QString &deep_link) {
    m_deep_link = deep_link;
    m_deep_link_isSet = true;
}

bool OAIBuild_logs::is_deep_link_Set() const{
    return m_deep_link_isSet;
}

bool OAIBuild_logs::is_deep_link_Valid() const{
    return m_deep_link_isValid;
}

QString OAIBuild_logs::getS3DeepLink() const {
    return m_s3_deep_link;
}
void OAIBuild_logs::setS3DeepLink(const QString &s3_deep_link) {
    m_s3_deep_link = s3_deep_link;
    m_s3_deep_link_isSet = true;
}

bool OAIBuild_logs::is_s3_deep_link_Set() const{
    return m_s3_deep_link_isSet;
}

bool OAIBuild_logs::is_s3_deep_link_Valid() const{
    return m_s3_deep_link_isValid;
}

QString OAIBuild_logs::getCloudWatchLogsArn() const {
    return m_cloud_watch_logs_arn;
}
void OAIBuild_logs::setCloudWatchLogsArn(const QString &cloud_watch_logs_arn) {
    m_cloud_watch_logs_arn = cloud_watch_logs_arn;
    m_cloud_watch_logs_arn_isSet = true;
}

bool OAIBuild_logs::is_cloud_watch_logs_arn_Set() const{
    return m_cloud_watch_logs_arn_isSet;
}

bool OAIBuild_logs::is_cloud_watch_logs_arn_Valid() const{
    return m_cloud_watch_logs_arn_isValid;
}

QString OAIBuild_logs::getS3LogsArn() const {
    return m_s3_logs_arn;
}
void OAIBuild_logs::setS3LogsArn(const QString &s3_logs_arn) {
    m_s3_logs_arn = s3_logs_arn;
    m_s3_logs_arn_isSet = true;
}

bool OAIBuild_logs::is_s3_logs_arn_Set() const{
    return m_s3_logs_arn_isSet;
}

bool OAIBuild_logs::is_s3_logs_arn_Valid() const{
    return m_s3_logs_arn_isValid;
}

OAILogsLocation_cloudWatchLogs OAIBuild_logs::getCloudWatchLogs() const {
    return m_cloud_watch_logs;
}
void OAIBuild_logs::setCloudWatchLogs(const OAILogsLocation_cloudWatchLogs &cloud_watch_logs) {
    m_cloud_watch_logs = cloud_watch_logs;
    m_cloud_watch_logs_isSet = true;
}

bool OAIBuild_logs::is_cloud_watch_logs_Set() const{
    return m_cloud_watch_logs_isSet;
}

bool OAIBuild_logs::is_cloud_watch_logs_Valid() const{
    return m_cloud_watch_logs_isValid;
}

OAILogsLocation_s3Logs OAIBuild_logs::getS3Logs() const {
    return m_s3_logs;
}
void OAIBuild_logs::setS3Logs(const OAILogsLocation_s3Logs &s3_logs) {
    m_s3_logs = s3_logs;
    m_s3_logs_isSet = true;
}

bool OAIBuild_logs::is_s3_logs_Set() const{
    return m_s3_logs_isSet;
}

bool OAIBuild_logs::is_s3_logs_Valid() const{
    return m_s3_logs_isValid;
}

bool OAIBuild_logs::isSet() const {
...
bool OAIBuild_logs::isValid() const {
