...
#ifndef OAIProjectCache_H
#define OAIProjectCache_H
...
class OAIProjectCache : public OAIObject {
public:
    OAIProjectCache();
    OAIProjectCache(QString json);
    ~OAIProjectCache() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectCache)

#endif // OAIProjectCache_H
