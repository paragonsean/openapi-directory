...
/*
 * OAILogsLocation_cloudWatchLogs.h
 *
 * 
 */

#ifndef OAILogsLocation_cloudWatchLogs_H
#define OAILogsLocation_cloudWatchLogs_H
...
class OAILogsLocation_cloudWatchLogs : public OAIObject {
public:
    OAILogsLocation_cloudWatchLogs();
    OAILogsLocation_cloudWatchLogs(QString json);
    ~OAILogsLocation_cloudWatchLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogsLocation_cloudWatchLogs)

#endif // OAILogsLocation_cloudWatchLogs_H
