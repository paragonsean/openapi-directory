...
/*
 * OAICreateWebhookOutput_webhook.h
 *
 * 
 */

#ifndef OAICreateWebhookOutput_webhook_H
#define OAICreateWebhookOutput_webhook_H
...
class OAICreateWebhookOutput_webhook : public OAIObject {
public:
    OAICreateWebhookOutput_webhook();
    OAICreateWebhookOutput_webhook(QString json);
    ~OAICreateWebhookOutput_webhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWebhookOutput_webhook)

#endif // OAICreateWebhookOutput_webhook_H
