...
/*
 * OAICreateProjectInput_environment.h
 *
 * 
 */

#ifndef OAICreateProjectInput_environment_H
#define OAICreateProjectInput_environment_H
...
class OAICreateProjectInput_environment : public OAIObject {
public:
    OAICreateProjectInput_environment();
    OAICreateProjectInput_environment(QString json);
    ~OAICreateProjectInput_environment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectInput_environment)

#endif // OAICreateProjectInput_environment_H
