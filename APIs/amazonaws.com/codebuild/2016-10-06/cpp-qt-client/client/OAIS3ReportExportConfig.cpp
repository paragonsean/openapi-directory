...
#include "OAIS3ReportExportConfig.h"
...
OAIS3ReportExportConfig::OAIS3ReportExportConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3ReportExportConfig::OAIS3ReportExportConfig() {
    this->initializeModel();
}

OAIS3ReportExportConfig::~OAIS3ReportExportConfig() {}

void OAIS3ReportExportConfig::initializeModel() {
...
void OAIS3ReportExportConfig::fromJson(QString jsonString) {
...
void OAIS3ReportExportConfig::fromJsonObject(QJsonObject json) {
...
QString OAIS3ReportExportConfig::asJson() const {
...
QJsonObject OAIS3ReportExportConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_bucket_isSet) {
...
QString OAIS3ReportExportConfig::getBucket() const {
    return m_bucket;
}
void OAIS3ReportExportConfig::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAIS3ReportExportConfig::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAIS3ReportExportConfig::is_bucket_Valid() const{
    return m_bucket_isValid;
}

QString OAIS3ReportExportConfig::getBucketOwner() const {
    return m_bucket_owner;
}
void OAIS3ReportExportConfig::setBucketOwner(const QString &bucket_owner) {
    m_bucket_owner = bucket_owner;
    m_bucket_owner_isSet = true;
}

bool OAIS3ReportExportConfig::is_bucket_owner_Set() const{
    return m_bucket_owner_isSet;
}

bool OAIS3ReportExportConfig::is_bucket_owner_Valid() const{
    return m_bucket_owner_isValid;
}

QString OAIS3ReportExportConfig::getPath() const {
    return m_path;
}
void OAIS3ReportExportConfig::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIS3ReportExportConfig::is_path_Set() const{
    return m_path_isSet;
}

bool OAIS3ReportExportConfig::is_path_Valid() const{
    return m_path_isValid;
}

OAIReportPackagingType OAIS3ReportExportConfig::getPackaging() const {
    return m_packaging;
}
void OAIS3ReportExportConfig::setPackaging(const OAIReportPackagingType &packaging) {
    m_packaging = packaging;
    m_packaging_isSet = true;
}

bool OAIS3ReportExportConfig::is_packaging_Set() const{
    return m_packaging_isSet;
}

bool OAIS3ReportExportConfig::is_packaging_Valid() const{
    return m_packaging_isValid;
}

QString OAIS3ReportExportConfig::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIS3ReportExportConfig::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIS3ReportExportConfig::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIS3ReportExportConfig::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

bool OAIS3ReportExportConfig::getEncryptionDisabled() const {
    return m_encryption_disabled;
}
void OAIS3ReportExportConfig::setEncryptionDisabled(const bool &encryption_disabled) {
    m_encryption_disabled = encryption_disabled;
    m_encryption_disabled_isSet = true;
}

bool OAIS3ReportExportConfig::is_encryption_disabled_Set() const{
    return m_encryption_disabled_isSet;
}

bool OAIS3ReportExportConfig::is_encryption_disabled_Valid() const{
    return m_encryption_disabled_isValid;
}

bool OAIS3ReportExportConfig::isSet() const {
...
bool OAIS3ReportExportConfig::isValid() const {
