...
/*
 * OAIFailoverShardResponse_Cluster.h
 *
 * 
 */

#ifndef OAIFailoverShardResponse_Cluster_H
#define OAIFailoverShardResponse_Cluster_H
...
class OAIFailoverShardResponse_Cluster : public OAIObject {
public:
    OAIFailoverShardResponse_Cluster();
    OAIFailoverShardResponse_Cluster(QString json);
    ~OAIFailoverShardResponse_Cluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFailoverShardResponse_Cluster)

#endif // OAIFailoverShardResponse_Cluster_H
