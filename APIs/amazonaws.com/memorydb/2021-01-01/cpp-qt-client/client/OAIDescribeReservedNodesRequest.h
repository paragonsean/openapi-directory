...
/*
 * OAIDescribeReservedNodesRequest.h
 *
 * 
 */

#ifndef OAIDescribeReservedNodesRequest_H
#define OAIDescribeReservedNodesRequest_H
...
class OAIDescribeReservedNodesRequest : public OAIObject {
public:
    OAIDescribeReservedNodesRequest();
    OAIDescribeReservedNodesRequest(QString json);
    ~OAIDescribeReservedNodesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeReservedNodesRequest)

#endif // OAIDescribeReservedNodesRequest_H
