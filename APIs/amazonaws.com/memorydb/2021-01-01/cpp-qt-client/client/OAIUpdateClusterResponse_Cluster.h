...
/*
 * OAIUpdateClusterResponse_Cluster.h
 *
 * 
 */

#ifndef OAIUpdateClusterResponse_Cluster_H
#define OAIUpdateClusterResponse_Cluster_H
...
class OAIUpdateClusterResponse_Cluster : public OAIObject {
public:
    OAIUpdateClusterResponse_Cluster();
    OAIUpdateClusterResponse_Cluster(QString json);
    ~OAIUpdateClusterResponse_Cluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClusterResponse_Cluster)

#endif // OAIUpdateClusterResponse_Cluster_H
