...
QString OAIClusterConfiguration::getName() const {
    return m_name;
}
void OAIClusterConfiguration::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIClusterConfiguration::is_name_Set() const{
    return m_name_isSet;
}

bool OAIClusterConfiguration::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIClusterConfiguration::getDescription() const {
    return m_description;
}
void OAIClusterConfiguration::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIClusterConfiguration::is_description_Set() const{
    return m_description_isSet;
}

bool OAIClusterConfiguration::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIClusterConfiguration::getNodeType() const {
    return m_node_type;
}
void OAIClusterConfiguration::setNodeType(const QString &node_type) {
    m_node_type = node_type;
    m_node_type_isSet = true;
}

bool OAIClusterConfiguration::is_node_type_Set() const{
    return m_node_type_isSet;
}

bool OAIClusterConfiguration::is_node_type_Valid() const{
    return m_node_type_isValid;
}

QString OAIClusterConfiguration::getEngineVersion() const {
    return m_engine_version;
}
void OAIClusterConfiguration::setEngineVersion(const QString &engine_version) {
    m_engine_version = engine_version;
    m_engine_version_isSet = true;
}

bool OAIClusterConfiguration::is_engine_version_Set() const{
    return m_engine_version_isSet;
}

bool OAIClusterConfiguration::is_engine_version_Valid() const{
    return m_engine_version_isValid;
}

QString OAIClusterConfiguration::getMaintenanceWindow() const {
    return m_maintenance_window;
}
void OAIClusterConfiguration::setMaintenanceWindow(const QString &maintenance_window) {
    m_maintenance_window = maintenance_window;
    m_maintenance_window_isSet = true;
}

bool OAIClusterConfiguration::is_maintenance_window_Set() const{
    return m_maintenance_window_isSet;
}

bool OAIClusterConfiguration::is_maintenance_window_Valid() const{
    return m_maintenance_window_isValid;
}

QString OAIClusterConfiguration::getTopicArn() const {
    return m_topic_arn;
}
void OAIClusterConfiguration::setTopicArn(const QString &topic_arn) {
    m_topic_arn = topic_arn;
    m_topic_arn_isSet = true;
}

bool OAIClusterConfiguration::is_topic_arn_Set() const{
    return m_topic_arn_isSet;
}

bool OAIClusterConfiguration::is_topic_arn_Valid() const{
    return m_topic_arn_isValid;
}

qint32 OAIClusterConfiguration::getPort() const {
    return m_port;
}
void OAIClusterConfiguration::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIClusterConfiguration::is_port_Set() const{
    return m_port_isSet;
}

bool OAIClusterConfiguration::is_port_Valid() const{
    return m_port_isValid;
}

QString OAIClusterConfiguration::getParameterGroupName() const {
    return m_parameter_group_name;
}
void OAIClusterConfiguration::setParameterGroupName(const QString &parameter_group_name) {
    m_parameter_group_name = parameter_group_name;
    m_parameter_group_name_isSet = true;
}

bool OAIClusterConfiguration::is_parameter_group_name_Set() const{
    return m_parameter_group_name_isSet;
}

bool OAIClusterConfiguration::is_parameter_group_name_Valid() const{
    return m_parameter_group_name_isValid;
}

QString OAIClusterConfiguration::getSubnetGroupName() const {
    return m_subnet_group_name;
}
void OAIClusterConfiguration::setSubnetGroupName(const QString &subnet_group_name) {
    m_subnet_group_name = subnet_group_name;
    m_subnet_group_name_isSet = true;
}

bool OAIClusterConfiguration::is_subnet_group_name_Set() const{
    return m_subnet_group_name_isSet;
}

bool OAIClusterConfiguration::is_subnet_group_name_Valid() const{
    return m_subnet_group_name_isValid;
}

QString OAIClusterConfiguration::getVpcId() const {
    return m_vpc_id;
}
void OAIClusterConfiguration::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIClusterConfiguration::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIClusterConfiguration::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

qint32 OAIClusterConfiguration::getSnapshotRetentionLimit() const {
    return m_snapshot_retention_limit;
}
void OAIClusterConfiguration::setSnapshotRetentionLimit(const qint32 &snapshot_retention_limit) {
    m_snapshot_retention_limit = snapshot_retention_limit;
    m_snapshot_retention_limit_isSet = true;
}

bool OAIClusterConfiguration::is_snapshot_retention_limit_Set() const{
    return m_snapshot_retention_limit_isSet;
}

bool OAIClusterConfiguration::is_snapshot_retention_limit_Valid() const{
    return m_snapshot_retention_limit_isValid;
}

QString OAIClusterConfiguration::getSnapshotWindow() const {
    return m_snapshot_window;
}
void OAIClusterConfiguration::setSnapshotWindow(const QString &snapshot_window) {
    m_snapshot_window = snapshot_window;
    m_snapshot_window_isSet = true;
}

bool OAIClusterConfiguration::is_snapshot_window_Set() const{
    return m_snapshot_window_isSet;
}

bool OAIClusterConfiguration::is_snapshot_window_Valid() const{
    return m_snapshot_window_isValid;
}

qint32 OAIClusterConfiguration::getNumShards() const {
    return m_num_shards;
}
void OAIClusterConfiguration::setNumShards(const qint32 &num_shards) {
    m_num_shards = num_shards;
    m_num_shards_isSet = true;
}

bool OAIClusterConfiguration::is_num_shards_Set() const{
    return m_num_shards_isSet;
}

bool OAIClusterConfiguration::is_num_shards_Valid() const{
    return m_num_shards_isValid;
}

QList OAIClusterConfiguration::getShards() const {
    return m_shards;
}
void OAIClusterConfiguration::setShards(const QList &shards) {
    m_shards = shards;
    m_shards_isSet = true;
}

bool OAIClusterConfiguration::is_shards_Set() const{
    return m_shards_isSet;
}

bool OAIClusterConfiguration::is_shards_Valid() const{
