...
/*
 * OAICopySnapshotResponse_Snapshot.h
 *
 * 
 */

#ifndef OAICopySnapshotResponse_Snapshot_H
#define OAICopySnapshotResponse_Snapshot_H
...
class OAICopySnapshotResponse_Snapshot : public OAIObject {
public:
    OAICopySnapshotResponse_Snapshot();
    OAICopySnapshotResponse_Snapshot(QString json);
    ~OAICopySnapshotResponse_Snapshot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopySnapshotResponse_Snapshot)

#endif // OAICopySnapshotResponse_Snapshot_H
