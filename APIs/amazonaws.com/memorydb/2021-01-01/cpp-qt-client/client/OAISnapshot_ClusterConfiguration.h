...
/*
 * OAISnapshot_ClusterConfiguration.h
 *
 * 
 */

#ifndef OAISnapshot_ClusterConfiguration_H
#define OAISnapshot_ClusterConfiguration_H
...
class OAISnapshot_ClusterConfiguration : public OAIObject {
public:
    OAISnapshot_ClusterConfiguration();
    OAISnapshot_ClusterConfiguration(QString json);
    ~OAISnapshot_ClusterConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnapshot_ClusterConfiguration)

#endif // OAISnapshot_ClusterConfiguration_H
