...
/*
 * OAIDeleteUserResponse_User.h
 *
 * 
 */

#ifndef OAIDeleteUserResponse_User_H
#define OAIDeleteUserResponse_User_H
...
class OAIDeleteUserResponse_User : public OAIObject {
public:
    OAIDeleteUserResponse_User();
    OAIDeleteUserResponse_User(QString json);
    ~OAIDeleteUserResponse_User() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteUserResponse_User)

#endif // OAIDeleteUserResponse_User_H
