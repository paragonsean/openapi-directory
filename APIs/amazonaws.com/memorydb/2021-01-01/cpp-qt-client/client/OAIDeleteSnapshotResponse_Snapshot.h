...
/*
 * OAIDeleteSnapshotResponse_Snapshot.h
 *
 * 
 */

#ifndef OAIDeleteSnapshotResponse_Snapshot_H
#define OAIDeleteSnapshotResponse_Snapshot_H
...
class OAIDeleteSnapshotResponse_Snapshot : public OAIObject {
public:
    OAIDeleteSnapshotResponse_Snapshot();
    OAIDeleteSnapshotResponse_Snapshot(QString json);
    ~OAIDeleteSnapshotResponse_Snapshot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSnapshotResponse_Snapshot)

#endif // OAIDeleteSnapshotResponse_Snapshot_H
