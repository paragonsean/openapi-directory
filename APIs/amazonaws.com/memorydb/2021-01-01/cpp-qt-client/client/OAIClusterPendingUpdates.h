...
/*
 * OAIClusterPendingUpdates.h
 *
 * A list of updates being applied to the cluster
 */

#ifndef OAIClusterPendingUpdates_H
#define OAIClusterPendingUpdates_H
...
class OAIClusterPendingUpdates : public OAIObject {
public:
    OAIClusterPendingUpdates();
    OAIClusterPendingUpdates(QString json);
    ~OAIClusterPendingUpdates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterPendingUpdates)

#endif // OAIClusterPendingUpdates_H
