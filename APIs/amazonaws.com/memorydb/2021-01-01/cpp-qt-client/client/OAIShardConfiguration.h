...
/*
 * OAIShardConfiguration.h
 *
 * Shard configuration options. Each shard configuration has the following: Slots and ReplicaCount.
 */

#ifndef OAIShardConfiguration_H
#define OAIShardConfiguration_H
...
class OAIShardConfiguration : public OAIObject {
public:
    OAIShardConfiguration();
    OAIShardConfiguration(QString json);
    ~OAIShardConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShardConfiguration)

#endif // OAIShardConfiguration_H
