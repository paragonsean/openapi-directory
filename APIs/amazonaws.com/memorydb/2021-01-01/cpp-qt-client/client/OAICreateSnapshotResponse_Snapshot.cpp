...
QString OAICreateSnapshotResponse_Snapshot::getStatus() const {
    return m_status;
}
void OAICreateSnapshotResponse_Snapshot::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateSnapshotResponse_Snapshot::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateSnapshotResponse_Snapshot::is_status_Valid() const{
    return m_status_isValid;
}

QString OAICreateSnapshotResponse_Snapshot::getSource() const {
    return m_source;
}
void OAICreateSnapshotResponse_Snapshot::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAICreateSnapshotResponse_Snapshot::is_source_Set() const{
    return m_source_isSet;
}

bool OAICreateSnapshotResponse_Snapshot::is_source_Valid() const{
    return m_source_isValid;
}

QString OAICreateSnapshotResponse_Snapshot::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAICreateSnapshotResponse_Snapshot::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAICreateSnapshotResponse_Snapshot::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAICreateSnapshotResponse_Snapshot::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAICreateSnapshotResponse_Snapshot::getArn() const {
    return m_arn;
}
void OAICreateSnapshotResponse_Snapshot::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateSnapshotResponse_Snapshot::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateSnapshotResponse_Snapshot::is_arn_Valid() const{
    return m_arn_isValid;
}

OAISnapshot_ClusterConfiguration OAICreateSnapshotResponse_Snapshot::getClusterConfiguration() const {
    return m_cluster_configuration;
}
void OAICreateSnapshotResponse_Snapshot::setClusterConfiguration(const OAISnapshot_ClusterConfiguration &cluster_configuration) {
    m_cluster_configuration = cluster_configuration;
    m_cluster_configuration_isSet = true;
}

bool OAICreateSnapshotResponse_Snapshot::is_cluster_configuration_Set() const{
    return m_cluster_configuration_isSet;
}

bool OAICreateSnapshotResponse_Snapshot::is_cluster_configuration_Valid() const{
    return m_cluster_configuration_isValid;
}

OAIDataTieringStatus OAICreateSnapshotResponse_Snapshot::getDataTiering() const {
    return m_data_tiering;
}
void OAICreateSnapshotResponse_Snapshot::setDataTiering(const OAIDataTieringStatus &data_tiering) {
    m_data_tiering = data_tiering;
    m_data_tiering_isSet = true;
}

bool OAICreateSnapshotResponse_Snapshot::is_data_tiering_Set() const{
    return m_data_tiering_isSet;
}

bool OAICreateSnapshotResponse_Snapshot::is_data_tiering_Valid() const{
