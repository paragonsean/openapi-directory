...
#include "OAIACLPendingChanges.h"
...
OAIACLPendingChanges::OAIACLPendingChanges(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIACLPendingChanges::OAIACLPendingChanges() {
    this->initializeModel();
}

OAIACLPendingChanges::~OAIACLPendingChanges() {}

void OAIACLPendingChanges::initializeModel() {
...
void OAIACLPendingChanges::fromJson(QString jsonString) {
...
void OAIACLPendingChanges::fromJsonObject(QJsonObject json) {
...
QString OAIACLPendingChanges::asJson() const {
...
QJsonObject OAIACLPendingChanges::asJsonObject() const {
    QJsonObject obj;
...
QList OAIACLPendingChanges::getUserNamesToRemove() const {
    return m_user_names_to_remove;
}
void OAIACLPendingChanges::setUserNamesToRemove(const QList &user_names_to_remove) {
    m_user_names_to_remove = user_names_to_remove;
    m_user_names_to_remove_isSet = true;
}

bool OAIACLPendingChanges::is_user_names_to_remove_Set() const{
    return m_user_names_to_remove_isSet;
}

bool OAIACLPendingChanges::is_user_names_to_remove_Valid() const{
    return m_user_names_to_remove_isValid;
}

QList OAIACLPendingChanges::getUserNamesToAdd() const {
    return m_user_names_to_add;
}
void OAIACLPendingChanges::setUserNamesToAdd(const QList &user_names_to_add) {
    m_user_names_to_add = user_names_to_add;
    m_user_names_to_add_isSet = true;
}

bool OAIACLPendingChanges::is_user_names_to_add_Set() const{
    return m_user_names_to_add_isSet;
}

bool OAIACLPendingChanges::is_user_names_to_add_Valid() const{
    return m_user_names_to_add_isValid;
}

bool OAIACLPendingChanges::isSet() const {
...
bool OAIACLPendingChanges::isValid() const {
