...
/*
 * OAIUser_Authentication.h
 *
 * 
 */

#ifndef OAIUser_Authentication_H
#define OAIUser_Authentication_H
...
class OAIUser_Authentication : public OAIObject {
public:
    OAIUser_Authentication();
    OAIUser_Authentication(QString json);
    ~OAIUser_Authentication() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_Authentication)

#endif // OAIUser_Authentication_H
