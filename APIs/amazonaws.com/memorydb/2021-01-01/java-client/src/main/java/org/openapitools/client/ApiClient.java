...
public class ApiClient {
    ...
    private String basePath = "http://memory-db.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-01-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://memory-db.us-east-1.amazonaws.com
