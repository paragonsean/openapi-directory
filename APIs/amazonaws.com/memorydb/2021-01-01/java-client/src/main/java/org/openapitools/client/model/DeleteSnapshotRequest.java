...
public class DeleteSnapshotRequest {
  ...
  public DeleteSnapshotRequest snapshotName(String snapshotName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.snapshotName, deleteSnapshotRequest.snapshotName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSnapshotRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSnapshotRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSnapshotRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSnapshotRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
