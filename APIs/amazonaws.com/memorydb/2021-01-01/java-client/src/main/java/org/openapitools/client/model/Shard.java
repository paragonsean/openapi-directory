...
public class Shard {
  ...
  public Shard status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Shard slots(String slots) {
    this.slots = slots;
    return this;
  }
  ...
  public Shard numberOfNodes(Integer numberOfNodes) {
  ...
  public boolean equals(Object o) {
    ...
    Shard shard = (Shard) o;
    return Objects.equals(this.name, shard.name) &&
        Objects.equals(this.status, shard.status) &&
        Objects.equals(this.slots, shard.slots) &&
        Objects.equals(this.nodes, shard.nodes) &&
        Objects.equals(this.numberOfNodes, shard.numberOfNodes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, status, slots, nodes, numberOfNodes);
  }
