...
public class CreateClusterResponseCluster {
  ...
  public CreateClusterResponseCluster() {
  }

  public CreateClusterResponseCluster name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateClusterResponseCluster description(String description) {
  ...
  public CreateClusterResponseCluster status(String status) {
    this.status = status;
    return this;
  }
  ...
  public CreateClusterResponseCluster pendingUpdates(ClusterPendingUpdates pendingUpdates) {
  ...
  public CreateClusterResponseCluster numberOfShards(Integer numberOfShards) {
  ...
  public CreateClusterResponseCluster shards(List shards) {
    this.shards = shards;
    return this;
  }
  ...
  public CreateClusterResponseCluster availabilityMode(AZStatus availabilityMode) {
  ...
  public CreateClusterResponseCluster clusterEndpoint(ClusterClusterEndpoint clusterEndpoint) {
  ...
  public CreateClusterResponseCluster nodeType(String nodeType) {
  ...
  public CreateClusterResponseCluster engineVersion(String engineVersion) {
  ...
  public CreateClusterResponseCluster enginePatchVersion(String enginePatchVersion) {
  ...
  public CreateClusterResponseCluster parameterGroupName(String parameterGroupName) {
  ...
  public CreateClusterResponseCluster parameterGroupStatus(String parameterGroupStatus) {
  ...
  public CreateClusterResponseCluster securityGroups(List securityGroups) {
  ...
  public CreateClusterResponseCluster subnetGroupName(String subnetGroupName) {
  ...
  public CreateClusterResponseCluster tlSEnabled(Boolean tlSEnabled) {
  ...
  public CreateClusterResponseCluster kmsKeyId(String kmsKeyId) {
  ...
  public CreateClusterResponseCluster ARN(String ARN) {
    this.ARN = ARN;
    return this;
  }
  ...
  public CreateClusterResponseCluster snsTopicArn(String snsTopicArn) {
  ...
  public CreateClusterResponseCluster snsTopicStatus(String snsTopicStatus) {
  ...
  public CreateClusterResponseCluster snapshotRetentionLimit(Integer snapshotRetentionLimit) {
  ...
  public CreateClusterResponseCluster maintenanceWindow(String maintenanceWindow) {
  ...
  public CreateClusterResponseCluster snapshotWindow(String snapshotWindow) {
  ...
  public CreateClusterResponseCluster acLName(String acLName) {
  ...
  public CreateClusterResponseCluster autoMinorVersionUpgrade(Boolean autoMinorVersionUpgrade) {
  ...
  public CreateClusterResponseCluster dataTiering(DataTieringStatus dataTiering) {
  ...
  public boolean equals(Object o) {
    ...
    CreateClusterResponseCluster createClusterResponseCluster = (CreateClusterResponseCluster) o;
    return Objects.equals(this.name, createClusterResponseCluster.name) &&
        Objects.equals(this.description, createClusterResponseCluster.description) &&
        Objects.equals(this.status, createClusterResponseCluster.status) &&
        Objects.equals(this.pendingUpdates, createClusterResponseCluster.pendingUpdates) &&
        Objects.equals(this.numberOfShards, createClusterResponseCluster.numberOfShards) &&
        Objects.equals(this.shards, createClusterResponseCluster.shards) &&
        Objects.equals(this.availabilityMode, createClusterResponseCluster.availabilityMode) &&
        Objects.equals(this.clusterEndpoint, createClusterResponseCluster.clusterEndpoint) &&
        Objects.equals(this.nodeType, createClusterResponseCluster.nodeType) &&
        Objects.equals(this.engineVersion, createClusterResponseCluster.engineVersion) &&
        Objects.equals(this.enginePatchVersion, createClusterResponseCluster.enginePatchVersion) &&
        Objects.equals(this.parameterGroupName, createClusterResponseCluster.parameterGroupName) &&
        Objects.equals(this.parameterGroupStatus, createClusterResponseCluster.parameterGroupStatus) &&
        Objects.equals(this.securityGroups, createClusterResponseCluster.securityGroups) &&
        Objects.equals(this.subnetGroupName, createClusterResponseCluster.subnetGroupName) &&
        Objects.equals(this.tlSEnabled, createClusterResponseCluster.tlSEnabled) &&
        Objects.equals(this.kmsKeyId, createClusterResponseCluster.kmsKeyId) &&
        Objects.equals(this.ARN, createClusterResponseCluster.ARN) &&
        Objects.equals(this.snsTopicArn, createClusterResponseCluster.snsTopicArn) &&
        Objects.equals(this.snsTopicStatus, createClusterResponseCluster.snsTopicStatus) &&
        Objects.equals(this.snapshotRetentionLimit, createClusterResponseCluster.snapshotRetentionLimit) &&
        Objects.equals(this.maintenanceWindow, createClusterResponseCluster.maintenanceWindow) &&
        Objects.equals(this.snapshotWindow, createClusterResponseCluster.snapshotWindow) &&
        Objects.equals(this.acLName, createClusterResponseCluster.acLName) &&
        Objects.equals(this.autoMinorVersionUpgrade, createClusterResponseCluster.autoMinorVersionUpgrade) &&
        Objects.equals(this.dataTiering, createClusterResponseCluster.dataTiering);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateClusterResponseCluster {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateClusterResponseCluster
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateClusterResponseCluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateClusterResponseCluster is not found in the empty JSON string", CreateClusterResponseCluster.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateClusterResponseCluster.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateClusterResponseCluster` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateClusterResponseCluster.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateClusterResponseCluster' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateClusterResponseCluster> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateClusterResponseCluster.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateClusterResponseCluster>() {
           @Override
           public void write(JsonWriter out, CreateClusterResponseCluster value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateClusterResponseCluster read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateClusterResponseCluster given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateClusterResponseCluster
   * @throws IOException if the JSON string is invalid with respect to CreateClusterResponseCluster
   */
  public static CreateClusterResponseCluster fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateClusterResponseCluster.class);
  }

  /**
   * Convert an instance of CreateClusterResponseCluster to an JSON string
   *
   * @return JSON string
   */
