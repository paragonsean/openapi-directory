...
import org.openapitools.client.model.NodeEndpoint;
...
public class Node {
  ...
  public Node availabilityZone(String availabilityZone) {
  ...
  public Node createTime(OffsetDateTime createTime) {
  ...
  public Node endpoint(NodeEndpoint endpoint) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, node.name) &&
        ...
        Objects.equals(this.availabilityZone, node.availabilityZone) &&
        Objects.equals(this.createTime, node.createTime) &&
        Objects.equals(this.endpoint, node.endpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, status, availabilityZone, createTime, endpoint);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Endpoint") != null && !jsonObj.get("Endpoint").isJsonNull()) {
        NodeEndpoint.validateJsonElement(jsonObj.get("Endpoint"));
      }
  }
