...
public class UpdateClusterResponseCluster {
  ...
  public UpdateClusterResponseCluster() {
  }

  public UpdateClusterResponseCluster name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateClusterResponseCluster description(String description) {
  ...
  public UpdateClusterResponseCluster status(String status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateClusterResponseCluster pendingUpdates(ClusterPendingUpdates pendingUpdates) {
  ...
  public UpdateClusterResponseCluster numberOfShards(Integer numberOfShards) {
  ...
  public UpdateClusterResponseCluster shards(List shards) {
    this.shards = shards;
    return this;
  }
  ...
  public UpdateClusterResponseCluster availabilityMode(AZStatus availabilityMode) {
  ...
  public UpdateClusterResponseCluster clusterEndpoint(ClusterClusterEndpoint clusterEndpoint) {
  ...
  public UpdateClusterResponseCluster nodeType(String nodeType) {
  ...
  public UpdateClusterResponseCluster engineVersion(String engineVersion) {
  ...
  public UpdateClusterResponseCluster enginePatchVersion(String enginePatchVersion) {
  ...
  public UpdateClusterResponseCluster parameterGroupName(String parameterGroupName) {
  ...
  public UpdateClusterResponseCluster parameterGroupStatus(String parameterGroupStatus) {
  ...
  public UpdateClusterResponseCluster securityGroups(List securityGroups) {
  ...
  public UpdateClusterResponseCluster subnetGroupName(String subnetGroupName) {
  ...
  public UpdateClusterResponseCluster tlSEnabled(Boolean tlSEnabled) {
  ...
  public UpdateClusterResponseCluster kmsKeyId(String kmsKeyId) {
  ...
  public UpdateClusterResponseCluster ARN(String ARN) {
    this.ARN = ARN;
    return this;
  }
  ...
  public UpdateClusterResponseCluster snsTopicArn(String snsTopicArn) {
  ...
  public UpdateClusterResponseCluster snsTopicStatus(String snsTopicStatus) {
  ...
  public UpdateClusterResponseCluster snapshotRetentionLimit(Integer snapshotRetentionLimit) {
  ...
  public UpdateClusterResponseCluster maintenanceWindow(String maintenanceWindow) {
  ...
  public UpdateClusterResponseCluster snapshotWindow(String snapshotWindow) {
  ...
  public UpdateClusterResponseCluster acLName(String acLName) {
  ...
  public UpdateClusterResponseCluster autoMinorVersionUpgrade(Boolean autoMinorVersionUpgrade) {
  ...
  public UpdateClusterResponseCluster dataTiering(DataTieringStatus dataTiering) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateClusterResponseCluster updateClusterResponseCluster = (UpdateClusterResponseCluster) o;
    return Objects.equals(this.name, updateClusterResponseCluster.name) &&
        Objects.equals(this.description, updateClusterResponseCluster.description) &&
        Objects.equals(this.status, updateClusterResponseCluster.status) &&
        Objects.equals(this.pendingUpdates, updateClusterResponseCluster.pendingUpdates) &&
        Objects.equals(this.numberOfShards, updateClusterResponseCluster.numberOfShards) &&
        Objects.equals(this.shards, updateClusterResponseCluster.shards) &&
        Objects.equals(this.availabilityMode, updateClusterResponseCluster.availabilityMode) &&
        Objects.equals(this.clusterEndpoint, updateClusterResponseCluster.clusterEndpoint) &&
        Objects.equals(this.nodeType, updateClusterResponseCluster.nodeType) &&
        Objects.equals(this.engineVersion, updateClusterResponseCluster.engineVersion) &&
        Objects.equals(this.enginePatchVersion, updateClusterResponseCluster.enginePatchVersion) &&
        Objects.equals(this.parameterGroupName, updateClusterResponseCluster.parameterGroupName) &&
        Objects.equals(this.parameterGroupStatus, updateClusterResponseCluster.parameterGroupStatus) &&
        Objects.equals(this.securityGroups, updateClusterResponseCluster.securityGroups) &&
        Objects.equals(this.subnetGroupName, updateClusterResponseCluster.subnetGroupName) &&
        Objects.equals(this.tlSEnabled, updateClusterResponseCluster.tlSEnabled) &&
        Objects.equals(this.kmsKeyId, updateClusterResponseCluster.kmsKeyId) &&
        Objects.equals(this.ARN, updateClusterResponseCluster.ARN) &&
        Objects.equals(this.snsTopicArn, updateClusterResponseCluster.snsTopicArn) &&
        Objects.equals(this.snsTopicStatus, updateClusterResponseCluster.snsTopicStatus) &&
        Objects.equals(this.snapshotRetentionLimit, updateClusterResponseCluster.snapshotRetentionLimit) &&
        Objects.equals(this.maintenanceWindow, updateClusterResponseCluster.maintenanceWindow) &&
        Objects.equals(this.snapshotWindow, updateClusterResponseCluster.snapshotWindow) &&
        Objects.equals(this.acLName, updateClusterResponseCluster.acLName) &&
        Objects.equals(this.autoMinorVersionUpgrade, updateClusterResponseCluster.autoMinorVersionUpgrade) &&
        Objects.equals(this.dataTiering, updateClusterResponseCluster.dataTiering);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateClusterResponseCluster {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateClusterResponseCluster
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateClusterResponseCluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateClusterResponseCluster is not found in the empty JSON string", UpdateClusterResponseCluster.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateClusterResponseCluster.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateClusterResponseCluster` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateClusterResponseCluster.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateClusterResponseCluster' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateClusterResponseCluster> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateClusterResponseCluster.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateClusterResponseCluster>() {
           @Override
           public void write(JsonWriter out, UpdateClusterResponseCluster value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateClusterResponseCluster read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateClusterResponseCluster given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateClusterResponseCluster
   * @throws IOException if the JSON string is invalid with respect to UpdateClusterResponseCluster
   */
  public static UpdateClusterResponseCluster fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateClusterResponseCluster.class);
  }

  /**
   * Convert an instance of UpdateClusterResponseCluster to an JSON string
   *
   * @return JSON string
   */
