...
public class ParameterGroup {
  ...
  public ParameterGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ParameterGroup family(String family) {
    this.family = family;
    return this;
  }
  ...
  public ParameterGroup ARN(String ARN) {
    this.ARN = ARN;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, parameterGroup.name) &&
        Objects.equals(this.family, parameterGroup.family) &&
        Objects.equals(this.description, parameterGroup.description) &&
        Objects.equals(this.ARN, parameterGroup.ARN);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
