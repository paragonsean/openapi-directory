...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.CreateClusterRequest();
  });
  ...
  describe('CreateClusterRequest', function() {
    it('should create an instance of CreateClusterRequest', function() {
      ...
      //var instance = new AmazonMemoryDb.CreateClusterRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.CreateClusterRequest);
    });
    ...
    it('should have the property numReplicasPerShard (base name: "NumReplicasPerShard")', function() {
      // uncomment below and update the code to test the property numReplicasPerShard
      //var instance = new AmazonMemoryDb.CreateClusterRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property snapshotArns (base name: "SnapshotArns")', function() {
      // uncomment below and update the code to test the property snapshotArns
      //var instance = new AmazonMemoryDb.CreateClusterRequest();
      //expect(instance).to.be();
    });
