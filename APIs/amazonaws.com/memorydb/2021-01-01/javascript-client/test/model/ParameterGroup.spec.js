...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.ParameterGroup();
  });
  ...
  describe('ParameterGroup', function() {
    it('should create an instance of ParameterGroup', function() {
      // uncomment below and update the code to test ParameterGroup
      //var instance = new AmazonMemoryDb.ParameterGroup();
      //expect(instance).to.be.a(AmazonMemoryDb.ParameterGroup);
    });
