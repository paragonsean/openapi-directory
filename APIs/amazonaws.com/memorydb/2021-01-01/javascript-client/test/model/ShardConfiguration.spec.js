...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.ShardConfiguration();
  });
  ...
  describe('ShardConfiguration', function() {
    it('should create an instance of ShardConfiguration', function() {
      // uncomment below and update the code to test ShardConfiguration
      //var instance = new AmazonMemoryDb.ShardConfiguration();
      //expect(instance).to.be.a(AmazonMemoryDb.ShardConfiguration);
    });
