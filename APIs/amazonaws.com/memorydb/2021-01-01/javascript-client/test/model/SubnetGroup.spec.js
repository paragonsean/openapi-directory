...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.SubnetGroup();
  });
  ...
  describe('SubnetGroup', function() {
    it('should create an instance of SubnetGroup', function() {
      // uncomment below and update the code to test SubnetGroup
      //var instance = new AmazonMemoryDb.SubnetGroup();
      //expect(instance).to.be.a(AmazonMemoryDb.SubnetGroup);
    });
