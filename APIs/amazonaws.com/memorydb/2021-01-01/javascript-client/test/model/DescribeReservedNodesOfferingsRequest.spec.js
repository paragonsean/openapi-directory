...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.DescribeReservedNodesOfferingsRequest();
  });
  ...
  describe('DescribeReservedNodesOfferingsRequest', function() {
    it('should create an instance of DescribeReservedNodesOfferingsRequest', function() {
      // uncomment below and update the code to test DescribeReservedNodesOfferingsRequest
      //var instance = new AmazonMemoryDb.DescribeReservedNodesOfferingsRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.DescribeReservedNodesOfferingsRequest);
    });
