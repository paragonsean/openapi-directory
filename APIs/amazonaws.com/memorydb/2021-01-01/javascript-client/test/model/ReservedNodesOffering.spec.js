...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.ReservedNodesOffering();
  });
  ...
  describe('ReservedNodesOffering', function() {
    it('should create an instance of ReservedNodesOffering', function() {
      // uncomment below and update the code to test ReservedNodesOffering
      //var instance = new AmazonMemoryDb.ReservedNodesOffering();
      //expect(instance).to.be.a(AmazonMemoryDb.ReservedNodesOffering);
    });
