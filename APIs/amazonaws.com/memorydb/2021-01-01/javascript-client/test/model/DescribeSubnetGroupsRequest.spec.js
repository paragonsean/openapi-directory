...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.DescribeSubnetGroupsRequest();
  });
  ...
  describe('DescribeSubnetGroupsRequest', function() {
    it('should create an instance of DescribeSubnetGroupsRequest', function() {
      // uncomment below and update the code to test DescribeSubnetGroupsRequest
      //var instance = new AmazonMemoryDb.DescribeSubnetGroupsRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.DescribeSubnetGroupsRequest);
    });
