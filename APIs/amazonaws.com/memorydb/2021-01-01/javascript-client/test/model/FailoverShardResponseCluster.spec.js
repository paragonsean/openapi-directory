...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.FailoverShardResponseCluster();
  });
  ...
  describe('FailoverShardResponseCluster', function() {
    it('should create an instance of FailoverShardResponseCluster', function() {
      // uncomment below and update the code to test FailoverShardResponseCluster
      //var instance = new AmazonMemoryDb.FailoverShardResponseCluster();
      //expect(instance).to.be.a(AmazonMemoryDb.FailoverShardResponseCluster);
    });
