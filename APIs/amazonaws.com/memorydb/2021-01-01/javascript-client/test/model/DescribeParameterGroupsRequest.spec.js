...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.DescribeParameterGroupsRequest();
  });
  ...
  describe('DescribeParameterGroupsRequest', function() {
    it('should create an instance of DescribeParameterGroupsRequest', function() {
      // uncomment below and update the code to test DescribeParameterGroupsRequest
      //var instance = new AmazonMemoryDb.DescribeParameterGroupsRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.DescribeParameterGroupsRequest);
    });
