...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.DeleteACLResponseACL();
  });
  ...
  describe('DeleteACLResponseACL', function() {
    it('should create an instance of DeleteACLResponseACL', function() {
      // uncomment below and update the code to test DeleteACLResponseACL
      //var instance = new AmazonMemoryDb.DeleteACLResponseACL();
      //expect(instance).to.be.a(AmazonMemoryDb.DeleteACLResponseACL);
    });
