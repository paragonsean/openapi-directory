...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.CreateClusterResponseCluster();
  });
  ...
  describe('CreateClusterResponseCluster', function() {
    it('should create an instance of CreateClusterResponseCluster', function() {
      ...
      //var instance = new AmazonMemoryDb.CreateClusterResponseCluster();
      //expect(instance).to.be.a(AmazonMemoryDb.CreateClusterResponseCluster);
    });
