...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.UpdateSubnetGroupRequest();
  });
  ...
  describe('UpdateSubnetGroupRequest', function() {
    it('should create an instance of UpdateSubnetGroupRequest', function() {
      // uncomment below and update the code to test UpdateSubnetGroupRequest
      //var instance = new AmazonMemoryDb.UpdateSubnetGroupRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.UpdateSubnetGroupRequest);
    });
