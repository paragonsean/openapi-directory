...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.UnprocessedCluster();
  });
  ...
  describe('UnprocessedCluster', function() {
    it('should create an instance of UnprocessedCluster', function() {
      // uncomment below and update the code to test UnprocessedCluster
      //var instance = new AmazonMemoryDb.UnprocessedCluster();
      //expect(instance).to.be.a(AmazonMemoryDb.UnprocessedCluster);
    });
