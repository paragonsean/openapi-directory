...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.UpdateACLResponseACL();
  });
  ...
  describe('UpdateACLResponseACL', function() {
    it('should create an instance of UpdateACLResponseACL', function() {
      // uncomment below and update the code to test UpdateACLResponseACL
      //var instance = new AmazonMemoryDb.UpdateACLResponseACL();
      //expect(instance).to.be.a(AmazonMemoryDb.UpdateACLResponseACL);
    });
