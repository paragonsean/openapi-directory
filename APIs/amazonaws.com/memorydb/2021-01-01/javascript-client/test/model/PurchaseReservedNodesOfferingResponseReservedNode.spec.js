...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.PurchaseReservedNodesOfferingResponseReservedNode();
  });
  ...
  describe('PurchaseReservedNodesOfferingResponseReservedNode', function() {
    it('should create an instance of PurchaseReservedNodesOfferingResponseReservedNode', function() {
      // uncomment below and update the code to test PurchaseReservedNodesOfferingResponseReservedNode
      //var instance = new AmazonMemoryDb.PurchaseReservedNodesOfferingResponseReservedNode();
      //expect(instance).to.be.a(AmazonMemoryDb.PurchaseReservedNodesOfferingResponseReservedNode);
    });
