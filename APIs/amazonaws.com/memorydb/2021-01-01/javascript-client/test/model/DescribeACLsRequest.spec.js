...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.DescribeACLsRequest();
  });
  ...
  describe('DescribeACLsRequest', function() {
    it('should create an instance of DescribeACLsRequest', function() {
      // uncomment below and update the code to test DescribeACLsRequest
      //var instance = new AmazonMemoryDb.DescribeACLsRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.DescribeACLsRequest);
    });
