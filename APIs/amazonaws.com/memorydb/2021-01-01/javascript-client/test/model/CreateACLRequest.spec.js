...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.CreateACLRequest();
  });
  ...
  describe('CreateACLRequest', function() {
    it('should create an instance of CreateACLRequest', function() {
      // uncomment below and update the code to test CreateACLRequest
      //var instance = new AmazonMemoryDb.CreateACLRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.CreateACLRequest);
    });
