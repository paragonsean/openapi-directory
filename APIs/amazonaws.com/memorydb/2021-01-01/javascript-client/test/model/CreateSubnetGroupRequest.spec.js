...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.CreateSubnetGroupRequest();
  });
  ...
  describe('CreateSubnetGroupRequest', function() {
    it('should create an instance of CreateSubnetGroupRequest', function() {
      // uncomment below and update the code to test CreateSubnetGroupRequest
      //var instance = new AmazonMemoryDb.CreateSubnetGroupRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.CreateSubnetGroupRequest);
    });
