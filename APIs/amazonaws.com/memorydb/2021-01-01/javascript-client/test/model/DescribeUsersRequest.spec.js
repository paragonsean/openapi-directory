...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.DescribeUsersRequest();
  });
  ...
  describe('DescribeUsersRequest', function() {
    it('should create an instance of DescribeUsersRequest', function() {
      // uncomment below and update the code to test DescribeUsersRequest
      //var instance = new AmazonMemoryDb.DescribeUsersRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.DescribeUsersRequest);
    });
