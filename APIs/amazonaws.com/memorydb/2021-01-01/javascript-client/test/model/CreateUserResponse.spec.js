...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.CreateUserResponse();
  });
  ...
  describe('CreateUserResponse', function() {
    it('should create an instance of CreateUserResponse', function() {
      ...
      //var instance = new AmazonMemoryDb.CreateUserResponse();
      //expect(instance).to.be.a(AmazonMemoryDb.CreateUserResponse);
    });
