...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.UpdateClusterResponseCluster();
  });
  ...
  describe('UpdateClusterResponseCluster', function() {
    it('should create an instance of UpdateClusterResponseCluster', function() {
      // uncomment below and update the code to test UpdateClusterResponseCluster
      //var instance = new AmazonMemoryDb.UpdateClusterResponseCluster();
      //expect(instance).to.be.a(AmazonMemoryDb.UpdateClusterResponseCluster);
    });
