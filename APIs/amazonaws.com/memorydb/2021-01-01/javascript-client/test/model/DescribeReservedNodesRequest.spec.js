...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMemoryDb.DescribeReservedNodesRequest();
  });
  ...
  describe('DescribeReservedNodesRequest', function() {
    it('should create an instance of DescribeReservedNodesRequest', function() {
      // uncomment below and update the code to test DescribeReservedNodesRequest
      //var instance = new AmazonMemoryDb.DescribeReservedNodesRequest();
      //expect(instance).to.be.a(AmazonMemoryDb.DescribeReservedNodesRequest);
    });
