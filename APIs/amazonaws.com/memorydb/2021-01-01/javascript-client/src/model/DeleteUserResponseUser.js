...
/**
 * The DeleteUserResponseUser model module.
 * @module model/DeleteUserResponseUser
 * @version 2021-01-01
 */
class DeleteUserResponseUser {
    /**
     * Constructs a new <code>DeleteUserResponseUser</code>.
     * @alias module:model/DeleteUserResponseUser
     * @implements module:model/User
     */
    constructor() { 
        User.initialize(this);
        DeleteUserResponseUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteUserResponseUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteUserResponseUser} obj Optional instance to populate.
     * @return {module:model/DeleteUserResponseUser} The populated <code>DeleteUserResponseUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteUserResponseUser();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteUserResponseUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteUserResponseUser</code>.
     */
 ...
 * @member {String} Name
 */
DeleteUserResponseUser.prototype['Name'] = undefined;

/**
 * @member {String} Status
 */
DeleteUserResponseUser.prototype['Status'] = undefined;

/**
 * @member {String} AccessString
 */
DeleteUserResponseUser.prototype['AccessString'] = undefined;

/**
 * @member {Array} ACLNames
 */
DeleteUserResponseUser.prototype['ACLNames'] = undefined;

/**
 * @member {String} MinimumEngineVersion
 */
DeleteUserResponseUser.prototype['MinimumEngineVersion'] = undefined;

/**
 * @member {module:model/UserAuthentication} Authentication
 */
DeleteUserResponseUser.prototype['Authentication'] = undefined;

/**
 * @member {String} ARN
 */
DeleteUserResponseUser.prototype['ARN'] = undefined;
...
export default DeleteUserResponseUser;
