...
import DeleteSnapshotResponseSnapshot from './DeleteSnapshotResponseSnapshot';
...
class DeleteSnapshotResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Snapshot')) {
                obj['Snapshot'] = DeleteSnapshotResponseSnapshot.constructFromObject(data['Snapshot']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Snapshot']) { // data not null
          DeleteSnapshotResponseSnapshot.validateJSON(data['Snapshot']);
        }
...
/**
 * @member {module:model/DeleteSnapshotResponseSnapshot} Snapshot
 */
DeleteSnapshotResponse.prototype['Snapshot'] = undefined;
