...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://memory-db.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://memory-db.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-01-01/Javascript'
        };
