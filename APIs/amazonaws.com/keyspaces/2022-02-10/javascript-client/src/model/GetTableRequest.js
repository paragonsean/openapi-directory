...
/**
 * The GetTableRequest model module.
 * @module model/GetTableRequest
 * @version 2022-02-10
 */
class GetTableRequest {
    /**
     * Constructs a new <code>GetTableRequest</code>.
     * @alias module:model/GetTableRequest
     * @param keyspaceName {String} 
     * @param tableName {String} 
     */
    constructor(keyspaceName, tableName) { 
        
        GetTableRequest.initialize(this, keyspaceName, tableName);
    }
    ...
    /**
     * Constructs a <code>GetTableRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTableRequest} obj Optional instance to populate.
     * @return {module:model/GetTableRequest} The populated <code>GetTableRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTableRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTableRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTableRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetTableRequest.RequiredProperties) {
...
GetTableRequest.RequiredProperties = ["keyspaceName", "tableName"];

/**
 * @member {String} keyspaceName
 */
GetTableRequest.prototype['keyspaceName'] = undefined;

/**
 * @member {String} tableName
 */
GetTableRequest.prototype['tableName'] = undefined;
...
export default GetTableRequest;
