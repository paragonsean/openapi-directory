...
/**
 * The CreateTableRequestComment model module.
 * @module model/CreateTableRequestComment
 * @version 2022-02-10
 */
class CreateTableRequestComment {
    /**
     * Constructs a new <code>CreateTableRequestComment</code>.
     * @alias module:model/CreateTableRequestComment
     * @implements module:model/Comment
     * @param message {String} 
     */
    constructor(message) { 
        Comment.initialize(this, message);
        CreateTableRequestComment.initialize(this, message);
    }
    ...
    /**
     * Constructs a <code>CreateTableRequestComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTableRequestComment} obj Optional instance to populate.
     * @return {module:model/CreateTableRequestComment} The populated <code>CreateTableRequestComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTableRequestComment();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTableRequestComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTableRequestComment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTableRequestComment.RequiredProperties) {
...
CreateTableRequestComment.RequiredProperties = ["message"];

/**
 * @member {String} message
 */
CreateTableRequestComment.prototype['message'] = undefined;
...
export default CreateTableRequestComment;
