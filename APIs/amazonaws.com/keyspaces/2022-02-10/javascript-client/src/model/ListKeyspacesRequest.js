...
/**
 * The ListKeyspacesRequest model module.
 * @module model/ListKeyspacesRequest
 * @version 2022-02-10
 */
class ListKeyspacesRequest {
    /**
     * Constructs a new <code>ListKeyspacesRequest</code>.
     * @alias module:model/ListKeyspacesRequest
     */
    constructor() { 
        
        ListKeyspacesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListKeyspacesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListKeyspacesRequest} obj Optional instance to populate.
     * @return {module:model/ListKeyspacesRequest} The populated <code>ListKeyspacesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListKeyspacesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListKeyspacesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListKeyspacesRequest</code>.
     */
 ...
 */
ListKeyspacesRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListKeyspacesRequest.prototype['maxResults'] = undefined;
...
export default ListKeyspacesRequest;
