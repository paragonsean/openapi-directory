...
/**
 * The CapacitySpecificationSummary model module.
 * @module model/CapacitySpecificationSummary
 * @version 2022-02-10
 */
class CapacitySpecificationSummary {
    /**
     * Constructs a new <code>CapacitySpecificationSummary</code>.
     ...
     * @alias module:model/CapacitySpecificationSummary
    ...
    /**
     * Constructs a <code>CapacitySpecificationSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CapacitySpecificationSummary} obj Optional instance to populate.
     * @return {module:model/CapacitySpecificationSummary} The populated <code>CapacitySpecificationSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CapacitySpecificationSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>CapacitySpecificationSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CapacitySpecificationSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CapacitySpecificationSummary.RequiredProperties) {
...
CapacitySpecificationSummary.RequiredProperties = ["throughputMode"];
...
export default CapacitySpecificationSummary;
