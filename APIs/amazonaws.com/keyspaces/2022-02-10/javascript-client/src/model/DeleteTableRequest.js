...
/**
 * The DeleteTableRequest model module.
 * @module model/DeleteTableRequest
 * @version 2022-02-10
 */
class DeleteTableRequest {
    /**
     * Constructs a new <code>DeleteTableRequest</code>.
     * @alias module:model/DeleteTableRequest
     * @param keyspaceName {String} 
     * @param tableName {String} 
     */
    constructor(keyspaceName, tableName) { 
        
        DeleteTableRequest.initialize(this, keyspaceName, tableName);
    }
    ...
    /**
     * Constructs a <code>DeleteTableRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTableRequest} obj Optional instance to populate.
     * @return {module:model/DeleteTableRequest} The populated <code>DeleteTableRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTableRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTableRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTableRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteTableRequest.RequiredProperties) {
...
DeleteTableRequest.RequiredProperties = ["keyspaceName", "tableName"];

/**
 * @member {String} keyspaceName
 */
DeleteTableRequest.prototype['keyspaceName'] = undefined;

/**
 * @member {String} tableName
 */
DeleteTableRequest.prototype['tableName'] = undefined;
