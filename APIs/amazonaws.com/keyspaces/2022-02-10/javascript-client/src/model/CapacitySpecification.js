...
/**
 * The CapacitySpecification model module.
 * @module model/CapacitySpecification
 * @version 2022-02-10
 */
class CapacitySpecification {
    /**
     * Constructs a new <code>CapacitySpecification</code>.
     ...
     * @alias module:model/CapacitySpecification
    ...
    /**
     * Constructs a <code>CapacitySpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CapacitySpecification} obj Optional instance to populate.
     * @return {module:model/CapacitySpecification} The populated <code>CapacitySpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CapacitySpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>CapacitySpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CapacitySpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CapacitySpecification.RequiredProperties) {
...
CapacitySpecification.RequiredProperties = ["throughputMode"];
...
export default CapacitySpecification;
