...
class ColumnDefinition {
    ...
    constructor(name, type) { 
        ...
        ColumnDefinition.initialize(this, name, type);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ColumnDefinition.RequiredProperties) {
...
ColumnDefinition.RequiredProperties = ["name", "type"];
 ...
 * @member {String} type
 */
ColumnDefinition.prototype['type'] = undefined;
