...
/**
 * The PartitionKey model module.
 * @module model/PartitionKey
 * @version 2022-02-10
 */
class PartitionKey {
    /**
     * Constructs a new <code>PartitionKey</code>.
     ...
     * @alias module:model/PartitionKey
     * @param name {String} 
     */
    constructor(name) { 
        
        PartitionKey.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>PartitionKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartitionKey} obj Optional instance to populate.
     * @return {module:model/PartitionKey} The populated <code>PartitionKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartitionKey();
    ...
    /**
     * Validates the JSON data with respect to <code>PartitionKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartitionKey</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartitionKey.RequiredProperties) {
...
PartitionKey.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
PartitionKey.prototype['name'] = undefined;
