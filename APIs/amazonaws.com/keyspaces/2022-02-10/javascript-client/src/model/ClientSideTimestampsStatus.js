...
* @readonly
*/
export default class ClientSideTimestampsStatus {
    ...
    /**
    * Returns a <code>ClientSideTimestampsStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ClientSideTimestampsStatus} The enum <code>ClientSideTimestampsStatus</code> value.
    */
