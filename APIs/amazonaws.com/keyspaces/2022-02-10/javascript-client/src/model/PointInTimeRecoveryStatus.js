...
* @readonly
*/
export default class PointInTimeRecoveryStatus {
    ...
    /**
    * Returns a <code>PointInTimeRecoveryStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PointInTimeRecoveryStatus} The enum <code>PointInTimeRecoveryStatus</code> value.
    */
