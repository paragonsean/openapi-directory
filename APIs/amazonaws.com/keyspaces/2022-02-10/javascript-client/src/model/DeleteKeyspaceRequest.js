...
/**
 * The DeleteKeyspaceRequest model module.
 * @module model/DeleteKeyspaceRequest
 * @version 2022-02-10
 */
class DeleteKeyspaceRequest {
    /**
     * Constructs a new <code>DeleteKeyspaceRequest</code>.
     * @alias module:model/DeleteKeyspaceRequest
     * @param keyspaceName {String} 
     */
    constructor(keyspaceName) { 
        
        DeleteKeyspaceRequest.initialize(this, keyspaceName);
    }
    ...
    /**
     * Constructs a <code>DeleteKeyspaceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteKeyspaceRequest} obj Optional instance to populate.
     * @return {module:model/DeleteKeyspaceRequest} The populated <code>DeleteKeyspaceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteKeyspaceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteKeyspaceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteKeyspaceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteKeyspaceRequest.RequiredProperties) {
...
DeleteKeyspaceRequest.RequiredProperties = ["keyspaceName"];

/**
 * @member {String} keyspaceName
 */
DeleteKeyspaceRequest.prototype['keyspaceName'] = undefined;
...
export default DeleteKeyspaceRequest;
