...
/**
 * The ClientSideTimestamps model module.
 * @module model/ClientSideTimestamps
 * @version 2022-02-10
 */
class ClientSideTimestamps {
    /**
     * Constructs a new <code>ClientSideTimestamps</code>.
     ...
     * @alias module:model/ClientSideTimestamps
    ...
    /**
     * Constructs a <code>ClientSideTimestamps</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientSideTimestamps} obj Optional instance to populate.
     * @return {module:model/ClientSideTimestamps} The populated <code>ClientSideTimestamps</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientSideTimestamps();
    ...
    /**
     * Validates the JSON data with respect to <code>ClientSideTimestamps</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientSideTimestamps</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClientSideTimestamps.RequiredProperties) {
...
ClientSideTimestamps.RequiredProperties = ["status"];
...
export default ClientSideTimestamps;
