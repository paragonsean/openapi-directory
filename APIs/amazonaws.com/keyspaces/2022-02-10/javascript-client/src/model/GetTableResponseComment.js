...
/**
 * The GetTableResponseComment model module.
 * @module model/GetTableResponseComment
 * @version 2022-02-10
 */
class GetTableResponseComment {
    /**
     * Constructs a new <code>GetTableResponseComment</code>.
     * @alias module:model/GetTableResponseComment
     * @implements module:model/Comment
     * @param message {String} 
     */
    constructor(message) { 
        Comment.initialize(this, message);
        GetTableResponseComment.initialize(this, message);
    }
    ...
    /**
     * Constructs a <code>GetTableResponseComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTableResponseComment} obj Optional instance to populate.
     * @return {module:model/GetTableResponseComment} The populated <code>GetTableResponseComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTableResponseComment();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTableResponseComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTableResponseComment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetTableResponseComment.RequiredProperties) {
...
GetTableResponseComment.RequiredProperties = ["message"];

/**
 * @member {String} message
 */
GetTableResponseComment.prototype['message'] = undefined;
...
export default GetTableResponseComment;
