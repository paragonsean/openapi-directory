...
/**
 * The TimeToLive model module.
 * @module model/TimeToLive
 * @version 2022-02-10
 */
class TimeToLive {
    /**
     * Constructs a new <code>TimeToLive</code>.
    ...
    /**
     * Constructs a <code>TimeToLive</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeToLive} obj Optional instance to populate.
     * @return {module:model/TimeToLive} The populated <code>TimeToLive</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeToLive();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeToLive</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeToLive</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TimeToLive.RequiredProperties) {
...
TimeToLive.RequiredProperties = ["status"];
