...
/**
 * The CreateKeyspaceResponse model module.
 * @module model/CreateKeyspaceResponse
 * @version 2022-02-10
 */
class CreateKeyspaceResponse {
    /**
     * Constructs a new <code>CreateKeyspaceResponse</code>.
     * @alias module:model/CreateKeyspaceResponse
     * @param resourceArn {String} 
     */
    constructor(resourceArn) { 
        
        CreateKeyspaceResponse.initialize(this, resourceArn);
    }
    ...
    /**
     * Constructs a <code>CreateKeyspaceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateKeyspaceResponse} obj Optional instance to populate.
     * @return {module:model/CreateKeyspaceResponse} The populated <code>CreateKeyspaceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateKeyspaceResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateKeyspaceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateKeyspaceResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateKeyspaceResponse.RequiredProperties) {
...
CreateKeyspaceResponse.RequiredProperties = ["resourceArn"];

/**
 * @member {String} resourceArn
 */
CreateKeyspaceResponse.prototype['resourceArn'] = undefined;
...
export default CreateKeyspaceResponse;
