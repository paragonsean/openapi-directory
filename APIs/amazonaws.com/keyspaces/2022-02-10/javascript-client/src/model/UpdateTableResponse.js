...
/**
 * The UpdateTableResponse model module.
 * @module model/UpdateTableResponse
 * @version 2022-02-10
 */
class UpdateTableResponse {
    /**
     * Constructs a new <code>UpdateTableResponse</code>.
     * @alias module:model/UpdateTableResponse
     * @param resourceArn {String} 
     */
    constructor(resourceArn) { 
        
        UpdateTableResponse.initialize(this, resourceArn);
    }
    ...
    /**
     * Constructs a <code>UpdateTableResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateTableResponse} obj Optional instance to populate.
     * @return {module:model/UpdateTableResponse} The populated <code>UpdateTableResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateTableResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateTableResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateTableResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateTableResponse.RequiredProperties) {
...
UpdateTableResponse.RequiredProperties = ["resourceArn"];

/**
 * @member {String} resourceArn
 */
UpdateTableResponse.prototype['resourceArn'] = undefined;
...
export default UpdateTableResponse;
