...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.UpdateTableResponse();
  });
  ...
  describe('UpdateTableResponse', function() {
    it('should create an instance of UpdateTableResponse', function() {
      // uncomment below and update the code to test UpdateTableResponse
      //var instance = new AmazonKeyspaces.UpdateTableResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.UpdateTableResponse);
    });
