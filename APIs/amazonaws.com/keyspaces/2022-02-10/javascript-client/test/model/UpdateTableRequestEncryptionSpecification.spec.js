...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.UpdateTableRequestEncryptionSpecification();
  });
  ...
  describe('UpdateTableRequestEncryptionSpecification', function() {
    it('should create an instance of UpdateTableRequestEncryptionSpecification', function() {
      // uncomment below and update the code to test UpdateTableRequestEncryptionSpecification
      //var instance = new AmazonKeyspaces.UpdateTableRequestEncryptionSpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.UpdateTableRequestEncryptionSpecification);
    });
