...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequestCapacitySpecification();
  });
  ...
  describe('CreateTableRequestCapacitySpecification', function() {
    it('should create an instance of CreateTableRequestCapacitySpecification', function() {
      // uncomment below and update the code to test CreateTableRequestCapacitySpecification
      //var instance = new AmazonKeyspaces.CreateTableRequestCapacitySpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequestCapacitySpecification);
    });
