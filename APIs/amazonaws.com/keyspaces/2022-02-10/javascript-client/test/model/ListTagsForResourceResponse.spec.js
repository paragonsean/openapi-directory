...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonKeyspaces.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.ListTagsForResourceResponse);
    });
