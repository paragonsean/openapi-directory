...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ListTablesRequest();
  });
  ...
  describe('ListTablesRequest', function() {
    it('should create an instance of ListTablesRequest', function() {
      // uncomment below and update the code to test ListTablesRequest
      //var instance = new AmazonKeyspaces.ListTablesRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.ListTablesRequest);
    });
