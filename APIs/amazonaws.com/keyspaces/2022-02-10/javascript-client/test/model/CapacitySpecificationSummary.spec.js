...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CapacitySpecificationSummary();
  });
  ...
  describe('CapacitySpecificationSummary', function() {
    it('should create an instance of CapacitySpecificationSummary', function() {
      // uncomment below and update the code to test CapacitySpecificationSummary
      //var instance = new AmazonKeyspaces.CapacitySpecificationSummary();
      //expect(instance).to.be.a(AmazonKeyspaces.CapacitySpecificationSummary);
    });
