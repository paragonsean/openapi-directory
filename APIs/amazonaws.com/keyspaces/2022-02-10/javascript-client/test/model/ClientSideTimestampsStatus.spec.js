...
(function(root, factory) {
  ...
  describe('ClientSideTimestampsStatus', function() {
    it('should create an instance of ClientSideTimestampsStatus', function() {
      // uncomment below and update the code to test ClientSideTimestampsStatus
      //var instance = new AmazonKeyspaces.ClientSideTimestampsStatus();
      //expect(instance).to.be.a(AmazonKeyspaces.ClientSideTimestampsStatus);
    });
