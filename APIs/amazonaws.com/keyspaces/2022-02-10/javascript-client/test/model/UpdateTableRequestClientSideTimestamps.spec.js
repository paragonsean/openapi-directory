...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.UpdateTableRequestClientSideTimestamps();
  });
  ...
  describe('UpdateTableRequestClientSideTimestamps', function() {
    it('should create an instance of UpdateTableRequestClientSideTimestamps', function() {
      // uncomment below and update the code to test UpdateTableRequestClientSideTimestamps
      //var instance = new AmazonKeyspaces.UpdateTableRequestClientSideTimestamps();
      //expect(instance).to.be.a(AmazonKeyspaces.UpdateTableRequestClientSideTimestamps);
    });
