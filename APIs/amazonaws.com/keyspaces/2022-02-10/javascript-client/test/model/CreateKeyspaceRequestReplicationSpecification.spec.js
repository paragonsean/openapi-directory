...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateKeyspaceRequestReplicationSpecification();
  });
  ...
  describe('CreateKeyspaceRequestReplicationSpecification', function() {
    it('should create an instance of CreateKeyspaceRequestReplicationSpecification', function() {
      // uncomment below and update the code to test CreateKeyspaceRequestReplicationSpecification
      //var instance = new AmazonKeyspaces.CreateKeyspaceRequestReplicationSpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateKeyspaceRequestReplicationSpecification);
    });
