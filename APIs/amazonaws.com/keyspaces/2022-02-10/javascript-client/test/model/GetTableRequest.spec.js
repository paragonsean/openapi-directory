...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableRequest();
  });
  ...
  describe('GetTableRequest', function() {
    it('should create an instance of GetTableRequest', function() {
      // uncomment below and update the code to test GetTableRequest
      //var instance = new AmazonKeyspaces.GetTableRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableRequest);
    });
