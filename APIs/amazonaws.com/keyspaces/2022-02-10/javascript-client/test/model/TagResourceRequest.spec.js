...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonKeyspaces.TagResourceRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.TagResourceRequest);
    });
