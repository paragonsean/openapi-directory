...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequestSchemaDefinition();
  });
  ...
  describe('CreateTableRequestSchemaDefinition', function() {
    it('should create an instance of CreateTableRequestSchemaDefinition', function() {
      // uncomment below and update the code to test CreateTableRequestSchemaDefinition
      //var instance = new AmazonKeyspaces.CreateTableRequestSchemaDefinition();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequestSchemaDefinition);
    });
