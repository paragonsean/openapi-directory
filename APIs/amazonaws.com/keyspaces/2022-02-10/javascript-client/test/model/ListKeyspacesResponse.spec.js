...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ListKeyspacesResponse();
  });
  ...
  describe('ListKeyspacesResponse', function() {
    it('should create an instance of ListKeyspacesResponse', function() {
      // uncomment below and update the code to test ListKeyspacesResponse
      //var instance = new AmazonKeyspaces.ListKeyspacesResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.ListKeyspacesResponse);
    });
    ...
    it('should have the property keyspaces (base name: "keyspaces")', function() {
      // uncomment below and update the code to test the property keyspaces
      //var instance = new AmazonKeyspaces.ListKeyspacesResponse();
      //expect(instance).to.be();
    });
