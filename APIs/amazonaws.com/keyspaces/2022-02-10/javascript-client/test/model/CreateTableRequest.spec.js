...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequest();
  });
  ...
  describe('CreateTableRequest', function() {
    it('should create an instance of CreateTableRequest', function() {
      ...
      //var instance = new AmazonKeyspaces.CreateTableRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequest);
    });
