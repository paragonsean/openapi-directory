...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetKeyspaceResponse();
  });
  ...
  describe('GetKeyspaceResponse', function() {
    it('should create an instance of GetKeyspaceResponse', function() {
      // uncomment below and update the code to test GetKeyspaceResponse
      //var instance = new AmazonKeyspaces.GetKeyspaceResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.GetKeyspaceResponse);
    });
