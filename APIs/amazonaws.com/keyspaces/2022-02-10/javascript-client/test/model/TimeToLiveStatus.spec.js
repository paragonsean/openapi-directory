...
(function(root, factory) {
  ...
  describe('TimeToLiveStatus', function() {
    it('should create an instance of TimeToLiveStatus', function() {
      // uncomment below and update the code to test TimeToLiveStatus
      //var instance = new AmazonKeyspaces.TimeToLiveStatus();
      //expect(instance).to.be.a(AmazonKeyspaces.TimeToLiveStatus);
    });
