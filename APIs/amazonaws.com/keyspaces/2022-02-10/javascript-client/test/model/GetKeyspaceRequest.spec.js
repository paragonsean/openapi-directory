...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetKeyspaceRequest();
  });
  ...
  describe('GetKeyspaceRequest', function() {
    it('should create an instance of GetKeyspaceRequest', function() {
      // uncomment below and update the code to test GetKeyspaceRequest
      //var instance = new AmazonKeyspaces.GetKeyspaceRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.GetKeyspaceRequest);
    });
