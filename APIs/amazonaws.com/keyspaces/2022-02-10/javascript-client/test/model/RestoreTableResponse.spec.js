...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.RestoreTableResponse();
  });
  ...
  describe('RestoreTableResponse', function() {
    it('should create an instance of RestoreTableResponse', function() {
      // uncomment below and update the code to test RestoreTableResponse
      //var instance = new AmazonKeyspaces.RestoreTableResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.RestoreTableResponse);
    });

    it('should have the property restoredTableARN (base name: "restoredTableARN")', function() {
      // uncomment below and update the code to test the property restoredTableARN
      //var instance = new AmazonKeyspaces.RestoreTableResponse();
