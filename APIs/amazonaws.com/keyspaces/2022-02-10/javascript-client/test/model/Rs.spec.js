...
(function(root, factory) {
  ...
  describe('Rs', function() {
    it('should create an instance of Rs', function() {
      // uncomment below and update the code to test Rs
      //var instance = new AmazonKeyspaces.Rs();
      //expect(instance).to.be.a(AmazonKeyspaces.Rs);
    });
