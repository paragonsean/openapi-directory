...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonKeyspaces.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.UntagResourceRequest);
    });
