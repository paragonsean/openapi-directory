...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.UpdateTableRequest();
  });
  ...
  describe('UpdateTableRequest', function() {
    it('should create an instance of UpdateTableRequest', function() {
      // uncomment below and update the code to test UpdateTableRequest
      //var instance = new AmazonKeyspaces.UpdateTableRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.UpdateTableRequest);
    });
