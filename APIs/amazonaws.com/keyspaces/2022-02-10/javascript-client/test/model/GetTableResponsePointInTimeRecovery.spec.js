...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableResponsePointInTimeRecovery();
  });
  ...
  describe('GetTableResponsePointInTimeRecovery', function() {
    it('should create an instance of GetTableResponsePointInTimeRecovery', function() {
      // uncomment below and update the code to test GetTableResponsePointInTimeRecovery
      //var instance = new AmazonKeyspaces.GetTableResponsePointInTimeRecovery();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableResponsePointInTimeRecovery);
    });
    ...
    it('should have the property earliestRestorableTimestamp (base name: "earliestRestorableTimestamp")', function() {
      // uncomment below and update the code to test the property earliestRestorableTimestamp
      //var instance = new AmazonKeyspaces.GetTableResponsePointInTimeRecovery();
      //expect(instance).to.be();
    });
