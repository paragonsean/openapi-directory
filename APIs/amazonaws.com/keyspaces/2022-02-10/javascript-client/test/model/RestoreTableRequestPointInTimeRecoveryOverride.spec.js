...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.RestoreTableRequestPointInTimeRecoveryOverride();
  });
  ...
  describe('RestoreTableRequestPointInTimeRecoveryOverride', function() {
    it('should create an instance of RestoreTableRequestPointInTimeRecoveryOverride', function() {
      // uncomment below and update the code to test RestoreTableRequestPointInTimeRecoveryOverride
      //var instance = new AmazonKeyspaces.RestoreTableRequestPointInTimeRecoveryOverride();
      //expect(instance).to.be.a(AmazonKeyspaces.RestoreTableRequestPointInTimeRecoveryOverride);
    });
