...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ListKeyspacesRequest();
  });
  ...
  describe('ListKeyspacesRequest', function() {
    it('should create an instance of ListKeyspacesRequest', function() {
      // uncomment below and update the code to test ListKeyspacesRequest
      //var instance = new AmazonKeyspaces.ListKeyspacesRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.ListKeyspacesRequest);
    });
