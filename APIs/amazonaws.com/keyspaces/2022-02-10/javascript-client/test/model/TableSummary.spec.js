...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.TableSummary();
  });
  ...
  describe('TableSummary', function() {
    it('should create an instance of TableSummary', function() {
      // uncomment below and update the code to test TableSummary
      //var instance = new AmazonKeyspaces.TableSummary();
      //expect(instance).to.be.a(AmazonKeyspaces.TableSummary);
    });
