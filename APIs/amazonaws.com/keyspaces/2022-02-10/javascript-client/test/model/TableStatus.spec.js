...
(function(root, factory) {
  ...
  describe('TableStatus', function() {
    it('should create an instance of TableStatus', function() {
      // uncomment below and update the code to test TableStatus
      //var instance = new AmazonKeyspaces.TableStatus();
      //expect(instance).to.be.a(AmazonKeyspaces.TableStatus);
    });
