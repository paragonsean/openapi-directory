...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ClientSideTimestamps();
  });
  ...
  describe('ClientSideTimestamps', function() {
    it('should create an instance of ClientSideTimestamps', function() {
      // uncomment below and update the code to test ClientSideTimestamps
      //var instance = new AmazonKeyspaces.ClientSideTimestamps();
      //expect(instance).to.be.a(AmazonKeyspaces.ClientSideTimestamps);
    });
