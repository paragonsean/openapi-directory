...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.UpdateTableRequestPointInTimeRecovery();
  });
  ...
  describe('UpdateTableRequestPointInTimeRecovery', function() {
    it('should create an instance of UpdateTableRequestPointInTimeRecovery', function() {
      // uncomment below and update the code to test UpdateTableRequestPointInTimeRecovery
      //var instance = new AmazonKeyspaces.UpdateTableRequestPointInTimeRecovery();
      //expect(instance).to.be.a(AmazonKeyspaces.UpdateTableRequestPointInTimeRecovery);
    });
