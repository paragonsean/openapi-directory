...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateKeyspaceResponse();
  });
  ...
  describe('CreateKeyspaceResponse', function() {
    it('should create an instance of CreateKeyspaceResponse', function() {
      // uncomment below and update the code to test CreateKeyspaceResponse
      //var instance = new AmazonKeyspaces.CreateKeyspaceResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateKeyspaceResponse);
    });
