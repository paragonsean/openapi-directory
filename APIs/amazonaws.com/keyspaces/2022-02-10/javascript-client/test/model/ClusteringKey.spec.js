...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ClusteringKey();
  });
  ...
  describe('ClusteringKey', function() {
    it('should create an instance of ClusteringKey', function() {
      // uncomment below and update the code to test ClusteringKey
      //var instance = new AmazonKeyspaces.ClusteringKey();
      //expect(instance).to.be.a(AmazonKeyspaces.ClusteringKey);
    });
