...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.DeleteKeyspaceRequest();
  });
  ...
  describe('DeleteKeyspaceRequest', function() {
    it('should create an instance of DeleteKeyspaceRequest', function() {
      // uncomment below and update the code to test DeleteKeyspaceRequest
      //var instance = new AmazonKeyspaces.DeleteKeyspaceRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.DeleteKeyspaceRequest);
    });
