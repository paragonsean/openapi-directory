...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableResponseTtl();
  });
  ...
  describe('GetTableResponseTtl', function() {
    it('should create an instance of GetTableResponseTtl', function() {
      // uncomment below and update the code to test GetTableResponseTtl
      //var instance = new AmazonKeyspaces.GetTableResponseTtl();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableResponseTtl);
    });
