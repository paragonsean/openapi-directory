...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.PartitionKey();
  });
  ...
  describe('PartitionKey', function() {
    it('should create an instance of PartitionKey', function() {
      // uncomment below and update the code to test PartitionKey
      //var instance = new AmazonKeyspaces.PartitionKey();
      //expect(instance).to.be.a(AmazonKeyspaces.PartitionKey);
    });
