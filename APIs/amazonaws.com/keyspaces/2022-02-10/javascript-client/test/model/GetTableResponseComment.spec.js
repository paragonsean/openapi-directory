...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableResponseComment();
  });
  ...
  describe('GetTableResponseComment', function() {
    it('should create an instance of GetTableResponseComment', function() {
      // uncomment below and update the code to test GetTableResponseComment
      //var instance = new AmazonKeyspaces.GetTableResponseComment();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableResponseComment);
    });
