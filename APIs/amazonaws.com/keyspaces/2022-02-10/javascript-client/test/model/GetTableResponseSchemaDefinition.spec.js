...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableResponseSchemaDefinition();
  });
  ...
  describe('GetTableResponseSchemaDefinition', function() {
    it('should create an instance of GetTableResponseSchemaDefinition', function() {
      // uncomment below and update the code to test GetTableResponseSchemaDefinition
      //var instance = new AmazonKeyspaces.GetTableResponseSchemaDefinition();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableResponseSchemaDefinition);
    });

    it('should have the property allColumns (base name: "allColumns")', function() {
      // uncomment below and update the code to test the property allColumns
      //var instance = new AmazonKeyspaces.GetTableResponseSchemaDefinition();
    ...
    it('should have the property clusteringKeys (base name: "clusteringKeys")', function() {
      // uncomment below and update the code to test the property clusteringKeys
      //var instance = new AmazonKeyspaces.GetTableResponseSchemaDefinition();
      //expect(instance).to.be();
    });

    it('should have the property staticColumns (base name: "staticColumns")', function() {
      // uncomment below and update the code to test the property staticColumns
      //var instance = new AmazonKeyspaces.GetTableResponseSchemaDefinition();
      //expect(instance).to.be();
    });
