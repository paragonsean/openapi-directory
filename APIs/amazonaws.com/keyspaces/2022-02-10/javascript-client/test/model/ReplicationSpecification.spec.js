...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ReplicationSpecification();
  });
  ...
  describe('ReplicationSpecification', function() {
    it('should create an instance of ReplicationSpecification', function() {
      // uncomment below and update the code to test ReplicationSpecification
      //var instance = new AmazonKeyspaces.ReplicationSpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.ReplicationSpecification);
    });

    it('should have the property replicationStrategy (base name: "replicationStrategy")', function() {
      // uncomment below and update the code to test the property replicationStrategy
      //var instance = new AmazonKeyspaces.ReplicationSpecification();
      //expect(instance).to.be();
    });

    it('should have the property regionList (base name: "regionList")', function() {
      // uncomment below and update the code to test the property regionList
      //var instance = new AmazonKeyspaces.ReplicationSpecification();
      //expect(instance).to.be();
    });
