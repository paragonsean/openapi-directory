...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableResponseClientSideTimestamps();
  });
  ...
  describe('GetTableResponseClientSideTimestamps', function() {
    it('should create an instance of GetTableResponseClientSideTimestamps', function() {
      // uncomment below and update the code to test GetTableResponseClientSideTimestamps
      //var instance = new AmazonKeyspaces.GetTableResponseClientSideTimestamps();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableResponseClientSideTimestamps);
    });
