...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.RestoreTableRequestCapacitySpecificationOverride();
  });
  ...
  describe('RestoreTableRequestCapacitySpecificationOverride', function() {
    it('should create an instance of RestoreTableRequestCapacitySpecificationOverride', function() {
      // uncomment below and update the code to test RestoreTableRequestCapacitySpecificationOverride
      //var instance = new AmazonKeyspaces.RestoreTableRequestCapacitySpecificationOverride();
      //expect(instance).to.be.a(AmazonKeyspaces.RestoreTableRequestCapacitySpecificationOverride);
    });
