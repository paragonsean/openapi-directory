...
(function(root, factory) {
  ...
  describe('PointInTimeRecoveryStatus', function() {
    it('should create an instance of PointInTimeRecoveryStatus', function() {
      // uncomment below and update the code to test PointInTimeRecoveryStatus
      //var instance = new AmazonKeyspaces.PointInTimeRecoveryStatus();
      //expect(instance).to.be.a(AmazonKeyspaces.PointInTimeRecoveryStatus);
    });
