...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequestTtl();
  });
  ...
  describe('CreateTableRequestTtl', function() {
    it('should create an instance of CreateTableRequestTtl', function() {
      // uncomment below and update the code to test CreateTableRequestTtl
      //var instance = new AmazonKeyspaces.CreateTableRequestTtl();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequestTtl);
    });
