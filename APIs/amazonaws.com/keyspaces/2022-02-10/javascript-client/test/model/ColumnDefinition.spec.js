...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ColumnDefinition();
  });
  ...
  describe('ColumnDefinition', function() {
    it('should create an instance of ColumnDefinition', function() {
      // uncomment below and update the code to test ColumnDefinition
      //var instance = new AmazonKeyspaces.ColumnDefinition();
      //expect(instance).to.be.a(AmazonKeyspaces.ColumnDefinition);
    });
