...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequestClientSideTimestamps();
  });
  ...
  describe('CreateTableRequestClientSideTimestamps', function() {
    it('should create an instance of CreateTableRequestClientSideTimestamps', function() {
      // uncomment below and update the code to test CreateTableRequestClientSideTimestamps
      //var instance = new AmazonKeyspaces.CreateTableRequestClientSideTimestamps();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequestClientSideTimestamps);
    });
