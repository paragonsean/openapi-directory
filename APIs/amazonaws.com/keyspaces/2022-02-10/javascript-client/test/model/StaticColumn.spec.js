...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.StaticColumn();
  });
  ...
  describe('StaticColumn', function() {
    it('should create an instance of StaticColumn', function() {
      // uncomment below and update the code to test StaticColumn
      //var instance = new AmazonKeyspaces.StaticColumn();
      //expect(instance).to.be.a(AmazonKeyspaces.StaticColumn);
    });
