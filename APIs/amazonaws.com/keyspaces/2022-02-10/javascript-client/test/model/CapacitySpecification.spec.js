...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CapacitySpecification();
  });
  ...
  describe('CapacitySpecification', function() {
    it('should create an instance of CapacitySpecification', function() {
      // uncomment below and update the code to test CapacitySpecification
      //var instance = new AmazonKeyspaces.CapacitySpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.CapacitySpecification);
    });
