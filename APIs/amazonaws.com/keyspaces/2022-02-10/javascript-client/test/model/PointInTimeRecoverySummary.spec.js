...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.PointInTimeRecoverySummary();
  });
  ...
  describe('PointInTimeRecoverySummary', function() {
    it('should create an instance of PointInTimeRecoverySummary', function() {
      // uncomment below and update the code to test PointInTimeRecoverySummary
      //var instance = new AmazonKeyspaces.PointInTimeRecoverySummary();
      //expect(instance).to.be.a(AmazonKeyspaces.PointInTimeRecoverySummary);
    });
