...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequestComment();
  });
  ...
  describe('CreateTableRequestComment', function() {
    it('should create an instance of CreateTableRequestComment', function() {
      // uncomment below and update the code to test CreateTableRequestComment
      //var instance = new AmazonKeyspaces.CreateTableRequestComment();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequestComment);
    });
