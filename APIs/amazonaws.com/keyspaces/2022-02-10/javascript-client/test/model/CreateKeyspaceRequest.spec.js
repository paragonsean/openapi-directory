...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateKeyspaceRequest();
  });
  ...
  describe('CreateKeyspaceRequest', function() {
    it('should create an instance of CreateKeyspaceRequest', function() {
      // uncomment below and update the code to test CreateKeyspaceRequest
      //var instance = new AmazonKeyspaces.CreateKeyspaceRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateKeyspaceRequest);
    });
    ...
    it('should have the property replicationSpecification (base name: "replicationSpecification")', function() {
      // uncomment below and update the code to test the property replicationSpecification
      //var instance = new AmazonKeyspaces.CreateKeyspaceRequest();
      //expect(instance).to.be();
    });
