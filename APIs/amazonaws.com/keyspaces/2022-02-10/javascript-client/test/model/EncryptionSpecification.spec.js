...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.EncryptionSpecification();
  });
  ...
  describe('EncryptionSpecification', function() {
    it('should create an instance of EncryptionSpecification', function() {
      // uncomment below and update the code to test EncryptionSpecification
      //var instance = new AmazonKeyspaces.EncryptionSpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.EncryptionSpecification);
    });
