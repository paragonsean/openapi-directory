...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableResponse();
  });
  ...
  describe('CreateTableResponse', function() {
    it('should create an instance of CreateTableResponse', function() {
      // uncomment below and update the code to test CreateTableResponse
      //var instance = new AmazonKeyspaces.CreateTableResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableResponse);
    });
