...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonKeyspaces.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.ListTagsForResourceRequest);
    });
