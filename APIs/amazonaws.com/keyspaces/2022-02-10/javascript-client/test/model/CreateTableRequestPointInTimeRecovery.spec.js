...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequestPointInTimeRecovery();
  });
  ...
  describe('CreateTableRequestPointInTimeRecovery', function() {
    it('should create an instance of CreateTableRequestPointInTimeRecovery', function() {
      // uncomment below and update the code to test CreateTableRequestPointInTimeRecovery
      //var instance = new AmazonKeyspaces.CreateTableRequestPointInTimeRecovery();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequestPointInTimeRecovery);
    });
