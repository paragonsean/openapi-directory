...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.KeyspaceSummary();
  });
  ...
  describe('KeyspaceSummary', function() {
    it('should create an instance of KeyspaceSummary', function() {
      // uncomment below and update the code to test KeyspaceSummary
      //var instance = new AmazonKeyspaces.KeyspaceSummary();
      //expect(instance).to.be.a(AmazonKeyspaces.KeyspaceSummary);
    });
