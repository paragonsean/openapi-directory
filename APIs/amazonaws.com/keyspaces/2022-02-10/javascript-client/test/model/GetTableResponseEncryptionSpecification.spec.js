...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableResponseEncryptionSpecification();
  });
  ...
  describe('GetTableResponseEncryptionSpecification', function() {
    it('should create an instance of GetTableResponseEncryptionSpecification', function() {
      // uncomment below and update the code to test GetTableResponseEncryptionSpecification
      //var instance = new AmazonKeyspaces.GetTableResponseEncryptionSpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableResponseEncryptionSpecification);
    });
