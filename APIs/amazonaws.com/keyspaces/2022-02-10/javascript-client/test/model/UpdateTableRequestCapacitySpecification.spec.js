...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.UpdateTableRequestCapacitySpecification();
  });
  ...
  describe('UpdateTableRequestCapacitySpecification', function() {
    it('should create an instance of UpdateTableRequestCapacitySpecification', function() {
      // uncomment below and update the code to test UpdateTableRequestCapacitySpecification
      //var instance = new AmazonKeyspaces.UpdateTableRequestCapacitySpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.UpdateTableRequestCapacitySpecification);
    });
