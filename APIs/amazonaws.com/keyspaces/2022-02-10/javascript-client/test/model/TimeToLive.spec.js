...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.TimeToLive();
  });
  ...
  describe('TimeToLive', function() {
    it('should create an instance of TimeToLive', function() {
      // uncomment below and update the code to test TimeToLive
      //var instance = new AmazonKeyspaces.TimeToLive();
      //expect(instance).to.be.a(AmazonKeyspaces.TimeToLive);
    });
