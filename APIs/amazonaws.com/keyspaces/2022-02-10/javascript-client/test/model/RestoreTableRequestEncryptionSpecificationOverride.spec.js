...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.RestoreTableRequestEncryptionSpecificationOverride();
  });
  ...
  describe('RestoreTableRequestEncryptionSpecificationOverride', function() {
    it('should create an instance of RestoreTableRequestEncryptionSpecificationOverride', function() {
      // uncomment below and update the code to test RestoreTableRequestEncryptionSpecificationOverride
      //var instance = new AmazonKeyspaces.RestoreTableRequestEncryptionSpecificationOverride();
      //expect(instance).to.be.a(AmazonKeyspaces.RestoreTableRequestEncryptionSpecificationOverride);
    });
