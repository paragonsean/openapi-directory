...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.DeleteTableRequest();
  });
  ...
  describe('DeleteTableRequest', function() {
    it('should create an instance of DeleteTableRequest', function() {
      // uncomment below and update the code to test DeleteTableRequest
      //var instance = new AmazonKeyspaces.DeleteTableRequest();
      //expect(instance).to.be.a(AmazonKeyspaces.DeleteTableRequest);
    });
