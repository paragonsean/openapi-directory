...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.GetTableResponseCapacitySpecification();
  });
  ...
  describe('GetTableResponseCapacitySpecification', function() {
    it('should create an instance of GetTableResponseCapacitySpecification', function() {
      // uncomment below and update the code to test GetTableResponseCapacitySpecification
      //var instance = new AmazonKeyspaces.GetTableResponseCapacitySpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.GetTableResponseCapacitySpecification);
    });
    ...
    it('should have the property lastUpdateToPayPerRequestTimestamp (base name: "lastUpdateToPayPerRequestTimestamp")', function() {
      // uncomment below and update the code to test the property lastUpdateToPayPerRequestTimestamp
      //var instance = new AmazonKeyspaces.GetTableResponseCapacitySpecification();
      //expect(instance).to.be();
    });
