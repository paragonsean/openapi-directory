...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.ListTablesResponse();
  });
  ...
  describe('ListTablesResponse', function() {
    it('should create an instance of ListTablesResponse', function() {
      ...
      //var instance = new AmazonKeyspaces.ListTablesResponse();
      //expect(instance).to.be.a(AmazonKeyspaces.ListTablesResponse);
    });
