...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.CreateTableRequestEncryptionSpecification();
  });
  ...
  describe('CreateTableRequestEncryptionSpecification', function() {
    it('should create an instance of CreateTableRequestEncryptionSpecification', function() {
      // uncomment below and update the code to test CreateTableRequestEncryptionSpecification
      //var instance = new AmazonKeyspaces.CreateTableRequestEncryptionSpecification();
      //expect(instance).to.be.a(AmazonKeyspaces.CreateTableRequestEncryptionSpecification);
    });
