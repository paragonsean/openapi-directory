...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKeyspaces.PointInTimeRecovery();
  });
  ...
  describe('PointInTimeRecovery', function() {
    it('should create an instance of PointInTimeRecovery', function() {
      // uncomment below and update the code to test PointInTimeRecovery
      //var instance = new AmazonKeyspaces.PointInTimeRecovery();
      //expect(instance).to.be.a(AmazonKeyspaces.PointInTimeRecovery);
    });
