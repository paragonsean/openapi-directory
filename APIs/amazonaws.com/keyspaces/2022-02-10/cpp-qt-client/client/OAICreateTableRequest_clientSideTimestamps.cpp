...
OAICreateTableRequest_clientSideTimestamps::OAICreateTableRequest_clientSideTimestamps(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTableRequest_clientSideTimestamps::OAICreateTableRequest_clientSideTimestamps() {
    this->initializeModel();
}

OAICreateTableRequest_clientSideTimestamps::~OAICreateTableRequest_clientSideTimestamps() {}

void OAICreateTableRequest_clientSideTimestamps::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAICreateTableRequest_clientSideTimestamps::fromJson(QString jsonString) {
...
void OAICreateTableRequest_clientSideTimestamps::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAICreateTableRequest_clientSideTimestamps::asJson() const {
...
QJsonObject OAICreateTableRequest_clientSideTimestamps::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIClientSideTimestampsStatus OAICreateTableRequest_clientSideTimestamps::getStatus() const {
    return m_status;
}
void OAICreateTableRequest_clientSideTimestamps::setStatus(const OAIClientSideTimestampsStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateTableRequest_clientSideTimestamps::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateTableRequest_clientSideTimestamps::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICreateTableRequest_clientSideTimestamps::isSet() const {
...
bool OAICreateTableRequest_clientSideTimestamps::isValid() const {
