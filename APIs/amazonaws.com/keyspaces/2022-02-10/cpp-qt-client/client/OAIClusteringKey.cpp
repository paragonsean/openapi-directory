...
OAIClusteringKey::OAIClusteringKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClusteringKey::OAIClusteringKey() {
    this->initializeModel();
}

OAIClusteringKey::~OAIClusteringKey() {}

void OAIClusteringKey::initializeModel() {
...
void OAIClusteringKey::fromJson(QString jsonString) {
...
void OAIClusteringKey::fromJsonObject(QJsonObject json) {
...
QString OAIClusteringKey::asJson() const {
...
QJsonObject OAIClusteringKey::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIClusteringKey::getName() const {
    return m_name;
}
void OAIClusteringKey::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIClusteringKey::is_name_Set() const{
    return m_name_isSet;
}

bool OAIClusteringKey::is_name_Valid() const{
    return m_name_isValid;
}

OAISortOrder OAIClusteringKey::getOrderBy() const {
    return m_order_by;
}
void OAIClusteringKey::setOrderBy(const OAISortOrder &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAIClusteringKey::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAIClusteringKey::is_order_by_Valid() const{
    return m_order_by_isValid;
}

bool OAIClusteringKey::isSet() const {
...
bool OAIClusteringKey::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_order_by_isValid && true;
}
