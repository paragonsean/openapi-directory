...
/*
 * OAIGetKeyspaceRequest.h
 *
 * 
 */

#ifndef OAIGetKeyspaceRequest_H
#define OAIGetKeyspaceRequest_H
...
class OAIGetKeyspaceRequest : public OAIObject {
public:
    OAIGetKeyspaceRequest();
    OAIGetKeyspaceRequest(QString json);
    ~OAIGetKeyspaceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetKeyspaceRequest)

#endif // OAIGetKeyspaceRequest_H
