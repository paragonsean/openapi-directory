...
OAICreateTableRequest_capacitySpecification::OAICreateTableRequest_capacitySpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTableRequest_capacitySpecification::OAICreateTableRequest_capacitySpecification() {
    this->initializeModel();
}

OAICreateTableRequest_capacitySpecification::~OAICreateTableRequest_capacitySpecification() {}

void OAICreateTableRequest_capacitySpecification::initializeModel() {
...
void OAICreateTableRequest_capacitySpecification::fromJson(QString jsonString) {
...
void OAICreateTableRequest_capacitySpecification::fromJsonObject(QJsonObject json) {
...
QString OAICreateTableRequest_capacitySpecification::asJson() const {
...
QJsonObject OAICreateTableRequest_capacitySpecification::asJsonObject() const {
    QJsonObject obj;
...
OAIThroughputMode OAICreateTableRequest_capacitySpecification::getThroughputMode() const {
    return m_throughput_mode;
}
void OAICreateTableRequest_capacitySpecification::setThroughputMode(const OAIThroughputMode &throughput_mode) {
    m_throughput_mode = throughput_mode;
    m_throughput_mode_isSet = true;
}

bool OAICreateTableRequest_capacitySpecification::is_throughput_mode_Set() const{
    return m_throughput_mode_isSet;
}

bool OAICreateTableRequest_capacitySpecification::is_throughput_mode_Valid() const{
    return m_throughput_mode_isValid;
}

qint32 OAICreateTableRequest_capacitySpecification::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAICreateTableRequest_capacitySpecification::setReadCapacityUnits(const qint32 &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAICreateTableRequest_capacitySpecification::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAICreateTableRequest_capacitySpecification::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

qint32 OAICreateTableRequest_capacitySpecification::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAICreateTableRequest_capacitySpecification::setWriteCapacityUnits(const qint32 &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAICreateTableRequest_capacitySpecification::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAICreateTableRequest_capacitySpecification::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

bool OAICreateTableRequest_capacitySpecification::isSet() const {
...
bool OAICreateTableRequest_capacitySpecification::isValid() const {
