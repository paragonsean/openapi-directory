...
OAIUpdateTableResponse::OAIUpdateTableResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTableResponse::OAIUpdateTableResponse() {
    this->initializeModel();
}

OAIUpdateTableResponse::~OAIUpdateTableResponse() {}

void OAIUpdateTableResponse::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIUpdateTableResponse::fromJson(QString jsonString) {
...
void OAIUpdateTableResponse::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("resourceArn")]);
    m_resource_arn_isSet = !json[QString("resourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIUpdateTableResponse::asJson() const {
...
QJsonObject OAIUpdateTableResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateTableResponse::getResourceArn() const {
    return m_resource_arn;
}
void OAIUpdateTableResponse::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIUpdateTableResponse::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIUpdateTableResponse::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIUpdateTableResponse::isSet() const {
...
bool OAIUpdateTableResponse::isValid() const {
