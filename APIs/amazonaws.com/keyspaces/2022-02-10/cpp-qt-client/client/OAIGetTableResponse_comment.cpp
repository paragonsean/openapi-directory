...
OAIGetTableResponse_comment::OAIGetTableResponse_comment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTableResponse_comment::OAIGetTableResponse_comment() {
    this->initializeModel();
}

OAIGetTableResponse_comment::~OAIGetTableResponse_comment() {}

void OAIGetTableResponse_comment::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIGetTableResponse_comment::fromJson(QString jsonString) {
...
void OAIGetTableResponse_comment::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("message")]);
    m_message_isSet = !json[QString("message")].isNull() && m_message_isValid;
}

QString OAIGetTableResponse_comment::asJson() const {
...
QJsonObject OAIGetTableResponse_comment::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIGetTableResponse_comment::getMessage() const {
    return m_message;
}
void OAIGetTableResponse_comment::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIGetTableResponse_comment::is_message_Set() const{
    return m_message_isSet;
}

bool OAIGetTableResponse_comment::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIGetTableResponse_comment::isSet() const {
...
bool OAIGetTableResponse_comment::isValid() const {
