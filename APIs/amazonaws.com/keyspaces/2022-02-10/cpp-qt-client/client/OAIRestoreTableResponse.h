...
/*
 * OAIRestoreTableResponse.h
 *
 * 
 */

#ifndef OAIRestoreTableResponse_H
#define OAIRestoreTableResponse_H
...
class OAIRestoreTableResponse : public OAIObject {
public:
    OAIRestoreTableResponse();
    OAIRestoreTableResponse(QString json);
    ~OAIRestoreTableResponse() override;
    ...
    QString getRestoredTableArn() const;
    void setRestoredTableArn(const QString &restored_table_arn);
    bool is_restored_table_arn_Set() const;
    bool is_restored_table_arn_Valid() const;
...
private:
    ...
    QString m_restored_table_arn;
    bool m_restored_table_arn_isSet;
    bool m_restored_table_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRestoreTableResponse)

#endif // OAIRestoreTableResponse_H
