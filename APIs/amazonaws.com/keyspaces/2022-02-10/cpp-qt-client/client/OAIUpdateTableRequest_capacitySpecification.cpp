...
OAIUpdateTableRequest_capacitySpecification::OAIUpdateTableRequest_capacitySpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTableRequest_capacitySpecification::OAIUpdateTableRequest_capacitySpecification() {
    this->initializeModel();
}

OAIUpdateTableRequest_capacitySpecification::~OAIUpdateTableRequest_capacitySpecification() {}

void OAIUpdateTableRequest_capacitySpecification::initializeModel() {
...
void OAIUpdateTableRequest_capacitySpecification::fromJson(QString jsonString) {
...
void OAIUpdateTableRequest_capacitySpecification::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTableRequest_capacitySpecification::asJson() const {
...
QJsonObject OAIUpdateTableRequest_capacitySpecification::asJsonObject() const {
    QJsonObject obj;
...
OAIThroughputMode OAIUpdateTableRequest_capacitySpecification::getThroughputMode() const {
    return m_throughput_mode;
}
void OAIUpdateTableRequest_capacitySpecification::setThroughputMode(const OAIThroughputMode &throughput_mode) {
    m_throughput_mode = throughput_mode;
    m_throughput_mode_isSet = true;
}

bool OAIUpdateTableRequest_capacitySpecification::is_throughput_mode_Set() const{
    return m_throughput_mode_isSet;
}

bool OAIUpdateTableRequest_capacitySpecification::is_throughput_mode_Valid() const{
    return m_throughput_mode_isValid;
}

qint32 OAIUpdateTableRequest_capacitySpecification::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIUpdateTableRequest_capacitySpecification::setReadCapacityUnits(const qint32 &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIUpdateTableRequest_capacitySpecification::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIUpdateTableRequest_capacitySpecification::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

qint32 OAIUpdateTableRequest_capacitySpecification::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIUpdateTableRequest_capacitySpecification::setWriteCapacityUnits(const qint32 &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIUpdateTableRequest_capacitySpecification::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIUpdateTableRequest_capacitySpecification::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

bool OAIUpdateTableRequest_capacitySpecification::isSet() const {
...
bool OAIUpdateTableRequest_capacitySpecification::isValid() const {
