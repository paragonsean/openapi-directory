...
OAIUpdateTableRequest_pointInTimeRecovery::OAIUpdateTableRequest_pointInTimeRecovery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTableRequest_pointInTimeRecovery::OAIUpdateTableRequest_pointInTimeRecovery() {
    this->initializeModel();
}

OAIUpdateTableRequest_pointInTimeRecovery::~OAIUpdateTableRequest_pointInTimeRecovery() {}

void OAIUpdateTableRequest_pointInTimeRecovery::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIUpdateTableRequest_pointInTimeRecovery::fromJson(QString jsonString) {
...
void OAIUpdateTableRequest_pointInTimeRecovery::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIUpdateTableRequest_pointInTimeRecovery::asJson() const {
...
QJsonObject OAIUpdateTableRequest_pointInTimeRecovery::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIPointInTimeRecoveryStatus OAIUpdateTableRequest_pointInTimeRecovery::getStatus() const {
    return m_status;
}
void OAIUpdateTableRequest_pointInTimeRecovery::setStatus(const OAIPointInTimeRecoveryStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateTableRequest_pointInTimeRecovery::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateTableRequest_pointInTimeRecovery::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIUpdateTableRequest_pointInTimeRecovery::isSet() const {
...
bool OAIUpdateTableRequest_pointInTimeRecovery::isValid() const {
