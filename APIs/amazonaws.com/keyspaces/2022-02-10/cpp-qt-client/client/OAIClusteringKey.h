...
#ifndef OAIClusteringKey_H
#define OAIClusteringKey_H
...
class OAIClusteringKey : public OAIObject {
public:
    OAIClusteringKey();
    OAIClusteringKey(QString json);
    ~OAIClusteringKey() override;
    ...
    OAISortOrder getOrderBy() const;
    void setOrderBy(const OAISortOrder &order_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusteringKey)

#endif // OAIClusteringKey_H
