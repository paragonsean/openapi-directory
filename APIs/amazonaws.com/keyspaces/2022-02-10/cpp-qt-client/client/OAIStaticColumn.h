...
#ifndef OAIStaticColumn_H
#define OAIStaticColumn_H
...
class OAIStaticColumn : public OAIObject {
public:
    OAIStaticColumn();
    OAIStaticColumn(QString json);
    ~OAIStaticColumn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStaticColumn)

#endif // OAIStaticColumn_H
