...
OAIRestoreTableRequest_encryptionSpecificationOverride::OAIRestoreTableRequest_encryptionSpecificationOverride(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreTableRequest_encryptionSpecificationOverride::OAIRestoreTableRequest_encryptionSpecificationOverride() {
    this->initializeModel();
}

OAIRestoreTableRequest_encryptionSpecificationOverride::~OAIRestoreTableRequest_encryptionSpecificationOverride() {}

void OAIRestoreTableRequest_encryptionSpecificationOverride::initializeModel() {
...
void OAIRestoreTableRequest_encryptionSpecificationOverride::fromJson(QString jsonString) {
...
void OAIRestoreTableRequest_encryptionSpecificationOverride::fromJsonObject(QJsonObject json) {
...
QString OAIRestoreTableRequest_encryptionSpecificationOverride::asJson() const {
...
QJsonObject OAIRestoreTableRequest_encryptionSpecificationOverride::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIEncryptionType OAIRestoreTableRequest_encryptionSpecificationOverride::getType() const {
    return m_type;
}
void OAIRestoreTableRequest_encryptionSpecificationOverride::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIRestoreTableRequest_encryptionSpecificationOverride::is_type_Set() const{
    return m_type_isSet;
}

bool OAIRestoreTableRequest_encryptionSpecificationOverride::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIRestoreTableRequest_encryptionSpecificationOverride::getKmsKeyIdentifier() const {
    return m_kms_key_identifier;
}
void OAIRestoreTableRequest_encryptionSpecificationOverride::setKmsKeyIdentifier(const QString &kms_key_identifier) {
    m_kms_key_identifier = kms_key_identifier;
    m_kms_key_identifier_isSet = true;
}

bool OAIRestoreTableRequest_encryptionSpecificationOverride::is_kms_key_identifier_Set() const{
    return m_kms_key_identifier_isSet;
}

bool OAIRestoreTableRequest_encryptionSpecificationOverride::is_kms_key_identifier_Valid() const{
    return m_kms_key_identifier_isValid;
}

bool OAIRestoreTableRequest_encryptionSpecificationOverride::isSet() const {
...
bool OAIRestoreTableRequest_encryptionSpecificationOverride::isValid() const {
