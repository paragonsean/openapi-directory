...
OAICreateTableRequest_ttl::OAICreateTableRequest_ttl(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTableRequest_ttl::OAICreateTableRequest_ttl() {
    this->initializeModel();
}

OAICreateTableRequest_ttl::~OAICreateTableRequest_ttl() {}

void OAICreateTableRequest_ttl::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAICreateTableRequest_ttl::fromJson(QString jsonString) {
...
void OAICreateTableRequest_ttl::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAICreateTableRequest_ttl::asJson() const {
...
QJsonObject OAICreateTableRequest_ttl::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAITimeToLiveStatus OAICreateTableRequest_ttl::getStatus() const {
    return m_status;
}
void OAICreateTableRequest_ttl::setStatus(const OAITimeToLiveStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateTableRequest_ttl::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateTableRequest_ttl::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICreateTableRequest_ttl::isSet() const {
...
bool OAICreateTableRequest_ttl::isValid() const {
