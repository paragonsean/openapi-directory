...
/*
 * OAIGetTableResponse_pointInTimeRecovery.h
 *
 * 
 */

#ifndef OAIGetTableResponse_pointInTimeRecovery_H
#define OAIGetTableResponse_pointInTimeRecovery_H
...
class OAIGetTableResponse_pointInTimeRecovery : public OAIObject {
public:
    OAIGetTableResponse_pointInTimeRecovery();
    OAIGetTableResponse_pointInTimeRecovery(QString json);
    ~OAIGetTableResponse_pointInTimeRecovery() override;
    ...
    OAIPointInTimeRecoveryStatus getStatus() const;
    void setStatus(const OAIPointInTimeRecoveryStatus &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    QDateTime getEarliestRestorableTimestamp() const;
    void setEarliestRestorableTimestamp(const QDateTime &earliest_restorable_timestamp);
    bool is_earliest_restorable_timestamp_Set() const;
    bool is_earliest_restorable_timestamp_Valid() const;
...
private:
    ...
    OAIPointInTimeRecoveryStatus m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    QDateTime m_earliest_restorable_timestamp;
    bool m_earliest_restorable_timestamp_isSet;
    bool m_earliest_restorable_timestamp_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetTableResponse_pointInTimeRecovery)

#endif // OAIGetTableResponse_pointInTimeRecovery_H
