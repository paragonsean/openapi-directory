...
/*
 * OAICreateKeyspaceResponse.h
 *
 * 
 */

#ifndef OAICreateKeyspaceResponse_H
#define OAICreateKeyspaceResponse_H
...
class OAICreateKeyspaceResponse : public OAIObject {
public:
    OAICreateKeyspaceResponse();
    OAICreateKeyspaceResponse(QString json);
    ~OAICreateKeyspaceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateKeyspaceResponse)

#endif // OAICreateKeyspaceResponse_H
