...
/*
 * OAIGetTableResponse_comment.h
 *
 * 
 */

#ifndef OAIGetTableResponse_comment_H
#define OAIGetTableResponse_comment_H
...
class OAIGetTableResponse_comment : public OAIObject {
public:
    OAIGetTableResponse_comment();
    OAIGetTableResponse_comment(QString json);
    ~OAIGetTableResponse_comment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableResponse_comment)

#endif // OAIGetTableResponse_comment_H
