...
OAIUpdateTableRequest_ttl::OAIUpdateTableRequest_ttl(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTableRequest_ttl::OAIUpdateTableRequest_ttl() {
    this->initializeModel();
}

OAIUpdateTableRequest_ttl::~OAIUpdateTableRequest_ttl() {}

void OAIUpdateTableRequest_ttl::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIUpdateTableRequest_ttl::fromJson(QString jsonString) {
...
void OAIUpdateTableRequest_ttl::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIUpdateTableRequest_ttl::asJson() const {
...
QJsonObject OAIUpdateTableRequest_ttl::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAITimeToLiveStatus OAIUpdateTableRequest_ttl::getStatus() const {
    return m_status;
}
void OAIUpdateTableRequest_ttl::setStatus(const OAITimeToLiveStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateTableRequest_ttl::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateTableRequest_ttl::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIUpdateTableRequest_ttl::isSet() const {
...
bool OAIUpdateTableRequest_ttl::isValid() const {
