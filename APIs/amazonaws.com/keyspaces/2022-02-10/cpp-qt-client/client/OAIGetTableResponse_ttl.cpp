...
OAIGetTableResponse_ttl::OAIGetTableResponse_ttl(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTableResponse_ttl::OAIGetTableResponse_ttl() {
    this->initializeModel();
}

OAIGetTableResponse_ttl::~OAIGetTableResponse_ttl() {}

void OAIGetTableResponse_ttl::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIGetTableResponse_ttl::fromJson(QString jsonString) {
...
void OAIGetTableResponse_ttl::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIGetTableResponse_ttl::asJson() const {
...
QJsonObject OAIGetTableResponse_ttl::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAITimeToLiveStatus OAIGetTableResponse_ttl::getStatus() const {
    return m_status;
}
void OAIGetTableResponse_ttl::setStatus(const OAITimeToLiveStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTableResponse_ttl::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTableResponse_ttl::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetTableResponse_ttl::isSet() const {
...
bool OAIGetTableResponse_ttl::isValid() const {
