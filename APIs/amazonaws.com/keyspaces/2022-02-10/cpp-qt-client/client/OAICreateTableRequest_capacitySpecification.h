...
/*
 * OAICreateTableRequest_capacitySpecification.h
 *
 * 
 */

#ifndef OAICreateTableRequest_capacitySpecification_H
#define OAICreateTableRequest_capacitySpecification_H
...
class OAICreateTableRequest_capacitySpecification : public OAIObject {
public:
    OAICreateTableRequest_capacitySpecification();
    OAICreateTableRequest_capacitySpecification(QString json);
    ~OAICreateTableRequest_capacitySpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_capacitySpecification)

#endif // OAICreateTableRequest_capacitySpecification_H
