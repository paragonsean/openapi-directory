...
/*
 * OAIDeleteKeyspaceRequest.h
 *
 * 
 */

#ifndef OAIDeleteKeyspaceRequest_H
#define OAIDeleteKeyspaceRequest_H
...
class OAIDeleteKeyspaceRequest : public OAIObject {
public:
    OAIDeleteKeyspaceRequest();
    OAIDeleteKeyspaceRequest(QString json);
    ~OAIDeleteKeyspaceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteKeyspaceRequest)

#endif // OAIDeleteKeyspaceRequest_H
