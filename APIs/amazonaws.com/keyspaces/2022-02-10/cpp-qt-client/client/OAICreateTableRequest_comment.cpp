...
OAICreateTableRequest_comment::OAICreateTableRequest_comment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTableRequest_comment::OAICreateTableRequest_comment() {
    this->initializeModel();
}

OAICreateTableRequest_comment::~OAICreateTableRequest_comment() {}

void OAICreateTableRequest_comment::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAICreateTableRequest_comment::fromJson(QString jsonString) {
...
void OAICreateTableRequest_comment::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("message")]);
    m_message_isSet = !json[QString("message")].isNull() && m_message_isValid;
}

QString OAICreateTableRequest_comment::asJson() const {
...
QJsonObject OAICreateTableRequest_comment::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAICreateTableRequest_comment::getMessage() const {
    return m_message;
}
void OAICreateTableRequest_comment::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAICreateTableRequest_comment::is_message_Set() const{
    return m_message_isSet;
}

bool OAICreateTableRequest_comment::is_message_Valid() const{
    return m_message_isValid;
}

bool OAICreateTableRequest_comment::isSet() const {
...
bool OAICreateTableRequest_comment::isValid() const {
