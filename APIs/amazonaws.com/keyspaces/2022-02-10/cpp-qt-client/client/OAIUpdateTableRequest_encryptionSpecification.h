...
/*
 * OAIUpdateTableRequest_encryptionSpecification.h
 *
 * 
 */

#ifndef OAIUpdateTableRequest_encryptionSpecification_H
#define OAIUpdateTableRequest_encryptionSpecification_H
...
class OAIUpdateTableRequest_encryptionSpecification : public OAIObject {
public:
    OAIUpdateTableRequest_encryptionSpecification();
    OAIUpdateTableRequest_encryptionSpecification(QString json);
    ~OAIUpdateTableRequest_encryptionSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableRequest_encryptionSpecification)

#endif // OAIUpdateTableRequest_encryptionSpecification_H
