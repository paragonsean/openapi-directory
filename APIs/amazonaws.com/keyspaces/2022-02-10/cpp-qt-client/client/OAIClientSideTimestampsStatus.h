...
/*
 * OAIClientSideTimestampsStatus.h
 *
 * 
 */

#ifndef OAIClientSideTimestampsStatus_H
#define OAIClientSideTimestampsStatus_H
...
class OAIClientSideTimestampsStatus : public OAIEnum {
public:
    OAIClientSideTimestampsStatus();
    OAIClientSideTimestampsStatus(QString json);
    ~OAIClientSideTimestampsStatus() override;
    ...
    enum class eOAIClientSideTimestampsStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLED
    };
    OAIClientSideTimestampsStatus::eOAIClientSideTimestampsStatus getValue() const;
    void setValue(const OAIClientSideTimestampsStatus::eOAIClientSideTimestampsStatus& value);
...
private:
    ...
    eOAIClientSideTimestampsStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientSideTimestampsStatus)

#endif // OAIClientSideTimestampsStatus_H
