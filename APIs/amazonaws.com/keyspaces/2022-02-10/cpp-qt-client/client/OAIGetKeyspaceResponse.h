...
/*
 * OAIGetKeyspaceResponse.h
 *
 * 
 */

#ifndef OAIGetKeyspaceResponse_H
#define OAIGetKeyspaceResponse_H
...
class OAIGetKeyspaceResponse : public OAIObject {
public:
    OAIGetKeyspaceResponse();
    OAIGetKeyspaceResponse(QString json);
    ~OAIGetKeyspaceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetKeyspaceResponse)

#endif // OAIGetKeyspaceResponse_H
