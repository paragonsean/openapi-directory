...
/*
 * OAIGetTableResponse_encryptionSpecification.h
 *
 * 
 */

#ifndef OAIGetTableResponse_encryptionSpecification_H
#define OAIGetTableResponse_encryptionSpecification_H
...
class OAIGetTableResponse_encryptionSpecification : public OAIObject {
public:
    OAIGetTableResponse_encryptionSpecification();
    OAIGetTableResponse_encryptionSpecification(QString json);
    ~OAIGetTableResponse_encryptionSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableResponse_encryptionSpecification)

#endif // OAIGetTableResponse_encryptionSpecification_H
