...
/*
 * OAIUpdateTableRequest_ttl.h
 *
 * 
 */

#ifndef OAIUpdateTableRequest_ttl_H
#define OAIUpdateTableRequest_ttl_H
...
class OAIUpdateTableRequest_ttl : public OAIObject {
public:
    OAIUpdateTableRequest_ttl();
    OAIUpdateTableRequest_ttl(QString json);
    ~OAIUpdateTableRequest_ttl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableRequest_ttl)

#endif // OAIUpdateTableRequest_ttl_H
