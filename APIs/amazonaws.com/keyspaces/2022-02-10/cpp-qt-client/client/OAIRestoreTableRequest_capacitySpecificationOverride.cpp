...
OAIRestoreTableRequest_capacitySpecificationOverride::OAIRestoreTableRequest_capacitySpecificationOverride(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreTableRequest_capacitySpecificationOverride::OAIRestoreTableRequest_capacitySpecificationOverride() {
    this->initializeModel();
}

OAIRestoreTableRequest_capacitySpecificationOverride::~OAIRestoreTableRequest_capacitySpecificationOverride() {}

void OAIRestoreTableRequest_capacitySpecificationOverride::initializeModel() {
...
void OAIRestoreTableRequest_capacitySpecificationOverride::fromJson(QString jsonString) {
...
void OAIRestoreTableRequest_capacitySpecificationOverride::fromJsonObject(QJsonObject json) {
...
QString OAIRestoreTableRequest_capacitySpecificationOverride::asJson() const {
...
QJsonObject OAIRestoreTableRequest_capacitySpecificationOverride::asJsonObject() const {
    QJsonObject obj;
...
OAIThroughputMode OAIRestoreTableRequest_capacitySpecificationOverride::getThroughputMode() const {
    return m_throughput_mode;
}
void OAIRestoreTableRequest_capacitySpecificationOverride::setThroughputMode(const OAIThroughputMode &throughput_mode) {
    m_throughput_mode = throughput_mode;
    m_throughput_mode_isSet = true;
}

bool OAIRestoreTableRequest_capacitySpecificationOverride::is_throughput_mode_Set() const{
    return m_throughput_mode_isSet;
}

bool OAIRestoreTableRequest_capacitySpecificationOverride::is_throughput_mode_Valid() const{
    return m_throughput_mode_isValid;
}

qint32 OAIRestoreTableRequest_capacitySpecificationOverride::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIRestoreTableRequest_capacitySpecificationOverride::setReadCapacityUnits(const qint32 &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIRestoreTableRequest_capacitySpecificationOverride::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIRestoreTableRequest_capacitySpecificationOverride::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

qint32 OAIRestoreTableRequest_capacitySpecificationOverride::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIRestoreTableRequest_capacitySpecificationOverride::setWriteCapacityUnits(const qint32 &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIRestoreTableRequest_capacitySpecificationOverride::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIRestoreTableRequest_capacitySpecificationOverride::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

bool OAIRestoreTableRequest_capacitySpecificationOverride::isSet() const {
...
bool OAIRestoreTableRequest_capacitySpecificationOverride::isValid() const {
