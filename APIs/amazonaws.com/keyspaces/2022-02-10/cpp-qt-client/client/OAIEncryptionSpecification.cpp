...
#include "OAIEncryptionSpecification.h"
...
OAIEncryptionSpecification::OAIEncryptionSpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEncryptionSpecification::OAIEncryptionSpecification() {
    this->initializeModel();
}

OAIEncryptionSpecification::~OAIEncryptionSpecification() {}

void OAIEncryptionSpecification::initializeModel() {
...
void OAIEncryptionSpecification::fromJson(QString jsonString) {
...
void OAIEncryptionSpecification::fromJsonObject(QJsonObject json) {
...
QString OAIEncryptionSpecification::asJson() const {
...
QJsonObject OAIEncryptionSpecification::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIEncryptionType OAIEncryptionSpecification::getType() const {
    return m_type;
}
void OAIEncryptionSpecification::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEncryptionSpecification::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEncryptionSpecification::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIEncryptionSpecification::getKmsKeyIdentifier() const {
    return m_kms_key_identifier;
}
void OAIEncryptionSpecification::setKmsKeyIdentifier(const QString &kms_key_identifier) {
    m_kms_key_identifier = kms_key_identifier;
    m_kms_key_identifier_isSet = true;
}

bool OAIEncryptionSpecification::is_kms_key_identifier_Set() const{
    return m_kms_key_identifier_isSet;
}

bool OAIEncryptionSpecification::is_kms_key_identifier_Valid() const{
    return m_kms_key_identifier_isValid;
}

bool OAIEncryptionSpecification::isSet() const {
...
bool OAIEncryptionSpecification::isValid() const {
