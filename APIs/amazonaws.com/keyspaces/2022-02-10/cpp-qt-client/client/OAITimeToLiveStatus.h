...
/*
 * OAITimeToLiveStatus.h
 *
 * 
 */

#ifndef OAITimeToLiveStatus_H
#define OAITimeToLiveStatus_H
...
class OAITimeToLiveStatus : public OAIEnum {
public:
    OAITimeToLiveStatus();
    OAITimeToLiveStatus(QString json);
    ~OAITimeToLiveStatus() override;
    ...
    enum class eOAITimeToLiveStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLED
    };
    OAITimeToLiveStatus::eOAITimeToLiveStatus getValue() const;
    void setValue(const OAITimeToLiveStatus::eOAITimeToLiveStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeToLiveStatus)

#endif // OAITimeToLiveStatus_H
