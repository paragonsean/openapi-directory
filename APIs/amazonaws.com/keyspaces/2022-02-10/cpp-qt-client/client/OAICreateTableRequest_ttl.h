...
/*
 * OAICreateTableRequest_ttl.h
 *
 * 
 */

#ifndef OAICreateTableRequest_ttl_H
#define OAICreateTableRequest_ttl_H
...
class OAICreateTableRequest_ttl : public OAIObject {
public:
    OAICreateTableRequest_ttl();
    OAICreateTableRequest_ttl(QString json);
    ~OAICreateTableRequest_ttl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_ttl)

#endif // OAICreateTableRequest_ttl_H
