...
/*
 * OAIListKeyspacesRequest.h
 *
 * 
 */

#ifndef OAIListKeyspacesRequest_H
#define OAIListKeyspacesRequest_H
...
class OAIListKeyspacesRequest : public OAIObject {
public:
    OAIListKeyspacesRequest();
    OAIListKeyspacesRequest(QString json);
    ~OAIListKeyspacesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListKeyspacesRequest)

#endif // OAIListKeyspacesRequest_H
