...
QString OAIDeleteTableRequest::getKeyspaceName() const {
    return m_keyspace_name;
}
void OAIDeleteTableRequest::setKeyspaceName(const QString &keyspace_name) {
    m_keyspace_name = keyspace_name;
    m_keyspace_name_isSet = true;
}

bool OAIDeleteTableRequest::is_keyspace_name_Set() const{
    return m_keyspace_name_isSet;
}

bool OAIDeleteTableRequest::is_keyspace_name_Valid() const{
    return m_keyspace_name_isValid;
}

QString OAIDeleteTableRequest::getTableName() const {
    return m_table_name;
}
void OAIDeleteTableRequest::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIDeleteTableRequest::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIDeleteTableRequest::is_table_name_Valid() const{
