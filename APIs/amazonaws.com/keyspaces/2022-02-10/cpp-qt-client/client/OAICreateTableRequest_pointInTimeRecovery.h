...
/*
 * OAICreateTableRequest_pointInTimeRecovery.h
 *
 * 
 */

#ifndef OAICreateTableRequest_pointInTimeRecovery_H
#define OAICreateTableRequest_pointInTimeRecovery_H
...
class OAICreateTableRequest_pointInTimeRecovery : public OAIObject {
public:
    OAICreateTableRequest_pointInTimeRecovery();
    OAICreateTableRequest_pointInTimeRecovery(QString json);
    ~OAICreateTableRequest_pointInTimeRecovery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_pointInTimeRecovery)

#endif // OAICreateTableRequest_pointInTimeRecovery_H
