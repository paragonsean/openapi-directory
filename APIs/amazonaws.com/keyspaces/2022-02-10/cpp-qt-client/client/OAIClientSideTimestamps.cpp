...
#include "OAIClientSideTimestamps.h"
...
OAIClientSideTimestamps::OAIClientSideTimestamps(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClientSideTimestamps::OAIClientSideTimestamps() {
    this->initializeModel();
}

OAIClientSideTimestamps::~OAIClientSideTimestamps() {}

void OAIClientSideTimestamps::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIClientSideTimestamps::fromJson(QString jsonString) {
...
void OAIClientSideTimestamps::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIClientSideTimestamps::asJson() const {
...
QJsonObject OAIClientSideTimestamps::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIClientSideTimestampsStatus OAIClientSideTimestamps::getStatus() const {
    return m_status;
}
void OAIClientSideTimestamps::setStatus(const OAIClientSideTimestampsStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIClientSideTimestamps::is_status_Set() const{
    return m_status_isSet;
}

bool OAIClientSideTimestamps::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIClientSideTimestamps::isSet() const {
...
bool OAIClientSideTimestamps::isValid() const {
