...
OAICreateTableRequest_encryptionSpecification::OAICreateTableRequest_encryptionSpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTableRequest_encryptionSpecification::OAICreateTableRequest_encryptionSpecification() {
    this->initializeModel();
}

OAICreateTableRequest_encryptionSpecification::~OAICreateTableRequest_encryptionSpecification() {}

void OAICreateTableRequest_encryptionSpecification::initializeModel() {
...
void OAICreateTableRequest_encryptionSpecification::fromJson(QString jsonString) {
...
void OAICreateTableRequest_encryptionSpecification::fromJsonObject(QJsonObject json) {
...
QString OAICreateTableRequest_encryptionSpecification::asJson() const {
...
QJsonObject OAICreateTableRequest_encryptionSpecification::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIEncryptionType OAICreateTableRequest_encryptionSpecification::getType() const {
    return m_type;
}
void OAICreateTableRequest_encryptionSpecification::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateTableRequest_encryptionSpecification::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateTableRequest_encryptionSpecification::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICreateTableRequest_encryptionSpecification::getKmsKeyIdentifier() const {
    return m_kms_key_identifier;
}
void OAICreateTableRequest_encryptionSpecification::setKmsKeyIdentifier(const QString &kms_key_identifier) {
    m_kms_key_identifier = kms_key_identifier;
    m_kms_key_identifier_isSet = true;
}

bool OAICreateTableRequest_encryptionSpecification::is_kms_key_identifier_Set() const{
    return m_kms_key_identifier_isSet;
}

bool OAICreateTableRequest_encryptionSpecification::is_kms_key_identifier_Valid() const{
    return m_kms_key_identifier_isValid;
}

bool OAICreateTableRequest_encryptionSpecification::isSet() const {
...
bool OAICreateTableRequest_encryptionSpecification::isValid() const {
