...
/*
 * OAICreateTableRequest_clientSideTimestamps.h
 *
 * 
 */

#ifndef OAICreateTableRequest_clientSideTimestamps_H
#define OAICreateTableRequest_clientSideTimestamps_H
...
class OAICreateTableRequest_clientSideTimestamps : public OAIObject {
public:
    OAICreateTableRequest_clientSideTimestamps();
    OAICreateTableRequest_clientSideTimestamps(QString json);
    ~OAICreateTableRequest_clientSideTimestamps() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_clientSideTimestamps)

#endif // OAICreateTableRequest_clientSideTimestamps_H
