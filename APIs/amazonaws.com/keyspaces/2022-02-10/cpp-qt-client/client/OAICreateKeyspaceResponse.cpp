...
OAICreateKeyspaceResponse::OAICreateKeyspaceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateKeyspaceResponse::OAICreateKeyspaceResponse() {
    this->initializeModel();
}

OAICreateKeyspaceResponse::~OAICreateKeyspaceResponse() {}

void OAICreateKeyspaceResponse::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAICreateKeyspaceResponse::fromJson(QString jsonString) {
...
void OAICreateKeyspaceResponse::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("resourceArn")]);
    m_resource_arn_isSet = !json[QString("resourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAICreateKeyspaceResponse::asJson() const {
...
QJsonObject OAICreateKeyspaceResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateKeyspaceResponse::getResourceArn() const {
    return m_resource_arn;
}
void OAICreateKeyspaceResponse::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAICreateKeyspaceResponse::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAICreateKeyspaceResponse::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAICreateKeyspaceResponse::isSet() const {
...
bool OAICreateKeyspaceResponse::isValid() const {
