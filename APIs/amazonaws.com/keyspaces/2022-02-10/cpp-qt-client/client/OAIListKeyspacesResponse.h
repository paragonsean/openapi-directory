...
/*
 * OAIListKeyspacesResponse.h
 *
 * 
 */

#ifndef OAIListKeyspacesResponse_H
#define OAIListKeyspacesResponse_H
...
class OAIListKeyspacesResponse : public OAIObject {
public:
    OAIListKeyspacesResponse();
    OAIListKeyspacesResponse(QString json);
    ~OAIListKeyspacesResponse() override;
    ...
    QList getKeyspaces() const;
    void setKeyspaces(const QList &keyspaces);
    bool is_keyspaces_Set() const;
    bool is_keyspaces_Valid() const;
...
private:
    ...
    QList m_keyspaces;
    bool m_keyspaces_isSet;
    bool m_keyspaces_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListKeyspacesResponse)

#endif // OAIListKeyspacesResponse_H
