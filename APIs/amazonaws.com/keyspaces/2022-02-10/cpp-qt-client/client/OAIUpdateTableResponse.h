...
/*
 * OAIUpdateTableResponse.h
 *
 * 
 */

#ifndef OAIUpdateTableResponse_H
#define OAIUpdateTableResponse_H
...
class OAIUpdateTableResponse : public OAIObject {
public:
    OAIUpdateTableResponse();
    OAIUpdateTableResponse(QString json);
    ~OAIUpdateTableResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableResponse)

#endif // OAIUpdateTableResponse_H
