...
/*
 * OAIGetTableResponse_ttl.h
 *
 * 
 */

#ifndef OAIGetTableResponse_ttl_H
#define OAIGetTableResponse_ttl_H
...
class OAIGetTableResponse_ttl : public OAIObject {
public:
    OAIGetTableResponse_ttl();
    OAIGetTableResponse_ttl(QString json);
    ~OAIGetTableResponse_ttl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableResponse_ttl)

#endif // OAIGetTableResponse_ttl_H
