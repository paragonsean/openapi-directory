...
#ifndef OAICapacitySpecification_H
#define OAICapacitySpecification_H
...
class OAICapacitySpecification : public OAIObject {
public:
    OAICapacitySpecification();
    OAICapacitySpecification(QString json);
    ~OAICapacitySpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICapacitySpecification)

#endif // OAICapacitySpecification_H
