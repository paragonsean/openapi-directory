...
/*
 * OAIUpdateTableRequest_capacitySpecification.h
 *
 * 
 */

#ifndef OAIUpdateTableRequest_capacitySpecification_H
#define OAIUpdateTableRequest_capacitySpecification_H
...
class OAIUpdateTableRequest_capacitySpecification : public OAIObject {
public:
    OAIUpdateTableRequest_capacitySpecification();
    OAIUpdateTableRequest_capacitySpecification(QString json);
    ~OAIUpdateTableRequest_capacitySpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableRequest_capacitySpecification)

#endif // OAIUpdateTableRequest_capacitySpecification_H
