...
/*
 * OAIUpdateTableRequest_pointInTimeRecovery.h
 *
 * 
 */

#ifndef OAIUpdateTableRequest_pointInTimeRecovery_H
#define OAIUpdateTableRequest_pointInTimeRecovery_H
...
class OAIUpdateTableRequest_pointInTimeRecovery : public OAIObject {
public:
    OAIUpdateTableRequest_pointInTimeRecovery();
    OAIUpdateTableRequest_pointInTimeRecovery(QString json);
    ~OAIUpdateTableRequest_pointInTimeRecovery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableRequest_pointInTimeRecovery)

#endif // OAIUpdateTableRequest_pointInTimeRecovery_H
