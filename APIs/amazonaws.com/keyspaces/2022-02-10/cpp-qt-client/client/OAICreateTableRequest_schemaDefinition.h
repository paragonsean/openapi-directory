...
/*
 * OAICreateTableRequest_schemaDefinition.h
 *
 * 
 */

#ifndef OAICreateTableRequest_schemaDefinition_H
#define OAICreateTableRequest_schemaDefinition_H
...
class OAICreateTableRequest_schemaDefinition : public OAIObject {
public:
    OAICreateTableRequest_schemaDefinition();
    OAICreateTableRequest_schemaDefinition(QString json);
    ~OAICreateTableRequest_schemaDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_schemaDefinition)

#endif // OAICreateTableRequest_schemaDefinition_H
