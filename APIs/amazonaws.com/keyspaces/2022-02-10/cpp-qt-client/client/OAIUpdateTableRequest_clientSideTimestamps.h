...
/*
 * OAIUpdateTableRequest_clientSideTimestamps.h
 *
 * 
 */

#ifndef OAIUpdateTableRequest_clientSideTimestamps_H
#define OAIUpdateTableRequest_clientSideTimestamps_H
...
class OAIUpdateTableRequest_clientSideTimestamps : public OAIObject {
public:
    OAIUpdateTableRequest_clientSideTimestamps();
    OAIUpdateTableRequest_clientSideTimestamps(QString json);
    ~OAIUpdateTableRequest_clientSideTimestamps() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableRequest_clientSideTimestamps)

#endif // OAIUpdateTableRequest_clientSideTimestamps_H
