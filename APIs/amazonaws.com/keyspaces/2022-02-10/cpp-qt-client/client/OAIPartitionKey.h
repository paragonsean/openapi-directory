...
#ifndef OAIPartitionKey_H
#define OAIPartitionKey_H
...
class OAIPartitionKey : public OAIObject {
public:
    OAIPartitionKey();
    OAIPartitionKey(QString json);
    ~OAIPartitionKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionKey)

#endif // OAIPartitionKey_H
