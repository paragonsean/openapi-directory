...
/*
 * OAICreateKeyspaceRequest.h
 *
 * 
 */

#ifndef OAICreateKeyspaceRequest_H
#define OAICreateKeyspaceRequest_H
...
namespace OpenAPI {
class OAICreateKeyspaceRequest_replicationSpecification;

class OAICreateKeyspaceRequest : public OAIObject {
public:
    OAICreateKeyspaceRequest();
    OAICreateKeyspaceRequest(QString json);
    ~OAICreateKeyspaceRequest() override;
    ...
    OAICreateKeyspaceRequest_replicationSpecification getReplicationSpecification() const;
    void setReplicationSpecification(const OAICreateKeyspaceRequest_replicationSpecification &replication_specification);
    bool is_replication_specification_Set() const;
    bool is_replication_specification_Valid() const;
...
private:
    ...
    OAICreateKeyspaceRequest_replicationSpecification m_replication_specification;
    bool m_replication_specification_isSet;
    bool m_replication_specification_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateKeyspaceRequest)

#endif // OAICreateKeyspaceRequest_H
