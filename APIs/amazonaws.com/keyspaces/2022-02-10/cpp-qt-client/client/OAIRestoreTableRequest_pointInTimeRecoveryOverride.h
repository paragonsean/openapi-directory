...
/*
 * OAIRestoreTableRequest_pointInTimeRecoveryOverride.h
 *
 * 
 */

#ifndef OAIRestoreTableRequest_pointInTimeRecoveryOverride_H
#define OAIRestoreTableRequest_pointInTimeRecoveryOverride_H
...
class OAIRestoreTableRequest_pointInTimeRecoveryOverride : public OAIObject {
public:
    OAIRestoreTableRequest_pointInTimeRecoveryOverride();
    OAIRestoreTableRequest_pointInTimeRecoveryOverride(QString json);
    ~OAIRestoreTableRequest_pointInTimeRecoveryOverride() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreTableRequest_pointInTimeRecoveryOverride)

#endif // OAIRestoreTableRequest_pointInTimeRecoveryOverride_H
