...
OAIRestoreTableRequest_pointInTimeRecoveryOverride::OAIRestoreTableRequest_pointInTimeRecoveryOverride(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreTableRequest_pointInTimeRecoveryOverride::OAIRestoreTableRequest_pointInTimeRecoveryOverride() {
    this->initializeModel();
}

OAIRestoreTableRequest_pointInTimeRecoveryOverride::~OAIRestoreTableRequest_pointInTimeRecoveryOverride() {}

void OAIRestoreTableRequest_pointInTimeRecoveryOverride::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIRestoreTableRequest_pointInTimeRecoveryOverride::fromJson(QString jsonString) {
...
void OAIRestoreTableRequest_pointInTimeRecoveryOverride::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIRestoreTableRequest_pointInTimeRecoveryOverride::asJson() const {
...
QJsonObject OAIRestoreTableRequest_pointInTimeRecoveryOverride::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIPointInTimeRecoveryStatus OAIRestoreTableRequest_pointInTimeRecoveryOverride::getStatus() const {
    return m_status;
}
void OAIRestoreTableRequest_pointInTimeRecoveryOverride::setStatus(const OAIPointInTimeRecoveryStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRestoreTableRequest_pointInTimeRecoveryOverride::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRestoreTableRequest_pointInTimeRecoveryOverride::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRestoreTableRequest_pointInTimeRecoveryOverride::isSet() const {
...
bool OAIRestoreTableRequest_pointInTimeRecoveryOverride::isValid() const {
