...
/*
 * OAICreateTableRequest_encryptionSpecification.h
 *
 * 
 */

#ifndef OAICreateTableRequest_encryptionSpecification_H
#define OAICreateTableRequest_encryptionSpecification_H
...
class OAICreateTableRequest_encryptionSpecification : public OAIObject {
public:
    OAICreateTableRequest_encryptionSpecification();
    OAICreateTableRequest_encryptionSpecification(QString json);
    ~OAICreateTableRequest_encryptionSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_encryptionSpecification)

#endif // OAICreateTableRequest_encryptionSpecification_H
