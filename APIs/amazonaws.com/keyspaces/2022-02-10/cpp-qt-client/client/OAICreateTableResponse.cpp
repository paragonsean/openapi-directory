...
QString OAICreateTableResponse::getResourceArn() const {
    return m_resource_arn;
}
void OAICreateTableResponse::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAICreateTableResponse::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAICreateTableResponse::is_resource_arn_Valid() const{
