...
OAIDeleteKeyspaceRequest::OAIDeleteKeyspaceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteKeyspaceRequest::OAIDeleteKeyspaceRequest() {
    this->initializeModel();
}

OAIDeleteKeyspaceRequest::~OAIDeleteKeyspaceRequest() {}

void OAIDeleteKeyspaceRequest::initializeModel() {

    m_keyspace_name_isSet = false;
    m_keyspace_name_isValid = false;
}

void OAIDeleteKeyspaceRequest::fromJson(QString jsonString) {
...
void OAIDeleteKeyspaceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteKeyspaceRequest::asJson() const {
...
QJsonObject OAIDeleteKeyspaceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteKeyspaceRequest::getKeyspaceName() const {
    return m_keyspace_name;
}
void OAIDeleteKeyspaceRequest::setKeyspaceName(const QString &keyspace_name) {
    m_keyspace_name = keyspace_name;
    m_keyspace_name_isSet = true;
}

bool OAIDeleteKeyspaceRequest::is_keyspace_name_Set() const{
    return m_keyspace_name_isSet;
}

bool OAIDeleteKeyspaceRequest::is_keyspace_name_Valid() const{
    return m_keyspace_name_isValid;
}

bool OAIDeleteKeyspaceRequest::isSet() const {
...
bool OAIDeleteKeyspaceRequest::isValid() const {
