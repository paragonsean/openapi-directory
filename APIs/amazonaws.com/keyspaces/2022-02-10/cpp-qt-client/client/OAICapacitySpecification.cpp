...
#include "OAICapacitySpecification.h"
...
OAICapacitySpecification::OAICapacitySpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICapacitySpecification::OAICapacitySpecification() {
    this->initializeModel();
}

OAICapacitySpecification::~OAICapacitySpecification() {}

void OAICapacitySpecification::initializeModel() {
...
void OAICapacitySpecification::fromJson(QString jsonString) {
...
void OAICapacitySpecification::fromJsonObject(QJsonObject json) {
...
QString OAICapacitySpecification::asJson() const {
...
QJsonObject OAICapacitySpecification::asJsonObject() const {
    QJsonObject obj;
...
OAIThroughputMode OAICapacitySpecification::getThroughputMode() const {
    return m_throughput_mode;
}
void OAICapacitySpecification::setThroughputMode(const OAIThroughputMode &throughput_mode) {
    m_throughput_mode = throughput_mode;
    m_throughput_mode_isSet = true;
}

bool OAICapacitySpecification::is_throughput_mode_Set() const{
    return m_throughput_mode_isSet;
}

bool OAICapacitySpecification::is_throughput_mode_Valid() const{
    return m_throughput_mode_isValid;
}

qint32 OAICapacitySpecification::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAICapacitySpecification::setReadCapacityUnits(const qint32 &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAICapacitySpecification::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAICapacitySpecification::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

qint32 OAICapacitySpecification::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAICapacitySpecification::setWriteCapacityUnits(const qint32 &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAICapacitySpecification::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAICapacitySpecification::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

bool OAICapacitySpecification::isSet() const {
...
bool OAICapacitySpecification::isValid() const {
