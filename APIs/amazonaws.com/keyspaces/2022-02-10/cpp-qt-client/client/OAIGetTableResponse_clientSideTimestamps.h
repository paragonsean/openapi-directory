...
/*
 * OAIGetTableResponse_clientSideTimestamps.h
 *
 * 
 */

#ifndef OAIGetTableResponse_clientSideTimestamps_H
#define OAIGetTableResponse_clientSideTimestamps_H
...
class OAIGetTableResponse_clientSideTimestamps : public OAIObject {
public:
    OAIGetTableResponse_clientSideTimestamps();
    OAIGetTableResponse_clientSideTimestamps(QString json);
    ~OAIGetTableResponse_clientSideTimestamps() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableResponse_clientSideTimestamps)

#endif // OAIGetTableResponse_clientSideTimestamps_H
