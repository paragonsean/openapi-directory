...
#ifndef OAITableSummary_H
#define OAITableSummary_H
...
class OAITableSummary : public OAIObject {
public:
    OAITableSummary();
    OAITableSummary(QString json);
    ~OAITableSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableSummary)

#endif // OAITableSummary_H
