...
/*
 * OAIKeyspaceSummary.h
 *
 * Represents the properties of a keyspace.
 */

#ifndef OAIKeyspaceSummary_H
#define OAIKeyspaceSummary_H
...
class OAIKeyspaceSummary : public OAIObject {
public:
    OAIKeyspaceSummary();
    OAIKeyspaceSummary(QString json);
    ~OAIKeyspaceSummary() override;
    ...
    QList getReplicationRegions() const;
    void setReplicationRegions(const QList &replication_regions);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyspaceSummary)

#endif // OAIKeyspaceSummary_H
