...
/*
 * OAIGetTableResponse_capacitySpecification.h
 *
 * 
 */

#ifndef OAIGetTableResponse_capacitySpecification_H
#define OAIGetTableResponse_capacitySpecification_H
...
class OAIGetTableResponse_capacitySpecification : public OAIObject {
public:
    OAIGetTableResponse_capacitySpecification();
    OAIGetTableResponse_capacitySpecification(QString json);
    ~OAIGetTableResponse_capacitySpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableResponse_capacitySpecification)

#endif // OAIGetTableResponse_capacitySpecification_H
