...
#ifndef OAIReplicationSpecification_H
#define OAIReplicationSpecification_H
...
class OAIReplicationSpecification : public OAIObject {
public:
    OAIReplicationSpecification();
    OAIReplicationSpecification(QString json);
    ~OAIReplicationSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicationSpecification)

#endif // OAIReplicationSpecification_H
