...
/*
 * OAICapacitySpecificationSummary.h
 *
...
#ifndef OAICapacitySpecificationSummary_H
#define OAICapacitySpecificationSummary_H
...
class OAICapacitySpecificationSummary : public OAIObject {
public:
    OAICapacitySpecificationSummary();
    OAICapacitySpecificationSummary(QString json);
    ~OAICapacitySpecificationSummary() override;
    ...
    QDateTime getLastUpdateToPayPerRequestTimestamp() const;
    void setLastUpdateToPayPerRequestTimestamp(const QDateTime &last_update_to_pay_per_request_timestamp);
    bool is_last_update_to_pay_per_request_timestamp_Set() const;
    bool is_last_update_to_pay_per_request_timestamp_Valid() const;
...
private:
    ...
    QDateTime m_last_update_to_pay_per_request_timestamp;
    bool m_last_update_to_pay_per_request_timestamp_isSet;
    bool m_last_update_to_pay_per_request_timestamp_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICapacitySpecificationSummary)

#endif // OAICapacitySpecificationSummary_H
