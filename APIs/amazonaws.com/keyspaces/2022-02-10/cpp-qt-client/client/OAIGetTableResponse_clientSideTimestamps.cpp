...
OAIGetTableResponse_clientSideTimestamps::OAIGetTableResponse_clientSideTimestamps(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTableResponse_clientSideTimestamps::OAIGetTableResponse_clientSideTimestamps() {
    this->initializeModel();
}

OAIGetTableResponse_clientSideTimestamps::~OAIGetTableResponse_clientSideTimestamps() {}

void OAIGetTableResponse_clientSideTimestamps::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIGetTableResponse_clientSideTimestamps::fromJson(QString jsonString) {
...
void OAIGetTableResponse_clientSideTimestamps::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIGetTableResponse_clientSideTimestamps::asJson() const {
...
QJsonObject OAIGetTableResponse_clientSideTimestamps::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIClientSideTimestampsStatus OAIGetTableResponse_clientSideTimestamps::getStatus() const {
    return m_status;
}
void OAIGetTableResponse_clientSideTimestamps::setStatus(const OAIClientSideTimestampsStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTableResponse_clientSideTimestamps::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTableResponse_clientSideTimestamps::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetTableResponse_clientSideTimestamps::isSet() const {
...
bool OAIGetTableResponse_clientSideTimestamps::isValid() const {
