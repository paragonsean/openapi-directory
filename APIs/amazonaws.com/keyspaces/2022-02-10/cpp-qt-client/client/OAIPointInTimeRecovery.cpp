...
#include "OAIPointInTimeRecovery.h"
...
OAIPointInTimeRecovery::OAIPointInTimeRecovery(QString json) {
...
void OAIPointInTimeRecovery::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIPointInTimeRecovery::fromJson(QString jsonString) {
...
void OAIPointInTimeRecovery::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIPointInTimeRecovery::asJson() const {
...
QJsonObject OAIPointInTimeRecovery::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIPointInTimeRecoveryStatus OAIPointInTimeRecovery::getStatus() const {
    return m_status;
}
void OAIPointInTimeRecovery::setStatus(const OAIPointInTimeRecoveryStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPointInTimeRecovery::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPointInTimeRecovery::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPointInTimeRecovery::isSet() const {
...
bool OAIPointInTimeRecovery::isValid() const {
