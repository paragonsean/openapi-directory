...
/*
 * OAICreateTableRequest_comment.h
 *
 * 
 */

#ifndef OAICreateTableRequest_comment_H
#define OAICreateTableRequest_comment_H
...
class OAICreateTableRequest_comment : public OAIObject {
public:
    OAICreateTableRequest_comment();
    OAICreateTableRequest_comment(QString json);
    ~OAICreateTableRequest_comment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableRequest_comment)

#endif // OAICreateTableRequest_comment_H
