...
#ifndef OAIPointInTimeRecovery_H
#define OAIPointInTimeRecovery_H
...
class OAIPointInTimeRecovery : public OAIObject {
public:
    OAIPointInTimeRecovery();
    OAIPointInTimeRecovery(QString json);
    ~OAIPointInTimeRecovery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPointInTimeRecovery)

#endif // OAIPointInTimeRecovery_H
