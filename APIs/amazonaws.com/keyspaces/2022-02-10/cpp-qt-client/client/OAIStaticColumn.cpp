...
OAIStaticColumn::OAIStaticColumn(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStaticColumn::OAIStaticColumn() {
    this->initializeModel();
}

OAIStaticColumn::~OAIStaticColumn() {}

void OAIStaticColumn::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIStaticColumn::fromJson(QString jsonString) {
...
void OAIStaticColumn::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIStaticColumn::asJson() const {
...
QJsonObject OAIStaticColumn::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIStaticColumn::getName() const {
    return m_name;
}
void OAIStaticColumn::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStaticColumn::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStaticColumn::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIStaticColumn::isSet() const {
...
bool OAIStaticColumn::isValid() const {
