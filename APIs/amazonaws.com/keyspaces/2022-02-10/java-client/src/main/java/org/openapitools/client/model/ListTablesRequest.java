...
public class ListTablesRequest {
  ...
  public ListTablesRequest nextToken(String nextToken) {
  ...
  public ListTablesRequest maxResults(Integer maxResults) {
  ...
  public ListTablesRequest keyspaceName(String keyspaceName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listTablesRequest.nextToken) &&
        Objects.equals(this.maxResults, listTablesRequest.maxResults) &&
        Objects.equals(this.keyspaceName, listTablesRequest.keyspaceName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, maxResults, keyspaceName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTablesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTablesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTablesRequest is not found in the empty JSON string", ListTablesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTablesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTablesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListTablesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTablesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTablesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTablesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTablesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTablesRequest>() {
           @Override
           public void write(JsonWriter out, ListTablesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTablesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTablesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTablesRequest
   * @throws IOException if the JSON string is invalid with respect to ListTablesRequest
   */
  public static ListTablesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTablesRequest.class);
  }

  /**
   * Convert an instance of ListTablesRequest to an JSON string
   *
   * @return JSON string
   */
