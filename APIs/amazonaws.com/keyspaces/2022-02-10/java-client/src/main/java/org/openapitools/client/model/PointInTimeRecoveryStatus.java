...
/**
 * Gets or Sets PointInTimeRecoveryStatus
 */
@JsonAdapter(PointInTimeRecoveryStatus.Adapter.class)
public enum PointInTimeRecoveryStatus {
  ...
  PointInTimeRecoveryStatus(String value) {
    this.value = value;
  }
  ...
  public static PointInTimeRecoveryStatus fromValue(String value) {
    for (PointInTimeRecoveryStatus b : PointInTimeRecoveryStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PointInTimeRecoveryStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PointInTimeRecoveryStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PointInTimeRecoveryStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PointInTimeRecoveryStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PointInTimeRecoveryStatus.fromValue(value);
  }
}
