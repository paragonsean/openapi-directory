...
/**
 * Gets or Sets ClientSideTimestampsStatus
 */
@JsonAdapter(ClientSideTimestampsStatus.Adapter.class)
public enum ClientSideTimestampsStatus {
  ...
  ClientSideTimestampsStatus(String value) {
    this.value = value;
  }
  ...
  public static ClientSideTimestampsStatus fromValue(String value) {
    for (ClientSideTimestampsStatus b : ClientSideTimestampsStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClientSideTimestampsStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClientSideTimestampsStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClientSideTimestampsStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClientSideTimestampsStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ClientSideTimestampsStatus.fromValue(value);
  }
}
