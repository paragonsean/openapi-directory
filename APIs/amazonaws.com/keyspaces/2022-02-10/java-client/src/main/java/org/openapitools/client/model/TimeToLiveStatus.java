...
/**
 * Gets or Sets TimeToLiveStatus
 */
@JsonAdapter(TimeToLiveStatus.Adapter.class)
public enum TimeToLiveStatus {
  ...
  public static TimeToLiveStatus fromValue(String value) {
    for (TimeToLiveStatus b : TimeToLiveStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<TimeToLiveStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final TimeToLiveStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TimeToLiveStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TimeToLiveStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TimeToLiveStatus.fromValue(value);
  }
}
