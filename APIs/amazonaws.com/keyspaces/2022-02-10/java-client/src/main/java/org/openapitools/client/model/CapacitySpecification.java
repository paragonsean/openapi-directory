...
public class CapacitySpecification {
  ...
  public CapacitySpecification throughputMode(ThroughputMode throughputMode) {
  ...
  public CapacitySpecification readCapacityUnits(Integer readCapacityUnits) {
  ...
  public CapacitySpecification writeCapacityUnits(Integer writeCapacityUnits) {
  ...
  public boolean equals(Object o) {
    ...
    CapacitySpecification capacitySpecification = (CapacitySpecification) o;
    return Objects.equals(this.throughputMode, capacitySpecification.throughputMode) &&
        Objects.equals(this.readCapacityUnits, capacitySpecification.readCapacityUnits) &&
        Objects.equals(this.writeCapacityUnits, capacitySpecification.writeCapacityUnits);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapacitySpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CapacitySpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapacitySpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CapacitySpecification is not found in the empty JSON string", CapacitySpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CapacitySpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CapacitySpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CapacitySpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CapacitySpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CapacitySpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CapacitySpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CapacitySpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<CapacitySpecification>() {
           @Override
           public void write(JsonWriter out, CapacitySpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CapacitySpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CapacitySpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CapacitySpecification
   * @throws IOException if the JSON string is invalid with respect to CapacitySpecification
   */
  public static CapacitySpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CapacitySpecification.class);
  }

  /**
   * Convert an instance of CapacitySpecification to an JSON string
   *
   * @return JSON string
   */
