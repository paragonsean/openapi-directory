...
public enum Rs {
  ...
  public static class Adapter extends TypeAdapter<Rs> {
    @Override
    public void write(final JsonWriter jsonWriter, final Rs enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Rs read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Rs.fromValue(value);
    }
  }
