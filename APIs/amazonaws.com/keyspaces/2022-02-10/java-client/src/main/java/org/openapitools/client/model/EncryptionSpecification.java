...
public class EncryptionSpecification {
  ...
  public EncryptionSpecification() {
  }

  public EncryptionSpecification type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public EncryptionSpecification kmsKeyIdentifier(String kmsKeyIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    EncryptionSpecification encryptionSpecification = (EncryptionSpecification) o;
    return Objects.equals(this.type, encryptionSpecification.type) &&
        Objects.equals(this.kmsKeyIdentifier, encryptionSpecification.kmsKeyIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class EncryptionSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EncryptionSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncryptionSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncryptionSpecification is not found in the empty JSON string", EncryptionSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncryptionSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EncryptionSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EncryptionSpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncryptionSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncryptionSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncryptionSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncryptionSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<EncryptionSpecification>() {
           @Override
           public void write(JsonWriter out, EncryptionSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EncryptionSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EncryptionSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EncryptionSpecification
   * @throws IOException if the JSON string is invalid with respect to EncryptionSpecification
   */
  public static EncryptionSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncryptionSpecification.class);
  }

  /**
   * Convert an instance of EncryptionSpecification to an JSON string
   *
   * @return JSON string
   */
