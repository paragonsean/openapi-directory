...
public class UpdateTableRequestCapacitySpecification {
  ...
  public UpdateTableRequestCapacitySpecification() {
  }

  public UpdateTableRequestCapacitySpecification throughputMode(ThroughputMode throughputMode) {
  ...
  public UpdateTableRequestCapacitySpecification readCapacityUnits(Integer readCapacityUnits) {
  ...
  public UpdateTableRequestCapacitySpecification writeCapacityUnits(Integer writeCapacityUnits) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTableRequestCapacitySpecification updateTableRequestCapacitySpecification = (UpdateTableRequestCapacitySpecification) o;
    return Objects.equals(this.throughputMode, updateTableRequestCapacitySpecification.throughputMode) &&
        Objects.equals(this.readCapacityUnits, updateTableRequestCapacitySpecification.readCapacityUnits) &&
        Objects.equals(this.writeCapacityUnits, updateTableRequestCapacitySpecification.writeCapacityUnits);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateTableRequestCapacitySpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTableRequestCapacitySpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTableRequestCapacitySpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTableRequestCapacitySpecification is not found in the empty JSON string", UpdateTableRequestCapacitySpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTableRequestCapacitySpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTableRequestCapacitySpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateTableRequestCapacitySpecification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTableRequestCapacitySpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTableRequestCapacitySpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTableRequestCapacitySpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTableRequestCapacitySpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTableRequestCapacitySpecification>() {
           @Override
           public void write(JsonWriter out, UpdateTableRequestCapacitySpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTableRequestCapacitySpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateTableRequestCapacitySpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTableRequestCapacitySpecification
   * @throws IOException if the JSON string is invalid with respect to UpdateTableRequestCapacitySpecification
   */
  public static UpdateTableRequestCapacitySpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTableRequestCapacitySpecification.class);
  }

  /**
   * Convert an instance of UpdateTableRequestCapacitySpecification to an JSON string
   *
   * @return JSON string
   */
