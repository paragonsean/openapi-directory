...
public class UpdateTableResponse {
  ...
  public UpdateTableResponse resourceArn(String resourceArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceArn, updateTableResponse.resourceArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTableResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTableResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTableResponse is not found in the empty JSON string", UpdateTableResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTableResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTableResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateTableResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTableResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTableResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTableResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTableResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTableResponse>() {
           @Override
           public void write(JsonWriter out, UpdateTableResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTableResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateTableResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTableResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateTableResponse
   */
  public static UpdateTableResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTableResponse.class);
  }

  /**
   * Convert an instance of UpdateTableResponse to an JSON string
   *
   * @return JSON string
   */
