...
public class GetKeyspaceRequest {
  ...
  public GetKeyspaceRequest keyspaceName(String keyspaceName) {
  ...
  public boolean equals(Object o) {
    ...
    GetKeyspaceRequest getKeyspaceRequest = (GetKeyspaceRequest) o;
    return Objects.equals(this.keyspaceName, getKeyspaceRequest.keyspaceName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetKeyspaceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetKeyspaceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetKeyspaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetKeyspaceRequest is not found in the empty JSON string", GetKeyspaceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetKeyspaceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetKeyspaceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetKeyspaceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetKeyspaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetKeyspaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetKeyspaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetKeyspaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetKeyspaceRequest>() {
           @Override
           public void write(JsonWriter out, GetKeyspaceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetKeyspaceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetKeyspaceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetKeyspaceRequest
   * @throws IOException if the JSON string is invalid with respect to GetKeyspaceRequest
   */
  public static GetKeyspaceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetKeyspaceRequest.class);
  }

  /**
   * Convert an instance of GetKeyspaceRequest to an JSON string
   *
   * @return JSON string
   */
