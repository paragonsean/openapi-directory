...
async def test_create_keyspace(client):
    """Test case for create_keyspace

    
    """
    body = {"keyspaceName":"","replicationSpecification":{"regionList":"","replicationStrategy":""},"tags":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.CreateKeyspace',
        headers=headers,
        json=body,
        )
...
async def test_create_table(client):
    ...
    """
    body = {"capacitySpecification":{"writeCapacityUnits":"","throughputMode":"","readCapacityUnits":""},"encryptionSpecification":{"kmsKeyIdentifier":"","type":""},"keyspaceName":"","clientSideTimestamps":{"status":""},"pointInTimeRecovery":{"status":""},"schemaDefinition":{"clusteringKeys":"","allColumns":"","partitionKeys":"","staticColumns":""},"comment":{"message":""},"defaultTimeToLive":"","ttl":{"status":""},"tableName":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.CreateTable',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_keyspace(client):
    """Test case for delete_keyspace
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.DeleteKeyspace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_table(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.DeleteTable',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_keyspace(client):
    """Test case for get_keyspace
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.GetKeyspace',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_table(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.GetTable',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_keyspaces(client):
    """Test case for list_keyspaces
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.ListKeyspaces',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tables(client):
    ...
    """
    body = {"keyspaceName":"","nextToken":"","maxResults":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.ListTables',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.ListTagsForResource',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_restore_table(client):
    """Test case for restore_table

    
    """
    body = {"restoreTimestamp":"","sourceTableName":"","targetKeyspaceName":"","capacitySpecificationOverride":{"writeCapacityUnits":"","throughputMode":"","readCapacityUnits":""},"tagsOverride":"","sourceKeyspaceName":"","pointInTimeRecoveryOverride":{"status":""},"targetTableName":"","encryptionSpecificationOverride":{"kmsKeyIdentifier":"","type":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.RestoreTable',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_table(client):
    ...
    """
    body = {"capacitySpecification":{"writeCapacityUnits":"","throughputMode":"","readCapacityUnits":""},"encryptionSpecification":{"kmsKeyIdentifier":"","type":""},"keyspaceName":"","clientSideTimestamps":{"status":""},"addColumns":"","pointInTimeRecovery":{"status":""},"defaultTimeToLive":"","ttl":{"status":""},"tableName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=KeyspacesService.UpdateTable',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
