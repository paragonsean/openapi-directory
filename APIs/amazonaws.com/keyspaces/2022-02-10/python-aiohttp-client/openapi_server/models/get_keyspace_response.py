...
class GetKeyspaceResponse(Model):
    ...
    def __init__(self, keyspace_name: str=None, resource_arn: str=None, replication_strategy: Rs=None, replication_regions: List=None):
        """GetKeyspaceResponse - a model defined in OpenAPI

        :param keyspace_name: The keyspace_name of this GetKeyspaceResponse.
        :param resource_arn: The resource_arn of this GetKeyspaceResponse.
        :param replication_strategy: The replication_strategy of this GetKeyspaceResponse.
        :param replication_regions: The replication_regions of this GetKeyspaceResponse.
        """
        self.openapi_types = {
            'keyspace_name': str,
            'resource_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetKeyspaceResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetKeyspaceResponse of this GetKeyspaceResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def keyspace_name(self):
        """Gets the keyspace_name of this GetKeyspaceResponse.


        :return: The keyspace_name of this GetKeyspaceResponse.
        :rtype: str
        """
    ...
    def keyspace_name(self, keyspace_name):
        """Sets the keyspace_name of this GetKeyspaceResponse.
    ...
    def resource_arn(self):
        """Gets the resource_arn of this GetKeyspaceResponse.


        :return: The resource_arn of this GetKeyspaceResponse.
        :rtype: str
        """
    ...
    def resource_arn(self, resource_arn):
        """Sets the resource_arn of this GetKeyspaceResponse.
    ...
    def replication_strategy(self):
        """Gets the replication_strategy of this GetKeyspaceResponse.


        :return: The replication_strategy of this GetKeyspaceResponse.
        :rtype: Rs
        """
    ...
    def replication_strategy(self, replication_strategy):
        """Sets the replication_strategy of this GetKeyspaceResponse.
    ...
    def replication_regions(self):
        """Gets the replication_regions of this GetKeyspaceResponse.


        :return: The replication_regions of this GetKeyspaceResponse.
        :rtype: List
        """
    ...
    def replication_regions(self, replication_regions):
        """Sets the replication_regions of this GetKeyspaceResponse.
