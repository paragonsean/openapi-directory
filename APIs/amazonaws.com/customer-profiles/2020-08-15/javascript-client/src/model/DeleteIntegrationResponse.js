...
class DeleteIntegrationResponse {
    ...
    constructor(message) { 
        ...
        DeleteIntegrationResponse.initialize(this, message);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteIntegrationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteIntegrationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteIntegrationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteIntegrationResponse.RequiredProperties) {
...
DeleteIntegrationResponse.RequiredProperties = ["Message"];

/**
 * @member {String} Message
 */
DeleteIntegrationResponse.prototype['Message'] = undefined;
...
export default DeleteIntegrationResponse;
