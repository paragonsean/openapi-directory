...
/**
 * The CreateProfileRequestShippingAddress model module.
 * @module model/CreateProfileRequestShippingAddress
 * @version 2020-08-15
 */
class CreateProfileRequestShippingAddress {
    /**
     * Constructs a new <code>CreateProfileRequestShippingAddress</code>.
     * @alias module:model/CreateProfileRequestShippingAddress
     * @implements module:model/Address
     */
    constructor() { 
        Address.initialize(this);
        CreateProfileRequestShippingAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateProfileRequestShippingAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProfileRequestShippingAddress} obj Optional instance to populate.
     * @return {module:model/CreateProfileRequestShippingAddress} The populated <code>CreateProfileRequestShippingAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProfileRequestShippingAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProfileRequestShippingAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProfileRequestShippingAddress</code>.
     */
 ...
 */
CreateProfileRequestShippingAddress.prototype['Address1'] = undefined;

/**
 * @member {String} Address2
 */
CreateProfileRequestShippingAddress.prototype['Address2'] = undefined;

/**
 * @member {String} Address3
 */
CreateProfileRequestShippingAddress.prototype['Address3'] = undefined;

/**
 * @member {String} Address4
 */
CreateProfileRequestShippingAddress.prototype['Address4'] = undefined;

/**
 * @member {String} City
 */
CreateProfileRequestShippingAddress.prototype['City'] = undefined;

/**
 * @member {String} County
 */
CreateProfileRequestShippingAddress.prototype['County'] = undefined;

/**
 * @member {String} State
 */
CreateProfileRequestShippingAddress.prototype['State'] = undefined;

/**
 * @member {String} Province
 */
CreateProfileRequestShippingAddress.prototype['Province'] = undefined;

/**
 * @member {String} Country
 */
CreateProfileRequestShippingAddress.prototype['Country'] = undefined;

/**
 * @member {String} PostalCode
 */
CreateProfileRequestShippingAddress.prototype['PostalCode'] = undefined;
...
export default CreateProfileRequestShippingAddress;
