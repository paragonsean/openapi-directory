...
/**
 * The UpdateAddress model module.
 * @module model/UpdateAddress
 * @version 2020-08-15
 */
class UpdateAddress {
    /**
     * Constructs a new <code>UpdateAddress</code>.
     * Updates associated with the address properties of a customer profile.
     * @alias module:model/UpdateAddress
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UpdateAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAddress} obj Optional instance to populate.
     * @return {module:model/UpdateAddress} The populated <code>UpdateAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAddress</code>.
     */
