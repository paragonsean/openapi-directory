...
/**
 * The CreateProfileRequestAddress model module.
 * @module model/CreateProfileRequestAddress
 * @version 2020-08-15
 */
class CreateProfileRequestAddress {
    /**
     * Constructs a new <code>CreateProfileRequestAddress</code>.
     * @alias module:model/CreateProfileRequestAddress
     * @implements module:model/Address
     */
    constructor() { 
        Address.initialize(this);
        CreateProfileRequestAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateProfileRequestAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProfileRequestAddress} obj Optional instance to populate.
     * @return {module:model/CreateProfileRequestAddress} The populated <code>CreateProfileRequestAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProfileRequestAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProfileRequestAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProfileRequestAddress</code>.
     */
 ...
 */
CreateProfileRequestAddress.prototype['Address1'] = undefined;

/**
 * @member {String} Address2
 */
CreateProfileRequestAddress.prototype['Address2'] = undefined;

/**
 * @member {String} Address3
 */
CreateProfileRequestAddress.prototype['Address3'] = undefined;

/**
 * @member {String} Address4
 */
CreateProfileRequestAddress.prototype['Address4'] = undefined;

/**
 * @member {String} City
 */
CreateProfileRequestAddress.prototype['City'] = undefined;

/**
 * @member {String} County
 */
CreateProfileRequestAddress.prototype['County'] = undefined;

/**
 * @member {String} State
 */
CreateProfileRequestAddress.prototype['State'] = undefined;

/**
 * @member {String} Province
 */
CreateProfileRequestAddress.prototype['Province'] = undefined;

/**
 * @member {String} Country
 */
CreateProfileRequestAddress.prototype['Country'] = undefined;

/**
 * @member {String} PostalCode
 */
CreateProfileRequestAddress.prototype['PostalCode'] = undefined;
...
export default CreateProfileRequestAddress;
