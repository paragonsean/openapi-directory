...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.Range();
  });
  ...
  describe('Range', function() {
    it('should create an instance of Range', function() {
      ...
      //var instance = new AmazonConnectCustomerProfiles.Range();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.Range);
    });
