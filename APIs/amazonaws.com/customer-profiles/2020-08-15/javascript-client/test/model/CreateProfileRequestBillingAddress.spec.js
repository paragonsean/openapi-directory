...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.CreateProfileRequestBillingAddress();
  });
  ...
  describe('CreateProfileRequestBillingAddress', function() {
    it('should create an instance of CreateProfileRequestBillingAddress', function() {
      // uncomment below and update the code to test CreateProfileRequestBillingAddress
      //var instance = new AmazonConnectCustomerProfiles.CreateProfileRequestBillingAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.CreateProfileRequestBillingAddress);
    });
