...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.Conditions();
  });
  ...
  describe('Conditions', function() {
    it('should create an instance of Conditions', function() {
      ...
      //var instance = new AmazonConnectCustomerProfiles.Conditions();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.Conditions);
    });
