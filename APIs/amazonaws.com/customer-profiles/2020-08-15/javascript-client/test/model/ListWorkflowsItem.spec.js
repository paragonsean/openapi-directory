...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.ListWorkflowsItem();
  });
  ...
  describe('ListWorkflowsItem', function() {
    it('should create an instance of ListWorkflowsItem', function() {
      // uncomment below and update the code to test ListWorkflowsItem
      //var instance = new AmazonConnectCustomerProfiles.ListWorkflowsItem();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.ListWorkflowsItem);
    });
