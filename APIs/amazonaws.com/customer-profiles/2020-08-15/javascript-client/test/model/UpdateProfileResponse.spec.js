...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.UpdateProfileResponse();
  });
  ...
  describe('UpdateProfileResponse', function() {
    it('should create an instance of UpdateProfileResponse', function() {
      ...
      //var instance = new AmazonConnectCustomerProfiles.UpdateProfileResponse();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.UpdateProfileResponse);
    });
