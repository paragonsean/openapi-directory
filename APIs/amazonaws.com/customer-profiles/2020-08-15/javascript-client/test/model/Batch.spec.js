...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.Batch();
  });
  ...
  describe('Batch', function() {
    it('should create an instance of Batch', function() {
      ...
      //var instance = new AmazonConnectCustomerProfiles.Batch();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.Batch);
    });
