...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestBillingAddress();
  });
  ...
  describe('UpdateProfileRequestBillingAddress', function() {
    it('should create an instance of UpdateProfileRequestBillingAddress', function() {
      // uncomment below and update the code to test UpdateProfileRequestBillingAddress
      //var instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestBillingAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.UpdateProfileRequestBillingAddress);
    });
