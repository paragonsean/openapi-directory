...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestMailingAddress();
  });
  ...
  describe('UpdateProfileRequestMailingAddress', function() {
    it('should create an instance of UpdateProfileRequestMailingAddress', function() {
      // uncomment below and update the code to test UpdateProfileRequestMailingAddress
      //var instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestMailingAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.UpdateProfileRequestMailingAddress);
    });
