...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestShippingAddress();
  });
  ...
  describe('UpdateProfileRequestShippingAddress', function() {
    it('should create an instance of UpdateProfileRequestShippingAddress', function() {
      // uncomment below and update the code to test UpdateProfileRequestShippingAddress
      //var instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestShippingAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.UpdateProfileRequestShippingAddress);
    });
