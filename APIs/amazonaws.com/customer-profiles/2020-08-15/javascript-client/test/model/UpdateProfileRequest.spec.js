...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.UpdateProfileRequest();
  });
  ...
  describe('UpdateProfileRequest', function() {
    it('should create an instance of UpdateProfileRequest', function() {
      // uncomment below and update the code to test UpdateProfileRequest
      //var instance = new AmazonConnectCustomerProfiles.UpdateProfileRequest();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.UpdateProfileRequest);
    });
