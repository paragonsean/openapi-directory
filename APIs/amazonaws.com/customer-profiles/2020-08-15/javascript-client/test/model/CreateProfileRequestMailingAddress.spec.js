...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.CreateProfileRequestMailingAddress();
  });
  ...
  describe('CreateProfileRequestMailingAddress', function() {
    it('should create an instance of CreateProfileRequestMailingAddress', function() {
      // uncomment below and update the code to test CreateProfileRequestMailingAddress
      //var instance = new AmazonConnectCustomerProfiles.CreateProfileRequestMailingAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.CreateProfileRequestMailingAddress);
    });
