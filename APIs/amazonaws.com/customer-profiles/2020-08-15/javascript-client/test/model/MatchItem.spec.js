...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.MatchItem();
  });
  ...
  describe('MatchItem', function() {
    it('should create an instance of MatchItem', function() {
      // uncomment below and update the code to test MatchItem
      //var instance = new AmazonConnectCustomerProfiles.MatchItem();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.MatchItem);
    });
