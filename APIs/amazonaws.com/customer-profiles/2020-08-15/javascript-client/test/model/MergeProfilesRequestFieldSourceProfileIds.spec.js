...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.MergeProfilesRequestFieldSourceProfileIds();
  });
  ...
  describe('MergeProfilesRequestFieldSourceProfileIds', function() {
    it('should create an instance of MergeProfilesRequestFieldSourceProfileIds', function() {
      // uncomment below and update the code to test MergeProfilesRequestFieldSourceProfileIds
      //var instance = new AmazonConnectCustomerProfiles.MergeProfilesRequestFieldSourceProfileIds();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.MergeProfilesRequestFieldSourceProfileIds);
    });
