...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.ConnectorOperator();
  });
  ...
  describe('ConnectorOperator', function() {
    it('should create an instance of ConnectorOperator', function() {
      // uncomment below and update the code to test ConnectorOperator
      //var instance = new AmazonConnectCustomerProfiles.ConnectorOperator();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.ConnectorOperator);
    });
