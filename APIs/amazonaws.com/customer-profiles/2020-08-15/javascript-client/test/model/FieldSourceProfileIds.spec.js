...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.FieldSourceProfileIds();
  });
  ...
  describe('FieldSourceProfileIds', function() {
    it('should create an instance of FieldSourceProfileIds', function() {
      // uncomment below and update the code to test FieldSourceProfileIds
      //var instance = new AmazonConnectCustomerProfiles.FieldSourceProfileIds();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.FieldSourceProfileIds);
    });
