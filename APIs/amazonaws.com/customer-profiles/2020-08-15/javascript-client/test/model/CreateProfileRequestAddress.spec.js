...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.CreateProfileRequestAddress();
  });
  ...
  describe('CreateProfileRequestAddress', function() {
    it('should create an instance of CreateProfileRequestAddress', function() {
      // uncomment below and update the code to test CreateProfileRequestAddress
      //var instance = new AmazonConnectCustomerProfiles.CreateProfileRequestAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.CreateProfileRequestAddress);
    });
