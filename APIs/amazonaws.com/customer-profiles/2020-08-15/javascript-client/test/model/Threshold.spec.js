...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.Threshold();
  });
  ...
  describe('Threshold', function() {
    it('should create an instance of Threshold', function() {
      ...
      //var instance = new AmazonConnectCustomerProfiles.Threshold();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.Threshold);
    });
