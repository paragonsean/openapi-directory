...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.ListDomainItem();
  });
  ...
  describe('ListDomainItem', function() {
    it('should create an instance of ListDomainItem', function() {
      // uncomment below and update the code to test ListDomainItem
      //var instance = new AmazonConnectCustomerProfiles.ListDomainItem();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.ListDomainItem);
    });
