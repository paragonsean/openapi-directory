...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestAddress();
  });
  ...
  describe('UpdateProfileRequestAddress', function() {
    it('should create an instance of UpdateProfileRequestAddress', function() {
      // uncomment below and update the code to test UpdateProfileRequestAddress
      //var instance = new AmazonConnectCustomerProfiles.UpdateProfileRequestAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.UpdateProfileRequestAddress);
    });
