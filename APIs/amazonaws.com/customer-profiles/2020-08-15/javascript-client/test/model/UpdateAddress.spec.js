...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.UpdateAddress();
  });
  ...
  describe('UpdateAddress', function() {
    it('should create an instance of UpdateAddress', function() {
      // uncomment below and update the code to test UpdateAddress
      //var instance = new AmazonConnectCustomerProfiles.UpdateAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.UpdateAddress);
    });
