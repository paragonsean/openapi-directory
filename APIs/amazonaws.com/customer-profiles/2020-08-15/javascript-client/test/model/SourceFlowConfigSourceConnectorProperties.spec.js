...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.SourceFlowConfigSourceConnectorProperties();
  });
  ...
  describe('SourceFlowConfigSourceConnectorProperties', function() {
    it('should create an instance of SourceFlowConfigSourceConnectorProperties', function() {
      // uncomment below and update the code to test SourceFlowConfigSourceConnectorProperties
      //var instance = new AmazonConnectCustomerProfiles.SourceFlowConfigSourceConnectorProperties();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.SourceFlowConfigSourceConnectorProperties);
    });
