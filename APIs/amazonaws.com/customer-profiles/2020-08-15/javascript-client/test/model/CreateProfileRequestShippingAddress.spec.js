...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCustomerProfiles.CreateProfileRequestShippingAddress();
  });
  ...
  describe('CreateProfileRequestShippingAddress', function() {
    it('should create an instance of CreateProfileRequestShippingAddress', function() {
      // uncomment below and update the code to test CreateProfileRequestShippingAddress
      //var instance = new AmazonConnectCustomerProfiles.CreateProfileRequestShippingAddress();
      //expect(instance).to.be.a(AmazonConnectCustomerProfiles.CreateProfileRequestShippingAddress);
    });
