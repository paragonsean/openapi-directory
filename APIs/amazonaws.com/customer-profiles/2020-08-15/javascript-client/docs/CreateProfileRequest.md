# AmazonConnectCustomerProfiles.CreateProfileRequest
...
**partyType** | **String** | The type of profile used to describe the customer. | [optional] 
...
**gender** | **String** | The gender with which the customer identifies.  | [optional] 
...
**address** | [**CreateProfileRequestAddress**](CreateProfileRequestAddress.md) |  | [optional] 
**shippingAddress** | [**CreateProfileRequestAddress**](CreateProfileRequestAddress.md) |  | [optional] 
**mailingAddress** | [**CreateProfileRequestAddress**](CreateProfileRequestAddress.md) |  | [optional] 
**billingAddress** | [**CreateProfileRequestAddress**](CreateProfileRequestAddress.md) |  | [optional] 
**attributes** | **{String: String}** | A key value pair of attributes of a customer profile. | [optional] 
