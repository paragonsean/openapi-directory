# AmazonConnectCustomerProfiles.UpdateDomainRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**defaultExpirationDays** | **Number** | The default number of days until the data within the domain expires. | [optional] 
