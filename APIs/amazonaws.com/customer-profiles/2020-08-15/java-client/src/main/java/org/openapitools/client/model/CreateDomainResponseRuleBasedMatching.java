...
public class CreateDomainResponseRuleBasedMatching {
  ...
  private RuleBasedMatchingStatus status;
  ...
  public CreateDomainResponseRuleBasedMatching() {
  }

  public CreateDomainResponseRuleBasedMatching enabled(Boolean enabled) {
  ...
  public CreateDomainResponseRuleBasedMatching matchingRules(List matchingRules) {
  ...
  public CreateDomainResponseRuleBasedMatching status(RuleBasedMatchingStatus status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public RuleBasedMatchingStatus getStatus() {
    return status;
  }

  public void setStatus(RuleBasedMatchingStatus status) {
    this.status = status;
  }


  public CreateDomainResponseRuleBasedMatching maxAllowedRuleLevelForMerging(Integer maxAllowedRuleLevelForMerging) {
  ...
  public CreateDomainResponseRuleBasedMatching maxAllowedRuleLevelForMatching(Integer maxAllowedRuleLevelForMatching) {
  ...
  public CreateDomainResponseRuleBasedMatching attributeTypesSelector(UpdateDomainRequestRuleBasedMatchingAttributeTypesSelector attributeTypesSelector) {
  ...
  public CreateDomainResponseRuleBasedMatching conflictResolution(ConflictResolution conflictResolution) {
  ...
  public CreateDomainResponseRuleBasedMatching exportingConfig(ExportingConfig exportingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDomainResponseRuleBasedMatching createDomainResponseRuleBasedMatching = (CreateDomainResponseRuleBasedMatching) o;
    return Objects.equals(this.enabled, createDomainResponseRuleBasedMatching.enabled) &&
        Objects.equals(this.matchingRules, createDomainResponseRuleBasedMatching.matchingRules) &&
        Objects.equals(this.status, createDomainResponseRuleBasedMatching.status) &&
        Objects.equals(this.maxAllowedRuleLevelForMerging, createDomainResponseRuleBasedMatching.maxAllowedRuleLevelForMerging) &&
        Objects.equals(this.maxAllowedRuleLevelForMatching, createDomainResponseRuleBasedMatching.maxAllowedRuleLevelForMatching) &&
        Objects.equals(this.attributeTypesSelector, createDomainResponseRuleBasedMatching.attributeTypesSelector) &&
        Objects.equals(this.conflictResolution, createDomainResponseRuleBasedMatching.conflictResolution) &&
        Objects.equals(this.exportingConfig, createDomainResponseRuleBasedMatching.exportingConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, matchingRules, status, maxAllowedRuleLevelForMerging, maxAllowedRuleLevelForMatching, attributeTypesSelector, conflictResolution, exportingConfig);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateDomainResponseRuleBasedMatching {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDomainResponseRuleBasedMatching
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDomainResponseRuleBasedMatching.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDomainResponseRuleBasedMatching is not found in the empty JSON string", CreateDomainResponseRuleBasedMatching.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDomainResponseRuleBasedMatching.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDomainResponseRuleBasedMatching` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Status") != null && !jsonObj.get("Status").isJsonNull()) {
        RuleBasedMatchingStatus.validateJsonElement(jsonObj.get("Status"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDomainResponseRuleBasedMatching.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDomainResponseRuleBasedMatching' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDomainResponseRuleBasedMatching> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDomainResponseRuleBasedMatching.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDomainResponseRuleBasedMatching>() {
           @Override
           public void write(JsonWriter out, CreateDomainResponseRuleBasedMatching value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDomainResponseRuleBasedMatching read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDomainResponseRuleBasedMatching given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDomainResponseRuleBasedMatching
   * @throws IOException if the JSON string is invalid with respect to CreateDomainResponseRuleBasedMatching
   */
  public static CreateDomainResponseRuleBasedMatching fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDomainResponseRuleBasedMatching.class);
  }

  /**
   * Convert an instance of CreateDomainResponseRuleBasedMatching to an JSON string
   *
   * @return JSON string
   */
