...
public class SourceFlowConfigSourceConnectorProperties {
  ...
  public SourceFlowConfigSourceConnectorProperties() {
  }

  public SourceFlowConfigSourceConnectorProperties marketo(SourceConnectorPropertiesMarketo marketo) {
  ...
  public SourceFlowConfigSourceConnectorProperties S3(SourceConnectorPropertiesS3 S3) {
    this.S3 = S3;
    return this;
  }
  ...
  public SourceFlowConfigSourceConnectorProperties salesforce(SourceConnectorPropertiesSalesforce salesforce) {
  ...
  public SourceFlowConfigSourceConnectorProperties serviceNow(SourceConnectorPropertiesServiceNow serviceNow) {
  ...
  public SourceFlowConfigSourceConnectorProperties zendesk(SourceConnectorPropertiesZendesk zendesk) {
  ...
  public boolean equals(Object o) {
    ...
    SourceFlowConfigSourceConnectorProperties sourceFlowConfigSourceConnectorProperties = (SourceFlowConfigSourceConnectorProperties) o;
    return Objects.equals(this.marketo, sourceFlowConfigSourceConnectorProperties.marketo) &&
        Objects.equals(this.S3, sourceFlowConfigSourceConnectorProperties.S3) &&
        Objects.equals(this.salesforce, sourceFlowConfigSourceConnectorProperties.salesforce) &&
        Objects.equals(this.serviceNow, sourceFlowConfigSourceConnectorProperties.serviceNow) &&
        Objects.equals(this.zendesk, sourceFlowConfigSourceConnectorProperties.zendesk);
  }
  ...
  public String toString() {
    ...
    sb.append("class SourceFlowConfigSourceConnectorProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SourceFlowConfigSourceConnectorProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SourceFlowConfigSourceConnectorProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceFlowConfigSourceConnectorProperties is not found in the empty JSON string", SourceFlowConfigSourceConnectorProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SourceFlowConfigSourceConnectorProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceFlowConfigSourceConnectorProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceFlowConfigSourceConnectorProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceFlowConfigSourceConnectorProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceFlowConfigSourceConnectorProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceFlowConfigSourceConnectorProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceFlowConfigSourceConnectorProperties>() {
           @Override
           public void write(JsonWriter out, SourceFlowConfigSourceConnectorProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SourceFlowConfigSourceConnectorProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SourceFlowConfigSourceConnectorProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SourceFlowConfigSourceConnectorProperties
   * @throws IOException if the JSON string is invalid with respect to SourceFlowConfigSourceConnectorProperties
   */
  public static SourceFlowConfigSourceConnectorProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceFlowConfigSourceConnectorProperties.class);
  }

  /**
   * Convert an instance of SourceFlowConfigSourceConnectorProperties to an JSON string
   *
   * @return JSON string
   */
