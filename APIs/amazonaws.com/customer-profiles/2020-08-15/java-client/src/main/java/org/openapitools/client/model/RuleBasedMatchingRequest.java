...
public class RuleBasedMatchingRequest {
  ...
  public RuleBasedMatchingRequest() {
  }

  public RuleBasedMatchingRequest enabled(Boolean enabled) {
  ...
  public RuleBasedMatchingRequest matchingRules(List matchingRules) {
  ...
  public RuleBasedMatchingRequest maxAllowedRuleLevelForMerging(Integer maxAllowedRuleLevelForMerging) {
  ...
  public RuleBasedMatchingRequest maxAllowedRuleLevelForMatching(Integer maxAllowedRuleLevelForMatching) {
  ...
  public RuleBasedMatchingRequest attributeTypesSelector(UpdateDomainRequestRuleBasedMatchingAttributeTypesSelector attributeTypesSelector) {
  ...
  public RuleBasedMatchingRequest conflictResolution(ConflictResolution conflictResolution) {
  ...
  public RuleBasedMatchingRequest exportingConfig(ExportingConfig exportingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    RuleBasedMatchingRequest ruleBasedMatchingRequest = (RuleBasedMatchingRequest) o;
    return Objects.equals(this.enabled, ruleBasedMatchingRequest.enabled) &&
        Objects.equals(this.matchingRules, ruleBasedMatchingRequest.matchingRules) &&
        Objects.equals(this.maxAllowedRuleLevelForMerging, ruleBasedMatchingRequest.maxAllowedRuleLevelForMerging) &&
        Objects.equals(this.maxAllowedRuleLevelForMatching, ruleBasedMatchingRequest.maxAllowedRuleLevelForMatching) &&
        Objects.equals(this.attributeTypesSelector, ruleBasedMatchingRequest.attributeTypesSelector) &&
        Objects.equals(this.conflictResolution, ruleBasedMatchingRequest.conflictResolution) &&
        Objects.equals(this.exportingConfig, ruleBasedMatchingRequest.exportingConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleBasedMatchingRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleBasedMatchingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleBasedMatchingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleBasedMatchingRequest is not found in the empty JSON string", RuleBasedMatchingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleBasedMatchingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleBasedMatchingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RuleBasedMatchingRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleBasedMatchingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleBasedMatchingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleBasedMatchingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleBasedMatchingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleBasedMatchingRequest>() {
           @Override
           public void write(JsonWriter out, RuleBasedMatchingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleBasedMatchingRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleBasedMatchingRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleBasedMatchingRequest
   * @throws IOException if the JSON string is invalid with respect to RuleBasedMatchingRequest
   */
  public static RuleBasedMatchingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleBasedMatchingRequest.class);
  }

  /**
   * Convert an instance of RuleBasedMatchingRequest to an JSON string
   *
   * @return JSON string
   */
