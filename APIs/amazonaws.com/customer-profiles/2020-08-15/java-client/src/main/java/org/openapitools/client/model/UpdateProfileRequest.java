...
import org.openapitools.client.model.UpdateProfileRequestAddress;
...
public class UpdateProfileRequest {
  ...
  public UpdateProfileRequest profileId(String profileId) {
  ...
  public UpdateProfileRequest additionalInformation(String additionalInformation) {
  ...
  public UpdateProfileRequest accountNumber(String accountNumber) {
  ...
  @Deprecated
  public UpdateProfileRequest partyType(PartyTypeEnum partyType) {
  ...
  public UpdateProfileRequest businessName(String businessName) {
  ...
  public UpdateProfileRequest middleName(String middleName) {
  ...
  public UpdateProfileRequest birthDate(String birthDate) {
  ...
  @Deprecated
  public UpdateProfileRequest gender(GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public UpdateProfileRequest phoneNumber(String phoneNumber) {
  ...
  public UpdateProfileRequest mobilePhoneNumber(String mobilePhoneNumber) {
  ...
  public UpdateProfileRequest homePhoneNumber(String homePhoneNumber) {
  ...
  public UpdateProfileRequest businessPhoneNumber(String businessPhoneNumber) {
  ...
  public UpdateProfileRequest emailAddress(String emailAddress) {
  ...
  public UpdateProfileRequest personalEmailAddress(String personalEmailAddress) {
  ...
  public UpdateProfileRequest businessEmailAddress(String businessEmailAddress) {
  ...
  public UpdateProfileRequest address(UpdateProfileRequestAddress address) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateProfileRequestAddress getAddress() {
    return address;
  }

  public void setAddress(UpdateProfileRequestAddress address) {
    this.address = address;
  }


  public UpdateProfileRequest shippingAddress(UpdateProfileRequestAddress shippingAddress) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateProfileRequestAddress getShippingAddress() {
    return shippingAddress;
  }

  public void setShippingAddress(UpdateProfileRequestAddress shippingAddress) {
    this.shippingAddress = shippingAddress;
  }


  public UpdateProfileRequest mailingAddress(UpdateProfileRequestAddress mailingAddress) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateProfileRequestAddress getMailingAddress() {
    return mailingAddress;
  }

  public void setMailingAddress(UpdateProfileRequestAddress mailingAddress) {
    this.mailingAddress = mailingAddress;
  }


  public UpdateProfileRequest billingAddress(UpdateProfileRequestAddress billingAddress) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateProfileRequestAddress getBillingAddress() {
    return billingAddress;
  }

  public void setBillingAddress(UpdateProfileRequestAddress billingAddress) {
    this.billingAddress = billingAddress;
  }


  public UpdateProfileRequest attributes(Map<String, String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public UpdateProfileRequest putAttributesItem(String key, String attributesItem) {
  ...
  public UpdateProfileRequest partyTypeString(String partyTypeString) {
  ...
  public UpdateProfileRequest genderString(String genderString) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profileId, updateProfileRequest.profileId) &&
        Objects.equals(this.additionalInformation, updateProfileRequest.additionalInformation) &&
        Objects.equals(this.accountNumber, updateProfileRequest.accountNumber) &&
        Objects.equals(this.partyType, updateProfileRequest.partyType) &&
        Objects.equals(this.businessName, updateProfileRequest.businessName) &&
        ...
        Objects.equals(this.birthDate, updateProfileRequest.birthDate) &&
        Objects.equals(this.gender, updateProfileRequest.gender) &&
        Objects.equals(this.phoneNumber, updateProfileRequest.phoneNumber) &&
        Objects.equals(this.mobilePhoneNumber, updateProfileRequest.mobilePhoneNumber) &&
        Objects.equals(this.homePhoneNumber, updateProfileRequest.homePhoneNumber) &&
        Objects.equals(this.businessPhoneNumber, updateProfileRequest.businessPhoneNumber) &&
        Objects.equals(this.emailAddress, updateProfileRequest.emailAddress) &&
        Objects.equals(this.personalEmailAddress, updateProfileRequest.personalEmailAddress) &&
        Objects.equals(this.businessEmailAddress, updateProfileRequest.businessEmailAddress) &&
        Objects.equals(this.address, updateProfileRequest.address) &&
        Objects.equals(this.shippingAddress, updateProfileRequest.shippingAddress) &&
        Objects.equals(this.mailingAddress, updateProfileRequest.mailingAddress) &&
        Objects.equals(this.billingAddress, updateProfileRequest.billingAddress) &&
        Objects.equals(this.attributes, updateProfileRequest.attributes) &&
        Objects.equals(this.partyTypeString, updateProfileRequest.partyTypeString) &&
        Objects.equals(this.genderString, updateProfileRequest.genderString);
  }

  @Override
  public int hashCode() {
    return Objects.hash(profileId, additionalInformation, accountNumber, partyType, businessName, firstName, middleName, lastName, birthDate, gender, phoneNumber, mobilePhoneNumber, homePhoneNumber, businessPhoneNumber, emailAddress, personalEmailAddress, businessEmailAddress, address, shippingAddress, mailingAddress, billingAddress, attributes, partyTypeString, genderString);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Address") != null && !jsonObj.get("Address").isJsonNull()) {
        UpdateProfileRequestAddress.validateJsonElement(jsonObj.get("Address"));
      }
      // validate the optional field `ShippingAddress`
      if (jsonObj.get("ShippingAddress") != null && !jsonObj.get("ShippingAddress").isJsonNull()) {
        UpdateProfileRequestAddress.validateJsonElement(jsonObj.get("ShippingAddress"));
      }
      // validate the optional field `MailingAddress`
      if (jsonObj.get("MailingAddress") != null && !jsonObj.get("MailingAddress").isJsonNull()) {
        UpdateProfileRequestAddress.validateJsonElement(jsonObj.get("MailingAddress"));
      }
      // validate the optional field `BillingAddress`
      if (jsonObj.get("BillingAddress") != null && !jsonObj.get("BillingAddress").isJsonNull()) {
        UpdateProfileRequestAddress.validateJsonElement(jsonObj.get("BillingAddress"));
      }
