...
public class MatchingRequest {
  ...
  public MatchingRequest enabled(Boolean enabled) {
  ...
  public MatchingRequest jobSchedule(UpdateDomainRequestMatchingJobSchedule jobSchedule) {
  ...
  public MatchingRequest autoMerging(UpdateDomainRequestMatchingAutoMerging autoMerging) {
  ...
  public MatchingRequest exportingConfig(UpdateDomainRequestMatchingExportingConfig exportingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    MatchingRequest matchingRequest = (MatchingRequest) o;
    return Objects.equals(this.enabled, matchingRequest.enabled) &&
        Objects.equals(this.jobSchedule, matchingRequest.jobSchedule) &&
        Objects.equals(this.autoMerging, matchingRequest.autoMerging) &&
        Objects.equals(this.exportingConfig, matchingRequest.exportingConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class MatchingRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MatchingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MatchingRequest is not found in the empty JSON string", MatchingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MatchingRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MatchingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MatchingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MatchingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MatchingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MatchingRequest>() {
           @Override
           public void write(JsonWriter out, MatchingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MatchingRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MatchingRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MatchingRequest
   * @throws IOException if the JSON string is invalid with respect to MatchingRequest
   */
  public static MatchingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MatchingRequest.class);
  }

  /**
   * Convert an instance of MatchingRequest to an JSON string
   *
   * @return JSON string
   */
