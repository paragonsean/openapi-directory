...
public class UpdateDomainResponseRuleBasedMatching {
  ...
  public UpdateDomainResponseRuleBasedMatching() {
  }

  public UpdateDomainResponseRuleBasedMatching enabled(Boolean enabled) {
  ...
  public UpdateDomainResponseRuleBasedMatching matchingRules(List matchingRules) {
  ...
  public UpdateDomainResponseRuleBasedMatching status(RuleBasedMatchingStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateDomainResponseRuleBasedMatching maxAllowedRuleLevelForMerging(Integer maxAllowedRuleLevelForMerging) {
  ...
  public UpdateDomainResponseRuleBasedMatching maxAllowedRuleLevelForMatching(Integer maxAllowedRuleLevelForMatching) {
  ...
  public UpdateDomainResponseRuleBasedMatching attributeTypesSelector(UpdateDomainRequestRuleBasedMatchingAttributeTypesSelector attributeTypesSelector) {
  ...
  public UpdateDomainResponseRuleBasedMatching conflictResolution(ConflictResolution conflictResolution) {
  ...
  public UpdateDomainResponseRuleBasedMatching exportingConfig(ExportingConfig exportingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDomainResponseRuleBasedMatching updateDomainResponseRuleBasedMatching = (UpdateDomainResponseRuleBasedMatching) o;
    return Objects.equals(this.enabled, updateDomainResponseRuleBasedMatching.enabled) &&
        Objects.equals(this.matchingRules, updateDomainResponseRuleBasedMatching.matchingRules) &&
        Objects.equals(this.status, updateDomainResponseRuleBasedMatching.status) &&
        Objects.equals(this.maxAllowedRuleLevelForMerging, updateDomainResponseRuleBasedMatching.maxAllowedRuleLevelForMerging) &&
        Objects.equals(this.maxAllowedRuleLevelForMatching, updateDomainResponseRuleBasedMatching.maxAllowedRuleLevelForMatching) &&
        Objects.equals(this.attributeTypesSelector, updateDomainResponseRuleBasedMatching.attributeTypesSelector) &&
        Objects.equals(this.conflictResolution, updateDomainResponseRuleBasedMatching.conflictResolution) &&
        Objects.equals(this.exportingConfig, updateDomainResponseRuleBasedMatching.exportingConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDomainResponseRuleBasedMatching {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDomainResponseRuleBasedMatching
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDomainResponseRuleBasedMatching.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDomainResponseRuleBasedMatching is not found in the empty JSON string", UpdateDomainResponseRuleBasedMatching.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDomainResponseRuleBasedMatching.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDomainResponseRuleBasedMatching` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDomainResponseRuleBasedMatching.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDomainResponseRuleBasedMatching' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDomainResponseRuleBasedMatching> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDomainResponseRuleBasedMatching.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDomainResponseRuleBasedMatching>() {
           @Override
           public void write(JsonWriter out, UpdateDomainResponseRuleBasedMatching value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDomainResponseRuleBasedMatching read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDomainResponseRuleBasedMatching given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDomainResponseRuleBasedMatching
   * @throws IOException if the JSON string is invalid with respect to UpdateDomainResponseRuleBasedMatching
   */
  public static UpdateDomainResponseRuleBasedMatching fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDomainResponseRuleBasedMatching.class);
  }

  /**
   * Convert an instance of UpdateDomainResponseRuleBasedMatching to an JSON string
   *
   * @return JSON string
   */
