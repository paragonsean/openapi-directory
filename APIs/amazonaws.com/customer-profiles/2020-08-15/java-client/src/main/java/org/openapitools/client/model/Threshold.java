...
public class Threshold {
  ...
  public Threshold value(String value) {
    this.value = value;
    return this;
  }
  ...
  public Threshold operator(Operator operator) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, threshold.value) &&
        Objects.equals(this.operator, threshold.operator);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Threshold.openapiRequiredFields) {
