...
public class RuleBasedMatchingResponse {
  ...
  public RuleBasedMatchingResponse() {
  }

  public RuleBasedMatchingResponse enabled(Boolean enabled) {
  ...
  public RuleBasedMatchingResponse matchingRules(List matchingRules) {
  ...
  public RuleBasedMatchingResponse status(RuleBasedMatchingStatus status) {
    this.status = status;
    return this;
  }
  ...
  public RuleBasedMatchingResponse maxAllowedRuleLevelForMerging(Integer maxAllowedRuleLevelForMerging) {
  ...
  public RuleBasedMatchingResponse maxAllowedRuleLevelForMatching(Integer maxAllowedRuleLevelForMatching) {
  ...
  public RuleBasedMatchingResponse attributeTypesSelector(UpdateDomainRequestRuleBasedMatchingAttributeTypesSelector attributeTypesSelector) {
  ...
  public RuleBasedMatchingResponse conflictResolution(ConflictResolution conflictResolution) {
  ...
  public RuleBasedMatchingResponse exportingConfig(ExportingConfig exportingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    RuleBasedMatchingResponse ruleBasedMatchingResponse = (RuleBasedMatchingResponse) o;
    return Objects.equals(this.enabled, ruleBasedMatchingResponse.enabled) &&
        Objects.equals(this.matchingRules, ruleBasedMatchingResponse.matchingRules) &&
        Objects.equals(this.status, ruleBasedMatchingResponse.status) &&
        Objects.equals(this.maxAllowedRuleLevelForMerging, ruleBasedMatchingResponse.maxAllowedRuleLevelForMerging) &&
        Objects.equals(this.maxAllowedRuleLevelForMatching, ruleBasedMatchingResponse.maxAllowedRuleLevelForMatching) &&
        Objects.equals(this.attributeTypesSelector, ruleBasedMatchingResponse.attributeTypesSelector) &&
        Objects.equals(this.conflictResolution, ruleBasedMatchingResponse.conflictResolution) &&
        Objects.equals(this.exportingConfig, ruleBasedMatchingResponse.exportingConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleBasedMatchingResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleBasedMatchingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleBasedMatchingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleBasedMatchingResponse is not found in the empty JSON string", RuleBasedMatchingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleBasedMatchingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleBasedMatchingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleBasedMatchingResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleBasedMatchingResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleBasedMatchingResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleBasedMatchingResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleBasedMatchingResponse>() {
           @Override
           public void write(JsonWriter out, RuleBasedMatchingResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleBasedMatchingResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleBasedMatchingResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleBasedMatchingResponse
   * @throws IOException if the JSON string is invalid with respect to RuleBasedMatchingResponse
   */
  public static RuleBasedMatchingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleBasedMatchingResponse.class);
  }

  /**
   * Convert an instance of RuleBasedMatchingResponse to an JSON string
   *
   * @return JSON string
   */
