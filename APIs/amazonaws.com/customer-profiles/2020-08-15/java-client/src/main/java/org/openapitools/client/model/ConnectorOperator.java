...
public class ConnectorOperator {
  ...
  public ConnectorOperator marketo(MarketoConnectorOperator marketo) {
  ...
  public ConnectorOperator S3(S3ConnectorOperator S3) {
    this.S3 = S3;
    return this;
  }
  ...
  public ConnectorOperator salesforce(SalesforceConnectorOperator salesforce) {
  ...
  public ConnectorOperator serviceNow(ServiceNowConnectorOperator serviceNow) {
  ...
  public ConnectorOperator zendesk(ZendeskConnectorOperator zendesk) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectorOperator connectorOperator = (ConnectorOperator) o;
    return Objects.equals(this.marketo, connectorOperator.marketo) &&
        Objects.equals(this.S3, connectorOperator.S3) &&
        Objects.equals(this.salesforce, connectorOperator.salesforce) &&
        Objects.equals(this.serviceNow, connectorOperator.serviceNow) &&
        Objects.equals(this.zendesk, connectorOperator.zendesk);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectorOperator {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectorOperator
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectorOperator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectorOperator is not found in the empty JSON string", ConnectorOperator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectorOperator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectorOperator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectorOperator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectorOperator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectorOperator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectorOperator.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectorOperator>() {
           @Override
           public void write(JsonWriter out, ConnectorOperator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectorOperator read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectorOperator given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectorOperator
   * @throws IOException if the JSON string is invalid with respect to ConnectorOperator
   */
  public static ConnectorOperator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectorOperator.class);
  }

  /**
   * Convert an instance of ConnectorOperator to an JSON string
   *
   * @return JSON string
   */
