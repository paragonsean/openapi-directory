...
public class UpdateDomainRequestMatching {
  ...
  public UpdateDomainRequestMatching() {
  }

  public UpdateDomainRequestMatching enabled(Boolean enabled) {
  ...
  public UpdateDomainRequestMatching jobSchedule(UpdateDomainRequestMatchingJobSchedule jobSchedule) {
  ...
  public UpdateDomainRequestMatching autoMerging(UpdateDomainRequestMatchingAutoMerging autoMerging) {
  ...
  public UpdateDomainRequestMatching exportingConfig(UpdateDomainRequestMatchingExportingConfig exportingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDomainRequestMatching updateDomainRequestMatching = (UpdateDomainRequestMatching) o;
    return Objects.equals(this.enabled, updateDomainRequestMatching.enabled) &&
        Objects.equals(this.jobSchedule, updateDomainRequestMatching.jobSchedule) &&
        Objects.equals(this.autoMerging, updateDomainRequestMatching.autoMerging) &&
        Objects.equals(this.exportingConfig, updateDomainRequestMatching.exportingConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDomainRequestMatching {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDomainRequestMatching
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDomainRequestMatching.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDomainRequestMatching is not found in the empty JSON string", UpdateDomainRequestMatching.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDomainRequestMatching.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDomainRequestMatching` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDomainRequestMatching.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDomainRequestMatching' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDomainRequestMatching> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDomainRequestMatching.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDomainRequestMatching>() {
           @Override
           public void write(JsonWriter out, UpdateDomainRequestMatching value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDomainRequestMatching read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDomainRequestMatching given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDomainRequestMatching
   * @throws IOException if the JSON string is invalid with respect to UpdateDomainRequestMatching
   */
  public static UpdateDomainRequestMatching fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDomainRequestMatching.class);
  }

  /**
   * Convert an instance of UpdateDomainRequestMatching to an JSON string
   *
   * @return JSON string
   */
