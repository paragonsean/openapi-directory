...
public class UpdateDomainRequestRuleBasedMatching {
  ...
  public UpdateDomainRequestRuleBasedMatching() {
  }

  public UpdateDomainRequestRuleBasedMatching enabled(Boolean enabled) {
  ...
  public UpdateDomainRequestRuleBasedMatching matchingRules(List matchingRules) {
  ...
  public UpdateDomainRequestRuleBasedMatching maxAllowedRuleLevelForMerging(Integer maxAllowedRuleLevelForMerging) {
  ...
  public UpdateDomainRequestRuleBasedMatching maxAllowedRuleLevelForMatching(Integer maxAllowedRuleLevelForMatching) {
  ...
  public UpdateDomainRequestRuleBasedMatching attributeTypesSelector(UpdateDomainRequestRuleBasedMatchingAttributeTypesSelector attributeTypesSelector) {
  ...
  public UpdateDomainRequestRuleBasedMatching conflictResolution(ConflictResolution conflictResolution) {
  ...
  public UpdateDomainRequestRuleBasedMatching exportingConfig(ExportingConfig exportingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDomainRequestRuleBasedMatching updateDomainRequestRuleBasedMatching = (UpdateDomainRequestRuleBasedMatching) o;
    return Objects.equals(this.enabled, updateDomainRequestRuleBasedMatching.enabled) &&
        Objects.equals(this.matchingRules, updateDomainRequestRuleBasedMatching.matchingRules) &&
        Objects.equals(this.maxAllowedRuleLevelForMerging, updateDomainRequestRuleBasedMatching.maxAllowedRuleLevelForMerging) &&
        Objects.equals(this.maxAllowedRuleLevelForMatching, updateDomainRequestRuleBasedMatching.maxAllowedRuleLevelForMatching) &&
        Objects.equals(this.attributeTypesSelector, updateDomainRequestRuleBasedMatching.attributeTypesSelector) &&
        Objects.equals(this.conflictResolution, updateDomainRequestRuleBasedMatching.conflictResolution) &&
        Objects.equals(this.exportingConfig, updateDomainRequestRuleBasedMatching.exportingConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDomainRequestRuleBasedMatching {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDomainRequestRuleBasedMatching
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDomainRequestRuleBasedMatching.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDomainRequestRuleBasedMatching is not found in the empty JSON string", UpdateDomainRequestRuleBasedMatching.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDomainRequestRuleBasedMatching.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDomainRequestRuleBasedMatching` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDomainRequestRuleBasedMatching.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDomainRequestRuleBasedMatching.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDomainRequestRuleBasedMatching' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDomainRequestRuleBasedMatching> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDomainRequestRuleBasedMatching.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDomainRequestRuleBasedMatching>() {
           @Override
           public void write(JsonWriter out, UpdateDomainRequestRuleBasedMatching value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDomainRequestRuleBasedMatching read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDomainRequestRuleBasedMatching given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDomainRequestRuleBasedMatching
   * @throws IOException if the JSON string is invalid with respect to UpdateDomainRequestRuleBasedMatching
   */
  public static UpdateDomainRequestRuleBasedMatching fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDomainRequestRuleBasedMatching.class);
  }

  /**
   * Convert an instance of UpdateDomainRequestRuleBasedMatching to an JSON string
   *
   * @return JSON string
   */
