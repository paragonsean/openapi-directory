...
|**expirationDays** | **Integer** | The number of days until the data in the object expires. |  [optional] |
...
|**fields** | [**Map&lt;String, ObjectTypeField&gt;**](ObjectTypeField.md) | A map of the name and ObjectType field. |  [optional] |
|**keys** | **Map&lt;String, List&lt;ObjectTypeKey&gt;&gt;** | A list of unique keys that can be used to map data to the profile. |  [optional] |
