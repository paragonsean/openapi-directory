...
class Address(Model):
    ...
    def __init__(self, address1: str=None, address2: str=None, address3: str=None, address4: str=None, city: str=None, county: str=None, state: str=None, province: str=None, country: str=None, postal_code: str=None):
        ...
        :param address3: The address3 of this Address.
        :param address4: The address4 of this Address.
    ...
    def address3(self):
        ...
        :return: The address3 of this Address.
        :rtype: str
        """
    ...
    @property
    def address4(self):
        """Gets the address4 of this Address.


        :return: The address4 of this Address.
        :rtype: str
        """
