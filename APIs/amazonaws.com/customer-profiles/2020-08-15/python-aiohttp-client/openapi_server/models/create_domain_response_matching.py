...
class CreateDomainResponseMatching(Model):
    ...
    def __init__(self, enabled: bool=None, job_schedule: UpdateDomainRequestMatchingJobSchedule=None, auto_merging: UpdateDomainRequestMatchingAutoMerging=None, exporting_config: UpdateDomainRequestMatchingExportingConfig=None):
        """CreateDomainResponseMatching - a model defined in OpenAPI

        :param enabled: The enabled of this CreateDomainResponseMatching.
        :param job_schedule: The job_schedule of this CreateDomainResponseMatching.
        :param auto_merging: The auto_merging of this CreateDomainResponseMatching.
        :param exporting_config: The exporting_config of this CreateDomainResponseMatching.
        """
        self.openapi_types = {
            'enabled': bool,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateDomainResponseMatching':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateDomainResponse_Matching of this CreateDomainResponseMatching.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def enabled(self):
        """Gets the enabled of this CreateDomainResponseMatching.


        :return: The enabled of this CreateDomainResponseMatching.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this CreateDomainResponseMatching.
    ...
    def job_schedule(self):
        """Gets the job_schedule of this CreateDomainResponseMatching.


        :return: The job_schedule of this CreateDomainResponseMatching.
    ...
    def job_schedule(self, job_schedule):
        """Sets the job_schedule of this CreateDomainResponseMatching.
    ...
    def auto_merging(self):
        """Gets the auto_merging of this CreateDomainResponseMatching.


        :return: The auto_merging of this CreateDomainResponseMatching.
    ...
    def auto_merging(self, auto_merging):
        """Sets the auto_merging of this CreateDomainResponseMatching.
    ...
    def exporting_config(self):
        """Gets the exporting_config of this CreateDomainResponseMatching.


        :return: The exporting_config of this CreateDomainResponseMatching.
    ...
    def exporting_config(self, exporting_config):
        """Sets the exporting_config of this CreateDomainResponseMatching.
