...
class MatchingRequest(Model):
    ...
    def __init__(self, enabled: bool=None, job_schedule: UpdateDomainRequestMatchingJobSchedule=None, auto_merging: UpdateDomainRequestMatchingAutoMerging=None, exporting_config: UpdateDomainRequestMatchingExportingConfig=None):
        """MatchingRequest - a model defined in OpenAPI

        :param enabled: The enabled of this MatchingRequest.
        :param job_schedule: The job_schedule of this MatchingRequest.
        :param auto_merging: The auto_merging of this MatchingRequest.
        :param exporting_config: The exporting_config of this MatchingRequest.
        """
        self.openapi_types = {
            'enabled': bool,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MatchingRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MatchingRequest of this MatchingRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def enabled(self):
        """Gets the enabled of this MatchingRequest.


        :return: The enabled of this MatchingRequest.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this MatchingRequest.
    ...
    def job_schedule(self):
        """Gets the job_schedule of this MatchingRequest.


        :return: The job_schedule of this MatchingRequest.
    ...
    def job_schedule(self, job_schedule):
        """Sets the job_schedule of this MatchingRequest.
    ...
    def auto_merging(self):
        """Gets the auto_merging of this MatchingRequest.


        :return: The auto_merging of this MatchingRequest.
    ...
    def auto_merging(self, auto_merging):
        """Sets the auto_merging of this MatchingRequest.
    ...
    def exporting_config(self):
        """Gets the exporting_config of this MatchingRequest.


        :return: The exporting_config of this MatchingRequest.
    ...
    def exporting_config(self, exporting_config):
        """Sets the exporting_config of this MatchingRequest.
