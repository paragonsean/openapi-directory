...
/*
 * OAIRuleBasedMatchingRequest.h
 *
 * The request to enable the rule-based matching.
 */

#ifndef OAIRuleBasedMatchingRequest_H
#define OAIRuleBasedMatchingRequest_H
...
class OAIRuleBasedMatchingRequest : public OAIObject {
public:
    OAIRuleBasedMatchingRequest();
    OAIRuleBasedMatchingRequest(QString json);
    ~OAIRuleBasedMatchingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleBasedMatchingRequest)

#endif // OAIRuleBasedMatchingRequest_H
