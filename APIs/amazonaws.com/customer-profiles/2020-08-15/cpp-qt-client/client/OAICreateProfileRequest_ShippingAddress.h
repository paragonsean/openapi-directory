...
/*
 * OAICreateProfileRequest_ShippingAddress.h
 *
 * 
 */

#ifndef OAICreateProfileRequest_ShippingAddress_H
#define OAICreateProfileRequest_ShippingAddress_H
...
class OAICreateProfileRequest_ShippingAddress : public OAIObject {
public:
    OAICreateProfileRequest_ShippingAddress();
    OAICreateProfileRequest_ShippingAddress(QString json);
    ~OAICreateProfileRequest_ShippingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProfileRequest_ShippingAddress)

#endif // OAICreateProfileRequest_ShippingAddress_H
