...
/*
 * OAIPutIntegrationResponse.h
 *
 * 
 */

#ifndef OAIPutIntegrationResponse_H
#define OAIPutIntegrationResponse_H
...
class OAIPutIntegrationResponse : public OAIObject {
public:
    OAIPutIntegrationResponse();
    OAIPutIntegrationResponse(QString json);
    ~OAIPutIntegrationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutIntegrationResponse)

#endif // OAIPutIntegrationResponse_H
