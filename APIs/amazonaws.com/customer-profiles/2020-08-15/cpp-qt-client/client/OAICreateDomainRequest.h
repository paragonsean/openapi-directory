...
namespace OpenAPI {
class OAICreateDomainRequest_Matching;
class OAICreateDomainRequest_RuleBasedMatching;
...
public:
    ...
    OAICreateDomainRequest_Matching getMatching() const;
    void setMatching(const OAICreateDomainRequest_Matching &matching);
    bool is_matching_Set() const;
    bool is_matching_Valid() const;

    OAICreateDomainRequest_RuleBasedMatching getRuleBasedMatching() const;
    void setRuleBasedMatching(const OAICreateDomainRequest_RuleBasedMatching &rule_based_matching);
...
private:
    ...
    OAICreateDomainRequest_Matching m_matching;
    bool m_matching_isSet;
    bool m_matching_isValid;

    OAICreateDomainRequest_RuleBasedMatching m_rule_based_matching;
