...
#ifndef OAIUpdateAddress_H
#define OAIUpdateAddress_H
...
class OAIUpdateAddress : public OAIObject {
public:
    OAIUpdateAddress();
    OAIUpdateAddress(QString json);
    ~OAIUpdateAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAddress)

#endif // OAIUpdateAddress_H
