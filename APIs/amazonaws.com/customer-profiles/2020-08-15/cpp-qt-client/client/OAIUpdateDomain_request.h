...
/*
 * OAIUpdateDomain_request.h
 *
 * 
 */

#ifndef OAIUpdateDomain_request_H
#define OAIUpdateDomain_request_H
...
namespace OpenAPI {
class OAIUpdateDomain_request_Matching;
class OAIUpdateDomain_request_RuleBasedMatching;

class OAIUpdateDomain_request : public OAIObject {
public:
    OAIUpdateDomain_request();
    OAIUpdateDomain_request(QString json);
    ~OAIUpdateDomain_request() override;
    ...
    OAIUpdateDomain_request_Matching getMatching() const;
    void setMatching(const OAIUpdateDomain_request_Matching &matching);
    bool is_matching_Set() const;
    bool is_matching_Valid() const;

    OAIUpdateDomain_request_RuleBasedMatching getRuleBasedMatching() const;
    void setRuleBasedMatching(const OAIUpdateDomain_request_RuleBasedMatching &rule_based_matching);
...
private:
    ...
    OAIUpdateDomain_request_Matching m_matching;
    bool m_matching_isSet;
    bool m_matching_isValid;

    OAIUpdateDomain_request_RuleBasedMatching m_rule_based_matching;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDomain_request)

#endif // OAIUpdateDomain_request_H
