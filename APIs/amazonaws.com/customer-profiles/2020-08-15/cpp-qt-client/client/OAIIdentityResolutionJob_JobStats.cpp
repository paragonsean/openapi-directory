...
OAIIdentityResolutionJob_JobStats::OAIIdentityResolutionJob_JobStats(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIdentityResolutionJob_JobStats::OAIIdentityResolutionJob_JobStats() {
    this->initializeModel();
}

OAIIdentityResolutionJob_JobStats::~OAIIdentityResolutionJob_JobStats() {}

void OAIIdentityResolutionJob_JobStats::initializeModel() {
...
void OAIIdentityResolutionJob_JobStats::fromJson(QString jsonString) {
...
void OAIIdentityResolutionJob_JobStats::fromJsonObject(QJsonObject json) {
...
QString OAIIdentityResolutionJob_JobStats::asJson() const {
...
QJsonObject OAIIdentityResolutionJob_JobStats::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIIdentityResolutionJob_JobStats::getNumberOfProfilesReviewed() const {
    return m_number_of_profiles_reviewed;
}
void OAIIdentityResolutionJob_JobStats::setNumberOfProfilesReviewed(const qint32 &number_of_profiles_reviewed) {
    m_number_of_profiles_reviewed = number_of_profiles_reviewed;
    m_number_of_profiles_reviewed_isSet = true;
}

bool OAIIdentityResolutionJob_JobStats::is_number_of_profiles_reviewed_Set() const{
    return m_number_of_profiles_reviewed_isSet;
}

bool OAIIdentityResolutionJob_JobStats::is_number_of_profiles_reviewed_Valid() const{
    return m_number_of_profiles_reviewed_isValid;
}

qint32 OAIIdentityResolutionJob_JobStats::getNumberOfMatchesFound() const {
    return m_number_of_matches_found;
}
void OAIIdentityResolutionJob_JobStats::setNumberOfMatchesFound(const qint32 &number_of_matches_found) {
    m_number_of_matches_found = number_of_matches_found;
    m_number_of_matches_found_isSet = true;
}

bool OAIIdentityResolutionJob_JobStats::is_number_of_matches_found_Set() const{
    return m_number_of_matches_found_isSet;
}

bool OAIIdentityResolutionJob_JobStats::is_number_of_matches_found_Valid() const{
    return m_number_of_matches_found_isValid;
}

qint32 OAIIdentityResolutionJob_JobStats::getNumberOfMergesDone() const {
    return m_number_of_merges_done;
}
void OAIIdentityResolutionJob_JobStats::setNumberOfMergesDone(const qint32 &number_of_merges_done) {
    m_number_of_merges_done = number_of_merges_done;
    m_number_of_merges_done_isSet = true;
}

bool OAIIdentityResolutionJob_JobStats::is_number_of_merges_done_Set() const{
    return m_number_of_merges_done_isSet;
}

bool OAIIdentityResolutionJob_JobStats::is_number_of_merges_done_Valid() const{
    return m_number_of_merges_done_isValid;
}

bool OAIIdentityResolutionJob_JobStats::isSet() const {
...
bool OAIIdentityResolutionJob_JobStats::isValid() const {
