...
/*
 * OAICreateProfile_request_Address.h
 *
 * A generic address associated with the customer that is not mailing, shipping, or billing.
 */

#ifndef OAICreateProfile_request_Address_H
#define OAICreateProfile_request_Address_H
...
class OAICreateProfile_request_Address : public OAIObject {
public:
    OAICreateProfile_request_Address();
    OAICreateProfile_request_Address(QString json);
    ~OAICreateProfile_request_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProfile_request_Address)

#endif // OAICreateProfile_request_Address_H
