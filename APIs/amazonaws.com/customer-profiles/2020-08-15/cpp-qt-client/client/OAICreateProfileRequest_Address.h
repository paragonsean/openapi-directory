...
/*
 * OAICreateProfileRequest_Address.h
 *
 * 
 */

#ifndef OAICreateProfileRequest_Address_H
#define OAICreateProfileRequest_Address_H
...
class OAICreateProfileRequest_Address : public OAIObject {
public:
    OAICreateProfileRequest_Address();
    OAICreateProfileRequest_Address(QString json);
    ~OAICreateProfileRequest_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProfileRequest_Address)

#endif // OAICreateProfileRequest_Address_H
