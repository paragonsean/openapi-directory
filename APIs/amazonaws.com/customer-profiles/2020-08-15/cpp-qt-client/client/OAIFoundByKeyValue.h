...
#ifndef OAIFoundByKeyValue_H
#define OAIFoundByKeyValue_H
...
class OAIFoundByKeyValue : public OAIObject {
public:
    OAIFoundByKeyValue();
    OAIFoundByKeyValue(QString json);
    ~OAIFoundByKeyValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFoundByKeyValue)

#endif // OAIFoundByKeyValue_H
