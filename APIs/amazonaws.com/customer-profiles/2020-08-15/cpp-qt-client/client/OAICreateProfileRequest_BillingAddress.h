...
/*
 * OAICreateProfileRequest_BillingAddress.h
 *
 * 
 */

#ifndef OAICreateProfileRequest_BillingAddress_H
#define OAICreateProfileRequest_BillingAddress_H
...
class OAICreateProfileRequest_BillingAddress : public OAIObject {
public:
    OAICreateProfileRequest_BillingAddress();
    OAICreateProfileRequest_BillingAddress(QString json);
    ~OAICreateProfileRequest_BillingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProfileRequest_BillingAddress)

#endif // OAICreateProfileRequest_BillingAddress_H
