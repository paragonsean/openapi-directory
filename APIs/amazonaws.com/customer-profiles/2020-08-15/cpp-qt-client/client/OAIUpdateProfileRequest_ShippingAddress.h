...
/*
 * OAIUpdateProfileRequest_ShippingAddress.h
 *
 * 
 */

#ifndef OAIUpdateProfileRequest_ShippingAddress_H
#define OAIUpdateProfileRequest_ShippingAddress_H
...
class OAIUpdateProfileRequest_ShippingAddress : public OAIObject {
public:
    OAIUpdateProfileRequest_ShippingAddress();
    OAIUpdateProfileRequest_ShippingAddress(QString json);
    ~OAIUpdateProfileRequest_ShippingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProfileRequest_ShippingAddress)

#endif // OAIUpdateProfileRequest_ShippingAddress_H
