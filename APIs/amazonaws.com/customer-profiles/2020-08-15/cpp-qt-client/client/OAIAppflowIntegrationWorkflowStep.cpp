...
#include "OAIAppflowIntegrationWorkflowStep.h"
...
OAIAppflowIntegrationWorkflowStep::OAIAppflowIntegrationWorkflowStep(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAppflowIntegrationWorkflowStep::OAIAppflowIntegrationWorkflowStep() {
    this->initializeModel();
}

OAIAppflowIntegrationWorkflowStep::~OAIAppflowIntegrationWorkflowStep() {}

void OAIAppflowIntegrationWorkflowStep::initializeModel() {
...
void OAIAppflowIntegrationWorkflowStep::fromJson(QString jsonString) {
...
void OAIAppflowIntegrationWorkflowStep::fromJsonObject(QJsonObject json) {
...
QString OAIAppflowIntegrationWorkflowStep::asJson() const {
...
QJsonObject OAIAppflowIntegrationWorkflowStep::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAppflowIntegrationWorkflowStep::getFlowName() const {
    return m_flow_name;
}
void OAIAppflowIntegrationWorkflowStep::setFlowName(const QString &flow_name) {
    m_flow_name = flow_name;
    m_flow_name_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_flow_name_Set() const{
    return m_flow_name_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_flow_name_Valid() const{
    return m_flow_name_isValid;
}

OAIStatus OAIAppflowIntegrationWorkflowStep::getStatus() const {
    return m_status;
}
void OAIAppflowIntegrationWorkflowStep::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIAppflowIntegrationWorkflowStep::getExecutionMessage() const {
    return m_execution_message;
}
void OAIAppflowIntegrationWorkflowStep::setExecutionMessage(const QString &execution_message) {
    m_execution_message = execution_message;
    m_execution_message_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_execution_message_Set() const{
    return m_execution_message_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_execution_message_Valid() const{
    return m_execution_message_isValid;
}

qint32 OAIAppflowIntegrationWorkflowStep::getRecordsProcessed() const {
    return m_records_processed;
}
void OAIAppflowIntegrationWorkflowStep::setRecordsProcessed(const qint32 &records_processed) {
    m_records_processed = records_processed;
    m_records_processed_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_records_processed_Set() const{
    return m_records_processed_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_records_processed_Valid() const{
    return m_records_processed_isValid;
}

QString OAIAppflowIntegrationWorkflowStep::getBatchRecordsStartTime() const {
    return m_batch_records_start_time;
}
void OAIAppflowIntegrationWorkflowStep::setBatchRecordsStartTime(const QString &batch_records_start_time) {
    m_batch_records_start_time = batch_records_start_time;
    m_batch_records_start_time_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_batch_records_start_time_Set() const{
    return m_batch_records_start_time_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_batch_records_start_time_Valid() const{
    return m_batch_records_start_time_isValid;
}

QString OAIAppflowIntegrationWorkflowStep::getBatchRecordsEndTime() const {
    return m_batch_records_end_time;
}
void OAIAppflowIntegrationWorkflowStep::setBatchRecordsEndTime(const QString &batch_records_end_time) {
    m_batch_records_end_time = batch_records_end_time;
    m_batch_records_end_time_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_batch_records_end_time_Set() const{
    return m_batch_records_end_time_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_batch_records_end_time_Valid() const{
    return m_batch_records_end_time_isValid;
}

QDateTime OAIAppflowIntegrationWorkflowStep::getCreatedAt() const {
    return m_created_at;
}
void OAIAppflowIntegrationWorkflowStep::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIAppflowIntegrationWorkflowStep::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIAppflowIntegrationWorkflowStep::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIAppflowIntegrationWorkflowStep::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIAppflowIntegrationWorkflowStep::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

bool OAIAppflowIntegrationWorkflowStep::isSet() const {
...
bool OAIAppflowIntegrationWorkflowStep::isValid() const {
