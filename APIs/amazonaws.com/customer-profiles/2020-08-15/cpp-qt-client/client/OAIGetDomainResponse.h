...
/*
 * OAIGetDomainResponse.h
 *
 * 
 */

#ifndef OAIGetDomainResponse_H
#define OAIGetDomainResponse_H
...
namespace OpenAPI {
class OAIGetDomainResponse_Stats;
class OAICreateDomainResponse_Matching;
class OAICreateDomainResponse_RuleBasedMatching;

class OAIGetDomainResponse : public OAIObject {
public:
    OAIGetDomainResponse();
    OAIGetDomainResponse(QString json);
    ~OAIGetDomainResponse() override;
    ...
    OAIGetDomainResponse_Stats getStats() const;
    void setStats(const OAIGetDomainResponse_Stats &stats);
...
private:
    ...
    OAIGetDomainResponse_Stats m_stats;
    bool m_stats_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDomainResponse)

#endif // OAIGetDomainResponse_H
