...
#include "OAIRuleBasedMatchingRequest.h"
...
OAIRuleBasedMatchingRequest::OAIRuleBasedMatchingRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleBasedMatchingRequest::OAIRuleBasedMatchingRequest() {
    this->initializeModel();
}

OAIRuleBasedMatchingRequest::~OAIRuleBasedMatchingRequest() {}

void OAIRuleBasedMatchingRequest::initializeModel() {
...
void OAIRuleBasedMatchingRequest::fromJson(QString jsonString) {
...
void OAIRuleBasedMatchingRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRuleBasedMatchingRequest::asJson() const {
...
QJsonObject OAIRuleBasedMatchingRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIRuleBasedMatchingRequest::getEnabled() const {
    return m_enabled;
}
void OAIRuleBasedMatchingRequest::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIRuleBasedMatchingRequest::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIRuleBasedMatchingRequest::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QList OAIRuleBasedMatchingRequest::getMatchingRules() const {
    return m_matching_rules;
}
void OAIRuleBasedMatchingRequest::setMatchingRules(const QList &matching_rules) {
    m_matching_rules = matching_rules;
    m_matching_rules_isSet = true;
}

bool OAIRuleBasedMatchingRequest::is_matching_rules_Set() const{
    return m_matching_rules_isSet;
}

bool OAIRuleBasedMatchingRequest::is_matching_rules_Valid() const{
    return m_matching_rules_isValid;
}

qint32 OAIRuleBasedMatchingRequest::getMaxAllowedRuleLevelForMerging() const {
    return m_max_allowed_rule_level_for_merging;
}
void OAIRuleBasedMatchingRequest::setMaxAllowedRuleLevelForMerging(const qint32 &max_allowed_rule_level_for_merging) {
    m_max_allowed_rule_level_for_merging = max_allowed_rule_level_for_merging;
    m_max_allowed_rule_level_for_merging_isSet = true;
}

bool OAIRuleBasedMatchingRequest::is_max_allowed_rule_level_for_merging_Set() const{
    return m_max_allowed_rule_level_for_merging_isSet;
}

bool OAIRuleBasedMatchingRequest::is_max_allowed_rule_level_for_merging_Valid() const{
    return m_max_allowed_rule_level_for_merging_isValid;
}

qint32 OAIRuleBasedMatchingRequest::getMaxAllowedRuleLevelForMatching() const {
    return m_max_allowed_rule_level_for_matching;
}
void OAIRuleBasedMatchingRequest::setMaxAllowedRuleLevelForMatching(const qint32 &max_allowed_rule_level_for_matching) {
...
bool OAIRuleBasedMatchingRequest::is_max_allowed_rule_level_for_matching_Set() const{
    return m_max_allowed_rule_level_for_matching_isSet;
}

bool OAIRuleBasedMatchingRequest::is_max_allowed_rule_level_for_matching_Valid() const{
    return m_max_allowed_rule_level_for_matching_isValid;
}

OAIUpdateDomain_request_RuleBasedMatching_AttributeTypesSelector OAIRuleBasedMatchingRequest::getAttributeTypesSelector() const {
    return m_attribute_types_selector;
}
void OAIRuleBasedMatchingRequest::setAttributeTypesSelector(const OAIUpdateDomain_request_RuleBasedMatching_AttributeTypesSelector &attribute_types_selector) {
    m_attribute_types_selector = attribute_types_selector;
    m_attribute_types_selector_isSet = true;
}

bool OAIRuleBasedMatchingRequest::is_attribute_types_selector_Set() const{
    return m_attribute_types_selector_isSet;
}

bool OAIRuleBasedMatchingRequest::is_attribute_types_selector_Valid() const{
    return m_attribute_types_selector_isValid;
}

OAIConflictResolution OAIRuleBasedMatchingRequest::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAIRuleBasedMatchingRequest::setConflictResolution(const OAIConflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAIRuleBasedMatchingRequest::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAIRuleBasedMatchingRequest::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

OAIExportingConfig OAIRuleBasedMatchingRequest::getExportingConfig() const {
    return m_exporting_config;
}
void OAIRuleBasedMatchingRequest::setExportingConfig(const OAIExportingConfig &exporting_config) {
    m_exporting_config = exporting_config;
    m_exporting_config_isSet = true;
}

bool OAIRuleBasedMatchingRequest::is_exporting_config_Set() const{
    return m_exporting_config_isSet;
}

bool OAIRuleBasedMatchingRequest::is_exporting_config_Valid() const{
    return m_exporting_config_isValid;
}

bool OAIRuleBasedMatchingRequest::isSet() const {
...
bool OAIRuleBasedMatchingRequest::isValid() const {
