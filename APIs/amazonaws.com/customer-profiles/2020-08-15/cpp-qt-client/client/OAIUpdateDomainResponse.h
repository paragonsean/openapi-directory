...
class OAIUpdateDomainResponse_RuleBasedMatching;
...
public:
    ...
    OAIUpdateDomainResponse_RuleBasedMatching getRuleBasedMatching() const;
    void setRuleBasedMatching(const OAIUpdateDomainResponse_RuleBasedMatching &rule_based_matching);
...
private:
    ...
    OAIUpdateDomainResponse_RuleBasedMatching m_rule_based_matching;
