...
/*
 * OAIDeleteProfileKey_request.h
 *
 * 
 */

#ifndef OAIDeleteProfileKey_request_H
#define OAIDeleteProfileKey_request_H
...
class OAIDeleteProfileKey_request : public OAIObject {
public:
    OAIDeleteProfileKey_request();
    OAIDeleteProfileKey_request(QString json);
    ~OAIDeleteProfileKey_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteProfileKey_request)

#endif // OAIDeleteProfileKey_request_H
