...
/*
 * OAIUpdateProfile_request_Address.h
 *
 * Updates associated with the address properties of a customer profile.
 */

#ifndef OAIUpdateProfile_request_Address_H
#define OAIUpdateProfile_request_Address_H
...
class OAIUpdateProfile_request_Address : public OAIObject {
public:
    OAIUpdateProfile_request_Address();
    OAIUpdateProfile_request_Address(QString json);
    ~OAIUpdateProfile_request_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProfile_request_Address)

#endif // OAIUpdateProfile_request_Address_H
