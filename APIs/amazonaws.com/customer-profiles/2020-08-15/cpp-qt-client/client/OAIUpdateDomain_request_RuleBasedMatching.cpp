...
#include "OAIUpdateDomain_request_RuleBasedMatching.h"
...
OAIUpdateDomain_request_RuleBasedMatching::OAIUpdateDomain_request_RuleBasedMatching(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDomain_request_RuleBasedMatching::OAIUpdateDomain_request_RuleBasedMatching() {
    this->initializeModel();
}

OAIUpdateDomain_request_RuleBasedMatching::~OAIUpdateDomain_request_RuleBasedMatching() {}

void OAIUpdateDomain_request_RuleBasedMatching::initializeModel() {
...
void OAIUpdateDomain_request_RuleBasedMatching::fromJson(QString jsonString) {
...
void OAIUpdateDomain_request_RuleBasedMatching::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDomain_request_RuleBasedMatching::asJson() const {
...
QJsonObject OAIUpdateDomain_request_RuleBasedMatching::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIUpdateDomain_request_RuleBasedMatching::getEnabled() const {
    return m_enabled;
}
void OAIUpdateDomain_request_RuleBasedMatching::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QList OAIUpdateDomain_request_RuleBasedMatching::getMatchingRules() const {
    return m_matching_rules;
}
void OAIUpdateDomain_request_RuleBasedMatching::setMatchingRules(const QList &matching_rules) {
    m_matching_rules = matching_rules;
    m_matching_rules_isSet = true;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_matching_rules_Set() const{
    return m_matching_rules_isSet;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_matching_rules_Valid() const{
    return m_matching_rules_isValid;
}

qint32 OAIUpdateDomain_request_RuleBasedMatching::getMaxAllowedRuleLevelForMerging() const {
    return m_max_allowed_rule_level_for_merging;
}
void OAIUpdateDomain_request_RuleBasedMatching::setMaxAllowedRuleLevelForMerging(const qint32 &max_allowed_rule_level_for_merging) {
    m_max_allowed_rule_level_for_merging = max_allowed_rule_level_for_merging;
    m_max_allowed_rule_level_for_merging_isSet = true;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_max_allowed_rule_level_for_merging_Set() const{
    return m_max_allowed_rule_level_for_merging_isSet;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_max_allowed_rule_level_for_merging_Valid() const{
    return m_max_allowed_rule_level_for_merging_isValid;
}

qint32 OAIUpdateDomain_request_RuleBasedMatching::getMaxAllowedRuleLevelForMatching() const {
    return m_max_allowed_rule_level_for_matching;
}
void OAIUpdateDomain_request_RuleBasedMatching::setMaxAllowedRuleLevelForMatching(const qint32 &max_allowed_rule_level_for_matching) {
...
bool OAIUpdateDomain_request_RuleBasedMatching::is_max_allowed_rule_level_for_matching_Set() const{
    return m_max_allowed_rule_level_for_matching_isSet;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_max_allowed_rule_level_for_matching_Valid() const{
    return m_max_allowed_rule_level_for_matching_isValid;
}

OAIUpdateDomain_request_RuleBasedMatching_AttributeTypesSelector OAIUpdateDomain_request_RuleBasedMatching::getAttributeTypesSelector() const {
    return m_attribute_types_selector;
}
void OAIUpdateDomain_request_RuleBasedMatching::setAttributeTypesSelector(const OAIUpdateDomain_request_RuleBasedMatching_AttributeTypesSelector &attribute_types_selector) {
    m_attribute_types_selector = attribute_types_selector;
    m_attribute_types_selector_isSet = true;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_attribute_types_selector_Set() const{
    return m_attribute_types_selector_isSet;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_attribute_types_selector_Valid() const{
    return m_attribute_types_selector_isValid;
}

OAIConflictResolution OAIUpdateDomain_request_RuleBasedMatching::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAIUpdateDomain_request_RuleBasedMatching::setConflictResolution(const OAIConflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

OAIExportingConfig OAIUpdateDomain_request_RuleBasedMatching::getExportingConfig() const {
    return m_exporting_config;
}
void OAIUpdateDomain_request_RuleBasedMatching::setExportingConfig(const OAIExportingConfig &exporting_config) {
    m_exporting_config = exporting_config;
    m_exporting_config_isSet = true;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_exporting_config_Set() const{
    return m_exporting_config_isSet;
}

bool OAIUpdateDomain_request_RuleBasedMatching::is_exporting_config_Valid() const{
    return m_exporting_config_isValid;
}

bool OAIUpdateDomain_request_RuleBasedMatching::isSet() const {
...
bool OAIUpdateDomain_request_RuleBasedMatching::isValid() const {
