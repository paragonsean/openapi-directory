...
/*
 * OAIFieldSourceProfileIds.h
 *
 * A duplicate customer profile that is to be merged into a main profile. 
 */

#ifndef OAIFieldSourceProfileIds_H
#define OAIFieldSourceProfileIds_H
...
class OAIFieldSourceProfileIds : public OAIObject {
public:
    OAIFieldSourceProfileIds();
    OAIFieldSourceProfileIds(QString json);
    ~OAIFieldSourceProfileIds() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldSourceProfileIds)

#endif // OAIFieldSourceProfileIds_H
