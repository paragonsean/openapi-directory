...
/*
 * OAICreateProfileRequest_MailingAddress.h
 *
 * 
 */

#ifndef OAICreateProfileRequest_MailingAddress_H
#define OAICreateProfileRequest_MailingAddress_H
...
class OAICreateProfileRequest_MailingAddress : public OAIObject {
public:
    OAICreateProfileRequest_MailingAddress();
    OAICreateProfileRequest_MailingAddress(QString json);
    ~OAICreateProfileRequest_MailingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProfileRequest_MailingAddress)

#endif // OAICreateProfileRequest_MailingAddress_H
