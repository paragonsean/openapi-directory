...
/*
 * OAIUpdateDomain_request_RuleBasedMatching.h
 *
 * The request to enable the rule-based matching.
 */

#ifndef OAIUpdateDomain_request_RuleBasedMatching_H
#define OAIUpdateDomain_request_RuleBasedMatching_H
...
class OAIUpdateDomain_request_RuleBasedMatching : public OAIObject {
public:
    OAIUpdateDomain_request_RuleBasedMatching();
    OAIUpdateDomain_request_RuleBasedMatching(QString json);
    ~OAIUpdateDomain_request_RuleBasedMatching() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDomain_request_RuleBasedMatching)

#endif // OAIUpdateDomain_request_RuleBasedMatching_H
