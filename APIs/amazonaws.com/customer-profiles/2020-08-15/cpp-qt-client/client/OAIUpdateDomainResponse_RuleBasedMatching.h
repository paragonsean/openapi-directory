...
/*
 * OAIUpdateDomainResponse_RuleBasedMatching.h
 *
 * 
 */

#ifndef OAIUpdateDomainResponse_RuleBasedMatching_H
#define OAIUpdateDomainResponse_RuleBasedMatching_H
...
class OAIUpdateDomainResponse_RuleBasedMatching : public OAIObject {
public:
    OAIUpdateDomainResponse_RuleBasedMatching();
    OAIUpdateDomainResponse_RuleBasedMatching(QString json);
    ~OAIUpdateDomainResponse_RuleBasedMatching() override;
    ...
    OAIRuleBasedMatchingStatus getStatus() const;
    void setStatus(const OAIRuleBasedMatchingStatus &status);
...
private:
    ...
    OAIRuleBasedMatchingStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDomainResponse_RuleBasedMatching)

#endif // OAIUpdateDomainResponse_RuleBasedMatching_H
