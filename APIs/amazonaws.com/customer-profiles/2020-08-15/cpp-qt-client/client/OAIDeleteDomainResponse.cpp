...
QString OAIDeleteDomainResponse::getMessage() const {
    return m_message;
}
void OAIDeleteDomainResponse::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDeleteDomainResponse::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDeleteDomainResponse::is_message_Valid() const{
