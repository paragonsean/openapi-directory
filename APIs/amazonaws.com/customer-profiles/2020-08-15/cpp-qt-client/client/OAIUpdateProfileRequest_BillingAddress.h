...
/*
 * OAIUpdateProfileRequest_BillingAddress.h
 *
 * 
 */

#ifndef OAIUpdateProfileRequest_BillingAddress_H
#define OAIUpdateProfileRequest_BillingAddress_H
...
class OAIUpdateProfileRequest_BillingAddress : public OAIObject {
public:
    OAIUpdateProfileRequest_BillingAddress();
    OAIUpdateProfileRequest_BillingAddress(QString json);
    ~OAIUpdateProfileRequest_BillingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProfileRequest_BillingAddress)

#endif // OAIUpdateProfileRequest_BillingAddress_H
