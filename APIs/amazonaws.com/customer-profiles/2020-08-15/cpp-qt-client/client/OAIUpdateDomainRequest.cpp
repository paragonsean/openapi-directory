...
qint32 OAIUpdateDomainRequest::getDefaultExpirationDays() const {
    return m_default_expiration_days;
}
void OAIUpdateDomainRequest::setDefaultExpirationDays(const qint32 &default_expiration_days) {
    m_default_expiration_days = default_expiration_days;
    m_default_expiration_days_isSet = true;
}

bool OAIUpdateDomainRequest::is_default_expiration_days_Set() const{
    return m_default_expiration_days_isSet;
}

bool OAIUpdateDomainRequest::is_default_expiration_days_Valid() const{
    return m_default_expiration_days_isValid;
}

QString OAIUpdateDomainRequest::getDefaultEncryptionKey() const {
    return m_default_encryption_key;
}
void OAIUpdateDomainRequest::setDefaultEncryptionKey(const QString &default_encryption_key) {
    m_default_encryption_key = default_encryption_key;
    m_default_encryption_key_isSet = true;
}

bool OAIUpdateDomainRequest::is_default_encryption_key_Set() const{
    return m_default_encryption_key_isSet;
}

bool OAIUpdateDomainRequest::is_default_encryption_key_Valid() const{
    return m_default_encryption_key_isValid;
}

QString OAIUpdateDomainRequest::getDeadLetterQueueUrl() const {
    return m_dead_letter_queue_url;
}
void OAIUpdateDomainRequest::setDeadLetterQueueUrl(const QString &dead_letter_queue_url) {
    m_dead_letter_queue_url = dead_letter_queue_url;
    m_dead_letter_queue_url_isSet = true;
}

bool OAIUpdateDomainRequest::is_dead_letter_queue_url_Set() const{
    return m_dead_letter_queue_url_isSet;
}

bool OAIUpdateDomainRequest::is_dead_letter_queue_url_Valid() const{
    return m_dead_letter_queue_url_isValid;
}

OAICreateDomainRequest_Matching OAIUpdateDomainRequest::getMatching() const {
    return m_matching;
}
void OAIUpdateDomainRequest::setMatching(const OAICreateDomainRequest_Matching &matching) {
    m_matching = matching;
    m_matching_isSet = true;
}

bool OAIUpdateDomainRequest::is_matching_Set() const{
    return m_matching_isSet;
}

bool OAIUpdateDomainRequest::is_matching_Valid() const{
    return m_matching_isValid;
}

OAIUpdateDomainRequest_RuleBasedMatching OAIUpdateDomainRequest::getRuleBasedMatching() const {
    return m_rule_based_matching;
}
void OAIUpdateDomainRequest::setRuleBasedMatching(const OAIUpdateDomainRequest_RuleBasedMatching &rule_based_matching) {
    m_rule_based_matching = rule_based_matching;
    m_rule_based_matching_isSet = true;
}

bool OAIUpdateDomainRequest::is_rule_based_matching_Set() const{
    return m_rule_based_matching_isSet;
}

bool OAIUpdateDomainRequest::is_rule_based_matching_Valid() const{
    return m_rule_based_matching_isValid;
}

QMap OAIUpdateDomainRequest::getTags() const {
    return m_tags;
}
void OAIUpdateDomainRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateDomainRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateDomainRequest::is_tags_Valid() const{
