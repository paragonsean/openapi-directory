...
/*
 * OAIUpdateProfileRequest_MailingAddress.h
 *
 * 
 */

#ifndef OAIUpdateProfileRequest_MailingAddress_H
#define OAIUpdateProfileRequest_MailingAddress_H
...
class OAIUpdateProfileRequest_MailingAddress : public OAIObject {
public:
    OAIUpdateProfileRequest_MailingAddress();
    OAIUpdateProfileRequest_MailingAddress(QString json);
    ~OAIUpdateProfileRequest_MailingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProfileRequest_MailingAddress)

#endif // OAIUpdateProfileRequest_MailingAddress_H
