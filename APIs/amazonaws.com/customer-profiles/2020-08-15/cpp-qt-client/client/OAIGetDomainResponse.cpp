...
OAIGetDomainResponse::OAIGetDomainResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDomainResponse::OAIGetDomainResponse() {
    this->initializeModel();
}

OAIGetDomainResponse::~OAIGetDomainResponse() {}

void OAIGetDomainResponse::initializeModel() {
...
void OAIGetDomainResponse::fromJson(QString jsonString) {
...
void OAIGetDomainResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetDomainResponse::asJson() const {
...
QJsonObject OAIGetDomainResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDomainResponse::getDomainName() const {
    return m_domain_name;
}
void OAIGetDomainResponse::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIGetDomainResponse::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIGetDomainResponse::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

qint32 OAIGetDomainResponse::getDefaultExpirationDays() const {
    return m_default_expiration_days;
}
void OAIGetDomainResponse::setDefaultExpirationDays(const qint32 &default_expiration_days) {
    m_default_expiration_days = default_expiration_days;
    m_default_expiration_days_isSet = true;
}

bool OAIGetDomainResponse::is_default_expiration_days_Set() const{
    return m_default_expiration_days_isSet;
}

bool OAIGetDomainResponse::is_default_expiration_days_Valid() const{
    return m_default_expiration_days_isValid;
}

QString OAIGetDomainResponse::getDefaultEncryptionKey() const {
    return m_default_encryption_key;
}
void OAIGetDomainResponse::setDefaultEncryptionKey(const QString &default_encryption_key) {
    m_default_encryption_key = default_encryption_key;
    m_default_encryption_key_isSet = true;
}

bool OAIGetDomainResponse::is_default_encryption_key_Set() const{
    return m_default_encryption_key_isSet;
}

bool OAIGetDomainResponse::is_default_encryption_key_Valid() const{
    return m_default_encryption_key_isValid;
}

QString OAIGetDomainResponse::getDeadLetterQueueUrl() const {
    return m_dead_letter_queue_url;
}
void OAIGetDomainResponse::setDeadLetterQueueUrl(const QString &dead_letter_queue_url) {
    m_dead_letter_queue_url = dead_letter_queue_url;
    m_dead_letter_queue_url_isSet = true;
}

bool OAIGetDomainResponse::is_dead_letter_queue_url_Set() const{
    return m_dead_letter_queue_url_isSet;
}

bool OAIGetDomainResponse::is_dead_letter_queue_url_Valid() const{
    return m_dead_letter_queue_url_isValid;
}

OAIGetDomainResponse_Stats OAIGetDomainResponse::getStats() const {
    return m_stats;
}
void OAIGetDomainResponse::setStats(const OAIGetDomainResponse_Stats &stats) {
    m_stats = stats;
    m_stats_isSet = true;
}

bool OAIGetDomainResponse::is_stats_Set() const{
    return m_stats_isSet;
}

bool OAIGetDomainResponse::is_stats_Valid() const{
    return m_stats_isValid;
}

OAICreateDomainResponse_Matching OAIGetDomainResponse::getMatching() const {
    return m_matching;
}
void OAIGetDomainResponse::setMatching(const OAICreateDomainResponse_Matching &matching) {
    m_matching = matching;
    m_matching_isSet = true;
}

bool OAIGetDomainResponse::is_matching_Set() const{
    return m_matching_isSet;
}

bool OAIGetDomainResponse::is_matching_Valid() const{
    return m_matching_isValid;
}

OAICreateDomainResponse_RuleBasedMatching OAIGetDomainResponse::getRuleBasedMatching() const {
    return m_rule_based_matching;
}
void OAIGetDomainResponse::setRuleBasedMatching(const OAICreateDomainResponse_RuleBasedMatching &rule_based_matching) {
    m_rule_based_matching = rule_based_matching;
    m_rule_based_matching_isSet = true;
}

bool OAIGetDomainResponse::is_rule_based_matching_Set() const{
    return m_rule_based_matching_isSet;
}

bool OAIGetDomainResponse::is_rule_based_matching_Valid() const{
    return m_rule_based_matching_isValid;
}

QDateTime OAIGetDomainResponse::getCreatedAt() const {
    return m_created_at;
}
void OAIGetDomainResponse::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetDomainResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetDomainResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIGetDomainResponse::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIGetDomainResponse::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIGetDomainResponse::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIGetDomainResponse::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

QMap OAIGetDomainResponse::getTags() const {
    return m_tags;
}
void OAIGetDomainResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetDomainResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetDomainResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIGetDomainResponse::isSet() const {
...
bool OAIGetDomainResponse::isValid() const {
