...
class OAIUpdateDomainRequest_RuleBasedMatching;
...
public:
    ...
    OAIUpdateDomainRequest_RuleBasedMatching getRuleBasedMatching() const;
    void setRuleBasedMatching(const OAIUpdateDomainRequest_RuleBasedMatching &rule_based_matching);
...
private:
    ...
    OAIUpdateDomainRequest_RuleBasedMatching m_rule_based_matching;
