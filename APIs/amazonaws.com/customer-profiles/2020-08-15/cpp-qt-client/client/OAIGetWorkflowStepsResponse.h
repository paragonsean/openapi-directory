...
/*
 * OAIGetWorkflowStepsResponse.h
 *
 * 
 */

#ifndef OAIGetWorkflowStepsResponse_H
#define OAIGetWorkflowStepsResponse_H
...
class OAIGetWorkflowStepsResponse : public OAIObject {
public:
    OAIGetWorkflowStepsResponse();
    OAIGetWorkflowStepsResponse(QString json);
    ~OAIGetWorkflowStepsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWorkflowStepsResponse)

#endif // OAIGetWorkflowStepsResponse_H
