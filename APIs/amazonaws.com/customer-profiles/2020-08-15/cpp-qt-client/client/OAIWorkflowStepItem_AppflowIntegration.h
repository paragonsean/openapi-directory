...
/*
 * OAIWorkflowStepItem_AppflowIntegration.h
 *
 * 
 */

#ifndef OAIWorkflowStepItem_AppflowIntegration_H
#define OAIWorkflowStepItem_AppflowIntegration_H
...
class OAIWorkflowStepItem_AppflowIntegration : public OAIObject {
public:
    OAIWorkflowStepItem_AppflowIntegration();
    OAIWorkflowStepItem_AppflowIntegration(QString json);
    ~OAIWorkflowStepItem_AppflowIntegration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowStepItem_AppflowIntegration)

#endif // OAIWorkflowStepItem_AppflowIntegration_H
