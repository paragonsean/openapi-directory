...
/*
 * OAICreateDomainRequest_RuleBasedMatching.h
 *
 * 
 */

#ifndef OAICreateDomainRequest_RuleBasedMatching_H
#define OAICreateDomainRequest_RuleBasedMatching_H
...
class OAICreateDomainRequest_RuleBasedMatching : public OAIObject {
public:
    OAICreateDomainRequest_RuleBasedMatching();
    OAICreateDomainRequest_RuleBasedMatching(QString json);
    ~OAICreateDomainRequest_RuleBasedMatching() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainRequest_RuleBasedMatching)

#endif // OAICreateDomainRequest_RuleBasedMatching_H
