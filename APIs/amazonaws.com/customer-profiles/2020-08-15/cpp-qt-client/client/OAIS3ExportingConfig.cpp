...
#include "OAIS3ExportingConfig.h"
...
OAIS3ExportingConfig::OAIS3ExportingConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3ExportingConfig::OAIS3ExportingConfig() {
    this->initializeModel();
}

OAIS3ExportingConfig::~OAIS3ExportingConfig() {}

void OAIS3ExportingConfig::initializeModel() {
...
void OAIS3ExportingConfig::fromJson(QString jsonString) {
...
void OAIS3ExportingConfig::fromJsonObject(QJsonObject json) {
...
QString OAIS3ExportingConfig::asJson() const {
...
QJsonObject OAIS3ExportingConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIS3ExportingConfig::getS3BucketName() const {
    return m_s3_bucket_name;
}
void OAIS3ExportingConfig::setS3BucketName(const QString &s3_bucket_name) {
    m_s3_bucket_name = s3_bucket_name;
    m_s3_bucket_name_isSet = true;
}

bool OAIS3ExportingConfig::is_s3_bucket_name_Set() const{
    return m_s3_bucket_name_isSet;
}

bool OAIS3ExportingConfig::is_s3_bucket_name_Valid() const{
    return m_s3_bucket_name_isValid;
}

QString OAIS3ExportingConfig::getS3KeyName() const {
    return m_s3_key_name;
}
void OAIS3ExportingConfig::setS3KeyName(const QString &s3_key_name) {
    m_s3_key_name = s3_key_name;
    m_s3_key_name_isSet = true;
}

bool OAIS3ExportingConfig::is_s3_key_name_Set() const{
    return m_s3_key_name_isSet;
}

bool OAIS3ExportingConfig::is_s3_key_name_Valid() const{
    return m_s3_key_name_isValid;
}

bool OAIS3ExportingConfig::isSet() const {
...
bool OAIS3ExportingConfig::isValid() const {
