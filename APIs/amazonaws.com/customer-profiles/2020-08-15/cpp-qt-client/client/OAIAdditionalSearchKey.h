...
#ifndef OAIAdditionalSearchKey_H
#define OAIAdditionalSearchKey_H
...
class OAIAdditionalSearchKey : public OAIObject {
public:
    OAIAdditionalSearchKey();
    OAIAdditionalSearchKey(QString json);
    ~OAIAdditionalSearchKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdditionalSearchKey)

#endif // OAIAdditionalSearchKey_H
