...
void OAIProfile::initializeModel() {
    ...
    m_found_by_items_isSet = false;
    m_found_by_items_isValid = false;
...
void OAIProfile::fromJsonObject(QJsonObject json) {
    ...
    m_found_by_items_isValid = ::OpenAPI::fromJsonValue(m_found_by_items, json[QString("FoundByItems")]);
    m_found_by_items_isSet = !json[QString("FoundByItems")].isNull() && m_found_by_items_isValid;
...
QJsonObject OAIProfile::asJsonObject() const {
    ...
    if (m_found_by_items.isSet()) {
        obj.insert(QString("FoundByItems"), ::OpenAPI::toJsonValue(m_found_by_items));
    }
...
QString OAIProfile::getAccountNumber() const {
    return m_account_number;
}
void OAIProfile::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIProfile::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIProfile::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIProfile::getAdditionalInformation() const {
    return m_additional_information;
}
void OAIProfile::setAdditionalInformation(const QString &additional_information) {
    m_additional_information = additional_information;
    m_additional_information_isSet = true;
}

bool OAIProfile::is_additional_information_Set() const{
    return m_additional_information_isSet;
}

bool OAIProfile::is_additional_information_Valid() const{
    return m_additional_information_isValid;
}

OAIPartyType OAIProfile::getPartyType() const {
    return m_party_type;
}
void OAIProfile::setPartyType(const OAIPartyType &party_type) {
    m_party_type = party_type;
    m_party_type_isSet = true;
}

bool OAIProfile::is_party_type_Set() const{
    return m_party_type_isSet;
}

bool OAIProfile::is_party_type_Valid() const{
    return m_party_type_isValid;
}

QString OAIProfile::getBusinessName() const {
    return m_business_name;
}
void OAIProfile::setBusinessName(const QString &business_name) {
    m_business_name = business_name;
    m_business_name_isSet = true;
}

bool OAIProfile::is_business_name_Set() const{
    return m_business_name_isSet;
}

bool OAIProfile::is_business_name_Valid() const{
...
QString OAIProfile::getMiddleName() const {
    return m_middle_name;
}
void OAIProfile::setMiddleName(const QString &middle_name) {
    m_middle_name = middle_name;
    m_middle_name_isSet = true;
}

bool OAIProfile::is_middle_name_Set() const{
    return m_middle_name_isSet;
}

bool OAIProfile::is_middle_name_Valid() const{
...
OAIGender OAIProfile::getGender() const {
    return m_gender;
}
void OAIProfile::setGender(const OAIGender &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIProfile::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIProfile::is_gender_Valid() const{
    return m_gender_isValid;
}

QString OAIProfile::getPhoneNumber() const {
    return m_phone_number;
}
void OAIProfile::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIProfile::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIProfile::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

QString OAIProfile::getMobilePhoneNumber() const {
    return m_mobile_phone_number;
}
void OAIProfile::setMobilePhoneNumber(const QString &mobile_phone_number) {
    m_mobile_phone_number = mobile_phone_number;
    m_mobile_phone_number_isSet = true;
}

bool OAIProfile::is_mobile_phone_number_Set() const{
    return m_mobile_phone_number_isSet;
}

bool OAIProfile::is_mobile_phone_number_Valid() const{
    return m_mobile_phone_number_isValid;
}

QString OAIProfile::getHomePhoneNumber() const {
    return m_home_phone_number;
}
void OAIProfile::setHomePhoneNumber(const QString &home_phone_number) {
    m_home_phone_number = home_phone_number;
    m_home_phone_number_isSet = true;
}

bool OAIProfile::is_home_phone_number_Set() const{
    return m_home_phone_number_isSet;
}

bool OAIProfile::is_home_phone_number_Valid() const{
    return m_home_phone_number_isValid;
}

QString OAIProfile::getBusinessPhoneNumber() const {
    return m_business_phone_number;
}
void OAIProfile::setBusinessPhoneNumber(const QString &business_phone_number) {
    m_business_phone_number = business_phone_number;
    m_business_phone_number_isSet = true;
}

bool OAIProfile::is_business_phone_number_Set() const{
    return m_business_phone_number_isSet;
}

bool OAIProfile::is_business_phone_number_Valid() const{
...
QString OAIProfile::getPersonalEmailAddress() const {
    return m_personal_email_address;
}
void OAIProfile::setPersonalEmailAddress(const QString &personal_email_address) {
    m_personal_email_address = personal_email_address;
    m_personal_email_address_isSet = true;
}

bool OAIProfile::is_personal_email_address_Set() const{
    return m_personal_email_address_isSet;
}

bool OAIProfile::is_personal_email_address_Valid() const{
    return m_personal_email_address_isValid;
}

QString OAIProfile::getBusinessEmailAddress() const {
    return m_business_email_address;
}
void OAIProfile::setBusinessEmailAddress(const QString &business_email_address) {
    m_business_email_address = business_email_address;
    m_business_email_address_isSet = true;
}

bool OAIProfile::is_business_email_address_Set() const{
    return m_business_email_address_isSet;
}

bool OAIProfile::is_business_email_address_Valid() const{
    return m_business_email_address_isValid;
}

OAICreateProfileRequest_Address OAIProfile::getAddress() const {
    return m_address;
}
void OAIProfile::setAddress(const OAICreateProfileRequest_Address &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIProfile::is_address_Set() const{
    return m_address_isSet;
}

bool OAIProfile::is_address_Valid() const{
    return m_address_isValid;
}

OAICreateProfileRequest_ShippingAddress OAIProfile::getShippingAddress() const {
    return m_shipping_address;
}
void OAIProfile::setShippingAddress(const OAICreateProfileRequest_ShippingAddress &shipping_address) {
    m_shipping_address = shipping_address;
    m_shipping_address_isSet = true;
}

bool OAIProfile::is_shipping_address_Set() const{
    return m_shipping_address_isSet;
}

bool OAIProfile::is_shipping_address_Valid() const{
    return m_shipping_address_isValid;
}

OAICreateProfileRequest_MailingAddress OAIProfile::getMailingAddress() const {
    return m_mailing_address;
}
void OAIProfile::setMailingAddress(const OAICreateProfileRequest_MailingAddress &mailing_address) {
    m_mailing_address = mailing_address;
    m_mailing_address_isSet = true;
}

bool OAIProfile::is_mailing_address_Set() const{
    return m_mailing_address_isSet;
}

bool OAIProfile::is_mailing_address_Valid() const{
    return m_mailing_address_isValid;
}

OAICreateProfileRequest_BillingAddress OAIProfile::getBillingAddress() const {
    return m_billing_address;
}
void OAIProfile::setBillingAddress(const OAICreateProfileRequest_BillingAddress &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIProfile::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIProfile::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QMap OAIProfile::getAttributes() const {
    return m_attributes;
}
void OAIProfile::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIProfile::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIProfile::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList OAIProfile::getFoundByItems() const {
    return m_found_by_items;
}
void OAIProfile::setFoundByItems(const QList &found_by_items) {
    m_found_by_items = found_by_items;
    m_found_by_items_isSet = true;
}

bool OAIProfile::is_found_by_items_Set() const{
    return m_found_by_items_isSet;
}

bool OAIProfile::is_found_by_items_Valid() const{
    return m_found_by_items_isValid;
}

QString OAIProfile::getPartyTypeString() const {
    return m_party_type_string;
}
void OAIProfile::setPartyTypeString(const QString &party_type_string) {
    m_party_type_string = party_type_string;
    m_party_type_string_isSet = true;
}

bool OAIProfile::is_party_type_string_Set() const{
    return m_party_type_string_isSet;
}

bool OAIProfile::is_party_type_string_Valid() const{
    return m_party_type_string_isValid;
}

QString OAIProfile::getGenderString() const {
    return m_gender_string;
}
void OAIProfile::setGenderString(const QString &gender_string) {
    m_gender_string = gender_string;
    m_gender_string_isSet = true;
}

bool OAIProfile::is_gender_string_Set() const{
    return m_gender_string_isSet;
}

bool OAIProfile::is_gender_string_Valid() const{
