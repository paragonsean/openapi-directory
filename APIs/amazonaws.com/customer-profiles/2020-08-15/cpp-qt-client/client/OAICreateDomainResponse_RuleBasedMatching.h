...
/*
 * OAICreateDomainResponse_RuleBasedMatching.h
 *
 * 
 */

#ifndef OAICreateDomainResponse_RuleBasedMatching_H
#define OAICreateDomainResponse_RuleBasedMatching_H
...
class OAICreateDomainResponse_RuleBasedMatching : public OAIObject {
public:
    OAICreateDomainResponse_RuleBasedMatching();
    OAICreateDomainResponse_RuleBasedMatching(QString json);
    ~OAICreateDomainResponse_RuleBasedMatching() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainResponse_RuleBasedMatching)

#endif // OAICreateDomainResponse_RuleBasedMatching_H
