...
/*
 * OAIDeleteProfileKeyRequest.h
 *
 * 
 */

#ifndef OAIDeleteProfileKeyRequest_H
#define OAIDeleteProfileKeyRequest_H
...
class OAIDeleteProfileKeyRequest : public OAIObject {
public:
    OAIDeleteProfileKeyRequest();
    OAIDeleteProfileKeyRequest(QString json);
    ~OAIDeleteProfileKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteProfileKeyRequest)

#endif // OAIDeleteProfileKeyRequest_H
