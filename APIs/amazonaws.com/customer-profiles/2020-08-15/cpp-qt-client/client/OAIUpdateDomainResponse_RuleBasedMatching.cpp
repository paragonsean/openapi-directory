...
#include "OAIUpdateDomainResponse_RuleBasedMatching.h"
...
OAIUpdateDomainResponse_RuleBasedMatching::OAIUpdateDomainResponse_RuleBasedMatching(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDomainResponse_RuleBasedMatching::OAIUpdateDomainResponse_RuleBasedMatching() {
    this->initializeModel();
}

OAIUpdateDomainResponse_RuleBasedMatching::~OAIUpdateDomainResponse_RuleBasedMatching() {}

void OAIUpdateDomainResponse_RuleBasedMatching::initializeModel() {
...
void OAIUpdateDomainResponse_RuleBasedMatching::fromJson(QString jsonString) {
...
void OAIUpdateDomainResponse_RuleBasedMatching::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDomainResponse_RuleBasedMatching::asJson() const {
...
QJsonObject OAIUpdateDomainResponse_RuleBasedMatching::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIUpdateDomainResponse_RuleBasedMatching::getEnabled() const {
    return m_enabled;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QList OAIUpdateDomainResponse_RuleBasedMatching::getMatchingRules() const {
    return m_matching_rules;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setMatchingRules(const QList &matching_rules) {
    m_matching_rules = matching_rules;
    m_matching_rules_isSet = true;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_matching_rules_Set() const{
    return m_matching_rules_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_matching_rules_Valid() const{
    return m_matching_rules_isValid;
}

OAIRuleBasedMatchingStatus OAIUpdateDomainResponse_RuleBasedMatching::getStatus() const {
    return m_status;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setStatus(const OAIRuleBasedMatchingStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIUpdateDomainResponse_RuleBasedMatching::getMaxAllowedRuleLevelForMerging() const {
    return m_max_allowed_rule_level_for_merging;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setMaxAllowedRuleLevelForMerging(const qint32 &max_allowed_rule_level_for_merging) {
    m_max_allowed_rule_level_for_merging = max_allowed_rule_level_for_merging;
    m_max_allowed_rule_level_for_merging_isSet = true;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_max_allowed_rule_level_for_merging_Set() const{
    return m_max_allowed_rule_level_for_merging_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_max_allowed_rule_level_for_merging_Valid() const{
    return m_max_allowed_rule_level_for_merging_isValid;
}

qint32 OAIUpdateDomainResponse_RuleBasedMatching::getMaxAllowedRuleLevelForMatching() const {
    return m_max_allowed_rule_level_for_matching;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setMaxAllowedRuleLevelForMatching(const qint32 &max_allowed_rule_level_for_matching) {
...
bool OAIUpdateDomainResponse_RuleBasedMatching::is_max_allowed_rule_level_for_matching_Set() const{
    return m_max_allowed_rule_level_for_matching_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_max_allowed_rule_level_for_matching_Valid() const{
    return m_max_allowed_rule_level_for_matching_isValid;
}

OAIUpdateDomain_request_RuleBasedMatching_AttributeTypesSelector OAIUpdateDomainResponse_RuleBasedMatching::getAttributeTypesSelector() const {
    return m_attribute_types_selector;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setAttributeTypesSelector(const OAIUpdateDomain_request_RuleBasedMatching_AttributeTypesSelector &attribute_types_selector) {
    m_attribute_types_selector = attribute_types_selector;
    m_attribute_types_selector_isSet = true;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_attribute_types_selector_Set() const{
    return m_attribute_types_selector_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_attribute_types_selector_Valid() const{
    return m_attribute_types_selector_isValid;
}

OAIConflictResolution OAIUpdateDomainResponse_RuleBasedMatching::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setConflictResolution(const OAIConflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

OAIExportingConfig OAIUpdateDomainResponse_RuleBasedMatching::getExportingConfig() const {
    return m_exporting_config;
}
void OAIUpdateDomainResponse_RuleBasedMatching::setExportingConfig(const OAIExportingConfig &exporting_config) {
    m_exporting_config = exporting_config;
    m_exporting_config_isSet = true;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_exporting_config_Set() const{
    return m_exporting_config_isSet;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::is_exporting_config_Valid() const{
    return m_exporting_config_isValid;
}

bool OAIUpdateDomainResponse_RuleBasedMatching::isSet() const {
...
bool OAIUpdateDomainResponse_RuleBasedMatching::isValid() const {
