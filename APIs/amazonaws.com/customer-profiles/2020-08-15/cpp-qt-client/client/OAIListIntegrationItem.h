...
/*
 * OAIListIntegrationItem.h
 *
 * An integration in list of integrations.
 */

#ifndef OAIListIntegrationItem_H
#define OAIListIntegrationItem_H
...
class OAIListIntegrationItem : public OAIObject {
public:
    OAIListIntegrationItem();
    OAIListIntegrationItem(QString json);
    ~OAIListIntegrationItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListIntegrationItem)

#endif // OAIListIntegrationItem_H
