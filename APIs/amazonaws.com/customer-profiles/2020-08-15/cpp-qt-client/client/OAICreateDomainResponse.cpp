...
QString OAICreateDomainResponse::getDomainName() const {
    return m_domain_name;
}
void OAICreateDomainResponse::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAICreateDomainResponse::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAICreateDomainResponse::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

qint32 OAICreateDomainResponse::getDefaultExpirationDays() const {
    return m_default_expiration_days;
}
void OAICreateDomainResponse::setDefaultExpirationDays(const qint32 &default_expiration_days) {
    m_default_expiration_days = default_expiration_days;
    m_default_expiration_days_isSet = true;
}

bool OAICreateDomainResponse::is_default_expiration_days_Set() const{
    return m_default_expiration_days_isSet;
}

bool OAICreateDomainResponse::is_default_expiration_days_Valid() const{
    return m_default_expiration_days_isValid;
}

QString OAICreateDomainResponse::getDefaultEncryptionKey() const {
    return m_default_encryption_key;
}
void OAICreateDomainResponse::setDefaultEncryptionKey(const QString &default_encryption_key) {
    m_default_encryption_key = default_encryption_key;
    m_default_encryption_key_isSet = true;
}

bool OAICreateDomainResponse::is_default_encryption_key_Set() const{
    return m_default_encryption_key_isSet;
}

bool OAICreateDomainResponse::is_default_encryption_key_Valid() const{
    return m_default_encryption_key_isValid;
}

QString OAICreateDomainResponse::getDeadLetterQueueUrl() const {
    return m_dead_letter_queue_url;
}
void OAICreateDomainResponse::setDeadLetterQueueUrl(const QString &dead_letter_queue_url) {
    m_dead_letter_queue_url = dead_letter_queue_url;
    m_dead_letter_queue_url_isSet = true;
}

bool OAICreateDomainResponse::is_dead_letter_queue_url_Set() const{
    return m_dead_letter_queue_url_isSet;
}

bool OAICreateDomainResponse::is_dead_letter_queue_url_Valid() const{
    return m_dead_letter_queue_url_isValid;
}

OAICreateDomainResponse_Matching OAICreateDomainResponse::getMatching() const {
    return m_matching;
}
void OAICreateDomainResponse::setMatching(const OAICreateDomainResponse_Matching &matching) {
    m_matching = matching;
    m_matching_isSet = true;
}

bool OAICreateDomainResponse::is_matching_Set() const{
    return m_matching_isSet;
}

bool OAICreateDomainResponse::is_matching_Valid() const{
    return m_matching_isValid;
}

OAICreateDomainResponse_RuleBasedMatching OAICreateDomainResponse::getRuleBasedMatching() const {
    return m_rule_based_matching;
}
void OAICreateDomainResponse::setRuleBasedMatching(const OAICreateDomainResponse_RuleBasedMatching &rule_based_matching) {
    m_rule_based_matching = rule_based_matching;
    m_rule_based_matching_isSet = true;
}

bool OAICreateDomainResponse::is_rule_based_matching_Set() const{
    return m_rule_based_matching_isSet;
}

bool OAICreateDomainResponse::is_rule_based_matching_Valid() const{
    return m_rule_based_matching_isValid;
}

QDateTime OAICreateDomainResponse::getCreatedAt() const {
    return m_created_at;
}
void OAICreateDomainResponse::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICreateDomainResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICreateDomainResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAICreateDomainResponse::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAICreateDomainResponse::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAICreateDomainResponse::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAICreateDomainResponse::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

QMap OAICreateDomainResponse::getTags() const {
    return m_tags;
}
void OAICreateDomainResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateDomainResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateDomainResponse::is_tags_Valid() const{
...
bool OAICreateDomainResponse::isValid() const {
    ...
    return m_domain_name_isValid && m_default_expiration_days_isValid && m_created_at_isValid && m_last_updated_at_isValid && true;
}
