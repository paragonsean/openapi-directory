...
OAIUpdateDomain_request::OAIUpdateDomain_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDomain_request::OAIUpdateDomain_request() {
    this->initializeModel();
}

OAIUpdateDomain_request::~OAIUpdateDomain_request() {}

void OAIUpdateDomain_request::initializeModel() {
...
void OAIUpdateDomain_request::fromJson(QString jsonString) {
...
void OAIUpdateDomain_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDomain_request::asJson() const {
...
QJsonObject OAIUpdateDomain_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUpdateDomain_request::getDefaultExpirationDays() const {
    return m_default_expiration_days;
}
void OAIUpdateDomain_request::setDefaultExpirationDays(const qint32 &default_expiration_days) {
    m_default_expiration_days = default_expiration_days;
    m_default_expiration_days_isSet = true;
}

bool OAIUpdateDomain_request::is_default_expiration_days_Set() const{
    return m_default_expiration_days_isSet;
}

bool OAIUpdateDomain_request::is_default_expiration_days_Valid() const{
    return m_default_expiration_days_isValid;
}

QString OAIUpdateDomain_request::getDefaultEncryptionKey() const {
    return m_default_encryption_key;
}
void OAIUpdateDomain_request::setDefaultEncryptionKey(const QString &default_encryption_key) {
    m_default_encryption_key = default_encryption_key;
    m_default_encryption_key_isSet = true;
}

bool OAIUpdateDomain_request::is_default_encryption_key_Set() const{
    return m_default_encryption_key_isSet;
}

bool OAIUpdateDomain_request::is_default_encryption_key_Valid() const{
    return m_default_encryption_key_isValid;
}

QString OAIUpdateDomain_request::getDeadLetterQueueUrl() const {
    return m_dead_letter_queue_url;
}
void OAIUpdateDomain_request::setDeadLetterQueueUrl(const QString &dead_letter_queue_url) {
    m_dead_letter_queue_url = dead_letter_queue_url;
    m_dead_letter_queue_url_isSet = true;
}

bool OAIUpdateDomain_request::is_dead_letter_queue_url_Set() const{
    return m_dead_letter_queue_url_isSet;
}

bool OAIUpdateDomain_request::is_dead_letter_queue_url_Valid() const{
    return m_dead_letter_queue_url_isValid;
}

OAIUpdateDomain_request_Matching OAIUpdateDomain_request::getMatching() const {
    return m_matching;
}
void OAIUpdateDomain_request::setMatching(const OAIUpdateDomain_request_Matching &matching) {
    m_matching = matching;
    m_matching_isSet = true;
}

bool OAIUpdateDomain_request::is_matching_Set() const{
    return m_matching_isSet;
}

bool OAIUpdateDomain_request::is_matching_Valid() const{
    return m_matching_isValid;
}

OAIUpdateDomain_request_RuleBasedMatching OAIUpdateDomain_request::getRuleBasedMatching() const {
    return m_rule_based_matching;
}
void OAIUpdateDomain_request::setRuleBasedMatching(const OAIUpdateDomain_request_RuleBasedMatching &rule_based_matching) {
    m_rule_based_matching = rule_based_matching;
    m_rule_based_matching_isSet = true;
}

bool OAIUpdateDomain_request::is_rule_based_matching_Set() const{
    return m_rule_based_matching_isSet;
}

bool OAIUpdateDomain_request::is_rule_based_matching_Valid() const{
    return m_rule_based_matching_isValid;
}

QMap<QString, QString> OAIUpdateDomain_request::getTags() const {
    return m_tags;
}
void OAIUpdateDomain_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateDomain_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateDomain_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIUpdateDomain_request::isSet() const {
...
bool OAIUpdateDomain_request::isValid() const {
