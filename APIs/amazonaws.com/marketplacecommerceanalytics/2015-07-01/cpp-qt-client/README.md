...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIGenerateDataSetRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIGenerateDataSetRequest Example::create(){
    OAIGenerateDataSetRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::generateDataSetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::generateDataSetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIGenerateDataSetRequest oai_generate_data_set_request = create(); // OAIGenerateDataSetRequest | 
      ...
      apiInstance.generateDataSet(x_amz_targetoai_generate_data_set_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
