...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://marketplacecommerceanalytics.{region}.amazonaws.com"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://marketplacecommerceanalytics.{region}.amazonaws.com"),
    "The AWS Marketplace Commerce Analytics multi-region endpoint",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","us-east-1",
    QSet<QString>{ {"us-east-1"},{"us-east-2"},{"us-west-1"},{"us-west-2"},{"us-gov-west-1"},{"us-gov-east-1"},{"ca-central-1"},{"eu-north-1"},{"eu-west-1"},{"eu-west-2"},{"eu-west-3"},{"eu-central-1"},{"eu-south-1"},{"af-south-1"},{"ap-northeast-1"},{"ap-northeast-2"},{"ap-northeast-3"},{"ap-southeast-1"},{"ap-southeast-2"},{"ap-east-1"},{"ap-south-1"},{"sa-east-1"},{"me-south-1"} })}, }));
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://marketplacecommerceanalytics.{region}.amazonaws.com.cn"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://marketplacecommerceanalytics.{region}.amazonaws.com.cn"),
    "The AWS Marketplace Commerce Analytics endpoint for China (Beijing) and China (Ningxia)",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","cn-north-1",
    QSet<QString>{ {"cn-north-1"},{"cn-northwest-1"} })}, }));
    
    _serverConfigs.insert("generateDataSet", defaultConf);
    _serverIndices.insert("generateDataSet", 0);
    _serverConfigs.insert("startSupportDataExport", defaultConf);
    _serverIndices.insert("startSupportDataExport", 0);
}
...
void OAIDefaultApi::generateDataSet(const QString &x_amz_target, const OAIGenerateDataSetRequest &oai_generate_data_set_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["generateDataSet"][_serverIndices.value("generateDataSet")].URL()+"/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.GenerateDataSet");
...

    {
        ...
        QByteArray output = oai_generate_data_set_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::generateDataSetCallback);
...
void OAIDefaultApi::generateDataSetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGenerateDataSetResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT generateDataSetSignal(output);
        Q_EMIT generateDataSetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT generateDataSetSignalE(output, error_type, error_str);
        Q_EMIT generateDataSetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT generateDataSetSignalError(output, error_type, error_str);
        Q_EMIT generateDataSetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::startSupportDataExport(const QString &x_amz_target, const OAIStartSupportDataExportRequest &oai_start_support_data_export_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["startSupportDataExport"][_serverIndices.value("startSupportDataExport")].URL()+"/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.StartSupportDataExport");
...

    {
        ...
        QByteArray output = oai_start_support_data_export_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    if (x_amz_content_sha256.hasValue())
    {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::startSupportDataExportCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::startSupportDataExportCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIStartSupportDataExportResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT startSupportDataExportSignal(output);
        Q_EMIT startSupportDataExportSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT startSupportDataExportSignalE(output, error_type, error_str);
        Q_EMIT startSupportDataExportSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT startSupportDataExportSignalError(output, error_type, error_str);
        Q_EMIT startSupportDataExportSignalErrorFull(worker, error_type, error_str);
    }
}
