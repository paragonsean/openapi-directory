...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICompleteAttachmentUpload_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICompleteAttachmentUpload_request Example::create(){
    OAICompleteAttachmentUpload_request obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::completeAttachmentUploadSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::completeAttachmentUploadSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString x_amz_bearer = create(); // QString | The authentication token associated with the participant's connection.
      ...
      OAICompleteAttachmentUpload_request oai_complete_attachment_upload_request = create(); // OAICompleteAttachmentUpload_request | 
      ...
      apiInstance.completeAttachmentUpload(x_amz_beareroai_complete_attachment_upload_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
