...
OAIStartPosition::OAIStartPosition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartPosition::OAIStartPosition() {
    this->initializeModel();
}

OAIStartPosition::~OAIStartPosition() {}

void OAIStartPosition::initializeModel() {
...
void OAIStartPosition::fromJson(QString jsonString) {
...
void OAIStartPosition::fromJsonObject(QJsonObject json) {
...
QString OAIStartPosition::asJson() const {
...
QJsonObject OAIStartPosition::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIStartPosition::getId() const {
    return m_id;
}
void OAIStartPosition::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStartPosition::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStartPosition::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIStartPosition::getAbsoluteTime() const {
    return m_absolute_time;
}
void OAIStartPosition::setAbsoluteTime(const QString &absolute_time) {
    m_absolute_time = absolute_time;
    m_absolute_time_isSet = true;
}

bool OAIStartPosition::is_absolute_time_Set() const{
    return m_absolute_time_isSet;
}

bool OAIStartPosition::is_absolute_time_Valid() const{
    return m_absolute_time_isValid;
}

qint32 OAIStartPosition::getMostRecent() const {
    return m_most_recent;
}
void OAIStartPosition::setMostRecent(const qint32 &most_recent) {
    m_most_recent = most_recent;
    m_most_recent_isSet = true;
}

bool OAIStartPosition::is_most_recent_Set() const{
    return m_most_recent_isSet;
}

bool OAIStartPosition::is_most_recent_Valid() const{
    return m_most_recent_isValid;
}

bool OAIStartPosition::isSet() const {
...
bool OAIStartPosition::isValid() const {
