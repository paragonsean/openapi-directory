...
#ifndef OAIStartPosition_H
#define OAIStartPosition_H
...
class OAIStartPosition : public OAIObject {
public:
    OAIStartPosition();
    OAIStartPosition(QString json);
    ~OAIStartPosition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartPosition)

#endif // OAIStartPosition_H
