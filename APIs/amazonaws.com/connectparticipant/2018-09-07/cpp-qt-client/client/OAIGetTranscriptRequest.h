...
/*
 * OAIGetTranscriptRequest.h
 *
 * 
 */

#ifndef OAIGetTranscriptRequest_H
#define OAIGetTranscriptRequest_H
...
namespace OpenAPI {
class OAIGetTranscriptRequest_StartPosition;

class OAIGetTranscriptRequest : public OAIObject {
public:
    OAIGetTranscriptRequest();
    OAIGetTranscriptRequest(QString json);
    ~OAIGetTranscriptRequest() override;
    ...
    OAIScanDirection getScanDirection() const;
    void setScanDirection(const OAIScanDirection &scan_direction);
    bool is_scan_direction_Set() const;
    bool is_scan_direction_Valid() const;

    OAISortKey getSortOrder() const;
    void setSortOrder(const OAISortKey &sort_order);
    bool is_sort_order_Set() const;
    bool is_sort_order_Valid() const;

    OAIGetTranscriptRequest_StartPosition getStartPosition() const;
    void setStartPosition(const OAIGetTranscriptRequest_StartPosition &start_position);
...
private:
    ...
    OAIScanDirection m_scan_direction;
    bool m_scan_direction_isSet;
    bool m_scan_direction_isValid;

    OAISortKey m_sort_order;
    bool m_sort_order_isSet;
    bool m_sort_order_isValid;

    OAIGetTranscriptRequest_StartPosition m_start_position;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTranscriptRequest)

#endif // OAIGetTranscriptRequest_H
