...
/*
 * OAIStartAttachmentUploadResponse_UploadMetadata.h
 *
 * 
 */

#ifndef OAIStartAttachmentUploadResponse_UploadMetadata_H
#define OAIStartAttachmentUploadResponse_UploadMetadata_H
...
class OAIStartAttachmentUploadResponse_UploadMetadata : public OAIObject {
public:
    OAIStartAttachmentUploadResponse_UploadMetadata();
    OAIStartAttachmentUploadResponse_UploadMetadata(QString json);
    ~OAIStartAttachmentUploadResponse_UploadMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartAttachmentUploadResponse_UploadMetadata)

#endif // OAIStartAttachmentUploadResponse_UploadMetadata_H
