...
/*
 * OAICompleteAttachmentUpload_request.h
 *
 * 
 */

#ifndef OAICompleteAttachmentUpload_request_H
#define OAICompleteAttachmentUpload_request_H
...
class OAICompleteAttachmentUpload_request : public OAIObject {
public:
    OAICompleteAttachmentUpload_request();
    OAICompleteAttachmentUpload_request(QString json);
    ~OAICompleteAttachmentUpload_request() override;
    ...
    QList<QString> getAttachmentIds() const;
    void setAttachmentIds(const QList<QString> &attachment_ids);
...
private:
    ...
    QList<QString> m_attachment_ids;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompleteAttachmentUpload_request)

#endif // OAICompleteAttachmentUpload_request_H
