...
#ifndef OAIAttachmentItem_H
#define OAIAttachmentItem_H
...
class OAIAttachmentItem : public OAIObject {
public:
    OAIAttachmentItem();
    OAIAttachmentItem(QString json);
    ~OAIAttachmentItem() override;
    ...
    OAIArtifactStatus getStatus() const;
    void setStatus(const OAIArtifactStatus &status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentItem)

#endif // OAIAttachmentItem_H
