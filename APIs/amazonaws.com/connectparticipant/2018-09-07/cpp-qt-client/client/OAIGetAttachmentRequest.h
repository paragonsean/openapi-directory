...
/*
 * OAIGetAttachmentRequest.h
 *
 * 
 */

#ifndef OAIGetAttachmentRequest_H
#define OAIGetAttachmentRequest_H
...
class OAIGetAttachmentRequest : public OAIObject {
public:
    OAIGetAttachmentRequest();
    OAIGetAttachmentRequest(QString json);
    ~OAIGetAttachmentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAttachmentRequest)

#endif // OAIGetAttachmentRequest_H
