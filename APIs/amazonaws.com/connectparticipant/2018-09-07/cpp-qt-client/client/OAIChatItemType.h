...
#ifndef OAIChatItemType_H
#define OAIChatItemType_H
...
class OAIChatItemType : public OAIEnum {
public:
    OAIChatItemType();
    OAIChatItemType(QString json);
    ~OAIChatItemType() override;
    ...
    OAIChatItemType::eOAIChatItemType getValue() const;
    void setValue(const OAIChatItemType::eOAIChatItemType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChatItemType)

#endif // OAIChatItemType_H
