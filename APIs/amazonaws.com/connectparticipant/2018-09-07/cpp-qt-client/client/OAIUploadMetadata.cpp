...
OAIUploadMetadata::OAIUploadMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUploadMetadata::OAIUploadMetadata() {
    this->initializeModel();
}

OAIUploadMetadata::~OAIUploadMetadata() {}

void OAIUploadMetadata::initializeModel() {
...
void OAIUploadMetadata::fromJson(QString jsonString) {
...
void OAIUploadMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIUploadMetadata::asJson() const {
...
QJsonObject OAIUploadMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_url_isSet) {
...
QString OAIUploadMetadata::getUrl() const {
    return m_url;
}
void OAIUploadMetadata::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIUploadMetadata::is_url_Set() const{
    return m_url_isSet;
}

bool OAIUploadMetadata::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIUploadMetadata::getUrlExpiry() const {
    return m_url_expiry;
}
void OAIUploadMetadata::setUrlExpiry(const QString &url_expiry) {
    m_url_expiry = url_expiry;
    m_url_expiry_isSet = true;
}

bool OAIUploadMetadata::is_url_expiry_Set() const{
    return m_url_expiry_isSet;
}

bool OAIUploadMetadata::is_url_expiry_Valid() const{
    return m_url_expiry_isValid;
}

QMap OAIUploadMetadata::getHeadersToInclude() const {
    return m_headers_to_include;
}
void OAIUploadMetadata::setHeadersToInclude(const QMap &headers_to_include) {
    m_headers_to_include = headers_to_include;
    m_headers_to_include_isSet = true;
}

bool OAIUploadMetadata::is_headers_to_include_Set() const{
    return m_headers_to_include_isSet;
}

bool OAIUploadMetadata::is_headers_to_include_Valid() const{
    return m_headers_to_include_isValid;
}

bool OAIUploadMetadata::isSet() const {
...
bool OAIUploadMetadata::isValid() const {
