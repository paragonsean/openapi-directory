...
/*
 * OAIGetAttachmentResponse.h
 *
 * 
 */

#ifndef OAIGetAttachmentResponse_H
#define OAIGetAttachmentResponse_H
...
class OAIGetAttachmentResponse : public OAIObject {
public:
    OAIGetAttachmentResponse();
    OAIGetAttachmentResponse(QString json);
    ~OAIGetAttachmentResponse() override;
    ...
    QString getUrlExpiry() const;
    void setUrlExpiry(const QString &url_expiry);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAttachmentResponse)

#endif // OAIGetAttachmentResponse_H
