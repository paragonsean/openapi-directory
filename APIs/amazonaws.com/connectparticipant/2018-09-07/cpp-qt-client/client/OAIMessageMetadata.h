...
/*
 * OAIMessageMetadata.h
 *
 * Contains metadata related to a message.
 */

#ifndef OAIMessageMetadata_H
#define OAIMessageMetadata_H
...
class OAIMessageMetadata : public OAIObject {
public:
    OAIMessageMetadata();
    OAIMessageMetadata(QString json);
    ~OAIMessageMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageMetadata)

#endif // OAIMessageMetadata_H
