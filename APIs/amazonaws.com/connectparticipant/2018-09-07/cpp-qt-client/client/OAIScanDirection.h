...
#ifndef OAIScanDirection_H
#define OAIScanDirection_H
...
class OAIScanDirection : public OAIEnum {
public:
    OAIScanDirection();
    OAIScanDirection(QString json);
    ~OAIScanDirection() override;
    ...
    enum class eOAIScanDirection {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        FORWARD, 
        BACKWARD
    };
    OAIScanDirection::eOAIScanDirection getValue() const;
    void setValue(const OAIScanDirection::eOAIScanDirection& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScanDirection)

#endif // OAIScanDirection_H
