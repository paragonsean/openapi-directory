...
/*
 * OAIStartAttachmentUpload_request.h
 *
 * 
 */

#ifndef OAIStartAttachmentUpload_request_H
#define OAIStartAttachmentUpload_request_H
...
class OAIStartAttachmentUpload_request : public OAIObject {
public:
    OAIStartAttachmentUpload_request();
    OAIStartAttachmentUpload_request(QString json);
    ~OAIStartAttachmentUpload_request() override;
    ...
    qint32 getAttachmentSizeInBytes() const;
    void setAttachmentSizeInBytes(const qint32 &attachment_size_in_bytes);
    bool is_attachment_size_in_bytes_Set() const;
    bool is_attachment_size_in_bytes_Valid() const;
...
private:
    ...
    qint32 m_attachment_size_in_bytes;
    bool m_attachment_size_in_bytes_isSet;
    bool m_attachment_size_in_bytes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartAttachmentUpload_request)

#endif // OAIStartAttachmentUpload_request_H
