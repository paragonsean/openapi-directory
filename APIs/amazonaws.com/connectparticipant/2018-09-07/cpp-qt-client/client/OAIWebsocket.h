...
#ifndef OAIWebsocket_H
#define OAIWebsocket_H
...
class OAIWebsocket : public OAIObject {
public:
    OAIWebsocket();
    OAIWebsocket(QString json);
    ~OAIWebsocket() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebsocket)

#endif // OAIWebsocket_H
