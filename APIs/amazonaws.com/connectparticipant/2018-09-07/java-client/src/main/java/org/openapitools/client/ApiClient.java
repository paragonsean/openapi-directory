...
public class ApiClient {
    ...
    private String basePath = "http://participant.connect.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-09-07/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://participant.connect.us-east-1.amazonaws.com
