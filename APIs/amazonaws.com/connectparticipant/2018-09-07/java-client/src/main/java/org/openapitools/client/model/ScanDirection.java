...
/**
 * Gets or Sets ScanDirection
 */
@JsonAdapter(ScanDirection.Adapter.class)
public enum ScanDirection {
  ...
  public static ScanDirection fromValue(String value) {
    for (ScanDirection b : ScanDirection.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScanDirection> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScanDirection enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScanDirection read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScanDirection.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ScanDirection.fromValue(value);
  }
}
