 ...
 */
@JsonAdapter(SortKey.Adapter.class)
public enum SortKey {
  ...
  public static class Adapter extends TypeAdapter<SortKey> {
    @Override
    public void write(final JsonWriter jsonWriter, final SortKey enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SortKey read(final JsonReader jsonReader) throws IOException {
