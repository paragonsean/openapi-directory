...
* @readonly
*/
export default class ArtifactStatus {
    ...
    /**
    * Returns a <code>ArtifactStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ArtifactStatus} The enum <code>ArtifactStatus</code> value.
    */
