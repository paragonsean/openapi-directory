...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.StartAttachmentUploadRequest();
  });
  ...
  describe('StartAttachmentUploadRequest', function() {
    it('should create an instance of StartAttachmentUploadRequest', function() {
      // uncomment below and update the code to test StartAttachmentUploadRequest
      //var instance = new AmazonConnectParticipantService.StartAttachmentUploadRequest();
      //expect(instance).to.be.a(AmazonConnectParticipantService.StartAttachmentUploadRequest);
    });
    ...
    it('should have the property attachmentSizeInBytes (base name: "AttachmentSizeInBytes")', function() {
      // uncomment below and update the code to test the property attachmentSizeInBytes
      //var instance = new AmazonConnectParticipantService.StartAttachmentUploadRequest();
      //expect(instance).to.be();
    });
