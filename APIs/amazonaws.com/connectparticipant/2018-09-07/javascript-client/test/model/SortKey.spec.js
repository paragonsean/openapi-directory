...
(function(root, factory) {
  ...
  describe('SortKey', function() {
    it('should create an instance of SortKey', function() {
      // uncomment below and update the code to test SortKey
      //var instance = new AmazonConnectParticipantService.SortKey();
      //expect(instance).to.be.a(AmazonConnectParticipantService.SortKey);
    });
