...
(function(root, factory) {
  ...
  describe('ArtifactStatus', function() {
    it('should create an instance of ArtifactStatus', function() {
      // uncomment below and update the code to test ArtifactStatus
      //var instance = new AmazonConnectParticipantService.ArtifactStatus();
      //expect(instance).to.be.a(AmazonConnectParticipantService.ArtifactStatus);
    });
