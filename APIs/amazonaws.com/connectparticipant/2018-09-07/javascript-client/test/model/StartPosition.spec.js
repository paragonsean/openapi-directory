...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.StartPosition();
  });
  ...
  describe('StartPosition', function() {
    it('should create an instance of StartPosition', function() {
      // uncomment below and update the code to test StartPosition
      //var instance = new AmazonConnectParticipantService.StartPosition();
      //expect(instance).to.be.a(AmazonConnectParticipantService.StartPosition);
    });
