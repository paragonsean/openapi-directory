...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.CompleteAttachmentUploadRequest();
  });
  ...
  describe('CompleteAttachmentUploadRequest', function() {
    it('should create an instance of CompleteAttachmentUploadRequest', function() {
      // uncomment below and update the code to test CompleteAttachmentUploadRequest
      //var instance = new AmazonConnectParticipantService.CompleteAttachmentUploadRequest();
      //expect(instance).to.be.a(AmazonConnectParticipantService.CompleteAttachmentUploadRequest);
    });
