...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.SendMessageResponse();
  });
  ...
  describe('SendMessageResponse', function() {
    it('should create an instance of SendMessageResponse', function() {
      ...
      //var instance = new AmazonConnectParticipantService.SendMessageResponse();
      //expect(instance).to.be.a(AmazonConnectParticipantService.SendMessageResponse);
    });
