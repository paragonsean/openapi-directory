...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.MessageMetadata();
  });
  ...
  describe('MessageMetadata', function() {
    it('should create an instance of MessageMetadata', function() {
      ...
      //var instance = new AmazonConnectParticipantService.MessageMetadata();
      //expect(instance).to.be.a(AmazonConnectParticipantService.MessageMetadata);
    });
