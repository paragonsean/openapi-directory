...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.Websocket();
  });
  ...
  describe('Websocket', function() {
    it('should create an instance of Websocket', function() {
      // uncomment below and update the code to test Websocket
      //var instance = new AmazonConnectParticipantService.Websocket();
      //expect(instance).to.be.a(AmazonConnectParticipantService.Websocket);
    });
    ...
    it('should have the property connectionExpiry (base name: "ConnectionExpiry")', function() {
      // uncomment below and update the code to test the property connectionExpiry
      //var instance = new AmazonConnectParticipantService.Websocket();
      //expect(instance).to.be();
    });
