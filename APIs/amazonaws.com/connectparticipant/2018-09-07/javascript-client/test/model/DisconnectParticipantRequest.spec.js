...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.DisconnectParticipantRequest();
  });
  ...
  describe('DisconnectParticipantRequest', function() {
    it('should create an instance of DisconnectParticipantRequest', function() {
      // uncomment below and update the code to test DisconnectParticipantRequest
      //var instance = new AmazonConnectParticipantService.DisconnectParticipantRequest();
      //expect(instance).to.be.a(AmazonConnectParticipantService.DisconnectParticipantRequest);
    });
