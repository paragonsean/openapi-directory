...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.SendMessageRequest();
  });
  ...
  describe('SendMessageRequest', function() {
    it('should create an instance of SendMessageRequest', function() {
      ...
      //var instance = new AmazonConnectParticipantService.SendMessageRequest();
      //expect(instance).to.be.a(AmazonConnectParticipantService.SendMessageRequest);
    });
