...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.ItemMessageMetadata();
  });
  ...
  describe('ItemMessageMetadata', function() {
    it('should create an instance of ItemMessageMetadata', function() {
      // uncomment below and update the code to test ItemMessageMetadata
      //var instance = new AmazonConnectParticipantService.ItemMessageMetadata();
      //expect(instance).to.be.a(AmazonConnectParticipantService.ItemMessageMetadata);
    });
