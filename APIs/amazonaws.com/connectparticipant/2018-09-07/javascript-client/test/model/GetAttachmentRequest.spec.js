...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.GetAttachmentRequest();
  });
  ...
  describe('GetAttachmentRequest', function() {
    it('should create an instance of GetAttachmentRequest', function() {
      // uncomment below and update the code to test GetAttachmentRequest
      //var instance = new AmazonConnectParticipantService.GetAttachmentRequest();
      //expect(instance).to.be.a(AmazonConnectParticipantService.GetAttachmentRequest);
    });
