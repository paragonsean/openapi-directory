...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.StartAttachmentUploadResponse();
  });
  ...
  describe('StartAttachmentUploadResponse', function() {
    it('should create an instance of StartAttachmentUploadResponse', function() {
      // uncomment below and update the code to test StartAttachmentUploadResponse
      //var instance = new AmazonConnectParticipantService.StartAttachmentUploadResponse();
      //expect(instance).to.be.a(AmazonConnectParticipantService.StartAttachmentUploadResponse);
    });
    ...
    it('should have the property uploadMetadata (base name: "UploadMetadata")', function() {
      // uncomment below and update the code to test the property uploadMetadata
      //var instance = new AmazonConnectParticipantService.StartAttachmentUploadResponse();
      //expect(instance).to.be();
    });
