...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.GetTranscriptResponse();
  });
  ...
  describe('GetTranscriptResponse', function() {
    it('should create an instance of GetTranscriptResponse', function() {
      // uncomment below and update the code to test GetTranscriptResponse
      //var instance = new AmazonConnectParticipantService.GetTranscriptResponse();
      //expect(instance).to.be.a(AmazonConnectParticipantService.GetTranscriptResponse);
    });
