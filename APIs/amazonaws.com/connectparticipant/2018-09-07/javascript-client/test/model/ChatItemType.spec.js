...
(function(root, factory) {
  ...
  describe('ChatItemType', function() {
    it('should create an instance of ChatItemType', function() {
      // uncomment below and update the code to test ChatItemType
      //var instance = new AmazonConnectParticipantService.ChatItemType();
      //expect(instance).to.be.a(AmazonConnectParticipantService.ChatItemType);
    });
