...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.AttachmentItem();
  });
  ...
  describe('AttachmentItem', function() {
    it('should create an instance of AttachmentItem', function() {
      // uncomment below and update the code to test AttachmentItem
      //var instance = new AmazonConnectParticipantService.AttachmentItem();
      //expect(instance).to.be.a(AmazonConnectParticipantService.AttachmentItem);
    });
