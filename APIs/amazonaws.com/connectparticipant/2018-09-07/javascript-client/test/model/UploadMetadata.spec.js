...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.UploadMetadata();
  });
  ...
  describe('UploadMetadata', function() {
    it('should create an instance of UploadMetadata', function() {
      ...
      //var instance = new AmazonConnectParticipantService.UploadMetadata();
      //expect(instance).to.be.a(AmazonConnectParticipantService.UploadMetadata);
    });
