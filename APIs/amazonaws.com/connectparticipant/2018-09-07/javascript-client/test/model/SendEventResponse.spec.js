...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.SendEventResponse();
  });
  ...
  describe('SendEventResponse', function() {
    it('should create an instance of SendEventResponse', function() {
      // uncomment below and update the code to test SendEventResponse
      //var instance = new AmazonConnectParticipantService.SendEventResponse();
      //expect(instance).to.be.a(AmazonConnectParticipantService.SendEventResponse);
    });
