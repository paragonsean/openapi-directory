...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectParticipantService.ConnectionCredentials();
  });
  ...
  describe('ConnectionCredentials', function() {
    it('should create an instance of ConnectionCredentials', function() {
      // uncomment below and update the code to test ConnectionCredentials
      //var instance = new AmazonConnectParticipantService.ConnectionCredentials();
      //expect(instance).to.be.a(AmazonConnectParticipantService.ConnectionCredentials);
    });

    it('should have the property connectionToken (base name: "ConnectionToken")', function() {
      // uncomment below and update the code to test the property connectionToken
      //var instance = new AmazonConnectParticipantService.ConnectionCredentials();
