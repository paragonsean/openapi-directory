...
(function(root, factory) {
  ...
  describe('ScanDirection', function() {
    it('should create an instance of ScanDirection', function() {
      // uncomment below and update the code to test ScanDirection
      //var instance = new AmazonConnectParticipantService.ScanDirection();
      //expect(instance).to.be.a(AmazonConnectParticipantService.ScanDirection);
    });
