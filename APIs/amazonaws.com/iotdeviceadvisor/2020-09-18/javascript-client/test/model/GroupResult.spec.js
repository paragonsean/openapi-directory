...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTCoreDeviceAdvisor.GroupResult();
  });
  ...
  describe('GroupResult', function() {
    it('should create an instance of GroupResult', function() {
      ...
      //var instance = new AwsIoTCoreDeviceAdvisor.GroupResult();
      //expect(instance).to.be.a(AwsIoTCoreDeviceAdvisor.GroupResult);
    });
