...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTCoreDeviceAdvisor.TestResult();
  });
  ...
  describe('TestResult', function() {
    it('should create an instance of TestResult', function() {
      ...
      //var instance = new AwsIoTCoreDeviceAdvisor.TestResult();
      //expect(instance).to.be.a(AwsIoTCoreDeviceAdvisor.TestResult);
    });
