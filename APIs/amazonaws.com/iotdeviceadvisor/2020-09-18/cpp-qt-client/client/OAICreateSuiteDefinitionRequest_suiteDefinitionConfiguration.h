...
/*
 * OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration.h
 *
 * 
 */

#ifndef OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration_H
#define OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration_H
...
class OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration : public OAIObject {
public:
    OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration();
    OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration(QString json);
    ~OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration)

#endif // OAICreateSuiteDefinitionRequest_suiteDefinitionConfiguration_H
