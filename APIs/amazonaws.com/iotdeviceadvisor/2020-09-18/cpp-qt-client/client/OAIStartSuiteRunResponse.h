...
/*
 * OAIStartSuiteRunResponse.h
 *
 * 
 */

#ifndef OAIStartSuiteRunResponse_H
#define OAIStartSuiteRunResponse_H
...
class OAIStartSuiteRunResponse : public OAIObject {
public:
    OAIStartSuiteRunResponse();
    OAIStartSuiteRunResponse(QString json);
    ~OAIStartSuiteRunResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSuiteRunResponse)

#endif // OAIStartSuiteRunResponse_H
