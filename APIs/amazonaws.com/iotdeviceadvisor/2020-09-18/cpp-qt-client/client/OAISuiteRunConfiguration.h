...
/*
 * OAISuiteRunConfiguration.h
 *
 * Gets suite run configuration.
 */

#ifndef OAISuiteRunConfiguration_H
#define OAISuiteRunConfiguration_H
...
class OAISuiteRunConfiguration : public OAIObject {
public:
    OAISuiteRunConfiguration();
    OAISuiteRunConfiguration(QString json);
    ~OAISuiteRunConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuiteRunConfiguration)

#endif // OAISuiteRunConfiguration_H
