...
/*
 * OAIStartSuiteRunRequest_suiteRunConfiguration.h
 *
 * 
 */

#ifndef OAIStartSuiteRunRequest_suiteRunConfiguration_H
#define OAIStartSuiteRunRequest_suiteRunConfiguration_H
...
class OAIStartSuiteRunRequest_suiteRunConfiguration : public OAIObject {
public:
    OAIStartSuiteRunRequest_suiteRunConfiguration();
    OAIStartSuiteRunRequest_suiteRunConfiguration(QString json);
    ~OAIStartSuiteRunRequest_suiteRunConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSuiteRunRequest_suiteRunConfiguration)

#endif // OAIStartSuiteRunRequest_suiteRunConfiguration_H
