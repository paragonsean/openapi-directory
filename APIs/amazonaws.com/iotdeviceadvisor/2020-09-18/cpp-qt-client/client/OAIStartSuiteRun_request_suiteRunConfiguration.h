...
/*
 * OAIStartSuiteRun_request_suiteRunConfiguration.h
 *
 * Gets suite run configuration.
 */

#ifndef OAIStartSuiteRun_request_suiteRunConfiguration_H
#define OAIStartSuiteRun_request_suiteRunConfiguration_H
...
class OAIStartSuiteRun_request_suiteRunConfiguration : public OAIObject {
public:
    OAIStartSuiteRun_request_suiteRunConfiguration();
    OAIStartSuiteRun_request_suiteRunConfiguration(QString json);
    ~OAIStartSuiteRun_request_suiteRunConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSuiteRun_request_suiteRunConfiguration)

#endif // OAIStartSuiteRun_request_suiteRunConfiguration_H
