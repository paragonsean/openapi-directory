...
public class SuiteDefinitionConfiguration {
  ...
  public SuiteDefinitionConfiguration() {
  }

  public SuiteDefinitionConfiguration suiteDefinitionName(String suiteDefinitionName) {
  ...
  public SuiteDefinitionConfiguration devices(List devices) {
  ...
  public SuiteDefinitionConfiguration intendedForQualification(Boolean intendedForQualification) {
  ...
  public SuiteDefinitionConfiguration isLongDurationTest(Boolean isLongDurationTest) {
  ...
  public SuiteDefinitionConfiguration rootGroup(String rootGroup) {
  ...
  public SuiteDefinitionConfiguration devicePermissionRoleArn(String devicePermissionRoleArn) {
  ...
  public SuiteDefinitionConfiguration protocol(Protocol protocol) {
  ...
  public boolean equals(Object o) {
    ...
    SuiteDefinitionConfiguration suiteDefinitionConfiguration = (SuiteDefinitionConfiguration) o;
    return Objects.equals(this.suiteDefinitionName, suiteDefinitionConfiguration.suiteDefinitionName) &&
        Objects.equals(this.devices, suiteDefinitionConfiguration.devices) &&
        Objects.equals(this.intendedForQualification, suiteDefinitionConfiguration.intendedForQualification) &&
        Objects.equals(this.isLongDurationTest, suiteDefinitionConfiguration.isLongDurationTest) &&
        Objects.equals(this.rootGroup, suiteDefinitionConfiguration.rootGroup) &&
        Objects.equals(this.devicePermissionRoleArn, suiteDefinitionConfiguration.devicePermissionRoleArn) &&
        Objects.equals(this.protocol, suiteDefinitionConfiguration.protocol);
  }
  ...
  public String toString() {
    ...
    sb.append("class SuiteDefinitionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SuiteDefinitionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuiteDefinitionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuiteDefinitionConfiguration is not found in the empty JSON string", SuiteDefinitionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuiteDefinitionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuiteDefinitionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SuiteDefinitionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuiteDefinitionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuiteDefinitionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuiteDefinitionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuiteDefinitionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SuiteDefinitionConfiguration>() {
           @Override
           public void write(JsonWriter out, SuiteDefinitionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuiteDefinitionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SuiteDefinitionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SuiteDefinitionConfiguration
   * @throws IOException if the JSON string is invalid with respect to SuiteDefinitionConfiguration
   */
  public static SuiteDefinitionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuiteDefinitionConfiguration.class);
  }

  /**
   * Convert an instance of SuiteDefinitionConfiguration to an JSON string
   *
   * @return JSON string
   */
