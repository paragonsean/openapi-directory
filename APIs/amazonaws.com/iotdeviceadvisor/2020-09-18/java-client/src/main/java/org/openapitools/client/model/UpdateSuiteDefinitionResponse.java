...
public class UpdateSuiteDefinitionResponse {
  ...
  public UpdateSuiteDefinitionResponse suiteDefinitionId(String suiteDefinitionId) {
  ...
  public UpdateSuiteDefinitionResponse suiteDefinitionArn(String suiteDefinitionArn) {
  ...
  public UpdateSuiteDefinitionResponse suiteDefinitionName(String suiteDefinitionName) {
  ...
  public UpdateSuiteDefinitionResponse suiteDefinitionVersion(String suiteDefinitionVersion) {
  ...
  public UpdateSuiteDefinitionResponse createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateSuiteDefinitionResponse lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSuiteDefinitionResponse updateSuiteDefinitionResponse = (UpdateSuiteDefinitionResponse) o;
    return Objects.equals(this.suiteDefinitionId, updateSuiteDefinitionResponse.suiteDefinitionId) &&
        Objects.equals(this.suiteDefinitionArn, updateSuiteDefinitionResponse.suiteDefinitionArn) &&
        Objects.equals(this.suiteDefinitionName, updateSuiteDefinitionResponse.suiteDefinitionName) &&
        Objects.equals(this.suiteDefinitionVersion, updateSuiteDefinitionResponse.suiteDefinitionVersion) &&
        Objects.equals(this.createdAt, updateSuiteDefinitionResponse.createdAt) &&
        Objects.equals(this.lastUpdatedAt, updateSuiteDefinitionResponse.lastUpdatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(suiteDefinitionId, suiteDefinitionArn, suiteDefinitionName, suiteDefinitionVersion, createdAt, lastUpdatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateSuiteDefinitionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSuiteDefinitionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSuiteDefinitionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSuiteDefinitionResponse is not found in the empty JSON string", UpdateSuiteDefinitionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSuiteDefinitionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSuiteDefinitionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSuiteDefinitionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSuiteDefinitionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSuiteDefinitionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSuiteDefinitionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSuiteDefinitionResponse>() {
           @Override
           public void write(JsonWriter out, UpdateSuiteDefinitionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSuiteDefinitionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSuiteDefinitionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSuiteDefinitionResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateSuiteDefinitionResponse
   */
  public static UpdateSuiteDefinitionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSuiteDefinitionResponse.class);
  }

  /**
   * Convert an instance of UpdateSuiteDefinitionResponse to an JSON string
   *
   * @return JSON string
   */
