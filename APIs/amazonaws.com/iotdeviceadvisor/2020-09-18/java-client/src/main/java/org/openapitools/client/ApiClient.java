...
public class ApiClient {
    ...
    private String basePath = "http://api.iotdeviceadvisor.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-09-18/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.iotdeviceadvisor.us-east-1.amazonaws.com
