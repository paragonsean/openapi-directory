...
/*
 * OAIStartApp_request_LaunchOverrides.h
 *
 * Options that apply when the app starts. These options override default behavior.
 */

#ifndef OAIStartApp_request_LaunchOverrides_H
#define OAIStartApp_request_LaunchOverrides_H
...
class OAIStartApp_request_LaunchOverrides : public OAIObject {
public:
    OAIStartApp_request_LaunchOverrides();
    OAIStartApp_request_LaunchOverrides(QString json);
    ~OAIStartApp_request_LaunchOverrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartApp_request_LaunchOverrides)

#endif // OAIStartApp_request_LaunchOverrides_H
