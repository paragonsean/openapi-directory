...
/*
 * OAIDescribeSimulationOutput_LiveSimulationState.h
 *
 * 
 */

#ifndef OAIDescribeSimulationOutput_LiveSimulationState_H
#define OAIDescribeSimulationOutput_LiveSimulationState_H
...
class OAIDescribeSimulationOutput_LiveSimulationState : public OAIObject {
public:
    OAIDescribeSimulationOutput_LiveSimulationState();
    OAIDescribeSimulationOutput_LiveSimulationState(QString json);
    ~OAIDescribeSimulationOutput_LiveSimulationState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSimulationOutput_LiveSimulationState)

#endif // OAIDescribeSimulationOutput_LiveSimulationState_H
