...
/*
 * OAIStartSimulationOutput.h
 *
 * 
 */

#ifndef OAIStartSimulationOutput_H
#define OAIStartSimulationOutput_H
...
class OAIStartSimulationOutput : public OAIObject {
public:
    OAIStartSimulationOutput();
    OAIStartSimulationOutput(QString json);
    ~OAIStartSimulationOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSimulationOutput)

#endif // OAIStartSimulationOutput_H
