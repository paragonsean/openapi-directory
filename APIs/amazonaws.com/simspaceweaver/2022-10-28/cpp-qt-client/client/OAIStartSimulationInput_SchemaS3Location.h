...
/*
 * OAIStartSimulationInput_SchemaS3Location.h
 *
 * 
 */

#ifndef OAIStartSimulationInput_SchemaS3Location_H
#define OAIStartSimulationInput_SchemaS3Location_H
...
class OAIStartSimulationInput_SchemaS3Location : public OAIObject {
public:
    OAIStartSimulationInput_SchemaS3Location();
    OAIStartSimulationInput_SchemaS3Location(QString json);
    ~OAIStartSimulationInput_SchemaS3Location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSimulationInput_SchemaS3Location)

#endif // OAIStartSimulationInput_SchemaS3Location_H
