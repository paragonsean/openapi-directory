...
/*
 * OAIClockTargetStatus.h
 *
 * 
 */

#ifndef OAIClockTargetStatus_H
#define OAIClockTargetStatus_H
...
class OAIClockTargetStatus : public OAIEnum {
public:
    OAIClockTargetStatus();
    OAIClockTargetStatus(QString json);
    ~OAIClockTargetStatus() override;
    ...
    enum class eOAIClockTargetStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        UNKNOWN, 
        STARTED, 
        STOPPED
    };
    OAIClockTargetStatus::eOAIClockTargetStatus getValue() const;
    void setValue(const OAIClockTargetStatus::eOAIClockTargetStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIClockTargetStatus)

#endif // OAIClockTargetStatus_H
