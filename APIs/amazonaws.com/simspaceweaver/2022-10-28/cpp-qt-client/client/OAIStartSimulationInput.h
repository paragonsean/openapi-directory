...
/*
 * OAIStartSimulationInput.h
 *
 * 
 */

#ifndef OAIStartSimulationInput_H
#define OAIStartSimulationInput_H
...
namespace OpenAPI {
class OAIStartSimulationInput_SchemaS3Location;
class OAIStartSimulationInput_SnapshotS3Location;

class OAIStartSimulationInput : public OAIObject {
public:
    OAIStartSimulationInput();
    OAIStartSimulationInput(QString json);
    ~OAIStartSimulationInput() override;
    ...
    OAIStartSimulationInput_SchemaS3Location getSchemaS3Location() const;
    void setSchemaS3Location(const OAIStartSimulationInput_SchemaS3Location &schema_s3_location);
    bool is_schema_s3_location_Set() const;
    bool is_schema_s3_location_Valid() const;

    OAIStartSimulationInput_SnapshotS3Location getSnapshotS3Location() const;
    void setSnapshotS3Location(const OAIStartSimulationInput_SnapshotS3Location &snapshot_s3_location);
...
private:
    ...
    OAIStartSimulationInput_SchemaS3Location m_schema_s3_location;
    bool m_schema_s3_location_isSet;
    bool m_schema_s3_location_isValid;

    OAIStartSimulationInput_SnapshotS3Location m_snapshot_s3_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSimulationInput)

#endif // OAIStartSimulationInput_H
