...
#ifndef OAIStopClockInput_H
#define OAIStopClockInput_H
...
class OAIStopClockInput : public OAIObject {
public:
    OAIStopClockInput();
    OAIStopClockInput(QString json);
    ~OAIStopClockInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopClockInput)

#endif // OAIStopClockInput_H
