...
#ifndef OAIStopAppInput_H
#define OAIStopAppInput_H
...
class OAIStopAppInput : public OAIObject {
public:
    OAIStopAppInput();
    OAIStopAppInput(QString json);
    ~OAIStopAppInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopAppInput)

#endif // OAIStopAppInput_H
