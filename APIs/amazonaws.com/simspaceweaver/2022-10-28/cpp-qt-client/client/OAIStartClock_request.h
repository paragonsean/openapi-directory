...
/*
 * OAIStartClock_request.h
 *
 * 
 */

#ifndef OAIStartClock_request_H
#define OAIStartClock_request_H
...
class OAIStartClock_request : public OAIObject {
public:
    OAIStartClock_request();
    OAIStartClock_request(QString json);
    ~OAIStartClock_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartClock_request)

#endif // OAIStartClock_request_H
