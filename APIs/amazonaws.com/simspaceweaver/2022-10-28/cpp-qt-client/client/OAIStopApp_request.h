...
/*
 * OAIStopApp_request.h
 *
 * 
 */

#ifndef OAIStopApp_request_H
#define OAIStopApp_request_H
...
class OAIStopApp_request : public OAIObject {
public:
    OAIStopApp_request();
    OAIStopApp_request(QString json);
    ~OAIStopApp_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopApp_request)

#endif // OAIStopApp_request_H
