...
/*
 * OAISimulationAppTargetStatus.h
 *
 * 
 */

#ifndef OAISimulationAppTargetStatus_H
#define OAISimulationAppTargetStatus_H
...
class OAISimulationAppTargetStatus : public OAIEnum {
public:
    OAISimulationAppTargetStatus();
    OAISimulationAppTargetStatus(QString json);
    ~OAISimulationAppTargetStatus() override;
    ...
    enum class eOAISimulationAppTargetStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        UNKNOWN, 
        STARTED, 
        STOPPED
    };
    OAISimulationAppTargetStatus::eOAISimulationAppTargetStatus getValue() const;
    void setValue(const OAISimulationAppTargetStatus::eOAISimulationAppTargetStatus& value);
...
private:
    ...
    eOAISimulationAppTargetStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimulationAppTargetStatus)

#endif // OAISimulationAppTargetStatus_H
