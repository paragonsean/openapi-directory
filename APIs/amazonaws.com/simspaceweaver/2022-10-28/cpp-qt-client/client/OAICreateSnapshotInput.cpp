...
OAICreateSnapshotInput_Destination OAICreateSnapshotInput::getDestination() const {
    return m_destination;
}
void OAICreateSnapshotInput::setDestination(const OAICreateSnapshotInput_Destination &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAICreateSnapshotInput::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAICreateSnapshotInput::is_destination_Valid() const{
    return m_destination_isValid;
}

QString OAICreateSnapshotInput::getSimulation() const {
    return m_simulation;
}
void OAICreateSnapshotInput::setSimulation(const QString &simulation) {
    m_simulation = simulation;
    m_simulation_isSet = true;
}

bool OAICreateSnapshotInput::is_simulation_Set() const{
    return m_simulation_isSet;
}

bool OAICreateSnapshotInput::is_simulation_Valid() const{
