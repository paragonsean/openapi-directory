...
/*
 * OAIStartApp_request.h
 *
 * 
 */

#ifndef OAIStartApp_request_H
#define OAIStartApp_request_H
...
namespace OpenAPI {
class OAIStartApp_request_LaunchOverrides;

class OAIStartApp_request : public OAIObject {
public:
    OAIStartApp_request();
    OAIStartApp_request(QString json);
    ~OAIStartApp_request() override;
    ...
    OAIStartApp_request_LaunchOverrides getLaunchOverrides() const;
    void setLaunchOverrides(const OAIStartApp_request_LaunchOverrides &launch_overrides);
...
private:
    ...
    OAIStartApp_request_LaunchOverrides m_launch_overrides;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartApp_request)

#endif // OAIStartApp_request_H
