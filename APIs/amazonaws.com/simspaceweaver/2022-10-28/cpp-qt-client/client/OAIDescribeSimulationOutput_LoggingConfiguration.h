...
/*
 * OAIDescribeSimulationOutput_LoggingConfiguration.h
 *
 * 
 */

#ifndef OAIDescribeSimulationOutput_LoggingConfiguration_H
#define OAIDescribeSimulationOutput_LoggingConfiguration_H
...
class OAIDescribeSimulationOutput_LoggingConfiguration : public OAIObject {
public:
    OAIDescribeSimulationOutput_LoggingConfiguration();
    OAIDescribeSimulationOutput_LoggingConfiguration(QString json);
    ~OAIDescribeSimulationOutput_LoggingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSimulationOutput_LoggingConfiguration)

#endif // OAIDescribeSimulationOutput_LoggingConfiguration_H
