...
/*
 * OAISimulationStatus.h
 *
 * 
 */

#ifndef OAISimulationStatus_H
#define OAISimulationStatus_H
...
class OAISimulationStatus : public OAIEnum {
public:
    OAISimulationStatus();
    OAISimulationStatus(QString json);
    ~OAISimulationStatus() override;
    ...
    enum class eOAISimulationStatus {
    ...
    OAISimulationStatus::eOAISimulationStatus getValue() const;
    void setValue(const OAISimulationStatus::eOAISimulationStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAISimulationStatus)

#endif // OAISimulationStatus_H
