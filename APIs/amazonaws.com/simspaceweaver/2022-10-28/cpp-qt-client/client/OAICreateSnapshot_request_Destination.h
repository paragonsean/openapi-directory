...
/*
 * OAICreateSnapshot_request_Destination.h
 *
 * An Amazon S3 bucket and optional folder (object key prefix) where SimSpace Weaver creates a file.
 */

#ifndef OAICreateSnapshot_request_Destination_H
#define OAICreateSnapshot_request_Destination_H
...
class OAICreateSnapshot_request_Destination : public OAIObject {
public:
    OAICreateSnapshot_request_Destination();
    OAICreateSnapshot_request_Destination(QString json);
    ~OAICreateSnapshot_request_Destination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSnapshot_request_Destination)

#endif // OAICreateSnapshot_request_Destination_H
