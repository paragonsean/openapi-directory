...
/*
 * OAISimulationAppStatus.h
 *
 * 
 */

#ifndef OAISimulationAppStatus_H
#define OAISimulationAppStatus_H
...
class OAISimulationAppStatus : public OAIEnum {
public:
    OAISimulationAppStatus();
    OAISimulationAppStatus(QString json);
    ~OAISimulationAppStatus() override;
    ...
    enum class eOAISimulationAppStatus {
    ...
    OAISimulationAppStatus::eOAISimulationAppStatus getValue() const;
    void setValue(const OAISimulationAppStatus::eOAISimulationAppStatus& value);
...
private:
    ...
    eOAISimulationAppStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimulationAppStatus)

#endif // OAISimulationAppStatus_H
