...
/*
 * OAIStartClockInput.h
 *
 * 
 */

#ifndef OAIStartClockInput_H
#define OAIStartClockInput_H
...
class OAIStartClockInput : public OAIObject {
public:
    OAIStartClockInput();
    OAIStartClockInput(QString json);
    ~OAIStartClockInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartClockInput)

#endif // OAIStartClockInput_H
