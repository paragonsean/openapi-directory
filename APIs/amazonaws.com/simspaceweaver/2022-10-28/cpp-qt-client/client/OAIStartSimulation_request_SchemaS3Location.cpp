...
OAIStartSimulation_request_SchemaS3Location::OAIStartSimulation_request_SchemaS3Location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSimulation_request_SchemaS3Location::OAIStartSimulation_request_SchemaS3Location() {
    this->initializeModel();
}

OAIStartSimulation_request_SchemaS3Location::~OAIStartSimulation_request_SchemaS3Location() {}

void OAIStartSimulation_request_SchemaS3Location::initializeModel() {
...
void OAIStartSimulation_request_SchemaS3Location::fromJson(QString jsonString) {
...
void OAIStartSimulation_request_SchemaS3Location::fromJsonObject(QJsonObject json) {
...
QString OAIStartSimulation_request_SchemaS3Location::asJson() const {
...
QJsonObject OAIStartSimulation_request_SchemaS3Location::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartSimulation_request_SchemaS3Location::getBucketName() const {
    return m_bucket_name;
}
void OAIStartSimulation_request_SchemaS3Location::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIStartSimulation_request_SchemaS3Location::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIStartSimulation_request_SchemaS3Location::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAIStartSimulation_request_SchemaS3Location::getObjectKey() const {
    return m_object_key;
}
void OAIStartSimulation_request_SchemaS3Location::setObjectKey(const QString &object_key) {
    m_object_key = object_key;
    m_object_key_isSet = true;
}

bool OAIStartSimulation_request_SchemaS3Location::is_object_key_Set() const{
    return m_object_key_isSet;
}

bool OAIStartSimulation_request_SchemaS3Location::is_object_key_Valid() const{
    return m_object_key_isValid;
}

bool OAIStartSimulation_request_SchemaS3Location::isSet() const {
...
bool OAIStartSimulation_request_SchemaS3Location::isValid() const {
