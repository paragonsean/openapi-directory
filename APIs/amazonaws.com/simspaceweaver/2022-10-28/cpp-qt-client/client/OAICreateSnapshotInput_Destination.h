...
/*
 * OAICreateSnapshotInput_Destination.h
 *
 * 
 */

#ifndef OAICreateSnapshotInput_Destination_H
#define OAICreateSnapshotInput_Destination_H
...
class OAICreateSnapshotInput_Destination : public OAIObject {
public:
    OAICreateSnapshotInput_Destination();
    OAICreateSnapshotInput_Destination(QString json);
    ~OAICreateSnapshotInput_Destination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSnapshotInput_Destination)

#endif // OAICreateSnapshotInput_Destination_H
