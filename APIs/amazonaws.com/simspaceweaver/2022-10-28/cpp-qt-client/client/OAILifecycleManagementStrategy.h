...
/*
 * OAILifecycleManagementStrategy.h
 *
 * 
 */

#ifndef OAILifecycleManagementStrategy_H
#define OAILifecycleManagementStrategy_H
...
class OAILifecycleManagementStrategy : public OAIEnum {
public:
    OAILifecycleManagementStrategy();
    OAILifecycleManagementStrategy(QString json);
    ~OAILifecycleManagementStrategy() override;
    ...
    enum class eOAILifecycleManagementStrategy {
    ...
    OAILifecycleManagementStrategy::eOAILifecycleManagementStrategy getValue() const;
    void setValue(const OAILifecycleManagementStrategy::eOAILifecycleManagementStrategy& value);
...
private:
    ...
    eOAILifecycleManagementStrategy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILifecycleManagementStrategy)

#endif // OAILifecycleManagementStrategy_H
