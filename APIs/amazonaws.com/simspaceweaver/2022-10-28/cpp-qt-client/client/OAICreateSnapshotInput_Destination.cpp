...
OAICreateSnapshotInput_Destination::OAICreateSnapshotInput_Destination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSnapshotInput_Destination::OAICreateSnapshotInput_Destination() {
    this->initializeModel();
}

OAICreateSnapshotInput_Destination::~OAICreateSnapshotInput_Destination() {}

void OAICreateSnapshotInput_Destination::initializeModel() {
...
void OAICreateSnapshotInput_Destination::fromJson(QString jsonString) {
...
void OAICreateSnapshotInput_Destination::fromJsonObject(QJsonObject json) {
...
QString OAICreateSnapshotInput_Destination::asJson() const {
...
QJsonObject OAICreateSnapshotInput_Destination::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSnapshotInput_Destination::getBucketName() const {
    return m_bucket_name;
}
void OAICreateSnapshotInput_Destination::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAICreateSnapshotInput_Destination::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAICreateSnapshotInput_Destination::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAICreateSnapshotInput_Destination::getObjectKeyPrefix() const {
    return m_object_key_prefix;
}
void OAICreateSnapshotInput_Destination::setObjectKeyPrefix(const QString &object_key_prefix) {
    m_object_key_prefix = object_key_prefix;
    m_object_key_prefix_isSet = true;
}

bool OAICreateSnapshotInput_Destination::is_object_key_prefix_Set() const{
    return m_object_key_prefix_isSet;
}

bool OAICreateSnapshotInput_Destination::is_object_key_prefix_Valid() const{
    return m_object_key_prefix_isValid;
}

bool OAICreateSnapshotInput_Destination::isSet() const {
...
bool OAICreateSnapshotInput_Destination::isValid() const {
