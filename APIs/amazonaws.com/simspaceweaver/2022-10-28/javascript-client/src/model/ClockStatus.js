...
* @readonly
*/
export default class ClockStatus {
    ...
    /**
    * Returns a <code>ClockStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ClockStatus} The enum <code>ClockStatus</code> value.
    */
