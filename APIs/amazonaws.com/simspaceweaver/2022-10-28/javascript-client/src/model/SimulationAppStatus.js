...
* @readonly
*/
export default class SimulationAppStatus {
    ...
    /**
    * Returns a <code>SimulationAppStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SimulationAppStatus} The enum <code>SimulationAppStatus</code> value.
    */
