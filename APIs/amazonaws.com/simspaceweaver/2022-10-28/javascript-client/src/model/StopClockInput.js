...
/**
 * The StopClockInput model module.
 * @module model/StopClockInput
 * @version 2022-10-28
 */
class StopClockInput {
    /**
     * Constructs a new <code>StopClockInput</code>.
     * @alias module:model/StopClockInput
     * @param simulation {String} 
     */
    constructor(simulation) { 
        
        StopClockInput.initialize(this, simulation);
    }
    ...
    /**
     * Constructs a <code>StopClockInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopClockInput} obj Optional instance to populate.
     * @return {module:model/StopClockInput} The populated <code>StopClockInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopClockInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StopClockInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopClockInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopClockInput.RequiredProperties) {
...
StopClockInput.RequiredProperties = ["Simulation"];

/**
 * @member {String} Simulation
 */
StopClockInput.prototype['Simulation'] = undefined;
