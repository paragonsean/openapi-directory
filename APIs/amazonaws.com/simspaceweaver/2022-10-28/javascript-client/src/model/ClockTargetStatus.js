...
* @readonly
*/
export default class ClockTargetStatus {
    ...
    /**
    * Returns a <code>ClockTargetStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ClockTargetStatus} The enum <code>ClockTargetStatus</code> value.
    */
