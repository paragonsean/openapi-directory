...
/**
 * The StartSimulationRequestSchemaS3Location model module.
 * @module model/StartSimulationRequestSchemaS3Location
 * @version 2022-10-28
 */
class StartSimulationRequestSchemaS3Location {
    /**
     * Constructs a new <code>StartSimulationRequestSchemaS3Location</code>.
     ...
     * @alias module:model/StartSimulationRequestSchemaS3Location
     */
    constructor() { 
        
        StartSimulationRequestSchemaS3Location.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartSimulationRequestSchemaS3Location</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartSimulationRequestSchemaS3Location} obj Optional instance to populate.
     * @return {module:model/StartSimulationRequestSchemaS3Location} The populated <code>StartSimulationRequestSchemaS3Location</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartSimulationRequestSchemaS3Location();
    ...
    /**
     * Validates the JSON data with respect to <code>StartSimulationRequestSchemaS3Location</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartSimulationRequestSchemaS3Location</code>.
     */
 ...
 */
StartSimulationRequestSchemaS3Location.prototype['BucketName'] = undefined;

/**
 * @member {String} ObjectKey
 */
StartSimulationRequestSchemaS3Location.prototype['ObjectKey'] = undefined;
...
export default StartSimulationRequestSchemaS3Location;
