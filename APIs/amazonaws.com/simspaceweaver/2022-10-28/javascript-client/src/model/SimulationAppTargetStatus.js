...
* @readonly
*/
export default class SimulationAppTargetStatus {
    ...
    /**
    * Returns a <code>SimulationAppTargetStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SimulationAppTargetStatus} The enum <code>SimulationAppTargetStatus</code> value.
    */
