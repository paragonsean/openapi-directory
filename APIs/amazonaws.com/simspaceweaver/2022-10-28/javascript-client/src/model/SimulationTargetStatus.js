...
* @readonly
*/
export default class SimulationTargetStatus {
    ...
    /**
    * Returns a <code>SimulationTargetStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SimulationTargetStatus} The enum <code>SimulationTargetStatus</code> value.
    */
