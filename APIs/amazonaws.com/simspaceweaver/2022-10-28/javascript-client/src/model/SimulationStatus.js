...
export default class SimulationStatus {
    ...
    /**
    * Returns a <code>SimulationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SimulationStatus} The enum <code>SimulationStatus</code> value.
    */
