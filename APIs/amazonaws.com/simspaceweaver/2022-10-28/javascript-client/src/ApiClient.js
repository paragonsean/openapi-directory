...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://simspaceweaver.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://simspaceweaver.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2022-10-28/Javascript'
        };
