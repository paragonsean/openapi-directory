...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartClockRequest();
  });
  ...
  describe('StartClockRequest', function() {
    it('should create an instance of StartClockRequest', function() {
      // uncomment below and update the code to test StartClockRequest
      //var instance = new AwsSimSpaceWeaver.StartClockRequest();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartClockRequest);
    });
