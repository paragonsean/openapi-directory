...
(function(root, factory) {
  ...
  describe('ClockTargetStatus', function() {
    it('should create an instance of ClockTargetStatus', function() {
      // uncomment below and update the code to test ClockTargetStatus
      //var instance = new AwsSimSpaceWeaver.ClockTargetStatus();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.ClockTargetStatus);
    });
