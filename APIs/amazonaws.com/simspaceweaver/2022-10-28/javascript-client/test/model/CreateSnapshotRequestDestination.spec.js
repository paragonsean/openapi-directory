...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.CreateSnapshotRequestDestination();
  });
  ...
  describe('CreateSnapshotRequestDestination', function() {
    it('should create an instance of CreateSnapshotRequestDestination', function() {
      // uncomment below and update the code to test CreateSnapshotRequestDestination
      //var instance = new AwsSimSpaceWeaver.CreateSnapshotRequestDestination();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.CreateSnapshotRequestDestination);
    });
