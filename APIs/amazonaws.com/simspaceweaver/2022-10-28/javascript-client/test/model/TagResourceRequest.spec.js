...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsSimSpaceWeaver.TagResourceRequest();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.TagResourceRequest);
    });
