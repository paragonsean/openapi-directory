...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.SimulationAppMetadata();
  });
  ...
  describe('SimulationAppMetadata', function() {
    it('should create an instance of SimulationAppMetadata', function() {
      // uncomment below and update the code to test SimulationAppMetadata
      //var instance = new AwsSimSpaceWeaver.SimulationAppMetadata();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationAppMetadata);
    });
