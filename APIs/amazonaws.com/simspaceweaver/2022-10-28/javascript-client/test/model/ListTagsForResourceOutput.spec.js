...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.ListTagsForResourceOutput();
  });
  ...
  describe('ListTagsForResourceOutput', function() {
    it('should create an instance of ListTagsForResourceOutput', function() {
      ...
      //var instance = new AwsSimSpaceWeaver.ListTagsForResourceOutput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.ListTagsForResourceOutput);
    });
