...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StopAppRequest();
  });
  ...
  describe('StopAppRequest', function() {
    it('should create an instance of StopAppRequest', function() {
      // uncomment below and update the code to test StopAppRequest
      //var instance = new AwsSimSpaceWeaver.StopAppRequest();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StopAppRequest);
    });
