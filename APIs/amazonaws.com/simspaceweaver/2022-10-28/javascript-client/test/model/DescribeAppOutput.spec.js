...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.DescribeAppOutput();
  });
  ...
  describe('DescribeAppOutput', function() {
    it('should create an instance of DescribeAppOutput', function() {
      // uncomment below and update the code to test DescribeAppOutput
      //var instance = new AwsSimSpaceWeaver.DescribeAppOutput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.DescribeAppOutput);
    });
