...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartSimulationOutput();
  });
  ...
  describe('StartSimulationOutput', function() {
    it('should create an instance of StartSimulationOutput', function() {
      // uncomment below and update the code to test StartSimulationOutput
      //var instance = new AwsSimSpaceWeaver.StartSimulationOutput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartSimulationOutput);
    });
