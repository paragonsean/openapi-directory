...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.ListAppsOutput();
  });
  ...
  describe('ListAppsOutput', function() {
    it('should create an instance of ListAppsOutput', function() {
      // uncomment below and update the code to test ListAppsOutput
      //var instance = new AwsSimSpaceWeaver.ListAppsOutput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.ListAppsOutput);
    });
