...
(function(root, factory) {
  ...
  describe('SimulationStatus', function() {
    it('should create an instance of SimulationStatus', function() {
      // uncomment below and update the code to test SimulationStatus
      //var instance = new AwsSimSpaceWeaver.SimulationStatus();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationStatus);
    });
