...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartAppOutput();
  });
  ...
  describe('StartAppOutput', function() {
    it('should create an instance of StartAppOutput', function() {
      // uncomment below and update the code to test StartAppOutput
      //var instance = new AwsSimSpaceWeaver.StartAppOutput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartAppOutput);
    });
