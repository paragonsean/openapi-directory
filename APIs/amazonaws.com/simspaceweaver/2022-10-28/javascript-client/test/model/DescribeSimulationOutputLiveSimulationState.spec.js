...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.DescribeSimulationOutputLiveSimulationState();
  });
  ...
  describe('DescribeSimulationOutputLiveSimulationState', function() {
    it('should create an instance of DescribeSimulationOutputLiveSimulationState', function() {
      // uncomment below and update the code to test DescribeSimulationOutputLiveSimulationState
      //var instance = new AwsSimSpaceWeaver.DescribeSimulationOutputLiveSimulationState();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.DescribeSimulationOutputLiveSimulationState);
    });
