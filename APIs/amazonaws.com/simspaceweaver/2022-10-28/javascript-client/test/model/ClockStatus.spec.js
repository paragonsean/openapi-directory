...
(function(root, factory) {
  ...
  describe('ClockStatus', function() {
    it('should create an instance of ClockStatus', function() {
      // uncomment below and update the code to test ClockStatus
      //var instance = new AwsSimSpaceWeaver.ClockStatus();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.ClockStatus);
    });
