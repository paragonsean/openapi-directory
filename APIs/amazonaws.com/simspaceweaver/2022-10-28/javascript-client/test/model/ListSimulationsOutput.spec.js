...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.ListSimulationsOutput();
  });
  ...
  describe('ListSimulationsOutput', function() {
    it('should create an instance of ListSimulationsOutput', function() {
      // uncomment below and update the code to test ListSimulationsOutput
      //var instance = new AwsSimSpaceWeaver.ListSimulationsOutput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.ListSimulationsOutput);
    });
