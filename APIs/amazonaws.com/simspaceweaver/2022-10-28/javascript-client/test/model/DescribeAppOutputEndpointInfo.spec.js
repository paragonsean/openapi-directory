...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.DescribeAppOutputEndpointInfo();
  });
  ...
  describe('DescribeAppOutputEndpointInfo', function() {
    it('should create an instance of DescribeAppOutputEndpointInfo', function() {
      // uncomment below and update the code to test DescribeAppOutputEndpointInfo
      //var instance = new AwsSimSpaceWeaver.DescribeAppOutputEndpointInfo();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.DescribeAppOutputEndpointInfo);
    });
    ...
    it('should have the property ingressPortMappings (base name: "IngressPortMappings")', function() {
      // uncomment below and update the code to test the property ingressPortMappings
      //var instance = new AwsSimSpaceWeaver.DescribeAppOutputEndpointInfo();
      //expect(instance).to.be();
    });
