...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StopSimulationInput();
  });
  ...
  describe('StopSimulationInput', function() {
    it('should create an instance of StopSimulationInput', function() {
      // uncomment below and update the code to test StopSimulationInput
      //var instance = new AwsSimSpaceWeaver.StopSimulationInput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StopSimulationInput);
    });
