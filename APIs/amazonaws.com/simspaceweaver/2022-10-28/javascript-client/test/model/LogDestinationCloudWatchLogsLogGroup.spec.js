...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.LogDestinationCloudWatchLogsLogGroup();
  });
  ...
  describe('LogDestinationCloudWatchLogsLogGroup', function() {
    it('should create an instance of LogDestinationCloudWatchLogsLogGroup', function() {
      // uncomment below and update the code to test LogDestinationCloudWatchLogsLogGroup
      //var instance = new AwsSimSpaceWeaver.LogDestinationCloudWatchLogsLogGroup();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.LogDestinationCloudWatchLogsLogGroup);
    });
