...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartSimulationRequestSchemaS3Location();
  });
  ...
  describe('StartSimulationRequestSchemaS3Location', function() {
    it('should create an instance of StartSimulationRequestSchemaS3Location', function() {
      // uncomment below and update the code to test StartSimulationRequestSchemaS3Location
      //var instance = new AwsSimSpaceWeaver.StartSimulationRequestSchemaS3Location();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartSimulationRequestSchemaS3Location);
    });
