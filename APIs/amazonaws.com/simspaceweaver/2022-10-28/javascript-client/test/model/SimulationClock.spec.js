...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.SimulationClock();
  });
  ...
  describe('SimulationClock', function() {
    it('should create an instance of SimulationClock', function() {
      // uncomment below and update the code to test SimulationClock
      //var instance = new AwsSimSpaceWeaver.SimulationClock();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationClock);
    });
