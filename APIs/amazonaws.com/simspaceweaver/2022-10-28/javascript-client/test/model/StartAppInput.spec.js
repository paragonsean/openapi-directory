...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartAppInput();
  });
  ...
  describe('StartAppInput', function() {
    it('should create an instance of StartAppInput', function() {
      // uncomment below and update the code to test StartAppInput
      //var instance = new AwsSimSpaceWeaver.StartAppInput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartAppInput);
    });
