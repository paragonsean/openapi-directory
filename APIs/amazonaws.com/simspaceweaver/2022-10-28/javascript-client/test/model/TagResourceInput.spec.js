...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new AwsSimSpaceWeaver.TagResourceInput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.TagResourceInput);
    });
