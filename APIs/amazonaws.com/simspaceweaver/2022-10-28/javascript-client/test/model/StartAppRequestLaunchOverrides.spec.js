...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartAppRequestLaunchOverrides();
  });
  ...
  describe('StartAppRequestLaunchOverrides', function() {
    it('should create an instance of StartAppRequestLaunchOverrides', function() {
      // uncomment below and update the code to test StartAppRequestLaunchOverrides
      //var instance = new AwsSimSpaceWeaver.StartAppRequestLaunchOverrides();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartAppRequestLaunchOverrides);
    });

    it('should have the property launchCommands (base name: "LaunchCommands")', function() {
      // uncomment below and update the code to test the property launchCommands
      //var instance = new AwsSimSpaceWeaver.StartAppRequestLaunchOverrides();
