...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.CreateSnapshotRequest();
  });
  ...
  describe('CreateSnapshotRequest', function() {
    it('should create an instance of CreateSnapshotRequest', function() {
      ...
      //var instance = new AwsSimSpaceWeaver.CreateSnapshotRequest();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.CreateSnapshotRequest);
    });
