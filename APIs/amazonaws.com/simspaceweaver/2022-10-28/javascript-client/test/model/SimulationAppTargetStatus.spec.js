...
(function(root, factory) {
  ...
  describe('SimulationAppTargetStatus', function() {
    it('should create an instance of SimulationAppTargetStatus', function() {
      // uncomment below and update the code to test SimulationAppTargetStatus
      //var instance = new AwsSimSpaceWeaver.SimulationAppTargetStatus();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationAppTargetStatus);
    });
