...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.CloudWatchLogsLogGroup();
  });
  ...
  describe('CloudWatchLogsLogGroup', function() {
    it('should create an instance of CloudWatchLogsLogGroup', function() {
      // uncomment below and update the code to test CloudWatchLogsLogGroup
      //var instance = new AwsSimSpaceWeaver.CloudWatchLogsLogGroup();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.CloudWatchLogsLogGroup);
    });
