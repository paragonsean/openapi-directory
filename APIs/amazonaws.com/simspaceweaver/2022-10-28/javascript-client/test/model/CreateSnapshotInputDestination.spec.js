...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.CreateSnapshotInputDestination();
  });
  ...
  describe('CreateSnapshotInputDestination', function() {
    it('should create an instance of CreateSnapshotInputDestination', function() {
      // uncomment below and update the code to test CreateSnapshotInputDestination
      //var instance = new AwsSimSpaceWeaver.CreateSnapshotInputDestination();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.CreateSnapshotInputDestination);
    });
