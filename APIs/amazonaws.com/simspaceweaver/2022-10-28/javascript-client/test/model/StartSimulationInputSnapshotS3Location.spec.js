...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartSimulationInputSnapshotS3Location();
  });
  ...
  describe('StartSimulationInputSnapshotS3Location', function() {
    it('should create an instance of StartSimulationInputSnapshotS3Location', function() {
      // uncomment below and update the code to test StartSimulationInputSnapshotS3Location
      //var instance = new AwsSimSpaceWeaver.StartSimulationInputSnapshotS3Location();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartSimulationInputSnapshotS3Location);
    });
