...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.DescribeSimulationOutputSchemaS3Location();
  });
  ...
  describe('DescribeSimulationOutputSchemaS3Location', function() {
    it('should create an instance of DescribeSimulationOutputSchemaS3Location', function() {
      // uncomment below and update the code to test DescribeSimulationOutputSchemaS3Location
      //var instance = new AwsSimSpaceWeaver.DescribeSimulationOutputSchemaS3Location();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.DescribeSimulationOutputSchemaS3Location);
    });
