...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.LoggingConfiguration();
  });
  ...
  describe('LoggingConfiguration', function() {
    it('should create an instance of LoggingConfiguration', function() {
      ...
      //var instance = new AwsSimSpaceWeaver.LoggingConfiguration();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.LoggingConfiguration);
    });
