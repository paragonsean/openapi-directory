...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.LiveSimulationState();
  });
  ...
  describe('LiveSimulationState', function() {
    it('should create an instance of LiveSimulationState', function() {
      // uncomment below and update the code to test LiveSimulationState
      //var instance = new AwsSimSpaceWeaver.LiveSimulationState();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.LiveSimulationState);
    });

    it('should have the property clocks (base name: "Clocks")', function() {
      // uncomment below and update the code to test the property clocks
      //var instance = new AwsSimSpaceWeaver.LiveSimulationState();
