...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StopAppInput();
  });
  ...
  describe('StopAppInput', function() {
    it('should create an instance of StopAppInput', function() {
      // uncomment below and update the code to test StopAppInput
      //var instance = new AwsSimSpaceWeaver.StopAppInput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StopAppInput);
    });
