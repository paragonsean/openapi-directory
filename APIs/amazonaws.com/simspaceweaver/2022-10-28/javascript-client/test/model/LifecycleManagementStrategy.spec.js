...
(function(root, factory) {
  ...
  describe('LifecycleManagementStrategy', function() {
    it('should create an instance of LifecycleManagementStrategy', function() {
      // uncomment below and update the code to test LifecycleManagementStrategy
      //var instance = new AwsSimSpaceWeaver.LifecycleManagementStrategy();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.LifecycleManagementStrategy);
    });
