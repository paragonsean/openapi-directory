...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.SimulationMetadata();
  });
  ...
  describe('SimulationMetadata', function() {
    it('should create an instance of SimulationMetadata', function() {
      // uncomment below and update the code to test SimulationMetadata
      //var instance = new AwsSimSpaceWeaver.SimulationMetadata();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationMetadata);
    });
