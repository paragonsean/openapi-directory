...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.SimulationAppPortMapping();
  });
  ...
  describe('SimulationAppPortMapping', function() {
    it('should create an instance of SimulationAppPortMapping', function() {
      // uncomment below and update the code to test SimulationAppPortMapping
      //var instance = new AwsSimSpaceWeaver.SimulationAppPortMapping();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationAppPortMapping);
    });
