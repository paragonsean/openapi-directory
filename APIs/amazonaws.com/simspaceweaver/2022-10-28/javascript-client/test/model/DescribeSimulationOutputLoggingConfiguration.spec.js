...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.DescribeSimulationOutputLoggingConfiguration();
  });
  ...
  describe('DescribeSimulationOutputLoggingConfiguration', function() {
    it('should create an instance of DescribeSimulationOutputLoggingConfiguration', function() {
      // uncomment below and update the code to test DescribeSimulationOutputLoggingConfiguration
      //var instance = new AwsSimSpaceWeaver.DescribeSimulationOutputLoggingConfiguration();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.DescribeSimulationOutputLoggingConfiguration);
    });
