...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartSimulationInputSchemaS3Location();
  });
  ...
  describe('StartSimulationInputSchemaS3Location', function() {
    it('should create an instance of StartSimulationInputSchemaS3Location', function() {
      // uncomment below and update the code to test StartSimulationInputSchemaS3Location
      //var instance = new AwsSimSpaceWeaver.StartSimulationInputSchemaS3Location();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartSimulationInputSchemaS3Location);
    });
