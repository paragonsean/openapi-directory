...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StopClockInput();
  });
  ...
  describe('StopClockInput', function() {
    it('should create an instance of StopClockInput', function() {
      // uncomment below and update the code to test StopClockInput
      //var instance = new AwsSimSpaceWeaver.StopClockInput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StopClockInput);
    });
