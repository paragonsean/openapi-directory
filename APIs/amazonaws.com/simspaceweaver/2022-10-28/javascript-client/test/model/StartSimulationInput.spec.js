...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartSimulationInput();
  });
  ...
  describe('StartSimulationInput', function() {
    it('should create an instance of StartSimulationInput', function() {
      // uncomment below and update the code to test StartSimulationInput
      //var instance = new AwsSimSpaceWeaver.StartSimulationInput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartSimulationInput);
    });
