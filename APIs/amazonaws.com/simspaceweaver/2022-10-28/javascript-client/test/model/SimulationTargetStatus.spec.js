...
(function(root, factory) {
  ...
  describe('SimulationTargetStatus', function() {
    it('should create an instance of SimulationTargetStatus', function() {
      // uncomment below and update the code to test SimulationTargetStatus
      //var instance = new AwsSimSpaceWeaver.SimulationTargetStatus();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationTargetStatus);
    });
