...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartClockInput();
  });
  ...
  describe('StartClockInput', function() {
    it('should create an instance of StartClockInput', function() {
      // uncomment below and update the code to test StartClockInput
      //var instance = new AwsSimSpaceWeaver.StartClockInput();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartClockInput);
    });
