...
(function(root, factory) {
  ...
  describe('SimulationAppStatus', function() {
    it('should create an instance of SimulationAppStatus', function() {
      // uncomment below and update the code to test SimulationAppStatus
      //var instance = new AwsSimSpaceWeaver.SimulationAppStatus();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationAppStatus);
    });
