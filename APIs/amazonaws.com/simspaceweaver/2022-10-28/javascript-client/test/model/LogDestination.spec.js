...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.LogDestination();
  });
  ...
  describe('LogDestination', function() {
    it('should create an instance of LogDestination', function() {
      // uncomment below and update the code to test LogDestination
      //var instance = new AwsSimSpaceWeaver.LogDestination();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.LogDestination);
    });

    it('should have the property cloudWatchLogsLogGroup (base name: "CloudWatchLogsLogGroup")', function() {
      // uncomment below and update the code to test the property cloudWatchLogsLogGroup
      //var instance = new AwsSimSpaceWeaver.LogDestination();
