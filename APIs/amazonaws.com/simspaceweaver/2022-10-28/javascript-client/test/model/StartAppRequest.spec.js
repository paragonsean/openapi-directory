...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.StartAppRequest();
  });
  ...
  describe('StartAppRequest', function() {
    it('should create an instance of StartAppRequest', function() {
      // uncomment below and update the code to test StartAppRequest
      //var instance = new AwsSimSpaceWeaver.StartAppRequest();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.StartAppRequest);
    });
    ...
    it('should have the property launchOverrides (base name: "LaunchOverrides")', function() {
      // uncomment below and update the code to test the property launchOverrides
      //var instance = new AwsSimSpaceWeaver.StartAppRequest();
      //expect(instance).to.be();
    });
