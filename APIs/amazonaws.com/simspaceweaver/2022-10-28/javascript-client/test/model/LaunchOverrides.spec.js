...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.LaunchOverrides();
  });
  ...
  describe('LaunchOverrides', function() {
    it('should create an instance of LaunchOverrides', function() {
      // uncomment below and update the code to test LaunchOverrides
      //var instance = new AwsSimSpaceWeaver.LaunchOverrides();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.LaunchOverrides);
    });
