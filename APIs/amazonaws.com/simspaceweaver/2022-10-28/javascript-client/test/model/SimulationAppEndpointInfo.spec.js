...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSimSpaceWeaver.SimulationAppEndpointInfo();
  });
  ...
  describe('SimulationAppEndpointInfo', function() {
    it('should create an instance of SimulationAppEndpointInfo', function() {
      // uncomment below and update the code to test SimulationAppEndpointInfo
      //var instance = new AwsSimSpaceWeaver.SimulationAppEndpointInfo();
      //expect(instance).to.be.a(AwsSimSpaceWeaver.SimulationAppEndpointInfo);
    });
