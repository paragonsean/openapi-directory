...
/**
 * Gets or Sets LifecycleManagementStrategy
 */
@JsonAdapter(LifecycleManagementStrategy.Adapter.class)
public enum LifecycleManagementStrategy {
  ...
  LifecycleManagementStrategy(String value) {
    this.value = value;
  }
  ...
  public static LifecycleManagementStrategy fromValue(String value) {
    for (LifecycleManagementStrategy b : LifecycleManagementStrategy.values()) {
  ...
  public static class Adapter extends TypeAdapter<LifecycleManagementStrategy> {
    @Override
    public void write(final JsonWriter jsonWriter, final LifecycleManagementStrategy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LifecycleManagementStrategy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LifecycleManagementStrategy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LifecycleManagementStrategy.fromValue(value);
  }
}
