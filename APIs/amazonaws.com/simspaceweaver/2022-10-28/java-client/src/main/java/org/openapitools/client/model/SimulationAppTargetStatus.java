...
/**
 * Gets or Sets SimulationAppTargetStatus
 */
@JsonAdapter(SimulationAppTargetStatus.Adapter.class)
public enum SimulationAppTargetStatus {
  ...
  SimulationAppTargetStatus(String value) {
    this.value = value;
  }
  ...
  public static SimulationAppTargetStatus fromValue(String value) {
    for (SimulationAppTargetStatus b : SimulationAppTargetStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<SimulationAppTargetStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final SimulationAppTargetStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SimulationAppTargetStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SimulationAppTargetStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SimulationAppTargetStatus.fromValue(value);
  }
}
