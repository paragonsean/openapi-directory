...
/**
 * Gets or Sets ClockStatus
 */
@JsonAdapter(ClockStatus.Adapter.class)
public enum ClockStatus {
  ...
  public static ClockStatus fromValue(String value) {
    for (ClockStatus b : ClockStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClockStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClockStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClockStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClockStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ClockStatus.fromValue(value);
  }
}
