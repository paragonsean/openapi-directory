...
public class ApiClient {
    ...
    private String basePath = "http://simspaceweaver.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://simspaceweaver.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://simspaceweaver.{region}.amazonaws.com",
      "The AWS SimSpace Weaver multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://simspaceweaver.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://simspaceweaver.{region}.amazonaws.com.cn",
      "The AWS SimSpace Weaver endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2022-10-28/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://simspaceweaver.us-east-1.amazonaws.com
