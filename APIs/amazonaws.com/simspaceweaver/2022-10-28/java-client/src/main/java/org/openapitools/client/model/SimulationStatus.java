...
/**
 * Gets or Sets SimulationStatus
 */
@JsonAdapter(SimulationStatus.Adapter.class)
public enum SimulationStatus {
  ...
  public static SimulationStatus fromValue(String value) {
    for (SimulationStatus b : SimulationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<SimulationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final SimulationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SimulationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SimulationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SimulationStatus.fromValue(value);
  }
}
