...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://sms-voice.pinpoint.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://sms-voice.pinpoint.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-09-05/Javascript'
        };
