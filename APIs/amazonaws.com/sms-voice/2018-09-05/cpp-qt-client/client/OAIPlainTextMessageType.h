...
/*
 * OAIPlainTextMessageType.h
 *
 * An object that defines a message that contains unformatted text.
 */

#ifndef OAIPlainTextMessageType_H
#define OAIPlainTextMessageType_H
...
class OAIPlainTextMessageType : public OAIObject {
public:
    OAIPlainTextMessageType();
    OAIPlainTextMessageType(QString json);
    ~OAIPlainTextMessageType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlainTextMessageType)

#endif // OAIPlainTextMessageType_H
