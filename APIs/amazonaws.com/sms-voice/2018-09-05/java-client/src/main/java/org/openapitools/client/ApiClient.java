...
public class ApiClient {
    ...
    private String basePath = "http://sms-voice.pinpoint.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-09-05/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://sms-voice.pinpoint.us-east-1.amazonaws.com
