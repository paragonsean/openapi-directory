...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.AiffSettings();
  });
  ...
  describe('AiffSettings', function() {
    it('should create an instance of AiffSettings', function() {
      // uncomment below and update the code to test AiffSettings
      //var instance = new AwsElementalMediaConvert.AiffSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.AiffSettings);
    });
