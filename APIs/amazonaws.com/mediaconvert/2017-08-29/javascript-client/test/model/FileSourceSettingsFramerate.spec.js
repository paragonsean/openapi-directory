...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.FileSourceSettingsFramerate();
  });
  ...
  describe('FileSourceSettingsFramerate', function() {
    it('should create an instance of FileSourceSettingsFramerate', function() {
      // uncomment below and update the code to test FileSourceSettingsFramerate
      //var instance = new AwsElementalMediaConvert.FileSourceSettingsFramerate();
      //expect(instance).to.be.a(AwsElementalMediaConvert.FileSourceSettingsFramerate);
    });
