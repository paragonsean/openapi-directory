...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.AudioCodecSettingsOpusSettings();
  });
  ...
  describe('AudioCodecSettingsOpusSettings', function() {
    it('should create an instance of AudioCodecSettingsOpusSettings', function() {
      // uncomment below and update the code to test AudioCodecSettingsOpusSettings
      //var instance = new AwsElementalMediaConvert.AudioCodecSettingsOpusSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.AudioCodecSettingsOpusSettings);
    });
