...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.AudioCodecSettingsAiffSettings();
  });
  ...
  describe('AudioCodecSettingsAiffSettings', function() {
    it('should create an instance of AudioCodecSettingsAiffSettings', function() {
      // uncomment below and update the code to test AudioCodecSettingsAiffSettings
      //var instance = new AwsElementalMediaConvert.AudioCodecSettingsAiffSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.AudioCodecSettingsAiffSettings);
    });
