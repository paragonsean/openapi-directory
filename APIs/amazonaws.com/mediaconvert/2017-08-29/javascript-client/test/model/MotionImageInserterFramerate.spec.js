...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.MotionImageInserterFramerate();
  });
  ...
  describe('MotionImageInserterFramerate', function() {
    it('should create an instance of MotionImageInserterFramerate', function() {
      // uncomment below and update the code to test MotionImageInserterFramerate
      //var instance = new AwsElementalMediaConvert.MotionImageInserterFramerate();
      //expect(instance).to.be.a(AwsElementalMediaConvert.MotionImageInserterFramerate);
    });
