...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.VideoCodecSettingsVp8Settings();
  });
  ...
  describe('VideoCodecSettingsVp8Settings', function() {
    it('should create an instance of VideoCodecSettingsVp8Settings', function() {
      // uncomment below and update the code to test VideoCodecSettingsVp8Settings
      //var instance = new AwsElementalMediaConvert.VideoCodecSettingsVp8Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.VideoCodecSettingsVp8Settings);
    });
