...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.VideoCodecSettingsH264Settings();
  });
  ...
  describe('VideoCodecSettingsH264Settings', function() {
    it('should create an instance of VideoCodecSettingsH264Settings', function() {
      // uncomment below and update the code to test VideoCodecSettingsH264Settings
      //var instance = new AwsElementalMediaConvert.VideoCodecSettingsH264Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.VideoCodecSettingsH264Settings);
    });
