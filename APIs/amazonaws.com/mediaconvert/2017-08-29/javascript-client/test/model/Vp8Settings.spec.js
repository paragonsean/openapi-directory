...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.Vp8Settings();
  });
  ...
  describe('Vp8Settings', function() {
    it('should create an instance of Vp8Settings', function() {
      // uncomment below and update the code to test Vp8Settings
      //var instance = new AwsElementalMediaConvert.Vp8Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.Vp8Settings);
    });
