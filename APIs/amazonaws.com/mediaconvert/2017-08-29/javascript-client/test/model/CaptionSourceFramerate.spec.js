...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.CaptionSourceFramerate();
  });
  ...
  describe('CaptionSourceFramerate', function() {
    it('should create an instance of CaptionSourceFramerate', function() {
      // uncomment below and update the code to test CaptionSourceFramerate
      //var instance = new AwsElementalMediaConvert.CaptionSourceFramerate();
      //expect(instance).to.be.a(AwsElementalMediaConvert.CaptionSourceFramerate);
    });
