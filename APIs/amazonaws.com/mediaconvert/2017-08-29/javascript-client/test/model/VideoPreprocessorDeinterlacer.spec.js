...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.VideoPreprocessorDeinterlacer();
  });
  ...
  describe('VideoPreprocessorDeinterlacer', function() {
    it('should create an instance of VideoPreprocessorDeinterlacer', function() {
      // uncomment below and update the code to test VideoPreprocessorDeinterlacer
      //var instance = new AwsElementalMediaConvert.VideoPreprocessorDeinterlacer();
      //expect(instance).to.be.a(AwsElementalMediaConvert.VideoPreprocessorDeinterlacer);
    });
