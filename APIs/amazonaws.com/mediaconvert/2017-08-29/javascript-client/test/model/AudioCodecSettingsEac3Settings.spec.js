...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.AudioCodecSettingsEac3Settings();
  });
  ...
  describe('AudioCodecSettingsEac3Settings', function() {
    it('should create an instance of AudioCodecSettingsEac3Settings', function() {
      // uncomment below and update the code to test AudioCodecSettingsEac3Settings
      //var instance = new AwsElementalMediaConvert.AudioCodecSettingsEac3Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.AudioCodecSettingsEac3Settings);
    });
