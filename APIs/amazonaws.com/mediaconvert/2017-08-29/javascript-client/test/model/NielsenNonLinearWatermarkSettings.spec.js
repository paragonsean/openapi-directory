...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.NielsenNonLinearWatermarkSettings();
  });
  ...
  describe('NielsenNonLinearWatermarkSettings', function() {
    it('should create an instance of NielsenNonLinearWatermarkSettings', function() {
      // uncomment below and update the code to test NielsenNonLinearWatermarkSettings
      //var instance = new AwsElementalMediaConvert.NielsenNonLinearWatermarkSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.NielsenNonLinearWatermarkSettings);
    });
