...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.ListQueuesResponse();
  });
  ...
  describe('ListQueuesResponse', function() {
    it('should create an instance of ListQueuesResponse', function() {
      ...
      //var instance = new AwsElementalMediaConvert.ListQueuesResponse();
      //expect(instance).to.be.a(AwsElementalMediaConvert.ListQueuesResponse);
    });
