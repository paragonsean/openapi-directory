...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.InputVideoSelector();
  });
  ...
  describe('InputVideoSelector', function() {
    it('should create an instance of InputVideoSelector', function() {
      // uncomment below and update the code to test InputVideoSelector
      //var instance = new AwsElementalMediaConvert.InputVideoSelector();
      //expect(instance).to.be.a(AwsElementalMediaConvert.InputVideoSelector);
    });
