...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.InputTemplate();
  });
  ...
  describe('InputTemplate', function() {
    it('should create an instance of InputTemplate', function() {
      // uncomment below and update the code to test InputTemplate
      //var instance = new AwsElementalMediaConvert.InputTemplate();
      //expect(instance).to.be.a(AwsElementalMediaConvert.InputTemplate);
    });
