...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.AudioCodecSettingsWavSettings();
  });
  ...
  describe('AudioCodecSettingsWavSettings', function() {
    it('should create an instance of AudioCodecSettingsWavSettings', function() {
      ...
      //var instance = new AwsElementalMediaConvert.AudioCodecSettingsWavSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.AudioCodecSettingsWavSettings);
    });
