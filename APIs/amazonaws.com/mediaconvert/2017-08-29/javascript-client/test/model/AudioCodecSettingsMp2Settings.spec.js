...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.AudioCodecSettingsMp2Settings();
  });
  ...
  describe('AudioCodecSettingsMp2Settings', function() {
    it('should create an instance of AudioCodecSettingsMp2Settings', function() {
      ...
      //var instance = new AwsElementalMediaConvert.AudioCodecSettingsMp2Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.AudioCodecSettingsMp2Settings);
    });
