...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.InputPosition();
  });
  ...
  describe('InputPosition', function() {
    it('should create an instance of InputPosition', function() {
      // uncomment below and update the code to test InputPosition
      //var instance = new AwsElementalMediaConvert.InputPosition();
      //expect(instance).to.be.a(AwsElementalMediaConvert.InputPosition);
    });
