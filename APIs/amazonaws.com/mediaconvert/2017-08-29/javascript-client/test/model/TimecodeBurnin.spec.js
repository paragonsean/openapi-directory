...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.TimecodeBurnin();
  });
  ...
  describe('TimecodeBurnin', function() {
    it('should create an instance of TimecodeBurnin', function() {
      // uncomment below and update the code to test TimecodeBurnin
      //var instance = new AwsElementalMediaConvert.TimecodeBurnin();
      //expect(instance).to.be.a(AwsElementalMediaConvert.TimecodeBurnin);
    });
