...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.ListPresetsResponse();
  });
  ...
  describe('ListPresetsResponse', function() {
    it('should create an instance of ListPresetsResponse', function() {
      // uncomment below and update the code to test ListPresetsResponse
      //var instance = new AwsElementalMediaConvert.ListPresetsResponse();
      //expect(instance).to.be.a(AwsElementalMediaConvert.ListPresetsResponse);
    });
