...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.Mp3Settings();
  });
  ...
  describe('Mp3Settings', function() {
    it('should create an instance of Mp3Settings', function() {
      // uncomment below and update the code to test Mp3Settings
      //var instance = new AwsElementalMediaConvert.Mp3Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.Mp3Settings);
    });
