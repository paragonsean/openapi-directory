...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.CmafGroupSettings();
  });
  ...
  describe('CmafGroupSettings', function() {
    it('should create an instance of CmafGroupSettings', function() {
      // uncomment below and update the code to test CmafGroupSettings
      //var instance = new AwsElementalMediaConvert.CmafGroupSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.CmafGroupSettings);
    });
