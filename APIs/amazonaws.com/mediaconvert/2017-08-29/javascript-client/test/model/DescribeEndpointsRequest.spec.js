...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.DescribeEndpointsRequest();
  });
  ...
  describe('DescribeEndpointsRequest', function() {
    it('should create an instance of DescribeEndpointsRequest', function() {
      // uncomment below and update the code to test DescribeEndpointsRequest
      //var instance = new AwsElementalMediaConvert.DescribeEndpointsRequest();
      //expect(instance).to.be.a(AwsElementalMediaConvert.DescribeEndpointsRequest);
    });
