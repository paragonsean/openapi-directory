...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.DashIsoGroupSettings();
  });
  ...
  describe('DashIsoGroupSettings', function() {
    it('should create an instance of DashIsoGroupSettings', function() {
      // uncomment below and update the code to test DashIsoGroupSettings
      //var instance = new AwsElementalMediaConvert.DashIsoGroupSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.DashIsoGroupSettings);
    });
