...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.Endpoint();
  });
  ...
  describe('Endpoint', function() {
    it('should create an instance of Endpoint', function() {
      ...
      //var instance = new AwsElementalMediaConvert.Endpoint();
      //expect(instance).to.be.a(AwsElementalMediaConvert.Endpoint);
    });
