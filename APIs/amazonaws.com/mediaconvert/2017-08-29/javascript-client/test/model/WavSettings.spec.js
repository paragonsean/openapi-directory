...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.WavSettings();
  });
  ...
  describe('WavSettings', function() {
    it('should create an instance of WavSettings', function() {
      ...
      //var instance = new AwsElementalMediaConvert.WavSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.WavSettings);
    });
