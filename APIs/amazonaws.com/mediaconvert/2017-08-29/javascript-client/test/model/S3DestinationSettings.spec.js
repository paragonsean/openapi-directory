...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.S3DestinationSettings();
  });
  ...
  describe('S3DestinationSettings', function() {
    it('should create an instance of S3DestinationSettings', function() {
      // uncomment below and update the code to test S3DestinationSettings
      //var instance = new AwsElementalMediaConvert.S3DestinationSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.S3DestinationSettings);
    });
