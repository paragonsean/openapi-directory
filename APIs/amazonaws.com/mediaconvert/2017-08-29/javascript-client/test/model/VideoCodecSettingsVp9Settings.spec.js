...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.VideoCodecSettingsVp9Settings();
  });
  ...
  describe('VideoCodecSettingsVp9Settings', function() {
    it('should create an instance of VideoCodecSettingsVp9Settings', function() {
      // uncomment below and update the code to test VideoCodecSettingsVp9Settings
      //var instance = new AwsElementalMediaConvert.VideoCodecSettingsVp9Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.VideoCodecSettingsVp9Settings);
    });
