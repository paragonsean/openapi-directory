...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.Mp2Settings();
  });
  ...
  describe('Mp2Settings', function() {
    it('should create an instance of Mp2Settings', function() {
      ...
      //var instance = new AwsElementalMediaConvert.Mp2Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.Mp2Settings);
    });
