...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.XavcSettings();
  });
  ...
  describe('XavcSettings', function() {
    it('should create an instance of XavcSettings', function() {
      // uncomment below and update the code to test XavcSettings
      //var instance = new AwsElementalMediaConvert.XavcSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.XavcSettings);
    });
