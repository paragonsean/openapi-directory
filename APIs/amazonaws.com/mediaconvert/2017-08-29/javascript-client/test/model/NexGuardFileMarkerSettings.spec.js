...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.NexGuardFileMarkerSettings();
  });
  ...
  describe('NexGuardFileMarkerSettings', function() {
    it('should create an instance of NexGuardFileMarkerSettings', function() {
      // uncomment below and update the code to test NexGuardFileMarkerSettings
      //var instance = new AwsElementalMediaConvert.NexGuardFileMarkerSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.NexGuardFileMarkerSettings);
    });
