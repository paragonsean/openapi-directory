...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.InputCrop();
  });
  ...
  describe('InputCrop', function() {
    it('should create an instance of InputCrop', function() {
      // uncomment below and update the code to test InputCrop
      //var instance = new AwsElementalMediaConvert.InputCrop();
      //expect(instance).to.be.a(AwsElementalMediaConvert.InputCrop);
    });
