...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.ListJobsResponse();
  });
  ...
  describe('ListJobsResponse', function() {
    it('should create an instance of ListJobsResponse', function() {
      ...
      //var instance = new AwsElementalMediaConvert.ListJobsResponse();
      //expect(instance).to.be.a(AwsElementalMediaConvert.ListJobsResponse);
    });
