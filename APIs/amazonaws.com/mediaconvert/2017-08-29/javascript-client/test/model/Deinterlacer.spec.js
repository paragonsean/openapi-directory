...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.Deinterlacer();
  });
  ...
  describe('Deinterlacer', function() {
    it('should create an instance of Deinterlacer', function() {
      // uncomment below and update the code to test Deinterlacer
      //var instance = new AwsElementalMediaConvert.Deinterlacer();
      //expect(instance).to.be.a(AwsElementalMediaConvert.Deinterlacer);
    });
