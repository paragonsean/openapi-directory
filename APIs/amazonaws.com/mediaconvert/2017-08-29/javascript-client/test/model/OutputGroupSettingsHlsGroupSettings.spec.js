...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.OutputGroupSettingsHlsGroupSettings();
  });
  ...
  describe('OutputGroupSettingsHlsGroupSettings', function() {
    it('should create an instance of OutputGroupSettingsHlsGroupSettings', function() {
      ...
      //var instance = new AwsElementalMediaConvert.OutputGroupSettingsHlsGroupSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.OutputGroupSettingsHlsGroupSettings);
    });
