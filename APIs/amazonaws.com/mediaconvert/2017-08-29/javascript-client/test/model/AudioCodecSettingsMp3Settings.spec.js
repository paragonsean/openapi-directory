...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.AudioCodecSettingsMp3Settings();
  });
  ...
  describe('AudioCodecSettingsMp3Settings', function() {
    it('should create an instance of AudioCodecSettingsMp3Settings', function() {
      // uncomment below and update the code to test AudioCodecSettingsMp3Settings
      //var instance = new AwsElementalMediaConvert.AudioCodecSettingsMp3Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.AudioCodecSettingsMp3Settings);
    });
