...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.Mpeg2Settings();
  });
  ...
  describe('Mpeg2Settings', function() {
    it('should create an instance of Mpeg2Settings', function() {
      ...
      //var instance = new AwsElementalMediaConvert.Mpeg2Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.Mpeg2Settings);
    });
    ...
    it('should have the property intraDcPrecision (base name: "IntraDcPrecision")', function() {
      // uncomment below and update the code to test the property intraDcPrecision
      //var instance = new AwsElementalMediaConvert.Mpeg2Settings();
      //expect(instance).to.be();
    });
