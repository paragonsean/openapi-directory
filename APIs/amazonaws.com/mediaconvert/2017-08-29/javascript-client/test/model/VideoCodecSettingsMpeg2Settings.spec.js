...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.VideoCodecSettingsMpeg2Settings();
  });
  ...
  describe('VideoCodecSettingsMpeg2Settings', function() {
    it('should create an instance of VideoCodecSettingsMpeg2Settings', function() {
      // uncomment below and update the code to test VideoCodecSettingsMpeg2Settings
      //var instance = new AwsElementalMediaConvert.VideoCodecSettingsMpeg2Settings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.VideoCodecSettingsMpeg2Settings);
    });
