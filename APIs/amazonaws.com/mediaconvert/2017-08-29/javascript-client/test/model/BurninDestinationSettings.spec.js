...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.BurninDestinationSettings();
  });
  ...
  describe('BurninDestinationSettings', function() {
    it('should create an instance of BurninDestinationSettings', function() {
      // uncomment below and update the code to test BurninDestinationSettings
      //var instance = new AwsElementalMediaConvert.BurninDestinationSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.BurninDestinationSettings);
    });
