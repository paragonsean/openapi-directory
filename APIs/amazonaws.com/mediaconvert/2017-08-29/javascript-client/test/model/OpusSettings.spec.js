...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaConvert.OpusSettings();
  });
  ...
  describe('OpusSettings', function() {
    it('should create an instance of OpusSettings', function() {
      // uncomment below and update the code to test OpusSettings
      //var instance = new AwsElementalMediaConvert.OpusSettings();
      //expect(instance).to.be.a(AwsElementalMediaConvert.OpusSettings);
    });
