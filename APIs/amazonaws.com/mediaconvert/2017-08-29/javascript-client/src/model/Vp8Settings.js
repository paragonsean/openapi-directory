...
/**
 * The Vp8Settings model module.
 * @module model/Vp8Settings
 * @version 2017-08-29
 */
class Vp8Settings {
    /**
     * Constructs a new <code>Vp8Settings</code>.
     * Required when you set Codec to the value VP8.
     * @alias module:model/Vp8Settings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Vp8Settings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Vp8Settings} obj Optional instance to populate.
     * @return {module:model/Vp8Settings} The populated <code>Vp8Settings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Vp8Settings();
    ...
    /**
     * Validates the JSON data with respect to <code>Vp8Settings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Vp8Settings</code>.
     */
