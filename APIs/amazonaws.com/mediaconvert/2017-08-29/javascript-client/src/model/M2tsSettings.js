...
/**
 * The M2tsSettings model module.
 * @module model/M2tsSettings
 * @version 2017-08-29
 */
class M2tsSettings {
    /**
     * Constructs a new <code>M2tsSettings</code>.
     ...
     * @alias module:model/M2tsSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>M2tsSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/M2tsSettings} obj Optional instance to populate.
     * @return {module:model/M2tsSettings} The populated <code>M2tsSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new M2tsSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>M2tsSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>M2tsSettings</code>.
     */
