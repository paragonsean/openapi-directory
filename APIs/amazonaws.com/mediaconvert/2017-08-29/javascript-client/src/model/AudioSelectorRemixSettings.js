...
/**
 * The AudioSelectorRemixSettings model module.
 * @module model/AudioSelectorRemixSettings
 * @version 2017-08-29
 */
class AudioSelectorRemixSettings {
    /**
     * Constructs a new <code>AudioSelectorRemixSettings</code>.
     * @alias module:model/AudioSelectorRemixSettings
     * @implements module:model/RemixSettings
     */
    constructor() { 
        RemixSettings.initialize(this);
        AudioSelectorRemixSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AudioSelectorRemixSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AudioSelectorRemixSettings} obj Optional instance to populate.
     * @return {module:model/AudioSelectorRemixSettings} The populated <code>AudioSelectorRemixSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AudioSelectorRemixSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>AudioSelectorRemixSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AudioSelectorRemixSettings</code>.
     */
 ...
 */
AudioSelectorRemixSettings.prototype['ChannelMapping'] = undefined;

/**
 * @member {Number} ChannelsIn
 */
AudioSelectorRemixSettings.prototype['ChannelsIn'] = undefined;

/**
 * @member {Number} ChannelsOut
 */
AudioSelectorRemixSettings.prototype['ChannelsOut'] = undefined;
...
export default AudioSelectorRemixSettings;
