...
import ColorCorrector from './ColorCorrector';
...
/**
 * The VideoPreprocessorColorCorrector model module.
 * @module model/VideoPreprocessorColorCorrector
 * @version 2017-08-29
 */
class VideoPreprocessorColorCorrector {
    /**
     * Constructs a new <code>VideoPreprocessorColorCorrector</code>.
     * @alias module:model/VideoPreprocessorColorCorrector
     * @implements module:model/ColorCorrector
     */
    constructor() { 
        ColorCorrector.initialize(this);
        VideoPreprocessorColorCorrector.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VideoPreprocessorColorCorrector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoPreprocessorColorCorrector} obj Optional instance to populate.
     * @return {module:model/VideoPreprocessorColorCorrector} The populated <code>VideoPreprocessorColorCorrector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoPreprocessorColorCorrector();
            ColorCorrector.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>VideoPreprocessorColorCorrector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoPreprocessorColorCorrector</code>.
     */
 ...
 */
VideoPreprocessorColorCorrector.prototype['Brightness'] = undefined;

/**
 * @member {module:model/ColorCorrectorClipLimits} ClipLimits
 */
VideoPreprocessorColorCorrector.prototype['ClipLimits'] = undefined;

/**
 * @member {module:model/ColorSpaceConversion} ColorSpaceConversion
 */
VideoPreprocessorColorCorrector.prototype['ColorSpaceConversion'] = undefined;

/**
 * @member {Number} Contrast
 */
VideoPreprocessorColorCorrector.prototype['Contrast'] = undefined;

/**
 * @member {module:model/ColorCorrectorHdr10Metadata} Hdr10Metadata
 */
VideoPreprocessorColorCorrector.prototype['Hdr10Metadata'] = undefined;

/**
 * @member {module:model/HDRToSDRToneMapper} HdrToSdrToneMapper
 */
VideoPreprocessorColorCorrector.prototype['HdrToSdrToneMapper'] = undefined;

/**
 * @member {Number} Hue
 */
VideoPreprocessorColorCorrector.prototype['Hue'] = undefined;

/**
 * @member {module:model/SampleRangeConversion} SampleRangeConversion
 */
VideoPreprocessorColorCorrector.prototype['SampleRangeConversion'] = undefined;

/**
 * @member {Number} Saturation
 */
VideoPreprocessorColorCorrector.prototype['Saturation'] = undefined;

/**
 * @member {Number} SdrReferenceWhiteLevel
 */
VideoPreprocessorColorCorrector.prototype['SdrReferenceWhiteLevel'] = undefined;


// Implement ColorCorrector interface:
/**
 * @member {Number} Brightness
 */
...
export default VideoPreprocessorColorCorrector;
