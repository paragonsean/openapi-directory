...
/**
 * The H264Settings model module.
 * @module model/H264Settings
 * @version 2017-08-29
 */
class H264Settings {
    /**
     * Constructs a new <code>H264Settings</code>.
     * Required when you set Codec to the value H_264.
     * @alias module:model/H264Settings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>H264Settings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/H264Settings} obj Optional instance to populate.
     * @return {module:model/H264Settings} The populated <code>H264Settings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new H264Settings();
    ...
    /**
     * Validates the JSON data with respect to <code>H264Settings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>H264Settings</code>.
     */
