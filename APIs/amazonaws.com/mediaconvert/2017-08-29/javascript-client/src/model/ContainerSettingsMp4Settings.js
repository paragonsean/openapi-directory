...
import Mp4Settings from './Mp4Settings';

/**
 * The ContainerSettingsMp4Settings model module.
 * @module model/ContainerSettingsMp4Settings
 * @version 2017-08-29
 */
class ContainerSettingsMp4Settings {
    /**
     * Constructs a new <code>ContainerSettingsMp4Settings</code>.
     * @alias module:model/ContainerSettingsMp4Settings
     * @implements module:model/Mp4Settings
     */
    constructor() { 
        Mp4Settings.initialize(this);
        ContainerSettingsMp4Settings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContainerSettingsMp4Settings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContainerSettingsMp4Settings} obj Optional instance to populate.
     * @return {module:model/ContainerSettingsMp4Settings} The populated <code>ContainerSettingsMp4Settings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContainerSettingsMp4Settings();
            Mp4Settings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ContainerSettingsMp4Settings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContainerSettingsMp4Settings</code>.
     */
 ...
 */
ContainerSettingsMp4Settings.prototype['AudioDuration'] = undefined;

/**
 * @member {module:model/Mp4CslgAtom} CslgAtom
 */
ContainerSettingsMp4Settings.prototype['CslgAtom'] = undefined;

/**
 * @member {Number} CttsVersion
 */
ContainerSettingsMp4Settings.prototype['CttsVersion'] = undefined;

/**
 * @member {module:model/Mp4FreeSpaceBox} FreeSpaceBox
 */
ContainerSettingsMp4Settings.prototype['FreeSpaceBox'] = undefined;

/**
 * @member {module:model/Mp4MoovPlacement} MoovPlacement
 */
ContainerSettingsMp4Settings.prototype['MoovPlacement'] = undefined;

/**
 * @member {String} Mp4MajorBrand
 */
ContainerSettingsMp4Settings.prototype['Mp4MajorBrand'] = undefined;


// Implement Mp4Settings interface:
/**
 * @member {module:model/CmfcAudioDuration} AudioDuration
 */
...
export default ContainerSettingsMp4Settings;
