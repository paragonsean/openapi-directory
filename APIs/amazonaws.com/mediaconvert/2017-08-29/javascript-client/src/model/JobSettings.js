...
class JobSettings {
     ...
     * @alias module:model/JobSettings
     */
    constructor() { 
     ...
     * @param {module:model/JobSettings} obj Optional instance to populate.
     * @return {module:model/JobSettings} The populated <code>JobSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>JobSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobSettings</code>.
     */
