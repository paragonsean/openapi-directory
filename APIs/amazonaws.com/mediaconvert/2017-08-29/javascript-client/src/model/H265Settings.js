...
/**
 * The H265Settings model module.
 * @module model/H265Settings
 * @version 2017-08-29
 */
class H265Settings {
    /**
     * Constructs a new <code>H265Settings</code>.
     * Settings for H265 codec
     * @alias module:model/H265Settings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>H265Settings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/H265Settings} obj Optional instance to populate.
     * @return {module:model/H265Settings} The populated <code>H265Settings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new H265Settings();
    ...
    /**
     * Validates the JSON data with respect to <code>H265Settings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>H265Settings</code>.
     */
