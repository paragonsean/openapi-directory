...
/**
 * The CmafGroupSettings model module.
 * @module model/CmafGroupSettings
 * @version 2017-08-29
 */
class CmafGroupSettings {
    /**
     * Constructs a new <code>CmafGroupSettings</code>.
     ...
     * @alias module:model/CmafGroupSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CmafGroupSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CmafGroupSettings} obj Optional instance to populate.
     * @return {module:model/CmafGroupSettings} The populated <code>CmafGroupSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CmafGroupSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>CmafGroupSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CmafGroupSettings</code>.
     */
...
export default CmafGroupSettings;
