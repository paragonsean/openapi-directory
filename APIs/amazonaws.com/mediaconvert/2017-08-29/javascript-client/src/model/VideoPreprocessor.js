...
/**
 * The VideoPreprocessor model module.
 * @module model/VideoPreprocessor
 * @version 2017-08-29
 */
class VideoPreprocessor {
    /**
     * Constructs a new <code>VideoPreprocessor</code>.
     ...
     * @alias module:model/VideoPreprocessor
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VideoPreprocessor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoPreprocessor} obj Optional instance to populate.
     * @return {module:model/VideoPreprocessor} The populated <code>VideoPreprocessor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoPreprocessor();
    ...
    /**
     * Validates the JSON data with respect to <code>VideoPreprocessor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoPreprocessor</code>.
     */
...
export default VideoPreprocessor;
