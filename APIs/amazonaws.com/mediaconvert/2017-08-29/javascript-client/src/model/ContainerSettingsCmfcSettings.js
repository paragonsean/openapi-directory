...
import CmfcSettings from './CmfcSettings';
import CmfcTimedMetadata from './CmfcTimedMetadata';
import CmfcTimedMetadataBoxVersion from './CmfcTimedMetadataBoxVersion';

/**
 * The ContainerSettingsCmfcSettings model module.
 * @module model/ContainerSettingsCmfcSettings
 * @version 2017-08-29
 */
class ContainerSettingsCmfcSettings {
    /**
     * Constructs a new <code>ContainerSettingsCmfcSettings</code>.
     * @alias module:model/ContainerSettingsCmfcSettings
     * @implements module:model/CmfcSettings
     */
    constructor() { 
        CmfcSettings.initialize(this);
        ContainerSettingsCmfcSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContainerSettingsCmfcSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContainerSettingsCmfcSettings} obj Optional instance to populate.
     * @return {module:model/ContainerSettingsCmfcSettings} The populated <code>ContainerSettingsCmfcSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContainerSettingsCmfcSettings();
            CmfcSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ContainerSettingsCmfcSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContainerSettingsCmfcSettings</code>.
     */
 ...
 */
ContainerSettingsCmfcSettings.prototype['AudioDuration'] = undefined;

/**
 * @member {String} AudioGroupId
 */
ContainerSettingsCmfcSettings.prototype['AudioGroupId'] = undefined;

/**
 * @member {String} AudioRenditionSets
 */
ContainerSettingsCmfcSettings.prototype['AudioRenditionSets'] = undefined;

/**
 * @member {module:model/CmfcAudioTrackType} AudioTrackType
 */
ContainerSettingsCmfcSettings.prototype['AudioTrackType'] = undefined;

/**
 * @member {module:model/CmfcDescriptiveVideoServiceFlag} DescriptiveVideoServiceFlag
 */
ContainerSettingsCmfcSettings.prototype['DescriptiveVideoServiceFlag'] = undefined;

/**
 * @member {module:model/CmfcIFrameOnlyManifest} IFrameOnlyManifest
 */
ContainerSettingsCmfcSettings.prototype['IFrameOnlyManifest'] = undefined;

/**
 * @member {module:model/CmfcKlvMetadata} KlvMetadata
 */
ContainerSettingsCmfcSettings.prototype['KlvMetadata'] = undefined;

/**
 * @member {module:model/CmfcManifestMetadataSignaling} ManifestMetadataSignaling
 */
ContainerSettingsCmfcSettings.prototype['ManifestMetadataSignaling'] = undefined;

/**
 * @member {module:model/CmfcScte35Esam} Scte35Esam
 */
ContainerSettingsCmfcSettings.prototype['Scte35Esam'] = undefined;

/**
 * @member {module:model/CmfcScte35Source} Scte35Source
 */
ContainerSettingsCmfcSettings.prototype['Scte35Source'] = undefined;

/**
 * @member {module:model/CmfcTimedMetadata} TimedMetadata
 */
ContainerSettingsCmfcSettings.prototype['TimedMetadata'] = undefined;

/**
 * @member {module:model/CmfcTimedMetadataBoxVersion} TimedMetadataBoxVersion
 */
ContainerSettingsCmfcSettings.prototype['TimedMetadataBoxVersion'] = undefined;

/**
 * @member {String} TimedMetadataSchemeIdUri
 */
ContainerSettingsCmfcSettings.prototype['TimedMetadataSchemeIdUri'] = undefined;

/**
 * @member {String} TimedMetadataValue
 */
ContainerSettingsCmfcSettings.prototype['TimedMetadataValue'] = undefined;


// Implement CmfcSettings interface:
/**
 * @member {module:model/CmfcAudioDuration} AudioDuration
 */
...
export default ContainerSettingsCmfcSettings;
