...
import Vp9Settings from './Vp9Settings';

/**
 * The VideoCodecSettingsVp9Settings model module.
 * @module model/VideoCodecSettingsVp9Settings
 * @version 2017-08-29
 */
class VideoCodecSettingsVp9Settings {
    /**
     * Constructs a new <code>VideoCodecSettingsVp9Settings</code>.
     * @alias module:model/VideoCodecSettingsVp9Settings
     * @implements module:model/Vp9Settings
     */
    constructor() { 
        Vp9Settings.initialize(this);
        VideoCodecSettingsVp9Settings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VideoCodecSettingsVp9Settings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoCodecSettingsVp9Settings} obj Optional instance to populate.
     * @return {module:model/VideoCodecSettingsVp9Settings} The populated <code>VideoCodecSettingsVp9Settings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoCodecSettingsVp9Settings();
            Vp9Settings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>VideoCodecSettingsVp9Settings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoCodecSettingsVp9Settings</code>.
     */
 ...
 */
VideoCodecSettingsVp9Settings.prototype['Bitrate'] = undefined;

/**
 * @member {module:model/Vp9FramerateControl} FramerateControl
 */
VideoCodecSettingsVp9Settings.prototype['FramerateControl'] = undefined;

/**
 * @member {module:model/Vp9FramerateConversionAlgorithm} FramerateConversionAlgorithm
 */
VideoCodecSettingsVp9Settings.prototype['FramerateConversionAlgorithm'] = undefined;

/**
 * @member {Number} FramerateDenominator
 */
VideoCodecSettingsVp9Settings.prototype['FramerateDenominator'] = undefined;

/**
 * @member {Number} FramerateNumerator
 */
VideoCodecSettingsVp9Settings.prototype['FramerateNumerator'] = undefined;

/**
 * @member {Number} GopSize
 */
VideoCodecSettingsVp9Settings.prototype['GopSize'] = undefined;

/**
 * @member {Number} HrdBufferSize
 */
VideoCodecSettingsVp9Settings.prototype['HrdBufferSize'] = undefined;

/**
 * @member {Number} MaxBitrate
 */
VideoCodecSettingsVp9Settings.prototype['MaxBitrate'] = undefined;

/**
 * @member {module:model/Vp9ParControl} ParControl
 */
VideoCodecSettingsVp9Settings.prototype['ParControl'] = undefined;

/**
 * @member {Number} ParDenominator
 */
VideoCodecSettingsVp9Settings.prototype['ParDenominator'] = undefined;

/**
 * @member {Number} ParNumerator
 */
VideoCodecSettingsVp9Settings.prototype['ParNumerator'] = undefined;

/**
 * @member {module:model/Vp9QualityTuningLevel} QualityTuningLevel
 */
VideoCodecSettingsVp9Settings.prototype['QualityTuningLevel'] = undefined;

/**
 * @member {module:model/Vp9RateControlMode} RateControlMode
 */
VideoCodecSettingsVp9Settings.prototype['RateControlMode'] = undefined;


// Implement Vp9Settings interface:
/**
 * @member {Number} Bitrate
 */
...
export default VideoCodecSettingsVp9Settings;
