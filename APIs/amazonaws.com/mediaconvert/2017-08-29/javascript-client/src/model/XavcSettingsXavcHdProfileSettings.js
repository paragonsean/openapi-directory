...
import XavcHdProfileSettings from './XavcHdProfileSettings';
import XavcHdProfileTelecine from './XavcHdProfileTelecine';
import XavcInterlaceMode from './XavcInterlaceMode';

/**
 * The XavcSettingsXavcHdProfileSettings model module.
 * @module model/XavcSettingsXavcHdProfileSettings
 * @version 2017-08-29
 */
class XavcSettingsXavcHdProfileSettings {
    /**
     * Constructs a new <code>XavcSettingsXavcHdProfileSettings</code>.
     * @alias module:model/XavcSettingsXavcHdProfileSettings
     * @implements module:model/XavcHdProfileSettings
     */
    constructor() { 
        XavcHdProfileSettings.initialize(this);
        XavcSettingsXavcHdProfileSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XavcSettingsXavcHdProfileSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XavcSettingsXavcHdProfileSettings} obj Optional instance to populate.
     * @return {module:model/XavcSettingsXavcHdProfileSettings} The populated <code>XavcSettingsXavcHdProfileSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XavcSettingsXavcHdProfileSettings();
            XavcHdProfileSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>XavcSettingsXavcHdProfileSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XavcSettingsXavcHdProfileSettings</code>.
     */
 ...
 */
XavcSettingsXavcHdProfileSettings.prototype['BitrateClass'] = undefined;

/**
 * @member {module:model/XavcFlickerAdaptiveQuantization} FlickerAdaptiveQuantization
 */
XavcSettingsXavcHdProfileSettings.prototype['FlickerAdaptiveQuantization'] = undefined;

/**
 * @member {module:model/XavcGopBReference} GopBReference
 */
XavcSettingsXavcHdProfileSettings.prototype['GopBReference'] = undefined;

/**
 * @member {Number} GopClosedCadence
 */
XavcSettingsXavcHdProfileSettings.prototype['GopClosedCadence'] = undefined;

/**
 * @member {Number} HrdBufferSize
 */
XavcSettingsXavcHdProfileSettings.prototype['HrdBufferSize'] = undefined;

/**
 * @member {module:model/XavcInterlaceMode} InterlaceMode
 */
XavcSettingsXavcHdProfileSettings.prototype['InterlaceMode'] = undefined;

/**
 * @member {module:model/XavcHdProfileQualityTuningLevel} QualityTuningLevel
 */
XavcSettingsXavcHdProfileSettings.prototype['QualityTuningLevel'] = undefined;

/**
 * @member {Number} Slices
 */
XavcSettingsXavcHdProfileSettings.prototype['Slices'] = undefined;

/**
 * @member {module:model/XavcHdProfileTelecine} Telecine
 */
XavcSettingsXavcHdProfileSettings.prototype['Telecine'] = undefined;


// Implement XavcHdProfileSettings interface:
/**
 * @member {module:model/XavcHdProfileBitrateClass} BitrateClass
 */
...
export default XavcSettingsXavcHdProfileSettings;
