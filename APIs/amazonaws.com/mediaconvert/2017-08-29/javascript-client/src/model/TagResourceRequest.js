...
class TagResourceRequest {
     ...
     * @param arn {String} The Amazon Resource Name (ARN) of the resource that you want to tag. To get the ARN, send a GET request with the resource name.
     * @param tags {Object.<String, String>} The tags that you want to add to the resource. You can tag resources with a key-value pair or with only a key.
     */
