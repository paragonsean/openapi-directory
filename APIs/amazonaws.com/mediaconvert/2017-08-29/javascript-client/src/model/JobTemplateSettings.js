...
/**
 * The JobTemplateSettings model module.
 * @module model/JobTemplateSettings
 * @version 2017-08-29
 */
class JobTemplateSettings {
    /**
     * Constructs a new <code>JobTemplateSettings</code>.
     * JobTemplateSettings contains all the transcode settings saved in the template that will be applied to jobs created from it.
     * @alias module:model/JobTemplateSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>JobTemplateSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JobTemplateSettings} obj Optional instance to populate.
     * @return {module:model/JobTemplateSettings} The populated <code>JobTemplateSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobTemplateSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>JobTemplateSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobTemplateSettings</code>.
     */
