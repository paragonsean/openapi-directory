...
/**
 * The Av1Settings model module.
 * @module model/Av1Settings
 * @version 2017-08-29
 */
class Av1Settings {
    /**
     * Constructs a new <code>Av1Settings</code>.
     * Required when you set Codec, under VideoDescription&gt;CodecSettings to the value AV1.
     * @alias module:model/Av1Settings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Av1Settings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Av1Settings} obj Optional instance to populate.
     * @return {module:model/Av1Settings} The populated <code>Av1Settings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Av1Settings();
    ...
    /**
     * Validates the JSON data with respect to <code>Av1Settings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Av1Settings</code>.
     */
