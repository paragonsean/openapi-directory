...
public class VideoSelectorHdr10Metadata {
  ...
  public VideoSelectorHdr10Metadata() {
  }

  public VideoSelectorHdr10Metadata bluePrimaryX(Integer bluePrimaryX) {
  ...
  public VideoSelectorHdr10Metadata bluePrimaryY(Integer bluePrimaryY) {
  ...
  public VideoSelectorHdr10Metadata greenPrimaryX(Integer greenPrimaryX) {
  ...
  public VideoSelectorHdr10Metadata greenPrimaryY(Integer greenPrimaryY) {
  ...
  public VideoSelectorHdr10Metadata maxContentLightLevel(Integer maxContentLightLevel) {
  ...
  public VideoSelectorHdr10Metadata maxFrameAverageLightLevel(Integer maxFrameAverageLightLevel) {
  ...
  public VideoSelectorHdr10Metadata maxLuminance(Integer maxLuminance) {
  ...
  public VideoSelectorHdr10Metadata minLuminance(Integer minLuminance) {
  ...
  public VideoSelectorHdr10Metadata redPrimaryX(Integer redPrimaryX) {
  ...
  public VideoSelectorHdr10Metadata redPrimaryY(Integer redPrimaryY) {
  ...
  public VideoSelectorHdr10Metadata whitePointX(Integer whitePointX) {
  ...
  public VideoSelectorHdr10Metadata whitePointY(Integer whitePointY) {
  ...
  public boolean equals(Object o) {
    ...
    VideoSelectorHdr10Metadata videoSelectorHdr10Metadata = (VideoSelectorHdr10Metadata) o;
    return Objects.equals(this.bluePrimaryX, videoSelectorHdr10Metadata.bluePrimaryX) &&
        Objects.equals(this.bluePrimaryY, videoSelectorHdr10Metadata.bluePrimaryY) &&
        Objects.equals(this.greenPrimaryX, videoSelectorHdr10Metadata.greenPrimaryX) &&
        Objects.equals(this.greenPrimaryY, videoSelectorHdr10Metadata.greenPrimaryY) &&
        Objects.equals(this.maxContentLightLevel, videoSelectorHdr10Metadata.maxContentLightLevel) &&
        Objects.equals(this.maxFrameAverageLightLevel, videoSelectorHdr10Metadata.maxFrameAverageLightLevel) &&
        Objects.equals(this.maxLuminance, videoSelectorHdr10Metadata.maxLuminance) &&
        Objects.equals(this.minLuminance, videoSelectorHdr10Metadata.minLuminance) &&
        Objects.equals(this.redPrimaryX, videoSelectorHdr10Metadata.redPrimaryX) &&
        Objects.equals(this.redPrimaryY, videoSelectorHdr10Metadata.redPrimaryY) &&
        Objects.equals(this.whitePointX, videoSelectorHdr10Metadata.whitePointX) &&
        Objects.equals(this.whitePointY, videoSelectorHdr10Metadata.whitePointY);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideoSelectorHdr10Metadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoSelectorHdr10Metadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoSelectorHdr10Metadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoSelectorHdr10Metadata is not found in the empty JSON string", VideoSelectorHdr10Metadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoSelectorHdr10Metadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoSelectorHdr10Metadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoSelectorHdr10Metadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoSelectorHdr10Metadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoSelectorHdr10Metadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoSelectorHdr10Metadata.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoSelectorHdr10Metadata>() {
           @Override
           public void write(JsonWriter out, VideoSelectorHdr10Metadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoSelectorHdr10Metadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoSelectorHdr10Metadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoSelectorHdr10Metadata
   * @throws IOException if the JSON string is invalid with respect to VideoSelectorHdr10Metadata
   */
  public static VideoSelectorHdr10Metadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoSelectorHdr10Metadata.class);
  }

  /**
   * Convert an instance of VideoSelectorHdr10Metadata to an JSON string
   *
   * @return JSON string
   */
