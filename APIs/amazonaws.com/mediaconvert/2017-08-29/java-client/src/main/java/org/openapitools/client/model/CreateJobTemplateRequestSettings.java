...
public class CreateJobTemplateRequestSettings {
  ...
  public CreateJobTemplateRequestSettings() {
  }

  public CreateJobTemplateRequestSettings adAvailOffset(Integer adAvailOffset) {
  ...
  public CreateJobTemplateRequestSettings availBlanking(CreateJobRequestSettingsAvailBlanking availBlanking) {
  ...
  public CreateJobTemplateRequestSettings esam(CreateJobRequestSettingsEsam esam) {
    this.esam = esam;
    return this;
  }
  ...
  public CreateJobTemplateRequestSettings extendedDataServices(CreateJobRequestSettingsExtendedDataServices extendedDataServices) {
  ...
  public CreateJobTemplateRequestSettings inputs(List inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public CreateJobTemplateRequestSettings kantarWatermark(CreateJobRequestSettingsKantarWatermark kantarWatermark) {
  ...
  public CreateJobTemplateRequestSettings motionImageInserter(CreateJobRequestSettingsMotionImageInserter motionImageInserter) {
  ...
  public CreateJobTemplateRequestSettings nielsenConfiguration(CreateJobRequestSettingsNielsenConfiguration nielsenConfiguration) {
  ...
  public CreateJobTemplateRequestSettings nielsenNonLinearWatermark(CreateJobRequestSettingsNielsenNonLinearWatermark nielsenNonLinearWatermark) {
  ...
  public CreateJobTemplateRequestSettings outputGroups(List outputGroups) {
  ...
  public CreateJobTemplateRequestSettings timecodeConfig(CreateJobRequestSettingsTimecodeConfig timecodeConfig) {
  ...
  public CreateJobTemplateRequestSettings timedMetadataInsertion(CreateJobRequestSettingsTimedMetadataInsertion timedMetadataInsertion) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobTemplateRequestSettings createJobTemplateRequestSettings = (CreateJobTemplateRequestSettings) o;
    return Objects.equals(this.adAvailOffset, createJobTemplateRequestSettings.adAvailOffset) &&
        Objects.equals(this.availBlanking, createJobTemplateRequestSettings.availBlanking) &&
        Objects.equals(this.esam, createJobTemplateRequestSettings.esam) &&
        Objects.equals(this.extendedDataServices, createJobTemplateRequestSettings.extendedDataServices) &&
        Objects.equals(this.inputs, createJobTemplateRequestSettings.inputs) &&
        Objects.equals(this.kantarWatermark, createJobTemplateRequestSettings.kantarWatermark) &&
        Objects.equals(this.motionImageInserter, createJobTemplateRequestSettings.motionImageInserter) &&
        Objects.equals(this.nielsenConfiguration, createJobTemplateRequestSettings.nielsenConfiguration) &&
        Objects.equals(this.nielsenNonLinearWatermark, createJobTemplateRequestSettings.nielsenNonLinearWatermark) &&
        Objects.equals(this.outputGroups, createJobTemplateRequestSettings.outputGroups) &&
        Objects.equals(this.timecodeConfig, createJobTemplateRequestSettings.timecodeConfig) &&
        Objects.equals(this.timedMetadataInsertion, createJobTemplateRequestSettings.timedMetadataInsertion);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobTemplateRequestSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJobTemplateRequestSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJobTemplateRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobTemplateRequestSettings is not found in the empty JSON string", CreateJobTemplateRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJobTemplateRequestSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJobTemplateRequestSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobTemplateRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobTemplateRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobTemplateRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobTemplateRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobTemplateRequestSettings>() {
           @Override
           public void write(JsonWriter out, CreateJobTemplateRequestSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJobTemplateRequestSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJobTemplateRequestSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJobTemplateRequestSettings
   * @throws IOException if the JSON string is invalid with respect to CreateJobTemplateRequestSettings
   */
  public static CreateJobTemplateRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobTemplateRequestSettings.class);
  }

  /**
   * Convert an instance of CreateJobTemplateRequestSettings to an JSON string
   *
   * @return JSON string
   */
