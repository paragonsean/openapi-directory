...
public class CaptionSourceSettings {
  ...
  public CaptionSourceSettings() {
  }

  public CaptionSourceSettings ancillarySourceSettings(CaptionSourceSettingsAncillarySourceSettings ancillarySourceSettings) {
  ...
  public CaptionSourceSettings dvbSubSourceSettings(CaptionSourceSettingsDvbSubSourceSettings dvbSubSourceSettings) {
  ...
  public CaptionSourceSettings embeddedSourceSettings(CaptionSourceSettingsEmbeddedSourceSettings embeddedSourceSettings) {
  ...
  public CaptionSourceSettings fileSourceSettings(CaptionSourceSettingsFileSourceSettings fileSourceSettings) {
  ...
  public CaptionSourceSettings sourceType(CaptionSourceType sourceType) {
  ...
  public CaptionSourceSettings teletextSourceSettings(CaptionSourceSettingsTeletextSourceSettings teletextSourceSettings) {
  ...
  public CaptionSourceSettings trackSourceSettings(CaptionSourceSettingsTrackSourceSettings trackSourceSettings) {
  ...
  public CaptionSourceSettings webvttHlsSourceSettings(CaptionSourceSettingsWebvttHlsSourceSettings webvttHlsSourceSettings) {
  ...
  public boolean equals(Object o) {
    ...
    CaptionSourceSettings captionSourceSettings = (CaptionSourceSettings) o;
    return Objects.equals(this.ancillarySourceSettings, captionSourceSettings.ancillarySourceSettings) &&
        Objects.equals(this.dvbSubSourceSettings, captionSourceSettings.dvbSubSourceSettings) &&
        Objects.equals(this.embeddedSourceSettings, captionSourceSettings.embeddedSourceSettings) &&
        Objects.equals(this.fileSourceSettings, captionSourceSettings.fileSourceSettings) &&
        Objects.equals(this.sourceType, captionSourceSettings.sourceType) &&
        Objects.equals(this.teletextSourceSettings, captionSourceSettings.teletextSourceSettings) &&
        Objects.equals(this.trackSourceSettings, captionSourceSettings.trackSourceSettings) &&
        Objects.equals(this.webvttHlsSourceSettings, captionSourceSettings.webvttHlsSourceSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class CaptionSourceSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CaptionSourceSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CaptionSourceSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CaptionSourceSettings is not found in the empty JSON string", CaptionSourceSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CaptionSourceSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CaptionSourceSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CaptionSourceSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CaptionSourceSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CaptionSourceSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CaptionSourceSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CaptionSourceSettings>() {
           @Override
           public void write(JsonWriter out, CaptionSourceSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CaptionSourceSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CaptionSourceSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CaptionSourceSettings
   * @throws IOException if the JSON string is invalid with respect to CaptionSourceSettings
   */
  public static CaptionSourceSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CaptionSourceSettings.class);
  }

  /**
   * Convert an instance of CaptionSourceSettings to an JSON string
   *
   * @return JSON string
   */
