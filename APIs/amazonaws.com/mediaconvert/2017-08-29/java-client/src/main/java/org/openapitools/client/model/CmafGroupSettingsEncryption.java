...
public class CmafGroupSettingsEncryption {
  ...
  public CmafGroupSettingsEncryption() {
  }

  public CmafGroupSettingsEncryption constantInitializationVector(String constantInitializationVector) {
  ...
  public CmafGroupSettingsEncryption encryptionMethod(CmafEncryptionType encryptionMethod) {
  ...
  public CmafGroupSettingsEncryption initializationVectorInManifest(CmafInitializationVectorInManifest initializationVectorInManifest) {
  ...
  public CmafGroupSettingsEncryption spekeKeyProvider(CmafEncryptionSettingsSpekeKeyProvider spekeKeyProvider) {
  ...
  public CmafGroupSettingsEncryption staticKeyProvider(CmafEncryptionSettingsStaticKeyProvider staticKeyProvider) {
  ...
  public CmafGroupSettingsEncryption type(CmafKeyProviderType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CmafGroupSettingsEncryption cmafGroupSettingsEncryption = (CmafGroupSettingsEncryption) o;
    return Objects.equals(this.constantInitializationVector, cmafGroupSettingsEncryption.constantInitializationVector) &&
        Objects.equals(this.encryptionMethod, cmafGroupSettingsEncryption.encryptionMethod) &&
        Objects.equals(this.initializationVectorInManifest, cmafGroupSettingsEncryption.initializationVectorInManifest) &&
        Objects.equals(this.spekeKeyProvider, cmafGroupSettingsEncryption.spekeKeyProvider) &&
        Objects.equals(this.staticKeyProvider, cmafGroupSettingsEncryption.staticKeyProvider) &&
        Objects.equals(this.type, cmafGroupSettingsEncryption.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CmafGroupSettingsEncryption {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CmafGroupSettingsEncryption
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CmafGroupSettingsEncryption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CmafGroupSettingsEncryption is not found in the empty JSON string", CmafGroupSettingsEncryption.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CmafGroupSettingsEncryption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CmafGroupSettingsEncryption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CmafGroupSettingsEncryption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CmafGroupSettingsEncryption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CmafGroupSettingsEncryption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CmafGroupSettingsEncryption.class));

       return (TypeAdapter<T>) new TypeAdapter<CmafGroupSettingsEncryption>() {
           @Override
           public void write(JsonWriter out, CmafGroupSettingsEncryption value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CmafGroupSettingsEncryption read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CmafGroupSettingsEncryption given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CmafGroupSettingsEncryption
   * @throws IOException if the JSON string is invalid with respect to CmafGroupSettingsEncryption
   */
  public static CmafGroupSettingsEncryption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CmafGroupSettingsEncryption.class);
  }

  /**
   * Convert an instance of CmafGroupSettingsEncryption to an JSON string
   *
   * @return JSON string
   */
