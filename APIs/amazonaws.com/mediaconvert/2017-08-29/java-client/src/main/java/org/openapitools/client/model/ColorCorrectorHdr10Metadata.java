...
public class ColorCorrectorHdr10Metadata {
  ...
  public ColorCorrectorHdr10Metadata() {
  }

  public ColorCorrectorHdr10Metadata bluePrimaryX(Integer bluePrimaryX) {
  ...
  public ColorCorrectorHdr10Metadata bluePrimaryY(Integer bluePrimaryY) {
  ...
  public ColorCorrectorHdr10Metadata greenPrimaryX(Integer greenPrimaryX) {
  ...
  public ColorCorrectorHdr10Metadata greenPrimaryY(Integer greenPrimaryY) {
  ...
  public ColorCorrectorHdr10Metadata maxContentLightLevel(Integer maxContentLightLevel) {
  ...
  public ColorCorrectorHdr10Metadata maxFrameAverageLightLevel(Integer maxFrameAverageLightLevel) {
  ...
  public ColorCorrectorHdr10Metadata maxLuminance(Integer maxLuminance) {
  ...
  public ColorCorrectorHdr10Metadata minLuminance(Integer minLuminance) {
  ...
  public ColorCorrectorHdr10Metadata redPrimaryX(Integer redPrimaryX) {
  ...
  public ColorCorrectorHdr10Metadata redPrimaryY(Integer redPrimaryY) {
  ...
  public ColorCorrectorHdr10Metadata whitePointX(Integer whitePointX) {
  ...
  public ColorCorrectorHdr10Metadata whitePointY(Integer whitePointY) {
  ...
  public boolean equals(Object o) {
    ...
    ColorCorrectorHdr10Metadata colorCorrectorHdr10Metadata = (ColorCorrectorHdr10Metadata) o;
    return Objects.equals(this.bluePrimaryX, colorCorrectorHdr10Metadata.bluePrimaryX) &&
        Objects.equals(this.bluePrimaryY, colorCorrectorHdr10Metadata.bluePrimaryY) &&
        Objects.equals(this.greenPrimaryX, colorCorrectorHdr10Metadata.greenPrimaryX) &&
        Objects.equals(this.greenPrimaryY, colorCorrectorHdr10Metadata.greenPrimaryY) &&
        Objects.equals(this.maxContentLightLevel, colorCorrectorHdr10Metadata.maxContentLightLevel) &&
        Objects.equals(this.maxFrameAverageLightLevel, colorCorrectorHdr10Metadata.maxFrameAverageLightLevel) &&
        Objects.equals(this.maxLuminance, colorCorrectorHdr10Metadata.maxLuminance) &&
        Objects.equals(this.minLuminance, colorCorrectorHdr10Metadata.minLuminance) &&
        Objects.equals(this.redPrimaryX, colorCorrectorHdr10Metadata.redPrimaryX) &&
        Objects.equals(this.redPrimaryY, colorCorrectorHdr10Metadata.redPrimaryY) &&
        Objects.equals(this.whitePointX, colorCorrectorHdr10Metadata.whitePointX) &&
        Objects.equals(this.whitePointY, colorCorrectorHdr10Metadata.whitePointY);
  }
  ...
  public String toString() {
    ...
    sb.append("class ColorCorrectorHdr10Metadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColorCorrectorHdr10Metadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColorCorrectorHdr10Metadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ColorCorrectorHdr10Metadata is not found in the empty JSON string", ColorCorrectorHdr10Metadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColorCorrectorHdr10Metadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColorCorrectorHdr10Metadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColorCorrectorHdr10Metadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColorCorrectorHdr10Metadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ColorCorrectorHdr10Metadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ColorCorrectorHdr10Metadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ColorCorrectorHdr10Metadata>() {
           @Override
           public void write(JsonWriter out, ColorCorrectorHdr10Metadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ColorCorrectorHdr10Metadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ColorCorrectorHdr10Metadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ColorCorrectorHdr10Metadata
   * @throws IOException if the JSON string is invalid with respect to ColorCorrectorHdr10Metadata
   */
  public static ColorCorrectorHdr10Metadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ColorCorrectorHdr10Metadata.class);
  }

  /**
   * Convert an instance of ColorCorrectorHdr10Metadata to an JSON string
   *
   * @return JSON string
   */
