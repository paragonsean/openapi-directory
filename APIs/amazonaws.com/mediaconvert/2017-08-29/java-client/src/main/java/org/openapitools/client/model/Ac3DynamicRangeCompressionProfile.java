 ...
 */
@JsonAdapter(Ac3DynamicRangeCompressionProfile.Adapter.class)
public enum Ac3DynamicRangeCompressionProfile {
  ...
  Ac3DynamicRangeCompressionProfile(String value) {
    this.value = value;
  }
  ...
  public static Ac3DynamicRangeCompressionProfile fromValue(String value) {
    for (Ac3DynamicRangeCompressionProfile b : Ac3DynamicRangeCompressionProfile.values()) {
  ...
  public static class Adapter extends TypeAdapter<Ac3DynamicRangeCompressionProfile> {
    @Override
    public void write(final JsonWriter jsonWriter, final Ac3DynamicRangeCompressionProfile enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Ac3DynamicRangeCompressionProfile read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Ac3DynamicRangeCompressionProfile.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    Ac3DynamicRangeCompressionProfile.fromValue(value);
  }
}
