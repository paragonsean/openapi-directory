...
public class JobTemplateSettings {
  ...
  public JobTemplateSettings() {
  }

  public JobTemplateSettings adAvailOffset(Integer adAvailOffset) {
  ...
  public JobTemplateSettings availBlanking(CreateJobRequestSettingsAvailBlanking availBlanking) {
  ...
  public JobTemplateSettings esam(CreateJobRequestSettingsEsam esam) {
    this.esam = esam;
    return this;
  }
  ...
  public JobTemplateSettings extendedDataServices(CreateJobRequestSettingsExtendedDataServices extendedDataServices) {
  ...
  public JobTemplateSettings inputs(List inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public JobTemplateSettings kantarWatermark(CreateJobRequestSettingsKantarWatermark kantarWatermark) {
  ...
  public JobTemplateSettings motionImageInserter(CreateJobRequestSettingsMotionImageInserter motionImageInserter) {
  ...
  public JobTemplateSettings nielsenConfiguration(CreateJobRequestSettingsNielsenConfiguration nielsenConfiguration) {
  ...
  public JobTemplateSettings nielsenNonLinearWatermark(CreateJobRequestSettingsNielsenNonLinearWatermark nielsenNonLinearWatermark) {
  ...
  public JobTemplateSettings outputGroups(List outputGroups) {
  ...
  public JobTemplateSettings timecodeConfig(CreateJobRequestSettingsTimecodeConfig timecodeConfig) {
  ...
  public JobTemplateSettings timedMetadataInsertion(CreateJobRequestSettingsTimedMetadataInsertion timedMetadataInsertion) {
  ...
  public boolean equals(Object o) {
    ...
    JobTemplateSettings jobTemplateSettings = (JobTemplateSettings) o;
    return Objects.equals(this.adAvailOffset, jobTemplateSettings.adAvailOffset) &&
        Objects.equals(this.availBlanking, jobTemplateSettings.availBlanking) &&
        Objects.equals(this.esam, jobTemplateSettings.esam) &&
        Objects.equals(this.extendedDataServices, jobTemplateSettings.extendedDataServices) &&
        Objects.equals(this.inputs, jobTemplateSettings.inputs) &&
        Objects.equals(this.kantarWatermark, jobTemplateSettings.kantarWatermark) &&
        Objects.equals(this.motionImageInserter, jobTemplateSettings.motionImageInserter) &&
        Objects.equals(this.nielsenConfiguration, jobTemplateSettings.nielsenConfiguration) &&
        Objects.equals(this.nielsenNonLinearWatermark, jobTemplateSettings.nielsenNonLinearWatermark) &&
        Objects.equals(this.outputGroups, jobTemplateSettings.outputGroups) &&
        Objects.equals(this.timecodeConfig, jobTemplateSettings.timecodeConfig) &&
        Objects.equals(this.timedMetadataInsertion, jobTemplateSettings.timedMetadataInsertion);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobTemplateSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobTemplateSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobTemplateSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobTemplateSettings is not found in the empty JSON string", JobTemplateSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobTemplateSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobTemplateSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobTemplateSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobTemplateSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobTemplateSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobTemplateSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<JobTemplateSettings>() {
           @Override
           public void write(JsonWriter out, JobTemplateSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobTemplateSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobTemplateSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobTemplateSettings
   * @throws IOException if the JSON string is invalid with respect to JobTemplateSettings
   */
  public static JobTemplateSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobTemplateSettings.class);
  }

  /**
   * Convert an instance of JobTemplateSettings to an JSON string
   *
   * @return JSON string
   */
