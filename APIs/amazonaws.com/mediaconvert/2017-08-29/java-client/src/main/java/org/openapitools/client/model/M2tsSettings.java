...
public class M2tsSettings {
  ...
  public M2tsSettings audioBufferModel(M2tsAudioBufferModel audioBufferModel) {
  ...
  public M2tsSettings audioDuration(M2tsAudioDuration audioDuration) {
  ...
  public M2tsSettings audioFramesPerPes(Integer audioFramesPerPes) {
  ...
  public M2tsSettings audioPids(List audioPids) {
  ...
  public M2tsSettings bitrate(Integer bitrate) {
  ...
  public M2tsSettings bufferModel(M2tsBufferModel bufferModel) {
  ...
  public M2tsSettings dataPTSControl(M2tsDataPtsControl dataPTSControl) {
  ...
  public M2tsSettings dvbNitSettings(M2tsSettingsDvbNitSettings dvbNitSettings) {
  ...
  public M2tsSettings dvbSdtSettings(M2tsSettingsDvbSdtSettings dvbSdtSettings) {
  ...
  public M2tsSettings dvbSubPids(List dvbSubPids) {
  ...
  public M2tsSettings dvbTdtSettings(M2tsSettingsDvbTdtSettings dvbTdtSettings) {
  ...
  public M2tsSettings dvbTeletextPid(Integer dvbTeletextPid) {
  ...
  public M2tsSettings ebpAudioInterval(M2tsEbpAudioInterval ebpAudioInterval) {
  ...
  public M2tsSettings ebpPlacement(M2tsEbpPlacement ebpPlacement) {
  ...
  public M2tsSettings esRateInPes(M2tsEsRateInPes esRateInPes) {
  ...
  public M2tsSettings forceTsVideoEbpOrder(M2tsForceTsVideoEbpOrder forceTsVideoEbpOrder) {
  ...
  public M2tsSettings fragmentTime(Double fragmentTime) {
  ...
  public M2tsSettings klvMetadata(M2tsKlvMetadata klvMetadata) {
  ...
  public M2tsSettings maxPcrInterval(Integer maxPcrInterval) {
  ...
  public M2tsSettings minEbpInterval(Integer minEbpInterval) {
  ...
  public M2tsSettings nielsenId3(M2tsNielsenId3 nielsenId3) {
  ...
  public M2tsSettings nullPacketBitrate(Double nullPacketBitrate) {
  ...
  public M2tsSettings patInterval(Integer patInterval) {
  ...
  public M2tsSettings pcrControl(M2tsPcrControl pcrControl) {
  ...
  public M2tsSettings pcrPid(Integer pcrPid) {
    this.pcrPid = pcrPid;
    return this;
  }
  ...
  public M2tsSettings pmtInterval(Integer pmtInterval) {
  ...
  public M2tsSettings pmtPid(Integer pmtPid) {
    this.pmtPid = pmtPid;
    return this;
  }
  ...
  public M2tsSettings privateMetadataPid(Integer privateMetadataPid) {
  ...
  public M2tsSettings programNumber(Integer programNumber) {
  ...
  public M2tsSettings rateMode(M2tsRateMode rateMode) {
  ...
  public M2tsSettings scte35Esam(M2tsSettingsScte35Esam scte35Esam) {
  ...
  public M2tsSettings scte35Pid(Integer scte35Pid) {
  ...
  public M2tsSettings scte35Source(M2tsScte35Source scte35Source) {
  ...
  public M2tsSettings segmentationMarkers(M2tsSegmentationMarkers segmentationMarkers) {
  ...
  public M2tsSettings segmentationStyle(M2tsSegmentationStyle segmentationStyle) {
  ...
  public M2tsSettings segmentationTime(Double segmentationTime) {
  ...
  public M2tsSettings timedMetadataPid(Integer timedMetadataPid) {
  ...
  public M2tsSettings transportStreamId(Integer transportStreamId) {
  ...
  public M2tsSettings videoPid(Integer videoPid) {
  ...
  public boolean equals(Object o) {
    ...
    M2tsSettings m2tsSettings = (M2tsSettings) o;
    return Objects.equals(this.audioBufferModel, m2tsSettings.audioBufferModel) &&
        Objects.equals(this.audioDuration, m2tsSettings.audioDuration) &&
        Objects.equals(this.audioFramesPerPes, m2tsSettings.audioFramesPerPes) &&
        Objects.equals(this.audioPids, m2tsSettings.audioPids) &&
        Objects.equals(this.bitrate, m2tsSettings.bitrate) &&
        Objects.equals(this.bufferModel, m2tsSettings.bufferModel) &&
        Objects.equals(this.dataPTSControl, m2tsSettings.dataPTSControl) &&
        Objects.equals(this.dvbNitSettings, m2tsSettings.dvbNitSettings) &&
        Objects.equals(this.dvbSdtSettings, m2tsSettings.dvbSdtSettings) &&
        Objects.equals(this.dvbSubPids, m2tsSettings.dvbSubPids) &&
        Objects.equals(this.dvbTdtSettings, m2tsSettings.dvbTdtSettings) &&
        Objects.equals(this.dvbTeletextPid, m2tsSettings.dvbTeletextPid) &&
        Objects.equals(this.ebpAudioInterval, m2tsSettings.ebpAudioInterval) &&
        Objects.equals(this.ebpPlacement, m2tsSettings.ebpPlacement) &&
        Objects.equals(this.esRateInPes, m2tsSettings.esRateInPes) &&
        Objects.equals(this.forceTsVideoEbpOrder, m2tsSettings.forceTsVideoEbpOrder) &&
        Objects.equals(this.fragmentTime, m2tsSettings.fragmentTime) &&
        Objects.equals(this.klvMetadata, m2tsSettings.klvMetadata) &&
        Objects.equals(this.maxPcrInterval, m2tsSettings.maxPcrInterval) &&
        Objects.equals(this.minEbpInterval, m2tsSettings.minEbpInterval) &&
        Objects.equals(this.nielsenId3, m2tsSettings.nielsenId3) &&
        Objects.equals(this.nullPacketBitrate, m2tsSettings.nullPacketBitrate) &&
        Objects.equals(this.patInterval, m2tsSettings.patInterval) &&
        Objects.equals(this.pcrControl, m2tsSettings.pcrControl) &&
        Objects.equals(this.pcrPid, m2tsSettings.pcrPid) &&
        Objects.equals(this.pmtInterval, m2tsSettings.pmtInterval) &&
        Objects.equals(this.pmtPid, m2tsSettings.pmtPid) &&
        Objects.equals(this.privateMetadataPid, m2tsSettings.privateMetadataPid) &&
        Objects.equals(this.programNumber, m2tsSettings.programNumber) &&
        Objects.equals(this.rateMode, m2tsSettings.rateMode) &&
        Objects.equals(this.scte35Esam, m2tsSettings.scte35Esam) &&
        Objects.equals(this.scte35Pid, m2tsSettings.scte35Pid) &&
        Objects.equals(this.scte35Source, m2tsSettings.scte35Source) &&
        Objects.equals(this.segmentationMarkers, m2tsSettings.segmentationMarkers) &&
        Objects.equals(this.segmentationStyle, m2tsSettings.segmentationStyle) &&
        Objects.equals(this.segmentationTime, m2tsSettings.segmentationTime) &&
        Objects.equals(this.timedMetadataPid, m2tsSettings.timedMetadataPid) &&
        Objects.equals(this.transportStreamId, m2tsSettings.transportStreamId) &&
        Objects.equals(this.videoPid, m2tsSettings.videoPid);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to M2tsSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!M2tsSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in M2tsSettings is not found in the empty JSON string", M2tsSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!M2tsSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `M2tsSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!M2tsSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'M2tsSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<M2tsSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(M2tsSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<M2tsSettings>() {
           @Override
           public void write(JsonWriter out, M2tsSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public M2tsSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of M2tsSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of M2tsSettings
   * @throws IOException if the JSON string is invalid with respect to M2tsSettings
   */
  public static M2tsSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, M2tsSettings.class);
  }

  /**
   * Convert an instance of M2tsSettings to an JSON string
   *
   * @return JSON string
   */
