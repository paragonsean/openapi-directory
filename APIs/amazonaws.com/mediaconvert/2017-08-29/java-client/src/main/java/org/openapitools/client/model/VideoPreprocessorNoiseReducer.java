...
public class VideoPreprocessorNoiseReducer {
  ...
  public VideoPreprocessorNoiseReducer() {
  }

  public VideoPreprocessorNoiseReducer filter(NoiseReducerFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public VideoPreprocessorNoiseReducer filterSettings(NoiseReducerFilterSettings filterSettings) {
  ...
  public VideoPreprocessorNoiseReducer spatialFilterSettings(NoiseReducerSpatialFilterSettings spatialFilterSettings) {
  ...
  public VideoPreprocessorNoiseReducer temporalFilterSettings(NoiseReducerTemporalFilterSettings temporalFilterSettings) {
  ...
  public boolean equals(Object o) {
    ...
    VideoPreprocessorNoiseReducer videoPreprocessorNoiseReducer = (VideoPreprocessorNoiseReducer) o;
    return Objects.equals(this.filter, videoPreprocessorNoiseReducer.filter) &&
        Objects.equals(this.filterSettings, videoPreprocessorNoiseReducer.filterSettings) &&
        Objects.equals(this.spatialFilterSettings, videoPreprocessorNoiseReducer.spatialFilterSettings) &&
        Objects.equals(this.temporalFilterSettings, videoPreprocessorNoiseReducer.temporalFilterSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideoPreprocessorNoiseReducer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoPreprocessorNoiseReducer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoPreprocessorNoiseReducer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoPreprocessorNoiseReducer is not found in the empty JSON string", VideoPreprocessorNoiseReducer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoPreprocessorNoiseReducer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoPreprocessorNoiseReducer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoPreprocessorNoiseReducer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoPreprocessorNoiseReducer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoPreprocessorNoiseReducer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoPreprocessorNoiseReducer.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoPreprocessorNoiseReducer>() {
           @Override
           public void write(JsonWriter out, VideoPreprocessorNoiseReducer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoPreprocessorNoiseReducer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoPreprocessorNoiseReducer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoPreprocessorNoiseReducer
   * @throws IOException if the JSON string is invalid with respect to VideoPreprocessorNoiseReducer
   */
  public static VideoPreprocessorNoiseReducer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoPreprocessorNoiseReducer.class);
  }

  /**
   * Convert an instance of VideoPreprocessorNoiseReducer to an JSON string
   *
   * @return JSON string
   */
