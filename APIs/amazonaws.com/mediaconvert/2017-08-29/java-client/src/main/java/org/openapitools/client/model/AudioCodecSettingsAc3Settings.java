...
public class AudioCodecSettingsAc3Settings {
  ...
  private Ac3DynamicRangeCompressionLine dynamicRangeCompressionLine;

  public static final String SERIALIZED_NAME_DYNAMIC_RANGE_COMPRESSION_PROFILE = "DynamicRangeCompressionProfile";
  @SerializedName(SERIALIZED_NAME_DYNAMIC_RANGE_COMPRESSION_PROFILE)
  private Ac3DynamicRangeCompressionProfile dynamicRangeCompressionProfile;
  ...
  private Ac3DynamicRangeCompressionRf dynamicRangeCompressionRf;
  ...
  public AudioCodecSettingsAc3Settings bitrate(Integer bitrate) {
  ...
  public AudioCodecSettingsAc3Settings dynamicRangeCompressionLine(Ac3DynamicRangeCompressionLine dynamicRangeCompressionLine) {
   ...
   */
  @javax.annotation.Nullable
  public Ac3DynamicRangeCompressionLine getDynamicRangeCompressionLine() {
    return dynamicRangeCompressionLine;
  }

  public void setDynamicRangeCompressionLine(Ac3DynamicRangeCompressionLine dynamicRangeCompressionLine) {
    this.dynamicRangeCompressionLine = dynamicRangeCompressionLine;
  }


  public AudioCodecSettingsAc3Settings dynamicRangeCompressionProfile(Ac3DynamicRangeCompressionProfile dynamicRangeCompressionProfile) {
    this.dynamicRangeCompressionProfile = dynamicRangeCompressionProfile;
    return this;
  }

  /**
   * Get dynamicRangeCompressionProfile
   * @return dynamicRangeCompressionProfile
   */
  @javax.annotation.Nullable
  public Ac3DynamicRangeCompressionProfile getDynamicRangeCompressionProfile() {
    return dynamicRangeCompressionProfile;
  }

  public void setDynamicRangeCompressionProfile(Ac3DynamicRangeCompressionProfile dynamicRangeCompressionProfile) {
    this.dynamicRangeCompressionProfile = dynamicRangeCompressionProfile;
  }


  public AudioCodecSettingsAc3Settings dynamicRangeCompressionRf(Ac3DynamicRangeCompressionRf dynamicRangeCompressionRf) {
   ...
   */
  @javax.annotation.Nullable
  public Ac3DynamicRangeCompressionRf getDynamicRangeCompressionRf() {
    return dynamicRangeCompressionRf;
  }

  public void setDynamicRangeCompressionRf(Ac3DynamicRangeCompressionRf dynamicRangeCompressionRf) {
    this.dynamicRangeCompressionRf = dynamicRangeCompressionRf;
  }
  ...
  public AudioCodecSettingsAc3Settings sampleRate(Integer sampleRate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bitrate, audioCodecSettingsAc3Settings.bitrate) &&
        ...
        Objects.equals(this.dynamicRangeCompressionLine, audioCodecSettingsAc3Settings.dynamicRangeCompressionLine) &&
        Objects.equals(this.dynamicRangeCompressionProfile, audioCodecSettingsAc3Settings.dynamicRangeCompressionProfile) &&
        Objects.equals(this.dynamicRangeCompressionRf, audioCodecSettingsAc3Settings.dynamicRangeCompressionRf) &&
        ...
        Objects.equals(this.sampleRate, audioCodecSettingsAc3Settings.sampleRate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bitrate, bitstreamMode, codingMode, dialnorm, dynamicRangeCompressionLine, dynamicRangeCompressionProfile, dynamicRangeCompressionRf, lfeFilter, metadataControl, sampleRate);
  }
  ...
  public String toString() {
    ...
    sb.append("    dynamicRangeCompressionProfile: ").append(toIndentedString(dynamicRangeCompressionProfile)).append("\n");
  ...
  static {
    ...
    openapiFields.add("DynamicRangeCompressionProfile");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("DynamicRangeCompressionLine") != null && !jsonObj.get("DynamicRangeCompressionLine").isJsonNull()) {
        Ac3DynamicRangeCompressionLine.validateJsonElement(jsonObj.get("DynamicRangeCompressionLine"));
      }
      // validate the optional field `DynamicRangeCompressionProfile`
      if (jsonObj.get("DynamicRangeCompressionProfile") != null && !jsonObj.get("DynamicRangeCompressionProfile").isJsonNull()) {
        Ac3DynamicRangeCompressionProfile.validateJsonElement(jsonObj.get("DynamicRangeCompressionProfile"));
      }
      ...
      if (jsonObj.get("DynamicRangeCompressionRf") != null && !jsonObj.get("DynamicRangeCompressionRf").isJsonNull()) {
        Ac3DynamicRangeCompressionRf.validateJsonElement(jsonObj.get("DynamicRangeCompressionRf"));
      }
