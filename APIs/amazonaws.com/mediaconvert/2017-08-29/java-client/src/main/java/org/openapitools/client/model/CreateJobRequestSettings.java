...
public class CreateJobRequestSettings {
  ...
  public CreateJobRequestSettings() {
  }

  public CreateJobRequestSettings adAvailOffset(Integer adAvailOffset) {
  ...
  public CreateJobRequestSettings availBlanking(CreateJobRequestSettingsAvailBlanking availBlanking) {
  ...
  public CreateJobRequestSettings esam(CreateJobRequestSettingsEsam esam) {
    this.esam = esam;
    return this;
  }
  ...
  public CreateJobRequestSettings extendedDataServices(CreateJobRequestSettingsExtendedDataServices extendedDataServices) {
  ...
  public CreateJobRequestSettings inputs(List inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public CreateJobRequestSettings kantarWatermark(CreateJobRequestSettingsKantarWatermark kantarWatermark) {
  ...
  public CreateJobRequestSettings motionImageInserter(CreateJobRequestSettingsMotionImageInserter motionImageInserter) {
  ...
  public CreateJobRequestSettings nielsenConfiguration(CreateJobRequestSettingsNielsenConfiguration nielsenConfiguration) {
  ...
  public CreateJobRequestSettings nielsenNonLinearWatermark(CreateJobRequestSettingsNielsenNonLinearWatermark nielsenNonLinearWatermark) {
  ...
  public CreateJobRequestSettings outputGroups(List outputGroups) {
  ...
  public CreateJobRequestSettings timecodeConfig(CreateJobRequestSettingsTimecodeConfig timecodeConfig) {
  ...
  public CreateJobRequestSettings timedMetadataInsertion(CreateJobRequestSettingsTimedMetadataInsertion timedMetadataInsertion) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobRequestSettings createJobRequestSettings = (CreateJobRequestSettings) o;
    return Objects.equals(this.adAvailOffset, createJobRequestSettings.adAvailOffset) &&
        Objects.equals(this.availBlanking, createJobRequestSettings.availBlanking) &&
        Objects.equals(this.esam, createJobRequestSettings.esam) &&
        Objects.equals(this.extendedDataServices, createJobRequestSettings.extendedDataServices) &&
        Objects.equals(this.inputs, createJobRequestSettings.inputs) &&
        Objects.equals(this.kantarWatermark, createJobRequestSettings.kantarWatermark) &&
        Objects.equals(this.motionImageInserter, createJobRequestSettings.motionImageInserter) &&
        Objects.equals(this.nielsenConfiguration, createJobRequestSettings.nielsenConfiguration) &&
        Objects.equals(this.nielsenNonLinearWatermark, createJobRequestSettings.nielsenNonLinearWatermark) &&
        Objects.equals(this.outputGroups, createJobRequestSettings.outputGroups) &&
        Objects.equals(this.timecodeConfig, createJobRequestSettings.timecodeConfig) &&
        Objects.equals(this.timedMetadataInsertion, createJobRequestSettings.timedMetadataInsertion);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobRequestSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJobRequestSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJobRequestSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobRequestSettings is not found in the empty JSON string", CreateJobRequestSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJobRequestSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJobRequestSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobRequestSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobRequestSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobRequestSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobRequestSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobRequestSettings>() {
           @Override
           public void write(JsonWriter out, CreateJobRequestSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJobRequestSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJobRequestSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJobRequestSettings
   * @throws IOException if the JSON string is invalid with respect to CreateJobRequestSettings
   */
  public static CreateJobRequestSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobRequestSettings.class);
  }

  /**
   * Convert an instance of CreateJobRequestSettings to an JSON string
   *
   * @return JSON string
   */
