...
public class MotionImageInserter {
  ...
  public MotionImageInserter() {
  }

  public MotionImageInserter framerate(MotionImageInserterFramerate framerate) {
  ...
  public MotionImageInserter input(String input) {
    this.input = input;
    return this;
  }
  ...
  public MotionImageInserter insertionMode(MotionImageInsertionMode insertionMode) {
  ...
  public MotionImageInserter offset(MotionImageInserterOffset offset) {
    this.offset = offset;
    return this;
  }
  ...
  public MotionImageInserter playback(MotionImagePlayback playback) {
  ...
  public MotionImageInserter startTime(String startTime) {
  ...
  public boolean equals(Object o) {
    ...
    MotionImageInserter motionImageInserter = (MotionImageInserter) o;
    return Objects.equals(this.framerate, motionImageInserter.framerate) &&
        Objects.equals(this.input, motionImageInserter.input) &&
        Objects.equals(this.insertionMode, motionImageInserter.insertionMode) &&
        Objects.equals(this.offset, motionImageInserter.offset) &&
        Objects.equals(this.playback, motionImageInserter.playback) &&
        Objects.equals(this.startTime, motionImageInserter.startTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class MotionImageInserter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MotionImageInserter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MotionImageInserter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MotionImageInserter is not found in the empty JSON string", MotionImageInserter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MotionImageInserter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MotionImageInserter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MotionImageInserter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MotionImageInserter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MotionImageInserter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MotionImageInserter.class));

       return (TypeAdapter<T>) new TypeAdapter<MotionImageInserter>() {
           @Override
           public void write(JsonWriter out, MotionImageInserter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MotionImageInserter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MotionImageInserter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MotionImageInserter
   * @throws IOException if the JSON string is invalid with respect to MotionImageInserter
   */
  public static MotionImageInserter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MotionImageInserter.class);
  }

  /**
   * Convert an instance of MotionImageInserter to an JSON string
   *
   * @return JSON string
   */
