...
public class OutputSettingsHlsSettings {
  ...
  public OutputSettingsHlsSettings() {
  }

  public OutputSettingsHlsSettings audioGroupId(String audioGroupId) {
  ...
  public OutputSettingsHlsSettings audioOnlyContainer(HlsAudioOnlyContainer audioOnlyContainer) {
  ...
  public OutputSettingsHlsSettings audioRenditionSets(String audioRenditionSets) {
  ...
  public OutputSettingsHlsSettings audioTrackType(HlsAudioTrackType audioTrackType) {
  ...
  public OutputSettingsHlsSettings descriptiveVideoServiceFlag(HlsDescriptiveVideoServiceFlag descriptiveVideoServiceFlag) {
  ...
  public OutputSettingsHlsSettings iframeOnlyManifest(HlsIFrameOnlyManifest iframeOnlyManifest) {
  ...
  public OutputSettingsHlsSettings segmentModifier(String segmentModifier) {
  ...
  public boolean equals(Object o) {
    ...
    OutputSettingsHlsSettings outputSettingsHlsSettings = (OutputSettingsHlsSettings) o;
    return Objects.equals(this.audioGroupId, outputSettingsHlsSettings.audioGroupId) &&
        Objects.equals(this.audioOnlyContainer, outputSettingsHlsSettings.audioOnlyContainer) &&
        Objects.equals(this.audioRenditionSets, outputSettingsHlsSettings.audioRenditionSets) &&
        Objects.equals(this.audioTrackType, outputSettingsHlsSettings.audioTrackType) &&
        Objects.equals(this.descriptiveVideoServiceFlag, outputSettingsHlsSettings.descriptiveVideoServiceFlag) &&
        Objects.equals(this.iframeOnlyManifest, outputSettingsHlsSettings.iframeOnlyManifest) &&
        Objects.equals(this.segmentModifier, outputSettingsHlsSettings.segmentModifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class OutputSettingsHlsSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OutputSettingsHlsSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OutputSettingsHlsSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OutputSettingsHlsSettings is not found in the empty JSON string", OutputSettingsHlsSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OutputSettingsHlsSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OutputSettingsHlsSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OutputSettingsHlsSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OutputSettingsHlsSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OutputSettingsHlsSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OutputSettingsHlsSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<OutputSettingsHlsSettings>() {
           @Override
           public void write(JsonWriter out, OutputSettingsHlsSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OutputSettingsHlsSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OutputSettingsHlsSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OutputSettingsHlsSettings
   * @throws IOException if the JSON string is invalid with respect to OutputSettingsHlsSettings
   */
  public static OutputSettingsHlsSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OutputSettingsHlsSettings.class);
  }

  /**
   * Convert an instance of OutputSettingsHlsSettings to an JSON string
   *
   * @return JSON string
   */
