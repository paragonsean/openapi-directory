...
public class MovSettings {
  ...
  public MovSettings clapAtom(MovClapAtom clapAtom) {
  ...
  public MovSettings cslgAtom(MovCslgAtom cslgAtom) {
  ...
  public MovSettings mpeg2FourCCControl(MovMpeg2FourCCControl mpeg2FourCCControl) {
  ...
  public MovSettings paddingControl(MovPaddingControl paddingControl) {
  ...
  public MovSettings reference(MovReference reference) {
  ...
  public boolean equals(Object o) {
    ...
    MovSettings movSettings = (MovSettings) o;
    return Objects.equals(this.clapAtom, movSettings.clapAtom) &&
        Objects.equals(this.cslgAtom, movSettings.cslgAtom) &&
        Objects.equals(this.mpeg2FourCCControl, movSettings.mpeg2FourCCControl) &&
        Objects.equals(this.paddingControl, movSettings.paddingControl) &&
        Objects.equals(this.reference, movSettings.reference);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MovSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MovSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MovSettings is not found in the empty JSON string", MovSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MovSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MovSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MovSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MovSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MovSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MovSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<MovSettings>() {
           @Override
           public void write(JsonWriter out, MovSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MovSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MovSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MovSettings
   * @throws IOException if the JSON string is invalid with respect to MovSettings
   */
  public static MovSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MovSettings.class);
  }

  /**
   * Convert an instance of MovSettings to an JSON string
   *
   * @return JSON string
   */
