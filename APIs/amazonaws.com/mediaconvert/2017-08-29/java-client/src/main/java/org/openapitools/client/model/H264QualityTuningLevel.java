 ...
 */
@JsonAdapter(H264QualityTuningLevel.Adapter.class)
public enum H264QualityTuningLevel {
  ...
  H264QualityTuningLevel(String value) {
    this.value = value;
  }
  ...
  public static H264QualityTuningLevel fromValue(String value) {
    for (H264QualityTuningLevel b : H264QualityTuningLevel.values()) {
  ...
  public static class Adapter extends TypeAdapter<H264QualityTuningLevel> {
    @Override
    public void write(final JsonWriter jsonWriter, final H264QualityTuningLevel enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public H264QualityTuningLevel read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return H264QualityTuningLevel.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    H264QualityTuningLevel.fromValue(value);
  }
}
