...
public class FileSourceSettings {
  ...
  public FileSourceSettings convert608To708(FileSourceConvert608To708 convert608To708) {
  ...
  public FileSourceSettings convertPaintToPop(CaptionSourceConvertPaintOnToPopOn convertPaintToPop) {
  ...
  public FileSourceSettings framerate(FileSourceSettingsFramerate framerate) {
  ...
  public FileSourceSettings sourceFile(String sourceFile) {
  ...
  public FileSourceSettings timeDelta(Integer timeDelta) {
  ...
  public FileSourceSettings timeDeltaUnits(FileSourceTimeDeltaUnits timeDeltaUnits) {
  ...
  public boolean equals(Object o) {
    ...
    FileSourceSettings fileSourceSettings = (FileSourceSettings) o;
    return Objects.equals(this.convert608To708, fileSourceSettings.convert608To708) &&
        Objects.equals(this.convertPaintToPop, fileSourceSettings.convertPaintToPop) &&
        Objects.equals(this.framerate, fileSourceSettings.framerate) &&
        Objects.equals(this.sourceFile, fileSourceSettings.sourceFile) &&
        Objects.equals(this.timeDelta, fileSourceSettings.timeDelta) &&
        Objects.equals(this.timeDeltaUnits, fileSourceSettings.timeDeltaUnits);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileSourceSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileSourceSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileSourceSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileSourceSettings is not found in the empty JSON string", FileSourceSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileSourceSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileSourceSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileSourceSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileSourceSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileSourceSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileSourceSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<FileSourceSettings>() {
           @Override
           public void write(JsonWriter out, FileSourceSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileSourceSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileSourceSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileSourceSettings
   * @throws IOException if the JSON string is invalid with respect to FileSourceSettings
   */
  public static FileSourceSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileSourceSettings.class);
  }

  /**
   * Convert an instance of FileSourceSettings to an JSON string
   *
   * @return JSON string
   */
