...
public class ContainerSettings {
  ...
  public ContainerSettings cmfcSettings(ContainerSettingsCmfcSettings cmfcSettings) {
  ...
  public ContainerSettings container(ContainerType container) {
  ...
  public ContainerSettings f4vSettings(ContainerSettingsF4vSettings f4vSettings) {
  ...
  public ContainerSettings m2tsSettings(ContainerSettingsM2tsSettings m2tsSettings) {
  ...
  public ContainerSettings m3u8Settings(ContainerSettingsM3u8Settings m3u8Settings) {
  ...
  public ContainerSettings movSettings(ContainerSettingsMovSettings movSettings) {
  ...
  public ContainerSettings mp4Settings(ContainerSettingsMp4Settings mp4Settings) {
  ...
  public ContainerSettings mpdSettings(ContainerSettingsMpdSettings mpdSettings) {
  ...
  public ContainerSettings mxfSettings(ContainerSettingsMxfSettings mxfSettings) {
  ...
  public boolean equals(Object o) {
    ...
    ContainerSettings containerSettings = (ContainerSettings) o;
    return Objects.equals(this.cmfcSettings, containerSettings.cmfcSettings) &&
        Objects.equals(this.container, containerSettings.container) &&
        Objects.equals(this.f4vSettings, containerSettings.f4vSettings) &&
        Objects.equals(this.m2tsSettings, containerSettings.m2tsSettings) &&
        Objects.equals(this.m3u8Settings, containerSettings.m3u8Settings) &&
        Objects.equals(this.movSettings, containerSettings.movSettings) &&
        Objects.equals(this.mp4Settings, containerSettings.mp4Settings) &&
        Objects.equals(this.mpdSettings, containerSettings.mpdSettings) &&
        Objects.equals(this.mxfSettings, containerSettings.mxfSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContainerSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContainerSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContainerSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContainerSettings is not found in the empty JSON string", ContainerSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContainerSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContainerSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContainerSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContainerSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContainerSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContainerSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ContainerSettings>() {
           @Override
           public void write(JsonWriter out, ContainerSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContainerSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContainerSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContainerSettings
   * @throws IOException if the JSON string is invalid with respect to ContainerSettings
   */
  public static ContainerSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContainerSettings.class);
  }

  /**
   * Convert an instance of ContainerSettings to an JSON string
   *
   * @return JSON string
   */
