...
public class ContainerSettingsCmfcSettings {
  ...
  public ContainerSettingsCmfcSettings() {
  }

  public ContainerSettingsCmfcSettings audioDuration(CmfcAudioDuration audioDuration) {
  ...
  public ContainerSettingsCmfcSettings audioGroupId(String audioGroupId) {
  ...
  public ContainerSettingsCmfcSettings audioRenditionSets(String audioRenditionSets) {
  ...
  public ContainerSettingsCmfcSettings audioTrackType(CmfcAudioTrackType audioTrackType) {
  ...
  public ContainerSettingsCmfcSettings descriptiveVideoServiceFlag(CmfcDescriptiveVideoServiceFlag descriptiveVideoServiceFlag) {
  ...
  public ContainerSettingsCmfcSettings iframeOnlyManifest(CmfcIFrameOnlyManifest iframeOnlyManifest) {
  ...
  public ContainerSettingsCmfcSettings klvMetadata(CmfcKlvMetadata klvMetadata) {
  ...
  public ContainerSettingsCmfcSettings manifestMetadataSignaling(CmfcManifestMetadataSignaling manifestMetadataSignaling) {
  ...
  public ContainerSettingsCmfcSettings scte35Esam(CmfcScte35Esam scte35Esam) {
  ...
  public ContainerSettingsCmfcSettings scte35Source(CmfcScte35Source scte35Source) {
  ...
  public ContainerSettingsCmfcSettings timedMetadata(CmfcTimedMetadata timedMetadata) {
  ...
  public ContainerSettingsCmfcSettings timedMetadataBoxVersion(CmfcTimedMetadataBoxVersion timedMetadataBoxVersion) {
  ...
  public ContainerSettingsCmfcSettings timedMetadataSchemeIdUri(String timedMetadataSchemeIdUri) {
  ...
  public ContainerSettingsCmfcSettings timedMetadataValue(String timedMetadataValue) {
  ...
  public boolean equals(Object o) {
    ...
    ContainerSettingsCmfcSettings containerSettingsCmfcSettings = (ContainerSettingsCmfcSettings) o;
    return Objects.equals(this.audioDuration, containerSettingsCmfcSettings.audioDuration) &&
        Objects.equals(this.audioGroupId, containerSettingsCmfcSettings.audioGroupId) &&
        Objects.equals(this.audioRenditionSets, containerSettingsCmfcSettings.audioRenditionSets) &&
        Objects.equals(this.audioTrackType, containerSettingsCmfcSettings.audioTrackType) &&
        Objects.equals(this.descriptiveVideoServiceFlag, containerSettingsCmfcSettings.descriptiveVideoServiceFlag) &&
        Objects.equals(this.iframeOnlyManifest, containerSettingsCmfcSettings.iframeOnlyManifest) &&
        Objects.equals(this.klvMetadata, containerSettingsCmfcSettings.klvMetadata) &&
        Objects.equals(this.manifestMetadataSignaling, containerSettingsCmfcSettings.manifestMetadataSignaling) &&
        Objects.equals(this.scte35Esam, containerSettingsCmfcSettings.scte35Esam) &&
        Objects.equals(this.scte35Source, containerSettingsCmfcSettings.scte35Source) &&
        Objects.equals(this.timedMetadata, containerSettingsCmfcSettings.timedMetadata) &&
        Objects.equals(this.timedMetadataBoxVersion, containerSettingsCmfcSettings.timedMetadataBoxVersion) &&
        Objects.equals(this.timedMetadataSchemeIdUri, containerSettingsCmfcSettings.timedMetadataSchemeIdUri) &&
        Objects.equals(this.timedMetadataValue, containerSettingsCmfcSettings.timedMetadataValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContainerSettingsCmfcSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContainerSettingsCmfcSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContainerSettingsCmfcSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContainerSettingsCmfcSettings is not found in the empty JSON string", ContainerSettingsCmfcSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContainerSettingsCmfcSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContainerSettingsCmfcSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContainerSettingsCmfcSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContainerSettingsCmfcSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContainerSettingsCmfcSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContainerSettingsCmfcSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ContainerSettingsCmfcSettings>() {
           @Override
           public void write(JsonWriter out, ContainerSettingsCmfcSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContainerSettingsCmfcSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContainerSettingsCmfcSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContainerSettingsCmfcSettings
   * @throws IOException if the JSON string is invalid with respect to ContainerSettingsCmfcSettings
   */
  public static ContainerSettingsCmfcSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContainerSettingsCmfcSettings.class);
  }

  /**
   * Convert an instance of ContainerSettingsCmfcSettings to an JSON string
   *
   * @return JSON string
   */
