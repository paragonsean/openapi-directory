 ...
 */
@JsonAdapter(H264GopSizeUnits.Adapter.class)
public enum H264GopSizeUnits {
  ...
  public static H264GopSizeUnits fromValue(String value) {
    for (H264GopSizeUnits b : H264GopSizeUnits.values()) {
  ...
  public static class Adapter extends TypeAdapter<H264GopSizeUnits> {
    @Override
    public void write(final JsonWriter jsonWriter, final H264GopSizeUnits enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public H264GopSizeUnits read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return H264GopSizeUnits.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    H264GopSizeUnits.fromValue(value);
  }
}
