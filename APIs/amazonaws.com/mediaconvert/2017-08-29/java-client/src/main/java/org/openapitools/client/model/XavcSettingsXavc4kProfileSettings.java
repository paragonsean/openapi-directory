...
public class XavcSettingsXavc4kProfileSettings {
  ...
  public XavcSettingsXavc4kProfileSettings() {
  }

  public XavcSettingsXavc4kProfileSettings bitrateClass(Xavc4kProfileBitrateClass bitrateClass) {
  ...
  public XavcSettingsXavc4kProfileSettings codecProfile(Xavc4kProfileCodecProfile codecProfile) {
  ...
  public XavcSettingsXavc4kProfileSettings flickerAdaptiveQuantization(XavcFlickerAdaptiveQuantization flickerAdaptiveQuantization) {
  ...
  public XavcSettingsXavc4kProfileSettings gopBReference(XavcGopBReference gopBReference) {
  ...
  public XavcSettingsXavc4kProfileSettings gopClosedCadence(Integer gopClosedCadence) {
  ...
  public XavcSettingsXavc4kProfileSettings hrdBufferSize(Integer hrdBufferSize) {
  ...
  public XavcSettingsXavc4kProfileSettings qualityTuningLevel(Xavc4kProfileQualityTuningLevel qualityTuningLevel) {
  ...
  public XavcSettingsXavc4kProfileSettings slices(Integer slices) {
    this.slices = slices;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XavcSettingsXavc4kProfileSettings xavcSettingsXavc4kProfileSettings = (XavcSettingsXavc4kProfileSettings) o;
    return Objects.equals(this.bitrateClass, xavcSettingsXavc4kProfileSettings.bitrateClass) &&
        Objects.equals(this.codecProfile, xavcSettingsXavc4kProfileSettings.codecProfile) &&
        Objects.equals(this.flickerAdaptiveQuantization, xavcSettingsXavc4kProfileSettings.flickerAdaptiveQuantization) &&
        Objects.equals(this.gopBReference, xavcSettingsXavc4kProfileSettings.gopBReference) &&
        Objects.equals(this.gopClosedCadence, xavcSettingsXavc4kProfileSettings.gopClosedCadence) &&
        Objects.equals(this.hrdBufferSize, xavcSettingsXavc4kProfileSettings.hrdBufferSize) &&
        Objects.equals(this.qualityTuningLevel, xavcSettingsXavc4kProfileSettings.qualityTuningLevel) &&
        Objects.equals(this.slices, xavcSettingsXavc4kProfileSettings.slices);
  }
  ...
  public String toString() {
    ...
    sb.append("class XavcSettingsXavc4kProfileSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to XavcSettingsXavc4kProfileSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XavcSettingsXavc4kProfileSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XavcSettingsXavc4kProfileSettings is not found in the empty JSON string", XavcSettingsXavc4kProfileSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XavcSettingsXavc4kProfileSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XavcSettingsXavc4kProfileSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XavcSettingsXavc4kProfileSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XavcSettingsXavc4kProfileSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XavcSettingsXavc4kProfileSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XavcSettingsXavc4kProfileSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<XavcSettingsXavc4kProfileSettings>() {
           @Override
           public void write(JsonWriter out, XavcSettingsXavc4kProfileSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XavcSettingsXavc4kProfileSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XavcSettingsXavc4kProfileSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XavcSettingsXavc4kProfileSettings
   * @throws IOException if the JSON string is invalid with respect to XavcSettingsXavc4kProfileSettings
   */
  public static XavcSettingsXavc4kProfileSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XavcSettingsXavc4kProfileSettings.class);
  }

  /**
   * Convert an instance of XavcSettingsXavc4kProfileSettings to an JSON string
   *
   * @return JSON string
   */
