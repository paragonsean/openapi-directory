...
public class H265QvbrSettings {
  ...
  public H265QvbrSettings() {
  }

  public H265QvbrSettings maxAverageBitrate(Integer maxAverageBitrate) {
  ...
  public H265QvbrSettings qvbrQualityLevel(Integer qvbrQualityLevel) {
  ...
  public H265QvbrSettings qvbrQualityLevelFineTune(Double qvbrQualityLevelFineTune) {
  ...
  public boolean equals(Object o) {
    ...
    H265QvbrSettings h265QvbrSettings = (H265QvbrSettings) o;
    return Objects.equals(this.maxAverageBitrate, h265QvbrSettings.maxAverageBitrate) &&
        Objects.equals(this.qvbrQualityLevel, h265QvbrSettings.qvbrQualityLevel) &&
        Objects.equals(this.qvbrQualityLevelFineTune, h265QvbrSettings.qvbrQualityLevelFineTune);
  }
  ...
  public String toString() {
    ...
    sb.append("class H265QvbrSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to H265QvbrSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!H265QvbrSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in H265QvbrSettings is not found in the empty JSON string", H265QvbrSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!H265QvbrSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `H265QvbrSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!H265QvbrSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'H265QvbrSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<H265QvbrSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(H265QvbrSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<H265QvbrSettings>() {
           @Override
           public void write(JsonWriter out, H265QvbrSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public H265QvbrSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of H265QvbrSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of H265QvbrSettings
   * @throws IOException if the JSON string is invalid with respect to H265QvbrSettings
   */
  public static H265QvbrSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, H265QvbrSettings.class);
  }

  /**
   * Convert an instance of H265QvbrSettings to an JSON string
   *
   * @return JSON string
   */
