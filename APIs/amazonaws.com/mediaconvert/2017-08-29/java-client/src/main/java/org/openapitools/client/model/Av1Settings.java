...
public class Av1Settings {
  ...
  public Av1Settings adaptiveQuantization(Av1AdaptiveQuantization adaptiveQuantization) {
  ...
  public Av1Settings bitDepth(Av1BitDepth bitDepth) {
  ...
  public Av1Settings framerateControl(Av1FramerateControl framerateControl) {
  ...
  public Av1Settings framerateConversionAlgorithm(Av1FramerateConversionAlgorithm framerateConversionAlgorithm) {
  ...
  public Av1Settings framerateDenominator(Integer framerateDenominator) {
  ...
  public Av1Settings framerateNumerator(Integer framerateNumerator) {
  ...
  public Av1Settings gopSize(Double gopSize) {
  ...
  public Av1Settings maxBitrate(Integer maxBitrate) {
  ...
  public Av1Settings numberBFramesBetweenReferenceFrames(Integer numberBFramesBetweenReferenceFrames) {
  ...
  public Av1Settings qvbrSettings(Av1SettingsQvbrSettings qvbrSettings) {
  ...
  public Av1Settings rateControlMode(Av1RateControlMode rateControlMode) {
  ...
  public Av1Settings slices(Integer slices) {
    this.slices = slices;
    return this;
  }
  ...
  public Av1Settings spatialAdaptiveQuantization(Av1SpatialAdaptiveQuantization spatialAdaptiveQuantization) {
  ...
  public boolean equals(Object o) {
    ...
    Av1Settings av1Settings = (Av1Settings) o;
    return Objects.equals(this.adaptiveQuantization, av1Settings.adaptiveQuantization) &&
        Objects.equals(this.bitDepth, av1Settings.bitDepth) &&
        Objects.equals(this.framerateControl, av1Settings.framerateControl) &&
        Objects.equals(this.framerateConversionAlgorithm, av1Settings.framerateConversionAlgorithm) &&
        Objects.equals(this.framerateDenominator, av1Settings.framerateDenominator) &&
        Objects.equals(this.framerateNumerator, av1Settings.framerateNumerator) &&
        Objects.equals(this.gopSize, av1Settings.gopSize) &&
        Objects.equals(this.maxBitrate, av1Settings.maxBitrate) &&
        Objects.equals(this.numberBFramesBetweenReferenceFrames, av1Settings.numberBFramesBetweenReferenceFrames) &&
        Objects.equals(this.qvbrSettings, av1Settings.qvbrSettings) &&
        Objects.equals(this.rateControlMode, av1Settings.rateControlMode) &&
        Objects.equals(this.slices, av1Settings.slices) &&
        Objects.equals(this.spatialAdaptiveQuantization, av1Settings.spatialAdaptiveQuantization);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Av1Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Av1Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Av1Settings is not found in the empty JSON string", Av1Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Av1Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Av1Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Av1Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Av1Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Av1Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Av1Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<Av1Settings>() {
           @Override
           public void write(JsonWriter out, Av1Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Av1Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Av1Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Av1Settings
   * @throws IOException if the JSON string is invalid with respect to Av1Settings
   */
  public static Av1Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Av1Settings.class);
  }

  /**
   * Convert an instance of Av1Settings to an JSON string
   *
   * @return JSON string
   */
