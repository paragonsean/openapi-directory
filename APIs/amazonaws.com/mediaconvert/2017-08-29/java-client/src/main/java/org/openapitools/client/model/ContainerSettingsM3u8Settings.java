...
public class ContainerSettingsM3u8Settings {
  ...
  public ContainerSettingsM3u8Settings() {
  }

  public ContainerSettingsM3u8Settings audioDuration(M3u8AudioDuration audioDuration) {
  ...
  public ContainerSettingsM3u8Settings audioFramesPerPes(Integer audioFramesPerPes) {
  ...
  public ContainerSettingsM3u8Settings audioPids(List audioPids) {
  ...
  public ContainerSettingsM3u8Settings dataPTSControl(M3u8DataPtsControl dataPTSControl) {
  ...
  public ContainerSettingsM3u8Settings maxPcrInterval(Integer maxPcrInterval) {
  ...
  public ContainerSettingsM3u8Settings nielsenId3(M3u8NielsenId3 nielsenId3) {
  ...
  public ContainerSettingsM3u8Settings patInterval(Integer patInterval) {
  ...
  public ContainerSettingsM3u8Settings pcrControl(M3u8PcrControl pcrControl) {
  ...
  public ContainerSettingsM3u8Settings pcrPid(Integer pcrPid) {
    this.pcrPid = pcrPid;
    return this;
  }
  ...
  public ContainerSettingsM3u8Settings pmtInterval(Integer pmtInterval) {
  ...
  public ContainerSettingsM3u8Settings pmtPid(Integer pmtPid) {
    this.pmtPid = pmtPid;
    return this;
  }
  ...
  public ContainerSettingsM3u8Settings privateMetadataPid(Integer privateMetadataPid) {
  ...
  public ContainerSettingsM3u8Settings programNumber(Integer programNumber) {
  ...
  public ContainerSettingsM3u8Settings scte35Pid(Integer scte35Pid) {
  ...
  public ContainerSettingsM3u8Settings scte35Source(M3u8Scte35Source scte35Source) {
  ...
  public ContainerSettingsM3u8Settings timedMetadata(TimedMetadata timedMetadata) {
  ...
  public ContainerSettingsM3u8Settings timedMetadataPid(Integer timedMetadataPid) {
  ...
  public ContainerSettingsM3u8Settings transportStreamId(Integer transportStreamId) {
  ...
  public ContainerSettingsM3u8Settings videoPid(Integer videoPid) {
  ...
  public boolean equals(Object o) {
    ...
    ContainerSettingsM3u8Settings containerSettingsM3u8Settings = (ContainerSettingsM3u8Settings) o;
    return Objects.equals(this.audioDuration, containerSettingsM3u8Settings.audioDuration) &&
        Objects.equals(this.audioFramesPerPes, containerSettingsM3u8Settings.audioFramesPerPes) &&
        Objects.equals(this.audioPids, containerSettingsM3u8Settings.audioPids) &&
        Objects.equals(this.dataPTSControl, containerSettingsM3u8Settings.dataPTSControl) &&
        Objects.equals(this.maxPcrInterval, containerSettingsM3u8Settings.maxPcrInterval) &&
        Objects.equals(this.nielsenId3, containerSettingsM3u8Settings.nielsenId3) &&
        Objects.equals(this.patInterval, containerSettingsM3u8Settings.patInterval) &&
        Objects.equals(this.pcrControl, containerSettingsM3u8Settings.pcrControl) &&
        Objects.equals(this.pcrPid, containerSettingsM3u8Settings.pcrPid) &&
        Objects.equals(this.pmtInterval, containerSettingsM3u8Settings.pmtInterval) &&
        Objects.equals(this.pmtPid, containerSettingsM3u8Settings.pmtPid) &&
        Objects.equals(this.privateMetadataPid, containerSettingsM3u8Settings.privateMetadataPid) &&
        Objects.equals(this.programNumber, containerSettingsM3u8Settings.programNumber) &&
        Objects.equals(this.scte35Pid, containerSettingsM3u8Settings.scte35Pid) &&
        Objects.equals(this.scte35Source, containerSettingsM3u8Settings.scte35Source) &&
        Objects.equals(this.timedMetadata, containerSettingsM3u8Settings.timedMetadata) &&
        Objects.equals(this.timedMetadataPid, containerSettingsM3u8Settings.timedMetadataPid) &&
        Objects.equals(this.transportStreamId, containerSettingsM3u8Settings.transportStreamId) &&
        Objects.equals(this.videoPid, containerSettingsM3u8Settings.videoPid);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContainerSettingsM3u8Settings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContainerSettingsM3u8Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContainerSettingsM3u8Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContainerSettingsM3u8Settings is not found in the empty JSON string", ContainerSettingsM3u8Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContainerSettingsM3u8Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContainerSettingsM3u8Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContainerSettingsM3u8Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContainerSettingsM3u8Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContainerSettingsM3u8Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContainerSettingsM3u8Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<ContainerSettingsM3u8Settings>() {
           @Override
           public void write(JsonWriter out, ContainerSettingsM3u8Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContainerSettingsM3u8Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContainerSettingsM3u8Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContainerSettingsM3u8Settings
   * @throws IOException if the JSON string is invalid with respect to ContainerSettingsM3u8Settings
   */
  public static ContainerSettingsM3u8Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContainerSettingsM3u8Settings.class);
  }

  /**
   * Convert an instance of ContainerSettingsM3u8Settings to an JSON string
   *
   * @return JSON string
   */
