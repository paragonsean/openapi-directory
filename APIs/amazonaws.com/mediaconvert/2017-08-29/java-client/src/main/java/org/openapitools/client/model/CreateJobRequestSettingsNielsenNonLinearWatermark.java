...
public class CreateJobRequestSettingsNielsenNonLinearWatermark {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark() {
  }

  public CreateJobRequestSettingsNielsenNonLinearWatermark activeWatermarkProcess(NielsenActiveWatermarkProcessType activeWatermarkProcess) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark adiFilename(String adiFilename) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark assetId(String assetId) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark assetName(String assetName) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark cbetSourceId(String cbetSourceId) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark episodeId(String episodeId) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark metadataDestination(String metadataDestination) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark sourceId(Integer sourceId) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark sourceWatermarkStatus(NielsenSourceWatermarkStatusType sourceWatermarkStatus) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark ticServerUrl(String ticServerUrl) {
  ...
  public CreateJobRequestSettingsNielsenNonLinearWatermark uniqueTicPerAudioTrack(NielsenUniqueTicPerAudioTrackType uniqueTicPerAudioTrack) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobRequestSettingsNielsenNonLinearWatermark createJobRequestSettingsNielsenNonLinearWatermark = (CreateJobRequestSettingsNielsenNonLinearWatermark) o;
    return Objects.equals(this.activeWatermarkProcess, createJobRequestSettingsNielsenNonLinearWatermark.activeWatermarkProcess) &&
        Objects.equals(this.adiFilename, createJobRequestSettingsNielsenNonLinearWatermark.adiFilename) &&
        Objects.equals(this.assetId, createJobRequestSettingsNielsenNonLinearWatermark.assetId) &&
        Objects.equals(this.assetName, createJobRequestSettingsNielsenNonLinearWatermark.assetName) &&
        Objects.equals(this.cbetSourceId, createJobRequestSettingsNielsenNonLinearWatermark.cbetSourceId) &&
        Objects.equals(this.episodeId, createJobRequestSettingsNielsenNonLinearWatermark.episodeId) &&
        Objects.equals(this.metadataDestination, createJobRequestSettingsNielsenNonLinearWatermark.metadataDestination) &&
        Objects.equals(this.sourceId, createJobRequestSettingsNielsenNonLinearWatermark.sourceId) &&
        Objects.equals(this.sourceWatermarkStatus, createJobRequestSettingsNielsenNonLinearWatermark.sourceWatermarkStatus) &&
        Objects.equals(this.ticServerUrl, createJobRequestSettingsNielsenNonLinearWatermark.ticServerUrl) &&
        Objects.equals(this.uniqueTicPerAudioTrack, createJobRequestSettingsNielsenNonLinearWatermark.uniqueTicPerAudioTrack);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobRequestSettingsNielsenNonLinearWatermark {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJobRequestSettingsNielsenNonLinearWatermark
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJobRequestSettingsNielsenNonLinearWatermark.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobRequestSettingsNielsenNonLinearWatermark is not found in the empty JSON string", CreateJobRequestSettingsNielsenNonLinearWatermark.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJobRequestSettingsNielsenNonLinearWatermark.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJobRequestSettingsNielsenNonLinearWatermark` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobRequestSettingsNielsenNonLinearWatermark.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobRequestSettingsNielsenNonLinearWatermark' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobRequestSettingsNielsenNonLinearWatermark> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobRequestSettingsNielsenNonLinearWatermark.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobRequestSettingsNielsenNonLinearWatermark>() {
           @Override
           public void write(JsonWriter out, CreateJobRequestSettingsNielsenNonLinearWatermark value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJobRequestSettingsNielsenNonLinearWatermark read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJobRequestSettingsNielsenNonLinearWatermark given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJobRequestSettingsNielsenNonLinearWatermark
   * @throws IOException if the JSON string is invalid with respect to CreateJobRequestSettingsNielsenNonLinearWatermark
   */
  public static CreateJobRequestSettingsNielsenNonLinearWatermark fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobRequestSettingsNielsenNonLinearWatermark.class);
  }

  /**
   * Convert an instance of CreateJobRequestSettingsNielsenNonLinearWatermark to an JSON string
   *
   * @return JSON string
   */
