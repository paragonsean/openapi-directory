...
public class InputVideoSelector {
  ...
  public InputVideoSelector() {
  }

  public InputVideoSelector alphaBehavior(AlphaBehavior alphaBehavior) {
  ...
  public InputVideoSelector colorSpace(ColorSpace colorSpace) {
  ...
  public InputVideoSelector colorSpaceUsage(ColorSpaceUsage colorSpaceUsage) {
  ...
  public InputVideoSelector embeddedTimecodeOverride(EmbeddedTimecodeOverride embeddedTimecodeOverride) {
  ...
  public InputVideoSelector hdr10Metadata(VideoSelectorHdr10Metadata hdr10Metadata) {
  ...
  public InputVideoSelector padVideo(PadVideo padVideo) {
  ...
  public InputVideoSelector pid(Integer pid) {
    this.pid = pid;
    return this;
  }
  ...
  public InputVideoSelector programNumber(Integer programNumber) {
  ...
  public InputVideoSelector rotate(InputRotate rotate) {
    this.rotate = rotate;
    return this;
  }
  ...
  public InputVideoSelector sampleRange(InputSampleRange sampleRange) {
  ...
  public boolean equals(Object o) {
    ...
    InputVideoSelector inputVideoSelector = (InputVideoSelector) o;
    return Objects.equals(this.alphaBehavior, inputVideoSelector.alphaBehavior) &&
        Objects.equals(this.colorSpace, inputVideoSelector.colorSpace) &&
        Objects.equals(this.colorSpaceUsage, inputVideoSelector.colorSpaceUsage) &&
        Objects.equals(this.embeddedTimecodeOverride, inputVideoSelector.embeddedTimecodeOverride) &&
        Objects.equals(this.hdr10Metadata, inputVideoSelector.hdr10Metadata) &&
        Objects.equals(this.padVideo, inputVideoSelector.padVideo) &&
        Objects.equals(this.pid, inputVideoSelector.pid) &&
        Objects.equals(this.programNumber, inputVideoSelector.programNumber) &&
        Objects.equals(this.rotate, inputVideoSelector.rotate) &&
        Objects.equals(this.sampleRange, inputVideoSelector.sampleRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class InputVideoSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InputVideoSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputVideoSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputVideoSelector is not found in the empty JSON string", InputVideoSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputVideoSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputVideoSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InputVideoSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InputVideoSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InputVideoSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InputVideoSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<InputVideoSelector>() {
           @Override
           public void write(JsonWriter out, InputVideoSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InputVideoSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InputVideoSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InputVideoSelector
   * @throws IOException if the JSON string is invalid with respect to InputVideoSelector
   */
  public static InputVideoSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InputVideoSelector.class);
  }

  /**
   * Convert an instance of InputVideoSelector to an JSON string
   *
   * @return JSON string
   */
