...
public class GetJobResponse {
  ...
  private CreateJobResponseJob job;

  public GetJobResponse() {
  }

  public GetJobResponse job(CreateJobResponseJob job) {
    this.job = job;
    return this;
  }
  ...
  public CreateJobResponseJob getJob() {
    return job;
  }

  public void setJob(CreateJobResponseJob job) {
    this.job = job;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Job") != null && !jsonObj.get("Job").isJsonNull()) {
        CreateJobResponseJob.validateJsonElement(jsonObj.get("Job"));
      }
  }
