...
public class ColorCorrector {
  ...
  public ColorCorrector brightness(Integer brightness) {
  ...
  public ColorCorrector clipLimits(ColorCorrectorClipLimits clipLimits) {
  ...
  public ColorCorrector colorSpaceConversion(ColorSpaceConversion colorSpaceConversion) {
  ...
  public ColorCorrector contrast(Integer contrast) {
  ...
  public ColorCorrector hdr10Metadata(ColorCorrectorHdr10Metadata hdr10Metadata) {
  ...
  public ColorCorrector hdrToSdrToneMapper(HDRToSDRToneMapper hdrToSdrToneMapper) {
  ...
  public ColorCorrector hue(Integer hue) {
    this.hue = hue;
    return this;
  }
  ...
  public ColorCorrector sampleRangeConversion(SampleRangeConversion sampleRangeConversion) {
  ...
  public ColorCorrector saturation(Integer saturation) {
  ...
  public ColorCorrector sdrReferenceWhiteLevel(Integer sdrReferenceWhiteLevel) {
  ...
  public boolean equals(Object o) {
    ...
    ColorCorrector colorCorrector = (ColorCorrector) o;
    return Objects.equals(this.brightness, colorCorrector.brightness) &&
        Objects.equals(this.clipLimits, colorCorrector.clipLimits) &&
        Objects.equals(this.colorSpaceConversion, colorCorrector.colorSpaceConversion) &&
        Objects.equals(this.contrast, colorCorrector.contrast) &&
        Objects.equals(this.hdr10Metadata, colorCorrector.hdr10Metadata) &&
        Objects.equals(this.hdrToSdrToneMapper, colorCorrector.hdrToSdrToneMapper) &&
        Objects.equals(this.hue, colorCorrector.hue) &&
        Objects.equals(this.sampleRangeConversion, colorCorrector.sampleRangeConversion) &&
        Objects.equals(this.saturation, colorCorrector.saturation) &&
        Objects.equals(this.sdrReferenceWhiteLevel, colorCorrector.sdrReferenceWhiteLevel);
  }
  ...
  public String toString() {
    ...
    sb.append("class ColorCorrector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColorCorrector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColorCorrector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ColorCorrector is not found in the empty JSON string", ColorCorrector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColorCorrector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColorCorrector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColorCorrector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColorCorrector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ColorCorrector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ColorCorrector.class));

       return (TypeAdapter<T>) new TypeAdapter<ColorCorrector>() {
           @Override
           public void write(JsonWriter out, ColorCorrector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ColorCorrector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ColorCorrector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ColorCorrector
   * @throws IOException if the JSON string is invalid with respect to ColorCorrector
   */
  public static ColorCorrector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ColorCorrector.class);
  }

  /**
   * Convert an instance of ColorCorrector to an JSON string
   *
   * @return JSON string
   */
