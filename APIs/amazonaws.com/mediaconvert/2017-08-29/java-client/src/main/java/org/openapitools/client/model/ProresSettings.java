...
public class ProresSettings {
  ...
  public ProresSettings() {
  }

  public ProresSettings chromaSampling(ProresChromaSampling chromaSampling) {
  ...
  public ProresSettings codecProfile(ProresCodecProfile codecProfile) {
  ...
  public ProresSettings framerateControl(ProresFramerateControl framerateControl) {
  ...
  public ProresSettings framerateConversionAlgorithm(ProresFramerateConversionAlgorithm framerateConversionAlgorithm) {
  ...
  public ProresSettings framerateDenominator(Integer framerateDenominator) {
  ...
  public ProresSettings framerateNumerator(Integer framerateNumerator) {
  ...
  public ProresSettings interlaceMode(ProresInterlaceMode interlaceMode) {
  ...
  public ProresSettings parControl(ProresParControl parControl) {
  ...
  public ProresSettings parDenominator(Integer parDenominator) {
  ...
  public ProresSettings parNumerator(Integer parNumerator) {
  ...
  public ProresSettings scanTypeConversionMode(ProresScanTypeConversionMode scanTypeConversionMode) {
  ...
  public ProresSettings slowPal(ProresSlowPal slowPal) {
  ...
  public ProresSettings telecine(ProresTelecine telecine) {
  ...
  public boolean equals(Object o) {
    ...
    ProresSettings proresSettings = (ProresSettings) o;
    return Objects.equals(this.chromaSampling, proresSettings.chromaSampling) &&
        Objects.equals(this.codecProfile, proresSettings.codecProfile) &&
        Objects.equals(this.framerateControl, proresSettings.framerateControl) &&
        Objects.equals(this.framerateConversionAlgorithm, proresSettings.framerateConversionAlgorithm) &&
        Objects.equals(this.framerateDenominator, proresSettings.framerateDenominator) &&
        Objects.equals(this.framerateNumerator, proresSettings.framerateNumerator) &&
        Objects.equals(this.interlaceMode, proresSettings.interlaceMode) &&
        Objects.equals(this.parControl, proresSettings.parControl) &&
        Objects.equals(this.parDenominator, proresSettings.parDenominator) &&
        Objects.equals(this.parNumerator, proresSettings.parNumerator) &&
        Objects.equals(this.scanTypeConversionMode, proresSettings.scanTypeConversionMode) &&
        Objects.equals(this.slowPal, proresSettings.slowPal) &&
        Objects.equals(this.telecine, proresSettings.telecine);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProresSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProresSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProresSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProresSettings is not found in the empty JSON string", ProresSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProresSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProresSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProresSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProresSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProresSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProresSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ProresSettings>() {
           @Override
           public void write(JsonWriter out, ProresSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProresSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProresSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProresSettings
   * @throws IOException if the JSON string is invalid with respect to ProresSettings
   */
  public static ProresSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProresSettings.class);
  }

  /**
   * Convert an instance of ProresSettings to an JSON string
   *
   * @return JSON string
   */
