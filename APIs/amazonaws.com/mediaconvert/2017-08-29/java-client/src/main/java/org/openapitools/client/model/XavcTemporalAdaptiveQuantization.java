 ...
 */
@JsonAdapter(XavcTemporalAdaptiveQuantization.Adapter.class)
public enum XavcTemporalAdaptiveQuantization {
  ...
  XavcTemporalAdaptiveQuantization(String value) {
    this.value = value;
  }
  ...
  public static XavcTemporalAdaptiveQuantization fromValue(String value) {
    for (XavcTemporalAdaptiveQuantization b : XavcTemporalAdaptiveQuantization.values()) {
  ...
  public static class Adapter extends TypeAdapter<XavcTemporalAdaptiveQuantization> {
    @Override
    public void write(final JsonWriter jsonWriter, final XavcTemporalAdaptiveQuantization enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public XavcTemporalAdaptiveQuantization read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return XavcTemporalAdaptiveQuantization.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    XavcTemporalAdaptiveQuantization.fromValue(value);
  }
}
