...
public class WavSettings {
  ...
  public WavSettings bitDepth(Integer bitDepth) {
  ...
  public WavSettings channels(Integer channels) {
  ...
  public WavSettings format(WavFormat format) {
    this.format = format;
    return this;
  }
  ...
  public WavSettings sampleRate(Integer sampleRate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bitDepth, wavSettings.bitDepth) &&
        Objects.equals(this.channels, wavSettings.channels) &&
        Objects.equals(this.format, wavSettings.format) &&
        Objects.equals(this.sampleRate, wavSettings.sampleRate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bitDepth, channels, format, sampleRate);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Format") != null && !jsonObj.get("Format").isJsonNull()) {
        WavFormat.validateJsonElement(jsonObj.get("Format"));
      }
