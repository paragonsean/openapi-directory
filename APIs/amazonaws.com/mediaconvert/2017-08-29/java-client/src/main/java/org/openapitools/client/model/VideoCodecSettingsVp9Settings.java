...
public class VideoCodecSettingsVp9Settings {
  ...
  public VideoCodecSettingsVp9Settings() {
  }

  public VideoCodecSettingsVp9Settings bitrate(Integer bitrate) {
  ...
  public VideoCodecSettingsVp9Settings framerateControl(Vp9FramerateControl framerateControl) {
  ...
  public VideoCodecSettingsVp9Settings framerateConversionAlgorithm(Vp9FramerateConversionAlgorithm framerateConversionAlgorithm) {
  ...
  public VideoCodecSettingsVp9Settings framerateDenominator(Integer framerateDenominator) {
  ...
  public VideoCodecSettingsVp9Settings framerateNumerator(Integer framerateNumerator) {
  ...
  public VideoCodecSettingsVp9Settings gopSize(Double gopSize) {
  ...
  public VideoCodecSettingsVp9Settings hrdBufferSize(Integer hrdBufferSize) {
  ...
  public VideoCodecSettingsVp9Settings maxBitrate(Integer maxBitrate) {
  ...
  public VideoCodecSettingsVp9Settings parControl(Vp9ParControl parControl) {
  ...
  public VideoCodecSettingsVp9Settings parDenominator(Integer parDenominator) {
  ...
  public VideoCodecSettingsVp9Settings parNumerator(Integer parNumerator) {
  ...
  public VideoCodecSettingsVp9Settings qualityTuningLevel(Vp9QualityTuningLevel qualityTuningLevel) {
  ...
  public VideoCodecSettingsVp9Settings rateControlMode(Vp9RateControlMode rateControlMode) {
  ...
  public boolean equals(Object o) {
    ...
    VideoCodecSettingsVp9Settings videoCodecSettingsVp9Settings = (VideoCodecSettingsVp9Settings) o;
    return Objects.equals(this.bitrate, videoCodecSettingsVp9Settings.bitrate) &&
        Objects.equals(this.framerateControl, videoCodecSettingsVp9Settings.framerateControl) &&
        Objects.equals(this.framerateConversionAlgorithm, videoCodecSettingsVp9Settings.framerateConversionAlgorithm) &&
        Objects.equals(this.framerateDenominator, videoCodecSettingsVp9Settings.framerateDenominator) &&
        Objects.equals(this.framerateNumerator, videoCodecSettingsVp9Settings.framerateNumerator) &&
        Objects.equals(this.gopSize, videoCodecSettingsVp9Settings.gopSize) &&
        Objects.equals(this.hrdBufferSize, videoCodecSettingsVp9Settings.hrdBufferSize) &&
        Objects.equals(this.maxBitrate, videoCodecSettingsVp9Settings.maxBitrate) &&
        Objects.equals(this.parControl, videoCodecSettingsVp9Settings.parControl) &&
        Objects.equals(this.parDenominator, videoCodecSettingsVp9Settings.parDenominator) &&
        Objects.equals(this.parNumerator, videoCodecSettingsVp9Settings.parNumerator) &&
        Objects.equals(this.qualityTuningLevel, videoCodecSettingsVp9Settings.qualityTuningLevel) &&
        Objects.equals(this.rateControlMode, videoCodecSettingsVp9Settings.rateControlMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideoCodecSettingsVp9Settings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoCodecSettingsVp9Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoCodecSettingsVp9Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoCodecSettingsVp9Settings is not found in the empty JSON string", VideoCodecSettingsVp9Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoCodecSettingsVp9Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoCodecSettingsVp9Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoCodecSettingsVp9Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoCodecSettingsVp9Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoCodecSettingsVp9Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoCodecSettingsVp9Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoCodecSettingsVp9Settings>() {
           @Override
           public void write(JsonWriter out, VideoCodecSettingsVp9Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoCodecSettingsVp9Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoCodecSettingsVp9Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoCodecSettingsVp9Settings
   * @throws IOException if the JSON string is invalid with respect to VideoCodecSettingsVp9Settings
   */
  public static VideoCodecSettingsVp9Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoCodecSettingsVp9Settings.class);
  }

  /**
   * Convert an instance of VideoCodecSettingsVp9Settings to an JSON string
   *
   * @return JSON string
   */
