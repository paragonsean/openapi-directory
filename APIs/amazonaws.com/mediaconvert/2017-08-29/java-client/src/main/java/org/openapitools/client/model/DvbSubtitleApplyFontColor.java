 ...
 */
@JsonAdapter(DvbSubtitleApplyFontColor.Adapter.class)
public enum DvbSubtitleApplyFontColor {
  ...
  DvbSubtitleApplyFontColor(String value) {
    this.value = value;
  }
  ...
  public static DvbSubtitleApplyFontColor fromValue(String value) {
    for (DvbSubtitleApplyFontColor b : DvbSubtitleApplyFontColor.values()) {
  ...
  public static class Adapter extends TypeAdapter<DvbSubtitleApplyFontColor> {
    @Override
    public void write(final JsonWriter jsonWriter, final DvbSubtitleApplyFontColor enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DvbSubtitleApplyFontColor read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DvbSubtitleApplyFontColor.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DvbSubtitleApplyFontColor.fromValue(value);
  }
}
