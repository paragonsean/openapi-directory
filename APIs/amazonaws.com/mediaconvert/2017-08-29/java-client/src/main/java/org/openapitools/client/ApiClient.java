...
public class ApiClient {
    ...
    private String basePath = "http://mediaconvert.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://mediaconvert.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://mediaconvert.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://mediaconvert.{region}.amazonaws.com.cn",
      "The MediaConvert endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-08-29/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://mediaconvert.us-east-1.amazonaws.com
