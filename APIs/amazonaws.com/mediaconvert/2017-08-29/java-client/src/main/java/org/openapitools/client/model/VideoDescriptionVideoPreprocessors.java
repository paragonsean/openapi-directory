...
public class VideoDescriptionVideoPreprocessors {
  ...
  public VideoDescriptionVideoPreprocessors() {
  }

  public VideoDescriptionVideoPreprocessors colorCorrector(VideoPreprocessorColorCorrector colorCorrector) {
  ...
  public VideoDescriptionVideoPreprocessors deinterlacer(VideoPreprocessorDeinterlacer deinterlacer) {
  ...
  public VideoDescriptionVideoPreprocessors dolbyVision(VideoPreprocessorDolbyVision dolbyVision) {
  ...
  public VideoDescriptionVideoPreprocessors hdr10Plus(VideoPreprocessorHdr10Plus hdr10Plus) {
  ...
  public VideoDescriptionVideoPreprocessors imageInserter(VideoPreprocessorImageInserter imageInserter) {
  ...
  public VideoDescriptionVideoPreprocessors noiseReducer(VideoPreprocessorNoiseReducer noiseReducer) {
  ...
  public VideoDescriptionVideoPreprocessors partnerWatermarking(VideoPreprocessorPartnerWatermarking partnerWatermarking) {
  ...
  public VideoDescriptionVideoPreprocessors timecodeBurnin(VideoPreprocessorTimecodeBurnin timecodeBurnin) {
  ...
  public boolean equals(Object o) {
    ...
    VideoDescriptionVideoPreprocessors videoDescriptionVideoPreprocessors = (VideoDescriptionVideoPreprocessors) o;
    return Objects.equals(this.colorCorrector, videoDescriptionVideoPreprocessors.colorCorrector) &&
        Objects.equals(this.deinterlacer, videoDescriptionVideoPreprocessors.deinterlacer) &&
        Objects.equals(this.dolbyVision, videoDescriptionVideoPreprocessors.dolbyVision) &&
        Objects.equals(this.hdr10Plus, videoDescriptionVideoPreprocessors.hdr10Plus) &&
        Objects.equals(this.imageInserter, videoDescriptionVideoPreprocessors.imageInserter) &&
        Objects.equals(this.noiseReducer, videoDescriptionVideoPreprocessors.noiseReducer) &&
        Objects.equals(this.partnerWatermarking, videoDescriptionVideoPreprocessors.partnerWatermarking) &&
        Objects.equals(this.timecodeBurnin, videoDescriptionVideoPreprocessors.timecodeBurnin);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideoDescriptionVideoPreprocessors {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoDescriptionVideoPreprocessors
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoDescriptionVideoPreprocessors.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoDescriptionVideoPreprocessors is not found in the empty JSON string", VideoDescriptionVideoPreprocessors.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoDescriptionVideoPreprocessors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoDescriptionVideoPreprocessors` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoDescriptionVideoPreprocessors.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoDescriptionVideoPreprocessors' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoDescriptionVideoPreprocessors> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoDescriptionVideoPreprocessors.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoDescriptionVideoPreprocessors>() {
           @Override
           public void write(JsonWriter out, VideoDescriptionVideoPreprocessors value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoDescriptionVideoPreprocessors read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoDescriptionVideoPreprocessors given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoDescriptionVideoPreprocessors
   * @throws IOException if the JSON string is invalid with respect to VideoDescriptionVideoPreprocessors
   */
  public static VideoDescriptionVideoPreprocessors fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoDescriptionVideoPreprocessors.class);
  }

  /**
   * Convert an instance of VideoDescriptionVideoPreprocessors to an JSON string
   *
   * @return JSON string
   */
