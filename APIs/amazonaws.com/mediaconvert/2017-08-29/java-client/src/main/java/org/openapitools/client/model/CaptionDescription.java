...
public class CaptionDescription {
  ...
  public CaptionDescription customLanguageCode(String customLanguageCode) {
  ...
  public CaptionDescription languageCode(LanguageCode languageCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.captionSelectorName, captionDescription.captionSelectorName) &&
        Objects.equals(this.customLanguageCode, captionDescription.customLanguageCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(captionSelectorName, customLanguageCode, destinationSettings, languageCode, languageDescription);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("CaptionSelectorName") != null && !jsonObj.get("CaptionSelectorName").isJsonNull()) {
