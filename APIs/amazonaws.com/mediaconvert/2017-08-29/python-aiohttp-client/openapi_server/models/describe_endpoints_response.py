...
class DescribeEndpointsResponse(Model):
    ...
    def __init__(self, endpoints: List=None, next_token: str=None):
        ...
        :param next_token: The next_token of this DescribeEndpointsResponse.
        """
        self.openapi_types = {
            'endpoints': List,
            'next_token': str
    ...
    @property
    def next_token(self):
        """Gets the next_token of this DescribeEndpointsResponse.


        :return: The next_token of this DescribeEndpointsResponse.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this DescribeEndpointsResponse.
