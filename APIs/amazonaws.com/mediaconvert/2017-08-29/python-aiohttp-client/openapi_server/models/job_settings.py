...
class JobSettings(Model):
    ...
    def __init__(self, ad_avail_offset: int=None, avail_blanking: CreateJobRequestSettingsAvailBlanking=None, esam: CreateJobRequestSettingsEsam=None, extended_data_services: CreateJobRequestSettingsExtendedDataServices=None, inputs: List=None, kantar_watermark: CreateJobRequestSettingsKantarWatermark=None, motion_image_inserter: CreateJobRequestSettingsMotionImageInserter=None, nielsen_configuration: CreateJobRequestSettingsNielsenConfiguration=None, nielsen_non_linear_watermark: CreateJobRequestSettingsNielsenNonLinearWatermark=None, output_groups: List=None, timecode_config: CreateJobRequestSettingsTimecodeConfig=None, timed_metadata_insertion: CreateJobRequestSettingsTimedMetadataInsertion=None):
        ...
        :param ad_avail_offset: The ad_avail_offset of this JobSettings.
        :param avail_blanking: The avail_blanking of this JobSettings.
        :param esam: The esam of this JobSettings.
        :param extended_data_services: The extended_data_services of this JobSettings.
        :param inputs: The inputs of this JobSettings.
        :param kantar_watermark: The kantar_watermark of this JobSettings.
        :param motion_image_inserter: The motion_image_inserter of this JobSettings.
        :param nielsen_configuration: The nielsen_configuration of this JobSettings.
        :param nielsen_non_linear_watermark: The nielsen_non_linear_watermark of this JobSettings.
        :param output_groups: The output_groups of this JobSettings.
        :param timecode_config: The timecode_config of this JobSettings.
        :param timed_metadata_insertion: The timed_metadata_insertion of this JobSettings.
        """
        self.openapi_types = {
            'ad_avail_offset': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'JobSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The JobSettings of this JobSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def ad_avail_offset(self):
        """Gets the ad_avail_offset of this JobSettings.


        :return: The ad_avail_offset of this JobSettings.
        :rtype: int
        """
    ...
    def ad_avail_offset(self, ad_avail_offset):
        """Sets the ad_avail_offset of this JobSettings.
    ...
    def avail_blanking(self):
        """Gets the avail_blanking of this JobSettings.


        :return: The avail_blanking of this JobSettings.
    ...
    def avail_blanking(self, avail_blanking):
        """Sets the avail_blanking of this JobSettings.
    ...
    @property
    def esam(self):
        """Gets the esam of this JobSettings.


        :return: The esam of this JobSettings.
    ...
    @esam.setter
    def esam(self, esam):
        """Sets the esam of this JobSettings.
    ...
    def extended_data_services(self):
        """Gets the extended_data_services of this JobSettings.


        :return: The extended_data_services of this JobSettings.
    ...
    def extended_data_services(self, extended_data_services):
        """Sets the extended_data_services of this JobSettings.
    ...
    @property
    def inputs(self):
        """Gets the inputs of this JobSettings.


        :return: The inputs of this JobSettings.
        :rtype: List
        """
        return self._inputs
    ...
    def inputs(self, inputs):
        """Sets the inputs of this JobSettings.
    ...
    def kantar_watermark(self):
        """Gets the kantar_watermark of this JobSettings.


        :return: The kantar_watermark of this JobSettings.
    ...
    def kantar_watermark(self, kantar_watermark):
        """Sets the kantar_watermark of this JobSettings.
    ...
    def motion_image_inserter(self):
        """Gets the motion_image_inserter of this JobSettings.


        :return: The motion_image_inserter of this JobSettings.
    ...
    def motion_image_inserter(self, motion_image_inserter):
        """Sets the motion_image_inserter of this JobSettings.
    ...
    def nielsen_configuration(self):
        """Gets the nielsen_configuration of this JobSettings.


        :return: The nielsen_configuration of this JobSettings.
    ...
    def nielsen_configuration(self, nielsen_configuration):
        """Sets the nielsen_configuration of this JobSettings.
    ...
    def nielsen_non_linear_watermark(self):
        """Gets the nielsen_non_linear_watermark of this JobSettings.


        :return: The nielsen_non_linear_watermark of this JobSettings.
    ...
    def nielsen_non_linear_watermark(self, nielsen_non_linear_watermark):
        """Sets the nielsen_non_linear_watermark of this JobSettings.
    ...
    def output_groups(self):
        """Gets the output_groups of this JobSettings.


        :return: The output_groups of this JobSettings.
        :rtype: List
        """
    ...
    def output_groups(self, output_groups):
        """Sets the output_groups of this JobSettings.
    ...
    def timecode_config(self):
        """Gets the timecode_config of this JobSettings.


        :return: The timecode_config of this JobSettings.
    ...
    def timecode_config(self, timecode_config):
        """Sets the timecode_config of this JobSettings.
    ...
    def timed_metadata_insertion(self):
        """Gets the timed_metadata_insertion of this JobSettings.


        :return: The timed_metadata_insertion of this JobSettings.
    ...
    def timed_metadata_insertion(self, timed_metadata_insertion):
        """Sets the timed_metadata_insertion of this JobSettings.
