...
OAIBurninSubtitleAlignment OAICaptionDestinationSettings_BurninDestinationSettings::getAlignment() const {
    return m_alignment;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setAlignment(const OAIBurninSubtitleAlignment &alignment) {
...
OAIBurninSubtitleApplyFontColor OAICaptionDestinationSettings_BurninDestinationSettings::getApplyFontColor() const {
    return m_apply_font_color;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setApplyFontColor(const OAIBurninSubtitleApplyFontColor &apply_font_color) {
    m_apply_font_color = apply_font_color;
    m_apply_font_color_isSet = true;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_apply_font_color_Set() const{
    return m_apply_font_color_isSet;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_apply_font_color_Valid() const{
    return m_apply_font_color_isValid;
}

OAIBurninSubtitleBackgroundColor OAICaptionDestinationSettings_BurninDestinationSettings::getBackgroundColor() const {
    return m_background_color;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setBackgroundColor(const OAIBurninSubtitleBackgroundColor &background_color) {
...
OAIBurninSubtitleFallbackFont OAICaptionDestinationSettings_BurninDestinationSettings::getFallbackFont() const {
    return m_fallback_font;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setFallbackFont(const OAIBurninSubtitleFallbackFont &fallback_font) {
    m_fallback_font = fallback_font;
    m_fallback_font_isSet = true;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_fallback_font_Set() const{
    return m_fallback_font_isSet;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_fallback_font_Valid() const{
    return m_fallback_font_isValid;
}

OAIBurninSubtitleFontColor OAICaptionDestinationSettings_BurninDestinationSettings::getFontColor() const {
    return m_font_color;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setFontColor(const OAIBurninSubtitleFontColor &font_color) {
...
OAIFontScript OAICaptionDestinationSettings_BurninDestinationSettings::getFontScript() const {
    return m_font_script;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setFontScript(const OAIFontScript &font_script) {
    m_font_script = font_script;
    m_font_script_isSet = true;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_font_script_Set() const{
    return m_font_script_isSet;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_font_script_Valid() const{
    return m_font_script_isValid;
}

qint32 OAICaptionDestinationSettings_BurninDestinationSettings::getFontSize() const {
    return m_font_size;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setFontSize(const qint32 &font_size) {
...
QString OAICaptionDestinationSettings_BurninDestinationSettings::getHexFontColor() const {
    return m_hex_font_color;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setHexFontColor(const QString &hex_font_color) {
    m_hex_font_color = hex_font_color;
    m_hex_font_color_isSet = true;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_hex_font_color_Set() const{
    return m_hex_font_color_isSet;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_hex_font_color_Valid() const{
    return m_hex_font_color_isValid;
}

OAIBurninSubtitleOutlineColor OAICaptionDestinationSettings_BurninDestinationSettings::getOutlineColor() const {
    return m_outline_color;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setOutlineColor(const OAIBurninSubtitleOutlineColor &outline_color) {
...
OAIBurninSubtitleShadowColor OAICaptionDestinationSettings_BurninDestinationSettings::getShadowColor() const {
    return m_shadow_color;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setShadowColor(const OAIBurninSubtitleShadowColor &shadow_color) {
...
OAIBurnInSubtitleStylePassthrough OAICaptionDestinationSettings_BurninDestinationSettings::getStylePassthrough() const {
    return m_style_passthrough;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setStylePassthrough(const OAIBurnInSubtitleStylePassthrough &style_passthrough) {
    m_style_passthrough = style_passthrough;
    m_style_passthrough_isSet = true;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_style_passthrough_Set() const{
    return m_style_passthrough_isSet;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_style_passthrough_Valid() const{
    return m_style_passthrough_isValid;
}

OAIBurninSubtitleTeletextSpacing OAICaptionDestinationSettings_BurninDestinationSettings::getTeletextSpacing() const {
    return m_teletext_spacing;
}
void OAICaptionDestinationSettings_BurninDestinationSettings::setTeletextSpacing(const OAIBurninSubtitleTeletextSpacing &teletext_spacing) {
    m_teletext_spacing = teletext_spacing;
    m_teletext_spacing_isSet = true;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_teletext_spacing_Set() const{
    return m_teletext_spacing_isSet;
}

bool OAICaptionDestinationSettings_BurninDestinationSettings::is_teletext_spacing_Valid() const{
