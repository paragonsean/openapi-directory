...
OAIVideoPreprocessor_ColorCorrector::OAIVideoPreprocessor_ColorCorrector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideoPreprocessor_ColorCorrector::OAIVideoPreprocessor_ColorCorrector() {
    this->initializeModel();
}

OAIVideoPreprocessor_ColorCorrector::~OAIVideoPreprocessor_ColorCorrector() {}

void OAIVideoPreprocessor_ColorCorrector::initializeModel() {
...
void OAIVideoPreprocessor_ColorCorrector::fromJson(QString jsonString) {
...
void OAIVideoPreprocessor_ColorCorrector::fromJsonObject(QJsonObject json) {
...
QString OAIVideoPreprocessor_ColorCorrector::asJson() const {
...
QJsonObject OAIVideoPreprocessor_ColorCorrector::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIVideoPreprocessor_ColorCorrector::getBrightness() const {
    return m_brightness;
}
void OAIVideoPreprocessor_ColorCorrector::setBrightness(const qint32 &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_brightness_Valid() const{
    return m_brightness_isValid;
}

OAIColorCorrector_ClipLimits OAIVideoPreprocessor_ColorCorrector::getClipLimits() const {
    return m_clip_limits;
}
void OAIVideoPreprocessor_ColorCorrector::setClipLimits(const OAIColorCorrector_ClipLimits &clip_limits) {
    m_clip_limits = clip_limits;
    m_clip_limits_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_clip_limits_Set() const{
    return m_clip_limits_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_clip_limits_Valid() const{
    return m_clip_limits_isValid;
}

OAIColorSpaceConversion OAIVideoPreprocessor_ColorCorrector::getColorSpaceConversion() const {
    return m_color_space_conversion;
}
void OAIVideoPreprocessor_ColorCorrector::setColorSpaceConversion(const OAIColorSpaceConversion &color_space_conversion) {
    m_color_space_conversion = color_space_conversion;
    m_color_space_conversion_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_color_space_conversion_Set() const{
    return m_color_space_conversion_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_color_space_conversion_Valid() const{
    return m_color_space_conversion_isValid;
}

qint32 OAIVideoPreprocessor_ColorCorrector::getContrast() const {
    return m_contrast;
}
void OAIVideoPreprocessor_ColorCorrector::setContrast(const qint32 &contrast) {
    m_contrast = contrast;
    m_contrast_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_contrast_Set() const{
    return m_contrast_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_contrast_Valid() const{
    return m_contrast_isValid;
}

OAIColorCorrector_Hdr10Metadata OAIVideoPreprocessor_ColorCorrector::getHdr10Metadata() const {
    return m_hdr10_metadata;
}
void OAIVideoPreprocessor_ColorCorrector::setHdr10Metadata(const OAIColorCorrector_Hdr10Metadata &hdr10_metadata) {
    m_hdr10_metadata = hdr10_metadata;
    m_hdr10_metadata_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_hdr10_metadata_Set() const{
    return m_hdr10_metadata_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_hdr10_metadata_Valid() const{
    return m_hdr10_metadata_isValid;
}

OAIHDRToSDRToneMapper OAIVideoPreprocessor_ColorCorrector::getHdrToSdrToneMapper() const {
    return m_hdr_to_sdr_tone_mapper;
}
void OAIVideoPreprocessor_ColorCorrector::setHdrToSdrToneMapper(const OAIHDRToSDRToneMapper &hdr_to_sdr_tone_mapper) {
    m_hdr_to_sdr_tone_mapper = hdr_to_sdr_tone_mapper;
    m_hdr_to_sdr_tone_mapper_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_hdr_to_sdr_tone_mapper_Set() const{
    return m_hdr_to_sdr_tone_mapper_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_hdr_to_sdr_tone_mapper_Valid() const{
    return m_hdr_to_sdr_tone_mapper_isValid;
}

qint32 OAIVideoPreprocessor_ColorCorrector::getHue() const {
    return m_hue;
}
void OAIVideoPreprocessor_ColorCorrector::setHue(const qint32 &hue) {
    m_hue = hue;
    m_hue_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_hue_Set() const{
    return m_hue_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_hue_Valid() const{
    return m_hue_isValid;
}

OAISampleRangeConversion OAIVideoPreprocessor_ColorCorrector::getSampleRangeConversion() const {
    return m_sample_range_conversion;
}
void OAIVideoPreprocessor_ColorCorrector::setSampleRangeConversion(const OAISampleRangeConversion &sample_range_conversion) {
    m_sample_range_conversion = sample_range_conversion;
    m_sample_range_conversion_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_sample_range_conversion_Set() const{
    return m_sample_range_conversion_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_sample_range_conversion_Valid() const{
    return m_sample_range_conversion_isValid;
}

qint32 OAIVideoPreprocessor_ColorCorrector::getSaturation() const {
    return m_saturation;
}
void OAIVideoPreprocessor_ColorCorrector::setSaturation(const qint32 &saturation) {
    m_saturation = saturation;
    m_saturation_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_saturation_Set() const{
    return m_saturation_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_saturation_Valid() const{
    return m_saturation_isValid;
}

qint32 OAIVideoPreprocessor_ColorCorrector::getSdrReferenceWhiteLevel() const {
    return m_sdr_reference_white_level;
}
void OAIVideoPreprocessor_ColorCorrector::setSdrReferenceWhiteLevel(const qint32 &sdr_reference_white_level) {
    m_sdr_reference_white_level = sdr_reference_white_level;
    m_sdr_reference_white_level_isSet = true;
}

bool OAIVideoPreprocessor_ColorCorrector::is_sdr_reference_white_level_Set() const{
    return m_sdr_reference_white_level_isSet;
}

bool OAIVideoPreprocessor_ColorCorrector::is_sdr_reference_white_level_Valid() const{
    return m_sdr_reference_white_level_isValid;
}

bool OAIVideoPreprocessor_ColorCorrector::isSet() const {
...
bool OAIVideoPreprocessor_ColorCorrector::isValid() const {
