...
/*
 * OAICreatePreset_request_settings.h
 *
 * Settings for preset
 */

#ifndef OAICreatePreset_request_settings_H
#define OAICreatePreset_request_settings_H
...
class OAICreatePreset_request_settings : public OAIObject {
public:
    OAICreatePreset_request_settings();
    OAICreatePreset_request_settings(QString json);
    ~OAICreatePreset_request_settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePreset_request_settings)

#endif // OAICreatePreset_request_settings_H
