...
OAICreateJobTemplateRequest_Settings::OAICreateJobTemplateRequest_Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateJobTemplateRequest_Settings::OAICreateJobTemplateRequest_Settings() {
    this->initializeModel();
}

OAICreateJobTemplateRequest_Settings::~OAICreateJobTemplateRequest_Settings() {}

void OAICreateJobTemplateRequest_Settings::initializeModel() {
...
void OAICreateJobTemplateRequest_Settings::fromJson(QString jsonString) {
...
void OAICreateJobTemplateRequest_Settings::fromJsonObject(QJsonObject json) {
...
QString OAICreateJobTemplateRequest_Settings::asJson() const {
...
QJsonObject OAICreateJobTemplateRequest_Settings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateJobTemplateRequest_Settings::getAdAvailOffset() const {
    return m_ad_avail_offset;
}
void OAICreateJobTemplateRequest_Settings::setAdAvailOffset(const qint32 &ad_avail_offset) {
    m_ad_avail_offset = ad_avail_offset;
    m_ad_avail_offset_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_ad_avail_offset_Set() const{
    return m_ad_avail_offset_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_ad_avail_offset_Valid() const{
    return m_ad_avail_offset_isValid;
}

OAICreateJob_request_settings_AvailBlanking OAICreateJobTemplateRequest_Settings::getAvailBlanking() const {
    return m_avail_blanking;
}
void OAICreateJobTemplateRequest_Settings::setAvailBlanking(const OAICreateJob_request_settings_AvailBlanking &avail_blanking) {
    m_avail_blanking = avail_blanking;
    m_avail_blanking_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_avail_blanking_Set() const{
    return m_avail_blanking_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_avail_blanking_Valid() const{
    return m_avail_blanking_isValid;
}

OAICreateJob_request_settings_Esam OAICreateJobTemplateRequest_Settings::getEsam() const {
    return m_esam;
}
void OAICreateJobTemplateRequest_Settings::setEsam(const OAICreateJob_request_settings_Esam &esam) {
    m_esam = esam;
    m_esam_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_esam_Set() const{
    return m_esam_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_esam_Valid() const{
    return m_esam_isValid;
}

OAICreateJob_request_settings_ExtendedDataServices OAICreateJobTemplateRequest_Settings::getExtendedDataServices() const {
    return m_extended_data_services;
}
void OAICreateJobTemplateRequest_Settings::setExtendedDataServices(const OAICreateJob_request_settings_ExtendedDataServices &extended_data_services) {
    m_extended_data_services = extended_data_services;
    m_extended_data_services_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_extended_data_services_Set() const{
    return m_extended_data_services_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_extended_data_services_Valid() const{
    return m_extended_data_services_isValid;
}

QList OAICreateJobTemplateRequest_Settings::getInputs() const {
    return m_inputs;
}
void OAICreateJobTemplateRequest_Settings::setInputs(const QList &inputs) {
    m_inputs = inputs;
    m_inputs_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_inputs_Set() const{
    return m_inputs_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_inputs_Valid() const{
    return m_inputs_isValid;
}

OAICreateJob_request_settings_KantarWatermark OAICreateJobTemplateRequest_Settings::getKantarWatermark() const {
    return m_kantar_watermark;
}
void OAICreateJobTemplateRequest_Settings::setKantarWatermark(const OAICreateJob_request_settings_KantarWatermark &kantar_watermark) {
    m_kantar_watermark = kantar_watermark;
    m_kantar_watermark_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_kantar_watermark_Set() const{
    return m_kantar_watermark_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_kantar_watermark_Valid() const{
    return m_kantar_watermark_isValid;
}

OAICreateJob_request_settings_MotionImageInserter OAICreateJobTemplateRequest_Settings::getMotionImageInserter() const {
    return m_motion_image_inserter;
}
void OAICreateJobTemplateRequest_Settings::setMotionImageInserter(const OAICreateJob_request_settings_MotionImageInserter &motion_image_inserter) {
    m_motion_image_inserter = motion_image_inserter;
    m_motion_image_inserter_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_motion_image_inserter_Set() const{
    return m_motion_image_inserter_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_motion_image_inserter_Valid() const{
    return m_motion_image_inserter_isValid;
}

OAICreateJob_request_settings_NielsenConfiguration OAICreateJobTemplateRequest_Settings::getNielsenConfiguration() const {
    return m_nielsen_configuration;
}
void OAICreateJobTemplateRequest_Settings::setNielsenConfiguration(const OAICreateJob_request_settings_NielsenConfiguration &nielsen_configuration) {
    m_nielsen_configuration = nielsen_configuration;
    m_nielsen_configuration_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_nielsen_configuration_Set() const{
    return m_nielsen_configuration_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_nielsen_configuration_Valid() const{
    return m_nielsen_configuration_isValid;
}

OAICreateJob_request_settings_NielsenNonLinearWatermark OAICreateJobTemplateRequest_Settings::getNielsenNonLinearWatermark() const {
    return m_nielsen_non_linear_watermark;
}
void OAICreateJobTemplateRequest_Settings::setNielsenNonLinearWatermark(const OAICreateJob_request_settings_NielsenNonLinearWatermark &nielsen_non_linear_watermark) {
    m_nielsen_non_linear_watermark = nielsen_non_linear_watermark;
    m_nielsen_non_linear_watermark_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_nielsen_non_linear_watermark_Set() const{
    return m_nielsen_non_linear_watermark_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_nielsen_non_linear_watermark_Valid() const{
    return m_nielsen_non_linear_watermark_isValid;
}

QList OAICreateJobTemplateRequest_Settings::getOutputGroups() const {
    return m_output_groups;
}
void OAICreateJobTemplateRequest_Settings::setOutputGroups(const QList &output_groups) {
    m_output_groups = output_groups;
    m_output_groups_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_output_groups_Set() const{
    return m_output_groups_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_output_groups_Valid() const{
    return m_output_groups_isValid;
}

OAICreateJob_request_settings_TimecodeConfig OAICreateJobTemplateRequest_Settings::getTimecodeConfig() const {
    return m_timecode_config;
}
void OAICreateJobTemplateRequest_Settings::setTimecodeConfig(const OAICreateJob_request_settings_TimecodeConfig &timecode_config) {
    m_timecode_config = timecode_config;
    m_timecode_config_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_timecode_config_Set() const{
    return m_timecode_config_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_timecode_config_Valid() const{
    return m_timecode_config_isValid;
}

OAICreateJob_request_settings_TimedMetadataInsertion OAICreateJobTemplateRequest_Settings::getTimedMetadataInsertion() const {
    return m_timed_metadata_insertion;
}
void OAICreateJobTemplateRequest_Settings::setTimedMetadataInsertion(const OAICreateJob_request_settings_TimedMetadataInsertion &timed_metadata_insertion) {
    m_timed_metadata_insertion = timed_metadata_insertion;
    m_timed_metadata_insertion_isSet = true;
}

bool OAICreateJobTemplateRequest_Settings::is_timed_metadata_insertion_Set() const{
    return m_timed_metadata_insertion_isSet;
}

bool OAICreateJobTemplateRequest_Settings::is_timed_metadata_insertion_Valid() const{
    return m_timed_metadata_insertion_isValid;
}

bool OAICreateJobTemplateRequest_Settings::isSet() const {
...
bool OAICreateJobTemplateRequest_Settings::isValid() const {
