...
#ifndef OAIPresetSettings_H
#define OAIPresetSettings_H
...
class OAIPresetSettings : public OAIObject {
public:
    OAIPresetSettings();
    OAIPresetSettings(QString json);
    ~OAIPresetSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPresetSettings)

#endif // OAIPresetSettings_H
