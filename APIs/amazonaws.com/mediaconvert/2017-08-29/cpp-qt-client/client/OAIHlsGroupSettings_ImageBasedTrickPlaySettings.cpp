...
OAIHlsGroupSettings_ImageBasedTrickPlaySettings::OAIHlsGroupSettings_ImageBasedTrickPlaySettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHlsGroupSettings_ImageBasedTrickPlaySettings::OAIHlsGroupSettings_ImageBasedTrickPlaySettings() {
    this->initializeModel();
}

OAIHlsGroupSettings_ImageBasedTrickPlaySettings::~OAIHlsGroupSettings_ImageBasedTrickPlaySettings() {}

void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::initializeModel() {
...
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::fromJson(QString jsonString) {
...
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::fromJsonObject(QJsonObject json) {
...
QString OAIHlsGroupSettings_ImageBasedTrickPlaySettings::asJson() const {
...
QJsonObject OAIHlsGroupSettings_ImageBasedTrickPlaySettings::asJsonObject() const {
    QJsonObject obj;
...
OAIHlsIntervalCadence OAIHlsGroupSettings_ImageBasedTrickPlaySettings::getIntervalCadence() const {
    return m_interval_cadence;
}
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::setIntervalCadence(const OAIHlsIntervalCadence &interval_cadence) {
    m_interval_cadence = interval_cadence;
    m_interval_cadence_isSet = true;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_interval_cadence_Set() const{
    return m_interval_cadence_isSet;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_interval_cadence_Valid() const{
    return m_interval_cadence_isValid;
}

qint32 OAIHlsGroupSettings_ImageBasedTrickPlaySettings::getThumbnailHeight() const {
    return m_thumbnail_height;
}
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::setThumbnailHeight(const qint32 &thumbnail_height) {
    m_thumbnail_height = thumbnail_height;
    m_thumbnail_height_isSet = true;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_thumbnail_height_Set() const{
    return m_thumbnail_height_isSet;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_thumbnail_height_Valid() const{
    return m_thumbnail_height_isValid;
}

double OAIHlsGroupSettings_ImageBasedTrickPlaySettings::getThumbnailInterval() const {
    return m_thumbnail_interval;
}
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::setThumbnailInterval(const double &thumbnail_interval) {
    m_thumbnail_interval = thumbnail_interval;
    m_thumbnail_interval_isSet = true;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_thumbnail_interval_Set() const{
    return m_thumbnail_interval_isSet;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_thumbnail_interval_Valid() const{
    return m_thumbnail_interval_isValid;
}

qint32 OAIHlsGroupSettings_ImageBasedTrickPlaySettings::getThumbnailWidth() const {
    return m_thumbnail_width;
}
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::setThumbnailWidth(const qint32 &thumbnail_width) {
    m_thumbnail_width = thumbnail_width;
    m_thumbnail_width_isSet = true;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_thumbnail_width_Set() const{
    return m_thumbnail_width_isSet;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_thumbnail_width_Valid() const{
    return m_thumbnail_width_isValid;
}

qint32 OAIHlsGroupSettings_ImageBasedTrickPlaySettings::getTileHeight() const {
    return m_tile_height;
}
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::setTileHeight(const qint32 &tile_height) {
    m_tile_height = tile_height;
    m_tile_height_isSet = true;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_tile_height_Set() const{
    return m_tile_height_isSet;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_tile_height_Valid() const{
    return m_tile_height_isValid;
}

qint32 OAIHlsGroupSettings_ImageBasedTrickPlaySettings::getTileWidth() const {
    return m_tile_width;
}
void OAIHlsGroupSettings_ImageBasedTrickPlaySettings::setTileWidth(const qint32 &tile_width) {
    m_tile_width = tile_width;
    m_tile_width_isSet = true;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_tile_width_Set() const{
    return m_tile_width_isSet;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::is_tile_width_Valid() const{
    return m_tile_width_isValid;
}

bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::isSet() const {
...
bool OAIHlsGroupSettings_ImageBasedTrickPlaySettings::isValid() const {
