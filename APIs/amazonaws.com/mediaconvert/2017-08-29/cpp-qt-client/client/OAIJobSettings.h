...
#ifndef OAIJobSettings_H
#define OAIJobSettings_H
...
class OAIJobSettings : public OAIObject {
public:
    OAIJobSettings();
    OAIJobSettings(QString json);
    ~OAIJobSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobSettings)

#endif // OAIJobSettings_H
