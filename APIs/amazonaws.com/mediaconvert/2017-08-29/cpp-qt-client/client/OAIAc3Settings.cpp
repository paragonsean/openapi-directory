...
qint32 OAIAc3Settings::getBitrate() const {
    return m_bitrate;
}
void OAIAc3Settings::setBitrate(const qint32 &bitrate) {
    m_bitrate = bitrate;
...
OAIAc3DynamicRangeCompressionLine OAIAc3Settings::getDynamicRangeCompressionLine() const {
    return m_dynamic_range_compression_line;
}
void OAIAc3Settings::setDynamicRangeCompressionLine(const OAIAc3DynamicRangeCompressionLine &dynamic_range_compression_line) {
    m_dynamic_range_compression_line = dynamic_range_compression_line;
    m_dynamic_range_compression_line_isSet = true;
}

bool OAIAc3Settings::is_dynamic_range_compression_line_Set() const{
    return m_dynamic_range_compression_line_isSet;
}

bool OAIAc3Settings::is_dynamic_range_compression_line_Valid() const{
    return m_dynamic_range_compression_line_isValid;
}

OAIAc3DynamicRangeCompressionProfile OAIAc3Settings::getDynamicRangeCompressionProfile() const {
    return m_dynamic_range_compression_profile;
}
void OAIAc3Settings::setDynamicRangeCompressionProfile(const OAIAc3DynamicRangeCompressionProfile &dynamic_range_compression_profile) {
    m_dynamic_range_compression_profile = dynamic_range_compression_profile;
    m_dynamic_range_compression_profile_isSet = true;
}

bool OAIAc3Settings::is_dynamic_range_compression_profile_Set() const{
    return m_dynamic_range_compression_profile_isSet;
}

bool OAIAc3Settings::is_dynamic_range_compression_profile_Valid() const{
    return m_dynamic_range_compression_profile_isValid;
}

OAIAc3DynamicRangeCompressionRf OAIAc3Settings::getDynamicRangeCompressionRf() const {
    return m_dynamic_range_compression_rf;
}
void OAIAc3Settings::setDynamicRangeCompressionRf(const OAIAc3DynamicRangeCompressionRf &dynamic_range_compression_rf) {
    m_dynamic_range_compression_rf = dynamic_range_compression_rf;
    m_dynamic_range_compression_rf_isSet = true;
}

bool OAIAc3Settings::is_dynamic_range_compression_rf_Set() const{
    return m_dynamic_range_compression_rf_isSet;
}

bool OAIAc3Settings::is_dynamic_range_compression_rf_Valid() const{
...
qint32 OAIAc3Settings::getSampleRate() const {
    return m_sample_rate;
}
void OAIAc3Settings::setSampleRate(const qint32 &sample_rate) {
    m_sample_rate = sample_rate;
    m_sample_rate_isSet = true;
}

bool OAIAc3Settings::is_sample_rate_Set() const{
    return m_sample_rate_isSet;
}

bool OAIAc3Settings::is_sample_rate_Valid() const{
