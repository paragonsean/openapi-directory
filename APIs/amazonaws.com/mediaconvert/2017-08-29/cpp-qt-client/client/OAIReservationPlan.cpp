...
OAIReservationPlan::OAIReservationPlan(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReservationPlan::OAIReservationPlan() {
    this->initializeModel();
}

OAIReservationPlan::~OAIReservationPlan() {}

void OAIReservationPlan::initializeModel() {
...
void OAIReservationPlan::fromJson(QString jsonString) {
...
void OAIReservationPlan::fromJsonObject(QJsonObject json) {
...
QString OAIReservationPlan::asJson() const {
...
QJsonObject OAIReservationPlan::asJsonObject() const {
    QJsonObject obj;
...
OAICommitment OAIReservationPlan::getCommitment() const {
    return m_commitment;
}
void OAIReservationPlan::setCommitment(const OAICommitment &commitment) {
    m_commitment = commitment;
    m_commitment_isSet = true;
}

bool OAIReservationPlan::is_commitment_Set() const{
    return m_commitment_isSet;
}

bool OAIReservationPlan::is_commitment_Valid() const{
    return m_commitment_isValid;
}

QDateTime OAIReservationPlan::getExpiresAt() const {
    return m_expires_at;
}
void OAIReservationPlan::setExpiresAt(const QDateTime &expires_at) {
    m_expires_at = expires_at;
    m_expires_at_isSet = true;
}

bool OAIReservationPlan::is_expires_at_Set() const{
    return m_expires_at_isSet;
}

bool OAIReservationPlan::is_expires_at_Valid() const{
    return m_expires_at_isValid;
}

QDateTime OAIReservationPlan::getPurchasedAt() const {
    return m_purchased_at;
}
void OAIReservationPlan::setPurchasedAt(const QDateTime &purchased_at) {
    m_purchased_at = purchased_at;
    m_purchased_at_isSet = true;
}

bool OAIReservationPlan::is_purchased_at_Set() const{
    return m_purchased_at_isSet;
}

bool OAIReservationPlan::is_purchased_at_Valid() const{
    return m_purchased_at_isValid;
}

OAIRenewalType OAIReservationPlan::getRenewalType() const {
    return m_renewal_type;
}
void OAIReservationPlan::setRenewalType(const OAIRenewalType &renewal_type) {
    m_renewal_type = renewal_type;
    m_renewal_type_isSet = true;
}

bool OAIReservationPlan::is_renewal_type_Set() const{
    return m_renewal_type_isSet;
}

bool OAIReservationPlan::is_renewal_type_Valid() const{
    return m_renewal_type_isValid;
}

qint32 OAIReservationPlan::getReservedSlots() const {
    return m_reserved_slots;
}
void OAIReservationPlan::setReservedSlots(const qint32 &reserved_slots) {
    m_reserved_slots = reserved_slots;
    m_reserved_slots_isSet = true;
}

bool OAIReservationPlan::is_reserved_slots_Set() const{
    return m_reserved_slots_isSet;
}

bool OAIReservationPlan::is_reserved_slots_Valid() const{
    return m_reserved_slots_isValid;
}

OAIReservationPlanStatus OAIReservationPlan::getStatus() const {
    return m_status;
}
void OAIReservationPlan::setStatus(const OAIReservationPlanStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIReservationPlan::is_status_Set() const{
    return m_status_isSet;
}

bool OAIReservationPlan::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIReservationPlan::isSet() const {
...
bool OAIReservationPlan::isValid() const {
