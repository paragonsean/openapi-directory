...
#ifndef OAIMpeg2Settings_H
#define OAIMpeg2Settings_H
...
class OAIMpeg2Settings : public OAIObject {
public:
    OAIMpeg2Settings();
    OAIMpeg2Settings(QString json);
    ~OAIMpeg2Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMpeg2Settings)

#endif // OAIMpeg2Settings_H
