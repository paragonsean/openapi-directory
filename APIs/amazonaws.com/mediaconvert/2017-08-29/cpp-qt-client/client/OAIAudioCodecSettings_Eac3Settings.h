...
/*
 * OAIAudioCodecSettings_Eac3Settings.h
 *
 * 
 */

#ifndef OAIAudioCodecSettings_Eac3Settings_H
#define OAIAudioCodecSettings_Eac3Settings_H
...
class OAIAudioCodecSettings_Eac3Settings : public OAIObject {
public:
    OAIAudioCodecSettings_Eac3Settings();
    OAIAudioCodecSettings_Eac3Settings(QString json);
    ~OAIAudioCodecSettings_Eac3Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudioCodecSettings_Eac3Settings)

#endif // OAIAudioCodecSettings_Eac3Settings_H
