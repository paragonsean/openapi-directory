...
/*
 * OAIUpdateQueueRequest_ReservationPlanSettings.h
 *
 * 
 */

#ifndef OAIUpdateQueueRequest_ReservationPlanSettings_H
#define OAIUpdateQueueRequest_ReservationPlanSettings_H
...
class OAIUpdateQueueRequest_ReservationPlanSettings : public OAIObject {
public:
    OAIUpdateQueueRequest_ReservationPlanSettings();
    OAIUpdateQueueRequest_ReservationPlanSettings(QString json);
    ~OAIUpdateQueueRequest_ReservationPlanSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateQueueRequest_ReservationPlanSettings)

#endif // OAIUpdateQueueRequest_ReservationPlanSettings_H
