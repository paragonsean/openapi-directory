...
OAIVp8Settings::OAIVp8Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVp8Settings::OAIVp8Settings() {
    this->initializeModel();
}

OAIVp8Settings::~OAIVp8Settings() {}

void OAIVp8Settings::initializeModel() {
...
void OAIVp8Settings::fromJson(QString jsonString) {
...
void OAIVp8Settings::fromJsonObject(QJsonObject json) {
...
QString OAIVp8Settings::asJson() const {
...
QJsonObject OAIVp8Settings::asJsonObject() const {
    QJsonObject obj;
    if (m_bitrate_isSet) {
...
qint32 OAIVp8Settings::getBitrate() const {
    return m_bitrate;
}
void OAIVp8Settings::setBitrate(const qint32 &bitrate) {
    m_bitrate = bitrate;
    m_bitrate_isSet = true;
}

bool OAIVp8Settings::is_bitrate_Set() const{
    return m_bitrate_isSet;
}

bool OAIVp8Settings::is_bitrate_Valid() const{
    return m_bitrate_isValid;
}

OAIVp8FramerateControl OAIVp8Settings::getFramerateControl() const {
    return m_framerate_control;
}
void OAIVp8Settings::setFramerateControl(const OAIVp8FramerateControl &framerate_control) {
    m_framerate_control = framerate_control;
    m_framerate_control_isSet = true;
}

bool OAIVp8Settings::is_framerate_control_Set() const{
    return m_framerate_control_isSet;
}

bool OAIVp8Settings::is_framerate_control_Valid() const{
    return m_framerate_control_isValid;
}

OAIVp8FramerateConversionAlgorithm OAIVp8Settings::getFramerateConversionAlgorithm() const {
    return m_framerate_conversion_algorithm;
}
void OAIVp8Settings::setFramerateConversionAlgorithm(const OAIVp8FramerateConversionAlgorithm &framerate_conversion_algorithm) {
    m_framerate_conversion_algorithm = framerate_conversion_algorithm;
    m_framerate_conversion_algorithm_isSet = true;
}

bool OAIVp8Settings::is_framerate_conversion_algorithm_Set() const{
    return m_framerate_conversion_algorithm_isSet;
}

bool OAIVp8Settings::is_framerate_conversion_algorithm_Valid() const{
    return m_framerate_conversion_algorithm_isValid;
}

qint32 OAIVp8Settings::getFramerateDenominator() const {
    return m_framerate_denominator;
}
void OAIVp8Settings::setFramerateDenominator(const qint32 &framerate_denominator) {
    m_framerate_denominator = framerate_denominator;
    m_framerate_denominator_isSet = true;
}

bool OAIVp8Settings::is_framerate_denominator_Set() const{
    return m_framerate_denominator_isSet;
}

bool OAIVp8Settings::is_framerate_denominator_Valid() const{
    return m_framerate_denominator_isValid;
}

qint32 OAIVp8Settings::getFramerateNumerator() const {
    return m_framerate_numerator;
}
void OAIVp8Settings::setFramerateNumerator(const qint32 &framerate_numerator) {
    m_framerate_numerator = framerate_numerator;
    m_framerate_numerator_isSet = true;
}

bool OAIVp8Settings::is_framerate_numerator_Set() const{
    return m_framerate_numerator_isSet;
}

bool OAIVp8Settings::is_framerate_numerator_Valid() const{
    return m_framerate_numerator_isValid;
}

double OAIVp8Settings::getGopSize() const {
    return m_gop_size;
}
void OAIVp8Settings::setGopSize(const double &gop_size) {
    m_gop_size = gop_size;
    m_gop_size_isSet = true;
}

bool OAIVp8Settings::is_gop_size_Set() const{
    return m_gop_size_isSet;
}

bool OAIVp8Settings::is_gop_size_Valid() const{
    return m_gop_size_isValid;
}

qint32 OAIVp8Settings::getHrdBufferSize() const {
    return m_hrd_buffer_size;
}
void OAIVp8Settings::setHrdBufferSize(const qint32 &hrd_buffer_size) {
    m_hrd_buffer_size = hrd_buffer_size;
    m_hrd_buffer_size_isSet = true;
}

bool OAIVp8Settings::is_hrd_buffer_size_Set() const{
    return m_hrd_buffer_size_isSet;
}

bool OAIVp8Settings::is_hrd_buffer_size_Valid() const{
    return m_hrd_buffer_size_isValid;
}

qint32 OAIVp8Settings::getMaxBitrate() const {
    return m_max_bitrate;
}
void OAIVp8Settings::setMaxBitrate(const qint32 &max_bitrate) {
    m_max_bitrate = max_bitrate;
    m_max_bitrate_isSet = true;
}

bool OAIVp8Settings::is_max_bitrate_Set() const{
    return m_max_bitrate_isSet;
}

bool OAIVp8Settings::is_max_bitrate_Valid() const{
    return m_max_bitrate_isValid;
}

OAIVp8ParControl OAIVp8Settings::getParControl() const {
    return m_par_control;
}
void OAIVp8Settings::setParControl(const OAIVp8ParControl &par_control) {
    m_par_control = par_control;
    m_par_control_isSet = true;
}

bool OAIVp8Settings::is_par_control_Set() const{
    return m_par_control_isSet;
}

bool OAIVp8Settings::is_par_control_Valid() const{
    return m_par_control_isValid;
}

qint32 OAIVp8Settings::getParDenominator() const {
    return m_par_denominator;
}
void OAIVp8Settings::setParDenominator(const qint32 &par_denominator) {
    m_par_denominator = par_denominator;
    m_par_denominator_isSet = true;
}

bool OAIVp8Settings::is_par_denominator_Set() const{
    return m_par_denominator_isSet;
}

bool OAIVp8Settings::is_par_denominator_Valid() const{
    return m_par_denominator_isValid;
}

qint32 OAIVp8Settings::getParNumerator() const {
    return m_par_numerator;
}
void OAIVp8Settings::setParNumerator(const qint32 &par_numerator) {
    m_par_numerator = par_numerator;
    m_par_numerator_isSet = true;
}

bool OAIVp8Settings::is_par_numerator_Set() const{
    return m_par_numerator_isSet;
}

bool OAIVp8Settings::is_par_numerator_Valid() const{
    return m_par_numerator_isValid;
}

OAIVp8QualityTuningLevel OAIVp8Settings::getQualityTuningLevel() const {
    return m_quality_tuning_level;
}
void OAIVp8Settings::setQualityTuningLevel(const OAIVp8QualityTuningLevel &quality_tuning_level) {
    m_quality_tuning_level = quality_tuning_level;
    m_quality_tuning_level_isSet = true;
}

bool OAIVp8Settings::is_quality_tuning_level_Set() const{
    return m_quality_tuning_level_isSet;
}

bool OAIVp8Settings::is_quality_tuning_level_Valid() const{
    return m_quality_tuning_level_isValid;
}

OAIVp8RateControlMode OAIVp8Settings::getRateControlMode() const {
    return m_rate_control_mode;
}
void OAIVp8Settings::setRateControlMode(const OAIVp8RateControlMode &rate_control_mode) {
    m_rate_control_mode = rate_control_mode;
    m_rate_control_mode_isSet = true;
}

bool OAIVp8Settings::is_rate_control_mode_Set() const{
    return m_rate_control_mode_isSet;
}

bool OAIVp8Settings::is_rate_control_mode_Valid() const{
    return m_rate_control_mode_isValid;
}

bool OAIVp8Settings::isSet() const {
...
bool OAIVp8Settings::isValid() const {
