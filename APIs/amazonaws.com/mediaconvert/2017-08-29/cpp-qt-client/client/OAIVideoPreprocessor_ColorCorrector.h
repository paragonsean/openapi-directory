...
/*
 * OAIVideoPreprocessor_ColorCorrector.h
 *
 * 
 */

#ifndef OAIVideoPreprocessor_ColorCorrector_H
#define OAIVideoPreprocessor_ColorCorrector_H
...
class OAIVideoPreprocessor_ColorCorrector : public OAIObject {
public:
    OAIVideoPreprocessor_ColorCorrector();
    OAIVideoPreprocessor_ColorCorrector(QString json);
    ~OAIVideoPreprocessor_ColorCorrector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoPreprocessor_ColorCorrector)

#endif // OAIVideoPreprocessor_ColorCorrector_H
