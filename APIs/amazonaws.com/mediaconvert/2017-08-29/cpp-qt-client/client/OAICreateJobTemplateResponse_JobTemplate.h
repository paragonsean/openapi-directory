...
/*
 * OAICreateJobTemplateResponse_JobTemplate.h
 *
 * 
 */

#ifndef OAICreateJobTemplateResponse_JobTemplate_H
#define OAICreateJobTemplateResponse_JobTemplate_H
...
class OAICreateJobTemplateResponse_JobTemplate : public OAIObject {
public:
    OAICreateJobTemplateResponse_JobTemplate();
    OAICreateJobTemplateResponse_JobTemplate(QString json);
    ~OAICreateJobTemplateResponse_JobTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobTemplateResponse_JobTemplate)

#endif // OAICreateJobTemplateResponse_JobTemplate_H
