...
OAIH264Settings_BandwidthReductionFilter OAIH264Settings::getBandwidthReductionFilter() const {
    return m_bandwidth_reduction_filter;
}
void OAIH264Settings::setBandwidthReductionFilter(const OAIH264Settings_BandwidthReductionFilter &bandwidth_reduction_filter) {
    m_bandwidth_reduction_filter = bandwidth_reduction_filter;
    m_bandwidth_reduction_filter_isSet = true;
}

bool OAIH264Settings::is_bandwidth_reduction_filter_Set() const{
    return m_bandwidth_reduction_filter_isSet;
}

bool OAIH264Settings::is_bandwidth_reduction_filter_Valid() const{
...
OAIH264CodecLevel OAIH264Settings::getCodecLevel() const {
    return m_codec_level;
}
void OAIH264Settings::setCodecLevel(const OAIH264CodecLevel &codec_level) {
    m_codec_level = codec_level;
    m_codec_level_isSet = true;
}

bool OAIH264Settings::is_codec_level_Set() const{
    return m_codec_level_isSet;
}

bool OAIH264Settings::is_codec_level_Valid() const{
    return m_codec_level_isValid;
}

OAIH264CodecProfile OAIH264Settings::getCodecProfile() const {
    return m_codec_profile;
}
void OAIH264Settings::setCodecProfile(const OAIH264CodecProfile &codec_profile) {
    m_codec_profile = codec_profile;
    m_codec_profile_isSet = true;
}

bool OAIH264Settings::is_codec_profile_Set() const{
    return m_codec_profile_isSet;
}

bool OAIH264Settings::is_codec_profile_Valid() const{
    return m_codec_profile_isValid;
}

OAIH264DynamicSubGop OAIH264Settings::getDynamicSubGop() const {
    return m_dynamic_sub_gop;
}
void OAIH264Settings::setDynamicSubGop(const OAIH264DynamicSubGop &dynamic_sub_gop) {
    m_dynamic_sub_gop = dynamic_sub_gop;
    m_dynamic_sub_gop_isSet = true;
}

bool OAIH264Settings::is_dynamic_sub_gop_Set() const{
    return m_dynamic_sub_gop_isSet;
}

bool OAIH264Settings::is_dynamic_sub_gop_Valid() const{
...
OAIH264FieldEncoding OAIH264Settings::getFieldEncoding() const {
    return m_field_encoding;
}
void OAIH264Settings::setFieldEncoding(const OAIH264FieldEncoding &field_encoding) {
    m_field_encoding = field_encoding;
    m_field_encoding_isSet = true;
}

bool OAIH264Settings::is_field_encoding_Set() const{
    return m_field_encoding_isSet;
}

bool OAIH264Settings::is_field_encoding_Valid() const{
    return m_field_encoding_isValid;
}

OAIH264FlickerAdaptiveQuantization OAIH264Settings::getFlickerAdaptiveQuantization() const {
    return m_flicker_adaptive_quantization;
}
void OAIH264Settings::setFlickerAdaptiveQuantization(const OAIH264FlickerAdaptiveQuantization &flicker_adaptive_quantization) {
    m_flicker_adaptive_quantization = flicker_adaptive_quantization;
    m_flicker_adaptive_quantization_isSet = true;
}

bool OAIH264Settings::is_flicker_adaptive_quantization_Set() const{
    return m_flicker_adaptive_quantization_isSet;
}

bool OAIH264Settings::is_flicker_adaptive_quantization_Valid() const{
...
OAIH264FramerateConversionAlgorithm OAIH264Settings::getFramerateConversionAlgorithm() const {
    return m_framerate_conversion_algorithm;
}
void OAIH264Settings::setFramerateConversionAlgorithm(const OAIH264FramerateConversionAlgorithm &framerate_conversion_algorithm) {
    m_framerate_conversion_algorithm = framerate_conversion_algorithm;
    m_framerate_conversion_algorithm_isSet = true;
}

bool OAIH264Settings::is_framerate_conversion_algorithm_Set() const{
    return m_framerate_conversion_algorithm_isSet;
}

bool OAIH264Settings::is_framerate_conversion_algorithm_Valid() const{
...
qint32 OAIH264Settings::getHrdBufferFinalFillPercentage() const {
    return m_hrd_buffer_final_fill_percentage;
}
void OAIH264Settings::setHrdBufferFinalFillPercentage(const qint32 &hrd_buffer_final_fill_percentage) {
    m_hrd_buffer_final_fill_percentage = hrd_buffer_final_fill_percentage;
    m_hrd_buffer_final_fill_percentage_isSet = true;
}

bool OAIH264Settings::is_hrd_buffer_final_fill_percentage_Set() const{
    return m_hrd_buffer_final_fill_percentage_isSet;
}

bool OAIH264Settings::is_hrd_buffer_final_fill_percentage_Valid() const{
    return m_hrd_buffer_final_fill_percentage_isValid;
}

qint32 OAIH264Settings::getHrdBufferInitialFillPercentage() const {
    return m_hrd_buffer_initial_fill_percentage;
}
void OAIH264Settings::setHrdBufferInitialFillPercentage(const qint32 &hrd_buffer_initial_fill_percentage) {
    m_hrd_buffer_initial_fill_percentage = hrd_buffer_initial_fill_percentage;
    m_hrd_buffer_initial_fill_percentage_isSet = true;
}

bool OAIH264Settings::is_hrd_buffer_initial_fill_percentage_Set() const{
    return m_hrd_buffer_initial_fill_percentage_isSet;
}

bool OAIH264Settings::is_hrd_buffer_initial_fill_percentage_Valid() const{
    return m_hrd_buffer_initial_fill_percentage_isValid;
}

qint32 OAIH264Settings::getHrdBufferSize() const {
    return m_hrd_buffer_size;
}
void OAIH264Settings::setHrdBufferSize(const qint32 &hrd_buffer_size) {
    m_hrd_buffer_size = hrd_buffer_size;
    m_hrd_buffer_size_isSet = true;
}

bool OAIH264Settings::is_hrd_buffer_size_Set() const{
    return m_hrd_buffer_size_isSet;
}

bool OAIH264Settings::is_hrd_buffer_size_Valid() const{
    return m_hrd_buffer_size_isValid;
}

OAIH264InterlaceMode OAIH264Settings::getInterlaceMode() const {
    return m_interlace_mode;
}
void OAIH264Settings::setInterlaceMode(const OAIH264InterlaceMode &interlace_mode) {
    m_interlace_mode = interlace_mode;
    m_interlace_mode_isSet = true;
}

bool OAIH264Settings::is_interlace_mode_Set() const{
    return m_interlace_mode_isSet;
}

bool OAIH264Settings::is_interlace_mode_Valid() const{
...
qint32 OAIH264Settings::getNumberBFramesBetweenReferenceFrames() const {
    return m_number_b_frames_between_reference_frames;
}
void OAIH264Settings::setNumberBFramesBetweenReferenceFrames(const qint32 &number_b_frames_between_reference_frames) {
...
bool OAIH264Settings::is_number_b_frames_between_reference_frames_Set() const{
    return m_number_b_frames_between_reference_frames_isSet;
}

bool OAIH264Settings::is_number_b_frames_between_reference_frames_Valid() const{
    return m_number_b_frames_between_reference_frames_isValid;
}

qint32 OAIH264Settings::getNumberReferenceFrames() const {
    return m_number_reference_frames;
}
void OAIH264Settings::setNumberReferenceFrames(const qint32 &number_reference_frames) {
    m_number_reference_frames = number_reference_frames;
    m_number_reference_frames_isSet = true;
}

bool OAIH264Settings::is_number_reference_frames_Set() const{
    return m_number_reference_frames_isSet;
}

bool OAIH264Settings::is_number_reference_frames_Valid() const{
...
OAIH264QualityTuningLevel OAIH264Settings::getQualityTuningLevel() const {
    return m_quality_tuning_level;
}
void OAIH264Settings::setQualityTuningLevel(const OAIH264QualityTuningLevel &quality_tuning_level) {
    m_quality_tuning_level = quality_tuning_level;
    m_quality_tuning_level_isSet = true;
}

bool OAIH264Settings::is_quality_tuning_level_Set() const{
    return m_quality_tuning_level_isSet;
}

bool OAIH264Settings::is_quality_tuning_level_Valid() const{
    return m_quality_tuning_level_isValid;
}

OAIH264Settings_QvbrSettings OAIH264Settings::getQvbrSettings() const {
    return m_qvbr_settings;
}
void OAIH264Settings::setQvbrSettings(const OAIH264Settings_QvbrSettings &qvbr_settings) {
    m_qvbr_settings = qvbr_settings;
    m_qvbr_settings_isSet = true;
}

bool OAIH264Settings::is_qvbr_settings_Set() const{
    return m_qvbr_settings_isSet;
}

bool OAIH264Settings::is_qvbr_settings_Valid() const{
...
OAIH264RepeatPps OAIH264Settings::getRepeatPps() const {
    return m_repeat_pps;
}
void OAIH264Settings::setRepeatPps(const OAIH264RepeatPps &repeat_pps) {
    m_repeat_pps = repeat_pps;
    m_repeat_pps_isSet = true;
}

bool OAIH264Settings::is_repeat_pps_Set() const{
    return m_repeat_pps_isSet;
}

bool OAIH264Settings::is_repeat_pps_Valid() const{
    return m_repeat_pps_isValid;
}

OAIH264ScanTypeConversionMode OAIH264Settings::getScanTypeConversionMode() const {
    return m_scan_type_conversion_mode;
}
void OAIH264Settings::setScanTypeConversionMode(const OAIH264ScanTypeConversionMode &scan_type_conversion_mode) {
    m_scan_type_conversion_mode = scan_type_conversion_mode;
    m_scan_type_conversion_mode_isSet = true;
}

bool OAIH264Settings::is_scan_type_conversion_mode_Set() const{
    return m_scan_type_conversion_mode_isSet;
}

bool OAIH264Settings::is_scan_type_conversion_mode_Valid() const{
...
OAIH264SlowPal OAIH264Settings::getSlowPal() const {
    return m_slow_pal;
}
void OAIH264Settings::setSlowPal(const OAIH264SlowPal &slow_pal) {
    m_slow_pal = slow_pal;
    m_slow_pal_isSet = true;
}

bool OAIH264Settings::is_slow_pal_Set() const{
    return m_slow_pal_isSet;
}

bool OAIH264Settings::is_slow_pal_Valid() const{
...
OAIH264SpatialAdaptiveQuantization OAIH264Settings::getSpatialAdaptiveQuantization() const {
    return m_spatial_adaptive_quantization;
}
void OAIH264Settings::setSpatialAdaptiveQuantization(const OAIH264SpatialAdaptiveQuantization &spatial_adaptive_quantization) {
    m_spatial_adaptive_quantization = spatial_adaptive_quantization;
    m_spatial_adaptive_quantization_isSet = true;
}

bool OAIH264Settings::is_spatial_adaptive_quantization_Set() const{
    return m_spatial_adaptive_quantization_isSet;
}

bool OAIH264Settings::is_spatial_adaptive_quantization_Valid() const{
...
OAIH264Telecine OAIH264Settings::getTelecine() const {
    return m_telecine;
}
void OAIH264Settings::setTelecine(const OAIH264Telecine &telecine) {
    m_telecine = telecine;
    m_telecine_isSet = true;
}

bool OAIH264Settings::is_telecine_Set() const{
    return m_telecine_isSet;
}

bool OAIH264Settings::is_telecine_Valid() const{
    return m_telecine_isValid;
}

OAIH264TemporalAdaptiveQuantization OAIH264Settings::getTemporalAdaptiveQuantization() const {
    return m_temporal_adaptive_quantization;
}
void OAIH264Settings::setTemporalAdaptiveQuantization(const OAIH264TemporalAdaptiveQuantization &temporal_adaptive_quantization) {
    m_temporal_adaptive_quantization = temporal_adaptive_quantization;
    m_temporal_adaptive_quantization_isSet = true;
}

bool OAIH264Settings::is_temporal_adaptive_quantization_Set() const{
    return m_temporal_adaptive_quantization_isSet;
}

bool OAIH264Settings::is_temporal_adaptive_quantization_Valid() const{
    return m_temporal_adaptive_quantization_isValid;
}

OAIH264UnregisteredSeiTimecode OAIH264Settings::getUnregisteredSeiTimecode() const {
    return m_unregistered_sei_timecode;
}
void OAIH264Settings::setUnregisteredSeiTimecode(const OAIH264UnregisteredSeiTimecode &unregistered_sei_timecode) {
    m_unregistered_sei_timecode = unregistered_sei_timecode;
    m_unregistered_sei_timecode_isSet = true;
}

bool OAIH264Settings::is_unregistered_sei_timecode_Set() const{
    return m_unregistered_sei_timecode_isSet;
}

bool OAIH264Settings::is_unregistered_sei_timecode_Valid() const{
