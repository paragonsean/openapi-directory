...
/*
 * OAICreateJobTemplateRequest_Settings.h
 *
 * 
 */

#ifndef OAICreateJobTemplateRequest_Settings_H
#define OAICreateJobTemplateRequest_Settings_H
...
class OAICreateJobTemplateRequest_Settings : public OAIObject {
public:
    OAICreateJobTemplateRequest_Settings();
    OAICreateJobTemplateRequest_Settings(QString json);
    ~OAICreateJobTemplateRequest_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobTemplateRequest_Settings)

#endif // OAICreateJobTemplateRequest_Settings_H
