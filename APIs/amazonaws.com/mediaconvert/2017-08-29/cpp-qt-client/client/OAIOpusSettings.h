...
#ifndef OAIOpusSettings_H
#define OAIOpusSettings_H
...
class OAIOpusSettings : public OAIObject {
public:
    OAIOpusSettings();
    OAIOpusSettings(QString json);
    ~OAIOpusSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpusSettings)

#endif // OAIOpusSettings_H
