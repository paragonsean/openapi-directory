...
/*
 * OAIOutputGroupSettings_DashIsoGroupSettings.h
 *
 * 
 */

#ifndef OAIOutputGroupSettings_DashIsoGroupSettings_H
#define OAIOutputGroupSettings_DashIsoGroupSettings_H
...
class OAIOutputGroupSettings_DashIsoGroupSettings : public OAIObject {
public:
    OAIOutputGroupSettings_DashIsoGroupSettings();
    OAIOutputGroupSettings_DashIsoGroupSettings(QString json);
    ~OAIOutputGroupSettings_DashIsoGroupSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputGroupSettings_DashIsoGroupSettings)

#endif // OAIOutputGroupSettings_DashIsoGroupSettings_H
