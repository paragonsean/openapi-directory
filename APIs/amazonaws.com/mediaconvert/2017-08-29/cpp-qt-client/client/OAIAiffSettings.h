...
#ifndef OAIAiffSettings_H
#define OAIAiffSettings_H
...
class OAIAiffSettings : public OAIObject {
public:
    OAIAiffSettings();
    OAIAiffSettings(QString json);
    ~OAIAiffSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAiffSettings)

#endif // OAIAiffSettings_H
