...
qint32 OAIMpeg2Settings::getBitrate() const {
    return m_bitrate;
}
void OAIMpeg2Settings::setBitrate(const qint32 &bitrate) {
    m_bitrate = bitrate;
    m_bitrate_isSet = true;
}

bool OAIMpeg2Settings::is_bitrate_Set() const{
    return m_bitrate_isSet;
}

bool OAIMpeg2Settings::is_bitrate_Valid() const{
    return m_bitrate_isValid;
}

OAIMpeg2CodecLevel OAIMpeg2Settings::getCodecLevel() const {
    return m_codec_level;
}
void OAIMpeg2Settings::setCodecLevel(const OAIMpeg2CodecLevel &codec_level) {
    m_codec_level = codec_level;
    m_codec_level_isSet = true;
}

bool OAIMpeg2Settings::is_codec_level_Set() const{
    return m_codec_level_isSet;
}

bool OAIMpeg2Settings::is_codec_level_Valid() const{
    return m_codec_level_isValid;
}

OAIMpeg2CodecProfile OAIMpeg2Settings::getCodecProfile() const {
    return m_codec_profile;
}
void OAIMpeg2Settings::setCodecProfile(const OAIMpeg2CodecProfile &codec_profile) {
    m_codec_profile = codec_profile;
    m_codec_profile_isSet = true;
}

bool OAIMpeg2Settings::is_codec_profile_Set() const{
    return m_codec_profile_isSet;
}

bool OAIMpeg2Settings::is_codec_profile_Valid() const{
    return m_codec_profile_isValid;
}

OAIMpeg2DynamicSubGop OAIMpeg2Settings::getDynamicSubGop() const {
    return m_dynamic_sub_gop;
}
void OAIMpeg2Settings::setDynamicSubGop(const OAIMpeg2DynamicSubGop &dynamic_sub_gop) {
    m_dynamic_sub_gop = dynamic_sub_gop;
    m_dynamic_sub_gop_isSet = true;
}

bool OAIMpeg2Settings::is_dynamic_sub_gop_Set() const{
    return m_dynamic_sub_gop_isSet;
}

bool OAIMpeg2Settings::is_dynamic_sub_gop_Valid() const{
    return m_dynamic_sub_gop_isValid;
}

OAIMpeg2FramerateControl OAIMpeg2Settings::getFramerateControl() const {
    return m_framerate_control;
}
void OAIMpeg2Settings::setFramerateControl(const OAIMpeg2FramerateControl &framerate_control) {
    m_framerate_control = framerate_control;
    m_framerate_control_isSet = true;
}

bool OAIMpeg2Settings::is_framerate_control_Set() const{
    return m_framerate_control_isSet;
}

bool OAIMpeg2Settings::is_framerate_control_Valid() const{
    return m_framerate_control_isValid;
}

OAIMpeg2FramerateConversionAlgorithm OAIMpeg2Settings::getFramerateConversionAlgorithm() const {
    return m_framerate_conversion_algorithm;
}
void OAIMpeg2Settings::setFramerateConversionAlgorithm(const OAIMpeg2FramerateConversionAlgorithm &framerate_conversion_algorithm) {
    m_framerate_conversion_algorithm = framerate_conversion_algorithm;
    m_framerate_conversion_algorithm_isSet = true;
}

bool OAIMpeg2Settings::is_framerate_conversion_algorithm_Set() const{
    return m_framerate_conversion_algorithm_isSet;
}

bool OAIMpeg2Settings::is_framerate_conversion_algorithm_Valid() const{
...
qint32 OAIMpeg2Settings::getHrdBufferFinalFillPercentage() const {
    return m_hrd_buffer_final_fill_percentage;
}
void OAIMpeg2Settings::setHrdBufferFinalFillPercentage(const qint32 &hrd_buffer_final_fill_percentage) {
    m_hrd_buffer_final_fill_percentage = hrd_buffer_final_fill_percentage;
    m_hrd_buffer_final_fill_percentage_isSet = true;
}

bool OAIMpeg2Settings::is_hrd_buffer_final_fill_percentage_Set() const{
    return m_hrd_buffer_final_fill_percentage_isSet;
}

bool OAIMpeg2Settings::is_hrd_buffer_final_fill_percentage_Valid() const{
    return m_hrd_buffer_final_fill_percentage_isValid;
}

qint32 OAIMpeg2Settings::getHrdBufferInitialFillPercentage() const {
    return m_hrd_buffer_initial_fill_percentage;
}
void OAIMpeg2Settings::setHrdBufferInitialFillPercentage(const qint32 &hrd_buffer_initial_fill_percentage) {
    m_hrd_buffer_initial_fill_percentage = hrd_buffer_initial_fill_percentage;
    m_hrd_buffer_initial_fill_percentage_isSet = true;
}

bool OAIMpeg2Settings::is_hrd_buffer_initial_fill_percentage_Set() const{
    return m_hrd_buffer_initial_fill_percentage_isSet;
}

bool OAIMpeg2Settings::is_hrd_buffer_initial_fill_percentage_Valid() const{
    return m_hrd_buffer_initial_fill_percentage_isValid;
}

qint32 OAIMpeg2Settings::getHrdBufferSize() const {
    return m_hrd_buffer_size;
}
void OAIMpeg2Settings::setHrdBufferSize(const qint32 &hrd_buffer_size) {
    m_hrd_buffer_size = hrd_buffer_size;
    m_hrd_buffer_size_isSet = true;
}

bool OAIMpeg2Settings::is_hrd_buffer_size_Set() const{
    return m_hrd_buffer_size_isSet;
}

bool OAIMpeg2Settings::is_hrd_buffer_size_Valid() const{
    return m_hrd_buffer_size_isValid;
}

OAIMpeg2InterlaceMode OAIMpeg2Settings::getInterlaceMode() const {
    return m_interlace_mode;
}
void OAIMpeg2Settings::setInterlaceMode(const OAIMpeg2InterlaceMode &interlace_mode) {
    m_interlace_mode = interlace_mode;
    m_interlace_mode_isSet = true;
}

bool OAIMpeg2Settings::is_interlace_mode_Set() const{
    return m_interlace_mode_isSet;
}

bool OAIMpeg2Settings::is_interlace_mode_Valid() const{
    return m_interlace_mode_isValid;
}

OAIMpeg2IntraDcPrecision OAIMpeg2Settings::getIntraDcPrecision() const {
    return m_intra_dc_precision;
}
void OAIMpeg2Settings::setIntraDcPrecision(const OAIMpeg2IntraDcPrecision &intra_dc_precision) {
    m_intra_dc_precision = intra_dc_precision;
    m_intra_dc_precision_isSet = true;
}

bool OAIMpeg2Settings::is_intra_dc_precision_Set() const{
    return m_intra_dc_precision_isSet;
}

bool OAIMpeg2Settings::is_intra_dc_precision_Valid() const{
    return m_intra_dc_precision_isValid;
}

qint32 OAIMpeg2Settings::getMaxBitrate() const {
    return m_max_bitrate;
}
void OAIMpeg2Settings::setMaxBitrate(const qint32 &max_bitrate) {
    m_max_bitrate = max_bitrate;
    m_max_bitrate_isSet = true;
}

bool OAIMpeg2Settings::is_max_bitrate_Set() const{
    return m_max_bitrate_isSet;
}

bool OAIMpeg2Settings::is_max_bitrate_Valid() const{
    return m_max_bitrate_isValid;
}

qint32 OAIMpeg2Settings::getMinIInterval() const {
    return m_min_i_interval;
}
void OAIMpeg2Settings::setMinIInterval(const qint32 &min_i_interval) {
    m_min_i_interval = min_i_interval;
    m_min_i_interval_isSet = true;
}

bool OAIMpeg2Settings::is_min_i_interval_Set() const{
    return m_min_i_interval_isSet;
}

bool OAIMpeg2Settings::is_min_i_interval_Valid() const{
    return m_min_i_interval_isValid;
}

qint32 OAIMpeg2Settings::getNumberBFramesBetweenReferenceFrames() const {
    return m_number_b_frames_between_reference_frames;
}
void OAIMpeg2Settings::setNumberBFramesBetweenReferenceFrames(const qint32 &number_b_frames_between_reference_frames) {
...
bool OAIMpeg2Settings::is_number_b_frames_between_reference_frames_Set() const{
    return m_number_b_frames_between_reference_frames_isSet;
}

bool OAIMpeg2Settings::is_number_b_frames_between_reference_frames_Valid() const{
    return m_number_b_frames_between_reference_frames_isValid;
}

OAIMpeg2ParControl OAIMpeg2Settings::getParControl() const {
    return m_par_control;
}
void OAIMpeg2Settings::setParControl(const OAIMpeg2ParControl &par_control) {
    m_par_control = par_control;
    m_par_control_isSet = true;
}

bool OAIMpeg2Settings::is_par_control_Set() const{
    return m_par_control_isSet;
}

bool OAIMpeg2Settings::is_par_control_Valid() const{
    return m_par_control_isValid;
}

qint32 OAIMpeg2Settings::getParDenominator() const {
    return m_par_denominator;
}
void OAIMpeg2Settings::setParDenominator(const qint32 &par_denominator) {
    m_par_denominator = par_denominator;
    m_par_denominator_isSet = true;
}

bool OAIMpeg2Settings::is_par_denominator_Set() const{
    return m_par_denominator_isSet;
}

bool OAIMpeg2Settings::is_par_denominator_Valid() const{
    return m_par_denominator_isValid;
}

qint32 OAIMpeg2Settings::getParNumerator() const {
    return m_par_numerator;
}
void OAIMpeg2Settings::setParNumerator(const qint32 &par_numerator) {
    m_par_numerator = par_numerator;
    m_par_numerator_isSet = true;
}

bool OAIMpeg2Settings::is_par_numerator_Set() const{
    return m_par_numerator_isSet;
}

bool OAIMpeg2Settings::is_par_numerator_Valid() const{
    return m_par_numerator_isValid;
}

OAIMpeg2QualityTuningLevel OAIMpeg2Settings::getQualityTuningLevel() const {
    return m_quality_tuning_level;
}
void OAIMpeg2Settings::setQualityTuningLevel(const OAIMpeg2QualityTuningLevel &quality_tuning_level) {
    m_quality_tuning_level = quality_tuning_level;
    m_quality_tuning_level_isSet = true;
}

bool OAIMpeg2Settings::is_quality_tuning_level_Set() const{
    return m_quality_tuning_level_isSet;
}

bool OAIMpeg2Settings::is_quality_tuning_level_Valid() const{
    return m_quality_tuning_level_isValid;
}

OAIMpeg2RateControlMode OAIMpeg2Settings::getRateControlMode() const {
    return m_rate_control_mode;
}
void OAIMpeg2Settings::setRateControlMode(const OAIMpeg2RateControlMode &rate_control_mode) {
    m_rate_control_mode = rate_control_mode;
    m_rate_control_mode_isSet = true;
}

bool OAIMpeg2Settings::is_rate_control_mode_Set() const{
    return m_rate_control_mode_isSet;
}

bool OAIMpeg2Settings::is_rate_control_mode_Valid() const{
    return m_rate_control_mode_isValid;
}

OAIMpeg2ScanTypeConversionMode OAIMpeg2Settings::getScanTypeConversionMode() const {
    return m_scan_type_conversion_mode;
}
void OAIMpeg2Settings::setScanTypeConversionMode(const OAIMpeg2ScanTypeConversionMode &scan_type_conversion_mode) {
    m_scan_type_conversion_mode = scan_type_conversion_mode;
    m_scan_type_conversion_mode_isSet = true;
}

bool OAIMpeg2Settings::is_scan_type_conversion_mode_Set() const{
    return m_scan_type_conversion_mode_isSet;
}

bool OAIMpeg2Settings::is_scan_type_conversion_mode_Valid() const{
    return m_scan_type_conversion_mode_isValid;
}

OAIMpeg2SceneChangeDetect OAIMpeg2Settings::getSceneChangeDetect() const {
    return m_scene_change_detect;
}
void OAIMpeg2Settings::setSceneChangeDetect(const OAIMpeg2SceneChangeDetect &scene_change_detect) {
    m_scene_change_detect = scene_change_detect;
    m_scene_change_detect_isSet = true;
}

bool OAIMpeg2Settings::is_scene_change_detect_Set() const{
    return m_scene_change_detect_isSet;
}

bool OAIMpeg2Settings::is_scene_change_detect_Valid() const{
    return m_scene_change_detect_isValid;
}

OAIMpeg2SlowPal OAIMpeg2Settings::getSlowPal() const {
    return m_slow_pal;
}
void OAIMpeg2Settings::setSlowPal(const OAIMpeg2SlowPal &slow_pal) {
    m_slow_pal = slow_pal;
    m_slow_pal_isSet = true;
}

bool OAIMpeg2Settings::is_slow_pal_Set() const{
    return m_slow_pal_isSet;
}

bool OAIMpeg2Settings::is_slow_pal_Valid() const{
    return m_slow_pal_isValid;
}

qint32 OAIMpeg2Settings::getSoftness() const {
    return m_softness;
}
void OAIMpeg2Settings::setSoftness(const qint32 &softness) {
    m_softness = softness;
    m_softness_isSet = true;
}

bool OAIMpeg2Settings::is_softness_Set() const{
    return m_softness_isSet;
}

bool OAIMpeg2Settings::is_softness_Valid() const{
    return m_softness_isValid;
}

OAIMpeg2SpatialAdaptiveQuantization OAIMpeg2Settings::getSpatialAdaptiveQuantization() const {
    return m_spatial_adaptive_quantization;
}
void OAIMpeg2Settings::setSpatialAdaptiveQuantization(const OAIMpeg2SpatialAdaptiveQuantization &spatial_adaptive_quantization) {
    m_spatial_adaptive_quantization = spatial_adaptive_quantization;
    m_spatial_adaptive_quantization_isSet = true;
}

bool OAIMpeg2Settings::is_spatial_adaptive_quantization_Set() const{
    return m_spatial_adaptive_quantization_isSet;
}

bool OAIMpeg2Settings::is_spatial_adaptive_quantization_Valid() const{
    return m_spatial_adaptive_quantization_isValid;
}

OAIMpeg2Syntax OAIMpeg2Settings::getSyntax() const {
    return m_syntax;
}
void OAIMpeg2Settings::setSyntax(const OAIMpeg2Syntax &syntax) {
    m_syntax = syntax;
    m_syntax_isSet = true;
}

bool OAIMpeg2Settings::is_syntax_Set() const{
    return m_syntax_isSet;
}

bool OAIMpeg2Settings::is_syntax_Valid() const{
    return m_syntax_isValid;
}

OAIMpeg2Telecine OAIMpeg2Settings::getTelecine() const {
    return m_telecine;
}
void OAIMpeg2Settings::setTelecine(const OAIMpeg2Telecine &telecine) {
    m_telecine = telecine;
    m_telecine_isSet = true;
}

bool OAIMpeg2Settings::is_telecine_Set() const{
    return m_telecine_isSet;
}

bool OAIMpeg2Settings::is_telecine_Valid() const{
    return m_telecine_isValid;
}

OAIMpeg2TemporalAdaptiveQuantization OAIMpeg2Settings::getTemporalAdaptiveQuantization() const {
    return m_temporal_adaptive_quantization;
}
void OAIMpeg2Settings::setTemporalAdaptiveQuantization(const OAIMpeg2TemporalAdaptiveQuantization &temporal_adaptive_quantization) {
    m_temporal_adaptive_quantization = temporal_adaptive_quantization;
    m_temporal_adaptive_quantization_isSet = true;
}

bool OAIMpeg2Settings::is_temporal_adaptive_quantization_Set() const{
    return m_temporal_adaptive_quantization_isSet;
}

bool OAIMpeg2Settings::is_temporal_adaptive_quantization_Valid() const{
