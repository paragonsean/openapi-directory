...
/*
 * OAIJobTemplateSettings.h
 *
 * JobTemplateSettings contains all the transcode settings saved in the template that will be applied to jobs created from it.
 */

#ifndef OAIJobTemplateSettings_H
#define OAIJobTemplateSettings_H
...
class OAIJobTemplateSettings : public OAIObject {
public:
    OAIJobTemplateSettings();
    OAIJobTemplateSettings(QString json);
    ~OAIJobTemplateSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobTemplateSettings)

#endif // OAIJobTemplateSettings_H
