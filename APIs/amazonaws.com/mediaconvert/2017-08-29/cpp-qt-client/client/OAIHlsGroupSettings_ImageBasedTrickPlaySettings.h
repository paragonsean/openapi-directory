...
/*
 * OAIHlsGroupSettings_ImageBasedTrickPlaySettings.h
 *
 * 
 */

#ifndef OAIHlsGroupSettings_ImageBasedTrickPlaySettings_H
#define OAIHlsGroupSettings_ImageBasedTrickPlaySettings_H
...
class OAIHlsGroupSettings_ImageBasedTrickPlaySettings : public OAIObject {
public:
    OAIHlsGroupSettings_ImageBasedTrickPlaySettings();
    OAIHlsGroupSettings_ImageBasedTrickPlaySettings(QString json);
    ~OAIHlsGroupSettings_ImageBasedTrickPlaySettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHlsGroupSettings_ImageBasedTrickPlaySettings)

#endif // OAIHlsGroupSettings_ImageBasedTrickPlaySettings_H
