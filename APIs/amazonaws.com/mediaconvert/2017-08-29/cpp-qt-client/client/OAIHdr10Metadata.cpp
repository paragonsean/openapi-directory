...
OAIHdr10Metadata::OAIHdr10Metadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHdr10Metadata::OAIHdr10Metadata() {
    this->initializeModel();
}

OAIHdr10Metadata::~OAIHdr10Metadata() {}

void OAIHdr10Metadata::initializeModel() {
...
void OAIHdr10Metadata::fromJson(QString jsonString) {
...
void OAIHdr10Metadata::fromJsonObject(QJsonObject json) {
...
QString OAIHdr10Metadata::asJson() const {
...
QJsonObject OAIHdr10Metadata::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIHdr10Metadata::getBluePrimaryX() const {
    return m_blue_primary_x;
}
void OAIHdr10Metadata::setBluePrimaryX(const qint32 &blue_primary_x) {
    m_blue_primary_x = blue_primary_x;
    m_blue_primary_x_isSet = true;
}

bool OAIHdr10Metadata::is_blue_primary_x_Set() const{
    return m_blue_primary_x_isSet;
}

bool OAIHdr10Metadata::is_blue_primary_x_Valid() const{
    return m_blue_primary_x_isValid;
}

qint32 OAIHdr10Metadata::getBluePrimaryY() const {
    return m_blue_primary_y;
}
void OAIHdr10Metadata::setBluePrimaryY(const qint32 &blue_primary_y) {
    m_blue_primary_y = blue_primary_y;
    m_blue_primary_y_isSet = true;
}

bool OAIHdr10Metadata::is_blue_primary_y_Set() const{
    return m_blue_primary_y_isSet;
}

bool OAIHdr10Metadata::is_blue_primary_y_Valid() const{
    return m_blue_primary_y_isValid;
}

qint32 OAIHdr10Metadata::getGreenPrimaryX() const {
    return m_green_primary_x;
}
void OAIHdr10Metadata::setGreenPrimaryX(const qint32 &green_primary_x) {
    m_green_primary_x = green_primary_x;
    m_green_primary_x_isSet = true;
}

bool OAIHdr10Metadata::is_green_primary_x_Set() const{
    return m_green_primary_x_isSet;
}

bool OAIHdr10Metadata::is_green_primary_x_Valid() const{
    return m_green_primary_x_isValid;
}

qint32 OAIHdr10Metadata::getGreenPrimaryY() const {
    return m_green_primary_y;
}
void OAIHdr10Metadata::setGreenPrimaryY(const qint32 &green_primary_y) {
    m_green_primary_y = green_primary_y;
    m_green_primary_y_isSet = true;
}

bool OAIHdr10Metadata::is_green_primary_y_Set() const{
    return m_green_primary_y_isSet;
}

bool OAIHdr10Metadata::is_green_primary_y_Valid() const{
    return m_green_primary_y_isValid;
}

qint32 OAIHdr10Metadata::getMaxContentLightLevel() const {
    return m_max_content_light_level;
}
void OAIHdr10Metadata::setMaxContentLightLevel(const qint32 &max_content_light_level) {
    m_max_content_light_level = max_content_light_level;
    m_max_content_light_level_isSet = true;
}

bool OAIHdr10Metadata::is_max_content_light_level_Set() const{
    return m_max_content_light_level_isSet;
}

bool OAIHdr10Metadata::is_max_content_light_level_Valid() const{
    return m_max_content_light_level_isValid;
}

qint32 OAIHdr10Metadata::getMaxFrameAverageLightLevel() const {
    return m_max_frame_average_light_level;
}
void OAIHdr10Metadata::setMaxFrameAverageLightLevel(const qint32 &max_frame_average_light_level) {
    m_max_frame_average_light_level = max_frame_average_light_level;
    m_max_frame_average_light_level_isSet = true;
}

bool OAIHdr10Metadata::is_max_frame_average_light_level_Set() const{
    return m_max_frame_average_light_level_isSet;
}

bool OAIHdr10Metadata::is_max_frame_average_light_level_Valid() const{
    return m_max_frame_average_light_level_isValid;
}

qint32 OAIHdr10Metadata::getMaxLuminance() const {
    return m_max_luminance;
}
void OAIHdr10Metadata::setMaxLuminance(const qint32 &max_luminance) {
    m_max_luminance = max_luminance;
    m_max_luminance_isSet = true;
}

bool OAIHdr10Metadata::is_max_luminance_Set() const{
    return m_max_luminance_isSet;
}

bool OAIHdr10Metadata::is_max_luminance_Valid() const{
    return m_max_luminance_isValid;
}

qint32 OAIHdr10Metadata::getMinLuminance() const {
    return m_min_luminance;
}
void OAIHdr10Metadata::setMinLuminance(const qint32 &min_luminance) {
    m_min_luminance = min_luminance;
    m_min_luminance_isSet = true;
}

bool OAIHdr10Metadata::is_min_luminance_Set() const{
    return m_min_luminance_isSet;
}

bool OAIHdr10Metadata::is_min_luminance_Valid() const{
    return m_min_luminance_isValid;
}

qint32 OAIHdr10Metadata::getRedPrimaryX() const {
    return m_red_primary_x;
}
void OAIHdr10Metadata::setRedPrimaryX(const qint32 &red_primary_x) {
    m_red_primary_x = red_primary_x;
    m_red_primary_x_isSet = true;
}

bool OAIHdr10Metadata::is_red_primary_x_Set() const{
    return m_red_primary_x_isSet;
}

bool OAIHdr10Metadata::is_red_primary_x_Valid() const{
    return m_red_primary_x_isValid;
}

qint32 OAIHdr10Metadata::getRedPrimaryY() const {
    return m_red_primary_y;
}
void OAIHdr10Metadata::setRedPrimaryY(const qint32 &red_primary_y) {
    m_red_primary_y = red_primary_y;
    m_red_primary_y_isSet = true;
}

bool OAIHdr10Metadata::is_red_primary_y_Set() const{
    return m_red_primary_y_isSet;
}

bool OAIHdr10Metadata::is_red_primary_y_Valid() const{
    return m_red_primary_y_isValid;
}

qint32 OAIHdr10Metadata::getWhitePointX() const {
    return m_white_point_x;
}
void OAIHdr10Metadata::setWhitePointX(const qint32 &white_point_x) {
    m_white_point_x = white_point_x;
    m_white_point_x_isSet = true;
}

bool OAIHdr10Metadata::is_white_point_x_Set() const{
    return m_white_point_x_isSet;
}

bool OAIHdr10Metadata::is_white_point_x_Valid() const{
    return m_white_point_x_isValid;
}

qint32 OAIHdr10Metadata::getWhitePointY() const {
    return m_white_point_y;
}
void OAIHdr10Metadata::setWhitePointY(const qint32 &white_point_y) {
    m_white_point_y = white_point_y;
    m_white_point_y_isSet = true;
}

bool OAIHdr10Metadata::is_white_point_y_Set() const{
    return m_white_point_y_isSet;
}

bool OAIHdr10Metadata::is_white_point_y_Valid() const{
    return m_white_point_y_isValid;
}

bool OAIHdr10Metadata::isSet() const {
...
bool OAIHdr10Metadata::isValid() const {
