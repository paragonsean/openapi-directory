...
/*
 * OAINielsenNonLinearWatermarkSettings.h
 *
 * Ignore these settings unless you are using Nielsen non-linear watermarking. Specify the values that MediaConvert uses to generate and place Nielsen watermarks in your output audio. In addition to specifying these values, you also need to set up your cloud TIC server. These settings apply to every output in your job. The MediaConvert implementation is currently with the following Nielsen versions: Nielsen Watermark SDK Version 5.2.1 Nielsen NLM Watermark Engine Version 1.2.7 Nielsen Watermark Authenticator [SID_TIC] Version [5.0.0]
 */

#ifndef OAINielsenNonLinearWatermarkSettings_H
#define OAINielsenNonLinearWatermarkSettings_H
...
class OAINielsenNonLinearWatermarkSettings : public OAIObject {
public:
    OAINielsenNonLinearWatermarkSettings();
    OAINielsenNonLinearWatermarkSettings(QString json);
    ~OAINielsenNonLinearWatermarkSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINielsenNonLinearWatermarkSettings)

#endif // OAINielsenNonLinearWatermarkSettings_H
