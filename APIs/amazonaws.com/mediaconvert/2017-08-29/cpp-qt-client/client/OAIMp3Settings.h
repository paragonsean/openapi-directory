...
#ifndef OAIMp3Settings_H
#define OAIMp3Settings_H
...
class OAIMp3Settings : public OAIObject {
public:
    OAIMp3Settings();
    OAIMp3Settings(QString json);
    ~OAIMp3Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMp3Settings)

#endif // OAIMp3Settings_H
