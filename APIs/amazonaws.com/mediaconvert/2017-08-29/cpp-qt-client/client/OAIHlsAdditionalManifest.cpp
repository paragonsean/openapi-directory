...
#include "OAIHlsAdditionalManifest.h"
...
OAIHlsAdditionalManifest::OAIHlsAdditionalManifest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHlsAdditionalManifest::OAIHlsAdditionalManifest() {
    this->initializeModel();
}

OAIHlsAdditionalManifest::~OAIHlsAdditionalManifest() {}

void OAIHlsAdditionalManifest::initializeModel() {
...
void OAIHlsAdditionalManifest::fromJson(QString jsonString) {
...
void OAIHlsAdditionalManifest::fromJsonObject(QJsonObject json) {
...
QString OAIHlsAdditionalManifest::asJson() const {
...
QJsonObject OAIHlsAdditionalManifest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIHlsAdditionalManifest::getManifestNameModifier() const {
    return m_manifest_name_modifier;
}
void OAIHlsAdditionalManifest::setManifestNameModifier(const QString &manifest_name_modifier) {
    m_manifest_name_modifier = manifest_name_modifier;
    m_manifest_name_modifier_isSet = true;
}

bool OAIHlsAdditionalManifest::is_manifest_name_modifier_Set() const{
    return m_manifest_name_modifier_isSet;
}

bool OAIHlsAdditionalManifest::is_manifest_name_modifier_Valid() const{
    return m_manifest_name_modifier_isValid;
}

QList OAIHlsAdditionalManifest::getSelectedOutputs() const {
    return m_selected_outputs;
}
void OAIHlsAdditionalManifest::setSelectedOutputs(const QList &selected_outputs) {
    m_selected_outputs = selected_outputs;
    m_selected_outputs_isSet = true;
}

bool OAIHlsAdditionalManifest::is_selected_outputs_Set() const{
    return m_selected_outputs_isSet;
}

bool OAIHlsAdditionalManifest::is_selected_outputs_Valid() const{
    return m_selected_outputs_isValid;
}

bool OAIHlsAdditionalManifest::isSet() const {
...
bool OAIHlsAdditionalManifest::isValid() const {
