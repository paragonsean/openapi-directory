...
#include "OAIDashIsoImageBasedTrickPlaySettings.h"
...
OAIDashIsoImageBasedTrickPlaySettings::OAIDashIsoImageBasedTrickPlaySettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDashIsoImageBasedTrickPlaySettings::OAIDashIsoImageBasedTrickPlaySettings() {
    this->initializeModel();
}

OAIDashIsoImageBasedTrickPlaySettings::~OAIDashIsoImageBasedTrickPlaySettings() {}

void OAIDashIsoImageBasedTrickPlaySettings::initializeModel() {
...
void OAIDashIsoImageBasedTrickPlaySettings::fromJson(QString jsonString) {
...
void OAIDashIsoImageBasedTrickPlaySettings::fromJsonObject(QJsonObject json) {
...
QString OAIDashIsoImageBasedTrickPlaySettings::asJson() const {
...
QJsonObject OAIDashIsoImageBasedTrickPlaySettings::asJsonObject() const {
    QJsonObject obj;
...
OAIDashIsoIntervalCadence OAIDashIsoImageBasedTrickPlaySettings::getIntervalCadence() const {
    return m_interval_cadence;
}
void OAIDashIsoImageBasedTrickPlaySettings::setIntervalCadence(const OAIDashIsoIntervalCadence &interval_cadence) {
    m_interval_cadence = interval_cadence;
    m_interval_cadence_isSet = true;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_interval_cadence_Set() const{
    return m_interval_cadence_isSet;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_interval_cadence_Valid() const{
    return m_interval_cadence_isValid;
}

qint32 OAIDashIsoImageBasedTrickPlaySettings::getThumbnailHeight() const {
    return m_thumbnail_height;
}
void OAIDashIsoImageBasedTrickPlaySettings::setThumbnailHeight(const qint32 &thumbnail_height) {
    m_thumbnail_height = thumbnail_height;
    m_thumbnail_height_isSet = true;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_thumbnail_height_Set() const{
    return m_thumbnail_height_isSet;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_thumbnail_height_Valid() const{
    return m_thumbnail_height_isValid;
}

double OAIDashIsoImageBasedTrickPlaySettings::getThumbnailInterval() const {
    return m_thumbnail_interval;
}
void OAIDashIsoImageBasedTrickPlaySettings::setThumbnailInterval(const double &thumbnail_interval) {
    m_thumbnail_interval = thumbnail_interval;
    m_thumbnail_interval_isSet = true;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_thumbnail_interval_Set() const{
    return m_thumbnail_interval_isSet;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_thumbnail_interval_Valid() const{
    return m_thumbnail_interval_isValid;
}

qint32 OAIDashIsoImageBasedTrickPlaySettings::getThumbnailWidth() const {
    return m_thumbnail_width;
}
void OAIDashIsoImageBasedTrickPlaySettings::setThumbnailWidth(const qint32 &thumbnail_width) {
    m_thumbnail_width = thumbnail_width;
    m_thumbnail_width_isSet = true;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_thumbnail_width_Set() const{
    return m_thumbnail_width_isSet;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_thumbnail_width_Valid() const{
    return m_thumbnail_width_isValid;
}

qint32 OAIDashIsoImageBasedTrickPlaySettings::getTileHeight() const {
    return m_tile_height;
}
void OAIDashIsoImageBasedTrickPlaySettings::setTileHeight(const qint32 &tile_height) {
    m_tile_height = tile_height;
    m_tile_height_isSet = true;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_tile_height_Set() const{
    return m_tile_height_isSet;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_tile_height_Valid() const{
    return m_tile_height_isValid;
}

qint32 OAIDashIsoImageBasedTrickPlaySettings::getTileWidth() const {
    return m_tile_width;
}
void OAIDashIsoImageBasedTrickPlaySettings::setTileWidth(const qint32 &tile_width) {
    m_tile_width = tile_width;
    m_tile_width_isSet = true;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_tile_width_Set() const{
    return m_tile_width_isSet;
}

bool OAIDashIsoImageBasedTrickPlaySettings::is_tile_width_Valid() const{
    return m_tile_width_isValid;
}

bool OAIDashIsoImageBasedTrickPlaySettings::isSet() const {
...
bool OAIDashIsoImageBasedTrickPlaySettings::isValid() const {
