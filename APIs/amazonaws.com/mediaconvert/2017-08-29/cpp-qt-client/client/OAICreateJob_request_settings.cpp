...
OAICreateJob_request_settings::OAICreateJob_request_settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateJob_request_settings::OAICreateJob_request_settings() {
    this->initializeModel();
}

OAICreateJob_request_settings::~OAICreateJob_request_settings() {}

void OAICreateJob_request_settings::initializeModel() {
...
void OAICreateJob_request_settings::fromJson(QString jsonString) {
...
void OAICreateJob_request_settings::fromJsonObject(QJsonObject json) {
...
QString OAICreateJob_request_settings::asJson() const {
...
QJsonObject OAICreateJob_request_settings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateJob_request_settings::getAdAvailOffset() const {
    return m_ad_avail_offset;
}
void OAICreateJob_request_settings::setAdAvailOffset(const qint32 &ad_avail_offset) {
    m_ad_avail_offset = ad_avail_offset;
    m_ad_avail_offset_isSet = true;
}

bool OAICreateJob_request_settings::is_ad_avail_offset_Set() const{
    return m_ad_avail_offset_isSet;
}

bool OAICreateJob_request_settings::is_ad_avail_offset_Valid() const{
    return m_ad_avail_offset_isValid;
}

OAICreateJob_request_settings_AvailBlanking OAICreateJob_request_settings::getAvailBlanking() const {
    return m_avail_blanking;
}
void OAICreateJob_request_settings::setAvailBlanking(const OAICreateJob_request_settings_AvailBlanking &avail_blanking) {
    m_avail_blanking = avail_blanking;
    m_avail_blanking_isSet = true;
}

bool OAICreateJob_request_settings::is_avail_blanking_Set() const{
    return m_avail_blanking_isSet;
}

bool OAICreateJob_request_settings::is_avail_blanking_Valid() const{
    return m_avail_blanking_isValid;
}

OAICreateJob_request_settings_Esam OAICreateJob_request_settings::getEsam() const {
    return m_esam;
}
void OAICreateJob_request_settings::setEsam(const OAICreateJob_request_settings_Esam &esam) {
    m_esam = esam;
    m_esam_isSet = true;
}

bool OAICreateJob_request_settings::is_esam_Set() const{
    return m_esam_isSet;
}

bool OAICreateJob_request_settings::is_esam_Valid() const{
    return m_esam_isValid;
}

OAICreateJob_request_settings_ExtendedDataServices OAICreateJob_request_settings::getExtendedDataServices() const {
    return m_extended_data_services;
}
void OAICreateJob_request_settings::setExtendedDataServices(const OAICreateJob_request_settings_ExtendedDataServices &extended_data_services) {
    m_extended_data_services = extended_data_services;
    m_extended_data_services_isSet = true;
}

bool OAICreateJob_request_settings::is_extended_data_services_Set() const{
    return m_extended_data_services_isSet;
}

bool OAICreateJob_request_settings::is_extended_data_services_Valid() const{
    return m_extended_data_services_isValid;
}

QList OAICreateJob_request_settings::getInputs() const {
    return m_inputs;
}
void OAICreateJob_request_settings::setInputs(const QList &inputs) {
    m_inputs = inputs;
    m_inputs_isSet = true;
}

bool OAICreateJob_request_settings::is_inputs_Set() const{
    return m_inputs_isSet;
}

bool OAICreateJob_request_settings::is_inputs_Valid() const{
    return m_inputs_isValid;
}

OAICreateJob_request_settings_KantarWatermark OAICreateJob_request_settings::getKantarWatermark() const {
    return m_kantar_watermark;
}
void OAICreateJob_request_settings::setKantarWatermark(const OAICreateJob_request_settings_KantarWatermark &kantar_watermark) {
    m_kantar_watermark = kantar_watermark;
    m_kantar_watermark_isSet = true;
}

bool OAICreateJob_request_settings::is_kantar_watermark_Set() const{
    return m_kantar_watermark_isSet;
}

bool OAICreateJob_request_settings::is_kantar_watermark_Valid() const{
    return m_kantar_watermark_isValid;
}

OAICreateJob_request_settings_MotionImageInserter OAICreateJob_request_settings::getMotionImageInserter() const {
    return m_motion_image_inserter;
}
void OAICreateJob_request_settings::setMotionImageInserter(const OAICreateJob_request_settings_MotionImageInserter &motion_image_inserter) {
    m_motion_image_inserter = motion_image_inserter;
    m_motion_image_inserter_isSet = true;
}

bool OAICreateJob_request_settings::is_motion_image_inserter_Set() const{
    return m_motion_image_inserter_isSet;
}

bool OAICreateJob_request_settings::is_motion_image_inserter_Valid() const{
    return m_motion_image_inserter_isValid;
}

OAICreateJob_request_settings_NielsenConfiguration OAICreateJob_request_settings::getNielsenConfiguration() const {
    return m_nielsen_configuration;
}
void OAICreateJob_request_settings::setNielsenConfiguration(const OAICreateJob_request_settings_NielsenConfiguration &nielsen_configuration) {
    m_nielsen_configuration = nielsen_configuration;
    m_nielsen_configuration_isSet = true;
}

bool OAICreateJob_request_settings::is_nielsen_configuration_Set() const{
    return m_nielsen_configuration_isSet;
}

bool OAICreateJob_request_settings::is_nielsen_configuration_Valid() const{
    return m_nielsen_configuration_isValid;
}

OAICreateJob_request_settings_NielsenNonLinearWatermark OAICreateJob_request_settings::getNielsenNonLinearWatermark() const {
    return m_nielsen_non_linear_watermark;
}
void OAICreateJob_request_settings::setNielsenNonLinearWatermark(const OAICreateJob_request_settings_NielsenNonLinearWatermark &nielsen_non_linear_watermark) {
    m_nielsen_non_linear_watermark = nielsen_non_linear_watermark;
    m_nielsen_non_linear_watermark_isSet = true;
}

bool OAICreateJob_request_settings::is_nielsen_non_linear_watermark_Set() const{
    return m_nielsen_non_linear_watermark_isSet;
}

bool OAICreateJob_request_settings::is_nielsen_non_linear_watermark_Valid() const{
    return m_nielsen_non_linear_watermark_isValid;
}

QList OAICreateJob_request_settings::getOutputGroups() const {
    return m_output_groups;
}
void OAICreateJob_request_settings::setOutputGroups(const QList &output_groups) {
    m_output_groups = output_groups;
    m_output_groups_isSet = true;
}

bool OAICreateJob_request_settings::is_output_groups_Set() const{
    return m_output_groups_isSet;
}

bool OAICreateJob_request_settings::is_output_groups_Valid() const{
    return m_output_groups_isValid;
}

OAICreateJob_request_settings_TimecodeConfig OAICreateJob_request_settings::getTimecodeConfig() const {
    return m_timecode_config;
}
void OAICreateJob_request_settings::setTimecodeConfig(const OAICreateJob_request_settings_TimecodeConfig &timecode_config) {
    m_timecode_config = timecode_config;
    m_timecode_config_isSet = true;
}

bool OAICreateJob_request_settings::is_timecode_config_Set() const{
    return m_timecode_config_isSet;
}

bool OAICreateJob_request_settings::is_timecode_config_Valid() const{
    return m_timecode_config_isValid;
}

OAICreateJob_request_settings_TimedMetadataInsertion OAICreateJob_request_settings::getTimedMetadataInsertion() const {
    return m_timed_metadata_insertion;
}
void OAICreateJob_request_settings::setTimedMetadataInsertion(const OAICreateJob_request_settings_TimedMetadataInsertion &timed_metadata_insertion) {
    m_timed_metadata_insertion = timed_metadata_insertion;
    m_timed_metadata_insertion_isSet = true;
}

bool OAICreateJob_request_settings::is_timed_metadata_insertion_Set() const{
    return m_timed_metadata_insertion_isSet;
}

bool OAICreateJob_request_settings::is_timed_metadata_insertion_Valid() const{
    return m_timed_metadata_insertion_isValid;
}

bool OAICreateJob_request_settings::isSet() const {
...
bool OAICreateJob_request_settings::isValid() const {
