...
/*
 * OAICreateQueue_request_reservationPlanSettings.h
 *
 * Details about the pricing plan for your reserved queue. Required for reserved queues and not applicable to on-demand queues.
 */

#ifndef OAICreateQueue_request_reservationPlanSettings_H
#define OAICreateQueue_request_reservationPlanSettings_H
...
class OAICreateQueue_request_reservationPlanSettings : public OAIObject {
public:
    OAICreateQueue_request_reservationPlanSettings();
    OAICreateQueue_request_reservationPlanSettings(QString json);
    ~OAICreateQueue_request_reservationPlanSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateQueue_request_reservationPlanSettings)

#endif // OAICreateQueue_request_reservationPlanSettings_H
