...
/*
 * OAICreateJobRequest_Settings.h
 *
 * 
 */

#ifndef OAICreateJobRequest_Settings_H
#define OAICreateJobRequest_Settings_H
...
class OAICreateJobRequest_Settings : public OAIObject {
public:
    OAICreateJobRequest_Settings();
    OAICreateJobRequest_Settings(QString json);
    ~OAICreateJobRequest_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobRequest_Settings)

#endif // OAICreateJobRequest_Settings_H
