...
/*
 * OAIInput_VideoSelector.h
 *
 * 
 */

#ifndef OAIInput_VideoSelector_H
#define OAIInput_VideoSelector_H
...
class OAIInput_VideoSelector : public OAIObject {
public:
    OAIInput_VideoSelector();
    OAIInput_VideoSelector(QString json);
    ~OAIInput_VideoSelector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInput_VideoSelector)

#endif // OAIInput_VideoSelector_H
