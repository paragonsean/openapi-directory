...
/*
 * OAIAudioCodecSettings_Ac3Settings.h
 *
 * 
 */

#ifndef OAIAudioCodecSettings_Ac3Settings_H
#define OAIAudioCodecSettings_Ac3Settings_H
...
class OAIAudioCodecSettings_Ac3Settings : public OAIObject {
public:
    OAIAudioCodecSettings_Ac3Settings();
    OAIAudioCodecSettings_Ac3Settings(QString json);
    ~OAIAudioCodecSettings_Ac3Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudioCodecSettings_Ac3Settings)

#endif // OAIAudioCodecSettings_Ac3Settings_H
