...
/*
 * OAIEac3AtmosSettings.h
 *
 * Required when you set Codec to the value EAC3_ATMOS.
 */

#ifndef OAIEac3AtmosSettings_H
#define OAIEac3AtmosSettings_H
...
class OAIEac3AtmosSettings : public OAIObject {
public:
    OAIEac3AtmosSettings();
    OAIEac3AtmosSettings(QString json);
    ~OAIEac3AtmosSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEac3AtmosSettings)

#endif // OAIEac3AtmosSettings_H
