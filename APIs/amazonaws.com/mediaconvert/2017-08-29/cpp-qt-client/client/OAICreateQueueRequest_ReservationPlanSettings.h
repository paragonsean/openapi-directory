...
/*
 * OAICreateQueueRequest_ReservationPlanSettings.h
 *
 * 
 */

#ifndef OAICreateQueueRequest_ReservationPlanSettings_H
#define OAICreateQueueRequest_ReservationPlanSettings_H
...
class OAICreateQueueRequest_ReservationPlanSettings : public OAIObject {
public:
    OAICreateQueueRequest_ReservationPlanSettings();
    OAICreateQueueRequest_ReservationPlanSettings(QString json);
    ~OAICreateQueueRequest_ReservationPlanSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateQueueRequest_ReservationPlanSettings)

#endif // OAICreateQueueRequest_ReservationPlanSettings_H
