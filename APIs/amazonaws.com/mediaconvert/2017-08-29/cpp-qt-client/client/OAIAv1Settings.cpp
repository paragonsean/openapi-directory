...
OAIAv1Settings::OAIAv1Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAv1Settings::OAIAv1Settings() {
    this->initializeModel();
}

OAIAv1Settings::~OAIAv1Settings() {}

void OAIAv1Settings::initializeModel() {
...
void OAIAv1Settings::fromJson(QString jsonString) {
...
void OAIAv1Settings::fromJsonObject(QJsonObject json) {
...
QString OAIAv1Settings::asJson() const {
...
QJsonObject OAIAv1Settings::asJsonObject() const {
    QJsonObject obj;
...
OAIAv1AdaptiveQuantization OAIAv1Settings::getAdaptiveQuantization() const {
    return m_adaptive_quantization;
}
void OAIAv1Settings::setAdaptiveQuantization(const OAIAv1AdaptiveQuantization &adaptive_quantization) {
    m_adaptive_quantization = adaptive_quantization;
    m_adaptive_quantization_isSet = true;
}

bool OAIAv1Settings::is_adaptive_quantization_Set() const{
    return m_adaptive_quantization_isSet;
}

bool OAIAv1Settings::is_adaptive_quantization_Valid() const{
    return m_adaptive_quantization_isValid;
}

OAIAv1BitDepth OAIAv1Settings::getBitDepth() const {
    return m_bit_depth;
}
void OAIAv1Settings::setBitDepth(const OAIAv1BitDepth &bit_depth) {
    m_bit_depth = bit_depth;
    m_bit_depth_isSet = true;
}

bool OAIAv1Settings::is_bit_depth_Set() const{
    return m_bit_depth_isSet;
}

bool OAIAv1Settings::is_bit_depth_Valid() const{
    return m_bit_depth_isValid;
}

OAIAv1FramerateControl OAIAv1Settings::getFramerateControl() const {
    return m_framerate_control;
}
void OAIAv1Settings::setFramerateControl(const OAIAv1FramerateControl &framerate_control) {
    m_framerate_control = framerate_control;
    m_framerate_control_isSet = true;
}

bool OAIAv1Settings::is_framerate_control_Set() const{
    return m_framerate_control_isSet;
}

bool OAIAv1Settings::is_framerate_control_Valid() const{
    return m_framerate_control_isValid;
}

OAIAv1FramerateConversionAlgorithm OAIAv1Settings::getFramerateConversionAlgorithm() const {
    return m_framerate_conversion_algorithm;
}
void OAIAv1Settings::setFramerateConversionAlgorithm(const OAIAv1FramerateConversionAlgorithm &framerate_conversion_algorithm) {
    m_framerate_conversion_algorithm = framerate_conversion_algorithm;
    m_framerate_conversion_algorithm_isSet = true;
}

bool OAIAv1Settings::is_framerate_conversion_algorithm_Set() const{
    return m_framerate_conversion_algorithm_isSet;
}

bool OAIAv1Settings::is_framerate_conversion_algorithm_Valid() const{
    return m_framerate_conversion_algorithm_isValid;
}

qint32 OAIAv1Settings::getFramerateDenominator() const {
    return m_framerate_denominator;
}
void OAIAv1Settings::setFramerateDenominator(const qint32 &framerate_denominator) {
    m_framerate_denominator = framerate_denominator;
    m_framerate_denominator_isSet = true;
}

bool OAIAv1Settings::is_framerate_denominator_Set() const{
    return m_framerate_denominator_isSet;
}

bool OAIAv1Settings::is_framerate_denominator_Valid() const{
    return m_framerate_denominator_isValid;
}

qint32 OAIAv1Settings::getFramerateNumerator() const {
    return m_framerate_numerator;
}
void OAIAv1Settings::setFramerateNumerator(const qint32 &framerate_numerator) {
    m_framerate_numerator = framerate_numerator;
    m_framerate_numerator_isSet = true;
}

bool OAIAv1Settings::is_framerate_numerator_Set() const{
    return m_framerate_numerator_isSet;
}

bool OAIAv1Settings::is_framerate_numerator_Valid() const{
    return m_framerate_numerator_isValid;
}

double OAIAv1Settings::getGopSize() const {
    return m_gop_size;
}
void OAIAv1Settings::setGopSize(const double &gop_size) {
    m_gop_size = gop_size;
    m_gop_size_isSet = true;
}

bool OAIAv1Settings::is_gop_size_Set() const{
    return m_gop_size_isSet;
}

bool OAIAv1Settings::is_gop_size_Valid() const{
    return m_gop_size_isValid;
}

qint32 OAIAv1Settings::getMaxBitrate() const {
    return m_max_bitrate;
}
void OAIAv1Settings::setMaxBitrate(const qint32 &max_bitrate) {
    m_max_bitrate = max_bitrate;
    m_max_bitrate_isSet = true;
}

bool OAIAv1Settings::is_max_bitrate_Set() const{
    return m_max_bitrate_isSet;
}

bool OAIAv1Settings::is_max_bitrate_Valid() const{
    return m_max_bitrate_isValid;
}

qint32 OAIAv1Settings::getNumberBFramesBetweenReferenceFrames() const {
    return m_number_b_frames_between_reference_frames;
}
void OAIAv1Settings::setNumberBFramesBetweenReferenceFrames(const qint32 &number_b_frames_between_reference_frames) {
...
bool OAIAv1Settings::is_number_b_frames_between_reference_frames_Set() const{
    return m_number_b_frames_between_reference_frames_isSet;
}

bool OAIAv1Settings::is_number_b_frames_between_reference_frames_Valid() const{
    return m_number_b_frames_between_reference_frames_isValid;
}

OAIAv1Settings_QvbrSettings OAIAv1Settings::getQvbrSettings() const {
    return m_qvbr_settings;
}
void OAIAv1Settings::setQvbrSettings(const OAIAv1Settings_QvbrSettings &qvbr_settings) {
    m_qvbr_settings = qvbr_settings;
    m_qvbr_settings_isSet = true;
}

bool OAIAv1Settings::is_qvbr_settings_Set() const{
    return m_qvbr_settings_isSet;
}

bool OAIAv1Settings::is_qvbr_settings_Valid() const{
    return m_qvbr_settings_isValid;
}

OAIAv1RateControlMode OAIAv1Settings::getRateControlMode() const {
    return m_rate_control_mode;
}
void OAIAv1Settings::setRateControlMode(const OAIAv1RateControlMode &rate_control_mode) {
    m_rate_control_mode = rate_control_mode;
    m_rate_control_mode_isSet = true;
}

bool OAIAv1Settings::is_rate_control_mode_Set() const{
    return m_rate_control_mode_isSet;
}

bool OAIAv1Settings::is_rate_control_mode_Valid() const{
    return m_rate_control_mode_isValid;
}

qint32 OAIAv1Settings::getSlices() const {
    return m_slices;
}
void OAIAv1Settings::setSlices(const qint32 &slices) {
    m_slices = slices;
    m_slices_isSet = true;
}

bool OAIAv1Settings::is_slices_Set() const{
    return m_slices_isSet;
}

bool OAIAv1Settings::is_slices_Valid() const{
    return m_slices_isValid;
}

OAIAv1SpatialAdaptiveQuantization OAIAv1Settings::getSpatialAdaptiveQuantization() const {
    return m_spatial_adaptive_quantization;
}
void OAIAv1Settings::setSpatialAdaptiveQuantization(const OAIAv1SpatialAdaptiveQuantization &spatial_adaptive_quantization) {
    m_spatial_adaptive_quantization = spatial_adaptive_quantization;
    m_spatial_adaptive_quantization_isSet = true;
}

bool OAIAv1Settings::is_spatial_adaptive_quantization_Set() const{
    return m_spatial_adaptive_quantization_isSet;
}

bool OAIAv1Settings::is_spatial_adaptive_quantization_Valid() const{
    return m_spatial_adaptive_quantization_isValid;
}

bool OAIAv1Settings::isSet() const {
...
bool OAIAv1Settings::isValid() const {
