...
QList OAIHlsGroupSettings::getAdditionalManifests() const {
    return m_additional_manifests;
}
void OAIHlsGroupSettings::setAdditionalManifests(const QList &additional_manifests) {
    m_additional_manifests = additional_manifests;
    m_additional_manifests_isSet = true;
}

bool OAIHlsGroupSettings::is_additional_manifests_Set() const{
    return m_additional_manifests_isSet;
}

bool OAIHlsGroupSettings::is_additional_manifests_Valid() const{
    return m_additional_manifests_isValid;
}

OAIHlsAudioOnlyHeader OAIHlsGroupSettings::getAudioOnlyHeader() const {
    return m_audio_only_header;
}
void OAIHlsGroupSettings::setAudioOnlyHeader(const OAIHlsAudioOnlyHeader &audio_only_header) {
    m_audio_only_header = audio_only_header;
    m_audio_only_header_isSet = true;
}

bool OAIHlsGroupSettings::is_audio_only_header_Set() const{
    return m_audio_only_header_isSet;
}

bool OAIHlsGroupSettings::is_audio_only_header_Valid() const{
    return m_audio_only_header_isValid;
}

QString OAIHlsGroupSettings::getBaseUrl() const {
    return m_base_url;
}
void OAIHlsGroupSettings::setBaseUrl(const QString &base_url) {
    m_base_url = base_url;
    m_base_url_isSet = true;
}

bool OAIHlsGroupSettings::is_base_url_Set() const{
    return m_base_url_isSet;
}

bool OAIHlsGroupSettings::is_base_url_Valid() const{
...
OAIHlsCaptionSegmentLengthControl OAIHlsGroupSettings::getCaptionSegmentLengthControl() const {
    return m_caption_segment_length_control;
}
void OAIHlsGroupSettings::setCaptionSegmentLengthControl(const OAIHlsCaptionSegmentLengthControl &caption_segment_length_control) {
    m_caption_segment_length_control = caption_segment_length_control;
    m_caption_segment_length_control_isSet = true;
}

bool OAIHlsGroupSettings::is_caption_segment_length_control_Set() const{
    return m_caption_segment_length_control_isSet;
}

bool OAIHlsGroupSettings::is_caption_segment_length_control_Valid() const{
...
QString OAIHlsGroupSettings::getDestination() const {
    return m_destination;
}
void OAIHlsGroupSettings::setDestination(const QString &destination) {
...
OAICmafGroupSettings_DestinationSettings OAIHlsGroupSettings::getDestinationSettings() const {
    return m_destination_settings;
}
void OAIHlsGroupSettings::setDestinationSettings(const OAICmafGroupSettings_DestinationSettings &destination_settings) {
    m_destination_settings = destination_settings;
    m_destination_settings_isSet = true;
}

bool OAIHlsGroupSettings::is_destination_settings_Set() const{
    return m_destination_settings_isSet;
}

bool OAIHlsGroupSettings::is_destination_settings_Valid() const{
...
OAIHlsGroupSettings_Encryption OAIHlsGroupSettings::getEncryption() const {
    return m_encryption;
}
void OAIHlsGroupSettings::setEncryption(const OAIHlsGroupSettings_Encryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAIHlsGroupSettings::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAIHlsGroupSettings::is_encryption_Valid() const{
    return m_encryption_isValid;
}

OAIHlsImageBasedTrickPlay OAIHlsGroupSettings::getImageBasedTrickPlay() const {
    return m_image_based_trick_play;
}
void OAIHlsGroupSettings::setImageBasedTrickPlay(const OAIHlsImageBasedTrickPlay &image_based_trick_play) {
    m_image_based_trick_play = image_based_trick_play;
    m_image_based_trick_play_isSet = true;
}

bool OAIHlsGroupSettings::is_image_based_trick_play_Set() const{
    return m_image_based_trick_play_isSet;
}

bool OAIHlsGroupSettings::is_image_based_trick_play_Valid() const{
    return m_image_based_trick_play_isValid;
}

OAIHlsGroupSettings_ImageBasedTrickPlaySettings OAIHlsGroupSettings::getImageBasedTrickPlaySettings() const {
    return m_image_based_trick_play_settings;
}
void OAIHlsGroupSettings::setImageBasedTrickPlaySettings(const OAIHlsGroupSettings_ImageBasedTrickPlaySettings &image_based_trick_play_settings) {
    m_image_based_trick_play_settings = image_based_trick_play_settings;
    m_image_based_trick_play_settings_isSet = true;
}

bool OAIHlsGroupSettings::is_image_based_trick_play_settings_Set() const{
    return m_image_based_trick_play_settings_isSet;
}

bool OAIHlsGroupSettings::is_image_based_trick_play_settings_Valid() const{
...
double OAIHlsGroupSettings::getMinFinalSegmentLength() const {
    return m_min_final_segment_length;
}
void OAIHlsGroupSettings::setMinFinalSegmentLength(const double &min_final_segment_length) {
    m_min_final_segment_length = min_final_segment_length;
    m_min_final_segment_length_isSet = true;
}

bool OAIHlsGroupSettings::is_min_final_segment_length_Set() const{
    return m_min_final_segment_length_isSet;
}

bool OAIHlsGroupSettings::is_min_final_segment_length_Valid() const{
...
OAIHlsProgressiveWriteHlsManifest OAIHlsGroupSettings::getProgressiveWriteHlsManifest() const {
    return m_progressive_write_hls_manifest;
}
void OAIHlsGroupSettings::setProgressiveWriteHlsManifest(const OAIHlsProgressiveWriteHlsManifest &progressive_write_hls_manifest) {
    m_progressive_write_hls_manifest = progressive_write_hls_manifest;
    m_progressive_write_hls_manifest_isSet = true;
}

bool OAIHlsGroupSettings::is_progressive_write_hls_manifest_Set() const{
    return m_progressive_write_hls_manifest_isSet;
}

bool OAIHlsGroupSettings::is_progressive_write_hls_manifest_Valid() const{
    return m_progressive_write_hls_manifest_isValid;
}

OAIHlsSegmentControl OAIHlsGroupSettings::getSegmentControl() const {
    return m_segment_control;
}
void OAIHlsGroupSettings::setSegmentControl(const OAIHlsSegmentControl &segment_control) {
    m_segment_control = segment_control;
    m_segment_control_isSet = true;
}

bool OAIHlsGroupSettings::is_segment_control_Set() const{
    return m_segment_control_isSet;
}

bool OAIHlsGroupSettings::is_segment_control_Valid() const{
...
OAIHlsSegmentLengthControl OAIHlsGroupSettings::getSegmentLengthControl() const {
    return m_segment_length_control;
}
void OAIHlsGroupSettings::setSegmentLengthControl(const OAIHlsSegmentLengthControl &segment_length_control) {
    m_segment_length_control = segment_length_control;
    m_segment_length_control_isSet = true;
}

bool OAIHlsGroupSettings::is_segment_length_control_Set() const{
    return m_segment_length_control_isSet;
}

bool OAIHlsGroupSettings::is_segment_length_control_Valid() const{
...
OAIHlsTargetDurationCompatibilityMode OAIHlsGroupSettings::getTargetDurationCompatibilityMode() const {
    return m_target_duration_compatibility_mode;
}
void OAIHlsGroupSettings::setTargetDurationCompatibilityMode(const OAIHlsTargetDurationCompatibilityMode &target_duration_compatibility_mode) {
    m_target_duration_compatibility_mode = target_duration_compatibility_mode;
    m_target_duration_compatibility_mode_isSet = true;
}

bool OAIHlsGroupSettings::is_target_duration_compatibility_mode_Set() const{
    return m_target_duration_compatibility_mode_isSet;
}

bool OAIHlsGroupSettings::is_target_duration_compatibility_mode_Valid() const{
