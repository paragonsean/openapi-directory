...
#ifndef OAIVc3Settings_H
#define OAIVc3Settings_H
...
class OAIVc3Settings : public OAIObject {
public:
    OAIVc3Settings();
    OAIVc3Settings(QString json);
    ~OAIVc3Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVc3Settings)

#endif // OAIVc3Settings_H
