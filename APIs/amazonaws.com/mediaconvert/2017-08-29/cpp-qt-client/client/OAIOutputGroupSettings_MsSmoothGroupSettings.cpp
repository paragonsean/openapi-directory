...
QList OAIOutputGroupSettings_MsSmoothGroupSettings::getAdditionalManifests() const {
    return m_additional_manifests;
}
void OAIOutputGroupSettings_MsSmoothGroupSettings::setAdditionalManifests(const QList &additional_manifests) {
    m_additional_manifests = additional_manifests;
    m_additional_manifests_isSet = true;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_additional_manifests_Set() const{
    return m_additional_manifests_isSet;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_additional_manifests_Valid() const{
    return m_additional_manifests_isValid;
}

OAIMsSmoothAudioDeduplication OAIOutputGroupSettings_MsSmoothGroupSettings::getAudioDeduplication() const {
    return m_audio_deduplication;
}
void OAIOutputGroupSettings_MsSmoothGroupSettings::setAudioDeduplication(const OAIMsSmoothAudioDeduplication &audio_deduplication) {
    m_audio_deduplication = audio_deduplication;
    m_audio_deduplication_isSet = true;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_audio_deduplication_Set() const{
    return m_audio_deduplication_isSet;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_audio_deduplication_Valid() const{
    return m_audio_deduplication_isValid;
}

QString OAIOutputGroupSettings_MsSmoothGroupSettings::getDestination() const {
    return m_destination;
}
void OAIOutputGroupSettings_MsSmoothGroupSettings::setDestination(const QString &destination) {
...
OAICmafGroupSettings_DestinationSettings OAIOutputGroupSettings_MsSmoothGroupSettings::getDestinationSettings() const {
    return m_destination_settings;
}
void OAIOutputGroupSettings_MsSmoothGroupSettings::setDestinationSettings(const OAICmafGroupSettings_DestinationSettings &destination_settings) {
    m_destination_settings = destination_settings;
    m_destination_settings_isSet = true;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_destination_settings_Set() const{
    return m_destination_settings_isSet;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_destination_settings_Valid() const{
    return m_destination_settings_isValid;
}

OAIMsSmoothGroupSettings_Encryption OAIOutputGroupSettings_MsSmoothGroupSettings::getEncryption() const {
    return m_encryption;
}
void OAIOutputGroupSettings_MsSmoothGroupSettings::setEncryption(const OAIMsSmoothGroupSettings_Encryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_encryption_Valid() const{
...
OAIMsSmoothFragmentLengthControl OAIOutputGroupSettings_MsSmoothGroupSettings::getFragmentLengthControl() const {
    return m_fragment_length_control;
}
void OAIOutputGroupSettings_MsSmoothGroupSettings::setFragmentLengthControl(const OAIMsSmoothFragmentLengthControl &fragment_length_control) {
    m_fragment_length_control = fragment_length_control;
    m_fragment_length_control_isSet = true;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_fragment_length_control_Set() const{
    return m_fragment_length_control_isSet;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_fragment_length_control_Valid() const{
    return m_fragment_length_control_isValid;
}

OAIMsSmoothManifestEncoding OAIOutputGroupSettings_MsSmoothGroupSettings::getManifestEncoding() const {
    return m_manifest_encoding;
}
void OAIOutputGroupSettings_MsSmoothGroupSettings::setManifestEncoding(const OAIMsSmoothManifestEncoding &manifest_encoding) {
    m_manifest_encoding = manifest_encoding;
    m_manifest_encoding_isSet = true;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_manifest_encoding_Set() const{
    return m_manifest_encoding_isSet;
}

bool OAIOutputGroupSettings_MsSmoothGroupSettings::is_manifest_encoding_Valid() const{
