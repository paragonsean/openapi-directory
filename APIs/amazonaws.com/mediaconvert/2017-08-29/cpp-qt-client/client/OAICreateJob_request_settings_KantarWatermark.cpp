...
OAICreateJob_request_settings_KantarWatermark::OAICreateJob_request_settings_KantarWatermark(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateJob_request_settings_KantarWatermark::OAICreateJob_request_settings_KantarWatermark() {
    this->initializeModel();
}

OAICreateJob_request_settings_KantarWatermark::~OAICreateJob_request_settings_KantarWatermark() {}

void OAICreateJob_request_settings_KantarWatermark::initializeModel() {
...
void OAICreateJob_request_settings_KantarWatermark::fromJson(QString jsonString) {
...
void OAICreateJob_request_settings_KantarWatermark::fromJsonObject(QJsonObject json) {
...
QString OAICreateJob_request_settings_KantarWatermark::asJson() const {
...
QJsonObject OAICreateJob_request_settings_KantarWatermark::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateJob_request_settings_KantarWatermark::getChannelName() const {
    return m_channel_name;
}
void OAICreateJob_request_settings_KantarWatermark::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getContentReference() const {
    return m_content_reference;
}
void OAICreateJob_request_settings_KantarWatermark::setContentReference(const QString &content_reference) {
    m_content_reference = content_reference;
    m_content_reference_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_content_reference_Set() const{
    return m_content_reference_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_content_reference_Valid() const{
    return m_content_reference_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getCredentialsSecretName() const {
    return m_credentials_secret_name;
}
void OAICreateJob_request_settings_KantarWatermark::setCredentialsSecretName(const QString &credentials_secret_name) {
    m_credentials_secret_name = credentials_secret_name;
    m_credentials_secret_name_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_credentials_secret_name_Set() const{
    return m_credentials_secret_name_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_credentials_secret_name_Valid() const{
    return m_credentials_secret_name_isValid;
}

double OAICreateJob_request_settings_KantarWatermark::getFileOffset() const {
    return m_file_offset;
}
void OAICreateJob_request_settings_KantarWatermark::setFileOffset(const double &file_offset) {
    m_file_offset = file_offset;
    m_file_offset_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_file_offset_Set() const{
    return m_file_offset_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_file_offset_Valid() const{
    return m_file_offset_isValid;
}

qint32 OAICreateJob_request_settings_KantarWatermark::getKantarLicenseId() const {
    return m_kantar_license_id;
}
void OAICreateJob_request_settings_KantarWatermark::setKantarLicenseId(const qint32 &kantar_license_id) {
    m_kantar_license_id = kantar_license_id;
    m_kantar_license_id_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_kantar_license_id_Set() const{
    return m_kantar_license_id_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_kantar_license_id_Valid() const{
    return m_kantar_license_id_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getKantarServerUrl() const {
    return m_kantar_server_url;
}
void OAICreateJob_request_settings_KantarWatermark::setKantarServerUrl(const QString &kantar_server_url) {
    m_kantar_server_url = kantar_server_url;
    m_kantar_server_url_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_kantar_server_url_Set() const{
    return m_kantar_server_url_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_kantar_server_url_Valid() const{
    return m_kantar_server_url_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getLogDestination() const {
    return m_log_destination;
}
void OAICreateJob_request_settings_KantarWatermark::setLogDestination(const QString &log_destination) {
    m_log_destination = log_destination;
    m_log_destination_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_log_destination_Set() const{
    return m_log_destination_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_log_destination_Valid() const{
    return m_log_destination_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getMetadata3() const {
    return m_metadata3;
}
void OAICreateJob_request_settings_KantarWatermark::setMetadata3(const QString &metadata3) {
    m_metadata3 = metadata3;
    m_metadata3_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata3_Set() const{
    return m_metadata3_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata3_Valid() const{
    return m_metadata3_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getMetadata4() const {
    return m_metadata4;
}
void OAICreateJob_request_settings_KantarWatermark::setMetadata4(const QString &metadata4) {
    m_metadata4 = metadata4;
    m_metadata4_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata4_Set() const{
    return m_metadata4_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata4_Valid() const{
    return m_metadata4_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getMetadata5() const {
    return m_metadata5;
}
void OAICreateJob_request_settings_KantarWatermark::setMetadata5(const QString &metadata5) {
    m_metadata5 = metadata5;
    m_metadata5_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata5_Set() const{
    return m_metadata5_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata5_Valid() const{
    return m_metadata5_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getMetadata6() const {
    return m_metadata6;
}
void OAICreateJob_request_settings_KantarWatermark::setMetadata6(const QString &metadata6) {
    m_metadata6 = metadata6;
    m_metadata6_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata6_Set() const{
    return m_metadata6_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata6_Valid() const{
    return m_metadata6_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getMetadata7() const {
    return m_metadata7;
}
void OAICreateJob_request_settings_KantarWatermark::setMetadata7(const QString &metadata7) {
    m_metadata7 = metadata7;
    m_metadata7_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata7_Set() const{
    return m_metadata7_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata7_Valid() const{
    return m_metadata7_isValid;
}

QString OAICreateJob_request_settings_KantarWatermark::getMetadata8() const {
    return m_metadata8;
}
void OAICreateJob_request_settings_KantarWatermark::setMetadata8(const QString &metadata8) {
    m_metadata8 = metadata8;
    m_metadata8_isSet = true;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata8_Set() const{
    return m_metadata8_isSet;
}

bool OAICreateJob_request_settings_KantarWatermark::is_metadata8_Valid() const{
    return m_metadata8_isValid;
}

bool OAICreateJob_request_settings_KantarWatermark::isSet() const {
...
bool OAICreateJob_request_settings_KantarWatermark::isValid() const {
