...
/*
 * OAIQueue_ReservationPlan.h
 *
 * 
 */

#ifndef OAIQueue_ReservationPlan_H
#define OAIQueue_ReservationPlan_H
...
class OAIQueue_ReservationPlan : public OAIObject {
public:
    OAIQueue_ReservationPlan();
    OAIQueue_ReservationPlan(QString json);
    ~OAIQueue_ReservationPlan() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueue_ReservationPlan)

#endif // OAIQueue_ReservationPlan_H
