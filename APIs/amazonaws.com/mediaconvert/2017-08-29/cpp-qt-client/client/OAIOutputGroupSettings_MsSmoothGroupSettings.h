...
/*
 * OAIOutputGroupSettings_MsSmoothGroupSettings.h
 *
 * 
 */

#ifndef OAIOutputGroupSettings_MsSmoothGroupSettings_H
#define OAIOutputGroupSettings_MsSmoothGroupSettings_H
...
class OAIOutputGroupSettings_MsSmoothGroupSettings : public OAIObject {
public:
    OAIOutputGroupSettings_MsSmoothGroupSettings();
    OAIOutputGroupSettings_MsSmoothGroupSettings(QString json);
    ~OAIOutputGroupSettings_MsSmoothGroupSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputGroupSettings_MsSmoothGroupSettings)

#endif // OAIOutputGroupSettings_MsSmoothGroupSettings_H
