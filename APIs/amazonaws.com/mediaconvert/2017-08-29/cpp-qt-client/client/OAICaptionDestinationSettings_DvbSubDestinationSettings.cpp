...
OAIDvbSubtitleAlignment OAICaptionDestinationSettings_DvbSubDestinationSettings::getAlignment() const {
    return m_alignment;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setAlignment(const OAIDvbSubtitleAlignment &alignment) {
...
OAIDvbSubtitleApplyFontColor OAICaptionDestinationSettings_DvbSubDestinationSettings::getApplyFontColor() const {
    return m_apply_font_color;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setApplyFontColor(const OAIDvbSubtitleApplyFontColor &apply_font_color) {
    m_apply_font_color = apply_font_color;
    m_apply_font_color_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_apply_font_color_Set() const{
    return m_apply_font_color_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_apply_font_color_Valid() const{
    return m_apply_font_color_isValid;
}

OAIDvbSubtitleBackgroundColor OAICaptionDestinationSettings_DvbSubDestinationSettings::getBackgroundColor() const {
    return m_background_color;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setBackgroundColor(const OAIDvbSubtitleBackgroundColor &background_color) {
...
OAIDvbddsHandling OAICaptionDestinationSettings_DvbSubDestinationSettings::getDdsHandling() const {
    return m_dds_handling;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setDdsHandling(const OAIDvbddsHandling &dds_handling) {
    m_dds_handling = dds_handling;
    m_dds_handling_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_dds_handling_Set() const{
    return m_dds_handling_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_dds_handling_Valid() const{
    return m_dds_handling_isValid;
}

qint32 OAICaptionDestinationSettings_DvbSubDestinationSettings::getDdsXCoordinate() const {
    return m_dds_x_coordinate;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setDdsXCoordinate(const qint32 &dds_x_coordinate) {
    m_dds_x_coordinate = dds_x_coordinate;
    m_dds_x_coordinate_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_dds_x_coordinate_Set() const{
    return m_dds_x_coordinate_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_dds_x_coordinate_Valid() const{
    return m_dds_x_coordinate_isValid;
}

qint32 OAICaptionDestinationSettings_DvbSubDestinationSettings::getDdsYCoordinate() const {
    return m_dds_y_coordinate;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setDdsYCoordinate(const qint32 &dds_y_coordinate) {
    m_dds_y_coordinate = dds_y_coordinate;
    m_dds_y_coordinate_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_dds_y_coordinate_Set() const{
    return m_dds_y_coordinate_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_dds_y_coordinate_Valid() const{
    return m_dds_y_coordinate_isValid;
}

OAIDvbSubSubtitleFallbackFont OAICaptionDestinationSettings_DvbSubDestinationSettings::getFallbackFont() const {
    return m_fallback_font;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setFallbackFont(const OAIDvbSubSubtitleFallbackFont &fallback_font) {
    m_fallback_font = fallback_font;
    m_fallback_font_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_fallback_font_Set() const{
    return m_fallback_font_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_fallback_font_Valid() const{
    return m_fallback_font_isValid;
}

OAIDvbSubtitleFontColor OAICaptionDestinationSettings_DvbSubDestinationSettings::getFontColor() const {
    return m_font_color;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setFontColor(const OAIDvbSubtitleFontColor &font_color) {
...
OAIFontScript OAICaptionDestinationSettings_DvbSubDestinationSettings::getFontScript() const {
    return m_font_script;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setFontScript(const OAIFontScript &font_script) {
    m_font_script = font_script;
    m_font_script_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_font_script_Set() const{
    return m_font_script_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_font_script_Valid() const{
    return m_font_script_isValid;
}

qint32 OAICaptionDestinationSettings_DvbSubDestinationSettings::getFontSize() const {
    return m_font_size;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setFontSize(const qint32 &font_size) {
...
qint32 OAICaptionDestinationSettings_DvbSubDestinationSettings::getHeight() const {
    return m_height;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_height_Set() const{
    return m_height_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_height_Valid() const{
    return m_height_isValid;
}

QString OAICaptionDestinationSettings_DvbSubDestinationSettings::getHexFontColor() const {
    return m_hex_font_color;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setHexFontColor(const QString &hex_font_color) {
    m_hex_font_color = hex_font_color;
    m_hex_font_color_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_hex_font_color_Set() const{
    return m_hex_font_color_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_hex_font_color_Valid() const{
    return m_hex_font_color_isValid;
}

OAIDvbSubtitleOutlineColor OAICaptionDestinationSettings_DvbSubDestinationSettings::getOutlineColor() const {
    return m_outline_color;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setOutlineColor(const OAIDvbSubtitleOutlineColor &outline_color) {
...
OAIDvbSubtitleShadowColor OAICaptionDestinationSettings_DvbSubDestinationSettings::getShadowColor() const {
    return m_shadow_color;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setShadowColor(const OAIDvbSubtitleShadowColor &shadow_color) {
...
OAIDvbSubtitleStylePassthrough OAICaptionDestinationSettings_DvbSubDestinationSettings::getStylePassthrough() const {
    return m_style_passthrough;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setStylePassthrough(const OAIDvbSubtitleStylePassthrough &style_passthrough) {
    m_style_passthrough = style_passthrough;
    m_style_passthrough_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_style_passthrough_Set() const{
    return m_style_passthrough_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_style_passthrough_Valid() const{
    return m_style_passthrough_isValid;
}

OAIDvbSubtitlingType OAICaptionDestinationSettings_DvbSubDestinationSettings::getSubtitlingType() const {
    return m_subtitling_type;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setSubtitlingType(const OAIDvbSubtitlingType &subtitling_type) {
    m_subtitling_type = subtitling_type;
    m_subtitling_type_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_subtitling_type_Set() const{
    return m_subtitling_type_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_subtitling_type_Valid() const{
    return m_subtitling_type_isValid;
}

OAIDvbSubtitleTeletextSpacing OAICaptionDestinationSettings_DvbSubDestinationSettings::getTeletextSpacing() const {
    return m_teletext_spacing;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setTeletextSpacing(const OAIDvbSubtitleTeletextSpacing &teletext_spacing) {
    m_teletext_spacing = teletext_spacing;
    m_teletext_spacing_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_teletext_spacing_Set() const{
    return m_teletext_spacing_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_teletext_spacing_Valid() const{
    return m_teletext_spacing_isValid;
}

qint32 OAICaptionDestinationSettings_DvbSubDestinationSettings::getWidth() const {
    return m_width;
}
void OAICaptionDestinationSettings_DvbSubDestinationSettings::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_width_Set() const{
    return m_width_isSet;
}

bool OAICaptionDestinationSettings_DvbSubDestinationSettings::is_width_Valid() const{
