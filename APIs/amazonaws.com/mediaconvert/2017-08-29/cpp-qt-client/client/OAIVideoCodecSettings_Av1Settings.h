...
/*
 * OAIVideoCodecSettings_Av1Settings.h
 *
 * 
 */

#ifndef OAIVideoCodecSettings_Av1Settings_H
#define OAIVideoCodecSettings_Av1Settings_H
...
class OAIVideoCodecSettings_Av1Settings : public OAIObject {
public:
    OAIVideoCodecSettings_Av1Settings();
    OAIVideoCodecSettings_Av1Settings(QString json);
    ~OAIVideoCodecSettings_Av1Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoCodecSettings_Av1Settings)

#endif // OAIVideoCodecSettings_Av1Settings_H
