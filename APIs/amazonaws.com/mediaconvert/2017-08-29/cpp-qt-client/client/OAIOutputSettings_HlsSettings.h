...
/*
 * OAIOutputSettings_HlsSettings.h
 *
 * 
 */

#ifndef OAIOutputSettings_HlsSettings_H
#define OAIOutputSettings_HlsSettings_H
...
class OAIOutputSettings_HlsSettings : public OAIObject {
public:
    OAIOutputSettings_HlsSettings();
    OAIOutputSettings_HlsSettings(QString json);
    ~OAIOutputSettings_HlsSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputSettings_HlsSettings)

#endif // OAIOutputSettings_HlsSettings_H
