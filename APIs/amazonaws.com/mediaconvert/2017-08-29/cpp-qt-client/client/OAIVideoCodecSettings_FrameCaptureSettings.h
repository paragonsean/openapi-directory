...
/*
 * OAIVideoCodecSettings_FrameCaptureSettings.h
 *
 * 
 */

#ifndef OAIVideoCodecSettings_FrameCaptureSettings_H
#define OAIVideoCodecSettings_FrameCaptureSettings_H
...
class OAIVideoCodecSettings_FrameCaptureSettings : public OAIObject {
public:
    OAIVideoCodecSettings_FrameCaptureSettings();
    OAIVideoCodecSettings_FrameCaptureSettings(QString json);
    ~OAIVideoCodecSettings_FrameCaptureSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoCodecSettings_FrameCaptureSettings)

#endif // OAIVideoCodecSettings_FrameCaptureSettings_H
