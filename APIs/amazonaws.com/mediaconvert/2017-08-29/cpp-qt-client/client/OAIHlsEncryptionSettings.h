...
/*
 * OAIHlsEncryptionSettings.h
 *
 * Settings for HLS encryption
 */

#ifndef OAIHlsEncryptionSettings_H
#define OAIHlsEncryptionSettings_H
...
class OAIHlsEncryptionSettings : public OAIObject {
public:
    OAIHlsEncryptionSettings();
    OAIHlsEncryptionSettings(QString json);
    ~OAIHlsEncryptionSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHlsEncryptionSettings)

#endif // OAIHlsEncryptionSettings_H
