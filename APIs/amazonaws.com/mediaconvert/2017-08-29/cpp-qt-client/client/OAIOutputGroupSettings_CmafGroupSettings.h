...
/*
 * OAIOutputGroupSettings_CmafGroupSettings.h
 *
 * 
 */

#ifndef OAIOutputGroupSettings_CmafGroupSettings_H
#define OAIOutputGroupSettings_CmafGroupSettings_H
...
class OAIOutputGroupSettings_CmafGroupSettings : public OAIObject {
public:
    OAIOutputGroupSettings_CmafGroupSettings();
    OAIOutputGroupSettings_CmafGroupSettings(QString json);
    ~OAIOutputGroupSettings_CmafGroupSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputGroupSettings_CmafGroupSettings)

#endif // OAIOutputGroupSettings_CmafGroupSettings_H
