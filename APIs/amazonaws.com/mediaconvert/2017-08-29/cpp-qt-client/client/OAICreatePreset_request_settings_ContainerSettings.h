...
/*
 * OAICreatePreset_request_settings_ContainerSettings.h
 *
 * 
 */

#ifndef OAICreatePreset_request_settings_ContainerSettings_H
#define OAICreatePreset_request_settings_ContainerSettings_H
...
class OAICreatePreset_request_settings_ContainerSettings : public OAIObject {
public:
    OAICreatePreset_request_settings_ContainerSettings();
    OAICreatePreset_request_settings_ContainerSettings(QString json);
    ~OAICreatePreset_request_settings_ContainerSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePreset_request_settings_ContainerSettings)

#endif // OAICreatePreset_request_settings_ContainerSettings_H
