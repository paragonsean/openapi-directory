...
OAICmafGroupSettings_Encryption::OAICmafGroupSettings_Encryption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICmafGroupSettings_Encryption::OAICmafGroupSettings_Encryption() {
    this->initializeModel();
}

OAICmafGroupSettings_Encryption::~OAICmafGroupSettings_Encryption() {}

void OAICmafGroupSettings_Encryption::initializeModel() {
...
void OAICmafGroupSettings_Encryption::fromJson(QString jsonString) {
...
void OAICmafGroupSettings_Encryption::fromJsonObject(QJsonObject json) {
...
QString OAICmafGroupSettings_Encryption::asJson() const {
...
QJsonObject OAICmafGroupSettings_Encryption::asJsonObject() const {
    QJsonObject obj;
...
QString OAICmafGroupSettings_Encryption::getConstantInitializationVector() const {
    return m_constant_initialization_vector;
}
void OAICmafGroupSettings_Encryption::setConstantInitializationVector(const QString &constant_initialization_vector) {
    m_constant_initialization_vector = constant_initialization_vector;
    m_constant_initialization_vector_isSet = true;
}

bool OAICmafGroupSettings_Encryption::is_constant_initialization_vector_Set() const{
    return m_constant_initialization_vector_isSet;
}

bool OAICmafGroupSettings_Encryption::is_constant_initialization_vector_Valid() const{
    return m_constant_initialization_vector_isValid;
}

OAICmafEncryptionType OAICmafGroupSettings_Encryption::getEncryptionMethod() const {
    return m_encryption_method;
}
void OAICmafGroupSettings_Encryption::setEncryptionMethod(const OAICmafEncryptionType &encryption_method) {
    m_encryption_method = encryption_method;
    m_encryption_method_isSet = true;
}

bool OAICmafGroupSettings_Encryption::is_encryption_method_Set() const{
    return m_encryption_method_isSet;
}

bool OAICmafGroupSettings_Encryption::is_encryption_method_Valid() const{
    return m_encryption_method_isValid;
}

OAICmafInitializationVectorInManifest OAICmafGroupSettings_Encryption::getInitializationVectorInManifest() const {
    return m_initialization_vector_in_manifest;
}
void OAICmafGroupSettings_Encryption::setInitializationVectorInManifest(const OAICmafInitializationVectorInManifest &initialization_vector_in_manifest) {
    m_initialization_vector_in_manifest = initialization_vector_in_manifest;
    m_initialization_vector_in_manifest_isSet = true;
}

bool OAICmafGroupSettings_Encryption::is_initialization_vector_in_manifest_Set() const{
    return m_initialization_vector_in_manifest_isSet;
}

bool OAICmafGroupSettings_Encryption::is_initialization_vector_in_manifest_Valid() const{
    return m_initialization_vector_in_manifest_isValid;
}

OAICmafEncryptionSettings_SpekeKeyProvider OAICmafGroupSettings_Encryption::getSpekeKeyProvider() const {
    return m_speke_key_provider;
}
void OAICmafGroupSettings_Encryption::setSpekeKeyProvider(const OAICmafEncryptionSettings_SpekeKeyProvider &speke_key_provider) {
    m_speke_key_provider = speke_key_provider;
    m_speke_key_provider_isSet = true;
}

bool OAICmafGroupSettings_Encryption::is_speke_key_provider_Set() const{
    return m_speke_key_provider_isSet;
}

bool OAICmafGroupSettings_Encryption::is_speke_key_provider_Valid() const{
    return m_speke_key_provider_isValid;
}

OAICmafEncryptionSettings_StaticKeyProvider OAICmafGroupSettings_Encryption::getStaticKeyProvider() const {
    return m_static_key_provider;
}
void OAICmafGroupSettings_Encryption::setStaticKeyProvider(const OAICmafEncryptionSettings_StaticKeyProvider &static_key_provider) {
    m_static_key_provider = static_key_provider;
    m_static_key_provider_isSet = true;
}

bool OAICmafGroupSettings_Encryption::is_static_key_provider_Set() const{
    return m_static_key_provider_isSet;
}

bool OAICmafGroupSettings_Encryption::is_static_key_provider_Valid() const{
    return m_static_key_provider_isValid;
}

OAICmafKeyProviderType OAICmafGroupSettings_Encryption::getType() const {
    return m_type;
}
void OAICmafGroupSettings_Encryption::setType(const OAICmafKeyProviderType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICmafGroupSettings_Encryption::is_type_Set() const{
    return m_type_isSet;
}

bool OAICmafGroupSettings_Encryption::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICmafGroupSettings_Encryption::isSet() const {
...
bool OAICmafGroupSettings_Encryption::isValid() const {
