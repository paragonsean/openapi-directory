...
#include "OAIHlsImageBasedTrickPlaySettings.h"
...
OAIHlsImageBasedTrickPlaySettings::OAIHlsImageBasedTrickPlaySettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHlsImageBasedTrickPlaySettings::OAIHlsImageBasedTrickPlaySettings() {
    this->initializeModel();
}

OAIHlsImageBasedTrickPlaySettings::~OAIHlsImageBasedTrickPlaySettings() {}

void OAIHlsImageBasedTrickPlaySettings::initializeModel() {
...
void OAIHlsImageBasedTrickPlaySettings::fromJson(QString jsonString) {
...
void OAIHlsImageBasedTrickPlaySettings::fromJsonObject(QJsonObject json) {
...
QString OAIHlsImageBasedTrickPlaySettings::asJson() const {
...
QJsonObject OAIHlsImageBasedTrickPlaySettings::asJsonObject() const {
    QJsonObject obj;
...
OAIHlsIntervalCadence OAIHlsImageBasedTrickPlaySettings::getIntervalCadence() const {
    return m_interval_cadence;
}
void OAIHlsImageBasedTrickPlaySettings::setIntervalCadence(const OAIHlsIntervalCadence &interval_cadence) {
    m_interval_cadence = interval_cadence;
    m_interval_cadence_isSet = true;
}

bool OAIHlsImageBasedTrickPlaySettings::is_interval_cadence_Set() const{
    return m_interval_cadence_isSet;
}

bool OAIHlsImageBasedTrickPlaySettings::is_interval_cadence_Valid() const{
    return m_interval_cadence_isValid;
}

qint32 OAIHlsImageBasedTrickPlaySettings::getThumbnailHeight() const {
    return m_thumbnail_height;
}
void OAIHlsImageBasedTrickPlaySettings::setThumbnailHeight(const qint32 &thumbnail_height) {
    m_thumbnail_height = thumbnail_height;
    m_thumbnail_height_isSet = true;
}

bool OAIHlsImageBasedTrickPlaySettings::is_thumbnail_height_Set() const{
    return m_thumbnail_height_isSet;
}

bool OAIHlsImageBasedTrickPlaySettings::is_thumbnail_height_Valid() const{
    return m_thumbnail_height_isValid;
}

double OAIHlsImageBasedTrickPlaySettings::getThumbnailInterval() const {
    return m_thumbnail_interval;
}
void OAIHlsImageBasedTrickPlaySettings::setThumbnailInterval(const double &thumbnail_interval) {
    m_thumbnail_interval = thumbnail_interval;
    m_thumbnail_interval_isSet = true;
}

bool OAIHlsImageBasedTrickPlaySettings::is_thumbnail_interval_Set() const{
    return m_thumbnail_interval_isSet;
}

bool OAIHlsImageBasedTrickPlaySettings::is_thumbnail_interval_Valid() const{
    return m_thumbnail_interval_isValid;
}

qint32 OAIHlsImageBasedTrickPlaySettings::getThumbnailWidth() const {
    return m_thumbnail_width;
}
void OAIHlsImageBasedTrickPlaySettings::setThumbnailWidth(const qint32 &thumbnail_width) {
    m_thumbnail_width = thumbnail_width;
    m_thumbnail_width_isSet = true;
}

bool OAIHlsImageBasedTrickPlaySettings::is_thumbnail_width_Set() const{
    return m_thumbnail_width_isSet;
}

bool OAIHlsImageBasedTrickPlaySettings::is_thumbnail_width_Valid() const{
    return m_thumbnail_width_isValid;
}

qint32 OAIHlsImageBasedTrickPlaySettings::getTileHeight() const {
    return m_tile_height;
}
void OAIHlsImageBasedTrickPlaySettings::setTileHeight(const qint32 &tile_height) {
    m_tile_height = tile_height;
    m_tile_height_isSet = true;
}

bool OAIHlsImageBasedTrickPlaySettings::is_tile_height_Set() const{
    return m_tile_height_isSet;
}

bool OAIHlsImageBasedTrickPlaySettings::is_tile_height_Valid() const{
    return m_tile_height_isValid;
}

qint32 OAIHlsImageBasedTrickPlaySettings::getTileWidth() const {
    return m_tile_width;
}
void OAIHlsImageBasedTrickPlaySettings::setTileWidth(const qint32 &tile_width) {
    m_tile_width = tile_width;
    m_tile_width_isSet = true;
}

bool OAIHlsImageBasedTrickPlaySettings::is_tile_width_Set() const{
    return m_tile_width_isSet;
}

bool OAIHlsImageBasedTrickPlaySettings::is_tile_width_Valid() const{
    return m_tile_width_isValid;
}

bool OAIHlsImageBasedTrickPlaySettings::isSet() const {
...
bool OAIHlsImageBasedTrickPlaySettings::isValid() const {
