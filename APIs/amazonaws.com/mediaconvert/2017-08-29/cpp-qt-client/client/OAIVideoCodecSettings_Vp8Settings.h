...
/*
 * OAIVideoCodecSettings_Vp8Settings.h
 *
 * 
 */

#ifndef OAIVideoCodecSettings_Vp8Settings_H
#define OAIVideoCodecSettings_Vp8Settings_H
...
class OAIVideoCodecSettings_Vp8Settings : public OAIObject {
public:
    OAIVideoCodecSettings_Vp8Settings();
    OAIVideoCodecSettings_Vp8Settings(QString json);
    ~OAIVideoCodecSettings_Vp8Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoCodecSettings_Vp8Settings)

#endif // OAIVideoCodecSettings_Vp8Settings_H
