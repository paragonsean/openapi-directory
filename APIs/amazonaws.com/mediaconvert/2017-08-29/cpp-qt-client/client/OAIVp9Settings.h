...
#ifndef OAIVp9Settings_H
#define OAIVp9Settings_H
...
class OAIVp9Settings : public OAIObject {
public:
    OAIVp9Settings();
    OAIVp9Settings(QString json);
    ~OAIVp9Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVp9Settings)

#endif // OAIVp9Settings_H
