...
/*
 * OAICreateJob_request_settings_MotionImageInserter.h
 *
 * 
 */

#ifndef OAICreateJob_request_settings_MotionImageInserter_H
#define OAICreateJob_request_settings_MotionImageInserter_H
...
class OAICreateJob_request_settings_MotionImageInserter : public OAIObject {
public:
    OAICreateJob_request_settings_MotionImageInserter();
    OAICreateJob_request_settings_MotionImageInserter(QString json);
    ~OAICreateJob_request_settings_MotionImageInserter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_settings_MotionImageInserter)

#endif // OAICreateJob_request_settings_MotionImageInserter_H
