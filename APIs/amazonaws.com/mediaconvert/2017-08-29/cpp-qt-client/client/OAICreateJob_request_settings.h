...
/*
 * OAICreateJob_request_settings.h
 *
 * JobSettings contains all the transcode settings for a job.
 */

#ifndef OAICreateJob_request_settings_H
#define OAICreateJob_request_settings_H
...
class OAICreateJob_request_settings : public OAIObject {
public:
    OAICreateJob_request_settings();
    OAICreateJob_request_settings(QString json);
    ~OAICreateJob_request_settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_settings)

#endif // OAICreateJob_request_settings_H
