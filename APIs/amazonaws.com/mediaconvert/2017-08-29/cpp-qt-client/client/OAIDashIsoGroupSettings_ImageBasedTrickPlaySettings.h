...
/*
 * OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings.h
 *
 * 
 */

#ifndef OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings_H
#define OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings_H
...
class OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings : public OAIObject {
public:
    OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings();
    OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings(QString json);
    ~OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings() override;
    ...
    OAIDashIsoIntervalCadence getIntervalCadence() const;
    void setIntervalCadence(const OAIDashIsoIntervalCadence &interval_cadence);
...
private:
    ...
    OAIDashIsoIntervalCadence m_interval_cadence;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings)

#endif // OAIDashIsoGroupSettings_ImageBasedTrickPlaySettings_H
