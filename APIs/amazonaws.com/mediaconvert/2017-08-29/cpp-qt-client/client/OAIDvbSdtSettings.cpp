...
OAIOutputSdt OAIDvbSdtSettings::getOutputSdt() const {
    return m_output_sdt;
}
void OAIDvbSdtSettings::setOutputSdt(const OAIOutputSdt &output_sdt) {
...
qint32 OAIDvbSdtSettings::getSdtInterval() const {
    return m_sdt_interval;
}
void OAIDvbSdtSettings::setSdtInterval(const qint32 &sdt_interval) {
    m_sdt_interval = sdt_interval;
    m_sdt_interval_isSet = true;
}

bool OAIDvbSdtSettings::is_sdt_interval_Set() const{
    return m_sdt_interval_isSet;
}

bool OAIDvbSdtSettings::is_sdt_interval_Valid() const{
