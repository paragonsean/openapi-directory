...
/*
 * OAIVideoDescription_VideoPreprocessors.h
 *
 * 
 */

#ifndef OAIVideoDescription_VideoPreprocessors_H
#define OAIVideoDescription_VideoPreprocessors_H
...
class OAIVideoDescription_VideoPreprocessors : public OAIObject {
public:
    OAIVideoDescription_VideoPreprocessors();
    OAIVideoDescription_VideoPreprocessors(QString json);
    ~OAIVideoDescription_VideoPreprocessors() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoDescription_VideoPreprocessors)

#endif // OAIVideoDescription_VideoPreprocessors_H
