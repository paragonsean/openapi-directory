...
#include "OAIXavc4kProfileSettings.h"
...
OAIXavc4kProfileSettings::OAIXavc4kProfileSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXavc4kProfileSettings::OAIXavc4kProfileSettings() {
    this->initializeModel();
}

OAIXavc4kProfileSettings::~OAIXavc4kProfileSettings() {}

void OAIXavc4kProfileSettings::initializeModel() {
...
void OAIXavc4kProfileSettings::fromJson(QString jsonString) {
...
void OAIXavc4kProfileSettings::fromJsonObject(QJsonObject json) {
...
QString OAIXavc4kProfileSettings::asJson() const {
...
QJsonObject OAIXavc4kProfileSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIXavc4kProfileBitrateClass OAIXavc4kProfileSettings::getBitrateClass() const {
    return m_bitrate_class;
}
void OAIXavc4kProfileSettings::setBitrateClass(const OAIXavc4kProfileBitrateClass &bitrate_class) {
    m_bitrate_class = bitrate_class;
    m_bitrate_class_isSet = true;
}

bool OAIXavc4kProfileSettings::is_bitrate_class_Set() const{
    return m_bitrate_class_isSet;
}

bool OAIXavc4kProfileSettings::is_bitrate_class_Valid() const{
    return m_bitrate_class_isValid;
}

OAIXavc4kProfileCodecProfile OAIXavc4kProfileSettings::getCodecProfile() const {
    return m_codec_profile;
}
void OAIXavc4kProfileSettings::setCodecProfile(const OAIXavc4kProfileCodecProfile &codec_profile) {
    m_codec_profile = codec_profile;
    m_codec_profile_isSet = true;
}

bool OAIXavc4kProfileSettings::is_codec_profile_Set() const{
    return m_codec_profile_isSet;
}

bool OAIXavc4kProfileSettings::is_codec_profile_Valid() const{
    return m_codec_profile_isValid;
}

OAIXavcFlickerAdaptiveQuantization OAIXavc4kProfileSettings::getFlickerAdaptiveQuantization() const {
    return m_flicker_adaptive_quantization;
}
void OAIXavc4kProfileSettings::setFlickerAdaptiveQuantization(const OAIXavcFlickerAdaptiveQuantization &flicker_adaptive_quantization) {
    m_flicker_adaptive_quantization = flicker_adaptive_quantization;
    m_flicker_adaptive_quantization_isSet = true;
}

bool OAIXavc4kProfileSettings::is_flicker_adaptive_quantization_Set() const{
    return m_flicker_adaptive_quantization_isSet;
}

bool OAIXavc4kProfileSettings::is_flicker_adaptive_quantization_Valid() const{
    return m_flicker_adaptive_quantization_isValid;
}

OAIXavcGopBReference OAIXavc4kProfileSettings::getGopBReference() const {
    return m_gop_b_reference;
}
void OAIXavc4kProfileSettings::setGopBReference(const OAIXavcGopBReference &gop_b_reference) {
    m_gop_b_reference = gop_b_reference;
    m_gop_b_reference_isSet = true;
}

bool OAIXavc4kProfileSettings::is_gop_b_reference_Set() const{
    return m_gop_b_reference_isSet;
}

bool OAIXavc4kProfileSettings::is_gop_b_reference_Valid() const{
    return m_gop_b_reference_isValid;
}

qint32 OAIXavc4kProfileSettings::getGopClosedCadence() const {
    return m_gop_closed_cadence;
}
void OAIXavc4kProfileSettings::setGopClosedCadence(const qint32 &gop_closed_cadence) {
    m_gop_closed_cadence = gop_closed_cadence;
    m_gop_closed_cadence_isSet = true;
}

bool OAIXavc4kProfileSettings::is_gop_closed_cadence_Set() const{
    return m_gop_closed_cadence_isSet;
}

bool OAIXavc4kProfileSettings::is_gop_closed_cadence_Valid() const{
    return m_gop_closed_cadence_isValid;
}

qint32 OAIXavc4kProfileSettings::getHrdBufferSize() const {
    return m_hrd_buffer_size;
}
void OAIXavc4kProfileSettings::setHrdBufferSize(const qint32 &hrd_buffer_size) {
    m_hrd_buffer_size = hrd_buffer_size;
    m_hrd_buffer_size_isSet = true;
}

bool OAIXavc4kProfileSettings::is_hrd_buffer_size_Set() const{
    return m_hrd_buffer_size_isSet;
}

bool OAIXavc4kProfileSettings::is_hrd_buffer_size_Valid() const{
    return m_hrd_buffer_size_isValid;
}

OAIXavc4kProfileQualityTuningLevel OAIXavc4kProfileSettings::getQualityTuningLevel() const {
    return m_quality_tuning_level;
}
void OAIXavc4kProfileSettings::setQualityTuningLevel(const OAIXavc4kProfileQualityTuningLevel &quality_tuning_level) {
    m_quality_tuning_level = quality_tuning_level;
    m_quality_tuning_level_isSet = true;
}

bool OAIXavc4kProfileSettings::is_quality_tuning_level_Set() const{
    return m_quality_tuning_level_isSet;
}

bool OAIXavc4kProfileSettings::is_quality_tuning_level_Valid() const{
    return m_quality_tuning_level_isValid;
}

qint32 OAIXavc4kProfileSettings::getSlices() const {
    return m_slices;
}
void OAIXavc4kProfileSettings::setSlices(const qint32 &slices) {
    m_slices = slices;
    m_slices_isSet = true;
}

bool OAIXavc4kProfileSettings::is_slices_Set() const{
    return m_slices_isSet;
}

bool OAIXavc4kProfileSettings::is_slices_Valid() const{
    return m_slices_isValid;
}

bool OAIXavc4kProfileSettings::isSet() const {
...
bool OAIXavc4kProfileSettings::isValid() const {
