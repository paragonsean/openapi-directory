...
/*
 * OAINoiseReducerTemporalFilterSettings.h
 *
 * Noise reducer filter settings for temporal filter.
 */

#ifndef OAINoiseReducerTemporalFilterSettings_H
#define OAINoiseReducerTemporalFilterSettings_H
...
class OAINoiseReducerTemporalFilterSettings : public OAIObject {
public:
    OAINoiseReducerTemporalFilterSettings();
    OAINoiseReducerTemporalFilterSettings(QString json);
    ~OAINoiseReducerTemporalFilterSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINoiseReducerTemporalFilterSettings)

#endif // OAINoiseReducerTemporalFilterSettings_H
