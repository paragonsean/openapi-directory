...
public class CreateWorkspaceResponse {
  ...
  public CreateWorkspaceResponse workspaceId(String workspaceId) {
  ...
  public CreateWorkspaceResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateWorkspaceResponse status(CreateWorkspaceResponseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(CreateWorkspaceResponseStatus status) {
    this.status = status;
  }


  public CreateWorkspaceResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
