...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPrometheusService.DescribeWorkspaceResponseWorkspace();
  });
  ...
  describe('DescribeWorkspaceResponseWorkspace', function() {
    it('should create an instance of DescribeWorkspaceResponseWorkspace', function() {
      ...
      //var instance = new AmazonPrometheusService.DescribeWorkspaceResponseWorkspace();
      //expect(instance).to.be.a(AmazonPrometheusService.DescribeWorkspaceResponseWorkspace);
    });
