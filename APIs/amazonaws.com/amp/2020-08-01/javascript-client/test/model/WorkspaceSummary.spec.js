...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPrometheusService.WorkspaceSummary();
  });
  ...
  describe('WorkspaceSummary', function() {
    it('should create an instance of WorkspaceSummary', function() {
      ...
      //var instance = new AmazonPrometheusService.WorkspaceSummary();
      //expect(instance).to.be.a(AmazonPrometheusService.WorkspaceSummary);
    });
