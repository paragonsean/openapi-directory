...
/*
 * OAICreateScanResponse_resourceId.h
 *
 * 
 */

#ifndef OAICreateScanResponse_resourceId_H
#define OAICreateScanResponse_resourceId_H
...
class OAICreateScanResponse_resourceId : public OAIObject {
public:
    OAICreateScanResponse_resourceId();
    OAICreateScanResponse_resourceId(QString json);
    ~OAICreateScanResponse_resourceId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScanResponse_resourceId)

#endif // OAICreateScanResponse_resourceId_H
