...
/*
 * OAIUpdateAccountConfiguration_request_encryptionConfig.h
 *
 * Information about account-level configuration.
 */

#ifndef OAIUpdateAccountConfiguration_request_encryptionConfig_H
#define OAIUpdateAccountConfiguration_request_encryptionConfig_H
...
class OAIUpdateAccountConfiguration_request_encryptionConfig : public OAIObject {
public:
    OAIUpdateAccountConfiguration_request_encryptionConfig();
    OAIUpdateAccountConfiguration_request_encryptionConfig(QString json);
    ~OAIUpdateAccountConfiguration_request_encryptionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccountConfiguration_request_encryptionConfig)

#endif // OAIUpdateAccountConfiguration_request_encryptionConfig_H
