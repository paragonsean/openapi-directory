...
/*
 * OAIFindingMetricsValuePerSeverity.h
 *
 * The severity of the issue in the code that generated a finding.
 */

#ifndef OAIFindingMetricsValuePerSeverity_H
#define OAIFindingMetricsValuePerSeverity_H
...
class OAIFindingMetricsValuePerSeverity : public OAIObject {
public:
    OAIFindingMetricsValuePerSeverity();
    OAIFindingMetricsValuePerSeverity(QString json);
    ~OAIFindingMetricsValuePerSeverity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindingMetricsValuePerSeverity)

#endif // OAIFindingMetricsValuePerSeverity_H
