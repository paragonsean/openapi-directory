...
/*
 * OAIUpdateAccountConfigurationRequest_encryptionConfig.h
 *
 * 
 */

#ifndef OAIUpdateAccountConfigurationRequest_encryptionConfig_H
#define OAIUpdateAccountConfigurationRequest_encryptionConfig_H
...
class OAIUpdateAccountConfigurationRequest_encryptionConfig : public OAIObject {
public:
    OAIUpdateAccountConfigurationRequest_encryptionConfig();
    OAIUpdateAccountConfigurationRequest_encryptionConfig(QString json);
    ~OAIUpdateAccountConfigurationRequest_encryptionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccountConfigurationRequest_encryptionConfig)

#endif // OAIUpdateAccountConfigurationRequest_encryptionConfig_H
