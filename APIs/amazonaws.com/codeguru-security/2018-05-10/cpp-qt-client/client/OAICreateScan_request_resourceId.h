...
/*
 * OAICreateScan_request_resourceId.h
 *
 * The identifier for a resource object that contains resources where a finding was detected.
 */

#ifndef OAICreateScan_request_resourceId_H
#define OAICreateScan_request_resourceId_H
...
class OAICreateScan_request_resourceId : public OAIObject {
public:
    OAICreateScan_request_resourceId();
    OAICreateScan_request_resourceId(QString json);
    ~OAICreateScan_request_resourceId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScan_request_resourceId)

#endif // OAICreateScan_request_resourceId_H
