...
/*
 * OAICreateUploadUrlRequest.h
 *
 * 
 */

#ifndef OAICreateUploadUrlRequest_H
#define OAICreateUploadUrlRequest_H
...
class OAICreateUploadUrlRequest : public OAIObject {
public:
    OAICreateUploadUrlRequest();
    OAICreateUploadUrlRequest(QString json);
    ~OAICreateUploadUrlRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUploadUrlRequest)

#endif // OAICreateUploadUrlRequest_H
