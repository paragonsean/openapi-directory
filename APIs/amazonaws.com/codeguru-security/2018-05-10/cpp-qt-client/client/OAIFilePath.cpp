...
OAIFilePath::OAIFilePath(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilePath::OAIFilePath() {
    this->initializeModel();
}

OAIFilePath::~OAIFilePath() {}

void OAIFilePath::initializeModel() {
...
void OAIFilePath::fromJson(QString jsonString) {
...
void OAIFilePath::fromJsonObject(QJsonObject json) {
...
QString OAIFilePath::asJson() const {
...
QJsonObject OAIFilePath::asJsonObject() const {
    QJsonObject obj;
...
QList OAIFilePath::getCodeSnippet() const {
    return m_code_snippet;
}
void OAIFilePath::setCodeSnippet(const QList &code_snippet) {
    m_code_snippet = code_snippet;
    m_code_snippet_isSet = true;
}

bool OAIFilePath::is_code_snippet_Set() const{
    return m_code_snippet_isSet;
}

bool OAIFilePath::is_code_snippet_Valid() const{
    return m_code_snippet_isValid;
}

qint32 OAIFilePath::getEndLine() const {
    return m_end_line;
}
void OAIFilePath::setEndLine(const qint32 &end_line) {
    m_end_line = end_line;
    m_end_line_isSet = true;
}

bool OAIFilePath::is_end_line_Set() const{
    return m_end_line_isSet;
}

bool OAIFilePath::is_end_line_Valid() const{
    return m_end_line_isValid;
}

QString OAIFilePath::getName() const {
    return m_name;
}
void OAIFilePath::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFilePath::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFilePath::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIFilePath::getPath() const {
    return m_path;
}
void OAIFilePath::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIFilePath::is_path_Set() const{
    return m_path_isSet;
}

bool OAIFilePath::is_path_Valid() const{
    return m_path_isValid;
}

qint32 OAIFilePath::getStartLine() const {
    return m_start_line;
}
void OAIFilePath::setStartLine(const qint32 &start_line) {
    m_start_line = start_line;
    m_start_line_isSet = true;
}

bool OAIFilePath::is_start_line_Set() const{
    return m_start_line_isSet;
}

bool OAIFilePath::is_start_line_Valid() const{
    return m_start_line_isValid;
}

bool OAIFilePath::isSet() const {
...
bool OAIFilePath::isValid() const {
