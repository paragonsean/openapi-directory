...
OAICreateScanRequest_resourceId::OAICreateScanRequest_resourceId(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScanRequest_resourceId::OAICreateScanRequest_resourceId() {
    this->initializeModel();
}

OAICreateScanRequest_resourceId::~OAICreateScanRequest_resourceId() {}

void OAICreateScanRequest_resourceId::initializeModel() {

    m_code_artifact_id_isSet = false;
    m_code_artifact_id_isValid = false;
}

void OAICreateScanRequest_resourceId::fromJson(QString jsonString) {
...
void OAICreateScanRequest_resourceId::fromJsonObject(QJsonObject json) {
...
QString OAICreateScanRequest_resourceId::asJson() const {
...
QJsonObject OAICreateScanRequest_resourceId::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateScanRequest_resourceId::getCodeArtifactId() const {
    return m_code_artifact_id;
}
void OAICreateScanRequest_resourceId::setCodeArtifactId(const QString &code_artifact_id) {
    m_code_artifact_id = code_artifact_id;
    m_code_artifact_id_isSet = true;
}

bool OAICreateScanRequest_resourceId::is_code_artifact_id_Set() const{
    return m_code_artifact_id_isSet;
}

bool OAICreateScanRequest_resourceId::is_code_artifact_id_Valid() const{
    return m_code_artifact_id_isValid;
}

bool OAICreateScanRequest_resourceId::isSet() const {
...
bool OAICreateScanRequest_resourceId::isValid() const {
