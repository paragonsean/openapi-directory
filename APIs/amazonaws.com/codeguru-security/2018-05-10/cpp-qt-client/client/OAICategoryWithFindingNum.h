...
/*
 * OAICategoryWithFindingNum.h
 *
 * Information about a finding category with open findings.
 */

#ifndef OAICategoryWithFindingNum_H
#define OAICategoryWithFindingNum_H
...
class OAICategoryWithFindingNum : public OAIObject {
public:
    OAICategoryWithFindingNum();
    OAICategoryWithFindingNum(QString json);
    ~OAICategoryWithFindingNum() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoryWithFindingNum)

#endif // OAICategoryWithFindingNum_H
