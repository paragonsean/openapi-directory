...
/*
 * OAIFinding_resource.h
 *
 * 
 */

#ifndef OAIFinding_resource_H
#define OAIFinding_resource_H
...
class OAIFinding_resource : public OAIObject {
public:
    OAIFinding_resource();
    OAIFinding_resource(QString json);
    ~OAIFinding_resource() override;
    ...
    QString getSubResourceId() const;
    void setSubResourceId(const QString &sub_resource_id);
    bool is_sub_resource_id_Set() const;
    bool is_sub_resource_id_Valid() const;
...
private:
    ...
    QString m_sub_resource_id;
    bool m_sub_resource_id_isSet;
    bool m_sub_resource_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIFinding_resource)

#endif // OAIFinding_resource_H
