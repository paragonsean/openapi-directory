...
/*
 * OAIMetricsSummary_openFindings.h
 *
 * 
 */

#ifndef OAIMetricsSummary_openFindings_H
#define OAIMetricsSummary_openFindings_H
...
class OAIMetricsSummary_openFindings : public OAIObject {
public:
    OAIMetricsSummary_openFindings();
    OAIMetricsSummary_openFindings(QString json);
    ~OAIMetricsSummary_openFindings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricsSummary_openFindings)

#endif // OAIMetricsSummary_openFindings_H
