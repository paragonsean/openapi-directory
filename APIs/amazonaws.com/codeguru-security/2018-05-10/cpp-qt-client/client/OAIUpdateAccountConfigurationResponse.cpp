...
OAIUpdateAccountConfigurationResponse_encryptionConfig OAIUpdateAccountConfigurationResponse::getEncryptionConfig() const {
    return m_encryption_config;
}
void OAIUpdateAccountConfigurationResponse::setEncryptionConfig(const OAIUpdateAccountConfigurationResponse_encryptionConfig &encryption_config) {
    m_encryption_config = encryption_config;
    m_encryption_config_isSet = true;
}

bool OAIUpdateAccountConfigurationResponse::is_encryption_config_Set() const{
    return m_encryption_config_isSet;
}

bool OAIUpdateAccountConfigurationResponse::is_encryption_config_Valid() const{
