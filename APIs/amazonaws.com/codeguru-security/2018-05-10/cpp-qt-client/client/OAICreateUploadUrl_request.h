...
/*
 * OAICreateUploadUrl_request.h
 *
 * 
 */

#ifndef OAICreateUploadUrl_request_H
#define OAICreateUploadUrl_request_H
...
class OAICreateUploadUrl_request : public OAIObject {
public:
    OAICreateUploadUrl_request();
    OAICreateUploadUrl_request(QString json);
    ~OAICreateUploadUrl_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUploadUrl_request)

#endif // OAICreateUploadUrl_request_H
