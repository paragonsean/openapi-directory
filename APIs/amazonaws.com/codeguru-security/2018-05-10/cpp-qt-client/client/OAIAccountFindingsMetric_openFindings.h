...
/*
 * OAIAccountFindingsMetric_openFindings.h
 *
 * 
 */

#ifndef OAIAccountFindingsMetric_openFindings_H
#define OAIAccountFindingsMetric_openFindings_H
...
class OAIAccountFindingsMetric_openFindings : public OAIObject {
public:
    OAIAccountFindingsMetric_openFindings();
    OAIAccountFindingsMetric_openFindings(QString json);
    ~OAIAccountFindingsMetric_openFindings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountFindingsMetric_openFindings)

#endif // OAIAccountFindingsMetric_openFindings_H
