...
/*
 * OAIAccountFindingsMetric_closedFindings.h
 *
 * 
 */

#ifndef OAIAccountFindingsMetric_closedFindings_H
#define OAIAccountFindingsMetric_closedFindings_H
...
class OAIAccountFindingsMetric_closedFindings : public OAIObject {
public:
    OAIAccountFindingsMetric_closedFindings();
    OAIAccountFindingsMetric_closedFindings(QString json);
    ~OAIAccountFindingsMetric_closedFindings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountFindingsMetric_closedFindings)

#endif // OAIAccountFindingsMetric_closedFindings_H
