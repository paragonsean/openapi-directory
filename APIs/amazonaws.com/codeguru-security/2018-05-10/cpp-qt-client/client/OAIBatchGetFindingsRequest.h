...
/*
 * OAIBatchGetFindingsRequest.h
 *
 * 
 */

#ifndef OAIBatchGetFindingsRequest_H
#define OAIBatchGetFindingsRequest_H
...
class OAIBatchGetFindingsRequest : public OAIObject {
public:
    OAIBatchGetFindingsRequest();
    OAIBatchGetFindingsRequest(QString json);
    ~OAIBatchGetFindingsRequest() override;
    ...
    QList getFindingIdentifiers() const;
    void setFindingIdentifiers(const QList &finding_identifiers);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetFindingsRequest)

#endif // OAIBatchGetFindingsRequest_H
