...
#include "OAIFindingMetricsValuePerSeverity.h"
...
OAIFindingMetricsValuePerSeverity::OAIFindingMetricsValuePerSeverity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFindingMetricsValuePerSeverity::OAIFindingMetricsValuePerSeverity() {
    this->initializeModel();
}

OAIFindingMetricsValuePerSeverity::~OAIFindingMetricsValuePerSeverity() {}

void OAIFindingMetricsValuePerSeverity::initializeModel() {
...
void OAIFindingMetricsValuePerSeverity::fromJson(QString jsonString) {
...
void OAIFindingMetricsValuePerSeverity::fromJsonObject(QJsonObject json) {
...
QString OAIFindingMetricsValuePerSeverity::asJson() const {
...
QJsonObject OAIFindingMetricsValuePerSeverity::asJsonObject() const {
    QJsonObject obj;
    if (m_critical_isSet) {
...
double OAIFindingMetricsValuePerSeverity::getCritical() const {
    return m_critical;
}
void OAIFindingMetricsValuePerSeverity::setCritical(const double &critical) {
    m_critical = critical;
    m_critical_isSet = true;
}

bool OAIFindingMetricsValuePerSeverity::is_critical_Set() const{
    return m_critical_isSet;
}

bool OAIFindingMetricsValuePerSeverity::is_critical_Valid() const{
    return m_critical_isValid;
}

double OAIFindingMetricsValuePerSeverity::getHigh() const {
    return m_high;
}
void OAIFindingMetricsValuePerSeverity::setHigh(const double &high) {
    m_high = high;
    m_high_isSet = true;
}

bool OAIFindingMetricsValuePerSeverity::is_high_Set() const{
    return m_high_isSet;
}

bool OAIFindingMetricsValuePerSeverity::is_high_Valid() const{
    return m_high_isValid;
}

double OAIFindingMetricsValuePerSeverity::getInfo() const {
    return m_info;
}
void OAIFindingMetricsValuePerSeverity::setInfo(const double &info) {
    m_info = info;
    m_info_isSet = true;
}

bool OAIFindingMetricsValuePerSeverity::is_info_Set() const{
    return m_info_isSet;
}

bool OAIFindingMetricsValuePerSeverity::is_info_Valid() const{
    return m_info_isValid;
}

double OAIFindingMetricsValuePerSeverity::getLow() const {
    return m_low;
}
void OAIFindingMetricsValuePerSeverity::setLow(const double &low) {
    m_low = low;
    m_low_isSet = true;
}

bool OAIFindingMetricsValuePerSeverity::is_low_Set() const{
    return m_low_isSet;
}

bool OAIFindingMetricsValuePerSeverity::is_low_Valid() const{
    return m_low_isValid;
}

double OAIFindingMetricsValuePerSeverity::getMedium() const {
    return m_medium;
}
void OAIFindingMetricsValuePerSeverity::setMedium(const double &medium) {
    m_medium = medium;
    m_medium_isSet = true;
}

bool OAIFindingMetricsValuePerSeverity::is_medium_Set() const{
    return m_medium_isSet;
}

bool OAIFindingMetricsValuePerSeverity::is_medium_Valid() const{
    return m_medium_isValid;
}

bool OAIFindingMetricsValuePerSeverity::isSet() const {
...
bool OAIFindingMetricsValuePerSeverity::isValid() const {
