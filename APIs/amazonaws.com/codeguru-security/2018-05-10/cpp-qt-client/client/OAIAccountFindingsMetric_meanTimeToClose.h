...
/*
 * OAIAccountFindingsMetric_meanTimeToClose.h
 *
 * 
 */

#ifndef OAIAccountFindingsMetric_meanTimeToClose_H
#define OAIAccountFindingsMetric_meanTimeToClose_H
...
class OAIAccountFindingsMetric_meanTimeToClose : public OAIObject {
public:
    OAIAccountFindingsMetric_meanTimeToClose();
    OAIAccountFindingsMetric_meanTimeToClose(QString json);
    ~OAIAccountFindingsMetric_meanTimeToClose() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountFindingsMetric_meanTimeToClose)

#endif // OAIAccountFindingsMetric_meanTimeToClose_H
