...
class Example : public QObject {
    Q_OBJECT
    OAIBatchGetFindings_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAIBatchGetFindings_request Example::create(){
    OAIBatchGetFindings_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::batchGetFindingsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::batchGetFindingsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIBatchGetFindings_request oai_batch_get_findings_request = create(); // OAIBatchGetFindings_request | 
      ...
      apiInstance.batchGetFindings(oai_batch_get_findings_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
