...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.AccountFindingsMetricMeanTimeToClose();
  });
  ...
  describe('AccountFindingsMetricMeanTimeToClose', function() {
    it('should create an instance of AccountFindingsMetricMeanTimeToClose', function() {
      // uncomment below and update the code to test AccountFindingsMetricMeanTimeToClose
      //var instance = new AmazonCodeGuruSecurity.AccountFindingsMetricMeanTimeToClose();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.AccountFindingsMetricMeanTimeToClose);
    });
