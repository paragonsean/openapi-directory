...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.ResourceId();
  });
  ...
  describe('ResourceId', function() {
    it('should create an instance of ResourceId', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.ResourceId();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ResourceId);
    });
