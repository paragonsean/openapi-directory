...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.EncryptionConfig();
  });
  ...
  describe('EncryptionConfig', function() {
    it('should create an instance of EncryptionConfig', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.EncryptionConfig();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.EncryptionConfig);
    });
