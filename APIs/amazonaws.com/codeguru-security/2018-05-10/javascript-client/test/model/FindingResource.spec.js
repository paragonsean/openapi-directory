...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.FindingResource();
  });
  ...
  describe('FindingResource', function() {
    it('should create an instance of FindingResource', function() {
      // uncomment below and update the code to test FindingResource
      //var instance = new AmazonCodeGuruSecurity.FindingResource();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.FindingResource);
    });
