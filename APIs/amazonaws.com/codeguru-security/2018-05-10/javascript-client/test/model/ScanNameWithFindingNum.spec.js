...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.ScanNameWithFindingNum();
  });
  ...
  describe('ScanNameWithFindingNum', function() {
    it('should create an instance of ScanNameWithFindingNum', function() {
      // uncomment below and update the code to test ScanNameWithFindingNum
      //var instance = new AmazonCodeGuruSecurity.ScanNameWithFindingNum();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ScanNameWithFindingNum);
    });
