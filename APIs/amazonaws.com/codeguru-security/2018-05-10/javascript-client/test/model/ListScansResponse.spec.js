...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.ListScansResponse();
  });
  ...
  describe('ListScansResponse', function() {
    it('should create an instance of ListScansResponse', function() {
      // uncomment below and update the code to test ListScansResponse
      //var instance = new AmazonCodeGuruSecurity.ListScansResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ListScansResponse);
    });
