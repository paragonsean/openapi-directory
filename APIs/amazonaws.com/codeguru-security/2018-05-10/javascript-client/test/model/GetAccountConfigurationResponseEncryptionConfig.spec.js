...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.GetAccountConfigurationResponseEncryptionConfig();
  });
  ...
  describe('GetAccountConfigurationResponseEncryptionConfig', function() {
    it('should create an instance of GetAccountConfigurationResponseEncryptionConfig', function() {
      // uncomment below and update the code to test GetAccountConfigurationResponseEncryptionConfig
      //var instance = new AmazonCodeGuruSecurity.GetAccountConfigurationResponseEncryptionConfig();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.GetAccountConfigurationResponseEncryptionConfig);
    });
