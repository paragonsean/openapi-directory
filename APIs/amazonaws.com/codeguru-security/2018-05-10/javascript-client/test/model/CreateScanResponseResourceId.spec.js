...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.CreateScanResponseResourceId();
  });
  ...
  describe('CreateScanResponseResourceId', function() {
    it('should create an instance of CreateScanResponseResourceId', function() {
      // uncomment below and update the code to test CreateScanResponseResourceId
      //var instance = new AmazonCodeGuruSecurity.CreateScanResponseResourceId();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.CreateScanResponseResourceId);
    });
