...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.FindingMetricsValuePerSeverity();
  });
  ...
  describe('FindingMetricsValuePerSeverity', function() {
    it('should create an instance of FindingMetricsValuePerSeverity', function() {
      // uncomment below and update the code to test FindingMetricsValuePerSeverity
      //var instance = new AmazonCodeGuruSecurity.FindingMetricsValuePerSeverity();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.FindingMetricsValuePerSeverity);
    });
