...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.ListFindingsMetricsResponse();
  });
  ...
  describe('ListFindingsMetricsResponse', function() {
    it('should create an instance of ListFindingsMetricsResponse', function() {
      // uncomment below and update the code to test ListFindingsMetricsResponse
      //var instance = new AmazonCodeGuruSecurity.ListFindingsMetricsResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ListFindingsMetricsResponse);
    });

    it('should have the property findingsMetrics (base name: "findingsMetrics")', function() {
      // uncomment below and update the code to test the property findingsMetrics
      //var instance = new AmazonCodeGuruSecurity.ListFindingsMetricsResponse();
