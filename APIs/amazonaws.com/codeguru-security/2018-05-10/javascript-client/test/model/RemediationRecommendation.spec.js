...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.RemediationRecommendation();
  });
  ...
  describe('RemediationRecommendation', function() {
    it('should create an instance of RemediationRecommendation', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.RemediationRecommendation();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.RemediationRecommendation);
    });
