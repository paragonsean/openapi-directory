...
(function(root, factory) {
  ...
  describe('ScanType', function() {
    it('should create an instance of ScanType', function() {
      // uncomment below and update the code to test ScanType
      //var instance = new AmazonCodeGuruSecurity.ScanType();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ScanType);
    });
