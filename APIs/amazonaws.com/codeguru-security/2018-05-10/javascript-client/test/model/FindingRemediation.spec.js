...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.FindingRemediation();
  });
  ...
  describe('FindingRemediation', function() {
    it('should create an instance of FindingRemediation', function() {
      // uncomment below and update the code to test FindingRemediation
      //var instance = new AmazonCodeGuruSecurity.FindingRemediation();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.FindingRemediation);
    });
