...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.FilePath();
  });
  ...
  describe('FilePath', function() {
    it('should create an instance of FilePath', function() {
      // uncomment below and update the code to test FilePath
      //var instance = new AmazonCodeGuruSecurity.FilePath();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.FilePath);
    });
