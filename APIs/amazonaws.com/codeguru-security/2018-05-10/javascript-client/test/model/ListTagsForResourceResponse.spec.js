...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ListTagsForResourceResponse);
    });
