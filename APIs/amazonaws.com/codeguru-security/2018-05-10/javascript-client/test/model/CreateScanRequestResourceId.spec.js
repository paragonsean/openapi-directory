...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.CreateScanRequestResourceId();
  });
  ...
  describe('CreateScanRequestResourceId', function() {
    it('should create an instance of CreateScanRequestResourceId', function() {
      // uncomment below and update the code to test CreateScanRequestResourceId
      //var instance = new AmazonCodeGuruSecurity.CreateScanRequestResourceId();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.CreateScanRequestResourceId);
    });
