...
(function(root, factory) {
  ...
  describe('ScanState', function() {
    it('should create an instance of ScanState', function() {
      // uncomment below and update the code to test ScanState
      //var instance = new AmazonCodeGuruSecurity.ScanState();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ScanState);
    });
