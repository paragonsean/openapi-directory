...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.MetricsSummaryOpenFindings();
  });
  ...
  describe('MetricsSummaryOpenFindings', function() {
    it('should create an instance of MetricsSummaryOpenFindings', function() {
      // uncomment below and update the code to test MetricsSummaryOpenFindings
      //var instance = new AmazonCodeGuruSecurity.MetricsSummaryOpenFindings();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.MetricsSummaryOpenFindings);
    });
