...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.TagResourceRequest();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.TagResourceRequest);
    });
