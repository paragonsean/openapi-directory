...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationRequestEncryptionConfig();
  });
  ...
  describe('UpdateAccountConfigurationRequestEncryptionConfig', function() {
    it('should create an instance of UpdateAccountConfigurationRequestEncryptionConfig', function() {
      // uncomment below and update the code to test UpdateAccountConfigurationRequestEncryptionConfig
      //var instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationRequestEncryptionConfig();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.UpdateAccountConfigurationRequestEncryptionConfig);
    });
