...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.FindingIdentifier();
  });
  ...
  describe('FindingIdentifier', function() {
    it('should create an instance of FindingIdentifier', function() {
      // uncomment below and update the code to test FindingIdentifier
      //var instance = new AmazonCodeGuruSecurity.FindingIdentifier();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.FindingIdentifier);
    });
