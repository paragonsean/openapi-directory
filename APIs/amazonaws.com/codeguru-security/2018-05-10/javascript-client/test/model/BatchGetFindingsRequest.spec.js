...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.BatchGetFindingsRequest();
  });
  ...
  describe('BatchGetFindingsRequest', function() {
    it('should create an instance of BatchGetFindingsRequest', function() {
      // uncomment below and update the code to test BatchGetFindingsRequest
      //var instance = new AmazonCodeGuruSecurity.BatchGetFindingsRequest();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.BatchGetFindingsRequest);
    });

    it('should have the property findingIdentifiers (base name: "findingIdentifiers")', function() {
      // uncomment below and update the code to test the property findingIdentifiers
      //var instance = new AmazonCodeGuruSecurity.BatchGetFindingsRequest();
