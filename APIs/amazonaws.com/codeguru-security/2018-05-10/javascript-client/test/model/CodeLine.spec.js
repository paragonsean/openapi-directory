...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.CodeLine();
  });
  ...
  describe('CodeLine', function() {
    it('should create an instance of CodeLine', function() {
      // uncomment below and update the code to test CodeLine
      //var instance = new AmazonCodeGuruSecurity.CodeLine();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.CodeLine);
    });
