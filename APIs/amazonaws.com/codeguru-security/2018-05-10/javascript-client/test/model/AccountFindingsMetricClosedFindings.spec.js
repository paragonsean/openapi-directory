...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.AccountFindingsMetricClosedFindings();
  });
  ...
  describe('AccountFindingsMetricClosedFindings', function() {
    it('should create an instance of AccountFindingsMetricClosedFindings', function() {
      // uncomment below and update the code to test AccountFindingsMetricClosedFindings
      //var instance = new AmazonCodeGuruSecurity.AccountFindingsMetricClosedFindings();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.AccountFindingsMetricClosedFindings);
    });
