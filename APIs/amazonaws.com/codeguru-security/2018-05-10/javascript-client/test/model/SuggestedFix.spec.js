...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.SuggestedFix();
  });
  ...
  describe('SuggestedFix', function() {
    it('should create an instance of SuggestedFix', function() {
      // uncomment below and update the code to test SuggestedFix
      //var instance = new AmazonCodeGuruSecurity.SuggestedFix();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.SuggestedFix);
    });
