...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.Recommendation();
  });
  ...
  describe('Recommendation', function() {
    it('should create an instance of Recommendation', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.Recommendation();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.Recommendation);
    });
