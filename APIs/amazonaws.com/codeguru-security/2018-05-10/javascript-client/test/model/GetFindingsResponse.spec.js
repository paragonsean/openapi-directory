...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.GetFindingsResponse();
  });
  ...
  describe('GetFindingsResponse', function() {
    it('should create an instance of GetFindingsResponse', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.GetFindingsResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.GetFindingsResponse);
    });
