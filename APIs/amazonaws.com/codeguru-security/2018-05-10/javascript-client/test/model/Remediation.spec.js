...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.Remediation();
  });
  ...
  describe('Remediation', function() {
    it('should create an instance of Remediation', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.Remediation();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.Remediation);
    });
