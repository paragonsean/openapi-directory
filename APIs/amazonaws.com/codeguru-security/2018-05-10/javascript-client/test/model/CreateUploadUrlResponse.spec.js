...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.CreateUploadUrlResponse();
  });
  ...
  describe('CreateUploadUrlResponse', function() {
    it('should create an instance of CreateUploadUrlResponse', function() {
      // uncomment below and update the code to test CreateUploadUrlResponse
      //var instance = new AmazonCodeGuruSecurity.CreateUploadUrlResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.CreateUploadUrlResponse);
    });

    it('should have the property codeArtifactId (base name: "codeArtifactId")', function() {
      // uncomment below and update the code to test the property codeArtifactId
      //var instance = new AmazonCodeGuruSecurity.CreateUploadUrlResponse();
