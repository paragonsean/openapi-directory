...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.GetScanResponse();
  });
  ...
  describe('GetScanResponse', function() {
    it('should create an instance of GetScanResponse', function() {
      // uncomment below and update the code to test GetScanResponse
      //var instance = new AmazonCodeGuruSecurity.GetScanResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.GetScanResponse);
    });
    ...
    it('should have the property numberOfRevisions (base name: "numberOfRevisions")', function() {
      // uncomment below and update the code to test the property numberOfRevisions
      //var instance = new AmazonCodeGuruSecurity.GetScanResponse();
      //expect(instance).to.be();
    });
