...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationResponseEncryptionConfig();
  });
  ...
  describe('UpdateAccountConfigurationResponseEncryptionConfig', function() {
    it('should create an instance of UpdateAccountConfigurationResponseEncryptionConfig', function() {
      // uncomment below and update the code to test UpdateAccountConfigurationResponseEncryptionConfig
      //var instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationResponseEncryptionConfig();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.UpdateAccountConfigurationResponseEncryptionConfig);
    });
