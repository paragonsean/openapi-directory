...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.BatchGetFindingsResponse();
  });
  ...
  describe('BatchGetFindingsResponse', function() {
    it('should create an instance of BatchGetFindingsResponse', function() {
      // uncomment below and update the code to test BatchGetFindingsResponse
      //var instance = new AmazonCodeGuruSecurity.BatchGetFindingsResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.BatchGetFindingsResponse);
    });

    it('should have the property failedFindings (base name: "failedFindings")', function() {
      // uncomment below and update the code to test the property failedFindings
      //var instance = new AmazonCodeGuruSecurity.BatchGetFindingsResponse();
