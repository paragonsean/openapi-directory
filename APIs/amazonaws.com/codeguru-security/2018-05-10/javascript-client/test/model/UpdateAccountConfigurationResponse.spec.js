...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationResponse();
  });
  ...
  describe('UpdateAccountConfigurationResponse', function() {
    it('should create an instance of UpdateAccountConfigurationResponse', function() {
      // uncomment below and update the code to test UpdateAccountConfigurationResponse
      //var instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.UpdateAccountConfigurationResponse);
    });
