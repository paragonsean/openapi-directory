...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.GetAccountConfigurationResponse();
  });
  ...
  describe('GetAccountConfigurationResponse', function() {
    it('should create an instance of GetAccountConfigurationResponse', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.GetAccountConfigurationResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.GetAccountConfigurationResponse);
    });
