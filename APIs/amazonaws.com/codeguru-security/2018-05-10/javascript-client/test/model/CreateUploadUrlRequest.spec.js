...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.CreateUploadUrlRequest();
  });
  ...
  describe('CreateUploadUrlRequest', function() {
    it('should create an instance of CreateUploadUrlRequest', function() {
      // uncomment below and update the code to test CreateUploadUrlRequest
      //var instance = new AmazonCodeGuruSecurity.CreateUploadUrlRequest();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.CreateUploadUrlRequest);
    });
