...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.CategoryWithFindingNum();
  });
  ...
  describe('CategoryWithFindingNum', function() {
    it('should create an instance of CategoryWithFindingNum', function() {
      // uncomment below and update the code to test CategoryWithFindingNum
      //var instance = new AmazonCodeGuruSecurity.CategoryWithFindingNum();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.CategoryWithFindingNum);
    });
    ...
    it('should have the property findingNumber (base name: "findingNumber")', function() {
      // uncomment below and update the code to test the property findingNumber
      //var instance = new AmazonCodeGuruSecurity.CategoryWithFindingNum();
      //expect(instance).to.be();
    });
