...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.ScanSummary();
  });
  ...
  describe('ScanSummary', function() {
    it('should create an instance of ScanSummary', function() {
      // uncomment below and update the code to test ScanSummary
      //var instance = new AmazonCodeGuruSecurity.ScanSummary();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.ScanSummary);
    });
