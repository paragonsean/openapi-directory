...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationRequest();
  });
  ...
  describe('UpdateAccountConfigurationRequest', function() {
    it('should create an instance of UpdateAccountConfigurationRequest', function() {
      ...
      //var instance = new AmazonCodeGuruSecurity.UpdateAccountConfigurationRequest();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.UpdateAccountConfigurationRequest);
    });
