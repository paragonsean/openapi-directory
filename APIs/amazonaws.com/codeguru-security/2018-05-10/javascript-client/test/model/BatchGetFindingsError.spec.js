...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.BatchGetFindingsError();
  });
  ...
  describe('BatchGetFindingsError', function() {
    it('should create an instance of BatchGetFindingsError', function() {
      // uncomment below and update the code to test BatchGetFindingsError
      //var instance = new AmazonCodeGuruSecurity.BatchGetFindingsError();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.BatchGetFindingsError);
    });
