...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.AccountFindingsMetricNewFindings();
  });
  ...
  describe('AccountFindingsMetricNewFindings', function() {
    it('should create an instance of AccountFindingsMetricNewFindings', function() {
      // uncomment below and update the code to test AccountFindingsMetricNewFindings
      //var instance = new AmazonCodeGuruSecurity.AccountFindingsMetricNewFindings();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.AccountFindingsMetricNewFindings);
    });
