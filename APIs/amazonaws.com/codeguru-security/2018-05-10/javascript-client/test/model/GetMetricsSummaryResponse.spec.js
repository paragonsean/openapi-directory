...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCodeGuruSecurity.GetMetricsSummaryResponse();
  });
  ...
  describe('GetMetricsSummaryResponse', function() {
    it('should create an instance of GetMetricsSummaryResponse', function() {
      // uncomment below and update the code to test GetMetricsSummaryResponse
      //var instance = new AmazonCodeGuruSecurity.GetMetricsSummaryResponse();
      //expect(instance).to.be.a(AmazonCodeGuruSecurity.GetMetricsSummaryResponse);
    });
