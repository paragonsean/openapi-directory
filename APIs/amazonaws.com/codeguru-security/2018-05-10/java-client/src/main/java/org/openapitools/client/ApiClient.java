...
public class ApiClient {
    ...
    private String basePath = "http://codeguru-security.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://codeguru-security.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://codeguru-security.{region}.amazonaws.com",
      "The Amazon CodeGuru Security multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://codeguru-security.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://codeguru-security.{region}.amazonaws.com.cn",
      "The Amazon CodeGuru Security endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-05-10/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://codeguru-security.us-east-1.amazonaws.com
