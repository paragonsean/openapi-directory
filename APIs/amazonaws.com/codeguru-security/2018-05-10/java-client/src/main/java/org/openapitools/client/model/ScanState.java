...
/**
 * Gets or Sets ScanState
 */
@JsonAdapter(ScanState.Adapter.class)
public enum ScanState {
  ...
  public static ScanState fromValue(String value) {
    for (ScanState b : ScanState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScanState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScanState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScanState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScanState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ScanState.fromValue(value);
  }
}
