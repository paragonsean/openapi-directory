...
public class CreateRouteResponseUriPathRoute {
  ...
  public CreateRouteResponseUriPathRoute() {
  }

  public CreateRouteResponseUriPathRoute activationState(RouteActivationState activationState) {
  ...
  public CreateRouteResponseUriPathRoute appendSourcePath(Boolean appendSourcePath) {
  ...
  public CreateRouteResponseUriPathRoute includeChildPaths(Boolean includeChildPaths) {
  ...
  public CreateRouteResponseUriPathRoute methods(List methods) {
  ...
  public CreateRouteResponseUriPathRoute sourcePath(String sourcePath) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRouteResponseUriPathRoute createRouteResponseUriPathRoute = (CreateRouteResponseUriPathRoute) o;
    return Objects.equals(this.activationState, createRouteResponseUriPathRoute.activationState) &&
        Objects.equals(this.appendSourcePath, createRouteResponseUriPathRoute.appendSourcePath) &&
        Objects.equals(this.includeChildPaths, createRouteResponseUriPathRoute.includeChildPaths) &&
        Objects.equals(this.methods, createRouteResponseUriPathRoute.methods) &&
        Objects.equals(this.sourcePath, createRouteResponseUriPathRoute.sourcePath);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRouteResponseUriPathRoute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRouteResponseUriPathRoute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRouteResponseUriPathRoute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRouteResponseUriPathRoute is not found in the empty JSON string", CreateRouteResponseUriPathRoute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRouteResponseUriPathRoute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRouteResponseUriPathRoute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateRouteResponseUriPathRoute.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRouteResponseUriPathRoute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRouteResponseUriPathRoute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRouteResponseUriPathRoute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRouteResponseUriPathRoute.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRouteResponseUriPathRoute>() {
           @Override
           public void write(JsonWriter out, CreateRouteResponseUriPathRoute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRouteResponseUriPathRoute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRouteResponseUriPathRoute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRouteResponseUriPathRoute
   * @throws IOException if the JSON string is invalid with respect to CreateRouteResponseUriPathRoute
   */
  public static CreateRouteResponseUriPathRoute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRouteResponseUriPathRoute.class);
  }

  /**
   * Convert an instance of CreateRouteResponseUriPathRoute to an JSON string
   *
   * @return JSON string
   */
