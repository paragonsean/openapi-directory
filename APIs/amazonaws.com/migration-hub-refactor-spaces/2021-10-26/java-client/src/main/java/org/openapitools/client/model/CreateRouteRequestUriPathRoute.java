...
public class CreateRouteRequestUriPathRoute {
  ...
  public CreateRouteRequestUriPathRoute() {
  }

  public CreateRouteRequestUriPathRoute activationState(RouteActivationState activationState) {
  ...
  public CreateRouteRequestUriPathRoute appendSourcePath(Boolean appendSourcePath) {
  ...
  public CreateRouteRequestUriPathRoute includeChildPaths(Boolean includeChildPaths) {
  ...
  public CreateRouteRequestUriPathRoute methods(List methods) {
  ...
  public CreateRouteRequestUriPathRoute sourcePath(String sourcePath) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRouteRequestUriPathRoute createRouteRequestUriPathRoute = (CreateRouteRequestUriPathRoute) o;
    return Objects.equals(this.activationState, createRouteRequestUriPathRoute.activationState) &&
        Objects.equals(this.appendSourcePath, createRouteRequestUriPathRoute.appendSourcePath) &&
        Objects.equals(this.includeChildPaths, createRouteRequestUriPathRoute.includeChildPaths) &&
        Objects.equals(this.methods, createRouteRequestUriPathRoute.methods) &&
        Objects.equals(this.sourcePath, createRouteRequestUriPathRoute.sourcePath);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRouteRequestUriPathRoute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRouteRequestUriPathRoute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRouteRequestUriPathRoute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRouteRequestUriPathRoute is not found in the empty JSON string", CreateRouteRequestUriPathRoute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRouteRequestUriPathRoute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRouteRequestUriPathRoute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateRouteRequestUriPathRoute.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRouteRequestUriPathRoute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRouteRequestUriPathRoute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRouteRequestUriPathRoute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRouteRequestUriPathRoute.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRouteRequestUriPathRoute>() {
           @Override
           public void write(JsonWriter out, CreateRouteRequestUriPathRoute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRouteRequestUriPathRoute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRouteRequestUriPathRoute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRouteRequestUriPathRoute
   * @throws IOException if the JSON string is invalid with respect to CreateRouteRequestUriPathRoute
   */
  public static CreateRouteRequestUriPathRoute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRouteRequestUriPathRoute.class);
  }

  /**
   * Convert an instance of CreateRouteRequestUriPathRoute to an JSON string
   *
   * @return JSON string
   */
