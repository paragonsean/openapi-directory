...
public class GetApplicationResponseApiGatewayProxy {
  ...
  public GetApplicationResponseApiGatewayProxy() {
  }

  public GetApplicationResponseApiGatewayProxy apiGatewayId(String apiGatewayId) {
  ...
  public GetApplicationResponseApiGatewayProxy endpointType(ApiGatewayEndpointType endpointType) {
  ...
  public GetApplicationResponseApiGatewayProxy nlbArn(String nlbArn) {
    this.nlbArn = nlbArn;
    return this;
  }
  ...
  public GetApplicationResponseApiGatewayProxy nlbName(String nlbName) {
  ...
  public GetApplicationResponseApiGatewayProxy proxyUrl(String proxyUrl) {
  ...
  public GetApplicationResponseApiGatewayProxy stageName(String stageName) {
  ...
  public GetApplicationResponseApiGatewayProxy vpcLinkId(String vpcLinkId) {
  ...
  public boolean equals(Object o) {
    ...
    GetApplicationResponseApiGatewayProxy getApplicationResponseApiGatewayProxy = (GetApplicationResponseApiGatewayProxy) o;
    return Objects.equals(this.apiGatewayId, getApplicationResponseApiGatewayProxy.apiGatewayId) &&
        Objects.equals(this.endpointType, getApplicationResponseApiGatewayProxy.endpointType) &&
        Objects.equals(this.nlbArn, getApplicationResponseApiGatewayProxy.nlbArn) &&
        Objects.equals(this.nlbName, getApplicationResponseApiGatewayProxy.nlbName) &&
        Objects.equals(this.proxyUrl, getApplicationResponseApiGatewayProxy.proxyUrl) &&
        Objects.equals(this.stageName, getApplicationResponseApiGatewayProxy.stageName) &&
        Objects.equals(this.vpcLinkId, getApplicationResponseApiGatewayProxy.vpcLinkId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetApplicationResponseApiGatewayProxy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetApplicationResponseApiGatewayProxy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetApplicationResponseApiGatewayProxy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetApplicationResponseApiGatewayProxy is not found in the empty JSON string", GetApplicationResponseApiGatewayProxy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetApplicationResponseApiGatewayProxy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetApplicationResponseApiGatewayProxy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetApplicationResponseApiGatewayProxy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetApplicationResponseApiGatewayProxy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetApplicationResponseApiGatewayProxy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetApplicationResponseApiGatewayProxy.class));

       return (TypeAdapter<T>) new TypeAdapter<GetApplicationResponseApiGatewayProxy>() {
           @Override
           public void write(JsonWriter out, GetApplicationResponseApiGatewayProxy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetApplicationResponseApiGatewayProxy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetApplicationResponseApiGatewayProxy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetApplicationResponseApiGatewayProxy
   * @throws IOException if the JSON string is invalid with respect to GetApplicationResponseApiGatewayProxy
   */
  public static GetApplicationResponseApiGatewayProxy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetApplicationResponseApiGatewayProxy.class);
  }

  /**
   * Convert an instance of GetApplicationResponseApiGatewayProxy to an JSON string
   *
   * @return JSON string
   */
