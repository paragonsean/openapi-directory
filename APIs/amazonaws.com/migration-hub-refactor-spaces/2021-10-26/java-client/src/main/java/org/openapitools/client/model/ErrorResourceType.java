...
/**
 * Gets or Sets ErrorResourceType
 */
@JsonAdapter(ErrorResourceType.Adapter.class)
public enum ErrorResourceType {
  ...
  ErrorResourceType(String value) {
    this.value = value;
  }
  ...
  public static ErrorResourceType fromValue(String value) {
    for (ErrorResourceType b : ErrorResourceType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ErrorResourceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ErrorResourceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ErrorResourceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ErrorResourceType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ErrorResourceType.fromValue(value);
  }
}
