...
public class ApiGatewayProxySummary {
  ...
  public ApiGatewayProxySummary() {
  }

  public ApiGatewayProxySummary apiGatewayId(String apiGatewayId) {
  ...
  public ApiGatewayProxySummary endpointType(ApiGatewayEndpointType endpointType) {
  ...
  public ApiGatewayProxySummary nlbArn(String nlbArn) {
    this.nlbArn = nlbArn;
    return this;
  }
  ...
  public ApiGatewayProxySummary nlbName(String nlbName) {
  ...
  public ApiGatewayProxySummary proxyUrl(String proxyUrl) {
  ...
  public ApiGatewayProxySummary stageName(String stageName) {
  ...
  public ApiGatewayProxySummary vpcLinkId(String vpcLinkId) {
  ...
  public boolean equals(Object o) {
    ...
    ApiGatewayProxySummary apiGatewayProxySummary = (ApiGatewayProxySummary) o;
    return Objects.equals(this.apiGatewayId, apiGatewayProxySummary.apiGatewayId) &&
        Objects.equals(this.endpointType, apiGatewayProxySummary.endpointType) &&
        Objects.equals(this.nlbArn, apiGatewayProxySummary.nlbArn) &&
        Objects.equals(this.nlbName, apiGatewayProxySummary.nlbName) &&
        Objects.equals(this.proxyUrl, apiGatewayProxySummary.proxyUrl) &&
        Objects.equals(this.stageName, apiGatewayProxySummary.stageName) &&
        Objects.equals(this.vpcLinkId, apiGatewayProxySummary.vpcLinkId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiGatewayProxySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiGatewayProxySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiGatewayProxySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiGatewayProxySummary is not found in the empty JSON string", ApiGatewayProxySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiGatewayProxySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiGatewayProxySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiGatewayProxySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiGatewayProxySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiGatewayProxySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiGatewayProxySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiGatewayProxySummary>() {
           @Override
           public void write(JsonWriter out, ApiGatewayProxySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiGatewayProxySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiGatewayProxySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiGatewayProxySummary
   * @throws IOException if the JSON string is invalid with respect to ApiGatewayProxySummary
   */
  public static ApiGatewayProxySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiGatewayProxySummary.class);
  }

  /**
   * Convert an instance of ApiGatewayProxySummary to an JSON string
   *
   * @return JSON string
   */
