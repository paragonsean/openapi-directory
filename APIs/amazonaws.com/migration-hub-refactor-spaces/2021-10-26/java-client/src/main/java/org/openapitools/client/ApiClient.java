...
public class ApiClient {
    ...
    private String basePath = "http://refactor-spaces.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://refactor-spaces.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://refactor-spaces.{region}.amazonaws.com",
      "The AWS Migration Hub Refactor Spaces multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://refactor-spaces.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://refactor-spaces.{region}.amazonaws.com.cn",
      "The AWS Migration Hub Refactor Spaces endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-10-26/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://refactor-spaces.us-east-1.amazonaws.com
