...
async def test_create_application(client):
    ...
    """
    body = {"VpcId":"","ApiGatewayProxy":{"StageName":"","EndpointType":""},"ProxyType":"","ClientToken":"","Tags":"","Name":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/environments/{environment_identifier}/applications'.format(environment_identifier='environment_identifier_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_environment(client):
    ...
    """
    body = {"Description":"","NetworkFabricType":"","ClientToken":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_route(client):
    ...
    """
    body = {"UriPathRoute":{"SourcePath":"","AppendSourcePath":"","ActivationState":"","Methods":"","IncludeChildPaths":""},"RouteType":"","DefaultRoute":{"ActivationState":""},"ServiceIdentifier":"","ClientToken":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/environments/{environment_identifier}/applications/{application_identifier}/routes'.format(application_identifier='application_identifier_example', environment_identifier='environment_identifier_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_service(client):
    ...
    """
    body = {"LambdaEndpoint":{"Arn":""},"UrlEndpoint":{"HealthUrl":"","Url":""},"Description":"","VpcId":"","EndpointType":"","ClientToken":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/environments/{environment_identifier}/applications/{application_identifier}/services'.format(application_identifier='application_identifier_example', environment_identifier='environment_identifier_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_application(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/environments/{environment_identifier}/applications/{application_identifier}'.format(application_identifier='application_identifier_example', environment_identifier='environment_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_environment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/environments/{environment_identifier}'.format(environment_identifier='environment_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_resource_policy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/resourcepolicy/{identifier}'.format(identifier='identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_route(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/environments/{environment_identifier}/applications/{application_identifier}/routes/{route_identifier}'.format(application_identifier='application_identifier_example', environment_identifier='environment_identifier_example', route_identifier='route_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_service(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/environments/{environment_identifier}/applications/{application_identifier}/services/{service_identifier}'.format(application_identifier='application_identifier_example', environment_identifier='environment_identifier_example', service_identifier='service_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_resource_policy(client):
    """Test case for get_resource_policy
...
async def test_list_environment_vpcs(client):
    """Test case for list_environment_vpcs
    ...
    response = await client.request(
        method='GET',
        path='/environments/{environment_identifier}/vpcs'.format(environment_identifier='environment_identifier_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
