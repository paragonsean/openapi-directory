...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://refactor-spaces.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://refactor-spaces.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-10-26/Javascript'
        };
    ...
    hostSettings() {
        return [
            ...
            },
            {
              ...
              'description': "The AWS Migration Hub Refactor Spaces endpoint for China (Beijing) and China (Ningxia)",
              'variables': {
                region: {
                    'description': "The AWS region",
