...
* @readonly
*/
export default class NetworkFabricType {
    ...
    /**
    * Returns a <code>NetworkFabricType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NetworkFabricType} The enum <code>NetworkFabricType</code> value.
    */
