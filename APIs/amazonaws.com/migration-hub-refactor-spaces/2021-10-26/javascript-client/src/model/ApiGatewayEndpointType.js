...
* @readonly
*/
export default class ApiGatewayEndpointType {
    ...
    /**
    * Returns a <code>ApiGatewayEndpointType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ApiGatewayEndpointType} The enum <code>ApiGatewayEndpointType</code> value.
    */
