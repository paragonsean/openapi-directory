...
* @readonly
*/
export default class RouteActivationState {
    ...
    /**
    * Returns a <code>RouteActivationState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RouteActivationState} The enum <code>RouteActivationState</code> value.
    */
