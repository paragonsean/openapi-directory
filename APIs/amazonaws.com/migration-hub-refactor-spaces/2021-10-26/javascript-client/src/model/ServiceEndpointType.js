...
* @readonly
*/
export default class ServiceEndpointType {
    ...
    /**
    * Returns a <code>ServiceEndpointType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ServiceEndpointType} The enum <code>ServiceEndpointType</code> value.
    */
