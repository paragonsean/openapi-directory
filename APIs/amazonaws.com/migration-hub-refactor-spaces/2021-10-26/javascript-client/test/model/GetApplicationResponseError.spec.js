...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.GetApplicationResponseError();
  });
  ...
  describe('GetApplicationResponseError', function() {
    it('should create an instance of GetApplicationResponseError', function() {
      // uncomment below and update the code to test GetApplicationResponseError
      //var instance = new AwsMigrationHubRefactorSpaces.GetApplicationResponseError();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.GetApplicationResponseError);
    });
