...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.LambdaEndpointSummary();
  });
  ...
  describe('LambdaEndpointSummary', function() {
    it('should create an instance of LambdaEndpointSummary', function() {
      // uncomment below and update the code to test LambdaEndpointSummary
      //var instance = new AwsMigrationHubRefactorSpaces.LambdaEndpointSummary();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.LambdaEndpointSummary);
    });
