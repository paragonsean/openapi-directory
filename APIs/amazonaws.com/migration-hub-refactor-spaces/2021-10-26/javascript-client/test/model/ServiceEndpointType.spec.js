...
(function(root, factory) {
  ...
  describe('ServiceEndpointType', function() {
    it('should create an instance of ServiceEndpointType', function() {
      // uncomment below and update the code to test ServiceEndpointType
      //var instance = new AwsMigrationHubRefactorSpaces.ServiceEndpointType();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ServiceEndpointType);
    });
