...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.UpdateRouteResponse();
  });
  ...
  describe('UpdateRouteResponse', function() {
    it('should create an instance of UpdateRouteResponse', function() {
      // uncomment below and update the code to test UpdateRouteResponse
      //var instance = new AwsMigrationHubRefactorSpaces.UpdateRouteResponse();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.UpdateRouteResponse);
    });
