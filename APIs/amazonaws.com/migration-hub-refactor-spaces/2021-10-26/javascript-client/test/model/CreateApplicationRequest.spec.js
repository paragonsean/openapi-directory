...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.CreateApplicationRequest();
  });
  ...
  describe('CreateApplicationRequest', function() {
    it('should create an instance of CreateApplicationRequest', function() {
      ...
      //var instance = new AwsMigrationHubRefactorSpaces.CreateApplicationRequest();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.CreateApplicationRequest);
    });
