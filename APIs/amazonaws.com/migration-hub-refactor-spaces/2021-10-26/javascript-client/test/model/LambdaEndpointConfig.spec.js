...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.LambdaEndpointConfig();
  });
  ...
  describe('LambdaEndpointConfig', function() {
    it('should create an instance of LambdaEndpointConfig', function() {
      // uncomment below and update the code to test LambdaEndpointConfig
      //var instance = new AwsMigrationHubRefactorSpaces.LambdaEndpointConfig();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.LambdaEndpointConfig);
    });
