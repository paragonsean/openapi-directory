...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.GetServiceResponseLambdaEndpoint();
  });
  ...
  describe('GetServiceResponseLambdaEndpoint', function() {
    it('should create an instance of GetServiceResponseLambdaEndpoint', function() {
      // uncomment below and update the code to test GetServiceResponseLambdaEndpoint
      //var instance = new AwsMigrationHubRefactorSpaces.GetServiceResponseLambdaEndpoint();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.GetServiceResponseLambdaEndpoint);
    });
