...
(function(root, factory) {
  ...
  describe('RouteState', function() {
    it('should create an instance of RouteState', function() {
      // uncomment below and update the code to test RouteState
      //var instance = new AwsMigrationHubRefactorSpaces.RouteState();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.RouteState);
    });
