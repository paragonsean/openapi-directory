...
(function(root, factory) {
  ...
  describe('RouteActivationState', function() {
    it('should create an instance of RouteActivationState', function() {
      // uncomment below and update the code to test RouteActivationState
      //var instance = new AwsMigrationHubRefactorSpaces.RouteActivationState();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.RouteActivationState);
    });
