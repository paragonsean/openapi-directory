...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.CreateServiceResponseLambdaEndpoint();
  });
  ...
  describe('CreateServiceResponseLambdaEndpoint', function() {
    it('should create an instance of CreateServiceResponseLambdaEndpoint', function() {
      // uncomment below and update the code to test CreateServiceResponseLambdaEndpoint
      //var instance = new AwsMigrationHubRefactorSpaces.CreateServiceResponseLambdaEndpoint();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.CreateServiceResponseLambdaEndpoint);
    });
