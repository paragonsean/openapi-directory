...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.ServiceSummaryLambdaEndpoint();
  });
  ...
  describe('ServiceSummaryLambdaEndpoint', function() {
    it('should create an instance of ServiceSummaryLambdaEndpoint', function() {
      // uncomment below and update the code to test ServiceSummaryLambdaEndpoint
      //var instance = new AwsMigrationHubRefactorSpaces.ServiceSummaryLambdaEndpoint();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ServiceSummaryLambdaEndpoint);
    });
