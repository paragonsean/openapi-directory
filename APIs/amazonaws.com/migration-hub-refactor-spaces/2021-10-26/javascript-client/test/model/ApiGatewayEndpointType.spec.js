...
(function(root, factory) {
  ...
  describe('ApiGatewayEndpointType', function() {
    it('should create an instance of ApiGatewayEndpointType', function() {
      // uncomment below and update the code to test ApiGatewayEndpointType
      //var instance = new AwsMigrationHubRefactorSpaces.ApiGatewayEndpointType();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ApiGatewayEndpointType);
    });
