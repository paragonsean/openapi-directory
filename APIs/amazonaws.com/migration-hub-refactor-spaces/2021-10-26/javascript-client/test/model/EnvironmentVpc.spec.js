...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.EnvironmentVpc();
  });
  ...
  describe('EnvironmentVpc', function() {
    it('should create an instance of EnvironmentVpc', function() {
      // uncomment below and update the code to test EnvironmentVpc
      //var instance = new AwsMigrationHubRefactorSpaces.EnvironmentVpc();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.EnvironmentVpc);
    });
