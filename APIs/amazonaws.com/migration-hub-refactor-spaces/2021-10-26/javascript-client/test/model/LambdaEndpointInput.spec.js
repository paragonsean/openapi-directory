...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.LambdaEndpointInput();
  });
  ...
  describe('LambdaEndpointInput', function() {
    it('should create an instance of LambdaEndpointInput', function() {
      // uncomment below and update the code to test LambdaEndpointInput
      //var instance = new AwsMigrationHubRefactorSpaces.LambdaEndpointInput();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.LambdaEndpointInput);
    });
