...
(function(root, factory) {
  ...
  describe('ErrorResourceType', function() {
    it('should create an instance of ErrorResourceType', function() {
      // uncomment below and update the code to test ErrorResourceType
      //var instance = new AwsMigrationHubRefactorSpaces.ErrorResourceType();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ErrorResourceType);
    });
