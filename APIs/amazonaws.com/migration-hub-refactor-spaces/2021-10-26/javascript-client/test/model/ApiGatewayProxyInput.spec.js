...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.ApiGatewayProxyInput();
  });
  ...
  describe('ApiGatewayProxyInput', function() {
    it('should create an instance of ApiGatewayProxyInput', function() {
      // uncomment below and update the code to test ApiGatewayProxyInput
      //var instance = new AwsMigrationHubRefactorSpaces.ApiGatewayProxyInput();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ApiGatewayProxyInput);
    });
