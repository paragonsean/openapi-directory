...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.DeleteRouteResponse();
  });
  ...
  describe('DeleteRouteResponse', function() {
    it('should create an instance of DeleteRouteResponse', function() {
      // uncomment below and update the code to test DeleteRouteResponse
      //var instance = new AwsMigrationHubRefactorSpaces.DeleteRouteResponse();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.DeleteRouteResponse);
    });
