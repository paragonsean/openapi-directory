...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.ApplicationSummary();
  });
  ...
  describe('ApplicationSummary', function() {
    it('should create an instance of ApplicationSummary', function() {
      ...
      //var instance = new AwsMigrationHubRefactorSpaces.ApplicationSummary();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ApplicationSummary);
    });

    it('should have the property apiGatewayProxy (base name: "ApiGatewayProxy")', function() {
      // uncomment below and update the code to test the property apiGatewayProxy
      //var instance = new AwsMigrationHubRefactorSpaces.ApplicationSummary();
