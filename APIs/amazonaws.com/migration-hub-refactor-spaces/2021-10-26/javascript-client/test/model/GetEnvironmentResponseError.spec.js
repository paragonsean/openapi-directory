...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.GetEnvironmentResponseError();
  });
  ...
  describe('GetEnvironmentResponseError', function() {
    it('should create an instance of GetEnvironmentResponseError', function() {
      // uncomment below and update the code to test GetEnvironmentResponseError
      //var instance = new AwsMigrationHubRefactorSpaces.GetEnvironmentResponseError();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.GetEnvironmentResponseError);
    });
