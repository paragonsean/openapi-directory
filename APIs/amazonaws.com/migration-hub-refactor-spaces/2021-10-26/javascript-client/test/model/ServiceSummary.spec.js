...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.ServiceSummary();
  });
  ...
  describe('ServiceSummary', function() {
    it('should create an instance of ServiceSummary', function() {
      // uncomment below and update the code to test ServiceSummary
      //var instance = new AwsMigrationHubRefactorSpaces.ServiceSummary();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ServiceSummary);
    });
