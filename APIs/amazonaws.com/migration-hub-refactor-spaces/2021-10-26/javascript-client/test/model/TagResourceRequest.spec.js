...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsMigrationHubRefactorSpaces.TagResourceRequest();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.TagResourceRequest);
    });
