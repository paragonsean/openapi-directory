...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.GetRouteResponseError();
  });
  ...
  describe('GetRouteResponseError', function() {
    it('should create an instance of GetRouteResponseError', function() {
      // uncomment below and update the code to test GetRouteResponseError
      //var instance = new AwsMigrationHubRefactorSpaces.GetRouteResponseError();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.GetRouteResponseError);
    });
