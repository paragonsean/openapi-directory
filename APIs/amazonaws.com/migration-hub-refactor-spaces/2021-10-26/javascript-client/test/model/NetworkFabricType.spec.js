...
(function(root, factory) {
  ...
  describe('NetworkFabricType', function() {
    it('should create an instance of NetworkFabricType', function() {
      // uncomment below and update the code to test NetworkFabricType
      //var instance = new AwsMigrationHubRefactorSpaces.NetworkFabricType();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.NetworkFabricType);
    });
