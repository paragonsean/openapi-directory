...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.PutResourcePolicyRequest();
  });
  ...
  describe('PutResourcePolicyRequest', function() {
    it('should create an instance of PutResourcePolicyRequest', function() {
      ...
      //var instance = new AwsMigrationHubRefactorSpaces.PutResourcePolicyRequest();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.PutResourcePolicyRequest);
    });
