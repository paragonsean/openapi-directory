...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new AwsMigrationHubRefactorSpaces.ErrorResponse();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.ErrorResponse);
    });
