...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.EnvironmentSummary();
  });
  ...
  describe('EnvironmentSummary', function() {
    it('should create an instance of EnvironmentSummary', function() {
      ...
      //var instance = new AwsMigrationHubRefactorSpaces.EnvironmentSummary();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.EnvironmentSummary);
    });
    ...
    it('should have the property networkFabricType (base name: "NetworkFabricType")', function() {
      // uncomment below and update the code to test the property networkFabricType
      //var instance = new AwsMigrationHubRefactorSpaces.EnvironmentSummary();
      //expect(instance).to.be();
    });
