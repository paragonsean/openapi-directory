...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.GetRouteResponse();
  });
  ...
  describe('GetRouteResponse', function() {
    it('should create an instance of GetRouteResponse', function() {
      // uncomment below and update the code to test GetRouteResponse
      //var instance = new AwsMigrationHubRefactorSpaces.GetRouteResponse();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.GetRouteResponse);
    });
