...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.GetResourcePolicyResponse();
  });
  ...
  describe('GetResourcePolicyResponse', function() {
    it('should create an instance of GetResourcePolicyResponse', function() {
      ...
      //var instance = new AwsMigrationHubRefactorSpaces.GetResourcePolicyResponse();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.GetResourcePolicyResponse);
    });
