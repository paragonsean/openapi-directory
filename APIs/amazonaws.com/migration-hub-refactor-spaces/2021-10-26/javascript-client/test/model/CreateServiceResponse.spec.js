...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.CreateServiceResponse();
  });
  ...
  describe('CreateServiceResponse', function() {
    it('should create an instance of CreateServiceResponse', function() {
      // uncomment below and update the code to test CreateServiceResponse
      //var instance = new AwsMigrationHubRefactorSpaces.CreateServiceResponse();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.CreateServiceResponse);
    });
