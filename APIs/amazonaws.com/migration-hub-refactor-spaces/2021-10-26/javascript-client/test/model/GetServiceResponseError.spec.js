...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.GetServiceResponseError();
  });
  ...
  describe('GetServiceResponseError', function() {
    it('should create an instance of GetServiceResponseError', function() {
      // uncomment below and update the code to test GetServiceResponseError
      //var instance = new AwsMigrationHubRefactorSpaces.GetServiceResponseError();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.GetServiceResponseError);
    });
