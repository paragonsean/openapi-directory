...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMigrationHubRefactorSpaces.RouteSummary();
  });
  ...
  describe('RouteSummary', function() {
    it('should create an instance of RouteSummary', function() {
      // uncomment below and update the code to test RouteSummary
      //var instance = new AwsMigrationHubRefactorSpaces.RouteSummary();
      //expect(instance).to.be.a(AwsMigrationHubRefactorSpaces.RouteSummary);
    });
    ...
    it('should have the property pathResourceToId (base name: "PathResourceToId")', function() {
      // uncomment below and update the code to test the property pathResourceToId
      //var instance = new AwsMigrationHubRefactorSpaces.RouteSummary();
      //expect(instance).to.be();
    });
