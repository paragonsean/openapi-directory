...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QString environment_identifier = create(); // QString | The unique identifier of the environment.
      ...
      apiInstance.createApplication(environment_identifieroai_create_application_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
