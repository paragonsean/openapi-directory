...
#include "OAIDefaultRouteInput.h"
...
OAIDefaultRouteInput::OAIDefaultRouteInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDefaultRouteInput::OAIDefaultRouteInput() {
    this->initializeModel();
}

OAIDefaultRouteInput::~OAIDefaultRouteInput() {}

void OAIDefaultRouteInput::initializeModel() {

    m_activation_state_isSet = false;
    m_activation_state_isValid = false;
}

void OAIDefaultRouteInput::fromJson(QString jsonString) {
...
void OAIDefaultRouteInput::fromJsonObject(QJsonObject json) {
...
QString OAIDefaultRouteInput::asJson() const {
...
QJsonObject OAIDefaultRouteInput::asJsonObject() const {
    QJsonObject obj;
...
OAIRouteActivationState OAIDefaultRouteInput::getActivationState() const {
    return m_activation_state;
}
void OAIDefaultRouteInput::setActivationState(const OAIRouteActivationState &activation_state) {
    m_activation_state = activation_state;
    m_activation_state_isSet = true;
}

bool OAIDefaultRouteInput::is_activation_state_Set() const{
    return m_activation_state_isSet;
}

bool OAIDefaultRouteInput::is_activation_state_Valid() const{
    return m_activation_state_isValid;
}

bool OAIDefaultRouteInput::isSet() const {
...
bool OAIDefaultRouteInput::isValid() const {
