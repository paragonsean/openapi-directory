...
/*
 * OAILambdaEndpointInput.h
 *
 * The input for the Lambda endpoint type. 
 */

#ifndef OAILambdaEndpointInput_H
#define OAILambdaEndpointInput_H
...
class OAILambdaEndpointInput : public OAIObject {
public:
    OAILambdaEndpointInput();
    OAILambdaEndpointInput(QString json);
    ~OAILambdaEndpointInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaEndpointInput)

#endif // OAILambdaEndpointInput_H
