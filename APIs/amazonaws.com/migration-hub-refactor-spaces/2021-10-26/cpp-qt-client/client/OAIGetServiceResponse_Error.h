...
/*
 * OAIGetServiceResponse_Error.h
 *
 * 
 */

#ifndef OAIGetServiceResponse_Error_H
#define OAIGetServiceResponse_Error_H
...
class OAIGetServiceResponse_Error : public OAIObject {
public:
    OAIGetServiceResponse_Error();
    OAIGetServiceResponse_Error(QString json);
    ~OAIGetServiceResponse_Error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceResponse_Error)

#endif // OAIGetServiceResponse_Error_H
