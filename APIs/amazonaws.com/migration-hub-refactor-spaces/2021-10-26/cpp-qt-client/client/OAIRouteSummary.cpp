...
OAIRouteSummary::OAIRouteSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRouteSummary::OAIRouteSummary() {
    this->initializeModel();
}

OAIRouteSummary::~OAIRouteSummary() {}

void OAIRouteSummary::initializeModel() {
...
void OAIRouteSummary::fromJson(QString jsonString) {
...
void OAIRouteSummary::fromJsonObject(QJsonObject json) {
...
QString OAIRouteSummary::asJson() const {
...
QJsonObject OAIRouteSummary::asJsonObject() const {
    QJsonObject obj;
...
bool OAIRouteSummary::getAppendSourcePath() const {
    return m_append_source_path;
}
void OAIRouteSummary::setAppendSourcePath(const bool &append_source_path) {
    m_append_source_path = append_source_path;
    m_append_source_path_isSet = true;
}

bool OAIRouteSummary::is_append_source_path_Set() const{
    return m_append_source_path_isSet;
}

bool OAIRouteSummary::is_append_source_path_Valid() const{
    return m_append_source_path_isValid;
}

QString OAIRouteSummary::getApplicationId() const {
    return m_application_id;
}
void OAIRouteSummary::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAIRouteSummary::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAIRouteSummary::is_application_id_Valid() const{
    return m_application_id_isValid;
}

QString OAIRouteSummary::getArn() const {
    return m_arn;
}
void OAIRouteSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRouteSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRouteSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIRouteSummary::getCreatedByAccountId() const {
    return m_created_by_account_id;
}
void OAIRouteSummary::setCreatedByAccountId(const QString &created_by_account_id) {
    m_created_by_account_id = created_by_account_id;
    m_created_by_account_id_isSet = true;
}

bool OAIRouteSummary::is_created_by_account_id_Set() const{
    return m_created_by_account_id_isSet;
}

bool OAIRouteSummary::is_created_by_account_id_Valid() const{
    return m_created_by_account_id_isValid;
}

QDateTime OAIRouteSummary::getCreatedTime() const {
    return m_created_time;
}
void OAIRouteSummary::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRouteSummary::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRouteSummary::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIRouteSummary::getEnvironmentId() const {
    return m_environment_id;
}
void OAIRouteSummary::setEnvironmentId(const QString &environment_id) {
    m_environment_id = environment_id;
    m_environment_id_isSet = true;
}

bool OAIRouteSummary::is_environment_id_Set() const{
    return m_environment_id_isSet;
}

bool OAIRouteSummary::is_environment_id_Valid() const{
    return m_environment_id_isValid;
}

OAIGetRouteResponse_Error OAIRouteSummary::getError() const {
    return m_error;
}
void OAIRouteSummary::setError(const OAIGetRouteResponse_Error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIRouteSummary::is_error_Set() const{
    return m_error_isSet;
}

bool OAIRouteSummary::is_error_Valid() const{
    return m_error_isValid;
}

bool OAIRouteSummary::getIncludeChildPaths() const {
    return m_include_child_paths;
}
void OAIRouteSummary::setIncludeChildPaths(const bool &include_child_paths) {
    m_include_child_paths = include_child_paths;
    m_include_child_paths_isSet = true;
}

bool OAIRouteSummary::is_include_child_paths_Set() const{
    return m_include_child_paths_isSet;
}

bool OAIRouteSummary::is_include_child_paths_Valid() const{
    return m_include_child_paths_isValid;
}

QDateTime OAIRouteSummary::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIRouteSummary::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIRouteSummary::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIRouteSummary::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

QList OAIRouteSummary::getMethods() const {
    return m_methods;
}
void OAIRouteSummary::setMethods(const QList &methods) {
    m_methods = methods;
    m_methods_isSet = true;
}

bool OAIRouteSummary::is_methods_Set() const{
    return m_methods_isSet;
}

bool OAIRouteSummary::is_methods_Valid() const{
    return m_methods_isValid;
}

QString OAIRouteSummary::getOwnerAccountId() const {
    return m_owner_account_id;
}
void OAIRouteSummary::setOwnerAccountId(const QString &owner_account_id) {
    m_owner_account_id = owner_account_id;
    m_owner_account_id_isSet = true;
}

bool OAIRouteSummary::is_owner_account_id_Set() const{
    return m_owner_account_id_isSet;
}

bool OAIRouteSummary::is_owner_account_id_Valid() const{
    return m_owner_account_id_isValid;
}

QMap OAIRouteSummary::getPathResourceToId() const {
    return m_path_resource_to_id;
}
void OAIRouteSummary::setPathResourceToId(const QMap &path_resource_to_id) {
    m_path_resource_to_id = path_resource_to_id;
    m_path_resource_to_id_isSet = true;
}

bool OAIRouteSummary::is_path_resource_to_id_Set() const{
    return m_path_resource_to_id_isSet;
}

bool OAIRouteSummary::is_path_resource_to_id_Valid() const{
    return m_path_resource_to_id_isValid;
}

QString OAIRouteSummary::getRouteId() const {
    return m_route_id;
}
void OAIRouteSummary::setRouteId(const QString &route_id) {
    m_route_id = route_id;
    m_route_id_isSet = true;
}

bool OAIRouteSummary::is_route_id_Set() const{
    return m_route_id_isSet;
}

bool OAIRouteSummary::is_route_id_Valid() const{
    return m_route_id_isValid;
}

OAIRouteType OAIRouteSummary::getRouteType() const {
    return m_route_type;
}
void OAIRouteSummary::setRouteType(const OAIRouteType &route_type) {
    m_route_type = route_type;
    m_route_type_isSet = true;
}

bool OAIRouteSummary::is_route_type_Set() const{
    return m_route_type_isSet;
}

bool OAIRouteSummary::is_route_type_Valid() const{
    return m_route_type_isValid;
}

QString OAIRouteSummary::getServiceId() const {
    return m_service_id;
}
void OAIRouteSummary::setServiceId(const QString &service_id) {
    m_service_id = service_id;
    m_service_id_isSet = true;
}

bool OAIRouteSummary::is_service_id_Set() const{
    return m_service_id_isSet;
}

bool OAIRouteSummary::is_service_id_Valid() const{
    return m_service_id_isValid;
}

QString OAIRouteSummary::getSourcePath() const {
    return m_source_path;
}
void OAIRouteSummary::setSourcePath(const QString &source_path) {
    m_source_path = source_path;
    m_source_path_isSet = true;
}

bool OAIRouteSummary::is_source_path_Set() const{
    return m_source_path_isSet;
}

bool OAIRouteSummary::is_source_path_Valid() const{
    return m_source_path_isValid;
}

OAIRouteState OAIRouteSummary::getState() const {
    return m_state;
}
void OAIRouteSummary::setState(const OAIRouteState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIRouteSummary::is_state_Set() const{
    return m_state_isSet;
}

bool OAIRouteSummary::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIRouteSummary::getTags() const {
    return m_tags;
}
void OAIRouteSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIRouteSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIRouteSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIRouteSummary::isSet() const {
...
bool OAIRouteSummary::isValid() const {
