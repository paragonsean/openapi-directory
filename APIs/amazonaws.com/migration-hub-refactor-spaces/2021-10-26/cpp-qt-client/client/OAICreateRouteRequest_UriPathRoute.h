...
/*
 * OAICreateRouteRequest_UriPathRoute.h
 *
 * 
 */

#ifndef OAICreateRouteRequest_UriPathRoute_H
#define OAICreateRouteRequest_UriPathRoute_H
...
class OAICreateRouteRequest_UriPathRoute : public OAIObject {
public:
    OAICreateRouteRequest_UriPathRoute();
    OAICreateRouteRequest_UriPathRoute(QString json);
    ~OAICreateRouteRequest_UriPathRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRouteRequest_UriPathRoute)

#endif // OAICreateRouteRequest_UriPathRoute_H
