...
/*
 * OAIApiGatewayProxyInput.h
 *
 * A wrapper object holding the Amazon API Gateway endpoint input. 
 */

#ifndef OAIApiGatewayProxyInput_H
#define OAIApiGatewayProxyInput_H
...
class OAIApiGatewayProxyInput : public OAIObject {
public:
    OAIApiGatewayProxyInput();
    OAIApiGatewayProxyInput(QString json);
    ~OAIApiGatewayProxyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiGatewayProxyInput)

#endif // OAIApiGatewayProxyInput_H
