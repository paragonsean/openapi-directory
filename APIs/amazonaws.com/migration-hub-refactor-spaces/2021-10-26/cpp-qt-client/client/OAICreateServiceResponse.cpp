...
QString OAICreateServiceResponse::getApplicationId() const {
    return m_application_id;
}
void OAICreateServiceResponse::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAICreateServiceResponse::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAICreateServiceResponse::is_application_id_Valid() const{
...
QString OAICreateServiceResponse::getCreatedByAccountId() const {
    return m_created_by_account_id;
}
void OAICreateServiceResponse::setCreatedByAccountId(const QString &created_by_account_id) {
    m_created_by_account_id = created_by_account_id;
    m_created_by_account_id_isSet = true;
}

bool OAICreateServiceResponse::is_created_by_account_id_Set() const{
    return m_created_by_account_id_isSet;
}

bool OAICreateServiceResponse::is_created_by_account_id_Valid() const{
    return m_created_by_account_id_isValid;
}

QDateTime OAICreateServiceResponse::getCreatedTime() const {
    return m_created_time;
}
void OAICreateServiceResponse::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICreateServiceResponse::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICreateServiceResponse::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICreateServiceResponse::getDescription() const {
    return m_description;
}
void OAICreateServiceResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateServiceResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateServiceResponse::is_description_Valid() const{
    return m_description_isValid;
}

OAIServiceEndpointType OAICreateServiceResponse::getEndpointType() const {
    return m_endpoint_type;
}
void OAICreateServiceResponse::setEndpointType(const OAIServiceEndpointType &endpoint_type) {
    m_endpoint_type = endpoint_type;
    m_endpoint_type_isSet = true;
}

bool OAICreateServiceResponse::is_endpoint_type_Set() const{
    return m_endpoint_type_isSet;
}

bool OAICreateServiceResponse::is_endpoint_type_Valid() const{
    return m_endpoint_type_isValid;
}

QString OAICreateServiceResponse::getEnvironmentId() const {
    return m_environment_id;
}
void OAICreateServiceResponse::setEnvironmentId(const QString &environment_id) {
    m_environment_id = environment_id;
    m_environment_id_isSet = true;
}

bool OAICreateServiceResponse::is_environment_id_Set() const{
    return m_environment_id_isSet;
}

bool OAICreateServiceResponse::is_environment_id_Valid() const{
    return m_environment_id_isValid;
}

OAICreateServiceResponse_LambdaEndpoint OAICreateServiceResponse::getLambdaEndpoint() const {
    return m_lambda_endpoint;
}
void OAICreateServiceResponse::setLambdaEndpoint(const OAICreateServiceResponse_LambdaEndpoint &lambda_endpoint) {
    m_lambda_endpoint = lambda_endpoint;
    m_lambda_endpoint_isSet = true;
}

bool OAICreateServiceResponse::is_lambda_endpoint_Set() const{
    return m_lambda_endpoint_isSet;
}

bool OAICreateServiceResponse::is_lambda_endpoint_Valid() const{
    return m_lambda_endpoint_isValid;
}

QDateTime OAICreateServiceResponse::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAICreateServiceResponse::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAICreateServiceResponse::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAICreateServiceResponse::is_last_updated_time_Valid() const{
...
QString OAICreateServiceResponse::getOwnerAccountId() const {
    return m_owner_account_id;
}
void OAICreateServiceResponse::setOwnerAccountId(const QString &owner_account_id) {
    m_owner_account_id = owner_account_id;
    m_owner_account_id_isSet = true;
}

bool OAICreateServiceResponse::is_owner_account_id_Set() const{
    return m_owner_account_id_isSet;
}

bool OAICreateServiceResponse::is_owner_account_id_Valid() const{
    return m_owner_account_id_isValid;
}

QString OAICreateServiceResponse::getServiceId() const {
    return m_service_id;
}
void OAICreateServiceResponse::setServiceId(const QString &service_id) {
    m_service_id = service_id;
    m_service_id_isSet = true;
}

bool OAICreateServiceResponse::is_service_id_Set() const{
    return m_service_id_isSet;
}

bool OAICreateServiceResponse::is_service_id_Valid() const{
    return m_service_id_isValid;
}

OAIServiceState OAICreateServiceResponse::getState() const {
    return m_state;
}
void OAICreateServiceResponse::setState(const OAIServiceState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICreateServiceResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAICreateServiceResponse::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAICreateServiceResponse::getTags() const {
    return m_tags;
}
void OAICreateServiceResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateServiceResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateServiceResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

OAICreateServiceResponse_UrlEndpoint OAICreateServiceResponse::getUrlEndpoint() const {
    return m_url_endpoint;
}
void OAICreateServiceResponse::setUrlEndpoint(const OAICreateServiceResponse_UrlEndpoint &url_endpoint) {
    m_url_endpoint = url_endpoint;
    m_url_endpoint_isSet = true;
}

bool OAICreateServiceResponse::is_url_endpoint_Set() const{
    return m_url_endpoint_isSet;
}

bool OAICreateServiceResponse::is_url_endpoint_Valid() const{
    return m_url_endpoint_isValid;
}

QString OAICreateServiceResponse::getVpcId() const {
    return m_vpc_id;
}
void OAICreateServiceResponse::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAICreateServiceResponse::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAICreateServiceResponse::is_vpc_id_Valid() const{
