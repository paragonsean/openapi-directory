...
/*
 * OAIUriPathRouteInput.h
 *
 * The configuration for the URI path route type. 
 */

#ifndef OAIUriPathRouteInput_H
#define OAIUriPathRouteInput_H
...
class OAIUriPathRouteInput : public OAIObject {
public:
    OAIUriPathRouteInput();
    OAIUriPathRouteInput(QString json);
    ~OAIUriPathRouteInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUriPathRouteInput)

#endif // OAIUriPathRouteInput_H
