...
/*
 * OAICreateEnvironmentResponse.h
 *
 * 
 */

#ifndef OAICreateEnvironmentResponse_H
#define OAICreateEnvironmentResponse_H
...
class OAICreateEnvironmentResponse : public OAIObject {
public:
    OAICreateEnvironmentResponse();
    OAICreateEnvironmentResponse(QString json);
    ~OAICreateEnvironmentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironmentResponse)

#endif // OAICreateEnvironmentResponse_H
