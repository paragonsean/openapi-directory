...
OAICreateRouteRequest_UriPathRoute::OAICreateRouteRequest_UriPathRoute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRouteRequest_UriPathRoute::OAICreateRouteRequest_UriPathRoute() {
    this->initializeModel();
}

OAICreateRouteRequest_UriPathRoute::~OAICreateRouteRequest_UriPathRoute() {}

void OAICreateRouteRequest_UriPathRoute::initializeModel() {
...
void OAICreateRouteRequest_UriPathRoute::fromJson(QString jsonString) {
...
void OAICreateRouteRequest_UriPathRoute::fromJsonObject(QJsonObject json) {
...
QString OAICreateRouteRequest_UriPathRoute::asJson() const {
...
QJsonObject OAICreateRouteRequest_UriPathRoute::asJsonObject() const {
    QJsonObject obj;
...
OAIRouteActivationState OAICreateRouteRequest_UriPathRoute::getActivationState() const {
    return m_activation_state;
}
void OAICreateRouteRequest_UriPathRoute::setActivationState(const OAIRouteActivationState &activation_state) {
    m_activation_state = activation_state;
    m_activation_state_isSet = true;
}

bool OAICreateRouteRequest_UriPathRoute::is_activation_state_Set() const{
    return m_activation_state_isSet;
}

bool OAICreateRouteRequest_UriPathRoute::is_activation_state_Valid() const{
    return m_activation_state_isValid;
}

bool OAICreateRouteRequest_UriPathRoute::getAppendSourcePath() const {
    return m_append_source_path;
}
void OAICreateRouteRequest_UriPathRoute::setAppendSourcePath(const bool &append_source_path) {
    m_append_source_path = append_source_path;
    m_append_source_path_isSet = true;
}

bool OAICreateRouteRequest_UriPathRoute::is_append_source_path_Set() const{
    return m_append_source_path_isSet;
}

bool OAICreateRouteRequest_UriPathRoute::is_append_source_path_Valid() const{
    return m_append_source_path_isValid;
}

bool OAICreateRouteRequest_UriPathRoute::getIncludeChildPaths() const {
    return m_include_child_paths;
}
void OAICreateRouteRequest_UriPathRoute::setIncludeChildPaths(const bool &include_child_paths) {
    m_include_child_paths = include_child_paths;
    m_include_child_paths_isSet = true;
}

bool OAICreateRouteRequest_UriPathRoute::is_include_child_paths_Set() const{
    return m_include_child_paths_isSet;
}

bool OAICreateRouteRequest_UriPathRoute::is_include_child_paths_Valid() const{
    return m_include_child_paths_isValid;
}

QList OAICreateRouteRequest_UriPathRoute::getMethods() const {
    return m_methods;
}
void OAICreateRouteRequest_UriPathRoute::setMethods(const QList &methods) {
    m_methods = methods;
    m_methods_isSet = true;
}

bool OAICreateRouteRequest_UriPathRoute::is_methods_Set() const{
    return m_methods_isSet;
}

bool OAICreateRouteRequest_UriPathRoute::is_methods_Valid() const{
    return m_methods_isValid;
}

QString OAICreateRouteRequest_UriPathRoute::getSourcePath() const {
    return m_source_path;
}
void OAICreateRouteRequest_UriPathRoute::setSourcePath(const QString &source_path) {
    m_source_path = source_path;
    m_source_path_isSet = true;
}

bool OAICreateRouteRequest_UriPathRoute::is_source_path_Set() const{
    return m_source_path_isSet;
}

bool OAICreateRouteRequest_UriPathRoute::is_source_path_Valid() const{
    return m_source_path_isValid;
}

bool OAICreateRouteRequest_UriPathRoute::isSet() const {
...
bool OAICreateRouteRequest_UriPathRoute::isValid() const {
