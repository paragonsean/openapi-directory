...
/*
 * OAIGetRouteResponse_Error.h
 *
 * 
 */

#ifndef OAIGetRouteResponse_Error_H
#define OAIGetRouteResponse_Error_H
...
class OAIGetRouteResponse_Error : public OAIObject {
public:
    OAIGetRouteResponse_Error();
    OAIGetRouteResponse_Error(QString json);
    ~OAIGetRouteResponse_Error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRouteResponse_Error)

#endif // OAIGetRouteResponse_Error_H
