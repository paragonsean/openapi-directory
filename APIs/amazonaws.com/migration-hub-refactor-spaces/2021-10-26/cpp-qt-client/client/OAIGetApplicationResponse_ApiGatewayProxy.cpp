...
#include "OAIGetApplicationResponse_ApiGatewayProxy.h"
...
OAIGetApplicationResponse_ApiGatewayProxy::OAIGetApplicationResponse_ApiGatewayProxy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetApplicationResponse_ApiGatewayProxy::OAIGetApplicationResponse_ApiGatewayProxy() {
    this->initializeModel();
}

OAIGetApplicationResponse_ApiGatewayProxy::~OAIGetApplicationResponse_ApiGatewayProxy() {}

void OAIGetApplicationResponse_ApiGatewayProxy::initializeModel() {
...
void OAIGetApplicationResponse_ApiGatewayProxy::fromJson(QString jsonString) {
...
void OAIGetApplicationResponse_ApiGatewayProxy::fromJsonObject(QJsonObject json) {
...
QString OAIGetApplicationResponse_ApiGatewayProxy::asJson() const {
...
QJsonObject OAIGetApplicationResponse_ApiGatewayProxy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetApplicationResponse_ApiGatewayProxy::getApiGatewayId() const {
    return m_api_gateway_id;
}
void OAIGetApplicationResponse_ApiGatewayProxy::setApiGatewayId(const QString &api_gateway_id) {
    m_api_gateway_id = api_gateway_id;
    m_api_gateway_id_isSet = true;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_api_gateway_id_Set() const{
    return m_api_gateway_id_isSet;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_api_gateway_id_Valid() const{
    return m_api_gateway_id_isValid;
}

OAIApiGatewayEndpointType OAIGetApplicationResponse_ApiGatewayProxy::getEndpointType() const {
    return m_endpoint_type;
}
void OAIGetApplicationResponse_ApiGatewayProxy::setEndpointType(const OAIApiGatewayEndpointType &endpoint_type) {
    m_endpoint_type = endpoint_type;
    m_endpoint_type_isSet = true;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_endpoint_type_Set() const{
    return m_endpoint_type_isSet;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_endpoint_type_Valid() const{
    return m_endpoint_type_isValid;
}

QString OAIGetApplicationResponse_ApiGatewayProxy::getNlbArn() const {
    return m_nlb_arn;
}
void OAIGetApplicationResponse_ApiGatewayProxy::setNlbArn(const QString &nlb_arn) {
    m_nlb_arn = nlb_arn;
    m_nlb_arn_isSet = true;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_nlb_arn_Set() const{
    return m_nlb_arn_isSet;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_nlb_arn_Valid() const{
    return m_nlb_arn_isValid;
}

QString OAIGetApplicationResponse_ApiGatewayProxy::getNlbName() const {
    return m_nlb_name;
}
void OAIGetApplicationResponse_ApiGatewayProxy::setNlbName(const QString &nlb_name) {
    m_nlb_name = nlb_name;
    m_nlb_name_isSet = true;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_nlb_name_Set() const{
    return m_nlb_name_isSet;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_nlb_name_Valid() const{
    return m_nlb_name_isValid;
}

QString OAIGetApplicationResponse_ApiGatewayProxy::getProxyUrl() const {
    return m_proxy_url;
}
void OAIGetApplicationResponse_ApiGatewayProxy::setProxyUrl(const QString &proxy_url) {
    m_proxy_url = proxy_url;
    m_proxy_url_isSet = true;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_proxy_url_Set() const{
    return m_proxy_url_isSet;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_proxy_url_Valid() const{
    return m_proxy_url_isValid;
}

QString OAIGetApplicationResponse_ApiGatewayProxy::getStageName() const {
    return m_stage_name;
}
void OAIGetApplicationResponse_ApiGatewayProxy::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

QString OAIGetApplicationResponse_ApiGatewayProxy::getVpcLinkId() const {
    return m_vpc_link_id;
}
void OAIGetApplicationResponse_ApiGatewayProxy::setVpcLinkId(const QString &vpc_link_id) {
    m_vpc_link_id = vpc_link_id;
    m_vpc_link_id_isSet = true;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_vpc_link_id_Set() const{
    return m_vpc_link_id_isSet;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::is_vpc_link_id_Valid() const{
    return m_vpc_link_id_isValid;
}

bool OAIGetApplicationResponse_ApiGatewayProxy::isSet() const {
...
bool OAIGetApplicationResponse_ApiGatewayProxy::isValid() const {
