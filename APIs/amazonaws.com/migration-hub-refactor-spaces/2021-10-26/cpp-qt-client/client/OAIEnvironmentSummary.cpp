...
QDateTime OAIEnvironmentSummary::getCreatedTime() const {
    return m_created_time;
}
void OAIEnvironmentSummary::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIEnvironmentSummary::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIEnvironmentSummary::is_created_time_Valid() const{
...
OAIGetEnvironmentResponse_Error OAIEnvironmentSummary::getError() const {
    return m_error;
}
void OAIEnvironmentSummary::setError(const OAIGetEnvironmentResponse_Error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIEnvironmentSummary::is_error_Set() const{
    return m_error_isSet;
}

bool OAIEnvironmentSummary::is_error_Valid() const{
    return m_error_isValid;
}

QDateTime OAIEnvironmentSummary::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIEnvironmentSummary::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIEnvironmentSummary::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIEnvironmentSummary::is_last_updated_time_Valid() const{
...
OAINetworkFabricType OAIEnvironmentSummary::getNetworkFabricType() const {
    return m_network_fabric_type;
}
void OAIEnvironmentSummary::setNetworkFabricType(const OAINetworkFabricType &network_fabric_type) {
    m_network_fabric_type = network_fabric_type;
    m_network_fabric_type_isSet = true;
}

bool OAIEnvironmentSummary::is_network_fabric_type_Set() const{
    return m_network_fabric_type_isSet;
}

bool OAIEnvironmentSummary::is_network_fabric_type_Valid() const{
    return m_network_fabric_type_isValid;
}

QString OAIEnvironmentSummary::getOwnerAccountId() const {
    return m_owner_account_id;
}
void OAIEnvironmentSummary::setOwnerAccountId(const QString &owner_account_id) {
    m_owner_account_id = owner_account_id;
    m_owner_account_id_isSet = true;
}

bool OAIEnvironmentSummary::is_owner_account_id_Set() const{
    return m_owner_account_id_isSet;
}

bool OAIEnvironmentSummary::is_owner_account_id_Valid() const{
    return m_owner_account_id_isValid;
}

OAIEnvironmentState OAIEnvironmentSummary::getState() const {
    return m_state;
}
void OAIEnvironmentSummary::setState(const OAIEnvironmentState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIEnvironmentSummary::is_state_Set() const{
    return m_state_isSet;
}

bool OAIEnvironmentSummary::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIEnvironmentSummary::getTags() const {
    return m_tags;
}
void OAIEnvironmentSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIEnvironmentSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIEnvironmentSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIEnvironmentSummary::getTransitGatewayId() const {
    return m_transit_gateway_id;
}
void OAIEnvironmentSummary::setTransitGatewayId(const QString &transit_gateway_id) {
    m_transit_gateway_id = transit_gateway_id;
    m_transit_gateway_id_isSet = true;
}

bool OAIEnvironmentSummary::is_transit_gateway_id_Set() const{
    return m_transit_gateway_id_isSet;
}

bool OAIEnvironmentSummary::is_transit_gateway_id_Valid() const{
