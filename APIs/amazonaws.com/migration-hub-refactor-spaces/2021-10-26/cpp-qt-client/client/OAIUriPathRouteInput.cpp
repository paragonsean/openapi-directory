...
#include "OAIUriPathRouteInput.h"
...
OAIUriPathRouteInput::OAIUriPathRouteInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUriPathRouteInput::OAIUriPathRouteInput() {
    this->initializeModel();
}

OAIUriPathRouteInput::~OAIUriPathRouteInput() {}

void OAIUriPathRouteInput::initializeModel() {
...
void OAIUriPathRouteInput::fromJson(QString jsonString) {
...
void OAIUriPathRouteInput::fromJsonObject(QJsonObject json) {
...
QString OAIUriPathRouteInput::asJson() const {
...
QJsonObject OAIUriPathRouteInput::asJsonObject() const {
    QJsonObject obj;
...
OAIRouteActivationState OAIUriPathRouteInput::getActivationState() const {
    return m_activation_state;
}
void OAIUriPathRouteInput::setActivationState(const OAIRouteActivationState &activation_state) {
    m_activation_state = activation_state;
    m_activation_state_isSet = true;
}

bool OAIUriPathRouteInput::is_activation_state_Set() const{
    return m_activation_state_isSet;
}

bool OAIUriPathRouteInput::is_activation_state_Valid() const{
    return m_activation_state_isValid;
}

bool OAIUriPathRouteInput::getAppendSourcePath() const {
    return m_append_source_path;
}
void OAIUriPathRouteInput::setAppendSourcePath(const bool &append_source_path) {
    m_append_source_path = append_source_path;
    m_append_source_path_isSet = true;
}

bool OAIUriPathRouteInput::is_append_source_path_Set() const{
    return m_append_source_path_isSet;
}

bool OAIUriPathRouteInput::is_append_source_path_Valid() const{
    return m_append_source_path_isValid;
}

bool OAIUriPathRouteInput::getIncludeChildPaths() const {
    return m_include_child_paths;
}
void OAIUriPathRouteInput::setIncludeChildPaths(const bool &include_child_paths) {
    m_include_child_paths = include_child_paths;
    m_include_child_paths_isSet = true;
}

bool OAIUriPathRouteInput::is_include_child_paths_Set() const{
    return m_include_child_paths_isSet;
}

bool OAIUriPathRouteInput::is_include_child_paths_Valid() const{
    return m_include_child_paths_isValid;
}

QList OAIUriPathRouteInput::getMethods() const {
    return m_methods;
}
void OAIUriPathRouteInput::setMethods(const QList &methods) {
    m_methods = methods;
    m_methods_isSet = true;
}

bool OAIUriPathRouteInput::is_methods_Set() const{
    return m_methods_isSet;
}

bool OAIUriPathRouteInput::is_methods_Valid() const{
    return m_methods_isValid;
}

QString OAIUriPathRouteInput::getSourcePath() const {
    return m_source_path;
}
void OAIUriPathRouteInput::setSourcePath(const QString &source_path) {
    m_source_path = source_path;
    m_source_path_isSet = true;
}

bool OAIUriPathRouteInput::is_source_path_Set() const{
    return m_source_path_isSet;
}

bool OAIUriPathRouteInput::is_source_path_Valid() const{
    return m_source_path_isValid;
}

bool OAIUriPathRouteInput::isSet() const {
...
bool OAIUriPathRouteInput::isValid() const {
