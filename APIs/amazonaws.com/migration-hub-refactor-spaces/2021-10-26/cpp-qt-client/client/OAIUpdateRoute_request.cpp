...
QJsonObject OAIUpdateRoute_request::asJsonObject() const {
    QJsonObject obj;
    if (m_activation_state_isSet) {
        obj.insert(QString("ActivationState"), ::OpenAPI::toJsonValue(m_activation_state));
    }
    return obj;
}

QString OAIUpdateRoute_request::getActivationState() const {
    return m_activation_state;
}
void OAIUpdateRoute_request::setActivationState(const QString &activation_state) {
    m_activation_state = activation_state;
    m_activation_state_isSet = true;
}

bool OAIUpdateRoute_request::is_activation_state_Set() const{
    return m_activation_state_isSet;
}

bool OAIUpdateRoute_request::is_activation_state_Valid() const{
