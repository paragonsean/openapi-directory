...
QString OAIGetServiceResponse::getApplicationId() const {
    return m_application_id;
}
void OAIGetServiceResponse::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAIGetServiceResponse::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAIGetServiceResponse::is_application_id_Valid() const{
...
QString OAIGetServiceResponse::getCreatedByAccountId() const {
    return m_created_by_account_id;
}
void OAIGetServiceResponse::setCreatedByAccountId(const QString &created_by_account_id) {
    m_created_by_account_id = created_by_account_id;
    m_created_by_account_id_isSet = true;
}

bool OAIGetServiceResponse::is_created_by_account_id_Set() const{
    return m_created_by_account_id_isSet;
}

bool OAIGetServiceResponse::is_created_by_account_id_Valid() const{
    return m_created_by_account_id_isValid;
}

QDateTime OAIGetServiceResponse::getCreatedTime() const {
    return m_created_time;
}
void OAIGetServiceResponse::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGetServiceResponse::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGetServiceResponse::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIGetServiceResponse::getDescription() const {
    return m_description;
}
void OAIGetServiceResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetServiceResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetServiceResponse::is_description_Valid() const{
    return m_description_isValid;
}

OAIServiceEndpointType OAIGetServiceResponse::getEndpointType() const {
    return m_endpoint_type;
}
void OAIGetServiceResponse::setEndpointType(const OAIServiceEndpointType &endpoint_type) {
    m_endpoint_type = endpoint_type;
    m_endpoint_type_isSet = true;
}

bool OAIGetServiceResponse::is_endpoint_type_Set() const{
    return m_endpoint_type_isSet;
}

bool OAIGetServiceResponse::is_endpoint_type_Valid() const{
    return m_endpoint_type_isValid;
}

QString OAIGetServiceResponse::getEnvironmentId() const {
    return m_environment_id;
}
void OAIGetServiceResponse::setEnvironmentId(const QString &environment_id) {
    m_environment_id = environment_id;
    m_environment_id_isSet = true;
}

bool OAIGetServiceResponse::is_environment_id_Set() const{
    return m_environment_id_isSet;
}

bool OAIGetServiceResponse::is_environment_id_Valid() const{
    return m_environment_id_isValid;
}

OAIGetServiceResponse_Error OAIGetServiceResponse::getError() const {
    return m_error;
}
void OAIGetServiceResponse::setError(const OAIGetServiceResponse_Error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGetServiceResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGetServiceResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIGetServiceResponse_LambdaEndpoint OAIGetServiceResponse::getLambdaEndpoint() const {
    return m_lambda_endpoint;
}
void OAIGetServiceResponse::setLambdaEndpoint(const OAIGetServiceResponse_LambdaEndpoint &lambda_endpoint) {
    m_lambda_endpoint = lambda_endpoint;
    m_lambda_endpoint_isSet = true;
}

bool OAIGetServiceResponse::is_lambda_endpoint_Set() const{
    return m_lambda_endpoint_isSet;
}

bool OAIGetServiceResponse::is_lambda_endpoint_Valid() const{
    return m_lambda_endpoint_isValid;
}

QDateTime OAIGetServiceResponse::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIGetServiceResponse::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIGetServiceResponse::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIGetServiceResponse::is_last_updated_time_Valid() const{
...
QString OAIGetServiceResponse::getOwnerAccountId() const {
    return m_owner_account_id;
}
void OAIGetServiceResponse::setOwnerAccountId(const QString &owner_account_id) {
    m_owner_account_id = owner_account_id;
    m_owner_account_id_isSet = true;
}

bool OAIGetServiceResponse::is_owner_account_id_Set() const{
    return m_owner_account_id_isSet;
}

bool OAIGetServiceResponse::is_owner_account_id_Valid() const{
    return m_owner_account_id_isValid;
}

QString OAIGetServiceResponse::getServiceId() const {
    return m_service_id;
}
void OAIGetServiceResponse::setServiceId(const QString &service_id) {
    m_service_id = service_id;
    m_service_id_isSet = true;
}

bool OAIGetServiceResponse::is_service_id_Set() const{
    return m_service_id_isSet;
}

bool OAIGetServiceResponse::is_service_id_Valid() const{
    return m_service_id_isValid;
}

OAIServiceState OAIGetServiceResponse::getState() const {
    return m_state;
}
void OAIGetServiceResponse::setState(const OAIServiceState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIGetServiceResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAIGetServiceResponse::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIGetServiceResponse::getTags() const {
    return m_tags;
}
void OAIGetServiceResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetServiceResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetServiceResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIGetServiceResponse_UrlEndpoint OAIGetServiceResponse::getUrlEndpoint() const {
    return m_url_endpoint;
}
void OAIGetServiceResponse::setUrlEndpoint(const OAIGetServiceResponse_UrlEndpoint &url_endpoint) {
    m_url_endpoint = url_endpoint;
    m_url_endpoint_isSet = true;
}

bool OAIGetServiceResponse::is_url_endpoint_Set() const{
    return m_url_endpoint_isSet;
}

bool OAIGetServiceResponse::is_url_endpoint_Valid() const{
    return m_url_endpoint_isValid;
}

QString OAIGetServiceResponse::getVpcId() const {
    return m_vpc_id;
}
void OAIGetServiceResponse::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIGetServiceResponse::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIGetServiceResponse::is_vpc_id_Valid() const{
