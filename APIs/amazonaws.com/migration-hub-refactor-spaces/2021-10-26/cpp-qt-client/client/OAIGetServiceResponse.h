...
class OAIGetServiceResponse_LambdaEndpoint;
class OAIGetServiceResponse_UrlEndpoint;
...
public:
    ...
    OAIGetServiceResponse_LambdaEndpoint getLambdaEndpoint() const;
    void setLambdaEndpoint(const OAIGetServiceResponse_LambdaEndpoint &lambda_endpoint);
    ...
    OAIGetServiceResponse_UrlEndpoint getUrlEndpoint() const;
    void setUrlEndpoint(const OAIGetServiceResponse_UrlEndpoint &url_endpoint);
...
private:
    ...
    OAIGetServiceResponse_LambdaEndpoint m_lambda_endpoint;
    ...
    OAIGetServiceResponse_UrlEndpoint m_url_endpoint;
