...
OAICreateApplicationResponse_ApiGatewayProxy OAICreateApplicationRequest::getApiGatewayProxy() const {
    return m_api_gateway_proxy;
}
void OAICreateApplicationRequest::setApiGatewayProxy(const OAICreateApplicationResponse_ApiGatewayProxy &api_gateway_proxy) {
    m_api_gateway_proxy = api_gateway_proxy;
    m_api_gateway_proxy_isSet = true;
}

bool OAICreateApplicationRequest::is_api_gateway_proxy_Set() const{
    return m_api_gateway_proxy_isSet;
}

bool OAICreateApplicationRequest::is_api_gateway_proxy_Valid() const{
...
OAIProxyType OAICreateApplicationRequest::getProxyType() const {
    return m_proxy_type;
}
void OAICreateApplicationRequest::setProxyType(const OAIProxyType &proxy_type) {
    m_proxy_type = proxy_type;
    m_proxy_type_isSet = true;
}

bool OAICreateApplicationRequest::is_proxy_type_Set() const{
    return m_proxy_type_isSet;
}

bool OAICreateApplicationRequest::is_proxy_type_Valid() const{
...
QString OAICreateApplicationRequest::getVpcId() const {
    return m_vpc_id;
}
void OAICreateApplicationRequest::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAICreateApplicationRequest::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAICreateApplicationRequest::is_vpc_id_Valid() const{
