...
/*
 * OAIUpdateRouteResponse.h
 *
 * 
 */

#ifndef OAIUpdateRouteResponse_H
#define OAIUpdateRouteResponse_H
...
class OAIUpdateRouteResponse : public OAIObject {
public:
    OAIUpdateRouteResponse();
    OAIUpdateRouteResponse(QString json);
    ~OAIUpdateRouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRouteResponse)

#endif // OAIUpdateRouteResponse_H
