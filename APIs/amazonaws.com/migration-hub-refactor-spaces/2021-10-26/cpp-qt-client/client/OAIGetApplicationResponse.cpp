...
OAIGetApplicationResponse_ApiGatewayProxy OAIGetApplicationResponse::getApiGatewayProxy() const {
    return m_api_gateway_proxy;
}
void OAIGetApplicationResponse::setApiGatewayProxy(const OAIGetApplicationResponse_ApiGatewayProxy &api_gateway_proxy) {
    m_api_gateway_proxy = api_gateway_proxy;
    m_api_gateway_proxy_isSet = true;
}

bool OAIGetApplicationResponse::is_api_gateway_proxy_Set() const{
    return m_api_gateway_proxy_isSet;
}

bool OAIGetApplicationResponse::is_api_gateway_proxy_Valid() const{
...
QString OAIGetApplicationResponse::getCreatedByAccountId() const {
    return m_created_by_account_id;
}
void OAIGetApplicationResponse::setCreatedByAccountId(const QString &created_by_account_id) {
    m_created_by_account_id = created_by_account_id;
    m_created_by_account_id_isSet = true;
}

bool OAIGetApplicationResponse::is_created_by_account_id_Set() const{
    return m_created_by_account_id_isSet;
}

bool OAIGetApplicationResponse::is_created_by_account_id_Valid() const{
    return m_created_by_account_id_isValid;
}

QDateTime OAIGetApplicationResponse::getCreatedTime() const {
    return m_created_time;
}
void OAIGetApplicationResponse::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGetApplicationResponse::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGetApplicationResponse::is_created_time_Valid() const{
...
OAIGetApplicationResponse_Error OAIGetApplicationResponse::getError() const {
    return m_error;
}
void OAIGetApplicationResponse::setError(const OAIGetApplicationResponse_Error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGetApplicationResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGetApplicationResponse::is_error_Valid() const{
    return m_error_isValid;
}

QDateTime OAIGetApplicationResponse::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIGetApplicationResponse::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIGetApplicationResponse::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIGetApplicationResponse::is_last_updated_time_Valid() const{
...
QString OAIGetApplicationResponse::getOwnerAccountId() const {
    return m_owner_account_id;
}
void OAIGetApplicationResponse::setOwnerAccountId(const QString &owner_account_id) {
    m_owner_account_id = owner_account_id;
    m_owner_account_id_isSet = true;
}

bool OAIGetApplicationResponse::is_owner_account_id_Set() const{
    return m_owner_account_id_isSet;
}

bool OAIGetApplicationResponse::is_owner_account_id_Valid() const{
    return m_owner_account_id_isValid;
}

OAIProxyType OAIGetApplicationResponse::getProxyType() const {
    return m_proxy_type;
}
void OAIGetApplicationResponse::setProxyType(const OAIProxyType &proxy_type) {
    m_proxy_type = proxy_type;
    m_proxy_type_isSet = true;
}

bool OAIGetApplicationResponse::is_proxy_type_Set() const{
    return m_proxy_type_isSet;
}

bool OAIGetApplicationResponse::is_proxy_type_Valid() const{
    return m_proxy_type_isValid;
}

OAIApplicationState OAIGetApplicationResponse::getState() const {
    return m_state;
}
void OAIGetApplicationResponse::setState(const OAIApplicationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIGetApplicationResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAIGetApplicationResponse::is_state_Valid() const{
...
QString OAIGetApplicationResponse::getVpcId() const {
    return m_vpc_id;
}
void OAIGetApplicationResponse::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIGetApplicationResponse::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIGetApplicationResponse::is_vpc_id_Valid() const{
