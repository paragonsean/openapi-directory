...
/*
 * OAIGetRouteResponse.h
 *
 * 
 */

#ifndef OAIGetRouteResponse_H
#define OAIGetRouteResponse_H
...
class OAIGetRouteResponse : public OAIObject {
public:
    OAIGetRouteResponse();
    OAIGetRouteResponse(QString json);
    ~OAIGetRouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRouteResponse)

#endif // OAIGetRouteResponse_H
