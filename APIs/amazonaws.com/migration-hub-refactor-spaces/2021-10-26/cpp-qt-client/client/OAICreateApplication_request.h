...
namespace OpenAPI {
class OAICreateApplication_request_ApiGatewayProxy;
...
public:
    ...
    OAICreateApplication_request_ApiGatewayProxy getApiGatewayProxy() const;
    void setApiGatewayProxy(const OAICreateApplication_request_ApiGatewayProxy &api_gateway_proxy);
    ...
    void setProxyType(const QString &proxy_type);
...
private:
    ...
    OAICreateApplication_request_ApiGatewayProxy m_api_gateway_proxy;
