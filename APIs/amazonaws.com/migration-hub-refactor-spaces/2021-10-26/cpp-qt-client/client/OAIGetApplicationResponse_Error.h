...
/*
 * OAIGetApplicationResponse_Error.h
 *
 * 
 */

#ifndef OAIGetApplicationResponse_Error_H
#define OAIGetApplicationResponse_Error_H
...
class OAIGetApplicationResponse_Error : public OAIObject {
public:
    OAIGetApplicationResponse_Error();
    OAIGetApplicationResponse_Error(QString json);
    ~OAIGetApplicationResponse_Error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetApplicationResponse_Error)

#endif // OAIGetApplicationResponse_Error_H
