...
namespace OpenAPI {
class OAIGetApplicationResponse_ApiGatewayProxy;
...
public:
    ...
    OAIGetApplicationResponse_ApiGatewayProxy getApiGatewayProxy() const;
    void setApiGatewayProxy(const OAIGetApplicationResponse_ApiGatewayProxy &api_gateway_proxy);
...
private:
    ...
    OAIGetApplicationResponse_ApiGatewayProxy m_api_gateway_proxy;
