...
/*
 * OAICreateRouteResponse.h
 *
 * 
 */

#ifndef OAICreateRouteResponse_H
#define OAICreateRouteResponse_H
...
namespace OpenAPI {
class OAICreateRouteResponse_UriPathRoute;

class OAICreateRouteResponse : public OAIObject {
public:
    OAICreateRouteResponse();
    OAICreateRouteResponse(QString json);
    ~OAICreateRouteResponse() override;
    ...
    OAICreateRouteResponse_UriPathRoute getUriPathRoute() const;
    void setUriPathRoute(const OAICreateRouteResponse_UriPathRoute &uri_path_route);
...
private:
    ...
    OAICreateRouteResponse_UriPathRoute m_uri_path_route;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRouteResponse)

#endif // OAICreateRouteResponse_H
