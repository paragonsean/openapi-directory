...
/*
 * OAICreateRoute_request_UriPathRoute.h
 *
 * The configuration for the URI path route type. 
 */

#ifndef OAICreateRoute_request_UriPathRoute_H
#define OAICreateRoute_request_UriPathRoute_H
...
class OAICreateRoute_request_UriPathRoute : public OAIObject {
public:
    OAICreateRoute_request_UriPathRoute();
    OAICreateRoute_request_UriPathRoute(QString json);
    ~OAICreateRoute_request_UriPathRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoute_request_UriPathRoute)

#endif // OAICreateRoute_request_UriPathRoute_H
