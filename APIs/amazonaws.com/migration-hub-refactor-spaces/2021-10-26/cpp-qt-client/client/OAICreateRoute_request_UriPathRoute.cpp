...
OAICreateRoute_request_UriPathRoute::OAICreateRoute_request_UriPathRoute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoute_request_UriPathRoute::OAICreateRoute_request_UriPathRoute() {
    this->initializeModel();
}

OAICreateRoute_request_UriPathRoute::~OAICreateRoute_request_UriPathRoute() {}

void OAICreateRoute_request_UriPathRoute::initializeModel() {
...
void OAICreateRoute_request_UriPathRoute::fromJson(QString jsonString) {
...
void OAICreateRoute_request_UriPathRoute::fromJsonObject(QJsonObject json) {
...
QString OAICreateRoute_request_UriPathRoute::asJson() const {
...
QJsonObject OAICreateRoute_request_UriPathRoute::asJsonObject() const {
    QJsonObject obj;
...
OAIRouteActivationState OAICreateRoute_request_UriPathRoute::getActivationState() const {
    return m_activation_state;
}
void OAICreateRoute_request_UriPathRoute::setActivationState(const OAIRouteActivationState &activation_state) {
    m_activation_state = activation_state;
    m_activation_state_isSet = true;
}

bool OAICreateRoute_request_UriPathRoute::is_activation_state_Set() const{
    return m_activation_state_isSet;
}

bool OAICreateRoute_request_UriPathRoute::is_activation_state_Valid() const{
    return m_activation_state_isValid;
}

bool OAICreateRoute_request_UriPathRoute::getAppendSourcePath() const {
    return m_append_source_path;
}
void OAICreateRoute_request_UriPathRoute::setAppendSourcePath(const bool &append_source_path) {
    m_append_source_path = append_source_path;
    m_append_source_path_isSet = true;
}

bool OAICreateRoute_request_UriPathRoute::is_append_source_path_Set() const{
    return m_append_source_path_isSet;
}

bool OAICreateRoute_request_UriPathRoute::is_append_source_path_Valid() const{
    return m_append_source_path_isValid;
}

bool OAICreateRoute_request_UriPathRoute::getIncludeChildPaths() const {
    return m_include_child_paths;
}
void OAICreateRoute_request_UriPathRoute::setIncludeChildPaths(const bool &include_child_paths) {
    m_include_child_paths = include_child_paths;
    m_include_child_paths_isSet = true;
}

bool OAICreateRoute_request_UriPathRoute::is_include_child_paths_Set() const{
    return m_include_child_paths_isSet;
}

bool OAICreateRoute_request_UriPathRoute::is_include_child_paths_Valid() const{
    return m_include_child_paths_isValid;
}

QList OAICreateRoute_request_UriPathRoute::getMethods() const {
    return m_methods;
}
void OAICreateRoute_request_UriPathRoute::setMethods(const QList &methods) {
    m_methods = methods;
    m_methods_isSet = true;
}

bool OAICreateRoute_request_UriPathRoute::is_methods_Set() const{
    return m_methods_isSet;
}

bool OAICreateRoute_request_UriPathRoute::is_methods_Valid() const{
    return m_methods_isValid;
}

QString OAICreateRoute_request_UriPathRoute::getSourcePath() const {
    return m_source_path;
}
void OAICreateRoute_request_UriPathRoute::setSourcePath(const QString &source_path) {
    m_source_path = source_path;
    m_source_path_isSet = true;
}

bool OAICreateRoute_request_UriPathRoute::is_source_path_Set() const{
    return m_source_path_isSet;
}

bool OAICreateRoute_request_UriPathRoute::is_source_path_Valid() const{
    return m_source_path_isValid;
}

bool OAICreateRoute_request_UriPathRoute::isSet() const {
...
bool OAICreateRoute_request_UriPathRoute::isValid() const {
