...
#include "OAIApiGatewayProxySummary.h"
...
OAIApiGatewayProxySummary::OAIApiGatewayProxySummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApiGatewayProxySummary::OAIApiGatewayProxySummary() {
    this->initializeModel();
}

OAIApiGatewayProxySummary::~OAIApiGatewayProxySummary() {}

void OAIApiGatewayProxySummary::initializeModel() {
...
void OAIApiGatewayProxySummary::fromJson(QString jsonString) {
...
void OAIApiGatewayProxySummary::fromJsonObject(QJsonObject json) {
...
QString OAIApiGatewayProxySummary::asJson() const {
...
QJsonObject OAIApiGatewayProxySummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApiGatewayProxySummary::getApiGatewayId() const {
    return m_api_gateway_id;
}
void OAIApiGatewayProxySummary::setApiGatewayId(const QString &api_gateway_id) {
    m_api_gateway_id = api_gateway_id;
    m_api_gateway_id_isSet = true;
}

bool OAIApiGatewayProxySummary::is_api_gateway_id_Set() const{
    return m_api_gateway_id_isSet;
}

bool OAIApiGatewayProxySummary::is_api_gateway_id_Valid() const{
    return m_api_gateway_id_isValid;
}

OAIApiGatewayEndpointType OAIApiGatewayProxySummary::getEndpointType() const {
    return m_endpoint_type;
}
void OAIApiGatewayProxySummary::setEndpointType(const OAIApiGatewayEndpointType &endpoint_type) {
    m_endpoint_type = endpoint_type;
    m_endpoint_type_isSet = true;
}

bool OAIApiGatewayProxySummary::is_endpoint_type_Set() const{
    return m_endpoint_type_isSet;
}

bool OAIApiGatewayProxySummary::is_endpoint_type_Valid() const{
    return m_endpoint_type_isValid;
}

QString OAIApiGatewayProxySummary::getNlbArn() const {
    return m_nlb_arn;
}
void OAIApiGatewayProxySummary::setNlbArn(const QString &nlb_arn) {
    m_nlb_arn = nlb_arn;
    m_nlb_arn_isSet = true;
}

bool OAIApiGatewayProxySummary::is_nlb_arn_Set() const{
    return m_nlb_arn_isSet;
}

bool OAIApiGatewayProxySummary::is_nlb_arn_Valid() const{
    return m_nlb_arn_isValid;
}

QString OAIApiGatewayProxySummary::getNlbName() const {
    return m_nlb_name;
}
void OAIApiGatewayProxySummary::setNlbName(const QString &nlb_name) {
    m_nlb_name = nlb_name;
    m_nlb_name_isSet = true;
}

bool OAIApiGatewayProxySummary::is_nlb_name_Set() const{
    return m_nlb_name_isSet;
}

bool OAIApiGatewayProxySummary::is_nlb_name_Valid() const{
    return m_nlb_name_isValid;
}

QString OAIApiGatewayProxySummary::getProxyUrl() const {
    return m_proxy_url;
}
void OAIApiGatewayProxySummary::setProxyUrl(const QString &proxy_url) {
    m_proxy_url = proxy_url;
    m_proxy_url_isSet = true;
}

bool OAIApiGatewayProxySummary::is_proxy_url_Set() const{
    return m_proxy_url_isSet;
}

bool OAIApiGatewayProxySummary::is_proxy_url_Valid() const{
    return m_proxy_url_isValid;
}

QString OAIApiGatewayProxySummary::getStageName() const {
    return m_stage_name;
}
void OAIApiGatewayProxySummary::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIApiGatewayProxySummary::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIApiGatewayProxySummary::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

QString OAIApiGatewayProxySummary::getVpcLinkId() const {
    return m_vpc_link_id;
}
void OAIApiGatewayProxySummary::setVpcLinkId(const QString &vpc_link_id) {
    m_vpc_link_id = vpc_link_id;
    m_vpc_link_id_isSet = true;
}

bool OAIApiGatewayProxySummary::is_vpc_link_id_Set() const{
    return m_vpc_link_id_isSet;
}

bool OAIApiGatewayProxySummary::is_vpc_link_id_Valid() const{
    return m_vpc_link_id_isValid;
}

bool OAIApiGatewayProxySummary::isSet() const {
...
bool OAIApiGatewayProxySummary::isValid() const {
