...
async def test_batch_get_traces(client):
    """Test case for batch_get_traces
...
async def test_create_group(client):
    ...
    """
    body = {"GroupName":"","InsightsConfiguration":{"NotificationsEnabled":"","InsightsEnabled":""},"FilterExpression":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_sampling_rule(client):
    """Test case for create_sampling_rule

    
    """
    body = {"SamplingRule":{"Priority":"","ReservoirSize":"","RuleARN":"","URLPath":"","Attributes":"","FixedRate":"","Host":"","ResourceARN":"","ServiceName":"","HTTPMethod":"","Version":"","ServiceType":"","RuleName":""},"Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_resource_policy(client):
    ...
    """
    body = {"PolicyRevisionId":"","PolicyName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_sampling_rule(client):
    """Test case for delete_sampling_rule

    
    """
    body = {"RuleARN":"","RuleName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_encryption_config(client):
    """Test case for get_encryption_config
...
async def test_get_insight_events(client):
    """Test case for get_insight_events
...
async def test_get_insight_impact_graph(client):
    """Test case for get_insight_impact_graph

    
    """
    body = {"EndTime":"","NextToken":"","StartTime":"","InsightId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_insight_summaries(client):
    """Test case for get_insight_summaries

    
    """
    body = {"States":"","GroupName":"","EndTime":"","NextToken":"","GroupARN":"","MaxResults":"","StartTime":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_get_sampling_rules(client):
    """Test case for get_sampling_rules
...
async def test_get_sampling_statistic_summaries(client):
    """Test case for get_sampling_statistic_summaries
...
async def test_get_sampling_targets(client):
    """Test case for get_sampling_targets
...
async def test_get_service_graph(client):
    """Test case for get_service_graph

    
    """
    body = {"GroupName":"","EndTime":"","NextToken":"","GroupARN":"","StartTime":""}
    params = [('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_get_time_series_service_statistics(client):
    """Test case for get_time_series_service_statistics

    
    """
    body = {"GroupName":"","EntitySelectorExpression":"","EndTime":"","NextToken":"","GroupARN":"","ForecastStatistics":"","StartTime":"","Period":""}
    params = [('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_get_trace_graph(client):
    """Test case for get_trace_graph
...
async def test_get_trace_summaries(client):
    """Test case for get_trace_summaries

    
    """
    body = {"TimeRangeType":"","EndTime":"","NextToken":"","StartTime":"","SamplingStrategy":{"Value":"","Name":""},"Sampling":"","FilterExpression":""}
    params = [('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_list_resource_policies(client):
    """Test case for list_resource_policies
...
async def test_put_encryption_config(client):
    """Test case for put_encryption_config
...
async def test_put_resource_policy(client):
    ...
    """
    body = {"PolicyRevisionId":"","BypassPolicyLockoutCheck":"","PolicyName":"","PolicyDocument":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_put_telemetry_records(client):
    """Test case for put_telemetry_records

    
    """
    body = {"ResourceARN":"","TelemetryRecords":"","Hostname":"","EC2InstanceId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_put_trace_segments(client):
    """Test case for put_trace_segments
...
async def test_update_group(client):
    ...
    """
    body = {"GroupName":"","GroupARN":"","InsightsConfiguration":{"NotificationsEnabled":"","InsightsEnabled":""},"FilterExpression":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_sampling_rule(client):
    """Test case for update_sampling_rule

    
    """
    body = {"SamplingRuleUpdate":{"ResourceARN":"","ServiceName":"","HTTPMethod":"","Priority":"","ReservoirSize":"","ServiceType":"","RuleARN":"","URLPath":"","Attributes":"","FixedRate":"","Host":"","RuleName":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
