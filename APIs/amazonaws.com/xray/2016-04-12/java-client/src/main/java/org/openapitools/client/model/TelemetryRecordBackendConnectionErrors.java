...
public class TelemetryRecordBackendConnectionErrors {
  ...
  public TelemetryRecordBackendConnectionErrors() {
  }

  public TelemetryRecordBackendConnectionErrors timeoutCount(Integer timeoutCount) {
  ...
  public TelemetryRecordBackendConnectionErrors connectionRefusedCount(Integer connectionRefusedCount) {
  ...
  public TelemetryRecordBackendConnectionErrors htTPCode4XXCount(Integer htTPCode4XXCount) {
  ...
  public TelemetryRecordBackendConnectionErrors htTPCode5XXCount(Integer htTPCode5XXCount) {
  ...
  public TelemetryRecordBackendConnectionErrors unknownHostCount(Integer unknownHostCount) {
  ...
  public TelemetryRecordBackendConnectionErrors otherCount(Integer otherCount) {
  ...
  public boolean equals(Object o) {
    ...
    TelemetryRecordBackendConnectionErrors telemetryRecordBackendConnectionErrors = (TelemetryRecordBackendConnectionErrors) o;
    return Objects.equals(this.timeoutCount, telemetryRecordBackendConnectionErrors.timeoutCount) &&
        Objects.equals(this.connectionRefusedCount, telemetryRecordBackendConnectionErrors.connectionRefusedCount) &&
        Objects.equals(this.htTPCode4XXCount, telemetryRecordBackendConnectionErrors.htTPCode4XXCount) &&
        Objects.equals(this.htTPCode5XXCount, telemetryRecordBackendConnectionErrors.htTPCode5XXCount) &&
        Objects.equals(this.unknownHostCount, telemetryRecordBackendConnectionErrors.unknownHostCount) &&
        Objects.equals(this.otherCount, telemetryRecordBackendConnectionErrors.otherCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class TelemetryRecordBackendConnectionErrors {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TelemetryRecordBackendConnectionErrors
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TelemetryRecordBackendConnectionErrors.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TelemetryRecordBackendConnectionErrors is not found in the empty JSON string", TelemetryRecordBackendConnectionErrors.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TelemetryRecordBackendConnectionErrors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TelemetryRecordBackendConnectionErrors` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TelemetryRecordBackendConnectionErrors.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TelemetryRecordBackendConnectionErrors' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TelemetryRecordBackendConnectionErrors> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TelemetryRecordBackendConnectionErrors.class));

       return (TypeAdapter<T>) new TypeAdapter<TelemetryRecordBackendConnectionErrors>() {
           @Override
           public void write(JsonWriter out, TelemetryRecordBackendConnectionErrors value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TelemetryRecordBackendConnectionErrors read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TelemetryRecordBackendConnectionErrors given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TelemetryRecordBackendConnectionErrors
   * @throws IOException if the JSON string is invalid with respect to TelemetryRecordBackendConnectionErrors
   */
  public static TelemetryRecordBackendConnectionErrors fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TelemetryRecordBackendConnectionErrors.class);
  }

  /**
   * Convert an instance of TelemetryRecordBackendConnectionErrors to an JSON string
   *
   * @return JSON string
   */
