...
public class SamplingRule {
  ...
  public SamplingRule ruleName(String ruleName) {
  ...
  public SamplingRule ruleARN(String ruleARN) {
  ...
  public SamplingRule resourceARN(String resourceARN) {
  ...
  public SamplingRule priority(Integer priority) {
  ...
  public SamplingRule fixedRate(Double fixedRate) {
  ...
  public SamplingRule reservoirSize(Integer reservoirSize) {
  ...
  public SamplingRule serviceName(String serviceName) {
  ...
  public SamplingRule serviceType(String serviceType) {
  ...
  public SamplingRule host(String host) {
    this.host = host;
    return this;
  }
  ...
  public SamplingRule htTPMethod(String htTPMethod) {
  ...
  public SamplingRule urLPath(String urLPath) {
  ...
  public SamplingRule version(Integer version) {
  ...
  public SamplingRule attributes(Map attributes) {
  ...
  public boolean equals(Object o) {
    ...
    SamplingRule samplingRule = (SamplingRule) o;
    return Objects.equals(this.ruleName, samplingRule.ruleName) &&
        Objects.equals(this.ruleARN, samplingRule.ruleARN) &&
        Objects.equals(this.resourceARN, samplingRule.resourceARN) &&
        Objects.equals(this.priority, samplingRule.priority) &&
        Objects.equals(this.fixedRate, samplingRule.fixedRate) &&
        Objects.equals(this.reservoirSize, samplingRule.reservoirSize) &&
        Objects.equals(this.serviceName, samplingRule.serviceName) &&
        Objects.equals(this.serviceType, samplingRule.serviceType) &&
        Objects.equals(this.host, samplingRule.host) &&
        Objects.equals(this.htTPMethod, samplingRule.htTPMethod) &&
        Objects.equals(this.urLPath, samplingRule.urLPath) &&
        Objects.equals(this.version, samplingRule.version) &&
        Objects.equals(this.attributes, samplingRule.attributes);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SamplingRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SamplingRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SamplingRule is not found in the empty JSON string", SamplingRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SamplingRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SamplingRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SamplingRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SamplingRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SamplingRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SamplingRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SamplingRule.class));

       return (TypeAdapter<T>) new TypeAdapter<SamplingRule>() {
           @Override
           public void write(JsonWriter out, SamplingRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SamplingRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SamplingRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SamplingRule
   * @throws IOException if the JSON string is invalid with respect to SamplingRule
   */
  public static SamplingRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SamplingRule.class);
  }

  /**
   * Convert an instance of SamplingRule to an JSON string
   *
   * @return JSON string
   */
