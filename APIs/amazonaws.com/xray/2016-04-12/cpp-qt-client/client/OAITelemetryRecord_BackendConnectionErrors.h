...
/*
 * OAITelemetryRecord_BackendConnectionErrors.h
 *
 * 
 */

#ifndef OAITelemetryRecord_BackendConnectionErrors_H
#define OAITelemetryRecord_BackendConnectionErrors_H
...
class OAITelemetryRecord_BackendConnectionErrors : public OAIObject {
public:
    OAITelemetryRecord_BackendConnectionErrors();
    OAITelemetryRecord_BackendConnectionErrors(QString json);
    ~OAITelemetryRecord_BackendConnectionErrors() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITelemetryRecord_BackendConnectionErrors)

#endif // OAITelemetryRecord_BackendConnectionErrors_H
