...
/*
 * OAIFaultStatistics.h
 *
 * Information about requests that failed with a 5xx Server Error status code.
 */

#ifndef OAIFaultStatistics_H
#define OAIFaultStatistics_H
...
class OAIFaultStatistics : public OAIObject {
public:
    OAIFaultStatistics();
    OAIFaultStatistics(QString json);
    ~OAIFaultStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaultStatistics)

#endif // OAIFaultStatistics_H
