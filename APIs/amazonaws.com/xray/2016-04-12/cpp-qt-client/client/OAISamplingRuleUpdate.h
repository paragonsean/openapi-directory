...
/*
 * OAISamplingRuleUpdate.h
 *
 * A document specifying changes to a sampling rule&#39;s configuration.
 */

#ifndef OAISamplingRuleUpdate_H
#define OAISamplingRuleUpdate_H
...
class OAISamplingRuleUpdate : public OAIObject {
public:
    OAISamplingRuleUpdate();
    OAISamplingRuleUpdate(QString json);
    ~OAISamplingRuleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISamplingRuleUpdate)

#endif // OAISamplingRuleUpdate_H
