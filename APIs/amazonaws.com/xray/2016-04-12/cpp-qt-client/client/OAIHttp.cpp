...
QString OAIHttp::getHttpUrl() const {
    return m_http_url;
}
void OAIHttp::setHttpUrl(const QString &http_url) {
    m_http_url = http_url;
    m_http_url_isSet = true;
}

bool OAIHttp::is_http_url_Set() const{
    return m_http_url_isSet;
}

bool OAIHttp::is_http_url_Valid() const{
    return m_http_url_isValid;
}

qint32 OAIHttp::getHttpStatus() const {
    return m_http_status;
}
void OAIHttp::setHttpStatus(const qint32 &http_status) {
    m_http_status = http_status;
    m_http_status_isSet = true;
}

bool OAIHttp::is_http_status_Set() const{
    return m_http_status_isSet;
}

bool OAIHttp::is_http_status_Valid() const{
    return m_http_status_isValid;
}

QString OAIHttp::getHttpMethod() const {
    return m_http_method;
}
void OAIHttp::setHttpMethod(const QString &http_method) {
    m_http_method = http_method;
    m_http_method_isSet = true;
}

bool OAIHttp::is_http_method_Set() const{
    return m_http_method_isSet;
}

bool OAIHttp::is_http_method_Valid() const{
    return m_http_method_isValid;
}

QString OAIHttp::getUserAgent() const {
    return m_user_agent;
}
void OAIHttp::setUserAgent(const QString &user_agent) {
    m_user_agent = user_agent;
    m_user_agent_isSet = true;
}

bool OAIHttp::is_user_agent_Set() const{
    return m_user_agent_isSet;
}

bool OAIHttp::is_user_agent_Valid() const{
    return m_user_agent_isValid;
}

QString OAIHttp::getClientIp() const {
    return m_client_ip;
}
void OAIHttp::setClientIp(const QString &client_ip) {
    m_client_ip = client_ip;
    m_client_ip_isSet = true;
}

bool OAIHttp::is_client_ip_Set() const{
    return m_client_ip_isSet;
}

bool OAIHttp::is_client_ip_Valid() const{
