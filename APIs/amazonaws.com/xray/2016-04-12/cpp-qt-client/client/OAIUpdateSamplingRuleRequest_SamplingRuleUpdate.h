...
/*
 * OAIUpdateSamplingRuleRequest_SamplingRuleUpdate.h
 *
 * 
 */

#ifndef OAIUpdateSamplingRuleRequest_SamplingRuleUpdate_H
#define OAIUpdateSamplingRuleRequest_SamplingRuleUpdate_H
...
class OAIUpdateSamplingRuleRequest_SamplingRuleUpdate : public OAIObject {
public:
    OAIUpdateSamplingRuleRequest_SamplingRuleUpdate();
    OAIUpdateSamplingRuleRequest_SamplingRuleUpdate(QString json);
    ~OAIUpdateSamplingRuleRequest_SamplingRuleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSamplingRuleRequest_SamplingRuleUpdate)

#endif // OAIUpdateSamplingRuleRequest_SamplingRuleUpdate_H
