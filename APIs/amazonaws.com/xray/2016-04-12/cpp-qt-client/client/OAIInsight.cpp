...
QString OAIInsight::getInsightId() const {
    return m_insight_id;
}
void OAIInsight::setInsightId(const QString &insight_id) {
    m_insight_id = insight_id;
    m_insight_id_isSet = true;
}

bool OAIInsight::is_insight_id_Set() const{
    return m_insight_id_isSet;
}

bool OAIInsight::is_insight_id_Valid() const{
    return m_insight_id_isValid;
}

QString OAIInsight::getGroupArn() const {
    return m_group_arn;
}
void OAIInsight::setGroupArn(const QString &group_arn) {
    m_group_arn = group_arn;
    m_group_arn_isSet = true;
}

bool OAIInsight::is_group_arn_Set() const{
    return m_group_arn_isSet;
}

bool OAIInsight::is_group_arn_Valid() const{
    return m_group_arn_isValid;
}

QString OAIInsight::getGroupName() const {
    return m_group_name;
}
void OAIInsight::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIInsight::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIInsight::is_group_name_Valid() const{
    return m_group_name_isValid;
}

OAIServiceId OAIInsight::getRootCauseServiceId() const {
    return m_root_cause_service_id;
}
void OAIInsight::setRootCauseServiceId(const OAIServiceId &root_cause_service_id) {
    m_root_cause_service_id = root_cause_service_id;
    m_root_cause_service_id_isSet = true;
}

bool OAIInsight::is_root_cause_service_id_Set() const{
    return m_root_cause_service_id_isSet;
}

bool OAIInsight::is_root_cause_service_id_Valid() const{
    return m_root_cause_service_id_isValid;
}

QList OAIInsight::getCategories() const {
    return m_categories;
}
void OAIInsight::setCategories(const QList &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAIInsight::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAIInsight::is_categories_Valid() const{
    return m_categories_isValid;
}

OAIInsightState OAIInsight::getState() const {
    return m_state;
}
void OAIInsight::setState(const OAIInsightState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIInsight::is_state_Set() const{
    return m_state_isSet;
}

bool OAIInsight::is_state_Valid() const{
    return m_state_isValid;
}

QDateTime OAIInsight::getStartTime() const {
    return m_start_time;
}
void OAIInsight::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIInsight::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIInsight::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIInsight::getEndTime() const {
    return m_end_time;
}
void OAIInsight::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIInsight::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIInsight::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIInsight::getSummary() const {
    return m_summary;
}
void OAIInsight::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIInsight::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIInsight::is_summary_Valid() const{
    return m_summary_isValid;
}

OAIInsight_ClientRequestImpactStatistics OAIInsight::getClientRequestImpactStatistics() const {
    return m_client_request_impact_statistics;
}
void OAIInsight::setClientRequestImpactStatistics(const OAIInsight_ClientRequestImpactStatistics &client_request_impact_statistics) {
    m_client_request_impact_statistics = client_request_impact_statistics;
    m_client_request_impact_statistics_isSet = true;
}

bool OAIInsight::is_client_request_impact_statistics_Set() const{
    return m_client_request_impact_statistics_isSet;
}

bool OAIInsight::is_client_request_impact_statistics_Valid() const{
    return m_client_request_impact_statistics_isValid;
}

OAIInsight_RootCauseServiceRequestImpactStatistics OAIInsight::getRootCauseServiceRequestImpactStatistics() const {
    return m_root_cause_service_request_impact_statistics;
}
void OAIInsight::setRootCauseServiceRequestImpactStatistics(const OAIInsight_RootCauseServiceRequestImpactStatistics &root_cause_service_request_impact_statistics) {
...
bool OAIInsight::is_root_cause_service_request_impact_statistics_Set() const{
    return m_root_cause_service_request_impact_statistics_isSet;
}

bool OAIInsight::is_root_cause_service_request_impact_statistics_Valid() const{
    return m_root_cause_service_request_impact_statistics_isValid;
}

QList OAIInsight::getTopAnomalousServices() const {
    return m_top_anomalous_services;
}
void OAIInsight::setTopAnomalousServices(const QList &top_anomalous_services) {
    m_top_anomalous_services = top_anomalous_services;
    m_top_anomalous_services_isSet = true;
}

bool OAIInsight::is_top_anomalous_services_Set() const{
    return m_top_anomalous_services_isSet;
}

bool OAIInsight::is_top_anomalous_services_Valid() const{
