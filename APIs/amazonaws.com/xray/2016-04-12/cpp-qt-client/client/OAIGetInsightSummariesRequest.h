...
/*
 * OAIGetInsightSummariesRequest.h
 *
 * 
 */

#ifndef OAIGetInsightSummariesRequest_H
#define OAIGetInsightSummariesRequest_H
...
class OAIGetInsightSummariesRequest : public OAIObject {
public:
    OAIGetInsightSummariesRequest();
    OAIGetInsightSummariesRequest(QString json);
    ~OAIGetInsightSummariesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInsightSummariesRequest)

#endif // OAIGetInsightSummariesRequest_H
