...
/*
 * OAISamplingStatisticsDocument.h
 *
...
#ifndef OAISamplingStatisticsDocument_H
#define OAISamplingStatisticsDocument_H
...
class OAISamplingStatisticsDocument : public OAIObject {
public:
    OAISamplingStatisticsDocument();
    OAISamplingStatisticsDocument(QString json);
    ~OAISamplingStatisticsDocument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISamplingStatisticsDocument)

#endif // OAISamplingStatisticsDocument_H
