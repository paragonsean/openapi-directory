...
/*
 * OAISamplingRuleRecord_SamplingRule.h
 *
 * 
 */

#ifndef OAISamplingRuleRecord_SamplingRule_H
#define OAISamplingRuleRecord_SamplingRule_H
...
class OAISamplingRuleRecord_SamplingRule : public OAIObject {
public:
    OAISamplingRuleRecord_SamplingRule();
    OAISamplingRuleRecord_SamplingRule(QString json);
    ~OAISamplingRuleRecord_SamplingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISamplingRuleRecord_SamplingRule)

#endif // OAISamplingRuleRecord_SamplingRule_H
