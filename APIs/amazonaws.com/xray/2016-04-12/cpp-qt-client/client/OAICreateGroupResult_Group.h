...
/*
 * OAICreateGroupResult_Group.h
 *
 * 
 */

#ifndef OAICreateGroupResult_Group_H
#define OAICreateGroupResult_Group_H
...
namespace OpenAPI {
class OAIGroup_InsightsConfiguration;

class OAICreateGroupResult_Group : public OAIObject {
public:
    OAICreateGroupResult_Group();
    OAICreateGroupResult_Group(QString json);
    ~OAICreateGroupResult_Group() override;
    ...
    OAIGroup_InsightsConfiguration getInsightsConfiguration() const;
    void setInsightsConfiguration(const OAIGroup_InsightsConfiguration &insights_configuration);
...
private:
    ...
    OAIGroup_InsightsConfiguration m_insights_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroupResult_Group)

#endif // OAICreateGroupResult_Group_H
