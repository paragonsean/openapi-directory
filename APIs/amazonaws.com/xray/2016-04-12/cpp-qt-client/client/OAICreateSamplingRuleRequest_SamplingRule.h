...
/*
 * OAICreateSamplingRuleRequest_SamplingRule.h
 *
 * 
 */

#ifndef OAICreateSamplingRuleRequest_SamplingRule_H
#define OAICreateSamplingRuleRequest_SamplingRule_H
...
class OAICreateSamplingRuleRequest_SamplingRule : public OAIObject {
public:
    OAICreateSamplingRuleRequest_SamplingRule();
    OAICreateSamplingRuleRequest_SamplingRule(QString json);
    ~OAICreateSamplingRuleRequest_SamplingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSamplingRuleRequest_SamplingRule)

#endif // OAICreateSamplingRuleRequest_SamplingRule_H
