...
/*
 * OAICreateSamplingRule_request_SamplingRule.h
 *
 * A sampling rule that services use to decide whether to instrument a request. Rule fields can match properties of the service, or properties of a request. The service can ignore rules that don&#39;t match its properties.
 */

#ifndef OAICreateSamplingRule_request_SamplingRule_H
#define OAICreateSamplingRule_request_SamplingRule_H
...
class OAICreateSamplingRule_request_SamplingRule : public OAIObject {
public:
    OAICreateSamplingRule_request_SamplingRule();
    OAICreateSamplingRule_request_SamplingRule(QString json);
    ~OAICreateSamplingRule_request_SamplingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSamplingRule_request_SamplingRule)

#endif // OAICreateSamplingRule_request_SamplingRule_H
