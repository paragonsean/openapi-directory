...
namespace OpenAPI {
class OAIUpdateGroupRequest_InsightsConfiguration;
...
public:
    ...
    OAIUpdateGroupRequest_InsightsConfiguration getInsightsConfiguration() const;
    void setInsightsConfiguration(const OAIUpdateGroupRequest_InsightsConfiguration &insights_configuration);
...
private:
    ...
    OAIUpdateGroupRequest_InsightsConfiguration m_insights_configuration;
