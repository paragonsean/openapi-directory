...
/*
 * OAIEdgeStatistics_FaultStatistics.h
 *
 * 
 */

#ifndef OAIEdgeStatistics_FaultStatistics_H
#define OAIEdgeStatistics_FaultStatistics_H
...
class OAIEdgeStatistics_FaultStatistics : public OAIObject {
public:
    OAIEdgeStatistics_FaultStatistics();
    OAIEdgeStatistics_FaultStatistics(QString json);
    ~OAIEdgeStatistics_FaultStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEdgeStatistics_FaultStatistics)

#endif // OAIEdgeStatistics_FaultStatistics_H
