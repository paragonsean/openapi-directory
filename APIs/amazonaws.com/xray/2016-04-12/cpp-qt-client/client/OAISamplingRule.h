...
#ifndef OAISamplingRule_H
#define OAISamplingRule_H
...
class OAISamplingRule : public OAIObject {
public:
    OAISamplingRule();
    OAISamplingRule(QString json);
    ~OAISamplingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISamplingRule)

#endif // OAISamplingRule_H
