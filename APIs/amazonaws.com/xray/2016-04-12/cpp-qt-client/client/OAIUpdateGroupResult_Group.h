...
/*
 * OAIUpdateGroupResult_Group.h
 *
 * 
 */

#ifndef OAIUpdateGroupResult_Group_H
#define OAIUpdateGroupResult_Group_H
...
class OAIUpdateGroupResult_Group : public OAIObject {
public:
    OAIUpdateGroupResult_Group();
    OAIUpdateGroupResult_Group(QString json);
    ~OAIUpdateGroupResult_Group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupResult_Group)

#endif // OAIUpdateGroupResult_Group_H
