# AwsXRay.GetTimeSeriesServiceStatisticsRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**startTime** | **Date** | The start of the time frame for which to aggregate statistics. | 
**endTime** | **Date** | The end of the time frame for which to aggregate statistics. | 
...
**period** | **Number** | Aggregation period in seconds. | [optional] 
