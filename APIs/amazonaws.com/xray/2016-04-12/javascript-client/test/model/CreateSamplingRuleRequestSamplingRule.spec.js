...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.CreateSamplingRuleRequestSamplingRule();
  });
  ...
  describe('CreateSamplingRuleRequestSamplingRule', function() {
    it('should create an instance of CreateSamplingRuleRequestSamplingRule', function() {
      // uncomment below and update the code to test CreateSamplingRuleRequestSamplingRule
      //var instance = new AwsXRay.CreateSamplingRuleRequestSamplingRule();
      //expect(instance).to.be.a(AwsXRay.CreateSamplingRuleRequestSamplingRule);
    });
