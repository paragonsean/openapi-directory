...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.SamplingRule();
  });
  ...
  describe('SamplingRule', function() {
    it('should create an instance of SamplingRule', function() {
      // uncomment below and update the code to test SamplingRule
      //var instance = new AwsXRay.SamplingRule();
      //expect(instance).to.be.a(AwsXRay.SamplingRule);
    });
