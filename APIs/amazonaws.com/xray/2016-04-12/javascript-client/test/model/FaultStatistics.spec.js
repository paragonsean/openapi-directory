...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.FaultStatistics();
  });
  ...
  describe('FaultStatistics', function() {
    it('should create an instance of FaultStatistics', function() {
      // uncomment below and update the code to test FaultStatistics
      //var instance = new AwsXRay.FaultStatistics();
      //expect(instance).to.be.a(AwsXRay.FaultStatistics);
    });
