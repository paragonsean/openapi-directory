...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.AnnotationValue();
  });
  ...
  describe('AnnotationValue', function() {
    it('should create an instance of AnnotationValue', function() {
      // uncomment below and update the code to test AnnotationValue
      //var instance = new AwsXRay.AnnotationValue();
      //expect(instance).to.be.a(AwsXRay.AnnotationValue);
    });
