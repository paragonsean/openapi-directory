...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.InsightImpactGraphService();
  });
  ...
  describe('InsightImpactGraphService', function() {
    it('should create an instance of InsightImpactGraphService', function() {
      // uncomment below and update the code to test InsightImpactGraphService
      //var instance = new AwsXRay.InsightImpactGraphService();
      //expect(instance).to.be.a(AwsXRay.InsightImpactGraphService);
    });
