...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.GetTraceGraphResult();
  });
  ...
  describe('GetTraceGraphResult', function() {
    it('should create an instance of GetTraceGraphResult', function() {
      // uncomment below and update the code to test GetTraceGraphResult
      //var instance = new AwsXRay.GetTraceGraphResult();
      //expect(instance).to.be.a(AwsXRay.GetTraceGraphResult);
    });
