...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.ValueWithServiceIdsAnnotationValue();
  });
  ...
  describe('ValueWithServiceIdsAnnotationValue', function() {
    it('should create an instance of ValueWithServiceIdsAnnotationValue', function() {
      // uncomment below and update the code to test ValueWithServiceIdsAnnotationValue
      //var instance = new AwsXRay.ValueWithServiceIdsAnnotationValue();
      //expect(instance).to.be.a(AwsXRay.ValueWithServiceIdsAnnotationValue);
    });
