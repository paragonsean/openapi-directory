...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.UnprocessedStatistics();
  });
  ...
  describe('UnprocessedStatistics', function() {
    it('should create an instance of UnprocessedStatistics', function() {
      // uncomment below and update the code to test UnprocessedStatistics
      //var instance = new AwsXRay.UnprocessedStatistics();
      //expect(instance).to.be.a(AwsXRay.UnprocessedStatistics);
    });
