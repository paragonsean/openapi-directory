...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.GetInsightSummariesRequest();
  });
  ...
  describe('GetInsightSummariesRequest', function() {
    it('should create an instance of GetInsightSummariesRequest', function() {
      // uncomment below and update the code to test GetInsightSummariesRequest
      //var instance = new AwsXRay.GetInsightSummariesRequest();
      //expect(instance).to.be.a(AwsXRay.GetInsightSummariesRequest);
    });
