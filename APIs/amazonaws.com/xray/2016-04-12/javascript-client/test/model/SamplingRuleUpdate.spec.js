...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsXRay.SamplingRuleUpdate();
  });
  ...
  describe('SamplingRuleUpdate', function() {
    it('should create an instance of SamplingRuleUpdate', function() {
      // uncomment below and update the code to test SamplingRuleUpdate
      //var instance = new AwsXRay.SamplingRuleUpdate();
      //expect(instance).to.be.a(AwsXRay.SamplingRuleUpdate);
    });
