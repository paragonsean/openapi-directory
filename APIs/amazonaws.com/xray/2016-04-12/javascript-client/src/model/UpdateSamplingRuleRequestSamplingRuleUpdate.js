...
import SamplingRuleUpdate from './SamplingRuleUpdate';

/**
 * The UpdateSamplingRuleRequestSamplingRuleUpdate model module.
 * @module model/UpdateSamplingRuleRequestSamplingRuleUpdate
 * @version 2016-04-12
 */
class UpdateSamplingRuleRequestSamplingRuleUpdate {
    /**
     * Constructs a new <code>UpdateSamplingRuleRequestSamplingRuleUpdate</code>.
     * @alias module:model/UpdateSamplingRuleRequestSamplingRuleUpdate
     * @implements module:model/SamplingRuleUpdate
     */
    constructor() { 
        SamplingRuleUpdate.initialize(this);
        UpdateSamplingRuleRequestSamplingRuleUpdate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSamplingRuleRequestSamplingRuleUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSamplingRuleRequestSamplingRuleUpdate} obj Optional instance to populate.
     * @return {module:model/UpdateSamplingRuleRequestSamplingRuleUpdate} The populated <code>UpdateSamplingRuleRequestSamplingRuleUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSamplingRuleRequestSamplingRuleUpdate();
            SamplingRuleUpdate.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSamplingRuleRequestSamplingRuleUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSamplingRuleRequestSamplingRuleUpdate</code>.
     */
 ...
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['RuleName'] = undefined;

/**
 * @member {String} RuleARN
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['RuleARN'] = undefined;

/**
 * @member {String} ResourceARN
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['ResourceARN'] = undefined;

/**
 * @member {Number} Priority
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['Priority'] = undefined;

/**
 * @member {Number} FixedRate
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['FixedRate'] = undefined;

/**
 * @member {Number} ReservoirSize
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['ReservoirSize'] = undefined;

/**
 * @member {String} Host
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['Host'] = undefined;

/**
 * @member {String} ServiceName
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['ServiceName'] = undefined;

/**
 * @member {String} ServiceType
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['ServiceType'] = undefined;

/**
 * @member {String} HTTPMethod
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['HTTPMethod'] = undefined;

/**
 * @member {String} URLPath
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['URLPath'] = undefined;

/**
 * @member {Object} Attributes
 */
UpdateSamplingRuleRequestSamplingRuleUpdate.prototype['Attributes'] = undefined;


// Implement SamplingRuleUpdate interface:
/**
 * @member {String} RuleName
 */
...
export default UpdateSamplingRuleRequestSamplingRuleUpdate;
