...
/**
 * The SamplingRule model module.
 * @module model/SamplingRule
 * @version 2016-04-12
 */
class SamplingRule {
    /**
     * Constructs a new <code>SamplingRule</code>.
     * A sampling rule that services use to decide whether to instrument a request. Rule fields can match properties of the service, or properties of a request. The service can ignore rules that don&#39;t match its properties.
     * @alias module:model/SamplingRule
    ...
    /**
     * Constructs a <code>SamplingRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SamplingRule} obj Optional instance to populate.
     * @return {module:model/SamplingRule} The populated <code>SamplingRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SamplingRule();
    ...
    /**
     * Validates the JSON data with respect to <code>SamplingRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SamplingRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SamplingRule.RequiredProperties) {
...
SamplingRule.RequiredProperties = ["ResourceARN", "Priority", "FixedRate", "ReservoirSize", "ServiceName", "ServiceType", "Host", "HTTPMethod", "URLPath", "Version"];
