...
/**
 * The AnnotationValue model module.
 * @module model/AnnotationValue
 * @version 2016-04-12
 */
class AnnotationValue {
    /**
     * Constructs a new <code>AnnotationValue</code>.
     * Value of a segment annotation. Has one of three value types: Number, Boolean, or String.
     * @alias module:model/AnnotationValue
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AnnotationValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnnotationValue} obj Optional instance to populate.
     * @return {module:model/AnnotationValue} The populated <code>AnnotationValue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnnotationValue();
    ...
    /**
     * Validates the JSON data with respect to <code>AnnotationValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnnotationValue</code>.
     */
