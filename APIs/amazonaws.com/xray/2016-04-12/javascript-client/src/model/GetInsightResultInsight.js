...
/**
 * The GetInsightResultInsight model module.
 * @module model/GetInsightResultInsight
 * @version 2016-04-12
 */
class GetInsightResultInsight {
    /**
     * Constructs a new <code>GetInsightResultInsight</code>.
     * @alias module:model/GetInsightResultInsight
     * @implements module:model/Insight
     */
    constructor() { 
        Insight.initialize(this);
        GetInsightResultInsight.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetInsightResultInsight</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInsightResultInsight} obj Optional instance to populate.
     * @return {module:model/GetInsightResultInsight} The populated <code>GetInsightResultInsight</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInsightResultInsight();
            Insight.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetInsightResultInsight</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInsightResultInsight</code>.
     */
 ...
 */
GetInsightResultInsight.prototype['InsightId'] = undefined;

/**
 * @member {String} GroupARN
 */
GetInsightResultInsight.prototype['GroupARN'] = undefined;

/**
 * @member {String} GroupName
 */
GetInsightResultInsight.prototype['GroupName'] = undefined;

/**
 * @member {module:model/ServiceId} RootCauseServiceId
 */
GetInsightResultInsight.prototype['RootCauseServiceId'] = undefined;

/**
 * @member {Array} Categories
 */
GetInsightResultInsight.prototype['Categories'] = undefined;

/**
 * @member {module:model/InsightState} State
 */
GetInsightResultInsight.prototype['State'] = undefined;

/**
 * @member {Date} StartTime
 */
GetInsightResultInsight.prototype['StartTime'] = undefined;

/**
 * @member {Date} EndTime
 */
GetInsightResultInsight.prototype['EndTime'] = undefined;

/**
 * @member {String} Summary
 */
GetInsightResultInsight.prototype['Summary'] = undefined;

/**
 * @member {module:model/InsightClientRequestImpactStatistics} ClientRequestImpactStatistics
 */
GetInsightResultInsight.prototype['ClientRequestImpactStatistics'] = undefined;

/**
 * @member {module:model/InsightRootCauseServiceRequestImpactStatistics} RootCauseServiceRequestImpactStatistics
 */
GetInsightResultInsight.prototype['RootCauseServiceRequestImpactStatistics'] = undefined;

/**
 * @member {Array} TopAnomalousServices
 */
GetInsightResultInsight.prototype['TopAnomalousServices'] = undefined;


// Implement Insight interface:
/**
 * @member {String} InsightId
 */
...
export default GetInsightResultInsight;
