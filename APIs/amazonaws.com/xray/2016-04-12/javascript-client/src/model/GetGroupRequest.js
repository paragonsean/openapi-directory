 ...
 * @module model/GetGroupRequest
 * @version 2016-04-12
 */
class GetGroupRequest {
    /**
     * Constructs a new <code>GetGroupRequest</code>.
     * @alias module:model/GetGroupRequest
     */
    constructor() { 
     ...
     * @param {module:model/GetGroupRequest} obj Optional instance to populate.
     * @return {module:model/GetGroupRequest} The populated <code>GetGroupRequest</code> instance.
     */
 ...
 */
GetGroupRequest.prototype['GroupName'] = undefined;

/**
 * @member {String} GroupARN
 */
GetGroupRequest.prototype['GroupARN'] = undefined;
