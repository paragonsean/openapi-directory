...
public class ParentSavingsPlanOffering {
  ...
  public ParentSavingsPlanOffering offeringId(String offeringId) {
  ...
  public ParentSavingsPlanOffering paymentOption(SavingsPlanPaymentOption paymentOption) {
  ...
  public ParentSavingsPlanOffering planType(SavingsPlanType planType) {
  ...
  public ParentSavingsPlanOffering durationSeconds(Integer durationSeconds) {
  ...
  public ParentSavingsPlanOffering currency(CurrencyCode currency) {
  ...
  public ParentSavingsPlanOffering planDescription(String planDescription) {
  ...
  public boolean equals(Object o) {
    ...
    ParentSavingsPlanOffering parentSavingsPlanOffering = (ParentSavingsPlanOffering) o;
    return Objects.equals(this.offeringId, parentSavingsPlanOffering.offeringId) &&
        Objects.equals(this.paymentOption, parentSavingsPlanOffering.paymentOption) &&
        Objects.equals(this.planType, parentSavingsPlanOffering.planType) &&
        Objects.equals(this.durationSeconds, parentSavingsPlanOffering.durationSeconds) &&
        Objects.equals(this.currency, parentSavingsPlanOffering.currency) &&
        Objects.equals(this.planDescription, parentSavingsPlanOffering.planDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParentSavingsPlanOffering {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParentSavingsPlanOffering
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParentSavingsPlanOffering.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParentSavingsPlanOffering is not found in the empty JSON string", ParentSavingsPlanOffering.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParentSavingsPlanOffering.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParentSavingsPlanOffering` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParentSavingsPlanOffering.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParentSavingsPlanOffering' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParentSavingsPlanOffering> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParentSavingsPlanOffering.class));

       return (TypeAdapter<T>) new TypeAdapter<ParentSavingsPlanOffering>() {
           @Override
           public void write(JsonWriter out, ParentSavingsPlanOffering value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ParentSavingsPlanOffering read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ParentSavingsPlanOffering given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ParentSavingsPlanOffering
   * @throws IOException if the JSON string is invalid with respect to ParentSavingsPlanOffering
   */
  public static ParentSavingsPlanOffering fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParentSavingsPlanOffering.class);
  }

  /**
   * Convert an instance of ParentSavingsPlanOffering to an JSON string
   *
   * @return JSON string
   */
