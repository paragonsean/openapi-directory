...
|**purchaseTime** | **OffsetDateTime** | The time at which to purchase the Savings Plan, in UTC format (YYYY-MM-DDTHH:MM:SSZ). |  [optional] |
|**clientToken** | **String** | Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. |  [optional] |
|**tags** | **Map&lt;String, String&gt;** | One or more tags. |  [optional] |
