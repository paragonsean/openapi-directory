...
/*
 * OAIDescribeSavingsPlanRatesResponse.h
 *
 * 
 */

#ifndef OAIDescribeSavingsPlanRatesResponse_H
#define OAIDescribeSavingsPlanRatesResponse_H
...
class OAIDescribeSavingsPlanRatesResponse : public OAIObject {
public:
    OAIDescribeSavingsPlanRatesResponse();
    OAIDescribeSavingsPlanRatesResponse(QString json);
    ~OAIDescribeSavingsPlanRatesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSavingsPlanRatesResponse)

#endif // OAIDescribeSavingsPlanRatesResponse_H
