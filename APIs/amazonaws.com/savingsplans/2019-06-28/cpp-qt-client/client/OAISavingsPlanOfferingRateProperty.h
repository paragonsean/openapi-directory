...
/*
 * OAISavingsPlanOfferingRateProperty.h
 *
 * Information about a property.
 */

#ifndef OAISavingsPlanOfferingRateProperty_H
#define OAISavingsPlanOfferingRateProperty_H
...
class OAISavingsPlanOfferingRateProperty : public OAIObject {
public:
    OAISavingsPlanOfferingRateProperty();
    OAISavingsPlanOfferingRateProperty(QString json);
    ~OAISavingsPlanOfferingRateProperty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavingsPlanOfferingRateProperty)

#endif // OAISavingsPlanOfferingRateProperty_H
