...
/*
 * OAIDeleteQueuedSavingsPlan_request.h
 *
 * 
 */

#ifndef OAIDeleteQueuedSavingsPlan_request_H
#define OAIDeleteQueuedSavingsPlan_request_H
...
class OAIDeleteQueuedSavingsPlan_request : public OAIObject {
public:
    OAIDeleteQueuedSavingsPlan_request();
    OAIDeleteQueuedSavingsPlan_request(QString json);
    ~OAIDeleteQueuedSavingsPlan_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteQueuedSavingsPlan_request)

#endif // OAIDeleteQueuedSavingsPlan_request_H
