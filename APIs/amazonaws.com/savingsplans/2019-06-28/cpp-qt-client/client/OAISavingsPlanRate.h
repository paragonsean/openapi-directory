...
/*
 * OAISavingsPlanRate.h
 *
 * Information about a Savings Plan rate.
 */

#ifndef OAISavingsPlanRate_H
#define OAISavingsPlanRate_H
...
class OAISavingsPlanRate : public OAIObject {
public:
    OAISavingsPlanRate();
    OAISavingsPlanRate(QString json);
    ~OAISavingsPlanRate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavingsPlanRate)

#endif // OAISavingsPlanRate_H
