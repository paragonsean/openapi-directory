...
/*
 * OAISavingsPlanRateFilter.h
 *
 * Information about a filter.
 */

#ifndef OAISavingsPlanRateFilter_H
#define OAISavingsPlanRateFilter_H
...
class OAISavingsPlanRateFilter : public OAIObject {
public:
    OAISavingsPlanRateFilter();
    OAISavingsPlanRateFilter(QString json);
    ~OAISavingsPlanRateFilter() override;
    ...
    OAISavingsPlanRateFilterName getName() const;
    void setName(const OAISavingsPlanRateFilterName &name);
...
private:
    ...
    OAISavingsPlanRateFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavingsPlanRateFilter)

#endif // OAISavingsPlanRateFilter_H
