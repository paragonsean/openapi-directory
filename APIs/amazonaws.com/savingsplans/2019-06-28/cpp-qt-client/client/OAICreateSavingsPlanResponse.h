...
/*
 * OAICreateSavingsPlanResponse.h
 *
 * 
 */

#ifndef OAICreateSavingsPlanResponse_H
#define OAICreateSavingsPlanResponse_H
...
class OAICreateSavingsPlanResponse : public OAIObject {
public:
    OAICreateSavingsPlanResponse();
    OAICreateSavingsPlanResponse(QString json);
    ~OAICreateSavingsPlanResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSavingsPlanResponse)

#endif // OAICreateSavingsPlanResponse_H
