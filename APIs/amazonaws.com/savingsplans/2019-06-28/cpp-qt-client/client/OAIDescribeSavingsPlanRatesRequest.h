...
/*
 * OAIDescribeSavingsPlanRatesRequest.h
 *
 * 
 */

#ifndef OAIDescribeSavingsPlanRatesRequest_H
#define OAIDescribeSavingsPlanRatesRequest_H
...
class OAIDescribeSavingsPlanRatesRequest : public OAIObject {
public:
    OAIDescribeSavingsPlanRatesRequest();
    OAIDescribeSavingsPlanRatesRequest(QString json);
    ~OAIDescribeSavingsPlanRatesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSavingsPlanRatesRequest)

#endif // OAIDescribeSavingsPlanRatesRequest_H
