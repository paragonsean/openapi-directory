...
OAICreateSavingsPlanResponse::OAICreateSavingsPlanResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSavingsPlanResponse::OAICreateSavingsPlanResponse() {
    this->initializeModel();
}

OAICreateSavingsPlanResponse::~OAICreateSavingsPlanResponse() {}

void OAICreateSavingsPlanResponse::initializeModel() {

    m_savings_plan_id_isSet = false;
    m_savings_plan_id_isValid = false;
}

void OAICreateSavingsPlanResponse::fromJson(QString jsonString) {
...
void OAICreateSavingsPlanResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateSavingsPlanResponse::asJson() const {
...
QJsonObject OAICreateSavingsPlanResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSavingsPlanResponse::getSavingsPlanId() const {
    return m_savings_plan_id;
}
void OAICreateSavingsPlanResponse::setSavingsPlanId(const QString &savings_plan_id) {
    m_savings_plan_id = savings_plan_id;
    m_savings_plan_id_isSet = true;
}

bool OAICreateSavingsPlanResponse::is_savings_plan_id_Set() const{
    return m_savings_plan_id_isSet;
}

bool OAICreateSavingsPlanResponse::is_savings_plan_id_Valid() const{
    return m_savings_plan_id_isValid;
}

bool OAICreateSavingsPlanResponse::isSet() const {
...
bool OAICreateSavingsPlanResponse::isValid() const {
