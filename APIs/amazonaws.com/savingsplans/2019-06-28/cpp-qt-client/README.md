...
class Example : public QObject {
    Q_OBJECT
    OAICreateSavingsPlan_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateSavingsPlan_request Example::create(){
    OAICreateSavingsPlan_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createSavingsPlanSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createSavingsPlanSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateSavingsPlan_request oai_create_savings_plan_request = create(); // OAICreateSavingsPlan_request | 
      ...
      apiInstance.createSavingsPlan(oai_create_savings_plan_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
