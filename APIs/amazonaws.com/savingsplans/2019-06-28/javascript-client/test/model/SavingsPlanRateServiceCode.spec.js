...
(function(root, factory) {
  ...
  describe('SavingsPlanRateServiceCode', function() {
    it('should create an instance of SavingsPlanRateServiceCode', function() {
      // uncomment below and update the code to test SavingsPlanRateServiceCode
      //var instance = new AwsSavingsPlans.SavingsPlanRateServiceCode();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanRateServiceCode);
    });
