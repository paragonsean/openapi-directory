...
(function(root, factory) {
  ...
  describe('SavingsPlanRateFilterName', function() {
    it('should create an instance of SavingsPlanRateFilterName', function() {
      // uncomment below and update the code to test SavingsPlanRateFilterName
      //var instance = new AwsSavingsPlans.SavingsPlanRateFilterName();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanRateFilterName);
    });
