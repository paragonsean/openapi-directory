...
(function(root, factory) {
  ...
  describe('SavingsPlanProductType', function() {
    it('should create an instance of SavingsPlanProductType', function() {
      // uncomment below and update the code to test SavingsPlanProductType
      //var instance = new AwsSavingsPlans.SavingsPlanProductType();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanProductType);
    });
