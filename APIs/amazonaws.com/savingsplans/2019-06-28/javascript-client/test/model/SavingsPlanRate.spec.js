...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.SavingsPlanRate();
  });
  ...
  describe('SavingsPlanRate', function() {
    it('should create an instance of SavingsPlanRate', function() {
      // uncomment below and update the code to test SavingsPlanRate
      //var instance = new AwsSavingsPlans.SavingsPlanRate();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanRate);
    });
