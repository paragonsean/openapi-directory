...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AwsSavingsPlans.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsSavingsPlans.ListTagsForResourceRequest);
    });
