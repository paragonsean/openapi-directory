...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.SavingsPlanOffering();
  });
  ...
  describe('SavingsPlanOffering', function() {
    it('should create an instance of SavingsPlanOffering', function() {
      // uncomment below and update the code to test SavingsPlanOffering
      //var instance = new AwsSavingsPlans.SavingsPlanOffering();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanOffering);
    });
