...
(function(root, factory) {
  ...
  describe('SavingsPlanState', function() {
    it('should create an instance of SavingsPlanState', function() {
      // uncomment below and update the code to test SavingsPlanState
      //var instance = new AwsSavingsPlans.SavingsPlanState();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanState);
    });
