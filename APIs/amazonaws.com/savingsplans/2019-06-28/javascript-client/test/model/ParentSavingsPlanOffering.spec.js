...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.ParentSavingsPlanOffering();
  });
  ...
  describe('ParentSavingsPlanOffering', function() {
    it('should create an instance of ParentSavingsPlanOffering', function() {
      // uncomment below and update the code to test ParentSavingsPlanOffering
      //var instance = new AwsSavingsPlans.ParentSavingsPlanOffering();
      //expect(instance).to.be.a(AwsSavingsPlans.ParentSavingsPlanOffering);
    });
