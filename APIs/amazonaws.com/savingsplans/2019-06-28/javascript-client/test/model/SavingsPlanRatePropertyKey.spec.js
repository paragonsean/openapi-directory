...
(function(root, factory) {
  ...
  describe('SavingsPlanRatePropertyKey', function() {
    it('should create an instance of SavingsPlanRatePropertyKey', function() {
      // uncomment below and update the code to test SavingsPlanRatePropertyKey
      //var instance = new AwsSavingsPlans.SavingsPlanRatePropertyKey();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanRatePropertyKey);
    });
