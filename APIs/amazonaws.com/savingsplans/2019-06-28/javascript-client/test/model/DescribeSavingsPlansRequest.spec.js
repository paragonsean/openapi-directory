...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.DescribeSavingsPlansRequest();
  });
  ...
  describe('DescribeSavingsPlansRequest', function() {
    it('should create an instance of DescribeSavingsPlansRequest', function() {
      // uncomment below and update the code to test DescribeSavingsPlansRequest
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansRequest();
      //expect(instance).to.be.a(AwsSavingsPlans.DescribeSavingsPlansRequest);
    });

    it('should have the property savingsPlanArns (base name: "savingsPlanArns")', function() {
      // uncomment below and update the code to test the property savingsPlanArns
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansRequest();
      //expect(instance).to.be();
    });

    it('should have the property savingsPlanIds (base name: "savingsPlanIds")', function() {
      // uncomment below and update the code to test the property savingsPlanIds
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansRequest();
      //expect(instance).to.be();
    });
