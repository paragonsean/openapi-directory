...
(function(root, factory) {
  ...
  describe('SavingsPlanPaymentOption', function() {
    it('should create an instance of SavingsPlanPaymentOption', function() {
      // uncomment below and update the code to test SavingsPlanPaymentOption
      //var instance = new AwsSavingsPlans.SavingsPlanPaymentOption();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanPaymentOption);
    });
