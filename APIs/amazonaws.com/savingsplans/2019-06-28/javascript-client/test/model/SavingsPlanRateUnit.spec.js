...
(function(root, factory) {
  ...
  describe('SavingsPlanRateUnit', function() {
    it('should create an instance of SavingsPlanRateUnit', function() {
      // uncomment below and update the code to test SavingsPlanRateUnit
      //var instance = new AwsSavingsPlans.SavingsPlanRateUnit();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanRateUnit);
    });
