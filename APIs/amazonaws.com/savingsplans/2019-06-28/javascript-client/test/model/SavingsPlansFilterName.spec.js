...
(function(root, factory) {
  ...
  describe('SavingsPlansFilterName', function() {
    it('should create an instance of SavingsPlansFilterName', function() {
      // uncomment below and update the code to test SavingsPlansFilterName
      //var instance = new AwsSavingsPlans.SavingsPlansFilterName();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlansFilterName);
    });
