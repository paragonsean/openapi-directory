...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.SavingsPlanRateFilter();
  });
  ...
  describe('SavingsPlanRateFilter', function() {
    it('should create an instance of SavingsPlanRateFilter', function() {
      // uncomment below and update the code to test SavingsPlanRateFilter
      //var instance = new AwsSavingsPlans.SavingsPlanRateFilter();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanRateFilter);
    });
