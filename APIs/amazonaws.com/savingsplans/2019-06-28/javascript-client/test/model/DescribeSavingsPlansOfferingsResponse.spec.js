...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingsResponse();
  });
  ...
  describe('DescribeSavingsPlansOfferingsResponse', function() {
    it('should create an instance of DescribeSavingsPlansOfferingsResponse', function() {
      // uncomment below and update the code to test DescribeSavingsPlansOfferingsResponse
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingsResponse();
      //expect(instance).to.be.a(AwsSavingsPlans.DescribeSavingsPlansOfferingsResponse);
    });
