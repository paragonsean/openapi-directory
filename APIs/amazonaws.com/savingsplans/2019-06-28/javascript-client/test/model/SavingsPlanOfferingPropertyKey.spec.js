...
(function(root, factory) {
  ...
  describe('SavingsPlanOfferingPropertyKey', function() {
    it('should create an instance of SavingsPlanOfferingPropertyKey', function() {
      // uncomment below and update the code to test SavingsPlanOfferingPropertyKey
      //var instance = new AwsSavingsPlans.SavingsPlanOfferingPropertyKey();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanOfferingPropertyKey);
    });
