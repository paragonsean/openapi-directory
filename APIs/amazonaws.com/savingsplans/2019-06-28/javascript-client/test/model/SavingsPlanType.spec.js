...
(function(root, factory) {
  ...
  describe('SavingsPlanType', function() {
    it('should create an instance of SavingsPlanType', function() {
      // uncomment below and update the code to test SavingsPlanType
      //var instance = new AwsSavingsPlans.SavingsPlanType();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanType);
    });
