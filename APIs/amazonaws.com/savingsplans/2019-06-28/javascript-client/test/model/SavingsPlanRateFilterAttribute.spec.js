...
(function(root, factory) {
  ...
  describe('SavingsPlanRateFilterAttribute', function() {
    it('should create an instance of SavingsPlanRateFilterAttribute', function() {
      // uncomment below and update the code to test SavingsPlanRateFilterAttribute
      //var instance = new AwsSavingsPlans.SavingsPlanRateFilterAttribute();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanRateFilterAttribute);
    });
