...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.SavingsPlanOfferingRateSavingsPlanOffering();
  });
  ...
  describe('SavingsPlanOfferingRateSavingsPlanOffering', function() {
    it('should create an instance of SavingsPlanOfferingRateSavingsPlanOffering', function() {
      // uncomment below and update the code to test SavingsPlanOfferingRateSavingsPlanOffering
      //var instance = new AwsSavingsPlans.SavingsPlanOfferingRateSavingsPlanOffering();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanOfferingRateSavingsPlanOffering);
    });
