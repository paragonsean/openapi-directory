...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.SavingsPlanFilter();
  });
  ...
  describe('SavingsPlanFilter', function() {
    it('should create an instance of SavingsPlanFilter', function() {
      // uncomment below and update the code to test SavingsPlanFilter
      //var instance = new AwsSavingsPlans.SavingsPlanFilter();
      //expect(instance).to.be.a(AwsSavingsPlans.SavingsPlanFilter);
    });
