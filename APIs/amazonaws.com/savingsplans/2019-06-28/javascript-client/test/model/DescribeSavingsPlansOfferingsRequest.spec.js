...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingsRequest();
  });
  ...
  describe('DescribeSavingsPlansOfferingsRequest', function() {
    it('should create an instance of DescribeSavingsPlansOfferingsRequest', function() {
      // uncomment below and update the code to test DescribeSavingsPlansOfferingsRequest
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingsRequest();
      //expect(instance).to.be.a(AwsSavingsPlans.DescribeSavingsPlansOfferingsRequest);
    });

    it('should have the property offeringIds (base name: "offeringIds")', function() {
      // uncomment below and update the code to test the property offeringIds
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingsRequest();
    ...
    it('should have the property planTypes (base name: "planTypes")', function() {
      // uncomment below and update the code to test the property planTypes
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingsRequest();
      //expect(instance).to.be();
    });

    it('should have the property durations (base name: "durations")', function() {
      // uncomment below and update the code to test the property durations
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingsRequest();
      //expect(instance).to.be();
    });
