...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingRatesResponse();
  });
  ...
  describe('DescribeSavingsPlansOfferingRatesResponse', function() {
    it('should create an instance of DescribeSavingsPlansOfferingRatesResponse', function() {
      // uncomment below and update the code to test DescribeSavingsPlansOfferingRatesResponse
      //var instance = new AwsSavingsPlans.DescribeSavingsPlansOfferingRatesResponse();
      //expect(instance).to.be.a(AwsSavingsPlans.DescribeSavingsPlansOfferingRatesResponse);
    });
