...
* @readonly
*/
export default class SavingsPlanOfferingPropertyKey {
    ...
    /**
    * Returns a <code>SavingsPlanOfferingPropertyKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SavingsPlanOfferingPropertyKey} The enum <code>SavingsPlanOfferingPropertyKey</code> value.
    */
