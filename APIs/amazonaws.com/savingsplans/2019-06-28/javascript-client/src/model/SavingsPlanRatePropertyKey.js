...
* @readonly
*/
export default class SavingsPlanRatePropertyKey {
    ...
    /**
    * Returns a <code>SavingsPlanRatePropertyKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SavingsPlanRatePropertyKey} The enum <code>SavingsPlanRatePropertyKey</code> value.
    */
