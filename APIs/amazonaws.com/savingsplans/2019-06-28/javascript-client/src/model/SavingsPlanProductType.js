...
* @readonly
*/
export default class SavingsPlanProductType {
    ...
    /**
    * Returns a <code>SavingsPlanProductType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SavingsPlanProductType} The enum <code>SavingsPlanProductType</code> value.
    */
