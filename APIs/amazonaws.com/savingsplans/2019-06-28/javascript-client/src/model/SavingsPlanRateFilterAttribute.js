...
* @readonly
*/
export default class SavingsPlanRateFilterAttribute {
    ...
    /**
    * Returns a <code>SavingsPlanRateFilterAttribute</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SavingsPlanRateFilterAttribute} The enum <code>SavingsPlanRateFilterAttribute</code> value.
    */
