...
* @readonly
*/
export default class SavingsPlanRateFilterName {
    ...
    /**
    * Returns a <code>SavingsPlanRateFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SavingsPlanRateFilterName} The enum <code>SavingsPlanRateFilterName</code> value.
    */
