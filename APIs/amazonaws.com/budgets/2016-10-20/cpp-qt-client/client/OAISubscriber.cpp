...
OAISubscriptionType OAISubscriber::getSubscriptionType() const {
    return m_subscription_type;
}
void OAISubscriber::setSubscriptionType(const OAISubscriptionType &subscription_type) {
    m_subscription_type = subscription_type;
    m_subscription_type_isSet = true;
}

bool OAISubscriber::is_subscription_type_Set() const{
    return m_subscription_type_isSet;
}

bool OAISubscriber::is_subscription_type_Valid() const{
