...
/*
 * OAIDescribeBudgetPerformanceHistoryRequest.h
 *
 * 
 */

#ifndef OAIDescribeBudgetPerformanceHistoryRequest_H
#define OAIDescribeBudgetPerformanceHistoryRequest_H
...
namespace OpenAPI {
class OAIDescribeBudgetPerformanceHistoryRequest_TimePeriod;

class OAIDescribeBudgetPerformanceHistoryRequest : public OAIObject {
public:
    OAIDescribeBudgetPerformanceHistoryRequest();
    OAIDescribeBudgetPerformanceHistoryRequest(QString json);
    ~OAIDescribeBudgetPerformanceHistoryRequest() override;
    ...
    OAIDescribeBudgetPerformanceHistoryRequest_TimePeriod getTimePeriod() const;
    void setTimePeriod(const OAIDescribeBudgetPerformanceHistoryRequest_TimePeriod &time_period);
...
private:
    ...
    OAIDescribeBudgetPerformanceHistoryRequest_TimePeriod m_time_period;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetPerformanceHistoryRequest)

#endif // OAIDescribeBudgetPerformanceHistoryRequest_H
