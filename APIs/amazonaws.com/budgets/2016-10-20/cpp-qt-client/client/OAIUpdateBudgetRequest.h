...
/*
 * OAIUpdateBudgetRequest.h
 *
 *  Request of UpdateBudget 
 */

#ifndef OAIUpdateBudgetRequest_H
#define OAIUpdateBudgetRequest_H
...
namespace OpenAPI {
class OAIUpdateBudgetRequest_NewBudget;

class OAIUpdateBudgetRequest : public OAIObject {
public:
    OAIUpdateBudgetRequest();
    OAIUpdateBudgetRequest(QString json);
    ~OAIUpdateBudgetRequest() override;
    ...
    OAIUpdateBudgetRequest_NewBudget getNewBudget() const;
    void setNewBudget(const OAIUpdateBudgetRequest_NewBudget &new_budget);
    bool is_new_budget_Set() const;
    bool is_new_budget_Valid() const;
...
private:
    ...
    OAIUpdateBudgetRequest_NewBudget m_new_budget;
    bool m_new_budget_isSet;
    bool m_new_budget_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBudgetRequest)

#endif // OAIUpdateBudgetRequest_H
