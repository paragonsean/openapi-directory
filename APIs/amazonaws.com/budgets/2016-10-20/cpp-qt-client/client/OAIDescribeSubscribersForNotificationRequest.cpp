...
OAIDescribeSubscribersForNotificationRequest::OAIDescribeSubscribersForNotificationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSubscribersForNotificationRequest::OAIDescribeSubscribersForNotificationRequest() {
    this->initializeModel();
}

OAIDescribeSubscribersForNotificationRequest::~OAIDescribeSubscribersForNotificationRequest() {}

void OAIDescribeSubscribersForNotificationRequest::initializeModel() {
...
void OAIDescribeSubscribersForNotificationRequest::fromJson(QString jsonString) {
...
void OAIDescribeSubscribersForNotificationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSubscribersForNotificationRequest::asJson() const {
...
QJsonObject OAIDescribeSubscribersForNotificationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeSubscribersForNotificationRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeSubscribersForNotificationRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeSubscribersForNotificationRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeSubscribersForNotificationRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIDescribeSubscribersForNotificationRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIDescribeSubscribersForNotificationRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDescribeSubscribersForNotificationRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDescribeSubscribersForNotificationRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAIDescribeSubscribersForNotificationRequest_Notification OAIDescribeSubscribersForNotificationRequest::getNotification() const {
    return m_notification;
}
void OAIDescribeSubscribersForNotificationRequest::setNotification(const OAIDescribeSubscribersForNotificationRequest_Notification &notification) {
    m_notification = notification;
    m_notification_isSet = true;
}

bool OAIDescribeSubscribersForNotificationRequest::is_notification_Set() const{
    return m_notification_isSet;
}

bool OAIDescribeSubscribersForNotificationRequest::is_notification_Valid() const{
    return m_notification_isValid;
}

qint32 OAIDescribeSubscribersForNotificationRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeSubscribersForNotificationRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeSubscribersForNotificationRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeSubscribersForNotificationRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeSubscribersForNotificationRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeSubscribersForNotificationRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeSubscribersForNotificationRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeSubscribersForNotificationRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeSubscribersForNotificationRequest::isSet() const {
...
bool OAIDescribeSubscribersForNotificationRequest::isValid() const {
