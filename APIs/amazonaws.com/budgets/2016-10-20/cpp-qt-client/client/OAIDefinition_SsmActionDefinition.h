...
/*
 * OAIDefinition_SsmActionDefinition.h
 *
 * 
 */

#ifndef OAIDefinition_SsmActionDefinition_H
#define OAIDefinition_SsmActionDefinition_H

#include <QJsonObject>

#include "OAIActionSubType.h"
#include <QList>
#include <QString>
...
class OAIDefinition_SsmActionDefinition : public OAIObject {
public:
    OAIDefinition_SsmActionDefinition();
    OAIDefinition_SsmActionDefinition(QString json);
    ~OAIDefinition_SsmActionDefinition() override;
    ...
    OAIActionSubType getActionSubType() const;
    void setActionSubType(const OAIActionSubType &action_sub_type);
    bool is_action_sub_type_Set() const;
    bool is_action_sub_type_Valid() const;
...
private:
    ...
    OAIActionSubType m_action_sub_type;
    bool m_action_sub_type_isSet;
    bool m_action_sub_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefinition_SsmActionDefinition)

#endif // OAIDefinition_SsmActionDefinition_H
