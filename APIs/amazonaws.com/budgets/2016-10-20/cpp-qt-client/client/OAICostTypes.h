...
#ifndef OAICostTypes_H
#define OAICostTypes_H
...
class OAICostTypes : public OAIObject {
public:
    OAICostTypes();
    OAICostTypes(QString json);
    ~OAICostTypes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICostTypes)

#endif // OAICostTypes_H
