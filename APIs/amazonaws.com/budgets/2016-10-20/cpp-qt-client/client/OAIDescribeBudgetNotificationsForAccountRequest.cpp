...
OAIDescribeBudgetNotificationsForAccountRequest::OAIDescribeBudgetNotificationsForAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetNotificationsForAccountRequest::OAIDescribeBudgetNotificationsForAccountRequest() {
    this->initializeModel();
}

OAIDescribeBudgetNotificationsForAccountRequest::~OAIDescribeBudgetNotificationsForAccountRequest() {}

void OAIDescribeBudgetNotificationsForAccountRequest::initializeModel() {
...
void OAIDescribeBudgetNotificationsForAccountRequest::fromJson(QString jsonString) {
...
void OAIDescribeBudgetNotificationsForAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetNotificationsForAccountRequest::asJson() const {
...
QJsonObject OAIDescribeBudgetNotificationsForAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetNotificationsForAccountRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeBudgetNotificationsForAccountRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeBudgetNotificationsForAccountRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeBudgetNotificationsForAccountRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

qint32 OAIDescribeBudgetNotificationsForAccountRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeBudgetNotificationsForAccountRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeBudgetNotificationsForAccountRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeBudgetNotificationsForAccountRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeBudgetNotificationsForAccountRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeBudgetNotificationsForAccountRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeBudgetNotificationsForAccountRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeBudgetNotificationsForAccountRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeBudgetNotificationsForAccountRequest::isSet() const {
...
bool OAIDescribeBudgetNotificationsForAccountRequest::isValid() const {
