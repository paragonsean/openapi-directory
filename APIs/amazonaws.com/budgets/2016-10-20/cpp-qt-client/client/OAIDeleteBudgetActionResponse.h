...
/*
 * OAIDeleteBudgetActionResponse.h
 *
 * 
 */

#ifndef OAIDeleteBudgetActionResponse_H
#define OAIDeleteBudgetActionResponse_H
...
class OAIDeleteBudgetActionResponse : public OAIObject {
public:
    OAIDeleteBudgetActionResponse();
    OAIDeleteBudgetActionResponse(QString json);
    ~OAIDeleteBudgetActionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBudgetActionResponse)

#endif // OAIDeleteBudgetActionResponse_H
