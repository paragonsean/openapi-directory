...
#ifndef OAIThresholdType_H
#define OAIThresholdType_H
...
class OAIThresholdType : public OAIEnum {
public:
    OAIThresholdType();
    OAIThresholdType(QString json);
    ~OAIThresholdType() override;
    ...
    enum class eOAIThresholdType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PERCENTAGE, 
        ABSOLUTE_VALUE
    };
    OAIThresholdType::eOAIThresholdType getValue() const;
    void setValue(const OAIThresholdType::eOAIThresholdType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIThresholdType)

#endif // OAIThresholdType_H
