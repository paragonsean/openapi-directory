...
/*
 * OAIDeleteNotificationRequest_Notification.h
 *
 * 
 */

#ifndef OAIDeleteNotificationRequest_Notification_H
#define OAIDeleteNotificationRequest_Notification_H
...
class OAIDeleteNotificationRequest_Notification : public OAIObject {
public:
    OAIDeleteNotificationRequest_Notification();
    OAIDeleteNotificationRequest_Notification(QString json);
    ~OAIDeleteNotificationRequest_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNotificationRequest_Notification)

#endif // OAIDeleteNotificationRequest_Notification_H
