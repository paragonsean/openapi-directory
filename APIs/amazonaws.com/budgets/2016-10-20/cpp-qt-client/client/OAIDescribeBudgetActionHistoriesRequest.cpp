...
OAIDescribeBudgetActionHistoriesRequest::OAIDescribeBudgetActionHistoriesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetActionHistoriesRequest::OAIDescribeBudgetActionHistoriesRequest() {
    this->initializeModel();
}

OAIDescribeBudgetActionHistoriesRequest::~OAIDescribeBudgetActionHistoriesRequest() {}

void OAIDescribeBudgetActionHistoriesRequest::initializeModel() {
...
void OAIDescribeBudgetActionHistoriesRequest::fromJson(QString jsonString) {
...
void OAIDescribeBudgetActionHistoriesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetActionHistoriesRequest::asJson() const {
...
QJsonObject OAIDescribeBudgetActionHistoriesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetActionHistoriesRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeBudgetActionHistoriesRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIDescribeBudgetActionHistoriesRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIDescribeBudgetActionHistoriesRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

QString OAIDescribeBudgetActionHistoriesRequest::getActionId() const {
    return m_action_id;
}
void OAIDescribeBudgetActionHistoriesRequest::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_action_id_Valid() const{
    return m_action_id_isValid;
}

OAITimePeriod OAIDescribeBudgetActionHistoriesRequest::getTimePeriod() const {
    return m_time_period;
}
void OAIDescribeBudgetActionHistoriesRequest::setTimePeriod(const OAITimePeriod &time_period) {
    m_time_period = time_period;
    m_time_period_isSet = true;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_time_period_Set() const{
    return m_time_period_isSet;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_time_period_Valid() const{
    return m_time_period_isValid;
}

qint32 OAIDescribeBudgetActionHistoriesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeBudgetActionHistoriesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeBudgetActionHistoriesRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeBudgetActionHistoriesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeBudgetActionHistoriesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeBudgetActionHistoriesRequest::isSet() const {
...
bool OAIDescribeBudgetActionHistoriesRequest::isValid() const {
