...
/*
 * OAIDescribeBudgetActionHistoriesResponse.h
 *
 * 
 */

#ifndef OAIDescribeBudgetActionHistoriesResponse_H
#define OAIDescribeBudgetActionHistoriesResponse_H
...
class OAIDescribeBudgetActionHistoriesResponse : public OAIObject {
public:
    OAIDescribeBudgetActionHistoriesResponse();
    OAIDescribeBudgetActionHistoriesResponse(QString json);
    ~OAIDescribeBudgetActionHistoriesResponse() override;
    ...
    QList getActionHistories() const;
    void setActionHistories(const QList &action_histories);
    bool is_action_histories_Set() const;
    bool is_action_histories_Valid() const;
...
private:
    ...
    QList m_action_histories;
    bool m_action_histories_isSet;
    bool m_action_histories_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetActionHistoriesResponse)

#endif // OAIDescribeBudgetActionHistoriesResponse_H
