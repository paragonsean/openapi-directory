...
/*
 * OAICalculatedSpend_ActualSpend.h
 *
 * 
 */

#ifndef OAICalculatedSpend_ActualSpend_H
#define OAICalculatedSpend_ActualSpend_H
...
class OAICalculatedSpend_ActualSpend : public OAIObject {
public:
    OAICalculatedSpend_ActualSpend();
    OAICalculatedSpend_ActualSpend(QString json);
    ~OAICalculatedSpend_ActualSpend() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculatedSpend_ActualSpend)

#endif // OAICalculatedSpend_ActualSpend_H
