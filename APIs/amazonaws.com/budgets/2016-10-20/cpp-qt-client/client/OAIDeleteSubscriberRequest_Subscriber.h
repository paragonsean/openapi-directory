...
/*
 * OAIDeleteSubscriberRequest_Subscriber.h
 *
 * 
 */

#ifndef OAIDeleteSubscriberRequest_Subscriber_H
#define OAIDeleteSubscriberRequest_Subscriber_H
...
class OAIDeleteSubscriberRequest_Subscriber : public OAIObject {
public:
    OAIDeleteSubscriberRequest_Subscriber();
    OAIDeleteSubscriberRequest_Subscriber(QString json);
    ~OAIDeleteSubscriberRequest_Subscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSubscriberRequest_Subscriber)

#endif // OAIDeleteSubscriberRequest_Subscriber_H
