...
OAINotificationState::OAINotificationState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotificationState::OAINotificationState() {
    this->initializeModel();
}

OAINotificationState::~OAINotificationState() {}

void OAINotificationState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAINotificationState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAINotificationState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("OK", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationState::OK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALARM", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationState::ALARM;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAINotificationState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAINotificationState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAINotificationState::OK:
            val = "OK";
            break;
        case eOAINotificationState::ALARM:
            val = "ALARM";
            break;
        default:
            break;
...
QJsonValue OAINotificationState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAINotificationState::eOAINotificationState OAINotificationState::getValue() const {
    return m_value;
}

void OAINotificationState::setValue(const OAINotificationState::eOAINotificationState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAINotificationState::isSet() const {
    
    return m_value_isSet;
}

bool OAINotificationState::isValid() const {
