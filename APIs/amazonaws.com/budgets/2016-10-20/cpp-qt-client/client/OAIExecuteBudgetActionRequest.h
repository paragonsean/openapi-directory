...
/*
 * OAIExecuteBudgetActionRequest.h
 *
 * 
 */

#ifndef OAIExecuteBudgetActionRequest_H
#define OAIExecuteBudgetActionRequest_H
...
class OAIExecuteBudgetActionRequest : public OAIObject {
public:
    OAIExecuteBudgetActionRequest();
    OAIExecuteBudgetActionRequest(QString json);
    ~OAIExecuteBudgetActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecuteBudgetActionRequest)

#endif // OAIExecuteBudgetActionRequest_H
