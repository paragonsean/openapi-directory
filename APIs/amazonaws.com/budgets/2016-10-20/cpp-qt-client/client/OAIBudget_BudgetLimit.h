...
/*
 * OAIBudget_BudgetLimit.h
 *
 * 
 */

#ifndef OAIBudget_BudgetLimit_H
#define OAIBudget_BudgetLimit_H
...
class OAIBudget_BudgetLimit : public OAIObject {
public:
    OAIBudget_BudgetLimit();
    OAIBudget_BudgetLimit(QString json);
    ~OAIBudget_BudgetLimit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudget_BudgetLimit)

#endif // OAIBudget_BudgetLimit_H
