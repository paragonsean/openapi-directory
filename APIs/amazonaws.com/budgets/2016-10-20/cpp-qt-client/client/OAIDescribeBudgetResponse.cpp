...
OAIDescribeBudgetResponse::OAIDescribeBudgetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetResponse::OAIDescribeBudgetResponse() {
    this->initializeModel();
}

OAIDescribeBudgetResponse::~OAIDescribeBudgetResponse() {}

void OAIDescribeBudgetResponse::initializeModel() {

    m_budget_isSet = false;
    m_budget_isValid = false;
}

void OAIDescribeBudgetResponse::fromJson(QString jsonString) {
...
void OAIDescribeBudgetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetResponse::asJson() const {
...
QJsonObject OAIDescribeBudgetResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_budget.isSet()) {
...
OAIDescribeBudgetResponse_Budget OAIDescribeBudgetResponse::getBudget() const {
    return m_budget;
}
void OAIDescribeBudgetResponse::setBudget(const OAIDescribeBudgetResponse_Budget &budget) {
    m_budget = budget;
    m_budget_isSet = true;
}

bool OAIDescribeBudgetResponse::is_budget_Set() const{
    return m_budget_isSet;
}

bool OAIDescribeBudgetResponse::is_budget_Valid() const{
    return m_budget_isValid;
}

bool OAIDescribeBudgetResponse::isSet() const {
...
bool OAIDescribeBudgetResponse::isValid() const {
