...
#ifndef OAITimeUnit_H
#define OAITimeUnit_H
...
class OAITimeUnit : public OAIEnum {
public:
    OAITimeUnit();
    OAITimeUnit(QString json);
    ~OAITimeUnit() override;
    ...
    OAITimeUnit::eOAITimeUnit getValue() const;
    void setValue(const OAITimeUnit::eOAITimeUnit& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeUnit)
