...
#include "OAIActionHistoryDetails.h"
...
OAIActionHistoryDetails::OAIActionHistoryDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionHistoryDetails::OAIActionHistoryDetails() {
    this->initializeModel();
}

OAIActionHistoryDetails::~OAIActionHistoryDetails() {}

void OAIActionHistoryDetails::initializeModel() {
...
void OAIActionHistoryDetails::fromJson(QString jsonString) {
...
void OAIActionHistoryDetails::fromJsonObject(QJsonObject json) {
...
QString OAIActionHistoryDetails::asJson() const {
...
QJsonObject OAIActionHistoryDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIActionHistoryDetails::getMessage() const {
    return m_message;
}
void OAIActionHistoryDetails::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIActionHistoryDetails::is_message_Set() const{
    return m_message_isSet;
}

bool OAIActionHistoryDetails::is_message_Valid() const{
    return m_message_isValid;
}

OAIActionHistoryDetails_Action OAIActionHistoryDetails::getAction() const {
    return m_action;
}
void OAIActionHistoryDetails::setAction(const OAIActionHistoryDetails_Action &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIActionHistoryDetails::is_action_Set() const{
    return m_action_isSet;
}

bool OAIActionHistoryDetails::is_action_Valid() const{
    return m_action_isValid;
}

bool OAIActionHistoryDetails::isSet() const {
...
bool OAIActionHistoryDetails::isValid() const {
