...
void OAINotificationType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("ACTUAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationType::ACTUAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FORECASTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationType::FORECASTED;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAINotificationType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAINotificationType::ACTUAL:
            val = "ACTUAL";
            break;
        case eOAINotificationType::FORECASTED:
            val = "FORECASTED";
            break;
        default:
            break;
