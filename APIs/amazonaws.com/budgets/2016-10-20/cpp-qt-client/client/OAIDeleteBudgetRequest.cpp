...
OAIDeleteBudgetRequest::OAIDeleteBudgetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteBudgetRequest::OAIDeleteBudgetRequest() {
    this->initializeModel();
}

OAIDeleteBudgetRequest::~OAIDeleteBudgetRequest() {}

void OAIDeleteBudgetRequest::initializeModel() {
...
void OAIDeleteBudgetRequest::fromJson(QString jsonString) {
...
void OAIDeleteBudgetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteBudgetRequest::asJson() const {
...
QJsonObject OAIDeleteBudgetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteBudgetRequest::getAccountId() const {
    return m_account_id;
}
void OAIDeleteBudgetRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDeleteBudgetRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDeleteBudgetRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIDeleteBudgetRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIDeleteBudgetRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDeleteBudgetRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDeleteBudgetRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

bool OAIDeleteBudgetRequest::isSet() const {
...
bool OAIDeleteBudgetRequest::isValid() const {
