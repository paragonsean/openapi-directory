...
/*
 * OAICreateSubscriberRequest_Subscriber.h
 *
 * 
 */

#ifndef OAICreateSubscriberRequest_Subscriber_H
#define OAICreateSubscriberRequest_Subscriber_H
...
class OAICreateSubscriberRequest_Subscriber : public OAIObject {
public:
    OAICreateSubscriberRequest_Subscriber();
    OAICreateSubscriberRequest_Subscriber(QString json);
    ~OAICreateSubscriberRequest_Subscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriberRequest_Subscriber)

#endif // OAICreateSubscriberRequest_Subscriber_H
