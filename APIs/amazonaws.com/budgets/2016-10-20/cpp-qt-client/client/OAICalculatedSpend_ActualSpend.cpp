...
OAICalculatedSpend_ActualSpend::OAICalculatedSpend_ActualSpend(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICalculatedSpend_ActualSpend::OAICalculatedSpend_ActualSpend() {
    this->initializeModel();
}

OAICalculatedSpend_ActualSpend::~OAICalculatedSpend_ActualSpend() {}

void OAICalculatedSpend_ActualSpend::initializeModel() {
...
void OAICalculatedSpend_ActualSpend::fromJson(QString jsonString) {
...
void OAICalculatedSpend_ActualSpend::fromJsonObject(QJsonObject json) {
...
QString OAICalculatedSpend_ActualSpend::asJson() const {
...
QJsonObject OAICalculatedSpend_ActualSpend::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
QString OAICalculatedSpend_ActualSpend::getAmount() const {
    return m_amount;
}
void OAICalculatedSpend_ActualSpend::setAmount(const QString &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAICalculatedSpend_ActualSpend::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAICalculatedSpend_ActualSpend::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAICalculatedSpend_ActualSpend::getUnit() const {
    return m_unit;
}
void OAICalculatedSpend_ActualSpend::setUnit(const QString &unit) {
    m_unit = unit;
    m_unit_isSet = true;
}

bool OAICalculatedSpend_ActualSpend::is_unit_Set() const{
    return m_unit_isSet;
}

bool OAICalculatedSpend_ActualSpend::is_unit_Valid() const{
    return m_unit_isValid;
}

bool OAICalculatedSpend_ActualSpend::isSet() const {
...
bool OAICalculatedSpend_ActualSpend::isValid() const {
