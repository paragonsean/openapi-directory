...
#ifndef OAIApprovalModel_H
#define OAIApprovalModel_H
...
class OAIApprovalModel : public OAIEnum {
public:
    OAIApprovalModel();
    OAIApprovalModel(QString json);
    ~OAIApprovalModel() override;
    ...
    enum class eOAIApprovalModel {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AUTOMATIC, 
        MANUAL
    };
    OAIApprovalModel::eOAIApprovalModel getValue() const;
    void setValue(const OAIApprovalModel::eOAIApprovalModel& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalModel)

#endif // OAIApprovalModel_H
