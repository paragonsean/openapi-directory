...
OAICalculatedSpend_ForecastedSpend::OAICalculatedSpend_ForecastedSpend(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICalculatedSpend_ForecastedSpend::OAICalculatedSpend_ForecastedSpend() {
    this->initializeModel();
}

OAICalculatedSpend_ForecastedSpend::~OAICalculatedSpend_ForecastedSpend() {}

void OAICalculatedSpend_ForecastedSpend::initializeModel() {
...
void OAICalculatedSpend_ForecastedSpend::fromJson(QString jsonString) {
...
void OAICalculatedSpend_ForecastedSpend::fromJsonObject(QJsonObject json) {
...
QString OAICalculatedSpend_ForecastedSpend::asJson() const {
...
QJsonObject OAICalculatedSpend_ForecastedSpend::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
QString OAICalculatedSpend_ForecastedSpend::getAmount() const {
    return m_amount;
}
void OAICalculatedSpend_ForecastedSpend::setAmount(const QString &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAICalculatedSpend_ForecastedSpend::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAICalculatedSpend_ForecastedSpend::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAICalculatedSpend_ForecastedSpend::getUnit() const {
    return m_unit;
}
void OAICalculatedSpend_ForecastedSpend::setUnit(const QString &unit) {
    m_unit = unit;
    m_unit_isSet = true;
}

bool OAICalculatedSpend_ForecastedSpend::is_unit_Set() const{
    return m_unit_isSet;
}

bool OAICalculatedSpend_ForecastedSpend::is_unit_Valid() const{
    return m_unit_isValid;
}

bool OAICalculatedSpend_ForecastedSpend::isSet() const {
...
bool OAICalculatedSpend_ForecastedSpend::isValid() const {
