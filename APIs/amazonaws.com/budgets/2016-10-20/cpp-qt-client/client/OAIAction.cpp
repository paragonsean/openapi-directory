...
QString OAIAction::getActionId() const {
    return m_action_id;
}
void OAIAction::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIAction::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIAction::is_action_id_Valid() const{
    return m_action_id_isValid;
}

QString OAIAction::getBudgetName() const {
    return m_budget_name;
}
void OAIAction::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIAction::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIAction::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAINotificationType OAIAction::getNotificationType() const {
    return m_notification_type;
}
void OAIAction::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIAction::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIAction::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIActionType OAIAction::getActionType() const {
    return m_action_type;
}
void OAIAction::setActionType(const OAIActionType &action_type) {
...
OAIAction_ActionThreshold OAIAction::getActionThreshold() const {
    return m_action_threshold;
}
void OAIAction::setActionThreshold(const OAIAction_ActionThreshold &action_threshold) {
    m_action_threshold = action_threshold;
    m_action_threshold_isSet = true;
}

bool OAIAction::is_action_threshold_Set() const{
    return m_action_threshold_isSet;
}

bool OAIAction::is_action_threshold_Valid() const{
    return m_action_threshold_isValid;
}

OAIAction_Definition OAIAction::getDefinition() const {
    return m_definition;
}
void OAIAction::setDefinition(const OAIAction_Definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIAction::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIAction::is_definition_Valid() const{
    return m_definition_isValid;
}

QString OAIAction::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAIAction::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAIAction::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAIAction::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

OAIApprovalModel OAIAction::getApprovalModel() const {
    return m_approval_model;
}
void OAIAction::setApprovalModel(const OAIApprovalModel &approval_model) {
    m_approval_model = approval_model;
    m_approval_model_isSet = true;
}

bool OAIAction::is_approval_model_Set() const{
    return m_approval_model_isSet;
}

bool OAIAction::is_approval_model_Valid() const{
    return m_approval_model_isValid;
}

OAIActionStatus OAIAction::getStatus() const {
    return m_status;
}
void OAIAction::setStatus(const OAIActionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QList<OAISubscriber> OAIAction::getSubscribers() const {
    return m_subscribers;
}
void OAIAction::setSubscribers(const QList<OAISubscriber> &subscribers) {
    m_subscribers = subscribers;
    m_subscribers_isSet = true;
}

bool OAIAction::is_subscribers_Set() const{
    return m_subscribers_isSet;
}

bool OAIAction::is_subscribers_Valid() const{
