...
/*
 * OAIUpdateNotificationRequest_OldNotification.h
 *
 * 
 */

#ifndef OAIUpdateNotificationRequest_OldNotification_H
#define OAIUpdateNotificationRequest_OldNotification_H
...
class OAIUpdateNotificationRequest_OldNotification : public OAIObject {
public:
    OAIUpdateNotificationRequest_OldNotification();
    OAIUpdateNotificationRequest_OldNotification(QString json);
    ~OAIUpdateNotificationRequest_OldNotification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNotificationRequest_OldNotification)

#endif // OAIUpdateNotificationRequest_OldNotification_H
