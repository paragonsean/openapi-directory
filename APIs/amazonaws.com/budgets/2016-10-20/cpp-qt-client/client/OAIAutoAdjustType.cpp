...
OAIAutoAdjustType::OAIAutoAdjustType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoAdjustType::OAIAutoAdjustType() {
    this->initializeModel();
}

OAIAutoAdjustType::~OAIAutoAdjustType() {}

void OAIAutoAdjustType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAutoAdjustType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAutoAdjustType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("HISTORICAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAutoAdjustType::HISTORICAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FORECAST", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAutoAdjustType::FORECAST;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAutoAdjustType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAutoAdjustType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAutoAdjustType::HISTORICAL:
            val = "HISTORICAL";
            break;
        case eOAIAutoAdjustType::FORECAST:
            val = "FORECAST";
            break;
        default:
            break;
...
QJsonValue OAIAutoAdjustType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAutoAdjustType::eOAIAutoAdjustType OAIAutoAdjustType::getValue() const {
    return m_value;
}

void OAIAutoAdjustType::setValue(const OAIAutoAdjustType::eOAIAutoAdjustType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAutoAdjustType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAutoAdjustType::isValid() const {
