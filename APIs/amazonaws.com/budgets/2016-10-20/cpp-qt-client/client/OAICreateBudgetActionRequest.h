...
/*
 * OAICreateBudgetActionRequest.h
 *
 * 
 */

#ifndef OAICreateBudgetActionRequest_H
#define OAICreateBudgetActionRequest_H
...
class OAICreateBudgetActionRequest : public OAIObject {
public:
    OAICreateBudgetActionRequest();
    OAICreateBudgetActionRequest(QString json);
    ~OAICreateBudgetActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBudgetActionRequest)

#endif // OAICreateBudgetActionRequest_H
