...
OAIDescribeBudgetActionsForAccountResponse::OAIDescribeBudgetActionsForAccountResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetActionsForAccountResponse::OAIDescribeBudgetActionsForAccountResponse() {
    this->initializeModel();
}

OAIDescribeBudgetActionsForAccountResponse::~OAIDescribeBudgetActionsForAccountResponse() {}

void OAIDescribeBudgetActionsForAccountResponse::initializeModel() {
...
void OAIDescribeBudgetActionsForAccountResponse::fromJson(QString jsonString) {
...
void OAIDescribeBudgetActionsForAccountResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetActionsForAccountResponse::asJson() const {
...
QJsonObject OAIDescribeBudgetActionsForAccountResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_actions.isSet()) {
...
QList OAIDescribeBudgetActionsForAccountResponse::getActions() const {
    return m_actions;
}
void OAIDescribeBudgetActionsForAccountResponse::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIDescribeBudgetActionsForAccountResponse::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIDescribeBudgetActionsForAccountResponse::is_actions_Valid() const{
    return m_actions_isValid;
}

QString OAIDescribeBudgetActionsForAccountResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeBudgetActionsForAccountResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeBudgetActionsForAccountResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeBudgetActionsForAccountResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeBudgetActionsForAccountResponse::isSet() const {
...
bool OAIDescribeBudgetActionsForAccountResponse::isValid() const {
