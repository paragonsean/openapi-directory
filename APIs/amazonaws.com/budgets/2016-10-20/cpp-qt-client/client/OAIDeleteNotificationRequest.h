...
/*
 * OAIDeleteNotificationRequest.h
 *
 *  Request of DeleteNotification 
 */

#ifndef OAIDeleteNotificationRequest_H
#define OAIDeleteNotificationRequest_H
...
namespace OpenAPI {
class OAIDeleteNotificationRequest_Notification;

class OAIDeleteNotificationRequest : public OAIObject {
public:
    OAIDeleteNotificationRequest();
    OAIDeleteNotificationRequest(QString json);
    ~OAIDeleteNotificationRequest() override;
    ...
    OAIDeleteNotificationRequest_Notification getNotification() const;
    void setNotification(const OAIDeleteNotificationRequest_Notification &notification);
...
private:
    ...
    OAIDeleteNotificationRequest_Notification m_notification;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNotificationRequest)

#endif // OAIDeleteNotificationRequest_H
