...
/*
 * OAINotificationWithSubscribers_Notification.h
 *
 * 
 */

#ifndef OAINotificationWithSubscribers_Notification_H
#define OAINotificationWithSubscribers_Notification_H
...
class OAINotificationWithSubscribers_Notification : public OAIObject {
public:
    OAINotificationWithSubscribers_Notification();
    OAINotificationWithSubscribers_Notification(QString json);
    ~OAINotificationWithSubscribers_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationWithSubscribers_Notification)

#endif // OAINotificationWithSubscribers_Notification_H
