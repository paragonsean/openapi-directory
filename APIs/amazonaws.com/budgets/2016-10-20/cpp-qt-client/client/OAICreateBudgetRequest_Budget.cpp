...
OAICreateBudgetRequest_Budget::OAICreateBudgetRequest_Budget(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBudgetRequest_Budget::OAICreateBudgetRequest_Budget() {
    this->initializeModel();
}

OAICreateBudgetRequest_Budget::~OAICreateBudgetRequest_Budget() {}

void OAICreateBudgetRequest_Budget::initializeModel() {
...
void OAICreateBudgetRequest_Budget::fromJson(QString jsonString) {
...
void OAICreateBudgetRequest_Budget::fromJsonObject(QJsonObject json) {
...
QString OAICreateBudgetRequest_Budget::asJson() const {
...
QJsonObject OAICreateBudgetRequest_Budget::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBudgetRequest_Budget::getBudgetName() const {
    return m_budget_name;
}
void OAICreateBudgetRequest_Budget::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAICreateBudgetRequest_Budget::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAIBudget_BudgetLimit OAICreateBudgetRequest_Budget::getBudgetLimit() const {
    return m_budget_limit;
}
void OAICreateBudgetRequest_Budget::setBudgetLimit(const OAIBudget_BudgetLimit &budget_limit) {
    m_budget_limit = budget_limit;
    m_budget_limit_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_budget_limit_Set() const{
    return m_budget_limit_isSet;
}

bool OAICreateBudgetRequest_Budget::is_budget_limit_Valid() const{
    return m_budget_limit_isValid;
}

QMap OAICreateBudgetRequest_Budget::getPlannedBudgetLimits() const {
    return m_planned_budget_limits;
}
void OAICreateBudgetRequest_Budget::setPlannedBudgetLimits(const QMap &planned_budget_limits) {
    m_planned_budget_limits = planned_budget_limits;
    m_planned_budget_limits_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_planned_budget_limits_Set() const{
    return m_planned_budget_limits_isSet;
}

bool OAICreateBudgetRequest_Budget::is_planned_budget_limits_Valid() const{
    return m_planned_budget_limits_isValid;
}

QMap OAICreateBudgetRequest_Budget::getCostFilters() const {
    return m_cost_filters;
}
void OAICreateBudgetRequest_Budget::setCostFilters(const QMap &cost_filters) {
    m_cost_filters = cost_filters;
    m_cost_filters_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_cost_filters_Set() const{
    return m_cost_filters_isSet;
}

bool OAICreateBudgetRequest_Budget::is_cost_filters_Valid() const{
    return m_cost_filters_isValid;
}

OAIBudget_CostTypes OAICreateBudgetRequest_Budget::getCostTypes() const {
    return m_cost_types;
}
void OAICreateBudgetRequest_Budget::setCostTypes(const OAIBudget_CostTypes &cost_types) {
    m_cost_types = cost_types;
    m_cost_types_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_cost_types_Set() const{
    return m_cost_types_isSet;
}

bool OAICreateBudgetRequest_Budget::is_cost_types_Valid() const{
    return m_cost_types_isValid;
}

OAITimeUnit OAICreateBudgetRequest_Budget::getTimeUnit() const {
    return m_time_unit;
}
void OAICreateBudgetRequest_Budget::setTimeUnit(const OAITimeUnit &time_unit) {
    m_time_unit = time_unit;
    m_time_unit_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_time_unit_Set() const{
    return m_time_unit_isSet;
}

bool OAICreateBudgetRequest_Budget::is_time_unit_Valid() const{
    return m_time_unit_isValid;
}

OAIBudget_TimePeriod OAICreateBudgetRequest_Budget::getTimePeriod() const {
    return m_time_period;
}
void OAICreateBudgetRequest_Budget::setTimePeriod(const OAIBudget_TimePeriod &time_period) {
    m_time_period = time_period;
    m_time_period_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_time_period_Set() const{
    return m_time_period_isSet;
}

bool OAICreateBudgetRequest_Budget::is_time_period_Valid() const{
    return m_time_period_isValid;
}

OAIBudget_CalculatedSpend OAICreateBudgetRequest_Budget::getCalculatedSpend() const {
    return m_calculated_spend;
}
void OAICreateBudgetRequest_Budget::setCalculatedSpend(const OAIBudget_CalculatedSpend &calculated_spend) {
    m_calculated_spend = calculated_spend;
    m_calculated_spend_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_calculated_spend_Set() const{
    return m_calculated_spend_isSet;
}

bool OAICreateBudgetRequest_Budget::is_calculated_spend_Valid() const{
    return m_calculated_spend_isValid;
}

OAIBudgetType OAICreateBudgetRequest_Budget::getBudgetType() const {
    return m_budget_type;
}
void OAICreateBudgetRequest_Budget::setBudgetType(const OAIBudgetType &budget_type) {
    m_budget_type = budget_type;
    m_budget_type_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_budget_type_Set() const{
    return m_budget_type_isSet;
}

bool OAICreateBudgetRequest_Budget::is_budget_type_Valid() const{
    return m_budget_type_isValid;
}

QDateTime OAICreateBudgetRequest_Budget::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAICreateBudgetRequest_Budget::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAICreateBudgetRequest_Budget::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

OAIBudget_AutoAdjustData OAICreateBudgetRequest_Budget::getAutoAdjustData() const {
    return m_auto_adjust_data;
}
void OAICreateBudgetRequest_Budget::setAutoAdjustData(const OAIBudget_AutoAdjustData &auto_adjust_data) {
    m_auto_adjust_data = auto_adjust_data;
    m_auto_adjust_data_isSet = true;
}

bool OAICreateBudgetRequest_Budget::is_auto_adjust_data_Set() const{
    return m_auto_adjust_data_isSet;
}

bool OAICreateBudgetRequest_Budget::is_auto_adjust_data_Valid() const{
    return m_auto_adjust_data_isValid;
}

bool OAICreateBudgetRequest_Budget::isSet() const {
...
bool OAICreateBudgetRequest_Budget::isValid() const {
