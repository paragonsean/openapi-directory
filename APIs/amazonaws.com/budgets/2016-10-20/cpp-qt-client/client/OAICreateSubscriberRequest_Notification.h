...
/*
 * OAICreateSubscriberRequest_Notification.h
 *
 * 
 */

#ifndef OAICreateSubscriberRequest_Notification_H
#define OAICreateSubscriberRequest_Notification_H

#include <QJsonObject>

#include "OAIComparisonOperator.h"
#include "OAINotificationState.h"
...
class OAICreateSubscriberRequest_Notification : public OAIObject {
public:
    OAICreateSubscriberRequest_Notification();
    OAICreateSubscriberRequest_Notification(QString json);
    ~OAICreateSubscriberRequest_Notification() override;
    ...
    OAIThresholdType getThresholdType() const;
    void setThresholdType(const OAIThresholdType &threshold_type);
    bool is_threshold_type_Set() const;
    bool is_threshold_type_Valid() const;

    OAINotificationState getNotificationState() const;
    void setNotificationState(const OAINotificationState &notification_state);
    bool is_notification_state_Set() const;
    bool is_notification_state_Valid() const;
...
private:
    ...
    OAIThresholdType m_threshold_type;
    bool m_threshold_type_isSet;
    bool m_threshold_type_isValid;

    OAINotificationState m_notification_state;
    bool m_notification_state_isSet;
    bool m_notification_state_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriberRequest_Notification)

#endif // OAICreateSubscriberRequest_Notification_H
