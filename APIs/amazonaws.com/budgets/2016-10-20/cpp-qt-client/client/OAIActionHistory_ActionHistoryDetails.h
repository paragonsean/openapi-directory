...
/*
 * OAIActionHistory_ActionHistoryDetails.h
 *
 * 
 */

#ifndef OAIActionHistory_ActionHistoryDetails_H
#define OAIActionHistory_ActionHistoryDetails_H
...
namespace OpenAPI {
class OAIActionHistoryDetails_Action;

class OAIActionHistory_ActionHistoryDetails : public OAIObject {
public:
    OAIActionHistory_ActionHistoryDetails();
    OAIActionHistory_ActionHistoryDetails(QString json);
    ~OAIActionHistory_ActionHistoryDetails() override;
    ...
    OAIActionHistoryDetails_Action getAction() const;
    void setAction(const OAIActionHistoryDetails_Action &action);
...
private:
    ...
    OAIActionHistoryDetails_Action m_action;
    bool m_action_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionHistory_ActionHistoryDetails)

#endif // OAIActionHistory_ActionHistoryDetails_H
