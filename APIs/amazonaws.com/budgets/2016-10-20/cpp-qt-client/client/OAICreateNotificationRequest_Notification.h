...
/*
 * OAICreateNotificationRequest_Notification.h
 *
 * 
 */

#ifndef OAICreateNotificationRequest_Notification_H
#define OAICreateNotificationRequest_Notification_H
...
class OAICreateNotificationRequest_Notification : public OAIObject {
public:
    OAICreateNotificationRequest_Notification();
    OAICreateNotificationRequest_Notification(QString json);
    ~OAICreateNotificationRequest_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNotificationRequest_Notification)

#endif // OAICreateNotificationRequest_Notification_H
