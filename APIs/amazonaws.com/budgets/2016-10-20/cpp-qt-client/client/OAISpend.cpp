...
OAISpend::OAISpend(QString json) {
...
void OAISpend::fromJson(QString jsonString) {
...
void OAISpend::fromJsonObject(QJsonObject json) {
...
QJsonObject OAISpend::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
QString OAISpend::getAmount() const {
    return m_amount;
}
void OAISpend::setAmount(const QString &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAISpend::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAISpend::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAISpend::getUnit() const {
    return m_unit;
}
void OAISpend::setUnit(const QString &unit) {
    m_unit = unit;
    m_unit_isSet = true;
}

bool OAISpend::is_unit_Set() const{
    return m_unit_isSet;
}

bool OAISpend::is_unit_Valid() const{
    return m_unit_isValid;
}

bool OAISpend::isSet() const {
