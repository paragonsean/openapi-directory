...
/*
 * OAIDescribeBudgetNotificationsForAccountResponse.h
 *
 * 
 */

#ifndef OAIDescribeBudgetNotificationsForAccountResponse_H
#define OAIDescribeBudgetNotificationsForAccountResponse_H
...
class OAIDescribeBudgetNotificationsForAccountResponse : public OAIObject {
public:
    OAIDescribeBudgetNotificationsForAccountResponse();
    OAIDescribeBudgetNotificationsForAccountResponse(QString json);
    ~OAIDescribeBudgetNotificationsForAccountResponse() override;
    ...
    QList getBudgetNotificationsForAccount() const;
    void setBudgetNotificationsForAccount(const QList &budget_notifications_for_account);
    bool is_budget_notifications_for_account_Set() const;
    bool is_budget_notifications_for_account_Valid() const;
...
private:
    ...
    QList m_budget_notifications_for_account;
    bool m_budget_notifications_for_account_isSet;
    bool m_budget_notifications_for_account_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetNotificationsForAccountResponse)

#endif // OAIDescribeBudgetNotificationsForAccountResponse_H
