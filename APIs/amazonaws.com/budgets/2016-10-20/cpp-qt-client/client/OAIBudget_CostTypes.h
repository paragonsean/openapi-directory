...
/*
 * OAIBudget_CostTypes.h
 *
 * 
 */

#ifndef OAIBudget_CostTypes_H
#define OAIBudget_CostTypes_H
...
class OAIBudget_CostTypes : public OAIObject {
public:
    OAIBudget_CostTypes();
    OAIBudget_CostTypes(QString json);
    ~OAIBudget_CostTypes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudget_CostTypes)

#endif // OAIBudget_CostTypes_H
