...
#include "OAIUpdateNotificationRequest_OldNotification.h"
...
OAIUpdateNotificationRequest_OldNotification::OAIUpdateNotificationRequest_OldNotification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNotificationRequest_OldNotification::OAIUpdateNotificationRequest_OldNotification() {
    this->initializeModel();
}

OAIUpdateNotificationRequest_OldNotification::~OAIUpdateNotificationRequest_OldNotification() {}

void OAIUpdateNotificationRequest_OldNotification::initializeModel() {
...
void OAIUpdateNotificationRequest_OldNotification::fromJson(QString jsonString) {
...
void OAIUpdateNotificationRequest_OldNotification::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNotificationRequest_OldNotification::asJson() const {
...
QJsonObject OAIUpdateNotificationRequest_OldNotification::asJsonObject() const {
    QJsonObject obj;
...
OAINotificationType OAIUpdateNotificationRequest_OldNotification::getNotificationType() const {
    return m_notification_type;
}
void OAIUpdateNotificationRequest_OldNotification::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIUpdateNotificationRequest_OldNotification::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIUpdateNotificationRequest_OldNotification::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIComparisonOperator OAIUpdateNotificationRequest_OldNotification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAIUpdateNotificationRequest_OldNotification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAIUpdateNotificationRequest_OldNotification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAIUpdateNotificationRequest_OldNotification::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

double OAIUpdateNotificationRequest_OldNotification::getThreshold() const {
    return m_threshold;
}
void OAIUpdateNotificationRequest_OldNotification::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAIUpdateNotificationRequest_OldNotification::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAIUpdateNotificationRequest_OldNotification::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIThresholdType OAIUpdateNotificationRequest_OldNotification::getThresholdType() const {
    return m_threshold_type;
}
void OAIUpdateNotificationRequest_OldNotification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAIUpdateNotificationRequest_OldNotification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAIUpdateNotificationRequest_OldNotification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAIUpdateNotificationRequest_OldNotification::getNotificationState() const {
    return m_notification_state;
}
void OAIUpdateNotificationRequest_OldNotification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAIUpdateNotificationRequest_OldNotification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAIUpdateNotificationRequest_OldNotification::is_notification_state_Valid() const{
    return m_notification_state_isValid;
}

bool OAIUpdateNotificationRequest_OldNotification::isSet() const {
...
bool OAIUpdateNotificationRequest_OldNotification::isValid() const {
