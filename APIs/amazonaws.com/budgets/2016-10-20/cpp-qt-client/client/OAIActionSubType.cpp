...
OAIActionSubType::OAIActionSubType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionSubType::OAIActionSubType() {
    this->initializeModel();
}

OAIActionSubType::~OAIActionSubType() {}

void OAIActionSubType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIActionSubType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIActionSubType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("STOP_EC2_INSTANCES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionSubType::EC2_INSTANCES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STOP_RDS_INSTANCES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionSubType::RDS_INSTANCES;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIActionSubType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIActionSubType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIActionSubType::EC2_INSTANCES:
            val = "STOP_EC2_INSTANCES";
            break;
        case eOAIActionSubType::RDS_INSTANCES:
            val = "STOP_RDS_INSTANCES";
            break;
        default:
            break;
    }
...
QJsonValue OAIActionSubType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIActionSubType::eOAIActionSubType OAIActionSubType::getValue() const {
    return m_value;
}

void OAIActionSubType::setValue(const OAIActionSubType::eOAIActionSubType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIActionSubType::isSet() const {
    
    return m_value_isSet;
}

bool OAIActionSubType::isValid() const {
