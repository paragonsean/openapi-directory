...
OAICreateBudgetActionResponse::OAICreateBudgetActionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBudgetActionResponse::OAICreateBudgetActionResponse() {
    this->initializeModel();
}

OAICreateBudgetActionResponse::~OAICreateBudgetActionResponse() {}

void OAICreateBudgetActionResponse::initializeModel() {
...
void OAICreateBudgetActionResponse::fromJson(QString jsonString) {
...
void OAICreateBudgetActionResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateBudgetActionResponse::asJson() const {
...
QJsonObject OAICreateBudgetActionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBudgetActionResponse::getAccountId() const {
    return m_account_id;
}
void OAICreateBudgetActionResponse::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICreateBudgetActionResponse::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICreateBudgetActionResponse::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAICreateBudgetActionResponse::getBudgetName() const {
    return m_budget_name;
}
void OAICreateBudgetActionResponse::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAICreateBudgetActionResponse::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAICreateBudgetActionResponse::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

QString OAICreateBudgetActionResponse::getActionId() const {
    return m_action_id;
}
void OAICreateBudgetActionResponse::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAICreateBudgetActionResponse::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAICreateBudgetActionResponse::is_action_id_Valid() const{
    return m_action_id_isValid;
}

bool OAICreateBudgetActionResponse::isSet() const {
...
bool OAICreateBudgetActionResponse::isValid() const {
