...
OAINotificationWithSubscribers_Notification::OAINotificationWithSubscribers_Notification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotificationWithSubscribers_Notification::OAINotificationWithSubscribers_Notification() {
    this->initializeModel();
}

OAINotificationWithSubscribers_Notification::~OAINotificationWithSubscribers_Notification() {}

void OAINotificationWithSubscribers_Notification::initializeModel() {
...
void OAINotificationWithSubscribers_Notification::fromJson(QString jsonString) {
...
void OAINotificationWithSubscribers_Notification::fromJsonObject(QJsonObject json) {
...
QString OAINotificationWithSubscribers_Notification::asJson() const {
...
QJsonObject OAINotificationWithSubscribers_Notification::asJsonObject() const {
    QJsonObject obj;
...
OAINotificationType OAINotificationWithSubscribers_Notification::getNotificationType() const {
    return m_notification_type;
}
void OAINotificationWithSubscribers_Notification::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAINotificationWithSubscribers_Notification::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAINotificationWithSubscribers_Notification::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIComparisonOperator OAINotificationWithSubscribers_Notification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAINotificationWithSubscribers_Notification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAINotificationWithSubscribers_Notification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAINotificationWithSubscribers_Notification::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

double OAINotificationWithSubscribers_Notification::getThreshold() const {
    return m_threshold;
}
void OAINotificationWithSubscribers_Notification::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAINotificationWithSubscribers_Notification::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAINotificationWithSubscribers_Notification::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIThresholdType OAINotificationWithSubscribers_Notification::getThresholdType() const {
    return m_threshold_type;
}
void OAINotificationWithSubscribers_Notification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAINotificationWithSubscribers_Notification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAINotificationWithSubscribers_Notification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAINotificationWithSubscribers_Notification::getNotificationState() const {
    return m_notification_state;
}
void OAINotificationWithSubscribers_Notification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAINotificationWithSubscribers_Notification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAINotificationWithSubscribers_Notification::is_notification_state_Valid() const{
    return m_notification_state_isValid;
}

bool OAINotificationWithSubscribers_Notification::isSet() const {
...
bool OAINotificationWithSubscribers_Notification::isValid() const {
