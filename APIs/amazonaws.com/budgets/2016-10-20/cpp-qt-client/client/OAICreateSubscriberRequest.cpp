...
QString OAICreateSubscriberRequest::getAccountId() const {
    return m_account_id;
}
void OAICreateSubscriberRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICreateSubscriberRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICreateSubscriberRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAICreateSubscriberRequest::getBudgetName() const {
    return m_budget_name;
}
void OAICreateSubscriberRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAICreateSubscriberRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAICreateSubscriberRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAICreateSubscriberRequest_Notification OAICreateSubscriberRequest::getNotification() const {
    return m_notification;
}
void OAICreateSubscriberRequest::setNotification(const OAICreateSubscriberRequest_Notification &notification) {
    m_notification = notification;
    m_notification_isSet = true;
}

bool OAICreateSubscriberRequest::is_notification_Set() const{
    return m_notification_isSet;
}

bool OAICreateSubscriberRequest::is_notification_Valid() const{
    return m_notification_isValid;
}

OAICreateSubscriberRequest_Subscriber OAICreateSubscriberRequest::getSubscriber() const {
    return m_subscriber;
}
void OAICreateSubscriberRequest::setSubscriber(const OAICreateSubscriberRequest_Subscriber &subscriber) {
    m_subscriber = subscriber;
    m_subscriber_isSet = true;
}

bool OAICreateSubscriberRequest::is_subscriber_Set() const{
    return m_subscriber_isSet;
}

bool OAICreateSubscriberRequest::is_subscriber_Valid() const{
