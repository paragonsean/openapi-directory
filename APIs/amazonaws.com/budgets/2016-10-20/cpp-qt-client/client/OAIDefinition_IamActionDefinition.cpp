...
OAIDefinition_IamActionDefinition::OAIDefinition_IamActionDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDefinition_IamActionDefinition::OAIDefinition_IamActionDefinition() {
    this->initializeModel();
}

OAIDefinition_IamActionDefinition::~OAIDefinition_IamActionDefinition() {}

void OAIDefinition_IamActionDefinition::initializeModel() {
...
void OAIDefinition_IamActionDefinition::fromJson(QString jsonString) {
...
void OAIDefinition_IamActionDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIDefinition_IamActionDefinition::asJson() const {
...
QJsonObject OAIDefinition_IamActionDefinition::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDefinition_IamActionDefinition::getPolicyArn() const {
    return m_policy_arn;
}
void OAIDefinition_IamActionDefinition::setPolicyArn(const QString &policy_arn) {
    m_policy_arn = policy_arn;
    m_policy_arn_isSet = true;
}

bool OAIDefinition_IamActionDefinition::is_policy_arn_Set() const{
    return m_policy_arn_isSet;
}

bool OAIDefinition_IamActionDefinition::is_policy_arn_Valid() const{
    return m_policy_arn_isValid;
}

QList OAIDefinition_IamActionDefinition::getRoles() const {
    return m_roles;
}
void OAIDefinition_IamActionDefinition::setRoles(const QList &roles) {
    m_roles = roles;
    m_roles_isSet = true;
}

bool OAIDefinition_IamActionDefinition::is_roles_Set() const{
    return m_roles_isSet;
}

bool OAIDefinition_IamActionDefinition::is_roles_Valid() const{
    return m_roles_isValid;
}

QList OAIDefinition_IamActionDefinition::getGroups() const {
    return m_groups;
}
void OAIDefinition_IamActionDefinition::setGroups(const QList &groups) {
    m_groups = groups;
    m_groups_isSet = true;
}

bool OAIDefinition_IamActionDefinition::is_groups_Set() const{
    return m_groups_isSet;
}

bool OAIDefinition_IamActionDefinition::is_groups_Valid() const{
    return m_groups_isValid;
}

QList OAIDefinition_IamActionDefinition::getUsers() const {
    return m_users;
}
void OAIDefinition_IamActionDefinition::setUsers(const QList &users) {
    m_users = users;
    m_users_isSet = true;
}

bool OAIDefinition_IamActionDefinition::is_users_Set() const{
    return m_users_isSet;
}

bool OAIDefinition_IamActionDefinition::is_users_Valid() const{
    return m_users_isValid;
}

bool OAIDefinition_IamActionDefinition::isSet() const {
...
bool OAIDefinition_IamActionDefinition::isValid() const {
