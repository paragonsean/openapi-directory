...
#ifndef OAIExecutionType_H
#define OAIExecutionType_H
...
class OAIExecutionType : public OAIEnum {
public:
    OAIExecutionType();
    OAIExecutionType(QString json);
    ~OAIExecutionType() override;
    ...
    OAIExecutionType::eOAIExecutionType getValue() const;
    void setValue(const OAIExecutionType::eOAIExecutionType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutionType)

#endif // OAIExecutionType_H
