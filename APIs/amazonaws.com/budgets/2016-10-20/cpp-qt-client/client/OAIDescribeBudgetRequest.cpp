...
OAIDescribeBudgetRequest::OAIDescribeBudgetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetRequest::OAIDescribeBudgetRequest() {
    this->initializeModel();
}

OAIDescribeBudgetRequest::~OAIDescribeBudgetRequest() {}

void OAIDescribeBudgetRequest::initializeModel() {
...
void OAIDescribeBudgetRequest::fromJson(QString jsonString) {
...
void OAIDescribeBudgetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetRequest::asJson() const {
...
QJsonObject OAIDescribeBudgetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeBudgetRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeBudgetRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeBudgetRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIDescribeBudgetRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIDescribeBudgetRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDescribeBudgetRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDescribeBudgetRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

bool OAIDescribeBudgetRequest::isSet() const {
...
bool OAIDescribeBudgetRequest::isValid() const {
