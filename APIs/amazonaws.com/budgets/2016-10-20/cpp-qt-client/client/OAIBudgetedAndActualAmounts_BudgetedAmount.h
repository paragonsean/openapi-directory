...
/*
 * OAIBudgetedAndActualAmounts_BudgetedAmount.h
 *
 * 
 */

#ifndef OAIBudgetedAndActualAmounts_BudgetedAmount_H
#define OAIBudgetedAndActualAmounts_BudgetedAmount_H
...
class OAIBudgetedAndActualAmounts_BudgetedAmount : public OAIObject {
public:
    OAIBudgetedAndActualAmounts_BudgetedAmount();
    OAIBudgetedAndActualAmounts_BudgetedAmount(QString json);
    ~OAIBudgetedAndActualAmounts_BudgetedAmount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudgetedAndActualAmounts_BudgetedAmount)

#endif // OAIBudgetedAndActualAmounts_BudgetedAmount_H
