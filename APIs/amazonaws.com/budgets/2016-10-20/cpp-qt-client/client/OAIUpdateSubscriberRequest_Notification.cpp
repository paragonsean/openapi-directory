...
OAIUpdateSubscriberRequest_Notification::OAIUpdateSubscriberRequest_Notification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSubscriberRequest_Notification::OAIUpdateSubscriberRequest_Notification() {
    this->initializeModel();
}

OAIUpdateSubscriberRequest_Notification::~OAIUpdateSubscriberRequest_Notification() {}

void OAIUpdateSubscriberRequest_Notification::initializeModel() {
...
void OAIUpdateSubscriberRequest_Notification::fromJson(QString jsonString) {
...
void OAIUpdateSubscriberRequest_Notification::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSubscriberRequest_Notification::asJson() const {
...
QJsonObject OAIUpdateSubscriberRequest_Notification::asJsonObject() const {
    QJsonObject obj;
...
OAINotificationType OAIUpdateSubscriberRequest_Notification::getNotificationType() const {
    return m_notification_type;
}
void OAIUpdateSubscriberRequest_Notification::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIUpdateSubscriberRequest_Notification::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIUpdateSubscriberRequest_Notification::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIComparisonOperator OAIUpdateSubscriberRequest_Notification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAIUpdateSubscriberRequest_Notification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAIUpdateSubscriberRequest_Notification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAIUpdateSubscriberRequest_Notification::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

double OAIUpdateSubscriberRequest_Notification::getThreshold() const {
    return m_threshold;
}
void OAIUpdateSubscriberRequest_Notification::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAIUpdateSubscriberRequest_Notification::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAIUpdateSubscriberRequest_Notification::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIThresholdType OAIUpdateSubscriberRequest_Notification::getThresholdType() const {
    return m_threshold_type;
}
void OAIUpdateSubscriberRequest_Notification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAIUpdateSubscriberRequest_Notification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAIUpdateSubscriberRequest_Notification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAIUpdateSubscriberRequest_Notification::getNotificationState() const {
    return m_notification_state;
}
void OAIUpdateSubscriberRequest_Notification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAIUpdateSubscriberRequest_Notification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAIUpdateSubscriberRequest_Notification::is_notification_state_Valid() const{
    return m_notification_state_isValid;
}

bool OAIUpdateSubscriberRequest_Notification::isSet() const {
...
bool OAIUpdateSubscriberRequest_Notification::isValid() const {
