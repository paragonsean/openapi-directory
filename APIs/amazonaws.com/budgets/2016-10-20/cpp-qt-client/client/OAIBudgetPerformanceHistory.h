...
/*
 * OAIBudgetPerformanceHistory.h
 *
 * A history of the state of a budget at the end of the budget&#39;s specified time period.
 */

#ifndef OAIBudgetPerformanceHistory_H
#define OAIBudgetPerformanceHistory_H
...
class OAIBudgetPerformanceHistory : public OAIObject {
public:
    OAIBudgetPerformanceHistory();
    OAIBudgetPerformanceHistory(QString json);
    ~OAIBudgetPerformanceHistory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudgetPerformanceHistory)

#endif // OAIBudgetPerformanceHistory_H
