...
QString OAIBudget::getBudgetName() const {
    return m_budget_name;
}
void OAIBudget::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIBudget::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIBudget::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAIBudget_BudgetLimit OAIBudget::getBudgetLimit() const {
    return m_budget_limit;
}
void OAIBudget::setBudgetLimit(const OAIBudget_BudgetLimit &budget_limit) {
    m_budget_limit = budget_limit;
    m_budget_limit_isSet = true;
}

bool OAIBudget::is_budget_limit_Set() const{
    return m_budget_limit_isSet;
}

bool OAIBudget::is_budget_limit_Valid() const{
    return m_budget_limit_isValid;
}

QMap OAIBudget::getPlannedBudgetLimits() const {
    return m_planned_budget_limits;
}
void OAIBudget::setPlannedBudgetLimits(const QMap &planned_budget_limits) {
    m_planned_budget_limits = planned_budget_limits;
    m_planned_budget_limits_isSet = true;
}

bool OAIBudget::is_planned_budget_limits_Set() const{
    return m_planned_budget_limits_isSet;
}

bool OAIBudget::is_planned_budget_limits_Valid() const{
    return m_planned_budget_limits_isValid;
}

QMap OAIBudget::getCostFilters() const {
    return m_cost_filters;
}
void OAIBudget::setCostFilters(const QMap &cost_filters) {
    m_cost_filters = cost_filters;
    m_cost_filters_isSet = true;
}

bool OAIBudget::is_cost_filters_Set() const{
    return m_cost_filters_isSet;
}

bool OAIBudget::is_cost_filters_Valid() const{
    return m_cost_filters_isValid;
}

OAIBudget_CostTypes OAIBudget::getCostTypes() const {
    return m_cost_types;
}
void OAIBudget::setCostTypes(const OAIBudget_CostTypes &cost_types) {
    m_cost_types = cost_types;
    m_cost_types_isSet = true;
}

bool OAIBudget::is_cost_types_Set() const{
    return m_cost_types_isSet;
}

bool OAIBudget::is_cost_types_Valid() const{
    return m_cost_types_isValid;
}

OAITimeUnit OAIBudget::getTimeUnit() const {
    return m_time_unit;
}
void OAIBudget::setTimeUnit(const OAITimeUnit &time_unit) {
    m_time_unit = time_unit;
    m_time_unit_isSet = true;
}

bool OAIBudget::is_time_unit_Set() const{
    return m_time_unit_isSet;
}

bool OAIBudget::is_time_unit_Valid() const{
    return m_time_unit_isValid;
}

OAIBudget_TimePeriod OAIBudget::getTimePeriod() const {
    return m_time_period;
}
void OAIBudget::setTimePeriod(const OAIBudget_TimePeriod &time_period) {
    m_time_period = time_period;
    m_time_period_isSet = true;
}

bool OAIBudget::is_time_period_Set() const{
    return m_time_period_isSet;
}

bool OAIBudget::is_time_period_Valid() const{
    return m_time_period_isValid;
}

OAIBudget_CalculatedSpend OAIBudget::getCalculatedSpend() const {
    return m_calculated_spend;
}
void OAIBudget::setCalculatedSpend(const OAIBudget_CalculatedSpend &calculated_spend) {
    m_calculated_spend = calculated_spend;
    m_calculated_spend_isSet = true;
}

bool OAIBudget::is_calculated_spend_Set() const{
    return m_calculated_spend_isSet;
}

bool OAIBudget::is_calculated_spend_Valid() const{
    return m_calculated_spend_isValid;
}

OAIBudgetType OAIBudget::getBudgetType() const {
    return m_budget_type;
}
void OAIBudget::setBudgetType(const OAIBudgetType &budget_type) {
    m_budget_type = budget_type;
    m_budget_type_isSet = true;
}

bool OAIBudget::is_budget_type_Set() const{
    return m_budget_type_isSet;
}

bool OAIBudget::is_budget_type_Valid() const{
    return m_budget_type_isValid;
}

QDateTime OAIBudget::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIBudget::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIBudget::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIBudget::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

OAIBudget_AutoAdjustData OAIBudget::getAutoAdjustData() const {
    return m_auto_adjust_data;
}
void OAIBudget::setAutoAdjustData(const OAIBudget_AutoAdjustData &auto_adjust_data) {
    m_auto_adjust_data = auto_adjust_data;
    m_auto_adjust_data_isSet = true;
}

bool OAIBudget::is_auto_adjust_data_Set() const{
    return m_auto_adjust_data_isSet;
}

bool OAIBudget::is_auto_adjust_data_Valid() const{
