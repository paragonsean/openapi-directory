...
/*
 * OAICreateSubscriberRequest.h
 *
 *  Request of CreateSubscriber 
 */

#ifndef OAICreateSubscriberRequest_H
#define OAICreateSubscriberRequest_H

#include <QJsonObject>

#include "OAICreateSubscriberRequest_Notification.h"
...
namespace OpenAPI {
class OAICreateSubscriberRequest_Notification;
class OAICreateSubscriberRequest_Subscriber;

class OAICreateSubscriberRequest : public OAIObject {
public:
    OAICreateSubscriberRequest();
    OAICreateSubscriberRequest(QString json);
    ~OAICreateSubscriberRequest() override;
    ...
    OAICreateSubscriberRequest_Notification getNotification() const;
    void setNotification(const OAICreateSubscriberRequest_Notification &notification);
    bool is_notification_Set() const;
    bool is_notification_Valid() const;

    OAICreateSubscriberRequest_Subscriber getSubscriber() const;
    void setSubscriber(const OAICreateSubscriberRequest_Subscriber &subscriber);
...
private:
    ...
    OAICreateSubscriberRequest_Notification m_notification;
    bool m_notification_isSet;
    bool m_notification_isValid;

    OAICreateSubscriberRequest_Subscriber m_subscriber;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriberRequest)

#endif // OAICreateSubscriberRequest_H
