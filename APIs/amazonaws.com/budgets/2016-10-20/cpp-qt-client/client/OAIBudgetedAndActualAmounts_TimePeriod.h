...
/*
 * OAIBudgetedAndActualAmounts_TimePeriod.h
 *
 * 
 */

#ifndef OAIBudgetedAndActualAmounts_TimePeriod_H
#define OAIBudgetedAndActualAmounts_TimePeriod_H
...
class OAIBudgetedAndActualAmounts_TimePeriod : public OAIObject {
public:
    OAIBudgetedAndActualAmounts_TimePeriod();
    OAIBudgetedAndActualAmounts_TimePeriod(QString json);
    ~OAIBudgetedAndActualAmounts_TimePeriod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudgetedAndActualAmounts_TimePeriod)

#endif // OAIBudgetedAndActualAmounts_TimePeriod_H
