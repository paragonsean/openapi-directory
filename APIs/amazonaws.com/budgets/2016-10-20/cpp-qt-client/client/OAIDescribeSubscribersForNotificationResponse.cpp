...
OAIDescribeSubscribersForNotificationResponse::OAIDescribeSubscribersForNotificationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeSubscribersForNotificationResponse::OAIDescribeSubscribersForNotificationResponse() {
    this->initializeModel();
}

OAIDescribeSubscribersForNotificationResponse::~OAIDescribeSubscribersForNotificationResponse() {}

void OAIDescribeSubscribersForNotificationResponse::initializeModel() {
...
void OAIDescribeSubscribersForNotificationResponse::fromJson(QString jsonString) {
...
void OAIDescribeSubscribersForNotificationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeSubscribersForNotificationResponse::asJson() const {
...
QJsonObject OAIDescribeSubscribersForNotificationResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeSubscribersForNotificationResponse::getSubscribers() const {
    return m_subscribers;
}
void OAIDescribeSubscribersForNotificationResponse::setSubscribers(const QList &subscribers) {
    m_subscribers = subscribers;
    m_subscribers_isSet = true;
}

bool OAIDescribeSubscribersForNotificationResponse::is_subscribers_Set() const{
    return m_subscribers_isSet;
}

bool OAIDescribeSubscribersForNotificationResponse::is_subscribers_Valid() const{
    return m_subscribers_isValid;
}

QString OAIDescribeSubscribersForNotificationResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeSubscribersForNotificationResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeSubscribersForNotificationResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeSubscribersForNotificationResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeSubscribersForNotificationResponse::isSet() const {
...
bool OAIDescribeSubscribersForNotificationResponse::isValid() const {
