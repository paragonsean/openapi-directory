...
void OAIComparisonOperator::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("GREATER_THAN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComparisonOperator::GREATER_THAN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LESS_THAN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComparisonOperator::LESS_THAN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EQUAL_TO", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComparisonOperator::EQUAL_TO;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIComparisonOperator::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIComparisonOperator::GREATER_THAN:
            val = "GREATER_THAN";
            break;
        case eOAIComparisonOperator::LESS_THAN:
            val = "LESS_THAN";
            break;
        case eOAIComparisonOperator::EQUAL_TO:
            val = "EQUAL_TO";
            break;
        default:
            break;
