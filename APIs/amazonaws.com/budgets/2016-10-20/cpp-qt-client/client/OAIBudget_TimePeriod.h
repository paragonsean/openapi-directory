...
/*
 * OAIBudget_TimePeriod.h
 *
 * 
 */

#ifndef OAIBudget_TimePeriod_H
#define OAIBudget_TimePeriod_H
...
class OAIBudget_TimePeriod : public OAIObject {
public:
    OAIBudget_TimePeriod();
    OAIBudget_TimePeriod(QString json);
    ~OAIBudget_TimePeriod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudget_TimePeriod)

#endif // OAIBudget_TimePeriod_H
