...
/*
 * OAIDescribeBudgetActionHistoriesRequest.h
 *
 * 
 */

#ifndef OAIDescribeBudgetActionHistoriesRequest_H
#define OAIDescribeBudgetActionHistoriesRequest_H
...
class OAIDescribeBudgetActionHistoriesRequest : public OAIObject {
public:
    OAIDescribeBudgetActionHistoriesRequest();
    OAIDescribeBudgetActionHistoriesRequest(QString json);
    ~OAIDescribeBudgetActionHistoriesRequest() override;
    ...
    OAITimePeriod getTimePeriod() const;
    void setTimePeriod(const OAITimePeriod &time_period);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetActionHistoriesRequest)

#endif // OAIDescribeBudgetActionHistoriesRequest_H
