...
/*
 * OAIDescribeBudgetResponse.h
 *
 *  Response of DescribeBudget 
 */

#ifndef OAIDescribeBudgetResponse_H
#define OAIDescribeBudgetResponse_H
...
namespace OpenAPI {
class OAIDescribeBudgetResponse_Budget;

class OAIDescribeBudgetResponse : public OAIObject {
public:
    OAIDescribeBudgetResponse();
    OAIDescribeBudgetResponse(QString json);
    ~OAIDescribeBudgetResponse() override;
    ...
    OAIDescribeBudgetResponse_Budget getBudget() const;
    void setBudget(const OAIDescribeBudgetResponse_Budget &budget);
...
private:
    ...
    OAIDescribeBudgetResponse_Budget m_budget;
    bool m_budget_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetResponse)

#endif // OAIDescribeBudgetResponse_H
