...
/*
 * OAICreateBudgetActionResponse.h
 *
 * 
 */

#ifndef OAICreateBudgetActionResponse_H
#define OAICreateBudgetActionResponse_H
...
class OAICreateBudgetActionResponse : public OAIObject {
public:
    OAICreateBudgetActionResponse();
    OAICreateBudgetActionResponse(QString json);
    ~OAICreateBudgetActionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBudgetActionResponse)

#endif // OAICreateBudgetActionResponse_H
