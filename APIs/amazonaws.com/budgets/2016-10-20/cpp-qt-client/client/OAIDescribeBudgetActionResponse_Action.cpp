...
#include "OAIDescribeBudgetActionResponse_Action.h"
...
OAIDescribeBudgetActionResponse_Action::OAIDescribeBudgetActionResponse_Action(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetActionResponse_Action::OAIDescribeBudgetActionResponse_Action() {
    this->initializeModel();
}

OAIDescribeBudgetActionResponse_Action::~OAIDescribeBudgetActionResponse_Action() {}

void OAIDescribeBudgetActionResponse_Action::initializeModel() {
...
void OAIDescribeBudgetActionResponse_Action::fromJson(QString jsonString) {
...
void OAIDescribeBudgetActionResponse_Action::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetActionResponse_Action::asJson() const {
...
QJsonObject OAIDescribeBudgetActionResponse_Action::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetActionResponse_Action::getActionId() const {
    return m_action_id;
}
void OAIDescribeBudgetActionResponse_Action::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_action_id_Valid() const{
    return m_action_id_isValid;
}

QString OAIDescribeBudgetActionResponse_Action::getBudgetName() const {
    return m_budget_name;
}
void OAIDescribeBudgetActionResponse_Action::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAINotificationType OAIDescribeBudgetActionResponse_Action::getNotificationType() const {
    return m_notification_type;
}
void OAIDescribeBudgetActionResponse_Action::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIActionType OAIDescribeBudgetActionResponse_Action::getActionType() const {
    return m_action_type;
}
void OAIDescribeBudgetActionResponse_Action::setActionType(const OAIActionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_action_type_Valid() const{
    return m_action_type_isValid;
}

OAIAction_ActionThreshold OAIDescribeBudgetActionResponse_Action::getActionThreshold() const {
    return m_action_threshold;
}
void OAIDescribeBudgetActionResponse_Action::setActionThreshold(const OAIAction_ActionThreshold &action_threshold) {
    m_action_threshold = action_threshold;
    m_action_threshold_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_action_threshold_Set() const{
    return m_action_threshold_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_action_threshold_Valid() const{
    return m_action_threshold_isValid;
}

OAIAction_Definition OAIDescribeBudgetActionResponse_Action::getDefinition() const {
    return m_definition;
}
void OAIDescribeBudgetActionResponse_Action::setDefinition(const OAIAction_Definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_definition_Valid() const{
    return m_definition_isValid;
}

QString OAIDescribeBudgetActionResponse_Action::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAIDescribeBudgetActionResponse_Action::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

OAIApprovalModel OAIDescribeBudgetActionResponse_Action::getApprovalModel() const {
    return m_approval_model;
}
void OAIDescribeBudgetActionResponse_Action::setApprovalModel(const OAIApprovalModel &approval_model) {
    m_approval_model = approval_model;
    m_approval_model_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_approval_model_Set() const{
    return m_approval_model_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_approval_model_Valid() const{
    return m_approval_model_isValid;
}

OAIActionStatus OAIDescribeBudgetActionResponse_Action::getStatus() const {
    return m_status;
}
void OAIDescribeBudgetActionResponse_Action::setStatus(const OAIActionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_status_Valid() const{
    return m_status_isValid;
}

QList<OAISubscriber> OAIDescribeBudgetActionResponse_Action::getSubscribers() const {
    return m_subscribers;
}
void OAIDescribeBudgetActionResponse_Action::setSubscribers(const QList<OAISubscriber> &subscribers) {
    m_subscribers = subscribers;
    m_subscribers_isSet = true;
}

bool OAIDescribeBudgetActionResponse_Action::is_subscribers_Set() const{
    return m_subscribers_isSet;
}

bool OAIDescribeBudgetActionResponse_Action::is_subscribers_Valid() const{
    return m_subscribers_isValid;
}

bool OAIDescribeBudgetActionResponse_Action::isSet() const {
...
bool OAIDescribeBudgetActionResponse_Action::isValid() const {
