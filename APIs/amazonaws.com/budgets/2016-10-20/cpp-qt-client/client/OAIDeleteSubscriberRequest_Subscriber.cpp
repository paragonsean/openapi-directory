...
#include "OAIDeleteSubscriberRequest_Subscriber.h"
...
OAIDeleteSubscriberRequest_Subscriber::OAIDeleteSubscriberRequest_Subscriber(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSubscriberRequest_Subscriber::OAIDeleteSubscriberRequest_Subscriber() {
    this->initializeModel();
}

OAIDeleteSubscriberRequest_Subscriber::~OAIDeleteSubscriberRequest_Subscriber() {}

void OAIDeleteSubscriberRequest_Subscriber::initializeModel() {
...
void OAIDeleteSubscriberRequest_Subscriber::fromJson(QString jsonString) {
...
void OAIDeleteSubscriberRequest_Subscriber::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSubscriberRequest_Subscriber::asJson() const {
...
QJsonObject OAIDeleteSubscriberRequest_Subscriber::asJsonObject() const {
    QJsonObject obj;
...
OAISubscriptionType OAIDeleteSubscriberRequest_Subscriber::getSubscriptionType() const {
    return m_subscription_type;
}
void OAIDeleteSubscriberRequest_Subscriber::setSubscriptionType(const OAISubscriptionType &subscription_type) {
    m_subscription_type = subscription_type;
    m_subscription_type_isSet = true;
}

bool OAIDeleteSubscriberRequest_Subscriber::is_subscription_type_Set() const{
    return m_subscription_type_isSet;
}

bool OAIDeleteSubscriberRequest_Subscriber::is_subscription_type_Valid() const{
    return m_subscription_type_isValid;
}

QString OAIDeleteSubscriberRequest_Subscriber::getAddress() const {
    return m_address;
}
void OAIDeleteSubscriberRequest_Subscriber::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIDeleteSubscriberRequest_Subscriber::is_address_Set() const{
    return m_address_isSet;
}

bool OAIDeleteSubscriberRequest_Subscriber::is_address_Valid() const{
    return m_address_isValid;
}

bool OAIDeleteSubscriberRequest_Subscriber::isSet() const {
...
bool OAIDeleteSubscriberRequest_Subscriber::isValid() const {
