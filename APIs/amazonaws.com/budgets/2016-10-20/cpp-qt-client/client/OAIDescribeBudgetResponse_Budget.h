...
/*
 * OAIDescribeBudgetResponse_Budget.h
 *
 * 
 */

#ifndef OAIDescribeBudgetResponse_Budget_H
#define OAIDescribeBudgetResponse_Budget_H
...
class OAIDescribeBudgetResponse_Budget : public OAIObject {
public:
    OAIDescribeBudgetResponse_Budget();
    OAIDescribeBudgetResponse_Budget(QString json);
    ~OAIDescribeBudgetResponse_Budget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetResponse_Budget)

#endif // OAIDescribeBudgetResponse_Budget_H
