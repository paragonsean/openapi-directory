...
/*
 * OAICreateBudgetRequest_Budget.h
 *
 * 
 */

#ifndef OAICreateBudgetRequest_Budget_H
#define OAICreateBudgetRequest_Budget_H
...
class OAICreateBudgetRequest_Budget : public OAIObject {
public:
    OAICreateBudgetRequest_Budget();
    OAICreateBudgetRequest_Budget(QString json);
    ~OAICreateBudgetRequest_Budget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBudgetRequest_Budget)

#endif // OAICreateBudgetRequest_Budget_H
