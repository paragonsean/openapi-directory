...
#include "OAIUpdateNotificationRequest_NewNotification.h"
...
OAIUpdateNotificationRequest_NewNotification::OAIUpdateNotificationRequest_NewNotification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNotificationRequest_NewNotification::OAIUpdateNotificationRequest_NewNotification() {
    this->initializeModel();
}

OAIUpdateNotificationRequest_NewNotification::~OAIUpdateNotificationRequest_NewNotification() {}

void OAIUpdateNotificationRequest_NewNotification::initializeModel() {
...
void OAIUpdateNotificationRequest_NewNotification::fromJson(QString jsonString) {
...
void OAIUpdateNotificationRequest_NewNotification::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNotificationRequest_NewNotification::asJson() const {
...
QJsonObject OAIUpdateNotificationRequest_NewNotification::asJsonObject() const {
    QJsonObject obj;
...
OAINotificationType OAIUpdateNotificationRequest_NewNotification::getNotificationType() const {
    return m_notification_type;
}
void OAIUpdateNotificationRequest_NewNotification::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIUpdateNotificationRequest_NewNotification::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIUpdateNotificationRequest_NewNotification::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIComparisonOperator OAIUpdateNotificationRequest_NewNotification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAIUpdateNotificationRequest_NewNotification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAIUpdateNotificationRequest_NewNotification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAIUpdateNotificationRequest_NewNotification::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

double OAIUpdateNotificationRequest_NewNotification::getThreshold() const {
    return m_threshold;
}
void OAIUpdateNotificationRequest_NewNotification::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAIUpdateNotificationRequest_NewNotification::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAIUpdateNotificationRequest_NewNotification::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIThresholdType OAIUpdateNotificationRequest_NewNotification::getThresholdType() const {
    return m_threshold_type;
}
void OAIUpdateNotificationRequest_NewNotification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAIUpdateNotificationRequest_NewNotification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAIUpdateNotificationRequest_NewNotification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAIUpdateNotificationRequest_NewNotification::getNotificationState() const {
    return m_notification_state;
}
void OAIUpdateNotificationRequest_NewNotification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAIUpdateNotificationRequest_NewNotification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAIUpdateNotificationRequest_NewNotification::is_notification_state_Valid() const{
    return m_notification_state_isValid;
}

bool OAIUpdateNotificationRequest_NewNotification::isSet() const {
...
bool OAIUpdateNotificationRequest_NewNotification::isValid() const {
