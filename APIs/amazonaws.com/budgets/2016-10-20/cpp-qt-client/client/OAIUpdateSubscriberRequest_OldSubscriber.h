...
/*
 * OAIUpdateSubscriberRequest_OldSubscriber.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberRequest_OldSubscriber_H
#define OAIUpdateSubscriberRequest_OldSubscriber_H
...
class OAIUpdateSubscriberRequest_OldSubscriber : public OAIObject {
public:
    OAIUpdateSubscriberRequest_OldSubscriber();
    OAIUpdateSubscriberRequest_OldSubscriber(QString json);
    ~OAIUpdateSubscriberRequest_OldSubscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberRequest_OldSubscriber)

#endif // OAIUpdateSubscriberRequest_OldSubscriber_H
