...
/*
 * OAIAction_ActionThreshold.h
 *
 * 
 */

#ifndef OAIAction_ActionThreshold_H
#define OAIAction_ActionThreshold_H
...
class OAIAction_ActionThreshold : public OAIObject {
public:
    OAIAction_ActionThreshold();
    OAIAction_ActionThreshold(QString json);
    ~OAIAction_ActionThreshold() override;
    ...
    void setActionThresholdValue(const double &action_threshold_value);
    bool is_action_threshold_value_Set() const;
    bool is_action_threshold_value_Valid() const;

    OAIThresholdType getActionThresholdType() const;
    void setActionThresholdType(const OAIThresholdType &action_threshold_type);
    bool is_action_threshold_type_Set() const;
    bool is_action_threshold_type_Valid() const;
...
private:
    ...
    double m_action_threshold_value;
    bool m_action_threshold_value_isSet;
    bool m_action_threshold_value_isValid;

    OAIThresholdType m_action_threshold_type;
    bool m_action_threshold_type_isSet;
    bool m_action_threshold_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAction_ActionThreshold)

#endif // OAIAction_ActionThreshold_H
