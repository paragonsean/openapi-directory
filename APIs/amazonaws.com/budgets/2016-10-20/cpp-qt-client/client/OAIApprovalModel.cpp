...
OAIApprovalModel::OAIApprovalModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalModel::OAIApprovalModel() {
    this->initializeModel();
}

OAIApprovalModel::~OAIApprovalModel() {}

void OAIApprovalModel::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIApprovalModel::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIApprovalModel::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AUTOMATIC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIApprovalModel::AUTOMATIC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MANUAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIApprovalModel::MANUAL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIApprovalModel::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIApprovalModel::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIApprovalModel::AUTOMATIC:
            val = "AUTOMATIC";
            break;
        case eOAIApprovalModel::MANUAL:
            val = "MANUAL";
            break;
        default:
            break;
...
QJsonValue OAIApprovalModel::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIApprovalModel::eOAIApprovalModel OAIApprovalModel::getValue() const {
    return m_value;
}

void OAIApprovalModel::setValue(const OAIApprovalModel::eOAIApprovalModel& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIApprovalModel::isSet() const {
    
    return m_value_isSet;
}

bool OAIApprovalModel::isValid() const {
