...
/*
 * OAIDeleteBudgetRequest.h
 *
 *  Request of DeleteBudget 
 */

#ifndef OAIDeleteBudgetRequest_H
#define OAIDeleteBudgetRequest_H
...
class OAIDeleteBudgetRequest : public OAIObject {
public:
    OAIDeleteBudgetRequest();
    OAIDeleteBudgetRequest(QString json);
    ~OAIDeleteBudgetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBudgetRequest)

#endif // OAIDeleteBudgetRequest_H
