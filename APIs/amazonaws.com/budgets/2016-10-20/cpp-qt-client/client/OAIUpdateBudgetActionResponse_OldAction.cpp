...
OAIUpdateBudgetActionResponse_OldAction::OAIUpdateBudgetActionResponse_OldAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBudgetActionResponse_OldAction::OAIUpdateBudgetActionResponse_OldAction() {
    this->initializeModel();
}

OAIUpdateBudgetActionResponse_OldAction::~OAIUpdateBudgetActionResponse_OldAction() {}

void OAIUpdateBudgetActionResponse_OldAction::initializeModel() {
...
void OAIUpdateBudgetActionResponse_OldAction::fromJson(QString jsonString) {
...
void OAIUpdateBudgetActionResponse_OldAction::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateBudgetActionResponse_OldAction::asJson() const {
...
QJsonObject OAIUpdateBudgetActionResponse_OldAction::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateBudgetActionResponse_OldAction::getActionId() const {
    return m_action_id;
}
void OAIUpdateBudgetActionResponse_OldAction::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_action_id_Valid() const{
    return m_action_id_isValid;
}

QString OAIUpdateBudgetActionResponse_OldAction::getBudgetName() const {
    return m_budget_name;
}
void OAIUpdateBudgetActionResponse_OldAction::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAINotificationType OAIUpdateBudgetActionResponse_OldAction::getNotificationType() const {
    return m_notification_type;
}
void OAIUpdateBudgetActionResponse_OldAction::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIActionType OAIUpdateBudgetActionResponse_OldAction::getActionType() const {
    return m_action_type;
}
void OAIUpdateBudgetActionResponse_OldAction::setActionType(const OAIActionType &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_action_type_Valid() const{
    return m_action_type_isValid;
}

OAIAction_ActionThreshold OAIUpdateBudgetActionResponse_OldAction::getActionThreshold() const {
    return m_action_threshold;
}
void OAIUpdateBudgetActionResponse_OldAction::setActionThreshold(const OAIAction_ActionThreshold &action_threshold) {
    m_action_threshold = action_threshold;
    m_action_threshold_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_action_threshold_Set() const{
    return m_action_threshold_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_action_threshold_Valid() const{
    return m_action_threshold_isValid;
}

OAIAction_Definition OAIUpdateBudgetActionResponse_OldAction::getDefinition() const {
    return m_definition;
}
void OAIUpdateBudgetActionResponse_OldAction::setDefinition(const OAIAction_Definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_definition_Valid() const{
    return m_definition_isValid;
}

QString OAIUpdateBudgetActionResponse_OldAction::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAIUpdateBudgetActionResponse_OldAction::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

OAIApprovalModel OAIUpdateBudgetActionResponse_OldAction::getApprovalModel() const {
    return m_approval_model;
}
void OAIUpdateBudgetActionResponse_OldAction::setApprovalModel(const OAIApprovalModel &approval_model) {
    m_approval_model = approval_model;
    m_approval_model_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_approval_model_Set() const{
    return m_approval_model_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_approval_model_Valid() const{
    return m_approval_model_isValid;
}

OAIActionStatus OAIUpdateBudgetActionResponse_OldAction::getStatus() const {
    return m_status;
}
void OAIUpdateBudgetActionResponse_OldAction::setStatus(const OAIActionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_status_Valid() const{
    return m_status_isValid;
}

QList<OAISubscriber> OAIUpdateBudgetActionResponse_OldAction::getSubscribers() const {
    return m_subscribers;
}
void OAIUpdateBudgetActionResponse_OldAction::setSubscribers(const QList<OAISubscriber> &subscribers) {
    m_subscribers = subscribers;
    m_subscribers_isSet = true;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_subscribers_Set() const{
    return m_subscribers_isSet;
}

bool OAIUpdateBudgetActionResponse_OldAction::is_subscribers_Valid() const{
    return m_subscribers_isValid;
}

bool OAIUpdateBudgetActionResponse_OldAction::isSet() const {
...
bool OAIUpdateBudgetActionResponse_OldAction::isValid() const {
