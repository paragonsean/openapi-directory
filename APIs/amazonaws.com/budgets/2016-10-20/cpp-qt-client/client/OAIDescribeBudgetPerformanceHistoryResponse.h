...
/*
 * OAIDescribeBudgetPerformanceHistoryResponse.h
 *
 * 
 */

#ifndef OAIDescribeBudgetPerformanceHistoryResponse_H
#define OAIDescribeBudgetPerformanceHistoryResponse_H
...
namespace OpenAPI {
class OAIDescribeBudgetPerformanceHistoryResponse_BudgetPerformanceHistory;

class OAIDescribeBudgetPerformanceHistoryResponse : public OAIObject {
public:
    OAIDescribeBudgetPerformanceHistoryResponse();
    OAIDescribeBudgetPerformanceHistoryResponse(QString json);
    ~OAIDescribeBudgetPerformanceHistoryResponse() override;
    ...
    OAIDescribeBudgetPerformanceHistoryResponse_BudgetPerformanceHistory getBudgetPerformanceHistory() const;
    void setBudgetPerformanceHistory(const OAIDescribeBudgetPerformanceHistoryResponse_BudgetPerformanceHistory &budget_performance_history);
    bool is_budget_performance_history_Set() const;
    bool is_budget_performance_history_Valid() const;
...
private:
    ...
    OAIDescribeBudgetPerformanceHistoryResponse_BudgetPerformanceHistory m_budget_performance_history;
    bool m_budget_performance_history_isSet;
    bool m_budget_performance_history_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetPerformanceHistoryResponse)

#endif // OAIDescribeBudgetPerformanceHistoryResponse_H
