...
#include "OAIDeleteSubscriberRequest_Notification.h"
...
OAIDeleteSubscriberRequest_Notification::OAIDeleteSubscriberRequest_Notification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSubscriberRequest_Notification::OAIDeleteSubscriberRequest_Notification() {
    this->initializeModel();
}

OAIDeleteSubscriberRequest_Notification::~OAIDeleteSubscriberRequest_Notification() {}

void OAIDeleteSubscriberRequest_Notification::initializeModel() {
...
void OAIDeleteSubscriberRequest_Notification::fromJson(QString jsonString) {
...
void OAIDeleteSubscriberRequest_Notification::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSubscriberRequest_Notification::asJson() const {
...
QJsonObject OAIDeleteSubscriberRequest_Notification::asJsonObject() const {
    QJsonObject obj;
...
OAINotificationType OAIDeleteSubscriberRequest_Notification::getNotificationType() const {
    return m_notification_type;
}
void OAIDeleteSubscriberRequest_Notification::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIDeleteSubscriberRequest_Notification::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIDeleteSubscriberRequest_Notification::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIComparisonOperator OAIDeleteSubscriberRequest_Notification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAIDeleteSubscriberRequest_Notification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAIDeleteSubscriberRequest_Notification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAIDeleteSubscriberRequest_Notification::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

double OAIDeleteSubscriberRequest_Notification::getThreshold() const {
    return m_threshold;
}
void OAIDeleteSubscriberRequest_Notification::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAIDeleteSubscriberRequest_Notification::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAIDeleteSubscriberRequest_Notification::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIThresholdType OAIDeleteSubscriberRequest_Notification::getThresholdType() const {
    return m_threshold_type;
}
void OAIDeleteSubscriberRequest_Notification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAIDeleteSubscriberRequest_Notification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAIDeleteSubscriberRequest_Notification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAIDeleteSubscriberRequest_Notification::getNotificationState() const {
    return m_notification_state;
}
void OAIDeleteSubscriberRequest_Notification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAIDeleteSubscriberRequest_Notification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAIDeleteSubscriberRequest_Notification::is_notification_state_Valid() const{
    return m_notification_state_isValid;
}

bool OAIDeleteSubscriberRequest_Notification::isSet() const {
...
bool OAIDeleteSubscriberRequest_Notification::isValid() const {
