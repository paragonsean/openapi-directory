...
OAIDescribeBudgetActionRequest::OAIDescribeBudgetActionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetActionRequest::OAIDescribeBudgetActionRequest() {
    this->initializeModel();
}

OAIDescribeBudgetActionRequest::~OAIDescribeBudgetActionRequest() {}

void OAIDescribeBudgetActionRequest::initializeModel() {
...
void OAIDescribeBudgetActionRequest::fromJson(QString jsonString) {
...
void OAIDescribeBudgetActionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetActionRequest::asJson() const {
...
QJsonObject OAIDescribeBudgetActionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetActionRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeBudgetActionRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeBudgetActionRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeBudgetActionRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIDescribeBudgetActionRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIDescribeBudgetActionRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDescribeBudgetActionRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDescribeBudgetActionRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

QString OAIDescribeBudgetActionRequest::getActionId() const {
    return m_action_id;
}
void OAIDescribeBudgetActionRequest::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIDescribeBudgetActionRequest::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIDescribeBudgetActionRequest::is_action_id_Valid() const{
    return m_action_id_isValid;
}

bool OAIDescribeBudgetActionRequest::isSet() const {
...
bool OAIDescribeBudgetActionRequest::isValid() const {
