...
/*
 * OAIDeleteSubscriberRequest_Notification.h
 *
 * 
 */

#ifndef OAIDeleteSubscriberRequest_Notification_H
#define OAIDeleteSubscriberRequest_Notification_H
...
class OAIDeleteSubscriberRequest_Notification : public OAIObject {
public:
    OAIDeleteSubscriberRequest_Notification();
    OAIDeleteSubscriberRequest_Notification(QString json);
    ~OAIDeleteSubscriberRequest_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSubscriberRequest_Notification)

#endif // OAIDeleteSubscriberRequest_Notification_H
