...
#ifndef OAIAutoAdjustType_H
#define OAIAutoAdjustType_H
...
class OAIAutoAdjustType : public OAIEnum {
public:
    OAIAutoAdjustType();
    OAIAutoAdjustType(QString json);
    ~OAIAutoAdjustType() override;
    ...
    enum class eOAIAutoAdjustType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        HISTORICAL, 
        FORECAST
    };
    OAIAutoAdjustType::eOAIAutoAdjustType getValue() const;
    void setValue(const OAIAutoAdjustType::eOAIAutoAdjustType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoAdjustType)

#endif // OAIAutoAdjustType_H
