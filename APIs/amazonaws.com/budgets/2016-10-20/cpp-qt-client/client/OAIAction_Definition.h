...
/*
 * OAIAction_Definition.h
 *
 * 
 */

#ifndef OAIAction_Definition_H
#define OAIAction_Definition_H

#include <QJsonObject>

#include "OAIDefinition_IamActionDefinition.h"
#include "OAIDefinition_ScpActionDefinition.h"
#include "OAIDefinition_SsmActionDefinition.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDefinition_IamActionDefinition;
class OAIDefinition_ScpActionDefinition;
class OAIDefinition_SsmActionDefinition;

class OAIAction_Definition : public OAIObject {
public:
    OAIAction_Definition();
    OAIAction_Definition(QString json);
    ~OAIAction_Definition() override;
    ...
    OAIDefinition_IamActionDefinition getIamActionDefinition() const;
    void setIamActionDefinition(const OAIDefinition_IamActionDefinition &iam_action_definition);
    bool is_iam_action_definition_Set() const;
    bool is_iam_action_definition_Valid() const;

    OAIDefinition_ScpActionDefinition getScpActionDefinition() const;
    void setScpActionDefinition(const OAIDefinition_ScpActionDefinition &scp_action_definition);
    bool is_scp_action_definition_Set() const;
    bool is_scp_action_definition_Valid() const;

    OAIDefinition_SsmActionDefinition getSsmActionDefinition() const;
    void setSsmActionDefinition(const OAIDefinition_SsmActionDefinition &ssm_action_definition);
    bool is_ssm_action_definition_Set() const;
    bool is_ssm_action_definition_Valid() const;
...
private:
    ...
    OAIDefinition_IamActionDefinition m_iam_action_definition;
    bool m_iam_action_definition_isSet;
    bool m_iam_action_definition_isValid;

    OAIDefinition_ScpActionDefinition m_scp_action_definition;
    bool m_scp_action_definition_isSet;
    bool m_scp_action_definition_isValid;

    OAIDefinition_SsmActionDefinition m_ssm_action_definition;
    bool m_ssm_action_definition_isSet;
    bool m_ssm_action_definition_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAction_Definition)

#endif // OAIAction_Definition_H
