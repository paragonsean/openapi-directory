...
/*
 * OAIActionHistoryDetails.h
 *
 * The description of the details for the event. 
 */

#ifndef OAIActionHistoryDetails_H
#define OAIActionHistoryDetails_H
...
class OAIActionHistoryDetails : public OAIObject {
public:
    OAIActionHistoryDetails();
    OAIActionHistoryDetails(QString json);
    ~OAIActionHistoryDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionHistoryDetails)

#endif // OAIActionHistoryDetails_H
