...
#ifndef OAIAutoAdjustData_H
#define OAIAutoAdjustData_H
...
class OAIAutoAdjustData : public OAIObject {
public:
    OAIAutoAdjustData();
    OAIAutoAdjustData(QString json);
    ~OAIAutoAdjustData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoAdjustData)

#endif // OAIAutoAdjustData_H
