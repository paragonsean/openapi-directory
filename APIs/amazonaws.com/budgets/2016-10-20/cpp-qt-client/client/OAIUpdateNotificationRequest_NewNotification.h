...
/*
 * OAIUpdateNotificationRequest_NewNotification.h
 *
 * 
 */

#ifndef OAIUpdateNotificationRequest_NewNotification_H
#define OAIUpdateNotificationRequest_NewNotification_H
...
class OAIUpdateNotificationRequest_NewNotification : public OAIObject {
public:
    OAIUpdateNotificationRequest_NewNotification();
    OAIUpdateNotificationRequest_NewNotification(QString json);
    ~OAIUpdateNotificationRequest_NewNotification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNotificationRequest_NewNotification)

#endif // OAIUpdateNotificationRequest_NewNotification_H
