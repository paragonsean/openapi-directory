...
/*
 * OAIDescribeBudgetActionsForBudgetRequest.h
 *
 * 
 */

#ifndef OAIDescribeBudgetActionsForBudgetRequest_H
#define OAIDescribeBudgetActionsForBudgetRequest_H
...
class OAIDescribeBudgetActionsForBudgetRequest : public OAIObject {
public:
    OAIDescribeBudgetActionsForBudgetRequest();
    OAIDescribeBudgetActionsForBudgetRequest(QString json);
    ~OAIDescribeBudgetActionsForBudgetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetActionsForBudgetRequest)

#endif // OAIDescribeBudgetActionsForBudgetRequest_H
