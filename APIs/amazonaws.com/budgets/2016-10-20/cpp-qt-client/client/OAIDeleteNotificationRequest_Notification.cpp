...
#include "OAIDeleteNotificationRequest_Notification.h"
...
OAIDeleteNotificationRequest_Notification::OAIDeleteNotificationRequest_Notification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteNotificationRequest_Notification::OAIDeleteNotificationRequest_Notification() {
    this->initializeModel();
}

OAIDeleteNotificationRequest_Notification::~OAIDeleteNotificationRequest_Notification() {}

void OAIDeleteNotificationRequest_Notification::initializeModel() {
...
void OAIDeleteNotificationRequest_Notification::fromJson(QString jsonString) {
...
void OAIDeleteNotificationRequest_Notification::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteNotificationRequest_Notification::asJson() const {
...
QJsonObject OAIDeleteNotificationRequest_Notification::asJsonObject() const {
    QJsonObject obj;
...
OAINotificationType OAIDeleteNotificationRequest_Notification::getNotificationType() const {
    return m_notification_type;
}
void OAIDeleteNotificationRequest_Notification::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIDeleteNotificationRequest_Notification::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIDeleteNotificationRequest_Notification::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIComparisonOperator OAIDeleteNotificationRequest_Notification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAIDeleteNotificationRequest_Notification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAIDeleteNotificationRequest_Notification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAIDeleteNotificationRequest_Notification::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

double OAIDeleteNotificationRequest_Notification::getThreshold() const {
    return m_threshold;
}
void OAIDeleteNotificationRequest_Notification::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAIDeleteNotificationRequest_Notification::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAIDeleteNotificationRequest_Notification::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIThresholdType OAIDeleteNotificationRequest_Notification::getThresholdType() const {
    return m_threshold_type;
}
void OAIDeleteNotificationRequest_Notification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAIDeleteNotificationRequest_Notification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAIDeleteNotificationRequest_Notification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAIDeleteNotificationRequest_Notification::getNotificationState() const {
    return m_notification_state;
}
void OAIDeleteNotificationRequest_Notification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAIDeleteNotificationRequest_Notification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAIDeleteNotificationRequest_Notification::is_notification_state_Valid() const{
    return m_notification_state_isValid;
}

bool OAIDeleteNotificationRequest_Notification::isSet() const {
...
bool OAIDeleteNotificationRequest_Notification::isValid() const {
