...
OAIBudgetedAndActualAmounts_ActualAmount::OAIBudgetedAndActualAmounts_ActualAmount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBudgetedAndActualAmounts_ActualAmount::OAIBudgetedAndActualAmounts_ActualAmount() {
    this->initializeModel();
}

OAIBudgetedAndActualAmounts_ActualAmount::~OAIBudgetedAndActualAmounts_ActualAmount() {}

void OAIBudgetedAndActualAmounts_ActualAmount::initializeModel() {
...
void OAIBudgetedAndActualAmounts_ActualAmount::fromJson(QString jsonString) {
...
void OAIBudgetedAndActualAmounts_ActualAmount::fromJsonObject(QJsonObject json) {
...
QString OAIBudgetedAndActualAmounts_ActualAmount::asJson() const {
...
QJsonObject OAIBudgetedAndActualAmounts_ActualAmount::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
QString OAIBudgetedAndActualAmounts_ActualAmount::getAmount() const {
    return m_amount;
}
void OAIBudgetedAndActualAmounts_ActualAmount::setAmount(const QString &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIBudgetedAndActualAmounts_ActualAmount::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIBudgetedAndActualAmounts_ActualAmount::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIBudgetedAndActualAmounts_ActualAmount::getUnit() const {
    return m_unit;
}
void OAIBudgetedAndActualAmounts_ActualAmount::setUnit(const QString &unit) {
    m_unit = unit;
    m_unit_isSet = true;
}

bool OAIBudgetedAndActualAmounts_ActualAmount::is_unit_Set() const{
    return m_unit_isSet;
}

bool OAIBudgetedAndActualAmounts_ActualAmount::is_unit_Valid() const{
    return m_unit_isValid;
}

bool OAIBudgetedAndActualAmounts_ActualAmount::isSet() const {
...
bool OAIBudgetedAndActualAmounts_ActualAmount::isValid() const {
