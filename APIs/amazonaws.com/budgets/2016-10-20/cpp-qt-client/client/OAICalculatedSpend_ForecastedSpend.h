...
/*
 * OAICalculatedSpend_ForecastedSpend.h
 *
 * 
 */

#ifndef OAICalculatedSpend_ForecastedSpend_H
#define OAICalculatedSpend_ForecastedSpend_H
...
class OAICalculatedSpend_ForecastedSpend : public OAIObject {
public:
    OAICalculatedSpend_ForecastedSpend();
    OAICalculatedSpend_ForecastedSpend(QString json);
    ~OAICalculatedSpend_ForecastedSpend() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculatedSpend_ForecastedSpend)

#endif // OAICalculatedSpend_ForecastedSpend_H
