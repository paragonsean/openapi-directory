...
/*
 * OAIDefinition_IamActionDefinition.h
 *
 * 
 */

#ifndef OAIDefinition_IamActionDefinition_H
#define OAIDefinition_IamActionDefinition_H
...
class OAIDefinition_IamActionDefinition : public OAIObject {
public:
    OAIDefinition_IamActionDefinition();
    OAIDefinition_IamActionDefinition(QString json);
    ~OAIDefinition_IamActionDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefinition_IamActionDefinition)

#endif // OAIDefinition_IamActionDefinition_H
