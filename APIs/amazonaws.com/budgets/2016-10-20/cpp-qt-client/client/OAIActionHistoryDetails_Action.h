...
/*
 * OAIActionHistoryDetails_Action.h
 *
 * 
 */

#ifndef OAIActionHistoryDetails_Action_H
#define OAIActionHistoryDetails_Action_H
...
class OAIActionHistoryDetails_Action : public OAIObject {
public:
    OAIActionHistoryDetails_Action();
    OAIActionHistoryDetails_Action(QString json);
    ~OAIActionHistoryDetails_Action() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionHistoryDetails_Action)

#endif // OAIActionHistoryDetails_Action_H
