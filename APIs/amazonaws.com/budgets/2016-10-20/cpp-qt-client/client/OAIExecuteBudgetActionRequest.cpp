...
OAIExecuteBudgetActionRequest::OAIExecuteBudgetActionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExecuteBudgetActionRequest::OAIExecuteBudgetActionRequest() {
    this->initializeModel();
}

OAIExecuteBudgetActionRequest::~OAIExecuteBudgetActionRequest() {}

void OAIExecuteBudgetActionRequest::initializeModel() {
...
void OAIExecuteBudgetActionRequest::fromJson(QString jsonString) {
...
void OAIExecuteBudgetActionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIExecuteBudgetActionRequest::asJson() const {
...
QJsonObject OAIExecuteBudgetActionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExecuteBudgetActionRequest::getAccountId() const {
    return m_account_id;
}
void OAIExecuteBudgetActionRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIExecuteBudgetActionRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIExecuteBudgetActionRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIExecuteBudgetActionRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIExecuteBudgetActionRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIExecuteBudgetActionRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIExecuteBudgetActionRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

QString OAIExecuteBudgetActionRequest::getActionId() const {
    return m_action_id;
}
void OAIExecuteBudgetActionRequest::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIExecuteBudgetActionRequest::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIExecuteBudgetActionRequest::is_action_id_Valid() const{
    return m_action_id_isValid;
}

OAIExecutionType OAIExecuteBudgetActionRequest::getExecutionType() const {
    return m_execution_type;
}
void OAIExecuteBudgetActionRequest::setExecutionType(const OAIExecutionType &execution_type) {
    m_execution_type = execution_type;
    m_execution_type_isSet = true;
}

bool OAIExecuteBudgetActionRequest::is_execution_type_Set() const{
    return m_execution_type_isSet;
}

bool OAIExecuteBudgetActionRequest::is_execution_type_Valid() const{
    return m_execution_type_isValid;
}

bool OAIExecuteBudgetActionRequest::isSet() const {
...
bool OAIExecuteBudgetActionRequest::isValid() const {
