...
void OAIEventType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("SYSTEM", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::SYSTEM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CREATE_ACTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::CREATE_ACTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_ACTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::DELETE_ACTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UPDATE_ACTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::UPDATE_ACTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXECUTE_ACTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::EXECUTE_ACTION;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIEventType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIEventType::SYSTEM:
            val = "SYSTEM";
            break;
        case eOAIEventType::CREATE_ACTION:
            val = "CREATE_ACTION";
            break;
        case eOAIEventType::DELETE_ACTION:
            val = "DELETE_ACTION";
            break;
        case eOAIEventType::UPDATE_ACTION:
            val = "UPDATE_ACTION";
            break;
        case eOAIEventType::EXECUTE_ACTION:
            val = "EXECUTE_ACTION";
            break;
        default:
            break;
