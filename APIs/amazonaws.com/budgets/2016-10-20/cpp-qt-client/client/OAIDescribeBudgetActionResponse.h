...
/*
 * OAIDescribeBudgetActionResponse.h
 *
 * 
 */

#ifndef OAIDescribeBudgetActionResponse_H
#define OAIDescribeBudgetActionResponse_H
...
namespace OpenAPI {
class OAIDescribeBudgetActionResponse_Action;

class OAIDescribeBudgetActionResponse : public OAIObject {
public:
    OAIDescribeBudgetActionResponse();
    OAIDescribeBudgetActionResponse(QString json);
    ~OAIDescribeBudgetActionResponse() override;
    ...
    OAIDescribeBudgetActionResponse_Action getAction() const;
    void setAction(const OAIDescribeBudgetActionResponse_Action &action);
...
private:
    ...
    OAIDescribeBudgetActionResponse_Action m_action;
    bool m_action_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetActionResponse)

#endif // OAIDescribeBudgetActionResponse_H
