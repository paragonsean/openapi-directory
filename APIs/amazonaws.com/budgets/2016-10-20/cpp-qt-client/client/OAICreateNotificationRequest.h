...
/*
 * OAICreateNotificationRequest.h
 *
 *  Request of CreateNotification 
 */

#ifndef OAICreateNotificationRequest_H
#define OAICreateNotificationRequest_H
...
namespace OpenAPI {
class OAICreateNotificationRequest_Notification;

class OAICreateNotificationRequest : public OAIObject {
public:
    OAICreateNotificationRequest();
    OAICreateNotificationRequest(QString json);
    ~OAICreateNotificationRequest() override;
    ...
    OAICreateNotificationRequest_Notification getNotification() const;
    void setNotification(const OAICreateNotificationRequest_Notification &notification);
...
private:
    ...
    OAICreateNotificationRequest_Notification m_notification;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNotificationRequest)

#endif // OAICreateNotificationRequest_H
