...
OAIBudgetedAndActualAmounts_BudgetedAmount::OAIBudgetedAndActualAmounts_BudgetedAmount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBudgetedAndActualAmounts_BudgetedAmount::OAIBudgetedAndActualAmounts_BudgetedAmount() {
    this->initializeModel();
}

OAIBudgetedAndActualAmounts_BudgetedAmount::~OAIBudgetedAndActualAmounts_BudgetedAmount() {}

void OAIBudgetedAndActualAmounts_BudgetedAmount::initializeModel() {
...
void OAIBudgetedAndActualAmounts_BudgetedAmount::fromJson(QString jsonString) {
...
void OAIBudgetedAndActualAmounts_BudgetedAmount::fromJsonObject(QJsonObject json) {
...
QString OAIBudgetedAndActualAmounts_BudgetedAmount::asJson() const {
...
QJsonObject OAIBudgetedAndActualAmounts_BudgetedAmount::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
QString OAIBudgetedAndActualAmounts_BudgetedAmount::getAmount() const {
    return m_amount;
}
void OAIBudgetedAndActualAmounts_BudgetedAmount::setAmount(const QString &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIBudgetedAndActualAmounts_BudgetedAmount::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIBudgetedAndActualAmounts_BudgetedAmount::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIBudgetedAndActualAmounts_BudgetedAmount::getUnit() const {
    return m_unit;
}
void OAIBudgetedAndActualAmounts_BudgetedAmount::setUnit(const QString &unit) {
    m_unit = unit;
    m_unit_isSet = true;
}

bool OAIBudgetedAndActualAmounts_BudgetedAmount::is_unit_Set() const{
    return m_unit_isSet;
}

bool OAIBudgetedAndActualAmounts_BudgetedAmount::is_unit_Valid() const{
    return m_unit_isValid;
}

bool OAIBudgetedAndActualAmounts_BudgetedAmount::isSet() const {
...
bool OAIBudgetedAndActualAmounts_BudgetedAmount::isValid() const {
