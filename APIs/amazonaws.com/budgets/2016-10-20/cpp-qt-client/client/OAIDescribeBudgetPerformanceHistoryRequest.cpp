...
OAIDescribeBudgetPerformanceHistoryRequest::OAIDescribeBudgetPerformanceHistoryRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetPerformanceHistoryRequest::OAIDescribeBudgetPerformanceHistoryRequest() {
    this->initializeModel();
}

OAIDescribeBudgetPerformanceHistoryRequest::~OAIDescribeBudgetPerformanceHistoryRequest() {}

void OAIDescribeBudgetPerformanceHistoryRequest::initializeModel() {
...
void OAIDescribeBudgetPerformanceHistoryRequest::fromJson(QString jsonString) {
...
void OAIDescribeBudgetPerformanceHistoryRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetPerformanceHistoryRequest::asJson() const {
...
QJsonObject OAIDescribeBudgetPerformanceHistoryRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetPerformanceHistoryRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeBudgetPerformanceHistoryRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIDescribeBudgetPerformanceHistoryRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIDescribeBudgetPerformanceHistoryRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

OAIDescribeBudgetPerformanceHistoryRequest_TimePeriod OAIDescribeBudgetPerformanceHistoryRequest::getTimePeriod() const {
    return m_time_period;
}
void OAIDescribeBudgetPerformanceHistoryRequest::setTimePeriod(const OAIDescribeBudgetPerformanceHistoryRequest_TimePeriod &time_period) {
    m_time_period = time_period;
    m_time_period_isSet = true;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_time_period_Set() const{
    return m_time_period_isSet;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_time_period_Valid() const{
    return m_time_period_isValid;
}

qint32 OAIDescribeBudgetPerformanceHistoryRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeBudgetPerformanceHistoryRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeBudgetPerformanceHistoryRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeBudgetPerformanceHistoryRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeBudgetPerformanceHistoryRequest::isSet() const {
...
bool OAIDescribeBudgetPerformanceHistoryRequest::isValid() const {
