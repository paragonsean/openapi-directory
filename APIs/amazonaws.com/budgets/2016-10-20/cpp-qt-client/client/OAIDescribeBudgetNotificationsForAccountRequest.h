...
/*
 * OAIDescribeBudgetNotificationsForAccountRequest.h
 *
 * 
 */

#ifndef OAIDescribeBudgetNotificationsForAccountRequest_H
#define OAIDescribeBudgetNotificationsForAccountRequest_H
...
class OAIDescribeBudgetNotificationsForAccountRequest : public OAIObject {
public:
    OAIDescribeBudgetNotificationsForAccountRequest();
    OAIDescribeBudgetNotificationsForAccountRequest(QString json);
    ~OAIDescribeBudgetNotificationsForAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetNotificationsForAccountRequest)

#endif // OAIDescribeBudgetNotificationsForAccountRequest_H
