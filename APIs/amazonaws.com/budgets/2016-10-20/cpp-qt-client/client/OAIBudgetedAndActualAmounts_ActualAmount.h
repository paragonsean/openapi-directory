...
/*
 * OAIBudgetedAndActualAmounts_ActualAmount.h
 *
 * 
 */

#ifndef OAIBudgetedAndActualAmounts_ActualAmount_H
#define OAIBudgetedAndActualAmounts_ActualAmount_H
...
class OAIBudgetedAndActualAmounts_ActualAmount : public OAIObject {
public:
    OAIBudgetedAndActualAmounts_ActualAmount();
    OAIBudgetedAndActualAmounts_ActualAmount(QString json);
    ~OAIBudgetedAndActualAmounts_ActualAmount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudgetedAndActualAmounts_ActualAmount)

#endif // OAIBudgetedAndActualAmounts_ActualAmount_H
