...
/*
 * OAIDeleteBudgetActionRequest.h
 *
 * 
 */

#ifndef OAIDeleteBudgetActionRequest_H
#define OAIDeleteBudgetActionRequest_H
...
class OAIDeleteBudgetActionRequest : public OAIObject {
public:
    OAIDeleteBudgetActionRequest();
    OAIDeleteBudgetActionRequest(QString json);
    ~OAIDeleteBudgetActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBudgetActionRequest)

#endif // OAIDeleteBudgetActionRequest_H
