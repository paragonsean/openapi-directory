...
/*
 * OAIScpActionDefinition.h
 *
 * The service control policies (SCP) action definition details. 
 */

#ifndef OAIScpActionDefinition_H
#define OAIScpActionDefinition_H
...
class OAIScpActionDefinition : public OAIObject {
public:
    OAIScpActionDefinition();
    OAIScpActionDefinition(QString json);
    ~OAIScpActionDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScpActionDefinition)

#endif // OAIScpActionDefinition_H
