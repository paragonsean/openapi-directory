...
void OAIActionType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("APPLY_IAM_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::APPLY_IAM_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("APPLY_SCP_POLICY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::APPLY_SCP_POLICY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RUN_SSM_DOCUMENTS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::RUN_SSM_DOCUMENTS;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIActionType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIActionType::APPLY_IAM_POLICY:
            val = "APPLY_IAM_POLICY";
            break;
        case eOAIActionType::APPLY_SCP_POLICY:
            val = "APPLY_SCP_POLICY";
            break;
        case eOAIActionType::RUN_SSM_DOCUMENTS:
            val = "RUN_SSM_DOCUMENTS";
            break;
        default:
            break;
    }
