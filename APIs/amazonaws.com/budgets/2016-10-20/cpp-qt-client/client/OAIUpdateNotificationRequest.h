...
/*
 * OAIUpdateNotificationRequest.h
 *
 *  Request of UpdateNotification 
 */

#ifndef OAIUpdateNotificationRequest_H
#define OAIUpdateNotificationRequest_H
...
namespace OpenAPI {
class OAIUpdateNotificationRequest_OldNotification;
class OAIUpdateNotificationRequest_NewNotification;

class OAIUpdateNotificationRequest : public OAIObject {
public:
    OAIUpdateNotificationRequest();
    OAIUpdateNotificationRequest(QString json);
    ~OAIUpdateNotificationRequest() override;
    ...
    OAIUpdateNotificationRequest_OldNotification getOldNotification() const;
    void setOldNotification(const OAIUpdateNotificationRequest_OldNotification &old_notification);
    bool is_old_notification_Set() const;
    bool is_old_notification_Valid() const;

    OAIUpdateNotificationRequest_NewNotification getNewNotification() const;
    void setNewNotification(const OAIUpdateNotificationRequest_NewNotification &new_notification);
    bool is_new_notification_Set() const;
    bool is_new_notification_Valid() const;
...
private:
    ...
    OAIUpdateNotificationRequest_OldNotification m_old_notification;
    bool m_old_notification_isSet;
    bool m_old_notification_isValid;

    OAIUpdateNotificationRequest_NewNotification m_new_notification;
    bool m_new_notification_isSet;
    bool m_new_notification_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNotificationRequest)

#endif // OAIUpdateNotificationRequest_H
