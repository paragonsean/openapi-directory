...
/*
 * OAINotificationState.h
 *
 * 
 */

#ifndef OAINotificationState_H
#define OAINotificationState_H
...
class OAINotificationState : public OAIEnum {
public:
    OAINotificationState();
    OAINotificationState(QString json);
    ~OAINotificationState() override;
    ...
    enum class eOAINotificationState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        OK, 
        ALARM
    };
    OAINotificationState::eOAINotificationState getValue() const;
    void setValue(const OAINotificationState::eOAINotificationState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationState)

#endif // OAINotificationState_H
