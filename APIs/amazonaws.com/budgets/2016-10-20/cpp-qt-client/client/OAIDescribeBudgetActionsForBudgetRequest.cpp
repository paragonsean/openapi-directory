...
OAIDescribeBudgetActionsForBudgetRequest::OAIDescribeBudgetActionsForBudgetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetActionsForBudgetRequest::OAIDescribeBudgetActionsForBudgetRequest() {
    this->initializeModel();
}

OAIDescribeBudgetActionsForBudgetRequest::~OAIDescribeBudgetActionsForBudgetRequest() {}

void OAIDescribeBudgetActionsForBudgetRequest::initializeModel() {
...
void OAIDescribeBudgetActionsForBudgetRequest::fromJson(QString jsonString) {
...
void OAIDescribeBudgetActionsForBudgetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetActionsForBudgetRequest::asJson() const {
...
QJsonObject OAIDescribeBudgetActionsForBudgetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetActionsForBudgetRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeBudgetActionsForBudgetRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIDescribeBudgetActionsForBudgetRequest::getBudgetName() const {
    return m_budget_name;
}
void OAIDescribeBudgetActionsForBudgetRequest::setBudgetName(const QString &budget_name) {
    m_budget_name = budget_name;
    m_budget_name_isSet = true;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_budget_name_Set() const{
    return m_budget_name_isSet;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_budget_name_Valid() const{
    return m_budget_name_isValid;
}

qint32 OAIDescribeBudgetActionsForBudgetRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeBudgetActionsForBudgetRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeBudgetActionsForBudgetRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeBudgetActionsForBudgetRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeBudgetActionsForBudgetRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeBudgetActionsForBudgetRequest::isSet() const {
...
bool OAIDescribeBudgetActionsForBudgetRequest::isValid() const {
