...
OAIDescribeBudgetActionsForAccountRequest::OAIDescribeBudgetActionsForAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBudgetActionsForAccountRequest::OAIDescribeBudgetActionsForAccountRequest() {
    this->initializeModel();
}

OAIDescribeBudgetActionsForAccountRequest::~OAIDescribeBudgetActionsForAccountRequest() {}

void OAIDescribeBudgetActionsForAccountRequest::initializeModel() {
...
void OAIDescribeBudgetActionsForAccountRequest::fromJson(QString jsonString) {
...
void OAIDescribeBudgetActionsForAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBudgetActionsForAccountRequest::asJson() const {
...
QJsonObject OAIDescribeBudgetActionsForAccountRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeBudgetActionsForAccountRequest::getAccountId() const {
    return m_account_id;
}
void OAIDescribeBudgetActionsForAccountRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDescribeBudgetActionsForAccountRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDescribeBudgetActionsForAccountRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

qint32 OAIDescribeBudgetActionsForAccountRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeBudgetActionsForAccountRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeBudgetActionsForAccountRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeBudgetActionsForAccountRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeBudgetActionsForAccountRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeBudgetActionsForAccountRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeBudgetActionsForAccountRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeBudgetActionsForAccountRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeBudgetActionsForAccountRequest::isSet() const {
...
bool OAIDescribeBudgetActionsForAccountRequest::isValid() const {
