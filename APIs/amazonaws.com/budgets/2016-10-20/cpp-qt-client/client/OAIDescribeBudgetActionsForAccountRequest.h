...
/*
 * OAIDescribeBudgetActionsForAccountRequest.h
 *
 * 
 */

#ifndef OAIDescribeBudgetActionsForAccountRequest_H
#define OAIDescribeBudgetActionsForAccountRequest_H
...
class OAIDescribeBudgetActionsForAccountRequest : public OAIObject {
public:
    OAIDescribeBudgetActionsForAccountRequest();
    OAIDescribeBudgetActionsForAccountRequest(QString json);
    ~OAIDescribeBudgetActionsForAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetActionsForAccountRequest)

#endif // OAIDescribeBudgetActionsForAccountRequest_H
