...
/*
 * OAISsmActionDefinition.h
 *
 * The Amazon Web Services Systems Manager (SSM) action definition details. 
 */

#ifndef OAISsmActionDefinition_H
#define OAISsmActionDefinition_H
...
class OAISsmActionDefinition : public OAIObject {
public:
    OAISsmActionDefinition();
    OAISsmActionDefinition(QString json);
    ~OAISsmActionDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISsmActionDefinition)

#endif // OAISsmActionDefinition_H
