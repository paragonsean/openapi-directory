...
/*
 * OAIHistoricalOptions.h
 *
 * The parameters that define or describe the historical data that your auto-adjusting budget is based on.
 */

#ifndef OAIHistoricalOptions_H
#define OAIHistoricalOptions_H
...
class OAIHistoricalOptions : public OAIObject {
public:
    OAIHistoricalOptions();
    OAIHistoricalOptions(QString json);
    ~OAIHistoricalOptions() override;
    ...
    qint32 getBudgetAdjustmentPeriod() const;
    void setBudgetAdjustmentPeriod(const qint32 &budget_adjustment_period);
    bool is_budget_adjustment_period_Set() const;
    bool is_budget_adjustment_period_Valid() const;

    qint32 getLookBackAvailablePeriods() const;
    void setLookBackAvailablePeriods(const qint32 &look_back_available_periods);
    bool is_look_back_available_periods_Set() const;
    bool is_look_back_available_periods_Valid() const;
...
private:
    ...
    qint32 m_budget_adjustment_period;
    bool m_budget_adjustment_period_isSet;
    bool m_budget_adjustment_period_isValid;

    qint32 m_look_back_available_periods;
    bool m_look_back_available_periods_isSet;
    bool m_look_back_available_periods_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIHistoricalOptions)

#endif // OAIHistoricalOptions_H
