...
/*
 * OAIActionThreshold.h
 *
 * The trigger threshold of the action. 
 */

#ifndef OAIActionThreshold_H
#define OAIActionThreshold_H
...
class OAIActionThreshold : public OAIObject {
public:
    OAIActionThreshold();
    OAIActionThreshold(QString json);
    ~OAIActionThreshold() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionThreshold)

#endif // OAIActionThreshold_H
