...
/*
 * OAIUpdateSubscriberRequest_NewSubscriber.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberRequest_NewSubscriber_H
#define OAIUpdateSubscriberRequest_NewSubscriber_H
...
class OAIUpdateSubscriberRequest_NewSubscriber : public OAIObject {
public:
    OAIUpdateSubscriberRequest_NewSubscriber();
    OAIUpdateSubscriberRequest_NewSubscriber(QString json);
    ~OAIUpdateSubscriberRequest_NewSubscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberRequest_NewSubscriber)

#endif // OAIUpdateSubscriberRequest_NewSubscriber_H
