...
/*
 * OAIDeleteSubscriberRequest.h
 *
 *  Request of DeleteSubscriber 
 */

#ifndef OAIDeleteSubscriberRequest_H
#define OAIDeleteSubscriberRequest_H
...
namespace OpenAPI {
class OAIDeleteSubscriberRequest_Notification;
class OAIDeleteSubscriberRequest_Subscriber;

class OAIDeleteSubscriberRequest : public OAIObject {
public:
    OAIDeleteSubscriberRequest();
    OAIDeleteSubscriberRequest(QString json);
    ~OAIDeleteSubscriberRequest() override;
    ...
    OAIDeleteSubscriberRequest_Notification getNotification() const;
    void setNotification(const OAIDeleteSubscriberRequest_Notification &notification);
    bool is_notification_Set() const;
    bool is_notification_Valid() const;

    OAIDeleteSubscriberRequest_Subscriber getSubscriber() const;
    void setSubscriber(const OAIDeleteSubscriberRequest_Subscriber &subscriber);
...
private:
    ...
    OAIDeleteSubscriberRequest_Notification m_notification;
    bool m_notification_isSet;
    bool m_notification_isValid;

    OAIDeleteSubscriberRequest_Subscriber m_subscriber;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSubscriberRequest)

#endif // OAIDeleteSubscriberRequest_H
