...
/*
 * OAIDescribeBudgetRequest.h
 *
 *  Request of DescribeBudget 
 */

#ifndef OAIDescribeBudgetRequest_H
#define OAIDescribeBudgetRequest_H
...
class OAIDescribeBudgetRequest : public OAIObject {
public:
    OAIDescribeBudgetRequest();
    OAIDescribeBudgetRequest(QString json);
    ~OAIDescribeBudgetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetRequest)

#endif // OAIDescribeBudgetRequest_H
