...
/*
 * OAICreateBudgetRequest.h
 *
 *  Request of CreateBudget 
 */

#ifndef OAICreateBudgetRequest_H
#define OAICreateBudgetRequest_H

#include <QJsonObject>

#include "OAICreateBudgetRequest_Budget.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateBudgetRequest_Budget;

class OAICreateBudgetRequest : public OAIObject {
public:
    OAICreateBudgetRequest();
    OAICreateBudgetRequest(QString json);
    ~OAICreateBudgetRequest() override;
    ...
    OAICreateBudgetRequest_Budget getBudget() const;
    void setBudget(const OAICreateBudgetRequest_Budget &budget);
    bool is_budget_Set() const;
    bool is_budget_Valid() const;

    QList getNotificationsWithSubscribers() const;
    void setNotificationsWithSubscribers(const QList &notifications_with_subscribers);
    bool is_notifications_with_subscribers_Set() const;
    bool is_notifications_with_subscribers_Valid() const;
...
private:
    ...
    OAICreateBudgetRequest_Budget m_budget;
    bool m_budget_isSet;
    bool m_budget_isValid;

    QList m_notifications_with_subscribers;
    bool m_notifications_with_subscribers_isSet;
    bool m_notifications_with_subscribers_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateBudgetRequest)

#endif // OAICreateBudgetRequest_H
