...
OAIBudgetPerformanceHistory_CostTypes::OAIBudgetPerformanceHistory_CostTypes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBudgetPerformanceHistory_CostTypes::OAIBudgetPerformanceHistory_CostTypes() {
    this->initializeModel();
}

OAIBudgetPerformanceHistory_CostTypes::~OAIBudgetPerformanceHistory_CostTypes() {}

void OAIBudgetPerformanceHistory_CostTypes::initializeModel() {
...
void OAIBudgetPerformanceHistory_CostTypes::fromJson(QString jsonString) {
...
void OAIBudgetPerformanceHistory_CostTypes::fromJsonObject(QJsonObject json) {
...
QString OAIBudgetPerformanceHistory_CostTypes::asJson() const {
...
QJsonObject OAIBudgetPerformanceHistory_CostTypes::asJsonObject() const {
    QJsonObject obj;
...
bool OAIBudgetPerformanceHistory_CostTypes::getIncludeTax() const {
    return m_include_tax;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeTax(const bool &include_tax) {
    m_include_tax = include_tax;
    m_include_tax_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_tax_Set() const{
    return m_include_tax_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_tax_Valid() const{
    return m_include_tax_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeSubscription() const {
    return m_include_subscription;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeSubscription(const bool &include_subscription) {
    m_include_subscription = include_subscription;
    m_include_subscription_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_subscription_Set() const{
    return m_include_subscription_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_subscription_Valid() const{
    return m_include_subscription_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getUseBlended() const {
    return m_use_blended;
}
void OAIBudgetPerformanceHistory_CostTypes::setUseBlended(const bool &use_blended) {
    m_use_blended = use_blended;
    m_use_blended_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_use_blended_Set() const{
    return m_use_blended_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_use_blended_Valid() const{
    return m_use_blended_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeRefund() const {
    return m_include_refund;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeRefund(const bool &include_refund) {
    m_include_refund = include_refund;
    m_include_refund_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_refund_Set() const{
    return m_include_refund_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_refund_Valid() const{
    return m_include_refund_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeCredit() const {
    return m_include_credit;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeCredit(const bool &include_credit) {
    m_include_credit = include_credit;
    m_include_credit_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_credit_Set() const{
    return m_include_credit_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_credit_Valid() const{
    return m_include_credit_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeUpfront() const {
    return m_include_upfront;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeUpfront(const bool &include_upfront) {
    m_include_upfront = include_upfront;
    m_include_upfront_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_upfront_Set() const{
    return m_include_upfront_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_upfront_Valid() const{
    return m_include_upfront_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeRecurring() const {
    return m_include_recurring;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeRecurring(const bool &include_recurring) {
    m_include_recurring = include_recurring;
    m_include_recurring_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_recurring_Set() const{
    return m_include_recurring_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_recurring_Valid() const{
    return m_include_recurring_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeOtherSubscription() const {
    return m_include_other_subscription;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeOtherSubscription(const bool &include_other_subscription) {
    m_include_other_subscription = include_other_subscription;
    m_include_other_subscription_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_other_subscription_Set() const{
    return m_include_other_subscription_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_other_subscription_Valid() const{
    return m_include_other_subscription_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeSupport() const {
    return m_include_support;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeSupport(const bool &include_support) {
    m_include_support = include_support;
    m_include_support_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_support_Set() const{
    return m_include_support_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_support_Valid() const{
    return m_include_support_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getIncludeDiscount() const {
    return m_include_discount;
}
void OAIBudgetPerformanceHistory_CostTypes::setIncludeDiscount(const bool &include_discount) {
    m_include_discount = include_discount;
    m_include_discount_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_discount_Set() const{
    return m_include_discount_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_include_discount_Valid() const{
    return m_include_discount_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::getUseAmortized() const {
    return m_use_amortized;
}
void OAIBudgetPerformanceHistory_CostTypes::setUseAmortized(const bool &use_amortized) {
    m_use_amortized = use_amortized;
    m_use_amortized_isSet = true;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_use_amortized_Set() const{
    return m_use_amortized_isSet;
}

bool OAIBudgetPerformanceHistory_CostTypes::is_use_amortized_Valid() const{
    return m_use_amortized_isValid;
}

bool OAIBudgetPerformanceHistory_CostTypes::isSet() const {
...
bool OAIBudgetPerformanceHistory_CostTypes::isValid() const {
