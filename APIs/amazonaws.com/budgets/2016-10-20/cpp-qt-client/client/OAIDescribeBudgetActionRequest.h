...
/*
 * OAIDescribeBudgetActionRequest.h
 *
 * 
 */

#ifndef OAIDescribeBudgetActionRequest_H
#define OAIDescribeBudgetActionRequest_H
...
class OAIDescribeBudgetActionRequest : public OAIObject {
public:
    OAIDescribeBudgetActionRequest();
    OAIDescribeBudgetActionRequest(QString json);
    ~OAIDescribeBudgetActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBudgetActionRequest)

#endif // OAIDescribeBudgetActionRequest_H
