...
/*
 * OAIBudgetNotificationsForAccount.h
 *
 *  The budget name and associated notifications for an account. 
 */

#ifndef OAIBudgetNotificationsForAccount_H
#define OAIBudgetNotificationsForAccount_H
...
class OAIBudgetNotificationsForAccount : public OAIObject {
public:
    OAIBudgetNotificationsForAccount();
    OAIBudgetNotificationsForAccount(QString json);
    ~OAIBudgetNotificationsForAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBudgetNotificationsForAccount)

#endif // OAIBudgetNotificationsForAccount_H
