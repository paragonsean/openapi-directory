...
OAICreateSubscriberRequest_Notification::OAICreateSubscriberRequest_Notification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSubscriberRequest_Notification::OAICreateSubscriberRequest_Notification() {
    this->initializeModel();
}

OAICreateSubscriberRequest_Notification::~OAICreateSubscriberRequest_Notification() {}

void OAICreateSubscriberRequest_Notification::initializeModel() {
...
void OAICreateSubscriberRequest_Notification::fromJson(QString jsonString) {
...
void OAICreateSubscriberRequest_Notification::fromJsonObject(QJsonObject json) {
...
QString OAICreateSubscriberRequest_Notification::asJson() const {
...
QJsonObject OAICreateSubscriberRequest_Notification::asJsonObject() const {
    QJsonObject obj;
...
OAINotificationType OAICreateSubscriberRequest_Notification::getNotificationType() const {
    return m_notification_type;
}
void OAICreateSubscriberRequest_Notification::setNotificationType(const OAINotificationType &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAICreateSubscriberRequest_Notification::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAICreateSubscriberRequest_Notification::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

OAIComparisonOperator OAICreateSubscriberRequest_Notification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAICreateSubscriberRequest_Notification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAICreateSubscriberRequest_Notification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAICreateSubscriberRequest_Notification::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

double OAICreateSubscriberRequest_Notification::getThreshold() const {
    return m_threshold;
}
void OAICreateSubscriberRequest_Notification::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAICreateSubscriberRequest_Notification::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAICreateSubscriberRequest_Notification::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIThresholdType OAICreateSubscriberRequest_Notification::getThresholdType() const {
    return m_threshold_type;
}
void OAICreateSubscriberRequest_Notification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAICreateSubscriberRequest_Notification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAICreateSubscriberRequest_Notification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAICreateSubscriberRequest_Notification::getNotificationState() const {
    return m_notification_state;
}
void OAICreateSubscriberRequest_Notification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAICreateSubscriberRequest_Notification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAICreateSubscriberRequest_Notification::is_notification_state_Valid() const{
    return m_notification_state_isValid;
}

bool OAICreateSubscriberRequest_Notification::isSet() const {
...
bool OAICreateSubscriberRequest_Notification::isValid() const {
