...
/*
 * OAIUpdateSubscriberRequest_Notification.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberRequest_Notification_H
#define OAIUpdateSubscriberRequest_Notification_H
...
class OAIUpdateSubscriberRequest_Notification : public OAIObject {
public:
    OAIUpdateSubscriberRequest_Notification();
    OAIUpdateSubscriberRequest_Notification(QString json);
    ~OAIUpdateSubscriberRequest_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberRequest_Notification)

#endif // OAIUpdateSubscriberRequest_Notification_H
