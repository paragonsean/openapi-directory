...
OAIComparisonOperator OAINotification::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAINotification::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAINotification::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAINotification::is_comparison_operator_Valid() const{
...
OAIThresholdType OAINotification::getThresholdType() const {
    return m_threshold_type;
}
void OAINotification::setThresholdType(const OAIThresholdType &threshold_type) {
    m_threshold_type = threshold_type;
    m_threshold_type_isSet = true;
}

bool OAINotification::is_threshold_type_Set() const{
    return m_threshold_type_isSet;
}

bool OAINotification::is_threshold_type_Valid() const{
    return m_threshold_type_isValid;
}

OAINotificationState OAINotification::getNotificationState() const {
    return m_notification_state;
}
void OAINotification::setNotificationState(const OAINotificationState &notification_state) {
    m_notification_state = notification_state;
    m_notification_state_isSet = true;
}

bool OAINotification::is_notification_state_Set() const{
    return m_notification_state_isSet;
}

bool OAINotification::is_notification_state_Valid() const{
