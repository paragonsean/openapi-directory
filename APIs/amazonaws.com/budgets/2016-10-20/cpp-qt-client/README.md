...
QString Example::create(){
    QString obj;
OAICreateBudgetRequest Example::create(){
    OAICreateBudgetRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createBudgetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createBudgetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICreateBudgetRequest oai_create_budget_request = create(); // OAICreateBudgetRequest | 
      ...
      apiInstance.createBudget(x_amz_targetoai_create_budget_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
