...
class DescribeBudgetActionsForBudgetRequest(Model):
    ...
    def __init__(self, account_id: str=None, budget_name: str=None, max_results: int=None, next_token: str=None):
        """DescribeBudgetActionsForBudgetRequest - a model defined in OpenAPI

        :param account_id: The account_id of this DescribeBudgetActionsForBudgetRequest.
        :param budget_name: The budget_name of this DescribeBudgetActionsForBudgetRequest.
        :param max_results: The max_results of this DescribeBudgetActionsForBudgetRequest.
        :param next_token: The next_token of this DescribeBudgetActionsForBudgetRequest.
        """
        self.openapi_types = {
            'account_id': str,
            'budget_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeBudgetActionsForBudgetRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeBudgetActionsForBudgetRequest of this DescribeBudgetActionsForBudgetRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this DescribeBudgetActionsForBudgetRequest.

        The account ID of the user. It's a 12-digit number.

        :return: The account_id of this DescribeBudgetActionsForBudgetRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this DescribeBudgetActionsForBudgetRequest.
    ...
    def budget_name(self):
        """Gets the budget_name of this DescribeBudgetActionsForBudgetRequest.

         A string that represents the budget name. The \":\" and \"\\\" characters, and the \"/action/\" substring, aren't allowed.

        :return: The budget_name of this DescribeBudgetActionsForBudgetRequest.
        :rtype: str
        """
    ...
    def budget_name(self, budget_name):
        """Sets the budget_name of this DescribeBudgetActionsForBudgetRequest.
    ...
    def max_results(self):
        """Gets the max_results of this DescribeBudgetActionsForBudgetRequest.

         An integer that represents how many entries a paginated response contains. The maximum is 100.

        :return: The max_results of this DescribeBudgetActionsForBudgetRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this DescribeBudgetActionsForBudgetRequest.
    ...
    @property
    def next_token(self):
        """Gets the next_token of this DescribeBudgetActionsForBudgetRequest.

         A generic string.

        :return: The next_token of this DescribeBudgetActionsForBudgetRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this DescribeBudgetActionsForBudgetRequest.
