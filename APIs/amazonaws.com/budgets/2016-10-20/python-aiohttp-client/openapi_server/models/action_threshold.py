...
class ActionThreshold(Model):
    ...
    def __init__(self, action_threshold_value: float=None, action_threshold_type: ThresholdType=None):
        """ActionThreshold - a model defined in OpenAPI

        :param action_threshold_value: The action_threshold_value of this ActionThreshold.
        :param action_threshold_type: The action_threshold_type of this ActionThreshold.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ActionThreshold':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ActionThreshold of this ActionThreshold.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def action_threshold_value(self):
        """Gets the action_threshold_value of this ActionThreshold.

         The threshold of a notification.

        :return: The action_threshold_value of this ActionThreshold.
        :rtype: float
        """
    ...
    def action_threshold_value(self, action_threshold_value):
        """Sets the action_threshold_value of this ActionThreshold.
    ...
    def action_threshold_type(self):
        """Gets the action_threshold_type of this ActionThreshold.


        :return: The action_threshold_type of this ActionThreshold.
        :rtype: ThresholdType
        """
    ...
    def action_threshold_type(self, action_threshold_type):
        """Sets the action_threshold_type of this ActionThreshold.
