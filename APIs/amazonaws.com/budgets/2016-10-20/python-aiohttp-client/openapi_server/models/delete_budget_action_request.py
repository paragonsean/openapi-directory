...
class DeleteBudgetActionRequest(Model):
    ...
    def __init__(self, account_id: str=None, budget_name: str=None, action_id: str=None):
        """DeleteBudgetActionRequest - a model defined in OpenAPI

        :param account_id: The account_id of this DeleteBudgetActionRequest.
        :param budget_name: The budget_name of this DeleteBudgetActionRequest.
        :param action_id: The action_id of this DeleteBudgetActionRequest.
        """
        self.openapi_types = {
            'account_id': str,
            'budget_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteBudgetActionRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteBudgetActionRequest of this DeleteBudgetActionRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this DeleteBudgetActionRequest.

        The account ID of the user. It's a 12-digit number.

        :return: The account_id of this DeleteBudgetActionRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this DeleteBudgetActionRequest.
    ...
    def budget_name(self):
        """Gets the budget_name of this DeleteBudgetActionRequest.

         A string that represents the budget name. The \":\" and \"\\\" characters, and the \"/action/\" substring, aren't allowed.

        :return: The budget_name of this DeleteBudgetActionRequest.
        :rtype: str
        """
    ...
    def budget_name(self, budget_name):
        """Sets the budget_name of this DeleteBudgetActionRequest.
    ...
    @property
    def action_id(self):
        """Gets the action_id of this DeleteBudgetActionRequest.


        :return: The action_id of this DeleteBudgetActionRequest.
        :rtype: str
        """
    ...
    def action_id(self, action_id):
        """Sets the action_id of this DeleteBudgetActionRequest.
