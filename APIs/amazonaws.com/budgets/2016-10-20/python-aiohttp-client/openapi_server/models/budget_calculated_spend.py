...
class BudgetCalculatedSpend(Model):
    ...
    def __init__(self, actual_spend: CalculatedSpendActualSpend=None, forecasted_spend: CalculatedSpendForecastedSpend=None):
        """BudgetCalculatedSpend - a model defined in OpenAPI

        :param actual_spend: The actual_spend of this BudgetCalculatedSpend.
        :param forecasted_spend: The forecasted_spend of this BudgetCalculatedSpend.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BudgetCalculatedSpend':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Budget_CalculatedSpend of this BudgetCalculatedSpend.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def actual_spend(self):
        """Gets the actual_spend of this BudgetCalculatedSpend.


        :return: The actual_spend of this BudgetCalculatedSpend.
    ...
    def actual_spend(self, actual_spend):
        """Sets the actual_spend of this BudgetCalculatedSpend.
    ...
    def forecasted_spend(self):
        """Gets the forecasted_spend of this BudgetCalculatedSpend.


        :return: The forecasted_spend of this BudgetCalculatedSpend.
    ...
    def forecasted_spend(self, forecasted_spend):
        """Sets the forecasted_spend of this BudgetCalculatedSpend.
