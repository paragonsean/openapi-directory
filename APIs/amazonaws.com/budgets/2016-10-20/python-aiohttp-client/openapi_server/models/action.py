...
class Action(Model):
    ...
    def __init__(self, action_id: str=None, budget_name: str=None, notification_type: NotificationType=None, action_type: ActionType=None, action_threshold: ActionActionThreshold=None, definition: ActionDefinition=None, execution_role_arn: str=None, approval_model: ApprovalModel=None, status: ActionStatus=None, subscribers: List[Subscriber]=None):
        ...
        :param budget_name: The budget_name of this Action.
        :param notification_type: The notification_type of this Action.
        :param action_type: The action_type of this Action.
        :param action_threshold: The action_threshold of this Action.
        :param definition: The definition of this Action.
        :param execution_role_arn: The execution_role_arn of this Action.
        :param approval_model: The approval_model of this Action.
        :param status: The status of this Action.
        :param subscribers: The subscribers of this Action.
        """
        self.openapi_types = {
            'action_id': str,
            'budget_name': str,
    ...
    def budget_name(self):
        """Gets the budget_name of this Action.

         A string that represents the budget name. The \":\" and \"\\\" characters, and the \"/action/\" substring, aren't allowed.

        :return: The budget_name of this Action.
        :rtype: str
        """
    ...
    def budget_name(self, budget_name):
        """Sets the budget_name of this Action.
    ...
    def notification_type(self):
        """Gets the notification_type of this Action.


        :return: The notification_type of this Action.
    ...
    def notification_type(self, notification_type):
        """Sets the notification_type of this Action.
    ...
    def action_threshold(self):
        """Gets the action_threshold of this Action.


        :return: The action_threshold of this Action.
    ...
    def action_threshold(self, action_threshold):
        """Sets the action_threshold of this Action.
    ...
    @property
    def definition(self):
        """Gets the definition of this Action.
    ...
    def definition(self, definition):
        """Sets the definition of this Action.
    ...
    def execution_role_arn(self):
        """Gets the execution_role_arn of this Action.


        :return: The execution_role_arn of this Action.
        :rtype: str
        """
    ...
    def execution_role_arn(self, execution_role_arn):
        """Sets the execution_role_arn of this Action.
    ...
    def approval_model(self):
        """Gets the approval_model of this Action.


        :return: The approval_model of this Action.
        :rtype: ApprovalModel
        """
    ...
    def approval_model(self, approval_model):
        """Sets the approval_model of this Action.
    ...
    def subscribers(self):
        """Gets the subscribers of this Action.

         A list of subscribers.

        :return: The subscribers of this Action.
    ...
    def subscribers(self, subscribers):
        """Sets the subscribers of this Action.
