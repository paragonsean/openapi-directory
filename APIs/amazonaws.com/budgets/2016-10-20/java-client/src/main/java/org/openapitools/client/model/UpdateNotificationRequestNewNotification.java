...
public class UpdateNotificationRequestNewNotification {
  ...
  public UpdateNotificationRequestNewNotification() {
  }

  public UpdateNotificationRequestNewNotification notificationType(NotificationType notificationType) {
  ...
  public UpdateNotificationRequestNewNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public UpdateNotificationRequestNewNotification threshold(Double threshold) {
  ...
  public UpdateNotificationRequestNewNotification thresholdType(ThresholdType thresholdType) {
  ...
  public UpdateNotificationRequestNewNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNotificationRequestNewNotification updateNotificationRequestNewNotification = (UpdateNotificationRequestNewNotification) o;
    return Objects.equals(this.notificationType, updateNotificationRequestNewNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, updateNotificationRequestNewNotification.comparisonOperator) &&
        Objects.equals(this.threshold, updateNotificationRequestNewNotification.threshold) &&
        Objects.equals(this.thresholdType, updateNotificationRequestNewNotification.thresholdType) &&
        Objects.equals(this.notificationState, updateNotificationRequestNewNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNotificationRequestNewNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNotificationRequestNewNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNotificationRequestNewNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNotificationRequestNewNotification is not found in the empty JSON string", UpdateNotificationRequestNewNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNotificationRequestNewNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNotificationRequestNewNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateNotificationRequestNewNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNotificationRequestNewNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNotificationRequestNewNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNotificationRequestNewNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNotificationRequestNewNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNotificationRequestNewNotification>() {
           @Override
           public void write(JsonWriter out, UpdateNotificationRequestNewNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNotificationRequestNewNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNotificationRequestNewNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNotificationRequestNewNotification
   * @throws IOException if the JSON string is invalid with respect to UpdateNotificationRequestNewNotification
   */
  public static UpdateNotificationRequestNewNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNotificationRequestNewNotification.class);
  }

  /**
   * Convert an instance of UpdateNotificationRequestNewNotification to an JSON string
   *
   * @return JSON string
   */
