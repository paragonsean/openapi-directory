...
public class BudgetCostTypes {
  ...
  public BudgetCostTypes includeTax(Boolean includeTax) {
  ...
  public BudgetCostTypes includeSubscription(Boolean includeSubscription) {
  ...
  public BudgetCostTypes useBlended(Boolean useBlended) {
  ...
  public BudgetCostTypes includeRefund(Boolean includeRefund) {
  ...
  public BudgetCostTypes includeCredit(Boolean includeCredit) {
  ...
  public BudgetCostTypes includeUpfront(Boolean includeUpfront) {
  ...
  public BudgetCostTypes includeRecurring(Boolean includeRecurring) {
  ...
  public BudgetCostTypes includeOtherSubscription(Boolean includeOtherSubscription) {
  ...
  public BudgetCostTypes includeSupport(Boolean includeSupport) {
  ...
  public BudgetCostTypes includeDiscount(Boolean includeDiscount) {
  ...
  public BudgetCostTypes useAmortized(Boolean useAmortized) {
  ...
  public boolean equals(Object o) {
    ...
    BudgetCostTypes budgetCostTypes = (BudgetCostTypes) o;
    return Objects.equals(this.includeTax, budgetCostTypes.includeTax) &&
        Objects.equals(this.includeSubscription, budgetCostTypes.includeSubscription) &&
        Objects.equals(this.useBlended, budgetCostTypes.useBlended) &&
        Objects.equals(this.includeRefund, budgetCostTypes.includeRefund) &&
        Objects.equals(this.includeCredit, budgetCostTypes.includeCredit) &&
        Objects.equals(this.includeUpfront, budgetCostTypes.includeUpfront) &&
        Objects.equals(this.includeRecurring, budgetCostTypes.includeRecurring) &&
        Objects.equals(this.includeOtherSubscription, budgetCostTypes.includeOtherSubscription) &&
        Objects.equals(this.includeSupport, budgetCostTypes.includeSupport) &&
        Objects.equals(this.includeDiscount, budgetCostTypes.includeDiscount) &&
        Objects.equals(this.useAmortized, budgetCostTypes.useAmortized);
  }
  ...
  public String toString() {
    ...
    sb.append("class BudgetCostTypes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BudgetCostTypes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BudgetCostTypes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BudgetCostTypes is not found in the empty JSON string", BudgetCostTypes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BudgetCostTypes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BudgetCostTypes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BudgetCostTypes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BudgetCostTypes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BudgetCostTypes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BudgetCostTypes.class));

       return (TypeAdapter<T>) new TypeAdapter<BudgetCostTypes>() {
           @Override
           public void write(JsonWriter out, BudgetCostTypes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BudgetCostTypes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BudgetCostTypes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BudgetCostTypes
   * @throws IOException if the JSON string is invalid with respect to BudgetCostTypes
   */
  public static BudgetCostTypes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BudgetCostTypes.class);
  }

  /**
   * Convert an instance of BudgetCostTypes to an JSON string
   *
   * @return JSON string
   */
