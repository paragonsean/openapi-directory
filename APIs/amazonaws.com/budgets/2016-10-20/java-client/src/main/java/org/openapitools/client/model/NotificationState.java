...
/**
 * Gets or Sets NotificationState
 */
@JsonAdapter(NotificationState.Adapter.class)
public enum NotificationState {
  ...
  public static class Adapter extends TypeAdapter<NotificationState> {
    @Override
    public void write(final JsonWriter jsonWriter, final NotificationState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NotificationState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NotificationState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NotificationState.fromValue(value);
  }
}
