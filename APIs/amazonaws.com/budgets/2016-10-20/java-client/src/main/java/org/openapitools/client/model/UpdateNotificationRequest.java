...
public class UpdateNotificationRequest {
  ...
  public static final String SERIALIZED_NAME_OLD_NOTIFICATION = "OldNotification";
  @SerializedName(SERIALIZED_NAME_OLD_NOTIFICATION)
  private UpdateNotificationRequestOldNotification oldNotification;

  public static final String SERIALIZED_NAME_NEW_NOTIFICATION = "NewNotification";
  @SerializedName(SERIALIZED_NAME_NEW_NOTIFICATION)
  private UpdateNotificationRequestNewNotification newNotification;

  public UpdateNotificationRequest() {
  }

  public UpdateNotificationRequest accountId(String accountId) {
  ...
  public UpdateNotificationRequest budgetName(String budgetName) {
  ...
  public UpdateNotificationRequest oldNotification(UpdateNotificationRequestOldNotification oldNotification) {
   ...
   */
  @javax.annotation.Nonnull
  public UpdateNotificationRequestOldNotification getOldNotification() {
    return oldNotification;
  }

  public void setOldNotification(UpdateNotificationRequestOldNotification oldNotification) {
    this.oldNotification = oldNotification;
  }


  public UpdateNotificationRequest newNotification(UpdateNotificationRequestNewNotification newNotification) {
   ...
   */
  @javax.annotation.Nonnull
  public UpdateNotificationRequestNewNotification getNewNotification() {
    return newNotification;
  }

  public void setNewNotification(UpdateNotificationRequestNewNotification newNotification) {
    this.newNotification = newNotification;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, updateNotificationRequest.accountId) &&
        Objects.equals(this.budgetName, updateNotificationRequest.budgetName) &&
        Objects.equals(this.oldNotification, updateNotificationRequest.oldNotification) &&
        Objects.equals(this.newNotification, updateNotificationRequest.newNotification);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, budgetName, oldNotification, newNotification);
  }
  ...
  public String toString() {
    ...
    sb.append("    oldNotification: ").append(toIndentedString(oldNotification)).append("\n");
    sb.append("    newNotification: ").append(toIndentedString(newNotification)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("OldNotification");
    openapiFields.add("NewNotification");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AccountId");
    openapiRequiredFields.add("BudgetName");
    openapiRequiredFields.add("OldNotification");
    openapiRequiredFields.add("NewNotification");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNotificationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNotificationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the required field `OldNotification`
      UpdateNotificationRequestOldNotification.validateJsonElement(jsonObj.get("OldNotification"));
      // validate the required field `NewNotification`
      UpdateNotificationRequestNewNotification.validateJsonElement(jsonObj.get("NewNotification"));
  }
