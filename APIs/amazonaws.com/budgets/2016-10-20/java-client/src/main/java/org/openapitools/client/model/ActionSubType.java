...
/**
 * Gets or Sets ActionSubType
 */
@JsonAdapter(ActionSubType.Adapter.class)
public enum ActionSubType {
  ...
  public static ActionSubType fromValue(String value) {
    for (ActionSubType b : ActionSubType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActionSubType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActionSubType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActionSubType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActionSubType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActionSubType.fromValue(value);
  }
}
