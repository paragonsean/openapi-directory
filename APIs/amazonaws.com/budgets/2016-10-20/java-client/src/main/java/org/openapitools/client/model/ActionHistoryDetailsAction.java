...
public class ActionHistoryDetailsAction {
  ...
  public ActionHistoryDetailsAction() {
  }

  public ActionHistoryDetailsAction actionId(String actionId) {
  ...
  public ActionHistoryDetailsAction budgetName(String budgetName) {
  ...
  public ActionHistoryDetailsAction notificationType(NotificationType notificationType) {
  ...
  public ActionHistoryDetailsAction actionType(ActionType actionType) {
  ...
  public ActionHistoryDetailsAction actionThreshold(ActionActionThreshold actionThreshold) {
  ...
  public ActionHistoryDetailsAction definition(ActionDefinition definition) {
  ...
  public ActionHistoryDetailsAction executionRoleArn(String executionRoleArn) {
  ...
  public ActionHistoryDetailsAction approvalModel(ApprovalModel approvalModel) {
  ...
  public ActionHistoryDetailsAction status(ActionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ActionHistoryDetailsAction subscribers(List<Subscriber> subscribers) {
    this.subscribers = subscribers;
    return this;
  }

  public ActionHistoryDetailsAction addSubscribersItem(Subscriber subscribersItem) {
  ...
  public boolean equals(Object o) {
    ...
    ActionHistoryDetailsAction actionHistoryDetailsAction = (ActionHistoryDetailsAction) o;
    return Objects.equals(this.actionId, actionHistoryDetailsAction.actionId) &&
        Objects.equals(this.budgetName, actionHistoryDetailsAction.budgetName) &&
        Objects.equals(this.notificationType, actionHistoryDetailsAction.notificationType) &&
        Objects.equals(this.actionType, actionHistoryDetailsAction.actionType) &&
        Objects.equals(this.actionThreshold, actionHistoryDetailsAction.actionThreshold) &&
        Objects.equals(this.definition, actionHistoryDetailsAction.definition) &&
        Objects.equals(this.executionRoleArn, actionHistoryDetailsAction.executionRoleArn) &&
        Objects.equals(this.approvalModel, actionHistoryDetailsAction.approvalModel) &&
        Objects.equals(this.status, actionHistoryDetailsAction.status) &&
        Objects.equals(this.subscribers, actionHistoryDetailsAction.subscribers);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionHistoryDetailsAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionHistoryDetailsAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionHistoryDetailsAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionHistoryDetailsAction is not found in the empty JSON string", ActionHistoryDetailsAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionHistoryDetailsAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionHistoryDetailsAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionHistoryDetailsAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionHistoryDetailsAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionHistoryDetailsAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionHistoryDetailsAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionHistoryDetailsAction.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionHistoryDetailsAction>() {
           @Override
           public void write(JsonWriter out, ActionHistoryDetailsAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionHistoryDetailsAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionHistoryDetailsAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionHistoryDetailsAction
   * @throws IOException if the JSON string is invalid with respect to ActionHistoryDetailsAction
   */
  public static ActionHistoryDetailsAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionHistoryDetailsAction.class);
  }

  /**
   * Convert an instance of ActionHistoryDetailsAction to an JSON string
   *
   * @return JSON string
   */
