...
public class ApiClient {
    ...
    private String basePath = "https://budgets.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-10-20/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://budgets.amazonaws.com
