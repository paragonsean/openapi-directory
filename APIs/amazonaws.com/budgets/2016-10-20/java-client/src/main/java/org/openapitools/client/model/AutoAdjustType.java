...
/**
 * Gets or Sets AutoAdjustType
 */
@JsonAdapter(AutoAdjustType.Adapter.class)
public enum AutoAdjustType {
  ...
  public static AutoAdjustType fromValue(String value) {
    for (AutoAdjustType b : AutoAdjustType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AutoAdjustType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AutoAdjustType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AutoAdjustType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AutoAdjustType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AutoAdjustType.fromValue(value);
  }
}
