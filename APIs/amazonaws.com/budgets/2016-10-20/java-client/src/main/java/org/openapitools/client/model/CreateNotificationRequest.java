...
public class CreateNotificationRequest {
  ...
  private CreateNotificationRequestNotification notification;
  ...
  public CreateNotificationRequest accountId(String accountId) {
  ...
  public CreateNotificationRequest budgetName(String budgetName) {
  ...
  public CreateNotificationRequest notification(CreateNotificationRequestNotification notification) {
   ...
   */
  @javax.annotation.Nonnull
  public CreateNotificationRequestNotification getNotification() {
    return notification;
  }

  public void setNotification(CreateNotificationRequestNotification notification) {
    this.notification = notification;
  }


  public CreateNotificationRequest subscribers(List subscribers) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, createNotificationRequest.accountId) &&
        Objects.equals(this.budgetName, createNotificationRequest.budgetName) &&
        Objects.equals(this.notification, createNotificationRequest.notification) &&
        Objects.equals(this.subscribers, createNotificationRequest.subscribers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, budgetName, notification, subscribers);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNotificationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNotificationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      CreateNotificationRequestNotification.validateJsonElement(jsonObj.get("Notification"));
