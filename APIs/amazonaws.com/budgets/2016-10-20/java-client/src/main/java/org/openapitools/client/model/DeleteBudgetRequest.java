...
public class DeleteBudgetRequest {
  ...
  public DeleteBudgetRequest accountId(String accountId) {
  ...
  public DeleteBudgetRequest budgetName(String budgetName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, deleteBudgetRequest.accountId) &&
        Objects.equals(this.budgetName, deleteBudgetRequest.budgetName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBudgetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBudgetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteBudgetRequest is not found in the empty JSON string", DeleteBudgetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBudgetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteBudgetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteBudgetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBudgetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBudgetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBudgetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBudgetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBudgetRequest>() {
           @Override
           public void write(JsonWriter out, DeleteBudgetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBudgetRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBudgetRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBudgetRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteBudgetRequest
   */
  public static DeleteBudgetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBudgetRequest.class);
  }

  /**
   * Convert an instance of DeleteBudgetRequest to an JSON string
   *
   * @return JSON string
   */
