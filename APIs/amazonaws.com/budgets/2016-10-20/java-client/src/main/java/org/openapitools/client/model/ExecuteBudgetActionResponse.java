...
import org.openapitools.client.model.ExecutionType;
...
public class ExecuteBudgetActionResponse {
  ...
  public ExecuteBudgetActionResponse() {
  }

  public ExecuteBudgetActionResponse accountId(String accountId) {
  ...
  public ExecuteBudgetActionResponse budgetName(String budgetName) {
  ...
  public ExecuteBudgetActionResponse actionId(String actionId) {
  ...
  public ExecuteBudgetActionResponse executionType(ExecutionType executionType) {
  ...
  public boolean equals(Object o) {
    ...
    ExecuteBudgetActionResponse executeBudgetActionResponse = (ExecuteBudgetActionResponse) o;
    return Objects.equals(this.accountId, executeBudgetActionResponse.accountId) &&
        Objects.equals(this.budgetName, executeBudgetActionResponse.budgetName) &&
        Objects.equals(this.actionId, executeBudgetActionResponse.actionId) &&
        Objects.equals(this.executionType, executeBudgetActionResponse.executionType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, budgetName, actionId, executionType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExecuteBudgetActionResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ExecutionType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExecuteBudgetActionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExecuteBudgetActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExecuteBudgetActionResponse is not found in the empty JSON string", ExecuteBudgetActionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecuteBudgetActionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExecuteBudgetActionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExecuteBudgetActionResponse.openapiRequiredFields) {
      ...
      // validate the required field `ExecutionType`
      ExecutionType.validateJsonElement(jsonObj.get("ExecutionType"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecuteBudgetActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecuteBudgetActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecuteBudgetActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecuteBudgetActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecuteBudgetActionResponse>() {
           @Override
           public void write(JsonWriter out, ExecuteBudgetActionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExecuteBudgetActionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExecuteBudgetActionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExecuteBudgetActionResponse
   * @throws IOException if the JSON string is invalid with respect to ExecuteBudgetActionResponse
   */
  public static ExecuteBudgetActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecuteBudgetActionResponse.class);
  }

  /**
   * Convert an instance of ExecuteBudgetActionResponse to an JSON string
   *
   * @return JSON string
   */
