 ...
 */
@JsonAdapter(ThresholdType.Adapter.class)
public enum ThresholdType {
  ...
  public static ThresholdType fromValue(String value) {
    for (ThresholdType b : ThresholdType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ThresholdType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ThresholdType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ThresholdType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ThresholdType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ThresholdType.fromValue(value);
  }
}
