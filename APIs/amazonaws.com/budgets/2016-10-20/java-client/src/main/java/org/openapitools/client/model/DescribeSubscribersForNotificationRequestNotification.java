...
public class DescribeSubscribersForNotificationRequestNotification {
  ...
  public DescribeSubscribersForNotificationRequestNotification() {
  }

  public DescribeSubscribersForNotificationRequestNotification notificationType(NotificationType notificationType) {
  ...
  public DescribeSubscribersForNotificationRequestNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public DescribeSubscribersForNotificationRequestNotification threshold(Double threshold) {
  ...
  public DescribeSubscribersForNotificationRequestNotification thresholdType(ThresholdType thresholdType) {
  ...
  public DescribeSubscribersForNotificationRequestNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSubscribersForNotificationRequestNotification describeSubscribersForNotificationRequestNotification = (DescribeSubscribersForNotificationRequestNotification) o;
    return Objects.equals(this.notificationType, describeSubscribersForNotificationRequestNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, describeSubscribersForNotificationRequestNotification.comparisonOperator) &&
        Objects.equals(this.threshold, describeSubscribersForNotificationRequestNotification.threshold) &&
        Objects.equals(this.thresholdType, describeSubscribersForNotificationRequestNotification.thresholdType) &&
        Objects.equals(this.notificationState, describeSubscribersForNotificationRequestNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeSubscribersForNotificationRequestNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSubscribersForNotificationRequestNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSubscribersForNotificationRequestNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSubscribersForNotificationRequestNotification is not found in the empty JSON string", DescribeSubscribersForNotificationRequestNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSubscribersForNotificationRequestNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSubscribersForNotificationRequestNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeSubscribersForNotificationRequestNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSubscribersForNotificationRequestNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSubscribersForNotificationRequestNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSubscribersForNotificationRequestNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSubscribersForNotificationRequestNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSubscribersForNotificationRequestNotification>() {
           @Override
           public void write(JsonWriter out, DescribeSubscribersForNotificationRequestNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSubscribersForNotificationRequestNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSubscribersForNotificationRequestNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSubscribersForNotificationRequestNotification
   * @throws IOException if the JSON string is invalid with respect to DescribeSubscribersForNotificationRequestNotification
   */
  public static DescribeSubscribersForNotificationRequestNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSubscribersForNotificationRequestNotification.class);
  }

  /**
   * Convert an instance of DescribeSubscribersForNotificationRequestNotification to an JSON string
   *
   * @return JSON string
   */
