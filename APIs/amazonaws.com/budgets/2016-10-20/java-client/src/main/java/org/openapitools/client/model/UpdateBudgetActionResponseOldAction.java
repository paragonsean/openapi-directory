...
public class UpdateBudgetActionResponseOldAction {
  ...
  public UpdateBudgetActionResponseOldAction() {
  }

  public UpdateBudgetActionResponseOldAction actionId(String actionId) {
  ...
  public UpdateBudgetActionResponseOldAction budgetName(String budgetName) {
  ...
  public UpdateBudgetActionResponseOldAction notificationType(NotificationType notificationType) {
  ...
  public UpdateBudgetActionResponseOldAction actionType(ActionType actionType) {
  ...
  public UpdateBudgetActionResponseOldAction actionThreshold(ActionActionThreshold actionThreshold) {
  ...
  public UpdateBudgetActionResponseOldAction definition(ActionDefinition definition) {
  ...
  public UpdateBudgetActionResponseOldAction executionRoleArn(String executionRoleArn) {
  ...
  public UpdateBudgetActionResponseOldAction approvalModel(ApprovalModel approvalModel) {
  ...
  public UpdateBudgetActionResponseOldAction status(ActionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateBudgetActionResponseOldAction subscribers(List<Subscriber> subscribers) {
    this.subscribers = subscribers;
    return this;
  }

  public UpdateBudgetActionResponseOldAction addSubscribersItem(Subscriber subscribersItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBudgetActionResponseOldAction updateBudgetActionResponseOldAction = (UpdateBudgetActionResponseOldAction) o;
    return Objects.equals(this.actionId, updateBudgetActionResponseOldAction.actionId) &&
        Objects.equals(this.budgetName, updateBudgetActionResponseOldAction.budgetName) &&
        Objects.equals(this.notificationType, updateBudgetActionResponseOldAction.notificationType) &&
        Objects.equals(this.actionType, updateBudgetActionResponseOldAction.actionType) &&
        Objects.equals(this.actionThreshold, updateBudgetActionResponseOldAction.actionThreshold) &&
        Objects.equals(this.definition, updateBudgetActionResponseOldAction.definition) &&
        Objects.equals(this.executionRoleArn, updateBudgetActionResponseOldAction.executionRoleArn) &&
        Objects.equals(this.approvalModel, updateBudgetActionResponseOldAction.approvalModel) &&
        Objects.equals(this.status, updateBudgetActionResponseOldAction.status) &&
        Objects.equals(this.subscribers, updateBudgetActionResponseOldAction.subscribers);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBudgetActionResponseOldAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBudgetActionResponseOldAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBudgetActionResponseOldAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBudgetActionResponseOldAction is not found in the empty JSON string", UpdateBudgetActionResponseOldAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBudgetActionResponseOldAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBudgetActionResponseOldAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateBudgetActionResponseOldAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBudgetActionResponseOldAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBudgetActionResponseOldAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBudgetActionResponseOldAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBudgetActionResponseOldAction.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBudgetActionResponseOldAction>() {
           @Override
           public void write(JsonWriter out, UpdateBudgetActionResponseOldAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBudgetActionResponseOldAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBudgetActionResponseOldAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBudgetActionResponseOldAction
   * @throws IOException if the JSON string is invalid with respect to UpdateBudgetActionResponseOldAction
   */
  public static UpdateBudgetActionResponseOldAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBudgetActionResponseOldAction.class);
  }

  /**
   * Convert an instance of UpdateBudgetActionResponseOldAction to an JSON string
   *
   * @return JSON string
   */
