...
import org.openapitools.client.model.DeleteNotificationRequestNotification;
...
public class DeleteNotificationRequest {
  ...
  private DeleteNotificationRequestNotification notification;

  public DeleteNotificationRequest() {
  }

  public DeleteNotificationRequest accountId(String accountId) {
  ...
  public DeleteNotificationRequest budgetName(String budgetName) {
  ...
  public DeleteNotificationRequest notification(DeleteNotificationRequestNotification notification) {
   ...
   */
  @javax.annotation.Nonnull
  public DeleteNotificationRequestNotification getNotification() {
    return notification;
  }

  public void setNotification(DeleteNotificationRequestNotification notification) {
    this.notification = notification;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, deleteNotificationRequest.accountId) &&
        Objects.equals(this.budgetName, deleteNotificationRequest.budgetName) &&
        Objects.equals(this.notification, deleteNotificationRequest.notification);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, budgetName, notification);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteNotificationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteNotificationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteNotificationRequest is not found in the empty JSON string", DeleteNotificationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteNotificationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteNotificationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteNotificationRequest.openapiRequiredFields) {
      ...
      DeleteNotificationRequestNotification.validateJsonElement(jsonObj.get("Notification"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteNotificationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteNotificationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteNotificationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteNotificationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteNotificationRequest>() {
           @Override
           public void write(JsonWriter out, DeleteNotificationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteNotificationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteNotificationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteNotificationRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteNotificationRequest
   */
  public static DeleteNotificationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteNotificationRequest.class);
  }

  /**
   * Convert an instance of DeleteNotificationRequest to an JSON string
   *
   * @return JSON string
   */
