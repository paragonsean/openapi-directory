...
public class IamActionDefinition {
  ...
  public IamActionDefinition() {
  }

  public IamActionDefinition policyArn(String policyArn) {
  ...
  public IamActionDefinition roles(List roles) {
    this.roles = roles;
    return this;
  }
  ...
  public IamActionDefinition groups(List groups) {
    this.groups = groups;
    return this;
  }
  ...
  public IamActionDefinition users(List users) {
    this.users = users;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IamActionDefinition iamActionDefinition = (IamActionDefinition) o;
    return Objects.equals(this.policyArn, iamActionDefinition.policyArn) &&
        Objects.equals(this.roles, iamActionDefinition.roles) &&
        Objects.equals(this.groups, iamActionDefinition.groups) &&
        Objects.equals(this.users, iamActionDefinition.users);
  }
  ...
  public String toString() {
    ...
    sb.append("class IamActionDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IamActionDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IamActionDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IamActionDefinition is not found in the empty JSON string", IamActionDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IamActionDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IamActionDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IamActionDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IamActionDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IamActionDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IamActionDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IamActionDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<IamActionDefinition>() {
           @Override
           public void write(JsonWriter out, IamActionDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IamActionDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IamActionDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IamActionDefinition
   * @throws IOException if the JSON string is invalid with respect to IamActionDefinition
   */
  public static IamActionDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IamActionDefinition.class);
  }

  /**
   * Convert an instance of IamActionDefinition to an JSON string
   *
   * @return JSON string
   */
