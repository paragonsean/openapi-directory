...
public class UpdateNotificationRequestOldNotification {
  ...
  public UpdateNotificationRequestOldNotification() {
  }

  public UpdateNotificationRequestOldNotification notificationType(NotificationType notificationType) {
  ...
  public UpdateNotificationRequestOldNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public UpdateNotificationRequestOldNotification threshold(Double threshold) {
  ...
  public UpdateNotificationRequestOldNotification thresholdType(ThresholdType thresholdType) {
  ...
  public UpdateNotificationRequestOldNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNotificationRequestOldNotification updateNotificationRequestOldNotification = (UpdateNotificationRequestOldNotification) o;
    return Objects.equals(this.notificationType, updateNotificationRequestOldNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, updateNotificationRequestOldNotification.comparisonOperator) &&
        Objects.equals(this.threshold, updateNotificationRequestOldNotification.threshold) &&
        Objects.equals(this.thresholdType, updateNotificationRequestOldNotification.thresholdType) &&
        Objects.equals(this.notificationState, updateNotificationRequestOldNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNotificationRequestOldNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNotificationRequestOldNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNotificationRequestOldNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNotificationRequestOldNotification is not found in the empty JSON string", UpdateNotificationRequestOldNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNotificationRequestOldNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNotificationRequestOldNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateNotificationRequestOldNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNotificationRequestOldNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNotificationRequestOldNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNotificationRequestOldNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNotificationRequestOldNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNotificationRequestOldNotification>() {
           @Override
           public void write(JsonWriter out, UpdateNotificationRequestOldNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNotificationRequestOldNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNotificationRequestOldNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNotificationRequestOldNotification
   * @throws IOException if the JSON string is invalid with respect to UpdateNotificationRequestOldNotification
   */
  public static UpdateNotificationRequestOldNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNotificationRequestOldNotification.class);
  }

  /**
   * Convert an instance of UpdateNotificationRequestOldNotification to an JSON string
   *
   * @return JSON string
   */
