...
public class DeleteBudgetActionResponse {
  ...
  public DeleteBudgetActionResponse() {
  }

  public DeleteBudgetActionResponse accountId(String accountId) {
  ...
  public DeleteBudgetActionResponse budgetName(String budgetName) {
  ...
  public DeleteBudgetActionResponse action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteBudgetActionResponse deleteBudgetActionResponse = (DeleteBudgetActionResponse) o;
    return Objects.equals(this.accountId, deleteBudgetActionResponse.accountId) &&
        Objects.equals(this.budgetName, deleteBudgetActionResponse.budgetName) &&
        Objects.equals(this.action, deleteBudgetActionResponse.action);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, budgetName, action);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteBudgetActionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBudgetActionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBudgetActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteBudgetActionResponse is not found in the empty JSON string", DeleteBudgetActionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBudgetActionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteBudgetActionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteBudgetActionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBudgetActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBudgetActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBudgetActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBudgetActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBudgetActionResponse>() {
           @Override
           public void write(JsonWriter out, DeleteBudgetActionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBudgetActionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBudgetActionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBudgetActionResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteBudgetActionResponse
   */
  public static DeleteBudgetActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBudgetActionResponse.class);
  }

  /**
   * Convert an instance of DeleteBudgetActionResponse to an JSON string
   *
   * @return JSON string
   */
