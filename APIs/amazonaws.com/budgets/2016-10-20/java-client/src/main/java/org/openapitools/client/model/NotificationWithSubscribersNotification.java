...
public class NotificationWithSubscribersNotification {
  ...
  public NotificationWithSubscribersNotification() {
  }

  public NotificationWithSubscribersNotification notificationType(NotificationType notificationType) {
  ...
  public NotificationWithSubscribersNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public NotificationWithSubscribersNotification threshold(Double threshold) {
  ...
  public NotificationWithSubscribersNotification thresholdType(ThresholdType thresholdType) {
  ...
  public NotificationWithSubscribersNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationWithSubscribersNotification notificationWithSubscribersNotification = (NotificationWithSubscribersNotification) o;
    return Objects.equals(this.notificationType, notificationWithSubscribersNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, notificationWithSubscribersNotification.comparisonOperator) &&
        Objects.equals(this.threshold, notificationWithSubscribersNotification.threshold) &&
        Objects.equals(this.thresholdType, notificationWithSubscribersNotification.thresholdType) &&
        Objects.equals(this.notificationState, notificationWithSubscribersNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationWithSubscribersNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotificationWithSubscribersNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationWithSubscribersNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotificationWithSubscribersNotification is not found in the empty JSON string", NotificationWithSubscribersNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotificationWithSubscribersNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotificationWithSubscribersNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotificationWithSubscribersNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotificationWithSubscribersNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotificationWithSubscribersNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotificationWithSubscribersNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotificationWithSubscribersNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<NotificationWithSubscribersNotification>() {
           @Override
           public void write(JsonWriter out, NotificationWithSubscribersNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotificationWithSubscribersNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotificationWithSubscribersNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotificationWithSubscribersNotification
   * @throws IOException if the JSON string is invalid with respect to NotificationWithSubscribersNotification
   */
  public static NotificationWithSubscribersNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotificationWithSubscribersNotification.class);
  }

  /**
   * Convert an instance of NotificationWithSubscribersNotification to an JSON string
   *
   * @return JSON string
   */
