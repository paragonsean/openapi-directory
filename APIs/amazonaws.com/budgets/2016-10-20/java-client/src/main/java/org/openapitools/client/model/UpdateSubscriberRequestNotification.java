...
public class UpdateSubscriberRequestNotification {
  ...
  public UpdateSubscriberRequestNotification() {
  }

  public UpdateSubscriberRequestNotification notificationType(NotificationType notificationType) {
  ...
  public UpdateSubscriberRequestNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public UpdateSubscriberRequestNotification threshold(Double threshold) {
  ...
  public UpdateSubscriberRequestNotification thresholdType(ThresholdType thresholdType) {
  ...
  public UpdateSubscriberRequestNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSubscriberRequestNotification updateSubscriberRequestNotification = (UpdateSubscriberRequestNotification) o;
    return Objects.equals(this.notificationType, updateSubscriberRequestNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, updateSubscriberRequestNotification.comparisonOperator) &&
        Objects.equals(this.threshold, updateSubscriberRequestNotification.threshold) &&
        Objects.equals(this.thresholdType, updateSubscriberRequestNotification.thresholdType) &&
        Objects.equals(this.notificationState, updateSubscriberRequestNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSubscriberRequestNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSubscriberRequestNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSubscriberRequestNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSubscriberRequestNotification is not found in the empty JSON string", UpdateSubscriberRequestNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSubscriberRequestNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSubscriberRequestNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSubscriberRequestNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSubscriberRequestNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSubscriberRequestNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSubscriberRequestNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSubscriberRequestNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSubscriberRequestNotification>() {
           @Override
           public void write(JsonWriter out, UpdateSubscriberRequestNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSubscriberRequestNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSubscriberRequestNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSubscriberRequestNotification
   * @throws IOException if the JSON string is invalid with respect to UpdateSubscriberRequestNotification
   */
  public static UpdateSubscriberRequestNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSubscriberRequestNotification.class);
  }

  /**
   * Convert an instance of UpdateSubscriberRequestNotification to an JSON string
   *
   * @return JSON string
   */
