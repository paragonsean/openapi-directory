...
public class BudgetPerformanceHistory {
  ...
  public BudgetPerformanceHistory budgetName(String budgetName) {
  ...
  public BudgetPerformanceHistory budgetType(BudgetType budgetType) {
  ...
  public BudgetPerformanceHistory costFilters(Map costFilters) {
  ...
  public BudgetPerformanceHistory costTypes(BudgetPerformanceHistoryCostTypes costTypes) {
  ...
  public BudgetPerformanceHistory timeUnit(TimeUnit timeUnit) {
  ...
  public BudgetPerformanceHistory budgetedAndActualAmountsList(List budgetedAndActualAmountsList) {
  ...
  public boolean equals(Object o) {
    ...
    BudgetPerformanceHistory budgetPerformanceHistory = (BudgetPerformanceHistory) o;
    return Objects.equals(this.budgetName, budgetPerformanceHistory.budgetName) &&
        Objects.equals(this.budgetType, budgetPerformanceHistory.budgetType) &&
        Objects.equals(this.costFilters, budgetPerformanceHistory.costFilters) &&
        Objects.equals(this.costTypes, budgetPerformanceHistory.costTypes) &&
        Objects.equals(this.timeUnit, budgetPerformanceHistory.timeUnit) &&
        Objects.equals(this.budgetedAndActualAmountsList, budgetPerformanceHistory.budgetedAndActualAmountsList);
  }
  ...
  public String toString() {
    ...
    sb.append("class BudgetPerformanceHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BudgetPerformanceHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BudgetPerformanceHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BudgetPerformanceHistory is not found in the empty JSON string", BudgetPerformanceHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BudgetPerformanceHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BudgetPerformanceHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BudgetPerformanceHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BudgetPerformanceHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BudgetPerformanceHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BudgetPerformanceHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<BudgetPerformanceHistory>() {
           @Override
           public void write(JsonWriter out, BudgetPerformanceHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BudgetPerformanceHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BudgetPerformanceHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BudgetPerformanceHistory
   * @throws IOException if the JSON string is invalid with respect to BudgetPerformanceHistory
   */
  public static BudgetPerformanceHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BudgetPerformanceHistory.class);
  }

  /**
   * Convert an instance of BudgetPerformanceHistory to an JSON string
   *
   * @return JSON string
   */
