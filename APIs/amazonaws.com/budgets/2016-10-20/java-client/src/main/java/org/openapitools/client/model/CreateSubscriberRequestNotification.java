...
public class CreateSubscriberRequestNotification {
  ...
  public CreateSubscriberRequestNotification() {
  }

  public CreateSubscriberRequestNotification notificationType(NotificationType notificationType) {
  ...
  public CreateSubscriberRequestNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public CreateSubscriberRequestNotification threshold(Double threshold) {
  ...
  public CreateSubscriberRequestNotification thresholdType(ThresholdType thresholdType) {
  ...
  public CreateSubscriberRequestNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSubscriberRequestNotification createSubscriberRequestNotification = (CreateSubscriberRequestNotification) o;
    return Objects.equals(this.notificationType, createSubscriberRequestNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, createSubscriberRequestNotification.comparisonOperator) &&
        Objects.equals(this.threshold, createSubscriberRequestNotification.threshold) &&
        Objects.equals(this.thresholdType, createSubscriberRequestNotification.thresholdType) &&
        Objects.equals(this.notificationState, createSubscriberRequestNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSubscriberRequestNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSubscriberRequestNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSubscriberRequestNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSubscriberRequestNotification is not found in the empty JSON string", CreateSubscriberRequestNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSubscriberRequestNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSubscriberRequestNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSubscriberRequestNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSubscriberRequestNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSubscriberRequestNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSubscriberRequestNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSubscriberRequestNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSubscriberRequestNotification>() {
           @Override
           public void write(JsonWriter out, CreateSubscriberRequestNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSubscriberRequestNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSubscriberRequestNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSubscriberRequestNotification
   * @throws IOException if the JSON string is invalid with respect to CreateSubscriberRequestNotification
   */
  public static CreateSubscriberRequestNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSubscriberRequestNotification.class);
  }

  /**
   * Convert an instance of CreateSubscriberRequestNotification to an JSON string
   *
   * @return JSON string
   */
