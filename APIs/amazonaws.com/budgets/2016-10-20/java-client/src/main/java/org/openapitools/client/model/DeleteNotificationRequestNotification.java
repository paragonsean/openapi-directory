...
public class DeleteNotificationRequestNotification {
  ...
  public DeleteNotificationRequestNotification() {
  }

  public DeleteNotificationRequestNotification notificationType(NotificationType notificationType) {
  ...
  public DeleteNotificationRequestNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public DeleteNotificationRequestNotification threshold(Double threshold) {
  ...
  public DeleteNotificationRequestNotification thresholdType(ThresholdType thresholdType) {
  ...
  public DeleteNotificationRequestNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteNotificationRequestNotification deleteNotificationRequestNotification = (DeleteNotificationRequestNotification) o;
    return Objects.equals(this.notificationType, deleteNotificationRequestNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, deleteNotificationRequestNotification.comparisonOperator) &&
        Objects.equals(this.threshold, deleteNotificationRequestNotification.threshold) &&
        Objects.equals(this.thresholdType, deleteNotificationRequestNotification.thresholdType) &&
        Objects.equals(this.notificationState, deleteNotificationRequestNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteNotificationRequestNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteNotificationRequestNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteNotificationRequestNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteNotificationRequestNotification is not found in the empty JSON string", DeleteNotificationRequestNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteNotificationRequestNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteNotificationRequestNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteNotificationRequestNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteNotificationRequestNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteNotificationRequestNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteNotificationRequestNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteNotificationRequestNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteNotificationRequestNotification>() {
           @Override
           public void write(JsonWriter out, DeleteNotificationRequestNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteNotificationRequestNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteNotificationRequestNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteNotificationRequestNotification
   * @throws IOException if the JSON string is invalid with respect to DeleteNotificationRequestNotification
   */
  public static DeleteNotificationRequestNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteNotificationRequestNotification.class);
  }

  /**
   * Convert an instance of DeleteNotificationRequestNotification to an JSON string
   *
   * @return JSON string
   */
