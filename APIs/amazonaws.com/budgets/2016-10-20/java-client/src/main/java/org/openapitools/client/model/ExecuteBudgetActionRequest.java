...
public class ExecuteBudgetActionRequest {
  ...
  public ExecuteBudgetActionRequest() {
  }

  public ExecuteBudgetActionRequest accountId(String accountId) {
  ...
  public ExecuteBudgetActionRequest budgetName(String budgetName) {
  ...
  public ExecuteBudgetActionRequest actionId(String actionId) {
  ...
  public ExecuteBudgetActionRequest executionType(ExecutionType executionType) {
  ...
  public boolean equals(Object o) {
    ...
    ExecuteBudgetActionRequest executeBudgetActionRequest = (ExecuteBudgetActionRequest) o;
    return Objects.equals(this.accountId, executeBudgetActionRequest.accountId) &&
        Objects.equals(this.budgetName, executeBudgetActionRequest.budgetName) &&
        Objects.equals(this.actionId, executeBudgetActionRequest.actionId) &&
        Objects.equals(this.executionType, executeBudgetActionRequest.executionType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExecuteBudgetActionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExecuteBudgetActionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExecuteBudgetActionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExecuteBudgetActionRequest is not found in the empty JSON string", ExecuteBudgetActionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecuteBudgetActionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExecuteBudgetActionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExecuteBudgetActionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecuteBudgetActionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecuteBudgetActionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecuteBudgetActionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecuteBudgetActionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecuteBudgetActionRequest>() {
           @Override
           public void write(JsonWriter out, ExecuteBudgetActionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExecuteBudgetActionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExecuteBudgetActionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExecuteBudgetActionRequest
   * @throws IOException if the JSON string is invalid with respect to ExecuteBudgetActionRequest
   */
  public static ExecuteBudgetActionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecuteBudgetActionRequest.class);
  }

  /**
   * Convert an instance of ExecuteBudgetActionRequest to an JSON string
   *
   * @return JSON string
   */
