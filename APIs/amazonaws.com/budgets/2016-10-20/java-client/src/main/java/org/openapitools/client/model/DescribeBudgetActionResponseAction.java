...
public class DescribeBudgetActionResponseAction {
  ...
  public DescribeBudgetActionResponseAction() {
  }

  public DescribeBudgetActionResponseAction actionId(String actionId) {
  ...
  public DescribeBudgetActionResponseAction budgetName(String budgetName) {
  ...
  public DescribeBudgetActionResponseAction notificationType(NotificationType notificationType) {
  ...
  public DescribeBudgetActionResponseAction actionType(ActionType actionType) {
  ...
  public DescribeBudgetActionResponseAction actionThreshold(ActionActionThreshold actionThreshold) {
  ...
  public DescribeBudgetActionResponseAction definition(ActionDefinition definition) {
  ...
  public DescribeBudgetActionResponseAction executionRoleArn(String executionRoleArn) {
  ...
  public DescribeBudgetActionResponseAction approvalModel(ApprovalModel approvalModel) {
  ...
  public DescribeBudgetActionResponseAction status(ActionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeBudgetActionResponseAction subscribers(List<Subscriber> subscribers) {
    this.subscribers = subscribers;
    return this;
  }

  public DescribeBudgetActionResponseAction addSubscribersItem(Subscriber subscribersItem) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeBudgetActionResponseAction describeBudgetActionResponseAction = (DescribeBudgetActionResponseAction) o;
    return Objects.equals(this.actionId, describeBudgetActionResponseAction.actionId) &&
        Objects.equals(this.budgetName, describeBudgetActionResponseAction.budgetName) &&
        Objects.equals(this.notificationType, describeBudgetActionResponseAction.notificationType) &&
        Objects.equals(this.actionType, describeBudgetActionResponseAction.actionType) &&
        Objects.equals(this.actionThreshold, describeBudgetActionResponseAction.actionThreshold) &&
        Objects.equals(this.definition, describeBudgetActionResponseAction.definition) &&
        Objects.equals(this.executionRoleArn, describeBudgetActionResponseAction.executionRoleArn) &&
        Objects.equals(this.approvalModel, describeBudgetActionResponseAction.approvalModel) &&
        Objects.equals(this.status, describeBudgetActionResponseAction.status) &&
        Objects.equals(this.subscribers, describeBudgetActionResponseAction.subscribers);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeBudgetActionResponseAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBudgetActionResponseAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBudgetActionResponseAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBudgetActionResponseAction is not found in the empty JSON string", DescribeBudgetActionResponseAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBudgetActionResponseAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBudgetActionResponseAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeBudgetActionResponseAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBudgetActionResponseAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBudgetActionResponseAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBudgetActionResponseAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBudgetActionResponseAction.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBudgetActionResponseAction>() {
           @Override
           public void write(JsonWriter out, DescribeBudgetActionResponseAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBudgetActionResponseAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBudgetActionResponseAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBudgetActionResponseAction
   * @throws IOException if the JSON string is invalid with respect to DescribeBudgetActionResponseAction
   */
  public static DescribeBudgetActionResponseAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBudgetActionResponseAction.class);
  }

  /**
   * Convert an instance of DescribeBudgetActionResponseAction to an JSON string
   *
   * @return JSON string
   */
