...
public class ScpActionDefinition {
  ...
  public ScpActionDefinition policyId(String policyId) {
  ...
  public ScpActionDefinition targetIds(List targetIds) {
  ...
  public boolean equals(Object o) {
    ...
    ScpActionDefinition scpActionDefinition = (ScpActionDefinition) o;
    return Objects.equals(this.policyId, scpActionDefinition.policyId) &&
        Objects.equals(this.targetIds, scpActionDefinition.targetIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScpActionDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScpActionDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScpActionDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScpActionDefinition is not found in the empty JSON string", ScpActionDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScpActionDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScpActionDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScpActionDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScpActionDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScpActionDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScpActionDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScpActionDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<ScpActionDefinition>() {
           @Override
           public void write(JsonWriter out, ScpActionDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScpActionDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScpActionDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScpActionDefinition
   * @throws IOException if the JSON string is invalid with respect to ScpActionDefinition
   */
  public static ScpActionDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScpActionDefinition.class);
  }

  /**
   * Convert an instance of ScpActionDefinition to an JSON string
   *
   * @return JSON string
   */
