...
public class DeleteSubscriberRequestNotification {
  ...
  public DeleteSubscriberRequestNotification() {
  }

  public DeleteSubscriberRequestNotification notificationType(NotificationType notificationType) {
  ...
  public DeleteSubscriberRequestNotification comparisonOperator(ComparisonOperator comparisonOperator) {
  ...
  public DeleteSubscriberRequestNotification threshold(Double threshold) {
  ...
  public DeleteSubscriberRequestNotification thresholdType(ThresholdType thresholdType) {
  ...
  public DeleteSubscriberRequestNotification notificationState(NotificationState notificationState) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSubscriberRequestNotification deleteSubscriberRequestNotification = (DeleteSubscriberRequestNotification) o;
    return Objects.equals(this.notificationType, deleteSubscriberRequestNotification.notificationType) &&
        Objects.equals(this.comparisonOperator, deleteSubscriberRequestNotification.comparisonOperator) &&
        Objects.equals(this.threshold, deleteSubscriberRequestNotification.threshold) &&
        Objects.equals(this.thresholdType, deleteSubscriberRequestNotification.thresholdType) &&
        Objects.equals(this.notificationState, deleteSubscriberRequestNotification.notificationState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSubscriberRequestNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSubscriberRequestNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSubscriberRequestNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSubscriberRequestNotification is not found in the empty JSON string", DeleteSubscriberRequestNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSubscriberRequestNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSubscriberRequestNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteSubscriberRequestNotification.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSubscriberRequestNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSubscriberRequestNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSubscriberRequestNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSubscriberRequestNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSubscriberRequestNotification>() {
           @Override
           public void write(JsonWriter out, DeleteSubscriberRequestNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSubscriberRequestNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSubscriberRequestNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSubscriberRequestNotification
   * @throws IOException if the JSON string is invalid with respect to DeleteSubscriberRequestNotification
   */
  public static DeleteSubscriberRequestNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSubscriberRequestNotification.class);
  }

  /**
   * Convert an instance of DeleteSubscriberRequestNotification to an JSON string
   *
   * @return JSON string
   */
