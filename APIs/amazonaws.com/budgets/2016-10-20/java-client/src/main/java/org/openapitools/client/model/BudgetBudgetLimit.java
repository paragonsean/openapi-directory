...
public class BudgetBudgetLimit {
  ...
  public BudgetBudgetLimit() {
  }

  public BudgetBudgetLimit amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public BudgetBudgetLimit unit(String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BudgetBudgetLimit budgetBudgetLimit = (BudgetBudgetLimit) o;
    return Objects.equals(this.amount, budgetBudgetLimit.amount) &&
        Objects.equals(this.unit, budgetBudgetLimit.unit);
  }
  ...
  public String toString() {
    ...
    sb.append("class BudgetBudgetLimit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BudgetBudgetLimit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BudgetBudgetLimit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BudgetBudgetLimit is not found in the empty JSON string", BudgetBudgetLimit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BudgetBudgetLimit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BudgetBudgetLimit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BudgetBudgetLimit.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BudgetBudgetLimit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BudgetBudgetLimit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BudgetBudgetLimit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BudgetBudgetLimit.class));

       return (TypeAdapter<T>) new TypeAdapter<BudgetBudgetLimit>() {
           @Override
           public void write(JsonWriter out, BudgetBudgetLimit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BudgetBudgetLimit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BudgetBudgetLimit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BudgetBudgetLimit
   * @throws IOException if the JSON string is invalid with respect to BudgetBudgetLimit
   */
  public static BudgetBudgetLimit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BudgetBudgetLimit.class);
  }

  /**
   * Convert an instance of BudgetBudgetLimit to an JSON string
   *
   * @return JSON string
   */
