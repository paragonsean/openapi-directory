 ...
 */
@JsonAdapter(ExecutionType.Adapter.class)
public enum ExecutionType {
  ...
  public static class Adapter extends TypeAdapter<ExecutionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExecutionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExecutionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExecutionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExecutionType.fromValue(value);
  }
}
