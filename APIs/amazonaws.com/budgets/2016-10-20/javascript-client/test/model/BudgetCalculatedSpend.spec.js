...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetCalculatedSpend();
  });
  ...
  describe('BudgetCalculatedSpend', function() {
    it('should create an instance of BudgetCalculatedSpend', function() {
      // uncomment below and update the code to test BudgetCalculatedSpend
      //var instance = new AwsBudgets.BudgetCalculatedSpend();
      //expect(instance).to.be.a(AwsBudgets.BudgetCalculatedSpend);
    });

    it('should have the property actualSpend (base name: "ActualSpend")', function() {
      // uncomment below and update the code to test the property actualSpend
      //var instance = new AwsBudgets.BudgetCalculatedSpend();
      //expect(instance).to.be();
    });

    it('should have the property forecastedSpend (base name: "ForecastedSpend")', function() {
      // uncomment below and update the code to test the property forecastedSpend
      //var instance = new AwsBudgets.BudgetCalculatedSpend();
      //expect(instance).to.be();
    });
