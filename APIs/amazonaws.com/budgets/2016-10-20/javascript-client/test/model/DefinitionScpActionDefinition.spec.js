...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DefinitionScpActionDefinition();
  });
  ...
  describe('DefinitionScpActionDefinition', function() {
    it('should create an instance of DefinitionScpActionDefinition', function() {
      // uncomment below and update the code to test DefinitionScpActionDefinition
      //var instance = new AwsBudgets.DefinitionScpActionDefinition();
      //expect(instance).to.be.a(AwsBudgets.DefinitionScpActionDefinition);
    });
