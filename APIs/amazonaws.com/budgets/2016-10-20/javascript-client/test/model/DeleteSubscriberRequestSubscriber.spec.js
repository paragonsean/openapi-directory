...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteSubscriberRequestSubscriber();
  });
  ...
  describe('DeleteSubscriberRequestSubscriber', function() {
    it('should create an instance of DeleteSubscriberRequestSubscriber', function() {
      // uncomment below and update the code to test DeleteSubscriberRequestSubscriber
      //var instance = new AwsBudgets.DeleteSubscriberRequestSubscriber();
      //expect(instance).to.be.a(AwsBudgets.DeleteSubscriberRequestSubscriber);
    });
