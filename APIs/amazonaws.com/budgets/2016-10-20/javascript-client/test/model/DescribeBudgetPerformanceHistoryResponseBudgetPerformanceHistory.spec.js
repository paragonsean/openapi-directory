...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory();
  });
  ...
  describe('DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory', function() {
    it('should create an instance of DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory', function() {
      // uncomment below and update the code to test DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory
      //var instance = new AwsBudgets.DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory);
    });
