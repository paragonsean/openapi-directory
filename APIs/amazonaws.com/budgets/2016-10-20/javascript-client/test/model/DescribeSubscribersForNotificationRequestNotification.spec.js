...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeSubscribersForNotificationRequestNotification();
  });
  ...
  describe('DescribeSubscribersForNotificationRequestNotification', function() {
    it('should create an instance of DescribeSubscribersForNotificationRequestNotification', function() {
      // uncomment below and update the code to test DescribeSubscribersForNotificationRequestNotification
      //var instance = new AwsBudgets.DescribeSubscribersForNotificationRequestNotification();
      //expect(instance).to.be.a(AwsBudgets.DescribeSubscribersForNotificationRequestNotification);
    });
