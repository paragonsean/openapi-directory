...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ExecuteBudgetActionRequest();
  });
  ...
  describe('ExecuteBudgetActionRequest', function() {
    it('should create an instance of ExecuteBudgetActionRequest', function() {
      // uncomment below and update the code to test ExecuteBudgetActionRequest
      //var instance = new AwsBudgets.ExecuteBudgetActionRequest();
      //expect(instance).to.be.a(AwsBudgets.ExecuteBudgetActionRequest);
    });
