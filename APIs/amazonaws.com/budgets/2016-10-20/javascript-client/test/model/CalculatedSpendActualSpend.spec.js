...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CalculatedSpendActualSpend();
  });
  ...
  describe('CalculatedSpendActualSpend', function() {
    it('should create an instance of CalculatedSpendActualSpend', function() {
      // uncomment below and update the code to test CalculatedSpendActualSpend
      //var instance = new AwsBudgets.CalculatedSpendActualSpend();
      //expect(instance).to.be.a(AwsBudgets.CalculatedSpendActualSpend);
    });
