...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateBudgetRequestBudget();
  });
  ...
  describe('CreateBudgetRequestBudget', function() {
    it('should create an instance of CreateBudgetRequestBudget', function() {
      // uncomment below and update the code to test CreateBudgetRequestBudget
      //var instance = new AwsBudgets.CreateBudgetRequestBudget();
      //expect(instance).to.be.a(AwsBudgets.CreateBudgetRequestBudget);
    });
