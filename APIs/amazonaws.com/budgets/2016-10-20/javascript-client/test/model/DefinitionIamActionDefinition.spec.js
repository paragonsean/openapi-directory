...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DefinitionIamActionDefinition();
  });
  ...
  describe('DefinitionIamActionDefinition', function() {
    it('should create an instance of DefinitionIamActionDefinition', function() {
      // uncomment below and update the code to test DefinitionIamActionDefinition
      //var instance = new AwsBudgets.DefinitionIamActionDefinition();
      //expect(instance).to.be.a(AwsBudgets.DefinitionIamActionDefinition);
    });
