...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateBudgetActionRequest();
  });
  ...
  describe('UpdateBudgetActionRequest', function() {
    it('should create an instance of UpdateBudgetActionRequest', function() {
      // uncomment below and update the code to test UpdateBudgetActionRequest
      //var instance = new AwsBudgets.UpdateBudgetActionRequest();
      //expect(instance).to.be.a(AwsBudgets.UpdateBudgetActionRequest);
    });
