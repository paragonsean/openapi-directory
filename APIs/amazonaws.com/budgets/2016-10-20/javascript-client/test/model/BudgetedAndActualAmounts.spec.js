...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetedAndActualAmounts();
  });
  ...
  describe('BudgetedAndActualAmounts', function() {
    it('should create an instance of BudgetedAndActualAmounts', function() {
      // uncomment below and update the code to test BudgetedAndActualAmounts
      //var instance = new AwsBudgets.BudgetedAndActualAmounts();
      //expect(instance).to.be.a(AwsBudgets.BudgetedAndActualAmounts);
    });

    it('should have the property budgetedAmount (base name: "BudgetedAmount")', function() {
      // uncomment below and update the code to test the property budgetedAmount
      //var instance = new AwsBudgets.BudgetedAndActualAmounts();
      //expect(instance).to.be();
    });

    it('should have the property actualAmount (base name: "ActualAmount")', function() {
