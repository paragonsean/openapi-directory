...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetedAndActualAmountsBudgetedAmount();
  });
  ...
  describe('BudgetedAndActualAmountsBudgetedAmount', function() {
    it('should create an instance of BudgetedAndActualAmountsBudgetedAmount', function() {
      // uncomment below and update the code to test BudgetedAndActualAmountsBudgetedAmount
      //var instance = new AwsBudgets.BudgetedAndActualAmountsBudgetedAmount();
      //expect(instance).to.be.a(AwsBudgets.BudgetedAndActualAmountsBudgetedAmount);
    });
