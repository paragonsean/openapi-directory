...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.NotificationWithSubscribersNotification();
  });
  ...
  describe('NotificationWithSubscribersNotification', function() {
    it('should create an instance of NotificationWithSubscribersNotification', function() {
      // uncomment below and update the code to test NotificationWithSubscribersNotification
      //var instance = new AwsBudgets.NotificationWithSubscribersNotification();
      //expect(instance).to.be.a(AwsBudgets.NotificationWithSubscribersNotification);
    });
