...
(function(root, factory) {
  ...
  describe('ExecutionType', function() {
    it('should create an instance of ExecutionType', function() {
      // uncomment below and update the code to test ExecutionType
      //var instance = new AwsBudgets.ExecutionType();
      //expect(instance).to.be.a(AwsBudgets.ExecutionType);
    });
