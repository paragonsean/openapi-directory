...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateBudgetRequest();
  });
  ...
  describe('UpdateBudgetRequest', function() {
    it('should create an instance of UpdateBudgetRequest', function() {
      // uncomment below and update the code to test UpdateBudgetRequest
      //var instance = new AwsBudgets.UpdateBudgetRequest();
      //expect(instance).to.be.a(AwsBudgets.UpdateBudgetRequest);
    });
    ...
    it('should have the property newBudget (base name: "NewBudget")', function() {
      // uncomment below and update the code to test the property newBudget
      //var instance = new AwsBudgets.UpdateBudgetRequest();
      //expect(instance).to.be();
    });
