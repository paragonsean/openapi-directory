...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetsRequest();
  });
  ...
  describe('DescribeBudgetsRequest', function() {
    it('should create an instance of DescribeBudgetsRequest', function() {
      // uncomment below and update the code to test DescribeBudgetsRequest
      //var instance = new AwsBudgets.DescribeBudgetsRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetsRequest);
    });
