...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetedAndActualAmountsTimePeriod();
  });
  ...
  describe('BudgetedAndActualAmountsTimePeriod', function() {
    it('should create an instance of BudgetedAndActualAmountsTimePeriod', function() {
      // uncomment below and update the code to test BudgetedAndActualAmountsTimePeriod
      //var instance = new AwsBudgets.BudgetedAndActualAmountsTimePeriod();
      //expect(instance).to.be.a(AwsBudgets.BudgetedAndActualAmountsTimePeriod);
    });
