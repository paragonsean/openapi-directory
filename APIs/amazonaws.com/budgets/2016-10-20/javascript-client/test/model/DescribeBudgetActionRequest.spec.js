...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionRequest();
  });
  ...
  describe('DescribeBudgetActionRequest', function() {
    it('should create an instance of DescribeBudgetActionRequest', function() {
      // uncomment below and update the code to test DescribeBudgetActionRequest
      //var instance = new AwsBudgets.DescribeBudgetActionRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionRequest);
    });
