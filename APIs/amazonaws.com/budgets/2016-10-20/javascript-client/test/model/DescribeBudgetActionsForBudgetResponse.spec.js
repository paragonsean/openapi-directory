...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionsForBudgetResponse();
  });
  ...
  describe('DescribeBudgetActionsForBudgetResponse', function() {
    it('should create an instance of DescribeBudgetActionsForBudgetResponse', function() {
      // uncomment below and update the code to test DescribeBudgetActionsForBudgetResponse
      //var instance = new AwsBudgets.DescribeBudgetActionsForBudgetResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionsForBudgetResponse);
    });
