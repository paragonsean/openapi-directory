...
(function(root, factory) {
  ...
  describe('NotificationState', function() {
    it('should create an instance of NotificationState', function() {
      // uncomment below and update the code to test NotificationState
      //var instance = new AwsBudgets.NotificationState();
      //expect(instance).to.be.a(AwsBudgets.NotificationState);
    });
