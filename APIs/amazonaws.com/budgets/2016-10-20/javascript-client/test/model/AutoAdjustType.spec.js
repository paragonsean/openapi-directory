...
(function(root, factory) {
  ...
  describe('AutoAdjustType', function() {
    it('should create an instance of AutoAdjustType', function() {
      // uncomment below and update the code to test AutoAdjustType
      //var instance = new AwsBudgets.AutoAdjustType();
      //expect(instance).to.be.a(AwsBudgets.AutoAdjustType);
    });
