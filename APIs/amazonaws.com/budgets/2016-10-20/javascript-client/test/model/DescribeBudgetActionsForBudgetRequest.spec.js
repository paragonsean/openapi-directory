...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionsForBudgetRequest();
  });
  ...
  describe('DescribeBudgetActionsForBudgetRequest', function() {
    it('should create an instance of DescribeBudgetActionsForBudgetRequest', function() {
      // uncomment below and update the code to test DescribeBudgetActionsForBudgetRequest
      //var instance = new AwsBudgets.DescribeBudgetActionsForBudgetRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionsForBudgetRequest);
    });
