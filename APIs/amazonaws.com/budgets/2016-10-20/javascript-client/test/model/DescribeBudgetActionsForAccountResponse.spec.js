...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionsForAccountResponse();
  });
  ...
  describe('DescribeBudgetActionsForAccountResponse', function() {
    it('should create an instance of DescribeBudgetActionsForAccountResponse', function() {
      // uncomment below and update the code to test DescribeBudgetActionsForAccountResponse
      //var instance = new AwsBudgets.DescribeBudgetActionsForAccountResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionsForAccountResponse);
    });
