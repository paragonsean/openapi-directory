...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.AutoAdjustData();
  });
  ...
  describe('AutoAdjustData', function() {
    it('should create an instance of AutoAdjustData', function() {
      // uncomment below and update the code to test AutoAdjustData
      //var instance = new AwsBudgets.AutoAdjustData();
      //expect(instance).to.be.a(AwsBudgets.AutoAdjustData);
    });
