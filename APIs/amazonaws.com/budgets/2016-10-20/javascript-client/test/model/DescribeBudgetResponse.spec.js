...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetResponse();
  });
  ...
  describe('DescribeBudgetResponse', function() {
    it('should create an instance of DescribeBudgetResponse', function() {
      // uncomment below and update the code to test DescribeBudgetResponse
      //var instance = new AwsBudgets.DescribeBudgetResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetResponse);
    });
