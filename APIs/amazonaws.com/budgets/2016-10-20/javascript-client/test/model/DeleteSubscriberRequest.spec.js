...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteSubscriberRequest();
  });
  ...
  describe('DeleteSubscriberRequest', function() {
    it('should create an instance of DeleteSubscriberRequest', function() {
      // uncomment below and update the code to test DeleteSubscriberRequest
      //var instance = new AwsBudgets.DeleteSubscriberRequest();
      //expect(instance).to.be.a(AwsBudgets.DeleteSubscriberRequest);
    });
