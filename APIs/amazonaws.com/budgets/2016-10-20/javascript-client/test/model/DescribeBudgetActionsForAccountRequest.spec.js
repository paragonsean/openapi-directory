...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionsForAccountRequest();
  });
  ...
  describe('DescribeBudgetActionsForAccountRequest', function() {
    it('should create an instance of DescribeBudgetActionsForAccountRequest', function() {
      // uncomment below and update the code to test DescribeBudgetActionsForAccountRequest
      //var instance = new AwsBudgets.DescribeBudgetActionsForAccountRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionsForAccountRequest);
    });
