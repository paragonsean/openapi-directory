...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetPerformanceHistoryRequestTimePeriod();
  });
  ...
  describe('DescribeBudgetPerformanceHistoryRequestTimePeriod', function() {
    it('should create an instance of DescribeBudgetPerformanceHistoryRequestTimePeriod', function() {
      // uncomment below and update the code to test DescribeBudgetPerformanceHistoryRequestTimePeriod
      //var instance = new AwsBudgets.DescribeBudgetPerformanceHistoryRequestTimePeriod();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetPerformanceHistoryRequestTimePeriod);
    });
