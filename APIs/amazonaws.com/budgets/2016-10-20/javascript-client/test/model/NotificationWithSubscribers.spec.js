...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.NotificationWithSubscribers();
  });
  ...
  describe('NotificationWithSubscribers', function() {
    it('should create an instance of NotificationWithSubscribers', function() {
      // uncomment below and update the code to test NotificationWithSubscribers
      //var instance = new AwsBudgets.NotificationWithSubscribers();
      //expect(instance).to.be.a(AwsBudgets.NotificationWithSubscribers);
    });
