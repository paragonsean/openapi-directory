...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ActionHistoryDetails();
  });
  ...
  describe('ActionHistoryDetails', function() {
    it('should create an instance of ActionHistoryDetails', function() {
      // uncomment below and update the code to test ActionHistoryDetails
      //var instance = new AwsBudgets.ActionHistoryDetails();
      //expect(instance).to.be.a(AwsBudgets.ActionHistoryDetails);
    });
