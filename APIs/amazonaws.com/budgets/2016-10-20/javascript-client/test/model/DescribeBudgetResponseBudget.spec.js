...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetResponseBudget();
  });
  ...
  describe('DescribeBudgetResponseBudget', function() {
    it('should create an instance of DescribeBudgetResponseBudget', function() {
      // uncomment below and update the code to test DescribeBudgetResponseBudget
      //var instance = new AwsBudgets.DescribeBudgetResponseBudget();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetResponseBudget);
    });
