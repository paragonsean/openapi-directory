...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateSubscriberRequest();
  });
  ...
  describe('UpdateSubscriberRequest', function() {
    it('should create an instance of UpdateSubscriberRequest', function() {
      // uncomment below and update the code to test UpdateSubscriberRequest
      //var instance = new AwsBudgets.UpdateSubscriberRequest();
      //expect(instance).to.be.a(AwsBudgets.UpdateSubscriberRequest);
    });
    ...
    it('should have the property oldSubscriber (base name: "OldSubscriber")', function() {
      // uncomment below and update the code to test the property oldSubscriber
      //var instance = new AwsBudgets.UpdateSubscriberRequest();
      //expect(instance).to.be();
    });

    it('should have the property newSubscriber (base name: "NewSubscriber")', function() {
      // uncomment below and update the code to test the property newSubscriber
      //var instance = new AwsBudgets.UpdateSubscriberRequest();
      //expect(instance).to.be();
    });
