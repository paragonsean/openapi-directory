...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.IamActionDefinition();
  });
  ...
  describe('IamActionDefinition', function() {
    it('should create an instance of IamActionDefinition', function() {
      // uncomment below and update the code to test IamActionDefinition
      //var instance = new AwsBudgets.IamActionDefinition();
      //expect(instance).to.be.a(AwsBudgets.IamActionDefinition);
    });
