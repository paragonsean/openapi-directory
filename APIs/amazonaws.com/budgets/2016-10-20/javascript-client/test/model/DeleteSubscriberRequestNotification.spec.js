...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteSubscriberRequestNotification();
  });
  ...
  describe('DeleteSubscriberRequestNotification', function() {
    it('should create an instance of DeleteSubscriberRequestNotification', function() {
      // uncomment below and update the code to test DeleteSubscriberRequestNotification
      //var instance = new AwsBudgets.DeleteSubscriberRequestNotification();
      //expect(instance).to.be.a(AwsBudgets.DeleteSubscriberRequestNotification);
    });
