...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetPerformanceHistoryResponse();
  });
  ...
  describe('DescribeBudgetPerformanceHistoryResponse', function() {
    it('should create an instance of DescribeBudgetPerformanceHistoryResponse', function() {
      // uncomment below and update the code to test DescribeBudgetPerformanceHistoryResponse
      //var instance = new AwsBudgets.DescribeBudgetPerformanceHistoryResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetPerformanceHistoryResponse);
    });

    it('should have the property budgetPerformanceHistory (base name: "BudgetPerformanceHistory")', function() {
      // uncomment below and update the code to test the property budgetPerformanceHistory
      //var instance = new AwsBudgets.DescribeBudgetPerformanceHistoryResponse();
