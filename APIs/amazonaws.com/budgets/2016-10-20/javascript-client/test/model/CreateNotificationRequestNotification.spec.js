...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateNotificationRequestNotification();
  });
  ...
  describe('CreateNotificationRequestNotification', function() {
    it('should create an instance of CreateNotificationRequestNotification', function() {
      // uncomment below and update the code to test CreateNotificationRequestNotification
      //var instance = new AwsBudgets.CreateNotificationRequestNotification();
      //expect(instance).to.be.a(AwsBudgets.CreateNotificationRequestNotification);
    });
