...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateBudgetActionResponseNewAction();
  });
  ...
  describe('UpdateBudgetActionResponseNewAction', function() {
    it('should create an instance of UpdateBudgetActionResponseNewAction', function() {
      // uncomment below and update the code to test UpdateBudgetActionResponseNewAction
      //var instance = new AwsBudgets.UpdateBudgetActionResponseNewAction();
      //expect(instance).to.be.a(AwsBudgets.UpdateBudgetActionResponseNewAction);
    });
    ...
    it('should have the property actionThreshold (base name: "ActionThreshold")', function() {
      // uncomment below and update the code to test the property actionThreshold
      //var instance = new AwsBudgets.UpdateBudgetActionResponseNewAction();
      //expect(instance).to.be();
    });
    ...
    it('should have the property approvalModel (base name: "ApprovalModel")', function() {
      // uncomment below and update the code to test the property approvalModel
      //var instance = new AwsBudgets.UpdateBudgetActionResponseNewAction();
      //expect(instance).to.be();
    });
