...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateSubscriberRequestOldSubscriber();
  });
  ...
  describe('UpdateSubscriberRequestOldSubscriber', function() {
    it('should create an instance of UpdateSubscriberRequestOldSubscriber', function() {
      // uncomment below and update the code to test UpdateSubscriberRequestOldSubscriber
      //var instance = new AwsBudgets.UpdateSubscriberRequestOldSubscriber();
      //expect(instance).to.be.a(AwsBudgets.UpdateSubscriberRequestOldSubscriber);
    });
