...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeNotificationsForBudgetRequest();
  });
  ...
  describe('DescribeNotificationsForBudgetRequest', function() {
    it('should create an instance of DescribeNotificationsForBudgetRequest', function() {
      // uncomment below and update the code to test DescribeNotificationsForBudgetRequest
      //var instance = new AwsBudgets.DescribeNotificationsForBudgetRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeNotificationsForBudgetRequest);
    });
