...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ActionHistoryActionHistoryDetails();
  });
  ...
  describe('ActionHistoryActionHistoryDetails', function() {
    it('should create an instance of ActionHistoryActionHistoryDetails', function() {
      // uncomment below and update the code to test ActionHistoryActionHistoryDetails
      //var instance = new AwsBudgets.ActionHistoryActionHistoryDetails();
      //expect(instance).to.be.a(AwsBudgets.ActionHistoryActionHistoryDetails);
    });
