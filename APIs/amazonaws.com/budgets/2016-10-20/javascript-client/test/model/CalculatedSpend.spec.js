...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CalculatedSpend();
  });
  ...
  describe('CalculatedSpend', function() {
    it('should create an instance of CalculatedSpend', function() {
      // uncomment below and update the code to test CalculatedSpend
      //var instance = new AwsBudgets.CalculatedSpend();
      //expect(instance).to.be.a(AwsBudgets.CalculatedSpend);
    });
