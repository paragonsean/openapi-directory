...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteBudgetActionRequest();
  });
  ...
  describe('DeleteBudgetActionRequest', function() {
    it('should create an instance of DeleteBudgetActionRequest', function() {
      // uncomment below and update the code to test DeleteBudgetActionRequest
      //var instance = new AwsBudgets.DeleteBudgetActionRequest();
      //expect(instance).to.be.a(AwsBudgets.DeleteBudgetActionRequest);
    });
