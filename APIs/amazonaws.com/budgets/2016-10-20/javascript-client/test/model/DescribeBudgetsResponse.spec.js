...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetsResponse();
  });
  ...
  describe('DescribeBudgetsResponse', function() {
    it('should create an instance of DescribeBudgetsResponse', function() {
      // uncomment below and update the code to test DescribeBudgetsResponse
      //var instance = new AwsBudgets.DescribeBudgetsResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetsResponse);
    });
