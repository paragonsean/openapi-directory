...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ExecuteBudgetActionResponse();
  });
  ...
  describe('ExecuteBudgetActionResponse', function() {
    it('should create an instance of ExecuteBudgetActionResponse', function() {
      // uncomment below and update the code to test ExecuteBudgetActionResponse
      //var instance = new AwsBudgets.ExecuteBudgetActionResponse();
      //expect(instance).to.be.a(AwsBudgets.ExecuteBudgetActionResponse);
    });
