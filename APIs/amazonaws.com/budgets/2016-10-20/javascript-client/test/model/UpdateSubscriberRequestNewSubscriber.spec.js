...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateSubscriberRequestNewSubscriber();
  });
  ...
  describe('UpdateSubscriberRequestNewSubscriber', function() {
    it('should create an instance of UpdateSubscriberRequestNewSubscriber', function() {
      // uncomment below and update the code to test UpdateSubscriberRequestNewSubscriber
      //var instance = new AwsBudgets.UpdateSubscriberRequestNewSubscriber();
      //expect(instance).to.be.a(AwsBudgets.UpdateSubscriberRequestNewSubscriber);
    });
