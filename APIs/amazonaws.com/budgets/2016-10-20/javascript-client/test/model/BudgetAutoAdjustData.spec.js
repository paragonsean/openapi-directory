...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetAutoAdjustData();
  });
  ...
  describe('BudgetAutoAdjustData', function() {
    it('should create an instance of BudgetAutoAdjustData', function() {
      // uncomment below and update the code to test BudgetAutoAdjustData
      //var instance = new AwsBudgets.BudgetAutoAdjustData();
      //expect(instance).to.be.a(AwsBudgets.BudgetAutoAdjustData);
    });

    it('should have the property autoAdjustType (base name: "AutoAdjustType")', function() {
      // uncomment below and update the code to test the property autoAdjustType
      //var instance = new AwsBudgets.BudgetAutoAdjustData();
      //expect(instance).to.be();
    });

    it('should have the property historicalOptions (base name: "HistoricalOptions")', function() {
      // uncomment below and update the code to test the property historicalOptions
      //var instance = new AwsBudgets.BudgetAutoAdjustData();
      //expect(instance).to.be();
    });

    it('should have the property lastAutoAdjustTime (base name: "LastAutoAdjustTime")', function() {
      // uncomment below and update the code to test the property lastAutoAdjustTime
      //var instance = new AwsBudgets.BudgetAutoAdjustData();
      //expect(instance).to.be();
    });
