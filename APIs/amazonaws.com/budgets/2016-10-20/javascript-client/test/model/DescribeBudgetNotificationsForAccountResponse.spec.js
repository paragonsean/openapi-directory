...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetNotificationsForAccountResponse();
  });
  ...
  describe('DescribeBudgetNotificationsForAccountResponse', function() {
    it('should create an instance of DescribeBudgetNotificationsForAccountResponse', function() {
      // uncomment below and update the code to test DescribeBudgetNotificationsForAccountResponse
      //var instance = new AwsBudgets.DescribeBudgetNotificationsForAccountResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetNotificationsForAccountResponse);
    });

    it('should have the property budgetNotificationsForAccount (base name: "BudgetNotificationsForAccount")', function() {
      // uncomment below and update the code to test the property budgetNotificationsForAccount
      //var instance = new AwsBudgets.DescribeBudgetNotificationsForAccountResponse();
