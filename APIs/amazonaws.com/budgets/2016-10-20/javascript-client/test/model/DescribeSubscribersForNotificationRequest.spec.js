...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeSubscribersForNotificationRequest();
  });
  ...
  describe('DescribeSubscribersForNotificationRequest', function() {
    it('should create an instance of DescribeSubscribersForNotificationRequest', function() {
      // uncomment below and update the code to test DescribeSubscribersForNotificationRequest
      //var instance = new AwsBudgets.DescribeSubscribersForNotificationRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeSubscribersForNotificationRequest);
    });
