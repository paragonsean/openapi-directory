...
(function(root, factory) {
  ...
  describe('ApprovalModel', function() {
    it('should create an instance of ApprovalModel', function() {
      // uncomment below and update the code to test ApprovalModel
      //var instance = new AwsBudgets.ApprovalModel();
      //expect(instance).to.be.a(AwsBudgets.ApprovalModel);
    });
