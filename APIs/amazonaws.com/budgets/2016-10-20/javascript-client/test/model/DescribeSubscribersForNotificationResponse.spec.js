...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeSubscribersForNotificationResponse();
  });
  ...
  describe('DescribeSubscribersForNotificationResponse', function() {
    it('should create an instance of DescribeSubscribersForNotificationResponse', function() {
      // uncomment below and update the code to test DescribeSubscribersForNotificationResponse
      //var instance = new AwsBudgets.DescribeSubscribersForNotificationResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeSubscribersForNotificationResponse);
    });
