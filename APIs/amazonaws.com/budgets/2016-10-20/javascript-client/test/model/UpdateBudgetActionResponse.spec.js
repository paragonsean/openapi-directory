...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateBudgetActionResponse();
  });
  ...
  describe('UpdateBudgetActionResponse', function() {
    it('should create an instance of UpdateBudgetActionResponse', function() {
      // uncomment below and update the code to test UpdateBudgetActionResponse
      //var instance = new AwsBudgets.UpdateBudgetActionResponse();
      //expect(instance).to.be.a(AwsBudgets.UpdateBudgetActionResponse);
    });
    ...
    it('should have the property oldAction (base name: "OldAction")', function() {
      // uncomment below and update the code to test the property oldAction
      //var instance = new AwsBudgets.UpdateBudgetActionResponse();
      //expect(instance).to.be();
    });

    it('should have the property newAction (base name: "NewAction")', function() {
      // uncomment below and update the code to test the property newAction
      //var instance = new AwsBudgets.UpdateBudgetActionResponse();
      //expect(instance).to.be();
    });
