...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.HistoricalOptions();
  });
  ...
  describe('HistoricalOptions', function() {
    it('should create an instance of HistoricalOptions', function() {
      // uncomment below and update the code to test HistoricalOptions
      //var instance = new AwsBudgets.HistoricalOptions();
      //expect(instance).to.be.a(AwsBudgets.HistoricalOptions);
    });
