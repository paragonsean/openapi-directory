...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
  });
  ...
  describe('UpdateBudgetRequestNewBudget', function() {
    it('should create an instance of UpdateBudgetRequestNewBudget', function() {
      // uncomment below and update the code to test UpdateBudgetRequestNewBudget
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be.a(AwsBudgets.UpdateBudgetRequestNewBudget);
    });

    it('should have the property budgetName (base name: "BudgetName")', function() {
      // uncomment below and update the code to test the property budgetName
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be();
    });

    it('should have the property budgetLimit (base name: "BudgetLimit")', function() {
      // uncomment below and update the code to test the property budgetLimit
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be();
    });

    it('should have the property plannedBudgetLimits (base name: "PlannedBudgetLimits")', function() {
      // uncomment below and update the code to test the property plannedBudgetLimits
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be();
    });

    it('should have the property costFilters (base name: "CostFilters")', function() {
      // uncomment below and update the code to test the property costFilters
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be();
    });

    it('should have the property costTypes (base name: "CostTypes")', function() {
      // uncomment below and update the code to test the property costTypes
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be();
    });
    ...
    it('should have the property calculatedSpend (base name: "CalculatedSpend")', function() {
      // uncomment below and update the code to test the property calculatedSpend
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be();
    });

    it('should have the property budgetType (base name: "BudgetType")', function() {
    ...
    it('should have the property autoAdjustData (base name: "AutoAdjustData")', function() {
      // uncomment below and update the code to test the property autoAdjustData
      //var instance = new AwsBudgets.UpdateBudgetRequestNewBudget();
      //expect(instance).to.be();
    });
