...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ActionHistoryDetailsAction();
  });
  ...
  describe('ActionHistoryDetailsAction', function() {
    it('should create an instance of ActionHistoryDetailsAction', function() {
      // uncomment below and update the code to test ActionHistoryDetailsAction
      //var instance = new AwsBudgets.ActionHistoryDetailsAction();
      //expect(instance).to.be.a(AwsBudgets.ActionHistoryDetailsAction);
    });
