...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.AutoAdjustDataHistoricalOptions();
  });
  ...
  describe('AutoAdjustDataHistoricalOptions', function() {
    it('should create an instance of AutoAdjustDataHistoricalOptions', function() {
      // uncomment below and update the code to test AutoAdjustDataHistoricalOptions
      //var instance = new AwsBudgets.AutoAdjustDataHistoricalOptions();
      //expect(instance).to.be.a(AwsBudgets.AutoAdjustDataHistoricalOptions);
    });

    it('should have the property budgetAdjustmentPeriod (base name: "BudgetAdjustmentPeriod")', function() {
      // uncomment below and update the code to test the property budgetAdjustmentPeriod
      //var instance = new AwsBudgets.AutoAdjustDataHistoricalOptions();
      //expect(instance).to.be();
    });

    it('should have the property lookBackAvailablePeriods (base name: "LookBackAvailablePeriods")', function() {
      // uncomment below and update the code to test the property lookBackAvailablePeriods
      //var instance = new AwsBudgets.AutoAdjustDataHistoricalOptions();
      //expect(instance).to.be();
    });
