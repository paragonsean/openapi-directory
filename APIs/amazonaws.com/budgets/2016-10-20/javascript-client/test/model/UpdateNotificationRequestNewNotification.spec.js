...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateNotificationRequestNewNotification();
  });
  ...
  describe('UpdateNotificationRequestNewNotification', function() {
    it('should create an instance of UpdateNotificationRequestNewNotification', function() {
      // uncomment below and update the code to test UpdateNotificationRequestNewNotification
      //var instance = new AwsBudgets.UpdateNotificationRequestNewNotification();
      //expect(instance).to.be.a(AwsBudgets.UpdateNotificationRequestNewNotification);
    });
    ...
    it('should have the property thresholdType (base name: "ThresholdType")', function() {
      // uncomment below and update the code to test the property thresholdType
      //var instance = new AwsBudgets.UpdateNotificationRequestNewNotification();
      //expect(instance).to.be();
    });

    it('should have the property notificationState (base name: "NotificationState")', function() {
      // uncomment below and update the code to test the property notificationState
      //var instance = new AwsBudgets.UpdateNotificationRequestNewNotification();
      //expect(instance).to.be();
    });
