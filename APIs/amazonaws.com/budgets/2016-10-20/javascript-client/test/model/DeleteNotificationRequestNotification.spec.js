...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteNotificationRequestNotification();
  });
  ...
  describe('DeleteNotificationRequestNotification', function() {
    it('should create an instance of DeleteNotificationRequestNotification', function() {
      // uncomment below and update the code to test DeleteNotificationRequestNotification
      //var instance = new AwsBudgets.DeleteNotificationRequestNotification();
      //expect(instance).to.be.a(AwsBudgets.DeleteNotificationRequestNotification);
    });
