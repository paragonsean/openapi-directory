...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CalculatedSpendForecastedSpend();
  });
  ...
  describe('CalculatedSpendForecastedSpend', function() {
    it('should create an instance of CalculatedSpendForecastedSpend', function() {
      // uncomment below and update the code to test CalculatedSpendForecastedSpend
      //var instance = new AwsBudgets.CalculatedSpendForecastedSpend();
      //expect(instance).to.be.a(AwsBudgets.CalculatedSpendForecastedSpend);
    });
