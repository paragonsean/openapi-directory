...
(function(root, factory) {
  ...
  describe('ThresholdType', function() {
    it('should create an instance of ThresholdType', function() {
      // uncomment below and update the code to test ThresholdType
      //var instance = new AwsBudgets.ThresholdType();
      //expect(instance).to.be.a(AwsBudgets.ThresholdType);
    });
