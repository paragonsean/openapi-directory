...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ActionDefinition();
  });
  ...
  describe('ActionDefinition', function() {
    it('should create an instance of ActionDefinition', function() {
      // uncomment below and update the code to test ActionDefinition
      //var instance = new AwsBudgets.ActionDefinition();
      //expect(instance).to.be.a(AwsBudgets.ActionDefinition);
    });

    it('should have the property iamActionDefinition (base name: "IamActionDefinition")', function() {
      // uncomment below and update the code to test the property iamActionDefinition
      //var instance = new AwsBudgets.ActionDefinition();
      //expect(instance).to.be();
    });

    it('should have the property scpActionDefinition (base name: "ScpActionDefinition")', function() {
      // uncomment below and update the code to test the property scpActionDefinition
      //var instance = new AwsBudgets.ActionDefinition();
      //expect(instance).to.be();
    });

    it('should have the property ssmActionDefinition (base name: "SsmActionDefinition")', function() {
      // uncomment below and update the code to test the property ssmActionDefinition
      //var instance = new AwsBudgets.ActionDefinition();
      //expect(instance).to.be();
    });
