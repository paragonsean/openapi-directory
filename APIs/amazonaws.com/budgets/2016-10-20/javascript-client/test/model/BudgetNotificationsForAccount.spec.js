...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetNotificationsForAccount();
  });
  ...
  describe('BudgetNotificationsForAccount', function() {
    it('should create an instance of BudgetNotificationsForAccount', function() {
      // uncomment below and update the code to test BudgetNotificationsForAccount
      //var instance = new AwsBudgets.BudgetNotificationsForAccount();
      //expect(instance).to.be.a(AwsBudgets.BudgetNotificationsForAccount);
    });
