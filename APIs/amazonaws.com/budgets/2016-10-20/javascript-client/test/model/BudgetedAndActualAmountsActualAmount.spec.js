...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetedAndActualAmountsActualAmount();
  });
  ...
  describe('BudgetedAndActualAmountsActualAmount', function() {
    it('should create an instance of BudgetedAndActualAmountsActualAmount', function() {
      // uncomment below and update the code to test BudgetedAndActualAmountsActualAmount
      //var instance = new AwsBudgets.BudgetedAndActualAmountsActualAmount();
      //expect(instance).to.be.a(AwsBudgets.BudgetedAndActualAmountsActualAmount);
    });
