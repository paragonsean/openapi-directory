...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DefinitionSsmActionDefinition();
  });
  ...
  describe('DefinitionSsmActionDefinition', function() {
    it('should create an instance of DefinitionSsmActionDefinition', function() {
      // uncomment below and update the code to test DefinitionSsmActionDefinition
      //var instance = new AwsBudgets.DefinitionSsmActionDefinition();
      //expect(instance).to.be.a(AwsBudgets.DefinitionSsmActionDefinition);
    });

    it('should have the property actionSubType (base name: "ActionSubType")', function() {
      // uncomment below and update the code to test the property actionSubType
      //var instance = new AwsBudgets.DefinitionSsmActionDefinition();
