...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.SsmActionDefinition();
  });
  ...
  describe('SsmActionDefinition', function() {
    it('should create an instance of SsmActionDefinition', function() {
      // uncomment below and update the code to test SsmActionDefinition
      //var instance = new AwsBudgets.SsmActionDefinition();
      //expect(instance).to.be.a(AwsBudgets.SsmActionDefinition);
    });
