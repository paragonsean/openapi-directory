...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetRequest();
  });
  ...
  describe('DescribeBudgetRequest', function() {
    it('should create an instance of DescribeBudgetRequest', function() {
      // uncomment below and update the code to test DescribeBudgetRequest
      //var instance = new AwsBudgets.DescribeBudgetRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetRequest);
    });
