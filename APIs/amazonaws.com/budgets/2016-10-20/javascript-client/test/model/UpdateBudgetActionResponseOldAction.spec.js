...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateBudgetActionResponseOldAction();
  });
  ...
  describe('UpdateBudgetActionResponseOldAction', function() {
    it('should create an instance of UpdateBudgetActionResponseOldAction', function() {
      // uncomment below and update the code to test UpdateBudgetActionResponseOldAction
      //var instance = new AwsBudgets.UpdateBudgetActionResponseOldAction();
      //expect(instance).to.be.a(AwsBudgets.UpdateBudgetActionResponseOldAction);
    });
