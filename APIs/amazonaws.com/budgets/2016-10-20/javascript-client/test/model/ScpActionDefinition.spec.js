...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ScpActionDefinition();
  });
  ...
  describe('ScpActionDefinition', function() {
    it('should create an instance of ScpActionDefinition', function() {
      // uncomment below and update the code to test ScpActionDefinition
      //var instance = new AwsBudgets.ScpActionDefinition();
      //expect(instance).to.be.a(AwsBudgets.ScpActionDefinition);
    });
