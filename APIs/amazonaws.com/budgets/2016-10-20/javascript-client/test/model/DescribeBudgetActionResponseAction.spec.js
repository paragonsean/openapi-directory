...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionResponseAction();
  });
  ...
  describe('DescribeBudgetActionResponseAction', function() {
    it('should create an instance of DescribeBudgetActionResponseAction', function() {
      // uncomment below and update the code to test DescribeBudgetActionResponseAction
      //var instance = new AwsBudgets.DescribeBudgetActionResponseAction();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionResponseAction);
    });
