...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.BudgetBudgetLimit();
  });
  ...
  describe('BudgetBudgetLimit', function() {
    it('should create an instance of BudgetBudgetLimit', function() {
      // uncomment below and update the code to test BudgetBudgetLimit
      //var instance = new AwsBudgets.BudgetBudgetLimit();
      //expect(instance).to.be.a(AwsBudgets.BudgetBudgetLimit);
    });
