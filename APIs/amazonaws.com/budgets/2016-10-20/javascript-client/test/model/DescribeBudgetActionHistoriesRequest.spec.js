...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionHistoriesRequest();
  });
  ...
  describe('DescribeBudgetActionHistoriesRequest', function() {
    it('should create an instance of DescribeBudgetActionHistoriesRequest', function() {
      // uncomment below and update the code to test DescribeBudgetActionHistoriesRequest
      //var instance = new AwsBudgets.DescribeBudgetActionHistoriesRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionHistoriesRequest);
    });
