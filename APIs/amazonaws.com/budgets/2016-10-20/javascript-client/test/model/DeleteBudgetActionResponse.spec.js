...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteBudgetActionResponse();
  });
  ...
  describe('DeleteBudgetActionResponse', function() {
    it('should create an instance of DeleteBudgetActionResponse', function() {
      // uncomment below and update the code to test DeleteBudgetActionResponse
      //var instance = new AwsBudgets.DeleteBudgetActionResponse();
      //expect(instance).to.be.a(AwsBudgets.DeleteBudgetActionResponse);
    });
