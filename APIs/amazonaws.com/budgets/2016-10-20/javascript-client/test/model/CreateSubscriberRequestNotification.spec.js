...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateSubscriberRequestNotification();
  });
  ...
  describe('CreateSubscriberRequestNotification', function() {
    it('should create an instance of CreateSubscriberRequestNotification', function() {
      // uncomment below and update the code to test CreateSubscriberRequestNotification
      //var instance = new AwsBudgets.CreateSubscriberRequestNotification();
      //expect(instance).to.be.a(AwsBudgets.CreateSubscriberRequestNotification);
    });
