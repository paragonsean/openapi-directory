...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateNotificationRequestOldNotification();
  });
  ...
  describe('UpdateNotificationRequestOldNotification', function() {
    it('should create an instance of UpdateNotificationRequestOldNotification', function() {
      // uncomment below and update the code to test UpdateNotificationRequestOldNotification
      //var instance = new AwsBudgets.UpdateNotificationRequestOldNotification();
      //expect(instance).to.be.a(AwsBudgets.UpdateNotificationRequestOldNotification);
    });
