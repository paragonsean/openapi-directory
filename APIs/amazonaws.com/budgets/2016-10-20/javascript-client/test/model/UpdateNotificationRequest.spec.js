...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateNotificationRequest();
  });
  ...
  describe('UpdateNotificationRequest', function() {
    it('should create an instance of UpdateNotificationRequest', function() {
      // uncomment below and update the code to test UpdateNotificationRequest
      //var instance = new AwsBudgets.UpdateNotificationRequest();
      //expect(instance).to.be.a(AwsBudgets.UpdateNotificationRequest);
    });
    ...
    it('should have the property oldNotification (base name: "OldNotification")', function() {
      // uncomment below and update the code to test the property oldNotification
      //var instance = new AwsBudgets.UpdateNotificationRequest();
      //expect(instance).to.be();
    });

    it('should have the property newNotification (base name: "NewNotification")', function() {
      // uncomment below and update the code to test the property newNotification
      //var instance = new AwsBudgets.UpdateNotificationRequest();
      //expect(instance).to.be();
    });
