...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionHistoriesResponse();
  });
  ...
  describe('DescribeBudgetActionHistoriesResponse', function() {
    it('should create an instance of DescribeBudgetActionHistoriesResponse', function() {
      // uncomment below and update the code to test DescribeBudgetActionHistoriesResponse
      //var instance = new AwsBudgets.DescribeBudgetActionHistoriesResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionHistoriesResponse);
    });

    it('should have the property actionHistories (base name: "ActionHistories")', function() {
      // uncomment below and update the code to test the property actionHistories
      //var instance = new AwsBudgets.DescribeBudgetActionHistoriesResponse();
