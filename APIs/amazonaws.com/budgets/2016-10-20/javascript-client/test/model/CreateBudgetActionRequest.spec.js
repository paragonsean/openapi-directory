...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateBudgetActionRequest();
  });
  ...
  describe('CreateBudgetActionRequest', function() {
    it('should create an instance of CreateBudgetActionRequest', function() {
      // uncomment below and update the code to test CreateBudgetActionRequest
      //var instance = new AwsBudgets.CreateBudgetActionRequest();
      //expect(instance).to.be.a(AwsBudgets.CreateBudgetActionRequest);
    });
