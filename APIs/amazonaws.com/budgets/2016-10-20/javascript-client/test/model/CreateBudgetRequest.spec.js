...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateBudgetRequest();
  });
  ...
  describe('CreateBudgetRequest', function() {
    it('should create an instance of CreateBudgetRequest', function() {
      // uncomment below and update the code to test CreateBudgetRequest
      //var instance = new AwsBudgets.CreateBudgetRequest();
      //expect(instance).to.be.a(AwsBudgets.CreateBudgetRequest);
    });
    ...
    it('should have the property notificationsWithSubscribers (base name: "NotificationsWithSubscribers")', function() {
      // uncomment below and update the code to test the property notificationsWithSubscribers
      //var instance = new AwsBudgets.CreateBudgetRequest();
      //expect(instance).to.be();
    });
