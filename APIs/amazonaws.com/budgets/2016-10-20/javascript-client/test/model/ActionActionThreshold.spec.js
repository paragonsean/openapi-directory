...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ActionActionThreshold();
  });
  ...
  describe('ActionActionThreshold', function() {
    it('should create an instance of ActionActionThreshold', function() {
      // uncomment below and update the code to test ActionActionThreshold
      //var instance = new AwsBudgets.ActionActionThreshold();
      //expect(instance).to.be.a(AwsBudgets.ActionActionThreshold);
    });
