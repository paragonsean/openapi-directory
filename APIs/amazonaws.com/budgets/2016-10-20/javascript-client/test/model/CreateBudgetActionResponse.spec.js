...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateBudgetActionResponse();
  });
  ...
  describe('CreateBudgetActionResponse', function() {
    it('should create an instance of CreateBudgetActionResponse', function() {
      // uncomment below and update the code to test CreateBudgetActionResponse
      //var instance = new AwsBudgets.CreateBudgetActionResponse();
      //expect(instance).to.be.a(AwsBudgets.CreateBudgetActionResponse);
    });
