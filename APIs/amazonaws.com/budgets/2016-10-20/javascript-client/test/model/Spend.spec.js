...
(function(root, factory) {
  ...
  describe('Spend', function() {
    it('should create an instance of Spend', function() {
      // uncomment below and update the code to test Spend
      //var instance = new AwsBudgets.Spend();
      //expect(instance).to.be.a(AwsBudgets.Spend);
    });
