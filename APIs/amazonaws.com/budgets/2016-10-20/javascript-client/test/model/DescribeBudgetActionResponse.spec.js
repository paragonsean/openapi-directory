...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetActionResponse();
  });
  ...
  describe('DescribeBudgetActionResponse', function() {
    it('should create an instance of DescribeBudgetActionResponse', function() {
      // uncomment below and update the code to test DescribeBudgetActionResponse
      //var instance = new AwsBudgets.DescribeBudgetActionResponse();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetActionResponse);
    });
