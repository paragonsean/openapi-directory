...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ActionHistory();
  });
  ...
  describe('ActionHistory', function() {
    it('should create an instance of ActionHistory', function() {
      // uncomment below and update the code to test ActionHistory
      //var instance = new AwsBudgets.ActionHistory();
      //expect(instance).to.be.a(AwsBudgets.ActionHistory);
    });
    ...
    it('should have the property actionHistoryDetails (base name: "ActionHistoryDetails")', function() {
      // uncomment below and update the code to test the property actionHistoryDetails
      //var instance = new AwsBudgets.ActionHistory();
      //expect(instance).to.be();
    });
