...
(function(root, factory) {
  ...
  describe('ActionSubType', function() {
    it('should create an instance of ActionSubType', function() {
      // uncomment below and update the code to test ActionSubType
      //var instance = new AwsBudgets.ActionSubType();
      //expect(instance).to.be.a(AwsBudgets.ActionSubType);
    });
