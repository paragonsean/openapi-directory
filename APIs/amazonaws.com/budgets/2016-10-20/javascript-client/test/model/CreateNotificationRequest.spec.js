...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateNotificationRequest();
  });
  ...
  describe('CreateNotificationRequest', function() {
    it('should create an instance of CreateNotificationRequest', function() {
      ...
      //var instance = new AwsBudgets.CreateNotificationRequest();
      //expect(instance).to.be.a(AwsBudgets.CreateNotificationRequest);
    });
