...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.CreateSubscriberRequestSubscriber();
  });
  ...
  describe('CreateSubscriberRequestSubscriber', function() {
    it('should create an instance of CreateSubscriberRequestSubscriber', function() {
      // uncomment below and update the code to test CreateSubscriberRequestSubscriber
      //var instance = new AwsBudgets.CreateSubscriberRequestSubscriber();
      //expect(instance).to.be.a(AwsBudgets.CreateSubscriberRequestSubscriber);
    });
