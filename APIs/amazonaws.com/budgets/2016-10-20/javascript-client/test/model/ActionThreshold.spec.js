...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.ActionThreshold();
  });
  ...
  describe('ActionThreshold', function() {
    it('should create an instance of ActionThreshold', function() {
      // uncomment below and update the code to test ActionThreshold
      //var instance = new AwsBudgets.ActionThreshold();
      //expect(instance).to.be.a(AwsBudgets.ActionThreshold);
    });

    it('should have the property actionThresholdValue (base name: "ActionThresholdValue")', function() {
      // uncomment below and update the code to test the property actionThresholdValue
      //var instance = new AwsBudgets.ActionThreshold();
      //expect(instance).to.be();
    });

    it('should have the property actionThresholdType (base name: "ActionThresholdType")', function() {
      // uncomment below and update the code to test the property actionThresholdType
      //var instance = new AwsBudgets.ActionThreshold();
      //expect(instance).to.be();
    });
