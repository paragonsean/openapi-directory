...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteNotificationRequest();
  });
  ...
  describe('DeleteNotificationRequest', function() {
    it('should create an instance of DeleteNotificationRequest', function() {
      // uncomment below and update the code to test DeleteNotificationRequest
      //var instance = new AwsBudgets.DeleteNotificationRequest();
      //expect(instance).to.be.a(AwsBudgets.DeleteNotificationRequest);
    });
