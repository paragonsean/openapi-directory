...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetNotificationsForAccountRequest();
  });
  ...
  describe('DescribeBudgetNotificationsForAccountRequest', function() {
    it('should create an instance of DescribeBudgetNotificationsForAccountRequest', function() {
      // uncomment below and update the code to test DescribeBudgetNotificationsForAccountRequest
      //var instance = new AwsBudgets.DescribeBudgetNotificationsForAccountRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetNotificationsForAccountRequest);
    });
