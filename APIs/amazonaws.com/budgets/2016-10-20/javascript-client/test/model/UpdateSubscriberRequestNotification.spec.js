...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.UpdateSubscriberRequestNotification();
  });
  ...
  describe('UpdateSubscriberRequestNotification', function() {
    it('should create an instance of UpdateSubscriberRequestNotification', function() {
      // uncomment below and update the code to test UpdateSubscriberRequestNotification
      //var instance = new AwsBudgets.UpdateSubscriberRequestNotification();
      //expect(instance).to.be.a(AwsBudgets.UpdateSubscriberRequestNotification);
    });
