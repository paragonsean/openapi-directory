...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DescribeBudgetPerformanceHistoryRequest();
  });
  ...
  describe('DescribeBudgetPerformanceHistoryRequest', function() {
    it('should create an instance of DescribeBudgetPerformanceHistoryRequest', function() {
      // uncomment below and update the code to test DescribeBudgetPerformanceHistoryRequest
      //var instance = new AwsBudgets.DescribeBudgetPerformanceHistoryRequest();
      //expect(instance).to.be.a(AwsBudgets.DescribeBudgetPerformanceHistoryRequest);
    });
