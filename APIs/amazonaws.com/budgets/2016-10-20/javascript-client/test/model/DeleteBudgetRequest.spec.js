...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsBudgets.DeleteBudgetRequest();
  });
  ...
  describe('DeleteBudgetRequest', function() {
    it('should create an instance of DeleteBudgetRequest', function() {
      // uncomment below and update the code to test DeleteBudgetRequest
      //var instance = new AwsBudgets.DeleteBudgetRequest();
      //expect(instance).to.be.a(AwsBudgets.DeleteBudgetRequest);
    });
