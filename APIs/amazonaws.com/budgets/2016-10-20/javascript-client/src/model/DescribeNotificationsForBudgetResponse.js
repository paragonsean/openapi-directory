...
/**
 * The DescribeNotificationsForBudgetResponse model module.
 * @module model/DescribeNotificationsForBudgetResponse
 * @version 2016-10-20
 */
class DescribeNotificationsForBudgetResponse {
    /**
     * Constructs a new <code>DescribeNotificationsForBudgetResponse</code>.
     *  Response of GetNotificationsForBudget 
     * @alias module:model/DescribeNotificationsForBudgetResponse
     */
    constructor() { 
        
        DescribeNotificationsForBudgetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeNotificationsForBudgetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeNotificationsForBudgetResponse} obj Optional instance to populate.
     * @return {module:model/DescribeNotificationsForBudgetResponse} The populated <code>DescribeNotificationsForBudgetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeNotificationsForBudgetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeNotificationsForBudgetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeNotificationsForBudgetResponse</code>.
     */
 ...
 */
DescribeNotificationsForBudgetResponse.prototype['Notifications'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeNotificationsForBudgetResponse.prototype['NextToken'] = undefined;
...
export default DescribeNotificationsForBudgetResponse;
