...
/**
 * The CreateSubscriberRequestSubscriber model module.
 * @module model/CreateSubscriberRequestSubscriber
 * @version 2016-10-20
 */
class CreateSubscriberRequestSubscriber {
    /**
     * Constructs a new <code>CreateSubscriberRequestSubscriber</code>.
     * @alias module:model/CreateSubscriberRequestSubscriber
    ...
    constructor(subscriptionType, address) { 
        ...
        CreateSubscriberRequestSubscriber.initialize(this, subscriptionType, address);
    }
    ...
    /**
     * Constructs a <code>CreateSubscriberRequestSubscriber</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSubscriberRequestSubscriber} obj Optional instance to populate.
     * @return {module:model/CreateSubscriberRequestSubscriber} The populated <code>CreateSubscriberRequestSubscriber</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSubscriberRequestSubscriber();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSubscriberRequestSubscriber</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSubscriberRequestSubscriber</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSubscriberRequestSubscriber.RequiredProperties) {
...
CreateSubscriberRequestSubscriber.RequiredProperties = ["SubscriptionType", "Address"];

/**
 * @member {module:model/SubscriptionType} SubscriptionType
 */
CreateSubscriberRequestSubscriber.prototype['SubscriptionType'] = undefined;

/**
 * @member {String} Address
 */
CreateSubscriberRequestSubscriber.prototype['Address'] = undefined;
...
export default CreateSubscriberRequestSubscriber;
