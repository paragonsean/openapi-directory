...
/**
 * The DescribeBudgetActionHistoriesRequest model module.
 * @module model/DescribeBudgetActionHistoriesRequest
 * @version 2016-10-20
 */
class DescribeBudgetActionHistoriesRequest {
    /**
     * Constructs a new <code>DescribeBudgetActionHistoriesRequest</code>.
     * @alias module:model/DescribeBudgetActionHistoriesRequest
    ...
    constructor(accountId, budgetName, actionId) { 
        ...
        DescribeBudgetActionHistoriesRequest.initialize(this, accountId, budgetName, actionId);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetActionHistoriesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetActionHistoriesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetActionHistoriesRequest} The populated <code>DescribeBudgetActionHistoriesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetActionHistoriesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetActionHistoriesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetActionHistoriesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetActionHistoriesRequest.RequiredProperties) {
        ...
        if (data['TimePeriod']) { // data not null
          TimePeriod.validateJSON(data['TimePeriod']);
        }
        // ensure the json data is a string
...
DescribeBudgetActionHistoriesRequest.RequiredProperties = ["AccountId", "BudgetName", "ActionId"];

/**
 * The account ID of the user. It's a 12-digit number.
 * @member {String} AccountId
 */
DescribeBudgetActionHistoriesRequest.prototype['AccountId'] = undefined;

/**
 *  A string that represents the budget name. The \":\" and \"\\\" characters, and the \"/action/\" substring, aren't allowed.
 * @member {String} BudgetName
 */
DescribeBudgetActionHistoriesRequest.prototype['BudgetName'] = undefined;

/**
 * @member {String} ActionId
 */
DescribeBudgetActionHistoriesRequest.prototype['ActionId'] = undefined;

/**
 * @member {module:model/TimePeriod} TimePeriod
 */
DescribeBudgetActionHistoriesRequest.prototype['TimePeriod'] = undefined;

/**
 *  An integer that represents how many entries a paginated response contains. The maximum is 100.
 * @member {Number} MaxResults
 */
DescribeBudgetActionHistoriesRequest.prototype['MaxResults'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetActionHistoriesRequest.prototype['NextToken'] = undefined;
...
export default DescribeBudgetActionHistoriesRequest;
