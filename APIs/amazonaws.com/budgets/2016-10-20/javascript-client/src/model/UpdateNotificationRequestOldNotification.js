...
/**
 * The UpdateNotificationRequestOldNotification model module.
 * @module model/UpdateNotificationRequestOldNotification
 * @version 2016-10-20
 */
class UpdateNotificationRequestOldNotification {
    /**
     * Constructs a new <code>UpdateNotificationRequestOldNotification</code>.
     * @alias module:model/UpdateNotificationRequestOldNotification
    ...
    constructor(notificationType, comparisonOperator, threshold) { 
        ...
        UpdateNotificationRequestOldNotification.initialize(this, notificationType, comparisonOperator, threshold);
    }
    ...
    /**
     * Constructs a <code>UpdateNotificationRequestOldNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNotificationRequestOldNotification} obj Optional instance to populate.
     * @return {module:model/UpdateNotificationRequestOldNotification} The populated <code>UpdateNotificationRequestOldNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNotificationRequestOldNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNotificationRequestOldNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNotificationRequestOldNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateNotificationRequestOldNotification.RequiredProperties) {
...
UpdateNotificationRequestOldNotification.RequiredProperties = ["NotificationType", "ComparisonOperator", "Threshold"];

/**
 * @member {module:model/NotificationType} NotificationType
 */
UpdateNotificationRequestOldNotification.prototype['NotificationType'] = undefined;

/**
 * @member {module:model/ComparisonOperator} ComparisonOperator
 */
UpdateNotificationRequestOldNotification.prototype['ComparisonOperator'] = undefined;

/**
 * @member {Number} Threshold
 */
UpdateNotificationRequestOldNotification.prototype['Threshold'] = undefined;

/**
 * @member {module:model/ThresholdType} ThresholdType
 */
UpdateNotificationRequestOldNotification.prototype['ThresholdType'] = undefined;

/**
 * @member {module:model/NotificationState} NotificationState
 */
UpdateNotificationRequestOldNotification.prototype['NotificationState'] = undefined;
...
export default UpdateNotificationRequestOldNotification;
