...
/**
 * The DeleteSubscriberRequestNotification model module.
 * @module model/DeleteSubscriberRequestNotification
 * @version 2016-10-20
 */
class DeleteSubscriberRequestNotification {
    /**
     * Constructs a new <code>DeleteSubscriberRequestNotification</code>.
     * @alias module:model/DeleteSubscriberRequestNotification
    ...
    constructor(notificationType, comparisonOperator, threshold) { 
        ...
        DeleteSubscriberRequestNotification.initialize(this, notificationType, comparisonOperator, threshold);
    }
    ...
    /**
     * Constructs a <code>DeleteSubscriberRequestNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteSubscriberRequestNotification} obj Optional instance to populate.
     * @return {module:model/DeleteSubscriberRequestNotification} The populated <code>DeleteSubscriberRequestNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSubscriberRequestNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSubscriberRequestNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSubscriberRequestNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteSubscriberRequestNotification.RequiredProperties) {
...
DeleteSubscriberRequestNotification.RequiredProperties = ["NotificationType", "ComparisonOperator", "Threshold"];

/**
 * @member {module:model/NotificationType} NotificationType
 */
DeleteSubscriberRequestNotification.prototype['NotificationType'] = undefined;

/**
 * @member {module:model/ComparisonOperator} ComparisonOperator
 */
DeleteSubscriberRequestNotification.prototype['ComparisonOperator'] = undefined;

/**
 * @member {Number} Threshold
 */
DeleteSubscriberRequestNotification.prototype['Threshold'] = undefined;

/**
 * @member {module:model/ThresholdType} ThresholdType
 */
DeleteSubscriberRequestNotification.prototype['ThresholdType'] = undefined;

/**
 * @member {module:model/NotificationState} NotificationState
 */
DeleteSubscriberRequestNotification.prototype['NotificationState'] = undefined;
...
export default DeleteSubscriberRequestNotification;
