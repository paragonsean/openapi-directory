...
/**
 * The CalculatedSpendForecastedSpend model module.
 * @module model/CalculatedSpendForecastedSpend
 * @version 2016-10-20
 */
class CalculatedSpendForecastedSpend {
    /**
     * Constructs a new <code>CalculatedSpendForecastedSpend</code>.
     * @alias module:model/CalculatedSpendForecastedSpend
    ...
    constructor(amount, unit) { 
        ...
        CalculatedSpendForecastedSpend.initialize(this, amount, unit);
    }
    ...
    /**
     * Constructs a <code>CalculatedSpendForecastedSpend</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CalculatedSpendForecastedSpend} obj Optional instance to populate.
     * @return {module:model/CalculatedSpendForecastedSpend} The populated <code>CalculatedSpendForecastedSpend</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CalculatedSpendForecastedSpend();
    ...
    /**
     * Validates the JSON data with respect to <code>CalculatedSpendForecastedSpend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CalculatedSpendForecastedSpend</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CalculatedSpendForecastedSpend.RequiredProperties) {
...
CalculatedSpendForecastedSpend.RequiredProperties = ["Amount", "Unit"];

/**
 * @member {String} Amount
 */
CalculatedSpendForecastedSpend.prototype['Amount'] = undefined;

/**
 * @member {String} Unit
 */
CalculatedSpendForecastedSpend.prototype['Unit'] = undefined;
...
export default CalculatedSpendForecastedSpend;
