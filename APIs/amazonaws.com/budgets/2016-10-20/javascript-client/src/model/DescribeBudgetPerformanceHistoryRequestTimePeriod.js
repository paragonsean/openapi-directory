...
/**
 * The DescribeBudgetPerformanceHistoryRequestTimePeriod model module.
 * @module model/DescribeBudgetPerformanceHistoryRequestTimePeriod
 * @version 2016-10-20
 */
class DescribeBudgetPerformanceHistoryRequestTimePeriod {
    /**
     * Constructs a new <code>DescribeBudgetPerformanceHistoryRequestTimePeriod</code>.
     * @alias module:model/DescribeBudgetPerformanceHistoryRequestTimePeriod
     * @implements module:model/TimePeriod
     */
    constructor() { 
        TimePeriod.initialize(this);
        DescribeBudgetPerformanceHistoryRequestTimePeriod.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetPerformanceHistoryRequestTimePeriod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetPerformanceHistoryRequestTimePeriod} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetPerformanceHistoryRequestTimePeriod} The populated <code>DescribeBudgetPerformanceHistoryRequestTimePeriod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetPerformanceHistoryRequestTimePeriod();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetPerformanceHistoryRequestTimePeriod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetPerformanceHistoryRequestTimePeriod</code>.
     */
 ...
 * @member {Date} Start
 */
DescribeBudgetPerformanceHistoryRequestTimePeriod.prototype['Start'] = undefined;

/**
 * @member {Date} End
 */
DescribeBudgetPerformanceHistoryRequestTimePeriod.prototype['End'] = undefined;
...
export default DescribeBudgetPerformanceHistoryRequestTimePeriod;
