...
import CreateBudgetRequestBudget from './CreateBudgetRequestBudget';

/**
 * The CreateBudgetRequest model module.
 * @module model/CreateBudgetRequest
 * @version 2016-10-20
 */
class CreateBudgetRequest {
    /**
     * Constructs a new <code>CreateBudgetRequest</code>.
     *  Request of CreateBudget 
     * @alias module:model/CreateBudgetRequest
     * @param accountId {String} 
     * @param budget {module:model/CreateBudgetRequestBudget} 
     */
    constructor(accountId, budget) { 
        
        CreateBudgetRequest.initialize(this, accountId, budget);
    }
     ...
     */
    static initialize(obj, accountId, budget) { 
        obj['AccountId'] = accountId;
        obj['Budget'] = budget;
    }

    /**
     * Constructs a <code>CreateBudgetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBudgetRequest} obj Optional instance to populate.
     * @return {module:model/CreateBudgetRequest} The populated <code>CreateBudgetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBudgetRequest();

            if (data.hasOwnProperty('AccountId')) {
                obj['AccountId'] = ApiClient.convertToType(data['AccountId'], 'String');
            }
            if (data.hasOwnProperty('Budget')) {
                obj['Budget'] = CreateBudgetRequestBudget.constructFromObject(data['Budget']);
            }
            if (data.hasOwnProperty('NotificationsWithSubscribers')) {
                obj['NotificationsWithSubscribers'] = ApiClient.convertToType(data['NotificationsWithSubscribers'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBudgetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBudgetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateBudgetRequest.RequiredProperties) {
        ...
        if (data['Budget']) { // data not null
          CreateBudgetRequestBudget.validateJSON(data['Budget']);
        }
        // validate the optional field `NotificationsWithSubscribers`
        if (data['NotificationsWithSubscribers']) { // data not null
          Array.validateJSON(data['NotificationsWithSubscribers']);
        }
...
CreateBudgetRequest.RequiredProperties = ["AccountId", "Budget"];

/**
 * @member {String} AccountId
 */
CreateBudgetRequest.prototype['AccountId'] = undefined;

/**
 * @member {module:model/CreateBudgetRequestBudget} Budget
 */
CreateBudgetRequest.prototype['Budget'] = undefined;

/**
 * @member {Array} NotificationsWithSubscribers
 */
CreateBudgetRequest.prototype['NotificationsWithSubscribers'] = undefined;
