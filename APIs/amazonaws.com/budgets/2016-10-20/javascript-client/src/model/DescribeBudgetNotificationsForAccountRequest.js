...
/**
 * The DescribeBudgetNotificationsForAccountRequest model module.
 * @module model/DescribeBudgetNotificationsForAccountRequest
 * @version 2016-10-20
 */
class DescribeBudgetNotificationsForAccountRequest {
    /**
     * Constructs a new <code>DescribeBudgetNotificationsForAccountRequest</code>.
     * @alias module:model/DescribeBudgetNotificationsForAccountRequest
     * @param accountId {String} The account ID of the user. It's a 12-digit number.
     */
    constructor(accountId) { 
        
        DescribeBudgetNotificationsForAccountRequest.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetNotificationsForAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetNotificationsForAccountRequest} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetNotificationsForAccountRequest} The populated <code>DescribeBudgetNotificationsForAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetNotificationsForAccountRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetNotificationsForAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetNotificationsForAccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetNotificationsForAccountRequest.RequiredProperties) {
...
DescribeBudgetNotificationsForAccountRequest.RequiredProperties = ["AccountId"];

/**
 * The account ID of the user. It's a 12-digit number.
 * @member {String} AccountId
 */
DescribeBudgetNotificationsForAccountRequest.prototype['AccountId'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribeBudgetNotificationsForAccountRequest.prototype['MaxResults'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetNotificationsForAccountRequest.prototype['NextToken'] = undefined;
...
export default DescribeBudgetNotificationsForAccountRequest;
