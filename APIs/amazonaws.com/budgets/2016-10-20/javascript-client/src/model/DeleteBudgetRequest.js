...
/**
 * The DeleteBudgetRequest model module.
 * @module model/DeleteBudgetRequest
 * @version 2016-10-20
 */
class DeleteBudgetRequest {
    /**
     * Constructs a new <code>DeleteBudgetRequest</code>.
     *  Request of DeleteBudget 
     * @alias module:model/DeleteBudgetRequest
     * @param accountId {String} 
     * @param budgetName {String} 
     */
    constructor(accountId, budgetName) { 
        
        DeleteBudgetRequest.initialize(this, accountId, budgetName);
    }
    ...
    /**
     * Constructs a <code>DeleteBudgetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBudgetRequest} obj Optional instance to populate.
     * @return {module:model/DeleteBudgetRequest} The populated <code>DeleteBudgetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBudgetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBudgetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBudgetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteBudgetRequest.RequiredProperties) {
...
DeleteBudgetRequest.RequiredProperties = ["AccountId", "BudgetName"];

/**
 * @member {String} AccountId
 */
DeleteBudgetRequest.prototype['AccountId'] = undefined;

/**
 * @member {String} BudgetName
 */
DeleteBudgetRequest.prototype['BudgetName'] = undefined;
