...
/**
 * The DeleteBudgetActionRequest model module.
 * @module model/DeleteBudgetActionRequest
 * @version 2016-10-20
 */
class DeleteBudgetActionRequest {
    /**
     * Constructs a new <code>DeleteBudgetActionRequest</code>.
     * @alias module:model/DeleteBudgetActionRequest
    ...
    constructor(accountId, budgetName, actionId) { 
        ...
        DeleteBudgetActionRequest.initialize(this, accountId, budgetName, actionId);
    }
    ...
    /**
     * Constructs a <code>DeleteBudgetActionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBudgetActionRequest} obj Optional instance to populate.
     * @return {module:model/DeleteBudgetActionRequest} The populated <code>DeleteBudgetActionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBudgetActionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBudgetActionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBudgetActionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteBudgetActionRequest.RequiredProperties) {
...
DeleteBudgetActionRequest.RequiredProperties = ["AccountId", "BudgetName", "ActionId"];

/**
 * The account ID of the user. It's a 12-digit number.
 * @member {String} AccountId
 */
DeleteBudgetActionRequest.prototype['AccountId'] = undefined;

/**
 *  A string that represents the budget name. The \":\" and \"\\\" characters, and the \"/action/\" substring, aren't allowed.
 * @member {String} BudgetName
 */
DeleteBudgetActionRequest.prototype['BudgetName'] = undefined;

/**
 * @member {String} ActionId
 */
DeleteBudgetActionRequest.prototype['ActionId'] = undefined;
...
export default DeleteBudgetActionRequest;
