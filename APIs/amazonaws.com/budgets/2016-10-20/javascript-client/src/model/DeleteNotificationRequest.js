...
import DeleteNotificationRequestNotification from './DeleteNotificationRequestNotification';

/**
 * The DeleteNotificationRequest model module.
 * @module model/DeleteNotificationRequest
 * @version 2016-10-20
 */
class DeleteNotificationRequest {
    /**
     * Constructs a new <code>DeleteNotificationRequest</code>.
     *  Request of DeleteNotification 
     * @alias module:model/DeleteNotificationRequest
     * @param accountId {String} 
     * @param budgetName {String} 
     * @param notification {module:model/DeleteNotificationRequestNotification} 
     */
    constructor(accountId, budgetName, notification) { 
        
        DeleteNotificationRequest.initialize(this, accountId, budgetName, notification);
    }
    ...
    /**
     * Constructs a <code>DeleteNotificationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteNotificationRequest} obj Optional instance to populate.
     * @return {module:model/DeleteNotificationRequest} The populated <code>DeleteNotificationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteNotificationRequest();
            ...
            if (data.hasOwnProperty('Notification')) {
                obj['Notification'] = DeleteNotificationRequestNotification.constructFromObject(data['Notification']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteNotificationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteNotificationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteNotificationRequest.RequiredProperties) {
        ...
        if (data['Notification']) { // data not null
          DeleteNotificationRequestNotification.validateJSON(data['Notification']);
        }
...
DeleteNotificationRequest.RequiredProperties = ["AccountId", "BudgetName", "Notification"];

/**
 * @member {String} AccountId
 */
DeleteNotificationRequest.prototype['AccountId'] = undefined;

/**
 * @member {String} BudgetName
 */
DeleteNotificationRequest.prototype['BudgetName'] = undefined;

/**
 * @member {module:model/DeleteNotificationRequestNotification} Notification
 */
DeleteNotificationRequest.prototype['Notification'] = undefined;
...
export default DeleteNotificationRequest;
