...
/**
 * The DescribeBudgetRequest model module.
 * @module model/DescribeBudgetRequest
 * @version 2016-10-20
 */
class DescribeBudgetRequest {
    /**
     * Constructs a new <code>DescribeBudgetRequest</code>.
     *  Request of DescribeBudget 
     * @alias module:model/DescribeBudgetRequest
     * @param accountId {String} 
     * @param budgetName {String} 
     */
    constructor(accountId, budgetName) { 
        
        DescribeBudgetRequest.initialize(this, accountId, budgetName);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetRequest} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetRequest} The populated <code>DescribeBudgetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetRequest.RequiredProperties) {
...
DescribeBudgetRequest.RequiredProperties = ["AccountId", "BudgetName"];

/**
 * @member {String} AccountId
 */
DescribeBudgetRequest.prototype['AccountId'] = undefined;

/**
 * @member {String} BudgetName
 */
DescribeBudgetRequest.prototype['BudgetName'] = undefined;
...
export default DescribeBudgetRequest;
