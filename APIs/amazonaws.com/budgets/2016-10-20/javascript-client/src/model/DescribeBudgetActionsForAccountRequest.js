...
/**
 * The DescribeBudgetActionsForAccountRequest model module.
 * @module model/DescribeBudgetActionsForAccountRequest
 * @version 2016-10-20
 */
class DescribeBudgetActionsForAccountRequest {
    /**
     * Constructs a new <code>DescribeBudgetActionsForAccountRequest</code>.
     * @alias module:model/DescribeBudgetActionsForAccountRequest
     * @param accountId {String} The account ID of the user. It's a 12-digit number.
     */
    constructor(accountId) { 
        
        DescribeBudgetActionsForAccountRequest.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetActionsForAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetActionsForAccountRequest} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetActionsForAccountRequest} The populated <code>DescribeBudgetActionsForAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetActionsForAccountRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetActionsForAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetActionsForAccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetActionsForAccountRequest.RequiredProperties) {
...
DescribeBudgetActionsForAccountRequest.RequiredProperties = ["AccountId"];

/**
 * The account ID of the user. It's a 12-digit number.
 * @member {String} AccountId
 */
DescribeBudgetActionsForAccountRequest.prototype['AccountId'] = undefined;

/**
 *  An integer that represents how many entries a paginated response contains. The maximum is 100.
 * @member {Number} MaxResults
 */
DescribeBudgetActionsForAccountRequest.prototype['MaxResults'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetActionsForAccountRequest.prototype['NextToken'] = undefined;
...
export default DescribeBudgetActionsForAccountRequest;
