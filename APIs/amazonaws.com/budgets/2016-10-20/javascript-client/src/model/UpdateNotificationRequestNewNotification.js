...
/**
 * The UpdateNotificationRequestNewNotification model module.
 * @module model/UpdateNotificationRequestNewNotification
 * @version 2016-10-20
 */
class UpdateNotificationRequestNewNotification {
    /**
     * Constructs a new <code>UpdateNotificationRequestNewNotification</code>.
     * @alias module:model/UpdateNotificationRequestNewNotification
    ...
    constructor(notificationType, comparisonOperator, threshold) { 
        ...
        UpdateNotificationRequestNewNotification.initialize(this, notificationType, comparisonOperator, threshold);
    }
    ...
    /**
     * Constructs a <code>UpdateNotificationRequestNewNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNotificationRequestNewNotification} obj Optional instance to populate.
     * @return {module:model/UpdateNotificationRequestNewNotification} The populated <code>UpdateNotificationRequestNewNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNotificationRequestNewNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNotificationRequestNewNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNotificationRequestNewNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateNotificationRequestNewNotification.RequiredProperties) {
...
UpdateNotificationRequestNewNotification.RequiredProperties = ["NotificationType", "ComparisonOperator", "Threshold"];

/**
 * @member {module:model/NotificationType} NotificationType
 */
UpdateNotificationRequestNewNotification.prototype['NotificationType'] = undefined;

/**
 * @member {module:model/ComparisonOperator} ComparisonOperator
 */
UpdateNotificationRequestNewNotification.prototype['ComparisonOperator'] = undefined;

/**
 * @member {Number} Threshold
 */
UpdateNotificationRequestNewNotification.prototype['Threshold'] = undefined;

/**
 * @member {module:model/ThresholdType} ThresholdType
 */
UpdateNotificationRequestNewNotification.prototype['ThresholdType'] = undefined;

/**
 * @member {module:model/NotificationState} NotificationState
 */
UpdateNotificationRequestNewNotification.prototype['NotificationState'] = undefined;
...
export default UpdateNotificationRequestNewNotification;
