...
/**
 * The DescribeBudgetActionHistoriesResponse model module.
 * @module model/DescribeBudgetActionHistoriesResponse
 * @version 2016-10-20
 */
class DescribeBudgetActionHistoriesResponse {
    /**
     * Constructs a new <code>DescribeBudgetActionHistoriesResponse</code>.
     * @alias module:model/DescribeBudgetActionHistoriesResponse
     * @param actionHistories {Array} 
     */
    constructor(actionHistories) { 
        
        DescribeBudgetActionHistoriesResponse.initialize(this, actionHistories);
    }
     ...
     */
    static initialize(obj, actionHistories) { 
        obj['ActionHistories'] = actionHistories;
    }

    /**
     * Constructs a <code>DescribeBudgetActionHistoriesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetActionHistoriesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetActionHistoriesResponse} The populated <code>DescribeBudgetActionHistoriesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetActionHistoriesResponse();

            if (data.hasOwnProperty('ActionHistories')) {
                obj['ActionHistories'] = ApiClient.convertToType(data['ActionHistories'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetActionHistoriesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetActionHistoriesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetActionHistoriesResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ActionHistories`
        if (data['ActionHistories']) { // data not null
          Array.validateJSON(data['ActionHistories']);
        }
...
DescribeBudgetActionHistoriesResponse.RequiredProperties = ["ActionHistories"];

/**
 * @member {Array} ActionHistories
 */
DescribeBudgetActionHistoriesResponse.prototype['ActionHistories'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetActionHistoriesResponse.prototype['NextToken'] = undefined;
...
export default DescribeBudgetActionHistoriesResponse;
