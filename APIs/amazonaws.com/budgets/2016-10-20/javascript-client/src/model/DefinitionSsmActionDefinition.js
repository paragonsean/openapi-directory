...
/**
 * The DefinitionSsmActionDefinition model module.
 * @module model/DefinitionSsmActionDefinition
 * @version 2016-10-20
 */
class DefinitionSsmActionDefinition {
    /**
     * Constructs a new <code>DefinitionSsmActionDefinition</code>.
     * @alias module:model/DefinitionSsmActionDefinition
     * @implements module:model/SsmActionDefinition
    ...
    constructor(actionSubType, region, instanceIds) { 
        ...
        DefinitionSsmActionDefinition.initialize(this, actionSubType, region, instanceIds);
    }
    ...
    /**
     * Constructs a <code>DefinitionSsmActionDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DefinitionSsmActionDefinition} obj Optional instance to populate.
     * @return {module:model/DefinitionSsmActionDefinition} The populated <code>DefinitionSsmActionDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DefinitionSsmActionDefinition();
            SsmActionDefinition.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DefinitionSsmActionDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DefinitionSsmActionDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DefinitionSsmActionDefinition.RequiredProperties) {
...
DefinitionSsmActionDefinition.RequiredProperties = ["ActionSubType", "Region", "InstanceIds"];

/**
 * @member {module:model/ActionSubType} ActionSubType
 */
DefinitionSsmActionDefinition.prototype['ActionSubType'] = undefined;

/**
 * @member {String} Region
 */
DefinitionSsmActionDefinition.prototype['Region'] = undefined;

/**
 * @member {Array} InstanceIds
 */
DefinitionSsmActionDefinition.prototype['InstanceIds'] = undefined;


// Implement SsmActionDefinition interface:
/**
 * @member {module:model/ActionSubType} ActionSubType
 */
...
export default DefinitionSsmActionDefinition;
