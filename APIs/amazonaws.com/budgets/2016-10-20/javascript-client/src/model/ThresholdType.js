...
* @readonly
*/
export default class ThresholdType {
    ...
    /**
    * Returns a <code>ThresholdType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ThresholdType} The enum <code>ThresholdType</code> value.
    */
