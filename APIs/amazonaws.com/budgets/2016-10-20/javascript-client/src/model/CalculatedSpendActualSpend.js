...
/**
 * The CalculatedSpendActualSpend model module.
 * @module model/CalculatedSpendActualSpend
 * @version 2016-10-20
 */
class CalculatedSpendActualSpend {
    /**
     * Constructs a new <code>CalculatedSpendActualSpend</code>.
     * @alias module:model/CalculatedSpendActualSpend
    ...
    constructor(amount, unit) { 
        ...
        CalculatedSpendActualSpend.initialize(this, amount, unit);
    }
    ...
    /**
     * Constructs a <code>CalculatedSpendActualSpend</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CalculatedSpendActualSpend} obj Optional instance to populate.
     * @return {module:model/CalculatedSpendActualSpend} The populated <code>CalculatedSpendActualSpend</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CalculatedSpendActualSpend();
    ...
    /**
     * Validates the JSON data with respect to <code>CalculatedSpendActualSpend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CalculatedSpendActualSpend</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CalculatedSpendActualSpend.RequiredProperties) {
...
CalculatedSpendActualSpend.RequiredProperties = ["Amount", "Unit"];

/**
 * @member {String} Amount
 */
CalculatedSpendActualSpend.prototype['Amount'] = undefined;

/**
 * @member {String} Unit
 */
CalculatedSpendActualSpend.prototype['Unit'] = undefined;
...
export default CalculatedSpendActualSpend;
