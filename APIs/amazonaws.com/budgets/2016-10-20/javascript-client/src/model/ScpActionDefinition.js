...
/**
 * The ScpActionDefinition model module.
 * @module model/ScpActionDefinition
 * @version 2016-10-20
 */
class ScpActionDefinition {
    /**
     * Constructs a new <code>ScpActionDefinition</code>.
     * The service control policies (SCP) action definition details. 
     * @alias module:model/ScpActionDefinition
     * @param policyId {String} 
     * @param targetIds {Array} 
     */
    constructor(policyId, targetIds) { 
        
        ScpActionDefinition.initialize(this, policyId, targetIds);
    }
     ...
     */
    static initialize(obj, policyId, targetIds) { 
        obj['PolicyId'] = policyId;
        obj['TargetIds'] = targetIds;
    }

    /**
     * Constructs a <code>ScpActionDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScpActionDefinition} obj Optional instance to populate.
     * @return {module:model/ScpActionDefinition} The populated <code>ScpActionDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScpActionDefinition();

            if (data.hasOwnProperty('PolicyId')) {
                obj['PolicyId'] = ApiClient.convertToType(data['PolicyId'], 'String');
            }
            if (data.hasOwnProperty('TargetIds')) {
                obj['TargetIds'] = ApiClient.convertToType(data['TargetIds'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScpActionDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScpActionDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScpActionDefinition.RequiredProperties) {
        ...
        // validate the optional field `TargetIds`
        if (data['TargetIds']) { // data not null
          Array.validateJSON(data['TargetIds']);
        }
...
ScpActionDefinition.RequiredProperties = ["PolicyId", "TargetIds"];

/**
 * @member {String} PolicyId
 */
ScpActionDefinition.prototype['PolicyId'] = undefined;

/**
 * @member {Array} TargetIds
 */
ScpActionDefinition.prototype['TargetIds'] = undefined;
...
export default ScpActionDefinition;
