...
/**
 * The DescribeBudgetActionsForBudgetResponse model module.
 * @module model/DescribeBudgetActionsForBudgetResponse
 * @version 2016-10-20
 */
class DescribeBudgetActionsForBudgetResponse {
    /**
     * Constructs a new <code>DescribeBudgetActionsForBudgetResponse</code>.
     * @alias module:model/DescribeBudgetActionsForBudgetResponse
     * @param actions {Array} 
     */
    constructor(actions) { 
        
        DescribeBudgetActionsForBudgetResponse.initialize(this, actions);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetActionsForBudgetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetActionsForBudgetResponse} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetActionsForBudgetResponse} The populated <code>DescribeBudgetActionsForBudgetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetActionsForBudgetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetActionsForBudgetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetActionsForBudgetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetActionsForBudgetResponse.RequiredProperties) {
...
DescribeBudgetActionsForBudgetResponse.RequiredProperties = ["Actions"];

/**
 * @member {Array} Actions
 */
DescribeBudgetActionsForBudgetResponse.prototype['Actions'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetActionsForBudgetResponse.prototype['NextToken'] = undefined;
...
export default DescribeBudgetActionsForBudgetResponse;
