...
/**
 * The NotificationWithSubscribersNotification model module.
 * @module model/NotificationWithSubscribersNotification
 * @version 2016-10-20
 */
class NotificationWithSubscribersNotification {
    /**
     * Constructs a new <code>NotificationWithSubscribersNotification</code>.
     * @alias module:model/NotificationWithSubscribersNotification
    ...
    constructor(notificationType, comparisonOperator, threshold) { 
        ...
        NotificationWithSubscribersNotification.initialize(this, notificationType, comparisonOperator, threshold);
    }
    ...
    /**
     * Constructs a <code>NotificationWithSubscribersNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotificationWithSubscribersNotification} obj Optional instance to populate.
     * @return {module:model/NotificationWithSubscribersNotification} The populated <code>NotificationWithSubscribersNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotificationWithSubscribersNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>NotificationWithSubscribersNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotificationWithSubscribersNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotificationWithSubscribersNotification.RequiredProperties) {
...
NotificationWithSubscribersNotification.RequiredProperties = ["NotificationType", "ComparisonOperator", "Threshold"];

/**
 * @member {module:model/NotificationType} NotificationType
 */
NotificationWithSubscribersNotification.prototype['NotificationType'] = undefined;

/**
 * @member {module:model/ComparisonOperator} ComparisonOperator
 */
NotificationWithSubscribersNotification.prototype['ComparisonOperator'] = undefined;

/**
 * @member {Number} Threshold
 */
NotificationWithSubscribersNotification.prototype['Threshold'] = undefined;

/**
 * @member {module:model/ThresholdType} ThresholdType
 */
NotificationWithSubscribersNotification.prototype['ThresholdType'] = undefined;

/**
 * @member {module:model/NotificationState} NotificationState
 */
NotificationWithSubscribersNotification.prototype['NotificationState'] = undefined;
...
export default NotificationWithSubscribersNotification;
