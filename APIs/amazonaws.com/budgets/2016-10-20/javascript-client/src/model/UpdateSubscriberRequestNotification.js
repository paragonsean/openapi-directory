...
/**
 * The UpdateSubscriberRequestNotification model module.
 * @module model/UpdateSubscriberRequestNotification
 * @version 2016-10-20
 */
class UpdateSubscriberRequestNotification {
    /**
     * Constructs a new <code>UpdateSubscriberRequestNotification</code>.
     * @alias module:model/UpdateSubscriberRequestNotification
    ...
    constructor(notificationType, comparisonOperator, threshold) { 
        ...
        UpdateSubscriberRequestNotification.initialize(this, notificationType, comparisonOperator, threshold);
    }
    ...
    /**
     * Constructs a <code>UpdateSubscriberRequestNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSubscriberRequestNotification} obj Optional instance to populate.
     * @return {module:model/UpdateSubscriberRequestNotification} The populated <code>UpdateSubscriberRequestNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSubscriberRequestNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSubscriberRequestNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSubscriberRequestNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSubscriberRequestNotification.RequiredProperties) {
...
UpdateSubscriberRequestNotification.RequiredProperties = ["NotificationType", "ComparisonOperator", "Threshold"];

/**
 * @member {module:model/NotificationType} NotificationType
 */
UpdateSubscriberRequestNotification.prototype['NotificationType'] = undefined;

/**
 * @member {module:model/ComparisonOperator} ComparisonOperator
 */
UpdateSubscriberRequestNotification.prototype['ComparisonOperator'] = undefined;

/**
 * @member {Number} Threshold
 */
UpdateSubscriberRequestNotification.prototype['Threshold'] = undefined;

/**
 * @member {module:model/ThresholdType} ThresholdType
 */
UpdateSubscriberRequestNotification.prototype['ThresholdType'] = undefined;

/**
 * @member {module:model/NotificationState} NotificationState
 */
UpdateSubscriberRequestNotification.prototype['NotificationState'] = undefined;
...
export default UpdateSubscriberRequestNotification;
