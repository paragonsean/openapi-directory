...
/**
 * The DescribeBudgetActionRequest model module.
 * @module model/DescribeBudgetActionRequest
 * @version 2016-10-20
 */
class DescribeBudgetActionRequest {
    /**
     * Constructs a new <code>DescribeBudgetActionRequest</code>.
     * @alias module:model/DescribeBudgetActionRequest
    ...
    constructor(accountId, budgetName, actionId) { 
        ...
        DescribeBudgetActionRequest.initialize(this, accountId, budgetName, actionId);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetActionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetActionRequest} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetActionRequest} The populated <code>DescribeBudgetActionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetActionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetActionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetActionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetActionRequest.RequiredProperties) {
...
DescribeBudgetActionRequest.RequiredProperties = ["AccountId", "BudgetName", "ActionId"];

/**
 * The account ID of the user. It's a 12-digit number.
 * @member {String} AccountId
 */
DescribeBudgetActionRequest.prototype['AccountId'] = undefined;

/**
 *  A string that represents the budget name. The \":\" and \"\\\" characters, and the \"/action/\" substring, aren't allowed.
 * @member {String} BudgetName
 */
DescribeBudgetActionRequest.prototype['BudgetName'] = undefined;

/**
 * @member {String} ActionId
 */
DescribeBudgetActionRequest.prototype['ActionId'] = undefined;
...
export default DescribeBudgetActionRequest;
