...
/**
 * The DescribeBudgetActionsForAccountResponse model module.
 * @module model/DescribeBudgetActionsForAccountResponse
 * @version 2016-10-20
 */
class DescribeBudgetActionsForAccountResponse {
    /**
     * Constructs a new <code>DescribeBudgetActionsForAccountResponse</code>.
     * @alias module:model/DescribeBudgetActionsForAccountResponse
     * @param actions {Array} 
     */
    constructor(actions) { 
        
        DescribeBudgetActionsForAccountResponse.initialize(this, actions);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetActionsForAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetActionsForAccountResponse} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetActionsForAccountResponse} The populated <code>DescribeBudgetActionsForAccountResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetActionsForAccountResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetActionsForAccountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetActionsForAccountResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBudgetActionsForAccountResponse.RequiredProperties) {
...
DescribeBudgetActionsForAccountResponse.RequiredProperties = ["Actions"];

/**
 * @member {Array} Actions
 */
DescribeBudgetActionsForAccountResponse.prototype['Actions'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetActionsForAccountResponse.prototype['NextToken'] = undefined;
...
export default DescribeBudgetActionsForAccountResponse;
