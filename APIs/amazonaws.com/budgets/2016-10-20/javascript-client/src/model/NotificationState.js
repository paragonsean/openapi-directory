...
export default class NotificationState {
    ...
    /**
    * Returns a <code>NotificationState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NotificationState} The enum <code>NotificationState</code> value.
    */
