...
/**
 * The DefinitionScpActionDefinition model module.
 * @module model/DefinitionScpActionDefinition
 * @version 2016-10-20
 */
class DefinitionScpActionDefinition {
    /**
     * Constructs a new <code>DefinitionScpActionDefinition</code>.
     * @alias module:model/DefinitionScpActionDefinition
     * @implements module:model/ScpActionDefinition
     * @param policyId {String} 
     * @param targetIds {Array} 
     */
    constructor(policyId, targetIds) { 
        ScpActionDefinition.initialize(this, policyId, targetIds);
        DefinitionScpActionDefinition.initialize(this, policyId, targetIds);
    }
    ...
    /**
     * Constructs a <code>DefinitionScpActionDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DefinitionScpActionDefinition} obj Optional instance to populate.
     * @return {module:model/DefinitionScpActionDefinition} The populated <code>DefinitionScpActionDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DefinitionScpActionDefinition();
            ScpActionDefinition.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DefinitionScpActionDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DefinitionScpActionDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DefinitionScpActionDefinition.RequiredProperties) {
...
DefinitionScpActionDefinition.RequiredProperties = ["PolicyId", "TargetIds"];

/**
 * @member {String} PolicyId
 */
DefinitionScpActionDefinition.prototype['PolicyId'] = undefined;

/**
 * @member {Array} TargetIds
 */
DefinitionScpActionDefinition.prototype['TargetIds'] = undefined;


// Implement ScpActionDefinition interface:
/**
 * @member {String} PolicyId
 */
...
export default DefinitionScpActionDefinition;
