...
export default class BudgetType {
        ...
        /**
         * value: "SAVINGS_PLANS_UTILIZATION"
         * @const
         */
    ...
    /**
    * Returns a <code>BudgetType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BudgetType} The enum <code>BudgetType</code> value.
    */
