...
/**
 * The DescribeNotificationsForBudgetRequest model module.
 * @module model/DescribeNotificationsForBudgetRequest
 * @version 2016-10-20
 */
class DescribeNotificationsForBudgetRequest {
    /**
     * Constructs a new <code>DescribeNotificationsForBudgetRequest</code>.
     *  Request of DescribeNotificationsForBudget 
     * @alias module:model/DescribeNotificationsForBudgetRequest
     * @param accountId {String} 
     * @param budgetName {String} 
     */
    constructor(accountId, budgetName) { 
        
        DescribeNotificationsForBudgetRequest.initialize(this, accountId, budgetName);
    }
    ...
    /**
     * Constructs a <code>DescribeNotificationsForBudgetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeNotificationsForBudgetRequest} obj Optional instance to populate.
     * @return {module:model/DescribeNotificationsForBudgetRequest} The populated <code>DescribeNotificationsForBudgetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeNotificationsForBudgetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeNotificationsForBudgetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeNotificationsForBudgetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeNotificationsForBudgetRequest.RequiredProperties) {
...
DescribeNotificationsForBudgetRequest.RequiredProperties = ["AccountId", "BudgetName"];

/**
 * @member {String} AccountId
 */
DescribeNotificationsForBudgetRequest.prototype['AccountId'] = undefined;

/**
 * @member {String} BudgetName
 */
DescribeNotificationsForBudgetRequest.prototype['BudgetName'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribeNotificationsForBudgetRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeNotificationsForBudgetRequest.prototype['NextToken'] = undefined;
...
export default DescribeNotificationsForBudgetRequest;
