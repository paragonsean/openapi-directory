...
* @readonly
*/
export default class AutoAdjustType {
    ...
    /**
    * Returns a <code>AutoAdjustType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AutoAdjustType} The enum <code>AutoAdjustType</code> value.
    */
