...
/**
 * The CreateSubscriberRequestNotification model module.
 * @module model/CreateSubscriberRequestNotification
 * @version 2016-10-20
 */
class CreateSubscriberRequestNotification {
    /**
     * Constructs a new <code>CreateSubscriberRequestNotification</code>.
     * @alias module:model/CreateSubscriberRequestNotification
    ...
    constructor(notificationType, comparisonOperator, threshold) { 
        ...
        CreateSubscriberRequestNotification.initialize(this, notificationType, comparisonOperator, threshold);
    }
    ...
    /**
     * Constructs a <code>CreateSubscriberRequestNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSubscriberRequestNotification} obj Optional instance to populate.
     * @return {module:model/CreateSubscriberRequestNotification} The populated <code>CreateSubscriberRequestNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSubscriberRequestNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSubscriberRequestNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSubscriberRequestNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSubscriberRequestNotification.RequiredProperties) {
...
CreateSubscriberRequestNotification.RequiredProperties = ["NotificationType", "ComparisonOperator", "Threshold"];

/**
 * @member {module:model/NotificationType} NotificationType
 */
CreateSubscriberRequestNotification.prototype['NotificationType'] = undefined;

/**
 * @member {module:model/ComparisonOperator} ComparisonOperator
 */
CreateSubscriberRequestNotification.prototype['ComparisonOperator'] = undefined;

/**
 * @member {Number} Threshold
 */
CreateSubscriberRequestNotification.prototype['Threshold'] = undefined;

/**
 * @member {module:model/ThresholdType} ThresholdType
 */
CreateSubscriberRequestNotification.prototype['ThresholdType'] = undefined;

/**
 * @member {module:model/NotificationState} NotificationState
 */
CreateSubscriberRequestNotification.prototype['NotificationState'] = undefined;
...
export default CreateSubscriberRequestNotification;
