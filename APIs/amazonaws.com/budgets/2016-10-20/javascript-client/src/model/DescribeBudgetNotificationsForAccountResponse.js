...
/**
 * The DescribeBudgetNotificationsForAccountResponse model module.
 * @module model/DescribeBudgetNotificationsForAccountResponse
 * @version 2016-10-20
 */
class DescribeBudgetNotificationsForAccountResponse {
    /**
     * Constructs a new <code>DescribeBudgetNotificationsForAccountResponse</code>.
     * @alias module:model/DescribeBudgetNotificationsForAccountResponse
     */
    constructor() { 
        
        DescribeBudgetNotificationsForAccountResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetNotificationsForAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetNotificationsForAccountResponse} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetNotificationsForAccountResponse} The populated <code>DescribeBudgetNotificationsForAccountResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetNotificationsForAccountResponse();

            if (data.hasOwnProperty('BudgetNotificationsForAccount')) {
                obj['BudgetNotificationsForAccount'] = ApiClient.convertToType(data['BudgetNotificationsForAccount'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetNotificationsForAccountResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetNotificationsForAccountResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `BudgetNotificationsForAccount`
        if (data['BudgetNotificationsForAccount']) { // data not null
          Array.validateJSON(data['BudgetNotificationsForAccount']);
        }
...
/**
 * @member {Array} BudgetNotificationsForAccount
 */
DescribeBudgetNotificationsForAccountResponse.prototype['BudgetNotificationsForAccount'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetNotificationsForAccountResponse.prototype['NextToken'] = undefined;
...
export default DescribeBudgetNotificationsForAccountResponse;
