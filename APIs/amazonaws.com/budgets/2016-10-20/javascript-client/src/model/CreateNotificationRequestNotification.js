...
/**
 * The CreateNotificationRequestNotification model module.
 * @module model/CreateNotificationRequestNotification
 * @version 2016-10-20
 */
class CreateNotificationRequestNotification {
    /**
     * Constructs a new <code>CreateNotificationRequestNotification</code>.
     * @alias module:model/CreateNotificationRequestNotification
    ...
    constructor(notificationType, comparisonOperator, threshold) { 
        ...
        CreateNotificationRequestNotification.initialize(this, notificationType, comparisonOperator, threshold);
    }
    ...
    /**
     * Constructs a <code>CreateNotificationRequestNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateNotificationRequestNotification} obj Optional instance to populate.
     * @return {module:model/CreateNotificationRequestNotification} The populated <code>CreateNotificationRequestNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateNotificationRequestNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNotificationRequestNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNotificationRequestNotification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateNotificationRequestNotification.RequiredProperties) {
...
CreateNotificationRequestNotification.RequiredProperties = ["NotificationType", "ComparisonOperator", "Threshold"];

/**
 * @member {module:model/NotificationType} NotificationType
 */
CreateNotificationRequestNotification.prototype['NotificationType'] = undefined;

/**
 * @member {module:model/ComparisonOperator} ComparisonOperator
 */
CreateNotificationRequestNotification.prototype['ComparisonOperator'] = undefined;

/**
 * @member {Number} Threshold
 */
CreateNotificationRequestNotification.prototype['Threshold'] = undefined;

/**
 * @member {module:model/ThresholdType} ThresholdType
 */
CreateNotificationRequestNotification.prototype['ThresholdType'] = undefined;

/**
 * @member {module:model/NotificationState} NotificationState
 */
CreateNotificationRequestNotification.prototype['NotificationState'] = undefined;
...
export default CreateNotificationRequestNotification;
