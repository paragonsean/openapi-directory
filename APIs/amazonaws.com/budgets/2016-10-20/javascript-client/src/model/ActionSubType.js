...
* @readonly
*/
export default class ActionSubType {
    
        /**
         * value: "STOP_EC2_INSTANCES"
         * @const
         */
        "EC2_INSTANCES" = "STOP_EC2_INSTANCES";
         ...
         * @const
         */
        "RDS_INSTANCES" = "STOP_RDS_INSTANCES";

    

    /**
    * Returns a <code>ActionSubType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ActionSubType} The enum <code>ActionSubType</code> value.
    */
