...
/**
 * The BudgetBudgetLimit model module.
 * @module model/BudgetBudgetLimit
 * @version 2016-10-20
 */
class BudgetBudgetLimit {
    /**
     * Constructs a new <code>BudgetBudgetLimit</code>.
     * @alias module:model/BudgetBudgetLimit
    ...
    constructor(amount, unit) { 
        ...
        BudgetBudgetLimit.initialize(this, amount, unit);
    }
    ...
    /**
     * Constructs a <code>BudgetBudgetLimit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BudgetBudgetLimit} obj Optional instance to populate.
     * @return {module:model/BudgetBudgetLimit} The populated <code>BudgetBudgetLimit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BudgetBudgetLimit();
    ...
    /**
     * Validates the JSON data with respect to <code>BudgetBudgetLimit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BudgetBudgetLimit</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BudgetBudgetLimit.RequiredProperties) {
...
BudgetBudgetLimit.RequiredProperties = ["Amount", "Unit"];

/**
 * @member {String} Amount
 */
BudgetBudgetLimit.prototype['Amount'] = undefined;

/**
 * @member {String} Unit
 */
BudgetBudgetLimit.prototype['Unit'] = undefined;
...
export default BudgetBudgetLimit;
