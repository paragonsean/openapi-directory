...
/**
 * The DeleteBudgetActionResponse model module.
 * @module model/DeleteBudgetActionResponse
 * @version 2016-10-20
 */
class DeleteBudgetActionResponse {
    /**
     * Constructs a new <code>DeleteBudgetActionResponse</code>.
     * @alias module:model/DeleteBudgetActionResponse
    ...
    constructor(accountId, budgetName, action) { 
        ...
        DeleteBudgetActionResponse.initialize(this, accountId, budgetName, action);
    }
    ...
    /**
     * Constructs a <code>DeleteBudgetActionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBudgetActionResponse} obj Optional instance to populate.
     * @return {module:model/DeleteBudgetActionResponse} The populated <code>DeleteBudgetActionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBudgetActionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBudgetActionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBudgetActionResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteBudgetActionResponse.RequiredProperties) {
...
DeleteBudgetActionResponse.RequiredProperties = ["AccountId", "BudgetName", "Action"];

/**
 * The account ID of the user. It's a 12-digit number.
 * @member {String} AccountId
 */
DeleteBudgetActionResponse.prototype['AccountId'] = undefined;

/**
 *  A string that represents the budget name. The \":\" and \"\\\" characters, and the \"/action/\" substring, aren't allowed.
 * @member {String} BudgetName
 */
DeleteBudgetActionResponse.prototype['BudgetName'] = undefined;

/**
 * @member {module:model/Action} Action
 */
DeleteBudgetActionResponse.prototype['Action'] = undefined;
...
export default DeleteBudgetActionResponse;
