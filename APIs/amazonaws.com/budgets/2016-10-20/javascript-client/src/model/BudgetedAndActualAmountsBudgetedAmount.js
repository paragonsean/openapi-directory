...
/**
 * The BudgetedAndActualAmountsBudgetedAmount model module.
 * @module model/BudgetedAndActualAmountsBudgetedAmount
 * @version 2016-10-20
 */
class BudgetedAndActualAmountsBudgetedAmount {
    /**
     * Constructs a new <code>BudgetedAndActualAmountsBudgetedAmount</code>.
     * @alias module:model/BudgetedAndActualAmountsBudgetedAmount
    ...
    constructor(amount, unit) { 
        ...
        BudgetedAndActualAmountsBudgetedAmount.initialize(this, amount, unit);
    }
    ...
    /**
     * Constructs a <code>BudgetedAndActualAmountsBudgetedAmount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BudgetedAndActualAmountsBudgetedAmount} obj Optional instance to populate.
     * @return {module:model/BudgetedAndActualAmountsBudgetedAmount} The populated <code>BudgetedAndActualAmountsBudgetedAmount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BudgetedAndActualAmountsBudgetedAmount();
    ...
    /**
     * Validates the JSON data with respect to <code>BudgetedAndActualAmountsBudgetedAmount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BudgetedAndActualAmountsBudgetedAmount</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BudgetedAndActualAmountsBudgetedAmount.RequiredProperties) {
...
BudgetedAndActualAmountsBudgetedAmount.RequiredProperties = ["Amount", "Unit"];

/**
 * @member {String} Amount
 */
BudgetedAndActualAmountsBudgetedAmount.prototype['Amount'] = undefined;

/**
 * @member {String} Unit
 */
BudgetedAndActualAmountsBudgetedAmount.prototype['Unit'] = undefined;
...
export default BudgetedAndActualAmountsBudgetedAmount;
