...
import DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory from './DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory';

/**
 * The DescribeBudgetPerformanceHistoryResponse model module.
 * @module model/DescribeBudgetPerformanceHistoryResponse
 * @version 2016-10-20
 */
class DescribeBudgetPerformanceHistoryResponse {
    /**
     * Constructs a new <code>DescribeBudgetPerformanceHistoryResponse</code>.
     * @alias module:model/DescribeBudgetPerformanceHistoryResponse
     */
    constructor() { 
        
        DescribeBudgetPerformanceHistoryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeBudgetPerformanceHistoryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBudgetPerformanceHistoryResponse} obj Optional instance to populate.
     * @return {module:model/DescribeBudgetPerformanceHistoryResponse} The populated <code>DescribeBudgetPerformanceHistoryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBudgetPerformanceHistoryResponse();

            if (data.hasOwnProperty('BudgetPerformanceHistory')) {
                obj['BudgetPerformanceHistory'] = DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory.constructFromObject(data['BudgetPerformanceHistory']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBudgetPerformanceHistoryResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBudgetPerformanceHistoryResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `BudgetPerformanceHistory`
        if (data['BudgetPerformanceHistory']) { // data not null
          DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory.validateJSON(data['BudgetPerformanceHistory']);
        }
...
/**
 * @member {module:model/DescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory} BudgetPerformanceHistory
 */
DescribeBudgetPerformanceHistoryResponse.prototype['BudgetPerformanceHistory'] = undefined;

/**
 *  A generic string.
 * @member {String} NextToken
 */
DescribeBudgetPerformanceHistoryResponse.prototype['NextToken'] = undefined;
...
export default DescribeBudgetPerformanceHistoryResponse;
