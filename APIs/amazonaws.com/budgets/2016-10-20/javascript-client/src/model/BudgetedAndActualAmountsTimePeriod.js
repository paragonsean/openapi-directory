...
/**
 * The BudgetedAndActualAmountsTimePeriod model module.
 * @module model/BudgetedAndActualAmountsTimePeriod
 * @version 2016-10-20
 */
class BudgetedAndActualAmountsTimePeriod {
    /**
     * Constructs a new <code>BudgetedAndActualAmountsTimePeriod</code>.
     * @alias module:model/BudgetedAndActualAmountsTimePeriod
     * @implements module:model/TimePeriod
     */
    constructor() { 
        TimePeriod.initialize(this);
        BudgetedAndActualAmountsTimePeriod.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BudgetedAndActualAmountsTimePeriod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BudgetedAndActualAmountsTimePeriod} obj Optional instance to populate.
     * @return {module:model/BudgetedAndActualAmountsTimePeriod} The populated <code>BudgetedAndActualAmountsTimePeriod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BudgetedAndActualAmountsTimePeriod();
            TimePeriod.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>BudgetedAndActualAmountsTimePeriod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BudgetedAndActualAmountsTimePeriod</code>.
     */
 ...
 * @member {Date} Start
 */
BudgetedAndActualAmountsTimePeriod.prototype['Start'] = undefined;

/**
 * @member {Date} End
 */
BudgetedAndActualAmountsTimePeriod.prototype['End'] = undefined;


// Implement TimePeriod interface:
/**
 * @member {Date} Start
 */
...
export default BudgetedAndActualAmountsTimePeriod;
