...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManagerUserSubscriptions.DisassociateUserRequest();
  });
  ...
  describe('DisassociateUserRequest', function() {
    it('should create an instance of DisassociateUserRequest', function() {
      // uncomment below and update the code to test DisassociateUserRequest
      //var instance = new AwsLicenseManagerUserSubscriptions.DisassociateUserRequest();
      //expect(instance).to.be.a(AwsLicenseManagerUserSubscriptions.DisassociateUserRequest);
    });
