...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManagerUserSubscriptions.Settings();
  });
  ...
  describe('Settings', function() {
    it('should create an instance of Settings', function() {
      ...
      //var instance = new AwsLicenseManagerUserSubscriptions.Settings();
      //expect(instance).to.be.a(AwsLicenseManagerUserSubscriptions.Settings);
    });
