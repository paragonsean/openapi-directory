...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManagerUserSubscriptions.IdentityProviderSummary();
  });
  ...
  describe('IdentityProviderSummary', function() {
    it('should create an instance of IdentityProviderSummary', function() {
      // uncomment below and update the code to test IdentityProviderSummary
      //var instance = new AwsLicenseManagerUserSubscriptions.IdentityProviderSummary();
      //expect(instance).to.be.a(AwsLicenseManagerUserSubscriptions.IdentityProviderSummary);
    });
