...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManagerUserSubscriptions.AssociateUserRequest();
  });
  ...
  describe('AssociateUserRequest', function() {
    it('should create an instance of AssociateUserRequest', function() {
      // uncomment below and update the code to test AssociateUserRequest
      //var instance = new AwsLicenseManagerUserSubscriptions.AssociateUserRequest();
      //expect(instance).to.be.a(AwsLicenseManagerUserSubscriptions.AssociateUserRequest);
    });
