...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManagerUserSubscriptions.ListInstancesRequest();
  });
  ...
  describe('ListInstancesRequest', function() {
    it('should create an instance of ListInstancesRequest', function() {
      // uncomment below and update the code to test ListInstancesRequest
      //var instance = new AwsLicenseManagerUserSubscriptions.ListInstancesRequest();
      //expect(instance).to.be.a(AwsLicenseManagerUserSubscriptions.ListInstancesRequest);
    });
