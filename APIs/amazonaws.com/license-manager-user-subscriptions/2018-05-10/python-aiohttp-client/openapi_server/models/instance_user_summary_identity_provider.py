...
class InstanceUserSummaryIdentityProvider(Model):
    ...
    def __init__(self, active_directory_identity_provider: AssociateUserRequestIdentityProviderActiveDirectoryIdentityProvider=None):
        """InstanceUserSummaryIdentityProvider - a model defined in OpenAPI

        :param active_directory_identity_provider: The active_directory_identity_provider of this InstanceUserSummaryIdentityProvider.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InstanceUserSummaryIdentityProvider':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The InstanceUserSummary_IdentityProvider of this InstanceUserSummaryIdentityProvider.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def active_directory_identity_provider(self):
        """Gets the active_directory_identity_provider of this InstanceUserSummaryIdentityProvider.


        :return: The active_directory_identity_provider of this InstanceUserSummaryIdentityProvider.
    ...
    def active_directory_identity_provider(self, active_directory_identity_provider):
        """Sets the active_directory_identity_provider of this InstanceUserSummaryIdentityProvider.
