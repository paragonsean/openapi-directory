...
class IdentityProvider(Model):
    ...
    def __init__(self, active_directory_identity_provider: AssociateUserRequestIdentityProviderActiveDirectoryIdentityProvider=None):
        ...
        :param active_directory_identity_provider: The active_directory_identity_provider of this IdentityProvider.
        """
        self.openapi_types = {
    ...
    def active_directory_identity_provider(self):
        """Gets the active_directory_identity_provider of this IdentityProvider.


        :return: The active_directory_identity_provider of this IdentityProvider.
    ...
    def active_directory_identity_provider(self, active_directory_identity_provider):
        """Sets the active_directory_identity_provider of this IdentityProvider.
