...
/*
 * OAIStopProductSubscriptionRequest.h
 *
 * 
 */

#ifndef OAIStopProductSubscriptionRequest_H
#define OAIStopProductSubscriptionRequest_H
...
class OAIStopProductSubscriptionRequest : public OAIObject {
public:
    OAIStopProductSubscriptionRequest();
    OAIStopProductSubscriptionRequest(QString json);
    ~OAIStopProductSubscriptionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopProductSubscriptionRequest)

#endif // OAIStopProductSubscriptionRequest_H
