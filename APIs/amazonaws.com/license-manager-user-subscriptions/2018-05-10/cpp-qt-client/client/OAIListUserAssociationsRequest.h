...
/*
 * OAIListUserAssociationsRequest.h
 *
 * 
 */

#ifndef OAIListUserAssociationsRequest_H
#define OAIListUserAssociationsRequest_H
...
class OAIListUserAssociationsRequest : public OAIObject {
public:
    OAIListUserAssociationsRequest();
    OAIListUserAssociationsRequest(QString json);
    ~OAIListUserAssociationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserAssociationsRequest)

#endif // OAIListUserAssociationsRequest_H
