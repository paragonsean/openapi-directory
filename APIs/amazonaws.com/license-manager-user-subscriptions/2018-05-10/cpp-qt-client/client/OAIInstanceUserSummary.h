...
/*
 * OAIInstanceUserSummary.h
 *
 * Describes users of an EC2 instance providing user-based subscriptions.
 */

#ifndef OAIInstanceUserSummary_H
#define OAIInstanceUserSummary_H
...
class OAIInstanceUserSummary : public OAIObject {
public:
    OAIInstanceUserSummary();
    OAIInstanceUserSummary(QString json);
    ~OAIInstanceUserSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceUserSummary)

#endif // OAIInstanceUserSummary_H
