...
#ifndef OAIUpdateSettings_H
#define OAIUpdateSettings_H
...
class OAIUpdateSettings : public OAIObject {
public:
    OAIUpdateSettings();
    OAIUpdateSettings(QString json);
    ~OAIUpdateSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSettings)

#endif // OAIUpdateSettings_H
