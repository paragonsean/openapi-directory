...
/*
 * OAIStopProductSubscription_request.h
 *
 * 
 */

#ifndef OAIStopProductSubscription_request_H
#define OAIStopProductSubscription_request_H
...
class OAIStopProductSubscription_request : public OAIObject {
public:
    OAIStopProductSubscription_request();
    OAIStopProductSubscription_request(QString json);
    ~OAIStopProductSubscription_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopProductSubscription_request)

#endif // OAIStopProductSubscription_request_H
