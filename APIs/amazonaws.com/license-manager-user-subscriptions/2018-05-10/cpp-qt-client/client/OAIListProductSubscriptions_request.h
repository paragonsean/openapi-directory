...
/*
 * OAIListProductSubscriptions_request.h
 *
 * 
 */

#ifndef OAIListProductSubscriptions_request_H
#define OAIListProductSubscriptions_request_H
...
class OAIListProductSubscriptions_request : public OAIObject {
public:
    OAIListProductSubscriptions_request();
    OAIListProductSubscriptions_request(QString json);
    ~OAIListProductSubscriptions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListProductSubscriptions_request)

#endif // OAIListProductSubscriptions_request_H
