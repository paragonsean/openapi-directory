...
/*
 * OAIDescribeListenersInput.h
 *
 * 
 */

#ifndef OAIDescribeListenersInput_H
#define OAIDescribeListenersInput_H
...
class OAIDescribeListenersInput : public OAIObject {
public:
    OAIDescribeListenersInput();
    OAIDescribeListenersInput(QString json);
    ~OAIDescribeListenersInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeListenersInput)

#endif // OAIDescribeListenersInput_H
