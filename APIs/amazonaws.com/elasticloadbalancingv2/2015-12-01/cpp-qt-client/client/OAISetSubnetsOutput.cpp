...
OAISetSubnetsOutput::OAISetSubnetsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetSubnetsOutput::OAISetSubnetsOutput() {
    this->initializeModel();
}

OAISetSubnetsOutput::~OAISetSubnetsOutput() {}

void OAISetSubnetsOutput::initializeModel() {
...
void OAISetSubnetsOutput::fromJson(QString jsonString) {
...
void OAISetSubnetsOutput::fromJsonObject(QJsonObject json) {
...
QString OAISetSubnetsOutput::asJson() const {
...
QJsonObject OAISetSubnetsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAISetSubnetsOutput::getAvailabilityZones() const {
    return m_availability_zones;
}
void OAISetSubnetsOutput::setAvailabilityZones(const QList &availability_zones) {
    m_availability_zones = availability_zones;
    m_availability_zones_isSet = true;
}

bool OAISetSubnetsOutput::is_availability_zones_Set() const{
    return m_availability_zones_isSet;
}

bool OAISetSubnetsOutput::is_availability_zones_Valid() const{
    return m_availability_zones_isValid;
}

OAIIpAddressType OAISetSubnetsOutput::getIpAddressType() const {
    return m_ip_address_type;
}
void OAISetSubnetsOutput::setIpAddressType(const OAIIpAddressType &ip_address_type) {
    m_ip_address_type = ip_address_type;
    m_ip_address_type_isSet = true;
}

bool OAISetSubnetsOutput::is_ip_address_type_Set() const{
    return m_ip_address_type_isSet;
}

bool OAISetSubnetsOutput::is_ip_address_type_Valid() const{
    return m_ip_address_type_isValid;
}

bool OAISetSubnetsOutput::isSet() const {
...
bool OAISetSubnetsOutput::isValid() const {
