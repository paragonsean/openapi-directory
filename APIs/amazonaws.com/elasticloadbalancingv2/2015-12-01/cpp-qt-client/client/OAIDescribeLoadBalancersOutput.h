...
/*
 * OAIDescribeLoadBalancersOutput.h
 *
 * 
 */

#ifndef OAIDescribeLoadBalancersOutput_H
#define OAIDescribeLoadBalancersOutput_H
...
class OAIDescribeLoadBalancersOutput : public OAIObject {
public:
    OAIDescribeLoadBalancersOutput();
    OAIDescribeLoadBalancersOutput(QString json);
    ~OAIDescribeLoadBalancersOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLoadBalancersOutput)

#endif // OAIDescribeLoadBalancersOutput_H
