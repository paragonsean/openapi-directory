...
/*
 * OAIAuthenticateCognitoActionConfig.h
 *
 * Request parameters to use when integrating with Amazon Cognito to authenticate users.
 */

#ifndef OAIAuthenticateCognitoActionConfig_H
#define OAIAuthenticateCognitoActionConfig_H
...
class OAIAuthenticateCognitoActionConfig : public OAIObject {
public:
    OAIAuthenticateCognitoActionConfig();
    OAIAuthenticateCognitoActionConfig(QString json);
    ~OAIAuthenticateCognitoActionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthenticateCognitoActionConfig)

#endif // OAIAuthenticateCognitoActionConfig_H
