...
/*
 * OAISetSubnetsInput.h
 *
 * 
 */

#ifndef OAISetSubnetsInput_H
#define OAISetSubnetsInput_H
...
class OAISetSubnetsInput : public OAIObject {
public:
    OAISetSubnetsInput();
    OAISetSubnetsInput(QString json);
    ~OAISetSubnetsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetSubnetsInput)

#endif // OAISetSubnetsInput_H
