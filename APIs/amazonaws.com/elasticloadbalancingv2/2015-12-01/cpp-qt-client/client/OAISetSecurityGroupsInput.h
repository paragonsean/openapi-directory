...
/*
 * OAISetSecurityGroupsInput.h
 *
 * 
 */

#ifndef OAISetSecurityGroupsInput_H
#define OAISetSecurityGroupsInput_H
...
class OAISetSecurityGroupsInput : public OAIObject {
public:
    OAISetSecurityGroupsInput();
    OAISetSecurityGroupsInput(QString json);
    ~OAISetSecurityGroupsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetSecurityGroupsInput)

#endif // OAISetSecurityGroupsInput_H
