...
/*
 * OAIDescribeTargetGroupsInput.h
 *
 * 
 */

#ifndef OAIDescribeTargetGroupsInput_H
#define OAIDescribeTargetGroupsInput_H
...
class OAIDescribeTargetGroupsInput : public OAIObject {
public:
    OAIDescribeTargetGroupsInput();
    OAIDescribeTargetGroupsInput(QString json);
    ~OAIDescribeTargetGroupsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTargetGroupsInput)

#endif // OAIDescribeTargetGroupsInput_H
