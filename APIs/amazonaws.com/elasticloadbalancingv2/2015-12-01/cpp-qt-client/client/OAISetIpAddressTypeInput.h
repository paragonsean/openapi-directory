...
/*
 * OAISetIpAddressTypeInput.h
 *
 * 
 */

#ifndef OAISetIpAddressTypeInput_H
#define OAISetIpAddressTypeInput_H
...
class OAISetIpAddressTypeInput : public OAIObject {
public:
    OAISetIpAddressTypeInput();
    OAISetIpAddressTypeInput(QString json);
    ~OAISetIpAddressTypeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetIpAddressTypeInput)

#endif // OAISetIpAddressTypeInput_H
