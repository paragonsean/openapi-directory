...
/*
 * OAIDescribeListenersOutput.h
 *
 * 
 */

#ifndef OAIDescribeListenersOutput_H
#define OAIDescribeListenersOutput_H
...
class OAIDescribeListenersOutput : public OAIObject {
public:
    OAIDescribeListenersOutput();
    OAIDescribeListenersOutput(QString json);
    ~OAIDescribeListenersOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeListenersOutput)

#endif // OAIDescribeListenersOutput_H
