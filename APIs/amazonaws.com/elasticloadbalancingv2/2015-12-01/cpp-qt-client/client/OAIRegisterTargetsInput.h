...
/*
 * OAIRegisterTargetsInput.h
 *
 * 
 */

#ifndef OAIRegisterTargetsInput_H
#define OAIRegisterTargetsInput_H
...
class OAIRegisterTargetsInput : public OAIObject {
public:
    OAIRegisterTargetsInput();
    OAIRegisterTargetsInput(QString json);
    ~OAIRegisterTargetsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterTargetsInput)

#endif // OAIRegisterTargetsInput_H
