...
#ifndef OAISourceIpConditionConfig_H
#define OAISourceIpConditionConfig_H
...
class OAISourceIpConditionConfig : public OAIObject {
public:
    OAISourceIpConditionConfig();
    OAISourceIpConditionConfig(QString json);
    ~OAISourceIpConditionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceIpConditionConfig)

#endif // OAISourceIpConditionConfig_H
