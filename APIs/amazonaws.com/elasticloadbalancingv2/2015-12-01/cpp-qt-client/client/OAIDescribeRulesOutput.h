...
/*
 * OAIDescribeRulesOutput.h
 *
 * 
 */

#ifndef OAIDescribeRulesOutput_H
#define OAIDescribeRulesOutput_H
...
class OAIDescribeRulesOutput : public OAIObject {
public:
    OAIDescribeRulesOutput();
    OAIDescribeRulesOutput(QString json);
    ~OAIDescribeRulesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRulesOutput)

#endif // OAIDescribeRulesOutput_H
