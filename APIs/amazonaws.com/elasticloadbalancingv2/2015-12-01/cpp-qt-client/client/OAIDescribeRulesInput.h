...
/*
 * OAIDescribeRulesInput.h
 *
 * 
 */

#ifndef OAIDescribeRulesInput_H
#define OAIDescribeRulesInput_H
...
class OAIDescribeRulesInput : public OAIObject {
public:
    OAIDescribeRulesInput();
    OAIDescribeRulesInput(QString json);
    ~OAIDescribeRulesInput() override;
    ...
    QList getRuleArns() const;
    void setRuleArns(const QList &rule_arns);
    bool is_rule_arns_Set() const;
    bool is_rule_arns_Valid() const;
...
private:
    ...
    QList m_rule_arns;
    bool m_rule_arns_isSet;
    bool m_rule_arns_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRulesInput)

#endif // OAIDescribeRulesInput_H
