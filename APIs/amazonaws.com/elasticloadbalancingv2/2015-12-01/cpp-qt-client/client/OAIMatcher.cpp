...
QString OAIMatcher::getGrpcCode() const {
    return m_grpc_code;
}
void OAIMatcher::setGrpcCode(const QString &grpc_code) {
    m_grpc_code = grpc_code;
    m_grpc_code_isSet = true;
}

bool OAIMatcher::is_grpc_code_Set() const{
    return m_grpc_code_isSet;
}

bool OAIMatcher::is_grpc_code_Valid() const{
