...
QString OAIListener::getListenerArn() const {
    return m_listener_arn;
}
void OAIListener::setListenerArn(const QString &listener_arn) {
    m_listener_arn = listener_arn;
    m_listener_arn_isSet = true;
}

bool OAIListener::is_listener_arn_Set() const{
    return m_listener_arn_isSet;
}

bool OAIListener::is_listener_arn_Valid() const{
    return m_listener_arn_isValid;
}

QString OAIListener::getLoadBalancerArn() const {
    return m_load_balancer_arn;
}
void OAIListener::setLoadBalancerArn(const QString &load_balancer_arn) {
    m_load_balancer_arn = load_balancer_arn;
    m_load_balancer_arn_isSet = true;
}

bool OAIListener::is_load_balancer_arn_Set() const{
    return m_load_balancer_arn_isSet;
}

bool OAIListener::is_load_balancer_arn_Valid() const{
...
OAIProtocolEnum OAIListener::getProtocol() const {
    return m_protocol;
}
void OAIListener::setProtocol(const OAIProtocolEnum &protocol) {
    m_protocol = protocol;
...
QList OAIListener::getCertificates() const {
    return m_certificates;
}
void OAIListener::setCertificates(const QList &certificates) {
    m_certificates = certificates;
    m_certificates_isSet = true;
}

bool OAIListener::is_certificates_Set() const{
    return m_certificates_isSet;
}

bool OAIListener::is_certificates_Valid() const{
    return m_certificates_isValid;
}

QString OAIListener::getSslPolicy() const {
    return m_ssl_policy;
}
void OAIListener::setSslPolicy(const QString &ssl_policy) {
    m_ssl_policy = ssl_policy;
    m_ssl_policy_isSet = true;
}

bool OAIListener::is_ssl_policy_Set() const{
    return m_ssl_policy_isSet;
}

bool OAIListener::is_ssl_policy_Valid() const{
    return m_ssl_policy_isValid;
}

QList OAIListener::getDefaultActions() const {
    return m_default_actions;
}
void OAIListener::setDefaultActions(const QList &default_actions) {
    m_default_actions = default_actions;
    m_default_actions_isSet = true;
}

bool OAIListener::is_default_actions_Set() const{
    return m_default_actions_isSet;
}

bool OAIListener::is_default_actions_Valid() const{
    return m_default_actions_isValid;
}

QList OAIListener::getAlpnPolicy() const {
    return m_alpn_policy;
}
void OAIListener::setAlpnPolicy(const QList &alpn_policy) {
    m_alpn_policy = alpn_policy;
    m_alpn_policy_isSet = true;
}

bool OAIListener::is_alpn_policy_Set() const{
    return m_alpn_policy_isSet;
}

bool OAIListener::is_alpn_policy_Valid() const{
