...
/*
 * OAICreateListenerInput.h
 *
 * 
 */

#ifndef OAICreateListenerInput_H
#define OAICreateListenerInput_H
...
class OAICreateListenerInput : public OAIObject {
public:
    OAICreateListenerInput();
    OAICreateListenerInput(QString json);
    ~OAICreateListenerInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateListenerInput)

#endif // OAICreateListenerInput_H
