...
/*
 * OAIDescribeTargetHealthInput.h
 *
 * 
 */

#ifndef OAIDescribeTargetHealthInput_H
#define OAIDescribeTargetHealthInput_H
...
class OAIDescribeTargetHealthInput : public OAIObject {
public:
    OAIDescribeTargetHealthInput();
    OAIDescribeTargetHealthInput(QString json);
    ~OAIDescribeTargetHealthInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTargetHealthInput)

#endif // OAIDescribeTargetHealthInput_H
