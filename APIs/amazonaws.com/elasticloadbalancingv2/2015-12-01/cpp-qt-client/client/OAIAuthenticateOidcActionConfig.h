...
/*
 * OAIAuthenticateOidcActionConfig.h
 *
 * Request parameters when using an identity provider (IdP) that is compliant with OpenID Connect (OIDC) to authenticate users.
 */

#ifndef OAIAuthenticateOidcActionConfig_H
#define OAIAuthenticateOidcActionConfig_H
...
class OAIAuthenticateOidcActionConfig : public OAIObject {
public:
    OAIAuthenticateOidcActionConfig();
    OAIAuthenticateOidcActionConfig(QString json);
    ~OAIAuthenticateOidcActionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthenticateOidcActionConfig)

#endif // OAIAuthenticateOidcActionConfig_H
