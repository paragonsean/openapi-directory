...
/*
 * OAIDescribeListenerCertificatesInput.h
 *
 * 
 */

#ifndef OAIDescribeListenerCertificatesInput_H
#define OAIDescribeListenerCertificatesInput_H
...
class OAIDescribeListenerCertificatesInput : public OAIObject {
public:
    OAIDescribeListenerCertificatesInput();
    OAIDescribeListenerCertificatesInput(QString json);
    ~OAIDescribeListenerCertificatesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeListenerCertificatesInput)

#endif // OAIDescribeListenerCertificatesInput_H
