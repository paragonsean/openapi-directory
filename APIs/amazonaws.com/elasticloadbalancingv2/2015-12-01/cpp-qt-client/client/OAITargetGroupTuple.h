...
/*
 * OAITargetGroupTuple.h
 *
 * Information about how traffic will be distributed between multiple target groups in a forward rule.
 */

#ifndef OAITargetGroupTuple_H
#define OAITargetGroupTuple_H
...
class OAITargetGroupTuple : public OAIObject {
public:
    OAITargetGroupTuple();
    OAITargetGroupTuple(QString json);
    ~OAITargetGroupTuple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetGroupTuple)

#endif // OAITargetGroupTuple_H
