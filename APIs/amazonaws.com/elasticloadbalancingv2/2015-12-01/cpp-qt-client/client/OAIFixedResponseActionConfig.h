...
/*
 * OAIFixedResponseActionConfig.h
 *
 * Information about an action that returns a custom HTTP response.
 */

#ifndef OAIFixedResponseActionConfig_H
#define OAIFixedResponseActionConfig_H
...
class OAIFixedResponseActionConfig : public OAIObject {
public:
    OAIFixedResponseActionConfig();
    OAIFixedResponseActionConfig(QString json);
    ~OAIFixedResponseActionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFixedResponseActionConfig)

#endif // OAIFixedResponseActionConfig_H
