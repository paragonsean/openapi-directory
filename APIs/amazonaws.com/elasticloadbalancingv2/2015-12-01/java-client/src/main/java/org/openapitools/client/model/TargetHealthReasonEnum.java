...
/**
 * Gets or Sets TargetHealthReasonEnum
 */
@JsonAdapter(TargetHealthReasonEnum.Adapter.class)
public enum TargetHealthReasonEnum {
  ...
  TargetHealthReasonEnum(String value) {
    this.value = value;
  }
  ...
  public static TargetHealthReasonEnum fromValue(String value) {
    for (TargetHealthReasonEnum b : TargetHealthReasonEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<TargetHealthReasonEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final TargetHealthReasonEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TargetHealthReasonEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TargetHealthReasonEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TargetHealthReasonEnum.fromValue(value);
  }
}
