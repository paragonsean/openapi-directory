...
async def test_g_et_add_listener_certificates(client):
    """Test case for g_et_add_listener_certificates

    
    """
    params = [('ListenerArn', 'listener_arn_example'),
                    ('Certificates', [openapi_server.Certificate()]),
    ...
    response = await client.request(
        method='GET',
        path='/#Action=AddListenerCertificates',
        headers=headers,
        params=params,
        )
...
async def test_g_et_add_tags(client):
    ...
    """
    params = [('ResourceArns', ['resource_arns_example']),
...
async def test_g_et_create_listener(client):
    """Test case for g_et_create_listener

    
    """
    params = [('LoadBalancerArn', 'load_balancer_arn_example'),
                    ('Protocol', 'protocol_example'),
                    ('Port', 56),
                    ('SslPolicy', 'ssl_policy_example'),
                    ('Certificates', [openapi_server.Certificate()]),
                    ('DefaultActions', [openapi_server.Action()]),
                    ('AlpnPolicy', ['alpn_policy_example']),
                    ('Tags', [openapi_server.Tag()]),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
...
async def test_g_et_create_load_balancer(client):
    ...
    params = [('Name', 'name_example'),
                    ...
                    ('SubnetMappings', [openapi_server.SubnetMapping()]),
                    ('SecurityGroups', ['security_groups_example']),
                    ('Scheme', 'scheme_example'),
                    ('Tags', [openapi_server.Tag()]),
                    ('Type', 'type_example'),
                    ('IpAddressType', 'ip_address_type_example'),
                    ('CustomerOwnedIpv4Pool', 'customer_owned_ipv4_pool_example'),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_g_et_create_rule(client):
    """Test case for g_et_create_rule

    
    """
    params = [('ListenerArn', 'listener_arn_example'),
                    ('Conditions', [openapi_server.RuleCondition()]),
                    ('Priority', 56),
                    ('Actions', [openapi_server.Action()]),
                    ('Tags', [openapi_server.Tag()]),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
...
async def test_g_et_create_target_group(client):
    """Test case for g_et_create_target_group

    
    """
    params = [('Name', 'name_example'),
                    ('Protocol', 'protocol_example'),
                    ('ProtocolVersion', 'protocol_version_example'),
                    ('Port', 56),
                    ('VpcId', 'vpc_id_example'),
                    ('HealthCheckProtocol', 'health_check_protocol_example'),
                    ('HealthCheckPort', 'health_check_port_example'),
                    ('HealthCheckEnabled', True),
                    ('HealthCheckPath', 'health_check_path_example'),
                    ('HealthCheckIntervalSeconds', 56),
                    ('HealthCheckTimeoutSeconds', 56),
                    ('HealthyThresholdCount', 56),
                    ('UnhealthyThresholdCount', 56),
                    ('Matcher', openapi_server.GETCreateTargetGroupMatcherParameter()),
...
async def test_g_et_delete_listener(client):
    """Test case for g_et_delete_listener
...
async def test_g_et_delete_rule(client):
    """Test case for g_et_delete_rule

    
    """
    params = [('RuleArn', 'rule_arn_example'),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_g_et_delete_target_group(client):
    """Test case for g_et_delete_target_group

    
    """
    params = [('TargetGroupArn', 'target_group_arn_example'),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_g_et_deregister_targets(client):
    """Test case for g_et_deregister_targets

    
    """
    params = [('TargetGroupArn', 'target_group_arn_example'),
                    ('Targets', [openapi_server.TargetDescription()]),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_g_et_describe_listener_certificates(client):
    """Test case for g_et_describe_listener_certificates
    ...
    response = await client.request(
        method='GET',
        path='/#Action=DescribeListenerCertificates',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_g_et_describe_listeners(client):
    """Test case for g_et_describe_listeners

    
    """
    params = [('LoadBalancerArn', 'load_balancer_arn_example'),
                    ('ListenerArns', ['listener_arns_example']),
                    ('Marker', 'marker_example'),
                    ('PageSize', 56),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
...
async def test_g_et_describe_load_balancers(client):
    ...
    """
    params = [('LoadBalancerArns', ['load_balancer_arns_example']),
                    ('Names', ['names_example']),
                    ('Marker', 'marker_example'),
                    ('PageSize', 56),
                    ('Action', 'action_example'),
...
async def test_g_et_describe_rules(client):
    """Test case for g_et_describe_rules

    
    """
    params = [('ListenerArn', 'listener_arn_example'),
                    ('RuleArns', ['rule_arns_example']),
                    ('Marker', 'marker_example'),
                    ('PageSize', 56),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
...
async def test_g_et_describe_ssl_policies(client):
    """Test case for g_et_describe_ssl_policies
    ...
    params = [('Names', ['names_example']),
                    ('Marker', 'marker_example'),
                    ('PageSize', 56),
                    ('LoadBalancerType', 'load_balancer_type_example'),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
    ...
    response = await client.request(
        method='GET',
        path='/#Action=DescribeSSLPolicies',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_g_et_describe_target_group_attributes(client):
    """Test case for g_et_describe_target_group_attributes
    ...
    response = await client.request(
        method='GET',
        path='/#Action=DescribeTargetGroupAttributes',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_g_et_describe_target_groups(client):
    """Test case for g_et_describe_target_groups
...
async def test_g_et_describe_target_health(client):
    """Test case for g_et_describe_target_health
...
async def test_g_et_modify_listener(client):
    """Test case for g_et_modify_listener
...
async def test_g_et_modify_load_balancer_attributes(client):
    ...
    """
    params = [('LoadBalancerArn', 'load_balancer_arn_example'),
                    ('Attributes', [openapi_server.LoadBalancerAttribute()]),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_g_et_modify_rule(client):
    """Test case for g_et_modify_rule
...
async def test_g_et_modify_target_group(client):
    """Test case for g_et_modify_target_group
...
async def test_g_et_modify_target_group_attributes(client):
    """Test case for g_et_modify_target_group_attributes

    
    """
    params = [('TargetGroupArn', 'target_group_arn_example'),
                    ('Attributes', [openapi_server.TargetGroupAttribute()]),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
    ...
    response = await client.request(
        method='GET',
        path='/#Action=ModifyTargetGroupAttributes',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_g_et_register_targets(client):
    """Test case for g_et_register_targets
...
async def test_g_et_remove_listener_certificates(client):
    """Test case for g_et_remove_listener_certificates
    ...
    response = await client.request(
        method='GET',
        path='/#Action=RemoveListenerCertificates',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_g_et_set_ip_address_type(client):
    """Test case for g_et_set_ip_address_type
...
async def test_g_et_set_rule_priorities(client):
    """Test case for g_et_set_rule_priorities

    
    """
    params = [('RulePriorities', [openapi_server.RulePriorityPair()]),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_g_et_set_security_groups(client):
    """Test case for g_et_set_security_groups
...
async def test_g_et_set_subnets(client):
    """Test case for g_et_set_subnets
...
async def test_p_ost_add_listener_certificates(client):
    """Test case for p_ost_add_listener_certificates

    
    """
    body = openapi_server.AddListenerCertificatesInput()
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_create_listener(client):
    """Test case for p_ost_create_listener

    
    """
    body = openapi_server.CreateListenerInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_p_ost_create_load_balancer(client):
    ...
    """
    body = openapi_server.CreateLoadBalancerInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_create_rule(client):
    """Test case for p_ost_create_rule

    
    """
    body = openapi_server.CreateRuleInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_create_target_group(client):
    """Test case for p_ost_create_target_group

    
    """
    body = openapi_server.CreateTargetGroupInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_delete_listener(client):
    """Test case for p_ost_delete_listener

    
    """
    body = openapi_server.DeleteListenerInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
async def test_p_ost_delete_load_balancer(client):
    ...
    """
    body = openapi_server.DeleteLoadBalancerInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_delete_rule(client):
    """Test case for p_ost_delete_rule

    
    """
    body = openapi_server.DeleteRuleInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_delete_target_group(client):
    """Test case for p_ost_delete_target_group

    
    """
    body = openapi_server.DeleteTargetGroupInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_deregister_targets(client):
    """Test case for p_ost_deregister_targets

    
    """
    body = openapi_server.DeregisterTargetsInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_describe_listener_certificates(client):
    """Test case for p_ost_describe_listener_certificates

    
    """
    body = openapi_server.DescribeListenerCertificatesInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_describe_listeners(client):
    """Test case for p_ost_describe_listeners

    
    """
    body = openapi_server.DescribeListenersInput()
    params = [('Marker', 'marker_example'),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
...
async def test_p_ost_describe_load_balancers(client):
    ...
    """
    body = openapi_server.DescribeLoadBalancersInput()
    params = [('Marker', 'marker_example'),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_describe_rules(client):
    """Test case for p_ost_describe_rules

    
    """
    body = openapi_server.DescribeRulesInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_describe_ssl_policies(client):
    """Test case for p_ost_describe_ssl_policies

    
    """
    body = openapi_server.DescribeSSLPoliciesInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_describe_target_group_attributes(client):
    """Test case for p_ost_describe_target_group_attributes

    
    """
    body = openapi_server.DescribeTargetGroupAttributesInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_describe_target_groups(client):
    """Test case for p_ost_describe_target_groups

    
    """
    body = openapi_server.DescribeTargetGroupsInput()
    params = [('Marker', 'marker_example'),
                    ('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_describe_target_health(client):
    """Test case for p_ost_describe_target_health

    
    """
    body = openapi_server.DescribeTargetHealthInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_modify_listener(client):
    """Test case for p_ost_modify_listener

    
    """
    body = openapi_server.ModifyListenerInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_modify_rule(client):
    """Test case for p_ost_modify_rule

    
    """
    body = openapi_server.ModifyRuleInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_modify_target_group(client):
    """Test case for p_ost_modify_target_group

    
    """
    body = openapi_server.ModifyTargetGroupInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_modify_target_group_attributes(client):
    """Test case for p_ost_modify_target_group_attributes

    
    """
    body = openapi_server.ModifyTargetGroupAttributesInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_register_targets(client):
    """Test case for p_ost_register_targets

    
    """
    body = openapi_server.RegisterTargetsInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_remove_listener_certificates(client):
    """Test case for p_ost_remove_listener_certificates

    
    """
    body = openapi_server.RemoveListenerCertificatesInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_set_ip_address_type(client):
    """Test case for p_ost_set_ip_address_type

    
    """
    body = openapi_server.SetIpAddressTypeInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_set_rule_priorities(client):
    """Test case for p_ost_set_rule_priorities

    
    """
    body = openapi_server.SetRulePrioritiesInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_set_security_groups(client):
    """Test case for p_ost_set_security_groups

    
    """
    body = openapi_server.SetSecurityGroupsInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_p_ost_set_subnets(client):
    """Test case for p_ost_set_subnets

    
    """
    body = openapi_server.SetSubnetsInput()
    params = [('Action', 'action_example'),
                    ('Version', 'version_example')]
    headers = { 
        'Accept': 'text/xml',
