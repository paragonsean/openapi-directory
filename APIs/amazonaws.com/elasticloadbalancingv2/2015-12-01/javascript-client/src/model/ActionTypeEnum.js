...
* @readonly
*/
export default class ActionTypeEnum {
    ...
    /**
    * Returns a <code>ActionTypeEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ActionTypeEnum} The enum <code>ActionTypeEnum</code> value.
    */
