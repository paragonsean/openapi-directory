...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.TargetGroup();
  });
  ...
  describe('TargetGroup', function() {
    it('should create an instance of TargetGroup', function() {
      // uncomment below and update the code to test TargetGroup
      //var instance = new ElasticLoadBalancing.TargetGroup();
      //expect(instance).to.be.a(ElasticLoadBalancing.TargetGroup);
    });
    ...
    it('should have the property targetGroupName (base name: "TargetGroupName")', function() {
      // uncomment below and update the code to test the property targetGroupName
      //var instance = new ElasticLoadBalancing.TargetGroup();
      //expect(instance).to.be();
    });
