...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.SubnetMapping();
  });
  ...
  describe('SubnetMapping', function() {
    it('should create an instance of SubnetMapping', function() {
      // uncomment below and update the code to test SubnetMapping
      //var instance = new ElasticLoadBalancing.SubnetMapping();
      //expect(instance).to.be.a(ElasticLoadBalancing.SubnetMapping);
    });
