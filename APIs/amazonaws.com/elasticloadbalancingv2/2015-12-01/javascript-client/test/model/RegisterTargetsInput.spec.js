...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.RegisterTargetsInput();
  });
  ...
  describe('RegisterTargetsInput', function() {
    it('should create an instance of RegisterTargetsInput', function() {
      // uncomment below and update the code to test RegisterTargetsInput
      //var instance = new ElasticLoadBalancing.RegisterTargetsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.RegisterTargetsInput);
    });
