...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.AvailabilityZone();
  });
  ...
  describe('AvailabilityZone', function() {
    it('should create an instance of AvailabilityZone', function() {
      ...
      //var instance = new ElasticLoadBalancing.AvailabilityZone();
      //expect(instance).to.be.a(ElasticLoadBalancing.AvailabilityZone);
    });
    ...
    it('should have the property loadBalancerAddresses (base name: "LoadBalancerAddresses")', function() {
      // uncomment below and update the code to test the property loadBalancerAddresses
      //var instance = new ElasticLoadBalancing.AvailabilityZone();
      //expect(instance).to.be();
    });
