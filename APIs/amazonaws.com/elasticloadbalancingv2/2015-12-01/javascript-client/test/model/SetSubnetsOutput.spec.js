...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.SetSubnetsOutput();
  });
  ...
  describe('SetSubnetsOutput', function() {
    it('should create an instance of SetSubnetsOutput', function() {
      // uncomment below and update the code to test SetSubnetsOutput
      //var instance = new ElasticLoadBalancing.SetSubnetsOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.SetSubnetsOutput);
    });
