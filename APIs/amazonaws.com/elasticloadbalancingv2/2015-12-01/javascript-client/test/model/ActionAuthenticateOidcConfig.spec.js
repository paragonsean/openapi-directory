...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ActionAuthenticateOidcConfig();
  });
  ...
  describe('ActionAuthenticateOidcConfig', function() {
    it('should create an instance of ActionAuthenticateOidcConfig', function() {
      // uncomment below and update the code to test ActionAuthenticateOidcConfig
      //var instance = new ElasticLoadBalancing.ActionAuthenticateOidcConfig();
      //expect(instance).to.be.a(ElasticLoadBalancing.ActionAuthenticateOidcConfig);
    });
