...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.Certificate();
  });
  ...
  describe('Certificate', function() {
    it('should create an instance of Certificate', function() {
      ...
      //var instance = new ElasticLoadBalancing.Certificate();
      //expect(instance).to.be.a(ElasticLoadBalancing.Certificate);
    });
