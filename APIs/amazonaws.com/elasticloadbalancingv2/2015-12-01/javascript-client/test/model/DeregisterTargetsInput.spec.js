...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DeregisterTargetsInput();
  });
  ...
  describe('DeregisterTargetsInput', function() {
    it('should create an instance of DeregisterTargetsInput', function() {
      // uncomment below and update the code to test DeregisterTargetsInput
      //var instance = new ElasticLoadBalancing.DeregisterTargetsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DeregisterTargetsInput);
    });
