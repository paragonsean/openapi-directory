...
namespace OpenAPI {
class OAICreateRepositoryRequest_catalogData;
...
public:
    ...
    OAICreateRepositoryRequest_catalogData getCatalogData() const;
    void setCatalogData(const OAICreateRepositoryRequest_catalogData &catalog_data);
...
private:
    ...
    OAICreateRepositoryRequest_catalogData m_catalog_data;
