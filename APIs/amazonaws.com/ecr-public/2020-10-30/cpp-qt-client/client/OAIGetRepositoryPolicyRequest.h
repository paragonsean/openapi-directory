...
/*
 * OAIGetRepositoryPolicyRequest.h
 *
 * 
 */

#ifndef OAIGetRepositoryPolicyRequest_H
#define OAIGetRepositoryPolicyRequest_H
...
class OAIGetRepositoryPolicyRequest : public OAIObject {
public:
    OAIGetRepositoryPolicyRequest();
    OAIGetRepositoryPolicyRequest(QString json);
    ~OAIGetRepositoryPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRepositoryPolicyRequest)

#endif // OAIGetRepositoryPolicyRequest_H
