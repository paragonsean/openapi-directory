...
/*
 * OAIDescribeImagesRequest.h
 *
 * 
 */

#ifndef OAIDescribeImagesRequest_H
#define OAIDescribeImagesRequest_H
...
class OAIDescribeImagesRequest : public OAIObject {
public:
    OAIDescribeImagesRequest();
    OAIDescribeImagesRequest(QString json);
    ~OAIDescribeImagesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImagesRequest)

#endif // OAIDescribeImagesRequest_H
