...
/*
 * OAIPutRepositoryCatalogDataResponse_catalogData.h
 *
 * 
 */

#ifndef OAIPutRepositoryCatalogDataResponse_catalogData_H
#define OAIPutRepositoryCatalogDataResponse_catalogData_H
...
class OAIPutRepositoryCatalogDataResponse_catalogData : public OAIObject {
public:
    OAIPutRepositoryCatalogDataResponse_catalogData();
    OAIPutRepositoryCatalogDataResponse_catalogData(QString json);
    ~OAIPutRepositoryCatalogDataResponse_catalogData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRepositoryCatalogDataResponse_catalogData)

#endif // OAIPutRepositoryCatalogDataResponse_catalogData_H
