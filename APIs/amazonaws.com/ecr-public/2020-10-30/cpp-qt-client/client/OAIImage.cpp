...
QString OAIImage::getRegistryId() const {
    return m_registry_id;
}
void OAIImage::setRegistryId(const QString &registry_id) {
    m_registry_id = registry_id;
    m_registry_id_isSet = true;
}

bool OAIImage::is_registry_id_Set() const{
    return m_registry_id_isSet;
}

bool OAIImage::is_registry_id_Valid() const{
    return m_registry_id_isValid;
}

QString OAIImage::getRepositoryName() const {
    return m_repository_name;
}
void OAIImage::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIImage::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIImage::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

OAIImage_imageId OAIImage::getImageId() const {
    return m_image_id;
}
void OAIImage::setImageId(const OAIImage_imageId &image_id) {
    m_image_id = image_id;
...
QString OAIImage::getImageManifest() const {
    return m_image_manifest;
}
void OAIImage::setImageManifest(const QString &image_manifest) {
    m_image_manifest = image_manifest;
    m_image_manifest_isSet = true;
}

bool OAIImage::is_image_manifest_Set() const{
    return m_image_manifest_isSet;
}

bool OAIImage::is_image_manifest_Valid() const{
    return m_image_manifest_isValid;
}

QString OAIImage::getImageManifestMediaType() const {
    return m_image_manifest_media_type;
}
void OAIImage::setImageManifestMediaType(const QString &image_manifest_media_type) {
    m_image_manifest_media_type = image_manifest_media_type;
    m_image_manifest_media_type_isSet = true;
}

bool OAIImage::is_image_manifest_media_type_Set() const{
    return m_image_manifest_media_type_isSet;
}

bool OAIImage::is_image_manifest_media_type_Valid() const{
