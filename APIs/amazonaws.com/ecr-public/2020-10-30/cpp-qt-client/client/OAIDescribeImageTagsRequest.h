...
/*
 * OAIDescribeImageTagsRequest.h
 *
 * 
 */

#ifndef OAIDescribeImageTagsRequest_H
#define OAIDescribeImageTagsRequest_H
...
class OAIDescribeImageTagsRequest : public OAIObject {
public:
    OAIDescribeImageTagsRequest();
    OAIDescribeImageTagsRequest(QString json);
    ~OAIDescribeImageTagsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImageTagsRequest)

#endif // OAIDescribeImageTagsRequest_H
