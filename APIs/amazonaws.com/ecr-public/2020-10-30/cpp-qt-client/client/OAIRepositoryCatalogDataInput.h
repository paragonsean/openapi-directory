...
class OAIRepositoryCatalogDataInput : public OAIObject {
public:
    OAIRepositoryCatalogDataInput();
    OAIRepositoryCatalogDataInput(QString json);
    ~OAIRepositoryCatalogDataInput() override;
    ...
    QString getLogoImageBlob() const;
    void setLogoImageBlob(const QString &logo_image_blob);
    bool is_logo_image_blob_Set() const;
    bool is_logo_image_blob_Valid() const;
...
private:
    ...
    QString m_logo_image_blob;
    bool m_logo_image_blob_isSet;
    bool m_logo_image_blob_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryCatalogDataInput)

#endif // OAIRepositoryCatalogDataInput_H
