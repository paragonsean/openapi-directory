...
/*
 * OAIGetRepositoryCatalogDataResponse_catalogData.h
 *
 * 
 */

#ifndef OAIGetRepositoryCatalogDataResponse_catalogData_H
#define OAIGetRepositoryCatalogDataResponse_catalogData_H
...
class OAIGetRepositoryCatalogDataResponse_catalogData : public OAIObject {
public:
    OAIGetRepositoryCatalogDataResponse_catalogData();
    OAIGetRepositoryCatalogDataResponse_catalogData(QString json);
    ~OAIGetRepositoryCatalogDataResponse_catalogData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRepositoryCatalogDataResponse_catalogData)

#endif // OAIGetRepositoryCatalogDataResponse_catalogData_H
