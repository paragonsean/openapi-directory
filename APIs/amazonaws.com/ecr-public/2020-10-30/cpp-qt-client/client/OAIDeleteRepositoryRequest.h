...
/*
 * OAIDeleteRepositoryRequest.h
 *
 * 
 */

#ifndef OAIDeleteRepositoryRequest_H
#define OAIDeleteRepositoryRequest_H
...
class OAIDeleteRepositoryRequest : public OAIObject {
public:
    OAIDeleteRepositoryRequest();
    OAIDeleteRepositoryRequest(QString json);
    ~OAIDeleteRepositoryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRepositoryRequest)

#endif // OAIDeleteRepositoryRequest_H
