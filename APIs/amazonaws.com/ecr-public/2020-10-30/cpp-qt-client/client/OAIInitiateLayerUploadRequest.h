...
/*
 * OAIInitiateLayerUploadRequest.h
 *
 * 
 */

#ifndef OAIInitiateLayerUploadRequest_H
#define OAIInitiateLayerUploadRequest_H
...
class OAIInitiateLayerUploadRequest : public OAIObject {
public:
    OAIInitiateLayerUploadRequest();
    OAIInitiateLayerUploadRequest(QString json);
    ~OAIInitiateLayerUploadRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateLayerUploadRequest)

#endif // OAIInitiateLayerUploadRequest_H
