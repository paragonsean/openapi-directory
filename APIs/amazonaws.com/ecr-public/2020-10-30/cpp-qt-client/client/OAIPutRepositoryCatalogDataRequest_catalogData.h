...
/*
 * OAIPutRepositoryCatalogDataRequest_catalogData.h
 *
 * 
 */

#ifndef OAIPutRepositoryCatalogDataRequest_catalogData_H
#define OAIPutRepositoryCatalogDataRequest_catalogData_H
...
class OAIPutRepositoryCatalogDataRequest_catalogData : public OAIObject {
public:
    OAIPutRepositoryCatalogDataRequest_catalogData();
    OAIPutRepositoryCatalogDataRequest_catalogData(QString json);
    ~OAIPutRepositoryCatalogDataRequest_catalogData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRepositoryCatalogDataRequest_catalogData)

#endif // OAIPutRepositoryCatalogDataRequest_catalogData_H
