...
/*
 * OAICreateRepositoryRequest_catalogData.h
 *
 * 
 */

#ifndef OAICreateRepositoryRequest_catalogData_H
#define OAICreateRepositoryRequest_catalogData_H
...
class OAICreateRepositoryRequest_catalogData : public OAIObject {
public:
    OAICreateRepositoryRequest_catalogData();
    OAICreateRepositoryRequest_catalogData(QString json);
    ~OAICreateRepositoryRequest_catalogData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepositoryRequest_catalogData)

#endif // OAICreateRepositoryRequest_catalogData_H
