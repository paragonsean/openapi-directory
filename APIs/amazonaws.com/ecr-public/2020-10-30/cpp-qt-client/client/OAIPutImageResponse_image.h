...
/*
 * OAIPutImageResponse_image.h
 *
 * 
 */

#ifndef OAIPutImageResponse_image_H
#define OAIPutImageResponse_image_H
...
class OAIPutImageResponse_image : public OAIObject {
public:
    OAIPutImageResponse_image();
    OAIPutImageResponse_image(QString json);
    ~OAIPutImageResponse_image() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutImageResponse_image)

#endif // OAIPutImageResponse_image_H
