...
/*
 * OAISetRepositoryPolicyRequest.h
 *
 * 
 */

#ifndef OAISetRepositoryPolicyRequest_H
#define OAISetRepositoryPolicyRequest_H
...
class OAISetRepositoryPolicyRequest : public OAIObject {
public:
    OAISetRepositoryPolicyRequest();
    OAISetRepositoryPolicyRequest(QString json);
    ~OAISetRepositoryPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetRepositoryPolicyRequest)

#endif // OAISetRepositoryPolicyRequest_H
