...
public class ReferencedImageDetail {
  ...
  public ReferencedImageDetail imageDigest(String imageDigest) {
  ...
  public ReferencedImageDetail imageSizeInBytes(Integer imageSizeInBytes) {
  ...
  public ReferencedImageDetail imagePushedAt(OffsetDateTime imagePushedAt) {
  ...
  public ReferencedImageDetail imageManifestMediaType(String imageManifestMediaType) {
  ...
  public ReferencedImageDetail artifactMediaType(String artifactMediaType) {
  ...
  public boolean equals(Object o) {
    ...
    ReferencedImageDetail referencedImageDetail = (ReferencedImageDetail) o;
    return Objects.equals(this.imageDigest, referencedImageDetail.imageDigest) &&
        Objects.equals(this.imageSizeInBytes, referencedImageDetail.imageSizeInBytes) &&
        Objects.equals(this.imagePushedAt, referencedImageDetail.imagePushedAt) &&
        Objects.equals(this.imageManifestMediaType, referencedImageDetail.imageManifestMediaType) &&
        Objects.equals(this.artifactMediaType, referencedImageDetail.artifactMediaType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReferencedImageDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReferencedImageDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReferencedImageDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReferencedImageDetail is not found in the empty JSON string", ReferencedImageDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReferencedImageDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReferencedImageDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReferencedImageDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReferencedImageDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReferencedImageDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReferencedImageDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<ReferencedImageDetail>() {
           @Override
           public void write(JsonWriter out, ReferencedImageDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReferencedImageDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReferencedImageDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReferencedImageDetail
   * @throws IOException if the JSON string is invalid with respect to ReferencedImageDetail
   */
  public static ReferencedImageDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReferencedImageDetail.class);
  }

  /**
   * Convert an instance of ReferencedImageDetail to an JSON string
   *
   * @return JSON string
   */
