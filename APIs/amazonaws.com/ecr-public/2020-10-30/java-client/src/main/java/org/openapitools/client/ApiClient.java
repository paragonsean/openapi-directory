...
public class ApiClient {
    ...
    private String basePath = "http://api.ecr-public.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-10-30/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.ecr-public.us-east-1.amazonaws.com
