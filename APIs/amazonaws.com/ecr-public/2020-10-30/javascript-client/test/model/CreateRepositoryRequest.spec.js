...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.CreateRepositoryRequest();
  });
  ...
  describe('CreateRepositoryRequest', function() {
    it('should create an instance of CreateRepositoryRequest', function() {
      ...
      //var instance = new AmazonElasticContainerRegistryPublic.CreateRepositoryRequest();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.CreateRepositoryRequest);
    });
    ...
    it('should have the property catalogData (base name: "catalogData")', function() {
      // uncomment below and update the code to test the property catalogData
      //var instance = new AmazonElasticContainerRegistryPublic.CreateRepositoryRequest();
      //expect(instance).to.be();
    });
