...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.ImageImageId();
  });
  ...
  describe('ImageImageId', function() {
    it('should create an instance of ImageImageId', function() {
      // uncomment below and update the code to test ImageImageId
      //var instance = new AmazonElasticContainerRegistryPublic.ImageImageId();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.ImageImageId);
    });
