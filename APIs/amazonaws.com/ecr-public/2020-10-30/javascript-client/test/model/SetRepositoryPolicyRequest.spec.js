...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.SetRepositoryPolicyRequest();
  });
  ...
  describe('SetRepositoryPolicyRequest', function() {
    it('should create an instance of SetRepositoryPolicyRequest', function() {
      // uncomment below and update the code to test SetRepositoryPolicyRequest
      //var instance = new AmazonElasticContainerRegistryPublic.SetRepositoryPolicyRequest();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.SetRepositoryPolicyRequest);
    });
