...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.ImageFailure();
  });
  ...
  describe('ImageFailure', function() {
    it('should create an instance of ImageFailure', function() {
      // uncomment below and update the code to test ImageFailure
      //var instance = new AmazonElasticContainerRegistryPublic.ImageFailure();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.ImageFailure);
    });
