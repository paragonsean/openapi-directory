...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.DeleteRepositoryRequest();
  });
  ...
  describe('DeleteRepositoryRequest', function() {
    it('should create an instance of DeleteRepositoryRequest', function() {
      // uncomment below and update the code to test DeleteRepositoryRequest
      //var instance = new AmazonElasticContainerRegistryPublic.DeleteRepositoryRequest();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.DeleteRepositoryRequest);
    });
