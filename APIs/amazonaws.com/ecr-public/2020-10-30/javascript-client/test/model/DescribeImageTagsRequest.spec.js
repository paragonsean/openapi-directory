...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.DescribeImageTagsRequest();
  });
  ...
  describe('DescribeImageTagsRequest', function() {
    it('should create an instance of DescribeImageTagsRequest', function() {
      // uncomment below and update the code to test DescribeImageTagsRequest
      //var instance = new AmazonElasticContainerRegistryPublic.DescribeImageTagsRequest();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.DescribeImageTagsRequest);
    });
