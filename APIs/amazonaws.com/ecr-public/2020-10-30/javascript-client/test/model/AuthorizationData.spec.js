...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.AuthorizationData();
  });
  ...
  describe('AuthorizationData', function() {
    it('should create an instance of AuthorizationData', function() {
      ...
      //var instance = new AmazonElasticContainerRegistryPublic.AuthorizationData();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.AuthorizationData);
    });
