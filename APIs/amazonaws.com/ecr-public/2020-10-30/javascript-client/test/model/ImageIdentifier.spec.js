...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.ImageIdentifier();
  });
  ...
  describe('ImageIdentifier', function() {
    it('should create an instance of ImageIdentifier', function() {
      ...
      //var instance = new AmazonElasticContainerRegistryPublic.ImageIdentifier();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.ImageIdentifier);
    });
