...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AmazonElasticContainerRegistryPublic.Tag();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.Tag);
    });
