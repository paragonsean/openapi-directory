...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticContainerRegistryPublic.ImageFailureImageId();
  });
  ...
  describe('ImageFailureImageId', function() {
    it('should create an instance of ImageFailureImageId', function() {
      // uncomment below and update the code to test ImageFailureImageId
      //var instance = new AmazonElasticContainerRegistryPublic.ImageFailureImageId();
      //expect(instance).to.be.a(AmazonElasticContainerRegistryPublic.ImageFailureImageId);
    });
