...
import CreateRepositoryRequestCatalogData from './CreateRepositoryRequestCatalogData';
...
class CreateRepositoryRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('catalogData')) {
                obj['catalogData'] = CreateRepositoryRequestCatalogData.constructFromObject(data['catalogData']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['catalogData']) { // data not null
          CreateRepositoryRequestCatalogData.validateJSON(data['catalogData']);
        }
...
/**
 * @member {module:model/CreateRepositoryRequestCatalogData} catalogData
 */
CreateRepositoryRequest.prototype['catalogData'] = undefined;
