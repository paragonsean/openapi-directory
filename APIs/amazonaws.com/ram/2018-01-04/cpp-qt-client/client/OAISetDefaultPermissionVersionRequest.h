...
/*
 * OAISetDefaultPermissionVersionRequest.h
 *
 * 
 */

#ifndef OAISetDefaultPermissionVersionRequest_H
#define OAISetDefaultPermissionVersionRequest_H
...
class OAISetDefaultPermissionVersionRequest : public OAIObject {
public:
    OAISetDefaultPermissionVersionRequest();
    OAISetDefaultPermissionVersionRequest(QString json);
    ~OAISetDefaultPermissionVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDefaultPermissionVersionRequest)

#endif // OAISetDefaultPermissionVersionRequest_H
