...
/*
 * OAICreateResourceShareRequest.h
 *
 * 
 */

#ifndef OAICreateResourceShareRequest_H
#define OAICreateResourceShareRequest_H
...
class OAICreateResourceShareRequest : public OAIObject {
public:
    OAICreateResourceShareRequest();
    OAICreateResourceShareRequest(QString json);
    ~OAICreateResourceShareRequest() override;
    ...
    QList getPermissionArns() const;
    void setPermissionArns(const QList &permission_arns);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResourceShareRequest)

#endif // OAICreateResourceShareRequest_H
