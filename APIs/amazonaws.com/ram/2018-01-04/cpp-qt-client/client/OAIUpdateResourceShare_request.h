...
/*
 * OAIUpdateResourceShare_request.h
 *
 * 
 */

#ifndef OAIUpdateResourceShare_request_H
#define OAIUpdateResourceShare_request_H
...
class OAIUpdateResourceShare_request : public OAIObject {
public:
    OAIUpdateResourceShare_request();
    OAIUpdateResourceShare_request(QString json);
    ~OAIUpdateResourceShare_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResourceShare_request)

#endif // OAIUpdateResourceShare_request_H
