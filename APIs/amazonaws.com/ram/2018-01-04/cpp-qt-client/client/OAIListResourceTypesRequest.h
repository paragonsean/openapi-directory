...
/*
 * OAIListResourceTypesRequest.h
 *
 * 
 */

#ifndef OAIListResourceTypesRequest_H
#define OAIListResourceTypesRequest_H
...
class OAIListResourceTypesRequest : public OAIObject {
public:
    OAIListResourceTypesRequest();
    OAIListResourceTypesRequest(QString json);
    ~OAIListResourceTypesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourceTypesRequest)

#endif // OAIListResourceTypesRequest_H
