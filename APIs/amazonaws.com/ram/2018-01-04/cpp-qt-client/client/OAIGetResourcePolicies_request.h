...
/*
 * OAIGetResourcePolicies_request.h
 *
 * 
 */

#ifndef OAIGetResourcePolicies_request_H
#define OAIGetResourcePolicies_request_H
...
class OAIGetResourcePolicies_request : public OAIObject {
public:
    OAIGetResourcePolicies_request();
    OAIGetResourcePolicies_request(QString json);
    ~OAIGetResourcePolicies_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourcePolicies_request)

#endif // OAIGetResourcePolicies_request_H
