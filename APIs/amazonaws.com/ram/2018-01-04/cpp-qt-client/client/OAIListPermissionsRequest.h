...
public:
    ...
    OAIPermissionTypeFilter getPermissionType() const;
    void setPermissionType(const OAIPermissionTypeFilter &permission_type);
...
private:
    ...
    OAIPermissionTypeFilter m_permission_type;
