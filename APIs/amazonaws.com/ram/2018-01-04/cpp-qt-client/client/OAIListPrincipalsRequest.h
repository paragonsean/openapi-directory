...
/*
 * OAIListPrincipalsRequest.h
 *
 * 
 */

#ifndef OAIListPrincipalsRequest_H
#define OAIListPrincipalsRequest_H
...
class OAIListPrincipalsRequest : public OAIObject {
public:
    OAIListPrincipalsRequest();
    OAIListPrincipalsRequest(QString json);
    ~OAIListPrincipalsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPrincipalsRequest)

#endif // OAIListPrincipalsRequest_H
