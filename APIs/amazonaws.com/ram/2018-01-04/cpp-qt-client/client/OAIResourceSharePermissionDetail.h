...
/*
 * OAIResourceSharePermissionDetail.h
 *
 * Information about a RAM managed permission.
 */

#ifndef OAIResourceSharePermissionDetail_H
#define OAIResourceSharePermissionDetail_H
...
class OAIResourceSharePermissionDetail : public OAIObject {
public:
    OAIResourceSharePermissionDetail();
    OAIResourceSharePermissionDetail(QString json);
    ~OAIResourceSharePermissionDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceSharePermissionDetail)

#endif // OAIResourceSharePermissionDetail_H
