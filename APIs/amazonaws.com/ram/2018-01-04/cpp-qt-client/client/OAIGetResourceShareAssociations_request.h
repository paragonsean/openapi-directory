...
/*
 * OAIGetResourceShareAssociations_request.h
 *
 * 
 */

#ifndef OAIGetResourceShareAssociations_request_H
#define OAIGetResourceShareAssociations_request_H
...
class OAIGetResourceShareAssociations_request : public OAIObject {
public:
    OAIGetResourceShareAssociations_request();
    OAIGetResourceShareAssociations_request(QString json);
    ~OAIGetResourceShareAssociations_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourceShareAssociations_request)

#endif // OAIGetResourceShareAssociations_request_H
