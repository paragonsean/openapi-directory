...
/*
 * OAIDisassociateResourceShare_request.h
 *
 * 
 */

#ifndef OAIDisassociateResourceShare_request_H
#define OAIDisassociateResourceShare_request_H
...
class OAIDisassociateResourceShare_request : public OAIObject {
public:
    OAIDisassociateResourceShare_request();
    OAIDisassociateResourceShare_request(QString json);
    ~OAIDisassociateResourceShare_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateResourceShare_request)

#endif // OAIDisassociateResourceShare_request_H
