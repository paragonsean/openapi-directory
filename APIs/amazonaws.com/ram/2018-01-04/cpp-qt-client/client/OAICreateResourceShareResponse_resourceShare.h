...
/*
 * OAICreateResourceShareResponse_resourceShare.h
 *
 * 
 */

#ifndef OAICreateResourceShareResponse_resourceShare_H
#define OAICreateResourceShareResponse_resourceShare_H
...
class OAICreateResourceShareResponse_resourceShare : public OAIObject {
public:
    OAICreateResourceShareResponse_resourceShare();
    OAICreateResourceShareResponse_resourceShare(QString json);
    ~OAICreateResourceShareResponse_resourceShare() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResourceShareResponse_resourceShare)

#endif // OAICreateResourceShareResponse_resourceShare_H
