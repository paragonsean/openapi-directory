...
/*
 * OAIDisassociateResourceShareRequest.h
 *
 * 
 */

#ifndef OAIDisassociateResourceShareRequest_H
#define OAIDisassociateResourceShareRequest_H
...
class OAIDisassociateResourceShareRequest : public OAIObject {
public:
    OAIDisassociateResourceShareRequest();
    OAIDisassociateResourceShareRequest(QString json);
    ~OAIDisassociateResourceShareRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateResourceShareRequest)

#endif // OAIDisassociateResourceShareRequest_H
