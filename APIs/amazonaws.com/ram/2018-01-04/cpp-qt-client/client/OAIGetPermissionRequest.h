...
/*
 * OAIGetPermissionRequest.h
 *
 * 
 */

#ifndef OAIGetPermissionRequest_H
#define OAIGetPermissionRequest_H
...
class OAIGetPermissionRequest : public OAIObject {
public:
    OAIGetPermissionRequest();
    OAIGetPermissionRequest(QString json);
    ~OAIGetPermissionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPermissionRequest)

#endif // OAIGetPermissionRequest_H
