...
/*
 * OAIDisassociateResourceSharePermissionRequest.h
 *
 * 
 */

#ifndef OAIDisassociateResourceSharePermissionRequest_H
#define OAIDisassociateResourceSharePermissionRequest_H
...
class OAIDisassociateResourceSharePermissionRequest : public OAIObject {
public:
    OAIDisassociateResourceSharePermissionRequest();
    OAIDisassociateResourceSharePermissionRequest(QString json);
    ~OAIDisassociateResourceSharePermissionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateResourceSharePermissionRequest)

#endif // OAIDisassociateResourceSharePermissionRequest_H
