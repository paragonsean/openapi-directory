...
/*
 * OAIAssociateResourceShareRequest.h
 *
 * 
 */

#ifndef OAIAssociateResourceShareRequest_H
#define OAIAssociateResourceShareRequest_H
...
class OAIAssociateResourceShareRequest : public OAIObject {
public:
    OAIAssociateResourceShareRequest();
    OAIAssociateResourceShareRequest(QString json);
    ~OAIAssociateResourceShareRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateResourceShareRequest)

#endif // OAIAssociateResourceShareRequest_H
