...
/*
 * OAIListPermissionAssociationsRequest.h
 *
 * 
 */

#ifndef OAIListPermissionAssociationsRequest_H
#define OAIListPermissionAssociationsRequest_H
...
class OAIListPermissionAssociationsRequest : public OAIObject {
public:
    OAIListPermissionAssociationsRequest();
    OAIListPermissionAssociationsRequest(QString json);
    ~OAIListPermissionAssociationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPermissionAssociationsRequest)

#endif // OAIListPermissionAssociationsRequest_H
