...
/*
 * OAIUpdateResourceShareResponse_resourceShare.h
 *
 * 
 */

#ifndef OAIUpdateResourceShareResponse_resourceShare_H
#define OAIUpdateResourceShareResponse_resourceShare_H
...
class OAIUpdateResourceShareResponse_resourceShare : public OAIObject {
public:
    OAIUpdateResourceShareResponse_resourceShare();
    OAIUpdateResourceShareResponse_resourceShare(QString json);
    ~OAIUpdateResourceShareResponse_resourceShare() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResourceShareResponse_resourceShare)

#endif // OAIUpdateResourceShareResponse_resourceShare_H
