...
/*
 * OAIReplacePermissionAssociationsRequest.h
 *
 * 
 */

#ifndef OAIReplacePermissionAssociationsRequest_H
#define OAIReplacePermissionAssociationsRequest_H
...
class OAIReplacePermissionAssociationsRequest : public OAIObject {
public:
    OAIReplacePermissionAssociationsRequest();
    OAIReplacePermissionAssociationsRequest(QString json);
    ~OAIReplacePermissionAssociationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplacePermissionAssociationsRequest)

#endif // OAIReplacePermissionAssociationsRequest_H
