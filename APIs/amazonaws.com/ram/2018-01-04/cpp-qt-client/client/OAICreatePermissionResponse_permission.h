...
/*
 * OAICreatePermissionResponse_permission.h
 *
 * 
 */

#ifndef OAICreatePermissionResponse_permission_H
#define OAICreatePermissionResponse_permission_H
...
class OAICreatePermissionResponse_permission : public OAIObject {
public:
    OAICreatePermissionResponse_permission();
    OAICreatePermissionResponse_permission(QString json);
    ~OAICreatePermissionResponse_permission() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePermissionResponse_permission)

#endif // OAICreatePermissionResponse_permission_H
