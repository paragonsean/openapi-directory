...
/*
 * OAIGetPermission_request.h
 *
 * 
 */

#ifndef OAIGetPermission_request_H
#define OAIGetPermission_request_H
...
class OAIGetPermission_request : public OAIObject {
public:
    OAIGetPermission_request();
    OAIGetPermission_request(QString json);
    ~OAIGetPermission_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPermission_request)

#endif // OAIGetPermission_request_H
