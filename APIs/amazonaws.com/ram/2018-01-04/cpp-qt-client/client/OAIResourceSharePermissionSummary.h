...
/*
 * OAIResourceSharePermissionSummary.h
 *
 * Information about an RAM permission.
 */

#ifndef OAIResourceSharePermissionSummary_H
#define OAIResourceSharePermissionSummary_H
...
class OAIResourceSharePermissionSummary : public OAIObject {
public:
    OAIResourceSharePermissionSummary();
    OAIResourceSharePermissionSummary(QString json);
    ~OAIResourceSharePermissionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceSharePermissionSummary)

#endif // OAIResourceSharePermissionSummary_H
