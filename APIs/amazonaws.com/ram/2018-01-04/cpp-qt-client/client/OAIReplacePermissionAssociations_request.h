...
/*
 * OAIReplacePermissionAssociations_request.h
 *
 * 
 */

#ifndef OAIReplacePermissionAssociations_request_H
#define OAIReplacePermissionAssociations_request_H
...
class OAIReplacePermissionAssociations_request : public OAIObject {
public:
    OAIReplacePermissionAssociations_request();
    OAIReplacePermissionAssociations_request(QString json);
    ~OAIReplacePermissionAssociations_request() override;
    ...
    qint32 getFromPermissionVersion() const;
    void setFromPermissionVersion(const qint32 &from_permission_version);
...
private:
    ...
    qint32 m_from_permission_version;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplacePermissionAssociations_request)

#endif // OAIReplacePermissionAssociations_request_H
