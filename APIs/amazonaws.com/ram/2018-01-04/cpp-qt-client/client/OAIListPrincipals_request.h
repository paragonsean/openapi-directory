...
/*
 * OAIListPrincipals_request.h
 *
 * 
 */

#ifndef OAIListPrincipals_request_H
#define OAIListPrincipals_request_H
...
class OAIListPrincipals_request : public OAIObject {
public:
    OAIListPrincipals_request();
    OAIListPrincipals_request(QString json);
    ~OAIListPrincipals_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPrincipals_request)

#endif // OAIListPrincipals_request_H
