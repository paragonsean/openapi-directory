...
/*
 * OAIUpdateResourceShareRequest.h
 *
 * 
 */

#ifndef OAIUpdateResourceShareRequest_H
#define OAIUpdateResourceShareRequest_H
...
class OAIUpdateResourceShareRequest : public OAIObject {
public:
    OAIUpdateResourceShareRequest();
    OAIUpdateResourceShareRequest(QString json);
    ~OAIUpdateResourceShareRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResourceShareRequest)

#endif // OAIUpdateResourceShareRequest_H
