...
public class ResourceShareInvitation {
  ...
  public ResourceShareInvitation resourceShareInvitationArn(String resourceShareInvitationArn) {
  ...
  public ResourceShareInvitation resourceShareName(String resourceShareName) {
  ...
  public ResourceShareInvitation resourceShareArn(String resourceShareArn) {
  ...
  public ResourceShareInvitation senderAccountId(String senderAccountId) {
  ...
  public ResourceShareInvitation receiverAccountId(String receiverAccountId) {
  ...
  public ResourceShareInvitation invitationTimestamp(OffsetDateTime invitationTimestamp) {
  ...
  public ResourceShareInvitation status(ResourceShareInvitationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ResourceShareInvitation resourceShareAssociations(List resourceShareAssociations) {
  ...
  public ResourceShareInvitation receiverArn(String receiverArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceShareInvitationArn, resourceShareInvitation.resourceShareInvitationArn) &&
        Objects.equals(this.resourceShareName, resourceShareInvitation.resourceShareName) &&
        Objects.equals(this.resourceShareArn, resourceShareInvitation.resourceShareArn) &&
        Objects.equals(this.senderAccountId, resourceShareInvitation.senderAccountId) &&
        Objects.equals(this.receiverAccountId, resourceShareInvitation.receiverAccountId) &&
        Objects.equals(this.invitationTimestamp, resourceShareInvitation.invitationTimestamp) &&
        Objects.equals(this.status, resourceShareInvitation.status) &&
        Objects.equals(this.resourceShareAssociations, resourceShareInvitation.resourceShareAssociations) &&
        Objects.equals(this.receiverArn, resourceShareInvitation.receiverArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceShareInvitation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceShareInvitation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceShareInvitation is not found in the empty JSON string", ResourceShareInvitation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceShareInvitation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceShareInvitation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceShareInvitation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceShareInvitation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceShareInvitation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceShareInvitation.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceShareInvitation>() {
           @Override
           public void write(JsonWriter out, ResourceShareInvitation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceShareInvitation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceShareInvitation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceShareInvitation
   * @throws IOException if the JSON string is invalid with respect to ResourceShareInvitation
   */
  public static ResourceShareInvitation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceShareInvitation.class);
  }

  /**
   * Convert an instance of ResourceShareInvitation to an JSON string
   *
   * @return JSON string
   */
