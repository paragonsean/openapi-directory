...
public class ApiClient {
    ...
    private String basePath = "http://ram.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-01-04/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://ram.us-east-1.amazonaws.com
