...
public class DisassociateResourceShareRequest {
  ...
  public DisassociateResourceShareRequest resourceShareArn(String resourceShareArn) {
  ...
  public DisassociateResourceShareRequest resourceArns(List<String> resourceArns) {
    this.resourceArns = resourceArns;
    return this;
  }

  public DisassociateResourceShareRequest addResourceArnsItem(String resourceArnsItem) {
  ...
  public DisassociateResourceShareRequest principals(List<String> principals) {
    this.principals = principals;
    return this;
  }

  public DisassociateResourceShareRequest addPrincipalsItem(String principalsItem) {
  ...
  public DisassociateResourceShareRequest clientToken(String clientToken) {
  ...
  public DisassociateResourceShareRequest sources(List<String> sources) {
    this.sources = sources;
    return this;
  }

  public DisassociateResourceShareRequest addSourcesItem(String sourcesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceShareArn, disassociateResourceShareRequest.resourceShareArn) &&
        Objects.equals(this.resourceArns, disassociateResourceShareRequest.resourceArns) &&
        Objects.equals(this.principals, disassociateResourceShareRequest.principals) &&
        Objects.equals(this.clientToken, disassociateResourceShareRequest.clientToken) &&
        Objects.equals(this.sources, disassociateResourceShareRequest.sources);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateResourceShareRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateResourceShareRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateResourceShareRequest is not found in the empty JSON string", DisassociateResourceShareRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateResourceShareRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateResourceShareRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisassociateResourceShareRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateResourceShareRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateResourceShareRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateResourceShareRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateResourceShareRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateResourceShareRequest>() {
           @Override
           public void write(JsonWriter out, DisassociateResourceShareRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateResourceShareRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateResourceShareRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateResourceShareRequest
   * @throws IOException if the JSON string is invalid with respect to DisassociateResourceShareRequest
   */
  public static DisassociateResourceShareRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateResourceShareRequest.class);
  }

  /**
   * Convert an instance of DisassociateResourceShareRequest to an JSON string
   *
   * @return JSON string
   */
