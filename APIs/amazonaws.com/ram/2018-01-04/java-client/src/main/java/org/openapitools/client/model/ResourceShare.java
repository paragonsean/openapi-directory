...
public class ResourceShare {
  ...
  public ResourceShare resourceShareArn(String resourceShareArn) {
  ...
  public ResourceShare name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceShare owningAccountId(String owningAccountId) {
  ...
  public ResourceShare allowExternalPrincipals(Boolean allowExternalPrincipals) {
  ...
  public ResourceShare status(ResourceShareStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ResourceShare statusMessage(String statusMessage) {
  ...
  public ResourceShare tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ResourceShare creationTime(OffsetDateTime creationTime) {
  ...
  public ResourceShare lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public ResourceShare featureSet(ResourceShareFeatureSet featureSet) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceShareArn, resourceShare.resourceShareArn) &&
        Objects.equals(this.name, resourceShare.name) &&
        ...
        Objects.equals(this.status, resourceShare.status) &&
        Objects.equals(this.statusMessage, resourceShare.statusMessage) &&
        Objects.equals(this.tags, resourceShare.tags) &&
        Objects.equals(this.creationTime, resourceShare.creationTime) &&
        Objects.equals(this.lastUpdatedTime, resourceShare.lastUpdatedTime) &&
        Objects.equals(this.featureSet, resourceShare.featureSet);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceShare
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceShare.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceShare is not found in the empty JSON string", ResourceShare.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceShare.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceShare` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceShare.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceShare' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceShare> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceShare.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceShare>() {
           @Override
           public void write(JsonWriter out, ResourceShare value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceShare read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceShare given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceShare
   * @throws IOException if the JSON string is invalid with respect to ResourceShare
   */
  public static ResourceShare fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceShare.class);
  }

  /**
   * Convert an instance of ResourceShare to an JSON string
   *
   * @return JSON string
   */
