...
public class AcceptResourceShareInvitationResponseResourceShareInvitation {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation() {
  }

  public AcceptResourceShareInvitationResponseResourceShareInvitation resourceShareInvitationArn(String resourceShareInvitationArn) {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation resourceShareName(String resourceShareName) {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation resourceShareArn(String resourceShareArn) {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation senderAccountId(String senderAccountId) {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation receiverAccountId(String receiverAccountId) {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation invitationTimestamp(OffsetDateTime invitationTimestamp) {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation status(ResourceShareInvitationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation resourceShareAssociations(List resourceShareAssociations) {
  ...
  public AcceptResourceShareInvitationResponseResourceShareInvitation receiverArn(String receiverArn) {
  ...
  public boolean equals(Object o) {
    ...
    AcceptResourceShareInvitationResponseResourceShareInvitation acceptResourceShareInvitationResponseResourceShareInvitation = (AcceptResourceShareInvitationResponseResourceShareInvitation) o;
    return Objects.equals(this.resourceShareInvitationArn, acceptResourceShareInvitationResponseResourceShareInvitation.resourceShareInvitationArn) &&
        Objects.equals(this.resourceShareName, acceptResourceShareInvitationResponseResourceShareInvitation.resourceShareName) &&
        Objects.equals(this.resourceShareArn, acceptResourceShareInvitationResponseResourceShareInvitation.resourceShareArn) &&
        Objects.equals(this.senderAccountId, acceptResourceShareInvitationResponseResourceShareInvitation.senderAccountId) &&
        Objects.equals(this.receiverAccountId, acceptResourceShareInvitationResponseResourceShareInvitation.receiverAccountId) &&
        Objects.equals(this.invitationTimestamp, acceptResourceShareInvitationResponseResourceShareInvitation.invitationTimestamp) &&
        Objects.equals(this.status, acceptResourceShareInvitationResponseResourceShareInvitation.status) &&
        Objects.equals(this.resourceShareAssociations, acceptResourceShareInvitationResponseResourceShareInvitation.resourceShareAssociations) &&
        Objects.equals(this.receiverArn, acceptResourceShareInvitationResponseResourceShareInvitation.receiverArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcceptResourceShareInvitationResponseResourceShareInvitation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcceptResourceShareInvitationResponseResourceShareInvitation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcceptResourceShareInvitationResponseResourceShareInvitation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcceptResourceShareInvitationResponseResourceShareInvitation is not found in the empty JSON string", AcceptResourceShareInvitationResponseResourceShareInvitation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcceptResourceShareInvitationResponseResourceShareInvitation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcceptResourceShareInvitationResponseResourceShareInvitation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcceptResourceShareInvitationResponseResourceShareInvitation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcceptResourceShareInvitationResponseResourceShareInvitation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcceptResourceShareInvitationResponseResourceShareInvitation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcceptResourceShareInvitationResponseResourceShareInvitation.class));

       return (TypeAdapter<T>) new TypeAdapter<AcceptResourceShareInvitationResponseResourceShareInvitation>() {
           @Override
           public void write(JsonWriter out, AcceptResourceShareInvitationResponseResourceShareInvitation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcceptResourceShareInvitationResponseResourceShareInvitation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcceptResourceShareInvitationResponseResourceShareInvitation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcceptResourceShareInvitationResponseResourceShareInvitation
   * @throws IOException if the JSON string is invalid with respect to AcceptResourceShareInvitationResponseResourceShareInvitation
   */
  public static AcceptResourceShareInvitationResponseResourceShareInvitation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcceptResourceShareInvitationResponseResourceShareInvitation.class);
  }

  /**
   * Convert an instance of AcceptResourceShareInvitationResponseResourceShareInvitation to an JSON string
   *
   * @return JSON string
   */
