...
|**permissionVersion** | **Integer** | &lt;p&gt;Specifies the version number of the RAM permission to retrieve. If you don&#39;t specify this parameter, the operation retrieves the default version.&lt;/p&gt; &lt;p&gt;To see the list of available versions, use &lt;a&gt;ListPermissionVersions&lt;/a&gt;.&lt;/p&gt; |  [optional] |
