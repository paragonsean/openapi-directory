...
/**
 * The DisassociateResourceShareRequest model module.
 * @module model/DisassociateResourceShareRequest
 * @version 2018-01-04
 */
class DisassociateResourceShareRequest {
    /**
     * Constructs a new <code>DisassociateResourceShareRequest</code>.
     * @alias module:model/DisassociateResourceShareRequest
     * @param resourceShareArn {String} Specifies <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\">Amazon Resource Name (ARN)</a> of the resource share that you want to remove resources or principals from.
     */
    constructor(resourceShareArn) { 
        
        DisassociateResourceShareRequest.initialize(this, resourceShareArn);
    }
    ...
    /**
     * Constructs a <code>DisassociateResourceShareRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateResourceShareRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateResourceShareRequest} The populated <code>DisassociateResourceShareRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateResourceShareRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateResourceShareRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateResourceShareRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateResourceShareRequest.RequiredProperties) {
...
DisassociateResourceShareRequest.RequiredProperties = ["resourceShareArn"];
 ...
 */
DisassociateResourceShareRequest.prototype['resourceShareArn'] = undefined;
 ...
 */
DisassociateResourceShareRequest.prototype['resourceArns'] = undefined;
 ...
 */
DisassociateResourceShareRequest.prototype['principals'] = undefined;
 ...
 */
DisassociateResourceShareRequest.prototype['clientToken'] = undefined;
 ...
 */
DisassociateResourceShareRequest.prototype['sources'] = undefined;
...
export default DisassociateResourceShareRequest;
