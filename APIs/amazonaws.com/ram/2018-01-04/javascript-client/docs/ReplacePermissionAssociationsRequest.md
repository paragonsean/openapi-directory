# AwsResourceAccessManager.ReplacePermissionAssociationsRequest
...
**fromPermissionVersion** | **Number** | Specifies that you want to updated the permissions for only those resource shares that use the specified version of the managed permission. | [optional] 
