# AwsResourceAccessManager.TagResourceRequest
...
**tags** | [**[Tag]**](Tag.md) | A list of one or more tag key and value pairs. The tag key must be present and not be an empty string. The tag value must be present but can be an empty string. | 
