...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.Principal();
  });
  ...
  describe('Principal', function() {
    it('should create an instance of Principal', function() {
      ...
      //var instance = new AwsResourceAccessManager.Principal();
      //expect(instance).to.be.a(AwsResourceAccessManager.Principal);
    });
