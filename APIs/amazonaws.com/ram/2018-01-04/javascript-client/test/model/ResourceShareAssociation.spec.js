...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.ResourceShareAssociation();
  });
  ...
  describe('ResourceShareAssociation', function() {
    it('should create an instance of ResourceShareAssociation', function() {
      // uncomment below and update the code to test ResourceShareAssociation
      //var instance = new AwsResourceAccessManager.ResourceShareAssociation();
      //expect(instance).to.be.a(AwsResourceAccessManager.ResourceShareAssociation);
    });
    ...
    it('should have the property associatedEntity (base name: "associatedEntity")', function() {
      // uncomment below and update the code to test the property associatedEntity
      //var instance = new AwsResourceAccessManager.ResourceShareAssociation();
      //expect(instance).to.be();
    });
