...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.ListResourceSharePermissionsRequest();
  });
  ...
  describe('ListResourceSharePermissionsRequest', function() {
    it('should create an instance of ListResourceSharePermissionsRequest', function() {
      // uncomment below and update the code to test ListResourceSharePermissionsRequest
      //var instance = new AwsResourceAccessManager.ListResourceSharePermissionsRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.ListResourceSharePermissionsRequest);
    });
