...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.DisassociateResourceSharePermissionRequest();
  });
  ...
  describe('DisassociateResourceSharePermissionRequest', function() {
    it('should create an instance of DisassociateResourceSharePermissionRequest', function() {
      // uncomment below and update the code to test DisassociateResourceSharePermissionRequest
      //var instance = new AwsResourceAccessManager.DisassociateResourceSharePermissionRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.DisassociateResourceSharePermissionRequest);
    });
