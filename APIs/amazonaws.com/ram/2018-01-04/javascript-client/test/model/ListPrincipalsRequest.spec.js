...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.ListPrincipalsRequest();
  });
  ...
  describe('ListPrincipalsRequest', function() {
    it('should create an instance of ListPrincipalsRequest', function() {
      // uncomment below and update the code to test ListPrincipalsRequest
      //var instance = new AwsResourceAccessManager.ListPrincipalsRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.ListPrincipalsRequest);
    });
