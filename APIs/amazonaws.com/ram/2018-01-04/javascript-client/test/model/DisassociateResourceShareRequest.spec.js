...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.DisassociateResourceShareRequest();
  });
  ...
  describe('DisassociateResourceShareRequest', function() {
    it('should create an instance of DisassociateResourceShareRequest', function() {
      // uncomment below and update the code to test DisassociateResourceShareRequest
      //var instance = new AwsResourceAccessManager.DisassociateResourceShareRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.DisassociateResourceShareRequest);
    });
