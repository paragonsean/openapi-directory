...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.GetPermissionRequest();
  });
  ...
  describe('GetPermissionRequest', function() {
    it('should create an instance of GetPermissionRequest', function() {
      // uncomment below and update the code to test GetPermissionRequest
      //var instance = new AwsResourceAccessManager.GetPermissionRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.GetPermissionRequest);
    });
