...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.GetResourceSharesRequest();
  });
  ...
  describe('GetResourceSharesRequest', function() {
    it('should create an instance of GetResourceSharesRequest', function() {
      // uncomment below and update the code to test GetResourceSharesRequest
      //var instance = new AwsResourceAccessManager.GetResourceSharesRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.GetResourceSharesRequest);
    });
    ...
    it('should have the property resourceShareStatus (base name: "resourceShareStatus")', function() {
      // uncomment below and update the code to test the property resourceShareStatus
      //var instance = new AwsResourceAccessManager.GetResourceSharesRequest();
      //expect(instance).to.be();
    });
