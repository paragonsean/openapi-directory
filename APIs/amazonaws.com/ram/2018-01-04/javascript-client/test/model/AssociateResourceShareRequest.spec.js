...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.AssociateResourceShareRequest();
  });
  ...
  describe('AssociateResourceShareRequest', function() {
    it('should create an instance of AssociateResourceShareRequest', function() {
      // uncomment below and update the code to test AssociateResourceShareRequest
      //var instance = new AwsResourceAccessManager.AssociateResourceShareRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.AssociateResourceShareRequest);
    });
