...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.ListPermissionVersionsRequest();
  });
  ...
  describe('ListPermissionVersionsRequest', function() {
    it('should create an instance of ListPermissionVersionsRequest', function() {
      // uncomment below and update the code to test ListPermissionVersionsRequest
      //var instance = new AwsResourceAccessManager.ListPermissionVersionsRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.ListPermissionVersionsRequest);
    });
