...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.AssociatedPermission();
  });
  ...
  describe('AssociatedPermission', function() {
    it('should create an instance of AssociatedPermission', function() {
      // uncomment below and update the code to test AssociatedPermission
      //var instance = new AwsResourceAccessManager.AssociatedPermission();
      //expect(instance).to.be.a(AwsResourceAccessManager.AssociatedPermission);
    });
