...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceAccessManager.AssociateResourceSharePermissionRequest();
  });
  ...
  describe('AssociateResourceSharePermissionRequest', function() {
    it('should create an instance of AssociateResourceSharePermissionRequest', function() {
      // uncomment below and update the code to test AssociateResourceSharePermissionRequest
      //var instance = new AwsResourceAccessManager.AssociateResourceSharePermissionRequest();
      //expect(instance).to.be.a(AwsResourceAccessManager.AssociateResourceSharePermissionRequest);
    });
