...
/*
 * OAIApplicationInstance.h
 *
 * An application instance on a device.
 */

#ifndef OAIApplicationInstance_H
#define OAIApplicationInstance_H
...
class OAIApplicationInstance : public OAIObject {
public:
    OAIApplicationInstance();
    OAIApplicationInstance(QString json);
    ~OAIApplicationInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationInstance)

#endif // OAIApplicationInstance_H
