...
#ifndef OAINetworkPayload_H
#define OAINetworkPayload_H
...
class OAINetworkPayload : public OAIObject {
public:
    OAINetworkPayload();
    OAINetworkPayload(QString json);
    ~OAINetworkPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkPayload)

#endif // OAINetworkPayload_H
