...
/*
 * OAIEthernetPayload.h
 *
 * A device&#39;s network configuration.
 */

#ifndef OAIEthernetPayload_H
#define OAIEthernetPayload_H
...
class OAIEthernetPayload : public OAIObject {
public:
    OAIEthernetPayload();
    OAIEthernetPayload(QString json);
    ~OAIEthernetPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEthernetPayload)

#endif // OAIEthernetPayload_H
