...
#ifndef OAINodeInterface_H
#define OAINodeInterface_H
...
class OAINodeInterface : public OAIObject {
public:
    OAINodeInterface();
    OAINodeInterface(QString json);
    ~OAINodeInterface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeInterface)

#endif // OAINodeInterface_H
