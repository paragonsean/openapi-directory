...
/*
 * OAIProvisionDeviceRequest_NetworkingConfiguration.h
 *
 * 
 */

#ifndef OAIProvisionDeviceRequest_NetworkingConfiguration_H
#define OAIProvisionDeviceRequest_NetworkingConfiguration_H
...
class OAIProvisionDeviceRequest_NetworkingConfiguration : public OAIObject {
public:
    OAIProvisionDeviceRequest_NetworkingConfiguration();
    OAIProvisionDeviceRequest_NetworkingConfiguration(QString json);
    ~OAIProvisionDeviceRequest_NetworkingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisionDeviceRequest_NetworkingConfiguration)

#endif // OAIProvisionDeviceRequest_NetworkingConfiguration_H
