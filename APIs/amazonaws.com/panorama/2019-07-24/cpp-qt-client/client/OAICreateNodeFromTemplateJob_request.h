...
/*
 * OAICreateNodeFromTemplateJob_request.h
 *
 * 
 */

#ifndef OAICreateNodeFromTemplateJob_request_H
#define OAICreateNodeFromTemplateJob_request_H
...
class OAICreateNodeFromTemplateJob_request : public OAIObject {
public:
    OAICreateNodeFromTemplateJob_request();
    OAICreateNodeFromTemplateJob_request(QString json);
    ~OAICreateNodeFromTemplateJob_request() override;
    ...
    QMap<QString, QString> getTemplateParameters() const;
    void setTemplateParameters(const QMap<QString, QString> &template_parameters);
...
private:
    ...
    QMap<QString, QString> m_template_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNodeFromTemplateJob_request)

#endif // OAICreateNodeFromTemplateJob_request_H
