...
public class NetworkStatus {
  ...
  public NetworkStatus ethernet0Status(NetworkStatusEthernet0Status ethernet0Status) {
  ...
  public NetworkStatus ethernet1Status(NetworkStatusEthernet1Status ethernet1Status) {
  ...
  public NetworkStatus lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public NetworkStatus ntpStatus(NetworkStatusNtpStatus ntpStatus) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ethernet0Status, networkStatus.ethernet0Status) &&
        Objects.equals(this.ethernet1Status, networkStatus.ethernet1Status) &&
        Objects.equals(this.lastUpdatedTime, networkStatus.lastUpdatedTime) &&
        Objects.equals(this.ntpStatus, networkStatus.ntpStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworkStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworkStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkStatus is not found in the empty JSON string", NetworkStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworkStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworkStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkStatus>() {
           @Override
  ...
  /**
   * Create an instance of NetworkStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworkStatus
   * @throws IOException if the JSON string is invalid with respect to NetworkStatus
   */
  public static NetworkStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkStatus.class);
  }

  /**
   * Convert an instance of NetworkStatus to an JSON string
   *
   * @return JSON string
   */
