...
public class ApiClient {
    ...
    private String basePath = "http://panorama.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://panorama.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://panorama.{region}.amazonaws.com",
      "The Panorama multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://panorama.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://panorama.{region}.amazonaws.com.cn",
      "The Panorama endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-07-24/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://panorama.us-east-1.amazonaws.com
