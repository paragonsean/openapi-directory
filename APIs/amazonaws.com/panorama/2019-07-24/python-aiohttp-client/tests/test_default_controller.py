...
async def test_create_application_instance(client):
    """Test case for create_application_instance

    
    """
    body = {"DefaultRuntimeContextDevice":"","ApplicationInstanceIdToReplace":"","Description":"","ManifestOverridesPayload":{"PayloadData":""},"ManifestPayload":{"PayloadData":""},"RuntimeRoleArn":"","Tags":"","Name":""}
    headers = { 
...
async def test_create_job_for_devices(client):
    """Test case for create_job_for_devices

    
    """
    body = {"DeviceIds":"","JobType":"","DeviceJobConfig":{"OTAJobConfig":{"ImageVersion":"","AllowMajorVersionUpdate":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_node_from_template_job(client):
    """Test case for create_node_from_template_job

    
    """
    body = {"NodeDescription":"","OutputPackageVersion":"","TemplateParameters":"","JobTags":"","NodeName":"","TemplateType":"","OutputPackageName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_package_import_job(client):
    """Test case for create_package_import_job

    
    """
    body = {"JobType":"","OutputConfig":{"PackageVersionOutputConfig":{"PackageName":"","MarkLatest":"","PackageVersion":""}},"JobTags":"","InputConfig":{"PackageVersionInputConfig":{"S3Location":{"BucketName":"","ObjectKey":"","Region":""}}},"ClientToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_package(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/packages/{package_id}'.format(package_id='package_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deregister_package_version(client):
    """Test case for deregister_package_version

    
    """
    params = [('OwnerAccount', 'owner_account_example'),
                    ('UpdatedLatestPatchVersion', 'updated_latest_patch_version_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='DELETE',
        path='/packages/{package_id}/versions/{package_version}/patch/{patch_version}'.format(package_id='package_id_example', package_version='package_version_example', patch_version='patch_version_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_application_instance(client):
    """Test case for describe_application_instance
    ...
    response = await client.request(
        method='GET',
        path='/application-instances/{application_instance_id}'.format(application_instance_id='application_instance_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_application_instance_details(client):
    """Test case for describe_application_instance_details
    ...
    response = await client.request(
        method='GET',
        path='/application-instances/{application_instance_id}/details'.format(application_instance_id='application_instance_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_device_job(client):
    """Test case for describe_device_job
...
async def test_describe_node(client):
    ...
    response = await client.request(
        method='GET',
        path='/nodes/{node_id}'.format(node_id='node_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_node_from_template_job(client):
    """Test case for describe_node_from_template_job
    ...
    response = await client.request(
        method='GET',
        path='/packages/template-job/{job_id}'.format(job_id='job_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_package(client):
    ...
    response = await client.request(
        method='GET',
        path='/packages/metadata/{package_id}'.format(package_id='package_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_package_import_job(client):
    """Test case for describe_package_import_job
    ...
    response = await client.request(
        method='GET',
        path='/packages/import-jobs/{job_id}'.format(job_id='job_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_package_version(client):
    ...
    """
    params = [('OwnerAccount', 'owner_account_example'),
                    ('PatchVersion', 'patch_version_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='GET',
        path='/packages/metadata/{package_id}/versions/{package_version}'.format(package_id='package_id_example', package_version='package_version_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_application_instance_dependencies(client):
    """Test case for list_application_instance_dependencies
    ...
    response = await client.request(
        method='GET',
        path='/application-instances/{application_instance_id}/package-dependencies'.format(application_instance_id='application_instance_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_application_instance_node_instances(client):
    """Test case for list_application_instance_node_instances
    ...
    response = await client.request(
        method='GET',
        path='/application-instances/{application_instance_id}/node-instances'.format(application_instance_id='application_instance_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_application_instances(client):
    """Test case for list_application_instances
...
async def test_list_devices(client):
    ...
    """
    params = [('DeviceAggregatedStatusFilter', 'device_aggregated_status_filter_example'),
                    ('MaxResults', 56),
...
async def test_list_devices_jobs(client):
    """Test case for list_devices_jobs
...
async def test_list_node_from_template_jobs(client):
    """Test case for list_node_from_template_jobs
...
async def test_list_package_import_jobs(client):
    """Test case for list_package_import_jobs
...
async def test_provision_device(client):
    """Test case for provision_device

    
    """
    body = {"Description":"","NetworkingConfiguration":{"Ntp":{"NtpServers":""},"Ethernet0":{"ConnectionType":"","StaticIpConnectionInfo":{"DefaultGateway":"","Dns":"","Mask":"","IpAddress":""}},"Ethernet1":{"ConnectionType":"","StaticIpConnectionInfo":{"DefaultGateway":"","Dns":"","Mask":"","IpAddress":""}}},"Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_register_package_version(client):
    """Test case for register_package_version

    
    """
    body = {"MarkLatest":"","OwnerAccount":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_remove_application_instance(client):
    """Test case for remove_application_instance
...
async def test_signal_application_instance_node_instances(client):
    """Test case for signal_application_instance_node_instances
    ...
    response = await client.request(
        method='PUT',
        path='/application-instances/{application_instance_id}/node-signals'.format(application_instance_id='application_instance_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_device_metadata(client):
    """Test case for update_device_metadata
