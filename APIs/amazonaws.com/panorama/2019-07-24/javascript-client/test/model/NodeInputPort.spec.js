...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.NodeInputPort();
  });
  ...
  describe('NodeInputPort', function() {
    it('should create an instance of NodeInputPort', function() {
      // uncomment below and update the code to test NodeInputPort
      //var instance = new AwsPanorama.NodeInputPort();
      //expect(instance).to.be.a(AwsPanorama.NodeInputPort);
    });
