...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.ListPackagesResponse();
  });
  ...
  describe('ListPackagesResponse', function() {
    it('should create an instance of ListPackagesResponse', function() {
      ...
      //var instance = new AwsPanorama.ListPackagesResponse();
      //expect(instance).to.be.a(AwsPanorama.ListPackagesResponse);
    });
