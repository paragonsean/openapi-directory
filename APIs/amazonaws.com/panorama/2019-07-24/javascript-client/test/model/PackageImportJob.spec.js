...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.PackageImportJob();
  });
  ...
  describe('PackageImportJob', function() {
    it('should create an instance of PackageImportJob', function() {
      // uncomment below and update the code to test PackageImportJob
      //var instance = new AwsPanorama.PackageImportJob();
      //expect(instance).to.be.a(AwsPanorama.PackageImportJob);
    });
