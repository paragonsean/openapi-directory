...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.DescribeDeviceJobResponse();
  });
  ...
  describe('DescribeDeviceJobResponse', function() {
    it('should create an instance of DescribeDeviceJobResponse', function() {
      // uncomment below and update the code to test DescribeDeviceJobResponse
      //var instance = new AwsPanorama.DescribeDeviceJobResponse();
      //expect(instance).to.be.a(AwsPanorama.DescribeDeviceJobResponse);
    });
