...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.DeviceLatestDeviceJob();
  });
  ...
  describe('DeviceLatestDeviceJob', function() {
    it('should create an instance of DeviceLatestDeviceJob', function() {
      // uncomment below and update the code to test DeviceLatestDeviceJob
      //var instance = new AwsPanorama.DeviceLatestDeviceJob();
      //expect(instance).to.be.a(AwsPanorama.DeviceLatestDeviceJob);
    });
