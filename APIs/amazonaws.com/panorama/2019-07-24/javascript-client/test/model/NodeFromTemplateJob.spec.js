...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.NodeFromTemplateJob();
  });
  ...
  describe('NodeFromTemplateJob', function() {
    it('should create an instance of NodeFromTemplateJob', function() {
      // uncomment below and update the code to test NodeFromTemplateJob
      //var instance = new AwsPanorama.NodeFromTemplateJob();
      //expect(instance).to.be.a(AwsPanorama.NodeFromTemplateJob);
    });
