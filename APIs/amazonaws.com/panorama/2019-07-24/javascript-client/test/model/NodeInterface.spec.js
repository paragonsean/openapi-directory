...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.NodeInterface();
  });
  ...
  describe('NodeInterface', function() {
    it('should create an instance of NodeInterface', function() {
      // uncomment below and update the code to test NodeInterface
      //var instance = new AwsPanorama.NodeInterface();
      //expect(instance).to.be.a(AwsPanorama.NodeInterface);
    });
