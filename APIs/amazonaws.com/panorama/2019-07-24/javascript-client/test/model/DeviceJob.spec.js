...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.DeviceJob();
  });
  ...
  describe('DeviceJob', function() {
    it('should create an instance of DeviceJob', function() {
      // uncomment below and update the code to test DeviceJob
      //var instance = new AwsPanorama.DeviceJob();
      //expect(instance).to.be.a(AwsPanorama.DeviceJob);
    });
