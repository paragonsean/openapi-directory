...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.LatestDeviceJob();
  });
  ...
  describe('LatestDeviceJob', function() {
    it('should create an instance of LatestDeviceJob', function() {
      // uncomment below and update the code to test LatestDeviceJob
      //var instance = new AwsPanorama.LatestDeviceJob();
      //expect(instance).to.be.a(AwsPanorama.LatestDeviceJob);
    });
