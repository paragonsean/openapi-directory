...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.DescribePackageImportJobResponse();
  });
  ...
  describe('DescribePackageImportJobResponse', function() {
    it('should create an instance of DescribePackageImportJobResponse', function() {
      // uncomment below and update the code to test DescribePackageImportJobResponse
      //var instance = new AwsPanorama.DescribePackageImportJobResponse();
      //expect(instance).to.be.a(AwsPanorama.DescribePackageImportJobResponse);
    });
