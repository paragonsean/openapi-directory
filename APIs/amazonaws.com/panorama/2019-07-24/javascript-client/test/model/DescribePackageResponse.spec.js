...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.DescribePackageResponse();
  });
  ...
  describe('DescribePackageResponse', function() {
    it('should create an instance of DescribePackageResponse', function() {
      // uncomment below and update the code to test DescribePackageResponse
      //var instance = new AwsPanorama.DescribePackageResponse();
      //expect(instance).to.be.a(AwsPanorama.DescribePackageResponse);
    });
    ...
    it('should have the property readAccessPrincipalArns (base name: "ReadAccessPrincipalArns")', function() {
      // uncomment below and update the code to test the property readAccessPrincipalArns
      //var instance = new AwsPanorama.DescribePackageResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property writeAccessPrincipalArns (base name: "WriteAccessPrincipalArns")', function() {
      // uncomment below and update the code to test the property writeAccessPrincipalArns
      //var instance = new AwsPanorama.DescribePackageResponse();
      //expect(instance).to.be();
    });
