...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.OutPutS3Location();
  });
  ...
  describe('OutPutS3Location', function() {
    it('should create an instance of OutPutS3Location', function() {
      // uncomment below and update the code to test OutPutS3Location
      //var instance = new AwsPanorama.OutPutS3Location();
      //expect(instance).to.be.a(AwsPanorama.OutPutS3Location);
    });
