...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPanorama.PackageListItem();
  });
  ...
  describe('PackageListItem', function() {
    it('should create an instance of PackageListItem', function() {
      // uncomment below and update the code to test PackageListItem
      //var instance = new AwsPanorama.PackageListItem();
      //expect(instance).to.be.a(AwsPanorama.PackageListItem);
    });
