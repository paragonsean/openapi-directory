...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://panorama.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://panorama.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2019-07-24/Javascript'
        };
