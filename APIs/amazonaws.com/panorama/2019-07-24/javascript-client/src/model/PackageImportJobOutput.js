...
/**
 * The PackageImportJobOutput model module.
 * @module model/PackageImportJobOutput
 * @version 2019-07-24
 */
class PackageImportJobOutput {
    /**
     * Constructs a new <code>PackageImportJobOutput</code>.
     * Results of a package import job.
     * @alias module:model/PackageImportJobOutput
    ...
    /**
     * Constructs a <code>PackageImportJobOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageImportJobOutput} obj Optional instance to populate.
     * @return {module:model/PackageImportJobOutput} The populated <code>PackageImportJobOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageImportJobOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageImportJobOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageImportJobOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PackageImportJobOutput.RequiredProperties) {
...
PackageImportJobOutput.RequiredProperties = ["OutputS3Location", "PackageId", "PackageVersion", "PatchVersion"];
...
export default PackageImportJobOutput;
