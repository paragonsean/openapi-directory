...
async def test_create_mesh(client):
    """Test case for create_mesh

    
    """
    body = openapi_server.CreateMeshRequest()
    headers = { 
...
async def test_create_route(client):
    ...
    """
    body = openapi_server.CreateRouteRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='PUT',
        path='/meshes/{mesh_name}/virtualRouter/{virtual_router_name}/routes'.format(mesh_name='mesh_name_example', virtual_router_name='virtual_router_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_virtual_node(client):
    """Test case for create_virtual_node

    
    """
    body = openapi_server.CreateVirtualNodeRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='PUT',
        path='/meshes/{mesh_name}/virtualNodes'.format(mesh_name='mesh_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_virtual_router(client):
    """Test case for create_virtual_router

    
    """
    body = openapi_server.CreateVirtualRouterRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='PUT',
        path='/meshes/{mesh_name}/virtualRouters'.format(mesh_name='mesh_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_mesh(client):
    """Test case for delete_mesh
    ...
    response = await client.request(
        method='DELETE',
        path='/meshes/{mesh_name}'.format(mesh_name='mesh_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_route(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/meshes/{mesh_name}/virtualRouter/{virtual_router_name}/routes/{route_name}'.format(mesh_name='mesh_name_example', route_name='route_name_example', virtual_router_name='virtual_router_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_virtual_node(client):
    """Test case for delete_virtual_node
    ...
    response = await client.request(
        method='DELETE',
        path='/meshes/{mesh_name}/virtualNodes/{virtual_node_name}'.format(mesh_name='mesh_name_example', virtual_node_name='virtual_node_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_virtual_router(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/meshes/{mesh_name}/virtualRouters/{virtual_router_name}'.format(mesh_name='mesh_name_example', virtual_router_name='virtual_router_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_mesh(client):
    """Test case for describe_mesh
...
async def test_describe_route(client):
    """Test case for describe_route
...
async def test_describe_virtual_node(client):
    """Test case for describe_virtual_node
...
async def test_describe_virtual_router(client):
    """Test case for describe_virtual_router
...
async def test_list_meshes(client):
    """Test case for list_meshes
...
async def test_list_virtual_nodes(client):
    """Test case for list_virtual_nodes
...
async def test_list_virtual_routers(client):
    """Test case for list_virtual_routers
...
async def test_update_route(client):
    ...
    """
    body = openapi_server.UpdateRouteRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_virtual_node(client):
    """Test case for update_virtual_node

    
    """
    body = openapi_server.UpdateVirtualNodeRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_virtual_router(client):
    """Test case for update_virtual_router

    
    """
    body = openapi_server.UpdateVirtualRouterRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
