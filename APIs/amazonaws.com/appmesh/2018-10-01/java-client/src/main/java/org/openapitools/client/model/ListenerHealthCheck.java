...
public class ListenerHealthCheck {
  ...
  public ListenerHealthCheck healthyThreshold(Integer healthyThreshold) {
  ...
  public ListenerHealthCheck intervalMillis(Integer intervalMillis) {
  ...
  public ListenerHealthCheck path(String path) {
    this.path = path;
    return this;
  }
  ...
  public ListenerHealthCheck port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public ListenerHealthCheck protocol(PortProtocol protocol) {
  ...
  public ListenerHealthCheck timeoutMillis(Integer timeoutMillis) {
  ...
  public ListenerHealthCheck unhealthyThreshold(Integer unhealthyThreshold) {
  ...
  public boolean equals(Object o) {
    ...
    ListenerHealthCheck listenerHealthCheck = (ListenerHealthCheck) o;
    return Objects.equals(this.healthyThreshold, listenerHealthCheck.healthyThreshold) &&
        Objects.equals(this.intervalMillis, listenerHealthCheck.intervalMillis) &&
        Objects.equals(this.path, listenerHealthCheck.path) &&
        Objects.equals(this.port, listenerHealthCheck.port) &&
        Objects.equals(this.protocol, listenerHealthCheck.protocol) &&
        Objects.equals(this.timeoutMillis, listenerHealthCheck.timeoutMillis) &&
        Objects.equals(this.unhealthyThreshold, listenerHealthCheck.unhealthyThreshold);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListenerHealthCheck {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListenerHealthCheck
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListenerHealthCheck.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListenerHealthCheck is not found in the empty JSON string", ListenerHealthCheck.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListenerHealthCheck.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListenerHealthCheck` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListenerHealthCheck.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListenerHealthCheck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListenerHealthCheck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListenerHealthCheck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListenerHealthCheck.class));

       return (TypeAdapter<T>) new TypeAdapter<ListenerHealthCheck>() {
           @Override
           public void write(JsonWriter out, ListenerHealthCheck value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListenerHealthCheck read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListenerHealthCheck given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListenerHealthCheck
   * @throws IOException if the JSON string is invalid with respect to ListenerHealthCheck
   */
  public static ListenerHealthCheck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListenerHealthCheck.class);
  }

  /**
   * Convert an instance of ListenerHealthCheck to an JSON string
   *
   * @return JSON string
   */
