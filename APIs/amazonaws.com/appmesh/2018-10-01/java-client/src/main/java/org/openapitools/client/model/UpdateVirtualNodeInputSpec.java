...
public class UpdateVirtualNodeInputSpec {
  ...
  public UpdateVirtualNodeInputSpec() {
  }

  public UpdateVirtualNodeInputSpec backends(List backends) {
  ...
  public UpdateVirtualNodeInputSpec listeners(List listeners) {
  ...
  public UpdateVirtualNodeInputSpec serviceDiscovery(CreateVirtualNodeRequestSpecServiceDiscovery serviceDiscovery) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateVirtualNodeInputSpec updateVirtualNodeInputSpec = (UpdateVirtualNodeInputSpec) o;
    return Objects.equals(this.backends, updateVirtualNodeInputSpec.backends) &&
        Objects.equals(this.listeners, updateVirtualNodeInputSpec.listeners) &&
        Objects.equals(this.serviceDiscovery, updateVirtualNodeInputSpec.serviceDiscovery);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateVirtualNodeInputSpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateVirtualNodeInputSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateVirtualNodeInputSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateVirtualNodeInputSpec is not found in the empty JSON string", UpdateVirtualNodeInputSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateVirtualNodeInputSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateVirtualNodeInputSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateVirtualNodeInputSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateVirtualNodeInputSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateVirtualNodeInputSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateVirtualNodeInputSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateVirtualNodeInputSpec>() {
           @Override
           public void write(JsonWriter out, UpdateVirtualNodeInputSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateVirtualNodeInputSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateVirtualNodeInputSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateVirtualNodeInputSpec
   * @throws IOException if the JSON string is invalid with respect to UpdateVirtualNodeInputSpec
   */
  public static UpdateVirtualNodeInputSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateVirtualNodeInputSpec.class);
  }

  /**
   * Convert an instance of UpdateVirtualNodeInputSpec to an JSON string
   *
   * @return JSON string
   */
