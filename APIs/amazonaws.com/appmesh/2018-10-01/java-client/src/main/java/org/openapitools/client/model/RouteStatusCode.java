...
/**
 * Gets or Sets RouteStatusCode
 */
@JsonAdapter(RouteStatusCode.Adapter.class)
public enum RouteStatusCode {
  ...
  public static RouteStatusCode fromValue(String value) {
    for (RouteStatusCode b : RouteStatusCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<RouteStatusCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final RouteStatusCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RouteStatusCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RouteStatusCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RouteStatusCode.fromValue(value);
  }
}
