...
/**
 * Gets or Sets VirtualNodeStatusCode
 */
@JsonAdapter(VirtualNodeStatusCode.Adapter.class)
public enum VirtualNodeStatusCode {
  ...
  VirtualNodeStatusCode(String value) {
    this.value = value;
  }
  ...
  public static VirtualNodeStatusCode fromValue(String value) {
    for (VirtualNodeStatusCode b : VirtualNodeStatusCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<VirtualNodeStatusCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final VirtualNodeStatusCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VirtualNodeStatusCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VirtualNodeStatusCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VirtualNodeStatusCode.fromValue(value);
  }
}
