...
public class VirtualNodeDataSpec {
  ...
  public VirtualNodeDataSpec() {
  }

  public VirtualNodeDataSpec backends(List backends) {
  ...
  public VirtualNodeDataSpec listeners(List listeners) {
  ...
  public VirtualNodeDataSpec serviceDiscovery(CreateVirtualNodeRequestSpecServiceDiscovery serviceDiscovery) {
  ...
  public boolean equals(Object o) {
    ...
    VirtualNodeDataSpec virtualNodeDataSpec = (VirtualNodeDataSpec) o;
    return Objects.equals(this.backends, virtualNodeDataSpec.backends) &&
        Objects.equals(this.listeners, virtualNodeDataSpec.listeners) &&
        Objects.equals(this.serviceDiscovery, virtualNodeDataSpec.serviceDiscovery);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backends, listeners, serviceDiscovery);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VirtualNodeDataSpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VirtualNodeDataSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VirtualNodeDataSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VirtualNodeDataSpec is not found in the empty JSON string", VirtualNodeDataSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VirtualNodeDataSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VirtualNodeDataSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VirtualNodeDataSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VirtualNodeDataSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VirtualNodeDataSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VirtualNodeDataSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<VirtualNodeDataSpec>() {
           @Override
           public void write(JsonWriter out, VirtualNodeDataSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VirtualNodeDataSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VirtualNodeDataSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VirtualNodeDataSpec
   * @throws IOException if the JSON string is invalid with respect to VirtualNodeDataSpec
   */
  public static VirtualNodeDataSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VirtualNodeDataSpec.class);
  }

  /**
   * Convert an instance of VirtualNodeDataSpec to an JSON string
   *
   * @return JSON string
   */
