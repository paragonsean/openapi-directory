...
OAICreateMesh_request Example::create(){
    OAICreateMesh_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createMeshSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createMeshSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateMesh_request oai_create_mesh_request = create(); // OAICreateMesh_request | 
      ...
      apiInstance.createMesh(oai_create_mesh_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
