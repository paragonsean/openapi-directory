...
/*
 * OAIDeleteMeshOutput_mesh.h
 *
 * 
 */

#ifndef OAIDeleteMeshOutput_mesh_H
#define OAIDeleteMeshOutput_mesh_H
...
class OAIDeleteMeshOutput_mesh : public OAIObject {
public:
    OAIDeleteMeshOutput_mesh();
    OAIDeleteMeshOutput_mesh(QString json);
    ~OAIDeleteMeshOutput_mesh() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMeshOutput_mesh)

#endif // OAIDeleteMeshOutput_mesh_H
