...
#include "OAIVirtualNodeData_spec.h"
...
OAIVirtualNodeData_spec::OAIVirtualNodeData_spec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVirtualNodeData_spec::OAIVirtualNodeData_spec() {
    this->initializeModel();
}

OAIVirtualNodeData_spec::~OAIVirtualNodeData_spec() {}

void OAIVirtualNodeData_spec::initializeModel() {
...
void OAIVirtualNodeData_spec::fromJson(QString jsonString) {
...
void OAIVirtualNodeData_spec::fromJsonObject(QJsonObject json) {
...
QString OAIVirtualNodeData_spec::asJson() const {
...
QJsonObject OAIVirtualNodeData_spec::asJsonObject() const {
    QJsonObject obj;
    if (m_backends.isSet()) {
...
QList OAIVirtualNodeData_spec::getBackends() const {
    return m_backends;
}
void OAIVirtualNodeData_spec::setBackends(const QList &backends) {
    m_backends = backends;
    m_backends_isSet = true;
}

bool OAIVirtualNodeData_spec::is_backends_Set() const{
    return m_backends_isSet;
}

bool OAIVirtualNodeData_spec::is_backends_Valid() const{
    return m_backends_isValid;
}

QList OAIVirtualNodeData_spec::getListeners() const {
    return m_listeners;
}
void OAIVirtualNodeData_spec::setListeners(const QList &listeners) {
    m_listeners = listeners;
    m_listeners_isSet = true;
}

bool OAIVirtualNodeData_spec::is_listeners_Set() const{
    return m_listeners_isSet;
}

bool OAIVirtualNodeData_spec::is_listeners_Valid() const{
    return m_listeners_isValid;
}

OAICreateVirtualNode_request_spec_serviceDiscovery OAIVirtualNodeData_spec::getServiceDiscovery() const {
    return m_service_discovery;
}
void OAIVirtualNodeData_spec::setServiceDiscovery(const OAICreateVirtualNode_request_spec_serviceDiscovery &service_discovery) {
    m_service_discovery = service_discovery;
    m_service_discovery_isSet = true;
}

bool OAIVirtualNodeData_spec::is_service_discovery_Set() const{
    return m_service_discovery_isSet;
}

bool OAIVirtualNodeData_spec::is_service_discovery_Valid() const{
    return m_service_discovery_isValid;
}

bool OAIVirtualNodeData_spec::isSet() const {
...
bool OAIVirtualNodeData_spec::isValid() const {
