...
/*
 * OAIUpdateRouteOutput_route.h
 *
 * 
 */

#ifndef OAIUpdateRouteOutput_route_H
#define OAIUpdateRouteOutput_route_H
...
class OAIUpdateRouteOutput_route : public OAIObject {
public:
    OAIUpdateRouteOutput_route();
    OAIUpdateRouteOutput_route(QString json);
    ~OAIUpdateRouteOutput_route() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRouteOutput_route)

#endif // OAIUpdateRouteOutput_route_H
