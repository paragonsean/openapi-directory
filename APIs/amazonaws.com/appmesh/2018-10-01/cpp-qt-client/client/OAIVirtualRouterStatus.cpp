...
#include "OAIVirtualRouterStatus.h"
...
OAIVirtualRouterStatus::OAIVirtualRouterStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVirtualRouterStatus::OAIVirtualRouterStatus() {
    this->initializeModel();
}

OAIVirtualRouterStatus::~OAIVirtualRouterStatus() {}

void OAIVirtualRouterStatus::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIVirtualRouterStatus::fromJson(QString jsonString) {
...
void OAIVirtualRouterStatus::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIVirtualRouterStatus::asJson() const {
...
QJsonObject OAIVirtualRouterStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIVirtualRouterStatusCode OAIVirtualRouterStatus::getStatus() const {
    return m_status;
}
void OAIVirtualRouterStatus::setStatus(const OAIVirtualRouterStatusCode &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVirtualRouterStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVirtualRouterStatus::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIVirtualRouterStatus::isSet() const {
...
bool OAIVirtualRouterStatus::isValid() const {
