...
/*
 * OAICreateVirtualRouterInput_spec.h
 *
 * 
 */

#ifndef OAICreateVirtualRouterInput_spec_H
#define OAICreateVirtualRouterInput_spec_H
...
class OAICreateVirtualRouterInput_spec : public OAIObject {
public:
    OAICreateVirtualRouterInput_spec();
    OAICreateVirtualRouterInput_spec(QString json);
    ~OAICreateVirtualRouterInput_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVirtualRouterInput_spec)

#endif // OAICreateVirtualRouterInput_spec_H
