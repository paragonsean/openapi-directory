...
/*
 * OAIUpdateVirtualNodeOutput.h
 *
 * 
 */

#ifndef OAIUpdateVirtualNodeOutput_H
#define OAIUpdateVirtualNodeOutput_H
...
namespace OpenAPI {
class OAIUpdateVirtualNodeOutput_virtualNode;

class OAIUpdateVirtualNodeOutput : public OAIObject {
public:
    OAIUpdateVirtualNodeOutput();
    OAIUpdateVirtualNodeOutput(QString json);
    ~OAIUpdateVirtualNodeOutput() override;
    ...
    OAIUpdateVirtualNodeOutput_virtualNode getVirtualNode() const;
    void setVirtualNode(const OAIUpdateVirtualNodeOutput_virtualNode &virtual_node);
...
private:
    ...
    OAIUpdateVirtualNodeOutput_virtualNode m_virtual_node;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVirtualNodeOutput)

#endif // OAIUpdateVirtualNodeOutput_H
