...
OAIRouteStatusCode OAIRouteStatus::getStatus() const {
    return m_status;
}
void OAIRouteStatus::setStatus(const OAIRouteStatusCode &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRouteStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRouteStatus::is_status_Valid() const{
