...
/*
 * OAIRouteStatusCode.h
 *
 * 
 */

#ifndef OAIRouteStatusCode_H
#define OAIRouteStatusCode_H
...
class OAIRouteStatusCode : public OAIEnum {
public:
    OAIRouteStatusCode();
    OAIRouteStatusCode(QString json);
    ~OAIRouteStatusCode() override;
    ...
    enum class eOAIRouteStatusCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        DELETED, 
        INACTIVE
    };
    OAIRouteStatusCode::eOAIRouteStatusCode getValue() const;
    void setValue(const OAIRouteStatusCode::eOAIRouteStatusCode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteStatusCode)

#endif // OAIRouteStatusCode_H
