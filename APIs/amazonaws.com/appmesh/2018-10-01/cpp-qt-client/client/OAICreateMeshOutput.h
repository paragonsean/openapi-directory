...
/*
 * OAICreateMeshOutput.h
 *
 * 
 */

#ifndef OAICreateMeshOutput_H
#define OAICreateMeshOutput_H
...
namespace OpenAPI {
class OAICreateMeshOutput_mesh;

class OAICreateMeshOutput : public OAIObject {
public:
    OAICreateMeshOutput();
    OAICreateMeshOutput(QString json);
    ~OAICreateMeshOutput() override;
    ...
    OAICreateMeshOutput_mesh getMesh() const;
    void setMesh(const OAICreateMeshOutput_mesh &mesh);
...
private:
    ...
    OAICreateMeshOutput_mesh m_mesh;
    bool m_mesh_isSet;
    bool m_mesh_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeshOutput)

#endif // OAICreateMeshOutput_H
