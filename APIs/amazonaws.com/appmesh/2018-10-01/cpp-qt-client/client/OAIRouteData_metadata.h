...
/*
 * OAIRouteData_metadata.h
 *
 * 
 */

#ifndef OAIRouteData_metadata_H
#define OAIRouteData_metadata_H
...
class OAIRouteData_metadata : public OAIObject {
public:
    OAIRouteData_metadata();
    OAIRouteData_metadata(QString json);
    ~OAIRouteData_metadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteData_metadata)

#endif // OAIRouteData_metadata_H
