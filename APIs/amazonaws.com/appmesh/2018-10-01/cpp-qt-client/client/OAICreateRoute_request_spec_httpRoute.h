...
/*
 * OAICreateRoute_request_spec_httpRoute.h
 *
 * 
 */

#ifndef OAICreateRoute_request_spec_httpRoute_H
#define OAICreateRoute_request_spec_httpRoute_H
...
class OAICreateRoute_request_spec_httpRoute : public OAIObject {
public:
    OAICreateRoute_request_spec_httpRoute();
    OAICreateRoute_request_spec_httpRoute(QString json);
    ~OAICreateRoute_request_spec_httpRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoute_request_spec_httpRoute)

#endif // OAICreateRoute_request_spec_httpRoute_H
