...
OAIVirtualRouterData_status::OAIVirtualRouterData_status(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVirtualRouterData_status::OAIVirtualRouterData_status() {
    this->initializeModel();
}

OAIVirtualRouterData_status::~OAIVirtualRouterData_status() {}

void OAIVirtualRouterData_status::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIVirtualRouterData_status::fromJson(QString jsonString) {
...
void OAIVirtualRouterData_status::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIVirtualRouterData_status::asJson() const {
...
QJsonObject OAIVirtualRouterData_status::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIVirtualRouterStatusCode OAIVirtualRouterData_status::getStatus() const {
    return m_status;
}
void OAIVirtualRouterData_status::setStatus(const OAIVirtualRouterStatusCode &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVirtualRouterData_status::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVirtualRouterData_status::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIVirtualRouterData_status::isSet() const {
...
bool OAIVirtualRouterData_status::isValid() const {
