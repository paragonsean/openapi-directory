...
#include "OAIVirtualRouterSpec.h"
...
OAIVirtualRouterSpec::OAIVirtualRouterSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVirtualRouterSpec::OAIVirtualRouterSpec() {
    this->initializeModel();
}

OAIVirtualRouterSpec::~OAIVirtualRouterSpec() {}

void OAIVirtualRouterSpec::initializeModel() {

    m_service_names_isSet = false;
    m_service_names_isValid = false;
}

void OAIVirtualRouterSpec::fromJson(QString jsonString) {
...
void OAIVirtualRouterSpec::fromJsonObject(QJsonObject json) {
...
QString OAIVirtualRouterSpec::asJson() const {
...
QJsonObject OAIVirtualRouterSpec::asJsonObject() const {
    QJsonObject obj;
...
QList OAIVirtualRouterSpec::getServiceNames() const {
    return m_service_names;
}
void OAIVirtualRouterSpec::setServiceNames(const QList &service_names) {
    m_service_names = service_names;
    m_service_names_isSet = true;
}

bool OAIVirtualRouterSpec::is_service_names_Set() const{
    return m_service_names_isSet;
}

bool OAIVirtualRouterSpec::is_service_names_Valid() const{
    return m_service_names_isValid;
}

bool OAIVirtualRouterSpec::isSet() const {
...
bool OAIVirtualRouterSpec::isValid() const {
