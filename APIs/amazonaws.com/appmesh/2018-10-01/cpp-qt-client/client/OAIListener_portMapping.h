...
/*
 * OAIListener_portMapping.h
 *
 * 
 */

#ifndef OAIListener_portMapping_H
#define OAIListener_portMapping_H
...
class OAIListener_portMapping : public OAIObject {
public:
    OAIListener_portMapping();
    OAIListener_portMapping(QString json);
    ~OAIListener_portMapping() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListener_portMapping)

#endif // OAIListener_portMapping_H
