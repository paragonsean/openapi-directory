...
/*
 * OAIMeshData_metadata.h
 *
 * 
 */

#ifndef OAIMeshData_metadata_H
#define OAIMeshData_metadata_H
...
class OAIMeshData_metadata : public OAIObject {
public:
    OAIMeshData_metadata();
    OAIMeshData_metadata(QString json);
    ~OAIMeshData_metadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMeshData_metadata)

#endif // OAIMeshData_metadata_H
