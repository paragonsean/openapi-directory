...
OAIRouteData_status::OAIRouteData_status(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRouteData_status::OAIRouteData_status() {
    this->initializeModel();
}

OAIRouteData_status::~OAIRouteData_status() {}

void OAIRouteData_status::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIRouteData_status::fromJson(QString jsonString) {
...
void OAIRouteData_status::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIRouteData_status::asJson() const {
...
QJsonObject OAIRouteData_status::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIRouteStatusCode OAIRouteData_status::getStatus() const {
    return m_status;
}
void OAIRouteData_status::setStatus(const OAIRouteStatusCode &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRouteData_status::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRouteData_status::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRouteData_status::isSet() const {
...
bool OAIRouteData_status::isValid() const {
