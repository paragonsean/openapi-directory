...
/*
 * OAICreateRoute_request_spec.h
 *
 * An object representing the specification of a route.
 */

#ifndef OAICreateRoute_request_spec_H
#define OAICreateRoute_request_spec_H
...
class OAICreateRoute_request_spec : public OAIObject {
public:
    OAICreateRoute_request_spec();
    OAICreateRoute_request_spec(QString json);
    ~OAICreateRoute_request_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoute_request_spec)

#endif // OAICreateRoute_request_spec_H
