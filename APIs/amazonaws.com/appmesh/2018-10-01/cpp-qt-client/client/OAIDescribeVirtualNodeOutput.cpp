...
OAIDescribeVirtualNodeOutput::OAIDescribeVirtualNodeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeVirtualNodeOutput::OAIDescribeVirtualNodeOutput() {
    this->initializeModel();
}

OAIDescribeVirtualNodeOutput::~OAIDescribeVirtualNodeOutput() {}

void OAIDescribeVirtualNodeOutput::initializeModel() {

    m_virtual_node_isSet = false;
    m_virtual_node_isValid = false;
}

void OAIDescribeVirtualNodeOutput::fromJson(QString jsonString) {
...
void OAIDescribeVirtualNodeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeVirtualNodeOutput::asJson() const {
...
QJsonObject OAIDescribeVirtualNodeOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeVirtualNodeOutput_virtualNode OAIDescribeVirtualNodeOutput::getVirtualNode() const {
    return m_virtual_node;
}
void OAIDescribeVirtualNodeOutput::setVirtualNode(const OAIDescribeVirtualNodeOutput_virtualNode &virtual_node) {
    m_virtual_node = virtual_node;
    m_virtual_node_isSet = true;
}

bool OAIDescribeVirtualNodeOutput::is_virtual_node_Set() const{
    return m_virtual_node_isSet;
}

bool OAIDescribeVirtualNodeOutput::is_virtual_node_Valid() const{
    return m_virtual_node_isValid;
}

bool OAIDescribeVirtualNodeOutput::isSet() const {
...
bool OAIDescribeVirtualNodeOutput::isValid() const {
