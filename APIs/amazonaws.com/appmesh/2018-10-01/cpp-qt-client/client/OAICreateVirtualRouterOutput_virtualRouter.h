...
/*
 * OAICreateVirtualRouterOutput_virtualRouter.h
 *
 * 
 */

#ifndef OAICreateVirtualRouterOutput_virtualRouter_H
#define OAICreateVirtualRouterOutput_virtualRouter_H
...
class OAICreateVirtualRouterOutput_virtualRouter : public OAIObject {
public:
    OAICreateVirtualRouterOutput_virtualRouter();
    OAICreateVirtualRouterOutput_virtualRouter(QString json);
    ~OAICreateVirtualRouterOutput_virtualRouter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVirtualRouterOutput_virtualRouter)

#endif // OAICreateVirtualRouterOutput_virtualRouter_H
