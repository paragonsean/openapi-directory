...
QList OAIVirtualRouterData_spec::getServiceNames() const {
    return m_service_names;
}
void OAIVirtualRouterData_spec::setServiceNames(const QList &service_names) {
    m_service_names = service_names;
    m_service_names_isSet = true;
}

bool OAIVirtualRouterData_spec::is_service_names_Set() const{
    return m_service_names_isSet;
}

bool OAIVirtualRouterData_spec::is_service_names_Valid() const{
