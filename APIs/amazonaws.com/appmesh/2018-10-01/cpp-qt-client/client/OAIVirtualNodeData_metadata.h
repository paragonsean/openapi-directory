...
/*
 * OAIVirtualNodeData_metadata.h
 *
 * 
 */

#ifndef OAIVirtualNodeData_metadata_H
#define OAIVirtualNodeData_metadata_H
...
class OAIVirtualNodeData_metadata : public OAIObject {
public:
    OAIVirtualNodeData_metadata();
    OAIVirtualNodeData_metadata(QString json);
    ~OAIVirtualNodeData_metadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNodeData_metadata)

#endif // OAIVirtualNodeData_metadata_H
