...
#include "OAIUpdateRouteOutput_route.h"
...
OAIUpdateRouteOutput_route::OAIUpdateRouteOutput_route(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRouteOutput_route::OAIUpdateRouteOutput_route() {
    this->initializeModel();
}

OAIUpdateRouteOutput_route::~OAIUpdateRouteOutput_route() {}

void OAIUpdateRouteOutput_route::initializeModel() {
...
void OAIUpdateRouteOutput_route::fromJson(QString jsonString) {
...
void OAIUpdateRouteOutput_route::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRouteOutput_route::asJson() const {
...
QJsonObject OAIUpdateRouteOutput_route::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRouteOutput_route::getMeshName() const {
    return m_mesh_name;
}
void OAIUpdateRouteOutput_route::setMeshName(const QString &mesh_name) {
    m_mesh_name = mesh_name;
    m_mesh_name_isSet = true;
}

bool OAIUpdateRouteOutput_route::is_mesh_name_Set() const{
    return m_mesh_name_isSet;
}

bool OAIUpdateRouteOutput_route::is_mesh_name_Valid() const{
    return m_mesh_name_isValid;
}

OAIRouteData_metadata OAIUpdateRouteOutput_route::getMetadata() const {
    return m_metadata;
}
void OAIUpdateRouteOutput_route::setMetadata(const OAIRouteData_metadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIUpdateRouteOutput_route::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIUpdateRouteOutput_route::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIUpdateRouteOutput_route::getRouteName() const {
    return m_route_name;
}
void OAIUpdateRouteOutput_route::setRouteName(const QString &route_name) {
    m_route_name = route_name;
    m_route_name_isSet = true;
}

bool OAIUpdateRouteOutput_route::is_route_name_Set() const{
    return m_route_name_isSet;
}

bool OAIUpdateRouteOutput_route::is_route_name_Valid() const{
    return m_route_name_isValid;
}

OAIRouteData_spec OAIUpdateRouteOutput_route::getSpec() const {
    return m_spec;
}
void OAIUpdateRouteOutput_route::setSpec(const OAIRouteData_spec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIUpdateRouteOutput_route::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIUpdateRouteOutput_route::is_spec_Valid() const{
    return m_spec_isValid;
}

OAIRouteData_status OAIUpdateRouteOutput_route::getStatus() const {
    return m_status;
}
void OAIUpdateRouteOutput_route::setStatus(const OAIRouteData_status &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateRouteOutput_route::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateRouteOutput_route::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIUpdateRouteOutput_route::getVirtualRouterName() const {
    return m_virtual_router_name;
}
void OAIUpdateRouteOutput_route::setVirtualRouterName(const QString &virtual_router_name) {
    m_virtual_router_name = virtual_router_name;
    m_virtual_router_name_isSet = true;
}

bool OAIUpdateRouteOutput_route::is_virtual_router_name_Set() const{
    return m_virtual_router_name_isSet;
}

bool OAIUpdateRouteOutput_route::is_virtual_router_name_Valid() const{
    return m_virtual_router_name_isValid;
}

bool OAIUpdateRouteOutput_route::isSet() const {
...
bool OAIUpdateRouteOutput_route::isValid() const {
