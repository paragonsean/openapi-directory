...
#ifndef OAIPortProtocol_H
#define OAIPortProtocol_H
...
class OAIPortProtocol : public OAIEnum {
public:
    OAIPortProtocol();
    OAIPortProtocol(QString json);
    ~OAIPortProtocol() override;
    ...
    enum class eOAIPortProtocol {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        HTTP, 
        TCP
    };
    OAIPortProtocol::eOAIPortProtocol getValue() const;
    void setValue(const OAIPortProtocol::eOAIPortProtocol& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortProtocol)

#endif // OAIPortProtocol_H
