...
OAIUpdateRouteInput::OAIUpdateRouteInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRouteInput::OAIUpdateRouteInput() {
    this->initializeModel();
}

OAIUpdateRouteInput::~OAIUpdateRouteInput() {}

void OAIUpdateRouteInput::initializeModel() {
...
void OAIUpdateRouteInput::fromJson(QString jsonString) {
...
void OAIUpdateRouteInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRouteInput::asJson() const {
...
QJsonObject OAIUpdateRouteInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRouteInput::getClientToken() const {
    return m_client_token;
}
void OAIUpdateRouteInput::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAIUpdateRouteInput::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAIUpdateRouteInput::is_client_token_Valid() const{
    return m_client_token_isValid;
}

OAIUpdateRouteInput_spec OAIUpdateRouteInput::getSpec() const {
    return m_spec;
}
void OAIUpdateRouteInput::setSpec(const OAIUpdateRouteInput_spec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIUpdateRouteInput::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIUpdateRouteInput::is_spec_Valid() const{
    return m_spec_isValid;
}

bool OAIUpdateRouteInput::isSet() const {
...
bool OAIUpdateRouteInput::isValid() const {
