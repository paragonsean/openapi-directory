...
/*
 * OAICreateRouteInput_spec.h
 *
 * 
 */

#ifndef OAICreateRouteInput_spec_H
#define OAICreateRouteInput_spec_H
...
class OAICreateRouteInput_spec : public OAIObject {
public:
    OAICreateRouteInput_spec();
    OAICreateRouteInput_spec(QString json);
    ~OAICreateRouteInput_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRouteInput_spec)

#endif // OAICreateRouteInput_spec_H
