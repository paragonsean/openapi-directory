...
/*
 * OAIDeleteVirtualRouterOutput_virtualRouter.h
 *
 * 
 */

#ifndef OAIDeleteVirtualRouterOutput_virtualRouter_H
#define OAIDeleteVirtualRouterOutput_virtualRouter_H
...
class OAIDeleteVirtualRouterOutput_virtualRouter : public OAIObject {
public:
    OAIDeleteVirtualRouterOutput_virtualRouter();
    OAIDeleteVirtualRouterOutput_virtualRouter(QString json);
    ~OAIDeleteVirtualRouterOutput_virtualRouter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVirtualRouterOutput_virtualRouter)

#endif // OAIDeleteVirtualRouterOutput_virtualRouter_H
