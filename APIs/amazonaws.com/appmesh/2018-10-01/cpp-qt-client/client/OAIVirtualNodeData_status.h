...
/*
 * OAIVirtualNodeData_status.h
 *
 * 
 */

#ifndef OAIVirtualNodeData_status_H
#define OAIVirtualNodeData_status_H
...
class OAIVirtualNodeData_status : public OAIObject {
public:
    OAIVirtualNodeData_status();
    OAIVirtualNodeData_status(QString json);
    ~OAIVirtualNodeData_status() override;
    ...
    OAIVirtualNodeStatusCode getStatus() const;
    void setStatus(const OAIVirtualNodeStatusCode &status);
...
private:
    ...
    OAIVirtualNodeStatusCode m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNodeData_status)

#endif // OAIVirtualNodeData_status_H
