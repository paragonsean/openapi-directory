...
/*
 * OAICreateMesh_request.h
 *
 * 
 */

#ifndef OAICreateMesh_request_H
#define OAICreateMesh_request_H
...
class OAICreateMesh_request : public OAIObject {
public:
    OAICreateMesh_request();
    OAICreateMesh_request(QString json);
    ~OAICreateMesh_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMesh_request)

#endif // OAICreateMesh_request_H
