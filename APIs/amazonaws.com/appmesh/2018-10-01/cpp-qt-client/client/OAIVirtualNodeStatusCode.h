...
/*
 * OAIVirtualNodeStatusCode.h
 *
 * 
 */

#ifndef OAIVirtualNodeStatusCode_H
#define OAIVirtualNodeStatusCode_H
...
class OAIVirtualNodeStatusCode : public OAIEnum {
public:
    OAIVirtualNodeStatusCode();
    OAIVirtualNodeStatusCode(QString json);
    ~OAIVirtualNodeStatusCode() override;
    ...
    enum class eOAIVirtualNodeStatusCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        DELETED, 
        INACTIVE
    };
    OAIVirtualNodeStatusCode::eOAIVirtualNodeStatusCode getValue() const;
    void setValue(const OAIVirtualNodeStatusCode::eOAIVirtualNodeStatusCode& value);
...
private:
    ...
    eOAIVirtualNodeStatusCode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNodeStatusCode)

#endif // OAIVirtualNodeStatusCode_H
