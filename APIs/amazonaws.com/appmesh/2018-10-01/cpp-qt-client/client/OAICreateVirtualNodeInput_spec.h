...
/*
 * OAICreateVirtualNodeInput_spec.h
 *
 * 
 */

#ifndef OAICreateVirtualNodeInput_spec_H
#define OAICreateVirtualNodeInput_spec_H
...
class OAICreateVirtualNodeInput_spec : public OAIObject {
public:
    OAICreateVirtualNodeInput_spec();
    OAICreateVirtualNodeInput_spec(QString json);
    ~OAICreateVirtualNodeInput_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVirtualNodeInput_spec)

#endif // OAICreateVirtualNodeInput_spec_H
