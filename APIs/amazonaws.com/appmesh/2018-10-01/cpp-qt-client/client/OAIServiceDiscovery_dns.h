...
/*
 * OAIServiceDiscovery_dns.h
 *
 * 
 */

#ifndef OAIServiceDiscovery_dns_H
#define OAIServiceDiscovery_dns_H
...
class OAIServiceDiscovery_dns : public OAIObject {
public:
    OAIServiceDiscovery_dns();
    OAIServiceDiscovery_dns(QString json);
    ~OAIServiceDiscovery_dns() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceDiscovery_dns)

#endif // OAIServiceDiscovery_dns_H
