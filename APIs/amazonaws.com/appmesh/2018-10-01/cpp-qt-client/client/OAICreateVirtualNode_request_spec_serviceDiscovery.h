...
/*
 * OAICreateVirtualNode_request_spec_serviceDiscovery.h
 *
 * 
 */

#ifndef OAICreateVirtualNode_request_spec_serviceDiscovery_H
#define OAICreateVirtualNode_request_spec_serviceDiscovery_H
...
class OAICreateVirtualNode_request_spec_serviceDiscovery : public OAIObject {
public:
    OAICreateVirtualNode_request_spec_serviceDiscovery();
    OAICreateVirtualNode_request_spec_serviceDiscovery(QString json);
    ~OAICreateVirtualNode_request_spec_serviceDiscovery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVirtualNode_request_spec_serviceDiscovery)

#endif // OAICreateVirtualNode_request_spec_serviceDiscovery_H
