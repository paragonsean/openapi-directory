...
#ifndef OAIMeshStatus_H
#define OAIMeshStatus_H
...
class OAIMeshStatus : public OAIObject {
public:
    OAIMeshStatus();
    OAIMeshStatus(QString json);
    ~OAIMeshStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMeshStatus)

#endif // OAIMeshStatus_H
