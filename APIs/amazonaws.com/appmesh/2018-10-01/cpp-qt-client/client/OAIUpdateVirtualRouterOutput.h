...
/*
 * OAIUpdateVirtualRouterOutput.h
 *
 * 
 */

#ifndef OAIUpdateVirtualRouterOutput_H
#define OAIUpdateVirtualRouterOutput_H
...
namespace OpenAPI {
class OAIUpdateVirtualRouterOutput_virtualRouter;

class OAIUpdateVirtualRouterOutput : public OAIObject {
public:
    OAIUpdateVirtualRouterOutput();
    OAIUpdateVirtualRouterOutput(QString json);
    ~OAIUpdateVirtualRouterOutput() override;
    ...
    OAIUpdateVirtualRouterOutput_virtualRouter getVirtualRouter() const;
    void setVirtualRouter(const OAIUpdateVirtualRouterOutput_virtualRouter &virtual_router);
...
private:
    ...
    OAIUpdateVirtualRouterOutput_virtualRouter m_virtual_router;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVirtualRouterOutput)

#endif // OAIUpdateVirtualRouterOutput_H
