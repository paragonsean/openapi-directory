...
/*
 * OAIVirtualRouterSpec.h
 *
 * An object representing the specification of a virtual router.
 */

#ifndef OAIVirtualRouterSpec_H
#define OAIVirtualRouterSpec_H
...
class OAIVirtualRouterSpec : public OAIObject {
public:
    OAIVirtualRouterSpec();
    OAIVirtualRouterSpec(QString json);
    ~OAIVirtualRouterSpec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualRouterSpec)

#endif // OAIVirtualRouterSpec_H
