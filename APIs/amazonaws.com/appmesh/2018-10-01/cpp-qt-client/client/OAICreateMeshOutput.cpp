...
OAICreateMeshOutput::OAICreateMeshOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMeshOutput::OAICreateMeshOutput() {
    this->initializeModel();
}

OAICreateMeshOutput::~OAICreateMeshOutput() {}

void OAICreateMeshOutput::initializeModel() {

    m_mesh_isSet = false;
    m_mesh_isValid = false;
}

void OAICreateMeshOutput::fromJson(QString jsonString) {
...
QJsonObject OAICreateMeshOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_mesh.isSet()) {
...
OAICreateMeshOutput_mesh OAICreateMeshOutput::getMesh() const {
    return m_mesh;
}
void OAICreateMeshOutput::setMesh(const OAICreateMeshOutput_mesh &mesh) {
    m_mesh = mesh;
    m_mesh_isSet = true;
}

bool OAICreateMeshOutput::is_mesh_Set() const{
    return m_mesh_isSet;
}

bool OAICreateMeshOutput::is_mesh_Valid() const{
    return m_mesh_isValid;
}

bool OAICreateMeshOutput::isSet() const {
...
bool OAICreateMeshOutput::isValid() const {
