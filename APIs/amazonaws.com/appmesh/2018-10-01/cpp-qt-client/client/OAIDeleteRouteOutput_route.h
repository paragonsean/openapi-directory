...
/*
 * OAIDeleteRouteOutput_route.h
 *
 * 
 */

#ifndef OAIDeleteRouteOutput_route_H
#define OAIDeleteRouteOutput_route_H

#include <QJsonObject>

#include "OAIRouteData_metadata.h"
#include "OAIRouteData_spec.h"
#include "OAIRouteData_status.h"
#include <QString>
...
namespace OpenAPI {
class OAIRouteData_metadata;
class OAIRouteData_spec;
class OAIRouteData_status;

class OAIDeleteRouteOutput_route : public OAIObject {
public:
    OAIDeleteRouteOutput_route();
    OAIDeleteRouteOutput_route(QString json);
    ~OAIDeleteRouteOutput_route() override;
    ...
    OAIRouteData_metadata getMetadata() const;
    void setMetadata(const OAIRouteData_metadata &metadata);
    ...
    OAIRouteData_spec getSpec() const;
    void setSpec(const OAIRouteData_spec &spec);
    bool is_spec_Set() const;
    bool is_spec_Valid() const;

    OAIRouteData_status getStatus() const;
    void setStatus(const OAIRouteData_status &status);
...
private:
    ...
    OAIRouteData_metadata m_metadata;
    ...
    OAIRouteData_spec m_spec;
    bool m_spec_isSet;
    bool m_spec_isValid;

    OAIRouteData_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRouteOutput_route)

#endif // OAIDeleteRouteOutput_route_H
