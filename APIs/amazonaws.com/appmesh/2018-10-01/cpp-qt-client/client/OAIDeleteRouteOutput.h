...
/*
 * OAIDeleteRouteOutput.h
 *
 * 
 */

#ifndef OAIDeleteRouteOutput_H
#define OAIDeleteRouteOutput_H

#include <QJsonObject>

#include "OAIDeleteRouteOutput_route.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDeleteRouteOutput_route;

class OAIDeleteRouteOutput : public OAIObject {
public:
    OAIDeleteRouteOutput();
    OAIDeleteRouteOutput(QString json);
    ~OAIDeleteRouteOutput() override;
    ...
    OAIDeleteRouteOutput_route getRoute() const;
    void setRoute(const OAIDeleteRouteOutput_route &route);
...
private:
    ...
    OAIDeleteRouteOutput_route m_route;
    bool m_route_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRouteOutput)

#endif // OAIDeleteRouteOutput_H
