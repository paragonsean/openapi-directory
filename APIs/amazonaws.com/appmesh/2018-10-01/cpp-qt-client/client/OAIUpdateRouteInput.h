...
/*
 * OAIUpdateRouteInput.h
 *
 * 
 */

#ifndef OAIUpdateRouteInput_H
#define OAIUpdateRouteInput_H
...
namespace OpenAPI {
class OAIUpdateRouteInput_spec;

class OAIUpdateRouteInput : public OAIObject {
public:
    OAIUpdateRouteInput();
    OAIUpdateRouteInput(QString json);
    ~OAIUpdateRouteInput() override;
    ...
    OAIUpdateRouteInput_spec getSpec() const;
    void setSpec(const OAIUpdateRouteInput_spec &spec);
...
private:
    ...
    OAIUpdateRouteInput_spec m_spec;
    bool m_spec_isSet;
    bool m_spec_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRouteInput)

#endif // OAIUpdateRouteInput_H
