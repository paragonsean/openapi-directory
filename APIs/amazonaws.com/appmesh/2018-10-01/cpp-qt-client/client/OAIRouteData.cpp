...
OAIRouteData::OAIRouteData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRouteData::OAIRouteData() {
    this->initializeModel();
}

OAIRouteData::~OAIRouteData() {}

void OAIRouteData::initializeModel() {
...
void OAIRouteData::fromJson(QString jsonString) {
...
void OAIRouteData::fromJsonObject(QJsonObject json) {
...
QString OAIRouteData::asJson() const {
...
QJsonObject OAIRouteData::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRouteData::getMeshName() const {
    return m_mesh_name;
}
void OAIRouteData::setMeshName(const QString &mesh_name) {
    m_mesh_name = mesh_name;
    m_mesh_name_isSet = true;
}

bool OAIRouteData::is_mesh_name_Set() const{
    return m_mesh_name_isSet;
}

bool OAIRouteData::is_mesh_name_Valid() const{
    return m_mesh_name_isValid;
}

OAIRouteData_metadata OAIRouteData::getMetadata() const {
    return m_metadata;
}
void OAIRouteData::setMetadata(const OAIRouteData_metadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIRouteData::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIRouteData::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIRouteData::getRouteName() const {
    return m_route_name;
}
void OAIRouteData::setRouteName(const QString &route_name) {
    m_route_name = route_name;
    m_route_name_isSet = true;
}

bool OAIRouteData::is_route_name_Set() const{
    return m_route_name_isSet;
}

bool OAIRouteData::is_route_name_Valid() const{
    return m_route_name_isValid;
}

OAIRouteData_spec OAIRouteData::getSpec() const {
    return m_spec;
}
void OAIRouteData::setSpec(const OAIRouteData_spec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIRouteData::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIRouteData::is_spec_Valid() const{
    return m_spec_isValid;
}

OAIRouteData_status OAIRouteData::getStatus() const {
    return m_status;
}
void OAIRouteData::setStatus(const OAIRouteData_status &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRouteData::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRouteData::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIRouteData::getVirtualRouterName() const {
    return m_virtual_router_name;
}
void OAIRouteData::setVirtualRouterName(const QString &virtual_router_name) {
    m_virtual_router_name = virtual_router_name;
    m_virtual_router_name_isSet = true;
}

bool OAIRouteData::is_virtual_router_name_Set() const{
    return m_virtual_router_name_isSet;
}

bool OAIRouteData::is_virtual_router_name_Valid() const{
    return m_virtual_router_name_isValid;
}

bool OAIRouteData::isSet() const {
...
bool OAIRouteData::isValid() const {
