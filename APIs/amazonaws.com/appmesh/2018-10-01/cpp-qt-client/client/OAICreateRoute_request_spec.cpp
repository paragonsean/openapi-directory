...
#include "OAICreateRoute_request_spec.h"
...
OAICreateRoute_request_spec::OAICreateRoute_request_spec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoute_request_spec::OAICreateRoute_request_spec() {
    this->initializeModel();
}

OAICreateRoute_request_spec::~OAICreateRoute_request_spec() {}

void OAICreateRoute_request_spec::initializeModel() {

    m_http_route_isSet = false;
    m_http_route_isValid = false;
}

void OAICreateRoute_request_spec::fromJson(QString jsonString) {
...
void OAICreateRoute_request_spec::fromJsonObject(QJsonObject json) {
...
QString OAICreateRoute_request_spec::asJson() const {
...
QJsonObject OAICreateRoute_request_spec::asJsonObject() const {
    QJsonObject obj;
...
OAICreateRoute_request_spec_httpRoute OAICreateRoute_request_spec::getHttpRoute() const {
    return m_http_route;
}
void OAICreateRoute_request_spec::setHttpRoute(const OAICreateRoute_request_spec_httpRoute &http_route) {
    m_http_route = http_route;
    m_http_route_isSet = true;
}

bool OAICreateRoute_request_spec::is_http_route_Set() const{
    return m_http_route_isSet;
}

bool OAICreateRoute_request_spec::is_http_route_Valid() const{
    return m_http_route_isValid;
}

bool OAICreateRoute_request_spec::isSet() const {
...
bool OAICreateRoute_request_spec::isValid() const {
