...
OAIDeleteMeshOutput::OAIDeleteMeshOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMeshOutput::OAIDeleteMeshOutput() {
    this->initializeModel();
}

OAIDeleteMeshOutput::~OAIDeleteMeshOutput() {}

void OAIDeleteMeshOutput::initializeModel() {

    m_mesh_isSet = false;
    m_mesh_isValid = false;
}

void OAIDeleteMeshOutput::fromJson(QString jsonString) {
...
QJsonObject OAIDeleteMeshOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_mesh.isSet()) {
...
OAIDeleteMeshOutput_mesh OAIDeleteMeshOutput::getMesh() const {
    return m_mesh;
}
void OAIDeleteMeshOutput::setMesh(const OAIDeleteMeshOutput_mesh &mesh) {
    m_mesh = mesh;
    m_mesh_isSet = true;
}

bool OAIDeleteMeshOutput::is_mesh_Set() const{
    return m_mesh_isSet;
}

bool OAIDeleteMeshOutput::is_mesh_Valid() const{
    return m_mesh_isValid;
}

bool OAIDeleteMeshOutput::isSet() const {
...
bool OAIDeleteMeshOutput::isValid() const {
