...
/*
 * OAIDescribeRouteOutput.h
 *
 * 
 */

#ifndef OAIDescribeRouteOutput_H
#define OAIDescribeRouteOutput_H
...
namespace OpenAPI {
class OAIDescribeRouteOutput_route;

class OAIDescribeRouteOutput : public OAIObject {
public:
    OAIDescribeRouteOutput();
    OAIDescribeRouteOutput(QString json);
    ~OAIDescribeRouteOutput() override;
    ...
    OAIDescribeRouteOutput_route getRoute() const;
    void setRoute(const OAIDescribeRouteOutput_route &route);
...
private:
    ...
    OAIDescribeRouteOutput_route m_route;
    bool m_route_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRouteOutput)

#endif // OAIDescribeRouteOutput_H
