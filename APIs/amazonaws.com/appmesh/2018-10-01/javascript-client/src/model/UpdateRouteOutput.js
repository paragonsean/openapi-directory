...
import UpdateRouteOutputRoute from './UpdateRouteOutputRoute';

/**
 * The UpdateRouteOutput model module.
 * @module model/UpdateRouteOutput
 * @version 2018-10-01
 */
class UpdateRouteOutput {
    /**
     * Constructs a new <code>UpdateRouteOutput</code>.
     * 
     * @alias module:model/UpdateRouteOutput
     */
    constructor() { 
        
        UpdateRouteOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateRouteOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRouteOutput} obj Optional instance to populate.
     * @return {module:model/UpdateRouteOutput} The populated <code>UpdateRouteOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRouteOutput();

            if (data.hasOwnProperty('route')) {
                obj['route'] = UpdateRouteOutputRoute.constructFromObject(data['route']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRouteOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRouteOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `route`
        if (data['route']) { // data not null
          UpdateRouteOutputRoute.validateJSON(data['route']);
        }
...
/**
 * @member {module:model/UpdateRouteOutputRoute} route
 */
UpdateRouteOutput.prototype['route'] = undefined;
...
export default UpdateRouteOutput;
