...
/**
 * The MeshStatus model module.
 * @module model/MeshStatus
 * @version 2018-10-01
 */
class MeshStatus {
    /**
     * Constructs a new <code>MeshStatus</code>.
     * An object representing the status of a service mesh.
     * @alias module:model/MeshStatus
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MeshStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MeshStatus} obj Optional instance to populate.
     * @return {module:model/MeshStatus} The populated <code>MeshStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeshStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>MeshStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeshStatus</code>.
     */
