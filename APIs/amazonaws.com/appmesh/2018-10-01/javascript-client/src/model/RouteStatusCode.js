...
* @readonly
*/
export default class RouteStatusCode {
    ...
    /**
    * Returns a <code>RouteStatusCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RouteStatusCode} The enum <code>RouteStatusCode</code> value.
    */
