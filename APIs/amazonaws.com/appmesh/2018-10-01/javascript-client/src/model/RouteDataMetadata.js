...
/**
 * The RouteDataMetadata model module.
 * @module model/RouteDataMetadata
 * @version 2018-10-01
 */
class RouteDataMetadata {
    /**
     * Constructs a new <code>RouteDataMetadata</code>.
     * @alias module:model/RouteDataMetadata
     * @implements module:model/ResourceMetadata
     */
    constructor() { 
        ResourceMetadata.initialize(this);
        RouteDataMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RouteDataMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RouteDataMetadata} obj Optional instance to populate.
     * @return {module:model/RouteDataMetadata} The populated <code>RouteDataMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RouteDataMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>RouteDataMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RouteDataMetadata</code>.
     */
 ...
 * @member {String} arn
 */
RouteDataMetadata.prototype['arn'] = undefined;

/**
 * @member {Date} createdAt
 */
RouteDataMetadata.prototype['createdAt'] = undefined;

/**
 * @member {Date} lastUpdatedAt
 */
RouteDataMetadata.prototype['lastUpdatedAt'] = undefined;

/**
 * @member {String} uid
 */
RouteDataMetadata.prototype['uid'] = undefined;

/**
 * @member {Number} version
 */
RouteDataMetadata.prototype['version'] = undefined;
...
export default RouteDataMetadata;
