...
import DeleteMeshOutputMesh from './DeleteMeshOutputMesh';

/**
 * The DeleteMeshOutput model module.
 * @module model/DeleteMeshOutput
 * @version 2018-10-01
 */
class DeleteMeshOutput {
    /**
     * Constructs a new <code>DeleteMeshOutput</code>.
     * 
     * @alias module:model/DeleteMeshOutput
     */
    constructor() { 
        
        DeleteMeshOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteMeshOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMeshOutput} obj Optional instance to populate.
     * @return {module:model/DeleteMeshOutput} The populated <code>DeleteMeshOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMeshOutput();

            if (data.hasOwnProperty('mesh')) {
                obj['mesh'] = DeleteMeshOutputMesh.constructFromObject(data['mesh']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMeshOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMeshOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `mesh`
        if (data['mesh']) { // data not null
          DeleteMeshOutputMesh.validateJSON(data['mesh']);
        }
...
/**
 * @member {module:model/DeleteMeshOutputMesh} mesh
 */
DeleteMeshOutput.prototype['mesh'] = undefined;
...
export default DeleteMeshOutput;
