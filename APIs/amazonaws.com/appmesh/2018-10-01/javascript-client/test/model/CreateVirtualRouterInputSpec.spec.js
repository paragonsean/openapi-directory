...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateVirtualRouterInputSpec();
  });
  ...
  describe('CreateVirtualRouterInputSpec', function() {
    it('should create an instance of CreateVirtualRouterInputSpec', function() {
      // uncomment below and update the code to test CreateVirtualRouterInputSpec
      //var instance = new AwsAppMesh.CreateVirtualRouterInputSpec();
      //expect(instance).to.be.a(AwsAppMesh.CreateVirtualRouterInputSpec);
    });
