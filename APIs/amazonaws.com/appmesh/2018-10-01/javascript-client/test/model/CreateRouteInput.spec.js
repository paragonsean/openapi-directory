...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateRouteInput();
  });
  ...
  describe('CreateRouteInput', function() {
    it('should create an instance of CreateRouteInput', function() {
      // uncomment below and update the code to test CreateRouteInput
      //var instance = new AwsAppMesh.CreateRouteInput();
      //expect(instance).to.be.a(AwsAppMesh.CreateRouteInput);
    });
