...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DeleteRouteOutput();
  });
  ...
  describe('DeleteRouteOutput', function() {
    it('should create an instance of DeleteRouteOutput', function() {
      // uncomment below and update the code to test DeleteRouteOutput
      //var instance = new AwsAppMesh.DeleteRouteOutput();
      //expect(instance).to.be.a(AwsAppMesh.DeleteRouteOutput);
    });
