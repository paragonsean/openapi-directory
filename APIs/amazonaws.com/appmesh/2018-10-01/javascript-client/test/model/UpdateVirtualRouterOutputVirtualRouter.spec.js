...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateVirtualRouterOutputVirtualRouter();
  });
  ...
  describe('UpdateVirtualRouterOutputVirtualRouter', function() {
    it('should create an instance of UpdateVirtualRouterOutputVirtualRouter', function() {
      // uncomment below and update the code to test UpdateVirtualRouterOutputVirtualRouter
      //var instance = new AwsAppMesh.UpdateVirtualRouterOutputVirtualRouter();
      //expect(instance).to.be.a(AwsAppMesh.UpdateVirtualRouterOutputVirtualRouter);
    });
