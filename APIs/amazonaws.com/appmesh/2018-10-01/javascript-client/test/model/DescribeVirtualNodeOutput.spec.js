...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DescribeVirtualNodeOutput();
  });
  ...
  describe('DescribeVirtualNodeOutput', function() {
    it('should create an instance of DescribeVirtualNodeOutput', function() {
      // uncomment below and update the code to test DescribeVirtualNodeOutput
      //var instance = new AwsAppMesh.DescribeVirtualNodeOutput();
      //expect(instance).to.be.a(AwsAppMesh.DescribeVirtualNodeOutput);
    });
