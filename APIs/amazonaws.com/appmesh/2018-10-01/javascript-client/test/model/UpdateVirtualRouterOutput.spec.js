...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateVirtualRouterOutput();
  });
  ...
  describe('UpdateVirtualRouterOutput', function() {
    it('should create an instance of UpdateVirtualRouterOutput', function() {
      // uncomment below and update the code to test UpdateVirtualRouterOutput
      //var instance = new AwsAppMesh.UpdateVirtualRouterOutput();
      //expect(instance).to.be.a(AwsAppMesh.UpdateVirtualRouterOutput);
    });
