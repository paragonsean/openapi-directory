...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.RouteSpec();
  });
  ...
  describe('RouteSpec', function() {
    it('should create an instance of RouteSpec', function() {
      // uncomment below and update the code to test RouteSpec
      //var instance = new AwsAppMesh.RouteSpec();
      //expect(instance).to.be.a(AwsAppMesh.RouteSpec);
    });
