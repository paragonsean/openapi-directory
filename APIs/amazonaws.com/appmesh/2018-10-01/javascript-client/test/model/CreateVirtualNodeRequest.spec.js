...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateVirtualNodeRequest();
  });
  ...
  describe('CreateVirtualNodeRequest', function() {
    it('should create an instance of CreateVirtualNodeRequest', function() {
      // uncomment below and update the code to test CreateVirtualNodeRequest
      //var instance = new AwsAppMesh.CreateVirtualNodeRequest();
      //expect(instance).to.be.a(AwsAppMesh.CreateVirtualNodeRequest);
    });
