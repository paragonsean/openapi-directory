...
(function(root, factory) {
  ...
  describe('VirtualRouterStatusCode', function() {
    it('should create an instance of VirtualRouterStatusCode', function() {
      // uncomment below and update the code to test VirtualRouterStatusCode
      //var instance = new AwsAppMesh.VirtualRouterStatusCode();
      //expect(instance).to.be.a(AwsAppMesh.VirtualRouterStatusCode);
    });
