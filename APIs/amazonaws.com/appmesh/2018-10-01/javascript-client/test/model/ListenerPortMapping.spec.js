...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListenerPortMapping();
  });
  ...
  describe('ListenerPortMapping', function() {
    it('should create an instance of ListenerPortMapping', function() {
      // uncomment below and update the code to test ListenerPortMapping
      //var instance = new AwsAppMesh.ListenerPortMapping();
      //expect(instance).to.be.a(AwsAppMesh.ListenerPortMapping);
    });
