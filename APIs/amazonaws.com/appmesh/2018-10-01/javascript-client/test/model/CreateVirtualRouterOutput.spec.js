...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateVirtualRouterOutput();
  });
  ...
  describe('CreateVirtualRouterOutput', function() {
    it('should create an instance of CreateVirtualRouterOutput', function() {
      // uncomment below and update the code to test CreateVirtualRouterOutput
      //var instance = new AwsAppMesh.CreateVirtualRouterOutput();
      //expect(instance).to.be.a(AwsAppMesh.CreateVirtualRouterOutput);
    });

    it('should have the property virtualRouter (base name: "virtualRouter")', function() {
      // uncomment below and update the code to test the property virtualRouter
      //var instance = new AwsAppMesh.CreateVirtualRouterOutput();
