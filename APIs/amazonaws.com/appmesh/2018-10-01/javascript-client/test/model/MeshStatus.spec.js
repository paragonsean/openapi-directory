...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.MeshStatus();
  });
  ...
  describe('MeshStatus', function() {
    it('should create an instance of MeshStatus', function() {
      // uncomment below and update the code to test MeshStatus
      //var instance = new AwsAppMesh.MeshStatus();
      //expect(instance).to.be.a(AwsAppMesh.MeshStatus);
    });
