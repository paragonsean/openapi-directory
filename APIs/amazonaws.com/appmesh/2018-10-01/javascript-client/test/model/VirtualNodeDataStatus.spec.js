...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualNodeDataStatus();
  });
  ...
  describe('VirtualNodeDataStatus', function() {
    it('should create an instance of VirtualNodeDataStatus', function() {
      // uncomment below and update the code to test VirtualNodeDataStatus
      //var instance = new AwsAppMesh.VirtualNodeDataStatus();
      //expect(instance).to.be.a(AwsAppMesh.VirtualNodeDataStatus);
    });
