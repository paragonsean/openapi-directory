...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateRouteOutputRoute();
  });
  ...
  describe('CreateRouteOutputRoute', function() {
    it('should create an instance of CreateRouteOutputRoute', function() {
      // uncomment below and update the code to test CreateRouteOutputRoute
      //var instance = new AwsAppMesh.CreateRouteOutputRoute();
      //expect(instance).to.be.a(AwsAppMesh.CreateRouteOutputRoute);
    });
