...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DescribeVirtualRouterOutputVirtualRouter();
  });
  ...
  describe('DescribeVirtualRouterOutputVirtualRouter', function() {
    it('should create an instance of DescribeVirtualRouterOutputVirtualRouter', function() {
      // uncomment below and update the code to test DescribeVirtualRouterOutputVirtualRouter
      //var instance = new AwsAppMesh.DescribeVirtualRouterOutputVirtualRouter();
      //expect(instance).to.be.a(AwsAppMesh.DescribeVirtualRouterOutputVirtualRouter);
    });
