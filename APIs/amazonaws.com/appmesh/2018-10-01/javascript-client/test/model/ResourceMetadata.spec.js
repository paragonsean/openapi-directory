...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ResourceMetadata();
  });
  ...
  describe('ResourceMetadata', function() {
    it('should create an instance of ResourceMetadata', function() {
      // uncomment below and update the code to test ResourceMetadata
      //var instance = new AwsAppMesh.ResourceMetadata();
      //expect(instance).to.be.a(AwsAppMesh.ResourceMetadata);
    });
