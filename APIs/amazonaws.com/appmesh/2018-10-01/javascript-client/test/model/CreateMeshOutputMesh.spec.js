...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateMeshOutputMesh();
  });
  ...
  describe('CreateMeshOutputMesh', function() {
    it('should create an instance of CreateMeshOutputMesh', function() {
      // uncomment below and update the code to test CreateMeshOutputMesh
      //var instance = new AwsAppMesh.CreateMeshOutputMesh();
      //expect(instance).to.be.a(AwsAppMesh.CreateMeshOutputMesh);
    });
