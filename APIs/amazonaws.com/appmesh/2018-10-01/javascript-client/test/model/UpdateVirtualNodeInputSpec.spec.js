...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateVirtualNodeInputSpec();
  });
  ...
  describe('UpdateVirtualNodeInputSpec', function() {
    it('should create an instance of UpdateVirtualNodeInputSpec', function() {
      // uncomment below and update the code to test UpdateVirtualNodeInputSpec
      //var instance = new AwsAppMesh.UpdateVirtualNodeInputSpec();
      //expect(instance).to.be.a(AwsAppMesh.UpdateVirtualNodeInputSpec);
    });
