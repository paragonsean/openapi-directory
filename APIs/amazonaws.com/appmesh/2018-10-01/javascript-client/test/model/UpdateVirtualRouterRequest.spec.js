...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateVirtualRouterRequest();
  });
  ...
  describe('UpdateVirtualRouterRequest', function() {
    it('should create an instance of UpdateVirtualRouterRequest', function() {
      // uncomment below and update the code to test UpdateVirtualRouterRequest
      //var instance = new AwsAppMesh.UpdateVirtualRouterRequest();
      //expect(instance).to.be.a(AwsAppMesh.UpdateVirtualRouterRequest);
    });
