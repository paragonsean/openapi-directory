...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.MeshData();
  });
  ...
  describe('MeshData', function() {
    it('should create an instance of MeshData', function() {
      // uncomment below and update the code to test MeshData
      //var instance = new AwsAppMesh.MeshData();
      //expect(instance).to.be.a(AwsAppMesh.MeshData);
    });
