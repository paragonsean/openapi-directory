...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateVirtualRouterInputSpec();
  });
  ...
  describe('UpdateVirtualRouterInputSpec', function() {
    it('should create an instance of UpdateVirtualRouterInputSpec', function() {
      // uncomment below and update the code to test UpdateVirtualRouterInputSpec
      //var instance = new AwsAppMesh.UpdateVirtualRouterInputSpec();
      //expect(instance).to.be.a(AwsAppMesh.UpdateVirtualRouterInputSpec);
    });
