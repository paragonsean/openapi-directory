...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateVirtualNodeOutput();
  });
  ...
  describe('UpdateVirtualNodeOutput', function() {
    it('should create an instance of UpdateVirtualNodeOutput', function() {
      // uncomment below and update the code to test UpdateVirtualNodeOutput
      //var instance = new AwsAppMesh.UpdateVirtualNodeOutput();
      //expect(instance).to.be.a(AwsAppMesh.UpdateVirtualNodeOutput);
    });
