...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateVirtualNodeInput();
  });
  ...
  describe('CreateVirtualNodeInput', function() {
    it('should create an instance of CreateVirtualNodeInput', function() {
      // uncomment below and update the code to test CreateVirtualNodeInput
      //var instance = new AwsAppMesh.CreateVirtualNodeInput();
      //expect(instance).to.be.a(AwsAppMesh.CreateVirtualNodeInput);
    });
