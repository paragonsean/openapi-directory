...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateRouteInput();
  });
  ...
  describe('UpdateRouteInput', function() {
    it('should create an instance of UpdateRouteInput', function() {
      // uncomment below and update the code to test UpdateRouteInput
      //var instance = new AwsAppMesh.UpdateRouteInput();
      //expect(instance).to.be.a(AwsAppMesh.UpdateRouteInput);
    });
