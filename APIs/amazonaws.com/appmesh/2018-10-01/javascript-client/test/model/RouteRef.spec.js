...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.RouteRef();
  });
  ...
  describe('RouteRef', function() {
    it('should create an instance of RouteRef', function() {
      // uncomment below and update the code to test RouteRef
      //var instance = new AwsAppMesh.RouteRef();
      //expect(instance).to.be.a(AwsAppMesh.RouteRef);
    });
