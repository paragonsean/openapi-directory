...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateRouteInputSpec();
  });
  ...
  describe('UpdateRouteInputSpec', function() {
    it('should create an instance of UpdateRouteInputSpec', function() {
      // uncomment below and update the code to test UpdateRouteInputSpec
      //var instance = new AwsAppMesh.UpdateRouteInputSpec();
      //expect(instance).to.be.a(AwsAppMesh.UpdateRouteInputSpec);
    });

    it('should have the property httpRoute (base name: "httpRoute")', function() {
      // uncomment below and update the code to test the property httpRoute
      //var instance = new AwsAppMesh.UpdateRouteInputSpec();
