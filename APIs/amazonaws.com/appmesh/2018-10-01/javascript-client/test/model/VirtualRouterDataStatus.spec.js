...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualRouterDataStatus();
  });
  ...
  describe('VirtualRouterDataStatus', function() {
    it('should create an instance of VirtualRouterDataStatus', function() {
      // uncomment below and update the code to test VirtualRouterDataStatus
      //var instance = new AwsAppMesh.VirtualRouterDataStatus();
      //expect(instance).to.be.a(AwsAppMesh.VirtualRouterDataStatus);
    });
