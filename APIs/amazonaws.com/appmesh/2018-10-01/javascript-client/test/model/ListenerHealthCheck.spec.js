...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListenerHealthCheck();
  });
  ...
  describe('ListenerHealthCheck', function() {
    it('should create an instance of ListenerHealthCheck', function() {
      // uncomment below and update the code to test ListenerHealthCheck
      //var instance = new AwsAppMesh.ListenerHealthCheck();
      //expect(instance).to.be.a(AwsAppMesh.ListenerHealthCheck);
    });
    ...
    it('should have the property intervalMillis (base name: "intervalMillis")', function() {
      // uncomment below and update the code to test the property intervalMillis
      //var instance = new AwsAppMesh.ListenerHealthCheck();
      //expect(instance).to.be();
    });
    ...
    it('should have the property timeoutMillis (base name: "timeoutMillis")', function() {
      // uncomment below and update the code to test the property timeoutMillis
      //var instance = new AwsAppMesh.ListenerHealthCheck();
      //expect(instance).to.be();
    });
