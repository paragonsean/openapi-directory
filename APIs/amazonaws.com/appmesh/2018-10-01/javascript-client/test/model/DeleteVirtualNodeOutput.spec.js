...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DeleteVirtualNodeOutput();
  });
  ...
  describe('DeleteVirtualNodeOutput', function() {
    it('should create an instance of DeleteVirtualNodeOutput', function() {
      // uncomment below and update the code to test DeleteVirtualNodeOutput
      //var instance = new AwsAppMesh.DeleteVirtualNodeOutput();
      //expect(instance).to.be.a(AwsAppMesh.DeleteVirtualNodeOutput);
    });
