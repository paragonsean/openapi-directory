...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateRouteRequest();
  });
  ...
  describe('CreateRouteRequest', function() {
    it('should create an instance of CreateRouteRequest', function() {
      // uncomment below and update the code to test CreateRouteRequest
      //var instance = new AwsAppMesh.CreateRouteRequest();
      //expect(instance).to.be.a(AwsAppMesh.CreateRouteRequest);
    });
