...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListVirtualNodesOutput();
  });
  ...
  describe('ListVirtualNodesOutput', function() {
    it('should create an instance of ListVirtualNodesOutput', function() {
      // uncomment below and update the code to test ListVirtualNodesOutput
      //var instance = new AwsAppMesh.ListVirtualNodesOutput();
      //expect(instance).to.be.a(AwsAppMesh.ListVirtualNodesOutput);
    });
    ...
    it('should have the property virtualNodes (base name: "virtualNodes")', function() {
      // uncomment below and update the code to test the property virtualNodes
      //var instance = new AwsAppMesh.ListVirtualNodesOutput();
      //expect(instance).to.be();
    });
