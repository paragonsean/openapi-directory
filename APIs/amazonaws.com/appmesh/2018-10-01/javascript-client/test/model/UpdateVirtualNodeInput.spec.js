...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateVirtualNodeInput();
  });
  ...
  describe('UpdateVirtualNodeInput', function() {
    it('should create an instance of UpdateVirtualNodeInput', function() {
      // uncomment below and update the code to test UpdateVirtualNodeInput
      //var instance = new AwsAppMesh.UpdateVirtualNodeInput();
      //expect(instance).to.be.a(AwsAppMesh.UpdateVirtualNodeInput);
    });
