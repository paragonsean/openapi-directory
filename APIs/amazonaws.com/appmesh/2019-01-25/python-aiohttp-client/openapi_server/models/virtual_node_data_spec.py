...
class VirtualNodeDataSpec(Model):
    ...
    def __init__(self, backend_defaults: CreateVirtualNodeRequestSpecBackendDefaults=None, backends: List=None, listeners: List=None, logging: CreateVirtualNodeRequestSpecLogging=None, service_discovery: CreateVirtualNodeRequestSpecServiceDiscovery=None):
        ...
        :param backend_defaults: The backend_defaults of this VirtualNodeDataSpec.
        :param backends: The backends of this VirtualNodeDataSpec.
        :param listeners: The listeners of this VirtualNodeDataSpec.
        :param logging: The logging of this VirtualNodeDataSpec.
    ...
    def backend_defaults(self):
        """Gets the backend_defaults of this VirtualNodeDataSpec.


        :return: The backend_defaults of this VirtualNodeDataSpec.
    ...
    def backend_defaults(self, backend_defaults):
        """Sets the backend_defaults of this VirtualNodeDataSpec.
    ...
    @property
    def logging(self):
        """Gets the logging of this VirtualNodeDataSpec.


        :return: The logging of this VirtualNodeDataSpec.
    ...
    def logging(self, logging):
        """Sets the logging of this VirtualNodeDataSpec.
