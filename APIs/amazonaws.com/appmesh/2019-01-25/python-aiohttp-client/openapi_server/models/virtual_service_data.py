...
class VirtualServiceData(Model):
    ...
    def __init__(self, mesh_name: str=None, metadata: ResourceMetadata=None, spec: VirtualServiceDataSpec=None, status: VirtualServiceDataStatus=None, virtual_service_name: str=None):
        """VirtualServiceData - a model defined in OpenAPI

        :param mesh_name: The mesh_name of this VirtualServiceData.
        :param metadata: The metadata of this VirtualServiceData.
        :param spec: The spec of this VirtualServiceData.
        :param status: The status of this VirtualServiceData.
        :param virtual_service_name: The virtual_service_name of this VirtualServiceData.
        """
        self.openapi_types = {
            'mesh_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VirtualServiceData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The VirtualServiceData of this VirtualServiceData.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def mesh_name(self):
        """Gets the mesh_name of this VirtualServiceData.


        :return: The mesh_name of this VirtualServiceData.
        :rtype: str
        """
    ...
    def mesh_name(self, mesh_name):
        """Sets the mesh_name of this VirtualServiceData.
    ...
    @property
    def metadata(self):
        """Gets the metadata of this VirtualServiceData.


        :return: The metadata of this VirtualServiceData.
    ...
    def metadata(self, metadata):
        """Sets the metadata of this VirtualServiceData.
    ...
    @property
    def spec(self):
        """Gets the spec of this VirtualServiceData.


        :return: The spec of this VirtualServiceData.
    ...
    @spec.setter
    def spec(self, spec):
        """Sets the spec of this VirtualServiceData.
    ...
    @property
    def status(self):
        """Gets the status of this VirtualServiceData.


        :return: The status of this VirtualServiceData.
    ...
    def status(self, status):
        """Sets the status of this VirtualServiceData.
    ...
    def virtual_service_name(self):
        """Gets the virtual_service_name of this VirtualServiceData.


        :return: The virtual_service_name of this VirtualServiceData.
        :rtype: str
        """
    ...
    def virtual_service_name(self, virtual_service_name):
        """Sets the virtual_service_name of this VirtualServiceData.
