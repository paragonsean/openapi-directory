...
class CreateGatewayRouteRequestSpec(Model):
    ...
    def __init__(self, grpc_route: CreateGatewayRouteRequestSpecGrpcRoute=None, http2_route: CreateGatewayRouteRequestSpecHttp2Route=None, http_route: CreateGatewayRouteRequestSpecHttpRoute=None, priority: int=None):
        """CreateGatewayRouteRequestSpec - a model defined in OpenAPI

        :param grpc_route: The grpc_route of this CreateGatewayRouteRequestSpec.
        :param http2_route: The http2_route of this CreateGatewayRouteRequestSpec.
        :param http_route: The http_route of this CreateGatewayRouteRequestSpec.
        :param priority: The priority of this CreateGatewayRouteRequestSpec.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateGatewayRouteRequestSpec':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateGatewayRoute_request_spec of this CreateGatewayRouteRequestSpec.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def grpc_route(self):
        """Gets the grpc_route of this CreateGatewayRouteRequestSpec.


        :return: The grpc_route of this CreateGatewayRouteRequestSpec.
    ...
    def grpc_route(self, grpc_route):
        """Sets the grpc_route of this CreateGatewayRouteRequestSpec.
    ...
    def http2_route(self):
        """Gets the http2_route of this CreateGatewayRouteRequestSpec.


        :return: The http2_route of this CreateGatewayRouteRequestSpec.
    ...
    def http2_route(self, http2_route):
        """Sets the http2_route of this CreateGatewayRouteRequestSpec.
    ...
    @property
    def http_route(self):
        """Gets the http_route of this CreateGatewayRouteRequestSpec.


        :return: The http_route of this CreateGatewayRouteRequestSpec.
    ...
    def http_route(self, http_route):
        """Sets the http_route of this CreateGatewayRouteRequestSpec.
    ...
    @property
    def priority(self):
        """Gets the priority of this CreateGatewayRouteRequestSpec.


        :return: The priority of this CreateGatewayRouteRequestSpec.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this CreateGatewayRouteRequestSpec.
