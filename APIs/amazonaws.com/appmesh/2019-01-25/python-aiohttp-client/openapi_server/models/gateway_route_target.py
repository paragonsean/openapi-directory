...
class GatewayRouteTarget(Model):
    ...
    def __init__(self, port: int=None, virtual_service: GatewayRouteTargetVirtualService=None):
        """GatewayRouteTarget - a model defined in OpenAPI

        :param port: The port of this GatewayRouteTarget.
        :param virtual_service: The virtual_service of this GatewayRouteTarget.
        """
        self.openapi_types = {
            'port': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GatewayRouteTarget':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GatewayRouteTarget of this GatewayRouteTarget.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def port(self):
        """Gets the port of this GatewayRouteTarget.


        :return: The port of this GatewayRouteTarget.
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this GatewayRouteTarget.
    ...
    def virtual_service(self):
        """Gets the virtual_service of this GatewayRouteTarget.


        :return: The virtual_service of this GatewayRouteTarget.
    ...
    def virtual_service(self, virtual_service):
        """Sets the virtual_service of this GatewayRouteTarget.
