...
class MeshSpec(Model):
    ...
    def __init__(self, egress_filter: CreateMeshRequestSpecEgressFilter=None, service_discovery: MeshServiceDiscovery=None):
        """MeshSpec - a model defined in OpenAPI

        :param egress_filter: The egress_filter of this MeshSpec.
        :param service_discovery: The service_discovery of this MeshSpec.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MeshSpec':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MeshSpec of this MeshSpec.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def egress_filter(self):
        """Gets the egress_filter of this MeshSpec.


        :return: The egress_filter of this MeshSpec.
    ...
    def egress_filter(self, egress_filter):
        """Sets the egress_filter of this MeshSpec.
    ...
    def service_discovery(self):
        """Gets the service_discovery of this MeshSpec.


        :return: The service_discovery of this MeshSpec.
    ...
    def service_discovery(self, service_discovery):
        """Sets the service_discovery of this MeshSpec.
