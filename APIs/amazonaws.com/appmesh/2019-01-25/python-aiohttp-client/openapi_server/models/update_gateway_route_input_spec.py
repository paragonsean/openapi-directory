...
class UpdateGatewayRouteInputSpec(Model):
    ...
    def __init__(self, grpc_route: CreateGatewayRouteRequestSpecGrpcRoute=None, http2_route: CreateGatewayRouteRequestSpecHttp2Route=None, http_route: CreateGatewayRouteRequestSpecHttpRoute=None, priority: int=None):
        """UpdateGatewayRouteInputSpec - a model defined in OpenAPI

        :param grpc_route: The grpc_route of this UpdateGatewayRouteInputSpec.
        :param http2_route: The http2_route of this UpdateGatewayRouteInputSpec.
        :param http_route: The http_route of this UpdateGatewayRouteInputSpec.
        :param priority: The priority of this UpdateGatewayRouteInputSpec.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateGatewayRouteInputSpec':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateGatewayRouteInput_spec of this UpdateGatewayRouteInputSpec.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def grpc_route(self):
        """Gets the grpc_route of this UpdateGatewayRouteInputSpec.


        :return: The grpc_route of this UpdateGatewayRouteInputSpec.
    ...
    def grpc_route(self, grpc_route):
        """Sets the grpc_route of this UpdateGatewayRouteInputSpec.
    ...
    def http2_route(self):
        """Gets the http2_route of this UpdateGatewayRouteInputSpec.


        :return: The http2_route of this UpdateGatewayRouteInputSpec.
    ...
    def http2_route(self, http2_route):
        """Sets the http2_route of this UpdateGatewayRouteInputSpec.
    ...
    @property
    def http_route(self):
        """Gets the http_route of this UpdateGatewayRouteInputSpec.


        :return: The http_route of this UpdateGatewayRouteInputSpec.
    ...
    def http_route(self, http_route):
        """Sets the http_route of this UpdateGatewayRouteInputSpec.
    ...
    @property
    def priority(self):
        """Gets the priority of this UpdateGatewayRouteInputSpec.


        :return: The priority of this UpdateGatewayRouteInputSpec.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this UpdateGatewayRouteInputSpec.
