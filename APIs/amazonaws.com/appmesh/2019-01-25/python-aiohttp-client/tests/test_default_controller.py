...
async def test_create_gateway_route(client):
    """Test case for create_gateway_route

    
    """
    body = openapi_server.CreateGatewayRouteRequest()
    params = [('meshOwner', 'mesh_owner_example')]
    headers = { 
    ...
    response = await client.request(
        method='PUT',
        path='/v20190125/meshes/{mesh_name}/virtualGateway/{virtual_gateway_name}/gatewayRoutes'.format(mesh_name='mesh_name_example', virtual_gateway_name='virtual_gateway_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_create_route(client):
    ...
    response = await client.request(
        method='PUT',
        path='/v20190125/meshes/{mesh_name}/virtualRouter/{virtual_router_name}/routes'.format(mesh_name='mesh_name_example', virtual_router_name='virtual_router_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_create_virtual_gateway(client):
    """Test case for create_virtual_gateway

    
    """
    body = openapi_server.CreateVirtualGatewayRequest()
    params = [('meshOwner', 'mesh_owner_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='PUT',
        path='/v20190125/meshes/{mesh_name}/virtualGateways'.format(mesh_name='mesh_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_create_virtual_node(client):
    ...
    response = await client.request(
        method='PUT',
        path='/v20190125/meshes/{mesh_name}/virtualNodes'.format(mesh_name='mesh_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_create_virtual_router(client):
    ...
    response = await client.request(
        method='PUT',
        path='/v20190125/meshes/{mesh_name}/virtualRouters'.format(mesh_name='mesh_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_create_virtual_service(client):
    """Test case for create_virtual_service

    
    """
    body = openapi_server.CreateVirtualServiceRequest()
    params = [('meshOwner', 'mesh_owner_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='PUT',
        path='/v20190125/meshes/{mesh_name}/virtualServices'.format(mesh_name='mesh_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_delete_gateway_route(client):
    """Test case for delete_gateway_route
    ...
    response = await client.request(
        method='DELETE',
        path='/v20190125/meshes/{mesh_name}/virtualGateway/{virtual_gateway_name}/gatewayRoutes/{gateway_route_name}'.format(gateway_route_name='gateway_route_name_example', mesh_name='mesh_name_example', virtual_gateway_name='virtual_gateway_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_mesh(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v20190125/meshes/{mesh_name}'.format(mesh_name='mesh_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_route(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v20190125/meshes/{mesh_name}/virtualRouter/{virtual_router_name}/routes/{route_name}'.format(mesh_name='mesh_name_example', route_name='route_name_example', virtual_router_name='virtual_router_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_virtual_gateway(client):
    """Test case for delete_virtual_gateway
    ...
    response = await client.request(
        method='DELETE',
        path='/v20190125/meshes/{mesh_name}/virtualGateways/{virtual_gateway_name}'.format(mesh_name='mesh_name_example', virtual_gateway_name='virtual_gateway_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_virtual_node(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v20190125/meshes/{mesh_name}/virtualNodes/{virtual_node_name}'.format(mesh_name='mesh_name_example', virtual_node_name='virtual_node_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_virtual_router(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v20190125/meshes/{mesh_name}/virtualRouters/{virtual_router_name}'.format(mesh_name='mesh_name_example', virtual_router_name='virtual_router_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_virtual_service(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v20190125/meshes/{mesh_name}/virtualServices/{virtual_service_name}'.format(mesh_name='mesh_name_example', virtual_service_name='virtual_service_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_gateway_route(client):
    """Test case for describe_gateway_route
...
async def test_describe_virtual_gateway(client):
    """Test case for describe_virtual_gateway
...
async def test_describe_virtual_service(client):
    """Test case for describe_virtual_service
...
async def test_list_gateway_routes(client):
    """Test case for list_gateway_routes

    
    """
    params = [('limit', 56),
                    ('meshOwner', 'mesh_owner_example'),
...
async def test_list_virtual_gateways(client):
    """Test case for list_virtual_gateways
...
async def test_list_virtual_services(client):
    """Test case for list_virtual_services
...
async def test_update_gateway_route(client):
    """Test case for update_gateway_route

    
    """
    body = openapi_server.UpdateGatewayRouteRequest()
    params = [('meshOwner', 'mesh_owner_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_update_mesh(client):
    """Test case for update_mesh

    
    """
    body = openapi_server.UpdateMeshRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_virtual_gateway(client):
    """Test case for update_virtual_gateway

    
    """
    body = openapi_server.UpdateVirtualGatewayRequest()
    params = [('meshOwner', 'mesh_owner_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_update_virtual_service(client):
    """Test case for update_virtual_service

    
    """
    body = openapi_server.UpdateVirtualServiceRequest()
    params = [('meshOwner', 'mesh_owner_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
