...
/*
 * OAIBackend_virtualService.h
 *
 * 
 */

#ifndef OAIBackend_virtualService_H
#define OAIBackend_virtualService_H
...
class OAIBackend_virtualService : public OAIObject {
public:
    OAIBackend_virtualService();
    OAIBackend_virtualService(QString json);
    ~OAIBackend_virtualService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackend_virtualService)

#endif // OAIBackend_virtualService_H
