...
/*
 * OAIVirtualGatewayRef.h
 *
 * An object that represents a virtual gateway returned by a list operation.
 */

#ifndef OAIVirtualGatewayRef_H
#define OAIVirtualGatewayRef_H
...
class OAIVirtualGatewayRef : public OAIObject {
public:
    OAIVirtualGatewayRef();
    OAIVirtualGatewayRef(QString json);
    ~OAIVirtualGatewayRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualGatewayRef)

#endif // OAIVirtualGatewayRef_H
