...
/*
 * OAIGrpcRoute_retryPolicy.h
 *
 * 
 */

#ifndef OAIGrpcRoute_retryPolicy_H
#define OAIGrpcRoute_retryPolicy_H
...
class OAIGrpcRoute_retryPolicy : public OAIObject {
public:
    OAIGrpcRoute_retryPolicy();
    OAIGrpcRoute_retryPolicy(QString json);
    ~OAIGrpcRoute_retryPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrpcRoute_retryPolicy)

#endif // OAIGrpcRoute_retryPolicy_H
