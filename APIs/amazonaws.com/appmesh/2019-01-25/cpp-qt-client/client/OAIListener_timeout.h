...
/*
 * OAIListener_timeout.h
 *
 * 
 */

#ifndef OAIListener_timeout_H
#define OAIListener_timeout_H
...
class OAIListener_timeout : public OAIObject {
public:
    OAIListener_timeout();
    OAIListener_timeout(QString json);
    ~OAIListener_timeout() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListener_timeout)

#endif // OAIListener_timeout_H
