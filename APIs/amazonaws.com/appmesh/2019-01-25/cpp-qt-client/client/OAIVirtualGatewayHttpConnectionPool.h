...
/*
 * OAIVirtualGatewayHttpConnectionPool.h
 *
 * An object that represents a type of connection pool.
 */

#ifndef OAIVirtualGatewayHttpConnectionPool_H
#define OAIVirtualGatewayHttpConnectionPool_H
...
class OAIVirtualGatewayHttpConnectionPool : public OAIObject {
public:
    OAIVirtualGatewayHttpConnectionPool();
    OAIVirtualGatewayHttpConnectionPool(QString json);
    ~OAIVirtualGatewayHttpConnectionPool() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualGatewayHttpConnectionPool)

#endif // OAIVirtualGatewayHttpConnectionPool_H
