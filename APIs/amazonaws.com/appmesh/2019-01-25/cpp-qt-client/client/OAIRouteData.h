...
#ifndef OAIRouteData_H
#define OAIRouteData_H
...
class OAIRouteData : public OAIObject {
public:
    OAIRouteData();
    OAIRouteData(QString json);
    ~OAIRouteData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteData)

#endif // OAIRouteData_H
