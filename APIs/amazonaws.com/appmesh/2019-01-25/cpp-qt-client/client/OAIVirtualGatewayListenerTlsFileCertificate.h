...
/*
 * OAIVirtualGatewayListenerTlsFileCertificate.h
 *
...
#ifndef OAIVirtualGatewayListenerTlsFileCertificate_H
#define OAIVirtualGatewayListenerTlsFileCertificate_H
...
class OAIVirtualGatewayListenerTlsFileCertificate : public OAIObject {
public:
    OAIVirtualGatewayListenerTlsFileCertificate();
    OAIVirtualGatewayListenerTlsFileCertificate(QString json);
    ~OAIVirtualGatewayListenerTlsFileCertificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualGatewayListenerTlsFileCertificate)

#endif // OAIVirtualGatewayListenerTlsFileCertificate_H
