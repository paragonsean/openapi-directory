...
/*
 * OAICreateRoute_request_spec_http2Route.h
 *
 * 
 */

#ifndef OAICreateRoute_request_spec_http2Route_H
#define OAICreateRoute_request_spec_http2Route_H
...
class OAICreateRoute_request_spec_http2Route : public OAIObject {
public:
    OAICreateRoute_request_spec_http2Route();
    OAICreateRoute_request_spec_http2Route(QString json);
    ~OAICreateRoute_request_spec_http2Route() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoute_request_spec_http2Route)

#endif // OAICreateRoute_request_spec_http2Route_H
