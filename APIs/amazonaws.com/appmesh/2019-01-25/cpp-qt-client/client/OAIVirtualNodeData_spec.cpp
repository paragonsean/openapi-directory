...
OAICreateVirtualNode_request_spec_backendDefaults OAIVirtualNodeData_spec::getBackendDefaults() const {
    return m_backend_defaults;
}
void OAIVirtualNodeData_spec::setBackendDefaults(const OAICreateVirtualNode_request_spec_backendDefaults &backend_defaults) {
    m_backend_defaults = backend_defaults;
    m_backend_defaults_isSet = true;
}

bool OAIVirtualNodeData_spec::is_backend_defaults_Set() const{
    return m_backend_defaults_isSet;
}

bool OAIVirtualNodeData_spec::is_backend_defaults_Valid() const{
...
OAICreateVirtualNode_request_spec_logging OAIVirtualNodeData_spec::getLogging() const {
    return m_logging;
}
void OAIVirtualNodeData_spec::setLogging(const OAICreateVirtualNode_request_spec_logging &logging) {
    m_logging = logging;
    m_logging_isSet = true;
}

bool OAIVirtualNodeData_spec::is_logging_Set() const{
    return m_logging_isSet;
}

bool OAIVirtualNodeData_spec::is_logging_Valid() const{
