...
QString OAICreateRoute_request::getRouteName() const {
    return m_route_name;
}
void OAICreateRoute_request::setRouteName(const QString &route_name) {
    m_route_name = route_name;
    m_route_name_isSet = true;
}

bool OAICreateRoute_request::is_route_name_Set() const{
    return m_route_name_isSet;
}

bool OAICreateRoute_request::is_route_name_Valid() const{
    return m_route_name_isValid;
}

OAICreateRoute_request_spec OAICreateRoute_request::getSpec() const {
    return m_spec;
}
void OAICreateRoute_request::setSpec(const OAICreateRoute_request_spec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAICreateRoute_request::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAICreateRoute_request::is_spec_Valid() const{
    return m_spec_isValid;
}

QList<OAITagRef> OAICreateRoute_request::getTags() const {
    return m_tags;
}
void OAICreateRoute_request::setTags(const QList<OAITagRef> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
