...
/*
 * OAIHttpGatewayRouteMatch.h
 *
 * An object that represents the criteria for determining a request match.
 */

#ifndef OAIHttpGatewayRouteMatch_H
#define OAIHttpGatewayRouteMatch_H
...
class OAIHttpGatewayRouteMatch : public OAIObject {
public:
    OAIHttpGatewayRouteMatch();
    OAIHttpGatewayRouteMatch(QString json);
    ~OAIHttpGatewayRouteMatch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpGatewayRouteMatch)

#endif // OAIHttpGatewayRouteMatch_H
