...
/*
 * OAIGrpcMetadataMatchMethod.h
 *
 * An object representing the method header to be matched.
 */

#ifndef OAIGrpcMetadataMatchMethod_H
#define OAIGrpcMetadataMatchMethod_H
...
class OAIGrpcMetadataMatchMethod : public OAIObject {
public:
    OAIGrpcMetadataMatchMethod();
    OAIGrpcMetadataMatchMethod(QString json);
    ~OAIGrpcMetadataMatchMethod() override;
    ...
    OAIMatchRange getRange() const;
    void setRange(const OAIMatchRange &range);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrpcMetadataMatchMethod)

#endif // OAIGrpcMetadataMatchMethod_H
