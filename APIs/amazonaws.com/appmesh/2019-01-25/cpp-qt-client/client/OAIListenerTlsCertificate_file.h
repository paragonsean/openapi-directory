...
/*
 * OAIListenerTlsCertificate_file.h
 *
 * 
 */

#ifndef OAIListenerTlsCertificate_file_H
#define OAIListenerTlsCertificate_file_H
...
class OAIListenerTlsCertificate_file : public OAIObject {
public:
    OAIListenerTlsCertificate_file();
    OAIListenerTlsCertificate_file(QString json);
    ~OAIListenerTlsCertificate_file() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListenerTlsCertificate_file)

#endif // OAIListenerTlsCertificate_file_H
