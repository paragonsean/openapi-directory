...
/*
 * OAIGrpcRouteMetadata_match.h
 *
 * 
 */

#ifndef OAIGrpcRouteMetadata_match_H
#define OAIGrpcRouteMetadata_match_H
...
class OAIGrpcRouteMetadata_match : public OAIObject {
public:
    OAIGrpcRouteMetadata_match();
    OAIGrpcRouteMetadata_match(QString json);
    ~OAIGrpcRouteMetadata_match() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrpcRouteMetadata_match)

#endif // OAIGrpcRouteMetadata_match_H
