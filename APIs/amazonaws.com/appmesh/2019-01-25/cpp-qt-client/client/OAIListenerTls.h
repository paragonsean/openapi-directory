...
#ifndef OAIListenerTls_H
#define OAIListenerTls_H
...
class OAIListenerTls : public OAIObject {
public:
    OAIListenerTls();
    OAIListenerTls(QString json);
    ~OAIListenerTls() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListenerTls)

#endif // OAIListenerTls_H
