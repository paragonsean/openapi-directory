...
/*
 * OAIListenerTlsCertificate.h
 *
 * An object that represents a listener&#39;s Transport Layer Security (TLS) certificate.
 */

#ifndef OAIListenerTlsCertificate_H
#define OAIListenerTlsCertificate_H
...
class OAIListenerTlsCertificate : public OAIObject {
public:
    OAIListenerTlsCertificate();
    OAIListenerTlsCertificate(QString json);
    ~OAIListenerTlsCertificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListenerTlsCertificate)

#endif // OAIListenerTlsCertificate_H
