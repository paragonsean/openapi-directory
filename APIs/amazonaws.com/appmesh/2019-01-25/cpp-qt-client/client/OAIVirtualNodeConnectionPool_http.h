...
/*
 * OAIVirtualNodeConnectionPool_http.h
 *
 * 
 */

#ifndef OAIVirtualNodeConnectionPool_http_H
#define OAIVirtualNodeConnectionPool_http_H
...
class OAIVirtualNodeConnectionPool_http : public OAIObject {
public:
    OAIVirtualNodeConnectionPool_http();
    OAIVirtualNodeConnectionPool_http(QString json);
    ~OAIVirtualNodeConnectionPool_http() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNodeConnectionPool_http)

#endif // OAIVirtualNodeConnectionPool_http_H
