...
OAIMeshData_spec::OAIMeshData_spec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMeshData_spec::OAIMeshData_spec() {
    this->initializeModel();
}

OAIMeshData_spec::~OAIMeshData_spec() {}

void OAIMeshData_spec::initializeModel() {
...
void OAIMeshData_spec::fromJson(QString jsonString) {
...
void OAIMeshData_spec::fromJsonObject(QJsonObject json) {
...
QString OAIMeshData_spec::asJson() const {
...
QJsonObject OAIMeshData_spec::asJsonObject() const {
    QJsonObject obj;
...
OAICreateMesh_request_spec_egressFilter OAIMeshData_spec::getEgressFilter() const {
    return m_egress_filter;
}
void OAIMeshData_spec::setEgressFilter(const OAICreateMesh_request_spec_egressFilter &egress_filter) {
    m_egress_filter = egress_filter;
    m_egress_filter_isSet = true;
}

bool OAIMeshData_spec::is_egress_filter_Set() const{
    return m_egress_filter_isSet;
}

bool OAIMeshData_spec::is_egress_filter_Valid() const{
    return m_egress_filter_isValid;
}

OAIMeshServiceDiscovery OAIMeshData_spec::getServiceDiscovery() const {
    return m_service_discovery;
}
void OAIMeshData_spec::setServiceDiscovery(const OAIMeshServiceDiscovery &service_discovery) {
    m_service_discovery = service_discovery;
    m_service_discovery_isSet = true;
}

bool OAIMeshData_spec::is_service_discovery_Set() const{
    return m_service_discovery_isSet;
}

bool OAIMeshData_spec::is_service_discovery_Valid() const{
    return m_service_discovery_isValid;
}

bool OAIMeshData_spec::isSet() const {
...
bool OAIMeshData_spec::isValid() const {
