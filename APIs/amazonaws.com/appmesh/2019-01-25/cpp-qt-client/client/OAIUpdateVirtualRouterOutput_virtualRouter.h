...
/*
 * OAIUpdateVirtualRouterOutput_virtualRouter.h
 *
 * 
 */

#ifndef OAIUpdateVirtualRouterOutput_virtualRouter_H
#define OAIUpdateVirtualRouterOutput_virtualRouter_H
...
class OAIUpdateVirtualRouterOutput_virtualRouter : public OAIObject {
public:
    OAIUpdateVirtualRouterOutput_virtualRouter();
    OAIUpdateVirtualRouterOutput_virtualRouter(QString json);
    ~OAIUpdateVirtualRouterOutput_virtualRouter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVirtualRouterOutput_virtualRouter)

#endif // OAIUpdateVirtualRouterOutput_virtualRouter_H
