...
/*
 * OAIGatewayRouteData_spec.h
 *
 * 
 */

#ifndef OAIGatewayRouteData_spec_H
#define OAIGatewayRouteData_spec_H
...
class OAIGatewayRouteData_spec : public OAIObject {
public:
    OAIGatewayRouteData_spec();
    OAIGatewayRouteData_spec(QString json);
    ~OAIGatewayRouteData_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayRouteData_spec)

#endif // OAIGatewayRouteData_spec_H
