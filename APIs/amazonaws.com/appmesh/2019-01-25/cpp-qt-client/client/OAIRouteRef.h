...
#ifndef OAIRouteRef_H
#define OAIRouteRef_H
...
class OAIRouteRef : public OAIObject {
public:
    OAIRouteRef();
    OAIRouteRef(QString json);
    ~OAIRouteRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteRef)
