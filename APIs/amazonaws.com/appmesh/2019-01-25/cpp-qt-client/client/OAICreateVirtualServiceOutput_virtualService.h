...
/*
 * OAICreateVirtualServiceOutput_virtualService.h
 *
 * 
 */

#ifndef OAICreateVirtualServiceOutput_virtualService_H
#define OAICreateVirtualServiceOutput_virtualService_H
...
class OAICreateVirtualServiceOutput_virtualService : public OAIObject {
public:
    OAICreateVirtualServiceOutput_virtualService();
    OAICreateVirtualServiceOutput_virtualService(QString json);
    ~OAICreateVirtualServiceOutput_virtualService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVirtualServiceOutput_virtualService)

#endif // OAICreateVirtualServiceOutput_virtualService_H
