...
OAIClientPolicyTls::OAIClientPolicyTls(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClientPolicyTls::OAIClientPolicyTls() {
    this->initializeModel();
}

OAIClientPolicyTls::~OAIClientPolicyTls() {}

void OAIClientPolicyTls::initializeModel() {
...
void OAIClientPolicyTls::fromJson(QString jsonString) {
...
void OAIClientPolicyTls::fromJsonObject(QJsonObject json) {
...
QString OAIClientPolicyTls::asJson() const {
...
QJsonObject OAIClientPolicyTls::asJsonObject() const {
    QJsonObject obj;
...
OAIClientPolicyTls_certificate OAIClientPolicyTls::getCertificate() const {
    return m_certificate;
}
void OAIClientPolicyTls::setCertificate(const OAIClientPolicyTls_certificate &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIClientPolicyTls::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIClientPolicyTls::is_certificate_Valid() const{
    return m_certificate_isValid;
}

bool OAIClientPolicyTls::getEnforce() const {
    return m_enforce;
}
void OAIClientPolicyTls::setEnforce(const bool &enforce) {
    m_enforce = enforce;
    m_enforce_isSet = true;
}

bool OAIClientPolicyTls::is_enforce_Set() const{
    return m_enforce_isSet;
}

bool OAIClientPolicyTls::is_enforce_Valid() const{
    return m_enforce_isValid;
}

QList OAIClientPolicyTls::getPorts() const {
    return m_ports;
}
void OAIClientPolicyTls::setPorts(const QList &ports) {
    m_ports = ports;
    m_ports_isSet = true;
}

bool OAIClientPolicyTls::is_ports_Set() const{
    return m_ports_isSet;
}

bool OAIClientPolicyTls::is_ports_Valid() const{
    return m_ports_isValid;
}

OAIClientPolicyTls_validation OAIClientPolicyTls::getValidation() const {
    return m_validation;
}
void OAIClientPolicyTls::setValidation(const OAIClientPolicyTls_validation &validation) {
    m_validation = validation;
    m_validation_isSet = true;
}

bool OAIClientPolicyTls::is_validation_Set() const{
    return m_validation_isSet;
}

bool OAIClientPolicyTls::is_validation_Valid() const{
    return m_validation_isValid;
}

bool OAIClientPolicyTls::isSet() const {
...
bool OAIClientPolicyTls::isValid() const {
