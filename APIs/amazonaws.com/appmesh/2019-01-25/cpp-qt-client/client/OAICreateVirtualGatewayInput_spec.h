...
/*
 * OAICreateVirtualGatewayInput_spec.h
 *
 * 
 */

#ifndef OAICreateVirtualGatewayInput_spec_H
#define OAICreateVirtualGatewayInput_spec_H
...
class OAICreateVirtualGatewayInput_spec : public OAIObject {
public:
    OAICreateVirtualGatewayInput_spec();
    OAICreateVirtualGatewayInput_spec(QString json);
    ~OAICreateVirtualGatewayInput_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVirtualGatewayInput_spec)

#endif // OAICreateVirtualGatewayInput_spec_H
