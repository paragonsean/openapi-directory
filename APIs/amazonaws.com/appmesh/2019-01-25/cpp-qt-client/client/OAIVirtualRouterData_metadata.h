...
/*
 * OAIVirtualRouterData_metadata.h
 *
 * 
 */

#ifndef OAIVirtualRouterData_metadata_H
#define OAIVirtualRouterData_metadata_H
...
class OAIVirtualRouterData_metadata : public OAIObject {
public:
    OAIVirtualRouterData_metadata();
    OAIVirtualRouterData_metadata(QString json);
    ~OAIVirtualRouterData_metadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualRouterData_metadata)

#endif // OAIVirtualRouterData_metadata_H
