...
/*
 * OAITlsValidationContextSdsTrust.h
 *
...
#ifndef OAITlsValidationContextSdsTrust_H
#define OAITlsValidationContextSdsTrust_H
...
class OAITlsValidationContextSdsTrust : public OAIObject {
public:
    OAITlsValidationContextSdsTrust();
    OAITlsValidationContextSdsTrust(QString json);
    ~OAITlsValidationContextSdsTrust() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITlsValidationContextSdsTrust)

#endif // OAITlsValidationContextSdsTrust_H
