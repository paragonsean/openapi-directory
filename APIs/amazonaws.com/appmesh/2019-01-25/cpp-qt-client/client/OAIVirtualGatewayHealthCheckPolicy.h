...
/*
 * OAIVirtualGatewayHealthCheckPolicy.h
 *
 * An object that represents the health check policy for a virtual gateway&#39;s listener.
 */

#ifndef OAIVirtualGatewayHealthCheckPolicy_H
#define OAIVirtualGatewayHealthCheckPolicy_H
...
class OAIVirtualGatewayHealthCheckPolicy : public OAIObject {
public:
    OAIVirtualGatewayHealthCheckPolicy();
    OAIVirtualGatewayHealthCheckPolicy(QString json);
    ~OAIVirtualGatewayHealthCheckPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualGatewayHealthCheckPolicy)

#endif // OAIVirtualGatewayHealthCheckPolicy_H
