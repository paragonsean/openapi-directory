...
/*
 * OAIListener_outlierDetection.h
 *
 * 
 */

#ifndef OAIListener_outlierDetection_H
#define OAIListener_outlierDetection_H
...
class OAIListener_outlierDetection : public OAIObject {
public:
    OAIListener_outlierDetection();
    OAIListener_outlierDetection(QString json);
    ~OAIListener_outlierDetection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListener_outlierDetection)

#endif // OAIListener_outlierDetection_H
