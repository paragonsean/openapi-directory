...
/*
 * OAIHttpGatewayRouteAction_rewrite.h
 *
 * 
 */

#ifndef OAIHttpGatewayRouteAction_rewrite_H
#define OAIHttpGatewayRouteAction_rewrite_H
...
class OAIHttpGatewayRouteAction_rewrite : public OAIObject {
public:
    OAIHttpGatewayRouteAction_rewrite();
    OAIHttpGatewayRouteAction_rewrite(QString json);
    ~OAIHttpGatewayRouteAction_rewrite() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpGatewayRouteAction_rewrite)

#endif // OAIHttpGatewayRouteAction_rewrite_H
