...
/*
 * OAIListenerTlsFileCertificate.h
 *
...
#ifndef OAIListenerTlsFileCertificate_H
#define OAIListenerTlsFileCertificate_H
...
class OAIListenerTlsFileCertificate : public OAIObject {
public:
    OAIListenerTlsFileCertificate();
    OAIListenerTlsFileCertificate(QString json);
    ~OAIListenerTlsFileCertificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListenerTlsFileCertificate)

#endif // OAIListenerTlsFileCertificate_H
