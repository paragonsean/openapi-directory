...
#ifndef OAIVirtualNodeRef_H
#define OAIVirtualNodeRef_H
...
class OAIVirtualNodeRef : public OAIObject {
public:
    OAIVirtualNodeRef();
    OAIVirtualNodeRef(QString json);
    ~OAIVirtualNodeRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNodeRef)

#endif // OAIVirtualNodeRef_H
