...
/*
 * OAIClientTlsCertificate_file.h
 *
 * 
 */

#ifndef OAIClientTlsCertificate_file_H
#define OAIClientTlsCertificate_file_H
...
class OAIClientTlsCertificate_file : public OAIObject {
public:
    OAIClientTlsCertificate_file();
    OAIClientTlsCertificate_file(QString json);
    ~OAIClientTlsCertificate_file() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientTlsCertificate_file)

#endif // OAIClientTlsCertificate_file_H
