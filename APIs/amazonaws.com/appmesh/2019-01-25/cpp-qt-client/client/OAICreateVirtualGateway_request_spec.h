...
/*
 * OAICreateVirtualGateway_request_spec.h
 *
 * An object that represents the specification of a service mesh resource.
 */

#ifndef OAICreateVirtualGateway_request_spec_H
#define OAICreateVirtualGateway_request_spec_H
...
class OAICreateVirtualGateway_request_spec : public OAIObject {
public:
    OAICreateVirtualGateway_request_spec();
    OAICreateVirtualGateway_request_spec(QString json);
    ~OAICreateVirtualGateway_request_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVirtualGateway_request_spec)

#endif // OAICreateVirtualGateway_request_spec_H
