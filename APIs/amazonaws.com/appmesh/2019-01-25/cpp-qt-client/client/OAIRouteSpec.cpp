...
OAICreateRoute_request_spec_grpcRoute OAIRouteSpec::getGrpcRoute() const {
    return m_grpc_route;
}
void OAIRouteSpec::setGrpcRoute(const OAICreateRoute_request_spec_grpcRoute &grpc_route) {
    m_grpc_route = grpc_route;
    m_grpc_route_isSet = true;
}

bool OAIRouteSpec::is_grpc_route_Set() const{
    return m_grpc_route_isSet;
}

bool OAIRouteSpec::is_grpc_route_Valid() const{
    return m_grpc_route_isValid;
}

OAICreateRoute_request_spec_http2Route OAIRouteSpec::getHttp2Route() const {
    return m_http2_route;
}
void OAIRouteSpec::setHttp2Route(const OAICreateRoute_request_spec_http2Route &http2_route) {
    m_http2_route = http2_route;
    m_http2_route_isSet = true;
}

bool OAIRouteSpec::is_http2_route_Set() const{
    return m_http2_route_isSet;
}

bool OAIRouteSpec::is_http2_route_Valid() const{
    return m_http2_route_isValid;
}

OAICreateRoute_request_spec_httpRoute OAIRouteSpec::getHttpRoute() const {
    return m_http_route;
}
void OAIRouteSpec::setHttpRoute(const OAICreateRoute_request_spec_httpRoute &http_route) {
    m_http_route = http_route;
    m_http_route_isSet = true;
}

bool OAIRouteSpec::is_http_route_Set() const{
    return m_http_route_isSet;
}

bool OAIRouteSpec::is_http_route_Valid() const{
    return m_http_route_isValid;
}

qint32 OAIRouteSpec::getPriority() const {
    return m_priority;
}
void OAIRouteSpec::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIRouteSpec::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIRouteSpec::is_priority_Valid() const{
    return m_priority_isValid;
}

OAICreateRoute_request_spec_tcpRoute OAIRouteSpec::getTcpRoute() const {
    return m_tcp_route;
}
void OAIRouteSpec::setTcpRoute(const OAICreateRoute_request_spec_tcpRoute &tcp_route) {
    m_tcp_route = tcp_route;
    m_tcp_route_isSet = true;
}

bool OAIRouteSpec::is_tcp_route_Set() const{
    return m_tcp_route_isSet;
}

bool OAIRouteSpec::is_tcp_route_Valid() const{
