...
/*
 * OAICreateGatewayRoute_request_spec.h
 *
 * An object that represents a gateway route specification. Specify one gateway route type.
 */

#ifndef OAICreateGatewayRoute_request_spec_H
#define OAICreateGatewayRoute_request_spec_H
...
class OAICreateGatewayRoute_request_spec : public OAIObject {
public:
    OAICreateGatewayRoute_request_spec();
    OAICreateGatewayRoute_request_spec(QString json);
    ~OAICreateGatewayRoute_request_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGatewayRoute_request_spec)

#endif // OAICreateGatewayRoute_request_spec_H
