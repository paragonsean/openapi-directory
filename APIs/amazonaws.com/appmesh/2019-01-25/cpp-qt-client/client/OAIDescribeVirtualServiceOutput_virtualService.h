...
/*
 * OAIDescribeVirtualServiceOutput_virtualService.h
 *
 * 
 */

#ifndef OAIDescribeVirtualServiceOutput_virtualService_H
#define OAIDescribeVirtualServiceOutput_virtualService_H
...
class OAIDescribeVirtualServiceOutput_virtualService : public OAIObject {
public:
    OAIDescribeVirtualServiceOutput_virtualService();
    OAIDescribeVirtualServiceOutput_virtualService(QString json);
    ~OAIDescribeVirtualServiceOutput_virtualService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVirtualServiceOutput_virtualService)

#endif // OAIDescribeVirtualServiceOutput_virtualService_H
