...
/*
 * OAIGatewayRouteRef.h
 *
 * An object that represents a gateway route returned by a list operation.
 */

#ifndef OAIGatewayRouteRef_H
#define OAIGatewayRouteRef_H
...
class OAIGatewayRouteRef : public OAIObject {
public:
    OAIGatewayRouteRef();
    OAIGatewayRouteRef(QString json);
    ~OAIGatewayRouteRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayRouteRef)

#endif // OAIGatewayRouteRef_H
