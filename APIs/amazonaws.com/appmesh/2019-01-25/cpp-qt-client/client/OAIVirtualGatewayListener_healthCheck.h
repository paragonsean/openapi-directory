...
/*
 * OAIVirtualGatewayListener_healthCheck.h
 *
 * 
 */

#ifndef OAIVirtualGatewayListener_healthCheck_H
#define OAIVirtualGatewayListener_healthCheck_H
...
class OAIVirtualGatewayListener_healthCheck : public OAIObject {
public:
    OAIVirtualGatewayListener_healthCheck();
    OAIVirtualGatewayListener_healthCheck(QString json);
    ~OAIVirtualGatewayListener_healthCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualGatewayListener_healthCheck)

#endif // OAIVirtualGatewayListener_healthCheck_H
