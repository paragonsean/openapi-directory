...
#ifndef OAIHttpRetryPolicy_H
#define OAIHttpRetryPolicy_H
...
class OAIHttpRetryPolicy : public OAIObject {
public:
    OAIHttpRetryPolicy();
    OAIHttpRetryPolicy(QString json);
    ~OAIHttpRetryPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpRetryPolicy)

#endif // OAIHttpRetryPolicy_H
