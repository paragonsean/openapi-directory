...
/*
 * OAIDeleteVirtualServiceOutput_virtualService.h
 *
 * 
 */

#ifndef OAIDeleteVirtualServiceOutput_virtualService_H
#define OAIDeleteVirtualServiceOutput_virtualService_H
...
class OAIDeleteVirtualServiceOutput_virtualService : public OAIObject {
public:
    OAIDeleteVirtualServiceOutput_virtualService();
    OAIDeleteVirtualServiceOutput_virtualService(QString json);
    ~OAIDeleteVirtualServiceOutput_virtualService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVirtualServiceOutput_virtualService)

#endif // OAIDeleteVirtualServiceOutput_virtualService_H
