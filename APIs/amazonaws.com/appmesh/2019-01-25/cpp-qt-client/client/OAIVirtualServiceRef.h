...
/*
 * OAIVirtualServiceRef.h
 *
 * An object that represents a virtual service returned by a list operation.
 */

#ifndef OAIVirtualServiceRef_H
#define OAIVirtualServiceRef_H
...
class OAIVirtualServiceRef : public OAIObject {
public:
    OAIVirtualServiceRef();
    OAIVirtualServiceRef(QString json);
    ~OAIVirtualServiceRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualServiceRef)

#endif // OAIVirtualServiceRef_H
