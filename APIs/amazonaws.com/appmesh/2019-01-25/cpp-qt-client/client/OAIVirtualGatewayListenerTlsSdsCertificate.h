...
/*
 * OAIVirtualGatewayListenerTlsSdsCertificate.h
 *
...
#ifndef OAIVirtualGatewayListenerTlsSdsCertificate_H
#define OAIVirtualGatewayListenerTlsSdsCertificate_H
...
class OAIVirtualGatewayListenerTlsSdsCertificate : public OAIObject {
public:
    OAIVirtualGatewayListenerTlsSdsCertificate();
    OAIVirtualGatewayListenerTlsSdsCertificate(QString json);
    ~OAIVirtualGatewayListenerTlsSdsCertificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualGatewayListenerTlsSdsCertificate)

#endif // OAIVirtualGatewayListenerTlsSdsCertificate_H
