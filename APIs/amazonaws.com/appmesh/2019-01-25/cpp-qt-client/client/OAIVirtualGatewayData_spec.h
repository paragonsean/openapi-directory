...
/*
 * OAIVirtualGatewayData_spec.h
 *
 * 
 */

#ifndef OAIVirtualGatewayData_spec_H
#define OAIVirtualGatewayData_spec_H
...
class OAIVirtualGatewayData_spec : public OAIObject {
public:
    OAIVirtualGatewayData_spec();
    OAIVirtualGatewayData_spec(QString json);
    ~OAIVirtualGatewayData_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualGatewayData_spec)

#endif // OAIVirtualGatewayData_spec_H
