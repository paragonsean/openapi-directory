...
/*
 * OAIHttpGatewayRouteHeader_match.h
 *
 * 
 */

#ifndef OAIHttpGatewayRouteHeader_match_H
#define OAIHttpGatewayRouteHeader_match_H
...
class OAIHttpGatewayRouteHeader_match : public OAIObject {
public:
    OAIHttpGatewayRouteHeader_match();
    OAIHttpGatewayRouteHeader_match(QString json);
    ~OAIHttpGatewayRouteHeader_match() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpGatewayRouteHeader_match)

#endif // OAIHttpGatewayRouteHeader_match_H
