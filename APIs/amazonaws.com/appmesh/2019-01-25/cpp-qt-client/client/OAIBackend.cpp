...
OAIBackend_virtualService OAIBackend::getVirtualService() const {
    return m_virtual_service;
}
void OAIBackend::setVirtualService(const OAIBackend_virtualService &virtual_service) {
    m_virtual_service = virtual_service;
    m_virtual_service_isSet = true;
}

bool OAIBackend::is_virtual_service_Set() const{
    return m_virtual_service_isSet;
}

bool OAIBackend::is_virtual_service_Valid() const{
