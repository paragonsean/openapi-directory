...
/*
 * OAIListenerTlsSdsCertificate.h
 *
...
#ifndef OAIListenerTlsSdsCertificate_H
#define OAIListenerTlsSdsCertificate_H
...
class OAIListenerTlsSdsCertificate : public OAIObject {
public:
    OAIListenerTlsSdsCertificate();
    OAIListenerTlsSdsCertificate(QString json);
    ~OAIListenerTlsSdsCertificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListenerTlsSdsCertificate)

#endif // OAIListenerTlsSdsCertificate_H
