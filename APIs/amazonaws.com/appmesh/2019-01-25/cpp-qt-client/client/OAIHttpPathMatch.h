...
#ifndef OAIHttpPathMatch_H
#define OAIHttpPathMatch_H
...
class OAIHttpPathMatch : public OAIObject {
public:
    OAIHttpPathMatch();
    OAIHttpPathMatch(QString json);
    ~OAIHttpPathMatch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpPathMatch)

#endif // OAIHttpPathMatch_H
