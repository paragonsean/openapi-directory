...
/*
 * OAIVirtualServiceData.h
 *
 * An object that represents a virtual service returned by a describe operation.
 */

#ifndef OAIVirtualServiceData_H
#define OAIVirtualServiceData_H
...
class OAIVirtualServiceData : public OAIObject {
public:
    OAIVirtualServiceData();
    OAIVirtualServiceData(QString json);
    ~OAIVirtualServiceData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualServiceData)

#endif // OAIVirtualServiceData_H
