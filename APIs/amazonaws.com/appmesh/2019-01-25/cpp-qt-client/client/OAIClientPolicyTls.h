...
/*
 * OAIClientPolicyTls.h
 *
 * A reference to an object that represents a Transport Layer Security (TLS) client policy.
 */

#ifndef OAIClientPolicyTls_H
#define OAIClientPolicyTls_H
...
class OAIClientPolicyTls : public OAIObject {
public:
    OAIClientPolicyTls();
    OAIClientPolicyTls(QString json);
    ~OAIClientPolicyTls() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientPolicyTls)

#endif // OAIClientPolicyTls_H
