...
OAICreateVirtualNode_request_spec_backendDefaults OAIVirtualNodeSpec::getBackendDefaults() const {
    return m_backend_defaults;
}
void OAIVirtualNodeSpec::setBackendDefaults(const OAICreateVirtualNode_request_spec_backendDefaults &backend_defaults) {
    m_backend_defaults = backend_defaults;
    m_backend_defaults_isSet = true;
}

bool OAIVirtualNodeSpec::is_backend_defaults_Set() const{
    return m_backend_defaults_isSet;
}

bool OAIVirtualNodeSpec::is_backend_defaults_Valid() const{
...
OAICreateVirtualNode_request_spec_logging OAIVirtualNodeSpec::getLogging() const {
    return m_logging;
}
void OAIVirtualNodeSpec::setLogging(const OAICreateVirtualNode_request_spec_logging &logging) {
    m_logging = logging;
    m_logging_isSet = true;
}

bool OAIVirtualNodeSpec::is_logging_Set() const{
    return m_logging_isSet;
}

bool OAIVirtualNodeSpec::is_logging_Valid() const{
