...
/*
 * OAIVirtualNodeHttpConnectionPool.h
 *
 * An object that represents a type of connection pool.
 */

#ifndef OAIVirtualNodeHttpConnectionPool_H
#define OAIVirtualNodeHttpConnectionPool_H
...
class OAIVirtualNodeHttpConnectionPool : public OAIObject {
public:
    OAIVirtualNodeHttpConnectionPool();
    OAIVirtualNodeHttpConnectionPool(QString json);
    ~OAIVirtualNodeHttpConnectionPool() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNodeHttpConnectionPool)

#endif // OAIVirtualNodeHttpConnectionPool_H
