...
/*
 * OAIUpdateVirtualGatewayInput_spec.h
 *
 * 
 */

#ifndef OAIUpdateVirtualGatewayInput_spec_H
#define OAIUpdateVirtualGatewayInput_spec_H
...
class OAIUpdateVirtualGatewayInput_spec : public OAIObject {
public:
    OAIUpdateVirtualGatewayInput_spec();
    OAIUpdateVirtualGatewayInput_spec(QString json);
    ~OAIUpdateVirtualGatewayInput_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVirtualGatewayInput_spec)

#endif // OAIUpdateVirtualGatewayInput_spec_H
