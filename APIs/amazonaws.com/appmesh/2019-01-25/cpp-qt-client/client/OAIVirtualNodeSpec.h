...
/*
 * OAIVirtualNodeSpec.h
 *
 * An object that represents the specification of a virtual node.
 */

#ifndef OAIVirtualNodeSpec_H
#define OAIVirtualNodeSpec_H
...
class OAIVirtualNodeSpec : public OAIObject {
public:
    OAIVirtualNodeSpec();
    OAIVirtualNodeSpec(QString json);
    ~OAIVirtualNodeSpec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNodeSpec)

#endif // OAIVirtualNodeSpec_H
