...
/*
 * OAIUpdateGatewayRouteInput_spec.h
 *
 * 
 */

#ifndef OAIUpdateGatewayRouteInput_spec_H
#define OAIUpdateGatewayRouteInput_spec_H
...
class OAIUpdateGatewayRouteInput_spec : public OAIObject {
public:
    OAIUpdateGatewayRouteInput_spec();
    OAIUpdateGatewayRouteInput_spec(QString json);
    ~OAIUpdateGatewayRouteInput_spec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGatewayRouteInput_spec)

#endif // OAIUpdateGatewayRouteInput_spec_H
