...
OAIMeshSpec::OAIMeshSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMeshSpec::OAIMeshSpec() {
    this->initializeModel();
}

OAIMeshSpec::~OAIMeshSpec() {}

void OAIMeshSpec::initializeModel() {
...
void OAIMeshSpec::fromJson(QString jsonString) {
...
void OAIMeshSpec::fromJsonObject(QJsonObject json) {
...
QString OAIMeshSpec::asJson() const {
...
QJsonObject OAIMeshSpec::asJsonObject() const {
    QJsonObject obj;
...
OAICreateMesh_request_spec_egressFilter OAIMeshSpec::getEgressFilter() const {
    return m_egress_filter;
}
void OAIMeshSpec::setEgressFilter(const OAICreateMesh_request_spec_egressFilter &egress_filter) {
    m_egress_filter = egress_filter;
    m_egress_filter_isSet = true;
}

bool OAIMeshSpec::is_egress_filter_Set() const{
    return m_egress_filter_isSet;
}

bool OAIMeshSpec::is_egress_filter_Valid() const{
    return m_egress_filter_isValid;
}

OAIMeshServiceDiscovery OAIMeshSpec::getServiceDiscovery() const {
    return m_service_discovery;
}
void OAIMeshSpec::setServiceDiscovery(const OAIMeshServiceDiscovery &service_discovery) {
    m_service_discovery = service_discovery;
    m_service_discovery_isSet = true;
}

bool OAIMeshSpec::is_service_discovery_Set() const{
    return m_service_discovery_isSet;
}

bool OAIMeshSpec::is_service_discovery_Valid() const{
    return m_service_discovery_isValid;
}

bool OAIMeshSpec::isSet() const {
...
bool OAIMeshSpec::isValid() const {
