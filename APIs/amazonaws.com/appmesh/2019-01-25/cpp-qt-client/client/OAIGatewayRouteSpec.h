...
/*
 * OAIGatewayRouteSpec.h
 *
 * An object that represents a gateway route specification. Specify one gateway route type.
 */

#ifndef OAIGatewayRouteSpec_H
#define OAIGatewayRouteSpec_H
...
class OAIGatewayRouteSpec : public OAIObject {
public:
    OAIGatewayRouteSpec();
    OAIGatewayRouteSpec(QString json);
    ~OAIGatewayRouteSpec() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayRouteSpec)

#endif // OAIGatewayRouteSpec_H
