...
QString OAIRouteData_metadata::getMeshOwner() const {
    return m_mesh_owner;
}
void OAIRouteData_metadata::setMeshOwner(const QString &mesh_owner) {
    m_mesh_owner = mesh_owner;
    m_mesh_owner_isSet = true;
}

bool OAIRouteData_metadata::is_mesh_owner_Set() const{
    return m_mesh_owner_isSet;
}

bool OAIRouteData_metadata::is_mesh_owner_Valid() const{
    return m_mesh_owner_isValid;
}

QString OAIRouteData_metadata::getResourceOwner() const {
    return m_resource_owner;
}
void OAIRouteData_metadata::setResourceOwner(const QString &resource_owner) {
    m_resource_owner = resource_owner;
    m_resource_owner_isSet = true;
}

bool OAIRouteData_metadata::is_resource_owner_Set() const{
    return m_resource_owner_isSet;
}

bool OAIRouteData_metadata::is_resource_owner_Valid() const{
