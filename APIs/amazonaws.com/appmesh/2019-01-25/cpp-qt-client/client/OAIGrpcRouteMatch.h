...
#ifndef OAIGrpcRouteMatch_H
#define OAIGrpcRouteMatch_H
...
class OAIGrpcRouteMatch : public OAIObject {
public:
    OAIGrpcRouteMatch();
    OAIGrpcRouteMatch(QString json);
    ~OAIGrpcRouteMatch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrpcRouteMatch)

#endif // OAIGrpcRouteMatch_H
