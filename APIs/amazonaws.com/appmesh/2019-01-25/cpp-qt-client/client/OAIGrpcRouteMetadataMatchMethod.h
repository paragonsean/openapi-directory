...
/*
 * OAIGrpcRouteMetadataMatchMethod.h
 *
 * An object that represents the match method. Specify one of the match values.
 */

#ifndef OAIGrpcRouteMetadataMatchMethod_H
#define OAIGrpcRouteMetadataMatchMethod_H
...
class OAIGrpcRouteMetadataMatchMethod : public OAIObject {
public:
    OAIGrpcRouteMetadataMatchMethod();
    OAIGrpcRouteMetadataMatchMethod(QString json);
    ~OAIGrpcRouteMetadataMatchMethod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrpcRouteMetadataMatchMethod)

#endif // OAIGrpcRouteMetadataMatchMethod_H
