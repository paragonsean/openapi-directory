...
/*
 * OAIHeaderMatchMethod.h
 *
 * An object that represents the method and value to match with the header value sent in a request. Specify one match method.
 */

#ifndef OAIHeaderMatchMethod_H
#define OAIHeaderMatchMethod_H
...
class OAIHeaderMatchMethod : public OAIObject {
public:
    OAIHeaderMatchMethod();
    OAIHeaderMatchMethod(QString json);
    ~OAIHeaderMatchMethod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeaderMatchMethod)

#endif // OAIHeaderMatchMethod_H
