...
/*
 * OAIServiceDiscovery_awsCloudMap.h
 *
 * 
 */

#ifndef OAIServiceDiscovery_awsCloudMap_H
#define OAIServiceDiscovery_awsCloudMap_H
...
class OAIServiceDiscovery_awsCloudMap : public OAIObject {
public:
    OAIServiceDiscovery_awsCloudMap();
    OAIServiceDiscovery_awsCloudMap(QString json);
    ~OAIServiceDiscovery_awsCloudMap() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceDiscovery_awsCloudMap)

#endif // OAIServiceDiscovery_awsCloudMap_H
