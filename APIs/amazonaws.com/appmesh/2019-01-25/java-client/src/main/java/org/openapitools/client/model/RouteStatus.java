...
public class RouteStatus {
  ...
  public RouteStatus status(RouteStatusCode status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, routeStatus.status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : RouteStatus.openapiRequiredFields) {
