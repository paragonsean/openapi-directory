...
public class ListenerOutlierDetection {
  ...
  public ListenerOutlierDetection() {
  }

  public ListenerOutlierDetection baseEjectionDuration(OutlierDetectionBaseEjectionDuration baseEjectionDuration) {
  ...
  public ListenerOutlierDetection interval(OutlierDetectionInterval interval) {
  ...
  public ListenerOutlierDetection maxEjectionPercent(Integer maxEjectionPercent) {
  ...
  public ListenerOutlierDetection maxServerErrors(Integer maxServerErrors) {
  ...
  public boolean equals(Object o) {
    ...
    ListenerOutlierDetection listenerOutlierDetection = (ListenerOutlierDetection) o;
    return Objects.equals(this.baseEjectionDuration, listenerOutlierDetection.baseEjectionDuration) &&
        Objects.equals(this.interval, listenerOutlierDetection.interval) &&
        Objects.equals(this.maxEjectionPercent, listenerOutlierDetection.maxEjectionPercent) &&
        Objects.equals(this.maxServerErrors, listenerOutlierDetection.maxServerErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListenerOutlierDetection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListenerOutlierDetection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListenerOutlierDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListenerOutlierDetection is not found in the empty JSON string", ListenerOutlierDetection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListenerOutlierDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListenerOutlierDetection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListenerOutlierDetection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListenerOutlierDetection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListenerOutlierDetection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListenerOutlierDetection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListenerOutlierDetection.class));

       return (TypeAdapter<T>) new TypeAdapter<ListenerOutlierDetection>() {
           @Override
           public void write(JsonWriter out, ListenerOutlierDetection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListenerOutlierDetection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListenerOutlierDetection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListenerOutlierDetection
   * @throws IOException if the JSON string is invalid with respect to ListenerOutlierDetection
   */
  public static ListenerOutlierDetection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListenerOutlierDetection.class);
  }

  /**
   * Convert an instance of ListenerOutlierDetection to an JSON string
   *
   * @return JSON string
   */
