...
public class CreateVirtualNodeRequestSpec {
  ...
  public CreateVirtualNodeRequestSpec() {
  }

  public CreateVirtualNodeRequestSpec backendDefaults(CreateVirtualNodeRequestSpecBackendDefaults backendDefaults) {
  ...
  public CreateVirtualNodeRequestSpec backends(List backends) {
  ...
  public CreateVirtualNodeRequestSpec listeners(List listeners) {
  ...
  public CreateVirtualNodeRequestSpec logging(CreateVirtualNodeRequestSpecLogging logging) {
  ...
  public CreateVirtualNodeRequestSpec serviceDiscovery(CreateVirtualNodeRequestSpecServiceDiscovery serviceDiscovery) {
  ...
  public boolean equals(Object o) {
    ...
    CreateVirtualNodeRequestSpec createVirtualNodeRequestSpec = (CreateVirtualNodeRequestSpec) o;
    return Objects.equals(this.backendDefaults, createVirtualNodeRequestSpec.backendDefaults) &&
        Objects.equals(this.backends, createVirtualNodeRequestSpec.backends) &&
        Objects.equals(this.listeners, createVirtualNodeRequestSpec.listeners) &&
        Objects.equals(this.logging, createVirtualNodeRequestSpec.logging) &&
        Objects.equals(this.serviceDiscovery, createVirtualNodeRequestSpec.serviceDiscovery);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateVirtualNodeRequestSpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateVirtualNodeRequestSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateVirtualNodeRequestSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateVirtualNodeRequestSpec is not found in the empty JSON string", CreateVirtualNodeRequestSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateVirtualNodeRequestSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateVirtualNodeRequestSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateVirtualNodeRequestSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateVirtualNodeRequestSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateVirtualNodeRequestSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateVirtualNodeRequestSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateVirtualNodeRequestSpec>() {
           @Override
           public void write(JsonWriter out, CreateVirtualNodeRequestSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateVirtualNodeRequestSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateVirtualNodeRequestSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateVirtualNodeRequestSpec
   * @throws IOException if the JSON string is invalid with respect to CreateVirtualNodeRequestSpec
   */
  public static CreateVirtualNodeRequestSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateVirtualNodeRequestSpec.class);
  }

  /**
   * Convert an instance of CreateVirtualNodeRequestSpec to an JSON string
   *
   * @return JSON string
   */
