...
public class CreateVirtualNodeInputSpec {
  ...
  public CreateVirtualNodeInputSpec() {
  }

  public CreateVirtualNodeInputSpec backendDefaults(CreateVirtualNodeRequestSpecBackendDefaults backendDefaults) {
  ...
  public CreateVirtualNodeInputSpec backends(List backends) {
  ...
  public CreateVirtualNodeInputSpec listeners(List listeners) {
  ...
  public CreateVirtualNodeInputSpec logging(CreateVirtualNodeRequestSpecLogging logging) {
  ...
  public CreateVirtualNodeInputSpec serviceDiscovery(CreateVirtualNodeRequestSpecServiceDiscovery serviceDiscovery) {
  ...
  public boolean equals(Object o) {
    ...
    CreateVirtualNodeInputSpec createVirtualNodeInputSpec = (CreateVirtualNodeInputSpec) o;
    return Objects.equals(this.backendDefaults, createVirtualNodeInputSpec.backendDefaults) &&
        Objects.equals(this.backends, createVirtualNodeInputSpec.backends) &&
        Objects.equals(this.listeners, createVirtualNodeInputSpec.listeners) &&
        Objects.equals(this.logging, createVirtualNodeInputSpec.logging) &&
        Objects.equals(this.serviceDiscovery, createVirtualNodeInputSpec.serviceDiscovery);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateVirtualNodeInputSpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateVirtualNodeInputSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateVirtualNodeInputSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateVirtualNodeInputSpec is not found in the empty JSON string", CreateVirtualNodeInputSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateVirtualNodeInputSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateVirtualNodeInputSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateVirtualNodeInputSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateVirtualNodeInputSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateVirtualNodeInputSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateVirtualNodeInputSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateVirtualNodeInputSpec>() {
           @Override
           public void write(JsonWriter out, CreateVirtualNodeInputSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateVirtualNodeInputSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateVirtualNodeInputSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateVirtualNodeInputSpec
   * @throws IOException if the JSON string is invalid with respect to CreateVirtualNodeInputSpec
   */
  public static CreateVirtualNodeInputSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateVirtualNodeInputSpec.class);
  }

  /**
   * Convert an instance of CreateVirtualNodeInputSpec to an JSON string
   *
   * @return JSON string
   */
