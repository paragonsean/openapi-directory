...
class VirtualNodeRef {
     ...
     */
    constructor(arn, createdAt, lastUpdatedAt, meshName, meshOwner, resourceOwner, version, virtualNodeName) { 
        
        VirtualNodeRef.initialize(this, arn, createdAt, lastUpdatedAt, meshName, meshOwner, resourceOwner, version, virtualNodeName);
    }
     ...
     */
    static initialize(obj, arn, createdAt, lastUpdatedAt, meshName, meshOwner, resourceOwner, version, virtualNodeName) { 
        obj['arn'] = arn;
    ...
    static validateJSON(data) {
        ...
        for (const property of VirtualNodeRef.RequiredProperties) {
...
VirtualNodeRef.RequiredProperties = ["arn", "createdAt", "lastUpdatedAt", "meshName", "meshOwner", "resourceOwner", "version", "virtualNodeName"];
 ...
 */
VirtualNodeRef.prototype['createdAt'] = undefined;

/**
 * @member {Date} lastUpdatedAt
 */
VirtualNodeRef.prototype['lastUpdatedAt'] = undefined;
 ...
 */
VirtualNodeRef.prototype['meshOwner'] = undefined;

/**
 * @member {String} resourceOwner
 */
VirtualNodeRef.prototype['resourceOwner'] = undefined;

/**
 * @member {Number} version
 */
VirtualNodeRef.prototype['version'] = undefined;
