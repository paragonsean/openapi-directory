...
class RouteStatus {
     ...
     * @param status {module:model/RouteStatusCode} 
     */
    constructor(status) { 
        
        RouteStatus.initialize(this, status);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of RouteStatus.RequiredProperties) {
...
RouteStatus.RequiredProperties = ["status"];
