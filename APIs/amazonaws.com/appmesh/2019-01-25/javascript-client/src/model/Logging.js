...
import LoggingAccessLog from './LoggingAccessLog';
...
class Logging {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('accessLog')) {
                obj['accessLog'] = LoggingAccessLog.constructFromObject(data['accessLog']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['accessLog']) { // data not null
          LoggingAccessLog.validateJSON(data['accessLog']);
        }
...
/**
 * @member {module:model/LoggingAccessLog} accessLog
 */
Logging.prototype['accessLog'] = undefined;
