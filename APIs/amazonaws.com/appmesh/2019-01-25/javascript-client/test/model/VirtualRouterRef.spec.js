...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualRouterRef();
  });
  ...
  describe('VirtualRouterRef', function() {
    it('should create an instance of VirtualRouterRef', function() {
      // uncomment below and update the code to test VirtualRouterRef
      //var instance = new AwsAppMesh.VirtualRouterRef();
      //expect(instance).to.be.a(AwsAppMesh.VirtualRouterRef);
    });
