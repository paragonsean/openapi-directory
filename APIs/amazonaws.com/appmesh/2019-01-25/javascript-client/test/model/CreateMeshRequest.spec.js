...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateMeshRequest();
  });
  ...
  describe('CreateMeshRequest', function() {
    it('should create an instance of CreateMeshRequest', function() {
      // uncomment below and update the code to test CreateMeshRequest
      //var instance = new AwsAppMesh.CreateMeshRequest();
      //expect(instance).to.be.a(AwsAppMesh.CreateMeshRequest);
    });
