...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.MeshRef();
  });
  ...
  describe('MeshRef', function() {
    it('should create an instance of MeshRef', function() {
      // uncomment below and update the code to test MeshRef
      //var instance = new AwsAppMesh.MeshRef();
      //expect(instance).to.be.a(AwsAppMesh.MeshRef);
    });
