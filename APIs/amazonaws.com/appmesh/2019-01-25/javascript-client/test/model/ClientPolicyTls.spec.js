...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ClientPolicyTls();
  });
  ...
  describe('ClientPolicyTls', function() {
    it('should create an instance of ClientPolicyTls', function() {
      // uncomment below and update the code to test ClientPolicyTls
      //var instance = new AwsAppMesh.ClientPolicyTls();
      //expect(instance).to.be.a(AwsAppMesh.ClientPolicyTls);
    });
