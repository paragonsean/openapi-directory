...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.HttpPathMatch();
  });
  ...
  describe('HttpPathMatch', function() {
    it('should create an instance of HttpPathMatch', function() {
      // uncomment below and update the code to test HttpPathMatch
      //var instance = new AwsAppMesh.HttpPathMatch();
      //expect(instance).to.be.a(AwsAppMesh.HttpPathMatch);
    });
