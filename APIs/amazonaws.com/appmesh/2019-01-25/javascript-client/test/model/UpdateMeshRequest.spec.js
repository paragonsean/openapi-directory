...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateMeshRequest();
  });
  ...
  describe('UpdateMeshRequest', function() {
    it('should create an instance of UpdateMeshRequest', function() {
      // uncomment below and update the code to test UpdateMeshRequest
      //var instance = new AwsAppMesh.UpdateMeshRequest();
      //expect(instance).to.be.a(AwsAppMesh.UpdateMeshRequest);
    });
