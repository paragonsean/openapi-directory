...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.HttpGatewayRouteHeaderMatch();
  });
  ...
  describe('HttpGatewayRouteHeaderMatch', function() {
    it('should create an instance of HttpGatewayRouteHeaderMatch', function() {
      // uncomment below and update the code to test HttpGatewayRouteHeaderMatch
      //var instance = new AwsAppMesh.HttpGatewayRouteHeaderMatch();
      //expect(instance).to.be.a(AwsAppMesh.HttpGatewayRouteHeaderMatch);
    });
