...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualGatewayListenerTls();
  });
  ...
  describe('VirtualGatewayListenerTls', function() {
    it('should create an instance of VirtualGatewayListenerTls', function() {
      // uncomment below and update the code to test VirtualGatewayListenerTls
      //var instance = new AwsAppMesh.VirtualGatewayListenerTls();
      //expect(instance).to.be.a(AwsAppMesh.VirtualGatewayListenerTls);
    });
