...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateMeshInput();
  });
  ...
  describe('UpdateMeshInput', function() {
    it('should create an instance of UpdateMeshInput', function() {
      // uncomment below and update the code to test UpdateMeshInput
      //var instance = new AwsAppMesh.UpdateMeshInput();
      //expect(instance).to.be.a(AwsAppMesh.UpdateMeshInput);
    });
