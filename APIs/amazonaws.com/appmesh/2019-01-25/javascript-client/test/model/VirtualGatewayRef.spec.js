...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualGatewayRef();
  });
  ...
  describe('VirtualGatewayRef', function() {
    it('should create an instance of VirtualGatewayRef', function() {
      // uncomment below and update the code to test VirtualGatewayRef
      //var instance = new AwsAppMesh.VirtualGatewayRef();
      //expect(instance).to.be.a(AwsAppMesh.VirtualGatewayRef);
    });
