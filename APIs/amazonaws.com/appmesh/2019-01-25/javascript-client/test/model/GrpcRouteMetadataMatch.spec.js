...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.GrpcRouteMetadataMatch();
  });
  ...
  describe('GrpcRouteMetadataMatch', function() {
    it('should create an instance of GrpcRouteMetadataMatch', function() {
      // uncomment below and update the code to test GrpcRouteMetadataMatch
      //var instance = new AwsAppMesh.GrpcRouteMetadataMatch();
      //expect(instance).to.be.a(AwsAppMesh.GrpcRouteMetadataMatch);
    });
