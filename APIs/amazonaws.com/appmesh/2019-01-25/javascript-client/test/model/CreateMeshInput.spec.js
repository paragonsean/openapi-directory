...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateMeshInput();
  });
  ...
  describe('CreateMeshInput', function() {
    it('should create an instance of CreateMeshInput', function() {
      // uncomment below and update the code to test CreateMeshInput
      //var instance = new AwsAppMesh.CreateMeshInput();
      //expect(instance).to.be.a(AwsAppMesh.CreateMeshInput);
    });
