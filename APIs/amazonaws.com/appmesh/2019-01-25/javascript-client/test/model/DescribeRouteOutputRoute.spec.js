...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DescribeRouteOutputRoute();
  });
  ...
  describe('DescribeRouteOutputRoute', function() {
    it('should create an instance of DescribeRouteOutputRoute', function() {
      // uncomment below and update the code to test DescribeRouteOutputRoute
      //var instance = new AwsAppMesh.DescribeRouteOutputRoute();
      //expect(instance).to.be.a(AwsAppMesh.DescribeRouteOutputRoute);
    });
