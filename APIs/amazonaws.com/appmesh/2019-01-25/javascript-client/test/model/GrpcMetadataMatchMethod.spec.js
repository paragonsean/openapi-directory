...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.GrpcMetadataMatchMethod();
  });
  ...
  describe('GrpcMetadataMatchMethod', function() {
    it('should create an instance of GrpcMetadataMatchMethod', function() {
      // uncomment below and update the code to test GrpcMetadataMatchMethod
      //var instance = new AwsAppMesh.GrpcMetadataMatchMethod();
      //expect(instance).to.be.a(AwsAppMesh.GrpcMetadataMatchMethod);
    });
