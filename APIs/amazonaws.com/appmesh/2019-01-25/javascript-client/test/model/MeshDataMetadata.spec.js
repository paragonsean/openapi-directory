...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.MeshDataMetadata();
  });
  ...
  describe('MeshDataMetadata', function() {
    it('should create an instance of MeshDataMetadata', function() {
      // uncomment below and update the code to test MeshDataMetadata
      //var instance = new AwsAppMesh.MeshDataMetadata();
      //expect(instance).to.be.a(AwsAppMesh.MeshDataMetadata);
    });
