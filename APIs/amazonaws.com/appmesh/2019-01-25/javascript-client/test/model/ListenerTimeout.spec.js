...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListenerTimeout();
  });
  ...
  describe('ListenerTimeout', function() {
    it('should create an instance of ListenerTimeout', function() {
      // uncomment below and update the code to test ListenerTimeout
      //var instance = new AwsAppMesh.ListenerTimeout();
      //expect(instance).to.be.a(AwsAppMesh.ListenerTimeout);
    });
