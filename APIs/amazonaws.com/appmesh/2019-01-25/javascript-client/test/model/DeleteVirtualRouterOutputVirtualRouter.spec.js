...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DeleteVirtualRouterOutputVirtualRouter();
  });
  ...
  describe('DeleteVirtualRouterOutputVirtualRouter', function() {
    it('should create an instance of DeleteVirtualRouterOutputVirtualRouter', function() {
      // uncomment below and update the code to test DeleteVirtualRouterOutputVirtualRouter
      //var instance = new AwsAppMesh.DeleteVirtualRouterOutputVirtualRouter();
      //expect(instance).to.be.a(AwsAppMesh.DeleteVirtualRouterOutputVirtualRouter);
    });
