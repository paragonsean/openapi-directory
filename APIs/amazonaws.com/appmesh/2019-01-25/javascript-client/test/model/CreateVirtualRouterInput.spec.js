...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateVirtualRouterInput();
  });
  ...
  describe('CreateVirtualRouterInput', function() {
    it('should create an instance of CreateVirtualRouterInput', function() {
      // uncomment below and update the code to test CreateVirtualRouterInput
      //var instance = new AwsAppMesh.CreateVirtualRouterInput();
      //expect(instance).to.be.a(AwsAppMesh.CreateVirtualRouterInput);
    });
