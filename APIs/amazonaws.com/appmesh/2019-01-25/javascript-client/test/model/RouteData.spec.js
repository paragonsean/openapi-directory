...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.RouteData();
  });
  ...
  describe('RouteData', function() {
    it('should create an instance of RouteData', function() {
      // uncomment below and update the code to test RouteData
      //var instance = new AwsAppMesh.RouteData();
      //expect(instance).to.be.a(AwsAppMesh.RouteData);
    });
