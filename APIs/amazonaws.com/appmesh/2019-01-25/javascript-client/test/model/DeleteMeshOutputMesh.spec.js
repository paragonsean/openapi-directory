...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DeleteMeshOutputMesh();
  });
  ...
  describe('DeleteMeshOutputMesh', function() {
    it('should create an instance of DeleteMeshOutputMesh', function() {
      // uncomment below and update the code to test DeleteMeshOutputMesh
      //var instance = new AwsAppMesh.DeleteMeshOutputMesh();
      //expect(instance).to.be.a(AwsAppMesh.DeleteMeshOutputMesh);
    });
