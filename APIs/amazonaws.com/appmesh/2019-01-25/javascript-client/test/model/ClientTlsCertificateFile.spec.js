...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ClientTlsCertificateFile();
  });
  ...
  describe('ClientTlsCertificateFile', function() {
    it('should create an instance of ClientTlsCertificateFile', function() {
      // uncomment below and update the code to test ClientTlsCertificateFile
      //var instance = new AwsAppMesh.ClientTlsCertificateFile();
      //expect(instance).to.be.a(AwsAppMesh.ClientTlsCertificateFile);
    });
