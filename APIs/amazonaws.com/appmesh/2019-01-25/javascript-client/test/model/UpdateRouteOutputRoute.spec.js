...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.UpdateRouteOutputRoute();
  });
  ...
  describe('UpdateRouteOutputRoute', function() {
    it('should create an instance of UpdateRouteOutputRoute', function() {
      // uncomment below and update the code to test UpdateRouteOutputRoute
      //var instance = new AwsAppMesh.UpdateRouteOutputRoute();
      //expect(instance).to.be.a(AwsAppMesh.UpdateRouteOutputRoute);
    });
