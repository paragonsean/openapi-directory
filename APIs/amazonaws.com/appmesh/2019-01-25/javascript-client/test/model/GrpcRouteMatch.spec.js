...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.GrpcRouteMatch();
  });
  ...
  describe('GrpcRouteMatch', function() {
    it('should create an instance of GrpcRouteMatch', function() {
      // uncomment below and update the code to test GrpcRouteMatch
      //var instance = new AwsAppMesh.GrpcRouteMatch();
      //expect(instance).to.be.a(AwsAppMesh.GrpcRouteMatch);
    });
