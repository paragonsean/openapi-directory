...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListRoutesOutput();
  });
  ...
  describe('ListRoutesOutput', function() {
    it('should create an instance of ListRoutesOutput', function() {
      // uncomment below and update the code to test ListRoutesOutput
      //var instance = new AwsAppMesh.ListRoutesOutput();
      //expect(instance).to.be.a(AwsAppMesh.ListRoutesOutput);
    });
