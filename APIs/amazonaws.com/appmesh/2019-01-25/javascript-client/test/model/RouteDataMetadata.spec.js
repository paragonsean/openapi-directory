...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.RouteDataMetadata();
  });
  ...
  describe('RouteDataMetadata', function() {
    it('should create an instance of RouteDataMetadata', function() {
      // uncomment below and update the code to test RouteDataMetadata
      //var instance = new AwsAppMesh.RouteDataMetadata();
      //expect(instance).to.be.a(AwsAppMesh.RouteDataMetadata);
    });
