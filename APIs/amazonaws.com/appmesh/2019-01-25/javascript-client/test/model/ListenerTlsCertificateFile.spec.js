...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListenerTlsCertificateFile();
  });
  ...
  describe('ListenerTlsCertificateFile', function() {
    it('should create an instance of ListenerTlsCertificateFile', function() {
      // uncomment below and update the code to test ListenerTlsCertificateFile
      //var instance = new AwsAppMesh.ListenerTlsCertificateFile();
      //expect(instance).to.be.a(AwsAppMesh.ListenerTlsCertificateFile);
    });
