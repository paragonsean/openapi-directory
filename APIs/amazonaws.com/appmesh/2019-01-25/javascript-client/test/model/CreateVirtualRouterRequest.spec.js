...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.CreateVirtualRouterRequest();
  });
  ...
  describe('CreateVirtualRouterRequest', function() {
    it('should create an instance of CreateVirtualRouterRequest', function() {
      // uncomment below and update the code to test CreateVirtualRouterRequest
      //var instance = new AwsAppMesh.CreateVirtualRouterRequest();
      //expect(instance).to.be.a(AwsAppMesh.CreateVirtualRouterRequest);
    });
