...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListenerTls();
  });
  ...
  describe('ListenerTls', function() {
    it('should create an instance of ListenerTls', function() {
      // uncomment below and update the code to test ListenerTls
      //var instance = new AwsAppMesh.ListenerTls();
      //expect(instance).to.be.a(AwsAppMesh.ListenerTls);
    });
