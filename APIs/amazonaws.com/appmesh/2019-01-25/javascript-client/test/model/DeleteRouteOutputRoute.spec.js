...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.DeleteRouteOutputRoute();
  });
  ...
  describe('DeleteRouteOutputRoute', function() {
    it('should create an instance of DeleteRouteOutputRoute', function() {
      // uncomment below and update the code to test DeleteRouteOutputRoute
      //var instance = new AwsAppMesh.DeleteRouteOutputRoute();
      //expect(instance).to.be.a(AwsAppMesh.DeleteRouteOutputRoute);
    });
