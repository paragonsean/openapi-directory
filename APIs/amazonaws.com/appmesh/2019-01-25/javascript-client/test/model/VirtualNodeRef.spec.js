...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualNodeRef();
  });
  ...
  describe('VirtualNodeRef', function() {
    it('should create an instance of VirtualNodeRef', function() {
      // uncomment below and update the code to test VirtualNodeRef
      //var instance = new AwsAppMesh.VirtualNodeRef();
      //expect(instance).to.be.a(AwsAppMesh.VirtualNodeRef);
    });
