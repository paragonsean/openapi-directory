...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualServiceRef();
  });
  ...
  describe('VirtualServiceRef', function() {
    it('should create an instance of VirtualServiceRef', function() {
      // uncomment below and update the code to test VirtualServiceRef
      //var instance = new AwsAppMesh.VirtualServiceRef();
      //expect(instance).to.be.a(AwsAppMesh.VirtualServiceRef);
    });
    ...
    it('should have the property meshOwner (base name: "meshOwner")', function() {
      // uncomment below and update the code to test the property meshOwner
      //var instance = new AwsAppMesh.VirtualServiceRef();
      //expect(instance).to.be();
    });
