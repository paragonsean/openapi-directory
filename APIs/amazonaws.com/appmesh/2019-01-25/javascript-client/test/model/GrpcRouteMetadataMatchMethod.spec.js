...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.GrpcRouteMetadataMatchMethod();
  });
  ...
  describe('GrpcRouteMetadataMatchMethod', function() {
    it('should create an instance of GrpcRouteMetadataMatchMethod', function() {
      // uncomment below and update the code to test GrpcRouteMetadataMatchMethod
      //var instance = new AwsAppMesh.GrpcRouteMetadataMatchMethod();
      //expect(instance).to.be.a(AwsAppMesh.GrpcRouteMetadataMatchMethod);
    });
