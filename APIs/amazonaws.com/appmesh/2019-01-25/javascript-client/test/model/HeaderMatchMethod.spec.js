...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.HeaderMatchMethod();
  });
  ...
  describe('HeaderMatchMethod', function() {
    it('should create an instance of HeaderMatchMethod', function() {
      // uncomment below and update the code to test HeaderMatchMethod
      //var instance = new AwsAppMesh.HeaderMatchMethod();
      //expect(instance).to.be.a(AwsAppMesh.HeaderMatchMethod);
    });
