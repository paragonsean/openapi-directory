...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.GrpcGatewayRouteMetadataMatch();
  });
  ...
  describe('GrpcGatewayRouteMetadataMatch', function() {
    it('should create an instance of GrpcGatewayRouteMetadataMatch', function() {
      // uncomment below and update the code to test GrpcGatewayRouteMetadataMatch
      //var instance = new AwsAppMesh.GrpcGatewayRouteMetadataMatch();
      //expect(instance).to.be.a(AwsAppMesh.GrpcGatewayRouteMetadataMatch);
    });
