...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.ListenerTlsFileCertificate();
  });
  ...
  describe('ListenerTlsFileCertificate', function() {
    it('should create an instance of ListenerTlsFileCertificate', function() {
      // uncomment below and update the code to test ListenerTlsFileCertificate
      //var instance = new AwsAppMesh.ListenerTlsFileCertificate();
      //expect(instance).to.be.a(AwsAppMesh.ListenerTlsFileCertificate);
    });
