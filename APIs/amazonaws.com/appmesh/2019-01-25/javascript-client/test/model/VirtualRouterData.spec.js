...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualRouterData();
  });
  ...
  describe('VirtualRouterData', function() {
    it('should create an instance of VirtualRouterData', function() {
      // uncomment below and update the code to test VirtualRouterData
      //var instance = new AwsAppMesh.VirtualRouterData();
      //expect(instance).to.be.a(AwsAppMesh.VirtualRouterData);
    });
