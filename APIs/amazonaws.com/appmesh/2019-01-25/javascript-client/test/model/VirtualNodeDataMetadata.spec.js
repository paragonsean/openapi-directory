...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppMesh.VirtualNodeDataMetadata();
  });
  ...
  describe('VirtualNodeDataMetadata', function() {
    it('should create an instance of VirtualNodeDataMetadata', function() {
      // uncomment below and update the code to test VirtualNodeDataMetadata
      //var instance = new AwsAppMesh.VirtualNodeDataMetadata();
      //expect(instance).to.be.a(AwsAppMesh.VirtualNodeDataMetadata);
    });
