...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForEquipment.DataIngestionJobSummary();
  });
  ...
  describe('DataIngestionJobSummary', function() {
    it('should create an instance of DataIngestionJobSummary', function() {
      // uncomment below and update the code to test DataIngestionJobSummary
      //var instance = new AmazonLookoutForEquipment.DataIngestionJobSummary();
      //expect(instance).to.be.a(AmazonLookoutForEquipment.DataIngestionJobSummary);
    });
