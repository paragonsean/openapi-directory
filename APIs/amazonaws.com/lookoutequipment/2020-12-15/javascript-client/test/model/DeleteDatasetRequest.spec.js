...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForEquipment.DeleteDatasetRequest();
  });
  ...
  describe('DeleteDatasetRequest', function() {
    it('should create an instance of DeleteDatasetRequest', function() {
      ...
      //var instance = new AmazonLookoutForEquipment.DeleteDatasetRequest();
      //expect(instance).to.be.a(AmazonLookoutForEquipment.DeleteDatasetRequest);
    });
