...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForEquipment.CreateLabelRequest();
  });
  ...
  describe('CreateLabelRequest', function() {
    it('should create an instance of CreateLabelRequest', function() {
      // uncomment below and update the code to test CreateLabelRequest
      //var instance = new AmazonLookoutForEquipment.CreateLabelRequest();
      //expect(instance).to.be.a(AmazonLookoutForEquipment.CreateLabelRequest);
    });
