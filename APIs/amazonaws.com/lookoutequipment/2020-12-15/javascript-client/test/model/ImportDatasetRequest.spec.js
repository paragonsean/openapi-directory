...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForEquipment.ImportDatasetRequest();
  });
  ...
  describe('ImportDatasetRequest', function() {
    it('should create an instance of ImportDatasetRequest', function() {
      // uncomment below and update the code to test ImportDatasetRequest
      //var instance = new AmazonLookoutForEquipment.ImportDatasetRequest();
      //expect(instance).to.be.a(AmazonLookoutForEquipment.ImportDatasetRequest);
    });
