...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForEquipment.ImportDatasetResponse();
  });
  ...
  describe('ImportDatasetResponse', function() {
    it('should create an instance of ImportDatasetResponse', function() {
      // uncomment below and update the code to test ImportDatasetResponse
      //var instance = new AmazonLookoutForEquipment.ImportDatasetResponse();
      //expect(instance).to.be.a(AmazonLookoutForEquipment.ImportDatasetResponse);
    });
