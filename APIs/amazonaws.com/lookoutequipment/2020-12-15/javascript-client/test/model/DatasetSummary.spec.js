...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForEquipment.DatasetSummary();
  });
  ...
  describe('DatasetSummary', function() {
    it('should create an instance of DatasetSummary', function() {
      ...
      //var instance = new AmazonLookoutForEquipment.DatasetSummary();
      //expect(instance).to.be.a(AmazonLookoutForEquipment.DatasetSummary);
    });
