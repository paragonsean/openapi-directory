...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForEquipment.ListDataIngestionJobsRequest();
  });
  ...
  describe('ListDataIngestionJobsRequest', function() {
    it('should create an instance of ListDataIngestionJobsRequest', function() {
      // uncomment below and update the code to test ListDataIngestionJobsRequest
      //var instance = new AmazonLookoutForEquipment.ListDataIngestionJobsRequest();
      //expect(instance).to.be.a(AmazonLookoutForEquipment.ListDataIngestionJobsRequest);
    });
