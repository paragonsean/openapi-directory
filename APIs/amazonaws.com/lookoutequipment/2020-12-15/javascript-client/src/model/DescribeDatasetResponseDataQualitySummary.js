...
/**
 * The DescribeDatasetResponseDataQualitySummary model module.
 * @module model/DescribeDatasetResponseDataQualitySummary
 * @version 2020-12-15
 */
class DescribeDatasetResponseDataQualitySummary {
    /**
     * Constructs a new <code>DescribeDatasetResponseDataQualitySummary</code>.
     * @alias module:model/DescribeDatasetResponseDataQualitySummary
    ...
    constructor(insufficientSensorData, missingSensorData, invalidSensorData, unsupportedTimestamps, duplicateTimestamps) { 
        ...
        DescribeDatasetResponseDataQualitySummary.initialize(this, insufficientSensorData, missingSensorData, invalidSensorData, unsupportedTimestamps, duplicateTimestamps);
    }
    ...
    /**
     * Constructs a <code>DescribeDatasetResponseDataQualitySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeDatasetResponseDataQualitySummary} obj Optional instance to populate.
     * @return {module:model/DescribeDatasetResponseDataQualitySummary} The populated <code>DescribeDatasetResponseDataQualitySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeDatasetResponseDataQualitySummary();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeDatasetResponseDataQualitySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeDatasetResponseDataQualitySummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeDatasetResponseDataQualitySummary.RequiredProperties) {
...
DescribeDatasetResponseDataQualitySummary.RequiredProperties = ["InsufficientSensorData", "MissingSensorData", "InvalidSensorData", "UnsupportedTimestamps", "DuplicateTimestamps"];

/**
 * @member {module:model/DataQualitySummaryInsufficientSensorData} InsufficientSensorData
 */
DescribeDatasetResponseDataQualitySummary.prototype['InsufficientSensorData'] = undefined;

/**
 * @member {module:model/DataQualitySummaryMissingSensorData} MissingSensorData
 */
DescribeDatasetResponseDataQualitySummary.prototype['MissingSensorData'] = undefined;

/**
 * @member {module:model/DataQualitySummaryInvalidSensorData} InvalidSensorData
 */
DescribeDatasetResponseDataQualitySummary.prototype['InvalidSensorData'] = undefined;

/**
 * @member {module:model/DataQualitySummaryUnsupportedTimestamps} UnsupportedTimestamps
 */
DescribeDatasetResponseDataQualitySummary.prototype['UnsupportedTimestamps'] = undefined;

/**
 * @member {module:model/DataQualitySummaryDuplicateTimestamps} DuplicateTimestamps
 */
DescribeDatasetResponseDataQualitySummary.prototype['DuplicateTimestamps'] = undefined;
...
export default DescribeDatasetResponseDataQualitySummary;
