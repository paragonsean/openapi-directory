...
/**
 * The CreateInferenceSchedulerRequestDataInputConfiguration model module.
 * @module model/CreateInferenceSchedulerRequestDataInputConfiguration
 * @version 2020-12-15
 */
class CreateInferenceSchedulerRequestDataInputConfiguration {
    /**
     * Constructs a new <code>CreateInferenceSchedulerRequestDataInputConfiguration</code>.
     * @alias module:model/CreateInferenceSchedulerRequestDataInputConfiguration
     * @implements module:model/InferenceInputConfiguration
     */
    constructor() { 
        InferenceInputConfiguration.initialize(this);
        CreateInferenceSchedulerRequestDataInputConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateInferenceSchedulerRequestDataInputConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateInferenceSchedulerRequestDataInputConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateInferenceSchedulerRequestDataInputConfiguration} The populated <code>CreateInferenceSchedulerRequestDataInputConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateInferenceSchedulerRequestDataInputConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateInferenceSchedulerRequestDataInputConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateInferenceSchedulerRequestDataInputConfiguration</code>.
     */
 ...
 */
CreateInferenceSchedulerRequestDataInputConfiguration.prototype['S3InputConfiguration'] = undefined;

/**
 * @member {String} InputTimeZoneOffset
 */
CreateInferenceSchedulerRequestDataInputConfiguration.prototype['InputTimeZoneOffset'] = undefined;

/**
 * @member {module:model/InferenceInputConfigurationInferenceInputNameConfiguration} InferenceInputNameConfiguration
 */
CreateInferenceSchedulerRequestDataInputConfiguration.prototype['InferenceInputNameConfiguration'] = undefined;
...
export default CreateInferenceSchedulerRequestDataInputConfiguration;
