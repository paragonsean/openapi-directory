...
/**
 * The DescribeInferenceSchedulerResponseDataInputConfiguration model module.
 * @module model/DescribeInferenceSchedulerResponseDataInputConfiguration
 * @version 2020-12-15
 */
class DescribeInferenceSchedulerResponseDataInputConfiguration {
    /**
     * Constructs a new <code>DescribeInferenceSchedulerResponseDataInputConfiguration</code>.
     * @alias module:model/DescribeInferenceSchedulerResponseDataInputConfiguration
     * @implements module:model/InferenceInputConfiguration
     */
    constructor() { 
        InferenceInputConfiguration.initialize(this);
        DescribeInferenceSchedulerResponseDataInputConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeInferenceSchedulerResponseDataInputConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeInferenceSchedulerResponseDataInputConfiguration} obj Optional instance to populate.
     * @return {module:model/DescribeInferenceSchedulerResponseDataInputConfiguration} The populated <code>DescribeInferenceSchedulerResponseDataInputConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeInferenceSchedulerResponseDataInputConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeInferenceSchedulerResponseDataInputConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeInferenceSchedulerResponseDataInputConfiguration</code>.
     */
 ...
 */
DescribeInferenceSchedulerResponseDataInputConfiguration.prototype['S3InputConfiguration'] = undefined;

/**
 * @member {String} InputTimeZoneOffset
 */
DescribeInferenceSchedulerResponseDataInputConfiguration.prototype['InputTimeZoneOffset'] = undefined;

/**
 * @member {module:model/InferenceInputConfigurationInferenceInputNameConfiguration} InferenceInputNameConfiguration
 */
DescribeInferenceSchedulerResponseDataInputConfiguration.prototype['InferenceInputNameConfiguration'] = undefined;
...
export default DescribeInferenceSchedulerResponseDataInputConfiguration;
