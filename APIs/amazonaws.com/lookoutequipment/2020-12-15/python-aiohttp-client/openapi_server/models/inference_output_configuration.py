...
class InferenceOutputConfiguration(Model):
    ...
    def __init__(self, s3_output_configuration: InferenceOutputConfigurationS3OutputConfiguration=None, kms_key_id: str=None):
        """InferenceOutputConfiguration - a model defined in OpenAPI

        :param s3_output_configuration: The s3_output_configuration of this InferenceOutputConfiguration.
        :param kms_key_id: The kms_key_id of this InferenceOutputConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InferenceOutputConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The InferenceOutputConfiguration of this InferenceOutputConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def s3_output_configuration(self):
        """Gets the s3_output_configuration of this InferenceOutputConfiguration.


        :return: The s3_output_configuration of this InferenceOutputConfiguration.
    ...
    def s3_output_configuration(self, s3_output_configuration):
        """Sets the s3_output_configuration of this InferenceOutputConfiguration.
    ...
    @property
    def kms_key_id(self):
        """Gets the kms_key_id of this InferenceOutputConfiguration.


        :return: The kms_key_id of this InferenceOutputConfiguration.
        :rtype: str
        """
    ...
    def kms_key_id(self, kms_key_id):
        """Sets the kms_key_id of this InferenceOutputConfiguration.
