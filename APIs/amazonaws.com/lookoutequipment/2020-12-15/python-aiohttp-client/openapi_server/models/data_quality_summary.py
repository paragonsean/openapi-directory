...
class DataQualitySummary(Model):
    ...
    def __init__(self, insufficient_sensor_data: DataQualitySummaryInsufficientSensorData=None, missing_sensor_data: DataQualitySummaryMissingSensorData=None, invalid_sensor_data: DataQualitySummaryInvalidSensorData=None, unsupported_timestamps: DataQualitySummaryUnsupportedTimestamps=None, duplicate_timestamps: DataQualitySummaryDuplicateTimestamps=None):
        """DataQualitySummary - a model defined in OpenAPI

        :param insufficient_sensor_data: The insufficient_sensor_data of this DataQualitySummary.
        :param missing_sensor_data: The missing_sensor_data of this DataQualitySummary.
        :param invalid_sensor_data: The invalid_sensor_data of this DataQualitySummary.
        :param unsupported_timestamps: The unsupported_timestamps of this DataQualitySummary.
        :param duplicate_timestamps: The duplicate_timestamps of this DataQualitySummary.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DataQualitySummary':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DataQualitySummary of this DataQualitySummary.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def insufficient_sensor_data(self):
        """Gets the insufficient_sensor_data of this DataQualitySummary.


        :return: The insufficient_sensor_data of this DataQualitySummary.
    ...
    def insufficient_sensor_data(self, insufficient_sensor_data):
        """Sets the insufficient_sensor_data of this DataQualitySummary.
    ...
    def missing_sensor_data(self):
        """Gets the missing_sensor_data of this DataQualitySummary.


        :return: The missing_sensor_data of this DataQualitySummary.
    ...
    def missing_sensor_data(self, missing_sensor_data):
        """Sets the missing_sensor_data of this DataQualitySummary.
    ...
    def invalid_sensor_data(self):
        """Gets the invalid_sensor_data of this DataQualitySummary.


        :return: The invalid_sensor_data of this DataQualitySummary.
    ...
    def invalid_sensor_data(self, invalid_sensor_data):
        """Sets the invalid_sensor_data of this DataQualitySummary.
    ...
    def unsupported_timestamps(self):
        """Gets the unsupported_timestamps of this DataQualitySummary.


        :return: The unsupported_timestamps of this DataQualitySummary.
    ...
    def unsupported_timestamps(self, unsupported_timestamps):
        """Sets the unsupported_timestamps of this DataQualitySummary.
    ...
    def duplicate_timestamps(self):
        """Gets the duplicate_timestamps of this DataQualitySummary.


        :return: The duplicate_timestamps of this DataQualitySummary.
    ...
    def duplicate_timestamps(self, duplicate_timestamps):
        """Sets the duplicate_timestamps of this DataQualitySummary.
