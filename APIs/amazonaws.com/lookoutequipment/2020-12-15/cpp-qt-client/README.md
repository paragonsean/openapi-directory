...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICreateDatasetRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICreateDatasetRequest Example::create(){
    OAICreateDatasetRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      OAICreateDatasetRequest oai_create_dataset_request = create(); // OAICreateDatasetRequest | 
      ...
      apiInstance.createDataset(x_amz_targetoai_create_dataset_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
