...
/*
 * OAICreateInferenceSchedulerResponse.h
 *
 * 
 */

#ifndef OAICreateInferenceSchedulerResponse_H
#define OAICreateInferenceSchedulerResponse_H
...
class OAICreateInferenceSchedulerResponse : public OAIObject {
public:
    OAICreateInferenceSchedulerResponse();
    OAICreateInferenceSchedulerResponse(QString json);
    ~OAICreateInferenceSchedulerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateInferenceSchedulerResponse)

#endif // OAICreateInferenceSchedulerResponse_H
