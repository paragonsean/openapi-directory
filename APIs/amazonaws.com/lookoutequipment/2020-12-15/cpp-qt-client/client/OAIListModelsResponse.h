...
public:
    ...
    QList getModelSummaries() const;
    void setModelSummaries(const QList &model_summaries);
    bool is_model_summaries_Set() const;
    bool is_model_summaries_Valid() const;
...
private:
    ...
    QList m_model_summaries;
    bool m_model_summaries_isSet;
    bool m_model_summaries_isValid;
};
