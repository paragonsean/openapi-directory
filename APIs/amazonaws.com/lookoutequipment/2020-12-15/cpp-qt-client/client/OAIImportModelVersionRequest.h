...
/*
 * OAIImportModelVersionRequest.h
 *
 * 
 */

#ifndef OAIImportModelVersionRequest_H
#define OAIImportModelVersionRequest_H
...
class OAIImportModelVersionRequest : public OAIObject {
public:
    OAIImportModelVersionRequest();
    OAIImportModelVersionRequest(QString json);
    ~OAIImportModelVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportModelVersionRequest)

#endif // OAIImportModelVersionRequest_H
