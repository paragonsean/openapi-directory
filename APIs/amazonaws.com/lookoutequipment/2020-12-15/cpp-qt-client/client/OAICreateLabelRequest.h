...
/*
 * OAICreateLabelRequest.h
 *
 * 
 */

#ifndef OAICreateLabelRequest_H
#define OAICreateLabelRequest_H
...
class OAICreateLabelRequest : public OAIObject {
public:
    OAICreateLabelRequest();
    OAICreateLabelRequest(QString json);
    ~OAICreateLabelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLabelRequest)

#endif // OAICreateLabelRequest_H
