...
/*
 * OAIDataQualitySummary_InsufficientSensorData.h
 *
 * 
 */

#ifndef OAIDataQualitySummary_InsufficientSensorData_H
#define OAIDataQualitySummary_InsufficientSensorData_H
...
class OAIDataQualitySummary_InsufficientSensorData : public OAIObject {
public:
    OAIDataQualitySummary_InsufficientSensorData();
    OAIDataQualitySummary_InsufficientSensorData(QString json);
    ~OAIDataQualitySummary_InsufficientSensorData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataQualitySummary_InsufficientSensorData)

#endif // OAIDataQualitySummary_InsufficientSensorData_H
