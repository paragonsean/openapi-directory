...
/*
 * OAIImportDatasetResponse.h
 *
 * 
 */

#ifndef OAIImportDatasetResponse_H
#define OAIImportDatasetResponse_H
...
class OAIImportDatasetResponse : public OAIObject {
public:
    OAIImportDatasetResponse();
    OAIImportDatasetResponse(QString json);
    ~OAIImportDatasetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportDatasetResponse)

#endif // OAIImportDatasetResponse_H
