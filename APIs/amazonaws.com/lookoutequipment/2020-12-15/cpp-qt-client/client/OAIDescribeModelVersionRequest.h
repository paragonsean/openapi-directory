...
/*
 * OAIDescribeModelVersionRequest.h
 *
 * 
 */

#ifndef OAIDescribeModelVersionRequest_H
#define OAIDescribeModelVersionRequest_H
...
class OAIDescribeModelVersionRequest : public OAIObject {
public:
    OAIDescribeModelVersionRequest();
    OAIDescribeModelVersionRequest(QString json);
    ~OAIDescribeModelVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeModelVersionRequest)

#endif // OAIDescribeModelVersionRequest_H
