...
/*
 * OAIInferenceInputConfiguration.h
 *
 * Specifies configuration information for the input data for the inference, including Amazon S3 location of input data.. 
 */

#ifndef OAIInferenceInputConfiguration_H
#define OAIInferenceInputConfiguration_H
...
class OAIInferenceInputConfiguration : public OAIObject {
public:
    OAIInferenceInputConfiguration();
    OAIInferenceInputConfiguration(QString json);
    ~OAIInferenceInputConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInferenceInputConfiguration)

#endif // OAIInferenceInputConfiguration_H
