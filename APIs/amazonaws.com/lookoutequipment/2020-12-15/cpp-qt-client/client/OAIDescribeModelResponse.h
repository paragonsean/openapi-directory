...
namespace OpenAPI {
class OAIDescribeModelResponse_LabelsInputConfiguration;
...
public:
    ...
    OAIDescribeModelResponse_LabelsInputConfiguration getLabelsInputConfiguration() const;
    void setLabelsInputConfiguration(const OAIDescribeModelResponse_LabelsInputConfiguration &labels_input_configuration);
    ...
    QDateTime getModelVersionActivatedAt() const;
    void setModelVersionActivatedAt(const QDateTime &model_version_activated_at);
    bool is_model_version_activated_at_Set() const;
    bool is_model_version_activated_at_Valid() const;

    qint32 getPreviousActiveModelVersion() const;
    void setPreviousActiveModelVersion(const qint32 &previous_active_model_version);
    bool is_previous_active_model_version_Set() const;
    bool is_previous_active_model_version_Valid() const;

    QString getPreviousActiveModelVersionArn() const;
    void setPreviousActiveModelVersionArn(const QString &previous_active_model_version_arn);
    bool is_previous_active_model_version_arn_Set() const;
    bool is_previous_active_model_version_arn_Valid() const;

    QDateTime getPreviousModelVersionActivatedAt() const;
    void setPreviousModelVersionActivatedAt(const QDateTime &previous_model_version_activated_at);
    bool is_previous_model_version_activated_at_Set() const;
    bool is_previous_model_version_activated_at_Valid() const;
...
private:
    ...
    OAIDescribeModelResponse_LabelsInputConfiguration m_labels_input_configuration;
    ...
    QDateTime m_model_version_activated_at;
    bool m_model_version_activated_at_isSet;
    bool m_model_version_activated_at_isValid;

    qint32 m_previous_active_model_version;
    bool m_previous_active_model_version_isSet;
    bool m_previous_active_model_version_isValid;

    QString m_previous_active_model_version_arn;
    bool m_previous_active_model_version_arn_isSet;
    bool m_previous_active_model_version_arn_isValid;

    QDateTime m_previous_model_version_activated_at;
    bool m_previous_model_version_activated_at_isSet;
    bool m_previous_model_version_activated_at_isValid;
};
