...
/*
 * OAIStopInferenceSchedulerResponse.h
 *
 * 
 */

#ifndef OAIStopInferenceSchedulerResponse_H
#define OAIStopInferenceSchedulerResponse_H
...
class OAIStopInferenceSchedulerResponse : public OAIObject {
public:
    OAIStopInferenceSchedulerResponse();
    OAIStopInferenceSchedulerResponse(QString json);
    ~OAIStopInferenceSchedulerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopInferenceSchedulerResponse)

#endif // OAIStopInferenceSchedulerResponse_H
