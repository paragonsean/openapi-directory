...
public class DescribeDatasetResponseDataQualitySummary {
  ...
  public DescribeDatasetResponseDataQualitySummary() {
  }

  public DescribeDatasetResponseDataQualitySummary insufficientSensorData(DataQualitySummaryInsufficientSensorData insufficientSensorData) {
  ...
  public DescribeDatasetResponseDataQualitySummary missingSensorData(DataQualitySummaryMissingSensorData missingSensorData) {
  ...
  public DescribeDatasetResponseDataQualitySummary invalidSensorData(DataQualitySummaryInvalidSensorData invalidSensorData) {
  ...
  public DescribeDatasetResponseDataQualitySummary unsupportedTimestamps(DataQualitySummaryUnsupportedTimestamps unsupportedTimestamps) {
  ...
  public DescribeDatasetResponseDataQualitySummary duplicateTimestamps(DataQualitySummaryDuplicateTimestamps duplicateTimestamps) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeDatasetResponseDataQualitySummary describeDatasetResponseDataQualitySummary = (DescribeDatasetResponseDataQualitySummary) o;
    return Objects.equals(this.insufficientSensorData, describeDatasetResponseDataQualitySummary.insufficientSensorData) &&
        Objects.equals(this.missingSensorData, describeDatasetResponseDataQualitySummary.missingSensorData) &&
        Objects.equals(this.invalidSensorData, describeDatasetResponseDataQualitySummary.invalidSensorData) &&
        Objects.equals(this.unsupportedTimestamps, describeDatasetResponseDataQualitySummary.unsupportedTimestamps) &&
        Objects.equals(this.duplicateTimestamps, describeDatasetResponseDataQualitySummary.duplicateTimestamps);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeDatasetResponseDataQualitySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeDatasetResponseDataQualitySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeDatasetResponseDataQualitySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeDatasetResponseDataQualitySummary is not found in the empty JSON string", DescribeDatasetResponseDataQualitySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeDatasetResponseDataQualitySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeDatasetResponseDataQualitySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeDatasetResponseDataQualitySummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeDatasetResponseDataQualitySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeDatasetResponseDataQualitySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeDatasetResponseDataQualitySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeDatasetResponseDataQualitySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeDatasetResponseDataQualitySummary>() {
           @Override
           public void write(JsonWriter out, DescribeDatasetResponseDataQualitySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeDatasetResponseDataQualitySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeDatasetResponseDataQualitySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeDatasetResponseDataQualitySummary
   * @throws IOException if the JSON string is invalid with respect to DescribeDatasetResponseDataQualitySummary
   */
  public static DescribeDatasetResponseDataQualitySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeDatasetResponseDataQualitySummary.class);
  }

  /**
   * Convert an instance of DescribeDatasetResponseDataQualitySummary to an JSON string
   *
   * @return JSON string
   */
