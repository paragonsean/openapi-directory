...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.SavingsPlansDetails();
  });
  ...
  describe('SavingsPlansDetails', function() {
    it('should create an instance of SavingsPlansDetails', function() {
      // uncomment below and update the code to test SavingsPlansDetails
      //var instance = new AwsCostExplorerService.SavingsPlansDetails();
      //expect(instance).to.be.a(AwsCostExplorerService.SavingsPlansDetails);
    });
