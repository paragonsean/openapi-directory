...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.RedshiftInstanceDetails();
  });
  ...
  describe('RedshiftInstanceDetails', function() {
    it('should create an instance of RedshiftInstanceDetails', function() {
      // uncomment below and update the code to test RedshiftInstanceDetails
      //var instance = new AwsCostExplorerService.RedshiftInstanceDetails();
      //expect(instance).to.be.a(AwsCostExplorerService.RedshiftInstanceDetails);
    });
