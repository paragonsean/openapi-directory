...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.UtilizationByTimeTotal();
  });
  ...
  describe('UtilizationByTimeTotal', function() {
    it('should create an instance of UtilizationByTimeTotal', function() {
      // uncomment below and update the code to test UtilizationByTimeTotal
      //var instance = new AwsCostExplorerService.UtilizationByTimeTotal();
      //expect(instance).to.be.a(AwsCostExplorerService.UtilizationByTimeTotal);
    });
