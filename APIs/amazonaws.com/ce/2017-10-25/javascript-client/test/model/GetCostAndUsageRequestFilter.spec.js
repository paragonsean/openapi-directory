...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetCostAndUsageRequestFilter();
  });
  ...
  describe('GetCostAndUsageRequestFilter', function() {
    it('should create an instance of GetCostAndUsageRequestFilter', function() {
      // uncomment below and update the code to test GetCostAndUsageRequestFilter
      //var instance = new AwsCostExplorerService.GetCostAndUsageRequestFilter();
      //expect(instance).to.be.a(AwsCostExplorerService.GetCostAndUsageRequestFilter);
    });
