...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetReservationPurchaseRecommendationRequest();
  });
  ...
  describe('GetReservationPurchaseRecommendationRequest', function() {
    it('should create an instance of GetReservationPurchaseRecommendationRequest', function() {
      // uncomment below and update the code to test GetReservationPurchaseRecommendationRequest
      //var instance = new AwsCostExplorerService.GetReservationPurchaseRecommendationRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetReservationPurchaseRecommendationRequest);
    });
