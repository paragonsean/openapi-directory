...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetSavingsPlansUtilizationRequest();
  });
  ...
  describe('GetSavingsPlansUtilizationRequest', function() {
    it('should create an instance of GetSavingsPlansUtilizationRequest', function() {
      // uncomment below and update the code to test GetSavingsPlansUtilizationRequest
      //var instance = new AwsCostExplorerService.GetSavingsPlansUtilizationRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetSavingsPlansUtilizationRequest);
    });
