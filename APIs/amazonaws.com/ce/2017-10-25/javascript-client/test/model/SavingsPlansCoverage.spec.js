...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.SavingsPlansCoverage();
  });
  ...
  describe('SavingsPlansCoverage', function() {
    it('should create an instance of SavingsPlansCoverage', function() {
      // uncomment below and update the code to test SavingsPlansCoverage
      //var instance = new AwsCostExplorerService.SavingsPlansCoverage();
      //expect(instance).to.be.a(AwsCostExplorerService.SavingsPlansCoverage);
    });
