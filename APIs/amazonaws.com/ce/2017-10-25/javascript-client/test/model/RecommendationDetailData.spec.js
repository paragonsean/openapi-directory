...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.RecommendationDetailData();
  });
  ...
  describe('RecommendationDetailData', function() {
    it('should create an instance of RecommendationDetailData', function() {
      // uncomment below and update the code to test RecommendationDetailData
      //var instance = new AwsCostExplorerService.RecommendationDetailData();
      //expect(instance).to.be.a(AwsCostExplorerService.RecommendationDetailData);
    });
