...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.RightsizingRecommendationCurrentInstance();
  });
  ...
  describe('RightsizingRecommendationCurrentInstance', function() {
    it('should create an instance of RightsizingRecommendationCurrentInstance', function() {
      // uncomment below and update the code to test RightsizingRecommendationCurrentInstance
      //var instance = new AwsCostExplorerService.RightsizingRecommendationCurrentInstance();
      //expect(instance).to.be.a(AwsCostExplorerService.RightsizingRecommendationCurrentInstance);
    });
