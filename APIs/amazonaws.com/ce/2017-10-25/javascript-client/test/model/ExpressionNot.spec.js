...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.ExpressionNot();
  });
  ...
  describe('ExpressionNot', function() {
    it('should create an instance of ExpressionNot', function() {
      // uncomment below and update the code to test ExpressionNot
      //var instance = new AwsCostExplorerService.ExpressionNot();
      //expect(instance).to.be.a(AwsCostExplorerService.ExpressionNot);
    });
