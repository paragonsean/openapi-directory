...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetReservationCoverageRequest();
  });
  ...
  describe('GetReservationCoverageRequest', function() {
    it('should create an instance of GetReservationCoverageRequest', function() {
      // uncomment below and update the code to test GetReservationCoverageRequest
      //var instance = new AwsCostExplorerService.GetReservationCoverageRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetReservationCoverageRequest);
    });
