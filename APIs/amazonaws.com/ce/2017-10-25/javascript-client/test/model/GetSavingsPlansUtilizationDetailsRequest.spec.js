...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetSavingsPlansUtilizationDetailsRequest();
  });
  ...
  describe('GetSavingsPlansUtilizationDetailsRequest', function() {
    it('should create an instance of GetSavingsPlansUtilizationDetailsRequest', function() {
      // uncomment below and update the code to test GetSavingsPlansUtilizationDetailsRequest
      //var instance = new AwsCostExplorerService.GetSavingsPlansUtilizationDetailsRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetSavingsPlansUtilizationDetailsRequest);
    });
