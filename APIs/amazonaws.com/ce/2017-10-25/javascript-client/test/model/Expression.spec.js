...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.Expression();
  });
  ...
  describe('Expression', function() {
    it('should create an instance of Expression', function() {
      ...
      //var instance = new AwsCostExplorerService.Expression();
      //expect(instance).to.be.a(AwsCostExplorerService.Expression);
    });
