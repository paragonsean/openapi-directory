...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetCostAndUsageWithResourcesRequest();
  });
  ...
  describe('GetCostAndUsageWithResourcesRequest', function() {
    it('should create an instance of GetCostAndUsageWithResourcesRequest', function() {
      // uncomment below and update the code to test GetCostAndUsageWithResourcesRequest
      //var instance = new AwsCostExplorerService.GetCostAndUsageWithResourcesRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetCostAndUsageWithResourcesRequest);
    });
