...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.InstanceDetailsElastiCacheInstanceDetails();
  });
  ...
  describe('InstanceDetailsElastiCacheInstanceDetails', function() {
    it('should create an instance of InstanceDetailsElastiCacheInstanceDetails', function() {
      // uncomment below and update the code to test InstanceDetailsElastiCacheInstanceDetails
      //var instance = new AwsCostExplorerService.InstanceDetailsElastiCacheInstanceDetails();
      //expect(instance).to.be.a(AwsCostExplorerService.InstanceDetailsElastiCacheInstanceDetails);
    });
