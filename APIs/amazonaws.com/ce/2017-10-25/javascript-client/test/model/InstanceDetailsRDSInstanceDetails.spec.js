...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.InstanceDetailsRDSInstanceDetails();
  });
  ...
  describe('InstanceDetailsRDSInstanceDetails', function() {
    it('should create an instance of InstanceDetailsRDSInstanceDetails', function() {
      // uncomment below and update the code to test InstanceDetailsRDSInstanceDetails
      //var instance = new AwsCostExplorerService.InstanceDetailsRDSInstanceDetails();
      //expect(instance).to.be.a(AwsCostExplorerService.InstanceDetailsRDSInstanceDetails);
    });
