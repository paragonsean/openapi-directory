...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.CostCategoryRuleRule();
  });
  ...
  describe('CostCategoryRuleRule', function() {
    it('should create an instance of CostCategoryRuleRule', function() {
      // uncomment below and update the code to test CostCategoryRuleRule
      //var instance = new AwsCostExplorerService.CostCategoryRuleRule();
      //expect(instance).to.be.a(AwsCostExplorerService.CostCategoryRuleRule);
    });
