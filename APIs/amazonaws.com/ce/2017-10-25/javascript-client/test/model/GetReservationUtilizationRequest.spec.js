...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetReservationUtilizationRequest();
  });
  ...
  describe('GetReservationUtilizationRequest', function() {
    it('should create an instance of GetReservationUtilizationRequest', function() {
      // uncomment below and update the code to test GetReservationUtilizationRequest
      //var instance = new AwsCostExplorerService.GetReservationUtilizationRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetReservationUtilizationRequest);
    });
