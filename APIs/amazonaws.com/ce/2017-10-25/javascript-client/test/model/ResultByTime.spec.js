...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.ResultByTime();
  });
  ...
  describe('ResultByTime', function() {
    it('should create an instance of ResultByTime', function() {
      // uncomment below and update the code to test ResultByTime
      //var instance = new AwsCostExplorerService.ResultByTime();
      //expect(instance).to.be.a(AwsCostExplorerService.ResultByTime);
    });
