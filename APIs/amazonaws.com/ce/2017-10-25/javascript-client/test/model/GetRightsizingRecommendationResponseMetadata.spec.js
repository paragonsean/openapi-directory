...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetRightsizingRecommendationResponseMetadata();
  });
  ...
  describe('GetRightsizingRecommendationResponseMetadata', function() {
    it('should create an instance of GetRightsizingRecommendationResponseMetadata', function() {
      // uncomment below and update the code to test GetRightsizingRecommendationResponseMetadata
      //var instance = new AwsCostExplorerService.GetRightsizingRecommendationResponseMetadata();
      //expect(instance).to.be.a(AwsCostExplorerService.GetRightsizingRecommendationResponseMetadata);
    });
