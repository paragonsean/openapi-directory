...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetSavingsPlansCoverageRequest();
  });
  ...
  describe('GetSavingsPlansCoverageRequest', function() {
    it('should create an instance of GetSavingsPlansCoverageRequest', function() {
      // uncomment below and update the code to test GetSavingsPlansCoverageRequest
      //var instance = new AwsCostExplorerService.GetSavingsPlansCoverageRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetSavingsPlansCoverageRequest);
    });
