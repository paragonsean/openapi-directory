...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary();
  });
  ...
  describe('SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary', function() {
    it('should create an instance of SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary', function() {
      // uncomment below and update the code to test SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary
      //var instance = new AwsCostExplorerService.SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary();
      //expect(instance).to.be.a(AwsCostExplorerService.SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary);
    });
    ...
    it('should have the property currentOnDemandSpend (base name: "CurrentOnDemandSpend")', function() {
      // uncomment below and update the code to test the property currentOnDemandSpend
      //var instance = new AwsCostExplorerService.SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property totalRecommendationCount (base name: "TotalRecommendationCount")', function() {
      // uncomment below and update the code to test the property totalRecommendationCount
      //var instance = new AwsCostExplorerService.SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary();
      //expect(instance).to.be();
    });

    it('should have the property dailyCommitmentToPurchase (base name: "DailyCommitmentToPurchase")', function() {
      // uncomment below and update the code to test the property dailyCommitmentToPurchase
      //var instance = new AwsCostExplorerService.SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary();
      //expect(instance).to.be();
    });
