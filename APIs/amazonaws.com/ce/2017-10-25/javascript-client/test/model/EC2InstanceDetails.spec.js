...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.EC2InstanceDetails();
  });
  ...
  describe('EC2InstanceDetails', function() {
    it('should create an instance of EC2InstanceDetails', function() {
      // uncomment below and update the code to test EC2InstanceDetails
      //var instance = new AwsCostExplorerService.EC2InstanceDetails();
      //expect(instance).to.be.a(AwsCostExplorerService.EC2InstanceDetails);
    });
