...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetDimensionValuesRequest();
  });
  ...
  describe('GetDimensionValuesRequest', function() {
    it('should create an instance of GetDimensionValuesRequest', function() {
      // uncomment below and update the code to test GetDimensionValuesRequest
      //var instance = new AwsCostExplorerService.GetDimensionValuesRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetDimensionValuesRequest);
    });
