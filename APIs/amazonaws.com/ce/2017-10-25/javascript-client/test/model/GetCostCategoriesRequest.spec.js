...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetCostCategoriesRequest();
  });
  ...
  describe('GetCostCategoriesRequest', function() {
    it('should create an instance of GetCostCategoriesRequest', function() {
      // uncomment below and update the code to test GetCostCategoriesRequest
      //var instance = new AwsCostExplorerService.GetCostCategoriesRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetCostCategoriesRequest);
    });
    ...
    it('should have the property costCategoryName (base name: "CostCategoryName")', function() {
      // uncomment below and update the code to test the property costCategoryName
      //var instance = new AwsCostExplorerService.GetCostCategoriesRequest();
      //expect(instance).to.be();
    });
