...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetRightsizingRecommendationRequest();
  });
  ...
  describe('GetRightsizingRecommendationRequest', function() {
    it('should create an instance of GetRightsizingRecommendationRequest', function() {
      // uncomment below and update the code to test GetRightsizingRecommendationRequest
      //var instance = new AwsCostExplorerService.GetRightsizingRecommendationRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetRightsizingRecommendationRequest);
    });
