...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.RootCause();
  });
  ...
  describe('RootCause', function() {
    it('should create an instance of RootCause', function() {
      // uncomment below and update the code to test RootCause
      //var instance = new AwsCostExplorerService.RootCause();
      //expect(instance).to.be.a(AwsCostExplorerService.RootCause);
    });
    ...
    it('should have the property linkedAccountName (base name: "LinkedAccountName")', function() {
      // uncomment below and update the code to test the property linkedAccountName
      //var instance = new AwsCostExplorerService.RootCause();
      //expect(instance).to.be();
    });
