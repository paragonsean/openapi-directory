...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.ElastiCacheInstanceDetails();
  });
  ...
  describe('ElastiCacheInstanceDetails', function() {
    it('should create an instance of ElastiCacheInstanceDetails', function() {
      // uncomment below and update the code to test ElastiCacheInstanceDetails
      //var instance = new AwsCostExplorerService.ElastiCacheInstanceDetails();
      //expect(instance).to.be.a(AwsCostExplorerService.ElastiCacheInstanceDetails);
    });
