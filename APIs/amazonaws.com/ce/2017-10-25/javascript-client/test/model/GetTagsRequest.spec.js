...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetTagsRequest();
  });
  ...
  describe('GetTagsRequest', function() {
    it('should create an instance of GetTagsRequest', function() {
      // uncomment below and update the code to test GetTagsRequest
      //var instance = new AwsCostExplorerService.GetTagsRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetTagsRequest);
    });
