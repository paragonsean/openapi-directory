...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetCostAndUsageRequest();
  });
  ...
  describe('GetCostAndUsageRequest', function() {
    it('should create an instance of GetCostAndUsageRequest', function() {
      // uncomment below and update the code to test GetCostAndUsageRequest
      //var instance = new AwsCostExplorerService.GetCostAndUsageRequest();
      //expect(instance).to.be.a(AwsCostExplorerService.GetCostAndUsageRequest);
    });
