...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.InstanceDetailsRedshiftInstanceDetails();
  });
  ...
  describe('InstanceDetailsRedshiftInstanceDetails', function() {
    it('should create an instance of InstanceDetailsRedshiftInstanceDetails', function() {
      // uncomment below and update the code to test InstanceDetailsRedshiftInstanceDetails
      //var instance = new AwsCostExplorerService.InstanceDetailsRedshiftInstanceDetails();
      //expect(instance).to.be.a(AwsCostExplorerService.InstanceDetailsRedshiftInstanceDetails);
    });
