...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.GetSavingsPlansPurchaseRecommendationResponseMetadata();
  });
  ...
  describe('GetSavingsPlansPurchaseRecommendationResponseMetadata', function() {
    it('should create an instance of GetSavingsPlansPurchaseRecommendationResponseMetadata', function() {
      // uncomment below and update the code to test GetSavingsPlansPurchaseRecommendationResponseMetadata
      //var instance = new AwsCostExplorerService.GetSavingsPlansPurchaseRecommendationResponseMetadata();
      //expect(instance).to.be.a(AwsCostExplorerService.GetSavingsPlansPurchaseRecommendationResponseMetadata);
    });
