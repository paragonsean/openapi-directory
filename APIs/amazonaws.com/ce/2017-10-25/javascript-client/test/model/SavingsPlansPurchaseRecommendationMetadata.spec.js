...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.SavingsPlansPurchaseRecommendationMetadata();
  });
  ...
  describe('SavingsPlansPurchaseRecommendationMetadata', function() {
    it('should create an instance of SavingsPlansPurchaseRecommendationMetadata', function() {
      // uncomment below and update the code to test SavingsPlansPurchaseRecommendationMetadata
      //var instance = new AwsCostExplorerService.SavingsPlansPurchaseRecommendationMetadata();
      //expect(instance).to.be.a(AwsCostExplorerService.SavingsPlansPurchaseRecommendationMetadata);
    });
