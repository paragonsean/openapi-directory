...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCostExplorerService.RightsizingRecommendationMetadata();
  });
  ...
  describe('RightsizingRecommendationMetadata', function() {
    it('should create an instance of RightsizingRecommendationMetadata', function() {
      // uncomment below and update the code to test RightsizingRecommendationMetadata
      //var instance = new AwsCostExplorerService.RightsizingRecommendationMetadata();
      //expect(instance).to.be.a(AwsCostExplorerService.RightsizingRecommendationMetadata);
    });
