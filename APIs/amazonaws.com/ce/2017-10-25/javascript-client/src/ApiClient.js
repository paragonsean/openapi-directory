...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://ce.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://ce.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-10-25/Javascript'
        };
    ...
    hostSettings() {
        return [
            ...
            },
            {
              ...
              'description': "The general AWS Cost Explorer endpoint for China (Beijing) and China (Ningxia)",
            },
            {
