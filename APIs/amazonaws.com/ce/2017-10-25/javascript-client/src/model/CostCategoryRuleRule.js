...
/**
 * The CostCategoryRuleRule model module.
 * @module model/CostCategoryRuleRule
 * @version 2017-10-25
 */
class CostCategoryRuleRule {
    /**
     * Constructs a new <code>CostCategoryRuleRule</code>.
     * @alias module:model/CostCategoryRuleRule
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        CostCategoryRuleRule.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CostCategoryRuleRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CostCategoryRuleRule} obj Optional instance to populate.
     * @return {module:model/CostCategoryRuleRule} The populated <code>CostCategoryRuleRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CostCategoryRuleRule();
    ...
    /**
     * Validates the JSON data with respect to <code>CostCategoryRuleRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CostCategoryRuleRule</code>.
     */
 ...
 * @member {Array} Or
 */
CostCategoryRuleRule.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
CostCategoryRuleRule.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
CostCategoryRuleRule.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
CostCategoryRuleRule.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
CostCategoryRuleRule.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
CostCategoryRuleRule.prototype['CostCategories'] = undefined;
...
export default CostCategoryRuleRule;
