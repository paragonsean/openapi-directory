...
/**
 * The GetReservationUtilizationRequestFilter model module.
 * @module model/GetReservationUtilizationRequestFilter
 * @version 2017-10-25
 */
class GetReservationUtilizationRequestFilter {
    /**
     * Constructs a new <code>GetReservationUtilizationRequestFilter</code>.
     * @alias module:model/GetReservationUtilizationRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetReservationUtilizationRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetReservationUtilizationRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetReservationUtilizationRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetReservationUtilizationRequestFilter} The populated <code>GetReservationUtilizationRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetReservationUtilizationRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetReservationUtilizationRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetReservationUtilizationRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetReservationUtilizationRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetReservationUtilizationRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetReservationUtilizationRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetReservationUtilizationRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetReservationUtilizationRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetReservationUtilizationRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetReservationUtilizationRequestFilter;
