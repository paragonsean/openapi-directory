...
/**
 * The GetReservationCoverageRequestFilter model module.
 * @module model/GetReservationCoverageRequestFilter
 * @version 2017-10-25
 */
class GetReservationCoverageRequestFilter {
    /**
     * Constructs a new <code>GetReservationCoverageRequestFilter</code>.
     * @alias module:model/GetReservationCoverageRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetReservationCoverageRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetReservationCoverageRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetReservationCoverageRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetReservationCoverageRequestFilter} The populated <code>GetReservationCoverageRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetReservationCoverageRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetReservationCoverageRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetReservationCoverageRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetReservationCoverageRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetReservationCoverageRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetReservationCoverageRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetReservationCoverageRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetReservationCoverageRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetReservationCoverageRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetReservationCoverageRequestFilter;
