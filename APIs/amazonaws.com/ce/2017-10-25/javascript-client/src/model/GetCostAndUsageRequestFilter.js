...
/**
 * The GetCostAndUsageRequestFilter model module.
 * @module model/GetCostAndUsageRequestFilter
 * @version 2017-10-25
 */
class GetCostAndUsageRequestFilter {
    /**
     * Constructs a new <code>GetCostAndUsageRequestFilter</code>.
     * @alias module:model/GetCostAndUsageRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetCostAndUsageRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCostAndUsageRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCostAndUsageRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetCostAndUsageRequestFilter} The populated <code>GetCostAndUsageRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCostAndUsageRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCostAndUsageRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCostAndUsageRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetCostAndUsageRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetCostAndUsageRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetCostAndUsageRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetCostAndUsageRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetCostAndUsageRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetCostAndUsageRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetCostAndUsageRequestFilter;
