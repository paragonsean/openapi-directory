...
/**
 * The GetUsageForecastRequestFilter model module.
 * @module model/GetUsageForecastRequestFilter
 * @version 2017-10-25
 */
class GetUsageForecastRequestFilter {
    /**
     * Constructs a new <code>GetUsageForecastRequestFilter</code>.
     * @alias module:model/GetUsageForecastRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetUsageForecastRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUsageForecastRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUsageForecastRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetUsageForecastRequestFilter} The populated <code>GetUsageForecastRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUsageForecastRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUsageForecastRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUsageForecastRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetUsageForecastRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetUsageForecastRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetUsageForecastRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetUsageForecastRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetUsageForecastRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetUsageForecastRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetUsageForecastRequestFilter;
