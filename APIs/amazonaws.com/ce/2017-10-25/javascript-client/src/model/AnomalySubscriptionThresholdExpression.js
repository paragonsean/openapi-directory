...
/**
 * The AnomalySubscriptionThresholdExpression model module.
 * @module model/AnomalySubscriptionThresholdExpression
 * @version 2017-10-25
 */
class AnomalySubscriptionThresholdExpression {
    /**
     * Constructs a new <code>AnomalySubscriptionThresholdExpression</code>.
     * @alias module:model/AnomalySubscriptionThresholdExpression
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        AnomalySubscriptionThresholdExpression.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AnomalySubscriptionThresholdExpression</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnomalySubscriptionThresholdExpression} obj Optional instance to populate.
     * @return {module:model/AnomalySubscriptionThresholdExpression} The populated <code>AnomalySubscriptionThresholdExpression</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnomalySubscriptionThresholdExpression();
    ...
    /**
     * Validates the JSON data with respect to <code>AnomalySubscriptionThresholdExpression</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnomalySubscriptionThresholdExpression</code>.
     */
 ...
 * @member {Array} Or
 */
AnomalySubscriptionThresholdExpression.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
AnomalySubscriptionThresholdExpression.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
AnomalySubscriptionThresholdExpression.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
AnomalySubscriptionThresholdExpression.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
AnomalySubscriptionThresholdExpression.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
AnomalySubscriptionThresholdExpression.prototype['CostCategories'] = undefined;
...
export default AnomalySubscriptionThresholdExpression;
