...
/**
 * The GetSavingsPlansCoverageRequestFilter model module.
 * @module model/GetSavingsPlansCoverageRequestFilter
 * @version 2017-10-25
 */
class GetSavingsPlansCoverageRequestFilter {
    /**
     * Constructs a new <code>GetSavingsPlansCoverageRequestFilter</code>.
     * @alias module:model/GetSavingsPlansCoverageRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetSavingsPlansCoverageRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSavingsPlansCoverageRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSavingsPlansCoverageRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetSavingsPlansCoverageRequestFilter} The populated <code>GetSavingsPlansCoverageRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSavingsPlansCoverageRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSavingsPlansCoverageRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSavingsPlansCoverageRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetSavingsPlansCoverageRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetSavingsPlansCoverageRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetSavingsPlansCoverageRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetSavingsPlansCoverageRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetSavingsPlansCoverageRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetSavingsPlansCoverageRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetSavingsPlansCoverageRequestFilter;
