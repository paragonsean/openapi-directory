...
/**
 * The GetCostAndUsageWithResourcesRequestFilter model module.
 * @module model/GetCostAndUsageWithResourcesRequestFilter
 * @version 2017-10-25
 */
class GetCostAndUsageWithResourcesRequestFilter {
    /**
     * Constructs a new <code>GetCostAndUsageWithResourcesRequestFilter</code>.
     * @alias module:model/GetCostAndUsageWithResourcesRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetCostAndUsageWithResourcesRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCostAndUsageWithResourcesRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCostAndUsageWithResourcesRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetCostAndUsageWithResourcesRequestFilter} The populated <code>GetCostAndUsageWithResourcesRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCostAndUsageWithResourcesRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCostAndUsageWithResourcesRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCostAndUsageWithResourcesRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetCostAndUsageWithResourcesRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetCostAndUsageWithResourcesRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetCostAndUsageWithResourcesRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetCostAndUsageWithResourcesRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetCostAndUsageWithResourcesRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetCostAndUsageWithResourcesRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetCostAndUsageWithResourcesRequestFilter;
