...
/**
 * The GetSavingsPlansUtilizationRequestFilter model module.
 * @module model/GetSavingsPlansUtilizationRequestFilter
 * @version 2017-10-25
 */
class GetSavingsPlansUtilizationRequestFilter {
    /**
     * Constructs a new <code>GetSavingsPlansUtilizationRequestFilter</code>.
     * @alias module:model/GetSavingsPlansUtilizationRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetSavingsPlansUtilizationRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSavingsPlansUtilizationRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSavingsPlansUtilizationRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetSavingsPlansUtilizationRequestFilter} The populated <code>GetSavingsPlansUtilizationRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSavingsPlansUtilizationRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSavingsPlansUtilizationRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSavingsPlansUtilizationRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetSavingsPlansUtilizationRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetSavingsPlansUtilizationRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetSavingsPlansUtilizationRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetSavingsPlansUtilizationRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetSavingsPlansUtilizationRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetSavingsPlansUtilizationRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetSavingsPlansUtilizationRequestFilter;
