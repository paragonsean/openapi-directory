...
/**
 * The GetCostForecastRequestFilter model module.
 * @module model/GetCostForecastRequestFilter
 * @version 2017-10-25
 */
class GetCostForecastRequestFilter {
    /**
     * Constructs a new <code>GetCostForecastRequestFilter</code>.
     * @alias module:model/GetCostForecastRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetCostForecastRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCostForecastRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCostForecastRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetCostForecastRequestFilter} The populated <code>GetCostForecastRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCostForecastRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCostForecastRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCostForecastRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetCostForecastRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetCostForecastRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetCostForecastRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetCostForecastRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetCostForecastRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetCostForecastRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetCostForecastRequestFilter;
