...
/**
 * The GetSavingsPlansPurchaseRecommendationRequestFilter model module.
 * @module model/GetSavingsPlansPurchaseRecommendationRequestFilter
 * @version 2017-10-25
 */
class GetSavingsPlansPurchaseRecommendationRequestFilter {
    /**
     * Constructs a new <code>GetSavingsPlansPurchaseRecommendationRequestFilter</code>.
     * @alias module:model/GetSavingsPlansPurchaseRecommendationRequestFilter
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        GetSavingsPlansPurchaseRecommendationRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSavingsPlansPurchaseRecommendationRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSavingsPlansPurchaseRecommendationRequestFilter} obj Optional instance to populate.
     * @return {module:model/GetSavingsPlansPurchaseRecommendationRequestFilter} The populated <code>GetSavingsPlansPurchaseRecommendationRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSavingsPlansPurchaseRecommendationRequestFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSavingsPlansPurchaseRecommendationRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSavingsPlansPurchaseRecommendationRequestFilter</code>.
     */
 ...
 * @member {Array} Or
 */
GetSavingsPlansPurchaseRecommendationRequestFilter.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
GetSavingsPlansPurchaseRecommendationRequestFilter.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
GetSavingsPlansPurchaseRecommendationRequestFilter.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
GetSavingsPlansPurchaseRecommendationRequestFilter.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
GetSavingsPlansPurchaseRecommendationRequestFilter.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
GetSavingsPlansPurchaseRecommendationRequestFilter.prototype['CostCategories'] = undefined;
...
export default GetSavingsPlansPurchaseRecommendationRequestFilter;
