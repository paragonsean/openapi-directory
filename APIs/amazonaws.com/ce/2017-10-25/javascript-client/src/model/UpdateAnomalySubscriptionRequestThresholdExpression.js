...
/**
 * The UpdateAnomalySubscriptionRequestThresholdExpression model module.
 * @module model/UpdateAnomalySubscriptionRequestThresholdExpression
 * @version 2017-10-25
 */
class UpdateAnomalySubscriptionRequestThresholdExpression {
    /**
     * Constructs a new <code>UpdateAnomalySubscriptionRequestThresholdExpression</code>.
     * @alias module:model/UpdateAnomalySubscriptionRequestThresholdExpression
     * @implements module:model/Expression
     */
    constructor() { 
        Expression.initialize(this);
        UpdateAnomalySubscriptionRequestThresholdExpression.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAnomalySubscriptionRequestThresholdExpression</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAnomalySubscriptionRequestThresholdExpression} obj Optional instance to populate.
     * @return {module:model/UpdateAnomalySubscriptionRequestThresholdExpression} The populated <code>UpdateAnomalySubscriptionRequestThresholdExpression</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAnomalySubscriptionRequestThresholdExpression();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAnomalySubscriptionRequestThresholdExpression</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAnomalySubscriptionRequestThresholdExpression</code>.
     */
 ...
 * @member {Array} Or
 */
UpdateAnomalySubscriptionRequestThresholdExpression.prototype['Or'] = undefined;

/**
 * @member {Array} And
 */
UpdateAnomalySubscriptionRequestThresholdExpression.prototype['And'] = undefined;

/**
 * @member {module:model/ExpressionNot} Not
 */
UpdateAnomalySubscriptionRequestThresholdExpression.prototype['Not'] = undefined;

/**
 * @member {module:model/ExpressionDimensions} Dimensions
 */
UpdateAnomalySubscriptionRequestThresholdExpression.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/ExpressionTags} Tags
 */
UpdateAnomalySubscriptionRequestThresholdExpression.prototype['Tags'] = undefined;

/**
 * @member {module:model/ExpressionCostCategories} CostCategories
 */
UpdateAnomalySubscriptionRequestThresholdExpression.prototype['CostCategories'] = undefined;
...
export default UpdateAnomalySubscriptionRequestThresholdExpression;
