...
class SavingsPlansUtilizationAggregates(Model):
    ...
    def __init__(self, utilization: SavingsPlansUtilizationAggregatesUtilization=None, savings: SavingsPlansUtilizationAggregatesSavings=None, amortized_commitment: SavingsPlansUtilizationAggregatesAmortizedCommitment=None):
        """SavingsPlansUtilizationAggregates - a model defined in OpenAPI

        :param utilization: The utilization of this SavingsPlansUtilizationAggregates.
        :param savings: The savings of this SavingsPlansUtilizationAggregates.
        :param amortized_commitment: The amortized_commitment of this SavingsPlansUtilizationAggregates.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SavingsPlansUtilizationAggregates':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SavingsPlansUtilizationAggregates of this SavingsPlansUtilizationAggregates.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def utilization(self):
        """Gets the utilization of this SavingsPlansUtilizationAggregates.


        :return: The utilization of this SavingsPlansUtilizationAggregates.
    ...
    def utilization(self, utilization):
        """Sets the utilization of this SavingsPlansUtilizationAggregates.
    ...
    @property
    def savings(self):
        """Gets the savings of this SavingsPlansUtilizationAggregates.


        :return: The savings of this SavingsPlansUtilizationAggregates.
    ...
    def savings(self, savings):
        """Sets the savings of this SavingsPlansUtilizationAggregates.
    ...
    def amortized_commitment(self):
        """Gets the amortized_commitment of this SavingsPlansUtilizationAggregates.


        :return: The amortized_commitment of this SavingsPlansUtilizationAggregates.
    ...
    def amortized_commitment(self, amortized_commitment):
        """Sets the amortized_commitment of this SavingsPlansUtilizationAggregates.
