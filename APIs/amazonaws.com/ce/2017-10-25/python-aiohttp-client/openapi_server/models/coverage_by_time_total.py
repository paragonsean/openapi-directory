...
class CoverageByTimeTotal(Model):
    ...
    def __init__(self, coverage_hours: CoverageCoverageHours=None, coverage_normalized_units: CoverageCoverageNormalizedUnits=None, coverage_cost: CoverageCoverageCost=None):
        """CoverageByTimeTotal - a model defined in OpenAPI

        :param coverage_hours: The coverage_hours of this CoverageByTimeTotal.
        :param coverage_normalized_units: The coverage_normalized_units of this CoverageByTimeTotal.
        :param coverage_cost: The coverage_cost of this CoverageByTimeTotal.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CoverageByTimeTotal':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CoverageByTime_Total of this CoverageByTimeTotal.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def coverage_hours(self):
        """Gets the coverage_hours of this CoverageByTimeTotal.


        :return: The coverage_hours of this CoverageByTimeTotal.
    ...
    def coverage_hours(self, coverage_hours):
        """Sets the coverage_hours of this CoverageByTimeTotal.
    ...
    def coverage_normalized_units(self):
        """Gets the coverage_normalized_units of this CoverageByTimeTotal.


        :return: The coverage_normalized_units of this CoverageByTimeTotal.
    ...
    def coverage_normalized_units(self, coverage_normalized_units):
        """Sets the coverage_normalized_units of this CoverageByTimeTotal.
    ...
    def coverage_cost(self):
        """Gets the coverage_cost of this CoverageByTimeTotal.


        :return: The coverage_cost of this CoverageByTimeTotal.
    ...
    def coverage_cost(self, coverage_cost):
        """Sets the coverage_cost of this CoverageByTimeTotal.
