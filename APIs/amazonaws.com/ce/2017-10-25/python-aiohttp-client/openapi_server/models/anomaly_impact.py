...
class AnomalyImpact(Model):
    ...
    def __init__(self, max_impact: float=None, total_impact: float=None, total_actual_spend: float=None, total_expected_spend: float=None, total_impact_percentage: float=None):
        """AnomalyImpact - a model defined in OpenAPI

        :param max_impact: The max_impact of this AnomalyImpact.
        :param total_impact: The total_impact of this AnomalyImpact.
        :param total_actual_spend: The total_actual_spend of this AnomalyImpact.
        :param total_expected_spend: The total_expected_spend of this AnomalyImpact.
        :param total_impact_percentage: The total_impact_percentage of this AnomalyImpact.
        """
        self.openapi_types = {
            'max_impact': float,
            'total_impact': float,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AnomalyImpact':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Anomaly_Impact of this AnomalyImpact.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_impact(self):
        """Gets the max_impact of this AnomalyImpact.


        :return: The max_impact of this AnomalyImpact.
        :rtype: float
        """
    ...
    def max_impact(self, max_impact):
        """Sets the max_impact of this AnomalyImpact.
    ...
    def total_impact(self):
        """Gets the total_impact of this AnomalyImpact.


        :return: The total_impact of this AnomalyImpact.
        :rtype: float
        """
    ...
    def total_impact(self, total_impact):
        """Sets the total_impact of this AnomalyImpact.
    ...
    def total_actual_spend(self):
        """Gets the total_actual_spend of this AnomalyImpact.


        :return: The total_actual_spend of this AnomalyImpact.
        :rtype: float
        """
    ...
    def total_actual_spend(self, total_actual_spend):
        """Sets the total_actual_spend of this AnomalyImpact.
    ...
    def total_expected_spend(self):
        """Gets the total_expected_spend of this AnomalyImpact.


        :return: The total_expected_spend of this AnomalyImpact.
        :rtype: float
        """
    ...
    def total_expected_spend(self, total_expected_spend):
        """Sets the total_expected_spend of this AnomalyImpact.
    ...
    def total_impact_percentage(self):
        """Gets the total_impact_percentage of this AnomalyImpact.


        :return: The total_impact_percentage of this AnomalyImpact.
        :rtype: float
        """
    ...
    def total_impact_percentage(self, total_impact_percentage):
        """Sets the total_impact_percentage of this AnomalyImpact.
