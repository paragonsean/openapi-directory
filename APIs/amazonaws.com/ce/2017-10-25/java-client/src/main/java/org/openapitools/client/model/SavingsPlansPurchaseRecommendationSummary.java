...
public class SavingsPlansPurchaseRecommendationSummary {
  ...
  public SavingsPlansPurchaseRecommendationSummary estimatedROI(String estimatedROI) {
  ...
  public SavingsPlansPurchaseRecommendationSummary currencyCode(String currencyCode) {
  ...
  public SavingsPlansPurchaseRecommendationSummary estimatedTotalCost(String estimatedTotalCost) {
  ...
  public SavingsPlansPurchaseRecommendationSummary currentOnDemandSpend(String currentOnDemandSpend) {
  ...
  public SavingsPlansPurchaseRecommendationSummary estimatedSavingsAmount(String estimatedSavingsAmount) {
  ...
  public SavingsPlansPurchaseRecommendationSummary totalRecommendationCount(String totalRecommendationCount) {
  ...
  public SavingsPlansPurchaseRecommendationSummary dailyCommitmentToPurchase(String dailyCommitmentToPurchase) {
  ...
  public SavingsPlansPurchaseRecommendationSummary hourlyCommitmentToPurchase(String hourlyCommitmentToPurchase) {
  ...
  public SavingsPlansPurchaseRecommendationSummary estimatedSavingsPercentage(String estimatedSavingsPercentage) {
  ...
  public SavingsPlansPurchaseRecommendationSummary estimatedMonthlySavingsAmount(String estimatedMonthlySavingsAmount) {
  ...
  public SavingsPlansPurchaseRecommendationSummary estimatedOnDemandCostWithCurrentCommitment(String estimatedOnDemandCostWithCurrentCommitment) {
  ...
  public boolean equals(Object o) {
    ...
    SavingsPlansPurchaseRecommendationSummary savingsPlansPurchaseRecommendationSummary = (SavingsPlansPurchaseRecommendationSummary) o;
    return Objects.equals(this.estimatedROI, savingsPlansPurchaseRecommendationSummary.estimatedROI) &&
        Objects.equals(this.currencyCode, savingsPlansPurchaseRecommendationSummary.currencyCode) &&
        Objects.equals(this.estimatedTotalCost, savingsPlansPurchaseRecommendationSummary.estimatedTotalCost) &&
        Objects.equals(this.currentOnDemandSpend, savingsPlansPurchaseRecommendationSummary.currentOnDemandSpend) &&
        Objects.equals(this.estimatedSavingsAmount, savingsPlansPurchaseRecommendationSummary.estimatedSavingsAmount) &&
        Objects.equals(this.totalRecommendationCount, savingsPlansPurchaseRecommendationSummary.totalRecommendationCount) &&
        Objects.equals(this.dailyCommitmentToPurchase, savingsPlansPurchaseRecommendationSummary.dailyCommitmentToPurchase) &&
        Objects.equals(this.hourlyCommitmentToPurchase, savingsPlansPurchaseRecommendationSummary.hourlyCommitmentToPurchase) &&
        Objects.equals(this.estimatedSavingsPercentage, savingsPlansPurchaseRecommendationSummary.estimatedSavingsPercentage) &&
        Objects.equals(this.estimatedMonthlySavingsAmount, savingsPlansPurchaseRecommendationSummary.estimatedMonthlySavingsAmount) &&
        Objects.equals(this.estimatedOnDemandCostWithCurrentCommitment, savingsPlansPurchaseRecommendationSummary.estimatedOnDemandCostWithCurrentCommitment);
  }
  ...
  public String toString() {
    ...
    sb.append("class SavingsPlansPurchaseRecommendationSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SavingsPlansPurchaseRecommendationSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SavingsPlansPurchaseRecommendationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SavingsPlansPurchaseRecommendationSummary is not found in the empty JSON string", SavingsPlansPurchaseRecommendationSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SavingsPlansPurchaseRecommendationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SavingsPlansPurchaseRecommendationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SavingsPlansPurchaseRecommendationSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SavingsPlansPurchaseRecommendationSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SavingsPlansPurchaseRecommendationSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SavingsPlansPurchaseRecommendationSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<SavingsPlansPurchaseRecommendationSummary>() {
           @Override
           public void write(JsonWriter out, SavingsPlansPurchaseRecommendationSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SavingsPlansPurchaseRecommendationSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SavingsPlansPurchaseRecommendationSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SavingsPlansPurchaseRecommendationSummary
   * @throws IOException if the JSON string is invalid with respect to SavingsPlansPurchaseRecommendationSummary
   */
  public static SavingsPlansPurchaseRecommendationSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SavingsPlansPurchaseRecommendationSummary.class);
  }

  /**
   * Convert an instance of SavingsPlansPurchaseRecommendationSummary to an JSON string
   *
   * @return JSON string
   */
