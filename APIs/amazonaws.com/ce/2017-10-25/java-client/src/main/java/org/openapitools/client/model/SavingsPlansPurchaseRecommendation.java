...
public class SavingsPlansPurchaseRecommendation {
  ...
  public SavingsPlansPurchaseRecommendation accountScope(AccountScope accountScope) {
  ...
  public SavingsPlansPurchaseRecommendation savingsPlansType(SupportedSavingsPlansType savingsPlansType) {
  ...
  public SavingsPlansPurchaseRecommendation termInYears(TermInYears termInYears) {
  ...
  public SavingsPlansPurchaseRecommendation paymentOption(PaymentOption paymentOption) {
  ...
  public SavingsPlansPurchaseRecommendation lookbackPeriodInDays(LookbackPeriodInDays lookbackPeriodInDays) {
  ...
  public SavingsPlansPurchaseRecommendation savingsPlansPurchaseRecommendationDetails(List savingsPlansPurchaseRecommendationDetails) {
  ...
  public SavingsPlansPurchaseRecommendation savingsPlansPurchaseRecommendationSummary(SavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationSummary savingsPlansPurchaseRecommendationSummary) {
  ...
  public boolean equals(Object o) {
    ...
    SavingsPlansPurchaseRecommendation savingsPlansPurchaseRecommendation = (SavingsPlansPurchaseRecommendation) o;
    return Objects.equals(this.accountScope, savingsPlansPurchaseRecommendation.accountScope) &&
        Objects.equals(this.savingsPlansType, savingsPlansPurchaseRecommendation.savingsPlansType) &&
        Objects.equals(this.termInYears, savingsPlansPurchaseRecommendation.termInYears) &&
        Objects.equals(this.paymentOption, savingsPlansPurchaseRecommendation.paymentOption) &&
        Objects.equals(this.lookbackPeriodInDays, savingsPlansPurchaseRecommendation.lookbackPeriodInDays) &&
        Objects.equals(this.savingsPlansPurchaseRecommendationDetails, savingsPlansPurchaseRecommendation.savingsPlansPurchaseRecommendationDetails) &&
        Objects.equals(this.savingsPlansPurchaseRecommendationSummary, savingsPlansPurchaseRecommendation.savingsPlansPurchaseRecommendationSummary);
  }
  ...
  public String toString() {
    ...
    sb.append("class SavingsPlansPurchaseRecommendation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SavingsPlansPurchaseRecommendation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SavingsPlansPurchaseRecommendation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SavingsPlansPurchaseRecommendation is not found in the empty JSON string", SavingsPlansPurchaseRecommendation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SavingsPlansPurchaseRecommendation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SavingsPlansPurchaseRecommendation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SavingsPlansPurchaseRecommendation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SavingsPlansPurchaseRecommendation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SavingsPlansPurchaseRecommendation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SavingsPlansPurchaseRecommendation.class));

       return (TypeAdapter<T>) new TypeAdapter<SavingsPlansPurchaseRecommendation>() {
           @Override
           public void write(JsonWriter out, SavingsPlansPurchaseRecommendation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SavingsPlansPurchaseRecommendation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SavingsPlansPurchaseRecommendation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SavingsPlansPurchaseRecommendation
   * @throws IOException if the JSON string is invalid with respect to SavingsPlansPurchaseRecommendation
   */
  public static SavingsPlansPurchaseRecommendation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SavingsPlansPurchaseRecommendation.class);
  }

  /**
   * Convert an instance of SavingsPlansPurchaseRecommendation to an JSON string
   *
   * @return JSON string
   */
