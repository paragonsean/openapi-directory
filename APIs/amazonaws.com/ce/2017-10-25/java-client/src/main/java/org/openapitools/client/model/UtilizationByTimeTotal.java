...
public class UtilizationByTimeTotal {
  ...
  public UtilizationByTimeTotal() {
  }

  public UtilizationByTimeTotal utilizationPercentage(String utilizationPercentage) {
  ...
  public UtilizationByTimeTotal utilizationPercentageInUnits(String utilizationPercentageInUnits) {
  ...
  public UtilizationByTimeTotal purchasedHours(String purchasedHours) {
  ...
  public UtilizationByTimeTotal purchasedUnits(String purchasedUnits) {
  ...
  public UtilizationByTimeTotal totalActualHours(String totalActualHours) {
  ...
  public UtilizationByTimeTotal totalActualUnits(String totalActualUnits) {
  ...
  public UtilizationByTimeTotal unusedHours(String unusedHours) {
  ...
  public UtilizationByTimeTotal unusedUnits(String unusedUnits) {
  ...
  public UtilizationByTimeTotal onDemandCostOfRIHoursUsed(String onDemandCostOfRIHoursUsed) {
  ...
  public UtilizationByTimeTotal netRISavings(String netRISavings) {
  ...
  public UtilizationByTimeTotal totalPotentialRISavings(String totalPotentialRISavings) {
  ...
  public UtilizationByTimeTotal amortizedUpfrontFee(String amortizedUpfrontFee) {
  ...
  public UtilizationByTimeTotal amortizedRecurringFee(String amortizedRecurringFee) {
  ...
  public UtilizationByTimeTotal totalAmortizedFee(String totalAmortizedFee) {
  ...
  public UtilizationByTimeTotal riCostForUnusedHours(String riCostForUnusedHours) {
  ...
  public UtilizationByTimeTotal realizedSavings(String realizedSavings) {
  ...
  public UtilizationByTimeTotal unrealizedSavings(String unrealizedSavings) {
  ...
  public boolean equals(Object o) {
    ...
    UtilizationByTimeTotal utilizationByTimeTotal = (UtilizationByTimeTotal) o;
    return Objects.equals(this.utilizationPercentage, utilizationByTimeTotal.utilizationPercentage) &&
        Objects.equals(this.utilizationPercentageInUnits, utilizationByTimeTotal.utilizationPercentageInUnits) &&
        Objects.equals(this.purchasedHours, utilizationByTimeTotal.purchasedHours) &&
        Objects.equals(this.purchasedUnits, utilizationByTimeTotal.purchasedUnits) &&
        Objects.equals(this.totalActualHours, utilizationByTimeTotal.totalActualHours) &&
        Objects.equals(this.totalActualUnits, utilizationByTimeTotal.totalActualUnits) &&
        Objects.equals(this.unusedHours, utilizationByTimeTotal.unusedHours) &&
        Objects.equals(this.unusedUnits, utilizationByTimeTotal.unusedUnits) &&
        Objects.equals(this.onDemandCostOfRIHoursUsed, utilizationByTimeTotal.onDemandCostOfRIHoursUsed) &&
        Objects.equals(this.netRISavings, utilizationByTimeTotal.netRISavings) &&
        Objects.equals(this.totalPotentialRISavings, utilizationByTimeTotal.totalPotentialRISavings) &&
        Objects.equals(this.amortizedUpfrontFee, utilizationByTimeTotal.amortizedUpfrontFee) &&
        Objects.equals(this.amortizedRecurringFee, utilizationByTimeTotal.amortizedRecurringFee) &&
        Objects.equals(this.totalAmortizedFee, utilizationByTimeTotal.totalAmortizedFee) &&
        Objects.equals(this.riCostForUnusedHours, utilizationByTimeTotal.riCostForUnusedHours) &&
        Objects.equals(this.realizedSavings, utilizationByTimeTotal.realizedSavings) &&
        Objects.equals(this.unrealizedSavings, utilizationByTimeTotal.unrealizedSavings);
  }
  ...
  public String toString() {
    ...
    sb.append("class UtilizationByTimeTotal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UtilizationByTimeTotal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UtilizationByTimeTotal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UtilizationByTimeTotal is not found in the empty JSON string", UtilizationByTimeTotal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UtilizationByTimeTotal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UtilizationByTimeTotal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UtilizationByTimeTotal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UtilizationByTimeTotal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UtilizationByTimeTotal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UtilizationByTimeTotal.class));

       return (TypeAdapter<T>) new TypeAdapter<UtilizationByTimeTotal>() {
           @Override
           public void write(JsonWriter out, UtilizationByTimeTotal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UtilizationByTimeTotal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UtilizationByTimeTotal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UtilizationByTimeTotal
   * @throws IOException if the JSON string is invalid with respect to UtilizationByTimeTotal
   */
  public static UtilizationByTimeTotal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UtilizationByTimeTotal.class);
  }

  /**
   * Convert an instance of UtilizationByTimeTotal to an JSON string
   *
   * @return JSON string
   */
