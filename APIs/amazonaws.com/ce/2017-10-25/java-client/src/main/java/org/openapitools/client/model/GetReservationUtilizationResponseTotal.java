...
public class GetReservationUtilizationResponseTotal {
  ...
  public GetReservationUtilizationResponseTotal() {
  }

  public GetReservationUtilizationResponseTotal utilizationPercentage(String utilizationPercentage) {
  ...
  public GetReservationUtilizationResponseTotal utilizationPercentageInUnits(String utilizationPercentageInUnits) {
  ...
  public GetReservationUtilizationResponseTotal purchasedHours(String purchasedHours) {
  ...
  public GetReservationUtilizationResponseTotal purchasedUnits(String purchasedUnits) {
  ...
  public GetReservationUtilizationResponseTotal totalActualHours(String totalActualHours) {
  ...
  public GetReservationUtilizationResponseTotal totalActualUnits(String totalActualUnits) {
  ...
  public GetReservationUtilizationResponseTotal unusedHours(String unusedHours) {
  ...
  public GetReservationUtilizationResponseTotal unusedUnits(String unusedUnits) {
  ...
  public GetReservationUtilizationResponseTotal onDemandCostOfRIHoursUsed(String onDemandCostOfRIHoursUsed) {
  ...
  public GetReservationUtilizationResponseTotal netRISavings(String netRISavings) {
  ...
  public GetReservationUtilizationResponseTotal totalPotentialRISavings(String totalPotentialRISavings) {
  ...
  public GetReservationUtilizationResponseTotal amortizedUpfrontFee(String amortizedUpfrontFee) {
  ...
  public GetReservationUtilizationResponseTotal amortizedRecurringFee(String amortizedRecurringFee) {
  ...
  public GetReservationUtilizationResponseTotal totalAmortizedFee(String totalAmortizedFee) {
  ...
  public GetReservationUtilizationResponseTotal riCostForUnusedHours(String riCostForUnusedHours) {
  ...
  public GetReservationUtilizationResponseTotal realizedSavings(String realizedSavings) {
  ...
  public GetReservationUtilizationResponseTotal unrealizedSavings(String unrealizedSavings) {
  ...
  public boolean equals(Object o) {
    ...
    GetReservationUtilizationResponseTotal getReservationUtilizationResponseTotal = (GetReservationUtilizationResponseTotal) o;
    return Objects.equals(this.utilizationPercentage, getReservationUtilizationResponseTotal.utilizationPercentage) &&
        Objects.equals(this.utilizationPercentageInUnits, getReservationUtilizationResponseTotal.utilizationPercentageInUnits) &&
        Objects.equals(this.purchasedHours, getReservationUtilizationResponseTotal.purchasedHours) &&
        Objects.equals(this.purchasedUnits, getReservationUtilizationResponseTotal.purchasedUnits) &&
        Objects.equals(this.totalActualHours, getReservationUtilizationResponseTotal.totalActualHours) &&
        Objects.equals(this.totalActualUnits, getReservationUtilizationResponseTotal.totalActualUnits) &&
        Objects.equals(this.unusedHours, getReservationUtilizationResponseTotal.unusedHours) &&
        Objects.equals(this.unusedUnits, getReservationUtilizationResponseTotal.unusedUnits) &&
        Objects.equals(this.onDemandCostOfRIHoursUsed, getReservationUtilizationResponseTotal.onDemandCostOfRIHoursUsed) &&
        Objects.equals(this.netRISavings, getReservationUtilizationResponseTotal.netRISavings) &&
        Objects.equals(this.totalPotentialRISavings, getReservationUtilizationResponseTotal.totalPotentialRISavings) &&
        Objects.equals(this.amortizedUpfrontFee, getReservationUtilizationResponseTotal.amortizedUpfrontFee) &&
        Objects.equals(this.amortizedRecurringFee, getReservationUtilizationResponseTotal.amortizedRecurringFee) &&
        Objects.equals(this.totalAmortizedFee, getReservationUtilizationResponseTotal.totalAmortizedFee) &&
        Objects.equals(this.riCostForUnusedHours, getReservationUtilizationResponseTotal.riCostForUnusedHours) &&
        Objects.equals(this.realizedSavings, getReservationUtilizationResponseTotal.realizedSavings) &&
        Objects.equals(this.unrealizedSavings, getReservationUtilizationResponseTotal.unrealizedSavings);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetReservationUtilizationResponseTotal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetReservationUtilizationResponseTotal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetReservationUtilizationResponseTotal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetReservationUtilizationResponseTotal is not found in the empty JSON string", GetReservationUtilizationResponseTotal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetReservationUtilizationResponseTotal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetReservationUtilizationResponseTotal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetReservationUtilizationResponseTotal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetReservationUtilizationResponseTotal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetReservationUtilizationResponseTotal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetReservationUtilizationResponseTotal.class));

       return (TypeAdapter<T>) new TypeAdapter<GetReservationUtilizationResponseTotal>() {
           @Override
           public void write(JsonWriter out, GetReservationUtilizationResponseTotal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetReservationUtilizationResponseTotal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetReservationUtilizationResponseTotal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetReservationUtilizationResponseTotal
   * @throws IOException if the JSON string is invalid with respect to GetReservationUtilizationResponseTotal
   */
  public static GetReservationUtilizationResponseTotal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetReservationUtilizationResponseTotal.class);
  }

  /**
   * Convert an instance of GetReservationUtilizationResponseTotal to an JSON string
   *
   * @return JSON string
   */
