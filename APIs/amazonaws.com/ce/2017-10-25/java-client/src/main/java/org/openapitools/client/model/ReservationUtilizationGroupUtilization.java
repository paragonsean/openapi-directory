...
public class ReservationUtilizationGroupUtilization {
  ...
  public ReservationUtilizationGroupUtilization() {
  }

  public ReservationUtilizationGroupUtilization utilizationPercentage(String utilizationPercentage) {
  ...
  public ReservationUtilizationGroupUtilization utilizationPercentageInUnits(String utilizationPercentageInUnits) {
  ...
  public ReservationUtilizationGroupUtilization purchasedHours(String purchasedHours) {
  ...
  public ReservationUtilizationGroupUtilization purchasedUnits(String purchasedUnits) {
  ...
  public ReservationUtilizationGroupUtilization totalActualHours(String totalActualHours) {
  ...
  public ReservationUtilizationGroupUtilization totalActualUnits(String totalActualUnits) {
  ...
  public ReservationUtilizationGroupUtilization unusedHours(String unusedHours) {
  ...
  public ReservationUtilizationGroupUtilization unusedUnits(String unusedUnits) {
  ...
  public ReservationUtilizationGroupUtilization onDemandCostOfRIHoursUsed(String onDemandCostOfRIHoursUsed) {
  ...
  public ReservationUtilizationGroupUtilization netRISavings(String netRISavings) {
  ...
  public ReservationUtilizationGroupUtilization totalPotentialRISavings(String totalPotentialRISavings) {
  ...
  public ReservationUtilizationGroupUtilization amortizedUpfrontFee(String amortizedUpfrontFee) {
  ...
  public ReservationUtilizationGroupUtilization amortizedRecurringFee(String amortizedRecurringFee) {
  ...
  public ReservationUtilizationGroupUtilization totalAmortizedFee(String totalAmortizedFee) {
  ...
  public ReservationUtilizationGroupUtilization riCostForUnusedHours(String riCostForUnusedHours) {
  ...
  public ReservationUtilizationGroupUtilization realizedSavings(String realizedSavings) {
  ...
  public ReservationUtilizationGroupUtilization unrealizedSavings(String unrealizedSavings) {
  ...
  public boolean equals(Object o) {
    ...
    ReservationUtilizationGroupUtilization reservationUtilizationGroupUtilization = (ReservationUtilizationGroupUtilization) o;
    return Objects.equals(this.utilizationPercentage, reservationUtilizationGroupUtilization.utilizationPercentage) &&
        Objects.equals(this.utilizationPercentageInUnits, reservationUtilizationGroupUtilization.utilizationPercentageInUnits) &&
        Objects.equals(this.purchasedHours, reservationUtilizationGroupUtilization.purchasedHours) &&
        Objects.equals(this.purchasedUnits, reservationUtilizationGroupUtilization.purchasedUnits) &&
        Objects.equals(this.totalActualHours, reservationUtilizationGroupUtilization.totalActualHours) &&
        Objects.equals(this.totalActualUnits, reservationUtilizationGroupUtilization.totalActualUnits) &&
        Objects.equals(this.unusedHours, reservationUtilizationGroupUtilization.unusedHours) &&
        Objects.equals(this.unusedUnits, reservationUtilizationGroupUtilization.unusedUnits) &&
        Objects.equals(this.onDemandCostOfRIHoursUsed, reservationUtilizationGroupUtilization.onDemandCostOfRIHoursUsed) &&
        Objects.equals(this.netRISavings, reservationUtilizationGroupUtilization.netRISavings) &&
        Objects.equals(this.totalPotentialRISavings, reservationUtilizationGroupUtilization.totalPotentialRISavings) &&
        Objects.equals(this.amortizedUpfrontFee, reservationUtilizationGroupUtilization.amortizedUpfrontFee) &&
        Objects.equals(this.amortizedRecurringFee, reservationUtilizationGroupUtilization.amortizedRecurringFee) &&
        Objects.equals(this.totalAmortizedFee, reservationUtilizationGroupUtilization.totalAmortizedFee) &&
        Objects.equals(this.riCostForUnusedHours, reservationUtilizationGroupUtilization.riCostForUnusedHours) &&
        Objects.equals(this.realizedSavings, reservationUtilizationGroupUtilization.realizedSavings) &&
        Objects.equals(this.unrealizedSavings, reservationUtilizationGroupUtilization.unrealizedSavings);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservationUtilizationGroupUtilization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservationUtilizationGroupUtilization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservationUtilizationGroupUtilization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservationUtilizationGroupUtilization is not found in the empty JSON string", ReservationUtilizationGroupUtilization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservationUtilizationGroupUtilization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservationUtilizationGroupUtilization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservationUtilizationGroupUtilization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservationUtilizationGroupUtilization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservationUtilizationGroupUtilization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservationUtilizationGroupUtilization.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservationUtilizationGroupUtilization>() {
           @Override
           public void write(JsonWriter out, ReservationUtilizationGroupUtilization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservationUtilizationGroupUtilization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservationUtilizationGroupUtilization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservationUtilizationGroupUtilization
   * @throws IOException if the JSON string is invalid with respect to ReservationUtilizationGroupUtilization
   */
  public static ReservationUtilizationGroupUtilization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservationUtilizationGroupUtilization.class);
  }

  /**
   * Convert an instance of ReservationUtilizationGroupUtilization to an JSON string
   *
   * @return JSON string
   */
