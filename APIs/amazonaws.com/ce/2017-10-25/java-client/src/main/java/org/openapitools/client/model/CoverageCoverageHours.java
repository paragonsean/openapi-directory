...
public class CoverageCoverageHours {
  ...
  public CoverageCoverageHours() {
  }

  public CoverageCoverageHours onDemandHours(String onDemandHours) {
  ...
  public CoverageCoverageHours reservedHours(String reservedHours) {
  ...
  public CoverageCoverageHours totalRunningHours(String totalRunningHours) {
  ...
  public CoverageCoverageHours coverageHoursPercentage(String coverageHoursPercentage) {
  ...
  public boolean equals(Object o) {
    ...
    CoverageCoverageHours coverageCoverageHours = (CoverageCoverageHours) o;
    return Objects.equals(this.onDemandHours, coverageCoverageHours.onDemandHours) &&
        Objects.equals(this.reservedHours, coverageCoverageHours.reservedHours) &&
        Objects.equals(this.totalRunningHours, coverageCoverageHours.totalRunningHours) &&
        Objects.equals(this.coverageHoursPercentage, coverageCoverageHours.coverageHoursPercentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoverageCoverageHours {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CoverageCoverageHours
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoverageCoverageHours.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoverageCoverageHours is not found in the empty JSON string", CoverageCoverageHours.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CoverageCoverageHours.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CoverageCoverageHours` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoverageCoverageHours.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoverageCoverageHours' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoverageCoverageHours> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoverageCoverageHours.class));

       return (TypeAdapter<T>) new TypeAdapter<CoverageCoverageHours>() {
           @Override
           public void write(JsonWriter out, CoverageCoverageHours value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CoverageCoverageHours read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CoverageCoverageHours given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CoverageCoverageHours
   * @throws IOException if the JSON string is invalid with respect to CoverageCoverageHours
   */
  public static CoverageCoverageHours fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoverageCoverageHours.class);
  }

  /**
   * Convert an instance of CoverageCoverageHours to an JSON string
   *
   * @return JSON string
   */
