...
public class ReservationPurchaseRecommendationDetailInstanceDetails {
  ...
  public ReservationPurchaseRecommendationDetailInstanceDetails() {
  }

  public ReservationPurchaseRecommendationDetailInstanceDetails ec2InstanceDetails(InstanceDetailsEC2InstanceDetails ec2InstanceDetails) {
  ...
  public ReservationPurchaseRecommendationDetailInstanceDetails rdSInstanceDetails(InstanceDetailsRDSInstanceDetails rdSInstanceDetails) {
  ...
  public ReservationPurchaseRecommendationDetailInstanceDetails redshiftInstanceDetails(InstanceDetailsRedshiftInstanceDetails redshiftInstanceDetails) {
  ...
  public ReservationPurchaseRecommendationDetailInstanceDetails elastiCacheInstanceDetails(InstanceDetailsElastiCacheInstanceDetails elastiCacheInstanceDetails) {
  ...
  public ReservationPurchaseRecommendationDetailInstanceDetails esInstanceDetails(InstanceDetailsESInstanceDetails esInstanceDetails) {
  ...
  public boolean equals(Object o) {
    ...
    ReservationPurchaseRecommendationDetailInstanceDetails reservationPurchaseRecommendationDetailInstanceDetails = (ReservationPurchaseRecommendationDetailInstanceDetails) o;
    return Objects.equals(this.ec2InstanceDetails, reservationPurchaseRecommendationDetailInstanceDetails.ec2InstanceDetails) &&
        Objects.equals(this.rdSInstanceDetails, reservationPurchaseRecommendationDetailInstanceDetails.rdSInstanceDetails) &&
        Objects.equals(this.redshiftInstanceDetails, reservationPurchaseRecommendationDetailInstanceDetails.redshiftInstanceDetails) &&
        Objects.equals(this.elastiCacheInstanceDetails, reservationPurchaseRecommendationDetailInstanceDetails.elastiCacheInstanceDetails) &&
        Objects.equals(this.esInstanceDetails, reservationPurchaseRecommendationDetailInstanceDetails.esInstanceDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservationPurchaseRecommendationDetailInstanceDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservationPurchaseRecommendationDetailInstanceDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservationPurchaseRecommendationDetailInstanceDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservationPurchaseRecommendationDetailInstanceDetails is not found in the empty JSON string", ReservationPurchaseRecommendationDetailInstanceDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservationPurchaseRecommendationDetailInstanceDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservationPurchaseRecommendationDetailInstanceDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservationPurchaseRecommendationDetailInstanceDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservationPurchaseRecommendationDetailInstanceDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservationPurchaseRecommendationDetailInstanceDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservationPurchaseRecommendationDetailInstanceDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservationPurchaseRecommendationDetailInstanceDetails>() {
           @Override
           public void write(JsonWriter out, ReservationPurchaseRecommendationDetailInstanceDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservationPurchaseRecommendationDetailInstanceDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservationPurchaseRecommendationDetailInstanceDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservationPurchaseRecommendationDetailInstanceDetails
   * @throws IOException if the JSON string is invalid with respect to ReservationPurchaseRecommendationDetailInstanceDetails
   */
  public static ReservationPurchaseRecommendationDetailInstanceDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservationPurchaseRecommendationDetailInstanceDetails.class);
  }

  /**
   * Convert an instance of ReservationPurchaseRecommendationDetailInstanceDetails to an JSON string
   *
   * @return JSON string
   */
