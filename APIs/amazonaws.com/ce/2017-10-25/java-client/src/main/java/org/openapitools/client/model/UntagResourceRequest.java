...
public class UntagResourceRequest {
  ...
  public static final String SERIALIZED_NAME_RESOURCE_TAG_KEYS = "ResourceTagKeys";
  @SerializedName(SERIALIZED_NAME_RESOURCE_TAG_KEYS)
  private List resourceTagKeys;
  ...
  public UntagResourceRequest resourceTagKeys(List resourceTagKeys) {
   ...
   */
  @javax.annotation.Nonnull
  public List getResourceTagKeys() {
    return resourceTagKeys;
  }

  public void setResourceTagKeys(List resourceTagKeys) {
    this.resourceTagKeys = resourceTagKeys;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceArn, untagResourceRequest.resourceArn) &&
        Objects.equals(this.resourceTagKeys, untagResourceRequest.resourceTagKeys);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceArn, resourceTagKeys);
  }
  ...
  public String toString() {
    ...
    sb.append("    resourceTagKeys: ").append(toIndentedString(resourceTagKeys)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ResourceTagKeys");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("ResourceArn");
    openapiRequiredFields.add("ResourceTagKeys");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `ResourceTagKeys`
      List.validateJsonElement(jsonObj.get("ResourceTagKeys"));
  }
