...
public class ResourceUtilizationEC2ResourceUtilization {
  ...
  public ResourceUtilizationEC2ResourceUtilization() {
  }

  public ResourceUtilizationEC2ResourceUtilization maxCpuUtilizationPercentage(String maxCpuUtilizationPercentage) {
  ...
  public ResourceUtilizationEC2ResourceUtilization maxMemoryUtilizationPercentage(String maxMemoryUtilizationPercentage) {
  ...
  public ResourceUtilizationEC2ResourceUtilization maxStorageUtilizationPercentage(String maxStorageUtilizationPercentage) {
  ...
  public ResourceUtilizationEC2ResourceUtilization ebSResourceUtilization(EC2ResourceUtilizationEBSResourceUtilization ebSResourceUtilization) {
  ...
  public ResourceUtilizationEC2ResourceUtilization diskResourceUtilization(EC2ResourceUtilizationDiskResourceUtilization diskResourceUtilization) {
  ...
  public ResourceUtilizationEC2ResourceUtilization networkResourceUtilization(EC2ResourceUtilizationNetworkResourceUtilization networkResourceUtilization) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceUtilizationEC2ResourceUtilization resourceUtilizationEC2ResourceUtilization = (ResourceUtilizationEC2ResourceUtilization) o;
    return Objects.equals(this.maxCpuUtilizationPercentage, resourceUtilizationEC2ResourceUtilization.maxCpuUtilizationPercentage) &&
        Objects.equals(this.maxMemoryUtilizationPercentage, resourceUtilizationEC2ResourceUtilization.maxMemoryUtilizationPercentage) &&
        Objects.equals(this.maxStorageUtilizationPercentage, resourceUtilizationEC2ResourceUtilization.maxStorageUtilizationPercentage) &&
        Objects.equals(this.ebSResourceUtilization, resourceUtilizationEC2ResourceUtilization.ebSResourceUtilization) &&
        Objects.equals(this.diskResourceUtilization, resourceUtilizationEC2ResourceUtilization.diskResourceUtilization) &&
        Objects.equals(this.networkResourceUtilization, resourceUtilizationEC2ResourceUtilization.networkResourceUtilization);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceUtilizationEC2ResourceUtilization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceUtilizationEC2ResourceUtilization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceUtilizationEC2ResourceUtilization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceUtilizationEC2ResourceUtilization is not found in the empty JSON string", ResourceUtilizationEC2ResourceUtilization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceUtilizationEC2ResourceUtilization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceUtilizationEC2ResourceUtilization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceUtilizationEC2ResourceUtilization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceUtilizationEC2ResourceUtilization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceUtilizationEC2ResourceUtilization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceUtilizationEC2ResourceUtilization.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceUtilizationEC2ResourceUtilization>() {
           @Override
           public void write(JsonWriter out, ResourceUtilizationEC2ResourceUtilization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceUtilizationEC2ResourceUtilization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceUtilizationEC2ResourceUtilization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceUtilizationEC2ResourceUtilization
   * @throws IOException if the JSON string is invalid with respect to ResourceUtilizationEC2ResourceUtilization
   */
  public static ResourceUtilizationEC2ResourceUtilization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceUtilizationEC2ResourceUtilization.class);
  }

  /**
   * Convert an instance of ResourceUtilizationEC2ResourceUtilization to an JSON string
   *
   * @return JSON string
   */
