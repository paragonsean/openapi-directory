...
public class ExpressionNot {
  ...
  public ExpressionNot or(List or) {
    this.or = or;
    return this;
  }
  ...
  public ExpressionNot and(List and) {
    this.and = and;
    return this;
  }
  ...
  public ExpressionNot not(ExpressionNot not) {
    this.not = not;
    return this;
  }
  ...
  public ExpressionNot dimensions(ExpressionDimensions dimensions) {
  ...
  public ExpressionNot tags(ExpressionTags tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ExpressionNot costCategories(ExpressionCostCategories costCategories) {
  ...
  public boolean equals(Object o) {
    ...
    ExpressionNot expressionNot = (ExpressionNot) o;
    return Objects.equals(this.or, expressionNot.or) &&
        Objects.equals(this.and, expressionNot.and) &&
        Objects.equals(this.not, expressionNot.not) &&
        Objects.equals(this.dimensions, expressionNot.dimensions) &&
        Objects.equals(this.tags, expressionNot.tags) &&
        Objects.equals(this.costCategories, expressionNot.costCategories);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpressionNot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpressionNot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpressionNot is not found in the empty JSON string", ExpressionNot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpressionNot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpressionNot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpressionNot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpressionNot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpressionNot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpressionNot.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpressionNot>() {
           @Override
           public void write(JsonWriter out, ExpressionNot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExpressionNot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExpressionNot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpressionNot
   * @throws IOException if the JSON string is invalid with respect to ExpressionNot
   */
  public static ExpressionNot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpressionNot.class);
  }

  /**
   * Convert an instance of ExpressionNot to an JSON string
   *
   * @return JSON string
   */
