...
public class DiskResourceUtilization {
  ...
  public DiskResourceUtilization diskReadOpsPerSecond(String diskReadOpsPerSecond) {
  ...
  public DiskResourceUtilization diskWriteOpsPerSecond(String diskWriteOpsPerSecond) {
  ...
  public DiskResourceUtilization diskReadBytesPerSecond(String diskReadBytesPerSecond) {
  ...
  public DiskResourceUtilization diskWriteBytesPerSecond(String diskWriteBytesPerSecond) {
  ...
  public boolean equals(Object o) {
    ...
    DiskResourceUtilization diskResourceUtilization = (DiskResourceUtilization) o;
    return Objects.equals(this.diskReadOpsPerSecond, diskResourceUtilization.diskReadOpsPerSecond) &&
        Objects.equals(this.diskWriteOpsPerSecond, diskResourceUtilization.diskWriteOpsPerSecond) &&
        Objects.equals(this.diskReadBytesPerSecond, diskResourceUtilization.diskReadBytesPerSecond) &&
        Objects.equals(this.diskWriteBytesPerSecond, diskResourceUtilization.diskWriteBytesPerSecond);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiskResourceUtilization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiskResourceUtilization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiskResourceUtilization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiskResourceUtilization is not found in the empty JSON string", DiskResourceUtilization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiskResourceUtilization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DiskResourceUtilization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiskResourceUtilization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiskResourceUtilization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiskResourceUtilization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiskResourceUtilization.class));

       return (TypeAdapter<T>) new TypeAdapter<DiskResourceUtilization>() {
           @Override
           public void write(JsonWriter out, DiskResourceUtilization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiskResourceUtilization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiskResourceUtilization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiskResourceUtilization
   * @throws IOException if the JSON string is invalid with respect to DiskResourceUtilization
   */
  public static DiskResourceUtilization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiskResourceUtilization.class);
  }

  /**
   * Convert an instance of DiskResourceUtilization to an JSON string
   *
   * @return JSON string
   */
