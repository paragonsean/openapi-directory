...
/*
 * OAIGetAnomalyMonitorsRequest.h
 *
 * 
 */

#ifndef OAIGetAnomalyMonitorsRequest_H
#define OAIGetAnomalyMonitorsRequest_H
...
class OAIGetAnomalyMonitorsRequest : public OAIObject {
public:
    OAIGetAnomalyMonitorsRequest();
    OAIGetAnomalyMonitorsRequest(QString json);
    ~OAIGetAnomalyMonitorsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAnomalyMonitorsRequest)

#endif // OAIGetAnomalyMonitorsRequest_H
