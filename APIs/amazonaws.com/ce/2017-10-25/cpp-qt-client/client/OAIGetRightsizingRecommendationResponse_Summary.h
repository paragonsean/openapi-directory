...
/*
 * OAIGetRightsizingRecommendationResponse_Summary.h
 *
 * 
 */

#ifndef OAIGetRightsizingRecommendationResponse_Summary_H
#define OAIGetRightsizingRecommendationResponse_Summary_H
...
class OAIGetRightsizingRecommendationResponse_Summary : public OAIObject {
public:
    OAIGetRightsizingRecommendationResponse_Summary();
    OAIGetRightsizingRecommendationResponse_Summary(QString json);
    ~OAIGetRightsizingRecommendationResponse_Summary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRightsizingRecommendationResponse_Summary)

#endif // OAIGetRightsizingRecommendationResponse_Summary_H
