...
/*
 * OAIInstanceDetails_EC2InstanceDetails.h
 *
 * 
 */

#ifndef OAIInstanceDetails_EC2InstanceDetails_H
#define OAIInstanceDetails_EC2InstanceDetails_H
...
class OAIInstanceDetails_EC2InstanceDetails : public OAIObject {
public:
    OAIInstanceDetails_EC2InstanceDetails();
    OAIInstanceDetails_EC2InstanceDetails(QString json);
    ~OAIInstanceDetails_EC2InstanceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceDetails_EC2InstanceDetails)

#endif // OAIInstanceDetails_EC2InstanceDetails_H
