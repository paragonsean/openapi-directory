...
/*
 * OAIResourceDetails_EC2ResourceDetails.h
 *
 * 
 */

#ifndef OAIResourceDetails_EC2ResourceDetails_H
#define OAIResourceDetails_EC2ResourceDetails_H
...
class OAIResourceDetails_EC2ResourceDetails : public OAIObject {
public:
    OAIResourceDetails_EC2ResourceDetails();
    OAIResourceDetails_EC2ResourceDetails(QString json);
    ~OAIResourceDetails_EC2ResourceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceDetails_EC2ResourceDetails)

#endif // OAIResourceDetails_EC2ResourceDetails_H
