...
/*
 * OAIUtilizationByTime_Total.h
 *
 * 
 */

#ifndef OAIUtilizationByTime_Total_H
#define OAIUtilizationByTime_Total_H
...
class OAIUtilizationByTime_Total : public OAIObject {
public:
    OAIUtilizationByTime_Total();
    OAIUtilizationByTime_Total(QString json);
    ~OAIUtilizationByTime_Total() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUtilizationByTime_Total)

#endif // OAIUtilizationByTime_Total_H
