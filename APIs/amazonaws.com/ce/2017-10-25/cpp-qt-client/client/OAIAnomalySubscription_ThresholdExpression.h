...
/*
 * OAIAnomalySubscription_ThresholdExpression.h
 *
 * 
 */

#ifndef OAIAnomalySubscription_ThresholdExpression_H
#define OAIAnomalySubscription_ThresholdExpression_H
...
class OAIAnomalySubscription_ThresholdExpression : public OAIObject {
public:
    OAIAnomalySubscription_ThresholdExpression();
    OAIAnomalySubscription_ThresholdExpression(QString json);
    ~OAIAnomalySubscription_ThresholdExpression() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnomalySubscription_ThresholdExpression)

#endif // OAIAnomalySubscription_ThresholdExpression_H
