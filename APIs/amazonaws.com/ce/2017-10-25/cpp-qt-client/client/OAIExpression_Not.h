...
#ifndef OAIExpression_Not_H
#define OAIExpression_Not_H
...
class OAIExpression_Not : public OAIObject {
public:
    OAIExpression_Not();
    OAIExpression_Not(QString json);
    ~OAIExpression_Not() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpression_Not)

#endif // OAIExpression_Not_H
