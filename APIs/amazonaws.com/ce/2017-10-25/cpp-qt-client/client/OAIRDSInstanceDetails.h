...
class OAIRDSInstanceDetails : public OAIObject {
public:
    OAIRDSInstanceDetails();
    OAIRDSInstanceDetails(QString json);
    ~OAIRDSInstanceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRDSInstanceDetails)

#endif // OAIRDSInstanceDetails_H
