...
/*
 * OAIExpression_Dimensions.h
 *
 * 
 */

#ifndef OAIExpression_Dimensions_H
#define OAIExpression_Dimensions_H
...
class OAIExpression_Dimensions : public OAIObject {
public:
    OAIExpression_Dimensions();
    OAIExpression_Dimensions(QString json);
    ~OAIExpression_Dimensions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpression_Dimensions)

#endif // OAIExpression_Dimensions_H
