...
#ifndef OAICostCategoryValues_H
#define OAICostCategoryValues_H
...
class OAICostCategoryValues : public OAIObject {
public:
    OAICostCategoryValues();
    OAICostCategoryValues(QString json);
    ~OAICostCategoryValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICostCategoryValues)

#endif // OAICostCategoryValues_H
