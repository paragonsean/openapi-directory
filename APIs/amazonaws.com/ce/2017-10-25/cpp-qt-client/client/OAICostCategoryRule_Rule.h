...
/*
 * OAICostCategoryRule_Rule.h
 *
 * 
 */

#ifndef OAICostCategoryRule_Rule_H
#define OAICostCategoryRule_Rule_H
...
class OAICostCategoryRule_Rule : public OAIObject {
public:
    OAICostCategoryRule_Rule();
    OAICostCategoryRule_Rule(QString json);
    ~OAICostCategoryRule_Rule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICostCategoryRule_Rule)

#endif // OAICostCategoryRule_Rule_H
