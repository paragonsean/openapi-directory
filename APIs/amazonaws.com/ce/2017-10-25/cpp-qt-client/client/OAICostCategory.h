...
#ifndef OAICostCategory_H
#define OAICostCategory_H
...
class OAICostCategory : public OAIObject {
public:
    OAICostCategory();
    OAICostCategory(QString json);
    ~OAICostCategory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICostCategory)

#endif // OAICostCategory_H
