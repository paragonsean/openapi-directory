...
/*
 * OAIGetSavingsPlansCoverageRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetSavingsPlansCoverageRequest_Filter_H
#define OAIGetSavingsPlansCoverageRequest_Filter_H
...
class OAIGetSavingsPlansCoverageRequest_Filter : public OAIObject {
public:
    OAIGetSavingsPlansCoverageRequest_Filter();
    OAIGetSavingsPlansCoverageRequest_Filter(QString json);
    ~OAIGetSavingsPlansCoverageRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSavingsPlansCoverageRequest_Filter)

#endif // OAIGetSavingsPlansCoverageRequest_Filter_H
