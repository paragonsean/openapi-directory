...
/*
 * OAISavingsPlansUtilizationByTime.h
 *
 * The amount of Savings Plans utilization (in hours).
 */

#ifndef OAISavingsPlansUtilizationByTime_H
#define OAISavingsPlansUtilizationByTime_H
...
class OAISavingsPlansUtilizationByTime : public OAIObject {
public:
    OAISavingsPlansUtilizationByTime();
    OAISavingsPlansUtilizationByTime(QString json);
    ~OAISavingsPlansUtilizationByTime() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavingsPlansUtilizationByTime)

#endif // OAISavingsPlansUtilizationByTime_H
