...
/*
 * OAIGetSavingsPlansCoverageRequest.h
 *
 * 
 */

#ifndef OAIGetSavingsPlansCoverageRequest_H
#define OAIGetSavingsPlansCoverageRequest_H
...
class OAIGetSavingsPlansCoverageRequest_Filter;
class OAIGetSavingsPlansCoverageRequest_SortBy;

class OAIGetSavingsPlansCoverageRequest : public OAIObject {
public:
    OAIGetSavingsPlansCoverageRequest();
    OAIGetSavingsPlansCoverageRequest(QString json);
    ~OAIGetSavingsPlansCoverageRequest() override;
    ...
    OAIGetSavingsPlansCoverageRequest_Filter getFilter() const;
    void setFilter(const OAIGetSavingsPlansCoverageRequest_Filter &filter);
    ...
    OAIGetSavingsPlansCoverageRequest_SortBy getSortBy() const;
    void setSortBy(const OAIGetSavingsPlansCoverageRequest_SortBy &sort_by);
...
private:
    ...
    OAIGetSavingsPlansCoverageRequest_Filter m_filter;
    bool m_filter_isSet;
    ...
    OAIGetSavingsPlansCoverageRequest_SortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSavingsPlansCoverageRequest)

#endif // OAIGetSavingsPlansCoverageRequest_H
