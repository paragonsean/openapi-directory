...
/*
 * OAIReservationCoverageGroup_Coverage.h
 *
 * 
 */

#ifndef OAIReservationCoverageGroup_Coverage_H
#define OAIReservationCoverageGroup_Coverage_H
...
class OAIReservationCoverageGroup_Coverage : public OAIObject {
public:
    OAIReservationCoverageGroup_Coverage();
    OAIReservationCoverageGroup_Coverage(QString json);
    ~OAIReservationCoverageGroup_Coverage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationCoverageGroup_Coverage)

#endif // OAIReservationCoverageGroup_Coverage_H
