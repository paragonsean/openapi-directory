...
/*
 * OAIRedshiftInstanceDetails.h
 *
 * Details about the Amazon Redshift instances that Amazon Web Services recommends that you purchase.
 */

#ifndef OAIRedshiftInstanceDetails_H
#define OAIRedshiftInstanceDetails_H
...
class OAIRedshiftInstanceDetails : public OAIObject {
public:
    OAIRedshiftInstanceDetails();
    OAIRedshiftInstanceDetails(QString json);
    ~OAIRedshiftInstanceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedshiftInstanceDetails)

#endif // OAIRedshiftInstanceDetails_H
