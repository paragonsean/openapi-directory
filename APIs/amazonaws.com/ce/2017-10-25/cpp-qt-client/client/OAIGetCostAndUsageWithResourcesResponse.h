...
/*
 * OAIGetCostAndUsageWithResourcesResponse.h
 *
 * 
 */

#ifndef OAIGetCostAndUsageWithResourcesResponse_H
#define OAIGetCostAndUsageWithResourcesResponse_H
...
class OAIGetCostAndUsageWithResourcesResponse : public OAIObject {
public:
    OAIGetCostAndUsageWithResourcesResponse();
    OAIGetCostAndUsageWithResourcesResponse(QString json);
    ~OAIGetCostAndUsageWithResourcesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCostAndUsageWithResourcesResponse)

#endif // OAIGetCostAndUsageWithResourcesResponse_H
