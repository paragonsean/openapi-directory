...
/*
 * OAIElastiCacheInstanceDetails.h
 *
 * Details about the Amazon ElastiCache instances that Amazon Web Services recommends that you purchase.
 */

#ifndef OAIElastiCacheInstanceDetails_H
#define OAIElastiCacheInstanceDetails_H
...
class OAIElastiCacheInstanceDetails : public OAIObject {
public:
    OAIElastiCacheInstanceDetails();
    OAIElastiCacheInstanceDetails(QString json);
    ~OAIElastiCacheInstanceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElastiCacheInstanceDetails)

#endif // OAIElastiCacheInstanceDetails_H
