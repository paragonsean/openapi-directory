...
/*
 * OAIGetReservationCoverageRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetReservationCoverageRequest_Filter_H
#define OAIGetReservationCoverageRequest_Filter_H
...
class OAIGetReservationCoverageRequest_Filter : public OAIObject {
public:
    OAIGetReservationCoverageRequest_Filter();
    OAIGetReservationCoverageRequest_Filter(QString json);
    ~OAIGetReservationCoverageRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReservationCoverageRequest_Filter)

#endif // OAIGetReservationCoverageRequest_Filter_H
