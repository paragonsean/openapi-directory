...
#include "OAIAnomalySubscription.h"
...
OAIAnomalySubscription::OAIAnomalySubscription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnomalySubscription::OAIAnomalySubscription() {
    this->initializeModel();
}

OAIAnomalySubscription::~OAIAnomalySubscription() {}

void OAIAnomalySubscription::initializeModel() {
...
void OAIAnomalySubscription::fromJson(QString jsonString) {
...
void OAIAnomalySubscription::fromJsonObject(QJsonObject json) {
...
QString OAIAnomalySubscription::asJson() const {
...
QJsonObject OAIAnomalySubscription::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAnomalySubscription::getSubscriptionArn() const {
    return m_subscription_arn;
}
void OAIAnomalySubscription::setSubscriptionArn(const QString &subscription_arn) {
    m_subscription_arn = subscription_arn;
    m_subscription_arn_isSet = true;
}

bool OAIAnomalySubscription::is_subscription_arn_Set() const{
    return m_subscription_arn_isSet;
}

bool OAIAnomalySubscription::is_subscription_arn_Valid() const{
    return m_subscription_arn_isValid;
}

QString OAIAnomalySubscription::getAccountId() const {
    return m_account_id;
}
void OAIAnomalySubscription::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIAnomalySubscription::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIAnomalySubscription::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QList OAIAnomalySubscription::getMonitorArnList() const {
    return m_monitor_arn_list;
}
void OAIAnomalySubscription::setMonitorArnList(const QList &monitor_arn_list) {
    m_monitor_arn_list = monitor_arn_list;
    m_monitor_arn_list_isSet = true;
}

bool OAIAnomalySubscription::is_monitor_arn_list_Set() const{
    return m_monitor_arn_list_isSet;
}

bool OAIAnomalySubscription::is_monitor_arn_list_Valid() const{
    return m_monitor_arn_list_isValid;
}

QList OAIAnomalySubscription::getSubscribers() const {
    return m_subscribers;
}
void OAIAnomalySubscription::setSubscribers(const QList &subscribers) {
    m_subscribers = subscribers;
    m_subscribers_isSet = true;
}

bool OAIAnomalySubscription::is_subscribers_Set() const{
    return m_subscribers_isSet;
}

bool OAIAnomalySubscription::is_subscribers_Valid() const{
    return m_subscribers_isValid;
}

double OAIAnomalySubscription::getThreshold() const {
    return m_threshold;
}
void OAIAnomalySubscription::setThreshold(const double &threshold) {
    m_threshold = threshold;
    m_threshold_isSet = true;
}

bool OAIAnomalySubscription::is_threshold_Set() const{
    return m_threshold_isSet;
}

bool OAIAnomalySubscription::is_threshold_Valid() const{
    return m_threshold_isValid;
}

OAIAnomalySubscriptionFrequency OAIAnomalySubscription::getFrequency() const {
    return m_frequency;
}
void OAIAnomalySubscription::setFrequency(const OAIAnomalySubscriptionFrequency &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAIAnomalySubscription::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAIAnomalySubscription::is_frequency_Valid() const{
    return m_frequency_isValid;
}

QString OAIAnomalySubscription::getSubscriptionName() const {
    return m_subscription_name;
}
void OAIAnomalySubscription::setSubscriptionName(const QString &subscription_name) {
    m_subscription_name = subscription_name;
    m_subscription_name_isSet = true;
}

bool OAIAnomalySubscription::is_subscription_name_Set() const{
    return m_subscription_name_isSet;
}

bool OAIAnomalySubscription::is_subscription_name_Valid() const{
    return m_subscription_name_isValid;
}

OAIAnomalySubscription_ThresholdExpression OAIAnomalySubscription::getThresholdExpression() const {
    return m_threshold_expression;
}
void OAIAnomalySubscription::setThresholdExpression(const OAIAnomalySubscription_ThresholdExpression &threshold_expression) {
    m_threshold_expression = threshold_expression;
    m_threshold_expression_isSet = true;
}

bool OAIAnomalySubscription::is_threshold_expression_Set() const{
    return m_threshold_expression_isSet;
}

bool OAIAnomalySubscription::is_threshold_expression_Valid() const{
    return m_threshold_expression_isValid;
}

bool OAIAnomalySubscription::isSet() const {
...
bool OAIAnomalySubscription::isValid() const {
