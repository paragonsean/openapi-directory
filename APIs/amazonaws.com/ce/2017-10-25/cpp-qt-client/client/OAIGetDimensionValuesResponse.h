...
/*
 * OAIGetDimensionValuesResponse.h
 *
 * 
 */

#ifndef OAIGetDimensionValuesResponse_H
#define OAIGetDimensionValuesResponse_H
...
class OAIGetDimensionValuesResponse : public OAIObject {
public:
    OAIGetDimensionValuesResponse();
    OAIGetDimensionValuesResponse(QString json);
    ~OAIGetDimensionValuesResponse() override;
    ...
    QList getDimensionValues() const;
    void setDimensionValues(const QList &dimension_values);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDimensionValuesResponse)

#endif // OAIGetDimensionValuesResponse_H
