...
/*
 * OAIRightsizingRecommendationMetadata.h
 *
 * Metadata for this recommendation set.
 */

#ifndef OAIRightsizingRecommendationMetadata_H
#define OAIRightsizingRecommendationMetadata_H
...
class OAIRightsizingRecommendationMetadata : public OAIObject {
public:
    OAIRightsizingRecommendationMetadata();
    OAIRightsizingRecommendationMetadata(QString json);
    ~OAIRightsizingRecommendationMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRightsizingRecommendationMetadata)

#endif // OAIRightsizingRecommendationMetadata_H
