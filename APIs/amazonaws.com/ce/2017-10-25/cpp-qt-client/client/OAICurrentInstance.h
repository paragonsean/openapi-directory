...
/*
 * OAICurrentInstance.h
 *
 * Context about the current instance.
 */

#ifndef OAICurrentInstance_H
#define OAICurrentInstance_H
...
class OAICurrentInstance : public OAIObject {
public:
    OAICurrentInstance();
    OAICurrentInstance(QString json);
    ~OAICurrentInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrentInstance)

#endif // OAICurrentInstance_H
