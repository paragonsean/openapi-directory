...
/*
 * OAISavingsPlansAmortizedCommitment.h
 *
 * The amortized amount of Savings Plans purchased in a specific account during a specific time interval.
 */

#ifndef OAISavingsPlansAmortizedCommitment_H
#define OAISavingsPlansAmortizedCommitment_H
...
class OAISavingsPlansAmortizedCommitment : public OAIObject {
public:
    OAISavingsPlansAmortizedCommitment();
    OAISavingsPlansAmortizedCommitment(QString json);
    ~OAISavingsPlansAmortizedCommitment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavingsPlansAmortizedCommitment)

#endif // OAISavingsPlansAmortizedCommitment_H
