...
/*
 * OAIGetSavingsPlansUtilizationRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetSavingsPlansUtilizationRequest_Filter_H
#define OAIGetSavingsPlansUtilizationRequest_Filter_H
...
class OAIGetSavingsPlansUtilizationRequest_Filter : public OAIObject {
public:
    OAIGetSavingsPlansUtilizationRequest_Filter();
    OAIGetSavingsPlansUtilizationRequest_Filter(QString json);
    ~OAIGetSavingsPlansUtilizationRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSavingsPlansUtilizationRequest_Filter)

#endif // OAIGetSavingsPlansUtilizationRequest_Filter_H
