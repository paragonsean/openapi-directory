...
#ifndef OAITagValues_H
#define OAITagValues_H
...
class OAITagValues : public OAIObject {
public:
    OAITagValues();
    OAITagValues(QString json);
    ~OAITagValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagValues)

#endif // OAITagValues_H
