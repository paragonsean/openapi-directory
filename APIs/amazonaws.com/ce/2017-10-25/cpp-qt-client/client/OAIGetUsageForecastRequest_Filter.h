...
/*
 * OAIGetUsageForecastRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetUsageForecastRequest_Filter_H
#define OAIGetUsageForecastRequest_Filter_H
...
class OAIGetUsageForecastRequest_Filter : public OAIObject {
public:
    OAIGetUsageForecastRequest_Filter();
    OAIGetUsageForecastRequest_Filter(QString json);
    ~OAIGetUsageForecastRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUsageForecastRequest_Filter)

#endif // OAIGetUsageForecastRequest_Filter_H
