...
/*
 * OAISavingsPlansUtilizationAggregates.h
 *
 * The aggregated utilization metrics for your Savings Plans usage.
 */

#ifndef OAISavingsPlansUtilizationAggregates_H
#define OAISavingsPlansUtilizationAggregates_H
...
class OAISavingsPlansUtilizationAggregates : public OAIObject {
public:
    OAISavingsPlansUtilizationAggregates();
    OAISavingsPlansUtilizationAggregates(QString json);
    ~OAISavingsPlansUtilizationAggregates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavingsPlansUtilizationAggregates)

#endif // OAISavingsPlansUtilizationAggregates_H
