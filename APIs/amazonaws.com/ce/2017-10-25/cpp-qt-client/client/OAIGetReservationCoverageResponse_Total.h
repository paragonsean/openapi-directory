...
/*
 * OAIGetReservationCoverageResponse_Total.h
 *
 * 
 */

#ifndef OAIGetReservationCoverageResponse_Total_H
#define OAIGetReservationCoverageResponse_Total_H
...
class OAIGetReservationCoverageResponse_Total : public OAIObject {
public:
    OAIGetReservationCoverageResponse_Total();
    OAIGetReservationCoverageResponse_Total(QString json);
    ~OAIGetReservationCoverageResponse_Total() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReservationCoverageResponse_Total)

#endif // OAIGetReservationCoverageResponse_Total_H
