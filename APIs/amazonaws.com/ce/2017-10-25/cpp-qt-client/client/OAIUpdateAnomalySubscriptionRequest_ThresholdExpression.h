...
/*
 * OAIUpdateAnomalySubscriptionRequest_ThresholdExpression.h
 *
 * 
 */

#ifndef OAIUpdateAnomalySubscriptionRequest_ThresholdExpression_H
#define OAIUpdateAnomalySubscriptionRequest_ThresholdExpression_H
...
class OAIUpdateAnomalySubscriptionRequest_ThresholdExpression : public OAIObject {
public:
    OAIUpdateAnomalySubscriptionRequest_ThresholdExpression();
    OAIUpdateAnomalySubscriptionRequest_ThresholdExpression(QString json);
    ~OAIUpdateAnomalySubscriptionRequest_ThresholdExpression() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAnomalySubscriptionRequest_ThresholdExpression)

#endif // OAIUpdateAnomalySubscriptionRequest_ThresholdExpression_H
