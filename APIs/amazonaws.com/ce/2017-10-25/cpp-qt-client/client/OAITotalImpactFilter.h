...
/*
 * OAITotalImpactFilter.h
 *
 * Filters cost anomalies based on the total impact. 
 */

#ifndef OAITotalImpactFilter_H
#define OAITotalImpactFilter_H
...
class OAITotalImpactFilter : public OAIObject {
public:
    OAITotalImpactFilter();
    OAITotalImpactFilter(QString json);
    ~OAITotalImpactFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalImpactFilter)

#endif // OAITotalImpactFilter_H
