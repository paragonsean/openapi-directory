...
#ifndef OAIAnomalyScore_H
#define OAIAnomalyScore_H
...
class OAIAnomalyScore : public OAIObject {
public:
    OAIAnomalyScore();
    OAIAnomalyScore(QString json);
    ~OAIAnomalyScore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnomalyScore)

#endif // OAIAnomalyScore_H
