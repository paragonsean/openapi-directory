...
/*
 * OAIGetReservationUtilizationRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetReservationUtilizationRequest_Filter_H
#define OAIGetReservationUtilizationRequest_Filter_H
...
class OAIGetReservationUtilizationRequest_Filter : public OAIObject {
public:
    OAIGetReservationUtilizationRequest_Filter();
    OAIGetReservationUtilizationRequest_Filter(QString json);
    ~OAIGetReservationUtilizationRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReservationUtilizationRequest_Filter)

#endif // OAIGetReservationUtilizationRequest_Filter_H
