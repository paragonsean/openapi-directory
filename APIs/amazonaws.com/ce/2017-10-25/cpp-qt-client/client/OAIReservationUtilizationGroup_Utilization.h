...
/*
 * OAIReservationUtilizationGroup_Utilization.h
 *
 * 
 */

#ifndef OAIReservationUtilizationGroup_Utilization_H
#define OAIReservationUtilizationGroup_Utilization_H
...
class OAIReservationUtilizationGroup_Utilization : public OAIObject {
public:
    OAIReservationUtilizationGroup_Utilization();
    OAIReservationUtilizationGroup_Utilization(QString json);
    ~OAIReservationUtilizationGroup_Utilization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationUtilizationGroup_Utilization)

#endif // OAIReservationUtilizationGroup_Utilization_H
