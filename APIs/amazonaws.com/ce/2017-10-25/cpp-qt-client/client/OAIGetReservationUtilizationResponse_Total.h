...
/*
 * OAIGetReservationUtilizationResponse_Total.h
 *
 * 
 */

#ifndef OAIGetReservationUtilizationResponse_Total_H
#define OAIGetReservationUtilizationResponse_Total_H
...
class OAIGetReservationUtilizationResponse_Total : public OAIObject {
public:
    OAIGetReservationUtilizationResponse_Total();
    OAIGetReservationUtilizationResponse_Total(QString json);
    ~OAIGetReservationUtilizationResponse_Total() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReservationUtilizationResponse_Total)

#endif // OAIGetReservationUtilizationResponse_Total_H
