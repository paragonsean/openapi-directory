...
/*
 * OAIGetCostAndUsageWithResourcesRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetCostAndUsageWithResourcesRequest_Filter_H
#define OAIGetCostAndUsageWithResourcesRequest_Filter_H
...
class OAIGetCostAndUsageWithResourcesRequest_Filter : public OAIObject {
public:
    OAIGetCostAndUsageWithResourcesRequest_Filter();
    OAIGetCostAndUsageWithResourcesRequest_Filter(QString json);
    ~OAIGetCostAndUsageWithResourcesRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCostAndUsageWithResourcesRequest_Filter)

#endif // OAIGetCostAndUsageWithResourcesRequest_Filter_H
