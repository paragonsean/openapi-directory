...
/*
 * OAIDiskResourceUtilization.h
 *
 * The field that contains a list of disk (local storage) metrics that are associated with the current instance. 
 */

#ifndef OAIDiskResourceUtilization_H
#define OAIDiskResourceUtilization_H
...
class OAIDiskResourceUtilization : public OAIObject {
public:
    OAIDiskResourceUtilization();
    OAIDiskResourceUtilization(QString json);
    ~OAIDiskResourceUtilization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiskResourceUtilization)

#endif // OAIDiskResourceUtilization_H
