...
/*
 * OAIGetCostAndUsageRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetCostAndUsageRequest_Filter_H
#define OAIGetCostAndUsageRequest_Filter_H
...
class OAIGetCostAndUsageRequest_Filter : public OAIObject {
public:
    OAIGetCostAndUsageRequest_Filter();
    OAIGetCostAndUsageRequest_Filter(QString json);
    ~OAIGetCostAndUsageRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCostAndUsageRequest_Filter)

#endif // OAIGetCostAndUsageRequest_Filter_H
