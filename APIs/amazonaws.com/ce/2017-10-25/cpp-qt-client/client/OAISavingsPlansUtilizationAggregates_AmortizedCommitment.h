...
/*
 * OAISavingsPlansUtilizationAggregates_AmortizedCommitment.h
 *
 * 
 */

#ifndef OAISavingsPlansUtilizationAggregates_AmortizedCommitment_H
#define OAISavingsPlansUtilizationAggregates_AmortizedCommitment_H
...
class OAISavingsPlansUtilizationAggregates_AmortizedCommitment : public OAIObject {
public:
    OAISavingsPlansUtilizationAggregates_AmortizedCommitment();
    OAISavingsPlansUtilizationAggregates_AmortizedCommitment(QString json);
    ~OAISavingsPlansUtilizationAggregates_AmortizedCommitment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavingsPlansUtilizationAggregates_AmortizedCommitment)

#endif // OAISavingsPlansUtilizationAggregates_AmortizedCommitment_H
