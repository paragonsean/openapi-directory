...
/*
 * OAIGetSavingsPlansUtilizationDetailsRequest_Filter.h
 *
 * 
 */

#ifndef OAIGetSavingsPlansUtilizationDetailsRequest_Filter_H
#define OAIGetSavingsPlansUtilizationDetailsRequest_Filter_H
...
class OAIGetSavingsPlansUtilizationDetailsRequest_Filter : public OAIObject {
public:
    OAIGetSavingsPlansUtilizationDetailsRequest_Filter();
    OAIGetSavingsPlansUtilizationDetailsRequest_Filter(QString json);
    ~OAIGetSavingsPlansUtilizationDetailsRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSavingsPlansUtilizationDetailsRequest_Filter)

#endif // OAIGetSavingsPlansUtilizationDetailsRequest_Filter_H
