...
OAIAnomalyScore::OAIAnomalyScore(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnomalyScore::OAIAnomalyScore() {
    this->initializeModel();
}

OAIAnomalyScore::~OAIAnomalyScore() {}

void OAIAnomalyScore::initializeModel() {
...
void OAIAnomalyScore::fromJson(QString jsonString) {
...
void OAIAnomalyScore::fromJsonObject(QJsonObject json) {
...
QString OAIAnomalyScore::asJson() const {
...
QJsonObject OAIAnomalyScore::asJsonObject() const {
    QJsonObject obj;
...
double OAIAnomalyScore::getMaxScore() const {
    return m_max_score;
}
void OAIAnomalyScore::setMaxScore(const double &max_score) {
    m_max_score = max_score;
    m_max_score_isSet = true;
}

bool OAIAnomalyScore::is_max_score_Set() const{
    return m_max_score_isSet;
}

bool OAIAnomalyScore::is_max_score_Valid() const{
    return m_max_score_isValid;
}

double OAIAnomalyScore::getCurrentScore() const {
    return m_current_score;
}
void OAIAnomalyScore::setCurrentScore(const double &current_score) {
    m_current_score = current_score;
    m_current_score_isSet = true;
}

bool OAIAnomalyScore::is_current_score_Set() const{
    return m_current_score_isSet;
}

bool OAIAnomalyScore::is_current_score_Valid() const{
    return m_current_score_isValid;
}

bool OAIAnomalyScore::isSet() const {
...
bool OAIAnomalyScore::isValid() const {
