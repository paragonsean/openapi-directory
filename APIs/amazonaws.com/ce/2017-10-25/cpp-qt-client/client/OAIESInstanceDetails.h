...
class OAIESInstanceDetails : public OAIObject {
public:
    OAIESInstanceDetails();
    OAIESInstanceDetails(QString json);
    ~OAIESInstanceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIESInstanceDetails)

#endif // OAIESInstanceDetails_H
