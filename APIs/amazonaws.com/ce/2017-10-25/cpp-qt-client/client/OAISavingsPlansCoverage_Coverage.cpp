...
OAISavingsPlansCoverage_Coverage::OAISavingsPlansCoverage_Coverage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISavingsPlansCoverage_Coverage::OAISavingsPlansCoverage_Coverage() {
    this->initializeModel();
}

OAISavingsPlansCoverage_Coverage::~OAISavingsPlansCoverage_Coverage() {}

void OAISavingsPlansCoverage_Coverage::initializeModel() {
...
void OAISavingsPlansCoverage_Coverage::fromJson(QString jsonString) {
...
void OAISavingsPlansCoverage_Coverage::fromJsonObject(QJsonObject json) {
...
QString OAISavingsPlansCoverage_Coverage::asJson() const {
...
QJsonObject OAISavingsPlansCoverage_Coverage::asJsonObject() const {
    QJsonObject obj;
...
QString OAISavingsPlansCoverage_Coverage::getSpendCoveredBySavingsPlans() const {
    return m_spend_covered_by_savings_plans;
}
void OAISavingsPlansCoverage_Coverage::setSpendCoveredBySavingsPlans(const QString &spend_covered_by_savings_plans) {
    m_spend_covered_by_savings_plans = spend_covered_by_savings_plans;
    m_spend_covered_by_savings_plans_isSet = true;
}

bool OAISavingsPlansCoverage_Coverage::is_spend_covered_by_savings_plans_Set() const{
    return m_spend_covered_by_savings_plans_isSet;
}

bool OAISavingsPlansCoverage_Coverage::is_spend_covered_by_savings_plans_Valid() const{
    return m_spend_covered_by_savings_plans_isValid;
}

QString OAISavingsPlansCoverage_Coverage::getOnDemandCost() const {
    return m_on_demand_cost;
}
void OAISavingsPlansCoverage_Coverage::setOnDemandCost(const QString &on_demand_cost) {
    m_on_demand_cost = on_demand_cost;
    m_on_demand_cost_isSet = true;
}

bool OAISavingsPlansCoverage_Coverage::is_on_demand_cost_Set() const{
    return m_on_demand_cost_isSet;
}

bool OAISavingsPlansCoverage_Coverage::is_on_demand_cost_Valid() const{
    return m_on_demand_cost_isValid;
}

QString OAISavingsPlansCoverage_Coverage::getTotalCost() const {
    return m_total_cost;
}
void OAISavingsPlansCoverage_Coverage::setTotalCost(const QString &total_cost) {
    m_total_cost = total_cost;
    m_total_cost_isSet = true;
}

bool OAISavingsPlansCoverage_Coverage::is_total_cost_Set() const{
    return m_total_cost_isSet;
}

bool OAISavingsPlansCoverage_Coverage::is_total_cost_Valid() const{
    return m_total_cost_isValid;
}

QString OAISavingsPlansCoverage_Coverage::getCoveragePercentage() const {
    return m_coverage_percentage;
}
void OAISavingsPlansCoverage_Coverage::setCoveragePercentage(const QString &coverage_percentage) {
    m_coverage_percentage = coverage_percentage;
    m_coverage_percentage_isSet = true;
}

bool OAISavingsPlansCoverage_Coverage::is_coverage_percentage_Set() const{
    return m_coverage_percentage_isSet;
}

bool OAISavingsPlansCoverage_Coverage::is_coverage_percentage_Valid() const{
    return m_coverage_percentage_isValid;
}

bool OAISavingsPlansCoverage_Coverage::isSet() const {
...
bool OAISavingsPlansCoverage_Coverage::isValid() const {
