...
/*
 * OAIGetCostCategoriesRequest.h
 *
 * 
 */

#ifndef OAIGetCostCategoriesRequest_H
#define OAIGetCostCategoriesRequest_H
...
class OAIGetCostCategoriesRequest : public OAIObject {
public:
    OAIGetCostCategoriesRequest();
    OAIGetCostCategoriesRequest(QString json);
    ~OAIGetCostCategoriesRequest() override;
    ...
    QString getCostCategoryName() const;
    void setCostCategoryName(const QString &cost_category_name);
    bool is_cost_category_name_Set() const;
    bool is_cost_category_name_Valid() const;
...
private:
    ...
    QString m_cost_category_name;
    bool m_cost_category_name_isSet;
    bool m_cost_category_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCostCategoriesRequest)

#endif // OAIGetCostCategoriesRequest_H
