...
/*
 * OAIReservationPurchaseRecommendationMetadata.h
 *
...
#ifndef OAIReservationPurchaseRecommendationMetadata_H
#define OAIReservationPurchaseRecommendationMetadata_H
...
class OAIReservationPurchaseRecommendationMetadata : public OAIObject {
public:
    OAIReservationPurchaseRecommendationMetadata();
    OAIReservationPurchaseRecommendationMetadata(QString json);
    ~OAIReservationPurchaseRecommendationMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationPurchaseRecommendationMetadata)

#endif // OAIReservationPurchaseRecommendationMetadata_H
