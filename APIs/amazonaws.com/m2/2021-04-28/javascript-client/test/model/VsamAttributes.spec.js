...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.VsamAttributes();
  });
  ...
  describe('VsamAttributes', function() {
    it('should create an instance of VsamAttributes', function() {
      // uncomment below and update the code to test VsamAttributes
      //var instance = new AwsMainframeModernization.VsamAttributes();
      //expect(instance).to.be.a(AwsMainframeModernization.VsamAttributes);
    });
