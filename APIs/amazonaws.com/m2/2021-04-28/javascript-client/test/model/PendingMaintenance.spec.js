...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.PendingMaintenance();
  });
  ...
  describe('PendingMaintenance', function() {
    it('should create an instance of PendingMaintenance', function() {
      // uncomment below and update the code to test PendingMaintenance
      //var instance = new AwsMainframeModernization.PendingMaintenance();
      //expect(instance).to.be.a(AwsMainframeModernization.PendingMaintenance);
    });
