...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.GetApplicationResponseLatestVersion();
  });
  ...
  describe('GetApplicationResponseLatestVersion', function() {
    it('should create an instance of GetApplicationResponseLatestVersion', function() {
      // uncomment below and update the code to test GetApplicationResponseLatestVersion
      //var instance = new AwsMainframeModernization.GetApplicationResponseLatestVersion();
      //expect(instance).to.be.a(AwsMainframeModernization.GetApplicationResponseLatestVersion);
    });
