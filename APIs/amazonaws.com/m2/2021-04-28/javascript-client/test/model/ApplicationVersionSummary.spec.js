...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.ApplicationVersionSummary();
  });
  ...
  describe('ApplicationVersionSummary', function() {
    it('should create an instance of ApplicationVersionSummary', function() {
      // uncomment below and update the code to test ApplicationVersionSummary
      //var instance = new AwsMainframeModernization.ApplicationVersionSummary();
      //expect(instance).to.be.a(AwsMainframeModernization.ApplicationVersionSummary);
    });
