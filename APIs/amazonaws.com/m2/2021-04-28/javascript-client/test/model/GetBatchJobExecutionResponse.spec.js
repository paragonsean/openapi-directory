...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.GetBatchJobExecutionResponse();
  });
  ...
  describe('GetBatchJobExecutionResponse', function() {
    it('should create an instance of GetBatchJobExecutionResponse', function() {
      // uncomment below and update the code to test GetBatchJobExecutionResponse
      //var instance = new AwsMainframeModernization.GetBatchJobExecutionResponse();
      //expect(instance).to.be.a(AwsMainframeModernization.GetBatchJobExecutionResponse);
    });
    ...
    it('should have the property jobUser (base name: "jobUser")', function() {
      // uncomment below and update the code to test the property jobUser
      //var instance = new AwsMainframeModernization.GetBatchJobExecutionResponse();
      //expect(instance).to.be();
    });
