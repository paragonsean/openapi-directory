...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.GetDeploymentResponse();
  });
  ...
  describe('GetDeploymentResponse', function() {
    it('should create an instance of GetDeploymentResponse', function() {
      ...
      //var instance = new AwsMainframeModernization.GetDeploymentResponse();
      //expect(instance).to.be.a(AwsMainframeModernization.GetDeploymentResponse);
    });
