...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.EngineVersionsSummary();
  });
  ...
  describe('EngineVersionsSummary', function() {
    it('should create an instance of EngineVersionsSummary', function() {
      // uncomment below and update the code to test EngineVersionsSummary
      //var instance = new AwsMainframeModernization.EngineVersionsSummary();
      //expect(instance).to.be.a(AwsMainframeModernization.EngineVersionsSummary);
    });
