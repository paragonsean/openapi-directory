...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.DataSetImportSummary();
  });
  ...
  describe('DataSetImportSummary', function() {
    it('should create an instance of DataSetImportSummary', function() {
      // uncomment below and update the code to test DataSetImportSummary
      //var instance = new AwsMainframeModernization.DataSetImportSummary();
      //expect(instance).to.be.a(AwsMainframeModernization.DataSetImportSummary);
    });
