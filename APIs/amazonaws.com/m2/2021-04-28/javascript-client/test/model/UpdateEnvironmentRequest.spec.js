...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.UpdateEnvironmentRequest();
  });
  ...
  describe('UpdateEnvironmentRequest', function() {
    it('should create an instance of UpdateEnvironmentRequest', function() {
      ...
      //var instance = new AwsMainframeModernization.UpdateEnvironmentRequest();
      //expect(instance).to.be.a(AwsMainframeModernization.UpdateEnvironmentRequest);
    });

    it('should have the property applyDuringMaintenanceWindow (base name: "applyDuringMaintenanceWindow")', function() {
      // uncomment below and update the code to test the property applyDuringMaintenanceWindow
      //var instance = new AwsMainframeModernization.UpdateEnvironmentRequest();
