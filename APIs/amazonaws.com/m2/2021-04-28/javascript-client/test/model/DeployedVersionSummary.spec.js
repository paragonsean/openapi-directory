...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.DeployedVersionSummary();
  });
  ...
  describe('DeployedVersionSummary', function() {
    it('should create an instance of DeployedVersionSummary', function() {
      // uncomment below and update the code to test DeployedVersionSummary
      //var instance = new AwsMainframeModernization.DeployedVersionSummary();
      //expect(instance).to.be.a(AwsMainframeModernization.DeployedVersionSummary);
    });
