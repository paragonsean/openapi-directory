...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.GetDataSetImportTaskResponseSummary();
  });
  ...
  describe('GetDataSetImportTaskResponseSummary', function() {
    it('should create an instance of GetDataSetImportTaskResponseSummary', function() {
      // uncomment below and update the code to test GetDataSetImportTaskResponseSummary
      //var instance = new AwsMainframeModernization.GetDataSetImportTaskResponseSummary();
      //expect(instance).to.be.a(AwsMainframeModernization.GetDataSetImportTaskResponseSummary);
    });
