...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.RecordLength();
  });
  ...
  describe('RecordLength', function() {
    it('should create an instance of RecordLength', function() {
      // uncomment below and update the code to test RecordLength
      //var instance = new AwsMainframeModernization.RecordLength();
      //expect(instance).to.be.a(AwsMainframeModernization.RecordLength);
    });
