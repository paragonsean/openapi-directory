...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.CreateApplicationResponse();
  });
  ...
  describe('CreateApplicationResponse', function() {
    it('should create an instance of CreateApplicationResponse', function() {
      ...
      //var instance = new AwsMainframeModernization.CreateApplicationResponse();
      //expect(instance).to.be.a(AwsMainframeModernization.CreateApplicationResponse);
    });
