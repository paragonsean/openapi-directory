...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMainframeModernization.DataSet();
  });
  ...
  describe('DataSet', function() {
    it('should create an instance of DataSet', function() {
      ...
      //var instance = new AwsMainframeModernization.DataSet();
      //expect(instance).to.be.a(AwsMainframeModernization.DataSet);
    });
