...
public class VsamDetailAttributes {
  ...
  public VsamDetailAttributes alternateKeys(List alternateKeys) {
  ...
  public VsamDetailAttributes cacheAtStartup(Boolean cacheAtStartup) {
  ...
  public VsamDetailAttributes compressed(Boolean compressed) {
  ...
  public VsamDetailAttributes encoding(String encoding) {
  ...
  public VsamDetailAttributes primaryKey(VsamDetailAttributesPrimaryKey primaryKey) {
  ...
  public VsamDetailAttributes recordFormat(String recordFormat) {
  ...
  public boolean equals(Object o) {
    ...
    VsamDetailAttributes vsamDetailAttributes = (VsamDetailAttributes) o;
    return Objects.equals(this.alternateKeys, vsamDetailAttributes.alternateKeys) &&
        Objects.equals(this.cacheAtStartup, vsamDetailAttributes.cacheAtStartup) &&
        Objects.equals(this.compressed, vsamDetailAttributes.compressed) &&
        Objects.equals(this.encoding, vsamDetailAttributes.encoding) &&
        Objects.equals(this.primaryKey, vsamDetailAttributes.primaryKey) &&
        Objects.equals(this.recordFormat, vsamDetailAttributes.recordFormat);
  }
  ...
  public String toString() {
    ...
    sb.append("class VsamDetailAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VsamDetailAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VsamDetailAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VsamDetailAttributes is not found in the empty JSON string", VsamDetailAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VsamDetailAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VsamDetailAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VsamDetailAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VsamDetailAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VsamDetailAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VsamDetailAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<VsamDetailAttributes>() {
           @Override
           public void write(JsonWriter out, VsamDetailAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VsamDetailAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VsamDetailAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VsamDetailAttributes
   * @throws IOException if the JSON string is invalid with respect to VsamDetailAttributes
   */
  public static VsamDetailAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VsamDetailAttributes.class);
  }

  /**
   * Convert an instance of VsamDetailAttributes to an JSON string
   *
   * @return JSON string
   */
