...
|**engineType** | [**EngineTypeEnum**](#EngineTypeEnum) | The engine type for the runtime environment. |  |
...
|**securityGroupIds** | **List&lt;String&gt;** | The list of security groups for the VPC associated with this runtime environment. |  [optional] |
|**storageConfigurations** | [**List&lt;StorageConfiguration&gt;**](StorageConfiguration.md) | Optional. The storage configurations for this runtime environment. |  [optional] |
|**subnetIds** | **List&lt;String&gt;** | The list of subnets associated with the VPC for this runtime environment. |  [optional] |
|**tags** | **Map&lt;String, String&gt;** | The tags for the runtime environment. |  [optional] |
