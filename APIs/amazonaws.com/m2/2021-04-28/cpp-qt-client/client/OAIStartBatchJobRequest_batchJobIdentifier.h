...
/*
 * OAIStartBatchJobRequest_batchJobIdentifier.h
 *
 * 
 */

#ifndef OAIStartBatchJobRequest_batchJobIdentifier_H
#define OAIStartBatchJobRequest_batchJobIdentifier_H
...
class OAIStartBatchJobRequest_batchJobIdentifier : public OAIObject {
public:
    OAIStartBatchJobRequest_batchJobIdentifier();
    OAIStartBatchJobRequest_batchJobIdentifier(QString json);
    ~OAIStartBatchJobRequest_batchJobIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartBatchJobRequest_batchJobIdentifier)

#endif // OAIStartBatchJobRequest_batchJobIdentifier_H
