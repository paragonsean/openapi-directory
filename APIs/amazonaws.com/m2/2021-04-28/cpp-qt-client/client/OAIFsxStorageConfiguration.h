...
/*
 * OAIFsxStorageConfiguration.h
 *
 * Defines the storage configuration for an Amazon FSx file system.
 */

#ifndef OAIFsxStorageConfiguration_H
#define OAIFsxStorageConfiguration_H
...
class OAIFsxStorageConfiguration : public OAIObject {
public:
    OAIFsxStorageConfiguration();
    OAIFsxStorageConfiguration(QString json);
    ~OAIFsxStorageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFsxStorageConfiguration)

#endif // OAIFsxStorageConfiguration_H
