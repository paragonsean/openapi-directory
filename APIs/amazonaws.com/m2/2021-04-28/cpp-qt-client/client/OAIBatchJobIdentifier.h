...
/*
 * OAIBatchJobIdentifier.h
 *
 * Identifies a specific batch job.
 */

#ifndef OAIBatchJobIdentifier_H
#define OAIBatchJobIdentifier_H
...
class OAIBatchJobIdentifier : public OAIObject {
public:
    OAIBatchJobIdentifier();
    OAIBatchJobIdentifier(QString json);
    ~OAIBatchJobIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchJobIdentifier)

#endif // OAIBatchJobIdentifier_H
