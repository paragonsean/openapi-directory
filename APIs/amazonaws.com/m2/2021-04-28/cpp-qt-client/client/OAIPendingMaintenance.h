...
/*
 * OAIPendingMaintenance.h
 *
 * The scheduled maintenance for a runtime engine.
 */

#ifndef OAIPendingMaintenance_H
#define OAIPendingMaintenance_H
...
class OAIPendingMaintenance : public OAIObject {
public:
    OAIPendingMaintenance();
    OAIPendingMaintenance(QString json);
    ~OAIPendingMaintenance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPendingMaintenance)

#endif // OAIPendingMaintenance_H
