...
/*
 * OAIGetDataSetImportTaskResponse_summary.h
 *
 * 
 */

#ifndef OAIGetDataSetImportTaskResponse_summary_H
#define OAIGetDataSetImportTaskResponse_summary_H
...
class OAIGetDataSetImportTaskResponse_summary : public OAIObject {
public:
    OAIGetDataSetImportTaskResponse_summary();
    OAIGetDataSetImportTaskResponse_summary(QString json);
    ~OAIGetDataSetImportTaskResponse_summary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataSetImportTaskResponse_summary)

#endif // OAIGetDataSetImportTaskResponse_summary_H
