...
/*
 * OAIDataSetImportSummary.h
 *
 * Represents a summary of data set imports.
 */

#ifndef OAIDataSetImportSummary_H
#define OAIDataSetImportSummary_H
...
class OAIDataSetImportSummary : public OAIObject {
public:
    OAIDataSetImportSummary();
    OAIDataSetImportSummary(QString json);
    ~OAIDataSetImportSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSetImportSummary)

#endif // OAIDataSetImportSummary_H
