...
class OAIDataSetImportConfig : public OAIObject {
public:
    OAIDataSetImportConfig();
    OAIDataSetImportConfig(QString json);
    ~OAIDataSetImportConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSetImportConfig)

#endif // OAIDataSetImportConfig_H
