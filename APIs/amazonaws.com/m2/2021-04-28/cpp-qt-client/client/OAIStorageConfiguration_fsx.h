...
/*
 * OAIStorageConfiguration_fsx.h
 *
 * 
 */

#ifndef OAIStorageConfiguration_fsx_H
#define OAIStorageConfiguration_fsx_H
...
class OAIStorageConfiguration_fsx : public OAIObject {
public:
    OAIStorageConfiguration_fsx();
    OAIStorageConfiguration_fsx(QString json);
    ~OAIStorageConfiguration_fsx() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStorageConfiguration_fsx)

#endif // OAIStorageConfiguration_fsx_H
