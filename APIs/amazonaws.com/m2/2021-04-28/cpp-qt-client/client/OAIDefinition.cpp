...
QString OAIDefinition::getContent() const {
    return m_content;
}
void OAIDefinition::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIDefinition::is_content_Set() const{
    return m_content_isSet;
}

bool OAIDefinition::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIDefinition::getS3Location() const {
    return m_s3_location;
}
void OAIDefinition::setS3Location(const QString &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAIDefinition::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAIDefinition::is_s3_location_Valid() const{
