...
/*
 * OAIStartBatchJob_request_batchJobIdentifier.h
 *
 * Identifies a specific batch job.
 */

#ifndef OAIStartBatchJob_request_batchJobIdentifier_H
#define OAIStartBatchJob_request_batchJobIdentifier_H
...
class OAIStartBatchJob_request_batchJobIdentifier : public OAIObject {
public:
    OAIStartBatchJob_request_batchJobIdentifier();
    OAIStartBatchJob_request_batchJobIdentifier(QString json);
    ~OAIStartBatchJob_request_batchJobIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartBatchJob_request_batchJobIdentifier)

#endif // OAIStartBatchJob_request_batchJobIdentifier_H
