...
/*
 * OAIEfsStorageConfiguration.h
 *
 * Defines the storage configuration for an Amazon EFS file system.
 */

#ifndef OAIEfsStorageConfiguration_H
#define OAIEfsStorageConfiguration_H
...
class OAIEfsStorageConfiguration : public OAIObject {
public:
    OAIEfsStorageConfiguration();
    OAIEfsStorageConfiguration(QString json);
    ~OAIEfsStorageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEfsStorageConfiguration)

#endif // OAIEfsStorageConfiguration_H
