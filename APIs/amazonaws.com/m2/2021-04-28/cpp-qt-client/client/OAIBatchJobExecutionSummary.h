...
/*
 * OAIBatchJobExecutionSummary.h
 *
 * A subset of the possible batch job attributes. Used in the batch job list.
 */

#ifndef OAIBatchJobExecutionSummary_H
#define OAIBatchJobExecutionSummary_H
...
class OAIBatchJobExecutionSummary : public OAIObject {
public:
    OAIBatchJobExecutionSummary();
    OAIBatchJobExecutionSummary(QString json);
    ~OAIBatchJobExecutionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchJobExecutionSummary)

#endif // OAIBatchJobExecutionSummary_H
