...
/*
 * OAIGetApplicationResponse_latestVersion.h
 *
 * 
 */

#ifndef OAIGetApplicationResponse_latestVersion_H
#define OAIGetApplicationResponse_latestVersion_H
...
class OAIGetApplicationResponse_latestVersion : public OAIObject {
public:
    OAIGetApplicationResponse_latestVersion();
    OAIGetApplicationResponse_latestVersion(QString json);
    ~OAIGetApplicationResponse_latestVersion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetApplicationResponse_latestVersion)

#endif // OAIGetApplicationResponse_latestVersion_H
