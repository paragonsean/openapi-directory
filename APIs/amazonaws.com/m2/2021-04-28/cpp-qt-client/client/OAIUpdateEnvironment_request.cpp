...
bool OAIUpdateEnvironment_request::isApplyDuringMaintenanceWindow() const {
    return m_apply_during_maintenance_window;
}
void OAIUpdateEnvironment_request::setApplyDuringMaintenanceWindow(const bool &apply_during_maintenance_window) {
    m_apply_during_maintenance_window = apply_during_maintenance_window;
    m_apply_during_maintenance_window_isSet = true;
}

bool OAIUpdateEnvironment_request::is_apply_during_maintenance_window_Set() const{
    return m_apply_during_maintenance_window_isSet;
}

bool OAIUpdateEnvironment_request::is_apply_during_maintenance_window_Valid() const{
    return m_apply_during_maintenance_window_isValid;
}

qint32 OAIUpdateEnvironment_request::getDesiredCapacity() const {
    return m_desired_capacity;
}
void OAIUpdateEnvironment_request::setDesiredCapacity(const qint32 &desired_capacity) {
    m_desired_capacity = desired_capacity;
    m_desired_capacity_isSet = true;
}

bool OAIUpdateEnvironment_request::is_desired_capacity_Set() const{
    return m_desired_capacity_isSet;
}

bool OAIUpdateEnvironment_request::is_desired_capacity_Valid() const{
    return m_desired_capacity_isValid;
}

QString OAIUpdateEnvironment_request::getEngineVersion() const {
    return m_engine_version;
}
void OAIUpdateEnvironment_request::setEngineVersion(const QString &engine_version) {
    m_engine_version = engine_version;
    m_engine_version_isSet = true;
}

bool OAIUpdateEnvironment_request::is_engine_version_Set() const{
    return m_engine_version_isSet;
}

bool OAIUpdateEnvironment_request::is_engine_version_Valid() const{
    return m_engine_version_isValid;
}

QString OAIUpdateEnvironment_request::getInstanceType() const {
    return m_instance_type;
}
void OAIUpdateEnvironment_request::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIUpdateEnvironment_request::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIUpdateEnvironment_request::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

QString OAIUpdateEnvironment_request::getPreferredMaintenanceWindow() const {
    return m_preferred_maintenance_window;
}
void OAIUpdateEnvironment_request::setPreferredMaintenanceWindow(const QString &preferred_maintenance_window) {
    m_preferred_maintenance_window = preferred_maintenance_window;
    m_preferred_maintenance_window_isSet = true;
}

bool OAIUpdateEnvironment_request::is_preferred_maintenance_window_Set() const{
    return m_preferred_maintenance_window_isSet;
}

bool OAIUpdateEnvironment_request::is_preferred_maintenance_window_Valid() const{
