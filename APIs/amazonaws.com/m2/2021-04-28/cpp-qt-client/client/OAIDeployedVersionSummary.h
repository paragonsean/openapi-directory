...
/*
 * OAIDeployedVersionSummary.h
 *
 * Contains a summary of a deployed application.
 */

#ifndef OAIDeployedVersionSummary_H
#define OAIDeployedVersionSummary_H
...
class OAIDeployedVersionSummary : public OAIObject {
public:
    OAIDeployedVersionSummary();
    OAIDeployedVersionSummary(QString json);
    ~OAIDeployedVersionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedVersionSummary)

#endif // OAIDeployedVersionSummary_H
