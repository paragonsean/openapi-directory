...
/*
 * OAIDataSetImportItem_dataSet.h
 *
 * 
 */

#ifndef OAIDataSetImportItem_dataSet_H
#define OAIDataSetImportItem_dataSet_H
...
class OAIDataSetImportItem_dataSet : public OAIObject {
public:
    OAIDataSetImportItem_dataSet();
    OAIDataSetImportItem_dataSet(QString json);
    ~OAIDataSetImportItem_dataSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSetImportItem_dataSet)

#endif // OAIDataSetImportItem_dataSet_H
