...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::cancelBatchJobExecutionSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::cancelBatchJobExecutionSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString application_id = create(); // QString | The unique identifier of the application.
      ...
      QString execution_id = create(); // QString | The unique identifier of the batch job execution.
      ...
      apiInstance.cancelBatchJobExecution(application_idexecution_idx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
