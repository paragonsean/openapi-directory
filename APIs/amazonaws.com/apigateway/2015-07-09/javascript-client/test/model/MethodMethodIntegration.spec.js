...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGateway.MethodMethodIntegration();
  });
  ...
  describe('MethodMethodIntegration', function() {
    it('should create an instance of MethodMethodIntegration', function() {
      // uncomment below and update the code to test MethodMethodIntegration
      //var instance = new AmazonApiGateway.MethodMethodIntegration();
      //expect(instance).to.be.a(AmazonApiGateway.MethodMethodIntegration);
    });
