...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGateway.UsagePlan();
  });
  ...
  describe('UsagePlan', function() {
    it('should create an instance of UsagePlan', function() {
      // uncomment below and update the code to test UsagePlan
      //var instance = new AmazonApiGateway.UsagePlan();
      //expect(instance).to.be.a(AmazonApiGateway.UsagePlan);
    });
