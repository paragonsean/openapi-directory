...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGateway.MethodSnapshot();
  });
  ...
  describe('MethodSnapshot', function() {
    it('should create an instance of MethodSnapshot', function() {
      // uncomment below and update the code to test MethodSnapshot
      //var instance = new AmazonApiGateway.MethodSnapshot();
      //expect(instance).to.be.a(AmazonApiGateway.MethodSnapshot);
    });
