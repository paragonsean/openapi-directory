...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGateway.RestApi();
  });
  ...
  describe('RestApi', function() {
    it('should create an instance of RestApi', function() {
      // uncomment below and update the code to test RestApi
      //var instance = new AmazonApiGateway.RestApi();
      //expect(instance).to.be.a(AmazonApiGateway.RestApi);
    });
