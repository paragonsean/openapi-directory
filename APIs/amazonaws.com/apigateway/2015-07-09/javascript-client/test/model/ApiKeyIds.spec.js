...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGateway.ApiKeyIds();
  });
  ...
  describe('ApiKeyIds', function() {
    it('should create an instance of ApiKeyIds', function() {
      // uncomment below and update the code to test ApiKeyIds
      //var instance = new AmazonApiGateway.ApiKeyIds();
      //expect(instance).to.be.a(AmazonApiGateway.ApiKeyIds);
    });
