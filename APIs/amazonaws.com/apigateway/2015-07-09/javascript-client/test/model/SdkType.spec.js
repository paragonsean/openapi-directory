...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGateway.SdkType();
  });
  ...
  describe('SdkType', function() {
    it('should create an instance of SdkType', function() {
      // uncomment below and update the code to test SdkType
      //var instance = new AmazonApiGateway.SdkType();
      //expect(instance).to.be.a(AmazonApiGateway.SdkType);
    });
