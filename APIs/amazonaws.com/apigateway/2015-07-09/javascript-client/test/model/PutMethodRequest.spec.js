...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGateway.PutMethodRequest();
  });
  ...
  describe('PutMethodRequest', function() {
    it('should create an instance of PutMethodRequest', function() {
      // uncomment below and update the code to test PutMethodRequest
      //var instance = new AmazonApiGateway.PutMethodRequest();
      //expect(instance).to.be.a(AmazonApiGateway.PutMethodRequest);
    });
