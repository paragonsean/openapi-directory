# AmazonApiGateway.CreateVpcLinkRequest
...
**targetArns** | **[String]** | The ARN of the network load balancer of the VPC targeted by the VPC link. The network load balancer must be owned by the same AWS account of the API owner. | 
