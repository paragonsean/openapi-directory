...
public class Integration {
  ...
  public Integration httpMethod(String httpMethod) {
  ...
  public Integration credentials(String credentials) {
  ...
  public Integration passthroughBehavior(String passthroughBehavior) {
  ...
  public Integration contentHandling(ContentHandlingStrategy contentHandling) {
  ...
  public Integration cacheNamespace(String cacheNamespace) {
  ...
  public Integration cacheKeyParameters(List cacheKeyParameters) {
  ...
  public Integration integrationResponses(Map integrationResponses) {
  ...
  public Integration tlsConfig(IntegrationTlsConfig tlsConfig) {
