...
public class CanarySettings {
  ...
  public CanarySettings() {
  }

  public CanarySettings percentTraffic(Double percentTraffic) {
  ...
  public CanarySettings deploymentId(String deploymentId) {
  ...
  public CanarySettings stageVariableOverrides(Map stageVariableOverrides) {
  ...
  public CanarySettings useStageCache(Boolean useStageCache) {
  ...
  public boolean equals(Object o) {
    ...
    CanarySettings canarySettings = (CanarySettings) o;
    return Objects.equals(this.percentTraffic, canarySettings.percentTraffic) &&
        Objects.equals(this.deploymentId, canarySettings.deploymentId) &&
        Objects.equals(this.stageVariableOverrides, canarySettings.stageVariableOverrides) &&
        Objects.equals(this.useStageCache, canarySettings.useStageCache);
  }
  ...
  public String toString() {
    ...
    sb.append("class CanarySettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CanarySettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CanarySettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CanarySettings is not found in the empty JSON string", CanarySettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CanarySettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CanarySettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CanarySettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CanarySettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CanarySettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CanarySettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CanarySettings>() {
           @Override
           public void write(JsonWriter out, CanarySettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CanarySettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CanarySettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CanarySettings
   * @throws IOException if the JSON string is invalid with respect to CanarySettings
   */
  public static CanarySettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CanarySettings.class);
  }

  /**
   * Convert an instance of CanarySettings to an JSON string
   *
   * @return JSON string
   */
