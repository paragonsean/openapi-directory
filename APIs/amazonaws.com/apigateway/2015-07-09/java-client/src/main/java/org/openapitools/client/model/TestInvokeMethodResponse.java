...
public class TestInvokeMethodResponse {
  ...
  public TestInvokeMethodResponse status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public TestInvokeMethodResponse body(String body) {
    this.body = body;
    return this;
  }
  ...
  public TestInvokeMethodResponse headers(Map headers) {
  ...
  public TestInvokeMethodResponse multiValueHeaders(Map multiValueHeaders) {
  ...
  public TestInvokeMethodResponse log(String log) {
    this.log = log;
    return this;
  }
  ...
  public TestInvokeMethodResponse latency(Integer latency) {
