...
public class ApiKey {
  ...
  public ApiKey customerId(String customerId) {
  ...
  public ApiKey lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public ApiKey stageKeys(List stageKeys) {
  ...
  public void setStageKeys(List stageKeys) {
    this.stageKeys = stageKeys;
  }


  public ApiKey tags(Map tags) {
    this.tags = tags;
    return this;
  }
