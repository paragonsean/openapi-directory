...
public class PutMethodRequest {
  ...
  public PutMethodRequest authorizationType(String authorizationType) {
  ...
  public PutMethodRequest authorizerId(String authorizerId) {
  ...
  public PutMethodRequest apiKeyRequired(Boolean apiKeyRequired) {
  ...
  public PutMethodRequest operationName(String operationName) {
  ...
  public PutMethodRequest requestParameters(Map<String, Boolean> requestParameters) {
  ...
  public PutMethodRequest requestModels(Map<String, String> requestModels) {
  ...
  public PutMethodRequest requestValidatorId(String requestValidatorId) {
  ...
  public PutMethodRequest authorizationScopes(List<String> authorizationScopes) {
