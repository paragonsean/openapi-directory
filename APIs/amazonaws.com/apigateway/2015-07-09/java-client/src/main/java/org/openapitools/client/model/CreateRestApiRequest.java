...
public class CreateRestApiRequest {
  ...
  public CreateRestApiRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateRestApiRequest description(String description) {
  ...
  public CreateRestApiRequest version(String version) {
  ...
  public CreateRestApiRequest cloneFrom(String cloneFrom) {
  ...
  public CreateRestApiRequest binaryMediaTypes(List<String> binaryMediaTypes) {
  ...
  public CreateRestApiRequest minimumCompressionSize(Integer minimumCompressionSize) {
  ...
  public CreateRestApiRequest apiKeySource(ApiKeySourceEnum apiKeySource) {
  ...
  public void setApiKeySource(ApiKeySourceEnum apiKeySource) {
    this.apiKeySource = apiKeySource;
  }


  public CreateRestApiRequest endpointConfiguration(CreateDomainNameRequestEndpointConfiguration endpointConfiguration) {
  ...
  public CreateRestApiRequest policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public CreateRestApiRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateRestApiRequest disableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
