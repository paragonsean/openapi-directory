...
public class MethodMethodIntegration {
  ...
  public MethodMethodIntegration() {
  }

  public MethodMethodIntegration type(IntegrationType type) {
    this.type = type;
    return this;
  }
  ...
  public MethodMethodIntegration httpMethod(String httpMethod) {
  ...
  public MethodMethodIntegration uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public MethodMethodIntegration connectionType(ConnectionType connectionType) {
  ...
  public MethodMethodIntegration connectionId(String connectionId) {
  ...
  public MethodMethodIntegration credentials(String credentials) {
  ...
  public MethodMethodIntegration requestParameters(Map requestParameters) {
  ...
  public MethodMethodIntegration requestTemplates(Map requestTemplates) {
  ...
  public MethodMethodIntegration passthroughBehavior(String passthroughBehavior) {
  ...
  public MethodMethodIntegration contentHandling(ContentHandlingStrategy contentHandling) {
  ...
  public MethodMethodIntegration timeoutInMillis(Integer timeoutInMillis) {
  ...
  public MethodMethodIntegration cacheNamespace(String cacheNamespace) {
  ...
  public MethodMethodIntegration cacheKeyParameters(List cacheKeyParameters) {
  ...
  public void setCacheKeyParameters(List cacheKeyParameters) {
    this.cacheKeyParameters = cacheKeyParameters;
  }


  public MethodMethodIntegration integrationResponses(Map integrationResponses) {
  ...
  public void setIntegrationResponses(Map integrationResponses) {
    this.integrationResponses = integrationResponses;
  }


  public MethodMethodIntegration tlsConfig(IntegrationTlsConfig tlsConfig) {
  ...
  public void setTlsConfig(IntegrationTlsConfig tlsConfig) {
    this.tlsConfig = tlsConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    MethodMethodIntegration methodMethodIntegration = (MethodMethodIntegration) o;
    return Objects.equals(this.type, methodMethodIntegration.type) &&
        Objects.equals(this.httpMethod, methodMethodIntegration.httpMethod) &&
        Objects.equals(this.uri, methodMethodIntegration.uri) &&
        Objects.equals(this.connectionType, methodMethodIntegration.connectionType) &&
        Objects.equals(this.connectionId, methodMethodIntegration.connectionId) &&
        Objects.equals(this.credentials, methodMethodIntegration.credentials) &&
        Objects.equals(this.requestParameters, methodMethodIntegration.requestParameters) &&
        Objects.equals(this.requestTemplates, methodMethodIntegration.requestTemplates) &&
        Objects.equals(this.passthroughBehavior, methodMethodIntegration.passthroughBehavior) &&
        Objects.equals(this.contentHandling, methodMethodIntegration.contentHandling) &&
        Objects.equals(this.timeoutInMillis, methodMethodIntegration.timeoutInMillis) &&
        Objects.equals(this.cacheNamespace, methodMethodIntegration.cacheNamespace) &&
        Objects.equals(this.cacheKeyParameters, methodMethodIntegration.cacheKeyParameters) &&
        Objects.equals(this.integrationResponses, methodMethodIntegration.integrationResponses) &&
        Objects.equals(this.tlsConfig, methodMethodIntegration.tlsConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class MethodMethodIntegration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MethodMethodIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MethodMethodIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MethodMethodIntegration is not found in the empty JSON string", MethodMethodIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MethodMethodIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MethodMethodIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MethodMethodIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MethodMethodIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MethodMethodIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MethodMethodIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<MethodMethodIntegration>() {
           @Override
           public void write(JsonWriter out, MethodMethodIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MethodMethodIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MethodMethodIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MethodMethodIntegration
   * @throws IOException if the JSON string is invalid with respect to MethodMethodIntegration
   */
  public static MethodMethodIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MethodMethodIntegration.class);
  }

  /**
   * Convert an instance of MethodMethodIntegration to an JSON string
   *
   * @return JSON string
   */
