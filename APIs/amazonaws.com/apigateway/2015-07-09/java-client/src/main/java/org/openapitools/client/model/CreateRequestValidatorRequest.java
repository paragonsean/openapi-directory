...
public class CreateRequestValidatorRequest {
  ...
  public CreateRequestValidatorRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateRequestValidatorRequest validateRequestBody(Boolean validateRequestBody) {
  ...
  public CreateRequestValidatorRequest validateRequestParameters(Boolean validateRequestParameters) {
