...
public class TestInvokeAuthorizerResponse {
  ...
  public TestInvokeAuthorizerResponse clientStatus(Integer clientStatus) {
  ...
  public TestInvokeAuthorizerResponse log(String log) {
    this.log = log;
    return this;
  }
  ...
  public TestInvokeAuthorizerResponse latency(Integer latency) {
  ...
  public TestInvokeAuthorizerResponse principalId(String principalId) {
  ...
  public TestInvokeAuthorizerResponse policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public TestInvokeAuthorizerResponse authorization(Map authorization) {
  ...
  public TestInvokeAuthorizerResponse claims(Map claims) {
    this.claims = claims;
    return this;
  }
