...
public class VpcLink {
  ...
  public VpcLink description(String description) {
  ...
  public VpcLink targetArns(List targetArns) {
  ...
  public void setTargetArns(List targetArns) {
    this.targetArns = targetArns;
  }


  public VpcLink status(VpcLinkStatus status) {
    this.status = status;
    return this;
  }
  ...
  public VpcLink statusMessage(String statusMessage) {
