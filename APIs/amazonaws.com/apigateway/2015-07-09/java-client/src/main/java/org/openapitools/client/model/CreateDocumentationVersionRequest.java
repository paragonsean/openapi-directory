...
public class CreateDocumentationVersionRequest {
  ...
  public CreateDocumentationVersionRequest documentationVersion(String documentationVersion) {
  ...
  public CreateDocumentationVersionRequest stageName(String stageName) {
  ...
  public CreateDocumentationVersionRequest description(String description) {
