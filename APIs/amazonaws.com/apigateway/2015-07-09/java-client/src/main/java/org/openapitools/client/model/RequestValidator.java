...
public class RequestValidator {
  ...
  public RequestValidator id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RequestValidator name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RequestValidator validateRequestBody(Boolean validateRequestBody) {
  ...
  public RequestValidator validateRequestParameters(Boolean validateRequestParameters) {
