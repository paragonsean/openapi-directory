...
public class SdkConfigurationProperty {
  ...
  public SdkConfigurationProperty name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SdkConfigurationProperty friendlyName(String friendlyName) {
  ...
  public SdkConfigurationProperty description(String description) {
  ...
  public SdkConfigurationProperty required(Boolean required) {
  ...
  public SdkConfigurationProperty defaultValue(String defaultValue) {
