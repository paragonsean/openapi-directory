...
public class CreateDocumentationPartRequestLocation {
  ...
  public CreateDocumentationPartRequestLocation type(DocumentationPartType type) {
    this.type = type;
    return this;
  }
  ...
  public CreateDocumentationPartRequestLocation path(String path) {
    this.path = path;
    return this;
  }
  ...
  public CreateDocumentationPartRequestLocation method(String method) {
    this.method = method;
    return this;
  }
  ...
  public CreateDocumentationPartRequestLocation statusCode(String statusCode) {
  ...
  public CreateDocumentationPartRequestLocation name(String name) {
    this.name = name;
    return this;
  }
