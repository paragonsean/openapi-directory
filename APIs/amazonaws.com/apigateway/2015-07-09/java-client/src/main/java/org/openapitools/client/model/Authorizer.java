...
public class Authorizer {
  ...
  public Authorizer id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Authorizer type(AuthorizerType type) {
    this.type = type;
    return this;
  }
  ...
  public Authorizer providerARNs(List providerARNs) {
  ...
  public void setProviderARNs(List providerARNs) {
    this.providerARNs = providerARNs;
  }


  public Authorizer authType(String authType) {
  ...
  public Authorizer authorizerCredentials(String authorizerCredentials) {
  ...
  public Authorizer identitySource(String identitySource) {
