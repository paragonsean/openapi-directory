...
public class PutIntegrationResponseRequest {
  ...
  public PutIntegrationResponseRequest selectionPattern(String selectionPattern) {
  ...
  public PutIntegrationResponseRequest responseParameters(Map<String, String> responseParameters) {
  ...
  public PutIntegrationResponseRequest responseTemplates(Map<String, String> responseTemplates) {
  ...
  public PutIntegrationResponseRequest contentHandling(ContentHandlingEnum contentHandling) {
  ...
  public void setContentHandling(ContentHandlingEnum contentHandling) {
    this.contentHandling = contentHandling;
  }
