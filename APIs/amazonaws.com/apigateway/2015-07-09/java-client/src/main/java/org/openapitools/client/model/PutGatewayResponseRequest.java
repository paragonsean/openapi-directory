...
public class PutGatewayResponseRequest {
  ...
  public PutGatewayResponseRequest statusCode(String statusCode) {
  ...
  public PutGatewayResponseRequest responseParameters(Map<String, String> responseParameters) {
  ...
  public PutGatewayResponseRequest responseTemplates(Map<String, String> responseTemplates) {
