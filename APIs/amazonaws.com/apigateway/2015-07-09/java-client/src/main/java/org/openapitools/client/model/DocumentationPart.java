...
public class DocumentationPart {
  ...
  public DocumentationPart id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DocumentationPart location(DocumentationPartLocation location) {
  ...
  public DocumentationPart properties(Object properties) {
