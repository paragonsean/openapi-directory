...
public class PutMethodResponseRequest {
  ...
  public PutMethodResponseRequest responseParameters(Map<String, Boolean> responseParameters) {
  ...
  public PutMethodResponseRequest responseModels(Map<String, String> responseModels) {
