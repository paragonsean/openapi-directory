...
public class GatewayResponse {
  ...
  public GatewayResponse responseType(GatewayResponseType responseType) {
  ...
  public GatewayResponse statusCode(String statusCode) {
  ...
  public GatewayResponse responseParameters(Map responseParameters) {
  ...
  public GatewayResponse responseTemplates(Map responseTemplates) {
  ...
  public GatewayResponse defaultResponse(Boolean defaultResponse) {
