...
public class PutIntegrationRequest {
  ...
  public PutIntegrationRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public PutIntegrationRequest httpMethod(String httpMethod) {
  ...
  public PutIntegrationRequest connectionType(ConnectionTypeEnum connectionType) {
  ...
  public PutIntegrationRequest connectionId(String connectionId) {
  ...
  public PutIntegrationRequest credentials(String credentials) {
  ...
  public PutIntegrationRequest requestParameters(Map<String, String> requestParameters) {
  ...
  public PutIntegrationRequest requestTemplates(Map<String, String> requestTemplates) {
  ...
  public PutIntegrationRequest passthroughBehavior(String passthroughBehavior) {
  ...
  public PutIntegrationRequest cacheNamespace(String cacheNamespace) {
  ...
  public PutIntegrationRequest cacheKeyParameters(List<String> cacheKeyParameters) {
  ...
  public PutIntegrationRequest contentHandling(ContentHandlingEnum contentHandling) {
  ...
  public PutIntegrationRequest timeoutInMillis(Integer timeoutInMillis) {
  ...
  public PutIntegrationRequest tlsConfig(PutIntegrationRequestTlsConfig tlsConfig) {
  ...
  public void setTlsConfig(PutIntegrationRequestTlsConfig tlsConfig) {
    this.tlsConfig = tlsConfig;
  }
