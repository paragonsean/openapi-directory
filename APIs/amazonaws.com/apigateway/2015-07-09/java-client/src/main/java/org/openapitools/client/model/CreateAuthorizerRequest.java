...
public class CreateAuthorizerRequest {
  ...
  public CreateAuthorizerRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CreateAuthorizerRequest providerARNs(List<String> providerARNs) {
  ...
  public void setProviderARNs(List<String> providerARNs) {
    this.providerARNs = providerARNs;
  }


  public CreateAuthorizerRequest authType(String authType) {
  ...
  public CreateAuthorizerRequest authorizerCredentials(String authorizerCredentials) {
  ...
  public CreateAuthorizerRequest identitySource(String identitySource) {
