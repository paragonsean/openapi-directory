...
public class RestApi {
  ...
  public RestApi description(String description) {
  ...
  public RestApi createdDate(OffsetDateTime createdDate) {
  ...
  public RestApi version(String version) {
  ...
  public RestApi warnings(List warnings) {
  ...
  public RestApi binaryMediaTypes(List binaryMediaTypes) {
  ...
  public RestApi minimumCompressionSize(Integer minimumCompressionSize) {
  ...
  public RestApi apiKeySource(ApiKeySourceType apiKeySource) {
  ...
  public RestApi endpointConfiguration(RestApiEndpointConfiguration endpointConfiguration) {
  ...
  public void setEndpointConfiguration(RestApiEndpointConfiguration endpointConfiguration) {
    this.endpointConfiguration = endpointConfiguration;
  }


  public RestApi policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public RestApi disableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
