...
class Example : public QObject {
    Q_OBJECT
    OAICreateApiKey_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateApiKey_request Example::create(){
    OAICreateApiKey_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createApiKeySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createApiKeySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateApiKey_request oai_create_api_key_request = create(); // OAICreateApiKey_request | 
      ...
      apiInstance.createApiKey(oai_create_api_key_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
