...
QList OAIUpdateIntegrationRequest::getPatchOperations() const {
    return m_patch_operations;
}
void OAIUpdateIntegrationRequest::setPatchOperations(const QList &patch_operations) {
    m_patch_operations = patch_operations;
    m_patch_operations_isSet = true;
}

bool OAIUpdateIntegrationRequest::is_patch_operations_Set() const{
    return m_patch_operations_isSet;
}

bool OAIUpdateIntegrationRequest::is_patch_operations_Valid() const{
