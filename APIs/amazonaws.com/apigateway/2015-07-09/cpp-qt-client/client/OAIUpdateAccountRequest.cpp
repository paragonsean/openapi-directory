...
QList OAIUpdateAccountRequest::getPatchOperations() const {
    return m_patch_operations;
}
void OAIUpdateAccountRequest::setPatchOperations(const QList &patch_operations) {
    m_patch_operations = patch_operations;
    m_patch_operations_isSet = true;
}

bool OAIUpdateAccountRequest::is_patch_operations_Set() const{
    return m_patch_operations_isSet;
}

bool OAIUpdateAccountRequest::is_patch_operations_Valid() const{
