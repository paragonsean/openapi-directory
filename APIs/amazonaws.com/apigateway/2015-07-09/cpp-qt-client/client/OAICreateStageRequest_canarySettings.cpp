...
OAICreateStageRequest_canarySettings::OAICreateStageRequest_canarySettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStageRequest_canarySettings::OAICreateStageRequest_canarySettings() {
    this->initializeModel();
}

OAICreateStageRequest_canarySettings::~OAICreateStageRequest_canarySettings() {}

void OAICreateStageRequest_canarySettings::initializeModel() {
...
void OAICreateStageRequest_canarySettings::fromJson(QString jsonString) {
...
void OAICreateStageRequest_canarySettings::fromJsonObject(QJsonObject json) {
...
QString OAICreateStageRequest_canarySettings::asJson() const {
...
QJsonObject OAICreateStageRequest_canarySettings::asJsonObject() const {
    QJsonObject obj;
...
double OAICreateStageRequest_canarySettings::getPercentTraffic() const {
    return m_percent_traffic;
}
void OAICreateStageRequest_canarySettings::setPercentTraffic(const double &percent_traffic) {
    m_percent_traffic = percent_traffic;
    m_percent_traffic_isSet = true;
}

bool OAICreateStageRequest_canarySettings::is_percent_traffic_Set() const{
    return m_percent_traffic_isSet;
}

bool OAICreateStageRequest_canarySettings::is_percent_traffic_Valid() const{
    return m_percent_traffic_isValid;
}

QString OAICreateStageRequest_canarySettings::getDeploymentId() const {
    return m_deployment_id;
}
void OAICreateStageRequest_canarySettings::setDeploymentId(const QString &deployment_id) {
    m_deployment_id = deployment_id;
    m_deployment_id_isSet = true;
}

bool OAICreateStageRequest_canarySettings::is_deployment_id_Set() const{
    return m_deployment_id_isSet;
}

bool OAICreateStageRequest_canarySettings::is_deployment_id_Valid() const{
    return m_deployment_id_isValid;
}

QMap OAICreateStageRequest_canarySettings::getStageVariableOverrides() const {
    return m_stage_variable_overrides;
}
void OAICreateStageRequest_canarySettings::setStageVariableOverrides(const QMap &stage_variable_overrides) {
    m_stage_variable_overrides = stage_variable_overrides;
    m_stage_variable_overrides_isSet = true;
}

bool OAICreateStageRequest_canarySettings::is_stage_variable_overrides_Set() const{
    return m_stage_variable_overrides_isSet;
}

bool OAICreateStageRequest_canarySettings::is_stage_variable_overrides_Valid() const{
    return m_stage_variable_overrides_isValid;
}

bool OAICreateStageRequest_canarySettings::getUseStageCache() const {
    return m_use_stage_cache;
}
void OAICreateStageRequest_canarySettings::setUseStageCache(const bool &use_stage_cache) {
    m_use_stage_cache = use_stage_cache;
    m_use_stage_cache_isSet = true;
}

bool OAICreateStageRequest_canarySettings::is_use_stage_cache_Set() const{
    return m_use_stage_cache_isSet;
}

bool OAICreateStageRequest_canarySettings::is_use_stage_cache_Valid() const{
    return m_use_stage_cache_isValid;
}

bool OAICreateStageRequest_canarySettings::isSet() const {
...
bool OAICreateStageRequest_canarySettings::isValid() const {
