...
QString OAIResources::getPosition() const {
    return m_position;
}
void OAIResources::setPosition(const QString &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIResources::is_position_Set() const{
    return m_position_isSet;
}

bool OAIResources::is_position_Valid() const{
    return m_position_isValid;
}

QList OAIResources::getItems() const {
    return m_items;
}
void OAIResources::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIResources::is_items_Set() const{
    return m_items_isSet;
}

bool OAIResources::is_items_Valid() const{
