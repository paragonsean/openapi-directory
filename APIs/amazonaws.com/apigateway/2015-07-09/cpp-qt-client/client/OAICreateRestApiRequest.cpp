...
#include "OAICreateRestApiRequest.h"
...
OAICreateRestApiRequest::OAICreateRestApiRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRestApiRequest::OAICreateRestApiRequest() {
    this->initializeModel();
}

OAICreateRestApiRequest::~OAICreateRestApiRequest() {}

void OAICreateRestApiRequest::initializeModel() {
...
void OAICreateRestApiRequest::fromJson(QString jsonString) {
...
void OAICreateRestApiRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateRestApiRequest::asJson() const {
...
QJsonObject OAICreateRestApiRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateRestApiRequest::getName() const {
    return m_name;
}
void OAICreateRestApiRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateRestApiRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateRestApiRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateRestApiRequest::getDescription() const {
    return m_description;
}
void OAICreateRestApiRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateRestApiRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateRestApiRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateRestApiRequest::getVersion() const {
    return m_version;
}
void OAICreateRestApiRequest::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICreateRestApiRequest::is_version_Set() const{
    return m_version_isSet;
}

bool OAICreateRestApiRequest::is_version_Valid() const{
    return m_version_isValid;
}

QString OAICreateRestApiRequest::getCloneFrom() const {
    return m_clone_from;
}
void OAICreateRestApiRequest::setCloneFrom(const QString &clone_from) {
    m_clone_from = clone_from;
    m_clone_from_isSet = true;
}

bool OAICreateRestApiRequest::is_clone_from_Set() const{
    return m_clone_from_isSet;
}

bool OAICreateRestApiRequest::is_clone_from_Valid() const{
    return m_clone_from_isValid;
}

QList OAICreateRestApiRequest::getBinaryMediaTypes() const {
    return m_binary_media_types;
}
void OAICreateRestApiRequest::setBinaryMediaTypes(const QList &binary_media_types) {
    m_binary_media_types = binary_media_types;
    m_binary_media_types_isSet = true;
}

bool OAICreateRestApiRequest::is_binary_media_types_Set() const{
    return m_binary_media_types_isSet;
}

bool OAICreateRestApiRequest::is_binary_media_types_Valid() const{
    return m_binary_media_types_isValid;
}

qint32 OAICreateRestApiRequest::getMinimumCompressionSize() const {
    return m_minimum_compression_size;
}
void OAICreateRestApiRequest::setMinimumCompressionSize(const qint32 &minimum_compression_size) {
    m_minimum_compression_size = minimum_compression_size;
    m_minimum_compression_size_isSet = true;
}

bool OAICreateRestApiRequest::is_minimum_compression_size_Set() const{
    return m_minimum_compression_size_isSet;
}

bool OAICreateRestApiRequest::is_minimum_compression_size_Valid() const{
    return m_minimum_compression_size_isValid;
}

OAIApiKeySourceType OAICreateRestApiRequest::getApiKeySource() const {
    return m_api_key_source;
}
void OAICreateRestApiRequest::setApiKeySource(const OAIApiKeySourceType &api_key_source) {
    m_api_key_source = api_key_source;
    m_api_key_source_isSet = true;
}

bool OAICreateRestApiRequest::is_api_key_source_Set() const{
    return m_api_key_source_isSet;
}

bool OAICreateRestApiRequest::is_api_key_source_Valid() const{
    return m_api_key_source_isValid;
}

OAIRestApi_endpointConfiguration OAICreateRestApiRequest::getEndpointConfiguration() const {
    return m_endpoint_configuration;
}
void OAICreateRestApiRequest::setEndpointConfiguration(const OAIRestApi_endpointConfiguration &endpoint_configuration) {
    m_endpoint_configuration = endpoint_configuration;
    m_endpoint_configuration_isSet = true;
}

bool OAICreateRestApiRequest::is_endpoint_configuration_Set() const{
    return m_endpoint_configuration_isSet;
}

bool OAICreateRestApiRequest::is_endpoint_configuration_Valid() const{
    return m_endpoint_configuration_isValid;
}

QString OAICreateRestApiRequest::getPolicy() const {
    return m_policy;
}
void OAICreateRestApiRequest::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAICreateRestApiRequest::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAICreateRestApiRequest::is_policy_Valid() const{
    return m_policy_isValid;
}

QMap OAICreateRestApiRequest::getTags() const {
    return m_tags;
}
void OAICreateRestApiRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRestApiRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRestApiRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateRestApiRequest::getDisableExecuteApiEndpoint() const {
    return m_disable_execute_api_endpoint;
}
void OAICreateRestApiRequest::setDisableExecuteApiEndpoint(const bool &disable_execute_api_endpoint) {
    m_disable_execute_api_endpoint = disable_execute_api_endpoint;
    m_disable_execute_api_endpoint_isSet = true;
}

bool OAICreateRestApiRequest::is_disable_execute_api_endpoint_Set() const{
    return m_disable_execute_api_endpoint_isSet;
}

bool OAICreateRestApiRequest::is_disable_execute_api_endpoint_Valid() const{
    return m_disable_execute_api_endpoint_isValid;
}

bool OAICreateRestApiRequest::isSet() const {
...
bool OAICreateRestApiRequest::isValid() const {
