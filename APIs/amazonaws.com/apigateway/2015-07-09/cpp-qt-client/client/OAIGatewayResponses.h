...
#ifndef OAIGatewayResponses_H
#define OAIGatewayResponses_H
...
class OAIGatewayResponses : public OAIObject {
public:
    OAIGatewayResponses();
    OAIGatewayResponses(QString json);
    ~OAIGatewayResponses() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayResponses)

#endif // OAIGatewayResponses_H
