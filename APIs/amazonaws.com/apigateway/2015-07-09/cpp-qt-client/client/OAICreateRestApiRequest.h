...
/*
 * OAICreateRestApiRequest.h
 *
 * The POST Request to add a new RestApi resource to your collection.
 */

#ifndef OAICreateRestApiRequest_H
#define OAICreateRestApiRequest_H
...
class OAICreateRestApiRequest : public OAIObject {
public:
    OAICreateRestApiRequest();
    OAICreateRestApiRequest(QString json);
    ~OAICreateRestApiRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRestApiRequest)

#endif // OAICreateRestApiRequest_H
