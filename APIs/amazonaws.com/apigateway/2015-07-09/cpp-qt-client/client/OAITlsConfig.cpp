...
bool OAITlsConfig::getInsecureSkipVerification() const {
    return m_insecure_skip_verification;
}
void OAITlsConfig::setInsecureSkipVerification(const bool &insecure_skip_verification) {
    m_insecure_skip_verification = insecure_skip_verification;
    m_insecure_skip_verification_isSet = true;
}

bool OAITlsConfig::is_insecure_skip_verification_Set() const{
    return m_insecure_skip_verification_isSet;
}

bool OAITlsConfig::is_insecure_skip_verification_Valid() const{
