...
/*
 * OAIPutGatewayResponseRequest.h
 *
 * Creates a customization of a GatewayResponse of a specified response type and status code on the given RestApi.
 */

#ifndef OAIPutGatewayResponseRequest_H
#define OAIPutGatewayResponseRequest_H
...
class OAIPutGatewayResponseRequest : public OAIObject {
public:
    OAIPutGatewayResponseRequest();
    OAIPutGatewayResponseRequest(QString json);
    ~OAIPutGatewayResponseRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutGatewayResponseRequest)

#endif // OAIPutGatewayResponseRequest_H
