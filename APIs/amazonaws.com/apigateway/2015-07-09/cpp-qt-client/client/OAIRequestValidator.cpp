...
OAIRequestValidator::OAIRequestValidator(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRequestValidator::OAIRequestValidator() {
    this->initializeModel();
}

OAIRequestValidator::~OAIRequestValidator() {}

void OAIRequestValidator::initializeModel() {
...
void OAIRequestValidator::fromJson(QString jsonString) {
...
void OAIRequestValidator::fromJsonObject(QJsonObject json) {
...
QString OAIRequestValidator::asJson() const {
...
QJsonObject OAIRequestValidator::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIRequestValidator::getId() const {
    return m_id;
}
void OAIRequestValidator::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRequestValidator::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRequestValidator::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIRequestValidator::getName() const {
    return m_name;
}
void OAIRequestValidator::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRequestValidator::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRequestValidator::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIRequestValidator::getValidateRequestBody() const {
    return m_validate_request_body;
}
void OAIRequestValidator::setValidateRequestBody(const bool &validate_request_body) {
    m_validate_request_body = validate_request_body;
    m_validate_request_body_isSet = true;
}

bool OAIRequestValidator::is_validate_request_body_Set() const{
    return m_validate_request_body_isSet;
}

bool OAIRequestValidator::is_validate_request_body_Valid() const{
    return m_validate_request_body_isValid;
}

bool OAIRequestValidator::getValidateRequestParameters() const {
    return m_validate_request_parameters;
}
void OAIRequestValidator::setValidateRequestParameters(const bool &validate_request_parameters) {
    m_validate_request_parameters = validate_request_parameters;
    m_validate_request_parameters_isSet = true;
}

bool OAIRequestValidator::is_validate_request_parameters_Set() const{
    return m_validate_request_parameters_isSet;
}

bool OAIRequestValidator::is_validate_request_parameters_Valid() const{
    return m_validate_request_parameters_isValid;
}

bool OAIRequestValidator::isSet() const {
...
bool OAIRequestValidator::isValid() const {
