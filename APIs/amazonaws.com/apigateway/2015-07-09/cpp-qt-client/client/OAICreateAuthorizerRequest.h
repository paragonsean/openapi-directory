...
public:
    ...
    OAIAuthorizerType getType() const;
    void setType(const OAIAuthorizerType &type);
    bool is_type_Set() const;
    bool is_type_Valid() const;

    QList getProviderArns() const;
    void setProviderArns(const QList &provider_arns);
...
private:
    ...
    OAIAuthorizerType m_type;
    bool m_type_isSet;
    bool m_type_isValid;

    QList m_provider_arns;
