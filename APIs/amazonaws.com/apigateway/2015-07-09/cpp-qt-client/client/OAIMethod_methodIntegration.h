...
/*
 * OAIMethod_methodIntegration.h
 *
 * 
 */

#ifndef OAIMethod_methodIntegration_H
#define OAIMethod_methodIntegration_H
...
namespace OpenAPI {
class OAIIntegration_tlsConfig;

class OAIMethod_methodIntegration : public OAIObject {
public:
    OAIMethod_methodIntegration();
    OAIMethod_methodIntegration(QString json);
    ~OAIMethod_methodIntegration() override;
    ...
    QMap getIntegrationResponses() const;
    void setIntegrationResponses(const QMap &integration_responses);
    bool is_integration_responses_Set() const;
    bool is_integration_responses_Valid() const;

    OAIIntegration_tlsConfig getTlsConfig() const;
    void setTlsConfig(const OAIIntegration_tlsConfig &tls_config);
...
private:
    ...
    QMap m_integration_responses;
    bool m_integration_responses_isSet;
    bool m_integration_responses_isValid;

    OAIIntegration_tlsConfig m_tls_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMethod_methodIntegration)

#endif // OAIMethod_methodIntegration_H
