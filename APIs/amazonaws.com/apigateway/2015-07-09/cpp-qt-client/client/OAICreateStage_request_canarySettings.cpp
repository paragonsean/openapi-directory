...
#include "OAICreateStage_request_canarySettings.h"
...
OAICreateStage_request_canarySettings::OAICreateStage_request_canarySettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStage_request_canarySettings::OAICreateStage_request_canarySettings() {
    this->initializeModel();
}

OAICreateStage_request_canarySettings::~OAICreateStage_request_canarySettings() {}

void OAICreateStage_request_canarySettings::initializeModel() {
...
void OAICreateStage_request_canarySettings::fromJson(QString jsonString) {
...
void OAICreateStage_request_canarySettings::fromJsonObject(QJsonObject json) {
...
QString OAICreateStage_request_canarySettings::asJson() const {
...
QJsonObject OAICreateStage_request_canarySettings::asJsonObject() const {
    QJsonObject obj;
...
double OAICreateStage_request_canarySettings::getPercentTraffic() const {
    return m_percent_traffic;
}
void OAICreateStage_request_canarySettings::setPercentTraffic(const double &percent_traffic) {
    m_percent_traffic = percent_traffic;
    m_percent_traffic_isSet = true;
}

bool OAICreateStage_request_canarySettings::is_percent_traffic_Set() const{
    return m_percent_traffic_isSet;
}

bool OAICreateStage_request_canarySettings::is_percent_traffic_Valid() const{
    return m_percent_traffic_isValid;
}

QString OAICreateStage_request_canarySettings::getDeploymentId() const {
    return m_deployment_id;
}
void OAICreateStage_request_canarySettings::setDeploymentId(const QString &deployment_id) {
    m_deployment_id = deployment_id;
    m_deployment_id_isSet = true;
}

bool OAICreateStage_request_canarySettings::is_deployment_id_Set() const{
    return m_deployment_id_isSet;
}

bool OAICreateStage_request_canarySettings::is_deployment_id_Valid() const{
    return m_deployment_id_isValid;
}

QMap OAICreateStage_request_canarySettings::getStageVariableOverrides() const {
    return m_stage_variable_overrides;
}
void OAICreateStage_request_canarySettings::setStageVariableOverrides(const QMap &stage_variable_overrides) {
    m_stage_variable_overrides = stage_variable_overrides;
    m_stage_variable_overrides_isSet = true;
}

bool OAICreateStage_request_canarySettings::is_stage_variable_overrides_Set() const{
    return m_stage_variable_overrides_isSet;
}

bool OAICreateStage_request_canarySettings::is_stage_variable_overrides_Valid() const{
    return m_stage_variable_overrides_isValid;
}

bool OAICreateStage_request_canarySettings::getUseStageCache() const {
    return m_use_stage_cache;
}
void OAICreateStage_request_canarySettings::setUseStageCache(const bool &use_stage_cache) {
    m_use_stage_cache = use_stage_cache;
    m_use_stage_cache_isSet = true;
}

bool OAICreateStage_request_canarySettings::is_use_stage_cache_Set() const{
    return m_use_stage_cache_isSet;
}

bool OAICreateStage_request_canarySettings::is_use_stage_cache_Valid() const{
    return m_use_stage_cache_isValid;
}

bool OAICreateStage_request_canarySettings::isSet() const {
...
bool OAICreateStage_request_canarySettings::isValid() const {
