...
OAITestInvokeMethod_request::OAITestInvokeMethod_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestInvokeMethod_request::OAITestInvokeMethod_request() {
    this->initializeModel();
}

OAITestInvokeMethod_request::~OAITestInvokeMethod_request() {}

void OAITestInvokeMethod_request::initializeModel() {
...
void OAITestInvokeMethod_request::fromJson(QString jsonString) {
...
void OAITestInvokeMethod_request::fromJsonObject(QJsonObject json) {
...
QString OAITestInvokeMethod_request::asJson() const {
...
QJsonObject OAITestInvokeMethod_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAITestInvokeMethod_request::getPathWithQueryString() const {
    return m_path_with_query_string;
}
void OAITestInvokeMethod_request::setPathWithQueryString(const QString &path_with_query_string) {
    m_path_with_query_string = path_with_query_string;
    m_path_with_query_string_isSet = true;
}

bool OAITestInvokeMethod_request::is_path_with_query_string_Set() const{
    return m_path_with_query_string_isSet;
}

bool OAITestInvokeMethod_request::is_path_with_query_string_Valid() const{
    return m_path_with_query_string_isValid;
}

QString OAITestInvokeMethod_request::getBody() const {
    return m_body;
}
void OAITestInvokeMethod_request::setBody(const QString &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAITestInvokeMethod_request::is_body_Set() const{
    return m_body_isSet;
}

bool OAITestInvokeMethod_request::is_body_Valid() const{
    return m_body_isValid;
}

QMap<QString, QString> OAITestInvokeMethod_request::getHeaders() const {
    return m_headers;
}
void OAITestInvokeMethod_request::setHeaders(const QMap<QString, QString> &headers) {
    m_headers = headers;
    m_headers_isSet = true;
}

bool OAITestInvokeMethod_request::is_headers_Set() const{
    return m_headers_isSet;
}

bool OAITestInvokeMethod_request::is_headers_Valid() const{
    return m_headers_isValid;
}

QMap<QString, QList> OAITestInvokeMethod_request::getMultiValueHeaders() const {
    return m_multi_value_headers;
}
void OAITestInvokeMethod_request::setMultiValueHeaders(const QMap<QString, QList> &multi_value_headers) {
    m_multi_value_headers = multi_value_headers;
    m_multi_value_headers_isSet = true;
}

bool OAITestInvokeMethod_request::is_multi_value_headers_Set() const{
    return m_multi_value_headers_isSet;
}

bool OAITestInvokeMethod_request::is_multi_value_headers_Valid() const{
    return m_multi_value_headers_isValid;
}

QString OAITestInvokeMethod_request::getClientCertificateId() const {
    return m_client_certificate_id;
}
void OAITestInvokeMethod_request::setClientCertificateId(const QString &client_certificate_id) {
    m_client_certificate_id = client_certificate_id;
    m_client_certificate_id_isSet = true;
}

bool OAITestInvokeMethod_request::is_client_certificate_id_Set() const{
    return m_client_certificate_id_isSet;
}

bool OAITestInvokeMethod_request::is_client_certificate_id_Valid() const{
    return m_client_certificate_id_isValid;
}

QMap<QString, QString> OAITestInvokeMethod_request::getStageVariables() const {
    return m_stage_variables;
}
void OAITestInvokeMethod_request::setStageVariables(const QMap<QString, QString> &stage_variables) {
    m_stage_variables = stage_variables;
    m_stage_variables_isSet = true;
}

bool OAITestInvokeMethod_request::is_stage_variables_Set() const{
    return m_stage_variables_isSet;
}

bool OAITestInvokeMethod_request::is_stage_variables_Valid() const{
    return m_stage_variables_isValid;
}

bool OAITestInvokeMethod_request::isSet() const {
...
bool OAITestInvokeMethod_request::isValid() const {
