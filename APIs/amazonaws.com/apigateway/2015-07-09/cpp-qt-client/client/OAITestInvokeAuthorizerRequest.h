...
/*
 * OAITestInvokeAuthorizerRequest.h
 *
 * Make a request to simulate the invocation of an Authorizer.
 */

#ifndef OAITestInvokeAuthorizerRequest_H
#define OAITestInvokeAuthorizerRequest_H
...
class OAITestInvokeAuthorizerRequest : public OAIObject {
public:
    OAITestInvokeAuthorizerRequest();
    OAITestInvokeAuthorizerRequest(QString json);
    ~OAITestInvokeAuthorizerRequest() override;
    ...
    QMap getAdditionalContext() const;
    void setAdditionalContext(const QMap &additional_context);
    bool is_additional_context_Set() const;
    bool is_additional_context_Valid() const;
...
private:
    ...
    QMap m_additional_context;
    bool m_additional_context_isSet;
    bool m_additional_context_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITestInvokeAuthorizerRequest)

#endif // OAITestInvokeAuthorizerRequest_H
