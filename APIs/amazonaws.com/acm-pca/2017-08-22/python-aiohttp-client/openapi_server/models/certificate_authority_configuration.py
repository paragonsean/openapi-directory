...
class CertificateAuthorityConfiguration(Model):
    ...
    def __init__(self, key_algorithm: KeyAlgorithm=None, signing_algorithm: SigningAlgorithm=None, subject: CertificateAuthorityConfigurationSubject=None, csr_extensions: CertificateAuthorityConfigurationCsrExtensions=None):
        """CertificateAuthorityConfiguration - a model defined in OpenAPI

        :param key_algorithm: The key_algorithm of this CertificateAuthorityConfiguration.
        :param signing_algorithm: The signing_algorithm of this CertificateAuthorityConfiguration.
        :param subject: The subject of this CertificateAuthorityConfiguration.
        :param csr_extensions: The csr_extensions of this CertificateAuthorityConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CertificateAuthorityConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CertificateAuthorityConfiguration of this CertificateAuthorityConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def key_algorithm(self):
        """Gets the key_algorithm of this CertificateAuthorityConfiguration.


        :return: The key_algorithm of this CertificateAuthorityConfiguration.
        :rtype: KeyAlgorithm
        """
    ...
    def key_algorithm(self, key_algorithm):
        """Sets the key_algorithm of this CertificateAuthorityConfiguration.
    ...
    def signing_algorithm(self):
        """Gets the signing_algorithm of this CertificateAuthorityConfiguration.


        :return: The signing_algorithm of this CertificateAuthorityConfiguration.
    ...
    def signing_algorithm(self, signing_algorithm):
        """Sets the signing_algorithm of this CertificateAuthorityConfiguration.
    ...
    @property
    def subject(self):
        """Gets the subject of this CertificateAuthorityConfiguration.


        :return: The subject of this CertificateAuthorityConfiguration.
    ...
    def subject(self, subject):
        """Sets the subject of this CertificateAuthorityConfiguration.
    ...
    def csr_extensions(self):
        """Gets the csr_extensions of this CertificateAuthorityConfiguration.


        :return: The csr_extensions of this CertificateAuthorityConfiguration.
    ...
    def csr_extensions(self, csr_extensions):
        """Sets the csr_extensions of this CertificateAuthorityConfiguration.
