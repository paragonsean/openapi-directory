...
public class CsrExtensionsKeyUsage {
  ...
  public CsrExtensionsKeyUsage() {
  }

  public CsrExtensionsKeyUsage digitalSignature(Boolean digitalSignature) {
  ...
  public CsrExtensionsKeyUsage nonRepudiation(Boolean nonRepudiation) {
  ...
  public CsrExtensionsKeyUsage keyEncipherment(Boolean keyEncipherment) {
  ...
  public CsrExtensionsKeyUsage dataEncipherment(Boolean dataEncipherment) {
  ...
  public CsrExtensionsKeyUsage keyAgreement(Boolean keyAgreement) {
  ...
  public CsrExtensionsKeyUsage keyCertSign(Boolean keyCertSign) {
  ...
  public CsrExtensionsKeyUsage crLSign(Boolean crLSign) {
  ...
  public CsrExtensionsKeyUsage encipherOnly(Boolean encipherOnly) {
  ...
  public CsrExtensionsKeyUsage decipherOnly(Boolean decipherOnly) {
  ...
  public boolean equals(Object o) {
    ...
    CsrExtensionsKeyUsage csrExtensionsKeyUsage = (CsrExtensionsKeyUsage) o;
    return Objects.equals(this.digitalSignature, csrExtensionsKeyUsage.digitalSignature) &&
        Objects.equals(this.nonRepudiation, csrExtensionsKeyUsage.nonRepudiation) &&
        Objects.equals(this.keyEncipherment, csrExtensionsKeyUsage.keyEncipherment) &&
        Objects.equals(this.dataEncipherment, csrExtensionsKeyUsage.dataEncipherment) &&
        Objects.equals(this.keyAgreement, csrExtensionsKeyUsage.keyAgreement) &&
        Objects.equals(this.keyCertSign, csrExtensionsKeyUsage.keyCertSign) &&
        Objects.equals(this.crLSign, csrExtensionsKeyUsage.crLSign) &&
        Objects.equals(this.encipherOnly, csrExtensionsKeyUsage.encipherOnly) &&
        Objects.equals(this.decipherOnly, csrExtensionsKeyUsage.decipherOnly);
  }
  ...
  public String toString() {
    ...
    sb.append("class CsrExtensionsKeyUsage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CsrExtensionsKeyUsage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CsrExtensionsKeyUsage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CsrExtensionsKeyUsage is not found in the empty JSON string", CsrExtensionsKeyUsage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CsrExtensionsKeyUsage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CsrExtensionsKeyUsage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CsrExtensionsKeyUsage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CsrExtensionsKeyUsage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CsrExtensionsKeyUsage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CsrExtensionsKeyUsage.class));

       return (TypeAdapter<T>) new TypeAdapter<CsrExtensionsKeyUsage>() {
           @Override
           public void write(JsonWriter out, CsrExtensionsKeyUsage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CsrExtensionsKeyUsage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CsrExtensionsKeyUsage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CsrExtensionsKeyUsage
   * @throws IOException if the JSON string is invalid with respect to CsrExtensionsKeyUsage
   */
  public static CsrExtensionsKeyUsage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CsrExtensionsKeyUsage.class);
  }

  /**
   * Convert an instance of CsrExtensionsKeyUsage to an JSON string
   *
   * @return JSON string
   */
