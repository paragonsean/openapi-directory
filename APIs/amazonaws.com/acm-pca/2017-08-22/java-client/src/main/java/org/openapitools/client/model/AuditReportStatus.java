...
/**
 * Gets or Sets AuditReportStatus
 */
@JsonAdapter(AuditReportStatus.Adapter.class)
public enum AuditReportStatus {
  ...
  public static AuditReportStatus fromValue(String value) {
    for (AuditReportStatus b : AuditReportStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AuditReportStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditReportStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditReportStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditReportStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuditReportStatus.fromValue(value);
  }
}
