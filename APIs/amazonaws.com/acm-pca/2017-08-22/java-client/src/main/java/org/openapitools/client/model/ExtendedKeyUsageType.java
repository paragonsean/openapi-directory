...
/**
 * Gets or Sets ExtendedKeyUsageType
 */
@JsonAdapter(ExtendedKeyUsageType.Adapter.class)
public enum ExtendedKeyUsageType {
  ...
  public static ExtendedKeyUsageType fromValue(String value) {
    for (ExtendedKeyUsageType b : ExtendedKeyUsageType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExtendedKeyUsageType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExtendedKeyUsageType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExtendedKeyUsageType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExtendedKeyUsageType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExtendedKeyUsageType.fromValue(value);
  }
}
