...
import org.openapitools.client.model.ApiPassthroughExtensions;
...
public class ApiPassthrough {
  ...
  private ApiPassthroughExtensions extensions;
  ...
  public ApiPassthrough extensions(ApiPassthroughExtensions extensions) {
  ...
  public ApiPassthroughExtensions getExtensions() {
    return extensions;
  }

  public void setExtensions(ApiPassthroughExtensions extensions) {
    this.extensions = extensions;
  }


  public ApiPassthrough subject(ASN1Subject subject) {
  ...
  public boolean equals(Object o) {
    ...
    ApiPassthrough apiPassthrough = (ApiPassthrough) o;
    return Objects.equals(this.extensions, apiPassthrough.extensions) &&
        Objects.equals(this.subject, apiPassthrough.subject);
  }

  @Override
  public int hashCode() {
    return Objects.hash(extensions, subject);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiPassthrough {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiPassthrough
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiPassthrough.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiPassthrough is not found in the empty JSON string", ApiPassthrough.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiPassthrough.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiPassthrough` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Extensions`
      if (jsonObj.get("Extensions") != null && !jsonObj.get("Extensions").isJsonNull()) {
        ApiPassthroughExtensions.validateJsonElement(jsonObj.get("Extensions"));
      }
      // validate the optional field `Subject`
      if (jsonObj.get("Subject") != null && !jsonObj.get("Subject").isJsonNull()) {
        ASN1Subject.validateJsonElement(jsonObj.get("Subject"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiPassthrough.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiPassthrough' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiPassthrough> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiPassthrough.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiPassthrough>() {
           @Override
           public void write(JsonWriter out, ApiPassthrough value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiPassthrough read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiPassthrough given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiPassthrough
   * @throws IOException if the JSON string is invalid with respect to ApiPassthrough
   */
  public static ApiPassthrough fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiPassthrough.class);
  }

  /**
   * Convert an instance of ApiPassthrough to an JSON string
   *
   * @return JSON string
   */
