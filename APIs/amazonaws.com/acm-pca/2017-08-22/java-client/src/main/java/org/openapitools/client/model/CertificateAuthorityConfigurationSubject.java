...
public class CertificateAuthorityConfigurationSubject {
  ...
  public CertificateAuthorityConfigurationSubject() {
  }

  public CertificateAuthorityConfigurationSubject country(String country) {
  ...
  public CertificateAuthorityConfigurationSubject organization(String organization) {
  ...
  public CertificateAuthorityConfigurationSubject organizationalUnit(String organizationalUnit) {
  ...
  public CertificateAuthorityConfigurationSubject distinguishedNameQualifier(String distinguishedNameQualifier) {
  ...
  public CertificateAuthorityConfigurationSubject state(String state) {
    this.state = state;
    return this;
  }
  ...
  public CertificateAuthorityConfigurationSubject commonName(String commonName) {
  ...
  public CertificateAuthorityConfigurationSubject serialNumber(String serialNumber) {
  ...
  public CertificateAuthorityConfigurationSubject locality(String locality) {
  ...
  public CertificateAuthorityConfigurationSubject title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CertificateAuthorityConfigurationSubject surname(String surname) {
  ...
  public CertificateAuthorityConfigurationSubject givenName(String givenName) {
  ...
  public CertificateAuthorityConfigurationSubject initials(String initials) {
  ...
  public CertificateAuthorityConfigurationSubject pseudonym(String pseudonym) {
  ...
  public CertificateAuthorityConfigurationSubject generationQualifier(String generationQualifier) {
  ...
  public CertificateAuthorityConfigurationSubject customAttributes(List customAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateAuthorityConfigurationSubject certificateAuthorityConfigurationSubject = (CertificateAuthorityConfigurationSubject) o;
    return Objects.equals(this.country, certificateAuthorityConfigurationSubject.country) &&
        Objects.equals(this.organization, certificateAuthorityConfigurationSubject.organization) &&
        Objects.equals(this.organizationalUnit, certificateAuthorityConfigurationSubject.organizationalUnit) &&
        Objects.equals(this.distinguishedNameQualifier, certificateAuthorityConfigurationSubject.distinguishedNameQualifier) &&
        Objects.equals(this.state, certificateAuthorityConfigurationSubject.state) &&
        Objects.equals(this.commonName, certificateAuthorityConfigurationSubject.commonName) &&
        Objects.equals(this.serialNumber, certificateAuthorityConfigurationSubject.serialNumber) &&
        Objects.equals(this.locality, certificateAuthorityConfigurationSubject.locality) &&
        Objects.equals(this.title, certificateAuthorityConfigurationSubject.title) &&
        Objects.equals(this.surname, certificateAuthorityConfigurationSubject.surname) &&
        Objects.equals(this.givenName, certificateAuthorityConfigurationSubject.givenName) &&
        Objects.equals(this.initials, certificateAuthorityConfigurationSubject.initials) &&
        Objects.equals(this.pseudonym, certificateAuthorityConfigurationSubject.pseudonym) &&
        Objects.equals(this.generationQualifier, certificateAuthorityConfigurationSubject.generationQualifier) &&
        Objects.equals(this.customAttributes, certificateAuthorityConfigurationSubject.customAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateAuthorityConfigurationSubject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CertificateAuthorityConfigurationSubject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CertificateAuthorityConfigurationSubject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateAuthorityConfigurationSubject is not found in the empty JSON string", CertificateAuthorityConfigurationSubject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CertificateAuthorityConfigurationSubject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CertificateAuthorityConfigurationSubject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateAuthorityConfigurationSubject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateAuthorityConfigurationSubject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateAuthorityConfigurationSubject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateAuthorityConfigurationSubject.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateAuthorityConfigurationSubject>() {
           @Override
           public void write(JsonWriter out, CertificateAuthorityConfigurationSubject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CertificateAuthorityConfigurationSubject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CertificateAuthorityConfigurationSubject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CertificateAuthorityConfigurationSubject
   * @throws IOException if the JSON string is invalid with respect to CertificateAuthorityConfigurationSubject
   */
  public static CertificateAuthorityConfigurationSubject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateAuthorityConfigurationSubject.class);
  }

  /**
   * Convert an instance of CertificateAuthorityConfigurationSubject to an JSON string
   *
   * @return JSON string
   */
