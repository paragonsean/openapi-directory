 ...
 */
@JsonAdapter(ResourceOwner.Adapter.class)
public enum ResourceOwner {
  ...
  public static ResourceOwner fromValue(String value) {
    for (ResourceOwner b : ResourceOwner.values()) {
  ...
  public static class Adapter extends TypeAdapter<ResourceOwner> {
    @Override
    public void write(final JsonWriter jsonWriter, final ResourceOwner enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ResourceOwner read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ResourceOwner.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ResourceOwner.fromValue(value);
  }
}
