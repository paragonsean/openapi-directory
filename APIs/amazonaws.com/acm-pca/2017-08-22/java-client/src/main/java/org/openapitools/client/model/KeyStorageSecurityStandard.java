...
/**
 * Gets or Sets KeyStorageSecurityStandard
 */
@JsonAdapter(KeyStorageSecurityStandard.Adapter.class)
public enum KeyStorageSecurityStandard {
  
  _2_OR_HIGHER("FIPS_140_2_LEVEL_2_OR_HIGHER"),
  
  _3_OR_HIGHER("FIPS_140_2_LEVEL_3_OR_HIGHER");

  private String value;

  KeyStorageSecurityStandard(String value) {
    this.value = value;
  }
  ...
  public static KeyStorageSecurityStandard fromValue(String value) {
    for (KeyStorageSecurityStandard b : KeyStorageSecurityStandard.values()) {
  ...
  public static class Adapter extends TypeAdapter<KeyStorageSecurityStandard> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeyStorageSecurityStandard enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeyStorageSecurityStandard read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeyStorageSecurityStandard.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KeyStorageSecurityStandard.fromValue(value);
  }
}
