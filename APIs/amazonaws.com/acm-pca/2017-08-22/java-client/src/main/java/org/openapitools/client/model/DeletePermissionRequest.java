...
public class DeletePermissionRequest {
  ...
  public DeletePermissionRequest certificateAuthorityArn(String certificateAuthorityArn) {
  ...
  public DeletePermissionRequest principal(String principal) {
  ...
  public DeletePermissionRequest sourceAccount(String sourceAccount) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePermissionRequest deletePermissionRequest = (DeletePermissionRequest) o;
    return Objects.equals(this.certificateAuthorityArn, deletePermissionRequest.certificateAuthorityArn) &&
        Objects.equals(this.principal, deletePermissionRequest.principal) &&
        Objects.equals(this.sourceAccount, deletePermissionRequest.sourceAccount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificateAuthorityArn, principal, sourceAccount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletePermissionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePermissionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePermissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePermissionRequest is not found in the empty JSON string", DeletePermissionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePermissionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePermissionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePermissionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePermissionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePermissionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePermissionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePermissionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePermissionRequest>() {
           @Override
           public void write(JsonWriter out, DeletePermissionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePermissionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePermissionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePermissionRequest
   * @throws IOException if the JSON string is invalid with respect to DeletePermissionRequest
   */
  public static DeletePermissionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePermissionRequest.class);
  }

  /**
   * Convert an instance of DeletePermissionRequest to an JSON string
   *
   * @return JSON string
   */
