...
/**
 * Gets or Sets CertificateAuthorityUsageMode
 */
@JsonAdapter(CertificateAuthorityUsageMode.Adapter.class)
public enum CertificateAuthorityUsageMode {
  ...
  CertificateAuthorityUsageMode(String value) {
    this.value = value;
  }
  ...
  public static CertificateAuthorityUsageMode fromValue(String value) {
    for (CertificateAuthorityUsageMode b : CertificateAuthorityUsageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CertificateAuthorityUsageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CertificateAuthorityUsageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CertificateAuthorityUsageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CertificateAuthorityUsageMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CertificateAuthorityUsageMode.fromValue(value);
  }
}
