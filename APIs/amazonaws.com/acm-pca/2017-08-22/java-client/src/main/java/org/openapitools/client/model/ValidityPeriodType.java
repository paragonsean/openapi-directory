...
/**
 * Gets or Sets ValidityPeriodType
 */
@JsonAdapter(ValidityPeriodType.Adapter.class)
public enum ValidityPeriodType {
  ...
  ValidityPeriodType(String value) {
    this.value = value;
  }
  ...
  public static ValidityPeriodType fromValue(String value) {
    for (ValidityPeriodType b : ValidityPeriodType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ValidityPeriodType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ValidityPeriodType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ValidityPeriodType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ValidityPeriodType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ValidityPeriodType.fromValue(value);
  }
}
