...
public class OtherName {
  ...
  public OtherName typeId(String typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public OtherName value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.typeId, otherName.typeId) &&
        Objects.equals(this.value, otherName.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OtherName
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OtherName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OtherName is not found in the empty JSON string", OtherName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OtherName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OtherName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OtherName.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OtherName.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OtherName' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OtherName> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OtherName.class));

       return (TypeAdapter<T>) new TypeAdapter<OtherName>() {
           @Override
           public void write(JsonWriter out, OtherName value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OtherName read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OtherName given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OtherName
   * @throws IOException if the JSON string is invalid with respect to OtherName
   */
  public static OtherName fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OtherName.class);
  }

  /**
   * Convert an instance of OtherName to an JSON string
   *
   * @return JSON string
   */
