...
public class CertificateAuthorityCertificateAuthorityConfiguration {
  ...
  public CertificateAuthorityCertificateAuthorityConfiguration() {
  }

  public CertificateAuthorityCertificateAuthorityConfiguration keyAlgorithm(KeyAlgorithm keyAlgorithm) {
  ...
  public CertificateAuthorityCertificateAuthorityConfiguration signingAlgorithm(SigningAlgorithm signingAlgorithm) {
  ...
  public CertificateAuthorityCertificateAuthorityConfiguration subject(CertificateAuthorityConfigurationSubject subject) {
  ...
  public CertificateAuthorityCertificateAuthorityConfiguration csrExtensions(CertificateAuthorityConfigurationCsrExtensions csrExtensions) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateAuthorityCertificateAuthorityConfiguration certificateAuthorityCertificateAuthorityConfiguration = (CertificateAuthorityCertificateAuthorityConfiguration) o;
    return Objects.equals(this.keyAlgorithm, certificateAuthorityCertificateAuthorityConfiguration.keyAlgorithm) &&
        Objects.equals(this.signingAlgorithm, certificateAuthorityCertificateAuthorityConfiguration.signingAlgorithm) &&
        Objects.equals(this.subject, certificateAuthorityCertificateAuthorityConfiguration.subject) &&
        Objects.equals(this.csrExtensions, certificateAuthorityCertificateAuthorityConfiguration.csrExtensions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateAuthorityCertificateAuthorityConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CertificateAuthorityCertificateAuthorityConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CertificateAuthorityCertificateAuthorityConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateAuthorityCertificateAuthorityConfiguration is not found in the empty JSON string", CertificateAuthorityCertificateAuthorityConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CertificateAuthorityCertificateAuthorityConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CertificateAuthorityCertificateAuthorityConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateAuthorityCertificateAuthorityConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateAuthorityCertificateAuthorityConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateAuthorityCertificateAuthorityConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateAuthorityCertificateAuthorityConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateAuthorityCertificateAuthorityConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateAuthorityCertificateAuthorityConfiguration>() {
           @Override
           public void write(JsonWriter out, CertificateAuthorityCertificateAuthorityConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CertificateAuthorityCertificateAuthorityConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CertificateAuthorityCertificateAuthorityConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CertificateAuthorityCertificateAuthorityConfiguration
   * @throws IOException if the JSON string is invalid with respect to CertificateAuthorityCertificateAuthorityConfiguration
   */
  public static CertificateAuthorityCertificateAuthorityConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateAuthorityCertificateAuthorityConfiguration.class);
  }

  /**
   * Convert an instance of CertificateAuthorityCertificateAuthorityConfiguration to an JSON string
   *
   * @return JSON string
   */
