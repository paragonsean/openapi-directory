...
/**
 * Gets or Sets CertificateAuthorityType
 */
@JsonAdapter(CertificateAuthorityType.Adapter.class)
public enum CertificateAuthorityType {
  ...
  public static CertificateAuthorityType fromValue(String value) {
    for (CertificateAuthorityType b : CertificateAuthorityType.values()) {
  ...
  public static class Adapter extends TypeAdapter<CertificateAuthorityType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CertificateAuthorityType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CertificateAuthorityType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CertificateAuthorityType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CertificateAuthorityType.fromValue(value);
  }
}
