...
/**
 * Gets or Sets AccessMethodType
 */
@JsonAdapter(AccessMethodType.Adapter.class)
public enum AccessMethodType {
  ...
  public static AccessMethodType fromValue(String value) {
    for (AccessMethodType b : AccessMethodType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AccessMethodType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccessMethodType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccessMethodType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccessMethodType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AccessMethodType.fromValue(value);
  }
}
