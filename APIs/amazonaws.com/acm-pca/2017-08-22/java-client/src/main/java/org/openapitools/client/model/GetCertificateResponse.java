...
public class GetCertificateResponse {
  ...
  public GetCertificateResponse certificate(String certificate) {
  ...
  public GetCertificateResponse certificateChain(String certificateChain) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificate, getCertificateResponse.certificate) &&
        Objects.equals(this.certificateChain, getCertificateResponse.certificateChain);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCertificateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCertificateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCertificateResponse is not found in the empty JSON string", GetCertificateResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCertificateResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCertificateResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCertificateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCertificateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCertificateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCertificateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCertificateResponse>() {
           @Override
           public void write(JsonWriter out, GetCertificateResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCertificateResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCertificateResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCertificateResponse
   * @throws IOException if the JSON string is invalid with respect to GetCertificateResponse
   */
  public static GetCertificateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCertificateResponse.class);
  }

  /**
   * Convert an instance of GetCertificateResponse to an JSON string
   *
   * @return JSON string
   */
