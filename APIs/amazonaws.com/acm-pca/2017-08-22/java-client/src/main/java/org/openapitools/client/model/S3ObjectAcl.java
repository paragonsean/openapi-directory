...
/**
 * Gets or Sets S3ObjectAcl
 */
@JsonAdapter(S3ObjectAcl.Adapter.class)
public enum S3ObjectAcl {
  ...
  public static S3ObjectAcl fromValue(String value) {
    for (S3ObjectAcl b : S3ObjectAcl.values()) {
  ...
  public static class Adapter extends TypeAdapter<S3ObjectAcl> {
    @Override
    public void write(final JsonWriter jsonWriter, final S3ObjectAcl enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public S3ObjectAcl read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return S3ObjectAcl.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    S3ObjectAcl.fromValue(value);
  }
}
