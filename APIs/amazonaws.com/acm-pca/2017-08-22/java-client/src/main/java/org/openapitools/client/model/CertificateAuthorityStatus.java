...
/**
 * Gets or Sets CertificateAuthorityStatus
 */
@JsonAdapter(CertificateAuthorityStatus.Adapter.class)
public enum CertificateAuthorityStatus {
  ...
  CertificateAuthorityStatus(String value) {
    this.value = value;
  }
  ...
  public static CertificateAuthorityStatus fromValue(String value) {
    for (CertificateAuthorityStatus b : CertificateAuthorityStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<CertificateAuthorityStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CertificateAuthorityStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CertificateAuthorityStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CertificateAuthorityStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CertificateAuthorityStatus.fromValue(value);
  }
}
