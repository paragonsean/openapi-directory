...
/**
 * Gets or Sets AuditReportResponseFormat
 */
@JsonAdapter(AuditReportResponseFormat.Adapter.class)
public enum AuditReportResponseFormat {
  ...
  AuditReportResponseFormat(String value) {
    this.value = value;
  }
  ...
  public static AuditReportResponseFormat fromValue(String value) {
    for (AuditReportResponseFormat b : AuditReportResponseFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<AuditReportResponseFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditReportResponseFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditReportResponseFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditReportResponseFormat.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuditReportResponseFormat.fromValue(value);
  }
}
