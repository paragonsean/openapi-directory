...
/**
 * Gets or Sets PolicyQualifierId
 */
@JsonAdapter(PolicyQualifierId.Adapter.class)
public enum PolicyQualifierId {
  ...
  PolicyQualifierId(String value) {
    this.value = value;
  }
  ...
  public static PolicyQualifierId fromValue(String value) {
    for (PolicyQualifierId b : PolicyQualifierId.values()) {
  ...
  public static class Adapter extends TypeAdapter<PolicyQualifierId> {
    @Override
    public void write(final JsonWriter jsonWriter, final PolicyQualifierId enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PolicyQualifierId read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PolicyQualifierId.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PolicyQualifierId.fromValue(value);
  }
}
