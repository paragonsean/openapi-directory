...
* @readonly
*/
export default class AuditReportResponseFormat {
    ...
    /**
    * Returns a <code>AuditReportResponseFormat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AuditReportResponseFormat} The enum <code>AuditReportResponseFormat</code> value.
    */
