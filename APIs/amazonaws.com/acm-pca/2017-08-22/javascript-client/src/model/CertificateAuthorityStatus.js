...
* @readonly
*/
export default class CertificateAuthorityStatus {
    ...
    /**
    * Returns a <code>CertificateAuthorityStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CertificateAuthorityStatus} The enum <code>CertificateAuthorityStatus</code> value.
    */
