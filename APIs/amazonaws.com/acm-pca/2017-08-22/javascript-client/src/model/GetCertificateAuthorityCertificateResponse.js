...
/**
 * The GetCertificateAuthorityCertificateResponse model module.
 * @module model/GetCertificateAuthorityCertificateResponse
 * @version 2017-08-22
 */
class GetCertificateAuthorityCertificateResponse {
    /**
     * Constructs a new <code>GetCertificateAuthorityCertificateResponse</code>.
     * @alias module:model/GetCertificateAuthorityCertificateResponse
     */
    constructor() { 
        
        GetCertificateAuthorityCertificateResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCertificateAuthorityCertificateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCertificateAuthorityCertificateResponse} obj Optional instance to populate.
     * @return {module:model/GetCertificateAuthorityCertificateResponse} The populated <code>GetCertificateAuthorityCertificateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCertificateAuthorityCertificateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCertificateAuthorityCertificateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCertificateAuthorityCertificateResponse</code>.
     */
 ...
 */
GetCertificateAuthorityCertificateResponse.prototype['Certificate'] = undefined;

/**
 * @member {String} CertificateChain
 */
GetCertificateAuthorityCertificateResponse.prototype['CertificateChain'] = undefined;
...
export default GetCertificateAuthorityCertificateResponse;
