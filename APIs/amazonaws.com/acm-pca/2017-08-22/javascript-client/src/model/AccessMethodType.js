...
* @readonly
*/
export default class AccessMethodType {
    ...
    /**
    * Returns a <code>AccessMethodType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AccessMethodType} The enum <code>AccessMethodType</code> value.
    */
