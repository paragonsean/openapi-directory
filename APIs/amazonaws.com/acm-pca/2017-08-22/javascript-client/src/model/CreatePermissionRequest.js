...
class CreatePermissionRequest {
     ...
     * @param actions {Array} 
     */
    constructor(certificateAuthorityArn, principal, actions) { 
        
        CreatePermissionRequest.initialize(this, certificateAuthorityArn, principal, actions);
    }
     ...
     */
    static initialize(obj, certificateAuthorityArn, principal, actions) { 
...
CreatePermissionRequest.RequiredProperties = ["CertificateAuthorityArn", "Principal", "Actions"];

/**
 * @member {String} CertificateAuthorityArn
 */
CreatePermissionRequest.prototype['CertificateAuthorityArn'] = undefined;

/**
 * @member {String} Principal
 */
CreatePermissionRequest.prototype['Principal'] = undefined;

/**
 * @member {String} SourceAccount
 */
CreatePermissionRequest.prototype['SourceAccount'] = undefined;

/**
 * @member {Array} Actions
 */
CreatePermissionRequest.prototype['Actions'] = undefined;
