...
/**
 * The DeletePermissionRequest model module.
 * @module model/DeletePermissionRequest
 * @version 2017-08-22
 */
class DeletePermissionRequest {
    /**
     * Constructs a new <code>DeletePermissionRequest</code>.
     * @alias module:model/DeletePermissionRequest
     * @param certificateAuthorityArn {String} 
     * @param principal {String} 
     */
    constructor(certificateAuthorityArn, principal) { 
        
        DeletePermissionRequest.initialize(this, certificateAuthorityArn, principal);
    }
     ...
     */
    static initialize(obj, certificateAuthorityArn, principal) { 
        obj['CertificateAuthorityArn'] = certificateAuthorityArn;
        obj['Principal'] = principal;
    }

    /**
     * Constructs a <code>DeletePermissionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePermissionRequest} obj Optional instance to populate.
     * @return {module:model/DeletePermissionRequest} The populated <code>DeletePermissionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePermissionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePermissionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePermissionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePermissionRequest.RequiredProperties) {
...
DeletePermissionRequest.RequiredProperties = ["CertificateAuthorityArn", "Principal"];

/**
 * @member {String} CertificateAuthorityArn
 */
DeletePermissionRequest.prototype['CertificateAuthorityArn'] = undefined;

/**
 * @member {String} Principal
 */
DeletePermissionRequest.prototype['Principal'] = undefined;

/**
 * @member {String} SourceAccount
 */
DeletePermissionRequest.prototype['SourceAccount'] = undefined;
...
export default DeletePermissionRequest;
