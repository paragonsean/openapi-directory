...
import ExtendedKeyUsageType from './ExtendedKeyUsageType';
...
class ExtendedKeyUsage {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ExtendedKeyUsageType')) {
                obj['ExtendedKeyUsageType'] = ApiClient.convertToType(data['ExtendedKeyUsageType'], ExtendedKeyUsageType);
            }
            if (data.hasOwnProperty('ExtendedKeyUsageObjectIdentifier')) {
                obj['ExtendedKeyUsageObjectIdentifier'] = ApiClient.convertToType(data['ExtendedKeyUsageObjectIdentifier'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['ExtendedKeyUsageType']) { // data not null
          ExtendedKeyUsageType.validateJSON(data['ExtendedKeyUsageType']);
        }
        // validate the optional field `ExtendedKeyUsageObjectIdentifier`
        if (data['ExtendedKeyUsageObjectIdentifier']) { // data not null
          String.validateJSON(data['ExtendedKeyUsageObjectIdentifier']);
        }
...
/**
 * @member {module:model/ExtendedKeyUsageType} ExtendedKeyUsageType
 */
ExtendedKeyUsage.prototype['ExtendedKeyUsageType'] = undefined;

/**
 * @member {String} ExtendedKeyUsageObjectIdentifier
 */
ExtendedKeyUsage.prototype['ExtendedKeyUsageObjectIdentifier'] = undefined;
