...
/**
 * The AccessMethod model module.
 * @module model/AccessMethod
 * @version 2017-08-22
 */
class AccessMethod {
    /**
     * Constructs a new <code>AccessMethod</code>.
     ...
     * @alias module:model/AccessMethod
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AccessMethod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccessMethod} obj Optional instance to populate.
     * @return {module:model/AccessMethod} The populated <code>AccessMethod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessMethod();
    ...
    /**
     * Validates the JSON data with respect to <code>AccessMethod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessMethod</code>.
     */
