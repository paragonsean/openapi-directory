...
/**
 * The RevocationConfiguration model module.
 * @module model/RevocationConfiguration
 * @version 2017-08-22
 */
class RevocationConfiguration {
    /**
     * Constructs a new <code>RevocationConfiguration</code>.
     ...
     * @alias module:model/RevocationConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RevocationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RevocationConfiguration} obj Optional instance to populate.
     * @return {module:model/RevocationConfiguration} The populated <code>RevocationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RevocationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RevocationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevocationConfiguration</code>.
     */
...
export default RevocationConfiguration;
