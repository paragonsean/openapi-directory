...
* @readonly
*/
export default class S3ObjectAcl {
    ...
    /**
    * Returns a <code>S3ObjectAcl</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/S3ObjectAcl} The enum <code>S3ObjectAcl</code> value.
    */
