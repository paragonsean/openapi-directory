...
/**
 * The DescribeCertificateAuthorityRequest model module.
 * @module model/DescribeCertificateAuthorityRequest
 * @version 2017-08-22
 */
class DescribeCertificateAuthorityRequest {
    /**
     * Constructs a new <code>DescribeCertificateAuthorityRequest</code>.
     * @alias module:model/DescribeCertificateAuthorityRequest
     * @param certificateAuthorityArn {String} 
     */
    constructor(certificateAuthorityArn) { 
        
        DescribeCertificateAuthorityRequest.initialize(this, certificateAuthorityArn);
    }
    ...
    /**
     * Constructs a <code>DescribeCertificateAuthorityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCertificateAuthorityRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCertificateAuthorityRequest} The populated <code>DescribeCertificateAuthorityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCertificateAuthorityRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCertificateAuthorityRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCertificateAuthorityRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeCertificateAuthorityRequest.RequiredProperties) {
...
DescribeCertificateAuthorityRequest.RequiredProperties = ["CertificateAuthorityArn"];

/**
 * @member {String} CertificateAuthorityArn
 */
DescribeCertificateAuthorityRequest.prototype['CertificateAuthorityArn'] = undefined;
...
export default DescribeCertificateAuthorityRequest;
