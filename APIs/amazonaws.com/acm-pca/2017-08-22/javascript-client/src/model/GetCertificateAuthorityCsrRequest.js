...
/**
 * The GetCertificateAuthorityCsrRequest model module.
 * @module model/GetCertificateAuthorityCsrRequest
 * @version 2017-08-22
 */
class GetCertificateAuthorityCsrRequest {
    /**
     * Constructs a new <code>GetCertificateAuthorityCsrRequest</code>.
     * @alias module:model/GetCertificateAuthorityCsrRequest
     * @param certificateAuthorityArn {String} 
     */
    constructor(certificateAuthorityArn) { 
        
        GetCertificateAuthorityCsrRequest.initialize(this, certificateAuthorityArn);
    }
    ...
    /**
     * Constructs a <code>GetCertificateAuthorityCsrRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCertificateAuthorityCsrRequest} obj Optional instance to populate.
     * @return {module:model/GetCertificateAuthorityCsrRequest} The populated <code>GetCertificateAuthorityCsrRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCertificateAuthorityCsrRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCertificateAuthorityCsrRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCertificateAuthorityCsrRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCertificateAuthorityCsrRequest.RequiredProperties) {
...
GetCertificateAuthorityCsrRequest.RequiredProperties = ["CertificateAuthorityArn"];

/**
 * @member {String} CertificateAuthorityArn
 */
GetCertificateAuthorityCsrRequest.prototype['CertificateAuthorityArn'] = undefined;
...
export default GetCertificateAuthorityCsrRequest;
