...
/**
 * The UntagCertificateAuthorityRequest model module.
 * @module model/UntagCertificateAuthorityRequest
 * @version 2017-08-22
 */
class UntagCertificateAuthorityRequest {
    /**
     * Constructs a new <code>UntagCertificateAuthorityRequest</code>.
     * @alias module:model/UntagCertificateAuthorityRequest
     * @param certificateAuthorityArn {String} 
     * @param tags {Array} 
     */
    constructor(certificateAuthorityArn, tags) { 
        
        UntagCertificateAuthorityRequest.initialize(this, certificateAuthorityArn, tags);
    }
    ...
    /**
     * Constructs a <code>UntagCertificateAuthorityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagCertificateAuthorityRequest} obj Optional instance to populate.
     * @return {module:model/UntagCertificateAuthorityRequest} The populated <code>UntagCertificateAuthorityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagCertificateAuthorityRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagCertificateAuthorityRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagCertificateAuthorityRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagCertificateAuthorityRequest.RequiredProperties) {
...
UntagCertificateAuthorityRequest.RequiredProperties = ["CertificateAuthorityArn", "Tags"];

/**
 * @member {String} CertificateAuthorityArn
 */
UntagCertificateAuthorityRequest.prototype['CertificateAuthorityArn'] = undefined;

/**
 * @member {Array} Tags
 */
UntagCertificateAuthorityRequest.prototype['Tags'] = undefined;
...
export default UntagCertificateAuthorityRequest;
