...
* @readonly
*/
export default class CertificateAuthorityUsageMode {
    ...
    /**
    * Returns a <code>CertificateAuthorityUsageMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CertificateAuthorityUsageMode} The enum <code>CertificateAuthorityUsageMode</code> value.
    */
