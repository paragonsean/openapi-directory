...
class PutPolicyRequest {
    ...
    constructor(resourceArn, policy) { 
        ...
        PutPolicyRequest.initialize(this, resourceArn, policy);
    }
...
PutPolicyRequest.RequiredProperties = ["ResourceArn", "Policy"];

/**
 * @member {String} ResourceArn
 */
PutPolicyRequest.prototype['ResourceArn'] = undefined;
