...
/**
 * The EdiPartyName model module.
 * @module model/EdiPartyName
 * @version 2017-08-22
 */
class EdiPartyName {
    /**
     * Constructs a new <code>EdiPartyName</code>.
     ...
     * @alias module:model/EdiPartyName
    ...
    /**
     * Constructs a <code>EdiPartyName</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EdiPartyName} obj Optional instance to populate.
     * @return {module:model/EdiPartyName} The populated <code>EdiPartyName</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EdiPartyName();
    ...
    /**
     * Validates the JSON data with respect to <code>EdiPartyName</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EdiPartyName</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EdiPartyName.RequiredProperties) {
...
EdiPartyName.RequiredProperties = ["PartyName"];
