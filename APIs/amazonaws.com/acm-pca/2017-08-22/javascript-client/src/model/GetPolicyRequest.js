...
/**
 * The GetPolicyRequest model module.
 * @module model/GetPolicyRequest
 * @version 2017-08-22
 */
class GetPolicyRequest {
    /**
     * Constructs a new <code>GetPolicyRequest</code>.
     * @alias module:model/GetPolicyRequest
     * @param resourceArn {String} 
     */
    constructor(resourceArn) { 
        
        GetPolicyRequest.initialize(this, resourceArn);
    }
    ...
    /**
     * Constructs a <code>GetPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyRequest} obj Optional instance to populate.
     * @return {module:model/GetPolicyRequest} The populated <code>GetPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyRequest.RequiredProperties) {
...
GetPolicyRequest.RequiredProperties = ["ResourceArn"];

/**
 * @member {String} ResourceArn
 */
GetPolicyRequest.prototype['ResourceArn'] = undefined;
...
export default GetPolicyRequest;
