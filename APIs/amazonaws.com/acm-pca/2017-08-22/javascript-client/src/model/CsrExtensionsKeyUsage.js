...
/**
 * The CsrExtensionsKeyUsage model module.
 * @module model/CsrExtensionsKeyUsage
 * @version 2017-08-22
 */
class CsrExtensionsKeyUsage {
    /**
     * Constructs a new <code>CsrExtensionsKeyUsage</code>.
     * @alias module:model/CsrExtensionsKeyUsage
     * @implements module:model/KeyUsage
     */
    constructor() { 
        KeyUsage.initialize(this);
        CsrExtensionsKeyUsage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CsrExtensionsKeyUsage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CsrExtensionsKeyUsage} obj Optional instance to populate.
     * @return {module:model/CsrExtensionsKeyUsage} The populated <code>CsrExtensionsKeyUsage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CsrExtensionsKeyUsage();
            KeyUsage.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CsrExtensionsKeyUsage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CsrExtensionsKeyUsage</code>.
     */
 ...
 */
CsrExtensionsKeyUsage.prototype['DigitalSignature'] = undefined;

/**
 * @member {Boolean} NonRepudiation
 */
CsrExtensionsKeyUsage.prototype['NonRepudiation'] = undefined;

/**
 * @member {Boolean} KeyEncipherment
 */
CsrExtensionsKeyUsage.prototype['KeyEncipherment'] = undefined;

/**
 * @member {Boolean} DataEncipherment
 */
CsrExtensionsKeyUsage.prototype['DataEncipherment'] = undefined;

/**
 * @member {Boolean} KeyAgreement
 */
CsrExtensionsKeyUsage.prototype['KeyAgreement'] = undefined;

/**
 * @member {Boolean} KeyCertSign
 */
CsrExtensionsKeyUsage.prototype['KeyCertSign'] = undefined;

/**
 * @member {Boolean} CRLSign
 */
CsrExtensionsKeyUsage.prototype['CRLSign'] = undefined;

/**
 * @member {Boolean} EncipherOnly
 */
CsrExtensionsKeyUsage.prototype['EncipherOnly'] = undefined;

/**
 * @member {Boolean} DecipherOnly
 */
CsrExtensionsKeyUsage.prototype['DecipherOnly'] = undefined;


// Implement KeyUsage interface:
/**
 * @member {Boolean} DigitalSignature
 */
...
export default CsrExtensionsKeyUsage;
