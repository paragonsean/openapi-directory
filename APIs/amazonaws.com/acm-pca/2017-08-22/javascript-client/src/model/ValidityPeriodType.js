...
* @readonly
*/
export default class ValidityPeriodType {
    ...
    /**
    * Returns a <code>ValidityPeriodType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ValidityPeriodType} The enum <code>ValidityPeriodType</code> value.
    */
