...
/**
 * The ImportCertificateAuthorityCertificateRequest model module.
 * @module model/ImportCertificateAuthorityCertificateRequest
 * @version 2017-08-22
 */
class ImportCertificateAuthorityCertificateRequest {
    /**
     * Constructs a new <code>ImportCertificateAuthorityCertificateRequest</code>.
     * @alias module:model/ImportCertificateAuthorityCertificateRequest
     * @param certificateAuthorityArn {String} 
     * @param certificate {String} 
     */
    constructor(certificateAuthorityArn, certificate) { 
        
        ImportCertificateAuthorityCertificateRequest.initialize(this, certificateAuthorityArn, certificate);
    }
     ...
     */
    static initialize(obj, certificateAuthorityArn, certificate) { 
        obj['CertificateAuthorityArn'] = certificateAuthorityArn;
        obj['Certificate'] = certificate;
    }

    /**
     * Constructs a <code>ImportCertificateAuthorityCertificateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportCertificateAuthorityCertificateRequest} obj Optional instance to populate.
     * @return {module:model/ImportCertificateAuthorityCertificateRequest} The populated <code>ImportCertificateAuthorityCertificateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportCertificateAuthorityCertificateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportCertificateAuthorityCertificateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportCertificateAuthorityCertificateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportCertificateAuthorityCertificateRequest.RequiredProperties) {
...
ImportCertificateAuthorityCertificateRequest.RequiredProperties = ["CertificateAuthorityArn", "Certificate"];

/**
 * @member {String} CertificateAuthorityArn
 */
ImportCertificateAuthorityCertificateRequest.prototype['CertificateAuthorityArn'] = undefined;

/**
 * @member {String} Certificate
 */
ImportCertificateAuthorityCertificateRequest.prototype['Certificate'] = undefined;

/**
 * @member {String} CertificateChain
 */
ImportCertificateAuthorityCertificateRequest.prototype['CertificateChain'] = undefined;
...
export default ImportCertificateAuthorityCertificateRequest;
