...
/**
 * The Qualifier model module.
 * @module model/Qualifier
 * @version 2017-08-22
 */
class Qualifier {
    /**
     * Constructs a new <code>Qualifier</code>.
    ...
    /**
     * Constructs a <code>Qualifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Qualifier} obj Optional instance to populate.
     * @return {module:model/Qualifier} The populated <code>Qualifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Qualifier();
    ...
    /**
     * Validates the JSON data with respect to <code>Qualifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Qualifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Qualifier.RequiredProperties) {
...
Qualifier.RequiredProperties = ["CpsUri"];
