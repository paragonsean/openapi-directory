...
/**
 * The OtherName model module.
 * @module model/OtherName
 * @version 2017-08-22
 */
class OtherName {
    /**
     * Constructs a new <code>OtherName</code>.
    ...
    /**
     * Constructs a <code>OtherName</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OtherName} obj Optional instance to populate.
     * @return {module:model/OtherName} The populated <code>OtherName</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OtherName();
    ...
    /**
     * Validates the JSON data with respect to <code>OtherName</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OtherName</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OtherName.RequiredProperties) {
...
OtherName.RequiredProperties = ["TypeId", "Value"];
