...
* @readonly
*/
export default class KeyStorageSecurityStandard {
    
        /**
         * value: "FIPS_140_2_LEVEL_2_OR_HIGHER"
         * @const
         */
        "2_OR_HIGHER" = "FIPS_140_2_LEVEL_2_OR_HIGHER";
         ...
         * @const
         */
        "3_OR_HIGHER" = "FIPS_140_2_LEVEL_3_OR_HIGHER";

    

    /**
    * Returns a <code>KeyStorageSecurityStandard</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeyStorageSecurityStandard} The enum <code>KeyStorageSecurityStandard</code> value.
    */
