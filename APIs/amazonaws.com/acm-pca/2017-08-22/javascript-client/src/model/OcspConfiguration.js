...
/**
 * The OcspConfiguration model module.
 * @module model/OcspConfiguration
 * @version 2017-08-22
 */
class OcspConfiguration {
    /**
     * Constructs a new <code>OcspConfiguration</code>.
     ...
     * @alias module:model/OcspConfiguration
    ...
    /**
     * Constructs a <code>OcspConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OcspConfiguration} obj Optional instance to populate.
     * @return {module:model/OcspConfiguration} The populated <code>OcspConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OcspConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>OcspConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OcspConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OcspConfiguration.RequiredProperties) {
...
OcspConfiguration.RequiredProperties = ["Enabled"];
