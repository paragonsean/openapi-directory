...
* @readonly
*/
export default class CertificateAuthorityType {
    ...
    /**
    * Returns a <code>CertificateAuthorityType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CertificateAuthorityType} The enum <code>CertificateAuthorityType</code> value.
    */
