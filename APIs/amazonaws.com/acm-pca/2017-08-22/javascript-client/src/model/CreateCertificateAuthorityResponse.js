...
/**
 * The CreateCertificateAuthorityResponse model module.
 * @module model/CreateCertificateAuthorityResponse
 * @version 2017-08-22
 */
class CreateCertificateAuthorityResponse {
    /**
     * Constructs a new <code>CreateCertificateAuthorityResponse</code>.
     * @alias module:model/CreateCertificateAuthorityResponse
     */
    constructor() { 
        
        CreateCertificateAuthorityResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCertificateAuthorityResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCertificateAuthorityResponse} obj Optional instance to populate.
     * @return {module:model/CreateCertificateAuthorityResponse} The populated <code>CreateCertificateAuthorityResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCertificateAuthorityResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCertificateAuthorityResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCertificateAuthorityResponse</code>.
     */
 ...
 */
CreateCertificateAuthorityResponse.prototype['CertificateAuthorityArn'] = undefined;
...
export default CreateCertificateAuthorityResponse;
