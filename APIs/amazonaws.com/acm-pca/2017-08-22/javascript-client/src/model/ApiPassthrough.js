...
/**
 * The ApiPassthrough model module.
 * @module model/ApiPassthrough
 * @version 2017-08-22
 */
class ApiPassthrough {
    /**
     * Constructs a new <code>ApiPassthrough</code>.
     ...
     * @alias module:model/ApiPassthrough
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ApiPassthrough</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiPassthrough} obj Optional instance to populate.
     * @return {module:model/ApiPassthrough} The populated <code>ApiPassthrough</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiPassthrough();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiPassthrough</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiPassthrough</code>.
     */
