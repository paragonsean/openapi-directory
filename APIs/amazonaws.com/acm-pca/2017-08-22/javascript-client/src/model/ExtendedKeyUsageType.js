...
* @readonly
*/
export default class ExtendedKeyUsageType {
    ...
    /**
    * Returns a <code>ExtendedKeyUsageType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExtendedKeyUsageType} The enum <code>ExtendedKeyUsageType</code> value.
    */
