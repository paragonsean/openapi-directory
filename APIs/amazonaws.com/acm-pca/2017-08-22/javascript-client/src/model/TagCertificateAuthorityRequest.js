...
/**
 * The TagCertificateAuthorityRequest model module.
 * @module model/TagCertificateAuthorityRequest
 * @version 2017-08-22
 */
class TagCertificateAuthorityRequest {
    /**
     * Constructs a new <code>TagCertificateAuthorityRequest</code>.
     * @alias module:model/TagCertificateAuthorityRequest
     * @param certificateAuthorityArn {String} 
     * @param tags {Array} 
     */
    constructor(certificateAuthorityArn, tags) { 
        
        TagCertificateAuthorityRequest.initialize(this, certificateAuthorityArn, tags);
    }
     ...
     */
    static initialize(obj, certificateAuthorityArn, tags) { 
        obj['CertificateAuthorityArn'] = certificateAuthorityArn;
        obj['Tags'] = tags;
    }

    /**
     * Constructs a <code>TagCertificateAuthorityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagCertificateAuthorityRequest} obj Optional instance to populate.
     * @return {module:model/TagCertificateAuthorityRequest} The populated <code>TagCertificateAuthorityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagCertificateAuthorityRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TagCertificateAuthorityRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagCertificateAuthorityRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TagCertificateAuthorityRequest.RequiredProperties) {
...
TagCertificateAuthorityRequest.RequiredProperties = ["CertificateAuthorityArn", "Tags"];

/**
 * @member {String} CertificateAuthorityArn
 */
TagCertificateAuthorityRequest.prototype['CertificateAuthorityArn'] = undefined;

/**
 * @member {Array} Tags
 */
TagCertificateAuthorityRequest.prototype['Tags'] = undefined;
...
export default TagCertificateAuthorityRequest;
