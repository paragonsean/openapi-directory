...
* @readonly
*/
export default class AuditReportStatus {
    ...
    /**
    * Returns a <code>AuditReportStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AuditReportStatus} The enum <code>AuditReportStatus</code> value.
    */
