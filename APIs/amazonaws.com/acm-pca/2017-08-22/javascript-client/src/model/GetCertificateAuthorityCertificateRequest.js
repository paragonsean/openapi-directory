...
/**
 * The GetCertificateAuthorityCertificateRequest model module.
 * @module model/GetCertificateAuthorityCertificateRequest
 * @version 2017-08-22
 */
class GetCertificateAuthorityCertificateRequest {
    /**
     * Constructs a new <code>GetCertificateAuthorityCertificateRequest</code>.
     * @alias module:model/GetCertificateAuthorityCertificateRequest
     * @param certificateAuthorityArn {String} 
     */
    constructor(certificateAuthorityArn) { 
        
        GetCertificateAuthorityCertificateRequest.initialize(this, certificateAuthorityArn);
    }
    ...
    /**
     * Constructs a <code>GetCertificateAuthorityCertificateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCertificateAuthorityCertificateRequest} obj Optional instance to populate.
     * @return {module:model/GetCertificateAuthorityCertificateRequest} The populated <code>GetCertificateAuthorityCertificateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCertificateAuthorityCertificateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCertificateAuthorityCertificateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCertificateAuthorityCertificateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCertificateAuthorityCertificateRequest.RequiredProperties) {
...
GetCertificateAuthorityCertificateRequest.RequiredProperties = ["CertificateAuthorityArn"];

/**
 * @member {String} CertificateAuthorityArn
 */
GetCertificateAuthorityCertificateRequest.prototype['CertificateAuthorityArn'] = undefined;
...
export default GetCertificateAuthorityCertificateRequest;
