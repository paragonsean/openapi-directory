...
/**
 * The IssueCertificateResponse model module.
 * @module model/IssueCertificateResponse
 * @version 2017-08-22
 */
class IssueCertificateResponse {
    /**
     * Constructs a new <code>IssueCertificateResponse</code>.
     * @alias module:model/IssueCertificateResponse
     */
    constructor() { 
        
        IssueCertificateResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IssueCertificateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IssueCertificateResponse} obj Optional instance to populate.
     * @return {module:model/IssueCertificateResponse} The populated <code>IssueCertificateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IssueCertificateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>IssueCertificateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IssueCertificateResponse</code>.
     */
 ...
 */
IssueCertificateResponse.prototype['CertificateArn'] = undefined;
...
export default IssueCertificateResponse;
