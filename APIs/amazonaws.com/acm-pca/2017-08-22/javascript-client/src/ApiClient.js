...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://acm-pca.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://acm-pca.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-08-22/Javascript'
        };
