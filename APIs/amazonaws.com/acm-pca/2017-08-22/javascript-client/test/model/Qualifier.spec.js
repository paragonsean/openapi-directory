...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.Qualifier();
  });
  ...
  describe('Qualifier', function() {
    it('should create an instance of Qualifier', function() {
      // uncomment below and update the code to test Qualifier
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.Qualifier();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.Qualifier);
    });
