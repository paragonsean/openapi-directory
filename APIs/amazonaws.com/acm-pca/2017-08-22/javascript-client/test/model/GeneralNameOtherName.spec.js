...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GeneralNameOtherName();
  });
  ...
  describe('GeneralNameOtherName', function() {
    it('should create an instance of GeneralNameOtherName', function() {
      // uncomment below and update the code to test GeneralNameOtherName
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GeneralNameOtherName();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GeneralNameOtherName);
    });
