...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.DeleteCertificateAuthorityRequest();
  });
  ...
  describe('DeleteCertificateAuthorityRequest', function() {
    it('should create an instance of DeleteCertificateAuthorityRequest', function() {
      // uncomment below and update the code to test DeleteCertificateAuthorityRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DeleteCertificateAuthorityRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.DeleteCertificateAuthorityRequest);
    });
    ...
    it('should have the property permanentDeletionTimeInDays (base name: "PermanentDeletionTimeInDays")', function() {
      // uncomment below and update the code to test the property permanentDeletionTimeInDays
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DeleteCertificateAuthorityRequest();
      //expect(instance).to.be();
    });
