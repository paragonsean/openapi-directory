...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfigurationCsrExtensions();
  });
  ...
  describe('CertificateAuthorityConfigurationCsrExtensions', function() {
    it('should create an instance of CertificateAuthorityConfigurationCsrExtensions', function() {
      // uncomment below and update the code to test CertificateAuthorityConfigurationCsrExtensions
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfigurationCsrExtensions();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfigurationCsrExtensions);
    });
    ...
    it('should have the property subjectInformationAccess (base name: "SubjectInformationAccess")', function() {
      // uncomment below and update the code to test the property subjectInformationAccess
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfigurationCsrExtensions();
      //expect(instance).to.be();
    });
