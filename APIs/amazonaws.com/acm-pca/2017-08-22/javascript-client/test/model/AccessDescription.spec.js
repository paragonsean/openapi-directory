...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessDescription();
  });
  ...
  describe('AccessDescription', function() {
    it('should create an instance of AccessDescription', function() {
      // uncomment below and update the code to test AccessDescription
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessDescription();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.AccessDescription);
    });
    ...
    it('should have the property accessLocation (base name: "AccessLocation")', function() {
      // uncomment below and update the code to test the property accessLocation
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessDescription();
      //expect(instance).to.be();
    });
