...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ApiPassthrough();
  });
  ...
  describe('ApiPassthrough', function() {
    it('should create an instance of ApiPassthrough', function() {
      // uncomment below and update the code to test ApiPassthrough
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ApiPassthrough();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ApiPassthrough);
    });
