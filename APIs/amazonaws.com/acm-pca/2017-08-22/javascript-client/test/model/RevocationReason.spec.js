...
(function(root, factory) {
  ...
  describe('RevocationReason', function() {
    it('should create an instance of RevocationReason', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.RevocationReason();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.RevocationReason);
    });
