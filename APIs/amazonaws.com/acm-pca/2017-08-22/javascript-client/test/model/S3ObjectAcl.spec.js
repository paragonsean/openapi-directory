...
(function(root, factory) {
  ...
  describe('S3ObjectAcl', function() {
    it('should create an instance of S3ObjectAcl', function() {
      // uncomment below and update the code to test S3ObjectAcl
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.S3ObjectAcl();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.S3ObjectAcl);
    });
