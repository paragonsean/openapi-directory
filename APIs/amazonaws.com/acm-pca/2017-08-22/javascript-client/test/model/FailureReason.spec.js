...
(function(root, factory) {
  ...
  describe('FailureReason', function() {
    it('should create an instance of FailureReason', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.FailureReason();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.FailureReason);
    });
