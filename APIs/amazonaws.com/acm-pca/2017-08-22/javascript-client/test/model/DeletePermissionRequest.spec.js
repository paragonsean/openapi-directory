...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.DeletePermissionRequest();
  });
  ...
  describe('DeletePermissionRequest', function() {
    it('should create an instance of DeletePermissionRequest', function() {
      // uncomment below and update the code to test DeletePermissionRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DeletePermissionRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.DeletePermissionRequest);
    });
