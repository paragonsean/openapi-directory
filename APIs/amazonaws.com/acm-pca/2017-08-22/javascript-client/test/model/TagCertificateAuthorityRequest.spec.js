...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.TagCertificateAuthorityRequest();
  });
  ...
  describe('TagCertificateAuthorityRequest', function() {
    it('should create an instance of TagCertificateAuthorityRequest', function() {
      // uncomment below and update the code to test TagCertificateAuthorityRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.TagCertificateAuthorityRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.TagCertificateAuthorityRequest);
    });
