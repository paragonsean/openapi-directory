...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.RestoreCertificateAuthorityRequest();
  });
  ...
  describe('RestoreCertificateAuthorityRequest', function() {
    it('should create an instance of RestoreCertificateAuthorityRequest', function() {
      // uncomment below and update the code to test RestoreCertificateAuthorityRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.RestoreCertificateAuthorityRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.RestoreCertificateAuthorityRequest);
    });
