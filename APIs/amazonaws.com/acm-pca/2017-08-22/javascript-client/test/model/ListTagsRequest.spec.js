...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ListTagsRequest();
  });
  ...
  describe('ListTagsRequest', function() {
    it('should create an instance of ListTagsRequest', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ListTagsRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ListTagsRequest);
    });
