...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfo();
  });
  ...
  describe('PolicyQualifierInfo', function() {
    it('should create an instance of PolicyQualifierInfo', function() {
      // uncomment below and update the code to test PolicyQualifierInfo
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfo();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfo);
    });

    it('should have the property policyQualifierId (base name: "PolicyQualifierId")', function() {
      // uncomment below and update the code to test the property policyQualifierId
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfo();
