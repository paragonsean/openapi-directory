...
(function(root, factory) {
  ...
  describe('KeyAlgorithm', function() {
    it('should create an instance of KeyAlgorithm', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.KeyAlgorithm();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.KeyAlgorithm);
    });
