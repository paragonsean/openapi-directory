...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.Permission();
  });
  ...
  describe('Permission', function() {
    it('should create an instance of Permission', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.Permission();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.Permission);
    });
