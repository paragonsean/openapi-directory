...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ListTagsResponse();
  });
  ...
  describe('ListTagsResponse', function() {
    it('should create an instance of ListTagsResponse', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ListTagsResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ListTagsResponse);
    });
