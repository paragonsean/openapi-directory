...
(function(root, factory) {
  ...
  describe('ExtendedKeyUsageType', function() {
    it('should create an instance of ExtendedKeyUsageType', function() {
      // uncomment below and update the code to test ExtendedKeyUsageType
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ExtendedKeyUsageType();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ExtendedKeyUsageType);
    });
