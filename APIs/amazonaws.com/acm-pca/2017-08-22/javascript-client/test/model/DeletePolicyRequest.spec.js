...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.DeletePolicyRequest();
  });
  ...
  describe('DeletePolicyRequest', function() {
    it('should create an instance of DeletePolicyRequest', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DeletePolicyRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.DeletePolicyRequest);
    });
