...
(function(root, factory) {
  ...
  describe('PolicyQualifierId', function() {
    it('should create an instance of PolicyQualifierId', function() {
      // uncomment below and update the code to test PolicyQualifierId
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierId();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierId);
    });
