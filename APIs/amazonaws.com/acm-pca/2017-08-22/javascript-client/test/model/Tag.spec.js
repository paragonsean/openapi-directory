...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.Tag();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.Tag);
    });
