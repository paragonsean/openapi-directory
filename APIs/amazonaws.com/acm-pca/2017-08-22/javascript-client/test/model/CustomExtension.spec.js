...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CustomExtension();
  });
  ...
  describe('CustomExtension', function() {
    it('should create an instance of CustomExtension', function() {
      // uncomment below and update the code to test CustomExtension
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CustomExtension();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CustomExtension);
    });
