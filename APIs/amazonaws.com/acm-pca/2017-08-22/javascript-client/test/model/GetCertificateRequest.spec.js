...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateRequest();
  });
  ...
  describe('GetCertificateRequest', function() {
    it('should create an instance of GetCertificateRequest', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetCertificateRequest);
    });
