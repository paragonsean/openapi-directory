...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.RevocationConfiguration();
  });
  ...
  describe('RevocationConfiguration', function() {
    it('should create an instance of RevocationConfiguration', function() {
      // uncomment below and update the code to test RevocationConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.RevocationConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.RevocationConfiguration);
    });
