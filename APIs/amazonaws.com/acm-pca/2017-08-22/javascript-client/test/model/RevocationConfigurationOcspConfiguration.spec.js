...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.RevocationConfigurationOcspConfiguration();
  });
  ...
  describe('RevocationConfigurationOcspConfiguration', function() {
    it('should create an instance of RevocationConfigurationOcspConfiguration', function() {
      // uncomment below and update the code to test RevocationConfigurationOcspConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.RevocationConfigurationOcspConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.RevocationConfigurationOcspConfiguration);
    });
    ...
    it('should have the property ocspCustomCname (base name: "OcspCustomCname")', function() {
      // uncomment below and update the code to test the property ocspCustomCname
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.RevocationConfigurationOcspConfiguration();
      //expect(instance).to.be();
    });
