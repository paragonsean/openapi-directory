...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequest();
  });
  ...
  describe('CreateCertificateAuthorityRequest', function() {
    it('should create an instance of CreateCertificateAuthorityRequest', function() {
      // uncomment below and update the code to test CreateCertificateAuthorityRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequest);
    });
    ...
    it('should have the property certificateAuthorityType (base name: "CertificateAuthorityType")', function() {
      // uncomment below and update the code to test the property certificateAuthorityType
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequest();
      //expect(instance).to.be();
    });
