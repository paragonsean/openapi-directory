...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.UntagCertificateAuthorityRequest();
  });
  ...
  describe('UntagCertificateAuthorityRequest', function() {
    it('should create an instance of UntagCertificateAuthorityRequest', function() {
      // uncomment below and update the code to test UntagCertificateAuthorityRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.UntagCertificateAuthorityRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.UntagCertificateAuthorityRequest);
    });
