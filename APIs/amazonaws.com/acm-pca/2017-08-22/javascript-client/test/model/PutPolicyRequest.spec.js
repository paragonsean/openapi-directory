...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.PutPolicyRequest();
  });
  ...
  describe('PutPolicyRequest', function() {
    it('should create an instance of PutPolicyRequest', function() {
      // uncomment below and update the code to test PutPolicyRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PutPolicyRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.PutPolicyRequest);
    });
