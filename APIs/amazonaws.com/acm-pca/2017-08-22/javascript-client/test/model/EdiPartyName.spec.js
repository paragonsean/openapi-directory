...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.EdiPartyName();
  });
  ...
  describe('EdiPartyName', function() {
    it('should create an instance of EdiPartyName', function() {
      // uncomment below and update the code to test EdiPartyName
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.EdiPartyName();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.EdiPartyName);
    });
