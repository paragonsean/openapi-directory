...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfiguration();
  });
  ...
  describe('CertificateAuthorityConfiguration', function() {
    it('should create an instance of CertificateAuthorityConfiguration', function() {
      // uncomment below and update the code to test CertificateAuthorityConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfiguration);
    });
