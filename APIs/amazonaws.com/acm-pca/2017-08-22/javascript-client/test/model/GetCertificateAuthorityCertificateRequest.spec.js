...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCertificateRequest();
  });
  ...
  describe('GetCertificateAuthorityCertificateRequest', function() {
    it('should create an instance of GetCertificateAuthorityCertificateRequest', function() {
      // uncomment below and update the code to test GetCertificateAuthorityCertificateRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCertificateRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCertificateRequest);
    });
