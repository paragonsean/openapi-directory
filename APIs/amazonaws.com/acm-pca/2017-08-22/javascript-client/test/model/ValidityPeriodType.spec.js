...
(function(root, factory) {
  ...
  describe('ValidityPeriodType', function() {
    it('should create an instance of ValidityPeriodType', function() {
      // uncomment below and update the code to test ValidityPeriodType
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ValidityPeriodType();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ValidityPeriodType);
    });
