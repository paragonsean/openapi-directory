...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCsrRequest();
  });
  ...
  describe('GetCertificateAuthorityCsrRequest', function() {
    it('should create an instance of GetCertificateAuthorityCsrRequest', function() {
      // uncomment below and update the code to test GetCertificateAuthorityCsrRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCsrRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCsrRequest);
    });
