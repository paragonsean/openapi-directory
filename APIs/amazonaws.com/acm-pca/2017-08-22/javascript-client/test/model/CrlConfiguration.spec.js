...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CrlConfiguration();
  });
  ...
  describe('CrlConfiguration', function() {
    it('should create an instance of CrlConfiguration', function() {
      // uncomment below and update the code to test CrlConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CrlConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CrlConfiguration);
    });
