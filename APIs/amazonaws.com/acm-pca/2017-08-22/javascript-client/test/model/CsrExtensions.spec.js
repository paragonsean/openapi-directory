...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CsrExtensions();
  });
  ...
  describe('CsrExtensions', function() {
    it('should create an instance of CsrExtensions', function() {
      // uncomment below and update the code to test CsrExtensions
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CsrExtensions();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CsrExtensions);
    });
