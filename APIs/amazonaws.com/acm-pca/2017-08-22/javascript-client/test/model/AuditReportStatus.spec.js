...
(function(root, factory) {
  ...
  describe('AuditReportStatus', function() {
    it('should create an instance of AuditReportStatus', function() {
      // uncomment below and update the code to test AuditReportStatus
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AuditReportStatus();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.AuditReportStatus);
    });
