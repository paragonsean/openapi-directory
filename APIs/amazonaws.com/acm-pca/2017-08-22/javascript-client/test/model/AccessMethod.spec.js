...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessMethod();
  });
  ...
  describe('AccessMethod', function() {
    it('should create an instance of AccessMethod', function() {
      // uncomment below and update the code to test AccessMethod
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessMethod();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.AccessMethod);
    });

    it('should have the property customObjectIdentifier (base name: "CustomObjectIdentifier")', function() {
      // uncomment below and update the code to test the property customObjectIdentifier
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessMethod();
      //expect(instance).to.be();
    });

    it('should have the property accessMethodType (base name: "AccessMethodType")', function() {
      // uncomment below and update the code to test the property accessMethodType
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessMethod();
      //expect(instance).to.be();
    });
