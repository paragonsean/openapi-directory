...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CreatePermissionRequest();
  });
  ...
  describe('CreatePermissionRequest', function() {
    it('should create an instance of CreatePermissionRequest', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreatePermissionRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CreatePermissionRequest);
    });
