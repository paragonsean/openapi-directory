...
(function(root, factory) {
  ...
  describe('ResourceOwner', function() {
    it('should create an instance of ResourceOwner', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ResourceOwner();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ResourceOwner);
    });
