...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfoQualifier();
  });
  ...
  describe('PolicyQualifierInfoQualifier', function() {
    it('should create an instance of PolicyQualifierInfoQualifier', function() {
      // uncomment below and update the code to test PolicyQualifierInfoQualifier
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfoQualifier();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfoQualifier);
    });

    it('should have the property cpsUri (base name: "CpsUri")', function() {
      // uncomment below and update the code to test the property cpsUri
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyQualifierInfoQualifier();
