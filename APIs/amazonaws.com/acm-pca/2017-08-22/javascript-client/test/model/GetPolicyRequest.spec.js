...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetPolicyRequest();
  });
  ...
  describe('GetPolicyRequest', function() {
    it('should create an instance of GetPolicyRequest', function() {
      // uncomment below and update the code to test GetPolicyRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetPolicyRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetPolicyRequest);
    });
