...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCsrResponse();
  });
  ...
  describe('GetCertificateAuthorityCsrResponse', function() {
    it('should create an instance of GetCertificateAuthorityCsrResponse', function() {
      // uncomment below and update the code to test GetCertificateAuthorityCsrResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCsrResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCsrResponse);
    });
