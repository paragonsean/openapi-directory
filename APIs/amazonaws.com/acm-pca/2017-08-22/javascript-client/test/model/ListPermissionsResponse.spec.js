...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ListPermissionsResponse();
  });
  ...
  describe('ListPermissionsResponse', function() {
    it('should create an instance of ListPermissionsResponse', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ListPermissionsResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ListPermissionsResponse);
    });
