...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CustomAttribute();
  });
  ...
  describe('CustomAttribute', function() {
    it('should create an instance of CustomAttribute', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CustomAttribute();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CustomAttribute);
    });
