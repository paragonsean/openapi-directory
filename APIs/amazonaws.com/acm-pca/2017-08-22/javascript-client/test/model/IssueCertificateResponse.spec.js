...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateResponse();
  });
  ...
  describe('IssueCertificateResponse', function() {
    it('should create an instance of IssueCertificateResponse', function() {
      // uncomment below and update the code to test IssueCertificateResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateResponse);
    });
