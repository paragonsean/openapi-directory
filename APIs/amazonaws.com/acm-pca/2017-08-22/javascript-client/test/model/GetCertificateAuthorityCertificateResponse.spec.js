...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCertificateResponse();
  });
  ...
  describe('GetCertificateAuthorityCertificateResponse', function() {
    it('should create an instance of GetCertificateAuthorityCertificateResponse', function() {
      // uncomment below and update the code to test GetCertificateAuthorityCertificateResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCertificateResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetCertificateAuthorityCertificateResponse);
    });
