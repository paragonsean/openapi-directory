...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.RevokeCertificateRequest();
  });
  ...
  describe('RevokeCertificateRequest', function() {
    it('should create an instance of RevokeCertificateRequest', function() {
      // uncomment below and update the code to test RevokeCertificateRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.RevokeCertificateRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.RevokeCertificateRequest);
    });
    ...
    it('should have the property certificateSerial (base name: "CertificateSerial")', function() {
      // uncomment below and update the code to test the property certificateSerial
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.RevokeCertificateRequest();
      //expect(instance).to.be();
    });
