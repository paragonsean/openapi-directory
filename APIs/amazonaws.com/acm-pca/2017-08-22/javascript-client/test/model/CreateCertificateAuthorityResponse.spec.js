...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityResponse();
  });
  ...
  describe('CreateCertificateAuthorityResponse', function() {
    it('should create an instance of CreateCertificateAuthorityResponse', function() {
      // uncomment below and update the code to test CreateCertificateAuthorityResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityResponse);
    });
