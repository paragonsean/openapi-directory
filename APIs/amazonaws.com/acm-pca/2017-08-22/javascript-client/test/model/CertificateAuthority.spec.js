...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthority();
  });
  ...
  describe('CertificateAuthority', function() {
    it('should create an instance of CertificateAuthority', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthority();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthority);
    });
