...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateResponse();
  });
  ...
  describe('GetCertificateResponse', function() {
    it('should create an instance of GetCertificateResponse', function() {
      // uncomment below and update the code to test GetCertificateResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetCertificateResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetCertificateResponse);
    });
