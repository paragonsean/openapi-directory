...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequest();
  });
  ...
  describe('UpdateCertificateAuthorityRequest', function() {
    it('should create an instance of UpdateCertificateAuthorityRequest', function() {
      // uncomment below and update the code to test UpdateCertificateAuthorityRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequest);
    });
