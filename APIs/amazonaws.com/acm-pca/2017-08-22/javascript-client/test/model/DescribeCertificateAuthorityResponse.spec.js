...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityResponse();
  });
  ...
  describe('DescribeCertificateAuthorityResponse', function() {
    it('should create an instance of DescribeCertificateAuthorityResponse', function() {
      // uncomment below and update the code to test DescribeCertificateAuthorityResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityResponse);
    });
