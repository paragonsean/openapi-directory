...
(function(root, factory) {
  ...
  describe('ActionType', function() {
    it('should create an instance of ActionType', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ActionType();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ActionType);
    });
