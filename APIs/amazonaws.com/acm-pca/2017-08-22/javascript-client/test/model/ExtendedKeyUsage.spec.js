...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ExtendedKeyUsage();
  });
  ...
  describe('ExtendedKeyUsage', function() {
    it('should create an instance of ExtendedKeyUsage', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ExtendedKeyUsage();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ExtendedKeyUsage);
    });

    it('should have the property extendedKeyUsageType (base name: "ExtendedKeyUsageType")', function() {
      // uncomment below and update the code to test the property extendedKeyUsageType
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ExtendedKeyUsage();
      //expect(instance).to.be();
    });

    it('should have the property extendedKeyUsageObjectIdentifier (base name: "ExtendedKeyUsageObjectIdentifier")', function() {
      // uncomment below and update the code to test the property extendedKeyUsageObjectIdentifier
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ExtendedKeyUsage();
      //expect(instance).to.be();
    });
