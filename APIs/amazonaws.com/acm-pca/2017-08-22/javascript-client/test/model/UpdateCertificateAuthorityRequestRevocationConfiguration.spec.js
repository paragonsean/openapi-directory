...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequestRevocationConfiguration();
  });
  ...
  describe('UpdateCertificateAuthorityRequestRevocationConfiguration', function() {
    it('should create an instance of UpdateCertificateAuthorityRequestRevocationConfiguration', function() {
      // uncomment below and update the code to test UpdateCertificateAuthorityRequestRevocationConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequestRevocationConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequestRevocationConfiguration);
    });

    it('should have the property crlConfiguration (base name: "CrlConfiguration")', function() {
      // uncomment below and update the code to test the property crlConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequestRevocationConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property ocspConfiguration (base name: "OcspConfiguration")', function() {
      // uncomment below and update the code to test the property ocspConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.UpdateCertificateAuthorityRequestRevocationConfiguration();
      //expect(instance).to.be();
    });
