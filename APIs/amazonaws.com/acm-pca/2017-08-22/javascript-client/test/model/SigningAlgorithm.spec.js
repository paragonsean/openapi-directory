...
(function(root, factory) {
  ...
  describe('SigningAlgorithm', function() {
    it('should create an instance of SigningAlgorithm', function() {
      // uncomment below and update the code to test SigningAlgorithm
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.SigningAlgorithm();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.SigningAlgorithm);
    });
