...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequestRevocationConfiguration();
  });
  ...
  describe('CreateCertificateAuthorityRequestRevocationConfiguration', function() {
    it('should create an instance of CreateCertificateAuthorityRequestRevocationConfiguration', function() {
      // uncomment below and update the code to test CreateCertificateAuthorityRequestRevocationConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequestRevocationConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequestRevocationConfiguration);
    });
