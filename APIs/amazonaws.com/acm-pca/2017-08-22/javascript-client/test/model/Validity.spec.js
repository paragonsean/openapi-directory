...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.Validity();
  });
  ...
  describe('Validity', function() {
    it('should create an instance of Validity', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.Validity();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.Validity);
    });
