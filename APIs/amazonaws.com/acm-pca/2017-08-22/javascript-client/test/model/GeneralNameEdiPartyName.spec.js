...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GeneralNameEdiPartyName();
  });
  ...
  describe('GeneralNameEdiPartyName', function() {
    it('should create an instance of GeneralNameEdiPartyName', function() {
      // uncomment below and update the code to test GeneralNameEdiPartyName
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GeneralNameEdiPartyName();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GeneralNameEdiPartyName);
    });
    ...
    it('should have the property nameAssigner (base name: "NameAssigner")', function() {
      // uncomment below and update the code to test the property nameAssigner
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GeneralNameEdiPartyName();
      //expect(instance).to.be();
    });
