...
(function(root, factory) {
  ...
  describe('CertificateAuthorityType', function() {
    it('should create an instance of CertificateAuthorityType', function() {
      // uncomment below and update the code to test CertificateAuthorityType
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityType();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityType);
    });
