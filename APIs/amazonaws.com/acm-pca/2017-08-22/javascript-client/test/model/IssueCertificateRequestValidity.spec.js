...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestValidity();
  });
  ...
  describe('IssueCertificateRequestValidity', function() {
    it('should create an instance of IssueCertificateRequestValidity', function() {
      // uncomment below and update the code to test IssueCertificateRequestValidity
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestValidity();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestValidity);
    });
