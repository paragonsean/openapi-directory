...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ImportCertificateAuthorityCertificateRequest();
  });
  ...
  describe('ImportCertificateAuthorityCertificateRequest', function() {
    it('should create an instance of ImportCertificateAuthorityCertificateRequest', function() {
      // uncomment below and update the code to test ImportCertificateAuthorityCertificateRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ImportCertificateAuthorityCertificateRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ImportCertificateAuthorityCertificateRequest);
    });
