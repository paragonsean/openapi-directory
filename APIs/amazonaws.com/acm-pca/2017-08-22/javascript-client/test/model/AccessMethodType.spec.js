...
(function(root, factory) {
  ...
  describe('AccessMethodType', function() {
    it('should create an instance of AccessMethodType', function() {
      // uncomment below and update the code to test AccessMethodType
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessMethodType();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.AccessMethodType);
    });
