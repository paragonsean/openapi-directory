...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityAuditReportResponse();
  });
  ...
  describe('DescribeCertificateAuthorityAuditReportResponse', function() {
    it('should create an instance of DescribeCertificateAuthorityAuditReportResponse', function() {
      // uncomment below and update the code to test DescribeCertificateAuthorityAuditReportResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityAuditReportResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityAuditReportResponse);
    });

    it('should have the property auditReportStatus (base name: "AuditReportStatus")', function() {
      // uncomment below and update the code to test the property auditReportStatus
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityAuditReportResponse();
