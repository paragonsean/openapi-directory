...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GetPolicyResponse();
  });
  ...
  describe('GetPolicyResponse', function() {
    it('should create an instance of GetPolicyResponse', function() {
      // uncomment below and update the code to test GetPolicyResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GetPolicyResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GetPolicyResponse);
    });
