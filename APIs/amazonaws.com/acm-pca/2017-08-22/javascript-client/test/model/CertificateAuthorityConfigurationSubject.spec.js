...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfigurationSubject();
  });
  ...
  describe('CertificateAuthorityConfigurationSubject', function() {
    it('should create an instance of CertificateAuthorityConfigurationSubject', function() {
      // uncomment below and update the code to test CertificateAuthorityConfigurationSubject
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfigurationSubject();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityConfigurationSubject);
    });
