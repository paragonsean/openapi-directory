...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CsrExtensionsKeyUsage();
  });
  ...
  describe('CsrExtensionsKeyUsage', function() {
    it('should create an instance of CsrExtensionsKeyUsage', function() {
      // uncomment below and update the code to test CsrExtensionsKeyUsage
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CsrExtensionsKeyUsage();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CsrExtensionsKeyUsage);
    });
