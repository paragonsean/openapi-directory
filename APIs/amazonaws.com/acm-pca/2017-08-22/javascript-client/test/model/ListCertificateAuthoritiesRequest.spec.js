...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ListCertificateAuthoritiesRequest();
  });
  ...
  describe('ListCertificateAuthoritiesRequest', function() {
    it('should create an instance of ListCertificateAuthoritiesRequest', function() {
      // uncomment below and update the code to test ListCertificateAuthoritiesRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ListCertificateAuthoritiesRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ListCertificateAuthoritiesRequest);
    });
