...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.GeneralName();
  });
  ...
  describe('GeneralName', function() {
    it('should create an instance of GeneralName', function() {
      // uncomment below and update the code to test GeneralName
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.GeneralName();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.GeneralName);
    });
