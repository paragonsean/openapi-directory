...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityCertificateAuthorityConfiguration();
  });
  ...
  describe('CertificateAuthorityCertificateAuthorityConfiguration', function() {
    it('should create an instance of CertificateAuthorityCertificateAuthorityConfiguration', function() {
      // uncomment below and update the code to test CertificateAuthorityCertificateAuthorityConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityCertificateAuthorityConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityCertificateAuthorityConfiguration);
    });
    ...
    it('should have the property csrExtensions (base name: "CsrExtensions")', function() {
      // uncomment below and update the code to test the property csrExtensions
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityCertificateAuthorityConfiguration();
      //expect(instance).to.be();
    });
