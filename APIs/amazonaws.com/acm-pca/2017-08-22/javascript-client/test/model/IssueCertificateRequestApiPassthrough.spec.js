...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestApiPassthrough();
  });
  ...
  describe('IssueCertificateRequestApiPassthrough', function() {
    it('should create an instance of IssueCertificateRequestApiPassthrough', function() {
      // uncomment below and update the code to test IssueCertificateRequestApiPassthrough
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestApiPassthrough();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestApiPassthrough);
    });
