...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.OcspConfiguration();
  });
  ...
  describe('OcspConfiguration', function() {
    it('should create an instance of OcspConfiguration', function() {
      // uncomment below and update the code to test OcspConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.OcspConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.OcspConfiguration);
    });
