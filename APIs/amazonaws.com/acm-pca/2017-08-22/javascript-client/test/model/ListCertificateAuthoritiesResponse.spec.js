...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ListCertificateAuthoritiesResponse();
  });
  ...
  describe('ListCertificateAuthoritiesResponse', function() {
    it('should create an instance of ListCertificateAuthoritiesResponse', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ListCertificateAuthoritiesResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ListCertificateAuthoritiesResponse);
    });
