...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ApiPassthroughExtensions();
  });
  ...
  describe('ApiPassthroughExtensions', function() {
    it('should create an instance of ApiPassthroughExtensions', function() {
      // uncomment below and update the code to test ApiPassthroughExtensions
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ApiPassthroughExtensions();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ApiPassthroughExtensions);
    });
    ...
    it('should have the property customExtensions (base name: "CustomExtensions")', function() {
      // uncomment below and update the code to test the property customExtensions
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ApiPassthroughExtensions();
      //expect(instance).to.be();
    });
