...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportRequest();
  });
  ...
  describe('CreateCertificateAuthorityAuditReportRequest', function() {
    it('should create an instance of CreateCertificateAuthorityAuditReportRequest', function() {
      // uncomment below and update the code to test CreateCertificateAuthorityAuditReportRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportRequest);
    });
    ...
    it('should have the property auditReportResponseFormat (base name: "AuditReportResponseFormat")', function() {
      // uncomment below and update the code to test the property auditReportResponseFormat
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportRequest();
      //expect(instance).to.be();
    });
