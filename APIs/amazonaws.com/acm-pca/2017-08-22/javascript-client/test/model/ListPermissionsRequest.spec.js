...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.ListPermissionsRequest();
  });
  ...
  describe('ListPermissionsRequest', function() {
    it('should create an instance of ListPermissionsRequest', function() {
      ...
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.ListPermissionsRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.ListPermissionsRequest);
    });
