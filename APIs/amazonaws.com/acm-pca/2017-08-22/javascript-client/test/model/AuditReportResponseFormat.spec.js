...
(function(root, factory) {
  ...
  describe('AuditReportResponseFormat', function() {
    it('should create an instance of AuditReportResponseFormat', function() {
      // uncomment below and update the code to test AuditReportResponseFormat
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AuditReportResponseFormat();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.AuditReportResponseFormat);
    });
