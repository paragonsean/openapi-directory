...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyInformation();
  });
  ...
  describe('PolicyInformation', function() {
    it('should create an instance of PolicyInformation', function() {
      // uncomment below and update the code to test PolicyInformation
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyInformation();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.PolicyInformation);
    });

    it('should have the property certPolicyId (base name: "CertPolicyId")', function() {
      // uncomment below and update the code to test the property certPolicyId
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyInformation();
      //expect(instance).to.be();
    });

    it('should have the property policyQualifiers (base name: "PolicyQualifiers")', function() {
      // uncomment below and update the code to test the property policyQualifiers
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.PolicyInformation();
      //expect(instance).to.be();
    });
