...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequest();
  });
  ...
  describe('IssueCertificateRequest', function() {
    it('should create an instance of IssueCertificateRequest', function() {
      // uncomment below and update the code to test IssueCertificateRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequest);
    });

    it('should have the property apiPassthrough (base name: "ApiPassthrough")', function() {
      // uncomment below and update the code to test the property apiPassthrough
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequest();
    ...
    it('should have the property validityNotBefore (base name: "ValidityNotBefore")', function() {
      // uncomment below and update the code to test the property validityNotBefore
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequest();
      //expect(instance).to.be();
    });
