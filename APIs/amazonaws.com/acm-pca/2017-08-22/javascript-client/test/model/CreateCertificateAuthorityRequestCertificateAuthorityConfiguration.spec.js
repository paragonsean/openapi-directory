...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequestCertificateAuthorityConfiguration();
  });
  ...
  describe('CreateCertificateAuthorityRequestCertificateAuthorityConfiguration', function() {
    it('should create an instance of CreateCertificateAuthorityRequestCertificateAuthorityConfiguration', function() {
      // uncomment below and update the code to test CreateCertificateAuthorityRequestCertificateAuthorityConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequestCertificateAuthorityConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityRequestCertificateAuthorityConfiguration);
    });
