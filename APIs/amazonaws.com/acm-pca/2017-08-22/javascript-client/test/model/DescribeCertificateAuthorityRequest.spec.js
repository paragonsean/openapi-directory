...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityRequest();
  });
  ...
  describe('DescribeCertificateAuthorityRequest', function() {
    it('should create an instance of DescribeCertificateAuthorityRequest', function() {
      // uncomment below and update the code to test DescribeCertificateAuthorityRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityRequest);
    });
