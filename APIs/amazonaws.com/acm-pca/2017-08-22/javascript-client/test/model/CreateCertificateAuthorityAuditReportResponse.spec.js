...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportResponse();
  });
  ...
  describe('CreateCertificateAuthorityAuditReportResponse', function() {
    it('should create an instance of CreateCertificateAuthorityAuditReportResponse', function() {
      // uncomment below and update the code to test CreateCertificateAuthorityAuditReportResponse
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportResponse();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportResponse);
    });

    it('should have the property auditReportId (base name: "AuditReportId")', function() {
      // uncomment below and update the code to test the property auditReportId
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CreateCertificateAuthorityAuditReportResponse();
