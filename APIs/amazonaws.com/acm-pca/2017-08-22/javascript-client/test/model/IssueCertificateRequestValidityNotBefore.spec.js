...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestValidityNotBefore();
  });
  ...
  describe('IssueCertificateRequestValidityNotBefore', function() {
    it('should create an instance of IssueCertificateRequestValidityNotBefore', function() {
      // uncomment below and update the code to test IssueCertificateRequestValidityNotBefore
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestValidityNotBefore();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.IssueCertificateRequestValidityNotBefore);
    });
