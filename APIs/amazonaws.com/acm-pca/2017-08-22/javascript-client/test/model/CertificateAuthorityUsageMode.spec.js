...
(function(root, factory) {
  ...
  describe('CertificateAuthorityUsageMode', function() {
    it('should create an instance of CertificateAuthorityUsageMode', function() {
      // uncomment below and update the code to test CertificateAuthorityUsageMode
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityUsageMode();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityUsageMode);
    });
