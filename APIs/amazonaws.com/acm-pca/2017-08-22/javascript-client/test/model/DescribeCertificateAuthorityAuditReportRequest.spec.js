...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityAuditReportRequest();
  });
  ...
  describe('DescribeCertificateAuthorityAuditReportRequest', function() {
    it('should create an instance of DescribeCertificateAuthorityAuditReportRequest', function() {
      // uncomment below and update the code to test DescribeCertificateAuthorityAuditReportRequest
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityAuditReportRequest();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.DescribeCertificateAuthorityAuditReportRequest);
    });
