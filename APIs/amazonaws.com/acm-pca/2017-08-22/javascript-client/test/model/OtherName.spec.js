...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.OtherName();
  });
  ...
  describe('OtherName', function() {
    it('should create an instance of OtherName', function() {
      // uncomment below and update the code to test OtherName
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.OtherName();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.OtherName);
    });
