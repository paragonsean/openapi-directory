...
(function(root, factory) {
  ...
  describe('CertificateAuthorityStatus', function() {
    it('should create an instance of CertificateAuthorityStatus', function() {
      // uncomment below and update the code to test CertificateAuthorityStatus
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityStatus();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityStatus);
    });
