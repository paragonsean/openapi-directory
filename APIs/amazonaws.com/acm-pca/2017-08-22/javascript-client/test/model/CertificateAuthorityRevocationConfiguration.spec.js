...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityRevocationConfiguration();
  });
  ...
  describe('CertificateAuthorityRevocationConfiguration', function() {
    it('should create an instance of CertificateAuthorityRevocationConfiguration', function() {
      // uncomment below and update the code to test CertificateAuthorityRevocationConfiguration
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityRevocationConfiguration();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.CertificateAuthorityRevocationConfiguration);
    });
