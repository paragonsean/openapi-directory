...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessDescriptionAccessMethod();
  });
  ...
  describe('AccessDescriptionAccessMethod', function() {
    it('should create an instance of AccessDescriptionAccessMethod', function() {
      // uncomment below and update the code to test AccessDescriptionAccessMethod
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.AccessDescriptionAccessMethod();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.AccessDescriptionAccessMethod);
    });
