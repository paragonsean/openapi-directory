...
(function(root, factory) {
  ...
  describe('KeyStorageSecurityStandard', function() {
    it('should create an instance of KeyStorageSecurityStandard', function() {
      // uncomment below and update the code to test KeyStorageSecurityStandard
      //var instance = new AwsCertificateManagerPrivateCertificateAuthority.KeyStorageSecurityStandard();
      //expect(instance).to.be.a(AwsCertificateManagerPrivateCertificateAuthority.KeyStorageSecurityStandard);
    });
