...
/*
 * OAIGetCertificateAuthorityCsrResponse.h
 *
 * 
 */

#ifndef OAIGetCertificateAuthorityCsrResponse_H
#define OAIGetCertificateAuthorityCsrResponse_H
...
class OAIGetCertificateAuthorityCsrResponse : public OAIObject {
public:
    OAIGetCertificateAuthorityCsrResponse();
    OAIGetCertificateAuthorityCsrResponse(QString json);
    ~OAIGetCertificateAuthorityCsrResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCertificateAuthorityCsrResponse)

#endif // OAIGetCertificateAuthorityCsrResponse_H
