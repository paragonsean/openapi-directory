...
/*
 * OAIGetCertificateAuthorityCertificateRequest.h
 *
 * 
 */

#ifndef OAIGetCertificateAuthorityCertificateRequest_H
#define OAIGetCertificateAuthorityCertificateRequest_H
...
class OAIGetCertificateAuthorityCertificateRequest : public OAIObject {
public:
    OAIGetCertificateAuthorityCertificateRequest();
    OAIGetCertificateAuthorityCertificateRequest(QString json);
    ~OAIGetCertificateAuthorityCertificateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCertificateAuthorityCertificateRequest)

#endif // OAIGetCertificateAuthorityCertificateRequest_H
