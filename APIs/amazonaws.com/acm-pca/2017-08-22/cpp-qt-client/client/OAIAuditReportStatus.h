...
/*
 * OAIAuditReportStatus.h
 *
 * 
 */

#ifndef OAIAuditReportStatus_H
#define OAIAuditReportStatus_H
...
class OAIAuditReportStatus : public OAIEnum {
public:
    OAIAuditReportStatus();
    OAIAuditReportStatus(QString json);
    ~OAIAuditReportStatus() override;
    ...
    enum class eOAIAuditReportStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CREATING, 
        SUCCESS, 
        FAILED
    };
    OAIAuditReportStatus::eOAIAuditReportStatus getValue() const;
    void setValue(const OAIAuditReportStatus::eOAIAuditReportStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuditReportStatus)

#endif // OAIAuditReportStatus_H
