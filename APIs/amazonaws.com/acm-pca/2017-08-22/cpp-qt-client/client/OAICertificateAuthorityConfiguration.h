...
/*
 * OAICertificateAuthorityConfiguration.h
 *
...
#ifndef OAICertificateAuthorityConfiguration_H
#define OAICertificateAuthorityConfiguration_H
...
class OAICertificateAuthorityConfiguration : public OAIObject {
public:
    OAICertificateAuthorityConfiguration();
    OAICertificateAuthorityConfiguration(QString json);
    ~OAICertificateAuthorityConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAuthorityConfiguration)

#endif // OAICertificateAuthorityConfiguration_H
