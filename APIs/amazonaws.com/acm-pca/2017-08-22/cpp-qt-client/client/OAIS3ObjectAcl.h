...
#ifndef OAIS3ObjectAcl_H
#define OAIS3ObjectAcl_H
...
class OAIS3ObjectAcl : public OAIEnum {
public:
    OAIS3ObjectAcl();
    OAIS3ObjectAcl(QString json);
    ~OAIS3ObjectAcl() override;
    ...
    enum class eOAIS3ObjectAcl {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PUBLIC_READ, 
        BUCKET_OWNER_FULL_CONTROL
    };
    OAIS3ObjectAcl::eOAIS3ObjectAcl getValue() const;
    void setValue(const OAIS3ObjectAcl::eOAIS3ObjectAcl& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3ObjectAcl)

#endif // OAIS3ObjectAcl_H
