...
/*
 * OAIKeyStorageSecurityStandard.h
 *
 * 
 */

#ifndef OAIKeyStorageSecurityStandard_H
#define OAIKeyStorageSecurityStandard_H
...
class OAIKeyStorageSecurityStandard : public OAIEnum {
public:
    OAIKeyStorageSecurityStandard();
    OAIKeyStorageSecurityStandard(QString json);
    ~OAIKeyStorageSecurityStandard() override;
    ...
    enum class eOAIKeyStorageSecurityStandard {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        _2_OR_HIGHER, 
        _3_OR_HIGHER
    };
    OAIKeyStorageSecurityStandard::eOAIKeyStorageSecurityStandard getValue() const;
    void setValue(const OAIKeyStorageSecurityStandard::eOAIKeyStorageSecurityStandard& value);
...
private:
    ...
    eOAIKeyStorageSecurityStandard m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyStorageSecurityStandard)

#endif // OAIKeyStorageSecurityStandard_H
