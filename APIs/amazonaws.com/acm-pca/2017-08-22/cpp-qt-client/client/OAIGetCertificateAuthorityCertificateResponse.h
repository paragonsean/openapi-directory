...
/*
 * OAIGetCertificateAuthorityCertificateResponse.h
 *
 * 
 */

#ifndef OAIGetCertificateAuthorityCertificateResponse_H
#define OAIGetCertificateAuthorityCertificateResponse_H
...
class OAIGetCertificateAuthorityCertificateResponse : public OAIObject {
public:
    OAIGetCertificateAuthorityCertificateResponse();
    OAIGetCertificateAuthorityCertificateResponse(QString json);
    ~OAIGetCertificateAuthorityCertificateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCertificateAuthorityCertificateResponse)

#endif // OAIGetCertificateAuthorityCertificateResponse_H
