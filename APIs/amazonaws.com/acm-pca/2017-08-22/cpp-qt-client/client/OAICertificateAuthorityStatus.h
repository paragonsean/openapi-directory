...
/*
 * OAICertificateAuthorityStatus.h
 *
 * 
 */

#ifndef OAICertificateAuthorityStatus_H
#define OAICertificateAuthorityStatus_H
...
class OAICertificateAuthorityStatus : public OAIEnum {
public:
    OAICertificateAuthorityStatus();
    OAICertificateAuthorityStatus(QString json);
    ~OAICertificateAuthorityStatus() override;
    ...
    enum class eOAICertificateAuthorityStatus {
    ...
    OAICertificateAuthorityStatus::eOAICertificateAuthorityStatus getValue() const;
    void setValue(const OAICertificateAuthorityStatus::eOAICertificateAuthorityStatus& value);
...
private:
    ...
    eOAICertificateAuthorityStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAuthorityStatus)

#endif // OAICertificateAuthorityStatus_H
