...
OAICertificateAuthority_CertificateAuthorityConfiguration::OAICertificateAuthority_CertificateAuthorityConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICertificateAuthority_CertificateAuthorityConfiguration::OAICertificateAuthority_CertificateAuthorityConfiguration() {
    this->initializeModel();
}

OAICertificateAuthority_CertificateAuthorityConfiguration::~OAICertificateAuthority_CertificateAuthorityConfiguration() {}

void OAICertificateAuthority_CertificateAuthorityConfiguration::initializeModel() {
...
void OAICertificateAuthority_CertificateAuthorityConfiguration::fromJson(QString jsonString) {
...
void OAICertificateAuthority_CertificateAuthorityConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICertificateAuthority_CertificateAuthorityConfiguration::asJson() const {
...
QJsonObject OAICertificateAuthority_CertificateAuthorityConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIKeyAlgorithm OAICertificateAuthority_CertificateAuthorityConfiguration::getKeyAlgorithm() const {
    return m_key_algorithm;
}
void OAICertificateAuthority_CertificateAuthorityConfiguration::setKeyAlgorithm(const OAIKeyAlgorithm &key_algorithm) {
    m_key_algorithm = key_algorithm;
    m_key_algorithm_isSet = true;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_key_algorithm_Set() const{
    return m_key_algorithm_isSet;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_key_algorithm_Valid() const{
    return m_key_algorithm_isValid;
}

OAISigningAlgorithm OAICertificateAuthority_CertificateAuthorityConfiguration::getSigningAlgorithm() const {
    return m_signing_algorithm;
}
void OAICertificateAuthority_CertificateAuthorityConfiguration::setSigningAlgorithm(const OAISigningAlgorithm &signing_algorithm) {
    m_signing_algorithm = signing_algorithm;
    m_signing_algorithm_isSet = true;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_signing_algorithm_Set() const{
    return m_signing_algorithm_isSet;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_signing_algorithm_Valid() const{
    return m_signing_algorithm_isValid;
}

OAICertificateAuthorityConfiguration_Subject OAICertificateAuthority_CertificateAuthorityConfiguration::getSubject() const {
    return m_subject;
}
void OAICertificateAuthority_CertificateAuthorityConfiguration::setSubject(const OAICertificateAuthorityConfiguration_Subject &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_subject_Valid() const{
    return m_subject_isValid;
}

OAICertificateAuthorityConfiguration_CsrExtensions OAICertificateAuthority_CertificateAuthorityConfiguration::getCsrExtensions() const {
    return m_csr_extensions;
}
void OAICertificateAuthority_CertificateAuthorityConfiguration::setCsrExtensions(const OAICertificateAuthorityConfiguration_CsrExtensions &csr_extensions) {
    m_csr_extensions = csr_extensions;
    m_csr_extensions_isSet = true;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_csr_extensions_Set() const{
    return m_csr_extensions_isSet;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::is_csr_extensions_Valid() const{
    return m_csr_extensions_isValid;
}

bool OAICertificateAuthority_CertificateAuthorityConfiguration::isSet() const {
...
bool OAICertificateAuthority_CertificateAuthorityConfiguration::isValid() const {
