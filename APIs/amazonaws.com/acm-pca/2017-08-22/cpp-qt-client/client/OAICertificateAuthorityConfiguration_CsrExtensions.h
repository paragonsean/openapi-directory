...
/*
 * OAICertificateAuthorityConfiguration_CsrExtensions.h
 *
 * 
 */

#ifndef OAICertificateAuthorityConfiguration_CsrExtensions_H
#define OAICertificateAuthorityConfiguration_CsrExtensions_H
...
class OAICertificateAuthorityConfiguration_CsrExtensions : public OAIObject {
public:
    OAICertificateAuthorityConfiguration_CsrExtensions();
    OAICertificateAuthorityConfiguration_CsrExtensions(QString json);
    ~OAICertificateAuthorityConfiguration_CsrExtensions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAuthorityConfiguration_CsrExtensions)

#endif // OAICertificateAuthorityConfiguration_CsrExtensions_H
