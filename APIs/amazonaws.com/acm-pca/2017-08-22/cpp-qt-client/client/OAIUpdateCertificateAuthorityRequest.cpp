...
OAIUpdateCertificateAuthorityRequest::OAIUpdateCertificateAuthorityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCertificateAuthorityRequest::OAIUpdateCertificateAuthorityRequest() {
    this->initializeModel();
}

OAIUpdateCertificateAuthorityRequest::~OAIUpdateCertificateAuthorityRequest() {}

void OAIUpdateCertificateAuthorityRequest::initializeModel() {
...
void OAIUpdateCertificateAuthorityRequest::fromJson(QString jsonString) {
...
void OAIUpdateCertificateAuthorityRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCertificateAuthorityRequest::asJson() const {
...
QJsonObject OAIUpdateCertificateAuthorityRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateCertificateAuthorityRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIUpdateCertificateAuthorityRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIUpdateCertificateAuthorityRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIUpdateCertificateAuthorityRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

OAIUpdateCertificateAuthorityRequest_RevocationConfiguration OAIUpdateCertificateAuthorityRequest::getRevocationConfiguration() const {
    return m_revocation_configuration;
}
void OAIUpdateCertificateAuthorityRequest::setRevocationConfiguration(const OAIUpdateCertificateAuthorityRequest_RevocationConfiguration &revocation_configuration) {
    m_revocation_configuration = revocation_configuration;
    m_revocation_configuration_isSet = true;
}

bool OAIUpdateCertificateAuthorityRequest::is_revocation_configuration_Set() const{
    return m_revocation_configuration_isSet;
}

bool OAIUpdateCertificateAuthorityRequest::is_revocation_configuration_Valid() const{
    return m_revocation_configuration_isValid;
}

OAICertificateAuthorityStatus OAIUpdateCertificateAuthorityRequest::getStatus() const {
    return m_status;
}
void OAIUpdateCertificateAuthorityRequest::setStatus(const OAICertificateAuthorityStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateCertificateAuthorityRequest::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateCertificateAuthorityRequest::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIUpdateCertificateAuthorityRequest::isSet() const {
...
bool OAIUpdateCertificateAuthorityRequest::isValid() const {
