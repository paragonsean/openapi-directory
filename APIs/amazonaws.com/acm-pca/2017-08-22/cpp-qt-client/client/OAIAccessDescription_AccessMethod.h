...
/*
 * OAIAccessDescription_AccessMethod.h
 *
 * 
 */

#ifndef OAIAccessDescription_AccessMethod_H
#define OAIAccessDescription_AccessMethod_H
...
class OAIAccessDescription_AccessMethod : public OAIObject {
public:
    OAIAccessDescription_AccessMethod();
    OAIAccessDescription_AccessMethod(QString json);
    ~OAIAccessDescription_AccessMethod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessDescription_AccessMethod)

#endif // OAIAccessDescription_AccessMethod_H
