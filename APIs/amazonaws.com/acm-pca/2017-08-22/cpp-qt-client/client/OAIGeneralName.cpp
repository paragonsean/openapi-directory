...
OAIGeneralName::OAIGeneralName(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGeneralName::OAIGeneralName() {
    this->initializeModel();
}

OAIGeneralName::~OAIGeneralName() {}

void OAIGeneralName::initializeModel() {
...
void OAIGeneralName::fromJson(QString jsonString) {
...
void OAIGeneralName::fromJsonObject(QJsonObject json) {
...
QString OAIGeneralName::asJson() const {
...
QJsonObject OAIGeneralName::asJsonObject() const {
    QJsonObject obj;
...
OAIGeneralName_OtherName OAIGeneralName::getOtherName() const {
    return m_other_name;
}
void OAIGeneralName::setOtherName(const OAIGeneralName_OtherName &other_name) {
    m_other_name = other_name;
    m_other_name_isSet = true;
}

bool OAIGeneralName::is_other_name_Set() const{
    return m_other_name_isSet;
}

bool OAIGeneralName::is_other_name_Valid() const{
    return m_other_name_isValid;
}

QString OAIGeneralName::getRfc822Name() const {
    return m_rfc822_name;
}
void OAIGeneralName::setRfc822Name(const QString &rfc822_name) {
    m_rfc822_name = rfc822_name;
    m_rfc822_name_isSet = true;
}

bool OAIGeneralName::is_rfc822_name_Set() const{
    return m_rfc822_name_isSet;
}

bool OAIGeneralName::is_rfc822_name_Valid() const{
    return m_rfc822_name_isValid;
}

QString OAIGeneralName::getDnsName() const {
    return m_dns_name;
}
void OAIGeneralName::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAIGeneralName::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAIGeneralName::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

OAIASN1Subject OAIGeneralName::getDirectoryName() const {
    return m_directory_name;
}
void OAIGeneralName::setDirectoryName(const OAIASN1Subject &directory_name) {
    m_directory_name = directory_name;
    m_directory_name_isSet = true;
}

bool OAIGeneralName::is_directory_name_Set() const{
    return m_directory_name_isSet;
}

bool OAIGeneralName::is_directory_name_Valid() const{
    return m_directory_name_isValid;
}

OAIGeneralName_EdiPartyName OAIGeneralName::getEdiPartyName() const {
    return m_edi_party_name;
}
void OAIGeneralName::setEdiPartyName(const OAIGeneralName_EdiPartyName &edi_party_name) {
    m_edi_party_name = edi_party_name;
    m_edi_party_name_isSet = true;
}

bool OAIGeneralName::is_edi_party_name_Set() const{
    return m_edi_party_name_isSet;
}

bool OAIGeneralName::is_edi_party_name_Valid() const{
    return m_edi_party_name_isValid;
}

QString OAIGeneralName::getUniformResourceIdentifier() const {
    return m_uniform_resource_identifier;
}
void OAIGeneralName::setUniformResourceIdentifier(const QString &uniform_resource_identifier) {
    m_uniform_resource_identifier = uniform_resource_identifier;
    m_uniform_resource_identifier_isSet = true;
}

bool OAIGeneralName::is_uniform_resource_identifier_Set() const{
    return m_uniform_resource_identifier_isSet;
}

bool OAIGeneralName::is_uniform_resource_identifier_Valid() const{
    return m_uniform_resource_identifier_isValid;
}

QString OAIGeneralName::getIpAddress() const {
    return m_ip_address;
}
void OAIGeneralName::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAIGeneralName::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAIGeneralName::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

QString OAIGeneralName::getRegisteredId() const {
    return m_registered_id;
}
void OAIGeneralName::setRegisteredId(const QString &registered_id) {
    m_registered_id = registered_id;
    m_registered_id_isSet = true;
}

bool OAIGeneralName::is_registered_id_Set() const{
    return m_registered_id_isSet;
}

bool OAIGeneralName::is_registered_id_Valid() const{
    return m_registered_id_isValid;
}

bool OAIGeneralName::isSet() const {
...
bool OAIGeneralName::isValid() const {
