...
OAIASN1Subject::OAIASN1Subject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIASN1Subject::OAIASN1Subject() {
    this->initializeModel();
}

OAIASN1Subject::~OAIASN1Subject() {}

void OAIASN1Subject::initializeModel() {
...
void OAIASN1Subject::fromJson(QString jsonString) {
...
void OAIASN1Subject::fromJsonObject(QJsonObject json) {
...
QString OAIASN1Subject::asJson() const {
...
QJsonObject OAIASN1Subject::asJsonObject() const {
    QJsonObject obj;
    if (m_country_isSet) {
...
QString OAIASN1Subject::getCountry() const {
    return m_country;
}
void OAIASN1Subject::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIASN1Subject::is_country_Set() const{
    return m_country_isSet;
}

bool OAIASN1Subject::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIASN1Subject::getOrganization() const {
    return m_organization;
}
void OAIASN1Subject::setOrganization(const QString &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIASN1Subject::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIASN1Subject::is_organization_Valid() const{
    return m_organization_isValid;
}

QString OAIASN1Subject::getOrganizationalUnit() const {
    return m_organizational_unit;
}
void OAIASN1Subject::setOrganizationalUnit(const QString &organizational_unit) {
    m_organizational_unit = organizational_unit;
    m_organizational_unit_isSet = true;
}

bool OAIASN1Subject::is_organizational_unit_Set() const{
    return m_organizational_unit_isSet;
}

bool OAIASN1Subject::is_organizational_unit_Valid() const{
    return m_organizational_unit_isValid;
}

QString OAIASN1Subject::getDistinguishedNameQualifier() const {
    return m_distinguished_name_qualifier;
}
void OAIASN1Subject::setDistinguishedNameQualifier(const QString &distinguished_name_qualifier) {
    m_distinguished_name_qualifier = distinguished_name_qualifier;
    m_distinguished_name_qualifier_isSet = true;
}

bool OAIASN1Subject::is_distinguished_name_qualifier_Set() const{
    return m_distinguished_name_qualifier_isSet;
}

bool OAIASN1Subject::is_distinguished_name_qualifier_Valid() const{
    return m_distinguished_name_qualifier_isValid;
}

QString OAIASN1Subject::getState() const {
    return m_state;
}
void OAIASN1Subject::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIASN1Subject::is_state_Set() const{
    return m_state_isSet;
}

bool OAIASN1Subject::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIASN1Subject::getCommonName() const {
    return m_common_name;
}
void OAIASN1Subject::setCommonName(const QString &common_name) {
    m_common_name = common_name;
    m_common_name_isSet = true;
}

bool OAIASN1Subject::is_common_name_Set() const{
    return m_common_name_isSet;
}

bool OAIASN1Subject::is_common_name_Valid() const{
    return m_common_name_isValid;
}

QString OAIASN1Subject::getSerialNumber() const {
    return m_serial_number;
}
void OAIASN1Subject::setSerialNumber(const QString &serial_number) {
    m_serial_number = serial_number;
    m_serial_number_isSet = true;
}

bool OAIASN1Subject::is_serial_number_Set() const{
    return m_serial_number_isSet;
}

bool OAIASN1Subject::is_serial_number_Valid() const{
    return m_serial_number_isValid;
}

QString OAIASN1Subject::getLocality() const {
    return m_locality;
}
void OAIASN1Subject::setLocality(const QString &locality) {
    m_locality = locality;
    m_locality_isSet = true;
}

bool OAIASN1Subject::is_locality_Set() const{
    return m_locality_isSet;
}

bool OAIASN1Subject::is_locality_Valid() const{
    return m_locality_isValid;
}

QString OAIASN1Subject::getTitle() const {
    return m_title;
}
void OAIASN1Subject::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIASN1Subject::is_title_Set() const{
    return m_title_isSet;
}

bool OAIASN1Subject::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIASN1Subject::getSurname() const {
    return m_surname;
}
void OAIASN1Subject::setSurname(const QString &surname) {
    m_surname = surname;
    m_surname_isSet = true;
}

bool OAIASN1Subject::is_surname_Set() const{
    return m_surname_isSet;
}

bool OAIASN1Subject::is_surname_Valid() const{
    return m_surname_isValid;
}

QString OAIASN1Subject::getGivenName() const {
    return m_given_name;
}
void OAIASN1Subject::setGivenName(const QString &given_name) {
    m_given_name = given_name;
    m_given_name_isSet = true;
}

bool OAIASN1Subject::is_given_name_Set() const{
    return m_given_name_isSet;
}

bool OAIASN1Subject::is_given_name_Valid() const{
    return m_given_name_isValid;
}

QString OAIASN1Subject::getInitials() const {
    return m_initials;
}
void OAIASN1Subject::setInitials(const QString &initials) {
    m_initials = initials;
    m_initials_isSet = true;
}

bool OAIASN1Subject::is_initials_Set() const{
    return m_initials_isSet;
}

bool OAIASN1Subject::is_initials_Valid() const{
    return m_initials_isValid;
}

QString OAIASN1Subject::getPseudonym() const {
    return m_pseudonym;
}
void OAIASN1Subject::setPseudonym(const QString &pseudonym) {
    m_pseudonym = pseudonym;
    m_pseudonym_isSet = true;
}

bool OAIASN1Subject::is_pseudonym_Set() const{
    return m_pseudonym_isSet;
}

bool OAIASN1Subject::is_pseudonym_Valid() const{
    return m_pseudonym_isValid;
}

QString OAIASN1Subject::getGenerationQualifier() const {
    return m_generation_qualifier;
}
void OAIASN1Subject::setGenerationQualifier(const QString &generation_qualifier) {
    m_generation_qualifier = generation_qualifier;
    m_generation_qualifier_isSet = true;
}

bool OAIASN1Subject::is_generation_qualifier_Set() const{
    return m_generation_qualifier_isSet;
}

bool OAIASN1Subject::is_generation_qualifier_Valid() const{
    return m_generation_qualifier_isValid;
}

QList OAIASN1Subject::getCustomAttributes() const {
    return m_custom_attributes;
}
void OAIASN1Subject::setCustomAttributes(const QList &custom_attributes) {
    m_custom_attributes = custom_attributes;
    m_custom_attributes_isSet = true;
}

bool OAIASN1Subject::is_custom_attributes_Set() const{
    return m_custom_attributes_isSet;
}

bool OAIASN1Subject::is_custom_attributes_Valid() const{
    return m_custom_attributes_isValid;
}

bool OAIASN1Subject::isSet() const {
...
bool OAIASN1Subject::isValid() const {
