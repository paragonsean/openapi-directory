...
OAITagCertificateAuthorityRequest::OAITagCertificateAuthorityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagCertificateAuthorityRequest::OAITagCertificateAuthorityRequest() {
    this->initializeModel();
}

OAITagCertificateAuthorityRequest::~OAITagCertificateAuthorityRequest() {}

void OAITagCertificateAuthorityRequest::initializeModel() {
...
void OAITagCertificateAuthorityRequest::fromJson(QString jsonString) {
...
void OAITagCertificateAuthorityRequest::fromJsonObject(QJsonObject json) {
...
QString OAITagCertificateAuthorityRequest::asJson() const {
...
QJsonObject OAITagCertificateAuthorityRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAITagCertificateAuthorityRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAITagCertificateAuthorityRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAITagCertificateAuthorityRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAITagCertificateAuthorityRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

QList OAITagCertificateAuthorityRequest::getTags() const {
    return m_tags;
}
void OAITagCertificateAuthorityRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagCertificateAuthorityRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagCertificateAuthorityRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagCertificateAuthorityRequest::isSet() const {
...
bool OAITagCertificateAuthorityRequest::isValid() const {
