...
/*
 * OAIIssueCertificateRequest_Validity.h
 *
 * 
 */

#ifndef OAIIssueCertificateRequest_Validity_H
#define OAIIssueCertificateRequest_Validity_H
...
class OAIIssueCertificateRequest_Validity : public OAIObject {
public:
    OAIIssueCertificateRequest_Validity();
    OAIIssueCertificateRequest_Validity(QString json);
    ~OAIIssueCertificateRequest_Validity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueCertificateRequest_Validity)

#endif // OAIIssueCertificateRequest_Validity_H
