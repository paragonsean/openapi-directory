...
void OAIFailureReason::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("REQUEST_TIMED_OUT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureReason::REQUEST_TIMED_OUT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNSUPPORTED_ALGORITHM", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFailureReason::UNSUPPORTED_ALGORITHM;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIFailureReason::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIFailureReason::REQUEST_TIMED_OUT:
            val = "REQUEST_TIMED_OUT";
            break;
        case eOAIFailureReason::UNSUPPORTED_ALGORITHM:
