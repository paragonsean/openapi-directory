...
/*
 * OAIAccessDescription_AccessLocation.h
 *
 * 
 */

#ifndef OAIAccessDescription_AccessLocation_H
#define OAIAccessDescription_AccessLocation_H
...
class OAIAccessDescription_AccessLocation : public OAIObject {
public:
    OAIAccessDescription_AccessLocation();
    OAIAccessDescription_AccessLocation(QString json);
    ~OAIAccessDescription_AccessLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessDescription_AccessLocation)

#endif // OAIAccessDescription_AccessLocation_H
