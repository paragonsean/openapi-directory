...
#include "OAIAuditReportResponseFormat.h"
...
OAIAuditReportResponseFormat::OAIAuditReportResponseFormat(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuditReportResponseFormat::OAIAuditReportResponseFormat() {
    this->initializeModel();
}

OAIAuditReportResponseFormat::~OAIAuditReportResponseFormat() {}

void OAIAuditReportResponseFormat::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAuditReportResponseFormat::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAuditReportResponseFormat::fromJson(QString jsonString) {
    
    if ( jsonString.compare("JSON", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuditReportResponseFormat::JSON;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CSV", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuditReportResponseFormat::CSV;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAuditReportResponseFormat::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAuditReportResponseFormat::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAuditReportResponseFormat::JSON:
            val = "JSON";
            break;
        case eOAIAuditReportResponseFormat::CSV:
            val = "CSV";
            break;
        default:
            break;
...
QJsonValue OAIAuditReportResponseFormat::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAuditReportResponseFormat::eOAIAuditReportResponseFormat OAIAuditReportResponseFormat::getValue() const {
    return m_value;
}

void OAIAuditReportResponseFormat::setValue(const OAIAuditReportResponseFormat::eOAIAuditReportResponseFormat& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAuditReportResponseFormat::isSet() const {
    
    return m_value_isSet;
}

bool OAIAuditReportResponseFormat::isValid() const {
