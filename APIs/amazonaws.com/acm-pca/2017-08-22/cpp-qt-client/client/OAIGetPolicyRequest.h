...
/*
 * OAIGetPolicyRequest.h
 *
 * 
 */

#ifndef OAIGetPolicyRequest_H
#define OAIGetPolicyRequest_H
...
class OAIGetPolicyRequest : public OAIObject {
public:
    OAIGetPolicyRequest();
    OAIGetPolicyRequest(QString json);
    ~OAIGetPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyRequest)

#endif // OAIGetPolicyRequest_H
