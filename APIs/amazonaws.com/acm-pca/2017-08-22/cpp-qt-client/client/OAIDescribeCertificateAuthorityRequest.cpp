...
OAIDescribeCertificateAuthorityRequest::OAIDescribeCertificateAuthorityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCertificateAuthorityRequest::OAIDescribeCertificateAuthorityRequest() {
    this->initializeModel();
}

OAIDescribeCertificateAuthorityRequest::~OAIDescribeCertificateAuthorityRequest() {}

void OAIDescribeCertificateAuthorityRequest::initializeModel() {

    m_certificate_authority_arn_isSet = false;
    m_certificate_authority_arn_isValid = false;
}

void OAIDescribeCertificateAuthorityRequest::fromJson(QString jsonString) {
...
void OAIDescribeCertificateAuthorityRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCertificateAuthorityRequest::asJson() const {
...
QJsonObject OAIDescribeCertificateAuthorityRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeCertificateAuthorityRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIDescribeCertificateAuthorityRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIDescribeCertificateAuthorityRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIDescribeCertificateAuthorityRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

bool OAIDescribeCertificateAuthorityRequest::isSet() const {
...
bool OAIDescribeCertificateAuthorityRequest::isValid() const {
