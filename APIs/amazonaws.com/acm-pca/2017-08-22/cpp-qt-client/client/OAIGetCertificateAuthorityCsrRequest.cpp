...
OAIGetCertificateAuthorityCsrRequest::OAIGetCertificateAuthorityCsrRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCertificateAuthorityCsrRequest::OAIGetCertificateAuthorityCsrRequest() {
    this->initializeModel();
}

OAIGetCertificateAuthorityCsrRequest::~OAIGetCertificateAuthorityCsrRequest() {}

void OAIGetCertificateAuthorityCsrRequest::initializeModel() {

    m_certificate_authority_arn_isSet = false;
    m_certificate_authority_arn_isValid = false;
}

void OAIGetCertificateAuthorityCsrRequest::fromJson(QString jsonString) {
...
void OAIGetCertificateAuthorityCsrRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetCertificateAuthorityCsrRequest::asJson() const {
...
QJsonObject OAIGetCertificateAuthorityCsrRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCertificateAuthorityCsrRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIGetCertificateAuthorityCsrRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIGetCertificateAuthorityCsrRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIGetCertificateAuthorityCsrRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

bool OAIGetCertificateAuthorityCsrRequest::isSet() const {
...
bool OAIGetCertificateAuthorityCsrRequest::isValid() const {
