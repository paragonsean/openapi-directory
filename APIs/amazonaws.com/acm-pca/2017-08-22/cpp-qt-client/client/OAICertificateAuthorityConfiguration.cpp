...
#include "OAICertificateAuthorityConfiguration.h"
...
OAICertificateAuthorityConfiguration::OAICertificateAuthorityConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICertificateAuthorityConfiguration::OAICertificateAuthorityConfiguration() {
    this->initializeModel();
}

OAICertificateAuthorityConfiguration::~OAICertificateAuthorityConfiguration() {}

void OAICertificateAuthorityConfiguration::initializeModel() {
...
void OAICertificateAuthorityConfiguration::fromJson(QString jsonString) {
...
void OAICertificateAuthorityConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICertificateAuthorityConfiguration::asJson() const {
...
QJsonObject OAICertificateAuthorityConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIKeyAlgorithm OAICertificateAuthorityConfiguration::getKeyAlgorithm() const {
    return m_key_algorithm;
}
void OAICertificateAuthorityConfiguration::setKeyAlgorithm(const OAIKeyAlgorithm &key_algorithm) {
    m_key_algorithm = key_algorithm;
    m_key_algorithm_isSet = true;
}

bool OAICertificateAuthorityConfiguration::is_key_algorithm_Set() const{
    return m_key_algorithm_isSet;
}

bool OAICertificateAuthorityConfiguration::is_key_algorithm_Valid() const{
    return m_key_algorithm_isValid;
}

OAISigningAlgorithm OAICertificateAuthorityConfiguration::getSigningAlgorithm() const {
    return m_signing_algorithm;
}
void OAICertificateAuthorityConfiguration::setSigningAlgorithm(const OAISigningAlgorithm &signing_algorithm) {
    m_signing_algorithm = signing_algorithm;
    m_signing_algorithm_isSet = true;
}

bool OAICertificateAuthorityConfiguration::is_signing_algorithm_Set() const{
    return m_signing_algorithm_isSet;
}

bool OAICertificateAuthorityConfiguration::is_signing_algorithm_Valid() const{
    return m_signing_algorithm_isValid;
}

OAICertificateAuthorityConfiguration_Subject OAICertificateAuthorityConfiguration::getSubject() const {
    return m_subject;
}
void OAICertificateAuthorityConfiguration::setSubject(const OAICertificateAuthorityConfiguration_Subject &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAICertificateAuthorityConfiguration::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAICertificateAuthorityConfiguration::is_subject_Valid() const{
    return m_subject_isValid;
}

OAICertificateAuthorityConfiguration_CsrExtensions OAICertificateAuthorityConfiguration::getCsrExtensions() const {
    return m_csr_extensions;
}
void OAICertificateAuthorityConfiguration::setCsrExtensions(const OAICertificateAuthorityConfiguration_CsrExtensions &csr_extensions) {
    m_csr_extensions = csr_extensions;
    m_csr_extensions_isSet = true;
}

bool OAICertificateAuthorityConfiguration::is_csr_extensions_Set() const{
    return m_csr_extensions_isSet;
}

bool OAICertificateAuthorityConfiguration::is_csr_extensions_Valid() const{
    return m_csr_extensions_isValid;
}

bool OAICertificateAuthorityConfiguration::isSet() const {
...
bool OAICertificateAuthorityConfiguration::isValid() const {
