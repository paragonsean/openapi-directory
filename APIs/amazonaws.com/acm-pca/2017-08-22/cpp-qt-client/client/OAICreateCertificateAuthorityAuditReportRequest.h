...
/*
 * OAICreateCertificateAuthorityAuditReportRequest.h
 *
 * 
 */

#ifndef OAICreateCertificateAuthorityAuditReportRequest_H
#define OAICreateCertificateAuthorityAuditReportRequest_H
...
class OAICreateCertificateAuthorityAuditReportRequest : public OAIObject {
public:
    OAICreateCertificateAuthorityAuditReportRequest();
    OAICreateCertificateAuthorityAuditReportRequest(QString json);
    ~OAICreateCertificateAuthorityAuditReportRequest() override;
    ...
    OAIAuditReportResponseFormat getAuditReportResponseFormat() const;
    void setAuditReportResponseFormat(const OAIAuditReportResponseFormat &audit_report_response_format);
    bool is_audit_report_response_format_Set() const;
    bool is_audit_report_response_format_Valid() const;
...
private:
    ...
    OAIAuditReportResponseFormat m_audit_report_response_format;
    bool m_audit_report_response_format_isSet;
    bool m_audit_report_response_format_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateCertificateAuthorityAuditReportRequest)

#endif // OAICreateCertificateAuthorityAuditReportRequest_H
