...
/*
 * OAIDescribeCertificateAuthorityResponse.h
 *
 * 
 */

#ifndef OAIDescribeCertificateAuthorityResponse_H
#define OAIDescribeCertificateAuthorityResponse_H

#include <QJsonObject>

#include "OAIDescribeCertificateAuthorityResponse_CertificateAuthority.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeCertificateAuthorityResponse_CertificateAuthority;

class OAIDescribeCertificateAuthorityResponse : public OAIObject {
public:
    OAIDescribeCertificateAuthorityResponse();
    OAIDescribeCertificateAuthorityResponse(QString json);
    ~OAIDescribeCertificateAuthorityResponse() override;
    ...
    OAIDescribeCertificateAuthorityResponse_CertificateAuthority getCertificateAuthority() const;
    void setCertificateAuthority(const OAIDescribeCertificateAuthorityResponse_CertificateAuthority &certificate_authority);
...
private:
    ...
    OAIDescribeCertificateAuthorityResponse_CertificateAuthority m_certificate_authority;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCertificateAuthorityResponse)

#endif // OAIDescribeCertificateAuthorityResponse_H
