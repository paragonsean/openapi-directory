...
OAICreateCertificateAuthorityResponse::OAICreateCertificateAuthorityResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCertificateAuthorityResponse::OAICreateCertificateAuthorityResponse() {
    this->initializeModel();
}

OAICreateCertificateAuthorityResponse::~OAICreateCertificateAuthorityResponse() {}

void OAICreateCertificateAuthorityResponse::initializeModel() {

    m_certificate_authority_arn_isSet = false;
    m_certificate_authority_arn_isValid = false;
}

void OAICreateCertificateAuthorityResponse::fromJson(QString jsonString) {
...
void OAICreateCertificateAuthorityResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateCertificateAuthorityResponse::asJson() const {
...
QJsonObject OAICreateCertificateAuthorityResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCertificateAuthorityResponse::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAICreateCertificateAuthorityResponse::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAICreateCertificateAuthorityResponse::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAICreateCertificateAuthorityResponse::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

bool OAICreateCertificateAuthorityResponse::isSet() const {
...
bool OAICreateCertificateAuthorityResponse::isValid() const {
