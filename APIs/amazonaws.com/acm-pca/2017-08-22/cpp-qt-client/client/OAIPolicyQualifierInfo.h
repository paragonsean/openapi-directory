...
#ifndef OAIPolicyQualifierInfo_H
#define OAIPolicyQualifierInfo_H
...
namespace OpenAPI {
class OAIPolicyQualifierInfo_Qualifier;

class OAIPolicyQualifierInfo : public OAIObject {
public:
    OAIPolicyQualifierInfo();
    OAIPolicyQualifierInfo(QString json);
    ~OAIPolicyQualifierInfo() override;
    ...
    OAIPolicyQualifierId getPolicyQualifierId() const;
    void setPolicyQualifierId(const OAIPolicyQualifierId &policy_qualifier_id);
    bool is_policy_qualifier_id_Set() const;
    bool is_policy_qualifier_id_Valid() const;

    OAIPolicyQualifierInfo_Qualifier getQualifier() const;
    void setQualifier(const OAIPolicyQualifierInfo_Qualifier &qualifier);
...
private:
    ...
    OAIPolicyQualifierId m_policy_qualifier_id;
    bool m_policy_qualifier_id_isSet;
    bool m_policy_qualifier_id_isValid;

    OAIPolicyQualifierInfo_Qualifier m_qualifier;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyQualifierInfo)

#endif // OAIPolicyQualifierInfo_H
