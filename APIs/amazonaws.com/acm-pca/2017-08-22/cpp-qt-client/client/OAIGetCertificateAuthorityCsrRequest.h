...
/*
 * OAIGetCertificateAuthorityCsrRequest.h
 *
 * 
 */

#ifndef OAIGetCertificateAuthorityCsrRequest_H
#define OAIGetCertificateAuthorityCsrRequest_H
...
class OAIGetCertificateAuthorityCsrRequest : public OAIObject {
public:
    OAIGetCertificateAuthorityCsrRequest();
    OAIGetCertificateAuthorityCsrRequest(QString json);
    ~OAIGetCertificateAuthorityCsrRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCertificateAuthorityCsrRequest)

#endif // OAIGetCertificateAuthorityCsrRequest_H
