...
/*
 * OAIDescribeCertificateAuthorityRequest.h
 *
 * 
 */

#ifndef OAIDescribeCertificateAuthorityRequest_H
#define OAIDescribeCertificateAuthorityRequest_H
...
class OAIDescribeCertificateAuthorityRequest : public OAIObject {
public:
    OAIDescribeCertificateAuthorityRequest();
    OAIDescribeCertificateAuthorityRequest(QString json);
    ~OAIDescribeCertificateAuthorityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCertificateAuthorityRequest)

#endif // OAIDescribeCertificateAuthorityRequest_H
