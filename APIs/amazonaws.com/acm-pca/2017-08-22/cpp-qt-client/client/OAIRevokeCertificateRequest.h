...
public:
    ...
    QString getCertificateSerial() const;
    void setCertificateSerial(const QString &certificate_serial);
    bool is_certificate_serial_Set() const;
    bool is_certificate_serial_Valid() const;
...
private:
    ...
    QString m_certificate_serial;
    bool m_certificate_serial_isSet;
    bool m_certificate_serial_isValid;
