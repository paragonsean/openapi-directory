...
OAIGetPolicyRequest::OAIGetPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyRequest::OAIGetPolicyRequest() {
    this->initializeModel();
}

OAIGetPolicyRequest::~OAIGetPolicyRequest() {}

void OAIGetPolicyRequest::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIGetPolicyRequest::fromJson(QString jsonString) {
...
void OAIGetPolicyRequest::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceArn")]);
    m_resource_arn_isSet = !json[QString("ResourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIGetPolicyRequest::asJson() const {
...
QJsonObject OAIGetPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPolicyRequest::getResourceArn() const {
    return m_resource_arn;
}
void OAIGetPolicyRequest::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIGetPolicyRequest::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIGetPolicyRequest::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIGetPolicyRequest::isSet() const {
...
bool OAIGetPolicyRequest::isValid() const {
