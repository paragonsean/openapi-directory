...
/*
 * OAIPolicyQualifierId.h
 *
 * 
 */

#ifndef OAIPolicyQualifierId_H
#define OAIPolicyQualifierId_H
...
class OAIPolicyQualifierId : public OAIEnum {
public:
    OAIPolicyQualifierId();
    OAIPolicyQualifierId(QString json);
    ~OAIPolicyQualifierId() override;
    ...
    enum class eOAIPolicyQualifierId {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CPS
    };
    OAIPolicyQualifierId::eOAIPolicyQualifierId getValue() const;
    void setValue(const OAIPolicyQualifierId::eOAIPolicyQualifierId& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyQualifierId)

#endif // OAIPolicyQualifierId_H
