...
OAIGetCertificateAuthorityCertificateResponse::OAIGetCertificateAuthorityCertificateResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCertificateAuthorityCertificateResponse::OAIGetCertificateAuthorityCertificateResponse() {
    this->initializeModel();
}

OAIGetCertificateAuthorityCertificateResponse::~OAIGetCertificateAuthorityCertificateResponse() {}

void OAIGetCertificateAuthorityCertificateResponse::initializeModel() {
...
void OAIGetCertificateAuthorityCertificateResponse::fromJson(QString jsonString) {
...
void OAIGetCertificateAuthorityCertificateResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetCertificateAuthorityCertificateResponse::asJson() const {
...
QJsonObject OAIGetCertificateAuthorityCertificateResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCertificateAuthorityCertificateResponse::getCertificate() const {
    return m_certificate;
}
void OAIGetCertificateAuthorityCertificateResponse::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIGetCertificateAuthorityCertificateResponse::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIGetCertificateAuthorityCertificateResponse::is_certificate_Valid() const{
    return m_certificate_isValid;
}

QString OAIGetCertificateAuthorityCertificateResponse::getCertificateChain() const {
    return m_certificate_chain;
}
void OAIGetCertificateAuthorityCertificateResponse::setCertificateChain(const QString &certificate_chain) {
    m_certificate_chain = certificate_chain;
    m_certificate_chain_isSet = true;
}

bool OAIGetCertificateAuthorityCertificateResponse::is_certificate_chain_Set() const{
    return m_certificate_chain_isSet;
}

bool OAIGetCertificateAuthorityCertificateResponse::is_certificate_chain_Valid() const{
    return m_certificate_chain_isValid;
}

bool OAIGetCertificateAuthorityCertificateResponse::isSet() const {
...
bool OAIGetCertificateAuthorityCertificateResponse::isValid() const {
