...
/*
 * OAIGeneralName_OtherName.h
 *
 * 
 */

#ifndef OAIGeneralName_OtherName_H
#define OAIGeneralName_OtherName_H
...
class OAIGeneralName_OtherName : public OAIObject {
public:
    OAIGeneralName_OtherName();
    OAIGeneralName_OtherName(QString json);
    ~OAIGeneralName_OtherName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeneralName_OtherName)

#endif // OAIGeneralName_OtherName_H
