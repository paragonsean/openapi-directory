...
#ifndef OAIOcspConfiguration_H
#define OAIOcspConfiguration_H
...
class OAIOcspConfiguration : public OAIObject {
public:
    OAIOcspConfiguration();
    OAIOcspConfiguration(QString json);
    ~OAIOcspConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOcspConfiguration)

#endif // OAIOcspConfiguration_H
