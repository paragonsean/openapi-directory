...
/*
 * OAIAccessMethodType.h
 *
 * 
 */

#ifndef OAIAccessMethodType_H
#define OAIAccessMethodType_H
...
class OAIAccessMethodType : public OAIEnum {
public:
    OAIAccessMethodType();
    OAIAccessMethodType(QString json);
    ~OAIAccessMethodType() override;
    ...
    enum class eOAIAccessMethodType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CA_REPOSITORY, 
        RESOURCE_PKI_MANIFEST, 
        RESOURCE_PKI_NOTIFY
    };
    OAIAccessMethodType::eOAIAccessMethodType getValue() const;
    void setValue(const OAIAccessMethodType::eOAIAccessMethodType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessMethodType)

#endif // OAIAccessMethodType_H
