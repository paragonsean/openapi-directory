...
OAIUntagCertificateAuthorityRequest::OAIUntagCertificateAuthorityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUntagCertificateAuthorityRequest::OAIUntagCertificateAuthorityRequest() {
    this->initializeModel();
}

OAIUntagCertificateAuthorityRequest::~OAIUntagCertificateAuthorityRequest() {}

void OAIUntagCertificateAuthorityRequest::initializeModel() {
...
void OAIUntagCertificateAuthorityRequest::fromJson(QString jsonString) {
...
void OAIUntagCertificateAuthorityRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUntagCertificateAuthorityRequest::asJson() const {
...
QJsonObject OAIUntagCertificateAuthorityRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUntagCertificateAuthorityRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIUntagCertificateAuthorityRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIUntagCertificateAuthorityRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIUntagCertificateAuthorityRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

QList OAIUntagCertificateAuthorityRequest::getTags() const {
    return m_tags;
}
void OAIUntagCertificateAuthorityRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUntagCertificateAuthorityRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUntagCertificateAuthorityRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIUntagCertificateAuthorityRequest::isSet() const {
...
bool OAIUntagCertificateAuthorityRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_certificate_authority_arn_isValid && m_tags_isValid && true;
}
