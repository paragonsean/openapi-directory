...
#ifndef OAIEdiPartyName_H
#define OAIEdiPartyName_H
...
class OAIEdiPartyName : public OAIObject {
public:
    OAIEdiPartyName();
    OAIEdiPartyName(QString json);
    ~OAIEdiPartyName() override;
    ...
    QString getNameAssigner() const;
    void setNameAssigner(const QString &name_assigner);
    bool is_name_assigner_Set() const;
    bool is_name_assigner_Valid() const;
...
private:
    ...
    QString m_name_assigner;
    bool m_name_assigner_isSet;
    bool m_name_assigner_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEdiPartyName)

#endif // OAIEdiPartyName_H
