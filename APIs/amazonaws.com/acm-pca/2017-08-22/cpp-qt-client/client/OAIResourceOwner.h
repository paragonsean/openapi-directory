...
class OAIResourceOwner : public OAIEnum {
public:
    OAIResourceOwner();
    ...
    enum class eOAIResourceOwner {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SELF, 
        OTHER_ACCOUNTS
    };
    OAIResourceOwner::eOAIResourceOwner getValue() const;
    void setValue(const OAIResourceOwner::eOAIResourceOwner& value);
