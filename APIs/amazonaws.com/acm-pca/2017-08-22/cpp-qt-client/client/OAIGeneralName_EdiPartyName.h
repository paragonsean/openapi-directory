...
/*
 * OAIGeneralName_EdiPartyName.h
 *
 * 
 */

#ifndef OAIGeneralName_EdiPartyName_H
#define OAIGeneralName_EdiPartyName_H
...
class OAIGeneralName_EdiPartyName : public OAIObject {
public:
    OAIGeneralName_EdiPartyName();
    OAIGeneralName_EdiPartyName(QString json);
    ~OAIGeneralName_EdiPartyName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeneralName_EdiPartyName)

#endif // OAIGeneralName_EdiPartyName_H
