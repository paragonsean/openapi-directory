...
/*
 * OAITagCertificateAuthorityRequest.h
 *
 * 
 */

#ifndef OAITagCertificateAuthorityRequest_H
#define OAITagCertificateAuthorityRequest_H
...
class OAITagCertificateAuthorityRequest : public OAIObject {
public:
    OAITagCertificateAuthorityRequest();
    OAITagCertificateAuthorityRequest(QString json);
    ~OAITagCertificateAuthorityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagCertificateAuthorityRequest)

#endif // OAITagCertificateAuthorityRequest_H
