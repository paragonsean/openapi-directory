...
/*
 * OAIApiPassthrough_Extensions.h
 *
 * 
 */

#ifndef OAIApiPassthrough_Extensions_H
#define OAIApiPassthrough_Extensions_H
...
class OAIApiPassthrough_Extensions : public OAIObject {
public:
    OAIApiPassthrough_Extensions();
    OAIApiPassthrough_Extensions(QString json);
    ~OAIApiPassthrough_Extensions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiPassthrough_Extensions)

#endif // OAIApiPassthrough_Extensions_H
