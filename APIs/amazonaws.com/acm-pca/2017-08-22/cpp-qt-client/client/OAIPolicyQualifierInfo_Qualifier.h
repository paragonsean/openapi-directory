...
/*
 * OAIPolicyQualifierInfo_Qualifier.h
 *
 * 
 */

#ifndef OAIPolicyQualifierInfo_Qualifier_H
#define OAIPolicyQualifierInfo_Qualifier_H
...
class OAIPolicyQualifierInfo_Qualifier : public OAIObject {
public:
    OAIPolicyQualifierInfo_Qualifier();
    OAIPolicyQualifierInfo_Qualifier(QString json);
    ~OAIPolicyQualifierInfo_Qualifier() override;
    ...
    QString getCpsUri() const;
    void setCpsUri(const QString &cps_uri);
    bool is_cps_uri_Set() const;
    bool is_cps_uri_Valid() const;
...
private:
    ...
    QString m_cps_uri;
    bool m_cps_uri_isSet;
    bool m_cps_uri_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPolicyQualifierInfo_Qualifier)

#endif // OAIPolicyQualifierInfo_Qualifier_H
