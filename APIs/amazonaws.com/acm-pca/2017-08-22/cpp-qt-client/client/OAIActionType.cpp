...
void OAIActionType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("IssueCertificate", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::ISSUECERTIFICATE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GetCertificate", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::GETCERTIFICATE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ListPermissions", Qt::CaseInsensitive) == 0) {
        m_value = eOAIActionType::LISTPERMISSIONS;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIActionType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIActionType::ISSUECERTIFICATE:
            val = "IssueCertificate";
            break;
        case eOAIActionType::GETCERTIFICATE:
            val = "GetCertificate";
            break;
        case eOAIActionType::LISTPERMISSIONS:
            val = "ListPermissions";
            break;
        default:
            break;
