...
/*
 * OAIGetCertificateRequest.h
 *
 * 
 */

#ifndef OAIGetCertificateRequest_H
#define OAIGetCertificateRequest_H
...
class OAIGetCertificateRequest : public OAIObject {
public:
    OAIGetCertificateRequest();
    OAIGetCertificateRequest(QString json);
    ~OAIGetCertificateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCertificateRequest)

#endif // OAIGetCertificateRequest_H
