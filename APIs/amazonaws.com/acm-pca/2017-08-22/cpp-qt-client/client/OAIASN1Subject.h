...
#ifndef OAIASN1Subject_H
#define OAIASN1Subject_H
...
class OAIASN1Subject : public OAIObject {
public:
    OAIASN1Subject();
    OAIASN1Subject(QString json);
    ~OAIASN1Subject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIASN1Subject)

#endif // OAIASN1Subject_H
