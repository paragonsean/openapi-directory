...
#ifndef OAIOtherName_H
#define OAIOtherName_H
...
class OAIOtherName : public OAIObject {
public:
    OAIOtherName();
    OAIOtherName(QString json);
    ~OAIOtherName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOtherName)

#endif // OAIOtherName_H
