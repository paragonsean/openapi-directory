...
/*
 * OAIDeleteCertificateAuthorityRequest.h
 *
 * 
 */

#ifndef OAIDeleteCertificateAuthorityRequest_H
#define OAIDeleteCertificateAuthorityRequest_H
...
class OAIDeleteCertificateAuthorityRequest : public OAIObject {
public:
    OAIDeleteCertificateAuthorityRequest();
    OAIDeleteCertificateAuthorityRequest(QString json);
    ~OAIDeleteCertificateAuthorityRequest() override;
    ...
    qint32 getPermanentDeletionTimeInDays() const;
    void setPermanentDeletionTimeInDays(const qint32 &permanent_deletion_time_in_days);
    bool is_permanent_deletion_time_in_days_Set() const;
    bool is_permanent_deletion_time_in_days_Valid() const;
...
private:
    ...
    qint32 m_permanent_deletion_time_in_days;
    bool m_permanent_deletion_time_in_days_isSet;
    bool m_permanent_deletion_time_in_days_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCertificateAuthorityRequest)

#endif // OAIDeleteCertificateAuthorityRequest_H
