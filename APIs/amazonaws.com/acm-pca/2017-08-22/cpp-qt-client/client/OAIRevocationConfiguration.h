...
#ifndef OAIRevocationConfiguration_H
#define OAIRevocationConfiguration_H
...
class OAIRevocationConfiguration : public OAIObject {
public:
    OAIRevocationConfiguration();
    OAIRevocationConfiguration(QString json);
    ~OAIRevocationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevocationConfiguration)

#endif // OAIRevocationConfiguration_H
