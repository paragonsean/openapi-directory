...
/*
 * OAICertificateAuthorityUsageMode.h
 *
 * 
 */

#ifndef OAICertificateAuthorityUsageMode_H
#define OAICertificateAuthorityUsageMode_H
...
class OAICertificateAuthorityUsageMode : public OAIEnum {
public:
    OAICertificateAuthorityUsageMode();
    OAICertificateAuthorityUsageMode(QString json);
    ~OAICertificateAuthorityUsageMode() override;
    ...
    enum class eOAICertificateAuthorityUsageMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        GENERAL_PURPOSE, 
        SHORT_LIVED_CERTIFICATE
    };
    OAICertificateAuthorityUsageMode::eOAICertificateAuthorityUsageMode getValue() const;
    void setValue(const OAICertificateAuthorityUsageMode::eOAICertificateAuthorityUsageMode& value);
...
private:
    ...
    eOAICertificateAuthorityUsageMode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAuthorityUsageMode)

#endif // OAICertificateAuthorityUsageMode_H
