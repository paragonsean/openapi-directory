...
OAICertificateAuthorityUsageMode::OAICertificateAuthorityUsageMode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICertificateAuthorityUsageMode::OAICertificateAuthorityUsageMode() {
    this->initializeModel();
}

OAICertificateAuthorityUsageMode::~OAICertificateAuthorityUsageMode() {}

void OAICertificateAuthorityUsageMode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICertificateAuthorityUsageMode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICertificateAuthorityUsageMode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("GENERAL_PURPOSE", Qt::CaseInsensitive) == 0) {
        m_value = eOAICertificateAuthorityUsageMode::GENERAL_PURPOSE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHORT_LIVED_CERTIFICATE", Qt::CaseInsensitive) == 0) {
        m_value = eOAICertificateAuthorityUsageMode::SHORT_LIVED_CERTIFICATE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICertificateAuthorityUsageMode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICertificateAuthorityUsageMode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICertificateAuthorityUsageMode::GENERAL_PURPOSE:
            val = "GENERAL_PURPOSE";
            break;
        case eOAICertificateAuthorityUsageMode::SHORT_LIVED_CERTIFICATE:
            val = "SHORT_LIVED_CERTIFICATE";
            break;
        default:
            break;
    }
...
QJsonValue OAICertificateAuthorityUsageMode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICertificateAuthorityUsageMode::eOAICertificateAuthorityUsageMode OAICertificateAuthorityUsageMode::getValue() const {
    return m_value;
}

void OAICertificateAuthorityUsageMode::setValue(const OAICertificateAuthorityUsageMode::eOAICertificateAuthorityUsageMode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICertificateAuthorityUsageMode::isSet() const {
    
    return m_value_isSet;
}

bool OAICertificateAuthorityUsageMode::isValid() const {
