...
/*
 * OAIUntagCertificateAuthorityRequest.h
 *
 * 
 */

#ifndef OAIUntagCertificateAuthorityRequest_H
#define OAIUntagCertificateAuthorityRequest_H
...
class OAIUntagCertificateAuthorityRequest : public OAIObject {
public:
    OAIUntagCertificateAuthorityRequest();
    OAIUntagCertificateAuthorityRequest(QString json);
    ~OAIUntagCertificateAuthorityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagCertificateAuthorityRequest)

#endif // OAIUntagCertificateAuthorityRequest_H
