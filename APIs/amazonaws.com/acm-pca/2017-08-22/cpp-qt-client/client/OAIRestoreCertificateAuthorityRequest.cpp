...
OAIRestoreCertificateAuthorityRequest::OAIRestoreCertificateAuthorityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreCertificateAuthorityRequest::OAIRestoreCertificateAuthorityRequest() {
    this->initializeModel();
}

OAIRestoreCertificateAuthorityRequest::~OAIRestoreCertificateAuthorityRequest() {}

void OAIRestoreCertificateAuthorityRequest::initializeModel() {

    m_certificate_authority_arn_isSet = false;
    m_certificate_authority_arn_isValid = false;
}

void OAIRestoreCertificateAuthorityRequest::fromJson(QString jsonString) {
...
void OAIRestoreCertificateAuthorityRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRestoreCertificateAuthorityRequest::asJson() const {
...
QJsonObject OAIRestoreCertificateAuthorityRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRestoreCertificateAuthorityRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIRestoreCertificateAuthorityRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIRestoreCertificateAuthorityRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIRestoreCertificateAuthorityRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

bool OAIRestoreCertificateAuthorityRequest::isSet() const {
...
bool OAIRestoreCertificateAuthorityRequest::isValid() const {
