...
/*
 * OAICertificateAuthority_CertificateAuthorityConfiguration.h
 *
 * 
 */

#ifndef OAICertificateAuthority_CertificateAuthorityConfiguration_H
#define OAICertificateAuthority_CertificateAuthorityConfiguration_H
...
class OAICertificateAuthority_CertificateAuthorityConfiguration : public OAIObject {
public:
    OAICertificateAuthority_CertificateAuthorityConfiguration();
    OAICertificateAuthority_CertificateAuthorityConfiguration(QString json);
    ~OAICertificateAuthority_CertificateAuthorityConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAuthority_CertificateAuthorityConfiguration)

#endif // OAICertificateAuthority_CertificateAuthorityConfiguration_H
