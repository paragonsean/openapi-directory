...
/*
 * OAIDeletePolicyRequest.h
 *
 * 
 */

#ifndef OAIDeletePolicyRequest_H
#define OAIDeletePolicyRequest_H
...
class OAIDeletePolicyRequest : public OAIObject {
public:
    OAIDeletePolicyRequest();
    OAIDeletePolicyRequest(QString json);
    ~OAIDeletePolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePolicyRequest)

#endif // OAIDeletePolicyRequest_H
