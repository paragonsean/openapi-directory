...
QString OAIGetCertificateRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIGetCertificateRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIGetCertificateRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIGetCertificateRequest::is_certificate_authority_arn_Valid() const{
...
bool OAIGetCertificateRequest::isValid() const {
    ...
    return m_certificate_authority_arn_isValid && m_certificate_arn_isValid && true;
}
