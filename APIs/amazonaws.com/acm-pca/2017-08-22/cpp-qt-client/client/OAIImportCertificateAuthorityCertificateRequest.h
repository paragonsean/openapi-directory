...
/*
 * OAIImportCertificateAuthorityCertificateRequest.h
 *
 * 
 */

#ifndef OAIImportCertificateAuthorityCertificateRequest_H
#define OAIImportCertificateAuthorityCertificateRequest_H
...
class OAIImportCertificateAuthorityCertificateRequest : public OAIObject {
public:
    OAIImportCertificateAuthorityCertificateRequest();
    OAIImportCertificateAuthorityCertificateRequest(QString json);
    ~OAIImportCertificateAuthorityCertificateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportCertificateAuthorityCertificateRequest)

#endif // OAIImportCertificateAuthorityCertificateRequest_H
