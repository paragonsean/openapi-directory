...
/*
 * OAICreateCertificateAuthorityAuditReportResponse.h
 *
 * 
 */

#ifndef OAICreateCertificateAuthorityAuditReportResponse_H
#define OAICreateCertificateAuthorityAuditReportResponse_H
...
class OAICreateCertificateAuthorityAuditReportResponse : public OAIObject {
public:
    OAICreateCertificateAuthorityAuditReportResponse();
    OAICreateCertificateAuthorityAuditReportResponse(QString json);
    ~OAICreateCertificateAuthorityAuditReportResponse() override;
    ...
    QString getAuditReportId() const;
    void setAuditReportId(const QString &audit_report_id);
    bool is_audit_report_id_Set() const;
    bool is_audit_report_id_Valid() const;
...
private:
    ...
    QString m_audit_report_id;
    bool m_audit_report_id_isSet;
    bool m_audit_report_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCertificateAuthorityAuditReportResponse)

#endif // OAICreateCertificateAuthorityAuditReportResponse_H
