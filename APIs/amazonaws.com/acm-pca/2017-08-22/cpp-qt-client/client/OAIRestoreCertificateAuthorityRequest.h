...
/*
 * OAIRestoreCertificateAuthorityRequest.h
 *
 * 
 */

#ifndef OAIRestoreCertificateAuthorityRequest_H
#define OAIRestoreCertificateAuthorityRequest_H
...
class OAIRestoreCertificateAuthorityRequest : public OAIObject {
public:
    OAIRestoreCertificateAuthorityRequest();
    OAIRestoreCertificateAuthorityRequest(QString json);
    ~OAIRestoreCertificateAuthorityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreCertificateAuthorityRequest)

#endif // OAIRestoreCertificateAuthorityRequest_H
