...
OAIImportCertificateAuthorityCertificateRequest::OAIImportCertificateAuthorityCertificateRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportCertificateAuthorityCertificateRequest::OAIImportCertificateAuthorityCertificateRequest() {
    this->initializeModel();
}

OAIImportCertificateAuthorityCertificateRequest::~OAIImportCertificateAuthorityCertificateRequest() {}

void OAIImportCertificateAuthorityCertificateRequest::initializeModel() {
...
void OAIImportCertificateAuthorityCertificateRequest::fromJson(QString jsonString) {
...
void OAIImportCertificateAuthorityCertificateRequest::fromJsonObject(QJsonObject json) {
...
QString OAIImportCertificateAuthorityCertificateRequest::asJson() const {
...
QJsonObject OAIImportCertificateAuthorityCertificateRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIImportCertificateAuthorityCertificateRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIImportCertificateAuthorityCertificateRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIImportCertificateAuthorityCertificateRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIImportCertificateAuthorityCertificateRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

QString OAIImportCertificateAuthorityCertificateRequest::getCertificate() const {
    return m_certificate;
}
void OAIImportCertificateAuthorityCertificateRequest::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIImportCertificateAuthorityCertificateRequest::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIImportCertificateAuthorityCertificateRequest::is_certificate_Valid() const{
    return m_certificate_isValid;
}

QString OAIImportCertificateAuthorityCertificateRequest::getCertificateChain() const {
    return m_certificate_chain;
}
void OAIImportCertificateAuthorityCertificateRequest::setCertificateChain(const QString &certificate_chain) {
    m_certificate_chain = certificate_chain;
    m_certificate_chain_isSet = true;
}

bool OAIImportCertificateAuthorityCertificateRequest::is_certificate_chain_Set() const{
    return m_certificate_chain_isSet;
}

bool OAIImportCertificateAuthorityCertificateRequest::is_certificate_chain_Valid() const{
    return m_certificate_chain_isValid;
}

bool OAIImportCertificateAuthorityCertificateRequest::isSet() const {
...
bool OAIImportCertificateAuthorityCertificateRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_certificate_authority_arn_isValid && m_certificate_isValid && true;
}
