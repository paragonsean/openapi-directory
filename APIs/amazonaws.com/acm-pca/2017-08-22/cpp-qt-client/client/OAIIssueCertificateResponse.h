...
/*
 * OAIIssueCertificateResponse.h
 *
 * 
 */

#ifndef OAIIssueCertificateResponse_H
#define OAIIssueCertificateResponse_H
...
class OAIIssueCertificateResponse : public OAIObject {
public:
    OAIIssueCertificateResponse();
    OAIIssueCertificateResponse(QString json);
    ~OAIIssueCertificateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueCertificateResponse)

#endif // OAIIssueCertificateResponse_H
