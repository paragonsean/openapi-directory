...
/*
 * OAIAuditReportResponseFormat.h
 *
 * 
 */

#ifndef OAIAuditReportResponseFormat_H
#define OAIAuditReportResponseFormat_H
...
class OAIAuditReportResponseFormat : public OAIEnum {
public:
    OAIAuditReportResponseFormat();
    OAIAuditReportResponseFormat(QString json);
    ~OAIAuditReportResponseFormat() override;
    ...
    enum class eOAIAuditReportResponseFormat {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        JSON, 
        CSV
    };
    OAIAuditReportResponseFormat::eOAIAuditReportResponseFormat getValue() const;
    void setValue(const OAIAuditReportResponseFormat::eOAIAuditReportResponseFormat& value);
...
private:
    ...
    eOAIAuditReportResponseFormat m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuditReportResponseFormat)

#endif // OAIAuditReportResponseFormat_H
