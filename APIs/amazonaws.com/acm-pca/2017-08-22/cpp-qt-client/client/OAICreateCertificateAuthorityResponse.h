...
/*
 * OAICreateCertificateAuthorityResponse.h
 *
 * 
 */

#ifndef OAICreateCertificateAuthorityResponse_H
#define OAICreateCertificateAuthorityResponse_H
...
class OAICreateCertificateAuthorityResponse : public OAIObject {
public:
    OAICreateCertificateAuthorityResponse();
    OAICreateCertificateAuthorityResponse(QString json);
    ~OAICreateCertificateAuthorityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCertificateAuthorityResponse)

#endif // OAICreateCertificateAuthorityResponse_H
