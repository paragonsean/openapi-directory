...
OAIIssueCertificateRequest_Validity::OAIIssueCertificateRequest_Validity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIssueCertificateRequest_Validity::OAIIssueCertificateRequest_Validity() {
    this->initializeModel();
}

OAIIssueCertificateRequest_Validity::~OAIIssueCertificateRequest_Validity() {}

void OAIIssueCertificateRequest_Validity::initializeModel() {
...
void OAIIssueCertificateRequest_Validity::fromJson(QString jsonString) {
...
void OAIIssueCertificateRequest_Validity::fromJsonObject(QJsonObject json) {
...
QString OAIIssueCertificateRequest_Validity::asJson() const {
...
QJsonObject OAIIssueCertificateRequest_Validity::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
qint32 OAIIssueCertificateRequest_Validity::getValue() const {
    return m_value;
}
void OAIIssueCertificateRequest_Validity::setValue(const qint32 &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIIssueCertificateRequest_Validity::is_value_Set() const{
    return m_value_isSet;
}

bool OAIIssueCertificateRequest_Validity::is_value_Valid() const{
    return m_value_isValid;
}

OAIValidityPeriodType OAIIssueCertificateRequest_Validity::getType() const {
    return m_type;
}
void OAIIssueCertificateRequest_Validity::setType(const OAIValidityPeriodType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIIssueCertificateRequest_Validity::is_type_Set() const{
    return m_type_isSet;
}

bool OAIIssueCertificateRequest_Validity::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIIssueCertificateRequest_Validity::isSet() const {
...
bool OAIIssueCertificateRequest_Validity::isValid() const {
