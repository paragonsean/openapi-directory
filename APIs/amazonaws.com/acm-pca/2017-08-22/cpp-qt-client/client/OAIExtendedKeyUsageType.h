...
/*
 * OAIExtendedKeyUsageType.h
 *
 * 
 */

#ifndef OAIExtendedKeyUsageType_H
#define OAIExtendedKeyUsageType_H
...
class OAIExtendedKeyUsageType : public OAIEnum {
public:
    OAIExtendedKeyUsageType();
    OAIExtendedKeyUsageType(QString json);
    ~OAIExtendedKeyUsageType() override;
    ...
    enum class eOAIExtendedKeyUsageType {
    ...
    OAIExtendedKeyUsageType::eOAIExtendedKeyUsageType getValue() const;
    void setValue(const OAIExtendedKeyUsageType::eOAIExtendedKeyUsageType& value);
...
private:
    ...
    eOAIExtendedKeyUsageType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtendedKeyUsageType)

#endif // OAIExtendedKeyUsageType_H
