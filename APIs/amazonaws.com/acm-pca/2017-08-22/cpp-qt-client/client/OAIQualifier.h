...
#ifndef OAIQualifier_H
#define OAIQualifier_H
...
class OAIQualifier : public OAIObject {
public:
    OAIQualifier();
    OAIQualifier(QString json);
    ~OAIQualifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQualifier)

#endif // OAIQualifier_H
