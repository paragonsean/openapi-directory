...
/*
 * OAICertificateAuthorityType.h
 *
 * 
 */

#ifndef OAICertificateAuthorityType_H
#define OAICertificateAuthorityType_H
...
class OAICertificateAuthorityType : public OAIEnum {
public:
    OAICertificateAuthorityType();
    OAICertificateAuthorityType(QString json);
    ~OAICertificateAuthorityType() override;
    ...
    enum class eOAICertificateAuthorityType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ROOT, 
        SUBORDINATE
    };
    OAICertificateAuthorityType::eOAICertificateAuthorityType getValue() const;
    void setValue(const OAICertificateAuthorityType::eOAICertificateAuthorityType& value);
...
private:
    ...
    eOAICertificateAuthorityType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAuthorityType)

#endif // OAICertificateAuthorityType_H
