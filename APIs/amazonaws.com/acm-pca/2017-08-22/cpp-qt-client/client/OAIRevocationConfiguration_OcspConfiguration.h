...
/*
 * OAIRevocationConfiguration_OcspConfiguration.h
 *
 * 
 */

#ifndef OAIRevocationConfiguration_OcspConfiguration_H
#define OAIRevocationConfiguration_OcspConfiguration_H
...
class OAIRevocationConfiguration_OcspConfiguration : public OAIObject {
public:
    OAIRevocationConfiguration_OcspConfiguration();
    OAIRevocationConfiguration_OcspConfiguration(QString json);
    ~OAIRevocationConfiguration_OcspConfiguration() override;
    ...
    QString getOcspCustomCname() const;
    void setOcspCustomCname(const QString &ocsp_custom_cname);
    bool is_ocsp_custom_cname_Set() const;
    bool is_ocsp_custom_cname_Valid() const;
...
private:
    ...
    QString m_ocsp_custom_cname;
    bool m_ocsp_custom_cname_isSet;
    bool m_ocsp_custom_cname_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRevocationConfiguration_OcspConfiguration)

#endif // OAIRevocationConfiguration_OcspConfiguration_H
