...
/*
 * OAIIssueCertificateRequest_ApiPassthrough.h
 *
 * 
 */

#ifndef OAIIssueCertificateRequest_ApiPassthrough_H
#define OAIIssueCertificateRequest_ApiPassthrough_H
...
class OAIIssueCertificateRequest_ApiPassthrough : public OAIObject {
public:
    OAIIssueCertificateRequest_ApiPassthrough();
    OAIIssueCertificateRequest_ApiPassthrough(QString json);
    ~OAIIssueCertificateRequest_ApiPassthrough() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueCertificateRequest_ApiPassthrough)

#endif // OAIIssueCertificateRequest_ApiPassthrough_H
