...
/*
 * OAIDescribeCertificateAuthorityAuditReportRequest.h
 *
 * 
 */

#ifndef OAIDescribeCertificateAuthorityAuditReportRequest_H
#define OAIDescribeCertificateAuthorityAuditReportRequest_H
...
class OAIDescribeCertificateAuthorityAuditReportRequest : public OAIObject {
public:
    OAIDescribeCertificateAuthorityAuditReportRequest();
    OAIDescribeCertificateAuthorityAuditReportRequest(QString json);
    ~OAIDescribeCertificateAuthorityAuditReportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCertificateAuthorityAuditReportRequest)

#endif // OAIDescribeCertificateAuthorityAuditReportRequest_H
