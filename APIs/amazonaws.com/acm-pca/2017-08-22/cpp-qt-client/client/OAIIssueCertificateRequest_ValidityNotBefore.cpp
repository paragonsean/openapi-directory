...
OAIIssueCertificateRequest_ValidityNotBefore::OAIIssueCertificateRequest_ValidityNotBefore(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIssueCertificateRequest_ValidityNotBefore::OAIIssueCertificateRequest_ValidityNotBefore() {
    this->initializeModel();
}

OAIIssueCertificateRequest_ValidityNotBefore::~OAIIssueCertificateRequest_ValidityNotBefore() {}

void OAIIssueCertificateRequest_ValidityNotBefore::initializeModel() {
...
void OAIIssueCertificateRequest_ValidityNotBefore::fromJson(QString jsonString) {
...
void OAIIssueCertificateRequest_ValidityNotBefore::fromJsonObject(QJsonObject json) {
...
QString OAIIssueCertificateRequest_ValidityNotBefore::asJson() const {
...
QJsonObject OAIIssueCertificateRequest_ValidityNotBefore::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
qint32 OAIIssueCertificateRequest_ValidityNotBefore::getValue() const {
    return m_value;
}
void OAIIssueCertificateRequest_ValidityNotBefore::setValue(const qint32 &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIIssueCertificateRequest_ValidityNotBefore::is_value_Set() const{
    return m_value_isSet;
}

bool OAIIssueCertificateRequest_ValidityNotBefore::is_value_Valid() const{
    return m_value_isValid;
}

OAIValidityPeriodType OAIIssueCertificateRequest_ValidityNotBefore::getType() const {
    return m_type;
}
void OAIIssueCertificateRequest_ValidityNotBefore::setType(const OAIValidityPeriodType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIIssueCertificateRequest_ValidityNotBefore::is_type_Set() const{
    return m_type_isSet;
}

bool OAIIssueCertificateRequest_ValidityNotBefore::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIIssueCertificateRequest_ValidityNotBefore::isSet() const {
...
bool OAIIssueCertificateRequest_ValidityNotBefore::isValid() const {
