...
/*
 * OAIIssueCertificateRequest_ValidityNotBefore.h
 *
 * 
 */

#ifndef OAIIssueCertificateRequest_ValidityNotBefore_H
#define OAIIssueCertificateRequest_ValidityNotBefore_H
...
class OAIIssueCertificateRequest_ValidityNotBefore : public OAIObject {
public:
    OAIIssueCertificateRequest_ValidityNotBefore();
    OAIIssueCertificateRequest_ValidityNotBefore(QString json);
    ~OAIIssueCertificateRequest_ValidityNotBefore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueCertificateRequest_ValidityNotBefore)

#endif // OAIIssueCertificateRequest_ValidityNotBefore_H
