...
/*
 * OAIDeletePermissionRequest.h
 *
 * 
 */

#ifndef OAIDeletePermissionRequest_H
#define OAIDeletePermissionRequest_H
...
class OAIDeletePermissionRequest : public OAIObject {
public:
    OAIDeletePermissionRequest();
    OAIDeletePermissionRequest(QString json);
    ~OAIDeletePermissionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePermissionRequest)

#endif // OAIDeletePermissionRequest_H
