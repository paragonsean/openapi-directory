...
QString OAIListTagsRequest::getCertificateAuthorityArn() const {
    return m_certificate_authority_arn;
}
void OAIListTagsRequest::setCertificateAuthorityArn(const QString &certificate_authority_arn) {
    m_certificate_authority_arn = certificate_authority_arn;
    m_certificate_authority_arn_isSet = true;
}

bool OAIListTagsRequest::is_certificate_authority_arn_Set() const{
    return m_certificate_authority_arn_isSet;
}

bool OAIListTagsRequest::is_certificate_authority_arn_Valid() const{
    return m_certificate_authority_arn_isValid;
}

QString OAIListTagsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListTagsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTagsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTagsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListTagsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListTagsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListTagsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListTagsRequest::is_max_results_Valid() const{
