...
QString OAICustomAttribute::getObjectIdentifier() const {
    return m_object_identifier;
}
void OAICustomAttribute::setObjectIdentifier(const QString &object_identifier) {
    m_object_identifier = object_identifier;
    m_object_identifier_isSet = true;
}

bool OAICustomAttribute::is_object_identifier_Set() const{
    return m_object_identifier_isSet;
}

bool OAICustomAttribute::is_object_identifier_Valid() const{
