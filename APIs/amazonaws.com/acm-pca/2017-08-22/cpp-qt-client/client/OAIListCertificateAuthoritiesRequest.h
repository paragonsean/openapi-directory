...
/*
 * OAIListCertificateAuthoritiesRequest.h
 *
 * 
 */

#ifndef OAIListCertificateAuthoritiesRequest_H
#define OAIListCertificateAuthoritiesRequest_H
...
class OAIListCertificateAuthoritiesRequest : public OAIObject {
public:
    OAIListCertificateAuthoritiesRequest();
    OAIListCertificateAuthoritiesRequest(QString json);
    ~OAIListCertificateAuthoritiesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCertificateAuthoritiesRequest)

#endif // OAIListCertificateAuthoritiesRequest_H
