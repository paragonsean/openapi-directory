...
/*
 * OAIValidityPeriodType.h
 *
 * 
 */

#ifndef OAIValidityPeriodType_H
#define OAIValidityPeriodType_H
...
class OAIValidityPeriodType : public OAIEnum {
public:
    OAIValidityPeriodType();
    OAIValidityPeriodType(QString json);
    ~OAIValidityPeriodType() override;
    ...
    enum class eOAIValidityPeriodType {
    ...
    OAIValidityPeriodType::eOAIValidityPeriodType getValue() const;
    void setValue(const OAIValidityPeriodType::eOAIValidityPeriodType& value);
...
private:
    ...
    eOAIValidityPeriodType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidityPeriodType)

#endif // OAIValidityPeriodType_H
