...
/*
 * OAIDescribeCertificateAuthorityResponse_CertificateAuthority.h
 *
 * 
 */

#ifndef OAIDescribeCertificateAuthorityResponse_CertificateAuthority_H
#define OAIDescribeCertificateAuthorityResponse_CertificateAuthority_H
...
class OAIDescribeCertificateAuthorityResponse_CertificateAuthority : public OAIObject {
public:
    OAIDescribeCertificateAuthorityResponse_CertificateAuthority();
    OAIDescribeCertificateAuthorityResponse_CertificateAuthority(QString json);
    ~OAIDescribeCertificateAuthorityResponse_CertificateAuthority() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCertificateAuthorityResponse_CertificateAuthority)

#endif // OAIDescribeCertificateAuthorityResponse_CertificateAuthority_H
