...
* @readonly
*/
export default class EventSourceValues {
    ...
    /**
    * Returns a <code>EventSourceValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventSourceValues} The enum <code>EventSourceValues</code> value.
    */
