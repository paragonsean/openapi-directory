...
* @readonly
*/
export default class EventTypeValues {
    ...
    /**
    * Returns a <code>EventTypeValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventTypeValues} The enum <code>EventTypeValues</code> value.
    */
