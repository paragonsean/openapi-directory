...
* @readonly
*/
export default class SettablePolicyStateValues {
    ...
    /**
    * Returns a <code>SettablePolicyStateValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SettablePolicyStateValues} The enum <code>SettablePolicyStateValues</code> value.
    */
