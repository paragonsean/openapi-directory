...
* @readonly
*/
export default class GettablePolicyStateValues {
    ...
    /**
    * Returns a <code>GettablePolicyStateValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GettablePolicyStateValues} The enum <code>GettablePolicyStateValues</code> value.
    */
