...
* @readonly
*/
export default class ResourceLocationValues {
    ...
    /**
    * Returns a <code>ResourceLocationValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ResourceLocationValues} The enum <code>ResourceLocationValues</code> value.
    */
