...
* @readonly
*/
export default class RetentionIntervalUnitValues {
    ...
    /**
    * Returns a <code>RetentionIntervalUnitValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RetentionIntervalUnitValues} The enum <code>RetentionIntervalUnitValues</code> value.
    */
