...
(function(root, factory) {
  ...
  describe('GettablePolicyStateValues', function() {
    it('should create an instance of GettablePolicyStateValues', function() {
      // uncomment below and update the code to test GettablePolicyStateValues
      //var instance = new AmazonDataLifecycleManager.GettablePolicyStateValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.GettablePolicyStateValues);
    });
