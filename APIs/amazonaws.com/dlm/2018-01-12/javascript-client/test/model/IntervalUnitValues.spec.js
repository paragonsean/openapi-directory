...
(function(root, factory) {
  ...
  describe('IntervalUnitValues', function() {
    it('should create an instance of IntervalUnitValues', function() {
      // uncomment below and update the code to test IntervalUnitValues
      //var instance = new AmazonDataLifecycleManager.IntervalUnitValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.IntervalUnitValues);
    });
