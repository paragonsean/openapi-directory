...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.ScheduleCreateRule();
  });
  ...
  describe('ScheduleCreateRule', function() {
    it('should create an instance of ScheduleCreateRule', function() {
      // uncomment below and update the code to test ScheduleCreateRule
      //var instance = new AmazonDataLifecycleManager.ScheduleCreateRule();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.ScheduleCreateRule);
    });
