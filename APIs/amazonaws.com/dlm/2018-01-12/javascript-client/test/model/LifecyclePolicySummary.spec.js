...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.LifecyclePolicySummary();
  });
  ...
  describe('LifecyclePolicySummary', function() {
    it('should create an instance of LifecyclePolicySummary', function() {
      // uncomment below and update the code to test LifecyclePolicySummary
      //var instance = new AmazonDataLifecycleManager.LifecyclePolicySummary();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.LifecyclePolicySummary);
    });
