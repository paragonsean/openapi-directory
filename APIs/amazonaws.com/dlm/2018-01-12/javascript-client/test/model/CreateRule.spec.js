...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.CreateRule();
  });
  ...
  describe('CreateRule', function() {
    it('should create an instance of CreateRule', function() {
      // uncomment below and update the code to test CreateRule
      //var instance = new AmazonDataLifecycleManager.CreateRule();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.CreateRule);
    });
