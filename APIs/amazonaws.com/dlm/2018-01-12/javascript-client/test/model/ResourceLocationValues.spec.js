...
(function(root, factory) {
  ...
  describe('ResourceLocationValues', function() {
    it('should create an instance of ResourceLocationValues', function() {
      // uncomment below and update the code to test ResourceLocationValues
      //var instance = new AmazonDataLifecycleManager.ResourceLocationValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.ResourceLocationValues);
    });
