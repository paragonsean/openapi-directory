...
(function(root, factory) {
  ...
  describe('EventTypeValues', function() {
    it('should create an instance of EventTypeValues', function() {
      // uncomment below and update the code to test EventTypeValues
      //var instance = new AmazonDataLifecycleManager.EventTypeValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.EventTypeValues);
    });
