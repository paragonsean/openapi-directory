...
(function(root, factory) {
  ...
  describe('SettablePolicyStateValues', function() {
    it('should create an instance of SettablePolicyStateValues', function() {
      // uncomment below and update the code to test SettablePolicyStateValues
      //var instance = new AmazonDataLifecycleManager.SettablePolicyStateValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.SettablePolicyStateValues);
    });
