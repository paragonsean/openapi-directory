...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.GetLifecyclePolicyResponsePolicy();
  });
  ...
  describe('GetLifecyclePolicyResponsePolicy', function() {
    it('should create an instance of GetLifecyclePolicyResponsePolicy', function() {
      // uncomment below and update the code to test GetLifecyclePolicyResponsePolicy
      //var instance = new AmazonDataLifecycleManager.GetLifecyclePolicyResponsePolicy();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.GetLifecyclePolicyResponsePolicy);
    });
