...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.GetLifecyclePolicyResponse();
  });
  ...
  describe('GetLifecyclePolicyResponse', function() {
    it('should create an instance of GetLifecyclePolicyResponse', function() {
      ...
      //var instance = new AmazonDataLifecycleManager.GetLifecyclePolicyResponse();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.GetLifecyclePolicyResponse);
    });
