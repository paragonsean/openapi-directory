...
(function(root, factory) {
  ...
  describe('RetentionIntervalUnitValues', function() {
    it('should create an instance of RetentionIntervalUnitValues', function() {
      // uncomment below and update the code to test RetentionIntervalUnitValues
      //var instance = new AmazonDataLifecycleManager.RetentionIntervalUnitValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.RetentionIntervalUnitValues);
    });
