...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.LifecyclePolicyPolicyDetails();
  });
  ...
  describe('LifecyclePolicyPolicyDetails', function() {
    it('should create an instance of LifecyclePolicyPolicyDetails', function() {
      // uncomment below and update the code to test LifecyclePolicyPolicyDetails
      //var instance = new AmazonDataLifecycleManager.LifecyclePolicyPolicyDetails();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.LifecyclePolicyPolicyDetails);
    });
