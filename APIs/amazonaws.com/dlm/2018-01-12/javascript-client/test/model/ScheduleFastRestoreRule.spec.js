...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.ScheduleFastRestoreRule();
  });
  ...
  describe('ScheduleFastRestoreRule', function() {
    it('should create an instance of ScheduleFastRestoreRule', function() {
      // uncomment below and update the code to test ScheduleFastRestoreRule
      //var instance = new AmazonDataLifecycleManager.ScheduleFastRestoreRule();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.ScheduleFastRestoreRule);
    });
