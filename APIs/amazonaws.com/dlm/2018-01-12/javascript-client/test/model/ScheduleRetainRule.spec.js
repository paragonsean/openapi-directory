...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.ScheduleRetainRule();
  });
  ...
  describe('ScheduleRetainRule', function() {
    it('should create an instance of ScheduleRetainRule', function() {
      // uncomment below and update the code to test ScheduleRetainRule
      //var instance = new AmazonDataLifecycleManager.ScheduleRetainRule();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.ScheduleRetainRule);
    });
