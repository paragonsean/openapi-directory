...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.Action();
  });
  ...
  describe('Action', function() {
    it('should create an instance of Action', function() {
      ...
      //var instance = new AmazonDataLifecycleManager.Action();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.Action);
    });
    ...
    it('should have the property crossRegionCopy (base name: "CrossRegionCopy")', function() {
      // uncomment below and update the code to test the property crossRegionCopy
      //var instance = new AmazonDataLifecycleManager.Action();
      //expect(instance).to.be();
    });
