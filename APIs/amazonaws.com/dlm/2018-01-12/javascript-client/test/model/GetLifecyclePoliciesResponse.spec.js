...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.GetLifecyclePoliciesResponse();
  });
  ...
  describe('GetLifecyclePoliciesResponse', function() {
    it('should create an instance of GetLifecyclePoliciesResponse', function() {
      // uncomment below and update the code to test GetLifecyclePoliciesResponse
      //var instance = new AmazonDataLifecycleManager.GetLifecyclePoliciesResponse();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.GetLifecyclePoliciesResponse);
    });
