...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.ScheduleDeprecateRule();
  });
  ...
  describe('ScheduleDeprecateRule', function() {
    it('should create an instance of ScheduleDeprecateRule', function() {
      // uncomment below and update the code to test ScheduleDeprecateRule
      //var instance = new AmazonDataLifecycleManager.ScheduleDeprecateRule();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.ScheduleDeprecateRule);
    });
