...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.CrossRegionCopyAction();
  });
  ...
  describe('CrossRegionCopyAction', function() {
    it('should create an instance of CrossRegionCopyAction', function() {
      // uncomment below and update the code to test CrossRegionCopyAction
      //var instance = new AmazonDataLifecycleManager.CrossRegionCopyAction();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.CrossRegionCopyAction);
    });
