...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.RetentionArchiveTier();
  });
  ...
  describe('RetentionArchiveTier', function() {
    it('should create an instance of RetentionArchiveTier', function() {
      // uncomment below and update the code to test RetentionArchiveTier
      //var instance = new AmazonDataLifecycleManager.RetentionArchiveTier();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.RetentionArchiveTier);
    });
