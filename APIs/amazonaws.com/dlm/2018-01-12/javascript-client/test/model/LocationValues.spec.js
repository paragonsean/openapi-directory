...
(function(root, factory) {
  ...
  describe('LocationValues', function() {
    it('should create an instance of LocationValues', function() {
      // uncomment below and update the code to test LocationValues
      //var instance = new AmazonDataLifecycleManager.LocationValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.LocationValues);
    });
