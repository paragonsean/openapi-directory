...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.DeprecateRule();
  });
  ...
  describe('DeprecateRule', function() {
    it('should create an instance of DeprecateRule', function() {
      // uncomment below and update the code to test DeprecateRule
      //var instance = new AmazonDataLifecycleManager.DeprecateRule();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.DeprecateRule);
    });
