...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.RetainRule();
  });
  ...
  describe('RetainRule', function() {
    it('should create an instance of RetainRule', function() {
      // uncomment below and update the code to test RetainRule
      //var instance = new AmazonDataLifecycleManager.RetainRule();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.RetainRule);
    });
