...
(function(root, factory) {
  ...
  describe('PolicyTypeValues', function() {
    it('should create an instance of PolicyTypeValues', function() {
      // uncomment below and update the code to test PolicyTypeValues
      //var instance = new AmazonDataLifecycleManager.PolicyTypeValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.PolicyTypeValues);
    });
