...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonDataLifecycleManager.TagResourceRequest();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.TagResourceRequest);
    });
