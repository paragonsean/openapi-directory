...
(function(root, factory) {
  ...
  describe('ResourceTypeValues', function() {
    it('should create an instance of ResourceTypeValues', function() {
      // uncomment below and update the code to test ResourceTypeValues
      //var instance = new AmazonDataLifecycleManager.ResourceTypeValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.ResourceTypeValues);
    });
