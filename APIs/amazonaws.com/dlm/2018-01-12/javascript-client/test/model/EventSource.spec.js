...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDataLifecycleManager.EventSource();
  });
  ...
  describe('EventSource', function() {
    it('should create an instance of EventSource', function() {
      ...
      //var instance = new AmazonDataLifecycleManager.EventSource();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.EventSource);
    });
