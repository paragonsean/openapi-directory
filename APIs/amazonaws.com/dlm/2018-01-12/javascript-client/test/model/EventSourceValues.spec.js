...
(function(root, factory) {
  ...
  describe('EventSourceValues', function() {
    it('should create an instance of EventSourceValues', function() {
      // uncomment below and update the code to test EventSourceValues
      //var instance = new AmazonDataLifecycleManager.EventSourceValues();
      //expect(instance).to.be.a(AmazonDataLifecycleManager.EventSourceValues);
    });
