...
public class UpdateLifecyclePolicyRequestPolicyDetails {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails() {
  }

  public UpdateLifecyclePolicyRequestPolicyDetails policyType(PolicyTypeValues policyType) {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails resourceTypes(List resourceTypes) {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails resourceLocations(List resourceLocations) {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails targetTags(List targetTags) {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails schedules(List schedules) {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails parameters(CreateLifecyclePolicyRequestPolicyDetailsParameters parameters) {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails eventSource(CreateLifecyclePolicyRequestPolicyDetailsEventSource eventSource) {
  ...
  public UpdateLifecyclePolicyRequestPolicyDetails actions(List actions) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateLifecyclePolicyRequestPolicyDetails updateLifecyclePolicyRequestPolicyDetails = (UpdateLifecyclePolicyRequestPolicyDetails) o;
    return Objects.equals(this.policyType, updateLifecyclePolicyRequestPolicyDetails.policyType) &&
        Objects.equals(this.resourceTypes, updateLifecyclePolicyRequestPolicyDetails.resourceTypes) &&
        Objects.equals(this.resourceLocations, updateLifecyclePolicyRequestPolicyDetails.resourceLocations) &&
        Objects.equals(this.targetTags, updateLifecyclePolicyRequestPolicyDetails.targetTags) &&
        Objects.equals(this.schedules, updateLifecyclePolicyRequestPolicyDetails.schedules) &&
        Objects.equals(this.parameters, updateLifecyclePolicyRequestPolicyDetails.parameters) &&
        Objects.equals(this.eventSource, updateLifecyclePolicyRequestPolicyDetails.eventSource) &&
        Objects.equals(this.actions, updateLifecyclePolicyRequestPolicyDetails.actions);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateLifecyclePolicyRequestPolicyDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateLifecyclePolicyRequestPolicyDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateLifecyclePolicyRequestPolicyDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateLifecyclePolicyRequestPolicyDetails is not found in the empty JSON string", UpdateLifecyclePolicyRequestPolicyDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateLifecyclePolicyRequestPolicyDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateLifecyclePolicyRequestPolicyDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateLifecyclePolicyRequestPolicyDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateLifecyclePolicyRequestPolicyDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateLifecyclePolicyRequestPolicyDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateLifecyclePolicyRequestPolicyDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateLifecyclePolicyRequestPolicyDetails>() {
           @Override
           public void write(JsonWriter out, UpdateLifecyclePolicyRequestPolicyDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateLifecyclePolicyRequestPolicyDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateLifecyclePolicyRequestPolicyDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateLifecyclePolicyRequestPolicyDetails
   * @throws IOException if the JSON string is invalid with respect to UpdateLifecyclePolicyRequestPolicyDetails
   */
  public static UpdateLifecyclePolicyRequestPolicyDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateLifecyclePolicyRequestPolicyDetails.class);
  }

  /**
   * Convert an instance of UpdateLifecyclePolicyRequestPolicyDetails to an JSON string
   *
   * @return JSON string
   */
