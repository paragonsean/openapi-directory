...
public class DeprecateRule {
  ...
  public DeprecateRule count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public DeprecateRule interval(Integer interval) {
  ...
  public DeprecateRule intervalUnit(RetentionIntervalUnitValues intervalUnit) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecateRule deprecateRule = (DeprecateRule) o;
    return Objects.equals(this.count, deprecateRule.count) &&
        Objects.equals(this.interval, deprecateRule.interval) &&
        Objects.equals(this.intervalUnit, deprecateRule.intervalUnit);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeprecateRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeprecateRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecateRule is not found in the empty JSON string", DeprecateRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeprecateRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeprecateRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecateRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecateRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecateRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecateRule.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecateRule>() {
           @Override
           public void write(JsonWriter out, DeprecateRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeprecateRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeprecateRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeprecateRule
   * @throws IOException if the JSON string is invalid with respect to DeprecateRule
   */
  public static DeprecateRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecateRule.class);
  }

  /**
   * Convert an instance of DeprecateRule to an JSON string
   *
   * @return JSON string
   */
