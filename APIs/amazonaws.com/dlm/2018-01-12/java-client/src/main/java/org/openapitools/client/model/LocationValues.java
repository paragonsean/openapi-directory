...
/**
 * Gets or Sets LocationValues
 */
@JsonAdapter(LocationValues.Adapter.class)
public enum LocationValues {
  ...
  public static LocationValues fromValue(String value) {
    for (LocationValues b : LocationValues.values()) {
  ...
  public static class Adapter extends TypeAdapter<LocationValues> {
    @Override
    public void write(final JsonWriter jsonWriter, final LocationValues enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LocationValues read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LocationValues.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LocationValues.fromValue(value);
  }
}
