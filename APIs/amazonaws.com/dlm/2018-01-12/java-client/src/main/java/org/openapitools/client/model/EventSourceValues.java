...
/**
 * Gets or Sets EventSourceValues
 */
@JsonAdapter(EventSourceValues.Adapter.class)
public enum EventSourceValues {
  ...
  EventSourceValues(String value) {
    this.value = value;
  }
  ...
  public static EventSourceValues fromValue(String value) {
    for (EventSourceValues b : EventSourceValues.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventSourceValues> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventSourceValues enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventSourceValues read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventSourceValues.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventSourceValues.fromValue(value);
  }
}
