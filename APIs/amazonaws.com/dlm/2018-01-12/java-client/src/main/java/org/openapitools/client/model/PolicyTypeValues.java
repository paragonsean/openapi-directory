...
/**
 * Gets or Sets PolicyTypeValues
 */
@JsonAdapter(PolicyTypeValues.Adapter.class)
public enum PolicyTypeValues {
  ...
  public static PolicyTypeValues fromValue(String value) {
    for (PolicyTypeValues b : PolicyTypeValues.values()) {
  ...
  public static class Adapter extends TypeAdapter<PolicyTypeValues> {
    @Override
    public void write(final JsonWriter jsonWriter, final PolicyTypeValues enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PolicyTypeValues read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PolicyTypeValues.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PolicyTypeValues.fromValue(value);
  }
}
