...
/**
 * Gets or Sets ResourceTypeValues
 */
@JsonAdapter(ResourceTypeValues.Adapter.class)
public enum ResourceTypeValues {
  ...
  public static ResourceTypeValues fromValue(String value) {
    for (ResourceTypeValues b : ResourceTypeValues.values()) {
  ...
  public static class Adapter extends TypeAdapter<ResourceTypeValues> {
    @Override
    public void write(final JsonWriter jsonWriter, final ResourceTypeValues enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ResourceTypeValues read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ResourceTypeValues.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ResourceTypeValues.fromValue(value);
  }
}
