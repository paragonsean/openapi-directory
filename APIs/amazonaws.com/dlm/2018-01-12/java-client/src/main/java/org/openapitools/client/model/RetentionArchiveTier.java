...
public class RetentionArchiveTier {
  ...
  public RetentionArchiveTier count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public RetentionArchiveTier interval(Integer interval) {
  ...
  public RetentionArchiveTier intervalUnit(RetentionIntervalUnitValues intervalUnit) {
  ...
  public boolean equals(Object o) {
    ...
    RetentionArchiveTier retentionArchiveTier = (RetentionArchiveTier) o;
    return Objects.equals(this.count, retentionArchiveTier.count) &&
        Objects.equals(this.interval, retentionArchiveTier.interval) &&
        Objects.equals(this.intervalUnit, retentionArchiveTier.intervalUnit);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetentionArchiveTier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetentionArchiveTier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetentionArchiveTier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetentionArchiveTier is not found in the empty JSON string", RetentionArchiveTier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetentionArchiveTier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetentionArchiveTier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetentionArchiveTier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetentionArchiveTier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetentionArchiveTier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetentionArchiveTier.class));

       return (TypeAdapter<T>) new TypeAdapter<RetentionArchiveTier>() {
           @Override
           public void write(JsonWriter out, RetentionArchiveTier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetentionArchiveTier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetentionArchiveTier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetentionArchiveTier
   * @throws IOException if the JSON string is invalid with respect to RetentionArchiveTier
   */
  public static RetentionArchiveTier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetentionArchiveTier.class);
  }

  /**
   * Convert an instance of RetentionArchiveTier to an JSON string
   *
   * @return JSON string
   */
