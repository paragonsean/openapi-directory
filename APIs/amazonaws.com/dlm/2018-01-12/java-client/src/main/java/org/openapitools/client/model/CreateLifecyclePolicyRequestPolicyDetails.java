...
public class CreateLifecyclePolicyRequestPolicyDetails {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails() {
  }

  public CreateLifecyclePolicyRequestPolicyDetails policyType(PolicyTypeValues policyType) {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails resourceTypes(List resourceTypes) {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails resourceLocations(List resourceLocations) {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails targetTags(List targetTags) {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails schedules(List schedules) {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails parameters(CreateLifecyclePolicyRequestPolicyDetailsParameters parameters) {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails eventSource(CreateLifecyclePolicyRequestPolicyDetailsEventSource eventSource) {
  ...
  public CreateLifecyclePolicyRequestPolicyDetails actions(List actions) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLifecyclePolicyRequestPolicyDetails createLifecyclePolicyRequestPolicyDetails = (CreateLifecyclePolicyRequestPolicyDetails) o;
    return Objects.equals(this.policyType, createLifecyclePolicyRequestPolicyDetails.policyType) &&
        Objects.equals(this.resourceTypes, createLifecyclePolicyRequestPolicyDetails.resourceTypes) &&
        Objects.equals(this.resourceLocations, createLifecyclePolicyRequestPolicyDetails.resourceLocations) &&
        Objects.equals(this.targetTags, createLifecyclePolicyRequestPolicyDetails.targetTags) &&
        Objects.equals(this.schedules, createLifecyclePolicyRequestPolicyDetails.schedules) &&
        Objects.equals(this.parameters, createLifecyclePolicyRequestPolicyDetails.parameters) &&
        Objects.equals(this.eventSource, createLifecyclePolicyRequestPolicyDetails.eventSource) &&
        Objects.equals(this.actions, createLifecyclePolicyRequestPolicyDetails.actions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLifecyclePolicyRequestPolicyDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLifecyclePolicyRequestPolicyDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLifecyclePolicyRequestPolicyDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLifecyclePolicyRequestPolicyDetails is not found in the empty JSON string", CreateLifecyclePolicyRequestPolicyDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLifecyclePolicyRequestPolicyDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLifecyclePolicyRequestPolicyDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLifecyclePolicyRequestPolicyDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLifecyclePolicyRequestPolicyDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLifecyclePolicyRequestPolicyDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLifecyclePolicyRequestPolicyDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLifecyclePolicyRequestPolicyDetails>() {
           @Override
           public void write(JsonWriter out, CreateLifecyclePolicyRequestPolicyDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLifecyclePolicyRequestPolicyDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLifecyclePolicyRequestPolicyDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLifecyclePolicyRequestPolicyDetails
   * @throws IOException if the JSON string is invalid with respect to CreateLifecyclePolicyRequestPolicyDetails
   */
  public static CreateLifecyclePolicyRequestPolicyDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLifecyclePolicyRequestPolicyDetails.class);
  }

  /**
   * Convert an instance of CreateLifecyclePolicyRequestPolicyDetails to an JSON string
   *
   * @return JSON string
   */
