...
class EventParameters(Model):
    ...
    def __init__(self, event_type: EventTypeValues=None, snapshot_owner: List=None, description_regex: str=None):
        """EventParameters - a model defined in OpenAPI

        :param event_type: The event_type of this EventParameters.
        :param snapshot_owner: The snapshot_owner of this EventParameters.
        :param description_regex: The description_regex of this EventParameters.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EventParameters':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EventParameters of this EventParameters.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def event_type(self):
        """Gets the event_type of this EventParameters.


        :return: The event_type of this EventParameters.
    ...
    def event_type(self, event_type):
        """Sets the event_type of this EventParameters.
    ...
    def snapshot_owner(self):
        """Gets the snapshot_owner of this EventParameters.


        :return: The snapshot_owner of this EventParameters.
        :rtype: List
        """
    ...
    def snapshot_owner(self, snapshot_owner):
        """Sets the snapshot_owner of this EventParameters.
    ...
    def description_regex(self):
        """Gets the description_regex of this EventParameters.


        :return: The description_regex of this EventParameters.
        :rtype: str
        """
    ...
    def description_regex(self, description_regex):
        """Sets the description_regex of this EventParameters.
