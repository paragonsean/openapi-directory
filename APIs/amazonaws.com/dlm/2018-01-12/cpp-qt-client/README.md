...
class Example : public QObject {
    Q_OBJECT
    OAICreateLifecyclePolicy_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateLifecyclePolicy_request Example::create(){
    OAICreateLifecyclePolicy_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createLifecyclePolicySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createLifecyclePolicySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateLifecyclePolicy_request oai_create_lifecycle_policy_request = create(); // OAICreateLifecyclePolicy_request | 
      ...
      apiInstance.createLifecyclePolicy(oai_create_lifecycle_policy_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
