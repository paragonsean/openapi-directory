...
/*
 * OAISchedule_CreateRule.h
 *
 * 
 */

#ifndef OAISchedule_CreateRule_H
#define OAISchedule_CreateRule_H
...
class OAISchedule_CreateRule : public OAIObject {
public:
    OAISchedule_CreateRule();
    OAISchedule_CreateRule(QString json);
    ~OAISchedule_CreateRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchedule_CreateRule)

#endif // OAISchedule_CreateRule_H
