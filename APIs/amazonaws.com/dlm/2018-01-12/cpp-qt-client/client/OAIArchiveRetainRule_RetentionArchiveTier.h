...
/*
 * OAIArchiveRetainRule_RetentionArchiveTier.h
 *
 * 
 */

#ifndef OAIArchiveRetainRule_RetentionArchiveTier_H
#define OAIArchiveRetainRule_RetentionArchiveTier_H
...
class OAIArchiveRetainRule_RetentionArchiveTier : public OAIObject {
public:
    OAIArchiveRetainRule_RetentionArchiveTier();
    OAIArchiveRetainRule_RetentionArchiveTier(QString json);
    ~OAIArchiveRetainRule_RetentionArchiveTier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArchiveRetainRule_RetentionArchiveTier)

#endif // OAIArchiveRetainRule_RetentionArchiveTier_H
