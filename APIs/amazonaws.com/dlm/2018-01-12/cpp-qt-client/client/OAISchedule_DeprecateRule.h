...
/*
 * OAISchedule_DeprecateRule.h
 *
 * 
 */

#ifndef OAISchedule_DeprecateRule_H
#define OAISchedule_DeprecateRule_H
...
class OAISchedule_DeprecateRule : public OAIObject {
public:
    OAISchedule_DeprecateRule();
    OAISchedule_DeprecateRule(QString json);
    ~OAISchedule_DeprecateRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchedule_DeprecateRule)

#endif // OAISchedule_DeprecateRule_H
