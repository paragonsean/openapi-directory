...
#ifndef OAIFastRestoreRule_H
#define OAIFastRestoreRule_H
...
class OAIFastRestoreRule : public OAIObject {
public:
    OAIFastRestoreRule();
    OAIFastRestoreRule(QString json);
    ~OAIFastRestoreRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFastRestoreRule)

#endif // OAIFastRestoreRule_H
