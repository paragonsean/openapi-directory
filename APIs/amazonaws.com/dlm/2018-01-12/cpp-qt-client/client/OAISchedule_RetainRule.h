...
/*
 * OAISchedule_RetainRule.h
 *
 * 
 */

#ifndef OAISchedule_RetainRule_H
#define OAISchedule_RetainRule_H
...
class OAISchedule_RetainRule : public OAIObject {
public:
    OAISchedule_RetainRule();
    OAISchedule_RetainRule(QString json);
    ~OAISchedule_RetainRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchedule_RetainRule)

#endif // OAISchedule_RetainRule_H
