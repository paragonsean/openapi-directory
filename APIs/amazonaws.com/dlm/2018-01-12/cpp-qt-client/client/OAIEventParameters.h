...
class OAIEventParameters : public OAIObject {
public:
    OAIEventParameters();
    OAIEventParameters(QString json);
    ~OAIEventParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventParameters)

#endif // OAIEventParameters_H
