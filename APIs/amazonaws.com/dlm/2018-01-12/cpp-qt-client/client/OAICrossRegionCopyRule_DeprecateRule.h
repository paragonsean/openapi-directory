...
/*
 * OAICrossRegionCopyRule_DeprecateRule.h
 *
 * 
 */

#ifndef OAICrossRegionCopyRule_DeprecateRule_H
#define OAICrossRegionCopyRule_DeprecateRule_H
...
class OAICrossRegionCopyRule_DeprecateRule : public OAIObject {
public:
    OAICrossRegionCopyRule_DeprecateRule();
    OAICrossRegionCopyRule_DeprecateRule(QString json);
    ~OAICrossRegionCopyRule_DeprecateRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrossRegionCopyRule_DeprecateRule)

#endif // OAICrossRegionCopyRule_DeprecateRule_H
