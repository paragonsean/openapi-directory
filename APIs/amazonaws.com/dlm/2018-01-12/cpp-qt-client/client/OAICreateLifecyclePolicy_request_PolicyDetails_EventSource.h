...
/*
 * OAICreateLifecyclePolicy_request_PolicyDetails_EventSource.h
 *
 * 
 */

#ifndef OAICreateLifecyclePolicy_request_PolicyDetails_EventSource_H
#define OAICreateLifecyclePolicy_request_PolicyDetails_EventSource_H
...
class OAICreateLifecyclePolicy_request_PolicyDetails_EventSource : public OAIObject {
public:
    OAICreateLifecyclePolicy_request_PolicyDetails_EventSource();
    OAICreateLifecyclePolicy_request_PolicyDetails_EventSource(QString json);
    ~OAICreateLifecyclePolicy_request_PolicyDetails_EventSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLifecyclePolicy_request_PolicyDetails_EventSource)

#endif // OAICreateLifecyclePolicy_request_PolicyDetails_EventSource_H
