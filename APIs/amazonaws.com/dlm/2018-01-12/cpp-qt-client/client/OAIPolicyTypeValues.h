...
/*
 * OAIPolicyTypeValues.h
 *
 * 
 */

#ifndef OAIPolicyTypeValues_H
#define OAIPolicyTypeValues_H
...
class OAIPolicyTypeValues : public OAIEnum {
public:
    OAIPolicyTypeValues();
    OAIPolicyTypeValues(QString json);
    ~OAIPolicyTypeValues() override;
    ...
    enum class eOAIPolicyTypeValues {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EBS_SNAPSHOT_MANAGEMENT, 
        IMAGE_MANAGEMENT, 
        EVENT_BASED_POLICY
    };
    OAIPolicyTypeValues::eOAIPolicyTypeValues getValue() const;
    void setValue(const OAIPolicyTypeValues::eOAIPolicyTypeValues& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyTypeValues)

#endif // OAIPolicyTypeValues_H
