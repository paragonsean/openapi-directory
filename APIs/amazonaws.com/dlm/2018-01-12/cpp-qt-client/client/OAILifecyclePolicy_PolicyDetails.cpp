...
OAILifecyclePolicy_PolicyDetails::OAILifecyclePolicy_PolicyDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILifecyclePolicy_PolicyDetails::OAILifecyclePolicy_PolicyDetails() {
    this->initializeModel();
}

OAILifecyclePolicy_PolicyDetails::~OAILifecyclePolicy_PolicyDetails() {}

void OAILifecyclePolicy_PolicyDetails::initializeModel() {
...
void OAILifecyclePolicy_PolicyDetails::fromJson(QString jsonString) {
...
void OAILifecyclePolicy_PolicyDetails::fromJsonObject(QJsonObject json) {
...
QString OAILifecyclePolicy_PolicyDetails::asJson() const {
...
QJsonObject OAILifecyclePolicy_PolicyDetails::asJsonObject() const {
    QJsonObject obj;
...
OAIPolicyTypeValues OAILifecyclePolicy_PolicyDetails::getPolicyType() const {
    return m_policy_type;
}
void OAILifecyclePolicy_PolicyDetails::setPolicyType(const OAIPolicyTypeValues &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

QList OAILifecyclePolicy_PolicyDetails::getResourceTypes() const {
    return m_resource_types;
}
void OAILifecyclePolicy_PolicyDetails::setResourceTypes(const QList &resource_types) {
    m_resource_types = resource_types;
    m_resource_types_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_resource_types_Set() const{
    return m_resource_types_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_resource_types_Valid() const{
    return m_resource_types_isValid;
}

QList OAILifecyclePolicy_PolicyDetails::getResourceLocations() const {
    return m_resource_locations;
}
void OAILifecyclePolicy_PolicyDetails::setResourceLocations(const QList &resource_locations) {
    m_resource_locations = resource_locations;
    m_resource_locations_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_resource_locations_Set() const{
    return m_resource_locations_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_resource_locations_Valid() const{
    return m_resource_locations_isValid;
}

QList OAILifecyclePolicy_PolicyDetails::getTargetTags() const {
    return m_target_tags;
}
void OAILifecyclePolicy_PolicyDetails::setTargetTags(const QList &target_tags) {
    m_target_tags = target_tags;
    m_target_tags_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_target_tags_Set() const{
    return m_target_tags_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_target_tags_Valid() const{
    return m_target_tags_isValid;
}

QList OAILifecyclePolicy_PolicyDetails::getSchedules() const {
    return m_schedules;
}
void OAILifecyclePolicy_PolicyDetails::setSchedules(const QList &schedules) {
    m_schedules = schedules;
    m_schedules_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_schedules_Set() const{
    return m_schedules_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_schedules_Valid() const{
    return m_schedules_isValid;
}

OAICreateLifecyclePolicy_request_PolicyDetails_Parameters OAILifecyclePolicy_PolicyDetails::getParameters() const {
    return m_parameters;
}
void OAILifecyclePolicy_PolicyDetails::setParameters(const OAICreateLifecyclePolicy_request_PolicyDetails_Parameters &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_parameters_Valid() const{
    return m_parameters_isValid;
}

OAICreateLifecyclePolicy_request_PolicyDetails_EventSource OAILifecyclePolicy_PolicyDetails::getEventSource() const {
    return m_event_source;
}
void OAILifecyclePolicy_PolicyDetails::setEventSource(const OAICreateLifecyclePolicy_request_PolicyDetails_EventSource &event_source) {
    m_event_source = event_source;
    m_event_source_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_event_source_Set() const{
    return m_event_source_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_event_source_Valid() const{
    return m_event_source_isValid;
}

QList OAILifecyclePolicy_PolicyDetails::getActions() const {
    return m_actions;
}
void OAILifecyclePolicy_PolicyDetails::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAILifecyclePolicy_PolicyDetails::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAILifecyclePolicy_PolicyDetails::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAILifecyclePolicy_PolicyDetails::isSet() const {
...
bool OAILifecyclePolicy_PolicyDetails::isValid() const {
