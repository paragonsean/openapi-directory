...
/*
 * OAIEventTypeValues.h
 *
 * 
 */

#ifndef OAIEventTypeValues_H
#define OAIEventTypeValues_H
...
class OAIEventTypeValues : public OAIEnum {
public:
    OAIEventTypeValues();
    OAIEventTypeValues(QString json);
    ~OAIEventTypeValues() override;
    ...
    enum class eOAIEventTypeValues {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SHARESNAPSHOT
    };
    OAIEventTypeValues::eOAIEventTypeValues getValue() const;
    void setValue(const OAIEventTypeValues::eOAIEventTypeValues& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventTypeValues)

#endif // OAIEventTypeValues_H
