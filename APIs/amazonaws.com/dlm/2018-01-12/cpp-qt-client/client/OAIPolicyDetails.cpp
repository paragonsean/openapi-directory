...
OAIPolicyTypeValues OAIPolicyDetails::getPolicyType() const {
    return m_policy_type;
}
void OAIPolicyDetails::setPolicyType(const OAIPolicyTypeValues &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAIPolicyDetails::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAIPolicyDetails::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

QList OAIPolicyDetails::getResourceTypes() const {
    return m_resource_types;
}
void OAIPolicyDetails::setResourceTypes(const QList &resource_types) {
    m_resource_types = resource_types;
    m_resource_types_isSet = true;
}

bool OAIPolicyDetails::is_resource_types_Set() const{
    return m_resource_types_isSet;
}

bool OAIPolicyDetails::is_resource_types_Valid() const{
    return m_resource_types_isValid;
}

QList OAIPolicyDetails::getResourceLocations() const {
    return m_resource_locations;
}
void OAIPolicyDetails::setResourceLocations(const QList &resource_locations) {
    m_resource_locations = resource_locations;
    m_resource_locations_isSet = true;
}

bool OAIPolicyDetails::is_resource_locations_Set() const{
    return m_resource_locations_isSet;
}

bool OAIPolicyDetails::is_resource_locations_Valid() const{
    return m_resource_locations_isValid;
}

QList OAIPolicyDetails::getTargetTags() const {
    return m_target_tags;
}
void OAIPolicyDetails::setTargetTags(const QList &target_tags) {
    m_target_tags = target_tags;
    m_target_tags_isSet = true;
}

bool OAIPolicyDetails::is_target_tags_Set() const{
    return m_target_tags_isSet;
}

bool OAIPolicyDetails::is_target_tags_Valid() const{
    return m_target_tags_isValid;
}

QList OAIPolicyDetails::getSchedules() const {
    return m_schedules;
}
void OAIPolicyDetails::setSchedules(const QList &schedules) {
    m_schedules = schedules;
    m_schedules_isSet = true;
}

bool OAIPolicyDetails::is_schedules_Set() const{
    return m_schedules_isSet;
}

bool OAIPolicyDetails::is_schedules_Valid() const{
    return m_schedules_isValid;
}

OAICreateLifecyclePolicy_request_PolicyDetails_Parameters OAIPolicyDetails::getParameters() const {
    return m_parameters;
}
void OAIPolicyDetails::setParameters(const OAICreateLifecyclePolicy_request_PolicyDetails_Parameters &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIPolicyDetails::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIPolicyDetails::is_parameters_Valid() const{
    return m_parameters_isValid;
}

OAICreateLifecyclePolicy_request_PolicyDetails_EventSource OAIPolicyDetails::getEventSource() const {
    return m_event_source;
}
void OAIPolicyDetails::setEventSource(const OAICreateLifecyclePolicy_request_PolicyDetails_EventSource &event_source) {
    m_event_source = event_source;
    m_event_source_isSet = true;
}

bool OAIPolicyDetails::is_event_source_Set() const{
    return m_event_source_isSet;
}

bool OAIPolicyDetails::is_event_source_Valid() const{
    return m_event_source_isValid;
}

QList OAIPolicyDetails::getActions() const {
    return m_actions;
}
void OAIPolicyDetails::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIPolicyDetails::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIPolicyDetails::is_actions_Valid() const{
