...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppValidationConfigurationResponse();
  });
  ...
  describe('GetAppValidationConfigurationResponse', function() {
    it('should create an instance of GetAppValidationConfigurationResponse', function() {
      // uncomment below and update the code to test GetAppValidationConfigurationResponse
      //var instance = new AwsServerMigrationService.GetAppValidationConfigurationResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppValidationConfigurationResponse);
    });
