...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.DeleteAppLaunchConfigurationRequest();
  });
  ...
  describe('DeleteAppLaunchConfigurationRequest', function() {
    it('should create an instance of DeleteAppLaunchConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteAppLaunchConfigurationRequest
      //var instance = new AwsServerMigrationService.DeleteAppLaunchConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.DeleteAppLaunchConfigurationRequest);
    });
