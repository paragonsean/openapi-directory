...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ListAppsRequest();
  });
  ...
  describe('ListAppsRequest', function() {
    it('should create an instance of ListAppsRequest', function() {
      ...
      //var instance = new AwsServerMigrationService.ListAppsRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.ListAppsRequest);
    });
