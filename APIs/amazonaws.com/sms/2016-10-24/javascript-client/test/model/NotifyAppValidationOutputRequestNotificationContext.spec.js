...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.NotifyAppValidationOutputRequestNotificationContext();
  });
  ...
  describe('NotifyAppValidationOutputRequestNotificationContext', function() {
    it('should create an instance of NotifyAppValidationOutputRequestNotificationContext', function() {
      // uncomment below and update the code to test NotifyAppValidationOutputRequestNotificationContext
      //var instance = new AwsServerMigrationService.NotifyAppValidationOutputRequestNotificationContext();
      //expect(instance).to.be.a(AwsServerMigrationService.NotifyAppValidationOutputRequestNotificationContext);
    });
