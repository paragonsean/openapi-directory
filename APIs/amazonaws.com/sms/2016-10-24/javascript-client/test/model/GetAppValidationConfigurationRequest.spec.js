...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppValidationConfigurationRequest();
  });
  ...
  describe('GetAppValidationConfigurationRequest', function() {
    it('should create an instance of GetAppValidationConfigurationRequest', function() {
      // uncomment below and update the code to test GetAppValidationConfigurationRequest
      //var instance = new AwsServerMigrationService.GetAppValidationConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppValidationConfigurationRequest);
    });
