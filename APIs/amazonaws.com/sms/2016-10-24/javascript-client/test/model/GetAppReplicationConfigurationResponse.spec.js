...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppReplicationConfigurationResponse();
  });
  ...
  describe('GetAppReplicationConfigurationResponse', function() {
    it('should create an instance of GetAppReplicationConfigurationResponse', function() {
      // uncomment below and update the code to test GetAppReplicationConfigurationResponse
      //var instance = new AwsServerMigrationService.GetAppReplicationConfigurationResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppReplicationConfigurationResponse);
    });

    it('should have the property serverGroupReplicationConfigurations (base name: "serverGroupReplicationConfigurations")', function() {
      // uncomment below and update the code to test the property serverGroupReplicationConfigurations
      //var instance = new AwsServerMigrationService.GetAppReplicationConfigurationResponse();
