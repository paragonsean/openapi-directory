...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ValidationOutputAppValidationOutput();
  });
  ...
  describe('ValidationOutputAppValidationOutput', function() {
    it('should create an instance of ValidationOutputAppValidationOutput', function() {
      // uncomment below and update the code to test ValidationOutputAppValidationOutput
      //var instance = new AwsServerMigrationService.ValidationOutputAppValidationOutput();
      //expect(instance).to.be.a(AwsServerMigrationService.ValidationOutputAppValidationOutput);
    });

    it('should have the property ssmOutput (base name: "ssmOutput")', function() {
      // uncomment below and update the code to test the property ssmOutput
      //var instance = new AwsServerMigrationService.ValidationOutputAppValidationOutput();
