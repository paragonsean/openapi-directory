...
(function(root, factory) {
  ...
  describe('AppValidationStrategy', function() {
    it('should create an instance of AppValidationStrategy', function() {
      // uncomment below and update the code to test AppValidationStrategy
      //var instance = new AwsServerMigrationService.AppValidationStrategy();
      //expect(instance).to.be.a(AwsServerMigrationService.AppValidationStrategy);
    });
