...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppValidationOutputRequest();
  });
  ...
  describe('GetAppValidationOutputRequest', function() {
    it('should create an instance of GetAppValidationOutputRequest', function() {
      // uncomment below and update the code to test GetAppValidationOutputRequest
      //var instance = new AwsServerMigrationService.GetAppValidationOutputRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppValidationOutputRequest);
    });
