...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.AppValidationConfigurationSsmValidationParameters();
  });
  ...
  describe('AppValidationConfigurationSsmValidationParameters', function() {
    it('should create an instance of AppValidationConfigurationSsmValidationParameters', function() {
      // uncomment below and update the code to test AppValidationConfigurationSsmValidationParameters
      //var instance = new AwsServerMigrationService.AppValidationConfigurationSsmValidationParameters();
      //expect(instance).to.be.a(AwsServerMigrationService.AppValidationConfigurationSsmValidationParameters);
    });
