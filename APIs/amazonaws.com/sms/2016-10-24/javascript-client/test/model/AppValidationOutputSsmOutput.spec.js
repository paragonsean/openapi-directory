...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.AppValidationOutputSsmOutput();
  });
  ...
  describe('AppValidationOutputSsmOutput', function() {
    it('should create an instance of AppValidationOutputSsmOutput', function() {
      // uncomment below and update the code to test AppValidationOutputSsmOutput
      //var instance = new AwsServerMigrationService.AppValidationOutputSsmOutput();
      //expect(instance).to.be.a(AwsServerMigrationService.AppValidationOutputSsmOutput);
    });
