...
(function(root, factory) {
  ...
  describe('ReplicationRunType', function() {
    it('should create an instance of ReplicationRunType', function() {
      // uncomment below and update the code to test ReplicationRunType
      //var instance = new AwsServerMigrationService.ReplicationRunType();
      //expect(instance).to.be.a(AwsServerMigrationService.ReplicationRunType);
    });
