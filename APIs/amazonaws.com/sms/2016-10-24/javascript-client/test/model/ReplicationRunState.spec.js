...
(function(root, factory) {
  ...
  describe('ReplicationRunState', function() {
    it('should create an instance of ReplicationRunState', function() {
      // uncomment below and update the code to test ReplicationRunState
      //var instance = new AwsServerMigrationService.ReplicationRunState();
      //expect(instance).to.be.a(AwsServerMigrationService.ReplicationRunState);
    });
