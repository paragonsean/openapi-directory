...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.AppValidationOutput();
  });
  ...
  describe('AppValidationOutput', function() {
    it('should create an instance of AppValidationOutput', function() {
      // uncomment below and update the code to test AppValidationOutput
      //var instance = new AwsServerMigrationService.AppValidationOutput();
      //expect(instance).to.be.a(AwsServerMigrationService.AppValidationOutput);
    });
