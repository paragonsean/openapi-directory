...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.SSMOutput();
  });
  ...
  describe('SSMOutput', function() {
    it('should create an instance of SSMOutput', function() {
      // uncomment below and update the code to test SSMOutput
      //var instance = new AwsServerMigrationService.SSMOutput();
      //expect(instance).to.be.a(AwsServerMigrationService.SSMOutput);
    });
