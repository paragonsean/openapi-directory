...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.CreateReplicationJobRequest();
  });
  ...
  describe('CreateReplicationJobRequest', function() {
    it('should create an instance of CreateReplicationJobRequest', function() {
      // uncomment below and update the code to test CreateReplicationJobRequest
      //var instance = new AwsServerMigrationService.CreateReplicationJobRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.CreateReplicationJobRequest);
    });
