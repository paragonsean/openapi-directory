...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GenerateTemplateResponse();
  });
  ...
  describe('GenerateTemplateResponse', function() {
    it('should create an instance of GenerateTemplateResponse', function() {
      // uncomment below and update the code to test GenerateTemplateResponse
      //var instance = new AwsServerMigrationService.GenerateTemplateResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GenerateTemplateResponse);
    });
