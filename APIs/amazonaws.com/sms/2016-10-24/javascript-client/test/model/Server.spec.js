...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.Server();
  });
  ...
  describe('Server', function() {
    it('should create an instance of Server', function() {
      ...
      //var instance = new AwsServerMigrationService.Server();
      //expect(instance).to.be.a(AwsServerMigrationService.Server);
    });
