...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GenerateTemplateRequest();
  });
  ...
  describe('GenerateTemplateRequest', function() {
    it('should create an instance of GenerateTemplateRequest', function() {
      // uncomment below and update the code to test GenerateTemplateRequest
      //var instance = new AwsServerMigrationService.GenerateTemplateRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GenerateTemplateRequest);
    });
    ...
    it('should have the property templateFormat (base name: "templateFormat")', function() {
      // uncomment below and update the code to test the property templateFormat
      //var instance = new AwsServerMigrationService.GenerateTemplateRequest();
      //expect(instance).to.be();
    });
