...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerGroupValidationConfiguration();
  });
  ...
  describe('ServerGroupValidationConfiguration', function() {
    it('should create an instance of ServerGroupValidationConfiguration', function() {
      // uncomment below and update the code to test ServerGroupValidationConfiguration
      //var instance = new AwsServerMigrationService.ServerGroupValidationConfiguration();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerGroupValidationConfiguration);
    });
    ...
    it('should have the property serverValidationConfigurations (base name: "serverValidationConfigurations")', function() {
      // uncomment below and update the code to test the property serverValidationConfigurations
      //var instance = new AwsServerMigrationService.ServerGroupValidationConfiguration();
      //expect(instance).to.be();
    });
