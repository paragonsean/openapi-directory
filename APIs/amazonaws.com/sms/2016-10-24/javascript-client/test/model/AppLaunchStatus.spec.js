...
(function(root, factory) {
  ...
  describe('AppLaunchStatus', function() {
    it('should create an instance of AppLaunchStatus', function() {
      // uncomment below and update the code to test AppLaunchStatus
      //var instance = new AwsServerMigrationService.AppLaunchStatus();
      //expect(instance).to.be.a(AwsServerMigrationService.AppLaunchStatus);
    });
