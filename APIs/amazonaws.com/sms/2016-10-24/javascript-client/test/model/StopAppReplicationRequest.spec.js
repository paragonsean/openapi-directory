...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.StopAppReplicationRequest();
  });
  ...
  describe('StopAppReplicationRequest', function() {
    it('should create an instance of StopAppReplicationRequest', function() {
      // uncomment below and update the code to test StopAppReplicationRequest
      //var instance = new AwsServerMigrationService.StopAppReplicationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.StopAppReplicationRequest);
    });
