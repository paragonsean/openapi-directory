...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.PutAppReplicationConfigurationRequest();
  });
  ...
  describe('PutAppReplicationConfigurationRequest', function() {
    it('should create an instance of PutAppReplicationConfigurationRequest', function() {
      // uncomment below and update the code to test PutAppReplicationConfigurationRequest
      //var instance = new AwsServerMigrationService.PutAppReplicationConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.PutAppReplicationConfigurationRequest);
    });
