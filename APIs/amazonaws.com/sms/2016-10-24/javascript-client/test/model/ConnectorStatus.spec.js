...
(function(root, factory) {
  ...
  describe('ConnectorStatus', function() {
    it('should create an instance of ConnectorStatus', function() {
      // uncomment below and update the code to test ConnectorStatus
      //var instance = new AwsServerMigrationService.ConnectorStatus();
      //expect(instance).to.be.a(AwsServerMigrationService.ConnectorStatus);
    });
