...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.PutAppLaunchConfigurationRequest();
  });
  ...
  describe('PutAppLaunchConfigurationRequest', function() {
    it('should create an instance of PutAppLaunchConfigurationRequest', function() {
      // uncomment below and update the code to test PutAppLaunchConfigurationRequest
      //var instance = new AwsServerMigrationService.PutAppLaunchConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.PutAppLaunchConfigurationRequest);
    });
    ...
    it('should have the property autoLaunch (base name: "autoLaunch")', function() {
      // uncomment below and update the code to test the property autoLaunch
      //var instance = new AwsServerMigrationService.PutAppLaunchConfigurationRequest();
      //expect(instance).to.be();
    });

    it('should have the property serverGroupLaunchConfigurations (base name: "serverGroupLaunchConfigurations")', function() {
      // uncomment below and update the code to test the property serverGroupLaunchConfigurations
      //var instance = new AwsServerMigrationService.PutAppLaunchConfigurationRequest();
      //expect(instance).to.be();
    });
