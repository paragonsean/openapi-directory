...
(function(root, factory) {
  ...
  describe('ServerCatalogStatus', function() {
    it('should create an instance of ServerCatalogStatus', function() {
      // uncomment below and update the code to test ServerCatalogStatus
      //var instance = new AwsServerMigrationService.ServerCatalogStatus();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerCatalogStatus);
    });
