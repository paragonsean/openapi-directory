...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetReplicationJobsResponse();
  });
  ...
  describe('GetReplicationJobsResponse', function() {
    it('should create an instance of GetReplicationJobsResponse', function() {
      // uncomment below and update the code to test GetReplicationJobsResponse
      //var instance = new AwsServerMigrationService.GetReplicationJobsResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetReplicationJobsResponse);
    });

    it('should have the property replicationJobList (base name: "replicationJobList")', function() {
      // uncomment below and update the code to test the property replicationJobList
      //var instance = new AwsServerMigrationService.GetReplicationJobsResponse();
