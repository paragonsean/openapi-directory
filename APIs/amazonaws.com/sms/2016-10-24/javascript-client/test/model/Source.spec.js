...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.Source();
  });
  ...
  describe('Source', function() {
    it('should create an instance of Source', function() {
      ...
      //var instance = new AwsServerMigrationService.Source();
      //expect(instance).to.be.a(AwsServerMigrationService.Source);
    });
