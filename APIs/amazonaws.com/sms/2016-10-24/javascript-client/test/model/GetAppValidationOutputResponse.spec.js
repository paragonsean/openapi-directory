...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppValidationOutputResponse();
  });
  ...
  describe('GetAppValidationOutputResponse', function() {
    it('should create an instance of GetAppValidationOutputResponse', function() {
      // uncomment below and update the code to test GetAppValidationOutputResponse
      //var instance = new AwsServerMigrationService.GetAppValidationOutputResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppValidationOutputResponse);
    });

    it('should have the property validationOutputList (base name: "validationOutputList")', function() {
      // uncomment below and update the code to test the property validationOutputList
      //var instance = new AwsServerMigrationService.GetAppValidationOutputResponse();
