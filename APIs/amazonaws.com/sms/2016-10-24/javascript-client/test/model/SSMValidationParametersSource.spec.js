...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.SSMValidationParametersSource();
  });
  ...
  describe('SSMValidationParametersSource', function() {
    it('should create an instance of SSMValidationParametersSource', function() {
      // uncomment below and update the code to test SSMValidationParametersSource
      //var instance = new AwsServerMigrationService.SSMValidationParametersSource();
      //expect(instance).to.be.a(AwsServerMigrationService.SSMValidationParametersSource);
    });
