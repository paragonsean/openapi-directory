...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.UpdateReplicationJobRequest();
  });
  ...
  describe('UpdateReplicationJobRequest', function() {
    it('should create an instance of UpdateReplicationJobRequest', function() {
      // uncomment below and update the code to test UpdateReplicationJobRequest
      //var instance = new AwsServerMigrationService.UpdateReplicationJobRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.UpdateReplicationJobRequest);
    });
