...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppResponse();
  });
  ...
  describe('GetAppResponse', function() {
    it('should create an instance of GetAppResponse', function() {
      ...
      //var instance = new AwsServerMigrationService.GetAppResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppResponse);
    });
