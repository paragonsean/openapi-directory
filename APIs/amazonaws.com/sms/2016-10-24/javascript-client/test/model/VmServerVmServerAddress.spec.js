...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.VmServerVmServerAddress();
  });
  ...
  describe('VmServerVmServerAddress', function() {
    it('should create an instance of VmServerVmServerAddress', function() {
      // uncomment below and update the code to test VmServerVmServerAddress
      //var instance = new AwsServerMigrationService.VmServerVmServerAddress();
      //expect(instance).to.be.a(AwsServerMigrationService.VmServerVmServerAddress);
    });

    it('should have the property vmManagerId (base name: "vmManagerId")', function() {
      // uncomment below and update the code to test the property vmManagerId
      //var instance = new AwsServerMigrationService.VmServerVmServerAddress();
