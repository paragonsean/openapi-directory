...
(function(root, factory) {
  ...
  describe('ServerValidationStrategy', function() {
    it('should create an instance of ServerValidationStrategy', function() {
      // uncomment below and update the code to test ServerValidationStrategy
      //var instance = new AwsServerMigrationService.ServerValidationStrategy();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerValidationStrategy);
    });
