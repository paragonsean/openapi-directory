...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppLaunchConfigurationRequest();
  });
  ...
  describe('GetAppLaunchConfigurationRequest', function() {
    it('should create an instance of GetAppLaunchConfigurationRequest', function() {
      // uncomment below and update the code to test GetAppLaunchConfigurationRequest
      //var instance = new AwsServerMigrationService.GetAppLaunchConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppLaunchConfigurationRequest);
    });
