...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.UserDataValidationParameters();
  });
  ...
  describe('UserDataValidationParameters', function() {
    it('should create an instance of UserDataValidationParameters', function() {
      // uncomment below and update the code to test UserDataValidationParameters
      //var instance = new AwsServerMigrationService.UserDataValidationParameters();
      //expect(instance).to.be.a(AwsServerMigrationService.UserDataValidationParameters);
    });
