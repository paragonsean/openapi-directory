...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.DeleteReplicationJobRequest();
  });
  ...
  describe('DeleteReplicationJobRequest', function() {
    it('should create an instance of DeleteReplicationJobRequest', function() {
      // uncomment below and update the code to test DeleteReplicationJobRequest
      //var instance = new AwsServerMigrationService.DeleteReplicationJobRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.DeleteReplicationJobRequest);
    });
