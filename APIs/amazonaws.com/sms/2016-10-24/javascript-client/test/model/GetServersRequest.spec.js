...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetServersRequest();
  });
  ...
  describe('GetServersRequest', function() {
    it('should create an instance of GetServersRequest', function() {
      // uncomment below and update the code to test GetServersRequest
      //var instance = new AwsServerMigrationService.GetServersRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GetServersRequest);
    });
    ...
    it('should have the property vmServerAddressList (base name: "vmServerAddressList")', function() {
      // uncomment below and update the code to test the property vmServerAddressList
      //var instance = new AwsServerMigrationService.GetServersRequest();
      //expect(instance).to.be();
    });
