...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ReplicationJobVmServer();
  });
  ...
  describe('ReplicationJobVmServer', function() {
    it('should create an instance of ReplicationJobVmServer', function() {
      // uncomment below and update the code to test ReplicationJobVmServer
      //var instance = new AwsServerMigrationService.ReplicationJobVmServer();
      //expect(instance).to.be.a(AwsServerMigrationService.ReplicationJobVmServer);
    });
