...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetReplicationJobsRequest();
  });
  ...
  describe('GetReplicationJobsRequest', function() {
    it('should create an instance of GetReplicationJobsRequest', function() {
      // uncomment below and update the code to test GetReplicationJobsRequest
      //var instance = new AwsServerMigrationService.GetReplicationJobsRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GetReplicationJobsRequest);
    });
