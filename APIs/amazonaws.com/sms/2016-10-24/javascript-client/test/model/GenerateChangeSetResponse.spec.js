...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GenerateChangeSetResponse();
  });
  ...
  describe('GenerateChangeSetResponse', function() {
    it('should create an instance of GenerateChangeSetResponse', function() {
      // uncomment below and update the code to test GenerateChangeSetResponse
      //var instance = new AwsServerMigrationService.GenerateChangeSetResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GenerateChangeSetResponse);
    });
