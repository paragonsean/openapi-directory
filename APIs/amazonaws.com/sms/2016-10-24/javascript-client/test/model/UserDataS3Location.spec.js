...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.UserDataS3Location();
  });
  ...
  describe('UserDataS3Location', function() {
    it('should create an instance of UserDataS3Location', function() {
      // uncomment below and update the code to test UserDataS3Location
      //var instance = new AwsServerMigrationService.UserDataS3Location();
      //expect(instance).to.be.a(AwsServerMigrationService.UserDataS3Location);
    });
