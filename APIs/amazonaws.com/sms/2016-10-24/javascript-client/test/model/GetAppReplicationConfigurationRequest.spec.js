...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppReplicationConfigurationRequest();
  });
  ...
  describe('GetAppReplicationConfigurationRequest', function() {
    it('should create an instance of GetAppReplicationConfigurationRequest', function() {
      // uncomment below and update the code to test GetAppReplicationConfigurationRequest
      //var instance = new AwsServerMigrationService.GetAppReplicationConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppReplicationConfigurationRequest);
    });
