...
(function(root, factory) {
  ...
  describe('AppStatus', function() {
    it('should create an instance of AppStatus', function() {
      // uncomment below and update the code to test AppStatus
      //var instance = new AwsServerMigrationService.AppStatus();
      //expect(instance).to.be.a(AwsServerMigrationService.AppStatus);
    });
