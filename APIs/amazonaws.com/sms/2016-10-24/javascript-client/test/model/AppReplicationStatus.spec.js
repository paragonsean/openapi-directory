...
(function(root, factory) {
  ...
  describe('AppReplicationStatus', function() {
    it('should create an instance of AppReplicationStatus', function() {
      // uncomment below and update the code to test AppReplicationStatus
      //var instance = new AwsServerMigrationService.AppReplicationStatus();
      //expect(instance).to.be.a(AwsServerMigrationService.AppReplicationStatus);
    });
