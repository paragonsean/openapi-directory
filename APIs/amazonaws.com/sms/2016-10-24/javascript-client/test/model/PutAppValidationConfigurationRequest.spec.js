...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.PutAppValidationConfigurationRequest();
  });
  ...
  describe('PutAppValidationConfigurationRequest', function() {
    it('should create an instance of PutAppValidationConfigurationRequest', function() {
      // uncomment below and update the code to test PutAppValidationConfigurationRequest
      //var instance = new AwsServerMigrationService.PutAppValidationConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.PutAppValidationConfigurationRequest);
    });
    ...
    it('should have the property appValidationConfigurations (base name: "appValidationConfigurations")', function() {
      // uncomment below and update the code to test the property appValidationConfigurations
      //var instance = new AwsServerMigrationService.PutAppValidationConfigurationRequest();
      //expect(instance).to.be();
    });

    it('should have the property serverGroupValidationConfigurations (base name: "serverGroupValidationConfigurations")', function() {
      // uncomment below and update the code to test the property serverGroupValidationConfigurations
      //var instance = new AwsServerMigrationService.PutAppValidationConfigurationRequest();
      //expect(instance).to.be();
    });
