...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.StartOnDemandAppReplicationRequest();
  });
  ...
  describe('StartOnDemandAppReplicationRequest', function() {
    it('should create an instance of StartOnDemandAppReplicationRequest', function() {
      // uncomment below and update the code to test StartOnDemandAppReplicationRequest
      //var instance = new AwsServerMigrationService.StartOnDemandAppReplicationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.StartOnDemandAppReplicationRequest);
    });
