...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.CreateAppRequest();
  });
  ...
  describe('CreateAppRequest', function() {
    it('should create an instance of CreateAppRequest', function() {
      ...
      //var instance = new AwsServerMigrationService.CreateAppRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.CreateAppRequest);
    });
