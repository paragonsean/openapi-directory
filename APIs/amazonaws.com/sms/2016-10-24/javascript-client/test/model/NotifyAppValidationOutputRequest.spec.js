...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.NotifyAppValidationOutputRequest();
  });
  ...
  describe('NotifyAppValidationOutputRequest', function() {
    it('should create an instance of NotifyAppValidationOutputRequest', function() {
      // uncomment below and update the code to test NotifyAppValidationOutputRequest
      //var instance = new AwsServerMigrationService.NotifyAppValidationOutputRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.NotifyAppValidationOutputRequest);
    });
    ...
    it('should have the property notificationContext (base name: "notificationContext")', function() {
      // uncomment below and update the code to test the property notificationContext
      //var instance = new AwsServerMigrationService.NotifyAppValidationOutputRequest();
      //expect(instance).to.be();
    });
