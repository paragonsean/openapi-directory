...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.VmServerAddress();
  });
  ...
  describe('VmServerAddress', function() {
    it('should create an instance of VmServerAddress', function() {
      // uncomment below and update the code to test VmServerAddress
      //var instance = new AwsServerMigrationService.VmServerAddress();
      //expect(instance).to.be.a(AwsServerMigrationService.VmServerAddress);
    });
