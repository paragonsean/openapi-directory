...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.NotificationContext();
  });
  ...
  describe('NotificationContext', function() {
    it('should create an instance of NotificationContext', function() {
      // uncomment below and update the code to test NotificationContext
      //var instance = new AwsServerMigrationService.NotificationContext();
      //expect(instance).to.be.a(AwsServerMigrationService.NotificationContext);
    });
