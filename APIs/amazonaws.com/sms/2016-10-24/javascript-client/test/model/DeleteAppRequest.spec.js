...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.DeleteAppRequest();
  });
  ...
  describe('DeleteAppRequest', function() {
    it('should create an instance of DeleteAppRequest', function() {
      // uncomment below and update the code to test DeleteAppRequest
      //var instance = new AwsServerMigrationService.DeleteAppRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.DeleteAppRequest);
    });
    ...
    it('should have the property forceStopAppReplication (base name: "forceStopAppReplication")', function() {
      // uncomment below and update the code to test the property forceStopAppReplication
      //var instance = new AwsServerMigrationService.DeleteAppRequest();
      //expect(instance).to.be();
    });

    it('should have the property forceTerminateApp (base name: "forceTerminateApp")', function() {
      // uncomment below and update the code to test the property forceTerminateApp
      //var instance = new AwsServerMigrationService.DeleteAppRequest();
      //expect(instance).to.be();
    });
