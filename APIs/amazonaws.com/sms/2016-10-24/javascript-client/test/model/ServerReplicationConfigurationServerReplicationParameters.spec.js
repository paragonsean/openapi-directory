...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerReplicationConfigurationServerReplicationParameters();
  });
  ...
  describe('ServerReplicationConfigurationServerReplicationParameters', function() {
    it('should create an instance of ServerReplicationConfigurationServerReplicationParameters', function() {
      // uncomment below and update the code to test ServerReplicationConfigurationServerReplicationParameters
      //var instance = new AwsServerMigrationService.ServerReplicationConfigurationServerReplicationParameters();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerReplicationConfigurationServerReplicationParameters);
    });

    it('should have the property seedTime (base name: "seedTime")', function() {
      // uncomment below and update the code to test the property seedTime
      //var instance = new AwsServerMigrationService.ServerReplicationConfigurationServerReplicationParameters();
