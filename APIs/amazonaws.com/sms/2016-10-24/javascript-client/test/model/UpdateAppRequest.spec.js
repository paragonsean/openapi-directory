...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.UpdateAppRequest();
  });
  ...
  describe('UpdateAppRequest', function() {
    it('should create an instance of UpdateAppRequest', function() {
      ...
      //var instance = new AwsServerMigrationService.UpdateAppRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.UpdateAppRequest);
    });
