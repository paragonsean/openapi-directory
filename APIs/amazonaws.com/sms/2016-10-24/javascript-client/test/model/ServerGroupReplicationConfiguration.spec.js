...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerGroupReplicationConfiguration();
  });
  ...
  describe('ServerGroupReplicationConfiguration', function() {
    it('should create an instance of ServerGroupReplicationConfiguration', function() {
      // uncomment below and update the code to test ServerGroupReplicationConfiguration
      //var instance = new AwsServerMigrationService.ServerGroupReplicationConfiguration();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerGroupReplicationConfiguration);
    });
    ...
    it('should have the property serverReplicationConfigurations (base name: "serverReplicationConfigurations")', function() {
      // uncomment below and update the code to test the property serverReplicationConfigurations
      //var instance = new AwsServerMigrationService.ServerGroupReplicationConfiguration();
      //expect(instance).to.be();
    });
