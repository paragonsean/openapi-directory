...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerValidationOutput();
  });
  ...
  describe('ServerValidationOutput', function() {
    it('should create an instance of ServerValidationOutput', function() {
      // uncomment below and update the code to test ServerValidationOutput
      //var instance = new AwsServerMigrationService.ServerValidationOutput();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerValidationOutput);
    });
