...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.DisassociateConnectorRequest();
  });
  ...
  describe('DisassociateConnectorRequest', function() {
    it('should create an instance of DisassociateConnectorRequest', function() {
      // uncomment below and update the code to test DisassociateConnectorRequest
      //var instance = new AwsServerMigrationService.DisassociateConnectorRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.DisassociateConnectorRequest);
    });
