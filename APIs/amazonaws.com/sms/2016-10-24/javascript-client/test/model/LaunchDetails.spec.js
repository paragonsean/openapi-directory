...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.LaunchDetails();
  });
  ...
  describe('LaunchDetails', function() {
    it('should create an instance of LaunchDetails', function() {
      // uncomment below and update the code to test LaunchDetails
      //var instance = new AwsServerMigrationService.LaunchDetails();
      //expect(instance).to.be.a(AwsServerMigrationService.LaunchDetails);
    });
