...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.LaunchAppRequest();
  });
  ...
  describe('LaunchAppRequest', function() {
    it('should create an instance of LaunchAppRequest', function() {
      // uncomment below and update the code to test LaunchAppRequest
      //var instance = new AwsServerMigrationService.LaunchAppRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.LaunchAppRequest);
    });
