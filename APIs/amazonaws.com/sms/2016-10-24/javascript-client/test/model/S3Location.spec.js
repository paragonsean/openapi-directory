...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.S3Location();
  });
  ...
  describe('S3Location', function() {
    it('should create an instance of S3Location', function() {
      ...
      //var instance = new AwsServerMigrationService.S3Location();
      //expect(instance).to.be.a(AwsServerMigrationService.S3Location);
    });
