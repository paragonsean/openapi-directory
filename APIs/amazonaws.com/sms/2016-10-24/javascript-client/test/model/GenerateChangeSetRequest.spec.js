...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GenerateChangeSetRequest();
  });
  ...
  describe('GenerateChangeSetRequest', function() {
    it('should create an instance of GenerateChangeSetRequest', function() {
      // uncomment below and update the code to test GenerateChangeSetRequest
      //var instance = new AwsServerMigrationService.GenerateChangeSetRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GenerateChangeSetRequest);
    });
    ...
    it('should have the property changesetFormat (base name: "changesetFormat")', function() {
      // uncomment below and update the code to test the property changesetFormat
      //var instance = new AwsServerMigrationService.GenerateChangeSetRequest();
      //expect(instance).to.be();
    });
