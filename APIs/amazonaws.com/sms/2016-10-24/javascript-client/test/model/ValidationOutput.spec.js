...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ValidationOutput();
  });
  ...
  describe('ValidationOutput', function() {
    it('should create an instance of ValidationOutput', function() {
      // uncomment below and update the code to test ValidationOutput
      //var instance = new AwsServerMigrationService.ValidationOutput();
      //expect(instance).to.be.a(AwsServerMigrationService.ValidationOutput);
    });

    it('should have the property validationId (base name: "validationId")', function() {
    ...
    it('should have the property latestValidationTime (base name: "latestValidationTime")', function() {
      // uncomment below and update the code to test the property latestValidationTime
      //var instance = new AwsServerMigrationService.ValidationOutput();
      //expect(instance).to.be();
    });

    it('should have the property appValidationOutput (base name: "appValidationOutput")', function() {
      // uncomment below and update the code to test the property appValidationOutput
      //var instance = new AwsServerMigrationService.ValidationOutput();
      //expect(instance).to.be();
    });

    it('should have the property serverValidationOutput (base name: "serverValidationOutput")', function() {
      // uncomment below and update the code to test the property serverValidationOutput
      //var instance = new AwsServerMigrationService.ValidationOutput();
      //expect(instance).to.be();
    });
