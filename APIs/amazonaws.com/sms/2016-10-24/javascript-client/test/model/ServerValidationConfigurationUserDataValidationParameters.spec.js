...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerValidationConfigurationUserDataValidationParameters();
  });
  ...
  describe('ServerValidationConfigurationUserDataValidationParameters', function() {
    it('should create an instance of ServerValidationConfigurationUserDataValidationParameters', function() {
      // uncomment below and update the code to test ServerValidationConfigurationUserDataValidationParameters
      //var instance = new AwsServerMigrationService.ServerValidationConfigurationUserDataValidationParameters();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerValidationConfigurationUserDataValidationParameters);
    });
