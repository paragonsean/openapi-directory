...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.VmServer();
  });
  ...
  describe('VmServer', function() {
    it('should create an instance of VmServer', function() {
      // uncomment below and update the code to test VmServer
      //var instance = new AwsServerMigrationService.VmServer();
      //expect(instance).to.be.a(AwsServerMigrationService.VmServer);
    });

    it('should have the property vmServerAddress (base name: "vmServerAddress")', function() {
      // uncomment below and update the code to test the property vmServerAddress
      //var instance = new AwsServerMigrationService.VmServer();
    ...
    it('should have the property vmManagerName (base name: "vmManagerName")', function() {
      // uncomment below and update the code to test the property vmManagerName
      //var instance = new AwsServerMigrationService.VmServer();
      //expect(instance).to.be();
    });

    it('should have the property vmManagerType (base name: "vmManagerType")', function() {
      // uncomment below and update the code to test the property vmManagerType
      //var instance = new AwsServerMigrationService.VmServer();
      //expect(instance).to.be();
    });
