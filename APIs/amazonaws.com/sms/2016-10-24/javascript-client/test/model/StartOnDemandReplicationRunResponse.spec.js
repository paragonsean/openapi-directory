...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.StartOnDemandReplicationRunResponse();
  });
  ...
  describe('StartOnDemandReplicationRunResponse', function() {
    it('should create an instance of StartOnDemandReplicationRunResponse', function() {
      // uncomment below and update the code to test StartOnDemandReplicationRunResponse
      //var instance = new AwsServerMigrationService.StartOnDemandReplicationRunResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.StartOnDemandReplicationRunResponse);
    });
