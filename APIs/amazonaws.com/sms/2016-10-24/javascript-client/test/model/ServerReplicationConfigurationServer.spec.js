...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerReplicationConfigurationServer();
  });
  ...
  describe('ServerReplicationConfigurationServer', function() {
    it('should create an instance of ServerReplicationConfigurationServer', function() {
      // uncomment below and update the code to test ServerReplicationConfigurationServer
      //var instance = new AwsServerMigrationService.ServerReplicationConfigurationServer();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerReplicationConfigurationServer);
    });
