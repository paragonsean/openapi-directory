...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.CreateReplicationJobResponse();
  });
  ...
  describe('CreateReplicationJobResponse', function() {
    it('should create an instance of CreateReplicationJobResponse', function() {
      // uncomment below and update the code to test CreateReplicationJobResponse
      //var instance = new AwsServerMigrationService.CreateReplicationJobResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.CreateReplicationJobResponse);
    });
