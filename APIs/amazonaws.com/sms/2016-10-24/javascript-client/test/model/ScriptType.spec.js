...
(function(root, factory) {
  ...
  describe('ScriptType', function() {
    it('should create an instance of ScriptType', function() {
      // uncomment below and update the code to test ScriptType
      //var instance = new AwsServerMigrationService.ScriptType();
      //expect(instance).to.be.a(AwsServerMigrationService.ScriptType);
    });
