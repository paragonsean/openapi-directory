...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.UserData();
  });
  ...
  describe('UserData', function() {
    it('should create an instance of UserData', function() {
      ...
      //var instance = new AwsServerMigrationService.UserData();
      //expect(instance).to.be.a(AwsServerMigrationService.UserData);
    });
