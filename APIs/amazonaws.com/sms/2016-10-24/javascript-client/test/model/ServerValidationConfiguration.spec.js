...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerValidationConfiguration();
  });
  ...
  describe('ServerValidationConfiguration', function() {
    it('should create an instance of ServerValidationConfiguration', function() {
      // uncomment below and update the code to test ServerValidationConfiguration
      //var instance = new AwsServerMigrationService.ServerValidationConfiguration();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerValidationConfiguration);
    });
    ...
    it('should have the property serverValidationStrategy (base name: "serverValidationStrategy")', function() {
      // uncomment below and update the code to test the property serverValidationStrategy
      //var instance = new AwsServerMigrationService.ServerValidationConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property userDataValidationParameters (base name: "userDataValidationParameters")', function() {
      // uncomment below and update the code to test the property userDataValidationParameters
      //var instance = new AwsServerMigrationService.ServerValidationConfiguration();
      //expect(instance).to.be();
    });
