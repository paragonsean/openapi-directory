...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerReplicationConfiguration();
  });
  ...
  describe('ServerReplicationConfiguration', function() {
    it('should create an instance of ServerReplicationConfiguration', function() {
      // uncomment below and update the code to test ServerReplicationConfiguration
      //var instance = new AwsServerMigrationService.ServerReplicationConfiguration();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerReplicationConfiguration);
    });
    ...
    it('should have the property serverReplicationParameters (base name: "serverReplicationParameters")', function() {
      // uncomment below and update the code to test the property serverReplicationParameters
      //var instance = new AwsServerMigrationService.ServerReplicationConfiguration();
      //expect(instance).to.be();
    });
