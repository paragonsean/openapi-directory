...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.TerminateAppRequest();
  });
  ...
  describe('TerminateAppRequest', function() {
    it('should create an instance of TerminateAppRequest', function() {
      // uncomment below and update the code to test TerminateAppRequest
      //var instance = new AwsServerMigrationService.TerminateAppRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.TerminateAppRequest);
    });
