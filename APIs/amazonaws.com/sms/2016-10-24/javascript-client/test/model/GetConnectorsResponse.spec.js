...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetConnectorsResponse();
  });
  ...
  describe('GetConnectorsResponse', function() {
    it('should create an instance of GetConnectorsResponse', function() {
      // uncomment below and update the code to test GetConnectorsResponse
      //var instance = new AwsServerMigrationService.GetConnectorsResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetConnectorsResponse);
    });

    it('should have the property connectorList (base name: "connectorList")', function() {
      // uncomment below and update the code to test the property connectorList
      //var instance = new AwsServerMigrationService.GetConnectorsResponse();
