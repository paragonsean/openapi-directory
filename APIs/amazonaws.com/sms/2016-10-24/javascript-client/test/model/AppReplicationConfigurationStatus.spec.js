...
(function(root, factory) {
  ...
  describe('AppReplicationConfigurationStatus', function() {
    it('should create an instance of AppReplicationConfigurationStatus', function() {
      // uncomment below and update the code to test AppReplicationConfigurationStatus
      //var instance = new AwsServerMigrationService.AppReplicationConfigurationStatus();
      //expect(instance).to.be.a(AwsServerMigrationService.AppReplicationConfigurationStatus);
    });
