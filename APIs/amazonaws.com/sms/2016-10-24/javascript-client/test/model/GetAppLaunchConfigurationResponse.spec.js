...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetAppLaunchConfigurationResponse();
  });
  ...
  describe('GetAppLaunchConfigurationResponse', function() {
    it('should create an instance of GetAppLaunchConfigurationResponse', function() {
      // uncomment below and update the code to test GetAppLaunchConfigurationResponse
      //var instance = new AwsServerMigrationService.GetAppLaunchConfigurationResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetAppLaunchConfigurationResponse);
    });
