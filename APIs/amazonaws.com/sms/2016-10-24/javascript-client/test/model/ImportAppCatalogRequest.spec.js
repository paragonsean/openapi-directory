...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ImportAppCatalogRequest();
  });
  ...
  describe('ImportAppCatalogRequest', function() {
    it('should create an instance of ImportAppCatalogRequest', function() {
      // uncomment below and update the code to test ImportAppCatalogRequest
      //var instance = new AwsServerMigrationService.ImportAppCatalogRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.ImportAppCatalogRequest);
    });
