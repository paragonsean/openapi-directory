...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ListAppsResponse();
  });
  ...
  describe('ListAppsResponse', function() {
    it('should create an instance of ListAppsResponse', function() {
      ...
      //var instance = new AwsServerMigrationService.ListAppsResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.ListAppsResponse);
    });
