...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerReplicationParameters();
  });
  ...
  describe('ServerReplicationParameters', function() {
    it('should create an instance of ServerReplicationParameters', function() {
      // uncomment below and update the code to test ServerReplicationParameters
      //var instance = new AwsServerMigrationService.ServerReplicationParameters();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerReplicationParameters);
    });
