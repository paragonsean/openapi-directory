...
(function(root, factory) {
  ...
  describe('AppLaunchConfigurationStatus', function() {
    it('should create an instance of AppLaunchConfigurationStatus', function() {
      // uncomment below and update the code to test AppLaunchConfigurationStatus
      //var instance = new AwsServerMigrationService.AppLaunchConfigurationStatus();
      //expect(instance).to.be.a(AwsServerMigrationService.AppLaunchConfigurationStatus);
    });
