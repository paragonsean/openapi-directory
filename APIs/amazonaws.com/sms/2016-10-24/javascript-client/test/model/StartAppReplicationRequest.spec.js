...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.StartAppReplicationRequest();
  });
  ...
  describe('StartAppReplicationRequest', function() {
    it('should create an instance of StartAppReplicationRequest', function() {
      // uncomment below and update the code to test StartAppReplicationRequest
      //var instance = new AwsServerMigrationService.StartAppReplicationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.StartAppReplicationRequest);
    });
