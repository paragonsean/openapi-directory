...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetReplicationRunsRequest();
  });
  ...
  describe('GetReplicationRunsRequest', function() {
    it('should create an instance of GetReplicationRunsRequest', function() {
      // uncomment below and update the code to test GetReplicationRunsRequest
      //var instance = new AwsServerMigrationService.GetReplicationRunsRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.GetReplicationRunsRequest);
    });
