...
(function(root, factory) {
  ...
  describe('VmManagerType', function() {
    it('should create an instance of VmManagerType', function() {
      // uncomment below and update the code to test VmManagerType
      //var instance = new AwsServerMigrationService.VmManagerType();
      //expect(instance).to.be.a(AwsServerMigrationService.VmManagerType);
    });
