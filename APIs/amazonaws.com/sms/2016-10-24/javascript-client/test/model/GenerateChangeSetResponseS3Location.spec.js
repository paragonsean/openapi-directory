...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GenerateChangeSetResponseS3Location();
  });
  ...
  describe('GenerateChangeSetResponseS3Location', function() {
    it('should create an instance of GenerateChangeSetResponseS3Location', function() {
      // uncomment below and update the code to test GenerateChangeSetResponseS3Location
      //var instance = new AwsServerMigrationService.GenerateChangeSetResponseS3Location();
      //expect(instance).to.be.a(AwsServerMigrationService.GenerateChangeSetResponseS3Location);
    });
