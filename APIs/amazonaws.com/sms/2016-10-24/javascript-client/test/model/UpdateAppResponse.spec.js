...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.UpdateAppResponse();
  });
  ...
  describe('UpdateAppResponse', function() {
    it('should create an instance of UpdateAppResponse', function() {
      ...
      //var instance = new AwsServerMigrationService.UpdateAppResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.UpdateAppResponse);
    });
    ...
    it('should have the property serverGroups (base name: "serverGroups")', function() {
      // uncomment below and update the code to test the property serverGroups
      //var instance = new AwsServerMigrationService.UpdateAppResponse();
      //expect(instance).to.be();
    });
