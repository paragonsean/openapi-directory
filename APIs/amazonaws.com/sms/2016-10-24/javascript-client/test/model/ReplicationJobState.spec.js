...
(function(root, factory) {
  ...
  describe('ReplicationJobState', function() {
    it('should create an instance of ReplicationJobState', function() {
      // uncomment below and update the code to test ReplicationJobState
      //var instance = new AwsServerMigrationService.ReplicationJobState();
      //expect(instance).to.be.a(AwsServerMigrationService.ReplicationJobState);
    });
