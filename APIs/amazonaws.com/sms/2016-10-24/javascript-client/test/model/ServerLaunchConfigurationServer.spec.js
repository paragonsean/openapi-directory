...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerLaunchConfigurationServer();
  });
  ...
  describe('ServerLaunchConfigurationServer', function() {
    it('should create an instance of ServerLaunchConfigurationServer', function() {
      // uncomment below and update the code to test ServerLaunchConfigurationServer
      //var instance = new AwsServerMigrationService.ServerLaunchConfigurationServer();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerLaunchConfigurationServer);
    });
    ...
    it('should have the property replicationJobTerminated (base name: "replicationJobTerminated")', function() {
      // uncomment below and update the code to test the property replicationJobTerminated
      //var instance = new AwsServerMigrationService.ServerLaunchConfigurationServer();
      //expect(instance).to.be();
    });
