...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ValidationOutputServerValidationOutput();
  });
  ...
  describe('ValidationOutputServerValidationOutput', function() {
    it('should create an instance of ValidationOutputServerValidationOutput', function() {
      // uncomment below and update the code to test ValidationOutputServerValidationOutput
      //var instance = new AwsServerMigrationService.ValidationOutputServerValidationOutput();
      //expect(instance).to.be.a(AwsServerMigrationService.ValidationOutputServerValidationOutput);
    });
