...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.DeleteAppReplicationConfigurationRequest();
  });
  ...
  describe('DeleteAppReplicationConfigurationRequest', function() {
    it('should create an instance of DeleteAppReplicationConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteAppReplicationConfigurationRequest
      //var instance = new AwsServerMigrationService.DeleteAppReplicationConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.DeleteAppReplicationConfigurationRequest);
    });
