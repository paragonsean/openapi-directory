...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerGroup();
  });
  ...
  describe('ServerGroup', function() {
    it('should create an instance of ServerGroup', function() {
      // uncomment below and update the code to test ServerGroup
      //var instance = new AwsServerMigrationService.ServerGroup();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerGroup);
    });
