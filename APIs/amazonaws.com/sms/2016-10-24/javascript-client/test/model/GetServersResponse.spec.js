...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetServersResponse();
  });
  ...
  describe('GetServersResponse', function() {
    it('should create an instance of GetServersResponse', function() {
      // uncomment below and update the code to test GetServersResponse
      //var instance = new AwsServerMigrationService.GetServersResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetServersResponse);
    });
    ...
    it('should have the property serverCatalogStatus (base name: "serverCatalogStatus")', function() {
      // uncomment below and update the code to test the property serverCatalogStatus
      //var instance = new AwsServerMigrationService.GetServersResponse();
      //expect(instance).to.be();
    });

    it('should have the property serverList (base name: "serverList")', function() {
      // uncomment below and update the code to test the property serverList
      //var instance = new AwsServerMigrationService.GetServersResponse();
      //expect(instance).to.be();
    });
