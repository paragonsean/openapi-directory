...
(function(root, factory) {
  ...
  describe('ConnectorCapability', function() {
    it('should create an instance of ConnectorCapability', function() {
      // uncomment below and update the code to test ConnectorCapability
      //var instance = new AwsServerMigrationService.ConnectorCapability();
      //expect(instance).to.be.a(AwsServerMigrationService.ConnectorCapability);
    });
