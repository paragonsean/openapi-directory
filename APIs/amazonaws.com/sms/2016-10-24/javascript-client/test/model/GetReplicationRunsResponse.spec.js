...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.GetReplicationRunsResponse();
  });
  ...
  describe('GetReplicationRunsResponse', function() {
    it('should create an instance of GetReplicationRunsResponse', function() {
      // uncomment below and update the code to test GetReplicationRunsResponse
      //var instance = new AwsServerMigrationService.GetReplicationRunsResponse();
      //expect(instance).to.be.a(AwsServerMigrationService.GetReplicationRunsResponse);
    });

    it('should have the property replicationJob (base name: "replicationJob")', function() {
      // uncomment below and update the code to test the property replicationJob
      //var instance = new AwsServerMigrationService.GetReplicationRunsResponse();
