...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ReplicationRunStageDetails();
  });
  ...
  describe('ReplicationRunStageDetails', function() {
    it('should create an instance of ReplicationRunStageDetails', function() {
      // uncomment below and update the code to test ReplicationRunStageDetails
      //var instance = new AwsServerMigrationService.ReplicationRunStageDetails();
      //expect(instance).to.be.a(AwsServerMigrationService.ReplicationRunStageDetails);
    });
    ...
    it('should have the property stageProgress (base name: "stageProgress")', function() {
      // uncomment below and update the code to test the property stageProgress
      //var instance = new AwsServerMigrationService.ReplicationRunStageDetails();
      //expect(instance).to.be();
    });
