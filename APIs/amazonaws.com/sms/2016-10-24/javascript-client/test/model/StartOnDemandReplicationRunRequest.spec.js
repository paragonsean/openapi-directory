...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.StartOnDemandReplicationRunRequest();
  });
  ...
  describe('StartOnDemandReplicationRunRequest', function() {
    it('should create an instance of StartOnDemandReplicationRunRequest', function() {
      // uncomment below and update the code to test StartOnDemandReplicationRunRequest
      //var instance = new AwsServerMigrationService.StartOnDemandReplicationRunRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.StartOnDemandReplicationRunRequest);
    });
