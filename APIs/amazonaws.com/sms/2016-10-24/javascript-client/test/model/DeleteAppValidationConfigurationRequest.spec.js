...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.DeleteAppValidationConfigurationRequest();
  });
  ...
  describe('DeleteAppValidationConfigurationRequest', function() {
    it('should create an instance of DeleteAppValidationConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteAppValidationConfigurationRequest
      //var instance = new AwsServerMigrationService.DeleteAppValidationConfigurationRequest();
      //expect(instance).to.be.a(AwsServerMigrationService.DeleteAppValidationConfigurationRequest);
    });
