...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.ServerLaunchConfigurationUserData();
  });
  ...
  describe('ServerLaunchConfigurationUserData', function() {
    it('should create an instance of ServerLaunchConfigurationUserData', function() {
      // uncomment below and update the code to test ServerLaunchConfigurationUserData
      //var instance = new AwsServerMigrationService.ServerLaunchConfigurationUserData();
      //expect(instance).to.be.a(AwsServerMigrationService.ServerLaunchConfigurationUserData);
    });
