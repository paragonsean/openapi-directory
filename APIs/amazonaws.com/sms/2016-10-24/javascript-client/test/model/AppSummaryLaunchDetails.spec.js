...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerMigrationService.AppSummaryLaunchDetails();
  });
  ...
  describe('AppSummaryLaunchDetails', function() {
    it('should create an instance of AppSummaryLaunchDetails', function() {
      // uncomment below and update the code to test AppSummaryLaunchDetails
      //var instance = new AwsServerMigrationService.AppSummaryLaunchDetails();
      //expect(instance).to.be.a(AwsServerMigrationService.AppSummaryLaunchDetails);
    });

    it('should have the property latestLaunchTime (base name: "latestLaunchTime")', function() {
      // uncomment below and update the code to test the property latestLaunchTime
      //var instance = new AwsServerMigrationService.AppSummaryLaunchDetails();
