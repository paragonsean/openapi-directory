...
* @readonly
*/
export default class AppReplicationConfigurationStatus {
    ...
    /**
    * Returns a <code>AppReplicationConfigurationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AppReplicationConfigurationStatus} The enum <code>AppReplicationConfigurationStatus</code> value.
    */
