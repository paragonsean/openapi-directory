...
class ListAppsRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('appIds')) {
                obj['appIds'] = ApiClient.convertToType(data['appIds'], Array);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['appIds']) { // data not null
          Array.validateJSON(data['appIds']);
        }
 ...
 * @member {Array} appIds
 */
ListAppsRequest.prototype['appIds'] = undefined;
