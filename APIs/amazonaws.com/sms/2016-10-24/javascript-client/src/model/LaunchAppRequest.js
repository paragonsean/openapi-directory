...
/**
 * The LaunchAppRequest model module.
 * @module model/LaunchAppRequest
 * @version 2016-10-24
 */
class LaunchAppRequest {
    /**
     * Constructs a new <code>LaunchAppRequest</code>.
     * @alias module:model/LaunchAppRequest
     */
    constructor() { 
        
        LaunchAppRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LaunchAppRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LaunchAppRequest} obj Optional instance to populate.
     * @return {module:model/LaunchAppRequest} The populated <code>LaunchAppRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LaunchAppRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>LaunchAppRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LaunchAppRequest</code>.
     */
 ...
 * @member {String} appId
 */
LaunchAppRequest.prototype['appId'] = undefined;
...
export default LaunchAppRequest;
