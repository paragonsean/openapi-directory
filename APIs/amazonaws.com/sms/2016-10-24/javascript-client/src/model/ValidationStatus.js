...
export default class ValidationStatus {
    ...
    /**
    * Returns a <code>ValidationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ValidationStatus} The enum <code>ValidationStatus</code> value.
    */
