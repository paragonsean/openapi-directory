...
/**
 * The SSMOutput model module.
 * @module model/SSMOutput
 * @version 2016-10-24
 */
class SSMOutput {
    /**
     * Constructs a new <code>SSMOutput</code>.
     * Contains the location of validation output.
     * @alias module:model/SSMOutput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SSMOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SSMOutput} obj Optional instance to populate.
     * @return {module:model/SSMOutput} The populated <code>SSMOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SSMOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>SSMOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SSMOutput</code>.
     */
