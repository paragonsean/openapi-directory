...
* @readonly
*/
export default class ReplicationRunState {
    ...
    /**
    * Returns a <code>ReplicationRunState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReplicationRunState} The enum <code>ReplicationRunState</code> value.
    */
