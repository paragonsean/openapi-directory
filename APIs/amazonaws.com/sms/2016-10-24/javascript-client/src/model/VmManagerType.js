...
* @readonly
*/
export default class VmManagerType {
    ...
    /**
    * Returns a <code>VmManagerType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VmManagerType} The enum <code>VmManagerType</code> value.
    */
