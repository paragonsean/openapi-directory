...
* @readonly
*/
export default class ReplicationRunType {
    ...
    /**
    * Returns a <code>ReplicationRunType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReplicationRunType} The enum <code>ReplicationRunType</code> value.
    */
