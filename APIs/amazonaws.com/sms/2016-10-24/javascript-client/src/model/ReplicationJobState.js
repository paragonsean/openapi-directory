...
* @readonly
*/
export default class ReplicationJobState {
    ...
    /**
    * Returns a <code>ReplicationJobState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReplicationJobState} The enum <code>ReplicationJobState</code> value.
    */
