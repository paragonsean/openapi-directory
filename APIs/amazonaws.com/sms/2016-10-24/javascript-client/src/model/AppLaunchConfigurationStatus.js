...
* @readonly
*/
export default class AppLaunchConfigurationStatus {
    ...
    /**
    * Returns a <code>AppLaunchConfigurationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AppLaunchConfigurationStatus} The enum <code>AppLaunchConfigurationStatus</code> value.
    */
