...
* @readonly
*/
export default class AppValidationStrategy {
    ...
    /**
    * Returns a <code>AppValidationStrategy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AppValidationStrategy} The enum <code>AppValidationStrategy</code> value.
    */
