...
/**
 * The TerminateAppRequest model module.
 * @module model/TerminateAppRequest
 * @version 2016-10-24
 */
class TerminateAppRequest {
    /**
     * Constructs a new <code>TerminateAppRequest</code>.
     * @alias module:model/TerminateAppRequest
     */
    constructor() { 
        
        TerminateAppRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TerminateAppRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TerminateAppRequest} obj Optional instance to populate.
     * @return {module:model/TerminateAppRequest} The populated <code>TerminateAppRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TerminateAppRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TerminateAppRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TerminateAppRequest</code>.
     */
 ...
 * @member {String} appId
 */
TerminateAppRequest.prototype['appId'] = undefined;
...
export default TerminateAppRequest;
