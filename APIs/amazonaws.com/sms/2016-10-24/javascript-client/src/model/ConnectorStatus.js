...
* @readonly
*/
export default class ConnectorStatus {
    ...
    /**
    * Returns a <code>ConnectorStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ConnectorStatus} The enum <code>ConnectorStatus</code> value.
    */
