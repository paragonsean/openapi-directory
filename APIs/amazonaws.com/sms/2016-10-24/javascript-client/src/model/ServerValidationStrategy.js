...
* @readonly
*/
export default class ServerValidationStrategy {
    ...
    /**
    * Returns a <code>ServerValidationStrategy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ServerValidationStrategy} The enum <code>ServerValidationStrategy</code> value.
    */
