...
* @readonly
*/
export default class ServerCatalogStatus {
    ...
    /**
    * Returns a <code>ServerCatalogStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ServerCatalogStatus} The enum <code>ServerCatalogStatus</code> value.
    */
