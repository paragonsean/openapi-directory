...
QString Example::create(){
    QString obj;
OAICreateAppRequest Example::create(){
    OAICreateAppRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      OAICreateAppRequest oai_create_app_request = create(); // OAICreateAppRequest | 
      ...
      apiInstance.createApp(x_amz_targetoai_create_app_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
