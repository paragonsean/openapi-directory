...
OAIGetAppValidationOutputRequest::OAIGetAppValidationOutputRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAppValidationOutputRequest::OAIGetAppValidationOutputRequest() {
    this->initializeModel();
}

OAIGetAppValidationOutputRequest::~OAIGetAppValidationOutputRequest() {}

void OAIGetAppValidationOutputRequest::initializeModel() {

    m_app_id_isSet = false;
    m_app_id_isValid = false;
}

void OAIGetAppValidationOutputRequest::fromJson(QString jsonString) {
...
void OAIGetAppValidationOutputRequest::fromJsonObject(QJsonObject json) {

    m_app_id_isValid = ::OpenAPI::fromJsonValue(m_app_id, json[QString("appId")]);
    m_app_id_isSet = !json[QString("appId")].isNull() && m_app_id_isValid;
}

QString OAIGetAppValidationOutputRequest::asJson() const {
...
QJsonObject OAIGetAppValidationOutputRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_app_id_isSet) {
...
QString OAIGetAppValidationOutputRequest::getAppId() const {
    return m_app_id;
}
void OAIGetAppValidationOutputRequest::setAppId(const QString &app_id) {
    m_app_id = app_id;
    m_app_id_isSet = true;
}

bool OAIGetAppValidationOutputRequest::is_app_id_Set() const{
    return m_app_id_isSet;
}

bool OAIGetAppValidationOutputRequest::is_app_id_Valid() const{
    return m_app_id_isValid;
}

bool OAIGetAppValidationOutputRequest::isSet() const {
...
bool OAIGetAppValidationOutputRequest::isValid() const {
