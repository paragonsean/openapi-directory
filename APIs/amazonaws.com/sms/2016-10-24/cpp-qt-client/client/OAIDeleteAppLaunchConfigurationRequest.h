...
/*
 * OAIDeleteAppLaunchConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteAppLaunchConfigurationRequest_H
#define OAIDeleteAppLaunchConfigurationRequest_H
...
class OAIDeleteAppLaunchConfigurationRequest : public OAIObject {
public:
    OAIDeleteAppLaunchConfigurationRequest();
    OAIDeleteAppLaunchConfigurationRequest(QString json);
    ~OAIDeleteAppLaunchConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAppLaunchConfigurationRequest)

#endif // OAIDeleteAppLaunchConfigurationRequest_H
