...
/*
 * OAIValidationOutput_serverValidationOutput.h
 *
 * 
 */

#ifndef OAIValidationOutput_serverValidationOutput_H
#define OAIValidationOutput_serverValidationOutput_H
...
class OAIValidationOutput_serverValidationOutput : public OAIObject {
public:
    OAIValidationOutput_serverValidationOutput();
    OAIValidationOutput_serverValidationOutput(QString json);
    ~OAIValidationOutput_serverValidationOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidationOutput_serverValidationOutput)

#endif // OAIValidationOutput_serverValidationOutput_H
