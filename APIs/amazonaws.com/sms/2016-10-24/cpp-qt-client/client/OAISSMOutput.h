...
#ifndef OAISSMOutput_H
#define OAISSMOutput_H
...
class OAISSMOutput : public OAIObject {
public:
    OAISSMOutput();
    OAISSMOutput(QString json);
    ~OAISSMOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSMOutput)

#endif // OAISSMOutput_H
