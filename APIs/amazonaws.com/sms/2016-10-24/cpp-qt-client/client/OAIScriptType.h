...
#ifndef OAIScriptType_H
#define OAIScriptType_H
...
class OAIScriptType : public OAIEnum {
public:
    OAIScriptType();
    OAIScriptType(QString json);
    ~OAIScriptType() override;
    ...
    enum class eOAIScriptType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SHELL_SCRIPT, 
        POWERSHELL_SCRIPT
    };
    OAIScriptType::eOAIScriptType getValue() const;
    void setValue(const OAIScriptType::eOAIScriptType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScriptType)

#endif // OAIScriptType_H
