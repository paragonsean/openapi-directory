...
/*
 * OAIStartAppReplicationRequest.h
 *
 * 
 */

#ifndef OAIStartAppReplicationRequest_H
#define OAIStartAppReplicationRequest_H
...
class OAIStartAppReplicationRequest : public OAIObject {
public:
    OAIStartAppReplicationRequest();
    OAIStartAppReplicationRequest(QString json);
    ~OAIStartAppReplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartAppReplicationRequest)

#endif // OAIStartAppReplicationRequest_H
