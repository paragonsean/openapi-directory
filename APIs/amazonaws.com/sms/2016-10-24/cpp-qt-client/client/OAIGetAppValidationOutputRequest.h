...
/*
 * OAIGetAppValidationOutputRequest.h
 *
 * 
 */

#ifndef OAIGetAppValidationOutputRequest_H
#define OAIGetAppValidationOutputRequest_H
...
class OAIGetAppValidationOutputRequest : public OAIObject {
public:
    OAIGetAppValidationOutputRequest();
    OAIGetAppValidationOutputRequest(QString json);
    ~OAIGetAppValidationOutputRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAppValidationOutputRequest)

#endif // OAIGetAppValidationOutputRequest_H
