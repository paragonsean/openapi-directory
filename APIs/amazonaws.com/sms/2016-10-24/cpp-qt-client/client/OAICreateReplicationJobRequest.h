...
/*
 * OAICreateReplicationJobRequest.h
 *
 * 
 */

#ifndef OAICreateReplicationJobRequest_H
#define OAICreateReplicationJobRequest_H
...
class OAICreateReplicationJobRequest : public OAIObject {
public:
    OAICreateReplicationJobRequest();
    OAICreateReplicationJobRequest(QString json);
    ~OAICreateReplicationJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateReplicationJobRequest)

#endif // OAICreateReplicationJobRequest_H
