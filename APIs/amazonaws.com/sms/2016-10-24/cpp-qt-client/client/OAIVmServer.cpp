...
OAIVmServer::OAIVmServer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVmServer::OAIVmServer() {
    this->initializeModel();
}

OAIVmServer::~OAIVmServer() {}

void OAIVmServer::initializeModel() {
...
void OAIVmServer::fromJson(QString jsonString) {
...
void OAIVmServer::fromJsonObject(QJsonObject json) {
...
QString OAIVmServer::asJson() const {
...
QJsonObject OAIVmServer::asJsonObject() const {
    QJsonObject obj;
...
OAIVmServer_vmServerAddress OAIVmServer::getVmServerAddress() const {
    return m_vm_server_address;
}
void OAIVmServer::setVmServerAddress(const OAIVmServer_vmServerAddress &vm_server_address) {
    m_vm_server_address = vm_server_address;
    m_vm_server_address_isSet = true;
}

bool OAIVmServer::is_vm_server_address_Set() const{
    return m_vm_server_address_isSet;
}

bool OAIVmServer::is_vm_server_address_Valid() const{
    return m_vm_server_address_isValid;
}

QString OAIVmServer::getVmName() const {
    return m_vm_name;
}
void OAIVmServer::setVmName(const QString &vm_name) {
    m_vm_name = vm_name;
    m_vm_name_isSet = true;
}

bool OAIVmServer::is_vm_name_Set() const{
    return m_vm_name_isSet;
}

bool OAIVmServer::is_vm_name_Valid() const{
    return m_vm_name_isValid;
}

QString OAIVmServer::getVmManagerName() const {
    return m_vm_manager_name;
}
void OAIVmServer::setVmManagerName(const QString &vm_manager_name) {
    m_vm_manager_name = vm_manager_name;
    m_vm_manager_name_isSet = true;
}

bool OAIVmServer::is_vm_manager_name_Set() const{
    return m_vm_manager_name_isSet;
}

bool OAIVmServer::is_vm_manager_name_Valid() const{
    return m_vm_manager_name_isValid;
}

OAIVmManagerType OAIVmServer::getVmManagerType() const {
    return m_vm_manager_type;
}
void OAIVmServer::setVmManagerType(const OAIVmManagerType &vm_manager_type) {
    m_vm_manager_type = vm_manager_type;
    m_vm_manager_type_isSet = true;
}

bool OAIVmServer::is_vm_manager_type_Set() const{
    return m_vm_manager_type_isSet;
}

bool OAIVmServer::is_vm_manager_type_Valid() const{
    return m_vm_manager_type_isValid;
}

QString OAIVmServer::getVmPath() const {
    return m_vm_path;
}
void OAIVmServer::setVmPath(const QString &vm_path) {
    m_vm_path = vm_path;
    m_vm_path_isSet = true;
}

bool OAIVmServer::is_vm_path_Set() const{
    return m_vm_path_isSet;
}

bool OAIVmServer::is_vm_path_Valid() const{
    return m_vm_path_isValid;
}

bool OAIVmServer::isSet() const {
...
bool OAIVmServer::isValid() const {
