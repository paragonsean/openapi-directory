...
/*
 * OAIServerReplicationConfiguration_server.h
 *
 * 
 */

#ifndef OAIServerReplicationConfiguration_server_H
#define OAIServerReplicationConfiguration_server_H
...
class OAIServerReplicationConfiguration_server : public OAIObject {
public:
    OAIServerReplicationConfiguration_server();
    OAIServerReplicationConfiguration_server(QString json);
    ~OAIServerReplicationConfiguration_server() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerReplicationConfiguration_server)

#endif // OAIServerReplicationConfiguration_server_H
