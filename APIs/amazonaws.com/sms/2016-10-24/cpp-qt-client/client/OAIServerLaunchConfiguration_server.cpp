...
OAIServerLaunchConfiguration_server::OAIServerLaunchConfiguration_server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerLaunchConfiguration_server::OAIServerLaunchConfiguration_server() {
    this->initializeModel();
}

OAIServerLaunchConfiguration_server::~OAIServerLaunchConfiguration_server() {}

void OAIServerLaunchConfiguration_server::initializeModel() {
...
void OAIServerLaunchConfiguration_server::fromJson(QString jsonString) {
...
void OAIServerLaunchConfiguration_server::fromJsonObject(QJsonObject json) {
...
QString OAIServerLaunchConfiguration_server::asJson() const {
...
QJsonObject OAIServerLaunchConfiguration_server::asJsonObject() const {
    QJsonObject obj;
...
QString OAIServerLaunchConfiguration_server::getServerId() const {
    return m_server_id;
}
void OAIServerLaunchConfiguration_server::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIServerLaunchConfiguration_server::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIServerLaunchConfiguration_server::is_server_id_Valid() const{
    return m_server_id_isValid;
}

OAIServerType OAIServerLaunchConfiguration_server::getServerType() const {
    return m_server_type;
}
void OAIServerLaunchConfiguration_server::setServerType(const OAIServerType &server_type) {
    m_server_type = server_type;
    m_server_type_isSet = true;
}

bool OAIServerLaunchConfiguration_server::is_server_type_Set() const{
    return m_server_type_isSet;
}

bool OAIServerLaunchConfiguration_server::is_server_type_Valid() const{
    return m_server_type_isValid;
}

OAIReplicationJob_vmServer OAIServerLaunchConfiguration_server::getVmServer() const {
    return m_vm_server;
}
void OAIServerLaunchConfiguration_server::setVmServer(const OAIReplicationJob_vmServer &vm_server) {
    m_vm_server = vm_server;
    m_vm_server_isSet = true;
}

bool OAIServerLaunchConfiguration_server::is_vm_server_Set() const{
    return m_vm_server_isSet;
}

bool OAIServerLaunchConfiguration_server::is_vm_server_Valid() const{
    return m_vm_server_isValid;
}

QString OAIServerLaunchConfiguration_server::getReplicationJobId() const {
    return m_replication_job_id;
}
void OAIServerLaunchConfiguration_server::setReplicationJobId(const QString &replication_job_id) {
    m_replication_job_id = replication_job_id;
    m_replication_job_id_isSet = true;
}

bool OAIServerLaunchConfiguration_server::is_replication_job_id_Set() const{
    return m_replication_job_id_isSet;
}

bool OAIServerLaunchConfiguration_server::is_replication_job_id_Valid() const{
    return m_replication_job_id_isValid;
}

bool OAIServerLaunchConfiguration_server::getReplicationJobTerminated() const {
    return m_replication_job_terminated;
}
void OAIServerLaunchConfiguration_server::setReplicationJobTerminated(const bool &replication_job_terminated) {
    m_replication_job_terminated = replication_job_terminated;
    m_replication_job_terminated_isSet = true;
}

bool OAIServerLaunchConfiguration_server::is_replication_job_terminated_Set() const{
    return m_replication_job_terminated_isSet;
}

bool OAIServerLaunchConfiguration_server::is_replication_job_terminated_Valid() const{
    return m_replication_job_terminated_isValid;
}

bool OAIServerLaunchConfiguration_server::isSet() const {
...
bool OAIServerLaunchConfiguration_server::isValid() const {
