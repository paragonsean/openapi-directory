...
/*
 * OAIGetAppReplicationConfigurationRequest.h
 *
 * 
 */

#ifndef OAIGetAppReplicationConfigurationRequest_H
#define OAIGetAppReplicationConfigurationRequest_H
...
class OAIGetAppReplicationConfigurationRequest : public OAIObject {
public:
    OAIGetAppReplicationConfigurationRequest();
    OAIGetAppReplicationConfigurationRequest(QString json);
    ~OAIGetAppReplicationConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAppReplicationConfigurationRequest)

#endif // OAIGetAppReplicationConfigurationRequest_H
