...
/*
 * OAIGenerateChangeSetRequest.h
 *
 * 
 */

#ifndef OAIGenerateChangeSetRequest_H
#define OAIGenerateChangeSetRequest_H
...
class OAIGenerateChangeSetRequest : public OAIObject {
public:
    OAIGenerateChangeSetRequest();
    OAIGenerateChangeSetRequest(QString json);
    ~OAIGenerateChangeSetRequest() override;
    ...
    OAIOutputFormat getChangesetFormat() const;
    void setChangesetFormat(const OAIOutputFormat &changeset_format);
    bool is_changeset_format_Set() const;
    bool is_changeset_format_Valid() const;
...
private:
    ...
    OAIOutputFormat m_changeset_format;
    bool m_changeset_format_isSet;
    bool m_changeset_format_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGenerateChangeSetRequest)

#endif // OAIGenerateChangeSetRequest_H
