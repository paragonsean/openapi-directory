...
/*
 * OAIUpdateReplicationJobRequest.h
 *
 * 
 */

#ifndef OAIUpdateReplicationJobRequest_H
#define OAIUpdateReplicationJobRequest_H
...
class OAIUpdateReplicationJobRequest : public OAIObject {
public:
    OAIUpdateReplicationJobRequest();
    OAIUpdateReplicationJobRequest(QString json);
    ~OAIUpdateReplicationJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateReplicationJobRequest)

#endif // OAIUpdateReplicationJobRequest_H
