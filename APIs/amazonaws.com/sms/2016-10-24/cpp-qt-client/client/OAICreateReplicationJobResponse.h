...
/*
 * OAICreateReplicationJobResponse.h
 *
 * 
 */

#ifndef OAICreateReplicationJobResponse_H
#define OAICreateReplicationJobResponse_H
...
class OAICreateReplicationJobResponse : public OAIObject {
public:
    OAICreateReplicationJobResponse();
    OAICreateReplicationJobResponse(QString json);
    ~OAICreateReplicationJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateReplicationJobResponse)

#endif // OAICreateReplicationJobResponse_H
