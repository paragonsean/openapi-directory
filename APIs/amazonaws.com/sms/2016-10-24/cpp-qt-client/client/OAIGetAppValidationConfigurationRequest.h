...
/*
 * OAIGetAppValidationConfigurationRequest.h
 *
 * 
 */

#ifndef OAIGetAppValidationConfigurationRequest_H
#define OAIGetAppValidationConfigurationRequest_H
...
class OAIGetAppValidationConfigurationRequest : public OAIObject {
public:
    OAIGetAppValidationConfigurationRequest();
    OAIGetAppValidationConfigurationRequest(QString json);
    ~OAIGetAppValidationConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAppValidationConfigurationRequest)

#endif // OAIGetAppValidationConfigurationRequest_H
