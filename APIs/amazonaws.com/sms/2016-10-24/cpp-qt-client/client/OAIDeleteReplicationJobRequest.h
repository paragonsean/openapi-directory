...
/*
 * OAIDeleteReplicationJobRequest.h
 *
 * 
 */

#ifndef OAIDeleteReplicationJobRequest_H
#define OAIDeleteReplicationJobRequest_H
...
class OAIDeleteReplicationJobRequest : public OAIObject {
public:
    OAIDeleteReplicationJobRequest();
    OAIDeleteReplicationJobRequest(QString json);
    ~OAIDeleteReplicationJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteReplicationJobRequest)

#endif // OAIDeleteReplicationJobRequest_H
