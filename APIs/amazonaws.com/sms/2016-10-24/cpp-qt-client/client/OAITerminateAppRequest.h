...
/*
 * OAITerminateAppRequest.h
 *
 * 
 */

#ifndef OAITerminateAppRequest_H
#define OAITerminateAppRequest_H
...
class OAITerminateAppRequest : public OAIObject {
public:
    OAITerminateAppRequest();
    OAITerminateAppRequest(QString json);
    ~OAITerminateAppRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITerminateAppRequest)

#endif // OAITerminateAppRequest_H
