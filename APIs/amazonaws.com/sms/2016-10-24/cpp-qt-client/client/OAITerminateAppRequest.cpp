...
OAITerminateAppRequest::OAITerminateAppRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITerminateAppRequest::OAITerminateAppRequest() {
    this->initializeModel();
}

OAITerminateAppRequest::~OAITerminateAppRequest() {}

void OAITerminateAppRequest::initializeModel() {

    m_app_id_isSet = false;
    m_app_id_isValid = false;
}

void OAITerminateAppRequest::fromJson(QString jsonString) {
...
void OAITerminateAppRequest::fromJsonObject(QJsonObject json) {

    m_app_id_isValid = ::OpenAPI::fromJsonValue(m_app_id, json[QString("appId")]);
    m_app_id_isSet = !json[QString("appId")].isNull() && m_app_id_isValid;
}

QString OAITerminateAppRequest::asJson() const {
...
QJsonObject OAITerminateAppRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_app_id_isSet) {
...
QString OAITerminateAppRequest::getAppId() const {
    return m_app_id;
}
void OAITerminateAppRequest::setAppId(const QString &app_id) {
    m_app_id = app_id;
    m_app_id_isSet = true;
}

bool OAITerminateAppRequest::is_app_id_Set() const{
    return m_app_id_isSet;
}

bool OAITerminateAppRequest::is_app_id_Valid() const{
    return m_app_id_isValid;
}

bool OAITerminateAppRequest::isSet() const {
...
bool OAITerminateAppRequest::isValid() const {
