...
/*
 * OAIDeleteAppReplicationConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteAppReplicationConfigurationRequest_H
#define OAIDeleteAppReplicationConfigurationRequest_H
...
class OAIDeleteAppReplicationConfigurationRequest : public OAIObject {
public:
    OAIDeleteAppReplicationConfigurationRequest();
    OAIDeleteAppReplicationConfigurationRequest(QString json);
    ~OAIDeleteAppReplicationConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAppReplicationConfigurationRequest)

#endif // OAIDeleteAppReplicationConfigurationRequest_H
