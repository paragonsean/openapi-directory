...
/*
 * OAIConnectorCapability.h
 *
 * 
 */

#ifndef OAIConnectorCapability_H
#define OAIConnectorCapability_H
...
class OAIConnectorCapability : public OAIEnum {
public:
    OAIConnectorCapability();
    OAIConnectorCapability(QString json);
    ~OAIConnectorCapability() override;
    ...
    enum class eOAIConnectorCapability {
    ...
    OAIConnectorCapability::eOAIConnectorCapability getValue() const;
    void setValue(const OAIConnectorCapability::eOAIConnectorCapability& value);
...
private:
    ...
    eOAIConnectorCapability m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectorCapability)

#endif // OAIConnectorCapability_H
