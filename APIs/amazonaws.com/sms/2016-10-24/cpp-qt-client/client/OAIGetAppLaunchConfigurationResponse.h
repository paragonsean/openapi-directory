...
/*
 * OAIGetAppLaunchConfigurationResponse.h
 *
 * 
 */

#ifndef OAIGetAppLaunchConfigurationResponse_H
#define OAIGetAppLaunchConfigurationResponse_H
...
class OAIGetAppLaunchConfigurationResponse : public OAIObject {
public:
    OAIGetAppLaunchConfigurationResponse();
    OAIGetAppLaunchConfigurationResponse(QString json);
    ~OAIGetAppLaunchConfigurationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAppLaunchConfigurationResponse)

#endif // OAIGetAppLaunchConfigurationResponse_H
