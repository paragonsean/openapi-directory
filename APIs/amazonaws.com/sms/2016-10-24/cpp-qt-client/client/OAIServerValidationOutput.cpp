...
#include "OAIServerValidationOutput.h"
...
OAIServerValidationOutput::OAIServerValidationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerValidationOutput::OAIServerValidationOutput() {
    this->initializeModel();
}

OAIServerValidationOutput::~OAIServerValidationOutput() {}

void OAIServerValidationOutput::initializeModel() {

    m_server_isSet = false;
    m_server_isValid = false;
}

void OAIServerValidationOutput::fromJson(QString jsonString) {
...
void OAIServerValidationOutput::fromJsonObject(QJsonObject json) {
...
QString OAIServerValidationOutput::asJson() const {
...
QJsonObject OAIServerValidationOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_server.isSet()) {
...
OAIServer OAIServerValidationOutput::getServer() const {
    return m_server;
}
void OAIServerValidationOutput::setServer(const OAIServer &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIServerValidationOutput::is_server_Set() const{
    return m_server_isSet;
}

bool OAIServerValidationOutput::is_server_Valid() const{
    return m_server_isValid;
}

bool OAIServerValidationOutput::isSet() const {
...
bool OAIServerValidationOutput::isValid() const {
