...
/*
 * OAIGetAppValidationOutputResponse.h
 *
 * 
 */

#ifndef OAIGetAppValidationOutputResponse_H
#define OAIGetAppValidationOutputResponse_H
...
class OAIGetAppValidationOutputResponse : public OAIObject {
public:
    OAIGetAppValidationOutputResponse();
    OAIGetAppValidationOutputResponse(QString json);
    ~OAIGetAppValidationOutputResponse() override;
    ...
    QList getValidationOutputList() const;
    void setValidationOutputList(const QList &validation_output_list);
    bool is_validation_output_list_Set() const;
    bool is_validation_output_list_Valid() const;
...
private:
    ...
    QList m_validation_output_list;
    bool m_validation_output_list_isSet;
    bool m_validation_output_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetAppValidationOutputResponse)

#endif // OAIGetAppValidationOutputResponse_H
