...
/*
 * OAIReplicationRunStageDetails.h
 *
 * Details of the current stage of a replication run.
 */

#ifndef OAIReplicationRunStageDetails_H
#define OAIReplicationRunStageDetails_H
...
class OAIReplicationRunStageDetails : public OAIObject {
public:
    OAIReplicationRunStageDetails();
    OAIReplicationRunStageDetails(QString json);
    ~OAIReplicationRunStageDetails() override;
    ...
    QString getStageProgress() const;
    void setStageProgress(const QString &stage_progress);
    bool is_stage_progress_Set() const;
    bool is_stage_progress_Valid() const;
...
private:
    ...
    QString m_stage_progress;
    bool m_stage_progress_isSet;
    bool m_stage_progress_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIReplicationRunStageDetails)

#endif // OAIReplicationRunStageDetails_H
