...
/*
 * OAIAppValidationStrategy.h
 *
 * 
 */

#ifndef OAIAppValidationStrategy_H
#define OAIAppValidationStrategy_H
...
class OAIAppValidationStrategy : public OAIEnum {
public:
    OAIAppValidationStrategy();
    OAIAppValidationStrategy(QString json);
    ~OAIAppValidationStrategy() override;
    ...
    enum class eOAIAppValidationStrategy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SSM
    };
    OAIAppValidationStrategy::eOAIAppValidationStrategy getValue() const;
    void setValue(const OAIAppValidationStrategy::eOAIAppValidationStrategy& value);
...
private:
    ...
    eOAIAppValidationStrategy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppValidationStrategy)

#endif // OAIAppValidationStrategy_H
