...
#ifndef OAIVmManagerType_H
#define OAIVmManagerType_H
...
class OAIVmManagerType : public OAIEnum {
public:
    OAIVmManagerType();
    OAIVmManagerType(QString json);
    ~OAIVmManagerType() override;
    ...
    enum class eOAIVmManagerType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        VSPHERE, 
        SCVMM, 
        HYPERV_MANAGER
    };
    OAIVmManagerType::eOAIVmManagerType getValue() const;
    void setValue(const OAIVmManagerType::eOAIVmManagerType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVmManagerType)

#endif // OAIVmManagerType_H
