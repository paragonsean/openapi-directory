...
/*
 * OAILaunchAppRequest.h
 *
 * 
 */

#ifndef OAILaunchAppRequest_H
#define OAILaunchAppRequest_H
...
class OAILaunchAppRequest : public OAIObject {
public:
    OAILaunchAppRequest();
    OAILaunchAppRequest(QString json);
    ~OAILaunchAppRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunchAppRequest)

#endif // OAILaunchAppRequest_H
