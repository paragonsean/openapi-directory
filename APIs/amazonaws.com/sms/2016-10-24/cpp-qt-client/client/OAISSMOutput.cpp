...
OAISSMOutput::OAISSMOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISSMOutput::OAISSMOutput() {
    this->initializeModel();
}

OAISSMOutput::~OAISSMOutput() {}

void OAISSMOutput::initializeModel() {

    m_s3_location_isSet = false;
    m_s3_location_isValid = false;
}

void OAISSMOutput::fromJson(QString jsonString) {
...
void OAISSMOutput::fromJsonObject(QJsonObject json) {
...
QString OAISSMOutput::asJson() const {
...
QJsonObject OAISSMOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIS3Location OAISSMOutput::getS3Location() const {
    return m_s3_location;
}
void OAISSMOutput::setS3Location(const OAIS3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAISSMOutput::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAISSMOutput::is_s3_location_Valid() const{
    return m_s3_location_isValid;
}

bool OAISSMOutput::isSet() const {
...
bool OAISSMOutput::isValid() const {
