...
/*
 * OAIAppValidationOutput_ssmOutput.h
 *
 * 
 */

#ifndef OAIAppValidationOutput_ssmOutput_H
#define OAIAppValidationOutput_ssmOutput_H
...
class OAIAppValidationOutput_ssmOutput : public OAIObject {
public:
    OAIAppValidationOutput_ssmOutput();
    OAIAppValidationOutput_ssmOutput(QString json);
    ~OAIAppValidationOutput_ssmOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppValidationOutput_ssmOutput)

#endif // OAIAppValidationOutput_ssmOutput_H
