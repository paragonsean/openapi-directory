...
/*
 * OAIGetAppLaunchConfigurationRequest.h
 *
 * 
 */

#ifndef OAIGetAppLaunchConfigurationRequest_H
#define OAIGetAppLaunchConfigurationRequest_H
...
class OAIGetAppLaunchConfigurationRequest : public OAIObject {
public:
    OAIGetAppLaunchConfigurationRequest();
    OAIGetAppLaunchConfigurationRequest(QString json);
    ~OAIGetAppLaunchConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAppLaunchConfigurationRequest)

#endif // OAIGetAppLaunchConfigurationRequest_H
