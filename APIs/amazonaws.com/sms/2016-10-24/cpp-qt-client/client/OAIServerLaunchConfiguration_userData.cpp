...
OAIServerLaunchConfiguration_userData::OAIServerLaunchConfiguration_userData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerLaunchConfiguration_userData::OAIServerLaunchConfiguration_userData() {
    this->initializeModel();
}

OAIServerLaunchConfiguration_userData::~OAIServerLaunchConfiguration_userData() {}

void OAIServerLaunchConfiguration_userData::initializeModel() {

    m_s3_location_isSet = false;
    m_s3_location_isValid = false;
}

void OAIServerLaunchConfiguration_userData::fromJson(QString jsonString) {
...
void OAIServerLaunchConfiguration_userData::fromJsonObject(QJsonObject json) {
...
QString OAIServerLaunchConfiguration_userData::asJson() const {
...
QJsonObject OAIServerLaunchConfiguration_userData::asJsonObject() const {
    QJsonObject obj;
...
OAIUserData_s3Location OAIServerLaunchConfiguration_userData::getS3Location() const {
    return m_s3_location;
}
void OAIServerLaunchConfiguration_userData::setS3Location(const OAIUserData_s3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAIServerLaunchConfiguration_userData::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAIServerLaunchConfiguration_userData::is_s3_location_Valid() const{
    return m_s3_location_isValid;
}

bool OAIServerLaunchConfiguration_userData::isSet() const {
...
bool OAIServerLaunchConfiguration_userData::isValid() const {
