...
/*
 * OAIConnectorStatus.h
 *
 * 
 */

#ifndef OAIConnectorStatus_H
#define OAIConnectorStatus_H
...
class OAIConnectorStatus : public OAIEnum {
public:
    OAIConnectorStatus();
    OAIConnectorStatus(QString json);
    ~OAIConnectorStatus() override;
    ...
    enum class eOAIConnectorStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        HEALTHY, 
        UNHEALTHY
    };
    OAIConnectorStatus::eOAIConnectorStatus getValue() const;
    void setValue(const OAIConnectorStatus::eOAIConnectorStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectorStatus)

#endif // OAIConnectorStatus_H
