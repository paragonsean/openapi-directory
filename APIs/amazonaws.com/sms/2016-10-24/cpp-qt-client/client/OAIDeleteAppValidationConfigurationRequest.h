...
/*
 * OAIDeleteAppValidationConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteAppValidationConfigurationRequest_H
#define OAIDeleteAppValidationConfigurationRequest_H
...
class OAIDeleteAppValidationConfigurationRequest : public OAIObject {
public:
    OAIDeleteAppValidationConfigurationRequest();
    OAIDeleteAppValidationConfigurationRequest(QString json);
    ~OAIDeleteAppValidationConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAppValidationConfigurationRequest)

#endif // OAIDeleteAppValidationConfigurationRequest_H
