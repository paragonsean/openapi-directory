...
/*
 * OAIImportAppCatalogRequest.h
 *
 * 
 */

#ifndef OAIImportAppCatalogRequest_H
#define OAIImportAppCatalogRequest_H
...
class OAIImportAppCatalogRequest : public OAIObject {
public:
    OAIImportAppCatalogRequest();
    OAIImportAppCatalogRequest(QString json);
    ~OAIImportAppCatalogRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAppCatalogRequest)

#endif // OAIImportAppCatalogRequest_H
