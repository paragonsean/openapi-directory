...
/*
 * OAIGetReplicationJobsRequest.h
 *
 * 
 */

#ifndef OAIGetReplicationJobsRequest_H
#define OAIGetReplicationJobsRequest_H
...
class OAIGetReplicationJobsRequest : public OAIObject {
public:
    OAIGetReplicationJobsRequest();
    OAIGetReplicationJobsRequest(QString json);
    ~OAIGetReplicationJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReplicationJobsRequest)

#endif // OAIGetReplicationJobsRequest_H
