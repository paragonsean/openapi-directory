...
/*
 * OAIServerCatalogStatus.h
 *
 * 
 */

#ifndef OAIServerCatalogStatus_H
#define OAIServerCatalogStatus_H
...
class OAIServerCatalogStatus : public OAIEnum {
public:
    OAIServerCatalogStatus();
    OAIServerCatalogStatus(QString json);
    ~OAIServerCatalogStatus() override;
    ...
    enum class eOAIServerCatalogStatus {
    ...
    OAIServerCatalogStatus::eOAIServerCatalogStatus getValue() const;
    void setValue(const OAIServerCatalogStatus::eOAIServerCatalogStatus& value);
...
private:
    ...
    eOAIServerCatalogStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerCatalogStatus)

#endif // OAIServerCatalogStatus_H
