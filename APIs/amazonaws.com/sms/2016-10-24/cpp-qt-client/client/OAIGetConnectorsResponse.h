...
/*
 * OAIGetConnectorsResponse.h
 *
 * 
 */

#ifndef OAIGetConnectorsResponse_H
#define OAIGetConnectorsResponse_H
...
class OAIGetConnectorsResponse : public OAIObject {
public:
    OAIGetConnectorsResponse();
    OAIGetConnectorsResponse(QString json);
    ~OAIGetConnectorsResponse() override;
    ...
    QList getConnectorList() const;
    void setConnectorList(const QList &connector_list);
    bool is_connector_list_Set() const;
    bool is_connector_list_Valid() const;
...
private:
    ...
    QList m_connector_list;
    bool m_connector_list_isSet;
    bool m_connector_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetConnectorsResponse)

#endif // OAIGetConnectorsResponse_H
