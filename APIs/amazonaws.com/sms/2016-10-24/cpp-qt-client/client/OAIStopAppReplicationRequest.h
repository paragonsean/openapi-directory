...
/*
 * OAIStopAppReplicationRequest.h
 *
 * 
 */

#ifndef OAIStopAppReplicationRequest_H
#define OAIStopAppReplicationRequest_H
...
class OAIStopAppReplicationRequest : public OAIObject {
public:
    OAIStopAppReplicationRequest();
    OAIStopAppReplicationRequest(QString json);
    ~OAIStopAppReplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopAppReplicationRequest)

#endif // OAIStopAppReplicationRequest_H
