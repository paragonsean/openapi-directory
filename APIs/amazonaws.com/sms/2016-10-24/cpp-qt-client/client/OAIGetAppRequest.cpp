...
OAIGetAppRequest::OAIGetAppRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAppRequest::OAIGetAppRequest() {
    this->initializeModel();
}

OAIGetAppRequest::~OAIGetAppRequest() {}

void OAIGetAppRequest::initializeModel() {

    m_app_id_isSet = false;
    m_app_id_isValid = false;
}

void OAIGetAppRequest::fromJson(QString jsonString) {
...
void OAIGetAppRequest::fromJsonObject(QJsonObject json) {

    m_app_id_isValid = ::OpenAPI::fromJsonValue(m_app_id, json[QString("appId")]);
    m_app_id_isSet = !json[QString("appId")].isNull() && m_app_id_isValid;
}

QString OAIGetAppRequest::asJson() const {
...
QJsonObject OAIGetAppRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_app_id_isSet) {
...
QString OAIGetAppRequest::getAppId() const {
    return m_app_id;
}
void OAIGetAppRequest::setAppId(const QString &app_id) {
    m_app_id = app_id;
    m_app_id_isSet = true;
}

bool OAIGetAppRequest::is_app_id_Set() const{
    return m_app_id_isSet;
}

bool OAIGetAppRequest::is_app_id_Valid() const{
    return m_app_id_isValid;
}

bool OAIGetAppRequest::isSet() const {
...
bool OAIGetAppRequest::isValid() const {
