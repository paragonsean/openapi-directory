...
/*
 * OAIGenerateTemplateRequest.h
 *
 * 
 */

#ifndef OAIGenerateTemplateRequest_H
#define OAIGenerateTemplateRequest_H
...
class OAIGenerateTemplateRequest : public OAIObject {
public:
    OAIGenerateTemplateRequest();
    OAIGenerateTemplateRequest(QString json);
    ~OAIGenerateTemplateRequest() override;
    ...
    OAIOutputFormat getTemplateFormat() const;
    void setTemplateFormat(const OAIOutputFormat &template_format);
    bool is_template_format_Set() const;
    bool is_template_format_Valid() const;
...
private:
    ...
    OAIOutputFormat m_template_format;
    bool m_template_format_isSet;
    bool m_template_format_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGenerateTemplateRequest)

#endif // OAIGenerateTemplateRequest_H
