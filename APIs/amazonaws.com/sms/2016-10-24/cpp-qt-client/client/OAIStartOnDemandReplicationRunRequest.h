...
/*
 * OAIStartOnDemandReplicationRunRequest.h
 *
 * 
 */

#ifndef OAIStartOnDemandReplicationRunRequest_H
#define OAIStartOnDemandReplicationRunRequest_H
...
class OAIStartOnDemandReplicationRunRequest : public OAIObject {
public:
    OAIStartOnDemandReplicationRunRequest();
    OAIStartOnDemandReplicationRunRequest(QString json);
    ~OAIStartOnDemandReplicationRunRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartOnDemandReplicationRunRequest)

#endif // OAIStartOnDemandReplicationRunRequest_H
