...
/*
 * OAIGenerateChangeSetResponse.h
 *
 * 
 */

#ifndef OAIGenerateChangeSetResponse_H
#define OAIGenerateChangeSetResponse_H
...
class OAIGenerateChangeSetResponse : public OAIObject {
public:
    OAIGenerateChangeSetResponse();
    OAIGenerateChangeSetResponse(QString json);
    ~OAIGenerateChangeSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateChangeSetResponse)

#endif // OAIGenerateChangeSetResponse_H
