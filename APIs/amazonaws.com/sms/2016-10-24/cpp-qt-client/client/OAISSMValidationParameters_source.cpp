...
OAISSMValidationParameters_source::OAISSMValidationParameters_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISSMValidationParameters_source::OAISSMValidationParameters_source() {
    this->initializeModel();
}

OAISSMValidationParameters_source::~OAISSMValidationParameters_source() {}

void OAISSMValidationParameters_source::initializeModel() {

    m_s3_location_isSet = false;
    m_s3_location_isValid = false;
}

void OAISSMValidationParameters_source::fromJson(QString jsonString) {
...
void OAISSMValidationParameters_source::fromJsonObject(QJsonObject json) {
...
QString OAISSMValidationParameters_source::asJson() const {
...
QJsonObject OAISSMValidationParameters_source::asJsonObject() const {
    QJsonObject obj;
...
OAIS3Location OAISSMValidationParameters_source::getS3Location() const {
    return m_s3_location;
}
void OAISSMValidationParameters_source::setS3Location(const OAIS3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAISSMValidationParameters_source::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAISSMValidationParameters_source::is_s3_location_Valid() const{
    return m_s3_location_isValid;
}

bool OAISSMValidationParameters_source::isSet() const {
...
bool OAISSMValidationParameters_source::isValid() const {
