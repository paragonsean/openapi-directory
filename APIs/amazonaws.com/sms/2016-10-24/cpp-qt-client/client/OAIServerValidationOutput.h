...
/*
 * OAIServerValidationOutput.h
 *
 * Contains output from validating an instance.
 */

#ifndef OAIServerValidationOutput_H
#define OAIServerValidationOutput_H
...
class OAIServerValidationOutput : public OAIObject {
public:
    OAIServerValidationOutput();
    OAIServerValidationOutput(QString json);
    ~OAIServerValidationOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerValidationOutput)

#endif // OAIServerValidationOutput_H
