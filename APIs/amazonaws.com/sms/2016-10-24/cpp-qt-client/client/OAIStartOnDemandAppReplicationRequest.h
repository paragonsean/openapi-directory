...
/*
 * OAIStartOnDemandAppReplicationRequest.h
 *
 * 
 */

#ifndef OAIStartOnDemandAppReplicationRequest_H
#define OAIStartOnDemandAppReplicationRequest_H
...
class OAIStartOnDemandAppReplicationRequest : public OAIObject {
public:
    OAIStartOnDemandAppReplicationRequest();
    OAIStartOnDemandAppReplicationRequest(QString json);
    ~OAIStartOnDemandAppReplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartOnDemandAppReplicationRequest)

#endif // OAIStartOnDemandAppReplicationRequest_H
