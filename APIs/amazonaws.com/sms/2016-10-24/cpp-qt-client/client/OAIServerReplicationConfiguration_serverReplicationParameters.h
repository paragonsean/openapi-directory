...
/*
 * OAIServerReplicationConfiguration_serverReplicationParameters.h
 *
 * 
 */

#ifndef OAIServerReplicationConfiguration_serverReplicationParameters_H
#define OAIServerReplicationConfiguration_serverReplicationParameters_H
...
class OAIServerReplicationConfiguration_serverReplicationParameters : public OAIObject {
public:
    OAIServerReplicationConfiguration_serverReplicationParameters();
    OAIServerReplicationConfiguration_serverReplicationParameters(QString json);
    ~OAIServerReplicationConfiguration_serverReplicationParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerReplicationConfiguration_serverReplicationParameters)

#endif // OAIServerReplicationConfiguration_serverReplicationParameters_H
