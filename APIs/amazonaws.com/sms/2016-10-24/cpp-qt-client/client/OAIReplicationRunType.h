...
/*
 * OAIReplicationRunType.h
 *
 * 
 */

#ifndef OAIReplicationRunType_H
#define OAIReplicationRunType_H
...
class OAIReplicationRunType : public OAIEnum {
public:
    OAIReplicationRunType();
    OAIReplicationRunType(QString json);
    ~OAIReplicationRunType() override;
    ...
    enum class eOAIReplicationRunType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ON_DEMAND, 
        AUTOMATIC
    };
    OAIReplicationRunType::eOAIReplicationRunType getValue() const;
    void setValue(const OAIReplicationRunType::eOAIReplicationRunType& value);
...
private:
    ...
    eOAIReplicationRunType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicationRunType)

#endif // OAIReplicationRunType_H
