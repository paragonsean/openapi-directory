...
/*
 * OAIServerValidationStrategy.h
 *
 * 
 */

#ifndef OAIServerValidationStrategy_H
#define OAIServerValidationStrategy_H
...
class OAIServerValidationStrategy : public OAIEnum {
public:
    OAIServerValidationStrategy();
    OAIServerValidationStrategy(QString json);
    ~OAIServerValidationStrategy() override;
    ...
    enum class eOAIServerValidationStrategy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        USERDATA
    };
    OAIServerValidationStrategy::eOAIServerValidationStrategy getValue() const;
    void setValue(const OAIServerValidationStrategy::eOAIServerValidationStrategy& value);
...
private:
    ...
    eOAIServerValidationStrategy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerValidationStrategy)

#endif // OAIServerValidationStrategy_H
