...
/*
 * OAIUserData_s3Location.h
 *
 * 
 */

#ifndef OAIUserData_s3Location_H
#define OAIUserData_s3Location_H
...
class OAIUserData_s3Location : public OAIObject {
public:
    OAIUserData_s3Location();
    OAIUserData_s3Location(QString json);
    ~OAIUserData_s3Location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserData_s3Location)

#endif // OAIUserData_s3Location_H
