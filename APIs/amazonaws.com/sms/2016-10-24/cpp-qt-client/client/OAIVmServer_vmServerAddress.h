...
/*
 * OAIVmServer_vmServerAddress.h
 *
 * 
 */

#ifndef OAIVmServer_vmServerAddress_H
#define OAIVmServer_vmServerAddress_H
...
class OAIVmServer_vmServerAddress : public OAIObject {
public:
    OAIVmServer_vmServerAddress();
    OAIVmServer_vmServerAddress(QString json);
    ~OAIVmServer_vmServerAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVmServer_vmServerAddress)

#endif // OAIVmServer_vmServerAddress_H
