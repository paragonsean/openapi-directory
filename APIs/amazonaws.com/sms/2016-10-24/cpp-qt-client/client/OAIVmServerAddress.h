...
/*
 * OAIVmServerAddress.h
 *
 * Represents a VM server location.
 */

#ifndef OAIVmServerAddress_H
#define OAIVmServerAddress_H
...
class OAIVmServerAddress : public OAIObject {
public:
    OAIVmServerAddress();
    OAIVmServerAddress(QString json);
    ~OAIVmServerAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVmServerAddress)

#endif // OAIVmServerAddress_H
