...
/*
 * OAIAppSummary_launchDetails.h
 *
 * 
 */

#ifndef OAIAppSummary_launchDetails_H
#define OAIAppSummary_launchDetails_H
...
class OAIAppSummary_launchDetails : public OAIObject {
public:
    OAIAppSummary_launchDetails();
    OAIAppSummary_launchDetails(QString json);
    ~OAIAppSummary_launchDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppSummary_launchDetails)

#endif // OAIAppSummary_launchDetails_H
