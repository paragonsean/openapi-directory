...
/*
 * OAIGetReplicationRunsResponse_replicationJob.h
 *
 * 
 */

#ifndef OAIGetReplicationRunsResponse_replicationJob_H
#define OAIGetReplicationRunsResponse_replicationJob_H
...
class OAIGetReplicationRunsResponse_replicationJob : public OAIObject {
public:
    OAIGetReplicationRunsResponse_replicationJob();
    OAIGetReplicationRunsResponse_replicationJob(QString json);
    ~OAIGetReplicationRunsResponse_replicationJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReplicationRunsResponse_replicationJob)

#endif // OAIGetReplicationRunsResponse_replicationJob_H
