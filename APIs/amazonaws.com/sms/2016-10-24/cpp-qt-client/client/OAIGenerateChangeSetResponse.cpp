...
OAIGenerateChangeSetResponse::OAIGenerateChangeSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateChangeSetResponse::OAIGenerateChangeSetResponse() {
    this->initializeModel();
}

OAIGenerateChangeSetResponse::~OAIGenerateChangeSetResponse() {}

void OAIGenerateChangeSetResponse::initializeModel() {

    m_s3_location_isSet = false;
    m_s3_location_isValid = false;
}

void OAIGenerateChangeSetResponse::fromJson(QString jsonString) {
...
void OAIGenerateChangeSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateChangeSetResponse::asJson() const {
...
QJsonObject OAIGenerateChangeSetResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGenerateChangeSetResponse_s3Location OAIGenerateChangeSetResponse::getS3Location() const {
    return m_s3_location;
}
void OAIGenerateChangeSetResponse::setS3Location(const OAIGenerateChangeSetResponse_s3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAIGenerateChangeSetResponse::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAIGenerateChangeSetResponse::is_s3_location_Valid() const{
    return m_s3_location_isValid;
}

bool OAIGenerateChangeSetResponse::isSet() const {
...
bool OAIGenerateChangeSetResponse::isValid() const {
