...
/*
 * OAIReplicationRun_stageDetails.h
 *
 * 
 */

#ifndef OAIReplicationRun_stageDetails_H
#define OAIReplicationRun_stageDetails_H
...
class OAIReplicationRun_stageDetails : public OAIObject {
public:
    OAIReplicationRun_stageDetails();
    OAIReplicationRun_stageDetails(QString json);
    ~OAIReplicationRun_stageDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicationRun_stageDetails)

#endif // OAIReplicationRun_stageDetails_H
