...
OAIAppValidationOutput_ssmOutput::OAIAppValidationOutput_ssmOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAppValidationOutput_ssmOutput::OAIAppValidationOutput_ssmOutput() {
    this->initializeModel();
}

OAIAppValidationOutput_ssmOutput::~OAIAppValidationOutput_ssmOutput() {}

void OAIAppValidationOutput_ssmOutput::initializeModel() {

    m_s3_location_isSet = false;
    m_s3_location_isValid = false;
}

void OAIAppValidationOutput_ssmOutput::fromJson(QString jsonString) {
...
void OAIAppValidationOutput_ssmOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAppValidationOutput_ssmOutput::asJson() const {
...
QJsonObject OAIAppValidationOutput_ssmOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIS3Location OAIAppValidationOutput_ssmOutput::getS3Location() const {
    return m_s3_location;
}
void OAIAppValidationOutput_ssmOutput::setS3Location(const OAIS3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAIAppValidationOutput_ssmOutput::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAIAppValidationOutput_ssmOutput::is_s3_location_Valid() const{
    return m_s3_location_isValid;
}

bool OAIAppValidationOutput_ssmOutput::isSet() const {
...
bool OAIAppValidationOutput_ssmOutput::isValid() const {
