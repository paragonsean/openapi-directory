...
#include "OAIServerReplicationConfiguration_server.h"
...
OAIServerReplicationConfiguration_server::OAIServerReplicationConfiguration_server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerReplicationConfiguration_server::OAIServerReplicationConfiguration_server() {
    this->initializeModel();
}

OAIServerReplicationConfiguration_server::~OAIServerReplicationConfiguration_server() {}

void OAIServerReplicationConfiguration_server::initializeModel() {
...
void OAIServerReplicationConfiguration_server::fromJson(QString jsonString) {
...
void OAIServerReplicationConfiguration_server::fromJsonObject(QJsonObject json) {
...
QString OAIServerReplicationConfiguration_server::asJson() const {
...
QJsonObject OAIServerReplicationConfiguration_server::asJsonObject() const {
    QJsonObject obj;
...
QString OAIServerReplicationConfiguration_server::getServerId() const {
    return m_server_id;
}
void OAIServerReplicationConfiguration_server::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIServerReplicationConfiguration_server::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIServerReplicationConfiguration_server::is_server_id_Valid() const{
    return m_server_id_isValid;
}

OAIServerType OAIServerReplicationConfiguration_server::getServerType() const {
    return m_server_type;
}
void OAIServerReplicationConfiguration_server::setServerType(const OAIServerType &server_type) {
    m_server_type = server_type;
    m_server_type_isSet = true;
}

bool OAIServerReplicationConfiguration_server::is_server_type_Set() const{
    return m_server_type_isSet;
}

bool OAIServerReplicationConfiguration_server::is_server_type_Valid() const{
    return m_server_type_isValid;
}

OAIReplicationJob_vmServer OAIServerReplicationConfiguration_server::getVmServer() const {
    return m_vm_server;
}
void OAIServerReplicationConfiguration_server::setVmServer(const OAIReplicationJob_vmServer &vm_server) {
    m_vm_server = vm_server;
    m_vm_server_isSet = true;
}

bool OAIServerReplicationConfiguration_server::is_vm_server_Set() const{
    return m_vm_server_isSet;
}

bool OAIServerReplicationConfiguration_server::is_vm_server_Valid() const{
    return m_vm_server_isValid;
}

QString OAIServerReplicationConfiguration_server::getReplicationJobId() const {
    return m_replication_job_id;
}
void OAIServerReplicationConfiguration_server::setReplicationJobId(const QString &replication_job_id) {
    m_replication_job_id = replication_job_id;
    m_replication_job_id_isSet = true;
}

bool OAIServerReplicationConfiguration_server::is_replication_job_id_Set() const{
    return m_replication_job_id_isSet;
}

bool OAIServerReplicationConfiguration_server::is_replication_job_id_Valid() const{
    return m_replication_job_id_isValid;
}

bool OAIServerReplicationConfiguration_server::getReplicationJobTerminated() const {
    return m_replication_job_terminated;
}
void OAIServerReplicationConfiguration_server::setReplicationJobTerminated(const bool &replication_job_terminated) {
    m_replication_job_terminated = replication_job_terminated;
    m_replication_job_terminated_isSet = true;
}

bool OAIServerReplicationConfiguration_server::is_replication_job_terminated_Set() const{
    return m_replication_job_terminated_isSet;
}

bool OAIServerReplicationConfiguration_server::is_replication_job_terminated_Valid() const{
    return m_replication_job_terminated_isValid;
}

bool OAIServerReplicationConfiguration_server::isSet() const {
...
bool OAIServerReplicationConfiguration_server::isValid() const {
