...
/*
 * OAIAppReplicationConfigurationStatus.h
 *
 * 
 */

#ifndef OAIAppReplicationConfigurationStatus_H
#define OAIAppReplicationConfigurationStatus_H
...
class OAIAppReplicationConfigurationStatus : public OAIEnum {
public:
    OAIAppReplicationConfigurationStatus();
    OAIAppReplicationConfigurationStatus(QString json);
    ~OAIAppReplicationConfigurationStatus() override;
    ...
    enum class eOAIAppReplicationConfigurationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NOT_CONFIGURED, 
        CONFIGURED
    };
    OAIAppReplicationConfigurationStatus::eOAIAppReplicationConfigurationStatus getValue() const;
    void setValue(const OAIAppReplicationConfigurationStatus::eOAIAppReplicationConfigurationStatus& value);
...
private:
    ...
    eOAIAppReplicationConfigurationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppReplicationConfigurationStatus)

#endif // OAIAppReplicationConfigurationStatus_H
