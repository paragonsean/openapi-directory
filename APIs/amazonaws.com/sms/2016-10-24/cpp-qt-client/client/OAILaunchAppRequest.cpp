...
OAILaunchAppRequest::OAILaunchAppRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILaunchAppRequest::OAILaunchAppRequest() {
    this->initializeModel();
}

OAILaunchAppRequest::~OAILaunchAppRequest() {}

void OAILaunchAppRequest::initializeModel() {

    m_app_id_isSet = false;
    m_app_id_isValid = false;
}

void OAILaunchAppRequest::fromJson(QString jsonString) {
...
void OAILaunchAppRequest::fromJsonObject(QJsonObject json) {

    m_app_id_isValid = ::OpenAPI::fromJsonValue(m_app_id, json[QString("appId")]);
    m_app_id_isSet = !json[QString("appId")].isNull() && m_app_id_isValid;
}

QString OAILaunchAppRequest::asJson() const {
...
QJsonObject OAILaunchAppRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_app_id_isSet) {
...
QString OAILaunchAppRequest::getAppId() const {
    return m_app_id;
}
void OAILaunchAppRequest::setAppId(const QString &app_id) {
    m_app_id = app_id;
    m_app_id_isSet = true;
}

bool OAILaunchAppRequest::is_app_id_Set() const{
    return m_app_id_isSet;
}

bool OAILaunchAppRequest::is_app_id_Valid() const{
    return m_app_id_isValid;
}

bool OAILaunchAppRequest::isSet() const {
...
bool OAILaunchAppRequest::isValid() const {
