...
OAIStartAppReplicationRequest::OAIStartAppReplicationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartAppReplicationRequest::OAIStartAppReplicationRequest() {
    this->initializeModel();
}

OAIStartAppReplicationRequest::~OAIStartAppReplicationRequest() {}

void OAIStartAppReplicationRequest::initializeModel() {

    m_app_id_isSet = false;
    m_app_id_isValid = false;
}

void OAIStartAppReplicationRequest::fromJson(QString jsonString) {
...
void OAIStartAppReplicationRequest::fromJsonObject(QJsonObject json) {

    m_app_id_isValid = ::OpenAPI::fromJsonValue(m_app_id, json[QString("appId")]);
    m_app_id_isSet = !json[QString("appId")].isNull() && m_app_id_isValid;
}

QString OAIStartAppReplicationRequest::asJson() const {
...
QJsonObject OAIStartAppReplicationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_app_id_isSet) {
...
QString OAIStartAppReplicationRequest::getAppId() const {
    return m_app_id;
}
void OAIStartAppReplicationRequest::setAppId(const QString &app_id) {
    m_app_id = app_id;
    m_app_id_isSet = true;
}

bool OAIStartAppReplicationRequest::is_app_id_Set() const{
    return m_app_id_isSet;
}

bool OAIStartAppReplicationRequest::is_app_id_Valid() const{
    return m_app_id_isValid;
}

bool OAIStartAppReplicationRequest::isSet() const {
...
bool OAIStartAppReplicationRequest::isValid() const {
