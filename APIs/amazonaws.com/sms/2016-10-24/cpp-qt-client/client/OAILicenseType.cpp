...
void OAILicenseType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("AWS", Qt::CaseInsensitive) == 0) {
        m_value = eOAILicenseType::AWS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BYOL", Qt::CaseInsensitive) == 0) {
        m_value = eOAILicenseType::BYOL;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAILicenseType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAILicenseType::AWS:
            val = "AWS";
            break;
        case eOAILicenseType::BYOL:
            val = "BYOL";
            break;
        default:
            break;
