...
/*
 * OAIAppLaunchConfigurationStatus.h
 *
 * 
 */

#ifndef OAIAppLaunchConfigurationStatus_H
#define OAIAppLaunchConfigurationStatus_H
...
class OAIAppLaunchConfigurationStatus : public OAIEnum {
public:
    OAIAppLaunchConfigurationStatus();
    OAIAppLaunchConfigurationStatus(QString json);
    ~OAIAppLaunchConfigurationStatus() override;
    ...
    enum class eOAIAppLaunchConfigurationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NOT_CONFIGURED, 
        CONFIGURED
    };
    OAIAppLaunchConfigurationStatus::eOAIAppLaunchConfigurationStatus getValue() const;
    void setValue(const OAIAppLaunchConfigurationStatus::eOAIAppLaunchConfigurationStatus& value);
...
private:
    ...
    eOAIAppLaunchConfigurationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppLaunchConfigurationStatus)

#endif // OAIAppLaunchConfigurationStatus_H
