...
/*
 * OAIDisassociateConnectorRequest.h
 *
 * 
 */

#ifndef OAIDisassociateConnectorRequest_H
#define OAIDisassociateConnectorRequest_H
...
class OAIDisassociateConnectorRequest : public OAIObject {
public:
    OAIDisassociateConnectorRequest();
    OAIDisassociateConnectorRequest(QString json);
    ~OAIDisassociateConnectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateConnectorRequest)

#endif // OAIDisassociateConnectorRequest_H
