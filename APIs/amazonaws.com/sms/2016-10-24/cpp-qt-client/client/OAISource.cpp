...
OAIS3Location OAISource::getS3Location() const {
    return m_s3_location;
}
void OAISource::setS3Location(const OAIS3Location &s3_location) {
    m_s3_location = s3_location;
    m_s3_location_isSet = true;
}

bool OAISource::is_s3_location_Set() const{
    return m_s3_location_isSet;
}

bool OAISource::is_s3_location_Valid() const{
