...
/*
 * OAIGetReplicationRunsRequest.h
 *
 * 
 */

#ifndef OAIGetReplicationRunsRequest_H
#define OAIGetReplicationRunsRequest_H
...
class OAIGetReplicationRunsRequest : public OAIObject {
public:
    OAIGetReplicationRunsRequest();
    OAIGetReplicationRunsRequest(QString json);
    ~OAIGetReplicationRunsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReplicationRunsRequest)

#endif // OAIGetReplicationRunsRequest_H
