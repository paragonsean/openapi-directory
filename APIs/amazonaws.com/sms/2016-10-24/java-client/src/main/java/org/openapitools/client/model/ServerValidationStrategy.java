...
/**
 * Gets or Sets ServerValidationStrategy
 */
@JsonAdapter(ServerValidationStrategy.Adapter.class)
public enum ServerValidationStrategy {
  ...
  ServerValidationStrategy(String value) {
    this.value = value;
  }
  ...
  public static ServerValidationStrategy fromValue(String value) {
    for (ServerValidationStrategy b : ServerValidationStrategy.values()) {
  ...
  public static class Adapter extends TypeAdapter<ServerValidationStrategy> {
    @Override
    public void write(final JsonWriter jsonWriter, final ServerValidationStrategy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ServerValidationStrategy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ServerValidationStrategy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ServerValidationStrategy.fromValue(value);
  }
}
