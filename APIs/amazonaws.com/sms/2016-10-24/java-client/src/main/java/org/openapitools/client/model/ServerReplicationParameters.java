...
public class ServerReplicationParameters {
  ...
  public ServerReplicationParameters seedTime(OffsetDateTime seedTime) {
  ...
  public ServerReplicationParameters frequency(Integer frequency) {
  ...
  public ServerReplicationParameters runOnce(Boolean runOnce) {
  ...
  public ServerReplicationParameters licenseType(LicenseType licenseType) {
  ...
  public ServerReplicationParameters numberOfRecentAmisToKeep(Integer numberOfRecentAmisToKeep) {
  ...
  public ServerReplicationParameters encrypted(Boolean encrypted) {
  ...
  public ServerReplicationParameters kmsKeyId(String kmsKeyId) {
  ...
  public boolean equals(Object o) {
    ...
    ServerReplicationParameters serverReplicationParameters = (ServerReplicationParameters) o;
    return Objects.equals(this.seedTime, serverReplicationParameters.seedTime) &&
        Objects.equals(this.frequency, serverReplicationParameters.frequency) &&
        Objects.equals(this.runOnce, serverReplicationParameters.runOnce) &&
        Objects.equals(this.licenseType, serverReplicationParameters.licenseType) &&
        Objects.equals(this.numberOfRecentAmisToKeep, serverReplicationParameters.numberOfRecentAmisToKeep) &&
        Objects.equals(this.encrypted, serverReplicationParameters.encrypted) &&
        Objects.equals(this.kmsKeyId, serverReplicationParameters.kmsKeyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerReplicationParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerReplicationParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerReplicationParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerReplicationParameters is not found in the empty JSON string", ServerReplicationParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerReplicationParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerReplicationParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerReplicationParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerReplicationParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerReplicationParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerReplicationParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerReplicationParameters>() {
           @Override
           public void write(JsonWriter out, ServerReplicationParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerReplicationParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerReplicationParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerReplicationParameters
   * @throws IOException if the JSON string is invalid with respect to ServerReplicationParameters
   */
  public static ServerReplicationParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerReplicationParameters.class);
  }

  /**
   * Convert an instance of ServerReplicationParameters to an JSON string
   *
   * @return JSON string
   */
