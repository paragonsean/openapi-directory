...
/**
 * Gets or Sets ServerCatalogStatus
 */
@JsonAdapter(ServerCatalogStatus.Adapter.class)
public enum ServerCatalogStatus {
  ...
  ServerCatalogStatus(String value) {
    this.value = value;
  }
  ...
  public static ServerCatalogStatus fromValue(String value) {
    for (ServerCatalogStatus b : ServerCatalogStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ServerCatalogStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ServerCatalogStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ServerCatalogStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ServerCatalogStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ServerCatalogStatus.fromValue(value);
  }
}
