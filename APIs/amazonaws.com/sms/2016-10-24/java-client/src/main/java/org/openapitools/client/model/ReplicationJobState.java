...
/**
 * Gets or Sets ReplicationJobState
 */
@JsonAdapter(ReplicationJobState.Adapter.class)
public enum ReplicationJobState {
  ...
  ReplicationJobState(String value) {
    this.value = value;
  }
  ...
  public static ReplicationJobState fromValue(String value) {
    for (ReplicationJobState b : ReplicationJobState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReplicationJobState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReplicationJobState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReplicationJobState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReplicationJobState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ReplicationJobState.fromValue(value);
  }
}
