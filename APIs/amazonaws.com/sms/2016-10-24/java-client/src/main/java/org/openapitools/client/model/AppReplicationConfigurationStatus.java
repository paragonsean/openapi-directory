...
/**
 * Gets or Sets AppReplicationConfigurationStatus
 */
@JsonAdapter(AppReplicationConfigurationStatus.Adapter.class)
public enum AppReplicationConfigurationStatus {
  ...
  AppReplicationConfigurationStatus(String value) {
    this.value = value;
  }
  ...
  public static AppReplicationConfigurationStatus fromValue(String value) {
    for (AppReplicationConfigurationStatus b : AppReplicationConfigurationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AppReplicationConfigurationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AppReplicationConfigurationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AppReplicationConfigurationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AppReplicationConfigurationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AppReplicationConfigurationStatus.fromValue(value);
  }
}
