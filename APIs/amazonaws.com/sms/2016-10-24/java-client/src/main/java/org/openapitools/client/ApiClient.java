...
public class ApiClient {
    ...
    private String basePath = "http://sms.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-10-24/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://sms.us-east-1.amazonaws.com
