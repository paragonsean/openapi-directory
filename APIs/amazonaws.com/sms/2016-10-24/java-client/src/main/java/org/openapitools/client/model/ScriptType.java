 ...
 */
@JsonAdapter(ScriptType.Adapter.class)
public enum ScriptType {
  ...
  public static class Adapter extends TypeAdapter<ScriptType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScriptType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScriptType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScriptType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ScriptType.fromValue(value);
  }
}
