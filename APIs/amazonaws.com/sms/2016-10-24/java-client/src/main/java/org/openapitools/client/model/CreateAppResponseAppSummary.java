...
public class CreateAppResponseAppSummary {
  ...
  public CreateAppResponseAppSummary() {
  }

  public CreateAppResponseAppSummary appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public CreateAppResponseAppSummary importedAppId(String importedAppId) {
  ...
  public CreateAppResponseAppSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAppResponseAppSummary description(String description) {
  ...
  public CreateAppResponseAppSummary status(AppStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateAppResponseAppSummary statusMessage(String statusMessage) {
  ...
  public CreateAppResponseAppSummary replicationConfigurationStatus(AppReplicationConfigurationStatus replicationConfigurationStatus) {
  ...
  public CreateAppResponseAppSummary replicationStatus(AppReplicationStatus replicationStatus) {
  ...
  public CreateAppResponseAppSummary replicationStatusMessage(String replicationStatusMessage) {
  ...
  public CreateAppResponseAppSummary latestReplicationTime(OffsetDateTime latestReplicationTime) {
  ...
  public CreateAppResponseAppSummary launchConfigurationStatus(AppLaunchConfigurationStatus launchConfigurationStatus) {
  ...
  public CreateAppResponseAppSummary launchStatus(AppLaunchStatus launchStatus) {
  ...
  public CreateAppResponseAppSummary launchStatusMessage(String launchStatusMessage) {
  ...
  public CreateAppResponseAppSummary launchDetails(AppSummaryLaunchDetails launchDetails) {
  ...
  public CreateAppResponseAppSummary creationTime(OffsetDateTime creationTime) {
  ...
  public CreateAppResponseAppSummary lastModified(OffsetDateTime lastModified) {
  ...
  public CreateAppResponseAppSummary roleName(String roleName) {
  ...
  public CreateAppResponseAppSummary totalServerGroups(Integer totalServerGroups) {
  ...
  public CreateAppResponseAppSummary totalServers(Integer totalServers) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAppResponseAppSummary createAppResponseAppSummary = (CreateAppResponseAppSummary) o;
    return Objects.equals(this.appId, createAppResponseAppSummary.appId) &&
        Objects.equals(this.importedAppId, createAppResponseAppSummary.importedAppId) &&
        Objects.equals(this.name, createAppResponseAppSummary.name) &&
        Objects.equals(this.description, createAppResponseAppSummary.description) &&
        Objects.equals(this.status, createAppResponseAppSummary.status) &&
        Objects.equals(this.statusMessage, createAppResponseAppSummary.statusMessage) &&
        Objects.equals(this.replicationConfigurationStatus, createAppResponseAppSummary.replicationConfigurationStatus) &&
        Objects.equals(this.replicationStatus, createAppResponseAppSummary.replicationStatus) &&
        Objects.equals(this.replicationStatusMessage, createAppResponseAppSummary.replicationStatusMessage) &&
        Objects.equals(this.latestReplicationTime, createAppResponseAppSummary.latestReplicationTime) &&
        Objects.equals(this.launchConfigurationStatus, createAppResponseAppSummary.launchConfigurationStatus) &&
        Objects.equals(this.launchStatus, createAppResponseAppSummary.launchStatus) &&
        Objects.equals(this.launchStatusMessage, createAppResponseAppSummary.launchStatusMessage) &&
        Objects.equals(this.launchDetails, createAppResponseAppSummary.launchDetails) &&
        Objects.equals(this.creationTime, createAppResponseAppSummary.creationTime) &&
        Objects.equals(this.lastModified, createAppResponseAppSummary.lastModified) &&
        Objects.equals(this.roleName, createAppResponseAppSummary.roleName) &&
        Objects.equals(this.totalServerGroups, createAppResponseAppSummary.totalServerGroups) &&
        Objects.equals(this.totalServers, createAppResponseAppSummary.totalServers);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAppResponseAppSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAppResponseAppSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAppResponseAppSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAppResponseAppSummary is not found in the empty JSON string", CreateAppResponseAppSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAppResponseAppSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAppResponseAppSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAppResponseAppSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAppResponseAppSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAppResponseAppSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAppResponseAppSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAppResponseAppSummary>() {
           @Override
           public void write(JsonWriter out, CreateAppResponseAppSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAppResponseAppSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAppResponseAppSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAppResponseAppSummary
   * @throws IOException if the JSON string is invalid with respect to CreateAppResponseAppSummary
   */
  public static CreateAppResponseAppSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAppResponseAppSummary.class);
  }

  /**
   * Convert an instance of CreateAppResponseAppSummary to an JSON string
   *
   * @return JSON string
   */
