...
/**
 * Gets or Sets VmManagerType
 */
@JsonAdapter(VmManagerType.Adapter.class)
public enum VmManagerType {
  ...
  public static VmManagerType fromValue(String value) {
    for (VmManagerType b : VmManagerType.values()) {
  ...
  public static class Adapter extends TypeAdapter<VmManagerType> {
    @Override
    public void write(final JsonWriter jsonWriter, final VmManagerType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VmManagerType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VmManagerType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VmManagerType.fromValue(value);
  }
}
