...
/**
 * Gets or Sets AppLaunchConfigurationStatus
 */
@JsonAdapter(AppLaunchConfigurationStatus.Adapter.class)
public enum AppLaunchConfigurationStatus {
  ...
  AppLaunchConfigurationStatus(String value) {
    this.value = value;
  }
  ...
  public static AppLaunchConfigurationStatus fromValue(String value) {
    for (AppLaunchConfigurationStatus b : AppLaunchConfigurationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AppLaunchConfigurationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AppLaunchConfigurationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AppLaunchConfigurationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AppLaunchConfigurationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AppLaunchConfigurationStatus.fromValue(value);
  }
}
