...
/**
 * Gets or Sets ReplicationRunType
 */
@JsonAdapter(ReplicationRunType.Adapter.class)
public enum ReplicationRunType {
  ...
  ReplicationRunType(String value) {
    this.value = value;
  }
  ...
  public static ReplicationRunType fromValue(String value) {
    for (ReplicationRunType b : ReplicationRunType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReplicationRunType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReplicationRunType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReplicationRunType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReplicationRunType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ReplicationRunType.fromValue(value);
  }
}
