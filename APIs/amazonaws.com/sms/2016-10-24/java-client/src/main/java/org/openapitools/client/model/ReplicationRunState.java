...
/**
 * Gets or Sets ReplicationRunState
 */
@JsonAdapter(ReplicationRunState.Adapter.class)
public enum ReplicationRunState {
  ...
  ReplicationRunState(String value) {
    this.value = value;
  }
  ...
  public static ReplicationRunState fromValue(String value) {
    for (ReplicationRunState b : ReplicationRunState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReplicationRunState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReplicationRunState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReplicationRunState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReplicationRunState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ReplicationRunState.fromValue(value);
  }
}
