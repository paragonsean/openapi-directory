 ...
 */
@JsonAdapter(ConnectorStatus.Adapter.class)
public enum ConnectorStatus {
  ...
  public static class Adapter extends TypeAdapter<ConnectorStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConnectorStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConnectorStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConnectorStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConnectorStatus.fromValue(value);
  }
}
