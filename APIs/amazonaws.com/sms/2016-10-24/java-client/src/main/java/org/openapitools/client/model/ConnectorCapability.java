...
/**
 * Gets or Sets ConnectorCapability
 */
@JsonAdapter(ConnectorCapability.Adapter.class)
public enum ConnectorCapability {
  ...
  ConnectorCapability(String value) {
    this.value = value;
  }
  ...
  public static ConnectorCapability fromValue(String value) {
    for (ConnectorCapability b : ConnectorCapability.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConnectorCapability> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConnectorCapability enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConnectorCapability read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConnectorCapability.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConnectorCapability.fromValue(value);
  }
}
