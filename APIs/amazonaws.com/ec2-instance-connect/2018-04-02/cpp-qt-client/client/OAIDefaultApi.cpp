...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://ec2-instance-connect.{region}.amazonaws.com"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://ec2-instance-connect.{region}.amazonaws.com"),
    "The EC2 Instance Connect multi-region endpoint",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","us-east-1",
    QSet<QString>{ {"us-east-1"},{"us-east-2"},{"us-west-1"},{"us-west-2"},{"us-gov-west-1"},{"us-gov-east-1"},{"ca-central-1"},{"eu-north-1"},{"eu-west-1"},{"eu-west-2"},{"eu-west-3"},{"eu-central-1"},{"eu-south-1"},{"af-south-1"},{"ap-northeast-1"},{"ap-northeast-2"},{"ap-northeast-3"},{"ap-southeast-1"},{"ap-southeast-2"},{"ap-east-1"},{"ap-south-1"},{"sa-east-1"},{"me-south-1"} })}, }));
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://ec2-instance-connect.{region}.amazonaws.com.cn"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://ec2-instance-connect.{region}.amazonaws.com.cn"),
    "The EC2 Instance Connect endpoint for China (Beijing) and China (Ningxia)",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","cn-north-1",
    QSet<QString>{ {"cn-north-1"},{"cn-northwest-1"} })}, }));
    
    _serverConfigs.insert("sendSSHPublicKey", defaultConf);
    _serverIndices.insert("sendSSHPublicKey", 0);
    _serverConfigs.insert("sendSerialConsoleSSHPublicKey", defaultConf);
    _serverIndices.insert("sendSerialConsoleSSHPublicKey", 0);
}
...
void OAIDefaultApi::sendSSHPublicKey(const QString &x_amz_target, const OAISendSSHPublicKeyRequest &oai_send_ssh_public_key_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
...

    {
        ...
        QByteArray output = oai_send_ssh_public_key_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::sendSSHPublicKeyCallback);
...
void OAIDefaultApi::sendSSHPublicKeyCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISendSSHPublicKeyResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sendSSHPublicKeySignal(output);
        Q_EMIT sendSSHPublicKeySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sendSSHPublicKeySignalE(output, error_type, error_str);
        Q_EMIT sendSSHPublicKeySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sendSSHPublicKeySignalError(output, error_type, error_str);
        Q_EMIT sendSSHPublicKeySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::sendSerialConsoleSSHPublicKey(const QString &x_amz_target, const OAISendSerialConsoleSSHPublicKeyRequest &oai_send_serial_console_ssh_public_key_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["sendSerialConsoleSSHPublicKey"][_serverIndices.value("sendSerialConsoleSSHPublicKey")].URL()+"/#X-Amz-Target=AWSEC2InstanceConnectService.SendSerialConsoleSSHPublicKey");
...

    {
        ...
        QByteArray output = oai_send_serial_console_ssh_public_key_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    if (x_amz_content_sha256.hasValue())
    {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::sendSerialConsoleSSHPublicKeyCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::sendSerialConsoleSSHPublicKeyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISendSerialConsoleSSHPublicKeyResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sendSerialConsoleSSHPublicKeySignal(output);
        Q_EMIT sendSerialConsoleSSHPublicKeySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sendSerialConsoleSSHPublicKeySignalE(output, error_type, error_str);
        Q_EMIT sendSerialConsoleSSHPublicKeySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sendSerialConsoleSSHPublicKeySignalError(output, error_type, error_str);
        Q_EMIT sendSerialConsoleSSHPublicKeySignalErrorFull(worker, error_type, error_str);
    }
}
