...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAISendSSHPublicKeyRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAISendSSHPublicKeyRequest Example::create(){
    OAISendSSHPublicKeyRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::sendSSHPublicKeySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::sendSSHPublicKeySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAISendSSHPublicKeyRequest oai_send_ssh_public_key_request = create(); // OAISendSSHPublicKeyRequest | 
      ...
      apiInstance.sendSSHPublicKey(x_amz_targetoai_send_ssh_public_key_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
