...
OAIDescribeServersRequest::OAIDescribeServersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeServersRequest::OAIDescribeServersRequest() {
    this->initializeModel();
}

OAIDescribeServersRequest::~OAIDescribeServersRequest() {}

void OAIDescribeServersRequest::initializeModel() {
...
void OAIDescribeServersRequest::fromJson(QString jsonString) {
...
void OAIDescribeServersRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeServersRequest::asJson() const {
...
QJsonObject OAIDescribeServersRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeServersRequest::getServerName() const {
    return m_server_name;
}
void OAIDescribeServersRequest::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIDescribeServersRequest::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIDescribeServersRequest::is_server_name_Valid() const{
    return m_server_name_isValid;
}

QString OAIDescribeServersRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeServersRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeServersRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeServersRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIDescribeServersRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeServersRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeServersRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeServersRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIDescribeServersRequest::isSet() const {
...
bool OAIDescribeServersRequest::isValid() const {
