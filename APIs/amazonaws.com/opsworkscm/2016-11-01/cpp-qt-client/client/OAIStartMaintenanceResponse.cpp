...
OAIStartMaintenanceResponse::OAIStartMaintenanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartMaintenanceResponse::OAIStartMaintenanceResponse() {
    this->initializeModel();
}

OAIStartMaintenanceResponse::~OAIStartMaintenanceResponse() {}

void OAIStartMaintenanceResponse::initializeModel() {

    m_server_isSet = false;
    m_server_isValid = false;
}

void OAIStartMaintenanceResponse::fromJson(QString jsonString) {
...
void OAIStartMaintenanceResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStartMaintenanceResponse::asJson() const {
...
QJsonObject OAIStartMaintenanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_server.isSet()) {
...
OAIStartMaintenanceResponse_Server OAIStartMaintenanceResponse::getServer() const {
    return m_server;
}
void OAIStartMaintenanceResponse::setServer(const OAIStartMaintenanceResponse_Server &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIStartMaintenanceResponse::is_server_Set() const{
    return m_server_isSet;
}

bool OAIStartMaintenanceResponse::is_server_Valid() const{
    return m_server_isValid;
}

bool OAIStartMaintenanceResponse::isSet() const {
...
bool OAIStartMaintenanceResponse::isValid() const {
