...
/*
 * OAIDescribeServersRequest.h
 *
 * 
 */

#ifndef OAIDescribeServersRequest_H
#define OAIDescribeServersRequest_H
...
class OAIDescribeServersRequest : public OAIObject {
public:
    OAIDescribeServersRequest();
    OAIDescribeServersRequest(QString json);
    ~OAIDescribeServersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeServersRequest)

#endif // OAIDescribeServersRequest_H
