...
OAIAssociateNodeResponse::OAIAssociateNodeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateNodeResponse::OAIAssociateNodeResponse() {
    this->initializeModel();
}

OAIAssociateNodeResponse::~OAIAssociateNodeResponse() {}

void OAIAssociateNodeResponse::initializeModel() {

    m_node_association_status_token_isSet = false;
    m_node_association_status_token_isValid = false;
}

void OAIAssociateNodeResponse::fromJson(QString jsonString) {
...
void OAIAssociateNodeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateNodeResponse::asJson() const {
...
QJsonObject OAIAssociateNodeResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateNodeResponse::getNodeAssociationStatusToken() const {
    return m_node_association_status_token;
}
void OAIAssociateNodeResponse::setNodeAssociationStatusToken(const QString &node_association_status_token) {
    m_node_association_status_token = node_association_status_token;
    m_node_association_status_token_isSet = true;
}

bool OAIAssociateNodeResponse::is_node_association_status_token_Set() const{
    return m_node_association_status_token_isSet;
}

bool OAIAssociateNodeResponse::is_node_association_status_token_Valid() const{
    return m_node_association_status_token_isValid;
}

bool OAIAssociateNodeResponse::isSet() const {
...
bool OAIAssociateNodeResponse::isValid() const {
