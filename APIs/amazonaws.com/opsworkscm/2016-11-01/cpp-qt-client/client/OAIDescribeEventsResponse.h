...
public:
    ...
    QList getServerEvents() const;
    void setServerEvents(const QList &server_events);
    bool is_server_events_Set() const;
    bool is_server_events_Valid() const;
...
private:
    ...
    QList m_server_events;
    bool m_server_events_isSet;
    bool m_server_events_isValid;
