...
OAIDeleteServerRequest::OAIDeleteServerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteServerRequest::OAIDeleteServerRequest() {
    this->initializeModel();
}

OAIDeleteServerRequest::~OAIDeleteServerRequest() {}

void OAIDeleteServerRequest::initializeModel() {

    m_server_name_isSet = false;
    m_server_name_isValid = false;
}

void OAIDeleteServerRequest::fromJson(QString jsonString) {
...
void OAIDeleteServerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteServerRequest::asJson() const {
...
QJsonObject OAIDeleteServerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteServerRequest::getServerName() const {
    return m_server_name;
}
void OAIDeleteServerRequest::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIDeleteServerRequest::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIDeleteServerRequest::is_server_name_Valid() const{
    return m_server_name_isValid;
}

bool OAIDeleteServerRequest::isSet() const {
...
bool OAIDeleteServerRequest::isValid() const {
