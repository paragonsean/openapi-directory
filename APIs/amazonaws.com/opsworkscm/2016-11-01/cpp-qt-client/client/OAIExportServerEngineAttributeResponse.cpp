...
OAIExportServerEngineAttributeResponse::OAIExportServerEngineAttributeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportServerEngineAttributeResponse::OAIExportServerEngineAttributeResponse() {
    this->initializeModel();
}

OAIExportServerEngineAttributeResponse::~OAIExportServerEngineAttributeResponse() {}

void OAIExportServerEngineAttributeResponse::initializeModel() {

    m_engine_attribute_isSet = false;
    m_engine_attribute_isValid = false;

    m_server_name_isSet = false;
    m_server_name_isValid = false;
}

void OAIExportServerEngineAttributeResponse::fromJson(QString jsonString) {
...
void OAIExportServerEngineAttributeResponse::fromJsonObject(QJsonObject json) {

    m_engine_attribute_isValid = ::OpenAPI::fromJsonValue(m_engine_attribute, json[QString("EngineAttribute")]);
    m_engine_attribute_isSet = !json[QString("EngineAttribute")].isNull() && m_engine_attribute_isValid;
...
QString OAIExportServerEngineAttributeResponse::asJson() const {
...
QJsonObject OAIExportServerEngineAttributeResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_engine_attribute.isSet()) {
        obj.insert(QString("EngineAttribute"), ::OpenAPI::toJsonValue(m_engine_attribute));
    }
...
OAIExportServerEngineAttributeResponse_EngineAttribute OAIExportServerEngineAttributeResponse::getEngineAttribute() const {
    return m_engine_attribute;
}
void OAIExportServerEngineAttributeResponse::setEngineAttribute(const OAIExportServerEngineAttributeResponse_EngineAttribute &engine_attribute) {
    m_engine_attribute = engine_attribute;
    m_engine_attribute_isSet = true;
}

bool OAIExportServerEngineAttributeResponse::is_engine_attribute_Set() const{
    return m_engine_attribute_isSet;
}

bool OAIExportServerEngineAttributeResponse::is_engine_attribute_Valid() const{
    return m_engine_attribute_isValid;
}

QString OAIExportServerEngineAttributeResponse::getServerName() const {
    return m_server_name;
}
void OAIExportServerEngineAttributeResponse::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIExportServerEngineAttributeResponse::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIExportServerEngineAttributeResponse::is_server_name_Valid() const{
    return m_server_name_isValid;
}

bool OAIExportServerEngineAttributeResponse::isSet() const {
...
bool OAIExportServerEngineAttributeResponse::isValid() const {
