...
/*
 * OAIDisassociateNodeResponse.h
 *
 * 
 */

#ifndef OAIDisassociateNodeResponse_H
#define OAIDisassociateNodeResponse_H
...
class OAIDisassociateNodeResponse : public OAIObject {
public:
    OAIDisassociateNodeResponse();
    OAIDisassociateNodeResponse(QString json);
    ~OAIDisassociateNodeResponse() override;
    ...
    QString getNodeAssociationStatusToken() const;
    void setNodeAssociationStatusToken(const QString &node_association_status_token);
    bool is_node_association_status_token_Set() const;
    bool is_node_association_status_token_Valid() const;
...
private:
    ...
    QString m_node_association_status_token;
    bool m_node_association_status_token_isSet;
    bool m_node_association_status_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateNodeResponse)

#endif // OAIDisassociateNodeResponse_H
