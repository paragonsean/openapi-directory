...
#include "OAIUpdateServerResponse_Server.h"
...
OAIUpdateServerResponse_Server::OAIUpdateServerResponse_Server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateServerResponse_Server::OAIUpdateServerResponse_Server() {
    this->initializeModel();
}

OAIUpdateServerResponse_Server::~OAIUpdateServerResponse_Server() {}

void OAIUpdateServerResponse_Server::initializeModel() {
...
void OAIUpdateServerResponse_Server::fromJson(QString jsonString) {
...
void OAIUpdateServerResponse_Server::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateServerResponse_Server::asJson() const {
...
QJsonObject OAIUpdateServerResponse_Server::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUpdateServerResponse_Server::getAssociatePublicIpAddress() const {
    return m_associate_public_ip_address;
}
void OAIUpdateServerResponse_Server::setAssociatePublicIpAddress(const bool &associate_public_ip_address) {
    m_associate_public_ip_address = associate_public_ip_address;
    m_associate_public_ip_address_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_associate_public_ip_address_Set() const{
    return m_associate_public_ip_address_isSet;
}

bool OAIUpdateServerResponse_Server::is_associate_public_ip_address_Valid() const{
    return m_associate_public_ip_address_isValid;
}

qint32 OAIUpdateServerResponse_Server::getBackupRetentionCount() const {
    return m_backup_retention_count;
}
void OAIUpdateServerResponse_Server::setBackupRetentionCount(const qint32 &backup_retention_count) {
    m_backup_retention_count = backup_retention_count;
    m_backup_retention_count_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_backup_retention_count_Set() const{
    return m_backup_retention_count_isSet;
}

bool OAIUpdateServerResponse_Server::is_backup_retention_count_Valid() const{
    return m_backup_retention_count_isValid;
}

QString OAIUpdateServerResponse_Server::getServerName() const {
    return m_server_name;
}
void OAIUpdateServerResponse_Server::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIUpdateServerResponse_Server::is_server_name_Valid() const{
    return m_server_name_isValid;
}

QDateTime OAIUpdateServerResponse_Server::getCreatedAt() const {
    return m_created_at;
}
void OAIUpdateServerResponse_Server::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIUpdateServerResponse_Server::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIUpdateServerResponse_Server::getCloudFormationStackArn() const {
    return m_cloud_formation_stack_arn;
}
void OAIUpdateServerResponse_Server::setCloudFormationStackArn(const QString &cloud_formation_stack_arn) {
    m_cloud_formation_stack_arn = cloud_formation_stack_arn;
    m_cloud_formation_stack_arn_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_cloud_formation_stack_arn_Set() const{
    return m_cloud_formation_stack_arn_isSet;
}

bool OAIUpdateServerResponse_Server::is_cloud_formation_stack_arn_Valid() const{
    return m_cloud_formation_stack_arn_isValid;
}

QString OAIUpdateServerResponse_Server::getCustomDomain() const {
    return m_custom_domain;
}
void OAIUpdateServerResponse_Server::setCustomDomain(const QString &custom_domain) {
    m_custom_domain = custom_domain;
    m_custom_domain_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_custom_domain_Set() const{
    return m_custom_domain_isSet;
}

bool OAIUpdateServerResponse_Server::is_custom_domain_Valid() const{
    return m_custom_domain_isValid;
}

bool OAIUpdateServerResponse_Server::getDisableAutomatedBackup() const {
    return m_disable_automated_backup;
}
void OAIUpdateServerResponse_Server::setDisableAutomatedBackup(const bool &disable_automated_backup) {
    m_disable_automated_backup = disable_automated_backup;
    m_disable_automated_backup_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_disable_automated_backup_Set() const{
    return m_disable_automated_backup_isSet;
}

bool OAIUpdateServerResponse_Server::is_disable_automated_backup_Valid() const{
    return m_disable_automated_backup_isValid;
}

QString OAIUpdateServerResponse_Server::getEndpoint() const {
    return m_endpoint;
}
void OAIUpdateServerResponse_Server::setEndpoint(const QString &endpoint) {
    m_endpoint = endpoint;
    m_endpoint_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_endpoint_Set() const{
    return m_endpoint_isSet;
}

bool OAIUpdateServerResponse_Server::is_endpoint_Valid() const{
    return m_endpoint_isValid;
}

QString OAIUpdateServerResponse_Server::getEngine() const {
    return m_engine;
}
void OAIUpdateServerResponse_Server::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIUpdateServerResponse_Server::is_engine_Valid() const{
    return m_engine_isValid;
}

QString OAIUpdateServerResponse_Server::getEngineModel() const {
    return m_engine_model;
}
void OAIUpdateServerResponse_Server::setEngineModel(const QString &engine_model) {
    m_engine_model = engine_model;
    m_engine_model_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_engine_model_Set() const{
    return m_engine_model_isSet;
}

bool OAIUpdateServerResponse_Server::is_engine_model_Valid() const{
    return m_engine_model_isValid;
}

QList OAIUpdateServerResponse_Server::getEngineAttributes() const {
    return m_engine_attributes;
}
void OAIUpdateServerResponse_Server::setEngineAttributes(const QList &engine_attributes) {
    m_engine_attributes = engine_attributes;
    m_engine_attributes_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_engine_attributes_Set() const{
    return m_engine_attributes_isSet;
}

bool OAIUpdateServerResponse_Server::is_engine_attributes_Valid() const{
    return m_engine_attributes_isValid;
}

QString OAIUpdateServerResponse_Server::getEngineVersion() const {
    return m_engine_version;
}
void OAIUpdateServerResponse_Server::setEngineVersion(const QString &engine_version) {
    m_engine_version = engine_version;
    m_engine_version_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_engine_version_Set() const{
    return m_engine_version_isSet;
}

bool OAIUpdateServerResponse_Server::is_engine_version_Valid() const{
    return m_engine_version_isValid;
}

QString OAIUpdateServerResponse_Server::getInstanceProfileArn() const {
    return m_instance_profile_arn;
}
void OAIUpdateServerResponse_Server::setInstanceProfileArn(const QString &instance_profile_arn) {
    m_instance_profile_arn = instance_profile_arn;
    m_instance_profile_arn_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_instance_profile_arn_Set() const{
    return m_instance_profile_arn_isSet;
}

bool OAIUpdateServerResponse_Server::is_instance_profile_arn_Valid() const{
    return m_instance_profile_arn_isValid;
}

QString OAIUpdateServerResponse_Server::getInstanceType() const {
    return m_instance_type;
}
void OAIUpdateServerResponse_Server::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIUpdateServerResponse_Server::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

QString OAIUpdateServerResponse_Server::getKeyPair() const {
    return m_key_pair;
}
void OAIUpdateServerResponse_Server::setKeyPair(const QString &key_pair) {
    m_key_pair = key_pair;
    m_key_pair_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_key_pair_Set() const{
    return m_key_pair_isSet;
}

bool OAIUpdateServerResponse_Server::is_key_pair_Valid() const{
    return m_key_pair_isValid;
}

OAIMaintenanceStatus OAIUpdateServerResponse_Server::getMaintenanceStatus() const {
    return m_maintenance_status;
}
void OAIUpdateServerResponse_Server::setMaintenanceStatus(const OAIMaintenanceStatus &maintenance_status) {
    m_maintenance_status = maintenance_status;
    m_maintenance_status_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_maintenance_status_Set() const{
    return m_maintenance_status_isSet;
}

bool OAIUpdateServerResponse_Server::is_maintenance_status_Valid() const{
    return m_maintenance_status_isValid;
}

QString OAIUpdateServerResponse_Server::getPreferredMaintenanceWindow() const {
    return m_preferred_maintenance_window;
}
void OAIUpdateServerResponse_Server::setPreferredMaintenanceWindow(const QString &preferred_maintenance_window) {
    m_preferred_maintenance_window = preferred_maintenance_window;
    m_preferred_maintenance_window_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_preferred_maintenance_window_Set() const{
    return m_preferred_maintenance_window_isSet;
}

bool OAIUpdateServerResponse_Server::is_preferred_maintenance_window_Valid() const{
    return m_preferred_maintenance_window_isValid;
}

QString OAIUpdateServerResponse_Server::getPreferredBackupWindow() const {
    return m_preferred_backup_window;
}
void OAIUpdateServerResponse_Server::setPreferredBackupWindow(const QString &preferred_backup_window) {
    m_preferred_backup_window = preferred_backup_window;
    m_preferred_backup_window_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_preferred_backup_window_Set() const{
    return m_preferred_backup_window_isSet;
}

bool OAIUpdateServerResponse_Server::is_preferred_backup_window_Valid() const{
    return m_preferred_backup_window_isValid;
}

QList OAIUpdateServerResponse_Server::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIUpdateServerResponse_Server::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIUpdateServerResponse_Server::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QString OAIUpdateServerResponse_Server::getServiceRoleArn() const {
    return m_service_role_arn;
}
void OAIUpdateServerResponse_Server::setServiceRoleArn(const QString &service_role_arn) {
    m_service_role_arn = service_role_arn;
    m_service_role_arn_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_service_role_arn_Set() const{
    return m_service_role_arn_isSet;
}

bool OAIUpdateServerResponse_Server::is_service_role_arn_Valid() const{
    return m_service_role_arn_isValid;
}

OAIServerStatus OAIUpdateServerResponse_Server::getStatus() const {
    return m_status;
}
void OAIUpdateServerResponse_Server::setStatus(const OAIServerStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateServerResponse_Server::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIUpdateServerResponse_Server::getStatusReason() const {
    return m_status_reason;
}
void OAIUpdateServerResponse_Server::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIUpdateServerResponse_Server::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QList OAIUpdateServerResponse_Server::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIUpdateServerResponse_Server::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIUpdateServerResponse_Server::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QString OAIUpdateServerResponse_Server::getServerArn() const {
    return m_server_arn;
}
void OAIUpdateServerResponse_Server::setServerArn(const QString &server_arn) {
    m_server_arn = server_arn;
    m_server_arn_isSet = true;
}

bool OAIUpdateServerResponse_Server::is_server_arn_Set() const{
    return m_server_arn_isSet;
}

bool OAIUpdateServerResponse_Server::is_server_arn_Valid() const{
    return m_server_arn_isValid;
}

bool OAIUpdateServerResponse_Server::isSet() const {
...
bool OAIUpdateServerResponse_Server::isValid() const {
