...
class OAIMaintenanceStatus : public OAIEnum {
public:
    ...
    enum class eOAIMaintenanceStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCESS, 
        FAILED
    };
    OAIMaintenanceStatus::eOAIMaintenanceStatus getValue() const;
    void setValue(const OAIMaintenanceStatus::eOAIMaintenanceStatus& value);
