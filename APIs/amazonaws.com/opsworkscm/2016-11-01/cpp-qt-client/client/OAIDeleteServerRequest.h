...
/*
 * OAIDeleteServerRequest.h
 *
 * 
 */

#ifndef OAIDeleteServerRequest_H
#define OAIDeleteServerRequest_H
...
class OAIDeleteServerRequest : public OAIObject {
public:
    OAIDeleteServerRequest();
    OAIDeleteServerRequest(QString json);
    ~OAIDeleteServerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteServerRequest)

#endif // OAIDeleteServerRequest_H
