...
/*
 * OAIStartMaintenanceResponse_Server.h
 *
 * 
 */

#ifndef OAIStartMaintenanceResponse_Server_H
#define OAIStartMaintenanceResponse_Server_H
...
class OAIStartMaintenanceResponse_Server : public OAIObject {
public:
    OAIStartMaintenanceResponse_Server();
    OAIStartMaintenanceResponse_Server(QString json);
    ~OAIStartMaintenanceResponse_Server() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMaintenanceResponse_Server)

#endif // OAIStartMaintenanceResponse_Server_H
