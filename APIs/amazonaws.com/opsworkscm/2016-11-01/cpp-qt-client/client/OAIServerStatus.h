...
class OAIServerStatus : public OAIEnum {
public:
    OAIServerStatus();
    ...
    OAIServerStatus::eOAIServerStatus getValue() const;
    void setValue(const OAIServerStatus::eOAIServerStatus& value);
