...
OAICreateServerResponse_Server OAICreateServerResponse::getServer() const {
    return m_server;
}
void OAICreateServerResponse::setServer(const OAICreateServerResponse_Server &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAICreateServerResponse::is_server_Set() const{
    return m_server_isSet;
}

bool OAICreateServerResponse::is_server_Valid() const{
