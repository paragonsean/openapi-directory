...
/*
 * OAICreateServerResponse.h
 *
 * 
 */

#ifndef OAICreateServerResponse_H
#define OAICreateServerResponse_H

#include <QJsonObject>

#include "OAICreateServerResponse_Server.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateServerResponse_Server;

class OAICreateServerResponse : public OAIObject {
public:
    OAICreateServerResponse();
    OAICreateServerResponse(QString json);
    ~OAICreateServerResponse() override;
    ...
    OAICreateServerResponse_Server getServer() const;
    void setServer(const OAICreateServerResponse_Server &server);
...
private:
    ...
    OAICreateServerResponse_Server m_server;
    bool m_server_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServerResponse)

#endif // OAICreateServerResponse_H
