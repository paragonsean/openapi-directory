...
void OAIBackupType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("AUTOMATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackupType::AUTOMATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MANUAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackupType::MANUAL;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIBackupType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIBackupType::AUTOMATED:
            val = "AUTOMATED";
            break;
        case eOAIBackupType::MANUAL:
            val = "MANUAL";
            break;
        default:
            break;
