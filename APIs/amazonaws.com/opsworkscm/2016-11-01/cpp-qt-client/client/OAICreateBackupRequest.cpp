...
QString OAICreateBackupRequest::getServerName() const {
    return m_server_name;
}
void OAICreateBackupRequest::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAICreateBackupRequest::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAICreateBackupRequest::is_server_name_Valid() const{
    return m_server_name_isValid;
}

QString OAICreateBackupRequest::getDescription() const {
    return m_description;
}
void OAICreateBackupRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateBackupRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateBackupRequest::is_description_Valid() const{
