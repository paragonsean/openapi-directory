...
OAIBackupStatus::OAIBackupStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackupStatus::OAIBackupStatus() {
    this->initializeModel();
}

OAIBackupStatus::~OAIBackupStatus() {}

void OAIBackupStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIBackupStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIBackupStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackupStatus::IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackupStatus::OK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackupStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackupStatus::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIBackupStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIBackupStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIBackupStatus::IN_PROGRESS:
            val = "IN_PROGRESS";
            break;
        case eOAIBackupStatus::OK:
            val = "OK";
            break;
        case eOAIBackupStatus::FAILED:
            val = "FAILED";
            break;
        case eOAIBackupStatus::DELETING:
            val = "DELETING";
            break;
        default:
            break;
...
QJsonValue OAIBackupStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIBackupStatus::eOAIBackupStatus OAIBackupStatus::getValue() const {
    return m_value;
}

void OAIBackupStatus::setValue(const OAIBackupStatus::eOAIBackupStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIBackupStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIBackupStatus::isValid() const {
