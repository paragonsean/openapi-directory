...
#ifndef OAINodeAssociationStatus_H
#define OAINodeAssociationStatus_H
...
class OAINodeAssociationStatus : public OAIEnum {
public:
    OAINodeAssociationStatus();
    OAINodeAssociationStatus(QString json);
    ~OAINodeAssociationStatus() override;
    ...
    enum class eOAINodeAssociationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCESS, 
        FAILED, 
        IN_PROGRESS
    };
    OAINodeAssociationStatus::eOAINodeAssociationStatus getValue() const;
    void setValue(const OAINodeAssociationStatus::eOAINodeAssociationStatus& value);
...
private:
    ...
    eOAINodeAssociationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeAssociationStatus)

#endif // OAINodeAssociationStatus_H
