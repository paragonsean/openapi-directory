...
/*
 * OAIStartMaintenanceResponse.h
 *
 * 
 */

#ifndef OAIStartMaintenanceResponse_H
#define OAIStartMaintenanceResponse_H
...
namespace OpenAPI {
class OAIStartMaintenanceResponse_Server;

class OAIStartMaintenanceResponse : public OAIObject {
public:
    OAIStartMaintenanceResponse();
    OAIStartMaintenanceResponse(QString json);
    ~OAIStartMaintenanceResponse() override;
    ...
    OAIStartMaintenanceResponse_Server getServer() const;
    void setServer(const OAIStartMaintenanceResponse_Server &server);
...
private:
    ...
    OAIStartMaintenanceResponse_Server m_server;
    bool m_server_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMaintenanceResponse)

#endif // OAIStartMaintenanceResponse_H
