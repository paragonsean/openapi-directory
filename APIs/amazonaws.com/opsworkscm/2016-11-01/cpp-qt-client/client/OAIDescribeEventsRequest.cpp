...
QString OAIDescribeEventsRequest::getServerName() const {
    return m_server_name;
}
void OAIDescribeEventsRequest::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIDescribeEventsRequest::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIDescribeEventsRequest::is_server_name_Valid() const{
