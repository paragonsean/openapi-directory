...
#ifndef OAIServerEvent_H
#define OAIServerEvent_H
...
class OAIServerEvent : public OAIObject {
public:
    OAIServerEvent();
    OAIServerEvent(QString json);
    ~OAIServerEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerEvent)

#endif // OAIServerEvent_H
