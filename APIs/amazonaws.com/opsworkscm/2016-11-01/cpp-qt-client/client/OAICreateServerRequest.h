...
/*
 * OAICreateServerRequest.h
 *
 * 
 */

#ifndef OAICreateServerRequest_H
#define OAICreateServerRequest_H
...
class OAICreateServerRequest : public OAIObject {
public:
    OAICreateServerRequest();
    OAICreateServerRequest(QString json);
    ~OAICreateServerRequest() override;
    ...
    QString getCustomCertificate() const;
    void setCustomCertificate(const QString &custom_certificate);
    bool is_custom_certificate_Set() const;
    bool is_custom_certificate_Valid() const;

    QString getCustomPrivateKey() const;
    void setCustomPrivateKey(const QString &custom_private_key);
    bool is_custom_private_key_Set() const;
    bool is_custom_private_key_Valid() const;
...
private:
    ...
    QString m_custom_certificate;
    bool m_custom_certificate_isSet;
    bool m_custom_certificate_isValid;

    QString m_custom_private_key;
    bool m_custom_private_key_isSet;
    bool m_custom_private_key_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServerRequest)

#endif // OAICreateServerRequest_H
