...
OAINodeAssociationStatus::OAINodeAssociationStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeAssociationStatus::OAINodeAssociationStatus() {
    this->initializeModel();
}

OAINodeAssociationStatus::~OAINodeAssociationStatus() {}

void OAINodeAssociationStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAINodeAssociationStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAINodeAssociationStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SUCCESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAINodeAssociationStatus::SUCCESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAINodeAssociationStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAINodeAssociationStatus::IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAINodeAssociationStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAINodeAssociationStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAINodeAssociationStatus::SUCCESS:
            val = "SUCCESS";
            break;
        case eOAINodeAssociationStatus::FAILED:
            val = "FAILED";
            break;
        case eOAINodeAssociationStatus::IN_PROGRESS:
            val = "IN_PROGRESS";
            break;
        default:
            break;
...
QJsonValue OAINodeAssociationStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAINodeAssociationStatus::eOAINodeAssociationStatus OAINodeAssociationStatus::getValue() const {
    return m_value;
}

void OAINodeAssociationStatus::setValue(const OAINodeAssociationStatus::eOAINodeAssociationStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAINodeAssociationStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAINodeAssociationStatus::isValid() const {
