...
void OAIMaintenanceStatus::initializeModel() {
    ...
    m_value = eOAIMaintenanceStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMaintenanceStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SUCCESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMaintenanceStatus::SUCCESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMaintenanceStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMaintenanceStatus::fromJsonValue(QJsonValue json) {
...
QString OAIMaintenanceStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIMaintenanceStatus::SUCCESS:
            val = "SUCCESS";
            break;
        case eOAIMaintenanceStatus::FAILED:
            val = "FAILED";
            break;
        default:
            break;
...
QJsonValue OAIMaintenanceStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMaintenanceStatus::eOAIMaintenanceStatus OAIMaintenanceStatus::getValue() const {
    return m_value;
}

void OAIMaintenanceStatus::setValue(const OAIMaintenanceStatus::eOAIMaintenanceStatus& value){
    m_value = value;
    m_value_isSet = true;
}
