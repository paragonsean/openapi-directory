...
namespace OpenAPI {
class OAIUpdateServerResponse_Server;
...
public:
    ...
    OAIUpdateServerResponse_Server getServer() const;
    void setServer(const OAIUpdateServerResponse_Server &server);
...
private:
    ...
    OAIUpdateServerResponse_Server m_server;
    bool m_server_isSet;
