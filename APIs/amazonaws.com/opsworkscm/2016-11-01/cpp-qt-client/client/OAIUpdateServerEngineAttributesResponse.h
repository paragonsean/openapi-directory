...
/*
 * OAIUpdateServerEngineAttributesResponse.h
 *
 * 
 */

#ifndef OAIUpdateServerEngineAttributesResponse_H
#define OAIUpdateServerEngineAttributesResponse_H
...
namespace OpenAPI {
class OAIUpdateServerEngineAttributesResponse_Server;

class OAIUpdateServerEngineAttributesResponse : public OAIObject {
public:
    OAIUpdateServerEngineAttributesResponse();
    OAIUpdateServerEngineAttributesResponse(QString json);
    ~OAIUpdateServerEngineAttributesResponse() override;
    ...
    OAIUpdateServerEngineAttributesResponse_Server getServer() const;
    void setServer(const OAIUpdateServerEngineAttributesResponse_Server &server);
...
private:
    ...
    OAIUpdateServerEngineAttributesResponse_Server m_server;
    bool m_server_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServerEngineAttributesResponse)

#endif // OAIUpdateServerEngineAttributesResponse_H
