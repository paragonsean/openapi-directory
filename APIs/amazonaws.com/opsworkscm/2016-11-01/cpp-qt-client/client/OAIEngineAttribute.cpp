...
OAIEngineAttribute::OAIEngineAttribute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEngineAttribute::OAIEngineAttribute() {
    this->initializeModel();
}

OAIEngineAttribute::~OAIEngineAttribute() {}

void OAIEngineAttribute::initializeModel() {
...
void OAIEngineAttribute::fromJson(QString jsonString) {
...
void OAIEngineAttribute::fromJsonObject(QJsonObject json) {
...
QString OAIEngineAttribute::asJson() const {
...
QJsonObject OAIEngineAttribute::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIEngineAttribute::getName() const {
    return m_name;
}
void OAIEngineAttribute::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIEngineAttribute::is_name_Set() const{
    return m_name_isSet;
}

bool OAIEngineAttribute::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIEngineAttribute::getValue() const {
    return m_value;
}
void OAIEngineAttribute::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIEngineAttribute::is_value_Set() const{
    return m_value_isSet;
}

bool OAIEngineAttribute::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIEngineAttribute::isSet() const {
...
bool OAIEngineAttribute::isValid() const {
