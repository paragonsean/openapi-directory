...
/*
 * OAIDescribeServersResponse.h
 *
 * 
 */

#ifndef OAIDescribeServersResponse_H
#define OAIDescribeServersResponse_H
...
class OAIDescribeServersResponse : public OAIObject {
public:
    OAIDescribeServersResponse();
    OAIDescribeServersResponse(QString json);
    ~OAIDescribeServersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeServersResponse)

#endif // OAIDescribeServersResponse_H
