...
/*
 * OAIStartMaintenanceRequest.h
 *
 * 
 */

#ifndef OAIStartMaintenanceRequest_H
#define OAIStartMaintenanceRequest_H
...
class OAIStartMaintenanceRequest : public OAIObject {
public:
    OAIStartMaintenanceRequest();
    OAIStartMaintenanceRequest(QString json);
    ~OAIStartMaintenanceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMaintenanceRequest)

#endif // OAIStartMaintenanceRequest_H
