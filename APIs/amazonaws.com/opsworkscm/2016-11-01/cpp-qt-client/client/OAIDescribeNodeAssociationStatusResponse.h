...
/*
 * OAIDescribeNodeAssociationStatusResponse.h
 *
 * 
 */

#ifndef OAIDescribeNodeAssociationStatusResponse_H
#define OAIDescribeNodeAssociationStatusResponse_H

#include <QJsonObject>

#include "OAINodeAssociationStatus.h"
#include <QList>
...
class OAIDescribeNodeAssociationStatusResponse : public OAIObject {
public:
    OAIDescribeNodeAssociationStatusResponse();
    OAIDescribeNodeAssociationStatusResponse(QString json);
    ~OAIDescribeNodeAssociationStatusResponse() override;
    ...
    OAINodeAssociationStatus getNodeAssociationStatus() const;
    void setNodeAssociationStatus(const OAINodeAssociationStatus &node_association_status);
    bool is_node_association_status_Set() const;
    bool is_node_association_status_Valid() const;
...
private:
    ...
    OAINodeAssociationStatus m_node_association_status;
    bool m_node_association_status_isSet;
    bool m_node_association_status_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeNodeAssociationStatusResponse)

#endif // OAIDescribeNodeAssociationStatusResponse_H
