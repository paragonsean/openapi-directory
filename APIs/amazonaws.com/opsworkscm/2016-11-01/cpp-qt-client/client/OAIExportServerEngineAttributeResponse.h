...
/*
 * OAIExportServerEngineAttributeResponse.h
 *
 * 
 */

#ifndef OAIExportServerEngineAttributeResponse_H
#define OAIExportServerEngineAttributeResponse_H
...
namespace OpenAPI {
class OAIExportServerEngineAttributeResponse_EngineAttribute;

class OAIExportServerEngineAttributeResponse : public OAIObject {
public:
    OAIExportServerEngineAttributeResponse();
    OAIExportServerEngineAttributeResponse(QString json);
    ~OAIExportServerEngineAttributeResponse() override;
    ...
    OAIExportServerEngineAttributeResponse_EngineAttribute getEngineAttribute() const;
    void setEngineAttribute(const OAIExportServerEngineAttributeResponse_EngineAttribute &engine_attribute);
    bool is_engine_attribute_Set() const;
    bool is_engine_attribute_Valid() const;
...
private:
    ...
    OAIExportServerEngineAttributeResponse_EngineAttribute m_engine_attribute;
    bool m_engine_attribute_isSet;
    bool m_engine_attribute_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportServerEngineAttributeResponse)

#endif // OAIExportServerEngineAttributeResponse_H
