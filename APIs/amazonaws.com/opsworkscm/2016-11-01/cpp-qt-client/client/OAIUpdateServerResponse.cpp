...
OAIUpdateServerResponse::OAIUpdateServerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateServerResponse::OAIUpdateServerResponse() {
    this->initializeModel();
}

OAIUpdateServerResponse::~OAIUpdateServerResponse() {}

void OAIUpdateServerResponse::initializeModel() {

    m_server_isSet = false;
    m_server_isValid = false;
}

void OAIUpdateServerResponse::fromJson(QString jsonString) {
...
void OAIUpdateServerResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateServerResponse::asJson() const {
...
QJsonObject OAIUpdateServerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_server.isSet()) {
...
OAIUpdateServerResponse_Server OAIUpdateServerResponse::getServer() const {
    return m_server;
}
void OAIUpdateServerResponse::setServer(const OAIUpdateServerResponse_Server &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIUpdateServerResponse::is_server_Set() const{
    return m_server_isSet;
}

bool OAIUpdateServerResponse::is_server_Valid() const{
    return m_server_isValid;
}

bool OAIUpdateServerResponse::isSet() const {
...
bool OAIUpdateServerResponse::isValid() const {
