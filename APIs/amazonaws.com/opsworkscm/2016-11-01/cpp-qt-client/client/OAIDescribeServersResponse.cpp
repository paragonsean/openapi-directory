...
OAIDescribeServersResponse::OAIDescribeServersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeServersResponse::OAIDescribeServersResponse() {
    this->initializeModel();
}

OAIDescribeServersResponse::~OAIDescribeServersResponse() {}

void OAIDescribeServersResponse::initializeModel() {
...
void OAIDescribeServersResponse::fromJson(QString jsonString) {
...
void OAIDescribeServersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeServersResponse::asJson() const {
...
QJsonObject OAIDescribeServersResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_servers.isSet()) {
...
QList OAIDescribeServersResponse::getServers() const {
    return m_servers;
}
void OAIDescribeServersResponse::setServers(const QList &servers) {
    m_servers = servers;
    m_servers_isSet = true;
}

bool OAIDescribeServersResponse::is_servers_Set() const{
    return m_servers_isSet;
}

bool OAIDescribeServersResponse::is_servers_Valid() const{
    return m_servers_isValid;
}

QString OAIDescribeServersResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeServersResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeServersResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeServersResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeServersResponse::isSet() const {
...
bool OAIDescribeServersResponse::isValid() const {
