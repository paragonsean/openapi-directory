...
/*
 * OAIExportServerEngineAttributeRequest.h
 *
 * 
 */

#ifndef OAIExportServerEngineAttributeRequest_H
#define OAIExportServerEngineAttributeRequest_H
...
class OAIExportServerEngineAttributeRequest : public OAIObject {
public:
    OAIExportServerEngineAttributeRequest();
    OAIExportServerEngineAttributeRequest(QString json);
    ~OAIExportServerEngineAttributeRequest() override;
    ...
    QString getExportAttributeName() const;
    void setExportAttributeName(const QString &export_attribute_name);
    bool is_export_attribute_name_Set() const;
    bool is_export_attribute_name_Valid() const;
    ...
    QList getInputAttributes() const;
    void setInputAttributes(const QList &input_attributes);
    bool is_input_attributes_Set() const;
    bool is_input_attributes_Valid() const;
...
private:
    ...
    QString m_export_attribute_name;
    bool m_export_attribute_name_isSet;
    bool m_export_attribute_name_isValid;

    QString m_server_name;
    bool m_server_name_isSet;
    bool m_server_name_isValid;

    QList m_input_attributes;
    bool m_input_attributes_isSet;
    bool m_input_attributes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIExportServerEngineAttributeRequest)

#endif // OAIExportServerEngineAttributeRequest_H
