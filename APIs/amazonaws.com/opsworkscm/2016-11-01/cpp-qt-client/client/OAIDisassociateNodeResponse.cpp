...
OAIDisassociateNodeResponse::OAIDisassociateNodeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateNodeResponse::OAIDisassociateNodeResponse() {
    this->initializeModel();
}

OAIDisassociateNodeResponse::~OAIDisassociateNodeResponse() {}

void OAIDisassociateNodeResponse::initializeModel() {

    m_node_association_status_token_isSet = false;
    m_node_association_status_token_isValid = false;
}

void OAIDisassociateNodeResponse::fromJson(QString jsonString) {
...
void OAIDisassociateNodeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateNodeResponse::asJson() const {
...
QJsonObject OAIDisassociateNodeResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateNodeResponse::getNodeAssociationStatusToken() const {
    return m_node_association_status_token;
}
void OAIDisassociateNodeResponse::setNodeAssociationStatusToken(const QString &node_association_status_token) {
    m_node_association_status_token = node_association_status_token;
    m_node_association_status_token_isSet = true;
}

bool OAIDisassociateNodeResponse::is_node_association_status_token_Set() const{
    return m_node_association_status_token_isSet;
}

bool OAIDisassociateNodeResponse::is_node_association_status_token_Valid() const{
    return m_node_association_status_token_isValid;
}

bool OAIDisassociateNodeResponse::isSet() const {
...
bool OAIDisassociateNodeResponse::isValid() const {
