...
OAIDisassociateNodeRequest::OAIDisassociateNodeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateNodeRequest::OAIDisassociateNodeRequest() {
    this->initializeModel();
}

OAIDisassociateNodeRequest::~OAIDisassociateNodeRequest() {}

void OAIDisassociateNodeRequest::initializeModel() {
...
void OAIDisassociateNodeRequest::fromJson(QString jsonString) {
...
void OAIDisassociateNodeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateNodeRequest::asJson() const {
...
QJsonObject OAIDisassociateNodeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateNodeRequest::getServerName() const {
    return m_server_name;
}
void OAIDisassociateNodeRequest::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIDisassociateNodeRequest::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIDisassociateNodeRequest::is_server_name_Valid() const{
    return m_server_name_isValid;
}

QString OAIDisassociateNodeRequest::getNodeName() const {
    return m_node_name;
}
void OAIDisassociateNodeRequest::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAIDisassociateNodeRequest::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAIDisassociateNodeRequest::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QList OAIDisassociateNodeRequest::getEngineAttributes() const {
    return m_engine_attributes;
}
void OAIDisassociateNodeRequest::setEngineAttributes(const QList &engine_attributes) {
    m_engine_attributes = engine_attributes;
    m_engine_attributes_isSet = true;
}

bool OAIDisassociateNodeRequest::is_engine_attributes_Set() const{
    return m_engine_attributes_isSet;
}

bool OAIDisassociateNodeRequest::is_engine_attributes_Valid() const{
    return m_engine_attributes_isValid;
}

bool OAIDisassociateNodeRequest::isSet() const {
...
bool OAIDisassociateNodeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_server_name_isValid && m_node_name_isValid && true;
}
