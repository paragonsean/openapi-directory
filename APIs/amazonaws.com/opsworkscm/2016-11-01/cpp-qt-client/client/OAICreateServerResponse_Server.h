...
/*
 * OAICreateServerResponse_Server.h
 *
 * 
 */

#ifndef OAICreateServerResponse_Server_H
#define OAICreateServerResponse_Server_H
...
class OAICreateServerResponse_Server : public OAIObject {
public:
    OAICreateServerResponse_Server();
    OAICreateServerResponse_Server(QString json);
    ~OAICreateServerResponse_Server() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServerResponse_Server)

#endif // OAICreateServerResponse_Server_H
