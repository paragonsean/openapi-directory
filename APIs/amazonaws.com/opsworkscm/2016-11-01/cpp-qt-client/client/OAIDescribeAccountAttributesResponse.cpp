...
OAIDescribeAccountAttributesResponse::OAIDescribeAccountAttributesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAccountAttributesResponse::OAIDescribeAccountAttributesResponse() {
    this->initializeModel();
}

OAIDescribeAccountAttributesResponse::~OAIDescribeAccountAttributesResponse() {}

void OAIDescribeAccountAttributesResponse::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAIDescribeAccountAttributesResponse::fromJson(QString jsonString) {
...
void OAIDescribeAccountAttributesResponse::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("Attributes")]);
    m_attributes_isSet = !json[QString("Attributes")].isNull() && m_attributes_isValid;
}

QString OAIDescribeAccountAttributesResponse::asJson() const {
...
QJsonObject OAIDescribeAccountAttributesResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeAccountAttributesResponse::getAttributes() const {
    return m_attributes;
}
void OAIDescribeAccountAttributesResponse::setAttributes(const QList &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIDescribeAccountAttributesResponse::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIDescribeAccountAttributesResponse::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIDescribeAccountAttributesResponse::isSet() const {
...
bool OAIDescribeAccountAttributesResponse::isValid() const {
