...
void OAIDescribeEventsResponse::initializeModel() {
    ...
    m_server_events_isSet = false;
    m_server_events_isValid = false;
...
void OAIDescribeEventsResponse::fromJsonObject(QJsonObject json) {
    ...
    m_server_events_isValid = ::OpenAPI::fromJsonValue(m_server_events, json[QString("ServerEvents")]);
    m_server_events_isSet = !json[QString("ServerEvents")].isNull() && m_server_events_isValid;
...
QJsonObject OAIDescribeEventsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_server_events.isSet()) {
        obj.insert(QString("ServerEvents"), ::OpenAPI::toJsonValue(m_server_events));
    }
...
QList OAIDescribeEventsResponse::getServerEvents() const {
    return m_server_events;
}
void OAIDescribeEventsResponse::setServerEvents(const QList &server_events) {
    m_server_events = server_events;
    m_server_events_isSet = true;
}

bool OAIDescribeEventsResponse::is_server_events_Set() const{
    return m_server_events_isSet;
}

bool OAIDescribeEventsResponse::is_server_events_Valid() const{
    return m_server_events_isValid;
}
