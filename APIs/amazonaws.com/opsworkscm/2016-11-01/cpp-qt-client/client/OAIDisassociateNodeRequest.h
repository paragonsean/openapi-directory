...
/*
 * OAIDisassociateNodeRequest.h
 *
 * 
 */

#ifndef OAIDisassociateNodeRequest_H
#define OAIDisassociateNodeRequest_H
...
class OAIDisassociateNodeRequest : public OAIObject {
public:
    OAIDisassociateNodeRequest();
    OAIDisassociateNodeRequest(QString json);
    ~OAIDisassociateNodeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateNodeRequest)

#endif // OAIDisassociateNodeRequest_H
