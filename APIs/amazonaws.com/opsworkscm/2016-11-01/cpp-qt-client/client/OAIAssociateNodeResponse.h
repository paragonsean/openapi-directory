...
/*
 * OAIAssociateNodeResponse.h
 *
 * 
 */

#ifndef OAIAssociateNodeResponse_H
#define OAIAssociateNodeResponse_H
...
class OAIAssociateNodeResponse : public OAIObject {
public:
    OAIAssociateNodeResponse();
    OAIAssociateNodeResponse(QString json);
    ~OAIAssociateNodeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateNodeResponse)

#endif // OAIAssociateNodeResponse_H
