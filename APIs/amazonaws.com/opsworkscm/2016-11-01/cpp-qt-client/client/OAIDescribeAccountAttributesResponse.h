...
/*
 * OAIDescribeAccountAttributesResponse.h
 *
 * 
 */

#ifndef OAIDescribeAccountAttributesResponse_H
#define OAIDescribeAccountAttributesResponse_H
...
class OAIDescribeAccountAttributesResponse : public OAIObject {
public:
    OAIDescribeAccountAttributesResponse();
    OAIDescribeAccountAttributesResponse(QString json);
    ~OAIDescribeAccountAttributesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountAttributesResponse)

#endif // OAIDescribeAccountAttributesResponse_H
