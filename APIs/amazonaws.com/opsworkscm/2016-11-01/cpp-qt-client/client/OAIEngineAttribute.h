...
/*
 * OAIEngineAttribute.h
 *
 * A name and value pair that is specific to the engine of the server. 
 */

#ifndef OAIEngineAttribute_H
#define OAIEngineAttribute_H
...
class OAIEngineAttribute : public OAIObject {
public:
    OAIEngineAttribute();
    OAIEngineAttribute(QString json);
    ~OAIEngineAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEngineAttribute)

#endif // OAIEngineAttribute_H
