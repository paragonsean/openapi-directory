...
OAIAssociateNodeRequest::OAIAssociateNodeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateNodeRequest::OAIAssociateNodeRequest() {
    this->initializeModel();
}

OAIAssociateNodeRequest::~OAIAssociateNodeRequest() {}

void OAIAssociateNodeRequest::initializeModel() {
...
void OAIAssociateNodeRequest::fromJson(QString jsonString) {
...
void OAIAssociateNodeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateNodeRequest::asJson() const {
...
QJsonObject OAIAssociateNodeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateNodeRequest::getServerName() const {
    return m_server_name;
}
void OAIAssociateNodeRequest::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIAssociateNodeRequest::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIAssociateNodeRequest::is_server_name_Valid() const{
    return m_server_name_isValid;
}

QString OAIAssociateNodeRequest::getNodeName() const {
    return m_node_name;
}
void OAIAssociateNodeRequest::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAIAssociateNodeRequest::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAIAssociateNodeRequest::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QList OAIAssociateNodeRequest::getEngineAttributes() const {
    return m_engine_attributes;
}
void OAIAssociateNodeRequest::setEngineAttributes(const QList &engine_attributes) {
    m_engine_attributes = engine_attributes;
    m_engine_attributes_isSet = true;
}

bool OAIAssociateNodeRequest::is_engine_attributes_Set() const{
    return m_engine_attributes_isSet;
}

bool OAIAssociateNodeRequest::is_engine_attributes_Valid() const{
    return m_engine_attributes_isValid;
}

bool OAIAssociateNodeRequest::isSet() const {
...
bool OAIAssociateNodeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_server_name_isValid && m_node_name_isValid && m_engine_attributes_isValid && true;
}
