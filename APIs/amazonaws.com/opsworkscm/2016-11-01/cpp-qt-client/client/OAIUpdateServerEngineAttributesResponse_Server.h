...
/*
 * OAIUpdateServerEngineAttributesResponse_Server.h
 *
 * 
 */

#ifndef OAIUpdateServerEngineAttributesResponse_Server_H
#define OAIUpdateServerEngineAttributesResponse_Server_H
...
class OAIUpdateServerEngineAttributesResponse_Server : public OAIObject {
public:
    OAIUpdateServerEngineAttributesResponse_Server();
    OAIUpdateServerEngineAttributesResponse_Server(QString json);
    ~OAIUpdateServerEngineAttributesResponse_Server() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServerEngineAttributesResponse_Server)

#endif // OAIUpdateServerEngineAttributesResponse_Server_H
