...
OAIDescribeNodeAssociationStatusResponse::OAIDescribeNodeAssociationStatusResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeNodeAssociationStatusResponse::OAIDescribeNodeAssociationStatusResponse() {
    this->initializeModel();
}

OAIDescribeNodeAssociationStatusResponse::~OAIDescribeNodeAssociationStatusResponse() {}

void OAIDescribeNodeAssociationStatusResponse::initializeModel() {

    m_node_association_status_isSet = false;
    m_node_association_status_isValid = false;

    m_engine_attributes_isSet = false;
    m_engine_attributes_isValid = false;
}

void OAIDescribeNodeAssociationStatusResponse::fromJson(QString jsonString) {
...
void OAIDescribeNodeAssociationStatusResponse::fromJsonObject(QJsonObject json) {

    m_node_association_status_isValid = ::OpenAPI::fromJsonValue(m_node_association_status, json[QString("NodeAssociationStatus")]);
    m_node_association_status_isSet = !json[QString("NodeAssociationStatus")].isNull() && m_node_association_status_isValid;
...
QString OAIDescribeNodeAssociationStatusResponse::asJson() const {
...
QJsonObject OAIDescribeNodeAssociationStatusResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_node_association_status.isSet()) {
        obj.insert(QString("NodeAssociationStatus"), ::OpenAPI::toJsonValue(m_node_association_status));
    }
...
OAINodeAssociationStatus OAIDescribeNodeAssociationStatusResponse::getNodeAssociationStatus() const {
    return m_node_association_status;
}
void OAIDescribeNodeAssociationStatusResponse::setNodeAssociationStatus(const OAINodeAssociationStatus &node_association_status) {
    m_node_association_status = node_association_status;
    m_node_association_status_isSet = true;
}

bool OAIDescribeNodeAssociationStatusResponse::is_node_association_status_Set() const{
    return m_node_association_status_isSet;
}

bool OAIDescribeNodeAssociationStatusResponse::is_node_association_status_Valid() const{
    return m_node_association_status_isValid;
}

QList OAIDescribeNodeAssociationStatusResponse::getEngineAttributes() const {
    return m_engine_attributes;
}
void OAIDescribeNodeAssociationStatusResponse::setEngineAttributes(const QList &engine_attributes) {
    m_engine_attributes = engine_attributes;
    m_engine_attributes_isSet = true;
}

bool OAIDescribeNodeAssociationStatusResponse::is_engine_attributes_Set() const{
    return m_engine_attributes_isSet;
}

bool OAIDescribeNodeAssociationStatusResponse::is_engine_attributes_Valid() const{
    return m_engine_attributes_isValid;
}

bool OAIDescribeNodeAssociationStatusResponse::isSet() const {
...
bool OAIDescribeNodeAssociationStatusResponse::isValid() const {
