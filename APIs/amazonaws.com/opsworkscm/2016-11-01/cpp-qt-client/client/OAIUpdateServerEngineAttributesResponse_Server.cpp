...
#include "OAIUpdateServerEngineAttributesResponse_Server.h"
...
OAIUpdateServerEngineAttributesResponse_Server::OAIUpdateServerEngineAttributesResponse_Server(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateServerEngineAttributesResponse_Server::OAIUpdateServerEngineAttributesResponse_Server() {
    this->initializeModel();
}

OAIUpdateServerEngineAttributesResponse_Server::~OAIUpdateServerEngineAttributesResponse_Server() {}

void OAIUpdateServerEngineAttributesResponse_Server::initializeModel() {
...
void OAIUpdateServerEngineAttributesResponse_Server::fromJson(QString jsonString) {
...
void OAIUpdateServerEngineAttributesResponse_Server::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateServerEngineAttributesResponse_Server::asJson() const {
...
QJsonObject OAIUpdateServerEngineAttributesResponse_Server::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUpdateServerEngineAttributesResponse_Server::getAssociatePublicIpAddress() const {
    return m_associate_public_ip_address;
}
void OAIUpdateServerEngineAttributesResponse_Server::setAssociatePublicIpAddress(const bool &associate_public_ip_address) {
    m_associate_public_ip_address = associate_public_ip_address;
    m_associate_public_ip_address_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_associate_public_ip_address_Set() const{
    return m_associate_public_ip_address_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_associate_public_ip_address_Valid() const{
    return m_associate_public_ip_address_isValid;
}

qint32 OAIUpdateServerEngineAttributesResponse_Server::getBackupRetentionCount() const {
    return m_backup_retention_count;
}
void OAIUpdateServerEngineAttributesResponse_Server::setBackupRetentionCount(const qint32 &backup_retention_count) {
    m_backup_retention_count = backup_retention_count;
    m_backup_retention_count_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_backup_retention_count_Set() const{
    return m_backup_retention_count_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_backup_retention_count_Valid() const{
    return m_backup_retention_count_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getServerName() const {
    return m_server_name;
}
void OAIUpdateServerEngineAttributesResponse_Server::setServerName(const QString &server_name) {
    m_server_name = server_name;
    m_server_name_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_server_name_Set() const{
    return m_server_name_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_server_name_Valid() const{
    return m_server_name_isValid;
}

QDateTime OAIUpdateServerEngineAttributesResponse_Server::getCreatedAt() const {
    return m_created_at;
}
void OAIUpdateServerEngineAttributesResponse_Server::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getCloudFormationStackArn() const {
    return m_cloud_formation_stack_arn;
}
void OAIUpdateServerEngineAttributesResponse_Server::setCloudFormationStackArn(const QString &cloud_formation_stack_arn) {
    m_cloud_formation_stack_arn = cloud_formation_stack_arn;
    m_cloud_formation_stack_arn_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_cloud_formation_stack_arn_Set() const{
    return m_cloud_formation_stack_arn_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_cloud_formation_stack_arn_Valid() const{
    return m_cloud_formation_stack_arn_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getCustomDomain() const {
    return m_custom_domain;
}
void OAIUpdateServerEngineAttributesResponse_Server::setCustomDomain(const QString &custom_domain) {
    m_custom_domain = custom_domain;
    m_custom_domain_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_custom_domain_Set() const{
    return m_custom_domain_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_custom_domain_Valid() const{
    return m_custom_domain_isValid;
}

bool OAIUpdateServerEngineAttributesResponse_Server::getDisableAutomatedBackup() const {
    return m_disable_automated_backup;
}
void OAIUpdateServerEngineAttributesResponse_Server::setDisableAutomatedBackup(const bool &disable_automated_backup) {
    m_disable_automated_backup = disable_automated_backup;
    m_disable_automated_backup_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_disable_automated_backup_Set() const{
    return m_disable_automated_backup_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_disable_automated_backup_Valid() const{
    return m_disable_automated_backup_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getEndpoint() const {
    return m_endpoint;
}
void OAIUpdateServerEngineAttributesResponse_Server::setEndpoint(const QString &endpoint) {
    m_endpoint = endpoint;
    m_endpoint_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_endpoint_Set() const{
    return m_endpoint_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_endpoint_Valid() const{
    return m_endpoint_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getEngine() const {
    return m_engine;
}
void OAIUpdateServerEngineAttributesResponse_Server::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_Valid() const{
    return m_engine_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getEngineModel() const {
    return m_engine_model;
}
void OAIUpdateServerEngineAttributesResponse_Server::setEngineModel(const QString &engine_model) {
    m_engine_model = engine_model;
    m_engine_model_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_model_Set() const{
    return m_engine_model_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_model_Valid() const{
    return m_engine_model_isValid;
}

QList OAIUpdateServerEngineAttributesResponse_Server::getEngineAttributes() const {
    return m_engine_attributes;
}
void OAIUpdateServerEngineAttributesResponse_Server::setEngineAttributes(const QList &engine_attributes) {
    m_engine_attributes = engine_attributes;
    m_engine_attributes_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_attributes_Set() const{
    return m_engine_attributes_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_attributes_Valid() const{
    return m_engine_attributes_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getEngineVersion() const {
    return m_engine_version;
}
void OAIUpdateServerEngineAttributesResponse_Server::setEngineVersion(const QString &engine_version) {
    m_engine_version = engine_version;
    m_engine_version_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_version_Set() const{
    return m_engine_version_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_engine_version_Valid() const{
    return m_engine_version_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getInstanceProfileArn() const {
    return m_instance_profile_arn;
}
void OAIUpdateServerEngineAttributesResponse_Server::setInstanceProfileArn(const QString &instance_profile_arn) {
    m_instance_profile_arn = instance_profile_arn;
    m_instance_profile_arn_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_instance_profile_arn_Set() const{
    return m_instance_profile_arn_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_instance_profile_arn_Valid() const{
    return m_instance_profile_arn_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getInstanceType() const {
    return m_instance_type;
}
void OAIUpdateServerEngineAttributesResponse_Server::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getKeyPair() const {
    return m_key_pair;
}
void OAIUpdateServerEngineAttributesResponse_Server::setKeyPair(const QString &key_pair) {
    m_key_pair = key_pair;
    m_key_pair_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_key_pair_Set() const{
    return m_key_pair_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_key_pair_Valid() const{
    return m_key_pair_isValid;
}

OAIMaintenanceStatus OAIUpdateServerEngineAttributesResponse_Server::getMaintenanceStatus() const {
    return m_maintenance_status;
}
void OAIUpdateServerEngineAttributesResponse_Server::setMaintenanceStatus(const OAIMaintenanceStatus &maintenance_status) {
    m_maintenance_status = maintenance_status;
    m_maintenance_status_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_maintenance_status_Set() const{
    return m_maintenance_status_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_maintenance_status_Valid() const{
    return m_maintenance_status_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getPreferredMaintenanceWindow() const {
    return m_preferred_maintenance_window;
}
void OAIUpdateServerEngineAttributesResponse_Server::setPreferredMaintenanceWindow(const QString &preferred_maintenance_window) {
    m_preferred_maintenance_window = preferred_maintenance_window;
    m_preferred_maintenance_window_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_preferred_maintenance_window_Set() const{
    return m_preferred_maintenance_window_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_preferred_maintenance_window_Valid() const{
    return m_preferred_maintenance_window_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getPreferredBackupWindow() const {
    return m_preferred_backup_window;
}
void OAIUpdateServerEngineAttributesResponse_Server::setPreferredBackupWindow(const QString &preferred_backup_window) {
    m_preferred_backup_window = preferred_backup_window;
    m_preferred_backup_window_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_preferred_backup_window_Set() const{
    return m_preferred_backup_window_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_preferred_backup_window_Valid() const{
    return m_preferred_backup_window_isValid;
}

QList OAIUpdateServerEngineAttributesResponse_Server::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIUpdateServerEngineAttributesResponse_Server::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getServiceRoleArn() const {
    return m_service_role_arn;
}
void OAIUpdateServerEngineAttributesResponse_Server::setServiceRoleArn(const QString &service_role_arn) {
    m_service_role_arn = service_role_arn;
    m_service_role_arn_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_service_role_arn_Set() const{
    return m_service_role_arn_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_service_role_arn_Valid() const{
    return m_service_role_arn_isValid;
}

OAIServerStatus OAIUpdateServerEngineAttributesResponse_Server::getStatus() const {
    return m_status;
}
void OAIUpdateServerEngineAttributesResponse_Server::setStatus(const OAIServerStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getStatusReason() const {
    return m_status_reason;
}
void OAIUpdateServerEngineAttributesResponse_Server::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QList OAIUpdateServerEngineAttributesResponse_Server::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIUpdateServerEngineAttributesResponse_Server::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QString OAIUpdateServerEngineAttributesResponse_Server::getServerArn() const {
    return m_server_arn;
}
void OAIUpdateServerEngineAttributesResponse_Server::setServerArn(const QString &server_arn) {
    m_server_arn = server_arn;
    m_server_arn_isSet = true;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_server_arn_Set() const{
    return m_server_arn_isSet;
}

bool OAIUpdateServerEngineAttributesResponse_Server::is_server_arn_Valid() const{
    return m_server_arn_isValid;
}

bool OAIUpdateServerEngineAttributesResponse_Server::isSet() const {
...
bool OAIUpdateServerEngineAttributesResponse_Server::isValid() const {
