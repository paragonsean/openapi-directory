...
/*
 * OAIUpdateServerEngineAttributesRequest.h
 *
 * 
 */

#ifndef OAIUpdateServerEngineAttributesRequest_H
#define OAIUpdateServerEngineAttributesRequest_H
...
class OAIUpdateServerEngineAttributesRequest : public OAIObject {
public:
    OAIUpdateServerEngineAttributesRequest();
    OAIUpdateServerEngineAttributesRequest(QString json);
    ~OAIUpdateServerEngineAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServerEngineAttributesRequest)

#endif // OAIUpdateServerEngineAttributesRequest_H
