...
/*
 * OAIAssociateNodeRequest.h
 *
 * 
 */

#ifndef OAIAssociateNodeRequest_H
#define OAIAssociateNodeRequest_H
...
class OAIAssociateNodeRequest : public OAIObject {
public:
    OAIAssociateNodeRequest();
    OAIAssociateNodeRequest(QString json);
    ~OAIAssociateNodeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateNodeRequest)

#endif // OAIAssociateNodeRequest_H
