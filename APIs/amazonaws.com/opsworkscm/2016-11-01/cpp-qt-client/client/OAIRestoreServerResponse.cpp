...
OAIRestoreServerResponse::OAIRestoreServerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreServerResponse::OAIRestoreServerResponse() {
    this->initializeModel();
}

OAIRestoreServerResponse::~OAIRestoreServerResponse() {}

void OAIRestoreServerResponse::initializeModel() {

    m_server_isSet = false;
    m_server_isValid = false;
}

void OAIRestoreServerResponse::fromJson(QString jsonString) {
...
void OAIRestoreServerResponse::fromJsonObject(QJsonObject json) {
...
QString OAIRestoreServerResponse::asJson() const {
...
QJsonObject OAIRestoreServerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_server.isSet()) {
...
OAIServer OAIRestoreServerResponse::getServer() const {
    return m_server;
}
void OAIRestoreServerResponse::setServer(const OAIServer &server) {
    m_server = server;
    m_server_isSet = true;
}

bool OAIRestoreServerResponse::is_server_Set() const{
    return m_server_isSet;
}

bool OAIRestoreServerResponse::is_server_Valid() const{
    return m_server_isValid;
}

bool OAIRestoreServerResponse::isSet() const {
...
bool OAIRestoreServerResponse::isValid() const {
