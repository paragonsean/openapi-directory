...
/*
 * OAIRestoreServerResponse.h
 *
 * 
 */

#ifndef OAIRestoreServerResponse_H
#define OAIRestoreServerResponse_H
...
class OAIRestoreServerResponse : public OAIObject {
public:
    OAIRestoreServerResponse();
    OAIRestoreServerResponse(QString json);
    ~OAIRestoreServerResponse() override;
    ...
    OAIServer getServer() const;
    void setServer(const OAIServer &server);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreServerResponse)

#endif // OAIRestoreServerResponse_H
