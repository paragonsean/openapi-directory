...
/*
 * OAIDescribeNodeAssociationStatusRequest.h
 *
 * 
 */

#ifndef OAIDescribeNodeAssociationStatusRequest_H
#define OAIDescribeNodeAssociationStatusRequest_H
...
class OAIDescribeNodeAssociationStatusRequest : public OAIObject {
public:
    OAIDescribeNodeAssociationStatusRequest();
    OAIDescribeNodeAssociationStatusRequest(QString json);
    ~OAIDescribeNodeAssociationStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeNodeAssociationStatusRequest)

#endif // OAIDescribeNodeAssociationStatusRequest_H
