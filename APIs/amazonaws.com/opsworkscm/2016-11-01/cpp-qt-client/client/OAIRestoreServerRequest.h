...
/*
 * OAIRestoreServerRequest.h
 *
 * 
 */

#ifndef OAIRestoreServerRequest_H
#define OAIRestoreServerRequest_H
...
class OAIRestoreServerRequest : public OAIObject {
public:
    OAIRestoreServerRequest();
    OAIRestoreServerRequest(QString json);
    ~OAIRestoreServerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreServerRequest)

#endif // OAIRestoreServerRequest_H
