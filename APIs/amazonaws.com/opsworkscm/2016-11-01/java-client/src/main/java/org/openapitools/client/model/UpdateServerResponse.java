...
import org.openapitools.client.model.UpdateServerResponseServer;
...
public class UpdateServerResponse {
  ...
  private UpdateServerResponseServer server;

  public UpdateServerResponse() {
  }

  public UpdateServerResponse server(UpdateServerResponseServer server) {
    this.server = server;
    return this;
  }
  ...
  public UpdateServerResponseServer getServer() {
    return server;
  }

  public void setServer(UpdateServerResponseServer server) {
    this.server = server;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateServerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateServerResponse is not found in the empty JSON string", UpdateServerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateServerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateServerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Server`
      if (jsonObj.get("Server") != null && !jsonObj.get("Server").isJsonNull()) {
        UpdateServerResponseServer.validateJsonElement(jsonObj.get("Server"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateServerResponse>() {
           @Override
           public void write(JsonWriter out, UpdateServerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateServerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateServerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateServerResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateServerResponse
   */
  public static UpdateServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateServerResponse.class);
  }

  /**
   * Convert an instance of UpdateServerResponse to an JSON string
   *
   * @return JSON string
   */
