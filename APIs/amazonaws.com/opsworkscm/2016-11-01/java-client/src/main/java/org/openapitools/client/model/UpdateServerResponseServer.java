...
public class UpdateServerResponseServer {
  ...
  public UpdateServerResponseServer() {
  }

  public UpdateServerResponseServer associatePublicIpAddress(Boolean associatePublicIpAddress) {
  ...
  public UpdateServerResponseServer backupRetentionCount(Integer backupRetentionCount) {
  ...
  public UpdateServerResponseServer serverName(String serverName) {
  ...
  public UpdateServerResponseServer createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateServerResponseServer cloudFormationStackArn(String cloudFormationStackArn) {
  ...
  public UpdateServerResponseServer customDomain(String customDomain) {
  ...
  public UpdateServerResponseServer disableAutomatedBackup(Boolean disableAutomatedBackup) {
  ...
  public UpdateServerResponseServer endpoint(String endpoint) {
  ...
  public UpdateServerResponseServer engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public UpdateServerResponseServer engineModel(String engineModel) {
  ...
  public UpdateServerResponseServer engineAttributes(List engineAttributes) {
  ...
  public UpdateServerResponseServer engineVersion(String engineVersion) {
  ...
  public UpdateServerResponseServer instanceProfileArn(String instanceProfileArn) {
  ...
  public UpdateServerResponseServer instanceType(String instanceType) {
  ...
  public UpdateServerResponseServer keyPair(String keyPair) {
  ...
  public UpdateServerResponseServer maintenanceStatus(MaintenanceStatus maintenanceStatus) {
  ...
  public UpdateServerResponseServer preferredMaintenanceWindow(String preferredMaintenanceWindow) {
  ...
  public UpdateServerResponseServer preferredBackupWindow(String preferredBackupWindow) {
  ...
  public UpdateServerResponseServer securityGroupIds(List securityGroupIds) {
  ...
  public UpdateServerResponseServer serviceRoleArn(String serviceRoleArn) {
  ...
  public UpdateServerResponseServer status(ServerStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateServerResponseServer statusReason(String statusReason) {
  ...
  public UpdateServerResponseServer subnetIds(List subnetIds) {
  ...
  public UpdateServerResponseServer serverArn(String serverArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateServerResponseServer updateServerResponseServer = (UpdateServerResponseServer) o;
    return Objects.equals(this.associatePublicIpAddress, updateServerResponseServer.associatePublicIpAddress) &&
        Objects.equals(this.backupRetentionCount, updateServerResponseServer.backupRetentionCount) &&
        Objects.equals(this.serverName, updateServerResponseServer.serverName) &&
        Objects.equals(this.createdAt, updateServerResponseServer.createdAt) &&
        Objects.equals(this.cloudFormationStackArn, updateServerResponseServer.cloudFormationStackArn) &&
        Objects.equals(this.customDomain, updateServerResponseServer.customDomain) &&
        Objects.equals(this.disableAutomatedBackup, updateServerResponseServer.disableAutomatedBackup) &&
        Objects.equals(this.endpoint, updateServerResponseServer.endpoint) &&
        Objects.equals(this.engine, updateServerResponseServer.engine) &&
        Objects.equals(this.engineModel, updateServerResponseServer.engineModel) &&
        Objects.equals(this.engineAttributes, updateServerResponseServer.engineAttributes) &&
        Objects.equals(this.engineVersion, updateServerResponseServer.engineVersion) &&
        Objects.equals(this.instanceProfileArn, updateServerResponseServer.instanceProfileArn) &&
        Objects.equals(this.instanceType, updateServerResponseServer.instanceType) &&
        Objects.equals(this.keyPair, updateServerResponseServer.keyPair) &&
        Objects.equals(this.maintenanceStatus, updateServerResponseServer.maintenanceStatus) &&
        Objects.equals(this.preferredMaintenanceWindow, updateServerResponseServer.preferredMaintenanceWindow) &&
        Objects.equals(this.preferredBackupWindow, updateServerResponseServer.preferredBackupWindow) &&
        Objects.equals(this.securityGroupIds, updateServerResponseServer.securityGroupIds) &&
        Objects.equals(this.serviceRoleArn, updateServerResponseServer.serviceRoleArn) &&
        Objects.equals(this.status, updateServerResponseServer.status) &&
        Objects.equals(this.statusReason, updateServerResponseServer.statusReason) &&
        Objects.equals(this.subnetIds, updateServerResponseServer.subnetIds) &&
        Objects.equals(this.serverArn, updateServerResponseServer.serverArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateServerResponseServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateServerResponseServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateServerResponseServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateServerResponseServer is not found in the empty JSON string", UpdateServerResponseServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateServerResponseServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateServerResponseServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateServerResponseServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateServerResponseServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateServerResponseServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateServerResponseServer.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateServerResponseServer>() {
           @Override
           public void write(JsonWriter out, UpdateServerResponseServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateServerResponseServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateServerResponseServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateServerResponseServer
   * @throws IOException if the JSON string is invalid with respect to UpdateServerResponseServer
   */
  public static UpdateServerResponseServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateServerResponseServer.class);
  }

  /**
   * Convert an instance of UpdateServerResponseServer to an JSON string
   *
   * @return JSON string
   */
