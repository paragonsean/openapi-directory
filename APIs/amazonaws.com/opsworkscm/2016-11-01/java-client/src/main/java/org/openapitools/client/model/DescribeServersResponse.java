...
public class DescribeServersResponse {
  ...
  public DescribeServersResponse servers(List servers) {
  ...
  public DescribeServersResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeServersResponse describeServersResponse = (DescribeServersResponse) o;
    return Objects.equals(this.servers, describeServersResponse.servers) &&
        Objects.equals(this.nextToken, describeServersResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(servers, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeServersResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeServersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeServersResponse is not found in the empty JSON string", DescribeServersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeServersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeServersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Servers`
      if (jsonObj.get("Servers") != null && !jsonObj.get("Servers").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Servers"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeServersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeServersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeServersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeServersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeServersResponse>() {
           @Override
           public void write(JsonWriter out, DescribeServersResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeServersResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeServersResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeServersResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeServersResponse
   */
  public static DescribeServersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeServersResponse.class);
  }

  /**
   * Convert an instance of DescribeServersResponse to an JSON string
   *
   * @return JSON string
   */
