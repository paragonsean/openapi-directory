...
public class RestoreServerResponse {
  ...
  public RestoreServerResponse server(Server server) {
    this.server = server;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RestoreServerResponse restoreServerResponse = (RestoreServerResponse) o;
    return Objects.equals(this.server, restoreServerResponse.server);
  }
  ...
  public String toString() {
    ...
    sb.append("class RestoreServerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RestoreServerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestoreServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RestoreServerResponse is not found in the empty JSON string", RestoreServerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RestoreServerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestoreServerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RestoreServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RestoreServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RestoreServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RestoreServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RestoreServerResponse>() {
           @Override
           public void write(JsonWriter out, RestoreServerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RestoreServerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RestoreServerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RestoreServerResponse
   * @throws IOException if the JSON string is invalid with respect to RestoreServerResponse
   */
  public static RestoreServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RestoreServerResponse.class);
  }

  /**
   * Convert an instance of RestoreServerResponse to an JSON string
   *
   * @return JSON string
   */
