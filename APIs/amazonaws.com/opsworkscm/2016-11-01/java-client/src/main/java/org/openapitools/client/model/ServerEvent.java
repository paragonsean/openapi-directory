...
public class ServerEvent {
  ...
  public ServerEvent createdAt(OffsetDateTime createdAt) {
  ...
  public ServerEvent serverName(String serverName) {
  ...
  public ServerEvent logUrl(String logUrl) {
    this.logUrl = logUrl;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, serverEvent.createdAt) &&
        Objects.equals(this.serverName, serverEvent.serverName) &&
        Objects.equals(this.message, serverEvent.message) &&
        Objects.equals(this.logUrl, serverEvent.logUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, serverName, message, logUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
