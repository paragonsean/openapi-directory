...
public class DisassociateNodeRequest {
  ...
  public DisassociateNodeRequest() {
  }

  public DisassociateNodeRequest serverName(String serverName) {
  ...
  public DisassociateNodeRequest nodeName(String nodeName) {
  ...
  public DisassociateNodeRequest engineAttributes(List engineAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateNodeRequest disassociateNodeRequest = (DisassociateNodeRequest) o;
    return Objects.equals(this.serverName, disassociateNodeRequest.serverName) &&
        Objects.equals(this.nodeName, disassociateNodeRequest.nodeName) &&
        Objects.equals(this.engineAttributes, disassociateNodeRequest.engineAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociateNodeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateNodeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateNodeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateNodeRequest is not found in the empty JSON string", DisassociateNodeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateNodeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateNodeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisassociateNodeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateNodeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateNodeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateNodeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateNodeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateNodeRequest>() {
           @Override
           public void write(JsonWriter out, DisassociateNodeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateNodeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateNodeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateNodeRequest
   * @throws IOException if the JSON string is invalid with respect to DisassociateNodeRequest
   */
  public static DisassociateNodeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateNodeRequest.class);
  }

  /**
   * Convert an instance of DisassociateNodeRequest to an JSON string
   *
   * @return JSON string
   */
