...
public class StartMaintenanceRequest {
  ...
  public StartMaintenanceRequest serverName(String serverName) {
  ...
  public StartMaintenanceRequest engineAttributes(List engineAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    StartMaintenanceRequest startMaintenanceRequest = (StartMaintenanceRequest) o;
    return Objects.equals(this.serverName, startMaintenanceRequest.serverName) &&
        Objects.equals(this.engineAttributes, startMaintenanceRequest.engineAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverName, engineAttributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartMaintenanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartMaintenanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartMaintenanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartMaintenanceRequest is not found in the empty JSON string", StartMaintenanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartMaintenanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartMaintenanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartMaintenanceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartMaintenanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartMaintenanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartMaintenanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartMaintenanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartMaintenanceRequest>() {
           @Override
           public void write(JsonWriter out, StartMaintenanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartMaintenanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartMaintenanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartMaintenanceRequest
   * @throws IOException if the JSON string is invalid with respect to StartMaintenanceRequest
   */
  public static StartMaintenanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartMaintenanceRequest.class);
  }

  /**
   * Convert an instance of StartMaintenanceRequest to an JSON string
   *
   * @return JSON string
   */
