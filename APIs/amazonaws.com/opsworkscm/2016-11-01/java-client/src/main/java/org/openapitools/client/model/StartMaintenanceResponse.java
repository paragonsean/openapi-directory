...
import org.openapitools.client.model.StartMaintenanceResponseServer;
...
public class StartMaintenanceResponse {
  ...
  private StartMaintenanceResponseServer server;

  public StartMaintenanceResponse() {
  }

  public StartMaintenanceResponse server(StartMaintenanceResponseServer server) {
    this.server = server;
    return this;
  }
  ...
  public StartMaintenanceResponseServer getServer() {
    return server;
  }

  public void setServer(StartMaintenanceResponseServer server) {
    this.server = server;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartMaintenanceResponse startMaintenanceResponse = (StartMaintenanceResponse) o;
    return Objects.equals(this.server, startMaintenanceResponse.server);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartMaintenanceResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartMaintenanceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartMaintenanceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartMaintenanceResponse is not found in the empty JSON string", StartMaintenanceResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartMaintenanceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartMaintenanceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Server`
      if (jsonObj.get("Server") != null && !jsonObj.get("Server").isJsonNull()) {
        StartMaintenanceResponseServer.validateJsonElement(jsonObj.get("Server"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartMaintenanceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartMaintenanceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartMaintenanceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartMaintenanceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartMaintenanceResponse>() {
           @Override
           public void write(JsonWriter out, StartMaintenanceResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartMaintenanceResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartMaintenanceResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartMaintenanceResponse
   * @throws IOException if the JSON string is invalid with respect to StartMaintenanceResponse
   */
  public static StartMaintenanceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartMaintenanceResponse.class);
  }

  /**
   * Convert an instance of StartMaintenanceResponse to an JSON string
   *
   * @return JSON string
   */
