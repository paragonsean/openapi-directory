...
public class AssociateNodeRequest {
  ...
  public AssociateNodeRequest() {
  }

  public AssociateNodeRequest serverName(String serverName) {
  ...
  public AssociateNodeRequest nodeName(String nodeName) {
  ...
  public AssociateNodeRequest engineAttributes(List engineAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateNodeRequest associateNodeRequest = (AssociateNodeRequest) o;
    return Objects.equals(this.serverName, associateNodeRequest.serverName) &&
        Objects.equals(this.nodeName, associateNodeRequest.nodeName) &&
        Objects.equals(this.engineAttributes, associateNodeRequest.engineAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverName, nodeName, engineAttributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateNodeRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("EngineAttributes");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateNodeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateNodeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateNodeRequest is not found in the empty JSON string", AssociateNodeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateNodeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateNodeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateNodeRequest.openapiRequiredFields) {
      ...
      // validate the required field `EngineAttributes`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateNodeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateNodeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateNodeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateNodeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateNodeRequest>() {
           @Override
           public void write(JsonWriter out, AssociateNodeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateNodeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateNodeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateNodeRequest
   * @throws IOException if the JSON string is invalid with respect to AssociateNodeRequest
   */
  public static AssociateNodeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateNodeRequest.class);
  }

  /**
   * Convert an instance of AssociateNodeRequest to an JSON string
   *
   * @return JSON string
   */
