...
public class AccountAttribute {
  ...
  public AccountAttribute name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AccountAttribute maximum(Integer maximum) {
  ...
  public AccountAttribute used(Integer used) {
    this.used = used;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountAttribute accountAttribute = (AccountAttribute) o;
    return Objects.equals(this.name, accountAttribute.name) &&
        Objects.equals(this.maximum, accountAttribute.maximum) &&
        Objects.equals(this.used, accountAttribute.used);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, maximum, used);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountAttribute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountAttribute is not found in the empty JSON string", AccountAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountAttribute>() {
           @Override
           public void write(JsonWriter out, AccountAttribute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountAttribute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountAttribute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountAttribute
   * @throws IOException if the JSON string is invalid with respect to AccountAttribute
   */
  public static AccountAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountAttribute.class);
  }

  /**
   * Convert an instance of AccountAttribute to an JSON string
   *
   * @return JSON string
   */
