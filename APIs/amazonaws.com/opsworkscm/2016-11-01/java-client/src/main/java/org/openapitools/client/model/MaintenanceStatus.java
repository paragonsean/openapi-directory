 ...
 */
@JsonAdapter(MaintenanceStatus.Adapter.class)
public enum MaintenanceStatus {
  ...
  public static class Adapter extends TypeAdapter<MaintenanceStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final MaintenanceStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MaintenanceStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MaintenanceStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MaintenanceStatus.fromValue(value);
  }
}
