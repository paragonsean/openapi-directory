 ...
 */
@JsonAdapter(NodeAssociationStatus.Adapter.class)
public enum NodeAssociationStatus {
  ...
  NodeAssociationStatus(String value) {
    this.value = value;
  }
  ...
  public static NodeAssociationStatus fromValue(String value) {
    for (NodeAssociationStatus b : NodeAssociationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<NodeAssociationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final NodeAssociationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NodeAssociationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NodeAssociationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NodeAssociationStatus.fromValue(value);
  }
}
