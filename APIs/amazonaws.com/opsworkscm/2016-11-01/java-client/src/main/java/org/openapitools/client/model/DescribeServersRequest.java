...
public class DescribeServersRequest {
  ...
  public DescribeServersRequest serverName(String serverName) {
  ...
  public DescribeServersRequest nextToken(String nextToken) {
  ...
  public DescribeServersRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeServersRequest describeServersRequest = (DescribeServersRequest) o;
    return Objects.equals(this.serverName, describeServersRequest.serverName) &&
        Objects.equals(this.nextToken, describeServersRequest.nextToken) &&
        Objects.equals(this.maxResults, describeServersRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeServersRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeServersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeServersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeServersRequest is not found in the empty JSON string", DescribeServersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeServersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeServersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeServersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeServersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeServersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeServersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeServersRequest>() {
           @Override
           public void write(JsonWriter out, DescribeServersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeServersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeServersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeServersRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeServersRequest
   */
  public static DescribeServersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeServersRequest.class);
  }

  /**
   * Convert an instance of DescribeServersRequest to an JSON string
   *
   * @return JSON string
   */
