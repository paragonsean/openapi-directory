...
public class CreateServerResponseServer {
  ...
  public CreateServerResponseServer() {
  }

  public CreateServerResponseServer associatePublicIpAddress(Boolean associatePublicIpAddress) {
  ...
  public CreateServerResponseServer backupRetentionCount(Integer backupRetentionCount) {
  ...
  public CreateServerResponseServer serverName(String serverName) {
  ...
  public CreateServerResponseServer createdAt(OffsetDateTime createdAt) {
  ...
  public CreateServerResponseServer cloudFormationStackArn(String cloudFormationStackArn) {
  ...
  public CreateServerResponseServer customDomain(String customDomain) {
  ...
  public CreateServerResponseServer disableAutomatedBackup(Boolean disableAutomatedBackup) {
  ...
  public CreateServerResponseServer endpoint(String endpoint) {
  ...
  public CreateServerResponseServer engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public CreateServerResponseServer engineModel(String engineModel) {
  ...
  public CreateServerResponseServer engineAttributes(List engineAttributes) {
  ...
  public CreateServerResponseServer engineVersion(String engineVersion) {
  ...
  public CreateServerResponseServer instanceProfileArn(String instanceProfileArn) {
  ...
  public CreateServerResponseServer instanceType(String instanceType) {
  ...
  public CreateServerResponseServer keyPair(String keyPair) {
  ...
  public CreateServerResponseServer maintenanceStatus(MaintenanceStatus maintenanceStatus) {
  ...
  public CreateServerResponseServer preferredMaintenanceWindow(String preferredMaintenanceWindow) {
  ...
  public CreateServerResponseServer preferredBackupWindow(String preferredBackupWindow) {
  ...
  public CreateServerResponseServer securityGroupIds(List securityGroupIds) {
  ...
  public CreateServerResponseServer serviceRoleArn(String serviceRoleArn) {
  ...
  public CreateServerResponseServer status(ServerStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateServerResponseServer statusReason(String statusReason) {
  ...
  public CreateServerResponseServer subnetIds(List subnetIds) {
  ...
  public CreateServerResponseServer serverArn(String serverArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateServerResponseServer createServerResponseServer = (CreateServerResponseServer) o;
    return Objects.equals(this.associatePublicIpAddress, createServerResponseServer.associatePublicIpAddress) &&
        Objects.equals(this.backupRetentionCount, createServerResponseServer.backupRetentionCount) &&
        Objects.equals(this.serverName, createServerResponseServer.serverName) &&
        Objects.equals(this.createdAt, createServerResponseServer.createdAt) &&
        Objects.equals(this.cloudFormationStackArn, createServerResponseServer.cloudFormationStackArn) &&
        Objects.equals(this.customDomain, createServerResponseServer.customDomain) &&
        Objects.equals(this.disableAutomatedBackup, createServerResponseServer.disableAutomatedBackup) &&
        Objects.equals(this.endpoint, createServerResponseServer.endpoint) &&
        Objects.equals(this.engine, createServerResponseServer.engine) &&
        Objects.equals(this.engineModel, createServerResponseServer.engineModel) &&
        Objects.equals(this.engineAttributes, createServerResponseServer.engineAttributes) &&
        Objects.equals(this.engineVersion, createServerResponseServer.engineVersion) &&
        Objects.equals(this.instanceProfileArn, createServerResponseServer.instanceProfileArn) &&
        Objects.equals(this.instanceType, createServerResponseServer.instanceType) &&
        Objects.equals(this.keyPair, createServerResponseServer.keyPair) &&
        Objects.equals(this.maintenanceStatus, createServerResponseServer.maintenanceStatus) &&
        Objects.equals(this.preferredMaintenanceWindow, createServerResponseServer.preferredMaintenanceWindow) &&
        Objects.equals(this.preferredBackupWindow, createServerResponseServer.preferredBackupWindow) &&
        Objects.equals(this.securityGroupIds, createServerResponseServer.securityGroupIds) &&
        Objects.equals(this.serviceRoleArn, createServerResponseServer.serviceRoleArn) &&
        Objects.equals(this.status, createServerResponseServer.status) &&
        Objects.equals(this.statusReason, createServerResponseServer.statusReason) &&
        Objects.equals(this.subnetIds, createServerResponseServer.subnetIds) &&
        Objects.equals(this.serverArn, createServerResponseServer.serverArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateServerResponseServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServerResponseServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServerResponseServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServerResponseServer is not found in the empty JSON string", CreateServerResponseServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateServerResponseServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateServerResponseServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateServerResponseServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateServerResponseServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateServerResponseServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateServerResponseServer.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateServerResponseServer>() {
           @Override
           public void write(JsonWriter out, CreateServerResponseServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateServerResponseServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateServerResponseServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServerResponseServer
   * @throws IOException if the JSON string is invalid with respect to CreateServerResponseServer
   */
  public static CreateServerResponseServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServerResponseServer.class);
  }

  /**
   * Convert an instance of CreateServerResponseServer to an JSON string
   *
   * @return JSON string
   */
