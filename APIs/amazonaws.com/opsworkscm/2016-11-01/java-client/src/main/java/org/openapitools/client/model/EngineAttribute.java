...
public class EngineAttribute {
  ...
  public EngineAttribute name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EngineAttribute value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EngineAttribute engineAttribute = (EngineAttribute) o;
    return Objects.equals(this.name, engineAttribute.name) &&
        Objects.equals(this.value, engineAttribute.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class EngineAttribute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EngineAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EngineAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EngineAttribute is not found in the empty JSON string", EngineAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EngineAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EngineAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EngineAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EngineAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EngineAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EngineAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<EngineAttribute>() {
           @Override
           public void write(JsonWriter out, EngineAttribute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EngineAttribute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EngineAttribute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EngineAttribute
   * @throws IOException if the JSON string is invalid with respect to EngineAttribute
   */
  public static EngineAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EngineAttribute.class);
  }

  /**
   * Convert an instance of EngineAttribute to an JSON string
   *
   * @return JSON string
   */
