...
import org.openapitools.client.model.NodeAssociationStatus;
...
public class DescribeNodeAssociationStatusResponse {
  public static final String SERIALIZED_NAME_NODE_ASSOCIATION_STATUS = "NodeAssociationStatus";
  @SerializedName(SERIALIZED_NAME_NODE_ASSOCIATION_STATUS)
  private NodeAssociationStatus nodeAssociationStatus;
  ...
  public DescribeNodeAssociationStatusResponse nodeAssociationStatus(NodeAssociationStatus nodeAssociationStatus) {
    this.nodeAssociationStatus = nodeAssociationStatus;
    return this;
  }

  /**
   * Get nodeAssociationStatus
   * @return nodeAssociationStatus
   */
  @javax.annotation.Nullable
  public NodeAssociationStatus getNodeAssociationStatus() {
    return nodeAssociationStatus;
  }
  ...
  public DescribeNodeAssociationStatusResponse engineAttributes(List engineAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeNodeAssociationStatusResponse describeNodeAssociationStatusResponse = (DescribeNodeAssociationStatusResponse) o;
    return Objects.equals(this.nodeAssociationStatus, describeNodeAssociationStatusResponse.nodeAssociationStatus) &&
        Objects.equals(this.engineAttributes, describeNodeAssociationStatusResponse.engineAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nodeAssociationStatus, engineAttributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeNodeAssociationStatusResponse {\n");
    sb.append("    nodeAssociationStatus: ").append(toIndentedString(nodeAssociationStatus)).append("\n");
  ...
  static {
    ...
    openapiFields.add("NodeAssociationStatus");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeNodeAssociationStatusResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeNodeAssociationStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeNodeAssociationStatusResponse is not found in the empty JSON string", DescribeNodeAssociationStatusResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeNodeAssociationStatusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeNodeAssociationStatusResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `NodeAssociationStatus`
      if (jsonObj.get("NodeAssociationStatus") != null && !jsonObj.get("NodeAssociationStatus").isJsonNull()) {
        NodeAssociationStatus.validateJsonElement(jsonObj.get("NodeAssociationStatus"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeNodeAssociationStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeNodeAssociationStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeNodeAssociationStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeNodeAssociationStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeNodeAssociationStatusResponse>() {
           @Override
           public void write(JsonWriter out, DescribeNodeAssociationStatusResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeNodeAssociationStatusResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeNodeAssociationStatusResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeNodeAssociationStatusResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeNodeAssociationStatusResponse
   */
  public static DescribeNodeAssociationStatusResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeNodeAssociationStatusResponse.class);
  }

  /**
   * Convert an instance of DescribeNodeAssociationStatusResponse to an JSON string
   *
   * @return JSON string
   */
