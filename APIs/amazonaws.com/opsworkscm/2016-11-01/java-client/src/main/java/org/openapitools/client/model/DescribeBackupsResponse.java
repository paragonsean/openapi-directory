...
public class DescribeBackupsResponse {
  ...
  public DescribeBackupsResponse backups(List backups) {
  ...
  public DescribeBackupsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backups, describeBackupsResponse.backups) &&
        Objects.equals(this.nextToken, describeBackupsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backups, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBackupsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBackupsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBackupsResponse is not found in the empty JSON string", DescribeBackupsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBackupsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBackupsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Backups`
      if (jsonObj.get("Backups") != null && !jsonObj.get("Backups").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Backups"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBackupsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBackupsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBackupsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBackupsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBackupsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeBackupsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBackupsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBackupsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBackupsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeBackupsResponse
   */
  public static DescribeBackupsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBackupsResponse.class);
  }

  /**
   * Convert an instance of DescribeBackupsResponse to an JSON string
   *
   * @return JSON string
   */
