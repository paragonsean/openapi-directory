...
public class AssociateNodeResponse {
  ...
  public AssociateNodeResponse nodeAssociationStatusToken(String nodeAssociationStatusToken) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateNodeResponse associateNodeResponse = (AssociateNodeResponse) o;
    return Objects.equals(this.nodeAssociationStatusToken, associateNodeResponse.nodeAssociationStatusToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateNodeResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateNodeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateNodeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateNodeResponse is not found in the empty JSON string", AssociateNodeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateNodeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateNodeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateNodeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateNodeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateNodeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateNodeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateNodeResponse>() {
           @Override
           public void write(JsonWriter out, AssociateNodeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateNodeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateNodeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateNodeResponse
   * @throws IOException if the JSON string is invalid with respect to AssociateNodeResponse
   */
  public static AssociateNodeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateNodeResponse.class);
  }

  /**
   * Convert an instance of AssociateNodeResponse to an JSON string
   *
   * @return JSON string
   */
