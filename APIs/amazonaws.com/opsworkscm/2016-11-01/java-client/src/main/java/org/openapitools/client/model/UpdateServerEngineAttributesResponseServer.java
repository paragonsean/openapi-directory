...
public class UpdateServerEngineAttributesResponseServer {
  ...
  public UpdateServerEngineAttributesResponseServer() {
  }

  public UpdateServerEngineAttributesResponseServer associatePublicIpAddress(Boolean associatePublicIpAddress) {
  ...
  public UpdateServerEngineAttributesResponseServer backupRetentionCount(Integer backupRetentionCount) {
  ...
  public UpdateServerEngineAttributesResponseServer serverName(String serverName) {
  ...
  public UpdateServerEngineAttributesResponseServer createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateServerEngineAttributesResponseServer cloudFormationStackArn(String cloudFormationStackArn) {
  ...
  public UpdateServerEngineAttributesResponseServer customDomain(String customDomain) {
  ...
  public UpdateServerEngineAttributesResponseServer disableAutomatedBackup(Boolean disableAutomatedBackup) {
  ...
  public UpdateServerEngineAttributesResponseServer endpoint(String endpoint) {
  ...
  public UpdateServerEngineAttributesResponseServer engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public UpdateServerEngineAttributesResponseServer engineModel(String engineModel) {
  ...
  public UpdateServerEngineAttributesResponseServer engineAttributes(List engineAttributes) {
  ...
  public UpdateServerEngineAttributesResponseServer engineVersion(String engineVersion) {
  ...
  public UpdateServerEngineAttributesResponseServer instanceProfileArn(String instanceProfileArn) {
  ...
  public UpdateServerEngineAttributesResponseServer instanceType(String instanceType) {
  ...
  public UpdateServerEngineAttributesResponseServer keyPair(String keyPair) {
  ...
  public UpdateServerEngineAttributesResponseServer maintenanceStatus(MaintenanceStatus maintenanceStatus) {
  ...
  public UpdateServerEngineAttributesResponseServer preferredMaintenanceWindow(String preferredMaintenanceWindow) {
  ...
  public UpdateServerEngineAttributesResponseServer preferredBackupWindow(String preferredBackupWindow) {
  ...
  public UpdateServerEngineAttributesResponseServer securityGroupIds(List securityGroupIds) {
  ...
  public UpdateServerEngineAttributesResponseServer serviceRoleArn(String serviceRoleArn) {
  ...
  public UpdateServerEngineAttributesResponseServer status(ServerStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateServerEngineAttributesResponseServer statusReason(String statusReason) {
  ...
  public UpdateServerEngineAttributesResponseServer subnetIds(List subnetIds) {
  ...
  public UpdateServerEngineAttributesResponseServer serverArn(String serverArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateServerEngineAttributesResponseServer updateServerEngineAttributesResponseServer = (UpdateServerEngineAttributesResponseServer) o;
    return Objects.equals(this.associatePublicIpAddress, updateServerEngineAttributesResponseServer.associatePublicIpAddress) &&
        Objects.equals(this.backupRetentionCount, updateServerEngineAttributesResponseServer.backupRetentionCount) &&
        Objects.equals(this.serverName, updateServerEngineAttributesResponseServer.serverName) &&
        Objects.equals(this.createdAt, updateServerEngineAttributesResponseServer.createdAt) &&
        Objects.equals(this.cloudFormationStackArn, updateServerEngineAttributesResponseServer.cloudFormationStackArn) &&
        Objects.equals(this.customDomain, updateServerEngineAttributesResponseServer.customDomain) &&
        Objects.equals(this.disableAutomatedBackup, updateServerEngineAttributesResponseServer.disableAutomatedBackup) &&
        Objects.equals(this.endpoint, updateServerEngineAttributesResponseServer.endpoint) &&
        Objects.equals(this.engine, updateServerEngineAttributesResponseServer.engine) &&
        Objects.equals(this.engineModel, updateServerEngineAttributesResponseServer.engineModel) &&
        Objects.equals(this.engineAttributes, updateServerEngineAttributesResponseServer.engineAttributes) &&
        Objects.equals(this.engineVersion, updateServerEngineAttributesResponseServer.engineVersion) &&
        Objects.equals(this.instanceProfileArn, updateServerEngineAttributesResponseServer.instanceProfileArn) &&
        Objects.equals(this.instanceType, updateServerEngineAttributesResponseServer.instanceType) &&
        Objects.equals(this.keyPair, updateServerEngineAttributesResponseServer.keyPair) &&
        Objects.equals(this.maintenanceStatus, updateServerEngineAttributesResponseServer.maintenanceStatus) &&
        Objects.equals(this.preferredMaintenanceWindow, updateServerEngineAttributesResponseServer.preferredMaintenanceWindow) &&
        Objects.equals(this.preferredBackupWindow, updateServerEngineAttributesResponseServer.preferredBackupWindow) &&
        Objects.equals(this.securityGroupIds, updateServerEngineAttributesResponseServer.securityGroupIds) &&
        Objects.equals(this.serviceRoleArn, updateServerEngineAttributesResponseServer.serviceRoleArn) &&
        Objects.equals(this.status, updateServerEngineAttributesResponseServer.status) &&
        Objects.equals(this.statusReason, updateServerEngineAttributesResponseServer.statusReason) &&
        Objects.equals(this.subnetIds, updateServerEngineAttributesResponseServer.subnetIds) &&
        Objects.equals(this.serverArn, updateServerEngineAttributesResponseServer.serverArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateServerEngineAttributesResponseServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateServerEngineAttributesResponseServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateServerEngineAttributesResponseServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateServerEngineAttributesResponseServer is not found in the empty JSON string", UpdateServerEngineAttributesResponseServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateServerEngineAttributesResponseServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateServerEngineAttributesResponseServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateServerEngineAttributesResponseServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateServerEngineAttributesResponseServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateServerEngineAttributesResponseServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateServerEngineAttributesResponseServer.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateServerEngineAttributesResponseServer>() {
           @Override
           public void write(JsonWriter out, UpdateServerEngineAttributesResponseServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateServerEngineAttributesResponseServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateServerEngineAttributesResponseServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateServerEngineAttributesResponseServer
   * @throws IOException if the JSON string is invalid with respect to UpdateServerEngineAttributesResponseServer
   */
  public static UpdateServerEngineAttributesResponseServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateServerEngineAttributesResponseServer.class);
  }

  /**
   * Convert an instance of UpdateServerEngineAttributesResponseServer to an JSON string
   *
   * @return JSON string
   */
