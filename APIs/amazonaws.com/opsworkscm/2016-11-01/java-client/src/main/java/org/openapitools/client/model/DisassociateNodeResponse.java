...
public class DisassociateNodeResponse {
  public static final String SERIALIZED_NAME_NODE_ASSOCIATION_STATUS_TOKEN = "NodeAssociationStatusToken";
  @SerializedName(SERIALIZED_NAME_NODE_ASSOCIATION_STATUS_TOKEN)
  private String nodeAssociationStatusToken;

  public DisassociateNodeResponse() {
  }

  public DisassociateNodeResponse nodeAssociationStatusToken(String nodeAssociationStatusToken) {
    this.nodeAssociationStatusToken = nodeAssociationStatusToken;
    return this;
  }

  /**
   * Get nodeAssociationStatusToken
  ...
  public boolean equals(Object o) {
    ...
    DisassociateNodeResponse disassociateNodeResponse = (DisassociateNodeResponse) o;
    return Objects.equals(this.nodeAssociationStatusToken, disassociateNodeResponse.nodeAssociationStatusToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nodeAssociationStatusToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisassociateNodeResponse {\n");
    sb.append("    nodeAssociationStatusToken: ").append(toIndentedString(nodeAssociationStatusToken)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("NodeAssociationStatusToken");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateNodeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateNodeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateNodeResponse is not found in the empty JSON string", DisassociateNodeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateNodeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateNodeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `NodeAssociationStatusToken`
      if (jsonObj.get("NodeAssociationStatusToken") != null && !jsonObj.get("NodeAssociationStatusToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("NodeAssociationStatusToken"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateNodeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateNodeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateNodeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateNodeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateNodeResponse>() {
           @Override
           public void write(JsonWriter out, DisassociateNodeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateNodeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateNodeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateNodeResponse
   * @throws IOException if the JSON string is invalid with respect to DisassociateNodeResponse
   */
  public static DisassociateNodeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateNodeResponse.class);
  }

  /**
   * Convert an instance of DisassociateNodeResponse to an JSON string
   *
   * @return JSON string
   */
