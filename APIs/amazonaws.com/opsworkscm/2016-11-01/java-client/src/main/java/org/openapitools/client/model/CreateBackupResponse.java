...
public class CreateBackupResponse {
  ...
  private CreateBackupResponseBackup backup;

  public CreateBackupResponse() {
  }

  public CreateBackupResponse backup(CreateBackupResponseBackup backup) {
    this.backup = backup;
    return this;
  }
  ...
  public CreateBackupResponseBackup getBackup() {
    return backup;
  }

  public void setBackup(CreateBackupResponseBackup backup) {
    this.backup = backup;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backup, createBackupResponse.backup);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBackupResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBackupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBackupResponse is not found in the empty JSON string", CreateBackupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBackupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBackupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Backup`
      if (jsonObj.get("Backup") != null && !jsonObj.get("Backup").isJsonNull()) {
        CreateBackupResponseBackup.validateJsonElement(jsonObj.get("Backup"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBackupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBackupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBackupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBackupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBackupResponse>() {
           @Override
           public void write(JsonWriter out, CreateBackupResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBackupResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBackupResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBackupResponse
   * @throws IOException if the JSON string is invalid with respect to CreateBackupResponse
   */
  public static CreateBackupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBackupResponse.class);
  }

  /**
   * Convert an instance of CreateBackupResponse to an JSON string
   *
   * @return JSON string
   */
