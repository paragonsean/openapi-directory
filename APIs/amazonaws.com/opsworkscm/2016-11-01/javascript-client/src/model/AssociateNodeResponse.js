...
/**
 * The AssociateNodeResponse model module.
 * @module model/AssociateNodeResponse
 * @version 2016-11-01
 */
class AssociateNodeResponse {
    /**
     * Constructs a new <code>AssociateNodeResponse</code>.
     * @alias module:model/AssociateNodeResponse
     */
    constructor() { 
        
        AssociateNodeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateNodeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateNodeResponse} obj Optional instance to populate.
     * @return {module:model/AssociateNodeResponse} The populated <code>AssociateNodeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateNodeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateNodeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateNodeResponse</code>.
     */
 ...
 */
AssociateNodeResponse.prototype['NodeAssociationStatusToken'] = undefined;
...
export default AssociateNodeResponse;
