...
import ExportServerEngineAttributeResponseEngineAttribute from './ExportServerEngineAttributeResponseEngineAttribute';

/**
 * The ExportServerEngineAttributeResponse model module.
 * @module model/ExportServerEngineAttributeResponse
 * @version 2016-11-01
 */
class ExportServerEngineAttributeResponse {
    /**
     * Constructs a new <code>ExportServerEngineAttributeResponse</code>.
     * @alias module:model/ExportServerEngineAttributeResponse
     */
    constructor() { 
        
        ExportServerEngineAttributeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExportServerEngineAttributeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportServerEngineAttributeResponse} obj Optional instance to populate.
     * @return {module:model/ExportServerEngineAttributeResponse} The populated <code>ExportServerEngineAttributeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportServerEngineAttributeResponse();

            if (data.hasOwnProperty('EngineAttribute')) {
                obj['EngineAttribute'] = ExportServerEngineAttributeResponseEngineAttribute.constructFromObject(data['EngineAttribute']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ExportServerEngineAttributeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportServerEngineAttributeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EngineAttribute`
        if (data['EngineAttribute']) { // data not null
          ExportServerEngineAttributeResponseEngineAttribute.validateJSON(data['EngineAttribute']);
        }
...
/**
 * @member {module:model/ExportServerEngineAttributeResponseEngineAttribute} EngineAttribute
 */
ExportServerEngineAttributeResponse.prototype['EngineAttribute'] = undefined;

/**
 * @member {String} ServerName
 */
ExportServerEngineAttributeResponse.prototype['ServerName'] = undefined;
...
export default ExportServerEngineAttributeResponse;
