...
/**
 * The DescribeAccountAttributesResponse model module.
 * @module model/DescribeAccountAttributesResponse
 * @version 2016-11-01
 */
class DescribeAccountAttributesResponse {
    /**
     * Constructs a new <code>DescribeAccountAttributesResponse</code>.
     * @alias module:model/DescribeAccountAttributesResponse
     */
    constructor() { 
        
        DescribeAccountAttributesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAccountAttributesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAccountAttributesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAccountAttributesResponse} The populated <code>DescribeAccountAttributesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAccountAttributesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAccountAttributesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAccountAttributesResponse</code>.
     */
 ...
 */
DescribeAccountAttributesResponse.prototype['Attributes'] = undefined;
...
export default DescribeAccountAttributesResponse;
