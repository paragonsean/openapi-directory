...
/**
 * The StartMaintenanceResponseServer model module.
 * @module model/StartMaintenanceResponseServer
 * @version 2016-11-01
 */
class StartMaintenanceResponseServer {
    /**
     * Constructs a new <code>StartMaintenanceResponseServer</code>.
     * @alias module:model/StartMaintenanceResponseServer
     * @implements module:model/Server
     */
    constructor() { 
        Server.initialize(this);
        StartMaintenanceResponseServer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartMaintenanceResponseServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMaintenanceResponseServer} obj Optional instance to populate.
     * @return {module:model/StartMaintenanceResponseServer} The populated <code>StartMaintenanceResponseServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMaintenanceResponseServer();
    ...
    /**
     * Validates the JSON data with respect to <code>StartMaintenanceResponseServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMaintenanceResponseServer</code>.
     */
 ...
 */
StartMaintenanceResponseServer.prototype['AssociatePublicIpAddress'] = undefined;

/**
 * @member {Number} BackupRetentionCount
 */
StartMaintenanceResponseServer.prototype['BackupRetentionCount'] = undefined;

/**
 * @member {String} ServerName
 */
StartMaintenanceResponseServer.prototype['ServerName'] = undefined;

/**
 * @member {Date} CreatedAt
 */
StartMaintenanceResponseServer.prototype['CreatedAt'] = undefined;

/**
 * @member {String} CloudFormationStackArn
 */
StartMaintenanceResponseServer.prototype['CloudFormationStackArn'] = undefined;

/**
 * @member {String} CustomDomain
 */
StartMaintenanceResponseServer.prototype['CustomDomain'] = undefined;

/**
 * @member {Boolean} DisableAutomatedBackup
 */
StartMaintenanceResponseServer.prototype['DisableAutomatedBackup'] = undefined;

/**
 * @member {String} Endpoint
 */
StartMaintenanceResponseServer.prototype['Endpoint'] = undefined;

/**
 * @member {String} Engine
 */
StartMaintenanceResponseServer.prototype['Engine'] = undefined;

/**
 * @member {String} EngineModel
 */
StartMaintenanceResponseServer.prototype['EngineModel'] = undefined;

/**
 * @member {Array} EngineAttributes
 */
StartMaintenanceResponseServer.prototype['EngineAttributes'] = undefined;

/**
 * @member {String} EngineVersion
 */
StartMaintenanceResponseServer.prototype['EngineVersion'] = undefined;

/**
 * @member {String} InstanceProfileArn
 */
StartMaintenanceResponseServer.prototype['InstanceProfileArn'] = undefined;

/**
 * @member {String} InstanceType
 */
StartMaintenanceResponseServer.prototype['InstanceType'] = undefined;

/**
 * @member {String} KeyPair
 */
StartMaintenanceResponseServer.prototype['KeyPair'] = undefined;

/**
 * @member {module:model/MaintenanceStatus} MaintenanceStatus
 */
StartMaintenanceResponseServer.prototype['MaintenanceStatus'] = undefined;

/**
 * @member {String} PreferredMaintenanceWindow
 */
StartMaintenanceResponseServer.prototype['PreferredMaintenanceWindow'] = undefined;

/**
 * @member {String} PreferredBackupWindow
 */
StartMaintenanceResponseServer.prototype['PreferredBackupWindow'] = undefined;

/**
 * @member {Array} SecurityGroupIds
 */
StartMaintenanceResponseServer.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {String} ServiceRoleArn
 */
StartMaintenanceResponseServer.prototype['ServiceRoleArn'] = undefined;

/**
 * @member {module:model/ServerStatus} Status
 */
StartMaintenanceResponseServer.prototype['Status'] = undefined;

/**
 * @member {String} StatusReason
 */
StartMaintenanceResponseServer.prototype['StatusReason'] = undefined;

/**
 * @member {Array} SubnetIds
 */
StartMaintenanceResponseServer.prototype['SubnetIds'] = undefined;

/**
 * @member {String} ServerArn
 */
StartMaintenanceResponseServer.prototype['ServerArn'] = undefined;
...
export default StartMaintenanceResponseServer;
