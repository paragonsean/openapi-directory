...
* @readonly
*/
export default class NodeAssociationStatus {
    ...
    /**
    * Returns a <code>NodeAssociationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NodeAssociationStatus} The enum <code>NodeAssociationStatus</code> value.
    */
