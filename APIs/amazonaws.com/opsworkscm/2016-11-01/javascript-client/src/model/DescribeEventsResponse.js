...
class DescribeEventsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ServerEvents')) {
                obj['ServerEvents'] = ApiClient.convertToType(data['ServerEvents'], Array);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['ServerEvents']) { // data not null
          Array.validateJSON(data['ServerEvents']);
        }
...
/**
 * @member {Array} ServerEvents
 */
DescribeEventsResponse.prototype['ServerEvents'] = undefined;
