...
export default class MaintenanceStatus {
    ...
    /**
    * Returns a <code>MaintenanceStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MaintenanceStatus} The enum <code>MaintenanceStatus</code> value.
    */
