...
/**
 * The DescribeServersRequest model module.
 * @module model/DescribeServersRequest
 * @version 2016-11-01
 */
class DescribeServersRequest {
    /**
     * Constructs a new <code>DescribeServersRequest</code>.
     * @alias module:model/DescribeServersRequest
     */
    constructor() { 
        
        DescribeServersRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeServersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeServersRequest} obj Optional instance to populate.
     * @return {module:model/DescribeServersRequest} The populated <code>DescribeServersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeServersRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeServersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeServersRequest</code>.
     */
 ...
 */
DescribeServersRequest.prototype['ServerName'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeServersRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribeServersRequest.prototype['MaxResults'] = undefined;
...
export default DescribeServersRequest;
