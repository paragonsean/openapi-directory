...
import StartMaintenanceResponseServer from './StartMaintenanceResponseServer';

/**
 * The StartMaintenanceResponse model module.
 * @module model/StartMaintenanceResponse
 * @version 2016-11-01
 */
class StartMaintenanceResponse {
    /**
     * Constructs a new <code>StartMaintenanceResponse</code>.
     * @alias module:model/StartMaintenanceResponse
     */
    constructor() { 
        
        StartMaintenanceResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartMaintenanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMaintenanceResponse} obj Optional instance to populate.
     * @return {module:model/StartMaintenanceResponse} The populated <code>StartMaintenanceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMaintenanceResponse();

            if (data.hasOwnProperty('Server')) {
                obj['Server'] = StartMaintenanceResponseServer.constructFromObject(data['Server']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartMaintenanceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMaintenanceResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Server`
        if (data['Server']) { // data not null
          StartMaintenanceResponseServer.validateJSON(data['Server']);
        }
...
/**
 * @member {module:model/StartMaintenanceResponseServer} Server
 */
StartMaintenanceResponse.prototype['Server'] = undefined;
...
export default StartMaintenanceResponse;
