...
/**
 * The ExportServerEngineAttributeResponseEngineAttribute model module.
 * @module model/ExportServerEngineAttributeResponseEngineAttribute
 * @version 2016-11-01
 */
class ExportServerEngineAttributeResponseEngineAttribute {
    /**
     * Constructs a new <code>ExportServerEngineAttributeResponseEngineAttribute</code>.
     * @alias module:model/ExportServerEngineAttributeResponseEngineAttribute
     * @implements module:model/EngineAttribute
     */
    constructor() { 
        EngineAttribute.initialize(this);
        ExportServerEngineAttributeResponseEngineAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExportServerEngineAttributeResponseEngineAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportServerEngineAttributeResponseEngineAttribute} obj Optional instance to populate.
     * @return {module:model/ExportServerEngineAttributeResponseEngineAttribute} The populated <code>ExportServerEngineAttributeResponseEngineAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportServerEngineAttributeResponseEngineAttribute();
            EngineAttribute.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ExportServerEngineAttributeResponseEngineAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportServerEngineAttributeResponseEngineAttribute</code>.
     */
 ...
 * @member {String} Name
 */
ExportServerEngineAttributeResponseEngineAttribute.prototype['Name'] = undefined;

/**
 * @member {String} Value
 */
ExportServerEngineAttributeResponseEngineAttribute.prototype['Value'] = undefined;


// Implement EngineAttribute interface:
/**
 * @member {String} Name
 */
...
export default ExportServerEngineAttributeResponseEngineAttribute;
