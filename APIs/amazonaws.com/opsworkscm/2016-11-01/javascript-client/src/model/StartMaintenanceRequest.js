...
/**
 * The StartMaintenanceRequest model module.
 * @module model/StartMaintenanceRequest
 * @version 2016-11-01
 */
class StartMaintenanceRequest {
    /**
     * Constructs a new <code>StartMaintenanceRequest</code>.
     * @alias module:model/StartMaintenanceRequest
     * @param serverName {String} 
     */
    constructor(serverName) { 
        
        StartMaintenanceRequest.initialize(this, serverName);
    }
    ...
    /**
     * Constructs a <code>StartMaintenanceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMaintenanceRequest} obj Optional instance to populate.
     * @return {module:model/StartMaintenanceRequest} The populated <code>StartMaintenanceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMaintenanceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartMaintenanceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMaintenanceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartMaintenanceRequest.RequiredProperties) {
...
StartMaintenanceRequest.RequiredProperties = ["ServerName"];

/**
 * @member {String} ServerName
 */
StartMaintenanceRequest.prototype['ServerName'] = undefined;

/**
 * @member {Array} EngineAttributes
 */
StartMaintenanceRequest.prototype['EngineAttributes'] = undefined;
...
export default StartMaintenanceRequest;
