...
/**
 * The DescribeServersResponse model module.
 * @module model/DescribeServersResponse
 * @version 2016-11-01
 */
class DescribeServersResponse {
    /**
     * Constructs a new <code>DescribeServersResponse</code>.
     * @alias module:model/DescribeServersResponse
     */
    constructor() { 
        
        DescribeServersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeServersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeServersResponse} obj Optional instance to populate.
     * @return {module:model/DescribeServersResponse} The populated <code>DescribeServersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeServersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeServersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeServersResponse</code>.
     */
 ...
 */
DescribeServersResponse.prototype['Servers'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeServersResponse.prototype['NextToken'] = undefined;
...
export default DescribeServersResponse;
