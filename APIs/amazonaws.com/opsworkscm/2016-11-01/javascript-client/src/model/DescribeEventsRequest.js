...
class DescribeEventsRequest {
    ...
    constructor(serverName) { 
        ...
        DescribeEventsRequest.initialize(this, serverName);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of DescribeEventsRequest.RequiredProperties) {
...
DescribeEventsRequest.RequiredProperties = ["ServerName"];

/**
 * @member {String} ServerName
 */
DescribeEventsRequest.prototype['ServerName'] = undefined;
