...
/**
 * The RestoreServerRequest model module.
 * @module model/RestoreServerRequest
 * @version 2016-11-01
 */
class RestoreServerRequest {
    /**
     * Constructs a new <code>RestoreServerRequest</code>.
     * @alias module:model/RestoreServerRequest
     * @param backupId {String} 
     * @param serverName {String} 
     */
    constructor(backupId, serverName) { 
        
        RestoreServerRequest.initialize(this, backupId, serverName);
    }
     ...
     */
    static initialize(obj, backupId, serverName) { 
        obj['BackupId'] = backupId;
        obj['ServerName'] = serverName;
    }

    /**
     * Constructs a <code>RestoreServerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RestoreServerRequest} obj Optional instance to populate.
     * @return {module:model/RestoreServerRequest} The populated <code>RestoreServerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestoreServerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RestoreServerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestoreServerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RestoreServerRequest.RequiredProperties) {
...
RestoreServerRequest.RequiredProperties = ["BackupId", "ServerName"];

/**
 * @member {String} BackupId
 */
RestoreServerRequest.prototype['BackupId'] = undefined;

/**
 * @member {String} ServerName
 */
RestoreServerRequest.prototype['ServerName'] = undefined;

/**
 * @member {String} InstanceType
 */
RestoreServerRequest.prototype['InstanceType'] = undefined;

/**
 * @member {String} KeyPair
 */
RestoreServerRequest.prototype['KeyPair'] = undefined;
...
export default RestoreServerRequest;
