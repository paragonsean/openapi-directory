...
import UpdateServerEngineAttributesResponseServer from './UpdateServerEngineAttributesResponseServer';

/**
 * The UpdateServerEngineAttributesResponse model module.
 * @module model/UpdateServerEngineAttributesResponse
 * @version 2016-11-01
 */
class UpdateServerEngineAttributesResponse {
    /**
     * Constructs a new <code>UpdateServerEngineAttributesResponse</code>.
     * @alias module:model/UpdateServerEngineAttributesResponse
     */
    constructor() { 
        
        UpdateServerEngineAttributesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateServerEngineAttributesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateServerEngineAttributesResponse} obj Optional instance to populate.
     * @return {module:model/UpdateServerEngineAttributesResponse} The populated <code>UpdateServerEngineAttributesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateServerEngineAttributesResponse();

            if (data.hasOwnProperty('Server')) {
                obj['Server'] = UpdateServerEngineAttributesResponseServer.constructFromObject(data['Server']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateServerEngineAttributesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateServerEngineAttributesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Server`
        if (data['Server']) { // data not null
          UpdateServerEngineAttributesResponseServer.validateJSON(data['Server']);
        }
...
/**
 * @member {module:model/UpdateServerEngineAttributesResponseServer} Server
 */
UpdateServerEngineAttributesResponse.prototype['Server'] = undefined;
...
export default UpdateServerEngineAttributesResponse;
