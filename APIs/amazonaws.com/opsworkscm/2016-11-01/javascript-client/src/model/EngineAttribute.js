...
/**
 * The EngineAttribute model module.
 * @module model/EngineAttribute
 * @version 2016-11-01
 */
class EngineAttribute {
    /**
     * Constructs a new <code>EngineAttribute</code>.
     * A name and value pair that is specific to the engine of the server. 
     * @alias module:model/EngineAttribute
     */
    constructor() { 
        
        EngineAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EngineAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EngineAttribute} obj Optional instance to populate.
     * @return {module:model/EngineAttribute} The populated <code>EngineAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EngineAttribute();
    ...
    /**
     * Validates the JSON data with respect to <code>EngineAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EngineAttribute</code>.
     */
 ...
 * @member {String} Name
 */
EngineAttribute.prototype['Name'] = undefined;

/**
 * @member {String} Value
 */
EngineAttribute.prototype['Value'] = undefined;
...
export default EngineAttribute;
