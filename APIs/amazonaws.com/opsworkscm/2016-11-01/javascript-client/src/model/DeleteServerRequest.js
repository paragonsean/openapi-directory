...
/**
 * The DeleteServerRequest model module.
 * @module model/DeleteServerRequest
 * @version 2016-11-01
 */
class DeleteServerRequest {
    /**
     * Constructs a new <code>DeleteServerRequest</code>.
     * @alias module:model/DeleteServerRequest
     * @param serverName {String} 
     */
    constructor(serverName) { 
        
        DeleteServerRequest.initialize(this, serverName);
    }
     ...
     */
    static initialize(obj, serverName) { 
        obj['ServerName'] = serverName;
    }

    /**
     * Constructs a <code>DeleteServerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteServerRequest} obj Optional instance to populate.
     * @return {module:model/DeleteServerRequest} The populated <code>DeleteServerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteServerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteServerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteServerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteServerRequest.RequiredProperties) {
...
DeleteServerRequest.RequiredProperties = ["ServerName"];

/**
 * @member {String} ServerName
 */
DeleteServerRequest.prototype['ServerName'] = undefined;
...
export default DeleteServerRequest;
