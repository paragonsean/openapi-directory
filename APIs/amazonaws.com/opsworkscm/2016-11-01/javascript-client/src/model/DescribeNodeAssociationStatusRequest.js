...
/**
 * The DescribeNodeAssociationStatusRequest model module.
 * @module model/DescribeNodeAssociationStatusRequest
 * @version 2016-11-01
 */
class DescribeNodeAssociationStatusRequest {
    /**
     * Constructs a new <code>DescribeNodeAssociationStatusRequest</code>.
     * @alias module:model/DescribeNodeAssociationStatusRequest
     * @param nodeAssociationStatusToken {String} 
     * @param serverName {String} 
     */
    constructor(nodeAssociationStatusToken, serverName) { 
        
        DescribeNodeAssociationStatusRequest.initialize(this, nodeAssociationStatusToken, serverName);
    }
     ...
     */
    static initialize(obj, nodeAssociationStatusToken, serverName) { 
        obj['NodeAssociationStatusToken'] = nodeAssociationStatusToken;
        obj['ServerName'] = serverName;
    }

    /**
     * Constructs a <code>DescribeNodeAssociationStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeNodeAssociationStatusRequest} obj Optional instance to populate.
     * @return {module:model/DescribeNodeAssociationStatusRequest} The populated <code>DescribeNodeAssociationStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeNodeAssociationStatusRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeNodeAssociationStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeNodeAssociationStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeNodeAssociationStatusRequest.RequiredProperties) {
...
DescribeNodeAssociationStatusRequest.RequiredProperties = ["NodeAssociationStatusToken", "ServerName"];

/**
 * @member {String} NodeAssociationStatusToken
 */
DescribeNodeAssociationStatusRequest.prototype['NodeAssociationStatusToken'] = undefined;

/**
 * @member {String} ServerName
 */
DescribeNodeAssociationStatusRequest.prototype['ServerName'] = undefined;
...
export default DescribeNodeAssociationStatusRequest;
