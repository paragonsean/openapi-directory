...
import CreateServerResponseServer from './CreateServerResponseServer';
...
class CreateServerResponse {
    ...
    constructor() { 
        ...
        CreateServerResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Server')) {
                obj['Server'] = CreateServerResponseServer.constructFromObject(data['Server']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Server']) { // data not null
          CreateServerResponseServer.validateJSON(data['Server']);
        }
...
/**
 * @member {module:model/CreateServerResponseServer} Server
 */
