...
import NodeAssociationStatus from './NodeAssociationStatus';

/**
 * The DescribeNodeAssociationStatusResponse model module.
 * @module model/DescribeNodeAssociationStatusResponse
 * @version 2016-11-01
 */
class DescribeNodeAssociationStatusResponse {
    /**
     * Constructs a new <code>DescribeNodeAssociationStatusResponse</code>.
     * @alias module:model/DescribeNodeAssociationStatusResponse
     */
    constructor() { 
        
        DescribeNodeAssociationStatusResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeNodeAssociationStatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeNodeAssociationStatusResponse} obj Optional instance to populate.
     * @return {module:model/DescribeNodeAssociationStatusResponse} The populated <code>DescribeNodeAssociationStatusResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeNodeAssociationStatusResponse();

            if (data.hasOwnProperty('NodeAssociationStatus')) {
                obj['NodeAssociationStatus'] = ApiClient.convertToType(data['NodeAssociationStatus'], NodeAssociationStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeNodeAssociationStatusResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeNodeAssociationStatusResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `NodeAssociationStatus`
        if (data['NodeAssociationStatus']) { // data not null
          NodeAssociationStatus.validateJSON(data['NodeAssociationStatus']);
        }
...
/**
 * @member {module:model/NodeAssociationStatus} NodeAssociationStatus
 */
DescribeNodeAssociationStatusResponse.prototype['NodeAssociationStatus'] = undefined;

/**
 * @member {Array} EngineAttributes
 */
DescribeNodeAssociationStatusResponse.prototype['EngineAttributes'] = undefined;
...
export default DescribeNodeAssociationStatusResponse;
