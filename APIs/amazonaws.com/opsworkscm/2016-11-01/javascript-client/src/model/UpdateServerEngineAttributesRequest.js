...
/**
 * The UpdateServerEngineAttributesRequest model module.
 * @module model/UpdateServerEngineAttributesRequest
 * @version 2016-11-01
 */
class UpdateServerEngineAttributesRequest {
    /**
     * Constructs a new <code>UpdateServerEngineAttributesRequest</code>.
     * @alias module:model/UpdateServerEngineAttributesRequest
     * @param serverName {String} 
     * @param attributeName {String} 
     */
    constructor(serverName, attributeName) { 
        
        UpdateServerEngineAttributesRequest.initialize(this, serverName, attributeName);
    }
     ...
     */
    static initialize(obj, serverName, attributeName) { 
        obj['ServerName'] = serverName;
        obj['AttributeName'] = attributeName;
    }

    /**
     * Constructs a <code>UpdateServerEngineAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateServerEngineAttributesRequest} obj Optional instance to populate.
     * @return {module:model/UpdateServerEngineAttributesRequest} The populated <code>UpdateServerEngineAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateServerEngineAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateServerEngineAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateServerEngineAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateServerEngineAttributesRequest.RequiredProperties) {
...
UpdateServerEngineAttributesRequest.RequiredProperties = ["ServerName", "AttributeName"];

/**
 * @member {String} ServerName
 */
UpdateServerEngineAttributesRequest.prototype['ServerName'] = undefined;

/**
 * @member {String} AttributeName
 */
UpdateServerEngineAttributesRequest.prototype['AttributeName'] = undefined;

/**
 * @member {String} AttributeValue
 */
UpdateServerEngineAttributesRequest.prototype['AttributeValue'] = undefined;
...
export default UpdateServerEngineAttributesRequest;
