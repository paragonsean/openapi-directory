...
/**
 * The ExportServerEngineAttributeRequest model module.
 * @module model/ExportServerEngineAttributeRequest
 * @version 2016-11-01
 */
class ExportServerEngineAttributeRequest {
    /**
     * Constructs a new <code>ExportServerEngineAttributeRequest</code>.
     * @alias module:model/ExportServerEngineAttributeRequest
     * @param exportAttributeName {String} 
     * @param serverName {String} 
     */
    constructor(exportAttributeName, serverName) { 
        
        ExportServerEngineAttributeRequest.initialize(this, exportAttributeName, serverName);
    }
     ...
     */
    static initialize(obj, exportAttributeName, serverName) { 
        obj['ExportAttributeName'] = exportAttributeName;
        obj['ServerName'] = serverName;
    }

    /**
     * Constructs a <code>ExportServerEngineAttributeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportServerEngineAttributeRequest} obj Optional instance to populate.
     * @return {module:model/ExportServerEngineAttributeRequest} The populated <code>ExportServerEngineAttributeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportServerEngineAttributeRequest();

            if (data.hasOwnProperty('ExportAttributeName')) {
                obj['ExportAttributeName'] = ApiClient.convertToType(data['ExportAttributeName'], 'String');
            }
            if (data.hasOwnProperty('ServerName')) {
                obj['ServerName'] = ApiClient.convertToType(data['ServerName'], 'String');
            }
            if (data.hasOwnProperty('InputAttributes')) {
                obj['InputAttributes'] = ApiClient.convertToType(data['InputAttributes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExportServerEngineAttributeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportServerEngineAttributeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExportServerEngineAttributeRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ExportAttributeName`
        if (data['ExportAttributeName']) { // data not null
          String.validateJSON(data['ExportAttributeName']);
        }
        ...
        if (data['InputAttributes']) { // data not null
          Array.validateJSON(data['InputAttributes']);
        }
...
ExportServerEngineAttributeRequest.RequiredProperties = ["ExportAttributeName", "ServerName"];

/**
 * @member {String} ExportAttributeName
 */
ExportServerEngineAttributeRequest.prototype['ExportAttributeName'] = undefined;

/**
 * @member {String} ServerName
 */
ExportServerEngineAttributeRequest.prototype['ServerName'] = undefined;

/**
 * @member {Array} InputAttributes
 */
ExportServerEngineAttributeRequest.prototype['InputAttributes'] = undefined;
...
export default ExportServerEngineAttributeRequest;
