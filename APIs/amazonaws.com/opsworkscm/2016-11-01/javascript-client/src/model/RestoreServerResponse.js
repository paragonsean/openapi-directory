...
/**
 * The RestoreServerResponse model module.
 * @module model/RestoreServerResponse
 * @version 2016-11-01
 */
class RestoreServerResponse {
    /**
     * Constructs a new <code>RestoreServerResponse</code>.
     * @alias module:model/RestoreServerResponse
     */
    constructor() { 
        
        RestoreServerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RestoreServerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RestoreServerResponse} obj Optional instance to populate.
     * @return {module:model/RestoreServerResponse} The populated <code>RestoreServerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestoreServerResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>RestoreServerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestoreServerResponse</code>.
     */
 ...
 */
RestoreServerResponse.prototype['Server'] = undefined;
...
export default RestoreServerResponse;
