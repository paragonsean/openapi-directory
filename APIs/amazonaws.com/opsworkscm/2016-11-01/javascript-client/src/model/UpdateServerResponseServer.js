...
/**
 * The UpdateServerResponseServer model module.
 * @module model/UpdateServerResponseServer
 * @version 2016-11-01
 */
class UpdateServerResponseServer {
    /**
     * Constructs a new <code>UpdateServerResponseServer</code>.
     * @alias module:model/UpdateServerResponseServer
     * @implements module:model/Server
     */
    constructor() { 
        Server.initialize(this);
        UpdateServerResponseServer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateServerResponseServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateServerResponseServer} obj Optional instance to populate.
     * @return {module:model/UpdateServerResponseServer} The populated <code>UpdateServerResponseServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateServerResponseServer();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateServerResponseServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateServerResponseServer</code>.
     */
 ...
 */
UpdateServerResponseServer.prototype['AssociatePublicIpAddress'] = undefined;

/**
 * @member {Number} BackupRetentionCount
 */
UpdateServerResponseServer.prototype['BackupRetentionCount'] = undefined;

/**
 * @member {String} ServerName
 */
UpdateServerResponseServer.prototype['ServerName'] = undefined;

/**
 * @member {Date} CreatedAt
 */
UpdateServerResponseServer.prototype['CreatedAt'] = undefined;

/**
 * @member {String} CloudFormationStackArn
 */
UpdateServerResponseServer.prototype['CloudFormationStackArn'] = undefined;

/**
 * @member {String} CustomDomain
 */
UpdateServerResponseServer.prototype['CustomDomain'] = undefined;

/**
 * @member {Boolean} DisableAutomatedBackup
 */
UpdateServerResponseServer.prototype['DisableAutomatedBackup'] = undefined;

/**
 * @member {String} Endpoint
 */
UpdateServerResponseServer.prototype['Endpoint'] = undefined;

/**
 * @member {String} Engine
 */
UpdateServerResponseServer.prototype['Engine'] = undefined;

/**
 * @member {String} EngineModel
 */
UpdateServerResponseServer.prototype['EngineModel'] = undefined;

/**
 * @member {Array} EngineAttributes
 */
UpdateServerResponseServer.prototype['EngineAttributes'] = undefined;

/**
 * @member {String} EngineVersion
 */
UpdateServerResponseServer.prototype['EngineVersion'] = undefined;

/**
 * @member {String} InstanceProfileArn
 */
UpdateServerResponseServer.prototype['InstanceProfileArn'] = undefined;

/**
 * @member {String} InstanceType
 */
UpdateServerResponseServer.prototype['InstanceType'] = undefined;

/**
 * @member {String} KeyPair
 */
UpdateServerResponseServer.prototype['KeyPair'] = undefined;

/**
 * @member {module:model/MaintenanceStatus} MaintenanceStatus
 */
UpdateServerResponseServer.prototype['MaintenanceStatus'] = undefined;

/**
 * @member {String} PreferredMaintenanceWindow
 */
UpdateServerResponseServer.prototype['PreferredMaintenanceWindow'] = undefined;

/**
 * @member {String} PreferredBackupWindow
 */
UpdateServerResponseServer.prototype['PreferredBackupWindow'] = undefined;

/**
 * @member {Array} SecurityGroupIds
 */
UpdateServerResponseServer.prototype['SecurityGroupIds'] = undefined;

/**
 * @member {String} ServiceRoleArn
 */
UpdateServerResponseServer.prototype['ServiceRoleArn'] = undefined;

/**
 * @member {module:model/ServerStatus} Status
 */
UpdateServerResponseServer.prototype['Status'] = undefined;

/**
 * @member {String} StatusReason
 */
UpdateServerResponseServer.prototype['StatusReason'] = undefined;

/**
 * @member {Array} SubnetIds
 */
UpdateServerResponseServer.prototype['SubnetIds'] = undefined;

/**
 * @member {String} ServerArn
 */
UpdateServerResponseServer.prototype['ServerArn'] = undefined;
...
export default UpdateServerResponseServer;
