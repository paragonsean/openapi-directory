...
/**
 * The ServerEvent model module.
 * @module model/ServerEvent
 * @version 2016-11-01
 */
class ServerEvent {
    /**
     * Constructs a new <code>ServerEvent</code>.
     * An event that is related to the server, such as the start of maintenance or backup. 
     * @alias module:model/ServerEvent
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ServerEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerEvent} obj Optional instance to populate.
     * @return {module:model/ServerEvent} The populated <code>ServerEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ServerEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerEvent</code>.
     */
 ...
 */
ServerEvent.prototype['CreatedAt'] = undefined;

/**
 * @member {String} ServerName
 */
ServerEvent.prototype['ServerName'] = undefined;

/**
 * @member {String} Message
 */
ServerEvent.prototype['Message'] = undefined;

/**
 * @member {String} LogUrl
 */
ServerEvent.prototype['LogUrl'] = undefined;
