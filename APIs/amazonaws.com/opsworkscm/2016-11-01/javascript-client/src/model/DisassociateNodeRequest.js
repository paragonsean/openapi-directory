...
/**
 * The DisassociateNodeRequest model module.
 * @module model/DisassociateNodeRequest
 * @version 2016-11-01
 */
class DisassociateNodeRequest {
    /**
     * Constructs a new <code>DisassociateNodeRequest</code>.
     * @alias module:model/DisassociateNodeRequest
     * @param serverName {String} 
     * @param nodeName {String} 
     */
    constructor(serverName, nodeName) { 
        
        DisassociateNodeRequest.initialize(this, serverName, nodeName);
    }
     ...
     */
    static initialize(obj, serverName, nodeName) { 
        obj['ServerName'] = serverName;
        obj['NodeName'] = nodeName;
    }

    /**
     * Constructs a <code>DisassociateNodeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateNodeRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateNodeRequest} The populated <code>DisassociateNodeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateNodeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateNodeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateNodeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateNodeRequest.RequiredProperties) {
...
DisassociateNodeRequest.RequiredProperties = ["ServerName", "NodeName"];

/**
 * @member {String} ServerName
 */
DisassociateNodeRequest.prototype['ServerName'] = undefined;

/**
 * @member {String} NodeName
 */
DisassociateNodeRequest.prototype['NodeName'] = undefined;

/**
 * @member {Array} EngineAttributes
 */
DisassociateNodeRequest.prototype['EngineAttributes'] = undefined;
...
export default DisassociateNodeRequest;
