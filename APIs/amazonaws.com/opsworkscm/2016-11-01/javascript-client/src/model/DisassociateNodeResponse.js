...
/**
 * The DisassociateNodeResponse model module.
 * @module model/DisassociateNodeResponse
 * @version 2016-11-01
 */
class DisassociateNodeResponse {
    /**
     * Constructs a new <code>DisassociateNodeResponse</code>.
     * @alias module:model/DisassociateNodeResponse
     */
    constructor() { 
        
        DisassociateNodeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociateNodeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateNodeResponse} obj Optional instance to populate.
     * @return {module:model/DisassociateNodeResponse} The populated <code>DisassociateNodeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateNodeResponse();

            if (data.hasOwnProperty('NodeAssociationStatusToken')) {
                obj['NodeAssociationStatusToken'] = ApiClient.convertToType(data['NodeAssociationStatusToken'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateNodeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateNodeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `NodeAssociationStatusToken`
        if (data['NodeAssociationStatusToken']) { // data not null
          String.validateJSON(data['NodeAssociationStatusToken']);
        }
...
/**
 * @member {String} NodeAssociationStatusToken
 */
DisassociateNodeResponse.prototype['NodeAssociationStatusToken'] = undefined;
...
export default DisassociateNodeResponse;
