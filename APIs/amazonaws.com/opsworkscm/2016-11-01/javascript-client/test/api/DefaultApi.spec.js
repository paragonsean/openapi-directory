...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('associateNode', function() {
      it('should call associateNode successfully', function(done) {
        //uncomment below and update the code to test associateNode
        //instance.associateNode(function(error) {
    ...
    describe('describeNodeAssociationStatus', function() {
      it('should call describeNodeAssociationStatus successfully', function(done) {
        //uncomment below and update the code to test describeNodeAssociationStatus
        //instance.describeNodeAssociationStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('describeServers', function() {
      it('should call describeServers successfully', function(done) {
        //uncomment below and update the code to test describeServers
        //instance.describeServers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('disassociateNode', function() {
      it('should call disassociateNode successfully', function(done) {
        //uncomment below and update the code to test disassociateNode
        //instance.disassociateNode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('exportServerEngineAttribute', function() {
      it('should call exportServerEngineAttribute successfully', function(done) {
        //uncomment below and update the code to test exportServerEngineAttribute
        //instance.exportServerEngineAttribute(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('restoreServer', function() {
      it('should call restoreServer successfully', function(done) {
        //uncomment below and update the code to test restoreServer
        //instance.restoreServer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('startMaintenance', function() {
      it('should call startMaintenance successfully', function(done) {
        //uncomment below and update the code to test startMaintenance
        //instance.startMaintenance(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateServerEngineAttributes', function() {
      it('should call updateServerEngineAttributes successfully', function(done) {
        //uncomment below and update the code to test updateServerEngineAttributes
        //instance.updateServerEngineAttributes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
