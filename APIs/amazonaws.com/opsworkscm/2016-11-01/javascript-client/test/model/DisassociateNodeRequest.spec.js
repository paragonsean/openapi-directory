...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DisassociateNodeRequest();
  });
  ...
  describe('DisassociateNodeRequest', function() {
    it('should create an instance of DisassociateNodeRequest', function() {
      // uncomment below and update the code to test DisassociateNodeRequest
      //var instance = new AwsOpsWorksCm.DisassociateNodeRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.DisassociateNodeRequest);
    });
