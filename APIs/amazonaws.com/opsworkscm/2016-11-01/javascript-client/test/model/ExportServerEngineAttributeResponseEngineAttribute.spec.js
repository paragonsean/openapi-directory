...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.ExportServerEngineAttributeResponseEngineAttribute();
  });
  ...
  describe('ExportServerEngineAttributeResponseEngineAttribute', function() {
    it('should create an instance of ExportServerEngineAttributeResponseEngineAttribute', function() {
      // uncomment below and update the code to test ExportServerEngineAttributeResponseEngineAttribute
      //var instance = new AwsOpsWorksCm.ExportServerEngineAttributeResponseEngineAttribute();
      //expect(instance).to.be.a(AwsOpsWorksCm.ExportServerEngineAttributeResponseEngineAttribute);
    });
