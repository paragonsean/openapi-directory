...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AwsOpsWorksCm.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.ListTagsForResourceRequest);
    });
