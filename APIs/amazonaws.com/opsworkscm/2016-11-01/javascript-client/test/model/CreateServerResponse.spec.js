...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.CreateServerResponse();
  });
  ...
  describe('CreateServerResponse', function() {
    it('should create an instance of CreateServerResponse', function() {
      // uncomment below and update the code to test CreateServerResponse
      //var instance = new AwsOpsWorksCm.CreateServerResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.CreateServerResponse);
    });
