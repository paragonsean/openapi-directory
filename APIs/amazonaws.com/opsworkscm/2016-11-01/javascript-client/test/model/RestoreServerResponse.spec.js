...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.RestoreServerResponse();
  });
  ...
  describe('RestoreServerResponse', function() {
    it('should create an instance of RestoreServerResponse', function() {
      // uncomment below and update the code to test RestoreServerResponse
      //var instance = new AwsOpsWorksCm.RestoreServerResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.RestoreServerResponse);
    });
