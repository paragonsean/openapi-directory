...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.AssociateNodeResponse();
  });
  ...
  describe('AssociateNodeResponse', function() {
    it('should create an instance of AssociateNodeResponse', function() {
      // uncomment below and update the code to test AssociateNodeResponse
      //var instance = new AwsOpsWorksCm.AssociateNodeResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.AssociateNodeResponse);
    });
