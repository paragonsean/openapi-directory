...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.UpdateServerEngineAttributesResponseServer();
  });
  ...
  describe('UpdateServerEngineAttributesResponseServer', function() {
    it('should create an instance of UpdateServerEngineAttributesResponseServer', function() {
      // uncomment below and update the code to test UpdateServerEngineAttributesResponseServer
      //var instance = new AwsOpsWorksCm.UpdateServerEngineAttributesResponseServer();
      //expect(instance).to.be.a(AwsOpsWorksCm.UpdateServerEngineAttributesResponseServer);
    });
