...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.AssociateNodeRequest();
  });
  ...
  describe('AssociateNodeRequest', function() {
    it('should create an instance of AssociateNodeRequest', function() {
      // uncomment below and update the code to test AssociateNodeRequest
      //var instance = new AwsOpsWorksCm.AssociateNodeRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.AssociateNodeRequest);
    });
