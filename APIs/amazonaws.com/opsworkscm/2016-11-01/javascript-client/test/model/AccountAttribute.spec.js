...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.AccountAttribute();
  });
  ...
  describe('AccountAttribute', function() {
    it('should create an instance of AccountAttribute', function() {
      // uncomment below and update the code to test AccountAttribute
      //var instance = new AwsOpsWorksCm.AccountAttribute();
      //expect(instance).to.be.a(AwsOpsWorksCm.AccountAttribute);
    });
