...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.UpdateServerResponse();
  });
  ...
  describe('UpdateServerResponse', function() {
    it('should create an instance of UpdateServerResponse', function() {
      // uncomment below and update the code to test UpdateServerResponse
      //var instance = new AwsOpsWorksCm.UpdateServerResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.UpdateServerResponse);
    });
