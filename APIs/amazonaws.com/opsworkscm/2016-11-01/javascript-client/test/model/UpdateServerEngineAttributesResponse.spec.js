...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.UpdateServerEngineAttributesResponse();
  });
  ...
  describe('UpdateServerEngineAttributesResponse', function() {
    it('should create an instance of UpdateServerEngineAttributesResponse', function() {
      // uncomment below and update the code to test UpdateServerEngineAttributesResponse
      //var instance = new AwsOpsWorksCm.UpdateServerEngineAttributesResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.UpdateServerEngineAttributesResponse);
    });
