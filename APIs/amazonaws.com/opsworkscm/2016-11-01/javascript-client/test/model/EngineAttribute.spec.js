...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.EngineAttribute();
  });
  ...
  describe('EngineAttribute', function() {
    it('should create an instance of EngineAttribute', function() {
      // uncomment below and update the code to test EngineAttribute
      //var instance = new AwsOpsWorksCm.EngineAttribute();
      //expect(instance).to.be.a(AwsOpsWorksCm.EngineAttribute);
    });
