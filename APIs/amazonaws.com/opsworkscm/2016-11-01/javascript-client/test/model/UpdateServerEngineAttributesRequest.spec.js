...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.UpdateServerEngineAttributesRequest();
  });
  ...
  describe('UpdateServerEngineAttributesRequest', function() {
    it('should create an instance of UpdateServerEngineAttributesRequest', function() {
      // uncomment below and update the code to test UpdateServerEngineAttributesRequest
      //var instance = new AwsOpsWorksCm.UpdateServerEngineAttributesRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.UpdateServerEngineAttributesRequest);
    });
