...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.StartMaintenanceResponseServer();
  });
  ...
  describe('StartMaintenanceResponseServer', function() {
    it('should create an instance of StartMaintenanceResponseServer', function() {
      // uncomment below and update the code to test StartMaintenanceResponseServer
      //var instance = new AwsOpsWorksCm.StartMaintenanceResponseServer();
      //expect(instance).to.be.a(AwsOpsWorksCm.StartMaintenanceResponseServer);
    });
