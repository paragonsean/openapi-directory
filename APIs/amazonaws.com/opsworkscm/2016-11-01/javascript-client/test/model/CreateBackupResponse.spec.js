...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.CreateBackupResponse();
  });
  ...
  describe('CreateBackupResponse', function() {
    it('should create an instance of CreateBackupResponse', function() {
      // uncomment below and update the code to test CreateBackupResponse
      //var instance = new AwsOpsWorksCm.CreateBackupResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.CreateBackupResponse);
    });
