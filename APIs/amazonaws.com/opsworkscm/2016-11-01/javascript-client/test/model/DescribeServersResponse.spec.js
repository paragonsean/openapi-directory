...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeServersResponse();
  });
  ...
  describe('DescribeServersResponse', function() {
    it('should create an instance of DescribeServersResponse', function() {
      // uncomment below and update the code to test DescribeServersResponse
      //var instance = new AwsOpsWorksCm.DescribeServersResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeServersResponse);
    });
