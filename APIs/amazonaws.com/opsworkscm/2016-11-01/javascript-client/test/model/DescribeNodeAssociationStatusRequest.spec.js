...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeNodeAssociationStatusRequest();
  });
  ...
  describe('DescribeNodeAssociationStatusRequest', function() {
    it('should create an instance of DescribeNodeAssociationStatusRequest', function() {
      // uncomment below and update the code to test DescribeNodeAssociationStatusRequest
      //var instance = new AwsOpsWorksCm.DescribeNodeAssociationStatusRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeNodeAssociationStatusRequest);
    });

    it('should have the property nodeAssociationStatusToken (base name: "NodeAssociationStatusToken")', function() {
      // uncomment below and update the code to test the property nodeAssociationStatusToken
      //var instance = new AwsOpsWorksCm.DescribeNodeAssociationStatusRequest();
