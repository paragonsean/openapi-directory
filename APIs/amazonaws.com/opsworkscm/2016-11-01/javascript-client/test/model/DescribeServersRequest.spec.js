...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeServersRequest();
  });
  ...
  describe('DescribeServersRequest', function() {
    it('should create an instance of DescribeServersRequest', function() {
      // uncomment below and update the code to test DescribeServersRequest
      //var instance = new AwsOpsWorksCm.DescribeServersRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeServersRequest);
    });
