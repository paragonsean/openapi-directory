...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsOpsWorksCm.TagResourceRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.TagResourceRequest);
    });
