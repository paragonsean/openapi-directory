...
(function(root, factory) {
  ...
  describe('BackupType', function() {
    it('should create an instance of BackupType', function() {
      // uncomment below and update the code to test BackupType
      //var instance = new AwsOpsWorksCm.BackupType();
      //expect(instance).to.be.a(AwsOpsWorksCm.BackupType);
    });
