...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeBackupsRequest();
  });
  ...
  describe('DescribeBackupsRequest', function() {
    it('should create an instance of DescribeBackupsRequest', function() {
      ...
      //var instance = new AwsOpsWorksCm.DescribeBackupsRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeBackupsRequest);
    });
