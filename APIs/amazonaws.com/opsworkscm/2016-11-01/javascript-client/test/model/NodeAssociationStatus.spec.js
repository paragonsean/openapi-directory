...
(function(root, factory) {
  ...
  describe('NodeAssociationStatus', function() {
    it('should create an instance of NodeAssociationStatus', function() {
      // uncomment below and update the code to test NodeAssociationStatus
      //var instance = new AwsOpsWorksCm.NodeAssociationStatus();
      //expect(instance).to.be.a(AwsOpsWorksCm.NodeAssociationStatus);
    });
