...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AwsOpsWorksCm.UntagResourceRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.UntagResourceRequest);
    });
