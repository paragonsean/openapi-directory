...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeBackupsResponse();
  });
  ...
  describe('DescribeBackupsResponse', function() {
    it('should create an instance of DescribeBackupsResponse', function() {
      ...
      //var instance = new AwsOpsWorksCm.DescribeBackupsResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeBackupsResponse);
    });
