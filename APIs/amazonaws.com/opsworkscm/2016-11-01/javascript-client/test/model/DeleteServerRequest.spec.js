...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DeleteServerRequest();
  });
  ...
  describe('DeleteServerRequest', function() {
    it('should create an instance of DeleteServerRequest', function() {
      ...
      //var instance = new AwsOpsWorksCm.DeleteServerRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.DeleteServerRequest);
    });
