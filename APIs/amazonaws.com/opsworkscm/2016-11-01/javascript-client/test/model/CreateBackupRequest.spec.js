...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.CreateBackupRequest();
  });
  ...
  describe('CreateBackupRequest', function() {
    it('should create an instance of CreateBackupRequest', function() {
      ...
      //var instance = new AwsOpsWorksCm.CreateBackupRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.CreateBackupRequest);
    });
