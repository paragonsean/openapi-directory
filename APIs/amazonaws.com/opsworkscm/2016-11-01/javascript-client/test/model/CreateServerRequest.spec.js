...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.CreateServerRequest();
  });
  ...
  describe('CreateServerRequest', function() {
    it('should create an instance of CreateServerRequest', function() {
      // uncomment below and update the code to test CreateServerRequest
      //var instance = new AwsOpsWorksCm.CreateServerRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.CreateServerRequest);
    });
    ...
    it('should have the property customCertificate (base name: "CustomCertificate")', function() {
      // uncomment below and update the code to test the property customCertificate
      //var instance = new AwsOpsWorksCm.CreateServerRequest();
      //expect(instance).to.be();
    });

    it('should have the property customPrivateKey (base name: "CustomPrivateKey")', function() {
      // uncomment below and update the code to test the property customPrivateKey
      //var instance = new AwsOpsWorksCm.CreateServerRequest();
      //expect(instance).to.be();
    });
