...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeAccountAttributesResponse();
  });
  ...
  describe('DescribeAccountAttributesResponse', function() {
    it('should create an instance of DescribeAccountAttributesResponse', function() {
      // uncomment below and update the code to test DescribeAccountAttributesResponse
      //var instance = new AwsOpsWorksCm.DescribeAccountAttributesResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeAccountAttributesResponse);
    });
