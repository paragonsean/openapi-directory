...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.UpdateServerRequest();
  });
  ...
  describe('UpdateServerRequest', function() {
    it('should create an instance of UpdateServerRequest', function() {
      // uncomment below and update the code to test UpdateServerRequest
      //var instance = new AwsOpsWorksCm.UpdateServerRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.UpdateServerRequest);
    });
