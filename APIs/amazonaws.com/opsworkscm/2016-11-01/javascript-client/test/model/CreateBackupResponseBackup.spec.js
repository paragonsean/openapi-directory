...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.CreateBackupResponseBackup();
  });
  ...
  describe('CreateBackupResponseBackup', function() {
    it('should create an instance of CreateBackupResponseBackup', function() {
      ...
      //var instance = new AwsOpsWorksCm.CreateBackupResponseBackup();
      //expect(instance).to.be.a(AwsOpsWorksCm.CreateBackupResponseBackup);
    });
    ...
    it('should have the property s3DataSize (base name: "S3DataSize")', function() {
      // uncomment below and update the code to test the property s3DataSize
      //var instance = new AwsOpsWorksCm.CreateBackupResponseBackup();
      //expect(instance).to.be();
    });

    it('should have the property s3DataUrl (base name: "S3DataUrl")', function() {
      // uncomment below and update the code to test the property s3DataUrl
      //var instance = new AwsOpsWorksCm.CreateBackupResponseBackup();
      //expect(instance).to.be();
    });

    it('should have the property s3LogUrl (base name: "S3LogUrl")', function() {
      // uncomment below and update the code to test the property s3LogUrl
      //var instance = new AwsOpsWorksCm.CreateBackupResponseBackup();
      //expect(instance).to.be();
    });
    ...
    it('should have the property toolsVersion (base name: "ToolsVersion")', function() {
      // uncomment below and update the code to test the property toolsVersion
      //var instance = new AwsOpsWorksCm.CreateBackupResponseBackup();
      //expect(instance).to.be();
    });
