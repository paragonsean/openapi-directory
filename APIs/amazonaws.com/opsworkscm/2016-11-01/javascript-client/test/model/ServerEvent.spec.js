...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.ServerEvent();
  });
  ...
  describe('ServerEvent', function() {
    it('should create an instance of ServerEvent', function() {
      // uncomment below and update the code to test ServerEvent
      //var instance = new AwsOpsWorksCm.ServerEvent();
      //expect(instance).to.be.a(AwsOpsWorksCm.ServerEvent);
    });
