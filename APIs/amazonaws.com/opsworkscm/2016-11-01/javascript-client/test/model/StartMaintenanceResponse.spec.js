...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.StartMaintenanceResponse();
  });
  ...
  describe('StartMaintenanceResponse', function() {
    it('should create an instance of StartMaintenanceResponse', function() {
      // uncomment below and update the code to test StartMaintenanceResponse
      //var instance = new AwsOpsWorksCm.StartMaintenanceResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.StartMaintenanceResponse);
    });
