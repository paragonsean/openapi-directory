...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.RestoreServerRequest();
  });
  ...
  describe('RestoreServerRequest', function() {
    it('should create an instance of RestoreServerRequest', function() {
      // uncomment below and update the code to test RestoreServerRequest
      //var instance = new AwsOpsWorksCm.RestoreServerRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.RestoreServerRequest);
    });
