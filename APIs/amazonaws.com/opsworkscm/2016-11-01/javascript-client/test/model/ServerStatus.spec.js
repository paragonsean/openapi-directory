...
(function(root, factory) {
  ...
  describe('ServerStatus', function() {
    it('should create an instance of ServerStatus', function() {
      // uncomment below and update the code to test ServerStatus
      //var instance = new AwsOpsWorksCm.ServerStatus();
      //expect(instance).to.be.a(AwsOpsWorksCm.ServerStatus);
    });
