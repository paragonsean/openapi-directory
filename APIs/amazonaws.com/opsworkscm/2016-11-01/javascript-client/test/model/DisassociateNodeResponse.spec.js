...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DisassociateNodeResponse();
  });
  ...
  describe('DisassociateNodeResponse', function() {
    it('should create an instance of DisassociateNodeResponse', function() {
      // uncomment below and update the code to test DisassociateNodeResponse
      //var instance = new AwsOpsWorksCm.DisassociateNodeResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.DisassociateNodeResponse);
    });
