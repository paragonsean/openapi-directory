...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.ExportServerEngineAttributeRequest();
  });
  ...
  describe('ExportServerEngineAttributeRequest', function() {
    it('should create an instance of ExportServerEngineAttributeRequest', function() {
      // uncomment below and update the code to test ExportServerEngineAttributeRequest
      //var instance = new AwsOpsWorksCm.ExportServerEngineAttributeRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.ExportServerEngineAttributeRequest);
    });

    it('should have the property exportAttributeName (base name: "ExportAttributeName")', function() {
      // uncomment below and update the code to test the property exportAttributeName
      //var instance = new AwsOpsWorksCm.ExportServerEngineAttributeRequest();
    ...
    it('should have the property inputAttributes (base name: "InputAttributes")', function() {
      // uncomment below and update the code to test the property inputAttributes
      //var instance = new AwsOpsWorksCm.ExportServerEngineAttributeRequest();
      //expect(instance).to.be();
    });
