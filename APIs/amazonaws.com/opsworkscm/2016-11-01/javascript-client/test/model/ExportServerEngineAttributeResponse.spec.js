...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.ExportServerEngineAttributeResponse();
  });
  ...
  describe('ExportServerEngineAttributeResponse', function() {
    it('should create an instance of ExportServerEngineAttributeResponse', function() {
      // uncomment below and update the code to test ExportServerEngineAttributeResponse
      //var instance = new AwsOpsWorksCm.ExportServerEngineAttributeResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.ExportServerEngineAttributeResponse);
    });

    it('should have the property engineAttribute (base name: "EngineAttribute")', function() {
      // uncomment below and update the code to test the property engineAttribute
      //var instance = new AwsOpsWorksCm.ExportServerEngineAttributeResponse();
