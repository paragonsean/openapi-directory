...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeEventsRequest();
  });
  ...
  describe('DescribeEventsRequest', function() {
    it('should create an instance of DescribeEventsRequest', function() {
      ...
      //var instance = new AwsOpsWorksCm.DescribeEventsRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeEventsRequest);
    });
