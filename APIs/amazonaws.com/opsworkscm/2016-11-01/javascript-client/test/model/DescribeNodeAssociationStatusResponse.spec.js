...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DescribeNodeAssociationStatusResponse();
  });
  ...
  describe('DescribeNodeAssociationStatusResponse', function() {
    it('should create an instance of DescribeNodeAssociationStatusResponse', function() {
      // uncomment below and update the code to test DescribeNodeAssociationStatusResponse
      //var instance = new AwsOpsWorksCm.DescribeNodeAssociationStatusResponse();
      //expect(instance).to.be.a(AwsOpsWorksCm.DescribeNodeAssociationStatusResponse);
    });

    it('should have the property nodeAssociationStatus (base name: "NodeAssociationStatus")', function() {
      // uncomment below and update the code to test the property nodeAssociationStatus
      //var instance = new AwsOpsWorksCm.DescribeNodeAssociationStatusResponse();
