...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.DeleteBackupRequest();
  });
  ...
  describe('DeleteBackupRequest', function() {
    it('should create an instance of DeleteBackupRequest', function() {
      // uncomment below and update the code to test DeleteBackupRequest
      //var instance = new AwsOpsWorksCm.DeleteBackupRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.DeleteBackupRequest);
    });
