...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.StartMaintenanceRequest();
  });
  ...
  describe('StartMaintenanceRequest', function() {
    it('should create an instance of StartMaintenanceRequest', function() {
      // uncomment below and update the code to test StartMaintenanceRequest
      //var instance = new AwsOpsWorksCm.StartMaintenanceRequest();
      //expect(instance).to.be.a(AwsOpsWorksCm.StartMaintenanceRequest);
    });
