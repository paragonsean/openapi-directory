...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsOpsWorksCm.UpdateServerResponseServer();
  });
  ...
  describe('UpdateServerResponseServer', function() {
    it('should create an instance of UpdateServerResponseServer', function() {
      // uncomment below and update the code to test UpdateServerResponseServer
      //var instance = new AwsOpsWorksCm.UpdateServerResponseServer();
      //expect(instance).to.be.a(AwsOpsWorksCm.UpdateServerResponseServer);
    });
