...
public class DomainInfo {
  ...
  public DomainInfo status(RegistrationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DomainInfo arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, domainInfo.name) &&
        ...
        Objects.equals(this.arn, domainInfo.arn);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : DomainInfo.openapiRequiredFields) {
