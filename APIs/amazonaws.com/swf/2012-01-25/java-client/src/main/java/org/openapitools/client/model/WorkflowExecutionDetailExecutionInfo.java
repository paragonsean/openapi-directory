...
public class WorkflowExecutionDetailExecutionInfo {
  ...
  public WorkflowExecutionDetailExecutionInfo() {
  }

  public WorkflowExecutionDetailExecutionInfo execution(WorkflowExecutionInfoExecution execution) {
  ...
  public WorkflowExecutionDetailExecutionInfo workflowType(WorkflowExecutionInfoWorkflowType workflowType) {
  ...
  public WorkflowExecutionDetailExecutionInfo startTimestamp(OffsetDateTime startTimestamp) {
  ...
  public WorkflowExecutionDetailExecutionInfo closeTimestamp(OffsetDateTime closeTimestamp) {
  ...
  public WorkflowExecutionDetailExecutionInfo executionStatus(ExecutionStatus executionStatus) {
  ...
  public WorkflowExecutionDetailExecutionInfo closeStatus(CloseStatus closeStatus) {
  ...
  public WorkflowExecutionDetailExecutionInfo parent(WorkflowExecutionInfoParent parent) {
    this.parent = parent;
    return this;
  }
  ...
  public WorkflowExecutionDetailExecutionInfo tagList(List tagList) {
  ...
  public WorkflowExecutionDetailExecutionInfo cancelRequested(Boolean cancelRequested) {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowExecutionDetailExecutionInfo workflowExecutionDetailExecutionInfo = (WorkflowExecutionDetailExecutionInfo) o;
    return Objects.equals(this.execution, workflowExecutionDetailExecutionInfo.execution) &&
        Objects.equals(this.workflowType, workflowExecutionDetailExecutionInfo.workflowType) &&
        Objects.equals(this.startTimestamp, workflowExecutionDetailExecutionInfo.startTimestamp) &&
        Objects.equals(this.closeTimestamp, workflowExecutionDetailExecutionInfo.closeTimestamp) &&
        Objects.equals(this.executionStatus, workflowExecutionDetailExecutionInfo.executionStatus) &&
        Objects.equals(this.closeStatus, workflowExecutionDetailExecutionInfo.closeStatus) &&
        Objects.equals(this.parent, workflowExecutionDetailExecutionInfo.parent) &&
        Objects.equals(this.tagList, workflowExecutionDetailExecutionInfo.tagList) &&
        Objects.equals(this.cancelRequested, workflowExecutionDetailExecutionInfo.cancelRequested);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkflowExecutionDetailExecutionInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkflowExecutionDetailExecutionInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowExecutionDetailExecutionInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowExecutionDetailExecutionInfo is not found in the empty JSON string", WorkflowExecutionDetailExecutionInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowExecutionDetailExecutionInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowExecutionDetailExecutionInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowExecutionDetailExecutionInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowExecutionDetailExecutionInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowExecutionDetailExecutionInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowExecutionDetailExecutionInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowExecutionDetailExecutionInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowExecutionDetailExecutionInfo>() {
           @Override
           public void write(JsonWriter out, WorkflowExecutionDetailExecutionInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowExecutionDetailExecutionInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WorkflowExecutionDetailExecutionInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkflowExecutionDetailExecutionInfo
   * @throws IOException if the JSON string is invalid with respect to WorkflowExecutionDetailExecutionInfo
   */
  public static WorkflowExecutionDetailExecutionInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowExecutionDetailExecutionInfo.class);
  }

  /**
   * Convert an instance of WorkflowExecutionDetailExecutionInfo to an JSON string
   *
   * @return JSON string
   */
