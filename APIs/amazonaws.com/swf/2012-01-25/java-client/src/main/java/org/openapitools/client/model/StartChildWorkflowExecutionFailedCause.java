...
/**
 * Gets or Sets StartChildWorkflowExecutionFailedCause
 */
@JsonAdapter(StartChildWorkflowExecutionFailedCause.Adapter.class)
public enum StartChildWorkflowExecutionFailedCause {
  ...
  StartChildWorkflowExecutionFailedCause(String value) {
    this.value = value;
  }
  ...
  public static StartChildWorkflowExecutionFailedCause fromValue(String value) {
    for (StartChildWorkflowExecutionFailedCause b : StartChildWorkflowExecutionFailedCause.values()) {
  ...
  public static class Adapter extends TypeAdapter<StartChildWorkflowExecutionFailedCause> {
    @Override
    public void write(final JsonWriter jsonWriter, final StartChildWorkflowExecutionFailedCause enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StartChildWorkflowExecutionFailedCause read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StartChildWorkflowExecutionFailedCause.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StartChildWorkflowExecutionFailedCause.fromValue(value);
  }
}
