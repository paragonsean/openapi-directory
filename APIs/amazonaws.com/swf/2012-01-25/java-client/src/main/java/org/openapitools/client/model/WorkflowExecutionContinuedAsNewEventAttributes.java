...
public class WorkflowExecutionContinuedAsNewEventAttributes {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes input(String input) {
    this.input = input;
    return this;
  }
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes decisionTaskCompletedEventId(Integer decisionTaskCompletedEventId) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes newExecutionRunId(String newExecutionRunId) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes executionStartToCloseTimeout(String executionStartToCloseTimeout) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes taskList(ContinueAsNewWorkflowExecutionDecisionAttributesTaskList taskList) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes taskPriority(String taskPriority) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes taskStartToCloseTimeout(String taskStartToCloseTimeout) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes childPolicy(ChildPolicy childPolicy) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes tagList(List tagList) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes workflowType(WorkflowExecutionStartedEventAttributesWorkflowType workflowType) {
  ...
  public WorkflowExecutionContinuedAsNewEventAttributes lambdaRole(String lambdaRole) {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowExecutionContinuedAsNewEventAttributes workflowExecutionContinuedAsNewEventAttributes = (WorkflowExecutionContinuedAsNewEventAttributes) o;
    return Objects.equals(this.input, workflowExecutionContinuedAsNewEventAttributes.input) &&
        Objects.equals(this.decisionTaskCompletedEventId, workflowExecutionContinuedAsNewEventAttributes.decisionTaskCompletedEventId) &&
        Objects.equals(this.newExecutionRunId, workflowExecutionContinuedAsNewEventAttributes.newExecutionRunId) &&
        Objects.equals(this.executionStartToCloseTimeout, workflowExecutionContinuedAsNewEventAttributes.executionStartToCloseTimeout) &&
        Objects.equals(this.taskList, workflowExecutionContinuedAsNewEventAttributes.taskList) &&
        Objects.equals(this.taskPriority, workflowExecutionContinuedAsNewEventAttributes.taskPriority) &&
        Objects.equals(this.taskStartToCloseTimeout, workflowExecutionContinuedAsNewEventAttributes.taskStartToCloseTimeout) &&
        Objects.equals(this.childPolicy, workflowExecutionContinuedAsNewEventAttributes.childPolicy) &&
        Objects.equals(this.tagList, workflowExecutionContinuedAsNewEventAttributes.tagList) &&
        Objects.equals(this.workflowType, workflowExecutionContinuedAsNewEventAttributes.workflowType) &&
        Objects.equals(this.lambdaRole, workflowExecutionContinuedAsNewEventAttributes.lambdaRole);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkflowExecutionContinuedAsNewEventAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkflowExecutionContinuedAsNewEventAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowExecutionContinuedAsNewEventAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowExecutionContinuedAsNewEventAttributes is not found in the empty JSON string", WorkflowExecutionContinuedAsNewEventAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowExecutionContinuedAsNewEventAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowExecutionContinuedAsNewEventAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowExecutionContinuedAsNewEventAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowExecutionContinuedAsNewEventAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowExecutionContinuedAsNewEventAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowExecutionContinuedAsNewEventAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowExecutionContinuedAsNewEventAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowExecutionContinuedAsNewEventAttributes>() {
           @Override
           public void write(JsonWriter out, WorkflowExecutionContinuedAsNewEventAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowExecutionContinuedAsNewEventAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WorkflowExecutionContinuedAsNewEventAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkflowExecutionContinuedAsNewEventAttributes
   * @throws IOException if the JSON string is invalid with respect to WorkflowExecutionContinuedAsNewEventAttributes
   */
  public static WorkflowExecutionContinuedAsNewEventAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowExecutionContinuedAsNewEventAttributes.class);
  }

  /**
   * Convert an instance of WorkflowExecutionContinuedAsNewEventAttributes to an JSON string
   *
   * @return JSON string
   */
