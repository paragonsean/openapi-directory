...
import org.openapitools.client.model.ScheduleActivityTaskDecisionAttributesActivityType;
import org.openapitools.client.model.ScheduleActivityTaskDecisionAttributesTaskList;
...
public class ScheduleActivityTaskDecisionAttributes {
  ...
  private ScheduleActivityTaskDecisionAttributesActivityType activityType;
  ...
  private ScheduleActivityTaskDecisionAttributesTaskList taskList;
  ...
  public ScheduleActivityTaskDecisionAttributes activityType(ScheduleActivityTaskDecisionAttributesActivityType activityType) {
  ...
  public ScheduleActivityTaskDecisionAttributesActivityType getActivityType() {
    return activityType;
  }

  public void setActivityType(ScheduleActivityTaskDecisionAttributesActivityType activityType) {
    this.activityType = activityType;
  }


  public ScheduleActivityTaskDecisionAttributes activityId(String activityId) {
  ...
  public ScheduleActivityTaskDecisionAttributes control(String control) {
  ...
  public ScheduleActivityTaskDecisionAttributes input(String input) {
    this.input = input;
    return this;
  }
  ...
  public ScheduleActivityTaskDecisionAttributes scheduleToCloseTimeout(String scheduleToCloseTimeout) {
  ...
  public ScheduleActivityTaskDecisionAttributes taskList(ScheduleActivityTaskDecisionAttributesTaskList taskList) {
   ...
   */
  @javax.annotation.Nullable
  public ScheduleActivityTaskDecisionAttributesTaskList getTaskList() {
    return taskList;
  }

  public void setTaskList(ScheduleActivityTaskDecisionAttributesTaskList taskList) {
    this.taskList = taskList;
  }


  public ScheduleActivityTaskDecisionAttributes taskPriority(String taskPriority) {
  ...
  public ScheduleActivityTaskDecisionAttributes scheduleToStartTimeout(String scheduleToStartTimeout) {
  ...
  public ScheduleActivityTaskDecisionAttributes startToCloseTimeout(String startToCloseTimeout) {
  ...
  public ScheduleActivityTaskDecisionAttributes heartbeatTimeout(String heartbeatTimeout) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleActivityTaskDecisionAttributes scheduleActivityTaskDecisionAttributes = (ScheduleActivityTaskDecisionAttributes) o;
    return Objects.equals(this.activityType, scheduleActivityTaskDecisionAttributes.activityType) &&
        Objects.equals(this.activityId, scheduleActivityTaskDecisionAttributes.activityId) &&
        Objects.equals(this.control, scheduleActivityTaskDecisionAttributes.control) &&
        Objects.equals(this.input, scheduleActivityTaskDecisionAttributes.input) &&
        Objects.equals(this.scheduleToCloseTimeout, scheduleActivityTaskDecisionAttributes.scheduleToCloseTimeout) &&
        Objects.equals(this.taskList, scheduleActivityTaskDecisionAttributes.taskList) &&
        Objects.equals(this.taskPriority, scheduleActivityTaskDecisionAttributes.taskPriority) &&
        Objects.equals(this.scheduleToStartTimeout, scheduleActivityTaskDecisionAttributes.scheduleToStartTimeout) &&
        Objects.equals(this.startToCloseTimeout, scheduleActivityTaskDecisionAttributes.startToCloseTimeout) &&
        Objects.equals(this.heartbeatTimeout, scheduleActivityTaskDecisionAttributes.heartbeatTimeout);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activityType, activityId, control, input, scheduleToCloseTimeout, taskList, taskPriority, scheduleToStartTimeout, startToCloseTimeout, heartbeatTimeout);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScheduleActivityTaskDecisionAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleActivityTaskDecisionAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleActivityTaskDecisionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleActivityTaskDecisionAttributes is not found in the empty JSON string", ScheduleActivityTaskDecisionAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleActivityTaskDecisionAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleActivityTaskDecisionAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScheduleActivityTaskDecisionAttributes.openapiRequiredFields) {
      ...
      ScheduleActivityTaskDecisionAttributesActivityType.validateJsonElement(jsonObj.get("activityType"));
      ...
      if (jsonObj.get("taskList") != null && !jsonObj.get("taskList").isJsonNull()) {
        ScheduleActivityTaskDecisionAttributesTaskList.validateJsonElement(jsonObj.get("taskList"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleActivityTaskDecisionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleActivityTaskDecisionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleActivityTaskDecisionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleActivityTaskDecisionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleActivityTaskDecisionAttributes>() {
           @Override
           public void write(JsonWriter out, ScheduleActivityTaskDecisionAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleActivityTaskDecisionAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleActivityTaskDecisionAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleActivityTaskDecisionAttributes
   * @throws IOException if the JSON string is invalid with respect to ScheduleActivityTaskDecisionAttributes
   */
  public static ScheduleActivityTaskDecisionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleActivityTaskDecisionAttributes.class);
  }

  /**
   * Convert an instance of ScheduleActivityTaskDecisionAttributes to an JSON string
   *
   * @return JSON string
   */
