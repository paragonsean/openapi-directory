...
public class ActivityTaskScheduledEventAttributes {
  ...
  public ActivityTaskScheduledEventAttributes activityType(ActivityTaskScheduledEventAttributesActivityType activityType) {
  ...
  public ActivityTaskScheduledEventAttributes activityId(String activityId) {
  ...
  public ActivityTaskScheduledEventAttributes input(String input) {
    this.input = input;
    return this;
  }
  ...
  public ActivityTaskScheduledEventAttributes control(String control) {
  ...
  public ActivityTaskScheduledEventAttributes scheduleToStartTimeout(String scheduleToStartTimeout) {
  ...
  public ActivityTaskScheduledEventAttributes scheduleToCloseTimeout(String scheduleToCloseTimeout) {
  ...
  public ActivityTaskScheduledEventAttributes startToCloseTimeout(String startToCloseTimeout) {
  ...
  public ActivityTaskScheduledEventAttributes taskList(ActivityTaskScheduledEventAttributesTaskList taskList) {
  ...
  public ActivityTaskScheduledEventAttributes taskPriority(String taskPriority) {
  ...
  public ActivityTaskScheduledEventAttributes decisionTaskCompletedEventId(Integer decisionTaskCompletedEventId) {
  ...
  public ActivityTaskScheduledEventAttributes heartbeatTimeout(String heartbeatTimeout) {
  ...
  public boolean equals(Object o) {
    ...
    ActivityTaskScheduledEventAttributes activityTaskScheduledEventAttributes = (ActivityTaskScheduledEventAttributes) o;
    return Objects.equals(this.activityType, activityTaskScheduledEventAttributes.activityType) &&
        Objects.equals(this.activityId, activityTaskScheduledEventAttributes.activityId) &&
        Objects.equals(this.input, activityTaskScheduledEventAttributes.input) &&
        Objects.equals(this.control, activityTaskScheduledEventAttributes.control) &&
        Objects.equals(this.scheduleToStartTimeout, activityTaskScheduledEventAttributes.scheduleToStartTimeout) &&
        Objects.equals(this.scheduleToCloseTimeout, activityTaskScheduledEventAttributes.scheduleToCloseTimeout) &&
        Objects.equals(this.startToCloseTimeout, activityTaskScheduledEventAttributes.startToCloseTimeout) &&
        Objects.equals(this.taskList, activityTaskScheduledEventAttributes.taskList) &&
        Objects.equals(this.taskPriority, activityTaskScheduledEventAttributes.taskPriority) &&
        Objects.equals(this.decisionTaskCompletedEventId, activityTaskScheduledEventAttributes.decisionTaskCompletedEventId) &&
        Objects.equals(this.heartbeatTimeout, activityTaskScheduledEventAttributes.heartbeatTimeout);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActivityTaskScheduledEventAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActivityTaskScheduledEventAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActivityTaskScheduledEventAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActivityTaskScheduledEventAttributes is not found in the empty JSON string", ActivityTaskScheduledEventAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActivityTaskScheduledEventAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActivityTaskScheduledEventAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActivityTaskScheduledEventAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActivityTaskScheduledEventAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActivityTaskScheduledEventAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActivityTaskScheduledEventAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActivityTaskScheduledEventAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ActivityTaskScheduledEventAttributes>() {
           @Override
           public void write(JsonWriter out, ActivityTaskScheduledEventAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActivityTaskScheduledEventAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActivityTaskScheduledEventAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActivityTaskScheduledEventAttributes
   * @throws IOException if the JSON string is invalid with respect to ActivityTaskScheduledEventAttributes
   */
  public static ActivityTaskScheduledEventAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActivityTaskScheduledEventAttributes.class);
  }

  /**
   * Convert an instance of ActivityTaskScheduledEventAttributes to an JSON string
   *
   * @return JSON string
   */
