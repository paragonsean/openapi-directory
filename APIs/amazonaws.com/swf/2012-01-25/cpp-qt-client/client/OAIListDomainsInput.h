...
/*
 * OAIListDomainsInput.h
 *
 * 
 */

#ifndef OAIListDomainsInput_H
#define OAIListDomainsInput_H
...
class OAIListDomainsInput : public OAIObject {
public:
    OAIListDomainsInput();
    OAIListDomainsInput(QString json);
    ~OAIListDomainsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDomainsInput)

#endif // OAIListDomainsInput_H
