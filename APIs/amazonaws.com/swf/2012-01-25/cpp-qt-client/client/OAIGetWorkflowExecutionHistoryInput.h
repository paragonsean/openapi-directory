...
/*
 * OAIGetWorkflowExecutionHistoryInput.h
 *
 * 
 */

#ifndef OAIGetWorkflowExecutionHistoryInput_H
#define OAIGetWorkflowExecutionHistoryInput_H
...
namespace OpenAPI {
class OAIGetWorkflowExecutionHistoryInput_execution;

class OAIGetWorkflowExecutionHistoryInput : public OAIObject {
public:
    OAIGetWorkflowExecutionHistoryInput();
    OAIGetWorkflowExecutionHistoryInput(QString json);
    ~OAIGetWorkflowExecutionHistoryInput() override;
    ...
    OAIGetWorkflowExecutionHistoryInput_execution getExecution() const;
    void setExecution(const OAIGetWorkflowExecutionHistoryInput_execution &execution);
...
private:
    ...
    OAIGetWorkflowExecutionHistoryInput_execution m_execution;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWorkflowExecutionHistoryInput)

#endif // OAIGetWorkflowExecutionHistoryInput_H
