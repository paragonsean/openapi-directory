...
/*
 * OAIWorkflowExecutionCompletedEventAttributes.h
 *
 * Provides the details of the &lt;code&gt;WorkflowExecutionCompleted&lt;/code&gt; event.
 */

#ifndef OAIWorkflowExecutionCompletedEventAttributes_H
#define OAIWorkflowExecutionCompletedEventAttributes_H
...
class OAIWorkflowExecutionCompletedEventAttributes : public OAIObject {
public:
    OAIWorkflowExecutionCompletedEventAttributes();
    OAIWorkflowExecutionCompletedEventAttributes(QString json);
    ~OAIWorkflowExecutionCompletedEventAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowExecutionCompletedEventAttributes)

#endif // OAIWorkflowExecutionCompletedEventAttributes_H
