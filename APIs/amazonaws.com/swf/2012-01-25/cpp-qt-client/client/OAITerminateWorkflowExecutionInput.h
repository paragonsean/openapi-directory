...
/*
 * OAITerminateWorkflowExecutionInput.h
 *
 * 
 */

#ifndef OAITerminateWorkflowExecutionInput_H
#define OAITerminateWorkflowExecutionInput_H
...
class OAITerminateWorkflowExecutionInput : public OAIObject {
public:
    OAITerminateWorkflowExecutionInput();
    OAITerminateWorkflowExecutionInput(QString json);
    ~OAITerminateWorkflowExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITerminateWorkflowExecutionInput)

#endif // OAITerminateWorkflowExecutionInput_H
