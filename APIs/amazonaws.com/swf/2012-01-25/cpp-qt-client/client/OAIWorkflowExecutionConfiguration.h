...
/*
 * OAIWorkflowExecutionConfiguration.h
 *
 * The configuration settings for a workflow execution including timeout values, tasklist etc. These configuration settings are determined from the defaults specified when registering the workflow type and those specified when starting the workflow execution.
 */

#ifndef OAIWorkflowExecutionConfiguration_H
#define OAIWorkflowExecutionConfiguration_H
...
class OAIWorkflowExecutionConfiguration : public OAIObject {
public:
    OAIWorkflowExecutionConfiguration();
    OAIWorkflowExecutionConfiguration(QString json);
    ~OAIWorkflowExecutionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowExecutionConfiguration)

#endif // OAIWorkflowExecutionConfiguration_H
