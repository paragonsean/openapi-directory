...
/*
 * OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes.h
 *
 * 
 */

#ifndef OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes_H
#define OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes_H
...
class OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes : public OAIObject {
public:
    OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes();
    OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes(QString json);
    ~OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes)

#endif // OAIHistoryEvent_signalExternalWorkflowExecutionInitiatedEventAttributes_H
