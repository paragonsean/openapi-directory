...
/*
 * OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes.h
 *
 * Provides the details of the &lt;code&gt;RequestCancelExternalWorkflowExecutionInitiated&lt;/code&gt; event.
 */

#ifndef OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes_H
#define OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes_H
...
class OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes : public OAIObject {
public:
    OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes();
    OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes(QString json);
    ~OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes)

#endif // OAIRequestCancelExternalWorkflowExecutionInitiatedEventAttributes_H
