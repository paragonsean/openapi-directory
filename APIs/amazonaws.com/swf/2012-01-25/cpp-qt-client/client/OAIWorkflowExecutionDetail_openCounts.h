...
/*
 * OAIWorkflowExecutionDetail_openCounts.h
 *
 * 
 */

#ifndef OAIWorkflowExecutionDetail_openCounts_H
#define OAIWorkflowExecutionDetail_openCounts_H
...
class OAIWorkflowExecutionDetail_openCounts : public OAIObject {
public:
    OAIWorkflowExecutionDetail_openCounts();
    OAIWorkflowExecutionDetail_openCounts(QString json);
    ~OAIWorkflowExecutionDetail_openCounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowExecutionDetail_openCounts)

#endif // OAIWorkflowExecutionDetail_openCounts_H
