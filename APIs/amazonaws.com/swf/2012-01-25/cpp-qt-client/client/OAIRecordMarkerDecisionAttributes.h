...
/*
 * OAIRecordMarkerDecisionAttributes.h
 *
...
#ifndef OAIRecordMarkerDecisionAttributes_H
#define OAIRecordMarkerDecisionAttributes_H
...
class OAIRecordMarkerDecisionAttributes : public OAIObject {
public:
    OAIRecordMarkerDecisionAttributes();
    OAIRecordMarkerDecisionAttributes(QString json);
    ~OAIRecordMarkerDecisionAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecordMarkerDecisionAttributes)

#endif // OAIRecordMarkerDecisionAttributes_H
