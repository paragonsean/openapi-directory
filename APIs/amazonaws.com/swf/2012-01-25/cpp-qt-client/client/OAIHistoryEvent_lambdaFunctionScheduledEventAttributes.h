...
/*
 * OAIHistoryEvent_lambdaFunctionScheduledEventAttributes.h
 *
 * 
 */

#ifndef OAIHistoryEvent_lambdaFunctionScheduledEventAttributes_H
#define OAIHistoryEvent_lambdaFunctionScheduledEventAttributes_H
...
class OAIHistoryEvent_lambdaFunctionScheduledEventAttributes : public OAIObject {
public:
    OAIHistoryEvent_lambdaFunctionScheduledEventAttributes();
    OAIHistoryEvent_lambdaFunctionScheduledEventAttributes(QString json);
    ~OAIHistoryEvent_lambdaFunctionScheduledEventAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_lambdaFunctionScheduledEventAttributes)

#endif // OAIHistoryEvent_lambdaFunctionScheduledEventAttributes_H
