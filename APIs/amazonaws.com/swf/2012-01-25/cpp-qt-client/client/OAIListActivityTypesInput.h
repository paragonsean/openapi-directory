...
/*
 * OAIListActivityTypesInput.h
 *
 * 
 */

#ifndef OAIListActivityTypesInput_H
#define OAIListActivityTypesInput_H
...
class OAIListActivityTypesInput : public OAIObject {
public:
    OAIListActivityTypesInput();
    OAIListActivityTypesInput(QString json);
    ~OAIListActivityTypesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActivityTypesInput)

#endif // OAIListActivityTypesInput_H
