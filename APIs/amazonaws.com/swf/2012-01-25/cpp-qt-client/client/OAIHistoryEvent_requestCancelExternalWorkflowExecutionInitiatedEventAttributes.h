...
/*
 * OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes.h
 *
 * 
 */

#ifndef OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes_H
#define OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes_H
...
class OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes : public OAIObject {
public:
    OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes();
    OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes(QString json);
    ~OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes)

#endif // OAIHistoryEvent_requestCancelExternalWorkflowExecutionInitiatedEventAttributes_H
