...
OAIWorkflowExecutionDetail_executionConfiguration::OAIWorkflowExecutionDetail_executionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorkflowExecutionDetail_executionConfiguration::OAIWorkflowExecutionDetail_executionConfiguration() {
    this->initializeModel();
}

OAIWorkflowExecutionDetail_executionConfiguration::~OAIWorkflowExecutionDetail_executionConfiguration() {}

void OAIWorkflowExecutionDetail_executionConfiguration::initializeModel() {
...
void OAIWorkflowExecutionDetail_executionConfiguration::fromJson(QString jsonString) {
...
void OAIWorkflowExecutionDetail_executionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIWorkflowExecutionDetail_executionConfiguration::asJson() const {
...
QJsonObject OAIWorkflowExecutionDetail_executionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWorkflowExecutionDetail_executionConfiguration::getTaskStartToCloseTimeout() const {
    return m_task_start_to_close_timeout;
}
void OAIWorkflowExecutionDetail_executionConfiguration::setTaskStartToCloseTimeout(const QString &task_start_to_close_timeout) {
    m_task_start_to_close_timeout = task_start_to_close_timeout;
    m_task_start_to_close_timeout_isSet = true;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_task_start_to_close_timeout_Set() const{
    return m_task_start_to_close_timeout_isSet;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_task_start_to_close_timeout_Valid() const{
    return m_task_start_to_close_timeout_isValid;
}

QString OAIWorkflowExecutionDetail_executionConfiguration::getExecutionStartToCloseTimeout() const {
    return m_execution_start_to_close_timeout;
}
void OAIWorkflowExecutionDetail_executionConfiguration::setExecutionStartToCloseTimeout(const QString &execution_start_to_close_timeout) {
    m_execution_start_to_close_timeout = execution_start_to_close_timeout;
    m_execution_start_to_close_timeout_isSet = true;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_execution_start_to_close_timeout_Set() const{
    return m_execution_start_to_close_timeout_isSet;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_execution_start_to_close_timeout_Valid() const{
    return m_execution_start_to_close_timeout_isValid;
}

OAIWorkflowExecutionConfiguration_taskList OAIWorkflowExecutionDetail_executionConfiguration::getTaskList() const {
    return m_task_list;
}
void OAIWorkflowExecutionDetail_executionConfiguration::setTaskList(const OAIWorkflowExecutionConfiguration_taskList &task_list) {
    m_task_list = task_list;
    m_task_list_isSet = true;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_task_list_Set() const{
    return m_task_list_isSet;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_task_list_Valid() const{
    return m_task_list_isValid;
}

QString OAIWorkflowExecutionDetail_executionConfiguration::getTaskPriority() const {
    return m_task_priority;
}
void OAIWorkflowExecutionDetail_executionConfiguration::setTaskPriority(const QString &task_priority) {
    m_task_priority = task_priority;
    m_task_priority_isSet = true;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_task_priority_Set() const{
    return m_task_priority_isSet;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_task_priority_Valid() const{
    return m_task_priority_isValid;
}

OAIChildPolicy OAIWorkflowExecutionDetail_executionConfiguration::getChildPolicy() const {
    return m_child_policy;
}
void OAIWorkflowExecutionDetail_executionConfiguration::setChildPolicy(const OAIChildPolicy &child_policy) {
    m_child_policy = child_policy;
    m_child_policy_isSet = true;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_child_policy_Set() const{
    return m_child_policy_isSet;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_child_policy_Valid() const{
    return m_child_policy_isValid;
}

QString OAIWorkflowExecutionDetail_executionConfiguration::getLambdaRole() const {
    return m_lambda_role;
}
void OAIWorkflowExecutionDetail_executionConfiguration::setLambdaRole(const QString &lambda_role) {
    m_lambda_role = lambda_role;
    m_lambda_role_isSet = true;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_lambda_role_Set() const{
    return m_lambda_role_isSet;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::is_lambda_role_Valid() const{
    return m_lambda_role_isValid;
}

bool OAIWorkflowExecutionDetail_executionConfiguration::isSet() const {
...
bool OAIWorkflowExecutionDetail_executionConfiguration::isValid() const {
