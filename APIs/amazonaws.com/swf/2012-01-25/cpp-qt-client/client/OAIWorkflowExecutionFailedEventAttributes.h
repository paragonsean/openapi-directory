...
/*
 * OAIWorkflowExecutionFailedEventAttributes.h
 *
 * Provides the details of the &lt;code&gt;WorkflowExecutionFailed&lt;/code&gt; event.
 */

#ifndef OAIWorkflowExecutionFailedEventAttributes_H
#define OAIWorkflowExecutionFailedEventAttributes_H
...
class OAIWorkflowExecutionFailedEventAttributes : public OAIObject {
public:
    OAIWorkflowExecutionFailedEventAttributes();
    OAIWorkflowExecutionFailedEventAttributes(QString json);
    ~OAIWorkflowExecutionFailedEventAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowExecutionFailedEventAttributes)

#endif // OAIWorkflowExecutionFailedEventAttributes_H
