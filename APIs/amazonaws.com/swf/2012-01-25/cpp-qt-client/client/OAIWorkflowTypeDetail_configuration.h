...
/*
 * OAIWorkflowTypeDetail_configuration.h
 *
 * 
 */

#ifndef OAIWorkflowTypeDetail_configuration_H
#define OAIWorkflowTypeDetail_configuration_H
...
class OAIWorkflowTypeDetail_configuration : public OAIObject {
public:
    OAIWorkflowTypeDetail_configuration();
    OAIWorkflowTypeDetail_configuration(QString json);
    ~OAIWorkflowTypeDetail_configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowTypeDetail_configuration)

#endif // OAIWorkflowTypeDetail_configuration_H
