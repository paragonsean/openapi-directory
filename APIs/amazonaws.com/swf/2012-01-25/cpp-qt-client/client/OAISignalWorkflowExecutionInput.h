...
/*
 * OAISignalWorkflowExecutionInput.h
 *
 * 
 */

#ifndef OAISignalWorkflowExecutionInput_H
#define OAISignalWorkflowExecutionInput_H
...
class OAISignalWorkflowExecutionInput : public OAIObject {
public:
    OAISignalWorkflowExecutionInput();
    OAISignalWorkflowExecutionInput(QString json);
    ~OAISignalWorkflowExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignalWorkflowExecutionInput)

#endif // OAISignalWorkflowExecutionInput_H
