...
/*
 * OAIWorkflowExecutionContinuedAsNewEventAttributes.h
 *
 * Provides the details of the &lt;code&gt;WorkflowExecutionContinuedAsNew&lt;/code&gt; event.
 */

#ifndef OAIWorkflowExecutionContinuedAsNewEventAttributes_H
#define OAIWorkflowExecutionContinuedAsNewEventAttributes_H
...
class OAIWorkflowExecutionContinuedAsNewEventAttributes : public OAIObject {
public:
    OAIWorkflowExecutionContinuedAsNewEventAttributes();
    OAIWorkflowExecutionContinuedAsNewEventAttributes(QString json);
    ~OAIWorkflowExecutionContinuedAsNewEventAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowExecutionContinuedAsNewEventAttributes)

#endif // OAIWorkflowExecutionContinuedAsNewEventAttributes_H
