...
/*
 * OAIWorkflowExecutionDetail_executionInfo.h
 *
 * 
 */

#ifndef OAIWorkflowExecutionDetail_executionInfo_H
#define OAIWorkflowExecutionDetail_executionInfo_H
...
class OAIWorkflowExecutionDetail_executionInfo : public OAIObject {
public:
    OAIWorkflowExecutionDetail_executionInfo();
    OAIWorkflowExecutionDetail_executionInfo(QString json);
    ~OAIWorkflowExecutionDetail_executionInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowExecutionDetail_executionInfo)

#endif // OAIWorkflowExecutionDetail_executionInfo_H
