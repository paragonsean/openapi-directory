...
/**
 * The StartLambdaFunctionFailedEventAttributes model module.
 * @module model/StartLambdaFunctionFailedEventAttributes
 * @version 2012-01-25
 */
class StartLambdaFunctionFailedEventAttributes {
    /**
     * Constructs a new <code>StartLambdaFunctionFailedEventAttributes</code>.
     * Provides the details of the &lt;code&gt;StartLambdaFunctionFailed&lt;/code&gt; event. It isn&#39;t set for other event types.
     * @alias module:model/StartLambdaFunctionFailedEventAttributes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StartLambdaFunctionFailedEventAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartLambdaFunctionFailedEventAttributes} obj Optional instance to populate.
     * @return {module:model/StartLambdaFunctionFailedEventAttributes} The populated <code>StartLambdaFunctionFailedEventAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartLambdaFunctionFailedEventAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>StartLambdaFunctionFailedEventAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartLambdaFunctionFailedEventAttributes</code>.
     */
...
export default StartLambdaFunctionFailedEventAttributes;
