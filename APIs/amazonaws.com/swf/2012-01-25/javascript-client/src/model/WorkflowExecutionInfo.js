...
/**
 * The WorkflowExecutionInfo model module.
 * @module model/WorkflowExecutionInfo
 * @version 2012-01-25
 */
class WorkflowExecutionInfo {
    /**
     * Constructs a new <code>WorkflowExecutionInfo</code>.
     * Contains information about a workflow execution.
     * @alias module:model/WorkflowExecutionInfo
    ...
    /**
     * Constructs a <code>WorkflowExecutionInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkflowExecutionInfo} obj Optional instance to populate.
     * @return {module:model/WorkflowExecutionInfo} The populated <code>WorkflowExecutionInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkflowExecutionInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkflowExecutionInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkflowExecutionInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkflowExecutionInfo.RequiredProperties) {
...
WorkflowExecutionInfo.RequiredProperties = ["execution", "workflowType", "startTimestamp", "executionStatus"];
...
export default WorkflowExecutionInfo;
