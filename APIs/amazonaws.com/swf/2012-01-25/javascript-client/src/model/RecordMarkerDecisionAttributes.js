...
/**
 * The RecordMarkerDecisionAttributes model module.
 * @module model/RecordMarkerDecisionAttributes
 * @version 2012-01-25
 */
class RecordMarkerDecisionAttributes {
    /**
     * Constructs a new <code>RecordMarkerDecisionAttributes</code>.
     ...
     * @alias module:model/RecordMarkerDecisionAttributes
    ...
    /**
     * Constructs a <code>RecordMarkerDecisionAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecordMarkerDecisionAttributes} obj Optional instance to populate.
     * @return {module:model/RecordMarkerDecisionAttributes} The populated <code>RecordMarkerDecisionAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordMarkerDecisionAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>RecordMarkerDecisionAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecordMarkerDecisionAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RecordMarkerDecisionAttributes.RequiredProperties) {
...
RecordMarkerDecisionAttributes.RequiredProperties = ["markerName"];
...
export default RecordMarkerDecisionAttributes;
