...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleWorkflowService.DomainDetail();
  });
  ...
  describe('DomainDetail', function() {
    it('should create an instance of DomainDetail', function() {
      ...
      //var instance = new AmazonSimpleWorkflowService.DomainDetail();
      //expect(instance).to.be.a(AmazonSimpleWorkflowService.DomainDetail);
    });

    it('should have the property domainInfo (base name: "domainInfo")', function() {
      // uncomment below and update the code to test the property domainInfo
      //var instance = new AmazonSimpleWorkflowService.DomainDetail();
