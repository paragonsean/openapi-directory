...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleWorkflowService.History();
  });
  ...
  describe('History', function() {
    it('should create an instance of History', function() {
      ...
      //var instance = new AmazonSimpleWorkflowService.History();
      //expect(instance).to.be.a(AmazonSimpleWorkflowService.History);
    });
