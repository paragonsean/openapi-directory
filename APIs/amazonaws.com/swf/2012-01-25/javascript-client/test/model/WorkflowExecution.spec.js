...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleWorkflowService.WorkflowExecution();
  });
  ...
  describe('WorkflowExecution', function() {
    it('should create an instance of WorkflowExecution', function() {
      // uncomment below and update the code to test WorkflowExecution
      //var instance = new AmazonSimpleWorkflowService.WorkflowExecution();
      //expect(instance).to.be.a(AmazonSimpleWorkflowService.WorkflowExecution);
    });
