...
class WorkflowExecutionDetailOpenCounts(Model):
    ...
    def __init__(self, open_activity_tasks: int=None, open_decision_tasks: int=None, open_timers: int=None, open_child_workflow_executions: int=None, open_lambda_functions: int=None):
        """WorkflowExecutionDetailOpenCounts - a model defined in OpenAPI

        :param open_activity_tasks: The open_activity_tasks of this WorkflowExecutionDetailOpenCounts.
        :param open_decision_tasks: The open_decision_tasks of this WorkflowExecutionDetailOpenCounts.
        :param open_timers: The open_timers of this WorkflowExecutionDetailOpenCounts.
        :param open_child_workflow_executions: The open_child_workflow_executions of this WorkflowExecutionDetailOpenCounts.
        :param open_lambda_functions: The open_lambda_functions of this WorkflowExecutionDetailOpenCounts.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'WorkflowExecutionDetailOpenCounts':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The WorkflowExecutionDetail_openCounts of this WorkflowExecutionDetailOpenCounts.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def open_activity_tasks(self):
        """Gets the open_activity_tasks of this WorkflowExecutionDetailOpenCounts.


        :return: The open_activity_tasks of this WorkflowExecutionDetailOpenCounts.
        :rtype: int
        """
    ...
    def open_activity_tasks(self, open_activity_tasks):
        """Sets the open_activity_tasks of this WorkflowExecutionDetailOpenCounts.
    ...
    def open_decision_tasks(self):
        """Gets the open_decision_tasks of this WorkflowExecutionDetailOpenCounts.


        :return: The open_decision_tasks of this WorkflowExecutionDetailOpenCounts.
        :rtype: int
        """
    ...
    def open_decision_tasks(self, open_decision_tasks):
        """Sets the open_decision_tasks of this WorkflowExecutionDetailOpenCounts.
    ...
    def open_timers(self):
        """Gets the open_timers of this WorkflowExecutionDetailOpenCounts.


        :return: The open_timers of this WorkflowExecutionDetailOpenCounts.
        :rtype: int
        """
    ...
    def open_timers(self, open_timers):
        """Sets the open_timers of this WorkflowExecutionDetailOpenCounts.
    ...
    def open_child_workflow_executions(self):
        """Gets the open_child_workflow_executions of this WorkflowExecutionDetailOpenCounts.


        :return: The open_child_workflow_executions of this WorkflowExecutionDetailOpenCounts.
        :rtype: int
        """
    ...
    def open_child_workflow_executions(self, open_child_workflow_executions):
        """Sets the open_child_workflow_executions of this WorkflowExecutionDetailOpenCounts.
    ...
    def open_lambda_functions(self):
        """Gets the open_lambda_functions of this WorkflowExecutionDetailOpenCounts.


        :return: The open_lambda_functions of this WorkflowExecutionDetailOpenCounts.
        :rtype: int
        """
    ...
    def open_lambda_functions(self, open_lambda_functions):
        """Sets the open_lambda_functions of this WorkflowExecutionDetailOpenCounts.
