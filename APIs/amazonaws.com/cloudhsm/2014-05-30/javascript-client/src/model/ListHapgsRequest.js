...
/**
 * The ListHapgsRequest model module.
 * @module model/ListHapgsRequest
 * @version 2014-05-30
 */
class ListHapgsRequest {
    /**
     * Constructs a new <code>ListHapgsRequest</code>.
     * @alias module:model/ListHapgsRequest
     */
    constructor() { 
        
        ListHapgsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHapgsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHapgsRequest} obj Optional instance to populate.
     * @return {module:model/ListHapgsRequest} The populated <code>ListHapgsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHapgsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListHapgsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHapgsRequest</code>.
     */
 ...
 */
ListHapgsRequest.prototype['NextToken'] = undefined;
...
export default ListHapgsRequest;
