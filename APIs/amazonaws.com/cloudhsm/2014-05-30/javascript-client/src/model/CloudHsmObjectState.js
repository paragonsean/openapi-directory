...
* @readonly
*/
export default class CloudHsmObjectState {
    ...
    /**
    * Returns a <code>CloudHsmObjectState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CloudHsmObjectState} The enum <code>CloudHsmObjectState</code> value.
    */
