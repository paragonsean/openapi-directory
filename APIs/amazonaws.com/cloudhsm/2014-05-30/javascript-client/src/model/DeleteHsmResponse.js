...
/**
 * The DeleteHsmResponse model module.
 * @module model/DeleteHsmResponse
 * @version 2014-05-30
 */
class DeleteHsmResponse {
    /**
     * Constructs a new <code>DeleteHsmResponse</code>.
     * Contains the output of the &lt;a&gt;DeleteHsm&lt;/a&gt; operation.
     * @alias module:model/DeleteHsmResponse
     * @param status {String} 
     */
    constructor(status) { 
        
        DeleteHsmResponse.initialize(this, status);
    }
    ...
    /**
     * Constructs a <code>DeleteHsmResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteHsmResponse} obj Optional instance to populate.
     * @return {module:model/DeleteHsmResponse} The populated <code>DeleteHsmResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteHsmResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteHsmResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteHsmResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteHsmResponse.RequiredProperties) {
...
DeleteHsmResponse.RequiredProperties = ["Status"];

/**
 * @member {String} Status
 */
DeleteHsmResponse.prototype['Status'] = undefined;
...
export default DeleteHsmResponse;
