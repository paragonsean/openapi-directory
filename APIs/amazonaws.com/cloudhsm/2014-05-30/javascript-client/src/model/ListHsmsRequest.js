...
/**
 * The ListHsmsRequest model module.
 * @module model/ListHsmsRequest
 * @version 2014-05-30
 */
class ListHsmsRequest {
    /**
     * Constructs a new <code>ListHsmsRequest</code>.
     * @alias module:model/ListHsmsRequest
     */
    constructor() { 
        
        ListHsmsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListHsmsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListHsmsRequest} obj Optional instance to populate.
     * @return {module:model/ListHsmsRequest} The populated <code>ListHsmsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListHsmsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListHsmsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHsmsRequest</code>.
     */
 ...
 */
ListHsmsRequest.prototype['NextToken'] = undefined;
...
export default ListHsmsRequest;
