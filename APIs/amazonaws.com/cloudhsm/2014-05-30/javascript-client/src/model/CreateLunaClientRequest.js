...
/**
 * The CreateLunaClientRequest model module.
 * @module model/CreateLunaClientRequest
 * @version 2014-05-30
 */
class CreateLunaClientRequest {
    /**
     * Constructs a new <code>CreateLunaClientRequest</code>.
     * Contains the inputs for the &lt;a&gt;CreateLunaClient&lt;/a&gt; action.
     * @alias module:model/CreateLunaClientRequest
     * @param certificate {String} 
     */
    constructor(certificate) { 
        
        CreateLunaClientRequest.initialize(this, certificate);
    }
    ...
    /**
     * Constructs a <code>CreateLunaClientRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLunaClientRequest} obj Optional instance to populate.
     * @return {module:model/CreateLunaClientRequest} The populated <code>CreateLunaClientRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLunaClientRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLunaClientRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLunaClientRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLunaClientRequest.RequiredProperties) {
...
CreateLunaClientRequest.RequiredProperties = ["Certificate"];

/**
 * @member {String} Label
 */
CreateLunaClientRequest.prototype['Label'] = undefined;

/**
 * @member {String} Certificate
 */
CreateLunaClientRequest.prototype['Certificate'] = undefined;
...
export default CreateLunaClientRequest;
