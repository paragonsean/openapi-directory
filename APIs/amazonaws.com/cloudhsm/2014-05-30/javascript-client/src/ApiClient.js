...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://cloudhsm.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://cloudhsm.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2014-05-30/Javascript'
        };
