...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.CreateLunaClientRequest();
  });
  ...
  describe('CreateLunaClientRequest', function() {
    it('should create an instance of CreateLunaClientRequest', function() {
      // uncomment below and update the code to test CreateLunaClientRequest
      //var instance = new AmazonCloudHsm.CreateLunaClientRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.CreateLunaClientRequest);
    });
