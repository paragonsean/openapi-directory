...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DescribeLunaClientRequest();
  });
  ...
  describe('DescribeLunaClientRequest', function() {
    it('should create an instance of DescribeLunaClientRequest', function() {
      // uncomment below and update the code to test DescribeLunaClientRequest
      //var instance = new AmazonCloudHsm.DescribeLunaClientRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.DescribeLunaClientRequest);
    });
