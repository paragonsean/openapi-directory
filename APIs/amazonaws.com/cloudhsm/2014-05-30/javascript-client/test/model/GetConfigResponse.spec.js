...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.GetConfigResponse();
  });
  ...
  describe('GetConfigResponse', function() {
    it('should create an instance of GetConfigResponse', function() {
      // uncomment below and update the code to test GetConfigResponse
      //var instance = new AmazonCloudHsm.GetConfigResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.GetConfigResponse);
    });
    ...
    it('should have the property configCred (base name: "ConfigCred")', function() {
      // uncomment below and update the code to test the property configCred
      //var instance = new AmazonCloudHsm.GetConfigResponse();
      //expect(instance).to.be();
    });
