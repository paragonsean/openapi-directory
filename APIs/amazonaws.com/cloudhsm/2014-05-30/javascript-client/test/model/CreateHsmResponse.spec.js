...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.CreateHsmResponse();
  });
  ...
  describe('CreateHsmResponse', function() {
    it('should create an instance of CreateHsmResponse', function() {
      // uncomment below and update the code to test CreateHsmResponse
      //var instance = new AmazonCloudHsm.CreateHsmResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.CreateHsmResponse);
    });
