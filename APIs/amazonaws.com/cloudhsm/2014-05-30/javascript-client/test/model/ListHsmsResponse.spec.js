...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListHsmsResponse();
  });
  ...
  describe('ListHsmsResponse', function() {
    it('should create an instance of ListHsmsResponse', function() {
      // uncomment below and update the code to test ListHsmsResponse
      //var instance = new AmazonCloudHsm.ListHsmsResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ListHsmsResponse);
    });

    it('should have the property hsmList (base name: "HsmList")', function() {
      // uncomment below and update the code to test the property hsmList
      //var instance = new AmazonCloudHsm.ListHsmsResponse();
