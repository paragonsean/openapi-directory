...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.CreateHapgRequest();
  });
  ...
  describe('CreateHapgRequest', function() {
    it('should create an instance of CreateHapgRequest', function() {
      // uncomment below and update the code to test CreateHapgRequest
      //var instance = new AmazonCloudHsm.CreateHapgRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.CreateHapgRequest);
    });
