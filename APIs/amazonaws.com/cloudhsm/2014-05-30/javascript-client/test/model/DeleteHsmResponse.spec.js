...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DeleteHsmResponse();
  });
  ...
  describe('DeleteHsmResponse', function() {
    it('should create an instance of DeleteHsmResponse', function() {
      // uncomment below and update the code to test DeleteHsmResponse
      //var instance = new AmazonCloudHsm.DeleteHsmResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.DeleteHsmResponse);
    });
