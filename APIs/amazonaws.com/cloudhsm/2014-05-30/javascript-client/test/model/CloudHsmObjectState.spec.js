...
(function(root, factory) {
  ...
  describe('CloudHsmObjectState', function() {
    it('should create an instance of CloudHsmObjectState', function() {
      // uncomment below and update the code to test CloudHsmObjectState
      //var instance = new AmazonCloudHsm.CloudHsmObjectState();
      //expect(instance).to.be.a(AmazonCloudHsm.CloudHsmObjectState);
    });
