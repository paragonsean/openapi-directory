...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.CreateLunaClientResponse();
  });
  ...
  describe('CreateLunaClientResponse', function() {
    it('should create an instance of CreateLunaClientResponse', function() {
      // uncomment below and update the code to test CreateLunaClientResponse
      //var instance = new AmazonCloudHsm.CreateLunaClientResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.CreateLunaClientResponse);
    });
