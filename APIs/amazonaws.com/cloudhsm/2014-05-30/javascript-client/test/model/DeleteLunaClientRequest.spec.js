...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DeleteLunaClientRequest();
  });
  ...
  describe('DeleteLunaClientRequest', function() {
    it('should create an instance of DeleteLunaClientRequest', function() {
      // uncomment below and update the code to test DeleteLunaClientRequest
      //var instance = new AmazonCloudHsm.DeleteLunaClientRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.DeleteLunaClientRequest);
    });
