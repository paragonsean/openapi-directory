...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DeleteHapgResponse();
  });
  ...
  describe('DeleteHapgResponse', function() {
    it('should create an instance of DeleteHapgResponse', function() {
      // uncomment below and update the code to test DeleteHapgResponse
      //var instance = new AmazonCloudHsm.DeleteHapgResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.DeleteHapgResponse);
    });
