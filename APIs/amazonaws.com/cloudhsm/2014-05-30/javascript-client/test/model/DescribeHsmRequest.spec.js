...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DescribeHsmRequest();
  });
  ...
  describe('DescribeHsmRequest', function() {
    it('should create an instance of DescribeHsmRequest', function() {
      // uncomment below and update the code to test DescribeHsmRequest
      //var instance = new AmazonCloudHsm.DescribeHsmRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.DescribeHsmRequest);
    });
    ...
    it('should have the property hsmSerialNumber (base name: "HsmSerialNumber")', function() {
      // uncomment below and update the code to test the property hsmSerialNumber
      //var instance = new AmazonCloudHsm.DescribeHsmRequest();
      //expect(instance).to.be();
    });
