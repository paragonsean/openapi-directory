...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.RemoveTagsFromResourceResponse();
  });
  ...
  describe('RemoveTagsFromResourceResponse', function() {
    it('should create an instance of RemoveTagsFromResourceResponse', function() {
      // uncomment below and update the code to test RemoveTagsFromResourceResponse
      //var instance = new AmazonCloudHsm.RemoveTagsFromResourceResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.RemoveTagsFromResourceResponse);
    });
