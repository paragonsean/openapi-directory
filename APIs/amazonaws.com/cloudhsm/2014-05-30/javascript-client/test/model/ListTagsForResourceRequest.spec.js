...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonCloudHsm.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.ListTagsForResourceRequest);
    });
