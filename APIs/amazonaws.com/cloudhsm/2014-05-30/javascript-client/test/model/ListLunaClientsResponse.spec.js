...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListLunaClientsResponse();
  });
  ...
  describe('ListLunaClientsResponse', function() {
    it('should create an instance of ListLunaClientsResponse', function() {
      // uncomment below and update the code to test ListLunaClientsResponse
      //var instance = new AmazonCloudHsm.ListLunaClientsResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ListLunaClientsResponse);
    });
