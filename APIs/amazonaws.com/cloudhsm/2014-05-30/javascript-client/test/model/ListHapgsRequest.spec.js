...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListHapgsRequest();
  });
  ...
  describe('ListHapgsRequest', function() {
    it('should create an instance of ListHapgsRequest', function() {
      // uncomment below and update the code to test ListHapgsRequest
      //var instance = new AmazonCloudHsm.ListHapgsRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.ListHapgsRequest);
    });
