...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DescribeLunaClientResponse();
  });
  ...
  describe('DescribeLunaClientResponse', function() {
    it('should create an instance of DescribeLunaClientResponse', function() {
      // uncomment below and update the code to test DescribeLunaClientResponse
      //var instance = new AmazonCloudHsm.DescribeLunaClientResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.DescribeLunaClientResponse);
    });

    it('should have the property clientArn (base name: "ClientArn")', function() {
      // uncomment below and update the code to test the property clientArn
      //var instance = new AmazonCloudHsm.DescribeLunaClientResponse();
