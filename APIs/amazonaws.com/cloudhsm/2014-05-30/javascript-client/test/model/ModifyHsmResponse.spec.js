...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ModifyHsmResponse();
  });
  ...
  describe('ModifyHsmResponse', function() {
    it('should create an instance of ModifyHsmResponse', function() {
      // uncomment below and update the code to test ModifyHsmResponse
      //var instance = new AmazonCloudHsm.ModifyHsmResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ModifyHsmResponse);
    });
