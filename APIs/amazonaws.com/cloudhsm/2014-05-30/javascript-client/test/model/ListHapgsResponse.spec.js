...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListHapgsResponse();
  });
  ...
  describe('ListHapgsResponse', function() {
    it('should create an instance of ListHapgsResponse', function() {
      // uncomment below and update the code to test ListHapgsResponse
      //var instance = new AmazonCloudHsm.ListHapgsResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ListHapgsResponse);
    });

    it('should have the property hapgList (base name: "HapgList")', function() {
      // uncomment below and update the code to test the property hapgList
      //var instance = new AmazonCloudHsm.ListHapgsResponse();
