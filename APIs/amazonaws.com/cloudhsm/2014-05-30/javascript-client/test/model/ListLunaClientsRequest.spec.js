...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListLunaClientsRequest();
  });
  ...
  describe('ListLunaClientsRequest', function() {
    it('should create an instance of ListLunaClientsRequest', function() {
      // uncomment below and update the code to test ListLunaClientsRequest
      //var instance = new AmazonCloudHsm.ListLunaClientsRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.ListLunaClientsRequest);
    });
