...
(function(root, factory) {
  ...
  describe('ClientVersion', function() {
    it('should create an instance of ClientVersion', function() {
      // uncomment below and update the code to test ClientVersion
      //var instance = new AmazonCloudHsm.ClientVersion();
      //expect(instance).to.be.a(AmazonCloudHsm.ClientVersion);
    });
