...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.CreateHsmRequest();
  });
  ...
  describe('CreateHsmRequest', function() {
    it('should create an instance of CreateHsmRequest', function() {
      // uncomment below and update the code to test CreateHsmRequest
      //var instance = new AmazonCloudHsm.CreateHsmRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.CreateHsmRequest);
    });
    ...
    it('should have the property syslogIp (base name: "SyslogIp")', function() {
      // uncomment below and update the code to test the property syslogIp
      //var instance = new AmazonCloudHsm.CreateHsmRequest();
      //expect(instance).to.be();
    });
