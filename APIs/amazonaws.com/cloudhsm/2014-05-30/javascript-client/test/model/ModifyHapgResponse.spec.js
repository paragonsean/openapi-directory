...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ModifyHapgResponse();
  });
  ...
  describe('ModifyHapgResponse', function() {
    it('should create an instance of ModifyHapgResponse', function() {
      // uncomment below and update the code to test ModifyHapgResponse
      //var instance = new AmazonCloudHsm.ModifyHapgResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ModifyHapgResponse);
    });
