...
(function(root, factory) {
  ...
  describe('HsmStatus', function() {
    it('should create an instance of HsmStatus', function() {
      // uncomment below and update the code to test HsmStatus
      //var instance = new AmazonCloudHsm.HsmStatus();
      //expect(instance).to.be.a(AmazonCloudHsm.HsmStatus);
    });
