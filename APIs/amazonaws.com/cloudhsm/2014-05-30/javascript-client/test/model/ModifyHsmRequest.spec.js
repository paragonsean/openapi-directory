...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ModifyHsmRequest();
  });
  ...
  describe('ModifyHsmRequest', function() {
    it('should create an instance of ModifyHsmRequest', function() {
      // uncomment below and update the code to test ModifyHsmRequest
      //var instance = new AmazonCloudHsm.ModifyHsmRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.ModifyHsmRequest);
    });
