...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DeleteHapgRequest();
  });
  ...
  describe('DeleteHapgRequest', function() {
    it('should create an instance of DeleteHapgRequest', function() {
      // uncomment below and update the code to test DeleteHapgRequest
      //var instance = new AmazonCloudHsm.DeleteHapgRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.DeleteHapgRequest);
    });
