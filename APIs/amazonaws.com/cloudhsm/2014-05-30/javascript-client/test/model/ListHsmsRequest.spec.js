...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListHsmsRequest();
  });
  ...
  describe('ListHsmsRequest', function() {
    it('should create an instance of ListHsmsRequest', function() {
      // uncomment below and update the code to test ListHsmsRequest
      //var instance = new AmazonCloudHsm.ListHsmsRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.ListHsmsRequest);
    });
