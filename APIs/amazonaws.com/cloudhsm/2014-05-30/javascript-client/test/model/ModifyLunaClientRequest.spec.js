...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ModifyLunaClientRequest();
  });
  ...
  describe('ModifyLunaClientRequest', function() {
    it('should create an instance of ModifyLunaClientRequest', function() {
      // uncomment below and update the code to test ModifyLunaClientRequest
      //var instance = new AmazonCloudHsm.ModifyLunaClientRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.ModifyLunaClientRequest);
    });
