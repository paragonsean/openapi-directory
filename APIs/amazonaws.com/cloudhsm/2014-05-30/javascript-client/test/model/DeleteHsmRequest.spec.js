...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DeleteHsmRequest();
  });
  ...
  describe('DeleteHsmRequest', function() {
    it('should create an instance of DeleteHsmRequest', function() {
      // uncomment below and update the code to test DeleteHsmRequest
      //var instance = new AmazonCloudHsm.DeleteHsmRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.DeleteHsmRequest);
    });
