...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.CreateHapgResponse();
  });
  ...
  describe('CreateHapgResponse', function() {
    it('should create an instance of CreateHapgResponse', function() {
      // uncomment below and update the code to test CreateHapgResponse
      //var instance = new AmazonCloudHsm.CreateHapgResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.CreateHapgResponse);
    });
