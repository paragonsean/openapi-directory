...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonCloudHsm.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ListTagsForResourceResponse);
    });
