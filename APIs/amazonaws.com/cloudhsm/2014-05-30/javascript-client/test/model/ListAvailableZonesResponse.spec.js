...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ListAvailableZonesResponse();
  });
  ...
  describe('ListAvailableZonesResponse', function() {
    it('should create an instance of ListAvailableZonesResponse', function() {
      // uncomment below and update the code to test ListAvailableZonesResponse
      //var instance = new AmazonCloudHsm.ListAvailableZonesResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ListAvailableZonesResponse);
    });

    it('should have the property aZList (base name: "AZList")', function() {
      // uncomment below and update the code to test the property aZList
      //var instance = new AmazonCloudHsm.ListAvailableZonesResponse();
