...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DeleteLunaClientResponse();
  });
  ...
  describe('DeleteLunaClientResponse', function() {
    it('should create an instance of DeleteLunaClientResponse', function() {
      // uncomment below and update the code to test DeleteLunaClientResponse
      //var instance = new AmazonCloudHsm.DeleteLunaClientResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.DeleteLunaClientResponse);
    });
