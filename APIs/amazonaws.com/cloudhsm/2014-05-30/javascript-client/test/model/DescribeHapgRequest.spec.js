...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.DescribeHapgRequest();
  });
  ...
  describe('DescribeHapgRequest', function() {
    it('should create an instance of DescribeHapgRequest', function() {
      // uncomment below and update the code to test DescribeHapgRequest
      //var instance = new AmazonCloudHsm.DescribeHapgRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.DescribeHapgRequest);
    });
