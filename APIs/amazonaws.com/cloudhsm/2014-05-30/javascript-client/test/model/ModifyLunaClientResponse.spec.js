...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ModifyLunaClientResponse();
  });
  ...
  describe('ModifyLunaClientResponse', function() {
    it('should create an instance of ModifyLunaClientResponse', function() {
      // uncomment below and update the code to test ModifyLunaClientResponse
      //var instance = new AmazonCloudHsm.ModifyLunaClientResponse();
      //expect(instance).to.be.a(AmazonCloudHsm.ModifyLunaClientResponse);
    });
