...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudHsm.ModifyHapgRequest();
  });
  ...
  describe('ModifyHapgRequest', function() {
    it('should create an instance of ModifyHapgRequest', function() {
      // uncomment below and update the code to test ModifyHapgRequest
      //var instance = new AmazonCloudHsm.ModifyHapgRequest();
      //expect(instance).to.be.a(AmazonCloudHsm.ModifyHapgRequest);
    });
