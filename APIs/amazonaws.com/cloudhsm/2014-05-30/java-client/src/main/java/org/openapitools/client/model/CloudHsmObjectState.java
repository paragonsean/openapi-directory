...
/**
 * Gets or Sets CloudHsmObjectState
 */
@JsonAdapter(CloudHsmObjectState.Adapter.class)
public enum CloudHsmObjectState {
  ...
  CloudHsmObjectState(String value) {
    this.value = value;
  }
  ...
  public static CloudHsmObjectState fromValue(String value) {
    for (CloudHsmObjectState b : CloudHsmObjectState.values()) {
  ...
  public static class Adapter extends TypeAdapter<CloudHsmObjectState> {
    @Override
    public void write(final JsonWriter jsonWriter, final CloudHsmObjectState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CloudHsmObjectState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CloudHsmObjectState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CloudHsmObjectState.fromValue(value);
  }
}
