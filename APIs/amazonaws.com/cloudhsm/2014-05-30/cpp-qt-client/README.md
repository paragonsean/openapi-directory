...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAddTagsToResourceRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAddTagsToResourceRequest Example::create(){
    OAIAddTagsToResourceRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::addTagsToResourceSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::addTagsToResourceSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAddTagsToResourceRequest oai_add_tags_to_resource_request = create(); // OAIAddTagsToResourceRequest | 
      ...
      apiInstance.addTagsToResource(x_amz_targetoai_add_tags_to_resource_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
