...
/*
 * OAIAddTagsToResourceRequest.h
 *
 * 
 */

#ifndef OAIAddTagsToResourceRequest_H
#define OAIAddTagsToResourceRequest_H
...
class OAIAddTagsToResourceRequest : public OAIObject {
public:
    OAIAddTagsToResourceRequest();
    OAIAddTagsToResourceRequest(QString json);
    ~OAIAddTagsToResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddTagsToResourceRequest)

#endif // OAIAddTagsToResourceRequest_H
