...
/*
 * OAIListHsmsResponse.h
 *
 * Contains the output of the &lt;code&gt;ListHsms&lt;/code&gt; operation.
 */

#ifndef OAIListHsmsResponse_H
#define OAIListHsmsResponse_H
...
class OAIListHsmsResponse : public OAIObject {
public:
    OAIListHsmsResponse();
    OAIListHsmsResponse(QString json);
    ~OAIListHsmsResponse() override;
    ...
    QList getHsmList() const;
    void setHsmList(const QList &hsm_list);
    bool is_hsm_list_Set() const;
    bool is_hsm_list_Valid() const;
...
private:
    ...
    QList m_hsm_list;
    bool m_hsm_list_isSet;
    bool m_hsm_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHsmsResponse)

#endif // OAIListHsmsResponse_H
