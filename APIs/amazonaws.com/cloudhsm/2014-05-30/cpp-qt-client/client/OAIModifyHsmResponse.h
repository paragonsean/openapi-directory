...
/*
 * OAIModifyHsmResponse.h
 *
 * Contains the output of the &lt;a&gt;ModifyHsm&lt;/a&gt; operation.
 */

#ifndef OAIModifyHsmResponse_H
#define OAIModifyHsmResponse_H
...
class OAIModifyHsmResponse : public OAIObject {
public:
    OAIModifyHsmResponse();
    OAIModifyHsmResponse(QString json);
    ~OAIModifyHsmResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyHsmResponse)

#endif // OAIModifyHsmResponse_H
