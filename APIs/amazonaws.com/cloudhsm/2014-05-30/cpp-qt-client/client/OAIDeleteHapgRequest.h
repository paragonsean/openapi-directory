...
/*
 * OAIDeleteHapgRequest.h
 *
 * Contains the inputs for the &lt;a&gt;DeleteHapg&lt;/a&gt; action.
 */

#ifndef OAIDeleteHapgRequest_H
#define OAIDeleteHapgRequest_H
...
class OAIDeleteHapgRequest : public OAIObject {
public:
    OAIDeleteHapgRequest();
    OAIDeleteHapgRequest(QString json);
    ~OAIDeleteHapgRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHapgRequest)

#endif // OAIDeleteHapgRequest_H
