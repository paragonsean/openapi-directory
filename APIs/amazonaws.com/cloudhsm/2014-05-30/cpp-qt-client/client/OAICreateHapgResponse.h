...
/*
 * OAICreateHapgResponse.h
 *
 * Contains the output of the &lt;a&gt;CreateHAPartitionGroup&lt;/a&gt; action.
 */

#ifndef OAICreateHapgResponse_H
#define OAICreateHapgResponse_H
...
class OAICreateHapgResponse : public OAIObject {
public:
    OAICreateHapgResponse();
    OAICreateHapgResponse(QString json);
    ~OAICreateHapgResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHapgResponse)

#endif // OAICreateHapgResponse_H
