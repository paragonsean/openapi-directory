...
OAIDeleteLunaClientResponse::OAIDeleteLunaClientResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteLunaClientResponse::OAIDeleteLunaClientResponse() {
    this->initializeModel();
}

OAIDeleteLunaClientResponse::~OAIDeleteLunaClientResponse() {}

void OAIDeleteLunaClientResponse::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIDeleteLunaClientResponse::fromJson(QString jsonString) {
...
void OAIDeleteLunaClientResponse::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("Status")]);
    m_status_isSet = !json[QString("Status")].isNull() && m_status_isValid;
}

QString OAIDeleteLunaClientResponse::asJson() const {
...
QJsonObject OAIDeleteLunaClientResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_status_isSet) {
...
QString OAIDeleteLunaClientResponse::getStatus() const {
    return m_status;
}
void OAIDeleteLunaClientResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeleteLunaClientResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeleteLunaClientResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDeleteLunaClientResponse::isSet() const {
...
bool OAIDeleteLunaClientResponse::isValid() const {
