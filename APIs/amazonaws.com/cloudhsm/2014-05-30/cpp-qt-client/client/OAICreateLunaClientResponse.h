...
/*
 * OAICreateLunaClientResponse.h
 *
 * Contains the output of the &lt;a&gt;CreateLunaClient&lt;/a&gt; action.
 */

#ifndef OAICreateLunaClientResponse_H
#define OAICreateLunaClientResponse_H
...
class OAICreateLunaClientResponse : public OAIObject {
public:
    OAICreateLunaClientResponse();
    OAICreateLunaClientResponse(QString json);
    ~OAICreateLunaClientResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLunaClientResponse)

#endif // OAICreateLunaClientResponse_H
