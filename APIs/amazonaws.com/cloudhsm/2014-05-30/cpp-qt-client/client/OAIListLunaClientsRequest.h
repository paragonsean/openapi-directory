...
/*
 * OAIListLunaClientsRequest.h
 *
 * 
 */

#ifndef OAIListLunaClientsRequest_H
#define OAIListLunaClientsRequest_H
...
class OAIListLunaClientsRequest : public OAIObject {
public:
    OAIListLunaClientsRequest();
    OAIListLunaClientsRequest(QString json);
    ~OAIListLunaClientsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLunaClientsRequest)

#endif // OAIListLunaClientsRequest_H
