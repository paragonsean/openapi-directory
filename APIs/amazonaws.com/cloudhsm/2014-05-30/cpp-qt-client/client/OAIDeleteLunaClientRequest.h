...
/*
 * OAIDeleteLunaClientRequest.h
 *
 * 
 */

#ifndef OAIDeleteLunaClientRequest_H
#define OAIDeleteLunaClientRequest_H
...
class OAIDeleteLunaClientRequest : public OAIObject {
public:
    OAIDeleteLunaClientRequest();
    OAIDeleteLunaClientRequest(QString json);
    ~OAIDeleteLunaClientRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLunaClientRequest)

#endif // OAIDeleteLunaClientRequest_H
