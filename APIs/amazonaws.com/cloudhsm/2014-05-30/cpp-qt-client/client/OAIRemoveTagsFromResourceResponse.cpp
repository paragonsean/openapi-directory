...
OAIRemoveTagsFromResourceResponse::OAIRemoveTagsFromResourceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveTagsFromResourceResponse::OAIRemoveTagsFromResourceResponse() {
    this->initializeModel();
}

OAIRemoveTagsFromResourceResponse::~OAIRemoveTagsFromResourceResponse() {}

void OAIRemoveTagsFromResourceResponse::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIRemoveTagsFromResourceResponse::fromJson(QString jsonString) {
...
void OAIRemoveTagsFromResourceResponse::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("Status")]);
    m_status_isSet = !json[QString("Status")].isNull() && m_status_isValid;
}

QString OAIRemoveTagsFromResourceResponse::asJson() const {
...
QJsonObject OAIRemoveTagsFromResourceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_status_isSet) {
...
QString OAIRemoveTagsFromResourceResponse::getStatus() const {
    return m_status;
}
void OAIRemoveTagsFromResourceResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRemoveTagsFromResourceResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRemoveTagsFromResourceResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRemoveTagsFromResourceResponse::isSet() const {
...
bool OAIRemoveTagsFromResourceResponse::isValid() const {
