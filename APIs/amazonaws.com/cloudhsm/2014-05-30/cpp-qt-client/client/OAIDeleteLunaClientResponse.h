...
/*
 * OAIDeleteLunaClientResponse.h
 *
 * 
 */

#ifndef OAIDeleteLunaClientResponse_H
#define OAIDeleteLunaClientResponse_H
...
class OAIDeleteLunaClientResponse : public OAIObject {
public:
    OAIDeleteLunaClientResponse();
    OAIDeleteLunaClientResponse(QString json);
    ~OAIDeleteLunaClientResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLunaClientResponse)

#endif // OAIDeleteLunaClientResponse_H
