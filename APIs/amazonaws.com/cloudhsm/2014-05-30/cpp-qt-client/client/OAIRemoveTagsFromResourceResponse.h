...
/*
 * OAIRemoveTagsFromResourceResponse.h
 *
 * 
 */

#ifndef OAIRemoveTagsFromResourceResponse_H
#define OAIRemoveTagsFromResourceResponse_H
...
class OAIRemoveTagsFromResourceResponse : public OAIObject {
public:
    OAIRemoveTagsFromResourceResponse();
    OAIRemoveTagsFromResourceResponse(QString json);
    ~OAIRemoveTagsFromResourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveTagsFromResourceResponse)

#endif // OAIRemoveTagsFromResourceResponse_H
