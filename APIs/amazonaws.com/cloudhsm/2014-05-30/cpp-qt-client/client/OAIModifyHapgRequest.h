...
/*
 * OAIModifyHapgRequest.h
 *
 * 
 */

#ifndef OAIModifyHapgRequest_H
#define OAIModifyHapgRequest_H
...
class OAIModifyHapgRequest : public OAIObject {
public:
    OAIModifyHapgRequest();
    OAIModifyHapgRequest(QString json);
    ~OAIModifyHapgRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyHapgRequest)

#endif // OAIModifyHapgRequest_H
