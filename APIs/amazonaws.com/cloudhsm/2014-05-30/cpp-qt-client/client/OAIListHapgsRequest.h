...
/*
 * OAIListHapgsRequest.h
 *
 * 
 */

#ifndef OAIListHapgsRequest_H
#define OAIListHapgsRequest_H
...
class OAIListHapgsRequest : public OAIObject {
public:
    OAIListHapgsRequest();
    OAIListHapgsRequest(QString json);
    ~OAIListHapgsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHapgsRequest)

#endif // OAIListHapgsRequest_H
