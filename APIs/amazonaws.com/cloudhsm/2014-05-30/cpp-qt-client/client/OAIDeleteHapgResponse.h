...
/*
 * OAIDeleteHapgResponse.h
 *
 * Contains the output of the &lt;a&gt;DeleteHapg&lt;/a&gt; action.
 */

#ifndef OAIDeleteHapgResponse_H
#define OAIDeleteHapgResponse_H
...
class OAIDeleteHapgResponse : public OAIObject {
public:
    OAIDeleteHapgResponse();
    OAIDeleteHapgResponse(QString json);
    ~OAIDeleteHapgResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHapgResponse)

#endif // OAIDeleteHapgResponse_H
