...
/*
 * OAIDeleteHsmResponse.h
 *
 * Contains the output of the &lt;a&gt;DeleteHsm&lt;/a&gt; operation.
 */

#ifndef OAIDeleteHsmResponse_H
#define OAIDeleteHsmResponse_H
...
class OAIDeleteHsmResponse : public OAIObject {
public:
    OAIDeleteHsmResponse();
    OAIDeleteHsmResponse(QString json);
    ~OAIDeleteHsmResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHsmResponse)

#endif // OAIDeleteHsmResponse_H
