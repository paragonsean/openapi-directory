...
/*
 * OAIDescribeHapgRequest.h
 *
 * Contains the inputs for the &lt;a&gt;DescribeHapg&lt;/a&gt; action.
 */

#ifndef OAIDescribeHapgRequest_H
#define OAIDescribeHapgRequest_H
...
class OAIDescribeHapgRequest : public OAIObject {
public:
    OAIDescribeHapgRequest();
    OAIDescribeHapgRequest(QString json);
    ~OAIDescribeHapgRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHapgRequest)

#endif // OAIDescribeHapgRequest_H
