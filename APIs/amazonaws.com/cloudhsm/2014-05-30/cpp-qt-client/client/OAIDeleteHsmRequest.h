...
/*
 * OAIDeleteHsmRequest.h
 *
 * Contains the inputs for the &lt;a&gt;DeleteHsm&lt;/a&gt; operation.
 */

#ifndef OAIDeleteHsmRequest_H
#define OAIDeleteHsmRequest_H
...
class OAIDeleteHsmRequest : public OAIObject {
public:
    OAIDeleteHsmRequest();
    OAIDeleteHsmRequest(QString json);
    ~OAIDeleteHsmRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHsmRequest)

#endif // OAIDeleteHsmRequest_H
