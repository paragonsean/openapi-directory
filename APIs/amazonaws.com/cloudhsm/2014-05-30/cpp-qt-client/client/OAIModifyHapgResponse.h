...
/*
 * OAIModifyHapgResponse.h
 *
 * 
 */

#ifndef OAIModifyHapgResponse_H
#define OAIModifyHapgResponse_H
...
class OAIModifyHapgResponse : public OAIObject {
public:
    OAIModifyHapgResponse();
    OAIModifyHapgResponse(QString json);
    ~OAIModifyHapgResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyHapgResponse)

#endif // OAIModifyHapgResponse_H
