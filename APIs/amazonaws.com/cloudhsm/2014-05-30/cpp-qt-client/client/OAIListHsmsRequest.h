...
/*
 * OAIListHsmsRequest.h
 *
 * 
 */

#ifndef OAIListHsmsRequest_H
#define OAIListHsmsRequest_H
...
class OAIListHsmsRequest : public OAIObject {
public:
    OAIListHsmsRequest();
    OAIListHsmsRequest(QString json);
    ~OAIListHsmsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHsmsRequest)

#endif // OAIListHsmsRequest_H
