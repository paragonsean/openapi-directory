...
/*
 * OAIModifyLunaClientResponse.h
 *
 * 
 */

#ifndef OAIModifyLunaClientResponse_H
#define OAIModifyLunaClientResponse_H
...
class OAIModifyLunaClientResponse : public OAIObject {
public:
    OAIModifyLunaClientResponse();
    OAIModifyLunaClientResponse(QString json);
    ~OAIModifyLunaClientResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyLunaClientResponse)

#endif // OAIModifyLunaClientResponse_H
