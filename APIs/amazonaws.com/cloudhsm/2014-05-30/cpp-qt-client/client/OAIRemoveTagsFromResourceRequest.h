...
/*
 * OAIRemoveTagsFromResourceRequest.h
 *
 * 
 */

#ifndef OAIRemoveTagsFromResourceRequest_H
#define OAIRemoveTagsFromResourceRequest_H
...
class OAIRemoveTagsFromResourceRequest : public OAIObject {
public:
    OAIRemoveTagsFromResourceRequest();
    OAIRemoveTagsFromResourceRequest(QString json);
    ~OAIRemoveTagsFromResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveTagsFromResourceRequest)

#endif // OAIRemoveTagsFromResourceRequest_H
