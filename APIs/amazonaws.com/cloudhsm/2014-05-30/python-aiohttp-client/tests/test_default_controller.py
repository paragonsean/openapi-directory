...
async def test_add_tags_to_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.AddTagsToResource',
        headers=headers,
        json=body,
        )
...
async def test_create_hapg(client):
    """Test case for create_hapg
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.CreateHapg',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_hsm(client):
    """Test case for create_hsm

    
    """
    body = {"SshKey":"","SubscriptionType":"PRODUCTION","ExternalId":"","EniIp":"","SyslogIp":"","SubnetId":"","IamRoleArn":"","ClientToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.CreateHsm',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_luna_client(client):
    """Test case for create_luna_client

    
    """
    body = {"Label":"","Certificate":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.CreateLunaClient',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_hapg(client):
    """Test case for delete_hapg
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.DeleteHapg',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_hsm(client):
    """Test case for delete_hsm
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.DeleteHsm',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_luna_client(client):
    """Test case for delete_luna_client
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.DeleteLunaClient',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_hapg(client):
    """Test case for describe_hapg
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.DescribeHapg',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_hsm(client):
    """Test case for describe_hsm

    
    """
    body = {"HsmSerialNumber":"","HsmArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.DescribeHsm',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_luna_client(client):
    """Test case for describe_luna_client

    
    """
    body = {"ClientArn":"","CertificateFingerprint":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.DescribeLunaClient',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_config(client):
    ...
    """
    body = {"ClientArn":"","HapgList":"","ClientVersion":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.GetConfig',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_available_zones(client):
    """Test case for list_available_zones
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ListAvailableZones',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_hapgs(client):
    """Test case for list_hapgs
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ListHapgs',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_hsms(client):
    """Test case for list_hsms
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ListHsms',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_luna_clients(client):
    """Test case for list_luna_clients
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ListLunaClients',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_modify_hapg(client):
    """Test case for modify_hapg

    
    """
    body = {"PartitionSerialList":"","Label":"","HapgArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ModifyHapg',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_modify_hsm(client):
    """Test case for modify_hsm

    
    """
    body = {"ExternalId":"","EniIp":"","SyslogIp":"","SubnetId":"","IamRoleArn":"","HsmArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ModifyHsm',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_modify_luna_client(client):
    """Test case for modify_luna_client

    
    """
    body = {"ClientArn":"","Certificate":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.ModifyLunaClient',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_remove_tags_from_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CloudHsmFrontendService.RemoveTagsFromResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
