...
/*
 * OAIUpdateHostKeyRequest.h
 *
 * 
 */

#ifndef OAIUpdateHostKeyRequest_H
#define OAIUpdateHostKeyRequest_H
...
class OAIUpdateHostKeyRequest : public OAIObject {
public:
    OAIUpdateHostKeyRequest();
    OAIUpdateHostKeyRequest(QString json);
    ~OAIUpdateHostKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateHostKeyRequest)

#endif // OAIUpdateHostKeyRequest_H
