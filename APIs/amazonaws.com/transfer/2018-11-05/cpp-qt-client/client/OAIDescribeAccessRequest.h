...
/*
 * OAIDescribeAccessRequest.h
 *
 * 
 */

#ifndef OAIDescribeAccessRequest_H
#define OAIDescribeAccessRequest_H
...
class OAIDescribeAccessRequest : public OAIObject {
public:
    OAIDescribeAccessRequest();
    OAIDescribeAccessRequest(QString json);
    ~OAIDescribeAccessRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccessRequest)

#endif // OAIDescribeAccessRequest_H
