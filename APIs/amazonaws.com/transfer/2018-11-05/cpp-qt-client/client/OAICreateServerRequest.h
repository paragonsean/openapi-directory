...
class OAICreateServerRequest_IdentityProviderDetails;
...
public:
    ...
    OAICreateServerRequest_IdentityProviderDetails getIdentityProviderDetails() const;
    void setIdentityProviderDetails(const OAICreateServerRequest_IdentityProviderDetails &identity_provider_details);
...
private:
    ...
    OAICreateServerRequest_IdentityProviderDetails m_identity_provider_details;
