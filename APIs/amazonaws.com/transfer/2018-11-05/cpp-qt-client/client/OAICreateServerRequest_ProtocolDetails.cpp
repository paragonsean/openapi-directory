...
OAICreateServerRequest_ProtocolDetails::OAICreateServerRequest_ProtocolDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateServerRequest_ProtocolDetails::OAICreateServerRequest_ProtocolDetails() {
    this->initializeModel();
}

OAICreateServerRequest_ProtocolDetails::~OAICreateServerRequest_ProtocolDetails() {}

void OAICreateServerRequest_ProtocolDetails::initializeModel() {
...
void OAICreateServerRequest_ProtocolDetails::fromJson(QString jsonString) {
...
void OAICreateServerRequest_ProtocolDetails::fromJsonObject(QJsonObject json) {
...
QString OAICreateServerRequest_ProtocolDetails::asJson() const {
...
QJsonObject OAICreateServerRequest_ProtocolDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateServerRequest_ProtocolDetails::getPassiveIp() const {
    return m_passive_ip;
}
void OAICreateServerRequest_ProtocolDetails::setPassiveIp(const QString &passive_ip) {
    m_passive_ip = passive_ip;
    m_passive_ip_isSet = true;
}

bool OAICreateServerRequest_ProtocolDetails::is_passive_ip_Set() const{
    return m_passive_ip_isSet;
}

bool OAICreateServerRequest_ProtocolDetails::is_passive_ip_Valid() const{
    return m_passive_ip_isValid;
}

OAITlsSessionResumptionMode OAICreateServerRequest_ProtocolDetails::getTlsSessionResumptionMode() const {
    return m_tls_session_resumption_mode;
}
void OAICreateServerRequest_ProtocolDetails::setTlsSessionResumptionMode(const OAITlsSessionResumptionMode &tls_session_resumption_mode) {
    m_tls_session_resumption_mode = tls_session_resumption_mode;
    m_tls_session_resumption_mode_isSet = true;
}

bool OAICreateServerRequest_ProtocolDetails::is_tls_session_resumption_mode_Set() const{
    return m_tls_session_resumption_mode_isSet;
}

bool OAICreateServerRequest_ProtocolDetails::is_tls_session_resumption_mode_Valid() const{
    return m_tls_session_resumption_mode_isValid;
}

OAISetStatOption OAICreateServerRequest_ProtocolDetails::getSetStatOption() const {
    return m_set_stat_option;
}
void OAICreateServerRequest_ProtocolDetails::setSetStatOption(const OAISetStatOption &set_stat_option) {
    m_set_stat_option = set_stat_option;
    m_set_stat_option_isSet = true;
}

bool OAICreateServerRequest_ProtocolDetails::is_set_stat_option_Set() const{
    return m_set_stat_option_isSet;
}

bool OAICreateServerRequest_ProtocolDetails::is_set_stat_option_Valid() const{
    return m_set_stat_option_isValid;
}

QList OAICreateServerRequest_ProtocolDetails::getAs2Transports() const {
    return m_as2_transports;
}
void OAICreateServerRequest_ProtocolDetails::setAs2Transports(const QList &as2_transports) {
    m_as2_transports = as2_transports;
    m_as2_transports_isSet = true;
}

bool OAICreateServerRequest_ProtocolDetails::is_as2_transports_Set() const{
    return m_as2_transports_isSet;
}

bool OAICreateServerRequest_ProtocolDetails::is_as2_transports_Valid() const{
    return m_as2_transports_isValid;
}

bool OAICreateServerRequest_ProtocolDetails::isSet() const {
...
bool OAICreateServerRequest_ProtocolDetails::isValid() const {
