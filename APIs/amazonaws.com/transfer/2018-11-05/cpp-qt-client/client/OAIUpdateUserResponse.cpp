...
QString OAIUpdateUserResponse::getServerId() const {
    return m_server_id;
}
void OAIUpdateUserResponse::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIUpdateUserResponse::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIUpdateUserResponse::is_server_id_Valid() const{
    return m_server_id_isValid;
}

QString OAIUpdateUserResponse::getUserName() const {
    return m_user_name;
}
void OAIUpdateUserResponse::setUserName(const QString &user_name) {
    m_user_name = user_name;
    m_user_name_isSet = true;
}

bool OAIUpdateUserResponse::is_user_name_Set() const{
    return m_user_name_isSet;
}

bool OAIUpdateUserResponse::is_user_name_Valid() const{
