...
/*
 * OAIUpdateServerRequest_IdentityProviderDetails.h
 *
 * 
 */

#ifndef OAIUpdateServerRequest_IdentityProviderDetails_H
#define OAIUpdateServerRequest_IdentityProviderDetails_H
...
class OAIUpdateServerRequest_IdentityProviderDetails : public OAIObject {
public:
    OAIUpdateServerRequest_IdentityProviderDetails();
    OAIUpdateServerRequest_IdentityProviderDetails(QString json);
    ~OAIUpdateServerRequest_IdentityProviderDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServerRequest_IdentityProviderDetails)

#endif // OAIUpdateServerRequest_IdentityProviderDetails_H
