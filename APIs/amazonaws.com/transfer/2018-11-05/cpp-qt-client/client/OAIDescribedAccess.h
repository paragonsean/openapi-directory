...
/*
 * OAIDescribedAccess.h
 *
 * Describes the properties of the access that was specified.
 */

#ifndef OAIDescribedAccess_H
#define OAIDescribedAccess_H
...
class OAIDescribedAccess : public OAIObject {
public:
    OAIDescribedAccess();
    OAIDescribedAccess(QString json);
    ~OAIDescribedAccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedAccess)

#endif // OAIDescribedAccess_H
