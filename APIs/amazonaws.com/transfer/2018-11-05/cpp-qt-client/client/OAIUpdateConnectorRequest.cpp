...
OAIUpdateConnectorRequest::OAIUpdateConnectorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateConnectorRequest::OAIUpdateConnectorRequest() {
    this->initializeModel();
}

OAIUpdateConnectorRequest::~OAIUpdateConnectorRequest() {}

void OAIUpdateConnectorRequest::initializeModel() {
...
void OAIUpdateConnectorRequest::fromJson(QString jsonString) {
...
void OAIUpdateConnectorRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateConnectorRequest::asJson() const {
...
QJsonObject OAIUpdateConnectorRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateConnectorRequest::getConnectorId() const {
    return m_connector_id;
}
void OAIUpdateConnectorRequest::setConnectorId(const QString &connector_id) {
    m_connector_id = connector_id;
    m_connector_id_isSet = true;
}

bool OAIUpdateConnectorRequest::is_connector_id_Set() const{
    return m_connector_id_isSet;
}

bool OAIUpdateConnectorRequest::is_connector_id_Valid() const{
    return m_connector_id_isValid;
}

QString OAIUpdateConnectorRequest::getUrl() const {
    return m_url;
}
void OAIUpdateConnectorRequest::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIUpdateConnectorRequest::is_url_Set() const{
    return m_url_isSet;
}

bool OAIUpdateConnectorRequest::is_url_Valid() const{
    return m_url_isValid;
}

OAICreateConnectorRequest_As2Config OAIUpdateConnectorRequest::getAs2Config() const {
    return m_as2_config;
}
void OAIUpdateConnectorRequest::setAs2Config(const OAICreateConnectorRequest_As2Config &as2_config) {
    m_as2_config = as2_config;
    m_as2_config_isSet = true;
}

bool OAIUpdateConnectorRequest::is_as2_config_Set() const{
    return m_as2_config_isSet;
}

bool OAIUpdateConnectorRequest::is_as2_config_Valid() const{
    return m_as2_config_isValid;
}

QString OAIUpdateConnectorRequest::getAccessRole() const {
    return m_access_role;
}
void OAIUpdateConnectorRequest::setAccessRole(const QString &access_role) {
    m_access_role = access_role;
    m_access_role_isSet = true;
}

bool OAIUpdateConnectorRequest::is_access_role_Set() const{
    return m_access_role_isSet;
}

bool OAIUpdateConnectorRequest::is_access_role_Valid() const{
    return m_access_role_isValid;
}

QString OAIUpdateConnectorRequest::getLoggingRole() const {
    return m_logging_role;
}
void OAIUpdateConnectorRequest::setLoggingRole(const QString &logging_role) {
    m_logging_role = logging_role;
    m_logging_role_isSet = true;
}

bool OAIUpdateConnectorRequest::is_logging_role_Set() const{
    return m_logging_role_isSet;
}

bool OAIUpdateConnectorRequest::is_logging_role_Valid() const{
    return m_logging_role_isValid;
}

OAICreateConnectorRequest_SftpConfig OAIUpdateConnectorRequest::getSftpConfig() const {
    return m_sftp_config;
}
void OAIUpdateConnectorRequest::setSftpConfig(const OAICreateConnectorRequest_SftpConfig &sftp_config) {
    m_sftp_config = sftp_config;
    m_sftp_config_isSet = true;
}

bool OAIUpdateConnectorRequest::is_sftp_config_Set() const{
    return m_sftp_config_isSet;
}

bool OAIUpdateConnectorRequest::is_sftp_config_Valid() const{
    return m_sftp_config_isValid;
}

bool OAIUpdateConnectorRequest::isSet() const {
...
bool OAIUpdateConnectorRequest::isValid() const {
