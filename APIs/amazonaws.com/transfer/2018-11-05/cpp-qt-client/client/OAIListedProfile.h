...
#ifndef OAIListedProfile_H
#define OAIListedProfile_H
...
class OAIListedProfile : public OAIObject {
public:
    OAIListedProfile();
    OAIListedProfile(QString json);
    ~OAIListedProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListedProfile)

#endif // OAIListedProfile_H
