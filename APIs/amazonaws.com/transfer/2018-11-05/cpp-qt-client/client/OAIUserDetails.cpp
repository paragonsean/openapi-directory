...
void OAIUserDetails::setUserName(const QString &user_name) {
    m_user_name = user_name;
    m_user_name_isSet = true;
}

bool OAIUserDetails::is_user_name_Set() const{
    return m_user_name_isSet;
}

bool OAIUserDetails::is_user_name_Valid() const{
    return m_user_name_isValid;
}

QString OAIUserDetails::getServerId() const {
    return m_server_id;
}
void OAIUserDetails::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIUserDetails::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIUserDetails::is_server_id_Valid() const{
