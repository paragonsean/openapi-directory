...
#ifndef OAIDescribedUser_H
#define OAIDescribedUser_H
...
class OAIDescribedUser : public OAIObject {
public:
    OAIDescribedUser();
    OAIDescribedUser(QString json);
    ~OAIDescribedUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedUser)

#endif // OAIDescribedUser_H
