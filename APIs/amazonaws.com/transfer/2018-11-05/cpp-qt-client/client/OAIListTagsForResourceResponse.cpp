...
QString OAIListTagsForResourceResponse::getArn() const {
    return m_arn;
}
void OAIListTagsForResourceResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIListTagsForResourceResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIListTagsForResourceResponse::is_arn_Valid() const{
