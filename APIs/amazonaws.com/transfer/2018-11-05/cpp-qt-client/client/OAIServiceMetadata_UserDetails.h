...
/*
 * OAIServiceMetadata_UserDetails.h
 *
 * 
 */

#ifndef OAIServiceMetadata_UserDetails_H
#define OAIServiceMetadata_UserDetails_H
...
class OAIServiceMetadata_UserDetails : public OAIObject {
public:
    OAIServiceMetadata_UserDetails();
    OAIServiceMetadata_UserDetails(QString json);
    ~OAIServiceMetadata_UserDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceMetadata_UserDetails)

#endif // OAIServiceMetadata_UserDetails_H
