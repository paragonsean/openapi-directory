...
/*
 * OAIDescribedHostKey.h
 *
 * The details for a server host key.
 */

#ifndef OAIDescribedHostKey_H
#define OAIDescribedHostKey_H
...
class OAIDescribedHostKey : public OAIObject {
public:
    OAIDescribedHostKey();
    OAIDescribedHostKey(QString json);
    ~OAIDescribedHostKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedHostKey)

#endif // OAIDescribedHostKey_H
