...
/*
 * OAIDeleteAccessRequest.h
 *
 * 
 */

#ifndef OAIDeleteAccessRequest_H
#define OAIDeleteAccessRequest_H
...
class OAIDeleteAccessRequest : public OAIObject {
public:
    OAIDeleteAccessRequest();
    OAIDeleteAccessRequest(QString json);
    ~OAIDeleteAccessRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAccessRequest)

#endif // OAIDeleteAccessRequest_H
