...
QString OAIListUsersResponse::getServerId() const {
    return m_server_id;
}
void OAIListUsersResponse::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIListUsersResponse::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIListUsersResponse::is_server_id_Valid() const{
...
bool OAIListUsersResponse::isValid() const {
    ...
    return m_server_id_isValid && m_users_isValid && true;
}
