...
#ifndef OAIPosixProfile_H
#define OAIPosixProfile_H
...
class OAIPosixProfile : public OAIObject {
public:
    OAIPosixProfile();
    OAIPosixProfile(QString json);
    ~OAIPosixProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPosixProfile)

#endif // OAIPosixProfile_H
