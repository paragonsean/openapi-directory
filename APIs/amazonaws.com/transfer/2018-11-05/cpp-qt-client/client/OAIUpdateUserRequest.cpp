...
QString OAIUpdateUserRequest::getHomeDirectory() const {
    return m_home_directory;
}
void OAIUpdateUserRequest::setHomeDirectory(const QString &home_directory) {
    m_home_directory = home_directory;
    m_home_directory_isSet = true;
}

bool OAIUpdateUserRequest::is_home_directory_Set() const{
    return m_home_directory_isSet;
}

bool OAIUpdateUserRequest::is_home_directory_Valid() const{
    return m_home_directory_isValid;
}

OAIHomeDirectoryType OAIUpdateUserRequest::getHomeDirectoryType() const {
    return m_home_directory_type;
}
void OAIUpdateUserRequest::setHomeDirectoryType(const OAIHomeDirectoryType &home_directory_type) {
    m_home_directory_type = home_directory_type;
    m_home_directory_type_isSet = true;
}

bool OAIUpdateUserRequest::is_home_directory_type_Set() const{
    return m_home_directory_type_isSet;
}

bool OAIUpdateUserRequest::is_home_directory_type_Valid() const{
    return m_home_directory_type_isValid;
}

QList OAIUpdateUserRequest::getHomeDirectoryMappings() const {
    return m_home_directory_mappings;
}
void OAIUpdateUserRequest::setHomeDirectoryMappings(const QList &home_directory_mappings) {
    m_home_directory_mappings = home_directory_mappings;
    m_home_directory_mappings_isSet = true;
}

bool OAIUpdateUserRequest::is_home_directory_mappings_Set() const{
    return m_home_directory_mappings_isSet;
}

bool OAIUpdateUserRequest::is_home_directory_mappings_Valid() const{
    return m_home_directory_mappings_isValid;
}

QString OAIUpdateUserRequest::getPolicy() const {
    return m_policy;
}
void OAIUpdateUserRequest::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIUpdateUserRequest::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIUpdateUserRequest::is_policy_Valid() const{
    return m_policy_isValid;
}

OAIUpdateUserRequest_PosixProfile OAIUpdateUserRequest::getPosixProfile() const {
    return m_posix_profile;
}
void OAIUpdateUserRequest::setPosixProfile(const OAIUpdateUserRequest_PosixProfile &posix_profile) {
    m_posix_profile = posix_profile;
    m_posix_profile_isSet = true;
}

bool OAIUpdateUserRequest::is_posix_profile_Set() const{
    return m_posix_profile_isSet;
}

bool OAIUpdateUserRequest::is_posix_profile_Valid() const{
    return m_posix_profile_isValid;
}

QString OAIUpdateUserRequest::getRole() const {
    return m_role;
}
void OAIUpdateUserRequest::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}
...
QString OAIUpdateUserRequest::getServerId() const {
    return m_server_id;
}
void OAIUpdateUserRequest::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIUpdateUserRequest::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIUpdateUserRequest::is_server_id_Valid() const{
