...
/*
 * OAIDescribeAccessResponse_Access.h
 *
 * 
 */

#ifndef OAIDescribeAccessResponse_Access_H
#define OAIDescribeAccessResponse_Access_H
...
class OAIDescribeAccessResponse_Access : public OAIObject {
public:
    OAIDescribeAccessResponse_Access();
    OAIDescribeAccessResponse_Access(QString json);
    ~OAIDescribeAccessResponse_Access() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccessResponse_Access)

#endif // OAIDescribeAccessResponse_Access_H
