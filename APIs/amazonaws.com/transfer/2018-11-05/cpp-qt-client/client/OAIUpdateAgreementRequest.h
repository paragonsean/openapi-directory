...
/*
 * OAIUpdateAgreementRequest.h
 *
 * 
 */

#ifndef OAIUpdateAgreementRequest_H
#define OAIUpdateAgreementRequest_H
...
class OAIUpdateAgreementRequest : public OAIObject {
public:
    OAIUpdateAgreementRequest();
    OAIUpdateAgreementRequest(QString json);
    ~OAIUpdateAgreementRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAgreementRequest)

#endif // OAIUpdateAgreementRequest_H
