...
#ifndef OAIHomeDirectoryMapEntry_H
#define OAIHomeDirectoryMapEntry_H
...
class OAIHomeDirectoryMapEntry : public OAIObject {
public:
    OAIHomeDirectoryMapEntry();
    OAIHomeDirectoryMapEntry(QString json);
    ~OAIHomeDirectoryMapEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHomeDirectoryMapEntry)

#endif // OAIHomeDirectoryMapEntry_H
