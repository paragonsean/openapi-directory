...
/*
 * OAIDescribeExecutionRequest.h
 *
 * 
 */

#ifndef OAIDescribeExecutionRequest_H
#define OAIDescribeExecutionRequest_H
...
class OAIDescribeExecutionRequest : public OAIObject {
public:
    OAIDescribeExecutionRequest();
    OAIDescribeExecutionRequest(QString json);
    ~OAIDescribeExecutionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExecutionRequest)

#endif // OAIDescribeExecutionRequest_H
