...
class OAIDescribedConnector : public OAIObject {
public:
    OAIDescribedConnector();
    OAIDescribedConnector(QString json);
    ~OAIDescribedConnector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedConnector)

#endif // OAIDescribedConnector_H
