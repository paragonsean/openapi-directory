...
OAIDescribedServer::OAIDescribedServer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribedServer::OAIDescribedServer() {
    this->initializeModel();
}

OAIDescribedServer::~OAIDescribedServer() {}

void OAIDescribedServer::initializeModel() {
...
void OAIDescribedServer::fromJson(QString jsonString) {
...
void OAIDescribedServer::fromJsonObject(QJsonObject json) {
...
QString OAIDescribedServer::asJson() const {
...
QJsonObject OAIDescribedServer::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDescribedServer::getArn() const {
    return m_arn;
}
void OAIDescribedServer::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribedServer::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribedServer::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIDescribedServer::getCertificate() const {
    return m_certificate;
}
void OAIDescribedServer::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIDescribedServer::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIDescribedServer::is_certificate_Valid() const{
    return m_certificate_isValid;
}

OAICreateServerRequest_ProtocolDetails OAIDescribedServer::getProtocolDetails() const {
    return m_protocol_details;
}
void OAIDescribedServer::setProtocolDetails(const OAICreateServerRequest_ProtocolDetails &protocol_details) {
    m_protocol_details = protocol_details;
    m_protocol_details_isSet = true;
}

bool OAIDescribedServer::is_protocol_details_Set() const{
    return m_protocol_details_isSet;
}

bool OAIDescribedServer::is_protocol_details_Valid() const{
    return m_protocol_details_isValid;
}

OAIDomain OAIDescribedServer::getDomain() const {
    return m_domain;
}
void OAIDescribedServer::setDomain(const OAIDomain &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIDescribedServer::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIDescribedServer::is_domain_Valid() const{
    return m_domain_isValid;
}

OAICreateServerRequest_EndpointDetails OAIDescribedServer::getEndpointDetails() const {
    return m_endpoint_details;
}
void OAIDescribedServer::setEndpointDetails(const OAICreateServerRequest_EndpointDetails &endpoint_details) {
    m_endpoint_details = endpoint_details;
    m_endpoint_details_isSet = true;
}

bool OAIDescribedServer::is_endpoint_details_Set() const{
    return m_endpoint_details_isSet;
}

bool OAIDescribedServer::is_endpoint_details_Valid() const{
    return m_endpoint_details_isValid;
}

OAIEndpointType OAIDescribedServer::getEndpointType() const {
    return m_endpoint_type;
}
void OAIDescribedServer::setEndpointType(const OAIEndpointType &endpoint_type) {
    m_endpoint_type = endpoint_type;
    m_endpoint_type_isSet = true;
}

bool OAIDescribedServer::is_endpoint_type_Set() const{
    return m_endpoint_type_isSet;
}

bool OAIDescribedServer::is_endpoint_type_Valid() const{
    return m_endpoint_type_isValid;
}

QString OAIDescribedServer::getHostKeyFingerprint() const {
    return m_host_key_fingerprint;
}
void OAIDescribedServer::setHostKeyFingerprint(const QString &host_key_fingerprint) {
    m_host_key_fingerprint = host_key_fingerprint;
    m_host_key_fingerprint_isSet = true;
}

bool OAIDescribedServer::is_host_key_fingerprint_Set() const{
    return m_host_key_fingerprint_isSet;
}

bool OAIDescribedServer::is_host_key_fingerprint_Valid() const{
    return m_host_key_fingerprint_isValid;
}

OAIDescribedServer_IdentityProviderDetails OAIDescribedServer::getIdentityProviderDetails() const {
    return m_identity_provider_details;
}
void OAIDescribedServer::setIdentityProviderDetails(const OAIDescribedServer_IdentityProviderDetails &identity_provider_details) {
    m_identity_provider_details = identity_provider_details;
    m_identity_provider_details_isSet = true;
}

bool OAIDescribedServer::is_identity_provider_details_Set() const{
    return m_identity_provider_details_isSet;
}

bool OAIDescribedServer::is_identity_provider_details_Valid() const{
    return m_identity_provider_details_isValid;
}

OAIIdentityProviderType OAIDescribedServer::getIdentityProviderType() const {
    return m_identity_provider_type;
}
void OAIDescribedServer::setIdentityProviderType(const OAIIdentityProviderType &identity_provider_type) {
    m_identity_provider_type = identity_provider_type;
    m_identity_provider_type_isSet = true;
}

bool OAIDescribedServer::is_identity_provider_type_Set() const{
    return m_identity_provider_type_isSet;
}

bool OAIDescribedServer::is_identity_provider_type_Valid() const{
    return m_identity_provider_type_isValid;
}

QString OAIDescribedServer::getLoggingRole() const {
    return m_logging_role;
}
void OAIDescribedServer::setLoggingRole(const QString &logging_role) {
    m_logging_role = logging_role;
    m_logging_role_isSet = true;
}

bool OAIDescribedServer::is_logging_role_Set() const{
    return m_logging_role_isSet;
}

bool OAIDescribedServer::is_logging_role_Valid() const{
    return m_logging_role_isValid;
}

QString OAIDescribedServer::getPostAuthenticationLoginBanner() const {
    return m_post_authentication_login_banner;
}
void OAIDescribedServer::setPostAuthenticationLoginBanner(const QString &post_authentication_login_banner) {
    m_post_authentication_login_banner = post_authentication_login_banner;
    m_post_authentication_login_banner_isSet = true;
}

bool OAIDescribedServer::is_post_authentication_login_banner_Set() const{
    return m_post_authentication_login_banner_isSet;
}

bool OAIDescribedServer::is_post_authentication_login_banner_Valid() const{
    return m_post_authentication_login_banner_isValid;
}

QString OAIDescribedServer::getPreAuthenticationLoginBanner() const {
    return m_pre_authentication_login_banner;
}
void OAIDescribedServer::setPreAuthenticationLoginBanner(const QString &pre_authentication_login_banner) {
    m_pre_authentication_login_banner = pre_authentication_login_banner;
    m_pre_authentication_login_banner_isSet = true;
}

bool OAIDescribedServer::is_pre_authentication_login_banner_Set() const{
    return m_pre_authentication_login_banner_isSet;
}

bool OAIDescribedServer::is_pre_authentication_login_banner_Valid() const{
    return m_pre_authentication_login_banner_isValid;
}

QList OAIDescribedServer::getProtocols() const {
    return m_protocols;
}
void OAIDescribedServer::setProtocols(const QList &protocols) {
    m_protocols = protocols;
    m_protocols_isSet = true;
}

bool OAIDescribedServer::is_protocols_Set() const{
    return m_protocols_isSet;
}

bool OAIDescribedServer::is_protocols_Valid() const{
    return m_protocols_isValid;
}

QString OAIDescribedServer::getSecurityPolicyName() const {
    return m_security_policy_name;
}
void OAIDescribedServer::setSecurityPolicyName(const QString &security_policy_name) {
    m_security_policy_name = security_policy_name;
    m_security_policy_name_isSet = true;
}

bool OAIDescribedServer::is_security_policy_name_Set() const{
    return m_security_policy_name_isSet;
}

bool OAIDescribedServer::is_security_policy_name_Valid() const{
    return m_security_policy_name_isValid;
}

QString OAIDescribedServer::getServerId() const {
    return m_server_id;
}
void OAIDescribedServer::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIDescribedServer::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIDescribedServer::is_server_id_Valid() const{
    return m_server_id_isValid;
}

OAIState OAIDescribedServer::getState() const {
    return m_state;
}
void OAIDescribedServer::setState(const OAIState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIDescribedServer::is_state_Set() const{
    return m_state_isSet;
}

bool OAIDescribedServer::is_state_Valid() const{
    return m_state_isValid;
}

QList OAIDescribedServer::getTags() const {
    return m_tags;
}
void OAIDescribedServer::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDescribedServer::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDescribedServer::is_tags_Valid() const{
    return m_tags_isValid;
}

qint32 OAIDescribedServer::getUserCount() const {
    return m_user_count;
}
void OAIDescribedServer::setUserCount(const qint32 &user_count) {
    m_user_count = user_count;
    m_user_count_isSet = true;
}

bool OAIDescribedServer::is_user_count_Set() const{
    return m_user_count_isSet;
}

bool OAIDescribedServer::is_user_count_Valid() const{
    return m_user_count_isValid;
}

OAICreateServerRequest_WorkflowDetails OAIDescribedServer::getWorkflowDetails() const {
    return m_workflow_details;
}
void OAIDescribedServer::setWorkflowDetails(const OAICreateServerRequest_WorkflowDetails &workflow_details) {
    m_workflow_details = workflow_details;
    m_workflow_details_isSet = true;
}

bool OAIDescribedServer::is_workflow_details_Set() const{
    return m_workflow_details_isSet;
}

bool OAIDescribedServer::is_workflow_details_Valid() const{
    return m_workflow_details_isValid;
}

QList OAIDescribedServer::getStructuredLogDestinations() const {
    return m_structured_log_destinations;
}
void OAIDescribedServer::setStructuredLogDestinations(const QList &structured_log_destinations) {
    m_structured_log_destinations = structured_log_destinations;
    m_structured_log_destinations_isSet = true;
}

bool OAIDescribedServer::is_structured_log_destinations_Set() const{
    return m_structured_log_destinations_isSet;
}

bool OAIDescribedServer::is_structured_log_destinations_Valid() const{
    return m_structured_log_destinations_isValid;
}

bool OAIDescribedServer::isSet() const {
...
bool OAIDescribedServer::isValid() const {
