...
/*
 * OAIDescribedServer.h
 *
 * Describes the properties of a file transfer protocol-enabled server that was specified.
 */

#ifndef OAIDescribedServer_H
#define OAIDescribedServer_H
...
class OAIDescribedServer : public OAIObject {
public:
    OAIDescribedServer();
    OAIDescribedServer(QString json);
    ~OAIDescribedServer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedServer)

#endif // OAIDescribedServer_H
