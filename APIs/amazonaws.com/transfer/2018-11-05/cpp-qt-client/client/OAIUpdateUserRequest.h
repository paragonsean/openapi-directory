...
namespace OpenAPI {
class OAIUpdateUserRequest_PosixProfile;
...
public:
    ...
    OAIUpdateUserRequest_PosixProfile getPosixProfile() const;
    void setPosixProfile(const OAIUpdateUserRequest_PosixProfile &posix_profile);
...
private:
    ...
    OAIUpdateUserRequest_PosixProfile m_posix_profile;
