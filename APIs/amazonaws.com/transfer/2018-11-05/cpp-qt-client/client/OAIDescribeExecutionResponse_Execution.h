...
/*
 * OAIDescribeExecutionResponse_Execution.h
 *
 * 
 */

#ifndef OAIDescribeExecutionResponse_Execution_H
#define OAIDescribeExecutionResponse_Execution_H
...
class OAIDescribeExecutionResponse_Execution : public OAIObject {
public:
    OAIDescribeExecutionResponse_Execution();
    OAIDescribeExecutionResponse_Execution(QString json);
    ~OAIDescribeExecutionResponse_Execution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExecutionResponse_Execution)

#endif // OAIDescribeExecutionResponse_Execution_H
