...
#ifndef OAITagStepDetails_H
#define OAITagStepDetails_H
...
class OAITagStepDetails : public OAIObject {
public:
    OAITagStepDetails();
    OAITagStepDetails(QString json);
    ~OAITagStepDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagStepDetails)

#endif // OAITagStepDetails_H
