...
/*
 * OAICreateServerRequest_IdentityProviderDetails.h
 *
 * 
 */

#ifndef OAICreateServerRequest_IdentityProviderDetails_H
#define OAICreateServerRequest_IdentityProviderDetails_H
...
class OAICreateServerRequest_IdentityProviderDetails : public OAIObject {
public:
    OAICreateServerRequest_IdentityProviderDetails();
    OAICreateServerRequest_IdentityProviderDetails(QString json);
    ~OAICreateServerRequest_IdentityProviderDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServerRequest_IdentityProviderDetails)

#endif // OAICreateServerRequest_IdentityProviderDetails_H
