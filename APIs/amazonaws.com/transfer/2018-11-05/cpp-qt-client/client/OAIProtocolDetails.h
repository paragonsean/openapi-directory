...
/*
 * OAIProtocolDetails.h
 *
 *  The protocol settings that are configured for your server. 
 */

#ifndef OAIProtocolDetails_H
#define OAIProtocolDetails_H
...
class OAIProtocolDetails : public OAIObject {
public:
    OAIProtocolDetails();
    OAIProtocolDetails(QString json);
    ~OAIProtocolDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProtocolDetails)

#endif // OAIProtocolDetails_H
