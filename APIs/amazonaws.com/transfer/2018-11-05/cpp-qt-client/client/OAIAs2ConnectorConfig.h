...
#ifndef OAIAs2ConnectorConfig_H
#define OAIAs2ConnectorConfig_H
...
class OAIAs2ConnectorConfig : public OAIObject {
public:
    OAIAs2ConnectorConfig();
    OAIAs2ConnectorConfig(QString json);
    ~OAIAs2ConnectorConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAs2ConnectorConfig)

#endif // OAIAs2ConnectorConfig_H
