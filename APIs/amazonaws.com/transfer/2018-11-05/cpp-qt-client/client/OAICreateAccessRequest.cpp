...
OAICreateAccessRequest::OAICreateAccessRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAccessRequest::OAICreateAccessRequest() {
    this->initializeModel();
}

OAICreateAccessRequest::~OAICreateAccessRequest() {}

void OAICreateAccessRequest::initializeModel() {
...
void OAICreateAccessRequest::fromJson(QString jsonString) {
...
void OAICreateAccessRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateAccessRequest::asJson() const {
...
QJsonObject OAICreateAccessRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAccessRequest::getHomeDirectory() const {
    return m_home_directory;
}
void OAICreateAccessRequest::setHomeDirectory(const QString &home_directory) {
    m_home_directory = home_directory;
    m_home_directory_isSet = true;
}

bool OAICreateAccessRequest::is_home_directory_Set() const{
    return m_home_directory_isSet;
}

bool OAICreateAccessRequest::is_home_directory_Valid() const{
    return m_home_directory_isValid;
}

OAIHomeDirectoryType OAICreateAccessRequest::getHomeDirectoryType() const {
    return m_home_directory_type;
}
void OAICreateAccessRequest::setHomeDirectoryType(const OAIHomeDirectoryType &home_directory_type) {
    m_home_directory_type = home_directory_type;
    m_home_directory_type_isSet = true;
}

bool OAICreateAccessRequest::is_home_directory_type_Set() const{
    return m_home_directory_type_isSet;
}

bool OAICreateAccessRequest::is_home_directory_type_Valid() const{
    return m_home_directory_type_isValid;
}

QList OAICreateAccessRequest::getHomeDirectoryMappings() const {
    return m_home_directory_mappings;
}
void OAICreateAccessRequest::setHomeDirectoryMappings(const QList &home_directory_mappings) {
    m_home_directory_mappings = home_directory_mappings;
    m_home_directory_mappings_isSet = true;
}

bool OAICreateAccessRequest::is_home_directory_mappings_Set() const{
    return m_home_directory_mappings_isSet;
}

bool OAICreateAccessRequest::is_home_directory_mappings_Valid() const{
    return m_home_directory_mappings_isValid;
}

QString OAICreateAccessRequest::getPolicy() const {
    return m_policy;
}
void OAICreateAccessRequest::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAICreateAccessRequest::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAICreateAccessRequest::is_policy_Valid() const{
    return m_policy_isValid;
}

OAIPosixProfile OAICreateAccessRequest::getPosixProfile() const {
    return m_posix_profile;
}
void OAICreateAccessRequest::setPosixProfile(const OAIPosixProfile &posix_profile) {
    m_posix_profile = posix_profile;
    m_posix_profile_isSet = true;
}

bool OAICreateAccessRequest::is_posix_profile_Set() const{
    return m_posix_profile_isSet;
}

bool OAICreateAccessRequest::is_posix_profile_Valid() const{
    return m_posix_profile_isValid;
}

QString OAICreateAccessRequest::getRole() const {
    return m_role;
}
void OAICreateAccessRequest::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAICreateAccessRequest::is_role_Set() const{
    return m_role_isSet;
}

bool OAICreateAccessRequest::is_role_Valid() const{
    return m_role_isValid;
}

QString OAICreateAccessRequest::getServerId() const {
    return m_server_id;
}
void OAICreateAccessRequest::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAICreateAccessRequest::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAICreateAccessRequest::is_server_id_Valid() const{
    return m_server_id_isValid;
}

QString OAICreateAccessRequest::getExternalId() const {
    return m_external_id;
}
void OAICreateAccessRequest::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAICreateAccessRequest::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAICreateAccessRequest::is_external_id_Valid() const{
    return m_external_id_isValid;
}

bool OAICreateAccessRequest::isSet() const {
...
bool OAICreateAccessRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_role_isValid && m_server_id_isValid && m_external_id_isValid && true;
}
