...
/*
 * OAICreateAccessResponse.h
 *
 * 
 */

#ifndef OAICreateAccessResponse_H
#define OAICreateAccessResponse_H
...
class OAICreateAccessResponse : public OAIObject {
public:
    OAICreateAccessResponse();
    OAICreateAccessResponse(QString json);
    ~OAICreateAccessResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccessResponse)

#endif // OAICreateAccessResponse_H
