...
/*
 * OAIUpdateAccessRequest.h
 *
 * 
 */

#ifndef OAIUpdateAccessRequest_H
#define OAIUpdateAccessRequest_H
...
class OAIUpdateAccessRequest : public OAIObject {
public:
    OAIUpdateAccessRequest();
    OAIUpdateAccessRequest(QString json);
    ~OAIUpdateAccessRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccessRequest)

#endif // OAIUpdateAccessRequest_H
