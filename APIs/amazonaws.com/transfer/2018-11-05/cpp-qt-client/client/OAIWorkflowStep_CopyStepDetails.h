...
/*
 * OAIWorkflowStep_CopyStepDetails.h
 *
 * 
 */

#ifndef OAIWorkflowStep_CopyStepDetails_H
#define OAIWorkflowStep_CopyStepDetails_H
...
namespace OpenAPI {
class OAICopyStepDetails_DestinationFileLocation;

class OAIWorkflowStep_CopyStepDetails : public OAIObject {
public:
    OAIWorkflowStep_CopyStepDetails();
    OAIWorkflowStep_CopyStepDetails(QString json);
    ~OAIWorkflowStep_CopyStepDetails() override;
    ...
    OAICopyStepDetails_DestinationFileLocation getDestinationFileLocation() const;
    void setDestinationFileLocation(const OAICopyStepDetails_DestinationFileLocation &destination_file_location);
...
private:
    ...
    OAICopyStepDetails_DestinationFileLocation m_destination_file_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowStep_CopyStepDetails)

#endif // OAIWorkflowStep_CopyStepDetails_H
