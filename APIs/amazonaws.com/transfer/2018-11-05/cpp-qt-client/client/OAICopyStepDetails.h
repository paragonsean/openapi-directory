...
/*
 * OAICopyStepDetails.h
 *
 * Each step type has its own &lt;code&gt;StepDetails&lt;/code&gt; structure.
 */

#ifndef OAICopyStepDetails_H
#define OAICopyStepDetails_H
...
class OAICopyStepDetails : public OAIObject {
public:
    OAICopyStepDetails();
    OAICopyStepDetails(QString json);
    ~OAICopyStepDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyStepDetails)

#endif // OAICopyStepDetails_H
