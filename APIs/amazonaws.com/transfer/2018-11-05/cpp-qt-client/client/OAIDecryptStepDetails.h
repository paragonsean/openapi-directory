...
/*
 * OAIDecryptStepDetails.h
 *
 * Each step type has its own &lt;code&gt;StepDetails&lt;/code&gt; structure.
 */

#ifndef OAIDecryptStepDetails_H
#define OAIDecryptStepDetails_H
...
class OAIDecryptStepDetails : public OAIObject {
public:
    OAIDecryptStepDetails();
    OAIDecryptStepDetails(QString json);
    ~OAIDecryptStepDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDecryptStepDetails)

#endif // OAIDecryptStepDetails_H
