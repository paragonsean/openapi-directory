...
#ifndef OAIDescribedSecurityPolicy_H
#define OAIDescribedSecurityPolicy_H
...
class OAIDescribedSecurityPolicy : public OAIObject {
public:
    OAIDescribedSecurityPolicy();
    OAIDescribedSecurityPolicy(QString json);
    ~OAIDescribedSecurityPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedSecurityPolicy)

#endif // OAIDescribedSecurityPolicy_H
