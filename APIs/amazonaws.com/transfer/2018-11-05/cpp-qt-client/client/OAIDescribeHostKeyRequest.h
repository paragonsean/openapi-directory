...
/*
 * OAIDescribeHostKeyRequest.h
 *
 * 
 */

#ifndef OAIDescribeHostKeyRequest_H
#define OAIDescribeHostKeyRequest_H
...
class OAIDescribeHostKeyRequest : public OAIObject {
public:
    OAIDescribeHostKeyRequest();
    OAIDescribeHostKeyRequest(QString json);
    ~OAIDescribeHostKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHostKeyRequest)

#endif // OAIDescribeHostKeyRequest_H
