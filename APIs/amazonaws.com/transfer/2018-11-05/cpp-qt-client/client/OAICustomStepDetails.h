...
/*
 * OAICustomStepDetails.h
 *
 * Each step type has its own &lt;code&gt;StepDetails&lt;/code&gt; structure.
 */

#ifndef OAICustomStepDetails_H
#define OAICustomStepDetails_H
...
class OAICustomStepDetails : public OAIObject {
public:
    OAICustomStepDetails();
    OAICustomStepDetails(QString json);
    ~OAICustomStepDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomStepDetails)

#endif // OAICustomStepDetails_H
