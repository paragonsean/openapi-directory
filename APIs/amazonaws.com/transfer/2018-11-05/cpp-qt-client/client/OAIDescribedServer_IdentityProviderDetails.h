...
/*
 * OAIDescribedServer_IdentityProviderDetails.h
 *
 * 
 */

#ifndef OAIDescribedServer_IdentityProviderDetails_H
#define OAIDescribedServer_IdentityProviderDetails_H
...
class OAIDescribedServer_IdentityProviderDetails : public OAIObject {
public:
    OAIDescribedServer_IdentityProviderDetails();
    OAIDescribedServer_IdentityProviderDetails(QString json);
    ~OAIDescribedServer_IdentityProviderDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedServer_IdentityProviderDetails)

#endif // OAIDescribedServer_IdentityProviderDetails_H
