...
/*
 * OAIDeleteHostKeyRequest.h
 *
 * 
 */

#ifndef OAIDeleteHostKeyRequest_H
#define OAIDeleteHostKeyRequest_H
...
class OAIDeleteHostKeyRequest : public OAIObject {
public:
    OAIDeleteHostKeyRequest();
    OAIDeleteHostKeyRequest(QString json);
    ~OAIDeleteHostKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHostKeyRequest)

#endif // OAIDeleteHostKeyRequest_H
