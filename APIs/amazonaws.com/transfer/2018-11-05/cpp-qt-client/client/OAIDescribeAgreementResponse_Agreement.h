...
/*
 * OAIDescribeAgreementResponse_Agreement.h
 *
 * 
 */

#ifndef OAIDescribeAgreementResponse_Agreement_H
#define OAIDescribeAgreementResponse_Agreement_H
...
class OAIDescribeAgreementResponse_Agreement : public OAIObject {
public:
    OAIDescribeAgreementResponse_Agreement();
    OAIDescribeAgreementResponse_Agreement(QString json);
    ~OAIDescribeAgreementResponse_Agreement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAgreementResponse_Agreement)

#endif // OAIDescribeAgreementResponse_Agreement_H
