...
#ifndef OAIListedAccess_H
#define OAIListedAccess_H
...
class OAIListedAccess : public OAIObject {
public:
    OAIListedAccess();
    OAIListedAccess(QString json);
    ~OAIListedAccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListedAccess)

#endif // OAIListedAccess_H
