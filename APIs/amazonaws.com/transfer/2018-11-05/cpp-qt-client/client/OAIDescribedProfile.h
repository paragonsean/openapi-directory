...
/*
 * OAIDescribedProfile.h
 *
 * The details for a local or partner AS2 profile. 
 */

#ifndef OAIDescribedProfile_H
#define OAIDescribedProfile_H
...
class OAIDescribedProfile : public OAIObject {
public:
    OAIDescribedProfile();
    OAIDescribedProfile(QString json);
    ~OAIDescribedProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribedProfile)

#endif // OAIDescribedProfile_H
