...
/*
 * OAIDescribeConnectorResponse_Connector.h
 *
 * 
 */

#ifndef OAIDescribeConnectorResponse_Connector_H
#define OAIDescribeConnectorResponse_Connector_H
...
class OAIDescribeConnectorResponse_Connector : public OAIObject {
public:
    OAIDescribeConnectorResponse_Connector();
    OAIDescribeConnectorResponse_Connector(QString json);
    ~OAIDescribeConnectorResponse_Connector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConnectorResponse_Connector)

#endif // OAIDescribeConnectorResponse_Connector_H
