...
/*
 * OAIInputFileLocation.h
 *
 * Specifies the location for the file that&#39;s being processed.
 */

#ifndef OAIInputFileLocation_H
#define OAIInputFileLocation_H
...
class OAIInputFileLocation : public OAIObject {
public:
    OAIInputFileLocation();
    OAIInputFileLocation(QString json);
    ~OAIInputFileLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputFileLocation)

#endif // OAIInputFileLocation_H
