...
/*
 * OAIListedCertificate.h
 *
 * Describes the properties of a certificate.
 */

#ifndef OAIListedCertificate_H
#define OAIListedCertificate_H
...
class OAIListedCertificate : public OAIObject {
public:
    OAIListedCertificate();
    OAIListedCertificate(QString json);
    ~OAIListedCertificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListedCertificate)

#endif // OAIListedCertificate_H
