...
/*
 * OAIDeleteSshPublicKeyRequest.h
 *
 * 
 */

#ifndef OAIDeleteSshPublicKeyRequest_H
#define OAIDeleteSshPublicKeyRequest_H
...
class OAIDeleteSshPublicKeyRequest : public OAIObject {
public:
    OAIDeleteSshPublicKeyRequest();
    OAIDeleteSshPublicKeyRequest(QString json);
    ~OAIDeleteSshPublicKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSshPublicKeyRequest)

#endif // OAIDeleteSshPublicKeyRequest_H
