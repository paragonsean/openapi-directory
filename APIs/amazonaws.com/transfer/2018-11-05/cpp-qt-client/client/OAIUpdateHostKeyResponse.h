...
/*
 * OAIUpdateHostKeyResponse.h
 *
 * 
 */

#ifndef OAIUpdateHostKeyResponse_H
#define OAIUpdateHostKeyResponse_H
...
class OAIUpdateHostKeyResponse : public OAIObject {
public:
    OAIUpdateHostKeyResponse();
    OAIUpdateHostKeyResponse(QString json);
    ~OAIUpdateHostKeyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateHostKeyResponse)

#endif // OAIUpdateHostKeyResponse_H
