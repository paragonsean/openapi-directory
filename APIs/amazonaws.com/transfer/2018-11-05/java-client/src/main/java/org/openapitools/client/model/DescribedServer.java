...
public class DescribedServer {
  ...
  public DescribedServer() {
  }

  public DescribedServer arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribedServer certificate(String certificate) {
  ...
  public DescribedServer protocolDetails(CreateServerRequestProtocolDetails protocolDetails) {
  ...
  public DescribedServer domain(Domain domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DescribedServer endpointDetails(CreateServerRequestEndpointDetails endpointDetails) {
  ...
  public DescribedServer endpointType(EndpointType endpointType) {
  ...
  public DescribedServer hostKeyFingerprint(String hostKeyFingerprint) {
  ...
  public DescribedServer identityProviderDetails(DescribedServerIdentityProviderDetails identityProviderDetails) {
  ...
  public DescribedServer identityProviderType(IdentityProviderType identityProviderType) {
  ...
  public DescribedServer loggingRole(String loggingRole) {
  ...
  public DescribedServer postAuthenticationLoginBanner(String postAuthenticationLoginBanner) {
  ...
  public DescribedServer preAuthenticationLoginBanner(String preAuthenticationLoginBanner) {
  ...
  public DescribedServer protocols(List protocols) {
  ...
  public DescribedServer securityPolicyName(String securityPolicyName) {
  ...
  public DescribedServer serverId(String serverId) {
  ...
  public DescribedServer state(State state) {
    this.state = state;
    return this;
  }
  ...
  public DescribedServer tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DescribedServer userCount(Integer userCount) {
  ...
  public DescribedServer workflowDetails(CreateServerRequestWorkflowDetails workflowDetails) {
  ...
  public DescribedServer structuredLogDestinations(List structuredLogDestinations) {
  ...
  public boolean equals(Object o) {
    ...
    DescribedServer describedServer = (DescribedServer) o;
    return Objects.equals(this.arn, describedServer.arn) &&
        Objects.equals(this.certificate, describedServer.certificate) &&
        Objects.equals(this.protocolDetails, describedServer.protocolDetails) &&
        Objects.equals(this.domain, describedServer.domain) &&
        Objects.equals(this.endpointDetails, describedServer.endpointDetails) &&
        Objects.equals(this.endpointType, describedServer.endpointType) &&
        Objects.equals(this.hostKeyFingerprint, describedServer.hostKeyFingerprint) &&
        Objects.equals(this.identityProviderDetails, describedServer.identityProviderDetails) &&
        Objects.equals(this.identityProviderType, describedServer.identityProviderType) &&
        Objects.equals(this.loggingRole, describedServer.loggingRole) &&
        Objects.equals(this.postAuthenticationLoginBanner, describedServer.postAuthenticationLoginBanner) &&
        Objects.equals(this.preAuthenticationLoginBanner, describedServer.preAuthenticationLoginBanner) &&
        Objects.equals(this.protocols, describedServer.protocols) &&
        Objects.equals(this.securityPolicyName, describedServer.securityPolicyName) &&
        Objects.equals(this.serverId, describedServer.serverId) &&
        Objects.equals(this.state, describedServer.state) &&
        Objects.equals(this.tags, describedServer.tags) &&
        Objects.equals(this.userCount, describedServer.userCount) &&
        Objects.equals(this.workflowDetails, describedServer.workflowDetails) &&
        Objects.equals(this.structuredLogDestinations, describedServer.structuredLogDestinations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribedServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribedServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribedServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribedServer is not found in the empty JSON string", DescribedServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribedServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribedServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribedServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribedServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribedServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribedServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribedServer.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribedServer>() {
           @Override
           public void write(JsonWriter out, DescribedServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribedServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribedServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribedServer
   * @throws IOException if the JSON string is invalid with respect to DescribedServer
   */
  public static DescribedServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribedServer.class);
  }

  /**
   * Convert an instance of DescribedServer to an JSON string
   *
   * @return JSON string
   */
