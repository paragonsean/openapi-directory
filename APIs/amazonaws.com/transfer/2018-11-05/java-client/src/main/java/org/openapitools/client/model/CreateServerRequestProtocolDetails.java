...
public class CreateServerRequestProtocolDetails {
  ...
  public CreateServerRequestProtocolDetails() {
  }

  public CreateServerRequestProtocolDetails passiveIp(String passiveIp) {
  ...
  public CreateServerRequestProtocolDetails tlsSessionResumptionMode(TlsSessionResumptionMode tlsSessionResumptionMode) {
  ...
  public CreateServerRequestProtocolDetails setStatOption(SetStatOption setStatOption) {
  ...
  public CreateServerRequestProtocolDetails as2Transports(List as2Transports) {
  ...
  public boolean equals(Object o) {
    ...
    CreateServerRequestProtocolDetails createServerRequestProtocolDetails = (CreateServerRequestProtocolDetails) o;
    return Objects.equals(this.passiveIp, createServerRequestProtocolDetails.passiveIp) &&
        Objects.equals(this.tlsSessionResumptionMode, createServerRequestProtocolDetails.tlsSessionResumptionMode) &&
        Objects.equals(this.setStatOption, createServerRequestProtocolDetails.setStatOption) &&
        Objects.equals(this.as2Transports, createServerRequestProtocolDetails.as2Transports);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateServerRequestProtocolDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServerRequestProtocolDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServerRequestProtocolDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServerRequestProtocolDetails is not found in the empty JSON string", CreateServerRequestProtocolDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateServerRequestProtocolDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateServerRequestProtocolDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateServerRequestProtocolDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateServerRequestProtocolDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateServerRequestProtocolDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateServerRequestProtocolDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateServerRequestProtocolDetails>() {
           @Override
           public void write(JsonWriter out, CreateServerRequestProtocolDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateServerRequestProtocolDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateServerRequestProtocolDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServerRequestProtocolDetails
   * @throws IOException if the JSON string is invalid with respect to CreateServerRequestProtocolDetails
   */
  public static CreateServerRequestProtocolDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServerRequestProtocolDetails.class);
  }

  /**
   * Convert an instance of CreateServerRequestProtocolDetails to an JSON string
   *
   * @return JSON string
   */
