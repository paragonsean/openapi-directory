...
public class DescribedExecution {
  ...
  public DescribedExecution executionId(String executionId) {
  ...
  public DescribedExecution initialFileLocation(DescribedExecutionInitialFileLocation initialFileLocation) {
  ...
  public DescribedExecution serviceMetadata(DescribedExecutionServiceMetadata serviceMetadata) {
  ...
  public DescribedExecution executionRole(String executionRole) {
  ...
  public DescribedExecution loggingConfiguration(DescribedExecutionLoggingConfiguration loggingConfiguration) {
  ...
  public DescribedExecution posixProfile(PosixProfile posixProfile) {
  ...
  public DescribedExecution status(ExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribedExecution results(DescribedExecutionResults results) {
  ...
  public boolean equals(Object o) {
    ...
    DescribedExecution describedExecution = (DescribedExecution) o;
    return Objects.equals(this.executionId, describedExecution.executionId) &&
        Objects.equals(this.initialFileLocation, describedExecution.initialFileLocation) &&
        Objects.equals(this.serviceMetadata, describedExecution.serviceMetadata) &&
        Objects.equals(this.executionRole, describedExecution.executionRole) &&
        Objects.equals(this.loggingConfiguration, describedExecution.loggingConfiguration) &&
        Objects.equals(this.posixProfile, describedExecution.posixProfile) &&
        Objects.equals(this.status, describedExecution.status) &&
        Objects.equals(this.results, describedExecution.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribedExecution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribedExecution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribedExecution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribedExecution is not found in the empty JSON string", DescribedExecution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribedExecution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribedExecution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribedExecution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribedExecution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribedExecution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribedExecution.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribedExecution>() {
           @Override
           public void write(JsonWriter out, DescribedExecution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribedExecution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribedExecution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribedExecution
   * @throws IOException if the JSON string is invalid with respect to DescribedExecution
   */
  public static DescribedExecution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribedExecution.class);
  }

  /**
   * Convert an instance of DescribedExecution to an JSON string
   *
   * @return JSON string
   */
