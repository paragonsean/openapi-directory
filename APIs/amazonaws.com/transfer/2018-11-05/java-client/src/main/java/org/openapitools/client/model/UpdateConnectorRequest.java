...
public class UpdateConnectorRequest {
  ...
  public UpdateConnectorRequest connectorId(String connectorId) {
  ...
  public UpdateConnectorRequest url(String url) {
    this.url = url;
    return this;
  }
  ...
  public UpdateConnectorRequest as2Config(CreateConnectorRequestAs2Config as2Config) {
  ...
  public UpdateConnectorRequest accessRole(String accessRole) {
  ...
  public UpdateConnectorRequest loggingRole(String loggingRole) {
  ...
  public UpdateConnectorRequest sftpConfig(CreateConnectorRequestSftpConfig sftpConfig) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectorId, updateConnectorRequest.connectorId) &&
        Objects.equals(this.url, updateConnectorRequest.url) &&
        Objects.equals(this.as2Config, updateConnectorRequest.as2Config) &&
        Objects.equals(this.accessRole, updateConnectorRequest.accessRole) &&
        Objects.equals(this.loggingRole, updateConnectorRequest.loggingRole) &&
        Objects.equals(this.sftpConfig, updateConnectorRequest.sftpConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectorId, url, as2Config, accessRole, loggingRole, sftpConfig);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateConnectorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateConnectorRequest is not found in the empty JSON string", UpdateConnectorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateConnectorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateConnectorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateConnectorRequest.openapiRequiredFields) {
