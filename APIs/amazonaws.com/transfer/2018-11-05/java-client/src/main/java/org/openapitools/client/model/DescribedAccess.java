...
public class DescribedAccess {
  ...
  public DescribedAccess homeDirectory(String homeDirectory) {
  ...
  public DescribedAccess homeDirectoryMappings(List homeDirectoryMappings) {
  ...
  public DescribedAccess homeDirectoryType(HomeDirectoryType homeDirectoryType) {
  ...
  public DescribedAccess policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public DescribedAccess posixProfile(PosixProfile posixProfile) {
  ...
  public DescribedAccess role(String role) {
    this.role = role;
    return this;
  }
  ...
  public DescribedAccess externalId(String externalId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribedAccess describedAccess = (DescribedAccess) o;
    return Objects.equals(this.homeDirectory, describedAccess.homeDirectory) &&
        Objects.equals(this.homeDirectoryMappings, describedAccess.homeDirectoryMappings) &&
        Objects.equals(this.homeDirectoryType, describedAccess.homeDirectoryType) &&
        Objects.equals(this.policy, describedAccess.policy) &&
        Objects.equals(this.posixProfile, describedAccess.posixProfile) &&
        Objects.equals(this.role, describedAccess.role) &&
        Objects.equals(this.externalId, describedAccess.externalId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribedAccess {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribedAccess
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribedAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribedAccess is not found in the empty JSON string", DescribedAccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribedAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribedAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribedAccess.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribedAccess' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribedAccess> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribedAccess.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribedAccess>() {
           @Override
           public void write(JsonWriter out, DescribedAccess value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribedAccess read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribedAccess given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribedAccess
   * @throws IOException if the JSON string is invalid with respect to DescribedAccess
   */
  public static DescribedAccess fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribedAccess.class);
  }

  /**
   * Convert an instance of DescribedAccess to an JSON string
   *
   * @return JSON string
   */
