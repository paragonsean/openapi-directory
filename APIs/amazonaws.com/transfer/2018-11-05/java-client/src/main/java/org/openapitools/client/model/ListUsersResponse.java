...
public class ListUsersResponse {
  ...
  public ListUsersResponse serverId(String serverId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listUsersResponse.nextToken) &&
        Objects.equals(this.serverId, listUsersResponse.serverId) &&
        Objects.equals(this.users, listUsersResponse.users);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, serverId, users);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ListUsersResponse.openapiRequiredFields) {
