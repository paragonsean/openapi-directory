...
public class UpdateAccessRequest {
  ...
  public UpdateAccessRequest homeDirectory(String homeDirectory) {
  ...
  public UpdateAccessRequest homeDirectoryType(HomeDirectoryType homeDirectoryType) {
  ...
  public UpdateAccessRequest homeDirectoryMappings(List homeDirectoryMappings) {
  ...
  public UpdateAccessRequest policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public UpdateAccessRequest posixProfile(PosixProfile posixProfile) {
  ...
  public UpdateAccessRequest role(String role) {
    this.role = role;
    return this;
  }
  ...
  public UpdateAccessRequest serverId(String serverId) {
  ...
  public UpdateAccessRequest externalId(String externalId) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAccessRequest updateAccessRequest = (UpdateAccessRequest) o;
    return Objects.equals(this.homeDirectory, updateAccessRequest.homeDirectory) &&
        Objects.equals(this.homeDirectoryType, updateAccessRequest.homeDirectoryType) &&
        Objects.equals(this.homeDirectoryMappings, updateAccessRequest.homeDirectoryMappings) &&
        Objects.equals(this.policy, updateAccessRequest.policy) &&
        Objects.equals(this.posixProfile, updateAccessRequest.posixProfile) &&
        Objects.equals(this.role, updateAccessRequest.role) &&
        Objects.equals(this.serverId, updateAccessRequest.serverId) &&
        Objects.equals(this.externalId, updateAccessRequest.externalId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAccessRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAccessRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAccessRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAccessRequest is not found in the empty JSON string", UpdateAccessRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAccessRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAccessRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateAccessRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAccessRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAccessRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAccessRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAccessRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAccessRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAccessRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAccessRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAccessRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAccessRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAccessRequest
   */
  public static UpdateAccessRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAccessRequest.class);
  }

  /**
   * Convert an instance of UpdateAccessRequest to an JSON string
   *
   * @return JSON string
   */
