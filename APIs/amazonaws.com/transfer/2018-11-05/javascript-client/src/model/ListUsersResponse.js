...
class ListUsersResponse {
     ...
     * @param users {Array} 
     */
    constructor(serverId, users) { 
        
        ListUsersResponse.initialize(this, serverId, users);
    }
     ...
     */
    static initialize(obj, serverId, users) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUsersResponse.RequiredProperties) {
...
ListUsersResponse.RequiredProperties = ["ServerId", "Users"];
 ...
 */
ListUsersResponse.prototype['ServerId'] = undefined;
