...
class CreateWorkflowResponse {
    ...
    constructor(workflowId) { 
        ...
        CreateWorkflowResponse.initialize(this, workflowId);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateWorkflowResponse.RequiredProperties) {
...
CreateWorkflowResponse.RequiredProperties = ["WorkflowId"];

/**
 * @member {String} WorkflowId
 */
CreateWorkflowResponse.prototype['WorkflowId'] = undefined;
