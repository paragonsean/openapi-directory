...
/**
 * The UpdateServerRequestIdentityProviderDetails model module.
 * @module model/UpdateServerRequestIdentityProviderDetails
 * @version 2018-11-05
 */
class UpdateServerRequestIdentityProviderDetails {
    /**
     * Constructs a new <code>UpdateServerRequestIdentityProviderDetails</code>.
     * @alias module:model/UpdateServerRequestIdentityProviderDetails
     * @implements module:model/IdentityProviderDetails
     */
    constructor() { 
        IdentityProviderDetails.initialize(this);
        UpdateServerRequestIdentityProviderDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateServerRequestIdentityProviderDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateServerRequestIdentityProviderDetails} obj Optional instance to populate.
     * @return {module:model/UpdateServerRequestIdentityProviderDetails} The populated <code>UpdateServerRequestIdentityProviderDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateServerRequestIdentityProviderDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateServerRequestIdentityProviderDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateServerRequestIdentityProviderDetails</code>.
     */
 ...
 * @member {String} Url
 */
UpdateServerRequestIdentityProviderDetails.prototype['Url'] = undefined;

/**
 * @member {String} InvocationRole
 */
UpdateServerRequestIdentityProviderDetails.prototype['InvocationRole'] = undefined;

/**
 * @member {String} DirectoryId
 */
UpdateServerRequestIdentityProviderDetails.prototype['DirectoryId'] = undefined;

/**
 * @member {String} Function
 */
UpdateServerRequestIdentityProviderDetails.prototype['Function'] = undefined;

/**
 * @member {module:model/SftpAuthenticationMethods} SftpAuthenticationMethods
 */
UpdateServerRequestIdentityProviderDetails.prototype['SftpAuthenticationMethods'] = undefined;
...
export default UpdateServerRequestIdentityProviderDetails;
