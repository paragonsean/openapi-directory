...
/**
 * The DescribedServerIdentityProviderDetails model module.
 * @module model/DescribedServerIdentityProviderDetails
 * @version 2018-11-05
 */
class DescribedServerIdentityProviderDetails {
    /**
     * Constructs a new <code>DescribedServerIdentityProviderDetails</code>.
     * @alias module:model/DescribedServerIdentityProviderDetails
     * @implements module:model/IdentityProviderDetails
     */
    constructor() { 
        IdentityProviderDetails.initialize(this);
        DescribedServerIdentityProviderDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribedServerIdentityProviderDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribedServerIdentityProviderDetails} obj Optional instance to populate.
     * @return {module:model/DescribedServerIdentityProviderDetails} The populated <code>DescribedServerIdentityProviderDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribedServerIdentityProviderDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribedServerIdentityProviderDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribedServerIdentityProviderDetails</code>.
     */
 ...
 * @member {String} Url
 */
DescribedServerIdentityProviderDetails.prototype['Url'] = undefined;

/**
 * @member {String} InvocationRole
 */
DescribedServerIdentityProviderDetails.prototype['InvocationRole'] = undefined;

/**
 * @member {String} DirectoryId
 */
DescribedServerIdentityProviderDetails.prototype['DirectoryId'] = undefined;

/**
 * @member {String} Function
 */
DescribedServerIdentityProviderDetails.prototype['Function'] = undefined;

/**
 * @member {module:model/SftpAuthenticationMethods} SftpAuthenticationMethods
 */
DescribedServerIdentityProviderDetails.prototype['SftpAuthenticationMethods'] = undefined;
...
export default DescribedServerIdentityProviderDetails;
