...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListAgreementsRequest();
  });
  ...
  describe('ListAgreementsRequest', function() {
    it('should create an instance of ListAgreementsRequest', function() {
      // uncomment below and update the code to test ListAgreementsRequest
      //var instance = new AwsTransferFamily.ListAgreementsRequest();
      //expect(instance).to.be.a(AwsTransferFamily.ListAgreementsRequest);
    });
