...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListAgreementsResponse();
  });
  ...
  describe('ListAgreementsResponse', function() {
    it('should create an instance of ListAgreementsResponse', function() {
      // uncomment below and update the code to test ListAgreementsResponse
      //var instance = new AwsTransferFamily.ListAgreementsResponse();
      //expect(instance).to.be.a(AwsTransferFamily.ListAgreementsResponse);
    });
