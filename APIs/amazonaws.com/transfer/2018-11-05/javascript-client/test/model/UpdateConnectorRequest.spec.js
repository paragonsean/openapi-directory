...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.UpdateConnectorRequest();
  });
  ...
  describe('UpdateConnectorRequest', function() {
    it('should create an instance of UpdateConnectorRequest', function() {
      // uncomment below and update the code to test UpdateConnectorRequest
      //var instance = new AwsTransferFamily.UpdateConnectorRequest();
      //expect(instance).to.be.a(AwsTransferFamily.UpdateConnectorRequest);
    });
