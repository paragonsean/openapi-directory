...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListedConnector();
  });
  ...
  describe('ListedConnector', function() {
    it('should create an instance of ListedConnector', function() {
      // uncomment below and update the code to test ListedConnector
      //var instance = new AwsTransferFamily.ListedConnector();
      //expect(instance).to.be.a(AwsTransferFamily.ListedConnector);
    });
