...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListedProfile();
  });
  ...
  describe('ListedProfile', function() {
    it('should create an instance of ListedProfile', function() {
      // uncomment below and update the code to test ListedProfile
      //var instance = new AwsTransferFamily.ListedProfile();
      //expect(instance).to.be.a(AwsTransferFamily.ListedProfile);
    });
