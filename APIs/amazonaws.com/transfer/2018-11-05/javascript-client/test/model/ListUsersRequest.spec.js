...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListUsersRequest();
  });
  ...
  describe('ListUsersRequest', function() {
    it('should create an instance of ListUsersRequest', function() {
      ...
      //var instance = new AwsTransferFamily.ListUsersRequest();
      //expect(instance).to.be.a(AwsTransferFamily.ListUsersRequest);
    });
