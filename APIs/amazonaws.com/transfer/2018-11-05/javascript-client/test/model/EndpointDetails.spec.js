...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.EndpointDetails();
  });
  ...
  describe('EndpointDetails', function() {
    it('should create an instance of EndpointDetails', function() {
      // uncomment below and update the code to test EndpointDetails
      //var instance = new AwsTransferFamily.EndpointDetails();
      //expect(instance).to.be.a(AwsTransferFamily.EndpointDetails);
    });
