...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.CreateServerRequestEndpointDetails();
  });
  ...
  describe('CreateServerRequestEndpointDetails', function() {
    it('should create an instance of CreateServerRequestEndpointDetails', function() {
      // uncomment below and update the code to test CreateServerRequestEndpointDetails
      //var instance = new AwsTransferFamily.CreateServerRequestEndpointDetails();
      //expect(instance).to.be.a(AwsTransferFamily.CreateServerRequestEndpointDetails);
    });

    it('should have the property addressAllocationIds (base name: "AddressAllocationIds")', function() {
      // uncomment below and update the code to test the property addressAllocationIds
      //var instance = new AwsTransferFamily.CreateServerRequestEndpointDetails();
