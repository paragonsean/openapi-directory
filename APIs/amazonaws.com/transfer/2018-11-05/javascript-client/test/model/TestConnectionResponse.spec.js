...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.TestConnectionResponse();
  });
  ...
  describe('TestConnectionResponse', function() {
    it('should create an instance of TestConnectionResponse', function() {
      // uncomment below and update the code to test TestConnectionResponse
      //var instance = new AwsTransferFamily.TestConnectionResponse();
      //expect(instance).to.be.a(AwsTransferFamily.TestConnectionResponse);
    });
