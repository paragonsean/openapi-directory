...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListedServer();
  });
  ...
  describe('ListedServer', function() {
    it('should create an instance of ListedServer', function() {
      // uncomment below and update the code to test ListedServer
      //var instance = new AwsTransferFamily.ListedServer();
      //expect(instance).to.be.a(AwsTransferFamily.ListedServer);
    });
