...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.FileLocationS3FileLocation();
  });
  ...
  describe('FileLocationS3FileLocation', function() {
    it('should create an instance of FileLocationS3FileLocation', function() {
      // uncomment below and update the code to test FileLocationS3FileLocation
      //var instance = new AwsTransferFamily.FileLocationS3FileLocation();
      //expect(instance).to.be.a(AwsTransferFamily.FileLocationS3FileLocation);
    });
