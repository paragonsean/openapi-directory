...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListServersResponse();
  });
  ...
  describe('ListServersResponse', function() {
    it('should create an instance of ListServersResponse', function() {
      // uncomment below and update the code to test ListServersResponse
      //var instance = new AwsTransferFamily.ListServersResponse();
      //expect(instance).to.be.a(AwsTransferFamily.ListServersResponse);
    });
