...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.DeleteConnectorRequest();
  });
  ...
  describe('DeleteConnectorRequest', function() {
    it('should create an instance of DeleteConnectorRequest', function() {
      // uncomment below and update the code to test DeleteConnectorRequest
      //var instance = new AwsTransferFamily.DeleteConnectorRequest();
      //expect(instance).to.be.a(AwsTransferFamily.DeleteConnectorRequest);
    });
