...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListAccessesRequest();
  });
  ...
  describe('ListAccessesRequest', function() {
    it('should create an instance of ListAccessesRequest', function() {
      // uncomment below and update the code to test ListAccessesRequest
      //var instance = new AwsTransferFamily.ListAccessesRequest();
      //expect(instance).to.be.a(AwsTransferFamily.ListAccessesRequest);
    });
