...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListUsersResponse();
  });
  ...
  describe('ListUsersResponse', function() {
    it('should create an instance of ListUsersResponse', function() {
      ...
      //var instance = new AwsTransferFamily.ListUsersResponse();
      //expect(instance).to.be.a(AwsTransferFamily.ListUsersResponse);
    });
