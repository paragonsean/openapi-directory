...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.S3FileLocation();
  });
  ...
  describe('S3FileLocation', function() {
    it('should create an instance of S3FileLocation', function() {
      // uncomment below and update the code to test S3FileLocation
      //var instance = new AwsTransferFamily.S3FileLocation();
      //expect(instance).to.be.a(AwsTransferFamily.S3FileLocation);
    });
