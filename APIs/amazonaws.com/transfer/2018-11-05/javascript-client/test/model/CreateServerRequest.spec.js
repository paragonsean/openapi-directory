...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.CreateServerRequest();
  });
  ...
  describe('CreateServerRequest', function() {
    it('should create an instance of CreateServerRequest', function() {
      ...
      //var instance = new AwsTransferFamily.CreateServerRequest();
      //expect(instance).to.be.a(AwsTransferFamily.CreateServerRequest);
    });
    ...
    it('should have the property hostKey (base name: "HostKey")', function() {
      // uncomment below and update the code to test the property hostKey
      //var instance = new AwsTransferFamily.CreateServerRequest();
      //expect(instance).to.be();
    });
