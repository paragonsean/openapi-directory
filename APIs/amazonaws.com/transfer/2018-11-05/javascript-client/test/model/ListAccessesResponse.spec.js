...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListAccessesResponse();
  });
  ...
  describe('ListAccessesResponse', function() {
    it('should create an instance of ListAccessesResponse', function() {
      // uncomment below and update the code to test ListAccessesResponse
      //var instance = new AwsTransferFamily.ListAccessesResponse();
      //expect(instance).to.be.a(AwsTransferFamily.ListAccessesResponse);
    });
