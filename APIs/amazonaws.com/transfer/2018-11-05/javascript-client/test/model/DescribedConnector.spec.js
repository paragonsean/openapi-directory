...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.DescribedConnector();
  });
  ...
  describe('DescribedConnector', function() {
    it('should create an instance of DescribedConnector', function() {
      // uncomment below and update the code to test DescribedConnector
      //var instance = new AwsTransferFamily.DescribedConnector();
      //expect(instance).to.be.a(AwsTransferFamily.DescribedConnector);
    });
