...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListServersRequest();
  });
  ...
  describe('ListServersRequest', function() {
    it('should create an instance of ListServersRequest', function() {
      ...
      //var instance = new AwsTransferFamily.ListServersRequest();
      //expect(instance).to.be.a(AwsTransferFamily.ListServersRequest);
    });
