...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.WorkflowDetail();
  });
  ...
  describe('WorkflowDetail', function() {
    it('should create an instance of WorkflowDetail', function() {
      // uncomment below and update the code to test WorkflowDetail
      //var instance = new AwsTransferFamily.WorkflowDetail();
      //expect(instance).to.be.a(AwsTransferFamily.WorkflowDetail);
    });
