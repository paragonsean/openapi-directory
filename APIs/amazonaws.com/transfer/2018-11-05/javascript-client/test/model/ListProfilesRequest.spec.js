...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListProfilesRequest();
  });
  ...
  describe('ListProfilesRequest', function() {
    it('should create an instance of ListProfilesRequest', function() {
      // uncomment below and update the code to test ListProfilesRequest
      //var instance = new AwsTransferFamily.ListProfilesRequest();
      //expect(instance).to.be.a(AwsTransferFamily.ListProfilesRequest);
    });
