...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListExecutionsRequest();
  });
  ...
  describe('ListExecutionsRequest', function() {
    it('should create an instance of ListExecutionsRequest', function() {
      // uncomment below and update the code to test ListExecutionsRequest
      //var instance = new AwsTransferFamily.ListExecutionsRequest();
      //expect(instance).to.be.a(AwsTransferFamily.ListExecutionsRequest);
    });
