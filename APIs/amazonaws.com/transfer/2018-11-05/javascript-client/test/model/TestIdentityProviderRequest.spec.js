...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.TestIdentityProviderRequest();
  });
  ...
  describe('TestIdentityProviderRequest', function() {
    it('should create an instance of TestIdentityProviderRequest', function() {
      // uncomment below and update the code to test TestIdentityProviderRequest
      //var instance = new AwsTransferFamily.TestIdentityProviderRequest();
      //expect(instance).to.be.a(AwsTransferFamily.TestIdentityProviderRequest);
    });
