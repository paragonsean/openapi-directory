...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.UpdateServerRequest();
  });
  ...
  describe('UpdateServerRequest', function() {
    it('should create an instance of UpdateServerRequest', function() {
      ...
      //var instance = new AwsTransferFamily.UpdateServerRequest();
      //expect(instance).to.be.a(AwsTransferFamily.UpdateServerRequest);
    });
