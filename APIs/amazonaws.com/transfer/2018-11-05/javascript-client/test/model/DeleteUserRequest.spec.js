...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.DeleteUserRequest();
  });
  ...
  describe('DeleteUserRequest', function() {
    it('should create an instance of DeleteUserRequest', function() {
      ...
      //var instance = new AwsTransferFamily.DeleteUserRequest();
      //expect(instance).to.be.a(AwsTransferFamily.DeleteUserRequest);
    });
