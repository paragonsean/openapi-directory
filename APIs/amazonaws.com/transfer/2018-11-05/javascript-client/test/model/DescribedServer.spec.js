...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.DescribedServer();
  });
  ...
  describe('DescribedServer', function() {
    it('should create an instance of DescribedServer', function() {
      // uncomment below and update the code to test DescribedServer
      //var instance = new AwsTransferFamily.DescribedServer();
      //expect(instance).to.be.a(AwsTransferFamily.DescribedServer);
    });
