...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.CreateWorkflowRequest();
  });
  ...
  describe('CreateWorkflowRequest', function() {
    it('should create an instance of CreateWorkflowRequest', function() {
      ...
      //var instance = new AwsTransferFamily.CreateWorkflowRequest();
      //expect(instance).to.be.a(AwsTransferFamily.CreateWorkflowRequest);
    });
    ...
    it('should have the property onExceptionSteps (base name: "OnExceptionSteps")', function() {
      // uncomment below and update the code to test the property onExceptionSteps
      //var instance = new AwsTransferFamily.CreateWorkflowRequest();
      //expect(instance).to.be();
    });
