...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.CreateUserResponse();
  });
  ...
  describe('CreateUserResponse', function() {
    it('should create an instance of CreateUserResponse', function() {
      ...
      //var instance = new AwsTransferFamily.CreateUserResponse();
      //expect(instance).to.be.a(AwsTransferFamily.CreateUserResponse);
    });
