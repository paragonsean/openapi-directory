...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.DeleteAgreementRequest();
  });
  ...
  describe('DeleteAgreementRequest', function() {
    it('should create an instance of DeleteAgreementRequest', function() {
      // uncomment below and update the code to test DeleteAgreementRequest
      //var instance = new AwsTransferFamily.DeleteAgreementRequest();
      //expect(instance).to.be.a(AwsTransferFamily.DeleteAgreementRequest);
    });
