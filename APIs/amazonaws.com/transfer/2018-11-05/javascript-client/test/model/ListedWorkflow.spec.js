...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListedWorkflow();
  });
  ...
  describe('ListedWorkflow', function() {
    it('should create an instance of ListedWorkflow', function() {
      // uncomment below and update the code to test ListedWorkflow
      //var instance = new AwsTransferFamily.ListedWorkflow();
      //expect(instance).to.be.a(AwsTransferFamily.ListedWorkflow);
    });
