...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListedExecution();
  });
  ...
  describe('ListedExecution', function() {
    it('should create an instance of ListedExecution', function() {
      // uncomment below and update the code to test ListedExecution
      //var instance = new AwsTransferFamily.ListedExecution();
      //expect(instance).to.be.a(AwsTransferFamily.ListedExecution);
    });
