...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.ListHostKeysRequest();
  });
  ...
  describe('ListHostKeysRequest', function() {
    it('should create an instance of ListHostKeysRequest', function() {
      // uncomment below and update the code to test ListHostKeysRequest
      //var instance = new AwsTransferFamily.ListHostKeysRequest();
      //expect(instance).to.be.a(AwsTransferFamily.ListHostKeysRequest);
    });
