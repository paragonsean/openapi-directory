...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.UpdateProfileResponse();
  });
  ...
  describe('UpdateProfileResponse', function() {
    it('should create an instance of UpdateProfileResponse', function() {
      ...
      //var instance = new AwsTransferFamily.UpdateProfileResponse();
      //expect(instance).to.be.a(AwsTransferFamily.UpdateProfileResponse);
    });
