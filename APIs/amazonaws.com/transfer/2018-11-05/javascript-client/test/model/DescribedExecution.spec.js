...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsTransferFamily.DescribedExecution();
  });
  ...
  describe('DescribedExecution', function() {
    it('should create an instance of DescribedExecution', function() {
      // uncomment below and update the code to test DescribedExecution
      //var instance = new AwsTransferFamily.DescribedExecution();
      //expect(instance).to.be.a(AwsTransferFamily.DescribedExecution);
    });
