...
/*
 * OAIEncryptionOptions.h
 *
 * Encryption options for the broker.
 */

#ifndef OAIEncryptionOptions_H
#define OAIEncryptionOptions_H
...
class OAIEncryptionOptions : public OAIObject {
public:
    OAIEncryptionOptions();
    OAIEncryptionOptions(QString json);
    ~OAIEncryptionOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncryptionOptions)

#endif // OAIEncryptionOptions_H
