...
/*
 * OAIDescribeBrokerResponse_PendingDataReplicationMetadata.h
 *
 * 
 */

#ifndef OAIDescribeBrokerResponse_PendingDataReplicationMetadata_H
#define OAIDescribeBrokerResponse_PendingDataReplicationMetadata_H
...
class OAIDescribeBrokerResponse_PendingDataReplicationMetadata : public OAIObject {
public:
    OAIDescribeBrokerResponse_PendingDataReplicationMetadata();
    OAIDescribeBrokerResponse_PendingDataReplicationMetadata(QString json);
    ~OAIDescribeBrokerResponse_PendingDataReplicationMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBrokerResponse_PendingDataReplicationMetadata)

#endif // OAIDescribeBrokerResponse_PendingDataReplicationMetadata_H
