...
/*
 * OAICreateBrokerRequest_LdapServerMetadata.h
 *
 * 
 */

#ifndef OAICreateBrokerRequest_LdapServerMetadata_H
#define OAICreateBrokerRequest_LdapServerMetadata_H
...
class OAICreateBrokerRequest_LdapServerMetadata : public OAIObject {
public:
    OAICreateBrokerRequest_LdapServerMetadata();
    OAICreateBrokerRequest_LdapServerMetadata(QString json);
    ~OAICreateBrokerRequest_LdapServerMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBrokerRequest_LdapServerMetadata)

#endif // OAICreateBrokerRequest_LdapServerMetadata_H
