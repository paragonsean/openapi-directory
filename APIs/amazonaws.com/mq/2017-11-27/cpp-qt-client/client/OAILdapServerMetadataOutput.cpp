...
#include "OAILdapServerMetadataOutput.h"
...
OAILdapServerMetadataOutput::OAILdapServerMetadataOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILdapServerMetadataOutput::OAILdapServerMetadataOutput() {
    this->initializeModel();
}

OAILdapServerMetadataOutput::~OAILdapServerMetadataOutput() {}

void OAILdapServerMetadataOutput::initializeModel() {
...
void OAILdapServerMetadataOutput::fromJson(QString jsonString) {
...
void OAILdapServerMetadataOutput::fromJsonObject(QJsonObject json) {
...
QString OAILdapServerMetadataOutput::asJson() const {
...
QJsonObject OAILdapServerMetadataOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_hosts.isSet()) {
...
QList OAILdapServerMetadataOutput::getHosts() const {
    return m_hosts;
}
void OAILdapServerMetadataOutput::setHosts(const QList &hosts) {
    m_hosts = hosts;
    m_hosts_isSet = true;
}

bool OAILdapServerMetadataOutput::is_hosts_Set() const{
    return m_hosts_isSet;
}

bool OAILdapServerMetadataOutput::is_hosts_Valid() const{
    return m_hosts_isValid;
}

QString OAILdapServerMetadataOutput::getRoleBase() const {
    return m_role_base;
}
void OAILdapServerMetadataOutput::setRoleBase(const QString &role_base) {
    m_role_base = role_base;
    m_role_base_isSet = true;
}

bool OAILdapServerMetadataOutput::is_role_base_Set() const{
    return m_role_base_isSet;
}

bool OAILdapServerMetadataOutput::is_role_base_Valid() const{
    return m_role_base_isValid;
}

QString OAILdapServerMetadataOutput::getRoleName() const {
    return m_role_name;
}
void OAILdapServerMetadataOutput::setRoleName(const QString &role_name) {
    m_role_name = role_name;
    m_role_name_isSet = true;
}

bool OAILdapServerMetadataOutput::is_role_name_Set() const{
    return m_role_name_isSet;
}

bool OAILdapServerMetadataOutput::is_role_name_Valid() const{
    return m_role_name_isValid;
}

QString OAILdapServerMetadataOutput::getRoleSearchMatching() const {
    return m_role_search_matching;
}
void OAILdapServerMetadataOutput::setRoleSearchMatching(const QString &role_search_matching) {
    m_role_search_matching = role_search_matching;
    m_role_search_matching_isSet = true;
}

bool OAILdapServerMetadataOutput::is_role_search_matching_Set() const{
    return m_role_search_matching_isSet;
}

bool OAILdapServerMetadataOutput::is_role_search_matching_Valid() const{
    return m_role_search_matching_isValid;
}

bool OAILdapServerMetadataOutput::getRoleSearchSubtree() const {
    return m_role_search_subtree;
}
void OAILdapServerMetadataOutput::setRoleSearchSubtree(const bool &role_search_subtree) {
    m_role_search_subtree = role_search_subtree;
    m_role_search_subtree_isSet = true;
}

bool OAILdapServerMetadataOutput::is_role_search_subtree_Set() const{
    return m_role_search_subtree_isSet;
}

bool OAILdapServerMetadataOutput::is_role_search_subtree_Valid() const{
    return m_role_search_subtree_isValid;
}

QString OAILdapServerMetadataOutput::getServiceAccountUsername() const {
    return m_service_account_username;
}
void OAILdapServerMetadataOutput::setServiceAccountUsername(const QString &service_account_username) {
    m_service_account_username = service_account_username;
    m_service_account_username_isSet = true;
}

bool OAILdapServerMetadataOutput::is_service_account_username_Set() const{
    return m_service_account_username_isSet;
}

bool OAILdapServerMetadataOutput::is_service_account_username_Valid() const{
    return m_service_account_username_isValid;
}

QString OAILdapServerMetadataOutput::getUserBase() const {
    return m_user_base;
}
void OAILdapServerMetadataOutput::setUserBase(const QString &user_base) {
    m_user_base = user_base;
    m_user_base_isSet = true;
}

bool OAILdapServerMetadataOutput::is_user_base_Set() const{
    return m_user_base_isSet;
}

bool OAILdapServerMetadataOutput::is_user_base_Valid() const{
    return m_user_base_isValid;
}

QString OAILdapServerMetadataOutput::getUserRoleName() const {
    return m_user_role_name;
}
void OAILdapServerMetadataOutput::setUserRoleName(const QString &user_role_name) {
    m_user_role_name = user_role_name;
    m_user_role_name_isSet = true;
}

bool OAILdapServerMetadataOutput::is_user_role_name_Set() const{
    return m_user_role_name_isSet;
}

bool OAILdapServerMetadataOutput::is_user_role_name_Valid() const{
    return m_user_role_name_isValid;
}

QString OAILdapServerMetadataOutput::getUserSearchMatching() const {
    return m_user_search_matching;
}
void OAILdapServerMetadataOutput::setUserSearchMatching(const QString &user_search_matching) {
    m_user_search_matching = user_search_matching;
    m_user_search_matching_isSet = true;
}

bool OAILdapServerMetadataOutput::is_user_search_matching_Set() const{
    return m_user_search_matching_isSet;
}

bool OAILdapServerMetadataOutput::is_user_search_matching_Valid() const{
    return m_user_search_matching_isValid;
}

bool OAILdapServerMetadataOutput::getUserSearchSubtree() const {
    return m_user_search_subtree;
}
void OAILdapServerMetadataOutput::setUserSearchSubtree(const bool &user_search_subtree) {
    m_user_search_subtree = user_search_subtree;
    m_user_search_subtree_isSet = true;
}

bool OAILdapServerMetadataOutput::is_user_search_subtree_Set() const{
    return m_user_search_subtree_isSet;
}

bool OAILdapServerMetadataOutput::is_user_search_subtree_Valid() const{
    return m_user_search_subtree_isValid;
}

bool OAILdapServerMetadataOutput::isSet() const {
...
bool OAILdapServerMetadataOutput::isValid() const {
