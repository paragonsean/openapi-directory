...
/*
 * OAIDescribeBrokerResponse_LdapServerMetadata.h
 *
 * 
 */

#ifndef OAIDescribeBrokerResponse_LdapServerMetadata_H
#define OAIDescribeBrokerResponse_LdapServerMetadata_H
...
class OAIDescribeBrokerResponse_LdapServerMetadata : public OAIObject {
public:
    OAIDescribeBrokerResponse_LdapServerMetadata();
    OAIDescribeBrokerResponse_LdapServerMetadata(QString json);
    ~OAIDescribeBrokerResponse_LdapServerMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBrokerResponse_LdapServerMetadata)

#endif // OAIDescribeBrokerResponse_LdapServerMetadata_H
