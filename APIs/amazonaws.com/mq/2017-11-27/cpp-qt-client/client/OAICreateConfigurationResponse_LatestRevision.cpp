...
QDateTime OAICreateConfigurationResponse_LatestRevision::getCreated() const {
    return m_created;
}
void OAICreateConfigurationResponse_LatestRevision::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAICreateConfigurationResponse_LatestRevision::is_created_Set() const{
    return m_created_isSet;
}

bool OAICreateConfigurationResponse_LatestRevision::is_created_Valid() const{
