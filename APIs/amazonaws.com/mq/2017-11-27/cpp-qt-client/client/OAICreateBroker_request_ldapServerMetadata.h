...
/*
 * OAICreateBroker_request_ldapServerMetadata.h
 *
...
#ifndef OAICreateBroker_request_ldapServerMetadata_H
#define OAICreateBroker_request_ldapServerMetadata_H
...
class OAICreateBroker_request_ldapServerMetadata : public OAIObject {
public:
    OAICreateBroker_request_ldapServerMetadata();
    OAICreateBroker_request_ldapServerMetadata(QString json);
    ~OAICreateBroker_request_ldapServerMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBroker_request_ldapServerMetadata)

#endif // OAICreateBroker_request_ldapServerMetadata_H
