...
/*
 * OAIDescribeBrokerResponse_Configurations.h
 *
 * 
 */

#ifndef OAIDescribeBrokerResponse_Configurations_H
#define OAIDescribeBrokerResponse_Configurations_H
...
class OAIDescribeBrokerResponse_Configurations : public OAIObject {
public:
    OAIDescribeBrokerResponse_Configurations();
    OAIDescribeBrokerResponse_Configurations(QString json);
    ~OAIDescribeBrokerResponse_Configurations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBrokerResponse_Configurations)

#endif // OAIDescribeBrokerResponse_Configurations_H
