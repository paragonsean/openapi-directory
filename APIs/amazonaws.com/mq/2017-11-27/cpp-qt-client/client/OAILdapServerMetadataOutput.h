...
/*
 * OAILdapServerMetadataOutput.h
 *
 * Optional. The metadata of the LDAP server used to authenticate and authorize connections to the broker.
 */

#ifndef OAILdapServerMetadataOutput_H
#define OAILdapServerMetadataOutput_H
...
class OAILdapServerMetadataOutput : public OAIObject {
public:
    OAILdapServerMetadataOutput();
    OAILdapServerMetadataOutput(QString json);
    ~OAILdapServerMetadataOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILdapServerMetadataOutput)

#endif // OAILdapServerMetadataOutput_H
