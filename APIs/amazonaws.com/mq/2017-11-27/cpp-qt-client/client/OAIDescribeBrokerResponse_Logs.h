...
/*
 * OAIDescribeBrokerResponse_Logs.h
 *
 * 
 */

#ifndef OAIDescribeBrokerResponse_Logs_H
#define OAIDescribeBrokerResponse_Logs_H
...
class OAIDescribeBrokerResponse_Logs : public OAIObject {
public:
    OAIDescribeBrokerResponse_Logs();
    OAIDescribeBrokerResponse_Logs(QString json);
    ~OAIDescribeBrokerResponse_Logs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBrokerResponse_Logs)

#endif // OAIDescribeBrokerResponse_Logs_H
