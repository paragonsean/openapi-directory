...
#ifndef OAIPendingLogs_H
#define OAIPendingLogs_H
...
class OAIPendingLogs : public OAIObject {
public:
    OAIPendingLogs();
    OAIPendingLogs(QString json);
    ~OAIPendingLogs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPendingLogs)

#endif // OAIPendingLogs_H
