...
/*
 * OAIDescribeBrokerResponse_PendingLdapServerMetadata.h
 *
 * 
 */

#ifndef OAIDescribeBrokerResponse_PendingLdapServerMetadata_H
#define OAIDescribeBrokerResponse_PendingLdapServerMetadata_H
...
class OAIDescribeBrokerResponse_PendingLdapServerMetadata : public OAIObject {
public:
    OAIDescribeBrokerResponse_PendingLdapServerMetadata();
    OAIDescribeBrokerResponse_PendingLdapServerMetadata(QString json);
    ~OAIDescribeBrokerResponse_PendingLdapServerMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBrokerResponse_PendingLdapServerMetadata)

#endif // OAIDescribeBrokerResponse_PendingLdapServerMetadata_H
