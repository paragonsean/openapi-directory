...
class Example : public QObject {
    Q_OBJECT
    OAICreateBroker_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateBroker_request Example::create(){
    OAICreateBroker_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createBrokerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createBrokerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateBroker_request oai_create_broker_request = create(); // OAICreateBroker_request | 
      ...
      apiInstance.createBroker(oai_create_broker_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
