...
async def test_create_broker(client):
    ...
    """
    body = {"SecurityGroups":"","DataReplicationPrimaryBrokerArn":"","EngineVersion":"","StorageType":"","Configuration":{"Revision":"","Id":""},"AuthenticationStrategy":"","MaintenanceWindowStartTime":{"DayOfWeek":"","TimeOfDay":"","TimeZone":""},"HostInstanceType":"","AutoMinorVersionUpgrade":"","Logs":{"Audit":"","General":""},"Users":"","CreatorRequestId":"","SubnetIds":"","DataReplicationMode":"","BrokerName":"","LdapServerMetadata":{"Hosts":"","RoleName":"","UserRoleName":"","UserSearchMatching":"","UserBase":"","UserSearchSubtree":"","RoleSearchMatching":"","ServiceAccountUsername":"","RoleBase":"","ServiceAccountPassword":"","RoleSearchSubtree":""},"DeploymentMode":"","EngineType":"","PubliclyAccessible":"","EncryptionOptions":{"KmsKeyId":"","UseAwsOwnedKey":""},"Tags":""}
    headers = { 
...
async def test_create_configuration(client):
    ...
    """
    body = {"EngineVersion":"","AuthenticationStrategy":"","EngineType":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_user(client):
    ...
    """
    body = {"ReplicationUser":"","Groups":"","ConsoleAccess":"","Password":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/v1/brokers/{broker_id}/users/{username}'.format(broker_id='broker_id_example', username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_broker(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/brokers/{broker_id}'.format(broker_id='broker_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_broker(client):
    """Test case for describe_broker
...
async def test_describe_broker_engine_types(client):
    """Test case for describe_broker_engine_types
...
async def test_describe_broker_instance_options(client):
    """Test case for describe_broker_instance_options

    
    """
    params = [('engineType', 'engine_type_example'),
                    ('hostInstanceType', 'host_instance_type_example'),
                    ('maxResults', 56),
                    ('nextToken', 'next_token_example'),
...
async def test_describe_configuration(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/configurations/{configuration_id}'.format(configuration_id='configuration_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_configuration_revision(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/configurations/{configuration_id}/revisions/{configuration_revision}'.format(configuration_id='configuration_id_example', configuration_revision='configuration_revision_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_configuration_revisions(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/configurations/{configuration_id}/revisions'.format(configuration_id='configuration_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_users(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/brokers/{broker_id}/users'.format(broker_id='broker_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_promote(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/brokers/{broker_id}/promote'.format(broker_id='broker_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reboot_broker(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/brokers/{broker_id}/reboot'.format(broker_id='broker_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_broker(client):
    ...
    """
    body = {"LdapServerMetadata":{"Hosts":"","RoleName":"","UserRoleName":"","UserSearchMatching":"","UserBase":"","UserSearchSubtree":"","RoleSearchMatching":"","ServiceAccountUsername":"","RoleBase":"","ServiceAccountPassword":"","RoleSearchSubtree":""},"SecurityGroups":"","EngineVersion":"","Configuration":{"Revision":"","Id":""},"AuthenticationStrategy":"","MaintenanceWindowStartTime":{"DayOfWeek":"","TimeOfDay":"","TimeZone":""},"HostInstanceType":"","AutoMinorVersionUpgrade":"","Logs":{"Audit":"","General":""},"DataReplicationMode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
