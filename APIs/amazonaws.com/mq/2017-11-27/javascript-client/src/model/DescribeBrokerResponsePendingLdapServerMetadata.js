...
/**
 * The DescribeBrokerResponsePendingLdapServerMetadata model module.
 * @module model/DescribeBrokerResponsePendingLdapServerMetadata
 * @version 2017-11-27
 */
class DescribeBrokerResponsePendingLdapServerMetadata {
    /**
     * Constructs a new <code>DescribeBrokerResponsePendingLdapServerMetadata</code>.
     * @alias module:model/DescribeBrokerResponsePendingLdapServerMetadata
    ...
    constructor(hosts, roleBase, roleSearchMatching, serviceAccountUsername, userBase, userSearchMatching) { 
        ...
        DescribeBrokerResponsePendingLdapServerMetadata.initialize(this, hosts, roleBase, roleSearchMatching, serviceAccountUsername, userBase, userSearchMatching);
    }
    ...
    /**
     * Constructs a <code>DescribeBrokerResponsePendingLdapServerMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBrokerResponsePendingLdapServerMetadata} obj Optional instance to populate.
     * @return {module:model/DescribeBrokerResponsePendingLdapServerMetadata} The populated <code>DescribeBrokerResponsePendingLdapServerMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBrokerResponsePendingLdapServerMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBrokerResponsePendingLdapServerMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBrokerResponsePendingLdapServerMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBrokerResponsePendingLdapServerMetadata.RequiredProperties) {
...
DescribeBrokerResponsePendingLdapServerMetadata.RequiredProperties = ["Hosts", "RoleBase", "RoleSearchMatching", "ServiceAccountUsername", "UserBase", "UserSearchMatching"];

/**
 * @member {Array} Hosts
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['Hosts'] = undefined;

/**
 * @member {String} RoleBase
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['RoleBase'] = undefined;

/**
 * @member {String} RoleName
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['RoleName'] = undefined;

/**
 * @member {String} RoleSearchMatching
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['RoleSearchMatching'] = undefined;

/**
 * @member {Boolean} RoleSearchSubtree
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['RoleSearchSubtree'] = undefined;

/**
 * @member {String} ServiceAccountUsername
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['ServiceAccountUsername'] = undefined;

/**
 * @member {String} UserBase
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['UserBase'] = undefined;

/**
 * @member {String} UserRoleName
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['UserRoleName'] = undefined;

/**
 * @member {String} UserSearchMatching
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['UserSearchMatching'] = undefined;

/**
 * @member {Boolean} UserSearchSubtree
 */
DescribeBrokerResponsePendingLdapServerMetadata.prototype['UserSearchSubtree'] = undefined;
...
export default DescribeBrokerResponsePendingLdapServerMetadata;
