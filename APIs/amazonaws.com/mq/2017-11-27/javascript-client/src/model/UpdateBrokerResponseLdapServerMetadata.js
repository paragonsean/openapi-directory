...
/**
 * The UpdateBrokerResponseLdapServerMetadata model module.
 * @module model/UpdateBrokerResponseLdapServerMetadata
 * @version 2017-11-27
 */
class UpdateBrokerResponseLdapServerMetadata {
    /**
     * Constructs a new <code>UpdateBrokerResponseLdapServerMetadata</code>.
     * @alias module:model/UpdateBrokerResponseLdapServerMetadata
    ...
    constructor(hosts, roleBase, roleSearchMatching, serviceAccountUsername, userBase, userSearchMatching) { 
        ...
        UpdateBrokerResponseLdapServerMetadata.initialize(this, hosts, roleBase, roleSearchMatching, serviceAccountUsername, userBase, userSearchMatching);
    }
    ...
    /**
     * Constructs a <code>UpdateBrokerResponseLdapServerMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBrokerResponseLdapServerMetadata} obj Optional instance to populate.
     * @return {module:model/UpdateBrokerResponseLdapServerMetadata} The populated <code>UpdateBrokerResponseLdapServerMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBrokerResponseLdapServerMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBrokerResponseLdapServerMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBrokerResponseLdapServerMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateBrokerResponseLdapServerMetadata.RequiredProperties) {
...
UpdateBrokerResponseLdapServerMetadata.RequiredProperties = ["Hosts", "RoleBase", "RoleSearchMatching", "ServiceAccountUsername", "UserBase", "UserSearchMatching"];

/**
 * @member {Array} Hosts
 */
UpdateBrokerResponseLdapServerMetadata.prototype['Hosts'] = undefined;

/**
 * @member {String} RoleBase
 */
UpdateBrokerResponseLdapServerMetadata.prototype['RoleBase'] = undefined;

/**
 * @member {String} RoleName
 */
UpdateBrokerResponseLdapServerMetadata.prototype['RoleName'] = undefined;

/**
 * @member {String} RoleSearchMatching
 */
UpdateBrokerResponseLdapServerMetadata.prototype['RoleSearchMatching'] = undefined;

/**
 * @member {Boolean} RoleSearchSubtree
 */
UpdateBrokerResponseLdapServerMetadata.prototype['RoleSearchSubtree'] = undefined;

/**
 * @member {String} ServiceAccountUsername
 */
UpdateBrokerResponseLdapServerMetadata.prototype['ServiceAccountUsername'] = undefined;

/**
 * @member {String} UserBase
 */
UpdateBrokerResponseLdapServerMetadata.prototype['UserBase'] = undefined;

/**
 * @member {String} UserRoleName
 */
UpdateBrokerResponseLdapServerMetadata.prototype['UserRoleName'] = undefined;

/**
 * @member {String} UserSearchMatching
 */
UpdateBrokerResponseLdapServerMetadata.prototype['UserSearchMatching'] = undefined;

/**
 * @member {Boolean} UserSearchSubtree
 */
UpdateBrokerResponseLdapServerMetadata.prototype['UserSearchSubtree'] = undefined;
...
export default UpdateBrokerResponseLdapServerMetadata;
