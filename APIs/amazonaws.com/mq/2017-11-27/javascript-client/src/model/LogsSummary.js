...
/**
 * The LogsSummary model module.
 * @module model/LogsSummary
 * @version 2017-11-27
 */
class LogsSummary {
    /**
     * Constructs a new <code>LogsSummary</code>.
     * The list of information about logs currently enabled and pending to be deployed for the specified broker.
     * @alias module:model/LogsSummary
    ...
    /**
     * Constructs a <code>LogsSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogsSummary} obj Optional instance to populate.
     * @return {module:model/LogsSummary} The populated <code>LogsSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogsSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>LogsSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogsSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LogsSummary.RequiredProperties) {
...
LogsSummary.RequiredProperties = ["General", "GeneralLogGroup"];
