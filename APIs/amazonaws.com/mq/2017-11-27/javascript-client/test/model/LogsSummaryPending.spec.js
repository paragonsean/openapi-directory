...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMq.LogsSummaryPending();
  });
  ...
  describe('LogsSummaryPending', function() {
    it('should create an instance of LogsSummaryPending', function() {
      // uncomment below and update the code to test LogsSummaryPending
      //var instance = new AmazonMq.LogsSummaryPending();
      //expect(instance).to.be.a(AmazonMq.LogsSummaryPending);
    });
