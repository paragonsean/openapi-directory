...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMq.DescribeConfigurationResponse();
  });
  ...
  describe('DescribeConfigurationResponse', function() {
    it('should create an instance of DescribeConfigurationResponse', function() {
      // uncomment below and update the code to test DescribeConfigurationResponse
      //var instance = new AmazonMq.DescribeConfigurationResponse();
      //expect(instance).to.be.a(AmazonMq.DescribeConfigurationResponse);
    });
