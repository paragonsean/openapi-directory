...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMq.CreateBrokerResponse();
  });
  ...
  describe('CreateBrokerResponse', function() {
    it('should create an instance of CreateBrokerResponse', function() {
      // uncomment below and update the code to test CreateBrokerResponse
      //var instance = new AmazonMq.CreateBrokerResponse();
      //expect(instance).to.be.a(AmazonMq.CreateBrokerResponse);
    });
