...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMq.ListConfigurationRevisionsResponse();
  });
  ...
  describe('ListConfigurationRevisionsResponse', function() {
    it('should create an instance of ListConfigurationRevisionsResponse', function() {
      ...
      //var instance = new AmazonMq.ListConfigurationRevisionsResponse();
      //expect(instance).to.be.a(AmazonMq.ListConfigurationRevisionsResponse);
    });
