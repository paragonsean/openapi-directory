...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonMq.ListConfigurationsResponse();
  });
  ...
  describe('ListConfigurationsResponse', function() {
    it('should create an instance of ListConfigurationsResponse', function() {
      ...
      //var instance = new AmazonMq.ListConfigurationsResponse();
      //expect(instance).to.be.a(AmazonMq.ListConfigurationsResponse);
    });
