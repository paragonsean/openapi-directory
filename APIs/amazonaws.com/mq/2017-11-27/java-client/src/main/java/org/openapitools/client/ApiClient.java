...
public class ApiClient {
    ...
    private String basePath = "http://mq.us-east-1.amazonaws.com";
    ...
    new ServerConfiguration(
      "http://mq.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://mq.{region}.amazonaws.com.cn",
      "The AmazonMQ endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-11-27/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://mq.us-east-1.amazonaws.com
