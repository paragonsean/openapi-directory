...
public class LogsSummary {
  ...
  public LogsSummary audit(Boolean audit) {
    this.audit = audit;
    return this;
  }
  ...
  public LogsSummary auditLogGroup(String auditLogGroup) {
  ...
  public LogsSummary general(Boolean general) {
  ...
  public LogsSummary generalLogGroup(String generalLogGroup) {
  ...
  public LogsSummary pending(LogsSummaryPending pending) {
  ...
  public boolean equals(Object o) {
    ...
    LogsSummary logsSummary = (LogsSummary) o;
    return Objects.equals(this.audit, logsSummary.audit) &&
        Objects.equals(this.auditLogGroup, logsSummary.auditLogGroup) &&
        Objects.equals(this.general, logsSummary.general) &&
        Objects.equals(this.generalLogGroup, logsSummary.generalLogGroup) &&
        Objects.equals(this.pending, logsSummary.pending);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogsSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogsSummary is not found in the empty JSON string", LogsSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogsSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogsSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LogsSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogsSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogsSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogsSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogsSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<LogsSummary>() {
           @Override
           public void write(JsonWriter out, LogsSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogsSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogsSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogsSummary
   * @throws IOException if the JSON string is invalid with respect to LogsSummary
   */
  public static LogsSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogsSummary.class);
  }

  /**
   * Convert an instance of LogsSummary to an JSON string
   *
   * @return JSON string
   */
