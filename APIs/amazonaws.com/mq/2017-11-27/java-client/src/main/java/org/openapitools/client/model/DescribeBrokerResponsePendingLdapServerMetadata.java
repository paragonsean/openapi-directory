...
public class DescribeBrokerResponsePendingLdapServerMetadata {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata() {
  }

  public DescribeBrokerResponsePendingLdapServerMetadata hosts(List hosts) {
    this.hosts = hosts;
    return this;
  }
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata roleBase(String roleBase) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata roleName(String roleName) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata roleSearchMatching(String roleSearchMatching) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata roleSearchSubtree(Boolean roleSearchSubtree) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata serviceAccountUsername(String serviceAccountUsername) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata userBase(String userBase) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata userRoleName(String userRoleName) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata userSearchMatching(String userSearchMatching) {
  ...
  public DescribeBrokerResponsePendingLdapServerMetadata userSearchSubtree(Boolean userSearchSubtree) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeBrokerResponsePendingLdapServerMetadata describeBrokerResponsePendingLdapServerMetadata = (DescribeBrokerResponsePendingLdapServerMetadata) o;
    return Objects.equals(this.hosts, describeBrokerResponsePendingLdapServerMetadata.hosts) &&
        Objects.equals(this.roleBase, describeBrokerResponsePendingLdapServerMetadata.roleBase) &&
        Objects.equals(this.roleName, describeBrokerResponsePendingLdapServerMetadata.roleName) &&
        Objects.equals(this.roleSearchMatching, describeBrokerResponsePendingLdapServerMetadata.roleSearchMatching) &&
        Objects.equals(this.roleSearchSubtree, describeBrokerResponsePendingLdapServerMetadata.roleSearchSubtree) &&
        Objects.equals(this.serviceAccountUsername, describeBrokerResponsePendingLdapServerMetadata.serviceAccountUsername) &&
        Objects.equals(this.userBase, describeBrokerResponsePendingLdapServerMetadata.userBase) &&
        Objects.equals(this.userRoleName, describeBrokerResponsePendingLdapServerMetadata.userRoleName) &&
        Objects.equals(this.userSearchMatching, describeBrokerResponsePendingLdapServerMetadata.userSearchMatching) &&
        Objects.equals(this.userSearchSubtree, describeBrokerResponsePendingLdapServerMetadata.userSearchSubtree);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeBrokerResponsePendingLdapServerMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBrokerResponsePendingLdapServerMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBrokerResponsePendingLdapServerMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBrokerResponsePendingLdapServerMetadata is not found in the empty JSON string", DescribeBrokerResponsePendingLdapServerMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBrokerResponsePendingLdapServerMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBrokerResponsePendingLdapServerMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeBrokerResponsePendingLdapServerMetadata.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBrokerResponsePendingLdapServerMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBrokerResponsePendingLdapServerMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBrokerResponsePendingLdapServerMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBrokerResponsePendingLdapServerMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBrokerResponsePendingLdapServerMetadata>() {
           @Override
           public void write(JsonWriter out, DescribeBrokerResponsePendingLdapServerMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBrokerResponsePendingLdapServerMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBrokerResponsePendingLdapServerMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBrokerResponsePendingLdapServerMetadata
   * @throws IOException if the JSON string is invalid with respect to DescribeBrokerResponsePendingLdapServerMetadata
   */
  public static DescribeBrokerResponsePendingLdapServerMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBrokerResponsePendingLdapServerMetadata.class);
  }

  /**
   * Convert an instance of DescribeBrokerResponsePendingLdapServerMetadata to an JSON string
   *
   * @return JSON string
   */
