...
public class UpdateBrokerResponseLdapServerMetadata {
  ...
  public UpdateBrokerResponseLdapServerMetadata() {
  }

  public UpdateBrokerResponseLdapServerMetadata hosts(List hosts) {
    this.hosts = hosts;
    return this;
  }
  ...
  public UpdateBrokerResponseLdapServerMetadata roleBase(String roleBase) {
  ...
  public UpdateBrokerResponseLdapServerMetadata roleName(String roleName) {
  ...
  public UpdateBrokerResponseLdapServerMetadata roleSearchMatching(String roleSearchMatching) {
  ...
  public UpdateBrokerResponseLdapServerMetadata roleSearchSubtree(Boolean roleSearchSubtree) {
  ...
  public UpdateBrokerResponseLdapServerMetadata serviceAccountUsername(String serviceAccountUsername) {
  ...
  public UpdateBrokerResponseLdapServerMetadata userBase(String userBase) {
  ...
  public UpdateBrokerResponseLdapServerMetadata userRoleName(String userRoleName) {
  ...
  public UpdateBrokerResponseLdapServerMetadata userSearchMatching(String userSearchMatching) {
  ...
  public UpdateBrokerResponseLdapServerMetadata userSearchSubtree(Boolean userSearchSubtree) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBrokerResponseLdapServerMetadata updateBrokerResponseLdapServerMetadata = (UpdateBrokerResponseLdapServerMetadata) o;
    return Objects.equals(this.hosts, updateBrokerResponseLdapServerMetadata.hosts) &&
        Objects.equals(this.roleBase, updateBrokerResponseLdapServerMetadata.roleBase) &&
        Objects.equals(this.roleName, updateBrokerResponseLdapServerMetadata.roleName) &&
        Objects.equals(this.roleSearchMatching, updateBrokerResponseLdapServerMetadata.roleSearchMatching) &&
        Objects.equals(this.roleSearchSubtree, updateBrokerResponseLdapServerMetadata.roleSearchSubtree) &&
        Objects.equals(this.serviceAccountUsername, updateBrokerResponseLdapServerMetadata.serviceAccountUsername) &&
        Objects.equals(this.userBase, updateBrokerResponseLdapServerMetadata.userBase) &&
        Objects.equals(this.userRoleName, updateBrokerResponseLdapServerMetadata.userRoleName) &&
        Objects.equals(this.userSearchMatching, updateBrokerResponseLdapServerMetadata.userSearchMatching) &&
        Objects.equals(this.userSearchSubtree, updateBrokerResponseLdapServerMetadata.userSearchSubtree);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBrokerResponseLdapServerMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBrokerResponseLdapServerMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBrokerResponseLdapServerMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBrokerResponseLdapServerMetadata is not found in the empty JSON string", UpdateBrokerResponseLdapServerMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBrokerResponseLdapServerMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBrokerResponseLdapServerMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateBrokerResponseLdapServerMetadata.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBrokerResponseLdapServerMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBrokerResponseLdapServerMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBrokerResponseLdapServerMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBrokerResponseLdapServerMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBrokerResponseLdapServerMetadata>() {
           @Override
           public void write(JsonWriter out, UpdateBrokerResponseLdapServerMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBrokerResponseLdapServerMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBrokerResponseLdapServerMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBrokerResponseLdapServerMetadata
   * @throws IOException if the JSON string is invalid with respect to UpdateBrokerResponseLdapServerMetadata
   */
  public static UpdateBrokerResponseLdapServerMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBrokerResponseLdapServerMetadata.class);
  }

  /**
   * Convert an instance of UpdateBrokerResponseLdapServerMetadata to an JSON string
   *
   * @return JSON string
   */
