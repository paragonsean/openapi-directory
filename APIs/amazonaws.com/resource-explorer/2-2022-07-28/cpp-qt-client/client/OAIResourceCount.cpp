...
OAIResourceCount::OAIResourceCount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResourceCount::OAIResourceCount() {
    this->initializeModel();
}

OAIResourceCount::~OAIResourceCount() {}

void OAIResourceCount::initializeModel() {
...
void OAIResourceCount::fromJson(QString jsonString) {
...
void OAIResourceCount::fromJsonObject(QJsonObject json) {
...
QString OAIResourceCount::asJson() const {
...
QJsonObject OAIResourceCount::asJsonObject() const {
    QJsonObject obj;
    if (m_complete_isSet) {
...
bool OAIResourceCount::getComplete() const {
    return m_complete;
}
void OAIResourceCount::setComplete(const bool &complete) {
    m_complete = complete;
    m_complete_isSet = true;
}

bool OAIResourceCount::is_complete_Set() const{
    return m_complete_isSet;
}

bool OAIResourceCount::is_complete_Valid() const{
    return m_complete_isValid;
}

qint32 OAIResourceCount::getTotalResources() const {
    return m_total_resources;
}
void OAIResourceCount::setTotalResources(const qint32 &total_resources) {
    m_total_resources = total_resources;
    m_total_resources_isSet = true;
}

bool OAIResourceCount::is_total_resources_Set() const{
    return m_total_resources_isSet;
}

bool OAIResourceCount::is_total_resources_Valid() const{
    return m_total_resources_isValid;
}

bool OAIResourceCount::isSet() const {
...
bool OAIResourceCount::isValid() const {
