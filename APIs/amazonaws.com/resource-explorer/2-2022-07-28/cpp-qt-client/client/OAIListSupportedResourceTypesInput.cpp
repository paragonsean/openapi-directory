...
#include "OAIListSupportedResourceTypesInput.h"
...
OAIListSupportedResourceTypesInput::OAIListSupportedResourceTypesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSupportedResourceTypesInput::OAIListSupportedResourceTypesInput() {
    this->initializeModel();
}

OAIListSupportedResourceTypesInput::~OAIListSupportedResourceTypesInput() {}

void OAIListSupportedResourceTypesInput::initializeModel() {
...
void OAIListSupportedResourceTypesInput::fromJson(QString jsonString) {
...
void OAIListSupportedResourceTypesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListSupportedResourceTypesInput::asJson() const {
...
QJsonObject OAIListSupportedResourceTypesInput::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListSupportedResourceTypesInput::getMaxResults() const {
    return m_max_results;
}
void OAIListSupportedResourceTypesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListSupportedResourceTypesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListSupportedResourceTypesInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListSupportedResourceTypesInput::getNextToken() const {
    return m_next_token;
}
void OAIListSupportedResourceTypesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSupportedResourceTypesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSupportedResourceTypesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSupportedResourceTypesInput::isSet() const {
...
bool OAIListSupportedResourceTypesInput::isValid() const {
