...
/*
 * OAICreateIndexOutput.h
 *
 * 
 */

#ifndef OAICreateIndexOutput_H
#define OAICreateIndexOutput_H
...
class OAICreateIndexOutput : public OAIObject {
public:
    OAICreateIndexOutput();
    OAICreateIndexOutput(QString json);
    ~OAICreateIndexOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIndexOutput)

#endif // OAICreateIndexOutput_H
