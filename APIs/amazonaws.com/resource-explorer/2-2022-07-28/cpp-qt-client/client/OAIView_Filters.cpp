...
OAIView_Filters::OAIView_Filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIView_Filters::OAIView_Filters() {
    this->initializeModel();
}

OAIView_Filters::~OAIView_Filters() {}

void OAIView_Filters::initializeModel() {

    m_filter_string_isSet = false;
    m_filter_string_isValid = false;
}

void OAIView_Filters::fromJson(QString jsonString) {
...
void OAIView_Filters::fromJsonObject(QJsonObject json) {

    m_filter_string_isValid = ::OpenAPI::fromJsonValue(m_filter_string, json[QString("FilterString")]);
    m_filter_string_isSet = !json[QString("FilterString")].isNull() && m_filter_string_isValid;
}

QString OAIView_Filters::asJson() const {
...
QJsonObject OAIView_Filters::asJsonObject() const {
    QJsonObject obj;
    if (m_filter_string_isSet) {
        obj.insert(QString("FilterString"), ::OpenAPI::toJsonValue(m_filter_string));
    }
    return obj;
}

QString OAIView_Filters::getFilterString() const {
    return m_filter_string;
}
void OAIView_Filters::setFilterString(const QString &filter_string) {
    m_filter_string = filter_string;
    m_filter_string_isSet = true;
}

bool OAIView_Filters::is_filter_string_Set() const{
    return m_filter_string_isSet;
}

bool OAIView_Filters::is_filter_string_Valid() const{
    return m_filter_string_isValid;
}

bool OAIView_Filters::isSet() const {
...
bool OAIView_Filters::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_filter_string_isValid && true;
}
