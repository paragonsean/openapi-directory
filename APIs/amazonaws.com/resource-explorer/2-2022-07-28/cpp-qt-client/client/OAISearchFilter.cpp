...
QString OAISearchFilter::getFilterString() const {
    return m_filter_string;
}
void OAISearchFilter::setFilterString(const QString &filter_string) {
    m_filter_string = filter_string;
    m_filter_string_isSet = true;
}

bool OAISearchFilter::is_filter_string_Set() const{
    return m_filter_string_isSet;
}

bool OAISearchFilter::is_filter_string_Valid() const{
