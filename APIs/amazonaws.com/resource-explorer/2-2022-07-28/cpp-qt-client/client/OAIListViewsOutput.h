...
/*
 * OAIListViewsOutput.h
 *
 * 
 */

#ifndef OAIListViewsOutput_H
#define OAIListViewsOutput_H
...
class OAIListViewsOutput : public OAIObject {
public:
    OAIListViewsOutput();
    OAIListViewsOutput(QString json);
    ~OAIListViewsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListViewsOutput)

#endif // OAIListViewsOutput_H
