...
/*
 * OAIGetDefaultViewOutput.h
 *
 * 
 */

#ifndef OAIGetDefaultViewOutput_H
#define OAIGetDefaultViewOutput_H
...
class OAIGetDefaultViewOutput : public OAIObject {
public:
    OAIGetDefaultViewOutput();
    OAIGetDefaultViewOutput(QString json);
    ~OAIGetDefaultViewOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDefaultViewOutput)

#endif // OAIGetDefaultViewOutput_H
