...
OAIAssociateDefaultViewOutput::OAIAssociateDefaultViewOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateDefaultViewOutput::OAIAssociateDefaultViewOutput() {
    this->initializeModel();
}

OAIAssociateDefaultViewOutput::~OAIAssociateDefaultViewOutput() {}

void OAIAssociateDefaultViewOutput::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIAssociateDefaultViewOutput::fromJson(QString jsonString) {
...
void OAIAssociateDefaultViewOutput::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateDefaultViewOutput::asJson() const {
...
QJsonObject OAIAssociateDefaultViewOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIAssociateDefaultViewOutput::getViewArn() const {
    return m_view_arn;
}
void OAIAssociateDefaultViewOutput::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIAssociateDefaultViewOutput::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIAssociateDefaultViewOutput::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIAssociateDefaultViewOutput::isSet() const {
...
bool OAIAssociateDefaultViewOutput::isValid() const {
