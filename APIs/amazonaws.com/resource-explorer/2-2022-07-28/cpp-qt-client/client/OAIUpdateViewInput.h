...
/*
 * OAIUpdateViewInput.h
 *
 * 
 */

#ifndef OAIUpdateViewInput_H
#define OAIUpdateViewInput_H
...
class OAIUpdateViewInput : public OAIObject {
public:
    OAIUpdateViewInput();
    OAIUpdateViewInput(QString json);
    ~OAIUpdateViewInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateViewInput)

#endif // OAIUpdateViewInput_H
