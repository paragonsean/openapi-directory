...
#ifndef OAISearchOutput_H
#define OAISearchOutput_H
...
namespace OpenAPI {
class OAISearchOutput_Count;

class OAISearchOutput : public OAIObject {
public:
    OAISearchOutput();
    OAISearchOutput(QString json);
    ~OAISearchOutput() override;
    ...
    OAISearchOutput_Count getCount() const;
    void setCount(const OAISearchOutput_Count &count);
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchOutput)

#endif // OAISearchOutput_H
