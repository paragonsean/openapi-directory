...
/*
 * OAIUpdateIndexType_request.h
 *
 * 
 */

#ifndef OAIUpdateIndexType_request_H
#define OAIUpdateIndexType_request_H
...
class OAIUpdateIndexType_request : public OAIObject {
public:
    OAIUpdateIndexType_request();
    OAIUpdateIndexType_request(QString json);
    ~OAIUpdateIndexType_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIndexType_request)

#endif // OAIUpdateIndexType_request_H
