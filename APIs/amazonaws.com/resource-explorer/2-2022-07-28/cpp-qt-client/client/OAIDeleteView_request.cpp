...
OAIDeleteView_request::OAIDeleteView_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteView_request::OAIDeleteView_request() {
    this->initializeModel();
}

OAIDeleteView_request::~OAIDeleteView_request() {}

void OAIDeleteView_request::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIDeleteView_request::fromJson(QString jsonString) {
...
void OAIDeleteView_request::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteView_request::asJson() const {
...
QJsonObject OAIDeleteView_request::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIDeleteView_request::getViewArn() const {
    return m_view_arn;
}
void OAIDeleteView_request::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIDeleteView_request::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIDeleteView_request::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIDeleteView_request::isSet() const {
...
bool OAIDeleteView_request::isValid() const {
