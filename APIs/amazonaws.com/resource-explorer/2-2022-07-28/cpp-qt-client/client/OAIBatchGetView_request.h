...
/*
 * OAIBatchGetView_request.h
 *
 * 
 */

#ifndef OAIBatchGetView_request_H
#define OAIBatchGetView_request_H
...
class OAIBatchGetView_request : public OAIObject {
public:
    OAIBatchGetView_request();
    OAIBatchGetView_request(QString json);
    ~OAIBatchGetView_request() override;
    ...
    QList<QString> getViewArns() const;
    void setViewArns(const QList<QString> &view_arns);
    bool is_view_arns_Set() const;
    bool is_view_arns_Valid() const;
...
private:
    ...
    QList<QString> m_view_arns;
    bool m_view_arns_isSet;
    bool m_view_arns_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetView_request)

#endif // OAIBatchGetView_request_H
