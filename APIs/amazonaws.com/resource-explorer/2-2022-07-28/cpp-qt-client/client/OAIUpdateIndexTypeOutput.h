...
/*
 * OAIUpdateIndexTypeOutput.h
 *
 * 
 */

#ifndef OAIUpdateIndexTypeOutput_H
#define OAIUpdateIndexTypeOutput_H
...
class OAIUpdateIndexTypeOutput : public OAIObject {
public:
    OAIUpdateIndexTypeOutput();
    OAIUpdateIndexTypeOutput(QString json);
    ~OAIUpdateIndexTypeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIndexTypeOutput)

#endif // OAIUpdateIndexTypeOutput_H
