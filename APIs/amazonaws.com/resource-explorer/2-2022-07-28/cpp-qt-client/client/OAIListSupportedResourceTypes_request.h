...
/*
 * OAIListSupportedResourceTypes_request.h
 *
 * 
 */

#ifndef OAIListSupportedResourceTypes_request_H
#define OAIListSupportedResourceTypes_request_H
...
class OAIListSupportedResourceTypes_request : public OAIObject {
public:
    OAIListSupportedResourceTypes_request();
    OAIListSupportedResourceTypes_request(QString json);
    ~OAIListSupportedResourceTypes_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSupportedResourceTypes_request)

#endif // OAIListSupportedResourceTypes_request_H
