...
#ifndef OAIGetViewInput_H
#define OAIGetViewInput_H
...
class OAIGetViewInput : public OAIObject {
public:
    OAIGetViewInput();
    OAIGetViewInput(QString json);
    ~OAIGetViewInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetViewInput)

#endif // OAIGetViewInput_H
