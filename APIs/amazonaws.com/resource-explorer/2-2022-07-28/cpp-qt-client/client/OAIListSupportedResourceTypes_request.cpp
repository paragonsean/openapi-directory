...
OAIListSupportedResourceTypes_request::OAIListSupportedResourceTypes_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSupportedResourceTypes_request::OAIListSupportedResourceTypes_request() {
    this->initializeModel();
}

OAIListSupportedResourceTypes_request::~OAIListSupportedResourceTypes_request() {}

void OAIListSupportedResourceTypes_request::initializeModel() {
...
void OAIListSupportedResourceTypes_request::fromJson(QString jsonString) {
...
void OAIListSupportedResourceTypes_request::fromJsonObject(QJsonObject json) {
...
QString OAIListSupportedResourceTypes_request::asJson() const {
...
QJsonObject OAIListSupportedResourceTypes_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListSupportedResourceTypes_request::getMaxResults() const {
    return m_max_results;
}
void OAIListSupportedResourceTypes_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListSupportedResourceTypes_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListSupportedResourceTypes_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListSupportedResourceTypes_request::getNextToken() const {
    return m_next_token;
}
void OAIListSupportedResourceTypes_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSupportedResourceTypes_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSupportedResourceTypes_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSupportedResourceTypes_request::isSet() const {
...
bool OAIListSupportedResourceTypes_request::isValid() const {
