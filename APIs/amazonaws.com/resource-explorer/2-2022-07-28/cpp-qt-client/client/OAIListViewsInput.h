...
#ifndef OAIListViewsInput_H
#define OAIListViewsInput_H
...
class OAIListViewsInput : public OAIObject {
public:
    OAIListViewsInput();
    OAIListViewsInput(QString json);
    ~OAIListViewsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListViewsInput)

#endif // OAIListViewsInput_H
