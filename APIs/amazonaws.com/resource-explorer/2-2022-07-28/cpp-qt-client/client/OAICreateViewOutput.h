...
/*
 * OAICreateViewOutput.h
 *
 * 
 */

#ifndef OAICreateViewOutput_H
#define OAICreateViewOutput_H
...
namespace OpenAPI {
class OAICreateViewOutput_View;

class OAICreateViewOutput : public OAIObject {
public:
    OAICreateViewOutput();
    OAICreateViewOutput(QString json);
    ~OAICreateViewOutput() override;
    ...
    OAICreateViewOutput_View getView() const;
    void setView(const OAICreateViewOutput_View &view);
...
private:
    ...
    OAICreateViewOutput_View m_view;
    bool m_view_isSet;
    bool m_view_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateViewOutput)

#endif // OAICreateViewOutput_H
