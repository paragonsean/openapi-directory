...
OAIUpdateIndexTypeOutput::OAIUpdateIndexTypeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIndexTypeOutput::OAIUpdateIndexTypeOutput() {
    this->initializeModel();
}

OAIUpdateIndexTypeOutput::~OAIUpdateIndexTypeOutput() {}

void OAIUpdateIndexTypeOutput::initializeModel() {
...
void OAIUpdateIndexTypeOutput::fromJson(QString jsonString) {
...
void OAIUpdateIndexTypeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIndexTypeOutput::asJson() const {
...
QJsonObject OAIUpdateIndexTypeOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateIndexTypeOutput::getArn() const {
    return m_arn;
}
void OAIUpdateIndexTypeOutput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateIndexTypeOutput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateIndexTypeOutput::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIUpdateIndexTypeOutput::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIUpdateIndexTypeOutput::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIUpdateIndexTypeOutput::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIUpdateIndexTypeOutput::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

OAIIndexState OAIUpdateIndexTypeOutput::getState() const {
    return m_state;
}
void OAIUpdateIndexTypeOutput::setState(const OAIIndexState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIUpdateIndexTypeOutput::is_state_Set() const{
    return m_state_isSet;
}

bool OAIUpdateIndexTypeOutput::is_state_Valid() const{
    return m_state_isValid;
}

OAIIndexType OAIUpdateIndexTypeOutput::getType() const {
    return m_type;
}
void OAIUpdateIndexTypeOutput::setType(const OAIIndexType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateIndexTypeOutput::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateIndexTypeOutput::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIUpdateIndexTypeOutput::isSet() const {
...
bool OAIUpdateIndexTypeOutput::isValid() const {
