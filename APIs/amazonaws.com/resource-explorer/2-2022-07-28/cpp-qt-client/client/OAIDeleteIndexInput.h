...
/*
 * OAIDeleteIndexInput.h
 *
 * 
 */

#ifndef OAIDeleteIndexInput_H
#define OAIDeleteIndexInput_H
...
class OAIDeleteIndexInput : public OAIObject {
public:
    OAIDeleteIndexInput();
    OAIDeleteIndexInput(QString json);
    ~OAIDeleteIndexInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteIndexInput)

#endif // OAIDeleteIndexInput_H
