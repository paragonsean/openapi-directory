...
/*
 * OAIDeleteIndex_request.h
 *
 * 
 */

#ifndef OAIDeleteIndex_request_H
#define OAIDeleteIndex_request_H
...
class OAIDeleteIndex_request : public OAIObject {
public:
    OAIDeleteIndex_request();
    OAIDeleteIndex_request(QString json);
    ~OAIDeleteIndex_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteIndex_request)

#endif // OAIDeleteIndex_request_H
