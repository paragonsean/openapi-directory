...
OAIListViewsInput::OAIListViewsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListViewsInput::OAIListViewsInput() {
    this->initializeModel();
}

OAIListViewsInput::~OAIListViewsInput() {}

void OAIListViewsInput::initializeModel() {
...
void OAIListViewsInput::fromJson(QString jsonString) {
...
void OAIListViewsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListViewsInput::asJson() const {
...
QJsonObject OAIListViewsInput::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListViewsInput::getMaxResults() const {
    return m_max_results;
}
void OAIListViewsInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListViewsInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListViewsInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListViewsInput::getNextToken() const {
    return m_next_token;
}
void OAIListViewsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListViewsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListViewsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListViewsInput::isSet() const {
...
bool OAIListViewsInput::isValid() const {
