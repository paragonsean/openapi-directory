...
#include "OAISupportedResourceType.h"
...
OAISupportedResourceType::OAISupportedResourceType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupportedResourceType::OAISupportedResourceType() {
    this->initializeModel();
}

OAISupportedResourceType::~OAISupportedResourceType() {}

void OAISupportedResourceType::initializeModel() {
...
void OAISupportedResourceType::fromJson(QString jsonString) {
...
void OAISupportedResourceType::fromJsonObject(QJsonObject json) {
...
QString OAISupportedResourceType::asJson() const {
...
QJsonObject OAISupportedResourceType::asJsonObject() const {
    QJsonObject obj;
...
QString OAISupportedResourceType::getResourceType() const {
    return m_resource_type;
}
void OAISupportedResourceType::setResourceType(const QString &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAISupportedResourceType::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAISupportedResourceType::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

QString OAISupportedResourceType::getService() const {
    return m_service;
}
void OAISupportedResourceType::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAISupportedResourceType::is_service_Set() const{
    return m_service_isSet;
}

bool OAISupportedResourceType::is_service_Valid() const{
    return m_service_isValid;
}

bool OAISupportedResourceType::isSet() const {
...
bool OAISupportedResourceType::isValid() const {
