...
/*
 * OAIDeleteViewInput.h
 *
 * 
 */

#ifndef OAIDeleteViewInput_H
#define OAIDeleteViewInput_H
...
class OAIDeleteViewInput : public OAIObject {
public:
    OAIDeleteViewInput();
    OAIDeleteViewInput(QString json);
    ~OAIDeleteViewInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteViewInput)

#endif // OAIDeleteViewInput_H
