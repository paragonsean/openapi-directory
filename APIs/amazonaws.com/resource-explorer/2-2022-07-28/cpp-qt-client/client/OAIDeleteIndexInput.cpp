...
OAIDeleteIndexInput::OAIDeleteIndexInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteIndexInput::OAIDeleteIndexInput() {
    this->initializeModel();
}

OAIDeleteIndexInput::~OAIDeleteIndexInput() {}

void OAIDeleteIndexInput::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteIndexInput::fromJson(QString jsonString) {
...
void OAIDeleteIndexInput::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteIndexInput::asJson() const {
...
QJsonObject OAIDeleteIndexInput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteIndexInput::getArn() const {
    return m_arn;
}
void OAIDeleteIndexInput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteIndexInput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteIndexInput::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteIndexInput::isSet() const {
...
bool OAIDeleteIndexInput::isValid() const {
