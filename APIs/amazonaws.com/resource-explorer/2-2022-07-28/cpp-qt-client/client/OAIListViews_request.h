...
/*
 * OAIListViews_request.h
 *
 * 
 */

#ifndef OAIListViews_request_H
#define OAIListViews_request_H
...
class OAIListViews_request : public OAIObject {
public:
    OAIListViews_request();
    OAIListViews_request(QString json);
    ~OAIListViews_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListViews_request)

#endif // OAIListViews_request_H
