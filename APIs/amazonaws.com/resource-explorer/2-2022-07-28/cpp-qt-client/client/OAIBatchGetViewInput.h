...
/*
 * OAIBatchGetViewInput.h
 *
 * 
 */

#ifndef OAIBatchGetViewInput_H
#define OAIBatchGetViewInput_H
...
class OAIBatchGetViewInput : public OAIObject {
public:
    OAIBatchGetViewInput();
    OAIBatchGetViewInput(QString json);
    ~OAIBatchGetViewInput() override;
    ...
    QList getViewArns() const;
    void setViewArns(const QList &view_arns);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetViewInput)

#endif // OAIBatchGetViewInput_H
