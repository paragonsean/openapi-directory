...
/*
 * OAIListSupportedResourceTypesOutput.h
 *
 * 
 */

#ifndef OAIListSupportedResourceTypesOutput_H
#define OAIListSupportedResourceTypesOutput_H
...
class OAIListSupportedResourceTypesOutput : public OAIObject {
public:
    OAIListSupportedResourceTypesOutput();
    OAIListSupportedResourceTypesOutput(QString json);
    ~OAIListSupportedResourceTypesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSupportedResourceTypesOutput)

#endif // OAIListSupportedResourceTypesOutput_H
