...
OAIBatchGetView_request::OAIBatchGetView_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetView_request::OAIBatchGetView_request() {
    this->initializeModel();
}

OAIBatchGetView_request::~OAIBatchGetView_request() {}

void OAIBatchGetView_request::initializeModel() {

    m_view_arns_isSet = false;
    m_view_arns_isValid = false;
}

void OAIBatchGetView_request::fromJson(QString jsonString) {
...
void OAIBatchGetView_request::fromJsonObject(QJsonObject json) {

    m_view_arns_isValid = ::OpenAPI::fromJsonValue(m_view_arns, json[QString("ViewArns")]);
    m_view_arns_isSet = !json[QString("ViewArns")].isNull() && m_view_arns_isValid;
}

QString OAIBatchGetView_request::asJson() const {
...
QJsonObject OAIBatchGetView_request::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arns.size() > 0) {
        obj.insert(QString("ViewArns"), ::OpenAPI::toJsonValue(m_view_arns));
    }
    return obj;
}

QList<QString> OAIBatchGetView_request::getViewArns() const {
    return m_view_arns;
}
void OAIBatchGetView_request::setViewArns(const QList<QString> &view_arns) {
    m_view_arns = view_arns;
    m_view_arns_isSet = true;
}

bool OAIBatchGetView_request::is_view_arns_Set() const{
    return m_view_arns_isSet;
}

bool OAIBatchGetView_request::is_view_arns_Valid() const{
    return m_view_arns_isValid;
}

bool OAIBatchGetView_request::isSet() const {
...
bool OAIBatchGetView_request::isValid() const {
