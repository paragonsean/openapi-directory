...
OAIGetViewInput::OAIGetViewInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetViewInput::OAIGetViewInput() {
    this->initializeModel();
}

OAIGetViewInput::~OAIGetViewInput() {}

void OAIGetViewInput::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIGetViewInput::fromJson(QString jsonString) {
...
void OAIGetViewInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetViewInput::asJson() const {
...
QJsonObject OAIGetViewInput::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIGetViewInput::getViewArn() const {
    return m_view_arn;
}
void OAIGetViewInput::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIGetViewInput::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIGetViewInput::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIGetViewInput::isSet() const {
...
bool OAIGetViewInput::isValid() const {
