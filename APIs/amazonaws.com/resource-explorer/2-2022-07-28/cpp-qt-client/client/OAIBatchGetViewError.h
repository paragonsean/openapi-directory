...
class OAIBatchGetViewError : public OAIObject {
public:
    OAIBatchGetViewError();
    OAIBatchGetViewError(QString json);
    ~OAIBatchGetViewError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetViewError)

#endif // OAIBatchGetViewError_H
