...
/*
 * OAIAssociateDefaultViewInput.h
 *
 * 
 */

#ifndef OAIAssociateDefaultViewInput_H
#define OAIAssociateDefaultViewInput_H
...
class OAIAssociateDefaultViewInput : public OAIObject {
public:
    OAIAssociateDefaultViewInput();
    OAIAssociateDefaultViewInput(QString json);
    ~OAIAssociateDefaultViewInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateDefaultViewInput)

#endif // OAIAssociateDefaultViewInput_H
