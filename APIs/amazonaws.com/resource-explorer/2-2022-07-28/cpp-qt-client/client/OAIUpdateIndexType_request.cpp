...
OAIUpdateIndexType_request::OAIUpdateIndexType_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIndexType_request::OAIUpdateIndexType_request() {
    this->initializeModel();
}

OAIUpdateIndexType_request::~OAIUpdateIndexType_request() {}

void OAIUpdateIndexType_request::initializeModel() {
...
void OAIUpdateIndexType_request::fromJson(QString jsonString) {
...
void OAIUpdateIndexType_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIndexType_request::asJson() const {
...
QJsonObject OAIUpdateIndexType_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateIndexType_request::getArn() const {
    return m_arn;
}
void OAIUpdateIndexType_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateIndexType_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateIndexType_request::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateIndexType_request::getType() const {
    return m_type;
}
void OAIUpdateIndexType_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateIndexType_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateIndexType_request::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIUpdateIndexType_request::isSet() const {
...
bool OAIUpdateIndexType_request::isValid() const {
