...
#ifndef OAISearchInput_H
#define OAISearchInput_H
...
class OAISearchInput : public OAIObject {
public:
    OAISearchInput();
    OAISearchInput(QString json);
    ~OAISearchInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchInput)

#endif // OAISearchInput_H
