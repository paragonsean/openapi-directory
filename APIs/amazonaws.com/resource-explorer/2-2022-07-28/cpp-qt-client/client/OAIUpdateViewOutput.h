...
/*
 * OAIUpdateViewOutput.h
 *
 * 
 */

#ifndef OAIUpdateViewOutput_H
#define OAIUpdateViewOutput_H
...
namespace OpenAPI {
class OAIUpdateViewOutput_View;

class OAIUpdateViewOutput : public OAIObject {
public:
    OAIUpdateViewOutput();
    OAIUpdateViewOutput(QString json);
    ~OAIUpdateViewOutput() override;
    ...
    OAIUpdateViewOutput_View getView() const;
    void setView(const OAIUpdateViewOutput_View &view);
...
private:
    ...
    OAIUpdateViewOutput_View m_view;
    bool m_view_isSet;
    bool m_view_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateViewOutput)

#endif // OAIUpdateViewOutput_H
