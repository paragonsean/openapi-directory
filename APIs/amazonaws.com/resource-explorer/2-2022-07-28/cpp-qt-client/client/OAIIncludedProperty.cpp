...
OAIIncludedProperty::OAIIncludedProperty(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIncludedProperty::OAIIncludedProperty() {
    this->initializeModel();
}

OAIIncludedProperty::~OAIIncludedProperty() {}

void OAIIncludedProperty::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIIncludedProperty::fromJson(QString jsonString) {
...
void OAIIncludedProperty::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAIIncludedProperty::asJson() const {
...
QJsonObject OAIIncludedProperty::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIIncludedProperty::getName() const {
    return m_name;
}
void OAIIncludedProperty::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIIncludedProperty::is_name_Set() const{
    return m_name_isSet;
}

bool OAIIncludedProperty::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIIncludedProperty::isSet() const {
...
bool OAIIncludedProperty::isValid() const {
