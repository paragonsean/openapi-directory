...
/*
 * OAICreateViewInput_Filters.h
 *
 * 
 */

#ifndef OAICreateViewInput_Filters_H
#define OAICreateViewInput_Filters_H
...
class OAICreateViewInput_Filters : public OAIObject {
public:
    OAICreateViewInput_Filters();
    OAICreateViewInput_Filters(QString json);
    ~OAICreateViewInput_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateViewInput_Filters)

#endif // OAICreateViewInput_Filters_H
