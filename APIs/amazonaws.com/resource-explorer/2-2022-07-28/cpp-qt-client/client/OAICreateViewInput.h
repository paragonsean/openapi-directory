...
/*
 * OAICreateViewInput.h
 *
 * 
 */

#ifndef OAICreateViewInput_H
#define OAICreateViewInput_H

#include <QJsonObject>

#include "OAICreateViewInput_Filters.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAICreateViewInput_Filters;

class OAICreateViewInput : public OAIObject {
public:
    OAICreateViewInput();
    OAICreateViewInput(QString json);
    ~OAICreateViewInput() override;
    ...
    OAICreateViewInput_Filters getFilters() const;
    void setFilters(const OAICreateViewInput_Filters &filters);
...
private:
    ...
    OAICreateViewInput_Filters m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateViewInput)

#endif // OAICreateViewInput_H
