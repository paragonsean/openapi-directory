...
/*
 * OAIGetViewOutput_View.h
 *
 * 
 */

#ifndef OAIGetViewOutput_View_H
#define OAIGetViewOutput_View_H
...
class OAIGetViewOutput_View : public OAIObject {
public:
    OAIGetViewOutput_View();
    OAIGetViewOutput_View(QString json);
    ~OAIGetViewOutput_View() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetViewOutput_View)

#endif // OAIGetViewOutput_View_H
