...
OAICreateView_request_Filters::OAICreateView_request_Filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateView_request_Filters::OAICreateView_request_Filters() {
    this->initializeModel();
}

OAICreateView_request_Filters::~OAICreateView_request_Filters() {}

void OAICreateView_request_Filters::initializeModel() {

    m_filter_string_isSet = false;
    m_filter_string_isValid = false;
}

void OAICreateView_request_Filters::fromJson(QString jsonString) {
...
void OAICreateView_request_Filters::fromJsonObject(QJsonObject json) {
...
QString OAICreateView_request_Filters::asJson() const {
...
QJsonObject OAICreateView_request_Filters::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateView_request_Filters::getFilterString() const {
    return m_filter_string;
}
void OAICreateView_request_Filters::setFilterString(const QString &filter_string) {
    m_filter_string = filter_string;
    m_filter_string_isSet = true;
}

bool OAICreateView_request_Filters::is_filter_string_Set() const{
    return m_filter_string_isSet;
}

bool OAICreateView_request_Filters::is_filter_string_Valid() const{
    return m_filter_string_isValid;
}

bool OAICreateView_request_Filters::isSet() const {
...
bool OAICreateView_request_Filters::isValid() const {
