...
OAIListIndexes_request::OAIListIndexes_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListIndexes_request::OAIListIndexes_request() {
    this->initializeModel();
}

OAIListIndexes_request::~OAIListIndexes_request() {}

void OAIListIndexes_request::initializeModel() {
...
void OAIListIndexes_request::fromJson(QString jsonString) {
...
void OAIListIndexes_request::fromJsonObject(QJsonObject json) {
...
QString OAIListIndexes_request::asJson() const {
...
QJsonObject OAIListIndexes_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListIndexes_request::getMaxResults() const {
    return m_max_results;
}
void OAIListIndexes_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListIndexes_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListIndexes_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListIndexes_request::getNextToken() const {
    return m_next_token;
}
void OAIListIndexes_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListIndexes_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListIndexes_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList<QString> OAIListIndexes_request::getRegions() const {
    return m_regions;
}
void OAIListIndexes_request::setRegions(const QList<QString> &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIListIndexes_request::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIListIndexes_request::is_regions_Valid() const{
    return m_regions_isValid;
}

QString OAIListIndexes_request::getType() const {
    return m_type;
}
void OAIListIndexes_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIListIndexes_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAIListIndexes_request::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIListIndexes_request::isSet() const {
...
bool OAIListIndexes_request::isValid() const {
