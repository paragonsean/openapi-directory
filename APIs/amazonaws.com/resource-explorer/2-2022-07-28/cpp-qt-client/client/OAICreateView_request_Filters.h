...
/*
 * OAICreateView_request_Filters.h
 *
 * A search filter defines which resources can be part of a search query result set.
 */

#ifndef OAICreateView_request_Filters_H
#define OAICreateView_request_Filters_H
...
class OAICreateView_request_Filters : public OAIObject {
public:
    OAICreateView_request_Filters();
    OAICreateView_request_Filters(QString json);
    ~OAICreateView_request_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateView_request_Filters)

#endif // OAICreateView_request_Filters_H
