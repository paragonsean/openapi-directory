...
OAICreateViewInput_Filters::OAICreateViewInput_Filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateViewInput_Filters::OAICreateViewInput_Filters() {
    this->initializeModel();
}

OAICreateViewInput_Filters::~OAICreateViewInput_Filters() {}

void OAICreateViewInput_Filters::initializeModel() {

    m_filter_string_isSet = false;
    m_filter_string_isValid = false;
}

void OAICreateViewInput_Filters::fromJson(QString jsonString) {
...
void OAICreateViewInput_Filters::fromJsonObject(QJsonObject json) {
...
QString OAICreateViewInput_Filters::asJson() const {
...
QJsonObject OAICreateViewInput_Filters::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateViewInput_Filters::getFilterString() const {
    return m_filter_string;
}
void OAICreateViewInput_Filters::setFilterString(const QString &filter_string) {
    m_filter_string = filter_string;
    m_filter_string_isSet = true;
}

bool OAICreateViewInput_Filters::is_filter_string_Set() const{
    return m_filter_string_isSet;
}

bool OAICreateViewInput_Filters::is_filter_string_Valid() const{
    return m_filter_string_isValid;
}

bool OAICreateViewInput_Filters::isSet() const {
...
bool OAICreateViewInput_Filters::isValid() const {
