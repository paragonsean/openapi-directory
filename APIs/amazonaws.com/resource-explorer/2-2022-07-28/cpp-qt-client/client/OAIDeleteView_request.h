...
/*
 * OAIDeleteView_request.h
 *
 * 
 */

#ifndef OAIDeleteView_request_H
#define OAIDeleteView_request_H
...
class OAIDeleteView_request : public OAIObject {
public:
    OAIDeleteView_request();
    OAIDeleteView_request(QString json);
    ~OAIDeleteView_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteView_request)

#endif // OAIDeleteView_request_H
