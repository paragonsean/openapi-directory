...
class OAISupportedResourceType : public OAIObject {
public:
    OAISupportedResourceType();
    OAISupportedResourceType(QString json);
    ~OAISupportedResourceType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupportedResourceType)

#endif // OAISupportedResourceType_H
