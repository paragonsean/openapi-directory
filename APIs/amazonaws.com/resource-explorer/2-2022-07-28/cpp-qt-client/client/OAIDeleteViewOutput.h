...
/*
 * OAIDeleteViewOutput.h
 *
 * 
 */

#ifndef OAIDeleteViewOutput_H
#define OAIDeleteViewOutput_H
...
class OAIDeleteViewOutput : public OAIObject {
public:
    OAIDeleteViewOutput();
    OAIDeleteViewOutput(QString json);
    ~OAIDeleteViewOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteViewOutput)

#endif // OAIDeleteViewOutput_H
