...
QString OAICreateIndex_request::getClientToken() const {
    return m_client_token;
}
void OAICreateIndex_request::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAICreateIndex_request::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAICreateIndex_request::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QMap<QString, QString> OAICreateIndex_request::getTags() const {
    return m_tags;
}
void OAICreateIndex_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateIndex_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateIndex_request::is_tags_Valid() const{
