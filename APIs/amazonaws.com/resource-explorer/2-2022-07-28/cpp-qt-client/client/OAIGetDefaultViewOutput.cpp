...
OAIGetDefaultViewOutput::OAIGetDefaultViewOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDefaultViewOutput::OAIGetDefaultViewOutput() {
    this->initializeModel();
}

OAIGetDefaultViewOutput::~OAIGetDefaultViewOutput() {}

void OAIGetDefaultViewOutput::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIGetDefaultViewOutput::fromJson(QString jsonString) {
...
void OAIGetDefaultViewOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetDefaultViewOutput::asJson() const {
...
QJsonObject OAIGetDefaultViewOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIGetDefaultViewOutput::getViewArn() const {
    return m_view_arn;
}
void OAIGetDefaultViewOutput::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIGetDefaultViewOutput::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIGetDefaultViewOutput::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIGetDefaultViewOutput::isSet() const {
...
bool OAIGetDefaultViewOutput::isValid() const {
