...
/*
 * OAIListIndexesInput.h
 *
 * 
 */

#ifndef OAIListIndexesInput_H
#define OAIListIndexesInput_H
...
class OAIListIndexesInput : public OAIObject {
public:
    OAIListIndexesInput();
    OAIListIndexesInput(QString json);
    ~OAIListIndexesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListIndexesInput)

#endif // OAIListIndexesInput_H
