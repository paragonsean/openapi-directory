...
#ifndef OAIView_Filters_H
#define OAIView_Filters_H
...
class OAIView_Filters : public OAIObject {
public:
    OAIView_Filters();
    OAIView_Filters(QString json);
    ~OAIView_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIView_Filters)

#endif // OAIView_Filters_H
