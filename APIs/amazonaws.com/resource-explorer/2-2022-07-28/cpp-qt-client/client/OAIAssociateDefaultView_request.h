...
/*
 * OAIAssociateDefaultView_request.h
 *
 * 
 */

#ifndef OAIAssociateDefaultView_request_H
#define OAIAssociateDefaultView_request_H
...
class OAIAssociateDefaultView_request : public OAIObject {
public:
    OAIAssociateDefaultView_request();
    OAIAssociateDefaultView_request(QString json);
    ~OAIAssociateDefaultView_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateDefaultView_request)

#endif // OAIAssociateDefaultView_request_H
