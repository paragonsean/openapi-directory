...
OAIAssociateDefaultView_request::OAIAssociateDefaultView_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateDefaultView_request::OAIAssociateDefaultView_request() {
    this->initializeModel();
}

OAIAssociateDefaultView_request::~OAIAssociateDefaultView_request() {}

void OAIAssociateDefaultView_request::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIAssociateDefaultView_request::fromJson(QString jsonString) {
...
void OAIAssociateDefaultView_request::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateDefaultView_request::asJson() const {
...
QJsonObject OAIAssociateDefaultView_request::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIAssociateDefaultView_request::getViewArn() const {
    return m_view_arn;
}
void OAIAssociateDefaultView_request::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIAssociateDefaultView_request::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIAssociateDefaultView_request::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIAssociateDefaultView_request::isSet() const {
...
bool OAIAssociateDefaultView_request::isValid() const {
