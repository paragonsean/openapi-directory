...
OAISearchOutput::OAISearchOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchOutput::OAISearchOutput() {
    this->initializeModel();
}

OAISearchOutput::~OAISearchOutput() {}

void OAISearchOutput::initializeModel() {
...
void OAISearchOutput::fromJson(QString jsonString) {
...
void OAISearchOutput::fromJsonObject(QJsonObject json) {
...
QString OAISearchOutput::asJson() const {
...
QJsonObject OAISearchOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_count.isSet()) {
...
OAISearchOutput_Count OAISearchOutput::getCount() const {
    return m_count;
}
void OAISearchOutput::setCount(const OAISearchOutput_Count &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAISearchOutput::is_count_Set() const{
    return m_count_isSet;
}

bool OAISearchOutput::is_count_Valid() const{
    return m_count_isValid;
}

QString OAISearchOutput::getNextToken() const {
    return m_next_token;
}
void OAISearchOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAISearchOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAISearchOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAISearchOutput::getResources() const {
    return m_resources;
}
void OAISearchOutput::setResources(const QList &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAISearchOutput::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAISearchOutput::is_resources_Valid() const{
    return m_resources_isValid;
}

QString OAISearchOutput::getViewArn() const {
    return m_view_arn;
}
void OAISearchOutput::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAISearchOutput::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAISearchOutput::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAISearchOutput::isSet() const {
...
bool OAISearchOutput::isValid() const {
