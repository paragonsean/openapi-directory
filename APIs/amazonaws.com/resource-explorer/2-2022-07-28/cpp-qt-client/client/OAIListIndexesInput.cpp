...
OAIListIndexesInput::OAIListIndexesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListIndexesInput::OAIListIndexesInput() {
    this->initializeModel();
}

OAIListIndexesInput::~OAIListIndexesInput() {}

void OAIListIndexesInput::initializeModel() {
...
void OAIListIndexesInput::fromJson(QString jsonString) {
...
void OAIListIndexesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListIndexesInput::asJson() const {
...
QJsonObject OAIListIndexesInput::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListIndexesInput::getMaxResults() const {
    return m_max_results;
}
void OAIListIndexesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListIndexesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListIndexesInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListIndexesInput::getNextToken() const {
    return m_next_token;
}
void OAIListIndexesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListIndexesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListIndexesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListIndexesInput::getRegions() const {
    return m_regions;
}
void OAIListIndexesInput::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIListIndexesInput::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIListIndexesInput::is_regions_Valid() const{
    return m_regions_isValid;
}

OAIIndexType OAIListIndexesInput::getType() const {
    return m_type;
}
void OAIListIndexesInput::setType(const OAIIndexType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIListIndexesInput::is_type_Set() const{
    return m_type_isSet;
}

bool OAIListIndexesInput::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIListIndexesInput::isSet() const {
...
bool OAIListIndexesInput::isValid() const {
