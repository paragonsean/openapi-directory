...
#include "OAIBatchGetViewInput.h"
...
OAIBatchGetViewInput::OAIBatchGetViewInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetViewInput::OAIBatchGetViewInput() {
    this->initializeModel();
}

OAIBatchGetViewInput::~OAIBatchGetViewInput() {}

void OAIBatchGetViewInput::initializeModel() {

    m_view_arns_isSet = false;
    m_view_arns_isValid = false;
}

void OAIBatchGetViewInput::fromJson(QString jsonString) {
...
void OAIBatchGetViewInput::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetViewInput::asJson() const {
...
QJsonObject OAIBatchGetViewInput::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arns.isSet()) {
        obj.insert(QString("ViewArns"), ::OpenAPI::toJsonValue(m_view_arns));
    }
    return obj;
}

QList OAIBatchGetViewInput::getViewArns() const {
    return m_view_arns;
}
void OAIBatchGetViewInput::setViewArns(const QList &view_arns) {
    m_view_arns = view_arns;
    m_view_arns_isSet = true;
}

bool OAIBatchGetViewInput::is_view_arns_Set() const{
    return m_view_arns_isSet;
}

bool OAIBatchGetViewInput::is_view_arns_Valid() const{
    return m_view_arns_isValid;
}

bool OAIBatchGetViewInput::isSet() const {
...
bool OAIBatchGetViewInput::isValid() const {
