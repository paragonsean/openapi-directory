...
QString OAISearch_request::getNextToken() const {
    return m_next_token;
}
void OAISearch_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAISearch_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAISearch_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAISearch_request::getQueryString() const {
    return m_query_string;
}
void OAISearch_request::setQueryString(const QString &query_string) {
    m_query_string = query_string;
    m_query_string_isSet = true;
}

bool OAISearch_request::is_query_string_Set() const{
    return m_query_string_isSet;
}

bool OAISearch_request::is_query_string_Valid() const{
    return m_query_string_isValid;
}

QString OAISearch_request::getViewArn() const {
    return m_view_arn;
}
void OAISearch_request::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAISearch_request::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAISearch_request::is_view_arn_Valid() const{
