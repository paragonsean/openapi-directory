...
#ifndef OAIIndexType_H
#define OAIIndexType_H
...
class OAIIndexType : public OAIEnum {
public:
    OAIIndexType();
    OAIIndexType(QString json);
    ~OAIIndexType() override;
    ...
    enum class eOAIIndexType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LOCAL, 
        AGGREGATOR
    };
    OAIIndexType::eOAIIndexType getValue() const;
    void setValue(const OAIIndexType::eOAIIndexType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndexType)

#endif // OAIIndexType_H
