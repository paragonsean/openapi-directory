...
#ifndef OAIResourceCount_H
#define OAIResourceCount_H
...
class OAIResourceCount : public OAIObject {
public:
    OAIResourceCount();
    OAIResourceCount(QString json);
    ~OAIResourceCount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceCount)

#endif // OAIResourceCount_H
