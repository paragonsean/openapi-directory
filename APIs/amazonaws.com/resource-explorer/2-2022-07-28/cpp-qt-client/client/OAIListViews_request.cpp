...
OAIListViews_request::OAIListViews_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListViews_request::OAIListViews_request() {
    this->initializeModel();
}

OAIListViews_request::~OAIListViews_request() {}

void OAIListViews_request::initializeModel() {
...
void OAIListViews_request::fromJson(QString jsonString) {
...
void OAIListViews_request::fromJsonObject(QJsonObject json) {
...
QString OAIListViews_request::asJson() const {
...
QJsonObject OAIListViews_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListViews_request::getMaxResults() const {
    return m_max_results;
}
void OAIListViews_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListViews_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListViews_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListViews_request::getNextToken() const {
    return m_next_token;
}
void OAIListViews_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListViews_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListViews_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListViews_request::isSet() const {
...
bool OAIListViews_request::isValid() const {
