...
QString OAIIndex::getArn() const {
    return m_arn;
}
void OAIIndex::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIIndex::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIIndex::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIIndex::getRegion() const {
    return m_region;
}
void OAIIndex::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIIndex::is_region_Set() const{
    return m_region_isSet;
}

bool OAIIndex::is_region_Valid() const{
    return m_region_isValid;
}

OAIIndexType OAIIndex::getType() const {
    return m_type;
}
void OAIIndex::setType(const OAIIndexType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIIndex::is_type_Set() const{
    return m_type_isSet;
}

bool OAIIndex::is_type_Valid() const{
