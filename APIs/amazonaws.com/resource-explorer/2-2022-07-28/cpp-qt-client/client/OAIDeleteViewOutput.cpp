...
OAIDeleteViewOutput::OAIDeleteViewOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteViewOutput::OAIDeleteViewOutput() {
    this->initializeModel();
}

OAIDeleteViewOutput::~OAIDeleteViewOutput() {}

void OAIDeleteViewOutput::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIDeleteViewOutput::fromJson(QString jsonString) {
...
void OAIDeleteViewOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteViewOutput::asJson() const {
...
QJsonObject OAIDeleteViewOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIDeleteViewOutput::getViewArn() const {
    return m_view_arn;
}
void OAIDeleteViewOutput::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIDeleteViewOutput::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIDeleteViewOutput::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIDeleteViewOutput::isSet() const {
...
bool OAIDeleteViewOutput::isValid() const {
