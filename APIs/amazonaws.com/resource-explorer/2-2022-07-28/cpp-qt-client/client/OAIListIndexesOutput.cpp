...
OAIListIndexesOutput::OAIListIndexesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListIndexesOutput::OAIListIndexesOutput() {
    this->initializeModel();
}

OAIListIndexesOutput::~OAIListIndexesOutput() {}

void OAIListIndexesOutput::initializeModel() {
...
void OAIListIndexesOutput::fromJson(QString jsonString) {
...
void OAIListIndexesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListIndexesOutput::asJson() const {
...
QJsonObject OAIListIndexesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_indexes.isSet()) {
...
QList OAIListIndexesOutput::getIndexes() const {
    return m_indexes;
}
void OAIListIndexesOutput::setIndexes(const QList &indexes) {
    m_indexes = indexes;
    m_indexes_isSet = true;
}

bool OAIListIndexesOutput::is_indexes_Set() const{
    return m_indexes_isSet;
}

bool OAIListIndexesOutput::is_indexes_Valid() const{
    return m_indexes_isValid;
}

QString OAIListIndexesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListIndexesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListIndexesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListIndexesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListIndexesOutput::isSet() const {
...
bool OAIListIndexesOutput::isValid() const {
