...
#include "OAIAssociateDefaultViewInput.h"
...
OAIAssociateDefaultViewInput::OAIAssociateDefaultViewInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateDefaultViewInput::OAIAssociateDefaultViewInput() {
    this->initializeModel();
}

OAIAssociateDefaultViewInput::~OAIAssociateDefaultViewInput() {}

void OAIAssociateDefaultViewInput::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIAssociateDefaultViewInput::fromJson(QString jsonString) {
...
void OAIAssociateDefaultViewInput::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateDefaultViewInput::asJson() const {
...
QJsonObject OAIAssociateDefaultViewInput::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIAssociateDefaultViewInput::getViewArn() const {
    return m_view_arn;
}
void OAIAssociateDefaultViewInput::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIAssociateDefaultViewInput::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIAssociateDefaultViewInput::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIAssociateDefaultViewInput::isSet() const {
...
bool OAIAssociateDefaultViewInput::isValid() const {
