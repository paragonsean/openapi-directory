...
/*
 * OAICreateViewOutput_View.h
 *
 * 
 */

#ifndef OAICreateViewOutput_View_H
#define OAICreateViewOutput_View_H
...
class OAICreateViewOutput_View : public OAIObject {
public:
    OAICreateViewOutput_View();
    OAICreateViewOutput_View(QString json);
    ~OAICreateViewOutput_View() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateViewOutput_View)

#endif // OAICreateViewOutput_View_H
