...
/*
 * OAIListIndexesOutput.h
 *
 * 
 */

#ifndef OAIListIndexesOutput_H
#define OAIListIndexesOutput_H
...
class OAIListIndexesOutput : public OAIObject {
public:
    OAIListIndexesOutput();
    OAIListIndexesOutput(QString json);
    ~OAIListIndexesOutput() override;
    ...
    QList getIndexes() const;
    void setIndexes(const QList &indexes);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListIndexesOutput)

#endif // OAIListIndexesOutput_H
