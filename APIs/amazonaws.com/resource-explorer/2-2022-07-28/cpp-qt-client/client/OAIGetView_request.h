...
/*
 * OAIGetView_request.h
 *
 * 
 */

#ifndef OAIGetView_request_H
#define OAIGetView_request_H
...
class OAIGetView_request : public OAIObject {
public:
    OAIGetView_request();
    OAIGetView_request(QString json);
    ~OAIGetView_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetView_request)

#endif // OAIGetView_request_H
