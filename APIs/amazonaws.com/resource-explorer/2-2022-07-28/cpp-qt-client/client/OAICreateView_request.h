...
/*
 * OAICreateView_request.h
 *
 * 
 */

#ifndef OAICreateView_request_H
#define OAICreateView_request_H
...
class OAICreateView_request : public OAIObject {
public:
    OAICreateView_request();
    OAICreateView_request(QString json);
    ~OAICreateView_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateView_request)

#endif // OAICreateView_request_H
