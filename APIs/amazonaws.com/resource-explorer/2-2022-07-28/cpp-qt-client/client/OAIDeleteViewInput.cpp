...
OAIDeleteViewInput::OAIDeleteViewInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteViewInput::OAIDeleteViewInput() {
    this->initializeModel();
}

OAIDeleteViewInput::~OAIDeleteViewInput() {}

void OAIDeleteViewInput::initializeModel() {

    m_view_arn_isSet = false;
    m_view_arn_isValid = false;
}

void OAIDeleteViewInput::fromJson(QString jsonString) {
...
void OAIDeleteViewInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteViewInput::asJson() const {
...
QJsonObject OAIDeleteViewInput::asJsonObject() const {
    QJsonObject obj;
    if (m_view_arn_isSet) {
...
QString OAIDeleteViewInput::getViewArn() const {
    return m_view_arn;
}
void OAIDeleteViewInput::setViewArn(const QString &view_arn) {
    m_view_arn = view_arn;
    m_view_arn_isSet = true;
}

bool OAIDeleteViewInput::is_view_arn_Set() const{
    return m_view_arn_isSet;
}

bool OAIDeleteViewInput::is_view_arn_Valid() const{
    return m_view_arn_isValid;
}

bool OAIDeleteViewInput::isSet() const {
...
bool OAIDeleteViewInput::isValid() const {
