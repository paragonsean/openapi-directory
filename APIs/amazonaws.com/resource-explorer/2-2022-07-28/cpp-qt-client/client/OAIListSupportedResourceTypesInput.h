...
/*
 * OAIListSupportedResourceTypesInput.h
 *
 * 
 */

#ifndef OAIListSupportedResourceTypesInput_H
#define OAIListSupportedResourceTypesInput_H
...
class OAIListSupportedResourceTypesInput : public OAIObject {
public:
    OAIListSupportedResourceTypesInput();
    OAIListSupportedResourceTypesInput(QString json);
    ~OAIListSupportedResourceTypesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSupportedResourceTypesInput)

#endif // OAIListSupportedResourceTypesInput_H
