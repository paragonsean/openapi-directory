...
/*
 * OAIUpdateView_request.h
 *
 * 
 */

#ifndef OAIUpdateView_request_H
#define OAIUpdateView_request_H

#include <QJsonObject>

#include "OAICreateView_request_Filters.h"
#include "OAIIncludedProperty.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateView_request_Filters;
class OAIIncludedProperty;

class OAIUpdateView_request : public OAIObject {
public:
    OAIUpdateView_request();
    OAIUpdateView_request(QString json);
    ~OAIUpdateView_request() override;
    ...
    OAICreateView_request_Filters getFilters() const;
    void setFilters(const OAICreateView_request_Filters &filters);
    bool is_filters_Set() const;
    bool is_filters_Valid() const;

    QList<OAIIncludedProperty> getIncludedProperties() const;
    void setIncludedProperties(const QList<OAIIncludedProperty> &included_properties);
...
private:
    ...
    OAICreateView_request_Filters m_filters;
    bool m_filters_isSet;
    bool m_filters_isValid;

    QList<OAIIncludedProperty> m_included_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateView_request)

#endif // OAIUpdateView_request_H
