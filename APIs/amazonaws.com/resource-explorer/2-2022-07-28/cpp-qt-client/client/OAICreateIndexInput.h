...
/*
 * OAICreateIndexInput.h
 *
 * 
 */

#ifndef OAICreateIndexInput_H
#define OAICreateIndexInput_H
...
class OAICreateIndexInput : public OAIObject {
public:
    OAICreateIndexInput();
    OAICreateIndexInput(QString json);
    ~OAICreateIndexInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIndexInput)

#endif // OAICreateIndexInput_H
