...
OAIIndexType::OAIIndexType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIndexType::OAIIndexType() {
    this->initializeModel();
}

OAIIndexType::~OAIIndexType() {}

void OAIIndexType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIIndexType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIIndexType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("LOCAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIndexType::LOCAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AGGREGATOR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIndexType::AGGREGATOR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIIndexType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIIndexType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIIndexType::LOCAL:
            val = "LOCAL";
            break;
        case eOAIIndexType::AGGREGATOR:
            val = "AGGREGATOR";
            break;
        default:
            break;
...
QJsonValue OAIIndexType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIIndexType::eOAIIndexType OAIIndexType::getValue() const {
    return m_value;
}

void OAIIndexType::setValue(const OAIIndexType::eOAIIndexType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIIndexType::isSet() const {
    
    return m_value_isSet;
}

bool OAIIndexType::isValid() const {
