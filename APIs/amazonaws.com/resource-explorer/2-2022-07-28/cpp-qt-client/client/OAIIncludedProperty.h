...
#ifndef OAIIncludedProperty_H
#define OAIIncludedProperty_H
...
class OAIIncludedProperty : public OAIObject {
public:
    OAIIncludedProperty();
    OAIIncludedProperty(QString json);
    ~OAIIncludedProperty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIncludedProperty)

#endif // OAIIncludedProperty_H
