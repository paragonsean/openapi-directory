...
OAICreateViewOutput::OAICreateViewOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateViewOutput::OAICreateViewOutput() {
    this->initializeModel();
}

OAICreateViewOutput::~OAICreateViewOutput() {}

void OAICreateViewOutput::initializeModel() {

    m_view_isSet = false;
    m_view_isValid = false;
}

void OAICreateViewOutput::fromJson(QString jsonString) {
...
QJsonObject OAICreateViewOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_view.isSet()) {
...
OAICreateViewOutput_View OAICreateViewOutput::getView() const {
    return m_view;
}
void OAICreateViewOutput::setView(const OAICreateViewOutput_View &view) {
    m_view = view;
    m_view_isSet = true;
}

bool OAICreateViewOutput::is_view_Set() const{
    return m_view_isSet;
}

bool OAICreateViewOutput::is_view_Valid() const{
    return m_view_isValid;
}

bool OAICreateViewOutput::isSet() const {
...
bool OAICreateViewOutput::isValid() const {
