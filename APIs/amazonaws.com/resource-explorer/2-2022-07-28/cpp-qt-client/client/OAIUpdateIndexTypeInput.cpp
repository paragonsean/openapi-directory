...
#include "OAIUpdateIndexTypeInput.h"
...
OAIUpdateIndexTypeInput::OAIUpdateIndexTypeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIndexTypeInput::OAIUpdateIndexTypeInput() {
    this->initializeModel();
}

OAIUpdateIndexTypeInput::~OAIUpdateIndexTypeInput() {}

void OAIUpdateIndexTypeInput::initializeModel() {
...
void OAIUpdateIndexTypeInput::fromJson(QString jsonString) {
...
void OAIUpdateIndexTypeInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIndexTypeInput::asJson() const {
...
QJsonObject OAIUpdateIndexTypeInput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateIndexTypeInput::getArn() const {
    return m_arn;
}
void OAIUpdateIndexTypeInput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateIndexTypeInput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateIndexTypeInput::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIIndexType OAIUpdateIndexTypeInput::getType() const {
    return m_type;
}
void OAIUpdateIndexTypeInput::setType(const OAIIndexType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateIndexTypeInput::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateIndexTypeInput::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIUpdateIndexTypeInput::isSet() const {
...
bool OAIUpdateIndexTypeInput::isValid() const {
