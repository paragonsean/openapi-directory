...
/*
 * OAIDeleteIndexOutput.h
 *
 * 
 */

#ifndef OAIDeleteIndexOutput_H
#define OAIDeleteIndexOutput_H
...
class OAIDeleteIndexOutput : public OAIObject {
public:
    OAIDeleteIndexOutput();
    OAIDeleteIndexOutput(QString json);
    ~OAIDeleteIndexOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteIndexOutput)

#endif // OAIDeleteIndexOutput_H
