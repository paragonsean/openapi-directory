...
#ifndef OAIGetViewOutput_H
#define OAIGetViewOutput_H
...
namespace OpenAPI {
class OAIGetViewOutput_View;

class OAIGetViewOutput : public OAIObject {
public:
    OAIGetViewOutput();
    OAIGetViewOutput(QString json);
    ~OAIGetViewOutput() override;
    ...
    OAIGetViewOutput_View getView() const;
    void setView(const OAIGetViewOutput_View &view);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetViewOutput)

#endif // OAIGetViewOutput_H
