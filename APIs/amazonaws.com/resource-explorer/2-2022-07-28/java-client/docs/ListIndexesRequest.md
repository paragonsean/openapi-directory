...
|**regions** | **List&lt;String&gt;** | If specified, limits the response to only information about the index in the specified list of Amazon Web Services Regions. |  [optional] |
|**type** | [**TypeEnum**](#TypeEnum) | &lt;p&gt;If specified, limits the output to only indexes of the specified Type, either &lt;code&gt;LOCAL&lt;/code&gt; or &lt;code&gt;AGGREGATOR&lt;/code&gt;.&lt;/p&gt; &lt;p&gt;Use this option to discover the aggregator index for your account.&lt;/p&gt; |  [optional] |
