...
public class GetDefaultViewOutput {
  ...
  public GetDefaultViewOutput viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetDefaultViewOutput getDefaultViewOutput = (GetDefaultViewOutput) o;
    return Objects.equals(this.viewArn, getDefaultViewOutput.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDefaultViewOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDefaultViewOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDefaultViewOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDefaultViewOutput is not found in the empty JSON string", GetDefaultViewOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDefaultViewOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDefaultViewOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDefaultViewOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDefaultViewOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDefaultViewOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDefaultViewOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDefaultViewOutput>() {
           @Override
           public void write(JsonWriter out, GetDefaultViewOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDefaultViewOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDefaultViewOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDefaultViewOutput
   * @throws IOException if the JSON string is invalid with respect to GetDefaultViewOutput
   */
  public static GetDefaultViewOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDefaultViewOutput.class);
  }

  /**
   * Convert an instance of GetDefaultViewOutput to an JSON string
   *
   * @return JSON string
   */
