...
public class GetViewRequest {
  ...
  public GetViewRequest viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetViewRequest getViewRequest = (GetViewRequest) o;
    return Objects.equals(this.viewArn, getViewRequest.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetViewRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetViewRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetViewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetViewRequest is not found in the empty JSON string", GetViewRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetViewRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetViewRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetViewRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetViewRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetViewRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetViewRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetViewRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetViewRequest>() {
           @Override
           public void write(JsonWriter out, GetViewRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetViewRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetViewRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetViewRequest
   * @throws IOException if the JSON string is invalid with respect to GetViewRequest
   */
  public static GetViewRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetViewRequest.class);
  }

  /**
   * Convert an instance of GetViewRequest to an JSON string
   *
   * @return JSON string
   */
