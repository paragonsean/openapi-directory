...
public class CreateViewInput {
  ...
  private CreateViewInputFilters filters;
  ...
  public CreateViewInput clientToken(String clientToken) {
  ...
  public CreateViewInput filters(CreateViewInputFilters filters) {
   ...
   */
  @javax.annotation.Nullable
  public CreateViewInputFilters getFilters() {
    return filters;
  }

  public void setFilters(CreateViewInputFilters filters) {
    this.filters = filters;
  }


  public CreateViewInput includedProperties(List includedProperties) {
  ...
  public CreateViewInput tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateViewInput viewName(String viewName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateViewInput createViewInput = (CreateViewInput) o;
    return Objects.equals(this.clientToken, createViewInput.clientToken) &&
        Objects.equals(this.filters, createViewInput.filters) &&
        Objects.equals(this.includedProperties, createViewInput.includedProperties) &&
        Objects.equals(this.tags, createViewInput.tags) &&
        Objects.equals(this.viewName, createViewInput.viewName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateViewInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateViewInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateViewInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateViewInput is not found in the empty JSON string", CreateViewInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateViewInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateViewInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateViewInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("Filters") != null && !jsonObj.get("Filters").isJsonNull()) {
        CreateViewInputFilters.validateJsonElement(jsonObj.get("Filters"));
      }
      ...
      // validate the required field `ViewName`
      String.validateJsonElement(jsonObj.get("ViewName"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateViewInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateViewInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateViewInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateViewInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateViewInput>() {
           @Override
           public void write(JsonWriter out, CreateViewInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateViewInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateViewInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateViewInput
   * @throws IOException if the JSON string is invalid with respect to CreateViewInput
   */
  public static CreateViewInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateViewInput.class);
  }

  /**
   * Convert an instance of CreateViewInput to an JSON string
   *
   * @return JSON string
   */
