...
import org.openapitools.client.model.UpdateViewOutputView;
...
public class UpdateViewOutput {
  ...
  private UpdateViewOutputView view;

  public UpdateViewOutput() {
  }

  public UpdateViewOutput view(UpdateViewOutputView view) {
    this.view = view;
    return this;
  }
  ...
  public UpdateViewOutputView getView() {
    return view;
  }

  public void setView(UpdateViewOutputView view) {
    this.view = view;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateViewOutput updateViewOutput = (UpdateViewOutput) o;
    return Objects.equals(this.view, updateViewOutput.view);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateViewOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateViewOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateViewOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateViewOutput is not found in the empty JSON string", UpdateViewOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateViewOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateViewOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `View`
      if (jsonObj.get("View") != null && !jsonObj.get("View").isJsonNull()) {
        UpdateViewOutputView.validateJsonElement(jsonObj.get("View"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateViewOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateViewOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateViewOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateViewOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateViewOutput>() {
           @Override
           public void write(JsonWriter out, UpdateViewOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateViewOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateViewOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateViewOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateViewOutput
   */
  public static UpdateViewOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateViewOutput.class);
  }

  /**
   * Convert an instance of UpdateViewOutput to an JSON string
   *
   * @return JSON string
   */
