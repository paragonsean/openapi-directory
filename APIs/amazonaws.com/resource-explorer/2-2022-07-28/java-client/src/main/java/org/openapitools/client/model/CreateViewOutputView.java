...
public class CreateViewOutputView {
  ...
  public CreateViewOutputView() {
  }

  public CreateViewOutputView filters(ViewFilters filters) {
  ...
  public CreateViewOutputView includedProperties(List includedProperties) {
  ...
  public CreateViewOutputView lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public CreateViewOutputView owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public CreateViewOutputView scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public CreateViewOutputView viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateViewOutputView createViewOutputView = (CreateViewOutputView) o;
    return Objects.equals(this.filters, createViewOutputView.filters) &&
        Objects.equals(this.includedProperties, createViewOutputView.includedProperties) &&
        Objects.equals(this.lastUpdatedAt, createViewOutputView.lastUpdatedAt) &&
        Objects.equals(this.owner, createViewOutputView.owner) &&
        Objects.equals(this.scope, createViewOutputView.scope) &&
        Objects.equals(this.viewArn, createViewOutputView.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateViewOutputView {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateViewOutputView
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateViewOutputView.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateViewOutputView is not found in the empty JSON string", CreateViewOutputView.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateViewOutputView.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateViewOutputView` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateViewOutputView.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateViewOutputView' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateViewOutputView> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateViewOutputView.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateViewOutputView>() {
           @Override
           public void write(JsonWriter out, CreateViewOutputView value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateViewOutputView read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateViewOutputView given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateViewOutputView
   * @throws IOException if the JSON string is invalid with respect to CreateViewOutputView
   */
  public static CreateViewOutputView fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateViewOutputView.class);
  }

  /**
   * Convert an instance of CreateViewOutputView to an JSON string
   *
   * @return JSON string
   */
