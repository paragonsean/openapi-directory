...
public class ListSupportedResourceTypesOutput {
  ...
  public ListSupportedResourceTypesOutput nextToken(String nextToken) {
  ...
  public ListSupportedResourceTypesOutput resourceTypes(List resourceTypes) {
  ...
  public boolean equals(Object o) {
    ...
    ListSupportedResourceTypesOutput listSupportedResourceTypesOutput = (ListSupportedResourceTypesOutput) o;
    return Objects.equals(this.nextToken, listSupportedResourceTypesOutput.nextToken) &&
        Objects.equals(this.resourceTypes, listSupportedResourceTypesOutput.resourceTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, resourceTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListSupportedResourceTypesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListSupportedResourceTypesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListSupportedResourceTypesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListSupportedResourceTypesOutput is not found in the empty JSON string", ListSupportedResourceTypesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListSupportedResourceTypesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListSupportedResourceTypesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListSupportedResourceTypesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListSupportedResourceTypesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListSupportedResourceTypesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListSupportedResourceTypesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListSupportedResourceTypesOutput>() {
           @Override
           public void write(JsonWriter out, ListSupportedResourceTypesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListSupportedResourceTypesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListSupportedResourceTypesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListSupportedResourceTypesOutput
   * @throws IOException if the JSON string is invalid with respect to ListSupportedResourceTypesOutput
   */
  public static ListSupportedResourceTypesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSupportedResourceTypesOutput.class);
  }

  /**
   * Convert an instance of ListSupportedResourceTypesOutput to an JSON string
   *
   * @return JSON string
   */
