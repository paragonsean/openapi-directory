...
public class UpdateViewInput {
  ...
  public UpdateViewInput filters(CreateViewInputFilters filters) {
  ...
  public UpdateViewInput includedProperties(List includedProperties) {
  ...
  public UpdateViewInput viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateViewInput updateViewInput = (UpdateViewInput) o;
    return Objects.equals(this.filters, updateViewInput.filters) &&
        Objects.equals(this.includedProperties, updateViewInput.includedProperties) &&
        Objects.equals(this.viewArn, updateViewInput.viewArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filters, includedProperties, viewArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateViewInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateViewInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateViewInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateViewInput is not found in the empty JSON string", UpdateViewInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateViewInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateViewInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateViewInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateViewInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateViewInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateViewInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateViewInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateViewInput>() {
           @Override
           public void write(JsonWriter out, UpdateViewInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateViewInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateViewInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateViewInput
   * @throws IOException if the JSON string is invalid with respect to UpdateViewInput
   */
  public static UpdateViewInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateViewInput.class);
  }

  /**
   * Convert an instance of UpdateViewInput to an JSON string
   *
   * @return JSON string
   */
