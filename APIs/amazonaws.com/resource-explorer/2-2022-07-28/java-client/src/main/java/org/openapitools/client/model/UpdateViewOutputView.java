...
public class UpdateViewOutputView {
  ...
  public UpdateViewOutputView() {
  }

  public UpdateViewOutputView filters(ViewFilters filters) {
  ...
  public UpdateViewOutputView includedProperties(List includedProperties) {
  ...
  public UpdateViewOutputView lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public UpdateViewOutputView owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public UpdateViewOutputView scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public UpdateViewOutputView viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateViewOutputView updateViewOutputView = (UpdateViewOutputView) o;
    return Objects.equals(this.filters, updateViewOutputView.filters) &&
        Objects.equals(this.includedProperties, updateViewOutputView.includedProperties) &&
        Objects.equals(this.lastUpdatedAt, updateViewOutputView.lastUpdatedAt) &&
        Objects.equals(this.owner, updateViewOutputView.owner) &&
        Objects.equals(this.scope, updateViewOutputView.scope) &&
        Objects.equals(this.viewArn, updateViewOutputView.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateViewOutputView {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateViewOutputView
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateViewOutputView.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateViewOutputView is not found in the empty JSON string", UpdateViewOutputView.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateViewOutputView.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateViewOutputView` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateViewOutputView.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateViewOutputView' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateViewOutputView> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateViewOutputView.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateViewOutputView>() {
           @Override
           public void write(JsonWriter out, UpdateViewOutputView value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateViewOutputView read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateViewOutputView given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateViewOutputView
   * @throws IOException if the JSON string is invalid with respect to UpdateViewOutputView
   */
  public static UpdateViewOutputView fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateViewOutputView.class);
  }

  /**
   * Convert an instance of UpdateViewOutputView to an JSON string
   *
   * @return JSON string
   */
