...
public class ResourceProperty {
  ...
  public ResourceProperty data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public ResourceProperty lastReportedAt(OffsetDateTime lastReportedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, resourceProperty.data) &&
        Objects.equals(this.lastReportedAt, resourceProperty.lastReportedAt) &&
        Objects.equals(this.name, resourceProperty.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, lastReportedAt, name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceProperty is not found in the empty JSON string", ResourceProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Data`
      if (jsonObj.get("Data") != null && !jsonObj.get("Data").isJsonNull()) {
        Object.validateJsonElement(jsonObj.get("Data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceProperty>() {
           @Override
           public void write(JsonWriter out, ResourceProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceProperty read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceProperty
   * @throws IOException if the JSON string is invalid with respect to ResourceProperty
   */
  public static ResourceProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceProperty.class);
  }

  /**
   * Convert an instance of ResourceProperty to an JSON string
   *
   * @return JSON string
   */
