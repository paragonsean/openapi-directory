...
public class DeleteViewRequest {
  ...
  public DeleteViewRequest viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteViewRequest deleteViewRequest = (DeleteViewRequest) o;
    return Objects.equals(this.viewArn, deleteViewRequest.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteViewRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ViewArn");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteViewRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteViewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteViewRequest is not found in the empty JSON string", DeleteViewRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteViewRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteViewRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteViewRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("ViewArn").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteViewRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteViewRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteViewRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteViewRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteViewRequest>() {
           @Override
           public void write(JsonWriter out, DeleteViewRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteViewRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteViewRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteViewRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteViewRequest
   */
  public static DeleteViewRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteViewRequest.class);
  }

  /**
   * Convert an instance of DeleteViewRequest to an JSON string
   *
   * @return JSON string
   */
