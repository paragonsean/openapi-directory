...
public class AssociateDefaultViewRequest {
  ...
  public AssociateDefaultViewRequest() {
  }

  public AssociateDefaultViewRequest viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateDefaultViewRequest associateDefaultViewRequest = (AssociateDefaultViewRequest) o;
    return Objects.equals(this.viewArn, associateDefaultViewRequest.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateDefaultViewRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateDefaultViewRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateDefaultViewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateDefaultViewRequest is not found in the empty JSON string", AssociateDefaultViewRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateDefaultViewRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateDefaultViewRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateDefaultViewRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateDefaultViewRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateDefaultViewRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateDefaultViewRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateDefaultViewRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateDefaultViewRequest>() {
           @Override
           public void write(JsonWriter out, AssociateDefaultViewRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateDefaultViewRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateDefaultViewRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateDefaultViewRequest
   * @throws IOException if the JSON string is invalid with respect to AssociateDefaultViewRequest
   */
  public static AssociateDefaultViewRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateDefaultViewRequest.class);
  }

  /**
   * Convert an instance of AssociateDefaultViewRequest to an JSON string
   *
   * @return JSON string
   */
