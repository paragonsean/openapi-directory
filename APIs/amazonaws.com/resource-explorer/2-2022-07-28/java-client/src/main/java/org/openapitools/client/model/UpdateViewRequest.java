...
public class UpdateViewRequest {
  ...
  public UpdateViewRequest filters(CreateViewRequestFilters filters) {
  ...
  public UpdateViewRequest includedProperties(List<IncludedProperty> includedProperties) {
    this.includedProperties = includedProperties;
    return this;
  }

  public UpdateViewRequest addIncludedPropertiesItem(IncludedProperty includedPropertiesItem) {
  ...
  public UpdateViewRequest viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filters, updateViewRequest.filters) &&
        Objects.equals(this.includedProperties, updateViewRequest.includedProperties) &&
        Objects.equals(this.viewArn, updateViewRequest.viewArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateViewRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateViewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateViewRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateViewRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
