...
public class GetViewInput {
  ...
  public GetViewInput viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetViewInput getViewInput = (GetViewInput) o;
    return Objects.equals(this.viewArn, getViewInput.viewArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetViewInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetViewInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetViewInput is not found in the empty JSON string", GetViewInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetViewInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetViewInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetViewInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetViewInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetViewInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetViewInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetViewInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetViewInput>() {
           @Override
           public void write(JsonWriter out, GetViewInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetViewInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetViewInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetViewInput
   * @throws IOException if the JSON string is invalid with respect to GetViewInput
   */
  public static GetViewInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetViewInput.class);
  }

  /**
   * Convert an instance of GetViewInput to an JSON string
   *
   * @return JSON string
   */
