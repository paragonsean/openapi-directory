...
public class SearchFilter {
  public static final String SERIALIZED_NAME_FILTER_STRING = "FilterString";
  @SerializedName(SERIALIZED_NAME_FILTER_STRING)
  private String filterString;

  public SearchFilter() {
  }

  public SearchFilter filterString(String filterString) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filterString, searchFilter.filterString);
  }
  ...
  static {
    ...
    openapiFields.add("FilterString");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("FilterString");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `FilterString`
      String.validateJsonElement(jsonObj.get("FilterString"));
  }
