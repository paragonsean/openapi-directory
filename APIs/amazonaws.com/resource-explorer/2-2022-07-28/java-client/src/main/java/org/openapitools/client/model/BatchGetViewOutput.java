...
public class BatchGetViewOutput {
  ...
  public BatchGetViewOutput errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public BatchGetViewOutput views(List views) {
    this.views = views;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchGetViewOutput batchGetViewOutput = (BatchGetViewOutput) o;
    return Objects.equals(this.errors, batchGetViewOutput.errors) &&
        Objects.equals(this.views, batchGetViewOutput.views);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errors, views);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetViewOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetViewOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetViewOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetViewOutput is not found in the empty JSON string", BatchGetViewOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetViewOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetViewOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetViewOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetViewOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetViewOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetViewOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetViewOutput>() {
           @Override
           public void write(JsonWriter out, BatchGetViewOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetViewOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetViewOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetViewOutput
   * @throws IOException if the JSON string is invalid with respect to BatchGetViewOutput
   */
  public static BatchGetViewOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetViewOutput.class);
  }

  /**
   * Convert an instance of BatchGetViewOutput to an JSON string
   *
   * @return JSON string
   */
