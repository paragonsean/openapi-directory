...
public class SupportedResourceType {
  ...
  public SupportedResourceType resourceType(String resourceType) {
  ...
  public SupportedResourceType service(String service) {
  ...
  public boolean equals(Object o) {
    ...
    SupportedResourceType supportedResourceType = (SupportedResourceType) o;
    return Objects.equals(this.resourceType, supportedResourceType.resourceType) &&
        Objects.equals(this.service, supportedResourceType.service);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceType, service);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SupportedResourceType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportedResourceType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportedResourceType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportedResourceType is not found in the empty JSON string", SupportedResourceType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportedResourceType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportedResourceType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportedResourceType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportedResourceType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportedResourceType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportedResourceType.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportedResourceType>() {
           @Override
           public void write(JsonWriter out, SupportedResourceType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportedResourceType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportedResourceType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportedResourceType
   * @throws IOException if the JSON string is invalid with respect to SupportedResourceType
   */
  public static SupportedResourceType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportedResourceType.class);
  }

  /**
   * Convert an instance of SupportedResourceType to an JSON string
   *
   * @return JSON string
   */
