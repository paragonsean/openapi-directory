...
public class BatchGetViewError {
  ...
  public BatchGetViewError() {
  }

  public BatchGetViewError errorMessage(String errorMessage) {
  ...
  public BatchGetViewError viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetViewError batchGetViewError = (BatchGetViewError) o;
    return Objects.equals(this.errorMessage, batchGetViewError.errorMessage) &&
        Objects.equals(this.viewArn, batchGetViewError.viewArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errorMessage, viewArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetViewError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetViewError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetViewError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetViewError is not found in the empty JSON string", BatchGetViewError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetViewError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetViewError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchGetViewError.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetViewError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetViewError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetViewError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetViewError.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetViewError>() {
           @Override
           public void write(JsonWriter out, BatchGetViewError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetViewError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetViewError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetViewError
   * @throws IOException if the JSON string is invalid with respect to BatchGetViewError
   */
  public static BatchGetViewError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetViewError.class);
  }

  /**
   * Convert an instance of BatchGetViewError to an JSON string
   *
   * @return JSON string
   */
