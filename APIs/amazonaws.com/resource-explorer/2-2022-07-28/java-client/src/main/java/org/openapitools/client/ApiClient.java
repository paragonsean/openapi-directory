...
public class ApiClient {
    ...
    private String basePath = "http://resource-explorer-2.us-east-1.api.aws";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2022-07-28/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://resource-explorer-2.us-east-1.api.aws
