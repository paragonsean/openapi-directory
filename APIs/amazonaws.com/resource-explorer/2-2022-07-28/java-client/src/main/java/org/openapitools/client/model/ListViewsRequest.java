...
public class ListViewsRequest {
  ...
  public ListViewsRequest maxResults(Integer maxResults) {
  ...
  public ListViewsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListViewsRequest listViewsRequest = (ListViewsRequest) o;
    return Objects.equals(this.maxResults, listViewsRequest.maxResults) &&
        Objects.equals(this.nextToken, listViewsRequest.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListViewsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListViewsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListViewsRequest is not found in the empty JSON string", ListViewsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListViewsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListViewsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListViewsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListViewsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListViewsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListViewsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListViewsRequest>() {
           @Override
           public void write(JsonWriter out, ListViewsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListViewsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListViewsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListViewsRequest
   * @throws IOException if the JSON string is invalid with respect to ListViewsRequest
   */
  public static ListViewsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListViewsRequest.class);
  }

  /**
   * Convert an instance of ListViewsRequest to an JSON string
   *
   * @return JSON string
   */
