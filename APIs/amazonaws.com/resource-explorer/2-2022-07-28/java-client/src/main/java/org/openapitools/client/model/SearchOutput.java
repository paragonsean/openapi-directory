...
import org.openapitools.client.model.SearchOutputCount;
...
public class SearchOutput {
  ...
  private SearchOutputCount count;
  ...
  public SearchOutput count(SearchOutputCount count) {
    this.count = count;
    return this;
  }
  ...
  public SearchOutputCount getCount() {
    return count;
  }

  public void setCount(SearchOutputCount count) {
    this.count = count;
  }


  public SearchOutput nextToken(String nextToken) {
  ...
  public SearchOutput resources(List resources) {
  ...
  public SearchOutput viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    SearchOutput searchOutput = (SearchOutput) o;
    return Objects.equals(this.count, searchOutput.count) &&
        Objects.equals(this.nextToken, searchOutput.nextToken) &&
        Objects.equals(this.resources, searchOutput.resources) &&
        Objects.equals(this.viewArn, searchOutput.viewArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, nextToken, resources, viewArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchOutput is not found in the empty JSON string", SearchOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Count`
      if (jsonObj.get("Count") != null && !jsonObj.get("Count").isJsonNull()) {
        SearchOutputCount.validateJsonElement(jsonObj.get("Count"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchOutput>() {
           @Override
           public void write(JsonWriter out, SearchOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchOutput
   * @throws IOException if the JSON string is invalid with respect to SearchOutput
   */
  public static SearchOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchOutput.class);
  }

  /**
   * Convert an instance of SearchOutput to an JSON string
   *
   * @return JSON string
   */
