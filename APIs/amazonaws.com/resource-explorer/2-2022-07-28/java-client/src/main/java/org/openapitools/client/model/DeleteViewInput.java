...
public class DeleteViewInput {
  ...
  public boolean equals(Object o) {
    ...
    DeleteViewInput deleteViewInput = (DeleteViewInput) o;
    return Objects.equals(this.viewArn, deleteViewInput.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteViewInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteViewInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteViewInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteViewInput is not found in the empty JSON string", DeleteViewInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteViewInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteViewInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteViewInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ViewArn`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteViewInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteViewInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteViewInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteViewInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteViewInput>() {
           @Override
           public void write(JsonWriter out, DeleteViewInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteViewInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteViewInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteViewInput
   * @throws IOException if the JSON string is invalid with respect to DeleteViewInput
   */
  public static DeleteViewInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteViewInput.class);
  }

  /**
   * Convert an instance of DeleteViewInput to an JSON string
   *
   * @return JSON string
   */
