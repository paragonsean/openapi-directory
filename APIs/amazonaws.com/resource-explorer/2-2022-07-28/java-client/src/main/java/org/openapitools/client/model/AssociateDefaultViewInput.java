...
public class AssociateDefaultViewInput {
  public static final String SERIALIZED_NAME_VIEW_ARN = "ViewArn";
  @SerializedName(SERIALIZED_NAME_VIEW_ARN)
  private String viewArn;

  public AssociateDefaultViewInput() {
  }

  public AssociateDefaultViewInput viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateDefaultViewInput associateDefaultViewInput = (AssociateDefaultViewInput) o;
    return Objects.equals(this.viewArn, associateDefaultViewInput.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateDefaultViewInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateDefaultViewInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateDefaultViewInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateDefaultViewInput is not found in the empty JSON string", AssociateDefaultViewInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateDefaultViewInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateDefaultViewInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateDefaultViewInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateDefaultViewInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateDefaultViewInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateDefaultViewInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateDefaultViewInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateDefaultViewInput>() {
           @Override
           public void write(JsonWriter out, AssociateDefaultViewInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateDefaultViewInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateDefaultViewInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateDefaultViewInput
   * @throws IOException if the JSON string is invalid with respect to AssociateDefaultViewInput
   */
  public static AssociateDefaultViewInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateDefaultViewInput.class);
  }

  /**
   * Convert an instance of AssociateDefaultViewInput to an JSON string
   *
   * @return JSON string
   */
