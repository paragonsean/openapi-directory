...
public class DeleteViewOutput {
  ...
  public DeleteViewOutput viewArn(String viewArn) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteViewOutput deleteViewOutput = (DeleteViewOutput) o;
    return Objects.equals(this.viewArn, deleteViewOutput.viewArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteViewOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteViewOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteViewOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteViewOutput is not found in the empty JSON string", DeleteViewOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteViewOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteViewOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteViewOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteViewOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteViewOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteViewOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteViewOutput>() {
           @Override
           public void write(JsonWriter out, DeleteViewOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteViewOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteViewOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteViewOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteViewOutput
   */
  public static DeleteViewOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteViewOutput.class);
  }

  /**
   * Convert an instance of DeleteViewOutput to an JSON string
   *
   * @return JSON string
   */
