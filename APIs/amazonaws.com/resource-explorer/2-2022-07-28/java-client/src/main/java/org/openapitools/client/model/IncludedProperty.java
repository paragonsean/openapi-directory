...
public class IncludedProperty {
  ...
  public IncludedProperty name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IncludedProperty includedProperty = (IncludedProperty) o;
    return Objects.equals(this.name, includedProperty.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncludedProperty {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IncludedProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IncludedProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncludedProperty is not found in the empty JSON string", IncludedProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IncludedProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IncludedProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncludedProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncludedProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncludedProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncludedProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncludedProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<IncludedProperty>() {
           @Override
           public void write(JsonWriter out, IncludedProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IncludedProperty read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IncludedProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IncludedProperty
   * @throws IOException if the JSON string is invalid with respect to IncludedProperty
   */
  public static IncludedProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncludedProperty.class);
  }

  /**
   * Convert an instance of IncludedProperty to an JSON string
   *
   * @return JSON string
   */
