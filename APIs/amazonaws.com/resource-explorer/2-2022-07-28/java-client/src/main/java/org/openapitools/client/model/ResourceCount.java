...
public class ResourceCount {
  ...
  public ResourceCount complete(Boolean complete) {
  ...
  public ResourceCount totalResources(Integer totalResources) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceCount resourceCount = (ResourceCount) o;
    return Objects.equals(this.complete, resourceCount.complete) &&
        Objects.equals(this.totalResources, resourceCount.totalResources);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceCount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceCount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceCount is not found in the empty JSON string", ResourceCount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceCount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceCount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceCount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceCount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceCount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceCount.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceCount>() {
           @Override
           public void write(JsonWriter out, ResourceCount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceCount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceCount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceCount
   * @throws IOException if the JSON string is invalid with respect to ResourceCount
   */
  public static ResourceCount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceCount.class);
  }

  /**
   * Convert an instance of ResourceCount to an JSON string
   *
   * @return JSON string
   */
