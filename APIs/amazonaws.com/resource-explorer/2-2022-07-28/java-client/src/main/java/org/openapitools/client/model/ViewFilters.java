...
public class ViewFilters {
  ...
  public ViewFilters filterString(String filterString) {
  ...
  public boolean equals(Object o) {
    ...
    ViewFilters viewFilters = (ViewFilters) o;
    return Objects.equals(this.filterString, viewFilters.filterString);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewFilters is not found in the empty JSON string", ViewFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewFilters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewFilters>() {
           @Override
           public void write(JsonWriter out, ViewFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewFilters
   * @throws IOException if the JSON string is invalid with respect to ViewFilters
   */
  public static ViewFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewFilters.class);
  }

  /**
   * Convert an instance of ViewFilters to an JSON string
   *
   * @return JSON string
   */
