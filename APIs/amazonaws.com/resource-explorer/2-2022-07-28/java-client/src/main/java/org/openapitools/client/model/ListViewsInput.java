...
public class ListViewsInput {
  ...
  public ListViewsInput() {
  }

  public ListViewsInput maxResults(Integer maxResults) {
  ...
  public ListViewsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListViewsInput listViewsInput = (ListViewsInput) o;
    return Objects.equals(this.maxResults, listViewsInput.maxResults) &&
        Objects.equals(this.nextToken, listViewsInput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListViewsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListViewsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListViewsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListViewsInput is not found in the empty JSON string", ListViewsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListViewsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListViewsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListViewsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListViewsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListViewsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListViewsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListViewsInput>() {
           @Override
           public void write(JsonWriter out, ListViewsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListViewsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListViewsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListViewsInput
   * @throws IOException if the JSON string is invalid with respect to ListViewsInput
   */
  public static ListViewsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListViewsInput.class);
  }

  /**
   * Convert an instance of ListViewsInput to an JSON string
   *
   * @return JSON string
   */
