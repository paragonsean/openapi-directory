...
public class CreateIndexInput {
  ...
  public CreateIndexInput clientToken(String clientToken) {
  ...
  public CreateIndexInput tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateIndexInput createIndexInput = (CreateIndexInput) o;
    return Objects.equals(this.clientToken, createIndexInput.clientToken) &&
        Objects.equals(this.tags, createIndexInput.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIndexInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIndexInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIndexInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIndexInput is not found in the empty JSON string", CreateIndexInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIndexInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIndexInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIndexInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIndexInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIndexInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIndexInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIndexInput>() {
           @Override
           public void write(JsonWriter out, CreateIndexInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIndexInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIndexInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIndexInput
   * @throws IOException if the JSON string is invalid with respect to CreateIndexInput
   */
  public static CreateIndexInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIndexInput.class);
  }

  /**
   * Convert an instance of CreateIndexInput to an JSON string
   *
   * @return JSON string
   */
