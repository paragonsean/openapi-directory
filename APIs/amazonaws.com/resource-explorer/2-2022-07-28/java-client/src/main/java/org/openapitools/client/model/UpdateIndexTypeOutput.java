...
public class UpdateIndexTypeOutput {
  ...
  public UpdateIndexTypeOutput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateIndexTypeOutput lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public UpdateIndexTypeOutput state(IndexState state) {
    this.state = state;
    return this;
  }
  ...
  public UpdateIndexTypeOutput type(IndexType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateIndexTypeOutput updateIndexTypeOutput = (UpdateIndexTypeOutput) o;
    return Objects.equals(this.arn, updateIndexTypeOutput.arn) &&
        Objects.equals(this.lastUpdatedAt, updateIndexTypeOutput.lastUpdatedAt) &&
        Objects.equals(this.state, updateIndexTypeOutput.state) &&
        Objects.equals(this.type, updateIndexTypeOutput.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, lastUpdatedAt, state, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateIndexTypeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateIndexTypeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateIndexTypeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateIndexTypeOutput is not found in the empty JSON string", UpdateIndexTypeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateIndexTypeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateIndexTypeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateIndexTypeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateIndexTypeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateIndexTypeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateIndexTypeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateIndexTypeOutput>() {
           @Override
           public void write(JsonWriter out, UpdateIndexTypeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateIndexTypeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateIndexTypeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateIndexTypeOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateIndexTypeOutput
   */
  public static UpdateIndexTypeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateIndexTypeOutput.class);
  }

  /**
   * Convert an instance of UpdateIndexTypeOutput to an JSON string
   *
   * @return JSON string
   */
