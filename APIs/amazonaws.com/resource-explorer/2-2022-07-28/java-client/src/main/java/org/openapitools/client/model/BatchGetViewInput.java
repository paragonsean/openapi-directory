...
public class BatchGetViewInput {
  public static final String SERIALIZED_NAME_VIEW_ARNS = "ViewArns";
  @SerializedName(SERIALIZED_NAME_VIEW_ARNS)
  private List viewArns;

  public BatchGetViewInput() {
  }

  public BatchGetViewInput viewArns(List viewArns) {
  ...
  public List getViewArns() {
    return viewArns;
  }

  public void setViewArns(List viewArns) {
    this.viewArns = viewArns;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchGetViewInput batchGetViewInput = (BatchGetViewInput) o;
    return Objects.equals(this.viewArns, batchGetViewInput.viewArns);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchGetViewInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetViewInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetViewInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetViewInput is not found in the empty JSON string", BatchGetViewInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetViewInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetViewInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ViewArns`
      if (jsonObj.get("ViewArns") != null && !jsonObj.get("ViewArns").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ViewArns"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetViewInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetViewInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetViewInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetViewInput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetViewInput>() {
           @Override
           public void write(JsonWriter out, BatchGetViewInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetViewInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetViewInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetViewInput
   * @throws IOException if the JSON string is invalid with respect to BatchGetViewInput
   */
  public static BatchGetViewInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetViewInput.class);
  }

  /**
   * Convert an instance of BatchGetViewInput to an JSON string
   *
   * @return JSON string
   */
