...
public class ListIndexesOutput {
  ...
  public ListIndexesOutput indexes(List indexes) {
  ...
  public ListIndexesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListIndexesOutput listIndexesOutput = (ListIndexesOutput) o;
    return Objects.equals(this.indexes, listIndexesOutput.indexes) &&
        Objects.equals(this.nextToken, listIndexesOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(indexes, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListIndexesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListIndexesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListIndexesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListIndexesOutput is not found in the empty JSON string", ListIndexesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListIndexesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListIndexesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Indexes`
      if (jsonObj.get("Indexes") != null && !jsonObj.get("Indexes").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Indexes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListIndexesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListIndexesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListIndexesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListIndexesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListIndexesOutput>() {
           @Override
           public void write(JsonWriter out, ListIndexesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListIndexesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListIndexesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListIndexesOutput
   * @throws IOException if the JSON string is invalid with respect to ListIndexesOutput
   */
  public static ListIndexesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListIndexesOutput.class);
  }

  /**
   * Convert an instance of ListIndexesOutput to an JSON string
   *
   * @return JSON string
   */
