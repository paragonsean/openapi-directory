...
public class GetViewOutput {
  ...
  private GetViewOutputView view;

  public GetViewOutput() {
  }

  public GetViewOutput tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GetViewOutput view(GetViewOutputView view) {
    this.view = view;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GetViewOutputView getView() {
    return view;
  }

  public void setView(GetViewOutputView view) {
    this.view = view;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetViewOutput getViewOutput = (GetViewOutput) o;
    return Objects.equals(this.tags, getViewOutput.tags) &&
        Objects.equals(this.view, getViewOutput.view);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, view);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetViewOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetViewOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetViewOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetViewOutput is not found in the empty JSON string", GetViewOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetViewOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetViewOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("View") != null && !jsonObj.get("View").isJsonNull()) {
        GetViewOutputView.validateJsonElement(jsonObj.get("View"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetViewOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetViewOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetViewOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetViewOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetViewOutput>() {
           @Override
           public void write(JsonWriter out, GetViewOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetViewOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetViewOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetViewOutput
   * @throws IOException if the JSON string is invalid with respect to GetViewOutput
   */
  public static GetViewOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetViewOutput.class);
  }

  /**
   * Convert an instance of GetViewOutput to an JSON string
   *
   * @return JSON string
   */
