...
public class DeleteIndexInput {
  public static final String SERIALIZED_NAME_ARN = "Arn";
  @SerializedName(SERIALIZED_NAME_ARN)
  private String arn;

  public DeleteIndexInput() {
  }

  public DeleteIndexInput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteIndexInput deleteIndexInput = (DeleteIndexInput) o;
    return Objects.equals(this.arn, deleteIndexInput.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteIndexInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteIndexInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteIndexInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteIndexInput is not found in the empty JSON string", DeleteIndexInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteIndexInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteIndexInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteIndexInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteIndexInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteIndexInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteIndexInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteIndexInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteIndexInput>() {
           @Override
           public void write(JsonWriter out, DeleteIndexInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteIndexInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteIndexInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteIndexInput
   * @throws IOException if the JSON string is invalid with respect to DeleteIndexInput
   */
  public static DeleteIndexInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteIndexInput.class);
  }

  /**
   * Convert an instance of DeleteIndexInput to an JSON string
   *
   * @return JSON string
   */
