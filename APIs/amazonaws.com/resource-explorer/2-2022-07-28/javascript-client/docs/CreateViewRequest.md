# AwsResourceExplorer.CreateViewRequest
...
**includedProperties** | [**[IncludedProperty]**](IncludedProperty.md) | &lt;p&gt;Specifies optional fields that you want included in search results from this view. It is a list of objects that each describe a field to include.&lt;/p&gt; &lt;p&gt;The default is an empty list, with no optional fields included in the results.&lt;/p&gt; | [optional] 
**tags** | **{String: String}** | Tag key and value pairs that are attached to the view. | [optional] 
