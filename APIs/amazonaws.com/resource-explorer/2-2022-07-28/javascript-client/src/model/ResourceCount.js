...
/**
 * The ResourceCount model module.
 * @module model/ResourceCount
 * @version 2022-07-28
 */
class ResourceCount {
    /**
     * Constructs a new <code>ResourceCount</code>.
     ...
     * @alias module:model/ResourceCount
     */
    constructor() { 
        
        ResourceCount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResourceCount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceCount} obj Optional instance to populate.
     * @return {module:model/ResourceCount} The populated <code>ResourceCount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceCount();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceCount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceCount</code>.
     */
    static validateJSON(data) {
        ...
        if (data['TotalResources']) { // data not null
          Number.validateJSON(data['TotalResources']);
        }
 ...
 */
ResourceCount.prototype['Complete'] = undefined;

/**
 * @member {Number} TotalResources
 */
ResourceCount.prototype['TotalResources'] = undefined;
