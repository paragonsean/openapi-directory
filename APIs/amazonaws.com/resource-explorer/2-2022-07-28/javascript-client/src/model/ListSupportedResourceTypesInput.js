...
/**
 * The ListSupportedResourceTypesInput model module.
 * @module model/ListSupportedResourceTypesInput
 * @version 2022-07-28
 */
class ListSupportedResourceTypesInput {
    /**
     * Constructs a new <code>ListSupportedResourceTypesInput</code>.
     * @alias module:model/ListSupportedResourceTypesInput
     */
    constructor() { 
        
        ListSupportedResourceTypesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSupportedResourceTypesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSupportedResourceTypesInput} obj Optional instance to populate.
     * @return {module:model/ListSupportedResourceTypesInput} The populated <code>ListSupportedResourceTypesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSupportedResourceTypesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSupportedResourceTypesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSupportedResourceTypesInput</code>.
     */
 ...
 */
ListSupportedResourceTypesInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListSupportedResourceTypesInput.prototype['NextToken'] = undefined;
...
export default ListSupportedResourceTypesInput;
