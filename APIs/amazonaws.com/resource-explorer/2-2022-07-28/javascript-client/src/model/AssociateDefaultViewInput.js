...
/**
 * The AssociateDefaultViewInput model module.
 * @module model/AssociateDefaultViewInput
 * @version 2022-07-28
 */
class AssociateDefaultViewInput {
    /**
     * Constructs a new <code>AssociateDefaultViewInput</code>.
     * @alias module:model/AssociateDefaultViewInput
     * @param viewArn {String} 
     */
    constructor(viewArn) { 
        
        AssociateDefaultViewInput.initialize(this, viewArn);
    }
    ...
    /**
     * Constructs a <code>AssociateDefaultViewInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateDefaultViewInput} obj Optional instance to populate.
     * @return {module:model/AssociateDefaultViewInput} The populated <code>AssociateDefaultViewInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateDefaultViewInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateDefaultViewInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateDefaultViewInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateDefaultViewInput.RequiredProperties) {
...
AssociateDefaultViewInput.RequiredProperties = ["ViewArn"];

/**
 * @member {String} ViewArn
 */
AssociateDefaultViewInput.prototype['ViewArn'] = undefined;
...
export default AssociateDefaultViewInput;
