...
import CreateViewInputFilters from './CreateViewInputFilters';

/**
 * The CreateViewInput model module.
 * @module model/CreateViewInput
 * @version 2022-07-28
 */
class CreateViewInput {
    /**
     * Constructs a new <code>CreateViewInput</code>.
     * @alias module:model/CreateViewInput
     * @param viewName {String} 
     */
    constructor(viewName) { 
        
        CreateViewInput.initialize(this, viewName);
    }
    ...
    /**
     * Constructs a <code>CreateViewInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateViewInput} obj Optional instance to populate.
     * @return {module:model/CreateViewInput} The populated <code>CreateViewInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateViewInput();

            if (data.hasOwnProperty('ClientToken')) {
                obj['ClientToken'] = ApiClient.convertToType(data['ClientToken'], 'String');
            }
            if (data.hasOwnProperty('Filters')) {
                obj['Filters'] = CreateViewInputFilters.constructFromObject(data['Filters']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateViewInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateViewInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateViewInput.RequiredProperties) {
        ...
        if (data['Filters']) { // data not null
          CreateViewInputFilters.validateJSON(data['Filters']);
        }
        ...
        // validate the optional field `ViewName`
        if (data['ViewName']) { // data not null
          String.validateJSON(data['ViewName']);
        }
...
CreateViewInput.RequiredProperties = ["ViewName"];

/**
 * @member {String} ClientToken
 */
CreateViewInput.prototype['ClientToken'] = undefined;

/**
 * @member {module:model/CreateViewInputFilters} Filters
 */
CreateViewInput.prototype['Filters'] = undefined;

/**
 * @member {Array} IncludedProperties
 */
CreateViewInput.prototype['IncludedProperties'] = undefined;

/**
 * @member {Object} Tags
 */
CreateViewInput.prototype['Tags'] = undefined;

/**
 * @member {String} ViewName
 */
CreateViewInput.prototype['ViewName'] = undefined;
...
export default CreateViewInput;
