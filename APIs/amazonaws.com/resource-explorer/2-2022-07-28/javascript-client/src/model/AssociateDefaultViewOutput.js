...
/**
 * The AssociateDefaultViewOutput model module.
 * @module model/AssociateDefaultViewOutput
 * @version 2022-07-28
 */
class AssociateDefaultViewOutput {
    /**
     * Constructs a new <code>AssociateDefaultViewOutput</code>.
     * @alias module:model/AssociateDefaultViewOutput
     */
    constructor() { 
        
        AssociateDefaultViewOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateDefaultViewOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateDefaultViewOutput} obj Optional instance to populate.
     * @return {module:model/AssociateDefaultViewOutput} The populated <code>AssociateDefaultViewOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateDefaultViewOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateDefaultViewOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateDefaultViewOutput</code>.
     */
 ...
 */
AssociateDefaultViewOutput.prototype['ViewArn'] = undefined;
...
export default AssociateDefaultViewOutput;
