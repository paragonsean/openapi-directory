...
/**
 * The DeleteViewInput model module.
 * @module model/DeleteViewInput
 * @version 2022-07-28
 */
class DeleteViewInput {
    /**
     * Constructs a new <code>DeleteViewInput</code>.
     * @alias module:model/DeleteViewInput
     * @param viewArn {String} 
     */
    constructor(viewArn) { 
        
        DeleteViewInput.initialize(this, viewArn);
    }
    ...
    /**
     * Constructs a <code>DeleteViewInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteViewInput} obj Optional instance to populate.
     * @return {module:model/DeleteViewInput} The populated <code>DeleteViewInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteViewInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteViewInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteViewInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteViewInput.RequiredProperties) {
...
DeleteViewInput.RequiredProperties = ["ViewArn"];

/**
 * @member {String} ViewArn
 */
DeleteViewInput.prototype['ViewArn'] = undefined;
...
export default DeleteViewInput;
