...
class UpdateViewRequest {
     ...
     * @param viewArn {String} The <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\">Amazon resource name (ARN)</a> of the view that you want to modify.
     */
    constructor(viewArn) { 
        
        UpdateViewRequest.initialize(this, viewArn);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateViewRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateViewRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateViewRequest.RequiredProperties) {
...
UpdateViewRequest.RequiredProperties = ["ViewArn"];

/**
 * @member {module:model/CreateViewRequestFilters} Filters
 */
UpdateViewRequest.prototype['Filters'] = undefined;
 ...
 */
UpdateViewRequest.prototype['IncludedProperties'] = undefined;
 ...
 */
UpdateViewRequest.prototype['ViewArn'] = undefined;
