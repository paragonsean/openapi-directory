...
/**
 * The ListViewsOutput model module.
 * @module model/ListViewsOutput
 * @version 2022-07-28
 */
class ListViewsOutput {
    /**
     * Constructs a new <code>ListViewsOutput</code>.
     * @alias module:model/ListViewsOutput
     */
    constructor() { 
        
        ListViewsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListViewsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListViewsOutput} obj Optional instance to populate.
     * @return {module:model/ListViewsOutput} The populated <code>ListViewsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListViewsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListViewsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListViewsOutput</code>.
     */
 ...
 */
ListViewsOutput.prototype['NextToken'] = undefined;

/**
 * @member {Array} Views
 */
ListViewsOutput.prototype['Views'] = undefined;
...
export default ListViewsOutput;
