...
/**
 * The BatchGetViewRequest model module.
 * @module model/BatchGetViewRequest
 * @version 2022-07-28
 */
class BatchGetViewRequest {
    /**
     * Constructs a new <code>BatchGetViewRequest</code>.
     * @alias module:model/BatchGetViewRequest
     */
    constructor() { 
        
        BatchGetViewRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetViewRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetViewRequest} obj Optional instance to populate.
     * @return {module:model/BatchGetViewRequest} The populated <code>BatchGetViewRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetViewRequest();

            if (data.hasOwnProperty('ViewArns')) {
                obj['ViewArns'] = ApiClient.convertToType(data['ViewArns'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetViewRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetViewRequest</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['ViewArns'])) {
            throw new Error("Expected the field `ViewArns` to be an array in the JSON data but got " + data['ViewArns']);
        }
 ...
 * @member {Array.<String>} ViewArns
 */
BatchGetViewRequest.prototype['ViewArns'] = undefined;
...
export default BatchGetViewRequest;
