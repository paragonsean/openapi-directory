...
class AssociateDefaultViewRequest {
    ...
    /**
     * Constructs a <code>AssociateDefaultViewRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateDefaultViewRequest} obj Optional instance to populate.
     * @return {module:model/AssociateDefaultViewRequest} The populated <code>AssociateDefaultViewRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateDefaultViewRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateDefaultViewRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateDefaultViewRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateDefaultViewRequest.RequiredProperties) {
...
AssociateDefaultViewRequest.RequiredProperties = ["ViewArn"];

/**
 * The <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\">Amazon resource name (ARN)</a> of the view to set as the default for the Amazon Web Services Region and Amazon Web Services account in which you call this operation. The specified view must already exist in the called Region.
 * @member {String} ViewArn
 */
AssociateDefaultViewRequest.prototype['ViewArn'] = undefined;
...
export default AssociateDefaultViewRequest;
