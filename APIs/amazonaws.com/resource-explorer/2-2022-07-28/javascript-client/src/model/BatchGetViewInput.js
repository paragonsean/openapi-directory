...
/**
 * The BatchGetViewInput model module.
 * @module model/BatchGetViewInput
 * @version 2022-07-28
 */
class BatchGetViewInput {
    /**
     * Constructs a new <code>BatchGetViewInput</code>.
     * @alias module:model/BatchGetViewInput
     */
    constructor() { 
        
        BatchGetViewInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetViewInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetViewInput} obj Optional instance to populate.
     * @return {module:model/BatchGetViewInput} The populated <code>BatchGetViewInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetViewInput();

            if (data.hasOwnProperty('ViewArns')) {
                obj['ViewArns'] = ApiClient.convertToType(data['ViewArns'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetViewInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetViewInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ViewArns`
        if (data['ViewArns']) { // data not null
          Array.validateJSON(data['ViewArns']);
        }
...
/**
 * @member {Array} ViewArns
 */
BatchGetViewInput.prototype['ViewArns'] = undefined;
...
export default BatchGetViewInput;
