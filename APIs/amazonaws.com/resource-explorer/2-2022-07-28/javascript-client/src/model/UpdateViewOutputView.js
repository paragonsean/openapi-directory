...
/**
 * The UpdateViewOutputView model module.
 * @module model/UpdateViewOutputView
 * @version 2022-07-28
 */
class UpdateViewOutputView {
    /**
     * Constructs a new <code>UpdateViewOutputView</code>.
     * @alias module:model/UpdateViewOutputView
     * @implements module:model/View
     */
    constructor() { 
        View.initialize(this);
        UpdateViewOutputView.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateViewOutputView</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateViewOutputView} obj Optional instance to populate.
     * @return {module:model/UpdateViewOutputView} The populated <code>UpdateViewOutputView</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateViewOutputView();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateViewOutputView</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateViewOutputView</code>.
     */
 ...
 */
UpdateViewOutputView.prototype['Filters'] = undefined;

/**
 * @member {Array} IncludedProperties
 */
UpdateViewOutputView.prototype['IncludedProperties'] = undefined;

/**
 * @member {Date} LastUpdatedAt
 */
UpdateViewOutputView.prototype['LastUpdatedAt'] = undefined;

/**
 * @member {String} Owner
 */
UpdateViewOutputView.prototype['Owner'] = undefined;

/**
 * @member {String} Scope
 */
UpdateViewOutputView.prototype['Scope'] = undefined;

/**
 * @member {String} ViewArn
 */
UpdateViewOutputView.prototype['ViewArn'] = undefined;
...
export default UpdateViewOutputView;
