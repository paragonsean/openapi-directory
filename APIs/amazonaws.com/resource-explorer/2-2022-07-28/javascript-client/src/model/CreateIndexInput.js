...
/**
 * The CreateIndexInput model module.
 * @module model/CreateIndexInput
 * @version 2022-07-28
 */
class CreateIndexInput {
    /**
     * Constructs a new <code>CreateIndexInput</code>.
     * @alias module:model/CreateIndexInput
     */
    constructor() { 
        
        CreateIndexInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateIndexInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIndexInput} obj Optional instance to populate.
     * @return {module:model/CreateIndexInput} The populated <code>CreateIndexInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIndexInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIndexInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIndexInput</code>.
     */
 ...
 */
CreateIndexInput.prototype['ClientToken'] = undefined;

/**
 * @member {Object} Tags
 */
CreateIndexInput.prototype['Tags'] = undefined;
...
export default CreateIndexInput;
