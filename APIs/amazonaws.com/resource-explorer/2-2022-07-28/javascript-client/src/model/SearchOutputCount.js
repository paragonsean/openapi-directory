...
/**
 * The SearchOutputCount model module.
 * @module model/SearchOutputCount
 * @version 2022-07-28
 */
class SearchOutputCount {
    /**
     * Constructs a new <code>SearchOutputCount</code>.
     * @alias module:model/SearchOutputCount
     * @implements module:model/ResourceCount
     */
    constructor() { 
        ResourceCount.initialize(this);
        SearchOutputCount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchOutputCount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchOutputCount} obj Optional instance to populate.
     * @return {module:model/SearchOutputCount} The populated <code>SearchOutputCount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchOutputCount();
            ResourceCount.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SearchOutputCount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchOutputCount</code>.
     */
 ...
 */
SearchOutputCount.prototype['Complete'] = undefined;

/**
 * @member {Number} TotalResources
 */
SearchOutputCount.prototype['TotalResources'] = undefined;


// Implement ResourceCount interface:
/**
 * @member {Boolean} Complete
 */
...
export default SearchOutputCount;
