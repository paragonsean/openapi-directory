...
/**
 * The GetViewInput model module.
 * @module model/GetViewInput
 * @version 2022-07-28
 */
class GetViewInput {
    /**
     * Constructs a new <code>GetViewInput</code>.
     * @alias module:model/GetViewInput
     * @param viewArn {String} 
     */
    constructor(viewArn) { 
        
        GetViewInput.initialize(this, viewArn);
    }
    ...
    /**
     * Constructs a <code>GetViewInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetViewInput} obj Optional instance to populate.
     * @return {module:model/GetViewInput} The populated <code>GetViewInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetViewInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetViewInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetViewInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetViewInput.RequiredProperties) {
...
GetViewInput.RequiredProperties = ["ViewArn"];

/**
 * @member {String} ViewArn
 */
GetViewInput.prototype['ViewArn'] = undefined;
