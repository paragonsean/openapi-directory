...
/**
 * The UpdateIndexTypeInput model module.
 * @module model/UpdateIndexTypeInput
 * @version 2022-07-28
 */
class UpdateIndexTypeInput {
    /**
     * Constructs a new <code>UpdateIndexTypeInput</code>.
     * @alias module:model/UpdateIndexTypeInput
     * @param arn {String} 
     * @param type {module:model/IndexType} 
     */
    constructor(arn, type) { 
        
        UpdateIndexTypeInput.initialize(this, arn, type);
    }
    ...
    /**
     * Constructs a <code>UpdateIndexTypeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIndexTypeInput} obj Optional instance to populate.
     * @return {module:model/UpdateIndexTypeInput} The populated <code>UpdateIndexTypeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIndexTypeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIndexTypeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIndexTypeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateIndexTypeInput.RequiredProperties) {
...
UpdateIndexTypeInput.RequiredProperties = ["Arn", "Type"];

/**
 * @member {String} Arn
 */
UpdateIndexTypeInput.prototype['Arn'] = undefined;

/**
 * @member {module:model/IndexType} Type
 */
UpdateIndexTypeInput.prototype['Type'] = undefined;
...
export default UpdateIndexTypeInput;
