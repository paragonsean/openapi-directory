...
/**
 * The DeleteViewRequest model module.
 * @module model/DeleteViewRequest
 * @version 2022-07-28
 */
class DeleteViewRequest {
    /**
     * Constructs a new <code>DeleteViewRequest</code>.
     * @alias module:model/DeleteViewRequest
     * @param viewArn {String} The <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\">Amazon resource name (ARN)</a> of the view that you want to delete.
     */
    constructor(viewArn) { 
        
        DeleteViewRequest.initialize(this, viewArn);
    }
    ...
    /**
     * Constructs a <code>DeleteViewRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteViewRequest} obj Optional instance to populate.
     * @return {module:model/DeleteViewRequest} The populated <code>DeleteViewRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteViewRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteViewRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteViewRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteViewRequest.RequiredProperties) {
...
DeleteViewRequest.RequiredProperties = ["ViewArn"];
 ...
 */
DeleteViewRequest.prototype['ViewArn'] = undefined;
...
export default DeleteViewRequest;
