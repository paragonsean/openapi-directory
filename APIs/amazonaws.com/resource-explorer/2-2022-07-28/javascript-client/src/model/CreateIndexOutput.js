...
/**
 * The CreateIndexOutput model module.
 * @module model/CreateIndexOutput
 * @version 2022-07-28
 */
class CreateIndexOutput {
    /**
     * Constructs a new <code>CreateIndexOutput</code>.
     * @alias module:model/CreateIndexOutput
     */
    constructor() { 
        
        CreateIndexOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateIndexOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIndexOutput} obj Optional instance to populate.
     * @return {module:model/CreateIndexOutput} The populated <code>CreateIndexOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIndexOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIndexOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIndexOutput</code>.
     */
 ...
 * @member {String} Arn
 */
CreateIndexOutput.prototype['Arn'] = undefined;

/**
 * @member {Date} CreatedAt
 */
CreateIndexOutput.prototype['CreatedAt'] = undefined;

/**
 * @member {module:model/IndexState} State
 */
CreateIndexOutput.prototype['State'] = undefined;
...
export default CreateIndexOutput;
