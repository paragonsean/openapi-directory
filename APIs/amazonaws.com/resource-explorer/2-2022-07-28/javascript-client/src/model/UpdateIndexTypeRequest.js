...
/**
 * The UpdateIndexTypeRequest model module.
 * @module model/UpdateIndexTypeRequest
 * @version 2022-07-28
 */
class UpdateIndexTypeRequest {
    /**
     * Constructs a new <code>UpdateIndexTypeRequest</code>.
     * @alias module:model/UpdateIndexTypeRequest
     * @param arn {String} The <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\">Amazon resource name (ARN)</a> of the index that you want to update.
     * @param type {module:model/UpdateIndexTypeRequest.TypeEnum} The type of the index. To understand the difference between <code>LOCAL</code> and <code>AGGREGATOR</code>, see <a href=\"https://docs.aws.amazon.com/resource-explorer/latest/userguide/manage-aggregator-region.html\">Turning on cross-Region search</a> in the <i>Amazon Web Services Resource Explorer User Guide</i>.
     */
    constructor(arn, type) { 
        
        UpdateIndexTypeRequest.initialize(this, arn, type);
    }
    ...
    /**
     * Constructs a <code>UpdateIndexTypeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIndexTypeRequest} obj Optional instance to populate.
     * @return {module:model/UpdateIndexTypeRequest} The populated <code>UpdateIndexTypeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIndexTypeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIndexTypeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIndexTypeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateIndexTypeRequest.RequiredProperties) {
...
UpdateIndexTypeRequest.RequiredProperties = ["Arn", "Type"];
 ...
 * @member {String} Arn
 */
UpdateIndexTypeRequest.prototype['Arn'] = undefined;
 ...
 * @member {module:model/UpdateIndexTypeRequest.TypeEnum} Type
 */
UpdateIndexTypeRequest.prototype['Type'] = undefined;
 ...
 * @readonly
 */
UpdateIndexTypeRequest['TypeEnum'] = {
...
export default UpdateIndexTypeRequest;
