...
import SearchOutputCount from './SearchOutputCount';

/**
 * The SearchOutput model module.
 * @module model/SearchOutput
 * @version 2022-07-28
 */
class SearchOutput {
    /**
     * Constructs a new <code>SearchOutput</code>.
     * @alias module:model/SearchOutput
     */
    constructor() { 
        
        SearchOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchOutput} obj Optional instance to populate.
     * @return {module:model/SearchOutput} The populated <code>SearchOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchOutput();

            if (data.hasOwnProperty('Count')) {
                obj['Count'] = SearchOutputCount.constructFromObject(data['Count']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Count`
        if (data['Count']) { // data not null
          SearchOutputCount.validateJSON(data['Count']);
        }
...
/**
 * @member {module:model/SearchOutputCount} Count
 */
SearchOutput.prototype['Count'] = undefined;

/**
 * @member {String} NextToken
 */
SearchOutput.prototype['NextToken'] = undefined;

/**
 * @member {Array} Resources
 */
SearchOutput.prototype['Resources'] = undefined;

/**
 * @member {String} ViewArn
 */
SearchOutput.prototype['ViewArn'] = undefined;
