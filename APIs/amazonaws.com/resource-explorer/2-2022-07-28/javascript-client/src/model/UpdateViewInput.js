...
/**
 * The UpdateViewInput model module.
 * @module model/UpdateViewInput
 * @version 2022-07-28
 */
class UpdateViewInput {
    /**
     * Constructs a new <code>UpdateViewInput</code>.
     * @alias module:model/UpdateViewInput
     * @param viewArn {String} 
     */
    constructor(viewArn) { 
        
        UpdateViewInput.initialize(this, viewArn);
    }
    ...
    /**
     * Constructs a <code>UpdateViewInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateViewInput} obj Optional instance to populate.
     * @return {module:model/UpdateViewInput} The populated <code>UpdateViewInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateViewInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateViewInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateViewInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateViewInput.RequiredProperties) {
...
UpdateViewInput.RequiredProperties = ["ViewArn"];

/**
 * @member {module:model/CreateViewInputFilters} Filters
 */
UpdateViewInput.prototype['Filters'] = undefined;

/**
 * @member {Array} IncludedProperties
 */
UpdateViewInput.prototype['IncludedProperties'] = undefined;

/**
 * @member {String} ViewArn
 */
UpdateViewInput.prototype['ViewArn'] = undefined;
...
export default UpdateViewInput;
