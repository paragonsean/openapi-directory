...
/**
 * The GetDefaultViewOutput model module.
 * @module model/GetDefaultViewOutput
 * @version 2022-07-28
 */
class GetDefaultViewOutput {
    /**
     * Constructs a new <code>GetDefaultViewOutput</code>.
     * @alias module:model/GetDefaultViewOutput
     */
    constructor() { 
        
        GetDefaultViewOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDefaultViewOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDefaultViewOutput} obj Optional instance to populate.
     * @return {module:model/GetDefaultViewOutput} The populated <code>GetDefaultViewOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDefaultViewOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDefaultViewOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDefaultViewOutput</code>.
     */
 ...
 */
GetDefaultViewOutput.prototype['ViewArn'] = undefined;
...
export default GetDefaultViewOutput;
