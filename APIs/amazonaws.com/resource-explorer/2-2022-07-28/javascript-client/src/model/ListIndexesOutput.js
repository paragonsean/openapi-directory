...
/**
 * The ListIndexesOutput model module.
 * @module model/ListIndexesOutput
 * @version 2022-07-28
 */
class ListIndexesOutput {
    /**
     * Constructs a new <code>ListIndexesOutput</code>.
     * @alias module:model/ListIndexesOutput
     */
    constructor() { 
        
        ListIndexesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListIndexesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListIndexesOutput} obj Optional instance to populate.
     * @return {module:model/ListIndexesOutput} The populated <code>ListIndexesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListIndexesOutput();

            if (data.hasOwnProperty('Indexes')) {
                obj['Indexes'] = ApiClient.convertToType(data['Indexes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListIndexesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListIndexesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Indexes`
        if (data['Indexes']) { // data not null
          Array.validateJSON(data['Indexes']);
        }
 ...
 */
ListIndexesOutput.prototype['Indexes'] = undefined;

/**
 * @member {String} NextToken
 */
ListIndexesOutput.prototype['NextToken'] = undefined;
...
export default ListIndexesOutput;
