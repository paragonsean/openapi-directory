...
import UpdateViewOutputView from './UpdateViewOutputView';

/**
 * The UpdateViewOutput model module.
 * @module model/UpdateViewOutput
 * @version 2022-07-28
 */
class UpdateViewOutput {
    /**
     * Constructs a new <code>UpdateViewOutput</code>.
     * @alias module:model/UpdateViewOutput
     */
    constructor() { 
        
        UpdateViewOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateViewOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateViewOutput} obj Optional instance to populate.
     * @return {module:model/UpdateViewOutput} The populated <code>UpdateViewOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateViewOutput();

            if (data.hasOwnProperty('View')) {
                obj['View'] = UpdateViewOutputView.constructFromObject(data['View']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateViewOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateViewOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `View`
        if (data['View']) { // data not null
          UpdateViewOutputView.validateJSON(data['View']);
        }
...
/**
 * @member {module:model/UpdateViewOutputView} View
 */
UpdateViewOutput.prototype['View'] = undefined;
...
export default UpdateViewOutput;
