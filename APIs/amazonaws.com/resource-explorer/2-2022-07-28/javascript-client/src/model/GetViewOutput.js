...
import GetViewOutputView from './GetViewOutputView';

/**
 * The GetViewOutput model module.
 * @module model/GetViewOutput
 * @version 2022-07-28
 */
class GetViewOutput {
    /**
     * Constructs a new <code>GetViewOutput</code>.
     * @alias module:model/GetViewOutput
     */
    constructor() { 
        
        GetViewOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetViewOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetViewOutput} obj Optional instance to populate.
     * @return {module:model/GetViewOutput} The populated <code>GetViewOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetViewOutput();

            if (data.hasOwnProperty('Tags')) {
                obj['Tags'] = ApiClient.convertToType(data['Tags'], Object);
            }
            if (data.hasOwnProperty('View')) {
                obj['View'] = GetViewOutputView.constructFromObject(data['View']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetViewOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetViewOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['View']) { // data not null
          GetViewOutputView.validateJSON(data['View']);
        }
 ...
 * @member {Object} Tags
 */
GetViewOutput.prototype['Tags'] = undefined;

/**
 * @member {module:model/GetViewOutputView} View
 */
GetViewOutput.prototype['View'] = undefined;
