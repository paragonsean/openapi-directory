...
/**
 * The ListViewsRequest model module.
 * @module model/ListViewsRequest
 * @version 2022-07-28
 */
class ListViewsRequest {
    /**
     * Constructs a new <code>ListViewsRequest</code>.
     * @alias module:model/ListViewsRequest
     */
    constructor() { 
        
        ListViewsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListViewsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListViewsRequest} obj Optional instance to populate.
     * @return {module:model/ListViewsRequest} The populated <code>ListViewsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListViewsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListViewsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListViewsRequest</code>.
     */
 ...
 */
ListViewsRequest.prototype['MaxResults'] = undefined;
 ...
 */
ListViewsRequest.prototype['NextToken'] = undefined;
...
export default ListViewsRequest;
