...
/**
 * The DeleteViewOutput model module.
 * @module model/DeleteViewOutput
 * @version 2022-07-28
 */
class DeleteViewOutput {
    /**
     * Constructs a new <code>DeleteViewOutput</code>.
     * @alias module:model/DeleteViewOutput
     */
    constructor() { 
        
        DeleteViewOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteViewOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteViewOutput} obj Optional instance to populate.
     * @return {module:model/DeleteViewOutput} The populated <code>DeleteViewOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteViewOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteViewOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteViewOutput</code>.
     */
 ...
 */
DeleteViewOutput.prototype['ViewArn'] = undefined;
...
export default DeleteViewOutput;
