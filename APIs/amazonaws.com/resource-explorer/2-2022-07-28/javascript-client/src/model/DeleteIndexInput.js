...
/**
 * The DeleteIndexInput model module.
 * @module model/DeleteIndexInput
 * @version 2022-07-28
 */
class DeleteIndexInput {
    /**
     * Constructs a new <code>DeleteIndexInput</code>.
     * @alias module:model/DeleteIndexInput
     * @param arn {String} 
     */
    constructor(arn) { 
        
        DeleteIndexInput.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DeleteIndexInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteIndexInput} obj Optional instance to populate.
     * @return {module:model/DeleteIndexInput} The populated <code>DeleteIndexInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteIndexInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteIndexInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteIndexInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteIndexInput.RequiredProperties) {
...
DeleteIndexInput.RequiredProperties = ["Arn"];

/**
 * @member {String} Arn
 */
DeleteIndexInput.prototype['Arn'] = undefined;
...
export default DeleteIndexInput;
