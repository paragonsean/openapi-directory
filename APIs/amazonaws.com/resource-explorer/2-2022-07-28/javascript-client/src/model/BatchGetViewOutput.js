...
/**
 * The BatchGetViewOutput model module.
 * @module model/BatchGetViewOutput
 * @version 2022-07-28
 */
class BatchGetViewOutput {
    /**
     * Constructs a new <code>BatchGetViewOutput</code>.
     * @alias module:model/BatchGetViewOutput
     */
    constructor() { 
        
        BatchGetViewOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetViewOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetViewOutput} obj Optional instance to populate.
     * @return {module:model/BatchGetViewOutput} The populated <code>BatchGetViewOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetViewOutput();

            if (data.hasOwnProperty('Errors')) {
                obj['Errors'] = ApiClient.convertToType(data['Errors'], Array);
            }
            if (data.hasOwnProperty('Views')) {
                obj['Views'] = ApiClient.convertToType(data['Views'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetViewOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetViewOutput</code>.
     */
 ...
 * @member {Array} Errors
 */
BatchGetViewOutput.prototype['Errors'] = undefined;

/**
 * @member {Array} Views
 */
BatchGetViewOutput.prototype['Views'] = undefined;
...
export default BatchGetViewOutput;
