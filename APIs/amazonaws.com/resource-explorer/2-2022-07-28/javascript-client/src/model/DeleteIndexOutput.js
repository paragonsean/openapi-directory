...
/**
 * The DeleteIndexOutput model module.
 * @module model/DeleteIndexOutput
 * @version 2022-07-28
 */
class DeleteIndexOutput {
    /**
     * Constructs a new <code>DeleteIndexOutput</code>.
     * @alias module:model/DeleteIndexOutput
     */
    constructor() { 
        
        DeleteIndexOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteIndexOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteIndexOutput} obj Optional instance to populate.
     * @return {module:model/DeleteIndexOutput} The populated <code>DeleteIndexOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteIndexOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteIndexOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteIndexOutput</code>.
     */
 ...
 * @member {String} Arn
 */
DeleteIndexOutput.prototype['Arn'] = undefined;

/**
 * @member {Date} LastUpdatedAt
 */
DeleteIndexOutput.prototype['LastUpdatedAt'] = undefined;

/**
 * @member {module:model/IndexState} State
 */
DeleteIndexOutput.prototype['State'] = undefined;
...
export default DeleteIndexOutput;
