...
/**
 * The ListViewsInput model module.
 * @module model/ListViewsInput
 * @version 2022-07-28
 */
class ListViewsInput {
    /**
     * Constructs a new <code>ListViewsInput</code>.
     * @alias module:model/ListViewsInput
     */
    constructor() { 
        
        ListViewsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListViewsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListViewsInput} obj Optional instance to populate.
     * @return {module:model/ListViewsInput} The populated <code>ListViewsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListViewsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListViewsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListViewsInput</code>.
     */
 ...
 */
ListViewsInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListViewsInput.prototype['NextToken'] = undefined;
