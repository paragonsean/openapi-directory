...
/**
 * The CreateViewRequestFilters model module.
 * @module model/CreateViewRequestFilters
 * @version 2022-07-28
 */
class CreateViewRequestFilters {
    /**
     * Constructs a new <code>CreateViewRequestFilters</code>.
     * A search filter defines which resources can be part of a search query result set.
     * @alias module:model/CreateViewRequestFilters
     */
    constructor() { 
        
        CreateViewRequestFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateViewRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateViewRequestFilters} obj Optional instance to populate.
     * @return {module:model/CreateViewRequestFilters} The populated <code>CreateViewRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateViewRequestFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateViewRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateViewRequestFilters</code>.
     */
 ...
 */
CreateViewRequestFilters.prototype['FilterString'] = undefined;
...
export default CreateViewRequestFilters;
