...
/**
 * The ListSupportedResourceTypesOutput model module.
 * @module model/ListSupportedResourceTypesOutput
 * @version 2022-07-28
 */
class ListSupportedResourceTypesOutput {
    /**
     * Constructs a new <code>ListSupportedResourceTypesOutput</code>.
     * @alias module:model/ListSupportedResourceTypesOutput
     */
    constructor() { 
        
        ListSupportedResourceTypesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSupportedResourceTypesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSupportedResourceTypesOutput} obj Optional instance to populate.
     * @return {module:model/ListSupportedResourceTypesOutput} The populated <code>ListSupportedResourceTypesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSupportedResourceTypesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSupportedResourceTypesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSupportedResourceTypesOutput</code>.
     */
 ...
 */
ListSupportedResourceTypesOutput.prototype['NextToken'] = undefined;

/**
 * @member {Array} ResourceTypes
 */
ListSupportedResourceTypesOutput.prototype['ResourceTypes'] = undefined;
...
export default ListSupportedResourceTypesOutput;
