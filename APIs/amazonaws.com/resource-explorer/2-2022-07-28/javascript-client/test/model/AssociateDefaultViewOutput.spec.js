...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.AssociateDefaultViewOutput();
  });
  ...
  describe('AssociateDefaultViewOutput', function() {
    it('should create an instance of AssociateDefaultViewOutput', function() {
      // uncomment below and update the code to test AssociateDefaultViewOutput
      //var instance = new AwsResourceExplorer.AssociateDefaultViewOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.AssociateDefaultViewOutput);
    });

    it('should have the property viewArn (base name: "ViewArn")', function() {
      // uncomment below and update the code to test the property viewArn
      //var instance = new AwsResourceExplorer.AssociateDefaultViewOutput();
