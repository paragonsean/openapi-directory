...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListSupportedResourceTypesRequest();
  });
  ...
  describe('ListSupportedResourceTypesRequest', function() {
    it('should create an instance of ListSupportedResourceTypesRequest', function() {
      // uncomment below and update the code to test ListSupportedResourceTypesRequest
      //var instance = new AwsResourceExplorer.ListSupportedResourceTypesRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.ListSupportedResourceTypesRequest);
    });
