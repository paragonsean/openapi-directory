...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ResourceCount();
  });
  ...
  describe('ResourceCount', function() {
    it('should create an instance of ResourceCount', function() {
      // uncomment below and update the code to test ResourceCount
      //var instance = new AwsResourceExplorer.ResourceCount();
      //expect(instance).to.be.a(AwsResourceExplorer.ResourceCount);
    });
