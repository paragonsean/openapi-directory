...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new AwsResourceExplorer.TagResourceInput();
      //expect(instance).to.be.a(AwsResourceExplorer.TagResourceInput);
    });
