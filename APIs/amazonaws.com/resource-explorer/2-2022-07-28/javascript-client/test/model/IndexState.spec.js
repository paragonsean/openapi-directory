...
(function(root, factory) {
  ...
  describe('IndexState', function() {
    it('should create an instance of IndexState', function() {
      // uncomment below and update the code to test IndexState
      //var instance = new AwsResourceExplorer.IndexState();
      //expect(instance).to.be.a(AwsResourceExplorer.IndexState);
    });
