...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.GetViewOutput();
  });
  ...
  describe('GetViewOutput', function() {
    it('should create an instance of GetViewOutput', function() {
      // uncomment below and update the code to test GetViewOutput
      //var instance = new AwsResourceExplorer.GetViewOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.GetViewOutput);
    });
