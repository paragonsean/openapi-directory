...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.UpdateViewOutput();
  });
  ...
  describe('UpdateViewOutput', function() {
    it('should create an instance of UpdateViewOutput', function() {
      // uncomment below and update the code to test UpdateViewOutput
      //var instance = new AwsResourceExplorer.UpdateViewOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.UpdateViewOutput);
    });
