...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListSupportedResourceTypesInput();
  });
  ...
  describe('ListSupportedResourceTypesInput', function() {
    it('should create an instance of ListSupportedResourceTypesInput', function() {
      // uncomment below and update the code to test ListSupportedResourceTypesInput
      //var instance = new AwsResourceExplorer.ListSupportedResourceTypesInput();
      //expect(instance).to.be.a(AwsResourceExplorer.ListSupportedResourceTypesInput);
    });
