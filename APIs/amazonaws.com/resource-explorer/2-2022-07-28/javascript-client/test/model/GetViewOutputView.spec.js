...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.GetViewOutputView();
  });
  ...
  describe('GetViewOutputView', function() {
    it('should create an instance of GetViewOutputView', function() {
      // uncomment below and update the code to test GetViewOutputView
      //var instance = new AwsResourceExplorer.GetViewOutputView();
      //expect(instance).to.be.a(AwsResourceExplorer.GetViewOutputView);
    });
