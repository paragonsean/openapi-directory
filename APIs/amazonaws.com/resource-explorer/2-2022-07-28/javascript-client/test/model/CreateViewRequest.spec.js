...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateViewRequest();
  });
  ...
  describe('CreateViewRequest', function() {
    it('should create an instance of CreateViewRequest', function() {
      // uncomment below and update the code to test CreateViewRequest
      //var instance = new AwsResourceExplorer.CreateViewRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateViewRequest);
    });
    ...
    it('should have the property includedProperties (base name: "IncludedProperties")', function() {
      // uncomment below and update the code to test the property includedProperties
      //var instance = new AwsResourceExplorer.CreateViewRequest();
      //expect(instance).to.be();
    });
