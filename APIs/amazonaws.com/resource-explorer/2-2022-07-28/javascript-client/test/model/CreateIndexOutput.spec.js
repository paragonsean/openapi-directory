...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateIndexOutput();
  });
  ...
  describe('CreateIndexOutput', function() {
    it('should create an instance of CreateIndexOutput', function() {
      // uncomment below and update the code to test CreateIndexOutput
      //var instance = new AwsResourceExplorer.CreateIndexOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateIndexOutput);
    });
