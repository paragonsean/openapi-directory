...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateViewRequestFilters();
  });
  ...
  describe('CreateViewRequestFilters', function() {
    it('should create an instance of CreateViewRequestFilters', function() {
      // uncomment below and update the code to test CreateViewRequestFilters
      //var instance = new AwsResourceExplorer.CreateViewRequestFilters();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateViewRequestFilters);
    });

    it('should have the property filterString (base name: "FilterString")', function() {
      // uncomment below and update the code to test the property filterString
      //var instance = new AwsResourceExplorer.CreateViewRequestFilters();
