...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.SearchInput();
  });
  ...
  describe('SearchInput', function() {
    it('should create an instance of SearchInput', function() {
      // uncomment below and update the code to test SearchInput
      //var instance = new AwsResourceExplorer.SearchInput();
      //expect(instance).to.be.a(AwsResourceExplorer.SearchInput);
    });
