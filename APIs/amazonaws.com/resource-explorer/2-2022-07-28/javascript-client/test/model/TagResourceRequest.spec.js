...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsResourceExplorer.TagResourceRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.TagResourceRequest);
    });
