...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.UpdateViewInput();
  });
  ...
  describe('UpdateViewInput', function() {
    it('should create an instance of UpdateViewInput', function() {
      // uncomment below and update the code to test UpdateViewInput
      //var instance = new AwsResourceExplorer.UpdateViewInput();
      //expect(instance).to.be.a(AwsResourceExplorer.UpdateViewInput);
    });
