...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.SearchOutput();
  });
  ...
  describe('SearchOutput', function() {
    it('should create an instance of SearchOutput', function() {
      // uncomment below and update the code to test SearchOutput
      //var instance = new AwsResourceExplorer.SearchOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.SearchOutput);
    });
