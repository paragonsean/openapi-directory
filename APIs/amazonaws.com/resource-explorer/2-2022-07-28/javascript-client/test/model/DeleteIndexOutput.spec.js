...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.DeleteIndexOutput();
  });
  ...
  describe('DeleteIndexOutput', function() {
    it('should create an instance of DeleteIndexOutput', function() {
      // uncomment below and update the code to test DeleteIndexOutput
      //var instance = new AwsResourceExplorer.DeleteIndexOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.DeleteIndexOutput);
    });
