...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ViewFilters();
  });
  ...
  describe('ViewFilters', function() {
    it('should create an instance of ViewFilters', function() {
      // uncomment below and update the code to test ViewFilters
      //var instance = new AwsResourceExplorer.ViewFilters();
      //expect(instance).to.be.a(AwsResourceExplorer.ViewFilters);
    });
