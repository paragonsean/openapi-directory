...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.AssociateDefaultViewRequest();
  });
  ...
  describe('AssociateDefaultViewRequest', function() {
    it('should create an instance of AssociateDefaultViewRequest', function() {
      // uncomment below and update the code to test AssociateDefaultViewRequest
      //var instance = new AwsResourceExplorer.AssociateDefaultViewRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.AssociateDefaultViewRequest);
    });
