...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.UpdateIndexTypeInput();
  });
  ...
  describe('UpdateIndexTypeInput', function() {
    it('should create an instance of UpdateIndexTypeInput', function() {
      // uncomment below and update the code to test UpdateIndexTypeInput
      //var instance = new AwsResourceExplorer.UpdateIndexTypeInput();
      //expect(instance).to.be.a(AwsResourceExplorer.UpdateIndexTypeInput);
    });
