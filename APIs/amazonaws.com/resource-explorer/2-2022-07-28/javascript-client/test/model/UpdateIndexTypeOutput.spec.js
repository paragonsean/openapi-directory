...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.UpdateIndexTypeOutput();
  });
  ...
  describe('UpdateIndexTypeOutput', function() {
    it('should create an instance of UpdateIndexTypeOutput', function() {
      // uncomment below and update the code to test UpdateIndexTypeOutput
      //var instance = new AwsResourceExplorer.UpdateIndexTypeOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.UpdateIndexTypeOutput);
    });
