...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.UpdateViewOutputView();
  });
  ...
  describe('UpdateViewOutputView', function() {
    it('should create an instance of UpdateViewOutputView', function() {
      // uncomment below and update the code to test UpdateViewOutputView
      //var instance = new AwsResourceExplorer.UpdateViewOutputView();
      //expect(instance).to.be.a(AwsResourceExplorer.UpdateViewOutputView);
    });
