...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.BatchGetViewRequest();
  });
  ...
  describe('BatchGetViewRequest', function() {
    it('should create an instance of BatchGetViewRequest', function() {
      // uncomment below and update the code to test BatchGetViewRequest
      //var instance = new AwsResourceExplorer.BatchGetViewRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.BatchGetViewRequest);
    });
