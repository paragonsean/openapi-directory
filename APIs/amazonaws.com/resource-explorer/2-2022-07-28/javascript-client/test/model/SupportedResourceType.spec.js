...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.SupportedResourceType();
  });
  ...
  describe('SupportedResourceType', function() {
    it('should create an instance of SupportedResourceType', function() {
      // uncomment below and update the code to test SupportedResourceType
      //var instance = new AwsResourceExplorer.SupportedResourceType();
      //expect(instance).to.be.a(AwsResourceExplorer.SupportedResourceType);
    });
