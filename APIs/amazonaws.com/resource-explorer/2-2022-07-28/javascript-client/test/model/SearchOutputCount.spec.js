...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.SearchOutputCount();
  });
  ...
  describe('SearchOutputCount', function() {
    it('should create an instance of SearchOutputCount', function() {
      // uncomment below and update the code to test SearchOutputCount
      //var instance = new AwsResourceExplorer.SearchOutputCount();
      //expect(instance).to.be.a(AwsResourceExplorer.SearchOutputCount);
    });
