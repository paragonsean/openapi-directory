...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListIndexesRequest();
  });
  ...
  describe('ListIndexesRequest', function() {
    it('should create an instance of ListIndexesRequest', function() {
      // uncomment below and update the code to test ListIndexesRequest
      //var instance = new AwsResourceExplorer.ListIndexesRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.ListIndexesRequest);
    });
