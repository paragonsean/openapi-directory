...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.GetViewInput();
  });
  ...
  describe('GetViewInput', function() {
    it('should create an instance of GetViewInput', function() {
      // uncomment below and update the code to test GetViewInput
      //var instance = new AwsResourceExplorer.GetViewInput();
      //expect(instance).to.be.a(AwsResourceExplorer.GetViewInput);
    });
