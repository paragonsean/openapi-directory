...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.GetViewRequest();
  });
  ...
  describe('GetViewRequest', function() {
    it('should create an instance of GetViewRequest', function() {
      // uncomment below and update the code to test GetViewRequest
      //var instance = new AwsResourceExplorer.GetViewRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.GetViewRequest);
    });
