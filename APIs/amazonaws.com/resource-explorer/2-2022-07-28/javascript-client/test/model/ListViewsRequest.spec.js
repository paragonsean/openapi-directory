...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListViewsRequest();
  });
  ...
  describe('ListViewsRequest', function() {
    it('should create an instance of ListViewsRequest', function() {
      // uncomment below and update the code to test ListViewsRequest
      //var instance = new AwsResourceExplorer.ListViewsRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.ListViewsRequest);
    });
