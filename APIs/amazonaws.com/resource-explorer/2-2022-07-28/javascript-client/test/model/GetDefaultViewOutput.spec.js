...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.GetDefaultViewOutput();
  });
  ...
  describe('GetDefaultViewOutput', function() {
    it('should create an instance of GetDefaultViewOutput', function() {
      // uncomment below and update the code to test GetDefaultViewOutput
      //var instance = new AwsResourceExplorer.GetDefaultViewOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.GetDefaultViewOutput);
    });
