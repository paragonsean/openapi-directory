...
(function(root, factory) {
  ...
  describe('IndexType', function() {
    it('should create an instance of IndexType', function() {
      // uncomment below and update the code to test IndexType
      //var instance = new AwsResourceExplorer.IndexType();
      //expect(instance).to.be.a(AwsResourceExplorer.IndexType);
    });
