...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateViewOutputView();
  });
  ...
  describe('CreateViewOutputView', function() {
    it('should create an instance of CreateViewOutputView', function() {
      // uncomment below and update the code to test CreateViewOutputView
      //var instance = new AwsResourceExplorer.CreateViewOutputView();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateViewOutputView);
    });
