...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListIndexesOutput();
  });
  ...
  describe('ListIndexesOutput', function() {
    it('should create an instance of ListIndexesOutput', function() {
      // uncomment below and update the code to test ListIndexesOutput
      //var instance = new AwsResourceExplorer.ListIndexesOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.ListIndexesOutput);
    });
