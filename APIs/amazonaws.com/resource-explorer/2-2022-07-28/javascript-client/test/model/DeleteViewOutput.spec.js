...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.DeleteViewOutput();
  });
  ...
  describe('DeleteViewOutput', function() {
    it('should create an instance of DeleteViewOutput', function() {
      // uncomment below and update the code to test DeleteViewOutput
      //var instance = new AwsResourceExplorer.DeleteViewOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.DeleteViewOutput);
    });
