...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.DeleteIndexInput();
  });
  ...
  describe('DeleteIndexInput', function() {
    it('should create an instance of DeleteIndexInput', function() {
      // uncomment below and update the code to test DeleteIndexInput
      //var instance = new AwsResourceExplorer.DeleteIndexInput();
      //expect(instance).to.be.a(AwsResourceExplorer.DeleteIndexInput);
    });
