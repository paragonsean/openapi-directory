...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateViewInputFilters();
  });
  ...
  describe('CreateViewInputFilters', function() {
    it('should create an instance of CreateViewInputFilters', function() {
      // uncomment below and update the code to test CreateViewInputFilters
      //var instance = new AwsResourceExplorer.CreateViewInputFilters();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateViewInputFilters);
    });
