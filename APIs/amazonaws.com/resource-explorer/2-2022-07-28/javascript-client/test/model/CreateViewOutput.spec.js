...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateViewOutput();
  });
  ...
  describe('CreateViewOutput', function() {
    it('should create an instance of CreateViewOutput', function() {
      // uncomment below and update the code to test CreateViewOutput
      //var instance = new AwsResourceExplorer.CreateViewOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateViewOutput);
    });
