...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.DeleteViewInput();
  });
  ...
  describe('DeleteViewInput', function() {
    it('should create an instance of DeleteViewInput', function() {
      // uncomment below and update the code to test DeleteViewInput
      //var instance = new AwsResourceExplorer.DeleteViewInput();
      //expect(instance).to.be.a(AwsResourceExplorer.DeleteViewInput);
    });
