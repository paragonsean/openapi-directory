...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.DeleteIndexRequest();
  });
  ...
  describe('DeleteIndexRequest', function() {
    it('should create an instance of DeleteIndexRequest', function() {
      ...
      //var instance = new AwsResourceExplorer.DeleteIndexRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.DeleteIndexRequest);
    });
