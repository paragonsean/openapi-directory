...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListTagsForResourceOutput();
  });
  ...
  describe('ListTagsForResourceOutput', function() {
    it('should create an instance of ListTagsForResourceOutput', function() {
      ...
      //var instance = new AwsResourceExplorer.ListTagsForResourceOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.ListTagsForResourceOutput);
    });
