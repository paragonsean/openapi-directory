...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.AssociateDefaultViewInput();
  });
  ...
  describe('AssociateDefaultViewInput', function() {
    it('should create an instance of AssociateDefaultViewInput', function() {
      // uncomment below and update the code to test AssociateDefaultViewInput
      //var instance = new AwsResourceExplorer.AssociateDefaultViewInput();
      //expect(instance).to.be.a(AwsResourceExplorer.AssociateDefaultViewInput);
    });
