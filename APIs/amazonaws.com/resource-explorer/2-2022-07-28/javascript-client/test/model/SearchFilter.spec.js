...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.SearchFilter();
  });
  ...
  describe('SearchFilter', function() {
    it('should create an instance of SearchFilter', function() {
      ...
      //var instance = new AwsResourceExplorer.SearchFilter();
      //expect(instance).to.be.a(AwsResourceExplorer.SearchFilter);
    });
