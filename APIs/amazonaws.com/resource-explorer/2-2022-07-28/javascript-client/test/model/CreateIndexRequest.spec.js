...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateIndexRequest();
  });
  ...
  describe('CreateIndexRequest', function() {
    it('should create an instance of CreateIndexRequest', function() {
      ...
      //var instance = new AwsResourceExplorer.CreateIndexRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateIndexRequest);
    });
