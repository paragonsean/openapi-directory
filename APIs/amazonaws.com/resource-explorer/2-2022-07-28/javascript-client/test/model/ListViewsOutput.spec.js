...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListViewsOutput();
  });
  ...
  describe('ListViewsOutput', function() {
    it('should create an instance of ListViewsOutput', function() {
      // uncomment below and update the code to test ListViewsOutput
      //var instance = new AwsResourceExplorer.ListViewsOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.ListViewsOutput);
    });
