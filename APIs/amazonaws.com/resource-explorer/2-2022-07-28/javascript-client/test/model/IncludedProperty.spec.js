...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.IncludedProperty();
  });
  ...
  describe('IncludedProperty', function() {
    it('should create an instance of IncludedProperty', function() {
      // uncomment below and update the code to test IncludedProperty
      //var instance = new AwsResourceExplorer.IncludedProperty();
      //expect(instance).to.be.a(AwsResourceExplorer.IncludedProperty);
    });
