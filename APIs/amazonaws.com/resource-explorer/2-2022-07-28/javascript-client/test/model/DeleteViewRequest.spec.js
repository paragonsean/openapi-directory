...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.DeleteViewRequest();
  });
  ...
  describe('DeleteViewRequest', function() {
    it('should create an instance of DeleteViewRequest', function() {
      // uncomment below and update the code to test DeleteViewRequest
      //var instance = new AwsResourceExplorer.DeleteViewRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.DeleteViewRequest);
    });
