...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateIndexInput();
  });
  ...
  describe('CreateIndexInput', function() {
    it('should create an instance of CreateIndexInput', function() {
      // uncomment below and update the code to test CreateIndexInput
      //var instance = new AwsResourceExplorer.CreateIndexInput();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateIndexInput);
    });
