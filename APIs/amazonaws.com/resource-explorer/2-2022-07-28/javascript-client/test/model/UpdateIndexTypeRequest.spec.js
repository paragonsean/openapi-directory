...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.UpdateIndexTypeRequest();
  });
  ...
  describe('UpdateIndexTypeRequest', function() {
    it('should create an instance of UpdateIndexTypeRequest', function() {
      // uncomment below and update the code to test UpdateIndexTypeRequest
      //var instance = new AwsResourceExplorer.UpdateIndexTypeRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.UpdateIndexTypeRequest);
    });
