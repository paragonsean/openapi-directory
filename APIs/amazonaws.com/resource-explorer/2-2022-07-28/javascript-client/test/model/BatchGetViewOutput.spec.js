...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.BatchGetViewOutput();
  });
  ...
  describe('BatchGetViewOutput', function() {
    it('should create an instance of BatchGetViewOutput', function() {
      // uncomment below and update the code to test BatchGetViewOutput
      //var instance = new AwsResourceExplorer.BatchGetViewOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.BatchGetViewOutput);
    });
