...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.SearchRequest();
  });
  ...
  describe('SearchRequest', function() {
    it('should create an instance of SearchRequest', function() {
      ...
      //var instance = new AwsResourceExplorer.SearchRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.SearchRequest);
    });
