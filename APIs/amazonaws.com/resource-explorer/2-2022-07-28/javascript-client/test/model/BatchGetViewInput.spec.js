...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.BatchGetViewInput();
  });
  ...
  describe('BatchGetViewInput', function() {
    it('should create an instance of BatchGetViewInput', function() {
      // uncomment below and update the code to test BatchGetViewInput
      //var instance = new AwsResourceExplorer.BatchGetViewInput();
      //expect(instance).to.be.a(AwsResourceExplorer.BatchGetViewInput);
    });

    it('should have the property viewArns (base name: "ViewArns")', function() {
      // uncomment below and update the code to test the property viewArns
      //var instance = new AwsResourceExplorer.BatchGetViewInput();
