...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListViewsInput();
  });
  ...
  describe('ListViewsInput', function() {
    it('should create an instance of ListViewsInput', function() {
      // uncomment below and update the code to test ListViewsInput
      //var instance = new AwsResourceExplorer.ListViewsInput();
      //expect(instance).to.be.a(AwsResourceExplorer.ListViewsInput);
    });
