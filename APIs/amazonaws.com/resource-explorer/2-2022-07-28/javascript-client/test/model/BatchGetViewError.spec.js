...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.BatchGetViewError();
  });
  ...
  describe('BatchGetViewError', function() {
    it('should create an instance of BatchGetViewError', function() {
      // uncomment below and update the code to test BatchGetViewError
      //var instance = new AwsResourceExplorer.BatchGetViewError();
      //expect(instance).to.be.a(AwsResourceExplorer.BatchGetViewError);
    });
