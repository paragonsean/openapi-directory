...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.UpdateViewRequest();
  });
  ...
  describe('UpdateViewRequest', function() {
    it('should create an instance of UpdateViewRequest', function() {
      // uncomment below and update the code to test UpdateViewRequest
      //var instance = new AwsResourceExplorer.UpdateViewRequest();
      //expect(instance).to.be.a(AwsResourceExplorer.UpdateViewRequest);
    });
