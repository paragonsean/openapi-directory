...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.CreateViewInput();
  });
  ...
  describe('CreateViewInput', function() {
    it('should create an instance of CreateViewInput', function() {
      // uncomment below and update the code to test CreateViewInput
      //var instance = new AwsResourceExplorer.CreateViewInput();
      //expect(instance).to.be.a(AwsResourceExplorer.CreateViewInput);
    });
