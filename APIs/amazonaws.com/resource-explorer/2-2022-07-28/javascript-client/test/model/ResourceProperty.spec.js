...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ResourceProperty();
  });
  ...
  describe('ResourceProperty', function() {
    it('should create an instance of ResourceProperty', function() {
      // uncomment below and update the code to test ResourceProperty
      //var instance = new AwsResourceExplorer.ResourceProperty();
      //expect(instance).to.be.a(AwsResourceExplorer.ResourceProperty);
    });
