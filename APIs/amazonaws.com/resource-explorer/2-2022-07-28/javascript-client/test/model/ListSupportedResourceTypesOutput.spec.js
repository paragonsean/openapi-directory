...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListSupportedResourceTypesOutput();
  });
  ...
  describe('ListSupportedResourceTypesOutput', function() {
    it('should create an instance of ListSupportedResourceTypesOutput', function() {
      // uncomment below and update the code to test ListSupportedResourceTypesOutput
      //var instance = new AwsResourceExplorer.ListSupportedResourceTypesOutput();
      //expect(instance).to.be.a(AwsResourceExplorer.ListSupportedResourceTypesOutput);
    });
