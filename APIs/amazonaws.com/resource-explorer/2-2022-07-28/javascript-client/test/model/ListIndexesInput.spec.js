...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceExplorer.ListIndexesInput();
  });
  ...
  describe('ListIndexesInput', function() {
    it('should create an instance of ListIndexesInput', function() {
      // uncomment below and update the code to test ListIndexesInput
      //var instance = new AwsResourceExplorer.ListIndexesInput();
      //expect(instance).to.be.a(AwsResourceExplorer.ListIndexesInput);
    });
