...
async def test_associate_default_view(client):
    """Test case for associate_default_view

    
    """
    body = openapi_server.AssociateDefaultViewRequest()
    headers = { 
...
async def test_batch_get_view(client):
    """Test case for batch_get_view

    
    """
    body = openapi_server.BatchGetViewRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_index(client):
    ...
    """
    body = openapi_server.CreateIndexRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_view(client):
    ...
    """
    body = openapi_server.CreateViewRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_index(client):
    ...
    """
    body = openapi_server.DeleteIndexRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_view(client):
    ...
    """
    body = openapi_server.DeleteViewRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_disassociate_default_view(client):
    """Test case for disassociate_default_view
...
async def test_get_default_view(client):
    """Test case for get_default_view
...
async def test_get_view(client):
    ...
    """
    body = openapi_server.GetViewRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_indexes(client):
    ...
    """
    body = openapi_server.ListIndexesRequest()
...
async def test_list_supported_resource_types(client):
    """Test case for list_supported_resource_types

    
    """
    body = openapi_server.ListSupportedResourceTypesRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_views(client):
    ...
    """
    body = openapi_server.ListViewsRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_update_index_type(client):
    """Test case for update_index_type

    
    """
    body = openapi_server.UpdateIndexTypeRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_view(client):
    """Test case for update_view

    
    """
    body = openapi_server.UpdateViewRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
