...
class ListViewsRequest(Model):
    ...
    def __init__(self, max_results: int=None, next_token: str=None):
        """ListViewsRequest - a model defined in OpenAPI

        :param max_results: The max_results of this ListViewsRequest.
        :param next_token: The next_token of this ListViewsRequest.
        """
        self.openapi_types = {
            'max_results': int,
            'next_token': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListViewsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListViews_request of this ListViewsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_results(self):
        """Gets the max_results of this ListViewsRequest.
        ...
        :return: The max_results of this ListViewsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListViewsRequest.
    ...
    @property
    def next_token(self):
        """Gets the next_token of this ListViewsRequest.
        ...
        :return: The next_token of this ListViewsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListViewsRequest.
