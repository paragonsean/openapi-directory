...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QString path = create(); // QString | The path (including the file name) where the object is stored in the container. Format: &lt;folder name&gt;/&lt;folder name&gt;/&lt;file name&gt;
      ...
      apiInstance.deleteObject(pathx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
