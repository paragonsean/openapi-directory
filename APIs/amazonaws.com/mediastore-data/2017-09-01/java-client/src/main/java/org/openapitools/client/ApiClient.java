...
public class ApiClient {
    ...
    private String basePath = "http://data.mediastore.us-east-1.amazonaws.com";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://data.mediastore.us-east-1.amazonaws.com
