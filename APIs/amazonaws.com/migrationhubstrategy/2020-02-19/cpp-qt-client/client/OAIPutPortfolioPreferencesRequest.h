...
/*
 * OAIPutPortfolioPreferencesRequest.h
 *
 * 
 */

#ifndef OAIPutPortfolioPreferencesRequest_H
#define OAIPutPortfolioPreferencesRequest_H
...
class OAIPutPortfolioPreferencesRequest_prioritizeBusinessGoals;

class OAIPutPortfolioPreferencesRequest : public OAIObject {
public:
    OAIPutPortfolioPreferencesRequest();
    OAIPutPortfolioPreferencesRequest(QString json);
    ~OAIPutPortfolioPreferencesRequest() override;
    ...
    OAIPutPortfolioPreferencesRequest_prioritizeBusinessGoals getPrioritizeBusinessGoals() const;
    void setPrioritizeBusinessGoals(const OAIPutPortfolioPreferencesRequest_prioritizeBusinessGoals &prioritize_business_goals);
...
private:
    ...
    OAIPutPortfolioPreferencesRequest_prioritizeBusinessGoals m_prioritize_business_goals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPortfolioPreferencesRequest)

#endif // OAIPutPortfolioPreferencesRequest_H
