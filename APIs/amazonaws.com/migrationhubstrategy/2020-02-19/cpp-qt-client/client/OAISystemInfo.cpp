...
QString OAISystemInfo::getCpuArchitecture() const {
    return m_cpu_architecture;
}
void OAISystemInfo::setCpuArchitecture(const QString &cpu_architecture) {
    m_cpu_architecture = cpu_architecture;
    m_cpu_architecture_isSet = true;
}

bool OAISystemInfo::is_cpu_architecture_Set() const{
    return m_cpu_architecture_isSet;
}

bool OAISystemInfo::is_cpu_architecture_Valid() const{
    return m_cpu_architecture_isValid;
}

QString OAISystemInfo::getFileSystemType() const {
    return m_file_system_type;
}
void OAISystemInfo::setFileSystemType(const QString &file_system_type) {
    m_file_system_type = file_system_type;
    m_file_system_type_isSet = true;
}

bool OAISystemInfo::is_file_system_type_Set() const{
    return m_file_system_type_isSet;
}

bool OAISystemInfo::is_file_system_type_Valid() const{
    return m_file_system_type_isValid;
}

QList OAISystemInfo::getNetworkInfoList() const {
    return m_network_info_list;
}
void OAISystemInfo::setNetworkInfoList(const QList &network_info_list) {
    m_network_info_list = network_info_list;
    m_network_info_list_isSet = true;
}

bool OAISystemInfo::is_network_info_list_Set() const{
    return m_network_info_list_isSet;
}

bool OAISystemInfo::is_network_info_list_Valid() const{
    return m_network_info_list_isValid;
}

OAISystemInfo_osInfo OAISystemInfo::getOsInfo() const {
    return m_os_info;
}
void OAISystemInfo::setOsInfo(const OAISystemInfo_osInfo &os_info) {
    m_os_info = os_info;
    m_os_info_isSet = true;
}

bool OAISystemInfo::is_os_info_Set() const{
    return m_os_info_isSet;
}

bool OAISystemInfo::is_os_info_Valid() const{
