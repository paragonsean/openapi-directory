...
OAIGetImportFileTaskResponse::OAIGetImportFileTaskResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImportFileTaskResponse::OAIGetImportFileTaskResponse() {
    this->initializeModel();
}

OAIGetImportFileTaskResponse::~OAIGetImportFileTaskResponse() {}

void OAIGetImportFileTaskResponse::initializeModel() {
...
void OAIGetImportFileTaskResponse::fromJson(QString jsonString) {
...
void OAIGetImportFileTaskResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetImportFileTaskResponse::asJson() const {
...
QJsonObject OAIGetImportFileTaskResponse::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIGetImportFileTaskResponse::getCompletionTime() const {
    return m_completion_time;
}
void OAIGetImportFileTaskResponse::setCompletionTime(const QDateTime &completion_time) {
    m_completion_time = completion_time;
    m_completion_time_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_completion_time_Set() const{
    return m_completion_time_isSet;
}

bool OAIGetImportFileTaskResponse::is_completion_time_Valid() const{
    return m_completion_time_isValid;
}

QString OAIGetImportFileTaskResponse::getId() const {
    return m_id;
}
void OAIGetImportFileTaskResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetImportFileTaskResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetImportFileTaskResponse::getImportName() const {
    return m_import_name;
}
void OAIGetImportFileTaskResponse::setImportName(const QString &import_name) {
    m_import_name = import_name;
    m_import_name_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_import_name_Set() const{
    return m_import_name_isSet;
}

bool OAIGetImportFileTaskResponse::is_import_name_Valid() const{
    return m_import_name_isValid;
}

QString OAIGetImportFileTaskResponse::getInputS3Bucket() const {
    return m_input_s3_bucket;
}
void OAIGetImportFileTaskResponse::setInputS3Bucket(const QString &input_s3_bucket) {
    m_input_s3_bucket = input_s3_bucket;
    m_input_s3_bucket_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_input_s3_bucket_Set() const{
    return m_input_s3_bucket_isSet;
}

bool OAIGetImportFileTaskResponse::is_input_s3_bucket_Valid() const{
    return m_input_s3_bucket_isValid;
}

QString OAIGetImportFileTaskResponse::getInputS3Key() const {
    return m_input_s3_key;
}
void OAIGetImportFileTaskResponse::setInputS3Key(const QString &input_s3_key) {
    m_input_s3_key = input_s3_key;
    m_input_s3_key_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_input_s3_key_Set() const{
    return m_input_s3_key_isSet;
}

bool OAIGetImportFileTaskResponse::is_input_s3_key_Valid() const{
    return m_input_s3_key_isValid;
}

qint32 OAIGetImportFileTaskResponse::getNumberOfRecordsFailed() const {
    return m_number_of_records_failed;
}
void OAIGetImportFileTaskResponse::setNumberOfRecordsFailed(const qint32 &number_of_records_failed) {
    m_number_of_records_failed = number_of_records_failed;
    m_number_of_records_failed_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_number_of_records_failed_Set() const{
    return m_number_of_records_failed_isSet;
}

bool OAIGetImportFileTaskResponse::is_number_of_records_failed_Valid() const{
    return m_number_of_records_failed_isValid;
}

qint32 OAIGetImportFileTaskResponse::getNumberOfRecordsSuccess() const {
    return m_number_of_records_success;
}
void OAIGetImportFileTaskResponse::setNumberOfRecordsSuccess(const qint32 &number_of_records_success) {
    m_number_of_records_success = number_of_records_success;
    m_number_of_records_success_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_number_of_records_success_Set() const{
    return m_number_of_records_success_isSet;
}

bool OAIGetImportFileTaskResponse::is_number_of_records_success_Valid() const{
    return m_number_of_records_success_isValid;
}

QDateTime OAIGetImportFileTaskResponse::getStartTime() const {
    return m_start_time;
}
void OAIGetImportFileTaskResponse::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIGetImportFileTaskResponse::is_start_time_Valid() const{
    return m_start_time_isValid;
}

OAIImportFileTaskStatus OAIGetImportFileTaskResponse::getStatus() const {
    return m_status;
}
void OAIGetImportFileTaskResponse::setStatus(const OAIImportFileTaskStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetImportFileTaskResponse::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIGetImportFileTaskResponse::getStatusReportS3Bucket() const {
    return m_status_report_s3_bucket;
}
void OAIGetImportFileTaskResponse::setStatusReportS3Bucket(const QString &status_report_s3_bucket) {
    m_status_report_s3_bucket = status_report_s3_bucket;
    m_status_report_s3_bucket_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_status_report_s3_bucket_Set() const{
    return m_status_report_s3_bucket_isSet;
}

bool OAIGetImportFileTaskResponse::is_status_report_s3_bucket_Valid() const{
    return m_status_report_s3_bucket_isValid;
}

QString OAIGetImportFileTaskResponse::getStatusReportS3Key() const {
    return m_status_report_s3_key;
}
void OAIGetImportFileTaskResponse::setStatusReportS3Key(const QString &status_report_s3_key) {
    m_status_report_s3_key = status_report_s3_key;
    m_status_report_s3_key_isSet = true;
}

bool OAIGetImportFileTaskResponse::is_status_report_s3_key_Set() const{
    return m_status_report_s3_key_isSet;
}

bool OAIGetImportFileTaskResponse::is_status_report_s3_key_Valid() const{
    return m_status_report_s3_key_isValid;
}

bool OAIGetImportFileTaskResponse::isSet() const {
...
bool OAIGetImportFileTaskResponse::isValid() const {
