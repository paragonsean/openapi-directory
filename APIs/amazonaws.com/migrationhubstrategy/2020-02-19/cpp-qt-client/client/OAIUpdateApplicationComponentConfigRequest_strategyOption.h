...
/*
 * OAIUpdateApplicationComponentConfigRequest_strategyOption.h
 *
 * 
 */

#ifndef OAIUpdateApplicationComponentConfigRequest_strategyOption_H
#define OAIUpdateApplicationComponentConfigRequest_strategyOption_H
...
class OAIUpdateApplicationComponentConfigRequest_strategyOption : public OAIObject {
public:
    OAIUpdateApplicationComponentConfigRequest_strategyOption();
    OAIUpdateApplicationComponentConfigRequest_strategyOption(QString json);
    ~OAIUpdateApplicationComponentConfigRequest_strategyOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApplicationComponentConfigRequest_strategyOption)

#endif // OAIUpdateApplicationComponentConfigRequest_strategyOption_H
