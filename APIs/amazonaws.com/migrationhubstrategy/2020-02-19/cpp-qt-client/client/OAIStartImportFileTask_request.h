...
/*
 * OAIStartImportFileTask_request.h
 *
 * 
 */

#ifndef OAIStartImportFileTask_request_H
#define OAIStartImportFileTask_request_H
...
class OAIStartImportFileTask_request : public OAIObject {
public:
    OAIStartImportFileTask_request();
    OAIStartImportFileTask_request(QString json);
    ~OAIStartImportFileTask_request() override;
    ...
    QList<OAIGroup> getGroupId() const;
    void setGroupId(const QList<OAIGroup> &group_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartImportFileTask_request)

#endif // OAIStartImportFileTask_request_H
