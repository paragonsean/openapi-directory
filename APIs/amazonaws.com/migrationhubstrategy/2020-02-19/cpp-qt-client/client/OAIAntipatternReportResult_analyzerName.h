...
/*
 * OAIAntipatternReportResult_analyzerName.h
 *
 * 
 */

#ifndef OAIAntipatternReportResult_analyzerName_H
#define OAIAntipatternReportResult_analyzerName_H
...
class OAIAntipatternReportResult_analyzerName : public OAIObject {
public:
    OAIAntipatternReportResult_analyzerName();
    OAIAntipatternReportResult_analyzerName(QString json);
    ~OAIAntipatternReportResult_analyzerName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAntipatternReportResult_analyzerName)

#endif // OAIAntipatternReportResult_analyzerName_H
