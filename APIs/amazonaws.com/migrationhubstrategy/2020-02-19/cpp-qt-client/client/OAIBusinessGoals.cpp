...
OAIBusinessGoals::OAIBusinessGoals(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBusinessGoals::OAIBusinessGoals() {
    this->initializeModel();
}

OAIBusinessGoals::~OAIBusinessGoals() {}

void OAIBusinessGoals::initializeModel() {
...
void OAIBusinessGoals::fromJson(QString jsonString) {
...
void OAIBusinessGoals::fromJsonObject(QJsonObject json) {
...
QString OAIBusinessGoals::asJson() const {
...
QJsonObject OAIBusinessGoals::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIBusinessGoals::getLicenseCostReduction() const {
    return m_license_cost_reduction;
}
void OAIBusinessGoals::setLicenseCostReduction(const qint32 &license_cost_reduction) {
    m_license_cost_reduction = license_cost_reduction;
    m_license_cost_reduction_isSet = true;
}

bool OAIBusinessGoals::is_license_cost_reduction_Set() const{
    return m_license_cost_reduction_isSet;
}

bool OAIBusinessGoals::is_license_cost_reduction_Valid() const{
    return m_license_cost_reduction_isValid;
}

qint32 OAIBusinessGoals::getModernizeInfrastructureWithCloudNativeTechnologies() const {
    return m_modernize_infrastructure_with_cloud_native_technologies;
}
void OAIBusinessGoals::setModernizeInfrastructureWithCloudNativeTechnologies(const qint32 &modernize_infrastructure_with_cloud_native_technologies) {
...
bool OAIBusinessGoals::is_modernize_infrastructure_with_cloud_native_technologies_Set() const{
    return m_modernize_infrastructure_with_cloud_native_technologies_isSet;
}

bool OAIBusinessGoals::is_modernize_infrastructure_with_cloud_native_technologies_Valid() const{
    return m_modernize_infrastructure_with_cloud_native_technologies_isValid;
}

qint32 OAIBusinessGoals::getReduceOperationalOverheadWithManagedServices() const {
    return m_reduce_operational_overhead_with_managed_services;
}
void OAIBusinessGoals::setReduceOperationalOverheadWithManagedServices(const qint32 &reduce_operational_overhead_with_managed_services) {
...
bool OAIBusinessGoals::is_reduce_operational_overhead_with_managed_services_Set() const{
    return m_reduce_operational_overhead_with_managed_services_isSet;
}

bool OAIBusinessGoals::is_reduce_operational_overhead_with_managed_services_Valid() const{
    return m_reduce_operational_overhead_with_managed_services_isValid;
}

qint32 OAIBusinessGoals::getSpeedOfMigration() const {
    return m_speed_of_migration;
}
void OAIBusinessGoals::setSpeedOfMigration(const qint32 &speed_of_migration) {
    m_speed_of_migration = speed_of_migration;
    m_speed_of_migration_isSet = true;
}

bool OAIBusinessGoals::is_speed_of_migration_Set() const{
    return m_speed_of_migration_isSet;
}

bool OAIBusinessGoals::is_speed_of_migration_Valid() const{
    return m_speed_of_migration_isValid;
}

bool OAIBusinessGoals::isSet() const {
...
bool OAIBusinessGoals::isValid() const {
