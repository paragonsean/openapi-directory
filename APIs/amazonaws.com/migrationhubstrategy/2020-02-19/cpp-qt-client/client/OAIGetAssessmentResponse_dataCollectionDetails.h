...
/*
 * OAIGetAssessmentResponse_dataCollectionDetails.h
 *
 * 
 */

#ifndef OAIGetAssessmentResponse_dataCollectionDetails_H
#define OAIGetAssessmentResponse_dataCollectionDetails_H
...
class OAIGetAssessmentResponse_dataCollectionDetails : public OAIObject {
public:
    OAIGetAssessmentResponse_dataCollectionDetails();
    OAIGetAssessmentResponse_dataCollectionDetails(QString json);
    ~OAIGetAssessmentResponse_dataCollectionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAssessmentResponse_dataCollectionDetails)

#endif // OAIGetAssessmentResponse_dataCollectionDetails_H
