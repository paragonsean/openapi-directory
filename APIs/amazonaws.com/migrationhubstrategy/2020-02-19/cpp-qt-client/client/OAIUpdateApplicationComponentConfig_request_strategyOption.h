...
/*
 * OAIUpdateApplicationComponentConfig_request_strategyOption.h
 *
 *  Information about all the available strategy options for migrating and modernizing an application component. 
 */

#ifndef OAIUpdateApplicationComponentConfig_request_strategyOption_H
#define OAIUpdateApplicationComponentConfig_request_strategyOption_H
...
class OAIUpdateApplicationComponentConfig_request_strategyOption : public OAIObject {
public:
    OAIUpdateApplicationComponentConfig_request_strategyOption();
    OAIUpdateApplicationComponentConfig_request_strategyOption(QString json);
    ~OAIUpdateApplicationComponentConfig_request_strategyOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApplicationComponentConfig_request_strategyOption)

#endif // OAIUpdateApplicationComponentConfig_request_strategyOption_H
