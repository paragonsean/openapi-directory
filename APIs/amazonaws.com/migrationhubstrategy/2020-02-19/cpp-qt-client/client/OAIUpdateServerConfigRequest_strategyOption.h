...
/*
 * OAIUpdateServerConfigRequest_strategyOption.h
 *
 * 
 */

#ifndef OAIUpdateServerConfigRequest_strategyOption_H
#define OAIUpdateServerConfigRequest_strategyOption_H
...
class OAIUpdateServerConfigRequest_strategyOption : public OAIObject {
public:
    OAIUpdateServerConfigRequest_strategyOption();
    OAIUpdateServerConfigRequest_strategyOption(QString json);
    ~OAIUpdateServerConfigRequest_strategyOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServerConfigRequest_strategyOption)

#endif // OAIUpdateServerConfigRequest_strategyOption_H
