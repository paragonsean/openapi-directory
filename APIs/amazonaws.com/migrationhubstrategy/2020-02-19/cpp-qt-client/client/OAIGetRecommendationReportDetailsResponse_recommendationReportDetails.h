...
/*
 * OAIGetRecommendationReportDetailsResponse_recommendationReportDetails.h
 *
 * 
 */

#ifndef OAIGetRecommendationReportDetailsResponse_recommendationReportDetails_H
#define OAIGetRecommendationReportDetailsResponse_recommendationReportDetails_H
...
class OAIGetRecommendationReportDetailsResponse_recommendationReportDetails : public OAIObject {
public:
    OAIGetRecommendationReportDetailsResponse_recommendationReportDetails();
    OAIGetRecommendationReportDetailsResponse_recommendationReportDetails(QString json);
    ~OAIGetRecommendationReportDetailsResponse_recommendationReportDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRecommendationReportDetailsResponse_recommendationReportDetails)

#endif // OAIGetRecommendationReportDetailsResponse_recommendationReportDetails_H
