...
QString OAIS3Object::getS3Bucket() const {
    return m_s3_bucket;
}
void OAIS3Object::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAIS3Object::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAIS3Object::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAIS3Object::getS3key() const {
    return m_s3key;
}
void OAIS3Object::setS3key(const QString &s3key) {
    m_s3key = s3key;
    m_s3key_isSet = true;
}

bool OAIS3Object::is_s3key_Set() const{
    return m_s3key_isSet;
}

bool OAIS3Object::is_s3key_Valid() const{
