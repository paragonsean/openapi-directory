...
/*
 * OAIGetServerDetailsResponse_serverDetail.h
 *
 * 
 */

#ifndef OAIGetServerDetailsResponse_serverDetail_H
#define OAIGetServerDetailsResponse_serverDetail_H
...
class OAIGetServerDetailsResponse_serverDetail : public OAIObject {
public:
    OAIGetServerDetailsResponse_serverDetail();
    OAIGetServerDetailsResponse_serverDetail(QString json);
    ~OAIGetServerDetailsResponse_serverDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServerDetailsResponse_serverDetail)

#endif // OAIGetServerDetailsResponse_serverDetail_H
