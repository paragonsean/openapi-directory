...
/*
 * OAIGetImportFileTaskResponse.h
 *
 * 
 */

#ifndef OAIGetImportFileTaskResponse_H
#define OAIGetImportFileTaskResponse_H
...
class OAIGetImportFileTaskResponse : public OAIObject {
public:
    OAIGetImportFileTaskResponse();
    OAIGetImportFileTaskResponse(QString json);
    ~OAIGetImportFileTaskResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetImportFileTaskResponse)

#endif // OAIGetImportFileTaskResponse_H
