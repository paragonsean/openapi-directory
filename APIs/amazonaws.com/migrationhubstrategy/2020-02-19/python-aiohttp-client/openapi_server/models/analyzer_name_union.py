...
class AnalyzerNameUnion(Model):
    ...
    def __init__(self, binary_analyzer_name: BinaryAnalyzerName=None, run_time_analyzer_name: RunTimeAnalyzerName=None, source_code_analyzer_name: SourceCodeAnalyzerName=None):
        """AnalyzerNameUnion - a model defined in OpenAPI

        :param binary_analyzer_name: The binary_analyzer_name of this AnalyzerNameUnion.
        :param run_time_analyzer_name: The run_time_analyzer_name of this AnalyzerNameUnion.
        :param source_code_analyzer_name: The source_code_analyzer_name of this AnalyzerNameUnion.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AnalyzerNameUnion':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AnalyzerNameUnion of this AnalyzerNameUnion.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def binary_analyzer_name(self):
        """Gets the binary_analyzer_name of this AnalyzerNameUnion.


        :return: The binary_analyzer_name of this AnalyzerNameUnion.
    ...
    def binary_analyzer_name(self, binary_analyzer_name):
        """Sets the binary_analyzer_name of this AnalyzerNameUnion.
    ...
    def run_time_analyzer_name(self):
        """Gets the run_time_analyzer_name of this AnalyzerNameUnion.


        :return: The run_time_analyzer_name of this AnalyzerNameUnion.
    ...
    def run_time_analyzer_name(self, run_time_analyzer_name):
        """Sets the run_time_analyzer_name of this AnalyzerNameUnion.
    ...
    def source_code_analyzer_name(self):
        """Gets the source_code_analyzer_name of this AnalyzerNameUnion.


        :return: The source_code_analyzer_name of this AnalyzerNameUnion.
    ...
    def source_code_analyzer_name(self, source_code_analyzer_name):
        """Sets the source_code_analyzer_name of this AnalyzerNameUnion.
