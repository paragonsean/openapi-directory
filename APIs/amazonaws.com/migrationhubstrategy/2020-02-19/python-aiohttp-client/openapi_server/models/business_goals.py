...
class BusinessGoals(Model):
    ...
    def __init__(self, license_cost_reduction: int=None, modernize_infrastructure_with_cloud_native_technologies: int=None, reduce_operational_overhead_with_managed_services: int=None, speed_of_migration: int=None):
        """BusinessGoals - a model defined in OpenAPI

        :param license_cost_reduction: The license_cost_reduction of this BusinessGoals.
        :param modernize_infrastructure_with_cloud_native_technologies: The modernize_infrastructure_with_cloud_native_technologies of this BusinessGoals.
        :param reduce_operational_overhead_with_managed_services: The reduce_operational_overhead_with_managed_services of this BusinessGoals.
        :param speed_of_migration: The speed_of_migration of this BusinessGoals.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BusinessGoals':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BusinessGoals of this BusinessGoals.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def license_cost_reduction(self):
        """Gets the license_cost_reduction of this BusinessGoals.


        :return: The license_cost_reduction of this BusinessGoals.
        :rtype: int
        """
    ...
    def license_cost_reduction(self, license_cost_reduction):
        """Sets the license_cost_reduction of this BusinessGoals.
    ...
    def modernize_infrastructure_with_cloud_native_technologies(self):
        """Gets the modernize_infrastructure_with_cloud_native_technologies of this BusinessGoals.


        :return: The modernize_infrastructure_with_cloud_native_technologies of this BusinessGoals.
        :rtype: int
        """
    ...
    def modernize_infrastructure_with_cloud_native_technologies(self, modernize_infrastructure_with_cloud_native_technologies):
        """Sets the modernize_infrastructure_with_cloud_native_technologies of this BusinessGoals.
    ...
    def reduce_operational_overhead_with_managed_services(self):
        """Gets the reduce_operational_overhead_with_managed_services of this BusinessGoals.


        :return: The reduce_operational_overhead_with_managed_services of this BusinessGoals.
        :rtype: int
        """
    ...
    def reduce_operational_overhead_with_managed_services(self, reduce_operational_overhead_with_managed_services):
        """Sets the reduce_operational_overhead_with_managed_services of this BusinessGoals.
    ...
    def speed_of_migration(self):
        """Gets the speed_of_migration of this BusinessGoals.


        :return: The speed_of_migration of this BusinessGoals.
        :rtype: int
        """
    ...
    def speed_of_migration(self, speed_of_migration):
        """Sets the speed_of_migration of this BusinessGoals.
