...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.GetAssessmentResponseDataCollectionDetails();
  });
  ...
  describe('GetAssessmentResponseDataCollectionDetails', function() {
    it('should create an instance of GetAssessmentResponseDataCollectionDetails', function() {
      // uncomment below and update the code to test GetAssessmentResponseDataCollectionDetails
      //var instance = new MigrationHubStrategyRecommendations.GetAssessmentResponseDataCollectionDetails();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.GetAssessmentResponseDataCollectionDetails);
    });
