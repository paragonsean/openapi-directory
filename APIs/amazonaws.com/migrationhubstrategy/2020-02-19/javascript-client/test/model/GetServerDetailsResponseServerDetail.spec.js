...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.GetServerDetailsResponseServerDetail();
  });
  ...
  describe('GetServerDetailsResponseServerDetail', function() {
    it('should create an instance of GetServerDetailsResponseServerDetail', function() {
      // uncomment below and update the code to test GetServerDetailsResponseServerDetail
      //var instance = new MigrationHubStrategyRecommendations.GetServerDetailsResponseServerDetail();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.GetServerDetailsResponseServerDetail);
    });
    ...
    it('should have the property applicationComponentStrategySummary (base name: "applicationComponentStrategySummary")', function() {
      // uncomment below and update the code to test the property applicationComponentStrategySummary
      //var instance = new MigrationHubStrategyRecommendations.GetServerDetailsResponseServerDetail();
      //expect(instance).to.be();
    });

    it('should have the property dataCollectionStatus (base name: "dataCollectionStatus")', function() {
      // uncomment below and update the code to test the property dataCollectionStatus
      //var instance = new MigrationHubStrategyRecommendations.GetServerDetailsResponseServerDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property serverError (base name: "serverError")', function() {
      // uncomment below and update the code to test the property serverError
      //var instance = new MigrationHubStrategyRecommendations.GetServerDetailsResponseServerDetail();
      //expect(instance).to.be();
    });
