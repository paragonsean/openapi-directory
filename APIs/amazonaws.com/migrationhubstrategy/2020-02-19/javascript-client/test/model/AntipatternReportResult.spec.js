...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.AntipatternReportResult();
  });
  ...
  describe('AntipatternReportResult', function() {
    it('should create an instance of AntipatternReportResult', function() {
      // uncomment below and update the code to test AntipatternReportResult
      //var instance = new MigrationHubStrategyRecommendations.AntipatternReportResult();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.AntipatternReportResult);
    });

    it('should have the property analyzerName (base name: "analyzerName")', function() {
      // uncomment below and update the code to test the property analyzerName
      //var instance = new MigrationHubStrategyRecommendations.AntipatternReportResult();
