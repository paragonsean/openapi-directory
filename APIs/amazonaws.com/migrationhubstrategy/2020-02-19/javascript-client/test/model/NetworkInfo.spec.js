...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.NetworkInfo();
  });
  ...
  describe('NetworkInfo', function() {
    it('should create an instance of NetworkInfo', function() {
      ...
      //var instance = new MigrationHubStrategyRecommendations.NetworkInfo();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.NetworkInfo);
    });
