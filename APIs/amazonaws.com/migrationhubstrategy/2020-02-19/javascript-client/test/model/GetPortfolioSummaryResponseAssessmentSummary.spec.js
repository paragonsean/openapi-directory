...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.GetPortfolioSummaryResponseAssessmentSummary();
  });
  ...
  describe('GetPortfolioSummaryResponseAssessmentSummary', function() {
    it('should create an instance of GetPortfolioSummaryResponseAssessmentSummary', function() {
      // uncomment below and update the code to test GetPortfolioSummaryResponseAssessmentSummary
      //var instance = new MigrationHubStrategyRecommendations.GetPortfolioSummaryResponseAssessmentSummary();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.GetPortfolioSummaryResponseAssessmentSummary);
    });
