...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.GetImportFileTaskResponse();
  });
  ...
  describe('GetImportFileTaskResponse', function() {
    it('should create an instance of GetImportFileTaskResponse', function() {
      // uncomment below and update the code to test GetImportFileTaskResponse
      //var instance = new MigrationHubStrategyRecommendations.GetImportFileTaskResponse();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.GetImportFileTaskResponse);
    });
