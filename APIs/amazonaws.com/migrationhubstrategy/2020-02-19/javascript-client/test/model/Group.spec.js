...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.Group();
  });
  ...
  describe('Group', function() {
    it('should create an instance of Group', function() {
      ...
      //var instance = new MigrationHubStrategyRecommendations.Group();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.Group);
    });
