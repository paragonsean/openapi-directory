...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationHubStrategyRecommendations.ServerDetail();
  });
  ...
  describe('ServerDetail', function() {
    it('should create an instance of ServerDetail', function() {
      // uncomment below and update the code to test ServerDetail
      //var instance = new MigrationHubStrategyRecommendations.ServerDetail();
      //expect(instance).to.be.a(MigrationHubStrategyRecommendations.ServerDetail);
    });
