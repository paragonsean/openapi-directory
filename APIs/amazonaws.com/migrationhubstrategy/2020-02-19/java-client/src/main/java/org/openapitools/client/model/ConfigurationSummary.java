...
public class ConfigurationSummary {
  ...
  public ConfigurationSummary ipAddressBasedRemoteInfoList(List ipAddressBasedRemoteInfoList) {
  ...
  public ConfigurationSummary pipelineInfoList(List pipelineInfoList) {
  ...
  public ConfigurationSummary remoteSourceCodeAnalysisServerInfo(ConfigurationSummaryRemoteSourceCodeAnalysisServerInfo remoteSourceCodeAnalysisServerInfo) {
  ...
  public ConfigurationSummary vcenterBasedRemoteInfoList(List vcenterBasedRemoteInfoList) {
  ...
  public ConfigurationSummary versionControlInfoList(List versionControlInfoList) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ipAddressBasedRemoteInfoList, configurationSummary.ipAddressBasedRemoteInfoList) &&
        Objects.equals(this.pipelineInfoList, configurationSummary.pipelineInfoList) &&
        Objects.equals(this.remoteSourceCodeAnalysisServerInfo, configurationSummary.remoteSourceCodeAnalysisServerInfo) &&
        Objects.equals(this.vcenterBasedRemoteInfoList, configurationSummary.vcenterBasedRemoteInfoList) &&
        Objects.equals(this.versionControlInfoList, configurationSummary.versionControlInfoList);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigurationSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigurationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigurationSummary is not found in the empty JSON string", ConfigurationSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigurationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigurationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigurationSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigurationSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigurationSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigurationSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigurationSummary>() {
           @Override
           public void write(JsonWriter out, ConfigurationSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfigurationSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfigurationSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfigurationSummary
   * @throws IOException if the JSON string is invalid with respect to ConfigurationSummary
   */
  public static ConfigurationSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigurationSummary.class);
  }

  /**
   * Convert an instance of ConfigurationSummary to an JSON string
   *
   * @return JSON string
   */
