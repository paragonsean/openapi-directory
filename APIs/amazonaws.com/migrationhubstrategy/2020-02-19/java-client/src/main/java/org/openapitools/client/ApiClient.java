...
public class ApiClient {
    ...
    private String basePath = "http://migrationhub-strategy.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-02-19/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://migrationhub-strategy.us-east-1.amazonaws.com
