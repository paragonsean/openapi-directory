...
public class GetImportFileTaskResponse {
  ...
  public GetImportFileTaskResponse completionTime(OffsetDateTime completionTime) {
  ...
  public GetImportFileTaskResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetImportFileTaskResponse importName(String importName) {
  ...
  public GetImportFileTaskResponse inputS3Bucket(String inputS3Bucket) {
  ...
  public GetImportFileTaskResponse inputS3Key(String inputS3Key) {
  ...
  public GetImportFileTaskResponse numberOfRecordsFailed(Integer numberOfRecordsFailed) {
  ...
  public GetImportFileTaskResponse numberOfRecordsSuccess(Integer numberOfRecordsSuccess) {
  ...
  public GetImportFileTaskResponse startTime(OffsetDateTime startTime) {
  ...
  public GetImportFileTaskResponse status(ImportFileTaskStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetImportFileTaskResponse statusReportS3Bucket(String statusReportS3Bucket) {
  ...
  public GetImportFileTaskResponse statusReportS3Key(String statusReportS3Key) {
  ...
  public boolean equals(Object o) {
    ...
    GetImportFileTaskResponse getImportFileTaskResponse = (GetImportFileTaskResponse) o;
    return Objects.equals(this.completionTime, getImportFileTaskResponse.completionTime) &&
        Objects.equals(this.id, getImportFileTaskResponse.id) &&
        Objects.equals(this.importName, getImportFileTaskResponse.importName) &&
        Objects.equals(this.inputS3Bucket, getImportFileTaskResponse.inputS3Bucket) &&
        Objects.equals(this.inputS3Key, getImportFileTaskResponse.inputS3Key) &&
        Objects.equals(this.numberOfRecordsFailed, getImportFileTaskResponse.numberOfRecordsFailed) &&
        Objects.equals(this.numberOfRecordsSuccess, getImportFileTaskResponse.numberOfRecordsSuccess) &&
        Objects.equals(this.startTime, getImportFileTaskResponse.startTime) &&
        Objects.equals(this.status, getImportFileTaskResponse.status) &&
        Objects.equals(this.statusReportS3Bucket, getImportFileTaskResponse.statusReportS3Bucket) &&
        Objects.equals(this.statusReportS3Key, getImportFileTaskResponse.statusReportS3Key);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetImportFileTaskResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImportFileTaskResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImportFileTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImportFileTaskResponse is not found in the empty JSON string", GetImportFileTaskResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImportFileTaskResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImportFileTaskResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImportFileTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImportFileTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImportFileTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImportFileTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImportFileTaskResponse>() {
           @Override
           public void write(JsonWriter out, GetImportFileTaskResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImportFileTaskResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImportFileTaskResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImportFileTaskResponse
   * @throws IOException if the JSON string is invalid with respect to GetImportFileTaskResponse
   */
  public static GetImportFileTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImportFileTaskResponse.class);
  }

  /**
   * Convert an instance of GetImportFileTaskResponse to an JSON string
   *
   * @return JSON string
   */
