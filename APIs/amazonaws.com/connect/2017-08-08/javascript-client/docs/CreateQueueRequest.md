# AmazonConnectService.CreateQueueRequest
...
**maxContacts** | **Number** | The maximum number of contacts that can be in the queue before it is considered full. | [optional] 
**quickConnectIds** | **[String]** | The quick connects available to agents who are working the queue. | [optional] 
