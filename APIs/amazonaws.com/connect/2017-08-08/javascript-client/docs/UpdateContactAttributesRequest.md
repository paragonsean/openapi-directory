# AmazonConnectService.UpdateContactAttributesRequest
...
**attributes** | **{String: String}** | &lt;p&gt;The Amazon Connect attributes. These attributes can be accessed in flows just like any other contact attributes.&lt;/p&gt; &lt;p&gt;You can have up to 32,768 UTF-8 bytes across all attributes for a contact. Attribute keys can include only alphanumeric, dash, and underscore characters.&lt;/p&gt; | 
