# AmazonConnectService.MonitorContactRequest
...
**allowedMonitorCapabilities** | [**[MonitorCapability]**](MonitorCapability.md) | Specify which monitoring actions the user is allowed to take. For example, whether the user is allowed to escalate from silent monitoring to barge. | [optional] 
