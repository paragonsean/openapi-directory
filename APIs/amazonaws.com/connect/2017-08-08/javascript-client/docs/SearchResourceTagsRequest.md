# AmazonConnectService.SearchResourceTagsRequest
...
**resourceTypes** | **[String]** | The list of resource types to be used to search tags from. If not provided or if any empty list is provided, this API will search from all supported resource types. | [optional] 
