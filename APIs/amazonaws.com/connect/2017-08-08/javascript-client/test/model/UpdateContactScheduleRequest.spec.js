...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.UpdateContactScheduleRequest();
  });
  ...
  describe('UpdateContactScheduleRequest', function() {
    it('should create an instance of UpdateContactScheduleRequest', function() {
      // uncomment below and update the code to test UpdateContactScheduleRequest
      //var instance = new AmazonConnectService.UpdateContactScheduleRequest();
      //expect(instance).to.be.a(AmazonConnectService.UpdateContactScheduleRequest);
    });
