...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.MetricResultV2();
  });
  ...
  describe('MetricResultV2', function() {
    it('should create an instance of MetricResultV2', function() {
      // uncomment below and update the code to test MetricResultV2
      //var instance = new AmazonConnectService.MetricResultV2();
      //expect(instance).to.be.a(AmazonConnectService.MetricResultV2);
    });
