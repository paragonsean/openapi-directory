...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.HierarchyLevel();
  });
  ...
  describe('HierarchyLevel', function() {
    it('should create an instance of HierarchyLevel', function() {
      ...
      //var instance = new AmazonConnectService.HierarchyLevel();
      //expect(instance).to.be.a(AmazonConnectService.HierarchyLevel);
    });
