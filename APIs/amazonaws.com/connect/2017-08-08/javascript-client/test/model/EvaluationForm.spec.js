...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.EvaluationForm();
  });
  ...
  describe('EvaluationForm', function() {
    it('should create an instance of EvaluationForm', function() {
      // uncomment below and update the code to test EvaluationForm
      //var instance = new AmazonConnectService.EvaluationForm();
      //expect(instance).to.be.a(AmazonConnectService.EvaluationForm);
    });
