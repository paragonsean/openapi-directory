...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.TaskTemplateMetadata();
  });
  ...
  describe('TaskTemplateMetadata', function() {
    it('should create an instance of TaskTemplateMetadata', function() {
      // uncomment below and update the code to test TaskTemplateMetadata
      //var instance = new AmazonConnectService.TaskTemplateMetadata();
      //expect(instance).to.be.a(AmazonConnectService.TaskTemplateMetadata);
    });
