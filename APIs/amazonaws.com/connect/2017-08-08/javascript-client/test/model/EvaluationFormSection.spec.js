...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.EvaluationFormSection();
  });
  ...
  describe('EvaluationFormSection', function() {
    it('should create an instance of EvaluationFormSection', function() {
      // uncomment below and update the code to test EvaluationFormSection
      //var instance = new AmazonConnectService.EvaluationFormSection();
      //expect(instance).to.be.a(AmazonConnectService.EvaluationFormSection);
    });
