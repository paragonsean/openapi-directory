...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.CreateParticipantRequest();
  });
  ...
  describe('CreateParticipantRequest', function() {
    it('should create an instance of CreateParticipantRequest', function() {
      // uncomment below and update the code to test CreateParticipantRequest
      //var instance = new AmazonConnectService.CreateParticipantRequest();
      //expect(instance).to.be.a(AmazonConnectService.CreateParticipantRequest);
    });
