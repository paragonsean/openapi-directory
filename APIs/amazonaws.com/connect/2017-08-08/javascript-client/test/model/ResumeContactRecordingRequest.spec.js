...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.ResumeContactRecordingRequest();
  });
  ...
  describe('ResumeContactRecordingRequest', function() {
    it('should create an instance of ResumeContactRecordingRequest', function() {
      // uncomment below and update the code to test ResumeContactRecordingRequest
      //var instance = new AmazonConnectService.ResumeContactRecordingRequest();
      //expect(instance).to.be.a(AmazonConnectService.ResumeContactRecordingRequest);
    });
