...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.DefaultVocabulary();
  });
  ...
  describe('DefaultVocabulary', function() {
    it('should create an instance of DefaultVocabulary', function() {
      // uncomment below and update the code to test DefaultVocabulary
      //var instance = new AmazonConnectService.DefaultVocabulary();
      //expect(instance).to.be.a(AmazonConnectService.DefaultVocabulary);
    });
