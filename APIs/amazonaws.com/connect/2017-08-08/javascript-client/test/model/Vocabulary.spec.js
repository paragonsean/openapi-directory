...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.Vocabulary();
  });
  ...
  describe('Vocabulary', function() {
    it('should create an instance of Vocabulary', function() {
      // uncomment below and update the code to test Vocabulary
      //var instance = new AmazonConnectService.Vocabulary();
      //expect(instance).to.be.a(AmazonConnectService.Vocabulary);
    });
