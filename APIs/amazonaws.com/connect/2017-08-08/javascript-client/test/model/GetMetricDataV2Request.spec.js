...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.GetMetricDataV2Request();
  });
  ...
  describe('GetMetricDataV2Request', function() {
    it('should create an instance of GetMetricDataV2Request', function() {
      // uncomment below and update the code to test GetMetricDataV2Request
      //var instance = new AmazonConnectService.GetMetricDataV2Request();
      //expect(instance).to.be.a(AmazonConnectService.GetMetricDataV2Request);
    });
